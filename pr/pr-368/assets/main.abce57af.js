 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var mo,go;class O extends _t{constructor(){super(...arguments),this.renderOptions={host:this},this._$Dt=void 0}createRenderRoot(){var e,t;const i=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=i.firstChild),i}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Dt=Mi(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Dt)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Dt)===null||e===void 0||e.setConnected(!1)}render(){return Se}}O.finalized=!0,O._$litElement$=!0,(mo=globalThis.litElementHydrateSupport)===null||mo===void 0||mo.call(globalThis,{LitElement:O});const sa=globalThis.litElementPolyfillSupport;sa==null||sa({LitElement:O});((go=globalThis.litElementVersions)!==null&&go!==void 0?go:globalThis.litElementVersions=[]).push("3.2.0");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*Pi(r,e){const t=typeof e=="function";if(r!==void 0){let i=-1;for(const o of r)i>-1&&(yield t?e(i):e),i++,yield o}}let Vi=class extends O{constructor(){super(...arguments),this.snippets=[],this.viewSize="desktop"}render(){var e;return!((e=this.snippets)===null||e===void 0)&&e.length?c`
      <div class="container">
        <div class="snippet-view ${this.viewSize}">
...
`+fe),mt&&(fe=Ge(fe,Je," "),fe=Ge(fe,et," ")),F&&xi?F.createHTML(fe):fe},e.setConfig=function(M){no(M),to=!0},e.clearConfig=function(){xt=null,to=!1},e.isValidAttribute=function(M,v,x){xt||no({});var C=ot(M),V=ot(v);return Ur(C,V,x)},e.addHook=function(M,v){typeof v=="function"&&(ye[M]=ye[M]||[],ei(ye[M],v))},e.removeHook=function(M){if(ye[M])return va(ye[M])},e.removeHooks=function(M){ye[M]&&(ye[M]=[])},e.removeAllHooks=function(){ye={}},e}var Li=Es();let ji=class extends ne{constructor(){super(...arguments),this.collectionLinks=[]}render(){return c`
    ...
    `}};l([h({type:Object})],ji.prototype,"collectionTitles",void 0);l([z()],ji.prototype,"collectionLinks",void 0);ji=l([L("tile-list")],ji);let Ye=class extends O{constructor(){super(...arguments),this.loggedIn=!1}render(){return c`
      <div id="container">
        <tile-list
          .model=${this.model}
 ...
 */const Ha=gi(class extends bi{constructor(r){if(super(r),r.type!==Ae.PROPERTY&&r.type!==Ae.ATTRIBUTE&&r.type!==Ae.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!us(r))throw Error("`live` bindings can only contain a single expression")}render(r){return r}update(r,[e]){if(e===Se||e===y)return e;const t=r.element,i=r.name;if(r.type===Ae.PROPERTY){if(e===t[i])return Se}else if(r.type===Ae.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(i))return Se}else if(r.type===Ae.ATTRIBUTE&&t.getAttribute(i)===e+"")return Se;return vs(r),e}}),Hd=Object.freeze({processing:"processing",complete:"complete"});class Vd extends O{static get properties(){return{mode:{type:String}}}constructor(){super(),this.mode=Hd.processing}render(){return c`
    ...
    `}get selectedRangeTemplate(){return I`
      ...
      />`}get histogramTemplate(){const e=this._histWidth/this._numBins,t=e-1;let i=this.sliderWidth;return this._histData.map(o=>{const a=I`
        ...
        />`;return i+=e,a})}formatDate(e){if(Number.isNaN(e))return"";const t=Fo(e);return t.year()<1e3?String(t.year()):t.format(this.dateFormat)}get minInputTemplate(){return c`
      <input
        id="date-min"
