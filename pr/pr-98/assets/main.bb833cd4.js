var go=Object.defineProperty,yo=Object.defineProperties;var bo=Object.getOwnPropertyDescriptors;var Wr=Object.getOwnPropertySymbols;var wo=Object.prototype.hasOwnProperty,xo=Object.prototype.propertyIsEnumerable;var jr=(a,e,t)=>e in a?go(a,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):a[e]=t,ge=(a,e)=>{for(var t in e||(e={}))wo.call(e,t)&&jr(a,t,e[t]);if(Wr)for(var t of Wr(e))xo.call(e,t)&&jr(a,t,e[t]);return a},Et=(a,e)=>yo(a,bo(e));const So=function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const o of r)if(o.type==="childList")for(const s of o.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function t(r){const o={};return r.integrity&&(o.integrity=r.integrity),r.referrerpolicy&&(o.referrerPolicy=r.referrerpolicy),r.crossorigin==="use-credentials"?o.credentials="include":r.crossorigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(r){if(r.ep)return;r.ep=!0;const o=t(r);fetch(r.href,o)}};So();function n(a,e,t,i){var r=arguments.length,o=r<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(a,e,t,i);else for(var l=a.length-1;l>=0;l--)(s=a[l])&&(o=(r<3?s(o):r>3?s(e,t,o):s(e,t))||o);return r>3&&o&&Object.defineProperty(e,t,o),o}function w(a){let e,t,i;return typeof a=="object"?(e=a.hashFunction,t=a.expiring,i=a.tags):e=a,(r,o,s)=>{if(s.value!=null)s.value=Qr(s.value,e,t,i);else if(s.get!=null)s.get=Qr(s.get,e,t,i);else throw"Only put a Memoize() decorator on a method or get accessor."}}const Fi=new Map;function Qr(a,e,t=0,i){const r=Symbol("__memoized_map__");return function(...o){let s;this.hasOwnProperty(r)||Object.defineProperty(this,r,{configurable:!1,enumerable:!1,writable:!1,value:new Map});let l=this[r];if(Array.isArray(i))for(const c of i)Fi.has(c)?Fi.get(c).push(l):Fi.set(c,[l]);if(e||o.length>0||t>0){let c;e===!0?c=o.map(f=>f.toString()).join("!"):e?c=e.apply(this,o):c=o[0];const h=`${c}__timestamp`;let u=!1;if(t>0)if(!l.has(h))u=!0;else{let f=l.get(h);u=Date.now()-f>t}l.has(c)&&!u?s=l.get(c):(s=a.apply(this,o),l.set(c,s),t>0&&l.set(h,Date.now()))}else{const c=this;l.has(c)?s=l.get(c):(s=a.apply(this,o),l.set(c,s))}return s}}class er{parseValue(e){return typeof e=="string"&&(e==="false"||e==="0")?!1:Boolean(e)}}er.shared=new er;class Oe{parseValue(e){if(typeof e=="number")return e;if(typeof e=="boolean")return;const t=parseFloat(e);if(!Number.isNaN(t))return t}}Oe.shared=new Oe;class si{parseValue(e){return Oe.shared.parseValue(e)}}si.shared=new si;class Pt{parseValue(e){return this.parseJSDate(e)||this.parseBracketDate(e)}parseBracketDate(e){if(typeof e!="string")return;const t=e.match(/\[([0-9]{4})\]/);if(!(!t||t.length<2))return this.parseJSDate(t[1])}parseJSDate(e){if(typeof e!="string")return;let t=e;t.match(/^[0-9]{4}-[0-9]{2}-[0-9]{2}\s{1}[0-9]{2}:[0-9]{2}:[0-9]{2}$/)&&(t=t.replace(" ","T"));const i=Date.parse(t);if(Number.isNaN(i))return;let r=new Date(t);return(t.indexOf("Z")>-1||t.indexOf("+")>-1||t.match(/^[0-9]{4}$/)||t.match(/^[0-9]{4}-[0-9]{2}-[0-9]{2}$/)||t.match(/^.*?-[0-9]{2}:[0-9]{2}$/)||t.match(/^.*?-[0-9]{4}$/))&&(r=new Date(r.getTime()+r.getTimezoneOffset()*1e3*60)),r}}Pt.shared=new Pt;class ni{parseValue(e){if(typeof e=="number")return e;if(typeof e=="boolean")return;const t=e.split(":");let i;return t.length===1?i=this.parseNumberFormat(t[0]):i=this.parseColonSeparatedFormat(t),i}parseNumberFormat(e){let t=parseFloat(e);return Number.isNaN(t)&&(t=void 0),t}parseColonSeparatedFormat(e){let t=!1;const i=e.map((r,o)=>{const s=parseFloat(r);if(Number.isNaN(s))return t=!0,0;const l=e.length-1-o,c=60**l;return s*Math.floor(c)}).reduce((r,o)=>r+o,0);return t?void 0:i}}ni.shared=new ni;class tr{parseValue(e){if(typeof e=="string")return e}}tr.shared=new tr;class $o{constructor(e,t){this.separators=[";",","],this.parser=e,t&&t.separators&&(this.separators=t.separators)}parseValue(e){const t=String(e);let i=[];for(const r of this.separators)if(i=t.split(r),i.length>1)break;return this.parseListValues(i)}parseListValues(e){const i=e.map(o=>o.trim()).map(o=>this.parser.parseValue(o)),r=[];return i.forEach(o=>{o!==void 0&&r.push(o)}),r}}class ir{parseValue(e){if(typeof e=="string")return e}}ir.shared=new ir;class li{parseValue(e){return String(e)}}li.shared=new li;class fe{constructor(e,t){this.parser=e,this.rawValue=t}get values(){return this.parseRawValue()}get value(){return this.values[0]}parseRawValue(){if(this.rawValue===void 0)return[];const e=Array.isArray(this.rawValue)?this.rawValue:[this.rawValue],t=[];return e.forEach(i=>{const r=this.parser.parseValue(i);Array.isArray(r)?t.push(...r):r!==void 0&&t.push(r)}),t}}n([w()],fe.prototype,"values",null);n([w()],fe.prototype,"value",null);class Co extends fe{constructor(e){super(er.shared,e)}}class $e extends fe{constructor(e){super(Pt.shared,e)}}class Ri extends fe{constructor(e){super(ni.shared,e)}}class de extends fe{constructor(e){super(Oe.shared,e)}}class B extends fe{constructor(e){super(li.shared,e)}}class _o extends fe{constructor(e){super(ir.shared,e)}}class Gr extends fe{constructor(e){super(si.shared,e)}}class zo extends fe{constructor(e){super(tr.shared,e)}}class ko extends fe{constructor(e,t){super(t,e)}}class To extends ko{constructor(e){const t=new $o(li.shared);super(e,t)}}class C{constructor(e){this.rawMetadata=e}get identifier(){var e;return(e=this.rawMetadata)===null||e===void 0?void 0:e.identifier}get addeddate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.addeddate?new $e(this.rawMetadata.addeddate):void 0}get audio_codec(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.audio_codec?new B(this.rawMetadata.audio_codec):void 0}get audio_sample_rate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.audio_sample_rate?new de(this.rawMetadata.audio_sample_rate):void 0}get avg_rating(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.avg_rating?new de(this.rawMetadata.avg_rating):void 0}get collection(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.collection?new B(this.rawMetadata.collection):void 0}get collections_raw(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.collections_raw?new B(this.rawMetadata.collections_raw):void 0}get collection_size(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.collection_size?new Gr(this.rawMetadata.collection_size):void 0}get contributor(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.contributor?new B(this.rawMetadata.contributor):void 0}get coverage(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.coverage?new B(this.rawMetadata.coverage):void 0}get creator(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.creator?new B(this.rawMetadata.creator):void 0}get date(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.date?new $e(this.rawMetadata.date):void 0}get description(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.description?new B(this.rawMetadata.description):void 0}get downloads(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.downloads?new de(this.rawMetadata.downloads):void 0}get duration(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.duration?new Ri(this.rawMetadata.duration):void 0}get"external-identifier"(){var e,t;return!((e=this.rawMetadata)===null||e===void 0)&&e["external-identifier"]?new B((t=this.rawMetadata)===null||t===void 0?void 0:t["external-identifier"]):void 0}get files_count(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.files_count?new de(this.rawMetadata.files_count):void 0}get indexdate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.indexdate?new $e(this.rawMetadata.indexdate):void 0}get isbn(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.isbn?new B(this.rawMetadata.isbn):void 0}get issue(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.issue?new B(this.rawMetadata.issue):void 0}get item_count(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.item_count?new de(this.rawMetadata.item_count):void 0}get item_size(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.item_size?new Gr(this.rawMetadata.item_size):void 0}get language(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.language?new B(this.rawMetadata.language):void 0}get length(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.length?new Ri(this.rawMetadata.length):void 0}get lineage(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.lineage?new B(this.rawMetadata.lineage):void 0}get month(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.month?new de(this.rawMetadata.month):void 0}get mediatype(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.mediatype?new zo(this.rawMetadata.mediatype):void 0}get noindex(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.noindex?new Co(this.rawMetadata.noindex):void 0}get notes(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.notes?new B(this.rawMetadata.notes):void 0}get num_favorites(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.num_favorites?new de(this.rawMetadata.num_favorites):void 0}get num_reviews(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.num_reviews?new de(this.rawMetadata.num_reviews):void 0}get openlibrary_edition(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.openlibrary_edition?new B(this.rawMetadata.openlibrary_edition):void 0}get openlibrary_work(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.openlibrary_work?new B(this.rawMetadata.openlibrary_work):void 0}get page_progression(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.page_progression?new _o(this.rawMetadata.page_progression):void 0}get partner(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.partner?new B(this.rawMetadata.partner):void 0}get ppi(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.ppi?new de(this.rawMetadata.ppi):void 0}get publicdate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.publicdate?new $e(this.rawMetadata.publicdate):void 0}get publisher(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.publisher?new B(this.rawMetadata.publisher):void 0}get reviewdate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.reviewdate?new $e(this.rawMetadata.reviewdate):void 0}get runtime(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.runtime?new Ri(this.rawMetadata.runtime):void 0}get scanner(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.scanner?new B(this.rawMetadata.scanner):void 0}get source(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.source?new B(this.rawMetadata.source):void 0}get start_localtime(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.start_localtime?new $e(this.rawMetadata.start_localtime):void 0}get start_time(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.start_time?new $e(this.rawMetadata.start_time):void 0}get stop_time(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.stop_time?new $e(this.rawMetadata.stop_time):void 0}get subject(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.subject?new To(this.rawMetadata.subject):void 0}get taper(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.taper?new B(this.rawMetadata.taper):void 0}get title(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.title?new B(this.rawMetadata.title):void 0}get transferer(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.transferer?new B(this.rawMetadata.transferer):void 0}get track(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.track?new de(this.rawMetadata.track):void 0}get type(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.type?new B(this.rawMetadata.type):void 0}get uploader(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.uploader?new B(this.rawMetadata.uploader):void 0}get utc_offset(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.utc_offset?new de(this.rawMetadata.utc_offset):void 0}get venue(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.venue?new B(this.rawMetadata.venue):void 0}get volume(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.volume?new B(this.rawMetadata.volume):void 0}get week(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.week?new de(this.rawMetadata.week):void 0}get year(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.year?new $e(this.rawMetadata.year):void 0}}n([w()],C.prototype,"addeddate",null);n([w()],C.prototype,"audio_codec",null);n([w()],C.prototype,"audio_sample_rate",null);n([w()],C.prototype,"avg_rating",null);n([w()],C.prototype,"collection",null);n([w()],C.prototype,"collections_raw",null);n([w()],C.prototype,"collection_size",null);n([w()],C.prototype,"contributor",null);n([w()],C.prototype,"coverage",null);n([w()],C.prototype,"creator",null);n([w()],C.prototype,"date",null);n([w()],C.prototype,"description",null);n([w()],C.prototype,"downloads",null);n([w()],C.prototype,"duration",null);n([w()],C.prototype,"external-identifier",null);n([w()],C.prototype,"files_count",null);n([w()],C.prototype,"indexdate",null);n([w()],C.prototype,"isbn",null);n([w()],C.prototype,"issue",null);n([w()],C.prototype,"item_count",null);n([w()],C.prototype,"item_size",null);n([w()],C.prototype,"language",null);n([w()],C.prototype,"length",null);n([w()],C.prototype,"lineage",null);n([w()],C.prototype,"month",null);n([w()],C.prototype,"mediatype",null);n([w()],C.prototype,"noindex",null);n([w()],C.prototype,"notes",null);n([w()],C.prototype,"num_favorites",null);n([w()],C.prototype,"num_reviews",null);n([w()],C.prototype,"openlibrary_edition",null);n([w()],C.prototype,"openlibrary_work",null);n([w()],C.prototype,"page_progression",null);n([w()],C.prototype,"partner",null);n([w()],C.prototype,"ppi",null);n([w()],C.prototype,"publicdate",null);n([w()],C.prototype,"publisher",null);n([w()],C.prototype,"reviewdate",null);n([w()],C.prototype,"runtime",null);n([w()],C.prototype,"scanner",null);n([w()],C.prototype,"source",null);n([w()],C.prototype,"start_localtime",null);n([w()],C.prototype,"start_time",null);n([w()],C.prototype,"stop_time",null);n([w()],C.prototype,"subject",null);n([w()],C.prototype,"taper",null);n([w()],C.prototype,"title",null);n([w()],C.prototype,"transferer",null);n([w()],C.prototype,"track",null);n([w()],C.prototype,"type",null);n([w()],C.prototype,"uploader",null);n([w()],C.prototype,"utc_offset",null);n([w()],C.prototype,"venue",null);n([w()],C.prototype,"volume",null);n([w()],C.prototype,"week",null);n([w()],C.prototype,"year",null);class wt{constructor(e){this.rawValue=e}get name(){return this.rawValue.name}get source(){return this.rawValue.source}get btih(){return this.rawValue.btih}get md5(){return this.rawValue.md5}get format(){return this.rawValue.format}get mtime(){return this.rawValue.mtime}get crc32(){return this.rawValue.crc32}get sha1(){return this.rawValue.sha1}get original(){return this.rawValue.original}get size(){return this.rawValue.size?si.shared.parseValue(this.rawValue.size):void 0}get title(){return this.rawValue.title}get length(){return this.rawValue.length?ni.shared.parseValue(this.rawValue.length):void 0}get height(){return this.rawValue.height?Oe.shared.parseValue(this.rawValue.height):void 0}get width(){return this.rawValue.width?Oe.shared.parseValue(this.rawValue.width):void 0}get track(){return this.rawValue.track?Oe.shared.parseValue(this.rawValue.track):void 0}get external_identifier(){return this.rawValue.external_identifier}get creator(){return this.rawValue.creator}get album(){return this.rawValue.album}}n([w()],wt.prototype,"size",null);n([w()],wt.prototype,"length",null);n([w()],wt.prototype,"height",null);n([w()],wt.prototype,"width",null);n([w()],wt.prototype,"track",null);class bi{constructor(e){this.rawValue=e}get reviewbody(){return this.rawValue.reviewbody}get reviewtitle(){return this.rawValue.reviewtitle}get reviewer(){return this.rawValue.reviewer}get reviewdate(){return this.rawValue.reviewdate?Pt.shared.parseValue(this.rawValue.reviewdate):void 0}get createdate(){return this.rawValue.createdate?Pt.shared.parseValue(this.rawValue.createdate):void 0}get stars(){return this.rawValue.stars?Oe.shared.parseValue(this.rawValue.stars):void 0}}n([w()],bi.prototype,"reviewdate",null);n([w()],bi.prototype,"createdate",null);n([w()],bi.prototype,"stars",null);class Do{constructor(e){var t,i;this.rawResponse=e,this.created=e.created,this.d1=e.d1,this.d2=e.d2,this.dir=e.dir,this.files=(t=e.files)===null||t===void 0?void 0:t.map(r=>new wt(r)),this.files_count=e.files_count,this.item_last_updated=e.item_last_updated,this.item_size=e.item_size,this.metadata=new C(e.metadata),this.server=e.server,this.uniq=e.uniq,this.workable_servers=e.workable_servers,this.speech_vs_music_asr=e.speech_vs_music_asr,this.reviews=(i=e.reviews)===null||i===void 0?void 0:i.map(r=>new bi(r))}}class Mo{constructor(e){this.numFound=e.numFound,this.start=e.start,this.docs=e.docs.map(t=>new C(t)),this.aggregations=e.aggregations}}class Ao{constructor(e){this.rawResponse=e,this.responseHeader=e.responseHeader,this.response=new Mo(e.response)}}var Ge;(function(a){a.networkError="SearchService.NetworkError",a.itemNotFound="SearchService.ItemNotFound",a.decodingError="SearchService.DecodingError",a.searchEngineError="SearchService.SearchEngineError"})(Ge||(Ge={}));class rr extends Error{constructor(e,t,i){super(t),this.name=e,this.type=e,this.details=i}}class Eo{static aggregateSearchParamsAsString(e){if(e.advancedParams){const t=e.advancedParams.map(r=>({terms:r}));return JSON.stringify(t)}if(e.simpleParams)return e.simpleParams.join(",")}static sortParamsAsString(e){return`${e.field} ${e.direction}`}static generateURLSearchParams(e){const t=new URLSearchParams;if(t.append("q",e.query),t.append("output","json"),e.rows&&t.append("rows",String(e.rows)),e.page&&t.append("page",String(e.page)),e.fields&&t.append("fl",e.fields.join(",")),e.sort){const r=e.sort.map(o=>this.sortParamsAsString(o));t.append("sort",r.join(","))}const i=e.aggregations;if(i){const r=this.aggregateSearchParamsAsString(i);r&&t.append("user_aggs",r)}return t}}class Oo{constructor(e){var t;if(this.baseUrl=(t=e==null?void 0:e.baseUrl)!==null&&t!==void 0?t:"archive.org",(e==null?void 0:e.includeCredentials)!==void 0?this.includeCredentials=e.includeCredentials:this.includeCredentials=window.location.href.match(/^https?:\/\/.*archive\.org(:[0-9]+)?/)!==null,(e==null?void 0:e.scope)!==void 0)this.requestScope=e.scope;else{const r=new URL(window.location.href).searchParams.get("scope");r&&(this.requestScope=r)}}async performSearch(e){const i=Eo.generateURLSearchParams(e).toString(),r=`https://${this.baseUrl}/advancedsearch.php?${i}`;return this.fetchUrl(r)}async fetchMetadata(e,t){const i=t?`/${t}`:"",r=`https://${this.baseUrl}/metadata/${e}${i}`;return this.fetchUrl(r,{requestOptions:{credentials:"omit"}})}async fetchUrl(e,t){var i;const r=new URL(e);this.requestScope&&r.searchParams.set("scope",this.requestScope);let o;try{const s=(i=t==null?void 0:t.requestOptions)!==null&&i!==void 0?i:{credentials:this.includeCredentials?"include":"same-origin"};o=await fetch(r.href,s)}catch(s){const l=s instanceof Error?s.message:typeof s=="string"?s:"Unknown error";return this.getErrorResult(Ge.networkError,l)}try{const s=await o.json(),l=s.error;if(l){const c=s.forensics;return this.getErrorResult(Ge.searchEngineError,l,c)}else return{success:s}}catch(s){const l=s instanceof Error?s.message:typeof s=="string"?s:"Unknown error";return this.getErrorResult(Ge.decodingError,l)}}getErrorResult(e,t,i){return{error:new rr(e,t,i)}}}class ar{constructor(e){this.searchBackend=e}async search(e){const t=await this.searchBackend.performSearch(e);return t.error?t:{success:new Ao(t.success)}}async fetchMetadata(e){var t;const i=await this.searchBackend.fetchMetadata(e);return i.error?i:((t=i.success)===null||t===void 0?void 0:t.metadata)===void 0?{error:new rr(Ge.itemNotFound)}:{success:new Do(i.success)}}async fetchMetadataValue(e,t){var i;const r=await this.searchBackend.fetchMetadata(e,t);return r.error?r:((i=r.success)===null||i===void 0?void 0:i.result)===void 0?{error:new rr(Ge.itemNotFound)}:{success:r.success.result}}}ar.default=new ar(new Oo);function Lo(){var a=!navigator.userAgentData&&/Safari\//.test(navigator.userAgent)&&!/Chrom(e|ium)\//.test(navigator.userAgent);if(!a||!indexedDB.databases)return Promise.resolve();var e;return new Promise(function(t){var i=function(){return indexedDB.databases().finally(t)};e=setInterval(i,100),i()}).finally(function(){return clearInterval(e)})}function xt(a){return new Promise((e,t)=>{a.oncomplete=a.onsuccess=()=>e(a.result),a.onabort=a.onerror=()=>t(a.error)})}function Io(a,e){const t=Lo().then(()=>{const i=indexedDB.open(a);return i.onupgradeneeded=()=>i.result.createObjectStore(e),xt(i)});return(i,r)=>t.then(o=>r(o.transaction(e,i).objectStore(e)))}let Ni;function wi(){return Ni||(Ni=Io("keyval-store","keyval")),Ni}function Fo(a,e=wi()){return e("readonly",t=>xt(t.get(a)))}function Ro(a,e,t=wi()){return t("readwrite",i=>(i.put(e,a),xt(i.transaction)))}function No(a,e=wi()){return e("readwrite",t=>(t.delete(a),xt(t.transaction)))}function Po(a,e){return a.openCursor().onsuccess=function(){!this.result||(e(this.result),this.result.continue())},xt(a.transaction)}function Bo(a=wi()){return a("readonly",e=>{if(e.getAllKeys)return xt(e.getAllKeys());const t=[];return Po(e,i=>t.push(i.key)).then(()=>t)})}function Uo(a,e){return a.setMilliseconds(a.getMilliseconds()+e*1e3),a}class Ho{constructor(e){var t,i,r,o;if(this.namespace=(t=e==null?void 0:e.namespace)!==null&&t!==void 0?t:"LocalCache",this.defaultTTL=(i=e==null?void 0:e.defaultTTL)!==null&&i!==void 0?i:15*60,(!((r=e==null?void 0:e.immediateClean)!==null&&r!==void 0)||r)&&this.cleanExpired(),!(e!=null&&e.disableCleaning)){const s=(o=e==null?void 0:e.cleaningInterval)!==null&&o!==void 0?o:60;setInterval(()=>{this.cleanExpired()},s*1e3)}}async set(e){var t;const i={value:e.value},r=(t=e.ttl)!==null&&t!==void 0?t:this.defaultTTL,o=Uo(new Date,r);i.expires=o;const s=this.getNamespacedKey(e.key);try{await Ro(s,i)}catch{}}async get(e){const t=this.getNamespacedKey(e);let i;try{i=await Fo(t)}catch{}if(!i)return;const r=new Date;if(i.expires&&i.expires<r){await this.delete(e);return}return i.value}async delete(e){const t=this.getNamespacedKey(e);try{await No(t)}catch{}}async cleanExpired(){const e=await this.getAllKeys();await Promise.all(e.map(async t=>this.get(t)))}async getAllKeys(){let e=[];try{e=await Bo()}catch{}const t=[];for(const o of e)typeof o=="string"&&t.push(o);return t.filter(o=>o.startsWith(this.namespace)).map(o=>this.removeNamespace(o))}getNamespacedKey(e){return`${this.namespace}-${e}`}removeNamespace(e){return e.replace(`${this.namespace}-`,"")}}/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const yr=window.ShadowRoot&&(window.ShadyCSS===void 0||window.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,br=Symbol(),Yr=new Map;class Ea{constructor(e,t){if(this._$cssResult$=!0,t!==br)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e}get styleSheet(){let e=Yr.get(this.cssText);return yr&&e===void 0&&(Yr.set(this.cssText,e=new CSSStyleSheet),e.replaceSync(this.cssText)),e}toString(){return this.cssText}}const Vo=a=>new Ea(typeof a=="string"?a:a+"",br),y=(a,...e)=>{const t=a.length===1?a[0]:e.reduce((i,r,o)=>i+(s=>{if(s._$cssResult$===!0)return s.cssText;if(typeof s=="number")return s;throw Error("Value passed to 'css' function must be a 'css' function result: "+s+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(r)+a[o+1],a[0]);return new Ea(t,br)},Wo=(a,e)=>{yr?a.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet):e.forEach(t=>{const i=document.createElement("style"),r=window.litNonce;r!==void 0&&i.setAttribute("nonce",r),i.textContent=t.cssText,a.appendChild(i)})},Kr=yr?a=>a:a=>a instanceof CSSStyleSheet?(e=>{let t="";for(const i of e.cssRules)t+=i.cssText;return Vo(t)})(a):a;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Pi;const qr=window.trustedTypes,jo=qr?qr.emptyScript:"",Xr=window.reactiveElementPolyfillSupport,or={toAttribute(a,e){switch(e){case Boolean:a=a?jo:null;break;case Object:case Array:a=a==null?a:JSON.stringify(a)}return a},fromAttribute(a,e){let t=a;switch(e){case Boolean:t=a!==null;break;case Number:t=a===null?null:Number(a);break;case Object:case Array:try{t=JSON.parse(a)}catch{t=null}}return t}},Oa=(a,e)=>e!==a&&(e==e||a==a),Bi={attribute:!0,type:String,converter:or,reflect:!1,hasChanged:Oa};class lt extends HTMLElement{constructor(){super(),this._$Et=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Ei=null,this.o()}static addInitializer(e){var t;(t=this.l)!==null&&t!==void 0||(this.l=[]),this.l.push(e)}static get observedAttributes(){this.finalize();const e=[];return this.elementProperties.forEach((t,i)=>{const r=this._$Eh(i,t);r!==void 0&&(this._$Eu.set(r,i),e.push(r))}),e}static createProperty(e,t=Bi){if(t.state&&(t.attribute=!1),this.finalize(),this.elementProperties.set(e,t),!t.noAccessor&&!this.prototype.hasOwnProperty(e)){const i=typeof e=="symbol"?Symbol():"__"+e,r=this.getPropertyDescriptor(e,i,t);r!==void 0&&Object.defineProperty(this.prototype,e,r)}}static getPropertyDescriptor(e,t,i){return{get(){return this[t]},set(r){const o=this[e];this[t]=r,this.requestUpdate(e,o,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)||Bi}static finalize(){if(this.hasOwnProperty("finalized"))return!1;this.finalized=!0;const e=Object.getPrototypeOf(this);if(e.finalize(),this.elementProperties=new Map(e.elementProperties),this._$Eu=new Map,this.hasOwnProperty("properties")){const t=this.properties,i=[...Object.getOwnPropertyNames(t),...Object.getOwnPropertySymbols(t)];for(const r of i)this.createProperty(r,t[r])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const i=new Set(e.flat(1/0).reverse());for(const r of i)t.unshift(Kr(r))}else e!==void 0&&t.push(Kr(e));return t}static _$Eh(e,t){const i=t.attribute;return i===!1?void 0:typeof i=="string"?i:typeof e=="string"?e.toLowerCase():void 0}o(){var e;this._$Ep=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$Em(),this.requestUpdate(),(e=this.constructor.l)===null||e===void 0||e.forEach(t=>t(this))}addController(e){var t,i;((t=this._$Eg)!==null&&t!==void 0?t:this._$Eg=[]).push(e),this.renderRoot!==void 0&&this.isConnected&&((i=e.hostConnected)===null||i===void 0||i.call(e))}removeController(e){var t;(t=this._$Eg)===null||t===void 0||t.splice(this._$Eg.indexOf(e)>>>0,1)}_$Em(){this.constructor.elementProperties.forEach((e,t)=>{this.hasOwnProperty(t)&&(this._$Et.set(t,this[t]),delete this[t])})}createRenderRoot(){var e;const t=(e=this.shadowRoot)!==null&&e!==void 0?e:this.attachShadow(this.constructor.shadowRootOptions);return Wo(t,this.constructor.elementStyles),t}connectedCallback(){var e;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$Eg)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostConnected)===null||i===void 0?void 0:i.call(t)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$Eg)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostDisconnected)===null||i===void 0?void 0:i.call(t)})}attributeChangedCallback(e,t,i){this._$AK(e,i)}_$ES(e,t,i=Bi){var r,o;const s=this.constructor._$Eh(e,i);if(s!==void 0&&i.reflect===!0){const l=((o=(r=i.converter)===null||r===void 0?void 0:r.toAttribute)!==null&&o!==void 0?o:or.toAttribute)(t,i.type);this._$Ei=e,l==null?this.removeAttribute(s):this.setAttribute(s,l),this._$Ei=null}}_$AK(e,t){var i,r,o;const s=this.constructor,l=s._$Eu.get(e);if(l!==void 0&&this._$Ei!==l){const c=s.getPropertyOptions(l),h=c.converter,u=(o=(r=(i=h)===null||i===void 0?void 0:i.fromAttribute)!==null&&r!==void 0?r:typeof h=="function"?h:null)!==null&&o!==void 0?o:or.fromAttribute;this._$Ei=l,this[l]=u(t,c.type),this._$Ei=null}}requestUpdate(e,t,i){let r=!0;e!==void 0&&(((i=i||this.constructor.getPropertyOptions(e)).hasChanged||Oa)(this[e],t)?(this._$AL.has(e)||this._$AL.set(e,t),i.reflect===!0&&this._$Ei!==e&&(this._$EC===void 0&&(this._$EC=new Map),this._$EC.set(e,i))):r=!1),!this.isUpdatePending&&r&&(this._$Ep=this._$E_())}async _$E_(){this.isUpdatePending=!0;try{await this._$Ep}catch(t){Promise.reject(t)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var e;if(!this.isUpdatePending)return;this.hasUpdated,this._$Et&&(this._$Et.forEach((r,o)=>this[o]=r),this._$Et=void 0);let t=!1;const i=this._$AL;try{t=this.shouldUpdate(i),t?(this.willUpdate(i),(e=this._$Eg)===null||e===void 0||e.forEach(r=>{var o;return(o=r.hostUpdate)===null||o===void 0?void 0:o.call(r)}),this.update(i)):this._$EU()}catch(r){throw t=!1,this._$EU(),r}t&&this._$AE(i)}willUpdate(e){}_$AE(e){var t;(t=this._$Eg)===null||t===void 0||t.forEach(i=>{var r;return(r=i.hostUpdated)===null||r===void 0?void 0:r.call(i)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EU(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$Ep}shouldUpdate(e){return!0}update(e){this._$EC!==void 0&&(this._$EC.forEach((t,i)=>this._$ES(i,this[i],t)),this._$EC=void 0),this._$EU()}updated(e){}firstUpdated(e){}}lt.finalized=!0,lt.elementProperties=new Map,lt.elementStyles=[],lt.shadowRootOptions={mode:"open"},Xr==null||Xr({ReactiveElement:lt}),((Pi=globalThis.reactiveElementVersions)!==null&&Pi!==void 0?Pi:globalThis.reactiveElementVersions=[]).push("1.3.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Ui;const ft=globalThis.trustedTypes,Zr=ft?ft.createPolicy("lit-html",{createHTML:a=>a}):void 0,_e=`lit$${(Math.random()+"").slice(9)}$`,wr="?"+_e,Qo=`<${wr}>`,vt=document,Bt=(a="")=>vt.createComment(a),Ut=a=>a===null||typeof a!="object"&&typeof a!="function",La=Array.isArray,Ia=a=>{var e;return La(a)||typeof((e=a)===null||e===void 0?void 0:e[Symbol.iterator])=="function"},Ot=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Jr=/-->/g,ea=/>/g,Ue=/>|[ 	\n\r](?:([^\s"'>=/]+)([ 	\n\r]*=[ 	\n\r]*(?:[^ 	\n\r"'`<>=]|("|')|))|$)/g,ta=/'/g,ia=/"/g,Fa=/^(?:script|style|textarea|title)$/i,Ra=a=>(e,...t)=>({_$litType$:a,strings:e,values:t}),m=Ra(1),O=Ra(2),ne=Symbol.for("lit-noChange"),$=Symbol.for("lit-nothing"),ra=new WeakMap,ti=(a,e,t)=>{var i,r;const o=(i=t==null?void 0:t.renderBefore)!==null&&i!==void 0?i:e;let s=o._$litPart$;if(s===void 0){const l=(r=t==null?void 0:t.renderBefore)!==null&&r!==void 0?r:null;o._$litPart$=s=new St(e.insertBefore(Bt(),l),l,void 0,t!=null?t:{})}return s._$AI(a),s},ut=vt.createTreeWalker(vt,129,null,!1),Na=(a,e)=>{const t=a.length-1,i=[];let r,o=e===2?"<svg>":"",s=Ot;for(let c=0;c<t;c++){const h=a[c];let u,f,g=-1,b=0;for(;b<h.length&&(s.lastIndex=b,f=s.exec(h),f!==null);)b=s.lastIndex,s===Ot?f[1]==="!--"?s=Jr:f[1]!==void 0?s=ea:f[2]!==void 0?(Fa.test(f[2])&&(r=RegExp("</"+f[2],"g")),s=Ue):f[3]!==void 0&&(s=Ue):s===Ue?f[0]===">"?(s=r!=null?r:Ot,g=-1):f[1]===void 0?g=-2:(g=s.lastIndex-f[2].length,u=f[1],s=f[3]===void 0?Ue:f[3]==='"'?ia:ta):s===ia||s===ta?s=Ue:s===Jr||s===ea?s=Ot:(s=Ue,r=void 0);const S=s===Ue&&a[c+1].startsWith("/>")?" ":"";o+=s===Ot?h+Qo:g>=0?(i.push(u),h.slice(0,g)+"$lit$"+h.slice(g)+_e+S):h+_e+(g===-2?(i.push(void 0),c):S)}const l=o+(a[t]||"<?>")+(e===2?"</svg>":"");if(!Array.isArray(a)||!a.hasOwnProperty("raw"))throw Error("invalid template strings array");return[Zr!==void 0?Zr.createHTML(l):l,i]};class Ht{constructor({strings:e,_$litType$:t},i){let r;this.parts=[];let o=0,s=0;const l=e.length-1,c=this.parts,[h,u]=Na(e,t);if(this.el=Ht.createElement(h,i),ut.currentNode=this.el.content,t===2){const f=this.el.content,g=f.firstChild;g.remove(),f.append(...g.childNodes)}for(;(r=ut.nextNode())!==null&&c.length<l;){if(r.nodeType===1){if(r.hasAttributes()){const f=[];for(const g of r.getAttributeNames())if(g.endsWith("$lit$")||g.startsWith(_e)){const b=u[s++];if(f.push(g),b!==void 0){const S=r.getAttribute(b.toLowerCase()+"$lit$").split(_e),z=/([.?@])?(.*)/.exec(b);c.push({type:1,index:o,name:z[2],strings:S,ctor:z[1]==="."?Ba:z[1]==="?"?Ua:z[1]==="@"?Ha:jt})}else c.push({type:6,index:o})}for(const g of f)r.removeAttribute(g)}if(Fa.test(r.tagName)){const f=r.textContent.split(_e),g=f.length-1;if(g>0){r.textContent=ft?ft.emptyScript:"";for(let b=0;b<g;b++)r.append(f[b],Bt()),ut.nextNode(),c.push({type:2,index:++o});r.append(f[g],Bt())}}}else if(r.nodeType===8)if(r.data===wr)c.push({type:2,index:o});else{let f=-1;for(;(f=r.data.indexOf(_e,f+1))!==-1;)c.push({type:7,index:o}),f+=_e.length-1}o++}}static createElement(e,t){const i=vt.createElement("template");return i.innerHTML=e,i}}function Ke(a,e,t=a,i){var r,o,s,l;if(e===ne)return e;let c=i!==void 0?(r=t._$Cl)===null||r===void 0?void 0:r[i]:t._$Cu;const h=Ut(e)?void 0:e._$litDirective$;return(c==null?void 0:c.constructor)!==h&&((o=c==null?void 0:c._$AO)===null||o===void 0||o.call(c,!1),h===void 0?c=void 0:(c=new h(a),c._$AT(a,t,i)),i!==void 0?((s=(l=t)._$Cl)!==null&&s!==void 0?s:l._$Cl=[])[i]=c:t._$Cu=c),c!==void 0&&(e=Ke(a,c._$AS(a,e.values),c,i)),e}class Pa{constructor(e,t){this.v=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}p(e){var t;const{el:{content:i},parts:r}=this._$AD,o=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:vt).importNode(i,!0);ut.currentNode=o;let s=ut.nextNode(),l=0,c=0,h=r[0];for(;h!==void 0;){if(l===h.index){let u;h.type===2?u=new St(s,s.nextSibling,this,e):h.type===1?u=new h.ctor(s,h.name,h.strings,this,e):h.type===6&&(u=new Va(s,this,e)),this.v.push(u),h=r[++c]}l!==(h==null?void 0:h.index)&&(s=ut.nextNode(),l++)}return o}m(e){let t=0;for(const i of this.v)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class St{constructor(e,t,i,r){var o;this.type=2,this._$AH=$,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=r,this._$Cg=(o=r==null?void 0:r.isConnected)===null||o===void 0||o}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cg}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&e.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Ke(this,e,t),Ut(e)?e===$||e==null||e===""?(this._$AH!==$&&this._$AR(),this._$AH=$):e!==this._$AH&&e!==ne&&this.$(e):e._$litType$!==void 0?this.T(e):e.nodeType!==void 0?this.k(e):Ia(e)?this.S(e):this.$(e)}M(e,t=this._$AB){return this._$AA.parentNode.insertBefore(e,t)}k(e){this._$AH!==e&&(this._$AR(),this._$AH=this.M(e))}$(e){this._$AH!==$&&Ut(this._$AH)?this._$AA.nextSibling.data=e:this.k(vt.createTextNode(e)),this._$AH=e}T(e){var t;const{values:i,_$litType$:r}=e,o=typeof r=="number"?this._$AC(e):(r.el===void 0&&(r.el=Ht.createElement(r.h,this.options)),r);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===o)this._$AH.m(i);else{const s=new Pa(o,this),l=s.p(this.options);s.m(i),this.k(l),this._$AH=s}}_$AC(e){let t=ra.get(e.strings);return t===void 0&&ra.set(e.strings,t=new Ht(e)),t}S(e){La(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,r=0;for(const o of e)r===t.length?t.push(i=new St(this.M(Bt()),this.M(Bt()),this,this.options)):i=t[r],i._$AI(o),r++;r<t.length&&(this._$AR(i&&i._$AB.nextSibling,r),t.length=r)}_$AR(e=this._$AA.nextSibling,t){var i;for((i=this._$AP)===null||i===void 0||i.call(this,!1,!0,t);e&&e!==this._$AB;){const r=e.nextSibling;e.remove(),e=r}}setConnected(e){var t;this._$AM===void 0&&(this._$Cg=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}}class jt{constructor(e,t,i,r,o){this.type=1,this._$AH=$,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=o,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=$}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,i,r){const o=this.strings;let s=!1;if(o===void 0)e=Ke(this,e,t,0),s=!Ut(e)||e!==this._$AH&&e!==ne,s&&(this._$AH=e);else{const l=e;let c,h;for(e=o[0],c=0;c<o.length-1;c++)h=Ke(this,l[i+c],t,c),h===ne&&(h=this._$AH[c]),s||(s=!Ut(h)||h!==this._$AH[c]),h===$?e=$:e!==$&&(e+=(h!=null?h:"")+o[c+1]),this._$AH[c]=h}s&&!r&&this.C(e)}C(e){e===$?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e!=null?e:"")}}class Ba extends jt{constructor(){super(...arguments),this.type=3}C(e){this.element[this.name]=e===$?void 0:e}}const Go=ft?ft.emptyScript:"";class Ua extends jt{constructor(){super(...arguments),this.type=4}C(e){e&&e!==$?this.element.setAttribute(this.name,Go):this.element.removeAttribute(this.name)}}class Ha extends jt{constructor(e,t,i,r,o){super(e,t,i,r,o),this.type=5}_$AI(e,t=this){var i;if((e=(i=Ke(this,e,t,0))!==null&&i!==void 0?i:$)===ne)return;const r=this._$AH,o=e===$&&r!==$||e.capture!==r.capture||e.once!==r.once||e.passive!==r.passive,s=e!==$&&(r===$||o);o&&this.element.removeEventListener(this.name,this,r),s&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,i;typeof this._$AH=="function"?this._$AH.call((i=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&i!==void 0?i:this.element,e):this._$AH.handleEvent(e)}}class Va{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){Ke(this,e)}}const Yo={L:"$lit$",P:_e,V:wr,I:1,N:Na,R:Pa,j:Ia,D:Ke,H:St,F:jt,O:Ua,W:Ha,B:Ba,Z:Va},aa=window.litHtmlPolyfillSupport;aa==null||aa(Ht,St),((Ui=globalThis.litHtmlVersions)!==null&&Ui!==void 0?Ui:globalThis.litHtmlVersions=[]).push("2.2.4");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Hi,Vi;class L extends lt{constructor(){super(...arguments),this.renderOptions={host:this},this._$Dt=void 0}createRenderRoot(){var e,t;const i=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=i.firstChild),i}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Dt=ti(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Dt)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Dt)===null||e===void 0||e.setConnected(!1)}render(){return ne}}L.finalized=!0,L._$litElement$=!0,(Hi=globalThis.litElementHydrateSupport)===null||Hi===void 0||Hi.call(globalThis,{LitElement:L});const oa=globalThis.litElementPolyfillSupport;oa==null||oa({LitElement:L});((Vi=globalThis.litElementVersions)!==null&&Vi!==void 0?Vi:globalThis.litElementVersions=[]).push("3.2.0");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ko=(a,e)=>e.kind==="method"&&e.descriptor&&!("value"in e.descriptor)?Et(ge({},e),{finisher(t){t.createProperty(e.key,a)}}):{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){typeof e.initializer=="function"&&(this[e.key]=e.initializer.call(this))},finisher(t){t.createProperty(e.key,a)}};function p(a){return(e,t)=>t!==void 0?((i,r,o)=>{r.constructor.createProperty(o,i)})(a,e,t):Ko(a,e)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function T(a){return p(Et(ge({},a),{state:!0}))}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Wa=({finisher:a,descriptor:e})=>(t,i)=>{var r;if(i===void 0){const o=(r=t.originalKey)!==null&&r!==void 0?r:t.key,s=e!=null?{kind:"method",placement:"prototype",key:o,descriptor:e(t.key)}:Et(ge({},t),{key:o});return a!=null&&(s.finisher=function(l){a(l,o)}),s}{const o=t.constructor;e!==void 0&&Object.defineProperty(t,i,e(i)),a==null||a(o,i)}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ce={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Si=a=>(...e)=>({_$litDirective$:a,values:e});class $i{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{H:Jo}=Yo,es=a=>a.strings===void 0,sa=()=>document.createComment(""),Lt=(a,e,t)=>{var i;const r=a._$AA.parentNode,o=e===void 0?a._$AB:e._$AA;if(t===void 0){const s=r.insertBefore(sa(),o),l=r.insertBefore(sa(),o);t=new Jo(s,l,a,a.options)}else{const s=t._$AB.nextSibling,l=t._$AM,c=l!==a;if(c){let h;(i=t._$AQ)===null||i===void 0||i.call(t,a),t._$AM=a,t._$AP!==void 0&&(h=a._$AU)!==l._$AU&&t._$AP(h)}if(s!==o||c){let h=t._$AA;for(;h!==s;){const u=h.nextSibling;r.insertBefore(h,o),h=u}}}return t},He=(a,e,t=a)=>(a._$AI(e,t),a),ts={},ja=(a,e=ts)=>a._$AH=e,is=a=>a._$AH,ji=a=>{var e;(e=a._$AP)===null||e===void 0||e.call(a,!1,!0);let t=a._$AA;const i=a._$AB.nextSibling;for(;t!==i;){const r=t.nextSibling;t.remove(),t=r}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const na=(a,e,t)=>{const i=new Map;for(let r=e;r<=t;r++)i.set(a[r],r);return i},Qa=Si(class extends $i{constructor(a){if(super(a),a.type!==Ce.CHILD)throw Error("repeat() can only be used in text expressions")}dt(a,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);const r=[],o=[];let s=0;for(const l of a)r[s]=i?i(l,s):s,o[s]=t(l,s),s++;return{values:o,keys:r}}render(a,e,t){return this.dt(a,e,t).values}update(a,[e,t,i]){var r;const o=is(a),{values:s,keys:l}=this.dt(e,t,i);if(!Array.isArray(o))return this.ut=l,s;const c=(r=this.ut)!==null&&r!==void 0?r:this.ut=[],h=[];let u,f,g=0,b=o.length-1,S=0,z=s.length-1;for(;g<=b&&S<=z;)if(o[g]===null)g++;else if(o[b]===null)b--;else if(c[g]===l[S])h[S]=He(o[g],s[S]),g++,S++;else if(c[b]===l[z])h[z]=He(o[b],s[z]),b--,z--;else if(c[g]===l[z])h[z]=He(o[g],s[z]),Lt(a,h[z+1],o[g]),g++,z--;else if(c[b]===l[S])h[S]=He(o[b],s[S]),Lt(a,o[g],o[b]),b--,S++;else if(u===void 0&&(u=na(l,S,z),f=na(c,g,b)),u.has(c[g]))if(u.has(c[b])){const E=f.get(l[S]),A=E!==void 0?o[E]:null;if(A===null){const F=Lt(a,o[g]);He(F,s[S]),h[S]=F}else h[S]=He(A,s[S]),Lt(a,o[g],A),o[E]=null;S++}else ji(o[b]),b--;else ji(o[g]),g++;for(;S<=z;){const E=Lt(a,h[z+1]);He(E,s[S]),h[S++]=E}for(;g<=b;){const E=o[g++];E!==null&&ji(E)}return this.ut=l,ja(a,h),ne}});function Xt(a,e,t){return Array.from({length:(e-a)/t+1},(i,r)=>a+r*t)}let Ie=class extends L{constructor(){super(...arguments),this.itemCount=0,this.scrollOptimizationsDisabled=!1,this.intersectionObserver=new IntersectionObserver(e=>{e.forEach(t=>{if(t.target===this.sentinel){t.isIntersecting&&this.dispatchEvent(new Event("scrollThresholdReached"));return}const r=t.target.dataset.cellIndex;if(!r)return;const o=parseInt(r,10);t.isIntersecting?this.visibleCellIndices.add(o):this.visibleCellIndices.delete(o)}),this.scrollOptimizationsDisabled||this.processVisibleCells()}),this.renderedCellIndices=new Set,this.visibleCellIndices=new Set,this.placeholderCellIndices=new Set}reload(){Xt(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.removeCell(t)),this.renderedCellIndices.clear(),this.visibleCellIndices.clear(),this.placeholderCellIndices.clear(),this.setupObservations()}scrollToCell(e,t){const i=this.cellContainers[e];if(!i)return!1;const r=t?"smooth":"auto";return i.scrollIntoView({behavior:r}),!0}getVisibleCellIndices(){return Array.from(this.visibleCellIndices)}updated(e){(e.has("itemCount")||e.has("scrollOptimizationsDisabled"))&&this.setupObservations()}disconnectedCallback(){this.intersectionObserver.disconnect()}setupObservations(){this.setupIntersectionObserver()}setupIntersectionObserver(){this.intersectionObserver.disconnect(),this.sentinel&&this.intersectionObserver.observe(this.sentinel),this.scrollOptimizationsDisabled?(Xt(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.visibleCellIndices.add(t)),this.processVisibleCells()):this.cellContainers.forEach(e=>this.intersectionObserver.observe(e))}render(){const e=this.itemCount-1,t=Xt(0,e,1);return m`
      <div id="container">
        <div id="sentinel"></div>
        ${Qa(t,i=>i,i=>m`
            <div
    ...
    `}};n([p({type:Number})],Ie.prototype,"itemCount",void 0);n([p({type:Object})],Ie.prototype,"cellProvider",void 0);n([p({type:Object})],Ie.prototype,"placeholderCellTemplate",void 0);n([p({type:Boolean})],Ie.prototype,"scrollOptimizationsDisabled",void 0);n([ce("#sentinel")],Ie.prototype,"sentinel",void 0);n([qo(".cell-container")],Ie.prototype,"cellContainers",void 0);Ie=n([U("infinite-scroller")],Ie);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const rs=(a,...e)=>({strTag:!0,strings:a,values:e}),nt=rs,as=a=>typeof a!="string"&&"strTag"in a,os=(a,e,t)=>{let i=a[0];for(let r=1;r<a.length;r++)i+=e[t?t[r-1]:r-1],i+=a[r];return i};/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ss=a=>as(a)?os(a.strings,a.values):a;/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;let sr=class extends L{render(){var e,t,i;return m`
      <div id="container">
    ...
    `}};n([p({type:Object})],sr.prototype,"model",void 0);sr=n([U("collection-tile")],sr);function ci(a,e="short",t="en-US"){if(!a)return"";const i={timeZone:"UTC"};switch(e){case"short":i.month="short",i.year="numeric";break;case"long":i.year="numeric",i.month="short",i.day="2-digit";break}return new Intl.DateTimeFormat(t,i).format(a)}/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const nr=Si(class extends $i{constructor(a){var e;if(super(a),a.type!==Ce.ATTRIBUTE||a.name!=="class"||((e=a.strings)===null||e===void 0?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(a){return" "+Object.keys(a).filter(e=>a[e]).join(" ")+" "}update(a,[e]){var t,i;if(this.et===void 0){this.et=new Set,a.strings!==void 0&&(this.st=new Set(a.strings.join(" ").split(/\s/).filter(o=>o!=="")));for(const o in e)e[o]&&!(!((t=this.st)===null||t===void 0)&&t.has(o))&&this.et.add(o);return this.render(e)}const r=a.element.classList;this.et.forEach(o=>{o in e||(r.remove(o),this.et.delete(o))});for(const o in e){const s=!!e[o];s===this.et.has(o)||((i=this.st)===null||i===void 0?void 0:i.has(o))||(s?(r.add(o),this.et.add(o)):(r.remove(o),this.et.delete(o)))}return ne}}),cs=O`
  <svg
    viewBox="0 0 100 100"
    xmlns="http://www.w3.org/2000/svg"
  >
...
`;let di=class extends L{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1}render(){return this.loginRequired&&!this.loggedIn?m`${ds} `:m`${cs}`}static get styles(){return y`
      :host {
        position: absolute;
        top: 50%;
        left: 50%;
    ...
    `}};n([p({type:Boolean})],di.prototype,"loggedIn",void 0);n([p({type:Boolean})],di.prototype,"loginRequired",void 0);di=n([U("icon-overlay")],di);let hi=class extends L{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1}render(){return m` <div class="overlay no-preview">${this.textDisplay}</div> `}get textDisplay(){return this.loginRequired&&!this.loggedIn?`Log in
to view this item`:"Content may be inappropriate"}static get styles(){return y`
    ...
    `}};n([p({type:Boolean})],hi.prototype,"loggedIn",void 0);n([p({type:Boolean})],hi.prototype,"loginRequired",void 0);hi=n([U("text-overlay")],hi);let ze=class extends L{constructor(){super(...arguments),this.isCompactTile=!1,this.isListTile=!1,this.hasSnippets=!1,this.loggedIn=!1,this.viewSize="desktop"}render(){var e;return!((e=this.model)===null||e===void 0)&&e.identifier?m`
      <div class=${nr(this.baseClass)}>
        <item-image
          .model=${this.model}
    ...
    `:$}get baseClass(){return{list:this.isListTile&&!this.isCompactTile,"list-compact":this.isListTile&&this.isCompactTile,"has-snippets":this.hasSnippets,[this.viewSize]:!0}}get iconOverlayTemplate(){var e,t,i;return!this.isListTile||!(!((e=this.model)===null||e===void 0)&&e.loginRequired)&&!(!((t=this.model)===null||t===void 0)&&t.contentWarning)?$:m`
      <icon-overlay
        .loggedIn=${this.loggedIn}
    ...
    `}};n([p({type:String})],ze.prototype,"baseImageUrl",void 0);n([p({type:Boolean})],ze.prototype,"isCompactTile",void 0);n([p({type:Boolean})],ze.prototype,"isListTile",void 0);n([p({type:Boolean})],ze.prototype,"hasSnippets",void 0);n([p({type:Boolean})],ze.prototype,"loggedIn",void 0);n([p({type:Object})],ze.prototype,"model",void 0);n([p({type:String})],ze.prototype,"viewSize",void 0);ze=n([U("image-block")],ze);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class lr extends $i{constructor(e){if(super(e),this.it=$,e.type!==Ce.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===$||e==null)return this.ft=void 0,this.it=e;if(e===ne)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this.ft;this.it=e;const t=[e];return t.raw=t,this.ft={_$litType$:this.constructor.resultType,strings:t,values:[]}}}lr.directiveName="unsafeHTML",lr.resultType=1;const hs=Si(lr);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*cr(a,e){if(a!==void 0){let t=0;for(const i of a)yield e(i,t++)}}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*ii(a,e){const t=typeof e=="function";if(a!==void 0){let i=-1;for(const r of a)i>-1&&(yield t?e(i):e),i++,yield r}}/*! @license DOMPurify 2.3.8 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/2.3.8/LICENSE */function Qe(a){return Qe=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},Qe(a)}function dr(a,e){return dr=Object.setPrototypeOf||function(i,r){return i.__proto__=r,i},dr(a,e)}function ps(){if(typeof Reflect=="undefined"||!Reflect.construct||Reflect.construct.sham)return!1;if(typeof Proxy=="function")return!0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],function(){})),!0}catch{return!1}}function ri(a,e,t){return ps()?ri=Reflect.construct:ri=function(r,o,s){var l=[null];l.push.apply(l,o);var c=Function.bind.apply(r,l),h=new c;return s&&dr(h,s.prototype),h},ri.apply(null,arguments)}function pe(a){return us(a)||ms(a)||fs(a)||vs()}function us(a){if(Array.isArray(a))return hr(a)}function ms(a){if(typeof Symbol!="undefined"&&a[Symbol.iterator]!=null||a["@@iterator"]!=null)return Array.from(a)}function fs(a,e){if(!!a){if(typeof a=="string")return hr(a,e);var t=Object.prototype.toString.call(a).slice(8,-1);if(t==="Object"&&a.constructor&&(t=a.constructor.name),t==="Map"||t==="Set")return Array.from(a);if(t==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t))return hr(a,e)}}function hr(a,e){(e==null||e>a.length)&&(e=a.length);for(var t=0,i=new Array(e);t<e;t++)i[t]=a[t];return i}function vs(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}var gs=Object.hasOwnProperty,la=Object.setPrototypeOf,ys=Object.isFrozen,bs=Object.getPrototypeOf,ws=Object.getOwnPropertyDescriptor,ee=Object.freeze,be=Object.seal,xs=Object.create,Ya=typeof Reflect!="undefined"&&Reflect,pi=Ya.apply,pr=Ya.construct;pi||(pi=function(e,t,i){return e.apply(t,i)});ee||(ee=function(e){return e});be||(be=function(e){return e});pr||(pr=function(e,t){return ri(e,pe(t))});var Ss=me(Array.prototype.forEach),ca=me(Array.prototype.pop),It=me(Array.prototype.push),ai=me(String.prototype.toLowerCase),$s=me(String.prototype.match),Me=me(String.prototype.replace),Cs=me(String.prototype.indexOf),_s=me(String.prototype.trim),J=me(RegExp.prototype.test),Qi=zs(TypeError);function me(a){return function(e){for(var t=arguments.length,i=new Array(t>1?t-1:0),r=1;r<t;r++)i[r-1]=arguments[r];return pi(a,e,i)}}function zs(a){return function(){for(var e=arguments.length,t=new Array(e),i=0;i<e;i++)t[i]=arguments[i];return pr(a,t)}}function D(a,e){la&&la(a,null);for(var t=e.length;t--;){var i=e[t];if(typeof i=="string"){var r=ai(i);r!==i&&(ys(e)||(e[t]=r),i=r)}a[i]=!0}return a}function Ve(a){var e=xs(null),t;for(t in a)pi(gs,a,[t])&&(e[t]=a[t]);return e}function Zt(a,e){for(;a!==null;){var t=ws(a,e);if(t){if(t.get)return me(t.get);if(typeof t.value=="function")return me(t.value)}a=bs(a)}function i(r){return console.warn("fallback value for",r),null}return i}var da=ee(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","section","select","shadow","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),Gi=ee(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","filter","font","g","glyph","glyphref","hkern","image","line","lineargradient","marker","mask","metadata","mpath","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),Yi=ee(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),ks=ee(["animate","color-profile","cursor","discard","fedropshadow","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),Ki=ee(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover"]),Ts=ee(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),ha=ee(["#text"]),pa=ee(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","face","for","headers","height","hidden","high","href","hreflang","id","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","pattern","placeholder","playsinline","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","xmlns","slot"]),qi=ee(["accent-height","accumulate","additive","alignment-baseline","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),ua=ee(["accent","accentunder","align","bevelled","close","columnsalign","columnlines","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lspace","lquote","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),Jt=ee(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),Ds=be(/\{\{[\w\W]*|[\w\W]*\}\}/gm),Ms=be(/<%[\w\W]*|[\w\W]*%>/gm),As=be(/^data-[\-\w.\u00B7-\uFFFF]/),Es=be(/^aria-[\-\w]+$/),Os=be(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|cid|xmpp):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),Ls=be(/^(?:\w+script|data):/i),Is=be(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),Fs=be(/^html$/i),Rs=function(){return typeof window=="undefined"?null:window},Ns=function(e,t){if(Qe(e)!=="object"||typeof e.createPolicy!="function")return null;var i=null,r="data-tt-policy-suffix";t.currentScript&&t.currentScript.hasAttribute(r)&&(i=t.currentScript.getAttribute(r));var o="dompurify"+(i?"#"+i:"");try{return e.createPolicy(o,{createHTML:function(l){return l}})}catch{return console.warn("TrustedTypes policy "+o+" could not be created."),null}};function Ka(){var a=arguments.length>0&&arguments[0]!==void 0?arguments[0]:Rs(),e=function(d){return Ka(d)};if(e.version="2.3.8",e.removed=[],!a||!a.document||a.document.nodeType!==9)return e.isSupported=!1,e;var t=a.document,i=a.document,r=a.DocumentFragment,o=a.HTMLTemplateElement,s=a.Node,l=a.Element,c=a.NodeFilter,h=a.NamedNodeMap,u=h===void 0?a.NamedNodeMap||a.MozNamedAttrMap:h,f=a.HTMLFormElement,g=a.DOMParser,b=a.trustedTypes,S=l.prototype,z=Zt(S,"cloneNode"),E=Zt(S,"nextSibling"),A=Zt(S,"childNodes"),F=Zt(S,"parentNode");if(typeof o=="function"){var I=i.createElement("template");I.content&&I.content.ownerDocument&&(i=I.content.ownerDocument)}var N=Ns(b,t),K=N?N.createHTML(""):"",se=i,ve=se.implementation,$t=se.createNodeIterator,Ct=se.createDocumentFragment,_t=se.getElementsByTagName,zt=t.importNode,Xe={};try{Xe=Ve(i).documentMode?i.documentMode:{}}catch{}var te={};e.isSupported=typeof F=="function"&&ve&&typeof ve.createHTMLDocument!="undefined"&&Xe!==9;var Fe=Ds,Re=Ms,kt=As,Tt=Es,Dt=Ls,Ze=Is,Ne=Os,W=null,Je=D({},[].concat(pe(da),pe(Gi),pe(Yi),pe(Ki),pe(ha))),j=null,et=D({},[].concat(pe(pa),pe(qi),pe(ua),pe(Jt))),H=Object.seal(Object.create(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),Te=null,_i=null,zr=!0,zi=!0,kr=!1,tt=!1,Pe=!1,ki=!1,Ti=!1,it=!1,Qt=!1,Gt=!1,Tr=!0,Di=!0,Mt=!1,rt={},at=null,Dr=D({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","style","svg","template","thead","title","video","xmp"]),Mr=null,Ar=D({},["audio","video","img","source","image","track"]),Mi=null,Er=D({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),Ai="http://www.w3.org/1998/Math/MathML",Ei="http://www.w3.org/2000/svg",De="http://www.w3.org/1999/xhtml",Yt=De,Oi=!1,ot,lo=["application/xhtml+xml","text/html"],co="text/html",Be,st=null,ho=i.createElement("form"),Or=function(d){return d instanceof RegExp||d instanceof Function},Li=function(d){st&&st===d||((!d||Qe(d)!=="object")&&(d={}),d=Ve(d),W="ALLOWED_TAGS"in d?D({},d.ALLOWED_TAGS):Je,j="ALLOWED_ATTR"in d?D({},d.ALLOWED_ATTR):et,Mi="ADD_URI_SAFE_ATTR"in d?D(Ve(Er),d.ADD_URI_SAFE_ATTR):Er,Mr="ADD_DATA_URI_TAGS"in d?D(Ve(Ar),d.ADD_DATA_URI_TAGS):Ar,at="FORBID_CONTENTS"in d?D({},d.FORBID_CONTENTS):Dr,Te="FORBID_TAGS"in d?D({},d.FORBID_TAGS):{},_i="FORBID_ATTR"in d?D({},d.FORBID_ATTR):{},rt="USE_PROFILES"in d?d.USE_PROFILES:!1,zr=d.ALLOW_ARIA_ATTR!==!1,zi=d.ALLOW_DATA_ATTR!==!1,kr=d.ALLOW_UNKNOWN_PROTOCOLS||!1,tt=d.SAFE_FOR_TEMPLATES||!1,Pe=d.WHOLE_DOCUMENT||!1,it=d.RETURN_DOM||!1,Qt=d.RETURN_DOM_FRAGMENT||!1,Gt=d.RETURN_TRUSTED_TYPE||!1,Ti=d.FORCE_BODY||!1,Tr=d.SANITIZE_DOM!==!1,Di=d.KEEP_CONTENT!==!1,Mt=d.IN_PLACE||!1,Ne=d.ALLOWED_URI_REGEXP||Ne,Yt=d.NAMESPACE||De,d.CUSTOM_ELEMENT_HANDLING&&Or(d.CUSTOM_ELEMENT_HANDLING.tagNameCheck)&&(H.tagNameCheck=d.CUSTOM_ELEMENT_HANDLING.tagNameCheck),d.CUSTOM_ELEMENT_HANDLING&&Or(d.CUSTOM_ELEMENT_HANDLING.attributeNameCheck)&&(H.attributeNameCheck=d.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),d.CUSTOM_ELEMENT_HANDLING&&typeof d.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements=="boolean"&&(H.allowCustomizedBuiltInElements=d.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements),ot=lo.indexOf(d.PARSER_MEDIA_TYPE)===-1?ot=co:ot=d.PARSER_MEDIA_TYPE,Be=ot==="application/xhtml+xml"?function(v){return v}:ai,tt&&(zi=!1),Qt&&(it=!0),rt&&(W=D({},pe(ha)),j=[],rt.html===!0&&(D(W,da),D(j,pa)),rt.svg===!0&&(D(W,Gi),D(j,qi),D(j,Jt)),rt.svgFilters===!0&&(D(W,Yi),D(j,qi),D(j,Jt)),rt.mathMl===!0&&(D(W,Ki),D(j,ua),D(j,Jt))),d.ADD_TAGS&&(W===Je&&(W=Ve(W)),D(W,d.ADD_TAGS)),d.ADD_ATTR&&(j===et&&(j=Ve(j)),D(j,d.ADD_ATTR)),d.ADD_URI_SAFE_ATTR&&D(Mi,d.ADD_URI_SAFE_ATTR),d.FORBID_CONTENTS&&(at===Dr&&(at=Ve(at)),D(at,d.FORBID_CONTENTS)),Di&&(W["#text"]=!0),Pe&&D(W,["html","head","body"]),W.table&&(D(W,["tbody"]),delete Te.tbody),ee&&ee(d),st=d)},Lr=D({},["mi","mo","mn","ms","mtext"]),Ir=D({},["foreignobject","desc","title","annotation-xml"]),po=D({},["title","style","font","a","script"]),Kt=D({},Gi);D(Kt,Yi),D(Kt,ks);var Ii=D({},Ki);D(Ii,Ts);var uo=function(d){var v=F(d);(!v||!v.tagName)&&(v={namespaceURI:De,tagName:"template"});var x=ai(d.tagName),R=ai(v.tagName);return d.namespaceURI===Ei?v.namespaceURI===De?x==="svg":v.namespaceURI===Ai?x==="svg"&&(R==="annotation-xml"||Lr[R]):Boolean(Kt[x]):d.namespaceURI===Ai?v.namespaceURI===De?x==="math":v.namespaceURI===Ei?x==="math"&&Ir[R]:Boolean(Ii[x]):d.namespaceURI===De?v.namespaceURI===Ei&&!Ir[R]||v.namespaceURI===Ai&&!Lr[R]?!1:!Ii[x]&&(po[x]||!Kt[x]):!1},xe=function(d){It(e.removed,{element:d});try{d.parentNode.removeChild(d)}catch{try{d.outerHTML=K}catch{d.remove()}}},Fr=function(d,v){try{It(e.removed,{attribute:v.getAttributeNode(d),from:v})}catch{It(e.removed,{attribute:null,from:v})}if(v.removeAttribute(d),d==="is"&&!j[d])if(it||Qt)try{xe(v)}catch{}else try{v.setAttribute(d,"")}catch{}},Rr=function(d){var v,x;if(Ti)d="<remove></remove>"+d;else{var R=$s(d,/^[\r\n\t ]+/);x=R&&R[0]}ot==="application/xhtml+xml"&&(d='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+d+"</body></html>");var ie=N?N.createHTML(d):d;if(Yt===De)try{v=new g().parseFromString(ie,ot)}catch{}if(!v||!v.documentElement){v=ve.createDocument(Yt,"template",null);try{v.documentElement.innerHTML=Oi?"":ie}catch{}}var X=v.body||v.documentElement;return d&&x&&X.insertBefore(i.createTextNode(x),X.childNodes[0]||null),Yt===De?_t.call(v,Pe?"html":"body")[0]:Pe?v.documentElement:X},Nr=function(d){return $t.call(d.ownerDocument||d,d,c.SHOW_ELEMENT|c.SHOW_COMMENT|c.SHOW_TEXT,null,!1)},mo=function(d){return d instanceof f&&(typeof d.nodeName!="string"||typeof d.textContent!="string"||typeof d.removeChild!="function"||!(d.attributes instanceof u)||typeof d.removeAttribute!="function"||typeof d.setAttribute!="function"||typeof d.namespaceURI!="string"||typeof d.insertBefore!="function")},At=function(d){return Qe(s)==="object"?d instanceof s:d&&Qe(d)==="object"&&typeof d.nodeType=="number"&&typeof d.nodeName=="string"},Se=function(d,v,x){!te[d]||Ss(te[d],function(R){R.call(e,v,x,st)})},Pr=function(d){var v;if(Se("beforeSanitizeElements",d,null),mo(d)||J(/[\u0080-\uFFFF]/,d.nodeName))return xe(d),!0;var x=Be(d.nodeName);if(Se("uponSanitizeElement",d,{tagName:x,allowedTags:W}),d.hasChildNodes()&&!At(d.firstElementChild)&&(!At(d.content)||!At(d.content.firstElementChild))&&J(/<[/\w]/g,d.innerHTML)&&J(/<[/\w]/g,d.textContent)||x==="select"&&J(/<template/i,d.innerHTML))return xe(d),!0;if(!W[x]||Te[x]){if(!Te[x]&&Ur(x)&&(H.tagNameCheck instanceof RegExp&&J(H.tagNameCheck,x)||H.tagNameCheck instanceof Function&&H.tagNameCheck(x)))return!1;if(Di&&!at[x]){var R=F(d)||d.parentNode,ie=A(d)||d.childNodes;if(ie&&R)for(var X=ie.length,q=X-1;q>=0;--q)R.insertBefore(z(ie[q],!0),E(d))}return xe(d),!0}return d instanceof l&&!uo(d)||(x==="noscript"||x==="noembed")&&J(/<\/no(script|embed)/i,d.innerHTML)?(xe(d),!0):(tt&&d.nodeType===3&&(v=d.textContent,v=Me(v,Fe," "),v=Me(v,Re," "),d.textContent!==v&&(It(e.removed,{element:d.cloneNode()}),d.textContent=v)),Se("afterSanitizeElements",d,null),!1)},Br=function(d,v,x){if(Tr&&(v==="id"||v==="name")&&(x in i||x in ho))return!1;if(!(zi&&!_i[v]&&J(kt,v))){if(!(zr&&J(Tt,v))){if(!j[v]||_i[v]){if(!(Ur(d)&&(H.tagNameCheck instanceof RegExp&&J(H.tagNameCheck,d)||H.tagNameCheck instanceof Function&&H.tagNameCheck(d))&&(H.attributeNameCheck instanceof RegExp&&J(H.attributeNameCheck,v)||H.attributeNameCheck instanceof Function&&H.attributeNameCheck(v))||v==="is"&&H.allowCustomizedBuiltInElements&&(H.tagNameCheck instanceof RegExp&&J(H.tagNameCheck,x)||H.tagNameCheck instanceof Function&&H.tagNameCheck(x))))return!1}else if(!Mi[v]){if(!J(Ne,Me(x,Ze,""))){if(!((v==="src"||v==="xlink:href"||v==="href")&&d!=="script"&&Cs(x,"data:")===0&&Mr[d])){if(!(kr&&!J(Dt,Me(x,Ze,"")))){if(x)return!1}}}}}}return!0},Ur=function(d){return d.indexOf("-")>0},Hr=function(d){var v,x,R,ie;Se("beforeSanitizeAttributes",d,null);var X=d.attributes;if(!!X){var q={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:j};for(ie=X.length;ie--;){v=X[ie];var qt=v,Z=qt.name,Vr=qt.namespaceURI;if(x=Z==="value"?v.value:_s(v.value),R=Be(Z),q.attrName=R,q.attrValue=x,q.keepAttr=!0,q.forceKeepAttr=void 0,Se("uponSanitizeAttribute",d,q),x=q.attrValue,!q.forceKeepAttr&&(Fr(Z,d),!!q.keepAttr)){if(J(/\/>/i,x)){Fr(Z,d);continue}tt&&(x=Me(x,Fe," "),x=Me(x,Re," "));var vo=Be(d.nodeName);if(!!Br(vo,R,x))try{Vr?d.setAttributeNS(Vr,Z,x):d.setAttribute(Z,x),ca(e.removed)}catch{}}}Se("afterSanitizeAttributes",d,null)}},fo=function _(d){var v,x=Nr(d);for(Se("beforeSanitizeShadowDOM",d,null);v=x.nextNode();)Se("uponSanitizeShadowNode",v,null),!Pr(v)&&(v.content instanceof r&&_(v.content),Hr(v));Se("afterSanitizeShadowDOM",d,null)};return e.sanitize=function(_,d){var v,x,R,ie,X;if(Oi=!_,Oi&&(_="<!-->"),typeof _!="string"&&!At(_)){if(typeof _.toString!="function")throw Qi("toString is not a function");if(_=_.toString(),typeof _!="string")throw Qi("dirty is not a string, aborting")}if(!e.isSupported){if(Qe(a.toStaticHTML)==="object"||typeof a.toStaticHTML=="function"){if(typeof _=="string")return a.toStaticHTML(_);if(At(_))return a.toStaticHTML(_.outerHTML)}return _}if(ki||Li(d),e.removed=[],typeof _=="string"&&(Mt=!1),Mt){if(_.nodeName){var q=Be(_.nodeName);if(!W[q]||Te[q])throw Qi("root node is forbidden and cannot be sanitized in-place")}}else if(_ instanceof s)v=Rr("<!---->"),x=v.ownerDocument.importNode(_,!0),x.nodeType===1&&x.nodeName==="BODY"||x.nodeName==="HTML"?v=x:v.appendChild(x);else{if(!it&&!tt&&!Pe&&_.indexOf("<")===-1)return N&&Gt?N.createHTML(_):_;if(v=Rr(_),!v)return it?null:Gt?K:""}v&&Ti&&xe(v.firstChild);for(var qt=Nr(Mt?_:v);R=qt.nextNode();)R.nodeType===3&&R===ie||Pr(R)||(R.content instanceof r&&fo(R.content),Hr(R),ie=R);if(ie=null,Mt)return _;if(it){if(Qt)for(X=Ct.call(v.ownerDocument);v.firstChild;)X.appendChild(v.firstChild);else X=v;return j.shadowroot&&(X=zt.call(t,X,!0)),X}var Z=Pe?v.outerHTML:v.innerHTML;return Pe&&W["!doctype"]&&v.ownerDocument&&v.ownerDocument.doctype&&v.ownerDocument.doctype.name&&J(Fs,v.ownerDocument.doctype.name)&&(Z="<!DOCTYPE "+v.ownerDocument.doctype.name+`>
`+Z),tt&&(Z=Me(Z,Fe," "),Z=Me(Z,Re," ")),N&&Gt?N.createHTML(Z):Z},e.setConfig=function(_){Li(_),ki=!0},e.clearConfig=function(){st=null,ki=!1},e.isValidAttribute=function(_,d,v){st||Li({});var x=Be(_),R=Be(d);return Br(x,R,v)},e.addHook=function(_,d){typeof d=="function"&&(te[_]=te[_]||[],It(te[_],d))},e.removeHook=function(_){if(te[_])return ca(te[_])},e.removeHooks=function(_){te[_]&&(te[_]=[])},e.removeAllHooks=function(){te={}},e}var mt=Ka(),ur;let ui=ur=class extends L{constructor(){super(...arguments),this.snippets=["this is a text {{{snippet}}} block with potentially","multiple {{{snippets}}} and such","but the {{{snippet}}} block may be quite long perhaps","depending on how many {{{snippet}}} matches there are","there may be multiple lines of {{{snippets}}} to show","but each {{{snippet}}} should be relatively short"],this.viewSize="desktop"}render(){var e;const t=this.viewSize==="grid"?"grid":"list";return m`
    ...
    `}get ellipsisJoinedSnippets(){const e={ALLOWED_TAGS:["mark"]};return ii(cr(this.snippets,t=>m`
          <span>
            ${hs(mt.sanitize(ur.markMatches(t),e))}
          </span>
        `),m` &hellip; `)}static markMatches(e){return e.replace(/{{{(.+?)}}}/g,"<mark>$1</mark>")}static get styles(){return y`
      #container {
        display: -webkit-box;
    ...
    `}};n([p({type:Array})],ui.prototype,"snippets",void 0);n([p({type:String})],ui.prototype,"viewSize",void 0);ui=ur=n([U("text-snippet-block")],ui);const Ps=y`
  .drop-shadow {
...
`,Zs={account:{color:"#000000",icon:Us,text:"Account"},audio:{color:"#00adef",icon:Hs,text:"Audio"},collection:{color:"#4666ff",icon:Ga,text:"Collection"},data:{color:"#333333",icon:Vs,text:"Data"},etree:{color:"#00adef",icon:Ws,text:"E-tree"},film:{color:"#bf1b2c",icon:ma,text:"Film"},image:{color:"#aa99c9",icon:js,text:"Image"},movies:{color:"#f1644b",icon:ma,text:"Movie"},radio:{color:"#8fdaef",icon:Qs,text:"Radio"},software:{color:"#9ecc4f",icon:Gs,text:"Software"},texts:{color:"#faab3c",icon:Ys,text:"Text"},tv:{color:"#f1644b",icon:Ks,text:"TV"},video:{color:"#f1644b",icon:qs,text:"Video"},web:{color:"#ffcd27",icon:Xs,text:"Web"}};let Wt=class extends L{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var e,t;const i=["tvnews","tvarchive","television"],r=["radio","radioprogram"];return this.mediatype==="movies"&&((e=this.collections)===null||e===void 0?void 0:e.some(o=>i.indexOf(o)>=0))?"tv":this.mediatype==="audio"&&((t=this.collections)===null||t===void 0?void 0:t.some(o=>r.indexOf(o)>=0))?"radio":this.mediatype||""}render(){const e=Zs[this.displayMediatype];return e?m`
      <div
        id="icon"
    ...
    `}};n([p({type:String})],Wt.prototype,"mediatype",void 0);n([p({type:Array})],Wt.prototype,"collections",void 0);n([p({type:Boolean})],Wt.prototype,"showText",void 0);Wt=n([U("mediatype-icon")],Wt);const Js=O`
...
`;function an(a,e){let t=1;return a>=1e9?t=1e9:a>=1e6?t=1e6:a>=1e3&&e==="short"&&(t=1e3),t}function on(a=0,e){const t=a/e,i=t<10;let r=0;return i?r=Math.round((t+Number.EPSILON)*10)/10:r=Math.round(t),r}function sn(a,e,t,i){switch(e){case 1e9:return je(t==="short"?nt`${a}B`:nt`${a} billion`);case 1e6:return je(t==="short"?nt`${a}M`:nt`${a} million`);case 1e3:return je(t==="short"?nt`${a}K`:nt`${a} thousand`);default:return new Intl.NumberFormat(i).format(a)}}function Rt(a,e="long",t="short",i="en-US"){const r=a!=null?a:-1;if(r<0)return"";const o=an(r,e),s=on(r,o);return sn(s,o,t,i)}let qe=class extends L{render(){return m`
    ...
    `}get textSnippetsTemplate(){return this.hasSnippets?m`
      <text-snippet-block .viewSize=${"grid"}></text-snippet-block>
    `:$}get hasSnippets(){return!0}static get styles(){return y`
      .container {
    ...
    `}};n([p({type:String})],gt.prototype,"baseImageUrl",void 0);n([p({type:Boolean})],gt.prototype,"loggedIn",void 0);n([p({type:Object})],gt.prototype,"model",void 0);n([p({type:Object})],gt.prototype,"sortParam",void 0);gt=n([U("item-tile")],gt);let mr=class extends L{render(){var e,t,i,r,o,s,l,c;return m`
    ...
    `}get descriptionTemplate(){var e,t;return this.metadataTemplate(mt.sanitize((t=(e=this.model)===null||e===void 0?void 0:e.description)!==null&&t!==void 0?t:""),"","description")}get textSnippetsTemplate(){return this.hasSnippets?m`
      <text-snippet-block .viewSize=${"list"}></text-snippet-block>
    `:$}get hasSnippets(){return!0}metadataTemplate(e,t="",i){return e?m`
    ...
    `}};n([p({type:Object})],he.prototype,"model",void 0);n([p({type:String})],he.prototype,"baseNavigationUrl",void 0);n([p({type:Object})],he.prototype,"collectionNameCache",void 0);n([p({type:Number})],he.prototype,"currentWidth",void 0);n([p({type:Number})],he.prototype,"currentHeight",void 0);n([p({type:Object})],he.prototype,"sortParam",void 0);n([p({type:Number})],he.prototype,"mobileBreakpoint",void 0);n([T()],he.prototype,"collectionLinks",void 0);n([p({type:String})],he.prototype,"baseImageUrl",void 0);n([p({type:Boolean})],he.prototype,"loggedIn",void 0);he=n([U("tile-list")],he);let we=class extends L{constructor(){super(...arguments),this.sortParam=null,this.loggedIn=!1}render(){var e,t,i,r,o,s,l,c,h,u;return m`
      <div id="list-line" class="${this.classSize}">
        ...
        <div id="title">${mt.sanitize((t=(e=this.model)===null||e===void 0?void 0:e.title)!==null&&t!==void 0?t:"")}</div>
        <div id="creator">
          ${((i=this.model)===null||i===void 0?void 0:i.mediatype)==="account"?Xa((r=this.model)===null||r===void 0?void 0:r.dateAdded):mt.sanitize((s=(o=this.model)===null||o===void 0?void 0:o.creator)!==null&&s!==void 0?s:"")}
        </div>
        ...
        <div id="views">
          ${Rt((u=(h=this.model)===null||h===void 0?void 0:h.viewCount)!==null&&u!==void 0?u:0,this.formatSize)}
        </div>
      </div>
    `}get date(){var e,t,i,r,o;switch((e=this.sortParam)===null||e===void 0?void 0:e.field){case"date":return(t=this.model)===null||t===void 0?void 0:t.datePublished;case"reviewdate":return(i=this.model)===null||i===void 0?void 0:i.dateReviewed;case"addeddate":return(r=this.model)===null||r===void 0?void 0:r.dateAdded;default:return(o=this.model)===null||o===void 0?void 0:o.dateArchived}}get classSize(){return this.mobileBreakpoint&&this.currentWidth&&this.currentWidth<this.mobileBreakpoint?"mobile":"desktop"}get formatSize(){return this.mobileBreakpoint&&this.currentWidth&&this.currentWidth<this.mobileBreakpoint?"short":"long"}static get styles(){return y`
      html {
    ...
    `}};n([p({type:Object})],yt.prototype,"model",void 0);n([p({type:Number})],yt.prototype,"currentWidth",void 0);n([p({type:Object})],yt.prototype,"sortParam",void 0);n([p({type:Number})],yt.prototype,"mobileBreakpoint",void 0);yt=n([U("tile-list-compact-header")],yt);let ae=class extends L{constructor(){super(...arguments),this.sortParam=null,this.loggedIn=!1}render(){return m`
      <div id="container">
    ...
    `}get linkTileTemplate(){var e,t;return m`
      <a
        ...
        title=${xi((t=this.model)===null||t===void 0?void 0:t.title)}
      >
        ${this.tile}
      </a>
    ...
    `}};fa=n([U("collection-browser-loading-tile")],fa);var M;(function(a){a.relevance="relevance",a.alltimeview="alltimeview",a.weeklyview="weeklyview",a.title="title",a.datearchived="datearchived",a.date="date",a.datereviewed="datereviewed",a.dateadded="dateadded",a.creator="creator"})(M||(M={}));const We={relevance:"Relevance",alltimeview:"All-time Views",weeklyview:"Weekly Views",title:"Title",datearchived:"Date Archived",date:"Date Published",datereviewed:"Date Reviewed",dateadded:"Date Added",creator:"Creator"},nn={relevance:null,alltimeview:"downloads",weeklyview:"week",title:"titleSorter",datearchived:"publicdate",date:"date",datereviewed:"reviewdate",dateadded:"addeddate",creator:"creatorSorter"},va={week:M.weeklyview,downloads:M.alltimeview,titleSorter:M.title,date:M.date,publicdate:M.datearchived,reviewdate:M.datereviewed,addeddate:M.dateadded,creatorSorter:M.creator},mi={subject:{},mediatype:{},language:{},creator:{},collection:{},year:{}};let fi=class extends L{constructor(){super(...arguments),this.selectedLetter=null,this.alphabet="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("")}get selectedUppercaseLetter(){var e;return(e=this.selectedLetter)===null||e===void 0?void 0:e.toUpperCase()}render(){return m`
      <div id="container">
        <ul>
    ...
    `}letterClicked(e){e===this.selectedUppercaseLetter?this.selectedLetter=null:this.selectedLetter=e,this.dispatchEvent(new CustomEvent("letterChanged",{detail:{selectedLetter:this.selectedUppercaseLetter}}))}};fi.styles=y`
    h1 {
      font-size: 1.2rem;
    }
  ...
  `;n([p({type:String})],fi.prototype,"selectedLetter",void 0);fi=n([U("alpha-bar")],fi);const ga=O`
...
`;let Y=class extends L{constructor(){super(...arguments),this.sortDirection=null,this.selectedSort=M.relevance,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.showRelevance=!0,this.alphaSelectorVisible=null,this.dateSortSelectorVisible=!1,this.viewSortSelectorVisible=!1,this.desktopSelectorBarWidth=0,this.selectorBarContainerWidth=0,this.hoveringOverDateSortOptions=!1,this.boundSortBarSelectorEscapeListener=e=>{e.key==="Escape"&&(this.viewSortSelectorVisible=!1,this.dateSortSelectorVisible=!1)}}render(){return m`
    ...
    `}getSortDisplayOption(e,t){var i,r;const o=(i=t==null?void 0:t.isSelected)!==null&&i!==void 0?i:()=>this.selectedSort===e,s=(r=t==null?void 0:t.displayName)!==null&&r!==void 0?r:We[e];return m`
      <a
        href="#"
    ...
    `}selectDateSort(e){this.dateSortSelectorVisible=!1,this.viewSortSelectorVisible=!1,this.setSelectedSort(e)}setSortDirections(e){this.sortDirection=e,this.emitSortChangedEvent()}setSelectedSort(e){this.selectedSort=e,this.emitSortChangedEvent()}get dateOptionSelected(){return[M.datearchived,M.date,M.datereviewed,M.dateadded].includes(this.selectedSort)}get viewOptionSelected(){return[M.alltimeview,M.weeklyview].includes(this.selectedSort)}get dateSortField(){var e;const t=We[M.date];return this.dateOptionSelected&&(e=We[this.selectedSort])!==null&&e!==void 0?e:t}get viewSortField(){var e;const t=We[M.weeklyview];return this.viewOptionSelected&&(e=We[this.selectedSort])!==null&&e!==void 0?e:t}get titleSelectorBar(){return m` <alpha-bar
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ya=Si(class extends $i{constructor(a){if(super(a),a.type!==Ce.PROPERTY&&a.type!==Ce.ATTRIBUTE&&a.type!==Ce.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!es(a))throw Error("`live` bindings can only contain a single expression")}render(a){return a}update(a,[e]){if(e===ne||e===$)return e;const t=a.element,i=a.name;if(a.type===Ce.PROPERTY){if(e===t[i])return ne}else if(a.type===Ce.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(i))return ne}else if(a.type===Ce.ATTRIBUTE&&t.getAttribute(i)===e+"")return ne;return ja(a),e}});var Za=60,Ja=Za*60,eo=Ja*24,hn=eo*7,bt=1e3,Xi=Za*bt,ba=Ja*bt,pn=eo*bt,un=hn*bt,xr="millisecond",ct="second",dt="minute",ht="hour",Ae="day",oi="week",ue="month",to="quarter",Ee="year",pt="date",mn="YYYY-MM-DDTHH:mm:ssZ",wa="Invalid Date",fn=/^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/,vn=/\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g,gn={name:"en",weekdays:"Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),months:"January_February_March_April_May_June_July_August_September_October_November_December".split("_")},fr=function(e,t,i){var r=String(e);return!r||r.length>=t?e:""+Array(t+1-r.length).join(i)+e},yn=function(e){var t=-e.utcOffset(),i=Math.abs(t),r=Math.floor(i/60),o=i%60;return(t<=0?"+":"-")+fr(r,2,"0")+":"+fr(o,2,"0")},bn=function a(e,t){if(e.date()<t.date())return-a(t,e);var i=(t.year()-e.year())*12+(t.month()-e.month()),r=e.clone().add(i,ue),o=t-r<0,s=e.clone().add(i+(o?-1:1),ue);return+(-(i+(t-r)/(o?r-s:s-r))||0)},wn=function(e){return e<0?Math.ceil(e)||0:Math.floor(e)},xn=function(e){var t={M:ue,y:Ee,w:oi,d:Ae,D:pt,h:ht,m:dt,s:ct,ms:xr,Q:to};return t[e]||String(e||"").toLowerCase().replace(/s$/,"")},Sn=function(e){return e===void 0},$n={s:fr,z:yn,m:bn,a:wn,p:xn,u:Sn},Nt="en",Ye={};Ye[Nt]=gn;var Sr=function(e){return e instanceof Ci},vi=function a(e,t,i){var r;if(!e)return Nt;if(typeof e=="string"){var o=e.toLowerCase();Ye[o]&&(r=o),t&&(Ye[o]=t,r=o);var s=e.split("-");if(!r&&s.length>1)return a(s[0])}else{var l=e.name;Ye[l]=e,r=l}return!i&&r&&(Nt=r),r||!i&&Nt},G=function(e,t){if(Sr(e))return e.clone();var i=typeof t=="object"?t:{};return i.date=e,i.args=arguments,new Ci(i)},Cn=function(e,t){return G(e,{locale:t.$L,utc:t.$u,x:t.$x,$offset:t.$offset})},P=$n;P.l=vi;P.i=Sr;P.w=Cn;var _n=function(e){var t=e.date,i=e.utc;if(t===null)return new Date(NaN);if(P.u(t))return new Date;if(t instanceof Date)return new Date(t);if(typeof t=="string"&&!/Z$/i.test(t)){var r=t.match(fn);if(r){var o=r[2]-1||0,s=(r[7]||"0").substring(0,3);return i?new Date(Date.UTC(r[1],o,r[3]||1,r[4]||0,r[5]||0,r[6]||0,s)):new Date(r[1],o,r[3]||1,r[4]||0,r[5]||0,r[6]||0,s)}}return new Date(t)},Ci=function(){function a(t){this.$L=vi(t.locale,null,!0),this.parse(t)}var e=a.prototype;return e.parse=function(i){this.$d=_n(i),this.$x=i.x||{},this.init()},e.init=function(){var i=this.$d;this.$y=i.getFullYear(),this.$M=i.getMonth(),this.$D=i.getDate(),this.$W=i.getDay(),this.$H=i.getHours(),this.$m=i.getMinutes(),this.$s=i.getSeconds(),this.$ms=i.getMilliseconds()},e.$utils=function(){return P},e.isValid=function(){return this.$d.toString()!==wa},e.isSame=function(i,r){var o=G(i);return this.startOf(r)<=o&&o<=this.endOf(r)},e.isAfter=function(i,r){return G(i)<this.startOf(r)},e.isBefore=function(i,r){return this.endOf(r)<G(i)},e.$g=function(i,r,o){return P.u(i)?this[r]:this.set(o,i)},e.unix=function(){return Math.floor(this.valueOf()/1e3)},e.valueOf=function(){return this.$d.getTime()},e.startOf=function(i,r){var o=this,s=P.u(r)?!0:r,l=P.p(i),c=function(A,F){var I=P.w(o.$u?Date.UTC(o.$y,F,A):new Date(o.$y,F,A),o);return s?I:I.endOf(Ae)},h=function(A,F){var I=[0,0,0,0],N=[23,59,59,999];return P.w(o.toDate()[A].apply(o.toDate("s"),(s?I:N).slice(F)),o)},u=this.$W,f=this.$M,g=this.$D,b="set"+(this.$u?"UTC":"");switch(l){case Ee:return s?c(1,0):c(31,11);case ue:return s?c(1,f):c(0,f+1);case oi:{var S=this.$locale().weekStart||0,z=(u<S?u+7:u)-S;return c(s?g-z:g+(6-z),f)}case Ae:case pt:return h(b+"Hours",0);case ht:return h(b+"Minutes",1);case dt:return h(b+"Seconds",2);case ct:return h(b+"Milliseconds",3);default:return this.clone()}},e.endOf=function(i){return this.startOf(i,!1)},e.$set=function(i,r){var o,s=P.p(i),l="set"+(this.$u?"UTC":""),c=(o={},o[Ae]=l+"Date",o[pt]=l+"Date",o[ue]=l+"Month",o[Ee]=l+"FullYear",o[ht]=l+"Hours",o[dt]=l+"Minutes",o[ct]=l+"Seconds",o[xr]=l+"Milliseconds",o)[s],h=s===Ae?this.$D+(r-this.$W):r;if(s===ue||s===Ee){var u=this.clone().set(pt,1);u.$d[c](h),u.init(),this.$d=u.set(pt,Math.min(this.$D,u.daysInMonth())).$d}else c&&this.$d[c](h);return this.init(),this},e.set=function(i,r){return this.clone().$set(i,r)},e.get=function(i){return this[P.p(i)]()},e.add=function(i,r){var o=this,s;i=Number(i);var l=P.p(r),c=function(g){var b=G(o);return P.w(b.date(b.date()+Math.round(g*i)),o)};if(l===ue)return this.set(ue,this.$M+i);if(l===Ee)return this.set(Ee,this.$y+i);if(l===Ae)return c(1);if(l===oi)return c(7);var h=(s={},s[dt]=Xi,s[ht]=ba,s[ct]=bt,s)[l]||1,u=this.$d.getTime()+i*h;return P.w(u,this)},e.subtract=function(i,r){return this.add(i*-1,r)},e.format=function(i){var r=this,o=this.$locale();if(!this.isValid())return o.invalidDate||wa;var s=i||mn,l=P.z(this),c=this.$H,h=this.$m,u=this.$M,f=o.weekdays,g=o.months,b=o.meridiem,S=function(I,N,K,se){return I&&(I[N]||I(r,s))||K[N].slice(0,se)},z=function(I){return P.s(c%12||12,I,"0")},E=b||function(F,I,N){var K=F<12?"AM":"PM";return N?K.toLowerCase():K},A={YY:String(this.$y).slice(-2),YYYY:this.$y,M:u+1,MM:P.s(u+1,2,"0"),MMM:S(o.monthsShort,u,g,3),MMMM:S(g,u),D:this.$D,DD:P.s(this.$D,2,"0"),d:String(this.$W),dd:S(o.weekdaysMin,this.$W,f,2),ddd:S(o.weekdaysShort,this.$W,f,3),dddd:f[this.$W],H:String(c),HH:P.s(c,2,"0"),h:z(1),hh:z(2),a:E(c,h,!0),A:E(c,h,!1),m:String(h),mm:P.s(h,2,"0"),s:String(this.$s),ss:P.s(this.$s,2,"0"),SSS:P.s(this.$ms,3,"0"),Z:l};return s.replace(vn,function(F,I){return I||A[F]||l.replace(":","")})},e.utcOffset=function(){return-Math.round(this.$d.getTimezoneOffset()/15)*15},e.diff=function(i,r,o){var s,l=P.p(r),c=G(i),h=(c.utcOffset()-this.utcOffset())*Xi,u=this-c,f=P.m(this,c);return f=(s={},s[Ee]=f/12,s[ue]=f,s[to]=f/3,s[oi]=(u-h)/un,s[Ae]=(u-h)/pn,s[ht]=u/ba,s[dt]=u/Xi,s[ct]=u/bt,s)[l]||u,o?f:P.a(f)},e.daysInMonth=function(){return this.endOf(ue).$D},e.$locale=function(){return Ye[this.$L]},e.locale=function(i,r){if(!i)return this.$L;var o=this.clone(),s=vi(i,r,!0);return s&&(o.$L=s),o},e.clone=function(){return P.w(this.$d,this)},e.toDate=function(){return new Date(this.valueOf())},e.toJSON=function(){return this.isValid()?this.toISOString():null},e.toISOString=function(){return this.$d.toISOString()},e.toString=function(){return this.$d.toUTCString()},a}(),io=Ci.prototype;G.prototype=io;[["$ms",xr],["$s",ct],["$m",dt],["$H",ht],["$W",Ae],["$M",ue],["$y",Ee],["$D",pt]].forEach(function(a){io[a[1]]=function(e){return this.$g(e,a[0],a[1])}});G.extend=function(a,e){return a.$i||(a(e,Ci,G),a.$i=!0),G};G.locale=vi;G.isDayjs=Sr;G.unix=function(a){return G(a*1e3)};G.en=Ye[Nt];G.Ls=Ye;G.p={};var zn=function(e){return e.replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g,function(t,i,r){return i||r.slice(1)})},kn={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"},Tn=function(e,t){return e.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g,function(i,r,o){var s=o&&o.toUpperCase();return r||t[o]||kn[o]||zn(t[s])})},Dn=/(\[[^[]*\])|([-:/.()\s]+)|(A|a|YYYY|YY?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g,Mn=/\d/,ei=/\d\d/,An=/\d{3}/,En=/\d{4}/,ye=/\d\d?/,On=/[+-]?\d+/,Ln=/[+-]\d\d:?(\d\d)?|Z/,Ft=/\d*[^\s\d-_:/()]+/,Le={},ro=function(e){return e=+e,e+(e>68?1900:2e3)};function In(a){if(!a||a==="Z")return 0;var e=a.match(/([+-]|\d\d)/g),t=+(e[1]*60)+(+e[2]||0);return t===0?0:e[0]==="+"?-t:t}var re=function(e){return function(t){this[e]=+t}},xa=[Ln,function(a){var e=this.zone||(this.zone={});e.offset=In(a)}],Zi=function(e){var t=Le[e];return t&&(t.indexOf?t:t.s.concat(t.f))},Sa=function(e,t){var i,r=Le,o=r.meridiem;if(!o)i=e===(t?"pm":"PM");else for(var s=1;s<=24;s+=1)if(e.indexOf(o(s,0,t))>-1){i=s>12;break}return i},Fn={A:[Ft,function(a){this.afternoon=Sa(a,!1)}],a:[Ft,function(a){this.afternoon=Sa(a,!0)}],S:[Mn,function(a){this.milliseconds=+a*100}],SS:[ei,function(a){this.milliseconds=+a*10}],SSS:[An,function(a){this.milliseconds=+a}],s:[ye,re("seconds")],ss:[ye,re("seconds")],m:[ye,re("minutes")],mm:[ye,re("minutes")],H:[ye,re("hours")],h:[ye,re("hours")],HH:[ye,re("hours")],hh:[ye,re("hours")],D:[ye,re("day")],DD:[ei,re("day")],Do:[Ft,function(a){var e=Le,t=e.ordinal,i=a.match(/\d+/);if(this.day=i[0],!!t)for(var r=1;r<=31;r+=1)t(r).replace(/\[|\]/g,"")===a&&(this.day=r)}],M:[ye,re("month")],MM:[ei,re("month")],MMM:[Ft,function(a){var e=Zi("months"),t=Zi("monthsShort"),i=(t||e.map(function(r){return r.slice(0,3)})).indexOf(a)+1;if(i<1)throw new Error;this.month=i%12||i}],MMMM:[Ft,function(a){var e=Zi("months"),t=e.indexOf(a)+1;if(t<1)throw new Error;this.month=t%12||t}],Y:[On,re("year")],YY:[ei,function(a){this.year=ro(a)}],YYYY:[En,re("year")],Z:xa,ZZ:xa};function Rn(a){var e=a.afternoon;if(e!==void 0){var t=a.hours;e?t<12&&(a.hours+=12):t===12&&(a.hours=0),delete a.afternoon}}function Nn(a){a=Tn(a,Le&&Le.formats);for(var e=a.match(Dn),t=e.length,i=0;i<t;i+=1){var r=e[i],o=Fn[r],s=o&&o[0],l=o&&o[1];l?e[i]={regex:s,parser:l}:e[i]=r.replace(/^\[|\]$/g,"")}return function(c){for(var h={},u=0,f=0;u<t;u+=1){var g=e[u];if(typeof g=="string")f+=g.length;else{var b=g.regex,S=g.parser,z=c.slice(f),E=b.exec(z),A=E[0];S.call(h,A),c=c.replace(A,"")}}return Rn(h),h}}var Pn=function(e,t,i){try{if(["x","X"].indexOf(t)>-1)return new Date((t==="X"?1e3:1)*e);var r=Nn(t),o=r(e),s=o.year,l=o.month,c=o.day,h=o.hours,u=o.minutes,f=o.seconds,g=o.milliseconds,b=o.zone,S=new Date,z=c||(!s&&!l?S.getDate():1),E=s||S.getFullYear(),A=0;s&&!l||(A=l>0?l-1:S.getMonth());var F=h||0,I=u||0,N=f||0,K=g||0;return b?new Date(Date.UTC(E,A,z,F,I,N,K+b.offset*60*1e3)):i?new Date(Date.UTC(E,A,z,F,I,N,K)):new Date(E,A,z,F,I,N,K)}catch{return new Date("")}},Bn=function(a,e,t){t.p.customParseFormat=!0,a&&a.parseTwoDigitYear&&(ro=a.parseTwoDigitYear);var i=e.prototype,r=i.parse;i.parse=function(o){var s=o.date,l=o.utc,c=o.args;this.$u=l;var h=c[1];if(typeof h=="string"){var u=c[2]===!0,f=c[3]===!0,g=u||f,b=c[2];f&&(b=c[2]),Le=this.$locale(),!u&&b&&(Le=t.Ls[b]),this.$d=Pn(s,h,l),this.init(),b&&b!==!0&&(this.$L=this.locale(b).$L),g&&s!=this.format(h)&&(this.$d=new Date("")),Le={}}else if(h instanceof Array)for(var S=h.length,z=1;z<=S;z+=1){c[1]=h[z-1];var E=t.apply(this,c);if(E.isValid()){this.$d=E.$d,this.$L=E.$L,this.init();break}z===S&&(this.$d=new Date(""))}else r.call(this,o)}};const Un=Object.freeze({processing:"processing",complete:"complete"});class Hn extends L{static get properties(){return{mode:{type:String}}}constructor(){super(),this.mode=Un.processing}render(){return m`
      <div class="${this.mode}">
        <svg
          viewBox="0 0 120 120"
    ...
    `}get selectedRangeTemplate(){return O`
      ...
      />`}get histogramTemplate(){const e=this._histWidth/this._numBins,t=e-1;let i=this.sliderWidth;return this._histData.map(r=>{const o=O`
        <rect
          ...
          fill="${i+t>=this.minSliderX&&i<=this.maxSliderX?Zn:e1}"
...
`;const c1=["mediatype","year","subject","collection","creator","language"],d1={subjectSorter:"subject",mediatypeSorter:"mediatype",languageSorter:"language",creatorSorter:"creator",collection:"collection",year:"year"},Da={subject:"Subject",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"};let oe=class extends L{constructor(){super(...arguments),this.facetsLoading=!1,this.fullYearAggregationLoading=!1,this.collapsableFacets=!1,this.showHistogramDatePicker=!1,this.openFacets={subject:!1,mediatype:!1,language:!1,creator:!1,collection:!1,year:!1}}render(){return m`
                ...
                <div class="facet-row">
                  <div class="facet-checkbox">
                    ...
                    <label
                      ...
                      title=${E}
                    >
                      <span class="eye">${n1}</span>
                      <span class="eye-closed">${l1}</span>
                    </label>
                  </div>
    ...
    `}facetClicked(e,t,i){const r=e.target,{checked:o,name:s,value:l}=r;o?this.facetChecked(s,l,i):this.facetUnchecked(s,l)}facetChecked(e,t,i){const{selectedFacets:r}=this;let o;r?o=ge({},r):o=mi,o[e][t]=i?"hidden":"selected",this.selectedFacets=o}facetUnchecked(e,t){const{selectedFacets:i}=this;let r;i?r=ge({},i):r=mi,delete r[e][t],this.selectedFacets=r}getFacetOptionFromKey(e){const r=e.split("__")[2].split(":")[1],o=Object.entries(d1).find(([l])=>r.includes(l)),s=o==null?void 0:o[1];if(!s)throw new Error(`Could not find facet option for key: ${e}`);return s}static get styles(){return y`
      #container.loading {
        opacity: 0.5;
      }
...
`;let yi=class extends L{constructor(){super(...arguments),this.placeholderType=null}render(){return this.placeholderType?m`${this.placeholderTemplate}`:$}get placeholderTemplate(){return m`
      <div
        class="placeholder ${this.placeholderType} ${this.isMobileView?"mobile":"desktop"}"
      >
        ${v1(this.placeholderType,[["empty-query",()=>this.emptyQueryTemplate],["null-result",()=>this.nullResultTemplate]])}
      </div>
    ...
    `}};n([p({type:String})],yi.prototype,"placeholderType",void 0);n([p({type:Boolean})],yi.prototype,"isMobileView",void 0);yi=n([U("empty-placeholder")],yi);let k=class extends L{constructor(){super(...arguments),this.baseImageUrl="https://archive.org",this.sortParam=null,this.selectedSort=M.relevance,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.sortDirection=null,this.pageSize=50,this.showHistogramDatePicker=!1,this.pageContext="search",this.restorationStateHandler=new m1({context:this.pageContext}),this.mobileBreakpoint=600,this.loggedIn=!1,this.isManageView=!1,this.initialPageNumber=1,this.pagesToRender=this.initialPageNumber,this.searchResultsLoading=!1,this.facetsLoading=!1,this.fullYearAggregationLoading=!1,this.mobileView=!1,this.mobileFacetsVisible=!1,this.placeholderType=null,this.languageCodeHandler=new f1,this.isScrollingToCell=!1,this.endOfDataReached=!1,this.isResizeToMobile=!1,this.placeholderCellTemplate=m`<collection-browser-loading-tile></collection-browser-loading-tile>`,this.dataSource={},this.initialQueryChangeHappened=!1,this.historyPopOccurred=!1,this.pageFetchesInProgress={}}tileModelAtCellIndex(e){var t;const i=Math.floor(e/this.pageSize)+1,r=e%this.pageSize,o=(t=this.dataSource[i])===null||t===void 0?void 0:t[r];return!o&&!this.isScrollingToCell&&this.fetchPage(i),o}get sortFilterQueries(){return[this.titleQuery,this.creatorQuery].filter(t=>t).join(" AND ")}get estimatedTileCount(){return this.pagesToRender*this.pageSize}get actualTileCount(){return Object.keys(this.dataSource).reduce((e,t)=>e+this.dataSource[t].length,0)}goToPage(e){this.initialPageNumber=e,this.pagesToRender=e,this.scrollToPage(e)}clearFilters(){this.selectedFacets=mi,this.sortParam=null,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.titleQuery=void 0,this.creatorQuery=void 0,this.selectedSort=M.relevance,this.sortDirection=null}render(){return this.setPlaceholderType(),m`
