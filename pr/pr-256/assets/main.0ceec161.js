 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ze={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},ni=a=>(...e)=>({_$litDirective$:a,values:e});class li{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Zt=ni(class extends li{constructor(a){var e;if(super(a),a.type!==ze.ATTRIBUTE||a.name!=="class"||((e=a.strings)===null||e===void 0?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(a){return" "+Object.keys(a).filter(e=>a[e]).join(" ")+" "}update(a,[e]){var t,i;if(this.et===void 0){this.et=new Set,a.strings!==void 0&&(this.st=new Set(a.strings.join(" ").split(/\s/).filter(r=>r!=="")));for(const r in e)e[r]&&!(!((t=this.st)===null||t===void 0)&&t.has(r))&&this.et.add(r);return this.render(e)}const o=a.element.classList;this.et.forEach(r=>{r in e||(o.remove(r),this.et.delete(r))});for(const r in e){const n=!!e[r];n===this.et.has(r)||((i=this.st)===null||i===void 0?void 0:i.has(r))||(n?(o.add(r),this.et.add(r)):(o.remove(r),this.et.delete(r)))}return ge}});/**
 * @license
...
`;let Jt=class extends P{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1,this.isCompactTile=!1}render(){return h`<div class="icon-overlay ${this.getClass}">
    ...
    `}};s([c({type:Boolean})],ei.prototype,"loggedIn",void 0);s([c({type:Boolean})],ei.prototype,"loginRequired",void 0);s([c({type:Boolean})],ei.prototype,"iconRequired",void 0);ei=s([A("text-overlay")],ei);let Ge=class extends P{constructor(){super(...arguments),this.isCompactTile=!1,this.isListTile=!1,this.loggedIn=!1,this.viewSize="desktop"}render(){var e;return!((e=this.model)===null||e===void 0)&&e.identifier?h`
    ...
    `}};s([c({type:String})],Ge.prototype,"baseImageUrl",void 0);s([c({type:Boolean})],Ge.prototype,"isCompactTile",void 0);s([c({type:Boolean})],Ge.prototype,"isListTile",void 0);s([c({type:Boolean})],Ge.prototype,"loggedIn",void 0);s([c({type:Object})],Ge.prototype,"model",void 0);s([c({type:String})],Ge.prototype,"viewSize",void 0);Ge=s([A("image-block")],Ge);let ti=class extends P{constructor(){super(...arguments),this.showInfoButton=!1}render(){return h`
      <div class="container">
...
`+he),Te&&(he=We(he,Ye," "),he=We(he,Ze," ")),O&&ci?O.createHTML(he):he},e.setConfig=function($){Ii($),it=!0},e.clearConfig=function(){Ct=null,it=!1},e.isValidAttribute=function($,p,w){Ct||Ii({});var C=at($),R=at(p);return qo(C,R,w)},e.addHook=function($,p){typeof p=="function"&&(me[$]=me[$]||[],Wt(me[$],p))},e.removeHook=function($){if(me[$])return fa(me[$])},e.removeHooks=function($){me[$]&&(me[$]=[])},e.removeAllHooks=function(){me={}},e}var Gt=nr(),z;(function(a){a.relevance="relevance",a.alltimeview="alltimeview",a.weeklyview="weeklyview",a.title="title",a.date="date",a.datearchived="datearchived",a.datereviewed="datereviewed",a.dateadded="dateadded",a.creator="creator"})(z||(z={}));const lt={relevance:"Relevance",alltimeview:"All-time views",weeklyview:"Weekly views",title:"Title",date:"Date published",datearchived:"Date archived",datereviewed:"Date reviewed",dateadded:"Date added",creator:"Creator"},xa={relevance:"desc",alltimeview:"desc",weeklyview:"desc",title:"asc",date:"desc",datearchived:"desc",datereviewed:"desc",dateadded:"desc",creator:"asc"},fn={relevance:null,alltimeview:"downloads",weeklyview:"week",title:"titleSorter",date:"date",datearchived:"publicdate",datereviewed:"reviewdate",dateadded:"addeddate",creator:"creatorSorter"};z.weeklyview,z.alltimeview,z.title,z.date,z.datearchived,z.datereviewed,z.dateadded,z.creator;const gn={week:"week",downloads:"downloads",titleSorter:"title",date:"date",publicdate:"publicdate",reviewdate:"reviewdate",addeddate:"addeddate",creatorSorter:"creator"},_a={week:z.weeklyview,downloads:z.alltimeview,title:z.title,titleSorter:z.title,date:z.date,publicdate:z.datearchived,reviewdate:z.datereviewed,addeddate:z.dateadded,creator:z.creator,creatorSorter:z.creator},bn={title:"firstTitle",creator:"firstCreator"},ai=()=>({subject:{},lending:{},mediatype:{},language:{},creator:{},collection:{},year:{}}),yn=["mediatype","lending","year","subject","collection","creator","language"],zi={subject:"Subject",lending:"Availability",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"},fo={subject:K.COUNT,lending:K.COUNT,mediatype:K.COUNT,language:K.COUNT,creator:K.COUNT,collection:K.COUNT,year:K.NUMERIC},wn={subject:K.ALPHABETICAL,lending:K.ALPHABETICAL,mediatype:K.ALPHABETICAL,language:K.ALPHABETICAL,creator:K.ALPHABETICAL,collection:K.ALPHABETICAL,year:K.NUMERIC},xn={is_lendable:!0,is_borrowable:!1,available_to_borrow:!0,is_browsable:!1,available_to_browse:!1,is_readable:!0,available_to_waitlist:!1},Ca={is_lendable:"Lending Library",available_to_borrow:"Borrow 14 Days",is_readable:"Always Available"},Eo={deemphasize:!0,community:!0,stream_only:!0,samples_only:!0,test_collection:!0,printdisabled:!0,"openlibrary-ol":!0,nationalemergencylibrary:!0,china:!0,americana:!0,toronto:!0};function lr(a){switch(a){case"publicdate":return"Archived";case"reviewdate":return"Reviewed";case"addeddate":return"Added";default:return"Published"}}function dr(a){return a?`Archivist since ${a.getFullYear()}`:""}let be=class extends P{constructor(){super(...arguments),this.sortParam=null,this.collectionLinks=[],this.loggedIn=!1,this.collectionPagePath="/details/"}render(){return h`
    ...
    `}};s([c({type:Object})],Qe.prototype,"model",void 0);s([c({type:String})],Qe.prototype,"baseNavigationUrl",void 0);s([c({type:String})],Qe.prototype,"baseImageUrl",void 0);s([c({type:Boolean})],Qe.prototype,"loggedIn",void 0);s([c({type:Object})],Qe.prototype,"sortParam",void 0);s([c({type:Object})],Qe.prototype,"collectionNameCache",void 0);Qe=s([A("tile-hover-pane")],Qe);let Se=class extends P{constructor(){super(...arguments),this.sortParam=null,this.loggedIn=!1,this.collectionPagePath="/details/"}render(){var e,t,i,o,r,n,l,d,u;return h`
      <div id="list-line" class="${this.classSize}">
        <image-block
          .model=${this.model}
          .baseImageUrl=${this.baseImageUrl}
...
`;let ut=class extends P{constructor(){super(...arguments),this.collectionPagePath="/details/"}facetClicked(e,t,i){const o=e.target,{checked:r,name:n,value:l}=o;r?this.facetChecked(n,l,t,i):this.facetUnchecked(n,l),this.dispatchFacetClickEvent(n,this.getFacetState(r,i),i)}facetChecked(e,t,i,o){const{selectedFacets:r}=this;let n;r?n=re({},r):n=ai(),n[e][t]={state:this.getFacetState(!0,o),count:i},this.selectedFacets=n,this.dispatchSelectedFacetsChanged()}facetUnchecked(e,t){const{selectedFacets:i}=this;let o;i?o=re({},i):o=ai(),delete o[e][t],this.selectedFacets=o,this.dispatchSelectedFacetsChanged()}getFacetState(e,t){let i;return e?i=t?"hidden":"selected":i="none",i}dispatchFacetClickEvent(e,t,i){const o=new CustomEvent("facetClick",{detail:{key:e,state:t,negative:i},composed:!0});this.dispatchEvent(o)}dispatchSelectedFacetsChanged(){const e=new CustomEvent("selectedFacetsChanged",{detail:this.selectedFacets,bubbles:!0,composed:!0});this.dispatchEvent(e)}getFacetsTemplate(e){let t=e==null?void 0:e.buckets;return t=[...t.filter(i=>i.state==="selected").sort((i,o)=>i.count<o.count?1:-1),...t.filter(i=>i.state==="hidden").sort((i,o)=>i.count<o.count?1:-1),...t.filter(i=>i.state==="none")],h`
    ...
    `}};Da=s([A("facet-tombstone-row")],Da);let Le=class extends P{constructor(){super(...arguments),this.boundEscapeListener=e=>{e.key==="Escape"&&this.closeModal()}}render(){var e,t;return h`
      <div id="container">
    ...
    `}showDatePickerModal(){var e,t,i;const{fullYearsHistogramAggregation:o}=this,r=o==null?void 0:o.first_bucket_key,n=o==null?void 0:o.last_bucket_key,l=o==null?void 0:o.buckets,u=h`
      <expanded-date-picker
        ${Dn(f=>{if(f&&f instanceof Le){const g=f;g.minSelectedDate=this.minSelectedDate,g.maxSelectedDate=this.maxSelectedDate}})}
        .minDate=${r}
        .maxDate=${n}
