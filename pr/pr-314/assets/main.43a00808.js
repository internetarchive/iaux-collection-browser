var el=Object.defineProperty,tl=Object.defineProperties;var il=Object.getOwnPropertyDescriptors;var Xa=Object.getOwnPropertySymbols;var ol=Object.prototype.hasOwnProperty,al=Object.prototype.propertyIsEnumerable;var Za=(a,e,t)=>e in a?el(a,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):a[e]=t,J=(a,e)=>{for(var t in e||(e={}))ol.call(e,t)&&Za(a,t,e[t]);if(Xa)for(var t of Xa(e))al.call(e,t)&&Za(a,t,e[t]);return a},ue=(a,e)=>tl(a,il(e));import No from"https://esm.archive.org/dayjs@1.11.10";import rl from"https://esm.archive.org/dayjs@1.9.4/esm/plugin/customParseFormat";const sl=function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const s of r.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function t(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerpolicy&&(r.referrerPolicy=o.referrerpolicy),o.crossorigin==="use-credentials"?r.credentials="include":o.crossorigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(o){if(o.ep)return;o.ep=!0;const r=t(o);fetch(o.href,r)}};sl();function l(a,e,t,i){var o=arguments.length,r=o<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(a,e,t,i);else for(var n=a.length-1;n>=0;n--)(s=a[n])&&(r=(o<3?s(r):o>3?s(e,t,r):s(e,t))||r);return o>3&&r&&Object.defineProperty(e,t,r),r}function ll(a,e,t,i){function o(r){return r instanceof t?r:new t(function(s){s(r)})}return new(t||(t=Promise))(function(r,s){function n(u){try{p(i.next(u))}catch(m){s(m)}}function d(u){try{p(i.throw(u))}catch(m){s(m)}}function p(u){u.done?r(u.value):o(u.value).then(n,d)}p((i=i.apply(a,e||[])).next())})}class nl{constructor(e){var t,i,o,r;this.ARCHIVE_ANALYTICS_VERSION=2,this.DEFAULT_SERVICE="ao_2",this.NO_SAMPLING_SERVICE="ao_no_sampling",this.DEFAULT_IMAGE_URL="https://analytics.archive.org/0.gif",this.defaultService=(t=e==null?void 0:e.defaultService)!==null&&t!==void 0?t:this.DEFAULT_SERVICE,this.imageUrl=(i=e==null?void 0:e.imageUrl)!==null&&i!==void 0?i:this.DEFAULT_IMAGE_URL,this.imageContainer=(o=e==null?void 0:e.imageContainer)!==null&&o!==void 0?o:document.body,this.requireImagePing=(r=e==null?void 0:e.requireImagePing)!==null&&r!==void 0?r:!1}sendPing(e){const t=this.generateTrackingUrl(e).toString();if(this.requireImagePing){this.sendPingViaImage(t);return}const i=navigator.sendBeacon&&navigator.sendBeacon.bind(navigator);try{i(t)}catch{this.sendPingViaImage(t)}}sendEvent(e){const t=e.label&&e.label.trim().length>0?e.label:window.location.pathname,i=J({kind:"event",ec:e.category,ea:e.action,el:t,cache_bust:Math.random()},e.eventConfiguration);this.sendPing(i)}sendEventNoSampling(e){const t=e.eventConfiguration||{};t.service=this.NO_SAMPLING_SERVICE;const i=e;i.eventConfiguration=t,this.sendEvent(i)}sendPingViaImage(e){const t=new Image(1,1);t.src=e,t.alt="",this.imageContainer.appendChild(t)}generateTrackingUrl(e){var t;const i=e!=null?e:{};i.service=(t=i.service)!==null&&t!==void 0?t:this.defaultService;const o=new URL(this.imageUrl),r=Object.keys(i);return r.forEach(s=>{const n=i[s];o.searchParams.append(s,n)}),o.searchParams.append("version",`${this.ARCHIVE_ANALYTICS_VERSION}`),o.searchParams.append("count",`${r.length+2}`),o}}function g(a){let e,t,i;return typeof a=="object"?(e=a.hashFunction,t=a.expiring,i=a.tags):e=a,(o,r,s)=>{if(s.value!=null)s.value=Ja(s.value,e,t,i);else if(s.get!=null)s.get=Ja(s.get,e,t,i);else throw"Only put a Memoize() decorator on a method or get accessor."}}const uo=new Map;function Ja(a,e,t=0,i){const o=Symbol("__memoized_map__");return function(...r){let s;this.hasOwnProperty(o)||Object.defineProperty(this,o,{configurable:!1,enumerable:!1,writable:!1,value:new Map});let n=this[o];if(Array.isArray(i))for(const d of i)uo.has(d)?uo.get(d).push(n):uo.set(d,[n]);if(e||r.length>0||t>0){let d;e===!0?d=r.map(m=>m.toString()).join("!"):e?d=e.apply(this,r):d=r[0];const p=`${d}__timestamp`;let u=!1;if(t>0)if(!n.has(p))u=!0;else{let m=n.get(p);u=Date.now()-m>t}n.has(d)&&!u?s=n.get(d):(s=a.apply(this,r),n.set(d,s),t>0&&n.set(p,Date.now()))}else{const d=this;n.has(d)?s=n.get(d):(s=a.apply(this,r),n.set(d,s))}return s}}class Uo{parseValue(e){return typeof e=="string"&&(e==="false"||e==="0")?!1:Boolean(e)}}Uo.shared=new Uo;class Bi{parseValue(e){if(typeof e=="number")return e;if(typeof e=="boolean")return;const t=parseFloat(e);if(!Number.isNaN(t))return t}}Bi.shared=new Bi;class Ho{parseValue(e){return Bi.shared.parseValue(e)}}Ho.shared=new Ho;class Vo{parseValue(e){return this.parseJSDate(e)||this.parseBracketDate(e)}parseBracketDate(e){if(typeof e!="string")return;const t=e.match(/\[([0-9]{4})\]/);if(!(!t||t.length<2))return this.parseJSDate(t[1])}parseJSDate(e){if(typeof e!="string")return;let t=e;t.match(/^[0-9]{4}-[0-9]{2}-[0-9]{2}\s{1}[0-9]{2}:[0-9]{2}:[0-9]{2}$/)&&(t=t.replace(" ","T"));const i=Date.parse(t);if(Number.isNaN(i))return;let o=new Date(t);return(t.indexOf("Z")>-1||t.indexOf("+")>-1||t.match(/^[0-9]{4}$/)||t.match(/^[0-9]{4}-[0-9]{2}-[0-9]{2}$/)||t.match(/^.*?-[0-9]{2}:[0-9]{2}$/)||t.match(/^.*?-[0-9]{4}$/))&&(o=new Date(o.getTime()+o.getTimezoneOffset()*1e3*60)),o}}Vo.shared=new Vo;class Wo{parseValue(e){if(typeof e=="number")return e;if(typeof e=="boolean")return;const t=e.split(":");let i;return t.length===1?i=this.parseNumberFormat(t[0]):i=this.parseColonSeparatedFormat(t),i}parseNumberFormat(e){let t=parseFloat(e);return Number.isNaN(t)&&(t=void 0),t}parseColonSeparatedFormat(e){let t=!1;const i=e.map((o,r)=>{const s=parseFloat(o);if(Number.isNaN(s))return t=!0,0;const n=e.length-1-r,d=60**n;return s*Math.floor(d)}).reduce((o,r)=>o+r,0);return t?void 0:i}}Wo.shared=new Wo;class jo{parseValue(e){if(typeof e=="string")return e}}jo.shared=new jo;class dl{constructor(e,t){this.separators=[";",","],this.parser=e,t&&t.separators&&(this.separators=t.separators)}parseValue(e){const t=String(e);let i=[];for(const o of this.separators)if(i=t.split(o),i.length>1)break;return this.parseListValues(i)}parseListValues(e){const i=e.map(r=>r.trim()).map(r=>this.parser.parseValue(r)),o=[];return i.forEach(r=>{r!==void 0&&o.push(r)}),o}}class Go{parseValue(e){if(typeof e=="string")return e}}Go.shared=new Go;class Ri{parseValue(e){return String(e)}}Ri.shared=new Ri;class Pe{constructor(e,t){this.parser=e,this.rawValue=t}get values(){return this.parseRawValue()}get value(){return this.values[0]}parseRawValue(){if(this.rawValue===void 0)return[];const e=Array.isArray(this.rawValue)?this.rawValue:[this.rawValue],t=[];return e.forEach(i=>{const o=this.parser.parseValue(i);Array.isArray(o)?t.push(...o):o!==void 0&&t.push(o)}),t}}l([g()],Pe.prototype,"values",null);l([g()],Pe.prototype,"value",null);class ht extends Pe{constructor(e){super(Uo.shared,e)}}class W extends Pe{constructor(e){super(Vo.shared,e)}}class vo extends Pe{constructor(e){super(Wo.shared,e)}}class U extends Pe{constructor(e){super(Bi.shared,e)}}class S extends Pe{constructor(e){super(Ri.shared,e)}}class cl extends Pe{constructor(e){super(Go.shared,e)}}class Fi extends Pe{constructor(e){super(Ho.shared,e)}}class ui extends Pe{constructor(e){super(jo.shared,e)}}class hl extends Pe{constructor(e,t){super(t,e)}}class pl extends hl{constructor(e){const t=new dl(Ri.shared);super(e,t)}}class E{constructor(e){this.rawMetadata=e}get identifier(){var e;return(e=this.rawMetadata)===null||e===void 0?void 0:e.identifier}get addeddate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.addeddate?new W(this.rawMetadata.addeddate):void 0}get audio_codec(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.audio_codec?new S(this.rawMetadata.audio_codec):void 0}get audio_sample_rate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.audio_sample_rate?new U(this.rawMetadata.audio_sample_rate):void 0}get avg_rating(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.avg_rating?new U(this.rawMetadata.avg_rating):void 0}get collection(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.collection?new S(this.rawMetadata.collection):void 0}get collections_raw(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.collections_raw?new S(this.rawMetadata.collections_raw):void 0}get collection_size(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.collection_size?new Fi(this.rawMetadata.collection_size):void 0}get contributor(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.contributor?new S(this.rawMetadata.contributor):void 0}get coverage(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.coverage?new S(this.rawMetadata.coverage):void 0}get creator(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.creator?new S(this.rawMetadata.creator):void 0}get date(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.date?new W(this.rawMetadata.date):void 0}get description(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.description?new S(this.rawMetadata.description):void 0}get downloads(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.downloads?new U(this.rawMetadata.downloads):void 0}get duration(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.duration?new vo(this.rawMetadata.duration):void 0}get"external-identifier"(){var e,t;return!((e=this.rawMetadata)===null||e===void 0)&&e["external-identifier"]?new S((t=this.rawMetadata)===null||t===void 0?void 0:t["external-identifier"]):void 0}get files_count(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.files_count?new U(this.rawMetadata.files_count):void 0}get indexdate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.indexdate?new W(this.rawMetadata.indexdate):void 0}get isbn(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.isbn?new S(this.rawMetadata.isbn):void 0}get issue(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.issue?new S(this.rawMetadata.issue):void 0}get item_count(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.item_count?new U(this.rawMetadata.item_count):void 0}get item_size(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.item_size?new Fi(this.rawMetadata.item_size):void 0}get language(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.language?new S(this.rawMetadata.language):void 0}get length(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.length?new vo(this.rawMetadata.length):void 0}get lineage(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.lineage?new S(this.rawMetadata.lineage):void 0}get month(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.month?new U(this.rawMetadata.month):void 0}get mediatype(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.mediatype?new ui(this.rawMetadata.mediatype):void 0}get noindex(){var e;return((e=this.rawMetadata)===null||e===void 0?void 0:e.noindex)!=null?new ht(this.rawMetadata.noindex):void 0}get notes(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.notes?new S(this.rawMetadata.notes):void 0}get num_favorites(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.num_favorites?new U(this.rawMetadata.num_favorites):void 0}get num_reviews(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.num_reviews?new U(this.rawMetadata.num_reviews):void 0}get openlibrary_edition(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.openlibrary_edition?new S(this.rawMetadata.openlibrary_edition):void 0}get openlibrary_work(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.openlibrary_work?new S(this.rawMetadata.openlibrary_work):void 0}get page_progression(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.page_progression?new cl(this.rawMetadata.page_progression):void 0}get partner(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.partner?new S(this.rawMetadata.partner):void 0}get ppi(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.ppi?new U(this.rawMetadata.ppi):void 0}get publicdate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.publicdate?new W(this.rawMetadata.publicdate):void 0}get publisher(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.publisher?new S(this.rawMetadata.publisher):void 0}get reviewdate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.reviewdate?new W(this.rawMetadata.reviewdate):void 0}get runtime(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.runtime?new vo(this.rawMetadata.runtime):void 0}get scanner(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.scanner?new S(this.rawMetadata.scanner):void 0}get source(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.source?new S(this.rawMetadata.source):void 0}get start_localtime(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.start_localtime?new W(this.rawMetadata.start_localtime):void 0}get start_time(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.start_time?new W(this.rawMetadata.start_time):void 0}get stop_time(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.stop_time?new W(this.rawMetadata.stop_time):void 0}get subject(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.subject?new pl(this.rawMetadata.subject):void 0}get taper(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.taper?new S(this.rawMetadata.taper):void 0}get title(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.title?new S(this.rawMetadata.title):void 0}get transferer(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.transferer?new S(this.rawMetadata.transferer):void 0}get track(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.track?new U(this.rawMetadata.track):void 0}get type(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.type?new S(this.rawMetadata.type):void 0}get uploader(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.uploader?new S(this.rawMetadata.uploader):void 0}get utc_offset(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.utc_offset?new U(this.rawMetadata.utc_offset):void 0}get venue(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.venue?new S(this.rawMetadata.venue):void 0}get volume(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.volume?new S(this.rawMetadata.volume):void 0}get week(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.week?new U(this.rawMetadata.week):void 0}get year(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.year?new W(this.rawMetadata.year):void 0}get query(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.query?new S(this.rawMetadata.fields.query):void 0}get date_favorited(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.date_favorited?new W(this.rawMetadata.fields.date_favorited):void 0}get __href__(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.__href__?new S(this.rawMetadata.fields.__href__):void 0}}l([g()],E.prototype,"addeddate",null);l([g()],E.prototype,"audio_codec",null);l([g()],E.prototype,"audio_sample_rate",null);l([g()],E.prototype,"avg_rating",null);l([g()],E.prototype,"collection",null);l([g()],E.prototype,"collections_raw",null);l([g()],E.prototype,"collection_size",null);l([g()],E.prototype,"contributor",null);l([g()],E.prototype,"coverage",null);l([g()],E.prototype,"creator",null);l([g()],E.prototype,"date",null);l([g()],E.prototype,"description",null);l([g()],E.prototype,"downloads",null);l([g()],E.prototype,"duration",null);l([g()],E.prototype,"external-identifier",null);l([g()],E.prototype,"files_count",null);l([g()],E.prototype,"indexdate",null);l([g()],E.prototype,"isbn",null);l([g()],E.prototype,"issue",null);l([g()],E.prototype,"item_count",null);l([g()],E.prototype,"item_size",null);l([g()],E.prototype,"language",null);l([g()],E.prototype,"length",null);l([g()],E.prototype,"lineage",null);l([g()],E.prototype,"month",null);l([g()],E.prototype,"mediatype",null);l([g()],E.prototype,"noindex",null);l([g()],E.prototype,"notes",null);l([g()],E.prototype,"num_favorites",null);l([g()],E.prototype,"num_reviews",null);l([g()],E.prototype,"openlibrary_edition",null);l([g()],E.prototype,"openlibrary_work",null);l([g()],E.prototype,"page_progression",null);l([g()],E.prototype,"partner",null);l([g()],E.prototype,"ppi",null);l([g()],E.prototype,"publicdate",null);l([g()],E.prototype,"publisher",null);l([g()],E.prototype,"reviewdate",null);l([g()],E.prototype,"runtime",null);l([g()],E.prototype,"scanner",null);l([g()],E.prototype,"source",null);l([g()],E.prototype,"start_localtime",null);l([g()],E.prototype,"start_time",null);l([g()],E.prototype,"stop_time",null);l([g()],E.prototype,"subject",null);l([g()],E.prototype,"taper",null);l([g()],E.prototype,"title",null);l([g()],E.prototype,"transferer",null);l([g()],E.prototype,"track",null);l([g()],E.prototype,"type",null);l([g()],E.prototype,"uploader",null);l([g()],E.prototype,"utc_offset",null);l([g()],E.prototype,"venue",null);l([g()],E.prototype,"volume",null);l([g()],E.prototype,"week",null);l([g()],E.prototype,"year",null);l([g()],E.prototype,"query",null);l([g()],E.prototype,"date_favorited",null);l([g()],E.prototype,"__href__",null);class F{constructor(e){this.rawMetadata=e}get identifier(){var e,t;return(t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.identifier}get addeddate(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.addeddate?new W(this.rawMetadata.fields.addeddate):void 0}get avg_rating(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.avg_rating)!=null?new U(this.rawMetadata.fields.avg_rating):void 0}get collection(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.collection?new S(this.rawMetadata.fields.collection):void 0}get collection_files_count(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.collection_files_count)!=null?new U(this.rawMetadata.fields.collection_files_count):void 0}get collection_size(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.collection_size)!=null?new Fi(this.rawMetadata.fields.collection_size):void 0}get creator(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.creator?new S(this.rawMetadata.fields.creator):void 0}get date(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.date?new W(this.rawMetadata.fields.date):void 0}get description(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.description?new S(this.rawMetadata.fields.description):void 0}get downloads(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.downloads)!=null?new U(this.rawMetadata.fields.downloads):void 0}get files_count(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.files_count)!=null?new U(this.rawMetadata.fields.files_count):void 0}get genre(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.genre?new S(this.rawMetadata.fields.genre):void 0}get indexflag(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.indexflag?new S(this.rawMetadata.fields.indexflag):void 0}get issue(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.issue?new S(this.rawMetadata.fields.issue):void 0}get item_count(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.item_count)!=null?new U(this.rawMetadata.fields.item_count):void 0}get item_size(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.item_size)!=null?new Fi(this.rawMetadata.fields.item_size):void 0}get language(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.language?new S(this.rawMetadata.fields.language):void 0}get lending___available_to_borrow(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.lending___available_to_borrow)!=null?new ht(this.rawMetadata.fields.lending___available_to_borrow):void 0}get lending___available_to_browse(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.lending___available_to_browse)!=null?new ht(this.rawMetadata.fields.lending___available_to_browse):void 0}get lending___available_to_waitlist(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.lending___available_to_waitlist)!=null?new ht(this.rawMetadata.fields.lending___available_to_waitlist):void 0}get lending___status(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.lending___status?new S(this.rawMetadata.fields.lending___status):void 0}get licenseurl(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.licenseurl?new S(this.rawMetadata.fields.licenseurl):void 0}get mediatype(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.mediatype?new ui(this.rawMetadata.fields.mediatype):void 0}get month(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.month)!=null?new U(this.rawMetadata.fields.month):void 0}get noindex(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.noindex)!=null?new ht(this.rawMetadata.fields.noindex):void 0}get num_favorites(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.num_favorites)!=null?new U(this.rawMetadata.fields.num_favorites):void 0}get num_reviews(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.num_reviews)!=null?new U(this.rawMetadata.fields.num_reviews):void 0}get publicdate(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.publicdate?new W(this.rawMetadata.fields.publicdate):void 0}get reviewdate(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.reviewdate?new W(this.rawMetadata.fields.reviewdate):void 0}get review(){var e;const t=(e=this.rawMetadata)===null||e===void 0?void 0:e.review;return t?{body:t.reviewbody,title:t.reviewtitle,author:t.reviewer,authorItem:t.reviewer_itemname,updatedate:new Date(t.reviewdate),createdate:new Date(t.createdate),stars:Number(t.stars)||0,__href__:t.__href__}:void 0}get source(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.source?new S(this.rawMetadata.fields.source):void 0}get subject(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.subject?new S(this.rawMetadata.fields.subject):void 0}get title(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.title?new S(this.rawMetadata.fields.title):void 0}get type(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.type?new S(this.rawMetadata.fields.type):void 0}get volume(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.volume?new S(this.rawMetadata.fields.volume):void 0}get week(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.week)!=null?new U(this.rawMetadata.fields.week):void 0}get year(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.year)!=null?new U(this.rawMetadata.fields.year):void 0}}l([g()],F.prototype,"addeddate",null);l([g()],F.prototype,"avg_rating",null);l([g()],F.prototype,"collection",null);l([g()],F.prototype,"collection_files_count",null);l([g()],F.prototype,"collection_size",null);l([g()],F.prototype,"creator",null);l([g()],F.prototype,"date",null);l([g()],F.prototype,"description",null);l([g()],F.prototype,"downloads",null);l([g()],F.prototype,"files_count",null);l([g()],F.prototype,"genre",null);l([g()],F.prototype,"indexflag",null);l([g()],F.prototype,"issue",null);l([g()],F.prototype,"item_count",null);l([g()],F.prototype,"item_size",null);l([g()],F.prototype,"language",null);l([g()],F.prototype,"lending___available_to_borrow",null);l([g()],F.prototype,"lending___available_to_browse",null);l([g()],F.prototype,"lending___available_to_waitlist",null);l([g()],F.prototype,"lending___status",null);l([g()],F.prototype,"licenseurl",null);l([g()],F.prototype,"mediatype",null);l([g()],F.prototype,"month",null);l([g()],F.prototype,"noindex",null);l([g()],F.prototype,"num_favorites",null);l([g()],F.prototype,"num_reviews",null);l([g()],F.prototype,"publicdate",null);l([g()],F.prototype,"reviewdate",null);l([g()],F.prototype,"review",null);l([g()],F.prototype,"source",null);l([g()],F.prototype,"subject",null);l([g()],F.prototype,"title",null);l([g()],F.prototype,"type",null);l([g()],F.prototype,"volume",null);l([g()],F.prototype,"week",null);l([g()],F.prototype,"year",null);class K{constructor(e){this.rawMetadata=e}get identifier(){var e,t;return(t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.identifier}get highlight(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.highlight)===null||t===void 0)&&t.text?new S(this.rawMetadata.highlight.text):void 0}get addeddate(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.addeddate?new W(this.rawMetadata.fields.addeddate):void 0}get avg_rating(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.avg_rating)!=null?new U(this.rawMetadata.fields.avg_rating):void 0}get collection(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.collection?new S(this.rawMetadata.fields.collection):void 0}get created_on(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.created_on?new W(this.rawMetadata.fields.created_on):void 0}get creator(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.creator?new S(this.rawMetadata.fields.creator):void 0}get date(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.date?new W(this.rawMetadata.fields.date):void 0}get description(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.description?new S(this.rawMetadata.fields.description):void 0}get downloads(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.downloads)!=null?new U(this.rawMetadata.fields.downloads):void 0}get filename(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.filename?new S(this.rawMetadata.fields.filename):void 0}get file_basename(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.file_basename?new S(this.rawMetadata.fields.file_basename):void 0}get file_creation_mtime(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.file_creation_mtime)!=null?new U(this.rawMetadata.fields.file_creation_mtime):void 0}get issue(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.issue?new S(this.rawMetadata.fields.issue):void 0}get mediatype(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.mediatype?new ui(this.rawMetadata.fields.mediatype):void 0}get page_num(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.page_num)!=null?new U(this.rawMetadata.fields.page_num):void 0}get publicdate(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.publicdate?new W(this.rawMetadata.fields.publicdate):void 0}get result_in_subfile(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.result_in_subfile)!=null?new ht(this.rawMetadata.fields.result_in_subfile):void 0}get reviewdate(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.reviewdate?new W(this.rawMetadata.fields.reviewdate):void 0}get source(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.source?new S(this.rawMetadata.fields.source):void 0}get subject(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.subject?new S(this.rawMetadata.fields.subject):void 0}get title(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.title?new S(this.rawMetadata.fields.title):void 0}get updated_on(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.updated_on?new W(this.rawMetadata.fields.updated_on):void 0}get year(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.year)!=null?new U(this.rawMetadata.fields.year):void 0}get __href__(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.__href__?new S(this.rawMetadata.fields.__href__):void 0}}l([g()],K.prototype,"highlight",null);l([g()],K.prototype,"addeddate",null);l([g()],K.prototype,"avg_rating",null);l([g()],K.prototype,"collection",null);l([g()],K.prototype,"created_on",null);l([g()],K.prototype,"creator",null);l([g()],K.prototype,"date",null);l([g()],K.prototype,"description",null);l([g()],K.prototype,"downloads",null);l([g()],K.prototype,"filename",null);l([g()],K.prototype,"file_basename",null);l([g()],K.prototype,"file_creation_mtime",null);l([g()],K.prototype,"issue",null);l([g()],K.prototype,"mediatype",null);l([g()],K.prototype,"page_num",null);l([g()],K.prototype,"publicdate",null);l([g()],K.prototype,"result_in_subfile",null);l([g()],K.prototype,"reviewdate",null);l([g()],K.prototype,"source",null);l([g()],K.prototype,"subject",null);l([g()],K.prototype,"title",null);l([g()],K.prototype,"updated_on",null);l([g()],K.prototype,"year",null);l([g()],K.prototype,"__href__",null);var Q;(function(a){a[a.COUNT=0]="COUNT",a[a.ALPHABETICAL=1]="ALPHABETICAL",a[a.NUMERIC=2]="NUMERIC"})(Q||(Q={}));class as{constructor(e){this.buckets=e.buckets,this.doc_count_error_upper_bound=e.doc_count_error_upper_bound,this.sum_other_doc_count=e.sum_other_doc_count,this.first_bucket_key=e.first_bucket_key,this.last_bucket_key=e.last_bucket_key,this.number_buckets=e.number_buckets,this.interval=e.interval}getSortedBuckets(e){const t=[...this.buckets];if(this.isRawNumberBuckets(t))return t;const i=new Intl.Collator;switch(e){case Q.ALPHABETICAL:return t.sort((o,r)=>i.compare(o.key.toString(),r.key.toString()));case Q.NUMERIC:return t.sort((o,r)=>Number(r.key)-Number(o.key));case Q.COUNT:default:return t}}isRawNumberBuckets(e){return typeof this.buckets[0]=="number"}}l([g()],as.prototype,"getSortedBuckets",null);class vi{constructor(e){this.rawMetadata=e}get identifier(){var e;return(e=this.rawMetadata)===null||e===void 0?void 0:e.fields.query}get title(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.title?new S(this.rawMetadata.fields.title):void 0}get query(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.query?new S(this.rawMetadata.fields.query):void 0}get date_favorited(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.date_favorited?new W(this.rawMetadata.fields.date_favorited):void 0}get __href__(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.__href__?new S(this.rawMetadata.fields.__href__):void 0}}l([g()],vi.prototype,"title",null);l([g()],vi.prototype,"query",null);l([g()],vi.prototype,"date_favorited",null);l([g()],vi.prototype,"__href__",null);class Ki{constructor(e){this.rawMetadata=e}get identifier(){var e,t;return(t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.url}get mediatype(){return new ui("web")}get title(){var e,t,i;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.url?new S((i=this.rawMetadata.fields)===null||i===void 0?void 0:i.url):void 0}get capture_dates(){var e,t,i;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.capture_dates?new W((i=this.rawMetadata.fields)===null||i===void 0?void 0:i.capture_dates):void 0}get __href__(){var e,t,i;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.__href__?new S((i=this.rawMetadata.fields)===null||i===void 0?void 0:i.__href__):void 0}}l([g()],Ki.prototype,"title",null);l([g()],Ki.prototype,"capture_dates",null);l([g()],Ki.prototype,"__href__",null);class Y{constructor(e){this.rawMetadata=e}get identifier(){var e,t;return(t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.identifier}get highlight(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.highlight)===null||t===void 0)&&t.text?new S(this.rawMetadata.highlight.text):void 0}get addeddate(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.addeddate?new W(this.rawMetadata.fields.addeddate):void 0}get avg_rating(){var e,t,i;const o=(t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.avg_rating;return o||o===0?new U((i=this.rawMetadata)===null||i===void 0?void 0:i.fields.avg_rating):void 0}get collection(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.collection?new S(this.rawMetadata.fields.collection):void 0}get created_on(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.created_on?new W(this.rawMetadata.fields.created_on):void 0}get creator(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.creator?new S(this.rawMetadata.fields.creator):void 0}get date(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.date?new W(this.rawMetadata.fields.date):void 0}get description(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.description?new S(this.rawMetadata.fields.description):void 0}get downloads(){var e,t,i;const o=(t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.downloads;return o||o===0?new U((i=this.rawMetadata)===null||i===void 0?void 0:i.fields.downloads):void 0}get filename(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.filename?new S(this.rawMetadata.fields.filename):void 0}get file_basename(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.file_basename?new S(this.rawMetadata.fields.file_basename):void 0}get file_creation_mtime(){var e,t,i;const o=(t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.file_creation_mtime;return o||o===0?new U((i=this.rawMetadata)===null||i===void 0?void 0:i.fields.file_creation_mtime):void 0}get issue(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.issue?new S(this.rawMetadata.fields.issue):void 0}get mediatype(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.mediatype?new ui(this.rawMetadata.fields.mediatype):void 0}get publicdate(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.publicdate?new W(this.rawMetadata.fields.publicdate):void 0}get result_in_subfile(){var e,t,i;const o=(t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.result_in_subfile;return o||o===!1?new ht((i=this.rawMetadata)===null||i===void 0?void 0:i.fields.result_in_subfile):void 0}get reviewdate(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.reviewdate?new W(this.rawMetadata.fields.reviewdate):void 0}get source(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.source?new S(this.rawMetadata.fields.source):void 0}get subject(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.subject?new S(this.rawMetadata.fields.subject):void 0}get title(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.title?new S(this.rawMetadata.fields.title):void 0}get updated_on(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.updated_on?new W(this.rawMetadata.fields.updated_on):void 0}get year(){var e,t,i;const o=(t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.year;return o||o===0?new U((i=this.rawMetadata)===null||i===void 0?void 0:i.fields.year):void 0}get start(){var e,t,i;const o=(t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.start;return o||o===0?new S((i=this.rawMetadata)===null||i===void 0?void 0:i.fields.start):void 0}get __href__(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.__href__?new S(this.rawMetadata.fields.__href__):void 0}}l([g()],Y.prototype,"highlight",null);l([g()],Y.prototype,"addeddate",null);l([g()],Y.prototype,"avg_rating",null);l([g()],Y.prototype,"collection",null);l([g()],Y.prototype,"created_on",null);l([g()],Y.prototype,"creator",null);l([g()],Y.prototype,"date",null);l([g()],Y.prototype,"description",null);l([g()],Y.prototype,"downloads",null);l([g()],Y.prototype,"filename",null);l([g()],Y.prototype,"file_basename",null);l([g()],Y.prototype,"file_creation_mtime",null);l([g()],Y.prototype,"issue",null);l([g()],Y.prototype,"mediatype",null);l([g()],Y.prototype,"publicdate",null);l([g()],Y.prototype,"result_in_subfile",null);l([g()],Y.prototype,"reviewdate",null);l([g()],Y.prototype,"source",null);l([g()],Y.prototype,"subject",null);l([g()],Y.prototype,"title",null);l([g()],Y.prototype,"updated_on",null);l([g()],Y.prototype,"year",null);l([g()],Y.prototype,"start",null);l([g()],Y.prototype,"__href__",null);const ul=["loans","waitlist","loan_history"];function vl(a){const e=a.slice(0,4),t=a.slice(4,6),i=a.slice(6,8),o=a.slice(8,10),r=a.slice(10,12),s=a.slice(12,14);return`${e}-${t}-${i}T${o}:${r}:${s}Z`}function fl(a){var e;const t=[];for(const i of a){if(!(!((e=i.captures)===null||e===void 0)&&e.length))continue;const o=encodeURIComponent(i.url),r=`https://web.archive.org/web/${i.captures[0]}/${o}`;t.push({hit_type:"web_archive",fields:{url:i.url,capture_dates:i.captures.map(s=>vl(s)),__href__:r}})}return t}class wa{constructor(e,t){var i,o,r,s,n,d,p,u,m,y,w,x,C,A;this.schema=t,this.schemaHitType=t==null?void 0:t.hit_type;let D;e!=null&&e.page_elements&&(this.pageElements=e.page_elements,D=Object.values(this.pageElements)[0]);let L=(i=e==null?void 0:e.hits)===null||i===void 0?void 0:i.hits;this.totalResults=(r=(o=e==null?void 0:e.hits)===null||o===void 0?void 0:o.total)!==null&&r!==void 0?r:0,this.returnedCount=(n=(s=e==null?void 0:e.hits)===null||s===void 0?void 0:s.returned)!==null&&n!==void 0?n:0,!(L!=null&&L.length)&&((d=this.pageElements)===null||d===void 0?void 0:d.service___fts)?(this.totalResults=0,this.returnedCount=0,this.handleFederatedPageElements()):!(L!=null&&L.length)&&((p=D==null?void 0:D.hits)===null||p===void 0?void 0:p.hits)?(L=D.hits.hits,this.totalResults=(u=D.hits.total)!==null&&u!==void 0?u:0,this.returnedCount=(m=D.hits.returned)!==null&&m!==void 0?m:0):!((y=this.pageElements)===null||y===void 0)&&y.lending?L=this.handleLendingPageElement():!((w=this.pageElements)===null||w===void 0)&&w.web_archives&&(L=this.handleWebArchivesPageElement()),this.results=this.formatHits(L);let G=e==null?void 0:e.aggregations;!(this.aggregations&&Object.keys(this.aggregations).length>0)&&(D==null?void 0:D.aggregations)&&(G=D.aggregations),G&&this.buildAggregations(G),e!=null&&e.collection_titles&&(this.collectionTitles=(x=e.collection_titles)!==null&&x!==void 0?x:{}),e!=null&&e.collection_extra_info&&(this.collectionExtraInfo=(C=e.collection_extra_info)!==null&&C!==void 0?C:null),e!=null&&e.account_extra_info&&(this.accountExtraInfo=(A=e.account_extra_info)!==null&&A!==void 0?A:null)}formatHits(e){var t;return(t=e==null?void 0:e.map(i=>{var o;return wa.createResult((o=i.hit_type)!==null&&o!==void 0?o:this.schemaHitType,i)}))!==null&&t!==void 0?t:[]}buildAggregations(e){this.aggregations=Object.entries(e).reduce((t,[i,o])=>(t[i]=new as(o),t),{})}handleLendingPageElement(){var e,t;const i=(e=this.pageElements)===null||e===void 0?void 0:e.lending,o=(t=i.loans)!==null&&t!==void 0?t:[];this.totalResults=o.length,this.returnedCount=this.totalResults;for(const r of ul)i[r]=this.formatHits(i[r]);return o}handleWebArchivesPageElement(){var e;const t=fl((e=this.pageElements)===null||e===void 0?void 0:e.web_archives);return this.totalResults=t.length,this.returnedCount=this.totalResults,t}handleFederatedPageElements(){var e,t,i,o;const r=["service___fts","service___tvs","service___rcs","service___whisper"];for(const s of r){const n=this.removeServicePrefix(s);this.federatedResults?this.federatedResults[s]=[]:this.federatedResults={[n]:[]};const d=(t=(e=this.pageElements)===null||e===void 0?void 0:e[s])===null||t===void 0?void 0:t.hits;d!=null&&d.hits&&(this.federatedResults[n]=this.formatHits(d==null?void 0:d.hits)),this.totalResults+=(i=d==null?void 0:d.total)!==null&&i!==void 0?i:0,this.returnedCount+=(o=d==null?void 0:d.returned)!==null&&o!==void 0?o:0}}removeServicePrefix(e){return e.split("___")[1]}static createResult(e,t){switch(e){case"item":return new F(t);case"text":case"asr_text":return new K(t);case"favorited_search":return new vi(t);case"web_archive":return new Ki(t);case"tv_clip":return new Y(t);default:return new F(t)}}}class ml{constructor(e){this.clientParameters=e.client_parameters,this.backendRequests=e.backend_requests,this.kind=e.kind}}class gl{constructor(e){var t,i,o;this.rawResponse=e,this.request=new ml(e.request),this.responseHeader=(t=e.response)===null||t===void 0?void 0:t.header,this.sessionContext=e.session_context,this.response=new wa((i=e.response)===null||i===void 0?void 0:i.body,(o=e.response)===null||o===void 0?void 0:o.hit_schema)}}class Yi{static aggregateSearchParamsAsString(e){if(e.omit)return"false";if(e.advancedParams){const t=e.advancedParams.map(o=>({terms:o}));return JSON.stringify(t)}if(e.simpleParams)return e.simpleParams.join(",")}static sortParamsAsString(e){return`${e.field}:${e.direction}`}static filterParamsAsString(e){return JSON.stringify(e)}static generateURLSearchParams(e){const t=new URLSearchParams;if(t.append("user_query",e.query),e.pageType&&t.append("page_type",String(e.pageType)),e.pageTarget&&t.append("page_target",String(e.pageTarget)),e.pageElements&&e.pageElements.length>0){const r=`[${e.pageElements.map(s=>`"${s}"`).join(",")}]`;t.append("page_elements",r)}if(e.rows!=null&&t.append("hits_per_page",String(e.rows)),e.page!=null&&t.append("page",String(e.page)),e.fields&&e.fields.length>0&&t.append("fields",e.fields.join(",")),e.filters&&Object.keys(e.filters).length>0){const o=this.filterParamsAsString(e.filters);o&&o!=="{}"&&t.append("filter_map",o)}if(e.sort&&e.sort.length>0){const o=e.sort.map(r=>this.sortParamsAsString(r));t.append("sort",o.join(","))}const i=e.aggregations;if(i){const o=this.aggregateSearchParamsAsString(i);o&&t.append("aggregations",o)}if(e.aggregationsSize!=null&&t.append("aggregations_size",String(e.aggregationsSize)),e.debugging&&t.append("debugging","true"),e.uid&&t.append("uid",e.uid),e.includeClientUrl!==!1){const o=window.location.href.slice(0,400);e.query.length<=1e3&&t.append("client_url",o)}return t}}var ii;(function(a){a.networkError="SearchService.NetworkError",a.itemNotFound="SearchService.ItemNotFound",a.decodingError="SearchService.DecodingError",a.searchEngineError="SearchService.SearchEngineError"})(ii||(ii={}));class bl extends Error{constructor(e,t,i){super(t),this.name=e,this.type=e,this.details=i}}const er={reCache:JSON.stringify({recompute:!0}),noCache:JSON.stringify({bypass:!0}),dontCache:JSON.stringify({no_compute:!0})};class Xi{constructor(e){var t,i;this.baseUrl=(t=e==null?void 0:e.baseUrl)!==null&&t!==void 0?t:"archive.org",(e==null?void 0:e.includeCredentials)!==void 0?this.includeCredentials=e.includeCredentials:this.includeCredentials=window.location.href.match(/^https?:\/\/.*archive\.org(:[0-9]+)?/)!==null;const o=new URL(window.location.href).searchParams,r=o.get("scope"),s=o.get("verbose"),n=o.get("debugging"),d=o.get("cacheDebug");let p="";for(const u of Object.keys(er))if(o.get(u)){p=er[u];break}p=(i=o.get("caching"))!==null&&i!==void 0?i:p,(e==null?void 0:e.caching)!==void 0?this.cachingFlags=e.caching:p&&(this.cachingFlags=p),(e==null?void 0:e.debuggingEnabled)!==void 0?this.debuggingEnabled=e.debuggingEnabled:(n||d)&&(this.debuggingEnabled=!0),(e==null?void 0:e.scope)!==void 0?this.requestScope=e.scope:r&&(this.requestScope=r),(e==null?void 0:e.verbose)!==void 0?this.verbose=e.verbose:s&&(this.verbose=!!s)}async fetchUrl(e,t){var i,o;const r=new URL(e);this.requestScope&&r.searchParams.set("scope",this.requestScope),this.cachingFlags&&r.searchParams.set("caching",this.cachingFlags);let s;try{const n=(i=t==null?void 0:t.requestOptions)!==null&&i!==void 0?i:{credentials:this.includeCredentials?"include":"same-origin"};s=await fetch(r.href,n)}catch(n){const d=n instanceof Error?n.message:typeof n=="string"?n:"Unknown error";return this.getErrorResult(ii.networkError,d)}try{const n=await s.json();this.verbose&&this.printResponse(n),n.debugging&&this.printDebuggingInfo(n);const d=(o=n.response)===null||o===void 0?void 0:o.error;return d?this.getErrorResult(ii.searchEngineError,d.message,d.forensics):{success:n}}catch(n){const d=n instanceof Error?n.message:typeof n=="string"?n:"Unknown error";return this.getErrorResult(ii.decodingError,d)}}getErrorResult(e,t,i){return{error:new bl(e,t,i)}}printResponse(e){var t,i,o,r,s;try{const n=JSON.parse(JSON.stringify(e)),d=(o=(i=(t=n==null?void 0:n.response)===null||t===void 0?void 0:t.body)===null||i===void 0?void 0:i.hits)===null||o===void 0?void 0:o.hits;if(Array.isArray(d)&&d.length>1){const u=[];u.push(d[0]),u.push(`*** ${d.length-1} hits omitted ***`),n.response.body.hits.hits=u}const p=(s=(r=n==null?void 0:n.response)===null||r===void 0?void 0:r.body)===null||s===void 0?void 0:s.aggregations;p&&Object.entries(p).forEach(([u,m])=>{var y,w,x,C;if(((w=(y=m)===null||y===void 0?void 0:y.buckets)===null||w===void 0?void 0:w.length)>0){const A=JSON.parse(JSON.stringify(m));A.buckets=`*** ${(C=(x=A.buckets)===null||x===void 0?void 0:x.length)!==null&&C!==void 0?C:0} buckets omitted ***`,n.response.body.aggregations[u]=A}}),console.log("***** RESPONSE RECEIVED *****"),console.groupCollapsed("Response"),console.log(JSON.stringify(n,null,2)),console.groupEnd()}catch(n){console.error("Error printing search response:",n)}}printDebuggingInfo(e){var t,i;const o=e.debugging,r=(t=o.messages)!==null&&t!==void 0?t:[],s=(i=o.data)!==null&&i!==void 0?i:{};console.log("***** BEGIN DEBUGGING *****"),console.log("Full response:"),console.log(JSON.stringify(e,null,2)),console.group("Debug messages");for(const n of r)console.log(n);console.groupEnd(),console.group("Debug data");for(const[n,d]of Object.entries(s))console.log(n,d);console.groupEnd(),console.log("***** END DEBUGGING *****")}}class yl extends Xi{constructor(e){var t;super(e),this.servicePath=(t=e==null?void 0:e.servicePath)!==null&&t!==void 0?t:"/services/search/beta/page_production"}async performSearch(e){this.debuggingEnabled&&e.debugging===void 0&&(e.debugging=!0);const i=Yi.generateURLSearchParams(e).toString(),o=`https://${this.baseUrl}${this.servicePath}/?${i}`;return this.fetchUrl(o)}}class wl extends Xi{constructor(e){var t;super(e),this.servicePath=(t=e==null?void 0:e.servicePath)!==null&&t!==void 0?t:"/services/search/beta/page_production"}async performSearch(e){this.debuggingEnabled&&e.debugging===void 0&&(e.debugging=!0);const i=Yi.generateURLSearchParams(e).toString(),o=`https://${this.baseUrl}${this.servicePath}/?service_backend=fts&${i}`;return this.fetchUrl(o)}}class _l extends Xi{constructor(e){var t;super(e),this.servicePath=(t=e==null?void 0:e.servicePath)!==null&&t!==void 0?t:"/services/search/beta/page_production"}async performSearch(e){this.debuggingEnabled&&e.debugging===void 0&&(e.debugging=!0);const i=Yi.generateURLSearchParams(e).toString(),o=`https://${this.baseUrl}${this.servicePath}/?service_backend=rcs&${i}`;return this.fetchUrl(o)}}var le;(function(a){a[a.METADATA=0]="METADATA",a[a.FULLTEXT=1]="FULLTEXT",a[a.RADIO=3]="RADIO",a[a.FEDERATED=4]="FEDERATED"})(le||(le={}));class xl extends Xi{constructor(e){var t;super(e),this.servicePath=(t=e==null?void 0:e.servicePath)!==null&&t!==void 0?t:"/services/search/beta/page_production"}async performSearch(e){this.debuggingEnabled&&e.debugging===void 0&&(e.debugging=!0);const i=Yi.generateURLSearchParams(e).toString(),o=`https://${this.baseUrl}${this.servicePath}/?page_type=simple_federation&${i}`;return this.fetchUrl(o)}}class De{constructor(e={}){this.backendOptions=e}async search(e,t=le.METADATA){const o=await De.getBackendForSearchType(t,this.backendOptions).performSearch(e);return o.error?o:{success:new gl(o.success)}}static getBackendForSearchType(e,t={}){switch(e){case le.FULLTEXT:return new wl(t);case le.RADIO:return new _l(t);case le.FEDERATED:return new xl(t);case le.METADATA:default:return new yl(t)}}}De.default=new De;l([g((a,e={})=>{const{includeCredentials:t=!1,verbose:i=!1,scope:o="",baseUrl:r=""}=e;return`${a};${t};${i};${o};${r}`})],De,"getBackendForSearchType",null);var Ye;(function(a){a.INCLUDE="inc",a.EXCLUDE="exc",a.GREATER_THAN="gt",a.GREATER_OR_EQUAL="gte",a.LESS_THAN="lt",a.LESS_OR_EQUAL="lte"})(Ye||(Ye={}));class $l{constructor(){this.filterMap={}}addFilter(e,t,i){if(this.filterMap[e]||(this.filterMap[e]={}),this.filterMap[e][t]){const o=[].concat(this.filterMap[e][t],i);this.filterMap[e][t]=Array.from(new Set(o))}else this.filterMap[e][t]=i;return this}removeSingleFilter(e,t,i){var o;if(!(!((o=this.filterMap[e])===null||o===void 0)&&o[t]))return this;const r=[].concat(this.filterMap[e][t]),s=r.indexOf(i);return s>=0&&r.splice(s,1),this.filterMap[e][t]=r.length===1?r[0]:r,r.length===0&&delete this.filterMap[e][t],this.deleteFieldIfEmpty(e),this}removeFilters(e,t){return this.filterMap[e]?(delete this.filterMap[e][t],this.deleteFieldIfEmpty(e),this):this}deleteFieldIfEmpty(e){const t=this.filterMap[e];t&&Object.keys(t).length===0&&delete this.filterMap[e]}setFilterMap(e){return this.filterMap=J({},e),this}mergeFilterMap(e){for(const[t,i]of Object.entries(e))for(const[o,r]of Object.entries(i))if(Array.isArray(r))for(const s of r)this.addFilter(t,o,s);else this.addFilter(t,o,r);return this}build(){return this.filterMap}}/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const _a=window.ShadowRoot&&(window.ShadyCSS===void 0||window.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,xa=Symbol(),tr=new Map;class rs{constructor(e,t){if(this._$cssResult$=!0,t!==xa)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e}get styleSheet(){let e=tr.get(this.cssText);return _a&&e===void 0&&(tr.set(this.cssText,e=new CSSStyleSheet),e.replaceSync(this.cssText)),e}toString(){return this.cssText}}const Sl=a=>new rs(typeof a=="string"?a:a+"",xa),f=(a,...e)=>{const t=a.length===1?a[0]:e.reduce((i,o,r)=>i+(s=>{if(s._$cssResult$===!0)return s.cssText;if(typeof s=="number")return s;throw Error("Value passed to 'css' function must be a 'css' function result: "+s+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(o)+a[r+1],a[0]);return new rs(t,xa)},Cl=(a,e)=>{_a?a.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet):e.forEach(t=>{const i=document.createElement("style"),o=window.litNonce;o!==void 0&&i.setAttribute("nonce",o),i.textContent=t.cssText,a.appendChild(i)})},ir=_a?a=>a:a=>a instanceof CSSStyleSheet?(e=>{let t="";for(const i of e.cssRules)t+=i.cssText;return Sl(t)})(a):a;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var fo;const or=window.trustedTypes,kl=or?or.emptyScript:"",ar=window.reactiveElementPolyfillSupport,qo={toAttribute(a,e){switch(e){case Boolean:a=a?kl:null;break;case Object:case Array:a=a==null?a:JSON.stringify(a)}return a},fromAttribute(a,e){let t=a;switch(e){case Boolean:t=a!==null;break;case Number:t=a===null?null:Number(a);break;case Object:case Array:try{t=JSON.parse(a)}catch{t=null}}return t}},ss=(a,e)=>e!==a&&(e==e||a==a),mo={attribute:!0,type:String,converter:qo,reflect:!1,hasChanged:ss};class Ct extends HTMLElement{constructor(){super(),this._$Et=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Ei=null,this.o()}static addInitializer(e){var t;(t=this.l)!==null&&t!==void 0||(this.l=[]),this.l.push(e)}static get observedAttributes(){this.finalize();const e=[];return this.elementProperties.forEach((t,i)=>{const o=this._$Eh(i,t);o!==void 0&&(this._$Eu.set(o,i),e.push(o))}),e}static createProperty(e,t=mo){if(t.state&&(t.attribute=!1),this.finalize(),this.elementProperties.set(e,t),!t.noAccessor&&!this.prototype.hasOwnProperty(e)){const i=typeof e=="symbol"?Symbol():"__"+e,o=this.getPropertyDescriptor(e,i,t);o!==void 0&&Object.defineProperty(this.prototype,e,o)}}static getPropertyDescriptor(e,t,i){return{get(){return this[t]},set(o){const r=this[e];this[t]=o,this.requestUpdate(e,r,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)||mo}static finalize(){if(this.hasOwnProperty("finalized"))return!1;this.finalized=!0;const e=Object.getPrototypeOf(this);if(e.finalize(),this.elementProperties=new Map(e.elementProperties),this._$Eu=new Map,this.hasOwnProperty("properties")){const t=this.properties,i=[...Object.getOwnPropertyNames(t),...Object.getOwnPropertySymbols(t)];for(const o of i)this.createProperty(o,t[o])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const i=new Set(e.flat(1/0).reverse());for(const o of i)t.unshift(ir(o))}else e!==void 0&&t.push(ir(e));return t}static _$Eh(e,t){const i=t.attribute;return i===!1?void 0:typeof i=="string"?i:typeof e=="string"?e.toLowerCase():void 0}o(){var e;this._$Ep=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$Em(),this.requestUpdate(),(e=this.constructor.l)===null||e===void 0||e.forEach(t=>t(this))}addController(e){var t,i;((t=this._$Eg)!==null&&t!==void 0?t:this._$Eg=[]).push(e),this.renderRoot!==void 0&&this.isConnected&&((i=e.hostConnected)===null||i===void 0||i.call(e))}removeController(e){var t;(t=this._$Eg)===null||t===void 0||t.splice(this._$Eg.indexOf(e)>>>0,1)}_$Em(){this.constructor.elementProperties.forEach((e,t)=>{this.hasOwnProperty(t)&&(this._$Et.set(t,this[t]),delete this[t])})}createRenderRoot(){var e;const t=(e=this.shadowRoot)!==null&&e!==void 0?e:this.attachShadow(this.constructor.shadowRootOptions);return Cl(t,this.constructor.elementStyles),t}connectedCallback(){var e;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$Eg)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostConnected)===null||i===void 0?void 0:i.call(t)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$Eg)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostDisconnected)===null||i===void 0?void 0:i.call(t)})}attributeChangedCallback(e,t,i){this._$AK(e,i)}_$ES(e,t,i=mo){var o,r;const s=this.constructor._$Eh(e,i);if(s!==void 0&&i.reflect===!0){const n=((r=(o=i.converter)===null||o===void 0?void 0:o.toAttribute)!==null&&r!==void 0?r:qo.toAttribute)(t,i.type);this._$Ei=e,n==null?this.removeAttribute(s):this.setAttribute(s,n),this._$Ei=null}}_$AK(e,t){var i,o,r;const s=this.constructor,n=s._$Eu.get(e);if(n!==void 0&&this._$Ei!==n){const d=s.getPropertyOptions(n),p=d.converter,u=(r=(o=(i=p)===null||i===void 0?void 0:i.fromAttribute)!==null&&o!==void 0?o:typeof p=="function"?p:null)!==null&&r!==void 0?r:qo.fromAttribute;this._$Ei=n,this[n]=u(t,d.type),this._$Ei=null}}requestUpdate(e,t,i){let o=!0;e!==void 0&&(((i=i||this.constructor.getPropertyOptions(e)).hasChanged||ss)(this[e],t)?(this._$AL.has(e)||this._$AL.set(e,t),i.reflect===!0&&this._$Ei!==e&&(this._$EC===void 0&&(this._$EC=new Map),this._$EC.set(e,i))):o=!1),!this.isUpdatePending&&o&&(this._$Ep=this._$E_())}async _$E_(){this.isUpdatePending=!0;try{await this._$Ep}catch(t){Promise.reject(t)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var e;if(!this.isUpdatePending)return;this.hasUpdated,this._$Et&&(this._$Et.forEach((o,r)=>this[r]=o),this._$Et=void 0);let t=!1;const i=this._$AL;try{t=this.shouldUpdate(i),t?(this.willUpdate(i),(e=this._$Eg)===null||e===void 0||e.forEach(o=>{var r;return(r=o.hostUpdate)===null||r===void 0?void 0:r.call(o)}),this.update(i)):this._$EU()}catch(o){throw t=!1,this._$EU(),o}t&&this._$AE(i)}willUpdate(e){}_$AE(e){var t;(t=this._$Eg)===null||t===void 0||t.forEach(i=>{var o;return(o=i.hostUpdated)===null||o===void 0?void 0:o.call(i)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EU(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$Ep}shouldUpdate(e){return!0}update(e){this._$EC!==void 0&&(this._$EC.forEach((t,i)=>this._$ES(i,this[i],t)),this._$EC=void 0),this._$EU()}updated(e){}firstUpdated(e){}}Ct.finalized=!0,Ct.elementProperties=new Map,Ct.elementStyles=[],Ct.shadowRootOptions={mode:"open"},ar==null||ar({ReactiveElement:Ct}),((fo=globalThis.reactiveElementVersions)!==null&&fo!==void 0?fo:globalThis.reactiveElementVersions=[]).push("1.3.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var go;const zt=globalThis.trustedTypes,rr=zt?zt.createPolicy("lit-html",{createHTML:a=>a}):void 0,Ve=`lit$${(Math.random()+"").slice(9)}$`,$a="?"+Ve,Tl=`<${$a}>`,Pt=document,ri=(a="")=>Pt.createComment(a),si=a=>a===null||typeof a!="object"&&typeof a!="function",ls=Array.isArray,ns=a=>{var e;return ls(a)||typeof((e=a)===null||e===void 0?void 0:e[Symbol.iterator])=="function"},Xt=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,sr=/-->/g,lr=/>/g,st=/>|[ 	\n\r](?:([^\s"'>=/]+)([ 	\n\r]*=[ 	\n\r]*(?:[^ 	\n\r"'`<>=]|("|')|))|$)/g,nr=/'/g,dr=/"/g,ds=/^(?:script|style|textarea|title)$/i,cs=a=>(e,...t)=>({_$litType$:a,strings:e,values:t}),c=cs(1),I=cs(2),Ce=Symbol.for("lit-noChange"),b=Symbol.for("lit-nothing"),cr=new WeakMap,Ei=(a,e,t)=>{var i,o;const r=(i=t==null?void 0:t.renderBefore)!==null&&i!==void 0?i:e;let s=r._$litPart$;if(s===void 0){const n=(o=t==null?void 0:t.renderBefore)!==null&&o!==void 0?o:null;r._$litPart$=s=new Ut(e.insertBefore(ri(),n),n,void 0,t!=null?t:{})}return s._$AI(a),s},Tt=Pt.createTreeWalker(Pt,129,null,!1),hs=(a,e)=>{const t=a.length-1,i=[];let o,r=e===2?"<svg>":"",s=Xt;for(let d=0;d<t;d++){const p=a[d];let u,m,y=-1,w=0;for(;w<p.length&&(s.lastIndex=w,m=s.exec(p),m!==null);)w=s.lastIndex,s===Xt?m[1]==="!--"?s=sr:m[1]!==void 0?s=lr:m[2]!==void 0?(ds.test(m[2])&&(o=RegExp("</"+m[2],"g")),s=st):m[3]!==void 0&&(s=st):s===st?m[0]===">"?(s=o!=null?o:Xt,y=-1):m[1]===void 0?y=-2:(y=s.lastIndex-m[2].length,u=m[1],s=m[3]===void 0?st:m[3]==='"'?dr:nr):s===dr||s===nr?s=st:s===sr||s===lr?s=Xt:(s=st,o=void 0);const x=s===st&&a[d+1].startsWith("/>")?" ":"";r+=s===Xt?p+Tl:y>=0?(i.push(u),p.slice(0,y)+"$lit$"+p.slice(y)+Ve+x):p+Ve+(y===-2?(i.push(void 0),d):x)}const n=r+(a[t]||"<?>")+(e===2?"</svg>":"");if(!Array.isArray(a)||!a.hasOwnProperty("raw"))throw Error("invalid template strings array");return[rr!==void 0?rr.createHTML(n):n,i]};class li{constructor({strings:e,_$litType$:t},i){let o;this.parts=[];let r=0,s=0;const n=e.length-1,d=this.parts,[p,u]=hs(e,t);if(this.el=li.createElement(p,i),Tt.currentNode=this.el.content,t===2){const m=this.el.content,y=m.firstChild;y.remove(),m.append(...y.childNodes)}for(;(o=Tt.nextNode())!==null&&d.length<n;){if(o.nodeType===1){if(o.hasAttributes()){const m=[];for(const y of o.getAttributeNames())if(y.endsWith("$lit$")||y.startsWith(Ve)){const w=u[s++];if(m.push(y),w!==void 0){const x=o.getAttribute(w.toLowerCase()+"$lit$").split(Ve),C=/([.?@])?(.*)/.exec(w);d.push({type:1,index:r,name:C[2],strings:x,ctor:C[1]==="."?us:C[1]==="?"?vs:C[1]==="@"?fs:fi})}else d.push({type:6,index:r})}for(const y of m)o.removeAttribute(y)}if(ds.test(o.tagName)){const m=o.textContent.split(Ve),y=m.length-1;if(y>0){o.textContent=zt?zt.emptyScript:"";for(let w=0;w<y;w++)o.append(m[w],ri()),Tt.nextNode(),d.push({type:2,index:++r});o.append(m[y],ri())}}}else if(o.nodeType===8)if(o.data===$a)d.push({type:2,index:r});else{let m=-1;for(;(m=o.data.indexOf(Ve,m+1))!==-1;)d.push({type:7,index:r}),m+=Ve.length-1}r++}}static createElement(e,t){const i=Pt.createElement("template");return i.innerHTML=e,i}}function ft(a,e,t=a,i){var o,r,s,n;if(e===Ce)return e;let d=i!==void 0?(o=t._$Cl)===null||o===void 0?void 0:o[i]:t._$Cu;const p=si(e)?void 0:e._$litDirective$;return(d==null?void 0:d.constructor)!==p&&((r=d==null?void 0:d._$AO)===null||r===void 0||r.call(d,!1),p===void 0?d=void 0:(d=new p(a),d._$AT(a,t,i)),i!==void 0?((s=(n=t)._$Cl)!==null&&s!==void 0?s:n._$Cl=[])[i]=d:t._$Cu=d),d!==void 0&&(e=ft(a,d._$AS(a,e.values),d,i)),e}class ps{constructor(e,t){this.v=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}p(e){var t;const{el:{content:i},parts:o}=this._$AD,r=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:Pt).importNode(i,!0);Tt.currentNode=r;let s=Tt.nextNode(),n=0,d=0,p=o[0];for(;p!==void 0;){if(n===p.index){let u;p.type===2?u=new Ut(s,s.nextSibling,this,e):p.type===1?u=new p.ctor(s,p.name,p.strings,this,e):p.type===6&&(u=new ms(s,this,e)),this.v.push(u),p=o[++d]}n!==(p==null?void 0:p.index)&&(s=Tt.nextNode(),n++)}return r}m(e){let t=0;for(const i of this.v)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class Ut{constructor(e,t,i,o){var r;this.type=2,this._$AH=b,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=o,this._$Cg=(r=o==null?void 0:o.isConnected)===null||r===void 0||r}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cg}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&e.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=ft(this,e,t),si(e)?e===b||e==null||e===""?(this._$AH!==b&&this._$AR(),this._$AH=b):e!==this._$AH&&e!==Ce&&this.$(e):e._$litType$!==void 0?this.T(e):e.nodeType!==void 0?this.k(e):ns(e)?this.S(e):this.$(e)}M(e,t=this._$AB){return this._$AA.parentNode.insertBefore(e,t)}k(e){this._$AH!==e&&(this._$AR(),this._$AH=this.M(e))}$(e){this._$AH!==b&&si(this._$AH)?this._$AA.nextSibling.data=e:this.k(Pt.createTextNode(e)),this._$AH=e}T(e){var t;const{values:i,_$litType$:o}=e,r=typeof o=="number"?this._$AC(e):(o.el===void 0&&(o.el=li.createElement(o.h,this.options)),o);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===r)this._$AH.m(i);else{const s=new ps(r,this),n=s.p(this.options);s.m(i),this.k(n),this._$AH=s}}_$AC(e){let t=cr.get(e.strings);return t===void 0&&cr.set(e.strings,t=new li(e)),t}S(e){ls(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,o=0;for(const r of e)o===t.length?t.push(i=new Ut(this.M(ri()),this.M(ri()),this,this.options)):i=t[o],i._$AI(r),o++;o<t.length&&(this._$AR(i&&i._$AB.nextSibling,o),t.length=o)}_$AR(e=this._$AA.nextSibling,t){var i;for((i=this._$AP)===null||i===void 0||i.call(this,!1,!0,t);e&&e!==this._$AB;){const o=e.nextSibling;e.remove(),e=o}}setConnected(e){var t;this._$AM===void 0&&(this._$Cg=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}}class fi{constructor(e,t,i,o,r){this.type=1,this._$AH=b,this._$AN=void 0,this.element=e,this.name=t,this._$AM=o,this.options=r,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=b}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,i,o){const r=this.strings;let s=!1;if(r===void 0)e=ft(this,e,t,0),s=!si(e)||e!==this._$AH&&e!==Ce,s&&(this._$AH=e);else{const n=e;let d,p;for(e=r[0],d=0;d<r.length-1;d++)p=ft(this,n[i+d],t,d),p===Ce&&(p=this._$AH[d]),s||(s=!si(p)||p!==this._$AH[d]),p===b?e=b:e!==b&&(e+=(p!=null?p:"")+r[d+1]),this._$AH[d]=p}s&&!o&&this.C(e)}C(e){e===b?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e!=null?e:"")}}class us extends fi{constructor(){super(...arguments),this.type=3}C(e){this.element[this.name]=e===b?void 0:e}}const El=zt?zt.emptyScript:"";class vs extends fi{constructor(){super(...arguments),this.type=4}C(e){e&&e!==b?this.element.setAttribute(this.name,El):this.element.removeAttribute(this.name)}}class fs extends fi{constructor(e,t,i,o,r){super(e,t,i,o,r),this.type=5}_$AI(e,t=this){var i;if((e=(i=ft(this,e,t,0))!==null&&i!==void 0?i:b)===Ce)return;const o=this._$AH,r=e===b&&o!==b||e.capture!==o.capture||e.once!==o.once||e.passive!==o.passive,s=e!==b&&(o===b||r);r&&this.element.removeEventListener(this.name,this,o),s&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,i;typeof this._$AH=="function"?this._$AH.call((i=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&i!==void 0?i:this.element,e):this._$AH.handleEvent(e)}}class ms{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){ft(this,e)}}const Ml={L:"$lit$",P:Ve,V:$a,I:1,N:hs,R:ps,j:ns,D:ft,H:Ut,F:fi,O:vs,W:fs,B:us,Z:ms},hr=window.litHtmlPolyfillSupport;hr==null||hr(li,Ut),((go=globalThis.litHtmlVersions)!==null&&go!==void 0?go:globalThis.litHtmlVersions=[]).push("2.2.4");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var bo,yo;class O extends Ct{constructor(){super(...arguments),this.renderOptions={host:this},this._$Dt=void 0}createRenderRoot(){var e,t;const i=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=i.firstChild),i}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Dt=Ei(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Dt)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Dt)===null||e===void 0||e.setConnected(!1)}render(){return Ce}}O.finalized=!0,O._$litElement$=!0,(bo=globalThis.litElementHydrateSupport)===null||bo===void 0||bo.call(globalThis,{LitElement:O});const pr=globalThis.litElementPolyfillSupport;pr==null||pr({LitElement:O});((yo=globalThis.litElementVersions)!==null&&yo!==void 0?yo:globalThis.litElementVersions=[]).push("3.2.0");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const B=a=>e=>typeof e=="function"?((t,i)=>(window.customElements.define(t,i),i))(a,e):((t,i)=>{const{kind:o,elements:r}=i;return{kind:o,elements:r,finisher(s){window.customElements.define(t,s)}}})(a,e);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const zl=(a,e)=>e.kind==="method"&&e.descriptor&&!("value"in e.descriptor)?ue(J({},e),{finisher(t){t.createProperty(e.key,a)}}):{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){typeof e.initializer=="function"&&(this[e.key]=e.initializer.call(this))},finisher(t){t.createProperty(e.key,a)}};function h(a){return(e,t)=>t!==void 0?((i,o,r)=>{o.constructor.createProperty(r,i)})(a,e,t):zl(a,e)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function P(a){return h(ue(J({},a),{state:!0}))}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const gs=({finisher:a,descriptor:e})=>(t,i)=>{var o;if(i===void 0){const r=(o=t.originalKey)!==null&&o!==void 0?o:t.key,s=e!=null?{kind:"method",placement:"prototype",key:r,descriptor:e(t.key)}:ue(J({},t),{key:r});return a!=null&&(s.finisher=function(n){a(n,r)}),s}{const r=t.constructor;e!==void 0&&Object.defineProperty(t,i,e(i)),a==null||a(r,i)}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Z(a,e){return gs({descriptor:t=>{const i={get(){var o,r;return(r=(o=this.renderRoot)===null||o===void 0?void 0:o.querySelector(a))!==null&&r!==void 0?r:null},enumerable:!0,configurable:!0};if(e){const o=typeof t=="symbol"?Symbol():"__"+t;i.get=function(){var r,s;return this[o]===void 0&&(this[o]=(s=(r=this.renderRoot)===null||r===void 0?void 0:r.querySelector(a))!==null&&s!==void 0?s:null),this[o]}}return i}})}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Pl(a){return gs({descriptor:e=>({get(){var t,i;return(i=(t=this.renderRoot)===null||t===void 0?void 0:t.querySelectorAll(a))!==null&&i!==void 0?i:[]},enumerable:!0,configurable:!0})})}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var wo;((wo=window.HTMLSlotElement)===null||wo===void 0?void 0:wo.prototype.assignedElements)!=null;class Al{constructor(){this.resizeObserver=new ResizeObserver(e=>{window.requestAnimationFrame(()=>{for(const t of e){const i=this.resizeHandlers.get(t.target);i==null||i.forEach(o=>{o.handleResize(t)})}})}),this.resizeHandlers=new Map}shutdown(){this.resizeHandlers.forEach((e,t)=>{this.resizeObserver.unobserve(t)}),this.resizeHandlers.clear()}addObserver(e){var t;const i=(t=this.resizeHandlers.get(e.target))!==null&&t!==void 0?t:new Set;i.add(e.handler),this.resizeHandlers.set(e.target,i),this.resizeObserver.observe(e.target,e.options)}removeObserver(e){const t=this.resizeHandlers.get(e.target);!t||(t.delete(e.handler),t.size===0&&(this.resizeObserver.unobserve(e.target),this.resizeHandlers.delete(e.target)))}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Le={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},mi=a=>(...e)=>({_$litDirective$:a,values:e});class gi{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const At=mi(class extends gi{constructor(a){var e;if(super(a),a.type!==Le.ATTRIBUTE||a.name!=="class"||((e=a.strings)===null||e===void 0?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(a){return" "+Object.keys(a).filter(e=>a[e]).join(" ")+" "}update(a,[e]){var t,i;if(this.et===void 0){this.et=new Set,a.strings!==void 0&&(this.st=new Set(a.strings.join(" ").split(/\s/).filter(r=>r!=="")));for(const r in e)e[r]&&!(!((t=this.st)===null||t===void 0)&&t.has(r))&&this.et.add(r);return this.render(e)}const o=a.element.classList;this.et.forEach(r=>{r in e||(o.remove(r),this.et.delete(r))});for(const r in e){const s=!!e[r];s===this.et.has(r)||((i=this.st)===null||i===void 0?void 0:i.has(r))||(s?(o.add(r),this.et.add(r)):(o.remove(r),this.et.delete(r)))}return Ce}});/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ll=(a,...e)=>({strTag:!0,strings:a,values:e}),ct=Ll,Dl=a=>typeof a!="string"&&"strTag"in a,Bl=(a,e,t)=>{let i=a[0];for(let o=1;o<a.length;o++)i+=e[t?t[o-1]:o-1],i+=a[o];return i};/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Rl=a=>Dl(a)?Bl(a.strings,a.values):a;/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class Fl{constructor(){this.settled=!1,this.promise=new Promise((e,t)=>{this._resolve=e,this._reject=t})}resolve(e){this.settled=!0,this._resolve(e)}reject(e){this.settled=!0,this._reject(e)}}/**
 * @license
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{H:Il}=Ml,bs=a=>a.strings===void 0,ur=()=>document.createComment(""),Zt=(a,e,t)=>{var i;const o=a._$AA.parentNode,r=e===void 0?a._$AB:e._$AA;if(t===void 0){const s=o.insertBefore(ur(),r),n=o.insertBefore(ur(),r);t=new Il(s,n,a,a.options)}else{const s=t._$AB.nextSibling,n=t._$AM,d=n!==a;if(d){let p;(i=t._$AQ)===null||i===void 0||i.call(t,a),t._$AM=a,t._$AP!==void 0&&(p=a._$AU)!==n._$AU&&t._$AP(p)}if(s!==r||d){let p=t._$AA;for(;p!==s;){const u=p.nextSibling;o.insertBefore(p,r),p=u}}}return t},lt=(a,e,t=a)=>(a._$AI(e,t),a),Nl={},ys=(a,e=Nl)=>a._$AH=e,Ul=a=>a._$AH,_o=a=>{var e;(e=a._$AP)===null||e===void 0||e.call(a,!1,!0);let t=a._$AA;const i=a._$AB.nextSibling;for(;t!==i;){const o=t.nextSibling;t.remove(),t=o}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const vr=(a,e,t)=>{const i=new Map;for(let o=e;o<=t;o++)i.set(a[o],o);return i},ws=mi(class extends gi{constructor(a){if(super(a),a.type!==Le.CHILD)throw Error("repeat() can only be used in text expressions")}dt(a,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);const o=[],r=[];let s=0;for(const n of a)o[s]=i?i(n,s):s,r[s]=t(n,s),s++;return{values:r,keys:o}}render(a,e,t){return this.dt(a,e,t).values}update(a,[e,t,i]){var o;const r=Ul(a),{values:s,keys:n}=this.dt(e,t,i);if(!Array.isArray(r))return this.ut=n,s;const d=(o=this.ut)!==null&&o!==void 0?o:this.ut=[],p=[];let u,m,y=0,w=r.length-1,x=0,C=s.length-1;for(;y<=w&&x<=C;)if(r[y]===null)y++;else if(r[w]===null)w--;else if(d[y]===n[x])p[x]=lt(r[y],s[x]),y++,x++;else if(d[w]===n[C])p[C]=lt(r[w],s[C]),w--,C--;else if(d[y]===n[C])p[C]=lt(r[y],s[C]),Zt(a,p[C+1],r[y]),y++,C--;else if(d[w]===n[x])p[x]=lt(r[w],s[x]),Zt(a,r[y],r[w]),w--,x++;else if(u===void 0&&(u=vr(n,x,C),m=vr(d,y,w)),u.has(d[y]))if(u.has(d[w])){const A=m.get(n[x]),D=A!==void 0?r[A]:null;if(D===null){const L=Zt(a,r[y]);lt(L,s[x]),p[x]=L}else p[x]=lt(D,s[x]),Zt(a,r[y],D),r[A]=null;x++}else _o(r[w]),w--;else _o(r[y]),y++;for(;x<=C;){const A=Zt(a,p[C+1]);lt(A,s[x]),p[x++]=A}for(;y<=w;){const A=r[y++];A!==null&&_o(A)}return this.ut=n,ys(a,p),Ce}});function Si(a,e,t){return Array.from({length:(e-a)/t+1},(i,o)=>a+o*t)}let je=class extends O{constructor(){super(...arguments),this.itemCount=0,this.scrollOptimizationsDisabled=!1,this.intersectionObserver=new IntersectionObserver(e=>{e.forEach(t=>{if(t.target===this.sentinel){t.isIntersecting&&this.dispatchEvent(new Event("scrollThresholdReached"));return}const o=t.target.dataset.cellIndex;if(!o)return;const r=parseInt(o,10);t.isIntersecting?this.visibleCellIndices.add(r):this.visibleCellIndices.delete(r)}),this.scrollOptimizationsDisabled||this.processVisibleCells()}),this.renderedCellIndices=new Set,this.visibleCellIndices=new Set,this.placeholderCellIndices=new Set}reload(){Si(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.removeCell(t)),this.renderedCellIndices.clear(),this.visibleCellIndices.clear(),this.placeholderCellIndices.clear(),this.setupObservations()}refreshCell(e){this.removeCell(e),this.bufferRange.includes(e)&&this.renderCellBuffer([e])}refreshAllVisibleCells(){this.bufferRange.forEach(e=>this.removeCell(e)),this.renderCellBuffer(this.bufferRange)}scrollToCell(e,t){const i=this.cellContainers[e];if(!i)return!1;const o=t?"smooth":"auto";return i.scrollIntoView({behavior:o}),!0}getVisibleCellIndices(){return Array.from(this.visibleCellIndices)}updated(e){(e.has("itemCount")||e.has("scrollOptimizationsDisabled"))&&this.setupObservations()}disconnectedCallback(){this.intersectionObserver.disconnect()}setupObservations(){this.setupIntersectionObserver()}setupIntersectionObserver(){this.intersectionObserver.disconnect(),this.sentinel&&this.intersectionObserver.observe(this.sentinel),this.scrollOptimizationsDisabled?(Si(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.visibleCellIndices.add(t)),this.processVisibleCells()):this.cellContainers.forEach(e=>this.intersectionObserver.observe(e))}render(){var e;const t=this.itemCount-1,i=Si(0,t,1),o=(e=this.ariaLandmarkLabel)!==null&&e!==void 0?e:b;return c`
    ...
    `}};l([h({type:Number})],je.prototype,"itemCount",void 0);l([h({type:Object})],je.prototype,"cellProvider",void 0);l([h({type:Object})],je.prototype,"placeholderCellTemplate",void 0);l([h({type:Boolean})],je.prototype,"scrollOptimizationsDisabled",void 0);l([h({type:String})],je.prototype,"ariaLandmarkLabel",void 0);l([Z("#sentinel")],je.prototype,"sentinel",void 0);l([Pl(".cell-container")],je.prototype,"cellContainers",void 0);je=l([B("infinite-scroller")],je);function Hl(a){return a==null?void 0:a.replace(/%22%22(?!%22%22)(.+?)%22%22/g,"%22$1%22")}function Vl(a){var e,t,i;return((e=a==null?void 0:a.rawMetadata)===null||e===void 0?void 0:e.hit_type)==="favorited_search"?"search":(i=(t=a.mediatype)===null||t===void 0?void 0:t.value)!==null&&i!==void 0?i:"data"}const Wl=I`
  <svg
    viewBox="0 0 100 100"
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const sn=(a,e,t)=>{for(const i of e)if(i[0]===a)return(0,i[1])();return t==null?void 0:t()};var ln=I`
...
`,Ae;let ke=Ae=class extends O{constructor(){super(...arguments),this.placeholderType=null,this.detailMessage=""}render(){return this.placeholderType?c`${this.placeholderTemplate}`:b}get placeholderTemplate(){return c`
      <div
        class="placeholder ${this.placeholderType} ${this.isMobileView?"mobile":"desktop"}"
      >
        ${sn(this.placeholderType,[["empty-query",()=>this.emptyQueryTemplate],["empty-collection",()=>this.emptyCollectionTemplate],["no-results",()=>this.noResultsTemplate],["query-error",()=>this.queryErrorTemplate],["collection-error",()=>this.collectionErrorTemplate]])}
      </div>
    ...
    <a href="mailto:info@archive.org">info@archive.org</a>.`);ke.QUERY_ERROR_DETAILS_MESSAGE=M("Error details:");l([h({type:String})],ke.prototype,"placeholderType",void 0);l([h({type:Boolean})],ke.prototype,"isMobileView",void 0);l([h({type:Boolean})],ke.prototype,"isCollection",void 0);l([h({type:String})],ke.prototype,"detailMessage",void 0);ke=Ae=l([B("empty-placeholder")],ke);/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ta=a=>a!=null?a:b,Ts=I`
...
`;var Zo;(function(a){a[a.bytes=0]="bytes",a[a.kilobytes=1]="kilobytes",a[a.megabytes=2]="megabytes",a[a.gigabytes=3]="gigabytes",a[a.terabytes=4]="terabytes",a[a.petabytes=5]="petabytes",a[a.exabytes=6]="exabytes",a[a.zettabytes=7]="zettabytes",a[a.yottabytes=8]="yottabytes"})(Zo||(Zo={}));function nn(a,e,t=" "){let i=a;if(i===void 0)return b;let o=0;for(;i>1024;)i/=1024,o+=1;const r=10**e;i=Math.round(i*r)/r;let s=Zo[o];return s=i===1?s.slice(0,-1):s,`${i.toLocaleString()+t+s}`}const dn=f`var(--tileBackgroundColor, #ffffff)`,cn=f`var(--tileCornerRadius, 4px)`,Ji=f`
...
`;class gr{constructor(e={}){var t;this.model=e.model,this.baseNavigationUrl=e.baseNavigationUrl,this.collectionPagePath=(t=e.collectionPagePath)!==null&&t!==void 0?t:"/details/",this.sortParam=e.sortParam,this.creatorFilter=e.creatorFilter}get firstCreatorMatchingFilter(){var e,t;let i;if(this.creatorFilter&&((e=this.model)===null||e===void 0?void 0:e.creators.length)){const o=this.creatorFilter;i=this.model.creators.find(r=>r.normalize("NFD").replace(/[^A-Z]+/gi,"").toUpperCase().startsWith(o))}return i!=null?i:(t=this.model)===null||t===void 0?void 0:t.creator}get accountLabel(){var e;return!((e=this.model)===null||e===void 0)&&e.dateAdded?M(ct`Archivist since ${this.model.dateAdded.getFullYear()}`):""}get dateLabel(){var e;switch((e=this.sortParam)===null||e===void 0?void 0:e.field){case"publicdate":return M("Archived");case"reviewdate":return M("Reviewed");case"addeddate":return M("Added");case"date":return M("Published");default:return""}}itemPageUrl(e,t=!1){if(!e||this.baseNavigationUrl==null)return b;const i=t?this.collectionPagePath:"/details/";return`${this.baseNavigationUrl}${i}${e}`}webArchivesCaptureLink(e,t){const o=`https://web.archive.org/web/${t.toISOString().replace(/[TZ:-]/g,"").replace(/\..*/,"")}/${encodeURIComponent(e)}`,r=Lt(t,"long");return c` <a href=${o}> ${r} </a> `}}class ce extends O{constructor(){super(...arguments),this.sortParam=null,this.defaultSortParam=null,this.loggedIn=!1,this.displayValueProvider=new gr}willUpdate(e){var t,i;(e.has("model")||e.has("baseNavigationUrl")||e.has("collectionPagePath")||e.has("sortParam")||e.has("defaultSortParam")||e.has("creatorFilter"))&&(this.displayValueProvider=new gr({model:this.model,baseNavigationUrl:this.baseNavigationUrl,collectionPagePath:this.collectionPagePath,sortParam:(i=(t=this.sortParam)!==null&&t!==void 0?t:this.defaultSortParam)!==null&&i!==void 0?i:void 0,creatorFilter:this.creatorFilter}))}}l([h({type:Object})],ce.prototype,"model",void 0);l([h({type:Number})],ce.prototype,"currentWidth",void 0);l([h({type:Number})],ce.prototype,"currentHeight",void 0);l([h({type:String})],ce.prototype,"baseNavigationUrl",void 0);l([h({type:String})],ce.prototype,"baseImageUrl",void 0);l([h({type:String})],ce.prototype,"collectionPagePath",void 0);l([h({type:Object})],ce.prototype,"sortParam",void 0);l([h({type:Object})],ce.prototype,"defaultSortParam",void 0);l([h({type:String})],ce.prototype,"creatorFilter",void 0);l([h({type:Number})],ce.prototype,"mobileBreakpoint",void 0);l([h({type:Boolean})],ce.prototype,"loggedIn",void 0);let Jo=class extends O{render(){return c`<div class="icon-overlay">${this.iconTemplate}</div>`}get iconTemplate(){var e;return this.type?c`${(e=_s[this.type])!==null&&e!==void 0?e:b}`:b}static get styles(){return f`
    ...
    `}};l([h({type:String})],Jo.prototype,"type",void 0);Jo=l([B("icon-overlay")],Jo);let ea=class extends O{render(){return c`
      <div class="overlay no-preview">
        <div class="icon-overlay">${this.iconTemplate}</div>
        <p class="text-overlay">${this.textTemplate}</p>
      </div>
    `}get iconTemplate(){var e;return this.type?c`${(e=_s[this.type])!==null&&e!==void 0?e:b}`:b}get textTemplate(){var e;return this.type?c`${(e=Gl[this.type])!==null&&e!==void 0?e:b}`:b}static get styles(){return f`
      :host {
        align-items: center;
        display: flex;
      }
    ...
    `}};l([h({type:String})],ea.prototype,"type",void 0);ea=l([B("text-overlay")],ea);let Ze=class extends O{constructor(){super(...arguments),this.isCompactTile=!1,this.isListTile=!1,this.loggedIn=!1,this.viewSize="desktop"}render(){var e;return!((e=this.model)===null||e===void 0)&&e.identifier?c`
    ...
    `}};l([h({type:String})],Ze.prototype,"baseImageUrl",void 0);l([h({type:Boolean})],Ze.prototype,"isCompactTile",void 0);l([h({type:Boolean})],Ze.prototype,"isListTile",void 0);l([h({type:Boolean})],Ze.prototype,"loggedIn",void 0);l([h({type:Object})],Ze.prototype,"model",void 0);l([h({type:String})],Ze.prototype,"viewSize",void 0);Ze=l([B("image-block")],Ze);let ta=class extends ce{constructor(){super(...arguments),this.showInfoButton=!1}render(){return c`
      <div class="container">
    ...
    >`}get getSizeTemplate(){var e,t;const i=(t=(e=this.model)===null||e===void 0?void 0:e.collectionSize)!==null&&t!==void 0?t:0;return i?c`<span id="item-size">${nn(i,1)}</span>`:""}get infoButtonTemplate(){return this.showInfoButton?c`<button class="info-button" @click=${this.infoButtonPressed}>
          &#9432;
          <span class="sr-only">${M("More info")}</span>
        </button>`:b}infoButtonPressed(e){e.preventDefault();const t=new CustomEvent("infoButtonPressed",{detail:{x:e.clientX,y:e.clientY}});this.dispatchEvent(t)}static get styles(){const e=f`var(--tileBorderColor, #555555)`,t=f`var(--tileBackgroundColor, #666666)`,i=f`#fff`;return[Ji,f`
        .container {
          background-color: ${t};
          border: 1px solid ${e};
        }
      ...
      `]}};l([h({type:Boolean})],ta.prototype,"showInfoButton",void 0);ta=l([B("collection-tile")],ta);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*Et(a,e){if(a!==void 0){let t=0;for(const i of a)yield e(i,t++)}}function hn(a){return new Date(a.getTime()-a.getTimezoneOffset()*1e3*60)}function Ea(a){return a?hn(a).toISOString().endsWith("-01-01T00:00:00.000Z"):!1}const Es=c`
...
`;let Dt=class extends O{constructor(){super(...arguments),this.title="",this.body="",this.starRating=0,this.viewSize="desktop"}render(){return!this.title&&!this.body&&!this.starRating?b:c`
    ...
    `}get filledStarTemplate(){return c`<span aria-hidden="true">${Es}</span>`}get unfilledStarTemplate(){return c`
      <span class="unfilled-star" aria-hidden="true">
        ${pn}
      </span>
    `}static get styles(){return[qe,f`
        .review-container {
          display: flex;
          flex-direction: row;
          flex-wrap: wrap;
      ...
      `]}};l([h({type:String})],Dt.prototype,"title",void 0);l([h({type:String})],Dt.prototype,"body",void 0);l([h({type:Number})],Dt.prototype,"starRating",void 0);l([h({type:String})],Dt.prototype,"viewSize",void 0);Dt=l([B("review-block")],Dt);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*zi(a,e){const t=typeof e=="function";if(a!==void 0){let i=-1;for(const o of a)i>-1&&(yield t?e(i):e),i++,yield o}}let Hi=class extends O{constructor(){super(...arguments),this.snippets=[],this.viewSize="desktop"}render(){var e;return!((e=this.snippets)===null||e===void 0)&&e.length?c`
      <div class="container">
        <div class="snippet-view ${this.viewSize}">
    ...
    `}};l([h({type:Array})],Hi.prototype,"snippets",void 0);l([h({type:String})],Hi.prototype,"viewSize",void 0);Hi=l([B("text-snippet-block")],Hi);const un=f`
  .drop-shadow {
    overflow: hidden;
    height: 100%;
  }
...
`;let Re=class extends O{constructor(){super(...arguments),this.isListTile=!1,this.isCompactTile=!1,this.loggedIn=!1,this.isWaveform=!1,this.isNotFound=!1}render(){return c`
      <div class=${At(this.itemBaseClass)}>${this.imageTemplate}</div>
    `}get imageTemplate(){var e;return((e=this.model)===null||e===void 0?void 0:e.mediatype)==="search"?c`${Ms}`:c`
      <img
    ...
    `}get imageSrc(){var e,t;if(this.isNotFound)return this.notFoundSrc;if(((e=this.model)===null||e===void 0?void 0:e.captureDates)&&this.model.identifier)try{const i=new URL(this.model.identifier),o=encodeURIComponent(i.hostname);return this.baseImageUrl?`https://web.archive.org/thumb/${o}?generate=1`:b}catch{return`${this.baseImageUrl}/images/notfound.png`}return this.baseImageUrl&&((t=this.model)===null||t===void 0?void 0:t.identifier)?`${this.baseImageUrl}/services/img/${this.model.identifier}`:b}get notFoundSrc(){return this.baseImageUrl?`${this.baseImageUrl}/images/notfound.png`:b}get hashBasedGradient(){var e;return!((e=this.model)===null||e===void 0)&&e.identifier?`waveform-grad${this.hashStrToInt(this.model.identifier)%6}`:"waveform-grad0"}hashStrToInt(e){return e.split("").reduce((t,i)=>t+i.charCodeAt(0),0)}get itemBaseClass(){var e;return{"drop-shadow":!0,"list-box":this.isListTile,"search-image":((e=this.model)===null||e===void 0?void 0:e.mediatype)==="search",[this.hashBasedGradient]:this.isWaveform}}get itemImageClass(){var e,t,i;const o=((e=this.model)===null||e===void 0?void 0:e.contentWarning)||((t=this.model)===null||t===void 0?void 0:t.loginRequired);return{contain:!this.isCompactTile&&!this.isWaveform,cover:this.isCompactTile,blur:o||!1,waveform:this.isWaveform,"account-image":this.isAccountImage,"collection-image":((i=this.model)===null||i===void 0?void 0:i.mediatype)==="collection"}}get isAccountImage(){var e;return((e=this.model)===null||e===void 0?void 0:e.mediatype)==="account"&&!this.isCompactTile&&!this.isListTile}onLoad(){var e,t;(((e=this.model)===null||e===void 0?void 0:e.mediatype)==="audio"||((t=this.model)===null||t===void 0?void 0:t.mediatype)==="etree")&&this.baseImage.naturalWidth/this.baseImage.naturalHeight===4&&(this.isWaveform=!0)}onError(){this.isNotFound=!0}static get styles(){return[un,vn,f`
      ...
      `]}};l([h({type:Object})],Re.prototype,"model",void 0);l([h({type:String})],Re.prototype,"baseImageUrl",void 0);l([h({type:Boolean})],Re.prototype,"isListTile",void 0);l([h({type:Boolean})],Re.prototype,"isCompactTile",void 0);l([h({type:Boolean})],Re.prototype,"loggedIn",void 0);l([P()],Re.prototype,"isWaveform",void 0);l([P()],Re.prototype,"isNotFound",void 0);l([Z("img")],Re.prototype,"baseImage",void 0);Re=l([B("item-image")],Re);const fn=I`
...
`,kn={account:{color:"#000000",icon:fn,text:"Account"},audio:{color:"#00adef",icon:mn,text:"Audio"},collection:{color:"#4666ff",icon:Ts,text:"Collection"},data:{color:"#333333",icon:gn,text:"Data"},etree:{color:"#00adef",icon:bn,text:"E-tree"},film:{color:"#bf1b2c",icon:br,text:"Film"},image:{color:"#aa99c9",icon:yn,text:"Image"},movies:{color:"#f1644b",icon:br,text:"Movie"},radio:{color:"#8fdaef",icon:wn,text:"Radio"},software:{color:"#9ecc4f",icon:_n,text:"Software"},texts:{color:"#faab3c",icon:xn,text:"Text"},tv:{color:"#f1644b",icon:$n,text:"TV"},video:{color:"#f1644b",icon:Sn,text:"Video"},web:{color:"#ffcd27",icon:Cn,text:"Web"},search:{color:"#000000",icon:Ms,text:"Search"}};let ni=class extends O{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var e,t;const i=["tvnews","tvarchive","television"],o=["radio","radioprogram"];return this.mediatype==="movies"&&((e=this.collections)===null||e===void 0?void 0:e.some(r=>i.indexOf(r)>=0))?"tv":this.mediatype==="audio"&&((t=this.collections)===null||t===void 0?void 0:t.some(r=>o.indexOf(r)>=0))?"radio":this.mediatype||""}render(){const e=kn[this.displayMediatype];return e?c`
      <div
        id="icon"
    ...
    `}};l([h({type:String})],ni.prototype,"mediatype",void 0);l([h({type:Array})],ni.prototype,"collections",void 0);l([h({type:Boolean})],ni.prototype,"showText",void 0);ni=l([B("mediatype-icon")],ni);const Tn=I`
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path
...
`;function zn(a,e){let t=1;return a>=1e9?t=1e9:a>=1e6?t=1e6:a>=1e3&&e==="short"&&(t=1e3),t}function Pn(a=0,e){const t=a/e,i=t<10;let o=0;return i?o=Math.round((t+Number.EPSILON)*10)/10:o=Math.round(t),o}function An(a,e,t,i){switch(e){case 1e9:return M(t==="short"?ct`${a}B`:ct`${a} billion`);case 1e6:return M(t==="short"?ct`${a}M`:ct`${a} million`);case 1e3:return M(t==="short"?ct`${a}K`:ct`${a} thousand`);default:return new Intl.NumberFormat(i).format(a)}}function oi(a,e="long",t="short",i="en-US"){const o=a!=null?a:-1;if(o<0)return"";const r=zn(o,e),s=Pn(o,r);return An(s,r,t,i)}let Je=class extends O{render(){var e,t,i,o,r;const s=oi(this.favCount,"short","short"),n=oi(this.commentCount,"short","short"),d=this.mediatype==="account"?`${(e=this.itemCount)!==null&&e!==void 0?e:0} uploads`:`${(t=this.viewCount)!==null&&t!==void 0?t:0} ${(i=this.viewLabel)!==null&&i!==void 0?i:"all-time views"}`;return c`
      <div class="item-stats">
        ...
        <ul id="stats-row">
          ...
          <li class="col" title="${d}">
            ${this.mediatype==="account"?En:Mn}
            <p class="status-text">
              <span class="sr-only">
                ${this.mediatype==="account"?M("Uploads:"):M("Views:")}
              </span>
              ${oi(this.mediatype==="account"?(o=this.itemCount)!==null&&o!==void 0?o:0:(r=this.viewCount)!==null&&r!==void 0?r:0,"short","short")}
            </p>
          </li>
    ...
    `}get sortedDateInfoTemplate(){var e,t,i,o,r;let s,n="long";switch((e=this.effectiveSort)===null||e===void 0?void 0:e.field){case"date":{const d=(t=this.model)===null||t===void 0?void 0:t.datePublished;s={field:"published",value:d},Ea(d)&&(n="year-only");break}case"reviewdate":s={field:"reviewed",value:(i=this.model)===null||i===void 0?void 0:i.dateReviewed};break;case"addeddate":s={field:"added",value:(o=this.model)===null||o===void 0?void 0:o.dateAdded};break;case"publicdate":s={field:"archived",value:(r=this.model)===null||r===void 0?void 0:r.dateArchived};break}return s!=null&&s.value?c`
    ...
    `}get isSortedByDate(){var e;return["date","reviewdate","addeddate","publicdate"].includes((e=this.effectiveSort)===null||e===void 0?void 0:e.field)}get effectiveSort(){var e;return(e=this.sortParam)!==null&&e!==void 0?e:this.defaultSortParam}get hasSnippets(){var e,t;return!!(!((t=(e=this.model)===null||e===void 0?void 0:e.snippets)===null||t===void 0)&&t.length)}infoButtonPressed(e){e.preventDefault();const t=new CustomEvent("infoButtonPressed",{detail:{x:e.clientX,y:e.clientY}});this.dispatchEvent(t)}static get styles(){const e=f`var(--tileBorderColor, #dddddd)`;return[Ji,f`
      ...
      `]}};l([h({type:Boolean})],ia.prototype,"showInfoButton",void 0);ia=l([B("item-tile")],ia);let oa=class extends ce{constructor(){super(...arguments),this.showInfoButton=!1}render(){return c`
      <div class="container">
        ${this.infoButtonTemplate}
        <div class="tile-details">
          <div class="item-info">
    ...
    >
          ...
          &#9432;
          <span class="sr-only">${M("More info")}</span>
        </button>`:b}infoButtonPressed(e){e.preventDefault();const t=new CustomEvent("infoButtonPressed",{detail:{x:e.clientX,y:e.clientY}});this.dispatchEvent(t)}static get styles(){const e=f`var(--tileBorderColor, #dddddd)`;return[Ji,f`
        .container {
          border: 1px solid ${e};
        }
      `]}};l([h({type:Boolean})],oa.prototype,"showInfoButton",void 0);oa=l([B("account-tile")],oa);let aa=class extends ce{constructor(){super(...arguments),this.showInfoButton=!1}render(){return c`
      <div class="container">
        <div class="tile-details">
          <div class="item-info">
            ${this.getImageBlockTemplate} ${this.getTitleTemplate}
    ...
    `}get getTitleTemplate(){var e;return c`<div id="title">
      <h4 class="truncated">${(e=this.model)===null||e===void 0?void 0:e.title}</h4>
    </div>`}static get styles(){const e=f`var(--tileBorderColor, #555555)`,t=f`var(--tileBackgroundColor, #666666)`,i=f`#fff`;return[Ji,f`
        .container {
          background-color: ${t};
          border: 1px solid ${e};
        }
      ...
      `]}};l([h({type:Boolean})],aa.prototype,"showInfoButton",void 0);aa=l([B("search-tile")],aa);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class ra extends gi{constructor(e){if(super(e),this.it=b,e.type!==Le.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===b||e==null)return this.ft=void 0,this.it=e;if(e===Ce)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this.ft;this.it=e;const t=[e];return t.raw=t,this.ft={_$litType$:this.constructor.resultType,strings:t,values:[]}}}ra.directiveName="unsafeHTML",ra.resultType=1;const Ln=mi(ra);/*! @license DOMPurify 2.3.8 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/2.3.8/LICENSE */function pt(a){return pt=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},pt(a)}function sa(a,e){return sa=Object.setPrototypeOf||function(i,o){return i.__proto__=o,i},sa(a,e)}function Dn(){if(typeof Reflect=="undefined"||!Reflect.construct||Reflect.construct.sham)return!1;if(typeof Proxy=="function")return!0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],function(){})),!0}catch{return!1}}function Pi(a,e,t){return Dn()?Pi=Reflect.construct:Pi=function(o,r,s){var n=[null];n.push.apply(n,r);var d=Function.bind.apply(o,n),p=new d;return s&&sa(p,s.prototype),p},Pi.apply(null,arguments)}function Ee(a){return Bn(a)||Rn(a)||Fn(a)||On()}function Bn(a){if(Array.isArray(a))return la(a)}function Rn(a){if(typeof Symbol!="undefined"&&a[Symbol.iterator]!=null||a["@@iterator"]!=null)return Array.from(a)}function Fn(a,e){if(!!a){if(typeof a=="string")return la(a,e);var t=Object.prototype.toString.call(a).slice(8,-1);if(t==="Object"&&a.constructor&&(t=a.constructor.name),t==="Map"||t==="Set")return Array.from(a);if(t==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t))return la(a,e)}}function la(a,e){(e==null||e>a.length)&&(e=a.length);for(var t=0,i=new Array(e);t<e;t++)i[t]=a[t];return i}function On(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}var In=Object.hasOwnProperty,yr=Object.setPrototypeOf,Nn=Object.isFrozen,Un=Object.getPrototypeOf,Hn=Object.getOwnPropertyDescriptor,ye=Object.freeze,Fe=Object.seal,Vn=Object.create,zs=typeof Reflect!="undefined"&&Reflect,Vi=zs.apply,na=zs.construct;Vi||(Vi=function(e,t,i){return e.apply(t,i)});ye||(ye=function(e){return e});Fe||(Fe=function(e){return e});na||(na=function(e,t){return Pi(e,Ee(t))});var Wn=Me(Array.prototype.forEach),wr=Me(Array.prototype.pop),Jt=Me(Array.prototype.push),Ai=Me(String.prototype.toLowerCase),jn=Me(String.prototype.match),Ke=Me(String.prototype.replace),Gn=Me(String.prototype.indexOf),qn=Me(String.prototype.trim),ge=Me(RegExp.prototype.test),xo=Qn(TypeError);function Me(a){return function(e){for(var t=arguments.length,i=new Array(t>1?t-1:0),o=1;o<t;o++)i[o-1]=arguments[o];return Vi(a,e,i)}}function Qn(a){return function(){for(var e=arguments.length,t=new Array(e),i=0;i<e;i++)t[i]=arguments[i];return na(a,t)}}function R(a,e){yr&&yr(a,null);for(var t=e.length;t--;){var i=e[t];if(typeof i=="string"){var o=Ai(i);o!==i&&(Nn(e)||(e[t]=o),i=o)}a[i]=!0}return a}function nt(a){var e=Vn(null),t;for(t in a)Vi(In,a,[t])&&(e[t]=a[t]);return e}function ki(a,e){for(;a!==null;){var t=Hn(a,e);if(t){if(t.get)return Me(t.get);if(typeof t.value=="function")return Me(t.value)}a=Un(a)}function i(o){return console.warn("fallback value for",o),null}return i}var _r=ye(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","section","select","shadow","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),$o=ye(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","filter","font","g","glyph","glyphref","hkern","image","line","lineargradient","marker","mask","metadata","mpath","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),So=ye(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),Kn=ye(["animate","color-profile","cursor","discard","fedropshadow","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),Co=ye(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover"]),Yn=ye(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),xr=ye(["#text"]),$r=ye(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","face","for","headers","height","hidden","high","href","hreflang","id","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","pattern","placeholder","playsinline","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","xmlns","slot"]),ko=ye(["accent-height","accumulate","additive","alignment-baseline","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),Sr=ye(["accent","accentunder","align","bevelled","close","columnsalign","columnlines","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lspace","lquote","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),Ti=ye(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),Xn=Fe(/\{\{[\w\W]*|[\w\W]*\}\}/gm),Zn=Fe(/<%[\w\W]*|[\w\W]*%>/gm),Jn=Fe(/^data-[\-\w.\u00B7-\uFFFF]/),ed=Fe(/^aria-[\-\w]+$/),td=Fe(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|cid|xmpp):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),id=Fe(/^(?:\w+script|data):/i),od=Fe(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),ad=Fe(/^html$/i),rd=function(){return typeof window=="undefined"?null:window},sd=function(e,t){if(pt(e)!=="object"||typeof e.createPolicy!="function")return null;var i=null,o="data-tt-policy-suffix";t.currentScript&&t.currentScript.hasAttribute(o)&&(i=t.currentScript.getAttribute(o));var r="dompurify"+(i?"#"+i:"");try{return e.createPolicy(r,{createHTML:function(n){return n}})}catch{return console.warn("TrustedTypes policy "+r+" could not be created."),null}};function Ps(){var a=arguments.length>0&&arguments[0]!==void 0?arguments[0]:rd(),e=function(v){return Ps(v)};if(e.version="2.3.8",e.removed=[],!a||!a.document||a.document.nodeType!==9)return e.isSupported=!1,e;var t=a.document,i=a.document,o=a.DocumentFragment,r=a.HTMLTemplateElement,s=a.Node,n=a.Element,d=a.NodeFilter,p=a.NamedNodeMap,u=p===void 0?a.NamedNodeMap||a.MozNamedAttrMap:p,m=a.HTMLFormElement,y=a.DOMParser,w=a.trustedTypes,x=n.prototype,C=ki(x,"cloneNode"),A=ki(x,"nextSibling"),D=ki(x,"childNodes"),L=ki(x,"parentNode");if(typeof r=="function"){var G=i.createElement("template");G.content&&G.content.ownerDocument&&(i=G.content.ownerDocument)}var N=sd(w,t),oe=N?N.createHTML(""):"",ne=i,$e=ne.implementation,j=ne.createNodeIterator,Se=ne.createDocumentFragment,Ht=ne.getElementsByTagName,Vt=t.importNode,gt={};try{gt=nt(i).documentMode?i.documentMode:{}}catch{}var _e={};e.isSupported=typeof L=="function"&&$e&&typeof $e.createHTMLDocument!="undefined"&&gt!==9;var tt=Xn,it=Zn,Wt=Jn,jt=ed,Gt=id,bt=od,ot=td,te=null,qt=R({},[].concat(Ee(_r),Ee($o),Ee(So),Ee(Co),Ee(xr))),he=null,Aa=R({},[].concat(Ee($r),Ee(ko),Ee(Sr),Ee(Ti))),se=Object.seal(Object.create(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),Qt=null,to=null,La=!0,io=!0,Da=!1,yt=!1,at=!1,oo=!1,ao=!1,wt=!1,yi=!1,wi=!1,Ba=!0,ro=!0,Kt=!1,_t={},xt=null,Ra=R({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","style","svg","template","thead","title","video","xmp"]),Fa=null,Oa=R({},["audio","video","img","source","image","track"]),so=null,Ia=R({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),lo="http://www.w3.org/1998/Math/MathML",no="http://www.w3.org/2000/svg",Qe="http://www.w3.org/1999/xhtml",_i=Qe,co=!1,$t,Gs=["application/xhtml+xml","text/html"],qs="text/html",rt,St=null,Qs=i.createElement("form"),Na=function(v){return v instanceof RegExp||v instanceof Function},ho=function(v){St&&St===v||((!v||pt(v)!=="object")&&(v={}),v=nt(v),te="ALLOWED_TAGS"in v?R({},v.ALLOWED_TAGS):qt,he="ALLOWED_ATTR"in v?R({},v.ALLOWED_ATTR):Aa,so="ADD_URI_SAFE_ATTR"in v?R(nt(Ia),v.ADD_URI_SAFE_ATTR):Ia,Fa="ADD_DATA_URI_TAGS"in v?R(nt(Oa),v.ADD_DATA_URI_TAGS):Oa,xt="FORBID_CONTENTS"in v?R({},v.FORBID_CONTENTS):Ra,Qt="FORBID_TAGS"in v?R({},v.FORBID_TAGS):{},to="FORBID_ATTR"in v?R({},v.FORBID_ATTR):{},_t="USE_PROFILES"in v?v.USE_PROFILES:!1,La=v.ALLOW_ARIA_ATTR!==!1,io=v.ALLOW_DATA_ATTR!==!1,Da=v.ALLOW_UNKNOWN_PROTOCOLS||!1,yt=v.SAFE_FOR_TEMPLATES||!1,at=v.WHOLE_DOCUMENT||!1,wt=v.RETURN_DOM||!1,yi=v.RETURN_DOM_FRAGMENT||!1,wi=v.RETURN_TRUSTED_TYPE||!1,ao=v.FORCE_BODY||!1,Ba=v.SANITIZE_DOM!==!1,ro=v.KEEP_CONTENT!==!1,Kt=v.IN_PLACE||!1,ot=v.ALLOWED_URI_REGEXP||ot,_i=v.NAMESPACE||Qe,v.CUSTOM_ELEMENT_HANDLING&&Na(v.CUSTOM_ELEMENT_HANDLING.tagNameCheck)&&(se.tagNameCheck=v.CUSTOM_ELEMENT_HANDLING.tagNameCheck),v.CUSTOM_ELEMENT_HANDLING&&Na(v.CUSTOM_ELEMENT_HANDLING.attributeNameCheck)&&(se.attributeNameCheck=v.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),v.CUSTOM_ELEMENT_HANDLING&&typeof v.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements=="boolean"&&(se.allowCustomizedBuiltInElements=v.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements),$t=Gs.indexOf(v.PARSER_MEDIA_TYPE)===-1?$t=qs:$t=v.PARSER_MEDIA_TYPE,rt=$t==="application/xhtml+xml"?function(_){return _}:Ai,yt&&(io=!1),yi&&(wt=!0),_t&&(te=R({},Ee(xr)),he=[],_t.html===!0&&(R(te,_r),R(he,$r)),_t.svg===!0&&(R(te,$o),R(he,ko),R(he,Ti)),_t.svgFilters===!0&&(R(te,So),R(he,ko),R(he,Ti)),_t.mathMl===!0&&(R(te,Co),R(he,Sr),R(he,Ti))),v.ADD_TAGS&&(te===qt&&(te=nt(te)),R(te,v.ADD_TAGS)),v.ADD_ATTR&&(he===Aa&&(he=nt(he)),R(he,v.ADD_ATTR)),v.ADD_URI_SAFE_ATTR&&R(so,v.ADD_URI_SAFE_ATTR),v.FORBID_CONTENTS&&(xt===Ra&&(xt=nt(xt)),R(xt,v.FORBID_CONTENTS)),ro&&(te["#text"]=!0),at&&R(te,["html","head","body"]),te.table&&(R(te,["tbody"]),delete Qt.tbody),ye&&ye(v),St=v)},Ua=R({},["mi","mo","mn","ms","mtext"]),Ha=R({},["foreignobject","desc","title","annotation-xml"]),Ks=R({},["title","style","font","a","script"]),xi=R({},$o);R(xi,So),R(xi,Kn);var po=R({},Co);R(po,Yn);var Ys=function(v){var _=L(v);(!_||!_.tagName)&&(_={namespaceURI:Qe,tagName:"template"});var k=Ai(v.tagName),V=Ai(_.tagName);return v.namespaceURI===no?_.namespaceURI===Qe?k==="svg":_.namespaceURI===lo?k==="svg"&&(V==="annotation-xml"||Ua[V]):Boolean(xi[k]):v.namespaceURI===lo?_.namespaceURI===Qe?k==="math":_.namespaceURI===no?k==="math"&&Ha[V]:Boolean(po[k]):v.namespaceURI===Qe?_.namespaceURI===no&&!Ha[V]||_.namespaceURI===lo&&!Ua[V]?!1:!po[k]&&(Ks[k]||!xi[k]):!1},Ne=function(v){Jt(e.removed,{element:v});try{v.parentNode.removeChild(v)}catch{try{v.outerHTML=oe}catch{v.remove()}}},Va=function(v,_){try{Jt(e.removed,{attribute:_.getAttributeNode(v),from:_})}catch{Jt(e.removed,{attribute:null,from:_})}if(_.removeAttribute(v),v==="is"&&!he[v])if(wt||yi)try{Ne(_)}catch{}else try{_.setAttribute(v,"")}catch{}},Wa=function(v){var _,k;if(ao)v="<remove></remove>"+v;else{var V=jn(v,/^[\r\n\t ]+/);k=V&&V[0]}$t==="application/xhtml+xml"&&(v='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+v+"</body></html>");var xe=N?N.createHTML(v):v;if(_i===Qe)try{_=new y().parseFromString(xe,$t)}catch{}if(!_||!_.documentElement){_=$e.createDocument(_i,"template",null);try{_.documentElement.innerHTML=co?"":xe}catch{}}var fe=_.body||_.documentElement;return v&&k&&fe.insertBefore(i.createTextNode(k),fe.childNodes[0]||null),_i===Qe?Ht.call(_,at?"html":"body")[0]:at?_.documentElement:fe},ja=function(v){return j.call(v.ownerDocument||v,v,d.SHOW_ELEMENT|d.SHOW_COMMENT|d.SHOW_TEXT,null,!1)},Xs=function(v){return v instanceof m&&(typeof v.nodeName!="string"||typeof v.textContent!="string"||typeof v.removeChild!="function"||!(v.attributes instanceof u)||typeof v.removeAttribute!="function"||typeof v.setAttribute!="function"||typeof v.namespaceURI!="string"||typeof v.insertBefore!="function")},Yt=function(v){return pt(s)==="object"?v instanceof s:v&&pt(v)==="object"&&typeof v.nodeType=="number"&&typeof v.nodeName=="string"},Ue=function(v,_,k){!_e[v]||Wn(_e[v],function(V){V.call(e,_,k,St)})},Ga=function(v){var _;if(Ue("beforeSanitizeElements",v,null),Xs(v)||ge(/[\u0080-\uFFFF]/,v.nodeName))return Ne(v),!0;var k=rt(v.nodeName);if(Ue("uponSanitizeElement",v,{tagName:k,allowedTags:te}),v.hasChildNodes()&&!Yt(v.firstElementChild)&&(!Yt(v.content)||!Yt(v.content.firstElementChild))&&ge(/<[/\w]/g,v.innerHTML)&&ge(/<[/\w]/g,v.textContent)||k==="select"&&ge(/<template/i,v.innerHTML))return Ne(v),!0;if(!te[k]||Qt[k]){if(!Qt[k]&&Qa(k)&&(se.tagNameCheck instanceof RegExp&&ge(se.tagNameCheck,k)||se.tagNameCheck instanceof Function&&se.tagNameCheck(k)))return!1;if(ro&&!xt[k]){var V=L(v)||v.parentNode,xe=D(v)||v.childNodes;if(xe&&V)for(var fe=xe.length,pe=fe-1;pe>=0;--pe)V.insertBefore(C(xe[pe],!0),A(v))}return Ne(v),!0}return v instanceof n&&!Ys(v)||(k==="noscript"||k==="noembed")&&ge(/<\/no(script|embed)/i,v.innerHTML)?(Ne(v),!0):(yt&&v.nodeType===3&&(_=v.textContent,_=Ke(_,tt," "),_=Ke(_,it," "),v.textContent!==_&&(Jt(e.removed,{element:v.cloneNode()}),v.textContent=_)),Ue("afterSanitizeElements",v,null),!1)},qa=function(v,_,k){if(Ba&&(_==="id"||_==="name")&&(k in i||k in Qs))return!1;if(!(io&&!to[_]&&ge(Wt,_))){if(!(La&&ge(jt,_))){if(!he[_]||to[_]){if(!(Qa(v)&&(se.tagNameCheck instanceof RegExp&&ge(se.tagNameCheck,v)||se.tagNameCheck instanceof Function&&se.tagNameCheck(v))&&(se.attributeNameCheck instanceof RegExp&&ge(se.attributeNameCheck,_)||se.attributeNameCheck instanceof Function&&se.attributeNameCheck(_))||_==="is"&&se.allowCustomizedBuiltInElements&&(se.tagNameCheck instanceof RegExp&&ge(se.tagNameCheck,k)||se.tagNameCheck instanceof Function&&se.tagNameCheck(k))))return!1}else if(!so[_]){if(!ge(ot,Ke(k,bt,""))){if(!((_==="src"||_==="xlink:href"||_==="href")&&v!=="script"&&Gn(k,"data:")===0&&Fa[v])){if(!(Da&&!ge(Gt,Ke(k,bt,"")))){if(k)return!1}}}}}}return!0},Qa=function(v){return v.indexOf("-")>0},Ka=function(v){var _,k,V,xe;Ue("beforeSanitizeAttributes",v,null);var fe=v.attributes;if(!!fe){var pe={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:he};for(xe=fe.length;xe--;){_=fe[xe];var $i=_,me=$i.name,Ya=$i.namespaceURI;if(k=me==="value"?_.value:qn(_.value),V=rt(me),pe.attrName=V,pe.attrValue=k,pe.keepAttr=!0,pe.forceKeepAttr=void 0,Ue("uponSanitizeAttribute",v,pe),k=pe.attrValue,!pe.forceKeepAttr&&(Va(me,v),!!pe.keepAttr)){if(ge(/\/>/i,k)){Va(me,v);continue}yt&&(k=Ke(k,tt," "),k=Ke(k,it," "));var Js=rt(v.nodeName);if(!!qa(Js,V,k))try{Ya?v.setAttributeNS(Ya,me,k):v.setAttribute(me,k),wr(e.removed)}catch{}}}Ue("afterSanitizeAttributes",v,null)}},Zs=function z(v){var _,k=ja(v);for(Ue("beforeSanitizeShadowDOM",v,null);_=k.nextNode();)Ue("uponSanitizeShadowNode",_,null),!Ga(_)&&(_.content instanceof o&&z(_.content),Ka(_));Ue("afterSanitizeShadowDOM",v,null)};return e.sanitize=function(z,v){var _,k,V,xe,fe;if(co=!z,co&&(z="<!-->"),typeof z!="string"&&!Yt(z)){if(typeof z.toString!="function")throw xo("toString is not a function");if(z=z.toString(),typeof z!="string")throw xo("dirty is not a string, aborting")}if(!e.isSupported){if(pt(a.toStaticHTML)==="object"||typeof a.toStaticHTML=="function"){if(typeof z=="string")return a.toStaticHTML(z);if(Yt(z))return a.toStaticHTML(z.outerHTML)}return z}if(oo||ho(v),e.removed=[],typeof z=="string"&&(Kt=!1),Kt){if(z.nodeName){var pe=rt(z.nodeName);if(!te[pe]||Qt[pe])throw xo("root node is forbidden and cannot be sanitized in-place")}}else if(z instanceof s)_=Wa("<!---->"),k=_.ownerDocument.importNode(z,!0),k.nodeType===1&&k.nodeName==="BODY"||k.nodeName==="HTML"?_=k:_.appendChild(k);else{if(!wt&&!yt&&!at&&z.indexOf("<")===-1)return N&&wi?N.createHTML(z):z;if(_=Wa(z),!_)return wt?null:wi?oe:""}_&&ao&&Ne(_.firstChild);for(var $i=ja(Kt?z:_);V=$i.nextNode();)V.nodeType===3&&V===xe||Ga(V)||(V.content instanceof o&&Zs(V.content),Ka(V),xe=V);if(xe=null,Kt)return z;if(wt){if(yi)for(fe=Se.call(_.ownerDocument);_.firstChild;)fe.appendChild(_.firstChild);else fe=_;return he.shadowroot&&(fe=Vt.call(t,fe,!0)),fe}var me=at?_.outerHTML:_.innerHTML;return at&&te["!doctype"]&&_.ownerDocument&&_.ownerDocument.doctype&&_.ownerDocument.doctype.name&&ge(ad,_.ownerDocument.doctype.name)&&(me="<!DOCTYPE "+_.ownerDocument.doctype.name+`>
`+me),yt&&(me=Ke(me,tt," "),me=Ke(me,it," ")),N&&wi?N.createHTML(me):me},e.setConfig=function(z){ho(z),oo=!0},e.clearConfig=function(){St=null,oo=!1},e.isValidAttribute=function(z,v,_){St||ho({});var k=rt(z),V=rt(v);return qa(k,V,_)},e.addHook=function(z,v){typeof v=="function"&&(_e[z]=_e[z]||[],Jt(_e[z],v))},e.removeHook=function(z){if(_e[z])return wr(_e[z])},e.removeHooks=function(z){_e[z]&&(_e[z]=[])},e.removeAllHooks=function(){_e={}},e}var Li=Ps();let Wi=class extends ce{constructor(){super(...arguments),this.collectionLinks=[]}render(){return c`
    ...
    `}get datePublishedTemplate(){var e;const t=(e=this.model)===null||e===void 0?void 0:e.datePublished;let i="long";return Ea(t)&&(i="year-only"),this.metadataTemplate(Lt(t,i),M("Published"))}get dateSortByTemplate(){return this.effectiveSort&&(this.effectiveSort.field==="addeddate"||this.effectiveSort.field==="reviewdate"||this.effectiveSort.field==="publicdate")?this.metadataTemplate(Lt(this.date,"long"),this.displayValueProvider.dateLabel):b}get viewsTemplate(){var e,t,i,o;const r=((e=this.effectiveSort)===null||e===void 0?void 0:e.field)==="week"?(t=this.model)===null||t===void 0?void 0:t.weeklyViewCount:(i=this.model)===null||i===void 0?void 0:i.viewCount;return r==null?b:((o=this.model)===null||o===void 0?void 0:o.mediatype)==="search"?this.metadataTemplate("(Favorited search query)",""):this.metadataTemplate(`${oi(r,this.formatSize)}`,M("Views"))}get ratingTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.averageRating,M("Avg Rating"))}get reviewsTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.commentCount,M("Reviews"))}get topicsTemplate(){var e;return!(!((e=this.model)===null||e===void 0)&&e.subjects)||this.model.subjects.length===0?b:c`
    ...
    >
      ${Li.sanitize(t)}</a
    >`}detailsLink(e,t,i=!1){if(!e)return b;const o=t!=null?t:e,r=this.displayValueProvider.itemPageUrl(e,i);return c`<a href=${r}> ${Li.sanitize(o)} </a>`}get mediatypeURL(){var e;if(this.baseNavigationUrl===void 0||!(!((e=this.model)===null||e===void 0)&&e.mediatype))return b;switch(this.model.mediatype){case"collection":return`${this.baseNavigationUrl}/search?query=mediatype:collection&sort=-downloads`;case"account":return b;default:return this.displayValueProvider.itemPageUrl(this.model.mediatype,!0)}}updated(e){(e.has("model")||e.has("collectionTitles"))&&this.buildCollectionLinks()}async buildCollectionLinks(){var e,t,i;if(!(!((e=this.model)===null||e===void 0)&&e.collections)||this.model.collections.length===0)return;this.collectionLinks=[];const o=[];for(const r of this.model.collections)!Zi[r]&&!r.startsWith("fav-")&&o.push(this.detailsLink(r,(i=(t=this.collectionTitles)===null||t===void 0?void 0:t.get(r))!==null&&i!==void 0?i:r,!0));this.collectionLinks=o}get date(){var e,t,i,o,r;switch((e=this.effectiveSort)===null||e===void 0?void 0:e.field){case"date":return(t=this.model)===null||t===void 0?void 0:t.datePublished;case"reviewdate":return(i=this.model)===null||i===void 0?void 0:i.dateReviewed;case"addeddate":return(o=this.model)===null||o===void 0?void 0:o.dateAdded;default:return(r=this.model)===null||r===void 0?void 0:r.dateArchived}}get effectiveSort(){var e;return(e=this.sortParam)!==null&&e!==void 0?e:this.defaultSortParam}get classSize(){return this.mobileBreakpoint&&this.currentWidth&&this.currentWidth<this.mobileBreakpoint?"mobile":"desktop"}get formatSize(){return this.mobileBreakpoint&&this.currentWidth&&this.currentWidth<this.mobileBreakpoint?"short":"long"}static get styles(){return f`
      html {
        font-size: unset;
      }
    ...
    `}};l([h({type:Object})],Wi.prototype,"collectionTitles",void 0);l([P()],Wi.prototype,"collectionLinks",void 0);Wi=l([B("tile-list")],Wi);let Oe=class extends O{constructor(){super(...arguments),this.loggedIn=!1}render(){return c`
      <div id="container">
        ${this.headerTemplate}
    ...
    `}get headerTemplate(){var e,t,i,o;if(((e=this.model)===null||e===void 0?void 0:e.collections.length)===0)return b;let r="",s="";for(const n of((t=this.model)===null||t===void 0?void 0:t.collections)||[])if(!Zi[n]&&!n.startsWith("fav-")){r=(o=(i=this.collectionTitles)===null||i===void 0?void 0:i.get(n))!==null&&o!==void 0?o:n,s=n;break}return s?c`
    ...
    `}};l([h({type:Object})],Oe.prototype,"model",void 0);l([h({type:String})],Oe.prototype,"baseNavigationUrl",void 0);l([h({type:String})],Oe.prototype,"baseImageUrl",void 0);l([h({type:Boolean})],Oe.prototype,"loggedIn",void 0);l([h({type:Object})],Oe.prototype,"sortParam",void 0);l([h({type:Number})],Oe.prototype,"mobileBreakpoint",void 0);l([h({type:Number})],Oe.prototype,"currentWidth",void 0);l([h({type:Object})],Oe.prototype,"collectionTitles",void 0);Oe=l([B("tile-hover-pane")],Oe);let Cr=class extends ce{render(){var e,t,i,o,r,s;return c`
      <div id="list-line" class="${this.classSize}">
        <image-block
          .model=${this.model}
          .baseImageUrl=${this.baseImageUrl}
    ...
    `}};Cr=l([B("tile-list-compact")],Cr);let kr=class extends ce{render(){return c`
    ...
    `}firstUpdated(){this.shouldPrepareHoverPane&&(this.hoverPaneController=new ld(this,{mobileBreakpoint:this.mobileBreakpoint,enableLongPress:!1}))}get headerTemplate(){const{currentWidth:e,sortParam:t,defaultSortParam:i,mobileBreakpoint:o}=this;return c`
    ...
    `}get linkTileTemplate(){var e,t,i;return c`
      <a
        ...
        title=${this.shouldPrepareHoverPane?b:Ta((i=this.model)===null||i===void 0?void 0:i.title)}
    ...
    `}};Er=l([B("collection-browser-loading-tile")],Er);/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Di=window,Ma=Di.ShadowRoot&&(Di.ShadyCSS===void 0||Di.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,As=Symbol(),Mr=new WeakMap;class nd{constructor(e,t,i){if(this._$cssResult$=!0,i!==As)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o;const t=this.t;if(Ma&&e===void 0){const i=t!==void 0&&t.length===1;i&&(e=Mr.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),i&&Mr.set(t,e))}return e}toString(){return this.cssText}}const dd=a=>new nd(typeof a=="string"?a:a+"",void 0,As),cd=(a,e)=>{Ma?a.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet):e.forEach(t=>{const i=document.createElement("style"),o=Di.litNonce;o!==void 0&&i.setAttribute("nonce",o),i.textContent=t.cssText,a.appendChild(i)})},zr=Ma?a=>a:a=>a instanceof CSSStyleSheet?(e=>{let t="";for(const i of e.cssRules)t+=i.cssText;return dd(t)})(a):a;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var To;const ji=window,Pr=ji.trustedTypes,hd=Pr?Pr.emptyScript:"",Ar=ji.reactiveElementPolyfillSupport,ca={toAttribute(a,e){switch(e){case Boolean:a=a?hd:null;break;case Object:case Array:a=a==null?a:JSON.stringify(a)}return a},fromAttribute(a,e){let t=a;switch(e){case Boolean:t=a!==null;break;case Number:t=a===null?null:Number(a);break;case Object:case Array:try{t=JSON.parse(a)}catch{t=null}}return t}},Ls=(a,e)=>e!==a&&(e==e||a==a),Eo={attribute:!0,type:String,converter:ca,reflect:!1,hasChanged:Ls},ha="finalized";class ei extends HTMLElement{constructor(){super(),this._$Ei=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$El=null,this._$Eu()}static addInitializer(e){var t;this.finalize(),((t=this.h)!==null&&t!==void 0?t:this.h=[]).push(e)}static get observedAttributes(){this.finalize();const e=[];return this.elementProperties.forEach((t,i)=>{const o=this._$Ep(i,t);o!==void 0&&(this._$Ev.set(o,i),e.push(o))}),e}static createProperty(e,t=Eo){if(t.state&&(t.attribute=!1),this.finalize(),this.elementProperties.set(e,t),!t.noAccessor&&!this.prototype.hasOwnProperty(e)){const i=typeof e=="symbol"?Symbol():"__"+e,o=this.getPropertyDescriptor(e,i,t);o!==void 0&&Object.defineProperty(this.prototype,e,o)}}static getPropertyDescriptor(e,t,i){return{get(){return this[t]},set(o){const r=this[e];this[t]=o,this.requestUpdate(e,r,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)||Eo}static finalize(){if(this.hasOwnProperty(ha))return!1;this[ha]=!0;const e=Object.getPrototypeOf(this);if(e.finalize(),e.h!==void 0&&(this.h=[...e.h]),this.elementProperties=new Map(e.elementProperties),this._$Ev=new Map,this.hasOwnProperty("properties")){const t=this.properties,i=[...Object.getOwnPropertyNames(t),...Object.getOwnPropertySymbols(t)];for(const o of i)this.createProperty(o,t[o])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const i=new Set(e.flat(1/0).reverse());for(const o of i)t.unshift(zr(o))}else e!==void 0&&t.push(zr(e));return t}static _$Ep(e,t){const i=t.attribute;return i===!1?void 0:typeof i=="string"?i:typeof e=="string"?e.toLowerCase():void 0}_$Eu(){var e;this._$E_=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$Eg(),this.requestUpdate(),(e=this.constructor.h)===null||e===void 0||e.forEach(t=>t(this))}addController(e){var t,i;((t=this._$ES)!==null&&t!==void 0?t:this._$ES=[]).push(e),this.renderRoot!==void 0&&this.isConnected&&((i=e.hostConnected)===null||i===void 0||i.call(e))}removeController(e){var t;(t=this._$ES)===null||t===void 0||t.splice(this._$ES.indexOf(e)>>>0,1)}_$Eg(){this.constructor.elementProperties.forEach((e,t)=>{this.hasOwnProperty(t)&&(this._$Ei.set(t,this[t]),delete this[t])})}createRenderRoot(){var e;const t=(e=this.shadowRoot)!==null&&e!==void 0?e:this.attachShadow(this.constructor.shadowRootOptions);return cd(t,this.constructor.elementStyles),t}connectedCallback(){var e;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$ES)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostConnected)===null||i===void 0?void 0:i.call(t)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$ES)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostDisconnected)===null||i===void 0?void 0:i.call(t)})}attributeChangedCallback(e,t,i){this._$AK(e,i)}_$EO(e,t,i=Eo){var o;const r=this.constructor._$Ep(e,i);if(r!==void 0&&i.reflect===!0){const s=(((o=i.converter)===null||o===void 0?void 0:o.toAttribute)!==void 0?i.converter:ca).toAttribute(t,i.type);this._$El=e,s==null?this.removeAttribute(r):this.setAttribute(r,s),this._$El=null}}_$AK(e,t){var i;const o=this.constructor,r=o._$Ev.get(e);if(r!==void 0&&this._$El!==r){const s=o.getPropertyOptions(r),n=typeof s.converter=="function"?{fromAttribute:s.converter}:((i=s.converter)===null||i===void 0?void 0:i.fromAttribute)!==void 0?s.converter:ca;this._$El=r,this[r]=n.fromAttribute(t,s.type),this._$El=null}}requestUpdate(e,t,i){let o=!0;e!==void 0&&(((i=i||this.constructor.getPropertyOptions(e)).hasChanged||Ls)(this[e],t)?(this._$AL.has(e)||this._$AL.set(e,t),i.reflect===!0&&this._$El!==e&&(this._$EC===void 0&&(this._$EC=new Map),this._$EC.set(e,i))):o=!1),!this.isUpdatePending&&o&&(this._$E_=this._$Ej())}async _$Ej(){this.isUpdatePending=!0;try{await this._$E_}catch(t){Promise.reject(t)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var e;if(!this.isUpdatePending)return;this.hasUpdated,this._$Ei&&(this._$Ei.forEach((o,r)=>this[r]=o),this._$Ei=void 0);let t=!1;const i=this._$AL;try{t=this.shouldUpdate(i),t?(this.willUpdate(i),(e=this._$ES)===null||e===void 0||e.forEach(o=>{var r;return(r=o.hostUpdate)===null||r===void 0?void 0:r.call(o)}),this.update(i)):this._$Ek()}catch(o){throw t=!1,this._$Ek(),o}t&&this._$AE(i)}willUpdate(e){}_$AE(e){var t;(t=this._$ES)===null||t===void 0||t.forEach(i=>{var o;return(o=i.hostUpdated)===null||o===void 0?void 0:o.call(i)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$Ek(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$E_}shouldUpdate(e){return!0}update(e){this._$EC!==void 0&&(this._$EC.forEach((t,i)=>this._$EO(i,this[i],t)),this._$EC=void 0),this._$Ek()}updated(e){}firstUpdated(e){}}ei[ha]=!0,ei.elementProperties=new Map,ei.elementStyles=[],ei.shadowRootOptions={mode:"open"},Ar==null||Ar({ReactiveElement:ei}),((To=ji.reactiveElementVersions)!==null&&To!==void 0?To:ji.reactiveElementVersions=[]).push("1.6.3");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Mo;const Gi=window,Bt=Gi.trustedTypes,Lr=Bt?Bt.createPolicy("lit-html",{createHTML:a=>a}):void 0,pa="$lit$",Xe=`lit$${(Math.random()+"").slice(9)}$`,Ds="?"+Xe,pd=`<${Ds}>`,mt=document,di=()=>mt.createComment(""),ci=a=>a===null||typeof a!="object"&&typeof a!="function",Bs=Array.isArray,ud=a=>Bs(a)||typeof(a==null?void 0:a[Symbol.iterator])=="function",zo=`[ 	
\f\r]`,ti=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Dr=/-->/g,Br=/>/g,dt=RegExp(`>|${zo}(?:([^\\s"'>=/]+)(${zo}*=${zo}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Rr=/'/g,Fr=/"/g,Rs=/^(?:script|style|textarea|title)$/i,Fs=a=>(e,...t)=>({_$litType$:a,strings:e,values:t}),Te=Fs(1),Os=Fs(2),Rt=Symbol.for("lit-noChange"),ie=Symbol.for("lit-nothing"),Or=new WeakMap,ut=mt.createTreeWalker(mt,129,null,!1);function Is(a,e){if(!Array.isArray(a)||!a.hasOwnProperty("raw"))throw Error("invalid template strings array");return Lr!==void 0?Lr.createHTML(e):e}const vd=(a,e)=>{const t=a.length-1,i=[];let o,r=e===2?"<svg>":"",s=ti;for(let n=0;n<t;n++){const d=a[n];let p,u,m=-1,y=0;for(;y<d.length&&(s.lastIndex=y,u=s.exec(d),u!==null);)y=s.lastIndex,s===ti?u[1]==="!--"?s=Dr:u[1]!==void 0?s=Br:u[2]!==void 0?(Rs.test(u[2])&&(o=RegExp("</"+u[2],"g")),s=dt):u[3]!==void 0&&(s=dt):s===dt?u[0]===">"?(s=o!=null?o:ti,m=-1):u[1]===void 0?m=-2:(m=s.lastIndex-u[2].length,p=u[1],s=u[3]===void 0?dt:u[3]==='"'?Fr:Rr):s===Fr||s===Rr?s=dt:s===Dr||s===Br?s=ti:(s=dt,o=void 0);const w=s===dt&&a[n+1].startsWith("/>")?" ":"";r+=s===ti?d+pd:m>=0?(i.push(p),d.slice(0,m)+pa+d.slice(m)+Xe+w):d+Xe+(m===-2?(i.push(void 0),n):w)}return[Is(a,r+(a[t]||"<?>")+(e===2?"</svg>":"")),i]};class hi{constructor({strings:e,_$litType$:t},i){let o;this.parts=[];let r=0,s=0;const n=e.length-1,d=this.parts,[p,u]=vd(e,t);if(this.el=hi.createElement(p,i),ut.currentNode=this.el.content,t===2){const m=this.el.content,y=m.firstChild;y.remove(),m.append(...y.childNodes)}for(;(o=ut.nextNode())!==null&&d.length<n;){if(o.nodeType===1){if(o.hasAttributes()){const m=[];for(const y of o.getAttributeNames())if(y.endsWith(pa)||y.startsWith(Xe)){const w=u[s++];if(m.push(y),w!==void 0){const x=o.getAttribute(w.toLowerCase()+pa).split(Xe),C=/([.?@])?(.*)/.exec(w);d.push({type:1,index:r,name:C[2],strings:x,ctor:C[1]==="."?md:C[1]==="?"?bd:C[1]==="@"?yd:eo})}else d.push({type:6,index:r})}for(const y of m)o.removeAttribute(y)}if(Rs.test(o.tagName)){const m=o.textContent.split(Xe),y=m.length-1;if(y>0){o.textContent=Bt?Bt.emptyScript:"";for(let w=0;w<y;w++)o.append(m[w],di()),ut.nextNode(),d.push({type:2,index:++r});o.append(m[y],di())}}}else if(o.nodeType===8)if(o.data===Ds)d.push({type:2,index:r});else{let m=-1;for(;(m=o.data.indexOf(Xe,m+1))!==-1;)d.push({type:7,index:r}),m+=Xe.length-1}r++}}static createElement(e,t){const i=mt.createElement("template");return i.innerHTML=e,i}}function Ft(a,e,t=a,i){var o,r,s,n;if(e===Rt)return e;let d=i!==void 0?(o=t._$Co)===null||o===void 0?void 0:o[i]:t._$Cl;const p=ci(e)?void 0:e._$litDirective$;return(d==null?void 0:d.constructor)!==p&&((r=d==null?void 0:d._$AO)===null||r===void 0||r.call(d,!1),p===void 0?d=void 0:(d=new p(a),d._$AT(a,t,i)),i!==void 0?((s=(n=t)._$Co)!==null&&s!==void 0?s:n._$Co=[])[i]=d:t._$Cl=d),d!==void 0&&(e=Ft(a,d._$AS(a,e.values),d,i)),e}class fd{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){var t;const{el:{content:i},parts:o}=this._$AD,r=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:mt).importNode(i,!0);ut.currentNode=r;let s=ut.nextNode(),n=0,d=0,p=o[0];for(;p!==void 0;){if(n===p.index){let u;p.type===2?u=new bi(s,s.nextSibling,this,e):p.type===1?u=new p.ctor(s,p.name,p.strings,this,e):p.type===6&&(u=new wd(s,this,e)),this._$AV.push(u),p=o[++d]}n!==(p==null?void 0:p.index)&&(s=ut.nextNode(),n++)}return ut.currentNode=mt,r}v(e){let t=0;for(const i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class bi{constructor(e,t,i,o){var r;this.type=2,this._$AH=ie,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=o,this._$Cp=(r=o==null?void 0:o.isConnected)===null||r===void 0||r}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cp}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Ft(this,e,t),ci(e)?e===ie||e==null||e===""?(this._$AH!==ie&&this._$AR(),this._$AH=ie):e!==this._$AH&&e!==Rt&&this._(e):e._$litType$!==void 0?this.g(e):e.nodeType!==void 0?this.$(e):ud(e)?this.T(e):this._(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==ie&&ci(this._$AH)?this._$AA.nextSibling.data=e:this.$(mt.createTextNode(e)),this._$AH=e}g(e){var t;const{values:i,_$litType$:o}=e,r=typeof o=="number"?this._$AC(e):(o.el===void 0&&(o.el=hi.createElement(Is(o.h,o.h[0]),this.options)),o);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===r)this._$AH.v(i);else{const s=new fd(r,this),n=s.u(this.options);s.v(i),this.$(n),this._$AH=s}}_$AC(e){let t=Or.get(e.strings);return t===void 0&&Or.set(e.strings,t=new hi(e)),t}T(e){Bs(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,o=0;for(const r of e)o===t.length?t.push(i=new bi(this.k(di()),this.k(di()),this,this.options)):i=t[o],i._$AI(r),o++;o<t.length&&(this._$AR(i&&i._$AB.nextSibling,o),t.length=o)}_$AR(e=this._$AA.nextSibling,t){var i;for((i=this._$AP)===null||i===void 0||i.call(this,!1,!0,t);e&&e!==this._$AB;){const o=e.nextSibling;e.remove(),e=o}}setConnected(e){var t;this._$AM===void 0&&(this._$Cp=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}}class eo{constructor(e,t,i,o,r){this.type=1,this._$AH=ie,this._$AN=void 0,this.element=e,this.name=t,this._$AM=o,this.options=r,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=ie}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,i,o){const r=this.strings;let s=!1;if(r===void 0)e=Ft(this,e,t,0),s=!ci(e)||e!==this._$AH&&e!==Rt,s&&(this._$AH=e);else{const n=e;let d,p;for(e=r[0],d=0;d<r.length-1;d++)p=Ft(this,n[i+d],t,d),p===Rt&&(p=this._$AH[d]),s||(s=!ci(p)||p!==this._$AH[d]),p===ie?e=ie:e!==ie&&(e+=(p!=null?p:"")+r[d+1]),this._$AH[d]=p}s&&!o&&this.j(e)}j(e){e===ie?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e!=null?e:"")}}class md extends eo{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===ie?void 0:e}}const gd=Bt?Bt.emptyScript:"";class bd extends eo{constructor(){super(...arguments),this.type=4}j(e){e&&e!==ie?this.element.setAttribute(this.name,gd):this.element.removeAttribute(this.name)}}class yd extends eo{constructor(e,t,i,o,r){super(e,t,i,o,r),this.type=5}_$AI(e,t=this){var i;if((e=(i=Ft(this,e,t,0))!==null&&i!==void 0?i:ie)===Rt)return;const o=this._$AH,r=e===ie&&o!==ie||e.capture!==o.capture||e.once!==o.once||e.passive!==o.passive,s=e!==ie&&(o===ie||r);r&&this.element.removeEventListener(this.name,this,o),s&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,i;typeof this._$AH=="function"?this._$AH.call((i=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&i!==void 0?i:this.element,e):this._$AH.handleEvent(e)}}class wd{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){Ft(this,e)}}const Ir=Gi.litHtmlPolyfillSupport;Ir==null||Ir(hi,bi),((Mo=Gi.litHtmlVersions)!==null&&Mo!==void 0?Mo:Gi.litHtmlVersions=[]).push("2.8.0");const _d=(a,e,t)=>{var i,o;const r=(i=t==null?void 0:t.renderBefore)!==null&&i!==void 0?i:e;let s=r._$litPart$;if(s===void 0){const n=(o=t==null?void 0:t.renderBefore)!==null&&o!==void 0?o:null;r._$litPart$=s=new bi(e.insertBefore(di(),n),n,void 0,t!=null?t:{})}return s._$AI(a),s};/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const za=window.ShadowRoot&&(window.ShadyCSS===void 0||window.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Pa=Symbol(),Nr=new Map;class Ns{constructor(e,t){if(this._$cssResult$=!0,t!==Pa)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e}get styleSheet(){let e=Nr.get(this.cssText);return za&&e===void 0&&(Nr.set(this.cssText,e=new CSSStyleSheet),e.replaceSync(this.cssText)),e}toString(){return this.cssText}}const xd=a=>new Ns(typeof a=="string"?a:a+"",Pa),He=(a,...e)=>{const t=a.length===1?a[0]:e.reduce((i,o,r)=>i+(s=>{if(s._$cssResult$===!0)return s.cssText;if(typeof s=="number")return s;throw Error("Value passed to 'css' function must be a 'css' function result: "+s+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(o)+a[r+1],a[0]);return new Ns(t,Pa)},$d=(a,e)=>{za?a.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet):e.forEach(t=>{const i=document.createElement("style"),o=window.litNonce;o!==void 0&&i.setAttribute("nonce",o),i.textContent=t.cssText,a.appendChild(i)})},Ur=za?a=>a:a=>a instanceof CSSStyleSheet?(e=>{let t="";for(const i of e.cssRules)t+=i.cssText;return xd(t)})(a):a;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Po;const Hr=window.trustedTypes,Sd=Hr?Hr.emptyScript:"",Vr=window.reactiveElementPolyfillSupport,ua={toAttribute(a,e){switch(e){case Boolean:a=a?Sd:null;break;case Object:case Array:a=a==null?a:JSON.stringify(a)}return a},fromAttribute(a,e){let t=a;switch(e){case Boolean:t=a!==null;break;case Number:t=a===null?null:Number(a);break;case Object:case Array:try{t=JSON.parse(a)}catch{t=null}}return t}},Us=(a,e)=>e!==a&&(e==e||a==a),Ao={attribute:!0,type:String,converter:ua,reflect:!1,hasChanged:Us};class kt extends HTMLElement{constructor(){super(),this._$Et=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Ei=null,this.o()}static addInitializer(e){var t;(t=this.l)!==null&&t!==void 0||(this.l=[]),this.l.push(e)}static get observedAttributes(){this.finalize();const e=[];return this.elementProperties.forEach((t,i)=>{const o=this._$Eh(i,t);o!==void 0&&(this._$Eu.set(o,i),e.push(o))}),e}static createProperty(e,t=Ao){if(t.state&&(t.attribute=!1),this.finalize(),this.elementProperties.set(e,t),!t.noAccessor&&!this.prototype.hasOwnProperty(e)){const i=typeof e=="symbol"?Symbol():"__"+e,o=this.getPropertyDescriptor(e,i,t);o!==void 0&&Object.defineProperty(this.prototype,e,o)}}static getPropertyDescriptor(e,t,i){return{get(){return this[t]},set(o){const r=this[e];this[t]=o,this.requestUpdate(e,r,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)||Ao}static finalize(){if(this.hasOwnProperty("finalized"))return!1;this.finalized=!0;const e=Object.getPrototypeOf(this);if(e.finalize(),this.elementProperties=new Map(e.elementProperties),this._$Eu=new Map,this.hasOwnProperty("properties")){const t=this.properties,i=[...Object.getOwnPropertyNames(t),...Object.getOwnPropertySymbols(t)];for(const o of i)this.createProperty(o,t[o])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const i=new Set(e.flat(1/0).reverse());for(const o of i)t.unshift(Ur(o))}else e!==void 0&&t.push(Ur(e));return t}static _$Eh(e,t){const i=t.attribute;return i===!1?void 0:typeof i=="string"?i:typeof e=="string"?e.toLowerCase():void 0}o(){var e;this._$Ep=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$Em(),this.requestUpdate(),(e=this.constructor.l)===null||e===void 0||e.forEach(t=>t(this))}addController(e){var t,i;((t=this._$Eg)!==null&&t!==void 0?t:this._$Eg=[]).push(e),this.renderRoot!==void 0&&this.isConnected&&((i=e.hostConnected)===null||i===void 0||i.call(e))}removeController(e){var t;(t=this._$Eg)===null||t===void 0||t.splice(this._$Eg.indexOf(e)>>>0,1)}_$Em(){this.constructor.elementProperties.forEach((e,t)=>{this.hasOwnProperty(t)&&(this._$Et.set(t,this[t]),delete this[t])})}createRenderRoot(){var e;const t=(e=this.shadowRoot)!==null&&e!==void 0?e:this.attachShadow(this.constructor.shadowRootOptions);return $d(t,this.constructor.elementStyles),t}connectedCallback(){var e;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$Eg)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostConnected)===null||i===void 0?void 0:i.call(t)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$Eg)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostDisconnected)===null||i===void 0?void 0:i.call(t)})}attributeChangedCallback(e,t,i){this._$AK(e,i)}_$ES(e,t,i=Ao){var o,r;const s=this.constructor._$Eh(e,i);if(s!==void 0&&i.reflect===!0){const n=((r=(o=i.converter)===null||o===void 0?void 0:o.toAttribute)!==null&&r!==void 0?r:ua.toAttribute)(t,i.type);this._$Ei=e,n==null?this.removeAttribute(s):this.setAttribute(s,n),this._$Ei=null}}_$AK(e,t){var i,o,r;const s=this.constructor,n=s._$Eu.get(e);if(n!==void 0&&this._$Ei!==n){const d=s.getPropertyOptions(n),p=d.converter,u=(r=(o=(i=p)===null||i===void 0?void 0:i.fromAttribute)!==null&&o!==void 0?o:typeof p=="function"?p:null)!==null&&r!==void 0?r:ua.fromAttribute;this._$Ei=n,this[n]=u(t,d.type),this._$Ei=null}}requestUpdate(e,t,i){let o=!0;e!==void 0&&(((i=i||this.constructor.getPropertyOptions(e)).hasChanged||Us)(this[e],t)?(this._$AL.has(e)||this._$AL.set(e,t),i.reflect===!0&&this._$Ei!==e&&(this._$EC===void 0&&(this._$EC=new Map),this._$EC.set(e,i))):o=!1),!this.isUpdatePending&&o&&(this._$Ep=this._$E_())}async _$E_(){this.isUpdatePending=!0;try{await this._$Ep}catch(t){Promise.reject(t)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var e;if(!this.isUpdatePending)return;this.hasUpdated,this._$Et&&(this._$Et.forEach((o,r)=>this[r]=o),this._$Et=void 0);let t=!1;const i=this._$AL;try{t=this.shouldUpdate(i),t?(this.willUpdate(i),(e=this._$Eg)===null||e===void 0||e.forEach(o=>{var r;return(r=o.hostUpdate)===null||r===void 0?void 0:r.call(o)}),this.update(i)):this._$EU()}catch(o){throw t=!1,this._$EU(),o}t&&this._$AE(i)}willUpdate(e){}_$AE(e){var t;(t=this._$Eg)===null||t===void 0||t.forEach(i=>{var o;return(o=i.hostUpdated)===null||o===void 0?void 0:o.call(i)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EU(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$Ep}shouldUpdate(e){return!0}update(e){this._$EC!==void 0&&(this._$EC.forEach((t,i)=>this._$ES(i,this[i],t)),this._$EC=void 0),this._$EU()}updated(e){}firstUpdated(e){}}kt.finalized=!0,kt.elementProperties=new Map,kt.elementStyles=[],kt.shadowRootOptions={mode:"open"},Vr==null||Vr({ReactiveElement:kt}),((Po=globalThis.reactiveElementVersions)!==null&&Po!==void 0?Po:globalThis.reactiveElementVersions=[]).push("1.3.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Lo,Do;class Mt extends kt{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e,t;const i=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=i.firstChild),i}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=_d(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!1)}render(){return Rt}}Mt.finalized=!0,Mt._$litElement$=!0,(Lo=globalThis.litElementHydrateSupport)===null||Lo===void 0||Lo.call(globalThis,{LitElement:Mt});const Wr=globalThis.litElementPolyfillSupport;Wr==null||Wr({LitElement:Mt});((Do=globalThis.litElementVersions)!==null&&Do!==void 0?Do:globalThis.litElementVersions=[]).push("3.3.3");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Hs=a=>e=>typeof e=="function"?((t,i)=>(customElements.define(t,i),i))(a,e):((t,i)=>{const{kind:o,elements:r}=i;return{kind:o,elements:r,finisher(s){customElements.define(t,s)}}})(a,e);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Cd=(a,e)=>e.kind==="method"&&e.descriptor&&!("value"in e.descriptor)?ue(J({},e),{finisher(t){t.createProperty(e.key,a)}}):{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){typeof e.initializer=="function"&&(this[e.key]=e.initializer.call(this))},finisher(t){t.createProperty(e.key,a)}},kd=(a,e,t)=>{e.constructor.createProperty(t,a)};function we(a){return(e,t)=>t!==void 0?kd(a,e,t):Cd(a,e)}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Bo;((Bo=window.HTMLSlotElement)===null||Bo===void 0?void 0:Bo.prototype.assignedElements)!=null;/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const jr=a=>a!=null?a:ie;var Td=Os`<svg class="caret-up-svg" viewBox="0 0 8 4" xmlns="http://www.w3.org/2000/svg">
<path d="m6.7226499 3.51689722c.22976435.15317623.54019902.0910893.69337525-.13867505.13615665-.20423497.10222882-.47220946-.06836249-.63681849l-.07031256-.05655675-3.2773501-2.18490007-3.2773501 2.18490007c-.22976434.15317623-.29185128.4636109-.13867505.69337524.13615665.20423498.39656688.27598409.61412572.18182636l.07924953-.04315131 2.7226499-1.81402514z"
  fill=""></path>
</svg>`,Ed=Os`<svg class="caret-down-svg" viewBox="0 0 8 4" xmlns="http://www.w3.org/2000/svg">
...
fill=""></path>
      ...
      >
        <span ?hidden=${!this.open} class="caret-up">
          <slot name="caret-up">${Td}</slot>
        </span>
        <span ?hidden=${this.open} class="caret-down">
          <slot name="caret-down">${Ed}</slot>
        </span>
      </span>
    ...
    `}static get styles(){const e=He`var(--dropdownBorderWidth, 1px)`,t=He`var(--dropdownBorderRadius, 4px)`,i=He`var(--dropdownBorderColor, #fff)`,o=He`var(--dropdownBgColor, #333)`,r=He`var(--dropdownTextColor, #fff)`,s=He`var(--dropdownHoverBgColor, rgba(255, 255, 255, 0.3))`,n=He`var(--dropdownSelectedBgColor, #fff)`;return He`
      :host {
        display: inline;
        color: ${r};
      }
  ...
  `;va=l([Hs("ia-icon-label")],va);let fa=class extends O{constructor(){super(...arguments),this.numResults=0}render(){return c`
    ...
    `}};l([h({type:Number})],fa.prototype,"numResults",void 0);fa=l([B("alpha-bar-tooltip")],fa);let Ge=class extends O{constructor(){super(...arguments),this.selectedLetter=null,this.tooltipShown=!1,this.alphabet="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("")}get selectedUppercaseLetter(){var e;return(e=this.selectedLetter)===null||e===void 0?void 0:e.toUpperCase()}render(){var e;return c`
  ...
  `;l([h({type:String})],Ge.prototype,"selectedLetter",void 0);l([h({type:Object})],Ge.prototype,"letterCounts",void 0);l([h({type:String})],Ge.prototype,"ariaLandmarkLabel",void 0);l([P()],Ge.prototype,"tooltipShown",void 0);l([P()],Ge.prototype,"hoveredLetter",void 0);l([Z("alpha-bar-tooltip")],Ge.prototype,"tooltip",void 0);Ge=l([B("alpha-bar")],Ge);const Md=c`
...
`;let q=class extends O{constructor(){super(...arguments),this.defaultSortDirection=null,this.defaultSortField=$.relevance,this.sortDirection=null,this.selectedSort=$.default,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.showRelevance=!0,this.showDateFavorited=!1,this.enableSortOptionsSlot=!1,this.suppressDisplayModes=!1,this.lastSelectedViewSort=$.weeklyview,this.lastSelectedDateSort=this.defaultDateSortField,this.alphaSelectorVisible=null,this.dropdownBackdropVisible=!1,this.desktopSortContainerWidth=0,this.selectorBarContainerWidth=0,this.boundSortBarSelectorEscapeListener=e=>{e.key==="Escape"&&this.closeDropdowns()}}render(){return c`
    ...
    `}get sortDirectionIcon(){return this.canChangeSortDirection?c`
      <div class="sort-direction-icon">
        ${this.finalizedSortDirection==="asc"?Md:zd}
      </div>
    `:c`<div class="sort-direction-icon">${Pd}</div>`}get desktopSortSelectorTemplate(){return c`
      <div
    ...
    ></alpha-bar>`}titleLetterChanged(e){var t;this.selectedTitleFilter=(t=e.detail.selectedLetter)!==null&&t!==void 0?t:null,this.emitTitleLetterChangedEvent()}creatorLetterChanged(e){var t;this.selectedCreatorFilter=(t=e.detail.selectedLetter)!==null&&t!==void 0?t:null,this.emitCreatorLetterChangedEvent()}emitTitleLetterChangedEvent(){const e=new CustomEvent("titleLetterChanged",{detail:{selectedLetter:this.selectedTitleFilter}});this.dispatchEvent(e)}emitCreatorLetterChangedEvent(){const e=new CustomEvent("creatorLetterChanged",{detail:{selectedLetter:this.selectedCreatorFilter}});this.dispatchEvent(e)}displayModeChanged(){const e=new CustomEvent("displayModeChanged",{detail:{displayMode:this.displayMode}});this.dispatchEvent(e)}emitSortChangedEvent(){const e=new CustomEvent("sortChanged",{detail:{selectedSort:this.selectedSort,sortDirection:this.sortDirection}});this.dispatchEvent(e)}static get styles(){return[qe,f`
      ...
      `]}};l([h({type:String})],q.prototype,"displayMode",void 0);l([h({type:String})],q.prototype,"defaultSortDirection",void 0);l([h({type:String})],q.prototype,"defaultSortField",void 0);l([h({type:String})],q.prototype,"sortDirection",void 0);l([h({type:String})],q.prototype,"selectedSort",void 0);l([h({type:String})],q.prototype,"selectedTitleFilter",void 0);l([h({type:String})],q.prototype,"selectedCreatorFilter",void 0);l([h({type:Boolean})],q.prototype,"showRelevance",void 0);l([h({type:Boolean})],q.prototype,"showDateFavorited",void 0);l([h({type:Boolean,reflect:!0})],q.prototype,"enableSortOptionsSlot",void 0);l([h({type:Boolean,reflect:!0})],q.prototype,"suppressDisplayModes",void 0);l([h({type:Object})],q.prototype,"prefixFilterCountMap",void 0);l([h({type:Object})],q.prototype,"resizeObserver",void 0);l([P()],q.prototype,"lastSelectedViewSort",void 0);l([P()],q.prototype,"lastSelectedDateSort",void 0);l([P()],q.prototype,"alphaSelectorVisible",void 0);l([P()],q.prototype,"dropdownBackdropVisible",void 0);l([P()],q.prototype,"desktopSortContainerWidth",void 0);l([P()],q.prototype,"selectorBarContainerWidth",void 0);l([Z("#desktop-sort-container")],q.prototype,"desktopSortContainer",void 0);l([Z("#sort-selector-container")],q.prototype,"sortSelectorContainer",void 0);l([Z("#views-dropdown")],q.prototype,"viewsDropdown",void 0);l([Z("#date-dropdown")],q.prototype,"dateDropdown",void 0);l([Z("#mobile-dropdown")],q.prototype,"mobileDropdown",void 0);q=l([B("sort-filter-bar")],q);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Gr(a,e,t){return a?e():t==null?void 0:t()}const qr=f`var(--white, #fff)`,Bd=f`var(--primaryDisableCTAFill, #767676)`,Rd=f`var(--secondaryCTABorder, #999)`,Fd=f`var(--primaryCTAFill, #194880)`,Ro=f`var(--primaryCTAFillRGB, 25, 72, 128)`,Od=f`var(--primaryCTABorder, #c5d1df)`,Id=f`var(--primaryErrorCTAFill, #d9534f)`,Fo=f`var(--primaryErrorCTAFillRGB, 229, 28, 38)`,Nd=f`var(--primaryErrorCTABorder, #d43f3a)`,Ud=f`var(--secondaryCTAFill, #333)`,Oo=f`var(--secondaryCTAFillRGB, 51, 51, 51)`,Hd=f`var(--primaryCTABorder, #979797)`,Vd=f`#ee8950`,Wd=f`#ec7939`;var jd=f`
  .ia-button {
    min-height: 3rem;
    cursor: pointer;
    color: ${qr};
...
`;let Ot=class extends O{constructor(){super(...arguments),this.label=M("Select items to remove"),this.showSelectAll=!1,this.showUnselectAll=!1,this.removeAllowed=!1}render(){return c`
      <div class="manage-container">
        ...
        <div class="manage-buttons">
          ...
          <div class="selection-buttons">
            ${Gr(this.showSelectAll,()=>c` <button
                class="link-styled select-all-btn"
                @click=${this.selectAllClicked}
              >
                ${M("Select all")}
              </button>`)}
            ${Gr(this.showUnselectAll,()=>c` <button
    ...
    `}};l([h({type:String})],Ot.prototype,"label",void 0);l([h({type:Boolean})],Ot.prototype,"showSelectAll",void 0);l([h({type:Boolean})],Ot.prototype,"showUnselectAll",void 0);l([h({type:Boolean})],Ot.prototype,"removeAllowed",void 0);Ot=l([B("manage-bar")],Ot);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ai=(a,e)=>{var t,i;const o=a._$AN;if(o===void 0)return!1;for(const r of o)(i=(t=r)._$AO)===null||i===void 0||i.call(t,e,!1),ai(r,e);return!0},qi=a=>{let e,t;do{if((e=a._$AM)===void 0)break;t=e._$AN,t.delete(a),a=e}while((t==null?void 0:t.size)===0)},Vs=a=>{for(let e;e=a._$AM;a=e){let t=e._$AN;if(t===void 0)e._$AN=t=new Set;else if(t.has(a))break;t.add(a),Qd(e)}};function Gd(a){this._$AN!==void 0?(qi(this),this._$AM=a,Vs(this)):this._$AM=a}function qd(a,e=!1,t=0){const i=this._$AH,o=this._$AN;if(o!==void 0&&o.size!==0)if(e)if(Array.isArray(i))for(let r=t;r<i.length;r++)ai(i[r],!1),qi(i[r]);else i!=null&&(ai(i,!1),qi(i));else ai(this,a)}const Qd=a=>{var e,t,i,o;a.type==Le.CHILD&&((e=(i=a)._$AP)!==null&&e!==void 0||(i._$AP=qd),(t=(o=a)._$AQ)!==null&&t!==void 0||(o._$AQ=Gd))};class Kd extends gi{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,i){super._$AT(e,t,i),Vs(this),this.isConnected=e._$AU}_$AO(e,t=!0){var i,o;e!==this.isConnected&&(this.isConnected=e,e?(i=this.reconnected)===null||i===void 0||i.call(this):(o=this.disconnected)===null||o===void 0||o.call(this)),t&&(ai(this,e),qi(this))}setValue(e){if(bs(this._$Ct))this._$Ct._$AI(e,this);else{const t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}}const Io=new WeakMap,Yd=mi(class extends Kd{render(a){return b}update(a,[e]){var t;const i=e!==this.U;return i&&this.U!==void 0&&this.ot(void 0),(i||this.rt!==this.lt)&&(this.U=e,this.ht=(t=a.options)===null||t===void 0?void 0:t.host,this.ot(this.lt=a.element)),b}ot(a){var e;if(typeof this.U=="function"){const t=(e=this.ht)!==null&&e!==void 0?e:globalThis;let i=Io.get(t);i===void 0&&(i=new WeakMap,Io.set(t,i)),i.get(this.U)!==void 0&&this.U.call(this.ht,void 0),i.set(this.U,a),a!==void 0&&this.U.call(this.ht,a)}else this.U.value=a}get rt(){var a,e,t;return typeof this.U=="function"?(e=Io.get((a=this.ht)!==null&&a!==void 0?a:globalThis))===null||e===void 0?void 0:e.get(this.U):(t=this.U)===null||t===void 0?void 0:t.value}disconnected(){this.rt===this.lt&&this.ot(void 0)}reconnected(){this.ot(this.lt)}});/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Qr=mi(class extends gi{constructor(a){if(super(a),a.type!==Le.PROPERTY&&a.type!==Le.ATTRIBUTE&&a.type!==Le.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!bs(a))throw Error("`live` bindings can only contain a single expression")}render(a){return a}update(a,[e]){if(e===Ce||e===b)return e;const t=a.element,i=a.name;if(a.type===Le.PROPERTY){if(e===t[i])return Ce}else if(a.type===Le.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(i))return Ce}else if(a.type===Le.ATTRIBUTE&&t.getAttribute(i)===e+"")return Ce;return ys(a),e}}),Xd=Object.freeze({processing:"processing",complete:"complete"});class Zd extends O{static get properties(){return{mode:{type:String}}}constructor(){super(),this.mode=Xd.processing}render(){return c`
      <div class="${this.mode}">
        <svg
          viewBox="0 0 120 120"
    ...
    `,this._tooltipVisible=!0}hideTooltip(){this._tooltipContent=void 0,this._tooltipVisible=!1}validMinSliderX(e){const t=Math.min(this.translateDateToPosition(this.maxSelectedDate),this.histogramRightEdgeX);return e=this.clamp(e,this.histogramLeftEdgeX,t),Number.isNaN(e)||t<this.histogramLeftEdgeX?this.histogramLeftEdgeX:e}validMaxSliderX(e){const t=Math.max(this.histogramLeftEdgeX,this.translateDateToPosition(this.minSelectedDate));return e=this.clamp(e,t,this.histogramRightEdgeX),Number.isNaN(e)||t>this.histogramRightEdgeX?this.histogramRightEdgeX:e}addListeners(){window.addEventListener("pointermove",this.move),window.addEventListener("pointerup",this.drop),window.addEventListener("pointercancel",this.drop)}removeListeners(){window.removeEventListener("pointermove",this.move),window.removeEventListener("pointerup",this.drop),window.removeEventListener("pointercancel",this.drop)}beginEmitUpdateProcess(){this.cancelPendingUpdateEvent(),this._emitUpdatedEventTimer=setTimeout(()=>{if(this.currentDateRangeString===this._previousDateRange)return;this._previousDateRange=this.currentDateRangeString;const e={detail:{minDate:this.minSelectedDate,maxDate:this.maxSelectedDate},bubbles:!0,composed:!0};this.dispatchEvent(new CustomEvent("histogramDateRangeUpdated",e))},this.updateDelay)}cancelPendingUpdateEvent(){this._emitUpdatedEventTimer!==void 0&&(clearTimeout(this._emitUpdatedEventTimer),this._emitUpdatedEventTimer=void 0)}setDragOffset(e){this._currentSlider=e.currentTarget;const t=this._currentSlider.id==="slider-min"?this.minSliderX:this.maxSliderX,i=this.getBoundingClientRect().x;this._dragOffset=e.clientX-i-t}translatePositionToDate(e){const t=Math.ceil((e-this.sliderWidth)*this.dateRangeMS/this._histWidth);return this.formatDate(this._minDateMS+t)}translateDateToPosition(e){const t=this.getMSFromString(e);return this.sliderWidth+(t-this._minDateMS)*this._histWidth/this.dateRangeMS}clamp(e,t,i){return Math.min(Math.max(e,t),i)}handleInputFocus(){this.updateWhileFocused||this.cancelPendingUpdateEvent()}handleMinDateInput(e){const t=e.currentTarget;t.value!==this.minSelectedDate&&(this.minSelectedDate=t.value,this.beginEmitUpdateProcess())}handleMaxDateInput(e){const t=e.currentTarget;t.value!==this.maxSelectedDate&&(this.maxSelectedDate=t.value,this.beginEmitUpdateProcess())}handleKeyUp(e){if(e.key==="Enter"){const t=e.currentTarget;t.blur(),t.id==="date-min"?this.handleMinDateInput(e):t.id==="date-max"&&this.handleMaxDateInput(e)}}get currentDateRangeString(){return`${this.minSelectedDate}:${this.maxSelectedDate}`}getMSFromString(e){const t=typeof e=="string"?e:String(e);if((t.split(/(\d+)/).length-1)/2===1){const o=new Date(0,0);return o.setFullYear(Number(t)),o.getTime()}return No(t,[this.dateFormat,Kr]).valueOf()}handleBarClick(e){const t=e.currentTarget.dataset,i=(this.getMSFromString(t.binStart)+this.getMSFromString(t.binEnd))/2,o=Math.abs(i-this.getMSFromString(this.minSelectedDate)),r=Math.abs(i-this.getMSFromString(this.maxSelectedDate));o<r?this.minSelectedDate=t.binStart:this.maxSelectedDate=t.binEnd,this.beginEmitUpdateProcess()}get minSliderTemplate(){const e=Yr,t=`
            ...
            q0,${e} ${e},${e}
            h${this.sliderWidth-e}
          `;return this.generateSliderSVG(this.minSliderX,"slider-min",t)}get maxSliderTemplate(){const e=Yr,t=`
            M${this.maxSliderX},0
            h${this.sliderWidth-e}
            q${e},0 ${e},${e}
            v${this.height-e*2}
    ...
    `}get selectedRangeTemplate(){return I`
      ...
      />`}get histogramTemplate(){const e=this._histWidth/this._numBins,t=e-1;let i=this.sliderWidth;return this._histData.map(o=>{const r=I`
        <rect
          ...
          fill="${i+t>=this.minSliderX&&i<=this.maxSliderX?nc:cc}"
          data-num-items="${o.value}"
          data-bin-start="${o.binStart}"
          data-bin-end="${o.binEnd}"
        />`;return i+=e,r})}formatDate(e){if(Number.isNaN(e))return"";const t=No(e);return t.year()<1e3?String(t.year()):t.format(this.dateFormat)}get minInputTemplate(){return c`
      <input
        id="date-min"
    ...
    ia-activity-indicator {
      ...
      --activityIndicatorLoadingRingColor: ${dc};
    }
    ...
    #tooltip:after {
      ...
      /* arrow */
      border: 5px solid ${Zr};
      border-color: ${Xr} transparent transparent
        transparent;
    }
    /****** slider ********/
    .draggable:hover {
...
`;let ae=class extends O{constructor(){super(...arguments),this.prompt="Do you find this feature useful?",this.buttonText="Beta",this.isOpen=!1,this.processing=!1,this.popupTopX=0,this.popupTopY=0,this.voteSubmitted=!1,this.voteNeedsChoosing=!1,this.resizingElement=document.body}render(){return c`
      <button
        id="beta-button"
    ...
    `}};l([h({type:String})],ae.prototype,"featureIdentifier",void 0);l([h({type:String})],ae.prototype,"prompt",void 0);l([h({type:String})],ae.prototype,"buttonText",void 0);l([h({type:Object})],ae.prototype,"recaptchaManager",void 0);l([h({type:Object})],ae.prototype,"resizeObserver",void 0);l([h({type:Boolean})],ae.prototype,"disabled",void 0);l([h({type:Object})],ae.prototype,"featureFeedbackService",void 0);l([Z("#beta-button")],ae.prototype,"betaButton",void 0);l([Z("#popup")],ae.prototype,"popup",void 0);l([P()],ae.prototype,"isOpen",void 0);l([P()],ae.prototype,"processing",void 0);l([P()],ae.prototype,"popupTopX",void 0);l([P()],ae.prototype,"popupTopY",void 0);l([P()],ae.prototype,"vote",void 0);l([P()],ae.prototype,"voteSubmitted",void 0);l([P()],ae.prototype,"error",void 0);l([P()],ae.prototype,"voteNeedsChoosing",void 0);l([P()],ae.prototype,"recaptchaWidget",void 0);l([Z("#comments")],ae.prototype,"comments",void 0);ae=l([B("feature-feedback")],ae);class ma{constructor(e){var t,i,o,r,s,n,d;this.title=e==null?void 0:e.title,this.subtitle=e==null?void 0:e.subtitle,this.headline=e==null?void 0:e.headline,this.message=e==null?void 0:e.message,this.headerColor=(t=e==null?void 0:e.headerColor)!==null&&t!==void 0?t:"#55A183",this.bodyColor=(i=e==null?void 0:e.bodyColor)!==null&&i!==void 0?i:"#f5f5f7",this.showProcessingIndicator=(o=e==null?void 0:e.showProcessingIndicator)!==null&&o!==void 0?o:!1,this.processingImageMode=(r=e==null?void 0:e.processingImageMode)!==null&&r!==void 0?r:"complete",this.showCloseButton=(s=e==null?void 0:e.showCloseButton)!==null&&s!==void 0?s:!0,this.showHeaderLogo=(n=e==null?void 0:e.showHeaderLogo)!==null&&n!==void 0?n:!0,this.closeOnBackdropClick=(d=e==null?void 0:e.closeOnBackdropClick)!==null&&d!==void 0?d:!0}}var bc=c`
<svg
  viewBox="0 0 40 40"
  version="1.1"
  xmlns="http://www.w3.org/2000/svg"
...
`;let ga=class extends O{constructor(){super(...arguments),this.config=new ma}render(){return c`
      <div class="modal-wrapper">
        <div class="modal-container">
          <header style="background-color: ${this.config.headerColor}">
            ${this.config.showCloseButton?this.closeButtonTemplate:""}
            ${this.config.showHeaderLogo?c`<div class="logo-icon">${yc}</div>`:b}
    ...
    `}static get styles(){const e=f`var(--modalLogoSize, 6.5rem)`,t=f`var(--processingImageSize, 7.5rem)`,i=f`var(--modalCornerRadius, 1rem)`,o=f`var(--modalBorder, 2px solid black)`,r=f`var(--modalBottomMargin, 2.5rem)`,s=f`var(--modalTopMargin, 5rem)`,n=f`var(--modalHeaderBottomPadding, 0.5em)`,d=f`var(--modalBottomPadding, 2rem)`,p=f`var(--modalScrollOffset, 5px)`,u=f`var(--modalTitleFontSize, 1.8rem)`,m=f`var(--modalSubtitleFontSize, 1.4rem)`,y=f`var(--modalHeadlineFontSize, 1.6rem)`,w=f`var(--modalMessageFontSize, 1.4rem)`,x=f`var(--modalTitleLineHeight, normal)`,C=f`var(--modalSubtitleLineHeight, normal)`,A=f`var(--modalHeadlineLineHeight, normal)`,D=f`var(--modalMessageLineHeight, normal)`;return f`
      .processing-logo {
        margin: auto;
        width: ${t};
        height: ${t};
    ...
    `}};l([h({type:Object})],ga.prototype,"config",void 0);ga=l([B("modal-template")],ga);function wc(a,e,t){var i=t||{},o=i.noTrailing,r=o===void 0?!1:o,s=i.noLeading,n=s===void 0?!1:s,d=i.debounceMode,p=d===void 0?void 0:d,u,m=!1,y=0;function w(){u&&clearTimeout(u)}function x(A){var D=A||{},L=D.upcomingOnly,G=L===void 0?!1:L;w(),m=!G}function C(){for(var A=arguments.length,D=new Array(A),L=0;L<A;L++)D[L]=arguments[L];var G=this,N=Date.now()-y;if(m)return;function oe(){y=Date.now(),e.apply(G,D)}function ne(){u=void 0}!n&&p&&!u&&oe(),w(),p===void 0&&N>a?n?(y=Date.now(),r||(u=setTimeout(p?ne:oe,a))):oe():r!==!0&&(u=setTimeout(p?ne:oe,p===void 0?a-N:a))}return C.cancel=x,C}var vt;(function(a){a.Open="open",a.Closed="closed"})(vt||(vt={}));class _c{constructor(e){this.windowResizeThrottler=wc(100,this.updateModalContainerHeight,{noLeading:!1,noTrailing:!1}).bind(this),this.modalManager=e}handleModeChange(e){switch(e){case vt.Open:this.startResizeListener(),this.stopDocumentScroll();break;case vt.Closed:this.stopResizeListener(),this.resumeDocumentScroll();break}}updateModalContainerHeight(){this.modalManager.style.setProperty("--containerHeight",`${window.innerHeight}px`)}stopDocumentScroll(){document.body.classList.add("modal-manager-open")}resumeDocumentScroll(){document.body.classList.remove("modal-manager-open")}startResizeListener(){window.addEventListener("resize",this.windowResizeThrottler)}stopResizeListener(){window.removeEventListener("resize",this.windowResizeThrottler)}}let It=class extends O{constructor(){super(...arguments),this.mode=vt.Closed,this.hostBridge=new _c(this),this.closeOnBackdropClick=!0}render(){return c`
      <div class="container">
    ...
    `}};l([h({type:String,reflect:!0})],It.prototype,"mode",void 0);l([h({type:Object})],It.prototype,"customModalContent",void 0);l([h({type:Object})],It.prototype,"hostBridge",void 0);l([Z("modal-template")],It.prototype,"modalTemplate",void 0);It=l([B("modal-manager")],It);var xc=c`
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path
...
`;let Nt=class extends O{constructor(){super(...arguments),this.step=2,this.currentPage=1,this.pages=[]}firstUpdated(){this.observePageCount()}updated(e){e.has("size")&&this.observePageCount(),e.has("currentPage")&&(this.observePageCount(),this.emitPageClick())}observePageCount(){this.pages=[];const e=7,t=this.size<=e;if(this.size<=5){this.pages=[...Array(this.size).keys()].map(r=>r+1);return}if(this.size===e){if(this.currentPage===2){this.pages=[1,2,3,4,0,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,4,5,this.size-1,this.size];return}}if(this.currentPage===1){this.pages=[1,2,3,0,this.size];return}if(this.currentPage===this.size){this.pages=[1,0,this.size-2,this.size-1,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,this.size-3,this.size-2,this.size-1,this.size];return}if(t&&this.currentPage>1&&this.currentPage<e){this.pages=[...Array(this.size).keys()].map(r=>r+1);return}let i=this.currentPage-this.step,o=this.currentPage+this.step;i<=0&&(o+=-i+1,i=1),o>=this.size&&(i=Math.max(i-(o-this.size),1),o=this.size),i===2&&(o-=1),o===this.size-1&&(i+=1),this.createFirstNode(i),this.createMiddelNode(i,o),this.createLastNode(o)}createFirstNode(e){var t,i;e>1&&((t=this.pages)===null||t===void 0||t.push(1)),e>2&&((i=this.pages)===null||i===void 0||i.push(0))}createMiddelNode(e,t){var i;for(let o=e;o<=t;o+=1)(i=this.pages)===null||i===void 0||i.push(o)}createLastNode(e){var t,i;e<this.size-1&&((t=this.pages)===null||t===void 0||t.push(0)),e<this.size&&((i=this.pages)===null||i===void 0||i.push(this.size))}get getEllipsisTemplate(){return c`<i class="ellipses">...</i>`}emitPageClick(){this.dispatchEvent(new CustomEvent("pageNumberClicked",{detail:{page:this.currentPage},bubbles:!0,composed:!0}))}onRewind(){this.currentPage-=1,this.currentPage<1&&(this.currentPage=1)}onForward(){this.currentPage+=1,this.currentPage>this.size&&(this.currentPage=this.size)}onChange(e){this.currentPage=e}getPageTemplate(e){return c`
    ...
    `}static get styles(){return[qe,f`
      ...
      `]}};l([h({type:Number})],Nt.prototype,"size",void 0);l([h({type:Number})],Nt.prototype,"step",void 0);l([h({type:Number})],Nt.prototype,"currentPage",void 0);l([P()],Nt.prototype,"pages",void 0);Nt=l([B("more-facets-pagination")],Nt);var Cc=I`
...
`,ba;let pi=ba=class extends O{render(){return c`${this.facetRowTemplate}`}get facetRowTemplate(){var e,t,i,o;const{bucket:r,facetType:s}=this;if(!r||!s)return b;const n=`${s}:${r.key}-show-only`,d=`${s}:${r.key}-negative`,p=s!=="collection"?c`${(e=r.displayText)!==null&&e!==void 0?e:r.key}`:c`<a href="/details/${r.key}">
            ${(i=(t=this.collectionTitles)===null||t===void 0?void 0:t.get(r.key))!==null&&i!==void 0?i:r.key}
          </a> `,u=r.state==="hidden",m=r.state==="selected",y=`${s}: ${(o=r.displayText)!==null&&o!==void 0?o:r.key}`,w=m?`Show all ${s}s`:`Only show ${y}`,x=`Hide ${y}`,C=`Unhide ${y}`,A=u?C:x,D=`${y}, ${r.count} results`;return c`
      <div class="facet-row-container">
        <div class="facet-checkboxes">
          ...
          <label
            ...
            data-testid=${d}
          >
            <span class="eye">${Cc}</span>
            <span class="eye-closed">${kc}</span>
          </label>
        </div>
        <label
          for=${n}
    ...
    `}facetClicked(e,t){const{bucket:i,facetType:o}=this;if(!i||!o)return;const r=e.target,{checked:s}=r;this.bucket=ue(J({},i),{state:ba.getFacetState(s,t)}),this.dispatchFacetClickEvent({facetType:o,bucket:this.bucket,negative:t})}dispatchFacetClickEvent(e){const t=new CustomEvent("facetClick",{detail:e});this.dispatchEvent(t)}static getFacetState(e,t){let i;return e?i=t?"hidden":"selected":i="none",i}static get styles(){const e=f`var(--facet-row-border-top, 1px solid transparent)`,t=f`var(--facet-row-border-bottom, 1px solid transparent)`;return f`
    ...
    `}};l([h({type:String})],pi.prototype,"facetType",void 0);l([h({type:Object})],pi.prototype,"bucket",void 0);l([h({type:Object})],pi.prototype,"collectionTitles",void 0);pi=ba=l([B("facet-row")],pi);let Qi=class extends O{facetClicked(e){this.dispatchFacetClickEvent(e.detail)}dispatchFacetClickEvent(e){const t=new CustomEvent("facetClick",{detail:e,composed:!0});this.dispatchEvent(t)}get facetsTemplate(){const{facetGroup:e}=this;if(!e)return b;const t=e.buckets;return c`
      <div class="facet-rows" data-testid="facets-on-${e.key}">
        ${ws(t,i=>`${e.key}:${i.key}`,i=>c`<facet-row
            .facetType=${e.key}
            .bucket=${i}
            .collectionTitles=${this.collectionTitles}
    ...
    `}};l([h({type:Object})],Qi.prototype,"facetGroup",void 0);l([h({type:Object})],Qi.prototype,"collectionTitles",void 0);Qi=l([B("facets-template")],Qi);let et=class extends O{constructor(){super(...arguments),this.leftValue="",this.rightValue="",this.side="left"}render(){var e,t;return c`
      <div id="container">
    ...
    `}get value(){return this.side==="left"?this.leftValue:this.rightValue}get selectedLabel(){var e,t;return this.side==="left"?(e=this.leftLabel)!==null&&e!==void 0?e:this.leftValue:(t=this.rightLabel)!==null&&t!==void 0?t:this.rightValue}handleClick(){this.side=this.side==="left"?"right":"left",this.emitChangeEvent()}handleRadioChange(){this.side=this.leftRadio.checked?"left":"right",this.emitChangeEvent()}emitChangeEvent(){const e=new CustomEvent("change",{detail:this.value});this.dispatchEvent(e)}static get styles(){const e=f`var(--switchWidth, 30px)`,t=f`var(--switchHeight, 14px)`,i=f`var(--switchMarginLeft, 5px)`,o=f`var(--switchMarginRight, 5px)`,r=f`var(--switchBorderWidth, 3px)`,s=f`var(--switchBgColor, #194880)`,n=f`var(--switchBorderColor, #194880)`,d=f`var(--labelFontSize, 1.3rem)`,p=f`var(--knobColor, white)`,u=f`var(--knobTransitionDuration, 0.25s)`,m=f`var(--knobTransitionFn, ease)`;return[qe,f`
      ...
      `]}};l([h({type:String,attribute:!0})],et.prototype,"leftValue",void 0);l([h({type:String,attribute:!0})],et.prototype,"leftLabel",void 0);l([h({type:String,attribute:!0})],et.prototype,"rightValue",void 0);l([h({type:String,attribute:!0})],et.prototype,"rightLabel",void 0);l([h({type:String,attribute:!0})],et.prototype,"side",void 0);l([Z("#switch-left")],et.prototype,"leftRadio",void 0);et=l([B("toggle-switch")],et);function ya(a,e){if(!!a)for(const[t,i]of Object.entries(a))for(const[o,r]of Object.entries(i))e(t,o,r,a)}function Ws(a,e,t,i=!1){const o=a!=null?a:We(),r=ue(J({},o),{[e]:ue(J({},o[e]),{[t.key]:t})});return i&&t.state==="none"&&delete r[e][t.key],r}function Tc(a){const e=We();return ya(a,(t,i,o)=>{e[t][i]=o}),e}function Ec(a,e){const t=Tc(a);return ya(e,(i,o,r)=>{t[i][o]=r}),ya(t,(i,o,r)=>{r.state==="none"&&delete t[i][o]}),t}const ts=["selected","hidden","none"];function js(a,e=Q.COUNT){return a.sort((t,i)=>{const o=ts.indexOf(t.state),r=ts.indexOf(i.state),s=o-r;let n;return e===Q.ALPHABETICAL?n=t.key.localeCompare(i.key):e===Q.NUMERIC?n=Number(i.key)-Number(t.key):n=i.count-t.count,s||n})}let de=class extends O{constructor(){super(...arguments),this.facetsPerPage=35,this.facetsLoading=!0,this.sortedBy=Q.COUNT,this.unappliedFacetChanges=We(),this.pageNumber=1}willUpdate(e){(e.has("aggregations")||e.has("facetsPerPage")||e.has("sortedBy")||e.has("selectedFacets")||e.has("unappliedFacetChanges"))&&(this.facetGroup=this.mergedFacets)}updated(e){(e.has("facetKey")||e.has("query")||e.has("searchType")||e.has("filterMap"))&&(this.facetsLoading=!0,this.pageNumber=1,this.sortedBy=Ni[this.facetKey],this.updateSpecificFacets())}firstUpdated(){this.setupEscapeListeners()}setupEscapeListeners(){this.modalManager?document.addEventListener("keydown",e=>{var t;e.key==="Escape"&&((t=this.modalManager)===null||t===void 0||t.closeModal())}):document.removeEventListener("keydown",()=>{})}get isSearchResultsPage(){var e;const t=(e=this.pageSpecifierParams)===null||e===void 0?void 0:e.pageType;return t===void 0||t==="search_results"}async updateSpecificFacets(){var e,t,i,o,r,s;if(!this.facetKey)return;const n=(e=this.query)===null||e===void 0?void 0:e.trim();if(!n&&this.isSearchResultsPage)return;const d={simpleParams:[this.facetKey]},p=65535,u=ue(J({},this.pageSpecifierParams),{query:n||"",filters:this.filterMap,aggregations:d,aggregationsSize:p,rows:0}),m=await((t=this.searchService)===null||t===void 0?void 0:t.search(u,this.searchType));this.aggregations=(i=m==null?void 0:m.success)===null||i===void 0?void 0:i.response.aggregations,this.facetsLoading=!1;const y=(r=(o=m==null?void 0:m.success)===null||o===void 0?void 0:o.response)===null||r===void 0?void 0:r.collectionTitles;if(y)for(const[w,x]of Object.entries(y))(s=this.collectionTitles)===null||s===void 0||s.set(w,x)}pageNumberClicked(e){var t,i;const o=(t=e==null?void 0:e.detail)===null||t===void 0?void 0:t.page;o&&(this.pageNumber=Number(o)),(i=this.analyticsHandler)===null||i===void 0||i.sendEvent({category:Be.default,action:ee.moreFacetsPageChange,label:`${this.pageNumber}`})}get mergedFacets(){var e;if(!this.facetKey||!this.selectedFacets)return;const{selectedFacetGroup:t,aggregationFacetGroup:i}=this;if(!i)return;const o=J({},t!=null?t:i),r=(e=t==null?void 0:t.buckets.map(n=>{const d=i.buckets.find(p=>p.key===n.key);return d?ue(J({},n),{count:d.count}):n}))!==null&&e!==void 0?e:[];js(r,this.sortedBy),i.buckets.forEach(n=>{t!=null&&t.buckets.find(p=>p.key===n.key)||r.push(n)});const s=this.unappliedFacetChanges[this.facetKey];for(const[n,d]of r.entries()){const p=s[d.key];p&&(r[n]=J({},p))}return o.buckets=r,o}get selectedFacetGroup(){if(!this.selectedFacets||!this.facetKey)return;const e=this.selectedFacets[this.facetKey];if(!e)return;const t=Ii[this.facetKey],i=Object.entries(e).map(([o,r])=>({displayText:o,key:o,count:r==null?void 0:r.count,state:r==null?void 0:r.state}));return{title:t,key:this.facetKey,buckets:i}}get aggregationFacetGroup(){if(!this.aggregations||!this.facetKey)return;const e=this.aggregations[this.facetKey];if(!e)return;const t=Ii[this.facetKey];let i=e.getSortedBuckets(this.sortedBy);this.facetKey==="collection"&&(i=i==null?void 0:i.filter(r=>{var s;const n=(s=r==null?void 0:r.key)===null||s===void 0?void 0:s.toString();return!Zi[n]&&!(n!=null&&n.startsWith("fav-"))}));const o=i.map(r=>{const s=`${r.key}`;return{displayText:`${s}`,key:`${s}`,count:r.doc_count,state:"none"}});return{title:t,key:this.facetKey,buckets:o}}get facetGroupForCurrentPage(){const{facetGroup:e}=this;if(!e)return;const t=(this.pageNumber-1)*this.facetsPerPage,i=e.buckets.slice(t,t+this.facetsPerPage);return ue(J({},e),{buckets:i})}get moreFacetsTemplate(){return c`
      <facets-template
        .facetGroup=${this.facetGroupForCurrentPage}
        .selectedFacets=${this.selectedFacets}
        .collectionTitles=${this.collectionTitles}
        @facetClick=${e=>{this.facetKey&&(this.unappliedFacetChanges=Ws(this.unappliedFacetChanges,this.facetKey,e.detail.bucket))}}
      ></facets-template>
    `}get loaderTemplate(){return c`<div class="facets-loader">
      <ia-activity-indicator .mode=${"processing"}></ia-activity-indicator>
        ...
        </div> `:b}sortFacetAggregation(e){this.sortedBy=e,this.dispatchEvent(new CustomEvent("sortedFacets",{detail:this.sortedBy}))}get modalHeaderTemplate(){var e,t,i;const r=((e=this.sortedBy)!==null&&e!==void 0?e:Ni[this.facetKey])===Q.COUNT?"left":"right";return c`<span class="sr-only">${M("More facets for:")}</span>
      <span class="title">
      ...
      ${this.facetsLoading?this.loaderTemplate:c`
          ...
          `}
    `}applySearchFacetsClicked(){var e,t;const i=Ec(this.selectedFacets,this.unappliedFacetChanges),o=new CustomEvent("facetsChanged",{detail:i,bubbles:!0,composed:!0});this.dispatchEvent(o),this.unappliedFacetChanges=We(),(e=this.modalManager)===null||e===void 0||e.closeModal(),(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:Be.default,action:`${ee.applyMoreFacetsModal}`,label:`${this.facetKey}`})}cancelClick(){var e,t;this.unappliedFacetChanges=We(),(e=this.modalManager)===null||e===void 0||e.closeModal(),(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:Be.default,action:ee.closeMoreFacetsModal,label:`${this.facetKey}`})}static get styles(){const e=f`var(--primaryButtonBGColor, #194880)`;return[qe,f`
        section#more-facets {
          overflow: auto;
    ...
    `}};is=l([B("facet-tombstone-row")],is);let Ie=class extends O{constructor(){super(...arguments),this.boundEscapeListener=e=>{e.key==="Escape"&&this.closeModal()}}render(){var e,t;return c`
      <div id="container">
    ...
    `}partOfCollectionClicked(e){var t;(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:Be.default,action:ee.partOfCollectionClicked,label:e.target.dataset.id})}showDatePickerModal(){var e,t,i;const{fullYearsHistogramAggregation:o}=this,r=o==null?void 0:o.first_bucket_key,s=o==null?void 0:o.last_bucket_key,n=o==null?void 0:o.buckets,p=c`
      <expanded-date-picker
        ${Yd(m=>{if(m&&m instanceof Ie){const y=m;y.minSelectedDate=this.minSelectedDate,y.maxSelectedDate=this.maxSelectedDate}})}
        .minDate=${r}
        .maxDate=${s}
    ...
    `,u=new ma({bodyColor:"#fff",headerColor:"#194880",showHeaderLogo:!1,closeOnBackdropClick:!0,title:c`Select a date range`});(e=this.modalManager)===null||e===void 0||e.classList.add("expanded-date-picker"),(t=this.modalManager)===null||t===void 0||t.showModal({config:u,customModalContent:p,userClosedModalCallback:this.handleExpandedDatePickerClosed}),(i=this.analyticsHandler)===null||i===void 0||i.sendEvent({category:Be.default,action:ee.histogramExpanded,label:window.location.href})}updated(e){e.has("selectedFacets")&&this.dispatchFacetsChangedEvent()}dispatchFacetsChangedEvent(){const e=new CustomEvent("facetsChanged",{detail:this.selectedFacets});this.dispatchEvent(e)}get expandDatePickerBtnTemplate(){return this.allowExpandingDatePicker&&!this.facetsLoading?c`<button
        ...
        >
          ...
          <histogram-date-range
            ...
            @histogramDateRangeUpdated=${this.histogramDateRangeUpdated}
          ></histogram-date-range>
        `}get mergedFacets(){const e=[];return Kl.forEach(t=>{var i,o;const r=this.selectedFacetGroups.find(u=>u.key===t),s=this.aggregationFacetGroups.find(u=>u.key===t);if(r&&!s){e.push(r);return}if(!s)return;const n=r!=null?r:s;let d=(i=r==null?void 0:r.buckets.map(u=>{const m=s.buckets.find(y=>y.key===u.key);return m?ue(J({},u),{count:m.count}):u}))!==null&&i!==void 0?i:[];s.buckets.forEach(u=>{d.find(y=>y.key===u.key)||d.push(u)});let p=(o=Object.keys((r==null?void 0:r.buckets)||[]))===null||o===void 0?void 0:o.length;if(p<this.allowedFacetCount&&(p=this.allowedFacetCount),t==="lending"&&(d=d.filter(u=>Xl[u.key])),js(d),t==="mediatype"){const u=d.findIndex(m=>m.key==="collection");if(u>=p){const[m]=d.splice(u,1);p>this.allowedFacetCount&&(p+=1),d.splice(p-1,0,m)}}n.buckets=d.slice(0,p),e.push(n)}),e}get selectedFacetGroups(){return this.selectedFacets?Object.entries(this.selectedFacets).map(([t,i])=>{const o=t,r=Ii[o],s=Object.entries(i).map(([n,d])=>{var p;let u=n;return o==="lending"&&(u=(p=fr[n])!==null&&p!==void 0?p:n),{displayText:u,key:n,count:d.count,state:d.state}});return{title:r,key:o,buckets:s}}):[]}get aggregationFacetGroups(){var e;const t=[];return Object.entries((e=this.aggregations)!==null&&e!==void 0?e:[]).forEach(([i,o])=>{if(i==="year_histogram")return;const r=i,s=Ii[r];if(!s)return;let n=o.getSortedBuckets(Ni[r]);r==="collection"&&(n=n==null?void 0:n.filter(u=>{var m;const y=(m=u==null?void 0:u.key)===null||m===void 0?void 0:m.toString();return!Zi[y]&&!(y!=null&&y.startsWith("fav-"))}));const d=n.map(u=>{var m;const y=u.key;let w=`${u.key}`;return r==="lending"&&(w=(m=fr[u.key])!==null&&m!==void 0?m:`${u.key}`),{displayText:w,key:`${y}`,count:u.doc_count,state:"none"}}),p={title:s,key:r,buckets:d};t.push(p)}),t}getFacetGroupTemplate(e){if(!this.facetsLoading&&e.buckets.length===0)return b;const{key:t}=e,i=this.openFacets[t],o=c`
      <span class="collapser ${i?"open":""}"> ${Xo} </span>
    `,r=()=>{const n=J({},this.openFacets);n[t]=!i,this.openFacets=n},s=`facet-group-header-label-${e.key}`;return c`
      <section
    ...
    `}searchMoreFacetsLink(e){if(!this.moreLinksVisible||e.key==="lending"||Object.keys(e.buckets).length<this.allowedFacetCount)return b;const t=Ni[e.key];return c`<button
      class="more-link"
      @click=${()=>{var i;this.showMoreFacetsModal(e,t),(i=this.analyticsHandler)===null||i===void 0||i.sendEvent({category:Be.default,action:ee.showMoreFacetsModal,label:e.key}),this.dispatchEvent(new CustomEvent("showMoreFacets",{detail:e.key}))}}
    ...
    `,s=new ma({bodyColor:"#fff",headerColor:"#194880",showHeaderLogo:!1,closeOnBackdropClick:!0,title:c`Select filters`});(i=this.modalManager)===null||i===void 0||i.classList.add("more-search-facets"),(o=this.modalManager)===null||o===void 0||o.showModal({config:s,customModalContent:r,userClosedModalCallback:()=>{var n;(n=this.modalManager)===null||n===void 0||n.classList.remove("more-search-facets")}})}getFacetTemplate(e){return c`
      <facets-template
        .collectionPagePath=${this.collectionPagePath}
        .facetGroup=${e}
        .selectedFacets=${this.selectedFacets}
        .collectionTitles=${this.collectionTitles}
        @facetClick=${t=>{this.selectedFacets=Ws(this.selectedFacets,e.key,t.detail.bucket,!0);const i=new CustomEvent("facetsChanged",{detail:this.selectedFacets,bubbles:!0,composed:!0});this.dispatchEvent(i)}}
      ></facets-template>
    `}static get styles(){return[qe,f`
        a:link {
          text-decoration: none;
    ...
    `}};os=l([B("circular-activity-indicator")],os);let T=class extends O{constructor(){super(),this.baseImageUrl="https://archive.org",this.searchType=le.METADATA,this.selectedSort=$.default,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.sortDirection=null,this.defaultSortField=$.relevance,this.defaultSortDirection=null,this.pageSize=50,this.showHistogramDatePicker=!1,this.suppressPlaceholders=!1,this.suppressResultCount=!1,this.suppressResultTiles=!1,this.suppressURLQuery=!1,this.suppressSortBar=!1,this.suppressDisplayModes=!1,this.facetLoadStrategy="eager",this.clearResultsOnEmptyQuery=!1,this.collectionPagePath="/details/",this.searchContext=Be.default,this.pageContext="search",this.restorationStateHandler=new on({context:this.pageContext}),this.mobileBreakpoint=600,this.loggedIn=!1,this.modalManager=void 0,this.isManageView=!1,this.manageViewLabel="Select items to remove",this.enableSortOptionsSlot=!1,this.showSmartResults=!1,this.dataSource=new rn(this,this.pageSize),this.initialPageNumber=1,this.pagesToRender=this.initialPageNumber,this.searchResultsLoading=!1,this.facetsLoading=!1,this.mobileView=!1,this.collapsibleFacetsVisible=!1,this.placeholderType=null,this.layoutSizeAnalyticsSent=!1,this.isScrollingToCell=!1,this.isResizeToMobile=!1,this.dataSourceInstallInProgress=!1,this.placeholderCellTemplate=c`<collection-browser-loading-tile></collection-browser-loading-tile>`,this.updateLeftColumnHeight=()=>{var e,t,i,o,r;if(this.mobileView)(t=(e=this.leftColumn)===null||e===void 0?void 0:e.style)===null||t===void 0||t.removeProperty("height");else{const s=(i=this.leftColumn)===null||i===void 0?void 0:i.getBoundingClientRect().top;(r=(o=this.leftColumn)===null||o===void 0?void 0:o.style)===null||r===void 0||r.setProperty("height",`${window.innerHeight-(s!=null?s:0)-3}px`)}},this.updateFacetFadeOut=e=>{var t,i;const o=(t=this.shadowRoot)===null||t===void 0?void 0:t.getElementById("facets-bottom-fade");o==null||o.classList.toggle("hidden",(i=e==null?void 0:e[0])===null||i===void 0?void 0:i.isIntersecting)},this.initialQueryChangeHappened=!1,this.historyPopOccurred=!1,this.addController(this.dataSource)}tileModelAtCellIndex(e){const t=this.dataSource.getTileModelAt(e);if(!t&&!this.isScrollingToCell&&this.dataSource.queryInitialized){const i=Math.floor(e/this.pageSize)+1;this.dataSource.fetchPage(i)}return t}get estimatedTileCount(){return this.pagesToRender*this.pageSize}async getSessionId(){try{const e=sessionStorage==null?void 0:sessionStorage.getItem("cb-session");if(e)return e;if(this.sessionIdGenPromise)return this.sessionIdGenPromise;this.sessionIdGenPromise=ks(Math.random().toString());const t=await this.sessionIdGenPromise;return sessionStorage==null||sessionStorage.setItem("cb-session",t),t}catch{return""}}goToPage(e){return this.initialPageNumber=e,this.pagesToRender=e,this.scrollToPage(e)}setSearchResultsLoading(e){this.searchResultsLoading=e}setFacetsLoading(e){this.facetsLoading=e}setTotalResultCount(e){this.totalResults=e}clearFilters({facets:e=!0,dateRange:t=!0,letterFilters:i=!0,sort:o=!1}={}){e&&this.hasCheckedFacets&&(this.selectedFacets=We()),t&&(this.minSelectedDate=void 0,this.maxSelectedDate=void 0),i&&(this.selectedTitleFilter=null,this.selectedCreatorFilter=null),o&&(this.sortDirection=null,this.selectedSort=$.default)}get hasCheckedFacets(){if(!this.selectedFacets)return!1;for(const e of Object.values(this.selectedFacets))for(const t of Object.values(e))if(t.state!=="none")return!0;return!1}get hasActiveFilters(){return!!(this.hasCheckedFacets||this.minSelectedDate||this.maxSelectedDate||this.selectedTitleFilter||this.selectedCreatorFilter)}willUpdate(){this.setPlaceholderType()}render(){return c`
      <div
    ...
    `}get facetsTemplate(){if(Yo.includes(this.profileElement))return b;if(this.facetLoadStrategy==="off")return c`
    ...
    `}scrollThresholdReached(){!this.dataSource.endOfDataReached&&this.dataSource.queryInitialized&&(this.pagesToRender+=1,this.dataSource.fetchPage(this.pagesToRender))}static get styles(){return[qe,f`
        :host {
          display: block;
