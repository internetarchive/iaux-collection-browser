...
`;let Yt=class extends B{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1,this.isCompactTile=!1}render(){return c`<div class="icon-overlay ${this.getClass}">
    ...
    `}};s([h({type:String})],Ke.prototype,"baseImageUrl",void 0);s([h({type:Boolean})],Ke.prototype,"isCompactTile",void 0);s([h({type:Boolean})],Ke.prototype,"isListTile",void 0);s([h({type:Boolean})],Ke.prototype,"loggedIn",void 0);s([h({type:Object})],Ke.prototype,"model",void 0);s([h({type:String})],Ke.prototype,"viewSize",void 0);Ke=s([P("image-block")],Ke);let po=class extends le{constructor(){super(...arguments),this.showInfoButton=!1}render(){return c`
      <div class="container">
...
`;function Vs(a,e){let t=1;return a>=1e9?t=1e9:a>=1e6?t=1e6:a>=1e3&&e==="short"&&(t=1e3),t}function Ws(a=0,e){const t=a/e,i=t<10;let o=0;return i?o=Math.round((t+Number.EPSILON)*10)/10:o=Math.round(t),o}function js(a,e,t,i){switch(e){case 1e9:return D(t==="short"?nt`${a}B`:nt`${a} billion`);case 1e6:return D(t==="short"?nt`${a}M`:nt`${a} million`);case 1e3:return D(t==="short"?nt`${a}K`:nt`${a} thousand`);default:return new Intl.NumberFormat(i).format(a)}}function Wt(a,e="long",t="short",i="en-US"){const o=a!=null?a:-1;if(o<0)return"";const r=Vs(o,e),l=Ws(o,r);return js(l,r,t,i)}let Ye=class extends B{render(){var e;const t=Wt(this.favCount,"short","short"),i=Wt(this.commentCount,"short","short"),o=this.mediatype==="account"?`${this.itemCount} uploads`:`${this.viewCount} ${(e=this.viewLabel)!==null&&e!==void 0?e:"all-time views"}`;return c`
    ...
    `}get isSortedByDate(){var e;return["date","reviewdate","addeddate","publicdate"].includes((e=this.sortParam)===null||e===void 0?void 0:e.field)}get hasSnippets(){var e,t;return!!(!((t=(e=this.model)===null||e===void 0?void 0:e.snippets)===null||t===void 0)&&t.length)}infoButtonPressed(e){e.preventDefault();const t=new CustomEvent("infoButtonPressed",{detail:{x:e.clientX,y:e.clientY}});this.dispatchEvent(t)}static get styles(){const e=m`var(--tileBorderColor, #dddddd)`;return[Di,m`
      ...
      `]}};s([h({type:Boolean})],uo.prototype,"showInfoButton",void 0);uo=s([P("item-tile")],uo);let vo=class extends le{constructor(){super(...arguments),this.showInfoButton=!1}render(){return c`
      <div class="container">
        ${this.infoButtonTemplate}
        <div class="tile-details">
          <div class="item-info">
    ...
    >
      ...
      `]}};s([h({type:Boolean})],vo.prototype,"showInfoButton",void 0);vo=s([P("account-tile")],vo);let mo=class extends le{constructor(){super(...arguments),this.showInfoButton=!1}render(){return c`
      <div class="container">
        <div class="tile-details">
          <div class="item-info">
            ${this.getImageBlockTemplate} ${this.getTitleTemplate}
...
`+ue),De&&(ue=Ge(ue,ye," "),ue=Ge(ue,Se," ")),K&&li?K.createHTML(ue):ue},e.setConfig=function(T){Oi(T),yt=!0},e.clearConfig=function(){St=null,yt=!1},e.isValidAttribute=function(T,u,x){St||Oi({});var C=at(T),H=at(u);return Xo(C,H,x)},e.addHook=function(T,u){typeof u=="function"&&(R[T]=R[T]||[],Ht(R[T],u))},e.removeHook=function(T){if(R[T])return xa(R[T])},e.removeHooks=function(T){R[T]&&(R[T]=[])},e.removeAllHooks=function(){R={}},e}var yi=ur(),_;(function(a){a.default="default",a.unrecognized="unrecognized",a.relevance="relevance",a.alltimeview="alltimeview",a.weeklyview="weeklyview",a.title="title",a.date="date",a.datearchived="datearchived",a.datereviewed="datereviewed",a.dateadded="dateadded",a.datefavorited="datefavorited",a.creator="creator"})(_||(_={}));const fe={[_.default]:{field:_.default,defaultSortDirection:null,canSetDirection:!1,shownInSortBar:!1,shownInURL:!1,handledBySearchService:!1,displayName:"",urlNames:["",null,void 0]},[_.unrecognized]:{field:_.unrecognized,defaultSortDirection:null,canSetDirection:!0,shownInSortBar:!1,shownInURL:!1,handledBySearchService:!0,displayName:"",urlNames:[]},[_.relevance]:{field:_.relevance,defaultSortDirection:null,canSetDirection:!1,shownInSortBar:!0,shownInURL:!1,handledBySearchService:!1,displayName:"Relevance",urlNames:["_score"]},[_.alltimeview]:{field:_.alltimeview,defaultSortDirection:"desc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"downloads",displayName:"All-time views",urlNames:["downloads"]},[_.weeklyview]:{field:_.weeklyview,defaultSortDirection:"desc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"week",displayName:"Weekly views",urlNames:["week"]},[_.title]:{field:_.title,defaultSortDirection:"asc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"titleSorter",displayName:"Title",urlNames:["title","titleSorter"]},[_.date]:{field:_.date,defaultSortDirection:"desc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"date",displayName:"Date published",urlNames:["date"]},[_.datearchived]:{field:_.datearchived,defaultSortDirection:"desc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"publicdate",displayName:"Date archived",urlNames:["publicdate"]},[_.datereviewed]:{field:_.datereviewed,defaultSortDirection:"desc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"reviewdate",displayName:"Date reviewed",urlNames:["reviewdate"]},[_.dateadded]:{field:_.dateadded,defaultSortDirection:"desc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"addeddate",displayName:"Date added",urlNames:["addeddate"]},[_.datefavorited]:{field:_.datefavorited,defaultSortDirection:"desc",canSetDirection:!1,shownInSortBar:!0,shownInURL:!1,handledBySearchService:!1,searchServiceKey:"favoritedate",displayName:"Date favorited",urlNames:["favoritedate"]},[_.creator]:{field:_.creator,defaultSortDirection:"asc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"creatorSorter",displayName:"Creator",urlNames:["creator","creatorSorter"]}};function vr(a){var e;return(e=Object.values(fe).find(t=>t.urlNames.some(i=>a===i)))!==null&&e!==void 0?e:fe[_.unrecognized]}const wl={title:"firstTitle",creator:"firstCreator"},ei=()=>({subject:{},lending:{},mediatype:{},language:{},creator:{},collection:{},year:{}}),xl=["mediatype","lending","year","subject","collection","creator","language"],ki={subject:"Subject",lending:"Availability",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"},wo={subject:Z.COUNT,lending:Z.COUNT,mediatype:Z.COUNT,language:Z.COUNT,creator:Z.COUNT,collection:Z.COUNT,year:Z.NUMERIC},_l={subject:Z.ALPHABETICAL,lending:Z.ALPHABETICAL,mediatype:Z.ALPHABETICAL,language:Z.ALPHABETICAL,creator:Z.ALPHABETICAL,collection:Z.ALPHABETICAL,year:Z.NUMERIC},Cl={is_lendable:!0,is_borrowable:!1,available_to_borrow:!0,is_browsable:!1,available_to_browse:!1,is_readable:!0,available_to_waitlist:!1},ka={is_lendable:"Lending Library",available_to_borrow:"Borrow 14 Days",is_readable:"Always Available"},Fo={deemphasize:!0,community:!0,stream_only:!0,samples_only:!0,test_collection:!0,printdisabled:!0,"openlibrary-ol":!0,nationalemergencylibrary:!0,china:!0,americana:!0,toronto:!0};let Ti=class extends le{constructor(){super(...arguments),this.collectionLinks=[]}render(){return c`
    ...
    `}};s([h({type:Object})],Xe.prototype,"model",void 0);s([h({type:String})],Xe.prototype,"baseNavigationUrl",void 0);s([h({type:String})],Xe.prototype,"baseImageUrl",void 0);s([h({type:Boolean})],Xe.prototype,"loggedIn",void 0);s([h({type:Object})],Xe.prototype,"sortParam",void 0);s([h({type:Object})],Xe.prototype,"collectionNameCache",void 0);Xe=s([P("tile-hover-pane")],Xe);let Ta=class extends le{render(){var e,t,i,o,r,l;return c`
      <div id="list-line" class="${this.classSize}">
        <image-block
          .model=${this.model}
          .baseImageUrl=${this.baseImageUrl}
    ...
    `}};Ta=s([P("tile-list-compact")],Ta);let Ma=class extends le{render(){return c`
  ...
  `;s([h({type:String})],Ve.prototype,"selectedLetter",void 0);s([h({type:Object})],Ve.prototype,"letterCounts",void 0);s([h({type:String})],Ve.prototype,"ariaLandmarkLabel",void 0);s([M()],Ve.prototype,"tooltipShown",void 0);s([M()],Ve.prototype,"hoveredLetter",void 0);s([Q("alpha-bar-tooltip")],Ve.prototype,"tooltip",void 0);Ve=s([P("alpha-bar")],Ve);const $l=c`
...
`;let $o=class extends B{constructor(){super(...arguments),this.config=new So}render(){return c`
    ...
    `}};s([h({type:Object})],$o.prototype,"config",void 0);$o=s([P("modal-template")],$o);function sn(a,e,t){var i=t||{},o=i.noTrailing,r=o===void 0?!1:o,l=i.noLeading,n=l===void 0?!1:l,d=i.debounceMode,p=d===void 0?void 0:d,v,f=!1,g=0;function w(){v&&clearTimeout(v)}function S(A){var L=A||{},U=L.upcomingOnly,re=U===void 0?!1:U;w(),f=!re}function E(){for(var A=arguments.length,L=new Array(A),U=0;U<A;U++)L[U]=arguments[U];var re=this,K=Date.now()-g;if(f)return;function ne(){g=Date.now(),e.apply(re,L)}function ee(){v=void 0}!n&&p&&!v&&ne(),w(),p===void 0&&K>a?n?(g=Date.now(),r||(v=setTimeout(p?ee:ne,a))):ne():r!==!0&&(v=setTimeout(p?ee:ne,p===void 0?a-K:a))}return E.cancel=S,E}var ct;(function(a){a.Open="open",a.Closed="closed"})(ct||(ct={}));class ln{constructor(e){this.windowResizeThrottler=sn(100,this.updateModalContainerHeight,{noLeading:!1,noTrailing:!1}).bind(this),this.modalManager=e}handleModeChange(e){switch(e){case ct.Open:this.startResizeListener(),this.stopDocumentScroll();break;case ct.Closed:this.stopResizeListener(),this.resumeDocumentScroll();break}}updateModalContainerHeight(){this.modalManager.style.setProperty("--containerHeight",`${window.innerHeight}px`)}stopDocumentScroll(){document.body.classList.add("modal-manager-open")}resumeDocumentScroll(){document.body.classList.remove("modal-manager-open")}startResizeListener(){window.addEventListener("resize",this.windowResizeThrottler)}stopResizeListener(){window.removeEventListener("resize",this.windowResizeThrottler)}}let Dt=class extends B{constructor(){super(...arguments),this.mode=ct.Closed,this.hostBridge=new ln(this),this.closeOnBackdropClick=!0}render(){return c`
      <div class="container">
...
`;let Lt=class extends B{constructor(){super(...arguments),this.step=2,this.currentPage=1,this.pages=[]}firstUpdated(){this.observePageCount()}updated(e){e.has("size")&&this.observePageCount(),e.has("currentPage")&&(this.observePageCount(),this.emitPageClick())}observePageCount(){this.pages=[];const e=7,t=this.size<=e;if(this.size<=5){this.pages=[...Array(this.size).keys()].map(r=>r+1);return}if(this.size===e){if(this.currentPage===2){this.pages=[1,2,3,4,0,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,4,5,this.size-1,this.size];return}}if(this.currentPage===1){this.pages=[1,2,3,0,this.size];return}if(this.currentPage===this.size){this.pages=[1,0,this.size-2,this.size-1,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,this.size-3,this.size-2,this.size-1,this.size];return}if(t&&this.currentPage>1&&this.currentPage<e){this.pages=[...Array(this.size).keys()].map(r=>r+1);return}let i=this.currentPage-this.step,o=this.currentPage+this.step;i<=0&&(o+=-i+1,i=1),o>=this.size&&(i=Math.max(i-(o-this.size),1),o=this.size),i===2&&(o-=1),o===this.size-1&&(i+=1),this.createFirstNode(i),this.createMiddelNode(i,o),this.createLastNode(o)}createFirstNode(e){var t,i;e>1&&((t=this.pages)===null||t===void 0||t.push(1)),e>2&&((i=this.pages)===null||i===void 0||i.push(0))}createMiddelNode(e,t){var i;for(let o=e;o<=t;o+=1)(i=this.pages)===null||i===void 0||i.push(o)}createLastNode(e){var t,i;e<this.size-1&&((t=this.pages)===null||t===void 0||t.push(0)),e<this.size&&((i=this.pages)===null||i===void 0||i.push(this.size))}get getEllipsisTemplate(){return c`<i class="ellipses">...</i>`}emitPageClick(){this.dispatchEvent(new CustomEvent("pageNumberClicked",{detail:{page:this.currentPage},bubbles:!0,composed:!0}))}onRewind(){this.currentPage-=1,this.currentPage<1&&(this.currentPage=1)}onForward(){this.currentPage+=1,this.currentPage>this.size&&(this.currentPage=this.size)}onChange(e){this.currentPage=e}getPageTemplate(e){return c`
    ...
    `}static get styles(){return[Je,m`
      ...
      `]}};s([h({type:Number})],Lt.prototype,"size",void 0);s([h({type:Number})],Lt.prototype,"step",void 0);s([h({type:Number})],Lt.prototype,"currentPage",void 0);s([M()],Lt.prototype,"pages",void 0);Lt=s([P("more-facets-pagination")],Lt);var hn=I`
...
`,Le;let xe=Le=class extends B{constructor(){super(...arguments),this.placeholderType=null,this.detailMessage=""}render(){return this.placeholderType?c`${this.placeholderTemplate}`:y}get placeholderTemplate(){return c`
    ...
    `}get facetTopViewTemplate(){return c`
