...
`;let kt=class extends O{facetClicked(e,t){const i=e.target,{checked:a,name:o,value:s}=i;a?this.facetChecked(o,s,t):this.facetUnchecked(o,s)}facetChecked(e,t,i){const{selectedFacets:a}=this;let o;a?o=ce({},a):o=Ci,o[e][t]=i?"hidden":"selected",this.selectedFacets=o,this.dispatchSelectedFacetsChanged()}facetUnchecked(e,t){const{selectedFacets:i}=this;let a;i?a=ce({},i):a=Ci,delete a[e][t],this.selectedFacets=a,this.dispatchSelectedFacetsChanged()}dispatchSelectedFacetsChanged(){const e=new CustomEvent("selectedFacetsChanged",{detail:this.selectedFacets,bubbles:!0,composed:!0});this.dispatchEvent(e)}getFacetsTemplate(e){var t;let i=(t=e==null?void 0:e.buckets)===null||t===void 0?void 0:t.filter(a=>a.key.startsWith("fav-")===!1);return i=[...i.filter(a=>a.state==="selected").sort((a,o)=>a.count<o.count?1:-1),...i.filter(a=>a.state==="hidden").sort((a,o)=>a.count<o.count?1:-1),...i.filter(a=>a.state==="none")],u`
    ...
    `}searchMoreFacetsLink(e){return Object.keys(e.buckets).length<this.allowedFacetCount?$:u`<button
      class="more-link"
