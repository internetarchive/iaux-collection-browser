...
`;function Ps(r,e){let t=1;return r>=1e9?t=1e9:r>=1e6?t=1e6:r>=1e3&&e==="short"&&(t=1e3),t}function Rs(r=0,e){const t=r/e,i=t<10;let a=0;return i?a=Math.round((t+Number.EPSILON)*10)/10:a=Math.round(t),a}function Ns(r,e,t,i){switch(e){case 1e9:return Ye(t==="short"?ht`${r}B`:ht`${r} billion`);case 1e6:return Ye(t==="short"?ht`${r}M`:ht`${r} million`);case 1e3:return Ye(t==="short"?ht`${r}K`:ht`${r} thousand`);default:return new Intl.NumberFormat(i).format(r)}}function Wt(r,e="long",t="short",i="en-US"){const a=r!=null?r:-1;if(a<0)return"";const o=Ps(a,e),s=Rs(a,o);return Ns(s,o,t,i)}let et=class extends O{render(){return m`
    ...
    ></text-snippet-block>`:$}get hasSnippets(){var e,t;return!!(!((t=(e=this.model)===null||e===void 0?void 0:e.snippets)===null||t===void 0)&&t.length)}static get styles(){return g`
      .container {
...
`+te),ot&&(te=Me(te,Pe," "),te=Me(te,Re," ")),R&&ii?R.createHTML(te):te},e.setConfig=function(k){Hi(k),Oi=!0},e.clearConfig=function(){ct=null,Oi=!1},e.isValidAttribute=function(k,h,y){ct||Hi({});var S=Ue(k),N=Ue(h);return ja(S,N,y)},e.addHook=function(k,h){typeof h=="function"&&(oe[k]=oe[k]||[],Ut(oe[k],h))},e.removeHook=function(k){if(oe[k])return vr(oe[k])},e.removeHooks=function(k){oe[k]&&(oe[k]=[])},e.removeAllHooks=function(){oe={}},e}var jt=eo();function to(r){switch(r){case"date":return"Published";case"reviewdate":return"Reviewed";case"addeddate":return"Added";default:return"Archived"}}function io(r){return r?`Archivist since ${r.getFullYear()}`:""}let ue=class extends O{constructor(){super(...arguments),this.sortParam=null,this.collectionLinks=[],this.loggedIn=!1}updated(e){e.has("model")&&this.fetchCollectionNames()}async fetchCollectionNames(){var e,t;if(!(!((e=this.model)===null||e===void 0)&&e.collections)||this.model.collections.length===0||!this.collectionNameCache)return;this.collectionLinks=[];const i=[],a=[];for(const o of this.model.collections)a.push((t=this.collectionNameCache)===null||t===void 0?void 0:t.collectionNameFor(o).then(s=>{i.push(this.detailsLink(o,s!=null?s:o))}));await Promise.all(a),this.collectionLinks=i}render(){return m`
    ...
    `}handleResize(e){this.currentWidth=e.contentRect.width,this.currentHeight=e.contentRect.height}disconnectedCallback(){this.stopResizeObservation(this.resizeObserver)}stopResizeObservation(e){e==null||e.removeObserver({handler:this,target:this.container})}startResizeObservation(){var e;this.stopResizeObservation(this.resizeObserver),(e=this.resizeObserver)===null||e===void 0||e.addObserver({handler:this,target:this.container})}updated(e){if(e.has("resizeObserver")){const t=e.get("resizeObserver");this.stopResizeObservation(t),this.startResizeObservation()}}get tile(){const{model:e,baseNavigationUrl:t,currentWidth:i,currentHeight:a,sortParam:o,mobileBreakpoint:s}=this;if(!e)return $;switch(this.tileDisplayMode){case"grid":switch(e.mediatype){case"collection":return m`<collection-tile
        ...
        >
          ...
          .loggedIn=${this.loggedIn}
        >
        </tile-list>`;default:return $}}static get styles(){return g`
      :host {
        display: block;
        height: 100%;
      }
...
`;let K=class extends O{constructor(){super(...arguments),this.sortDirection=null,this.selectedSort=L.relevance,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.showRelevance=!0,this.alphaSelectorVisible=null,this.dateSortSelectorVisible=!1,this.viewSortSelectorVisible=!1,this.desktopSelectorBarWidth=0,this.selectorBarContainerWidth=0,this.hoveringOverDateSortOptions=!1,this.boundSortBarSelectorEscapeListener=e=>{e.key==="Escape"&&(this.viewSortSelectorVisible=!1,this.dateSortSelectorVisible=!1)}}render(){return m`
    ...
    `}get desktopSortSelectorTemplate(){return m`
      ...
      >
        ...
        <li>
          ${this.showRelevance?this.getSortDisplayOption(L.relevance):$}
        </li>
        <li>
      ...
      <div class="modal-wrapper">
        <div class="modal-container">
          <header style="background-color: ${this.config.headerColor}">
            ...
            ${this.config.showHeaderLogo?m`<div class="logo-icon">${vl}</div>`:$}
...
`;let _t=class extends O{constructor(){super(...arguments),this.step=2,this.pages=[],this.currentPage=1}firstUpdated(){this.observePageCount()}observePageCount(){this.pages=[];let e=this.currentPage-this.step,t=this.currentPage+this.step;e<=0&&(t+=-e+1,e=1),t>=this.size&&(e=Math.max(e-(t-this.size),1),t=this.size),e===2&&(t-=1),t===this.size-1&&(e+=1),this.createFirstNode(e),this.createMiddelNode(e,t),this.createLastNode(t)}createFirstNode(e){var t,i;e>1&&((t=this.pages)===null||t===void 0||t.push(1)),e>2&&((i=this.pages)===null||i===void 0||i.push(0))}createMiddelNode(e,t){var i;for(let a=e;a<=t;a+=1)(i=this.pages)===null||i===void 0||i.push(a)}createLastNode(e){var t,i;e<this.size-1&&((t=this.pages)===null||t===void 0||t.push(0)),e<this.size&&((i=this.pages)===null||i===void 0||i.push(this.size))}get getEllipsisTemplate(){return m`<i>...</i>`}emitPageClick(){this.dispatchEvent(new CustomEvent("pageNumberClicked",{detail:{page:this.currentPage},bubbles:!0,composed:!0}))}onRewind(){this.currentPage-=1,this.currentPage<1&&(this.currentPage=1),this.observePageCount(),this.emitPageClick()}onForward(){this.currentPage+=1,this.currentPage>this.size&&(this.currentPage=this.size),this.observePageCount(),this.emitPageClick()}onChange(e){this.currentPage=e,this.observePageCount(),this.emitPageClick()}getPageTemplate(e){return m`
      <button
...
`;let kt=class extends O{facetClicked(e,t){const i=e.target,{checked:a,name:o,value:s}=i;a?this.facetChecked(o,s,t):this.facetUnchecked(o,s)}facetChecked(e,t,i){const{selectedFacets:a}=this;let o;a?o=ce({},a):o=Ci,o[e][t]=i?"hidden":"selected",this.selectedFacets=o,this.dispatchSelectedFacetsChanged()}facetUnchecked(e,t){const{selectedFacets:i}=this;let a;i?a=ce({},i):a=Ci,delete a[e][t],this.selectedFacets=a,this.dispatchSelectedFacetsChanged()}dispatchSelectedFacetsChanged(){const e=new CustomEvent("selectedFacetsChanged",{detail:this.selectedFacets,bubbles:!0,composed:!0});this.dispatchEvent(e)}getFacetsTemplate(e){let t=e==null?void 0:e.buckets;return t=[...t.filter(i=>i.state==="selected").sort((i,a)=>i.count<a.count?1:-1),...t.filter(i=>i.state==="hidden").sort((i,a)=>i.count<a.count?1:-1),...t.filter(i=>i.state==="none")],m`
      <div class="facets-on-${this.renderOn}">
        ${Zr(t,i=>`${e.key}:${i.key}`,i=>{var a,o;const s=`${e.key}:${i.key}-show-only`,l=`${e.key}:${i.key}-negative`,d=e.key!=="collection"?m`${(a=i.displayText)!==null&&a!==void 0?a:i.key}`:m`
                    <async-collection-name
                      .collectionNameCache=${this.collectionNameCache}
                      .identifier=${i.key}
                      placeholder="-"
                    ></async-collection-name>
                  `,c=i.state==="hidden",u=i.state==="selected",f=`${e.key}: ${(o=i.displayText)!==null&&o!==void 0?o:i.key}`,v=u?`Show all ${e.key}s`:`Only show ${f}`,b=`Hide ${f}`,w=`Unhide ${f}`,_=c?w:b;return m`
              <div class="facet-row">
    ...
    `}get loaderTemplate(){return m`<div class="facets-loader">
      <ia-activity-indicator .mode="processing"></ia-activity-indicator>
        ...
        ></more-facets-pagination>`:$}get footerTemplate(){return this.paginationSize>0?m`${this.facetsPaginationTemplate}
        <div class="footer">
          <button
    ...
    `}searchMoreFacetsLink(e){return Object.keys(e.buckets).length<this.allowedFacetCount?$:m`<button
      class="more-link"
...
`;let Ti=class extends O{constructor(){super(...arguments),this.placeholderType=null}render(){return this.placeholderType?m`${this.placeholderTemplate}`:$}get placeholderTemplate(){return m`
      <div
