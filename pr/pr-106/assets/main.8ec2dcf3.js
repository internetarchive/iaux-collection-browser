...
`;let kt=class extends O{constructor(){super(...arguments),this.renderOn="page"}facetClicked(e,t){const i=e.target,{checked:a,name:o,value:s}=i;a?this.facetChecked(o,s,t):this.facetUnchecked(o,s)}facetChecked(e,t,i){const{selectedFacets:a}=this;let o;a?o=ce({},a):o=Ci,o[e][t]=i?"hidden":"selected",this.selectedFacets=o,this.dispatchSelectedFacetsChanged()}facetUnchecked(e,t){const{selectedFacets:i}=this;let a;i?a=ce({},i):a=Ci,delete a[e][t],this.selectedFacets=a,this.dispatchSelectedFacetsChanged()}dispatchSelectedFacetsChanged(){const e=new CustomEvent("selectedFacetsChanged",{detail:this.selectedFacets,bubbles:!0,composed:!0});this.dispatchEvent(e)}getFacetsTemplate(e){var t;const i=(t=e==null?void 0:e.buckets)===null||t===void 0?void 0:t.filter(a=>a.key.startsWith("fav-")===!1);return u`
      <ul class="facet-list">
