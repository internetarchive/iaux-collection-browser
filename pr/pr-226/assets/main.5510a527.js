...
`,ws={account:{color:"#000000",icon:ds,text:"Account"},audio:{color:"#00adef",icon:cs,text:"Audio"},collection:{color:"#4666ff",icon:Ka,text:"Collection"},data:{color:"#333333",icon:hs,text:"Data"},etree:{color:"#00adef",icon:ps,text:"E-tree"},film:{color:"#bf1b2c",icon:la,text:"Film"},image:{color:"#aa99c9",icon:us,text:"Image"},movies:{color:"#f1644b",icon:la,text:"Movie"},radio:{color:"#8fdaef",icon:vs,text:"Radio"},software:{color:"#9ecc4f",icon:ms,text:"Software"},texts:{color:"#faab3c",icon:fs,text:"Text"},tv:{color:"#f1644b",icon:gs,text:"TV"},video:{color:"#f1644b",icon:ys,text:"Video"},web:{color:"#ffcd27",icon:bs,text:"Web"}};let Zt=class extends E{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var e,t;const i=["tvnews","tvarchive","television"],o=["radio","radioprogram"];return this.mediatype==="movies"&&((e=this.collections)===null||e===void 0?void 0:e.some(r=>i.indexOf(r)>=0))?"tv":this.mediatype==="audio"&&((t=this.collections)===null||t===void 0?void 0:t.some(r=>o.indexOf(r)>=0))?"radio":this.mediatype||""}render(){const e=ws[this.displayMediatype];return e?h`
      <div
        id="icon"
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let gt=zs;function Es(a,e){let t=1;return a>=1e9?t=1e9:a>=1e6?t=1e6:a>=1e3&&e==="short"&&(t=1e3),t}function Ds(a=0,e){const t=a/e,i=t<10;let o=0;return i?o=Math.round((t+Number.EPSILON)*10)/10:o=Math.round(t),o}function As(a,e,t,i){switch(e){case 1e9:return gt(t==="short"?ft`${a}B`:ft`${a} billion`);case 1e6:return gt(t==="short"?ft`${a}M`:ft`${a} million`);case 1e3:return gt(t==="short"?ft`${a}K`:ft`${a} thousand`);default:return new Intl.NumberFormat(i).format(a)}}function Wt(a,e="long",t="short",i="en-US"){const o=a!=null?a:-1;if(o<0)return"";const r=Es(o,e),n=Ds(o,r);return As(n,r,t,i)}let Ie=class extends E{render(){var e;const t=Wt(this.favCount,"short","short"),i=Wt(this.commentCount,"short","short"),o=this.mediatype==="account"?`${this.itemCount} uploads`:`${this.viewCount} ${(e=this.viewLabel)!==null&&e!==void 0?e:"all-time views"}`;return h`
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const wa=Ti(class extends ki{constructor(a){if(super(a),a.type!==Le.PROPERTY&&a.type!==Le.ATTRIBUTE&&a.type!==Le.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!es(a))throw Error("`live` bindings can only contain a single expression")}render(a){return a}update(a,[e]){if(e===me||e===b)return e;const t=a.element,i=a.name;if(a.type===Le.PROPERTY){if(e===t[i])return me}else if(a.type===Le.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(i))return me}else if(a.type===Le.ATTRIBUTE&&t.getAttribute(i)===e+"")return me;return Qa(a),e}}),_n=Object.freeze({processing:"processing",complete:"complete"});class $n extends E{static get properties(){return{mode:{type:String}}}constructor(){super(),this.mode=_n.processing}render(){return h`
      <div class="${this.mode}">
        <svg
          viewBox="0 0 120 120"
  ...
  `;s([c({type:Number})],W.prototype,"width",void 0);s([c({type:Number})],W.prototype,"height",void 0);s([c({type:Number})],W.prototype,"sliderWidth",void 0);s([c({type:Number})],W.prototype,"tooltipWidth",void 0);s([c({type:Number})],W.prototype,"tooltipHeight",void 0);s([c({type:Number})],W.prototype,"updateDelay",void 0);s([c({type:String})],W.prototype,"dateFormat",void 0);s([c({type:String})],W.prototype,"missingDataMessage",void 0);s([c({type:String})],W.prototype,"minDate",void 0);s([c({type:String})],W.prototype,"maxDate",void 0);s([c({type:Boolean})],W.prototype,"disabled",void 0);s([c({type:Object})],W.prototype,"bins",void 0);s([k()],W.prototype,"_tooltipOffset",void 0);s([k()],W.prototype,"_tooltipContent",void 0);s([k()],W.prototype,"_tooltipVisible",void 0);s([k()],W.prototype,"_isDragging",void 0);s([k()],W.prototype,"_isLoading",void 0);s([c({type:Boolean})],W.prototype,"loading",null);s([c()],W.prototype,"minSelectedDate",null);s([c()],W.prototype,"maxSelectedDate",null);W=s([A("histogram-date-range")],W);const Sa=F`
...
`;let ti=class extends E{constructor(){super(...arguments),this.placeholderType=null,this.detailMessage=""}render(){return this.placeholderType?h`${this.placeholderTemplate}`:b}get placeholderTemplate(){return h`
      <div
