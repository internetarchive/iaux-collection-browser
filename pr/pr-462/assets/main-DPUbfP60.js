...
`;function zd(s,e){let t=1;return s>=1e9?t=1e9:s>=1e6?t=1e6:s>=1e3&&e==="short"&&(t=1e3),t}function Ld(s=0,e){const t=s/e,i=t<10;let o=0;return i?o=Math.round((t+Number.EPSILON)*10)/10:o=Math.round(t),o}function Pd(s,e,t,i){switch(e){case 1e9:return C(t==="short"?nt`${s}B`:nt`${s} billion`);case 1e6:return C(t==="short"?nt`${s}M`:nt`${s} million`);case 1e3:return C(t==="short"?nt`${s}K`:nt`${s} thousand`);default:return new Intl.NumberFormat(i).format(s)}}function rr(s,e="long",t="short",i="en-US"){const o=s??-1;if(o<0)return"";const r=zd(o,e),a=Ld(o,r);return Pd(a,r,t,i)}let Ae=class extends I{constructor(){super(...arguments),this.isTvSearchResult=!1,this.showTvClips=!1}render(){return c`
    ...
    `}get sortedDateInfoTemplate(){var e,t,i,o,r;let a,l="long";switch((e=this.effectiveSort)===null||e===void 0?void 0:e.field){case"date":{const d=(t=this.model)===null||t===void 0?void 0:t.datePublished;a={field:"published",value:d},sr(d)&&(l="year-only");break}case"reviewdate":a={field:"reviewed",value:(i=this.model)===null||i===void 0?void 0:i.dateReviewed};break;case"addeddate":a={field:"added",value:(o=this.model)===null||o===void 0?void 0:o.dateAdded};break;case"publicdate":a={field:"archived",value:(r=this.model)===null||r===void 0?void 0:r.dateArchived};break}return a!=null&&a.value?c`
...
`;let G=class extends I{constructor(){super(...arguments),this.defaultSortDirection=null,this.defaultSortField=_.relevance,this.sortDirection=null,this.selectedSort=_.default,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.showRelevance=!0,this.showDateFavorited=!1,this.enableSortOptionsSlot=!1,this.suppressDisplayModes=!1,this.lastSelectedViewSort=_.weeklyview,this.lastSelectedDateSort=this.defaultDateSortField,this.alphaSelectorVisible=null,this.dropdownBackdropVisible=!1,this.desktopSortContainerWidth=0,this.selectorBarContainerWidth=0,this.boundSortBarSelectorEscapeListener=e=>{e.key==="Escape"&&this.closeDropdowns()}}render(){return c`
    ...
    `}getSortDisplayOption(e,t){var i,o;const r=(i=t==null?void 0:t.selected)!==null&&i!==void 0?i:this.finalizedSortField===e,a=(o=t==null?void 0:t.displayName)!==null&&o!==void 0?o:we[e].displayName;return c`
      <button
        class=${r?"selected":b}
        data-title="${a}"
