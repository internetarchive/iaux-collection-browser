 ...
 */const sa=(a,e,t)=>{const i=new Map;for(let o=e;o<=t;o++)i.set(a[o],o);return i},Qa=ki(class extends Ti{constructor(a){if(super(a),a.type!==Le.CHILD)throw Error("repeat() can only be used in text expressions")}dt(a,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);const o=[],r=[];let n=0;for(const l of a)o[n]=i?i(l,n):n,r[n]=t(l,n),n++;return{values:r,keys:o}}render(a,e,t){return this.dt(a,e,t).values}update(a,[e,t,i]){var o;const r=ts(a),{values:n,keys:l}=this.dt(e,t,i);if(!Array.isArray(r))return this.ut=l,n;const d=(o=this.ut)!==null&&o!==void 0?o:this.ut=[],u=[];let v,f,b=0,x=r.length-1,_=0,M=n.length-1;for(;b<=x&&_<=M;)if(r[b]===null)b++;else if(r[x]===null)x--;else if(d[b]===l[_])u[_]=Ye(r[b],n[_]),b++,_++;else if(d[x]===l[M])u[M]=Ye(r[x],n[M]),x--,M--;else if(d[b]===l[M])u[M]=Ye(r[b],n[M]),Nt(a,u[M+1],r[b]),b++,M--;else if(d[x]===l[_])u[_]=Ye(r[x],n[_]),Nt(a,r[b],r[x]),x--,_++;else if(v===void 0&&(v=sa(l,_,M),f=sa(d,b,x)),v.has(d[b]))if(v.has(d[x])){const P=f.get(l[_]),Z=P!==void 0?r[P]:null;if(Z===null){const R=Nt(a,r[b]);Ye(R,n[_]),u[_]=R}else u[_]=Ye(Z,n[_]),Nt(a,r[b],Z),r[P]=null;_++}else ji(r[x]),x--;else ji(r[b]),b++;for(;_<=M;){const P=Nt(a,u[M+1]);Ye(P,n[_]),u[_++]=P}for(;b<=x;){const P=r[b++];P!==null&&ji(P)}return this.ut=l,Ga(a,u),me}});function li(a,e,t){return Array.from({length:(e-a)/t+1},(i,o)=>a+o*t)}let Oe=class extends E{constructor(){super(...arguments),this.itemCount=0,this.scrollOptimizationsDisabled=!1,this.intersectionObserver=new IntersectionObserver(e=>{e.forEach(t=>{if(t.target===this.sentinel){t.isIntersecting&&this.dispatchEvent(new Event("scrollThresholdReached"));return}const o=t.target.dataset.cellIndex;if(!o)return;const r=parseInt(o,10);t.isIntersecting?this.visibleCellIndices.add(r):this.visibleCellIndices.delete(r)}),this.scrollOptimizationsDisabled||this.processVisibleCells()}),this.renderedCellIndices=new Set,this.visibleCellIndices=new Set,this.placeholderCellIndices=new Set}reload(){li(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.removeCell(t)),this.renderedCellIndices.clear(),this.visibleCellIndices.clear(),this.placeholderCellIndices.clear(),this.setupObservations()}scrollToCell(e,t){const i=this.cellContainers[e];if(!i)return!1;const o=t?"smooth":"auto";return i.scrollIntoView({behavior:o}),!0}getVisibleCellIndices(){return Array.from(this.visibleCellIndices)}updated(e){(e.has("itemCount")||e.has("scrollOptimizationsDisabled"))&&this.setupObservations()}disconnectedCallback(){this.intersectionObserver.disconnect()}setupObservations(){this.setupIntersectionObserver()}setupIntersectionObserver(){this.intersectionObserver.disconnect(),this.sentinel&&this.intersectionObserver.observe(this.sentinel),this.scrollOptimizationsDisabled?(li(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.visibleCellIndices.add(t)),this.processVisibleCells()):this.cellContainers.forEach(e=>this.intersectionObserver.observe(e))}render(){const e=this.itemCount-1,t=li(0,e,1);return h`
    ...
    `}};s([c({type:Number})],Oe.prototype,"itemCount",void 0);s([c({type:Object})],Oe.prototype,"cellProvider",void 0);s([c({type:Object})],Oe.prototype,"placeholderCellTemplate",void 0);s([c({type:Boolean})],Oe.prototype,"scrollOptimizationsDisabled",void 0);s([G("#sentinel")],Oe.prototype,"sentinel",void 0);s([Kr(".cell-container")],Oe.prototype,"cellContainers",void 0);Oe=s([A("infinite-scroller")],Oe);/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;let Kt=class extends E{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1,this.isCompactTile=!1}render(){return h`<div class="icon-overlay ${this.getClass}">
    ...
    `}};s([c({type:Boolean})],Xt.prototype,"loggedIn",void 0);s([c({type:Boolean})],Xt.prototype,"loginRequired",void 0);s([c({type:Boolean})],Xt.prototype,"iconRequired",void 0);Xt=s([A("text-overlay")],Xt);let Be=class extends E{constructor(){super(...arguments),this.isCompactTile=!1,this.isListTile=!1,this.loggedIn=!1,this.viewSize="desktop"}render(){var e;return!((e=this.model)===null||e===void 0)&&e.identifier?h`
    ...
    `}};s([c({type:String})],Be.prototype,"baseImageUrl",void 0);s([c({type:Boolean})],Be.prototype,"isCompactTile",void 0);s([c({type:Boolean})],Be.prototype,"isListTile",void 0);s([c({type:Boolean})],Be.prototype,"loggedIn",void 0);s([c({type:Object})],Be.prototype,"model",void 0);s([c({type:String})],Be.prototype,"viewSize",void 0);Be=s([A("image-block")],Be);let Yt=class extends E{constructor(){super(...arguments),this.showInfoButton=!1}render(){return h`
      <div class="container">
...
`+se),Ce&&(se=Pe(se,He," "),se=Pe(se,We," ")),K&&ai?K.createHTML(se):se},e.setConfig=function($){Ai($),Qe=!0},e.clearConfig=function(){vt=null,Qe=!1},e.isValidAttribute=function($,p,w){vt||Ai({});var C=Ke($),B=Ke(p);return No(C,B,w)},e.addHook=function($,p){typeof p=="function"&&(ce[$]=ce[$]||[],Ut(ce[$],p))},e.removeHook=function($){if(ce[$])return da(ce[$])},e.removeHooks=function($){ce[$]&&(ce[$]=[])},e.removeAllHooks=function(){ce={}},e}var jt=Za(),z;(function(a){a.relevance="relevance",a.alltimeview="alltimeview",a.weeklyview="weeklyview",a.title="title",a.date="date",a.datearchived="datearchived",a.datereviewed="datereviewed",a.dateadded="dateadded",a.creator="creator"})(z||(z={}));const Je={relevance:"Relevance",alltimeview:"All-time views",weeklyview:"Weekly views",title:"Title",date:"Date published",datearchived:"Date archived",datereviewed:"Date reviewed",dateadded:"Date added",creator:"Creator"},va={relevance:"desc",alltimeview:"desc",weeklyview:"desc",title:"asc",date:"desc",datearchived:"desc",datereviewed:"desc",dateadded:"desc",creator:"asc"},nn={relevance:null,alltimeview:"downloads",weeklyview:"week",title:"titleSorter",date:"date",datearchived:"publicdate",datereviewed:"reviewdate",dateadded:"addeddate",creator:"creatorSorter"};z.weeklyview,z.alltimeview,z.title,z.date,z.datearchived,z.datereviewed,z.dateadded,z.creator;const ln={week:"week",downloads:"downloads",titleSorter:"title",date:"date",publicdate:"publicdate",reviewdate:"reviewdate",addeddate:"addeddate",creatorSorter:"creator"},ma={week:z.weeklyview,downloads:z.alltimeview,title:z.title,titleSorter:z.title,date:z.date,publicdate:z.datearchived,reviewdate:z.datereviewed,addeddate:z.dateadded,creator:z.creator,creatorSorter:z.creator},dn={title:"firstTitle",creator:"firstCreator"},ei=()=>({subject:{},lending:{},mediatype:{},language:{},creator:{},collection:{},year:{}}),cn=["mediatype","lending","year","subject","collection","creator","language"],Ci={subject:"Subject",lending:"Availability",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"},ho={subject:V.COUNT,lending:V.COUNT,mediatype:V.COUNT,language:V.COUNT,creator:V.COUNT,collection:V.COUNT,year:V.NUMERIC},hn={subject:V.ALPHABETICAL,lending:V.ALPHABETICAL,mediatype:V.ALPHABETICAL,language:V.ALPHABETICAL,creator:V.ALPHABETICAL,collection:V.ALPHABETICAL,year:V.NUMERIC},pn={is_lendable:!0,is_borrowable:!1,available_to_borrow:!0,is_browsable:!1,available_to_browse:!1,is_readable:!0,available_to_waitlist:!1},fa={is_lendable:"Lending Library",available_to_borrow:"Borrow 14 Days",is_readable:"Always Available"},$o={deemphasize:!0,community:!0,stream_only:!0,samples_only:!0,test_collection:!0,printdisabled:!0,"openlibrary-ol":!0,nationalemergencylibrary:!0,china:!0,americana:!0,toronto:!0};function Ja(a){switch(a){case"publicdate":return"Archived";case"reviewdate":return"Reviewed";case"addeddate":return"Added";default:return"Published"}}function er(a){return a?`Archivist since ${a.getFullYear()}`:""}let fe=class extends E{constructor(){super(...arguments),this.sortParam=null,this.collectionLinks=[],this.loggedIn=!1}render(){return h`
  ...
  `;s([c({type:String})],Ne.prototype,"selectedLetter",void 0);s([c({type:Object})],Ne.prototype,"letterCounts",void 0);s([T()],Ne.prototype,"tooltipShown",void 0);s([T()],Ne.prototype,"hoveredLetter",void 0);s([G("alpha-bar-tooltip")],Ne.prototype,"tooltip",void 0);Ne=s([A("alpha-bar")],Ne);const vn=h`
