 ...
 */const na=(a,e,t)=>{const i=new Map;for(let o=e;o<=t;o++)i.set(a[o],o);return i},Qa=ki(class extends Ti{constructor(a){if(super(a),a.type!==Le.CHILD)throw Error("repeat() can only be used in text expressions")}dt(a,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);const o=[],r=[];let n=0;for(const l of a)o[n]=i?i(l,n):n,r[n]=t(l,n),n++;return{values:r,keys:o}}render(a,e,t){return this.dt(a,e,t).values}update(a,[e,t,i]){var o;const r=is(a),{values:n,keys:l}=this.dt(e,t,i);if(!Array.isArray(r))return this.ut=l,n;const d=(o=this.ut)!==null&&o!==void 0?o:this.ut=[],u=[];let v,f,b=0,x=r.length-1,_=0,k=n.length-1;for(;b<=x&&_<=k;)if(r[b]===null)b++;else if(r[x]===null)x--;else if(d[b]===l[_])u[_]=Ze(r[b],n[_]),b++,_++;else if(d[x]===l[k])u[k]=Ze(r[x],n[k]),x--,k--;else if(d[b]===l[k])u[k]=Ze(r[b],n[k]),Nt(a,u[k+1],r[b]),b++,k--;else if(d[x]===l[_])u[_]=Ze(r[x],n[_]),Nt(a,r[b],r[x]),x--,_++;else if(v===void 0&&(v=na(l,_,k),f=na(d,b,x)),v.has(d[b]))if(v.has(d[x])){const D=f.get(l[_]),B=D!==void 0?r[D]:null;if(B===null){const U=Nt(a,r[b]);Ze(U,n[_]),u[_]=U}else u[_]=Ze(B,n[_]),Nt(a,r[b],B),r[D]=null;_++}else ji(r[x]),x--;else ji(r[b]),b++;for(;_<=k;){const D=Nt(a,u[k+1]);Ze(D,n[_]),u[_++]=D}for(;b<=x;){const D=r[b++];D!==null&&ji(D)}return this.ut=l,qa(a,u),fe}});function li(a,e,t){return Array.from({length:(e-a)/t+1},(i,o)=>a+o*t)}let De=class extends E{constructor(){super(...arguments),this.itemCount=0,this.scrollOptimizationsDisabled=!1,this.intersectionObserver=new IntersectionObserver(e=>{e.forEach(t=>{if(t.target===this.sentinel){t.isIntersecting&&this.dispatchEvent(new Event("scrollThresholdReached"));return}const o=t.target.dataset.cellIndex;if(!o)return;const r=parseInt(o,10);t.isIntersecting?this.visibleCellIndices.add(r):this.visibleCellIndices.delete(r)}),this.scrollOptimizationsDisabled||this.processVisibleCells()}),this.renderedCellIndices=new Set,this.visibleCellIndices=new Set,this.placeholderCellIndices=new Set}reload(){li(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.removeCell(t)),this.renderedCellIndices.clear(),this.visibleCellIndices.clear(),this.placeholderCellIndices.clear(),this.setupObservations()}scrollToCell(e,t){const i=this.cellContainers[e];if(!i)return!1;const o=t?"smooth":"auto";return i.scrollIntoView({behavior:o}),!0}getVisibleCellIndices(){return Array.from(this.visibleCellIndices)}updated(e){(e.has("itemCount")||e.has("scrollOptimizationsDisabled"))&&this.setupObservations()}disconnectedCallback(){this.intersectionObserver.disconnect()}setupObservations(){this.setupIntersectionObserver()}setupIntersectionObserver(){this.intersectionObserver.disconnect(),this.sentinel&&this.intersectionObserver.observe(this.sentinel),this.scrollOptimizationsDisabled?(li(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.visibleCellIndices.add(t)),this.processVisibleCells()):this.cellContainers.forEach(e=>this.intersectionObserver.observe(e))}render(){const e=this.itemCount-1,t=li(0,e,1);return h`
    ...
    `}};s([c({type:Number})],De.prototype,"itemCount",void 0);s([c({type:Number})],De.prototype,"predictedFullItemCount",void 0);s([c({type:Object})],De.prototype,"cellProvider",void 0);s([c({type:Object})],De.prototype,"placeholderCellTemplate",void 0);s([c({type:Boolean})],De.prototype,"scrollOptimizationsDisabled",void 0);s([K("#sentinel")],De.prototype,"sentinel",void 0);s([Xr(".cell-container")],De.prototype,"cellContainers",void 0);De=s([A("infinite-scroller")],De);/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`+le),Ce&&(le=Fe(le,We," "),le=Fe(le,je," ")),R&&ai?R.createHTML(le):le},e.setConfig=function($){Pi($),Qe=!0},e.clearConfig=function(){mt=null,Qe=!1},e.isValidAttribute=function($,p,w){mt||Pi({});var C=Xe($),I=Xe(p);return Uo(C,I,w)},e.addHook=function($,p){typeof p=="function"&&(pe[$]=pe[$]||[],Ut(pe[$],p))},e.removeHook=function($){if(pe[$])return ca(pe[$])},e.removeHooks=function($){pe[$]&&(pe[$]=[])},e.removeAllHooks=function(){pe={}},e}var jt=Ja(),M;(function(a){a.relevance="relevance",a.alltimeview="alltimeview",a.weeklyview="weeklyview",a.title="title",a.date="date",a.datearchived="datearchived",a.datereviewed="datereviewed",a.dateadded="dateadded",a.creator="creator"})(M||(M={}));const et={relevance:"Relevance",alltimeview:"All-time views",weeklyview:"Weekly views",title:"Title",date:"Date published",datearchived:"Date archived",datereviewed:"Date reviewed",dateadded:"Date added",creator:"Creator"},ma={relevance:"desc",alltimeview:"desc",weeklyview:"desc",title:"asc",date:"desc",datearchived:"desc",datereviewed:"desc",dateadded:"desc",creator:"asc"},dn={relevance:null,alltimeview:"downloads",weeklyview:"week",title:"titleSorter",date:"date",datearchived:"publicdate",datereviewed:"reviewdate",dateadded:"addeddate",creator:"creatorSorter"};M.weeklyview,M.alltimeview,M.title,M.date,M.datearchived,M.datereviewed,M.dateadded,M.creator;const cn={week:"week",downloads:"downloads",titleSorter:"title",date:"date",publicdate:"publicdate",reviewdate:"reviewdate",addeddate:"addeddate",creatorSorter:"creator"},fa={week:M.weeklyview,downloads:M.alltimeview,title:M.title,titleSorter:M.title,date:M.date,publicdate:M.datearchived,reviewdate:M.datereviewed,addeddate:M.dateadded,creator:M.creator,creatorSorter:M.creator},hn={title:"firstTitle",creator:"firstCreator"},ei=()=>({subject:{},lending:{},mediatype:{},language:{},creator:{},collection:{},year:{}}),pn=["mediatype","lending","year","subject","collection","creator","language"],Ci={subject:"Subject",lending:"Availability",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"},ho={subject:Q.COUNT,lending:Q.COUNT,mediatype:Q.COUNT,language:Q.COUNT,creator:Q.COUNT,collection:Q.COUNT,year:Q.NUMERIC},un={subject:Q.ALPHABETICAL,lending:Q.ALPHABETICAL,mediatype:Q.ALPHABETICAL,language:Q.ALPHABETICAL,creator:Q.ALPHABETICAL,collection:Q.ALPHABETICAL,year:Q.NUMERIC},vn={is_lendable:!0,is_borrowable:!1,available_to_borrow:!0,is_browsable:!1,available_to_browse:!1,is_readable:!0,available_to_waitlist:!1},ga={is_lendable:"Lending Library",available_to_borrow:"Borrow 14 Days",is_readable:"Always Available"},So={deemphasize:!0,community:!0,stream_only:!0,samples_only:!0,test_collection:!0,printdisabled:!0,"openlibrary-ol":!0,nationalemergencylibrary:!0,china:!0,americana:!0,toronto:!0};function er(a){switch(a){case"publicdate":return"Archived";case"reviewdate":return"Reviewed";case"addeddate":return"Added";default:return"Published"}}function tr(a){return a?`Archivist since ${a.getFullYear()}`:""}let ge=class extends E{constructor(){super(...arguments),this.sortParam=null,this.collectionLinks=[],this.loggedIn=!1}render(){return h`
    ...
    `}};s([c({type:Object})],Ne.prototype,"model",void 0);s([c({type:String})],Ne.prototype,"baseNavigationUrl",void 0);s([c({type:String})],Ne.prototype,"baseImageUrl",void 0);s([c({type:Boolean})],Ne.prototype,"loggedIn",void 0);s([c({type:Object})],Ne.prototype,"sortParam",void 0);s([c({type:Object})],Ne.prototype,"collectionNameCache",void 0);Ne=s([A("tile-hover-pane")],Ne);let Se=class extends E{constructor(){super(...arguments),this.sortParam=null,this.loggedIn=!1}render(){var e,t,i,o,r,n,l,d,u;return h`
      <div id="list-line" class="${this.classSize}">
        <image-block
          .model=${this.model}
          .baseImageUrl=${this.baseImageUrl}
