 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const yi=Ti(class extends zi{constructor(a){var e;if(super(a),a.type!==Pe.ATTRIBUTE||a.name!=="class"||((e=a.strings)===null||e===void 0?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(a){return" "+Object.keys(a).filter(e=>a[e]).join(" ")+" "}update(a,[e]){var t,i;if(this.et===void 0){this.et=new Set,a.strings!==void 0&&(this.st=new Set(a.strings.join(" ").split(/\s/).filter(r=>r!=="")));for(const r in e)e[r]&&!(!((t=this.st)===null||t===void 0)&&t.has(r))&&this.et.add(r);return this.render(e)}const o=a.element.classList;this.et.forEach(r=>{r in e||(o.remove(r),this.et.delete(r))});for(const r in e){const n=!!e[r];n===this.et.has(r)||((i=this.st)===null||i===void 0?void 0:i.has(r))||(n?(o.add(r),this.et.add(r)):(o.remove(r),this.et.delete(r)))}return ge}});/**
 * @license
...
`;let Xt=class extends D{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1,this.isCompactTile=!1}render(){return h`<div class="icon-overlay ${this.getClass}">
      ${this.iconDisplay}
    ...
    `}};s([c({type:Boolean})],Xt.prototype,"loggedIn",void 0);s([c({type:Boolean})],Xt.prototype,"loginRequired",void 0);s([c({type:Boolean})],Xt.prototype,"isCompactTile",void 0);Xt=s([A("icon-overlay")],Xt);let Yt=class extends D{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1,this.iconRequired=!1}render(){return h`
    ...
    `}};s([c({type:Boolean})],Yt.prototype,"loggedIn",void 0);s([c({type:Boolean})],Yt.prototype,"loginRequired",void 0);s([c({type:Boolean})],Yt.prototype,"iconRequired",void 0);Yt=s([A("text-overlay")],Yt);let We=class extends D{constructor(){super(...arguments),this.isCompactTile=!1,this.isListTile=!1,this.loggedIn=!1,this.viewSize="desktop"}render(){var e;return!((e=this.model)===null||e===void 0)&&e.identifier?h`
      <div class=${yi(this.baseClass)}>
        <item-image
          .model=${this.model}
    ...
    `}};s([c({type:String})],We.prototype,"baseImageUrl",void 0);s([c({type:Boolean})],We.prototype,"isCompactTile",void 0);s([c({type:Boolean})],We.prototype,"isListTile",void 0);s([c({type:Boolean})],We.prototype,"loggedIn",void 0);s([c({type:Object})],We.prototype,"model",void 0);s([c({type:String})],We.prototype,"viewSize",void 0);We=s([A("image-block")],We);let Zt=class extends D{constructor(){super(...arguments),this.showInfoButton=!1}render(){return h`
      <div class="container">
    ...
    >`}get getSizeTemplate(){var e,t;const i=(t=(e=this.model)===null||e===void 0?void 0:e.collectionSize)!==null&&t!==void 0?t:0;return i?h`<span id="item-size">${as(i,1)}</span>`:""}get infoButtonTemplate(){return this.showInfoButton?h`<button class="info-button" @click=${this.infoButtonPressed}>
      ...
      `]}};s([c({type:Object})],Zt.prototype,"model",void 0);s([c({type:String})],Zt.prototype,"baseImageUrl",void 0);s([c({type:Boolean})],Zt.prototype,"showInfoButton",void 0);Zt=s([A("collection-tile")],Zt);function xi(a,e="short",t="en-US"){if(!a)return"";const i={timeZone:"UTC"};switch(e){case"year-only":i.year="numeric";break;case"short":i.month="short",i.year="numeric";break;case"long":i.year="numeric",i.month="short",i.day="2-digit";break}return new Intl.DateTimeFormat(t,i).format(a)}function ns(a){return new Date(a.getTime()-a.getTimezoneOffset()*1e3*60)}function So(a){return a?ns(a).toISOString().endsWith("-01-01T00:00:00.000Z"):!1}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*ui(a,e){const t=typeof e=="function";if(a!==void 0){let i=-1;for(const o of a)i>-1&&(yield t?e(i):e),i++,yield o}}let _i=class extends D{constructor(){super(...arguments),this.snippets=[],this.viewSize="desktop"}render(){var e;return!((e=this.snippets)===null||e===void 0)&&e.length?h`
      <div class="container">
...
`;let Oe=class extends D{constructor(){super(...arguments),this.isListTile=!1,this.isCompactTile=!1,this.loggedIn=!1,this.isWaveform=!1}render(){return h`
      <div class=${yi(this.itemBaseClass)}>
        <img
          class=${yi(this.itemImageClass)}
          src="${this.imageSrc}"
          alt=""
          @load=${this.onLoad}
        />
...
`,xs={account:{color:"#000000",icon:cs,text:"Account"},audio:{color:"#00adef",icon:hs,text:"Audio"},collection:{color:"#4666ff",icon:Xa,text:"Collection"},data:{color:"#333333",icon:ps,text:"Data"},etree:{color:"#00adef",icon:us,text:"E-tree"},film:{color:"#bf1b2c",icon:da,text:"Film"},image:{color:"#aa99c9",icon:vs,text:"Image"},movies:{color:"#f1644b",icon:da,text:"Movie"},radio:{color:"#8fdaef",icon:ms,text:"Radio"},software:{color:"#9ecc4f",icon:fs,text:"Software"},texts:{color:"#faab3c",icon:gs,text:"Text"},tv:{color:"#f1644b",icon:bs,text:"TV"},video:{color:"#f1644b",icon:ys,text:"Video"},web:{color:"#ffcd27",icon:ws,text:"Web"}};let Jt=class extends D{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var e,t;const i=["tvnews","tvarchive","television"],o=["radio","radioprogram"];return this.mediatype==="movies"&&((e=this.collections)===null||e===void 0?void 0:e.some(r=>i.indexOf(r)>=0))?"tv":this.mediatype==="audio"&&((t=this.collections)===null||t===void 0?void 0:t.some(r=>o.indexOf(r)>=0))?"radio":this.mediatype||""}render(){const e=xs[this.displayMediatype];return e?h`
    ...
    `}};s([c({type:String})],Jt.prototype,"mediatype",void 0);s([c({type:Array})],Jt.prototype,"collections",void 0);s([c({type:Boolean})],Jt.prototype,"showText",void 0);Jt=s([A("mediatype-icon")],Jt);const _s=F`
 ...
 */let Ct=Ms;function Ds(a,e){let t=1;return a>=1e9?t=1e9:a>=1e6?t=1e6:a>=1e3&&e==="short"&&(t=1e3),t}function Ps(a=0,e){const t=a/e,i=t<10;let o=0;return i?o=Math.round((t+Number.EPSILON)*10)/10:o=Math.round(t),o}function As(a,e,t,i){switch(e){case 1e9:return Ct(t==="short"?_t`${a}B`:_t`${a} billion`);case 1e6:return Ct(t==="short"?_t`${a}M`:_t`${a} million`);case 1e3:return Ct(t==="short"?_t`${a}K`:_t`${a} thousand`);default:return new Intl.NumberFormat(i).format(a)}}function jt(a,e="long",t="short",i="en-US"){const o=a!=null?a:-1;if(o<0)return"";const r=Ds(o,e),n=Ps(o,r);return As(n,r,t,i)}let je=class extends D{render(){var e;const t=jt(this.favCount,"short","short"),i=jt(this.commentCount,"short","short"),o=this.mediatype==="account"?`${this.itemCount} uploads`:`${this.viewCount} ${(e=this.viewLabel)!==null&&e!==void 0?e:"all-time views"}`;return h`
    ...
    `}get doesSortedByDate(){var e;return["date","reviewdate","addeddate","publicdate"].includes((e=this.sortParam)===null||e===void 0?void 0:e.field)}get hasSnippets(){var e,t;return!!(!((t=(e=this.model)===null||e===void 0?void 0:e.snippets)===null||t===void 0)&&t.length)}infoButtonPressed(e){e.preventDefault();const t=new CustomEvent("infoButtonPressed",{detail:{x:e.clientX,y:e.clientY}});this.dispatchEvent(t)}static get styles(){const e=m`var(--tileBorderColor, #dddddd)`;return[$o,m`
      ...
      `]}};s([c({type:String})],ct.prototype,"baseImageUrl",void 0);s([c({type:Boolean})],ct.prototype,"loggedIn",void 0);s([c({type:Object})],ct.prototype,"model",void 0);s([c({type:Object})],ct.prototype,"sortParam",void 0);s([c({type:Boolean})],ct.prototype,"showInfoButton",void 0);ct=s([A("item-tile")],ct);let ei=class extends D{constructor(){super(...arguments),this.showInfoButton=!1}render(){return h`
      <div class="container">
        ${this.infoButtonTemplate}
        <div class="tile-details">
          <div class="item-info">
    ...
    >
      ...
      `]}};s([c({type:Object})],ei.prototype,"model",void 0);s([c({type:String})],ei.prototype,"baseImageUrl",void 0);s([c({type:Boolean})],ei.prototype,"showInfoButton",void 0);ei=s([A("account-tile")],ei);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`+de),Se&&(de=Ne(de,Qe," "),de=Ne(de,Ke," ")),B&&ri?B.createHTML(de):de},e.setConfig=function($){Ai($),Je=!0},e.clearConfig=function(){wt=null,Je=!1},e.isValidAttribute=function($,p,w){wt||Ai({});var C=tt($),I=tt(p);return Ho(C,I,w)},e.addHook=function($,p){typeof p=="function"&&(ve[$]=ve[$]||[],Ht(ve[$],p))},e.removeHook=function($){if(ve[$])return ha(ve[$])},e.removeHooks=function($){ve[$]&&(ve[$]=[])},e.removeAllHooks=function(){ve={}},e}var Vt=er(),M;(function(a){a.relevance="relevance",a.alltimeview="alltimeview",a.weeklyview="weeklyview",a.title="title",a.date="date",a.datearchived="datearchived",a.datereviewed="datereviewed",a.dateadded="dateadded",a.creator="creator"})(M||(M={}));const rt={relevance:"Relevance",alltimeview:"All-time views",weeklyview:"Weekly views",title:"Title",date:"Date published",datearchived:"Date archived",datereviewed:"Date reviewed",dateadded:"Date added",creator:"Creator"},fa={relevance:"desc",alltimeview:"desc",weeklyview:"desc",title:"asc",date:"desc",datearchived:"desc",datereviewed:"desc",dateadded:"desc",creator:"asc"},cn={relevance:null,alltimeview:"downloads",weeklyview:"week",title:"titleSorter",date:"date",datearchived:"publicdate",datereviewed:"reviewdate",dateadded:"addeddate",creator:"creatorSorter"};M.weeklyview,M.alltimeview,M.title,M.date,M.datearchived,M.datereviewed,M.dateadded,M.creator;const hn={week:"week",downloads:"downloads",titleSorter:"title",date:"date",publicdate:"publicdate",reviewdate:"reviewdate",addeddate:"addeddate",creatorSorter:"creator"},ga={week:M.weeklyview,downloads:M.alltimeview,title:M.title,titleSorter:M.title,date:M.date,publicdate:M.datearchived,reviewdate:M.datereviewed,addeddate:M.dateadded,creator:M.creator,creatorSorter:M.creator},pn={title:"firstTitle",creator:"firstCreator"},ti=()=>({subject:{},lending:{},mediatype:{},language:{},creator:{},collection:{},year:{}}),un=["mediatype","lending","year","subject","collection","creator","language"],$i={subject:"Subject",lending:"Availability",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"},po={subject:K.COUNT,lending:K.COUNT,mediatype:K.COUNT,language:K.COUNT,creator:K.COUNT,collection:K.COUNT,year:K.NUMERIC},vn={subject:K.ALPHABETICAL,lending:K.ALPHABETICAL,mediatype:K.ALPHABETICAL,language:K.ALPHABETICAL,creator:K.ALPHABETICAL,collection:K.ALPHABETICAL,year:K.NUMERIC},mn={is_lendable:!0,is_borrowable:!1,available_to_borrow:!0,is_browsable:!1,available_to_browse:!1,is_readable:!0,available_to_waitlist:!1},ba={is_lendable:"Lending Library",available_to_borrow:"Borrow 14 Days",is_readable:"Always Available"},ko={deemphasize:!0,community:!0,stream_only:!0,samples_only:!0,test_collection:!0,printdisabled:!0,"openlibrary-ol":!0,nationalemergencylibrary:!0,china:!0,americana:!0,toronto:!0};function tr(a){switch(a){case"publicdate":return"Archived";case"reviewdate":return"Reviewed";case"addeddate":return"Added";default:return"Published"}}function ir(a){return a?`Archivist since ${a.getFullYear()}`:""}let be=class extends D{constructor(){super(...arguments),this.sortParam=null,this.collectionLinks=[],this.loggedIn=!1}render(){return h`
    ...
    `:y}get volumeTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.volume,"Volume")}get issueTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.issue,"Issue")}get creatorTemplate(){var e,t,i;return((e=this.model)===null||e===void 0?void 0:e.mediatype)==="account"?h`
      ...
      <div id="creator" class="metadata">
        ...
        ${ui(so(this.model.creators,o=>this.searchLink("creator",o)),h`, `)}
      </div>
...
`;let Dt=class extends D{facetClicked(e,t,i){const o=e.target,{checked:r,name:n,value:l}=o;r?this.facetChecked(n,l,t,i):this.facetUnchecked(n,l),this.dispatchFacetClickEvent(n,this.getFacetState(r,i),i)}facetChecked(e,t,i,o){const{selectedFacets:r}=this;let n;r?n=fe({},r):n=ti(),n[e][t]={state:this.getFacetState(!0,o),count:i},this.selectedFacets=n,this.dispatchSelectedFacetsChanged()}facetUnchecked(e,t){const{selectedFacets:i}=this;let o;i?o=fe({},i):o=ti(),delete o[e][t],this.selectedFacets=o,this.dispatchSelectedFacetsChanged()}getFacetState(e,t){let i;return e?i=t?"hidden":"selected":i="none",i}dispatchFacetClickEvent(e,t,i){const o=new CustomEvent("facetClick",{detail:{key:e,state:t,negative:i},composed:!0});this.dispatchEvent(o)}dispatchSelectedFacetsChanged(){const e=new CustomEvent("selectedFacetsChanged",{detail:this.selectedFacets,bubbles:!0,composed:!0});this.dispatchEvent(e)}getFacetsTemplate(e){let t=e==null?void 0:e.buckets;return t=[...t.filter(i=>i.state==="selected").sort((i,o)=>i.count<o.count?1:-1),...t.filter(i=>i.state==="hidden").sort((i,o)=>i.count<o.count?1:-1),...t.filter(i=>i.state==="none")],h`
...
`;let ii=class extends D{constructor(){super(...arguments),this.placeholderType=null,this.detailMessage=""}render(){return this.placeholderType?h`${this.placeholderTemplate}`:y}get placeholderTemplate(){return h`
      <div
    ...
    ></infinite-scroller>`}get infiniteScrollerClasses(){var e;return yi({[(e=this.displayMode)!==null&&e!==void 0?e:""]:!!this.displayMode,hidden:!!this.placeholderType})}get sortFilterBarTemplate(){return h`
      <sort-filter-bar
