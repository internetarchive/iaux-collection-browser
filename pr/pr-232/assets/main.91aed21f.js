 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ae={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Ti=a=>(...e)=>({_$litDirective$:a,values:e});class zi{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const yi=Ti(class extends zi{constructor(a){var e;if(super(a),a.type!==Ae.ATTRIBUTE||a.name!=="class"||((e=a.strings)===null||e===void 0?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(a){return" "+Object.keys(a).filter(e=>a[e]).join(" ")+" "}update(a,[e]){var t,i;if(this.et===void 0){this.et=new Set,a.strings!==void 0&&(this.st=new Set(a.strings.join(" ").split(/\s/).filter(r=>r!=="")));for(const r in e)e[r]&&!(!((t=this.st)===null||t===void 0)&&t.has(r))&&this.et.add(r);return this.render(e)}const o=a.element.classList;this.et.forEach(r=>{r in e||(o.remove(r),this.et.delete(r))});for(const r in e){const n=!!e[r];n===this.et.has(r)||((i=this.st)===null||i===void 0?void 0:i.has(r))||(n?(o.add(r),this.et.add(r)):(o.remove(r),this.et.delete(r)))}return ge}});/**
 * @license
 ...
 */const la=(a,e,t)=>{const i=new Map;for(let o=e;o<=t;o++)i.set(a[o],o);return i},Ka=Ti(class extends zi{constructor(a){if(super(a),a.type!==Ae.CHILD)throw Error("repeat() can only be used in text expressions")}dt(a,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);const o=[],r=[];let n=0;for(const l of a)o[n]=i?i(l,n):n,r[n]=t(l,n),n++;return{values:r,keys:o}}render(a,e,t){return this.dt(a,e,t).values}update(a,[e,t,i]){var o;const r=os(a),{values:n,keys:l}=this.dt(e,t,i);if(!Array.isArray(r))return this.ut=l,n;const d=(o=this.ut)!==null&&o!==void 0?o:this.ut=[],u=[];let v,f,b=0,x=r.length-1,_=0,k=n.length-1;for(;b<=x&&_<=k;)if(r[b]===null)b++;else if(r[x]===null)x--;else if(d[b]===l[_])u[_]=ot(r[b],n[_]),b++,_++;else if(d[x]===l[k])u[k]=ot(r[x],n[k]),x--,k--;else if(d[b]===l[k])u[k]=ot(r[b],n[k]),Ut(a,u[k+1],r[b]),b++,k--;else if(d[x]===l[_])u[_]=ot(r[x],n[_]),Ut(a,r[b],r[x]),x--,_++;else if(v===void 0&&(v=la(l,_,k),f=la(d,b,x)),v.has(d[b]))if(v.has(d[x])){const E=f.get(l[_]),R=E!==void 0?r[E]:null;if(R===null){const H=Ut(a,r[b]);ot(H,n[_]),u[_]=H}else u[_]=ot(R,n[_]),Ut(a,r[b],R),r[E]=null;_++}else Vi(r[x]),x--;else Vi(r[b]),b++;for(;_<=k;){const E=Ut(a,u[k+1]);ot(E,n[_]),u[_++]=E}for(;b<=x;){const E=r[b++];E!==null&&Vi(E)}return this.ut=l,Qa(a,u),ge}});function di(a,e,t){return Array.from({length:(e-a)/t+1},(i,o)=>a+o*t)}let ke=class extends D{constructor(){super(...arguments),this.itemCount=0,this.scrollOptimizationsDisabled=!1,this.intersectionObserver=new IntersectionObserver(e=>{e.forEach(t=>{if(t.target===this.sentinel){t.isIntersecting&&this.dispatchEvent(new Event("scrollThresholdReached"));return}const o=t.target.dataset.cellIndex;if(!o)return;const r=parseInt(o,10);t.isIntersecting?this.visibleCellIndices.add(r):this.visibleCellIndices.delete(r)}),this.scrollOptimizationsDisabled||this.processVisibleCells()}),this.renderedCellIndices=new Set,this.visibleCellIndices=new Set,this.placeholderCellIndices=new Set}reload(){di(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.removeCell(t)),this.renderedCellIndices.clear(),this.visibleCellIndices.clear(),this.placeholderCellIndices.clear(),this.setupObservations()}scrollToCell(e,t){const i=this.cellContainers[e];if(!i)return!1;const o=t?"smooth":"auto";return i.scrollIntoView({behavior:o}),!0}getVisibleCellIndices(){return Array.from(this.visibleCellIndices)}updated(e){(e.has("itemCount")||e.has("scrollOptimizationsDisabled"))&&this.setupObservations()}disconnectedCallback(){this.intersectionObserver.disconnect()}setupObservations(){this.setupIntersectionObserver()}setupIntersectionObserver(){this.intersectionObserver.disconnect(),this.sentinel&&this.intersectionObserver.observe(this.sentinel),this.scrollOptimizationsDisabled?(di(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.visibleCellIndices.add(t)),this.processVisibleCells()):this.cellContainers.forEach(e=>this.intersectionObserver.observe(e))}render(){var e;const t=this.itemCount-1,i=di(0,t,1),o=(e=this.ariaLandmarkLabel)!==null&&e!==void 0?e:y;return h`
    ...
    `}};s([c({type:Number})],ke.prototype,"itemCount",void 0);s([c({type:Number})],ke.prototype,"predictedFullItemCount",void 0);s([c({type:Object})],ke.prototype,"cellProvider",void 0);s([c({type:Object})],ke.prototype,"placeholderCellTemplate",void 0);s([c({type:Boolean})],ke.prototype,"scrollOptimizationsDisabled",void 0);s([c({type:String})],ke.prototype,"ariaLandmarkLabel",void 0);s([X("#sentinel")],ke.prototype,"sentinel",void 0);s([Yr(".cell-container")],ke.prototype,"cellContainers",void 0);ke=s([A("infinite-scroller")],ke);/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`+de),Se&&(de=Ne(de,Qe," "),de=Ne(de,Ke," ")),B&&ri?B.createHTML(de):de},e.setConfig=function($){Ai($),Je=!0},e.clearConfig=function(){wt=null,Je=!1},e.isValidAttribute=function($,p,w){wt||Ai({});var C=tt($),I=tt(p);return Ho(C,I,w)},e.addHook=function($,p){typeof p=="function"&&(ve[$]=ve[$]||[],Ht(ve[$],p))},e.removeHook=function($){if(ve[$])return ha(ve[$])},e.removeHooks=function($){ve[$]&&(ve[$]=[])},e.removeAllHooks=function(){ve={}},e}var Vt=er(),M;(function(a){a.relevance="relevance",a.alltimeview="alltimeview",a.weeklyview="weeklyview",a.title="title",a.date="date",a.datearchived="datearchived",a.datereviewed="datereviewed",a.dateadded="dateadded",a.creator="creator"})(M||(M={}));const rt={relevance:"Relevance",alltimeview:"All-time views",weeklyview:"Weekly views",title:"Title",date:"Date published",datearchived:"Date archived",datereviewed:"Date reviewed",dateadded:"Date added",creator:"Creator"},fa={relevance:"desc",alltimeview:"desc",weeklyview:"desc",title:"asc",date:"desc",datearchived:"desc",datereviewed:"desc",dateadded:"desc",creator:"asc"},cn={relevance:null,alltimeview:"downloads",weeklyview:"week",title:"titleSorter",date:"date",datearchived:"publicdate",datereviewed:"reviewdate",dateadded:"addeddate",creator:"creatorSorter"};M.weeklyview,M.alltimeview,M.title,M.date,M.datearchived,M.datereviewed,M.dateadded,M.creator;const hn={week:"week",downloads:"downloads",titleSorter:"title",date:"date",publicdate:"publicdate",reviewdate:"reviewdate",addeddate:"addeddate",creatorSorter:"creator"},ga={week:M.weeklyview,downloads:M.alltimeview,title:M.title,titleSorter:M.title,date:M.date,publicdate:M.datearchived,reviewdate:M.datereviewed,addeddate:M.dateadded,creator:M.creator,creatorSorter:M.creator},pn={title:"firstTitle",creator:"firstCreator"},ti=()=>({subject:{},lending:{},mediatype:{},language:{},creator:{},collection:{},year:{}}),un=["mediatype","lending","year","subject","collection","creator","language"],$i={subject:"Subject",lending:"Availability",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"},po={subject:K.COUNT,lending:K.COUNT,mediatype:K.COUNT,language:K.COUNT,creator:K.COUNT,collection:K.COUNT,year:K.NUMERIC},vn={subject:K.ALPHABETICAL,lending:K.ALPHABETICAL,mediatype:K.ALPHABETICAL,language:K.ALPHABETICAL,creator:K.ALPHABETICAL,collection:K.ALPHABETICAL,year:K.NUMERIC},mn={is_lendable:!0,is_borrowable:!1,available_to_borrow:!0,is_browsable:!1,available_to_browse:!1,is_readable:!0,available_to_waitlist:!1},ba={is_lendable:"Lending Library",available_to_borrow:"Borrow 14 Days",is_readable:"Always Available"},ko={deemphasize:!0,community:!0,stream_only:!0,samples_only:!0,test_collection:!0,printdisabled:!0,"openlibrary-ol":!0,nationalemergencylibrary:!0,china:!0,americana:!0,toronto:!0};function tr(a){switch(a){case"publicdate":return"Archived";case"reviewdate":return"Reviewed";case"addeddate":return"Added";default:return"Published"}}function ir(a){return a?`Archivist since ${a.getFullYear()}`:""}let be=class extends D{constructor(){super(...arguments),this.sortParam=null,this.collectionLinks=[],this.loggedIn=!1}render(){return h`
    ...
    `}};s([c({type:Object})],Ve.prototype,"model",void 0);s([c({type:String})],Ve.prototype,"baseNavigationUrl",void 0);s([c({type:String})],Ve.prototype,"baseImageUrl",void 0);s([c({type:Boolean})],Ve.prototype,"loggedIn",void 0);s([c({type:Object})],Ve.prototype,"sortParam",void 0);s([c({type:Object})],Ve.prototype,"collectionNameCache",void 0);Ve=s([A("tile-hover-pane")],Ve);let ze=class extends D{constructor(){super(...arguments),this.sortParam=null,this.loggedIn=!1}render(){var e,t,i,o,r,n,l,d,u;return h`
      <div id="list-line" class="${this.classSize}">
        <image-block
          .model=${this.model}
          .baseImageUrl=${this.baseImageUrl}
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const xa=Ti(class extends zi{constructor(a){if(super(a),a.type!==Ae.PROPERTY&&a.type!==Ae.ATTRIBUTE&&a.type!==Ae.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!ts(a))throw Error("`live` bindings can only contain a single expression")}render(a){return a}update(a,[e]){if(e===ge||e===y)return e;const t=a.element,i=a.name;if(a.type===Ae.PROPERTY){if(e===t[i])return ge}else if(a.type===Ae.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(i))return ge}else if(a.type===Ae.ATTRIBUTE&&t.getAttribute(i)===e+"")return ge;return Qa(a),e}}),Cn=Object.freeze({processing:"processing",complete:"complete"});class $n extends D{static get properties(){return{mode:{type:String}}}constructor(){super(),this.mode=Cn.processing}render(){return h`
      <div class="${this.mode}">
        <svg
          viewBox="0 0 120 120"
