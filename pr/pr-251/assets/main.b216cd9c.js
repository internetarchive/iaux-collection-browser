...
`+ce),Se&&(ce=He(ce,Xe," "),ce=He(ce,Ye," ")),O&&ci?O.createHTML(ce):ce},e.setConfig=function(C){Ii(C),tt=!0},e.clearConfig=function(){_t=null,tt=!1},e.isValidAttribute=function(C,p,w){_t||Ii({});var $=ot(C),R=ot(p);return qo($,R,w)},e.addHook=function(C,p){typeof p=="function"&&(me[C]=me[C]||[],Wt(me[C],p))},e.removeHook=function(C){if(me[C])return fa(me[C])},e.removeHooks=function(C){me[C]&&(me[C]=[])},e.removeAllHooks=function(){me={}},e}var Gt=nr(),z;(function(a){a.relevance="relevance",a.alltimeview="alltimeview",a.weeklyview="weeklyview",a.title="title",a.date="date",a.datearchived="datearchived",a.datereviewed="datereviewed",a.dateadded="dateadded",a.creator="creator"})(z||(z={}));const nt={relevance:"Relevance",alltimeview:"All-time views",weeklyview:"Weekly views",title:"Title",date:"Date published",datearchived:"Date archived",datereviewed:"Date reviewed",dateadded:"Date added",creator:"Creator"},xa={relevance:"desc",alltimeview:"desc",weeklyview:"desc",title:"asc",date:"desc",datearchived:"desc",datereviewed:"desc",dateadded:"desc",creator:"asc"},fn={relevance:null,alltimeview:"downloads",weeklyview:"week",title:"titleSorter",date:"date",datearchived:"publicdate",datereviewed:"reviewdate",dateadded:"addeddate",creator:"creatorSorter"};z.weeklyview,z.alltimeview,z.title,z.date,z.datearchived,z.datereviewed,z.dateadded,z.creator;const gn={week:"week",downloads:"downloads",titleSorter:"title",date:"date",publicdate:"publicdate",reviewdate:"reviewdate",addeddate:"addeddate",creatorSorter:"creator"},_a={week:z.weeklyview,downloads:z.alltimeview,title:z.title,titleSorter:z.title,date:z.date,publicdate:z.datearchived,reviewdate:z.datereviewed,addeddate:z.dateadded,creator:z.creator,creatorSorter:z.creator},bn={title:"firstTitle",creator:"firstCreator"},ai=()=>({subject:{},lending:{},mediatype:{},language:{},creator:{},collection:{},year:{}}),yn=["mediatype","lending","year","subject","collection","creator","language"],zi={subject:"Subject",lending:"Availability",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"},fo={subject:Q.COUNT,lending:Q.COUNT,mediatype:Q.COUNT,language:Q.COUNT,creator:Q.COUNT,collection:Q.COUNT,year:Q.NUMERIC},wn={subject:Q.ALPHABETICAL,lending:Q.ALPHABETICAL,mediatype:Q.ALPHABETICAL,language:Q.ALPHABETICAL,creator:Q.ALPHABETICAL,collection:Q.ALPHABETICAL,year:Q.NUMERIC},xn={is_lendable:!0,is_borrowable:!1,available_to_borrow:!0,is_browsable:!1,available_to_browse:!1,is_readable:!0,available_to_waitlist:!1},$a={is_lendable:"Lending Library",available_to_borrow:"Borrow 14 Days",is_readable:"Always Available"},Eo={deemphasize:!0,community:!0,stream_only:!0,samples_only:!0,test_collection:!0,printdisabled:!0,"openlibrary-ol":!0,nationalemergencylibrary:!0,china:!0,americana:!0,toronto:!0};function lr(a){switch(a){case"publicdate":return"Archived";case"reviewdate":return"Reviewed";case"addeddate":return"Added";default:return"Published"}}function dr(a){return a?`Archivist since ${a.getFullYear()}`:""}let be=class extends D{constructor(){super(...arguments),this.sortParam=null,this.collectionLinks=[],this.loggedIn=!1}render(){return h`
  ...
  `;bo=s([P("ia-icon-label")],bo);let yo=class extends D{constructor(){super(...arguments),this.numResults=0}render(){return h`
    ...
    `}};s([c({type:Number})],yo.prototype,"numResults",void 0);yo=s([P("alpha-bar-tooltip")],yo);let Ie=class extends D{constructor(){super(...arguments),this.selectedLetter=null,this.tooltipShown=!1,this.alphabet="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("")}get selectedUppercaseLetter(){var e;return(e=this.selectedLetter)===null||e===void 0?void 0:e.toUpperCase()}render(){var e;return h`
  ...
  `;s([c({type:String})],Ie.prototype,"selectedLetter",void 0);s([c({type:Object})],Ie.prototype,"letterCounts",void 0);s([c({type:String})],Ie.prototype,"ariaLandmarkLabel",void 0);s([k()],Ie.prototype,"tooltipShown",void 0);s([k()],Ie.prototype,"hoveredLetter",void 0);s([K("alpha-bar-tooltip")],Ie.prototype,"tooltip",void 0);Ie=s([P("alpha-bar")],Ie);const $n=h`
...
`;let xo=class extends D{constructor(){super(...arguments),this.config=new wo}render(){return h`
    ...
    `}static get styles(){const e=m`var(--modalLogoSize, 6.5rem)`,t=m`var(--processingImageSize, 7.5rem)`,i=m`var(--modalCornerRadius, 1rem)`,o=m`var(--modalBorder, 2px solid black)`,r=m`var(--modalBottomMargin, 2.5rem)`,n=m`var(--modalTopMargin, 5rem)`,l=m`var(--modalHeaderBottomPadding, 0.5em)`,d=m`var(--modalBottomPadding, 2rem)`,u=m`var(--modalScrollOffset, 5px)`,v=m`var(--modalTitleFontSize, 1.8rem)`,f=m`var(--modalSubtitleFontSize, 1.4rem)`,b=m`var(--modalHeadlineFontSize, 1.6rem)`,x=m`var(--modalMessageFontSize, 1.4rem)`,_=m`var(--modalTitleLineHeight, normal)`,M=m`var(--modalSubtitleLineHeight, normal)`,L=m`var(--modalHeadlineLineHeight, normal)`,I=m`var(--modalMessageLineHeight, normal)`;return m`
      .processing-logo {
        margin: auto;
        width: ${t};
        height: ${t};
    ...
    `}};s([c({type:Object})],xo.prototype,"config",void 0);xo=s([P("modal-template")],xo);function ol(a,e,t){var i=t||{},o=i.noTrailing,r=o===void 0?!1:o,n=i.noLeading,l=n===void 0?!1:n,d=i.debounceMode,u=d===void 0?void 0:d,v,f=!1,b=0;function x(){v&&clearTimeout(v)}function _(L){var I=L||{},V=I.upcomingOnly,te=V===void 0?!1:V;x(),f=!te}function M(){for(var L=arguments.length,I=new Array(L),V=0;V<L;V++)I[V]=arguments[V];var te=this,O=Date.now()-b;if(f)return;function X(){b=Date.now(),e.apply(te,I)}function J(){v=void 0}!l&&u&&!v&&X(),x(),u===void 0&&O>a?l?(b=Date.now(),r||(v=setTimeout(u?J:X,a))):X():r!==!0&&(v=setTimeout(u?J:X,u===void 0?a-O:a))}return M.cancel=_,M}var dt;(function(a){a.Open="open",a.Closed="closed"})(dt||(dt={}));class al{constructor(e){this.windowResizeThrottler=ol(100,this.updateModalContainerHeight,{noLeading:!1,noTrailing:!1}).bind(this),this.modalManager=e}handleModeChange(e){switch(e){case dt.Open:this.startResizeListener(),this.stopDocumentScroll();break;case dt.Closed:this.stopResizeListener(),this.resumeDocumentScroll();break}}updateModalContainerHeight(){this.modalManager.style.setProperty("--containerHeight",`${window.innerHeight}px`)}stopDocumentScroll(){document.body.classList.add("modal-manager-open")}resumeDocumentScroll(){document.body.classList.remove("modal-manager-open")}startResizeListener(){window.addEventListener("resize",this.windowResizeThrottler)}stopResizeListener(){window.removeEventListener("resize",this.windowResizeThrottler)}}let Et=class extends D{constructor(){super(...arguments),this.mode=dt.Closed,this.hostBridge=new al(this),this.closeOnBackdropClick=!0}render(){return h`
      <div class="container">
