(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))s(r);new MutationObserver(r=>{for(const o of r)if(o.type==="childList")for(const a of o.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&s(a)}).observe(document,{childList:!0,subtree:!0});function t(r){const o={};return r.integrity&&(o.integrity=r.integrity),r.referrerPolicy&&(o.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?o.credentials="include":r.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function s(r){if(r.ep)return;r.ep=!0;const o=t(r);fetch(r.href,o)}})();class W0{constructor(e){var t,s,r,o;this.ARCHIVE_ANALYTICS_VERSION=2,this.DEFAULT_SERVICE="ao_2",this.NO_SAMPLING_SERVICE="ao_no_sampling",this.DEFAULT_IMAGE_URL="https://athena.archive.org/0.gif",this.defaultService=(t=e==null?void 0:e.defaultService)!==null&&t!==void 0?t:this.DEFAULT_SERVICE,this.imageUrl=(s=e==null?void 0:e.imageUrl)!==null&&s!==void 0?s:this.DEFAULT_IMAGE_URL,this.imageContainer=(r=e==null?void 0:e.imageContainer)!==null&&r!==void 0?r:document.body,this.requireImagePing=(o=e==null?void 0:e.requireImagePing)!==null&&o!==void 0?o:!1}sendPing(e){const t=this.generateTrackingUrl(e).toString();if(this.requireImagePing){this.sendPingViaImage(t);return}const s=navigator.sendBeacon&&navigator.sendBeacon.bind(navigator);try{s(t)}catch{this.sendPingViaImage(t)}}sendEvent(e){const t=e.label&&e.label.trim().length>0?e.label:window.location.pathname,s={kind:"event",ec:e.category,ea:e.action,el:t,cache_bust:Math.random(),...e.eventConfiguration};this.sendPing(s)}sendEventNoSampling(e){const t=e.eventConfiguration||{};t.service=this.NO_SAMPLING_SERVICE;const s=e;s.eventConfiguration=t,this.sendEvent(s)}sendPingViaImage(e){const t=new Image(1,1);t.src=e,t.alt="",this.imageContainer.appendChild(t)}generateTrackingUrl(e){var t;const s=e??{};s.service=(t=s.service)!==null&&t!==void 0?t:this.defaultService;const r=new URL(this.imageUrl),o=Object.keys(s);return o.forEach(a=>{const l=s[a];r.searchParams.append(a,l)}),r.searchParams.append("version",`${this.ARCHIVE_ANALYTICS_VERSION}`),r.searchParams.append("count",`${o.length+2}`),r}}function p(i,e,t,s){var r=arguments.length,o=r<3?e:s===null?s=Object.getOwnPropertyDescriptor(e,t):s,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(i,e,t,s);else for(var l=i.length-1;l>=0;l--)(a=i[l])&&(o=(r<3?a(o):r>3?a(e,t,o):a(e,t))||o);return r>3&&o&&Object.defineProperty(e,t,o),o}function _(i){let e,t,s;return typeof i=="object"?(e=i.hashFunction,t=i.expiring,s=i.tags):e=i,(r,o,a)=>{if(a.value!=null)a.value=_c(a.value,e,t,s);else if(a.get!=null)a.get=_c(a.get,e,t,s);else throw"Only put a Memoize() decorator on a method or get accessor."}}const Ta=new Map;function _c(i,e,t=0,s){const r=Symbol("__memoized_map__");return function(...o){let a;this.hasOwnProperty(r)||Object.defineProperty(this,r,{configurable:!1,enumerable:!1,writable:!1,value:new Map});let l=this[r];if(Array.isArray(s))for(const n of s)Ta.has(n)?Ta.get(n).push(l):Ta.set(n,[l]);if(e||o.length>0||t>0){let n;e===!0?n=o.map(d=>d.toString()).join("!"):e?n=e.apply(this,o):n=o[0];const c=`${n}__timestamp`;let h=!1;if(t>0)if(!l.has(c))h=!0;else{let d=l.get(c);h=Date.now()-d>t}l.has(n)&&!h?a=l.get(n):(a=i.apply(this,o),l.set(n,a),t>0&&l.set(c,Date.now()))}else{const n=this;l.has(n)?a=l.get(n):(a=i.apply(this,o),l.set(n,a))}return a}}class Pn{parseValue(e){return typeof e=="string"&&(e==="false"||e==="0")?!1:!!e}}Pn.shared=new Pn;class Rt{parseValue(e){if(typeof e=="number")return e;if(typeof e=="boolean")return;const t=parseFloat(e);if(!Number.isNaN(t))return t}}Rt.shared=new Rt;class So{parseValue(e){return Rt.shared.parseValue(e)}}So.shared=new So;class Cr{parseValue(e){return this.parseJSDate(e)||this.parseBracketDate(e)}parseBracketDate(e){if(typeof e!="string")return;const t=e.match(/\[([0-9]{4})\]/);if(!(!t||t.length<2))return this.parseJSDate(t[1])}parseJSDate(e){if(typeof e!="string")return;let t=e;t.match(/^[0-9]{4}-[0-9]{2}-[0-9]{2}\s{1}[0-9]{2}:[0-9]{2}:[0-9]{2}$/)&&(t=t.replace(" ","T"));const s=Date.parse(t);if(Number.isNaN(s))return;let r=new Date(t);return(t.match(/^[0-9]{4}$/)||t.match(/^[0-9]{4}-[0-9]{2}-[0-9]{2}$/))&&(r=new Date(r.getTime()+r.getTimezoneOffset()*1e3*60)),r}}Cr.shared=new Cr;class Co{parseValue(e){if(typeof e=="number")return e;if(typeof e=="boolean")return;const t=e.split(":");let s;return t.length===1?s=this.parseNumberFormat(t[0]):s=this.parseColonSeparatedFormat(t),s}parseNumberFormat(e){let t=parseFloat(e);return Number.isNaN(t)&&(t=void 0),t}parseColonSeparatedFormat(e){let t=!1;const s=e.map((r,o)=>{const a=parseFloat(r);if(Number.isNaN(a))return t=!0,0;const n=60**(e.length-1-o);return a*Math.floor(n)}).reduce((r,o)=>r+o,0);return t?void 0:s}}Co.shared=new Co;class On{parseValue(e){if(typeof e=="string")return e}}On.shared=new On;class q0{constructor(e,t){this.separators=[";",","],this.parser=e,t&&t.separators&&(this.separators=t.separators)}parseValue(e){const t=String(e);let s=[];for(const r of this.separators)if(s=t.split(r),s.length>1)break;return this.parseListValues(s)}parseListValues(e){const s=e.map(o=>o.trim()).map(o=>this.parser.parseValue(o)),r=[];return s.forEach(o=>{o!==void 0&&r.push(o)}),r}}class Dn{parseValue(e){if(typeof e=="string")return e}}Dn.shared=new Dn;class To{parseValue(e){return String(e)}}To.shared=new To;class zs{get name(){return this.rawValue.name}get source(){return this.rawValue.source}get btih(){return this.rawValue.btih}get md5(){return this.rawValue.md5}get format(){return this.rawValue.format}get mtime(){if(this.rawValue.mtime==null)return;const e=Rt.shared.parseValue(this.rawValue.mtime);if(e)return new Date(e*1e3)}get crc32(){return this.rawValue.crc32}get sha1(){return this.rawValue.sha1}get original(){return this.rawValue.original}get size(){return this.rawValue.size!=null?So.shared.parseValue(this.rawValue.size):void 0}get title(){return this.rawValue.title}get length(){return this.rawValue.length!=null?Co.shared.parseValue(this.rawValue.length):void 0}get height(){return this.rawValue.height!=null?Rt.shared.parseValue(this.rawValue.height):void 0}get width(){return this.rawValue.width!=null?Rt.shared.parseValue(this.rawValue.width):void 0}get track(){return this.rawValue.track!=null?Rt.shared.parseValue(this.rawValue.track):void 0}get external_identifier(){return this.rawValue.external_identifier}get creator(){return this.rawValue.creator}get album(){return this.rawValue.album}constructor(e={}){this.rawValue=e}}p([_()],zs.prototype,"mtime",null);p([_()],zs.prototype,"size",null);p([_()],zs.prototype,"length",null);p([_()],zs.prototype,"height",null);p([_()],zs.prototype,"width",null);p([_()],zs.prototype,"track",null);class bt{get values(){return this.parseRawValue()}get value(){return this.values[0]}constructor(e,t){this.parser=e,this.rawValue=t}parseRawValue(){const e=Array.isArray(this.rawValue)?this.rawValue:[this.rawValue],t=[];return e.forEach(s=>{const r=this.parser.parseValue(s);Array.isArray(r)?t.push(...r):r!==void 0&&t.push(r)}),t}}p([_()],bt.prototype,"values",null);p([_()],bt.prototype,"value",null);class Bi extends bt{constructor(e){super(Pn.shared,e)}}class et extends bt{constructor(e){super(Cr.shared,e)}}class Aa extends bt{constructor(e){super(Co.shared,e)}}class Ee extends bt{constructor(e){super(Rt.shared,e)}}class F extends bt{constructor(e){super(To.shared,e)}}class G0 extends bt{constructor(e){super(Dn.shared,e)}}class Sc extends bt{constructor(e){super(So.shared,e)}}class zd extends bt{constructor(e){super(On.shared,e)}}class Y0 extends bt{constructor(e,t){super(t,e)}}class Q0 extends Y0{constructor(e){const t=new q0(To.shared);super(e,t)}}class M{get identifier(){return this.rawMetadata.identifier}get addeddate(){return this.rawMetadata.addeddate!=null?new et(this.rawMetadata.addeddate):void 0}get audio_codec(){return this.rawMetadata.audio_codec!=null?new F(this.rawMetadata.audio_codec):void 0}get audio_sample_rate(){return this.rawMetadata.audio_sample_rate!=null?new Ee(this.rawMetadata.audio_sample_rate):void 0}get avg_rating(){return this.rawMetadata.avg_rating!=null?new Ee(this.rawMetadata.avg_rating):void 0}get collection(){return this.rawMetadata.collection!=null?new F(this.rawMetadata.collection):void 0}get collections_raw(){return this.rawMetadata.collections_raw!=null?new F(this.rawMetadata.collections_raw):void 0}get collection_size(){return this.rawMetadata.collection_size!=null?new Sc(this.rawMetadata.collection_size):void 0}get contact(){return this.rawMetadata.contact!=null?new F(this.rawMetadata.contact):void 0}get contributor(){return this.rawMetadata.contributor!=null?new F(this.rawMetadata.contributor):void 0}get coverage(){return this.rawMetadata.coverage!=null?new F(this.rawMetadata.coverage):void 0}get creator(){return this.rawMetadata.creator!=null?new F(this.rawMetadata.creator):void 0}get creator_alt_script(){return this.rawMetadata["creator-alt-script"]!=null?new F(this.rawMetadata["creator-alt-script"]):void 0}get credits(){return this.rawMetadata.credits!=null?new F(this.rawMetadata.credits):void 0}get collection_layout(){return this.rawMetadata.collection_layout!=null?new F(this.rawMetadata.collection_layout):void 0}get date(){return this.rawMetadata.date!=null?new et(this.rawMetadata.date):void 0}get description(){return this.rawMetadata.description!=null?new F(this.rawMetadata.description):void 0}get downloads(){return this.rawMetadata.downloads!=null?new Ee(this.rawMetadata.downloads):void 0}get duration(){return this.rawMetadata.duration!=null?new Aa(this.rawMetadata.duration):void 0}get external_identifier(){return this.rawMetadata["external-identifier"]!=null?new F(this.rawMetadata["external-identifier"]):void 0}get external_link(){return this.rawMetadata["external-link"]!=null?new F(this.rawMetadata["external-link"]):void 0}get files_count(){return this.rawMetadata.files_count!=null?new Ee(this.rawMetadata.files_count):void 0}get indexdate(){return this.rawMetadata.indexdate!=null?new et(this.rawMetadata.indexdate):void 0}get isbn(){return this.rawMetadata.isbn!=null?new F(this.rawMetadata.isbn):void 0}get issue(){return this.rawMetadata.issue!=null?new F(this.rawMetadata.issue):void 0}get item_count(){return this.rawMetadata.item_count!=null?new Ee(this.rawMetadata.item_count):void 0}get item_size(){return this.rawMetadata.item_size!=null?new Sc(this.rawMetadata.item_size):void 0}get language(){return this.rawMetadata.language!=null?new F(this.rawMetadata.language):void 0}get length(){return this.rawMetadata.length!=null?new Aa(this.rawMetadata.length):void 0}get licenseurl(){return this.rawMetadata.licenseurl!=null?new F(this.rawMetadata.licenseurl):void 0}get lineage(){return this.rawMetadata.lineage!=null?new F(this.rawMetadata.lineage):void 0}get month(){return this.rawMetadata.month!=null?new Ee(this.rawMetadata.month):void 0}get mediatype(){return this.rawMetadata.mediatype!=null?new zd(this.rawMetadata.mediatype):void 0}get noindex(){return this.rawMetadata.noindex!=null?new Bi(this.rawMetadata.noindex):void 0}get notes(){return this.rawMetadata.notes!=null?new F(this.rawMetadata.notes):void 0}get num_favorites(){return this.rawMetadata.num_favorites!=null?new Ee(this.rawMetadata.num_favorites):void 0}get num_reviews(){return this.rawMetadata.num_reviews!=null?new Ee(this.rawMetadata.num_reviews):void 0}get openlibrary_edition(){return this.rawMetadata.openlibrary_edition!=null?new F(this.rawMetadata.openlibrary_edition):void 0}get openlibrary_work(){return this.rawMetadata.openlibrary_work!=null?new F(this.rawMetadata.openlibrary_work):void 0}get page_progression(){return this.rawMetadata.page_progression!=null?new G0(this.rawMetadata.page_progression):void 0}get paginated(){return this.rawMetadata.paginated!=null?new Bi(this.rawMetadata.paginated):void 0}get partner(){return this.rawMetadata.partner!=null?new F(this.rawMetadata.partner):void 0}get post_text(){return this.rawMetadata.post_text!=null?new F(this.rawMetadata.post_text):void 0}get ppi(){return this.rawMetadata.ppi!=null?new Ee(this.rawMetadata.ppi):void 0}get publicdate(){return this.rawMetadata.publicdate!=null?new et(this.rawMetadata.publicdate):void 0}get publisher(){return this.rawMetadata.publisher!=null?new F(this.rawMetadata.publisher):void 0}get reviewdate(){return this.rawMetadata.reviewdate!=null?new et(this.rawMetadata.reviewdate):void 0}get rights(){return this.rawMetadata.rights!=null?new F(this.rawMetadata.rights):void 0}get rights_holder(){var e;const t=(e=this.rawMetadata["rights-holder"])!==null&&e!==void 0?e:this.rawMetadata.rights_holder;return t!=null?new F(t):void 0}get runtime(){return this.rawMetadata.runtime!=null?new Aa(this.rawMetadata.runtime):void 0}get scanner(){return this.rawMetadata.scanner!=null?new F(this.rawMetadata.scanner):void 0}get segments(){return this.rawMetadata.segments!=null?new F(this.rawMetadata.segments):void 0}get shotlist(){return this.rawMetadata.shotlist!=null?new F(this.rawMetadata.shotlist):void 0}get source(){return this.rawMetadata.source!=null?new F(this.rawMetadata.source):void 0}get sponsor(){return this.rawMetadata.sponsor!=null?new F(this.rawMetadata.sponsor):void 0}get start_localtime(){return this.rawMetadata.start_localtime!=null?new et(this.rawMetadata.start_localtime):void 0}get start_time(){return this.rawMetadata.start_time!=null?new et(this.rawMetadata.start_time):void 0}get stop_time(){return this.rawMetadata.stop_time!=null?new et(this.rawMetadata.stop_time):void 0}get subject(){return this.rawMetadata.subject!=null?new Q0(this.rawMetadata.subject):void 0}get taper(){return this.rawMetadata.taper!=null?new F(this.rawMetadata.taper):void 0}get title(){return this.rawMetadata.title!=null?new F(this.rawMetadata.title):void 0}get title_alt_script(){return this.rawMetadata["title-alt-script"]!=null?new F(this.rawMetadata["title-alt-script"]):void 0}get transferer(){return this.rawMetadata.transferer!=null?new F(this.rawMetadata.transferer):void 0}get track(){return this.rawMetadata.track!=null?new Ee(this.rawMetadata.track):void 0}get type(){return this.rawMetadata.type!=null?new F(this.rawMetadata.type):void 0}get uploader(){return this.rawMetadata.uploader!=null?new F(this.rawMetadata.uploader):void 0}get utc_offset(){return this.rawMetadata.utc_offset!=null?new Ee(this.rawMetadata.utc_offset):void 0}get venue(){return this.rawMetadata.venue!=null?new F(this.rawMetadata.venue):void 0}get volume(){return this.rawMetadata.volume!=null?new F(this.rawMetadata.volume):void 0}get week(){return this.rawMetadata.week!=null?new Ee(this.rawMetadata.week):void 0}get year(){return this.rawMetadata.year!=null?new Ee(this.rawMetadata.year):void 0}constructor(e={}){this.rawMetadata=e}}p([_()],M.prototype,"addeddate",null);p([_()],M.prototype,"audio_codec",null);p([_()],M.prototype,"audio_sample_rate",null);p([_()],M.prototype,"avg_rating",null);p([_()],M.prototype,"collection",null);p([_()],M.prototype,"collections_raw",null);p([_()],M.prototype,"collection_size",null);p([_()],M.prototype,"contact",null);p([_()],M.prototype,"contributor",null);p([_()],M.prototype,"coverage",null);p([_()],M.prototype,"creator",null);p([_()],M.prototype,"creator_alt_script",null);p([_()],M.prototype,"credits",null);p([_()],M.prototype,"collection_layout",null);p([_()],M.prototype,"date",null);p([_()],M.prototype,"description",null);p([_()],M.prototype,"downloads",null);p([_()],M.prototype,"duration",null);p([_()],M.prototype,"external_identifier",null);p([_()],M.prototype,"external_link",null);p([_()],M.prototype,"files_count",null);p([_()],M.prototype,"indexdate",null);p([_()],M.prototype,"isbn",null);p([_()],M.prototype,"issue",null);p([_()],M.prototype,"item_count",null);p([_()],M.prototype,"item_size",null);p([_()],M.prototype,"language",null);p([_()],M.prototype,"length",null);p([_()],M.prototype,"licenseurl",null);p([_()],M.prototype,"lineage",null);p([_()],M.prototype,"month",null);p([_()],M.prototype,"mediatype",null);p([_()],M.prototype,"noindex",null);p([_()],M.prototype,"notes",null);p([_()],M.prototype,"num_favorites",null);p([_()],M.prototype,"num_reviews",null);p([_()],M.prototype,"openlibrary_edition",null);p([_()],M.prototype,"openlibrary_work",null);p([_()],M.prototype,"page_progression",null);p([_()],M.prototype,"paginated",null);p([_()],M.prototype,"partner",null);p([_()],M.prototype,"post_text",null);p([_()],M.prototype,"ppi",null);p([_()],M.prototype,"publicdate",null);p([_()],M.prototype,"publisher",null);p([_()],M.prototype,"reviewdate",null);p([_()],M.prototype,"rights",null);p([_()],M.prototype,"rights_holder",null);p([_()],M.prototype,"runtime",null);p([_()],M.prototype,"scanner",null);p([_()],M.prototype,"segments",null);p([_()],M.prototype,"shotlist",null);p([_()],M.prototype,"source",null);p([_()],M.prototype,"sponsor",null);p([_()],M.prototype,"start_localtime",null);p([_()],M.prototype,"start_time",null);p([_()],M.prototype,"stop_time",null);p([_()],M.prototype,"subject",null);p([_()],M.prototype,"taper",null);p([_()],M.prototype,"title",null);p([_()],M.prototype,"title_alt_script",null);p([_()],M.prototype,"transferer",null);p([_()],M.prototype,"track",null);p([_()],M.prototype,"type",null);p([_()],M.prototype,"uploader",null);p([_()],M.prototype,"utc_offset",null);p([_()],M.prototype,"venue",null);p([_()],M.prototype,"volume",null);p([_()],M.prototype,"week",null);p([_()],M.prototype,"year",null);class Xo{get reviewbody(){return this.rawValue.reviewbody}get reviewtitle(){return this.rawValue.reviewtitle}get reviewer(){return this.rawValue.reviewer}get reviewer_itemname(){return this.rawValue.reviewer_itemname}get reviewdate(){return this.rawValue.reviewdate!=null?Cr.shared.parseValue(this.rawValue.reviewdate):void 0}get createdate(){return this.rawValue.createdate!=null?Cr.shared.parseValue(this.rawValue.createdate):void 0}get stars(){return this.rawValue.stars!=null?Rt.shared.parseValue(this.rawValue.stars):void 0}constructor(e={}){this.rawValue=e}}p([_()],Xo.prototype,"reviewdate",null);p([_()],Xo.prototype,"createdate",null);p([_()],Xo.prototype,"stars",null);class ml extends Xo{get reviewer_account_status(){var e;return(e=this.account_status)===null||e===void 0?void 0:e.status}get reviewer_account_status_reason(){var e;return(e=this.account_status)===null||e===void 0?void 0:e.reason}get __href__(){return this.rawValue.__href__}get account_status(){const e=this.rawValue.reviewer_account_status;if(!e)return;let t="unknown",s;e.startsWith("ok")&&(t="ok"),e.startsWith("locked")&&(t="locked");const r=e.split("__");return r.length>1&&(s=r.slice(1).join("__")),{status:t,reason:s}}}p([_()],ml.prototype,"account_status",null);const K0=["loans","waitlist","loan_history"];function X0(i){const e=i.slice(0,4),t=i.slice(4,6),s=i.slice(6,8),r=i.slice(8,10),o=i.slice(10,12),a=i.slice(12,14);return`${e}-${t}-${s}T${r}:${o}:${a}Z`}function Z0(i){var e;const t=[];for(const s of i){if(!(!((e=s.captures)===null||e===void 0)&&e.length))continue;const r=encodeURIComponent(s.url),o=`https://web.archive.org/web/${s.captures[0]}/${r}`;t.push({hit_type:"web_archive",fields:{url:s.url,capture_dates:s.captures.map(a=>X0(a)),__href__:o}})}return t}class ye extends M{get created_on(){return this.rawMetadata.created_on!=null?new et(this.rawMetadata.created_on):void 0}get file_creation_mtime(){return this.rawMetadata.file_creation_mtime!=null?new Ee(this.rawMetadata.file_creation_mtime):void 0}get filename(){return this.rawMetadata.filename!=null?new F(this.rawMetadata.filename):void 0}get file_basename(){return this.rawMetadata.file_basename!=null?new F(this.rawMetadata.file_basename):void 0}get result_in_subfile(){return this.rawMetadata.result_in_subfile!=null?new Bi(this.rawMetadata.result_in_subfile):void 0}get query(){return this.rawMetadata.query!=null?new F(this.rawMetadata.query):void 0}get date_favorited(){return this.rawMetadata.date_favorited!=null?new et(this.rawMetadata.date_favorited):void 0}get updated_on(){return this.rawMetadata.updated_on!=null?new et(this.rawMetadata.updated_on):void 0}get ad_id(){return this.rawMetadata.ad_id!=null?new F(this.rawMetadata.ad_id):void 0}get factcheck(){return this.rawMetadata.factcheck!=null?new F(this.rawMetadata.factcheck):void 0}get is_clip(){return this.rawMetadata.clip!=null?new Bi(this.rawMetadata.clip):void 0}get num_clips(){return this.rawMetadata.nclips!=null?new Ee(this.rawMetadata.nclips):void 0}get __href__(){return this.rawMetadata.__href__!=null?new F(this.rawMetadata.__href__):void 0}get __img__(){return this.rawMetadata.__img__!=null?new F(this.rawMetadata.__img__):void 0}}p([_()],ye.prototype,"created_on",null);p([_()],ye.prototype,"file_creation_mtime",null);p([_()],ye.prototype,"filename",null);p([_()],ye.prototype,"file_basename",null);p([_()],ye.prototype,"result_in_subfile",null);p([_()],ye.prototype,"query",null);p([_()],ye.prototype,"date_favorited",null);p([_()],ye.prototype,"updated_on",null);p([_()],ye.prototype,"ad_id",null);p([_()],ye.prototype,"factcheck",null);p([_()],ye.prototype,"is_clip",null);p([_()],ye.prototype,"num_clips",null);p([_()],ye.prototype,"__href__",null);p([_()],ye.prototype,"__img__",null);class ft{constructor(e){var t;this.rawMetadata=e,this.fields=new ye((t=e.fields)!==null&&t!==void 0?t:{})}get identifier(){return this.fields.identifier}get addeddate(){return this.fields.addeddate}get avg_rating(){return this.fields.avg_rating}get collection(){return this.fields.collection}get collection_files_count(){var e;return((e=this.rawMetadata.fields)===null||e===void 0?void 0:e.collection_files_count)!=null?new Ee(this.rawMetadata.fields.collection_files_count):void 0}get collection_size(){return this.fields.collection_size}get creator(){return this.fields.creator}get date(){return this.fields.date}get description(){return this.fields.description}get downloads(){return this.fields.downloads}get files_count(){return this.fields.files_count}get genre(){var e;return((e=this.rawMetadata.fields)===null||e===void 0?void 0:e.genre)!=null?new F(this.rawMetadata.fields.genre):void 0}get indexflag(){var e;return((e=this.rawMetadata.fields)===null||e===void 0?void 0:e.indexflag)!=null?new F(this.rawMetadata.fields.indexflag):void 0}get issue(){return this.fields.issue}get item_count(){return this.fields.item_count}get item_size(){return this.fields.item_size}get language(){return this.fields.language}get lending___available_to_borrow(){var e;return((e=this.rawMetadata.fields)===null||e===void 0?void 0:e.lending___available_to_borrow)!=null?new Bi(this.rawMetadata.fields.lending___available_to_borrow):void 0}get lending___available_to_browse(){var e;return((e=this.rawMetadata.fields)===null||e===void 0?void 0:e.lending___available_to_browse)!=null?new Bi(this.rawMetadata.fields.lending___available_to_browse):void 0}get lending___available_to_waitlist(){var e;return((e=this.rawMetadata.fields)===null||e===void 0?void 0:e.lending___available_to_waitlist)!=null?new Bi(this.rawMetadata.fields.lending___available_to_waitlist):void 0}get lending___status(){var e;return((e=this.rawMetadata.fields)===null||e===void 0?void 0:e.lending___status)!=null?new F(this.rawMetadata.fields.lending___status):void 0}get licenseurl(){var e;return((e=this.rawMetadata.fields)===null||e===void 0?void 0:e.licenseurl)!=null?new F(this.rawMetadata.fields.licenseurl):void 0}get mediatype(){return this.fields.mediatype}get month(){return this.fields.month}get noindex(){return this.fields.noindex}get num_favorites(){return this.fields.num_favorites}get num_reviews(){return this.fields.num_reviews}get publicdate(){return this.fields.publicdate}get reviewdate(){return this.fields.reviewdate}get review(){const e=this.rawMetadata.review;return e?new ml(e):void 0}get source(){return this.fields.source}get subject(){return this.fields.subject}get title(){return this.fields.title}get type(){return this.fields.type}get volume(){return this.fields.volume}get week(){return this.fields.week}get year(){return this.fields.year}}p([_()],ft.prototype,"collection_files_count",null);p([_()],ft.prototype,"genre",null);p([_()],ft.prototype,"indexflag",null);p([_()],ft.prototype,"lending___available_to_borrow",null);p([_()],ft.prototype,"lending___available_to_browse",null);p([_()],ft.prototype,"lending___available_to_waitlist",null);p([_()],ft.prototype,"lending___status",null);p([_()],ft.prototype,"licenseurl",null);p([_()],ft.prototype,"review",null);class gl{constructor(e){var t;this.rawMetadata=e,this.fields=new ye((t=e.fields)!==null&&t!==void 0?t:{})}get identifier(){return this.fields.identifier}get highlight(){var e;return!((e=this.rawMetadata.highlight)===null||e===void 0)&&e.text?new F(this.rawMetadata.highlight.text):void 0}get addeddate(){return this.fields.addeddate}get avg_rating(){return this.fields.avg_rating}get collection(){return this.fields.collection}get created_on(){return this.fields.created_on}get creator(){return this.fields.creator}get date(){return this.fields.date}get description(){return this.fields.description}get downloads(){return this.fields.downloads}get filename(){return this.fields.filename}get file_basename(){return this.fields.file_basename}get file_creation_mtime(){return this.fields.file_creation_mtime}get issue(){return this.fields.issue}get mediatype(){return this.fields.mediatype}get page_num(){var e;return((e=this.rawMetadata.fields)===null||e===void 0?void 0:e.page_num)!=null?new Ee(this.rawMetadata.fields.page_num):void 0}get publicdate(){return this.fields.publicdate}get result_in_subfile(){return this.fields.result_in_subfile}get reviewdate(){return this.fields.reviewdate}get source(){return this.fields.source}get subject(){return this.fields.subject}get title(){return this.fields.title}get updated_on(){return this.fields.updated_on}get year(){return this.fields.year}get __href__(){return this.fields.__href__}}p([_()],gl.prototype,"highlight",null);p([_()],gl.prototype,"page_num",null);var V;(function(i){i[i.COUNT=0]="COUNT",i[i.ALPHABETICAL=1]="ALPHABETICAL",i[i.NUMERIC=2]="NUMERIC"})(V||(V={}));class Id{constructor(e){this.buckets=e.buckets,this.first_bucket_key=e.first_bucket_key,this.last_bucket_key=e.last_bucket_key,this.number_buckets=e.number_buckets,this.interval=e.interval,this.first_bucket_year=e.first_bucket_year,this.first_bucket_month=e.first_bucket_month,this.last_bucket_year=e.last_bucket_year,this.last_bucket_month=e.last_bucket_month,this.interval_in_months=e.interval_in_months}getSortedBuckets(e){const t=[...this.buckets];if(this.isRawNumberBuckets(t))return t;const s=new Intl.Collator;switch(e){case V.ALPHABETICAL:return t.sort((r,o)=>s.compare(r.key.toString(),o.key.toString()));case V.NUMERIC:return t.sort((r,o)=>Number(o.key)-Number(r.key));case V.COUNT:default:return t}}isRawNumberBuckets(e){return typeof e[0]=="number"}}p([_()],Id.prototype,"getSortedBuckets",null);class J0{constructor(e){var t;this.rawMetadata=e,this.fields=new ye((t=e.fields)!==null&&t!==void 0?t:{})}get identifier(){var e;return(e=this.fields.query)===null||e===void 0?void 0:e.value}get title(){return this.fields.title}get query(){return this.fields.query}get date_favorited(){return this.fields.date_favorited}get __href__(){return this.fields.__href__}}class vl{constructor(e){var t;this.rawMetadata=e,this.fields=new ye((t=e.fields)!==null&&t!==void 0?t:{})}get identifier(){var e;return(e=this.rawMetadata.fields)===null||e===void 0?void 0:e.url}get mediatype(){return new zd("web")}get title(){var e,t;return!((e=this.rawMetadata.fields)===null||e===void 0)&&e.url?new F((t=this.rawMetadata.fields)===null||t===void 0?void 0:t.url):void 0}get capture_dates(){var e,t;return!((e=this.rawMetadata.fields)===null||e===void 0)&&e.capture_dates?new et((t=this.rawMetadata.fields)===null||t===void 0?void 0:t.capture_dates):void 0}get __href__(){return this.fields.__href__}}p([_()],vl.prototype,"title",null);p([_()],vl.prototype,"capture_dates",null);class bl{constructor(e){var t;this.rawMetadata=e,this.fields=new ye((t=e.fields)!==null&&t!==void 0?t:{})}get identifier(){return this.fields.identifier}get highlight(){var e;return!((e=this.rawMetadata.highlight)===null||e===void 0)&&e.text?new F(this.rawMetadata.highlight.text):void 0}get addeddate(){return this.fields.addeddate}get ad_id(){return this.fields.ad_id}get avg_rating(){return this.fields.avg_rating}get collection(){return this.fields.collection}get created_on(){return this.fields.created_on}get creator(){return this.fields.creator}get date(){return this.fields.date}get description(){return this.fields.description}get downloads(){return this.fields.downloads}get factcheck(){return this.fields.factcheck}get filename(){return this.fields.filename}get file_basename(){return this.fields.file_basename}get file_creation_mtime(){return this.fields.file_creation_mtime}get files_count(){return this.fields.files_count}get is_clip(){return this.fields.is_clip}get issue(){return this.fields.issue}get item_count(){return this.fields.item_count}get item_size(){return this.fields.item_size}get language(){return this.fields.language}get mediatype(){return this.fields.mediatype}get num_clips(){return this.fields.num_clips}get num_favorites(){return this.fields.num_favorites}get publicdate(){return this.fields.publicdate}get result_in_subfile(){return this.fields.result_in_subfile}get reviewdate(){return this.fields.reviewdate}get source(){return this.fields.source}get subject(){return this.fields.subject}get title(){return this.fields.title}get updated_on(){return this.fields.updated_on}get week(){return this.fields.week}get year(){return this.fields.year}get start(){var e;return((e=this.rawMetadata.fields)===null||e===void 0?void 0:e.start)!=null?new F(this.rawMetadata.fields.start):void 0}get __href__(){return this.fields.__href__}get __img__(){return this.fields.__img__}}p([_()],bl.prototype,"highlight",null);p([_()],bl.prototype,"start",null);class yl{constructor(e){this.rawResponse=e}get item_size(){return this.rawResponse.item_size}get files_count(){return this.rawResponse.files_count}get month(){return this.rawResponse.month}get week(){return this.rawResponse.week}get downloads(){return this.rawResponse.downloads}get num_favorites(){return this.rawResponse.num_favorites}get title_message(){return this.rawResponse.title_message}get primary_collection(){return this.rawResponse.primary_collection}get thumbnail_url(){return this.rawResponse.thumbnail_url}get num_reviews(){return this.rawResponse.num_reviews}get uploader_details(){return this.rawResponse.uploader_details}get public_metadata(){if(this.rawResponse.public_metadata)return new M(this.rawResponse.public_metadata)}get part_of(){return this.rawResponse.part_of}get speech_vs_music_asr_metadata(){return this.rawResponse.speech_vs_music_asr_metadata}get reviews_metadata(){var e;return((e=this.rawResponse.reviews_metadata)!==null&&e!==void 0?e:[]).map(s=>new ml(s))}}p([_()],yl.prototype,"public_metadata",null);p([_()],yl.prototype,"reviews_metadata",null);class $l{constructor(e,t){var s,r,o,a,l,n,c,h,d,f,g,$,w,T,P;this.extraInfo=null,this.schema=t,this.schemaHitType=t==null?void 0:t.hit_type;let O;e!=null&&e.page_elements&&(this.pageElements=e.page_elements,O=Object.values(this.pageElements)[0]);let D=(s=e==null?void 0:e.hits)===null||s===void 0?void 0:s.hits;this.totalResults=(o=(r=e==null?void 0:e.hits)===null||r===void 0?void 0:r.total)!==null&&o!==void 0?o:0,this.returnedCount=(l=(a=e==null?void 0:e.hits)===null||a===void 0?void 0:a.returned)!==null&&l!==void 0?l:0,!(D!=null&&D.length)&&(!((n=this.pageElements)===null||n===void 0)&&n.service___fts)?(this.totalResults=0,this.returnedCount=0,this.handleFederatedPageElements()):!(D!=null&&D.length)&&(!((c=O==null?void 0:O.hits)===null||c===void 0)&&c.hits)?(D=O.hits.hits,this.totalResults=(h=O.hits.total)!==null&&h!==void 0?h:0,this.returnedCount=(d=O.hits.returned)!==null&&d!==void 0?d:0):!((f=this.pageElements)===null||f===void 0)&&f.lending?D=this.handleLendingPageElement():!((g=this.pageElements)===null||g===void 0)&&g.web_archives&&(D=this.handleWebArchivesPageElement()),this.results=this.formatHits(D);let z=e==null?void 0:e.aggregations;!(this.aggregations&&Object.keys(this.aggregations).length>0)&&(O!=null&&O.aggregations)&&(z=O.aggregations),z&&this.buildAggregations(z),e!=null&&e.collection_titles&&(this.collectionTitles=($=e.collection_titles)!==null&&$!==void 0?$:{}),e!=null&&e.tv_channel_aliases&&(this.tvChannelAliases=(w=e.tv_channel_aliases)!==null&&w!==void 0?w:{}),e!=null&&e.collection_extra_info&&(this.collectionExtraInfo=(T=e.collection_extra_info)!==null&&T!==void 0?T:null),e!=null&&e.account_extra_info&&(this.accountExtraInfo=(P=e.account_extra_info)!==null&&P!==void 0?P:null),e!=null&&e.extra_info&&(this.extraInfo=new yl(e.extra_info))}formatHits(e){var t;return(t=e==null?void 0:e.map(s=>{var r;return $l.createResult((r=s.hit_type)!==null&&r!==void 0?r:this.schemaHitType,s)}))!==null&&t!==void 0?t:[]}buildAggregations(e){this.aggregations=Object.entries(e).reduce((t,[s,r])=>(t[s]=new Id(r),t),{})}handleLendingPageElement(){var e,t;const s=(e=this.pageElements)===null||e===void 0?void 0:e.lending,r=(t=s.loans)!==null&&t!==void 0?t:[];this.totalResults=r.length,this.returnedCount=this.totalResults;for(const o of K0)s[o]=this.formatHits(s[o]);return r}handleWebArchivesPageElement(){var e;const t=Z0((e=this.pageElements)===null||e===void 0?void 0:e.web_archives);return this.totalResults=t.length,this.returnedCount=this.totalResults,t}handleFederatedPageElements(){var e,t,s,r;const o=["service___fts","service___tvs","service___rcs","service___whisper","metadata___mediatype___texts","metadata___mediatype___movies","metadata___mediatype___audio","metadata___mediatype___software","metadata___mediatype___image","metadata___mediatype___etree"];for(const a of o){const l=this.removePageElementPrefix(a);this.federatedResults?this.federatedResults[a]=[]:this.federatedResults={[l]:[]};const n=(t=(e=this.pageElements)===null||e===void 0?void 0:e[a])===null||t===void 0?void 0:t.hits;n!=null&&n.hits&&(this.federatedResults[l]=this.formatHits(n==null?void 0:n.hits)),this.totalResults+=(s=n==null?void 0:n.total)!==null&&s!==void 0?s:0,this.returnedCount+=(r=n==null?void 0:n.returned)!==null&&r!==void 0?r:0}}removePageElementPrefix(e){return e.split("___").pop()}static createResult(e,t){switch(e){case"item":return new ft(t);case"text":case"asr_text":return new gl(t);case"favorited_search":return new J0(t);case"web_archive":return new vl(t);case"tv_clip":return new bl(t);default:return new ft(t)}}}class ep{constructor(e){this.clientParameters=e.client_parameters,this.backendRequests=e.backend_requests,this.kind=e.kind}}class tp{constructor(e){var t,s,r;this.rawResponse=e,this.request=new ep(e.request),this.responseHeader=(t=e.response)===null||t===void 0?void 0:t.header,this.sessionContext=e.session_context,this.response=new $l((s=e.response)===null||s===void 0?void 0:s.body,(r=e.response)===null||r===void 0?void 0:r.hit_schema)}}class Is{static aggregateSearchParamsAsString(e){if(e.omit)return"false";if(e.advancedParams){const t=e.advancedParams.map(r=>({terms:r}));return JSON.stringify(t)}if(e.simpleParams)return e.simpleParams.join(",")}static sortParamsAsString(e){return`${e.field}:${e.direction}`}static filterParamsAsString(e){return JSON.stringify(e)}static generateURLSearchParams(e){const t=new URLSearchParams;if(e.query&&t.append("user_query",e.query),e.pageType&&t.append("page_type",String(e.pageType)),e.pageTarget&&t.append("page_target",String(e.pageTarget)),e.pageElements&&e.pageElements.length>0){const o=`[${e.pageElements.map(a=>`"${a}"`).join(",")}]`;t.append("page_elements",o)}if(e.rows!=null&&t.append("hits_per_page",String(e.rows)),e.page!=null&&t.append("page",String(e.page)),e.fields&&e.fields.length>0&&t.append("fields",e.fields.join(",")),e.filters&&Object.keys(e.filters).length>0){const r=this.filterParamsAsString(e.filters);r&&r!=="{}"&&t.append("filter_map",r)}if(e.sort&&e.sort.length>0){const r=e.sort.map(o=>this.sortParamsAsString(o));t.append("sort",r.join(","))}const s=e.aggregations;if(s){const r=this.aggregateSearchParamsAsString(s);r&&t.append("aggregations",r)}if(e.aggregationsSize!=null&&t.append("aggregations_size",String(e.aggregationsSize)),e.debugging&&t.append("debugging","true"),e.uid&&t.append("uid",e.uid),e.includeClientUrl!==!1){const r=e.query==null,o=e.query&&e.query.length<=1e3;if(r||o){const l=window.location.href.slice(0,400);t.append("client_url",l)}}return t}}var ur;(function(i){i.networkError="SearchService.NetworkError",i.itemNotFound="SearchService.ItemNotFound",i.decodingError="SearchService.DecodingError",i.searchEngineError="SearchService.SearchEngineError"})(ur||(ur={}));class ip extends Error{constructor(e,t,s){super(t),this.name=e,this.type=e,this.details=s}}const Cc={reCache:JSON.stringify({recompute:!0}),noCache:JSON.stringify({bypass:!0}),dontCache:JSON.stringify({no_compute:!0})};class Ns{constructor(e){var t,s;this.baseUrl=(t=e==null?void 0:e.baseUrl)!==null&&t!==void 0?t:"archive.org",(e==null?void 0:e.includeCredentials)!==void 0?this.includeCredentials=e.includeCredentials:this.includeCredentials=window.location.href.match(/^https?:\/\/.*archive\.org(:[0-9]+)?/)!==null;const r=new URL(window.location.href).searchParams,o=r.get("scope"),a=r.get("verbose"),l=r.get("debugging"),n=r.get("cacheDebug");let c="";for(const h of Object.keys(Cc))if(r.get(h)){c=Cc[h];break}c=(s=r.get("caching"))!==null&&s!==void 0?s:c,(e==null?void 0:e.caching)!==void 0?this.cachingFlags=e.caching:c&&(this.cachingFlags=c),(e==null?void 0:e.debuggingEnabled)!==void 0?this.debuggingEnabled=e.debuggingEnabled:(l||n)&&(this.debuggingEnabled=!0),(e==null?void 0:e.scope)!==void 0?this.requestScope=e.scope:o&&(this.requestScope=o),(e==null?void 0:e.verbose)!==void 0?this.verbose=e.verbose:a&&(this.verbose=!!a)}async fetchUrl(e,t){var s,r;const o=new URL(e);this.requestScope&&o.searchParams.set("scope",this.requestScope),this.cachingFlags&&o.searchParams.set("caching",this.cachingFlags);let a;try{const l=(s=t==null?void 0:t.requestOptions)!==null&&s!==void 0?s:{credentials:this.includeCredentials?"include":"same-origin"};a=await fetch(o.href,l)}catch(l){const n=l instanceof Error?l.message:typeof l=="string"?l:"Unknown error";return this.getErrorResult(ur.networkError,n)}try{const l=await a.json();this.verbose&&this.printResponse(l),l.debugging&&this.printDebuggingInfo(l);const n=(r=l.response)===null||r===void 0?void 0:r.error;return n?this.getErrorResult(ur.searchEngineError,n.message,n.forensics):{success:l}}catch(l){const n=l instanceof Error?l.message:typeof l=="string"?l:"Unknown error";return this.getErrorResult(ur.decodingError,n)}}getErrorResult(e,t,s){return{error:new ip(e,t,s)}}printResponse(e){var t,s,r,o,a;try{const l=JSON.parse(JSON.stringify(e)),n=(r=(s=(t=l==null?void 0:l.response)===null||t===void 0?void 0:t.body)===null||s===void 0?void 0:s.hits)===null||r===void 0?void 0:r.hits;if(Array.isArray(n)&&n.length>1){const h=[];h.push(n[0]),h.push(`*** ${n.length-1} hits omitted ***`),l.response.body.hits.hits=h}const c=(a=(o=l==null?void 0:l.response)===null||o===void 0?void 0:o.body)===null||a===void 0?void 0:a.aggregations;c&&Object.entries(c).forEach(([h,d])=>{var f,g,$,w;if(((g=(f=d)===null||f===void 0?void 0:f.buckets)===null||g===void 0?void 0:g.length)>0){const T=JSON.parse(JSON.stringify(d));T.buckets=`*** ${(w=($=T.buckets)===null||$===void 0?void 0:$.length)!==null&&w!==void 0?w:0} buckets omitted ***`,l.response.body.aggregations[h]=T}}),console.log("***** RESPONSE RECEIVED *****"),console.groupCollapsed("Response"),console.log(JSON.stringify(l,null,2)),console.groupEnd()}catch(l){console.error("Error printing search response:",l)}}printDebuggingInfo(e){var t,s;const r=e.debugging,o=(t=r.messages)!==null&&t!==void 0?t:[],a=(s=r.data)!==null&&s!==void 0?s:{};console.log("***** BEGIN DEBUGGING *****"),console.log("Full response:"),console.log(JSON.stringify(e,null,2)),console.group("Debug messages");for(const l of o)console.log(l);console.groupEnd(),console.group("Debug data");for(const[l,n]of Object.entries(a))console.log(l,n);console.groupEnd(),console.log("***** END DEBUGGING *****")}}class sp extends Ns{constructor(e){var t;super(e),this.servicePath=(t=e==null?void 0:e.servicePath)!==null&&t!==void 0?t:"/services/search/beta/page_production"}async performSearch(e){this.debuggingEnabled&&e.debugging===void 0&&(e.debugging=!0);const s=Is.generateURLSearchParams(e).toString(),r=`https://${this.baseUrl}${this.servicePath}/?service_backend=metadata&${s}`;return this.fetchUrl(r)}}class rp extends Ns{constructor(e){var t;super(e),this.servicePath=(t=e==null?void 0:e.servicePath)!==null&&t!==void 0?t:"/services/search/beta/page_production"}async performSearch(e){this.debuggingEnabled&&e.debugging===void 0&&(e.debugging=!0);const s=Is.generateURLSearchParams(e).toString(),r=`https://${this.baseUrl}${this.servicePath}/?service_backend=fts&${s}`;return this.fetchUrl(r)}}class op extends Ns{constructor(e){var t;super(e),this.servicePath=(t=e==null?void 0:e.servicePath)!==null&&t!==void 0?t:"/services/search/beta/page_production"}async performSearch(e){this.debuggingEnabled&&e.debugging===void 0&&(e.debugging=!0);const s=Is.generateURLSearchParams(e).toString(),r=`https://${this.baseUrl}${this.servicePath}/?service_backend=rcs&${s}`;return this.fetchUrl(r)}}var I;(function(i){i[i.DEFAULT=0]="DEFAULT",i[i.METADATA=1]="METADATA",i[i.FULLTEXT=2]="FULLTEXT",i[i.TV=3]="TV",i[i.RADIO=4]="RADIO",i[i.FEDERATED=5]="FEDERATED"})(I||(I={}));class ap extends Ns{constructor(e){var t;super(e),this.servicePath=(t=e==null?void 0:e.servicePath)!==null&&t!==void 0?t:"/services/search/beta/page_production"}async performSearch(e){this.debuggingEnabled&&e.debugging===void 0&&(e.debugging=!0);const s=Is.generateURLSearchParams(e).toString(),r=`https://${this.baseUrl}${this.servicePath}/?service_backend=tvs&${s}`;return this.fetchUrl(r)}}class np extends Ns{constructor(e){var t;super(e),this.servicePath=(t=e==null?void 0:e.servicePath)!==null&&t!==void 0?t:"/services/search/beta/page_production"}async performSearch(e){this.debuggingEnabled&&e.debugging===void 0&&(e.debugging=!0);const s=Is.generateURLSearchParams(e).toString(),r=`https://${this.baseUrl}${this.servicePath}/?page_type=simple_federation&${s}`;return this.fetchUrl(r)}}class lp extends Ns{constructor(e){var t;super(e),this.servicePath=(t=e==null?void 0:e.servicePath)!==null&&t!==void 0?t:"/services/search/beta/page_production"}async performSearch(e){this.debuggingEnabled&&e.debugging===void 0&&(e.debugging=!0);const s=Is.generateURLSearchParams(e).toString(),r=`https://${this.baseUrl}${this.servicePath}/?${s}`,{pageType:o,identifiers:a}=e,n=o==="client_document_fetch"&&!!(a!=null&&a.length)?{requestOptions:{method:"POST",body:JSON.stringify({doc_ids:a}),credentials:"include"}}:void 0;return this.fetchUrl(r,n)}}class us{constructor(e={}){this.backendOptions=e}async search(e,t=I.METADATA){const r=await us.getBackendForSearchType(t,this.backendOptions).performSearch(e);return r.error?r:{success:new tp(r.success)}}itemDetails(e){const t={pageType:"item_details",pageTarget:e};return this.search(t,I.DEFAULT)}static getBackendForSearchType(e,t={}){switch(e){case I.METADATA:return new sp(t);case I.FULLTEXT:return new rp(t);case I.RADIO:return new op(t);case I.TV:return new ap(t);case I.FEDERATED:return new np(t);default:return new lp(t)}}}us.default=new us;p([_((i,e={})=>{const{includeCredentials:t=!1,verbose:s=!1,scope:r="",baseUrl:o=""}=e;return`${i};${t};${s};${r};${o}`})],us,"getBackendForSearchType",null);var Wt;(function(i){i.INCLUDE="inc",i.EXCLUDE="exc",i.GREATER_THAN="gt",i.GREATER_OR_EQUAL="gte",i.LESS_THAN="lt",i.LESS_OR_EQUAL="lte"})(Wt||(Wt={}));class cp{constructor(){this.filterMap={}}addFilter(e,t,s){if(this.filterMap[e]||(this.filterMap[e]={}),this.filterMap[e][t]){const r=[].concat(this.filterMap[e][t],s);this.filterMap[e][t]=Array.from(new Set(r))}else this.filterMap[e][t]=s;return this}removeSingleFilter(e,t,s){var r;if(!(!((r=this.filterMap[e])===null||r===void 0)&&r[t]))return this;const o=[].concat(this.filterMap[e][t]),a=o.indexOf(s);return a>=0&&o.splice(a,1),this.filterMap[e][t]=o.length===1?o[0]:o,o.length===0&&delete this.filterMap[e][t],this.deleteFieldIfEmpty(e),this}removeFilters(e,t){return this.filterMap[e]?(delete this.filterMap[e][t],this.deleteFieldIfEmpty(e),this):this}deleteFieldIfEmpty(e){const t=this.filterMap[e];t&&Object.keys(t).length===0&&delete this.filterMap[e]}setFilterMap(e){return this.filterMap={...e},this}mergeFilterMap(e){for(const[t,s]of Object.entries(e))for(const[r,o]of Object.entries(s))if(Array.isArray(o))for(const a of o)this.addFilter(t,r,a);else this.addFilter(t,r,o);return this}build(){return this.filterMap}}/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ho=globalThis,wl=ho.ShadowRoot&&(ho.ShadyCSS===void 0||ho.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Nd=Symbol(),Tc=new WeakMap;let hp=class{constructor(e,t,s){if(this._$cssResult$=!0,s!==Nd)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o;const t=this.t;if(wl&&e===void 0){const s=t!==void 0&&t.length===1;s&&(e=Tc.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),s&&Tc.set(t,e))}return e}toString(){return this.cssText}};const dp=i=>new hp(typeof i=="string"?i:i+"",void 0,Nd),pp=(i,e)=>{if(wl)i.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(const t of e){const s=document.createElement("style"),r=ho.litNonce;r!==void 0&&s.setAttribute("nonce",r),s.textContent=t.cssText,i.appendChild(s)}},Ac=wl?i=>i:i=>i instanceof CSSStyleSheet?(e=>{let t="";for(const s of e.cssRules)t+=s.cssText;return dp(t)})(i):i;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{is:up,defineProperty:fp,getOwnPropertyDescriptor:mp,getOwnPropertyNames:gp,getOwnPropertySymbols:vp,getPrototypeOf:bp}=Object,ri=globalThis,kc=ri.trustedTypes,yp=kc?kc.emptyScript:"",ka=ri.reactiveElementPolyfillSupport,fr=(i,e)=>i,Ao={toAttribute(i,e){switch(e){case Boolean:i=i?yp:null;break;case Object:case Array:i=i==null?i:JSON.stringify(i)}return i},fromAttribute(i,e){let t=i;switch(e){case Boolean:t=i!==null;break;case Number:t=i===null?null:Number(i);break;case Object:case Array:try{t=JSON.parse(i)}catch{t=null}}return t}},xl=(i,e)=>!up(i,e),Ec={attribute:!0,type:String,converter:Ao,reflect:!1,useDefault:!1,hasChanged:xl};Symbol.metadata??(Symbol.metadata=Symbol("metadata")),ri.litPropertyMetadata??(ri.litPropertyMetadata=new WeakMap);let Ws=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??(this.l=[])).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=Ec){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(e,t),!t.noAccessor){const s=Symbol(),r=this.getPropertyDescriptor(e,s,t);r!==void 0&&fp(this.prototype,e,r)}}static getPropertyDescriptor(e,t,s){const{get:r,set:o}=mp(this.prototype,e)??{get(){return this[t]},set(a){this[t]=a}};return{get:r,set(a){const l=r==null?void 0:r.call(this);o==null||o.call(this,a),this.requestUpdate(e,l,s)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??Ec}static _$Ei(){if(this.hasOwnProperty(fr("elementProperties")))return;const e=bp(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(fr("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(fr("properties"))){const t=this.properties,s=[...gp(t),...vp(t)];for(const r of s)this.createProperty(r,t[r])}const e=this[Symbol.metadata];if(e!==null){const t=litPropertyMetadata.get(e);if(t!==void 0)for(const[s,r]of t)this.elementProperties.set(s,r)}this._$Eh=new Map;for(const[t,s]of this.elementProperties){const r=this._$Eu(t,s);r!==void 0&&this._$Eh.set(r,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const s=new Set(e.flat(1/0).reverse());for(const r of s)t.unshift(Ac(r))}else e!==void 0&&t.push(Ac(e));return t}static _$Eu(e,t){const s=t.attribute;return s===!1?void 0:typeof s=="string"?s:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){var e;this._$ES=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$E_(),this.requestUpdate(),(e=this.constructor.l)==null||e.forEach(t=>t(this))}addController(e){var t;(this._$EO??(this._$EO=new Set)).add(e),this.renderRoot!==void 0&&this.isConnected&&((t=e.hostConnected)==null||t.call(e))}removeController(e){var t;(t=this._$EO)==null||t.delete(e)}_$E_(){const e=new Map,t=this.constructor.elementProperties;for(const s of t.keys())this.hasOwnProperty(s)&&(e.set(s,this[s]),delete this[s]);e.size>0&&(this._$Ep=e)}createRenderRoot(){const e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return pp(e,this.constructor.elementStyles),e}connectedCallback(){var e;this.renderRoot??(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$EO)==null||e.forEach(t=>{var s;return(s=t.hostConnected)==null?void 0:s.call(t)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$EO)==null||e.forEach(t=>{var s;return(s=t.hostDisconnected)==null?void 0:s.call(t)})}attributeChangedCallback(e,t,s){this._$AK(e,s)}_$ET(e,t){var o;const s=this.constructor.elementProperties.get(e),r=this.constructor._$Eu(e,s);if(r!==void 0&&s.reflect===!0){const a=(((o=s.converter)==null?void 0:o.toAttribute)!==void 0?s.converter:Ao).toAttribute(t,s.type);this._$Em=e,a==null?this.removeAttribute(r):this.setAttribute(r,a),this._$Em=null}}_$AK(e,t){var o,a;const s=this.constructor,r=s._$Eh.get(e);if(r!==void 0&&this._$Em!==r){const l=s.getPropertyOptions(r),n=typeof l.converter=="function"?{fromAttribute:l.converter}:((o=l.converter)==null?void 0:o.fromAttribute)!==void 0?l.converter:Ao;this._$Em=r;const c=n.fromAttribute(t,l.type);this[r]=c??((a=this._$Ej)==null?void 0:a.get(r))??c,this._$Em=null}}requestUpdate(e,t,s,r=!1,o){var a;if(e!==void 0){const l=this.constructor;if(r===!1&&(o=this[e]),s??(s=l.getPropertyOptions(e)),!((s.hasChanged??xl)(o,t)||s.useDefault&&s.reflect&&o===((a=this._$Ej)==null?void 0:a.get(e))&&!this.hasAttribute(l._$Eu(e,s))))return;this.C(e,t,s)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,t,{useDefault:s,reflect:r,wrapped:o},a){s&&!(this._$Ej??(this._$Ej=new Map)).has(e)&&(this._$Ej.set(e,a??t??this[e]),o!==!0||a!==void 0)||(this._$AL.has(e)||(this.hasUpdated||s||(t=void 0),this._$AL.set(e,t)),r===!0&&this._$Em!==e&&(this._$Eq??(this._$Eq=new Set)).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var s;if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??(this.renderRoot=this.createRenderRoot()),this._$Ep){for(const[o,a]of this._$Ep)this[o]=a;this._$Ep=void 0}const r=this.constructor.elementProperties;if(r.size>0)for(const[o,a]of r){const{wrapped:l}=a,n=this[o];l!==!0||this._$AL.has(o)||n===void 0||this.C(o,void 0,a,n)}}let e=!1;const t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),(s=this._$EO)==null||s.forEach(r=>{var o;return(o=r.hostUpdate)==null?void 0:o.call(r)}),this.update(t)):this._$EM()}catch(r){throw e=!1,this._$EM(),r}e&&this._$AE(t)}willUpdate(e){}_$AE(e){var t;(t=this._$EO)==null||t.forEach(s=>{var r;return(r=s.hostUpdated)==null?void 0:r.call(s)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&(this._$Eq=this._$Eq.forEach(t=>this._$ET(t,this[t]))),this._$EM()}updated(e){}firstUpdated(e){}};Ws.elementStyles=[],Ws.shadowRootOptions={mode:"open"},Ws[fr("elementProperties")]=new Map,Ws[fr("finalized")]=new Map,ka==null||ka({ReactiveElement:Ws}),(ri.reactiveElementVersions??(ri.reactiveElementVersions=[])).push("2.1.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const mr=globalThis,Mc=i=>i,ko=mr.trustedTypes,Pc=ko?ko.createPolicy("lit-html",{createHTML:i=>i}):void 0,Hd="$lit$",Qt=`lit$${Math.random().toFixed(9).slice(2)}$`,Ud="?"+Qt,$p=`<${Ud}>`,Ni=document,Eo=()=>Ni.createComment(""),Tr=i=>i===null||typeof i!="object"&&typeof i!="function",_l=Array.isArray,wp=i=>_l(i)||typeof(i==null?void 0:i[Symbol.iterator])=="function",Ea=`[ 	
\f\r]`,qs=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Oc=/-->/g,Dc=/>/g,pi=RegExp(`>|${Ea}(?:([^\\s"'>=/]+)(${Ea}*=${Ea}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Lc=/'/g,Bc=/"/g,Vd=/^(?:script|style|textarea|title)$/i,tt=Symbol.for("lit-noChange"),ie=Symbol.for("lit-nothing"),Fc=new WeakMap,Ti=Ni.createTreeWalker(Ni,129);function jd(i,e){if(!_l(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return Pc!==void 0?Pc.createHTML(e):e}const xp=(i,e)=>{const t=i.length-1,s=[];let r,o=e===2?"<svg>":e===3?"<math>":"",a=qs;for(let l=0;l<t;l++){const n=i[l];let c,h,d=-1,f=0;for(;f<n.length&&(a.lastIndex=f,h=a.exec(n),h!==null);)f=a.lastIndex,a===qs?h[1]==="!--"?a=Oc:h[1]!==void 0?a=Dc:h[2]!==void 0?(Vd.test(h[2])&&(r=RegExp("</"+h[2],"g")),a=pi):h[3]!==void 0&&(a=pi):a===pi?h[0]===">"?(a=r??qs,d=-1):h[1]===void 0?d=-2:(d=a.lastIndex-h[2].length,c=h[1],a=h[3]===void 0?pi:h[3]==='"'?Bc:Lc):a===Bc||a===Lc?a=pi:a===Oc||a===Dc?a=qs:(a=pi,r=void 0);const g=a===pi&&i[l+1].startsWith("/>")?" ":"";o+=a===qs?n+$p:d>=0?(s.push(c),n.slice(0,d)+Hd+n.slice(d)+Qt+g):n+Qt+(d===-2?l:g)}return[jd(i,o+(i[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),s]};let Ln=class Wd{constructor({strings:e,_$litType$:t},s){let r;this.parts=[];let o=0,a=0;const l=e.length-1,n=this.parts,[c,h]=xp(e,t);if(this.el=Wd.createElement(c,s),Ti.currentNode=this.el.content,t===2||t===3){const d=this.el.content.firstChild;d.replaceWith(...d.childNodes)}for(;(r=Ti.nextNode())!==null&&n.length<l;){if(r.nodeType===1){if(r.hasAttributes())for(const d of r.getAttributeNames())if(d.endsWith(Hd)){const f=h[a++],g=r.getAttribute(d).split(Qt),$=/([.?@])?(.*)/.exec(f);n.push({type:1,index:o,name:$[2],strings:g,ctor:$[1]==="."?Sp:$[1]==="?"?Cp:$[1]==="@"?Tp:Zo}),r.removeAttribute(d)}else d.startsWith(Qt)&&(n.push({type:6,index:o}),r.removeAttribute(d));if(Vd.test(r.tagName)){const d=r.textContent.split(Qt),f=d.length-1;if(f>0){r.textContent=ko?ko.emptyScript:"";for(let g=0;g<f;g++)r.append(d[g],Eo()),Ti.nextNode(),n.push({type:2,index:++o});r.append(d[f],Eo())}}}else if(r.nodeType===8)if(r.data===Ud)n.push({type:2,index:o});else{let d=-1;for(;(d=r.data.indexOf(Qt,d+1))!==-1;)n.push({type:7,index:o}),d+=Qt.length-1}o++}}static createElement(e,t){const s=Ni.createElement("template");return s.innerHTML=e,s}};function fs(i,e,t=i,s){var a,l;if(e===tt)return e;let r=s!==void 0?(a=t._$Co)==null?void 0:a[s]:t._$Cl;const o=Tr(e)?void 0:e._$litDirective$;return(r==null?void 0:r.constructor)!==o&&((l=r==null?void 0:r._$AO)==null||l.call(r,!1),o===void 0?r=void 0:(r=new o(i),r._$AT(i,t,s)),s!==void 0?(t._$Co??(t._$Co=[]))[s]=r:t._$Cl=r),r!==void 0&&(e=fs(i,r._$AS(i,e.values),r,s)),e}let _p=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:t},parts:s}=this._$AD,r=((e==null?void 0:e.creationScope)??Ni).importNode(t,!0);Ti.currentNode=r;let o=Ti.nextNode(),a=0,l=0,n=s[0];for(;n!==void 0;){if(a===n.index){let c;n.type===2?c=new Sl(o,o.nextSibling,this,e):n.type===1?c=new n.ctor(o,n.name,n.strings,this,e):n.type===6&&(c=new Ap(o,this,e)),this._$AV.push(c),n=s[++l]}a!==(n==null?void 0:n.index)&&(o=Ti.nextNode(),a++)}return Ti.currentNode=Ni,r}p(e){let t=0;for(const s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(e,s,t),t+=s.strings.length-2):s._$AI(e[t])),t++}},Sl=class qd{get _$AU(){var e;return((e=this._$AM)==null?void 0:e._$AU)??this._$Cv}constructor(e,t,s,r){this.type=2,this._$AH=ie,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=s,this.options=r,this._$Cv=(r==null?void 0:r.isConnected)??!0}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=fs(this,e,t),Tr(e)?e===ie||e==null||e===""?(this._$AH!==ie&&this._$AR(),this._$AH=ie):e!==this._$AH&&e!==tt&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):wp(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==ie&&Tr(this._$AH)?this._$AA.nextSibling.data=e:this.T(Ni.createTextNode(e)),this._$AH=e}$(e){var o;const{values:t,_$litType$:s}=e,r=typeof s=="number"?this._$AC(e):(s.el===void 0&&(s.el=Ln.createElement(jd(s.h,s.h[0]),this.options)),s);if(((o=this._$AH)==null?void 0:o._$AD)===r)this._$AH.p(t);else{const a=new _p(r,this),l=a.u(this.options);a.p(t),this.T(l),this._$AH=a}}_$AC(e){let t=Fc.get(e.strings);return t===void 0&&Fc.set(e.strings,t=new Ln(e)),t}k(e){_l(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let s,r=0;for(const o of e)r===t.length?t.push(s=new qd(this.O(Eo()),this.O(Eo()),this,this.options)):s=t[r],s._$AI(o),r++;r<t.length&&(this._$AR(s&&s._$AB.nextSibling,r),t.length=r)}_$AR(e=this._$AA.nextSibling,t){var s;for((s=this._$AP)==null?void 0:s.call(this,!1,!0,t);e!==this._$AB;){const r=Mc(e).nextSibling;Mc(e).remove(),e=r}}setConnected(e){var t;this._$AM===void 0&&(this._$Cv=e,(t=this._$AP)==null||t.call(this,e))}},Zo=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,s,r,o){this.type=1,this._$AH=ie,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=o,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=ie}_$AI(e,t=this,s,r){const o=this.strings;let a=!1;if(o===void 0)e=fs(this,e,t,0),a=!Tr(e)||e!==this._$AH&&e!==tt,a&&(this._$AH=e);else{const l=e;let n,c;for(e=o[0],n=0;n<o.length-1;n++)c=fs(this,l[s+n],t,n),c===tt&&(c=this._$AH[n]),a||(a=!Tr(c)||c!==this._$AH[n]),c===ie?e=ie:e!==ie&&(e+=(c??"")+o[n+1]),this._$AH[n]=c}a&&!r&&this.j(e)}j(e){e===ie?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},Sp=class extends Zo{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===ie?void 0:e}},Cp=class extends Zo{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==ie)}},Tp=class extends Zo{constructor(e,t,s,r,o){super(e,t,s,r,o),this.type=5}_$AI(e,t=this){if((e=fs(this,e,t,0)??ie)===tt)return;const s=this._$AH,r=e===ie&&s!==ie||e.capture!==s.capture||e.once!==s.once||e.passive!==s.passive,o=e!==ie&&(s===ie||r);r&&this.element.removeEventListener(this.name,this,s),o&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t;typeof this._$AH=="function"?this._$AH.call(((t=this.options)==null?void 0:t.host)??this.element,e):this._$AH.handleEvent(e)}},Ap=class{constructor(e,t,s){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(e){fs(this,e)}};const kp={I:Sl},Ma=mr.litHtmlPolyfillSupport;Ma==null||Ma(Ln,Sl),(mr.litHtmlVersions??(mr.litHtmlVersions=[])).push("3.3.2");/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const po=globalThis,Cl=po.ShadowRoot&&(po.ShadyCSS===void 0||po.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Tl=Symbol(),Rc=new WeakMap;let Gd=class{constructor(e,t,s){if(this._$cssResult$=!0,s!==Tl)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o;const t=this.t;if(Cl&&e===void 0){const s=t!==void 0&&t.length===1;s&&(e=Rc.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),s&&Rc.set(t,e))}return e}toString(){return this.cssText}};const Ep=i=>new Gd(typeof i=="string"?i:i+"",void 0,Tl),y=(i,...e)=>{const t=i.length===1?i[0]:e.reduce((s,r,o)=>s+(a=>{if(a._$cssResult$===!0)return a.cssText;if(typeof a=="number")return a;throw Error("Value passed to 'css' function must be a 'css' function result: "+a+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(r)+i[o+1],i[0]);return new Gd(t,i,Tl)},Mp=(i,e)=>{if(Cl)i.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(const t of e){const s=document.createElement("style"),r=po.litNonce;r!==void 0&&s.setAttribute("nonce",r),s.textContent=t.cssText,i.appendChild(s)}},zc=Cl?i=>i:i=>i instanceof CSSStyleSheet?(e=>{let t="";for(const s of e.cssRules)t+=s.cssText;return Ep(t)})(i):i;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{is:Pp,defineProperty:Op,getOwnPropertyDescriptor:Dp,getOwnPropertyNames:Lp,getOwnPropertySymbols:Bp,getPrototypeOf:Fp}=Object,oi=globalThis,Ic=oi.trustedTypes,Rp=Ic?Ic.emptyScript:"",Pa=oi.reactiveElementPolyfillSupport,gr=(i,e)=>i,Bn={toAttribute(i,e){switch(e){case Boolean:i=i?Rp:null;break;case Object:case Array:i=i==null?i:JSON.stringify(i)}return i},fromAttribute(i,e){let t=i;switch(e){case Boolean:t=i!==null;break;case Number:t=i===null?null:Number(i);break;case Object:case Array:try{t=JSON.parse(i)}catch{t=null}}return t}},Yd=(i,e)=>!Pp(i,e),Nc={attribute:!0,type:String,converter:Bn,reflect:!1,useDefault:!1,hasChanged:Yd};Symbol.metadata??(Symbol.metadata=Symbol("metadata")),oi.litPropertyMetadata??(oi.litPropertyMetadata=new WeakMap);let as=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??(this.l=[])).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=Nc){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(e,t),!t.noAccessor){const s=Symbol(),r=this.getPropertyDescriptor(e,s,t);r!==void 0&&Op(this.prototype,e,r)}}static getPropertyDescriptor(e,t,s){const{get:r,set:o}=Dp(this.prototype,e)??{get(){return this[t]},set(a){this[t]=a}};return{get:r,set(a){const l=r==null?void 0:r.call(this);o==null||o.call(this,a),this.requestUpdate(e,l,s)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??Nc}static _$Ei(){if(this.hasOwnProperty(gr("elementProperties")))return;const e=Fp(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(gr("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(gr("properties"))){const t=this.properties,s=[...Lp(t),...Bp(t)];for(const r of s)this.createProperty(r,t[r])}const e=this[Symbol.metadata];if(e!==null){const t=litPropertyMetadata.get(e);if(t!==void 0)for(const[s,r]of t)this.elementProperties.set(s,r)}this._$Eh=new Map;for(const[t,s]of this.elementProperties){const r=this._$Eu(t,s);r!==void 0&&this._$Eh.set(r,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const s=new Set(e.flat(1/0).reverse());for(const r of s)t.unshift(zc(r))}else e!==void 0&&t.push(zc(e));return t}static _$Eu(e,t){const s=t.attribute;return s===!1?void 0:typeof s=="string"?s:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){var e;this._$ES=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$E_(),this.requestUpdate(),(e=this.constructor.l)==null||e.forEach(t=>t(this))}addController(e){var t;(this._$EO??(this._$EO=new Set)).add(e),this.renderRoot!==void 0&&this.isConnected&&((t=e.hostConnected)==null||t.call(e))}removeController(e){var t;(t=this._$EO)==null||t.delete(e)}_$E_(){const e=new Map,t=this.constructor.elementProperties;for(const s of t.keys())this.hasOwnProperty(s)&&(e.set(s,this[s]),delete this[s]);e.size>0&&(this._$Ep=e)}createRenderRoot(){const e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Mp(e,this.constructor.elementStyles),e}connectedCallback(){var e;this.renderRoot??(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$EO)==null||e.forEach(t=>{var s;return(s=t.hostConnected)==null?void 0:s.call(t)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$EO)==null||e.forEach(t=>{var s;return(s=t.hostDisconnected)==null?void 0:s.call(t)})}attributeChangedCallback(e,t,s){this._$AK(e,s)}_$ET(e,t){var o;const s=this.constructor.elementProperties.get(e),r=this.constructor._$Eu(e,s);if(r!==void 0&&s.reflect===!0){const a=(((o=s.converter)==null?void 0:o.toAttribute)!==void 0?s.converter:Bn).toAttribute(t,s.type);this._$Em=e,a==null?this.removeAttribute(r):this.setAttribute(r,a),this._$Em=null}}_$AK(e,t){var o,a;const s=this.constructor,r=s._$Eh.get(e);if(r!==void 0&&this._$Em!==r){const l=s.getPropertyOptions(r),n=typeof l.converter=="function"?{fromAttribute:l.converter}:((o=l.converter)==null?void 0:o.fromAttribute)!==void 0?l.converter:Bn;this._$Em=r;const c=n.fromAttribute(t,l.type);this[r]=c??((a=this._$Ej)==null?void 0:a.get(r))??c,this._$Em=null}}requestUpdate(e,t,s,r=!1,o){var a;if(e!==void 0){const l=this.constructor;if(r===!1&&(o=this[e]),s??(s=l.getPropertyOptions(e)),!((s.hasChanged??Yd)(o,t)||s.useDefault&&s.reflect&&o===((a=this._$Ej)==null?void 0:a.get(e))&&!this.hasAttribute(l._$Eu(e,s))))return;this.C(e,t,s)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,t,{useDefault:s,reflect:r,wrapped:o},a){s&&!(this._$Ej??(this._$Ej=new Map)).has(e)&&(this._$Ej.set(e,a??t??this[e]),o!==!0||a!==void 0)||(this._$AL.has(e)||(this.hasUpdated||s||(t=void 0),this._$AL.set(e,t)),r===!0&&this._$Em!==e&&(this._$Eq??(this._$Eq=new Set)).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var s;if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??(this.renderRoot=this.createRenderRoot()),this._$Ep){for(const[o,a]of this._$Ep)this[o]=a;this._$Ep=void 0}const r=this.constructor.elementProperties;if(r.size>0)for(const[o,a]of r){const{wrapped:l}=a,n=this[o];l!==!0||this._$AL.has(o)||n===void 0||this.C(o,void 0,a,n)}}let e=!1;const t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),(s=this._$EO)==null||s.forEach(r=>{var o;return(o=r.hostUpdate)==null?void 0:o.call(r)}),this.update(t)):this._$EM()}catch(r){throw e=!1,this._$EM(),r}e&&this._$AE(t)}willUpdate(e){}_$AE(e){var t;(t=this._$EO)==null||t.forEach(s=>{var r;return(r=s.hostUpdated)==null?void 0:r.call(s)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&(this._$Eq=this._$Eq.forEach(t=>this._$ET(t,this[t]))),this._$EM()}updated(e){}firstUpdated(e){}};as.elementStyles=[],as.shadowRootOptions={mode:"open"},as[gr("elementProperties")]=new Map,as[gr("finalized")]=new Map,Pa==null||Pa({ReactiveElement:as}),(oi.reactiveElementVersions??(oi.reactiveElementVersions=[])).push("2.1.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const vr=globalThis,Hc=i=>i,Mo=vr.trustedTypes,Uc=Mo?Mo.createPolicy("lit-html",{createHTML:i=>i}):void 0,Qd="$lit$",Kt=`lit$${Math.random().toFixed(9).slice(2)}$`,Kd="?"+Kt,zp=`<${Kd}>`,Hi=document,Ar=()=>Hi.createComment(""),kr=i=>i===null||typeof i!="object"&&typeof i!="function",Al=Array.isArray,Ip=i=>Al(i)||typeof(i==null?void 0:i[Symbol.iterator])=="function",Oa=`[ 	
\f\r]`,Gs=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Vc=/-->/g,jc=/>/g,ui=RegExp(`>|${Oa}(?:([^\\s"'>=/]+)(${Oa}*=${Oa}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Wc=/'/g,qc=/"/g,Xd=/^(?:script|style|textarea|title)$/i,Zd=i=>(e,...t)=>({_$litType$:i,strings:e,values:t}),m=Zd(1),q=Zd(2),ms=Symbol.for("lit-noChange"),b=Symbol.for("lit-nothing"),Gc=new WeakMap,Ai=Hi.createTreeWalker(Hi,129);function Jd(i,e){if(!Al(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return Uc!==void 0?Uc.createHTML(e):e}const Np=(i,e)=>{const t=i.length-1,s=[];let r,o=e===2?"<svg>":e===3?"<math>":"",a=Gs;for(let l=0;l<t;l++){const n=i[l];let c,h,d=-1,f=0;for(;f<n.length&&(a.lastIndex=f,h=a.exec(n),h!==null);)f=a.lastIndex,a===Gs?h[1]==="!--"?a=Vc:h[1]!==void 0?a=jc:h[2]!==void 0?(Xd.test(h[2])&&(r=RegExp("</"+h[2],"g")),a=ui):h[3]!==void 0&&(a=ui):a===ui?h[0]===">"?(a=r??Gs,d=-1):h[1]===void 0?d=-2:(d=a.lastIndex-h[2].length,c=h[1],a=h[3]===void 0?ui:h[3]==='"'?qc:Wc):a===qc||a===Wc?a=ui:a===Vc||a===jc?a=Gs:(a=ui,r=void 0);const g=a===ui&&i[l+1].startsWith("/>")?" ":"";o+=a===Gs?n+zp:d>=0?(s.push(c),n.slice(0,d)+Qd+n.slice(d)+Kt+g):n+Kt+(d===-2?l:g)}return[Jd(i,o+(i[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),s]};let Fn=class e1{constructor({strings:e,_$litType$:t},s){let r;this.parts=[];let o=0,a=0;const l=e.length-1,n=this.parts,[c,h]=Np(e,t);if(this.el=e1.createElement(c,s),Ai.currentNode=this.el.content,t===2||t===3){const d=this.el.content.firstChild;d.replaceWith(...d.childNodes)}for(;(r=Ai.nextNode())!==null&&n.length<l;){if(r.nodeType===1){if(r.hasAttributes())for(const d of r.getAttributeNames())if(d.endsWith(Qd)){const f=h[a++],g=r.getAttribute(d).split(Kt),$=/([.?@])?(.*)/.exec(f);n.push({type:1,index:o,name:$[2],strings:g,ctor:$[1]==="."?Up:$[1]==="?"?Vp:$[1]==="@"?jp:Jo}),r.removeAttribute(d)}else d.startsWith(Kt)&&(n.push({type:6,index:o}),r.removeAttribute(d));if(Xd.test(r.tagName)){const d=r.textContent.split(Kt),f=d.length-1;if(f>0){r.textContent=Mo?Mo.emptyScript:"";for(let g=0;g<f;g++)r.append(d[g],Ar()),Ai.nextNode(),n.push({type:2,index:++o});r.append(d[f],Ar())}}}else if(r.nodeType===8)if(r.data===Kd)n.push({type:2,index:o});else{let d=-1;for(;(d=r.data.indexOf(Kt,d+1))!==-1;)n.push({type:7,index:o}),d+=Kt.length-1}o++}}static createElement(e,t){const s=Hi.createElement("template");return s.innerHTML=e,s}};function gs(i,e,t=i,s){var a,l;if(e===ms)return e;let r=s!==void 0?(a=t._$Co)==null?void 0:a[s]:t._$Cl;const o=kr(e)?void 0:e._$litDirective$;return(r==null?void 0:r.constructor)!==o&&((l=r==null?void 0:r._$AO)==null||l.call(r,!1),o===void 0?r=void 0:(r=new o(i),r._$AT(i,t,s)),s!==void 0?(t._$Co??(t._$Co=[]))[s]=r:t._$Cl=r),r!==void 0&&(e=gs(i,r._$AS(i,e.values),r,s)),e}let Hp=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:t},parts:s}=this._$AD,r=((e==null?void 0:e.creationScope)??Hi).importNode(t,!0);Ai.currentNode=r;let o=Ai.nextNode(),a=0,l=0,n=s[0];for(;n!==void 0;){if(a===n.index){let c;n.type===2?c=new kl(o,o.nextSibling,this,e):n.type===1?c=new n.ctor(o,n.name,n.strings,this,e):n.type===6&&(c=new Wp(o,this,e)),this._$AV.push(c),n=s[++l]}a!==(n==null?void 0:n.index)&&(o=Ai.nextNode(),a++)}return Ai.currentNode=Hi,r}p(e){let t=0;for(const s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(e,s,t),t+=s.strings.length-2):s._$AI(e[t])),t++}},kl=class t1{get _$AU(){var e;return((e=this._$AM)==null?void 0:e._$AU)??this._$Cv}constructor(e,t,s,r){this.type=2,this._$AH=b,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=s,this.options=r,this._$Cv=(r==null?void 0:r.isConnected)??!0}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=gs(this,e,t),kr(e)?e===b||e==null||e===""?(this._$AH!==b&&this._$AR(),this._$AH=b):e!==this._$AH&&e!==ms&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):Ip(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==b&&kr(this._$AH)?this._$AA.nextSibling.data=e:this.T(Hi.createTextNode(e)),this._$AH=e}$(e){var o;const{values:t,_$litType$:s}=e,r=typeof s=="number"?this._$AC(e):(s.el===void 0&&(s.el=Fn.createElement(Jd(s.h,s.h[0]),this.options)),s);if(((o=this._$AH)==null?void 0:o._$AD)===r)this._$AH.p(t);else{const a=new Hp(r,this),l=a.u(this.options);a.p(t),this.T(l),this._$AH=a}}_$AC(e){let t=Gc.get(e.strings);return t===void 0&&Gc.set(e.strings,t=new Fn(e)),t}k(e){Al(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let s,r=0;for(const o of e)r===t.length?t.push(s=new t1(this.O(Ar()),this.O(Ar()),this,this.options)):s=t[r],s._$AI(o),r++;r<t.length&&(this._$AR(s&&s._$AB.nextSibling,r),t.length=r)}_$AR(e=this._$AA.nextSibling,t){var s;for((s=this._$AP)==null?void 0:s.call(this,!1,!0,t);e!==this._$AB;){const r=Hc(e).nextSibling;Hc(e).remove(),e=r}}setConnected(e){var t;this._$AM===void 0&&(this._$Cv=e,(t=this._$AP)==null||t.call(this,e))}},Jo=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,s,r,o){this.type=1,this._$AH=b,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=o,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=b}_$AI(e,t=this,s,r){const o=this.strings;let a=!1;if(o===void 0)e=gs(this,e,t,0),a=!kr(e)||e!==this._$AH&&e!==ms,a&&(this._$AH=e);else{const l=e;let n,c;for(e=o[0],n=0;n<o.length-1;n++)c=gs(this,l[s+n],t,n),c===ms&&(c=this._$AH[n]),a||(a=!kr(c)||c!==this._$AH[n]),c===b?e=b:e!==b&&(e+=(c??"")+o[n+1]),this._$AH[n]=c}a&&!r&&this.j(e)}j(e){e===b?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},Up=class extends Jo{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===b?void 0:e}},Vp=class extends Jo{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==b)}},jp=class extends Jo{constructor(e,t,s,r,o){super(e,t,s,r,o),this.type=5}_$AI(e,t=this){if((e=gs(this,e,t,0)??b)===ms)return;const s=this._$AH,r=e===b&&s!==b||e.capture!==s.capture||e.once!==s.once||e.passive!==s.passive,o=e!==b&&(s===b||r);r&&this.element.removeEventListener(this.name,this,s),o&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t;typeof this._$AH=="function"?this._$AH.call(((t=this.options)==null?void 0:t.host)??this.element,e):this._$AH.handleEvent(e)}},Wp=class{constructor(e,t,s){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(e){gs(this,e)}};const Da=vr.litHtmlPolyfillSupport;Da==null||Da(Fn,kl),(vr.litHtmlVersions??(vr.litHtmlVersions=[])).push("3.3.2");const qp=(i,e,t)=>{const s=(t==null?void 0:t.renderBefore)??e;let r=s._$litPart$;if(r===void 0){const o=(t==null?void 0:t.renderBefore)??null;s._$litPart$=r=new kl(e.insertBefore(Ar(),o),o,void 0,t??{})}return r._$AI(i),r};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Fi=globalThis;let H=class extends as{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var t;const e=super.createRenderRoot();return(t=this.renderOptions).renderBefore??(t.renderBefore=e.firstChild),e}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=qp(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)==null||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)==null||e.setConnected(!1)}render(){return ms}};var Rd;H._$litElement$=!0,H.finalized=!0,(Rd=Fi.litElementHydrateSupport)==null||Rd.call(Fi,{LitElement:H});const La=Fi.litElementPolyfillSupport;La==null||La({LitElement:H});(Fi.litElementVersions??(Fi.litElementVersions=[])).push("4.2.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Gp={attribute:!0,type:String,converter:Ao,reflect:!1,hasChanged:xl},Yp=(i=Gp,e,t)=>{const{kind:s,metadata:r}=t;let o=globalThis.litPropertyMetadata.get(r);if(o===void 0&&globalThis.litPropertyMetadata.set(r,o=new Map),s==="setter"&&((i=Object.create(i)).wrapped=!0),o.set(t.name,i),s==="accessor"){const{name:a}=t;return{set(l){const n=e.get.call(this);e.set.call(this,l),this.requestUpdate(a,n,i,!0,l)},init(l){return l!==void 0&&this.C(a,void 0,i,l),l}}}if(s==="setter"){const{name:a}=t;return function(l){const n=this[a];e.call(this,l),this.requestUpdate(a,n,i,!0,l)}}throw Error("Unsupported decorator location: "+s)};function u(i){return(e,t)=>typeof t=="object"?Yp(i,e,t):((s,r,o)=>{const a=r.hasOwnProperty(o);return r.constructor.createProperty(o,s),a?Object.getOwnPropertyDescriptor(r,o):void 0})(i,e,t)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Qp=(i,e,t)=>(t.configurable=!0,t.enumerable=!0,Reflect.decorate&&typeof e!="object"&&Object.defineProperty(i,e,t),t);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function ee(i,e){return(t,s,r)=>{const o=a=>{var l;return((l=a.renderRoot)==null?void 0:l.querySelector(i))??null};return Qp(t,s,{get(){return o(this)}})}}class Kp{constructor(){this.resizeObserver=new ResizeObserver(e=>{window.requestAnimationFrame(()=>{for(const t of e){const s=this.resizeHandlers.get(t.target);s==null||s.forEach(r=>{r.handleResize(t)})}})}),this.resizeHandlers=new Map}shutdown(){this.resizeHandlers.forEach((e,t)=>{this.resizeObserver.unobserve(t)}),this.resizeHandlers.clear()}addObserver(e){var t;const s=(t=this.resizeHandlers.get(e.target))!==null&&t!==void 0?t:new Set;s.add(e.handler),this.resizeHandlers.set(e.target,s),this.resizeObserver.observe(e.target,e.options)}removeObserver(e){const t=this.resizeHandlers.get(e.target);t&&(t.delete(e.handler),t.size===0&&(this.resizeObserver.unobserve(e.target),this.resizeHandlers.delete(e.target)))}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const St={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4},jr=i=>(...e)=>({_$litDirective$:i,values:e});let Wr=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,s){this._$Ct=e,this._$AM=t,this._$Ci=s}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}};/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Qe=jr(class extends Wr{constructor(i){var e;if(super(i),i.type!==St.ATTRIBUTE||i.name!=="class"||((e=i.strings)==null?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(i){return" "+Object.keys(i).filter(e=>i[e]).join(" ")+" "}update(i,[e]){var s,r;if(this.st===void 0){this.st=new Set,i.strings!==void 0&&(this.nt=new Set(i.strings.join(" ").split(/\s/).filter(o=>o!=="")));for(const o in e)e[o]&&!((s=this.nt)!=null&&s.has(o))&&this.st.add(o);return this.render(e)}const t=i.element.classList;for(const o of this.st)o in e||(t.remove(o),this.st.delete(o));for(const o in e){const a=!!e[o];a===this.st.has(o)||(r=this.nt)!=null&&r.has(o)||(a?(t.add(o),this.st.add(o)):(t.remove(o),this.st.delete(o)))}return tt}});/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Xp=(i,...e)=>({strTag:!0,strings:i,values:e}),ht=Xp,Zp=i=>typeof i!="string"&&"strTag"in i,Jp=(i,e,t)=>{let s=i[0];for(let r=1;r<i.length;r++)s+=e[r-1],s+=i[r];return s};/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const eu=i=>Zp(i)?Jp(i.strings,i.values):i;let S=eu;/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let tu=class{constructor(){this.settled=!1,this.promise=new Promise((e,t)=>{this._resolve=e,this._reject=t})}resolve(e){this.settled=!0,this._resolve(e)}reject(e){this.settled=!0,this._reject(e)}};/**
 * @license
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let iu=new tu;iu.resolve();/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const uo=window,El=uo.ShadowRoot&&(uo.ShadyCSS===void 0||uo.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Ml=Symbol(),Yc=new WeakMap;let i1=class{constructor(e,t,s){if(this._$cssResult$=!0,s!==Ml)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o;const t=this.t;if(El&&e===void 0){const s=t!==void 0&&t.length===1;s&&(e=Yc.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),s&&Yc.set(t,e))}return e}toString(){return this.cssText}};const su=i=>new i1(typeof i=="string"?i:i+"",void 0,Ml),x=(i,...e)=>{const t=i.length===1?i[0]:e.reduce((s,r,o)=>s+(a=>{if(a._$cssResult$===!0)return a.cssText;if(typeof a=="number")return a;throw Error("Value passed to 'css' function must be a 'css' function result: "+a+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(r)+i[o+1],i[0]);return new i1(t,i,Ml)},ru=(i,e)=>{El?i.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet):e.forEach(t=>{const s=document.createElement("style"),r=uo.litNonce;r!==void 0&&s.setAttribute("nonce",r),s.textContent=t.cssText,i.appendChild(s)})},Qc=El?i=>i:i=>i instanceof CSSStyleSheet?(e=>{let t="";for(const s of e.cssRules)t+=s.cssText;return su(t)})(i):i;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Ba;const Po=window,Kc=Po.trustedTypes,ou=Kc?Kc.emptyScript:"",Xc=Po.reactiveElementPolyfillSupport,Rn={toAttribute(i,e){switch(e){case Boolean:i=i?ou:null;break;case Object:case Array:i=i==null?i:JSON.stringify(i)}return i},fromAttribute(i,e){let t=i;switch(e){case Boolean:t=i!==null;break;case Number:t=i===null?null:Number(i);break;case Object:case Array:try{t=JSON.parse(i)}catch{t=null}}return t}},s1=(i,e)=>e!==i&&(e==e||i==i),Fa={attribute:!0,type:String,converter:Rn,reflect:!1,hasChanged:s1},zn="finalized";let dt=class extends HTMLElement{constructor(){super(),this._$Ei=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$El=null,this._$Eu()}static addInitializer(e){var t;this.finalize(),((t=this.h)!==null&&t!==void 0?t:this.h=[]).push(e)}static get observedAttributes(){this.finalize();const e=[];return this.elementProperties.forEach((t,s)=>{const r=this._$Ep(s,t);r!==void 0&&(this._$Ev.set(r,s),e.push(r))}),e}static createProperty(e,t=Fa){if(t.state&&(t.attribute=!1),this.finalize(),this.elementProperties.set(e,t),!t.noAccessor&&!this.prototype.hasOwnProperty(e)){const s=typeof e=="symbol"?Symbol():"__"+e,r=this.getPropertyDescriptor(e,s,t);r!==void 0&&Object.defineProperty(this.prototype,e,r)}}static getPropertyDescriptor(e,t,s){return{get(){return this[t]},set(r){const o=this[e];this[t]=r,this.requestUpdate(e,o,s)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)||Fa}static finalize(){if(this.hasOwnProperty(zn))return!1;this[zn]=!0;const e=Object.getPrototypeOf(this);if(e.finalize(),e.h!==void 0&&(this.h=[...e.h]),this.elementProperties=new Map(e.elementProperties),this._$Ev=new Map,this.hasOwnProperty("properties")){const t=this.properties,s=[...Object.getOwnPropertyNames(t),...Object.getOwnPropertySymbols(t)];for(const r of s)this.createProperty(r,t[r])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const s=new Set(e.flat(1/0).reverse());for(const r of s)t.unshift(Qc(r))}else e!==void 0&&t.push(Qc(e));return t}static _$Ep(e,t){const s=t.attribute;return s===!1?void 0:typeof s=="string"?s:typeof e=="string"?e.toLowerCase():void 0}_$Eu(){var e;this._$E_=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$Eg(),this.requestUpdate(),(e=this.constructor.h)===null||e===void 0||e.forEach(t=>t(this))}addController(e){var t,s;((t=this._$ES)!==null&&t!==void 0?t:this._$ES=[]).push(e),this.renderRoot!==void 0&&this.isConnected&&((s=e.hostConnected)===null||s===void 0||s.call(e))}removeController(e){var t;(t=this._$ES)===null||t===void 0||t.splice(this._$ES.indexOf(e)>>>0,1)}_$Eg(){this.constructor.elementProperties.forEach((e,t)=>{this.hasOwnProperty(t)&&(this._$Ei.set(t,this[t]),delete this[t])})}createRenderRoot(){var e;const t=(e=this.shadowRoot)!==null&&e!==void 0?e:this.attachShadow(this.constructor.shadowRootOptions);return ru(t,this.constructor.elementStyles),t}connectedCallback(){var e;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$ES)===null||e===void 0||e.forEach(t=>{var s;return(s=t.hostConnected)===null||s===void 0?void 0:s.call(t)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$ES)===null||e===void 0||e.forEach(t=>{var s;return(s=t.hostDisconnected)===null||s===void 0?void 0:s.call(t)})}attributeChangedCallback(e,t,s){this._$AK(e,s)}_$EO(e,t,s=Fa){var r;const o=this.constructor._$Ep(e,s);if(o!==void 0&&s.reflect===!0){const a=(((r=s.converter)===null||r===void 0?void 0:r.toAttribute)!==void 0?s.converter:Rn).toAttribute(t,s.type);this._$El=e,a==null?this.removeAttribute(o):this.setAttribute(o,a),this._$El=null}}_$AK(e,t){var s;const r=this.constructor,o=r._$Ev.get(e);if(o!==void 0&&this._$El!==o){const a=r.getPropertyOptions(o),l=typeof a.converter=="function"?{fromAttribute:a.converter}:((s=a.converter)===null||s===void 0?void 0:s.fromAttribute)!==void 0?a.converter:Rn;this._$El=o,this[o]=l.fromAttribute(t,a.type),this._$El=null}}requestUpdate(e,t,s){let r=!0;e!==void 0&&(((s=s||this.constructor.getPropertyOptions(e)).hasChanged||s1)(this[e],t)?(this._$AL.has(e)||this._$AL.set(e,t),s.reflect===!0&&this._$El!==e&&(this._$EC===void 0&&(this._$EC=new Map),this._$EC.set(e,s))):r=!1),!this.isUpdatePending&&r&&(this._$E_=this._$Ej())}async _$Ej(){this.isUpdatePending=!0;try{await this._$E_}catch(t){Promise.reject(t)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var e;if(!this.isUpdatePending)return;this.hasUpdated,this._$Ei&&(this._$Ei.forEach((r,o)=>this[o]=r),this._$Ei=void 0);let t=!1;const s=this._$AL;try{t=this.shouldUpdate(s),t?(this.willUpdate(s),(e=this._$ES)===null||e===void 0||e.forEach(r=>{var o;return(o=r.hostUpdate)===null||o===void 0?void 0:o.call(r)}),this.update(s)):this._$Ek()}catch(r){throw t=!1,this._$Ek(),r}t&&this._$AE(s)}willUpdate(e){}_$AE(e){var t;(t=this._$ES)===null||t===void 0||t.forEach(s=>{var r;return(r=s.hostUpdated)===null||r===void 0?void 0:r.call(s)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$Ek(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$E_}shouldUpdate(e){return!0}update(e){this._$EC!==void 0&&(this._$EC.forEach((t,s)=>this._$EO(s,this[s],t)),this._$EC=void 0),this._$Ek()}updated(e){}firstUpdated(e){}};dt[zn]=!0,dt.elementProperties=new Map,dt.elementStyles=[],dt.shadowRootOptions={mode:"open"},Xc==null||Xc({ReactiveElement:dt}),((Ba=Po.reactiveElementVersions)!==null&&Ba!==void 0?Ba:Po.reactiveElementVersions=[]).push("1.6.3");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Ra;const Oo=window,vs=Oo.trustedTypes,Zc=vs?vs.createPolicy("lit-html",{createHTML:i=>i}):void 0,In="$lit$",Xt=`lit$${(Math.random()+"").slice(9)}$`,r1="?"+Xt,au=`<${r1}>`,Ui=document,Er=()=>Ui.createComment(""),Mr=i=>i===null||typeof i!="object"&&typeof i!="function",o1=Array.isArray,nu=i=>o1(i)||typeof(i==null?void 0:i[Symbol.iterator])=="function",za=`[ 	
\f\r]`,Ys=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Jc=/-->/g,eh=/>/g,fi=RegExp(`>|${za}(?:([^\\s"'>=/]+)(${za}*=${za}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),th=/'/g,ih=/"/g,a1=/^(?:script|style|textarea|title)$/i,lu=i=>(e,...t)=>({_$litType$:i,strings:e,values:t}),sh=lu(1),Vi=Symbol.for("lit-noChange"),ge=Symbol.for("lit-nothing"),rh=new WeakMap,ki=Ui.createTreeWalker(Ui,129,null,!1);function n1(i,e){if(!Array.isArray(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return Zc!==void 0?Zc.createHTML(e):e}const cu=(i,e)=>{const t=i.length-1,s=[];let r,o=e===2?"<svg>":"",a=Ys;for(let l=0;l<t;l++){const n=i[l];let c,h,d=-1,f=0;for(;f<n.length&&(a.lastIndex=f,h=a.exec(n),h!==null);)f=a.lastIndex,a===Ys?h[1]==="!--"?a=Jc:h[1]!==void 0?a=eh:h[2]!==void 0?(a1.test(h[2])&&(r=RegExp("</"+h[2],"g")),a=fi):h[3]!==void 0&&(a=fi):a===fi?h[0]===">"?(a=r??Ys,d=-1):h[1]===void 0?d=-2:(d=a.lastIndex-h[2].length,c=h[1],a=h[3]===void 0?fi:h[3]==='"'?ih:th):a===ih||a===th?a=fi:a===Jc||a===eh?a=Ys:(a=fi,r=void 0);const g=a===fi&&i[l+1].startsWith("/>")?" ":"";o+=a===Ys?n+au:d>=0?(s.push(c),n.slice(0,d)+In+n.slice(d)+Xt+g):n+Xt+(d===-2?(s.push(void 0),l):g)}return[n1(i,o+(i[t]||"<?>")+(e===2?"</svg>":"")),s]};let Nn=class l1{constructor({strings:e,_$litType$:t},s){let r;this.parts=[];let o=0,a=0;const l=e.length-1,n=this.parts,[c,h]=cu(e,t);if(this.el=l1.createElement(c,s),ki.currentNode=this.el.content,t===2){const d=this.el.content,f=d.firstChild;f.remove(),d.append(...f.childNodes)}for(;(r=ki.nextNode())!==null&&n.length<l;){if(r.nodeType===1){if(r.hasAttributes()){const d=[];for(const f of r.getAttributeNames())if(f.endsWith(In)||f.startsWith(Xt)){const g=h[a++];if(d.push(f),g!==void 0){const $=r.getAttribute(g.toLowerCase()+In).split(Xt),w=/([.?@])?(.*)/.exec(g);n.push({type:1,index:o,name:w[2],strings:$,ctor:w[1]==="."?du:w[1]==="?"?uu:w[1]==="@"?fu:ta})}else n.push({type:6,index:o})}for(const f of d)r.removeAttribute(f)}if(a1.test(r.tagName)){const d=r.textContent.split(Xt),f=d.length-1;if(f>0){r.textContent=vs?vs.emptyScript:"";for(let g=0;g<f;g++)r.append(d[g],Er()),ki.nextNode(),n.push({type:2,index:++o});r.append(d[f],Er())}}}else if(r.nodeType===8)if(r.data===r1)n.push({type:2,index:o});else{let d=-1;for(;(d=r.data.indexOf(Xt,d+1))!==-1;)n.push({type:7,index:o}),d+=Xt.length-1}o++}}static createElement(e,t){const s=Ui.createElement("template");return s.innerHTML=e,s}};function bs(i,e,t=i,s){var r,o,a,l;if(e===Vi)return e;let n=s!==void 0?(r=t._$Co)===null||r===void 0?void 0:r[s]:t._$Cl;const c=Mr(e)?void 0:e._$litDirective$;return(n==null?void 0:n.constructor)!==c&&((o=n==null?void 0:n._$AO)===null||o===void 0||o.call(n,!1),c===void 0?n=void 0:(n=new c(i),n._$AT(i,t,s)),s!==void 0?((a=(l=t)._$Co)!==null&&a!==void 0?a:l._$Co=[])[s]=n:t._$Cl=n),n!==void 0&&(e=bs(i,n._$AS(i,e.values),n,s)),e}let hu=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){var t;const{el:{content:s},parts:r}=this._$AD,o=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:Ui).importNode(s,!0);ki.currentNode=o;let a=ki.nextNode(),l=0,n=0,c=r[0];for(;c!==void 0;){if(l===c.index){let h;c.type===2?h=new ea(a,a.nextSibling,this,e):c.type===1?h=new c.ctor(a,c.name,c.strings,this,e):c.type===6&&(h=new mu(a,this,e)),this._$AV.push(h),c=r[++n]}l!==(c==null?void 0:c.index)&&(a=ki.nextNode(),l++)}return ki.currentNode=Ui,o}v(e){let t=0;for(const s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(e,s,t),t+=s.strings.length-2):s._$AI(e[t])),t++}},ea=class c1{constructor(e,t,s,r){var o;this.type=2,this._$AH=ge,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=s,this.options=r,this._$Cp=(o=r==null?void 0:r.isConnected)===null||o===void 0||o}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cp}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=bs(this,e,t),Mr(e)?e===ge||e==null||e===""?(this._$AH!==ge&&this._$AR(),this._$AH=ge):e!==this._$AH&&e!==Vi&&this._(e):e._$litType$!==void 0?this.g(e):e.nodeType!==void 0?this.$(e):nu(e)?this.T(e):this._(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==ge&&Mr(this._$AH)?this._$AA.nextSibling.data=e:this.$(Ui.createTextNode(e)),this._$AH=e}g(e){var t;const{values:s,_$litType$:r}=e,o=typeof r=="number"?this._$AC(e):(r.el===void 0&&(r.el=Nn.createElement(n1(r.h,r.h[0]),this.options)),r);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===o)this._$AH.v(s);else{const a=new hu(o,this),l=a.u(this.options);a.v(s),this.$(l),this._$AH=a}}_$AC(e){let t=rh.get(e.strings);return t===void 0&&rh.set(e.strings,t=new Nn(e)),t}T(e){o1(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let s,r=0;for(const o of e)r===t.length?t.push(s=new c1(this.k(Er()),this.k(Er()),this,this.options)):s=t[r],s._$AI(o),r++;r<t.length&&(this._$AR(s&&s._$AB.nextSibling,r),t.length=r)}_$AR(e=this._$AA.nextSibling,t){var s;for((s=this._$AP)===null||s===void 0||s.call(this,!1,!0,t);e&&e!==this._$AB;){const r=e.nextSibling;e.remove(),e=r}}setConnected(e){var t;this._$AM===void 0&&(this._$Cp=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}},ta=class{constructor(e,t,s,r,o){this.type=1,this._$AH=ge,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=o,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=ge}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,s,r){const o=this.strings;let a=!1;if(o===void 0)e=bs(this,e,t,0),a=!Mr(e)||e!==this._$AH&&e!==Vi,a&&(this._$AH=e);else{const l=e;let n,c;for(e=o[0],n=0;n<o.length-1;n++)c=bs(this,l[s+n],t,n),c===Vi&&(c=this._$AH[n]),a||(a=!Mr(c)||c!==this._$AH[n]),c===ge?e=ge:e!==ge&&(e+=(c??"")+o[n+1]),this._$AH[n]=c}a&&!r&&this.j(e)}j(e){e===ge?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},du=class extends ta{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===ge?void 0:e}};const pu=vs?vs.emptyScript:"";let uu=class extends ta{constructor(){super(...arguments),this.type=4}j(e){e&&e!==ge?this.element.setAttribute(this.name,pu):this.element.removeAttribute(this.name)}},fu=class extends ta{constructor(e,t,s,r,o){super(e,t,s,r,o),this.type=5}_$AI(e,t=this){var s;if((e=(s=bs(this,e,t,0))!==null&&s!==void 0?s:ge)===Vi)return;const r=this._$AH,o=e===ge&&r!==ge||e.capture!==r.capture||e.once!==r.once||e.passive!==r.passive,a=e!==ge&&(r===ge||o);o&&this.element.removeEventListener(this.name,this,r),a&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,s;typeof this._$AH=="function"?this._$AH.call((s=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&s!==void 0?s:this.element,e):this._$AH.handleEvent(e)}},mu=class{constructor(e,t,s){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(e){bs(this,e)}};const gu={I:ea},oh=Oo.litHtmlPolyfillSupport;oh==null||oh(Nn,ea),((Ra=Oo.litHtmlVersions)!==null&&Ra!==void 0?Ra:Oo.litHtmlVersions=[]).push("2.8.0");const fo=(i,e,t)=>{var s,r;const o=(s=t==null?void 0:t.renderBefore)!==null&&s!==void 0?s:e;let a=o._$litPart$;if(a===void 0){const l=(r=t==null?void 0:t.renderBefore)!==null&&r!==void 0?r:null;o._$litPart$=a=new ea(e.insertBefore(Er(),l),l,void 0,t??{})}return a._$AI(i),a};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Ia,Na;let br=class extends dt{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e,t;const s=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=s.firstChild),s}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=fo(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!1)}render(){return Vi}};br.finalized=!0,br._$litElement$=!0,(Ia=globalThis.litElementHydrateSupport)===null||Ia===void 0||Ia.call(globalThis,{LitElement:br});const ah=globalThis.litElementPolyfillSupport;ah==null||ah({LitElement:br});((Na=globalThis.litElementVersions)!==null&&Na!==void 0?Na:globalThis.litElementVersions=[]).push("3.3.3");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Tt=i=>e=>typeof e=="function"?((t,s)=>(customElements.define(t,s),s))(i,e):((t,s)=>{const{kind:r,elements:o}=s;return{kind:r,elements:o,finisher(a){customElements.define(t,a)}}})(i,e);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const vu=(i,e)=>e.kind==="method"&&e.descriptor&&!("value"in e.descriptor)?{...e,finisher(t){t.createProperty(e.key,i)}}:{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){typeof e.initializer=="function"&&(this[e.key]=e.initializer.call(this))},finisher(t){t.createProperty(e.key,i)}},bu=(i,e,t)=>{e.constructor.createProperty(t,i)};function E(i){return(e,t)=>t!==void 0?bu(i,e,t):vu(i,e)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function be(i){return E({...i,state:!0})}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Pl=({finisher:i,descriptor:e})=>(t,s)=>{var r;if(s===void 0){const o=(r=t.originalKey)!==null&&r!==void 0?r:t.key,a=e!=null?{kind:"method",placement:"prototype",key:o,descriptor:e(t.key)}:{...t,key:o};return i!=null&&(a.finisher=function(l){i(l,o)}),a}{const o=t.constructor;e!==void 0&&Object.defineProperty(t,s,e(s)),i==null||i(o,s)}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function qe(i,e){return Pl({descriptor:t=>({get(){var r,o;return(o=(r=this.renderRoot)===null||r===void 0?void 0:r.querySelector(i))!==null&&o!==void 0?o:null},enumerable:!0,configurable:!0})})}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function yu(i){return Pl({descriptor:e=>({get(){var t,s;return(s=(t=this.renderRoot)===null||t===void 0?void 0:t.querySelectorAll(i))!==null&&s!==void 0?s:[]},enumerable:!0,configurable:!0})})}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Ha;const $u=((Ha=window.HTMLSlotElement)===null||Ha===void 0?void 0:Ha.prototype.assignedElements)!=null?(i,e)=>i.assignedElements(e):(i,e)=>i.assignedNodes(e).filter(t=>t.nodeType===Node.ELEMENT_NODE);function h1(i){const{slot:e,selector:t}=i??{};return Pl({descriptor:s=>({get(){var r;const o="slot"+(e?`[name=${e}]`:":not([name])"),a=(r=this.renderRoot)===null||r===void 0?void 0:r.querySelector(o),l=a!=null?$u(a,i):[];return t?l.filter(n=>n.matches(t)):l},enumerable:!0,configurable:!0})})}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const wu={CHILD:2},xu=i=>(...e)=>({_$litDirective$:i,values:e});let _u=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,s){this._$Ct=e,this._$AM=t,this._$Ci=s}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}};/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{I:Su}=gu,nh=()=>document.createComment(""),Qs=(i,e,t)=>{var s;const r=i._$AA.parentNode,o=e===void 0?i._$AB:e._$AA;if(t===void 0){const a=r.insertBefore(nh(),o),l=r.insertBefore(nh(),o);t=new Su(a,l,i,i.options)}else{const a=t._$AB.nextSibling,l=t._$AM,n=l!==i;if(n){let c;(s=t._$AQ)===null||s===void 0||s.call(t,i),t._$AM=i,t._$AP!==void 0&&(c=i._$AU)!==l._$AU&&t._$AP(c)}if(a!==o||n){let c=t._$AA;for(;c!==a;){const h=c.nextSibling;r.insertBefore(c,o),c=h}}}return t},mi=(i,e,t=i)=>(i._$AI(e,t),i),Cu={},Tu=(i,e=Cu)=>i._$AH=e,Au=i=>i._$AH,Ua=i=>{var e;(e=i._$AP)===null||e===void 0||e.call(i,!1,!0);let t=i._$AA;const s=i._$AB.nextSibling;for(;t!==s;){const r=t.nextSibling;t.remove(),t=r}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const lh=(i,e,t)=>{const s=new Map;for(let r=e;r<=t;r++)s.set(i[r],r);return s},ku=xu(class extends _u{constructor(i){if(super(i),i.type!==wu.CHILD)throw Error("repeat() can only be used in text expressions")}ct(i,e,t){let s;t===void 0?t=e:e!==void 0&&(s=e);const r=[],o=[];let a=0;for(const l of i)r[a]=s?s(l,a):a,o[a]=t(l,a),a++;return{values:o,keys:r}}render(i,e,t){return this.ct(i,e,t).values}update(i,[e,t,s]){var r;const o=Au(i),{values:a,keys:l}=this.ct(e,t,s);if(!Array.isArray(o))return this.ut=l,a;const n=(r=this.ut)!==null&&r!==void 0?r:this.ut=[],c=[];let h,d,f=0,g=o.length-1,$=0,w=a.length-1;for(;f<=g&&$<=w;)if(o[f]===null)f++;else if(o[g]===null)g--;else if(n[f]===l[$])c[$]=mi(o[f],a[$]),f++,$++;else if(n[g]===l[w])c[w]=mi(o[g],a[w]),g--,w--;else if(n[f]===l[w])c[w]=mi(o[f],a[w]),Qs(i,c[w+1],o[f]),f++,w--;else if(n[g]===l[$])c[$]=mi(o[g],a[$]),Qs(i,o[f],o[g]),g--,$++;else if(h===void 0&&(h=lh(l,$,w),d=lh(n,f,g)),h.has(n[f]))if(h.has(n[g])){const T=d.get(l[$]),P=T!==void 0?o[T]:null;if(P===null){const O=Qs(i,o[f]);mi(O,a[$]),c[$]=O}else c[$]=mi(P,a[$]),Qs(i,o[f],P),o[T]=null;$++}else Ua(o[g]),g--;else Ua(o[f]),f++;for(;$<=w;){const T=Qs(i,c[w+1]);mi(T,a[$]),c[$++]=T}for(;f<=g;){const T=o[f++];T!==null&&Ua(T)}return this.ut=l,Tu(i,c),Vi}});function ro(i,e,t){return Array.from({length:(e-i)/t+1},(s,r)=>i+r*t)}let Nt=class extends br{constructor(){super(...arguments),this.itemCount=0,this.scrollOptimizationsDisabled=!1,this.intersectionObserver=new IntersectionObserver(e=>{e.forEach(t=>{if(t.target===this.sentinel){t.isIntersecting&&this.dispatchEvent(new Event("scrollThresholdReached"));return}const r=t.target.dataset.cellIndex;if(!r)return;const o=parseInt(r,10);t.isIntersecting?this.visibleCellIndices.add(o):this.visibleCellIndices.delete(o)}),this.scrollOptimizationsDisabled||this.processVisibleCells()}),this.renderedCellIndices=new Set,this.visibleCellIndices=new Set,this.placeholderCellIndices=new Set}reload(){ro(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.removeCell(t)),this.renderedCellIndices.clear(),this.visibleCellIndices.clear(),this.placeholderCellIndices.clear(),this.setupObservations()}refreshCell(e){this.removeCell(e),this.bufferRange.includes(e)&&this.renderCellBuffer([e])}refreshAllVisibleCells(){this.bufferRange.forEach(e=>this.removeCell(e)),this.renderCellBuffer(this.bufferRange)}scrollToCell(e,t){const s=this.cellContainers[e];if(!s)return!1;const r=t?"smooth":"auto";return s.scrollIntoView({behavior:r}),!0}getVisibleCellIndices(){return Array.from(this.visibleCellIndices)}updated(e){(e.has("itemCount")||e.has("scrollOptimizationsDisabled"))&&this.setupObservations()}disconnectedCallback(){this.intersectionObserver.disconnect()}setupObservations(){this.setupIntersectionObserver()}setupIntersectionObserver(){this.intersectionObserver.disconnect(),this.sentinel&&this.intersectionObserver.observe(this.sentinel),this.scrollOptimizationsDisabled?(ro(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.visibleCellIndices.add(t)),this.processVisibleCells()):this.cellContainers.forEach(e=>this.intersectionObserver.observe(e))}render(){var e;const t=this.itemCount-1,s=ro(0,t,1),r=(e=this.ariaLandmarkLabel)!==null&&e!==void 0?e:ge;return sh`
    ...
    `}};p([E({type:Number})],Nt.prototype,"itemCount",void 0);p([E({type:Object})],Nt.prototype,"cellProvider",void 0);p([E({type:Object})],Nt.prototype,"placeholderCellTemplate",void 0);p([E({type:Boolean})],Nt.prototype,"scrollOptimizationsDisabled",void 0);p([E({type:String})],Nt.prototype,"ariaLandmarkLabel",void 0);p([qe("#sentinel")],Nt.prototype,"sentinel",void 0);p([yu(".cell-container")],Nt.prototype,"cellContainers",void 0);Nt=p([Tt("infinite-scroller")],Nt);function Eu(i){return i==null?void 0:i.replace(/%22%22(?!%22%22)(.+?)%22%22/g,"%22$1%22")}function Mu(i){var e,t;return((e=i==null?void 0:i.rawMetadata)==null?void 0:e.hit_type)==="favorited_search"?"search":((t=i.mediatype)==null?void 0:t.value)??"data"}const Pu=q`
  <svg
    viewBox="0 0 100 100"
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{I:Xu}=kp,ph=i=>i,y1=i=>i.strings===void 0,uh=()=>document.createComment(""),Ks=(i,e,t)=>{var o;const s=i._$AA.parentNode,r=e===void 0?i._$AB:e._$AA;if(t===void 0){const a=s.insertBefore(uh(),r),l=s.insertBefore(uh(),r);t=new Xu(a,l,i,i.options)}else{const a=t._$AB.nextSibling,l=t._$AM,n=l!==i;if(n){let c;(o=t._$AQ)==null||o.call(t,i),t._$AM=i,t._$AP!==void 0&&(c=i._$AU)!==l._$AU&&t._$AP(c)}if(a!==r||n){let c=t._$AA;for(;c!==a;){const h=ph(c).nextSibling;ph(s).insertBefore(c,r),c=h}}}return t},gi=(i,e,t=i)=>(i._$AI(e,t),i),Zu={},$1=(i,e=Zu)=>i._$AH=e,Ju=i=>i._$AH,Va=i=>{i._$AR(),i._$AA.remove()};/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const e2=jr(class extends Wr{constructor(i){if(super(i),i.type!==St.PROPERTY&&i.type!==St.ATTRIBUTE&&i.type!==St.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!y1(i))throw Error("`live` bindings can only contain a single expression")}render(i){return i}update(i,[e]){if(e===tt||e===ie)return e;const t=i.element,s=i.name;if(i.type===St.PROPERTY){if(e===t[s])return tt}else if(i.type===St.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(s))return tt}else if(i.type===St.ATTRIBUTE&&t.getAttribute(s)===e+"")return tt;return $1(i),e}});/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function mo(i,e,t){return i?e(i):t==null?void 0:t(i)}function t2(i,e){return e.some(t=>i.has(t))}function i2(i,e){const t=[...i],s=[...e],r=t.length,o=s.length;if(r===0)return!0;let a=0,l=0;for(;l<o;){if(s[l]===t[a]&&(a+=1),a>=r)return!0;l+=1}return!1}const w1=y`
  :host {
    /*
    BASE STYLES
...
`,s2="data:image/svg+xml,%3csvg%20viewBox='0%200%208%204'%20xmlns='http://www.w3.org/2000/svg'%20%3e%3cpath%20d='m6.7226499.58397485c.22976435-.15317623.54019902-.09108929.69337525.13867505.13615665.20423498.10222882.47220947-.06836249.63681849l-.07031256.05655676-3.2773501%202.18490006-3.2773501-2.18490006c-.22976434-.15317623-.29185128-.4636109-.13867505-.69337525.13615665-.20423497.39656688-.27598409.61412572-.18182636l.07924953.04315131%202.7226499%201.81402515z'%20%3e%3c/path%3e%3c/svg%3e",r2="data:image/svg+xml,%3csvg%20viewBox='0%200%208%204'%20xmlns='http://www.w3.org/2000/svg'%20%3e%3cpath%20d='m6.7226499%203.51689722c.22976435.15317623.54019902.0910893.69337525-.13867505.13615665-.20423497.10222882-.47220946-.06836249-.63681849l-.07031256-.05655675-3.2773501-2.18490007-3.2773501%202.18490007c-.22976434.15317623-.29185128.4636109-.13867505.69337524.13615665.20423498.39656688.27598409.61412572.18182636l.07924953-.04315131%202.7226499-1.81402514z'%20%3e%3c/path%3e%3c/svg%3e",o2="data:image/svg+xml,%3csvg%20viewBox='0%200%20100%20100'%20xmlns='http://www.w3.org/2000/svg'%20%3e%3cpath%20d='m50%200c27.6142375%200%2050%2022.3857625%2050%2050s-22.3857625%2050-50%2050-50-22.3857625-50-50%2022.3857625-50%2050-50zm23.8159475%2026.1840525c-1.4033215-1.4033215-3.5816761-1.5592461-5.1572272-.4677738l-.5598841.4677738-18.0988362%2018.0989475-18.0988362-18.0989475-.5598841-.4677738c-1.5755511-1.0914723-3.7539057-.9355477-5.1572272.4677738-1.5787367%201.5787367-1.5787367%204.1383746%200%205.7171113l18.0989475%2018.0988362-18.0989475%2018.0988362c-1.5787367%201.5787367-1.5787367%204.1383746%200%205.7171113%201.4033215%201.4033215%203.5816761%201.5592461%205.1572272.4677738l.5598841-.4677738%2018.0988362-18.0989475%2018.0988362%2018.0989475.5598841.4677738c1.5755511%201.0914723%203.7539057.9355477%205.1572272-.4677738%201.5787367-1.5787367%201.5787367-4.1383746%200-5.7171113l-18.0989475-18.0988362%2018.0989475-18.0988362c1.5787367-1.5787367%201.5787367-4.1383746%200-5.7171113z'%20fill-rule='evenodd'%20%3e%3c/path%3e%3c/svg%3e",a2={all:()=>!0,prefix:(i,e)=>e.startsWith(i),suffix:(i,e)=>e.endsWith(i),substring:(i,e)=>e.includes(i),subsequence:i2},n2="list",l2="substring",c2=i=>i,h2=i=>i.toLocaleLowerCase();let Z=class extends H{constructor(){super(),this.options=[],this.behavior=n2,this.maxAutocompleteEntries=Number.POSITIVE_INFINITY,this.filter=l2,this.caseSensitive=!1,this.sort=!1,this.wrapArrowKeys=!1,this.stayOpen=!1,this.clearable=!1,this.open=!1,this.disabled=!1,this.required=!1,this.value=null,this.hasFocus=!1,this.highlightedOption=null,this.enteredText="",this.filterText="",this.losingFocus=!1,this.optionsByID=new Map,this.optionFilteringValues=new Map,this.optionsRespectingSortFlag=[],this.filteredOptions=[],this.internals=this.attachInternals()}render(){const e=Qe({disabled:this.disabled,focused:this.hasFocus});return m`
    ...
    `}get textInputTemplate(){var t;const e=Qe({"clear-padding":this.clearable&&!this.shouldShowClearButton});return m`
      <input
        ...
        aria-activedescendant=${We((t=this.highlightedOption)==null?void 0:t.id)}
    ...
    `;return[w1,e]}};Z.formAssociated=!0;Z.shadowRootOptions={...H.shadowRootOptions,delegatesFocus:!0};p([u({type:Array})],Z.prototype,"options",void 0);p([u({type:String})],Z.prototype,"placeholder",void 0);p([u({type:String})],Z.prototype,"behavior",void 0);p([u({type:Number,attribute:"max-autocomplete-entries"})],Z.prototype,"maxAutocompleteEntries",void 0);p([u({type:String})],Z.prototype,"filter",void 0);p([u({type:Boolean,reflect:!0,attribute:"case-sensitive"})],Z.prototype,"caseSensitive",void 0);p([u({type:Boolean,reflect:!0})],Z.prototype,"sort",void 0);p([u({type:Boolean,reflect:!0,attribute:"wrap-arrow-keys"})],Z.prototype,"wrapArrowKeys",void 0);p([u({type:Boolean,reflect:!0,attribute:"stay-open"})],Z.prototype,"stayOpen",void 0);p([u({type:Boolean,reflect:!0})],Z.prototype,"clearable",void 0);p([u({type:Boolean,reflect:!0})],Z.prototype,"open",void 0);p([u({type:Boolean,reflect:!0})],Z.prototype,"disabled",void 0);p([u({type:Boolean,reflect:!0})],Z.prototype,"required",void 0);p([u({type:String})],Z.prototype,"value",void 0);p([R()],Z.prototype,"hasFocus",void 0);p([R()],Z.prototype,"highlightedOption",void 0);p([R()],Z.prototype,"enteredText",void 0);p([R()],Z.prototype,"filterText",void 0);p([ee("#main-widget-row")],Z.prototype,"mainWidgetRow",void 0);p([ee("#text-input")],Z.prototype,"textInput",void 0);p([ee("#options-list")],Z.prototype,"optionsList",void 0);Z=p([N("ia-combo-box")],Z);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const x1=(i,e,t)=>{for(const s of e)if(s[0]===i)return(0,s[1])();return t==null?void 0:t()},d2=q`
...
`;var p2=Object.defineProperty,u2=Object.getOwnPropertyDescriptor,qr=(i,e,t,s)=>{for(var r=s>1?void 0:s?u2(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&p2(e,t,r),r};let ce=class extends H{constructor(){super(...arguments),this.placeholderType=null,this.detailMessage=""}render(){return this.placeholderType?m`${this.placeholderTemplate}`:b}get placeholderTemplate(){return m`
      <div
    ...
    `}};ce.MESSAGE_EMPTY_QUERY=S('To begin searching, enter a search term in the box above and hit "Go".');ce.MESSAGE_NO_SEARCH_RESULTS=S("Your search did not match any items in the Archive. Try different keywords or a more general search.");ce.MESSAGE_NO_COLLECTION_RESULTS=S("Your search did not match any items in this collection. Try different keywords or a more general search.");ce.MESSAGE_NO_VIEWABLE_MEMBERS=S("This collection contains no viewable items.");ce.MESSAGE_QUERY_ERROR=S(m`The search engine encountered an error, which might be related to your
      search query.
      <a
        href="https://help.archive.org/help/search-building-powerful-complex-queries/"
      >
        Tips for constructing search queries.
      </a> `);ce.MESSAGE_COLLECTION_ERROR=S(m`The search engine encountered an error while loading this collection.
      If the problem persists, please let us know at
      <a href="mailto:info@archive.org">info@archive.org</a>.`);ce.QUERY_ERROR_DETAILS_MESSAGE=S("Error details:");qr([u({type:String})],ce.prototype,"placeholderType",2);qr([u({type:Boolean})],ce.prototype,"isMobileView",2);qr([u({type:Boolean})],ce.prototype,"isCollection",2);qr([u({type:String})],ce.prototype,"detailMessage",2);ce=qr([N("empty-placeholder")],ce);const _1=q`
...
`;var S1=(i=>(i[i.bytes=0]="bytes",i[i.kilobytes=1]="kilobytes",i[i.megabytes=2]="megabytes",i[i.gigabytes=3]="gigabytes",i[i.terabytes=4]="terabytes",i[i.petabytes=5]="petabytes",i[i.exabytes=6]="exabytes",i[i.zettabytes=7]="zettabytes",i[i.yottabytes=8]="yottabytes",i))(S1||{});function f2(i,e,t=" "){let s=i;if(s===void 0)return b;let r=0;for(;s>1024;)s/=1024,r+=1;const o=10**e;s=Math.round(s*o)/o;let a=S1[r];return a=s===1?a.slice(0,-1):a,`${s.toLocaleString()+t+a}`}const m2=y`var(--tileBackgroundColor, #ffffff)`,g2=y`var(--tileCornerRadius, 4px)`,ra=y`
...
`;function C1(i,e="short",{locale:t="en-US",useLocalTime:s=!1}={}){if(!i)return"";const r=s?{}:{timeZone:"UTC"};switch(e){case"year-only":return`${i.getUTCFullYear()}`;case"short":r.month="short",r.year="numeric";break;case"long":r.year="numeric",r.month="short",r.day="2-digit";break}return new Intl.DateTimeFormat(t,r).format(i)}class fh{constructor(e={}){this.model=e.model,this.baseNavigationUrl=e.baseNavigationUrl,this.collectionPagePath=e.collectionPagePath??"/details/",this.sortParam=e.sortParam,this.creatorFilter=e.creatorFilter}get firstCreatorMatchingFilter(){var t,s;let e;if(this.creatorFilter&&((t=this.model)!=null&&t.creators.length)){const r=this.creatorFilter;e=this.model.creators.find(o=>o.normalize("NFD").replace(/[^A-Z]+/gi,"").toUpperCase().startsWith(r))}return e??((s=this.model)==null?void 0:s.creator)}get accountLabel(){var e;return(e=this.model)!=null&&e.dateAdded?S(ht`Archivist since ${this.model.dateAdded.getFullYear()}`):""}get dateLabel(){var e;switch((e=this.sortParam)==null?void 0:e.field){case"publicdate":return S("Archived");case"reviewdate":return S("Reviewed");case"addeddate":return S("Added");case"date":return S("Published");default:return""}}itemPageUrl(e,t=!1){if(!e||this.baseNavigationUrl==null)return b;const s=t?this.collectionPagePath:"/details/";return`${this.baseNavigationUrl}${s}${e}`}webArchivesCaptureLink(e,t){const r=`https://web.archive.org/web/${t.toISOString().replace(/[TZ:-]/g,"").replace(/\..*/,"")}/${encodeURIComponent(e)}`,o=C1(t,"long");return m` <a href=${r}> ${o} </a> `}}var v2=Object.defineProperty,Xe=(i,e,t,s)=>{for(var r=void 0,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=a(e,t,r)||r);return r&&v2(e,t,r),r};class pe extends H{constructor(){super(...arguments),this.sortParam=null,this.defaultSortParam=null,this.loggedIn=!1,this.suppressBlurring=!1,this.useLocalTime=!1,this.displayValueProvider=new fh}willUpdate(e){(e.has("model")||e.has("baseNavigationUrl")||e.has("collectionPagePath")||e.has("sortParam")||e.has("defaultSortParam")||e.has("creatorFilter"))&&(this.displayValueProvider=new fh({model:this.model,baseNavigationUrl:this.baseNavigationUrl,collectionPagePath:this.collectionPagePath,sortParam:this.sortParam??this.defaultSortParam??void 0,creatorFilter:this.creatorFilter}))}getFormattedDate(e,t){const{useLocalTime:s}=this;return C1(e,t,{useLocalTime:s})}}Xe([u({type:Object})],pe.prototype,"model");Xe([u({type:Number})],pe.prototype,"currentWidth");Xe([u({type:Number})],pe.prototype,"currentHeight");Xe([u({type:String})],pe.prototype,"baseNavigationUrl");Xe([u({type:String})],pe.prototype,"baseImageUrl");Xe([u({type:String})],pe.prototype,"collectionPagePath");Xe([u({type:Object})],pe.prototype,"sortParam");Xe([u({type:Object})],pe.prototype,"defaultSortParam");Xe([u({type:String})],pe.prototype,"creatorFilter");Xe([u({type:Number})],pe.prototype,"mobileBreakpoint");Xe([u({type:Boolean})],pe.prototype,"loggedIn");Xe([u({type:Boolean})],pe.prototype,"suppressBlurring");Xe([u({type:Boolean})],pe.prototype,"useLocalTime");var b2=Object.defineProperty,y2=Object.getOwnPropertyDescriptor,T1=(i,e,t,s)=>{for(var r=s>1?void 0:s?y2(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&b2(e,t,r),r};let qn=class extends H{render(){return m`<div class="icon-overlay">${this.iconTemplate}</div>`}get iconTemplate(){return this.type?m`${d1[this.type]??b}`:b}static get styles(){return y`
      :host {
        position: absolute;
        top: 50%;
        left: 50%;
    ...
    `}};T1([u({type:String})],qn.prototype,"type",2);qn=T1([N("icon-overlay")],qn);var $2=Object.defineProperty,w2=Object.getOwnPropertyDescriptor,A1=(i,e,t,s)=>{for(var r=s>1?void 0:s?w2(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&$2(e,t,r),r};let Gn=class extends H{render(){return m`
      <div class="overlay no-preview">
        <div class="icon-overlay">${this.iconTemplate}</div>
        <p class="text-overlay">${this.textTemplate}</p>
      </div>
    `}get iconTemplate(){return this.type?m`${d1[this.type]??b}`:b}get textTemplate(){return this.type?m`${Du[this.type]??b}`:b}static get styles(){return y`
      :host {
        align-items: center;
        display: flex;
      }
    ...
    `}};A1([u({type:String})],Gn.prototype,"type",2);Gn=A1([N("text-overlay")],Gn);var x2=Object.defineProperty,_2=Object.getOwnPropertyDescriptor,ci=(i,e,t,s)=>{for(var r=s>1?void 0:s?_2(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&x2(e,t,r),r};let Ht=class extends H{constructor(){super(...arguments),this.isCompactTile=!1,this.isListTile=!1,this.loggedIn=!1,this.suppressBlurring=!1,this.viewSize="desktop"}render(){var i;return(i=this.model)!=null&&i.identifier?m`
    ...
    `}};ci([u({type:String})],Ht.prototype,"baseImageUrl",2);ci([u({type:Boolean})],Ht.prototype,"isCompactTile",2);ci([u({type:Boolean})],Ht.prototype,"isListTile",2);ci([u({type:Boolean})],Ht.prototype,"loggedIn",2);ci([u({type:Boolean})],Ht.prototype,"suppressBlurring",2);ci([u({type:Object})],Ht.prototype,"model",2);ci([u({type:String})],Ht.prototype,"viewSize",2);Ht=ci([N("image-block")],Ht);var S2=Object.defineProperty,C2=Object.getOwnPropertyDescriptor,Bl=(i,e,t,s)=>{for(var r=s>1?void 0:s?C2(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&S2(e,t,r),r};let Fo=class extends pe{constructor(){super(...arguments),this.showInfoButton=!1,this.layoutType="default"}render(){const i=Qe({container:!0,minimal:this.layoutType==="minimal"});return m`
      <div class=${i}>
    ...
    >`}get getSizeTemplate(){var e;const i=((e=this.model)==null?void 0:e.collectionSize)??0;return i?m`<span id="item-size">${f2(i,1)}</span>`:""}get infoButtonTemplate(){return this.showInfoButton?m`<button class="info-button" @click=${this.infoButtonPressed}>
          &#9432;
          <span class="sr-only">${S("More info")}</span>
        </button>`:b}infoButtonPressed(i){i.preventDefault();const e=new CustomEvent("infoButtonPressed",{detail:{x:i.clientX,y:i.clientY}});this.dispatchEvent(e)}static get styles(){const i=y`var(--tileBorderColor, #555555)`,e=y`var(--tileBackgroundColor, #666666)`,t=y`#fff`;return[ra,y`
        .container {
          background-color: ${e};
          border: 1px solid ${i};
        }
      ...
      `]}};Bl([u({type:Boolean})],Fo.prototype,"showInfoButton",2);Bl([u({type:String})],Fo.prototype,"layoutType",2);Fo=Bl([N("collection-tile")],Fo);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*Ri(i,e){if(i!==void 0){let t=0;for(const s of i)yield e(s,t++)}}function Fl(i){return i?i.toISOString().endsWith("-01-01T00:00:00.000Z"):!1}const k1=m`
...
`;var A2=Object.defineProperty,k2=Object.getOwnPropertyDescriptor,Gr=(i,e,t,s)=>{for(var r=s>1?void 0:s?k2(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&A2(e,t,r),r};let ys=class extends H{constructor(){super(...arguments),this.title="",this.body="",this.starRating=0,this.viewSize="desktop"}render(){return!this.title&&!this.body&&!this.starRating?b:m`
    ...
    `}static get styles(){return[yt,y`
      ...
      `]}};Gr([u({type:String})],ys.prototype,"title",2);Gr([u({type:String})],ys.prototype,"body",2);Gr([u({type:Number})],ys.prototype,"starRating",2);Gr([u({type:String})],ys.prototype,"viewSize",2);ys=Gr([N("review-block")],ys);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*go(i,e){const t=typeof e=="function";if(i!==void 0){let s=-1;for(const r of i)s>-1&&(yield t?e(s):e),s++,yield r}}var E2=Object.defineProperty,M2=Object.getOwnPropertyDescriptor,Rl=(i,e,t,s)=>{for(var r=s>1?void 0:s?M2(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&E2(e,t,r),r};let Ro=class extends H{constructor(){super(...arguments),this.snippets=[],this.viewSize="desktop"}render(){var i;return(i=this.snippets)!=null&&i.length?m`
      <div class="container">
        <div class="snippet-view ${this.viewSize}">
    ...
    `}};Rl([u({type:Array})],Ro.prototype,"snippets",2);Rl([u({type:String})],Ro.prototype,"viewSize",2);Ro=Rl([N("text-snippet-block")],Ro);const P2=y`
  .drop-shadow {
    overflow: hidden;
    height: 100%;
  }
...
`;var D2=Object.defineProperty,L2=Object.getOwnPropertyDescriptor,At=(i,e,t,s)=>{for(var r=s>1?void 0:s?L2(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&D2(e,t,r),r};let mt=class extends H{constructor(){super(...arguments),this.isListTile=!1,this.isCompactTile=!1,this.loggedIn=!1,this.suppressBlurring=!1,this.isWaveform=!1,this.isNotFound=!1}render(){return m`
    ...
    `}get imageSrc(){var i,e,t;if(this.isNotFound)return this.notFoundSrc;if((i=this.model)!=null&&i.captureDates&&this.model.identifier)try{const s=new URL(this.model.identifier),r=encodeURIComponent(s.hostname);return this.baseImageUrl?`https://web.archive.org/thumb/${r}?generate=1`:b}catch{return`${this.baseImageUrl}/images/notfound.png`}return(e=this.model)!=null&&e.thumbnailUrl?this.model.thumbnailUrl:this.baseImageUrl&&((t=this.model)!=null&&t.identifier)?`${this.baseImageUrl}/services/img/${this.model.identifier}`:b}get notFoundSrc(){return this.baseImageUrl?`${this.baseImageUrl}/images/notfound.png`:b}get hashBasedGradient(){var e;return(e=this.model)!=null&&e.identifier?`waveform-grad${this.hashStrToInt(this.model.identifier)%6}`:"waveform-grad0"}hashStrToInt(i){return i.split("").reduce((e,t)=>e+t.charCodeAt(0),0)}get itemBaseClass(){var i;return{"drop-shadow":!0,"list-box":this.isListTile,"search-image":((i=this.model)==null?void 0:i.mediatype)==="search",[this.hashBasedGradient]:this.isWaveform}}get itemImageClass(){var t,s,r;const e=!!((t=this.model)!=null&&t.contentWarning||(s=this.model)!=null&&s.loginRequired)&&!this.suppressBlurring;return{contain:!this.isCompactTile&&!this.isWaveform,cover:this.isCompactTile,blur:e,waveform:this.isWaveform,"account-image":this.isAccountImage,"collection-image":((r=this.model)==null?void 0:r.mediatype)==="collection"}}get isAccountImage(){var i;return((i=this.model)==null?void 0:i.mediatype)==="account"&&!this.isCompactTile&&!this.isListTile}onLoad(){var i,e;(((i=this.model)==null?void 0:i.mediatype)==="audio"||((e=this.model)==null?void 0:e.mediatype)==="etree")&&this.baseImage.naturalWidth/this.baseImage.naturalHeight===4&&(this.isWaveform=!0)}onError(){this.isNotFound=!0}static get styles(){return[P2,O2,y`
      ...
      `]}};At([u({type:Object})],mt.prototype,"model",2);At([u({type:String})],mt.prototype,"baseImageUrl",2);At([u({type:Boolean})],mt.prototype,"isListTile",2);At([u({type:Boolean})],mt.prototype,"isCompactTile",2);At([u({type:Boolean})],mt.prototype,"loggedIn",2);At([u({type:Boolean})],mt.prototype,"suppressBlurring",2);At([R()],mt.prototype,"isWaveform",2);At([R()],mt.prototype,"isNotFound",2);At([ee("img")],mt.prototype,"baseImage",2);mt=At([N("item-image")],mt);const B2=q`
...
`,M1={account:{color:"#000000",icon:B2,text:"Account"},audio:{color:"#00adef",icon:F2,text:"Audio"},collection:{color:"#4666ff",icon:_1,text:"Collection"},data:{color:"#333333",icon:R2,text:"Data"},etree:{color:"#00adef",icon:z2,text:"E-tree"},film:{color:"#bf1b2c",icon:mh,text:"Film"},image:{color:"#aa99c9",icon:I2,text:"Image"},movies:{color:"#f1644b",icon:mh,text:"Movie"},none:{color:"#00000000",icon:m``,text:""},radio:{color:"#8fdaef",icon:N2,text:"Radio"},software:{color:"#9ecc4f",icon:H2,text:"Software"},texts:{color:"#faab3c",icon:U2,text:"Text"},tv:{color:"#f1644b",icon:V2,text:"TV"},tvCommercial:{color:"#84b648",icon:j2,text:"TV Commercial"},tvFactCheck:{color:"#f1644b",icon:W2,text:"TV Fact Check"},tvQuote:{color:"#fe7a5f",icon:Y2,text:"TV Quote"},video:{color:"#f1644b",icon:q2,text:"Video"},web:{color:"#ffcd27",icon:G2,text:"Web"},search:{color:"#000000",icon:E1,text:"Search"}};var Q2=Object.defineProperty,K2=Object.getOwnPropertyDescriptor,zl=(i,e,t,s)=>{for(var r=s>1?void 0:s?K2(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&Q2(e,t,r),r};const X2="tv_ads",Z2="factchecked",J2=new Set(["tvnews","tvarchive","television"]),e3=new Set(["radio","radioprogram"]);let zo=class extends H{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var i;return this.isTvItem?this.tvDisplayMediatype:this.isRadioItem?"radio":((i=this.model)==null?void 0:i.mediatype)??"none"}get tvDisplayMediatype(){var i,e;return this.isTvCommercial?"tvCommercial":(i=this.model)!=null&&i.isTvSearchResult&&this.isTvFactCheck?"tvFactCheck":(e=this.model)!=null&&e.isTvSearchResult&&this.isTvQuote?"tvQuote":"tv"}get isTvItem(){var i,e;return!!(((i=this.model)==null?void 0:i.mediatype)==="movies"&&((e=this.model)!=null&&e.collections.some(t=>J2.has(t))))}get isTvCommercial(){var i,e,t;return!!((e=(i=this.model)==null?void 0:i.adIds)!=null&&e.length||(t=this.model)!=null&&t.collections.includes(X2))}get isTvFactCheck(){var i,e,t;return!!((e=(i=this.model)==null?void 0:i.factChecks)!=null&&e.length||(t=this.model)!=null&&t.collections.includes(Z2))}get isTvQuote(){var i;return!!((i=this.model)!=null&&i.isClip)}get isRadioItem(){var i,e;return!!(((i=this.model)==null?void 0:i.mediatype)==="audio"&&((e=this.model)!=null&&e.collections.some(t=>e3.has(t))))}render(){const i=M1[this.displayMediatype];return i?m`
      <div
        id="icon"
    ...
    `}};zl([u({type:Object})],zo.prototype,"model",2);zl([u({type:Boolean})],zo.prototype,"showText",2);zo=zl([N("tile-mediatype-icon")],zo);const t3=q`
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path
...
`;function o3(i,e){let t=1;return i>=1e9?t=1e9:i>=1e6?t=1e6:i>=1e3&&e==="short"&&(t=1e3),t}function a3(i=0,e){const t=i/e,s=t<10;let r=0;return s?r=Math.round((t+Number.EPSILON)*10)/10:r=Math.round(t),r}function n3(i,e,t,s){switch(e){case 1e9:return S(t==="short"?ht`${i}B`:ht`${i} billion`);case 1e6:return S(t==="short"?ht`${i}M`:ht`${i} million`);case 1e3:return S(t==="short"?ht`${i}K`:ht`${i} thousand`);default:return new Intl.NumberFormat(s).format(i)}}function Il(i,e="long",t="short",s="en-US"){const r=i??-1;if(r<0)return"";const o=o3(r,e),a=a3(r,o);return n3(a,o,t,s)}var l3=Object.defineProperty,c3=Object.getOwnPropertyDescriptor,kt=(i,e,t,s)=>{for(var r=s>1?void 0:s?c3(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&l3(e,t,r),r};let gt=class extends H{constructor(){super(...arguments),this.showTvClips=!1}render(){return m`
    ...
    `}columnTemplate(i,e,t,s=[]){const r=Il(i??0,"short","short"),o=S(ht`${r} ${e}`),a=e+":";return m`
    ...
    `}get viewsColumnTemplate(){const i=this.viewLabel??S("all-time views");return this.columnTemplate(this.viewCount,i,s3)}get uploadsColumnTemplate(){return this.columnTemplate(this.itemCount,S("uploads"),i3)}get favoritesColumnTemplate(){return this.columnTemplate(this.favCount,S("favorites"),k1)}get reviewsColumnTemplate(){return this.columnTemplate(this.commentCount,S("reviews"),t3,["reviews"])}get tvClipsColumnTemplate(){return this.columnTemplate(this.tvClipCount,S("clips"),r3)}static get styles(){return[yt,y`
        tile-mediatype-icon {
          --iconHeight: 25px;
          --iconWidth: 25px;
        }
      ...
      `]}};kt([u({type:Object})],gt.prototype,"model",2);kt([u({type:String})],gt.prototype,"mediatype",2);kt([u({type:Number})],gt.prototype,"itemCount",2);kt([u({type:Number})],gt.prototype,"viewCount",2);kt([u({type:String})],gt.prototype,"viewLabel",2);kt([u({type:Number})],gt.prototype,"favCount",2);kt([u({type:Number})],gt.prototype,"commentCount",2);kt([u({type:Boolean})],gt.prototype,"showTvClips",2);kt([u({type:Number})],gt.prototype,"tvClipCount",2);gt=kt([N("tile-stats")],gt);var h3=Object.defineProperty,d3=Object.getOwnPropertyDescriptor,oa=(i,e,t,s)=>{for(var r=s>1?void 0:s?d3(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&h3(e,t,r),r};let Pr=class extends pe{constructor(){super(...arguments),this.showInfoButton=!1,this.showTvClips=!1,this.layoutType="default"}render(){var t;const i=(t=this.model)==null?void 0:t.title,e=Qe({container:!0,simple:this.layoutType!=="default","stats-only":this.layoutType==="stats-only","snippets-only":this.layoutType==="snippets-only",minimal:this.layoutType==="minimal"});return m`
      <div class=${e}>
        ${this.infoButtonTemplate}
        <div class="tile-details">
          <div class="item-info">
    ...
    `}get sortedDateInfoTemplate(){var s,r,o,a,l;let i,e="long";switch((s=this.effectiveSort)==null?void 0:s.field){case"date":{const n=(r=this.model)==null?void 0:r.datePublished;i={field:"published",value:n},Fl(n)&&(e="year-only");break}case"reviewdate":i={field:"reviewed",value:(o=this.model)==null?void 0:o.dateReviewed};break;case"addeddate":i={field:"added",value:(a=this.model)==null?void 0:a.dateAdded};break;case"publicdate":i={field:"archived",value:(l=this.model)==null?void 0:l.dateArchived};break}if(!(i!=null&&i.value))return b;const t=this.getFormattedDate(i.value,e);return m`
    ...
    `}get webArchivesCaptureDatesTemplate(){var i;return!((i=this.model)!=null&&i.captureDates)||!this.model.title?b:m`
      <ul class="capture-dates">
        ${Ri(this.model.captureDates,e=>m`<li>
    ...
    `}get isSortedByDate(){var i;return["date","reviewdate","addeddate","publicdate"].includes((i=this.effectiveSort)==null?void 0:i.field)}get effectiveSort(){return this.sortParam??this.defaultSortParam}get hasSnippets(){var i,e;return!!((e=(i=this.model)==null?void 0:i.snippets)!=null&&e.length)}infoButtonPressed(i){i.preventDefault();const e=new CustomEvent("infoButtonPressed",{detail:{x:i.clientX,y:i.clientY}});this.dispatchEvent(e)}static get styles(){const i=y`var(--tileBorderColor, #dddddd)`;return[ra,y`
      ...
      `]}};oa([u({type:Boolean})],Pr.prototype,"showInfoButton",2);oa([u({type:Boolean})],Pr.prototype,"showTvClips",2);oa([u({type:String})],Pr.prototype,"layoutType",2);Pr=oa([N("item-tile")],Pr);var p3=Object.defineProperty,u3=Object.getOwnPropertyDescriptor,P1=(i,e,t,s)=>{for(var r=s>1?void 0:s?u3(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&p3(e,t,r),r};let Yn=class extends pe{constructor(){super(...arguments),this.showInfoButton=!1}render(){return m`
      <div class="container">
        ${this.infoButtonTemplate}
        <div class="tile-details">
          <div class="item-info">
    ...
    >
          ...
          &#9432;
          <span class="sr-only">${S("More info")}</span>
        </button>`:b}infoButtonPressed(i){i.preventDefault();const e=new CustomEvent("infoButtonPressed",{detail:{x:i.clientX,y:i.clientY}});this.dispatchEvent(e)}static get styles(){const i=y`var(--tileBorderColor, #dddddd)`;return[ra,y`
        .container {
          border: 1px solid ${i};
        }
      `]}};P1([u({type:Boolean})],Yn.prototype,"showInfoButton",2);Yn=P1([N("account-tile")],Yn);var f3=Object.defineProperty,m3=Object.getOwnPropertyDescriptor,O1=(i,e,t,s)=>{for(var r=s>1?void 0:s?m3(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&f3(e,t,r),r};let Qn=class extends pe{constructor(){super(...arguments),this.showInfoButton=!1}render(){return m`
      <div class="container">
        <div class="tile-details">
          <div class="item-info">
            ${this.getImageBlockTemplate} ${this.getTitleTemplate}
    ...
    `}get getTitleTemplate(){var i;return m`<div id="title">
      <h3 class="truncated">${(i=this.model)==null?void 0:i.title}</h3>
    </div>`}static get styles(){const i=y`var(--tileBorderColor, #555555)`,e=y`var(--tileBackgroundColor, #666666)`,t=y`#fff`;return[ra,y`
        .container {
          background-color: ${e};
          border: 1px solid ${i};
        }
      ...
      `]}};O1([u({type:Boolean})],Qn.prototype,"showInfoButton",2);Qn=O1([N("search-tile")],Qn);function vo(i,e,t,s=20,r=0){let o=[];if(r>=s)return o;const a=n=>{const c=n.assignedNodes().filter(h=>h.nodeType===1);return c.length>0?vo(c[0].parentElement,e,t,s,r+1):[]},l=Array.from(i.children||[]);for(const n of l)e(n)||(t(n)&&o.push(n),n.shadowRoot!=null?o.push(...vo(n.shadowRoot,e,t,s,r+1)):n.tagName==="SLOT"?o.push(...a(n)):o.push(...vo(n,e,t,s,r+1)));return o}function D1(i){return i.hasAttribute("hidden")||i.hasAttribute("aria-hidden")&&i.getAttribute("aria-hidden")!=="false"||i.style.display==="none"||i.style.opacity==="0"||i.style.visibility==="hidden"||i.style.visibility==="collapse"}function g3(i){return i.hasAttribute("disabled")||i.hasAttribute("aria-disabled")&&i.getAttribute("aria-disabled")!=="false"}function v3(i){return i.getAttribute("tabindex")==="-1"||D1(i)||g3(i)?!1:i.hasAttribute("tabindex")||(i instanceof HTMLAnchorElement||i instanceof HTMLAreaElement)&&i.hasAttribute("href")||i instanceof HTMLButtonElement||i instanceof HTMLInputElement||i instanceof HTMLTextAreaElement||i instanceof HTMLSelectElement||i instanceof HTMLIFrameElement}const ja=new Map;function b3(i,e,t){const s=ja.get(t);s!=null&&window.clearTimeout(s),ja.set(t,window.setTimeout(()=>{i(),ja.delete(t)},e))}const L1=document.createElement("template");L1.innerHTML=`
	<div id="start"></div>
	<div id="backup"></div>
	<slot></slot>
	<div id="end"></div>
`;class y3 extends HTMLElement{constructor(){super(),this.debounceId=Math.random().toString(),this._focused=!1;const e=this.attachShadow({mode:"open"});e.appendChild(L1.content.cloneNode(!0)),this.$backup=e.querySelector("#backup"),this.$start=e.querySelector("#start"),this.$end=e.querySelector("#end"),this.focusLastElement=this.focusLastElement.bind(this),this.focusFirstElement=this.focusFirstElement.bind(this),this.onFocusIn=this.onFocusIn.bind(this),this.onFocusOut=this.onFocusOut.bind(this)}static get observedAttributes(){return["inactive"]}get inactive(){return this.hasAttribute("inactive")}set inactive(e){e?this.setAttribute("inactive",""):this.removeAttribute("inactive")}get focused(){return this._focused}connectedCallback(){this.$start.addEventListener("focus",this.focusLastElement),this.$end.addEventListener("focus",this.focusFirstElement),this.addEventListener("focusin",this.onFocusIn),this.addEventListener("focusout",this.onFocusOut),this.render()}disconnectedCallback(){this.$start.removeEventListener("focus",this.focusLastElement),this.$end.removeEventListener("focus",this.focusFirstElement),this.removeEventListener("focusin",this.onFocusIn),this.removeEventListener("focusout",this.onFocusOut)}attributeChangedCallback(){this.render()}focusFirstElement(){this.trapFocus()}focusLastElement(){this.trapFocus(!0)}getFocusableElements(){return vo(this,D1,v3)}trapFocus(e){if(this.inactive)return;let t=this.getFocusableElements();t.length>0?(e?t[t.length-1].focus():t[0].focus(),this.$backup.setAttribute("tabindex","-1")):(this.$backup.setAttribute("tabindex","0"),this.$backup.focus())}onFocusIn(){this.updateFocused(!0)}onFocusOut(){this.updateFocused(!1)}updateFocused(e){b3(()=>{this.focused!==e&&(this._focused=e,this.render())},0,this.debounceId)}render(){this.$start.setAttribute("tabindex",!this.focused||this.inactive?"-1":"0"),this.$end.setAttribute("tabindex",!this.focused||this.inactive?"-1":"0"),this.focused?this.setAttribute("focused",""):this.removeAttribute("focused")}}window.customElements.define("focus-trap",y3);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let Kn=class extends Wr{constructor(e){if(super(e),this.it=ie,e.type!==St.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===ie||e==null)return this._t=void 0,this.it=e;if(e===tt)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this._t;this.it=e;const t=[e];return t.raw=t,this._t={_$litType$:this.constructor.resultType,strings:t,values:[]}}};Kn.directiveName="unsafeHTML",Kn.resultType=1;const $3=jr(Kn);/*! @license DOMPurify 3.2.4 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/3.2.4/LICENSE */const{entries:B1,setPrototypeOf:gh,isFrozen:w3,getPrototypeOf:x3,getOwnPropertyDescriptor:_3}=Object;let{freeze:Fe,seal:st,create:F1}=Object,{apply:Xn,construct:Zn}=typeof Reflect<"u"&&Reflect;Fe||(Fe=function(e){return e});st||(st=function(e){return e});Xn||(Xn=function(e,t,s){return e.apply(t,s)});Zn||(Zn=function(e,t){return new e(...t)});const ao=Re(Array.prototype.forEach),S3=Re(Array.prototype.lastIndexOf),vh=Re(Array.prototype.pop),Xs=Re(Array.prototype.push),C3=Re(Array.prototype.splice),bo=Re(String.prototype.toLowerCase),Wa=Re(String.prototype.toString),bh=Re(String.prototype.match),Zs=Re(String.prototype.replace),T3=Re(String.prototype.indexOf),A3=Re(String.prototype.trim),lt=Re(Object.prototype.hasOwnProperty),Le=Re(RegExp.prototype.test),Js=k3(TypeError);function Re(i){return function(e){for(var t=arguments.length,s=new Array(t>1?t-1:0),r=1;r<t;r++)s[r-1]=arguments[r];return Xn(i,e,s)}}function k3(i){return function(){for(var e=arguments.length,t=new Array(e),s=0;s<e;s++)t[s]=arguments[s];return Zn(i,t)}}function U(i,e){let t=arguments.length>2&&arguments[2]!==void 0?arguments[2]:bo;gh&&gh(i,null);let s=e.length;for(;s--;){let r=e[s];if(typeof r=="string"){const o=t(r);o!==r&&(w3(e)||(e[s]=o),r=o)}i[r]=!0}return i}function E3(i){for(let e=0;e<i.length;e++)lt(i,e)||(i[e]=null);return i}function Si(i){const e=F1(null);for(const[t,s]of B1(i))lt(i,t)&&(Array.isArray(s)?e[t]=E3(s):s&&typeof s=="object"&&s.constructor===Object?e[t]=Si(s):e[t]=s);return e}function er(i,e){for(;i!==null;){const s=_3(i,e);if(s){if(s.get)return Re(s.get);if(typeof s.value=="function")return Re(s.value)}i=x3(i)}function t(){return null}return t}const yh=Fe(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","section","select","shadow","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),qa=Fe(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","filter","font","g","glyph","glyphref","hkern","image","line","lineargradient","marker","mask","metadata","mpath","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),Ga=Fe(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feDropShadow","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),M3=Fe(["animate","color-profile","cursor","discard","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),Ya=Fe(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover","mprescripts"]),P3=Fe(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),$h=Fe(["#text"]),wh=Fe(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","face","for","headers","height","hidden","high","href","hreflang","id","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","pattern","placeholder","playsinline","popover","popovertarget","popovertargetaction","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","wrap","xmlns","slot"]),Qa=Fe(["accent-height","accumulate","additive","alignment-baseline","amplitude","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","exponent","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","intercept","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","slope","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","tablevalues","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),xh=Fe(["accent","accentunder","align","bevelled","close","columnsalign","columnlines","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lspace","lquote","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),no=Fe(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),O3=st(/\{\{[\w\W]*|[\w\W]*\}\}/gm),D3=st(/<%[\w\W]*|[\w\W]*%>/gm),L3=st(/\$\{[\w\W]*/gm),B3=st(/^data-[\-\w.\u00B7-\uFFFF]+$/),F3=st(/^aria-[\-\w]+$/),R1=st(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),R3=st(/^(?:\w+script|data):/i),z3=st(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),z1=st(/^html$/i),I3=st(/^[a-z][.\w]*(-[.\w]+)+$/i);var _h=Object.freeze({__proto__:null,ARIA_ATTR:F3,ATTR_WHITESPACE:z3,CUSTOM_ELEMENT:I3,DATA_ATTR:B3,DOCTYPE_NAME:z1,ERB_EXPR:D3,IS_ALLOWED_URI:R1,IS_SCRIPT_OR_DATA:R3,MUSTACHE_EXPR:O3,TMPLIT_EXPR:L3});const tr={element:1,text:3,progressingInstruction:7,comment:8,document:9},N3=function(){return typeof window>"u"?null:window},H3=function(e,t){if(typeof e!="object"||typeof e.createPolicy!="function")return null;let s=null;const r="data-tt-policy-suffix";t&&t.hasAttribute(r)&&(s=t.getAttribute(r));const o="dompurify"+(s?"#"+s:"");try{return e.createPolicy(o,{createHTML(a){return a},createScriptURL(a){return a}})}catch{return console.warn("TrustedTypes policy "+o+" could not be created."),null}},Sh=function(){return{afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}};function I1(){let i=arguments.length>0&&arguments[0]!==void 0?arguments[0]:N3();const e=B=>I1(B);if(e.version="3.2.4",e.removed=[],!i||!i.document||i.document.nodeType!==tr.document||!i.Element)return e.isSupported=!1,e;let{document:t}=i;const s=t,r=s.currentScript,{DocumentFragment:o,HTMLTemplateElement:a,Node:l,Element:n,NodeFilter:c,NamedNodeMap:h=i.NamedNodeMap||i.MozNamedAttrMap,HTMLFormElement:d,DOMParser:f,trustedTypes:g}=i,$=n.prototype,w=er($,"cloneNode"),T=er($,"remove"),P=er($,"nextSibling"),O=er($,"childNodes"),D=er($,"parentNode");if(typeof a=="function"){const B=t.createElement("template");B.content&&B.content.ownerDocument&&(t=B.content.ownerDocument)}let z,Y="";const{implementation:fe,createNodeIterator:Ge,createDocumentFragment:Ue,getElementsByTagName:at}=t,{importNode:Mt}=s;let ne=Sh();e.isSupported=typeof B1=="function"&&typeof D=="function"&&fe&&fe.createHTMLDocument!==void 0;const{MUSTACHE_EXPR:Pt,ERB_EXPR:Ot,TMPLIT_EXPR:Dt,DATA_ATTR:hi,ARIA_ATTR:me,IS_SCRIPT_OR_DATA:we,ATTR_WHITESPACE:Je,CUSTOM_ELEMENT:fa}=_h;let{IS_ALLOWED_URI:Jl}=_h,xe=null;const ec=U({},[...yh,...qa,...Ga,...Ya,...$h]);let Ae=null;const tc=U({},[...wh,...Qa,...xh,...no]);let le=Object.seal(F1(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),Hs=null,ma=null,ic=!0,ga=!0,sc=!1,rc=!0,Zi=!1,va=!0,di=!1,ba=!1,ya=!1,Ji=!1,Xr=!1,Zr=!1,oc=!0,ac=!1;const R0="user-content-";let $a=!0,Us=!1,es={},ts=null;const nc=U({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","style","svg","template","thead","title","video","xmp"]);let lc=null;const cc=U({},["audio","video","img","source","image","track"]);let wa=null;const hc=U({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),Jr="http://www.w3.org/1998/Math/MathML",eo="http://www.w3.org/2000/svg",Lt="http://www.w3.org/1999/xhtml";let is=Lt,xa=!1,_a=null;const z0=U({},[Jr,eo,Lt],Wa);let to=U({},["mi","mo","mn","ms","mtext"]),io=U({},["annotation-xml"]);const I0=U({},["title","style","font","a","script"]);let Vs=null;const N0=["application/xhtml+xml","text/html"],H0="text/html";let _e=null,ss=null;const U0=t.createElement("form"),dc=function(v){return v instanceof RegExp||v instanceof Function},Sa=function(){let v=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if(!(ss&&ss===v)){if((!v||typeof v!="object")&&(v={}),v=Si(v),Vs=N0.indexOf(v.PARSER_MEDIA_TYPE)===-1?H0:v.PARSER_MEDIA_TYPE,_e=Vs==="application/xhtml+xml"?Wa:bo,xe=lt(v,"ALLOWED_TAGS")?U({},v.ALLOWED_TAGS,_e):ec,Ae=lt(v,"ALLOWED_ATTR")?U({},v.ALLOWED_ATTR,_e):tc,_a=lt(v,"ALLOWED_NAMESPACES")?U({},v.ALLOWED_NAMESPACES,Wa):z0,wa=lt(v,"ADD_URI_SAFE_ATTR")?U(Si(hc),v.ADD_URI_SAFE_ATTR,_e):hc,lc=lt(v,"ADD_DATA_URI_TAGS")?U(Si(cc),v.ADD_DATA_URI_TAGS,_e):cc,ts=lt(v,"FORBID_CONTENTS")?U({},v.FORBID_CONTENTS,_e):nc,Hs=lt(v,"FORBID_TAGS")?U({},v.FORBID_TAGS,_e):{},ma=lt(v,"FORBID_ATTR")?U({},v.FORBID_ATTR,_e):{},es=lt(v,"USE_PROFILES")?v.USE_PROFILES:!1,ic=v.ALLOW_ARIA_ATTR!==!1,ga=v.ALLOW_DATA_ATTR!==!1,sc=v.ALLOW_UNKNOWN_PROTOCOLS||!1,rc=v.ALLOW_SELF_CLOSE_IN_ATTR!==!1,Zi=v.SAFE_FOR_TEMPLATES||!1,va=v.SAFE_FOR_XML!==!1,di=v.WHOLE_DOCUMENT||!1,Ji=v.RETURN_DOM||!1,Xr=v.RETURN_DOM_FRAGMENT||!1,Zr=v.RETURN_TRUSTED_TYPE||!1,ya=v.FORCE_BODY||!1,oc=v.SANITIZE_DOM!==!1,ac=v.SANITIZE_NAMED_PROPS||!1,$a=v.KEEP_CONTENT!==!1,Us=v.IN_PLACE||!1,Jl=v.ALLOWED_URI_REGEXP||R1,is=v.NAMESPACE||Lt,to=v.MATHML_TEXT_INTEGRATION_POINTS||to,io=v.HTML_INTEGRATION_POINTS||io,le=v.CUSTOM_ELEMENT_HANDLING||{},v.CUSTOM_ELEMENT_HANDLING&&dc(v.CUSTOM_ELEMENT_HANDLING.tagNameCheck)&&(le.tagNameCheck=v.CUSTOM_ELEMENT_HANDLING.tagNameCheck),v.CUSTOM_ELEMENT_HANDLING&&dc(v.CUSTOM_ELEMENT_HANDLING.attributeNameCheck)&&(le.attributeNameCheck=v.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),v.CUSTOM_ELEMENT_HANDLING&&typeof v.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements=="boolean"&&(le.allowCustomizedBuiltInElements=v.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements),Zi&&(ga=!1),Xr&&(Ji=!0),es&&(xe=U({},$h),Ae=[],es.html===!0&&(U(xe,yh),U(Ae,wh)),es.svg===!0&&(U(xe,qa),U(Ae,Qa),U(Ae,no)),es.svgFilters===!0&&(U(xe,Ga),U(Ae,Qa),U(Ae,no)),es.mathMl===!0&&(U(xe,Ya),U(Ae,xh),U(Ae,no))),v.ADD_TAGS&&(xe===ec&&(xe=Si(xe)),U(xe,v.ADD_TAGS,_e)),v.ADD_ATTR&&(Ae===tc&&(Ae=Si(Ae)),U(Ae,v.ADD_ATTR,_e)),v.ADD_URI_SAFE_ATTR&&U(wa,v.ADD_URI_SAFE_ATTR,_e),v.FORBID_CONTENTS&&(ts===nc&&(ts=Si(ts)),U(ts,v.FORBID_CONTENTS,_e)),$a&&(xe["#text"]=!0),di&&U(xe,["html","head","body"]),xe.table&&(U(xe,["tbody"]),delete Hs.tbody),v.TRUSTED_TYPES_POLICY){if(typeof v.TRUSTED_TYPES_POLICY.createHTML!="function")throw Js('TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.');if(typeof v.TRUSTED_TYPES_POLICY.createScriptURL!="function")throw Js('TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.');z=v.TRUSTED_TYPES_POLICY,Y=z.createHTML("")}else z===void 0&&(z=H3(g,r)),z!==null&&typeof Y=="string"&&(Y=z.createHTML(""));Fe&&Fe(v),ss=v}},pc=U({},[...qa,...Ga,...M3]),uc=U({},[...Ya,...P3]),V0=function(v){let C=D(v);(!C||!C.tagName)&&(C={namespaceURI:is,tagName:"template"});const L=bo(v.tagName),te=bo(C.tagName);return _a[v.namespaceURI]?v.namespaceURI===eo?C.namespaceURI===Lt?L==="svg":C.namespaceURI===Jr?L==="svg"&&(te==="annotation-xml"||to[te]):!!pc[L]:v.namespaceURI===Jr?C.namespaceURI===Lt?L==="math":C.namespaceURI===eo?L==="math"&&io[te]:!!uc[L]:v.namespaceURI===Lt?C.namespaceURI===eo&&!io[te]||C.namespaceURI===Jr&&!to[te]?!1:!uc[L]&&(I0[L]||!pc[L]):!!(Vs==="application/xhtml+xml"&&_a[v.namespaceURI]):!1},wt=function(v){Xs(e.removed,{element:v});try{D(v).removeChild(v)}catch{T(v)}},so=function(v,C){try{Xs(e.removed,{attribute:C.getAttributeNode(v),from:C})}catch{Xs(e.removed,{attribute:null,from:C})}if(C.removeAttribute(v),v==="is")if(Ji||Xr)try{wt(C)}catch{}else try{C.setAttribute(v,"")}catch{}},fc=function(v){let C=null,L=null;if(ya)v="<remove></remove>"+v;else{const ke=bh(v,/^[\r\n\t ]+/);L=ke&&ke[0]}Vs==="application/xhtml+xml"&&is===Lt&&(v='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+v+"</body></html>");const te=z?z.createHTML(v):v;if(is===Lt)try{C=new f().parseFromString(te,Vs)}catch{}if(!C||!C.documentElement){C=fe.createDocument(is,"template",null);try{C.documentElement.innerHTML=xa?Y:te}catch{}}const Me=C.body||C.documentElement;return v&&L&&Me.insertBefore(t.createTextNode(L),Me.childNodes[0]||null),is===Lt?at.call(C,di?"html":"body")[0]:di?C.documentElement:Me},mc=function(v){return Ge.call(v.ownerDocument||v,v,c.SHOW_ELEMENT|c.SHOW_COMMENT|c.SHOW_TEXT|c.SHOW_PROCESSING_INSTRUCTION|c.SHOW_CDATA_SECTION,null)},Ca=function(v){return v instanceof d&&(typeof v.nodeName!="string"||typeof v.textContent!="string"||typeof v.removeChild!="function"||!(v.attributes instanceof h)||typeof v.removeAttribute!="function"||typeof v.setAttribute!="function"||typeof v.namespaceURI!="string"||typeof v.insertBefore!="function"||typeof v.hasChildNodes!="function")},gc=function(v){return typeof l=="function"&&v instanceof l};function Bt(B,v,C){ao(B,L=>{L.call(e,v,C,ss)})}const vc=function(v){let C=null;if(Bt(ne.beforeSanitizeElements,v,null),Ca(v))return wt(v),!0;const L=_e(v.nodeName);if(Bt(ne.uponSanitizeElement,v,{tagName:L,allowedTags:xe}),v.hasChildNodes()&&!gc(v.firstElementChild)&&Le(/<[/\w]/g,v.innerHTML)&&Le(/<[/\w]/g,v.textContent)||v.nodeType===tr.progressingInstruction||va&&v.nodeType===tr.comment&&Le(/<[/\w]/g,v.data))return wt(v),!0;if(!xe[L]||Hs[L]){if(!Hs[L]&&yc(L)&&(le.tagNameCheck instanceof RegExp&&Le(le.tagNameCheck,L)||le.tagNameCheck instanceof Function&&le.tagNameCheck(L)))return!1;if($a&&!ts[L]){const te=D(v)||v.parentNode,Me=O(v)||v.childNodes;if(Me&&te){const ke=Me.length;for(let Ve=ke-1;Ve>=0;--Ve){const xt=w(Me[Ve],!0);xt.__removalCount=(v.__removalCount||0)+1,te.insertBefore(xt,P(v))}}}return wt(v),!0}return v instanceof n&&!V0(v)||(L==="noscript"||L==="noembed"||L==="noframes")&&Le(/<\/no(script|embed|frames)/i,v.innerHTML)?(wt(v),!0):(Zi&&v.nodeType===tr.text&&(C=v.textContent,ao([Pt,Ot,Dt],te=>{C=Zs(C,te," ")}),v.textContent!==C&&(Xs(e.removed,{element:v.cloneNode()}),v.textContent=C)),Bt(ne.afterSanitizeElements,v,null),!1)},bc=function(v,C,L){if(oc&&(C==="id"||C==="name")&&(L in t||L in U0))return!1;if(!(ga&&!ma[C]&&Le(hi,C))){if(!(ic&&Le(me,C))){if(!Ae[C]||ma[C]){if(!(yc(v)&&(le.tagNameCheck instanceof RegExp&&Le(le.tagNameCheck,v)||le.tagNameCheck instanceof Function&&le.tagNameCheck(v))&&(le.attributeNameCheck instanceof RegExp&&Le(le.attributeNameCheck,C)||le.attributeNameCheck instanceof Function&&le.attributeNameCheck(C))||C==="is"&&le.allowCustomizedBuiltInElements&&(le.tagNameCheck instanceof RegExp&&Le(le.tagNameCheck,L)||le.tagNameCheck instanceof Function&&le.tagNameCheck(L))))return!1}else if(!wa[C]){if(!Le(Jl,Zs(L,Je,""))){if(!((C==="src"||C==="xlink:href"||C==="href")&&v!=="script"&&T3(L,"data:")===0&&lc[v])){if(!(sc&&!Le(we,Zs(L,Je,"")))){if(L)return!1}}}}}}return!0},yc=function(v){return v!=="annotation-xml"&&bh(v,fa)},$c=function(v){Bt(ne.beforeSanitizeAttributes,v,null);const{attributes:C}=v;if(!C||Ca(v))return;const L={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:Ae,forceKeepAttr:void 0};let te=C.length;for(;te--;){const Me=C[te],{name:ke,namespaceURI:Ve,value:xt}=Me,js=_e(ke);let De=ke==="value"?xt:A3(xt);if(L.attrName=js,L.attrValue=De,L.keepAttr=!0,L.forceKeepAttr=void 0,Bt(ne.uponSanitizeAttribute,v,L),De=L.attrValue,ac&&(js==="id"||js==="name")&&(so(ke,v),De=R0+De),va&&Le(/((--!?|])>)|<\/(style|title)/i,De)){so(ke,v);continue}if(L.forceKeepAttr||(so(ke,v),!L.keepAttr))continue;if(!rc&&Le(/\/>/i,De)){so(ke,v);continue}Zi&&ao([Pt,Ot,Dt],xc=>{De=Zs(De,xc," ")});const wc=_e(v.nodeName);if(bc(wc,js,De)){if(z&&typeof g=="object"&&typeof g.getAttributeType=="function"&&!Ve)switch(g.getAttributeType(wc,js)){case"TrustedHTML":{De=z.createHTML(De);break}case"TrustedScriptURL":{De=z.createScriptURL(De);break}}try{Ve?v.setAttributeNS(Ve,ke,De):v.setAttribute(ke,De),Ca(v)?wt(v):vh(e.removed)}catch{}}}Bt(ne.afterSanitizeAttributes,v,null)},j0=function B(v){let C=null;const L=mc(v);for(Bt(ne.beforeSanitizeShadowDOM,v,null);C=L.nextNode();)Bt(ne.uponSanitizeShadowNode,C,null),vc(C),$c(C),C.content instanceof o&&B(C.content);Bt(ne.afterSanitizeShadowDOM,v,null)};return e.sanitize=function(B){let v=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},C=null,L=null,te=null,Me=null;if(xa=!B,xa&&(B="<!-->"),typeof B!="string"&&!gc(B))if(typeof B.toString=="function"){if(B=B.toString(),typeof B!="string")throw Js("dirty is not a string, aborting")}else throw Js("toString is not a function");if(!e.isSupported)return B;if(ba||Sa(v),e.removed=[],typeof B=="string"&&(Us=!1),Us){if(B.nodeName){const xt=_e(B.nodeName);if(!xe[xt]||Hs[xt])throw Js("root node is forbidden and cannot be sanitized in-place")}}else if(B instanceof l)C=fc("<!---->"),L=C.ownerDocument.importNode(B,!0),L.nodeType===tr.element&&L.nodeName==="BODY"||L.nodeName==="HTML"?C=L:C.appendChild(L);else{if(!Ji&&!Zi&&!di&&B.indexOf("<")===-1)return z&&Zr?z.createHTML(B):B;if(C=fc(B),!C)return Ji?null:Zr?Y:""}C&&ya&&wt(C.firstChild);const ke=mc(Us?B:C);for(;te=ke.nextNode();)vc(te),$c(te),te.content instanceof o&&j0(te.content);if(Us)return B;if(Ji){if(Xr)for(Me=Ue.call(C.ownerDocument);C.firstChild;)Me.appendChild(C.firstChild);else Me=C;return(Ae.shadowroot||Ae.shadowrootmode)&&(Me=Mt.call(s,Me,!0)),Me}let Ve=di?C.outerHTML:C.innerHTML;return di&&xe["!doctype"]&&C.ownerDocument&&C.ownerDocument.doctype&&C.ownerDocument.doctype.name&&Le(z1,C.ownerDocument.doctype.name)&&(Ve="<!DOCTYPE "+C.ownerDocument.doctype.name+`>
`+Ve),Zi&&ao([Pt,Ot,Dt],xt=>{Ve=Zs(Ve,xt," ")}),z&&Zr?z.createHTML(Ve):Ve},e.setConfig=function(){let B=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};Sa(B),ba=!0},e.clearConfig=function(){ss=null,ba=!1},e.isValidAttribute=function(B,v,C){ss||Sa({});const L=_e(B),te=_e(v);return bc(L,te,C)},e.addHook=function(B,v){typeof v=="function"&&Xs(ne[B],v)},e.removeHook=function(B,v){if(v!==void 0){const C=S3(ne[B],v);return C===-1?void 0:C3(ne[B],C,1)[0]}return vh(ne[B])},e.removeHooks=function(B){ne[B]=[]},e.removeAllHooks=function(){ne=Sh()},e}var yo=I1(),U3=Object.defineProperty,V3=Object.getOwnPropertyDescriptor,Nl=(i,e,t,s)=>{for(var r=s>1?void 0:s?V3(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&U3(e,t,r),r};let Io=class extends pe{constructor(){super(...arguments),this.collectionLinks=[]}render(){return m`
    ...
    `}get imageBlockTemplate(){var t;if(!this.model)return b;const i=this.model.mediatype==="collection",e=this.displayValueProvider.itemPageUrl(this.model.identifier,i);return m`<a
      id="image-link"
      title=${S(ht`View ${(t=this.model)==null?void 0:t.title}`)}
      href=${e}
    >
      <image-block
        .model=${this.model}
    ...
    `}get iconRightTemplate(){var i;return m`
      <a
        ...
        title=${S(ht`See more: ${(i=this.model)==null?void 0:i.mediatype}`)}
      >
        <tile-mediatype-icon .model=${this.model}> </tile-mediatype-icon>
      </a>
    ...
    `:b}get volumeTemplate(){var i;return this.metadataTemplate((i=this.model)==null?void 0:i.volume,S("Volume"))}get issueTemplate(){var i;return this.metadataTemplate((i=this.model)==null?void 0:i.issue,S("Issue"))}get creatorTemplate(){var i,e;return((i=this.model)==null?void 0:i.mediatype)==="account"?m`
      ...
      <div id="creator" class="metadata">
        ...
        ${go(Ri(this.model.creators,t=>this.searchLink("creator",t)),", ")}
      </div>
    `}get datePublishedTemplate(){var t;const i=(t=this.model)==null?void 0:t.datePublished;let e="long";return Fl(i)&&(e="year-only"),this.metadataTemplate(this.getFormattedDate(i,e),S("Published"))}get dateSortByTemplate(){return this.effectiveSort&&(this.effectiveSort.field==="addeddate"||this.effectiveSort.field==="reviewdate"||this.effectiveSort.field==="publicdate")?this.metadataTemplate(this.getFormattedDate(this.date,"long"),this.displayValueProvider.dateLabel):b}get viewsTemplate(){var e,t,s,r;const i=((e=this.effectiveSort)==null?void 0:e.field)==="week"?(t=this.model)==null?void 0:t.weeklyViewCount:(s=this.model)==null?void 0:s.viewCount;return i==null?b:((r=this.model)==null?void 0:r.mediatype)==="search"?this.metadataTemplate("(Favorited search query)",""):this.metadataTemplate(`${Il(i,this.formatSize)}`,S("Views"))}get ratingTemplate(){var i;return this.metadataTemplate((i=this.model)==null?void 0:i.averageRating,S("Avg Rating"))}get reviewsTemplate(){var i;return this.metadataTemplate((i=this.model)==null?void 0:i.commentCount,S("Reviews"))}get topicsTemplate(){var i;return!((i=this.model)!=null&&i.subjects)||this.model.subjects.length===0?b:m`
      <div id="topics" class="metadata">
        ${this.labelTemplate(S("Topics"))}
        ${go(Ri(this.model.subjects,e=>this.searchLink("subject",e)),", ")}
      </div>
    ...
    `}};Nl([u({type:Object})],Io.prototype,"collectionTitles",2);Nl([R()],Io.prototype,"collectionLinks",2);Io=Nl([N("tile-list")],Io);var j3=Object.defineProperty,W3=Object.getOwnPropertyDescriptor,Et=(i,e,t,s)=>{for(var r=s>1?void 0:s?W3(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&j3(e,t,r),r};let vt=class extends H{constructor(){super(...arguments),this.loggedIn=!1,this.suppressBlurring=!1}render(){return m`
      <div id="container">
        <focus-trap>
          ${this.headerTemplate}
    ...
    `}};Et([u({type:Object})],vt.prototype,"model",2);Et([u({type:String})],vt.prototype,"baseNavigationUrl",2);Et([u({type:String})],vt.prototype,"baseImageUrl",2);Et([u({type:Boolean})],vt.prototype,"loggedIn",2);Et([u({type:Boolean})],vt.prototype,"suppressBlurring",2);Et([u({type:Object})],vt.prototype,"sortParam",2);Et([u({type:Number})],vt.prototype,"mobileBreakpoint",2);Et([u({type:Number})],vt.prototype,"currentWidth",2);Et([u({type:Object})],vt.prototype,"collectionTitles",2);vt=Et([N("tile-hover-pane")],vt);var q3=Object.getOwnPropertyDescriptor,G3=(i,e,t,s)=>{for(var r=s>1?void 0:s?q3(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=a(r)||r);return r};let Ch=class extends pe{render(){var i,e;return m`
      <div id="list-line" class="${this.classSize}">
        <image-block
          .model=${this.model}
          .baseImageUrl=${this.baseImageUrl}
    ...
    `}};Ch=G3([N("tile-list-compact")],Ch);var Y3=Object.getOwnPropertyDescriptor,Q3=(i,e,t,s)=>{for(var r=s>1?void 0:s?Y3(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=a(r)||r);return r};let Th=class extends pe{render(){return m`
    ...
    `}get linkTileTemplate(){var i,e;return m`
      <a
        ...
        title=${this.shouldPrepareHoverPane?b:We((e=this.model)==null?void 0:e.title)}
    ...
    `}get shouldPrepareHoverPane(){var i,e;return this.enableHoverPane&&!!this.tileDisplayMode&&ze.HOVER_PANE_DISPLAY_MODES[this.tileDisplayMode]&&((i=this.model)==null?void 0:i.mediatype)!=="search"&&!((e=this.model)!=null&&e.captureDates)}get isHoverEnabled(){return window.matchMedia("(hover: hover)").matches}getHoverPane(){return this.hoverPane}getHoverPaneProps(){return this}handleResize(i){this.currentWidth=i.contentRect.width,this.currentHeight=i.contentRect.height}disconnectedCallback(){this.stopResizeObservation(this.resizeObserver)}stopResizeObservation(i){i==null||i.removeObserver({handler:this,target:this.container})}startResizeObservation(){var i;this.stopResizeObservation(this.resizeObserver),(i=this.resizeObserver)==null||i.addObserver({handler:this,target:this.container})}updated(i){if(i.has("resizeObserver")){const e=i.get("resizeObserver");this.stopResizeObservation(e),this.startResizeObservation()}}handleLinkClicked(i){this.isManageView&&(i.preventDefault(),this.model&&(this.model.checked=!this.model.checked)),this.dispatchEvent(new CustomEvent("resultSelected",{detail:this.model}))}handleLinkContextMenu(i){this.isManageView&&this.linkTileHref!==b&&(i.preventDefault(),window.open(this.linkTileHref,"_blank"))}tileInfoButtonPressed(i){var e;(e=this.hoverPaneController)==null||e.toggleHoverPane({coords:i.detail,enableTouchBackdrop:!0})}get tile(){const{model:i,collectionPagePath:e,baseNavigationUrl:t,currentWidth:s,currentHeight:r,sortParam:o,creatorFilter:a,mobileBreakpoint:l,defaultSortParam:n}=this;if(!i)return b;switch(this.tileDisplayMode){case"grid":switch(i.mediatype){case"collection":return m`<collection-tile
        ...
        >
          ...
          ?useLocalTime=${this.useLocalTime}
        >
        </tile-list>`;default:return b}}static get styles(){return[yt,y`
        :host {
          display: block;
          height: 100%;
        }
      ...
      `]}};ze.HOVER_PANE_DISPLAY_MODES={grid:!0,"list-compact":!0,"list-detail":!1,"list-header":!1};ot([u({type:String})],ze.prototype,"tileDisplayMode",2);ot([u({type:Boolean})],ze.prototype,"isManageView",2);ot([u({type:Object})],ze.prototype,"resizeObserver",2);ot([u({type:Object})],ze.prototype,"collectionTitles",2);ot([u({type:Boolean})],ze.prototype,"showTvClips",2);ot([u({type:String})],ze.prototype,"layoutType",2);ot([u({type:Boolean})],ze.prototype,"enableHoverPane",2);ot([u({type:String})],ze.prototype,"manageCheckTitle",2);ot([ee("#container")],ze.prototype,"container",2);ot([ee("tile-hover-pane")],ze.prototype,"hoverPane",2);ot([ee(".tile-link")],ze.prototype,"tileLinkElement",2);ze=ot([N("tile-dispatcher")],ze);var J3=Object.getOwnPropertyDescriptor,ef=(i,e,t,s)=>{for(var r=s>1?void 0:s?J3(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=a(r)||r);return r};let kh=class extends H{render(){return m` <div id="container"></div> `}static get styles(){return y`
      :host {
        display: block;
        height: 100%;
      }
    ...
    `}};kh=ef([N("collection-browser-loading-tile")],kh);const tf=m`
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Ka;const No=window,$s=No.trustedTypes,Eh=$s?$s.createPolicy("lit-html",{createHTML:i=>i}):void 0,Jn="$lit$",Zt=`lit$${(Math.random()+"").slice(9)}$`,N1="?"+Zt,lf=`<${N1}>`,ji=document,Or=()=>ji.createComment(""),Dr=i=>i===null||typeof i!="object"&&typeof i!="function",H1=Array.isArray,cf=i=>H1(i)||typeof(i==null?void 0:i[Symbol.iterator])=="function",Xa=`[ 	
\f\r]`,ir=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Mh=/-->/g,Ph=/>/g,vi=RegExp(`>|${Xa}(?:([^\\s"'>=/]+)(${Xa}*=${Xa}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Oh=/'/g,Dh=/"/g,U1=/^(?:script|style|textarea|title)$/i,V1=i=>(e,...t)=>({_$litType$:i,strings:e,values:t}),Be=V1(1),j1=V1(2),ws=Symbol.for("lit-noChange"),Se=Symbol.for("lit-nothing"),Lh=new WeakMap,Mi=ji.createTreeWalker(ji,129,null,!1);function W1(i,e){if(!Array.isArray(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return Eh!==void 0?Eh.createHTML(e):e}const hf=(i,e)=>{const t=i.length-1,s=[];let r,o=e===2?"<svg>":"",a=ir;for(let l=0;l<t;l++){const n=i[l];let c,h,d=-1,f=0;for(;f<n.length&&(a.lastIndex=f,h=a.exec(n),h!==null);)f=a.lastIndex,a===ir?h[1]==="!--"?a=Mh:h[1]!==void 0?a=Ph:h[2]!==void 0?(U1.test(h[2])&&(r=RegExp("</"+h[2],"g")),a=vi):h[3]!==void 0&&(a=vi):a===vi?h[0]===">"?(a=r??ir,d=-1):h[1]===void 0?d=-2:(d=a.lastIndex-h[2].length,c=h[1],a=h[3]===void 0?vi:h[3]==='"'?Dh:Oh):a===Dh||a===Oh?a=vi:a===Mh||a===Ph?a=ir:(a=vi,r=void 0);const g=a===vi&&i[l+1].startsWith("/>")?" ":"";o+=a===ir?n+lf:d>=0?(s.push(c),n.slice(0,d)+Jn+n.slice(d)+Zt+g):n+Zt+(d===-2?(s.push(void 0),l):g)}return[W1(i,o+(i[t]||"<?>")+(e===2?"</svg>":"")),s]};let el=class q1{constructor({strings:e,_$litType$:t},s){let r;this.parts=[];let o=0,a=0;const l=e.length-1,n=this.parts,[c,h]=hf(e,t);if(this.el=q1.createElement(c,s),Mi.currentNode=this.el.content,t===2){const d=this.el.content,f=d.firstChild;f.remove(),d.append(...f.childNodes)}for(;(r=Mi.nextNode())!==null&&n.length<l;){if(r.nodeType===1){if(r.hasAttributes()){const d=[];for(const f of r.getAttributeNames())if(f.endsWith(Jn)||f.startsWith(Zt)){const g=h[a++];if(d.push(f),g!==void 0){const $=r.getAttribute(g.toLowerCase()+Jn).split(Zt),w=/([.?@])?(.*)/.exec(g);n.push({type:1,index:o,name:w[2],strings:$,ctor:w[1]==="."?pf:w[1]==="?"?ff:w[1]==="@"?mf:aa})}else n.push({type:6,index:o})}for(const f of d)r.removeAttribute(f)}if(U1.test(r.tagName)){const d=r.textContent.split(Zt),f=d.length-1;if(f>0){r.textContent=$s?$s.emptyScript:"";for(let g=0;g<f;g++)r.append(d[g],Or()),Mi.nextNode(),n.push({type:2,index:++o});r.append(d[f],Or())}}}else if(r.nodeType===8)if(r.data===N1)n.push({type:2,index:o});else{let d=-1;for(;(d=r.data.indexOf(Zt,d+1))!==-1;)n.push({type:7,index:o}),d+=Zt.length-1}o++}}static createElement(e,t){const s=ji.createElement("template");return s.innerHTML=e,s}};function xs(i,e,t=i,s){var r,o,a,l;if(e===ws)return e;let n=s!==void 0?(r=t._$Co)===null||r===void 0?void 0:r[s]:t._$Cl;const c=Dr(e)?void 0:e._$litDirective$;return(n==null?void 0:n.constructor)!==c&&((o=n==null?void 0:n._$AO)===null||o===void 0||o.call(n,!1),c===void 0?n=void 0:(n=new c(i),n._$AT(i,t,s)),s!==void 0?((a=(l=t)._$Co)!==null&&a!==void 0?a:l._$Co=[])[s]=n:t._$Cl=n),n!==void 0&&(e=xs(i,n._$AS(i,e.values),n,s)),e}let df=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){var t;const{el:{content:s},parts:r}=this._$AD,o=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:ji).importNode(s,!0);Mi.currentNode=o;let a=Mi.nextNode(),l=0,n=0,c=r[0];for(;c!==void 0;){if(l===c.index){let h;c.type===2?h=new Hl(a,a.nextSibling,this,e):c.type===1?h=new c.ctor(a,c.name,c.strings,this,e):c.type===6&&(h=new gf(a,this,e)),this._$AV.push(h),c=r[++n]}l!==(c==null?void 0:c.index)&&(a=Mi.nextNode(),l++)}return Mi.currentNode=ji,o}v(e){let t=0;for(const s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(e,s,t),t+=s.strings.length-2):s._$AI(e[t])),t++}},Hl=class G1{constructor(e,t,s,r){var o;this.type=2,this._$AH=Se,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=s,this.options=r,this._$Cp=(o=r==null?void 0:r.isConnected)===null||o===void 0||o}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cp}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=xs(this,e,t),Dr(e)?e===Se||e==null||e===""?(this._$AH!==Se&&this._$AR(),this._$AH=Se):e!==this._$AH&&e!==ws&&this._(e):e._$litType$!==void 0?this.g(e):e.nodeType!==void 0?this.$(e):cf(e)?this.T(e):this._(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==Se&&Dr(this._$AH)?this._$AA.nextSibling.data=e:this.$(ji.createTextNode(e)),this._$AH=e}g(e){var t;const{values:s,_$litType$:r}=e,o=typeof r=="number"?this._$AC(e):(r.el===void 0&&(r.el=el.createElement(W1(r.h,r.h[0]),this.options)),r);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===o)this._$AH.v(s);else{const a=new df(o,this),l=a.u(this.options);a.v(s),this.$(l),this._$AH=a}}_$AC(e){let t=Lh.get(e.strings);return t===void 0&&Lh.set(e.strings,t=new el(e)),t}T(e){H1(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let s,r=0;for(const o of e)r===t.length?t.push(s=new G1(this.k(Or()),this.k(Or()),this,this.options)):s=t[r],s._$AI(o),r++;r<t.length&&(this._$AR(s&&s._$AB.nextSibling,r),t.length=r)}_$AR(e=this._$AA.nextSibling,t){var s;for((s=this._$AP)===null||s===void 0||s.call(this,!1,!0,t);e&&e!==this._$AB;){const r=e.nextSibling;e.remove(),e=r}}setConnected(e){var t;this._$AM===void 0&&(this._$Cp=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}},aa=class{constructor(e,t,s,r,o){this.type=1,this._$AH=Se,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=o,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=Se}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,s,r){const o=this.strings;let a=!1;if(o===void 0)e=xs(this,e,t,0),a=!Dr(e)||e!==this._$AH&&e!==ws,a&&(this._$AH=e);else{const l=e;let n,c;for(e=o[0],n=0;n<o.length-1;n++)c=xs(this,l[s+n],t,n),c===ws&&(c=this._$AH[n]),a||(a=!Dr(c)||c!==this._$AH[n]),c===Se?e=Se:e!==Se&&(e+=(c??"")+o[n+1]),this._$AH[n]=c}a&&!r&&this.j(e)}j(e){e===Se?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},pf=class extends aa{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===Se?void 0:e}};const uf=$s?$s.emptyScript:"";let ff=class extends aa{constructor(){super(...arguments),this.type=4}j(e){e&&e!==Se?this.element.setAttribute(this.name,uf):this.element.removeAttribute(this.name)}},mf=class extends aa{constructor(e,t,s,r,o){super(e,t,s,r,o),this.type=5}_$AI(e,t=this){var s;if((e=(s=xs(this,e,t,0))!==null&&s!==void 0?s:Se)===ws)return;const r=this._$AH,o=e===Se&&r!==Se||e.capture!==r.capture||e.once!==r.once||e.passive!==r.passive,a=e!==Se&&(r===Se||o);o&&this.element.removeEventListener(this.name,this,r),a&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,s;typeof this._$AH=="function"?this._$AH.call((s=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&s!==void 0?s:this.element,e):this._$AH.handleEvent(e)}},gf=class{constructor(e,t,s){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(e){xs(this,e)}};const Bh=No.litHtmlPolyfillSupport;Bh==null||Bh(el,Hl),((Ka=No.litHtmlVersions)!==null&&Ka!==void 0?Ka:No.litHtmlVersions=[]).push("2.8.0");const vf=(i,e,t)=>{var s,r;const o=(s=t==null?void 0:t.renderBefore)!==null&&s!==void 0?s:e;let a=o._$litPart$;if(a===void 0){const l=(r=t==null?void 0:t.renderBefore)!==null&&r!==void 0?r:null;o._$litPart$=a=new Hl(e.insertBefore(Or(),l),l,void 0,t??{})}return a._$AI(i),a};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Za,Ja;let ps=class extends dt{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e,t;const s=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=s.firstChild),s}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=vf(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!1)}render(){return ws}};ps.finalized=!0,ps._$litElement$=!0,(Za=globalThis.litElementHydrateSupport)===null||Za===void 0||Za.call(globalThis,{LitElement:ps});const Fh=globalThis.litElementPolyfillSupport;Fh==null||Fh({LitElement:ps});((Ja=globalThis.litElementVersions)!==null&&Ja!==void 0?Ja:globalThis.litElementVersions=[]).push("3.3.3");/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function rs(i,e,t){return i?e():t==null?void 0:t()}const bf=j1`<svg class="caret-up-svg" viewBox="0 0 8 4" xmlns="http://www.w3.org/2000/svg">
<path d="m6.7226499 3.51689722c.22976435.15317623.54019902.0910893.69337525-.13867505.13615665-.20423497.10222882-.47220946-.06836249-.63681849l-.07031256-.05655675-3.2773501-2.18490007-3.2773501 2.18490007c-.22976434.15317623-.29185128.4636109-.13867505.69337524.13615665.20423498.39656688.27598409.61412572.18182636l.07924953-.04315131 2.7226499-1.81402514z"
  fill=""></path>
</svg>`,yf=j1`<svg class="caret-down-svg" viewBox="0 0 8 4" xmlns="http://www.w3.org/2000/svg">
<path d="m6.7226499.58397485c.22976435-.15317623.54019902-.09108929.69337525.13867505.13615665.20423498.10222882.47220947-.06836249.63681849l-.07031256.05655676-3.2773501 2.18490006-3.2773501-2.18490006c-.22976434-.15317623-.29185128-.4636109-.13867505-.69337525.13615665-.20423497.39656688-.27598409.61412572-.18182636l.07924953.04315131 2.7226499 1.81402515z"
fill=""></path>
</svg>`;let he=class extends ps{constructor(){super(...arguments),this.open=!1,this.isDisabled=!1,this.displayCaret=!1,this.closeOnSelect=!1,this.openViaButton=!0,this.usePopover=!1,this.includeSelectedOption=!1,this.selectedOption="",this.options=[],this.optionGroup="options",this.optionSelected=()=>{},this.isCustomList=!1,this.hasCustomClickHandler=!1,this.closeOnEscape=!1,this.closeOnBackdropClick=!1,this.boundKeyboardListener=e=>{switch(e.key){case"Escape":case"Esc":this.closeOptions();break}},this.closeOptions=e=>{e&&e.type==="click"&&e.stopPropagation(),this.open=!1,this.updatePopoverState()}}async firstUpdated(){await new Promise(e=>{setTimeout(e,0)}),this.addEventListener("closeDropdown",this.closeOptions)}willUpdate(e){e.has("open")&&this.updatePopoverState()}disconnectedCallback(){var e;(e=super.disconnectedCallback)===null||e===void 0||e.call(this),this.removeKeyboardListener()}setupKeyboardListener(){this.closeOnEscape&&document.addEventListener("keydown",this.boundKeyboardListener)}removeKeyboardListener(){this.closeOnEscape&&document.removeEventListener("keydown",this.boundKeyboardListener)}get dropdownState(){return this.open?(this.setupKeyboardListener(),"open"):(this.removeKeyboardListener(),"closed")}toggleOptions(){this.open=!this.open,this.updatePopoverState()}updatePopoverState(){var e,t;this.usePopover&&((t=(e=this.dropdownMenu)===null||e===void 0?void 0:e.togglePopover)===null||t===void 0||t.call(e,this.open),this.open&&this.positionDropdownMenu())}positionDropdownMenu(){if(!this.dropdownMenu)return;const e=this.container.getBoundingClientRect();this.dropdownMenu.style.left=`${e.left}px`,this.dropdownMenu.style.top=`${e.bottom}px`,this.dropdownMenu.style.minWidth=`${e.width}px`}mainButtonClicked(){var e;this.openViaButton?this.toggleOptions():(e=this.mainButtonLabelSlotted[0])===null||e===void 0||e.click()}mainButtonKeyDown(e){(e.key==="Enter"||e.key===" ")&&(this.mainButtonClicked(),e.preventDefault())}caretKeyDown(e){(e.key==="Enter"||e.key===" ")&&(this.toggleOptions(),e.preventDefault())}renderOption(e){const{label:t,url:s=void 0,id:r}=e;let o;const a=this.selectedOption===r?"selected":"";return s?o=Be`<a
        href=${s}
    ...
    `}get caretTemplate(){return this.displayCaret?this.openViaButton?Be`
      ...
      <button
        ...
        aria-haspopup="true"
        aria-expanded=${this.open}
        @click=${rs(this.shouldAttachEventHandlers,()=>this.toggleOptions)}
        @keydown=${rs(this.shouldAttachEventHandlers,()=>this.caretKeyDown)}
      ...
      <div class="ia-dropdown-group">
        <div class="button-row">
          <button
            ...
            aria-expanded=${this.open}
            @click=${rs(this.shouldAttachEventHandlers,()=>this.mainButtonClicked)}
            @keydown=${rs(this.shouldAttachEventHandlers,()=>this.mainButtonKeyDown)}
            ?disabled=${this.isDisabled}
          >
            ...
            ${rs(this.shouldNestCaretInButton,()=>this.caretTemplate)}
          </button>
          ${rs(!this.shouldNestCaretInButton,()=>this.caretTemplate)}
        </div>
    ...
    `}};p([E({type:Boolean,reflect:!0})],he.prototype,"open",void 0);p([E({type:Boolean,reflect:!0})],he.prototype,"isDisabled",void 0);p([E({type:Boolean})],he.prototype,"displayCaret",void 0);p([E({type:Boolean})],he.prototype,"closeOnSelect",void 0);p([E({type:Boolean})],he.prototype,"openViaButton",void 0);p([E({type:Boolean})],he.prototype,"usePopover",void 0);p([E({type:Boolean})],he.prototype,"includeSelectedOption",void 0);p([E({type:String})],he.prototype,"selectedOption",void 0);p([E({attribute:!1})],he.prototype,"options",void 0);p([E({type:String})],he.prototype,"optionGroup",void 0);p([E({attribute:!1})],he.prototype,"optionSelected",void 0);p([E({type:Boolean,reflect:!0})],he.prototype,"isCustomList",void 0);p([E({type:Boolean,reflect:!0})],he.prototype,"hasCustomClickHandler",void 0);p([E({type:Boolean,reflect:!0})],he.prototype,"closeOnEscape",void 0);p([E({type:Boolean,reflect:!0})],he.prototype,"closeOnBackdropClick",void 0);p([qe(".ia-dropdown-group")],he.prototype,"container",void 0);p([qe("#dropdown-main")],he.prototype,"dropdownMenu",void 0);p([qe(".click-main")],he.prototype,"mainButton",void 0);p([h1({slot:"dropdown-label"})],he.prototype,"mainButtonLabelSlotted",void 0);he=p([Tt("ia-dropdown")],he);let tl=class extends ps{render(){return Be`
  ...
  `;tl=p([Tt("ia-icon-label")],tl);var $f=Object.defineProperty,wf=Object.getOwnPropertyDescriptor,Y1=(i,e,t,s)=>{for(var r=s>1?void 0:s?wf(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&$f(e,t,r),r};let il=class extends H{constructor(){super(...arguments),this.numResults=0}render(){return m`
    ...
    `}};Y1([u({type:Number})],il.prototype,"numResults",2);il=Y1([N("alpha-bar-tooltip")],il);var xf=Object.defineProperty,_f=Object.getOwnPropertyDescriptor,Ki=(i,e,t,s)=>{for(var r=s>1?void 0:s?_f(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&xf(e,t,r),r};let Ut=class extends H{constructor(){super(...arguments),this.selectedLetter=null,this.tooltipShown=!1,this.alphabet="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("")}get selectedUppercaseLetter(){var i;return(i=this.selectedLetter)==null?void 0:i.toUpperCase()}render(){return m`
  ...
  `;Ki([u({type:String})],Ut.prototype,"selectedLetter",2);Ki([u({type:Object})],Ut.prototype,"letterCounts",2);Ki([u({type:String})],Ut.prototype,"ariaLandmarkLabel",2);Ki([R()],Ut.prototype,"tooltipShown",2);Ki([R()],Ut.prototype,"hoveredLetter",2);Ki([ee("alpha-bar-tooltip")],Ut.prototype,"tooltip",2);Ut=Ki([N("alpha-bar")],Ut);var Sf=Object.defineProperty,Cf=Object.getOwnPropertyDescriptor,He=(i,e,t,s)=>{for(var r=s>1?void 0:s?Cf(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&Sf(e,t,r),r};let Oe=class extends H{constructor(){super(...arguments),this.defaultSortDirection=null,this.defaultSortField=je.relevance,this.sortDirection=null,this.selectedSort=je.default,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.sortFieldAvailability=ia,this.enableSortOptionsSlot=!1,this.suppressDisplayModes=!1,this.alphaSelectorVisible=null,this.dropdownBackdropVisible=!1,this.boundSortBarSelectorEscapeListener=i=>{i.key==="Escape"&&this.closeDropdown()}}render(){return m`
      <div id="container">
    ...
    `:m`<div class="sort-direction-icon">${rf}</div>`}get sortSelectorTemplate(){const i=Object.values(Ye).filter(e=>e.shownInSortBar&&this.sortFieldAvailability[e.field]);return m`
      <div id="sort-dropdown-container">
        ${this.getSortDropdown({displayName:Ye[this.finalizedSortField].displayName,id:"sort-dropdown",selected:!0,dropdownOptions:i.map(e=>this.getDropdownOption(e.field)),selectedOption:this.finalizedSortField,onOptionSelected:this.sortOptionSelected,onDropdownClick:()=>{this.dropdownBackdropVisible=this.sortOptionsDropdown.open,this.sortOptionsDropdown.classList.toggle("open",this.sortOptionsDropdown.open)}})}
      </div>
    ...
    `}get dropdownBackdrop(){return m`
      ...
      ></div>
    `}closeDropdown(){this.dropdownBackdropVisible=!1,this.sortOptionsDropdown&&(this.sortOptionsDropdown.open=!1,this.sortOptionsDropdown.classList.remove("open"))}setSortDirection(i){this.sortDirection=i,this.emitSortChangedEvent()}toggleSortDirection(){this.setSortDirection(this.finalizedSortDirection==="desc"?"asc":"desc")}handleSortDirectionClicked(){!this.sortDirection&&this.defaultSortField&&this.defaultSortDirection&&(this.selectedSort=this.defaultSortField,this.sortDirection=this.defaultSortDirection),this.toggleSortDirection()}setSelectedSort(i){this.selectedSort=i;const e=Ye[i];this.sortDirection=e.defaultSortDirection,this.emitSortChangedEvent()}get finalizedSortField(){var e;const i=this.selectedSort===je.default?this.defaultSortField:this.selectedSort;return this.sortFieldAvailability[i]?i:((e=this.firstAvailableOption)==null?void 0:e.field)??i}get finalizedSortDirection(){return this.sortDirection===null?this.defaultSortDirection:this.sortDirection}get firstAvailableOption(){return Object.values(Ye).find(i=>i.shownInSortBar&&this.sortFieldAvailability[i.field])}get canChangeSortDirection(){return Ye[this.finalizedSortField].canSetDirection}get titleSelectorBar(){var i;return m` <alpha-bar
    ...
    ></alpha-bar>`}titleLetterChanged(i){this.selectedTitleFilter=i.detail.selectedLetter??null,this.emitTitleLetterChangedEvent()}creatorLetterChanged(i){this.selectedCreatorFilter=i.detail.selectedLetter??null,this.emitCreatorLetterChangedEvent()}emitTitleLetterChangedEvent(){const i=new CustomEvent("titleLetterChanged",{detail:{selectedLetter:this.selectedTitleFilter}});this.dispatchEvent(i)}emitCreatorLetterChangedEvent(){const i=new CustomEvent("creatorLetterChanged",{detail:{selectedLetter:this.selectedCreatorFilter}});this.dispatchEvent(i)}displayModeChanged(){const i=new CustomEvent("displayModeChanged",{detail:{displayMode:this.displayMode}});this.dispatchEvent(i)}emitSortChangedEvent(){const i=new CustomEvent("sortChanged",{detail:{selectedSort:this.selectedSort,sortDirection:this.sortDirection}});this.dispatchEvent(i)}static get styles(){const i=y`#bbbbbb`;return[yt,y`
      ...
      `]}};He([u({type:String})],Oe.prototype,"displayMode",2);He([u({type:String})],Oe.prototype,"defaultSortDirection",2);He([u({type:String})],Oe.prototype,"defaultSortField",2);He([u({type:String})],Oe.prototype,"sortDirection",2);He([u({type:String})],Oe.prototype,"selectedSort",2);He([u({type:String})],Oe.prototype,"selectedTitleFilter",2);He([u({type:String})],Oe.prototype,"selectedCreatorFilter",2);He([u({type:Object})],Oe.prototype,"sortFieldAvailability",2);He([u({type:Boolean,reflect:!0})],Oe.prototype,"enableSortOptionsSlot",2);He([u({type:Boolean,reflect:!0})],Oe.prototype,"suppressDisplayModes",2);He([u({type:Object})],Oe.prototype,"prefixFilterCountMap",2);He([R()],Oe.prototype,"alphaSelectorVisible",2);He([R()],Oe.prototype,"dropdownBackdropVisible",2);He([ee("#sort-dropdown")],Oe.prototype,"sortOptionsDropdown",2);Oe=He([N("sort-filter-bar")],Oe);class zi{constructor(e){this.title=e==null?void 0:e.title,this.subtitle=e==null?void 0:e.subtitle,this.headline=e==null?void 0:e.headline,this.message=e==null?void 0:e.message,this.headerColor=(e==null?void 0:e.headerColor)??"#55A183",this.bodyColor=(e==null?void 0:e.bodyColor)??"#fbfbfd",this.showProcessingIndicator=(e==null?void 0:e.showProcessingIndicator)??!1,this.processingImageMode=(e==null?void 0:e.processingImageMode)??"complete",this.showCloseButton=(e==null?void 0:e.showCloseButton)??!0,this.showLeftNavButton=(e==null?void 0:e.showLeftNavButton)??!1,this.leftNavButtonText=(e==null?void 0:e.leftNavButtonText)??"",this.showHeaderLogo=(e==null?void 0:e.showHeaderLogo)??!0,this.closeOnBackdropClick=(e==null?void 0:e.closeOnBackdropClick)??!0}}function*Ul(i=document.activeElement){i!=null&&(yield i,"shadowRoot"in i&&i.shadowRoot&&i.shadowRoot.mode!=="closed"&&(yield*Ul(i.shadowRoot.activeElement)))}function Q1(){return[...Ul()].pop()}const Rh=new WeakMap;function K1(i){let e=Rh.get(i);return e||(e=window.getComputedStyle(i,null),Rh.set(i,e)),e}function Tf(i){if("checkVisibility"in i&&typeof i.checkVisibility=="function")return i.checkVisibility({checkOpacity:!1,checkVisibilityCSS:!0});const e=K1(i);return e.visibility!=="hidden"&&e.display!=="none"}function Af(i){const e=K1(i),{overflowY:t,overflowX:s}=e;return t==="scroll"||s==="scroll"?!0:t!=="auto"||s!=="auto"?!1:i.scrollHeight>i.clientHeight&&t==="auto"||i.scrollWidth>i.clientWidth&&s==="auto"}function kf(i){const e=i.tagName.toLowerCase(),t=Number(i.getAttribute("tabindex"));return i.hasAttribute("tabindex")&&(isNaN(t)||t<=-1)||i.hasAttribute("disabled")||i.closest("[inert]")||e==="input"&&i.getAttribute("type")==="radio"&&!i.hasAttribute("checked")||!Tf(i)?!1:(e==="audio"||e==="video")&&i.hasAttribute("controls")||i.hasAttribute("tabindex")||i.hasAttribute("contenteditable")&&i.getAttribute("contenteditable")!=="false"||["button","input","select","textarea","a","audio","video","summary","iframe"].includes(e)?!0:Af(i)}function Ef(i,e){var t;return((t=i.getRootNode({composed:!0}))==null?void 0:t.host)!==e}function zh(i){const e=new WeakMap,t=[];function s(r){if(r instanceof Element){if(r.hasAttribute("inert")||r.closest("[inert]")||e.has(r))return;e.set(r,!0),!t.includes(r)&&kf(r)&&t.push(r),r instanceof HTMLSlotElement&&Ef(r,i)&&r.assignedElements({flatten:!0}).forEach(o=>{s(o)}),r.shadowRoot!==null&&r.shadowRoot.mode==="open"&&s(r.shadowRoot)}for(const o of Array.from(r.children))s(o)}return s(i),t.sort((r,o)=>{const a=Number(r.getAttribute("tabindex"))||0;return(Number(o.getAttribute("tabindex"))||0)-a})}let sr=[];class Mf{constructor(e){this.isExternalActivated=!1,this.tabDirection="forward",this.currentFocus=null,this.previousFocus=null,this.handleFocusIn=()=>{this.isActive()&&this.checkFocus()},this.handleKeyDown=t=>{var l;if(t.key!=="Tab"||this.isExternalActivated||!this.isActive())return;const s=Q1();if(this.previousFocus=s,this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus))return;t.shiftKey?this.tabDirection="backward":this.tabDirection="forward";const r=zh(this.element);let o=r.findIndex(n=>n===s);this.previousFocus=this.currentFocus;const a=this.tabDirection==="forward"?1:-1;for(;;){o+a>=r.length?o=0:o+a<0?o=r.length-1:o+=a,this.previousFocus=this.currentFocus;const n=r[o];if(this.tabDirection==="backward"&&this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus)||n&&this.possiblyHasTabbableChildren(n))return;t.preventDefault(),this.currentFocus=n,(l=this.currentFocus)==null||l.focus({preventScroll:!1});const c=[...Ul()];if(c.includes(this.currentFocus)||!c.includes(this.previousFocus))break}setTimeout(()=>this.checkFocus())},this.handleKeyUp=()=>{this.tabDirection="forward"},this.element=e,this.elementsWithTabbableControls=["iframe"]}activate(){sr.push(this.element),document.addEventListener("focusin",this.handleFocusIn),document.addEventListener("keydown",this.handleKeyDown),document.addEventListener("keyup",this.handleKeyUp)}deactivate(){sr=sr.filter(e=>e!==this.element),this.currentFocus=null,document.removeEventListener("focusin",this.handleFocusIn),document.removeEventListener("keydown",this.handleKeyDown),document.removeEventListener("keyup",this.handleKeyUp)}isActive(){return sr[sr.length-1]===this.element}activateExternal(){this.isExternalActivated=!0}deactivateExternal(){this.isExternalActivated=!1}checkFocus(){if(this.isActive()&&!this.isExternalActivated){const e=zh(this.element);if(!this.element.matches(":focus-within")){const t=e[0],s=e[e.length-1],r=this.tabDirection==="forward"?t:s;typeof(r==null?void 0:r.focus)=="function"&&(this.currentFocus=r,r.focus({preventScroll:!1}))}}}possiblyHasTabbableChildren(e){return this.elementsWithTabbableControls.includes(e.tagName.toLowerCase())||e.hasAttribute("controls")}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var en;const Ho=window,_s=Ho.trustedTypes,Ih=_s?_s.createPolicy("lit-html",{createHTML:i=>i}):void 0,sl="$lit$",Jt=`lit$${(Math.random()+"").slice(9)}$`,X1="?"+Jt,Pf=`<${X1}>`,Wi=document,Lr=()=>Wi.createComment(""),Br=i=>i===null||typeof i!="object"&&typeof i!="function",Z1=Array.isArray,Of=i=>Z1(i)||typeof(i==null?void 0:i[Symbol.iterator])=="function",tn=`[ 	
\f\r]`,rr=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Nh=/-->/g,Hh=/>/g,bi=RegExp(`>|${tn}(?:([^\\s"'>=/]+)(${tn}*=${tn}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Uh=/'/g,Vh=/"/g,J1=/^(?:script|style|textarea|title)$/i,Df=i=>(e,...t)=>({_$litType$:i,strings:e,values:t}),Lf=Df(1),Ss=Symbol.for("lit-noChange"),Ce=Symbol.for("lit-nothing"),jh=new WeakMap,Pi=Wi.createTreeWalker(Wi,129,null,!1);function e0(i,e){if(!Array.isArray(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return Ih!==void 0?Ih.createHTML(e):e}const Bf=(i,e)=>{const t=i.length-1,s=[];let r,o=e===2?"<svg>":"",a=rr;for(let l=0;l<t;l++){const n=i[l];let c,h,d=-1,f=0;for(;f<n.length&&(a.lastIndex=f,h=a.exec(n),h!==null);)f=a.lastIndex,a===rr?h[1]==="!--"?a=Nh:h[1]!==void 0?a=Hh:h[2]!==void 0?(J1.test(h[2])&&(r=RegExp("</"+h[2],"g")),a=bi):h[3]!==void 0&&(a=bi):a===bi?h[0]===">"?(a=r??rr,d=-1):h[1]===void 0?d=-2:(d=a.lastIndex-h[2].length,c=h[1],a=h[3]===void 0?bi:h[3]==='"'?Vh:Uh):a===Vh||a===Uh?a=bi:a===Nh||a===Hh?a=rr:(a=bi,r=void 0);const g=a===bi&&i[l+1].startsWith("/>")?" ":"";o+=a===rr?n+Pf:d>=0?(s.push(c),n.slice(0,d)+sl+n.slice(d)+Jt+g):n+Jt+(d===-2?(s.push(void 0),l):g)}return[e0(i,o+(i[t]||"<?>")+(e===2?"</svg>":"")),s]};let rl=class t0{constructor({strings:e,_$litType$:t},s){let r;this.parts=[];let o=0,a=0;const l=e.length-1,n=this.parts,[c,h]=Bf(e,t);if(this.el=t0.createElement(c,s),Pi.currentNode=this.el.content,t===2){const d=this.el.content,f=d.firstChild;f.remove(),d.append(...f.childNodes)}for(;(r=Pi.nextNode())!==null&&n.length<l;){if(r.nodeType===1){if(r.hasAttributes()){const d=[];for(const f of r.getAttributeNames())if(f.endsWith(sl)||f.startsWith(Jt)){const g=h[a++];if(d.push(f),g!==void 0){const $=r.getAttribute(g.toLowerCase()+sl).split(Jt),w=/([.?@])?(.*)/.exec(g);n.push({type:1,index:o,name:w[2],strings:$,ctor:w[1]==="."?Rf:w[1]==="?"?If:w[1]==="@"?Nf:na})}else n.push({type:6,index:o})}for(const f of d)r.removeAttribute(f)}if(J1.test(r.tagName)){const d=r.textContent.split(Jt),f=d.length-1;if(f>0){r.textContent=_s?_s.emptyScript:"";for(let g=0;g<f;g++)r.append(d[g],Lr()),Pi.nextNode(),n.push({type:2,index:++o});r.append(d[f],Lr())}}}else if(r.nodeType===8)if(r.data===X1)n.push({type:2,index:o});else{let d=-1;for(;(d=r.data.indexOf(Jt,d+1))!==-1;)n.push({type:7,index:o}),d+=Jt.length-1}o++}}static createElement(e,t){const s=Wi.createElement("template");return s.innerHTML=e,s}};function Cs(i,e,t=i,s){var r,o,a,l;if(e===Ss)return e;let n=s!==void 0?(r=t._$Co)===null||r===void 0?void 0:r[s]:t._$Cl;const c=Br(e)?void 0:e._$litDirective$;return(n==null?void 0:n.constructor)!==c&&((o=n==null?void 0:n._$AO)===null||o===void 0||o.call(n,!1),c===void 0?n=void 0:(n=new c(i),n._$AT(i,t,s)),s!==void 0?((a=(l=t)._$Co)!==null&&a!==void 0?a:l._$Co=[])[s]=n:t._$Cl=n),n!==void 0&&(e=Cs(i,n._$AS(i,e.values),n,s)),e}let Ff=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){var t;const{el:{content:s},parts:r}=this._$AD,o=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:Wi).importNode(s,!0);Pi.currentNode=o;let a=Pi.nextNode(),l=0,n=0,c=r[0];for(;c!==void 0;){if(l===c.index){let h;c.type===2?h=new Vl(a,a.nextSibling,this,e):c.type===1?h=new c.ctor(a,c.name,c.strings,this,e):c.type===6&&(h=new Hf(a,this,e)),this._$AV.push(h),c=r[++n]}l!==(c==null?void 0:c.index)&&(a=Pi.nextNode(),l++)}return Pi.currentNode=Wi,o}v(e){let t=0;for(const s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(e,s,t),t+=s.strings.length-2):s._$AI(e[t])),t++}},Vl=class i0{constructor(e,t,s,r){var o;this.type=2,this._$AH=Ce,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=s,this.options=r,this._$Cp=(o=r==null?void 0:r.isConnected)===null||o===void 0||o}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cp}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Cs(this,e,t),Br(e)?e===Ce||e==null||e===""?(this._$AH!==Ce&&this._$AR(),this._$AH=Ce):e!==this._$AH&&e!==Ss&&this._(e):e._$litType$!==void 0?this.g(e):e.nodeType!==void 0?this.$(e):Of(e)?this.T(e):this._(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==Ce&&Br(this._$AH)?this._$AA.nextSibling.data=e:this.$(Wi.createTextNode(e)),this._$AH=e}g(e){var t;const{values:s,_$litType$:r}=e,o=typeof r=="number"?this._$AC(e):(r.el===void 0&&(r.el=rl.createElement(e0(r.h,r.h[0]),this.options)),r);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===o)this._$AH.v(s);else{const a=new Ff(o,this),l=a.u(this.options);a.v(s),this.$(l),this._$AH=a}}_$AC(e){let t=jh.get(e.strings);return t===void 0&&jh.set(e.strings,t=new rl(e)),t}T(e){Z1(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let s,r=0;for(const o of e)r===t.length?t.push(s=new i0(this.k(Lr()),this.k(Lr()),this,this.options)):s=t[r],s._$AI(o),r++;r<t.length&&(this._$AR(s&&s._$AB.nextSibling,r),t.length=r)}_$AR(e=this._$AA.nextSibling,t){var s;for((s=this._$AP)===null||s===void 0||s.call(this,!1,!0,t);e&&e!==this._$AB;){const r=e.nextSibling;e.remove(),e=r}}setConnected(e){var t;this._$AM===void 0&&(this._$Cp=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}},na=class{constructor(e,t,s,r,o){this.type=1,this._$AH=Ce,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=o,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=Ce}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,s,r){const o=this.strings;let a=!1;if(o===void 0)e=Cs(this,e,t,0),a=!Br(e)||e!==this._$AH&&e!==Ss,a&&(this._$AH=e);else{const l=e;let n,c;for(e=o[0],n=0;n<o.length-1;n++)c=Cs(this,l[s+n],t,n),c===Ss&&(c=this._$AH[n]),a||(a=!Br(c)||c!==this._$AH[n]),c===Ce?e=Ce:e!==Ce&&(e+=(c??"")+o[n+1]),this._$AH[n]=c}a&&!r&&this.j(e)}j(e){e===Ce?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},Rf=class extends na{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===Ce?void 0:e}};const zf=_s?_s.emptyScript:"";let If=class extends na{constructor(){super(...arguments),this.type=4}j(e){e&&e!==Ce?this.element.setAttribute(this.name,zf):this.element.removeAttribute(this.name)}},Nf=class extends na{constructor(e,t,s,r,o){super(e,t,s,r,o),this.type=5}_$AI(e,t=this){var s;if((e=(s=Cs(this,e,t,0))!==null&&s!==void 0?s:Ce)===Ss)return;const r=this._$AH,o=e===Ce&&r!==Ce||e.capture!==r.capture||e.once!==r.once||e.passive!==r.passive,a=e!==Ce&&(r===Ce||o);o&&this.element.removeEventListener(this.name,this,r),a&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,s;typeof this._$AH=="function"?this._$AH.call((s=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&s!==void 0?s:this.element,e):this._$AH.handleEvent(e)}},Hf=class{constructor(e,t,s){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(e){Cs(this,e)}};const Wh=Ho.litHtmlPolyfillSupport;Wh==null||Wh(rl,Vl),((en=Ho.litHtmlVersions)!==null&&en!==void 0?en:Ho.litHtmlVersions=[]).push("2.8.0");const Uf=(i,e,t)=>{var s,r;const o=(s=t==null?void 0:t.renderBefore)!==null&&s!==void 0?s:e;let a=o._$litPart$;if(a===void 0){const l=(r=t==null?void 0:t.renderBefore)!==null&&r!==void 0?r:null;o._$litPart$=a=new Vl(e.insertBefore(Lr(),l),l,void 0,t??{})}return a._$AI(i),a};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var sn,rn;let yr=class extends dt{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e,t;const s=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=s.firstChild),s}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Uf(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!1)}render(){return Ss}};yr.finalized=!0,yr._$litElement$=!0,(sn=globalThis.litElementHydrateSupport)===null||sn===void 0||sn.call(globalThis,{LitElement:yr});const qh=globalThis.litElementPolyfillSupport;qh==null||qh({LitElement:yr});((rn=globalThis.litElementVersions)!==null&&rn!==void 0?rn:globalThis.litElementVersions=[]).push("3.3.3");var Gh;(function(i){i.processing="processing",i.complete="complete"})(Gh||(Gh={}));let ol=class extends yr{constructor(){super(...arguments),this.mode="processing"}render(){return Lf`
      <div class="${this.mode}">
        <svg
          viewBox="0 0 120 120"
    ...
    `}};p([E({type:String})],ol.prototype,"mode",void 0);ol=p([Tt("ia-activity-indicator")],ol);const Vf=m`
<svg
  viewBox="0 0 40 40"
  version="1.1"
  xmlns="http://www.w3.org/2000/svg"
...
`;class jf extends H{static get styles(){return y`
      :host {
...
`;let al=class extends H{constructor(){super(...arguments),this.config=new zi}render(){return m`
    ...
    </button> `}static get styles(){const e=y`var(--modalLogoSize, 6.5rem)`,t=y`var(--processingImageSize, 7.5rem)`,s=y`var(--modalCornerRadius, 1rem)`,r=y`var(--modalBorder, 2px solid black)`,o=y`var(--modalBottomMargin, 2.5rem)`,a=y`var(--modalTopMargin, 5rem)`,l=y`var(--modalHeaderBottomPadding, 0.5em)`,n=y`var(--modalBottomPadding, 2rem)`,c=y`var(--modalScrollOffset, 5px)`,h=y`var(--modalTitleFontSize, 1.8rem)`,d=y`var(--modalSubtitleFontSize, 1.4rem)`,f=y`var(--modalHeadlineFontSize, 1.6rem)`,g=y`var(--modalMessageFontSize, 1.4rem)`,$=y`var(--modalTitleLineHeight, normal)`,w=y`var(--modalSubtitleLineHeight, normal)`,T=y`var(--modalHeadlineLineHeight, normal)`,P=y`var(--modalMessageLineHeight, normal)`;return y`
      .processing-logo {
        margin: auto;
        width: ${t};
        height: ${t};
    ...
    `}};p([u({type:Object})],al.prototype,"config",void 0);al=p([N("modal-template")],al);function Gf(i,e,t){var s=t||{},r=s.noTrailing,o=r===void 0?!1:r,a=s.noLeading,l=a===void 0?!1:a,n=s.debounceMode,c=n===void 0?void 0:n,h,d=!1,f=0;function g(){h&&clearTimeout(h)}function $(T){var P=T||{},O=P.upcomingOnly,D=O===void 0?!1:O;g(),d=!D}function w(){for(var T=arguments.length,P=new Array(T),O=0;O<T;O++)P[O]=arguments[O];var D=this,z=Date.now()-f;if(d)return;function Y(){f=Date.now(),e.apply(D,P)}function fe(){h=void 0}!l&&c&&!h&&Y(),g(),c===void 0&&z>i?l?(f=Date.now(),o||(h=setTimeout(c?fe:Y,i))):Y():o!==!0&&(h=setTimeout(c?fe:Y,c===void 0?i-z:i))}return w.cancel=$,w}var si;(function(i){i.Open="open",i.Closed="closed"})(si||(si={}));class Yf{constructor(e){this.windowResizeThrottler=Gf(100,this.updateModalContainerHeight,{noLeading:!1,noTrailing:!1}).bind(this),this.modalManager=e}handleModeChange(e){switch(e){case si.Open:this.startResizeListener(),this.stopDocumentScroll();break;case si.Closed:this.stopResizeListener(),this.resumeDocumentScroll();break}}updateModalContainerHeight(){this.modalManager.style.setProperty("--containerHeight",`${window.innerHeight}px`)}stopDocumentScroll(){document.body.classList.add("modal-manager-open")}resumeDocumentScroll(){document.body.classList.remove("modal-manager-open")}startResizeListener(){window.addEventListener("resize",this.windowResizeThrottler)}stopResizeListener(){window.removeEventListener("resize",this.windowResizeThrottler)}}let Ts=class extends H{constructor(){super(...arguments),this.mode=si.Closed,this.hostBridge=new Yf(this),this.modal=new Mf(this),this.closeOnBackdropClick=!0}async firstUpdated(){await new Promise(e=>setTimeout(e,0)),this.closeOnBackdropClick&&this.addEventListener("keydown",e=>{e.key==="Escape"&&this.backdropClicked()})}disconnectedCallback(){super.disconnectedCallback(),this.modal.deactivate()}render(){return m`
      <div class="container">
    ...
    `}};p([u({type:String,reflect:!0})],Ts.prototype,"mode",void 0);p([u({type:Object})],Ts.prototype,"customModalContent",void 0);p([u({type:Object})],Ts.prototype,"hostBridge",void 0);p([ee("modal-template")],Ts.prototype,"modalTemplate",void 0);Ts=p([N("modal-manager")],Ts);const Yh=y`var(--white, #fff)`,Qf=y`var(--primaryDisableCTAFill, #767676)`,Kf=y`var(--secondaryCTABorder, #999)`,Xf=y`var(--primaryCTAFill, #194880)`,on=y`var(--primaryCTAFillRGB, 25, 72, 128)`,Zf=y`var(--primaryCTABorder, #c5d1df)`,Jf=y`var(--primaryErrorCTAFill, #d9534f)`,an=y`var(--primaryErrorCTAFillRGB, 229, 28, 38)`,em=y`var(--primaryErrorCTABorder, #d43f3a)`,tm=y`var(--secondaryCTAFill, #333)`,nn=y`var(--secondaryCTAFillRGB, 51, 51, 51)`,im=y`var(--primaryCTABorder, #979797)`,sm=y`var(---primaryWarningFill, #ee8950)`,ln=y`var(--primaryWarningFillRGB, 238, 137, 80)`,rm=y`var(--primaryWarningBorder, #ec7939)`,om=y`
  .ia-button {
    min-height: 3rem;
    cursor: pointer;
    color: ${Yh};
...
`;var am=Object.defineProperty,nm=Object.getOwnPropertyDescriptor,jl=(i,e,t,s)=>{for(var r=s>1?void 0:s?nm(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&am(e,t,r),r};let Uo=class extends H{constructor(){super(...arguments),this.items=[]}render(){return m`
      <ul>
        ${Ri(this.items,({title:i,date:e})=>m`
            <li>
    ...
    `}};jl([u({type:Object})],Uo.prototype,"items",2);jl([u({type:String})],Uo.prototype,"message",2);Uo=jl([N("remove-items-modal-content")],Uo);var lm=Object.defineProperty,cm=Object.getOwnPropertyDescriptor,Vt=(i,e,t,s)=>{for(var r=s>1?void 0:s?cm(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&lm(e,t,r),r};let Ct=class extends H{constructor(){super(...arguments),this.label=S("Select items to remove"),this.selectedItems=[],this.showSelectAll=!1,this.showUnselectAll=!1,this.showItemManageButton=!1,this.removeAllowed=!1}render(){return m`
    ...
    `}};Vt([u({type:String})],Ct.prototype,"label",2);Vt([u({type:Object})],Ct.prototype,"modalManager",2);Vt([u({type:Object})],Ct.prototype,"selectedItems",2);Vt([u({type:String})],Ct.prototype,"manageViewModalMsg",2);Vt([u({type:Boolean})],Ct.prototype,"showSelectAll",2);Vt([u({type:Boolean})],Ct.prototype,"showUnselectAll",2);Vt([u({type:Boolean})],Ct.prototype,"showItemManageButton",2);Vt([u({type:Boolean})],Ct.prototype,"removeAllowed",2);Ct=Vt([N("manage-bar")],Ct);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const $r=(i,e)=>{var s;const t=i._$AN;if(t===void 0)return!1;for(const r of t)(s=r._$AO)==null||s.call(r,e,!1),$r(r,e);return!0},Vo=i=>{let e,t;do{if((e=i._$AM)===void 0)break;t=e._$AN,t.delete(i),i=e}while((t==null?void 0:t.size)===0)},s0=i=>{for(let e;e=i._$AM;i=e){let t=e._$AN;if(t===void 0)e._$AN=t=new Set;else if(t.has(i))break;t.add(i),pm(e)}};function hm(i){this._$AN!==void 0?(Vo(this),this._$AM=i,s0(this)):this._$AM=i}function dm(i,e=!1,t=0){const s=this._$AH,r=this._$AN;if(r!==void 0&&r.size!==0)if(e)if(Array.isArray(s))for(let o=t;o<s.length;o++)$r(s[o],!1),Vo(s[o]);else s!=null&&($r(s,!1),Vo(s));else $r(this,i)}const pm=i=>{i.type==St.CHILD&&(i._$AP??(i._$AP=dm),i._$AQ??(i._$AQ=hm))};let um=class extends Wr{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,s){super._$AT(e,t,s),s0(this),this.isConnected=e._$AU}_$AO(e,t=!0){var s,r;e!==this.isConnected&&(this.isConnected=e,e?(s=this.reconnected)==null||s.call(this):(r=this.disconnected)==null||r.call(this)),t&&($r(this,e),Vo(this))}setValue(e){if(y1(this._$Ct))this._$Ct._$AI(e,this);else{const t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}};const cn=new WeakMap,fm=jr(class extends um{render(i){return ie}update(i,[e]){var s;const t=e!==this.G;return t&&this.G!==void 0&&this.rt(void 0),(t||this.lt!==this.ct)&&(this.G=e,this.ht=(s=i.options)==null?void 0:s.host,this.rt(this.ct=i.element)),ie}rt(i){if(this.isConnected||(i=void 0),typeof this.G=="function"){const e=this.ht??globalThis;let t=cn.get(e);t===void 0&&(t=new WeakMap,cn.set(e,t)),t.get(this.G)!==void 0&&this.G.call(this.ht,void 0),t.set(this.G,i),i!==void 0&&this.G.call(this.ht,i)}else this.G.value=i}get lt(){var i,e;return typeof this.G=="function"?(i=cn.get(this.ht??globalThis))==null?void 0:i.get(this.G):(e=this.G)==null?void 0:e.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}});var r0=60,o0=r0*60,a0=o0*24,mm=a0*7,As=1e3,hn=r0*As,Qh=o0*As,gm=a0*As,vm=mm*As,Wl="millisecond",ns="second",ls="minute",cs="hour",qt="day",$o="week",ct="month",n0="quarter",Gt="year",hs="date",bm="YYYY-MM-DDTHH:mm:ssZ",Kh="Invalid Date",ym=/^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/,$m=/\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g;const wm={name:"en",weekdays:"Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),months:"January_February_March_April_May_June_July_August_September_October_November_December".split("_"),ordinal:function(e){var t=["th","st","nd","rd"],s=e%100;return"["+e+(t[(s-20)%10]||t[s]||t[0])+"]"}};var nl=function(e,t,s){var r=String(e);return!r||r.length>=t?e:""+Array(t+1-r.length).join(s)+e},xm=function(e){var t=-e.utcOffset(),s=Math.abs(t),r=Math.floor(s/60),o=s%60;return(t<=0?"+":"-")+nl(r,2,"0")+":"+nl(o,2,"0")},_m=function i(e,t){if(e.date()<t.date())return-i(t,e);var s=(t.year()-e.year())*12+(t.month()-e.month()),r=e.clone().add(s,ct),o=t-r<0,a=e.clone().add(s+(o?-1:1),ct);return+(-(s+(t-r)/(o?r-a:a-r))||0)},Sm=function(e){return e<0?Math.ceil(e)||0:Math.floor(e)},Cm=function(e){var t={M:ct,y:Gt,w:$o,d:qt,D:hs,h:cs,m:ls,s:ns,ms:Wl,Q:n0};return t[e]||String(e||"").toLowerCase().replace(/s$/,"")},Tm=function(e){return e===void 0};const Am={s:nl,z:xm,m:_m,a:Sm,p:Cm,u:Tm};var wr="en",Ii={};Ii[wr]=wm;var l0="$isDayjsObject",ql=function(e){return e instanceof la||!!(e&&e[l0])},jo=function i(e,t,s){var r;if(!e)return wr;if(typeof e=="string"){var o=e.toLowerCase();Ii[o]&&(r=o),t&&(Ii[o]=t,r=o);var a=e.split("-");if(!r&&a.length>1)return i(a[0])}else{var l=e.name;Ii[l]=e,r=l}return!s&&r&&(wr=r),r||!s&&wr},se=function(e,t){if(ql(e))return e.clone();var s=typeof t=="object"?t:{};return s.date=e,s.args=arguments,new la(s)},km=function(e,t){return se(e,{locale:t.$L,utc:t.$u,x:t.$x,$offset:t.$offset})},Q=Am;Q.l=jo;Q.i=ql;Q.w=km;var Em=function(e){var t=e.date,s=e.utc;if(t===null)return new Date(NaN);if(Q.u(t))return new Date;if(t instanceof Date)return new Date(t);if(typeof t=="string"&&!/Z$/i.test(t)){var r=t.match(ym);if(r){var o=r[2]-1||0,a=(r[7]||"0").substring(0,3);return s?new Date(Date.UTC(r[1],o,r[3]||1,r[4]||0,r[5]||0,r[6]||0,a)):new Date(r[1],o,r[3]||1,r[4]||0,r[5]||0,r[6]||0,a)}}return new Date(t)},la=function(){function i(t){this.$L=jo(t.locale,null,!0),this.parse(t),this.$x=this.$x||t.x||{},this[l0]=!0}var e=i.prototype;return e.parse=function(s){this.$d=Em(s),this.init()},e.init=function(){var s=this.$d;this.$y=s.getFullYear(),this.$M=s.getMonth(),this.$D=s.getDate(),this.$W=s.getDay(),this.$H=s.getHours(),this.$m=s.getMinutes(),this.$s=s.getSeconds(),this.$ms=s.getMilliseconds()},e.$utils=function(){return Q},e.isValid=function(){return this.$d.toString()!==Kh},e.isSame=function(s,r){var o=se(s);return this.startOf(r)<=o&&o<=this.endOf(r)},e.isAfter=function(s,r){return se(s)<this.startOf(r)},e.isBefore=function(s,r){return this.endOf(r)<se(s)},e.$g=function(s,r,o){return Q.u(s)?this[r]:this.set(o,s)},e.unix=function(){return Math.floor(this.valueOf()/1e3)},e.valueOf=function(){return this.$d.getTime()},e.startOf=function(s,r){var o=this,a=Q.u(r)?!0:r,l=Q.p(s),n=function(P,O){var D=Q.w(o.$u?Date.UTC(o.$y,O,P):new Date(o.$y,O,P),o);return a?D:D.endOf(qt)},c=function(P,O){var D=[0,0,0,0],z=[23,59,59,999];return Q.w(o.toDate()[P].apply(o.toDate("s"),(a?D:z).slice(O)),o)},h=this.$W,d=this.$M,f=this.$D,g="set"+(this.$u?"UTC":"");switch(l){case Gt:return a?n(1,0):n(31,11);case ct:return a?n(1,d):n(0,d+1);case $o:{var $=this.$locale().weekStart||0,w=(h<$?h+7:h)-$;return n(a?f-w:f+(6-w),d)}case qt:case hs:return c(g+"Hours",0);case cs:return c(g+"Minutes",1);case ls:return c(g+"Seconds",2);case ns:return c(g+"Milliseconds",3);default:return this.clone()}},e.endOf=function(s){return this.startOf(s,!1)},e.$set=function(s,r){var o,a=Q.p(s),l="set"+(this.$u?"UTC":""),n=(o={},o[qt]=l+"Date",o[hs]=l+"Date",o[ct]=l+"Month",o[Gt]=l+"FullYear",o[cs]=l+"Hours",o[ls]=l+"Minutes",o[ns]=l+"Seconds",o[Wl]=l+"Milliseconds",o)[a],c=a===qt?this.$D+(r-this.$W):r;if(a===ct||a===Gt){var h=this.clone().set(hs,1);h.$d[n](c),h.init(),this.$d=h.set(hs,Math.min(this.$D,h.daysInMonth())).$d}else n&&this.$d[n](c);return this.init(),this},e.set=function(s,r){return this.clone().$set(s,r)},e.get=function(s){return this[Q.p(s)]()},e.add=function(s,r){var o=this,a;s=Number(s);var l=Q.p(r),n=function(f){var g=se(o);return Q.w(g.date(g.date()+Math.round(f*s)),o)};if(l===ct)return this.set(ct,this.$M+s);if(l===Gt)return this.set(Gt,this.$y+s);if(l===qt)return n(1);if(l===$o)return n(7);var c=(a={},a[ls]=hn,a[cs]=Qh,a[ns]=As,a)[l]||1,h=this.$d.getTime()+s*c;return Q.w(h,this)},e.subtract=function(s,r){return this.add(s*-1,r)},e.format=function(s){var r=this,o=this.$locale();if(!this.isValid())return o.invalidDate||Kh;var a=s||bm,l=Q.z(this),n=this.$H,c=this.$m,h=this.$M,d=o.weekdays,f=o.months,g=o.meridiem,$=function(D,z,Y,fe){return D&&(D[z]||D(r,a))||Y[z].slice(0,fe)},w=function(D){return Q.s(n%12||12,D,"0")},T=g||function(O,D,z){var Y=O<12?"AM":"PM";return z?Y.toLowerCase():Y},P=function(D){switch(D){case"YY":return String(r.$y).slice(-2);case"YYYY":return Q.s(r.$y,4,"0");case"M":return h+1;case"MM":return Q.s(h+1,2,"0");case"MMM":return $(o.monthsShort,h,f,3);case"MMMM":return $(f,h);case"D":return r.$D;case"DD":return Q.s(r.$D,2,"0");case"d":return String(r.$W);case"dd":return $(o.weekdaysMin,r.$W,d,2);case"ddd":return $(o.weekdaysShort,r.$W,d,3);case"dddd":return d[r.$W];case"H":return String(n);case"HH":return Q.s(n,2,"0");case"h":return w(1);case"hh":return w(2);case"a":return T(n,c,!0);case"A":return T(n,c,!1);case"m":return String(c);case"mm":return Q.s(c,2,"0");case"s":return String(r.$s);case"ss":return Q.s(r.$s,2,"0");case"SSS":return Q.s(r.$ms,3,"0");case"Z":return l}return null};return a.replace($m,function(O,D){return D||P(O)||l.replace(":","")})},e.utcOffset=function(){return-Math.round(this.$d.getTimezoneOffset()/15)*15},e.diff=function(s,r,o){var a=this,l=Q.p(r),n=se(s),c=(n.utcOffset()-this.utcOffset())*hn,h=this-n,d=function(){return Q.m(a,n)},f;switch(l){case Gt:f=d()/12;break;case ct:f=d();break;case n0:f=d()/3;break;case $o:f=(h-c)/vm;break;case qt:f=(h-c)/gm;break;case cs:f=h/Qh;break;case ls:f=h/hn;break;case ns:f=h/As;break;default:f=h;break}return o?f:Q.a(f)},e.daysInMonth=function(){return this.endOf(ct).$D},e.$locale=function(){return Ii[this.$L]},e.locale=function(s,r){if(!s)return this.$L;var o=this.clone(),a=jo(s,r,!0);return a&&(o.$L=a),o},e.clone=function(){return Q.w(this.$d,this)},e.toDate=function(){return new Date(this.valueOf())},e.toJSON=function(){return this.isValid()?this.toISOString():null},e.toISOString=function(){return this.$d.toISOString()},e.toString=function(){return this.$d.toUTCString()},i}(),c0=la.prototype;se.prototype=c0;[["$ms",Wl],["$s",ns],["$m",ls],["$H",cs],["$W",qt],["$M",ct],["$y",Gt],["$D",hs]].forEach(function(i){c0[i[1]]=function(e){return this.$g(e,i[0],i[1])}});se.extend=function(i,e){return i.$i||(i(e,la,se),i.$i=!0),se};se.locale=jo;se.isDayjs=ql;se.unix=function(i){return se(i*1e3)};se.en=Ii[wr];se.Ls=Ii;se.p={};var Mm=function(e){return e.replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g,function(t,s,r){return s||r.slice(1)})},Pm={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"},Om=function(e,t){return e.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g,function(s,r,o){var a=o&&o.toUpperCase();return r||t[o]||Pm[o]||Mm(t[a])})},Dm=/(\[[^[]*\])|([-_:/.,()\s]+)|(A|a|Q|YYYY|YY?|ww?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g,Xh=/\d/,or=/\d\d/,Lm=/\d{3}/,Bm=/\d{4}/,nt=/\d\d?/,Fm=/[+-]?\d+/,Rm=/[+-]\d\d:?(\d\d)?|Z/,ar=/\d*[^-_:/,()\s\d]+/,ai={},h0=function(e){return e=+e,e+(e>68?1900:2e3)};function zm(i){if(!i||i==="Z")return 0;var e=i.match(/([+-]|\d\d)/g),t=+(e[1]*60)+(+e[2]||0);return t===0?0:e[0]==="+"?-t:t}var Pe=function(e){return function(t){this[e]=+t}},Zh=[Rm,function(i){var e=this.zone||(this.zone={});e.offset=zm(i)}],dn=function(e){var t=ai[e];return t&&(t.indexOf?t:t.s.concat(t.f))},Jh=function(e,t){var s,r=ai,o=r.meridiem;if(!o)s=e===(t?"pm":"PM");else for(var a=1;a<=24;a+=1)if(e.indexOf(o(a,0,t))>-1){s=a>12;break}return s},Im={A:[ar,function(i){this.afternoon=Jh(i,!1)}],a:[ar,function(i){this.afternoon=Jh(i,!0)}],Q:[Xh,function(i){this.month=(i-1)*3+1}],S:[Xh,function(i){this.milliseconds=+i*100}],SS:[or,function(i){this.milliseconds=+i*10}],SSS:[Lm,function(i){this.milliseconds=+i}],s:[nt,Pe("seconds")],ss:[nt,Pe("seconds")],m:[nt,Pe("minutes")],mm:[nt,Pe("minutes")],H:[nt,Pe("hours")],h:[nt,Pe("hours")],HH:[nt,Pe("hours")],hh:[nt,Pe("hours")],D:[nt,Pe("day")],DD:[or,Pe("day")],Do:[ar,function(i){var e=ai,t=e.ordinal,s=i.match(/\d+/);if(this.day=s[0],!!t)for(var r=1;r<=31;r+=1)t(r).replace(/\[|\]/g,"")===i&&(this.day=r)}],w:[nt,Pe("week")],ww:[or,Pe("week")],M:[nt,Pe("month")],MM:[or,Pe("month")],MMM:[ar,function(i){var e=dn("months"),t=dn("monthsShort"),s=(t||e.map(function(r){return r.slice(0,3)})).indexOf(i)+1;if(s<1)throw new Error;this.month=s%12||s}],MMMM:[ar,function(i){var e=dn("months"),t=e.indexOf(i)+1;if(t<1)throw new Error;this.month=t%12||t}],Y:[Fm,Pe("year")],YY:[or,function(i){this.year=h0(i)}],YYYY:[Bm,Pe("year")],Z:Zh,ZZ:Zh};function Nm(i){var e=i.afternoon;if(e!==void 0){var t=i.hours;e?t<12&&(i.hours+=12):t===12&&(i.hours=0),delete i.afternoon}}function Hm(i){i=Om(i,ai&&ai.formats);for(var e=i.match(Dm),t=e.length,s=0;s<t;s+=1){var r=e[s],o=Im[r],a=o&&o[0],l=o&&o[1];l?e[s]={regex:a,parser:l}:e[s]=r.replace(/^\[|\]$/g,"")}return function(n){for(var c={},h=0,d=0;h<t;h+=1){var f=e[h];if(typeof f=="string")d+=f.length;else{var g=f.regex,$=f.parser,w=n.slice(d),T=g.exec(w),P=T[0];$.call(c,P),n=n.replace(P,"")}}return Nm(c),c}}var Um=function(e,t,s,r){try{if(["x","X"].indexOf(t)>-1)return new Date((t==="X"?1e3:1)*e);var o=Hm(t),a=o(e),l=a.year,n=a.month,c=a.day,h=a.hours,d=a.minutes,f=a.seconds,g=a.milliseconds,$=a.zone,w=a.week,T=new Date,P=c||(!l&&!n?T.getDate():1),O=l||T.getFullYear(),D=0;l&&!n||(D=n>0?n-1:T.getMonth());var z=h||0,Y=d||0,fe=f||0,Ge=g||0;if($)return new Date(Date.UTC(O,D,P,z,Y,fe,Ge+$.offset*60*1e3));if(s)return new Date(Date.UTC(O,D,P,z,Y,fe,Ge));var Ue;return Ue=new Date(O,D,P,z,Y,fe,Ge),w&&(Ue=r(Ue).week(w).toDate()),Ue}catch{return new Date("")}};const Vm=function(i,e,t){t.p.customParseFormat=!0,i&&i.parseTwoDigitYear&&(h0=i.parseTwoDigitYear);var s=e.prototype,r=s.parse;s.parse=function(o){var a=o.date,l=o.utc,n=o.args;this.$u=l;var c=n[1];if(typeof c=="string"){var h=n[2]===!0,d=n[3]===!0,f=h||d,g=n[2];d&&(g=n[2]),ai=this.$locale(),!h&&g&&(ai=t.Ls[g]),this.$d=Um(a,c,l,t),this.init(),g&&g!==!0&&(this.$L=this.locale(g).$L),f&&a!=this.format(c)&&(this.$d=new Date("")),ai={}}else if(c instanceof Array)for(var $=c.length,w=1;w<=$;w+=1){n[1]=c[w-1];var T=t.apply(this,n);if(T.isValid()){this.$d=T.$d,this.$L=T.$L,this.init();break}w===$&&(this.$d=new Date(""))}else r.call(this,o)}};function jm(i,e){const t=e.prototype,s=t.parse;t.parse=function(r){const o=r.date,a=r.args[1];s.call(this,r);const l=this.year(),n=l>=1900&&l<2e3,c=typeof a=="string"&&a.includes("YYYY"),h=Array.isArray(a)&&typeof a[0]=="string"&&a[0].includes("YYYY"),d=c||h,f=typeof o=="string"&&!o.includes(`${l}`);n&&d&&f&&(this.$d.setFullYear(l-1900),this.init())}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var pn;const Wo=window,ks=Wo.trustedTypes,ed=ks?ks.createPolicy("lit-html",{createHTML:i=>i}):void 0,ll="$lit$",ei=`lit$${(Math.random()+"").slice(9)}$`,d0="?"+ei,Wm=`<${d0}>`,qi=document,Fr=()=>qi.createComment(""),Rr=i=>i===null||typeof i!="object"&&typeof i!="function",p0=Array.isArray,qm=i=>p0(i)||typeof(i==null?void 0:i[Symbol.iterator])=="function",un=`[ 	
\f\r]`,nr=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,td=/-->/g,id=/>/g,yi=RegExp(`>|${un}(?:([^\\s"'>=/]+)(${un}*=${un}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),sd=/'/g,rd=/"/g,u0=/^(?:script|style|textarea|title)$/i,f0=i=>(e,...t)=>({_$litType$:i,strings:e,values:t}),_t=f0(1),fn=f0(2),it=Symbol.for("lit-noChange"),ve=Symbol.for("lit-nothing"),od=new WeakMap,Oi=qi.createTreeWalker(qi,129,null,!1);function m0(i,e){if(!Array.isArray(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return ed!==void 0?ed.createHTML(e):e}const Gm=(i,e)=>{const t=i.length-1,s=[];let r,o=e===2?"<svg>":"",a=nr;for(let l=0;l<t;l++){const n=i[l];let c,h,d=-1,f=0;for(;f<n.length&&(a.lastIndex=f,h=a.exec(n),h!==null);)f=a.lastIndex,a===nr?h[1]==="!--"?a=td:h[1]!==void 0?a=id:h[2]!==void 0?(u0.test(h[2])&&(r=RegExp("</"+h[2],"g")),a=yi):h[3]!==void 0&&(a=yi):a===yi?h[0]===">"?(a=r??nr,d=-1):h[1]===void 0?d=-2:(d=a.lastIndex-h[2].length,c=h[1],a=h[3]===void 0?yi:h[3]==='"'?rd:sd):a===rd||a===sd?a=yi:a===td||a===id?a=nr:(a=yi,r=void 0);const g=a===yi&&i[l+1].startsWith("/>")?" ":"";o+=a===nr?n+Wm:d>=0?(s.push(c),n.slice(0,d)+ll+n.slice(d)+ei+g):n+ei+(d===-2?(s.push(void 0),l):g)}return[m0(i,o+(i[t]||"<?>")+(e===2?"</svg>":"")),s]};let cl=class g0{constructor({strings:e,_$litType$:t},s){let r;this.parts=[];let o=0,a=0;const l=e.length-1,n=this.parts,[c,h]=Gm(e,t);if(this.el=g0.createElement(c,s),Oi.currentNode=this.el.content,t===2){const d=this.el.content,f=d.firstChild;f.remove(),d.append(...f.childNodes)}for(;(r=Oi.nextNode())!==null&&n.length<l;){if(r.nodeType===1){if(r.hasAttributes()){const d=[];for(const f of r.getAttributeNames())if(f.endsWith(ll)||f.startsWith(ei)){const g=h[a++];if(d.push(f),g!==void 0){const $=r.getAttribute(g.toLowerCase()+ll).split(ei),w=/([.?@])?(.*)/.exec(g);n.push({type:1,index:o,name:w[2],strings:$,ctor:w[1]==="."?Qm:w[1]==="?"?Xm:w[1]==="@"?Zm:ca})}else n.push({type:6,index:o})}for(const f of d)r.removeAttribute(f)}if(u0.test(r.tagName)){const d=r.textContent.split(ei),f=d.length-1;if(f>0){r.textContent=ks?ks.emptyScript:"";for(let g=0;g<f;g++)r.append(d[g],Fr()),Oi.nextNode(),n.push({type:2,index:++o});r.append(d[f],Fr())}}}else if(r.nodeType===8)if(r.data===d0)n.push({type:2,index:o});else{let d=-1;for(;(d=r.data.indexOf(ei,d+1))!==-1;)n.push({type:7,index:o}),d+=ei.length-1}o++}}static createElement(e,t){const s=qi.createElement("template");return s.innerHTML=e,s}};function Es(i,e,t=i,s){var r,o,a,l;if(e===it)return e;let n=s!==void 0?(r=t._$Co)===null||r===void 0?void 0:r[s]:t._$Cl;const c=Rr(e)?void 0:e._$litDirective$;return(n==null?void 0:n.constructor)!==c&&((o=n==null?void 0:n._$AO)===null||o===void 0||o.call(n,!1),c===void 0?n=void 0:(n=new c(i),n._$AT(i,t,s)),s!==void 0?((a=(l=t)._$Co)!==null&&a!==void 0?a:l._$Co=[])[s]=n:t._$Cl=n),n!==void 0&&(e=Es(i,n._$AS(i,e.values),n,s)),e}let Ym=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){var t;const{el:{content:s},parts:r}=this._$AD,o=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:qi).importNode(s,!0);Oi.currentNode=o;let a=Oi.nextNode(),l=0,n=0,c=r[0];for(;c!==void 0;){if(l===c.index){let h;c.type===2?h=new Gl(a,a.nextSibling,this,e):c.type===1?h=new c.ctor(a,c.name,c.strings,this,e):c.type===6&&(h=new Jm(a,this,e)),this._$AV.push(h),c=r[++n]}l!==(c==null?void 0:c.index)&&(a=Oi.nextNode(),l++)}return Oi.currentNode=qi,o}v(e){let t=0;for(const s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(e,s,t),t+=s.strings.length-2):s._$AI(e[t])),t++}},Gl=class v0{constructor(e,t,s,r){var o;this.type=2,this._$AH=ve,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=s,this.options=r,this._$Cp=(o=r==null?void 0:r.isConnected)===null||o===void 0||o}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cp}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Es(this,e,t),Rr(e)?e===ve||e==null||e===""?(this._$AH!==ve&&this._$AR(),this._$AH=ve):e!==this._$AH&&e!==it&&this._(e):e._$litType$!==void 0?this.g(e):e.nodeType!==void 0?this.$(e):qm(e)?this.T(e):this._(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==ve&&Rr(this._$AH)?this._$AA.nextSibling.data=e:this.$(qi.createTextNode(e)),this._$AH=e}g(e){var t;const{values:s,_$litType$:r}=e,o=typeof r=="number"?this._$AC(e):(r.el===void 0&&(r.el=cl.createElement(m0(r.h,r.h[0]),this.options)),r);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===o)this._$AH.v(s);else{const a=new Ym(o,this),l=a.u(this.options);a.v(s),this.$(l),this._$AH=a}}_$AC(e){let t=od.get(e.strings);return t===void 0&&od.set(e.strings,t=new cl(e)),t}T(e){p0(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let s,r=0;for(const o of e)r===t.length?t.push(s=new v0(this.k(Fr()),this.k(Fr()),this,this.options)):s=t[r],s._$AI(o),r++;r<t.length&&(this._$AR(s&&s._$AB.nextSibling,r),t.length=r)}_$AR(e=this._$AA.nextSibling,t){var s;for((s=this._$AP)===null||s===void 0||s.call(this,!1,!0,t);e&&e!==this._$AB;){const r=e.nextSibling;e.remove(),e=r}}setConnected(e){var t;this._$AM===void 0&&(this._$Cp=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}},ca=class{constructor(e,t,s,r,o){this.type=1,this._$AH=ve,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=o,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=ve}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,s,r){const o=this.strings;let a=!1;if(o===void 0)e=Es(this,e,t,0),a=!Rr(e)||e!==this._$AH&&e!==it,a&&(this._$AH=e);else{const l=e;let n,c;for(e=o[0],n=0;n<o.length-1;n++)c=Es(this,l[s+n],t,n),c===it&&(c=this._$AH[n]),a||(a=!Rr(c)||c!==this._$AH[n]),c===ve?e=ve:e!==ve&&(e+=(c??"")+o[n+1]),this._$AH[n]=c}a&&!r&&this.j(e)}j(e){e===ve?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},Qm=class extends ca{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===ve?void 0:e}};const Km=ks?ks.emptyScript:"";let Xm=class extends ca{constructor(){super(...arguments),this.type=4}j(e){e&&e!==ve?this.element.setAttribute(this.name,Km):this.element.removeAttribute(this.name)}},Zm=class extends ca{constructor(e,t,s,r,o){super(e,t,s,r,o),this.type=5}_$AI(e,t=this){var s;if((e=(s=Es(this,e,t,0))!==null&&s!==void 0?s:ve)===it)return;const r=this._$AH,o=e===ve&&r!==ve||e.capture!==r.capture||e.once!==r.once||e.passive!==r.passive,a=e!==ve&&(r===ve||o);o&&this.element.removeEventListener(this.name,this,r),a&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,s;typeof this._$AH=="function"?this._$AH.call((s=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&s!==void 0?s:this.element,e):this._$AH.handleEvent(e)}},Jm=class{constructor(e,t,s){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(e){Es(this,e)}};const ad=Wo.litHtmlPolyfillSupport;ad==null||ad(cl,Gl),((pn=Wo.litHtmlVersions)!==null&&pn!==void 0?pn:Wo.litHtmlVersions=[]).push("2.8.0");const e4=(i,e,t)=>{var s,r;const o=(s=t==null?void 0:t.renderBefore)!==null&&s!==void 0?s:e;let a=o._$litPart$;if(a===void 0){const l=(r=t==null?void 0:t.renderBefore)!==null&&r!==void 0?r:null;o._$litPart$=a=new Gl(e.insertBefore(Fr(),l),l,void 0,t??{})}return a._$AI(i),a};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var mn,gn;let xr=class extends dt{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e,t;const s=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=s.firstChild),s}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=e4(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!1)}render(){return it}};xr.finalized=!0,xr._$litElement$=!0,(mn=globalThis.litElementHydrateSupport)===null||mn===void 0||mn.call(globalThis,{LitElement:xr});const nd=globalThis.litElementPolyfillSupport;nd==null||nd({LitElement:xr});((gn=globalThis.litElementVersions)!==null&&gn!==void 0?gn:globalThis.litElementVersions=[]).push("3.3.3");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Yt={ATTRIBUTE:1,PROPERTY:3,BOOLEAN_ATTRIBUTE:4},Yl=i=>(...e)=>({_$litDirective$:i,values:e});let Ql=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,s){this._$Ct=e,this._$AM=t,this._$Ci=s}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}};/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const t4=i=>i.strings===void 0,i4={},s4=(i,e=i4)=>i._$AH=e;/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ld=Yl(class extends Ql{constructor(i){if(super(i),i.type!==Yt.PROPERTY&&i.type!==Yt.ATTRIBUTE&&i.type!==Yt.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!t4(i))throw Error("`live` bindings can only contain a single expression")}render(i){return i}update(i,[e]){if(e===it||e===ve)return e;const t=i.element,s=i.name;if(i.type===Yt.PROPERTY){if(e===t[s])return it}else if(i.type===Yt.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(s))return it}else if(i.type===Yt.ATTRIBUTE&&t.getAttribute(s)===e+"")return it;return s4(i),e}});/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const r4=Yl(class extends Ql{constructor(i){var e;if(super(i),i.type!==Yt.ATTRIBUTE||i.name!=="class"||((e=i.strings)===null||e===void 0?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(i){return" "+Object.keys(i).filter(e=>i[e]).join(" ")+" "}update(i,[e]){var t,s;if(this.it===void 0){this.it=new Set,i.strings!==void 0&&(this.nt=new Set(i.strings.join(" ").split(/\s/).filter(o=>o!=="")));for(const o in e)e[o]&&!(!((t=this.nt)===null||t===void 0)&&t.has(o))&&this.it.add(o);return this.render(e)}const r=i.element.classList;this.it.forEach(o=>{o in e||(r.remove(o),this.it.delete(o))});for(const o in e){const a=!!e[o];a===this.it.has(o)||!((s=this.nt)===null||s===void 0)&&s.has(o)||(a?(r.add(o),this.it.add(o)):(r.remove(o),this.it.delete(o)))}return it}});/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const b0="important",o4=" !"+b0,a4=Yl(class extends Ql{constructor(i){var e;if(super(i),i.type!==Yt.ATTRIBUTE||i.name!=="style"||((e=i.strings)===null||e===void 0?void 0:e.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(i){return Object.keys(i).reduce((e,t)=>{const s=i[t];return s==null?e:e+`${t=t.includes("-")?t:t.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${s};`},"")}update(i,[e]){const{style:t}=i.element;if(this.ht===void 0){this.ht=new Set;for(const s in e)this.ht.add(s);return this.render(e)}this.ht.forEach(s=>{e[s]==null&&(this.ht.delete(s),s.includes("-")?t.removeProperty(s):t[s]="")});for(const s in e){const r=e[s];if(r!=null){this.ht.add(s);const o=typeof r=="string"&&r.endsWith(o4);s.includes("-")||o?t.setProperty(s,o?r.slice(0,-11):r,o?b0:""):t[s]=r}}return it}});se.extend(Vm);se.extend(jm);const n4=180,l4=40,c4=10,h4=125,d4=30,cd="YYYY",p4="no data",u4=0,f4="item",hd=4,m4={linear:i=>i,logarithmic:i=>Math.log1p(i)},g4=x`var(--histogramDateRangeSliderColor, #4B65FE)`,v4=x`var(--histogramDateRangeSelectedRangeColor, #DBE0FF)`,b4=x`var(--histogramDateRangeBarIncludedFill, #2C2C2C)`,y4=x`var(--histogramDateRangeActivityIndicator, #2C2C2C)`,$4=x`var(--histogramDateRangeBarExcludedFill, #CCCCCC)`,w4=x`var(--histogramDateRangeInputRowMargin, 0)`,x4=x`var(--histogramDateRangeInputBorder, 0.5px solid #2C2C2C)`,_4=x`var(--histogramDateRangeInputWidth, 35px)`,S4=x`var(--histogramDateRangeInputFontSize, 1.2rem)`,C4=x`var(--histogramDateRangeInputFontFamily, sans-serif)`,dd=x`var(--histogramDateRangeTooltipBackgroundColor, #2C2C2C)`,pd=x`var(--histogramDateRangeTooltipTextColor, #FFFFFF)`,T4=x`var(--histogramDateRangeTooltipFontSize, 1.1rem)`,A4=x`var(--histogramDateRangeTooltipFontFamily, sans-serif)`;let G=class extends xr{constructor(){super(...arguments),this.width=n4,this.height=l4,this.sliderWidth=c4,this.tooltipWidth=h4,this.tooltipHeight=d4,this.updateDelay=u4,this.dateFormat=cd,this.missingDataMessage=p4,this.minDate="",this.maxDate="",this.disabled=!1,this.bins=[],this.updateWhileFocused=!1,this.binSnapping="none",this.tooltipLabel=f4,this.barScaling="logarithmic",this._tooltipOffsetX=0,this._tooltipOffsetY=0,this._isDragging=!1,this._isLoading=!1,this._minSelectedDate="",this._maxSelectedDate="",this._minDateMS=0,this._maxDateMS=0,this._dragOffset=0,this._histWidth=0,this._binWidth=0,this._histData=[],this._previousDateRange="",this.drag=e=>{e.preventDefault(),!this.disabled&&(this.setDragOffset(e),this._isDragging=!0,this.addListeners(),this.cancelPendingUpdateEvent())},this.drop=()=>{this._isDragging&&(this.removeListeners(),this.beginEmitUpdateProcess()),this._isDragging=!1},this.move=e=>{const t=this.getBoundingClientRect().x,s=e.clientX-t-this._dragOffset;this._currentSlider.id==="slider-min"?this.minSelectedDate=this.translatePositionToDate(this.validMinSliderX(s)):(this.maxSelectedDate=this.translatePositionToDate(this.validMaxSliderX(s)),this.getMSFromString(this.maxSelectedDate)>this._maxDateMS&&(this.maxSelectedDate=this.maxDate))}}disconnectedCallback(){this.removeListeners(),super.disconnectedCallback()}willUpdate(e){(e.has("bins")||e.has("minDate")||e.has("maxDate")||e.has("minSelectedDate")||e.has("maxSelectedDate")||e.has("width")||e.has("height")||e.has("binSnapping")||e.has("barScaling"))&&this.handleDataUpdate()}handleDataUpdate(){this.hasBinData&&(this._histWidth=this.width-this.sliderWidth*2,this._minDateMS=this.snapTimestamp(this.getMSFromString(this.minDate)),this._maxDateMS=this.snapTimestamp(this.getMSFromString(this.maxDate)+this.snapInterval)+this.snapEndOffset,this._binWidth=this._histWidth/this._numBins,this._previousDateRange=this.currentDateRangeString,this._histData=this.calculateHistData(),this.minSelectedDate=this.minSelectedDate?this.minSelectedDate:this.minDate,this.maxSelectedDate=this.maxSelectedDate?this.maxSelectedDate:this.maxDate)}snapToNextSecond(e){return Math.ceil(e/1e3)*1e3}snapToMonth(e){const t=se(e),s=t.date()<16?0:1;return t.add(s,"month").date(1).hour(0).minute(0).second(0).millisecond(0).valueOf()}snapToYear(e){const t=se(e),s=t.month()<6?0:1;return t.add(s,"year").month(0).date(1).hour(0).minute(0).second(0).millisecond(0).valueOf()}snapTimestamp(e){switch(this.binSnapping){case"year":return this.snapToYear(e);case"month":return this.snapToMonth(e);case"none":default:return this.snapToNextSecond(e)}}get barScalingFunction(){return typeof this.barScaling=="string"?m4[this.barScaling]:this.barScaling}calculateHistData(){const{bins:e,height:t,dateRangeMS:s,_numBins:r,_minDateMS:o}=this,a=Math.min(...this.bins),l=Math.max(...this.bins),n=a===l?1:this.barScalingFunction(l),c=t/n,h=s/r;return e.map((d,f)=>{const g=this.snapTimestamp(f*h+o),$=this.formatDate(g),w=this.snapTimestamp((f+1)*h+o)+this.snapEndOffset,T=this.formatDate(w),P=this.formatDate(g,this.tooltipDateFormat),O=this.formatDate(w,this.tooltipDateFormat),D=P===O?P:`${P} - ${O}`;return{value:d,height:Math.floor(this.barScalingFunction(d)*c),binStart:$,binEnd:T,tooltip:D}})}get hasBinData(){return this._numBins>0}get _numBins(){return!this.bins||!this.bins.length?0:this.bins.length}get histogramLeftEdgeX(){return this.sliderWidth}get histogramRightEdgeX(){return this.width-this.sliderWidth}get snapInterval(){switch(this.binSnapping){case"year":return 31536e6;case"month":return 2592e6;case"none":default:return 0}}get snapEndOffset(){return this.binSnapping!=="none"&&this._numBins>1?-1:0}get tooltipDateFormat(){var e;return(e=this._tooltipDateFormat)!==null&&e!==void 0?e:this.dateFormat}set tooltipDateFormat(e){this._tooltipDateFormat=e}get loading(){return this._isLoading}set loading(e){this.disabled=e,this._isLoading=e}get minSelectedDate(){return this.formatDate(this.getMSFromString(this._minSelectedDate))}set minSelectedDate(e){if(!this._minSelectedDate){this._minSelectedDate=e;return}const t=this.getMSFromString(e),s=!Number.isNaN(t),r=t<=this.getMSFromString(this.maxSelectedDate);s&&r&&(this._minSelectedDate=this.formatDate(t)),this.requestUpdate()}get maxSelectedDate(){return this.formatDate(this.getMSFromString(this._maxSelectedDate))}set maxSelectedDate(e){if(!this._maxSelectedDate){this._maxSelectedDate=e;return}const t=this.getMSFromString(e),s=!Number.isNaN(t),r=t>=this.getMSFromString(this.minSelectedDate);s&&r&&(this._maxSelectedDate=this.formatDate(t)),this.requestUpdate()}get minSliderX(){const e=this.translateDateToPosition(this.minSelectedDate);return this.validMinSliderX(e)}get maxSliderX(){const e=this.snapTimestamp(this.getMSFromString(this.maxSelectedDate)+this.snapInterval),t=this.translateDateToPosition(this.formatDate(e));return this.validMaxSliderX(t)}get dateRangeMS(){return this._maxDateMS-this._minDateMS}showTooltip(e){var t,s;if(this._isDragging||this.disabled)return;const r=e.currentTarget,o=r.x.baseVal.value+this.sliderWidth/2,a=r.dataset,l=`${this.tooltipLabel}${a.numItems!=="1"?"s":""}`,n=Number(a.numItems).toLocaleString(),c=2,d=9+this.tooltipHeight,f=this.getBoundingClientRect(),g=f.x+o,$=f.y;this._tooltipOffsetX=g-c+(this._binWidth-this.sliderWidth-this.tooltipWidth)/2+window.scrollX,this._tooltipOffsetY=$-d+window.scrollY,this._tooltipContent=_t`
      ${n} ${l}<br />
      ${a.tooltip}
    `,(s=(t=this._tooltip).showPopover)===null||s===void 0||s.call(t)}hideTooltip(){var e,t;this._tooltipContent=void 0,(t=(e=this._tooltip).hidePopover)===null||t===void 0||t.call(e)}validMinSliderX(e){const t=Math.min(this.translateDateToPosition(this.maxSelectedDate),this.histogramRightEdgeX);return e=this.clamp(e,this.histogramLeftEdgeX,t),Number.isNaN(e)||t<this.histogramLeftEdgeX?this.histogramLeftEdgeX:e}validMaxSliderX(e){const t=Math.max(this.histogramLeftEdgeX,this.translateDateToPosition(this.minSelectedDate));return e=this.clamp(e,t,this.histogramRightEdgeX),Number.isNaN(e)||t>this.histogramRightEdgeX?this.histogramRightEdgeX:e}addListeners(){window.addEventListener("pointermove",this.move),window.addEventListener("pointerup",this.drop),window.addEventListener("pointercancel",this.drop)}removeListeners(){window.removeEventListener("pointermove",this.move),window.removeEventListener("pointerup",this.drop),window.removeEventListener("pointercancel",this.drop)}beginEmitUpdateProcess(){this.cancelPendingUpdateEvent(),this._emitUpdatedEventTimer=setTimeout(()=>{if(this.currentDateRangeString===this._previousDateRange)return;this._previousDateRange=this.currentDateRangeString;const e={detail:{minDate:this.minSelectedDate,maxDate:this.maxSelectedDate},bubbles:!0,composed:!0};this.dispatchEvent(new CustomEvent("histogramDateRangeUpdated",e))},this.updateDelay)}cancelPendingUpdateEvent(){this._emitUpdatedEventTimer!==void 0&&(clearTimeout(this._emitUpdatedEventTimer),this._emitUpdatedEventTimer=void 0)}setDragOffset(e){this._currentSlider=e.currentTarget;const t=this._currentSlider.id==="slider-min"?this.minSliderX:this.maxSliderX,s=this.getBoundingClientRect().x;this._dragOffset=e.clientX-s-t}translatePositionToDate(e){const t=this.snapToNextSecond((e-this.sliderWidth)*this.dateRangeMS/this._histWidth);return this.formatDate(this._minDateMS+t)}translateDateToPosition(e){const t=this.getMSFromString(e);return this.sliderWidth+(t-this._minDateMS)*this._histWidth/this.dateRangeMS}clamp(e,t,s){return Math.min(Math.max(e,t),s)}handleInputFocus(){this.updateWhileFocused||this.cancelPendingUpdateEvent()}handleMinDateInput(e){const t=e.currentTarget;t.value!==this.minSelectedDate&&(this.minSelectedDate=t.value,this.beginEmitUpdateProcess())}handleMaxDateInput(e){const t=e.currentTarget;t.value!==this.maxSelectedDate&&(this.maxSelectedDate=t.value,this.beginEmitUpdateProcess())}handleKeyUp(e){if(e.key==="Enter"){const t=e.currentTarget;t.blur(),t.id==="date-min"?this.handleMinDateInput(e):t.id==="date-max"&&this.handleMaxDateInput(e)}}get currentDateRangeString(){return`${this.minSelectedDate}:${this.maxSelectedDate}`}getMSFromString(e){const t=typeof e=="string"?e:String(e);if((t.split(/(\d+)/).length-1)/2===1){const r=new Date(0,0);return r.setFullYear(Number(t)),r.getTime()}return se(t,[this.dateFormat,cd]).valueOf()}handleBarClick(e){const t=e.currentTarget.dataset,s=(this.getMSFromString(t.binStart)+this.getMSFromString(t.binEnd))/2,r=Math.abs(s-this.getMSFromString(this.minSelectedDate)),o=Math.abs(s-this.getMSFromString(this.maxSelectedDate));r<o?this.minSelectedDate=t.binStart:this.maxSelectedDate=t.binEnd,this.beginEmitUpdateProcess()}get minSliderTemplate(){const e=hd,t=`
            M${this.minSliderX},0
            ...
            q0,${e} ${e},${e}
            h${this.sliderWidth-e}
          `;return this.generateSliderSVG(this.minSliderX,"slider-min",t)}get maxSliderTemplate(){const e=hd,t=`
            M${this.maxSliderX},0
            h${this.sliderWidth-e}
            q${e},0 ${e},${e}
            v${this.height-e*2}
            q0,${e} -${e},${e}
            h-${this.sliderWidth-e}
          `;return this.generateSliderSVG(this.maxSliderX,"slider-max",t)}generateSliderSVG(e,t,s){const r=t==="slider-min"?1:-1,o=r4({slider:!0,draggable:!this.disabled,dragging:this._isDragging});return fn`
    <svg
      id=${t}
      class=${o}
    ...
    `}get selectedRangeTemplate(){return fn`
      <rect
        x="${this.minSliderX}"
        y="0"
        ...
        height="${this.height}"
        fill="${v4}"
      />`}get histogramTemplate(){const e=this._histWidth/this._numBins,t=e-1;let s=this.sliderWidth;return this._histData.map(r=>{const{minSelectedDate:o,maxSelectedDate:a}=this,l=r.height,n=this.isBefore(r.binEnd,o),c=this.isAfter(r.binStart,a),h=n||c?$4:b4,d=`stroke-dasharray: 0 ${t} ${l} ${t} 0 ${l}`,f=fn`
        <rect
        ...
        <rect
          ...
          height=${l}
          fill=${h}
        />`;return s+=e,f})}isBefore(e,t){const s=this.getMSFromString(e),r=this.getMSFromString(t);return s<r}isAfter(e,t){const s=this.getMSFromString(e),r=this.getMSFromString(t);return s>r}formatDate(e,t=this.dateFormat){if(Number.isNaN(e))return"";const s=se(e);return s.year()<1e3?s.year(199999).format(t).replace(/199999/g,s.year().toString()):s.format(t)}get minInputTemplate(){return _t`
      <input
        id="date-min"
    ...
    `}get maxInputTemplate(){return _t`
      <input
        ...
        @keyup=${this.handleKeyUp}
        .value=${ld(this.maxSelectedDate)}
        ?disabled=${this.disabled}
      />
    `}get minLabelTemplate(){return _t`<label for="date-min" class="sr-only">Minimum date:</label>`}get maxLabelTemplate(){return _t`<label for="date-max" class="sr-only">Maximum date:</label>`}get tooltipTemplate(){const e=a4({width:`${this.tooltipWidth}px`,height:`${this.tooltipHeight}px`,top:`${this._tooltipOffsetY}px`,left:`${this._tooltipOffsetX}px`});return _t`
    ...
    `:ve}render(){return this.hasBinData?_t`
      <div
        id="container"
        class="
          noselect
    ...
    ia-activity-indicator {
      ...
      --activityIndicatorLoadingRingColor: ${y4};
    }
    ...
    #tooltip:after {
      ...
      /* arrow */
      border: 5px solid ${pd};
      border-color: ${dd} transparent transparent
        transparent;
    }
    /****** slider ********/
    .slider {
  ...
  `;p([E({type:Number})],G.prototype,"width",void 0);p([E({type:Number})],G.prototype,"height",void 0);p([E({type:Number})],G.prototype,"sliderWidth",void 0);p([E({type:Number})],G.prototype,"tooltipWidth",void 0);p([E({type:Number})],G.prototype,"tooltipHeight",void 0);p([E({type:Number})],G.prototype,"updateDelay",void 0);p([E({type:String})],G.prototype,"dateFormat",void 0);p([E({type:String})],G.prototype,"missingDataMessage",void 0);p([E({type:String})],G.prototype,"minDate",void 0);p([E({type:String})],G.prototype,"maxDate",void 0);p([E({type:Boolean})],G.prototype,"disabled",void 0);p([E({type:Array})],G.prototype,"bins",void 0);p([E({type:Boolean})],G.prototype,"updateWhileFocused",void 0);p([E({type:String})],G.prototype,"binSnapping",void 0);p([E({type:String})],G.prototype,"tooltipLabel",void 0);p([E({type:String})],G.prototype,"barScaling",void 0);p([be()],G.prototype,"_tooltipOffsetX",void 0);p([be()],G.prototype,"_tooltipOffsetY",void 0);p([be()],G.prototype,"_tooltipContent",void 0);p([be()],G.prototype,"_tooltipDateFormat",void 0);p([be()],G.prototype,"_isDragging",void 0);p([be()],G.prototype,"_isLoading",void 0);p([qe("#tooltip")],G.prototype,"_tooltip",void 0);p([E({type:String})],G.prototype,"tooltipDateFormat",null);p([E({type:Boolean})],G.prototype,"loading",null);p([E()],G.prototype,"minSelectedDate",null);p([E()],G.prototype,"maxSelectedDate",null);G=p([Tt("histogram-date-range")],G);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var vn;const qo=window,Ms=qo.trustedTypes,ud=Ms?Ms.createPolicy("lit-html",{createHTML:i=>i}):void 0,hl="$lit$",ti=`lit$${(Math.random()+"").slice(9)}$`,y0="?"+ti,k4=`<${y0}>`,Gi=document,zr=()=>Gi.createComment(""),Ir=i=>i===null||typeof i!="object"&&typeof i!="function",$0=Array.isArray,E4=i=>$0(i)||typeof(i==null?void 0:i[Symbol.iterator])=="function",bn=`[ 	
\f\r]`,lr=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,fd=/-->/g,md=/>/g,$i=RegExp(`>|${bn}(?:([^\\s"'>=/]+)(${bn}*=${bn}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),gd=/'/g,vd=/"/g,w0=/^(?:script|style|textarea|title)$/i,x0=i=>(e,...t)=>({_$litType$:i,strings:e,values:t}),X=x0(1),_0=x0(2),ni=Symbol.for("lit-noChange"),K=Symbol.for("lit-nothing"),bd=new WeakMap,Di=Gi.createTreeWalker(Gi,129,null,!1);function S0(i,e){if(!Array.isArray(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return ud!==void 0?ud.createHTML(e):e}const M4=(i,e)=>{const t=i.length-1,s=[];let r,o=e===2?"<svg>":"",a=lr;for(let l=0;l<t;l++){const n=i[l];let c,h,d=-1,f=0;for(;f<n.length&&(a.lastIndex=f,h=a.exec(n),h!==null);)f=a.lastIndex,a===lr?h[1]==="!--"?a=fd:h[1]!==void 0?a=md:h[2]!==void 0?(w0.test(h[2])&&(r=RegExp("</"+h[2],"g")),a=$i):h[3]!==void 0&&(a=$i):a===$i?h[0]===">"?(a=r??lr,d=-1):h[1]===void 0?d=-2:(d=a.lastIndex-h[2].length,c=h[1],a=h[3]===void 0?$i:h[3]==='"'?vd:gd):a===vd||a===gd?a=$i:a===fd||a===md?a=lr:(a=$i,r=void 0);const g=a===$i&&i[l+1].startsWith("/>")?" ":"";o+=a===lr?n+k4:d>=0?(s.push(c),n.slice(0,d)+hl+n.slice(d)+ti+g):n+ti+(d===-2?(s.push(void 0),l):g)}return[S0(i,o+(i[t]||"<?>")+(e===2?"</svg>":"")),s]};let dl=class C0{constructor({strings:e,_$litType$:t},s){let r;this.parts=[];let o=0,a=0;const l=e.length-1,n=this.parts,[c,h]=M4(e,t);if(this.el=C0.createElement(c,s),Di.currentNode=this.el.content,t===2){const d=this.el.content,f=d.firstChild;f.remove(),d.append(...f.childNodes)}for(;(r=Di.nextNode())!==null&&n.length<l;){if(r.nodeType===1){if(r.hasAttributes()){const d=[];for(const f of r.getAttributeNames())if(f.endsWith(hl)||f.startsWith(ti)){const g=h[a++];if(d.push(f),g!==void 0){const $=r.getAttribute(g.toLowerCase()+hl).split(ti),w=/([.?@])?(.*)/.exec(g);n.push({type:1,index:o,name:w[2],strings:$,ctor:w[1]==="."?O4:w[1]==="?"?L4:w[1]==="@"?B4:ha})}else n.push({type:6,index:o})}for(const f of d)r.removeAttribute(f)}if(w0.test(r.tagName)){const d=r.textContent.split(ti),f=d.length-1;if(f>0){r.textContent=Ms?Ms.emptyScript:"";for(let g=0;g<f;g++)r.append(d[g],zr()),Di.nextNode(),n.push({type:2,index:++o});r.append(d[f],zr())}}}else if(r.nodeType===8)if(r.data===y0)n.push({type:2,index:o});else{let d=-1;for(;(d=r.data.indexOf(ti,d+1))!==-1;)n.push({type:7,index:o}),d+=ti.length-1}o++}}static createElement(e,t){const s=Gi.createElement("template");return s.innerHTML=e,s}};function Ps(i,e,t=i,s){var r,o,a,l;if(e===ni)return e;let n=s!==void 0?(r=t._$Co)===null||r===void 0?void 0:r[s]:t._$Cl;const c=Ir(e)?void 0:e._$litDirective$;return(n==null?void 0:n.constructor)!==c&&((o=n==null?void 0:n._$AO)===null||o===void 0||o.call(n,!1),c===void 0?n=void 0:(n=new c(i),n._$AT(i,t,s)),s!==void 0?((a=(l=t)._$Co)!==null&&a!==void 0?a:l._$Co=[])[s]=n:t._$Cl=n),n!==void 0&&(e=Ps(i,n._$AS(i,e.values),n,s)),e}let P4=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){var t;const{el:{content:s},parts:r}=this._$AD,o=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:Gi).importNode(s,!0);Di.currentNode=o;let a=Di.nextNode(),l=0,n=0,c=r[0];for(;c!==void 0;){if(l===c.index){let h;c.type===2?h=new Kl(a,a.nextSibling,this,e):c.type===1?h=new c.ctor(a,c.name,c.strings,this,e):c.type===6&&(h=new F4(a,this,e)),this._$AV.push(h),c=r[++n]}l!==(c==null?void 0:c.index)&&(a=Di.nextNode(),l++)}return Di.currentNode=Gi,o}v(e){let t=0;for(const s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(e,s,t),t+=s.strings.length-2):s._$AI(e[t])),t++}},Kl=class T0{constructor(e,t,s,r){var o;this.type=2,this._$AH=K,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=s,this.options=r,this._$Cp=(o=r==null?void 0:r.isConnected)===null||o===void 0||o}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cp}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Ps(this,e,t),Ir(e)?e===K||e==null||e===""?(this._$AH!==K&&this._$AR(),this._$AH=K):e!==this._$AH&&e!==ni&&this._(e):e._$litType$!==void 0?this.g(e):e.nodeType!==void 0?this.$(e):E4(e)?this.T(e):this._(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==K&&Ir(this._$AH)?this._$AA.nextSibling.data=e:this.$(Gi.createTextNode(e)),this._$AH=e}g(e){var t;const{values:s,_$litType$:r}=e,o=typeof r=="number"?this._$AC(e):(r.el===void 0&&(r.el=dl.createElement(S0(r.h,r.h[0]),this.options)),r);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===o)this._$AH.v(s);else{const a=new P4(o,this),l=a.u(this.options);a.v(s),this.$(l),this._$AH=a}}_$AC(e){let t=bd.get(e.strings);return t===void 0&&bd.set(e.strings,t=new dl(e)),t}T(e){$0(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let s,r=0;for(const o of e)r===t.length?t.push(s=new T0(this.k(zr()),this.k(zr()),this,this.options)):s=t[r],s._$AI(o),r++;r<t.length&&(this._$AR(s&&s._$AB.nextSibling,r),t.length=r)}_$AR(e=this._$AA.nextSibling,t){var s;for((s=this._$AP)===null||s===void 0||s.call(this,!1,!0,t);e&&e!==this._$AB;){const r=e.nextSibling;e.remove(),e=r}}setConnected(e){var t;this._$AM===void 0&&(this._$Cp=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}},ha=class{constructor(e,t,s,r,o){this.type=1,this._$AH=K,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=o,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=K}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,s,r){const o=this.strings;let a=!1;if(o===void 0)e=Ps(this,e,t,0),a=!Ir(e)||e!==this._$AH&&e!==ni,a&&(this._$AH=e);else{const l=e;let n,c;for(e=o[0],n=0;n<o.length-1;n++)c=Ps(this,l[s+n],t,n),c===ni&&(c=this._$AH[n]),a||(a=!Ir(c)||c!==this._$AH[n]),c===K?e=K:e!==K&&(e+=(c??"")+o[n+1]),this._$AH[n]=c}a&&!r&&this.j(e)}j(e){e===K?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},O4=class extends ha{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===K?void 0:e}};const D4=Ms?Ms.emptyScript:"";let L4=class extends ha{constructor(){super(...arguments),this.type=4}j(e){e&&e!==K?this.element.setAttribute(this.name,D4):this.element.removeAttribute(this.name)}},B4=class extends ha{constructor(e,t,s,r,o){super(e,t,s,r,o),this.type=5}_$AI(e,t=this){var s;if((e=(s=Ps(this,e,t,0))!==null&&s!==void 0?s:K)===ni)return;const r=this._$AH,o=e===K&&r!==K||e.capture!==r.capture||e.once!==r.once||e.passive!==r.passive,a=e!==K&&(r===K||o);o&&this.element.removeEventListener(this.name,this,r),a&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,s;typeof this._$AH=="function"?this._$AH.call((s=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&s!==void 0?s:this.element,e):this._$AH.handleEvent(e)}},F4=class{constructor(e,t,s){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(e){Ps(this,e)}};const yd=qo.litHtmlPolyfillSupport;yd==null||yd(dl,Kl),((vn=qo.litHtmlVersions)!==null&&vn!==void 0?vn:qo.litHtmlVersions=[]).push("2.8.0");const R4=(i,e,t)=>{var s,r;const o=(s=t==null?void 0:t.renderBefore)!==null&&s!==void 0?s:e;let a=o._$litPart$;if(a===void 0){const l=(r=t==null?void 0:t.renderBefore)!==null&&r!==void 0?r:null;o._$litPart$=a=new Kl(e.insertBefore(zr(),l),l,void 0,t??{})}return a._$AI(i),a};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var yn,$n;let pt=class extends dt{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e,t;const s=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=s.firstChild),s}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=R4(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!1)}render(){return ni}};pt.finalized=!0,pt._$litElement$=!0,(yn=globalThis.litElementHydrateSupport)===null||yn===void 0||yn.call(globalThis,{LitElement:pt});const $d=globalThis.litElementPolyfillSupport;$d==null||$d({LitElement:pt});(($n=globalThis.litElementVersions)!==null&&$n!==void 0?$n:globalThis.litElementVersions=[]).push("3.3.3");const _r=_0`
<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><path d="m51.5960452 0c5.420012 0 6.7920618 2.72313378 8.1300179 9.28391016 2.9793915 19.21608984-2.9793915 28.94849474 0 31.58229234 1.2215505 1.079857 1.8678662.7924226 3.2997314.0773518l.2153069-.1075882c2.1016905-1.0490161 5.8499713-2.8359661 14.9013153-2.8359661l2.3393989.00075c14.0694555.01425 14.2569231.29925 18.0062757 5.99925 0 3.2648986.9924719 9.5-3.9698878 9.5 4.9623597 0 7.9397755 15.5 0 15.5 7.9397755 0 6.9473035 15.5-.9924719 15.5 7.9397754 0 5.9548316 12 2.9774158 13-1.1342536.5714286-1.9876793 1.0011812-2.627102 1.3222794l-.3279542.1645673c-1.5889262.796641-1.5747062.7780161-1.4530457.6832252l.0244872-.0190992c.0041709-.0032756.0083532-.0065808.0124967-.0098908l.0239934-.0197196c.1060465-.0904428.1029348-.1457697-1.111471.3786377h-55.0821921c-3.3082398-3.0266004-4.9623597-5.0266004-4.9623597-6v-33.4737525c5.5882429-8.3508317 10.6469206-21.2754909 15.1760333-38.7739777v-17.92948326c0-2.54852436 1.8066707-3.82278654 5.4200119-3.82278654zm-27.5960452 56c2.209139 0 4 1.790861 4 4v36c0 2.209139-1.790861 4-4 4h-20c-2.209139 0-4-1.790861-4-4v-36c0-2.209139 1.790861-4 4-4z" fill-rule="evenodd"/></svg>`,Sr=_0`
<svg viewBox="0 0 100 100"
  xmlns="http://www.w3.org/2000/svg">
...
`;let oe=class extends pt{constructor(){super(...arguments),this.prompt="Do you find this feature useful?",this.buttonText="Beta",this.displayMode="button",this.isOpen=!1,this.processing=!1,this.popupTopX=0,this.popupTopY=0,this.voteSubmitted=!1,this.voteNeedsChoosing=!1,this.resizingElement=document.body}render(){return X`
    ...
    `}get upvoteSelected(){return this.vote==="up"}get downvoteSelected(){return this.vote==="down"}upvoteKeypressed(e){(e.key==="Enter"||e.key===" ")&&this.upvoteButtonSelected()}downvoteKeypressed(e){(e.key==="Enter"||e.key===" ")&&this.downvoteButtonSelected()}upvoteButtonSelected(){this.processing||this.voteSubmitted||(this.vote=this.vote==="up"?void 0:"up",this.handleButtonSelection())}downvoteButtonSelected(){this.processing||this.voteSubmitted||(this.vote=this.vote==="down"?void 0:"down",this.handleButtonSelection())}async handleButtonSelection(){this.isOpen||(await this.setupRecaptcha(),this.submit())}get chooseVoteErrorClass(){return this.voteNeedsChoosing?"error":""}get upvoteButtonClass(){switch(this.vote){case"up":return"selected";case"down":return"unselected";default:return"noselection"}}get downvoteButtonClass(){switch(this.vote){case"up":return"unselected";case"down":return"selected";default:return"noselection"}}backgroundClicked(e){var t;e.target instanceof Node&&(!((t=this.popup)===null||t===void 0)&&t.contains(e.target)||this.cancel(e))}cancel(e){e.preventDefault(),this.closePopup(),this.voteSubmitted||this.resetState()}async submit(e){if(e==null||e.preventDefault(),!this.vote){this.voteNeedsChoosing=!0,this.error=X`Please select a vote.`;return}if(!this.featureIdentifier)throw new Error("featureIdentifier is required");if(!this.featureFeedbackService)throw new Error("featureFeedbackService is required");if(!this.recaptchaWidget)throw new Error("recaptchaWidget is required");const t=this.isOpen;this.processing=!0;try{const s=await this.recaptchaWidget.execute();(await this.featureFeedbackService.submitFeedback({featureIdentifier:this.featureIdentifier,vote:this.vote,comments:this.comments.value,recaptchaToken:s})).success?(this.voteSubmitted=!0,t&&this.closePopup()):this.error=X`There was an error submitting your feedback.`}catch(s){this.error=X`There was an error submitting your feedback.<br />Error:
        ${s instanceof Error?s.message:s}`}this.processing=!1}static get styles(){const e=x`var(--featureFeedbackBlueColor, #194880)`,t=x`var(--featureFeedbackDarkGrayColor, #767676)`,s=x`var(--defaultColorSvgFilter, invert(52%) sepia(0%) saturate(1%) hue-rotate(331deg) brightness(87%) contrast(89%))`,r=x`var(--featureFeedbackBackdropZindex, 5)`,o=x`var(--featureFeedbackModalZindex, 6)`,a=x`var(--featureFeedbackPopupBorderColor, ${e})`,l=x`var(--featureFeedbackSubmitButtonColor, ${e})`,n=x`var(--featureFeedbackBetaButtonBorderColor, ${e})`,c=x`var(--featureFeedbackBetaButtonTextColor, ${e})`,h=x`var(--featureFeedbackBetaButtonSvgFilter, ${s})`,d=x`var(--featureFeedbackCancelButtonColor, #515151)`,f=x`var(--featureFeedbackPopupBlockerColor, rgba(255, 255, 255, 0.3))`,g=x`var(--featureFeedbackPopupBackgroundColor, #F5F5F7)`,$=x`var(--featureFeedbackPromptFontWeight, bold)`,w=x`var(--featureFeedbackPromptFontSize, 1.4rem)`,T=x`var(--featureFeedbackCommentButtonFontWeight, normal)`,P=x`var(--featureFeedbackCommentButtonFontWeight, 1.4rem)`,O=x`var(--defaultColor, ${t});`,D=x`var(--defaultColorSvgFilter, ${s});`,z=x`var(--upvoteColor, #23765D);`,Y=x`var(--upvoteColorSvgFilter, invert(34%) sepia(72%) saturate(357%) hue-rotate(111deg) brightness(97%) contrast(95%));`,fe=x`var(--downvoteColor, #720D11);`,Ge=x`var(--downvoteColorSvgFilter, invert(5%) sepia(81%) saturate(5874%) hue-rotate(352deg) brightness(105%) contrast(95%));`,Ue=x`var(--unselectedColor, #CCCCCC);`,at=x`var(--unselectedColorSvgFilter, invert(100%) sepia(0%) saturate(107%) hue-rotate(138deg) brightness(89%) contrast(77%));`;return x`
      #container {
        display: inline-block;
      }
    ...
    `}};p([E({type:String})],oe.prototype,"featureIdentifier",void 0);p([E({type:String})],oe.prototype,"prompt",void 0);p([E({type:String})],oe.prototype,"buttonText",void 0);p([E({type:String})],oe.prototype,"displayMode",void 0);p([E({type:Object})],oe.prototype,"recaptchaManager",void 0);p([E({type:Object})],oe.prototype,"resizeObserver",void 0);p([E({type:Boolean})],oe.prototype,"disabled",void 0);p([E({type:Object})],oe.prototype,"featureFeedbackService",void 0);p([be()],oe.prototype,"isOpen",void 0);p([be()],oe.prototype,"processing",void 0);p([be()],oe.prototype,"popupTopX",void 0);p([be()],oe.prototype,"popupTopY",void 0);p([be()],oe.prototype,"vote",void 0);p([be()],oe.prototype,"voteSubmitted",void 0);p([be()],oe.prototype,"error",void 0);p([be()],oe.prototype,"voteNeedsChoosing",void 0);p([be()],oe.prototype,"recaptchaWidget",void 0);p([qe("#container")],oe.prototype,"container",void 0);p([qe("#popup")],oe.prototype,"popup",void 0);p([qe("#comments")],oe.prototype,"comments",void 0);oe=p([Tt("feature-feedback")],oe);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const M0="important",z4=" !"+M0,I4=k0(class extends E0{constructor(i){var e;if(super(i),i.type!==A0.ATTRIBUTE||i.name!=="style"||((e=i.strings)===null||e===void 0?void 0:e.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(i){return Object.keys(i).reduce((e,t)=>{const s=i[t];return s==null?e:e+`${t=t.includes("-")?t:t.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${s};`},"")}update(i,[e]){const{style:t}=i.element;if(this.ht===void 0){this.ht=new Set;for(const s in e)this.ht.add(s);return this.render(e)}this.ht.forEach(s=>{e[s]==null&&(this.ht.delete(s),s.includes("-")?t.removeProperty(s):t[s]="")});for(const s in e){const r=e[s];if(r!=null){this.ht.add(s);const o=typeof r=="string"&&r.endsWith(z4);s.includes("-")||o?t.setProperty(s,o?r.slice(0,-11):r,o?M0:""):t[s]=r}}return ni}});/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const N4=i=>typeof i!="string"&&"strTag"in i,H4=(i,e,t)=>{let s=i[0];for(let r=1;r<i.length;r++)s+=e[r-1],s+=i[r];return s};/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const U4=i=>N4(i)?H4(i.strings,i.values):i;/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class V4{constructor(){this.settled=!1,this.promise=new Promise((e,t)=>{this._resolve=e,this._reject=t})}resolve(e){this.settled=!0,this._resolve(e)}reject(e){this.settled=!0,this._reject(e)}}/**
 * @license
 * Copyright 2014 Travis Webb
 * SPDX-License-Identifier: MIT
 */for(let i=0;i<256;i++)(i>>4&15).toString(16)+(i&15).toString(16);/**
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var wn;const Go=window,Os=Go.trustedTypes,wd=Os?Os.createPolicy("lit-html",{createHTML:i=>i}):void 0,pl="$lit$",ii=`lit$${(Math.random()+"").slice(9)}$`,P0="?"+ii,W4=`<${P0}>`,Yi=document,Nr=()=>Yi.createComment(""),Hr=i=>i===null||typeof i!="object"&&typeof i!="function",O0=Array.isArray,q4=i=>O0(i)||typeof(i==null?void 0:i[Symbol.iterator])=="function",xn=`[ 	
\f\r]`,cr=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,xd=/-->/g,_d=/>/g,wi=RegExp(`>|${xn}(?:([^\\s"'>=/]+)(${xn}*=${xn}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Sd=/'/g,Cd=/"/g,D0=/^(?:script|style|textarea|title)$/i,Ds=Symbol.for("lit-noChange"),Te=Symbol.for("lit-nothing"),Td=new WeakMap,Li=Yi.createTreeWalker(Yi,129,null,!1);function L0(i,e){if(!Array.isArray(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return wd!==void 0?wd.createHTML(e):e}const G4=(i,e)=>{const t=i.length-1,s=[];let r,o=e===2?"<svg>":"",a=cr;for(let l=0;l<t;l++){const n=i[l];let c,h,d=-1,f=0;for(;f<n.length&&(a.lastIndex=f,h=a.exec(n),h!==null);)f=a.lastIndex,a===cr?h[1]==="!--"?a=xd:h[1]!==void 0?a=_d:h[2]!==void 0?(D0.test(h[2])&&(r=RegExp("</"+h[2],"g")),a=wi):h[3]!==void 0&&(a=wi):a===wi?h[0]===">"?(a=r??cr,d=-1):h[1]===void 0?d=-2:(d=a.lastIndex-h[2].length,c=h[1],a=h[3]===void 0?wi:h[3]==='"'?Cd:Sd):a===Cd||a===Sd?a=wi:a===xd||a===_d?a=cr:(a=wi,r=void 0);const g=a===wi&&i[l+1].startsWith("/>")?" ":"";o+=a===cr?n+W4:d>=0?(s.push(c),n.slice(0,d)+pl+n.slice(d)+ii+g):n+ii+(d===-2?(s.push(void 0),l):g)}return[L0(i,o+(i[t]||"<?>")+(e===2?"</svg>":"")),s]};class Ur{constructor({strings:e,_$litType$:t},s){let r;this.parts=[];let o=0,a=0;const l=e.length-1,n=this.parts,[c,h]=G4(e,t);if(this.el=Ur.createElement(c,s),Li.currentNode=this.el.content,t===2){const d=this.el.content,f=d.firstChild;f.remove(),d.append(...f.childNodes)}for(;(r=Li.nextNode())!==null&&n.length<l;){if(r.nodeType===1){if(r.hasAttributes()){const d=[];for(const f of r.getAttributeNames())if(f.endsWith(pl)||f.startsWith(ii)){const g=h[a++];if(d.push(f),g!==void 0){const $=r.getAttribute(g.toLowerCase()+pl).split(ii),w=/([.?@])?(.*)/.exec(g);n.push({type:1,index:o,name:w[2],strings:$,ctor:w[1]==="."?Q4:w[1]==="?"?X4:w[1]==="@"?Z4:da})}else n.push({type:6,index:o})}for(const f of d)r.removeAttribute(f)}if(D0.test(r.tagName)){const d=r.textContent.split(ii),f=d.length-1;if(f>0){r.textContent=Os?Os.emptyScript:"";for(let g=0;g<f;g++)r.append(d[g],Nr()),Li.nextNode(),n.push({type:2,index:++o});r.append(d[f],Nr())}}}else if(r.nodeType===8)if(r.data===P0)n.push({type:2,index:o});else{let d=-1;for(;(d=r.data.indexOf(ii,d+1))!==-1;)n.push({type:7,index:o}),d+=ii.length-1}o++}}static createElement(e,t){const s=Yi.createElement("template");return s.innerHTML=e,s}}function Ls(i,e,t=i,s){var r,o,a,l;if(e===Ds)return e;let n=s!==void 0?(r=t._$Co)===null||r===void 0?void 0:r[s]:t._$Cl;const c=Hr(e)?void 0:e._$litDirective$;return(n==null?void 0:n.constructor)!==c&&((o=n==null?void 0:n._$AO)===null||o===void 0||o.call(n,!1),c===void 0?n=void 0:(n=new c(i),n._$AT(i,t,s)),s!==void 0?((a=(l=t)._$Co)!==null&&a!==void 0?a:l._$Co=[])[s]=n:t._$Cl=n),n!==void 0&&(e=Ls(i,n._$AS(i,e.values),n,s)),e}class Y4{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){var t;const{el:{content:s},parts:r}=this._$AD,o=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:Yi).importNode(s,!0);Li.currentNode=o;let a=Li.nextNode(),l=0,n=0,c=r[0];for(;c!==void 0;){if(l===c.index){let h;c.type===2?h=new Yr(a,a.nextSibling,this,e):c.type===1?h=new c.ctor(a,c.name,c.strings,this,e):c.type===6&&(h=new J4(a,this,e)),this._$AV.push(h),c=r[++n]}l!==(c==null?void 0:c.index)&&(a=Li.nextNode(),l++)}return Li.currentNode=Yi,o}v(e){let t=0;for(const s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(e,s,t),t+=s.strings.length-2):s._$AI(e[t])),t++}}class Yr{constructor(e,t,s,r){var o;this.type=2,this._$AH=Te,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=s,this.options=r,this._$Cp=(o=r==null?void 0:r.isConnected)===null||o===void 0||o}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cp}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Ls(this,e,t),Hr(e)?e===Te||e==null||e===""?(this._$AH!==Te&&this._$AR(),this._$AH=Te):e!==this._$AH&&e!==Ds&&this._(e):e._$litType$!==void 0?this.g(e):e.nodeType!==void 0?this.$(e):q4(e)?this.T(e):this._(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==Te&&Hr(this._$AH)?this._$AA.nextSibling.data=e:this.$(Yi.createTextNode(e)),this._$AH=e}g(e){var t;const{values:s,_$litType$:r}=e,o=typeof r=="number"?this._$AC(e):(r.el===void 0&&(r.el=Ur.createElement(L0(r.h,r.h[0]),this.options)),r);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===o)this._$AH.v(s);else{const a=new Y4(o,this),l=a.u(this.options);a.v(s),this.$(l),this._$AH=a}}_$AC(e){let t=Td.get(e.strings);return t===void 0&&Td.set(e.strings,t=new Ur(e)),t}T(e){O0(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let s,r=0;for(const o of e)r===t.length?t.push(s=new Yr(this.k(Nr()),this.k(Nr()),this,this.options)):s=t[r],s._$AI(o),r++;r<t.length&&(this._$AR(s&&s._$AB.nextSibling,r),t.length=r)}_$AR(e=this._$AA.nextSibling,t){var s;for((s=this._$AP)===null||s===void 0||s.call(this,!1,!0,t);e&&e!==this._$AB;){const r=e.nextSibling;e.remove(),e=r}}setConnected(e){var t;this._$AM===void 0&&(this._$Cp=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}}class da{constructor(e,t,s,r,o){this.type=1,this._$AH=Te,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=o,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=Te}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,s,r){const o=this.strings;let a=!1;if(o===void 0)e=Ls(this,e,t,0),a=!Hr(e)||e!==this._$AH&&e!==Ds,a&&(this._$AH=e);else{const l=e;let n,c;for(e=o[0],n=0;n<o.length-1;n++)c=Ls(this,l[s+n],t,n),c===Ds&&(c=this._$AH[n]),a||(a=!Hr(c)||c!==this._$AH[n]),c===Te?e=Te:e!==Te&&(e+=(c??"")+o[n+1]),this._$AH[n]=c}a&&!r&&this.j(e)}j(e){e===Te?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class Q4 extends da{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===Te?void 0:e}}const K4=Os?Os.emptyScript:"";class X4 extends da{constructor(){super(...arguments),this.type=4}j(e){e&&e!==Te?this.element.setAttribute(this.name,K4):this.element.removeAttribute(this.name)}}class Z4 extends da{constructor(e,t,s,r,o){super(e,t,s,r,o),this.type=5}_$AI(e,t=this){var s;if((e=(s=Ls(this,e,t,0))!==null&&s!==void 0?s:Te)===Ds)return;const r=this._$AH,o=e===Te&&r!==Te||e.capture!==r.capture||e.once!==r.once||e.passive!==r.passive,a=e!==Te&&(r===Te||o);o&&this.element.removeEventListener(this.name,this,r),a&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,s;typeof this._$AH=="function"?this._$AH.call((s=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&s!==void 0?s:this.element,e):this._$AH.handleEvent(e)}}class J4{constructor(e,t,s){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(e){Ls(this,e)}}const Ad=Go.litHtmlPolyfillSupport;Ad==null||Ad(Ur,Yr),((wn=Go.litHtmlVersions)!==null&&wn!==void 0?wn:Go.litHtmlVersions=[]).push("2.8.0");const eg=(i,e,t)=>{var s,r;const o=(s=t==null?void 0:t.renderBefore)!==null&&s!==void 0?s:e;let a=o._$litPart$;if(a===void 0){const l=(r=t==null?void 0:t.renderBefore)!==null&&r!==void 0?r:null;o._$litPart$=a=new Yr(e.insertBefore(Nr(),l),l,void 0,t??{})}return a._$AI(i),a};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var _n,Sn;class wo extends dt{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e,t;const s=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=s.firstChild),s}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=eg(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!1)}render(){return Ds}}wo.finalized=!0,wo._$litElement$=!0,(_n=globalThis.litElementHydrateSupport)===null||_n===void 0||_n.call(globalThis,{LitElement:wo});const kd=globalThis.litElementPolyfillSupport;kd==null||kd({LitElement:wo});((Sn=globalThis.litElementVersions)!==null&&Sn!==void 0?Sn:globalThis.litElementVersions=[]).push("3.3.3");const Ed=x`var(--white, #fff)`,tg=x`var(--ia-theme-link-color, #4b64ff)`,ig=x`var(--primaryDisableCTAFill, #767676)`,sg=x`var(--secondaryCTABorder, #999)`,rg=x`var(--primaryCTAFill, #194880)`,Cn=x`var(--primaryCTAFillRGB, 25, 72, 128)`,og=x`var(--primaryCTABorder, #c5d1df)`,ag=x`var(--primaryErrorCTAFill, #d9534f)`,Tn=x`var(--primaryErrorCTAFillRGB, 229, 28, 38)`,ng=x`var(--primaryErrorCTABorder, #d43f3a)`,lg=x`var(--secondaryCTAFill, #333)`,An=x`var(--secondaryCTAFillRGB, 51, 51, 51)`,cg=x`var(--primaryCTABorder, #979797)`,hg=x`var(---primaryWarningFill, #ee8950)`,kn=x`var(--primaryWarningFillRGB, 238, 137, 80)`,dg=x`var(--primaryWarningBorder, #ec7939)`,pg=x`
  .ia-button {
    min-height: 3rem;
    cursor: pointer;
    color: ${Ed};
  ...
  .ia-button.warning:hover {
    background-color: rgba(${kn}, 0.9);
  }
  .ia-button.warning:focus-visible {
    background-color: rgba(${kn}, 0.8);
  }
  .ia-button.warning:active {
    background-color: rgba(${kn}, 0.7);
  }
...
`;function Md(i){return"disabled"in i&&typeof i.disabled=="boolean"}function ug(i){return"numbered"in i&&typeof i.numbered=="boolean"}function fg(i){return"validate"in i&&typeof i.validate=="function"}function mg(i){return"response"in i&&typeof i.response=="object"&&i.response!==null&&"name"in i.response&&typeof i.response.name=="string"}class gg extends Error{}async function En(i,e,t="Operation timed out"){const s=new Promise((r,o)=>setTimeout(o,e,new gg(t)));return Promise.race([i,s])}var Ci;let J=Ci=class extends pt{constructor(){super(...arguments),this.buttonText="Feedback",this.showButtonThumbs=!1,this.showQuestionNumbers=!1,this.disabled=!1,this.submitTimeout=8e3,this.isOpen=!1,this.submissionState="idle",this.popupTopX=0,this.popupTopY=0,this.resizingElement=document.body,this.handleScroll=()=>{this.isOpen&&this.positionPopup()},this.handleEscape=e=>{e.key==="Escape"&&this.cancel(e)}}render(){return X`<div id="container">${this.feedbackButtonTemplate}</div>`}willUpdate(e){if(e.has("submissionState")&&(this.isProcessing||this.isSubmitted?this.disableSlottedChildren():this.restoreSlottedChildrenDisabledStates()),e.has("resizeObserver")){const t=e.get("resizeObserver");this.disconnectResizeObserver(t)}}updated(e){(e.has("showQuestionNumbers")||e.has("assignedElements"))&&this.applyQuestionNumbers();const t=e.get("submissionState");t&&(this.submissionState==="error"||t==="error")&&this.positionPopup(),e.has("isOpen")&&this.isOpen&&this.focusFirstFormElement()}disconnectedCallback(){this.removeEscapeListener(),this.stopScrollObserver(),this.disconnectResizeObserver(this.resizeObserver)}disableSlottedChildren(){this.assignedElements.filter(Md).forEach(e=>{e.dataset.originallyDisabled=e.disabled?"true":"false",e.disabled=!0})}restoreSlottedChildrenDisabledStates(){this.assignedElements.filter(Md).forEach(e=>{const{originallyDisabled:t}=e.dataset;if(t===void 0)return;const s=t==="true";delete e.dataset.originallyDisabled,e.disabled=s})}handleResize(){this.isOpen&&this.positionPopup()}setupEscapeListener(){document.addEventListener("keyup",this.handleEscape)}removeEscapeListener(){document.removeEventListener("keyup",this.handleEscape)}setupScrollObserver(){document.addEventListener("scroll",this.handleScroll)}stopScrollObserver(){document.removeEventListener("scroll",this.handleScroll)}setupResizeObserver(){this.resizeObserver&&this.resizeObserver.addObserver({handler:this,target:this.resizingElement})}disconnectResizeObserver(e){const t=e??this.resizeObserver;t==null||t.removeObserver({handler:this,target:this.resizingElement})}getRecaptchaWidget(){if(this.recaptchaWidgetPromise)return this.recaptchaWidgetPromise;if(this.recaptchaManager)return this.recaptchaWidgetPromise=this.recaptchaManager.getRecaptchaWidget(),this.recaptchaWidgetPromise}resetSubmissionState(){this.setSubmissionState("idle"),this.error=void 0}setSubmissionState(e){this.submissionState!==e&&(this.submissionState=e,this.emitSubmissionStateChanged())}emitSubmissionStateChanged(){this.dispatchEvent(new CustomEvent("submissionStateChanged",{detail:this.submissionState}))}get isProcessing(){return this.submissionState==="processing"}get isSubmitted(){return this.submissionState==="submitted"}showPopup(){this.isSubmitted||(this.setupResizeObserver(),this.setupScrollObserver(),this.setupEscapeListener(),this.positionPopup(),this.isOpen=!0,this.getRecaptchaWidget())}closePopup(){this.disconnectResizeObserver(),this.stopScrollObserver(),this.removeEscapeListener(),this.isOpen=!1}positionPopup(){const e=this.container.getBoundingClientRect(),t=this.popup.getBoundingClientRect(),s=window.innerWidth,r=window.innerHeight,o=s/2,a=r/2,l=5,n=5;e.left<o?this.popupTopX=e.right-20:this.popupTopX=e.left+20-t.width,this.popupTopX+t.width>s&&(this.popupTopX=s-t.width-l),e.top<a?this.popupTopY=e.bottom-10:this.popupTopY=e.top+10-t.height,this.popupTopY+t.height>r&&(this.popupTopY=r-t.height-n),this.popupTopX=Math.max(l,this.popupTopX),this.popupTopY=Math.max(n,this.popupTopY)}get feedbackButtonThumbsTemplate(){return this.showButtonThumbs?X`
    ...
    `:K}get feedbackButtonCheckTemplate(){return X`<span class="beta-button-icon success">&check;</span>`}get feedbackButtonTemplate(){return X`
      ...
      ${this.popupTemplate}
    `}get popupTemplate(){const e=this.isProcessing||this.isSubmitted,t=this.isProcessing?Ci.SUBMIT_BUTTON_PROCESSING_TEXT:Ci.SUBMIT_BUTTON_NORMAL_TEXT,s=this.error?X`<div id="error">${this.error}</div>`:K,r=I4({left:`${this.popupTopX}px`,top:`${this.popupTopY}px`}),o=a=>a.stopPropagation();return X`
      <div
        id="popup-background"
        class=${this.isOpen?"open":"closed"}
        @click=${this.backgroundClicked}
    ...
    `}focusFirstFormElement(){const e=this.getRootNode();for(const t of this.assignedElements)if(t.focus(),e.activeElement===t)return;this.focusCancelButton()}focusCancelButton(){this.cancelButton.focus()}focusSubmitButton(){this.submitButton.focus()}applyQuestionNumbers(){if(!this.showQuestionNumbers){this.assignedElements.forEach(t=>{var s;(s=t.querySelector("[slot=question-number]"))===null||s===void 0||s.remove()});return}let e=1;this.assignedElements.filter(t=>ug(t)&&t.numbered).forEach(t=>{let s=t.querySelector("[slot=question-number]");s||(s=document.createElement("span"),s.setAttribute("slot","question-number")),s.textContent=`${e}. `,t.append(s),e+=1})}backgroundClicked(e){var t;e.target instanceof Node&&(!((t=this.popup)===null||t===void 0)&&t.contains(e.target)||this.cancel(e))}cancel(e){e.preventDefault(),this.closePopup(),this.isSubmitted||this.resetSubmissionState()}validate(){return this.assignedElements.filter(fg).map(e=>e.validate()).every(e=>e)}async submit(e){if(e==null||e.preventDefault(),!this.validate()){this.error=X`${Ci.ERROR_MESSAGE_MISSING_REQUIRED_INPUT}`,this.setSubmissionState("error");return}const{surveyIdentifier:t,submitTimeout:s,featureFeedbackService:r}=this;if(this.error=void 0,!t)throw new Error("surveyIdentifier is required");if(!r)throw new Error("featureFeedbackService is required");const o=this.getRecaptchaWidget();let a;try{a=await En(o,s)}catch(n){throw new Error(`recaptchaWidget load failed: ${n}`)}if(!a)throw new Error("recaptchaWidget is required");const l=this.isOpen;this.setSubmissionState("processing");try{const n=await En(a.execute(),s);(await En(r.submitSurvey({surveyIdentifier:t,responses:this.assignedElements.filter(mg).map(h=>h.response),recaptchaToken:n}),s)).success?(this.setSubmissionState("submitted"),l&&this.closePopup()):(this.error=X`${Ci.ERROR_MESSAGE_SUBMIT_REQUEST_FAILED}`,this.setSubmissionState("error"))}catch(n){this.error=X`${Ci.ERROR_MESSAGE_SUBMIT_REQUEST_FAILED}
        <br />
    ...
    `;return[pg,T]}};J.SUBMIT_BUTTON_NORMAL_TEXT=ut("Submit feedback");J.SUBMIT_BUTTON_PROCESSING_TEXT=ut("Submitting...");J.ERROR_MESSAGE_MISSING_REQUIRED_INPUT=ut("Please respond to the indicated questions.");J.ERROR_MESSAGE_SUBMIT_REQUEST_FAILED=ut("There was an error submitting your feedback.");p([E({type:String})],J.prototype,"surveyIdentifier",void 0);p([E({type:String})],J.prototype,"buttonText",void 0);p([E({type:Boolean})],J.prototype,"showButtonThumbs",void 0);p([E({type:Boolean})],J.prototype,"showQuestionNumbers",void 0);p([E({type:Boolean})],J.prototype,"disabled",void 0);p([E({type:Number})],J.prototype,"submitTimeout",void 0);p([E({type:Object})],J.prototype,"featureFeedbackService",void 0);p([E({type:Object})],J.prototype,"recaptchaManager",void 0);p([E({type:Object})],J.prototype,"resizeObserver",void 0);p([be()],J.prototype,"isOpen",void 0);p([be()],J.prototype,"submissionState",void 0);p([be()],J.prototype,"popupTopX",void 0);p([be()],J.prototype,"popupTopY",void 0);p([be()],J.prototype,"error",void 0);p([qe("#container")],J.prototype,"container",void 0);p([qe("#popup")],J.prototype,"popup",void 0);p([qe("#cancel-button")],J.prototype,"cancelButton",void 0);p([qe("#submit-button")],J.prototype,"submitButton",void 0);p([h1()],J.prototype,"assignedElements",void 0);J=Ci=p([Tt("ia-feedback-survey")],J);var xo;let Ke=xo=class extends pt{constructor(){super(),this.prompt="",this.value="",this.required=!1,this.disabled=!1,this.skipNumber=!1,this.visible=!0,this.internals=this.attachInternals()}render(){return X`
      <div id="container">
    ...
    `}};Ke.DEFAULT_PLACEHOLDER_REQUIRED=ut("Comments");Ke.DEFAULT_PLACEHOLDER_OPTIONAL=ut("Comments (optional)");Ke.formAssociated=!0;Ke.shadowRootOptions={...pt.shadowRootOptions,delegatesFocus:!0};p([E({type:String})],Ke.prototype,"prompt",void 0);p([E({type:String})],Ke.prototype,"value",void 0);p([E({type:Boolean,reflect:!0})],Ke.prototype,"required",void 0);p([E({type:Boolean,reflect:!0})],Ke.prototype,"disabled",void 0);p([E({type:Boolean,reflect:!0})],Ke.prototype,"skipNumber",void 0);p([E({type:String})],Ke.prototype,"placeholder",void 0);p([qe("#comments")],Ke.prototype,"commentBox",void 0);Ke=xo=p([Tt("ia-survey-comment")],Ke);/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Pd=k0(class extends E0{constructor(i){var e;if(super(i),i.type!==A0.ATTRIBUTE||i.name!=="class"||((e=i.strings)===null||e===void 0?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(i){return" "+Object.keys(i).filter(e=>i[e]).join(" ")+" "}update(i,[e]){var t,s;if(this.it===void 0){this.it=new Set,i.strings!==void 0&&(this.nt=new Set(i.strings.join(" ").split(/\s/).filter(o=>o!=="")));for(const o in e)e[o]&&!(!((t=this.nt)===null||t===void 0)&&t.has(o))&&this.it.add(o);return this.render(e)}const r=i.element.classList;this.it.forEach(o=>{o in e||(r.remove(o),this.it.delete(o))});for(const o in e){const a=!!e[o];a===this.it.has(o)||!((s=this.nt)===null||s===void 0)&&s.has(o)||(a?(r.add(o),this.it.add(o)):(r.remove(o),this.it.delete(o)))}return ni}});var _o;let Ie=_o=class extends pt{constructor(){super(),this.prompt="",this.vote=void 0,this.required=!1,this.disabled=!1,this.skipNumber=!1,this.showComments=!1,this.visible=!0,this.internals=this.attachInternals()}render(){return X`
      <div id="container">
        <div
          id="prompt-row"
          role="radiogroup"
    ...
    `}};Ie.UPVOTE_SR_LABEL=ut("Vote up");Ie.DOWNVOTE_SR_LABEL=ut("Vote down");Ie.formAssociated=!0;Ie.shadowRootOptions={...pt.shadowRootOptions,delegatesFocus:!0};p([E({type:String})],Ie.prototype,"prompt",void 0);p([E({type:String})],Ie.prototype,"vote",void 0);p([E({type:String})],Ie.prototype,"comment",void 0);p([E({type:String})],Ie.prototype,"commentPlaceholder",void 0);p([E({type:Boolean,reflect:!0})],Ie.prototype,"required",void 0);p([E({type:Boolean,reflect:!0})],Ie.prototype,"disabled",void 0);p([E({type:Boolean,reflect:!0})],Ie.prototype,"skipNumber",void 0);p([E({type:Boolean,reflect:!0})],Ie.prototype,"showComments",void 0);p([qe("#comments")],Ie.prototype,"commentBox",void 0);Ie=_o=p([Tt("ia-survey-vote")],Ie);let Yo=class extends pt{constructor(){super(...arguments),this.name="",this.visible=!1,this.disabled=!1}createRenderRoot(){return this}render(){return K}validate(){return!0}get numbered(){return!1}get response(){return{name:this.name,comment:this.value}}};p([E({type:String,reflect:!0})],Yo.prototype,"name",void 0);p([E({type:String,reflect:!0})],Yo.prototype,"value",void 0);Yo=p([Tt("ia-survey-extra")],Yo);const vg=m`
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path
...
`;var bg=Object.defineProperty,yg=Object.getOwnPropertyDescriptor,Ze=(i,e,t,s)=>{for(var r=s>1?void 0:s?yg(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&bg(e,t,r),r};let Ne=class extends H{constructor(){super(...arguments),this.binSnapping="none",this.barScaling="logarithmic",this.boundEscapeListener=i=>{i.key==="Escape"&&this.closeModal()}}render(){return m`
      <div id="container">
    ...
    `}};Ze([u({type:String})],Ne.prototype,"minDate",2);Ze([u({type:String})],Ne.prototype,"maxDate",2);Ze([u({type:String})],Ne.prototype,"minSelectedDate",2);Ze([u({type:String})],Ne.prototype,"maxSelectedDate",2);Ze([u({type:Array})],Ne.prototype,"buckets",2);Ze([u({type:String})],Ne.prototype,"customDateFormat",2);Ze([u({type:String})],Ne.prototype,"customTooltipDateFormat",2);Ze([u({type:String})],Ne.prototype,"customTooltipLabel",2);Ze([u({type:String})],Ne.prototype,"binSnapping",2);Ze([u({type:String})],Ne.prototype,"barScaling",2);Ze([u({type:Object,attribute:!1})],Ne.prototype,"modalManager",2);Ze([u({type:Object,attribute:!1})],Ne.prototype,"analyticsHandler",2);Ne=Ze([N("expanded-date-picker")],Ne);let Qi=class extends H{constructor(){super(...arguments),this.loadingTitle=S("Loading..."),this.successTitle=S("Success"),this.errorTitle=S("Error"),this.loadingStyle="ring-dots",this.mode="loading"}render(){return m`${x1(this.mode,[["loading",()=>this.loadingIndicatorTemplate],["success",()=>this.successIndicatorTemplate],["error",()=>this.errorIndicatorTemplate]])}`}get loadingIndicatorTemplate(){return m`
      <svg
    ...
    `}get shouldShowLoadingDots(){return this.loadingStyle!=="ring"}static get styles(){return[w1,y`
        :host {
      ...
      `]}};p([u({type:String})],Qi.prototype,"loadingTitle",void 0);p([u({type:String})],Qi.prototype,"successTitle",void 0);p([u({type:String})],Qi.prototype,"errorTitle",void 0);p([u({type:String})],Qi.prototype,"loadingStyle",void 0);p([u({type:String})],Qi.prototype,"mode",void 0);Qi=p([N("ia-status-indicator")],Qi);const $g=q`
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path 
      d="m20.1116715 50.0035012-.1116715-.1085359 43.1159942-46.61088155c2.401537-2.18938917 4.6902018-3.28408375 6.8659943-3.28408375s4.1642651.63837733 5.9654178 1.91513199c1.8011528 1.27675467 3.1520173 2.97248092 4.0525937 5.08717877l-39.4020173 42.99768924 39.4020173 42.9976892c-.9005764 2.1146979-2.2514409 3.8104241-4.0525937 5.0871788-1.8011527 1.2767547-3.7896253 1.915132-5.9654178 1.915132-2.1013449 0-4.3900096-1.0573489-6.8659943-3.1720468l-43.1159942-46.7194174z"
    />
...
`;var xg=Object.defineProperty,_g=Object.getOwnPropertyDescriptor,Qr=(i,e,t,s)=>{for(var r=s>1?void 0:s?_g(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&xg(e,t,r),r};let Bs=class extends H{constructor(){super(...arguments),this.step=2,this.currentPage=1,this.pages=[]}firstUpdated(){this.observePageCount()}updated(i){i.has("size")&&this.observePageCount(),i.has("currentPage")&&(this.observePageCount(),this.emitPageClick())}observePageCount(){this.pages=[];const i=7,e=this.size<=i;if(this.size<=5){this.pages=[...Array(this.size).keys()].map(r=>r+1);return}if(this.size===i){if(this.currentPage===2){this.pages=[1,2,3,4,0,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,4,5,this.size-1,this.size];return}}if(this.currentPage===1){this.pages=[1,2,3,0,this.size];return}if(this.currentPage===this.size){this.pages=[1,0,this.size-2,this.size-1,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,this.size-3,this.size-2,this.size-1,this.size];return}if(e&&this.currentPage>1&&this.currentPage<i){this.pages=[...Array(this.size).keys()].map(r=>r+1);return}let t=this.currentPage-this.step,s=this.currentPage+this.step;t<=0&&(s+=-t+1,t=1),s>=this.size&&(t=Math.max(t-(s-this.size),1),s=this.size),t===2&&(s-=1),s===this.size-1&&(t+=1),this.createFirstNode(t),this.createMiddelNode(t,s),this.createLastNode(s)}createFirstNode(i){var e,t;i>1&&((e=this.pages)==null||e.push(1)),i>2&&((t=this.pages)==null||t.push(0))}createMiddelNode(i,e){var t;for(let s=i;s<=e;s+=1)(t=this.pages)==null||t.push(s)}createLastNode(i){var e,t;i<this.size-1&&((e=this.pages)==null||e.push(0)),i<this.size&&((t=this.pages)==null||t.push(this.size))}get getEllipsisTemplate(){return m`<i class="ellipses">...</i>`}emitPageClick(){this.dispatchEvent(new CustomEvent("pageNumberClicked",{detail:{page:this.currentPage},bubbles:!0,composed:!0}))}onRewind(){this.currentPage-=1,this.currentPage<1&&(this.currentPage=1)}onForward(){this.currentPage+=1,this.currentPage>this.size&&(this.currentPage=this.size)}onChange(i){this.currentPage=i}getPageTemplate(i){return m`
    ...
    `}static get styles(){return[yt,y`
      ...
      `]}};Qr([u({type:Number})],Bs.prototype,"size",2);Qr([u({type:Number})],Bs.prototype,"step",2);Qr([u({type:Number})],Bs.prototype,"currentPage",2);Qr([R()],Bs.prototype,"pages",2);Bs=Qr([N("more-facets-pagination")],Bs);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Od=(i,e,t)=>{const s=new Map;for(let r=e;r<=t;r++)s.set(i[r],r);return s},B0=jr(class extends Wr{constructor(i){if(super(i),i.type!==St.CHILD)throw Error("repeat() can only be used in text expressions")}dt(i,e,t){let s;t===void 0?t=e:e!==void 0&&(s=e);const r=[],o=[];let a=0;for(const l of i)r[a]=s?s(l,a):a,o[a]=t(l,a),a++;return{values:o,keys:r}}render(i,e,t){return this.dt(i,e,t).values}update(i,[e,t,s]){const r=Ju(i),{values:o,keys:a}=this.dt(e,t,s);if(!Array.isArray(r))return this.ut=a,o;const l=this.ut??(this.ut=[]),n=[];let c,h,d=0,f=r.length-1,g=0,$=o.length-1;for(;d<=f&&g<=$;)if(r[d]===null)d++;else if(r[f]===null)f--;else if(l[d]===a[g])n[g]=gi(r[d],o[g]),d++,g++;else if(l[f]===a[$])n[$]=gi(r[f],o[$]),f--,$--;else if(l[d]===a[$])n[$]=gi(r[d],o[$]),Ks(i,n[$+1],r[d]),d++,$--;else if(l[f]===a[g])n[g]=gi(r[f],o[g]),Ks(i,r[d],r[f]),f--,g++;else if(c===void 0&&(c=Od(a,g,$),h=Od(l,d,f)),c.has(l[d]))if(c.has(l[f])){const w=h.get(a[g]),T=w!==void 0?r[w]:null;if(T===null){const P=Ks(i,r[d]);gi(P,o[g]),n[g]=P}else n[g]=gi(T,o[g]),Ks(i,r[d],T),r[w]=null;g++}else Va(r[f]),f--;else Va(r[d]),d++;for(;g<=$;){const w=Ks(i,n[$+1]);gi(w,o[g]),n[g++]=w}for(;d<=f;){const w=r[d++];w!==null&&Va(w)}return this.ut=a,$1(i,n),tt}}),Sg=q`
...
`;var Tg=Object.defineProperty,Ag=Object.getOwnPropertyDescriptor,pa=(i,e,t,s)=>{for(var r=s>1?void 0:s?Ag(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&Tg(e,t,r),r};let Fs=class extends H{render(){return m`${this.facetRowTemplate}`}get facetRowTemplate(){var w;const{bucket:i,facetType:e}=this;if(!i||!e)return b;const t=`${e}:${i.key}-show-only`,s=`${e}:${i.key}-negative`,r=i.extraNote?m`<span class="facet-note">${i.extraNote}</span>`:b,o=e!=="collection"?m`${i.displayText??i.key} ${r}`:m`<a href="/details/${i.key}">
            ${((w=this.collectionTitles)==null?void 0:w.get(i.key))??i.key}
          </a> `,a=i.count>0?i.count.toLocaleString():"",l=i.state==="hidden",n=i.state==="selected",c=`${e}: ${i.displayText??i.key}`,h=n?`Show all ${e}s`:`Only show ${c}`,d=`Hide ${c}`,f=`Unhide ${c}`,g=l?f:d,$=`${c}, ${i.count} results`;return m`
        ...
        <div class="facet-checkboxes">
          ...
          <div class="hide-facet-container">
            ...
            >
              ...
              <span class="eye eye-open">${Sg}</span>
              <span class="eye eye-closed">${Cg}</span>
            </label>
          </div>
        </div>
        <label
    ...
    `;return[yt,s]}};pa([u({type:String})],Fs.prototype,"facetType",2);pa([u({type:Object})],Fs.prototype,"bucket",2);pa([u({type:Object})],Fs.prototype,"collectionTitles",2);Fs=pa([N("facet-row")],Fs);var kg=Object.defineProperty,Eg=Object.getOwnPropertyDescriptor,Xl=(i,e,t,s)=>{for(var r=s>1?void 0:s?Eg(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&kg(e,t,r),r};let Qo=class extends H{facetClicked(i){this.dispatchFacetClickEvent(i.detail)}dispatchFacetClickEvent(i){const e=new CustomEvent("facetClick",{detail:i,composed:!0});this.dispatchEvent(e)}get facetsTemplate(){const{facetGroup:i}=this;if(!i)return b;const e=i.buckets;return m`
    ...
    `}};Xl([u({type:Object})],Qo.prototype,"facetGroup",2);Xl([u({type:Object})],Qo.prototype,"collectionTitles",2);Qo=Xl([N("facets-template")],Qo);var Mg=Object.defineProperty,Pg=Object.getOwnPropertyDescriptor,Xi=(i,e,t,s)=>{for(var r=s>1?void 0:s?Pg(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&Mg(e,t,r),r};let li=class extends H{constructor(){super(...arguments),this.leftValue="",this.rightValue="",this.side="left"}render(){return m`
      <div id="container">
    ...
    `}get paginationSize(){var e;if(!this.aggregations||!this.facetKey)return 0;const i=(e=this.aggregations[this.facetKey])==null?void 0:e.buckets.length;return Math.ceil(i/this.facetsPerPage)}get facetsPaginationTemplate(){return this.paginationSize>1?m`<more-facets-pagination
        ...
        </div> `:b}sortFacetAggregation(i){this.sortedBy=i,this.dispatchEvent(new CustomEvent("sortedFacets",{detail:this.sortedBy}))}get modalHeaderTemplate(){var t,s;const e=(this.sortedBy??ds[this.facetKey])===V.COUNT?"left":"right";return m`<span class="sr-only">${S("More facets for:")}</span>
      <span class="title">
      ...
      ${this.facetsLoading?this.loaderTemplate:m`
          ...
          `}
    `}applySearchFacetsClicked(){var t,s;const i=v1(this.selectedFacets,this.unappliedFacetChanges),e=new CustomEvent("facetsChanged",{detail:i,bubbles:!0,composed:!0});this.dispatchEvent(e),this.unappliedFacetChanges=zt(),(t=this.modalManager)==null||t.closeModal(),(s=this.analyticsHandler)==null||s.sendEvent({category:It.default,action:`${re.applyMoreFacetsModal}`,label:`${this.facetKey}`})}cancelClick(){var i,e;this.unappliedFacetChanges=zt(),(i=this.modalManager)==null||i.closeModal(),(e=this.analyticsHandler)==null||e.sendEvent({category:It.default,action:re.closeMoreFacetsModal,label:`${this.facetKey}`})}static get styles(){const i=y`var(--primaryButtonBGColor, #194880)`;return[yt,y`
        section#more-facets {
          overflow: auto;
      ...
      `]}};ue([u({type:String})],ae.prototype,"facetKey",2);ue([u({type:String})],ae.prototype,"query",2);ue([u({type:Array})],ae.prototype,"identifiers",2);ue([u({type:Object})],ae.prototype,"filterMap",2);ue([u({type:Number})],ae.prototype,"searchType",2);ue([u({type:Object})],ae.prototype,"pageSpecifierParams",2);ue([u({type:Object})],ae.prototype,"collectionTitles",2);ue([u({type:Object})],ae.prototype,"tvChannelAliases",2);ue([u({type:Number})],ae.prototype,"facetsPerPage",2);ue([u({type:Boolean})],ae.prototype,"facetsLoading",2);ue([u({type:Object})],ae.prototype,"selectedFacets",2);ue([u({type:Number})],ae.prototype,"sortedBy",2);ue([u({type:Boolean})],ae.prototype,"isTvSearch",2);ue([u({type:Object})],ae.prototype,"modalManager",2);ue([u({type:Object})],ae.prototype,"searchService",2);ue([u({type:Object,attribute:!1})],ae.prototype,"analyticsHandler",2);ue([R()],ae.prototype,"aggregations",2);ue([R()],ae.prototype,"facetGroup",2);ue([R()],ae.prototype,"unappliedFacetChanges",2);ue([R()],ae.prototype,"pageNumber",2);ae=ue([N("more-facets-content")],ae);var Fg=Object.getOwnPropertyDescriptor,Rg=(i,e,t,s)=>{for(var r=s>1?void 0:s?Fg(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=a(r)||r);return r};let Dd=class extends H{render(){return m`
      <div id="row">
    ...
    `}get collectionPartOfTemplate(){var e;if(!((e=this.parentCollections)!=null&&e.length))return b;const i="partof-heading";return m`
      ...
      >
        ...
        <ul>
          ${Ri(this.parentCollections,t=>{var r;const s=`${this.baseNavigationUrl}${this.collectionPagePath}${t}`;return m` <li>
              <a
                href=${s}
                data-id=${t}
    ...
    `}getTombstoneFacetGroupTemplate(){return m`
      ${Ri(Array(5).fill(null),()=>m`<facet-tombstone-row></facet-tombstone-row>`)}
    `}searchMoreFacetsLink(i){if(!this.moreLinksVisible||i.key==="lending"||Object.keys(i.buckets).length<this.allowedFacetCount)return b;const e=ds[i.key];return m`<button
      class="more-link"
      @click=${()=>{var t;this.showMoreFacetsModal(i,e),(t=this.analyticsHandler)==null||t.sendEvent({category:It.default,action:re.showMoreFacetsModal,label:i.key}),this.dispatchEvent(new CustomEvent("showMoreFacets",{detail:i.key}))}}
    ...
    `}static get styles(){return[yt,y`
      ...
      `]}};W([u({type:Object})],j.prototype,"searchService",2);W([u({type:Number})],j.prototype,"searchType",2);W([u({type:Object})],j.prototype,"aggregations",2);W([u({type:Object})],j.prototype,"histogramAggregation",2);W([u({type:String})],j.prototype,"minSelectedDate",2);W([u({type:String})],j.prototype,"maxSelectedDate",2);W([u({type:Boolean})],j.prototype,"moreLinksVisible",2);W([u({type:Boolean})],j.prototype,"facetsLoading",2);W([u({type:Boolean})],j.prototype,"histogramAggregationLoading",2);W([u({type:Object})],j.prototype,"selectedFacets",2);W([u({type:Boolean})],j.prototype,"collapsableFacets",2);W([u({type:Number})],j.prototype,"contentWidth",2);W([u({type:Boolean})],j.prototype,"showHistogramDatePicker",2);W([u({type:Boolean})],j.prototype,"allowExpandingDatePicker",2);W([u({type:Boolean})],j.prototype,"suppressMediatypeFacets",2);W([u({type:String})],j.prototype,"query",2);W([u({type:Array})],j.prototype,"identifiers",2);W([u({type:Object})],j.prototype,"pageSpecifierParams",2);W([u({type:Array})],j.prototype,"parentCollections",2);W([u({type:Object})],j.prototype,"filterMap",2);W([u({type:String})],j.prototype,"baseNavigationUrl",2);W([u({type:String})],j.prototype,"collectionPagePath",2);W([u({type:Boolean})],j.prototype,"isManageView",2);W([u({type:Boolean})],j.prototype,"isTvSearch",2);W([u({type:Array})],j.prototype,"facetDisplayOrder",2);W([u({type:Object,attribute:!1})],j.prototype,"modalManager",2);W([u({type:Object,attribute:!1})],j.prototype,"resizeObserver",2);W([u({type:Object,attribute:!1})],j.prototype,"featureFeedbackService",2);W([u({type:Object,attribute:!1})],j.prototype,"recaptchaManager",2);W([u({type:Object,attribute:!1})],j.prototype,"analyticsHandler",2);W([u({type:Object,attribute:!1})],j.prototype,"collectionTitles",2);W([u({type:Object,attribute:!1})],j.prototype,"tvChannelAliases",2);W([R()],j.prototype,"openFacets",2);j=W([N("collection-facets")],j);var Ng=Object.getOwnPropertyDescriptor,Hg=(i,e,t,s)=>{for(var r=s>1?void 0:s?Ng(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=a(r)||r);return r};let Ld=class extends H{render(){return m`
      <div class="lds-ring">
        <div></div>
        <div></div>
        <div></div>
    ...
    `}};Ld=Hg([N("circular-activity-indicator")],Ld);function Ug(i,e){return i===void 0?e!==void 0:e===void 0?i!==void 0:i.facetType===e.facetType&&i.bucketKey===e.bucketKey}function ul(i,e){return i.label===e.label&&i.facets.length===e.facets.length&&i.facets.every((t,s)=>Ug(t,e.facets[s]))}function F0(i){if(!Array.isArray(i[0])){let r=[...i];for(let o=0;o<r.length;o++){const a=r[o];r=r.filter(l=>a===l||!ul(a,l))}return r}const e=i,t=[];for(const s of e){const r=[];for(const o of s)t.find(l=>l.find(n=>ul(o,n)))||r.push(o);r.length>0&&t.push(r)}return t}class Zl{async getRecommendedFacets(){const e=navigator.language,t=Zl.getLanguageDisplayName(e);return t?[{facets:[{facetType:"language",bucketKey:t}]}]:[]}static getLanguageDisplayName(e){const t=e.split("-")[0];return new Intl.DisplayNames(["en"],{type:"language"}).of(t)}}const xi={facets:[{facetType:"mediatype",bucketKey:"texts"}]},_i={facets:[{facetType:"mediatype",bucketKey:"audio"}]},os={facets:[{facetType:"mediatype",bucketKey:"movies"}]},jt={facets:[{facetType:"mediatype",bucketKey:"image"}]},hr={facets:[{facetType:"mediatype",bucketKey:"software"}]},Mn={facets:[{facetType:"mediatype",bucketKey:"etree"}]},Vg={facets:[{facetType:"mediatype",bucketKey:"web"}]},jg={facets:[{facetType:"mediatype",bucketKey:"data"}]},Wg={text:[xi],book:[xi],novel:[xi],magazine:[xi],newspaper:[xi],pdf:[xi],epub:[xi],audio:[_i],song:[_i],music:[_i],listen:[_i],podcast:[_i],radio:[_i],stream:[_i,os],video:[os],movie:[os],film:[os],animation:[os],youtube:[os],image:[jt],photo:[jt],picture:[jt],painting:[jt],jpg:[jt],jpeg:[jt],png:[jt],gif:[jt],software:[hr],app:[hr],program:[hr],game:[hr],arcade:[hr],etree:[Mn],concert:[Mn],"live music":[Mn],"web crawl":[Vg],dataset:[jg]};class qg{async getRecommendedFacets(e){const t=[];for(const[s,r]of Object.entries(Wg))e.includes(s)&&t.push(...r);return t}}const lo=[{facets:[{facetType:"mediatype",bucketKey:"texts"}]}],Bd=[{label:"Films by __QUERY",facets:[{facetType:"mediatype",bucketKey:"movies"},{facetType:"creator",bucketKey:"__QUERY"}]}],dr=[{label:"Writing by __QUERY",facets:[{facetType:"mediatype",bucketKey:"texts"},{facetType:"creator",bucketKey:"__QUERY"}]}],co=[{label:"Images by __QUERY",facets:[{facetType:"mediatype",bucketKey:"image"},{facetType:"creator",bucketKey:"__QUERY"}]}],pr=[{label:"Music by __QUERY",facets:[{facetType:"mediatype",bucketKey:"audio"},{facetType:"creator",bucketKey:"__QUERY"}]}],Gg={"written work":lo,literature:lo,book:lo,novel:lo,filmmaker:Bd,director:Bd,author:dr,writer:dr,novelist:dr,essayist:dr,poet:dr,"visual artist":co,"graphic artist":co,photographer:co,painter:co,singer:pr,songwriter:pr,musician:pr,composer:pr,pianist:pr};class Yg{constructor(){this.WIKIDATA_BASE_URL="https://www.wikidata.org/w/api.php",this.WIKIDATA_DEFAULT_ARGS="?action=wbsearchentities&format=json&language=en&uselang=en&origin=*&type=item&limit=5"}getWikidataURL(e){const t=encodeURIComponent(e);return`${this.WIKIDATA_BASE_URL}${this.WIKIDATA_DEFAULT_ARGS}&search=${t}`}replaceQueryPlaceholders(e,t){return e.map(s=>{var r;return{label:(r=s.label)==null?void 0:r.replace("__QUERY",t),facets:s.facets.map(o=>{var l;const a={...o,bucketKey:o.bucketKey.replace("__QUERY",t.toLowerCase())};return o.displayText&&(a.displayText=(l=a.displayText)==null?void 0:l.replace("__QUERY",t)),a})}})}async getRecommendedFacets(e){var s;const t=[];try{const r=this.getWikidataURL(e),a=await(await fetch(r)).json();for(const[l,n]of Object.entries(Gg))if(new RegExp(`\\b${l}\\b`).test((s=a.search[0])==null?void 0:s.description)){const h=a.search[0].label;t.push(...this.replaceQueryPlaceholders(n,h))}return t}catch(r){return console.warn(r),[]}}}const Ko=class Ko{async getRecommendedFacets(e,t=Ko.DEFAULT_HEURISTICS){const s=t.map(r=>new r().getRecommendedFacets(e));return F0((await Promise.all(s)).flat())}};Ko.DEFAULT_HEURISTICS=[qg,Yg,Zl];let fl=Ko;const Ft=window.location&&(window.location.hostname==="localhost"||window.location.host.match(/^(www|cat)-[a-z0-9]+\.archive\.org$/)||window.location.host.match(/\.code\.archive\.org$/)||window.location.host.match(/\.dev\.archive\.org$/)||window.location.host.match(/^ia-petabox-/)||window.location.host.match(/^local\.archive\.org/)||window.location.host.match(/^internetarchive\.github\.io$/))?console.log.bind(console):()=>{},Qg=m`
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path
...
`;var Xg=Object.defineProperty,Zg=Object.getOwnPropertyDescriptor,ua=(i,e,t,s)=>{for(var r=s>1?void 0:s?Zg(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&Xg(e,t,r),r};function Jg(i){return i&&i.charAt(0).toLocaleUpperCase()+i.slice(1)}let Vr=class extends H{constructor(){super(...arguments),this.selected=!1}render(){if(!this.facetInfo)return b;const i=this.facetInfo.facets.length===1,e=this.facetInfo.facets[0],t=Jg((this.labelPrefix?`${this.labelPrefix} `:"")+(this.facetInfo.label??e.displayText??e.bucketKey));if(!t)return b;const s=i&&e.facetType==="mediatype"?M1[e.bucketKey].icon:b;return m`
      <a
      ...
      >
        ${s} ${t}
        ${this.selected?m`<span class="unselect-button">${Kg}</span>`:b}
      </a>
    ...
    `}};Kr([u({type:Array})],Rs.prototype,"facetInfo",2);Kr([u({type:String})],Rs.prototype,"labelPrefix",2);Kr([u({type:Object})],Rs.prototype,"activeFacetRef",2);Kr([ee("ia-dropdown")],Rs.prototype,"dropdown",2);Rs=Kr([N("smart-facet-dropdown")],Rs);var i6=Object.defineProperty,s6=Object.getOwnPropertyDescriptor,$t=(i,e,t,s)=>{for(var r=s>1?void 0:s?s6(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&i6(e,t,r),r};const Fd={collection:"Collection: ",creator:"By: ",subject:"About: "};function r6(i){return i.charAt(0).toUpperCase()+i.slice(1)}let rt=class extends H{constructor(){super(...arguments),this.filterToggleShown=!1,this.filterToggleActive=!1,this.heuristicRecs=[],this.smartFacets=[]}render(){if(!this.query)return b;const i=!!this.label&&this.smartFacets.length>0;return m`
    ...
    `}willUpdate(i){let e=!1;i.has("query")&&(Ft("query change",i.get("query"),this.query),this.lastAggregations=void 0,e=!0),i.has("aggregations")&&!this.lastAggregations&&this.aggregations&&Object.keys(this.aggregations).length>0&&(Ft("aggs change",i.get("aggregations"),this.aggregations),this.lastAggregations=this.aggregations,e=!0),e&&(Ft("should update smart facets, doing so..."),this.updateSmartFacets())}refresh(){this.lastAggregations=this.aggregations,this.updateSmartFacets()}deselectAll(){for(const i of this.smartFacets)for(const e of i)e.selected=!1;this.requestUpdate()}async updateSmartFacets(){Ft("updating smart facets"),this.query&&(this.heuristicRecs=await new fl().getRecommendedFacets(this.query),Ft("heuristic recs are",this.heuristicRecs),this.smartFacets=F0(this.facetsToDisplay),Ft("smart facets are",this.smartFacets))}makeSmartFacet(i){return i.length===0?b:i.length===1?this.smartFacetButton(i[0]):this.smartFacetDropdown(i)}smartFacetButton(i){return m`
      <smart-facet-button
        .facetInfo=${i}
        .labelPrefix=${Fd[i.facets[0].facetType]}
    ...
    `}smartFacetDropdown(i){return m`
      <smart-facet-dropdown
        .facetInfo=${i}
        .labelPrefix=${Fd[i[0].facets[0].facetType]}
    ...
    </infinite-scroller>`}get infiniteScrollerClasses(){return Qe({[this.displayMode??""]:!!this.displayMode,hidden:!!this.placeholderType})}get sortFilterBarTemplate(){var e;if(this.suppressSortBar)return b;let i=ia;return(e=this.withinCollection)!=null&&e.startsWith("fav-")?i=Bu:!this.withinCollection&&this.searchType===I.TV&&(i=Fu),i.relevance=this.isRelevanceSortAvailable,m`
      <sort-filter-bar
    ...
    `:b}get manageViewModalMsg(){const i=this.dataSource.checkedTileModels.length>1;switch(this.profileElement){case"uploads":return S(i?"Note: It may take a few minutes for these items to stop appearing in your uploads list.":"Note: It may take a few minutes for this item to stop appearing in your uploads list.");case"web_archives":return S(i?"Note: It may take a few minutes for these items to stop appearing in your web archives list.":"Note: It may take a few minutes for this item to stop appearing in your web archives list.");default:return""}}get manageBarTemplate(){return m`
      ...
      ></manage-bar>
    `}handleRemoveItems(){this.dispatchEvent(new CustomEvent("itemRemovalRequested",{detail:{items:this.dataSource.checkedTileModels.map(i=>{const e=(i==null?void 0:i.mediatype)==="search"?"search:":"",t=(i==null?void 0:i.identifier)??"";return`${e}${t}`})}}))}handleManageItems(){this.dispatchEvent(new CustomEvent("itemManagerRequested",{detail:{items:this.dataSource.checkedTileModels.map(i=>i!=null&&i.identifier?i.identifier:"")}}))}refreshSmartFacets(){var i;(i=this.smartFacetBar)==null||i.refresh()}showRemoveItemsProcessingModal(){var i;(i=this.manageBar)==null||i.showRemoveItemsProcessingModal()}showRemoveItemsErrorModal(){var i;(i=this.manageBar)==null||i.showRemoveItemsErrorModal()}removeCheckedTiles(){this.dataSource.removeCheckedTiles()}tileBlurCheckboxChanged(i){var t;const{checked:e}=i.target;this.tileBlurOverrideState=e?"on":"off",(t=this.infiniteScroller)==null||t.refreshAllVisibleCells()}get shouldSuppressTileBlurring(){if(this.tileBlurOverrideState!=="no-override")return this.tileBlurOverrideState==="off";const{sessionContext:i}=this.dataSource,e=i==null?void 0:i.pps_relevant_user_preferences;return(e==null?void 0:e.display__blur_moderated_content)==="off"}userChangedSort(i){const{selectedSort:e,sortDirection:t}=i.detail;this.selectedSort=e,this.sortDirection=t,(this.currentPage??1)>1&&this.goToPage(1),this.currentPage=1}sendSortByAnalytics(i){var t;const e=i&&!this.sortDirection;(t=this.analyticsHandler)==null||t.sendEvent({category:this.searchContext,action:re.sortBy,label:`${this.selectedSort}${this.sortDirection||e?`-${this.sortDirection}`:""}`})}selectedSortChanged(){this.dataSource.updatePrefixFiltersForCurrentSort()}get sortParam(){const i=Ye[this.selectedSort];if(!(i!=null&&i.handledBySearchService))return null;const e=new URL(window.location.href).searchParams.get("sort"),t=i.searchServiceKey??(e==null?void 0:e.replace(/^-/,""));return this.sortDirection||(this.sortDirection="asc"),t?{field:t,direction:this.sortDirection}:null}get defaultSortParam(){const i=this.defaultSortDirection??"asc",e=Ye[this.defaultSortField].searchServiceKey;return e?{field:e,direction:i}:null}displayModeChanged(i){var e;this.displayMode=i.detail.displayMode,this.displayMode&&((e=this.analyticsHandler)==null||e.sendEvent({category:this.searchContext,action:re.displayMode,label:this.displayMode}))}get titleQuery(){return this.selectedTitleFilter?`firstTitle:${this.selectedTitleFilter}`:void 0}get creatorQuery(){return this.selectedCreatorFilter?`firstCreator:${this.selectedCreatorFilter}`:void 0}sendFilterByTitleAnalytics(i){var t;if(!i&&!this.selectedTitleFilter)return;const e=i&&!this.selectedTitleFilter;(t=this.analyticsHandler)==null||t.sendEvent({category:this.searchContext,action:re.filterByTitle,label:e?`clear-${i}`:`${i||"start"}-${this.selectedTitleFilter}`})}sendFilterByCreatorAnalytics(i){var t;if(!i&&!this.selectedCreatorFilter)return;const e=i&&!this.selectedCreatorFilter;(t=this.analyticsHandler)==null||t.sendEvent({category:this.searchContext,action:re.filterByCreator,label:e?`clear-${i}`:`${i||"start"}-${this.selectedCreatorFilter}`})}titleLetterSelected(i){this.selectedCreatorFilter=null,this.selectedTitleFilter=i.detail.selectedLetter}creatorLetterSelected(i){this.selectedTitleFilter=null,this.selectedCreatorFilter=i.detail.selectedLetter}get mobileFacetsTemplate(){return Vn.includes(this.profileElement)?b:m`
      <details id="mobile-filter-collapse" @toggle=${e=>{var s;const t=e.target;this.isResizeToMobile=!1,this.collapsibleFacetsVisible=t.open,(s=this.analyticsHandler)==null||s.sendEvent({category:this.searchContext,action:re.mobileFacetsToggled,label:t.open?"open":"closed"})}}>
        <summary>
          <span class="collapser-icon">${Wn}</span>
          <h2>${S("Filters")}</h2>
          ${this.clearFiltersBtnTemplate(!0)}
        </summary>
        ${this.facetsTemplate}
      </details>
    `}async tvDropdownToggled(i){if(i.detail&&!this.tvMapsPopulated){this.tvMapsLoading=!0,this.tvMapsErrored=!1;try{await this.dataSource.populateTVChannelMaps(),this.tvMapsPopulated=!0}catch{this.tvMapsErrored=!0}this.tvMapsLoading=!1}}async networksDropdownChanged(){var s;const i=this.selectedTVNetwork,e=(s=this.tvNetworksDropdown.selectedOption)==null?void 0:s.text;this.selectedTVNetwork=e??void 0;const t=this.dataSource.tvChannelMaps.channelToNetwork.entries();for(const[r,o]of t)if(o===i){const a={key:r.toLowerCase(),count:0,state:"none"};this.selectedFacets=Ei(this.selectedFacets,"creator",a,!0)}else if(o===this.selectedTVNetwork){const a={key:r.toLowerCase(),count:0,state:"selected"};this.selectedFacets=Ei(this.selectedFacets,"creator",a)}}async showsDropdownChanged(){var t;const i=this.selectedTVShow,e=(t=this.tvShowsDropdown.selectedOption)==null?void 0:t.text;if(this.selectedTVShow=e??void 0,i!==void 0){const s={key:i,count:0,state:"none"};this.selectedFacets=Ei(this.selectedFacets,"program",s,!0)}if(this.selectedTVShow){const s={key:this.selectedTVShow,count:0,state:"selected"};this.selectedFacets=Ei(this.selectedFacets,"program",s)}}get tvDropdownFiltersTemplate(){if(this.searchType!==I.TV)return b;const{channelToNetwork:i,programToChannels:e}=this.dataSource.tvChannelMaps,t=i?[...new Set(i.values())]:[];let s=e?[...e.entries()]:[];i&&this.selectedTVNetwork&&(s=s.filter(([,c])=>Object.keys(c).some(h=>i.get(h)===this.selectedTVNetwork)));const r=S("Filter by Network"),o=S("Filter by Show"),a=s.map(([c])=>c),l=m`
    ...
    `}get facetsTemplate(){if(Vn.includes(this.profileElement))return b;if(this.facetLoadStrategy==="off")return m`
        <p class="facets-message">
          ${S("Facets are temporarily unavailable.")}
        </p>
      `;const i=this.isTVCollection||!this.withinCollection&&this.searchType===I.TV,e=i?Iu:p1,t=m`
      <collection-facets
        .collectionPagePath=${this.collectionPagePath}
    ...
    `}scrollThresholdReached(){!this.dataSource.endOfDataReached&&this.dataSource.queryInitialized&&(this.pagesToRender+=1,this.dataSource.fetchPage(this.pagesToRender))}fetchManageableSearchResults(){var t;const i=!this.dataSource.totalResults,e=!this.searchResultsLoading&&this.dataSource.totalResults>100;this.pageContext==="search"&&(i||e)&&(this.dataSource.resetPages(),this.dataSource.fetchPage(1,this.maxPagesToManage),(t=this.infiniteScroller)==null||t.reload())}static get styles(){return[yt,y`
      ...
      `]}};k([u({type:String})],A.prototype,"baseNavigationUrl",2);k([u({type:String})],A.prototype,"baseImageUrl",2);k([u({type:Object})],A.prototype,"searchService",2);k([u({type:Number})],A.prototype,"searchType",2);k([u({type:String})],A.prototype,"withinCollection",2);k([u({type:String})],A.prototype,"withinProfile",2);k([u({type:String})],A.prototype,"profileElement",2);k([u({type:String})],A.prototype,"baseQuery",2);k([u({type:Array})],A.prototype,"identifiers",2);k([u({type:String})],A.prototype,"displayMode",2);k([u({type:String})],A.prototype,"selectedSort",2);k([u({type:String})],A.prototype,"selectedTitleFilter",2);k([u({type:String})],A.prototype,"selectedCreatorFilter",2);k([u({type:String})],A.prototype,"sortDirection",2);k([u({type:String})],A.prototype,"defaultSortField",2);k([u({type:String})],A.prototype,"defaultSortDirection",2);k([u({type:Number})],A.prototype,"pageSize",2);k([u({type:Number})],A.prototype,"currentPage",2);k([u({type:String})],A.prototype,"minSelectedDate",2);k([u({type:String})],A.prototype,"maxSelectedDate",2);k([u({type:Object})],A.prototype,"selectedFacets",2);k([u({type:Object})],A.prototype,"internalFilters",2);k([u({type:Boolean})],A.prototype,"showSmartFacetBar",2);k([u({type:String})],A.prototype,"smartFacetBarLabel",2);k([u({type:Boolean})],A.prototype,"showHistogramDatePicker",2);k([u({type:Boolean})],A.prototype,"suppressPlaceholders",2);k([u({type:Boolean})],A.prototype,"suppressResultCount",2);k([u({type:Boolean})],A.prototype,"suppressResultTiles",2);k([u({type:Boolean})],A.prototype,"suppressURLQuery",2);k([u({type:Boolean})],A.prototype,"suppressURLSinParam",2);k([u({type:Boolean})],A.prototype,"suppressSortBar",2);k([u({type:Boolean})],A.prototype,"suppressDisplayModes",2);k([u({type:Boolean})],A.prototype,"suppressMediatypeFacets",2);k([u({type:String})],A.prototype,"facetLoadStrategy",2);k([u({type:Boolean,reflect:!0})],A.prototype,"facetPaneVisible",2);k([u({type:Boolean})],A.prototype,"clearResultsOnEmptyQuery",2);k([u({type:String})],A.prototype,"collectionPagePath",2);k([u({type:String,reflect:!0})],A.prototype,"searchContext",2);k([u({type:String})],A.prototype,"pageContext",2);k([u({type:Object})],A.prototype,"restorationStateHandler",2);k([u({type:Number})],A.prototype,"mobileBreakpoint",2);k([u({type:Boolean})],A.prototype,"loggedIn",2);k([u({type:Object})],A.prototype,"resizeObserver",2);k([u({type:Object})],A.prototype,"modalManager",2);k([u({type:Object})],A.prototype,"featureFeedbackService",2);k([u({type:Object})],A.prototype,"recaptchaManager",2);k([u({type:Boolean})],A.prototype,"isTVCollection",2);k([u({type:Boolean})],A.prototype,"isManageView",2);k([u({type:String})],A.prototype,"manageViewLabel",2);k([u({type:Boolean})],A.prototype,"enableSortOptionsSlot",2);k([u({type:Boolean,reflect:!0})],A.prototype,"showSmartResults",2);k([u({type:Number})],A.prototype,"maxPagesToManage",2);k([u({type:Object})],A.prototype,"dataSource",2);k([R()],A.prototype,"pagesToRender",2);k([R()],A.prototype,"searchResultsLoading",2);k([R()],A.prototype,"facetsLoading",2);k([R()],A.prototype,"totalResults",2);k([R()],A.prototype,"mobileView",2);k([R()],A.prototype,"tileBlurOverrideState",2);k([R()],A.prototype,"collapsibleFacetsVisible",2);k([R()],A.prototype,"contentWidth",2);k([R()],A.prototype,"placeholderType",2);k([R()],A.prototype,"selectedTVNetwork",2);k([R()],A.prototype,"selectedTVShow",2);k([R()],A.prototype,"tvMapsPopulated",2);k([R()],A.prototype,"tvMapsLoading",2);k([R()],A.prototype,"tvMapsErrored",2);k([ee("#content-container")],A.prototype,"contentContainer",2);k([ee("#left-column")],A.prototype,"leftColumn",2);k([ee("collection-facets")],A.prototype,"collectionFacets",2);k([ee("manage-bar")],A.prototype,"manageBar",2);k([ee("smart-facet-bar")],A.prototype,"smartFacetBar",2);k([ee("#tv-networks")],A.prototype,"tvNetworksDropdown",2);k([ee("#tv-shows")],A.prototype,"tvShowsDropdown",2);k([u({type:Object,attribute:!1})],A.prototype,"analyticsHandler",2);k([ee("infinite-scroller")],A.prototype,"infiniteScroller",2);A=k([N("collection-browser")],A);var n6=Object.defineProperty,l6=Object.getOwnPropertyDescriptor,$e=(i,e,t,s)=>{for(var r=s>1?void 0:s?l6(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&n6(e,t,r),r};let de=class extends H{constructor(){super(...arguments),this.searchService=this.initSearchServiceFromUrlParams(),this.resizeObserver=new Kp,this.toggleSlots=!1,this.cellWidth=18,this.cellHeight=29,this.rowGap=1.7,this.colGap=1.7,this.suppressFacets=!1,this.lazyLoadFacets=!1,this.loggedIn=!1,this.searchType=I.METADATA,this.analyticsManager=new W0,this.analyticsHandler={sendPing:this.sendAnalytics.bind(this),sendEvent:this.sendAnalytics.bind(this),sendEventNoSampling:this.sendAnalytics.bind(this)}}sendAnalytics(i){var e;console.log("Analytics Received ----",i),this.latestAction=i,(e=this.analyticsManager)==null||e.sendEvent(i)}initSearchServiceFromUrlParams(){const i=new URL(window.location.href).searchParams;return new us({includeCredentials:!1,baseUrl:i.get("search_base_url")??void 0,servicePath:i.get("search_service_path")??void 0,debuggingEnabled:!!i.get("debugging")})}searchPressed(i){i.preventDefault(),this.searchQuery=this.baseQueryField.value,this.collectionBrowser.searchType=this.searchType,this.goToCurrentPage()}collectionChanged(i){i.preventDefault(),this.withinCollection=this.baseCollectionField.value,this.collectionBrowser.withinCollection=this.withinCollection,this.goToCurrentPage()}goToCurrentPage(){const i=this.currentPage??1;i>1&&this.collectionBrowser.goToPage(i)}changePagePressed(i){i.preventDefault(),this.currentPage=this.pageNumberInput.valueAsNumber,this.collectionBrowser.goToPage(this.currentPage)}updated(i){i.has("currentPage")&&this.currentPage&&(this.pageNumberInput.value=this.currentPage.toString()),i.has("searchQuery")&&this.queryUpdated()}queryUpdated(){this.collectionBrowser.baseQuery=this.searchQuery}get getClass(){return new URLSearchParams(window.location.search).get("hide-dev-tools")?"hidden":""}render(){return m`
  ...
  `;$e([R()],de.prototype,"toggleSlots",2);$e([R()],de.prototype,"currentPage",2);$e([R()],de.prototype,"searchQuery",2);$e([R()],de.prototype,"withinCollection",2);$e([R()],de.prototype,"cellWidth",2);$e([R()],de.prototype,"cellHeight",2);$e([R()],de.prototype,"rowGap",2);$e([R()],de.prototype,"colGap",2);$e([R()],de.prototype,"suppressFacets",2);$e([R()],de.prototype,"lazyLoadFacets",2);$e([R()],de.prototype,"loggedIn",2);$e([R()],de.prototype,"searchType",2);$e([u({type:Object,reflect:!1})],de.prototype,"latestAction",2);$e([ee("#base-query-field")],de.prototype,"baseQueryField",2);$e([ee("#base-collection-field")],de.prototype,"baseCollectionField",2);$e([ee("#page-number-input")],de.prototype,"pageNumberInput",2);$e([ee("collection-browser")],de.prototype,"collectionBrowser",2);$e([ee("modal-manager")],de.prototype,"modalManager",2);de=$e([N("app-root")],de);
