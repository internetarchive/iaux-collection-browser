...
`;let Xt=class extends L{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1,this.isCompactTile=!1}render(){return h`<div class="icon-overlay ${this.getClass}">
      ${this.iconDisplay}
    ...
    `}};s([c({type:Boolean})],Xt.prototype,"loggedIn",void 0);s([c({type:Boolean})],Xt.prototype,"loginRequired",void 0);s([c({type:Boolean})],Xt.prototype,"isCompactTile",void 0);Xt=s([A("icon-overlay")],Xt);let Yt=class extends L{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1,this.iconRequired=!1}render(){return h`
    ...
    `}};s([c({type:Boolean})],Yt.prototype,"loggedIn",void 0);s([c({type:Boolean})],Yt.prototype,"loginRequired",void 0);s([c({type:Boolean})],Yt.prototype,"iconRequired",void 0);Yt=s([A("text-overlay")],Yt);let Oe=class extends L{constructor(){super(...arguments),this.isCompactTile=!1,this.isListTile=!1,this.loggedIn=!1,this.viewSize="desktop"}render(){var e;return!((e=this.model)===null||e===void 0)&&e.identifier?h`
    ...
    `}};s([c({type:String})],Oe.prototype,"baseImageUrl",void 0);s([c({type:Boolean})],Oe.prototype,"isCompactTile",void 0);s([c({type:Boolean})],Oe.prototype,"isListTile",void 0);s([c({type:Boolean})],Oe.prototype,"loggedIn",void 0);s([c({type:Object})],Oe.prototype,"model",void 0);s([c({type:String})],Oe.prototype,"viewSize",void 0);Oe=s([A("image-block")],Oe);let Kt=class extends L{constructor(){super(...arguments),this.showInfoButton=!1}render(){return h`
      <div class="container">
 ...
 */let bt=Ss;function zs(a,e){let t=1;return a>=1e9?t=1e9:a>=1e6?t=1e6:a>=1e3&&e==="short"&&(t=1e3),t}function Ms(a=0,e){const t=a/e,i=t<10;let o=0;return i?o=Math.round((t+Number.EPSILON)*10)/10:o=Math.round(t),o}function Ls(a,e,t,i){switch(e){case 1e9:return bt(t==="short"?yt`${a}B`:yt`${a} billion`);case 1e6:return bt(t==="short"?yt`${a}M`:yt`${a} million`);case 1e3:return bt(t==="short"?yt`${a}K`:yt`${a} thousand`);default:return new Intl.NumberFormat(i).format(a)}}function Wt(a,e="long",t="short",i="en-US"){const o=a!=null?a:-1;if(o<0)return"";const r=zs(o,e),n=Ms(o,r);return Ls(n,r,t,i)}let Ie=class extends L{render(){var e;const t=Wt(this.favCount,"short","short"),i=Wt(this.commentCount,"short","short"),o=this.mediatype==="account"?`${this.itemCount} uploads`:`${this.viewCount} ${(e=this.viewLabel)!==null&&e!==void 0?e:"all-time views"}`;return h`
    ...
    `}get doesSortedByDate(){var e;return["date","reviewdate","addeddate","publicdate"].includes((e=this.sortParam)===null||e===void 0?void 0:e.field)}get hasSnippets(){var e,t;return!!(!((t=(e=this.model)===null||e===void 0?void 0:e.snippets)===null||t===void 0)&&t.length)}infoButtonPressed(e){e.preventDefault();const t=new CustomEvent("infoButtonPressed",{detail:{x:e.clientX,y:e.clientY}});this.dispatchEvent(t)}static get styles(){const e=m`var(--tileBorderColor, #dddddd)`;return[_o,m`
      ...
      `]}};s([c({type:String})],st.prototype,"baseImageUrl",void 0);s([c({type:Boolean})],st.prototype,"loggedIn",void 0);s([c({type:Object})],st.prototype,"model",void 0);s([c({type:Object})],st.prototype,"sortParam",void 0);s([c({type:Boolean})],st.prototype,"showInfoButton",void 0);st=s([A("item-tile")],st);let Jt=class extends L{constructor(){super(...arguments),this.showInfoButton=!1}render(){return h`
      <div class="container">
        ${this.infoButtonTemplate}
        <div class="tile-details">
          <div class="item-info">
...
`+ne),$e&&(ne=Ae(ne,We," "),ne=Ae(ne,je," ")),G&&ai?G.createHTML(ne):ne},e.setConfig=function(C){Pi(C),qe=!0},e.clearConfig=function(){ft=null,qe=!1},e.isValidAttribute=function(C,p,w){ft||Pi({});var _=Ye(C),O=Ye(p);return Ro(_,O,w)},e.addHook=function(C,p){typeof p=="function"&&(pe[C]=pe[C]||[],Ut(pe[C],p))},e.removeHook=function(C){if(pe[C])return la(pe[C])},e.removeHooks=function(C){pe[C]&&(pe[C]=[])},e.removeAllHooks=function(){pe={}},e}var jt=Ka(),z;(function(a){a.relevance="relevance",a.alltimeview="alltimeview",a.weeklyview="weeklyview",a.title="title",a.date="date",a.datearchived="datearchived",a.datereviewed="datereviewed",a.dateadded="dateadded",a.creator="creator"})(z||(z={}));const et={relevance:"Relevance",alltimeview:"All-time views",weeklyview:"Weekly views",title:"Title",date:"Date published",datearchived:"Date archived",datereviewed:"Date reviewed",dateadded:"Date added",creator:"Creator"},ua={relevance:"desc",alltimeview:"desc",weeklyview:"desc",title:"asc",date:"desc",datearchived:"desc",datereviewed:"desc",dateadded:"desc",creator:"asc"},sn={relevance:null,alltimeview:"downloads",weeklyview:"week",title:"titleSorter",date:"date",datearchived:"publicdate",datereviewed:"reviewdate",dateadded:"addeddate",creator:"creatorSorter"};z.weeklyview,z.alltimeview,z.title,z.date,z.datearchived,z.datereviewed,z.dateadded,z.creator;const nn={week:"week",downloads:"downloads",titleSorter:"title",date:"date",publicdate:"publicdate",reviewdate:"reviewdate",addeddate:"addeddate",creatorSorter:"creator"},va={week:z.weeklyview,downloads:z.alltimeview,title:z.title,titleSorter:z.title,date:z.date,publicdate:z.datearchived,reviewdate:z.datereviewed,addeddate:z.dateadded,creator:z.creator,creatorSorter:z.creator},ln={title:"firstTitle",creator:"firstCreator"},ei=()=>({subject:{},lending:{},mediatype:{},language:{},creator:{},collection:{},year:{}}),dn=["mediatype","lending","year","subject","collection","creator","language"],$i={subject:"Subject",lending:"Availability",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"},cn={is_lendable:!0,is_borrowable:!1,available_to_borrow:!0,is_browsable:!1,available_to_browse:!1,is_readable:!0,available_to_waitlist:!1},ma={is_lendable:"Lending Library",available_to_borrow:"Borrow 14 Days",is_readable:"Always Available"},$o={deemphasize:!0,community:!0,stream_only:!0,samples_only:!0,test_collection:!0,printdisabled:!0,"openlibrary-ol":!0,nationalemergencylibrary:!0,china:!0,americana:!0,toronto:!0};function Za(a){switch(a){case"publicdate":return"Archived";case"reviewdate":return"Reviewed";case"addeddate":return"Added";default:return"Published"}}function Ja(a){return a?`Archivist since ${a.getFullYear()}`:""}let fe=class extends L{constructor(){super(...arguments),this.sortParam=null,this.collectionLinks=[],this.loggedIn=!1}render(){return h`
  ...
  `;po=s([A("ia-icon-label")],po);let uo=class extends L{constructor(){super(...arguments),this.numResults=0}render(){return h`
    ...
    `}};s([c({type:Number})],uo.prototype,"numResults",void 0);uo=s([A("alpha-bar-tooltip")],uo);let Ne=class extends L{constructor(){super(...arguments),this.selectedLetter=null,this.tooltipShown=!1,this.alphabet="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("")}get selectedUppercaseLetter(){var e;return(e=this.selectedLetter)===null||e===void 0?void 0:e.toUpperCase()}render(){return h`
      <div id="container">
        <ul>
...
`;let vo=class extends L{constructor(){super(...arguments),this.config=new er}render(){return h`
    ...
    `}static get styles(){const e=m`var(--modalLogoSize, 6.5rem)`,t=m`var(--processingImageSize, 7.5rem)`,i=m`var(--modalCornerRadius, 1rem)`,o=m`var(--modalBorder, 2px solid black)`,r=m`var(--modalBottomMargin, 2.5rem)`,n=m`var(--modalTopMargin, 5rem)`,l=m`var(--modalHeaderBottomPadding, 0.5em)`,d=m`var(--modalBottomPadding, 2rem)`,u=m`var(--modalScrollOffset, 5px)`,v=m`var(--modalTitleFontSize, 1.8rem)`,f=m`var(--modalSubtitleFontSize, 1.4rem)`,y=m`var(--modalHeadlineFontSize, 1.6rem)`,x=m`var(--modalMessageFontSize, 1.4rem)`,$=m`var(--modalTitleLineHeight, normal)`,E=m`var(--modalSubtitleLineHeight, normal)`,D=m`var(--modalHeadlineLineHeight, normal)`,N=m`var(--modalMessageLineHeight, normal)`;return m`
      .processing-logo {
        margin: auto;
        width: ${t};
        height: ${t};
    ...
    `}};s([c({type:Object})],vo.prototype,"config",void 0);vo=s([A("modal-template")],vo);function Nn(a,e,t){var i=t||{},o=i.noTrailing,r=o===void 0?!1:o,n=i.noLeading,l=n===void 0?!1:n,d=i.debounceMode,u=d===void 0?void 0:d,v,f=!1,y=0;function x(){v&&clearTimeout(v)}function $(D){var N=D||{},j=N.upcomingOnly,ee=j===void 0?!1:j;x(),f=!ee}function E(){for(var D=arguments.length,N=new Array(D),j=0;j<D;j++)N[j]=arguments[j];var ee=this,G=Date.now()-y;if(f)return;function he(){y=Date.now(),e.apply(ee,N)}function Z(){v=void 0}!l&&u&&!v&&he(),x(),u===void 0&&G>a?l?(y=Date.now(),r||(v=setTimeout(u?Z:he,a))):he():r!==!0&&(v=setTimeout(u?Z:he,u===void 0?a-G:a))}return E.cancel=$,E}var ot;(function(a){a.Open="open",a.Closed="closed"})(ot||(ot={}));class Un{constructor(e){this.windowResizeThrottler=Nn(100,this.updateModalContainerHeight).bind(this),this.modalManager=e}handleModeChange(e){switch(e){case ot.Open:this.startResizeListener(),this.stopDocumentScroll();break;case ot.Closed:this.stopResizeListener(),this.resumeDocumentScroll();break}}updateModalContainerHeight(){this.modalManager.style.setProperty("--containerHeight",`${window.innerHeight}px`)}stopDocumentScroll(){document.body.classList.add("modal-manager-open")}resumeDocumentScroll(){document.body.classList.remove("modal-manager-open")}startResizeListener(){window.addEventListener("resize",this.windowResizeThrottler)}stopResizeListener(){window.removeEventListener("resize",this.windowResizeThrottler)}}let kt=class extends L{constructor(){super(...arguments),this.mode=ot.Closed,this.hostBridge=new Un(this),this.closeOnBackdropClick=!0}render(){return h`
      <div class="container">
...
`;let Mt=class extends L{facetClicked(e,t,i){const o=e.target,{checked:r,name:n,value:l}=o;r?this.facetChecked(n,l,t,i):this.facetUnchecked(n,l)}facetChecked(e,t,i,o){const{selectedFacets:r}=this;let n;r?n=ve({},r):n=ei(),n[e][t]={state:o?"hidden":"selected",count:i},this.selectedFacets=n,this.dispatchSelectedFacetsChanged()}facetUnchecked(e,t){const{selectedFacets:i}=this;let o;i?o=ve({},i):o=ei(),delete o[e][t],this.selectedFacets=o,this.dispatchSelectedFacetsChanged()}dispatchSelectedFacetsChanged(){const e=new CustomEvent("selectedFacetsChanged",{detail:this.selectedFacets,bubbles:!0,composed:!0});this.dispatchEvent(e)}getFacetsTemplate(e){let t=e==null?void 0:e.buckets;return t=[...t.filter(i=>i.state==="selected").sort((i,o)=>i.count<o.count?1:-1),...t.filter(i=>i.state==="hidden").sort((i,o)=>i.count<o.count?1:-1),...t.filter(i=>i.state==="none")],h`
      <div class="facets-on-${this.renderOn}">
        ${Ga(t,i=>`${e.key}:${i.key}`,i=>{var o,r;const n=`${e.key}:${i.key}-show-only`,l=`${e.key}:${i.key}-negative`,d=e.key!=="collection"?h`${(o=i.displayText)!==null&&o!==void 0?o:i.key}`:h`<a href="/details/${i.key}">
                    <async-collection-name
                      ...
                      placeholder="-"
                    ></async-collection-name>
                  </a> `,u=i.state==="hidden",v=i.state==="selected",f=`${e.key}: ${(r=i.displayText)!==null&&r!==void 0?r:i.key}`,y=v?`Show all ${e.key}s`:`Only show ${f}`,x=`Hide ${f}`,$=`Unhide ${f}`,E=u?$:x;return h`
              <div class="facet-row">
    ...
    `}};s([c({type:String})],K.prototype,"facetKey",void 0);s([c({type:String})],K.prototype,"facetAggregationKey",void 0);s([c({type:String})],K.prototype,"query",void 0);s([c({type:Object})],K.prototype,"filterMap",void 0);s([c({type:Object})],K.prototype,"modalManager",void 0);s([c({type:Object})],K.prototype,"searchService",void 0);s([c({type:String})],K.prototype,"searchType",void 0);s([c({type:Object})],K.prototype,"collectionNameCache",void 0);s([c({type:Object})],K.prototype,"selectedFacets",void 0);s([c({type:String})],K.prototype,"sortedBy",void 0);s([c({type:Object,attribute:!1})],K.prototype,"analyticsHandler",void 0);s([k()],K.prototype,"aggregations",void 0);s([k()],K.prototype,"facetGroup",void 0);s([k()],K.prototype,"facetGroupTitle",void 0);s([k()],K.prototype,"pageNumber",void 0);s([k()],K.prototype,"facetsLoading",void 0);s([k()],K.prototype,"paginationSize",void 0);s([k()],K.prototype,"facetsType",void 0);K=s([A("more-facets-content")],K);let Sa=class extends L{render(){return h`
      <div id="row">
