...
`;let ni=class extends O{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1,this.isCompactTile=!1}render(){return c`<div class="icon-overlay ${this.getClass}">
    ...
    `}};l([h({type:Boolean})],ni.prototype,"loggedIn",void 0);l([h({type:Boolean})],ni.prototype,"loginRequired",void 0);l([h({type:Boolean})],ni.prototype,"isCompactTile",void 0);ni=l([L("icon-overlay")],ni);let di=class extends O{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1,this.iconRequired=!1}render(){return c`
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Ra(r,e,t){return r?e():t==null?void 0:t()}let vi=class extends O{constructor(){super(...arguments),this.label=P("Select items to remove"),this.showSelectAll=!1,this.showUnselectAll=!1}render(){return c`
