(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))s(r);new MutationObserver(r=>{for(const o of r)if(o.type==="childList")for(const a of o.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&s(a)}).observe(document,{childList:!0,subtree:!0});function t(r){const o={};return r.integrity&&(o.integrity=r.integrity),r.referrerPolicy&&(o.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?o.credentials="include":r.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function s(r){if(r.ep)return;r.ep=!0;const o=t(r);fetch(r.href,o)}})();class Yp{constructor(e){var t,s,r,o;this.ARCHIVE_ANALYTICS_VERSION=2,this.DEFAULT_SERVICE="ao_2",this.NO_SAMPLING_SERVICE="ao_no_sampling",this.DEFAULT_IMAGE_URL="https://athena.archive.org/0.gif",this.defaultService=(t=e==null?void 0:e.defaultService)!==null&&t!==void 0?t:this.DEFAULT_SERVICE,this.imageUrl=(s=e==null?void 0:e.imageUrl)!==null&&s!==void 0?s:this.DEFAULT_IMAGE_URL,this.imageContainer=(r=e==null?void 0:e.imageContainer)!==null&&r!==void 0?r:document.body,this.requireImagePing=(o=e==null?void 0:e.requireImagePing)!==null&&o!==void 0?o:!1}sendPing(e){const t=this.generateTrackingUrl(e).toString();if(this.requireImagePing){this.sendPingViaImage(t);return}const s=navigator.sendBeacon&&navigator.sendBeacon.bind(navigator);try{s(t)}catch{this.sendPingViaImage(t)}}sendEvent(e){const t=e.label&&e.label.trim().length>0?e.label:window.location.pathname,s={kind:"event",ec:e.category,ea:e.action,el:t,cache_bust:Math.random(),...e.eventConfiguration};this.sendPing(s)}sendEventNoSampling(e){const t=e.eventConfiguration||{};t.service=this.NO_SAMPLING_SERVICE;const s=e;s.eventConfiguration=t,this.sendEvent(s)}sendPingViaImage(e){const t=new Image(1,1);t.src=e,t.alt="",this.imageContainer.appendChild(t)}generateTrackingUrl(e){var t;const s=e??{};s.service=(t=s.service)!==null&&t!==void 0?t:this.defaultService;const r=new URL(this.imageUrl),o=Object.keys(s);return o.forEach(a=>{const l=s[a];r.searchParams.append(a,l)}),r.searchParams.append("version",`${this.ARCHIVE_ANALYTICS_VERSION}`),r.searchParams.append("count",`${o.length+2}`),r}}function p(i,e,t,s){var r=arguments.length,o=r<3?e:s===null?s=Object.getOwnPropertyDescriptor(e,t):s,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(i,e,t,s);else for(var l=i.length-1;l>=0;l--)(a=i[l])&&(o=(r<3?a(o):r>3?a(e,t,o):a(e,t))||o);return r>3&&o&&Object.defineProperty(e,t,o),o}function S(i){let e,t,s;return typeof i=="object"?(e=i.hashFunction,t=i.expiring,s=i.tags):e=i,(r,o,a)=>{if(a.value!=null)a.value=xc(a.value,e,t,s);else if(a.get!=null)a.get=xc(a.get,e,t,s);else throw"Only put a Memoize() decorator on a method or get accessor."}}const Ca=new Map;function xc(i,e,t=0,s){const r=Symbol("__memoized_map__");return function(...o){let a;this.hasOwnProperty(r)||Object.defineProperty(this,r,{configurable:!1,enumerable:!1,writable:!1,value:new Map});let l=this[r];if(Array.isArray(s))for(const n of s)Ca.has(n)?Ca.get(n).push(l):Ca.set(n,[l]);if(e||o.length>0||t>0){let n;e===!0?n=o.map(h=>h.toString()).join("!"):e?n=e.apply(this,o):n=o[0];const c=`${n}__timestamp`;let d=!1;if(t>0)if(!l.has(c))d=!0;else{let h=l.get(c);d=Date.now()-h>t}l.has(n)&&!d?a=l.get(n):(a=i.apply(this,o),l.set(n,a),t>0&&l.set(c,Date.now()))}else{const n=this;l.has(n)?a=l.get(n):(a=i.apply(this,o),l.set(n,a))}return a}}class Mn{parseValue(e){return typeof e=="string"&&(e==="false"||e==="0")?!1:!!e}}Mn.shared=new Mn;class Lt{parseValue(e){if(typeof e=="number")return e;if(typeof e=="boolean")return;const t=parseFloat(e);if(!Number.isNaN(t))return t}}Lt.shared=new Lt;class _o{parseValue(e){return Lt.shared.parseValue(e)}}_o.shared=new _o;class Cr{parseValue(e){return this.parseJSDate(e)||this.parseBracketDate(e)}parseBracketDate(e){if(typeof e!="string")return;const t=e.match(/\[([0-9]{4})\]/);if(!(!t||t.length<2))return this.parseJSDate(t[1])}parseJSDate(e){if(typeof e!="string")return;let t=e;t.match(/^[0-9]{4}-[0-9]{2}-[0-9]{2}\s{1}[0-9]{2}:[0-9]{2}:[0-9]{2}$/)&&(t=t.replace(" ","T"));const s=Date.parse(t);if(Number.isNaN(s))return;let r=new Date(t);return(t.match(/^[0-9]{4}$/)||t.match(/^[0-9]{4}-[0-9]{2}-[0-9]{2}$/))&&(r=new Date(r.getTime()+r.getTimezoneOffset()*1e3*60)),r}}Cr.shared=new Cr;class Co{parseValue(e){if(typeof e=="number")return e;if(typeof e=="boolean")return;const t=e.split(":");let s;return t.length===1?s=this.parseNumberFormat(t[0]):s=this.parseColonSeparatedFormat(t),s}parseNumberFormat(e){let t=parseFloat(e);return Number.isNaN(t)&&(t=void 0),t}parseColonSeparatedFormat(e){let t=!1;const s=e.map((r,o)=>{const a=parseFloat(r);if(Number.isNaN(a))return t=!0,0;const n=60**(e.length-1-o);return a*Math.floor(n)}).reduce((r,o)=>r+o,0);return t?void 0:s}}Co.shared=new Co;class Pn{parseValue(e){if(typeof e=="string")return e}}Pn.shared=new Pn;class Qp{constructor(e,t){this.separators=[";",","],this.parser=e,t&&t.separators&&(this.separators=t.separators)}parseValue(e){const t=String(e);let s=[];for(const r of this.separators)if(s=t.split(r),s.length>1)break;return this.parseListValues(s)}parseListValues(e){const s=e.map(o=>o.trim()).map(o=>this.parser.parseValue(o)),r=[];return s.forEach(o=>{o!==void 0&&r.push(o)}),r}}class On{parseValue(e){if(typeof e=="string")return e}}On.shared=new On;class To{parseValue(e){return String(e)}}To.shared=new To;class Fs{get name(){return this.rawValue.name}get source(){return this.rawValue.source}get btih(){return this.rawValue.btih}get md5(){return this.rawValue.md5}get format(){return this.rawValue.format}get mtime(){if(this.rawValue.mtime==null)return;const e=Lt.shared.parseValue(this.rawValue.mtime);if(e)return new Date(e*1e3)}get crc32(){return this.rawValue.crc32}get sha1(){return this.rawValue.sha1}get original(){return this.rawValue.original}get size(){return this.rawValue.size!=null?_o.shared.parseValue(this.rawValue.size):void 0}get title(){return this.rawValue.title}get length(){return this.rawValue.length!=null?Co.shared.parseValue(this.rawValue.length):void 0}get height(){return this.rawValue.height!=null?Lt.shared.parseValue(this.rawValue.height):void 0}get width(){return this.rawValue.width!=null?Lt.shared.parseValue(this.rawValue.width):void 0}get track(){return this.rawValue.track!=null?Lt.shared.parseValue(this.rawValue.track):void 0}get external_identifier(){return this.rawValue.external_identifier}get creator(){return this.rawValue.creator}get album(){return this.rawValue.album}constructor(e={}){this.rawValue=e}}p([S()],Fs.prototype,"mtime",null);p([S()],Fs.prototype,"size",null);p([S()],Fs.prototype,"length",null);p([S()],Fs.prototype,"height",null);p([S()],Fs.prototype,"width",null);p([S()],Fs.prototype,"track",null);class bt{get values(){return this.parseRawValue()}get value(){return this.values[0]}constructor(e,t){this.parser=e,this.rawValue=t}parseRawValue(){const e=Array.isArray(this.rawValue)?this.rawValue:[this.rawValue],t=[];return e.forEach(s=>{const r=this.parser.parseValue(s);Array.isArray(r)?t.push(...r):r!==void 0&&t.push(r)}),t}}p([S()],bt.prototype,"values",null);p([S()],bt.prototype,"value",null);class Oi extends bt{constructor(e){super(Mn.shared,e)}}class Je extends bt{constructor(e){super(Cr.shared,e)}}class Ta extends bt{constructor(e){super(Co.shared,e)}}class Oe extends bt{constructor(e){super(Lt.shared,e)}}class F extends bt{constructor(e){super(To.shared,e)}}class Kp extends bt{constructor(e){super(On.shared,e)}}class Sc extends bt{constructor(e){super(_o.shared,e)}}class Ih extends bt{constructor(e){super(Pn.shared,e)}}class Xp extends bt{constructor(e,t){super(t,e)}}class Zp extends Xp{constructor(e){const t=new Qp(To.shared);super(e,t)}}class M{get identifier(){return this.rawMetadata.identifier}get addeddate(){return this.rawMetadata.addeddate!=null?new Je(this.rawMetadata.addeddate):void 0}get audio_codec(){return this.rawMetadata.audio_codec!=null?new F(this.rawMetadata.audio_codec):void 0}get audio_sample_rate(){return this.rawMetadata.audio_sample_rate!=null?new Oe(this.rawMetadata.audio_sample_rate):void 0}get avg_rating(){return this.rawMetadata.avg_rating!=null?new Oe(this.rawMetadata.avg_rating):void 0}get collection(){return this.rawMetadata.collection!=null?new F(this.rawMetadata.collection):void 0}get collections_raw(){return this.rawMetadata.collections_raw!=null?new F(this.rawMetadata.collections_raw):void 0}get collection_size(){return this.rawMetadata.collection_size!=null?new Sc(this.rawMetadata.collection_size):void 0}get contact(){return this.rawMetadata.contact!=null?new F(this.rawMetadata.contact):void 0}get contributor(){return this.rawMetadata.contributor!=null?new F(this.rawMetadata.contributor):void 0}get coverage(){return this.rawMetadata.coverage!=null?new F(this.rawMetadata.coverage):void 0}get creator(){return this.rawMetadata.creator!=null?new F(this.rawMetadata.creator):void 0}get creator_alt_script(){return this.rawMetadata["creator-alt-script"]!=null?new F(this.rawMetadata["creator-alt-script"]):void 0}get credits(){return this.rawMetadata.credits!=null?new F(this.rawMetadata.credits):void 0}get collection_layout(){return this.rawMetadata.collection_layout!=null?new F(this.rawMetadata.collection_layout):void 0}get date(){return this.rawMetadata.date!=null?new Je(this.rawMetadata.date):void 0}get description(){return this.rawMetadata.description!=null?new F(this.rawMetadata.description):void 0}get downloads(){return this.rawMetadata.downloads!=null?new Oe(this.rawMetadata.downloads):void 0}get duration(){return this.rawMetadata.duration!=null?new Ta(this.rawMetadata.duration):void 0}get external_identifier(){return this.rawMetadata["external-identifier"]!=null?new F(this.rawMetadata["external-identifier"]):void 0}get external_link(){return this.rawMetadata["external-link"]!=null?new F(this.rawMetadata["external-link"]):void 0}get files_count(){return this.rawMetadata.files_count!=null?new Oe(this.rawMetadata.files_count):void 0}get indexdate(){return this.rawMetadata.indexdate!=null?new Je(this.rawMetadata.indexdate):void 0}get isbn(){return this.rawMetadata.isbn!=null?new F(this.rawMetadata.isbn):void 0}get issue(){return this.rawMetadata.issue!=null?new F(this.rawMetadata.issue):void 0}get item_count(){return this.rawMetadata.item_count!=null?new Oe(this.rawMetadata.item_count):void 0}get item_size(){return this.rawMetadata.item_size!=null?new Sc(this.rawMetadata.item_size):void 0}get language(){return this.rawMetadata.language!=null?new F(this.rawMetadata.language):void 0}get length(){return this.rawMetadata.length!=null?new Ta(this.rawMetadata.length):void 0}get licenseurl(){return this.rawMetadata.licenseurl!=null?new F(this.rawMetadata.licenseurl):void 0}get lineage(){return this.rawMetadata.lineage!=null?new F(this.rawMetadata.lineage):void 0}get month(){return this.rawMetadata.month!=null?new Oe(this.rawMetadata.month):void 0}get mediatype(){return this.rawMetadata.mediatype!=null?new Ih(this.rawMetadata.mediatype):void 0}get noindex(){return this.rawMetadata.noindex!=null?new Oi(this.rawMetadata.noindex):void 0}get notes(){return this.rawMetadata.notes!=null?new F(this.rawMetadata.notes):void 0}get num_favorites(){return this.rawMetadata.num_favorites!=null?new Oe(this.rawMetadata.num_favorites):void 0}get num_reviews(){return this.rawMetadata.num_reviews!=null?new Oe(this.rawMetadata.num_reviews):void 0}get openlibrary_edition(){return this.rawMetadata.openlibrary_edition!=null?new F(this.rawMetadata.openlibrary_edition):void 0}get openlibrary_work(){return this.rawMetadata.openlibrary_work!=null?new F(this.rawMetadata.openlibrary_work):void 0}get page_progression(){return this.rawMetadata.page_progression!=null?new Kp(this.rawMetadata.page_progression):void 0}get paginated(){return this.rawMetadata.paginated!=null?new Oi(this.rawMetadata.paginated):void 0}get partner(){return this.rawMetadata.partner!=null?new F(this.rawMetadata.partner):void 0}get post_text(){return this.rawMetadata.post_text!=null?new F(this.rawMetadata.post_text):void 0}get ppi(){return this.rawMetadata.ppi!=null?new Oe(this.rawMetadata.ppi):void 0}get publicdate(){return this.rawMetadata.publicdate!=null?new Je(this.rawMetadata.publicdate):void 0}get publisher(){return this.rawMetadata.publisher!=null?new F(this.rawMetadata.publisher):void 0}get reviewdate(){return this.rawMetadata.reviewdate!=null?new Je(this.rawMetadata.reviewdate):void 0}get rights(){return this.rawMetadata.rights!=null?new F(this.rawMetadata.rights):void 0}get rights_holder(){var e;const t=(e=this.rawMetadata["rights-holder"])!==null&&e!==void 0?e:this.rawMetadata.rights_holder;return t!=null?new F(t):void 0}get runtime(){return this.rawMetadata.runtime!=null?new Ta(this.rawMetadata.runtime):void 0}get scanner(){return this.rawMetadata.scanner!=null?new F(this.rawMetadata.scanner):void 0}get segments(){return this.rawMetadata.segments!=null?new F(this.rawMetadata.segments):void 0}get shotlist(){return this.rawMetadata.shotlist!=null?new F(this.rawMetadata.shotlist):void 0}get source(){return this.rawMetadata.source!=null?new F(this.rawMetadata.source):void 0}get sponsor(){return this.rawMetadata.sponsor!=null?new F(this.rawMetadata.sponsor):void 0}get start_localtime(){return this.rawMetadata.start_localtime!=null?new Je(this.rawMetadata.start_localtime):void 0}get start_time(){return this.rawMetadata.start_time!=null?new Je(this.rawMetadata.start_time):void 0}get stop_time(){return this.rawMetadata.stop_time!=null?new Je(this.rawMetadata.stop_time):void 0}get subject(){return this.rawMetadata.subject!=null?new Zp(this.rawMetadata.subject):void 0}get taper(){return this.rawMetadata.taper!=null?new F(this.rawMetadata.taper):void 0}get title(){return this.rawMetadata.title!=null?new F(this.rawMetadata.title):void 0}get title_alt_script(){return this.rawMetadata["title-alt-script"]!=null?new F(this.rawMetadata["title-alt-script"]):void 0}get transferer(){return this.rawMetadata.transferer!=null?new F(this.rawMetadata.transferer):void 0}get track(){return this.rawMetadata.track!=null?new Oe(this.rawMetadata.track):void 0}get type(){return this.rawMetadata.type!=null?new F(this.rawMetadata.type):void 0}get uploader(){return this.rawMetadata.uploader!=null?new F(this.rawMetadata.uploader):void 0}get utc_offset(){return this.rawMetadata.utc_offset!=null?new Oe(this.rawMetadata.utc_offset):void 0}get venue(){return this.rawMetadata.venue!=null?new F(this.rawMetadata.venue):void 0}get volume(){return this.rawMetadata.volume!=null?new F(this.rawMetadata.volume):void 0}get week(){return this.rawMetadata.week!=null?new Oe(this.rawMetadata.week):void 0}get year(){return this.rawMetadata.year!=null?new Oe(this.rawMetadata.year):void 0}constructor(e={}){this.rawMetadata=e}}p([S()],M.prototype,"addeddate",null);p([S()],M.prototype,"audio_codec",null);p([S()],M.prototype,"audio_sample_rate",null);p([S()],M.prototype,"avg_rating",null);p([S()],M.prototype,"collection",null);p([S()],M.prototype,"collections_raw",null);p([S()],M.prototype,"collection_size",null);p([S()],M.prototype,"contact",null);p([S()],M.prototype,"contributor",null);p([S()],M.prototype,"coverage",null);p([S()],M.prototype,"creator",null);p([S()],M.prototype,"creator_alt_script",null);p([S()],M.prototype,"credits",null);p([S()],M.prototype,"collection_layout",null);p([S()],M.prototype,"date",null);p([S()],M.prototype,"description",null);p([S()],M.prototype,"downloads",null);p([S()],M.prototype,"duration",null);p([S()],M.prototype,"external_identifier",null);p([S()],M.prototype,"external_link",null);p([S()],M.prototype,"files_count",null);p([S()],M.prototype,"indexdate",null);p([S()],M.prototype,"isbn",null);p([S()],M.prototype,"issue",null);p([S()],M.prototype,"item_count",null);p([S()],M.prototype,"item_size",null);p([S()],M.prototype,"language",null);p([S()],M.prototype,"length",null);p([S()],M.prototype,"licenseurl",null);p([S()],M.prototype,"lineage",null);p([S()],M.prototype,"month",null);p([S()],M.prototype,"mediatype",null);p([S()],M.prototype,"noindex",null);p([S()],M.prototype,"notes",null);p([S()],M.prototype,"num_favorites",null);p([S()],M.prototype,"num_reviews",null);p([S()],M.prototype,"openlibrary_edition",null);p([S()],M.prototype,"openlibrary_work",null);p([S()],M.prototype,"page_progression",null);p([S()],M.prototype,"paginated",null);p([S()],M.prototype,"partner",null);p([S()],M.prototype,"post_text",null);p([S()],M.prototype,"ppi",null);p([S()],M.prototype,"publicdate",null);p([S()],M.prototype,"publisher",null);p([S()],M.prototype,"reviewdate",null);p([S()],M.prototype,"rights",null);p([S()],M.prototype,"rights_holder",null);p([S()],M.prototype,"runtime",null);p([S()],M.prototype,"scanner",null);p([S()],M.prototype,"segments",null);p([S()],M.prototype,"shotlist",null);p([S()],M.prototype,"source",null);p([S()],M.prototype,"sponsor",null);p([S()],M.prototype,"start_localtime",null);p([S()],M.prototype,"start_time",null);p([S()],M.prototype,"stop_time",null);p([S()],M.prototype,"subject",null);p([S()],M.prototype,"taper",null);p([S()],M.prototype,"title",null);p([S()],M.prototype,"title_alt_script",null);p([S()],M.prototype,"transferer",null);p([S()],M.prototype,"track",null);p([S()],M.prototype,"type",null);p([S()],M.prototype,"uploader",null);p([S()],M.prototype,"utc_offset",null);p([S()],M.prototype,"venue",null);p([S()],M.prototype,"volume",null);p([S()],M.prototype,"week",null);p([S()],M.prototype,"year",null);class Xo{get reviewbody(){return this.rawValue.reviewbody}get reviewtitle(){return this.rawValue.reviewtitle}get reviewer(){return this.rawValue.reviewer}get reviewer_itemname(){return this.rawValue.reviewer_itemname}get reviewdate(){return this.rawValue.reviewdate!=null?Cr.shared.parseValue(this.rawValue.reviewdate):void 0}get createdate(){return this.rawValue.createdate!=null?Cr.shared.parseValue(this.rawValue.createdate):void 0}get stars(){return this.rawValue.stars!=null?Lt.shared.parseValue(this.rawValue.stars):void 0}constructor(e={}){this.rawValue=e}}p([S()],Xo.prototype,"reviewdate",null);p([S()],Xo.prototype,"createdate",null);p([S()],Xo.prototype,"stars",null);class fl extends Xo{get reviewer_account_status(){var e;return(e=this.account_status)===null||e===void 0?void 0:e.status}get reviewer_account_status_reason(){var e;return(e=this.account_status)===null||e===void 0?void 0:e.reason}get __href__(){return this.rawValue.__href__}get account_status(){const e=this.rawValue.reviewer_account_status;if(!e)return;let t="unknown",s;e.startsWith("ok")&&(t="ok"),e.startsWith("locked")&&(t="locked");const r=e.split("__");return r.length>1&&(s=r.slice(1).join("__")),{status:t,reason:s}}}p([S()],fl.prototype,"account_status",null);const Jp=["loans","waitlist","loan_history"];function e0(i){const e=i.slice(0,4),t=i.slice(4,6),s=i.slice(6,8),r=i.slice(8,10),o=i.slice(10,12),a=i.slice(12,14);return`${e}-${t}-${s}T${r}:${o}:${a}Z`}function t0(i){var e;const t=[];for(const s of i){if(!(!((e=s.captures)===null||e===void 0)&&e.length))continue;const r=encodeURIComponent(s.url),o=`https://web.archive.org/web/${s.captures[0]}/${r}`;t.push({hit_type:"web_archive",fields:{url:s.url,capture_dates:s.captures.map(a=>e0(a)),__href__:o}})}return t}class Se extends M{get created_on(){return this.rawMetadata.created_on!=null?new Je(this.rawMetadata.created_on):void 0}get file_creation_mtime(){return this.rawMetadata.file_creation_mtime!=null?new Oe(this.rawMetadata.file_creation_mtime):void 0}get filename(){return this.rawMetadata.filename!=null?new F(this.rawMetadata.filename):void 0}get file_basename(){return this.rawMetadata.file_basename!=null?new F(this.rawMetadata.file_basename):void 0}get result_in_subfile(){return this.rawMetadata.result_in_subfile!=null?new Oi(this.rawMetadata.result_in_subfile):void 0}get query(){return this.rawMetadata.query!=null?new F(this.rawMetadata.query):void 0}get date_favorited(){return this.rawMetadata.date_favorited!=null?new Je(this.rawMetadata.date_favorited):void 0}get updated_on(){return this.rawMetadata.updated_on!=null?new Je(this.rawMetadata.updated_on):void 0}get ad_id(){return this.rawMetadata.ad_id!=null?new F(this.rawMetadata.ad_id):void 0}get factcheck(){return this.rawMetadata.factcheck!=null?new F(this.rawMetadata.factcheck):void 0}get is_clip(){return this.rawMetadata.clip!=null?new Oi(this.rawMetadata.clip):void 0}get num_clips(){return this.rawMetadata.nclips!=null?new Oe(this.rawMetadata.nclips):void 0}get __href__(){return this.rawMetadata.__href__!=null?new F(this.rawMetadata.__href__):void 0}get __img__(){return this.rawMetadata.__img__!=null?new F(this.rawMetadata.__img__):void 0}}p([S()],Se.prototype,"created_on",null);p([S()],Se.prototype,"file_creation_mtime",null);p([S()],Se.prototype,"filename",null);p([S()],Se.prototype,"file_basename",null);p([S()],Se.prototype,"result_in_subfile",null);p([S()],Se.prototype,"query",null);p([S()],Se.prototype,"date_favorited",null);p([S()],Se.prototype,"updated_on",null);p([S()],Se.prototype,"ad_id",null);p([S()],Se.prototype,"factcheck",null);p([S()],Se.prototype,"is_clip",null);p([S()],Se.prototype,"num_clips",null);p([S()],Se.prototype,"__href__",null);p([S()],Se.prototype,"__img__",null);class ft{constructor(e){var t;this.rawMetadata=e,this.fields=new Se((t=e.fields)!==null&&t!==void 0?t:{})}get identifier(){return this.fields.identifier}get addeddate(){return this.fields.addeddate}get avg_rating(){return this.fields.avg_rating}get collection(){return this.fields.collection}get collection_files_count(){var e;return((e=this.rawMetadata.fields)===null||e===void 0?void 0:e.collection_files_count)!=null?new Oe(this.rawMetadata.fields.collection_files_count):void 0}get collection_size(){return this.fields.collection_size}get creator(){return this.fields.creator}get date(){return this.fields.date}get description(){return this.fields.description}get downloads(){return this.fields.downloads}get files_count(){return this.fields.files_count}get genre(){var e;return((e=this.rawMetadata.fields)===null||e===void 0?void 0:e.genre)!=null?new F(this.rawMetadata.fields.genre):void 0}get indexflag(){var e;return((e=this.rawMetadata.fields)===null||e===void 0?void 0:e.indexflag)!=null?new F(this.rawMetadata.fields.indexflag):void 0}get issue(){return this.fields.issue}get item_count(){return this.fields.item_count}get item_size(){return this.fields.item_size}get language(){return this.fields.language}get lending___available_to_borrow(){var e;return((e=this.rawMetadata.fields)===null||e===void 0?void 0:e.lending___available_to_borrow)!=null?new Oi(this.rawMetadata.fields.lending___available_to_borrow):void 0}get lending___available_to_browse(){var e;return((e=this.rawMetadata.fields)===null||e===void 0?void 0:e.lending___available_to_browse)!=null?new Oi(this.rawMetadata.fields.lending___available_to_browse):void 0}get lending___available_to_waitlist(){var e;return((e=this.rawMetadata.fields)===null||e===void 0?void 0:e.lending___available_to_waitlist)!=null?new Oi(this.rawMetadata.fields.lending___available_to_waitlist):void 0}get lending___status(){var e;return((e=this.rawMetadata.fields)===null||e===void 0?void 0:e.lending___status)!=null?new F(this.rawMetadata.fields.lending___status):void 0}get licenseurl(){var e;return((e=this.rawMetadata.fields)===null||e===void 0?void 0:e.licenseurl)!=null?new F(this.rawMetadata.fields.licenseurl):void 0}get mediatype(){return this.fields.mediatype}get month(){return this.fields.month}get noindex(){return this.fields.noindex}get num_favorites(){return this.fields.num_favorites}get num_reviews(){return this.fields.num_reviews}get publicdate(){return this.fields.publicdate}get reviewdate(){return this.fields.reviewdate}get review(){const e=this.rawMetadata.review;return e?new fl(e):void 0}get source(){return this.fields.source}get subject(){return this.fields.subject}get title(){return this.fields.title}get type(){return this.fields.type}get volume(){return this.fields.volume}get week(){return this.fields.week}get year(){return this.fields.year}}p([S()],ft.prototype,"collection_files_count",null);p([S()],ft.prototype,"genre",null);p([S()],ft.prototype,"indexflag",null);p([S()],ft.prototype,"lending___available_to_borrow",null);p([S()],ft.prototype,"lending___available_to_browse",null);p([S()],ft.prototype,"lending___available_to_waitlist",null);p([S()],ft.prototype,"lending___status",null);p([S()],ft.prototype,"licenseurl",null);p([S()],ft.prototype,"review",null);class ml{constructor(e){var t;this.rawMetadata=e,this.fields=new Se((t=e.fields)!==null&&t!==void 0?t:{})}get identifier(){return this.fields.identifier}get highlight(){var e;return!((e=this.rawMetadata.highlight)===null||e===void 0)&&e.text?new F(this.rawMetadata.highlight.text):void 0}get addeddate(){return this.fields.addeddate}get avg_rating(){return this.fields.avg_rating}get collection(){return this.fields.collection}get created_on(){return this.fields.created_on}get creator(){return this.fields.creator}get date(){return this.fields.date}get description(){return this.fields.description}get downloads(){return this.fields.downloads}get filename(){return this.fields.filename}get file_basename(){return this.fields.file_basename}get file_creation_mtime(){return this.fields.file_creation_mtime}get issue(){return this.fields.issue}get mediatype(){return this.fields.mediatype}get page_num(){var e;return((e=this.rawMetadata.fields)===null||e===void 0?void 0:e.page_num)!=null?new Oe(this.rawMetadata.fields.page_num):void 0}get publicdate(){return this.fields.publicdate}get result_in_subfile(){return this.fields.result_in_subfile}get reviewdate(){return this.fields.reviewdate}get source(){return this.fields.source}get subject(){return this.fields.subject}get title(){return this.fields.title}get updated_on(){return this.fields.updated_on}get year(){return this.fields.year}get __href__(){return this.fields.__href__}}p([S()],ml.prototype,"highlight",null);p([S()],ml.prototype,"page_num",null);var j;(function(i){i[i.COUNT=0]="COUNT",i[i.ALPHABETICAL=1]="ALPHABETICAL",i[i.NUMERIC=2]="NUMERIC"})(j||(j={}));class Nh{constructor(e){this.buckets=e.buckets,this.first_bucket_key=e.first_bucket_key,this.last_bucket_key=e.last_bucket_key,this.number_buckets=e.number_buckets,this.interval=e.interval,this.first_bucket_year=e.first_bucket_year,this.first_bucket_month=e.first_bucket_month,this.last_bucket_year=e.last_bucket_year,this.last_bucket_month=e.last_bucket_month,this.interval_in_months=e.interval_in_months}getSortedBuckets(e){const t=[...this.buckets];if(this.isRawNumberBuckets(t))return t;const s=new Intl.Collator;switch(e){case j.ALPHABETICAL:return t.sort((r,o)=>s.compare(r.key.toString(),o.key.toString()));case j.NUMERIC:return t.sort((r,o)=>Number(o.key)-Number(r.key));case j.COUNT:default:return t}}isRawNumberBuckets(e){return typeof e[0]=="number"}}p([S()],Nh.prototype,"getSortedBuckets",null);class i0{constructor(e){var t;this.rawMetadata=e,this.fields=new Se((t=e.fields)!==null&&t!==void 0?t:{})}get identifier(){var e;return(e=this.fields.query)===null||e===void 0?void 0:e.value}get title(){return this.fields.title}get query(){return this.fields.query}get date_favorited(){return this.fields.date_favorited}get __href__(){return this.fields.__href__}}class gl{constructor(e){var t;this.rawMetadata=e,this.fields=new Se((t=e.fields)!==null&&t!==void 0?t:{})}get identifier(){var e;return(e=this.rawMetadata.fields)===null||e===void 0?void 0:e.url}get mediatype(){return new Ih("web")}get title(){var e,t;return!((e=this.rawMetadata.fields)===null||e===void 0)&&e.url?new F((t=this.rawMetadata.fields)===null||t===void 0?void 0:t.url):void 0}get capture_dates(){var e,t;return!((e=this.rawMetadata.fields)===null||e===void 0)&&e.capture_dates?new Je((t=this.rawMetadata.fields)===null||t===void 0?void 0:t.capture_dates):void 0}get __href__(){return this.fields.__href__}}p([S()],gl.prototype,"title",null);p([S()],gl.prototype,"capture_dates",null);class vl{constructor(e){var t;this.rawMetadata=e,this.fields=new Se((t=e.fields)!==null&&t!==void 0?t:{})}get identifier(){return this.fields.identifier}get highlight(){var e;return!((e=this.rawMetadata.highlight)===null||e===void 0)&&e.text?new F(this.rawMetadata.highlight.text):void 0}get addeddate(){return this.fields.addeddate}get ad_id(){return this.fields.ad_id}get avg_rating(){return this.fields.avg_rating}get collection(){return this.fields.collection}get created_on(){return this.fields.created_on}get creator(){return this.fields.creator}get date(){return this.fields.date}get description(){return this.fields.description}get downloads(){return this.fields.downloads}get factcheck(){return this.fields.factcheck}get filename(){return this.fields.filename}get file_basename(){return this.fields.file_basename}get file_creation_mtime(){return this.fields.file_creation_mtime}get files_count(){return this.fields.files_count}get is_clip(){return this.fields.is_clip}get issue(){return this.fields.issue}get item_count(){return this.fields.item_count}get item_size(){return this.fields.item_size}get language(){return this.fields.language}get mediatype(){return this.fields.mediatype}get num_clips(){return this.fields.num_clips}get num_favorites(){return this.fields.num_favorites}get publicdate(){return this.fields.publicdate}get result_in_subfile(){return this.fields.result_in_subfile}get reviewdate(){return this.fields.reviewdate}get source(){return this.fields.source}get subject(){return this.fields.subject}get title(){return this.fields.title}get updated_on(){return this.fields.updated_on}get week(){return this.fields.week}get year(){return this.fields.year}get start(){var e;return((e=this.rawMetadata.fields)===null||e===void 0?void 0:e.start)!=null?new F(this.rawMetadata.fields.start):void 0}get __href__(){return this.fields.__href__}get __img__(){return this.fields.__img__}}p([S()],vl.prototype,"highlight",null);p([S()],vl.prototype,"start",null);class bl{constructor(e){this.rawResponse=e}get item_size(){return this.rawResponse.item_size}get files_count(){return this.rawResponse.files_count}get month(){return this.rawResponse.month}get week(){return this.rawResponse.week}get downloads(){return this.rawResponse.downloads}get num_favorites(){return this.rawResponse.num_favorites}get title_message(){return this.rawResponse.title_message}get primary_collection(){return this.rawResponse.primary_collection}get thumbnail_url(){return this.rawResponse.thumbnail_url}get num_reviews(){return this.rawResponse.num_reviews}get uploader_details(){return this.rawResponse.uploader_details}get public_metadata(){if(this.rawResponse.public_metadata)return new M(this.rawResponse.public_metadata)}get part_of(){return this.rawResponse.part_of}get speech_vs_music_asr_metadata(){return this.rawResponse.speech_vs_music_asr_metadata}get reviews_metadata(){var e;return((e=this.rawResponse.reviews_metadata)!==null&&e!==void 0?e:[]).map(s=>new fl(s))}}p([S()],bl.prototype,"public_metadata",null);p([S()],bl.prototype,"reviews_metadata",null);class yl{constructor(e,t){var s,r,o,a,l,n,c,d,h,f,g,y,$,A,O;this.extraInfo=null,this.schema=t,this.schemaHitType=t==null?void 0:t.hit_type;let P;e!=null&&e.page_elements&&(this.pageElements=e.page_elements,P=Object.values(this.pageElements)[0]);let D=(s=e==null?void 0:e.hits)===null||s===void 0?void 0:s.hits;this.totalResults=(o=(r=e==null?void 0:e.hits)===null||r===void 0?void 0:r.total)!==null&&o!==void 0?o:0,this.returnedCount=(l=(a=e==null?void 0:e.hits)===null||a===void 0?void 0:a.returned)!==null&&l!==void 0?l:0,!(D!=null&&D.length)&&(!((n=this.pageElements)===null||n===void 0)&&n.service___fts)?(this.totalResults=0,this.returnedCount=0,this.handleFederatedPageElements()):!(D!=null&&D.length)&&(!((c=P==null?void 0:P.hits)===null||c===void 0)&&c.hits)?(D=P.hits.hits,this.totalResults=(d=P.hits.total)!==null&&d!==void 0?d:0,this.returnedCount=(h=P.hits.returned)!==null&&h!==void 0?h:0):!((f=this.pageElements)===null||f===void 0)&&f.lending?D=this.handleLendingPageElement():!((g=this.pageElements)===null||g===void 0)&&g.web_archives&&(D=this.handleWebArchivesPageElement()),this.results=this.formatHits(D);let z=e==null?void 0:e.aggregations;!(this.aggregations&&Object.keys(this.aggregations).length>0)&&(P!=null&&P.aggregations)&&(z=P.aggregations),z&&this.buildAggregations(z),e!=null&&e.collection_titles&&(this.collectionTitles=(y=e.collection_titles)!==null&&y!==void 0?y:{}),e!=null&&e.tv_channel_aliases&&(this.tvChannelAliases=($=e.tv_channel_aliases)!==null&&$!==void 0?$:{}),e!=null&&e.collection_extra_info&&(this.collectionExtraInfo=(A=e.collection_extra_info)!==null&&A!==void 0?A:null),e!=null&&e.account_extra_info&&(this.accountExtraInfo=(O=e.account_extra_info)!==null&&O!==void 0?O:null),e!=null&&e.extra_info&&(this.extraInfo=new bl(e.extra_info))}formatHits(e){var t;return(t=e==null?void 0:e.map(s=>{var r;return yl.createResult((r=s.hit_type)!==null&&r!==void 0?r:this.schemaHitType,s)}))!==null&&t!==void 0?t:[]}buildAggregations(e){this.aggregations=Object.entries(e).reduce((t,[s,r])=>(t[s]=new Nh(r),t),{})}handleLendingPageElement(){var e,t;const s=(e=this.pageElements)===null||e===void 0?void 0:e.lending,r=(t=s.loans)!==null&&t!==void 0?t:[];this.totalResults=r.length,this.returnedCount=this.totalResults;for(const o of Jp)s[o]=this.formatHits(s[o]);return r}handleWebArchivesPageElement(){var e;const t=t0((e=this.pageElements)===null||e===void 0?void 0:e.web_archives);return this.totalResults=t.length,this.returnedCount=this.totalResults,t}handleFederatedPageElements(){var e,t,s,r;const o=["service___fts","service___tvs","service___rcs","service___whisper","metadata___mediatype___texts","metadata___mediatype___movies","metadata___mediatype___audio","metadata___mediatype___software","metadata___mediatype___image","metadata___mediatype___etree"];for(const a of o){const l=this.removePageElementPrefix(a);this.federatedResults?this.federatedResults[a]=[]:this.federatedResults={[l]:[]};const n=(t=(e=this.pageElements)===null||e===void 0?void 0:e[a])===null||t===void 0?void 0:t.hits;n!=null&&n.hits&&(this.federatedResults[l]=this.formatHits(n==null?void 0:n.hits)),this.totalResults+=(s=n==null?void 0:n.total)!==null&&s!==void 0?s:0,this.returnedCount+=(r=n==null?void 0:n.returned)!==null&&r!==void 0?r:0}}removePageElementPrefix(e){return e.split("___").pop()}static createResult(e,t){switch(e){case"item":return new ft(t);case"text":case"asr_text":return new ml(t);case"favorited_search":return new i0(t);case"web_archive":return new gl(t);case"tv_clip":return new vl(t);default:return new ft(t)}}}class s0{constructor(e){this.clientParameters=e.client_parameters,this.backendRequests=e.backend_requests,this.kind=e.kind}}class r0{constructor(e){var t,s,r;this.rawResponse=e,this.request=new s0(e.request),this.responseHeader=(t=e.response)===null||t===void 0?void 0:t.header,this.sessionContext=e.session_context,this.response=new yl((s=e.response)===null||s===void 0?void 0:s.body,(r=e.response)===null||r===void 0?void 0:r.hit_schema)}}class Rs{static aggregateSearchParamsAsString(e){if(e.omit)return"false";if(e.advancedParams){const t=e.advancedParams.map(r=>({terms:r}));return JSON.stringify(t)}if(e.simpleParams)return e.simpleParams.join(",")}static sortParamsAsString(e){return`${e.field}:${e.direction}`}static filterParamsAsString(e){return JSON.stringify(e)}static generateURLSearchParams(e){const t=new URLSearchParams;if(e.query&&t.append("user_query",e.query),e.pageType&&t.append("page_type",String(e.pageType)),e.pageTarget&&t.append("page_target",String(e.pageTarget)),e.pageElements&&e.pageElements.length>0){const o=`[${e.pageElements.map(a=>`"${a}"`).join(",")}]`;t.append("page_elements",o)}if(e.rows!=null&&t.append("hits_per_page",String(e.rows)),e.page!=null&&t.append("page",String(e.page)),e.fields&&e.fields.length>0&&t.append("fields",e.fields.join(",")),e.filters&&Object.keys(e.filters).length>0){const r=this.filterParamsAsString(e.filters);r&&r!=="{}"&&t.append("filter_map",r)}if(e.sort&&e.sort.length>0){const r=e.sort.map(o=>this.sortParamsAsString(o));t.append("sort",r.join(","))}const s=e.aggregations;if(s){const r=this.aggregateSearchParamsAsString(s);r&&t.append("aggregations",r)}if(e.aggregationsSize!=null&&t.append("aggregations_size",String(e.aggregationsSize)),e.debugging&&t.append("debugging","true"),e.uid&&t.append("uid",e.uid),e.includeClientUrl!==!1){const r=e.query==null,o=e.query&&e.query.length<=1e3;if(r||o){const l=window.location.href.slice(0,400);t.append("client_url",l)}}return t}}var ur;(function(i){i.networkError="SearchService.NetworkError",i.itemNotFound="SearchService.ItemNotFound",i.decodingError="SearchService.DecodingError",i.searchEngineError="SearchService.SearchEngineError"})(ur||(ur={}));class o0 extends Error{constructor(e,t,s){super(t),this.name=e,this.type=e,this.details=s}}const _c={reCache:JSON.stringify({recompute:!0}),noCache:JSON.stringify({bypass:!0}),dontCache:JSON.stringify({no_compute:!0})};class zs{constructor(e){var t,s;this.baseUrl=(t=e==null?void 0:e.baseUrl)!==null&&t!==void 0?t:"archive.org",(e==null?void 0:e.includeCredentials)!==void 0?this.includeCredentials=e.includeCredentials:this.includeCredentials=window.location.href.match(/^https?:\/\/.*archive\.org(:[0-9]+)?/)!==null;const r=new URL(window.location.href).searchParams,o=r.get("scope"),a=r.get("verbose"),l=r.get("debugging"),n=r.get("cacheDebug");let c="";for(const d of Object.keys(_c))if(r.get(d)){c=_c[d];break}c=(s=r.get("caching"))!==null&&s!==void 0?s:c,(e==null?void 0:e.caching)!==void 0?this.cachingFlags=e.caching:c&&(this.cachingFlags=c),(e==null?void 0:e.debuggingEnabled)!==void 0?this.debuggingEnabled=e.debuggingEnabled:(l||n)&&(this.debuggingEnabled=!0),(e==null?void 0:e.scope)!==void 0?this.requestScope=e.scope:o&&(this.requestScope=o),(e==null?void 0:e.verbose)!==void 0?this.verbose=e.verbose:a&&(this.verbose=!!a)}async fetchUrl(e,t){var s,r;const o=new URL(e);this.requestScope&&o.searchParams.set("scope",this.requestScope),this.cachingFlags&&o.searchParams.set("caching",this.cachingFlags);let a;try{const l=(s=t==null?void 0:t.requestOptions)!==null&&s!==void 0?s:{credentials:this.includeCredentials?"include":"same-origin"};a=await fetch(o.href,l)}catch(l){const n=l instanceof Error?l.message:typeof l=="string"?l:"Unknown error";return this.getErrorResult(ur.networkError,n)}try{const l=await a.json();this.verbose&&this.printResponse(l),l.debugging&&this.printDebuggingInfo(l);const n=(r=l.response)===null||r===void 0?void 0:r.error;return n?this.getErrorResult(ur.searchEngineError,n.message,n.forensics):{success:l}}catch(l){const n=l instanceof Error?l.message:typeof l=="string"?l:"Unknown error";return this.getErrorResult(ur.decodingError,n)}}getErrorResult(e,t,s){return{error:new o0(e,t,s)}}printResponse(e){var t,s,r,o,a;try{const l=JSON.parse(JSON.stringify(e)),n=(r=(s=(t=l==null?void 0:l.response)===null||t===void 0?void 0:t.body)===null||s===void 0?void 0:s.hits)===null||r===void 0?void 0:r.hits;if(Array.isArray(n)&&n.length>1){const d=[];d.push(n[0]),d.push(`*** ${n.length-1} hits omitted ***`),l.response.body.hits.hits=d}const c=(a=(o=l==null?void 0:l.response)===null||o===void 0?void 0:o.body)===null||a===void 0?void 0:a.aggregations;c&&Object.entries(c).forEach(([d,h])=>{var f,g,y,$;if(((g=(f=h)===null||f===void 0?void 0:f.buckets)===null||g===void 0?void 0:g.length)>0){const A=JSON.parse(JSON.stringify(h));A.buckets=`*** ${($=(y=A.buckets)===null||y===void 0?void 0:y.length)!==null&&$!==void 0?$:0} buckets omitted ***`,l.response.body.aggregations[d]=A}}),console.log("***** RESPONSE RECEIVED *****"),console.groupCollapsed("Response"),console.log(JSON.stringify(l,null,2)),console.groupEnd()}catch(l){console.error("Error printing search response:",l)}}printDebuggingInfo(e){var t,s;const r=e.debugging,o=(t=r.messages)!==null&&t!==void 0?t:[],a=(s=r.data)!==null&&s!==void 0?s:{};console.log("***** BEGIN DEBUGGING *****"),console.log("Full response:"),console.log(JSON.stringify(e,null,2)),console.group("Debug messages");for(const l of o)console.log(l);console.groupEnd(),console.group("Debug data");for(const[l,n]of Object.entries(a))console.log(l,n);console.groupEnd(),console.log("***** END DEBUGGING *****")}}class a0 extends zs{constructor(e){var t;super(e),this.servicePath=(t=e==null?void 0:e.servicePath)!==null&&t!==void 0?t:"/services/search/beta/page_production"}async performSearch(e){this.debuggingEnabled&&e.debugging===void 0&&(e.debugging=!0);const s=Rs.generateURLSearchParams(e).toString(),r=`https://${this.baseUrl}${this.servicePath}/?service_backend=metadata&${s}`;return this.fetchUrl(r)}}class n0 extends zs{constructor(e){var t;super(e),this.servicePath=(t=e==null?void 0:e.servicePath)!==null&&t!==void 0?t:"/services/search/beta/page_production"}async performSearch(e){this.debuggingEnabled&&e.debugging===void 0&&(e.debugging=!0);const s=Rs.generateURLSearchParams(e).toString(),r=`https://${this.baseUrl}${this.servicePath}/?service_backend=fts&${s}`;return this.fetchUrl(r)}}class l0 extends zs{constructor(e){var t;super(e),this.servicePath=(t=e==null?void 0:e.servicePath)!==null&&t!==void 0?t:"/services/search/beta/page_production"}async performSearch(e){this.debuggingEnabled&&e.debugging===void 0&&(e.debugging=!0);const s=Rs.generateURLSearchParams(e).toString(),r=`https://${this.baseUrl}${this.servicePath}/?service_backend=rcs&${s}`;return this.fetchUrl(r)}}var I;(function(i){i[i.DEFAULT=0]="DEFAULT",i[i.METADATA=1]="METADATA",i[i.FULLTEXT=2]="FULLTEXT",i[i.TV=3]="TV",i[i.RADIO=4]="RADIO",i[i.FEDERATED=5]="FEDERATED"})(I||(I={}));class c0 extends zs{constructor(e){var t;super(e),this.servicePath=(t=e==null?void 0:e.servicePath)!==null&&t!==void 0?t:"/services/search/beta/page_production"}async performSearch(e){this.debuggingEnabled&&e.debugging===void 0&&(e.debugging=!0);const s=Rs.generateURLSearchParams(e).toString(),r=`https://${this.baseUrl}${this.servicePath}/?service_backend=tvs&${s}`;return this.fetchUrl(r)}}class d0 extends zs{constructor(e){var t;super(e),this.servicePath=(t=e==null?void 0:e.servicePath)!==null&&t!==void 0?t:"/services/search/beta/page_production"}async performSearch(e){this.debuggingEnabled&&e.debugging===void 0&&(e.debugging=!0);const s=Rs.generateURLSearchParams(e).toString(),r=`https://${this.baseUrl}${this.servicePath}/?page_type=simple_federation&${s}`;return this.fetchUrl(r)}}class h0 extends zs{constructor(e){var t;super(e),this.servicePath=(t=e==null?void 0:e.servicePath)!==null&&t!==void 0?t:"/services/search/beta/page_production"}async performSearch(e){this.debuggingEnabled&&e.debugging===void 0&&(e.debugging=!0);const s=Rs.generateURLSearchParams(e).toString(),r=`https://${this.baseUrl}${this.servicePath}/?${s}`,{pageType:o,identifiers:a}=e,n=o==="client_document_fetch"&&!!(a!=null&&a.length)?{requestOptions:{method:"POST",body:JSON.stringify({doc_ids:a}),credentials:"include"}}:void 0;return this.fetchUrl(r,n)}}class ps{constructor(e={}){this.backendOptions=e}async search(e,t=I.METADATA){const r=await ps.getBackendForSearchType(t,this.backendOptions).performSearch(e);return r.error?r:{success:new r0(r.success)}}itemDetails(e){const t={pageType:"item_details",pageTarget:e};return this.search(t,I.DEFAULT)}static getBackendForSearchType(e,t={}){switch(e){case I.METADATA:return new a0(t);case I.FULLTEXT:return new n0(t);case I.RADIO:return new l0(t);case I.TV:return new c0(t);case I.FEDERATED:return new d0(t);default:return new h0(t)}}}ps.default=new ps;p([S((i,e={})=>{const{includeCredentials:t=!1,verbose:s=!1,scope:r="",baseUrl:o=""}=e;return`${i};${t};${s};${r};${o}`})],ps,"getBackendForSearchType",null);var Ut;(function(i){i.INCLUDE="inc",i.EXCLUDE="exc",i.GREATER_THAN="gt",i.GREATER_OR_EQUAL="gte",i.LESS_THAN="lt",i.LESS_OR_EQUAL="lte"})(Ut||(Ut={}));class p0{constructor(){this.filterMap={}}addFilter(e,t,s){if(this.filterMap[e]||(this.filterMap[e]={}),this.filterMap[e][t]){const r=[].concat(this.filterMap[e][t],s);this.filterMap[e][t]=Array.from(new Set(r))}else this.filterMap[e][t]=s;return this}removeSingleFilter(e,t,s){var r;if(!(!((r=this.filterMap[e])===null||r===void 0)&&r[t]))return this;const o=[].concat(this.filterMap[e][t]),a=o.indexOf(s);return a>=0&&o.splice(a,1),this.filterMap[e][t]=o.length===1?o[0]:o,o.length===0&&delete this.filterMap[e][t],this.deleteFieldIfEmpty(e),this}removeFilters(e,t){return this.filterMap[e]?(delete this.filterMap[e][t],this.deleteFieldIfEmpty(e),this):this}deleteFieldIfEmpty(e){const t=this.filterMap[e];t&&Object.keys(t).length===0&&delete this.filterMap[e]}setFilterMap(e){return this.filterMap={...e},this}mergeFilterMap(e){for(const[t,s]of Object.entries(e))for(const[r,o]of Object.entries(s))if(Array.isArray(o))for(const a of o)this.addFilter(t,r,a);else this.addFilter(t,r,o);return this}build(){return this.filterMap}}/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ho=globalThis,wl=ho.ShadowRoot&&(ho.ShadyCSS===void 0||ho.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Hh=Symbol(),Cc=new WeakMap;let u0=class{constructor(e,t,s){if(this._$cssResult$=!0,s!==Hh)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o;const t=this.t;if(wl&&e===void 0){const s=t!==void 0&&t.length===1;s&&(e=Cc.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),s&&Cc.set(t,e))}return e}toString(){return this.cssText}};const f0=i=>new u0(typeof i=="string"?i:i+"",void 0,Hh),m0=(i,e)=>{if(wl)i.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(const t of e){const s=document.createElement("style"),r=ho.litNonce;r!==void 0&&s.setAttribute("nonce",r),s.textContent=t.cssText,i.appendChild(s)}},Tc=wl?i=>i:i=>i instanceof CSSStyleSheet?(e=>{let t="";for(const s of e.cssRules)t+=s.cssText;return f0(t)})(i):i;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{is:g0,defineProperty:v0,getOwnPropertyDescriptor:b0,getOwnPropertyNames:y0,getOwnPropertySymbols:w0,getPrototypeOf:$0}=Object,ti=globalThis,Ac=ti.trustedTypes,x0=Ac?Ac.emptyScript:"",Aa=ti.reactiveElementPolyfillSupport,fr=(i,e)=>i,Ao={toAttribute(i,e){switch(e){case Boolean:i=i?x0:null;break;case Object:case Array:i=i==null?i:JSON.stringify(i)}return i},fromAttribute(i,e){let t=i;switch(e){case Boolean:t=i!==null;break;case Number:t=i===null?null:Number(i);break;case Object:case Array:try{t=JSON.parse(i)}catch{t=null}}return t}},$l=(i,e)=>!g0(i,e),kc={attribute:!0,type:String,converter:Ao,reflect:!1,useDefault:!1,hasChanged:$l};Symbol.metadata??(Symbol.metadata=Symbol("metadata")),ti.litPropertyMetadata??(ti.litPropertyMetadata=new WeakMap);let Ws=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??(this.l=[])).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=kc){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(e,t),!t.noAccessor){const s=Symbol(),r=this.getPropertyDescriptor(e,s,t);r!==void 0&&v0(this.prototype,e,r)}}static getPropertyDescriptor(e,t,s){const{get:r,set:o}=b0(this.prototype,e)??{get(){return this[t]},set(a){this[t]=a}};return{get:r,set(a){const l=r==null?void 0:r.call(this);o==null||o.call(this,a),this.requestUpdate(e,l,s)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??kc}static _$Ei(){if(this.hasOwnProperty(fr("elementProperties")))return;const e=$0(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(fr("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(fr("properties"))){const t=this.properties,s=[...y0(t),...w0(t)];for(const r of s)this.createProperty(r,t[r])}const e=this[Symbol.metadata];if(e!==null){const t=litPropertyMetadata.get(e);if(t!==void 0)for(const[s,r]of t)this.elementProperties.set(s,r)}this._$Eh=new Map;for(const[t,s]of this.elementProperties){const r=this._$Eu(t,s);r!==void 0&&this._$Eh.set(r,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const s=new Set(e.flat(1/0).reverse());for(const r of s)t.unshift(Tc(r))}else e!==void 0&&t.push(Tc(e));return t}static _$Eu(e,t){const s=t.attribute;return s===!1?void 0:typeof s=="string"?s:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){var e;this._$ES=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$E_(),this.requestUpdate(),(e=this.constructor.l)==null||e.forEach(t=>t(this))}addController(e){var t;(this._$EO??(this._$EO=new Set)).add(e),this.renderRoot!==void 0&&this.isConnected&&((t=e.hostConnected)==null||t.call(e))}removeController(e){var t;(t=this._$EO)==null||t.delete(e)}_$E_(){const e=new Map,t=this.constructor.elementProperties;for(const s of t.keys())this.hasOwnProperty(s)&&(e.set(s,this[s]),delete this[s]);e.size>0&&(this._$Ep=e)}createRenderRoot(){const e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return m0(e,this.constructor.elementStyles),e}connectedCallback(){var e;this.renderRoot??(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$EO)==null||e.forEach(t=>{var s;return(s=t.hostConnected)==null?void 0:s.call(t)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$EO)==null||e.forEach(t=>{var s;return(s=t.hostDisconnected)==null?void 0:s.call(t)})}attributeChangedCallback(e,t,s){this._$AK(e,s)}_$ET(e,t){var o;const s=this.constructor.elementProperties.get(e),r=this.constructor._$Eu(e,s);if(r!==void 0&&s.reflect===!0){const a=(((o=s.converter)==null?void 0:o.toAttribute)!==void 0?s.converter:Ao).toAttribute(t,s.type);this._$Em=e,a==null?this.removeAttribute(r):this.setAttribute(r,a),this._$Em=null}}_$AK(e,t){var o,a;const s=this.constructor,r=s._$Eh.get(e);if(r!==void 0&&this._$Em!==r){const l=s.getPropertyOptions(r),n=typeof l.converter=="function"?{fromAttribute:l.converter}:((o=l.converter)==null?void 0:o.fromAttribute)!==void 0?l.converter:Ao;this._$Em=r;const c=n.fromAttribute(t,l.type);this[r]=c??((a=this._$Ej)==null?void 0:a.get(r))??c,this._$Em=null}}requestUpdate(e,t,s,r=!1,o){var a;if(e!==void 0){const l=this.constructor;if(r===!1&&(o=this[e]),s??(s=l.getPropertyOptions(e)),!((s.hasChanged??$l)(o,t)||s.useDefault&&s.reflect&&o===((a=this._$Ej)==null?void 0:a.get(e))&&!this.hasAttribute(l._$Eu(e,s))))return;this.C(e,t,s)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,t,{useDefault:s,reflect:r,wrapped:o},a){s&&!(this._$Ej??(this._$Ej=new Map)).has(e)&&(this._$Ej.set(e,a??t??this[e]),o!==!0||a!==void 0)||(this._$AL.has(e)||(this.hasUpdated||s||(t=void 0),this._$AL.set(e,t)),r===!0&&this._$Em!==e&&(this._$Eq??(this._$Eq=new Set)).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var s;if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??(this.renderRoot=this.createRenderRoot()),this._$Ep){for(const[o,a]of this._$Ep)this[o]=a;this._$Ep=void 0}const r=this.constructor.elementProperties;if(r.size>0)for(const[o,a]of r){const{wrapped:l}=a,n=this[o];l!==!0||this._$AL.has(o)||n===void 0||this.C(o,void 0,a,n)}}let e=!1;const t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),(s=this._$EO)==null||s.forEach(r=>{var o;return(o=r.hostUpdate)==null?void 0:o.call(r)}),this.update(t)):this._$EM()}catch(r){throw e=!1,this._$EM(),r}e&&this._$AE(t)}willUpdate(e){}_$AE(e){var t;(t=this._$EO)==null||t.forEach(s=>{var r;return(r=s.hostUpdated)==null?void 0:r.call(s)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&(this._$Eq=this._$Eq.forEach(t=>this._$ET(t,this[t]))),this._$EM()}updated(e){}firstUpdated(e){}};Ws.elementStyles=[],Ws.shadowRootOptions={mode:"open"},Ws[fr("elementProperties")]=new Map,Ws[fr("finalized")]=new Map,Aa==null||Aa({ReactiveElement:Ws}),(ti.reactiveElementVersions??(ti.reactiveElementVersions=[])).push("2.1.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const mr=globalThis,Ec=i=>i,ko=mr.trustedTypes,Mc=ko?ko.createPolicy("lit-html",{createHTML:i=>i}):void 0,Uh="$lit$",qt=`lit$${Math.random().toFixed(9).slice(2)}$`,Vh="?"+qt,S0=`<${Vh}>`,Ri=document,Eo=()=>Ri.createComment(""),Tr=i=>i===null||typeof i!="object"&&typeof i!="function",xl=Array.isArray,_0=i=>xl(i)||typeof(i==null?void 0:i[Symbol.iterator])=="function",ka=`[ 	
\f\r]`,qs=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Pc=/-->/g,Oc=/>/g,ci=RegExp(`>|${ka}(?:([^\\s"'>=/]+)(${ka}*=${ka}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Dc=/'/g,Lc=/"/g,jh=/^(?:script|style|textarea|title)$/i,et=Symbol.for("lit-noChange"),oe=Symbol.for("lit-nothing"),Bc=new WeakMap,Si=Ri.createTreeWalker(Ri,129);function Wh(i,e){if(!xl(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return Mc!==void 0?Mc.createHTML(e):e}const C0=(i,e)=>{const t=i.length-1,s=[];let r,o=e===2?"<svg>":e===3?"<math>":"",a=qs;for(let l=0;l<t;l++){const n=i[l];let c,d,h=-1,f=0;for(;f<n.length&&(a.lastIndex=f,d=a.exec(n),d!==null);)f=a.lastIndex,a===qs?d[1]==="!--"?a=Pc:d[1]!==void 0?a=Oc:d[2]!==void 0?(jh.test(d[2])&&(r=RegExp("</"+d[2],"g")),a=ci):d[3]!==void 0&&(a=ci):a===ci?d[0]===">"?(a=r??qs,h=-1):d[1]===void 0?h=-2:(h=a.lastIndex-d[2].length,c=d[1],a=d[3]===void 0?ci:d[3]==='"'?Lc:Dc):a===Lc||a===Dc?a=ci:a===Pc||a===Oc?a=qs:(a=ci,r=void 0);const g=a===ci&&i[l+1].startsWith("/>")?" ":"";o+=a===qs?n+S0:h>=0?(s.push(c),n.slice(0,h)+Uh+n.slice(h)+qt+g):n+qt+(h===-2?l:g)}return[Wh(i,o+(i[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),s]};let Dn=class qh{constructor({strings:e,_$litType$:t},s){let r;this.parts=[];let o=0,a=0;const l=e.length-1,n=this.parts,[c,d]=C0(e,t);if(this.el=qh.createElement(c,s),Si.currentNode=this.el.content,t===2||t===3){const h=this.el.content.firstChild;h.replaceWith(...h.childNodes)}for(;(r=Si.nextNode())!==null&&n.length<l;){if(r.nodeType===1){if(r.hasAttributes())for(const h of r.getAttributeNames())if(h.endsWith(Uh)){const f=d[a++],g=r.getAttribute(h).split(qt),y=/([.?@])?(.*)/.exec(f);n.push({type:1,index:o,name:y[2],strings:g,ctor:y[1]==="."?A0:y[1]==="?"?k0:y[1]==="@"?E0:Zo}),r.removeAttribute(h)}else h.startsWith(qt)&&(n.push({type:6,index:o}),r.removeAttribute(h));if(jh.test(r.tagName)){const h=r.textContent.split(qt),f=h.length-1;if(f>0){r.textContent=ko?ko.emptyScript:"";for(let g=0;g<f;g++)r.append(h[g],Eo()),Si.nextNode(),n.push({type:2,index:++o});r.append(h[f],Eo())}}}else if(r.nodeType===8)if(r.data===Vh)n.push({type:2,index:o});else{let h=-1;for(;(h=r.data.indexOf(qt,h+1))!==-1;)n.push({type:7,index:o}),h+=qt.length-1}o++}}static createElement(e,t){const s=Ri.createElement("template");return s.innerHTML=e,s}};function us(i,e,t=i,s){var a,l;if(e===et)return e;let r=s!==void 0?(a=t._$Co)==null?void 0:a[s]:t._$Cl;const o=Tr(e)?void 0:e._$litDirective$;return(r==null?void 0:r.constructor)!==o&&((l=r==null?void 0:r._$AO)==null||l.call(r,!1),o===void 0?r=void 0:(r=new o(i),r._$AT(i,t,s)),s!==void 0?(t._$Co??(t._$Co=[]))[s]=r:t._$Cl=r),r!==void 0&&(e=us(i,r._$AS(i,e.values),r,s)),e}let T0=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:t},parts:s}=this._$AD,r=((e==null?void 0:e.creationScope)??Ri).importNode(t,!0);Si.currentNode=r;let o=Si.nextNode(),a=0,l=0,n=s[0];for(;n!==void 0;){if(a===n.index){let c;n.type===2?c=new Sl(o,o.nextSibling,this,e):n.type===1?c=new n.ctor(o,n.name,n.strings,this,e):n.type===6&&(c=new M0(o,this,e)),this._$AV.push(c),n=s[++l]}a!==(n==null?void 0:n.index)&&(o=Si.nextNode(),a++)}return Si.currentNode=Ri,r}p(e){let t=0;for(const s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(e,s,t),t+=s.strings.length-2):s._$AI(e[t])),t++}},Sl=class Gh{get _$AU(){var e;return((e=this._$AM)==null?void 0:e._$AU)??this._$Cv}constructor(e,t,s,r){this.type=2,this._$AH=oe,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=s,this.options=r,this._$Cv=(r==null?void 0:r.isConnected)??!0}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=us(this,e,t),Tr(e)?e===oe||e==null||e===""?(this._$AH!==oe&&this._$AR(),this._$AH=oe):e!==this._$AH&&e!==et&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):_0(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==oe&&Tr(this._$AH)?this._$AA.nextSibling.data=e:this.T(Ri.createTextNode(e)),this._$AH=e}$(e){var o;const{values:t,_$litType$:s}=e,r=typeof s=="number"?this._$AC(e):(s.el===void 0&&(s.el=Dn.createElement(Wh(s.h,s.h[0]),this.options)),s);if(((o=this._$AH)==null?void 0:o._$AD)===r)this._$AH.p(t);else{const a=new T0(r,this),l=a.u(this.options);a.p(t),this.T(l),this._$AH=a}}_$AC(e){let t=Bc.get(e.strings);return t===void 0&&Bc.set(e.strings,t=new Dn(e)),t}k(e){xl(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let s,r=0;for(const o of e)r===t.length?t.push(s=new Gh(this.O(Eo()),this.O(Eo()),this,this.options)):s=t[r],s._$AI(o),r++;r<t.length&&(this._$AR(s&&s._$AB.nextSibling,r),t.length=r)}_$AR(e=this._$AA.nextSibling,t){var s;for((s=this._$AP)==null?void 0:s.call(this,!1,!0,t);e!==this._$AB;){const r=Ec(e).nextSibling;Ec(e).remove(),e=r}}setConnected(e){var t;this._$AM===void 0&&(this._$Cv=e,(t=this._$AP)==null||t.call(this,e))}},Zo=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,s,r,o){this.type=1,this._$AH=oe,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=o,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=oe}_$AI(e,t=this,s,r){const o=this.strings;let a=!1;if(o===void 0)e=us(this,e,t,0),a=!Tr(e)||e!==this._$AH&&e!==et,a&&(this._$AH=e);else{const l=e;let n,c;for(e=o[0],n=0;n<o.length-1;n++)c=us(this,l[s+n],t,n),c===et&&(c=this._$AH[n]),a||(a=!Tr(c)||c!==this._$AH[n]),c===oe?e=oe:e!==oe&&(e+=(c??"")+o[n+1]),this._$AH[n]=c}a&&!r&&this.j(e)}j(e){e===oe?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},A0=class extends Zo{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===oe?void 0:e}},k0=class extends Zo{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==oe)}},E0=class extends Zo{constructor(e,t,s,r,o){super(e,t,s,r,o),this.type=5}_$AI(e,t=this){if((e=us(this,e,t,0)??oe)===et)return;const s=this._$AH,r=e===oe&&s!==oe||e.capture!==s.capture||e.once!==s.once||e.passive!==s.passive,o=e!==oe&&(s===oe||r);r&&this.element.removeEventListener(this.name,this,s),o&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t;typeof this._$AH=="function"?this._$AH.call(((t=this.options)==null?void 0:t.host)??this.element,e):this._$AH.handleEvent(e)}},M0=class{constructor(e,t,s){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(e){us(this,e)}};const P0={I:Sl},Ea=mr.litHtmlPolyfillSupport;Ea==null||Ea(Dn,Sl),(mr.litHtmlVersions??(mr.litHtmlVersions=[])).push("3.3.2");/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const po=globalThis,_l=po.ShadowRoot&&(po.ShadyCSS===void 0||po.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Cl=Symbol(),Fc=new WeakMap;let Yh=class{constructor(e,t,s){if(this._$cssResult$=!0,s!==Cl)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o;const t=this.t;if(_l&&e===void 0){const s=t!==void 0&&t.length===1;s&&(e=Fc.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),s&&Fc.set(t,e))}return e}toString(){return this.cssText}};const O0=i=>new Yh(typeof i=="string"?i:i+"",void 0,Cl),w=(i,...e)=>{const t=i.length===1?i[0]:e.reduce((s,r,o)=>s+(a=>{if(a._$cssResult$===!0)return a.cssText;if(typeof a=="number")return a;throw Error("Value passed to 'css' function must be a 'css' function result: "+a+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(r)+i[o+1],i[0]);return new Yh(t,i,Cl)},D0=(i,e)=>{if(_l)i.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(const t of e){const s=document.createElement("style"),r=po.litNonce;r!==void 0&&s.setAttribute("nonce",r),s.textContent=t.cssText,i.appendChild(s)}},Rc=_l?i=>i:i=>i instanceof CSSStyleSheet?(e=>{let t="";for(const s of e.cssRules)t+=s.cssText;return O0(t)})(i):i;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{is:L0,defineProperty:B0,getOwnPropertyDescriptor:F0,getOwnPropertyNames:R0,getOwnPropertySymbols:z0,getPrototypeOf:I0}=Object,ii=globalThis,zc=ii.trustedTypes,N0=zc?zc.emptyScript:"",Ma=ii.reactiveElementPolyfillSupport,gr=(i,e)=>i,Ln={toAttribute(i,e){switch(e){case Boolean:i=i?N0:null;break;case Object:case Array:i=i==null?i:JSON.stringify(i)}return i},fromAttribute(i,e){let t=i;switch(e){case Boolean:t=i!==null;break;case Number:t=i===null?null:Number(i);break;case Object:case Array:try{t=JSON.parse(i)}catch{t=null}}return t}},Qh=(i,e)=>!L0(i,e),Ic={attribute:!0,type:String,converter:Ln,reflect:!1,useDefault:!1,hasChanged:Qh};Symbol.metadata??(Symbol.metadata=Symbol("metadata")),ii.litPropertyMetadata??(ii.litPropertyMetadata=new WeakMap);let os=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??(this.l=[])).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=Ic){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(e,t),!t.noAccessor){const s=Symbol(),r=this.getPropertyDescriptor(e,s,t);r!==void 0&&B0(this.prototype,e,r)}}static getPropertyDescriptor(e,t,s){const{get:r,set:o}=F0(this.prototype,e)??{get(){return this[t]},set(a){this[t]=a}};return{get:r,set(a){const l=r==null?void 0:r.call(this);o==null||o.call(this,a),this.requestUpdate(e,l,s)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??Ic}static _$Ei(){if(this.hasOwnProperty(gr("elementProperties")))return;const e=I0(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(gr("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(gr("properties"))){const t=this.properties,s=[...R0(t),...z0(t)];for(const r of s)this.createProperty(r,t[r])}const e=this[Symbol.metadata];if(e!==null){const t=litPropertyMetadata.get(e);if(t!==void 0)for(const[s,r]of t)this.elementProperties.set(s,r)}this._$Eh=new Map;for(const[t,s]of this.elementProperties){const r=this._$Eu(t,s);r!==void 0&&this._$Eh.set(r,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const s=new Set(e.flat(1/0).reverse());for(const r of s)t.unshift(Rc(r))}else e!==void 0&&t.push(Rc(e));return t}static _$Eu(e,t){const s=t.attribute;return s===!1?void 0:typeof s=="string"?s:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){var e;this._$ES=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$E_(),this.requestUpdate(),(e=this.constructor.l)==null||e.forEach(t=>t(this))}addController(e){var t;(this._$EO??(this._$EO=new Set)).add(e),this.renderRoot!==void 0&&this.isConnected&&((t=e.hostConnected)==null||t.call(e))}removeController(e){var t;(t=this._$EO)==null||t.delete(e)}_$E_(){const e=new Map,t=this.constructor.elementProperties;for(const s of t.keys())this.hasOwnProperty(s)&&(e.set(s,this[s]),delete this[s]);e.size>0&&(this._$Ep=e)}createRenderRoot(){const e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return D0(e,this.constructor.elementStyles),e}connectedCallback(){var e;this.renderRoot??(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$EO)==null||e.forEach(t=>{var s;return(s=t.hostConnected)==null?void 0:s.call(t)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$EO)==null||e.forEach(t=>{var s;return(s=t.hostDisconnected)==null?void 0:s.call(t)})}attributeChangedCallback(e,t,s){this._$AK(e,s)}_$ET(e,t){var o;const s=this.constructor.elementProperties.get(e),r=this.constructor._$Eu(e,s);if(r!==void 0&&s.reflect===!0){const a=(((o=s.converter)==null?void 0:o.toAttribute)!==void 0?s.converter:Ln).toAttribute(t,s.type);this._$Em=e,a==null?this.removeAttribute(r):this.setAttribute(r,a),this._$Em=null}}_$AK(e,t){var o,a;const s=this.constructor,r=s._$Eh.get(e);if(r!==void 0&&this._$Em!==r){const l=s.getPropertyOptions(r),n=typeof l.converter=="function"?{fromAttribute:l.converter}:((o=l.converter)==null?void 0:o.fromAttribute)!==void 0?l.converter:Ln;this._$Em=r;const c=n.fromAttribute(t,l.type);this[r]=c??((a=this._$Ej)==null?void 0:a.get(r))??c,this._$Em=null}}requestUpdate(e,t,s,r=!1,o){var a;if(e!==void 0){const l=this.constructor;if(r===!1&&(o=this[e]),s??(s=l.getPropertyOptions(e)),!((s.hasChanged??Qh)(o,t)||s.useDefault&&s.reflect&&o===((a=this._$Ej)==null?void 0:a.get(e))&&!this.hasAttribute(l._$Eu(e,s))))return;this.C(e,t,s)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,t,{useDefault:s,reflect:r,wrapped:o},a){s&&!(this._$Ej??(this._$Ej=new Map)).has(e)&&(this._$Ej.set(e,a??t??this[e]),o!==!0||a!==void 0)||(this._$AL.has(e)||(this.hasUpdated||s||(t=void 0),this._$AL.set(e,t)),r===!0&&this._$Em!==e&&(this._$Eq??(this._$Eq=new Set)).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var s;if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??(this.renderRoot=this.createRenderRoot()),this._$Ep){for(const[o,a]of this._$Ep)this[o]=a;this._$Ep=void 0}const r=this.constructor.elementProperties;if(r.size>0)for(const[o,a]of r){const{wrapped:l}=a,n=this[o];l!==!0||this._$AL.has(o)||n===void 0||this.C(o,void 0,a,n)}}let e=!1;const t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),(s=this._$EO)==null||s.forEach(r=>{var o;return(o=r.hostUpdate)==null?void 0:o.call(r)}),this.update(t)):this._$EM()}catch(r){throw e=!1,this._$EM(),r}e&&this._$AE(t)}willUpdate(e){}_$AE(e){var t;(t=this._$EO)==null||t.forEach(s=>{var r;return(r=s.hostUpdated)==null?void 0:r.call(s)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&(this._$Eq=this._$Eq.forEach(t=>this._$ET(t,this[t]))),this._$EM()}updated(e){}firstUpdated(e){}};os.elementStyles=[],os.shadowRootOptions={mode:"open"},os[gr("elementProperties")]=new Map,os[gr("finalized")]=new Map,Ma==null||Ma({ReactiveElement:os}),(ii.reactiveElementVersions??(ii.reactiveElementVersions=[])).push("2.1.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const vr=globalThis,Nc=i=>i,Mo=vr.trustedTypes,Hc=Mo?Mo.createPolicy("lit-html",{createHTML:i=>i}):void 0,Kh="$lit$",Gt=`lit$${Math.random().toFixed(9).slice(2)}$`,Xh="?"+Gt,H0=`<${Xh}>`,zi=document,Ar=()=>zi.createComment(""),kr=i=>i===null||typeof i!="object"&&typeof i!="function",Tl=Array.isArray,U0=i=>Tl(i)||typeof(i==null?void 0:i[Symbol.iterator])=="function",Pa=`[ 	
\f\r]`,Gs=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Uc=/-->/g,Vc=/>/g,di=RegExp(`>|${Pa}(?:([^\\s"'>=/]+)(${Pa}*=${Pa}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),jc=/'/g,Wc=/"/g,Zh=/^(?:script|style|textarea|title)$/i,Jh=i=>(e,...t)=>({_$litType$:i,strings:e,values:t}),m=Jh(1),G=Jh(2),fs=Symbol.for("lit-noChange"),b=Symbol.for("lit-nothing"),qc=new WeakMap,_i=zi.createTreeWalker(zi,129);function e1(i,e){if(!Tl(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return Hc!==void 0?Hc.createHTML(e):e}const V0=(i,e)=>{const t=i.length-1,s=[];let r,o=e===2?"<svg>":e===3?"<math>":"",a=Gs;for(let l=0;l<t;l++){const n=i[l];let c,d,h=-1,f=0;for(;f<n.length&&(a.lastIndex=f,d=a.exec(n),d!==null);)f=a.lastIndex,a===Gs?d[1]==="!--"?a=Uc:d[1]!==void 0?a=Vc:d[2]!==void 0?(Zh.test(d[2])&&(r=RegExp("</"+d[2],"g")),a=di):d[3]!==void 0&&(a=di):a===di?d[0]===">"?(a=r??Gs,h=-1):d[1]===void 0?h=-2:(h=a.lastIndex-d[2].length,c=d[1],a=d[3]===void 0?di:d[3]==='"'?Wc:jc):a===Wc||a===jc?a=di:a===Uc||a===Vc?a=Gs:(a=di,r=void 0);const g=a===di&&i[l+1].startsWith("/>")?" ":"";o+=a===Gs?n+H0:h>=0?(s.push(c),n.slice(0,h)+Kh+n.slice(h)+Gt+g):n+Gt+(h===-2?l:g)}return[e1(i,o+(i[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),s]};let Bn=class t1{constructor({strings:e,_$litType$:t},s){let r;this.parts=[];let o=0,a=0;const l=e.length-1,n=this.parts,[c,d]=V0(e,t);if(this.el=t1.createElement(c,s),_i.currentNode=this.el.content,t===2||t===3){const h=this.el.content.firstChild;h.replaceWith(...h.childNodes)}for(;(r=_i.nextNode())!==null&&n.length<l;){if(r.nodeType===1){if(r.hasAttributes())for(const h of r.getAttributeNames())if(h.endsWith(Kh)){const f=d[a++],g=r.getAttribute(h).split(Gt),y=/([.?@])?(.*)/.exec(f);n.push({type:1,index:o,name:y[2],strings:g,ctor:y[1]==="."?W0:y[1]==="?"?q0:y[1]==="@"?G0:Jo}),r.removeAttribute(h)}else h.startsWith(Gt)&&(n.push({type:6,index:o}),r.removeAttribute(h));if(Zh.test(r.tagName)){const h=r.textContent.split(Gt),f=h.length-1;if(f>0){r.textContent=Mo?Mo.emptyScript:"";for(let g=0;g<f;g++)r.append(h[g],Ar()),_i.nextNode(),n.push({type:2,index:++o});r.append(h[f],Ar())}}}else if(r.nodeType===8)if(r.data===Xh)n.push({type:2,index:o});else{let h=-1;for(;(h=r.data.indexOf(Gt,h+1))!==-1;)n.push({type:7,index:o}),h+=Gt.length-1}o++}}static createElement(e,t){const s=zi.createElement("template");return s.innerHTML=e,s}};function ms(i,e,t=i,s){var a,l;if(e===fs)return e;let r=s!==void 0?(a=t._$Co)==null?void 0:a[s]:t._$Cl;const o=kr(e)?void 0:e._$litDirective$;return(r==null?void 0:r.constructor)!==o&&((l=r==null?void 0:r._$AO)==null||l.call(r,!1),o===void 0?r=void 0:(r=new o(i),r._$AT(i,t,s)),s!==void 0?(t._$Co??(t._$Co=[]))[s]=r:t._$Cl=r),r!==void 0&&(e=ms(i,r._$AS(i,e.values),r,s)),e}let j0=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:t},parts:s}=this._$AD,r=((e==null?void 0:e.creationScope)??zi).importNode(t,!0);_i.currentNode=r;let o=_i.nextNode(),a=0,l=0,n=s[0];for(;n!==void 0;){if(a===n.index){let c;n.type===2?c=new Al(o,o.nextSibling,this,e):n.type===1?c=new n.ctor(o,n.name,n.strings,this,e):n.type===6&&(c=new Y0(o,this,e)),this._$AV.push(c),n=s[++l]}a!==(n==null?void 0:n.index)&&(o=_i.nextNode(),a++)}return _i.currentNode=zi,r}p(e){let t=0;for(const s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(e,s,t),t+=s.strings.length-2):s._$AI(e[t])),t++}},Al=class i1{get _$AU(){var e;return((e=this._$AM)==null?void 0:e._$AU)??this._$Cv}constructor(e,t,s,r){this.type=2,this._$AH=b,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=s,this.options=r,this._$Cv=(r==null?void 0:r.isConnected)??!0}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=ms(this,e,t),kr(e)?e===b||e==null||e===""?(this._$AH!==b&&this._$AR(),this._$AH=b):e!==this._$AH&&e!==fs&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):U0(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==b&&kr(this._$AH)?this._$AA.nextSibling.data=e:this.T(zi.createTextNode(e)),this._$AH=e}$(e){var o;const{values:t,_$litType$:s}=e,r=typeof s=="number"?this._$AC(e):(s.el===void 0&&(s.el=Bn.createElement(e1(s.h,s.h[0]),this.options)),s);if(((o=this._$AH)==null?void 0:o._$AD)===r)this._$AH.p(t);else{const a=new j0(r,this),l=a.u(this.options);a.p(t),this.T(l),this._$AH=a}}_$AC(e){let t=qc.get(e.strings);return t===void 0&&qc.set(e.strings,t=new Bn(e)),t}k(e){Tl(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let s,r=0;for(const o of e)r===t.length?t.push(s=new i1(this.O(Ar()),this.O(Ar()),this,this.options)):s=t[r],s._$AI(o),r++;r<t.length&&(this._$AR(s&&s._$AB.nextSibling,r),t.length=r)}_$AR(e=this._$AA.nextSibling,t){var s;for((s=this._$AP)==null?void 0:s.call(this,!1,!0,t);e!==this._$AB;){const r=Nc(e).nextSibling;Nc(e).remove(),e=r}}setConnected(e){var t;this._$AM===void 0&&(this._$Cv=e,(t=this._$AP)==null||t.call(this,e))}},Jo=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,s,r,o){this.type=1,this._$AH=b,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=o,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=b}_$AI(e,t=this,s,r){const o=this.strings;let a=!1;if(o===void 0)e=ms(this,e,t,0),a=!kr(e)||e!==this._$AH&&e!==fs,a&&(this._$AH=e);else{const l=e;let n,c;for(e=o[0],n=0;n<o.length-1;n++)c=ms(this,l[s+n],t,n),c===fs&&(c=this._$AH[n]),a||(a=!kr(c)||c!==this._$AH[n]),c===b?e=b:e!==b&&(e+=(c??"")+o[n+1]),this._$AH[n]=c}a&&!r&&this.j(e)}j(e){e===b?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},W0=class extends Jo{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===b?void 0:e}},q0=class extends Jo{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==b)}},G0=class extends Jo{constructor(e,t,s,r,o){super(e,t,s,r,o),this.type=5}_$AI(e,t=this){if((e=ms(this,e,t,0)??b)===fs)return;const s=this._$AH,r=e===b&&s!==b||e.capture!==s.capture||e.once!==s.once||e.passive!==s.passive,o=e!==b&&(s===b||r);r&&this.element.removeEventListener(this.name,this,s),o&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t;typeof this._$AH=="function"?this._$AH.call(((t=this.options)==null?void 0:t.host)??this.element,e):this._$AH.handleEvent(e)}},Y0=class{constructor(e,t,s){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(e){ms(this,e)}};const Oa=vr.litHtmlPolyfillSupport;Oa==null||Oa(Bn,Al),(vr.litHtmlVersions??(vr.litHtmlVersions=[])).push("3.3.2");const Q0=(i,e,t)=>{const s=(t==null?void 0:t.renderBefore)??e;let r=s._$litPart$;if(r===void 0){const o=(t==null?void 0:t.renderBefore)??null;s._$litPart$=r=new Al(e.insertBefore(Ar(),o),o,void 0,t??{})}return r._$AI(i),r};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Di=globalThis;let H=class extends os{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var t;const e=super.createRenderRoot();return(t=this.renderOptions).renderBefore??(t.renderBefore=e.firstChild),e}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Q0(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)==null||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)==null||e.setConnected(!1)}render(){return fs}};var zh;H._$litElement$=!0,H.finalized=!0,(zh=Di.litElementHydrateSupport)==null||zh.call(Di,{LitElement:H});const Da=Di.litElementPolyfillSupport;Da==null||Da({LitElement:H});(Di.litElementVersions??(Di.litElementVersions=[])).push("4.2.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const K0={attribute:!0,type:String,converter:Ao,reflect:!1,hasChanged:$l},X0=(i=K0,e,t)=>{const{kind:s,metadata:r}=t;let o=globalThis.litPropertyMetadata.get(r);if(o===void 0&&globalThis.litPropertyMetadata.set(r,o=new Map),s==="setter"&&((i=Object.create(i)).wrapped=!0),o.set(t.name,i),s==="accessor"){const{name:a}=t;return{set(l){const n=e.get.call(this);e.set.call(this,l),this.requestUpdate(a,n,i,!0,l)},init(l){return l!==void 0&&this.C(a,void 0,i,l),l}}}if(s==="setter"){const{name:a}=t;return function(l){const n=this[a];e.call(this,l),this.requestUpdate(a,n,i,!0,l)}}throw Error("Unsupported decorator location: "+s)};function u(i){return(e,t)=>typeof t=="object"?X0(i,e,t):((s,r,o)=>{const a=r.hasOwnProperty(o);return r.constructor.createProperty(o,s),a?Object.getOwnPropertyDescriptor(r,o):void 0})(i,e,t)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function R(i){return u({...i,state:!0,attribute:!1})}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Z0=(i,e,t)=>(t.configurable=!0,t.enumerable=!0,Reflect.decorate&&typeof e!="object"&&Object.defineProperty(i,e,t),t);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Q(i,e){return(t,s,r)=>{const o=a=>{var l;return((l=a.renderRoot)==null?void 0:l.querySelector(i))??null};return Z0(t,s,{get(){return o(this)}})}}class J0{constructor(){this.resizeObserver=new ResizeObserver(e=>{window.requestAnimationFrame(()=>{for(const t of e){const s=this.resizeHandlers.get(t.target);s==null||s.forEach(r=>{r.handleResize(t)})}})}),this.resizeHandlers=new Map}shutdown(){this.resizeHandlers.forEach((e,t)=>{this.resizeObserver.unobserve(t)}),this.resizeHandlers.clear()}addObserver(e){var t;const s=(t=this.resizeHandlers.get(e.target))!==null&&t!==void 0?t:new Set;s.add(e.handler),this.resizeHandlers.set(e.target,s),this.resizeObserver.observe(e.target,e.options)}removeObserver(e){const t=this.resizeHandlers.get(e.target);t&&(t.delete(e.handler),t.size===0&&(this.resizeObserver.unobserve(e.target),this.resizeHandlers.delete(e.target)))}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const _t={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4},jr=i=>(...e)=>({_$litDirective$:i,values:e});let Wr=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,s){this._$Ct=e,this._$AM=t,this._$Ci=s}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}};/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Qe=jr(class extends Wr{constructor(i){var e;if(super(i),i.type!==_t.ATTRIBUTE||i.name!=="class"||((e=i.strings)==null?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(i){return" "+Object.keys(i).filter(e=>i[e]).join(" ")+" "}update(i,[e]){var s,r;if(this.st===void 0){this.st=new Set,i.strings!==void 0&&(this.nt=new Set(i.strings.join(" ").split(/\s/).filter(o=>o!=="")));for(const o in e)e[o]&&!((s=this.nt)!=null&&s.has(o))&&this.st.add(o);return this.render(e)}const t=i.element.classList;for(const o of this.st)o in e||(t.remove(o),this.st.delete(o));for(const o in e){const a=!!e[o];a===this.st.has(o)||(r=this.nt)!=null&&r.has(o)||(a?(t.add(o),this.st.add(o)):(t.remove(o),this.st.delete(o)))}return et}});/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const eu=(i,...e)=>({strTag:!0,strings:i,values:e}),Ct=eu,tu=i=>typeof i!="string"&&"strTag"in i,iu=(i,e,t)=>{let s=i[0];for(let r=1;r<i.length;r++)s+=e[r-1],s+=i[r];return s};/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const su=i=>tu(i)?iu(i.strings,i.values):i;let _=su;/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let ru=class{constructor(){this.settled=!1,this.promise=new Promise((e,t)=>{this._resolve=e,this._reject=t})}resolve(e){this.settled=!0,this._resolve(e)}reject(e){this.settled=!0,this._reject(e)}};/**
 * @license
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let ou=new ru;ou.resolve();/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const uo=window,kl=uo.ShadowRoot&&(uo.ShadyCSS===void 0||uo.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,El=Symbol(),Gc=new WeakMap;let s1=class{constructor(e,t,s){if(this._$cssResult$=!0,s!==El)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o;const t=this.t;if(kl&&e===void 0){const s=t!==void 0&&t.length===1;s&&(e=Gc.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),s&&Gc.set(t,e))}return e}toString(){return this.cssText}};const au=i=>new s1(typeof i=="string"?i:i+"",void 0,El),x=(i,...e)=>{const t=i.length===1?i[0]:e.reduce((s,r,o)=>s+(a=>{if(a._$cssResult$===!0)return a.cssText;if(typeof a=="number")return a;throw Error("Value passed to 'css' function must be a 'css' function result: "+a+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(r)+i[o+1],i[0]);return new s1(t,i,El)},nu=(i,e)=>{kl?i.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet):e.forEach(t=>{const s=document.createElement("style"),r=uo.litNonce;r!==void 0&&s.setAttribute("nonce",r),s.textContent=t.cssText,i.appendChild(s)})},Yc=kl?i=>i:i=>i instanceof CSSStyleSheet?(e=>{let t="";for(const s of e.cssRules)t+=s.cssText;return au(t)})(i):i;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var La;const Po=window,Qc=Po.trustedTypes,lu=Qc?Qc.emptyScript:"",Kc=Po.reactiveElementPolyfillSupport,Fn={toAttribute(i,e){switch(e){case Boolean:i=i?lu:null;break;case Object:case Array:i=i==null?i:JSON.stringify(i)}return i},fromAttribute(i,e){let t=i;switch(e){case Boolean:t=i!==null;break;case Number:t=i===null?null:Number(i);break;case Object:case Array:try{t=JSON.parse(i)}catch{t=null}}return t}},r1=(i,e)=>e!==i&&(e==e||i==i),Ba={attribute:!0,type:String,converter:Fn,reflect:!1,hasChanged:r1},Rn="finalized";let ht=class extends HTMLElement{constructor(){super(),this._$Ei=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$El=null,this._$Eu()}static addInitializer(e){var t;this.finalize(),((t=this.h)!==null&&t!==void 0?t:this.h=[]).push(e)}static get observedAttributes(){this.finalize();const e=[];return this.elementProperties.forEach((t,s)=>{const r=this._$Ep(s,t);r!==void 0&&(this._$Ev.set(r,s),e.push(r))}),e}static createProperty(e,t=Ba){if(t.state&&(t.attribute=!1),this.finalize(),this.elementProperties.set(e,t),!t.noAccessor&&!this.prototype.hasOwnProperty(e)){const s=typeof e=="symbol"?Symbol():"__"+e,r=this.getPropertyDescriptor(e,s,t);r!==void 0&&Object.defineProperty(this.prototype,e,r)}}static getPropertyDescriptor(e,t,s){return{get(){return this[t]},set(r){const o=this[e];this[t]=r,this.requestUpdate(e,o,s)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)||Ba}static finalize(){if(this.hasOwnProperty(Rn))return!1;this[Rn]=!0;const e=Object.getPrototypeOf(this);if(e.finalize(),e.h!==void 0&&(this.h=[...e.h]),this.elementProperties=new Map(e.elementProperties),this._$Ev=new Map,this.hasOwnProperty("properties")){const t=this.properties,s=[...Object.getOwnPropertyNames(t),...Object.getOwnPropertySymbols(t)];for(const r of s)this.createProperty(r,t[r])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const s=new Set(e.flat(1/0).reverse());for(const r of s)t.unshift(Yc(r))}else e!==void 0&&t.push(Yc(e));return t}static _$Ep(e,t){const s=t.attribute;return s===!1?void 0:typeof s=="string"?s:typeof e=="string"?e.toLowerCase():void 0}_$Eu(){var e;this._$E_=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$Eg(),this.requestUpdate(),(e=this.constructor.h)===null||e===void 0||e.forEach(t=>t(this))}addController(e){var t,s;((t=this._$ES)!==null&&t!==void 0?t:this._$ES=[]).push(e),this.renderRoot!==void 0&&this.isConnected&&((s=e.hostConnected)===null||s===void 0||s.call(e))}removeController(e){var t;(t=this._$ES)===null||t===void 0||t.splice(this._$ES.indexOf(e)>>>0,1)}_$Eg(){this.constructor.elementProperties.forEach((e,t)=>{this.hasOwnProperty(t)&&(this._$Ei.set(t,this[t]),delete this[t])})}createRenderRoot(){var e;const t=(e=this.shadowRoot)!==null&&e!==void 0?e:this.attachShadow(this.constructor.shadowRootOptions);return nu(t,this.constructor.elementStyles),t}connectedCallback(){var e;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$ES)===null||e===void 0||e.forEach(t=>{var s;return(s=t.hostConnected)===null||s===void 0?void 0:s.call(t)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$ES)===null||e===void 0||e.forEach(t=>{var s;return(s=t.hostDisconnected)===null||s===void 0?void 0:s.call(t)})}attributeChangedCallback(e,t,s){this._$AK(e,s)}_$EO(e,t,s=Ba){var r;const o=this.constructor._$Ep(e,s);if(o!==void 0&&s.reflect===!0){const a=(((r=s.converter)===null||r===void 0?void 0:r.toAttribute)!==void 0?s.converter:Fn).toAttribute(t,s.type);this._$El=e,a==null?this.removeAttribute(o):this.setAttribute(o,a),this._$El=null}}_$AK(e,t){var s;const r=this.constructor,o=r._$Ev.get(e);if(o!==void 0&&this._$El!==o){const a=r.getPropertyOptions(o),l=typeof a.converter=="function"?{fromAttribute:a.converter}:((s=a.converter)===null||s===void 0?void 0:s.fromAttribute)!==void 0?a.converter:Fn;this._$El=o,this[o]=l.fromAttribute(t,a.type),this._$El=null}}requestUpdate(e,t,s){let r=!0;e!==void 0&&(((s=s||this.constructor.getPropertyOptions(e)).hasChanged||r1)(this[e],t)?(this._$AL.has(e)||this._$AL.set(e,t),s.reflect===!0&&this._$El!==e&&(this._$EC===void 0&&(this._$EC=new Map),this._$EC.set(e,s))):r=!1),!this.isUpdatePending&&r&&(this._$E_=this._$Ej())}async _$Ej(){this.isUpdatePending=!0;try{await this._$E_}catch(t){Promise.reject(t)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var e;if(!this.isUpdatePending)return;this.hasUpdated,this._$Ei&&(this._$Ei.forEach((r,o)=>this[o]=r),this._$Ei=void 0);let t=!1;const s=this._$AL;try{t=this.shouldUpdate(s),t?(this.willUpdate(s),(e=this._$ES)===null||e===void 0||e.forEach(r=>{var o;return(o=r.hostUpdate)===null||o===void 0?void 0:o.call(r)}),this.update(s)):this._$Ek()}catch(r){throw t=!1,this._$Ek(),r}t&&this._$AE(s)}willUpdate(e){}_$AE(e){var t;(t=this._$ES)===null||t===void 0||t.forEach(s=>{var r;return(r=s.hostUpdated)===null||r===void 0?void 0:r.call(s)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$Ek(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$E_}shouldUpdate(e){return!0}update(e){this._$EC!==void 0&&(this._$EC.forEach((t,s)=>this._$EO(s,this[s],t)),this._$EC=void 0),this._$Ek()}updated(e){}firstUpdated(e){}};ht[Rn]=!0,ht.elementProperties=new Map,ht.elementStyles=[],ht.shadowRootOptions={mode:"open"},Kc==null||Kc({ReactiveElement:ht}),((La=Po.reactiveElementVersions)!==null&&La!==void 0?La:Po.reactiveElementVersions=[]).push("1.6.3");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Fa;const Oo=window,gs=Oo.trustedTypes,Xc=gs?gs.createPolicy("lit-html",{createHTML:i=>i}):void 0,zn="$lit$",Yt=`lit$${(Math.random()+"").slice(9)}$`,o1="?"+Yt,cu=`<${o1}>`,Ii=document,Er=()=>Ii.createComment(""),Mr=i=>i===null||typeof i!="object"&&typeof i!="function",a1=Array.isArray,du=i=>a1(i)||typeof(i==null?void 0:i[Symbol.iterator])=="function",Ra=`[ 	
\f\r]`,Ys=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Zc=/-->/g,Jc=/>/g,hi=RegExp(`>|${Ra}(?:([^\\s"'>=/]+)(${Ra}*=${Ra}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),ed=/'/g,td=/"/g,n1=/^(?:script|style|textarea|title)$/i,hu=i=>(e,...t)=>({_$litType$:i,strings:e,values:t}),id=hu(1),Ni=Symbol.for("lit-noChange"),we=Symbol.for("lit-nothing"),sd=new WeakMap,Ci=Ii.createTreeWalker(Ii,129,null,!1);function l1(i,e){if(!Array.isArray(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return Xc!==void 0?Xc.createHTML(e):e}const pu=(i,e)=>{const t=i.length-1,s=[];let r,o=e===2?"<svg>":"",a=Ys;for(let l=0;l<t;l++){const n=i[l];let c,d,h=-1,f=0;for(;f<n.length&&(a.lastIndex=f,d=a.exec(n),d!==null);)f=a.lastIndex,a===Ys?d[1]==="!--"?a=Zc:d[1]!==void 0?a=Jc:d[2]!==void 0?(n1.test(d[2])&&(r=RegExp("</"+d[2],"g")),a=hi):d[3]!==void 0&&(a=hi):a===hi?d[0]===">"?(a=r??Ys,h=-1):d[1]===void 0?h=-2:(h=a.lastIndex-d[2].length,c=d[1],a=d[3]===void 0?hi:d[3]==='"'?td:ed):a===td||a===ed?a=hi:a===Zc||a===Jc?a=Ys:(a=hi,r=void 0);const g=a===hi&&i[l+1].startsWith("/>")?" ":"";o+=a===Ys?n+cu:h>=0?(s.push(c),n.slice(0,h)+zn+n.slice(h)+Yt+g):n+Yt+(h===-2?(s.push(void 0),l):g)}return[l1(i,o+(i[t]||"<?>")+(e===2?"</svg>":"")),s]};let In=class c1{constructor({strings:e,_$litType$:t},s){let r;this.parts=[];let o=0,a=0;const l=e.length-1,n=this.parts,[c,d]=pu(e,t);if(this.el=c1.createElement(c,s),Ci.currentNode=this.el.content,t===2){const h=this.el.content,f=h.firstChild;f.remove(),h.append(...f.childNodes)}for(;(r=Ci.nextNode())!==null&&n.length<l;){if(r.nodeType===1){if(r.hasAttributes()){const h=[];for(const f of r.getAttributeNames())if(f.endsWith(zn)||f.startsWith(Yt)){const g=d[a++];if(h.push(f),g!==void 0){const y=r.getAttribute(g.toLowerCase()+zn).split(Yt),$=/([.?@])?(.*)/.exec(g);n.push({type:1,index:o,name:$[2],strings:y,ctor:$[1]==="."?fu:$[1]==="?"?gu:$[1]==="@"?vu:ta})}else n.push({type:6,index:o})}for(const f of h)r.removeAttribute(f)}if(n1.test(r.tagName)){const h=r.textContent.split(Yt),f=h.length-1;if(f>0){r.textContent=gs?gs.emptyScript:"";for(let g=0;g<f;g++)r.append(h[g],Er()),Ci.nextNode(),n.push({type:2,index:++o});r.append(h[f],Er())}}}else if(r.nodeType===8)if(r.data===o1)n.push({type:2,index:o});else{let h=-1;for(;(h=r.data.indexOf(Yt,h+1))!==-1;)n.push({type:7,index:o}),h+=Yt.length-1}o++}}static createElement(e,t){const s=Ii.createElement("template");return s.innerHTML=e,s}};function vs(i,e,t=i,s){var r,o,a,l;if(e===Ni)return e;let n=s!==void 0?(r=t._$Co)===null||r===void 0?void 0:r[s]:t._$Cl;const c=Mr(e)?void 0:e._$litDirective$;return(n==null?void 0:n.constructor)!==c&&((o=n==null?void 0:n._$AO)===null||o===void 0||o.call(n,!1),c===void 0?n=void 0:(n=new c(i),n._$AT(i,t,s)),s!==void 0?((a=(l=t)._$Co)!==null&&a!==void 0?a:l._$Co=[])[s]=n:t._$Cl=n),n!==void 0&&(e=vs(i,n._$AS(i,e.values),n,s)),e}let uu=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){var t;const{el:{content:s},parts:r}=this._$AD,o=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:Ii).importNode(s,!0);Ci.currentNode=o;let a=Ci.nextNode(),l=0,n=0,c=r[0];for(;c!==void 0;){if(l===c.index){let d;c.type===2?d=new ea(a,a.nextSibling,this,e):c.type===1?d=new c.ctor(a,c.name,c.strings,this,e):c.type===6&&(d=new bu(a,this,e)),this._$AV.push(d),c=r[++n]}l!==(c==null?void 0:c.index)&&(a=Ci.nextNode(),l++)}return Ci.currentNode=Ii,o}v(e){let t=0;for(const s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(e,s,t),t+=s.strings.length-2):s._$AI(e[t])),t++}},ea=class d1{constructor(e,t,s,r){var o;this.type=2,this._$AH=we,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=s,this.options=r,this._$Cp=(o=r==null?void 0:r.isConnected)===null||o===void 0||o}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cp}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=vs(this,e,t),Mr(e)?e===we||e==null||e===""?(this._$AH!==we&&this._$AR(),this._$AH=we):e!==this._$AH&&e!==Ni&&this._(e):e._$litType$!==void 0?this.g(e):e.nodeType!==void 0?this.$(e):du(e)?this.T(e):this._(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==we&&Mr(this._$AH)?this._$AA.nextSibling.data=e:this.$(Ii.createTextNode(e)),this._$AH=e}g(e){var t;const{values:s,_$litType$:r}=e,o=typeof r=="number"?this._$AC(e):(r.el===void 0&&(r.el=In.createElement(l1(r.h,r.h[0]),this.options)),r);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===o)this._$AH.v(s);else{const a=new uu(o,this),l=a.u(this.options);a.v(s),this.$(l),this._$AH=a}}_$AC(e){let t=sd.get(e.strings);return t===void 0&&sd.set(e.strings,t=new In(e)),t}T(e){a1(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let s,r=0;for(const o of e)r===t.length?t.push(s=new d1(this.k(Er()),this.k(Er()),this,this.options)):s=t[r],s._$AI(o),r++;r<t.length&&(this._$AR(s&&s._$AB.nextSibling,r),t.length=r)}_$AR(e=this._$AA.nextSibling,t){var s;for((s=this._$AP)===null||s===void 0||s.call(this,!1,!0,t);e&&e!==this._$AB;){const r=e.nextSibling;e.remove(),e=r}}setConnected(e){var t;this._$AM===void 0&&(this._$Cp=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}},ta=class{constructor(e,t,s,r,o){this.type=1,this._$AH=we,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=o,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=we}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,s,r){const o=this.strings;let a=!1;if(o===void 0)e=vs(this,e,t,0),a=!Mr(e)||e!==this._$AH&&e!==Ni,a&&(this._$AH=e);else{const l=e;let n,c;for(e=o[0],n=0;n<o.length-1;n++)c=vs(this,l[s+n],t,n),c===Ni&&(c=this._$AH[n]),a||(a=!Mr(c)||c!==this._$AH[n]),c===we?e=we:e!==we&&(e+=(c??"")+o[n+1]),this._$AH[n]=c}a&&!r&&this.j(e)}j(e){e===we?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},fu=class extends ta{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===we?void 0:e}};const mu=gs?gs.emptyScript:"";let gu=class extends ta{constructor(){super(...arguments),this.type=4}j(e){e&&e!==we?this.element.setAttribute(this.name,mu):this.element.removeAttribute(this.name)}},vu=class extends ta{constructor(e,t,s,r,o){super(e,t,s,r,o),this.type=5}_$AI(e,t=this){var s;if((e=(s=vs(this,e,t,0))!==null&&s!==void 0?s:we)===Ni)return;const r=this._$AH,o=e===we&&r!==we||e.capture!==r.capture||e.once!==r.once||e.passive!==r.passive,a=e!==we&&(r===we||o);o&&this.element.removeEventListener(this.name,this,r),a&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,s;typeof this._$AH=="function"?this._$AH.call((s=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&s!==void 0?s:this.element,e):this._$AH.handleEvent(e)}},bu=class{constructor(e,t,s){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(e){vs(this,e)}};const yu={I:ea},rd=Oo.litHtmlPolyfillSupport;rd==null||rd(In,ea),((Fa=Oo.litHtmlVersions)!==null&&Fa!==void 0?Fa:Oo.litHtmlVersions=[]).push("2.8.0");const fo=(i,e,t)=>{var s,r;const o=(s=t==null?void 0:t.renderBefore)!==null&&s!==void 0?s:e;let a=o._$litPart$;if(a===void 0){const l=(r=t==null?void 0:t.renderBefore)!==null&&r!==void 0?r:null;o._$litPart$=a=new ea(e.insertBefore(Er(),l),l,void 0,t??{})}return a._$AI(i),a};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var za,Ia;let br=class extends ht{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e,t;const s=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=s.firstChild),s}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=fo(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!1)}render(){return Ni}};br.finalized=!0,br._$litElement$=!0,(za=globalThis.litElementHydrateSupport)===null||za===void 0||za.call(globalThis,{LitElement:br});const od=globalThis.litElementPolyfillSupport;od==null||od({LitElement:br});((Ia=globalThis.litElementVersions)!==null&&Ia!==void 0?Ia:globalThis.litElementVersions=[]).push("3.3.3");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const wu=(i,e)=>e.kind==="method"&&e.descriptor&&!("value"in e.descriptor)?{...e,finisher(t){t.createProperty(e.key,i)}}:{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){typeof e.initializer=="function"&&(this[e.key]=e.initializer.call(this))},finisher(t){t.createProperty(e.key,i)}},$u=(i,e,t)=>{e.constructor.createProperty(t,i)};function E(i){return(e,t)=>t!==void 0?$u(i,e,t):wu(i,e)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function xe(i){return E({...i,state:!0})}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Ye(i,e){return Ml({descriptor:t=>({get(){var r,o;return(o=(r=this.renderRoot)===null||r===void 0?void 0:r.querySelector(i))!==null&&o!==void 0?o:null},enumerable:!0,configurable:!0})})}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function xu(i){return Ml({descriptor:e=>({get(){var t,s;return(s=(t=this.renderRoot)===null||t===void 0?void 0:t.querySelectorAll(i))!==null&&s!==void 0?s:[]},enumerable:!0,configurable:!0})})}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Na;const Su=((Na=window.HTMLSlotElement)===null||Na===void 0?void 0:Na.prototype.assignedElements)!=null?(i,e)=>i.assignedElements(e):(i,e)=>i.assignedNodes(e).filter(t=>t.nodeType===Node.ELEMENT_NODE);function h1(i){const{slot:e,selector:t}=i??{};return Ml({descriptor:s=>({get(){var r;const o="slot"+(e?`[name=${e}]`:":not([name])"),a=(r=this.renderRoot)===null||r===void 0?void 0:r.querySelector(o),l=a!=null?Su(a,i):[];return t?l.filter(n=>n.matches(t)):l},enumerable:!0,configurable:!0})})}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const _u={CHILD:2},Cu=i=>(...e)=>({_$litDirective$:i,values:e});let Tu=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,s){this._$Ct=e,this._$AM=t,this._$Ci=s}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}};/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{I:Au}=yu,ad=()=>document.createComment(""),Qs=(i,e,t)=>{var s;const r=i._$AA.parentNode,o=e===void 0?i._$AB:e._$AA;if(t===void 0){const a=r.insertBefore(ad(),o),l=r.insertBefore(ad(),o);t=new Au(a,l,i,i.options)}else{const a=t._$AB.nextSibling,l=t._$AM,n=l!==i;if(n){let c;(s=t._$AQ)===null||s===void 0||s.call(t,i),t._$AM=i,t._$AP!==void 0&&(c=i._$AU)!==l._$AU&&t._$AP(c)}if(a!==o||n){let c=t._$AA;for(;c!==a;){const d=c.nextSibling;r.insertBefore(c,o),c=d}}}return t},pi=(i,e,t=i)=>(i._$AI(e,t),i),ku={},Eu=(i,e=ku)=>i._$AH=e,Mu=i=>i._$AH,Ha=i=>{var e;(e=i._$AP)===null||e===void 0||e.call(i,!1,!0);let t=i._$AA;const s=i._$AB.nextSibling;for(;t!==s;){const r=t.nextSibling;t.remove(),t=r}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const nd=(i,e,t)=>{const s=new Map;for(let r=e;r<=t;r++)s.set(i[r],r);return s},Pu=Cu(class extends Tu{constructor(i){if(super(i),i.type!==_u.CHILD)throw Error("repeat() can only be used in text expressions")}ct(i,e,t){let s;t===void 0?t=e:e!==void 0&&(s=e);const r=[],o=[];let a=0;for(const l of i)r[a]=s?s(l,a):a,o[a]=t(l,a),a++;return{values:o,keys:r}}render(i,e,t){return this.ct(i,e,t).values}update(i,[e,t,s]){var r;const o=Mu(i),{values:a,keys:l}=this.ct(e,t,s);if(!Array.isArray(o))return this.ut=l,a;const n=(r=this.ut)!==null&&r!==void 0?r:this.ut=[],c=[];let d,h,f=0,g=o.length-1,y=0,$=a.length-1;for(;f<=g&&y<=$;)if(o[f]===null)f++;else if(o[g]===null)g--;else if(n[f]===l[y])c[y]=pi(o[f],a[y]),f++,y++;else if(n[g]===l[$])c[$]=pi(o[g],a[$]),g--,$--;else if(n[f]===l[$])c[$]=pi(o[f],a[$]),Qs(i,c[$+1],o[f]),f++,$--;else if(n[g]===l[y])c[y]=pi(o[g],a[y]),Qs(i,o[f],o[g]),g--,y++;else if(d===void 0&&(d=nd(l,y,$),h=nd(n,f,g)),d.has(n[f]))if(d.has(n[g])){const A=h.get(l[y]),O=A!==void 0?o[A]:null;if(O===null){const P=Qs(i,o[f]);pi(P,a[y]),c[y]=P}else c[y]=pi(O,a[y]),Qs(i,o[f],O),o[A]=null;y++}else Ha(o[g]),g--;else Ha(o[f]),f++;for(;y<=$;){const A=Qs(i,c[$+1]);pi(A,a[y]),c[y++]=A}for(;f<=g;){const A=o[f++];A!==null&&Ha(A)}return this.ut=l,Eu(i,c),Ni}});function ro(i,e,t){return Array.from({length:(e-i)/t+1},(s,r)=>i+r*t)}let Rt=class extends br{constructor(){super(...arguments),this.itemCount=0,this.scrollOptimizationsDisabled=!1,this.intersectionObserver=new IntersectionObserver(e=>{e.forEach(t=>{if(t.target===this.sentinel){t.isIntersecting&&this.dispatchEvent(new Event("scrollThresholdReached"));return}const r=t.target.dataset.cellIndex;if(!r)return;const o=parseInt(r,10);t.isIntersecting?this.visibleCellIndices.add(o):this.visibleCellIndices.delete(o)}),this.scrollOptimizationsDisabled||this.processVisibleCells()}),this.renderedCellIndices=new Set,this.visibleCellIndices=new Set,this.placeholderCellIndices=new Set}reload(){ro(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.removeCell(t)),this.renderedCellIndices.clear(),this.visibleCellIndices.clear(),this.placeholderCellIndices.clear(),this.setupObservations()}refreshCell(e){this.removeCell(e),this.bufferRange.includes(e)&&this.renderCellBuffer([e])}refreshAllVisibleCells(){this.bufferRange.forEach(e=>this.removeCell(e)),this.renderCellBuffer(this.bufferRange)}scrollToCell(e,t){const s=this.cellContainers[e];if(!s)return!1;const r=t?"smooth":"auto";return s.scrollIntoView({behavior:r}),!0}getVisibleCellIndices(){return Array.from(this.visibleCellIndices)}updated(e){(e.has("itemCount")||e.has("scrollOptimizationsDisabled"))&&this.setupObservations()}disconnectedCallback(){this.intersectionObserver.disconnect()}setupObservations(){this.setupIntersectionObserver()}setupIntersectionObserver(){this.intersectionObserver.disconnect(),this.sentinel&&this.intersectionObserver.observe(this.sentinel),this.scrollOptimizationsDisabled?(ro(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.visibleCellIndices.add(t)),this.processVisibleCells()):this.cellContainers.forEach(e=>this.intersectionObserver.observe(e))}render(){var e;const t=this.itemCount-1,s=ro(0,t,1),r=(e=this.ariaLandmarkLabel)!==null&&e!==void 0?e:we;return id`
    ...
    `}};p([E({type:Number})],Rt.prototype,"itemCount",void 0);p([E({type:Object})],Rt.prototype,"cellProvider",void 0);p([E({type:Object})],Rt.prototype,"placeholderCellTemplate",void 0);p([E({type:Boolean})],Rt.prototype,"scrollOptimizationsDisabled",void 0);p([E({type:String})],Rt.prototype,"ariaLandmarkLabel",void 0);p([Ye("#sentinel")],Rt.prototype,"sentinel",void 0);p([xu(".cell-container")],Rt.prototype,"cellContainers",void 0);Rt=p([At("infinite-scroller")],Rt);function Ou(i){return i==null?void 0:i.replace(/%22%22(?!%22%22)(.+?)%22%22/g,"%22$1%22")}function Du(i){var e,t;return((e=i==null?void 0:i.rawMetadata)==null?void 0:e.hit_type)==="favorited_search"?"search":((t=i.mediatype)==null?void 0:t.value)??"data"}const Lu=G`
  <svg
    viewBox="0 0 100 100"
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{I:e2}=P0,ud=i=>i,$1=i=>i.strings===void 0,fd=()=>document.createComment(""),Ks=(i,e,t)=>{var o;const s=i._$AA.parentNode,r=e===void 0?i._$AB:e._$AA;if(t===void 0){const a=s.insertBefore(fd(),r),l=s.insertBefore(fd(),r);t=new e2(a,l,i,i.options)}else{const a=t._$AB.nextSibling,l=t._$AM,n=l!==i;if(n){let c;(o=t._$AQ)==null||o.call(t,i),t._$AM=i,t._$AP!==void 0&&(c=i._$AU)!==l._$AU&&t._$AP(c)}if(a!==r||n){let c=t._$AA;for(;c!==a;){const d=ud(c).nextSibling;ud(s).insertBefore(c,r),c=d}}}return t},ui=(i,e,t=i)=>(i._$AI(e,t),i),t2={},x1=(i,e=t2)=>i._$AH=e,i2=i=>i._$AH,Ua=i=>{i._$AR(),i._$AA.remove()};/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const s2=jr(class extends Wr{constructor(i){if(super(i),i.type!==_t.PROPERTY&&i.type!==_t.ATTRIBUTE&&i.type!==_t.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!$1(i))throw Error("`live` bindings can only contain a single expression")}render(i){return i}update(i,[e]){if(e===et||e===oe)return e;const t=i.element,s=i.name;if(i.type===_t.PROPERTY){if(e===t[s])return et}else if(i.type===_t.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(s))return et}else if(i.type===_t.ATTRIBUTE&&t.getAttribute(s)===e+"")return et;return x1(i),e}});/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function mo(i,e,t){return i?e(i):t==null?void 0:t(i)}function r2(i,e){return e.some(t=>i.has(t))}function o2(i,e){const t=[...i],s=[...e],r=t.length,o=s.length;if(r===0)return!0;let a=0,l=0;for(;l<o;){if(s[l]===t[a]&&(a+=1),a>=r)return!0;l+=1}return!1}const S1=w`
  :host {
    /*
    BASE STYLES
...
`,a2="data:image/svg+xml,%3csvg%20viewBox='0%200%208%204'%20xmlns='http://www.w3.org/2000/svg'%20%3e%3cpath%20d='m6.7226499.58397485c.22976435-.15317623.54019902-.09108929.69337525.13867505.13615665.20423498.10222882.47220947-.06836249.63681849l-.07031256.05655676-3.2773501%202.18490006-3.2773501-2.18490006c-.22976434-.15317623-.29185128-.4636109-.13867505-.69337525.13615665-.20423497.39656688-.27598409.61412572-.18182636l.07924953.04315131%202.7226499%201.81402515z'%20%3e%3c/path%3e%3c/svg%3e",n2="data:image/svg+xml,%3csvg%20viewBox='0%200%208%204'%20xmlns='http://www.w3.org/2000/svg'%20%3e%3cpath%20d='m6.7226499%203.51689722c.22976435.15317623.54019902.0910893.69337525-.13867505.13615665-.20423497.10222882-.47220946-.06836249-.63681849l-.07031256-.05655675-3.2773501-2.18490007-3.2773501%202.18490007c-.22976434.15317623-.29185128.4636109-.13867505.69337524.13615665.20423498.39656688.27598409.61412572.18182636l.07924953-.04315131%202.7226499-1.81402514z'%20%3e%3c/path%3e%3c/svg%3e",l2="data:image/svg+xml,%3csvg%20viewBox='0%200%20100%20100'%20xmlns='http://www.w3.org/2000/svg'%20%3e%3cpath%20d='m50%200c27.6142375%200%2050%2022.3857625%2050%2050s-22.3857625%2050-50%2050-50-22.3857625-50-50%2022.3857625-50%2050-50zm23.8159475%2026.1840525c-1.4033215-1.4033215-3.5816761-1.5592461-5.1572272-.4677738l-.5598841.4677738-18.0988362%2018.0989475-18.0988362-18.0989475-.5598841-.4677738c-1.5755511-1.0914723-3.7539057-.9355477-5.1572272.4677738-1.5787367%201.5787367-1.5787367%204.1383746%200%205.7171113l18.0989475%2018.0988362-18.0989475%2018.0988362c-1.5787367%201.5787367-1.5787367%204.1383746%200%205.7171113%201.4033215%201.4033215%203.5816761%201.5592461%205.1572272.4677738l.5598841-.4677738%2018.0988362-18.0989475%2018.0988362%2018.0989475.5598841.4677738c1.5755511%201.0914723%203.7539057.9355477%205.1572272-.4677738%201.5787367-1.5787367%201.5787367-4.1383746%200-5.7171113l-18.0989475-18.0988362%2018.0989475-18.0988362c1.5787367-1.5787367%201.5787367-4.1383746%200-5.7171113z'%20fill-rule='evenodd'%20%3e%3c/path%3e%3c/svg%3e",c2={all:()=>!0,prefix:(i,e)=>e.startsWith(i),suffix:(i,e)=>e.endsWith(i),substring:(i,e)=>e.includes(i),subsequence:o2},d2="list",h2="substring",p2=i=>i,u2=i=>i.toLocaleLowerCase();let ie=class extends H{constructor(){super(),this.options=[],this.behavior=d2,this.maxAutocompleteEntries=Number.POSITIVE_INFINITY,this.filter=h2,this.caseSensitive=!1,this.sort=!1,this.wrapArrowKeys=!1,this.stayOpen=!1,this.clearable=!1,this.open=!1,this.disabled=!1,this.required=!1,this.value=null,this.hasFocus=!1,this.highlightedOption=null,this.enteredText="",this.filterText="",this.losingFocus=!1,this.optionsByID=new Map,this.optionFilteringValues=new Map,this.optionsRespectingSortFlag=[],this.filteredOptions=[],this.internals=this.attachInternals()}render(){const e=Qe({disabled:this.disabled,focused:this.hasFocus});return m`
    ...
    `}get textInputTemplate(){var t;const e=Qe({"clear-padding":this.clearable&&!this.shouldShowClearButton});return m`
      <input
        ...
        aria-activedescendant=${Ge((t=this.highlightedOption)==null?void 0:t.id)}
    ...
    `;return[S1,e]}};ie.formAssociated=!0;ie.shadowRootOptions={...H.shadowRootOptions,delegatesFocus:!0};p([u({type:Array})],ie.prototype,"options",void 0);p([u({type:String})],ie.prototype,"placeholder",void 0);p([u({type:String})],ie.prototype,"behavior",void 0);p([u({type:Number,attribute:"max-autocomplete-entries"})],ie.prototype,"maxAutocompleteEntries",void 0);p([u({type:String})],ie.prototype,"filter",void 0);p([u({type:Boolean,reflect:!0,attribute:"case-sensitive"})],ie.prototype,"caseSensitive",void 0);p([u({type:Boolean,reflect:!0})],ie.prototype,"sort",void 0);p([u({type:Boolean,reflect:!0,attribute:"wrap-arrow-keys"})],ie.prototype,"wrapArrowKeys",void 0);p([u({type:Boolean,reflect:!0,attribute:"stay-open"})],ie.prototype,"stayOpen",void 0);p([u({type:Boolean,reflect:!0})],ie.prototype,"clearable",void 0);p([u({type:Boolean,reflect:!0})],ie.prototype,"open",void 0);p([u({type:Boolean,reflect:!0})],ie.prototype,"disabled",void 0);p([u({type:Boolean,reflect:!0})],ie.prototype,"required",void 0);p([u({type:String})],ie.prototype,"value",void 0);p([R()],ie.prototype,"hasFocus",void 0);p([R()],ie.prototype,"highlightedOption",void 0);p([R()],ie.prototype,"enteredText",void 0);p([R()],ie.prototype,"filterText",void 0);p([Q("#main-widget-row")],ie.prototype,"mainWidgetRow",void 0);p([Q("#text-input")],ie.prototype,"textInput",void 0);p([Q("#options-list")],ie.prototype,"optionsList",void 0);ie=p([N("ia-combo-box")],ie);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const _1=(i,e,t)=>{for(const s of e)if(s[0]===i)return(0,s[1])();return t==null?void 0:t()},f2=G`
...
`;var m2=Object.defineProperty,g2=Object.getOwnPropertyDescriptor,qr=(i,e,t,s)=>{for(var r=s>1?void 0:s?g2(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&m2(e,t,r),r};let fe=class extends H{constructor(){super(...arguments),this.placeholderType=null,this.detailMessage=""}render(){return this.placeholderType?m`${this.placeholderTemplate}`:b}get placeholderTemplate(){return m`
      <div
        class="placeholder ${this.placeholderType} ${this.isMobileView?"mobile":"desktop"}"
      >
        ${_1(this.placeholderType,[["empty-query",()=>this.emptyQueryTemplate],["empty-collection",()=>this.emptyCollectionTemplate],["no-results",()=>this.noResultsTemplate],["query-error",()=>this.queryErrorTemplate],["collection-error",()=>this.collectionErrorTemplate]])}
      </div>
    `}get emptyQueryTemplate(){return m`
      <h2 class="title" data-testid="empty-query-text-msg">
        ${fe.MESSAGE_EMPTY_QUERY}
      </h2>
      <div>${f2}</div>
    `}get emptyCollectionTemplate(){return m`
      <h2 class="title" data-testid="empty-collection-text-msg">
        ${fe.MESSAGE_NO_VIEWABLE_MEMBERS}
      </h2>
      <div>${oo}</div>
    `}get noResultsTemplate(){return m`
      <h2 class="title" data-testid="empty-results-text-msg">
        ${this.isCollection?fe.MESSAGE_NO_COLLECTION_RESULTS:fe.MESSAGE_NO_SEARCH_RESULTS}
      </h2>
      <div>${oo}</div>
    `}get queryErrorTemplate(){return m`
      <h2 class="title" data-testid="error-query-text-msg">
        ${fe.MESSAGE_QUERY_ERROR}
      </h2>
      <div>${oo}</div>
      <p class="error-details">
        ${fe.QUERY_ERROR_DETAILS_MESSAGE} ${this.detailMessage}
      </p>
    `}get collectionErrorTemplate(){return m`
      <h2 class="title" data-testid="error-collection-text-msg">
        ${fe.MESSAGE_COLLECTION_ERROR}
      </h2>
      <div>${oo}</div>
      <p class="error-details">
        ${fe.QUERY_ERROR_DETAILS_MESSAGE} ${this.detailMessage}
    ...
    `}};fe.MESSAGE_EMPTY_QUERY=_('To begin searching, enter a search term in the box above and hit "Go".');fe.MESSAGE_NO_SEARCH_RESULTS=_("Your search did not match any items in the Archive. Try different keywords or a more general search.");fe.MESSAGE_NO_COLLECTION_RESULTS=_("Your search did not match any items in this collection. Try different keywords or a more general search.");fe.MESSAGE_NO_VIEWABLE_MEMBERS=_("This collection contains no viewable items.");fe.MESSAGE_QUERY_ERROR=_(m`The search engine encountered an error, which might be related to your
      search query.
      <a
        href="https://help.archive.org/help/search-building-powerful-complex-queries/"
      >
        Tips for constructing search queries.
      </a> `);fe.MESSAGE_COLLECTION_ERROR=_(m`The search engine encountered an error while loading this collection.
      If the problem persists, please let us know at
      <a href="mailto:info@archive.org">info@archive.org</a>.`);fe.QUERY_ERROR_DETAILS_MESSAGE=_("Error details:");qr([u({type:String})],fe.prototype,"placeholderType",2);qr([u({type:Boolean})],fe.prototype,"isMobileView",2);qr([u({type:Boolean})],fe.prototype,"isCollection",2);qr([u({type:String})],fe.prototype,"detailMessage",2);fe=qr([N("empty-placeholder")],fe);const C1=G`
...
`;var T1=(i=>(i[i.bytes=0]="bytes",i[i.kilobytes=1]="kilobytes",i[i.megabytes=2]="megabytes",i[i.gigabytes=3]="gigabytes",i[i.terabytes=4]="terabytes",i[i.petabytes=5]="petabytes",i[i.exabytes=6]="exabytes",i[i.zettabytes=7]="zettabytes",i[i.yottabytes=8]="yottabytes",i))(T1||{});function v2(i,e,t=" "){let s=i;if(s===void 0)return b;let r=0;for(;s>1024;)s/=1024,r+=1;const o=10**e;s=Math.round(s*o)/o;let a=T1[r];return a=s===1?a.slice(0,-1):a,`${s.toLocaleString()+t+a}`}const b2=w`var(--tileBackgroundColor, #ffffff)`,y2=w`var(--tileCornerRadius, 4px)`,ra=w`
...
`;function A1(i,e="short",{locale:t="en-US",useLocalTime:s=!1}={}){if(!i)return"";const r=s?{}:{timeZone:"UTC"};switch(e){case"year-only":return`${i.getUTCFullYear()}`;case"short":r.month="short",r.year="numeric";break;case"long":r.year="numeric",r.month="short",r.day="2-digit";break}return new Intl.DateTimeFormat(t,r).format(i)}class md{constructor(e={}){this.model=e.model,this.baseNavigationUrl=e.baseNavigationUrl,this.collectionPagePath=e.collectionPagePath??"/details/",this.sortParam=e.sortParam,this.creatorFilter=e.creatorFilter}get firstCreatorMatchingFilter(){var t,s;let e;if(this.creatorFilter&&((t=this.model)!=null&&t.creators.length)){const r=this.creatorFilter;e=this.model.creators.find(o=>o.normalize("NFD").replace(/[^A-Z]+/gi,"").toUpperCase().startsWith(r))}return e??((s=this.model)==null?void 0:s.creator)}get accountLabel(){var e;return(e=this.model)!=null&&e.dateAdded?_(Ct`Archivist since ${this.model.dateAdded.getFullYear()}`):""}get dateLabel(){var e;switch((e=this.sortParam)==null?void 0:e.field){case"publicdate":return _("Archived");case"reviewdate":return _("Reviewed");case"addeddate":return _("Added");case"date":return _("Published");default:return""}}itemPageUrl(e,t=!1){if(!e||this.baseNavigationUrl==null)return b;const s=t?this.collectionPagePath:"/details/";return`${this.baseNavigationUrl}${s}${e}`}webArchivesCaptureLink(e,t){const r=`https://web.archive.org/web/${t.toISOString().replace(/[TZ:-]/g,"").replace(/\..*/,"")}/${encodeURIComponent(e)}`,o=A1(t,"long");return m` <a href=${r}> ${o} </a> `}}var w2=Object.defineProperty,Xe=(i,e,t,s)=>{for(var r=void 0,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=a(e,t,r)||r);return r&&w2(e,t,r),r};class ve extends H{constructor(){super(...arguments),this.sortParam=null,this.defaultSortParam=null,this.loggedIn=!1,this.suppressBlurring=!1,this.useLocalTime=!1,this.displayValueProvider=new md}willUpdate(e){(e.has("model")||e.has("baseNavigationUrl")||e.has("collectionPagePath")||e.has("sortParam")||e.has("defaultSortParam")||e.has("creatorFilter"))&&(this.displayValueProvider=new md({model:this.model,baseNavigationUrl:this.baseNavigationUrl,collectionPagePath:this.collectionPagePath,sortParam:this.sortParam??this.defaultSortParam??void 0,creatorFilter:this.creatorFilter}))}getFormattedDate(e,t){const{useLocalTime:s}=this;return A1(e,t,{useLocalTime:s})}}Xe([u({type:Object})],ve.prototype,"model");Xe([u({type:Number})],ve.prototype,"currentWidth");Xe([u({type:Number})],ve.prototype,"currentHeight");Xe([u({type:String})],ve.prototype,"baseNavigationUrl");Xe([u({type:String})],ve.prototype,"baseImageUrl");Xe([u({type:String})],ve.prototype,"collectionPagePath");Xe([u({type:Object})],ve.prototype,"sortParam");Xe([u({type:Object})],ve.prototype,"defaultSortParam");Xe([u({type:String})],ve.prototype,"creatorFilter");Xe([u({type:Number})],ve.prototype,"mobileBreakpoint");Xe([u({type:Boolean})],ve.prototype,"loggedIn");Xe([u({type:Boolean})],ve.prototype,"suppressBlurring");Xe([u({type:Boolean})],ve.prototype,"useLocalTime");var $2=Object.defineProperty,x2=Object.getOwnPropertyDescriptor,k1=(i,e,t,s)=>{for(var r=s>1?void 0:s?x2(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&$2(e,t,r),r};let Wn=class extends H{render(){return m`<div class="icon-overlay">${this.iconTemplate}</div>`}get iconTemplate(){return this.type?m`${p1[this.type]??b}`:b}static get styles(){return w`
      :host {
        position: absolute;
        top: 50%;
        left: 50%;
    ...
    `}};k1([u({type:String})],Wn.prototype,"type",2);Wn=k1([N("icon-overlay")],Wn);var S2=Object.defineProperty,_2=Object.getOwnPropertyDescriptor,E1=(i,e,t,s)=>{for(var r=s>1?void 0:s?_2(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&S2(e,t,r),r};let qn=class extends H{render(){return m`
      <div class="overlay no-preview">
        <div class="icon-overlay">${this.iconTemplate}</div>
        <p class="text-overlay">${this.textTemplate}</p>
      </div>
    `}get iconTemplate(){return this.type?m`${p1[this.type]??b}`:b}get textTemplate(){return this.type?m`${Fu[this.type]??b}`:b}static get styles(){return w`
      :host {
        align-items: center;
        display: flex;
      }
    ...
    `}};E1([u({type:String})],qn.prototype,"type",2);qn=E1([N("text-overlay")],qn);var C2=Object.defineProperty,T2=Object.getOwnPropertyDescriptor,ai=(i,e,t,s)=>{for(var r=s>1?void 0:s?T2(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&C2(e,t,r),r};let zt=class extends H{constructor(){super(...arguments),this.isCompactTile=!1,this.isListTile=!1,this.loggedIn=!1,this.suppressBlurring=!1,this.viewSize="desktop"}render(){var i;return(i=this.model)!=null&&i.identifier?m`
    ...
    `}};ai([u({type:String})],zt.prototype,"baseImageUrl",2);ai([u({type:Boolean})],zt.prototype,"isCompactTile",2);ai([u({type:Boolean})],zt.prototype,"isListTile",2);ai([u({type:Boolean})],zt.prototype,"loggedIn",2);ai([u({type:Boolean})],zt.prototype,"suppressBlurring",2);ai([u({type:Object})],zt.prototype,"model",2);ai([u({type:String})],zt.prototype,"viewSize",2);zt=ai([N("image-block")],zt);var A2=Object.defineProperty,k2=Object.getOwnPropertyDescriptor,Ll=(i,e,t,s)=>{for(var r=s>1?void 0:s?k2(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&A2(e,t,r),r};let Fo=class extends ve{constructor(){super(...arguments),this.showInfoButton=!1,this.layoutType="default"}render(){const i=Qe({container:!0,minimal:this.layoutType==="minimal"});return m`
      <div class=${i}>
    ...
    >`}get getSizeTemplate(){var e;const i=((e=this.model)==null?void 0:e.collectionSize)??0;return i?m`<span id="item-size">${v2(i,1)}</span>`:""}get infoButtonTemplate(){return this.showInfoButton?m`<button class="info-button" @click=${this.infoButtonPressed}>
          &#9432;
          <span class="sr-only">${_("More info")}</span>
        </button>`:b}infoButtonPressed(i){i.preventDefault();const e=new CustomEvent("infoButtonPressed",{detail:{x:i.clientX,y:i.clientY}});this.dispatchEvent(e)}static get styles(){const i=w`var(--tileBorderColor, #555555)`,e=w`var(--tileBackgroundColor, #666666)`,t=w`#fff`;return[ra,w`
        .container {
          background-color: ${e};
          border: 1px solid ${i};
        }
      ...
      `]}};Ll([u({type:Boolean})],Fo.prototype,"showInfoButton",2);Ll([u({type:String})],Fo.prototype,"layoutType",2);Fo=Ll([N("collection-tile")],Fo);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*Li(i,e){if(i!==void 0){let t=0;for(const s of i)yield e(s,t++)}}function Bl(i){return i?i.toISOString().endsWith("-01-01T00:00:00.000Z"):!1}const M1=m`
...
`;var M2=Object.defineProperty,P2=Object.getOwnPropertyDescriptor,Gr=(i,e,t,s)=>{for(var r=s>1?void 0:s?P2(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&M2(e,t,r),r};let bs=class extends H{constructor(){super(...arguments),this.title="",this.body="",this.starRating=0,this.viewSize="desktop"}render(){return!this.title&&!this.body&&!this.starRating?b:m`
    ...
    `}get filledStarTemplate(){return m`<span aria-hidden="true">${M1}</span>`}get unfilledStarTemplate(){return m`
      <span class="unfilled-star" aria-hidden="true">
        ${E2}
      </span>
    `}static get styles(){return[yt,w`
        .review-container {
          display: flex;
          flex-direction: row;
          flex-wrap: wrap;
      ...
      `]}};Gr([u({type:String})],bs.prototype,"title",2);Gr([u({type:String})],bs.prototype,"body",2);Gr([u({type:Number})],bs.prototype,"starRating",2);Gr([u({type:String})],bs.prototype,"viewSize",2);bs=Gr([N("review-block")],bs);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*go(i,e){const t=typeof e=="function";if(i!==void 0){let s=-1;for(const r of i)s>-1&&(yield t?e(s):e),s++,yield r}}var O2=Object.defineProperty,D2=Object.getOwnPropertyDescriptor,Fl=(i,e,t,s)=>{for(var r=s>1?void 0:s?D2(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&O2(e,t,r),r};let Ro=class extends H{constructor(){super(...arguments),this.snippets=[],this.viewSize="desktop"}render(){var i;return(i=this.snippets)!=null&&i.length?m`
      <div class="container">
        <div class="snippet-view ${this.viewSize}">
    ...
    `}get snippetTemplates(){var i;return(i=this.snippets)==null?void 0:i.map(e=>{const t=e.matchAll(/{{{(.+?)}}}/gs),s=[];let r=0;for(const o of t)o.index!=null&&(s.push(m`
            ${e.slice(r,o.index)}
            <mark>${o[1]}</mark>
          `),r=o.index+o[0].length);return s.push(m`${e.slice(r)}`),m`<span>${s}</span>`})}static get styles(){return w`
      .container {
        display: flex;
        flex-direction: row;
        flex-wrap: wrap;
    ...
    `}};Fl([u({type:Array})],Ro.prototype,"snippets",2);Fl([u({type:String})],Ro.prototype,"viewSize",2);Ro=Fl([N("text-snippet-block")],Ro);const L2=w`
  .drop-shadow {
    overflow: hidden;
    height: 100%;
  }
...
`;var F2=Object.defineProperty,R2=Object.getOwnPropertyDescriptor,kt=(i,e,t,s)=>{for(var r=s>1?void 0:s?R2(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&F2(e,t,r),r};let mt=class extends H{constructor(){super(...arguments),this.isListTile=!1,this.isCompactTile=!1,this.loggedIn=!1,this.suppressBlurring=!1,this.isWaveform=!1,this.isNotFound=!1}render(){return m`
      <div class=${Qe(this.itemBaseClass)}>${this.imageTemplate}</div>
    `}get imageTemplate(){var i;return((i=this.model)==null?void 0:i.mediatype)==="search"?m`${P1}`:m`
      <img
    ...
    `}get imageSrc(){var i,e,t;if(this.isNotFound)return this.notFoundSrc;if((i=this.model)!=null&&i.captureDates&&this.model.identifier)try{const s=new URL(this.model.identifier),r=encodeURIComponent(s.hostname);return this.baseImageUrl?`https://web.archive.org/thumb/${r}?generate=1`:b}catch{return`${this.baseImageUrl}/images/notfound.png`}return(e=this.model)!=null&&e.thumbnailUrl?this.model.thumbnailUrl:this.baseImageUrl&&((t=this.model)!=null&&t.identifier)?`${this.baseImageUrl}/services/img/${this.model.identifier}`:b}get notFoundSrc(){return this.baseImageUrl?`${this.baseImageUrl}/images/notfound.png`:b}get hashBasedGradient(){var e;return(e=this.model)!=null&&e.identifier?`waveform-grad${this.hashStrToInt(this.model.identifier)%6}`:"waveform-grad0"}hashStrToInt(i){return i.split("").reduce((e,t)=>e+t.charCodeAt(0),0)}get itemBaseClass(){var i;return{"drop-shadow":!0,"list-box":this.isListTile,"search-image":((i=this.model)==null?void 0:i.mediatype)==="search",[this.hashBasedGradient]:this.isWaveform}}get itemImageClass(){var t,s,r;const e=!!((t=this.model)!=null&&t.contentWarning||(s=this.model)!=null&&s.loginRequired)&&!this.suppressBlurring;return{contain:!this.isCompactTile&&!this.isWaveform,cover:this.isCompactTile,blur:e,waveform:this.isWaveform,"account-image":this.isAccountImage,"collection-image":((r=this.model)==null?void 0:r.mediatype)==="collection"}}get isAccountImage(){var i;return((i=this.model)==null?void 0:i.mediatype)==="account"&&!this.isCompactTile&&!this.isListTile}onLoad(){var i,e;(((i=this.model)==null?void 0:i.mediatype)==="audio"||((e=this.model)==null?void 0:e.mediatype)==="etree")&&this.baseImage.naturalWidth/this.baseImage.naturalHeight===4&&(this.isWaveform=!0)}onError(){this.isNotFound=!0}static get styles(){return[L2,B2,w`
      ...
      `]}};kt([u({type:Object})],mt.prototype,"model",2);kt([u({type:String})],mt.prototype,"baseImageUrl",2);kt([u({type:Boolean})],mt.prototype,"isListTile",2);kt([u({type:Boolean})],mt.prototype,"isCompactTile",2);kt([u({type:Boolean})],mt.prototype,"loggedIn",2);kt([u({type:Boolean})],mt.prototype,"suppressBlurring",2);kt([R()],mt.prototype,"isWaveform",2);kt([R()],mt.prototype,"isNotFound",2);kt([Q("img")],mt.prototype,"baseImage",2);mt=kt([N("item-image")],mt);const z2=G`
...
`,O1={account:{color:"#000000",icon:z2,text:"Account"},audio:{color:"#00adef",icon:I2,text:"Audio"},collection:{color:"#4666ff",icon:C1,text:"Collection"},data:{color:"#333333",icon:N2,text:"Data"},etree:{color:"#00adef",icon:H2,text:"E-tree"},film:{color:"#bf1b2c",icon:gd,text:"Film"},image:{color:"#aa99c9",icon:U2,text:"Image"},movies:{color:"#f1644b",icon:gd,text:"Movie"},none:{color:"#00000000",icon:m``,text:""},radio:{color:"#8fdaef",icon:V2,text:"Radio"},software:{color:"#9ecc4f",icon:j2,text:"Software"},texts:{color:"#faab3c",icon:W2,text:"Text"},tv:{color:"#f1644b",icon:q2,text:"TV"},tvCommercial:{color:"#84b648",icon:G2,text:"TV Commercial"},tvFactCheck:{color:"#f1644b",icon:Y2,text:"TV Fact Check"},tvQuote:{color:"#fe7a5f",icon:X2,text:"TV Quote"},video:{color:"#f1644b",icon:Q2,text:"Video"},web:{color:"#ffcd27",icon:K2,text:"Web"},search:{color:"#000000",icon:P1,text:"Search"}};var Z2=Object.defineProperty,J2=Object.getOwnPropertyDescriptor,Rl=(i,e,t,s)=>{for(var r=s>1?void 0:s?J2(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&Z2(e,t,r),r};const e3="tv_ads",t3="factchecked",i3=new Set(["tvnews","tvarchive","television"]),s3=new Set(["radio","radioprogram"]);let zo=class extends H{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var i;return this.isTvItem?this.tvDisplayMediatype:this.isRadioItem?"radio":((i=this.model)==null?void 0:i.mediatype)??"none"}get tvDisplayMediatype(){var i,e;return this.isTvCommercial?"tvCommercial":(i=this.model)!=null&&i.isTvSearchResult&&this.isTvFactCheck?"tvFactCheck":(e=this.model)!=null&&e.isTvSearchResult&&this.isTvQuote?"tvQuote":"tv"}get isTvItem(){var i,e;return!!(((i=this.model)==null?void 0:i.mediatype)==="movies"&&((e=this.model)!=null&&e.collections.some(t=>i3.has(t))))}get isTvCommercial(){var i,e,t;return!!((e=(i=this.model)==null?void 0:i.adIds)!=null&&e.length||(t=this.model)!=null&&t.collections.includes(e3))}get isTvFactCheck(){var i,e,t;return!!((e=(i=this.model)==null?void 0:i.factChecks)!=null&&e.length||(t=this.model)!=null&&t.collections.includes(t3))}get isTvQuote(){var i;return!!((i=this.model)!=null&&i.isClip)}get isRadioItem(){var i,e;return!!(((i=this.model)==null?void 0:i.mediatype)==="audio"&&((e=this.model)!=null&&e.collections.some(t=>s3.has(t))))}render(){const i=O1[this.displayMediatype];return i?m`
      <div
        id="icon"
    ...
    `}};Rl([u({type:Object})],zo.prototype,"model",2);Rl([u({type:Boolean})],zo.prototype,"showText",2);zo=Rl([N("tile-mediatype-icon")],zo);const r3=G`
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path
...
`;function l3(i,e){let t=1;return i>=1e9?t=1e9:i>=1e6?t=1e6:i>=1e3&&e==="short"&&(t=1e3),t}function c3(i=0,e){const t=i/e,s=t<10;let r=0;return s?r=Math.round((t+Number.EPSILON)*10)/10:r=Math.round(t),r}function d3(i,e,t,s){switch(e){case 1e9:return _(t==="short"?Ct`${i}B`:Ct`${i} billion`);case 1e6:return _(t==="short"?Ct`${i}M`:Ct`${i} million`);case 1e3:return _(t==="short"?Ct`${i}K`:Ct`${i} thousand`);default:return new Intl.NumberFormat(s).format(i)}}function zl(i,e="long",t="short",s="en-US"){const r=i??-1;if(r<0)return"";const o=l3(r,e),a=c3(r,o);return d3(a,o,t,s)}var h3=Object.defineProperty,p3=Object.getOwnPropertyDescriptor,Et=(i,e,t,s)=>{for(var r=s>1?void 0:s?p3(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&h3(e,t,r),r};let gt=class extends H{constructor(){super(...arguments),this.showTvClips=!1}render(){return m`
    ...
    `}columnTemplate(i,e,t,s=[]){const r=zl(i??0,"short","short"),o=_(Ct`${r} ${e}`),a=e+":";return m`
    ...
    `}get viewsColumnTemplate(){const i=this.viewLabel??_("all-time views");return this.columnTemplate(this.viewCount,i,a3)}get uploadsColumnTemplate(){return this.columnTemplate(this.itemCount,_("uploads"),o3)}get favoritesColumnTemplate(){return this.columnTemplate(this.favCount,_("favorites"),M1)}get reviewsColumnTemplate(){return this.columnTemplate(this.commentCount,_("reviews"),r3,["reviews"])}get tvClipsColumnTemplate(){return this.columnTemplate(this.tvClipCount,_("clips"),n3)}static get styles(){return[yt,w`
        tile-mediatype-icon {
          --iconHeight: 25px;
          --iconWidth: 25px;
        }
      ...
      `]}};Et([u({type:Object})],gt.prototype,"model",2);Et([u({type:String})],gt.prototype,"mediatype",2);Et([u({type:Number})],gt.prototype,"itemCount",2);Et([u({type:Number})],gt.prototype,"viewCount",2);Et([u({type:String})],gt.prototype,"viewLabel",2);Et([u({type:Number})],gt.prototype,"favCount",2);Et([u({type:Number})],gt.prototype,"commentCount",2);Et([u({type:Boolean})],gt.prototype,"showTvClips",2);Et([u({type:Number})],gt.prototype,"tvClipCount",2);gt=Et([N("tile-stats")],gt);var u3=Object.defineProperty,f3=Object.getOwnPropertyDescriptor,oa=(i,e,t,s)=>{for(var r=s>1?void 0:s?f3(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&u3(e,t,r),r};let Pr=class extends ve{constructor(){super(...arguments),this.showInfoButton=!1,this.showTvClips=!1,this.layoutType="default"}render(){var t;const i=(t=this.model)==null?void 0:t.title,e=Qe({container:!0,simple:this.layoutType!=="default","stats-only":this.layoutType==="stats-only","snippets-only":this.layoutType==="snippets-only",minimal:this.layoutType==="minimal"});return m`
      <div class=${e}>
        ${this.infoButtonTemplate}
        <div class="tile-details">
          <div class="item-info">
    ...
    `}get isSortedByDate(){var i;return["date","reviewdate","addeddate","publicdate"].includes((i=this.effectiveSort)==null?void 0:i.field)}get effectiveSort(){return this.sortParam??this.defaultSortParam}get hasSnippets(){var i,e;return!!((e=(i=this.model)==null?void 0:i.snippets)!=null&&e.length)}infoButtonPressed(i){i.preventDefault();const e=new CustomEvent("infoButtonPressed",{detail:{x:i.clientX,y:i.clientY}});this.dispatchEvent(e)}static get styles(){const i=w`var(--tileBorderColor, #dddddd)`;return[ra,w`
      ...
      `]}};oa([u({type:Boolean})],Pr.prototype,"showInfoButton",2);oa([u({type:Boolean})],Pr.prototype,"showTvClips",2);oa([u({type:String})],Pr.prototype,"layoutType",2);Pr=oa([N("item-tile")],Pr);var m3=Object.defineProperty,g3=Object.getOwnPropertyDescriptor,D1=(i,e,t,s)=>{for(var r=s>1?void 0:s?g3(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&m3(e,t,r),r};let Gn=class extends ve{constructor(){super(...arguments),this.showInfoButton=!1}render(){return m`
      <div class="container">
        ${this.infoButtonTemplate}
        <div class="tile-details">
          <div class="item-info">
    ...
    >
          ...
          &#9432;
          <span class="sr-only">${_("More info")}</span>
        </button>`:b}infoButtonPressed(i){i.preventDefault();const e=new CustomEvent("infoButtonPressed",{detail:{x:i.clientX,y:i.clientY}});this.dispatchEvent(e)}static get styles(){const i=w`var(--tileBorderColor, #dddddd)`;return[ra,w`
        .container {
          border: 1px solid ${i};
        }
      `]}};D1([u({type:Boolean})],Gn.prototype,"showInfoButton",2);Gn=D1([N("account-tile")],Gn);var v3=Object.defineProperty,b3=Object.getOwnPropertyDescriptor,L1=(i,e,t,s)=>{for(var r=s>1?void 0:s?b3(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&v3(e,t,r),r};let Yn=class extends ve{constructor(){super(...arguments),this.showInfoButton=!1}render(){return m`
      <div class="container">
        <div class="tile-details">
          <div class="item-info">
            ${this.getImageBlockTemplate} ${this.getTitleTemplate}
    ...
    `}get getTitleTemplate(){var i;return m`<div id="title">
      <h3 class="truncated">${(i=this.model)==null?void 0:i.title}</h3>
    </div>`}static get styles(){const i=w`var(--tileBorderColor, #555555)`,e=w`var(--tileBackgroundColor, #666666)`,t=w`#fff`;return[ra,w`
        .container {
          background-color: ${e};
          border: 1px solid ${i};
        }
      ...
      `]}};L1([u({type:Boolean})],Yn.prototype,"showInfoButton",2);Yn=L1([N("search-tile")],Yn);function vo(i,e,t,s=20,r=0){let o=[];if(r>=s)return o;const a=n=>{const c=n.assignedNodes().filter(d=>d.nodeType===1);return c.length>0?vo(c[0].parentElement,e,t,s,r+1):[]},l=Array.from(i.children||[]);for(const n of l)e(n)||(t(n)&&o.push(n),n.shadowRoot!=null?o.push(...vo(n.shadowRoot,e,t,s,r+1)):n.tagName==="SLOT"?o.push(...a(n)):o.push(...vo(n,e,t,s,r+1)));return o}function B1(i){return i.hasAttribute("hidden")||i.hasAttribute("aria-hidden")&&i.getAttribute("aria-hidden")!=="false"||i.style.display==="none"||i.style.opacity==="0"||i.style.visibility==="hidden"||i.style.visibility==="collapse"}function y3(i){return i.hasAttribute("disabled")||i.hasAttribute("aria-disabled")&&i.getAttribute("aria-disabled")!=="false"}function w3(i){return i.getAttribute("tabindex")==="-1"||B1(i)||y3(i)?!1:i.hasAttribute("tabindex")||(i instanceof HTMLAnchorElement||i instanceof HTMLAreaElement)&&i.hasAttribute("href")||i instanceof HTMLButtonElement||i instanceof HTMLInputElement||i instanceof HTMLTextAreaElement||i instanceof HTMLSelectElement||i instanceof HTMLIFrameElement}const Va=new Map;function $3(i,e,t){const s=Va.get(t);s!=null&&window.clearTimeout(s),Va.set(t,window.setTimeout(()=>{i(),Va.delete(t)},e))}const F1=document.createElement("template");F1.innerHTML=`
	<div id="start"></div>
	<div id="backup"></div>
	<slot></slot>
	<div id="end"></div>
`;class x3 extends HTMLElement{constructor(){super(),this.debounceId=Math.random().toString(),this._focused=!1;const e=this.attachShadow({mode:"open"});e.appendChild(F1.content.cloneNode(!0)),this.$backup=e.querySelector("#backup"),this.$start=e.querySelector("#start"),this.$end=e.querySelector("#end"),this.focusLastElement=this.focusLastElement.bind(this),this.focusFirstElement=this.focusFirstElement.bind(this),this.onFocusIn=this.onFocusIn.bind(this),this.onFocusOut=this.onFocusOut.bind(this)}static get observedAttributes(){return["inactive"]}get inactive(){return this.hasAttribute("inactive")}set inactive(e){e?this.setAttribute("inactive",""):this.removeAttribute("inactive")}get focused(){return this._focused}connectedCallback(){this.$start.addEventListener("focus",this.focusLastElement),this.$end.addEventListener("focus",this.focusFirstElement),this.addEventListener("focusin",this.onFocusIn),this.addEventListener("focusout",this.onFocusOut),this.render()}disconnectedCallback(){this.$start.removeEventListener("focus",this.focusLastElement),this.$end.removeEventListener("focus",this.focusFirstElement),this.removeEventListener("focusin",this.onFocusIn),this.removeEventListener("focusout",this.onFocusOut)}attributeChangedCallback(){this.render()}focusFirstElement(){this.trapFocus()}focusLastElement(){this.trapFocus(!0)}getFocusableElements(){return vo(this,B1,w3)}trapFocus(e){if(this.inactive)return;let t=this.getFocusableElements();t.length>0?(e?t[t.length-1].focus():t[0].focus(),this.$backup.setAttribute("tabindex","-1")):(this.$backup.setAttribute("tabindex","0"),this.$backup.focus())}onFocusIn(){this.updateFocused(!0)}onFocusOut(){this.updateFocused(!1)}updateFocused(e){$3(()=>{this.focused!==e&&(this._focused=e,this.render())},0,this.debounceId)}render(){this.$start.setAttribute("tabindex",!this.focused||this.inactive?"-1":"0"),this.$end.setAttribute("tabindex",!this.focused||this.inactive?"-1":"0"),this.focused?this.setAttribute("focused",""):this.removeAttribute("focused")}}window.customElements.define("focus-trap",x3);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let Qn=class extends Wr{constructor(e){if(super(e),this.it=oe,e.type!==_t.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===oe||e==null)return this._t=void 0,this.it=e;if(e===et)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this._t;this.it=e;const t=[e];return t.raw=t,this._t={_$litType$:this.constructor.resultType,strings:t,values:[]}}};Qn.directiveName="unsafeHTML",Qn.resultType=1;const S3=jr(Qn);/*! @license DOMPurify 3.2.4 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/3.2.4/LICENSE */const{entries:R1,setPrototypeOf:vd,isFrozen:_3,getPrototypeOf:C3,getOwnPropertyDescriptor:T3}=Object;let{freeze:Ne,seal:it,create:z1}=Object,{apply:Kn,construct:Xn}=typeof Reflect<"u"&&Reflect;Ne||(Ne=function(e){return e});it||(it=function(e){return e});Kn||(Kn=function(e,t,s){return e.apply(t,s)});Xn||(Xn=function(e,t){return new e(...t)});const ao=He(Array.prototype.forEach),A3=He(Array.prototype.lastIndexOf),bd=He(Array.prototype.pop),Xs=He(Array.prototype.push),k3=He(Array.prototype.splice),bo=He(String.prototype.toLowerCase),ja=He(String.prototype.toString),yd=He(String.prototype.match),Zs=He(String.prototype.replace),E3=He(String.prototype.indexOf),M3=He(String.prototype.trim),lt=He(Object.prototype.hasOwnProperty),Re=He(RegExp.prototype.test),Js=P3(TypeError);function He(i){return function(e){for(var t=arguments.length,s=new Array(t>1?t-1:0),r=1;r<t;r++)s[r-1]=arguments[r];return Kn(i,e,s)}}function P3(i){return function(){for(var e=arguments.length,t=new Array(e),s=0;s<e;s++)t[s]=arguments[s];return Xn(i,t)}}function U(i,e){let t=arguments.length>2&&arguments[2]!==void 0?arguments[2]:bo;vd&&vd(i,null);let s=e.length;for(;s--;){let r=e[s];if(typeof r=="string"){const o=t(r);o!==r&&(_3(e)||(e[s]=o),r=o)}i[r]=!0}return i}function O3(i){for(let e=0;e<i.length;e++)lt(i,e)||(i[e]=null);return i}function $i(i){const e=z1(null);for(const[t,s]of R1(i))lt(i,t)&&(Array.isArray(s)?e[t]=O3(s):s&&typeof s=="object"&&s.constructor===Object?e[t]=$i(s):e[t]=s);return e}function er(i,e){for(;i!==null;){const s=T3(i,e);if(s){if(s.get)return He(s.get);if(typeof s.value=="function")return He(s.value)}i=C3(i)}function t(){return null}return t}const wd=Ne(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","section","select","shadow","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),Wa=Ne(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","filter","font","g","glyph","glyphref","hkern","image","line","lineargradient","marker","mask","metadata","mpath","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),qa=Ne(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feDropShadow","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),D3=Ne(["animate","color-profile","cursor","discard","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),Ga=Ne(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover","mprescripts"]),L3=Ne(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),$d=Ne(["#text"]),xd=Ne(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","face","for","headers","height","hidden","high","href","hreflang","id","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","pattern","placeholder","playsinline","popover","popovertarget","popovertargetaction","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","wrap","xmlns","slot"]),Ya=Ne(["accent-height","accumulate","additive","alignment-baseline","amplitude","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","exponent","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","intercept","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","slope","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","tablevalues","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),Sd=Ne(["accent","accentunder","align","bevelled","close","columnsalign","columnlines","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lspace","lquote","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),no=Ne(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),B3=it(/\{\{[\w\W]*|[\w\W]*\}\}/gm),F3=it(/<%[\w\W]*|[\w\W]*%>/gm),R3=it(/\$\{[\w\W]*/gm),z3=it(/^data-[\-\w.\u00B7-\uFFFF]+$/),I3=it(/^aria-[\-\w]+$/),I1=it(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),N3=it(/^(?:\w+script|data):/i),H3=it(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),N1=it(/^html$/i),U3=it(/^[a-z][.\w]*(-[.\w]+)+$/i);var _d=Object.freeze({__proto__:null,ARIA_ATTR:I3,ATTR_WHITESPACE:H3,CUSTOM_ELEMENT:U3,DATA_ATTR:z3,DOCTYPE_NAME:N1,ERB_EXPR:F3,IS_ALLOWED_URI:I1,IS_SCRIPT_OR_DATA:N3,MUSTACHE_EXPR:B3,TMPLIT_EXPR:R3});const tr={element:1,text:3,progressingInstruction:7,comment:8,document:9},V3=function(){return typeof window>"u"?null:window},j3=function(e,t){if(typeof e!="object"||typeof e.createPolicy!="function")return null;let s=null;const r="data-tt-policy-suffix";t&&t.hasAttribute(r)&&(s=t.getAttribute(r));const o="dompurify"+(s?"#"+s:"");try{return e.createPolicy(o,{createHTML(a){return a},createScriptURL(a){return a}})}catch{return console.warn("TrustedTypes policy "+o+" could not be created."),null}},Cd=function(){return{afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}};function H1(){let i=arguments.length>0&&arguments[0]!==void 0?arguments[0]:V3();const e=B=>H1(B);if(e.version="3.2.4",e.removed=[],!i||!i.document||i.document.nodeType!==tr.document||!i.Element)return e.isSupported=!1,e;let{document:t}=i;const s=t,r=s.currentScript,{DocumentFragment:o,HTMLTemplateElement:a,Node:l,Element:n,NodeFilter:c,NamedNodeMap:d=i.NamedNodeMap||i.MozNamedAttrMap,HTMLFormElement:h,DOMParser:f,trustedTypes:g}=i,y=n.prototype,$=er(y,"cloneNode"),A=er(y,"remove"),O=er(y,"nextSibling"),P=er(y,"childNodes"),D=er(y,"parentNode");if(typeof a=="function"){const B=t.createElement("template");B.content&&B.content.ownerDocument&&(t=B.content.ownerDocument)}let z,K="";const{implementation:be,createNodeIterator:Be,createDocumentFragment:We,getElementsByTagName:ot}=t,{importNode:ni}=s;let pe=Cd();e.isSupported=typeof R1=="function"&&typeof D=="function"&&be&&be.createHTMLDocument!==void 0;const{MUSTACHE_EXPR:Pt,ERB_EXPR:ce,TMPLIT_EXPR:ye,DATA_ATTR:at,ARIA_ATTR:Ki,IS_SCRIPT_OR_DATA:Kr,ATTR_WHITESPACE:Ns,CUSTOM_ELEMENT:Ip}=_d;let{IS_ALLOWED_URI:Zl}=_d,Ce=null;const Jl=U({},[...wd,...Wa,...qa,...Ga,...$d]);let Me=null;const ec=U({},[...xd,...Ya,...Sd,...no]);let ue=Object.seal(z1(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),Hs=null,fa=null,tc=!0,ma=!0,ic=!1,sc=!0,Xi=!1,ga=!0,li=!1,va=!1,ba=!1,Zi=!1,Xr=!1,Zr=!1,rc=!0,oc=!1;const Np="user-content-";let ya=!0,Us=!1,Ji={},es=null;const ac=U({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","style","svg","template","thead","title","video","xmp"]);let nc=null;const lc=U({},["audio","video","img","source","image","track"]);let wa=null;const cc=U({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),Jr="http://www.w3.org/1998/Math/MathML",eo="http://www.w3.org/2000/svg",Ot="http://www.w3.org/1999/xhtml";let ts=Ot,$a=!1,xa=null;const Hp=U({},[Jr,eo,Ot],ja);let to=U({},["mi","mo","mn","ms","mtext"]),io=U({},["annotation-xml"]);const Up=U({},["title","style","font","a","script"]);let Vs=null;const Vp=["application/xhtml+xml","text/html"],jp="text/html";let Te=null,is=null;const Wp=t.createElement("form"),dc=function(v){return v instanceof RegExp||v instanceof Function},Sa=function(){let v=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if(!(is&&is===v)){if((!v||typeof v!="object")&&(v={}),v=$i(v),Vs=Vp.indexOf(v.PARSER_MEDIA_TYPE)===-1?jp:v.PARSER_MEDIA_TYPE,Te=Vs==="application/xhtml+xml"?ja:bo,Ce=lt(v,"ALLOWED_TAGS")?U({},v.ALLOWED_TAGS,Te):Jl,Me=lt(v,"ALLOWED_ATTR")?U({},v.ALLOWED_ATTR,Te):ec,xa=lt(v,"ALLOWED_NAMESPACES")?U({},v.ALLOWED_NAMESPACES,ja):Hp,wa=lt(v,"ADD_URI_SAFE_ATTR")?U($i(cc),v.ADD_URI_SAFE_ATTR,Te):cc,nc=lt(v,"ADD_DATA_URI_TAGS")?U($i(lc),v.ADD_DATA_URI_TAGS,Te):lc,es=lt(v,"FORBID_CONTENTS")?U({},v.FORBID_CONTENTS,Te):ac,Hs=lt(v,"FORBID_TAGS")?U({},v.FORBID_TAGS,Te):{},fa=lt(v,"FORBID_ATTR")?U({},v.FORBID_ATTR,Te):{},Ji=lt(v,"USE_PROFILES")?v.USE_PROFILES:!1,tc=v.ALLOW_ARIA_ATTR!==!1,ma=v.ALLOW_DATA_ATTR!==!1,ic=v.ALLOW_UNKNOWN_PROTOCOLS||!1,sc=v.ALLOW_SELF_CLOSE_IN_ATTR!==!1,Xi=v.SAFE_FOR_TEMPLATES||!1,ga=v.SAFE_FOR_XML!==!1,li=v.WHOLE_DOCUMENT||!1,Zi=v.RETURN_DOM||!1,Xr=v.RETURN_DOM_FRAGMENT||!1,Zr=v.RETURN_TRUSTED_TYPE||!1,ba=v.FORCE_BODY||!1,rc=v.SANITIZE_DOM!==!1,oc=v.SANITIZE_NAMED_PROPS||!1,ya=v.KEEP_CONTENT!==!1,Us=v.IN_PLACE||!1,Zl=v.ALLOWED_URI_REGEXP||I1,ts=v.NAMESPACE||Ot,to=v.MATHML_TEXT_INTEGRATION_POINTS||to,io=v.HTML_INTEGRATION_POINTS||io,ue=v.CUSTOM_ELEMENT_HANDLING||{},v.CUSTOM_ELEMENT_HANDLING&&dc(v.CUSTOM_ELEMENT_HANDLING.tagNameCheck)&&(ue.tagNameCheck=v.CUSTOM_ELEMENT_HANDLING.tagNameCheck),v.CUSTOM_ELEMENT_HANDLING&&dc(v.CUSTOM_ELEMENT_HANDLING.attributeNameCheck)&&(ue.attributeNameCheck=v.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),v.CUSTOM_ELEMENT_HANDLING&&typeof v.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements=="boolean"&&(ue.allowCustomizedBuiltInElements=v.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements),Xi&&(ma=!1),Xr&&(Zi=!0),Ji&&(Ce=U({},$d),Me=[],Ji.html===!0&&(U(Ce,wd),U(Me,xd)),Ji.svg===!0&&(U(Ce,Wa),U(Me,Ya),U(Me,no)),Ji.svgFilters===!0&&(U(Ce,qa),U(Me,Ya),U(Me,no)),Ji.mathMl===!0&&(U(Ce,Ga),U(Me,Sd),U(Me,no))),v.ADD_TAGS&&(Ce===Jl&&(Ce=$i(Ce)),U(Ce,v.ADD_TAGS,Te)),v.ADD_ATTR&&(Me===ec&&(Me=$i(Me)),U(Me,v.ADD_ATTR,Te)),v.ADD_URI_SAFE_ATTR&&U(wa,v.ADD_URI_SAFE_ATTR,Te),v.FORBID_CONTENTS&&(es===ac&&(es=$i(es)),U(es,v.FORBID_CONTENTS,Te)),ya&&(Ce["#text"]=!0),li&&U(Ce,["html","head","body"]),Ce.table&&(U(Ce,["tbody"]),delete Hs.tbody),v.TRUSTED_TYPES_POLICY){if(typeof v.TRUSTED_TYPES_POLICY.createHTML!="function")throw Js('TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.');if(typeof v.TRUSTED_TYPES_POLICY.createScriptURL!="function")throw Js('TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.');z=v.TRUSTED_TYPES_POLICY,K=z.createHTML("")}else z===void 0&&(z=j3(g,r)),z!==null&&typeof K=="string"&&(K=z.createHTML(""));Ne&&Ne(v),is=v}},hc=U({},[...Wa,...qa,...D3]),pc=U({},[...Ga,...L3]),qp=function(v){let C=D(v);(!C||!C.tagName)&&(C={namespaceURI:ts,tagName:"template"});const L=bo(v.tagName),re=bo(C.tagName);return xa[v.namespaceURI]?v.namespaceURI===eo?C.namespaceURI===Ot?L==="svg":C.namespaceURI===Jr?L==="svg"&&(re==="annotation-xml"||to[re]):!!hc[L]:v.namespaceURI===Jr?C.namespaceURI===Ot?L==="math":C.namespaceURI===eo?L==="math"&&io[re]:!!pc[L]:v.namespaceURI===Ot?C.namespaceURI===eo&&!io[re]||C.namespaceURI===Jr&&!to[re]?!1:!pc[L]&&(Up[L]||!hc[L]):!!(Vs==="application/xhtml+xml"&&xa[v.namespaceURI]):!1},$t=function(v){Xs(e.removed,{element:v});try{D(v).removeChild(v)}catch{A(v)}},so=function(v,C){try{Xs(e.removed,{attribute:C.getAttributeNode(v),from:C})}catch{Xs(e.removed,{attribute:null,from:C})}if(C.removeAttribute(v),v==="is")if(Zi||Xr)try{$t(C)}catch{}else try{C.setAttribute(v,"")}catch{}},uc=function(v){let C=null,L=null;if(ba)v="<remove></remove>"+v;else{const Pe=yd(v,/^[\r\n\t ]+/);L=Pe&&Pe[0]}Vs==="application/xhtml+xml"&&ts===Ot&&(v='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+v+"</body></html>");const re=z?z.createHTML(v):v;if(ts===Ot)try{C=new f().parseFromString(re,Vs)}catch{}if(!C||!C.documentElement){C=be.createDocument(ts,"template",null);try{C.documentElement.innerHTML=$a?K:re}catch{}}const De=C.body||C.documentElement;return v&&L&&De.insertBefore(t.createTextNode(L),De.childNodes[0]||null),ts===Ot?ot.call(C,li?"html":"body")[0]:li?C.documentElement:De},fc=function(v){return Be.call(v.ownerDocument||v,v,c.SHOW_ELEMENT|c.SHOW_COMMENT|c.SHOW_TEXT|c.SHOW_PROCESSING_INSTRUCTION|c.SHOW_CDATA_SECTION,null)},_a=function(v){return v instanceof h&&(typeof v.nodeName!="string"||typeof v.textContent!="string"||typeof v.removeChild!="function"||!(v.attributes instanceof d)||typeof v.removeAttribute!="function"||typeof v.setAttribute!="function"||typeof v.namespaceURI!="string"||typeof v.insertBefore!="function"||typeof v.hasChildNodes!="function")},mc=function(v){return typeof l=="function"&&v instanceof l};function Dt(B,v,C){ao(B,L=>{L.call(e,v,C,is)})}const gc=function(v){let C=null;if(Dt(pe.beforeSanitizeElements,v,null),_a(v))return $t(v),!0;const L=Te(v.nodeName);if(Dt(pe.uponSanitizeElement,v,{tagName:L,allowedTags:Ce}),v.hasChildNodes()&&!mc(v.firstElementChild)&&Re(/<[/\w]/g,v.innerHTML)&&Re(/<[/\w]/g,v.textContent)||v.nodeType===tr.progressingInstruction||ga&&v.nodeType===tr.comment&&Re(/<[/\w]/g,v.data))return $t(v),!0;if(!Ce[L]||Hs[L]){if(!Hs[L]&&bc(L)&&(ue.tagNameCheck instanceof RegExp&&Re(ue.tagNameCheck,L)||ue.tagNameCheck instanceof Function&&ue.tagNameCheck(L)))return!1;if(ya&&!es[L]){const re=D(v)||v.parentNode,De=P(v)||v.childNodes;if(De&&re){const Pe=De.length;for(let qe=Pe-1;qe>=0;--qe){const xt=$(De[qe],!0);xt.__removalCount=(v.__removalCount||0)+1,re.insertBefore(xt,O(v))}}}return $t(v),!0}return v instanceof n&&!qp(v)||(L==="noscript"||L==="noembed"||L==="noframes")&&Re(/<\/no(script|embed|frames)/i,v.innerHTML)?($t(v),!0):(Xi&&v.nodeType===tr.text&&(C=v.textContent,ao([Pt,ce,ye],re=>{C=Zs(C,re," ")}),v.textContent!==C&&(Xs(e.removed,{element:v.cloneNode()}),v.textContent=C)),Dt(pe.afterSanitizeElements,v,null),!1)},vc=function(v,C,L){if(rc&&(C==="id"||C==="name")&&(L in t||L in Wp))return!1;if(!(ma&&!fa[C]&&Re(at,C))){if(!(tc&&Re(Ki,C))){if(!Me[C]||fa[C]){if(!(bc(v)&&(ue.tagNameCheck instanceof RegExp&&Re(ue.tagNameCheck,v)||ue.tagNameCheck instanceof Function&&ue.tagNameCheck(v))&&(ue.attributeNameCheck instanceof RegExp&&Re(ue.attributeNameCheck,C)||ue.attributeNameCheck instanceof Function&&ue.attributeNameCheck(C))||C==="is"&&ue.allowCustomizedBuiltInElements&&(ue.tagNameCheck instanceof RegExp&&Re(ue.tagNameCheck,L)||ue.tagNameCheck instanceof Function&&ue.tagNameCheck(L))))return!1}else if(!wa[C]){if(!Re(Zl,Zs(L,Ns,""))){if(!((C==="src"||C==="xlink:href"||C==="href")&&v!=="script"&&E3(L,"data:")===0&&nc[v])){if(!(ic&&!Re(Kr,Zs(L,Ns,"")))){if(L)return!1}}}}}}return!0},bc=function(v){return v!=="annotation-xml"&&yd(v,Ip)},yc=function(v){Dt(pe.beforeSanitizeAttributes,v,null);const{attributes:C}=v;if(!C||_a(v))return;const L={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:Me,forceKeepAttr:void 0};let re=C.length;for(;re--;){const De=C[re],{name:Pe,namespaceURI:qe,value:xt}=De,js=Te(Pe);let Fe=Pe==="value"?xt:M3(xt);if(L.attrName=js,L.attrValue=Fe,L.keepAttr=!0,L.forceKeepAttr=void 0,Dt(pe.uponSanitizeAttribute,v,L),Fe=L.attrValue,oc&&(js==="id"||js==="name")&&(so(Pe,v),Fe=Np+Fe),ga&&Re(/((--!?|])>)|<\/(style|title)/i,Fe)){so(Pe,v);continue}if(L.forceKeepAttr||(so(Pe,v),!L.keepAttr))continue;if(!sc&&Re(/\/>/i,Fe)){so(Pe,v);continue}Xi&&ao([Pt,ce,ye],$c=>{Fe=Zs(Fe,$c," ")});const wc=Te(v.nodeName);if(vc(wc,js,Fe)){if(z&&typeof g=="object"&&typeof g.getAttributeType=="function"&&!qe)switch(g.getAttributeType(wc,js)){case"TrustedHTML":{Fe=z.createHTML(Fe);break}case"TrustedScriptURL":{Fe=z.createScriptURL(Fe);break}}try{qe?v.setAttributeNS(qe,Pe,Fe):v.setAttribute(Pe,Fe),_a(v)?$t(v):bd(e.removed)}catch{}}}Dt(pe.afterSanitizeAttributes,v,null)},Gp=function B(v){let C=null;const L=fc(v);for(Dt(pe.beforeSanitizeShadowDOM,v,null);C=L.nextNode();)Dt(pe.uponSanitizeShadowNode,C,null),gc(C),yc(C),C.content instanceof o&&B(C.content);Dt(pe.afterSanitizeShadowDOM,v,null)};return e.sanitize=function(B){let v=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},C=null,L=null,re=null,De=null;if($a=!B,$a&&(B="<!-->"),typeof B!="string"&&!mc(B))if(typeof B.toString=="function"){if(B=B.toString(),typeof B!="string")throw Js("dirty is not a string, aborting")}else throw Js("toString is not a function");if(!e.isSupported)return B;if(va||Sa(v),e.removed=[],typeof B=="string"&&(Us=!1),Us){if(B.nodeName){const xt=Te(B.nodeName);if(!Ce[xt]||Hs[xt])throw Js("root node is forbidden and cannot be sanitized in-place")}}else if(B instanceof l)C=uc("<!---->"),L=C.ownerDocument.importNode(B,!0),L.nodeType===tr.element&&L.nodeName==="BODY"||L.nodeName==="HTML"?C=L:C.appendChild(L);else{if(!Zi&&!Xi&&!li&&B.indexOf("<")===-1)return z&&Zr?z.createHTML(B):B;if(C=uc(B),!C)return Zi?null:Zr?K:""}C&&ba&&$t(C.firstChild);const Pe=fc(Us?B:C);for(;re=Pe.nextNode();)gc(re),yc(re),re.content instanceof o&&Gp(re.content);if(Us)return B;if(Zi){if(Xr)for(De=We.call(C.ownerDocument);C.firstChild;)De.appendChild(C.firstChild);else De=C;return(Me.shadowroot||Me.shadowrootmode)&&(De=ni.call(s,De,!0)),De}let qe=li?C.outerHTML:C.innerHTML;return li&&Ce["!doctype"]&&C.ownerDocument&&C.ownerDocument.doctype&&C.ownerDocument.doctype.name&&Re(N1,C.ownerDocument.doctype.name)&&(qe="<!DOCTYPE "+C.ownerDocument.doctype.name+`>
`+qe),Xi&&ao([Pt,ce,ye],xt=>{qe=Zs(qe,xt," ")}),z&&Zr?z.createHTML(qe):qe},e.setConfig=function(){let B=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};Sa(B),va=!0},e.clearConfig=function(){is=null,va=!1},e.isValidAttribute=function(B,v,C){is||Sa({});const L=Te(B),re=Te(v);return vc(L,re,C)},e.addHook=function(B,v){typeof v=="function"&&Xs(pe[B],v)},e.removeHook=function(B,v){if(v!==void 0){const C=A3(pe[B],v);return C===-1?void 0:k3(pe[B],C,1)[0]}return bd(pe[B])},e.removeHooks=function(B){pe[B]=[]},e.removeAllHooks=function(){pe=Cd()},e}var yo=H1(),W3=Object.defineProperty,q3=Object.getOwnPropertyDescriptor,Il=(i,e,t,s)=>{for(var r=s>1?void 0:s?q3(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&W3(e,t,r),r};let Io=class extends ve{constructor(){super(...arguments),this.collectionLinks=[]}render(){return m`
    ...
    `}get imageBlockTemplate(){var t;if(!this.model)return b;const i=this.model.mediatype==="collection",e=this.displayValueProvider.itemPageUrl(this.model.identifier,i);return m`<a
      id="image-link"
      title=${_(Ct`View ${(t=this.model)==null?void 0:t.title}`)}
      href=${e}
    >
      <image-block
        .model=${this.model}
    ...
    `}get iconRightTemplate(){var i;return m`
      <a
        ...
        title=${_(Ct`See more: ${(i=this.model)==null?void 0:i.mediatype}`)}
      >
        <tile-mediatype-icon .model=${this.model}> </tile-mediatype-icon>
      </a>
    ...
    `:b}get volumeTemplate(){var i;return this.metadataTemplate((i=this.model)==null?void 0:i.volume,_("Volume"))}get issueTemplate(){var i;return this.metadataTemplate((i=this.model)==null?void 0:i.issue,_("Issue"))}get creatorTemplate(){var i,e;return((i=this.model)==null?void 0:i.mediatype)==="account"?m`
    ...
    `}get datePublishedTemplate(){var t;const i=(t=this.model)==null?void 0:t.datePublished;let e="long";return Bl(i)&&(e="year-only"),this.metadataTemplate(this.getFormattedDate(i,e),_("Published"))}get dateSortByTemplate(){return this.effectiveSort&&(this.effectiveSort.field==="addeddate"||this.effectiveSort.field==="reviewdate"||this.effectiveSort.field==="publicdate")?this.metadataTemplate(this.getFormattedDate(this.date,"long"),this.displayValueProvider.dateLabel):b}get viewsTemplate(){var e,t,s,r;const i=((e=this.effectiveSort)==null?void 0:e.field)==="week"?(t=this.model)==null?void 0:t.weeklyViewCount:(s=this.model)==null?void 0:s.viewCount;return i==null?b:((r=this.model)==null?void 0:r.mediatype)==="search"?this.metadataTemplate("(Favorited search query)",""):this.metadataTemplate(`${zl(i,this.formatSize)}`,_("Views"))}get ratingTemplate(){var i;return this.metadataTemplate((i=this.model)==null?void 0:i.averageRating,_("Avg Rating"))}get reviewsTemplate(){var i;return this.metadataTemplate((i=this.model)==null?void 0:i.commentCount,_("Reviews"))}get topicsTemplate(){var i;return!((i=this.model)!=null&&i.subjects)||this.model.subjects.length===0?b:m`
    ...
    `}};Il([u({type:Object})],Io.prototype,"collectionTitles",2);Il([R()],Io.prototype,"collectionLinks",2);Io=Il([N("tile-list")],Io);var G3=Object.defineProperty,Y3=Object.getOwnPropertyDescriptor,Mt=(i,e,t,s)=>{for(var r=s>1?void 0:s?Y3(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&G3(e,t,r),r};let vt=class extends H{constructor(){super(...arguments),this.loggedIn=!1,this.suppressBlurring=!1}render(){return m`
      <div id="container">
        <focus-trap>
          ${this.headerTemplate}
    ...
    `:b}static get styles(){const i=w`var(--hoverPaneHeaderBGColor, #edf0ff)`,e=w`var(--ia-theme-link-color, #4b64ff)`,t=w`var(--ia-theme-base-font-family, "Helvetica Neue", Helvetica, Arial, sans-serif);`;return w`
      :host {
        margin: 0;
        border: 0;
        padding: 0;
    ...
    `}};Mt([u({type:Object})],vt.prototype,"model",2);Mt([u({type:String})],vt.prototype,"baseNavigationUrl",2);Mt([u({type:String})],vt.prototype,"baseImageUrl",2);Mt([u({type:Boolean})],vt.prototype,"loggedIn",2);Mt([u({type:Boolean})],vt.prototype,"suppressBlurring",2);Mt([u({type:Object})],vt.prototype,"sortParam",2);Mt([u({type:Number})],vt.prototype,"mobileBreakpoint",2);Mt([u({type:Number})],vt.prototype,"currentWidth",2);Mt([u({type:Object})],vt.prototype,"collectionTitles",2);vt=Mt([N("tile-hover-pane")],vt);var Q3=Object.getOwnPropertyDescriptor,K3=(i,e,t,s)=>{for(var r=s>1?void 0:s?Q3(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=a(r)||r);return r};let Td=class extends ve{render(){var i,e;return m`
      <div id="list-line" class="${this.classSize}">
        <image-block
          .model=${this.model}
          .baseImageUrl=${this.baseImageUrl}
    ...
    `}};Td=K3([N("tile-list-compact")],Td);var X3=Object.getOwnPropertyDescriptor,Z3=(i,e,t,s)=>{for(var r=s>1?void 0:s?X3(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=a(r)||r);return r};let Ad=class extends ve{render(){return m`
    ...
    `}firstUpdated(){this.shouldPrepareHoverPane&&(this.hoverPaneController=new J3(this,{mobileBreakpoint:this.mobileBreakpoint,enableLongPress:!1}))}get headerTemplate(){const{currentWidth:i,sortParam:e,defaultSortParam:t,mobileBreakpoint:s}=this;return m`
    ...
    `}get linkTileTemplate(){var i,e;return m`
      <a
        ...
        title=${this.shouldPrepareHoverPane?b:Ge((e=this.model)==null?void 0:e.title)}
    ...
    `}get shouldPrepareHoverPane(){var i,e;return this.enableHoverPane&&!!this.tileDisplayMode&&Ue.HOVER_PANE_DISPLAY_MODES[this.tileDisplayMode]&&((i=this.model)==null?void 0:i.mediatype)!=="search"&&!((e=this.model)!=null&&e.captureDates)}get isHoverEnabled(){return window.matchMedia("(hover: hover)").matches}getHoverPane(){return this.hoverPane}getHoverPaneProps(){return this}handleResize(i){this.currentWidth=i.contentRect.width,this.currentHeight=i.contentRect.height}disconnectedCallback(){this.stopResizeObservation(this.resizeObserver)}stopResizeObservation(i){i==null||i.removeObserver({handler:this,target:this.container})}startResizeObservation(){var i;this.stopResizeObservation(this.resizeObserver),(i=this.resizeObserver)==null||i.addObserver({handler:this,target:this.container})}updated(i){if(i.has("resizeObserver")){const e=i.get("resizeObserver");this.stopResizeObservation(e),this.startResizeObservation()}}handleLinkClicked(i){this.isManageView&&(i.preventDefault(),this.model&&(this.model.checked=!this.model.checked)),this.dispatchEvent(new CustomEvent("resultSelected",{detail:this.model}))}handleLinkContextMenu(i){this.isManageView&&this.linkTileHref!==b&&(i.preventDefault(),window.open(this.linkTileHref,"_blank"))}tileInfoButtonPressed(i){var e;(e=this.hoverPaneController)==null||e.toggleHoverPane({coords:i.detail,enableTouchBackdrop:!0})}get tile(){const{model:i,collectionPagePath:e,baseNavigationUrl:t,currentWidth:s,currentHeight:r,sortParam:o,creatorFilter:a,mobileBreakpoint:l,defaultSortParam:n}=this;if(!i)return b;switch(this.tileDisplayMode){case"grid":switch(i.mediatype){case"collection":return m`<collection-tile
        ...
        >
          ...
          ?useLocalTime=${this.useLocalTime}
        >
        </tile-list>`;default:return b}}static get styles(){return[yt,w`
        :host {
          display: block;
          height: 100%;
        }
      ...
      `]}};Ue.HOVER_PANE_DISPLAY_MODES={grid:!0,"list-compact":!0,"list-detail":!1,"list-header":!1};rt([u({type:String})],Ue.prototype,"tileDisplayMode",2);rt([u({type:Boolean})],Ue.prototype,"isManageView",2);rt([u({type:Object})],Ue.prototype,"resizeObserver",2);rt([u({type:Object})],Ue.prototype,"collectionTitles",2);rt([u({type:Boolean})],Ue.prototype,"showTvClips",2);rt([u({type:String})],Ue.prototype,"layoutType",2);rt([u({type:Boolean})],Ue.prototype,"enableHoverPane",2);rt([u({type:String})],Ue.prototype,"manageCheckTitle",2);rt([Q("#container")],Ue.prototype,"container",2);rt([Q("tile-hover-pane")],Ue.prototype,"hoverPane",2);rt([Q(".tile-link")],Ue.prototype,"tileLinkElement",2);Ue=rt([N("tile-dispatcher")],Ue);var sf=Object.getOwnPropertyDescriptor,rf=(i,e,t,s)=>{for(var r=s>1?void 0:s?sf(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=a(r)||r);return r};let Ed=class extends H{render(){return m` <div id="container"></div> `}static get styles(){return w`
      :host {
        display: block;
        height: 100%;
      }
    ...
    `}};Ed=rf([N("collection-browser-loading-tile")],Ed);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Qa;const No=window,ys=No.trustedTypes,Md=ys?ys.createPolicy("lit-html",{createHTML:i=>i}):void 0,Zn="$lit$",Qt=`lit$${(Math.random()+"").slice(9)}$`,U1="?"+Qt,of=`<${U1}>`,Hi=document,Or=()=>Hi.createComment(""),Dr=i=>i===null||typeof i!="object"&&typeof i!="function",V1=Array.isArray,af=i=>V1(i)||typeof(i==null?void 0:i[Symbol.iterator])=="function",Ka=`[ 	
\f\r]`,ir=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Pd=/-->/g,Od=/>/g,fi=RegExp(`>|${Ka}(?:([^\\s"'>=/]+)(${Ka}*=${Ka}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Dd=/'/g,Ld=/"/g,j1=/^(?:script|style|textarea|title)$/i,W1=i=>(e,...t)=>({_$litType$:i,strings:e,values:t}),ze=W1(1),q1=W1(2),ws=Symbol.for("lit-noChange"),Ae=Symbol.for("lit-nothing"),Bd=new WeakMap,Ai=Hi.createTreeWalker(Hi,129,null,!1);function G1(i,e){if(!Array.isArray(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return Md!==void 0?Md.createHTML(e):e}const nf=(i,e)=>{const t=i.length-1,s=[];let r,o=e===2?"<svg>":"",a=ir;for(let l=0;l<t;l++){const n=i[l];let c,d,h=-1,f=0;for(;f<n.length&&(a.lastIndex=f,d=a.exec(n),d!==null);)f=a.lastIndex,a===ir?d[1]==="!--"?a=Pd:d[1]!==void 0?a=Od:d[2]!==void 0?(j1.test(d[2])&&(r=RegExp("</"+d[2],"g")),a=fi):d[3]!==void 0&&(a=fi):a===fi?d[0]===">"?(a=r??ir,h=-1):d[1]===void 0?h=-2:(h=a.lastIndex-d[2].length,c=d[1],a=d[3]===void 0?fi:d[3]==='"'?Ld:Dd):a===Ld||a===Dd?a=fi:a===Pd||a===Od?a=ir:(a=fi,r=void 0);const g=a===fi&&i[l+1].startsWith("/>")?" ":"";o+=a===ir?n+of:h>=0?(s.push(c),n.slice(0,h)+Zn+n.slice(h)+Qt+g):n+Qt+(h===-2?(s.push(void 0),l):g)}return[G1(i,o+(i[t]||"<?>")+(e===2?"</svg>":"")),s]};let Jn=class Y1{constructor({strings:e,_$litType$:t},s){let r;this.parts=[];let o=0,a=0;const l=e.length-1,n=this.parts,[c,d]=nf(e,t);if(this.el=Y1.createElement(c,s),Ai.currentNode=this.el.content,t===2){const h=this.el.content,f=h.firstChild;f.remove(),h.append(...f.childNodes)}for(;(r=Ai.nextNode())!==null&&n.length<l;){if(r.nodeType===1){if(r.hasAttributes()){const h=[];for(const f of r.getAttributeNames())if(f.endsWith(Zn)||f.startsWith(Qt)){const g=d[a++];if(h.push(f),g!==void 0){const y=r.getAttribute(g.toLowerCase()+Zn).split(Qt),$=/([.?@])?(.*)/.exec(g);n.push({type:1,index:o,name:$[2],strings:y,ctor:$[1]==="."?cf:$[1]==="?"?hf:$[1]==="@"?pf:aa})}else n.push({type:6,index:o})}for(const f of h)r.removeAttribute(f)}if(j1.test(r.tagName)){const h=r.textContent.split(Qt),f=h.length-1;if(f>0){r.textContent=ys?ys.emptyScript:"";for(let g=0;g<f;g++)r.append(h[g],Or()),Ai.nextNode(),n.push({type:2,index:++o});r.append(h[f],Or())}}}else if(r.nodeType===8)if(r.data===U1)n.push({type:2,index:o});else{let h=-1;for(;(h=r.data.indexOf(Qt,h+1))!==-1;)n.push({type:7,index:o}),h+=Qt.length-1}o++}}static createElement(e,t){const s=Hi.createElement("template");return s.innerHTML=e,s}};function $s(i,e,t=i,s){var r,o,a,l;if(e===ws)return e;let n=s!==void 0?(r=t._$Co)===null||r===void 0?void 0:r[s]:t._$Cl;const c=Dr(e)?void 0:e._$litDirective$;return(n==null?void 0:n.constructor)!==c&&((o=n==null?void 0:n._$AO)===null||o===void 0||o.call(n,!1),c===void 0?n=void 0:(n=new c(i),n._$AT(i,t,s)),s!==void 0?((a=(l=t)._$Co)!==null&&a!==void 0?a:l._$Co=[])[s]=n:t._$Cl=n),n!==void 0&&(e=$s(i,n._$AS(i,e.values),n,s)),e}let lf=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){var t;const{el:{content:s},parts:r}=this._$AD,o=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:Hi).importNode(s,!0);Ai.currentNode=o;let a=Ai.nextNode(),l=0,n=0,c=r[0];for(;c!==void 0;){if(l===c.index){let d;c.type===2?d=new Nl(a,a.nextSibling,this,e):c.type===1?d=new c.ctor(a,c.name,c.strings,this,e):c.type===6&&(d=new uf(a,this,e)),this._$AV.push(d),c=r[++n]}l!==(c==null?void 0:c.index)&&(a=Ai.nextNode(),l++)}return Ai.currentNode=Hi,o}v(e){let t=0;for(const s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(e,s,t),t+=s.strings.length-2):s._$AI(e[t])),t++}},Nl=class Q1{constructor(e,t,s,r){var o;this.type=2,this._$AH=Ae,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=s,this.options=r,this._$Cp=(o=r==null?void 0:r.isConnected)===null||o===void 0||o}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cp}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=$s(this,e,t),Dr(e)?e===Ae||e==null||e===""?(this._$AH!==Ae&&this._$AR(),this._$AH=Ae):e!==this._$AH&&e!==ws&&this._(e):e._$litType$!==void 0?this.g(e):e.nodeType!==void 0?this.$(e):af(e)?this.T(e):this._(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==Ae&&Dr(this._$AH)?this._$AA.nextSibling.data=e:this.$(Hi.createTextNode(e)),this._$AH=e}g(e){var t;const{values:s,_$litType$:r}=e,o=typeof r=="number"?this._$AC(e):(r.el===void 0&&(r.el=Jn.createElement(G1(r.h,r.h[0]),this.options)),r);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===o)this._$AH.v(s);else{const a=new lf(o,this),l=a.u(this.options);a.v(s),this.$(l),this._$AH=a}}_$AC(e){let t=Bd.get(e.strings);return t===void 0&&Bd.set(e.strings,t=new Jn(e)),t}T(e){V1(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let s,r=0;for(const o of e)r===t.length?t.push(s=new Q1(this.k(Or()),this.k(Or()),this,this.options)):s=t[r],s._$AI(o),r++;r<t.length&&(this._$AR(s&&s._$AB.nextSibling,r),t.length=r)}_$AR(e=this._$AA.nextSibling,t){var s;for((s=this._$AP)===null||s===void 0||s.call(this,!1,!0,t);e&&e!==this._$AB;){const r=e.nextSibling;e.remove(),e=r}}setConnected(e){var t;this._$AM===void 0&&(this._$Cp=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}},aa=class{constructor(e,t,s,r,o){this.type=1,this._$AH=Ae,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=o,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=Ae}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,s,r){const o=this.strings;let a=!1;if(o===void 0)e=$s(this,e,t,0),a=!Dr(e)||e!==this._$AH&&e!==ws,a&&(this._$AH=e);else{const l=e;let n,c;for(e=o[0],n=0;n<o.length-1;n++)c=$s(this,l[s+n],t,n),c===ws&&(c=this._$AH[n]),a||(a=!Dr(c)||c!==this._$AH[n]),c===Ae?e=Ae:e!==Ae&&(e+=(c??"")+o[n+1]),this._$AH[n]=c}a&&!r&&this.j(e)}j(e){e===Ae?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},cf=class extends aa{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===Ae?void 0:e}};const df=ys?ys.emptyScript:"";let hf=class extends aa{constructor(){super(...arguments),this.type=4}j(e){e&&e!==Ae?this.element.setAttribute(this.name,df):this.element.removeAttribute(this.name)}},pf=class extends aa{constructor(e,t,s,r,o){super(e,t,s,r,o),this.type=5}_$AI(e,t=this){var s;if((e=(s=$s(this,e,t,0))!==null&&s!==void 0?s:Ae)===ws)return;const r=this._$AH,o=e===Ae&&r!==Ae||e.capture!==r.capture||e.once!==r.once||e.passive!==r.passive,a=e!==Ae&&(r===Ae||o);o&&this.element.removeEventListener(this.name,this,r),a&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,s;typeof this._$AH=="function"?this._$AH.call((s=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&s!==void 0?s:this.element,e):this._$AH.handleEvent(e)}},uf=class{constructor(e,t,s){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(e){$s(this,e)}};const Fd=No.litHtmlPolyfillSupport;Fd==null||Fd(Jn,Nl),((Qa=No.litHtmlVersions)!==null&&Qa!==void 0?Qa:No.litHtmlVersions=[]).push("2.8.0");const ff=(i,e,t)=>{var s,r;const o=(s=t==null?void 0:t.renderBefore)!==null&&s!==void 0?s:e;let a=o._$litPart$;if(a===void 0){const l=(r=t==null?void 0:t.renderBefore)!==null&&r!==void 0?r:null;o._$litPart$=a=new Nl(e.insertBefore(Or(),l),l,void 0,t??{})}return a._$AI(i),a};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Xa,Za;let hs=class extends ht{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e,t;const s=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=s.firstChild),s}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=ff(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!1)}render(){return ws}};hs.finalized=!0,hs._$litElement$=!0,(Xa=globalThis.litElementHydrateSupport)===null||Xa===void 0||Xa.call(globalThis,{LitElement:hs});const Rd=globalThis.litElementPolyfillSupport;Rd==null||Rd({LitElement:hs});((Za=globalThis.litElementVersions)!==null&&Za!==void 0?Za:globalThis.litElementVersions=[]).push("3.3.3");/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function ss(i,e,t){return i?e():t==null?void 0:t()}const mf=q1`<svg class="caret-up-svg" viewBox="0 0 8 4" xmlns="http://www.w3.org/2000/svg">
<path d="m6.7226499 3.51689722c.22976435.15317623.54019902.0910893.69337525-.13867505.13615665-.20423497.10222882-.47220946-.06836249-.63681849l-.07031256-.05655675-3.2773501-2.18490007-3.2773501 2.18490007c-.22976434.15317623-.29185128.4636109-.13867505.69337524.13615665.20423498.39656688.27598409.61412572.18182636l.07924953-.04315131 2.7226499-1.81402514z"
  fill=""></path>
</svg>`,gf=q1`<svg class="caret-down-svg" viewBox="0 0 8 4" xmlns="http://www.w3.org/2000/svg">
<path d="m6.7226499.58397485c.22976435-.15317623.54019902-.09108929.69337525.13867505.13615665.20423498.10222882.47220947-.06836249.63681849l-.07031256.05655676-3.2773501 2.18490006-3.2773501-2.18490006c-.22976434-.15317623-.29185128-.4636109-.13867505-.69337525.13615665-.20423497.39656688-.27598409.61412572-.18182636l.07924953.04315131 2.7226499 1.81402515z"
fill=""></path>
</svg>`;let me=class extends hs{constructor(){super(...arguments),this.open=!1,this.isDisabled=!1,this.displayCaret=!1,this.closeOnSelect=!1,this.openViaButton=!0,this.usePopover=!1,this.includeSelectedOption=!1,this.selectedOption="",this.options=[],this.optionGroup="options",this.optionSelected=()=>{},this.isCustomList=!1,this.hasCustomClickHandler=!1,this.closeOnEscape=!1,this.closeOnBackdropClick=!1,this.boundKeyboardListener=e=>{switch(e.key){case"Escape":case"Esc":this.closeOptions();break}},this.closeOptions=e=>{e&&e.type==="click"&&e.stopPropagation(),this.open=!1,this.updatePopoverState()}}async firstUpdated(){await new Promise(e=>{setTimeout(e,0)}),this.addEventListener("closeDropdown",this.closeOptions)}willUpdate(e){e.has("open")&&this.updatePopoverState()}disconnectedCallback(){var e;(e=super.disconnectedCallback)===null||e===void 0||e.call(this),this.removeKeyboardListener()}setupKeyboardListener(){this.closeOnEscape&&document.addEventListener("keydown",this.boundKeyboardListener)}removeKeyboardListener(){this.closeOnEscape&&document.removeEventListener("keydown",this.boundKeyboardListener)}get dropdownState(){return this.open?(this.setupKeyboardListener(),"open"):(this.removeKeyboardListener(),"closed")}toggleOptions(){this.open=!this.open,this.updatePopoverState()}updatePopoverState(){var e,t;this.usePopover&&((t=(e=this.dropdownMenu)===null||e===void 0?void 0:e.togglePopover)===null||t===void 0||t.call(e,this.open),this.open&&this.positionDropdownMenu())}positionDropdownMenu(){if(!this.dropdownMenu)return;const e=this.container.getBoundingClientRect();this.dropdownMenu.style.left=`${e.left}px`,this.dropdownMenu.style.top=`${e.bottom}px`,this.dropdownMenu.style.minWidth=`${e.width}px`}mainButtonClicked(){var e;this.openViaButton?this.toggleOptions():(e=this.mainButtonLabelSlotted[0])===null||e===void 0||e.click()}mainButtonKeyDown(e){(e.key==="Enter"||e.key===" ")&&(this.mainButtonClicked(),e.preventDefault())}caretKeyDown(e){(e.key==="Enter"||e.key===" ")&&(this.toggleOptions(),e.preventDefault())}renderOption(e){const{label:t,url:s=void 0,id:r}=e;let o;const a=this.selectedOption===r?"selected":"";return s?o=ze`<a
        href=${s}
      ...
      <span ?hidden=${!this.open} class="caret-up">
        <slot name="caret-up">${mf}</slot>
      </span>
    `}get caretDownTemplate(){return ze`
      <span ?hidden=${this.open} class="caret-down">
        <slot name="caret-down">${gf}</slot>
      </span>
    `}get caretTemplate(){return this.displayCaret?this.openViaButton?ze`
      ...
      <button
        ...
        aria-haspopup="true"
        aria-expanded=${this.open}
        @click=${ss(this.shouldAttachEventHandlers,()=>this.toggleOptions)}
        @keydown=${ss(this.shouldAttachEventHandlers,()=>this.caretKeyDown)}
      ...
      <div class="ia-dropdown-group">
        <div class="button-row">
          <button
            ...
            aria-expanded=${this.open}
            @click=${ss(this.shouldAttachEventHandlers,()=>this.mainButtonClicked)}
            @keydown=${ss(this.shouldAttachEventHandlers,()=>this.mainButtonKeyDown)}
            ?disabled=${this.isDisabled}
          >
            ...
            ${ss(this.shouldNestCaretInButton,()=>this.caretTemplate)}
          </button>
          ${ss(!this.shouldNestCaretInButton,()=>this.caretTemplate)}
        </div>
    ...
    `}};p([E({type:Boolean,reflect:!0})],me.prototype,"open",void 0);p([E({type:Boolean,reflect:!0})],me.prototype,"isDisabled",void 0);p([E({type:Boolean})],me.prototype,"displayCaret",void 0);p([E({type:Boolean})],me.prototype,"closeOnSelect",void 0);p([E({type:Boolean})],me.prototype,"openViaButton",void 0);p([E({type:Boolean})],me.prototype,"usePopover",void 0);p([E({type:Boolean})],me.prototype,"includeSelectedOption",void 0);p([E({type:String})],me.prototype,"selectedOption",void 0);p([E({attribute:!1})],me.prototype,"options",void 0);p([E({type:String})],me.prototype,"optionGroup",void 0);p([E({attribute:!1})],me.prototype,"optionSelected",void 0);p([E({type:Boolean,reflect:!0})],me.prototype,"isCustomList",void 0);p([E({type:Boolean,reflect:!0})],me.prototype,"hasCustomClickHandler",void 0);p([E({type:Boolean,reflect:!0})],me.prototype,"closeOnEscape",void 0);p([E({type:Boolean,reflect:!0})],me.prototype,"closeOnBackdropClick",void 0);p([Ye(".ia-dropdown-group")],me.prototype,"container",void 0);p([Ye("#dropdown-main")],me.prototype,"dropdownMenu",void 0);p([Ye(".click-main")],me.prototype,"mainButton",void 0);p([h1({slot:"dropdown-label"})],me.prototype,"mainButtonLabelSlotted",void 0);me=p([At("ia-dropdown")],me);let el=class extends hs{render(){return ze`
  ...
  `;el=p([At("ia-icon-label")],el);var vf=Object.defineProperty,bf=Object.getOwnPropertyDescriptor,K1=(i,e,t,s)=>{for(var r=s>1?void 0:s?bf(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&vf(e,t,r),r};let tl=class extends H{constructor(){super(...arguments),this.numResults=0}render(){return m`
    ...
    `}static get styles(){const i=w`var(--tooltipArrowSize, 5px)`,e=w`var(--tooltipArrowOffset, 0px)`;return w`
      #tooltip-container {
        width: max-content;
        max-width: 200px;
        pointer-events: none;
    ...
    `}};K1([u({type:Number})],tl.prototype,"numResults",2);tl=K1([N("alpha-bar-tooltip")],tl);var yf=Object.defineProperty,wf=Object.getOwnPropertyDescriptor,Yi=(i,e,t,s)=>{for(var r=s>1?void 0:s?wf(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&yf(e,t,r),r};let It=class extends H{constructor(){super(...arguments),this.selectedLetter=null,this.tooltipShown=!1,this.alphabet="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("")}get selectedUppercaseLetter(){var i;return(i=this.selectedLetter)==null?void 0:i.toUpperCase()}render(){return m`
  ...
  `;Yi([u({type:String})],It.prototype,"selectedLetter",2);Yi([u({type:Object})],It.prototype,"letterCounts",2);Yi([u({type:String})],It.prototype,"ariaLandmarkLabel",2);Yi([R()],It.prototype,"tooltipShown",2);Yi([R()],It.prototype,"hoveredLetter",2);Yi([Q("alpha-bar-tooltip")],It.prototype,"tooltip",2);It=Yi([N("alpha-bar")],It);const $f=m`
...
`;var Af=Object.defineProperty,kf=Object.getOwnPropertyDescriptor,te=(i,e,t,s)=>{for(var r=s>1?void 0:s?kf(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&Af(e,t,r),r};let J=class extends H{constructor(){super(...arguments),this.defaultSortDirection=null,this.defaultSortField=V.relevance,this.defaultViewSort=V.weeklyview,this.defaultDateSort=V.date,this.sortDirection=null,this.selectedSort=V.default,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.sortFieldAvailability=ia,this.enableSortOptionsSlot=!1,this.suppressDisplayModes=!1,this.lastSelectedViewSort=this.defaultViewSort,this.lastSelectedDateSort=this.defaultDateSort,this.alphaSelectorVisible=null,this.dropdownBackdropVisible=!1,this.desktopSortContainerWidth=0,this.selectorBarContainerWidth=0,this.boundSortBarSelectorEscapeListener=i=>{i.key==="Escape"&&this.closeDropdowns()}}render(){return m`
      <div id="container">
    ...
    `}get sortDirectionIcon(){return this.canChangeSortDirection?m`
      <div class="sort-direction-icon">
        ${this.finalizedSortDirection==="asc"?$f:xf}
      </div>
    `:m`<div class="sort-direction-icon">${Sf}</div>`}get desktopSortSelectorTemplate(){return m`
      <div
    ...
    `}get mobileSortSelectorTemplate(){const i=Object.values(Ie).filter(e=>e.shownInSortBar&&this.sortFieldAvailability[e.field]);return m`
      <div
        id="mobile-sort-container"
        class=${this.mobileSelectorVisible?"visible":"hidden"}
      >
        ${this.getSortDropdown({displayName:Ie[this.finalizedSortField].displayName,id:"mobile-dropdown",selected:!0,dropdownOptions:i.map(e=>this.getDropdownOption(e.field)),selectedOption:this.finalizedSortField,onOptionSelected:this.mobileSortChanged,onDropdownClick:()=>{this.dropdownBackdropVisible=this.mobileDropdown.open,this.mobileDropdown.classList.toggle("open",this.mobileDropdown.open)}})}
      </div>
    `}getSortSelectorButton(i,e){const t=this.finalizedSortField===i,s=Ie[i].displayName,r=(e==null?void 0:e.onSelected)??(()=>this.clearAlphaBarFilters());return m`
      <button
        class=${t?"selected":""}
        data-title=${s}
    ...
    `}get dropdownBackdrop(){return m`
      ...
      ></div>
    `}closeDropdowns(){this.dropdownBackdropVisible=!1;const i=[this.viewsDropdown,this.dateDropdown,this.mobileDropdown];for(const e of i)e&&(e.open=!1,e.classList.remove("open"))}selectDropdownSortField(i){this.dropdownBackdropVisible=!1,this.setSelectedSort(i)}clearAlphaBarFilters(){this.alphaSelectorVisible=null,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.emitTitleLetterChangedEvent(),this.emitCreatorLetterChangedEvent()}setSortDirection(i){this.sortDirection=i,this.emitSortChangedEvent()}toggleSortDirection(){this.setSortDirection(this.finalizedSortDirection==="desc"?"asc":"desc")}handleSortDirectionClicked(){!this.sortDirection&&this.defaultSortField&&this.defaultSortDirection&&(this.selectedSort=this.defaultSortField,this.sortDirection=this.defaultSortDirection),this.toggleSortDirection()}setSelectedSort(i){this.selectedSort=i;const e=Ie[i];this.sortDirection=e.defaultSortDirection,this.emitSortChangedEvent()}get finalizedSortField(){return this.selectedSort===V.default?this.defaultSortField:this.selectedSort}get finalizedSortDirection(){return this.sortDirection===null?this.defaultSortDirection:this.sortDirection}get canChangeSortDirection(){return Ie[this.finalizedSortField].canSetDirection}get dateOptionSelected(){return[V.datefavorited,V.datearchived,V.date,V.datereviewed,V.dateadded].includes(this.finalizedSortField)}get viewOptionSelected(){return[V.alltimeview,V.weeklyview].includes(this.finalizedSortField)}get dateSortDisplayName(){return Ie[this.lastSelectedDateSort].displayName}get viewSortDisplayName(){return Ie[this.lastSelectedViewSort].displayName}get availableViewsFields(){return ld.filter(i=>this.sortFieldAvailability[i])}get availableDateFields(){return cd.filter(i=>this.sortFieldAvailability[i])}get titleSelectorBar(){var i;return m` <alpha-bar
    ...
    ></alpha-bar>`}titleLetterChanged(i){this.selectedTitleFilter=i.detail.selectedLetter??null,this.emitTitleLetterChangedEvent()}creatorLetterChanged(i){this.selectedCreatorFilter=i.detail.selectedLetter??null,this.emitCreatorLetterChangedEvent()}emitTitleLetterChangedEvent(){const i=new CustomEvent("titleLetterChanged",{detail:{selectedLetter:this.selectedTitleFilter}});this.dispatchEvent(i)}emitCreatorLetterChangedEvent(){const i=new CustomEvent("creatorLetterChanged",{detail:{selectedLetter:this.selectedCreatorFilter}});this.dispatchEvent(i)}displayModeChanged(){const i=new CustomEvent("displayModeChanged",{detail:{displayMode:this.displayMode}});this.dispatchEvent(i)}emitSortChangedEvent(){const i=new CustomEvent("sortChanged",{detail:{selectedSort:this.selectedSort,sortDirection:this.sortDirection}});this.dispatchEvent(i)}static get styles(){return[yt,w`
      ...
      `]}};te([u({type:String})],J.prototype,"displayMode",2);te([u({type:String})],J.prototype,"defaultSortDirection",2);te([u({type:String})],J.prototype,"defaultSortField",2);te([u({type:String})],J.prototype,"defaultViewSort",2);te([u({type:String})],J.prototype,"defaultDateSort",2);te([u({type:String})],J.prototype,"sortDirection",2);te([u({type:String})],J.prototype,"selectedSort",2);te([u({type:String})],J.prototype,"selectedTitleFilter",2);te([u({type:String})],J.prototype,"selectedCreatorFilter",2);te([u({type:Object})],J.prototype,"sortFieldAvailability",2);te([u({type:Boolean,reflect:!0})],J.prototype,"enableSortOptionsSlot",2);te([u({type:Boolean,reflect:!0})],J.prototype,"suppressDisplayModes",2);te([u({type:Object})],J.prototype,"prefixFilterCountMap",2);te([u({type:Object})],J.prototype,"resizeObserver",2);te([R()],J.prototype,"lastSelectedViewSort",2);te([R()],J.prototype,"lastSelectedDateSort",2);te([R()],J.prototype,"alphaSelectorVisible",2);te([R()],J.prototype,"dropdownBackdropVisible",2);te([R()],J.prototype,"desktopSortContainerWidth",2);te([R()],J.prototype,"selectorBarContainerWidth",2);te([Q("#desktop-sort-container")],J.prototype,"desktopSortContainer",2);te([Q("#sort-selector-container")],J.prototype,"sortSelectorContainer",2);te([Q("#views-dropdown")],J.prototype,"viewsDropdown",2);te([Q("#date-dropdown")],J.prototype,"dateDropdown",2);te([Q("#mobile-dropdown")],J.prototype,"mobileDropdown",2);J=te([N("sort-filter-bar")],J);class Bi{constructor(e){this.title=e==null?void 0:e.title,this.subtitle=e==null?void 0:e.subtitle,this.headline=e==null?void 0:e.headline,this.message=e==null?void 0:e.message,this.headerColor=(e==null?void 0:e.headerColor)??"#55A183",this.bodyColor=(e==null?void 0:e.bodyColor)??"#fbfbfd",this.showProcessingIndicator=(e==null?void 0:e.showProcessingIndicator)??!1,this.processingImageMode=(e==null?void 0:e.processingImageMode)??"complete",this.showCloseButton=(e==null?void 0:e.showCloseButton)??!0,this.showLeftNavButton=(e==null?void 0:e.showLeftNavButton)??!1,this.leftNavButtonText=(e==null?void 0:e.leftNavButtonText)??"",this.showHeaderLogo=(e==null?void 0:e.showHeaderLogo)??!0,this.closeOnBackdropClick=(e==null?void 0:e.closeOnBackdropClick)??!0}}function*Hl(i=document.activeElement){i!=null&&(yield i,"shadowRoot"in i&&i.shadowRoot&&i.shadowRoot.mode!=="closed"&&(yield*Hl(i.shadowRoot.activeElement)))}function X1(){return[...Hl()].pop()}const zd=new WeakMap;function Z1(i){let e=zd.get(i);return e||(e=window.getComputedStyle(i,null),zd.set(i,e)),e}function Ef(i){if("checkVisibility"in i&&typeof i.checkVisibility=="function")return i.checkVisibility({checkOpacity:!1,checkVisibilityCSS:!0});const e=Z1(i);return e.visibility!=="hidden"&&e.display!=="none"}function Mf(i){const e=Z1(i),{overflowY:t,overflowX:s}=e;return t==="scroll"||s==="scroll"?!0:t!=="auto"||s!=="auto"?!1:i.scrollHeight>i.clientHeight&&t==="auto"||i.scrollWidth>i.clientWidth&&s==="auto"}function Pf(i){const e=i.tagName.toLowerCase(),t=Number(i.getAttribute("tabindex"));return i.hasAttribute("tabindex")&&(isNaN(t)||t<=-1)||i.hasAttribute("disabled")||i.closest("[inert]")||e==="input"&&i.getAttribute("type")==="radio"&&!i.hasAttribute("checked")||!Ef(i)?!1:(e==="audio"||e==="video")&&i.hasAttribute("controls")||i.hasAttribute("tabindex")||i.hasAttribute("contenteditable")&&i.getAttribute("contenteditable")!=="false"||["button","input","select","textarea","a","audio","video","summary","iframe"].includes(e)?!0:Mf(i)}function Of(i,e){var t;return((t=i.getRootNode({composed:!0}))==null?void 0:t.host)!==e}function Id(i){const e=new WeakMap,t=[];function s(r){if(r instanceof Element){if(r.hasAttribute("inert")||r.closest("[inert]")||e.has(r))return;e.set(r,!0),!t.includes(r)&&Pf(r)&&t.push(r),r instanceof HTMLSlotElement&&Of(r,i)&&r.assignedElements({flatten:!0}).forEach(o=>{s(o)}),r.shadowRoot!==null&&r.shadowRoot.mode==="open"&&s(r.shadowRoot)}for(const o of Array.from(r.children))s(o)}return s(i),t.sort((r,o)=>{const a=Number(r.getAttribute("tabindex"))||0;return(Number(o.getAttribute("tabindex"))||0)-a})}let sr=[];class Df{constructor(e){this.isExternalActivated=!1,this.tabDirection="forward",this.currentFocus=null,this.previousFocus=null,this.handleFocusIn=()=>{this.isActive()&&this.checkFocus()},this.handleKeyDown=t=>{var l;if(t.key!=="Tab"||this.isExternalActivated||!this.isActive())return;const s=X1();if(this.previousFocus=s,this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus))return;t.shiftKey?this.tabDirection="backward":this.tabDirection="forward";const r=Id(this.element);let o=r.findIndex(n=>n===s);this.previousFocus=this.currentFocus;const a=this.tabDirection==="forward"?1:-1;for(;;){o+a>=r.length?o=0:o+a<0?o=r.length-1:o+=a,this.previousFocus=this.currentFocus;const n=r[o];if(this.tabDirection==="backward"&&this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus)||n&&this.possiblyHasTabbableChildren(n))return;t.preventDefault(),this.currentFocus=n,(l=this.currentFocus)==null||l.focus({preventScroll:!1});const c=[...Hl()];if(c.includes(this.currentFocus)||!c.includes(this.previousFocus))break}setTimeout(()=>this.checkFocus())},this.handleKeyUp=()=>{this.tabDirection="forward"},this.element=e,this.elementsWithTabbableControls=["iframe"]}activate(){sr.push(this.element),document.addEventListener("focusin",this.handleFocusIn),document.addEventListener("keydown",this.handleKeyDown),document.addEventListener("keyup",this.handleKeyUp)}deactivate(){sr=sr.filter(e=>e!==this.element),this.currentFocus=null,document.removeEventListener("focusin",this.handleFocusIn),document.removeEventListener("keydown",this.handleKeyDown),document.removeEventListener("keyup",this.handleKeyUp)}isActive(){return sr[sr.length-1]===this.element}activateExternal(){this.isExternalActivated=!0}deactivateExternal(){this.isExternalActivated=!1}checkFocus(){if(this.isActive()&&!this.isExternalActivated){const e=Id(this.element);if(!this.element.matches(":focus-within")){const t=e[0],s=e[e.length-1],r=this.tabDirection==="forward"?t:s;typeof(r==null?void 0:r.focus)=="function"&&(this.currentFocus=r,r.focus({preventScroll:!1}))}}}possiblyHasTabbableChildren(e){return this.elementsWithTabbableControls.includes(e.tagName.toLowerCase())||e.hasAttribute("controls")}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Ja;const Ho=window,xs=Ho.trustedTypes,Nd=xs?xs.createPolicy("lit-html",{createHTML:i=>i}):void 0,il="$lit$",Kt=`lit$${(Math.random()+"").slice(9)}$`,J1="?"+Kt,Lf=`<${J1}>`,Ui=document,Lr=()=>Ui.createComment(""),Br=i=>i===null||typeof i!="object"&&typeof i!="function",ep=Array.isArray,Bf=i=>ep(i)||typeof(i==null?void 0:i[Symbol.iterator])=="function",en=`[ 	
\f\r]`,rr=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Hd=/-->/g,Ud=/>/g,mi=RegExp(`>|${en}(?:([^\\s"'>=/]+)(${en}*=${en}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Vd=/'/g,jd=/"/g,tp=/^(?:script|style|textarea|title)$/i,Ff=i=>(e,...t)=>({_$litType$:i,strings:e,values:t}),Rf=Ff(1),Ss=Symbol.for("lit-noChange"),ke=Symbol.for("lit-nothing"),Wd=new WeakMap,ki=Ui.createTreeWalker(Ui,129,null,!1);function ip(i,e){if(!Array.isArray(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return Nd!==void 0?Nd.createHTML(e):e}const zf=(i,e)=>{const t=i.length-1,s=[];let r,o=e===2?"<svg>":"",a=rr;for(let l=0;l<t;l++){const n=i[l];let c,d,h=-1,f=0;for(;f<n.length&&(a.lastIndex=f,d=a.exec(n),d!==null);)f=a.lastIndex,a===rr?d[1]==="!--"?a=Hd:d[1]!==void 0?a=Ud:d[2]!==void 0?(tp.test(d[2])&&(r=RegExp("</"+d[2],"g")),a=mi):d[3]!==void 0&&(a=mi):a===mi?d[0]===">"?(a=r??rr,h=-1):d[1]===void 0?h=-2:(h=a.lastIndex-d[2].length,c=d[1],a=d[3]===void 0?mi:d[3]==='"'?jd:Vd):a===jd||a===Vd?a=mi:a===Hd||a===Ud?a=rr:(a=mi,r=void 0);const g=a===mi&&i[l+1].startsWith("/>")?" ":"";o+=a===rr?n+Lf:h>=0?(s.push(c),n.slice(0,h)+il+n.slice(h)+Kt+g):n+Kt+(h===-2?(s.push(void 0),l):g)}return[ip(i,o+(i[t]||"<?>")+(e===2?"</svg>":"")),s]};let sl=class sp{constructor({strings:e,_$litType$:t},s){let r;this.parts=[];let o=0,a=0;const l=e.length-1,n=this.parts,[c,d]=zf(e,t);if(this.el=sp.createElement(c,s),ki.currentNode=this.el.content,t===2){const h=this.el.content,f=h.firstChild;f.remove(),h.append(...f.childNodes)}for(;(r=ki.nextNode())!==null&&n.length<l;){if(r.nodeType===1){if(r.hasAttributes()){const h=[];for(const f of r.getAttributeNames())if(f.endsWith(il)||f.startsWith(Kt)){const g=d[a++];if(h.push(f),g!==void 0){const y=r.getAttribute(g.toLowerCase()+il).split(Kt),$=/([.?@])?(.*)/.exec(g);n.push({type:1,index:o,name:$[2],strings:y,ctor:$[1]==="."?Nf:$[1]==="?"?Uf:$[1]==="@"?Vf:na})}else n.push({type:6,index:o})}for(const f of h)r.removeAttribute(f)}if(tp.test(r.tagName)){const h=r.textContent.split(Kt),f=h.length-1;if(f>0){r.textContent=xs?xs.emptyScript:"";for(let g=0;g<f;g++)r.append(h[g],Lr()),ki.nextNode(),n.push({type:2,index:++o});r.append(h[f],Lr())}}}else if(r.nodeType===8)if(r.data===J1)n.push({type:2,index:o});else{let h=-1;for(;(h=r.data.indexOf(Kt,h+1))!==-1;)n.push({type:7,index:o}),h+=Kt.length-1}o++}}static createElement(e,t){const s=Ui.createElement("template");return s.innerHTML=e,s}};function _s(i,e,t=i,s){var r,o,a,l;if(e===Ss)return e;let n=s!==void 0?(r=t._$Co)===null||r===void 0?void 0:r[s]:t._$Cl;const c=Br(e)?void 0:e._$litDirective$;return(n==null?void 0:n.constructor)!==c&&((o=n==null?void 0:n._$AO)===null||o===void 0||o.call(n,!1),c===void 0?n=void 0:(n=new c(i),n._$AT(i,t,s)),s!==void 0?((a=(l=t)._$Co)!==null&&a!==void 0?a:l._$Co=[])[s]=n:t._$Cl=n),n!==void 0&&(e=_s(i,n._$AS(i,e.values),n,s)),e}let If=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){var t;const{el:{content:s},parts:r}=this._$AD,o=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:Ui).importNode(s,!0);ki.currentNode=o;let a=ki.nextNode(),l=0,n=0,c=r[0];for(;c!==void 0;){if(l===c.index){let d;c.type===2?d=new Ul(a,a.nextSibling,this,e):c.type===1?d=new c.ctor(a,c.name,c.strings,this,e):c.type===6&&(d=new jf(a,this,e)),this._$AV.push(d),c=r[++n]}l!==(c==null?void 0:c.index)&&(a=ki.nextNode(),l++)}return ki.currentNode=Ui,o}v(e){let t=0;for(const s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(e,s,t),t+=s.strings.length-2):s._$AI(e[t])),t++}},Ul=class rp{constructor(e,t,s,r){var o;this.type=2,this._$AH=ke,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=s,this.options=r,this._$Cp=(o=r==null?void 0:r.isConnected)===null||o===void 0||o}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cp}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=_s(this,e,t),Br(e)?e===ke||e==null||e===""?(this._$AH!==ke&&this._$AR(),this._$AH=ke):e!==this._$AH&&e!==Ss&&this._(e):e._$litType$!==void 0?this.g(e):e.nodeType!==void 0?this.$(e):Bf(e)?this.T(e):this._(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==ke&&Br(this._$AH)?this._$AA.nextSibling.data=e:this.$(Ui.createTextNode(e)),this._$AH=e}g(e){var t;const{values:s,_$litType$:r}=e,o=typeof r=="number"?this._$AC(e):(r.el===void 0&&(r.el=sl.createElement(ip(r.h,r.h[0]),this.options)),r);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===o)this._$AH.v(s);else{const a=new If(o,this),l=a.u(this.options);a.v(s),this.$(l),this._$AH=a}}_$AC(e){let t=Wd.get(e.strings);return t===void 0&&Wd.set(e.strings,t=new sl(e)),t}T(e){ep(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let s,r=0;for(const o of e)r===t.length?t.push(s=new rp(this.k(Lr()),this.k(Lr()),this,this.options)):s=t[r],s._$AI(o),r++;r<t.length&&(this._$AR(s&&s._$AB.nextSibling,r),t.length=r)}_$AR(e=this._$AA.nextSibling,t){var s;for((s=this._$AP)===null||s===void 0||s.call(this,!1,!0,t);e&&e!==this._$AB;){const r=e.nextSibling;e.remove(),e=r}}setConnected(e){var t;this._$AM===void 0&&(this._$Cp=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}},na=class{constructor(e,t,s,r,o){this.type=1,this._$AH=ke,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=o,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=ke}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,s,r){const o=this.strings;let a=!1;if(o===void 0)e=_s(this,e,t,0),a=!Br(e)||e!==this._$AH&&e!==Ss,a&&(this._$AH=e);else{const l=e;let n,c;for(e=o[0],n=0;n<o.length-1;n++)c=_s(this,l[s+n],t,n),c===Ss&&(c=this._$AH[n]),a||(a=!Br(c)||c!==this._$AH[n]),c===ke?e=ke:e!==ke&&(e+=(c??"")+o[n+1]),this._$AH[n]=c}a&&!r&&this.j(e)}j(e){e===ke?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},Nf=class extends na{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===ke?void 0:e}};const Hf=xs?xs.emptyScript:"";let Uf=class extends na{constructor(){super(...arguments),this.type=4}j(e){e&&e!==ke?this.element.setAttribute(this.name,Hf):this.element.removeAttribute(this.name)}},Vf=class extends na{constructor(e,t,s,r,o){super(e,t,s,r,o),this.type=5}_$AI(e,t=this){var s;if((e=(s=_s(this,e,t,0))!==null&&s!==void 0?s:ke)===Ss)return;const r=this._$AH,o=e===ke&&r!==ke||e.capture!==r.capture||e.once!==r.once||e.passive!==r.passive,a=e!==ke&&(r===ke||o);o&&this.element.removeEventListener(this.name,this,r),a&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,s;typeof this._$AH=="function"?this._$AH.call((s=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&s!==void 0?s:this.element,e):this._$AH.handleEvent(e)}},jf=class{constructor(e,t,s){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(e){_s(this,e)}};const qd=Ho.litHtmlPolyfillSupport;qd==null||qd(sl,Ul),((Ja=Ho.litHtmlVersions)!==null&&Ja!==void 0?Ja:Ho.litHtmlVersions=[]).push("2.8.0");const Wf=(i,e,t)=>{var s,r;const o=(s=t==null?void 0:t.renderBefore)!==null&&s!==void 0?s:e;let a=o._$litPart$;if(a===void 0){const l=(r=t==null?void 0:t.renderBefore)!==null&&r!==void 0?r:null;o._$litPart$=a=new Ul(e.insertBefore(Lr(),l),l,void 0,t??{})}return a._$AI(i),a};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var tn,sn;let yr=class extends ht{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e,t;const s=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=s.firstChild),s}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Wf(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!1)}render(){return Ss}};yr.finalized=!0,yr._$litElement$=!0,(tn=globalThis.litElementHydrateSupport)===null||tn===void 0||tn.call(globalThis,{LitElement:yr});const Gd=globalThis.litElementPolyfillSupport;Gd==null||Gd({LitElement:yr});((sn=globalThis.litElementVersions)!==null&&sn!==void 0?sn:globalThis.litElementVersions=[]).push("3.3.3");var Yd;(function(i){i.processing="processing",i.complete="complete"})(Yd||(Yd={}));let rl=class extends yr{constructor(){super(...arguments),this.mode="processing"}render(){return Rf`
      <div class="${this.mode}">
        <svg
          viewBox="0 0 120 120"
    ...
    `}};p([E({type:String})],rl.prototype,"mode",void 0);rl=p([At("ia-activity-indicator")],rl);const qf=m`
<svg
  viewBox="0 0 40 40"
  version="1.1"
  xmlns="http://www.w3.org/2000/svg"
...
`;class Gf extends H{static get styles(){return w`
      :host {
    ...
    `}render(){return qf}}customElements.define("ia-icon-close",Gf);const Yf=m`
  <svg
    class="ia-logo"
    viewBox="0 0 27 30"
    xmlns="http://www.w3.org/2000/svg"
...
`;let ol=class extends H{constructor(){super(...arguments),this.config=new Bi}render(){return m`
      <div class="modal-wrapper">
        <div class="modal-container">
          <header style="background-color: ${this.config.headerColor}">
            ...
            ${this.config.showHeaderLogo?m`<div class="logo-icon">${Yf}</div>`:b}
    ...
    </button> `}static get styles(){const e=w`var(--modalLogoSize, 6.5rem)`,t=w`var(--processingImageSize, 7.5rem)`,s=w`var(--modalCornerRadius, 1rem)`,r=w`var(--modalBorder, 2px solid black)`,o=w`var(--modalBottomMargin, 2.5rem)`,a=w`var(--modalTopMargin, 5rem)`,l=w`var(--modalHeaderBottomPadding, 0.5em)`,n=w`var(--modalBottomPadding, 2rem)`,c=w`var(--modalScrollOffset, 5px)`,d=w`var(--modalTitleFontSize, 1.8rem)`,h=w`var(--modalSubtitleFontSize, 1.4rem)`,f=w`var(--modalHeadlineFontSize, 1.6rem)`,g=w`var(--modalMessageFontSize, 1.4rem)`,y=w`var(--modalTitleLineHeight, normal)`,$=w`var(--modalSubtitleLineHeight, normal)`,A=w`var(--modalHeadlineLineHeight, normal)`,O=w`var(--modalMessageLineHeight, normal)`;return w`
      .processing-logo {
        margin: auto;
        width: ${t};
        height: ${t};
    ...
    `}};p([u({type:Object})],ol.prototype,"config",void 0);ol=p([N("modal-template")],ol);function Kf(i,e,t){var s=t||{},r=s.noTrailing,o=r===void 0?!1:r,a=s.noLeading,l=a===void 0?!1:a,n=s.debounceMode,c=n===void 0?void 0:n,d,h=!1,f=0;function g(){d&&clearTimeout(d)}function y(A){var O=A||{},P=O.upcomingOnly,D=P===void 0?!1:P;g(),h=!D}function $(){for(var A=arguments.length,O=new Array(A),P=0;P<A;P++)O[P]=arguments[P];var D=this,z=Date.now()-f;if(h)return;function K(){f=Date.now(),e.apply(D,O)}function be(){d=void 0}!l&&c&&!d&&K(),g(),c===void 0&&z>i?l?(f=Date.now(),o||(d=setTimeout(c?be:K,i))):K():o!==!0&&(d=setTimeout(c?be:K,c===void 0?i-z:i))}return $.cancel=y,$}var ei;(function(i){i.Open="open",i.Closed="closed"})(ei||(ei={}));class Xf{constructor(e){this.windowResizeThrottler=Kf(100,this.updateModalContainerHeight,{noLeading:!1,noTrailing:!1}).bind(this),this.modalManager=e}handleModeChange(e){switch(e){case ei.Open:this.startResizeListener(),this.stopDocumentScroll();break;case ei.Closed:this.stopResizeListener(),this.resumeDocumentScroll();break}}updateModalContainerHeight(){this.modalManager.style.setProperty("--containerHeight",`${window.innerHeight}px`)}stopDocumentScroll(){document.body.classList.add("modal-manager-open")}resumeDocumentScroll(){document.body.classList.remove("modal-manager-open")}startResizeListener(){window.addEventListener("resize",this.windowResizeThrottler)}stopResizeListener(){window.removeEventListener("resize",this.windowResizeThrottler)}}let Cs=class extends H{constructor(){super(...arguments),this.mode=ei.Closed,this.hostBridge=new Xf(this),this.modal=new Df(this),this.closeOnBackdropClick=!0}async firstUpdated(){await new Promise(e=>setTimeout(e,0)),this.closeOnBackdropClick&&this.addEventListener("keydown",e=>{e.key==="Escape"&&this.backdropClicked()})}disconnectedCallback(){super.disconnectedCallback(),this.modal.deactivate()}render(){return m`
      <div class="container">
    ...
    `}};p([u({type:String,reflect:!0})],Cs.prototype,"mode",void 0);p([u({type:Object})],Cs.prototype,"customModalContent",void 0);p([u({type:Object})],Cs.prototype,"hostBridge",void 0);p([Q("modal-template")],Cs.prototype,"modalTemplate",void 0);Cs=p([N("modal-manager")],Cs);const Qd=w`var(--white, #fff)`,Zf=w`var(--primaryDisableCTAFill, #767676)`,Jf=w`var(--secondaryCTABorder, #999)`,em=w`var(--primaryCTAFill, #194880)`,rn=w`var(--primaryCTAFillRGB, 25, 72, 128)`,tm=w`var(--primaryCTABorder, #c5d1df)`,im=w`var(--primaryErrorCTAFill, #d9534f)`,on=w`var(--primaryErrorCTAFillRGB, 229, 28, 38)`,sm=w`var(--primaryErrorCTABorder, #d43f3a)`,rm=w`var(--secondaryCTAFill, #333)`,an=w`var(--secondaryCTAFillRGB, 51, 51, 51)`,om=w`var(--primaryCTABorder, #979797)`,am=w`var(---primaryWarningFill, #ee8950)`,nn=w`var(--primaryWarningFillRGB, 238, 137, 80)`,nm=w`var(--primaryWarningBorder, #ec7939)`,lm=w`
  .ia-button {
    min-height: 3rem;
    cursor: pointer;
    color: ${Qd};
...
`;var cm=Object.defineProperty,dm=Object.getOwnPropertyDescriptor,Vl=(i,e,t,s)=>{for(var r=s>1?void 0:s?dm(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&cm(e,t,r),r};let Uo=class extends H{constructor(){super(...arguments),this.items=[]}render(){return m`
      <ul>
    ...
    `}};Vl([u({type:Object})],Uo.prototype,"items",2);Vl([u({type:String})],Uo.prototype,"message",2);Uo=Vl([N("remove-items-modal-content")],Uo);var hm=Object.defineProperty,pm=Object.getOwnPropertyDescriptor,Nt=(i,e,t,s)=>{for(var r=s>1?void 0:s?pm(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&hm(e,t,r),r};let Tt=class extends H{constructor(){super(...arguments),this.label=_("Select items to remove"),this.selectedItems=[],this.showSelectAll=!1,this.showUnselectAll=!1,this.showItemManageButton=!1,this.removeAllowed=!1}render(){return m`
    ...
    `}};Nt([u({type:String})],Tt.prototype,"label",2);Nt([u({type:Object})],Tt.prototype,"modalManager",2);Nt([u({type:Object})],Tt.prototype,"selectedItems",2);Nt([u({type:String})],Tt.prototype,"manageViewModalMsg",2);Nt([u({type:Boolean})],Tt.prototype,"showSelectAll",2);Nt([u({type:Boolean})],Tt.prototype,"showUnselectAll",2);Nt([u({type:Boolean})],Tt.prototype,"showItemManageButton",2);Nt([u({type:Boolean})],Tt.prototype,"removeAllowed",2);Tt=Nt([N("manage-bar")],Tt);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const wr=(i,e)=>{var s;const t=i._$AN;if(t===void 0)return!1;for(const r of t)(s=r._$AO)==null||s.call(r,e,!1),wr(r,e);return!0},Vo=i=>{let e,t;do{if((e=i._$AM)===void 0)break;t=e._$AN,t.delete(i),i=e}while((t==null?void 0:t.size)===0)},op=i=>{for(let e;e=i._$AM;i=e){let t=e._$AN;if(t===void 0)e._$AN=t=new Set;else if(t.has(i))break;t.add(i),mm(e)}};function um(i){this._$AN!==void 0?(Vo(this),this._$AM=i,op(this)):this._$AM=i}function fm(i,e=!1,t=0){const s=this._$AH,r=this._$AN;if(r!==void 0&&r.size!==0)if(e)if(Array.isArray(s))for(let o=t;o<s.length;o++)wr(s[o],!1),Vo(s[o]);else s!=null&&(wr(s,!1),Vo(s));else wr(this,i)}const mm=i=>{i.type==_t.CHILD&&(i._$AP??(i._$AP=fm),i._$AQ??(i._$AQ=um))};let gm=class extends Wr{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,s){super._$AT(e,t,s),op(this),this.isConnected=e._$AU}_$AO(e,t=!0){var s,r;e!==this.isConnected&&(this.isConnected=e,e?(s=this.reconnected)==null||s.call(this):(r=this.disconnected)==null||r.call(this)),t&&(wr(this,e),Vo(this))}setValue(e){if($1(this._$Ct))this._$Ct._$AI(e,this);else{const t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}};const ln=new WeakMap,vm=jr(class extends gm{render(i){return oe}update(i,[e]){var s;const t=e!==this.G;return t&&this.G!==void 0&&this.rt(void 0),(t||this.lt!==this.ct)&&(this.G=e,this.ht=(s=i.options)==null?void 0:s.host,this.rt(this.ct=i.element)),oe}rt(i){if(this.isConnected||(i=void 0),typeof this.G=="function"){const e=this.ht??globalThis;let t=ln.get(e);t===void 0&&(t=new WeakMap,ln.set(e,t)),t.get(this.G)!==void 0&&this.G.call(this.ht,void 0),t.set(this.G,i),i!==void 0&&this.G.call(this.ht,i)}else this.G.value=i}get lt(){var i,e;return typeof this.G=="function"?(i=ln.get(this.ht??globalThis))==null?void 0:i.get(this.G):(e=this.G)==null?void 0:e.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}});var ap=60,np=ap*60,lp=np*24,bm=lp*7,Ts=1e3,cn=ap*Ts,Kd=np*Ts,ym=lp*Ts,wm=bm*Ts,jl="millisecond",as="second",ns="minute",ls="hour",Vt="day",wo="week",dt="month",cp="quarter",jt="year",cs="date",$m="YYYY-MM-DDTHH:mm:ssZ",Xd="Invalid Date",xm=/^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/,Sm=/\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g;const _m={name:"en",weekdays:"Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),months:"January_February_March_April_May_June_July_August_September_October_November_December".split("_"),ordinal:function(e){var t=["th","st","nd","rd"],s=e%100;return"["+e+(t[(s-20)%10]||t[s]||t[0])+"]"}};var al=function(e,t,s){var r=String(e);return!r||r.length>=t?e:""+Array(t+1-r.length).join(s)+e},Cm=function(e){var t=-e.utcOffset(),s=Math.abs(t),r=Math.floor(s/60),o=s%60;return(t<=0?"+":"-")+al(r,2,"0")+":"+al(o,2,"0")},Tm=function i(e,t){if(e.date()<t.date())return-i(t,e);var s=(t.year()-e.year())*12+(t.month()-e.month()),r=e.clone().add(s,dt),o=t-r<0,a=e.clone().add(s+(o?-1:1),dt);return+(-(s+(t-r)/(o?r-a:a-r))||0)},Am=function(e){return e<0?Math.ceil(e)||0:Math.floor(e)},km=function(e){var t={M:dt,y:jt,w:wo,d:Vt,D:cs,h:ls,m:ns,s:as,ms:jl,Q:cp};return t[e]||String(e||"").toLowerCase().replace(/s$/,"")},Em=function(e){return e===void 0};const Mm={s:al,z:Cm,m:Tm,a:Am,p:km,u:Em};var $r="en",Fi={};Fi[$r]=_m;var dp="$isDayjsObject",Wl=function(e){return e instanceof la||!!(e&&e[dp])},jo=function i(e,t,s){var r;if(!e)return $r;if(typeof e=="string"){var o=e.toLowerCase();Fi[o]&&(r=o),t&&(Fi[o]=t,r=o);var a=e.split("-");if(!r&&a.length>1)return i(a[0])}else{var l=e.name;Fi[l]=e,r=l}return!s&&r&&($r=r),r||!s&&$r},ne=function(e,t){if(Wl(e))return e.clone();var s=typeof t=="object"?t:{};return s.date=e,s.args=arguments,new la(s)},Pm=function(e,t){return ne(e,{locale:t.$L,utc:t.$u,x:t.$x,$offset:t.$offset})},X=Mm;X.l=jo;X.i=Wl;X.w=Pm;var Om=function(e){var t=e.date,s=e.utc;if(t===null)return new Date(NaN);if(X.u(t))return new Date;if(t instanceof Date)return new Date(t);if(typeof t=="string"&&!/Z$/i.test(t)){var r=t.match(xm);if(r){var o=r[2]-1||0,a=(r[7]||"0").substring(0,3);return s?new Date(Date.UTC(r[1],o,r[3]||1,r[4]||0,r[5]||0,r[6]||0,a)):new Date(r[1],o,r[3]||1,r[4]||0,r[5]||0,r[6]||0,a)}}return new Date(t)},la=function(){function i(t){this.$L=jo(t.locale,null,!0),this.parse(t),this.$x=this.$x||t.x||{},this[dp]=!0}var e=i.prototype;return e.parse=function(s){this.$d=Om(s),this.init()},e.init=function(){var s=this.$d;this.$y=s.getFullYear(),this.$M=s.getMonth(),this.$D=s.getDate(),this.$W=s.getDay(),this.$H=s.getHours(),this.$m=s.getMinutes(),this.$s=s.getSeconds(),this.$ms=s.getMilliseconds()},e.$utils=function(){return X},e.isValid=function(){return this.$d.toString()!==Xd},e.isSame=function(s,r){var o=ne(s);return this.startOf(r)<=o&&o<=this.endOf(r)},e.isAfter=function(s,r){return ne(s)<this.startOf(r)},e.isBefore=function(s,r){return this.endOf(r)<ne(s)},e.$g=function(s,r,o){return X.u(s)?this[r]:this.set(o,s)},e.unix=function(){return Math.floor(this.valueOf()/1e3)},e.valueOf=function(){return this.$d.getTime()},e.startOf=function(s,r){var o=this,a=X.u(r)?!0:r,l=X.p(s),n=function(O,P){var D=X.w(o.$u?Date.UTC(o.$y,P,O):new Date(o.$y,P,O),o);return a?D:D.endOf(Vt)},c=function(O,P){var D=[0,0,0,0],z=[23,59,59,999];return X.w(o.toDate()[O].apply(o.toDate("s"),(a?D:z).slice(P)),o)},d=this.$W,h=this.$M,f=this.$D,g="set"+(this.$u?"UTC":"");switch(l){case jt:return a?n(1,0):n(31,11);case dt:return a?n(1,h):n(0,h+1);case wo:{var y=this.$locale().weekStart||0,$=(d<y?d+7:d)-y;return n(a?f-$:f+(6-$),h)}case Vt:case cs:return c(g+"Hours",0);case ls:return c(g+"Minutes",1);case ns:return c(g+"Seconds",2);case as:return c(g+"Milliseconds",3);default:return this.clone()}},e.endOf=function(s){return this.startOf(s,!1)},e.$set=function(s,r){var o,a=X.p(s),l="set"+(this.$u?"UTC":""),n=(o={},o[Vt]=l+"Date",o[cs]=l+"Date",o[dt]=l+"Month",o[jt]=l+"FullYear",o[ls]=l+"Hours",o[ns]=l+"Minutes",o[as]=l+"Seconds",o[jl]=l+"Milliseconds",o)[a],c=a===Vt?this.$D+(r-this.$W):r;if(a===dt||a===jt){var d=this.clone().set(cs,1);d.$d[n](c),d.init(),this.$d=d.set(cs,Math.min(this.$D,d.daysInMonth())).$d}else n&&this.$d[n](c);return this.init(),this},e.set=function(s,r){return this.clone().$set(s,r)},e.get=function(s){return this[X.p(s)]()},e.add=function(s,r){var o=this,a;s=Number(s);var l=X.p(r),n=function(f){var g=ne(o);return X.w(g.date(g.date()+Math.round(f*s)),o)};if(l===dt)return this.set(dt,this.$M+s);if(l===jt)return this.set(jt,this.$y+s);if(l===Vt)return n(1);if(l===wo)return n(7);var c=(a={},a[ns]=cn,a[ls]=Kd,a[as]=Ts,a)[l]||1,d=this.$d.getTime()+s*c;return X.w(d,this)},e.subtract=function(s,r){return this.add(s*-1,r)},e.format=function(s){var r=this,o=this.$locale();if(!this.isValid())return o.invalidDate||Xd;var a=s||$m,l=X.z(this),n=this.$H,c=this.$m,d=this.$M,h=o.weekdays,f=o.months,g=o.meridiem,y=function(D,z,K,be){return D&&(D[z]||D(r,a))||K[z].slice(0,be)},$=function(D){return X.s(n%12||12,D,"0")},A=g||function(P,D,z){var K=P<12?"AM":"PM";return z?K.toLowerCase():K},O=function(D){switch(D){case"YY":return String(r.$y).slice(-2);case"YYYY":return X.s(r.$y,4,"0");case"M":return d+1;case"MM":return X.s(d+1,2,"0");case"MMM":return y(o.monthsShort,d,f,3);case"MMMM":return y(f,d);case"D":return r.$D;case"DD":return X.s(r.$D,2,"0");case"d":return String(r.$W);case"dd":return y(o.weekdaysMin,r.$W,h,2);case"ddd":return y(o.weekdaysShort,r.$W,h,3);case"dddd":return h[r.$W];case"H":return String(n);case"HH":return X.s(n,2,"0");case"h":return $(1);case"hh":return $(2);case"a":return A(n,c,!0);case"A":return A(n,c,!1);case"m":return String(c);case"mm":return X.s(c,2,"0");case"s":return String(r.$s);case"ss":return X.s(r.$s,2,"0");case"SSS":return X.s(r.$ms,3,"0");case"Z":return l}return null};return a.replace(Sm,function(P,D){return D||O(P)||l.replace(":","")})},e.utcOffset=function(){return-Math.round(this.$d.getTimezoneOffset()/15)*15},e.diff=function(s,r,o){var a=this,l=X.p(r),n=ne(s),c=(n.utcOffset()-this.utcOffset())*cn,d=this-n,h=function(){return X.m(a,n)},f;switch(l){case jt:f=h()/12;break;case dt:f=h();break;case cp:f=h()/3;break;case wo:f=(d-c)/wm;break;case Vt:f=(d-c)/ym;break;case ls:f=d/Kd;break;case ns:f=d/cn;break;case as:f=d/Ts;break;default:f=d;break}return o?f:X.a(f)},e.daysInMonth=function(){return this.endOf(dt).$D},e.$locale=function(){return Fi[this.$L]},e.locale=function(s,r){if(!s)return this.$L;var o=this.clone(),a=jo(s,r,!0);return a&&(o.$L=a),o},e.clone=function(){return X.w(this.$d,this)},e.toDate=function(){return new Date(this.valueOf())},e.toJSON=function(){return this.isValid()?this.toISOString():null},e.toISOString=function(){return this.$d.toISOString()},e.toString=function(){return this.$d.toUTCString()},i}(),hp=la.prototype;ne.prototype=hp;[["$ms",jl],["$s",as],["$m",ns],["$H",ls],["$W",Vt],["$M",dt],["$y",jt],["$D",cs]].forEach(function(i){hp[i[1]]=function(e){return this.$g(e,i[0],i[1])}});ne.extend=function(i,e){return i.$i||(i(e,la,ne),i.$i=!0),ne};ne.locale=jo;ne.isDayjs=Wl;ne.unix=function(i){return ne(i*1e3)};ne.en=Fi[$r];ne.Ls=Fi;ne.p={};var Dm=function(e){return e.replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g,function(t,s,r){return s||r.slice(1)})},Lm={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"},Bm=function(e,t){return e.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g,function(s,r,o){var a=o&&o.toUpperCase();return r||t[o]||Lm[o]||Dm(t[a])})},Fm=/(\[[^[]*\])|([-_:/.,()\s]+)|(A|a|Q|YYYY|YY?|ww?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g,Zd=/\d/,or=/\d\d/,Rm=/\d{3}/,zm=/\d{4}/,nt=/\d\d?/,Im=/[+-]?\d+/,Nm=/[+-]\d\d:?(\d\d)?|Z/,ar=/\d*[^-_:/,()\s\d]+/,si={},pp=function(e){return e=+e,e+(e>68?1900:2e3)};function Hm(i){if(!i||i==="Z")return 0;var e=i.match(/([+-]|\d\d)/g),t=+(e[1]*60)+(+e[2]||0);return t===0?0:e[0]==="+"?-t:t}var Le=function(e){return function(t){this[e]=+t}},Jd=[Nm,function(i){var e=this.zone||(this.zone={});e.offset=Hm(i)}],dn=function(e){var t=si[e];return t&&(t.indexOf?t:t.s.concat(t.f))},eh=function(e,t){var s,r=si,o=r.meridiem;if(!o)s=e===(t?"pm":"PM");else for(var a=1;a<=24;a+=1)if(e.indexOf(o(a,0,t))>-1){s=a>12;break}return s},Um={A:[ar,function(i){this.afternoon=eh(i,!1)}],a:[ar,function(i){this.afternoon=eh(i,!0)}],Q:[Zd,function(i){this.month=(i-1)*3+1}],S:[Zd,function(i){this.milliseconds=+i*100}],SS:[or,function(i){this.milliseconds=+i*10}],SSS:[Rm,function(i){this.milliseconds=+i}],s:[nt,Le("seconds")],ss:[nt,Le("seconds")],m:[nt,Le("minutes")],mm:[nt,Le("minutes")],H:[nt,Le("hours")],h:[nt,Le("hours")],HH:[nt,Le("hours")],hh:[nt,Le("hours")],D:[nt,Le("day")],DD:[or,Le("day")],Do:[ar,function(i){var e=si,t=e.ordinal,s=i.match(/\d+/);if(this.day=s[0],!!t)for(var r=1;r<=31;r+=1)t(r).replace(/\[|\]/g,"")===i&&(this.day=r)}],w:[nt,Le("week")],ww:[or,Le("week")],M:[nt,Le("month")],MM:[or,Le("month")],MMM:[ar,function(i){var e=dn("months"),t=dn("monthsShort"),s=(t||e.map(function(r){return r.slice(0,3)})).indexOf(i)+1;if(s<1)throw new Error;this.month=s%12||s}],MMMM:[ar,function(i){var e=dn("months"),t=e.indexOf(i)+1;if(t<1)throw new Error;this.month=t%12||t}],Y:[Im,Le("year")],YY:[or,function(i){this.year=pp(i)}],YYYY:[zm,Le("year")],Z:Jd,ZZ:Jd};function Vm(i){var e=i.afternoon;if(e!==void 0){var t=i.hours;e?t<12&&(i.hours+=12):t===12&&(i.hours=0),delete i.afternoon}}function jm(i){i=Bm(i,si&&si.formats);for(var e=i.match(Fm),t=e.length,s=0;s<t;s+=1){var r=e[s],o=Um[r],a=o&&o[0],l=o&&o[1];l?e[s]={regex:a,parser:l}:e[s]=r.replace(/^\[|\]$/g,"")}return function(n){for(var c={},d=0,h=0;d<t;d+=1){var f=e[d];if(typeof f=="string")h+=f.length;else{var g=f.regex,y=f.parser,$=n.slice(h),A=g.exec($),O=A[0];y.call(c,O),n=n.replace(O,"")}}return Vm(c),c}}var Wm=function(e,t,s,r){try{if(["x","X"].indexOf(t)>-1)return new Date((t==="X"?1e3:1)*e);var o=jm(t),a=o(e),l=a.year,n=a.month,c=a.day,d=a.hours,h=a.minutes,f=a.seconds,g=a.milliseconds,y=a.zone,$=a.week,A=new Date,O=c||(!l&&!n?A.getDate():1),P=l||A.getFullYear(),D=0;l&&!n||(D=n>0?n-1:A.getMonth());var z=d||0,K=h||0,be=f||0,Be=g||0;if(y)return new Date(Date.UTC(P,D,O,z,K,be,Be+y.offset*60*1e3));if(s)return new Date(Date.UTC(P,D,O,z,K,be,Be));var We;return We=new Date(P,D,O,z,K,be,Be),$&&(We=r(We).week($).toDate()),We}catch{return new Date("")}};const qm=function(i,e,t){t.p.customParseFormat=!0,i&&i.parseTwoDigitYear&&(pp=i.parseTwoDigitYear);var s=e.prototype,r=s.parse;s.parse=function(o){var a=o.date,l=o.utc,n=o.args;this.$u=l;var c=n[1];if(typeof c=="string"){var d=n[2]===!0,h=n[3]===!0,f=d||h,g=n[2];h&&(g=n[2]),si=this.$locale(),!d&&g&&(si=t.Ls[g]),this.$d=Wm(a,c,l,t),this.init(),g&&g!==!0&&(this.$L=this.locale(g).$L),f&&a!=this.format(c)&&(this.$d=new Date("")),si={}}else if(c instanceof Array)for(var y=c.length,$=1;$<=y;$+=1){n[1]=c[$-1];var A=t.apply(this,n);if(A.isValid()){this.$d=A.$d,this.$L=A.$L,this.init();break}$===y&&(this.$d=new Date(""))}else r.call(this,o)}};function Gm(i,e){const t=e.prototype,s=t.parse;t.parse=function(r){const o=r.date,a=r.args[1];s.call(this,r);const l=this.year(),n=l>=1900&&l<2e3,c=typeof a=="string"&&a.includes("YYYY"),d=Array.isArray(a)&&typeof a[0]=="string"&&a[0].includes("YYYY"),h=c||d,f=typeof o=="string"&&!o.includes(`${l}`);n&&h&&f&&(this.$d.setFullYear(l-1900),this.init())}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var hn;const Wo=window,As=Wo.trustedTypes,th=As?As.createPolicy("lit-html",{createHTML:i=>i}):void 0,nl="$lit$",Xt=`lit$${(Math.random()+"").slice(9)}$`,up="?"+Xt,Ym=`<${up}>`,Vi=document,Fr=()=>Vi.createComment(""),Rr=i=>i===null||typeof i!="object"&&typeof i!="function",fp=Array.isArray,Qm=i=>fp(i)||typeof(i==null?void 0:i[Symbol.iterator])=="function",pn=`[ 	
\f\r]`,nr=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,ih=/-->/g,sh=/>/g,gi=RegExp(`>|${pn}(?:([^\\s"'>=/]+)(${pn}*=${pn}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),rh=/'/g,oh=/"/g,mp=/^(?:script|style|textarea|title)$/i,gp=i=>(e,...t)=>({_$litType$:i,strings:e,values:t}),St=gp(1),un=gp(2),tt=Symbol.for("lit-noChange"),$e=Symbol.for("lit-nothing"),ah=new WeakMap,Ei=Vi.createTreeWalker(Vi,129,null,!1);function vp(i,e){if(!Array.isArray(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return th!==void 0?th.createHTML(e):e}const Km=(i,e)=>{const t=i.length-1,s=[];let r,o=e===2?"<svg>":"",a=nr;for(let l=0;l<t;l++){const n=i[l];let c,d,h=-1,f=0;for(;f<n.length&&(a.lastIndex=f,d=a.exec(n),d!==null);)f=a.lastIndex,a===nr?d[1]==="!--"?a=ih:d[1]!==void 0?a=sh:d[2]!==void 0?(mp.test(d[2])&&(r=RegExp("</"+d[2],"g")),a=gi):d[3]!==void 0&&(a=gi):a===gi?d[0]===">"?(a=r??nr,h=-1):d[1]===void 0?h=-2:(h=a.lastIndex-d[2].length,c=d[1],a=d[3]===void 0?gi:d[3]==='"'?oh:rh):a===oh||a===rh?a=gi:a===ih||a===sh?a=nr:(a=gi,r=void 0);const g=a===gi&&i[l+1].startsWith("/>")?" ":"";o+=a===nr?n+Ym:h>=0?(s.push(c),n.slice(0,h)+nl+n.slice(h)+Xt+g):n+Xt+(h===-2?(s.push(void 0),l):g)}return[vp(i,o+(i[t]||"<?>")+(e===2?"</svg>":"")),s]};let ll=class bp{constructor({strings:e,_$litType$:t},s){let r;this.parts=[];let o=0,a=0;const l=e.length-1,n=this.parts,[c,d]=Km(e,t);if(this.el=bp.createElement(c,s),Ei.currentNode=this.el.content,t===2){const h=this.el.content,f=h.firstChild;f.remove(),h.append(...f.childNodes)}for(;(r=Ei.nextNode())!==null&&n.length<l;){if(r.nodeType===1){if(r.hasAttributes()){const h=[];for(const f of r.getAttributeNames())if(f.endsWith(nl)||f.startsWith(Xt)){const g=d[a++];if(h.push(f),g!==void 0){const y=r.getAttribute(g.toLowerCase()+nl).split(Xt),$=/([.?@])?(.*)/.exec(g);n.push({type:1,index:o,name:$[2],strings:y,ctor:$[1]==="."?Zm:$[1]==="?"?eg:$[1]==="@"?tg:ca})}else n.push({type:6,index:o})}for(const f of h)r.removeAttribute(f)}if(mp.test(r.tagName)){const h=r.textContent.split(Xt),f=h.length-1;if(f>0){r.textContent=As?As.emptyScript:"";for(let g=0;g<f;g++)r.append(h[g],Fr()),Ei.nextNode(),n.push({type:2,index:++o});r.append(h[f],Fr())}}}else if(r.nodeType===8)if(r.data===up)n.push({type:2,index:o});else{let h=-1;for(;(h=r.data.indexOf(Xt,h+1))!==-1;)n.push({type:7,index:o}),h+=Xt.length-1}o++}}static createElement(e,t){const s=Vi.createElement("template");return s.innerHTML=e,s}};function ks(i,e,t=i,s){var r,o,a,l;if(e===tt)return e;let n=s!==void 0?(r=t._$Co)===null||r===void 0?void 0:r[s]:t._$Cl;const c=Rr(e)?void 0:e._$litDirective$;return(n==null?void 0:n.constructor)!==c&&((o=n==null?void 0:n._$AO)===null||o===void 0||o.call(n,!1),c===void 0?n=void 0:(n=new c(i),n._$AT(i,t,s)),s!==void 0?((a=(l=t)._$Co)!==null&&a!==void 0?a:l._$Co=[])[s]=n:t._$Cl=n),n!==void 0&&(e=ks(i,n._$AS(i,e.values),n,s)),e}let Xm=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){var t;const{el:{content:s},parts:r}=this._$AD,o=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:Vi).importNode(s,!0);Ei.currentNode=o;let a=Ei.nextNode(),l=0,n=0,c=r[0];for(;c!==void 0;){if(l===c.index){let d;c.type===2?d=new ql(a,a.nextSibling,this,e):c.type===1?d=new c.ctor(a,c.name,c.strings,this,e):c.type===6&&(d=new ig(a,this,e)),this._$AV.push(d),c=r[++n]}l!==(c==null?void 0:c.index)&&(a=Ei.nextNode(),l++)}return Ei.currentNode=Vi,o}v(e){let t=0;for(const s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(e,s,t),t+=s.strings.length-2):s._$AI(e[t])),t++}},ql=class yp{constructor(e,t,s,r){var o;this.type=2,this._$AH=$e,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=s,this.options=r,this._$Cp=(o=r==null?void 0:r.isConnected)===null||o===void 0||o}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cp}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=ks(this,e,t),Rr(e)?e===$e||e==null||e===""?(this._$AH!==$e&&this._$AR(),this._$AH=$e):e!==this._$AH&&e!==tt&&this._(e):e._$litType$!==void 0?this.g(e):e.nodeType!==void 0?this.$(e):Qm(e)?this.T(e):this._(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==$e&&Rr(this._$AH)?this._$AA.nextSibling.data=e:this.$(Vi.createTextNode(e)),this._$AH=e}g(e){var t;const{values:s,_$litType$:r}=e,o=typeof r=="number"?this._$AC(e):(r.el===void 0&&(r.el=ll.createElement(vp(r.h,r.h[0]),this.options)),r);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===o)this._$AH.v(s);else{const a=new Xm(o,this),l=a.u(this.options);a.v(s),this.$(l),this._$AH=a}}_$AC(e){let t=ah.get(e.strings);return t===void 0&&ah.set(e.strings,t=new ll(e)),t}T(e){fp(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let s,r=0;for(const o of e)r===t.length?t.push(s=new yp(this.k(Fr()),this.k(Fr()),this,this.options)):s=t[r],s._$AI(o),r++;r<t.length&&(this._$AR(s&&s._$AB.nextSibling,r),t.length=r)}_$AR(e=this._$AA.nextSibling,t){var s;for((s=this._$AP)===null||s===void 0||s.call(this,!1,!0,t);e&&e!==this._$AB;){const r=e.nextSibling;e.remove(),e=r}}setConnected(e){var t;this._$AM===void 0&&(this._$Cp=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}},ca=class{constructor(e,t,s,r,o){this.type=1,this._$AH=$e,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=o,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=$e}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,s,r){const o=this.strings;let a=!1;if(o===void 0)e=ks(this,e,t,0),a=!Rr(e)||e!==this._$AH&&e!==tt,a&&(this._$AH=e);else{const l=e;let n,c;for(e=o[0],n=0;n<o.length-1;n++)c=ks(this,l[s+n],t,n),c===tt&&(c=this._$AH[n]),a||(a=!Rr(c)||c!==this._$AH[n]),c===$e?e=$e:e!==$e&&(e+=(c??"")+o[n+1]),this._$AH[n]=c}a&&!r&&this.j(e)}j(e){e===$e?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},Zm=class extends ca{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===$e?void 0:e}};const Jm=As?As.emptyScript:"";let eg=class extends ca{constructor(){super(...arguments),this.type=4}j(e){e&&e!==$e?this.element.setAttribute(this.name,Jm):this.element.removeAttribute(this.name)}},tg=class extends ca{constructor(e,t,s,r,o){super(e,t,s,r,o),this.type=5}_$AI(e,t=this){var s;if((e=(s=ks(this,e,t,0))!==null&&s!==void 0?s:$e)===tt)return;const r=this._$AH,o=e===$e&&r!==$e||e.capture!==r.capture||e.once!==r.once||e.passive!==r.passive,a=e!==$e&&(r===$e||o);o&&this.element.removeEventListener(this.name,this,r),a&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,s;typeof this._$AH=="function"?this._$AH.call((s=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&s!==void 0?s:this.element,e):this._$AH.handleEvent(e)}},ig=class{constructor(e,t,s){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(e){ks(this,e)}};const nh=Wo.litHtmlPolyfillSupport;nh==null||nh(ll,ql),((hn=Wo.litHtmlVersions)!==null&&hn!==void 0?hn:Wo.litHtmlVersions=[]).push("2.8.0");const sg=(i,e,t)=>{var s,r;const o=(s=t==null?void 0:t.renderBefore)!==null&&s!==void 0?s:e;let a=o._$litPart$;if(a===void 0){const l=(r=t==null?void 0:t.renderBefore)!==null&&r!==void 0?r:null;o._$litPart$=a=new ql(e.insertBefore(Fr(),l),l,void 0,t??{})}return a._$AI(i),a};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var fn,mn;let xr=class extends ht{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e,t;const s=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=s.firstChild),s}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=sg(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!1)}render(){return tt}};xr.finalized=!0,xr._$litElement$=!0,(fn=globalThis.litElementHydrateSupport)===null||fn===void 0||fn.call(globalThis,{LitElement:xr});const lh=globalThis.litElementPolyfillSupport;lh==null||lh({LitElement:xr});((mn=globalThis.litElementVersions)!==null&&mn!==void 0?mn:globalThis.litElementVersions=[]).push("3.3.3");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */const wp="important",lg=" !"+wp,cg=Gl(class extends Yl{constructor(i){var e;if(super(i),i.type!==Wt.ATTRIBUTE||i.name!=="style"||((e=i.strings)===null||e===void 0?void 0:e.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(i){return Object.keys(i).reduce((e,t)=>{const s=i[t];return s==null?e:e+`${t=t.includes("-")?t:t.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${s};`},"")}update(i,[e]){const{style:t}=i.element;if(this.ht===void 0){this.ht=new Set;for(const s in e)this.ht.add(s);return this.render(e)}this.ht.forEach(s=>{e[s]==null&&(this.ht.delete(s),s.includes("-")?t.removeProperty(s):t[s]="")});for(const s in e){const r=e[s];if(r!=null){this.ht.add(s);const o=typeof r=="string"&&r.endsWith(lg);s.includes("-")||o?t.setProperty(s,o?r.slice(0,-11):r,o?wp:""):t[s]=r}}return tt}});ne.extend(qm);ne.extend(Gm);const dg=180,hg=40,pg=10,ug=125,fg=30,dh="YYYY",mg="no data",gg=0,vg="item",hh=4,bg={linear:i=>i,logarithmic:i=>Math.log1p(i)},yg=x`var(--histogramDateRangeSliderColor, #4B65FE)`,wg=x`var(--histogramDateRangeSelectedRangeColor, #DBE0FF)`,$g=x`var(--histogramDateRangeBarIncludedFill, #2C2C2C)`,xg=x`var(--histogramDateRangeActivityIndicator, #2C2C2C)`,Sg=x`var(--histogramDateRangeBarExcludedFill, #CCCCCC)`,_g=x`var(--histogramDateRangeInputRowMargin, 0)`,Cg=x`var(--histogramDateRangeInputBorder, 0.5px solid #2C2C2C)`,Tg=x`var(--histogramDateRangeInputWidth, 35px)`,Ag=x`var(--histogramDateRangeInputFontSize, 1.2rem)`,kg=x`var(--histogramDateRangeInputFontFamily, sans-serif)`,ph=x`var(--histogramDateRangeTooltipBackgroundColor, #2C2C2C)`,uh=x`var(--histogramDateRangeTooltipTextColor, #FFFFFF)`,Eg=x`var(--histogramDateRangeTooltipFontSize, 1.1rem)`,Mg=x`var(--histogramDateRangeTooltipFontFamily, sans-serif)`;let Y=class extends xr{constructor(){super(...arguments),this.width=dg,this.height=hg,this.sliderWidth=pg,this.tooltipWidth=ug,this.tooltipHeight=fg,this.updateDelay=gg,this.dateFormat=dh,this.missingDataMessage=mg,this.minDate="",this.maxDate="",this.disabled=!1,this.bins=[],this.updateWhileFocused=!1,this.binSnapping="none",this.tooltipLabel=vg,this.barScaling="logarithmic",this._tooltipOffsetX=0,this._tooltipOffsetY=0,this._isDragging=!1,this._isLoading=!1,this._minSelectedDate="",this._maxSelectedDate="",this._minDateMS=0,this._maxDateMS=0,this._dragOffset=0,this._histWidth=0,this._binWidth=0,this._histData=[],this._previousDateRange="",this.drag=e=>{e.preventDefault(),!this.disabled&&(this.setDragOffset(e),this._isDragging=!0,this.addListeners(),this.cancelPendingUpdateEvent())},this.drop=()=>{this._isDragging&&(this.removeListeners(),this.beginEmitUpdateProcess()),this._isDragging=!1},this.move=e=>{const t=this.getBoundingClientRect().x,s=e.clientX-t-this._dragOffset;this._currentSlider.id==="slider-min"?this.minSelectedDate=this.translatePositionToDate(this.validMinSliderX(s)):(this.maxSelectedDate=this.translatePositionToDate(this.validMaxSliderX(s)),this.getMSFromString(this.maxSelectedDate)>this._maxDateMS&&(this.maxSelectedDate=this.maxDate))}}disconnectedCallback(){this.removeListeners(),super.disconnectedCallback()}willUpdate(e){(e.has("bins")||e.has("minDate")||e.has("maxDate")||e.has("minSelectedDate")||e.has("maxSelectedDate")||e.has("width")||e.has("height")||e.has("binSnapping")||e.has("barScaling"))&&this.handleDataUpdate()}handleDataUpdate(){this.hasBinData&&(this._histWidth=this.width-this.sliderWidth*2,this._minDateMS=this.snapTimestamp(this.getMSFromString(this.minDate)),this._maxDateMS=this.snapTimestamp(this.getMSFromString(this.maxDate)+this.snapInterval)+this.snapEndOffset,this._binWidth=this._histWidth/this._numBins,this._previousDateRange=this.currentDateRangeString,this._histData=this.calculateHistData(),this.minSelectedDate=this.minSelectedDate?this.minSelectedDate:this.minDate,this.maxSelectedDate=this.maxSelectedDate?this.maxSelectedDate:this.maxDate)}snapToNextSecond(e){return Math.ceil(e/1e3)*1e3}snapToMonth(e){const t=ne(e),s=t.date()<16?0:1;return t.add(s,"month").date(1).hour(0).minute(0).second(0).millisecond(0).valueOf()}snapToYear(e){const t=ne(e),s=t.month()<6?0:1;return t.add(s,"year").month(0).date(1).hour(0).minute(0).second(0).millisecond(0).valueOf()}snapTimestamp(e){switch(this.binSnapping){case"year":return this.snapToYear(e);case"month":return this.snapToMonth(e);case"none":default:return this.snapToNextSecond(e)}}get barScalingFunction(){return typeof this.barScaling=="string"?bg[this.barScaling]:this.barScaling}calculateHistData(){const{bins:e,height:t,dateRangeMS:s,_numBins:r,_minDateMS:o}=this,a=Math.min(...this.bins),l=Math.max(...this.bins),n=a===l?1:this.barScalingFunction(l),c=t/n,d=s/r;return e.map((h,f)=>{const g=this.snapTimestamp(f*d+o),y=this.formatDate(g),$=this.snapTimestamp((f+1)*d+o)+this.snapEndOffset,A=this.formatDate($),O=this.formatDate(g,this.tooltipDateFormat),P=this.formatDate($,this.tooltipDateFormat),D=O===P?O:`${O} - ${P}`;return{value:h,height:Math.floor(this.barScalingFunction(h)*c),binStart:y,binEnd:A,tooltip:D}})}get hasBinData(){return this._numBins>0}get _numBins(){return!this.bins||!this.bins.length?0:this.bins.length}get histogramLeftEdgeX(){return this.sliderWidth}get histogramRightEdgeX(){return this.width-this.sliderWidth}get snapInterval(){switch(this.binSnapping){case"year":return 31536e6;case"month":return 2592e6;case"none":default:return 0}}get snapEndOffset(){return this.binSnapping!=="none"&&this._numBins>1?-1:0}get tooltipDateFormat(){var e;return(e=this._tooltipDateFormat)!==null&&e!==void 0?e:this.dateFormat}set tooltipDateFormat(e){this._tooltipDateFormat=e}get loading(){return this._isLoading}set loading(e){this.disabled=e,this._isLoading=e}get minSelectedDate(){return this.formatDate(this.getMSFromString(this._minSelectedDate))}set minSelectedDate(e){if(!this._minSelectedDate){this._minSelectedDate=e;return}const t=this.getMSFromString(e),s=!Number.isNaN(t),r=t<=this.getMSFromString(this.maxSelectedDate);s&&r&&(this._minSelectedDate=this.formatDate(t)),this.requestUpdate()}get maxSelectedDate(){return this.formatDate(this.getMSFromString(this._maxSelectedDate))}set maxSelectedDate(e){if(!this._maxSelectedDate){this._maxSelectedDate=e;return}const t=this.getMSFromString(e),s=!Number.isNaN(t),r=t>=this.getMSFromString(this.minSelectedDate);s&&r&&(this._maxSelectedDate=this.formatDate(t)),this.requestUpdate()}get minSliderX(){const e=this.translateDateToPosition(this.minSelectedDate);return this.validMinSliderX(e)}get maxSliderX(){const e=this.snapTimestamp(this.getMSFromString(this.maxSelectedDate)+this.snapInterval),t=this.translateDateToPosition(this.formatDate(e));return this.validMaxSliderX(t)}get dateRangeMS(){return this._maxDateMS-this._minDateMS}showTooltip(e){var t,s;if(this._isDragging||this.disabled)return;const r=e.currentTarget,o=r.x.baseVal.value+this.sliderWidth/2,a=r.dataset,l=`${this.tooltipLabel}${a.numItems!=="1"?"s":""}`,n=Number(a.numItems).toLocaleString(),c=2,h=9+this.tooltipHeight,f=this.getBoundingClientRect(),g=f.x+o,y=f.y;this._tooltipOffsetX=g-c+(this._binWidth-this.sliderWidth-this.tooltipWidth)/2+window.scrollX,this._tooltipOffsetY=y-h+window.scrollY,this._tooltipContent=St`
    ...
    `,(s=(t=this._tooltip).showPopover)===null||s===void 0||s.call(t)}hideTooltip(){var e,t;this._tooltipContent=void 0,(t=(e=this._tooltip).hidePopover)===null||t===void 0||t.call(e)}validMinSliderX(e){const t=Math.min(this.translateDateToPosition(this.maxSelectedDate),this.histogramRightEdgeX);return e=this.clamp(e,this.histogramLeftEdgeX,t),Number.isNaN(e)||t<this.histogramLeftEdgeX?this.histogramLeftEdgeX:e}validMaxSliderX(e){const t=Math.max(this.histogramLeftEdgeX,this.translateDateToPosition(this.minSelectedDate));return e=this.clamp(e,t,this.histogramRightEdgeX),Number.isNaN(e)||t>this.histogramRightEdgeX?this.histogramRightEdgeX:e}addListeners(){window.addEventListener("pointermove",this.move),window.addEventListener("pointerup",this.drop),window.addEventListener("pointercancel",this.drop)}removeListeners(){window.removeEventListener("pointermove",this.move),window.removeEventListener("pointerup",this.drop),window.removeEventListener("pointercancel",this.drop)}beginEmitUpdateProcess(){this.cancelPendingUpdateEvent(),this._emitUpdatedEventTimer=setTimeout(()=>{if(this.currentDateRangeString===this._previousDateRange)return;this._previousDateRange=this.currentDateRangeString;const e={detail:{minDate:this.minSelectedDate,maxDate:this.maxSelectedDate},bubbles:!0,composed:!0};this.dispatchEvent(new CustomEvent("histogramDateRangeUpdated",e))},this.updateDelay)}cancelPendingUpdateEvent(){this._emitUpdatedEventTimer!==void 0&&(clearTimeout(this._emitUpdatedEventTimer),this._emitUpdatedEventTimer=void 0)}setDragOffset(e){this._currentSlider=e.currentTarget;const t=this._currentSlider.id==="slider-min"?this.minSliderX:this.maxSliderX,s=this.getBoundingClientRect().x;this._dragOffset=e.clientX-s-t}translatePositionToDate(e){const t=this.snapToNextSecond((e-this.sliderWidth)*this.dateRangeMS/this._histWidth);return this.formatDate(this._minDateMS+t)}translateDateToPosition(e){const t=this.getMSFromString(e);return this.sliderWidth+(t-this._minDateMS)*this._histWidth/this.dateRangeMS}clamp(e,t,s){return Math.min(Math.max(e,t),s)}handleInputFocus(){this.updateWhileFocused||this.cancelPendingUpdateEvent()}handleMinDateInput(e){const t=e.currentTarget;t.value!==this.minSelectedDate&&(this.minSelectedDate=t.value,this.beginEmitUpdateProcess())}handleMaxDateInput(e){const t=e.currentTarget;t.value!==this.maxSelectedDate&&(this.maxSelectedDate=t.value,this.beginEmitUpdateProcess())}handleKeyUp(e){if(e.key==="Enter"){const t=e.currentTarget;t.blur(),t.id==="date-min"?this.handleMinDateInput(e):t.id==="date-max"&&this.handleMaxDateInput(e)}}get currentDateRangeString(){return`${this.minSelectedDate}:${this.maxSelectedDate}`}getMSFromString(e){const t=typeof e=="string"?e:String(e);if((t.split(/(\d+)/).length-1)/2===1){const r=new Date(0,0);return r.setFullYear(Number(t)),r.getTime()}return ne(t,[this.dateFormat,dh]).valueOf()}handleBarClick(e){const t=e.currentTarget.dataset,s=(this.getMSFromString(t.binStart)+this.getMSFromString(t.binEnd))/2,r=Math.abs(s-this.getMSFromString(this.minSelectedDate)),o=Math.abs(s-this.getMSFromString(this.maxSelectedDate));r<o?this.minSelectedDate=t.binStart:this.maxSelectedDate=t.binEnd,this.beginEmitUpdateProcess()}get minSliderTemplate(){const e=hh,t=`
            ...
            q0,${e} ${e},${e}
            h${this.sliderWidth-e}
          `;return this.generateSliderSVG(this.minSliderX,"slider-min",t)}get maxSliderTemplate(){const e=hh,t=`
            M${this.maxSliderX},0
            h${this.sliderWidth-e}
            q${e},0 ${e},${e}
            v${this.height-e*2}
            q0,${e} -${e},${e}
            h-${this.sliderWidth-e}
          `;return this.generateSliderSVG(this.maxSliderX,"slider-max",t)}generateSliderSVG(e,t,s){const r=t==="slider-min"?1:-1,o=ng({slider:!0,draggable:!this.disabled,dragging:this._isDragging});return un`
    <svg
      id=${t}
      class=${o}
    ...
    `}get selectedRangeTemplate(){return un`
      <rect
        ...
        height="${this.height}"
        fill="${wg}"
      />`}get histogramTemplate(){const e=this._histWidth/this._numBins,t=e-1;let s=this.sliderWidth;return this._histData.map(r=>{const{minSelectedDate:o,maxSelectedDate:a}=this,l=r.height,n=this.isBefore(r.binEnd,o),c=this.isAfter(r.binStart,a),d=n||c?Sg:$g,h=`stroke-dasharray: 0 ${t} ${l} ${t} 0 ${l}`,f=un`
        <rect
        ...
        <rect
          ...
          height=${l}
          fill=${d}
        />`;return s+=e,f})}isBefore(e,t){const s=this.getMSFromString(e),r=this.getMSFromString(t);return s<r}isAfter(e,t){const s=this.getMSFromString(e),r=this.getMSFromString(t);return s>r}formatDate(e,t=this.dateFormat){if(Number.isNaN(e))return"";const s=ne(e);return s.year()<1e3?s.year(199999).format(t).replace(/199999/g,s.year().toString()):s.format(t)}get minInputTemplate(){return St`
      <input
        id="date-min"
        ...
        .value=${ch(this.minSelectedDate)}
        ?disabled=${this.disabled}
      />
    `}get maxInputTemplate(){return St`
      <input
        id="date-max"
        placeholder=${this.dateFormat}
        type="text"
        ...
        @keyup=${this.handleKeyUp}
        .value=${ch(this.maxSelectedDate)}
        ?disabled=${this.disabled}
      />
    `}get minLabelTemplate(){return St`<label for="date-min" class="sr-only">Minimum date:</label>`}get maxLabelTemplate(){return St`<label for="date-max" class="sr-only">Maximum date:</label>`}get tooltipTemplate(){const e=cg({width:`${this.tooltipWidth}px`,height:`${this.tooltipHeight}px`,top:`${this._tooltipOffsetY}px`,left:`${this._tooltipOffsetX}px`});return St`
      <div id="tooltip" style=${e} popover>${this._tooltipContent}</div>
    `}get histogramAccessibilityTemplate(){let e="";this.minSelectedDate&&this.maxSelectedDate?e=` from ${this.minSelectedDate} to ${this.maxSelectedDate}`:this.minSelectedDate?e=` from ${this.minSelectedDate}`:this.maxSelectedDate&&(e=` up to ${this.maxSelectedDate}`);const t=`Filter results for dates${e}`,s=`This histogram shows the distribution of dates${e}`;return St`<title id="histogram-title">${t}</title
      ><desc id="histogram-desc">${s}</desc>`}get noDataTemplate(){return St`
      <div class="missing-data-message">${this.missingDataMessage}</div>
    `}get activityIndicatorTemplate(){return this.loading?St`
      <ia-activity-indicator mode="processing"> </ia-activity-indicator>
    `:$e}render(){return this.hasBinData?St`
      <div
        id="container"
        class="
          noselect
    ...
    `:this.noDataTemplate}};Y.styles=x`
    ...
    ia-activity-indicator {
      ...
      --activityIndicatorLoadingRingColor: ${xg};
    }
    ...
    #tooltip:after {
      ...
      /* arrow */
      border: 5px solid ${uh};
      border-color: ${ph} transparent transparent
        transparent;
    }
    /****** slider ********/
    .slider {
  ...
  `;p([E({type:Number})],Y.prototype,"width",void 0);p([E({type:Number})],Y.prototype,"height",void 0);p([E({type:Number})],Y.prototype,"sliderWidth",void 0);p([E({type:Number})],Y.prototype,"tooltipWidth",void 0);p([E({type:Number})],Y.prototype,"tooltipHeight",void 0);p([E({type:Number})],Y.prototype,"updateDelay",void 0);p([E({type:String})],Y.prototype,"dateFormat",void 0);p([E({type:String})],Y.prototype,"missingDataMessage",void 0);p([E({type:String})],Y.prototype,"minDate",void 0);p([E({type:String})],Y.prototype,"maxDate",void 0);p([E({type:Boolean})],Y.prototype,"disabled",void 0);p([E({type:Array})],Y.prototype,"bins",void 0);p([E({type:Boolean})],Y.prototype,"updateWhileFocused",void 0);p([E({type:String})],Y.prototype,"binSnapping",void 0);p([E({type:String})],Y.prototype,"tooltipLabel",void 0);p([E({type:String})],Y.prototype,"barScaling",void 0);p([xe()],Y.prototype,"_tooltipOffsetX",void 0);p([xe()],Y.prototype,"_tooltipOffsetY",void 0);p([xe()],Y.prototype,"_tooltipContent",void 0);p([xe()],Y.prototype,"_tooltipDateFormat",void 0);p([xe()],Y.prototype,"_isDragging",void 0);p([xe()],Y.prototype,"_isLoading",void 0);p([Ye("#tooltip")],Y.prototype,"_tooltip",void 0);p([E({type:String})],Y.prototype,"tooltipDateFormat",null);p([E({type:Boolean})],Y.prototype,"loading",null);p([E()],Y.prototype,"minSelectedDate",null);p([E()],Y.prototype,"maxSelectedDate",null);Y=p([At("histogram-date-range")],Y);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var gn;const qo=window,Es=qo.trustedTypes,fh=Es?Es.createPolicy("lit-html",{createHTML:i=>i}):void 0,cl="$lit$",Zt=`lit$${(Math.random()+"").slice(9)}$`,$p="?"+Zt,Pg=`<${$p}>`,ji=document,zr=()=>ji.createComment(""),Ir=i=>i===null||typeof i!="object"&&typeof i!="function",xp=Array.isArray,Og=i=>xp(i)||typeof(i==null?void 0:i[Symbol.iterator])=="function",vn=`[ 	
\f\r]`,lr=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,mh=/-->/g,gh=/>/g,vi=RegExp(`>|${vn}(?:([^\\s"'>=/]+)(${vn}*=${vn}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),vh=/'/g,bh=/"/g,Sp=/^(?:script|style|textarea|title)$/i,_p=i=>(e,...t)=>({_$litType$:i,strings:e,values:t}),ee=_p(1),Cp=_p(2),ri=Symbol.for("lit-noChange"),Z=Symbol.for("lit-nothing"),yh=new WeakMap,Mi=ji.createTreeWalker(ji,129,null,!1);function Tp(i,e){if(!Array.isArray(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return fh!==void 0?fh.createHTML(e):e}const Dg=(i,e)=>{const t=i.length-1,s=[];let r,o=e===2?"<svg>":"",a=lr;for(let l=0;l<t;l++){const n=i[l];let c,d,h=-1,f=0;for(;f<n.length&&(a.lastIndex=f,d=a.exec(n),d!==null);)f=a.lastIndex,a===lr?d[1]==="!--"?a=mh:d[1]!==void 0?a=gh:d[2]!==void 0?(Sp.test(d[2])&&(r=RegExp("</"+d[2],"g")),a=vi):d[3]!==void 0&&(a=vi):a===vi?d[0]===">"?(a=r??lr,h=-1):d[1]===void 0?h=-2:(h=a.lastIndex-d[2].length,c=d[1],a=d[3]===void 0?vi:d[3]==='"'?bh:vh):a===bh||a===vh?a=vi:a===mh||a===gh?a=lr:(a=vi,r=void 0);const g=a===vi&&i[l+1].startsWith("/>")?" ":"";o+=a===lr?n+Pg:h>=0?(s.push(c),n.slice(0,h)+cl+n.slice(h)+Zt+g):n+Zt+(h===-2?(s.push(void 0),l):g)}return[Tp(i,o+(i[t]||"<?>")+(e===2?"</svg>":"")),s]};let dl=class Ap{constructor({strings:e,_$litType$:t},s){let r;this.parts=[];let o=0,a=0;const l=e.length-1,n=this.parts,[c,d]=Dg(e,t);if(this.el=Ap.createElement(c,s),Mi.currentNode=this.el.content,t===2){const h=this.el.content,f=h.firstChild;f.remove(),h.append(...f.childNodes)}for(;(r=Mi.nextNode())!==null&&n.length<l;){if(r.nodeType===1){if(r.hasAttributes()){const h=[];for(const f of r.getAttributeNames())if(f.endsWith(cl)||f.startsWith(Zt)){const g=d[a++];if(h.push(f),g!==void 0){const y=r.getAttribute(g.toLowerCase()+cl).split(Zt),$=/([.?@])?(.*)/.exec(g);n.push({type:1,index:o,name:$[2],strings:y,ctor:$[1]==="."?Bg:$[1]==="?"?Rg:$[1]==="@"?zg:da})}else n.push({type:6,index:o})}for(const f of h)r.removeAttribute(f)}if(Sp.test(r.tagName)){const h=r.textContent.split(Zt),f=h.length-1;if(f>0){r.textContent=Es?Es.emptyScript:"";for(let g=0;g<f;g++)r.append(h[g],zr()),Mi.nextNode(),n.push({type:2,index:++o});r.append(h[f],zr())}}}else if(r.nodeType===8)if(r.data===$p)n.push({type:2,index:o});else{let h=-1;for(;(h=r.data.indexOf(Zt,h+1))!==-1;)n.push({type:7,index:o}),h+=Zt.length-1}o++}}static createElement(e,t){const s=ji.createElement("template");return s.innerHTML=e,s}};function Ms(i,e,t=i,s){var r,o,a,l;if(e===ri)return e;let n=s!==void 0?(r=t._$Co)===null||r===void 0?void 0:r[s]:t._$Cl;const c=Ir(e)?void 0:e._$litDirective$;return(n==null?void 0:n.constructor)!==c&&((o=n==null?void 0:n._$AO)===null||o===void 0||o.call(n,!1),c===void 0?n=void 0:(n=new c(i),n._$AT(i,t,s)),s!==void 0?((a=(l=t)._$Co)!==null&&a!==void 0?a:l._$Co=[])[s]=n:t._$Cl=n),n!==void 0&&(e=Ms(i,n._$AS(i,e.values),n,s)),e}let Lg=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){var t;const{el:{content:s},parts:r}=this._$AD,o=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:ji).importNode(s,!0);Mi.currentNode=o;let a=Mi.nextNode(),l=0,n=0,c=r[0];for(;c!==void 0;){if(l===c.index){let d;c.type===2?d=new Ql(a,a.nextSibling,this,e):c.type===1?d=new c.ctor(a,c.name,c.strings,this,e):c.type===6&&(d=new Ig(a,this,e)),this._$AV.push(d),c=r[++n]}l!==(c==null?void 0:c.index)&&(a=Mi.nextNode(),l++)}return Mi.currentNode=ji,o}v(e){let t=0;for(const s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(e,s,t),t+=s.strings.length-2):s._$AI(e[t])),t++}},Ql=class kp{constructor(e,t,s,r){var o;this.type=2,this._$AH=Z,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=s,this.options=r,this._$Cp=(o=r==null?void 0:r.isConnected)===null||o===void 0||o}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cp}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Ms(this,e,t),Ir(e)?e===Z||e==null||e===""?(this._$AH!==Z&&this._$AR(),this._$AH=Z):e!==this._$AH&&e!==ri&&this._(e):e._$litType$!==void 0?this.g(e):e.nodeType!==void 0?this.$(e):Og(e)?this.T(e):this._(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==Z&&Ir(this._$AH)?this._$AA.nextSibling.data=e:this.$(ji.createTextNode(e)),this._$AH=e}g(e){var t;const{values:s,_$litType$:r}=e,o=typeof r=="number"?this._$AC(e):(r.el===void 0&&(r.el=dl.createElement(Tp(r.h,r.h[0]),this.options)),r);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===o)this._$AH.v(s);else{const a=new Lg(o,this),l=a.u(this.options);a.v(s),this.$(l),this._$AH=a}}_$AC(e){let t=yh.get(e.strings);return t===void 0&&yh.set(e.strings,t=new dl(e)),t}T(e){xp(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let s,r=0;for(const o of e)r===t.length?t.push(s=new kp(this.k(zr()),this.k(zr()),this,this.options)):s=t[r],s._$AI(o),r++;r<t.length&&(this._$AR(s&&s._$AB.nextSibling,r),t.length=r)}_$AR(e=this._$AA.nextSibling,t){var s;for((s=this._$AP)===null||s===void 0||s.call(this,!1,!0,t);e&&e!==this._$AB;){const r=e.nextSibling;e.remove(),e=r}}setConnected(e){var t;this._$AM===void 0&&(this._$Cp=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}},da=class{constructor(e,t,s,r,o){this.type=1,this._$AH=Z,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=o,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=Z}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,s,r){const o=this.strings;let a=!1;if(o===void 0)e=Ms(this,e,t,0),a=!Ir(e)||e!==this._$AH&&e!==ri,a&&(this._$AH=e);else{const l=e;let n,c;for(e=o[0],n=0;n<o.length-1;n++)c=Ms(this,l[s+n],t,n),c===ri&&(c=this._$AH[n]),a||(a=!Ir(c)||c!==this._$AH[n]),c===Z?e=Z:e!==Z&&(e+=(c??"")+o[n+1]),this._$AH[n]=c}a&&!r&&this.j(e)}j(e){e===Z?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},Bg=class extends da{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===Z?void 0:e}};const Fg=Es?Es.emptyScript:"";let Rg=class extends da{constructor(){super(...arguments),this.type=4}j(e){e&&e!==Z?this.element.setAttribute(this.name,Fg):this.element.removeAttribute(this.name)}},zg=class extends da{constructor(e,t,s,r,o){super(e,t,s,r,o),this.type=5}_$AI(e,t=this){var s;if((e=(s=Ms(this,e,t,0))!==null&&s!==void 0?s:Z)===ri)return;const r=this._$AH,o=e===Z&&r!==Z||e.capture!==r.capture||e.once!==r.once||e.passive!==r.passive,a=e!==Z&&(r===Z||o);o&&this.element.removeEventListener(this.name,this,r),a&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,s;typeof this._$AH=="function"?this._$AH.call((s=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&s!==void 0?s:this.element,e):this._$AH.handleEvent(e)}},Ig=class{constructor(e,t,s){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(e){Ms(this,e)}};const wh=qo.litHtmlPolyfillSupport;wh==null||wh(dl,Ql),((gn=qo.litHtmlVersions)!==null&&gn!==void 0?gn:qo.litHtmlVersions=[]).push("2.8.0");const Ng=(i,e,t)=>{var s,r;const o=(s=t==null?void 0:t.renderBefore)!==null&&s!==void 0?s:e;let a=o._$litPart$;if(a===void 0){const l=(r=t==null?void 0:t.renderBefore)!==null&&r!==void 0?r:null;o._$litPart$=a=new Ql(e.insertBefore(zr(),l),l,void 0,t??{})}return a._$AI(i),a};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var bn,yn;let pt=class extends ht{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e,t;const s=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=s.firstChild),s}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Ng(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!1)}render(){return ri}};pt.finalized=!0,pt._$litElement$=!0,(bn=globalThis.litElementHydrateSupport)===null||bn===void 0||bn.call(globalThis,{LitElement:pt});const $h=globalThis.litElementPolyfillSupport;$h==null||$h({LitElement:pt});((yn=globalThis.litElementVersions)!==null&&yn!==void 0?yn:globalThis.litElementVersions=[]).push("3.3.3");const Sr=Cp`
<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><path d="m51.5960452 0c5.420012 0 6.7920618 2.72313378 8.1300179 9.28391016 2.9793915 19.21608984-2.9793915 28.94849474 0 31.58229234 1.2215505 1.079857 1.8678662.7924226 3.2997314.0773518l.2153069-.1075882c2.1016905-1.0490161 5.8499713-2.8359661 14.9013153-2.8359661l2.3393989.00075c14.0694555.01425 14.2569231.29925 18.0062757 5.99925 0 3.2648986.9924719 9.5-3.9698878 9.5 4.9623597 0 7.9397755 15.5 0 15.5 7.9397755 0 6.9473035 15.5-.9924719 15.5 7.9397754 0 5.9548316 12 2.9774158 13-1.1342536.5714286-1.9876793 1.0011812-2.627102 1.3222794l-.3279542.1645673c-1.5889262.796641-1.5747062.7780161-1.4530457.6832252l.0244872-.0190992c.0041709-.0032756.0083532-.0065808.0124967-.0098908l.0239934-.0197196c.1060465-.0904428.1029348-.1457697-1.111471.3786377h-55.0821921c-3.3082398-3.0266004-4.9623597-5.0266004-4.9623597-6v-33.4737525c5.5882429-8.3508317 10.6469206-21.2754909 15.1760333-38.7739777v-17.92948326c0-2.54852436 1.8066707-3.82278654 5.4200119-3.82278654zm-27.5960452 56c2.209139 0 4 1.790861 4 4v36c0 2.209139-1.790861 4-4 4h-20c-2.209139 0-4-1.790861-4-4v-36c0-2.209139 1.790861-4 4-4z" fill-rule="evenodd"/></svg>`,_r=Cp`
<svg viewBox="0 0 100 100"
  xmlns="http://www.w3.org/2000/svg">
...
`;let he=class extends pt{constructor(){super(...arguments),this.prompt="Do you find this feature useful?",this.buttonText="Beta",this.displayMode="button",this.isOpen=!1,this.processing=!1,this.popupTopX=0,this.popupTopY=0,this.voteSubmitted=!1,this.voteNeedsChoosing=!1,this.resizingElement=document.body}render(){return ee`
      ...
      >
        ...
        >
          ...
          >
            ...
            ${this.error?ee`<div id="error">${this.error}</div>`:Z}
            <div id="actions">
              <button
                @click=${this.cancel}
                id="cancel-button"
    ...
    `}get upvoteSelected(){return this.vote==="up"}get downvoteSelected(){return this.vote==="down"}upvoteKeypressed(e){(e.key==="Enter"||e.key===" ")&&this.upvoteButtonSelected()}downvoteKeypressed(e){(e.key==="Enter"||e.key===" ")&&this.downvoteButtonSelected()}upvoteButtonSelected(){this.processing||this.voteSubmitted||(this.vote=this.vote==="up"?void 0:"up",this.handleButtonSelection())}downvoteButtonSelected(){this.processing||this.voteSubmitted||(this.vote=this.vote==="down"?void 0:"down",this.handleButtonSelection())}async handleButtonSelection(){this.isOpen||(await this.setupRecaptcha(),this.submit())}get chooseVoteErrorClass(){return this.voteNeedsChoosing?"error":""}get upvoteButtonClass(){switch(this.vote){case"up":return"selected";case"down":return"unselected";default:return"noselection"}}get downvoteButtonClass(){switch(this.vote){case"up":return"unselected";case"down":return"selected";default:return"noselection"}}backgroundClicked(e){var t;e.target instanceof Node&&(!((t=this.popup)===null||t===void 0)&&t.contains(e.target)||this.cancel(e))}cancel(e){e.preventDefault(),this.closePopup(),this.voteSubmitted||this.resetState()}async submit(e){if(e==null||e.preventDefault(),!this.vote){this.voteNeedsChoosing=!0,this.error=ee`Please select a vote.`;return}if(!this.featureIdentifier)throw new Error("featureIdentifier is required");if(!this.featureFeedbackService)throw new Error("featureFeedbackService is required");if(!this.recaptchaWidget)throw new Error("recaptchaWidget is required");const t=this.isOpen;this.processing=!0;try{const s=await this.recaptchaWidget.execute();(await this.featureFeedbackService.submitFeedback({featureIdentifier:this.featureIdentifier,vote:this.vote,comments:this.comments.value,recaptchaToken:s})).success?(this.voteSubmitted=!0,t&&this.closePopup()):this.error=ee`There was an error submitting your feedback.`}catch(s){this.error=ee`There was an error submitting your feedback.<br />Error:
        ${s instanceof Error?s.message:s}`}this.processing=!1}static get styles(){const e=x`var(--featureFeedbackBlueColor, #194880)`,t=x`var(--featureFeedbackDarkGrayColor, #767676)`,s=x`var(--defaultColorSvgFilter, invert(52%) sepia(0%) saturate(1%) hue-rotate(331deg) brightness(87%) contrast(89%))`,r=x`var(--featureFeedbackBackdropZindex, 5)`,o=x`var(--featureFeedbackModalZindex, 6)`,a=x`var(--featureFeedbackPopupBorderColor, ${e})`,l=x`var(--featureFeedbackSubmitButtonColor, ${e})`,n=x`var(--featureFeedbackBetaButtonBorderColor, ${e})`,c=x`var(--featureFeedbackBetaButtonTextColor, ${e})`,d=x`var(--featureFeedbackBetaButtonSvgFilter, ${s})`,h=x`var(--featureFeedbackCancelButtonColor, #515151)`,f=x`var(--featureFeedbackPopupBlockerColor, rgba(255, 255, 255, 0.3))`,g=x`var(--featureFeedbackPopupBackgroundColor, #F5F5F7)`,y=x`var(--featureFeedbackPromptFontWeight, bold)`,$=x`var(--featureFeedbackPromptFontSize, 1.4rem)`,A=x`var(--featureFeedbackCommentButtonFontWeight, normal)`,O=x`var(--featureFeedbackCommentButtonFontWeight, 1.4rem)`,P=x`var(--defaultColor, ${t});`,D=x`var(--defaultColorSvgFilter, ${s});`,z=x`var(--upvoteColor, #23765D);`,K=x`var(--upvoteColorSvgFilter, invert(34%) sepia(72%) saturate(357%) hue-rotate(111deg) brightness(97%) contrast(95%));`,be=x`var(--downvoteColor, #720D11);`,Be=x`var(--downvoteColorSvgFilter, invert(5%) sepia(81%) saturate(5874%) hue-rotate(352deg) brightness(105%) contrast(95%));`,We=x`var(--unselectedColor, #CCCCCC);`,ot=x`var(--unselectedColorSvgFilter, invert(100%) sepia(0%) saturate(107%) hue-rotate(138deg) brightness(89%) contrast(77%));`;return x`
      #container {
        display: inline-block;
      }
    ...
    `}};p([E({type:String})],he.prototype,"featureIdentifier",void 0);p([E({type:String})],he.prototype,"prompt",void 0);p([E({type:String})],he.prototype,"buttonText",void 0);p([E({type:String})],he.prototype,"displayMode",void 0);p([E({type:Object})],he.prototype,"recaptchaManager",void 0);p([E({type:Object})],he.prototype,"resizeObserver",void 0);p([E({type:Boolean})],he.prototype,"disabled",void 0);p([E({type:Object})],he.prototype,"featureFeedbackService",void 0);p([xe()],he.prototype,"isOpen",void 0);p([xe()],he.prototype,"processing",void 0);p([xe()],he.prototype,"popupTopX",void 0);p([xe()],he.prototype,"popupTopY",void 0);p([xe()],he.prototype,"vote",void 0);p([xe()],he.prototype,"voteSubmitted",void 0);p([xe()],he.prototype,"error",void 0);p([xe()],he.prototype,"voteNeedsChoosing",void 0);p([xe()],he.prototype,"recaptchaWidget",void 0);p([Ye("#container")],he.prototype,"container",void 0);p([Ye("#popup")],he.prototype,"popup",void 0);p([Ye("#comments")],he.prototype,"comments",void 0);he=p([At("feature-feedback")],he);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ep={ATTRIBUTE:1},Mp=i=>(...e)=>({_$litDirective$:i,values:e});let Pp=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,s){this._$Ct=e,this._$AM=t,this._$Ci=s}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}};/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Op="important",Hg=" !"+Op,Ug=Mp(class extends Pp{constructor(i){var e;if(super(i),i.type!==Ep.ATTRIBUTE||i.name!=="style"||((e=i.strings)===null||e===void 0?void 0:e.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(i){return Object.keys(i).reduce((e,t)=>{const s=i[t];return s==null?e:e+`${t=t.includes("-")?t:t.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${s};`},"")}update(i,[e]){const{style:t}=i.element;if(this.ht===void 0){this.ht=new Set;for(const s in e)this.ht.add(s);return this.render(e)}this.ht.forEach(s=>{e[s]==null&&(this.ht.delete(s),s.includes("-")?t.removeProperty(s):t[s]="")});for(const s in e){const r=e[s];if(r!=null){this.ht.add(s);const o=typeof r=="string"&&r.endsWith(Hg);s.includes("-")||o?t.setProperty(s,o?r.slice(0,-11):r,o?Op:""):t[s]=r}}return ri}});/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Vg=i=>typeof i!="string"&&"strTag"in i,jg=(i,e,t)=>{let s=i[0];for(let r=1;r<i.length;r++)s+=e[r-1],s+=i[r];return s};/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Wg=i=>Vg(i)?jg(i.strings,i.values):i;/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class qg{constructor(){this.settled=!1,this.promise=new Promise((e,t)=>{this._resolve=e,this._reject=t})}resolve(e){this.settled=!0,this._resolve(e)}reject(e){this.settled=!0,this._reject(e)}}/**
 * @license
 * Copyright 2014 Travis Webb
 * SPDX-License-Identifier: MIT
 */for(let i=0;i<256;i++)(i>>4&15).toString(16)+(i&15).toString(16);/**
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var wn;const Go=window,Ps=Go.trustedTypes,xh=Ps?Ps.createPolicy("lit-html",{createHTML:i=>i}):void 0,hl="$lit$",Jt=`lit$${(Math.random()+"").slice(9)}$`,Dp="?"+Jt,Yg=`<${Dp}>`,Wi=document,Nr=()=>Wi.createComment(""),Hr=i=>i===null||typeof i!="object"&&typeof i!="function",Lp=Array.isArray,Qg=i=>Lp(i)||typeof(i==null?void 0:i[Symbol.iterator])=="function",$n=`[ 	
\f\r]`,cr=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Sh=/-->/g,_h=/>/g,bi=RegExp(`>|${$n}(?:([^\\s"'>=/]+)(${$n}*=${$n}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Ch=/'/g,Th=/"/g,Bp=/^(?:script|style|textarea|title)$/i,Os=Symbol.for("lit-noChange"),Ee=Symbol.for("lit-nothing"),Ah=new WeakMap,Pi=Wi.createTreeWalker(Wi,129,null,!1);function Fp(i,e){if(!Array.isArray(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return xh!==void 0?xh.createHTML(e):e}const Kg=(i,e)=>{const t=i.length-1,s=[];let r,o=e===2?"<svg>":"",a=cr;for(let l=0;l<t;l++){const n=i[l];let c,d,h=-1,f=0;for(;f<n.length&&(a.lastIndex=f,d=a.exec(n),d!==null);)f=a.lastIndex,a===cr?d[1]==="!--"?a=Sh:d[1]!==void 0?a=_h:d[2]!==void 0?(Bp.test(d[2])&&(r=RegExp("</"+d[2],"g")),a=bi):d[3]!==void 0&&(a=bi):a===bi?d[0]===">"?(a=r??cr,h=-1):d[1]===void 0?h=-2:(h=a.lastIndex-d[2].length,c=d[1],a=d[3]===void 0?bi:d[3]==='"'?Th:Ch):a===Th||a===Ch?a=bi:a===Sh||a===_h?a=cr:(a=bi,r=void 0);const g=a===bi&&i[l+1].startsWith("/>")?" ":"";o+=a===cr?n+Yg:h>=0?(s.push(c),n.slice(0,h)+hl+n.slice(h)+Jt+g):n+Jt+(h===-2?(s.push(void 0),l):g)}return[Fp(i,o+(i[t]||"<?>")+(e===2?"</svg>":"")),s]};class Ur{constructor({strings:e,_$litType$:t},s){let r;this.parts=[];let o=0,a=0;const l=e.length-1,n=this.parts,[c,d]=Kg(e,t);if(this.el=Ur.createElement(c,s),Pi.currentNode=this.el.content,t===2){const h=this.el.content,f=h.firstChild;f.remove(),h.append(...f.childNodes)}for(;(r=Pi.nextNode())!==null&&n.length<l;){if(r.nodeType===1){if(r.hasAttributes()){const h=[];for(const f of r.getAttributeNames())if(f.endsWith(hl)||f.startsWith(Jt)){const g=d[a++];if(h.push(f),g!==void 0){const y=r.getAttribute(g.toLowerCase()+hl).split(Jt),$=/([.?@])?(.*)/.exec(g);n.push({type:1,index:o,name:$[2],strings:y,ctor:$[1]==="."?Zg:$[1]==="?"?e4:$[1]==="@"?t4:ha})}else n.push({type:6,index:o})}for(const f of h)r.removeAttribute(f)}if(Bp.test(r.tagName)){const h=r.textContent.split(Jt),f=h.length-1;if(f>0){r.textContent=Ps?Ps.emptyScript:"";for(let g=0;g<f;g++)r.append(h[g],Nr()),Pi.nextNode(),n.push({type:2,index:++o});r.append(h[f],Nr())}}}else if(r.nodeType===8)if(r.data===Dp)n.push({type:2,index:o});else{let h=-1;for(;(h=r.data.indexOf(Jt,h+1))!==-1;)n.push({type:7,index:o}),h+=Jt.length-1}o++}}static createElement(e,t){const s=Wi.createElement("template");return s.innerHTML=e,s}}function Ds(i,e,t=i,s){var r,o,a,l;if(e===Os)return e;let n=s!==void 0?(r=t._$Co)===null||r===void 0?void 0:r[s]:t._$Cl;const c=Hr(e)?void 0:e._$litDirective$;return(n==null?void 0:n.constructor)!==c&&((o=n==null?void 0:n._$AO)===null||o===void 0||o.call(n,!1),c===void 0?n=void 0:(n=new c(i),n._$AT(i,t,s)),s!==void 0?((a=(l=t)._$Co)!==null&&a!==void 0?a:l._$Co=[])[s]=n:t._$Cl=n),n!==void 0&&(e=Ds(i,n._$AS(i,e.values),n,s)),e}class Xg{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){var t;const{el:{content:s},parts:r}=this._$AD,o=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:Wi).importNode(s,!0);Pi.currentNode=o;let a=Pi.nextNode(),l=0,n=0,c=r[0];for(;c!==void 0;){if(l===c.index){let d;c.type===2?d=new Yr(a,a.nextSibling,this,e):c.type===1?d=new c.ctor(a,c.name,c.strings,this,e):c.type===6&&(d=new i4(a,this,e)),this._$AV.push(d),c=r[++n]}l!==(c==null?void 0:c.index)&&(a=Pi.nextNode(),l++)}return Pi.currentNode=Wi,o}v(e){let t=0;for(const s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(e,s,t),t+=s.strings.length-2):s._$AI(e[t])),t++}}class Yr{constructor(e,t,s,r){var o;this.type=2,this._$AH=Ee,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=s,this.options=r,this._$Cp=(o=r==null?void 0:r.isConnected)===null||o===void 0||o}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cp}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Ds(this,e,t),Hr(e)?e===Ee||e==null||e===""?(this._$AH!==Ee&&this._$AR(),this._$AH=Ee):e!==this._$AH&&e!==Os&&this._(e):e._$litType$!==void 0?this.g(e):e.nodeType!==void 0?this.$(e):Qg(e)?this.T(e):this._(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==Ee&&Hr(this._$AH)?this._$AA.nextSibling.data=e:this.$(Wi.createTextNode(e)),this._$AH=e}g(e){var t;const{values:s,_$litType$:r}=e,o=typeof r=="number"?this._$AC(e):(r.el===void 0&&(r.el=Ur.createElement(Fp(r.h,r.h[0]),this.options)),r);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===o)this._$AH.v(s);else{const a=new Xg(o,this),l=a.u(this.options);a.v(s),this.$(l),this._$AH=a}}_$AC(e){let t=Ah.get(e.strings);return t===void 0&&Ah.set(e.strings,t=new Ur(e)),t}T(e){Lp(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let s,r=0;for(const o of e)r===t.length?t.push(s=new Yr(this.k(Nr()),this.k(Nr()),this,this.options)):s=t[r],s._$AI(o),r++;r<t.length&&(this._$AR(s&&s._$AB.nextSibling,r),t.length=r)}_$AR(e=this._$AA.nextSibling,t){var s;for((s=this._$AP)===null||s===void 0||s.call(this,!1,!0,t);e&&e!==this._$AB;){const r=e.nextSibling;e.remove(),e=r}}setConnected(e){var t;this._$AM===void 0&&(this._$Cp=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}}class ha{constructor(e,t,s,r,o){this.type=1,this._$AH=Ee,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=o,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=Ee}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,s,r){const o=this.strings;let a=!1;if(o===void 0)e=Ds(this,e,t,0),a=!Hr(e)||e!==this._$AH&&e!==Os,a&&(this._$AH=e);else{const l=e;let n,c;for(e=o[0],n=0;n<o.length-1;n++)c=Ds(this,l[s+n],t,n),c===Os&&(c=this._$AH[n]),a||(a=!Hr(c)||c!==this._$AH[n]),c===Ee?e=Ee:e!==Ee&&(e+=(c??"")+o[n+1]),this._$AH[n]=c}a&&!r&&this.j(e)}j(e){e===Ee?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class Zg extends ha{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===Ee?void 0:e}}const Jg=Ps?Ps.emptyScript:"";class e4 extends ha{constructor(){super(...arguments),this.type=4}j(e){e&&e!==Ee?this.element.setAttribute(this.name,Jg):this.element.removeAttribute(this.name)}}class t4 extends ha{constructor(e,t,s,r,o){super(e,t,s,r,o),this.type=5}_$AI(e,t=this){var s;if((e=(s=Ds(this,e,t,0))!==null&&s!==void 0?s:Ee)===Os)return;const r=this._$AH,o=e===Ee&&r!==Ee||e.capture!==r.capture||e.once!==r.once||e.passive!==r.passive,a=e!==Ee&&(r===Ee||o);o&&this.element.removeEventListener(this.name,this,r),a&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,s;typeof this._$AH=="function"?this._$AH.call((s=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&s!==void 0?s:this.element,e):this._$AH.handleEvent(e)}}class i4{constructor(e,t,s){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(e){Ds(this,e)}}const kh=Go.litHtmlPolyfillSupport;kh==null||kh(Ur,Yr),((wn=Go.litHtmlVersions)!==null&&wn!==void 0?wn:Go.litHtmlVersions=[]).push("2.8.0");const s4=(i,e,t)=>{var s,r;const o=(s=t==null?void 0:t.renderBefore)!==null&&s!==void 0?s:e;let a=o._$litPart$;if(a===void 0){const l=(r=t==null?void 0:t.renderBefore)!==null&&r!==void 0?r:null;o._$litPart$=a=new Yr(e.insertBefore(Nr(),l),l,void 0,t??{})}return a._$AI(i),a};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var xn,Sn;class $o extends ht{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e,t;const s=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=s.firstChild),s}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=s4(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!1)}render(){return Os}}$o.finalized=!0,$o._$litElement$=!0,(xn=globalThis.litElementHydrateSupport)===null||xn===void 0||xn.call(globalThis,{LitElement:$o});const Eh=globalThis.litElementPolyfillSupport;Eh==null||Eh({LitElement:$o});((Sn=globalThis.litElementVersions)!==null&&Sn!==void 0?Sn:globalThis.litElementVersions=[]).push("3.3.3");const Mh=x`var(--white, #fff)`,r4=x`var(--ia-theme-link-color, #4b64ff)`,o4=x`var(--primaryDisableCTAFill, #767676)`,a4=x`var(--secondaryCTABorder, #999)`,n4=x`var(--primaryCTAFill, #194880)`,_n=x`var(--primaryCTAFillRGB, 25, 72, 128)`,l4=x`var(--primaryCTABorder, #c5d1df)`,c4=x`var(--primaryErrorCTAFill, #d9534f)`,Cn=x`var(--primaryErrorCTAFillRGB, 229, 28, 38)`,d4=x`var(--primaryErrorCTABorder, #d43f3a)`,h4=x`var(--secondaryCTAFill, #333)`,Tn=x`var(--secondaryCTAFillRGB, 51, 51, 51)`,p4=x`var(--primaryCTABorder, #979797)`,u4=x`var(---primaryWarningFill, #ee8950)`,An=x`var(--primaryWarningFillRGB, 238, 137, 80)`,f4=x`var(--primaryWarningBorder, #ec7939)`,m4=x`
  .ia-button {
    min-height: 3rem;
    cursor: pointer;
    color: ${Mh};
...
`;function Ph(i){return"disabled"in i&&typeof i.disabled=="boolean"}function g4(i){return"numbered"in i&&typeof i.numbered=="boolean"}function v4(i){return"validate"in i&&typeof i.validate=="function"}function b4(i){return"response"in i&&typeof i.response=="object"&&i.response!==null&&"name"in i.response&&typeof i.response.name=="string"}class y4 extends Error{}async function kn(i,e,t="Operation timed out"){const s=new Promise((r,o)=>setTimeout(o,e,new y4(t)));return Promise.race([i,s])}var xi;let se=xi=class extends pt{constructor(){super(...arguments),this.buttonText="Feedback",this.showButtonThumbs=!1,this.showQuestionNumbers=!1,this.disabled=!1,this.submitTimeout=8e3,this.isOpen=!1,this.submissionState="idle",this.popupTopX=0,this.popupTopY=0,this.resizingElement=document.body,this.handleScroll=()=>{this.isOpen&&this.positionPopup()},this.handleEscape=e=>{e.key==="Escape"&&this.cancel(e)}}render(){return ee`<div id="container">${this.feedbackButtonTemplate}</div>`}willUpdate(e){if(e.has("submissionState")&&(this.isProcessing||this.isSubmitted?this.disableSlottedChildren():this.restoreSlottedChildrenDisabledStates()),e.has("resizeObserver")){const t=e.get("resizeObserver");this.disconnectResizeObserver(t)}}updated(e){(e.has("showQuestionNumbers")||e.has("assignedElements"))&&this.applyQuestionNumbers();const t=e.get("submissionState");t&&(this.submissionState==="error"||t==="error")&&this.positionPopup(),e.has("isOpen")&&this.isOpen&&this.focusFirstFormElement()}disconnectedCallback(){this.removeEscapeListener(),this.stopScrollObserver(),this.disconnectResizeObserver(this.resizeObserver)}disableSlottedChildren(){this.assignedElements.filter(Ph).forEach(e=>{e.dataset.originallyDisabled=e.disabled?"true":"false",e.disabled=!0})}restoreSlottedChildrenDisabledStates(){this.assignedElements.filter(Ph).forEach(e=>{const{originallyDisabled:t}=e.dataset;if(t===void 0)return;const s=t==="true";delete e.dataset.originallyDisabled,e.disabled=s})}handleResize(){this.isOpen&&this.positionPopup()}setupEscapeListener(){document.addEventListener("keyup",this.handleEscape)}removeEscapeListener(){document.removeEventListener("keyup",this.handleEscape)}setupScrollObserver(){document.addEventListener("scroll",this.handleScroll)}stopScrollObserver(){document.removeEventListener("scroll",this.handleScroll)}setupResizeObserver(){this.resizeObserver&&this.resizeObserver.addObserver({handler:this,target:this.resizingElement})}disconnectResizeObserver(e){const t=e??this.resizeObserver;t==null||t.removeObserver({handler:this,target:this.resizingElement})}getRecaptchaWidget(){if(this.recaptchaWidgetPromise)return this.recaptchaWidgetPromise;if(this.recaptchaManager)return this.recaptchaWidgetPromise=this.recaptchaManager.getRecaptchaWidget(),this.recaptchaWidgetPromise}resetSubmissionState(){this.setSubmissionState("idle"),this.error=void 0}setSubmissionState(e){this.submissionState!==e&&(this.submissionState=e,this.emitSubmissionStateChanged())}emitSubmissionStateChanged(){this.dispatchEvent(new CustomEvent("submissionStateChanged",{detail:this.submissionState}))}get isProcessing(){return this.submissionState==="processing"}get isSubmitted(){return this.submissionState==="submitted"}showPopup(){this.isSubmitted||(this.setupResizeObserver(),this.setupScrollObserver(),this.setupEscapeListener(),this.positionPopup(),this.isOpen=!0,this.getRecaptchaWidget())}closePopup(){this.disconnectResizeObserver(),this.stopScrollObserver(),this.removeEscapeListener(),this.isOpen=!1}positionPopup(){const e=this.container.getBoundingClientRect(),t=this.popup.getBoundingClientRect(),s=window.innerWidth,r=window.innerHeight,o=s/2,a=r/2,l=5,n=5;e.left<o?this.popupTopX=e.right-20:this.popupTopX=e.left+20-t.width,this.popupTopX+t.width>s&&(this.popupTopX=s-t.width-l),e.top<a?this.popupTopY=e.bottom-10:this.popupTopY=e.top+10-t.height,this.popupTopY+t.height>r&&(this.popupTopY=r-t.height-n),this.popupTopX=Math.max(l,this.popupTopX),this.popupTopY=Math.max(n,this.popupTopY)}get feedbackButtonThumbsTemplate(){return this.showButtonThumbs?ee`
    ...
    `:Z}get feedbackButtonCheckTemplate(){return ee`<span class="beta-button-icon success">&check;</span>`}get feedbackButtonTemplate(){return ee`
      ...
      ${this.popupTemplate}
    `}get popupTemplate(){const e=this.isProcessing||this.isSubmitted,t=this.isProcessing?xi.SUBMIT_BUTTON_PROCESSING_TEXT:xi.SUBMIT_BUTTON_NORMAL_TEXT,s=this.error?ee`<div id="error">${this.error}</div>`:Z,r=Ug({left:`${this.popupTopX}px`,top:`${this.popupTopY}px`}),o=a=>a.stopPropagation();return ee`
      <div
        id="popup-background"
        class=${this.isOpen?"open":"closed"}
        @click=${this.backgroundClicked}
    ...
    `}focusFirstFormElement(){const e=this.getRootNode();for(const t of this.assignedElements)if(t.focus(),e.activeElement===t)return;this.focusCancelButton()}focusCancelButton(){this.cancelButton.focus()}focusSubmitButton(){this.submitButton.focus()}applyQuestionNumbers(){if(!this.showQuestionNumbers){this.assignedElements.forEach(t=>{var s;(s=t.querySelector("[slot=question-number]"))===null||s===void 0||s.remove()});return}let e=1;this.assignedElements.filter(t=>g4(t)&&t.numbered).forEach(t=>{let s=t.querySelector("[slot=question-number]");s||(s=document.createElement("span"),s.setAttribute("slot","question-number")),s.textContent=`${e}. `,t.append(s),e+=1})}backgroundClicked(e){var t;e.target instanceof Node&&(!((t=this.popup)===null||t===void 0)&&t.contains(e.target)||this.cancel(e))}cancel(e){e.preventDefault(),this.closePopup(),this.isSubmitted||this.resetSubmissionState()}validate(){return this.assignedElements.filter(v4).map(e=>e.validate()).every(e=>e)}async submit(e){if(e==null||e.preventDefault(),!this.validate()){this.error=ee`${xi.ERROR_MESSAGE_MISSING_REQUIRED_INPUT}`,this.setSubmissionState("error");return}const{surveyIdentifier:t,submitTimeout:s,featureFeedbackService:r}=this;if(this.error=void 0,!t)throw new Error("surveyIdentifier is required");if(!r)throw new Error("featureFeedbackService is required");const o=this.getRecaptchaWidget();let a;try{a=await kn(o,s)}catch(n){throw new Error(`recaptchaWidget load failed: ${n}`)}if(!a)throw new Error("recaptchaWidget is required");const l=this.isOpen;this.setSubmissionState("processing");try{const n=await kn(a.execute(),s);(await kn(r.submitSurvey({surveyIdentifier:t,responses:this.assignedElements.filter(b4).map(d=>d.response),recaptchaToken:n}),s)).success?(this.setSubmissionState("submitted"),l&&this.closePopup()):(this.error=ee`${xi.ERROR_MESSAGE_SUBMIT_REQUEST_FAILED}`,this.setSubmissionState("error"))}catch(n){this.error=ee`${xi.ERROR_MESSAGE_SUBMIT_REQUEST_FAILED}
        <br />
    ...
    `;return[m4,A]}};se.SUBMIT_BUTTON_NORMAL_TEXT=ut("Submit feedback");se.SUBMIT_BUTTON_PROCESSING_TEXT=ut("Submitting...");se.ERROR_MESSAGE_MISSING_REQUIRED_INPUT=ut("Please respond to the indicated questions.");se.ERROR_MESSAGE_SUBMIT_REQUEST_FAILED=ut("There was an error submitting your feedback.");p([E({type:String})],se.prototype,"surveyIdentifier",void 0);p([E({type:String})],se.prototype,"buttonText",void 0);p([E({type:Boolean})],se.prototype,"showButtonThumbs",void 0);p([E({type:Boolean})],se.prototype,"showQuestionNumbers",void 0);p([E({type:Boolean})],se.prototype,"disabled",void 0);p([E({type:Number})],se.prototype,"submitTimeout",void 0);p([E({type:Object})],se.prototype,"featureFeedbackService",void 0);p([E({type:Object})],se.prototype,"recaptchaManager",void 0);p([E({type:Object})],se.prototype,"resizeObserver",void 0);p([xe()],se.prototype,"isOpen",void 0);p([xe()],se.prototype,"submissionState",void 0);p([xe()],se.prototype,"popupTopX",void 0);p([xe()],se.prototype,"popupTopY",void 0);p([xe()],se.prototype,"error",void 0);p([Ye("#container")],se.prototype,"container",void 0);p([Ye("#popup")],se.prototype,"popup",void 0);p([Ye("#cancel-button")],se.prototype,"cancelButton",void 0);p([Ye("#submit-button")],se.prototype,"submitButton",void 0);p([h1()],se.prototype,"assignedElements",void 0);se=xi=p([At("ia-feedback-survey")],se);var xo;let Ke=xo=class extends pt{constructor(){super(),this.prompt="",this.value="",this.required=!1,this.disabled=!1,this.skipNumber=!1,this.visible=!0,this.internals=this.attachInternals()}render(){return ee`
      <div id="container">
        ${this.promptTextTemplate}${this.commentBoxTemplate}
      </div>
    `}willUpdate(e){e.has("required")&&(this.internals.ariaRequired=this.required.toString()),e.has("disabled")&&(this.internals.ariaDisabled=this.disabled.toString())}validate(){return!this.required||!!this.commentBox.value?this.internals.setValidity({}):this.internals.setValidity({valueMissing:!0},"A comment is required."),this.internals.reportValidity()}get numbered(){return!this.skipNumber}get response(){return{name:this.prompt,comment:this.value}}get promptTextTemplate(){if(!this.prompt)return Z;const e=this.numbered?ee`<slot name="question-number"></slot>`:Z;return ee`<div id="prompt-text">${e}${this.prompt}</div>`}get commentBoxTemplate(){var e;const t=this.required?xo.DEFAULT_PLACEHOLDER_REQUIRED:xo.DEFAULT_PLACEHOLDER_OPTIONAL,s=(e=this.placeholder)!==null&&e!==void 0?e:t;return ee`
      <textarea
        id="comments"
        tabindex="0"
        placeholder=${s}
    ...
    `}};Ke.DEFAULT_PLACEHOLDER_REQUIRED=ut("Comments");Ke.DEFAULT_PLACEHOLDER_OPTIONAL=ut("Comments (optional)");Ke.formAssociated=!0;Ke.shadowRootOptions={...pt.shadowRootOptions,delegatesFocus:!0};p([E({type:String})],Ke.prototype,"prompt",void 0);p([E({type:String})],Ke.prototype,"value",void 0);p([E({type:Boolean,reflect:!0})],Ke.prototype,"required",void 0);p([E({type:Boolean,reflect:!0})],Ke.prototype,"disabled",void 0);p([E({type:Boolean,reflect:!0})],Ke.prototype,"skipNumber",void 0);p([E({type:String})],Ke.prototype,"placeholder",void 0);p([Ye("#comments")],Ke.prototype,"commentBox",void 0);Ke=xo=p([At("ia-survey-comment")],Ke);/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Oh=Mp(class extends Pp{constructor(i){var e;if(super(i),i.type!==Ep.ATTRIBUTE||i.name!=="class"||((e=i.strings)===null||e===void 0?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(i){return" "+Object.keys(i).filter(e=>i[e]).join(" ")+" "}update(i,[e]){var t,s;if(this.it===void 0){this.it=new Set,i.strings!==void 0&&(this.nt=new Set(i.strings.join(" ").split(/\s/).filter(o=>o!=="")));for(const o in e)e[o]&&!(!((t=this.nt)===null||t===void 0)&&t.has(o))&&this.it.add(o);return this.render(e)}const r=i.element.classList;this.it.forEach(o=>{o in e||(r.remove(o),this.it.delete(o))});for(const o in e){const a=!!e[o];a===this.it.has(o)||!((s=this.nt)===null||s===void 0)&&s.has(o)||(a?(r.add(o),this.it.add(o)):(r.remove(o),this.it.delete(o)))}return ri}});var So;let Ve=So=class extends pt{constructor(){super(),this.prompt="",this.vote=void 0,this.required=!1,this.disabled=!1,this.skipNumber=!1,this.showComments=!1,this.visible=!0,this.internals=this.attachInternals()}render(){return ee`
      <div id="container">
        <div
          id="prompt-row"
          role="radiogroup"
    ...
    `}willUpdate(e){e.has("required")&&(this.internals.ariaRequired=this.required.toString()),e.has("disabled")&&(this.internals.ariaDisabled=this.disabled.toString())}validate(){return!this.required||this.vote?this.internals.setValidity({}):this.internals.setValidity({valueMissing:!0},"A vote is required."),this.internals.checkValidity()}get numbered(){return!this.skipNumber}get response(){var e;return{...(e=this.commentBox)===null||e===void 0?void 0:e.response,name:this.prompt,rating:this.vote}}get promptTextTemplate(){if(!this.prompt)return Z;const e=this.numbered?ee`<slot name="question-number"></slot>`:Z;return ee`<div id="prompt-text">${e}${this.prompt}</div>`}get voteButtonsTemplate(){const e=this.vote==="up",t=this.vote==="down",r={"vote-button":!0,noselection:this.vote===void 0},o=Oh({...r,selected:e,unselected:t}),a=Oh({...r,selected:t,unselected:e});return ee`
      <label
        id="upvote"
        class=${o}
        ?disabled=${this.disabled}
      >
        ...
        />
        ${Sr}
        <span class="sr-only">${So.UPVOTE_SR_LABEL}</span>
      </label>
      ...
      >
        ...
        />
        ${_r}
        <span class="sr-only">${So.DOWNVOTE_SR_LABEL}</span>
      </label>
    ...
    `}};Ve.UPVOTE_SR_LABEL=ut("Vote up");Ve.DOWNVOTE_SR_LABEL=ut("Vote down");Ve.formAssociated=!0;Ve.shadowRootOptions={...pt.shadowRootOptions,delegatesFocus:!0};p([E({type:String})],Ve.prototype,"prompt",void 0);p([E({type:String})],Ve.prototype,"vote",void 0);p([E({type:String})],Ve.prototype,"comment",void 0);p([E({type:String})],Ve.prototype,"commentPlaceholder",void 0);p([E({type:Boolean,reflect:!0})],Ve.prototype,"required",void 0);p([E({type:Boolean,reflect:!0})],Ve.prototype,"disabled",void 0);p([E({type:Boolean,reflect:!0})],Ve.prototype,"skipNumber",void 0);p([E({type:Boolean,reflect:!0})],Ve.prototype,"showComments",void 0);p([Ye("#comments")],Ve.prototype,"commentBox",void 0);Ve=So=p([At("ia-survey-vote")],Ve);let Yo=class extends pt{constructor(){super(...arguments),this.name="",this.visible=!1,this.disabled=!1}createRenderRoot(){return this}render(){return Z}validate(){return!0}get numbered(){return!1}get response(){return{name:this.name,comment:this.value}}};p([E({type:String,reflect:!0})],Yo.prototype,"name",void 0);p([E({type:String,reflect:!0})],Yo.prototype,"value",void 0);Yo=p([At("ia-survey-extra")],Yo);const w4=m`
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path
...
`;var $4=Object.defineProperty,x4=Object.getOwnPropertyDescriptor,Ze=(i,e,t,s)=>{for(var r=s>1?void 0:s?x4(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&$4(e,t,r),r};let je=class extends H{constructor(){super(...arguments),this.binSnapping="none",this.barScaling="logarithmic",this.boundEscapeListener=i=>{i.key==="Escape"&&this.closeModal()}}render(){return m`
      <div id="container">
        <histogram-date-range
          ...
          dateFormat=${Ge(this.customDateFormat)}
          tooltipDateFormat=${Ge(this.customTooltipDateFormat)}
          tooltipLabel=${Ge(this.customTooltipLabel)}
    ...
    `}};Ze([u({type:String})],je.prototype,"minDate",2);Ze([u({type:String})],je.prototype,"maxDate",2);Ze([u({type:String})],je.prototype,"minSelectedDate",2);Ze([u({type:String})],je.prototype,"maxSelectedDate",2);Ze([u({type:Array})],je.prototype,"buckets",2);Ze([u({type:String})],je.prototype,"customDateFormat",2);Ze([u({type:String})],je.prototype,"customTooltipDateFormat",2);Ze([u({type:String})],je.prototype,"customTooltipLabel",2);Ze([u({type:String})],je.prototype,"binSnapping",2);Ze([u({type:String})],je.prototype,"barScaling",2);Ze([u({type:Object,attribute:!1})],je.prototype,"modalManager",2);Ze([u({type:Object,attribute:!1})],je.prototype,"analyticsHandler",2);je=Ze([N("expanded-date-picker")],je);let qi=class extends H{constructor(){super(...arguments),this.loadingTitle=_("Loading..."),this.successTitle=_("Success"),this.errorTitle=_("Error"),this.loadingStyle="ring-dots",this.mode="loading"}render(){return m`${_1(this.mode,[["loading",()=>this.loadingIndicatorTemplate],["success",()=>this.successIndicatorTemplate],["error",()=>this.errorIndicatorTemplate]])}`}get loadingIndicatorTemplate(){return m`
      <svg
    ...
    `}get shouldShowLoadingDots(){return this.loadingStyle!=="ring"}static get styles(){return[S1,w`
        :host {
      ...
      `]}};p([u({type:String})],qi.prototype,"loadingTitle",void 0);p([u({type:String})],qi.prototype,"successTitle",void 0);p([u({type:String})],qi.prototype,"errorTitle",void 0);p([u({type:String})],qi.prototype,"loadingStyle",void 0);p([u({type:String})],qi.prototype,"mode",void 0);qi=p([N("ia-status-indicator")],qi);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Dh=(i,e,t)=>{const s=new Map;for(let r=e;r<=t;r++)s.set(i[r],r);return s},Rp=jr(class extends Wr{constructor(i){if(super(i),i.type!==_t.CHILD)throw Error("repeat() can only be used in text expressions")}dt(i,e,t){let s;t===void 0?t=e:e!==void 0&&(s=e);const r=[],o=[];let a=0;for(const l of i)r[a]=s?s(l,a):a,o[a]=t(l,a),a++;return{values:o,keys:r}}render(i,e,t){return this.dt(i,e,t).values}update(i,[e,t,s]){const r=i2(i),{values:o,keys:a}=this.dt(e,t,s);if(!Array.isArray(r))return this.ut=a,o;const l=this.ut??(this.ut=[]),n=[];let c,d,h=0,f=r.length-1,g=0,y=o.length-1;for(;h<=f&&g<=y;)if(r[h]===null)h++;else if(r[f]===null)f--;else if(l[h]===a[g])n[g]=ui(r[h],o[g]),h++,g++;else if(l[f]===a[y])n[y]=ui(r[f],o[y]),f--,y--;else if(l[h]===a[y])n[y]=ui(r[h],o[y]),Ks(i,n[y+1],r[h]),h++,y--;else if(l[f]===a[g])n[g]=ui(r[f],o[g]),Ks(i,r[h],r[f]),f--,g++;else if(c===void 0&&(c=Dh(a,g,y),d=Dh(l,h,f)),c.has(l[h]))if(c.has(l[f])){const $=d.get(a[g]),A=$!==void 0?r[$]:null;if(A===null){const O=Ks(i,r[h]);ui(O,o[g]),n[g]=O}else n[g]=ui(A,o[g]),Ks(i,r[h],A),r[$]=null;g++}else Ua(r[f]),f--;else Ua(r[h]),h++;for(;g<=y;){const $=Ks(i,n[y+1]);ui($,o[g]),n[g++]=$}for(;h<=f;){const $=r[h++];$!==null&&Ua($)}return this.ut=a,x1(i,n),et}}),S4=G`
...
`;var C4=Object.defineProperty,T4=Object.getOwnPropertyDescriptor,pa=(i,e,t,s)=>{for(var r=s>1?void 0:s?T4(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&C4(e,t,r),r};let Ls=class extends H{render(){return m`${this.facetRowTemplate}`}get facetRowTemplate(){var $;const{bucket:i,facetType:e}=this;if(!i||!e)return b;const t=`${e}:${i.key}-show-only`,s=`${e}:${i.key}-negative`,r=i.extraNote?m`<span class="facet-note">${i.extraNote}</span>`:b,o=e!=="collection"?m`${i.displayText??i.key} ${r}`:m`<a href="/details/${i.key}">
            ${(($=this.collectionTitles)==null?void 0:$.get(i.key))??i.key}
          </a> `,a=i.count>0?i.count.toLocaleString():"",l=i.state==="hidden",n=i.state==="selected",c=`${e}: ${i.displayText??i.key}`,d=n?`Show all ${e}s`:`Only show ${c}`,h=`Hide ${c}`,f=`Unhide ${c}`,g=l?f:h,y=`${c}, ${i.count} results`;return m`
        ...
        <div class="facet-checkboxes">
          ...
          <div class="hide-facet-container">
            ...
            >
              ...
              <span class="eye eye-closed">${_4}</span>
            </label>
          </div>
        </div>
        <label
    ...
    `;return[yt,s]}};pa([u({type:String})],Ls.prototype,"facetType",2);pa([u({type:Object})],Ls.prototype,"bucket",2);pa([u({type:Object})],Ls.prototype,"collectionTitles",2);Ls=pa([N("facet-row")],Ls);var A4=Object.defineProperty,k4=Object.getOwnPropertyDescriptor,Kl=(i,e,t,s)=>{for(var r=s>1?void 0:s?k4(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&A4(e,t,r),r};let Qo=class extends H{facetClicked(i){this.dispatchFacetClickEvent(i.detail)}dispatchFacetClickEvent(i){const e=new CustomEvent("facetClick",{detail:i,composed:!0});this.dispatchEvent(e)}get facetsTemplate(){const{facetGroup:i}=this;if(!i)return b;const e=i.buckets;return m`
      <div class="facet-rows" data-testid="facets-on-${i.key}">
        ${Rp(e,t=>`${i.key}:${t.key}`,t=>m`<facet-row
              .facetType=${i.key}
              .bucket=${t}
              .collectionTitles=${this.collectionTitles}
    ...
    `}render(){return m`${this.facetsTemplate}`}static get styles(){const i=w`var(--facetsColumnCount, 1)`,e=w`var(--facetsColumnGap, 15px)`,t=w`var(--facetsColumnWidth, auto)`,s=w`var(--facetsMaxHeight, none)`;return w`
      .facet-rows {
        column-count: ${i};
        column-gap: ${e};
        column-width: ${t};
    ...
    `}};Kl([u({type:Object})],Qo.prototype,"facetGroup",2);Kl([u({type:Object})],Qo.prototype,"collectionTitles",2);Qo=Kl([N("facets-template")],Qo);var E4=Object.defineProperty,M4=Object.getOwnPropertyDescriptor,Qi=(i,e,t,s)=>{for(var r=s>1?void 0:s?M4(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&E4(e,t,r),r};let oi=class extends H{constructor(){super(...arguments),this.leftValue="",this.rightValue="",this.side="left"}render(){return m`
      <div id="container">
    ...
    `}get value(){return this.side==="left"?this.leftValue:this.rightValue}get selectedLabel(){return this.side==="left"?this.leftLabel??this.leftValue:this.rightLabel??this.rightValue}handleClick(){this.side=this.side==="left"?"right":"left",this.emitChangeEvent()}handleRadioChange(){this.side=this.leftRadio.checked?"left":"right",this.emitChangeEvent()}emitChangeEvent(){const i=new CustomEvent("change",{detail:this.value});this.dispatchEvent(i)}static get styles(){const i=w`var(--switchWidth, 30px)`,e=w`var(--switchHeight, 14px)`,t=w`var(--switchMarginLeft, 5px)`,s=w`var(--switchMarginRight, 5px)`,r=w`var(--switchBorderWidth, 3px)`,o=w`var(--switchBgColor, #194880)`,a=w`var(--switchBorderColor, #194880)`,l=w`var(--labelFontSize, 1.3rem)`,n=w`var(--knobColor, white)`,c=w`var(--knobTransitionDuration, 0.25s)`,d=w`var(--knobTransitionFn, ease)`;return[yt,w`
        #container {
          display: inline-flex;
          align-items: center;
          flex-wrap: nowrap;
      ...
      `]}};Qi([u({type:String,attribute:!0})],oi.prototype,"leftValue",2);Qi([u({type:String,attribute:!0})],oi.prototype,"leftLabel",2);Qi([u({type:String,attribute:!0})],oi.prototype,"rightValue",2);Qi([u({type:String,attribute:!0})],oi.prototype,"rightLabel",2);Qi([u({type:String,attribute:!0})],oi.prototype,"side",2);Qi([Q("#switch-left")],oi.prototype,"leftRadio",2);oi=Qi([N("toggle-switch")],oi);const P4=G`
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path 
      d="m20.1116715 50.0035012-.1116715-.1085359 43.1159942-46.61088155c2.401537-2.18938917 4.6902018-3.28408375 6.8659943-3.28408375s4.1642651.63837733 5.9654178 1.91513199c1.8011528 1.27675467 3.1520173 2.97248092 4.0525937 5.08717877l-39.4020173 42.99768924 39.4020173 42.9976892c-.9005764 2.1146979-2.2514409 3.8104241-4.0525937 5.0871788-1.8011527 1.2767547-3.7896253 1.915132-5.9654178 1.915132-2.1013449 0-4.3900096-1.0573489-6.8659943-3.1720468l-43.1159942-46.7194174z"
    />
...
`;var D4=Object.defineProperty,L4=Object.getOwnPropertyDescriptor,Is=(i,e,t,s)=>{for(var r=s>1?void 0:s?L4(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&D4(e,t,r),r};let Gi=class extends H{constructor(){super(...arguments),this.step=2,this.currentPage=1,this.compact=!1,this.pages=[]}firstUpdated(){this.observePageCount()}updated(i){(i.has("size")||i.has("compact"))&&this.observePageCount(),i.has("currentPage")&&(this.observePageCount(),this.emitPageClick())}observePageCount(){if(this.pages=[],this.compact){this.observePageCountCompact();return}const i=7,e=this.size<=i;if(this.size<=5){this.pages=[...Array(this.size).keys()].map(r=>r+1);return}if(this.size===i){if(this.currentPage===2){this.pages=[1,2,3,4,0,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,4,5,this.size-1,this.size];return}}if(this.currentPage===1){this.pages=[1,2,3,0,this.size];return}if(this.currentPage===this.size){this.pages=[1,0,this.size-2,this.size-1,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,this.size-3,this.size-2,this.size-1,this.size];return}if(e&&this.currentPage>1&&this.currentPage<i){this.pages=[...Array(this.size).keys()].map(r=>r+1);return}let t=this.currentPage-this.step,s=this.currentPage+this.step;t<=0&&(s+=-t+1,t=1),s>=this.size&&(t=Math.max(t-(s-this.size),1),s=this.size),t===2&&(s-=1),s===this.size-1&&(t+=1),this.createFirstNode(t),this.createMiddelNode(t,s),this.createLastNode(s)}createFirstNode(i){var e,t;i>1&&((e=this.pages)==null||e.push(1)),i>2&&((t=this.pages)==null||t.push(0))}createMiddelNode(i,e){var t;for(let s=i;s<=e;s+=1)(t=this.pages)==null||t.push(s)}createLastNode(i){var e,t;i<this.size-1&&((e=this.pages)==null||e.push(0)),i<this.size&&((t=this.pages)==null||t.push(this.size))}observePageCountCompact(){if(this.size<=3){this.pages=[...Array(this.size).keys()].map(e=>e+1);return}const i=[];i.push(1),this.currentPage>3&&i.push(0),this.currentPage-1>1&&i.push(this.currentPage-1),this.currentPage!==1&&this.currentPage!==this.size&&i.push(this.currentPage),this.currentPage+1<this.size&&i.push(this.currentPage+1),this.currentPage<this.size-2&&i.push(0),i.push(this.size),this.pages=i}get getEllipsisTemplate(){return m`<i class="ellipses">...</i>`}emitPageClick(){this.dispatchEvent(new CustomEvent("pageNumberClicked",{detail:{page:this.currentPage},bubbles:!0,composed:!0}))}onRewind(){this.currentPage-=1,this.currentPage<1&&(this.currentPage=1)}onForward(){this.currentPage+=1,this.currentPage>this.size&&(this.currentPage=this.size)}onChange(i){this.currentPage=i}getPageTemplate(i){return m`
      <button
    ...
    `}static get styles(){return[yt,w`
      ...
      `]}};Is([u({type:Number})],Gi.prototype,"size",2);Is([u({type:Number})],Gi.prototype,"step",2);Is([u({type:Number})],Gi.prototype,"currentPage",2);Is([u({type:Boolean})],Gi.prototype,"compact",2);Is([R()],Gi.prototype,"pages",2);Gi=Is([N("more-facets-pagination")],Gi);const B4=1e4,F4=35;var R4=Object.defineProperty,z4=Object.getOwnPropertyDescriptor,le=(i,e,t,s)=>{for(var r=s>1?void 0:s?z4(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&R4(e,t,r),r};const I4=1e3;let ae=class extends H{constructor(){super(...arguments),this.facetsPerPage=F4,this.facetsLoading=!0,this.sortedBy=j.COUNT,this.isTvSearch=!1,this.unappliedFacetChanges=Bt(),this.filterText="",this.pageNumber=1,this.isCompactView=!1}willUpdate(i){(i.has("aggregations")||i.has("facetsPerPage")||i.has("sortedBy")||i.has("selectedFacets")||i.has("unappliedFacetChanges"))&&(this.facetGroup=this.mergedFacets),i.has("filterText")&&(this.pageNumber=1)}updated(i){var e;if((i.has("facetKey")||i.has("query")||i.has("searchType")||i.has("filterMap"))&&(this.facetsLoading=!0,this.pageNumber=1,this.sortedBy=this.searchType===I.TV?Vu[this.facetKey]:ds[this.facetKey],this.updateSpecificFacets()),i.has("filterText")){const t=(e=this.shadowRoot)==null?void 0:e.querySelector(".facets-content");t&&(t.scrollLeft=0)}}firstUpdated(){this.setupEscapeListeners(),this.setupCompactViewListener()}setupCompactViewListener(){const i=window.matchMedia("(max-width: 560px)");this.isCompactView=i.matches,i.addEventListener("change",e=>{this.isCompactView=e.matches})}setupEscapeListeners(){this.modalManager?document.addEventListener("keydown",i=>{var e;i.key==="Escape"&&((e=this.modalManager)==null||e.closeModal())}):document.removeEventListener("keydown",()=>{})}get isSearchResultsPage(){var e;const i=(e=this.pageSpecifierParams)==null?void 0:e.pageType;return i===void 0||i==="search_results"}async updateSpecificFacets(){var a,l,n,c,d,h;if(!this.facetKey)return;const i=(a=this.query)==null?void 0:a.trim();if(!i&&this.isSearchResultsPage)return;const e={simpleParams:[this.facetKey]},t=B4,s={...this.pageSpecifierParams,query:i||"",identifiers:this.identifiers,filters:this.filterMap,aggregations:e,aggregationsSize:t,rows:0},r=await((l=this.searchService)==null?void 0:l.search(s,this.searchType));this.aggregations=(n=r==null?void 0:r.success)==null?void 0:n.response.aggregations,this.facetsLoading=!1;const o=(d=(c=r==null?void 0:r.success)==null?void 0:c.response)==null?void 0:d.collectionTitles;if(o)for(const[f,g]of Object.entries(o))(h=this.collectionTitles)==null||h.set(f,g)}get mergedFacets(){if(!this.facetKey||!this.selectedFacets)return;const{selectedFacetGroup:i,aggregationFacetGroup:e}=this;if(!e)return;const t={...i??e},s=(i==null?void 0:i.buckets.map(o=>{const a=e.buckets.find(l=>l.key===o.key);return a?{...o,count:a.count}:o}))??[];w1(s,this.sortedBy),e.buckets.forEach(o=>{i!=null&&i.buckets.find(l=>l.key===o.key)||s.push(o)});const r=this.unappliedFacetChanges[this.facetKey];for(const[o,a]of s.entries()){const l=r==null?void 0:r[a.key];l&&(s[o]={...l})}return this.facetKey==="creator"&&this.isTvSearch&&s.forEach(o=>{var l,n;o.displayText=(l=o.displayText??o.key)==null?void 0:l.toLocaleUpperCase();const a=(n=this.tvChannelAliases)==null?void 0:n.get(o.displayText);a&&a!==o.displayText&&(o.extraNote=`(${a})`)}),t.buckets=s,t}get selectedFacetGroup(){if(!this.selectedFacets||!this.facetKey)return;const i=this.selectedFacets[this.facetKey];if(!i)return;const e=Lo[this.facetKey],t=Object.entries(i).map(([s,r])=>({displayText:s,key:s,count:r==null?void 0:r.count,state:r==null?void 0:r.state}));return{title:e,key:this.facetKey,buckets:t}}get aggregationFacetGroup(){if(!this.aggregations||!this.facetKey)return;const i=this.aggregations[this.facetKey];if(!i)return;const e=Lo[this.facetKey];let t=i.getSortedBuckets(this.sortedBy);this.facetKey==="collection"&&(t=t==null?void 0:t.filter(r=>{var a;const o=(a=r==null?void 0:r.key)==null?void 0:a.toString();return!sa[o]&&!(o!=null&&o.startsWith("fav-"))}));const s=t.map(r=>{const o=`${r.key}`;return{displayText:`${o}`,key:`${o}`,count:r.doc_count,state:"none"}});return{title:e,key:this.facetKey,buckets:s}}get filteredFacetGroup(){const{facetGroup:i,filterText:e}=this;if(!i)return;if(!e.trim())return i;const t=e.toLowerCase().trim(),s=i.buckets.filter(r=>r.key.toLowerCase().includes(t));return{...i,buckets:s}}get usePagination(){var e;return(((e=this.filteredFacetGroup)==null?void 0:e.buckets.length)??0)>=I4}get facetGroupForCurrentPage(){const i=this.filteredFacetGroup;if(!i)return;if(!this.usePagination)return i;const e=(this.pageNumber-1)*this.facetsPerPage,t=e+this.facetsPerPage,s=i.buckets.slice(e,t);return{...i,buckets:s}}get moreFacetsTemplate(){const i=this.facetGroupForCurrentPage;return this.filterText.trim()&&(!i||i.buckets.length===0)?this.emptyFilterResultsTemplate:m`
      <facets-template
        .facetGroup=${i}
        .selectedFacets=${this.selectedFacets}
        .collectionTitles=${this.collectionTitles}
        @facetClick=${e=>{this.facetKey&&(this.unappliedFacetChanges=Ti(this.unappliedFacetChanges,this.facetKey,e.detail.bucket))}}
      ></facets-template>
    ...
    `}get emptyFilterResultsTemplate(){return m`
      <div class="empty-results">
        <p>${_("No matching values found.")}</p>
        <p class="hint">${_("Try a different search term.")}</p>
      </div>
    `}get paginationSize(){var e;const i=((e=this.filteredFacetGroup)==null?void 0:e.buckets)??[];return Math.ceil(i.length/this.facetsPerPage)}get facetsPaginationTemplate(){return this.usePagination?m`<more-facets-pagination
      .size=${this.paginationSize}
      .currentPage=${this.pageNumber}
      .compact=${this.isCompactView}
      @pageNumberClicked=${this.pageNumberClicked}
    ></more-facets-pagination>`:b}get footerTemplate(){return m`
    ...
    `}sortFacetAggregation(i){this.sortedBy=i,this.dispatchEvent(new CustomEvent("sortedFacets",{detail:this.sortedBy}))}handleFilterInput(i){const e=i.target;this.filterText=e.value}handleFilterClear(){var e;this.filterText="";const i=(e=this.shadowRoot)==null?void 0:e.querySelector("#facet-filter");i==null||i.focus()}pageNumberClicked(i){var e;this.pageNumber=i.detail.page,(e=this.analyticsHandler)==null||e.sendEvent({category:Ft.default,action:de.moreFacetsPageChange,label:`${this.pageNumber}`}),this.dispatchEvent(new CustomEvent("pageChanged",{detail:this.pageNumber}))}get modalHeaderTemplate(){var t,s;const e=(this.sortedBy??ds[this.facetKey])===j.COUNT?"left":"right";return m`<span class="sr-only">${_("More facets for:")}</span>
        ...
        <span class="filter-controls">
          ...
          <span class="filter-input-container">
            <input
              ...
              aria-label=${_("Filter facets")}
            />
            ${this.filterText?m`<button
      ...
      </span>`}render(){const i=this.usePagination?"facets-content pagination-mode":"facets-content horizontal-scroll-mode",e=this.usePagination?"pagination-mode":"horizontal-scroll-mode";return m`
      ${this.facetsLoading?this.loaderTemplate:m`
            <section id="more-facets" class="${e}">
              <div class="header-content">${this.modalHeaderTemplate}</div>
              <div class="${i}">
                ${this.usePagination?this.moreFacetsTemplate:m`<div class="facets-horizontal-container">
          ...
          `}
    `}applySearchFacetsClicked(){var t,s;const i=y1(this.selectedFacets,this.unappliedFacetChanges),e=new CustomEvent("facetsChanged",{detail:i,bubbles:!0,composed:!0});this.dispatchEvent(e),this.unappliedFacetChanges=Bt(),this.filterText="",(t=this.modalManager)==null||t.closeModal(),(s=this.analyticsHandler)==null||s.sendEvent({category:Ft.default,action:`${de.applyMoreFacetsModal}`,label:`${this.facetKey}`})}cancelClick(){var i,e;this.unappliedFacetChanges=Bt(),this.filterText="",(i=this.modalManager)==null||i.closeModal(),(e=this.analyticsHandler)==null||e.sendEvent({category:Ft.default,action:de.closeMoreFacetsModal,label:`${this.facetKey}`})}static get styles(){const i=w`var(--primaryButtonBGColor, #194880)`;return[yt,w`
        section#more-facets {
          display: flex;
          flex-direction: column;
      ...
      `]}};le([u({type:String})],ae.prototype,"facetKey",2);le([u({type:String})],ae.prototype,"query",2);le([u({type:Array})],ae.prototype,"identifiers",2);le([u({type:Object})],ae.prototype,"filterMap",2);le([u({type:Number})],ae.prototype,"searchType",2);le([u({type:Object})],ae.prototype,"pageSpecifierParams",2);le([u({type:Object})],ae.prototype,"collectionTitles",2);le([u({type:Object})],ae.prototype,"tvChannelAliases",2);le([u({type:Number})],ae.prototype,"facetsPerPage",2);le([u({type:Boolean})],ae.prototype,"facetsLoading",2);le([u({type:Object})],ae.prototype,"selectedFacets",2);le([u({type:Number})],ae.prototype,"sortedBy",2);le([u({type:Boolean})],ae.prototype,"isTvSearch",2);le([u({type:Object})],ae.prototype,"modalManager",2);le([u({type:Object})],ae.prototype,"searchService",2);le([u({type:Object,attribute:!1})],ae.prototype,"analyticsHandler",2);le([R()],ae.prototype,"aggregations",2);le([R()],ae.prototype,"facetGroup",2);le([R()],ae.prototype,"unappliedFacetChanges",2);le([R()],ae.prototype,"filterText",2);le([R()],ae.prototype,"pageNumber",2);le([R()],ae.prototype,"isCompactView",2);ae=le([N("more-facets-content")],ae);var N4=Object.getOwnPropertyDescriptor,H4=(i,e,t,s)=>{for(var r=s>1?void 0:s?N4(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=a(r)||r);return r};let Lh=class extends H{render(){return m`
      <div id="row">
    ...
    `}};Lh=H4([N("facet-tombstone-row")],Lh);var U4=Object.defineProperty,V4=Object.getOwnPropertyDescriptor,q=(i,e,t,s)=>{for(var r=s>1?void 0:s?V4(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&U4(e,t,r),r};let W=class extends H{constructor(){super(...arguments),this.moreLinksVisible=!0,this.facetsLoading=!1,this.histogramAggregationLoading=!1,this.collapsableFacets=!1,this.showHistogramDatePicker=!1,this.allowExpandingDatePicker=!1,this.suppressMediatypeFacets=!1,this.parentCollections=[],this.collectionPagePath="/details/",this.isManageView=!1,this.isTvSearch=!1,this.facetDisplayOrder=f1,this.openFacets={subject:!1,lending:!1,mediatype:!1,language:!1,creator:!1,collection:!1,year:!1,clip_type:!1,program:!1,person:!1,sponsor:!1},this.allowedFacetCount=6,this.handleExpandedDatePickerClosed=()=>{var i;(i=this.modalManager)==null||i.classList.remove("expanded-date-picker")},this.histogramDateRangeUpdated=i=>{const{minDate:e,maxDate:t}=i.detail,s=new CustomEvent("histogramDateRangeUpdated",{detail:{minDate:e,maxDate:t}});this.dispatchEvent(s)}}render(){const i=Qe({loading:this.facetsLoading,managing:this.isManageView}),e=this.isTvSearch?_("Date Published"):_("Year Published"),t="date-picker-label";return m`
    ...
    `}partOfCollectionClicked(i){var e;(e=this.analyticsHandler)==null||e.sendEvent({category:Ft.default,action:de.partOfCollectionClicked,label:i.target.dataset.id})}get histogramProps(){const{histogramAggregation:i}=this;if(!i)return;const e=i.first_bucket_year??i.first_bucket_key,t=i.last_bucket_year??i.last_bucket_key;if(e==null||t==null)return;const s=i.first_bucket_month??1,r=i.last_bucket_month??12,o=i.interval??1,a=i.interval_in_months??12,l=n=>n.toString().padStart(2,"0");if(this.isTvSearch){const n=a<12;return{buckets:i.buckets,dateFormat:"YYYY-MM",tooltipDateFormat:n?"MMM YYYY":"YYYY",tooltipLabel:"broadcast",binSnapping:n?"month":"year",barScaling:"linear",minDate:`${e}-${l(s)}`,maxDate:`${t}-${l(r+a-1)}`}}return{buckets:i.buckets,dateFormat:"YYYY",tooltipDateFormat:"YYYY",tooltipLabel:"item",binSnapping:"year",barScaling:"logarithmic",minDate:`${e}`,maxDate:`${t+o-1}`}}showDatePickerModal(){var f,g,y;const{histogramProps:i}=this;if(!i)return;const{buckets:e,dateFormat:t,tooltipDateFormat:s,tooltipLabel:r,binSnapping:o,barScaling:a,minDate:l,maxDate:n}=i,d=m`
      ...
      ></expanded-date-picker>
    `,h=new Bi({bodyColor:"#fff",headerColor:"#194880",showHeaderLogo:!1,closeOnBackdropClick:!0,title:m`${_("Select a date range")}`});(f=this.modalManager)==null||f.classList.add("expanded-date-picker"),(g=this.modalManager)==null||g.showModal({config:h,customModalContent:d,userClosedModalCallback:this.handleExpandedDatePickerClosed}),(y=this.analyticsHandler)==null||y.sendEvent({category:Ft.default,action:de.histogramExpanded,label:window.location.href})}updated(i){i.has("selectedFacets")&&this.dispatchFacetsChangedEvent()}dispatchFacetsChangedEvent(){const i=new CustomEvent("facetsChanged",{detail:this.selectedFacets});this.dispatchEvent(i)}get expandDatePickerBtnTemplate(){return this.allowExpandingDatePicker&&!this.facetsLoading?m`<button
          class="expand-date-picker-btn"
          aria-haspopup="dialog"
          @click=${this.showDatePickerModal}
        >
          <span class="sr-only">${_("Expand date histogram")}</span>
          <span aria-hidden="true">${w4}</span>
    ...
    `}searchMoreFacetsLink(i){if(!this.moreLinksVisible||i.key==="lending"||Object.keys(i.buckets).length<this.allowedFacetCount)return b;const e=ds[i.key];return m`<button
      class="more-link"
      @click=${()=>{var t;this.showMoreFacetsModal(i,e),(t=this.analyticsHandler)==null||t.sendEvent({category:Ft.default,action:de.showMoreFacetsModal,label:i.key}),this.dispatchEvent(new CustomEvent("showMoreFacets",{detail:i.key}))}}
    ...
    `}static get styles(){const i=w`var(--circularActivityIndicatorColor, dodgerblue)`,e=w`var(--circularActivityIndicatorThickness, 4px)`;return w`
      :host {
        display: block;
      }
    ...
    `}};Bh=W4([N("circular-activity-indicator")],Bh);function q4(i,e){return i===void 0?e!==void 0:e===void 0?i!==void 0:i.facetType===e.facetType&&i.bucketKey===e.bucketKey}function pl(i,e){return i.label===e.label&&i.facets.length===e.facets.length&&i.facets.every((t,s)=>q4(t,e.facets[s]))}function zp(i){if(!Array.isArray(i[0])){let r=[...i];for(let o=0;o<r.length;o++){const a=r[o];r=r.filter(l=>a===l||!pl(a,l))}return r}const e=i,t=[];for(const s of e){const r=[];for(const o of s)t.find(l=>l.find(n=>pl(o,n)))||r.push(o);r.length>0&&t.push(r)}return t}class Xl{async getRecommendedFacets(){const e=navigator.language,t=Xl.getLanguageDisplayName(e);return t?[{facets:[{facetType:"language",bucketKey:t}]}]:[]}static getLanguageDisplayName(e){const t=e.split("-")[0];return new Intl.DisplayNames(["en"],{type:"language"}).of(t)}}const yi={facets:[{facetType:"mediatype",bucketKey:"texts"}]},wi={facets:[{facetType:"mediatype",bucketKey:"audio"}]},rs={facets:[{facetType:"mediatype",bucketKey:"movies"}]},Ht={facets:[{facetType:"mediatype",bucketKey:"image"}]},dr={facets:[{facetType:"mediatype",bucketKey:"software"}]},En={facets:[{facetType:"mediatype",bucketKey:"etree"}]},G4={facets:[{facetType:"mediatype",bucketKey:"web"}]},Y4={facets:[{facetType:"mediatype",bucketKey:"data"}]},Q4={text:[yi],book:[yi],novel:[yi],magazine:[yi],newspaper:[yi],pdf:[yi],epub:[yi],audio:[wi],song:[wi],music:[wi],listen:[wi],podcast:[wi],radio:[wi],stream:[wi,rs],video:[rs],movie:[rs],film:[rs],animation:[rs],youtube:[rs],image:[Ht],photo:[Ht],picture:[Ht],painting:[Ht],jpg:[Ht],jpeg:[Ht],png:[Ht],gif:[Ht],software:[dr],app:[dr],program:[dr],game:[dr],arcade:[dr],etree:[En],concert:[En],"live music":[En],"web crawl":[G4],dataset:[Y4]};class K4{async getRecommendedFacets(e){const t=[];for(const[s,r]of Object.entries(Q4))e.includes(s)&&t.push(...r);return t}}const lo=[{facets:[{facetType:"mediatype",bucketKey:"texts"}]}],Fh=[{label:"Films by __QUERY",facets:[{facetType:"mediatype",bucketKey:"movies"},{facetType:"creator",bucketKey:"__QUERY"}]}],hr=[{label:"Writing by __QUERY",facets:[{facetType:"mediatype",bucketKey:"texts"},{facetType:"creator",bucketKey:"__QUERY"}]}],co=[{label:"Images by __QUERY",facets:[{facetType:"mediatype",bucketKey:"image"},{facetType:"creator",bucketKey:"__QUERY"}]}],pr=[{label:"Music by __QUERY",facets:[{facetType:"mediatype",bucketKey:"audio"},{facetType:"creator",bucketKey:"__QUERY"}]}],X4={"written work":lo,literature:lo,book:lo,novel:lo,filmmaker:Fh,director:Fh,author:hr,writer:hr,novelist:hr,essayist:hr,poet:hr,"visual artist":co,"graphic artist":co,photographer:co,painter:co,singer:pr,songwriter:pr,musician:pr,composer:pr,pianist:pr};class Z4{constructor(){this.WIKIDATA_BASE_URL="https://www.wikidata.org/w/api.php",this.WIKIDATA_DEFAULT_ARGS="?action=wbsearchentities&format=json&language=en&uselang=en&origin=*&type=item&limit=5"}getWikidataURL(e){const t=encodeURIComponent(e);return`${this.WIKIDATA_BASE_URL}${this.WIKIDATA_DEFAULT_ARGS}&search=${t}`}replaceQueryPlaceholders(e,t){return e.map(s=>{var r;return{label:(r=s.label)==null?void 0:r.replace("__QUERY",t),facets:s.facets.map(o=>{var l;const a={...o,bucketKey:o.bucketKey.replace("__QUERY",t.toLowerCase())};return o.displayText&&(a.displayText=(l=a.displayText)==null?void 0:l.replace("__QUERY",t)),a})}})}async getRecommendedFacets(e){var s;const t=[];try{const r=this.getWikidataURL(e),a=await(await fetch(r)).json();for(const[l,n]of Object.entries(X4))if(new RegExp(`\\b${l}\\b`).test((s=a.search[0])==null?void 0:s.description)){const d=a.search[0].label;t.push(...this.replaceQueryPlaceholders(n,d))}return t}catch(r){return console.warn(r),[]}}}const Ko=class Ko{async getRecommendedFacets(e,t=Ko.DEFAULT_HEURISTICS){const s=t.map(r=>new r().getRecommendedFacets(e));return zp((await Promise.all(s)).flat())}};Ko.DEFAULT_HEURISTICS=[K4,Z4,Xl];let ul=Ko;const J4=m`
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path
...
`;var t6=Object.defineProperty,i6=Object.getOwnPropertyDescriptor,ua=(i,e,t,s)=>{for(var r=s>1?void 0:s?i6(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&t6(e,t,r),r};function s6(i){return i&&i.charAt(0).toLocaleUpperCase()+i.slice(1)}let Vr=class extends H{constructor(){super(...arguments),this.selected=!1}render(){if(!this.facetInfo)return b;const i=this.facetInfo.facets.length===1,e=this.facetInfo.facets[0],t=s6((this.labelPrefix?`${this.labelPrefix} `:"")+(this.facetInfo.label??e.displayText??e.bucketKey));if(!t)return b;const s=i&&e.facetType==="mediatype"?O1[e.bucketKey].icon:b;return m`
      <a
      ...
      >
        ${s} ${t}
        ${this.selected?m`<span class="unselect-button">${e6}</span>`:b}
      </a>
    ...
    `}};ua([u({type:Object})],Vr.prototype,"facetInfo",2);ua([u({type:String})],Vr.prototype,"labelPrefix",2);ua([u({type:Boolean})],Vr.prototype,"selected",2);Vr=ua([N("smart-facet-button")],Vr);var r6=Object.defineProperty,o6=Object.getOwnPropertyDescriptor,Qr=(i,e,t,s)=>{for(var r=s>1?void 0:s?o6(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&r6(e,t,r),r};let Bs=class extends H{render(){if(!this.facetInfo||!this.activeFacetRef||this.facetInfo.length===0)return b;const i=this.activeFacetRef.displayText??this.activeFacetRef.bucketKey;return i?m`
    ...
    `}smartFacetDropdown(i){return m`
      <smart-facet-dropdown
        .facetInfo=${i}
        .labelPrefix=${Rh[i[0].facets[0].facetType]}
    ...
    `}};wt([u({type:String})],st.prototype,"query",2);wt([u({type:Object})],st.prototype,"aggregations",2);wt([u({type:Object})],st.prototype,"selectedFacets",2);wt([u({type:Object})],st.prototype,"collectionTitles",2);wt([u({type:Boolean})],st.prototype,"filterToggleShown",2);wt([u({type:Boolean})],st.prototype,"filterToggleActive",2);wt([u({type:String})],st.prototype,"label",2);wt([R()],st.prototype,"heuristicRecs",2);wt([R()],st.prototype,"smartFacets",2);wt([R()],st.prototype,"lastAggregations",2);st=wt([N("smart-facet-bar")],st);var c6=Object.defineProperty,d6=Object.getOwnPropertyDescriptor,k=(i,e,t,s)=>{for(var r=s>1?void 0:s?d6(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&c6(e,t,r),r};let T=class extends H{constructor(){super(),this.baseImageUrl="https://archive.org",this.searchType=I.DEFAULT,this.selectedSort=V.default,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.sortDirection=null,this.defaultSortField=V.relevance,this.defaultSortDirection=null,this.pageSize=50,this.showSmartFacetBar=!1,this.showHistogramDatePicker=!1,this.suppressPlaceholders=!1,this.suppressResultCount=!1,this.suppressResultTiles=!1,this.suppressURLQuery=!1,this.suppressURLSinParam=!1,this.suppressSortBar=!1,this.suppressDisplayModes=!1,this.suppressMediatypeFacets=!1,this.facetLoadStrategy="eager",this.facetPaneVisible=!1,this.clearResultsOnEmptyQuery=!1,this.collectionPagePath="/details/",this.searchContext=Ft.default,this.pageContext="search",this.restorationStateHandler=new Ku({context:this.pageContext}),this.mobileBreakpoint=600,this.loggedIn=!1,this.modalManager=void 0,this.isTVCollection=!1,this.isManageView=!1,this.manageViewLabel="Select items to remove",this.enableSortOptionsSlot=!1,this.showSmartResults=!1,this.maxPagesToManage=15,this.dataSource=new Ju(this,this.pageSize),this.initialPageNumber=1,this.pagesToRender=this.initialPageNumber,this.searchResultsLoading=!1,this.facetsLoading=!1,this.mobileView=!1,this.tileBlurOverrideState="no-override",this.collapsibleFacetsVisible=!1,this.placeholderType=null,this.selectedTVNetwork=void 0,this.selectedTVShow=void 0,this.tvMapsPopulated=!1,this.tvMapsLoading=!1,this.tvMapsErrored=!1,this.layoutSizeAnalyticsSent=!1,this.isScrollingToCell=!1,this.isResizeToMobile=!1,this.dataSourceInstallInProgress=!1,this.placeholderCellTemplate=m`<collection-browser-loading-tile></collection-browser-loading-tile>`,this.updateLeftColumnHeight=()=>{var i,e,t,s,r;if(this.mobileView)(e=(i=this.leftColumn)==null?void 0:i.style)==null||e.removeProperty("height");else{const o=(t=this.leftColumn)==null?void 0:t.getBoundingClientRect().top,a=window.innerHeight-(o??0),l=o===0?null:`calc(${a}px - var(--leftColumnPaddingTop, 2rem))`;(r=(s=this.leftColumn)==null?void 0:s.style)==null||r.setProperty("height",l)}},this.updateFacetFadeOut=i=>{var t,s;const e=(t=this.shadowRoot)==null?void 0:t.getElementById("facets-bottom-fade");e==null||e.classList.toggle("hidden",(s=i==null?void 0:i[0])==null?void 0:s.isIntersecting)},this.initialQueryChangeHappened=!1,this.historyPopOccurred=!1,this.addController(this.dataSource)}tileModelAtCellIndex(i){const e=this.dataSource.getTileModelAt(i);if(!e&&!this.isScrollingToCell&&this.dataSource.queryInitialized){const t=Math.floor(i/this.pageSize)+1;this.dataSource.fetchPage(t)}return e}get estimatedTileCount(){return this.pagesToRender*this.pageSize}async getSessionId(){try{const i=sessionStorage==null?void 0:sessionStorage.getItem("cb-session");if(i)return i;if(this.sessionIdGenPromise)return this.sessionIdGenPromise;this.sessionIdGenPromise=b1(Math.random().toString());const e=await this.sessionIdGenPromise;return sessionStorage==null||sessionStorage.setItem("cb-session",e),e}catch{return""}}goToPage(i){return this.initialPageNumber=i,this.pagesToRender=i,this.scrollToPage(i)}setSearchResultsLoading(i){this.searchResultsLoading=i}setFacetsLoading(i){this.facetsLoading=i}setTotalResultCount(i){this.totalResults=i}clearFilters({facets:i=!0,dateRange:e=!0,letterFilters:t=!0,sort:s=!1}={}){i&&this.hasCheckedFacets&&(this.selectedFacets=Bt()),e&&(this.minSelectedDate=void 0,this.maxSelectedDate=void 0),t&&(this.selectedTitleFilter=null,this.selectedCreatorFilter=null),s&&(this.sortDirection=null,this.selectedSort=V.default),this.clearTVDropdowns(),this.smartFacetBar&&this.smartFacetBar.deselectAll()}clearTVDropdowns(){this.selectedTVNetwork=void 0,this.selectedTVShow=void 0,this.tvNetworksDropdown&&this.tvNetworksDropdown.clearSelectedOption(),this.tvShowsDropdown&&this.tvShowsDropdown.clearSelectedOption()}get hasCheckedFacets(){if(!this.selectedFacets)return!1;for(const i of Object.values(this.selectedFacets))for(const e of Object.values(i))if(e.state!=="none")return!0;return!1}get hasActiveFilters(){return!!(this.hasCheckedFacets||this.minSelectedDate||this.maxSelectedDate||this.selectedTitleFilter||this.selectedCreatorFilter)}willUpdate(i){this.setPlaceholderType(),i.has("searchType")&&this.searchType===I.TV&&this.applyDefaultTVSearchSort()}render(){return m`
    ...
    </div>`}get resultsCountTemplate(){var r;if(this.suppressResultCount)return b;const i=this.searchResultsLoading||this.totalResults===void 0,e=Qe({filtered:this.hasActiveFilters}),t=(r=this.totalResults)==null?void 0:r.toLocaleString(),s=this.totalResults===1?"Result":"Results";return m`
    ...
    </infinite-scroller>`}get infiniteScrollerClasses(){return Qe({[this.displayMode??""]:!!this.displayMode,hidden:!!this.placeholderType})}get sortFilterBarTemplate(){var s;if(this.suppressSortBar)return b;let i=V.weeklyview,e=V.date,t=ia;return(s=this.withinCollection)!=null&&s.startsWith("fav-")?(e=V.datefavorited,t=Ru):!this.withinCollection&&this.searchType===I.TV&&(i=V.alltimeview,e=V.datearchived,t=zu),t.relevance=this.isRelevanceSortAvailable,m`
      <sort-filter-bar
    ...
    `:b}get manageViewModalMsg(){const i=this.dataSource.checkedTileModels.length>1;switch(this.profileElement){case"uploads":return _(i?"Note: It may take a few minutes for these items to stop appearing in your uploads list.":"Note: It may take a few minutes for this item to stop appearing in your uploads list.");case"web_archives":return _(i?"Note: It may take a few minutes for these items to stop appearing in your web archives list.":"Note: It may take a few minutes for this item to stop appearing in your web archives list.");default:return""}}get manageBarTemplate(){return m`
      ...
      ></manage-bar>
    `}handleRemoveItems(){this.dispatchEvent(new CustomEvent("itemRemovalRequested",{detail:{items:this.dataSource.checkedTileModels.map(i=>{const e=(i==null?void 0:i.mediatype)==="search"?"search:":"",t=(i==null?void 0:i.identifier)??"";return`${e}${t}`})}}))}handleManageItems(){this.dispatchEvent(new CustomEvent("itemManagerRequested",{detail:{items:this.dataSource.checkedTileModels.map(i=>i!=null&&i.identifier?i.identifier:"")}}))}refreshSmartFacets(){var i;(i=this.smartFacetBar)==null||i.refresh()}showRemoveItemsProcessingModal(){var i;(i=this.manageBar)==null||i.showRemoveItemsProcessingModal()}showRemoveItemsErrorModal(){var i;(i=this.manageBar)==null||i.showRemoveItemsErrorModal()}removeCheckedTiles(){this.dataSource.removeCheckedTiles()}tileBlurCheckboxChanged(i){var t;const{checked:e}=i.target;this.tileBlurOverrideState=e?"on":"off",(t=this.infiniteScroller)==null||t.refreshAllVisibleCells()}get shouldSuppressTileBlurring(){if(this.tileBlurOverrideState!=="no-override")return this.tileBlurOverrideState==="off";const{sessionContext:i}=this.dataSource,e=i==null?void 0:i.pps_relevant_user_preferences;return(e==null?void 0:e.display__blur_moderated_content)==="off"}userChangedSort(i){const{selectedSort:e,sortDirection:t}=i.detail;this.selectedSort=e,this.sortDirection=t,(this.currentPage??1)>1&&this.goToPage(1),this.currentPage=1}sendSortByAnalytics(i){var t;const e=i&&!this.sortDirection;(t=this.analyticsHandler)==null||t.sendEvent({category:this.searchContext,action:de.sortBy,label:`${this.selectedSort}${this.sortDirection||e?`-${this.sortDirection}`:""}`})}selectedSortChanged(){this.dataSource.updatePrefixFiltersForCurrentSort()}get sortParam(){const i=Ie[this.selectedSort];if(!(i!=null&&i.handledBySearchService))return null;const e=new URL(window.location.href).searchParams.get("sort"),t=i.searchServiceKey??(e==null?void 0:e.replace(/^-/,""));return this.sortDirection||(this.sortDirection="asc"),t?{field:t,direction:this.sortDirection}:null}get defaultSortParam(){const i=this.defaultSortDirection??"asc",e=Ie[this.defaultSortField].searchServiceKey;return e?{field:e,direction:i}:null}displayModeChanged(i){var e;this.displayMode=i.detail.displayMode,this.displayMode&&((e=this.analyticsHandler)==null||e.sendEvent({category:this.searchContext,action:de.displayMode,label:this.displayMode}))}get titleQuery(){return this.selectedTitleFilter?`firstTitle:${this.selectedTitleFilter}`:void 0}get creatorQuery(){return this.selectedCreatorFilter?`firstCreator:${this.selectedCreatorFilter}`:void 0}sendFilterByTitleAnalytics(i){var t;if(!i&&!this.selectedTitleFilter)return;const e=i&&!this.selectedTitleFilter;(t=this.analyticsHandler)==null||t.sendEvent({category:this.searchContext,action:de.filterByTitle,label:e?`clear-${i}`:`${i||"start"}-${this.selectedTitleFilter}`})}sendFilterByCreatorAnalytics(i){var t;if(!i&&!this.selectedCreatorFilter)return;const e=i&&!this.selectedCreatorFilter;(t=this.analyticsHandler)==null||t.sendEvent({category:this.searchContext,action:de.filterByCreator,label:e?`clear-${i}`:`${i||"start"}-${this.selectedCreatorFilter}`})}titleLetterSelected(i){this.selectedCreatorFilter=null,this.selectedTitleFilter=i.detail.selectedLetter}creatorLetterSelected(i){this.selectedTitleFilter=null,this.selectedCreatorFilter=i.detail.selectedLetter}get mobileFacetsTemplate(){return Un.includes(this.profileElement)?b:m`
      <details id="mobile-filter-collapse" @toggle=${e=>{var s;const t=e.target;this.isResizeToMobile=!1,this.collapsibleFacetsVisible=t.open,(s=this.analyticsHandler)==null||s.sendEvent({category:this.searchContext,action:de.mobileFacetsToggled,label:t.open?"open":"closed"})}}>
        <summary>
    ...
    `}get facetsTemplate(){if(Un.includes(this.profileElement))return b;if(this.facetLoadStrategy==="off")return m`
      ...
      `;const i=this.isTVCollection||!this.withinCollection&&this.searchType===I.TV,e=i?Uu:f1,t=m`
      <collection-facets
        .collectionPagePath=${this.collectionPagePath}
    ...
    `}scrollThresholdReached(){!this.dataSource.endOfDataReached&&this.dataSource.queryInitialized&&(this.pagesToRender+=1,this.dataSource.fetchPage(this.pagesToRender))}fetchManageableSearchResults(){var t;const i=!this.dataSource.totalResults,e=!this.searchResultsLoading&&this.dataSource.totalResults>100;this.pageContext==="search"&&(i||e)&&(this.dataSource.resetPages(),this.dataSource.fetchPage(1,this.maxPagesToManage),(t=this.infiniteScroller)==null||t.reload())}static get styles(){return[yt,w`
      ...
      `]}};k([u({type:String})],T.prototype,"baseNavigationUrl",2);k([u({type:String})],T.prototype,"baseImageUrl",2);k([u({type:Object})],T.prototype,"searchService",2);k([u({type:Number})],T.prototype,"searchType",2);k([u({type:String})],T.prototype,"withinCollection",2);k([u({type:String})],T.prototype,"withinProfile",2);k([u({type:String})],T.prototype,"profileElement",2);k([u({type:String})],T.prototype,"baseQuery",2);k([u({type:Array})],T.prototype,"identifiers",2);k([u({type:String})],T.prototype,"displayMode",2);k([u({type:String})],T.prototype,"selectedSort",2);k([u({type:String})],T.prototype,"selectedTitleFilter",2);k([u({type:String})],T.prototype,"selectedCreatorFilter",2);k([u({type:String})],T.prototype,"sortDirection",2);k([u({type:String})],T.prototype,"defaultSortField",2);k([u({type:String})],T.prototype,"defaultSortDirection",2);k([u({type:Number})],T.prototype,"pageSize",2);k([u({type:Number})],T.prototype,"currentPage",2);k([u({type:String})],T.prototype,"minSelectedDate",2);k([u({type:String})],T.prototype,"maxSelectedDate",2);k([u({type:Object})],T.prototype,"selectedFacets",2);k([u({type:Object})],T.prototype,"internalFilters",2);k([u({type:Boolean})],T.prototype,"showSmartFacetBar",2);k([u({type:String})],T.prototype,"smartFacetBarLabel",2);k([u({type:Boolean})],T.prototype,"showHistogramDatePicker",2);k([u({type:Boolean})],T.prototype,"suppressPlaceholders",2);k([u({type:Boolean})],T.prototype,"suppressResultCount",2);k([u({type:Boolean})],T.prototype,"suppressResultTiles",2);k([u({type:Boolean})],T.prototype,"suppressURLQuery",2);k([u({type:Boolean})],T.prototype,"suppressURLSinParam",2);k([u({type:Boolean})],T.prototype,"suppressSortBar",2);k([u({type:Boolean})],T.prototype,"suppressDisplayModes",2);k([u({type:Boolean})],T.prototype,"suppressMediatypeFacets",2);k([u({type:String})],T.prototype,"facetLoadStrategy",2);k([u({type:Boolean,reflect:!0})],T.prototype,"facetPaneVisible",2);k([u({type:Boolean})],T.prototype,"clearResultsOnEmptyQuery",2);k([u({type:String})],T.prototype,"collectionPagePath",2);k([u({type:String,reflect:!0})],T.prototype,"searchContext",2);k([u({type:String})],T.prototype,"pageContext",2);k([u({type:Object})],T.prototype,"restorationStateHandler",2);k([u({type:Number})],T.prototype,"mobileBreakpoint",2);k([u({type:Boolean})],T.prototype,"loggedIn",2);k([u({type:Object})],T.prototype,"resizeObserver",2);k([u({type:Object})],T.prototype,"modalManager",2);k([u({type:Object})],T.prototype,"featureFeedbackService",2);k([u({type:Object})],T.prototype,"recaptchaManager",2);k([u({type:Boolean})],T.prototype,"isTVCollection",2);k([u({type:Boolean})],T.prototype,"isManageView",2);k([u({type:String})],T.prototype,"manageViewLabel",2);k([u({type:Boolean})],T.prototype,"enableSortOptionsSlot",2);k([u({type:Boolean,reflect:!0})],T.prototype,"showSmartResults",2);k([u({type:Number})],T.prototype,"maxPagesToManage",2);k([u({type:Object})],T.prototype,"dataSource",2);k([R()],T.prototype,"pagesToRender",2);k([R()],T.prototype,"searchResultsLoading",2);k([R()],T.prototype,"facetsLoading",2);k([R()],T.prototype,"totalResults",2);k([R()],T.prototype,"mobileView",2);k([R()],T.prototype,"tileBlurOverrideState",2);k([R()],T.prototype,"collapsibleFacetsVisible",2);k([R()],T.prototype,"contentWidth",2);k([R()],T.prototype,"placeholderType",2);k([R()],T.prototype,"selectedTVNetwork",2);k([R()],T.prototype,"selectedTVShow",2);k([R()],T.prototype,"tvMapsPopulated",2);k([R()],T.prototype,"tvMapsLoading",2);k([R()],T.prototype,"tvMapsErrored",2);k([Q("#content-container")],T.prototype,"contentContainer",2);k([Q("#left-column")],T.prototype,"leftColumn",2);k([Q("collection-facets")],T.prototype,"collectionFacets",2);k([Q("manage-bar")],T.prototype,"manageBar",2);k([Q("smart-facet-bar")],T.prototype,"smartFacetBar",2);k([Q("#tv-networks")],T.prototype,"tvNetworksDropdown",2);k([Q("#tv-shows")],T.prototype,"tvShowsDropdown",2);k([u({type:Object,attribute:!1})],T.prototype,"analyticsHandler",2);k([Q("infinite-scroller")],T.prototype,"infiniteScroller",2);T=k([N("collection-browser")],T);var h6=Object.defineProperty,p6=Object.getOwnPropertyDescriptor,_e=(i,e,t,s)=>{for(var r=s>1?void 0:s?p6(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&h6(e,t,r),r};let ge=class extends H{constructor(){super(...arguments),this.searchService=this.initSearchServiceFromUrlParams(),this.resizeObserver=new J0,this.toggleSlots=!1,this.cellWidth=18,this.cellHeight=29,this.rowGap=1.7,this.colGap=1.7,this.suppressFacets=!1,this.lazyLoadFacets=!1,this.loggedIn=!1,this.searchType=I.METADATA,this.analyticsManager=new Yp,this.analyticsHandler={sendPing:this.sendAnalytics.bind(this),sendEvent:this.sendAnalytics.bind(this),sendEventNoSampling:this.sendAnalytics.bind(this)}}sendAnalytics(i){var e;console.log("Analytics Received ----",i),this.latestAction=i,(e=this.analyticsManager)==null||e.sendEvent(i)}initSearchServiceFromUrlParams(){const i=new URL(window.location.href).searchParams;return new ps({includeCredentials:!1,baseUrl:i.get("search_base_url")??void 0,servicePath:i.get("search_service_path")??void 0,debuggingEnabled:!!i.get("debugging")})}searchPressed(i){i.preventDefault(),this.searchQuery=this.baseQueryField.value,this.collectionBrowser.searchType=this.searchType,this.goToCurrentPage()}collectionChanged(i){i.preventDefault(),this.withinCollection=this.baseCollectionField.value,this.collectionBrowser.withinCollection=this.withinCollection,this.goToCurrentPage()}goToCurrentPage(){const i=this.currentPage??1;i>1&&this.collectionBrowser.goToPage(i)}changePagePressed(i){i.preventDefault(),this.currentPage=this.pageNumberInput.valueAsNumber,this.collectionBrowser.goToPage(this.currentPage)}updated(i){i.has("currentPage")&&this.currentPage&&(this.pageNumberInput.value=this.currentPage.toString()),i.has("searchQuery")&&this.queryUpdated()}queryUpdated(){this.collectionBrowser.baseQuery=this.searchQuery}get getClass(){return new URLSearchParams(window.location.search).get("hide-dev-tools")?"hidden":""}render(){return m`
  ...
  `;_e([R()],ge.prototype,"toggleSlots",2);_e([R()],ge.prototype,"currentPage",2);_e([R()],ge.prototype,"searchQuery",2);_e([R()],ge.prototype,"withinCollection",2);_e([R()],ge.prototype,"cellWidth",2);_e([R()],ge.prototype,"cellHeight",2);_e([R()],ge.prototype,"rowGap",2);_e([R()],ge.prototype,"colGap",2);_e([R()],ge.prototype,"suppressFacets",2);_e([R()],ge.prototype,"lazyLoadFacets",2);_e([R()],ge.prototype,"loggedIn",2);_e([R()],ge.prototype,"searchType",2);_e([u({type:Object,reflect:!1})],ge.prototype,"latestAction",2);_e([Q("#base-query-field")],ge.prototype,"baseQueryField",2);_e([Q("#base-collection-field")],ge.prototype,"baseCollectionField",2);_e([Q("#page-number-input")],ge.prototype,"pageNumberInput",2);_e([Q("collection-browser")],ge.prototype,"collectionBrowser",2);_e([Q("modal-manager")],ge.prototype,"modalManager",2);ge=_e([N("app-root")],ge);
