...
fill=""></path>
  ...
  `;wi([h({type:String})],Lt.prototype,"selectedLetter",2);wi([h({type:Object})],Lt.prototype,"letterCounts",2);wi([h({type:String})],Lt.prototype,"ariaLandmarkLabel",2);wi([R()],Lt.prototype,"tooltipShown",2);wi([R()],Lt.prototype,"hoveredLetter",2);wi([J("alpha-bar-tooltip")],Lt.prototype,"tooltip",2);Lt=wi([U("alpha-bar")],Lt);const hu=p`
...
`;let de=class extends lt{constructor(){super(...arguments),this.prompt="Do you find this feature useful?",this.buttonText="Beta",this.displayMode="button",this.isOpen=!1,this.processing=!1,this.popupTopX=0,this.popupTopY=0,this.voteSubmitted=!1,this.voteNeedsChoosing=!1,this.resizingElement=document.body}render(){return P`
    ...
    `}};d([T({type:String})],de.prototype,"featureIdentifier",void 0);d([T({type:String})],de.prototype,"prompt",void 0);d([T({type:String})],de.prototype,"buttonText",void 0);d([T({type:String})],de.prototype,"displayMode",void 0);d([T({type:Object})],de.prototype,"recaptchaManager",void 0);d([T({type:Object})],de.prototype,"resizeObserver",void 0);d([T({type:Boolean})],de.prototype,"disabled",void 0);d([T({type:Object})],de.prototype,"featureFeedbackService",void 0);d([$e()],de.prototype,"isOpen",void 0);d([$e()],de.prototype,"processing",void 0);d([$e()],de.prototype,"popupTopX",void 0);d([$e()],de.prototype,"popupTopY",void 0);d([$e()],de.prototype,"vote",void 0);d([$e()],de.prototype,"voteSubmitted",void 0);d([$e()],de.prototype,"error",void 0);d([$e()],de.prototype,"voteNeedsChoosing",void 0);d([$e()],de.prototype,"recaptchaWidget",void 0);d([Ne("#container")],de.prototype,"container",void 0);d([Ne("#popup")],de.prototype,"popup",void 0);d([Ne("#comments")],de.prototype,"comments",void 0);de=d([Je("feature-feedback")],de);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;var E3=Object.defineProperty,A3=Object.getOwnPropertyDescriptor,Qs=(i,e,t,s)=>{for(var r=s>1?void 0:s?A3(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&E3(e,t,r),r};let Yi=class extends H{constructor(){super(...arguments),this.step=2,this.currentPage=1,this.pages=[]}firstUpdated(){this.observePageCount()}updated(i){i.has("size")&&this.observePageCount(),i.has("currentPage")&&(this.observePageCount(),this.emitPageClick())}observePageCount(){this.pages=[];const i=7,e=this.size<=i;if(this.size<=5){this.pages=[...Array(this.size).keys()].map(r=>r+1);return}if(this.size===i){if(this.currentPage===2){this.pages=[1,2,3,4,0,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,4,5,this.size-1,this.size];return}}if(this.currentPage===1){this.pages=[1,2,3,0,this.size];return}if(this.currentPage===this.size){this.pages=[1,0,this.size-2,this.size-1,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,this.size-3,this.size-2,this.size-1,this.size];return}if(e&&this.currentPage>1&&this.currentPage<i){this.pages=[...Array(this.size).keys()].map(r=>r+1);return}let t=this.currentPage-this.step,s=this.currentPage+this.step;t<=0&&(s+=-t+1,t=1),s>=this.size&&(t=Math.max(t-(s-this.size),1),s=this.size),t===2&&(s-=1),s===this.size-1&&(t+=1),this.createFirstNode(t),this.createMiddelNode(t,s),this.createLastNode(s)}createFirstNode(i){var e,t;i>1&&((e=this.pages)==null||e.push(1)),i>2&&((t=this.pages)==null||t.push(0))}createMiddelNode(i,e){var t;for(let s=i;s<=e;s+=1)(t=this.pages)==null||t.push(s)}createLastNode(i){var e,t;i<this.size-1&&((e=this.pages)==null||e.push(0)),i<this.size&&((t=this.pages)==null||t.push(this.size))}get getEllipsisTemplate(){return p`<i class="ellipses">...</i>`}emitPageClick(){this.dispatchEvent(new CustomEvent("pageNumberClicked",{detail:{page:this.currentPage},bubbles:!0,composed:!0}))}onRewind(){this.currentPage-=1,this.currentPage<1&&(this.currentPage=1)}onForward(){this.currentPage+=1,this.currentPage>this.size&&(this.currentPage=this.size)}onChange(i){this.currentPage=i}getPageTemplate(i){return p`
    ...
    `}sortFacetAggregation(i){this.sortedBy=i,this.dispatchEvent(new CustomEvent("sortedFacets",{detail:this.sortedBy}))}handleFilterInput(i){const e=i.target;this.filterText=e.value}pageNumberClicked(i){var e;this.pageNumber=i.detail.page,(e=this.analyticsHandler)==null||e.sendEvent({category:Pt.default,action:ce.moreFacetsPageChange,label:`${this.pageNumber}`}),this.dispatchEvent(new CustomEvent("pageChanged",{detail:this.pageNumber}))}get modalHeaderTemplate(){var t,s;const e=(this.sortedBy??Es[this.facetKey])===G.COUNT?"left":"right";return p`<span class="sr-only">${S("More facets for:")}</span>
      <span class="title">
    ...
    `}applySearchFacetsClicked(){var t,s;const i=nd(this.selectedFacets,this.unappliedFacetChanges),e=new CustomEvent("facetsChanged",{detail:i,bubbles:!0,composed:!0});this.dispatchEvent(e),this.unappliedFacetChanges=Mt(),this.filterText="",(t=this.modalManager)==null||t.closeModal(),(s=this.analyticsHandler)==null||s.sendEvent({category:Pt.default,action:`${ce.applyMoreFacetsModal}`,label:`${this.facetKey}`})}cancelClick(){var i,e;this.unappliedFacetChanges=Mt(),this.filterText="",(i=this.modalManager)==null||i.closeModal(),(e=this.analyticsHandler)==null||e.sendEvent({category:Pt.default,action:ce.closeMoreFacetsModal,label:`${this.facetKey}`})}static get styles(){const i=x`var(--primaryButtonBGColor, #194880)`;return[mt,x`
      ...
      `]}};he([h({type:String})],ne.prototype,"facetKey",2);he([h({type:String})],ne.prototype,"query",2);he([h({type:Array})],ne.prototype,"identifiers",2);he([h({type:Object})],ne.prototype,"filterMap",2);he([h({type:Number})],ne.prototype,"searchType",2);he([h({type:Object})],ne.prototype,"pageSpecifierParams",2);he([h({type:Object})],ne.prototype,"collectionTitles",2);he([h({type:Object})],ne.prototype,"tvChannelAliases",2);he([h({type:Number})],ne.prototype,"facetsPerPage",2);he([h({type:Boolean})],ne.prototype,"facetsLoading",2);he([h({type:Object})],ne.prototype,"selectedFacets",2);he([h({type:Number})],ne.prototype,"sortedBy",2);he([h({type:Boolean})],ne.prototype,"isTvSearch",2);he([h({type:Object})],ne.prototype,"modalManager",2);he([h({type:Object})],ne.prototype,"searchService",2);he([h({type:Object,attribute:!1})],ne.prototype,"analyticsHandler",2);he([R()],ne.prototype,"aggregations",2);he([R()],ne.prototype,"facetGroup",2);he([R()],ne.prototype,"unappliedFacetChanges",2);he([R()],ne.prototype,"filterText",2);he([R()],ne.prototype,"pageNumber",2);ne=he([U("more-facets-content")],ne);var F3=Object.getOwnPropertyDescriptor,B3=(i,e,t,s)=>{for(var r=s>1?void 0:s?F3(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=a(r)||r);return r};let xc=class extends H{render(){return p`
      <div id="row">
    ...
    `}searchMoreFacetsLink(i){if(!this.moreLinksVisible||i.key==="lending"||Object.keys(i.buckets).length<this.allowedFacetCount)return b;const e=Es[i.key];return p`<button
      class="more-link"
      @click=${()=>{var t;this.showMoreFacetsModal(i,e),(t=this.analyticsHandler)==null||t.sendEvent({category:Pt.default,action:ce.showMoreFacetsModal,label:i.key}),this.dispatchEvent(new CustomEvent("showMoreFacets",{detail:i.key}))}}
...
`;var K3=Object.defineProperty,X3=Object.getOwnPropertyDescriptor,io=(i,e,t,s)=>{for(var r=s>1?void 0:s?X3(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&K3(e,t,r),r};function Z3(i){return i&&i.charAt(0).toLocaleUpperCase()+i.slice(1)}let js=class extends H{constructor(){super(...arguments),this.selected=!1}render(){if(!this.facetInfo)return b;const i=this.facetInfo.facets.length===1,e=this.facetInfo.facets[0],t=Z3((this.labelPrefix?`${this.labelPrefix} `:"")+(this.facetInfo.label??e.displayText??e.bucketKey));if(!t)return b;const s=i&&e.facetType==="mediatype"?$d[e.bucketKey].icon:b;return p`
    ...
    `:b}get manageViewModalMsg(){const i=this.dataSource.checkedTileModels.length>1;switch(this.profileElement){case"uploads":return S(i?"Note: It may take a few minutes for these items to stop appearing in your uploads list.":"Note: It may take a few minutes for this item to stop appearing in your uploads list.");case"web_archives":return S(i?"Note: It may take a few minutes for these items to stop appearing in your web archives list.":"Note: It may take a few minutes for this item to stop appearing in your web archives list.");default:return""}}get manageBarTemplate(){return p`
      ...
      ></manage-bar>
    `}handleRemoveItems(){this.dispatchEvent(new CustomEvent("itemRemovalRequested",{detail:{items:this.dataSource.checkedTileModels.map(i=>{const e=(i==null?void 0:i.mediatype)==="search"?"search:":"",t=(i==null?void 0:i.identifier)??"";return`${e}${t}`})}}))}handleManageItems(){this.dispatchEvent(new CustomEvent("itemManagerRequested",{detail:{items:this.dataSource.checkedTileModels.map(i=>i!=null&&i.identifier?i.identifier:"")}}))}refreshSmartFacets(){var i;(i=this.smartFacetBar)==null||i.refresh()}showRemoveItemsProcessingModal(){var i;(i=this.manageBar)==null||i.showRemoveItemsProcessingModal()}showRemoveItemsErrorModal(){var i;(i=this.manageBar)==null||i.showRemoveItemsErrorModal()}removeCheckedTiles(){this.dataSource.removeCheckedTiles()}tileBlurCheckboxChanged(i){var t;const{checked:e}=i.target;this.tileBlurOverrideState=e?"on":"off",(t=this.infiniteScroller)==null||t.refreshAllVisibleCells()}get shouldSuppressTileBlurring(){if(this.tileBlurOverrideState!=="no-override")return this.tileBlurOverrideState==="off";const{sessionContext:i}=this.dataSource,e=i==null?void 0:i.pps_relevant_user_preferences;return(e==null?void 0:e.display__blur_moderated_content)==="off"}userChangedSort(i){const{selectedSort:e,sortDirection:t}=i.detail;this.selectedSort=e,this.sortDirection=t,(this.currentPage??1)>1&&this.goToPage(1),this.currentPage=1}sendSortByAnalytics(i){var t;const e=i&&!this.sortDirection;(t=this.analyticsHandler)==null||t.sendEvent({category:this.searchContext,action:ce.sortBy,label:`${this.selectedSort}${this.sortDirection||e?`-${this.sortDirection}`:""}`})}selectedSortChanged(){this.dataSource.updatePrefixFiltersForCurrentSort()}get sortParam(){const i=Le[this.selectedSort];if(!(i!=null&&i.handledBySearchService))return null;const e=new URL(window.location.href).searchParams.get("sort"),t=i.searchServiceKey??(e==null?void 0:e.replace(/^-/,""));return this.sortDirection||(this.sortDirection="asc"),t?{field:t,direction:this.sortDirection}:null}get defaultSortParam(){const i=this.defaultSortDirection??"asc",e=Le[this.defaultSortField].searchServiceKey;return e?{field:e,direction:i}:null}displayModeChanged(i){var e;this.displayMode=i.detail.displayMode,this.displayMode&&((e=this.analyticsHandler)==null||e.sendEvent({category:this.searchContext,action:ce.displayMode,label:this.displayMode}))}get titleQuery(){return this.selectedTitleFilter?`firstTitle:${this.selectedTitleFilter}`:void 0}get creatorQuery(){return this.selectedCreatorFilter?`firstCreator:${this.selectedCreatorFilter}`:void 0}sendFilterByTitleAnalytics(i){var t;if(!i&&!this.selectedTitleFilter)return;const e=i&&!this.selectedTitleFilter;(t=this.analyticsHandler)==null||t.sendEvent({category:this.searchContext,action:ce.filterByTitle,label:e?`clear-${i}`:`${i||"start"}-${this.selectedTitleFilter}`})}sendFilterByCreatorAnalytics(i){var t;if(!i&&!this.selectedCreatorFilter)return;const e=i&&!this.selectedCreatorFilter;(t=this.analyticsHandler)==null||t.sendEvent({category:this.searchContext,action:ce.filterByCreator,label:e?`clear-${i}`:`${i||"start"}-${this.selectedCreatorFilter}`})}titleLetterSelected(i){this.selectedCreatorFilter=null,this.selectedTitleFilter=i.detail.selectedLetter}creatorLetterSelected(i){this.selectedTitleFilter=null,this.selectedCreatorFilter=i.detail.selectedLetter}get mobileFacetsTemplate(){return Sa.includes(this.profileElement)?b:p`
      <details id="mobile-filter-collapse" @toggle=${e=>{var s;const t=e.target;this.isResizeToMobile=!1,this.collapsibleFacetsVisible=t.open,(s=this.analyticsHandler)==null||s.sendEvent({category:this.searchContext,action:ce.mobileFacetsToggled,label:t.open?"open":"closed"})}}>
        <summary>
