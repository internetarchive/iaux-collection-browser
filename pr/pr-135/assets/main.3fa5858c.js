 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ss=r=>ws(r)?xs(r.strings,r.values):r;/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let $s=new _s;$s.resolve();/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let Ke=Ss;const no=I`
...
`+se),ot&&(se=De(se,Be," "),se=De(se,He," ")),R&&ti?R.createHTML(se):se},e.setConfig=function(C){Ri(C),Di=!0},e.clearConfig=function(){ct=null,Di=!1},e.isValidAttribute=function(C,h,b){ct||Ri({});var _=We(C),H=We(h);return qa(_,H,b)},e.addHook=function(C,h){typeof h=="function"&&(he[C]=he[C]||[],Ut(he[C],h))},e.removeHook=function(C){if(he[C])return xr(he[C])},e.removeHooks=function(C){he[C]&&(he[C]=[])},e.removeAllHooks=function(){he={}},e}var Gt=co(),L;(function(r){r.relevance="relevance",r.alltimeview="alltimeview",r.weeklyview="weeklyview",r.title="title",r.datearchived="datearchived",r.date="date",r.datereviewed="datereviewed",r.dateadded="dateadded",r.creator="creator"})(L||(L={}));const Ye={relevance:"Relevance",alltimeview:"All-time Views",weeklyview:"Weekly Views",title:"Title",datearchived:"Date Archived",date:"Date Published",datereviewed:"Date Reviewed",dateadded:"Date Added",creator:"Creator"},Sn={relevance:null,alltimeview:"downloads",weeklyview:"week",title:"titleSorter",datearchived:"publicdate",date:"date",datereviewed:"reviewdate",dateadded:"addeddate",creator:"creatorSorter"},kr={week:L.weeklyview,downloads:L.alltimeview,titleSorter:L.title,date:L.date,publicdate:L.datearchived,reviewdate:L.datereviewed,addeddate:L.dateadded,creatorSorter:L.creator},xi={subject:{},lending:{},mediatype:{},language:{},creator:{},collection:{},year:{}},_n=["mediatype","lending","year","subject","collection","creator","language"],Si={subject:"Subject",lending:"Availability",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"},$n={is_lendable:!0,is_borrowable:!1,available_to_borrow:!0,is_browsable:!1,available_to_browse:!1,is_readable:!0,available_to_waitlist:!1},Tr={is_lendable:"Lending Library",available_to_borrow:"Borrow 14 Days",is_readable:"Always Available"},ho={deemphasize:!0,community:!0};function po(r){switch(r){case"date":return"Published";case"reviewdate":return"Reviewed";case"addeddate":return"Added";default:return"Archived"}}function uo(r){return r?`Archivist since ${r.getFullYear()}`:""}let ye=class extends F{constructor(){super(...arguments),this.sortParam=null,this.collectionLinks=[],this.loggedIn=!1}updated(e){e.has("model")&&this.fetchCollectionNames()}async fetchCollectionNames(){var e,t;if(!(!((e=this.model)===null||e===void 0)&&e.collections)||this.model.collections.length===0||!this.collectionNameCache)return;this.collectionLinks=[];const i=[],a=[];for(const o of this.model.collections)ho[o]||a.push((t=this.collectionNameCache)===null||t===void 0?void 0:t.collectionNameFor(o).then(s=>{i.push(this.detailsLink(o,s!=null?s:o))}));await Promise.all(a),this.collectionLinks=i}render(){return m`
    ...
    `}};zr=n([N("collection-browser-loading-tile")],zr);let _i=class extends F{constructor(){super(...arguments),this.selectedLetter=null,this.alphabet="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("")}get selectedUppercaseLetter(){var e;return(e=this.selectedLetter)===null||e===void 0?void 0:e.toUpperCase()}render(){return m`
      <div id="container">
        <ul>
      ...
      <div class="modal-wrapper">
        <div class="modal-container">
          <header style="background-color: ${this.config.headerColor}">
            ...
            ${this.config.showHeaderLogo?m`<div class="logo-icon">${Cl}</div>`:S}
