 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function us(r){return ro({descriptor:e=>({get(){var t,i;return(i=(t=this.renderRoot)===null||t===void 0?void 0:t.querySelectorAll(r))!==null&&i!==void 0?i:[]},enumerable:!0,configurable:!0})})}/**
 * @license
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const{H:vs}=cs,fs=r=>r.strings===void 0,fr=()=>document.createComment(""),Gt=(r,e,t)=>{var i;const a=r._$AA.parentNode,o=e===void 0?r._$AB:e._$AA;if(t===void 0){const n=a.insertBefore(fr(),o),l=a.insertBefore(fr(),o);t=new vs(n,l,r,r.options)}else{const n=t._$AB.nextSibling,l=t._$AM,d=l!==r;if(d){let c;(i=t._$AQ)===null||i===void 0||i.call(t,r),t._$AM=r,t._$AP!==void 0&&(c=r._$AU)!==l._$AU&&t._$AP(c)}if(n!==o||d){let c=t._$AA;for(;c!==n;){const p=c.nextSibling;a.insertBefore(c,o),c=p}}}return t},Ye=(r,e,t=r)=>(r._$AI(e,t),r),gs={},oo=(r,e=gs)=>r._$AH=e,ys=r=>r._$AH,ea=r=>{var e;(e=r._$AP)===null||e===void 0||e.call(r,!1,!0);let t=r._$AA;const i=r._$AB.nextSibling;for(;t!==i;){const a=t.nextSibling;t.remove(),t=a}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`+le),ct&&(le=Le(le,He," "),le=Le(le,Ue," ")),B&&si?B.createHTML(le):le},e.setConfig=function(C){ji(C),Ii=!0},e.clearConfig=function(){vt=null,Ii=!1},e.isValidAttribute=function(C,h,b){vt||ji({});var S=Ge(C),H=Ge(h);return Za(S,H,b)},e.addHook=function(C,h){typeof h=="function"&&(ue[C]=ue[C]||[],Qt(ue[C],h))},e.removeHook=function(C){if(ue[C])return xr(ue[C])},e.removeHooks=function(C){ue[C]&&(ue[C]=[])},e.removeAllHooks=function(){ue={}},e}var Zt=co(),L;(function(r){r.relevance="relevance",r.alltimeview="alltimeview",r.weeklyview="weeklyview",r.title="title",r.datearchived="datearchived",r.date="date",r.datereviewed="datereviewed",r.dateadded="dateadded",r.creator="creator"})(L||(L={}));const qe={relevance:"Relevance",alltimeview:"All-time Views",weeklyview:"Weekly Views",title:"Title",datearchived:"Date Archived",date:"Date Published",datereviewed:"Date Reviewed",dateadded:"Date Added",creator:"Creator"},_n={relevance:null,alltimeview:"downloads",weeklyview:"week",title:"titleSorter",datearchived:"publicdate",date:"date",datereviewed:"reviewdate",dateadded:"addeddate",creator:"creatorSorter"},kr={week:L.weeklyview,downloads:L.alltimeview,titleSorter:L.title,date:L.date,publicdate:L.datearchived,reviewdate:L.datereviewed,addeddate:L.dateadded,creatorSorter:L.creator},Ti={subject:{},lending:{},mediatype:{},language:{},creator:{},collection:{},year:{}},Sn=["mediatype","lending","year","subject","collection","creator","language"],zi={subject:"Subject",lending:"Availability",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"},$n={is_lendable:!0,is_borrowable:!1,available_to_borrow:!0,is_browsable:!1,available_to_browse:!1,is_readable:!0,available_to_waitlist:!1},Tr={is_lendable:"Lending Library",available_to_borrow:"Borrow 14 Days",is_readable:"Always Available"},ho={deemphasize:!0,community:!0,stream_only:!0,samples_only:!0,test_collection:!0,printdisabled:!0,"openlibrary-ol":!0,nationalemergencylibrary:!0,china:!0,americana:!0,toronto:!0};function uo(r){switch(r){case"date":return"Published";case"reviewdate":return"Reviewed";case"addeddate":return"Added";default:return"Archived"}}function po(r){return r?`Archivist since ${r.getFullYear()}`:""}let ye=class extends O{constructor(){super(...arguments),this.sortParam=null,this.collectionLinks=[],this.loggedIn=!1}updated(e){e.has("model")&&this.fetchCollectionNames()}async fetchCollectionNames(){var e,t;if(!(!((e=this.model)===null||e===void 0)&&e.collections)||this.model.collections.length===0||!this.collectionNameCache)return;this.collectionLinks=[];const i=[],a=[];for(const o of this.model.collections)ho[o]||a.push((t=this.collectionNameCache)===null||t===void 0?void 0:t.collectionNameFor(o).then(n=>{i.push(this.detailsLink(o,n!=null?n:o))}));await Promise.all(a),this.collectionLinks=i}render(){return m`
    ...
    `}};zr=s([R("collection-browser-loading-tile")],zr);let Mi=class extends O{constructor(){super(...arguments),this.selectedLetter=null,this.alphabet="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("")}get selectedUppercaseLetter(){var e;return(e=this.selectedLetter)===null||e===void 0?void 0:e.toUpperCase()}render(){return m`
      <div id="container">
        <ul>
