...
`,pn={account:{color:"#000000",icon:en,text:"Account"},audio:{color:"#00adef",icon:tn,text:"Audio"},collection:{color:"#4666ff",icon:gs,text:"Collection"},data:{color:"#333333",icon:on,text:"Data"},etree:{color:"#00adef",icon:rn,text:"E-tree"},film:{color:"#bf1b2c",icon:da,text:"Film"},image:{color:"#aa99c9",icon:an,text:"Image"},movies:{color:"#f1644b",icon:da,text:"Movie"},radio:{color:"#8fdaef",icon:sn,text:"Radio"},software:{color:"#9ecc4f",icon:ln,text:"Software"},texts:{color:"#faab3c",icon:nn,text:"Text"},tv:{color:"#f1644b",icon:dn,text:"TV"},video:{color:"#f1644b",icon:cn,text:"Video"},web:{color:"#ffcd27",icon:hn,text:"Web"},search:{color:"#000000",icon:xs,text:"Search"}};let ci=class extends R{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var e,t;const i=["tvnews","tvarchive","television"],o=["radio","radioprogram"];return this.mediatype==="movies"&&((e=this.collections)===null||e===void 0?void 0:e.some(a=>i.indexOf(a)>=0))?"tv":this.mediatype==="audio"&&((t=this.collections)===null||t===void 0?void 0:t.some(a=>o.indexOf(a)>=0))?"radio":this.mediatype||""}render(){const e=pn[this.displayMediatype];return e?c`
    ...
    `}};l([h({type:String})],ci.prototype,"mediatype",void 0);l([h({type:Array})],ci.prototype,"collections",void 0);l([h({type:Boolean})],ci.prototype,"showText",void 0);ci=l([L("mediatype-icon")],ci);const un=I`
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path
...
`;function mn(r,e){let t=1;return r>=1e9?t=1e9:r>=1e6?t=1e6:r>=1e3&&e==="short"&&(t=1e3),t}function gn(r=0,e){const t=r/e,i=t<10;let o=0;return i?o=Math.round((t+Number.EPSILON)*10)/10:o=Math.round(t),o}function bn(r,e,t,i){switch(e){case 1e9:return P(t==="short"?nt`${r}B`:nt`${r} billion`);case 1e6:return P(t==="short"?nt`${r}M`:nt`${r} million`);case 1e3:return P(t==="short"?nt`${r}K`:nt`${r} thousand`);default:return new Intl.NumberFormat(i).format(r)}}function oi(r,e="long",t="short",i="en-US"){const o=r!=null?r:-1;if(o<0)return"";const a=mn(o,e),s=gn(o,a);return bn(s,a,t,i)}let Xe=class extends R{render(){var e,t,i,o,a;const s=oi(this.favCount,"short","short"),n=oi(this.commentCount,"short","short"),d=this.mediatype==="account"?`${(e=this.itemCount)!==null&&e!==void 0?e:0} uploads`:`${(t=this.viewCount)!==null&&t!==void 0?t:0} ${(i=this.viewLabel)!==null&&i!==void 0?i:"all-time views"}`;return c`
...
fill=""></path>
  ...
  `;ar=l([Ls("ia-icon-label")],ar);let sr=class extends R{constructor(){super(...arguments),this.numResults=0}render(){return c`
...
`;let nr=class extends R{constructor(){super(...arguments),this.config=new lr}render(){return c`
    ...
    `}};l([h({type:String,reflect:!0})],Ft.prototype,"mode",void 0);l([h({type:Object})],Ft.prototype,"customModalContent",void 0);l([h({type:Object})],Ft.prototype,"hostBridge",void 0);l([X("modal-template")],Ft.prototype,"modalTemplate",void 0);Ft=l([L("modal-manager")],Ft);var ec=c`
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path
...
`;let It=class extends R{constructor(){super(...arguments),this.step=2,this.currentPage=1,this.pages=[]}firstUpdated(){this.observePageCount()}updated(e){e.has("size")&&this.observePageCount(),e.has("currentPage")&&(this.observePageCount(),this.emitPageClick())}observePageCount(){this.pages=[];const e=7,t=this.size<=e;if(this.size<=5){this.pages=[...Array(this.size).keys()].map(a=>a+1);return}if(this.size===e){if(this.currentPage===2){this.pages=[1,2,3,4,0,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,4,5,this.size-1,this.size];return}}if(this.currentPage===1){this.pages=[1,2,3,0,this.size];return}if(this.currentPage===this.size){this.pages=[1,0,this.size-2,this.size-1,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,this.size-3,this.size-2,this.size-1,this.size];return}if(t&&this.currentPage>1&&this.currentPage<e){this.pages=[...Array(this.size).keys()].map(a=>a+1);return}let i=this.currentPage-this.step,o=this.currentPage+this.step;i<=0&&(o+=-i+1,i=1),o>=this.size&&(i=Math.max(i-(o-this.size),1),o=this.size),i===2&&(o-=1),o===this.size-1&&(i+=1),this.createFirstNode(i),this.createMiddelNode(i,o),this.createLastNode(o)}createFirstNode(e){var t,i;e>1&&((t=this.pages)===null||t===void 0||t.push(1)),e>2&&((i=this.pages)===null||i===void 0||i.push(0))}createMiddelNode(e,t){var i;for(let o=e;o<=t;o+=1)(i=this.pages)===null||i===void 0||i.push(o)}createLastNode(e){var t,i;e<this.size-1&&((t=this.pages)===null||t===void 0||t.push(0)),e<this.size&&((i=this.pages)===null||i===void 0||i.push(this.size))}get getEllipsisTemplate(){return c`<i class="ellipses">...</i>`}emitPageClick(){this.dispatchEvent(new CustomEvent("pageNumberClicked",{detail:{page:this.currentPage},bubbles:!0,composed:!0}))}onRewind(){this.currentPage-=1,this.currentPage<1&&(this.currentPage=1)}onForward(){this.currentPage+=1,this.currentPage>this.size&&(this.currentPage=this.size)}onChange(e){this.currentPage=e}getPageTemplate(e){return c`
    ...
    `}static get styles(){return[We,g`
      ...
      `]}};l([h({type:Number})],It.prototype,"size",void 0);l([h({type:Number})],It.prototype,"step",void 0);l([h({type:Number})],It.prototype,"currentPage",void 0);l([z()],It.prototype,"pages",void 0);It=l([L("more-facets-pagination")],It);var oc=I`
...
`,dr;let Nt=dr=class extends R{render(){return c`${this.facetRowTemplate}`}get facetRowTemplate(){var e,t,i,o;const{bucket:a,facetType:s}=this;if(!a||!s)return y;const n=`${s}:${a.key}-show-only`,d=`${s}:${a.key}-negative`,p=s!=="collection"?c`${(e=a.displayText)!==null&&e!==void 0?e:a.key}`:c`<a href="/details/${a.key}">
    ...
    `}applySearchFacetsClicked(){var e,t;const i=new CustomEvent("facetsChanged",{detail:this.selectedFacets,bubbles:!0,composed:!0});this.dispatchEvent(i),(e=this.modalManager)===null||e===void 0||e.closeModal(),(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:De.default,action:`${se.applyMoreFacetsModal}`,label:`${this.facetKey}`})}cancelClick(){var e,t;(e=this.modalManager)===null||e===void 0||e.closeModal(),(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:De.default,action:se.closeMoreFacetsModal,label:`${this.facetKey}`})}static get styles(){const e=g`var(--primaryButtonBGColor, #194880)`;return[We,g`
      ...
      `]}};l([h({type:String})],re.prototype,"facetKey",void 0);l([h({type:String})],re.prototype,"facetAggregationKey",void 0);l([h({type:String})],re.prototype,"query",void 0);l([h({type:Object})],re.prototype,"filterMap",void 0);l([h({type:Object})],re.prototype,"modalManager",void 0);l([h({type:Object})],re.prototype,"searchService",void 0);l([h({type:String})],re.prototype,"searchType",void 0);l([h({type:String})],re.prototype,"withinCollection",void 0);l([h({type:Object})],re.prototype,"collectionTitles",void 0);l([h({type:Object})],re.prototype,"selectedFacets",void 0);l([h({type:String})],re.prototype,"sortedBy",void 0);l([h({type:Object,attribute:!1})],re.prototype,"analyticsHandler",void 0);l([z()],re.prototype,"aggregations",void 0);l([z()],re.prototype,"facetGroup",void 0);l([z()],re.prototype,"facetGroupTitle",void 0);l([z()],re.prototype,"pageNumber",void 0);l([z()],re.prototype,"facetsLoading",void 0);l([z()],re.prototype,"paginationSize",void 0);l([z()],re.prototype,"facetsType",void 0);re=l([L("more-facets-content")],re);let Wa=class extends R{render(){return c`
      <div id="row">
    ...
    `}};Wa=l([L("facet-tombstone-row")],Wa);let Oe=class extends R{constructor(){super(...arguments),this.boundEscapeListener=e=>{e.key==="Escape"&&this.closeModal()}}render(){var e,t;return c`
      <div id="container">
    ...
    `}partOfCollectionClicked(e){var t;(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:De.default,action:se.partOfCollectionClicked,label:e.target.dataset.id})}showDatePickerModal(){var e,t,i;const{fullYearsHistogramAggregation:o}=this,a=o==null?void 0:o.first_bucket_key,s=o==null?void 0:o.last_bucket_key,n=o==null?void 0:o.buckets,p=c`
      <expanded-date-picker
        ${Ed(f=>{if(f&&f instanceof Oe){const m=f;m.minSelectedDate=this.minSelectedDate,m.maxSelectedDate=this.maxSelectedDate}})}
        .minDate=${a}
        .maxDate=${s}
