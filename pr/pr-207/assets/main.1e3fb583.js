 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function C(a){return c(ut(he({},a),{state:!0}))}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;let qt=class extends M{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1,this.isCompactTile=!1}render(){return h`<div class="icon-overlay ${this.getClass}">
      ${this.iconDisplay}
    </div>`}get getClass(){return this.isCompactTile?"list-compact":"list-detail"}get iconDisplay(){return this.loginRequired&&!this.loggedIn?h`${Qa}`:h`${Ga}`}static get styles(){return m`
      :host {
        position: absolute;
        top: 50%;
        left: 50%;
    ...
    `}get iconDisplay(){return this.loginRequired&&!this.loggedIn?h`${Qa}`:h`${Ga}`}get textDisplay(){return this.loginRequired&&!this.loggedIn?h`Log in to view this item`:h`Content may be inappropriate`}static get styles(){return m`
      :host {
        align-items: center;
        display: flex;
      }
    ...
    `}};s([c({type:Boolean})],Xt.prototype,"loggedIn",void 0);s([c({type:Boolean})],Xt.prototype,"loginRequired",void 0);s([c({type:Boolean})],Xt.prototype,"iconRequired",void 0);Xt=s([A("text-overlay")],Xt);let Oe=class extends M{constructor(){super(...arguments),this.isCompactTile=!1,this.isListTile=!1,this.loggedIn=!1,this.viewSize="desktop"}render(){var e;return!((e=this.model)===null||e===void 0)&&e.identifier?h`
    ...
    `}};s([c({type:String})],Oe.prototype,"baseImageUrl",void 0);s([c({type:Boolean})],Oe.prototype,"isCompactTile",void 0);s([c({type:Boolean})],Oe.prototype,"isListTile",void 0);s([c({type:Boolean})],Oe.prototype,"loggedIn",void 0);s([c({type:Object})],Oe.prototype,"model",void 0);s([c({type:String})],Oe.prototype,"viewSize",void 0);Oe=s([A("image-block")],Oe);let Yt=class extends M{constructor(){super(...arguments),this.showInfoButton=!1}render(){return h`
      <div class="container">
    ...
    >`}get getSizeTemplate(){var e,t;const i=(t=(e=this.model)===null||e===void 0?void 0:e.collectionSize)!==null&&t!==void 0?t:0;return i?h`<span id="item-size">${Jr(i,1)}</span>`:""}get infoButtonTemplate(){return this.showInfoButton?h`<button class="info-button" @click=${this.infoButtonPressed}>
        ...
        </button>`:w}infoButtonPressed(e){e.preventDefault();const t=new CustomEvent("infoButtonPressed",{detail:{x:e.clientX,y:e.clientY}});this.dispatchEvent(t)}static get styles(){const e=m`var(--tileBorderColor, #555555)`,t=m`var(--tileBackgroundColor, #666666)`,i=m`#fff`;return[xo,m`
        .container {
          background-color: ${t};
          border: 1px solid ${e};
        }
 ...
 */function*di(a,e){const t=typeof e=="function";if(a!==void 0){let i=-1;for(const o of a)i>-1&&(yield t?e(i):e),i++,yield o}}let yi=class extends M{constructor(){super(...arguments),this.snippets=[],this.viewSize="desktop"}render(){var e;return!((e=this.snippets)===null||e===void 0)&&e.length?h`
    ...
    `}};s([c({type:Array})],yi.prototype,"snippets",void 0);s([c({type:String})],yi.prototype,"viewSize",void 0);yi=s([A("text-snippet-block")],yi);const is=m`
  .drop-shadow {
    overflow: hidden;
    height: 100%;
  }
...
`,ms={account:{color:"#000000",icon:as,text:"Account"},audio:{color:"#00adef",icon:rs,text:"Audio"},collection:{color:"#4666ff",icon:Va,text:"Collection"},data:{color:"#333333",icon:ss,text:"Data"},etree:{color:"#00adef",icon:ns,text:"E-tree"},film:{color:"#bf1b2c",icon:ra,text:"Film"},image:{color:"#aa99c9",icon:ls,text:"Image"},movies:{color:"#f1644b",icon:ra,text:"Movie"},radio:{color:"#8fdaef",icon:ds,text:"Radio"},software:{color:"#9ecc4f",icon:cs,text:"Software"},texts:{color:"#faab3c",icon:hs,text:"Text"},tv:{color:"#f1644b",icon:ps,text:"TV"},video:{color:"#f1644b",icon:us,text:"Video"},web:{color:"#ffcd27",icon:vs,text:"Web"}};let Kt=class extends M{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var e,t;const i=["tvnews","tvarchive","television"],o=["radio","radioprogram"];return this.mediatype==="movies"&&((e=this.collections)===null||e===void 0?void 0:e.some(r=>i.indexOf(r)>=0))?"tv":this.mediatype==="audio"&&((t=this.collections)===null||t===void 0?void 0:t.some(r=>o.indexOf(r)>=0))?"radio":this.mediatype||""}render(){const e=ms[this.displayMediatype];return e?h`
    ...
    `}};s([c({type:String})],Kt.prototype,"mediatype",void 0);s([c({type:Array})],Kt.prototype,"collections",void 0);s([c({type:Boolean})],Kt.prototype,"showText",void 0);Kt=s([A("mediatype-icon")],Kt);const fs=P`
 ...
 */let mt=Ss;function Ts(a,e){let t=1;return a>=1e9?t=1e9:a>=1e6?t=1e6:a>=1e3&&e==="short"&&(t=1e3),t}function ks(a=0,e){const t=a/e,i=t<10;let o=0;return i?o=Math.round((t+Number.EPSILON)*10)/10:o=Math.round(t),o}function zs(a,e,t,i){switch(e){case 1e9:return mt(t==="short"?vt`${a}B`:vt`${a} billion`);case 1e6:return mt(t==="short"?vt`${a}M`:vt`${a} million`);case 1e3:return mt(t==="short"?vt`${a}K`:vt`${a} thousand`);default:return new Intl.NumberFormat(i).format(a)}}function Ut(a,e="long",t="short",i="en-US"){const o=a!=null?a:-1;if(o<0)return"";const r=Ts(o,e),n=ks(o,r);return zs(n,r,t,i)}let tt=class extends M{render(){const e=Ut(this.favCount,"short","short"),t=Ut(this.commentCount,"short","short"),i=this.mediatype==="account"?`${this.itemCount} uploads`:`${this.viewCount} all-time views`;return h`
    ...
    `}get doesSortedByDate(){var e;return["date","reviewdate","addeddate","publicdate"].includes((e=this.sortParam)===null||e===void 0?void 0:e.field)}get hasSnippets(){var e,t;return!!(!((t=(e=this.model)===null||e===void 0?void 0:e.snippets)===null||t===void 0)&&t.length)}infoButtonPressed(e){e.preventDefault();const t=new CustomEvent("infoButtonPressed",{detail:{x:e.clientX,y:e.clientY}});this.dispatchEvent(t)}static get styles(){const e=m`var(--tileBorderColor, #dddddd)`;return[xo,m`
        .container {
          border: 1px solid ${e};
        }
    ...
    >
          ...
          &#9432;
          <span class="sr-only">More info</span>
        </button>`:w}infoButtonPressed(e){e.preventDefault();const t=new CustomEvent("infoButtonPressed",{detail:{x:e.clientX,y:e.clientY}});this.dispatchEvent(t)}static get styles(){const e=m`var(--tileBorderColor, #dddddd)`;return[xo,m`
        .container {
          border: 1px solid ${e};
        }
...
`+re),_e&&(re=Pe(re,Re," "),re=Pe(re,Ne," ")),Y&&ti?Y.createHTML(re):re},e.setConfig=function(S){Di(S),je=!0},e.clearConfig=function(){pt=null,je=!1},e.isValidAttribute=function(S,p,b){pt||Di({});var _=Ge(S),B=Ge(p);return Io(_,B,b)},e.addHook=function(S,p){typeof p=="function"&&(de[S]=de[S]||[],Nt(de[S],p))},e.removeHook=function(S){if(de[S])return na(de[S])},e.removeHooks=function(S){de[S]&&(de[S]=[])},e.removeAllHooks=function(){de={}},e}var Wt=Xa(),D;(function(a){a.relevance="relevance",a.alltimeview="alltimeview",a.weeklyview="weeklyview",a.title="title",a.date="date",a.datearchived="datearchived",a.datereviewed="datereviewed",a.dateadded="dateadded",a.creator="creator"})(D||(D={}));const Ye={relevance:"Relevance",alltimeview:"All-time views",weeklyview:"Weekly views",title:"Title",date:"Date published",datearchived:"Date archived",datereviewed:"Date reviewed",dateadded:"Date added",creator:"Creator"},an={relevance:null,alltimeview:"downloads",weeklyview:"week",title:"titleSorter",date:"date",datearchived:"publicdate",datereviewed:"reviewdate",dateadded:"addeddate",creator:"creatorSorter"},pa={week:D.weeklyview,downloads:D.alltimeview,titleSorter:D.title,date:D.date,publicdate:D.datearchived,reviewdate:D.datereviewed,addeddate:D.dateadded,creatorSorter:D.creator},rn={title:"firstTitle",creator:"firstCreator"},wi={subject:{},lending:{},mediatype:{},language:{},creator:{},collection:{},year:{}},sn=["mediatype","lending","year","subject","collection","creator","language"],xi={subject:"Subject",lending:"Availability",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"},nn={is_lendable:!0,is_borrowable:!1,available_to_borrow:!0,is_browsable:!1,available_to_browse:!1,is_readable:!0,available_to_waitlist:!1},ua={is_lendable:"Lending Library",available_to_borrow:"Borrow 14 Days",is_readable:"Always Available"},_o={deemphasize:!0,community:!0,stream_only:!0,samples_only:!0,test_collection:!0,printdisabled:!0,"openlibrary-ol":!0,nationalemergencylibrary:!0,china:!0,americana:!0,toronto:!0};function Ya(a){switch(a){case"publicdate":return"Archived";case"reviewdate":return"Reviewed";case"addeddate":return"Added";default:return"Published"}}function Ka(a){return a?`Archivist since ${a.getFullYear()}`:""}let me=class extends M{constructor(){super(...arguments),this.sortParam=null,this.collectionLinks=[],this.loggedIn=!1}render(){return h`
    ...
    `}};s([c({type:Object})],Be.prototype,"model",void 0);s([c({type:String})],Be.prototype,"baseNavigationUrl",void 0);s([c({type:String})],Be.prototype,"baseImageUrl",void 0);s([c({type:Boolean})],Be.prototype,"loggedIn",void 0);s([c({type:Object})],Be.prototype,"sortParam",void 0);s([c({type:Object})],Be.prototype,"collectionNameCache",void 0);Be=s([A("tile-hover-pane")],Be);let $e=class extends M{constructor(){super(...arguments),this.sortParam=null,this.loggedIn=!1}render(){var e,t,i,o,r,n,l,d,u;return h`
      <div id="list-line" class="${this.classSize}">
        <image-block
          .model=${this.model}
          .baseImageUrl=${this.baseImageUrl}
        ...
        <a href=${this.href} id="title"
          >${Wt.sanitize((t=(e=this.model)===null||e===void 0?void 0:e.title)!==null&&t!==void 0?t:"")}</a
        >
        <div id="creator">
    ...
    `}};s([c({type:Boolean,attribute:!0})],fe.prototype,"open",void 0);s([c({type:Boolean,attribute:!0})],fe.prototype,"displayCaret",void 0);s([c({type:Boolean,attribute:!0})],fe.prototype,"closeOnSelect",void 0);s([c({type:Boolean,attribute:!0})],fe.prototype,"openViaButton",void 0);s([c({type:Boolean,attribute:!0})],fe.prototype,"openViaCaret",void 0);s([c({type:Boolean,attribute:!0})],fe.prototype,"includeSelectedOption",void 0);s([c({type:String,attribute:!0})],fe.prototype,"selectedOption",void 0);s([c({type:Array})],fe.prototype,"options",void 0);s([c({type:String})],fe.prototype,"optionGroup",void 0);s([c({type:Function})],fe.prototype,"optionSelected",void 0);fe=s([A("ia-dropdown")],fe);let ho=class extends M{render(){return h`
  ...
  `;s([c({type:String})],Ie.prototype,"selectedLetter",void 0);s([c({type:Object})],Ie.prototype,"letterCounts",void 0);s([C()],Ie.prototype,"tooltipShown",void 0);s([C()],Ie.prototype,"hoveredLetter",void 0);s([K("alpha-bar-tooltip")],Ie.prototype,"tooltip",void 0);Ie=s([A("alpha-bar")],Ie);const fa=P`
    ...
    `}get desktopSortSelectorTemplate(){return h`
      ...
      >
        ...
        <ul id="desktop-sort-selector">
          <li>
            ${this.showRelevance?this.getSortDisplayOption(D.relevance):w}
          </li>
          <li>
            ${this.getSortDropdown({optionSelectedHandler:()=>{this.dateSortSelectorVisible=!1,this.alphaSelectorVisible=null,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.emitTitleLetterChangedEvent(),this.emitCreatorLetterChangedEvent()},clickHandler:()=>{!this.viewsDropdown.open&&!this.viewOptionSelected&&this.setSelectedSort(D.weeklyview),this.dateDropdown.open=!1,this.viewSortSelectorVisible=this.viewsDropdown.open,this.viewsDropdown.classList.toggle("open",this.viewsDropdown.open)},displayName:h`${this.viewSortField}`,id:"views-dropdown",isSelected:()=>this.viewOptionSelected,dropdownOptions:[this.getDropdownOption(D.weeklyview),this.getDropdownOption(D.alltimeview)],selectedOption:this.viewOptionSelected?this.selectedSort:""})}
          </li>
          <li>
          ...
          <li>
            ${this.getSortDropdown({optionSelectedHandler:()=>{this.viewSortSelectorVisible=!1,this.alphaSelectorVisible=null,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.emitTitleLetterChangedEvent(),this.emitCreatorLetterChangedEvent()},clickHandler:()=>{!this.dateDropdown.open&&!this.dateOptionSelected&&this.setSelectedSort(D.date),this.viewsDropdown.open=!1,this.dateSortSelectorVisible=this.dateDropdown.open,this.dateDropdown.classList.toggle("open",this.dateDropdown.open)},displayName:h`${this.dateSortField}`,id:"date-dropdown",isSelected:()=>this.dateOptionSelected,dropdownOptions:[this.getDropdownOption(D.date),this.getDropdownOption(D.datearchived),this.getDropdownOption(D.datereviewed),this.getDropdownOption(D.dateadded)],selectedOption:this.dateOptionSelected?this.selectedSort:""})}
          </li>
          <li>
 ...
 */const ga=Ci(class extends Ti{constructor(a){if(super(a),a.type!==Me.PROPERTY&&a.type!==Me.ATTRIBUTE&&a.type!==Me.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Yr(a))throw Error("`live` bindings can only contain a single expression")}render(a){return a}update(a,[e]){if(e===ve||e===w)return e;const t=a.element,i=a.name;if(a.type===Me.PROPERTY){if(e===t[i])return ve}else if(a.type===Me.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(i))return ve}else if(a.type===Me.ATTRIBUTE&&t.getAttribute(i)===e+"")return ve;return Wa(a),e}}),pn=Object.freeze({processing:"processing",complete:"complete"});class un extends M{static get properties(){return{mode:{type:String}}}constructor(){super(),this.mode=pn.processing}render(){return h`
    ...
    `,this._tooltipVisible=!0}hideTooltip(){this._tooltipContent=void 0,this._tooltipVisible=!1}validMinSliderX(e){const t=Math.min(this.translateDateToPosition(this.maxSelectedDate),this.histogramRightEdgeX);return e=this.clamp(e,this.histogramLeftEdgeX,t),Number.isNaN(e)||t<this.histogramLeftEdgeX?this.histogramLeftEdgeX:e}validMaxSliderX(e){const t=Math.max(this.histogramLeftEdgeX,this.translateDateToPosition(this.minSelectedDate));return e=this.clamp(e,t,this.histogramRightEdgeX),Number.isNaN(e)||t>this.histogramRightEdgeX?this.histogramRightEdgeX:e}addListeners(){window.addEventListener("pointermove",this.move),window.addEventListener("pointerup",this.drop),window.addEventListener("pointercancel",this.drop)}removeListeners(){window.removeEventListener("pointermove",this.move),window.removeEventListener("pointerup",this.drop),window.removeEventListener("pointercancel",this.drop)}beginEmitUpdateProcess(){this.cancelPendingUpdateEvent(),this._emitUpdatedEventTimer=setTimeout(()=>{if(this.currentDateRangeString===this._previousDateRange)return;this._previousDateRange=this.currentDateRangeString;const e={detail:{minDate:this.minSelectedDate,maxDate:this.maxSelectedDate},bubbles:!0,composed:!0};this.dispatchEvent(new CustomEvent("histogramDateRangeUpdated",e))},this.updateDelay)}cancelPendingUpdateEvent(){this._emitUpdatedEventTimer!==void 0&&(clearTimeout(this._emitUpdatedEventTimer),this._emitUpdatedEventTimer=void 0)}setDragOffset(e){this._currentSlider=e.currentTarget;const t=this._currentSlider.id==="slider-min"?this.minSliderX:this.maxSliderX,i=this.getBoundingClientRect().x;this._dragOffset=e.clientX-i-t}translatePositionToDate(e){const t=Math.ceil((e-this.sliderWidth)*this.dateRangeMS/this._histWidth);return this.formatDate(this._minDateMS+t)}translateDateToPosition(e){const t=this.getMSFromString(e);return this.sliderWidth+(t-this._minDateMS)*this._histWidth/this.dateRangeMS}clamp(e,t,i){return Math.min(Math.max(e,t),i)}handleMinDateInput(e){const t=e.currentTarget;this.minSelectedDate=t.value,this.beginEmitUpdateProcess()}handleMaxDateInput(e){const t=e.currentTarget;this.maxSelectedDate=t.value,this.beginEmitUpdateProcess()}handleKeyUp(e){if(e.key==="Enter"){const t=e.currentTarget;t.blur(),t.id==="date-min"?this.handleMinDateInput(e):t.id==="date-max"&&this.handleMaxDateInput(e)}}get currentDateRangeString(){return`${this.minSelectedDate}:${this.maxSelectedDate}`}getMSFromString(e){const t=typeof e=="string"?e:String(e);if((t.split(/(\d+)/).length-1)/2===1){const o=new Date(0,0);return o.setFullYear(Number(t)),o.getTime()}return Xi(t,[this.dateFormat,ya]).valueOf()}handleBarClick(e){const t=e.currentTarget.dataset,i=(this.getMSFromString(t.binStart)+this.getMSFromString(t.binEnd))/2,o=Math.abs(i-this.getMSFromString(this.minSelectedDate)),r=Math.abs(i-this.getMSFromString(this.maxSelectedDate));o<r?this.minSelectedDate=t.binStart:this.maxSelectedDate=t.binEnd,this.beginEmitUpdateProcess()}get minSliderTemplate(){const e=ba,t=`
          ...
          `;return this.generateSliderSVG(this.minSliderX,"slider-min",t)}get maxSliderTemplate(){const e=ba,t=`
            ...
            q0,${e} -${e},${e}
            h-${this.sliderWidth-e}
          `;return this.generateSliderSVG(this.maxSliderX,"slider-max",t)}generateSliderSVG(e,t,i){const o=t==="slider-min"?1:-1;return P`
    <svg
      id="${t}"
      class="
    ...
    `}get selectedRangeTemplate(){return P`
      <rect
        ...
        height="${this.height}"
        fill="${_n}"
      />`}get histogramTemplate(){const e=this._histWidth/this._numBins,t=e-1;let i=this.sliderWidth;return this._histData.map(o=>{const r=P`
        <rect
          class="bar"
          ...
          fill="${i+t>=this.minSliderX&&i<=this.maxSliderX?Sn:Cn}"
...
`;let uo=class extends M{constructor(){super(...arguments),this.config=new Za}render(){return h`
    ...
    `}static get styles(){const e=m`var(--modalLogoSize, 6.5rem)`,t=m`var(--processingImageSize, 7.5rem)`,i=m`var(--modalCornerRadius, 1rem)`,o=m`var(--modalBorder, 2px solid black)`,r=m`var(--modalBottomMargin, 2.5rem)`,n=m`var(--modalTopMargin, 5rem)`,l=m`var(--modalHeaderBottomPadding, 0.5em)`,d=m`var(--modalBottomPadding, 2rem)`,u=m`var(--modalScrollOffset, 5px)`,v=m`var(--modalTitleFontSize, 1.8rem)`,f=m`var(--modalSubtitleFontSize, 1.4rem)`,y=m`var(--modalHeadlineFontSize, 1.6rem)`,x=m`var(--modalMessageFontSize, 1.4rem)`,z=m`var(--modalTitleLineHeight, normal)`,L=m`var(--modalSubtitleLineHeight, normal)`,O=m`var(--modalHeadlineLineHeight, normal)`,N=m`var(--modalMessageLineHeight, normal)`;return m`
      .processing-logo {
        margin: auto;
        width: ${t};
        height: ${t};
    ...
    `}};s([c({type:String,reflect:!0})],$t.prototype,"mode",void 0);s([c({type:Object})],$t.prototype,"customModalContent",void 0);s([c({type:Object})],$t.prototype,"hostBridge",void 0);s([K("modal-template")],$t.prototype,"modalTemplate",void 0);$t=s([A("modal-manager")],$t);var Ja=P`<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><path d="m79.8883285 50.0035012.1116715-.1085359-43.1159942-46.61088155c-2.401537-2.18938917-4.6902018-3.28408375-6.8659943-3.28408375s-4.1642651.63837733-5.9654178 1.91513199c-1.8011528 1.27675467-3.1520173 2.97248092-4.0525937 5.08717877l39.4020173 42.99768924-39.4020173 42.9976892c.9005764 2.1146979 2.2514409 3.8104241 4.0525937 5.0871788 1.8011527 1.2767547 3.7896253 1.915132 5.9654178 1.915132 2.1013449 0 4.3900096-1.0573489 6.8659943-3.1720468l43.1159942-46.7194174z"/></svg>
`,On=P`
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path 
...
`;let Ct=class extends M{constructor(){super(...arguments),this.step=2,this.currentPage=1,this.pages=[]}firstUpdated(){this.observePageCount()}updated(e){e.has("size")&&this.observePageCount(),e.has("currentPage")&&(this.observePageCount(),this.emitPageClick())}observePageCount(){this.pages=[];const e=7,t=this.size<=e;if(this.size<=5){this.pages=[...Array(this.size).keys()].map(r=>r+1);return}if(this.size===e){if(this.currentPage===2){this.pages=[1,2,3,4,0,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,4,5,this.size-1,this.size];return}}if(this.currentPage===1){this.pages=[1,2,3,0,this.size];return}if(this.currentPage===this.size){this.pages=[1,0,this.size-2,this.size-1,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,this.size-3,this.size-2,this.size-1,this.size];return}if(t&&this.currentPage>1&&this.currentPage<e){this.pages=[...Array(this.size).keys()].map(r=>r+1);return}let i=this.currentPage-this.step,o=this.currentPage+this.step;i<=0&&(o+=-i+1,i=1),o>=this.size&&(i=Math.max(i-(o-this.size),1),o=this.size),i===2&&(o-=1),o===this.size-1&&(i+=1),this.createFirstNode(i),this.createMiddelNode(i,o),this.createLastNode(o)}createFirstNode(e){var t,i;e>1&&((t=this.pages)===null||t===void 0||t.push(1)),e>2&&((i=this.pages)===null||i===void 0||i.push(0))}createMiddelNode(e,t){var i;for(let o=e;o<=t;o+=1)(i=this.pages)===null||i===void 0||i.push(o)}createLastNode(e){var t,i;e<this.size-1&&((t=this.pages)===null||t===void 0||t.push(0)),e<this.size&&((i=this.pages)===null||i===void 0||i.push(this.size))}get getEllipsisTemplate(){return h`<i class="ellipses">...</i>`}emitPageClick(){this.dispatchEvent(new CustomEvent("pageNumberClicked",{detail:{page:this.currentPage},bubbles:!0,composed:!0}))}onRewind(){this.currentPage-=1,this.currentPage<1&&(this.currentPage=1)}onForward(){this.currentPage+=1,this.currentPage>this.size&&(this.currentPage=this.size)}onChange(e){this.currentPage=e}getPageTemplate(e){return h`
    ...
    `}};s([c({type:Number})],Ct.prototype,"size",void 0);s([c({type:Number})],Ct.prototype,"step",void 0);s([c({type:Number})],Ct.prototype,"currentPage",void 0);s([C()],Ct.prototype,"pages",void 0);Ct=s([A("more-facets-pagination")],Ct);var In=P`
...
`;let Tt=class extends M{facetClicked(e,t,i){const o=e.target,{checked:r,name:n,value:l}=o;r?this.facetChecked(n,l,t,i):this.facetUnchecked(n,l)}facetChecked(e,t,i,o){const{selectedFacets:r}=this;let n;r?n=he({},r):n=wi,n[e][t]={state:o?"hidden":"selected",count:i},this.selectedFacets=n,this.dispatchSelectedFacetsChanged()}facetUnchecked(e,t){const{selectedFacets:i}=this;let o;i?o=he({},i):o=wi,delete o[e][t],this.selectedFacets=o,this.dispatchSelectedFacetsChanged()}dispatchSelectedFacetsChanged(){const e=new CustomEvent("selectedFacetsChanged",{detail:this.selectedFacets,bubbles:!0,composed:!0});this.dispatchEvent(e)}getFacetsTemplate(e){let t=e==null?void 0:e.buckets;return t=[...t.filter(i=>i.state==="selected").sort((i,o)=>i.count<o.count?1:-1),...t.filter(i=>i.state==="hidden").sort((i,o)=>i.count<o.count?1:-1),...t.filter(i=>i.state==="none")],h`
      <div class="facets-on-${this.renderOn}">
        ${ja(t,i=>`${e.key}:${i.key}`,i=>{var o,r;const n=`${e.key}:${i.key}-show-only`,l=`${e.key}:${i.key}-negative`,d=e.key!=="collection"?h`${(o=i.displayText)!==null&&o!==void 0?o:i.key}`:h`<a href="/details/${i.key}">
                    <async-collection-name
                      ...
                      placeholder="-"
                    ></async-collection-name>
                  </a> `,u=i.state==="hidden",v=i.state==="selected",f=`${e.key}: ${(r=i.displayText)!==null&&r!==void 0?r:i.key}`,y=v?`Show all ${e.key}s`:`Only show ${f}`,x=`Hide ${f}`,z=`Unhide ${f}`,L=u?z:x;return h`
              <div class="facet-row">
    ...
    `}};s([c({type:String})],X.prototype,"facetKey",void 0);s([c({type:String})],X.prototype,"facetAggregationKey",void 0);s([c({type:String})],X.prototype,"query",void 0);s([c({type:Object})],X.prototype,"filterMap",void 0);s([c({type:Object})],X.prototype,"modalManager",void 0);s([c({type:Object})],X.prototype,"searchService",void 0);s([c({type:String})],X.prototype,"searchType",void 0);s([c({type:Object})],X.prototype,"collectionNameCache",void 0);s([c({type:Object})],X.prototype,"selectedFacets",void 0);s([c({type:String})],X.prototype,"sortedBy",void 0);s([c({type:Object,attribute:!1})],X.prototype,"analyticsHandler",void 0);s([C()],X.prototype,"aggregations",void 0);s([C()],X.prototype,"facetGroup",void 0);s([C()],X.prototype,"facetGroupTitle",void 0);s([C()],X.prototype,"pageNumber",void 0);s([C()],X.prototype,"facetsLoading",void 0);s([C()],X.prototype,"paginationSize",void 0);s([C()],X.prototype,"facetsType",void 0);X=s([A("more-facets-content")],X);let $a=class extends M{render(){return h`
      <div id="row">
...
`),favCount:(Ne=(Re=d.num_favorites)===null||Re===void 0?void 0:Re.value)!==null&&Ne!==void 0?Ne:0,href:(Pt=d.__href__)===null||Pt===void 0?void 0:Pt.value,identifier:d.identifier,issue:(At=d.issue)===null||At===void 0?void 0:At.value,itemCount:(at=(Ft=d.item_count)===null||Ft===void 0?void 0:Ft.value)!==null&&at!==void 0?at:0,mediatype:(V=(He=d.mediatype)===null||He===void 0?void 0:He.value)!==null&&V!==void 0?V:"data",snippets:(G=(rt=d.highlight)===null||rt===void 0?void 0:rt.values)!==null&&G!==void 0?G:[],source:(st=d.source)===null||st===void 0?void 0:st.value,subjects:(Ce=(H=d.subject)===null||H===void 0?void 0:H.values)!==null&&Ce!==void 0?Ce:[],title:(nt=(Ue=d.title)===null||Ue===void 0?void 0:Ue.value)!==null&&nt!==void 0?nt:"",volume:(We=d.volume)===null||We===void 0?void 0:We.value,viewCount:(_e=(lt=d.downloads)===null||lt===void 0?void 0:lt.value)!==null&&_e!==void 0?_e:0,weeklyViewCount:(ge=d.week)===null||ge===void 0?void 0:ge.value,loginRequired:je,contentWarning:Ve})}),o[e]=r,this.dataSource=o,this.currentVisiblePageNumbers.includes(e)&&((i=this.infiniteScroller)===null||i===void 0||i.reload())}async fetchPrefixFilterBuckets(e){var t,i,o,r,n,l;if(!this.fullQueryWithoutAlphaFilters)return[];const d=rn[e],u={query:this.fullQueryWithoutAlphaFilters,rows:0,aggregations:{simpleParams:[d]},aggregationsSize:26},v=await((t=this.searchService)===null||t===void 0?void 0:t.search(u,this.searchType));return(l=(n=(r=(o=(i=v==null?void 0:v.success)===null||i===void 0?void 0:i.response)===null||o===void 0?void 0:o.aggregations)===null||r===void 0?void 0:r[d])===null||n===void 0?void 0:n.buckets)!==null&&l!==void 0?l:[]}async updatePrefixFilterCounts(e){const t=await this.fetchPrefixFilterBuckets(e);this.prefixFilterCountMap=he({},this.prefixFilterCountMap),this.prefixFilterCountMap[e]=t.reduce((i,o)=>(i[o.key.toUpperCase()]=o.doc_count,i),{})}async updatePrefixFiltersForCurrentSort(){if(["title","creator"].includes(this.selectedSort)){const e=this.selectedSort;this.prefixFilterCountMap[e]||this.updatePrefixFilterCounts(e)}}refreshLetterCounts(){this.prefixFilterCountMap={},this.updatePrefixFiltersForCurrentSort()}resultSelected(e){var t,i;(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:this.searchContext,action:J.resultSelected,label:e.detail.mediatype}),(i=this.analyticsHandler)===null||i===void 0||i.sendEvent({category:this.searchContext,action:J.resultSelected,label:`page-${this.currentPage}`})}cellForIndex(e){const t=this.tileModelAtCellIndex(e);if(!!t)return h`
  ...
  `;s([C()],oe.prototype,"currentPage",void 0);s([C()],oe.prototype,"searchQuery",void 0);s([C()],oe.prototype,"cellWidth",void 0);s([C()],oe.prototype,"cellHeight",void 0);s([C()],oe.prototype,"rowGap",void 0);s([C()],oe.prototype,"colGap",void 0);s([C()],oe.prototype,"loggedIn",void 0);s([C()],oe.prototype,"searchType",void 0);s([c({type:Object,reflect:!1})],oe.prototype,"latestAction",void 0);s([K("#base-query-field")],oe.prototype,"baseQueryField",void 0);s([K("#page-number-input")],oe.prototype,"pageNumberInput",void 0);s([K("collection-browser")],oe.prototype,"collectionBrowser",void 0);s([K("modal-manager")],oe.prototype,"modalManager",void 0);oe=s([A("app-root")],oe);
