...
`+ne),$e&&(ne=Ae(ne,He," "),ne=Ae(ne,We," ")),G&&ii?G.createHTML(ne):ne},e.setConfig=function($){Di($),Qe=!0},e.clearConfig=function(){vt=null,Qe=!1},e.isValidAttribute=function($,p,w){vt||Di({});var _=Xe($),O=Xe(p);return Io(_,O,w)},e.addHook=function($,p){typeof p=="function"&&(pe[$]=pe[$]||[],Nt(pe[$],p))},e.removeHook=function($){if(pe[$])return na(pe[$])},e.removeHooks=function($){pe[$]&&(pe[$]=[])},e.removeAllHooks=function(){pe={}},e}var Wt=Ya(),D;(function(a){a.relevance="relevance",a.alltimeview="alltimeview",a.weeklyview="weeklyview",a.title="title",a.date="date",a.datearchived="datearchived",a.datereviewed="datereviewed",a.dateadded="dateadded",a.creator="creator"})(D||(D={}));const Je={relevance:"Relevance",alltimeview:"All-time views",weeklyview:"Weekly views",title:"Title",date:"Date published",datearchived:"Date archived",datereviewed:"Date reviewed",dateadded:"Date added",creator:"Creator"},pa={relevance:"desc",alltimeview:"desc",weeklyview:"desc",title:"asc",date:"desc",datearchived:"desc",datereviewed:"desc",dateadded:"desc",creator:"asc"},rn={relevance:null,alltimeview:"downloads",weeklyview:"week",title:"titleSorter",date:"date",datearchived:"publicdate",datereviewed:"reviewdate",dateadded:"addeddate",creator:"creatorSorter"},ua={week:D.weeklyview,downloads:D.alltimeview,titleSorter:D.title,date:D.date,publicdate:D.datearchived,reviewdate:D.datereviewed,addeddate:D.dateadded,creatorSorter:D.creator},sn={title:"firstTitle",creator:"firstCreator"},xi={subject:{},lending:{},mediatype:{},language:{},creator:{},collection:{},year:{}},nn=["mediatype","lending","year","subject","collection","creator","language"],_i={subject:"Subject",lending:"Availability",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"},ln={is_lendable:!0,is_borrowable:!1,available_to_borrow:!0,is_browsable:!1,available_to_browse:!1,is_readable:!0,available_to_waitlist:!1},va={is_lendable:"Lending Library",available_to_borrow:"Borrow 14 Days",is_readable:"Always Available"},_o={deemphasize:!0,community:!0,stream_only:!0,samples_only:!0,test_collection:!0,printdisabled:!0,"openlibrary-ol":!0,nationalemergencylibrary:!0,china:!0,americana:!0,toronto:!0};function Ka(a){switch(a){case"publicdate":return"Archived";case"reviewdate":return"Reviewed";case"addeddate":return"Added";default:return"Published"}}function Za(a){return a?`Archivist since ${a.getFullYear()}`:""}let fe=class extends M{constructor(){super(...arguments),this.sortParam=null,this.collectionLinks=[],this.loggedIn=!1}render(){return h`
  ...
  `;ho=s([B("ia-icon-label")],ho);let po=class extends M{constructor(){super(...arguments),this.numResults=0}render(){return h`
    ...
    `}};s([c({type:Number})],po.prototype,"numResults",void 0);po=s([B("alpha-bar-tooltip")],po);let Ne=class extends M{constructor(){super(...arguments),this.selectedLetter=null,this.tooltipShown=!1,this.alphabet="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("")}get selectedUppercaseLetter(){var e;return(e=this.selectedLetter)===null||e===void 0?void 0:e.toUpperCase()}render(){return h`
      <div id="container">
        <ul>
  ...
  `;s([c({type:String})],Ne.prototype,"selectedLetter",void 0);s([c({type:Object})],Ne.prototype,"letterCounts",void 0);s([S()],Ne.prototype,"tooltipShown",void 0);s([S()],Ne.prototype,"hoveredLetter",void 0);s([K("alpha-bar-tooltip")],Ne.prototype,"tooltip",void 0);Ne=s([B("alpha-bar")],Ne);const cn=h`
...
`;let uo=class extends M{constructor(){super(...arguments),this.config=new Ja}render(){return h`
    ...
    `}};s([c({type:Object})],uo.prototype,"config",void 0);uo=s([B("modal-template")],uo);function In(a,e,t){var i=t||{},o=i.noTrailing,r=o===void 0?!1:o,n=i.noLeading,l=n===void 0?!1:n,d=i.debounceMode,u=d===void 0?void 0:d,v,f=!1,y=0;function x(){v&&clearTimeout(v)}function z(E){var N=E||{},j=N.upcomingOnly,ee=j===void 0?!1:j;x(),f=!ee}function F(){for(var E=arguments.length,N=new Array(E),j=0;j<E;j++)N[j]=arguments[j];var ee=this,G=Date.now()-y;if(f)return;function he(){y=Date.now(),e.apply(ee,N)}function Z(){v=void 0}!l&&u&&!v&&he(),x(),u===void 0&&G>a?l?(y=Date.now(),r||(v=setTimeout(u?Z:he,a))):he():r!==!0&&(v=setTimeout(u?Z:he,u===void 0?a-G:a))}return F.cancel=z,F}var tt;(function(a){a.Open="open",a.Closed="closed"})(tt||(tt={}));class Rn{constructor(e){this.windowResizeThrottler=In(100,this.updateModalContainerHeight).bind(this),this.modalManager=e}handleModeChange(e){switch(e){case tt.Open:this.startResizeListener(),this.stopDocumentScroll();break;case tt.Closed:this.stopResizeListener(),this.resumeDocumentScroll();break}}updateModalContainerHeight(){this.modalManager.style.setProperty("--containerHeight",`${window.innerHeight}px`)}stopDocumentScroll(){document.body.classList.add("modal-manager-open")}resumeDocumentScroll(){document.body.classList.remove("modal-manager-open")}startResizeListener(){window.addEventListener("resize",this.windowResizeThrottler)}stopResizeListener(){window.removeEventListener("resize",this.windowResizeThrottler)}}let Tt=class extends M{constructor(){super(...arguments),this.mode=tt.Closed,this.hostBridge=new Rn(this),this.closeOnBackdropClick=!0}render(){return h`
      <div class="container">
