...
`;let Kt=class extends M{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1,this.isCompactTile=!1}render(){return h`<div class="icon-overlay ${this.getClass}">
    ...
    `}};s([c({type:String})],Oe.prototype,"baseImageUrl",void 0);s([c({type:Boolean})],Oe.prototype,"isCompactTile",void 0);s([c({type:Boolean})],Oe.prototype,"isListTile",void 0);s([c({type:Boolean})],Oe.prototype,"loggedIn",void 0);s([c({type:Object})],Oe.prototype,"model",void 0);s([c({type:String})],Oe.prototype,"viewSize",void 0);Oe=s([P("image-block")],Oe);let Xt=class extends M{constructor(){super(...arguments),this.showInfoButton=!1}render(){return h`
      <div class="container">
...
`+re),xe&&(re=De(re,Re," "),re=De(re,Ne," ")),Y&&ti?Y.createHTML(re):re},e.setConfig=function(S){Ai(S),We=!0},e.clearConfig=function(){ut=null,We=!1},e.isValidAttribute=function(S,p,y){ut||Ai({});var _=Qe(S),I=Qe(p);return Ba(_,I,y)},e.addHook=function(S,p){typeof p=="function"&&(ce[S]=ce[S]||[],Ht(ce[S],p))},e.removeHook=function(S){if(ce[S])return no(ce[S])},e.removeHooks=function(S){ce[S]&&(ce[S]=[])},e.removeAllHooks=function(){ce={}},e}var Wt=Yo(),L;(function(o){o.relevance="relevance",o.alltimeview="alltimeview",o.weeklyview="weeklyview",o.title="title",o.datearchived="datearchived",o.date="date",o.datereviewed="datereviewed",o.dateadded="dateadded",o.creator="creator"})(L||(L={}));const Xe={relevance:"Relevance",alltimeview:"All-time views",weeklyview:"Weekly views",title:"Title",datearchived:"Date archived",date:"Date published",datereviewed:"Date reviewed",dateadded:"Date added",creator:"Creator"},rn={relevance:null,alltimeview:"downloads",weeklyview:"week",title:"titleSorter",datearchived:"publicdate",date:"date",datereviewed:"reviewdate",dateadded:"addeddate",creator:"creatorSorter"},uo={week:L.weeklyview,downloads:L.alltimeview,titleSorter:L.title,date:L.date,publicdate:L.datearchived,reviewdate:L.datereviewed,addeddate:L.dateadded,creatorSorter:L.creator},sn={title:"firstTitle",creator:"firstCreator"},wi={subject:{},lending:{},mediatype:{},language:{},creator:{},collection:{},year:{}},nn=["mediatype","lending","year","subject","collection","creator","language"],xi={subject:"Subject",lending:"Availability",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"},ln={is_lendable:!0,is_borrowable:!1,available_to_borrow:!0,is_browsable:!1,available_to_browse:!1,is_readable:!0,available_to_waitlist:!1},vo={is_lendable:"Lending Library",available_to_borrow:"Borrow 14 Days",is_readable:"Always Available"},_a={deemphasize:!0,community:!0,stream_only:!0,samples_only:!0,test_collection:!0,printdisabled:!0,"openlibrary-ol":!0,nationalemergencylibrary:!0,china:!0,americana:!0,toronto:!0};function Xo(o){switch(o){case"publicdate":return"Archived";case"reviewdate":return"Reviewed";case"addeddate":return"Added";default:return"Published"}}function Zo(o){return o?`Archivist since ${o.getFullYear()}`:""}let me=class extends M{constructor(){super(...arguments),this.sortParam=null,this.collectionLinks=[],this.loggedIn=!1}render(){return h`
    ...
    `}};s([c({type:Object})],Ie.prototype,"model",void 0);s([c({type:String})],Ie.prototype,"baseNavigationUrl",void 0);s([c({type:String})],Ie.prototype,"baseImageUrl",void 0);s([c({type:Boolean})],Ie.prototype,"loggedIn",void 0);s([c({type:Object})],Ie.prototype,"sortParam",void 0);s([c({type:Object})],Ie.prototype,"collectionNameCache",void 0);Ie=s([P("tile-hover-pane")],Ie);let Ce=class extends M{constructor(){super(...arguments),this.sortParam=null,this.loggedIn=!1}render(){var e,t,i,a,r,n,l,d,u;return h`
      <div id="list-line" class="${this.classSize}">
        <image-block
          .model=${this.model}
          .baseImageUrl=${this.baseImageUrl}
    ...
    `}get desktopSortSelectorTemplate(){return h`
      ...
      >
        ...
        <ul id="desktop-sort-selector">
          ...
          <li>
            ${this.getSortDropdown({optionSelectedHandler:()=>{this.viewsDropdown.open=!1,this.restoreDateDropdownDefaults(),this.dateSortSelectorVisible=!1,this.alphaSelectorVisible=null,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.emitTitleLetterChangedEvent(),this.emitCreatorLetterChangedEvent()},clickHandler:()=>{this.viewOptionSelected||this.setSelectedSort(L.weeklyview),this.dateDropdown.open=!1,this.viewSortSelectorVisible=this.viewsDropdown.open,this.viewsDropdown.classList.toggle("open",this.viewsDropdown.open)},displayName:h`${this.viewSortField}`,id:"views-dropdown",isSelected:()=>this.viewOptionSelected,dropdownOptions:[this.getDropdownOption(L.weeklyview),this.getDropdownOption(L.alltimeview)],selectedOption:this.viewOptionSelected?this.selectedSort:L.weeklyview})}
          </li>
          <li>
...
`;let ua=class extends M{constructor(){super(...arguments),this.config=new Jo}render(){return h`
    ...
    `}static get styles(){const e=f`var(--modalLogoSize, 6.5rem)`,t=f`var(--processingImageSize, 7.5rem)`,i=f`var(--modalCornerRadius, 1rem)`,a=f`var(--modalBorder, 2px solid black)`,r=f`var(--modalBottomMargin, 2.5rem)`,n=f`var(--modalTopMargin, 5rem)`,l=f`var(--modalHeaderBottomPadding, 0.5em)`,d=f`var(--modalBottomPadding, 2rem)`,u=f`var(--modalScrollOffset, 5px)`,v=f`var(--modalTitleFontSize, 1.8rem)`,m=f`var(--modalSubtitleFontSize, 1.4rem)`,b=f`var(--modalHeadlineFontSize, 1.6rem)`,x=f`var(--modalMessageFontSize, 1.4rem)`,k=f`var(--modalTitleLineHeight, normal)`,E=f`var(--modalSubtitleLineHeight, normal)`,O=f`var(--modalHeadlineLineHeight, normal)`,H=f`var(--modalMessageLineHeight, normal)`;return f`
      .processing-logo {
        margin: auto;
        width: ${t};
        height: ${t};
    ...
    `}};s([c({type:Object})],ua.prototype,"config",void 0);ua=s([P("modal-template")],ua);function Fn(o,e,t){var i=t||{},a=i.noTrailing,r=a===void 0?!1:a,n=i.noLeading,l=n===void 0?!1:n,d=i.debounceMode,u=d===void 0?void 0:d,v,m=!1,b=0;function x(){v&&clearTimeout(v)}function k(O){var H=O||{},W=H.upcomingOnly,oe=W===void 0?!1:W;x(),m=!oe}function E(){for(var O=arguments.length,H=new Array(O),W=0;W<O;W++)H[W]=arguments[W];var oe=this,Y=Date.now()-b;if(m)return;function pe(){b=Date.now(),e.apply(oe,H)}function ue(){v=void 0}!l&&u&&!v&&pe(),x(),u===void 0&&Y>o?l?(b=Date.now(),r||(v=setTimeout(u?ue:pe,o))):pe():r!==!0&&(v=setTimeout(u?ue:pe,u===void 0?o-Y:o))}return E.cancel=k,E}var Je;(function(o){o.Open="open",o.Closed="closed"})(Je||(Je={}));class On{constructor(e){this.windowResizeThrottler=Fn(100,this.updateModalContainerHeight).bind(this),this.modalManager=e}handleModeChange(e){switch(e){case Je.Open:this.startResizeListener(),this.stopDocumentScroll();break;case Je.Closed:this.stopResizeListener(),this.resumeDocumentScroll();break}}updateModalContainerHeight(){this.modalManager.style.setProperty("--containerHeight",`${window.innerHeight}px`)}stopDocumentScroll(){document.body.classList.add("modal-manager-open")}resumeDocumentScroll(){document.body.classList.remove("modal-manager-open")}startResizeListener(){window.addEventListener("resize",this.windowResizeThrottler)}stopResizeListener(){window.removeEventListener("resize",this.windowResizeThrottler)}}let $t=class extends M{constructor(){super(...arguments),this.mode=Je.Closed,this.hostBridge=new On(this),this.closeOnBackdropClick=!0}render(){return h`
      <div class="container">
              ...
              <div class="facet-row">
                <div class="facet-checkbox">
                  <input
                    ...
                    .name=${e.key}
                    .value=${i.key}
                    @click=${O=>{this.facetClicked(O,i.count,!1)}}
                    .checked=${v}
                  ...
                  <input
                    ...
                    .name=${e.key}
                    .value=${i.key}
                    @click=${O=>{this.facetClicked(O,i.count,!0)}}
                    .checked=${u}
