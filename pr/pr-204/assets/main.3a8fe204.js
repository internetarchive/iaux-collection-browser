 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Wo=(r,e)=>e.kind==="method"&&e.descriptor&&!("value"in e.descriptor)?mt(ve({},e),{finisher(t){t.createProperty(e.key,r)}}):{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){typeof e.initializer=="function"&&(this[e.key]=e.initializer.call(this))},finisher(t){t.createProperty(e.key,r)}};function c(r){return(e,t)=>t!==void 0?((i,a,o)=>{a.constructor.createProperty(o,i)})(r,e,t):Wo(r,e)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function C(r){return c(mt(ve({},r),{state:!0}))}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ur=({finisher:r,descriptor:e})=>(t,i)=>{var a;if(i===void 0){const o=(a=t.originalKey)!==null&&a!==void 0?a:t.key,l=e!=null?{kind:"method",placement:"prototype",key:o,descriptor:e(t.key)}:mt(ve({},t),{key:o});return r!=null&&(l.finisher=function(n){r(n,o)}),l}{const o=t.constructor;e!==void 0&&Object.defineProperty(t,i,e(i)),r==null||r(o,i)}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ws=(r,...e)=>({strTag:!0,strings:r,values:e}),ft=ws,xs=r=>typeof r!="string"&&"strTag"in r,_s=(r,e,t)=>{let i=r[0];for(let a=1;a<r.length;a++)i+=e[t?t[a-1]:a-1],i+=r[a];return i};/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let gt=Ss;function Ts(r,e){let t=1;return r>=1e9?t=1e9:r>=1e6?t=1e6:r>=1e3&&e==="short"&&(t=1e3),t}function ks(r=0,e){const t=r/e,i=t<10;let a=0;return i?a=Math.round((t+Number.EPSILON)*10)/10:a=Math.round(t),a}function zs(r,e,t,i){switch(e){case 1e9:return gt(t==="short"?ft`${r}B`:ft`${r} billion`);case 1e6:return gt(t==="short"?ft`${r}M`:ft`${r} million`);case 1e3:return gt(t==="short"?ft`${r}K`:ft`${r} thousand`);default:return new Intl.NumberFormat(i).format(r)}}function Ht(r,e="long",t="short",i="en-US"){const a=r!=null?r:-1;if(a<0)return"";const o=Ts(a,e),l=ks(a,o);return zs(l,o,t,i)}let at=class extends M{render(){const e=Ht(this.favCount,"short","short"),t=Ht(this.commentCount,"short","short"),i=this.mediatype==="account"?`${this.itemCount} uploads`:`${this.viewCount} all-time views`;return h`
    ...
    `}};s([c({type:String})],at.prototype,"mediatype",void 0);s([c({type:Number})],at.prototype,"itemCount",void 0);s([c({type:Number})],at.prototype,"viewCount",void 0);s([c({type:Number})],at.prototype,"favCount",void 0);s([c({type:Number})],at.prototype,"commentCount",void 0);at=s([I("tile-stats")],at);let rt=class extends M{constructor(){super(...arguments),this.loggedIn=!1,this.showInfoButton=!1}render(){var e,t,i,a,o;const l=(e=this.model)===null||e===void 0?void 0:e.title;return h`
      <div class="container">
        ${this.infoButtonTemplate}
        <div class="tile-details">
          <div class="item-info">
    ...
    `}get doesSortedByDate(){var e;return["date","reviewdate","addeddate","publicdate"].includes((e=this.sortParam)===null||e===void 0?void 0:e.field)}get hasSnippets(){var e,t;return!!(!((t=(e=this.model)===null||e===void 0?void 0:e.snippets)===null||t===void 0)&&t.length)}infoButtonPressed(e){e.preventDefault();const t=new CustomEvent("infoButtonPressed",{detail:{x:e.clientX,y:e.clientY}});this.dispatchEvent(t)}static get styles(){const e=m`var(--tileBorderColor, #dddddd)`;return[ba,m`
      ...
      `]}};s([c({type:String})],rt.prototype,"baseImageUrl",void 0);s([c({type:Boolean})],rt.prototype,"loggedIn",void 0);s([c({type:Object})],rt.prototype,"model",void 0);s([c({type:Object})],rt.prototype,"sortParam",void 0);s([c({type:Boolean})],rt.prototype,"showInfoButton",void 0);rt=s([I("item-tile")],rt);let Zt=class extends M{constructor(){super(...arguments),this.showInfoButton=!1}render(){return h`
      <div class="container">
        ${this.infoButtonTemplate}
        <div class="tile-details">
          <div class="item-info">
...
`;let zt=class extends M{facetClicked(e,t,i){const a=e.target,{checked:o,name:l,value:n}=a;o?this.facetChecked(l,n,t,i):this.facetUnchecked(l,n)}facetChecked(e,t,i,a){const{selectedFacets:o}=this;let l;o?l=ve({},o):l=xi,l[e][t]={state:a?"hidden":"selected",count:i},this.selectedFacets=l,this.dispatchSelectedFacetsChanged()}facetUnchecked(e,t){const{selectedFacets:i}=this;let a;i?a=ve({},i):a=xi,delete a[e][t],this.selectedFacets=a,this.dispatchSelectedFacetsChanged()}dispatchSelectedFacetsChanged(){const e=new CustomEvent("selectedFacetsChanged",{detail:this.selectedFacets,bubbles:!0,composed:!0});this.dispatchEvent(e)}getFacetsTemplate(e){let t=e==null?void 0:e.buckets;return t=[...t.filter(i=>i.state==="selected").sort((i,a)=>i.count<a.count?1:-1),...t.filter(i=>i.state==="hidden").sort((i,a)=>i.count<a.count?1:-1),...t.filter(i=>i.state==="none")],h`
    ...
    `}};s([c({type:String})],Re.prototype,"leftValue",void 0);s([c({type:String})],Re.prototype,"leftLabel",void 0);s([c({type:String})],Re.prototype,"rightValue",void 0);s([c({type:String})],Re.prototype,"rightLabel",void 0);s([c({type:String})],Re.prototype,"side",void 0);s([J("#switch-left")],Re.prototype,"leftRadio",void 0);Re=s([I("toggle-switch")],Re);let X=class extends M{constructor(){super(...arguments),this.sortedBy="count",this.facetGroup=[],this.facetGroupTitle="",this.pageNumber=1,this.facetsLoading=!0,this.paginationSize=0,this.facetsType="modal",this.facetsPerPage=35}updated(e){e.has("facetKey")&&(this.facetsLoading=!0,this.pageNumber=1,this.updateSpecificFacets()),e.has("pageNumber")&&(this.facetGroup=this.aggregationFacetGroups)}firstUpdated(){this.setupEscapeListeners()}setupEscapeListeners(){this.modalManager?document.addEventListener("keydown",e=>{var t;e.key==="Escape"&&((t=this.modalManager)===null||t===void 0||t.closeModal())}):document.removeEventListener("keydown",()=>{})}async updateSpecificFacets(){var e,t;const i={simpleParams:[this.facetAggregationKey]},a=65535,o={query:this.query,filters:this.filterMap,aggregations:i,aggregationsSize:a,rows:0},l=await((e=this.searchService)===null||e===void 0?void 0:e.search(o,this.searchType));this.aggregations=(t=l==null?void 0:l.success)===null||t===void 0?void 0:t.response.aggregations,this.facetGroup=this.aggregationFacetGroups,this.facetsLoading=!1}pageNumberClicked(e){var t,i;const a=(t=e==null?void 0:e.detail)===null||t===void 0?void 0:t.page;a&&(this.pageNumber=Number(a)),(i=this.analyticsHandler)===null||i===void 0||i.sendEvent({category:tt.default,action:ie.moreFacetsPageChange,label:`${this.pageNumber}`})}get mergedFacets(){var e;const t=[],i=this.selectedFacetGroups.find(n=>n.key===this.facetKey),a=this.aggregationFacetGroups.find(n=>n.key===this.facetKey);if(i&&!a)return t.push(i),t;if(!a)return t;const o=i!=null?i:a,l=(e=i==null?void 0:i.buckets.map(n=>{const d=a.buckets.find(u=>u.key===n.key);return d?mt(ve({},n),{count:d.count}):n}))!==null&&e!==void 0?e:[];return a.buckets.forEach(n=>{l.find(u=>u.key===n.key)||l.push(n)}),o.buckets=l,t.push(o),t}get selectedFacetGroups(){return this.selectedFacets?Object.entries(this.selectedFacets).map(([t,i])=>{const a=t,o=_i[a],l=Object.entries(i).map(([n,d])=>({displayText:n,key:n,count:d==null?void 0:d.count,state:d==null?void 0:d.state}));return{title:o,key:a,buckets:l}}):[]}get aggregationFacetGroups(){var e;const t=[];return Object.entries((e=this.aggregations)!==null&&e!==void 0?e:[]).forEach(([i,a])=>{if(i==="year_histogram")return;const o=i;this.facetGroupTitle=_i[o];let l=a.getSortedBuckets(this.sortedBy==="alpha"?_t.ALPHABETICAL:_t.COUNT);o==="collection"&&(l=l==null?void 0:l.filter(f=>{var y;const x=(y=f==null?void 0:f.key)===null||y===void 0?void 0:y.toString();return!wa[x]&&!(x!=null&&x.startsWith("fav-"))}),this.preloadCollectionNames(l));const{length:n}=Object.keys(l);this.paginationSize=Math.ceil(n/this.facetsPerPage);const u=(l==null?void 0:l.slice((this.pageNumber-1)*this.facetsPerPage,this.pageNumber*this.facetsPerPage)).map(f=>{const y=f.key;return{displayText:`${f.key}`,key:`${y}`,count:f.doc_count,state:"none"}}),v={title:this.facetGroupTitle,key:o,buckets:u};t.push(v)}),t}preloadCollectionNames(e){var t;const i=e==null?void 0:e.map(o=>o.key),a=Array.from(new Set(i));(t=this.collectionNameCache)===null||t===void 0||t.preloadIdentifiers(a)}get getMoreFacetsTemplate(){var e;return h`
      <facets-template
    ...
    `}get loaderTemplate(){return h`<div class="facets-loader">
      ...
      <span class="title">
        ...
        <toggle-switch
          ...
          .rightValue=${"alpha"}
          .rightLabel=${"Value"}
          @change=${e=>{this.sortFacetAggregation(e.detail)}}
        ></toggle-switch>
