var co=Object.defineProperty,ho=Object.defineProperties;var po=Object.getOwnPropertyDescriptors;var Na=Object.getOwnPropertySymbols;var uo=Object.prototype.hasOwnProperty,mo=Object.prototype.propertyIsEnumerable;var Ha=(r,e,t)=>e in r?co(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t,se=(r,e)=>{for(var t in e||(e={}))uo.call(e,t)&&Ha(r,t,e[t]);if(Na)for(var t of Na(e))mo.call(e,t)&&Ha(r,t,e[t]);return r},ht=(r,e)=>ho(r,po(e));import Ki from"https://esm.archive.org/dayjs@^1.10.7";import vo from"https://esm.archive.org/dayjs@1.9.4/esm/plugin/customParseFormat";const fo=function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))i(a);new MutationObserver(a=>{for(const o of a)if(o.type==="childList")for(const n of o.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function t(a){const o={};return a.integrity&&(o.integrity=a.integrity),a.referrerpolicy&&(o.referrerPolicy=a.referrerpolicy),a.crossorigin==="use-credentials"?o.credentials="include":a.crossorigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(a){if(a.ep)return;a.ep=!0;const o=t(a);fetch(a.href,o)}};fo();function s(r,e,t,i){var a=arguments.length,o=a<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(r,e,t,i);else for(var l=r.length-1;l>=0;l--)(n=r[l])&&(o=(a<3?n(o):a>3?n(e,t,o):n(e,t))||o);return a>3&&o&&Object.defineProperty(e,t,o),o}function go(r,e,t,i){function a(o){return o instanceof t?o:new t(function(n){n(o)})}return new(t||(t=Promise))(function(o,n){function l(m){try{u(i.next(m))}catch(v){n(v)}}function d(m){try{u(i.throw(m))}catch(v){n(v)}}function u(m){m.done?o(m.value):a(m.value).then(l,d)}u((i=i.apply(r,e||[])).next())})}class bo{constructor(e){var t,i,a,o;this.ARCHIVE_ANALYTICS_VERSION=2,this.DEFAULT_SERVICE="ao_2",this.NO_SAMPLING_SERVICE="ao_no_sampling",this.DEFAULT_IMAGE_URL="https://analytics.archive.org/0.gif",this.defaultService=(t=e==null?void 0:e.defaultService)!==null&&t!==void 0?t:this.DEFAULT_SERVICE,this.imageUrl=(i=e==null?void 0:e.imageUrl)!==null&&i!==void 0?i:this.DEFAULT_IMAGE_URL,this.imageContainer=(a=e==null?void 0:e.imageContainer)!==null&&a!==void 0?a:document.body,this.requireImagePing=(o=e==null?void 0:e.requireImagePing)!==null&&o!==void 0?o:!1}sendPing(e){const t=this.generateTrackingUrl(e).toString();if(this.requireImagePing){this.sendPingViaImage(t);return}const i=navigator.sendBeacon&&navigator.sendBeacon.bind(navigator);try{i(t)}catch{this.sendPingViaImage(t)}}sendEvent(e){const t=e.label&&e.label.trim().length>0?e.label:window.location.pathname,i=se({kind:"event",ec:e.category,ea:e.action,el:t,cache_bust:Math.random()},e.eventConfiguration);this.sendPing(i)}sendEventNoSampling(e){const t=e.eventConfiguration||{};t.service=this.NO_SAMPLING_SERVICE;const i=e;i.eventConfiguration=t,this.sendEvent(i)}sendPingViaImage(e){const t=new Image(1,1);t.src=e,t.alt="",this.imageContainer.appendChild(t)}generateTrackingUrl(e){var t;const i=e!=null?e:{};i.service=(t=i.service)!==null&&t!==void 0?t:this.defaultService;const a=new URL(this.imageUrl),o=Object.keys(i);return o.forEach(n=>{const l=i[n];a.searchParams.append(n,l)}),a.searchParams.append("version",`${this.ARCHIVE_ANALYTICS_VERSION}`),a.searchParams.append("count",`${o.length+2}`),a}}function g(r){let e,t,i;return typeof r=="object"?(e=r.hashFunction,t=r.expiring,i=r.tags):e=r,(a,o,n)=>{if(n.value!=null)n.value=Ua(n.value,e,t,i);else if(n.get!=null)n.get=Ua(n.get,e,t,i);else throw"Only put a Memoize() decorator on a method or get accessor."}}const Pi=new Map;function Ua(r,e,t=0,i){const a=Symbol("__memoized_map__");return function(...o){let n;this.hasOwnProperty(a)||Object.defineProperty(this,a,{configurable:!1,enumerable:!1,writable:!1,value:new Map});let l=this[a];if(Array.isArray(i))for(const d of i)Pi.has(d)?Pi.get(d).push(l):Pi.set(d,[l]);if(e||o.length>0||t>0){let d;e===!0?d=o.map(v=>v.toString()).join("!"):e?d=e.apply(this,o):d=o[0];const u=`${d}__timestamp`;let m=!1;if(t>0)if(!l.has(u))m=!0;else{let v=l.get(u);m=Date.now()-v>t}l.has(d)&&!m?n=l.get(d):(n=r.apply(this,o),l.set(d,n),t>0&&l.set(u,Date.now()))}else{const d=this;l.has(d)?n=l.get(d):(n=r.apply(this,o),l.set(d,n))}return n}}class Yi{parseValue(e){return typeof e=="string"&&(e==="false"||e==="0")?!1:Boolean(e)}}Yi.shared=new Yi;class di{parseValue(e){if(typeof e=="number")return e;if(typeof e=="boolean")return;const t=parseFloat(e);if(!Number.isNaN(t))return t}}di.shared=new di;class Xi{parseValue(e){return di.shared.parseValue(e)}}Xi.shared=new Xi;class Zi{parseValue(e){return this.parseJSDate(e)||this.parseBracketDate(e)}parseBracketDate(e){if(typeof e!="string")return;const t=e.match(/\[([0-9]{4})\]/);if(!(!t||t.length<2))return this.parseJSDate(t[1])}parseJSDate(e){if(typeof e!="string")return;let t=e;t.match(/^[0-9]{4}-[0-9]{2}-[0-9]{2}\s{1}[0-9]{2}:[0-9]{2}:[0-9]{2}$/)&&(t=t.replace(" ","T"));const i=Date.parse(t);if(Number.isNaN(i))return;let a=new Date(t);return(t.indexOf("Z")>-1||t.indexOf("+")>-1||t.match(/^[0-9]{4}$/)||t.match(/^[0-9]{4}-[0-9]{2}-[0-9]{2}$/)||t.match(/^.*?-[0-9]{2}:[0-9]{2}$/)||t.match(/^.*?-[0-9]{4}$/))&&(a=new Date(a.getTime()+a.getTimezoneOffset()*1e3*60)),a}}Zi.shared=new Zi;class Ji{parseValue(e){if(typeof e=="number")return e;if(typeof e=="boolean")return;const t=e.split(":");let i;return t.length===1?i=this.parseNumberFormat(t[0]):i=this.parseColonSeparatedFormat(t),i}parseNumberFormat(e){let t=parseFloat(e);return Number.isNaN(t)&&(t=void 0),t}parseColonSeparatedFormat(e){let t=!1;const i=e.map((a,o)=>{const n=parseFloat(a);if(Number.isNaN(n))return t=!0,0;const l=e.length-1-o,d=60**l;return n*Math.floor(d)}).reduce((a,o)=>a+o,0);return t?void 0:i}}Ji.shared=new Ji;class ea{parseValue(e){if(typeof e=="string")return e}}ea.shared=new ea;class yo{constructor(e,t){this.separators=[";",","],this.parser=e,t&&t.separators&&(this.separators=t.separators)}parseValue(e){const t=String(e);let i=[];for(const a of this.separators)if(i=t.split(a),i.length>1)break;return this.parseListValues(i)}parseListValues(e){const i=e.map(o=>o.trim()).map(o=>this.parser.parseValue(o)),a=[];return i.forEach(o=>{o!==void 0&&a.push(o)}),a}}class ta{parseValue(e){if(typeof e=="string")return e}}ta.shared=new ta;class ci{parseValue(e){return String(e)}}ci.shared=new ci;class ye{constructor(e,t){this.parser=e,this.rawValue=t}get values(){return this.parseRawValue()}get value(){return this.values[0]}parseRawValue(){if(this.rawValue===void 0)return[];const e=Array.isArray(this.rawValue)?this.rawValue:[this.rawValue],t=[];return e.forEach(i=>{const a=this.parser.parseValue(i);Array.isArray(a)?t.push(...a):a!==void 0&&t.push(a)}),t}}s([g()],ye.prototype,"values",null);s([g()],ye.prototype,"value",null);class vt extends ye{constructor(e){super(Yi.shared,e)}}class J extends ye{constructor(e){super(Zi.shared,e)}}class Di extends ye{constructor(e){super(Ji.shared,e)}}class R extends ye{constructor(e){super(di.shared,e)}}class T extends ye{constructor(e){super(ci.shared,e)}}class wo extends ye{constructor(e){super(ta.shared,e)}}class hi extends ye{constructor(e){super(Xi.shared,e)}}class ma extends ye{constructor(e){super(ea.shared,e)}}class xo extends ye{constructor(e,t){super(t,e)}}class _o extends xo{constructor(e){const t=new yo(ci.shared);super(e,t)}}class C{constructor(e){this.rawMetadata=e}get identifier(){var e;return(e=this.rawMetadata)===null||e===void 0?void 0:e.identifier}get addeddate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.addeddate?new J(this.rawMetadata.addeddate):void 0}get audio_codec(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.audio_codec?new T(this.rawMetadata.audio_codec):void 0}get audio_sample_rate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.audio_sample_rate?new R(this.rawMetadata.audio_sample_rate):void 0}get avg_rating(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.avg_rating?new R(this.rawMetadata.avg_rating):void 0}get collection(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.collection?new T(this.rawMetadata.collection):void 0}get collections_raw(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.collections_raw?new T(this.rawMetadata.collections_raw):void 0}get collection_size(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.collection_size?new hi(this.rawMetadata.collection_size):void 0}get contributor(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.contributor?new T(this.rawMetadata.contributor):void 0}get coverage(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.coverage?new T(this.rawMetadata.coverage):void 0}get creator(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.creator?new T(this.rawMetadata.creator):void 0}get date(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.date?new J(this.rawMetadata.date):void 0}get description(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.description?new T(this.rawMetadata.description):void 0}get downloads(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.downloads?new R(this.rawMetadata.downloads):void 0}get duration(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.duration?new Di(this.rawMetadata.duration):void 0}get"external-identifier"(){var e,t;return!((e=this.rawMetadata)===null||e===void 0)&&e["external-identifier"]?new T((t=this.rawMetadata)===null||t===void 0?void 0:t["external-identifier"]):void 0}get files_count(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.files_count?new R(this.rawMetadata.files_count):void 0}get indexdate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.indexdate?new J(this.rawMetadata.indexdate):void 0}get isbn(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.isbn?new T(this.rawMetadata.isbn):void 0}get issue(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.issue?new T(this.rawMetadata.issue):void 0}get item_count(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.item_count?new R(this.rawMetadata.item_count):void 0}get item_size(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.item_size?new hi(this.rawMetadata.item_size):void 0}get language(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.language?new T(this.rawMetadata.language):void 0}get length(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.length?new Di(this.rawMetadata.length):void 0}get lineage(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.lineage?new T(this.rawMetadata.lineage):void 0}get month(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.month?new R(this.rawMetadata.month):void 0}get mediatype(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.mediatype?new ma(this.rawMetadata.mediatype):void 0}get noindex(){var e;return((e=this.rawMetadata)===null||e===void 0?void 0:e.noindex)!=null?new vt(this.rawMetadata.noindex):void 0}get notes(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.notes?new T(this.rawMetadata.notes):void 0}get num_favorites(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.num_favorites?new R(this.rawMetadata.num_favorites):void 0}get num_reviews(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.num_reviews?new R(this.rawMetadata.num_reviews):void 0}get openlibrary_edition(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.openlibrary_edition?new T(this.rawMetadata.openlibrary_edition):void 0}get openlibrary_work(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.openlibrary_work?new T(this.rawMetadata.openlibrary_work):void 0}get page_progression(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.page_progression?new wo(this.rawMetadata.page_progression):void 0}get partner(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.partner?new T(this.rawMetadata.partner):void 0}get ppi(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.ppi?new R(this.rawMetadata.ppi):void 0}get publicdate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.publicdate?new J(this.rawMetadata.publicdate):void 0}get publisher(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.publisher?new T(this.rawMetadata.publisher):void 0}get reviewdate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.reviewdate?new J(this.rawMetadata.reviewdate):void 0}get runtime(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.runtime?new Di(this.rawMetadata.runtime):void 0}get scanner(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.scanner?new T(this.rawMetadata.scanner):void 0}get source(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.source?new T(this.rawMetadata.source):void 0}get start_localtime(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.start_localtime?new J(this.rawMetadata.start_localtime):void 0}get start_time(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.start_time?new J(this.rawMetadata.start_time):void 0}get stop_time(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.stop_time?new J(this.rawMetadata.stop_time):void 0}get subject(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.subject?new _o(this.rawMetadata.subject):void 0}get taper(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.taper?new T(this.rawMetadata.taper):void 0}get title(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.title?new T(this.rawMetadata.title):void 0}get transferer(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.transferer?new T(this.rawMetadata.transferer):void 0}get track(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.track?new R(this.rawMetadata.track):void 0}get type(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.type?new T(this.rawMetadata.type):void 0}get uploader(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.uploader?new T(this.rawMetadata.uploader):void 0}get utc_offset(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.utc_offset?new R(this.rawMetadata.utc_offset):void 0}get venue(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.venue?new T(this.rawMetadata.venue):void 0}get volume(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.volume?new T(this.rawMetadata.volume):void 0}get week(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.week?new R(this.rawMetadata.week):void 0}get year(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.year?new J(this.rawMetadata.year):void 0}}s([g()],C.prototype,"addeddate",null);s([g()],C.prototype,"audio_codec",null);s([g()],C.prototype,"audio_sample_rate",null);s([g()],C.prototype,"avg_rating",null);s([g()],C.prototype,"collection",null);s([g()],C.prototype,"collections_raw",null);s([g()],C.prototype,"collection_size",null);s([g()],C.prototype,"contributor",null);s([g()],C.prototype,"coverage",null);s([g()],C.prototype,"creator",null);s([g()],C.prototype,"date",null);s([g()],C.prototype,"description",null);s([g()],C.prototype,"downloads",null);s([g()],C.prototype,"duration",null);s([g()],C.prototype,"external-identifier",null);s([g()],C.prototype,"files_count",null);s([g()],C.prototype,"indexdate",null);s([g()],C.prototype,"isbn",null);s([g()],C.prototype,"issue",null);s([g()],C.prototype,"item_count",null);s([g()],C.prototype,"item_size",null);s([g()],C.prototype,"language",null);s([g()],C.prototype,"length",null);s([g()],C.prototype,"lineage",null);s([g()],C.prototype,"month",null);s([g()],C.prototype,"mediatype",null);s([g()],C.prototype,"noindex",null);s([g()],C.prototype,"notes",null);s([g()],C.prototype,"num_favorites",null);s([g()],C.prototype,"num_reviews",null);s([g()],C.prototype,"openlibrary_edition",null);s([g()],C.prototype,"openlibrary_work",null);s([g()],C.prototype,"page_progression",null);s([g()],C.prototype,"partner",null);s([g()],C.prototype,"ppi",null);s([g()],C.prototype,"publicdate",null);s([g()],C.prototype,"publisher",null);s([g()],C.prototype,"reviewdate",null);s([g()],C.prototype,"runtime",null);s([g()],C.prototype,"scanner",null);s([g()],C.prototype,"source",null);s([g()],C.prototype,"start_localtime",null);s([g()],C.prototype,"start_time",null);s([g()],C.prototype,"stop_time",null);s([g()],C.prototype,"subject",null);s([g()],C.prototype,"taper",null);s([g()],C.prototype,"title",null);s([g()],C.prototype,"transferer",null);s([g()],C.prototype,"track",null);s([g()],C.prototype,"type",null);s([g()],C.prototype,"uploader",null);s([g()],C.prototype,"utc_offset",null);s([g()],C.prototype,"venue",null);s([g()],C.prototype,"volume",null);s([g()],C.prototype,"week",null);s([g()],C.prototype,"year",null);class D{constructor(e){this.rawMetadata=e}get identifier(){var e,t;return(t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.identifier}get addeddate(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.addeddate?new J(this.rawMetadata.fields.addeddate):void 0}get avg_rating(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.avg_rating)!=null?new R(this.rawMetadata.fields.avg_rating):void 0}get collection(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.collection?new T(this.rawMetadata.fields.collection):void 0}get collection_files_count(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.collection_files_count)!=null?new R(this.rawMetadata.fields.collection_files_count):void 0}get collection_size(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.collection_size)!=null?new hi(this.rawMetadata.fields.collection_size):void 0}get creator(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.creator?new T(this.rawMetadata.fields.creator):void 0}get date(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.date?new J(this.rawMetadata.fields.date):void 0}get description(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.description?new T(this.rawMetadata.fields.description):void 0}get downloads(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.downloads)!=null?new R(this.rawMetadata.fields.downloads):void 0}get files_count(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.files_count)!=null?new R(this.rawMetadata.fields.files_count):void 0}get genre(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.genre?new T(this.rawMetadata.fields.genre):void 0}get indexflag(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.indexflag?new T(this.rawMetadata.fields.indexflag):void 0}get issue(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.issue?new T(this.rawMetadata.fields.issue):void 0}get item_count(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.item_count)!=null?new R(this.rawMetadata.fields.item_count):void 0}get item_size(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.item_size)!=null?new hi(this.rawMetadata.fields.item_size):void 0}get language(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.language?new T(this.rawMetadata.fields.language):void 0}get lending___available_to_borrow(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.lending___available_to_borrow)!=null?new vt(this.rawMetadata.fields.lending___available_to_borrow):void 0}get lending___available_to_browse(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.lending___available_to_browse)!=null?new vt(this.rawMetadata.fields.lending___available_to_browse):void 0}get lending___available_to_waitlist(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.lending___available_to_waitlist)!=null?new vt(this.rawMetadata.fields.lending___available_to_waitlist):void 0}get lending___status(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.lending___status?new T(this.rawMetadata.fields.lending___status):void 0}get licenseurl(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.licenseurl?new T(this.rawMetadata.fields.licenseurl):void 0}get mediatype(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.mediatype?new ma(this.rawMetadata.fields.mediatype):void 0}get month(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.month)!=null?new R(this.rawMetadata.fields.month):void 0}get noindex(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.noindex)!=null?new vt(this.rawMetadata.fields.noindex):void 0}get num_favorites(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.num_favorites)!=null?new R(this.rawMetadata.fields.num_favorites):void 0}get num_reviews(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.num_reviews)!=null?new R(this.rawMetadata.fields.num_reviews):void 0}get source(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.source?new T(this.rawMetadata.fields.source):void 0}get subject(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.subject?new T(this.rawMetadata.fields.subject):void 0}get title(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.title?new T(this.rawMetadata.fields.title):void 0}get type(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.type?new T(this.rawMetadata.fields.type):void 0}get volume(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.volume?new T(this.rawMetadata.fields.volume):void 0}get week(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.week)!=null?new R(this.rawMetadata.fields.week):void 0}get year(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.year)!=null?new R(this.rawMetadata.fields.year):void 0}}s([g()],D.prototype,"addeddate",null);s([g()],D.prototype,"avg_rating",null);s([g()],D.prototype,"collection",null);s([g()],D.prototype,"collection_files_count",null);s([g()],D.prototype,"collection_size",null);s([g()],D.prototype,"creator",null);s([g()],D.prototype,"date",null);s([g()],D.prototype,"description",null);s([g()],D.prototype,"downloads",null);s([g()],D.prototype,"files_count",null);s([g()],D.prototype,"genre",null);s([g()],D.prototype,"indexflag",null);s([g()],D.prototype,"issue",null);s([g()],D.prototype,"item_count",null);s([g()],D.prototype,"item_size",null);s([g()],D.prototype,"language",null);s([g()],D.prototype,"lending___available_to_borrow",null);s([g()],D.prototype,"lending___available_to_browse",null);s([g()],D.prototype,"lending___available_to_waitlist",null);s([g()],D.prototype,"lending___status",null);s([g()],D.prototype,"licenseurl",null);s([g()],D.prototype,"mediatype",null);s([g()],D.prototype,"month",null);s([g()],D.prototype,"noindex",null);s([g()],D.prototype,"num_favorites",null);s([g()],D.prototype,"num_reviews",null);s([g()],D.prototype,"source",null);s([g()],D.prototype,"subject",null);s([g()],D.prototype,"title",null);s([g()],D.prototype,"type",null);s([g()],D.prototype,"volume",null);s([g()],D.prototype,"week",null);s([g()],D.prototype,"year",null);class B{constructor(e){this.rawMetadata=e}get identifier(){var e,t;return(t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.identifier}get highlight(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.highlight)===null||t===void 0)&&t.text?new T(this.rawMetadata.highlight.text):void 0}get addeddate(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.addeddate?new J(this.rawMetadata.fields.addeddate):void 0}get avg_rating(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.avg_rating)!=null?new R(this.rawMetadata.fields.avg_rating):void 0}get collection(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.collection?new T(this.rawMetadata.fields.collection):void 0}get created_on(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.created_on?new J(this.rawMetadata.fields.created_on):void 0}get creator(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.creator?new T(this.rawMetadata.fields.creator):void 0}get date(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.date?new J(this.rawMetadata.fields.date):void 0}get description(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.description?new T(this.rawMetadata.fields.description):void 0}get downloads(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.downloads)!=null?new R(this.rawMetadata.fields.downloads):void 0}get filename(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.filename?new T(this.rawMetadata.fields.filename):void 0}get file_basename(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.file_basename?new T(this.rawMetadata.fields.file_basename):void 0}get file_creation_mtime(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.file_creation_mtime)!=null?new R(this.rawMetadata.fields.file_creation_mtime):void 0}get issue(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.issue?new T(this.rawMetadata.fields.issue):void 0}get mediatype(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.mediatype?new ma(this.rawMetadata.fields.mediatype):void 0}get page_num(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.page_num)!=null?new R(this.rawMetadata.fields.page_num):void 0}get publicdate(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.publicdate?new J(this.rawMetadata.fields.publicdate):void 0}get result_in_subfile(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.result_in_subfile)!=null?new vt(this.rawMetadata.fields.result_in_subfile):void 0}get reviewdate(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.reviewdate?new J(this.rawMetadata.fields.reviewdate):void 0}get source(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.source?new T(this.rawMetadata.fields.source):void 0}get subject(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.subject?new T(this.rawMetadata.fields.subject):void 0}get title(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.title?new T(this.rawMetadata.fields.title):void 0}get updated_on(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.updated_on?new J(this.rawMetadata.fields.updated_on):void 0}get year(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.year)!=null?new R(this.rawMetadata.fields.year):void 0}get __href__(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.__href__?new T(this.rawMetadata.fields.__href__):void 0}}s([g()],B.prototype,"highlight",null);s([g()],B.prototype,"addeddate",null);s([g()],B.prototype,"avg_rating",null);s([g()],B.prototype,"collection",null);s([g()],B.prototype,"created_on",null);s([g()],B.prototype,"creator",null);s([g()],B.prototype,"date",null);s([g()],B.prototype,"description",null);s([g()],B.prototype,"downloads",null);s([g()],B.prototype,"filename",null);s([g()],B.prototype,"file_basename",null);s([g()],B.prototype,"file_creation_mtime",null);s([g()],B.prototype,"issue",null);s([g()],B.prototype,"mediatype",null);s([g()],B.prototype,"page_num",null);s([g()],B.prototype,"publicdate",null);s([g()],B.prototype,"result_in_subfile",null);s([g()],B.prototype,"reviewdate",null);s([g()],B.prototype,"source",null);s([g()],B.prototype,"subject",null);s([g()],B.prototype,"title",null);s([g()],B.prototype,"updated_on",null);s([g()],B.prototype,"year",null);s([g()],B.prototype,"__href__",null);var bt;(function(r){r[r.COUNT=0]="COUNT",r[r.ALPHABETICAL=1]="ALPHABETICAL"})(bt||(bt={}));class $r{constructor(e){this.buckets=e.buckets,this.doc_count_error_upper_bound=e.doc_count_error_upper_bound,this.sum_other_doc_count=e.sum_other_doc_count,this.first_bucket_key=e.first_bucket_key,this.last_bucket_key=e.last_bucket_key,this.number_buckets=e.number_buckets,this.interval=e.interval}getSortedBuckets(e){if(typeof this.buckets[0]=="number")return[...this.buckets];const t=new Intl.Collator;switch(e){case bt.ALPHABETICAL:return[...this.buckets].sort((i,a)=>t.compare(i.key.toString(),a.key.toString()));case bt.COUNT:default:return[...this.buckets]}}}s([g()],$r.prototype,"getSortedBuckets",null);class va{constructor(e,t){var i,a,o,n,l,d,u;this.schema=t;const m=t==null?void 0:t.hit_type;this.totalResults=(a=(i=e==null?void 0:e.hits)===null||i===void 0?void 0:i.total)!==null&&a!==void 0?a:0,this.returnedCount=(n=(o=e==null?void 0:e.hits)===null||o===void 0?void 0:o.returned)!==null&&n!==void 0?n:0,this.results=(u=(d=(l=e==null?void 0:e.hits)===null||l===void 0?void 0:l.hits)===null||d===void 0?void 0:d.map(v=>va.createResult(m,v)))!==null&&u!==void 0?u:[],e!=null&&e.aggregations&&(this.aggregations=Object.entries(e.aggregations).reduce((v,[b,x])=>(v[b]=new $r(x),v),{}))}static createResult(e,t){switch(e){case"item":return new D(t);case"text":return new B(t);default:return t}}}class So{constructor(e){this.clientParameters=e.client_parameters,this.finalizedParameters=e.finalized_parameters}}class Co{constructor(e){var t,i,a;this.rawResponse=e,this.request=new So(e.request),this.responseHeader=(t=e.response)===null||t===void 0?void 0:t.header,this.response=new va((i=e.response)===null||i===void 0?void 0:i.body,(a=e.response)===null||a===void 0?void 0:a.hit_schema)}}class kr{static aggregateSearchParamsAsString(e){if(e.omit)return"false";if(e.advancedParams){const t=e.advancedParams.map(a=>({terms:a}));return JSON.stringify(t)}if(e.simpleParams)return e.simpleParams.join(",")}static sortParamsAsString(e){return`${e.field}:${e.direction}`}static filterParamsAsString(e){return JSON.stringify(e)}static generateURLSearchParams(e){const t=new URLSearchParams;if(t.append("user_query",e.query),e.pageType&&t.append("page_type",String(e.pageType)),e.pageTarget&&t.append("page_target",String(e.pageTarget)),e.rows!=null&&t.append("hits_per_page",String(e.rows)),e.page!=null&&t.append("page",String(e.page)),e.fields&&e.fields.length>0&&t.append("fields",e.fields.join(",")),e.filters&&Object.keys(e.filters).length>0){const a=this.filterParamsAsString(e.filters);a&&a!=="{}"&&t.append("filter_map",a)}if(e.sort&&e.sort.length>0){const a=e.sort.map(o=>this.sortParamsAsString(o));t.append("sort",a.join(","))}const i=e.aggregations;if(i){const a=this.aggregateSearchParamsAsString(i);a&&t.append("aggregations",a)}return e.aggregationsSize!=null&&t.append("aggregations_size",String(e.aggregationsSize)),e.debugging&&t.append("debugging","true"),e.uid&&t.append("uid",e.uid),e.includeClientUrl!==!1&&t.append("client_url",window.location.href),t}}var Nt;(function(r){r.networkError="SearchService.NetworkError",r.itemNotFound="SearchService.ItemNotFound",r.decodingError="SearchService.DecodingError",r.searchEngineError="SearchService.SearchEngineError"})(Nt||(Nt={}));class $o extends Error{constructor(e,t,i){super(t),this.name=e,this.type=e,this.details=i}}class Tr{constructor(e){var t,i;if(this.baseUrl=(t=e==null?void 0:e.baseUrl)!==null&&t!==void 0?t:"archive.org",this.debuggingEnabled=(i=e==null?void 0:e.debuggingEnabled)!==null&&i!==void 0?i:!1,(e==null?void 0:e.includeCredentials)!==void 0?this.includeCredentials=e.includeCredentials:this.includeCredentials=window.location.href.match(/^https?:\/\/.*archive\.org(:[0-9]+)?/)!==null,(e==null?void 0:e.scope)!==void 0)this.requestScope=e.scope;else{const o=new URL(window.location.href).searchParams.get("scope");o&&(this.requestScope=o)}}async fetchUrl(e,t){var i;const a=new URL(e);this.requestScope&&a.searchParams.set("scope",this.requestScope);let o;try{const n=(i=t==null?void 0:t.requestOptions)!==null&&i!==void 0?i:{credentials:this.includeCredentials?"include":"same-origin"};o=await fetch(a.href,n)}catch(n){const l=n instanceof Error?n.message:typeof n=="string"?n:"Unknown error";return this.getErrorResult(Nt.networkError,l)}try{const n=await o.json();n.debugging&&this.printDebuggingInfo(n);const l=n.error;if(l){const d=n.forensics;return this.getErrorResult(Nt.searchEngineError,l,d)}else return{success:n}}catch(n){const l=n instanceof Error?n.message:typeof n=="string"?n:"Unknown error";return this.getErrorResult(Nt.decodingError,l)}}getErrorResult(e,t,i){return{error:new $o(e,t,i)}}printDebuggingInfo(e){var t,i;const a=e.debugging,o=(t=a.messages)!==null&&t!==void 0?t:[],n=(i=a.data)!==null&&i!==void 0?i:{};console.log("***** BEGIN DEBUGGING *****"),console.log("Full response:"),console.log(JSON.stringify(e,null,2)),console.group("Debug messages");for(const l of o)console.log(l);console.groupEnd(),console.group("Debug data");for(const[l,d]of Object.entries(n))console.log(l,d);console.groupEnd(),console.log("***** END DEBUGGING *****")}}class ko extends Tr{constructor(e){var t;super(e),this.servicePath=(t=e==null?void 0:e.servicePath)!==null&&t!==void 0?t:"/services/search/beta/page_production"}async performSearch(e){this.debuggingEnabled&&e.debugging===void 0&&(e.debugging=!0);const i=kr.generateURLSearchParams(e).toString(),a=`https://${this.baseUrl}${this.servicePath}/?service_backend=metadata&${i}`;return this.fetchUrl(a)}}class To extends Tr{constructor(e){var t;super(e),this.servicePath=(t=e==null?void 0:e.servicePath)!==null&&t!==void 0?t:"/services/search/beta/page_production"}async performSearch(e){this.debuggingEnabled&&e.debugging===void 0&&(e.debugging=!0);const i=kr.generateURLSearchParams(e).toString(),a=`https://${this.baseUrl}${this.servicePath}/?service_backend=fts&${i}`;return this.fetchUrl(a)}}var le;(function(r){r[r.METADATA=0]="METADATA",r[r.FULLTEXT=1]="FULLTEXT"})(le||(le={}));class Pe{constructor(e={}){this.backendOptions=e}async search(e,t=le.METADATA){const a=await Pe.getBackendForSearchType(t,this.backendOptions).performSearch(e);return a.error?a:{success:new Co(a.success)}}static getBackendForSearchType(e,t={}){switch(e){case le.FULLTEXT:return new To(t);case le.METADATA:default:return new ko(t)}}}Pe.default=new Pe;s([g((r,e={})=>{const{includeCredentials:t="",scope:i="",baseUrl:a=""}=e;return`${r};${t};${i};${a}`})],Pe,"getBackendForSearchType",null);var ft;(function(r){r.INCLUDE="inc",r.EXCLUDE="exc",r.GREATER_THAN="gt",r.GREATER_OR_EQUAL="gte",r.LESS_THAN="lt",r.LESS_OR_EQUAL="lte"})(ft||(ft={}));class zo{constructor(){this.filterMap={}}addFilter(e,t,i){if(this.filterMap[e]||(this.filterMap[e]={}),this.filterMap[e][t]){const a=[].concat(this.filterMap[e][t],i);this.filterMap[e][t]=Array.from(new Set(a))}else this.filterMap[e][t]=i;return this}removeSingleFilter(e,t,i){var a;if(!(!((a=this.filterMap[e])===null||a===void 0)&&a[t]))return this;const o=[].concat(this.filterMap[e][t]),n=o.indexOf(i);return n>=0&&o.splice(n,1),this.filterMap[e][t]=o.length===1?o[0]:o,o.length===0&&delete this.filterMap[e][t],this.deleteFieldIfEmpty(e),this}removeFilters(e,t){return this.filterMap[e]?(delete this.filterMap[e][t],this.deleteFieldIfEmpty(e),this):this}deleteFieldIfEmpty(e){const t=this.filterMap[e];t&&Object.keys(t).length===0&&delete this.filterMap[e]}setFilterMap(e){return this.filterMap=se({},e),this}mergeFilterMap(e){for(const[t,i]of Object.entries(e))for(const[a,o]of Object.entries(i))if(Array.isArray(o))for(const n of o)this.addFilter(t,a,n);else this.addFilter(t,a,o);return this}build(){return this.filterMap}}function Mo(){var r=!navigator.userAgentData&&/Safari\//.test(navigator.userAgent)&&!/Chrom(e|ium)\//.test(navigator.userAgent);if(!r||!indexedDB.databases)return Promise.resolve();var e;return new Promise(function(t){var i=function(){return indexedDB.databases().finally(t)};e=setInterval(i,100),i()}).finally(function(){return clearInterval(e)})}function kt(r){return new Promise((e,t)=>{r.oncomplete=r.onsuccess=()=>e(r.result),r.onabort=r.onerror=()=>t(r.error)})}function Eo(r,e){const t=Mo().then(()=>{const i=indexedDB.open(r);return i.onupgradeneeded=()=>i.result.createObjectStore(e),kt(i)});return(i,a)=>t.then(o=>a(o.transaction(e,i).objectStore(e)))}let Fi;function Si(){return Fi||(Fi=Eo("keyval-store","keyval")),Fi}function Lo(r,e=Si()){return e("readonly",t=>kt(t.get(r)))}function Ao(r,e,t=Si()){return t("readwrite",i=>(i.put(e,r),kt(i.transaction)))}function Po(r,e=Si()){return e("readwrite",t=>(t.delete(r),kt(t.transaction)))}function Do(r,e){return r.openCursor().onsuccess=function(){!this.result||(e(this.result),this.result.continue())},kt(r.transaction)}function Fo(r=Si()){return r("readonly",e=>{if(e.getAllKeys)return kt(e.getAllKeys());const t=[];return Do(e,i=>t.push(i.key)).then(()=>t)})}function Io(r,e){return r.setMilliseconds(r.getMilliseconds()+e*1e3),r}class Oo{constructor(e){var t,i,a,o;if(this.namespace=(t=e==null?void 0:e.namespace)!==null&&t!==void 0?t:"LocalCache",this.defaultTTL=(i=e==null?void 0:e.defaultTTL)!==null&&i!==void 0?i:15*60,(!((a=e==null?void 0:e.immediateClean)!==null&&a!==void 0)||a)&&this.cleanExpired(),!(e!=null&&e.disableCleaning)){const n=(o=e==null?void 0:e.cleaningInterval)!==null&&o!==void 0?o:60;setInterval(()=>{this.cleanExpired()},n*1e3)}}async set(e){var t;const i={value:e.value},a=(t=e.ttl)!==null&&t!==void 0?t:this.defaultTTL,o=Io(new Date,a);i.expires=o;const n=this.getNamespacedKey(e.key);try{await Ao(n,i)}catch{}}async get(e){const t=this.getNamespacedKey(e);let i;try{i=await Lo(t)}catch{}if(!i)return;const a=new Date;if(i.expires&&i.expires<a){await this.delete(e);return}return i.value}async delete(e){const t=this.getNamespacedKey(e);try{await Po(t)}catch{}}async cleanExpired(){const e=await this.getAllKeys();await Promise.all(e.map(async t=>this.get(t)))}async getAllKeys(){let e=[];try{e=await Fo()}catch{}const t=[];for(const o of e)typeof o=="string"&&t.push(o);return t.filter(o=>o.startsWith(this.namespace)).map(o=>this.removeNamespace(o))}getNamespacedKey(e){return`${this.namespace}-${e}`}removeNamespace(e){return e.replace(`${this.namespace}-`,"")}}/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const fa=window.ShadowRoot&&(window.ShadyCSS===void 0||window.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,ga=Symbol(),ja=new Map;class zr{constructor(e,t){if(this._$cssResult$=!0,t!==ga)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e}get styleSheet(){let e=ja.get(this.cssText);return fa&&e===void 0&&(ja.set(this.cssText,e=new CSSStyleSheet),e.replaceSync(this.cssText)),e}toString(){return this.cssText}}const Ro=r=>new zr(typeof r=="string"?r:r+"",ga),f=(r,...e)=>{const t=r.length===1?r[0]:e.reduce((i,a,o)=>i+(n=>{if(n._$cssResult$===!0)return n.cssText;if(typeof n=="number")return n;throw Error("Value passed to 'css' function must be a 'css' function result: "+n+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(a)+r[o+1],r[0]);return new zr(t,ga)},Bo=(r,e)=>{fa?r.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet):e.forEach(t=>{const i=document.createElement("style"),a=window.litNonce;a!==void 0&&i.setAttribute("nonce",a),i.textContent=t.cssText,r.appendChild(i)})},Wa=fa?r=>r:r=>r instanceof CSSStyleSheet?(e=>{let t="";for(const i of e.cssRules)t+=i.cssText;return Ro(t)})(r):r;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Ii;const Va=window.trustedTypes,No=Va?Va.emptyScript:"",Ga=window.reactiveElementPolyfillSupport,ia={toAttribute(r,e){switch(e){case Boolean:r=r?No:null;break;case Object:case Array:r=r==null?r:JSON.stringify(r)}return r},fromAttribute(r,e){let t=r;switch(e){case Boolean:t=r!==null;break;case Number:t=r===null?null:Number(r);break;case Object:case Array:try{t=JSON.parse(r)}catch{t=null}}return t}},Mr=(r,e)=>e!==r&&(e==e||r==r),Oi={attribute:!0,type:String,converter:ia,reflect:!1,hasChanged:Mr};class mt extends HTMLElement{constructor(){super(),this._$Et=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Ei=null,this.o()}static addInitializer(e){var t;(t=this.l)!==null&&t!==void 0||(this.l=[]),this.l.push(e)}static get observedAttributes(){this.finalize();const e=[];return this.elementProperties.forEach((t,i)=>{const a=this._$Eh(i,t);a!==void 0&&(this._$Eu.set(a,i),e.push(a))}),e}static createProperty(e,t=Oi){if(t.state&&(t.attribute=!1),this.finalize(),this.elementProperties.set(e,t),!t.noAccessor&&!this.prototype.hasOwnProperty(e)){const i=typeof e=="symbol"?Symbol():"__"+e,a=this.getPropertyDescriptor(e,i,t);a!==void 0&&Object.defineProperty(this.prototype,e,a)}}static getPropertyDescriptor(e,t,i){return{get(){return this[t]},set(a){const o=this[e];this[t]=a,this.requestUpdate(e,o,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)||Oi}static finalize(){if(this.hasOwnProperty("finalized"))return!1;this.finalized=!0;const e=Object.getPrototypeOf(this);if(e.finalize(),this.elementProperties=new Map(e.elementProperties),this._$Eu=new Map,this.hasOwnProperty("properties")){const t=this.properties,i=[...Object.getOwnPropertyNames(t),...Object.getOwnPropertySymbols(t)];for(const a of i)this.createProperty(a,t[a])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const i=new Set(e.flat(1/0).reverse());for(const a of i)t.unshift(Wa(a))}else e!==void 0&&t.push(Wa(e));return t}static _$Eh(e,t){const i=t.attribute;return i===!1?void 0:typeof i=="string"?i:typeof e=="string"?e.toLowerCase():void 0}o(){var e;this._$Ep=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$Em(),this.requestUpdate(),(e=this.constructor.l)===null||e===void 0||e.forEach(t=>t(this))}addController(e){var t,i;((t=this._$Eg)!==null&&t!==void 0?t:this._$Eg=[]).push(e),this.renderRoot!==void 0&&this.isConnected&&((i=e.hostConnected)===null||i===void 0||i.call(e))}removeController(e){var t;(t=this._$Eg)===null||t===void 0||t.splice(this._$Eg.indexOf(e)>>>0,1)}_$Em(){this.constructor.elementProperties.forEach((e,t)=>{this.hasOwnProperty(t)&&(this._$Et.set(t,this[t]),delete this[t])})}createRenderRoot(){var e;const t=(e=this.shadowRoot)!==null&&e!==void 0?e:this.attachShadow(this.constructor.shadowRootOptions);return Bo(t,this.constructor.elementStyles),t}connectedCallback(){var e;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$Eg)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostConnected)===null||i===void 0?void 0:i.call(t)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$Eg)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostDisconnected)===null||i===void 0?void 0:i.call(t)})}attributeChangedCallback(e,t,i){this._$AK(e,i)}_$ES(e,t,i=Oi){var a,o;const n=this.constructor._$Eh(e,i);if(n!==void 0&&i.reflect===!0){const l=((o=(a=i.converter)===null||a===void 0?void 0:a.toAttribute)!==null&&o!==void 0?o:ia.toAttribute)(t,i.type);this._$Ei=e,l==null?this.removeAttribute(n):this.setAttribute(n,l),this._$Ei=null}}_$AK(e,t){var i,a,o;const n=this.constructor,l=n._$Eu.get(e);if(l!==void 0&&this._$Ei!==l){const d=n.getPropertyOptions(l),u=d.converter,m=(o=(a=(i=u)===null||i===void 0?void 0:i.fromAttribute)!==null&&a!==void 0?a:typeof u=="function"?u:null)!==null&&o!==void 0?o:ia.fromAttribute;this._$Ei=l,this[l]=m(t,d.type),this._$Ei=null}}requestUpdate(e,t,i){let a=!0;e!==void 0&&(((i=i||this.constructor.getPropertyOptions(e)).hasChanged||Mr)(this[e],t)?(this._$AL.has(e)||this._$AL.set(e,t),i.reflect===!0&&this._$Ei!==e&&(this._$EC===void 0&&(this._$EC=new Map),this._$EC.set(e,i))):a=!1),!this.isUpdatePending&&a&&(this._$Ep=this._$E_())}async _$E_(){this.isUpdatePending=!0;try{await this._$Ep}catch(t){Promise.reject(t)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var e;if(!this.isUpdatePending)return;this.hasUpdated,this._$Et&&(this._$Et.forEach((a,o)=>this[o]=a),this._$Et=void 0);let t=!1;const i=this._$AL;try{t=this.shouldUpdate(i),t?(this.willUpdate(i),(e=this._$Eg)===null||e===void 0||e.forEach(a=>{var o;return(o=a.hostUpdate)===null||o===void 0?void 0:o.call(a)}),this.update(i)):this._$EU()}catch(a){throw t=!1,this._$EU(),a}t&&this._$AE(i)}willUpdate(e){}_$AE(e){var t;(t=this._$Eg)===null||t===void 0||t.forEach(i=>{var a;return(a=i.hostUpdated)===null||a===void 0?void 0:a.call(i)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EU(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$Ep}shouldUpdate(e){return!0}update(e){this._$EC!==void 0&&(this._$EC.forEach((t,i)=>this._$ES(i,this[i],t)),this._$EC=void 0),this._$EU()}updated(e){}firstUpdated(e){}}mt.finalized=!0,mt.elementProperties=new Map,mt.elementStyles=[],mt.shadowRootOptions={mode:"open"},Ga==null||Ga({ReactiveElement:mt}),((Ii=globalThis.reactiveElementVersions)!==null&&Ii!==void 0?Ii:globalThis.reactiveElementVersions=[]).push("1.3.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Ri;const yt=globalThis.trustedTypes,Qa=yt?yt.createPolicy("lit-html",{createHTML:r=>r}):void 0,Me=`lit$${(Math.random()+"").slice(9)}$`,ba="?"+Me,Ho=`<${ba}>`,wt=document,jt=(r="")=>wt.createComment(r),Wt=r=>r===null||typeof r!="object"&&typeof r!="function",Er=Array.isArray,Lr=r=>{var e;return Er(r)||typeof((e=r)===null||e===void 0?void 0:e[Symbol.iterator])=="function"},Ot=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,qa=/-->/g,Ka=/>/g,Ge=/>|[ 	\n\r](?:([^\s"'>=/]+)([ 	\n\r]*=[ 	\n\r]*(?:[^ 	\n\r"'`<>=]|("|')|))|$)/g,Ya=/'/g,Xa=/"/g,Ar=/^(?:script|style|textarea|title)$/i,Pr=r=>(e,...t)=>({_$litType$:r,strings:e,values:t}),p=Pr(1),P=Pr(2),me=Symbol.for("lit-noChange"),w=Symbol.for("lit-nothing"),Za=new WeakMap,oi=(r,e,t)=>{var i,a;const o=(i=t==null?void 0:t.renderBefore)!==null&&i!==void 0?i:e;let n=o._$litPart$;if(n===void 0){const l=(a=t==null?void 0:t.renderBefore)!==null&&a!==void 0?a:null;o._$litPart$=n=new Tt(e.insertBefore(jt(),l),l,void 0,t!=null?t:{})}return n._$AI(r),n},gt=wt.createTreeWalker(wt,129,null,!1),Dr=(r,e)=>{const t=r.length-1,i=[];let a,o=e===2?"<svg>":"",n=Ot;for(let d=0;d<t;d++){const u=r[d];let m,v,b=-1,x=0;for(;x<u.length&&(n.lastIndex=x,v=n.exec(u),v!==null);)x=n.lastIndex,n===Ot?v[1]==="!--"?n=qa:v[1]!==void 0?n=Ka:v[2]!==void 0?(Ar.test(v[2])&&(a=RegExp("</"+v[2],"g")),n=Ge):v[3]!==void 0&&(n=Ge):n===Ge?v[0]===">"?(n=a!=null?a:Ot,b=-1):v[1]===void 0?b=-2:(b=n.lastIndex-v[2].length,m=v[1],n=v[3]===void 0?Ge:v[3]==='"'?Xa:Ya):n===Xa||n===Ya?n=Ge:n===qa||n===Ka?n=Ot:(n=Ge,a=void 0);const k=n===Ge&&r[d+1].startsWith("/>")?" ":"";o+=n===Ot?u+Ho:b>=0?(i.push(m),u.slice(0,b)+"$lit$"+u.slice(b)+Me+k):u+Me+(b===-2?(i.push(void 0),d):k)}const l=o+(r[t]||"<?>")+(e===2?"</svg>":"");if(!Array.isArray(r)||!r.hasOwnProperty("raw"))throw Error("invalid template strings array");return[Qa!==void 0?Qa.createHTML(l):l,i]};class Vt{constructor({strings:e,_$litType$:t},i){let a;this.parts=[];let o=0,n=0;const l=e.length-1,d=this.parts,[u,m]=Dr(e,t);if(this.el=Vt.createElement(u,i),gt.currentNode=this.el.content,t===2){const v=this.el.content,b=v.firstChild;b.remove(),v.append(...b.childNodes)}for(;(a=gt.nextNode())!==null&&d.length<l;){if(a.nodeType===1){if(a.hasAttributes()){const v=[];for(const b of a.getAttributeNames())if(b.endsWith("$lit$")||b.startsWith(Me)){const x=m[n++];if(v.push(b),x!==void 0){const k=a.getAttribute(x.toLowerCase()+"$lit$").split(Me),M=/([.?@])?(.*)/.exec(x);d.push({type:1,index:o,name:M[2],strings:k,ctor:M[1]==="."?Ir:M[1]==="?"?Or:M[1]==="@"?Rr:Yt})}else d.push({type:6,index:o})}for(const b of v)a.removeAttribute(b)}if(Ar.test(a.tagName)){const v=a.textContent.split(Me),b=v.length-1;if(b>0){a.textContent=yt?yt.emptyScript:"";for(let x=0;x<b;x++)a.append(v[x],jt()),gt.nextNode(),d.push({type:2,index:++o});a.append(v[b],jt())}}}else if(a.nodeType===8)if(a.data===ba)d.push({type:2,index:o});else{let v=-1;for(;(v=a.data.indexOf(Me,v+1))!==-1;)d.push({type:7,index:o}),v+=Me.length-1}o++}}static createElement(e,t){const i=wt.createElement("template");return i.innerHTML=e,i}}function Je(r,e,t=r,i){var a,o,n,l;if(e===me)return e;let d=i!==void 0?(a=t._$Cl)===null||a===void 0?void 0:a[i]:t._$Cu;const u=Wt(e)?void 0:e._$litDirective$;return(d==null?void 0:d.constructor)!==u&&((o=d==null?void 0:d._$AO)===null||o===void 0||o.call(d,!1),u===void 0?d=void 0:(d=new u(r),d._$AT(r,t,i)),i!==void 0?((n=(l=t)._$Cl)!==null&&n!==void 0?n:l._$Cl=[])[i]=d:t._$Cu=d),d!==void 0&&(e=Je(r,d._$AS(r,e.values),d,i)),e}class Fr{constructor(e,t){this.v=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}p(e){var t;const{el:{content:i},parts:a}=this._$AD,o=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:wt).importNode(i,!0);gt.currentNode=o;let n=gt.nextNode(),l=0,d=0,u=a[0];for(;u!==void 0;){if(l===u.index){let m;u.type===2?m=new Tt(n,n.nextSibling,this,e):u.type===1?m=new u.ctor(n,u.name,u.strings,this,e):u.type===6&&(m=new Br(n,this,e)),this.v.push(m),u=a[++d]}l!==(u==null?void 0:u.index)&&(n=gt.nextNode(),l++)}return o}m(e){let t=0;for(const i of this.v)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class Tt{constructor(e,t,i,a){var o;this.type=2,this._$AH=w,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=a,this._$Cg=(o=a==null?void 0:a.isConnected)===null||o===void 0||o}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cg}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&e.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Je(this,e,t),Wt(e)?e===w||e==null||e===""?(this._$AH!==w&&this._$AR(),this._$AH=w):e!==this._$AH&&e!==me&&this.$(e):e._$litType$!==void 0?this.T(e):e.nodeType!==void 0?this.k(e):Lr(e)?this.S(e):this.$(e)}M(e,t=this._$AB){return this._$AA.parentNode.insertBefore(e,t)}k(e){this._$AH!==e&&(this._$AR(),this._$AH=this.M(e))}$(e){this._$AH!==w&&Wt(this._$AH)?this._$AA.nextSibling.data=e:this.k(wt.createTextNode(e)),this._$AH=e}T(e){var t;const{values:i,_$litType$:a}=e,o=typeof a=="number"?this._$AC(e):(a.el===void 0&&(a.el=Vt.createElement(a.h,this.options)),a);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===o)this._$AH.m(i);else{const n=new Fr(o,this),l=n.p(this.options);n.m(i),this.k(l),this._$AH=n}}_$AC(e){let t=Za.get(e.strings);return t===void 0&&Za.set(e.strings,t=new Vt(e)),t}S(e){Er(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,a=0;for(const o of e)a===t.length?t.push(i=new Tt(this.M(jt()),this.M(jt()),this,this.options)):i=t[a],i._$AI(o),a++;a<t.length&&(this._$AR(i&&i._$AB.nextSibling,a),t.length=a)}_$AR(e=this._$AA.nextSibling,t){var i;for((i=this._$AP)===null||i===void 0||i.call(this,!1,!0,t);e&&e!==this._$AB;){const a=e.nextSibling;e.remove(),e=a}}setConnected(e){var t;this._$AM===void 0&&(this._$Cg=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}}class Yt{constructor(e,t,i,a,o){this.type=1,this._$AH=w,this._$AN=void 0,this.element=e,this.name=t,this._$AM=a,this.options=o,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=w}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,i,a){const o=this.strings;let n=!1;if(o===void 0)e=Je(this,e,t,0),n=!Wt(e)||e!==this._$AH&&e!==me,n&&(this._$AH=e);else{const l=e;let d,u;for(e=o[0],d=0;d<o.length-1;d++)u=Je(this,l[i+d],t,d),u===me&&(u=this._$AH[d]),n||(n=!Wt(u)||u!==this._$AH[d]),u===w?e=w:e!==w&&(e+=(u!=null?u:"")+o[d+1]),this._$AH[d]=u}n&&!a&&this.C(e)}C(e){e===w?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e!=null?e:"")}}class Ir extends Yt{constructor(){super(...arguments),this.type=3}C(e){this.element[this.name]=e===w?void 0:e}}const Uo=yt?yt.emptyScript:"";class Or extends Yt{constructor(){super(...arguments),this.type=4}C(e){e&&e!==w?this.element.setAttribute(this.name,Uo):this.element.removeAttribute(this.name)}}class Rr extends Yt{constructor(e,t,i,a,o){super(e,t,i,a,o),this.type=5}_$AI(e,t=this){var i;if((e=(i=Je(this,e,t,0))!==null&&i!==void 0?i:w)===me)return;const a=this._$AH,o=e===w&&a!==w||e.capture!==a.capture||e.once!==a.once||e.passive!==a.passive,n=e!==w&&(a===w||o);o&&this.element.removeEventListener(this.name,this,a),n&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,i;typeof this._$AH=="function"?this._$AH.call((i=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&i!==void 0?i:this.element,e):this._$AH.handleEvent(e)}}class Br{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){Je(this,e)}}const jo={L:"$lit$",P:Me,V:ba,I:1,N:Dr,R:Fr,j:Lr,D:Je,H:Tt,F:Yt,O:Or,W:Rr,B:Ir,Z:Br},Ja=window.litHtmlPolyfillSupport;Ja==null||Ja(Vt,Tt),((Ri=globalThis.litHtmlVersions)!==null&&Ri!==void 0?Ri:globalThis.litHtmlVersions=[]).push("2.2.4");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Bi,Ni;class E extends mt{constructor(){super(...arguments),this.renderOptions={host:this},this._$Dt=void 0}createRenderRoot(){var e,t;const i=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=i.firstChild),i}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Dt=oi(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Dt)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Dt)===null||e===void 0||e.setConnected(!1)}render(){return me}}E.finalized=!0,E._$litElement$=!0,(Bi=globalThis.litElementHydrateSupport)===null||Bi===void 0||Bi.call(globalThis,{LitElement:E});const er=globalThis.litElementPolyfillSupport;er==null||er({LitElement:E});((Ni=globalThis.litElementVersions)!==null&&Ni!==void 0?Ni:globalThis.litElementVersions=[]).push("3.2.0");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Wo=(r,e)=>e.kind==="method"&&e.descriptor&&!("value"in e.descriptor)?ht(se({},e),{finisher(t){t.createProperty(e.key,r)}}):{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){typeof e.initializer=="function"&&(this[e.key]=e.initializer.call(this))},finisher(t){t.createProperty(e.key,r)}};function c(r){return(e,t)=>t!==void 0?((i,a,o)=>{a.constructor.createProperty(o,i)})(r,e,t):Wo(r,e)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function $(r){return c(ht(se({},r),{state:!0}))}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Nr=({finisher:r,descriptor:e})=>(t,i)=>{var a;if(i===void 0){const o=(a=t.originalKey)!==null&&a!==void 0?a:t.key,n=e!=null?{kind:"method",placement:"prototype",key:o,descriptor:e(t.key)}:ht(se({},t),{key:o});return r!=null&&(n.finisher=function(l){r(l,o)}),n}{const o=t.constructor;e!==void 0&&Object.defineProperty(t,i,e(i)),r==null||r(o,i)}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function te(r,e){return Nr({descriptor:t=>{const i={get(){var a,o;return(o=(a=this.renderRoot)===null||a===void 0?void 0:a.querySelector(r))!==null&&o!==void 0?o:null},enumerable:!0,configurable:!0};if(e){const a=typeof t=="symbol"?Symbol():"__"+t;i.get=function(){var o,n;return this[a]===void 0&&(this[a]=(n=(o=this.renderRoot)===null||o===void 0?void 0:o.querySelector(r))!==null&&n!==void 0?n:null),this[a]}}return i}})}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */const ir=(r,e,t)=>{const i=new Map;for(let a=e;a<=t;a++)i.set(r[a],a);return i},Ur=Ci(class extends $i{constructor(r){if(super(r),r.type!==ze.CHILD)throw Error("repeat() can only be used in text expressions")}dt(r,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);const a=[],o=[];let n=0;for(const l of r)a[n]=i?i(l,n):n,o[n]=t(l,n),n++;return{values:o,keys:a}}render(r,e,t){return this.dt(r,e,t).values}update(r,[e,t,i]){var a;const o=Xo(r),{values:n,keys:l}=this.dt(e,t,i);if(!Array.isArray(o))return this.ut=l,n;const d=(a=this.ut)!==null&&a!==void 0?a:this.ut=[],u=[];let m,v,b=0,x=o.length-1,k=0,M=n.length-1;for(;b<=x&&k<=M;)if(o[b]===null)b++;else if(o[x]===null)x--;else if(d[b]===l[k])u[k]=Qe(o[b],n[k]),b++,k++;else if(d[x]===l[M])u[M]=Qe(o[x],n[M]),x--,M--;else if(d[b]===l[M])u[M]=Qe(o[b],n[M]),Rt(r,u[M+1],o[b]),b++,M--;else if(d[x]===l[k])u[k]=Qe(o[x],n[k]),Rt(r,o[b],o[x]),x--,k++;else if(m===void 0&&(m=ir(l,k,M),v=ir(d,b,x)),m.has(d[b]))if(m.has(d[x])){const I=v.get(l[k]),N=I!==void 0?o[I]:null;if(N===null){const W=Rt(r,o[b]);Qe(W,n[k]),u[k]=W}else u[k]=Qe(N,n[k]),Rt(r,o[b],N),o[I]=null;k++}else Ui(o[x]),x--;else Ui(o[b]),b++;for(;k<=M;){const I=Rt(r,u[M+1]);Qe(I,n[k]),u[k++]=I}for(;b<=x;){const I=o[b++];I!==null&&Ui(I)}return this.ut=l,Hr(r,u),me}});function ii(r,e,t){return Array.from({length:(e-r)/t+1},(i,a)=>r+a*t)}let De=class extends E{constructor(){super(...arguments),this.itemCount=0,this.scrollOptimizationsDisabled=!1,this.intersectionObserver=new IntersectionObserver(e=>{e.forEach(t=>{if(t.target===this.sentinel){t.isIntersecting&&this.dispatchEvent(new Event("scrollThresholdReached"));return}const a=t.target.dataset.cellIndex;if(!a)return;const o=parseInt(a,10);t.isIntersecting?this.visibleCellIndices.add(o):this.visibleCellIndices.delete(o)}),this.scrollOptimizationsDisabled||this.processVisibleCells()}),this.renderedCellIndices=new Set,this.visibleCellIndices=new Set,this.placeholderCellIndices=new Set}reload(){ii(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.removeCell(t)),this.renderedCellIndices.clear(),this.visibleCellIndices.clear(),this.placeholderCellIndices.clear(),this.setupObservations()}scrollToCell(e,t){const i=this.cellContainers[e];if(!i)return!1;const a=t?"smooth":"auto";return i.scrollIntoView({behavior:a}),!0}getVisibleCellIndices(){return Array.from(this.visibleCellIndices)}updated(e){(e.has("itemCount")||e.has("scrollOptimizationsDisabled"))&&this.setupObservations()}disconnectedCallback(){this.intersectionObserver.disconnect()}setupObservations(){this.setupIntersectionObserver()}setupIntersectionObserver(){this.intersectionObserver.disconnect(),this.sentinel&&this.intersectionObserver.observe(this.sentinel),this.scrollOptimizationsDisabled?(ii(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.visibleCellIndices.add(t)),this.processVisibleCells()):this.cellContainers.forEach(e=>this.intersectionObserver.observe(e))}render(){const e=this.itemCount-1,t=ii(0,e,1);return p`
    ...
    `}};s([c({type:Number})],De.prototype,"itemCount",void 0);s([c({type:Object})],De.prototype,"cellProvider",void 0);s([c({type:Object})],De.prototype,"placeholderCellTemplate",void 0);s([c({type:Boolean})],De.prototype,"scrollOptimizationsDisabled",void 0);s([te("#sentinel")],De.prototype,"sentinel",void 0);s([Vo(".cell-container")],De.prototype,"cellContainers",void 0);De=s([F("infinite-scroller")],De);/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ui=r=>r!=null?r:w,jr=P`
...
`;var aa;(function(r){r[r.bytes=0]="bytes",r[r.kilobytes=1]="kilobytes",r[r.megabytes=2]="megabytes",r[r.gigabytes=3]="gigabytes",r[r.terabytes=4]="terabytes",r[r.petabytes=5]="petabytes",r[r.exabytes=6]="exabytes",r[r.zettabytes=7]="zettabytes",r[r.yottabytes=8]="yottabytes"})(aa||(aa={}));function Zo(r,e,t=" "){let i=r;if(i===void 0)return w;let a=0;for(;i>1024;)i/=1024,a+=1;const o=10**e;i=Math.round(i*o)/o;let n=aa[a];return n=i===1?n.slice(0,-1):n,`${i.toLocaleString()+t+n}`}const Jo=f`var(--tileBackgroundColor, #ffffff)`,es=f`var(--tileCornerRadius, 4px)`,ya=f`
  .container {
    background-color: ${Jo};
    border: 1px #2c2c2c;
    border-radius: ${es};
...
`;let Qt=class extends E{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1,this.isCompactTile=!1}render(){return p`<div class="icon-overlay ${this.getClass}">
      ${this.iconDisplay}
    </div>`}get getClass(){return this.isCompactTile?"list-compact":"list-detail"}get iconDisplay(){return this.loginRequired&&!this.loggedIn?p`${Vr}`:p`${Wr}`}static get styles(){return f`
      :host {
        position: absolute;
        top: 50%;
        left: 50%;
    ...
    `}};s([c({type:Boolean})],Qt.prototype,"loggedIn",void 0);s([c({type:Boolean})],Qt.prototype,"loginRequired",void 0);s([c({type:Boolean})],Qt.prototype,"isCompactTile",void 0);Qt=s([F("icon-overlay")],Qt);let qt=class extends E{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1,this.iconRequired=!1}render(){return p`
      <div class="overlay no-preview">
        <div class="icon-overlay">${this.iconDisplay}</div>
        <p class="text-overlay">${this.textDisplay}</p>
      </div>
    `}get iconDisplay(){return this.loginRequired&&!this.loggedIn?p`${Vr}`:p`${Wr}`}get textDisplay(){return this.loginRequired&&!this.loggedIn?p`Log in to view this item`:p`Content may be inappropriate`}static get styles(){return f`
      :host {
        align-items: center;
        display: flex;
      }
    ...
    `}};s([c({type:Boolean})],qt.prototype,"loggedIn",void 0);s([c({type:Boolean})],qt.prototype,"loginRequired",void 0);s([c({type:Boolean})],qt.prototype,"iconRequired",void 0);qt=s([F("text-overlay")],qt);let Fe=class extends E{constructor(){super(...arguments),this.isCompactTile=!1,this.isListTile=!1,this.loggedIn=!1,this.viewSize="desktop"}render(){var e;return!((e=this.model)===null||e===void 0)&&e.identifier?p`
    ...
    >`}get getSizeTemplate(){var e,t;const i=(t=(e=this.model)===null||e===void 0?void 0:e.collectionSize)!==null&&t!==void 0?t:0;return i?p`<span id="item-size">${Zo(i,1)}</span>`:""}static get styles(){const e=f`var(--tileBorderColor, #555555)`,t=f`var(--tileBackgroundColor, #666666)`,i=f`#fff`;return[ya,f`
        .container {
          background-color: ${t};
          border: 1px solid ${e};
        }
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*si(r,e){const t=typeof e=="function";if(r!==void 0){let i=-1;for(const a of r)i>-1&&(yield t?e(i):e),i++,yield a}}let fi=class extends E{constructor(){super(...arguments),this.snippets=[],this.viewSize="desktop"}render(){var e;return!((e=this.snippets)===null||e===void 0)&&e.length?p`
      <div class="container">
    ...
    `}};s([c({type:Array})],fi.prototype,"snippets",void 0);s([c({type:String})],fi.prototype,"viewSize",void 0);fi=s([F("text-snippet-block")],fi);const ts=f`
  .drop-shadow {
    overflow: hidden;
    height: 100%;
  }
...
`;let Ee=class extends E{constructor(){super(...arguments),this.isListTile=!1,this.isCompactTile=!1,this.loggedIn=!1,this.isWaveform=!1}render(){return p`
...
`,ms={account:{color:"#000000",icon:as,text:"Account"},audio:{color:"#00adef",icon:rs,text:"Audio"},collection:{color:"#4666ff",icon:jr,text:"Collection"},data:{color:"#333333",icon:os,text:"Data"},etree:{color:"#00adef",icon:ss,text:"E-tree"},film:{color:"#bf1b2c",icon:ar,text:"Film"},image:{color:"#aa99c9",icon:ns,text:"Image"},movies:{color:"#f1644b",icon:ar,text:"Movie"},radio:{color:"#8fdaef",icon:ls,text:"Radio"},software:{color:"#9ecc4f",icon:ds,text:"Software"},texts:{color:"#faab3c",icon:cs,text:"Text"},tv:{color:"#f1644b",icon:hs,text:"TV"},video:{color:"#f1644b",icon:ps,text:"Video"},web:{color:"#ffcd27",icon:us,text:"Web"}};let Kt=class extends E{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var e,t;const i=["tvnews","tvarchive","television"],a=["radio","radioprogram"];return this.mediatype==="movies"&&((e=this.collections)===null||e===void 0?void 0:e.some(o=>i.indexOf(o)>=0))?"tv":this.mediatype==="audio"&&((t=this.collections)===null||t===void 0?void 0:t.some(o=>a.indexOf(o)>=0))?"radio":this.mediatype||""}render(){const e=ms[this.displayMediatype];return e?p`
      <div
        id="icon"
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ys=(r,...e)=>({strTag:!0,strings:r,values:e}),pt=ys,ws=r=>typeof r!="string"&&"strTag"in r,xs=(r,e,t)=>{let i=r[0];for(let a=1;a<r.length;a++)i+=e[t?t[a-1]:a-1],i+=r[a];return i};/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const _s=r=>ws(r)?xs(r.strings,r.values):r;/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class Ss{constructor(){this.settled=!1,this.promise=new Promise((e,t)=>{this._resolve=e,this._reject=t})}resolve(e){this.settled=!0,this._resolve(e)}reject(e){this.settled=!0,this._reject(e)}}/**
 * @license
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let Cs=new Ss;Cs.resolve();/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let ut=_s;function $s(r,e){let t=1;return r>=1e9?t=1e9:r>=1e6?t=1e6:r>=1e3&&e==="short"&&(t=1e3),t}function ks(r=0,e){const t=r/e,i=t<10;let a=0;return i?a=Math.round((t+Number.EPSILON)*10)/10:a=Math.round(t),a}function Ts(r,e,t,i){switch(e){case 1e9:return ut(t==="short"?pt`${r}B`:pt`${r} billion`);case 1e6:return ut(t==="short"?pt`${r}M`:pt`${r} million`);case 1e3:return ut(t==="short"?pt`${r}K`:pt`${r} thousand`);default:return new Intl.NumberFormat(i).format(r)}}function Ht(r,e="long",t="short",i="en-US"){const a=r!=null?r:-1;if(a<0)return"";const o=$s(a,e),n=ks(a,o);return Ts(n,o,t,i)}let et=class extends E{render(){const e=Ht(this.favCount,"short","short"),t=Ht(this.commentCount,"short","short"),i=this.mediatype==="account"?`${this.itemCount} uploads`:`${this.viewCount} all-time views`;return p`
    ...
    `}get doesSortedByDate(){var e;return["date","reviewdate","addeddate","publicdate"].includes((e=this.sortParam)===null||e===void 0?void 0:e.field)}get hasSnippets(){var e,t;return!!(!((t=(e=this.model)===null||e===void 0?void 0:e.snippets)===null||t===void 0)&&t.length)}static get styles(){const e=f`var(--tileBorderColor, #dddddd)`;return[ya,f`
      ...
      `]}};s([c({type:String})],xt.prototype,"baseImageUrl",void 0);s([c({type:Boolean})],xt.prototype,"loggedIn",void 0);s([c({type:Object})],xt.prototype,"model",void 0);s([c({type:Object})],xt.prototype,"sortParam",void 0);xt=s([F("item-tile")],xt);let gi=class extends E{render(){return p`
      <div class="container">
        <div class="tile-details">
          <div class="item-info">
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class oa extends $i{constructor(e){if(super(e),this.it=w,e.type!==ze.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===w||e==null)return this.ft=void 0,this.it=e;if(e===me)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this.ft;this.it=e;const t=[e];return t.raw=t,this.ft={_$litType$:this.constructor.resultType,strings:t,values:[]}}}oa.directiveName="unsafeHTML",oa.resultType=1;const zs=Ci(oa);/*! @license DOMPurify 2.3.8 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/2.3.8/LICENSE */function Ye(r){return Ye=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},Ye(r)}function sa(r,e){return sa=Object.setPrototypeOf||function(i,a){return i.__proto__=a,i},sa(r,e)}function Ms(){if(typeof Reflect=="undefined"||!Reflect.construct||Reflect.construct.sham)return!1;if(typeof Proxy=="function")return!0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],function(){})),!0}catch{return!1}}function ni(r,e,t){return Ms()?ni=Reflect.construct:ni=function(a,o,n){var l=[null];l.push.apply(l,o);var d=Function.bind.apply(a,l),u=new d;return n&&sa(u,n.prototype),u},ni.apply(null,arguments)}function ge(r){return Es(r)||Ls(r)||As(r)||Ps()}function Es(r){if(Array.isArray(r))return na(r)}function Ls(r){if(typeof Symbol!="undefined"&&r[Symbol.iterator]!=null||r["@@iterator"]!=null)return Array.from(r)}function As(r,e){if(!!r){if(typeof r=="string")return na(r,e);var t=Object.prototype.toString.call(r).slice(8,-1);if(t==="Object"&&r.constructor&&(t=r.constructor.name),t==="Map"||t==="Set")return Array.from(r);if(t==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t))return na(r,e)}}function na(r,e){(e==null||e>r.length)&&(e=r.length);for(var t=0,i=new Array(e);t<e;t++)i[t]=r[t];return i}function Ps(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}var Ds=Object.hasOwnProperty,rr=Object.setPrototypeOf,Fs=Object.isFrozen,Is=Object.getPrototypeOf,Os=Object.getOwnPropertyDescriptor,de=Object.freeze,_e=Object.seal,Rs=Object.create,Gr=typeof Reflect!="undefined"&&Reflect,bi=Gr.apply,la=Gr.construct;bi||(bi=function(e,t,i){return e.apply(t,i)});de||(de=function(e){return e});_e||(_e=function(e){return e});la||(la=function(e,t){return ni(e,ge(t))});var Bs=be(Array.prototype.forEach),or=be(Array.prototype.pop),Bt=be(Array.prototype.push),li=be(String.prototype.toLowerCase),Ns=be(String.prototype.match),Ae=be(String.prototype.replace),Hs=be(String.prototype.indexOf),Us=be(String.prototype.trim),ne=be(RegExp.prototype.test),ji=js(TypeError);function be(r){return function(e){for(var t=arguments.length,i=new Array(t>1?t-1:0),a=1;a<t;a++)i[a-1]=arguments[a];return bi(r,e,i)}}function js(r){return function(){for(var e=arguments.length,t=new Array(e),i=0;i<e;i++)t[i]=arguments[i];return la(r,t)}}function L(r,e){rr&&rr(r,null);for(var t=e.length;t--;){var i=e[t];if(typeof i=="string"){var a=li(i);a!==i&&(Fs(e)||(e[t]=a),i=a)}r[i]=!0}return r}function qe(r){var e=Rs(null),t;for(t in r)bi(Ds,r,[t])&&(e[t]=r[t]);return e}function ai(r,e){for(;r!==null;){var t=Os(r,e);if(t){if(t.get)return be(t.get);if(typeof t.value=="function")return be(t.value)}r=Is(r)}function i(a){return console.warn("fallback value for",a),null}return i}var sr=de(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","section","select","shadow","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),Wi=de(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","filter","font","g","glyph","glyphref","hkern","image","line","lineargradient","marker","mask","metadata","mpath","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),Vi=de(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),Ws=de(["animate","color-profile","cursor","discard","fedropshadow","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),Gi=de(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover"]),Vs=de(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),nr=de(["#text"]),lr=de(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","face","for","headers","height","hidden","high","href","hreflang","id","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","pattern","placeholder","playsinline","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","xmlns","slot"]),Qi=de(["accent-height","accumulate","additive","alignment-baseline","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),dr=de(["accent","accentunder","align","bevelled","close","columnsalign","columnlines","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lspace","lquote","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),ri=de(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),Gs=_e(/\{\{[\w\W]*|[\w\W]*\}\}/gm),Qs=_e(/<%[\w\W]*|[\w\W]*%>/gm),qs=_e(/^data-[\-\w.\u00B7-\uFFFF]/),Ks=_e(/^aria-[\-\w]+$/),Ys=_e(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|cid|xmpp):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),Xs=_e(/^(?:\w+script|data):/i),Zs=_e(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),Js=_e(/^html$/i),en=function(){return typeof window=="undefined"?null:window},tn=function(e,t){if(Ye(e)!=="object"||typeof e.createPolicy!="function")return null;var i=null,a="data-tt-policy-suffix";t.currentScript&&t.currentScript.hasAttribute(a)&&(i=t.currentScript.getAttribute(a));var o="dompurify"+(i?"#"+i:"");try{return e.createPolicy(o,{createHTML:function(l){return l}})}catch{return console.warn("TrustedTypes policy "+o+" could not be created."),null}};function Qr(){var r=arguments.length>0&&arguments[0]!==void 0?arguments[0]:en(),e=function(h){return Qr(h)};if(e.version="2.3.8",e.removed=[],!r||!r.document||r.document.nodeType!==9)return e.isSupported=!1,e;var t=r.document,i=r.document,a=r.DocumentFragment,o=r.HTMLTemplateElement,n=r.Node,l=r.Element,d=r.NodeFilter,u=r.NamedNodeMap,m=u===void 0?r.NamedNodeMap||r.MozNamedAttrMap:u,v=r.HTMLFormElement,b=r.DOMParser,x=r.trustedTypes,k=l.prototype,M=ai(k,"cloneNode"),I=ai(k,"nextSibling"),N=ai(k,"childNodes"),W=ai(k,"parentNode");if(typeof o=="function"){var re=i.createElement("template");re.content&&re.content.ownerDocument&&(i=re.content.ownerDocument)}var K=tn(x,t),pe=K?K.createHTML(""):"",ue=i,we=ue.implementation,zt=ue.createNodeIterator,Mt=ue.createDocumentFragment,Et=ue.getElementsByTagName,Lt=t.importNode,tt={};try{tt=qe(i).documentMode?i.documentMode:{}}catch{}var ce={};e.isSupported=typeof W=="function"&&we&&typeof we.createHTMLDocument!="undefined"&&tt!==9;var Re=Gs,Be=Qs,At=qs,Pt=Ks,Dt=Xs,it=Zs,Ne=Ys,V=null,at=L({},[].concat(ge(sr),ge(Wi),ge(Vi),ge(Gi),ge(nr))),G=null,rt=L({},[].concat(ge(lr),ge(Qi),ge(dr),ge(ri))),H=Object.seal(Object.create(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),Ce=null,He=null,ot=!0,Ue=!0,st=!1,xe=!1,fe=!1,je=!1,We=!1,$e=!1,Xt=!1,Zt=!1,Ca=!0,ki=!0,Ft=!1,nt={},lt=null,$a=L({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","style","svg","template","thead","title","video","xmp"]),ka=null,Ta=L({},["audio","video","img","source","image","track"]),Ti=null,za=L({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),zi="http://www.w3.org/1998/Math/MathML",Mi="http://www.w3.org/2000/svg",Le="http://www.w3.org/1999/xhtml",Jt=Le,Ei=!1,dt,to=["application/xhtml+xml","text/html"],io="text/html",Ve,ct=null,ao=i.createElement("form"),Ma=function(h){return h instanceof RegExp||h instanceof Function},Li=function(h){ct&&ct===h||((!h||Ye(h)!=="object")&&(h={}),h=qe(h),V="ALLOWED_TAGS"in h?L({},h.ALLOWED_TAGS):at,G="ALLOWED_ATTR"in h?L({},h.ALLOWED_ATTR):rt,Ti="ADD_URI_SAFE_ATTR"in h?L(qe(za),h.ADD_URI_SAFE_ATTR):za,ka="ADD_DATA_URI_TAGS"in h?L(qe(Ta),h.ADD_DATA_URI_TAGS):Ta,lt="FORBID_CONTENTS"in h?L({},h.FORBID_CONTENTS):$a,Ce="FORBID_TAGS"in h?L({},h.FORBID_TAGS):{},He="FORBID_ATTR"in h?L({},h.FORBID_ATTR):{},nt="USE_PROFILES"in h?h.USE_PROFILES:!1,ot=h.ALLOW_ARIA_ATTR!==!1,Ue=h.ALLOW_DATA_ATTR!==!1,st=h.ALLOW_UNKNOWN_PROTOCOLS||!1,xe=h.SAFE_FOR_TEMPLATES||!1,fe=h.WHOLE_DOCUMENT||!1,$e=h.RETURN_DOM||!1,Xt=h.RETURN_DOM_FRAGMENT||!1,Zt=h.RETURN_TRUSTED_TYPE||!1,We=h.FORCE_BODY||!1,Ca=h.SANITIZE_DOM!==!1,ki=h.KEEP_CONTENT!==!1,Ft=h.IN_PLACE||!1,Ne=h.ALLOWED_URI_REGEXP||Ne,Jt=h.NAMESPACE||Le,h.CUSTOM_ELEMENT_HANDLING&&Ma(h.CUSTOM_ELEMENT_HANDLING.tagNameCheck)&&(H.tagNameCheck=h.CUSTOM_ELEMENT_HANDLING.tagNameCheck),h.CUSTOM_ELEMENT_HANDLING&&Ma(h.CUSTOM_ELEMENT_HANDLING.attributeNameCheck)&&(H.attributeNameCheck=h.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),h.CUSTOM_ELEMENT_HANDLING&&typeof h.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements=="boolean"&&(H.allowCustomizedBuiltInElements=h.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements),dt=to.indexOf(h.PARSER_MEDIA_TYPE)===-1?dt=io:dt=h.PARSER_MEDIA_TYPE,Ve=dt==="application/xhtml+xml"?function(y){return y}:li,xe&&(Ue=!1),Xt&&($e=!0),nt&&(V=L({},ge(nr)),G=[],nt.html===!0&&(L(V,sr),L(G,lr)),nt.svg===!0&&(L(V,Wi),L(G,Qi),L(G,ri)),nt.svgFilters===!0&&(L(V,Vi),L(G,Qi),L(G,ri)),nt.mathMl===!0&&(L(V,Gi),L(G,dr),L(G,ri))),h.ADD_TAGS&&(V===at&&(V=qe(V)),L(V,h.ADD_TAGS)),h.ADD_ATTR&&(G===rt&&(G=qe(G)),L(G,h.ADD_ATTR)),h.ADD_URI_SAFE_ATTR&&L(Ti,h.ADD_URI_SAFE_ATTR),h.FORBID_CONTENTS&&(lt===$a&&(lt=qe(lt)),L(lt,h.FORBID_CONTENTS)),ki&&(V["#text"]=!0),fe&&L(V,["html","head","body"]),V.table&&(L(V,["tbody"]),delete Ce.tbody),de&&de(h),ct=h)},Ea=L({},["mi","mo","mn","ms","mtext"]),La=L({},["foreignobject","desc","title","annotation-xml"]),ro=L({},["title","style","font","a","script"]),ei=L({},Wi);L(ei,Vi),L(ei,Ws);var Ai=L({},Gi);L(Ai,Vs);var oo=function(h){var y=W(h);(!y||!y.tagName)&&(y={namespaceURI:Le,tagName:"template"});var _=li(h.tagName),O=li(y.tagName);return h.namespaceURI===Mi?y.namespaceURI===Le?_==="svg":y.namespaceURI===zi?_==="svg"&&(O==="annotation-xml"||Ea[O]):Boolean(ei[_]):h.namespaceURI===zi?y.namespaceURI===Le?_==="math":y.namespaceURI===Mi?_==="math"&&La[O]:Boolean(Ai[_]):h.namespaceURI===Le?y.namespaceURI===Mi&&!La[O]||y.namespaceURI===zi&&!Ea[O]?!1:!Ai[_]&&(ro[_]||!ei[_]):!1},ke=function(h){Bt(e.removed,{element:h});try{h.parentNode.removeChild(h)}catch{try{h.outerHTML=pe}catch{h.remove()}}},Aa=function(h,y){try{Bt(e.removed,{attribute:y.getAttributeNode(h),from:y})}catch{Bt(e.removed,{attribute:null,from:y})}if(y.removeAttribute(h),h==="is"&&!G[h])if($e||Xt)try{ke(y)}catch{}else try{y.setAttribute(h,"")}catch{}},Pa=function(h){var y,_;if(We)h="<remove></remove>"+h;else{var O=Ns(h,/^[\r\n\t ]+/);_=O&&O[0]}dt==="application/xhtml+xml"&&(h='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+h+"</body></html>");var he=K?K.createHTML(h):h;if(Jt===Le)try{y=new b().parseFromString(he,dt)}catch{}if(!y||!y.documentElement){y=we.createDocument(Jt,"template",null);try{y.documentElement.innerHTML=Ei?"":he}catch{}}var ie=y.body||y.documentElement;return h&&_&&ie.insertBefore(i.createTextNode(_),ie.childNodes[0]||null),Jt===Le?Et.call(y,fe?"html":"body")[0]:fe?y.documentElement:ie},Da=function(h){return zt.call(h.ownerDocument||h,h,d.SHOW_ELEMENT|d.SHOW_COMMENT|d.SHOW_TEXT,null,!1)},so=function(h){return h instanceof v&&(typeof h.nodeName!="string"||typeof h.textContent!="string"||typeof h.removeChild!="function"||!(h.attributes instanceof m)||typeof h.removeAttribute!="function"||typeof h.setAttribute!="function"||typeof h.namespaceURI!="string"||typeof h.insertBefore!="function")},It=function(h){return Ye(n)==="object"?h instanceof n:h&&Ye(h)==="object"&&typeof h.nodeType=="number"&&typeof h.nodeName=="string"},Te=function(h,y,_){!ce[h]||Bs(ce[h],function(O){O.call(e,y,_,ct)})},Fa=function(h){var y;if(Te("beforeSanitizeElements",h,null),so(h)||ne(/[\u0080-\uFFFF]/,h.nodeName))return ke(h),!0;var _=Ve(h.nodeName);if(Te("uponSanitizeElement",h,{tagName:_,allowedTags:V}),h.hasChildNodes()&&!It(h.firstElementChild)&&(!It(h.content)||!It(h.content.firstElementChild))&&ne(/<[/\w]/g,h.innerHTML)&&ne(/<[/\w]/g,h.textContent)||_==="select"&&ne(/<template/i,h.innerHTML))return ke(h),!0;if(!V[_]||Ce[_]){if(!Ce[_]&&Oa(_)&&(H.tagNameCheck instanceof RegExp&&ne(H.tagNameCheck,_)||H.tagNameCheck instanceof Function&&H.tagNameCheck(_)))return!1;if(ki&&!lt[_]){var O=W(h)||h.parentNode,he=N(h)||h.childNodes;if(he&&O)for(var ie=he.length,X=ie-1;X>=0;--X)O.insertBefore(M(he[X],!0),I(h))}return ke(h),!0}return h instanceof l&&!oo(h)||(_==="noscript"||_==="noembed")&&ne(/<\/no(script|embed)/i,h.innerHTML)?(ke(h),!0):(xe&&h.nodeType===3&&(y=h.textContent,y=Ae(y,Re," "),y=Ae(y,Be," "),h.textContent!==y&&(Bt(e.removed,{element:h.cloneNode()}),h.textContent=y)),Te("afterSanitizeElements",h,null),!1)},Ia=function(h,y,_){if(Ca&&(y==="id"||y==="name")&&(_ in i||_ in ao))return!1;if(!(Ue&&!He[y]&&ne(At,y))){if(!(ot&&ne(Pt,y))){if(!G[y]||He[y]){if(!(Oa(h)&&(H.tagNameCheck instanceof RegExp&&ne(H.tagNameCheck,h)||H.tagNameCheck instanceof Function&&H.tagNameCheck(h))&&(H.attributeNameCheck instanceof RegExp&&ne(H.attributeNameCheck,y)||H.attributeNameCheck instanceof Function&&H.attributeNameCheck(y))||y==="is"&&H.allowCustomizedBuiltInElements&&(H.tagNameCheck instanceof RegExp&&ne(H.tagNameCheck,_)||H.tagNameCheck instanceof Function&&H.tagNameCheck(_))))return!1}else if(!Ti[y]){if(!ne(Ne,Ae(_,it,""))){if(!((y==="src"||y==="xlink:href"||y==="href")&&h!=="script"&&Hs(_,"data:")===0&&ka[h])){if(!(st&&!ne(Dt,Ae(_,it,"")))){if(_)return!1}}}}}}return!0},Oa=function(h){return h.indexOf("-")>0},Ra=function(h){var y,_,O,he;Te("beforeSanitizeAttributes",h,null);var ie=h.attributes;if(!!ie){var X={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:G};for(he=ie.length;he--;){y=ie[he];var ti=y,oe=ti.name,Ba=ti.namespaceURI;if(_=oe==="value"?y.value:Us(y.value),O=Ve(oe),X.attrName=O,X.attrValue=_,X.keepAttr=!0,X.forceKeepAttr=void 0,Te("uponSanitizeAttribute",h,X),_=X.attrValue,!X.forceKeepAttr&&(Aa(oe,h),!!X.keepAttr)){if(ne(/\/>/i,_)){Aa(oe,h);continue}xe&&(_=Ae(_,Re," "),_=Ae(_,Be," "));var lo=Ve(h.nodeName);if(!!Ia(lo,O,_))try{Ba?h.setAttributeNS(Ba,oe,_):h.setAttribute(oe,_),or(e.removed)}catch{}}}Te("afterSanitizeAttributes",h,null)}},no=function S(h){var y,_=Da(h);for(Te("beforeSanitizeShadowDOM",h,null);y=_.nextNode();)Te("uponSanitizeShadowNode",y,null),!Fa(y)&&(y.content instanceof a&&S(y.content),Ra(y));Te("afterSanitizeShadowDOM",h,null)};return e.sanitize=function(S,h){var y,_,O,he,ie;if(Ei=!S,Ei&&(S="<!-->"),typeof S!="string"&&!It(S)){if(typeof S.toString!="function")throw ji("toString is not a function");if(S=S.toString(),typeof S!="string")throw ji("dirty is not a string, aborting")}if(!e.isSupported){if(Ye(r.toStaticHTML)==="object"||typeof r.toStaticHTML=="function"){if(typeof S=="string")return r.toStaticHTML(S);if(It(S))return r.toStaticHTML(S.outerHTML)}return S}if(je||Li(h),e.removed=[],typeof S=="string"&&(Ft=!1),Ft){if(S.nodeName){var X=Ve(S.nodeName);if(!V[X]||Ce[X])throw ji("root node is forbidden and cannot be sanitized in-place")}}else if(S instanceof n)y=Pa("<!---->"),_=y.ownerDocument.importNode(S,!0),_.nodeType===1&&_.nodeName==="BODY"||_.nodeName==="HTML"?y=_:y.appendChild(_);else{if(!$e&&!xe&&!fe&&S.indexOf("<")===-1)return K&&Zt?K.createHTML(S):S;if(y=Pa(S),!y)return $e?null:Zt?pe:""}y&&We&&ke(y.firstChild);for(var ti=Da(Ft?S:y);O=ti.nextNode();)O.nodeType===3&&O===he||Fa(O)||(O.content instanceof a&&no(O.content),Ra(O),he=O);if(he=null,Ft)return S;if($e){if(Xt)for(ie=Mt.call(y.ownerDocument);y.firstChild;)ie.appendChild(y.firstChild);else ie=y;return G.shadowroot&&(ie=Lt.call(t,ie,!0)),ie}var oe=fe?y.outerHTML:y.innerHTML;return fe&&V["!doctype"]&&y.ownerDocument&&y.ownerDocument.doctype&&y.ownerDocument.doctype.name&&ne(Js,y.ownerDocument.doctype.name)&&(oe="<!DOCTYPE "+y.ownerDocument.doctype.name+`>
`+oe),xe&&(oe=Ae(oe,Re," "),oe=Ae(oe,Be," ")),K&&Zt?K.createHTML(oe):oe},e.setConfig=function(S){Li(S),je=!0},e.clearConfig=function(){ct=null,je=!1},e.isValidAttribute=function(S,h,y){ct||Li({});var _=Ve(S),O=Ve(h);return Ia(_,O,y)},e.addHook=function(S,h){typeof h=="function"&&(ce[S]=ce[S]||[],Bt(ce[S],h))},e.removeHook=function(S){if(ce[S])return or(ce[S])},e.removeHooks=function(S){ce[S]&&(ce[S]=[])},e.removeAllHooks=function(){ce={}},e}var Ut=Qr(),A;(function(r){r.relevance="relevance",r.alltimeview="alltimeview",r.weeklyview="weeklyview",r.title="title",r.datearchived="datearchived",r.date="date",r.datereviewed="datereviewed",r.dateadded="dateadded",r.creator="creator"})(A||(A={}));const Ke={relevance:"Relevance",alltimeview:"All-time Views",weeklyview:"Weekly Views",title:"Title",datearchived:"Date Archived",date:"Date Published",datereviewed:"Date Reviewed",dateadded:"Date Added",creator:"Creator"},an={relevance:null,alltimeview:"downloads",weeklyview:"week",title:"titleSorter",datearchived:"publicdate",date:"date",datereviewed:"reviewdate",dateadded:"addeddate",creator:"creatorSorter"},cr={week:A.weeklyview,downloads:A.alltimeview,titleSorter:A.title,date:A.date,publicdate:A.datearchived,reviewdate:A.datereviewed,addeddate:A.dateadded,creatorSorter:A.creator},rn={title:"firstTitle",creator:"firstCreator"},yi={subject:{},lending:{},mediatype:{},language:{},creator:{},collection:{},year:{}},on=["mediatype","lending","year","subject","collection","creator","language"],wi={subject:"Subject",lending:"Availability",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"},sn={is_lendable:!0,is_borrowable:!1,available_to_borrow:!0,is_browsable:!1,available_to_browse:!1,is_readable:!0,available_to_waitlist:!1},hr={is_lendable:"Lending Library",available_to_borrow:"Borrow 14 Days",is_readable:"Always Available"},wa={deemphasize:!0,community:!0,stream_only:!0,samples_only:!0,test_collection:!0,printdisabled:!0,"openlibrary-ol":!0,nationalemergencylibrary:!0,china:!0,americana:!0,toronto:!0};function qr(r){switch(r){case"publicdate":return"Archived";case"reviewdate":return"Reviewed";case"addeddate":return"Added";default:return"Published"}}function Kr(r){return r?`Archivist since ${r.getFullYear()}`:""}let ve=class extends E{constructor(){super(...arguments),this.sortParam=null,this.collectionLinks=[],this.loggedIn=!1}render(){return p`
    ...
    `:w}get volumeTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.volume,"Volume")}get issueTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.issue,"Issue")}get creatorTemplate(){var e,t,i;return((e=this.model)===null||e===void 0?void 0:e.mediatype)==="account"?p`
        <div id="creator" class="metadata">
          <span class="label"> ${Kr((t=this.model)===null||t===void 0?void 0:t.dateAdded)} </span>
        </div>
    ...
    `}get descriptionTemplate(){var e,t,i;return this.metadataTemplate(zs(Ut.sanitize((i=(t=(e=this.model)===null||e===void 0?void 0:e.description)===null||t===void 0?void 0:t.replace(/\n/g," "))!==null&&i!==void 0?i:"")),"","description")}get textSnippetsTemplate(){var e;return this.hasSnippets?p`<text-snippet-block
      viewsize="list"
    ...
    >`}detailsLink(e,t){const i=t!=null?t:e;return p`<a
      ...
      >${Ut.sanitize(i)}</a
    >`}get mediatypeURL(){var e;if(this.baseNavigationUrl===void 0||!(!((e=this.model)===null||e===void 0)&&e.mediatype))return w;switch(this.model.mediatype){case"collection":return`${this.baseNavigationUrl}/search?query=mediatype:collection&sort=-downloads`;case"account":return w;default:return`${this.baseNavigationUrl}/details/${encodeURI(this.model.mediatype)}`}}updated(e){e.has("model")&&this.fetchCollectionNames()}async fetchCollectionNames(){var e,t;if(!(!((e=this.model)===null||e===void 0)&&e.collections)||this.model.collections.length===0||!this.collectionNameCache)return;this.collectionLinks=[];const i=[],a=[];for(const o of this.model.collections)!wa[o]&&!o.startsWith("fav-")&&a.push((t=this.collectionNameCache)===null||t===void 0?void 0:t.collectionNameFor(o).then(n=>{i.push(this.detailsLink(o,n!=null?n:o))}));await Promise.all(a),this.collectionLinks=i}get date(){var e,t,i,a,o;switch((e=this.sortParam)===null||e===void 0?void 0:e.field){case"date":return(t=this.model)===null||t===void 0?void 0:t.datePublished;case"reviewdate":return(i=this.model)===null||i===void 0?void 0:i.dateReviewed;case"addeddate":return(a=this.model)===null||a===void 0?void 0:a.dateAdded;default:return(o=this.model)===null||o===void 0?void 0:o.dateArchived}}get classSize(){return this.mobileBreakpoint&&this.currentWidth&&this.currentWidth<this.mobileBreakpoint?"mobile":"desktop"}get formatSize(){return this.mobileBreakpoint&&this.currentWidth&&this.currentWidth<this.mobileBreakpoint?"short":"long"}static get styles(){return f`
      html {
        font-size: unset;
      }
    ...
    `}};s([c({type:Object})],ve.prototype,"model",void 0);s([c({type:String})],ve.prototype,"baseNavigationUrl",void 0);s([c({type:Object})],ve.prototype,"collectionNameCache",void 0);s([c({type:Number})],ve.prototype,"currentWidth",void 0);s([c({type:Number})],ve.prototype,"currentHeight",void 0);s([c({type:Object})],ve.prototype,"sortParam",void 0);s([c({type:Number})],ve.prototype,"mobileBreakpoint",void 0);s([$()],ve.prototype,"collectionLinks",void 0);s([c({type:String})],ve.prototype,"baseImageUrl",void 0);s([c({type:Boolean})],ve.prototype,"loggedIn",void 0);ve=s([F("tile-list")],ve);let Ie=class extends E{constructor(){super(...arguments),this.loggedIn=!1}render(){return p`
      <div id="container">
        <tile-list
          .model=${this.model}
    ...
    `}};s([c({type:Object})],Ie.prototype,"model",void 0);s([c({type:String})],Ie.prototype,"baseNavigationUrl",void 0);s([c({type:String})],Ie.prototype,"baseImageUrl",void 0);s([c({type:Boolean})],Ie.prototype,"loggedIn",void 0);s([c({type:Object})],Ie.prototype,"sortParam",void 0);s([c({type:Object})],Ie.prototype,"collectionNameCache",void 0);Ie=s([F("tile-hover-pane")],Ie);let Se=class extends E{constructor(){super(...arguments),this.sortParam=null,this.loggedIn=!1}render(){var e,t,i,a,o,n,l,d,u;return p`
      <div id="list-line" class="${this.classSize}">
        ...
        <div id="creator">
          ${((i=this.model)===null||i===void 0?void 0:i.mediatype)==="account"?Kr((a=this.model)===null||a===void 0?void 0:a.dateAdded):Ut.sanitize((n=(o=this.model)===null||o===void 0?void 0:o.creator)!==null&&n!==void 0?n:"")}
        </div>
    ...
    `}get linkTileTemplate(){var e,t;return p`
      <a
        ...
        title=${this.shouldPrepareHoverPane?w:ui((t=this.model)===null||t===void 0?void 0:t.title)}
    ...
    `}};s([c({type:Number})],ca.prototype,"numResults",void 0);ca=s([F("alpha-bar-tooltip")],ca);let Oe=class extends E{constructor(){super(...arguments),this.selectedLetter=null,this.tooltipShown=!1,this.alphabet="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("")}get selectedUppercaseLetter(){var e;return(e=this.selectedLetter)===null||e===void 0?void 0:e.toUpperCase()}render(){return p`
      <div id="container">
        <ul>
    ...
    `}tooltipTemplate(e){var t,i;return this.hoveredLetter!==e?w:this.tooltipShown?p`<alpha-bar-tooltip
        ...
        ></alpha-bar-tooltip>`:w}letterClicked(e){e===this.selectedUppercaseLetter?this.selectedLetter=null:this.selectedLetter=e,this.dispatchEvent(new CustomEvent("letterChanged",{detail:{selectedLetter:this.selectedUppercaseLetter}}))}async handleMouseMove(e){var t,i;const a=e.target;if(a&&!this.tooltipShown){const o=(i=(t=a.textContent)===null||t===void 0?void 0:t.trim())!==null&&i!==void 0?i:void 0;this.tooltipShown=!0,this.hoveredLetter=o,await this.updateComplete,await new Promise(n=>{setTimeout(n,0)}),this.tooltip&&this.tooltip.dataset.letter===o&&this.positionTooltip(a)}}handleMouseLeave(){this.tooltipShown=!1,this.hoveredLetter=void 0}positionTooltip(e){if(!this.tooltip)return;const t=this.tooltip.clientWidth;let a=e.clientWidth/2-t/2;const o=getComputedStyle(document.body),n=parseFloat(o.getPropertyValue("margin-left")),l=parseFloat(o.getPropertyValue("margin-right")),d=document.body.clientWidth+n+l,m=e.getBoundingClientRect().left+a,v=m+t,b=1;let x;m<b?x=m-b:v>d-b&&(x=v-d+b),x&&(a-=x,this.tooltip.style.setProperty("--tooltipArrowOffset",`${x}px`)),this.tooltip.style.left=`${a}px`,this.tooltip.classList.add("fade-in")}};Oe.styles=f`
    h1 {
      font-size: 1.2rem;
    }
  ...
  `;s([c({type:String})],Oe.prototype,"selectedLetter",void 0);s([c({type:Object})],Oe.prototype,"letterCounts",void 0);s([$()],Oe.prototype,"tooltipShown",void 0);s([$()],Oe.prototype,"hoveredLetter",void 0);s([te("alpha-bar-tooltip")],Oe.prototype,"tooltip",void 0);Oe=s([F("alpha-bar")],Oe);const mr=P`
...
`;let Y=class extends E{constructor(){super(...arguments),this.sortDirection=null,this.selectedSort=A.relevance,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.showRelevance=!0,this.alphaSelectorVisible=null,this.dateSortSelectorVisible=!1,this.viewSortSelectorVisible=!1,this.desktopSelectorBarWidth=0,this.selectorBarContainerWidth=0,this.hoveringOverDateSortOptions=!1,this.boundSortBarSelectorEscapeListener=e=>{e.key==="Escape"&&(this.viewSortSelectorVisible=!1,this.dateSortSelectorVisible=!1)}}render(){return p`
  ...
  `;s([c({type:String})],Y.prototype,"displayMode",void 0);s([c({type:String})],Y.prototype,"sortDirection",void 0);s([c({type:String})],Y.prototype,"selectedSort",void 0);s([c({type:String})],Y.prototype,"selectedTitleFilter",void 0);s([c({type:String})],Y.prototype,"selectedCreatorFilter",void 0);s([c({type:Boolean})],Y.prototype,"showRelevance",void 0);s([c({type:Object})],Y.prototype,"prefixFilterCountMap",void 0);s([c({type:Object})],Y.prototype,"resizeObserver",void 0);s([$()],Y.prototype,"alphaSelectorVisible",void 0);s([$()],Y.prototype,"dateSortSelectorVisible",void 0);s([$()],Y.prototype,"viewSortSelectorVisible",void 0);s([$()],Y.prototype,"desktopSelectorBarWidth",void 0);s([$()],Y.prototype,"selectorBarContainerWidth",void 0);s([$()],Y.prototype,"hoveringOverDateSortOptions",void 0);s([te("#desktop-sort-selector")],Y.prototype,"desktopSortSelector",void 0);s([te("#sort-selector-container")],Y.prototype,"sortSelectorContainer",void 0);Y=s([F("sort-filter-bar")],Y);/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const vr=Ci(class extends $i{constructor(r){if(super(r),r.type!==ze.PROPERTY&&r.type!==ze.ATTRIBUTE&&r.type!==ze.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Ko(r))throw Error("`live` bindings can only contain a single expression")}render(r){return r}update(r,[e]){if(e===me||e===w)return e;const t=r.element,i=r.name;if(r.type===ze.PROPERTY){if(e===t[i])return me}else if(r.type===ze.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(i))return me}else if(r.type===ze.ATTRIBUTE&&t.getAttribute(i)===e+"")return me;return Hr(r),e}}),hn=Object.freeze({processing:"processing",complete:"complete"});class pn extends E{static get properties(){return{mode:{type:String}}}constructor(){super(),this.mode=hn.processing}render(){return p`
      <div class="${this.mode}">
        <svg
          viewBox="0 0 120 120"
    ...
    `}get selectedRangeTemplate(){return P`
      ...
      />`}get histogramTemplate(){const e=this._histWidth/this._numBins,t=e-1;let i=this.sliderWidth;return this._histData.map(a=>{const o=P`
        <rect
          ...
          fill="${i+t>=this.minSliderX&&i<=this.maxSliderX?_n:Cn}"
    ...
    ia-activity-indicator {
      ...
      --activityIndicatorLoadingRingColor: ${Sn};
    }
...
`;let Q=class extends E{constructor(){super(...arguments),this.prompt="Do you find this feature useful?",this.buttonText="Beta",this.isOpen=!1,this.processing=!1,this.popupTopX=0,this.popupTopY=0,this.voteSubmitted=!1,this.voteNeedsChoosing=!1,this.resizingElement=document.body}render(){return p`
      <button
        id="beta-button"
    ...
    `}};s([c({type:String})],Q.prototype,"featureIdentifier",void 0);s([c({type:String})],Q.prototype,"prompt",void 0);s([c({type:String})],Q.prototype,"buttonText",void 0);s([c({type:Object})],Q.prototype,"recaptchaManager",void 0);s([c({type:Object})],Q.prototype,"resizeObserver",void 0);s([c({type:Boolean})],Q.prototype,"disabled",void 0);s([c({type:Object})],Q.prototype,"featureFeedbackService",void 0);s([te("#beta-button")],Q.prototype,"betaButton",void 0);s([te("#popup")],Q.prototype,"popup",void 0);s([$()],Q.prototype,"isOpen",void 0);s([$()],Q.prototype,"processing",void 0);s([$()],Q.prototype,"popupTopX",void 0);s([$()],Q.prototype,"popupTopY",void 0);s([$()],Q.prototype,"vote",void 0);s([$()],Q.prototype,"voteSubmitted",void 0);s([$()],Q.prototype,"error",void 0);s([$()],Q.prototype,"voteNeedsChoosing",void 0);s([$()],Q.prototype,"recaptchaWidget",void 0);s([te("#comments")],Q.prototype,"comments",void 0);Q=s([F("feature-feedback")],Q);class Yr{constructor(e){var t,i,a,o,n,l,d;this.title=e==null?void 0:e.title,this.subtitle=e==null?void 0:e.subtitle,this.headline=e==null?void 0:e.headline,this.message=e==null?void 0:e.message,this.headerColor=(t=e==null?void 0:e.headerColor)!==null&&t!==void 0?t:"#55A183",this.bodyColor=(i=e==null?void 0:e.bodyColor)!==null&&i!==void 0?i:"#f5f5f7",this.showProcessingIndicator=(a=e==null?void 0:e.showProcessingIndicator)!==null&&a!==void 0?a:!1,this.processingImageMode=(o=e==null?void 0:e.processingImageMode)!==null&&o!==void 0?o:"complete",this.showCloseButton=(n=e==null?void 0:e.showCloseButton)!==null&&n!==void 0?n:!0,this.showHeaderLogo=(l=e==null?void 0:e.showHeaderLogo)!==null&&l!==void 0?l:!0,this.closeOnBackdropClick=(d=e==null?void 0:e.closeOnBackdropClick)!==null&&d!==void 0?d:!0}}var Ln=p`
<svg
  viewBox="0 0 40 40"
  version="1.1"
  xmlns="http://www.w3.org/2000/svg"
...
`;let ha=class extends E{constructor(){super(...arguments),this.config=new Yr}render(){return p`
      <div class="modal-wrapper">
        <div class="modal-container">
          <header style="background-color: ${this.config.headerColor}">
            ${this.config.showCloseButton?this.closeButtonTemplate:""}
            ${this.config.showHeaderLogo?p`<div class="logo-icon">${An}</div>`:w}
    ...
    `}static get styles(){const e=f`var(--modalLogoSize, 6.5rem)`,t=f`var(--processingImageSize, 7.5rem)`,i=f`var(--modalCornerRadius, 1rem)`,a=f`var(--modalBorder, 2px solid black)`,o=f`var(--modalBottomMargin, 2.5rem)`,n=f`var(--modalTopMargin, 5rem)`,l=f`var(--modalHeaderBottomPadding, 0.5em)`,d=f`var(--modalBottomPadding, 2rem)`,u=f`var(--modalScrollOffset, 5px)`,m=f`var(--modalTitleFontSize, 1.8rem)`,v=f`var(--modalSubtitleFontSize, 1.4rem)`,b=f`var(--modalHeadlineFontSize, 1.6rem)`,x=f`var(--modalMessageFontSize, 1.4rem)`,k=f`var(--modalTitleLineHeight, normal)`,M=f`var(--modalSubtitleLineHeight, normal)`,I=f`var(--modalHeadlineLineHeight, normal)`,N=f`var(--modalMessageLineHeight, normal)`;return f`
      .processing-logo {
        margin: auto;
        width: ${t};
        height: ${t};
    ...
    `}};s([c({type:Object})],ha.prototype,"config",void 0);ha=s([F("modal-template")],ha);function Pn(r,e,t){var i=t||{},a=i.noTrailing,o=a===void 0?!1:a,n=i.noLeading,l=n===void 0?!1:n,d=i.debounceMode,u=d===void 0?void 0:d,m,v=!1,b=0;function x(){m&&clearTimeout(m)}function k(I){var N=I||{},W=N.upcomingOnly,re=W===void 0?!1:W;x(),v=!re}function M(){for(var I=arguments.length,N=new Array(I),W=0;W<I;W++)N[W]=arguments[W];var re=this,K=Date.now()-b;if(v)return;function pe(){b=Date.now(),e.apply(re,N)}function ue(){m=void 0}!l&&u&&!m&&pe(),x(),u===void 0&&K>r?l?(b=Date.now(),o||(m=setTimeout(u?ue:pe,r))):pe():o!==!0&&(m=setTimeout(u?ue:pe,u===void 0?r-K:r))}return M.cancel=k,M}var Xe;(function(r){r.Open="open",r.Closed="closed"})(Xe||(Xe={}));class Dn{constructor(e){this.windowResizeThrottler=Pn(100,this.updateModalContainerHeight).bind(this),this.modalManager=e}handleModeChange(e){switch(e){case Xe.Open:this.startResizeListener(),this.stopDocumentScroll();break;case Xe.Closed:this.stopResizeListener(),this.resumeDocumentScroll();break}}updateModalContainerHeight(){this.modalManager.style.setProperty("--containerHeight",`${window.innerHeight}px`)}stopDocumentScroll(){document.body.classList.add("modal-manager-open")}resumeDocumentScroll(){document.body.classList.remove("modal-manager-open")}startResizeListener(){window.addEventListener("resize",this.windowResizeThrottler)}stopResizeListener(){window.removeEventListener("resize",this.windowResizeThrottler)}}let St=class extends E{constructor(){super(...arguments),this.mode=Xe.Closed,this.hostBridge=new Dn(this),this.closeOnBackdropClick=!0}render(){return p`
      <div class="container">
...
`;let Ct=class extends E{constructor(){super(...arguments),this.step=2,this.currentPage=1,this.pages=[]}firstUpdated(){this.observePageCount()}updated(e){e.has("size")&&this.observePageCount(),e.has("currentPage")&&(this.observePageCount(),this.emitPageClick())}observePageCount(){this.pages=[];const e=7,t=this.size<=e;if(this.size<=5){this.pages=[...Array(this.size).keys()].map(o=>o+1);return}if(this.size===e){if(this.currentPage===2){this.pages=[1,2,3,4,0,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,4,5,this.size-1,this.size];return}}if(this.currentPage===1){this.pages=[1,2,3,0,this.size];return}if(this.currentPage===this.size){this.pages=[1,0,this.size-2,this.size-1,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,this.size-3,this.size-2,this.size-1,this.size];return}if(t&&this.currentPage>1&&this.currentPage<e){this.pages=[...Array(this.size).keys()].map(o=>o+1);return}let i=this.currentPage-this.step,a=this.currentPage+this.step;i<=0&&(a+=-i+1,i=1),a>=this.size&&(i=Math.max(i-(a-this.size),1),a=this.size),i===2&&(a-=1),a===this.size-1&&(i+=1),this.createFirstNode(i),this.createMiddelNode(i,a),this.createLastNode(a)}createFirstNode(e){var t,i;e>1&&((t=this.pages)===null||t===void 0||t.push(1)),e>2&&((i=this.pages)===null||i===void 0||i.push(0))}createMiddelNode(e,t){var i;for(let a=e;a<=t;a+=1)(i=this.pages)===null||i===void 0||i.push(a)}createLastNode(e){var t,i;e<this.size-1&&((t=this.pages)===null||t===void 0||t.push(0)),e<this.size&&((i=this.pages)===null||i===void 0||i.push(this.size))}get getEllipsisTemplate(){return p`<i class="ellipses">...</i>`}emitPageClick(){this.dispatchEvent(new CustomEvent("pageNumberClicked",{detail:{page:this.currentPage},bubbles:!0,composed:!0}))}onRewind(){this.currentPage-=1,this.currentPage<1&&(this.currentPage=1)}onForward(){this.currentPage+=1,this.currentPage>this.size&&(this.currentPage=this.size)}onChange(e){this.currentPage=e}getPageTemplate(e){return p`
    ...
    `}};s([c({type:Number})],Ct.prototype,"size",void 0);s([c({type:Number})],Ct.prototype,"step",void 0);s([c({type:Number})],Ct.prototype,"currentPage",void 0);s([$()],Ct.prototype,"pages",void 0);Ct=s([F("more-facets-pagination")],Ct);var On=P`
...
`;let $t=class extends E{facetClicked(e,t,i){const a=e.target,{checked:o,name:n,value:l}=a;o?this.facetChecked(n,l,t,i):this.facetUnchecked(n,l)}facetChecked(e,t,i,a){const{selectedFacets:o}=this;let n;o?n=se({},o):n=yi,n[e][t]={state:a?"hidden":"selected",count:i},this.selectedFacets=n,this.dispatchSelectedFacetsChanged()}facetUnchecked(e,t){const{selectedFacets:i}=this;let a;i?a=se({},i):a=yi,delete a[e][t],this.selectedFacets=a,this.dispatchSelectedFacetsChanged()}dispatchSelectedFacetsChanged(){const e=new CustomEvent("selectedFacetsChanged",{detail:this.selectedFacets,bubbles:!0,composed:!0});this.dispatchEvent(e)}getFacetsTemplate(e){let t=e==null?void 0:e.buckets;return t=[...t.filter(i=>i.state==="selected").sort((i,a)=>i.count<a.count?1:-1),...t.filter(i=>i.state==="hidden").sort((i,a)=>i.count<a.count?1:-1),...t.filter(i=>i.state==="none")],p`
    ...
    `}};s([c({type:String})],q.prototype,"facetKey",void 0);s([c({type:String})],q.prototype,"facetAggregationKey",void 0);s([c({type:String})],q.prototype,"query",void 0);s([c({type:Object})],q.prototype,"filterMap",void 0);s([c({type:Object})],q.prototype,"modalManager",void 0);s([c({type:Object})],q.prototype,"searchService",void 0);s([c({type:String})],q.prototype,"searchType",void 0);s([c({type:Object})],q.prototype,"collectionNameCache",void 0);s([c({type:Object})],q.prototype,"languageCodeHandler",void 0);s([c({type:Object})],q.prototype,"selectedFacets",void 0);s([c({type:String})],q.prototype,"sortedBy",void 0);s([c({type:Object,attribute:!1})],q.prototype,"analyticsHandler",void 0);s([$()],q.prototype,"aggregations",void 0);s([$()],q.prototype,"facetGroup",void 0);s([$()],q.prototype,"facetGroupTitle",void 0);s([$()],q.prototype,"pageNumber",void 0);s([$()],q.prototype,"facetsLoading",void 0);s([$()],q.prototype,"paginationSize",void 0);s([$()],q.prototype,"facetsType",void 0);q=s([F("more-facets-content")],q);let _r=class extends E{render(){return p`
      <div id="row">
    ...
    `}updated(e){e.has("selectedFacets")&&this.dispatchFacetsChangedEvent()}dispatchFacetsChangedEvent(){const e=new CustomEvent("facetsChanged",{detail:this.selectedFacets});this.dispatchEvent(e)}get currentYearsHistogramAggregation(){var e;return(e=this.aggregations)===null||e===void 0?void 0:e.year_histogram}get histogramTemplate(){const{fullYearsHistogramAggregation:e}=this;return this.fullYearAggregationLoading?p`<div class="histogram-loading-indicator">&hellip;</div>`:p`
          ...
          ></histogram-date-range>
        `}histogramDateRangeUpdated(e){const{minDate:t,maxDate:i}=e.detail,a=new CustomEvent("histogramDateRangeUpdated",{detail:{minDate:t,maxDate:i}});this.dispatchEvent(a)}get mergedFacets(){const e=[];return on.forEach(t=>{var i,a;const o=this.selectedFacetGroups.find(m=>m.key===t),n=this.aggregationFacetGroups.find(m=>m.key===t);if(o&&!n){e.push(o);return}if(!n)return;const l=o!=null?o:n;let d=(i=o==null?void 0:o.buckets.map(m=>{const v=n.buckets.find(b=>b.key===m.key);return v?ht(se({},m),{count:v.count}):m}))!==null&&i!==void 0?i:[];n.buckets.forEach(m=>{d.find(b=>b.key===m.key)||d.push(m)}),t==="lending"&&(d=d.filter(m=>sn[m.key]));let u=(a=Object.keys((o==null?void 0:o.buckets)||[]))===null||a===void 0?void 0:a.length;u<this.allowedFacetCount&&(u=this.allowedFacetCount),l.buckets=d.splice(0,u),e.push(l)}),e}get selectedFacetGroups(){return this.selectedFacets?Object.entries(this.selectedFacets).map(([t,i])=>{const a=t,o=wi[a],n=Object.entries(i).map(([l,d])=>{var u,m,v;let b=l;return a==="language"&&(b=(m=(u=this.languageCodeHandler)===null||u===void 0?void 0:u.getLanguageNameFromCodeString(l))!==null&&m!==void 0?m:l),a==="lending"&&(b=(v=hr[l])!==null&&v!==void 0?v:l),{displayText:b,key:l,count:d.count,state:d.state}});return{title:o,key:a,buckets:n}}):[]}get aggregationFacetGroups(){var e;const t=[];return Object.entries((e=this.aggregations)!==null&&e!==void 0?e:[]).forEach(([i,a])=>{if(i==="year_histogram")return;const o=i,n=wi[o];if(!n)return;let l=a.buckets;o==="collection"&&(l=l==null?void 0:l.filter(m=>{var v;const b=(v=m==null?void 0:m.key)===null||v===void 0?void 0:v.toString();return!wa[b]&&!(b!=null&&b.startsWith("fav-"))}));const d=l.map(m=>{var v,b,x;let k=m.key,M=`${m.key}`;return o==="language"&&(k=(b=(v=this.languageCodeHandler)===null||v===void 0?void 0:v.getCodeStringFromLanguageName(`${m.key}`))!==null&&b!==void 0?b:m.key),o==="lending"&&(M=(x=hr[m.key])!==null&&x!==void 0?x:`${m.key}`),{displayText:M,key:`${k}`,count:m.doc_count,state:"none"}}),u={title:n,key:o,buckets:d};t.push(u)}),t}getFacetGroupTemplate(e){if(!this.facetsLoading&&e.buckets.length===0)return w;const{key:t}=e,i=this.openFacets[t],a=p`
    ...
    `,l=new Yr({bodyColor:"#fff",headerColor:"#194880",showHeaderLogo:!1,closeOnBackdropClick:!0,title:p`Select filters`});(i=this.modalManager)===null||i===void 0||i.classList.add("more-search-facets"),(a=this.modalManager)===null||a===void 0||a.showModal({config:l,customModalContent:n})}getFacetTemplate(e){return p`
      <facets-template
        .facetGroup=${e}
        .selectedFacets=${this.selectedFacets}
        .renderOn=${"page"}
...
`;let _i=class extends E{constructor(){super(...arguments),this.placeholderType=null}render(){return this.placeholderType?p`${this.placeholderTemplate}`:w}get placeholderTemplate(){return p`
      <div
        class="placeholder ${this.placeholderType} ${this.isMobileView?"mobile":"desktop"}"
      >
        ${Wn(this.placeholderType,[["empty-query",()=>this.emptyQueryTemplate],["null-result",()=>this.nullResultTemplate]])}
      </div>
...
`),favCount:(Be=(Re=d.num_favorites)===null||Re===void 0?void 0:Re.value)!==null&&Be!==void 0?Be:0,identifier:d.identifier,issue:(At=d.issue)===null||At===void 0?void 0:At.value,itemCount:(Dt=(Pt=d.item_count)===null||Pt===void 0?void 0:Pt.value)!==null&&Dt!==void 0?Dt:0,mediatype:(Ne=(it=d.mediatype)===null||it===void 0?void 0:it.value)!==null&&Ne!==void 0?Ne:"data",snippets:(at=(V=d.highlight)===null||V===void 0?void 0:V.values)!==null&&at!==void 0?at:[],source:(G=d.source)===null||G===void 0?void 0:G.value,subjects:(H=(rt=d.subject)===null||rt===void 0?void 0:rt.values)!==null&&H!==void 0?H:[],title:this.etreeTitle((Ce=d.title)===null||Ce===void 0?void 0:Ce.value,(He=d.mediatype)===null||He===void 0?void 0:He.value,(ot=d.collection)===null||ot===void 0?void 0:ot.values),volume:(Ue=d.volume)===null||Ue===void 0?void 0:Ue.value,viewCount:(xe=(st=d.downloads)===null||st===void 0?void 0:st.value)!==null&&xe!==void 0?xe:0,weeklyViewCount:(fe=d.week)===null||fe===void 0?void 0:fe.value,loginRequired:je,contentWarning:We})}),a[e]=o,this.dataSource=a,this.currentVisiblePageNumbers.includes(e)&&((i=this.infiniteScroller)===null||i===void 0||i.reload())}async fetchPrefixFilterBuckets(e){var t,i,a,o,n,l;if(!this.fullQueryWithoutAlphaFilters)return[];const d=rn[e],u={query:this.fullQueryWithoutAlphaFilters,rows:0,aggregations:{simpleParams:[d]},aggregationsSize:26},m=await((t=this.searchService)===null||t===void 0?void 0:t.search(u,this.searchType));return(l=(n=(o=(a=(i=m==null?void 0:m.success)===null||i===void 0?void 0:i.response)===null||a===void 0?void 0:a.aggregations)===null||o===void 0?void 0:o[d])===null||n===void 0?void 0:n.buckets)!==null&&l!==void 0?l:[]}async updatePrefixFilterCounts(e){const t=await this.fetchPrefixFilterBuckets(e);this.prefixFilterCountMap=se({},this.prefixFilterCountMap),this.prefixFilterCountMap[e]=t.reduce((i,a)=>(i[a.key.toUpperCase()]=a.doc_count,i),{})}async updatePrefixFiltersForCurrentSort(){if(["title","creator"].includes(this.selectedSort)){const e=this.selectedSort;this.prefixFilterCountMap[e]||this.updatePrefixFilterCounts(e)}}refreshLetterCounts(){this.prefixFilterCountMap={},this.updatePrefixFiltersForCurrentSort()}etreeTitle(e,t,i){if(t==="etree"||(i==null?void 0:i.includes("etree"))){const a=/^(.*) Live at (.*) on (\d\d\d\d-\d\d-\d\d)$/,o=e==null?void 0:e.replace(a,"$3: $2");if(o)return`${o}`}return e!=null?e:""}resultSelected(e){var t,i;(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:this.searchContext,action:Z.resultSelected,label:e.detail.mediatype}),(i=this.analyticsHandler)===null||i===void 0||i.sendEvent({category:this.searchContext,action:Z.resultSelected,label:`page-${this.currentPage}`})}cellForIndex(e){const t=this.tileModelAtCellIndex(e);if(!!t)return p`
  ...
  `;s([c({type:String})],z.prototype,"baseNavigationUrl",void 0);s([c({type:String})],z.prototype,"baseImageUrl",void 0);s([c({type:Object})],z.prototype,"searchService",void 0);s([c({type:String})],z.prototype,"searchType",void 0);s([c({type:String})],z.prototype,"baseQuery",void 0);s([c({type:String})],z.prototype,"displayMode",void 0);s([c({type:Object})],z.prototype,"sortParam",void 0);s([c({type:String})],z.prototype,"selectedSort",void 0);s([c({type:String})],z.prototype,"selectedTitleFilter",void 0);s([c({type:String})],z.prototype,"selectedCreatorFilter",void 0);s([c({type:String})],z.prototype,"sortDirection",void 0);s([c({type:Number})],z.prototype,"pageSize",void 0);s([c({type:Object})],z.prototype,"resizeObserver",void 0);s([c({type:String})],z.prototype,"titleQuery",void 0);s([c({type:String})],z.prototype,"creatorQuery",void 0);s([c({type:Number})],z.prototype,"currentPage",void 0);s([c({type:String})],z.prototype,"minSelectedDate",void 0);s([c({type:String})],z.prototype,"maxSelectedDate",void 0);s([c({type:Object})],z.prototype,"selectedFacets",void 0);s([c({type:Boolean})],z.prototype,"showHistogramDatePicker",void 0);s([c({type:String,reflect:!0})],z.prototype,"searchContext",void 0);s([c({type:Object})],z.prototype,"collectionNameCache",void 0);s([c({type:String})],z.prototype,"pageContext",void 0);s([c({type:Object})],z.prototype,"restorationStateHandler",void 0);s([c({type:Number})],z.prototype,"mobileBreakpoint",void 0);s([c({type:Boolean})],z.prototype,"loggedIn",void 0);s([c({type:Object})],z.prototype,"modalManager",void 0);s([c({type:Boolean})],z.prototype,"isManageView",void 0);s([$()],z.prototype,"pagesToRender",void 0);s([$()],z.prototype,"searchResultsLoading",void 0);s([$()],z.prototype,"facetsLoading",void 0);s([$()],z.prototype,"fullYearAggregationLoading",void 0);s([$()],z.prototype,"aggregations",void 0);s([$()],z.prototype,"fullYearsHistogramAggregation",void 0);s([$()],z.prototype,"previousSearchType",void 0);s([$()],z.prototype,"totalResults",void 0);s([$()],z.prototype,"mobileView",void 0);s([$()],z.prototype,"mobileFacetsVisible",void 0);s([$()],z.prototype,"placeholderType",void 0);s([$()],z.prototype,"prefixFilterCountMap",void 0);s([te("#content-container")],z.prototype,"contentContainer",void 0);s([c({type:Object,attribute:!1})],z.prototype,"analyticsHandler",void 0);s([te("infinite-scroller")],z.prototype,"infiniteScroller",void 0);z=s([F("collection-browser")],z);let ae=class extends E{constructor(){super(...arguments),this.searchService=this.initSearchServiceFromUrlParams(),this.resizeObserver=new Go,this.localCache=new Oo,this.collectionNameCache=new Qo({searchService:this.searchService,localCache:this.localCache}),this.cellWidth=18,this.cellHeight=29,this.rowGap=1.7,this.colGap=1.7,this.loggedIn=!1,this.searchType=le.METADATA,this.analyticsManager=new bo,this.analyticsHandler={sendPing:this.sendAnalytics.bind(this),sendEvent:this.sendAnalytics.bind(this),sendEventNoSampling:this.sendAnalytics.bind(this)}}sendAnalytics(e){var t;console.log("Analytics Received ----",e),this.latestAction=e,(t=this.analyticsManager)===null||t===void 0||t.sendEvent(e)}initSearchServiceFromUrlParams(){var e,t,i;const a=new URL(window.location.href).searchParams;return new Pe({includeCredentials:!1,baseUrl:(e=a.get("search_base_url"))!==null&&e!==void 0?e:void 0,servicePath:(t=a.get("search_service_path"))!==null&&t!==void 0?t:void 0,debuggingEnabled:(i=!!a.get("debugging"))!==null&&i!==void 0?i:void 0})}searchPressed(e){var t,i;e.preventDefault(),this.searchQuery=this.baseQueryField.value,((t=this.currentPage)!==null&&t!==void 0?t:1)>1&&this.collectionBrowser.goToPage((i=this.currentPage)!==null&&i!==void 0?i:1)}changePagePressed(e){e.preventDefault(),this.currentPage=this.pageNumberInput.valueAsNumber,this.collectionBrowser.goToPage(this.currentPage)}updated(e){e.has("currentPage")&&this.currentPage&&(this.pageNumberInput.value=this.currentPage.toString()),e.has("searchQuery")&&this.queryUpdated()}queryUpdated(){this.collectionBrowser.baseQuery=this.searchQuery}get getClass(){return new URLSearchParams(window.location.search).get("hide-dev-tools")?"hidden":""}render(){var e;return p`
  ...
  `;s([$()],ae.prototype,"currentPage",void 0);s([$()],ae.prototype,"searchQuery",void 0);s([$()],ae.prototype,"cellWidth",void 0);s([$()],ae.prototype,"cellHeight",void 0);s([$()],ae.prototype,"rowGap",void 0);s([$()],ae.prototype,"colGap",void 0);s([$()],ae.prototype,"loggedIn",void 0);s([$()],ae.prototype,"searchType",void 0);s([c({type:Object,reflect:!1})],ae.prototype,"latestAction",void 0);s([te("#base-query-field")],ae.prototype,"baseQueryField",void 0);s([te("#page-number-input")],ae.prototype,"pageNumberInput",void 0);s([te("collection-browser")],ae.prototype,"collectionBrowser",void 0);s([te("modal-manager")],ae.prototype,"modalManager",void 0);ae=s([F("app-root")],ae);
