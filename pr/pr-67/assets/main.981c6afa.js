var cs=Object.defineProperty,hs=Object.defineProperties;var us=Object.getOwnPropertyDescriptors;var Ir=Object.getOwnPropertySymbols;var ps=Object.prototype.hasOwnProperty,vs=Object.prototype.propertyIsEnumerable;var zr=(a,e,t)=>e in a?cs(a,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):a[e]=t,fe=(a,e)=>{for(var t in e||(e={}))ps.call(e,t)&&zr(a,t,e[t]);if(Ir)for(var t of Ir(e))vs.call(e,t)&&zr(a,t,e[t]);return a},At=(a,e)=>hs(a,us(e));const ms=function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const s of r)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function t(r){const s={};return r.integrity&&(s.integrity=r.integrity),r.referrerpolicy&&(s.referrerPolicy=r.referrerpolicy),r.crossorigin==="use-credentials"?s.credentials="include":r.crossorigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(r){if(r.ep)return;r.ep=!0;const s=t(r);fetch(r.href,s)}};ms();function n(a,e,t,i){var r=arguments.length,s=r<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")s=Reflect.decorate(a,e,t,i);else for(var l=a.length-1;l>=0;l--)(o=a[l])&&(s=(r<3?o(s):r>3?o(e,t,s):o(e,t))||s);return r>3&&s&&Object.defineProperty(e,t,s),s}function w(a){let e,t,i;return typeof a=="object"?(e=a.hashFunction,t=a.expiring,i=a.tags):e=a,(r,s,o)=>{if(o.value!=null)o.value=Nr(o.value,e,t,i);else if(o.get!=null)o.get=Nr(o.get,e,t,i);else throw"Only put a Memoize() decorator on a method or get accessor."}}const Di=new Map;function Nr(a,e,t=0,i){const r=Symbol("__memoized_map__");return function(...s){let o;this.hasOwnProperty(r)||Object.defineProperty(this,r,{configurable:!1,enumerable:!1,writable:!1,value:new Map});let l=this[r];if(Array.isArray(i))for(const d of i)Di.has(d)?Di.get(d).push(l):Di.set(d,[l]);if(e||s.length>0||t>0){let d;e===!0?d=s.map(v=>v.toString()).join("!"):e?d=e.apply(this,s):d=s[0];const h=`${d}__timestamp`;let p=!1;if(t>0)if(!l.has(h))p=!0;else{let v=l.get(h);p=Date.now()-v>t}l.has(d)&&!p?o=l.get(d):(o=a.apply(this,s),l.set(d,o),t>0&&l.set(h,Date.now()))}else{const d=this;l.has(d)?o=l.get(d):(o=a.apply(this,s),l.set(d,o))}return o}}class Gi{parseValue(e){return typeof e=="string"&&(e==="false"||e==="0")?!1:Boolean(e)}}Gi.shared=new Gi;class Oe{parseValue(e){if(typeof e=="number")return e;if(typeof e=="boolean")return;const t=parseFloat(e);if(!Number.isNaN(t))return t}}Oe.shared=new Oe;class si{parseValue(e){return Oe.shared.parseValue(e)}}si.shared=new si;class Pt{parseValue(e){return this.parseJSDate(e)||this.parseBracketDate(e)}parseBracketDate(e){if(typeof e!="string")return;const t=e.match(/\[([0-9]{4})\]/);if(!(!t||t.length<2))return this.parseJSDate(t[1])}parseJSDate(e){if(typeof e!="string")return;let t=e;t.match(/^[0-9]{4}-[0-9]{2}-[0-9]{2}\s{1}[0-9]{2}:[0-9]{2}:[0-9]{2}$/)&&(t=t.replace(" ","T"));const i=Date.parse(t);if(Number.isNaN(i))return;let r=new Date(t);return(t.indexOf("Z")>-1||t.indexOf("+")>-1||t.match(/^[0-9]{4}$/)||t.match(/^[0-9]{4}-[0-9]{2}-[0-9]{2}$/)||t.match(/^.*?-[0-9]{2}:[0-9]{2}$/)||t.match(/^.*?-[0-9]{4}$/))&&(r=new Date(r.getTime()+r.getTimezoneOffset()*1e3*60)),r}}Pt.shared=new Pt;class oi{parseValue(e){if(typeof e=="number")return e;if(typeof e=="boolean")return;const t=e.split(":");let i;return t.length===1?i=this.parseNumberFormat(t[0]):i=this.parseColonSeparatedFormat(t),i}parseNumberFormat(e){let t=parseFloat(e);return Number.isNaN(t)&&(t=void 0),t}parseColonSeparatedFormat(e){let t=!1;const i=e.map((r,s)=>{const o=parseFloat(r);if(Number.isNaN(o))return t=!0,0;const l=e.length-1-s,d=60**l;return o*Math.floor(d)}).reduce((r,s)=>r+s,0);return t?void 0:i}}oi.shared=new oi;class Yi{parseValue(e){if(typeof e=="string")return e}}Yi.shared=new Yi;class gs{constructor(e,t){this.separators=[";",","],this.parser=e,t&&t.separators&&(this.separators=t.separators)}parseValue(e){const t=String(e);let i=[];for(const r of this.separators)if(i=t.split(r),i.length>1)break;return this.parseListValues(i)}parseListValues(e){const i=e.map(s=>s.trim()).map(s=>this.parser.parseValue(s)),r=[];return i.forEach(s=>{s!==void 0&&r.push(s)}),r}}class Ki{parseValue(e){if(typeof e=="string")return e}}Ki.shared=new Ki;class ni{parseValue(e){return String(e)}}ni.shared=new ni;class me{constructor(e,t){this.parser=e,this.rawValue=t}get values(){return this.parseRawValue()}get value(){return this.values[0]}parseRawValue(){if(this.rawValue===void 0)return[];const e=Array.isArray(this.rawValue)?this.rawValue:[this.rawValue],t=[];return e.forEach(i=>{const r=this.parser.parseValue(i);Array.isArray(r)?t.push(...r):r!==void 0&&t.push(r)}),t}}n([w()],me.prototype,"values",null);n([w()],me.prototype,"value",null);class fs extends me{constructor(e){super(Gi.shared,e)}}class $e extends me{constructor(e){super(Pt.shared,e)}}class Mi extends me{constructor(e){super(oi.shared,e)}}class de extends me{constructor(e){super(Oe.shared,e)}}class B extends me{constructor(e){super(ni.shared,e)}}class bs extends me{constructor(e){super(Ki.shared,e)}}class Pr extends me{constructor(e){super(si.shared,e)}}class ys extends me{constructor(e){super(Yi.shared,e)}}class ws extends me{constructor(e,t){super(t,e)}}class Ss extends ws{constructor(e){const t=new gs(ni.shared);super(e,t)}}class x{constructor(e){this.rawMetadata=e}get identifier(){var e;return(e=this.rawMetadata)===null||e===void 0?void 0:e.identifier}get addeddate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.addeddate?new $e(this.rawMetadata.addeddate):void 0}get audio_codec(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.audio_codec?new B(this.rawMetadata.audio_codec):void 0}get audio_sample_rate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.audio_sample_rate?new de(this.rawMetadata.audio_sample_rate):void 0}get avg_rating(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.avg_rating?new de(this.rawMetadata.avg_rating):void 0}get collection(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.collection?new B(this.rawMetadata.collection):void 0}get collections_raw(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.collections_raw?new B(this.rawMetadata.collections_raw):void 0}get collection_size(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.collection_size?new Pr(this.rawMetadata.collection_size):void 0}get contributor(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.contributor?new B(this.rawMetadata.contributor):void 0}get coverage(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.coverage?new B(this.rawMetadata.coverage):void 0}get creator(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.creator?new B(this.rawMetadata.creator):void 0}get date(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.date?new $e(this.rawMetadata.date):void 0}get description(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.description?new B(this.rawMetadata.description):void 0}get downloads(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.downloads?new de(this.rawMetadata.downloads):void 0}get duration(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.duration?new Mi(this.rawMetadata.duration):void 0}get"external-identifier"(){var e,t;return!((e=this.rawMetadata)===null||e===void 0)&&e["external-identifier"]?new B((t=this.rawMetadata)===null||t===void 0?void 0:t["external-identifier"]):void 0}get files_count(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.files_count?new de(this.rawMetadata.files_count):void 0}get indexdate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.indexdate?new $e(this.rawMetadata.indexdate):void 0}get isbn(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.isbn?new B(this.rawMetadata.isbn):void 0}get issue(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.issue?new B(this.rawMetadata.issue):void 0}get item_count(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.item_count?new de(this.rawMetadata.item_count):void 0}get item_size(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.item_size?new Pr(this.rawMetadata.item_size):void 0}get language(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.language?new B(this.rawMetadata.language):void 0}get length(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.length?new Mi(this.rawMetadata.length):void 0}get lineage(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.lineage?new B(this.rawMetadata.lineage):void 0}get month(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.month?new de(this.rawMetadata.month):void 0}get mediatype(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.mediatype?new ys(this.rawMetadata.mediatype):void 0}get noindex(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.noindex?new fs(this.rawMetadata.noindex):void 0}get notes(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.notes?new B(this.rawMetadata.notes):void 0}get num_favorites(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.num_favorites?new de(this.rawMetadata.num_favorites):void 0}get num_reviews(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.num_reviews?new de(this.rawMetadata.num_reviews):void 0}get openlibrary_edition(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.openlibrary_edition?new B(this.rawMetadata.openlibrary_edition):void 0}get openlibrary_work(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.openlibrary_work?new B(this.rawMetadata.openlibrary_work):void 0}get page_progression(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.page_progression?new bs(this.rawMetadata.page_progression):void 0}get partner(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.partner?new B(this.rawMetadata.partner):void 0}get ppi(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.ppi?new de(this.rawMetadata.ppi):void 0}get publicdate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.publicdate?new $e(this.rawMetadata.publicdate):void 0}get publisher(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.publisher?new B(this.rawMetadata.publisher):void 0}get reviewdate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.reviewdate?new $e(this.rawMetadata.reviewdate):void 0}get runtime(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.runtime?new Mi(this.rawMetadata.runtime):void 0}get scanner(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.scanner?new B(this.rawMetadata.scanner):void 0}get source(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.source?new B(this.rawMetadata.source):void 0}get start_localtime(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.start_localtime?new $e(this.rawMetadata.start_localtime):void 0}get start_time(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.start_time?new $e(this.rawMetadata.start_time):void 0}get stop_time(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.stop_time?new $e(this.rawMetadata.stop_time):void 0}get subject(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.subject?new Ss(this.rawMetadata.subject):void 0}get taper(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.taper?new B(this.rawMetadata.taper):void 0}get title(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.title?new B(this.rawMetadata.title):void 0}get transferer(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.transferer?new B(this.rawMetadata.transferer):void 0}get track(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.track?new de(this.rawMetadata.track):void 0}get type(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.type?new B(this.rawMetadata.type):void 0}get uploader(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.uploader?new B(this.rawMetadata.uploader):void 0}get utc_offset(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.utc_offset?new de(this.rawMetadata.utc_offset):void 0}get venue(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.venue?new B(this.rawMetadata.venue):void 0}get volume(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.volume?new B(this.rawMetadata.volume):void 0}get week(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.week?new de(this.rawMetadata.week):void 0}get year(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.year?new $e(this.rawMetadata.year):void 0}}n([w()],x.prototype,"addeddate",null);n([w()],x.prototype,"audio_codec",null);n([w()],x.prototype,"audio_sample_rate",null);n([w()],x.prototype,"avg_rating",null);n([w()],x.prototype,"collection",null);n([w()],x.prototype,"collections_raw",null);n([w()],x.prototype,"collection_size",null);n([w()],x.prototype,"contributor",null);n([w()],x.prototype,"coverage",null);n([w()],x.prototype,"creator",null);n([w()],x.prototype,"date",null);n([w()],x.prototype,"description",null);n([w()],x.prototype,"downloads",null);n([w()],x.prototype,"duration",null);n([w()],x.prototype,"external-identifier",null);n([w()],x.prototype,"files_count",null);n([w()],x.prototype,"indexdate",null);n([w()],x.prototype,"isbn",null);n([w()],x.prototype,"issue",null);n([w()],x.prototype,"item_count",null);n([w()],x.prototype,"item_size",null);n([w()],x.prototype,"language",null);n([w()],x.prototype,"length",null);n([w()],x.prototype,"lineage",null);n([w()],x.prototype,"month",null);n([w()],x.prototype,"mediatype",null);n([w()],x.prototype,"noindex",null);n([w()],x.prototype,"notes",null);n([w()],x.prototype,"num_favorites",null);n([w()],x.prototype,"num_reviews",null);n([w()],x.prototype,"openlibrary_edition",null);n([w()],x.prototype,"openlibrary_work",null);n([w()],x.prototype,"page_progression",null);n([w()],x.prototype,"partner",null);n([w()],x.prototype,"ppi",null);n([w()],x.prototype,"publicdate",null);n([w()],x.prototype,"publisher",null);n([w()],x.prototype,"reviewdate",null);n([w()],x.prototype,"runtime",null);n([w()],x.prototype,"scanner",null);n([w()],x.prototype,"source",null);n([w()],x.prototype,"start_localtime",null);n([w()],x.prototype,"start_time",null);n([w()],x.prototype,"stop_time",null);n([w()],x.prototype,"subject",null);n([w()],x.prototype,"taper",null);n([w()],x.prototype,"title",null);n([w()],x.prototype,"transferer",null);n([w()],x.prototype,"track",null);n([w()],x.prototype,"type",null);n([w()],x.prototype,"uploader",null);n([w()],x.prototype,"utc_offset",null);n([w()],x.prototype,"venue",null);n([w()],x.prototype,"volume",null);n([w()],x.prototype,"week",null);n([w()],x.prototype,"year",null);class bt{constructor(e){this.rawValue=e}get name(){return this.rawValue.name}get source(){return this.rawValue.source}get btih(){return this.rawValue.btih}get md5(){return this.rawValue.md5}get format(){return this.rawValue.format}get mtime(){return this.rawValue.mtime}get crc32(){return this.rawValue.crc32}get sha1(){return this.rawValue.sha1}get original(){return this.rawValue.original}get size(){return this.rawValue.size?si.shared.parseValue(this.rawValue.size):void 0}get title(){return this.rawValue.title}get length(){return this.rawValue.length?oi.shared.parseValue(this.rawValue.length):void 0}get height(){return this.rawValue.height?Oe.shared.parseValue(this.rawValue.height):void 0}get width(){return this.rawValue.width?Oe.shared.parseValue(this.rawValue.width):void 0}get track(){return this.rawValue.track?Oe.shared.parseValue(this.rawValue.track):void 0}get external_identifier(){return this.rawValue.external_identifier}get creator(){return this.rawValue.creator}get album(){return this.rawValue.album}}n([w()],bt.prototype,"size",null);n([w()],bt.prototype,"length",null);n([w()],bt.prototype,"height",null);n([w()],bt.prototype,"width",null);n([w()],bt.prototype,"track",null);class vi{constructor(e){this.rawValue=e}get reviewbody(){return this.rawValue.reviewbody}get reviewtitle(){return this.rawValue.reviewtitle}get reviewer(){return this.rawValue.reviewer}get reviewdate(){return this.rawValue.reviewdate?Pt.shared.parseValue(this.rawValue.reviewdate):void 0}get createdate(){return this.rawValue.createdate?Pt.shared.parseValue(this.rawValue.createdate):void 0}get stars(){return this.rawValue.stars?Oe.shared.parseValue(this.rawValue.stars):void 0}}n([w()],vi.prototype,"reviewdate",null);n([w()],vi.prototype,"createdate",null);n([w()],vi.prototype,"stars",null);class $s{constructor(e){var t,i;this.rawResponse=e,this.created=e.created,this.d1=e.d1,this.d2=e.d2,this.dir=e.dir,this.files=(t=e.files)===null||t===void 0?void 0:t.map(r=>new bt(r)),this.files_count=e.files_count,this.item_last_updated=e.item_last_updated,this.item_size=e.item_size,this.metadata=new x(e.metadata),this.server=e.server,this.uniq=e.uniq,this.workable_servers=e.workable_servers,this.speech_vs_music_asr=e.speech_vs_music_asr,this.reviews=(i=e.reviews)===null||i===void 0?void 0:i.map(r=>new vi(r))}}class xs{constructor(e){this.numFound=e.numFound,this.start=e.start,this.docs=e.docs.map(t=>new x(t)),this.aggregations=e.aggregations}}class Cs{constructor(e){this.rawResponse=e,this.responseHeader=e.responseHeader,this.response=new xs(e.response)}}var je;(function(a){a.networkError="SearchService.NetworkError",a.itemNotFound="SearchService.ItemNotFound",a.decodingError="SearchService.DecodingError",a.searchEngineError="SearchService.SearchEngineError"})(je||(je={}));class qi extends Error{constructor(e,t,i){super(t),this.name=e,this.type=e,this.details=i}}class _s{static aggregateSearchParamsAsString(e){if(e.advancedParams){const t=e.advancedParams.map(r=>({terms:r}));return JSON.stringify(t)}if(e.simpleParams)return e.simpleParams.join(",")}static sortParamsAsString(e){return`${e.field} ${e.direction}`}static generateURLSearchParams(e){const t=new URLSearchParams;if(t.append("q",e.query),t.append("output","json"),e.rows&&t.append("rows",String(e.rows)),e.page&&t.append("page",String(e.page)),e.fields&&t.append("fl",e.fields.join(",")),e.sort){const r=e.sort.map(s=>this.sortParamsAsString(s));t.append("sort",r.join(","))}const i=e.aggregations;if(i){const r=this.aggregateSearchParamsAsString(i);r&&t.append("user_aggs",r)}return t}}class ks{constructor(e){var t;if(this.baseUrl=(t=e==null?void 0:e.baseUrl)!==null&&t!==void 0?t:"archive.org",(e==null?void 0:e.includeCredentials)!==void 0?this.includeCredentials=e.includeCredentials:this.includeCredentials=window.location.href.match(/^https?:\/\/.*archive\.org(:[0-9]+)?/)!==null,(e==null?void 0:e.scope)!==void 0)this.requestScope=e.scope;else{const r=new URL(window.location.href).searchParams.get("scope");r&&(this.requestScope=r)}}async performSearch(e){const i=_s.generateURLSearchParams(e).toString(),r=`https://${this.baseUrl}/advancedsearch.php?${i}`;return this.fetchUrl(r)}async fetchMetadata(e,t){const i=t?`/${t}`:"",r=`https://${this.baseUrl}/metadata/${e}${i}`;return this.fetchUrl(r,{requestOptions:{credentials:"omit"}})}async fetchUrl(e,t){var i;const r=new URL(e);this.requestScope&&r.searchParams.set("scope",this.requestScope);let s;try{const o=(i=t==null?void 0:t.requestOptions)!==null&&i!==void 0?i:{credentials:this.includeCredentials?"include":"same-origin"};s=await fetch(r.href,o)}catch(o){const l=o instanceof Error?o.message:typeof o=="string"?o:"Unknown error";return this.getErrorResult(je.networkError,l)}try{const o=await s.json(),l=o.error;if(l){const d=o.forensics;return this.getErrorResult(je.searchEngineError,l,d)}else return{success:o}}catch(o){const l=o instanceof Error?o.message:typeof o=="string"?o:"Unknown error";return this.getErrorResult(je.decodingError,l)}}getErrorResult(e,t,i){return{error:new qi(e,t,i)}}}class Xi{constructor(e){this.searchBackend=e}async search(e){const t=await this.searchBackend.performSearch(e);return t.error?t:{success:new Cs(t.success)}}async fetchMetadata(e){var t;const i=await this.searchBackend.fetchMetadata(e);return i.error?i:((t=i.success)===null||t===void 0?void 0:t.metadata)===void 0?{error:new qi(je.itemNotFound)}:{success:new $s(i.success)}}async fetchMetadataValue(e,t){var i;const r=await this.searchBackend.fetchMetadata(e,t);return r.error?r:((i=r.success)===null||i===void 0?void 0:i.result)===void 0?{error:new qi(je.itemNotFound)}:{success:r.success.result}}}Xi.default=new Xi(new ks);function Ts(){var a=!navigator.userAgentData&&/Safari\//.test(navigator.userAgent)&&!/Chrom(e|ium)\//.test(navigator.userAgent);if(!a||!indexedDB.databases)return Promise.resolve();var e;return new Promise(function(t){var i=function(){return indexedDB.databases().finally(t)};e=setInterval(i,100),i()}).finally(function(){return clearInterval(e)})}function yt(a){return new Promise((e,t)=>{a.oncomplete=a.onsuccess=()=>e(a.result),a.onabort=a.onerror=()=>t(a.error)})}function Ds(a,e){const t=Ts().then(()=>{const i=indexedDB.open(a);return i.onupgradeneeded=()=>i.result.createObjectStore(e),yt(i)});return(i,r)=>t.then(s=>r(s.transaction(e,i).objectStore(e)))}let Ai;function mi(){return Ai||(Ai=Ds("keyval-store","keyval")),Ai}function Ms(a,e=mi()){return e("readonly",t=>yt(t.get(a)))}function As(a,e,t=mi()){return t("readwrite",i=>(i.put(e,a),yt(i.transaction)))}function Es(a,e=mi()){return e("readwrite",t=>(t.delete(a),yt(t.transaction)))}function Os(a,e){return a.openCursor().onsuccess=function(){!this.result||(e(this.result),this.result.continue())},yt(a.transaction)}function Ls(a=mi()){return a("readonly",e=>{if(e.getAllKeys)return yt(e.getAllKeys());const t=[];return Os(e,i=>t.push(i.key)).then(()=>t)})}function Fs(a,e){return a.setMilliseconds(a.getMilliseconds()+e*1e3),a}class Rs{constructor(e){var t,i,r,s;if(this.namespace=(t=e==null?void 0:e.namespace)!==null&&t!==void 0?t:"LocalCache",this.defaultTTL=(i=e==null?void 0:e.defaultTTL)!==null&&i!==void 0?i:15*60,(!((r=e==null?void 0:e.immediateClean)!==null&&r!==void 0)||r)&&this.cleanExpired(),!(e!=null&&e.disableCleaning)){const o=(s=e==null?void 0:e.cleaningInterval)!==null&&s!==void 0?s:60;setInterval(()=>{this.cleanExpired()},o*1e3)}}async set(e){var t;const i={value:e.value},r=(t=e.ttl)!==null&&t!==void 0?t:this.defaultTTL,s=Fs(new Date,r);i.expires=s;const o=this.getNamespacedKey(e.key);try{await As(o,i)}catch{}}async get(e){const t=this.getNamespacedKey(e);let i;try{i=await Ms(t)}catch{}if(!i)return;const r=new Date;if(i.expires&&i.expires<r){await this.delete(e);return}return i.value}async delete(e){const t=this.getNamespacedKey(e);try{await Es(t)}catch{}}async cleanExpired(){const e=await this.getAllKeys();await Promise.all(e.map(async t=>this.get(t)))}async getAllKeys(){let e=[];try{e=await Ls()}catch{}const t=[];for(const s of e)typeof s=="string"&&t.push(s);return t.filter(s=>s.startsWith(this.namespace)).map(s=>this.removeNamespace(s))}getNamespacedKey(e){return`${this.namespace}-${e}`}removeNamespace(e){return e.replace(`${this.namespace}-`,"")}}/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const lr=window.ShadowRoot&&(window.ShadyCSS===void 0||window.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,dr=Symbol(),Br=new Map;class ka{constructor(e,t){if(this._$cssResult$=!0,t!==dr)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e}get styleSheet(){let e=Br.get(this.cssText);return lr&&e===void 0&&(Br.set(this.cssText,e=new CSSStyleSheet),e.replaceSync(this.cssText)),e}toString(){return this.cssText}}const Is=a=>new ka(typeof a=="string"?a:a+"",dr),b=(a,...e)=>{const t=a.length===1?a[0]:e.reduce((i,r,s)=>i+(o=>{if(o._$cssResult$===!0)return o.cssText;if(typeof o=="number")return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(r)+a[s+1],a[0]);return new ka(t,dr)},zs=(a,e)=>{lr?a.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet):e.forEach(t=>{const i=document.createElement("style"),r=window.litNonce;r!==void 0&&i.setAttribute("nonce",r),i.textContent=t.cssText,a.appendChild(i)})},Ur=lr?a=>a:a=>a instanceof CSSStyleSheet?(e=>{let t="";for(const i of e.cssRules)t+=i.cssText;return Is(t)})(a):a;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Ei;const Hr=window.trustedTypes,Ns=Hr?Hr.emptyScript:"",Wr=window.reactiveElementPolyfillSupport,Zi={toAttribute(a,e){switch(e){case Boolean:a=a?Ns:null;break;case Object:case Array:a=a==null?a:JSON.stringify(a)}return a},fromAttribute(a,e){let t=a;switch(e){case Boolean:t=a!==null;break;case Number:t=a===null?null:Number(a);break;case Object:case Array:try{t=JSON.parse(a)}catch{t=null}}return t}},Ta=(a,e)=>e!==a&&(e==e||a==a),Oi={attribute:!0,type:String,converter:Zi,reflect:!1,hasChanged:Ta};class nt extends HTMLElement{constructor(){super(),this._$Et=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Ei=null,this.o()}static addInitializer(e){var t;(t=this.l)!==null&&t!==void 0||(this.l=[]),this.l.push(e)}static get observedAttributes(){this.finalize();const e=[];return this.elementProperties.forEach((t,i)=>{const r=this._$Eh(i,t);r!==void 0&&(this._$Eu.set(r,i),e.push(r))}),e}static createProperty(e,t=Oi){if(t.state&&(t.attribute=!1),this.finalize(),this.elementProperties.set(e,t),!t.noAccessor&&!this.prototype.hasOwnProperty(e)){const i=typeof e=="symbol"?Symbol():"__"+e,r=this.getPropertyDescriptor(e,i,t);r!==void 0&&Object.defineProperty(this.prototype,e,r)}}static getPropertyDescriptor(e,t,i){return{get(){return this[t]},set(r){const s=this[e];this[t]=r,this.requestUpdate(e,s,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)||Oi}static finalize(){if(this.hasOwnProperty("finalized"))return!1;this.finalized=!0;const e=Object.getPrototypeOf(this);if(e.finalize(),this.elementProperties=new Map(e.elementProperties),this._$Eu=new Map,this.hasOwnProperty("properties")){const t=this.properties,i=[...Object.getOwnPropertyNames(t),...Object.getOwnPropertySymbols(t)];for(const r of i)this.createProperty(r,t[r])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const i=new Set(e.flat(1/0).reverse());for(const r of i)t.unshift(Ur(r))}else e!==void 0&&t.push(Ur(e));return t}static _$Eh(e,t){const i=t.attribute;return i===!1?void 0:typeof i=="string"?i:typeof e=="string"?e.toLowerCase():void 0}o(){var e;this._$Ep=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$Em(),this.requestUpdate(),(e=this.constructor.l)===null||e===void 0||e.forEach(t=>t(this))}addController(e){var t,i;((t=this._$Eg)!==null&&t!==void 0?t:this._$Eg=[]).push(e),this.renderRoot!==void 0&&this.isConnected&&((i=e.hostConnected)===null||i===void 0||i.call(e))}removeController(e){var t;(t=this._$Eg)===null||t===void 0||t.splice(this._$Eg.indexOf(e)>>>0,1)}_$Em(){this.constructor.elementProperties.forEach((e,t)=>{this.hasOwnProperty(t)&&(this._$Et.set(t,this[t]),delete this[t])})}createRenderRoot(){var e;const t=(e=this.shadowRoot)!==null&&e!==void 0?e:this.attachShadow(this.constructor.shadowRootOptions);return zs(t,this.constructor.elementStyles),t}connectedCallback(){var e;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$Eg)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostConnected)===null||i===void 0?void 0:i.call(t)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$Eg)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostDisconnected)===null||i===void 0?void 0:i.call(t)})}attributeChangedCallback(e,t,i){this._$AK(e,i)}_$ES(e,t,i=Oi){var r,s;const o=this.constructor._$Eh(e,i);if(o!==void 0&&i.reflect===!0){const l=((s=(r=i.converter)===null||r===void 0?void 0:r.toAttribute)!==null&&s!==void 0?s:Zi.toAttribute)(t,i.type);this._$Ei=e,l==null?this.removeAttribute(o):this.setAttribute(o,l),this._$Ei=null}}_$AK(e,t){var i,r,s;const o=this.constructor,l=o._$Eu.get(e);if(l!==void 0&&this._$Ei!==l){const d=o.getPropertyOptions(l),h=d.converter,p=(s=(r=(i=h)===null||i===void 0?void 0:i.fromAttribute)!==null&&r!==void 0?r:typeof h=="function"?h:null)!==null&&s!==void 0?s:Zi.fromAttribute;this._$Ei=l,this[l]=p(t,d.type),this._$Ei=null}}requestUpdate(e,t,i){let r=!0;e!==void 0&&(((i=i||this.constructor.getPropertyOptions(e)).hasChanged||Ta)(this[e],t)?(this._$AL.has(e)||this._$AL.set(e,t),i.reflect===!0&&this._$Ei!==e&&(this._$EC===void 0&&(this._$EC=new Map),this._$EC.set(e,i))):r=!1),!this.isUpdatePending&&r&&(this._$Ep=this._$E_())}async _$E_(){this.isUpdatePending=!0;try{await this._$Ep}catch(t){Promise.reject(t)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var e;if(!this.isUpdatePending)return;this.hasUpdated,this._$Et&&(this._$Et.forEach((r,s)=>this[s]=r),this._$Et=void 0);let t=!1;const i=this._$AL;try{t=this.shouldUpdate(i),t?(this.willUpdate(i),(e=this._$Eg)===null||e===void 0||e.forEach(r=>{var s;return(s=r.hostUpdate)===null||s===void 0?void 0:s.call(r)}),this.update(i)):this._$EU()}catch(r){throw t=!1,this._$EU(),r}t&&this._$AE(i)}willUpdate(e){}_$AE(e){var t;(t=this._$Eg)===null||t===void 0||t.forEach(i=>{var r;return(r=i.hostUpdated)===null||r===void 0?void 0:r.call(i)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EU(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$Ep}shouldUpdate(e){return!0}update(e){this._$EC!==void 0&&(this._$EC.forEach((t,i)=>this._$ES(i,this[i],t)),this._$EC=void 0),this._$EU()}updated(e){}firstUpdated(e){}}nt.finalized=!0,nt.elementProperties=new Map,nt.elementStyles=[],nt.shadowRootOptions={mode:"open"},Wr==null||Wr({ReactiveElement:nt}),((Ei=globalThis.reactiveElementVersions)!==null&&Ei!==void 0?Ei:globalThis.reactiveElementVersions=[]).push("1.3.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Li;const pt=globalThis.trustedTypes,Vr=pt?pt.createPolicy("lit-html",{createHTML:a=>a}):void 0,xe=`lit$${(Math.random()+"").slice(9)}$`,cr="?"+xe,Ps=`<${cr}>`,vt=document,Bt=(a="")=>vt.createComment(a),Ut=a=>a===null||typeof a!="object"&&typeof a!="function",Da=Array.isArray,Ma=a=>{var e;return Da(a)||typeof((e=a)===null||e===void 0?void 0:e[Symbol.iterator])=="function"},Et=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,jr=/-->/g,Qr=/>/g,Be=/>|[ 	\n\r](?:([^\s"'>=/]+)([ 	\n\r]*=[ 	\n\r]*(?:[^ 	\n\r"'`<>=]|("|')|))|$)/g,Gr=/'/g,Yr=/"/g,Aa=/^(?:script|style|textarea|title)$/i,Ea=a=>(e,...t)=>({_$litType$:a,strings:e,values:t}),m=Ea(1),L=Ea(2),ce=Symbol.for("lit-noChange"),_=Symbol.for("lit-nothing"),Kr=new WeakMap,ti=(a,e,t)=>{var i,r;const s=(i=t==null?void 0:t.renderBefore)!==null&&i!==void 0?i:e;let o=s._$litPart$;if(o===void 0){const l=(r=t==null?void 0:t.renderBefore)!==null&&r!==void 0?r:null;s._$litPart$=o=new wt(e.insertBefore(Bt(),l),l,void 0,t!=null?t:{})}return o._$AI(a),o},ut=vt.createTreeWalker(vt,129,null,!1),Oa=(a,e)=>{const t=a.length-1,i=[];let r,s=e===2?"<svg>":"",o=Et;for(let d=0;d<t;d++){const h=a[d];let p,v,f=-1,y=0;for(;y<h.length&&(o.lastIndex=y,v=o.exec(h),v!==null);)y=o.lastIndex,o===Et?v[1]==="!--"?o=jr:v[1]!==void 0?o=Qr:v[2]!==void 0?(Aa.test(v[2])&&(r=RegExp("</"+v[2],"g")),o=Be):v[3]!==void 0&&(o=Be):o===Be?v[0]===">"?(o=r!=null?r:Et,f=-1):v[1]===void 0?f=-2:(f=o.lastIndex-v[2].length,p=v[1],o=v[3]===void 0?Be:v[3]==='"'?Yr:Gr):o===Yr||o===Gr?o=Be:o===jr||o===Qr?o=Et:(o=Be,r=void 0);const $=o===Be&&a[d+1].startsWith("/>")?" ":"";s+=o===Et?h+Ps:f>=0?(i.push(p),h.slice(0,f)+"$lit$"+h.slice(f)+xe+$):h+xe+(f===-2?(i.push(void 0),d):$)}const l=s+(a[t]||"<?>")+(e===2?"</svg>":"");if(!Array.isArray(a)||!a.hasOwnProperty("raw"))throw Error("invalid template strings array");return[Vr!==void 0?Vr.createHTML(l):l,i]};class Ht{constructor({strings:e,_$litType$:t},i){let r;this.parts=[];let s=0,o=0;const l=e.length-1,d=this.parts,[h,p]=Oa(e,t);if(this.el=Ht.createElement(h,i),ut.currentNode=this.el.content,t===2){const v=this.el.content,f=v.firstChild;f.remove(),v.append(...f.childNodes)}for(;(r=ut.nextNode())!==null&&d.length<l;){if(r.nodeType===1){if(r.hasAttributes()){const v=[];for(const f of r.getAttributeNames())if(f.endsWith("$lit$")||f.startsWith(xe)){const y=p[o++];if(v.push(f),y!==void 0){const $=r.getAttribute(y.toLowerCase()+"$lit$").split(xe),k=/([.?@])?(.*)/.exec(y);d.push({type:1,index:s,name:k[2],strings:$,ctor:k[1]==="."?Fa:k[1]==="?"?Ra:k[1]==="@"?Ia:jt})}else d.push({type:6,index:s})}for(const f of v)r.removeAttribute(f)}if(Aa.test(r.tagName)){const v=r.textContent.split(xe),f=v.length-1;if(f>0){r.textContent=pt?pt.emptyScript:"";for(let y=0;y<f;y++)r.append(v[y],Bt()),ut.nextNode(),d.push({type:2,index:++s});r.append(v[f],Bt())}}}else if(r.nodeType===8)if(r.data===cr)d.push({type:2,index:s});else{let v=-1;for(;(v=r.data.indexOf(xe,v+1))!==-1;)d.push({type:7,index:s}),v+=xe.length-1}s++}}static createElement(e,t){const i=vt.createElement("template");return i.innerHTML=e,i}}function Ye(a,e,t=a,i){var r,s,o,l;if(e===ce)return e;let d=i!==void 0?(r=t._$Cl)===null||r===void 0?void 0:r[i]:t._$Cu;const h=Ut(e)?void 0:e._$litDirective$;return(d==null?void 0:d.constructor)!==h&&((s=d==null?void 0:d._$AO)===null||s===void 0||s.call(d,!1),h===void 0?d=void 0:(d=new h(a),d._$AT(a,t,i)),i!==void 0?((o=(l=t)._$Cl)!==null&&o!==void 0?o:l._$Cl=[])[i]=d:t._$Cu=d),d!==void 0&&(e=Ye(a,d._$AS(a,e.values),d,i)),e}class La{constructor(e,t){this.v=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}p(e){var t;const{el:{content:i},parts:r}=this._$AD,s=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:vt).importNode(i,!0);ut.currentNode=s;let o=ut.nextNode(),l=0,d=0,h=r[0];for(;h!==void 0;){if(l===h.index){let p;h.type===2?p=new wt(o,o.nextSibling,this,e):h.type===1?p=new h.ctor(o,h.name,h.strings,this,e):h.type===6&&(p=new za(o,this,e)),this.v.push(p),h=r[++d]}l!==(h==null?void 0:h.index)&&(o=ut.nextNode(),l++)}return s}m(e){let t=0;for(const i of this.v)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class wt{constructor(e,t,i,r){var s;this.type=2,this._$AH=_,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=r,this._$Cg=(s=r==null?void 0:r.isConnected)===null||s===void 0||s}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cg}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&e.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Ye(this,e,t),Ut(e)?e===_||e==null||e===""?(this._$AH!==_&&this._$AR(),this._$AH=_):e!==this._$AH&&e!==ce&&this.$(e):e._$litType$!==void 0?this.T(e):e.nodeType!==void 0?this.k(e):Ma(e)?this.S(e):this.$(e)}M(e,t=this._$AB){return this._$AA.parentNode.insertBefore(e,t)}k(e){this._$AH!==e&&(this._$AR(),this._$AH=this.M(e))}$(e){this._$AH!==_&&Ut(this._$AH)?this._$AA.nextSibling.data=e:this.k(vt.createTextNode(e)),this._$AH=e}T(e){var t;const{values:i,_$litType$:r}=e,s=typeof r=="number"?this._$AC(e):(r.el===void 0&&(r.el=Ht.createElement(r.h,this.options)),r);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===s)this._$AH.m(i);else{const o=new La(s,this),l=o.p(this.options);o.m(i),this.k(l),this._$AH=o}}_$AC(e){let t=Kr.get(e.strings);return t===void 0&&Kr.set(e.strings,t=new Ht(e)),t}S(e){Da(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,r=0;for(const s of e)r===t.length?t.push(i=new wt(this.M(Bt()),this.M(Bt()),this,this.options)):i=t[r],i._$AI(s),r++;r<t.length&&(this._$AR(i&&i._$AB.nextSibling,r),t.length=r)}_$AR(e=this._$AA.nextSibling,t){var i;for((i=this._$AP)===null||i===void 0||i.call(this,!1,!0,t);e&&e!==this._$AB;){const r=e.nextSibling;e.remove(),e=r}}setConnected(e){var t;this._$AM===void 0&&(this._$Cg=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}}class jt{constructor(e,t,i,r,s){this.type=1,this._$AH=_,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=s,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=_}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,i,r){const s=this.strings;let o=!1;if(s===void 0)e=Ye(this,e,t,0),o=!Ut(e)||e!==this._$AH&&e!==ce,o&&(this._$AH=e);else{const l=e;let d,h;for(e=s[0],d=0;d<s.length-1;d++)h=Ye(this,l[i+d],t,d),h===ce&&(h=this._$AH[d]),o||(o=!Ut(h)||h!==this._$AH[d]),h===_?e=_:e!==_&&(e+=(h!=null?h:"")+s[d+1]),this._$AH[d]=h}o&&!r&&this.C(e)}C(e){e===_?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e!=null?e:"")}}class Fa extends jt{constructor(){super(...arguments),this.type=3}C(e){this.element[this.name]=e===_?void 0:e}}const Bs=pt?pt.emptyScript:"";class Ra extends jt{constructor(){super(...arguments),this.type=4}C(e){e&&e!==_?this.element.setAttribute(this.name,Bs):this.element.removeAttribute(this.name)}}class Ia extends jt{constructor(e,t,i,r,s){super(e,t,i,r,s),this.type=5}_$AI(e,t=this){var i;if((e=(i=Ye(this,e,t,0))!==null&&i!==void 0?i:_)===ce)return;const r=this._$AH,s=e===_&&r!==_||e.capture!==r.capture||e.once!==r.once||e.passive!==r.passive,o=e!==_&&(r===_||s);s&&this.element.removeEventListener(this.name,this,r),o&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,i;typeof this._$AH=="function"?this._$AH.call((i=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&i!==void 0?i:this.element,e):this._$AH.handleEvent(e)}}class za{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){Ye(this,e)}}const Us={L:"$lit$",P:xe,V:cr,I:1,N:Oa,R:La,j:Ma,D:Ye,H:wt,F:jt,O:Ra,W:Ia,B:Fa,Z:za},qr=window.litHtmlPolyfillSupport;qr==null||qr(Ht,wt),((Li=globalThis.litHtmlVersions)!==null&&Li!==void 0?Li:globalThis.litHtmlVersions=[]).push("2.2.4");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Fi,Ri;class P extends nt{constructor(){super(...arguments),this.renderOptions={host:this},this._$Dt=void 0}createRenderRoot(){var e,t;const i=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=i.firstChild),i}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Dt=ti(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Dt)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Dt)===null||e===void 0||e.setConnected(!1)}render(){return ce}}P.finalized=!0,P._$litElement$=!0,(Fi=globalThis.litElementHydrateSupport)===null||Fi===void 0||Fi.call(globalThis,{LitElement:P});const Xr=globalThis.litElementPolyfillSupport;Xr==null||Xr({LitElement:P});((Ri=globalThis.litElementVersions)!==null&&Ri!==void 0?Ri:globalThis.litElementVersions=[]).push("3.2.0");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const V=a=>e=>typeof e=="function"?((t,i)=>(window.customElements.define(t,i),i))(a,e):((t,i)=>{const{kind:r,elements:s}=i;return{kind:r,elements:s,finisher(o){window.customElements.define(t,o)}}})(a,e);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Hs=(a,e)=>e.kind==="method"&&e.descriptor&&!("value"in e.descriptor)?At(fe({},e),{finisher(t){t.createProperty(e.key,a)}}):{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){typeof e.initializer=="function"&&(this[e.key]=e.initializer.call(this))},finisher(t){t.createProperty(e.key,a)}};function u(a){return(e,t)=>t!==void 0?((i,r,s)=>{r.constructor.createProperty(s,i)})(a,e,t):Hs(a,e)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */const Jr=(a,e,t)=>{const i=new Map;for(let r=e;r<=t;r++)i.set(a[r],r);return i},Ba=hr(class extends ur{constructor(a){if(super(a),a.type!==Me.CHILD)throw Error("repeat() can only be used in text expressions")}dt(a,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);const r=[],s=[];let o=0;for(const l of a)r[o]=i?i(l,o):o,s[o]=t(l,o),o++;return{values:s,keys:r}}render(a,e,t){return this.dt(a,e,t).values}update(a,[e,t,i]){var r;const s=Ks(a),{values:o,keys:l}=this.dt(e,t,i);if(!Array.isArray(s))return this.ut=l,o;const d=(r=this.ut)!==null&&r!==void 0?r:this.ut=[],h=[];let p,v,f=0,y=s.length-1,$=0,k=o.length-1;for(;f<=y&&$<=k;)if(s[f]===null)f++;else if(s[y]===null)y--;else if(d[f]===l[$])h[$]=Ue(s[f],o[$]),f++,$++;else if(d[y]===l[k])h[k]=Ue(s[y],o[k]),y--,k--;else if(d[f]===l[k])h[k]=Ue(s[f],o[k]),Ot(a,h[k+1],s[f]),f++,k--;else if(d[y]===l[$])h[$]=Ue(s[y],o[$]),Ot(a,s[f],s[y]),y--,$++;else if(p===void 0&&(p=Jr(l,$,k),v=Jr(d,f,y)),p.has(d[f]))if(p.has(d[y])){const E=v.get(l[$]),A=E!==void 0?s[E]:null;if(A===null){const R=Ot(a,s[f]);Ue(R,o[$]),h[$]=R}else h[$]=Ue(A,o[$]),Ot(a,s[f],A),s[E]=null;$++}else zi(s[y]),y--;else zi(s[f]),f++;for(;$<=k;){const E=Ot(a,h[k+1]);Ue(E,o[$]),h[$++]=E}for(;f<=y;){const E=s[f++];E!==null&&zi(E)}return this.ut=l,Pa(a,h),ce}});function Xt(a,e,t){return Array.from({length:(e-a)/t+1},(i,r)=>a+r*t)}let Fe=class extends P{constructor(){super(...arguments),this.itemCount=0,this.scrollOptimizationsDisabled=!1,this.intersectionObserver=new IntersectionObserver(e=>{e.forEach(t=>{if(t.target===this.sentinel){t.isIntersecting&&this.dispatchEvent(new Event("scrollThresholdReached"));return}const r=t.target.dataset.cellIndex;if(!r)return;const s=parseInt(r,10);t.isIntersecting?this.visibleCellIndices.add(s):this.visibleCellIndices.delete(s)}),this.scrollOptimizationsDisabled||this.processVisibleCells()}),this.renderedCellIndices=new Set,this.visibleCellIndices=new Set,this.placeholderCellIndices=new Set}reload(){Xt(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.removeCell(t)),this.renderedCellIndices.clear(),this.visibleCellIndices.clear(),this.placeholderCellIndices.clear(),this.setupObservations()}scrollToCell(e,t){const i=this.cellContainers[e];if(!i)return!1;const r=t?"smooth":"auto";return i.scrollIntoView({behavior:r}),!0}getVisibleCellIndices(){return Array.from(this.visibleCellIndices)}updated(e){(e.has("itemCount")||e.has("scrollOptimizationsDisabled"))&&this.setupObservations()}disconnectedCallback(){this.intersectionObserver.disconnect()}setupObservations(){this.setupIntersectionObserver()}setupIntersectionObserver(){this.intersectionObserver.disconnect(),this.sentinel&&this.intersectionObserver.observe(this.sentinel),this.scrollOptimizationsDisabled?(Xt(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.visibleCellIndices.add(t)),this.processVisibleCells()):this.cellContainers.forEach(e=>this.intersectionObserver.observe(e))}render(){const e=this.itemCount-1,t=Xt(0,e,1);return m`
    ...
    `}};n([u({type:Number})],Fe.prototype,"itemCount",void 0);n([u({type:Object})],Fe.prototype,"cellProvider",void 0);n([u({type:Object})],Fe.prototype,"placeholderCellTemplate",void 0);n([u({type:Boolean})],Fe.prototype,"scrollOptimizationsDisabled",void 0);n([le("#sentinel")],Fe.prototype,"sentinel",void 0);n([Ws(".cell-container")],Fe.prototype,"cellContainers",void 0);Fe=n([V("infinite-scroller")],Fe);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const qs=(a,...e)=>({strTag:!0,strings:a,values:e}),ot=qs,Xs=a=>typeof a!="string"&&"strTag"in a,Zs=(a,e,t)=>{let i=a[0];for(let r=1;r<a.length;r++)i+=e[t?t[r-1]:r-1],i+=a[r];return i};/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Js=a=>Xs(a)?Zs(a.strings,a.values):a;/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class eo{constructor(){this.settled=!1,this.promise=new Promise((e,t)=>{this._resolve=e,this._reject=t})}resolve(e){this.settled=!0,this._resolve(e)}reject(e){this.settled=!0,this._reject(e)}}/**
 * @license
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let to=new eo;to.resolve();/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let We=Js;const Ua=L`
...
`;let Ji=class extends P{render(){var e,t,i;return m`
      <div id="container">
        ...
        <div id="item-count-container">
          <div id="item-count-image-container">${Ua}</div>
    ...
    `}};n([u({type:Object})],Ji.prototype,"model",void 0);Ji=n([V("collection-tile")],Ji);const io=L`
...
`,vo={account:{color:"#000000",icon:io,text:"Account"},audio:{color:"#00adef",icon:ro,text:"Audio"},collection:{color:"#4666ff",icon:Ua,text:"Collection"},data:{color:"#333333",icon:ao,text:"Data"},etree:{color:"#00adef",icon:so,text:"E-tree"},film:{color:"#bf1b2c",icon:ea,text:"Film"},image:{color:"#aa99c9",icon:oo,text:"Image"},movies:{color:"#f1644b",icon:ea,text:"Movie"},radio:{color:"#8fdaef",icon:no,text:"Radio"},software:{color:"#9ecc4f",icon:lo,text:"Software"},texts:{color:"#faab3c",icon:co,text:"Text"},tv:{color:"#f1644b",icon:ho,text:"TV"},video:{color:"#f1644b",icon:uo,text:"Video"},web:{color:"#ffcd27",icon:po,text:"Web"}};let Vt=class extends P{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var e,t;const i=["tvnews","tvarchive","television"],r=["radio","radioprogram"];return this.mediatype==="movies"&&((e=this.collections)===null||e===void 0?void 0:e.some(s=>i.indexOf(s)>=0))?"tv":this.mediatype==="audio"&&((t=this.collections)===null||t===void 0?void 0:t.some(s=>r.indexOf(s)>=0))?"radio":this.mediatype||""}render(){const e=vo[this.displayMediatype];return e?m`
      <div
        id="icon"
 ...
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ta=hr(class extends ur{constructor(a){var e;if(super(a),a.type!==Me.ATTRIBUTE||a.name!=="class"||((e=a.strings)===null||e===void 0?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(a){return" "+Object.keys(a).filter(e=>a[e]).join(" ")+" "}update(a,[e]){var t,i;if(this.et===void 0){this.et=new Set,a.strings!==void 0&&(this.st=new Set(a.strings.join(" ").split(/\s/).filter(s=>s!=="")));for(const s in e)e[s]&&!(!((t=this.st)===null||t===void 0)&&t.has(s))&&this.et.add(s);return this.render(e)}const r=a.element.classList;this.et.forEach(s=>{s in e||(r.remove(s),this.et.delete(s))});for(const s in e){const o=!!e[s];o===this.et.has(s)||((i=this.st)===null||i===void 0?void 0:i.has(s))||(o?(r.add(s),this.et.add(s)):(r.remove(s),this.et.delete(s)))}return ce}}),mo=b`
  .drop-shadow {
...
`;let mt=class extends P{constructor(){super(...arguments),this.isListTile=!1,this.loggedIn=!1,this.loginRequired=!1,this.contentWarning=!1}render(){return this.loginRequired&&!this.loggedIn?m` ${this.loginRequiredTemplate} `:m` ${this.contentWarningTemplate} `}get loginRequiredTemplate(){return this.isListTile?m` ${bo} `:m`
      <div class="tile-action no-preview">Log in to view this item</div>
    `}get contentWarningTemplate(){return this.isListTile?m` ${fo} `:m`
    ...
    `}};n([u({type:Boolean})],mt.prototype,"isListTile",void 0);n([u({type:Boolean})],mt.prototype,"loggedIn",void 0);n([u({type:Boolean})],mt.prototype,"loginRequired",void 0);n([u({type:Boolean})],mt.prototype,"contentWarning",void 0);mt=n([V("item-image-overlay")],mt);let Ce=class extends P{constructor(){super(...arguments),this.isListTile=!1,this.isCompactTile=!1,this.loggedIn=!1,this.isWaveform=!1}render(){return m`
      <div class=${ta(this.itemBaseClass)}>
        <img
          class=${ta(this.itemImageClass)}
          src="${this.imageSrc}"
          alt=""
          @load=${this.onLoad}
        />
    ...
    `}get itemImageOverlayTemplate(){var e,t,i,r;return!(!((e=this.model)===null||e===void 0)&&e.loginRequired)&&!(!((t=this.model)===null||t===void 0)&&t.contentWarning)?_:m`
      <item-image-overlay
...
`;function xo(a,e){let t=1;return a>=1e9?t=1e9:a>=1e6?t=1e6:a>=1e3&&e==="short"&&(t=1e3),t}function Co(a=0,e){const t=a/e,i=t<10;let r=0;return i?r=Math.round((t+Number.EPSILON)*10)/10:r=Math.round(t),r}function _o(a,e,t,i){switch(e){case 1e9:return We(t==="short"?ot`${a}B`:ot`${a} billion`);case 1e6:return We(t==="short"?ot`${a}M`:ot`${a} million`);case 1e3:return We(t==="short"?ot`${a}K`:ot`${a} thousand`);default:return new Intl.NumberFormat(i).format(a)}}function It(a,e="long",t="short",i="en-US"){const r=a!=null?a:-1;if(r<0)return"";const s=xo(r,e),o=Co(r,s);return _o(o,s,t,i)}let Ke=class extends P{render(){return m`
      <div class="item-stats">
        ...
        <ul id="stats-row">
          ...
          <li class="col">
            ${this.mediatype==="account"?So:$o}
            <p class="status-text">
              <span class="sr-only">
                ${this.mediatype==="account"?"Uploads:":"Views:"}
              </span>
              ${It(this.mediatype==="account"?this.itemCount:this.viewCount,"short","short")}
            </p>
          </li>
          <li class="col">
            ${yo}
          ...
          <li class="col">
            ...
            <p class="status-text">
              ...
              ${It(this.commentCount,"short","short")}
            </p>
          </li>
        </ul>
      </div>
    ...
    `}};n([u({type:Object})],li.prototype,"model",void 0);n([u({type:String})],li.prototype,"baseImageUrl",void 0);li=n([V("item-tile")],li);let er=class extends P{render(){var e,t,i,r,s,o,l,d;return m`
    ...
    `}};n([u({type:Object})],er.prototype,"model",void 0);er=n([V("account-tile")],er);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*Ni(a,e){const t=typeof e=="function";if(a!==void 0){let i=-1;for(const r of a)i>-1&&(yield t?e(i):e),i++,yield r}}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*ia(a,e){if(a!==void 0){let t=0;for(const i of a)yield e(i,t++)}}/*! @license DOMPurify 2.3.8 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/2.3.8/LICENSE */function Ve(a){return Ve=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},Ve(a)}function tr(a,e){return tr=Object.setPrototypeOf||function(i,r){return i.__proto__=r,i},tr(a,e)}function ko(){if(typeof Reflect=="undefined"||!Reflect.construct||Reflect.construct.sham)return!1;if(typeof Proxy=="function")return!0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],function(){})),!0}catch{return!1}}function ii(a,e,t){return ko()?ii=Reflect.construct:ii=function(r,s,o){var l=[null];l.push.apply(l,s);var d=Function.bind.apply(r,l),h=new d;return o&&tr(h,o.prototype),h},ii.apply(null,arguments)}function he(a){return To(a)||Do(a)||Mo(a)||Ao()}function To(a){if(Array.isArray(a))return ir(a)}function Do(a){if(typeof Symbol!="undefined"&&a[Symbol.iterator]!=null||a["@@iterator"]!=null)return Array.from(a)}function Mo(a,e){if(!!a){if(typeof a=="string")return ir(a,e);var t=Object.prototype.toString.call(a).slice(8,-1);if(t==="Object"&&a.constructor&&(t=a.constructor.name),t==="Map"||t==="Set")return Array.from(a);if(t==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t))return ir(a,e)}}function ir(a,e){(e==null||e>a.length)&&(e=a.length);for(var t=0,i=new Array(e);t<e;t++)i[t]=a[t];return i}function Ao(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}var Eo=Object.hasOwnProperty,ra=Object.setPrototypeOf,Oo=Object.isFrozen,Lo=Object.getPrototypeOf,Fo=Object.getOwnPropertyDescriptor,ee=Object.freeze,ye=Object.seal,Ro=Object.create,Ha=typeof Reflect!="undefined"&&Reflect,di=Ha.apply,rr=Ha.construct;di||(di=function(e,t,i){return e.apply(t,i)});ee||(ee=function(e){return e});ye||(ye=function(e){return e});rr||(rr=function(e,t){return ii(e,he(t))});var Io=pe(Array.prototype.forEach),aa=pe(Array.prototype.pop),Lt=pe(Array.prototype.push),ri=pe(String.prototype.toLowerCase),zo=pe(String.prototype.match),De=pe(String.prototype.replace),No=pe(String.prototype.indexOf),Po=pe(String.prototype.trim),J=pe(RegExp.prototype.test),Pi=Bo(TypeError);function pe(a){return function(e){for(var t=arguments.length,i=new Array(t>1?t-1:0),r=1;r<t;r++)i[r-1]=arguments[r];return di(a,e,i)}}function Bo(a){return function(){for(var e=arguments.length,t=new Array(e),i=0;i<e;i++)t[i]=arguments[i];return rr(a,t)}}function M(a,e){ra&&ra(a,null);for(var t=e.length;t--;){var i=e[t];if(typeof i=="string"){var r=ri(i);r!==i&&(Oo(e)||(e[t]=r),i=r)}a[i]=!0}return a}function He(a){var e=Ro(null),t;for(t in a)di(Eo,a,[t])&&(e[t]=a[t]);return e}function Zt(a,e){for(;a!==null;){var t=Fo(a,e);if(t){if(t.get)return pe(t.get);if(typeof t.value=="function")return pe(t.value)}a=Lo(a)}function i(r){return console.warn("fallback value for",r),null}return i}var sa=ee(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","section","select","shadow","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),Bi=ee(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","filter","font","g","glyph","glyphref","hkern","image","line","lineargradient","marker","mask","metadata","mpath","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),Ui=ee(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),Uo=ee(["animate","color-profile","cursor","discard","fedropshadow","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),Hi=ee(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover"]),Ho=ee(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),oa=ee(["#text"]),na=ee(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","face","for","headers","height","hidden","high","href","hreflang","id","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","pattern","placeholder","playsinline","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","xmlns","slot"]),Wi=ee(["accent-height","accumulate","additive","alignment-baseline","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),la=ee(["accent","accentunder","align","bevelled","close","columnsalign","columnlines","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lspace","lquote","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),Jt=ee(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),Wo=ye(/\{\{[\w\W]*|[\w\W]*\}\}/gm),Vo=ye(/<%[\w\W]*|[\w\W]*%>/gm),jo=ye(/^data-[\-\w.\u00B7-\uFFFF]/),Qo=ye(/^aria-[\-\w]+$/),Go=ye(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|cid|xmpp):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),Yo=ye(/^(?:\w+script|data):/i),Ko=ye(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),qo=ye(/^html$/i),Xo=function(){return typeof window=="undefined"?null:window},Zo=function(e,t){if(Ve(e)!=="object"||typeof e.createPolicy!="function")return null;var i=null,r="data-tt-policy-suffix";t.currentScript&&t.currentScript.hasAttribute(r)&&(i=t.currentScript.getAttribute(r));var s="dompurify"+(i?"#"+i:"");try{return e.createPolicy(s,{createHTML:function(l){return l}})}catch{return console.warn("TrustedTypes policy "+s+" could not be created."),null}};function Wa(){var a=arguments.length>0&&arguments[0]!==void 0?arguments[0]:Xo(),e=function(c){return Wa(c)};if(e.version="2.3.8",e.removed=[],!a||!a.document||a.document.nodeType!==9)return e.isSupported=!1,e;var t=a.document,i=a.document,r=a.DocumentFragment,s=a.HTMLTemplateElement,o=a.Node,l=a.Element,d=a.NodeFilter,h=a.NamedNodeMap,p=h===void 0?a.NamedNodeMap||a.MozNamedAttrMap:h,v=a.HTMLFormElement,f=a.DOMParser,y=a.trustedTypes,$=l.prototype,k=Zt($,"cloneNode"),E=Zt($,"nextSibling"),A=Zt($,"childNodes"),R=Zt($,"parentNode");if(typeof s=="function"){var F=i.createElement("template");F.content&&F.content.ownerDocument&&(i=F.content.ownerDocument)}var z=Zo(y,t),Y=z?z.createHTML(""):"",se=i,ge=se.implementation,St=se.createNodeIterator,$t=se.createDocumentFragment,xt=se.getElementsByTagName,Ct=t.importNode,qe={};try{qe=He(i).documentMode?i.documentMode:{}}catch{}var te={};e.isSupported=typeof R=="function"&&ge&&typeof ge.createHTMLDocument!="undefined"&&qe!==9;var Re=Wo,Ie=Vo,_t=jo,kt=Qo,Tt=Yo,Xe=Ko,ze=Go,W=null,Ze=M({},[].concat(he(sa),he(Bi),he(Ui),he(Hi),he(oa))),j=null,Je=M({},[].concat(he(na),he(Wi),he(la),he(Jt))),U=Object.seal(Object.create(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),ke=null,fi=null,br=!0,bi=!0,yr=!1,et=!1,Ne=!1,yi=!1,wi=!1,tt=!1,Qt=!1,Gt=!1,wr=!0,Si=!0,Dt=!1,it={},rt=null,Sr=M({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","style","svg","template","thead","title","video","xmp"]),$r=null,xr=M({},["audio","video","img","source","image","track"]),$i=null,Cr=M({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),xi="http://www.w3.org/1998/Math/MathML",Ci="http://www.w3.org/2000/svg",Te="http://www.w3.org/1999/xhtml",Yt=Te,_i=!1,at,is=["application/xhtml+xml","text/html"],rs="text/html",Pe,st=null,as=i.createElement("form"),_r=function(c){return c instanceof RegExp||c instanceof Function},ki=function(c){st&&st===c||((!c||Ve(c)!=="object")&&(c={}),c=He(c),W="ALLOWED_TAGS"in c?M({},c.ALLOWED_TAGS):Ze,j="ALLOWED_ATTR"in c?M({},c.ALLOWED_ATTR):Je,$i="ADD_URI_SAFE_ATTR"in c?M(He(Cr),c.ADD_URI_SAFE_ATTR):Cr,$r="ADD_DATA_URI_TAGS"in c?M(He(xr),c.ADD_DATA_URI_TAGS):xr,rt="FORBID_CONTENTS"in c?M({},c.FORBID_CONTENTS):Sr,ke="FORBID_TAGS"in c?M({},c.FORBID_TAGS):{},fi="FORBID_ATTR"in c?M({},c.FORBID_ATTR):{},it="USE_PROFILES"in c?c.USE_PROFILES:!1,br=c.ALLOW_ARIA_ATTR!==!1,bi=c.ALLOW_DATA_ATTR!==!1,yr=c.ALLOW_UNKNOWN_PROTOCOLS||!1,et=c.SAFE_FOR_TEMPLATES||!1,Ne=c.WHOLE_DOCUMENT||!1,tt=c.RETURN_DOM||!1,Qt=c.RETURN_DOM_FRAGMENT||!1,Gt=c.RETURN_TRUSTED_TYPE||!1,wi=c.FORCE_BODY||!1,wr=c.SANITIZE_DOM!==!1,Si=c.KEEP_CONTENT!==!1,Dt=c.IN_PLACE||!1,ze=c.ALLOWED_URI_REGEXP||ze,Yt=c.NAMESPACE||Te,c.CUSTOM_ELEMENT_HANDLING&&_r(c.CUSTOM_ELEMENT_HANDLING.tagNameCheck)&&(U.tagNameCheck=c.CUSTOM_ELEMENT_HANDLING.tagNameCheck),c.CUSTOM_ELEMENT_HANDLING&&_r(c.CUSTOM_ELEMENT_HANDLING.attributeNameCheck)&&(U.attributeNameCheck=c.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),c.CUSTOM_ELEMENT_HANDLING&&typeof c.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements=="boolean"&&(U.allowCustomizedBuiltInElements=c.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements),at=is.indexOf(c.PARSER_MEDIA_TYPE)===-1?at=rs:at=c.PARSER_MEDIA_TYPE,Pe=at==="application/xhtml+xml"?function(g){return g}:ri,et&&(bi=!1),Qt&&(tt=!0),it&&(W=M({},he(oa)),j=[],it.html===!0&&(M(W,sa),M(j,na)),it.svg===!0&&(M(W,Bi),M(j,Wi),M(j,Jt)),it.svgFilters===!0&&(M(W,Ui),M(j,Wi),M(j,Jt)),it.mathMl===!0&&(M(W,Hi),M(j,la),M(j,Jt))),c.ADD_TAGS&&(W===Ze&&(W=He(W)),M(W,c.ADD_TAGS)),c.ADD_ATTR&&(j===Je&&(j=He(j)),M(j,c.ADD_ATTR)),c.ADD_URI_SAFE_ATTR&&M($i,c.ADD_URI_SAFE_ATTR),c.FORBID_CONTENTS&&(rt===Sr&&(rt=He(rt)),M(rt,c.FORBID_CONTENTS)),Si&&(W["#text"]=!0),Ne&&M(W,["html","head","body"]),W.table&&(M(W,["tbody"]),delete ke.tbody),ee&&ee(c),st=c)},kr=M({},["mi","mo","mn","ms","mtext"]),Tr=M({},["foreignobject","desc","title","annotation-xml"]),ss=M({},["title","style","font","a","script"]),Kt=M({},Bi);M(Kt,Ui),M(Kt,Uo);var Ti=M({},Hi);M(Ti,Ho);var os=function(c){var g=R(c);(!g||!g.tagName)&&(g={namespaceURI:Te,tagName:"template"});var S=ri(c.tagName),I=ri(g.tagName);return c.namespaceURI===Ci?g.namespaceURI===Te?S==="svg":g.namespaceURI===xi?S==="svg"&&(I==="annotation-xml"||kr[I]):Boolean(Kt[S]):c.namespaceURI===xi?g.namespaceURI===Te?S==="math":g.namespaceURI===Ci?S==="math"&&Tr[I]:Boolean(Ti[S]):c.namespaceURI===Te?g.namespaceURI===Ci&&!Tr[I]||g.namespaceURI===xi&&!kr[I]?!1:!Ti[S]&&(ss[S]||!Kt[S]):!1},we=function(c){Lt(e.removed,{element:c});try{c.parentNode.removeChild(c)}catch{try{c.outerHTML=Y}catch{c.remove()}}},Dr=function(c,g){try{Lt(e.removed,{attribute:g.getAttributeNode(c),from:g})}catch{Lt(e.removed,{attribute:null,from:g})}if(g.removeAttribute(c),c==="is"&&!j[c])if(tt||Qt)try{we(g)}catch{}else try{g.setAttribute(c,"")}catch{}},Mr=function(c){var g,S;if(wi)c="<remove></remove>"+c;else{var I=zo(c,/^[\r\n\t ]+/);S=I&&I[0]}at==="application/xhtml+xml"&&(c='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+c+"</body></html>");var ie=z?z.createHTML(c):c;if(Yt===Te)try{g=new f().parseFromString(ie,at)}catch{}if(!g||!g.documentElement){g=ge.createDocument(Yt,"template",null);try{g.documentElement.innerHTML=_i?"":ie}catch{}}var X=g.body||g.documentElement;return c&&S&&X.insertBefore(i.createTextNode(S),X.childNodes[0]||null),Yt===Te?xt.call(g,Ne?"html":"body")[0]:Ne?g.documentElement:X},Ar=function(c){return St.call(c.ownerDocument||c,c,d.SHOW_ELEMENT|d.SHOW_COMMENT|d.SHOW_TEXT,null,!1)},ns=function(c){return c instanceof v&&(typeof c.nodeName!="string"||typeof c.textContent!="string"||typeof c.removeChild!="function"||!(c.attributes instanceof p)||typeof c.removeAttribute!="function"||typeof c.setAttribute!="function"||typeof c.namespaceURI!="string"||typeof c.insertBefore!="function")},Mt=function(c){return Ve(o)==="object"?c instanceof o:c&&Ve(c)==="object"&&typeof c.nodeType=="number"&&typeof c.nodeName=="string"},Se=function(c,g,S){!te[c]||Io(te[c],function(I){I.call(e,g,S,st)})},Er=function(c){var g;if(Se("beforeSanitizeElements",c,null),ns(c)||J(/[\u0080-\uFFFF]/,c.nodeName))return we(c),!0;var S=Pe(c.nodeName);if(Se("uponSanitizeElement",c,{tagName:S,allowedTags:W}),c.hasChildNodes()&&!Mt(c.firstElementChild)&&(!Mt(c.content)||!Mt(c.content.firstElementChild))&&J(/<[/\w]/g,c.innerHTML)&&J(/<[/\w]/g,c.textContent)||S==="select"&&J(/<template/i,c.innerHTML))return we(c),!0;if(!W[S]||ke[S]){if(!ke[S]&&Lr(S)&&(U.tagNameCheck instanceof RegExp&&J(U.tagNameCheck,S)||U.tagNameCheck instanceof Function&&U.tagNameCheck(S)))return!1;if(Si&&!rt[S]){var I=R(c)||c.parentNode,ie=A(c)||c.childNodes;if(ie&&I)for(var X=ie.length,K=X-1;K>=0;--K)I.insertBefore(k(ie[K],!0),E(c))}return we(c),!0}return c instanceof l&&!os(c)||(S==="noscript"||S==="noembed")&&J(/<\/no(script|embed)/i,c.innerHTML)?(we(c),!0):(et&&c.nodeType===3&&(g=c.textContent,g=De(g,Re," "),g=De(g,Ie," "),c.textContent!==g&&(Lt(e.removed,{element:c.cloneNode()}),c.textContent=g)),Se("afterSanitizeElements",c,null),!1)},Or=function(c,g,S){if(wr&&(g==="id"||g==="name")&&(S in i||S in as))return!1;if(!(bi&&!fi[g]&&J(_t,g))){if(!(br&&J(kt,g))){if(!j[g]||fi[g]){if(!(Lr(c)&&(U.tagNameCheck instanceof RegExp&&J(U.tagNameCheck,c)||U.tagNameCheck instanceof Function&&U.tagNameCheck(c))&&(U.attributeNameCheck instanceof RegExp&&J(U.attributeNameCheck,g)||U.attributeNameCheck instanceof Function&&U.attributeNameCheck(g))||g==="is"&&U.allowCustomizedBuiltInElements&&(U.tagNameCheck instanceof RegExp&&J(U.tagNameCheck,S)||U.tagNameCheck instanceof Function&&U.tagNameCheck(S))))return!1}else if(!$i[g]){if(!J(ze,De(S,Xe,""))){if(!((g==="src"||g==="xlink:href"||g==="href")&&c!=="script"&&No(S,"data:")===0&&$r[c])){if(!(yr&&!J(Tt,De(S,Xe,"")))){if(S)return!1}}}}}}return!0},Lr=function(c){return c.indexOf("-")>0},Fr=function(c){var g,S,I,ie;Se("beforeSanitizeAttributes",c,null);var X=c.attributes;if(!!X){var K={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:j};for(ie=X.length;ie--;){g=X[ie];var qt=g,Z=qt.name,Rr=qt.namespaceURI;if(S=Z==="value"?g.value:Po(g.value),I=Pe(Z),K.attrName=I,K.attrValue=S,K.keepAttr=!0,K.forceKeepAttr=void 0,Se("uponSanitizeAttribute",c,K),S=K.attrValue,!K.forceKeepAttr&&(Dr(Z,c),!!K.keepAttr)){if(J(/\/>/i,S)){Dr(Z,c);continue}et&&(S=De(S,Re," "),S=De(S,Ie," "));var ds=Pe(c.nodeName);if(!!Or(ds,I,S))try{Rr?c.setAttributeNS(Rr,Z,S):c.setAttribute(Z,S),aa(e.removed)}catch{}}}Se("afterSanitizeAttributes",c,null)}},ls=function C(c){var g,S=Ar(c);for(Se("beforeSanitizeShadowDOM",c,null);g=S.nextNode();)Se("uponSanitizeShadowNode",g,null),!Er(g)&&(g.content instanceof r&&C(g.content),Fr(g));Se("afterSanitizeShadowDOM",c,null)};return e.sanitize=function(C,c){var g,S,I,ie,X;if(_i=!C,_i&&(C="<!-->"),typeof C!="string"&&!Mt(C)){if(typeof C.toString!="function")throw Pi("toString is not a function");if(C=C.toString(),typeof C!="string")throw Pi("dirty is not a string, aborting")}if(!e.isSupported){if(Ve(a.toStaticHTML)==="object"||typeof a.toStaticHTML=="function"){if(typeof C=="string")return a.toStaticHTML(C);if(Mt(C))return a.toStaticHTML(C.outerHTML)}return C}if(yi||ki(c),e.removed=[],typeof C=="string"&&(Dt=!1),Dt){if(C.nodeName){var K=Pe(C.nodeName);if(!W[K]||ke[K])throw Pi("root node is forbidden and cannot be sanitized in-place")}}else if(C instanceof o)g=Mr("<!---->"),S=g.ownerDocument.importNode(C,!0),S.nodeType===1&&S.nodeName==="BODY"||S.nodeName==="HTML"?g=S:g.appendChild(S);else{if(!tt&&!et&&!Ne&&C.indexOf("<")===-1)return z&&Gt?z.createHTML(C):C;if(g=Mr(C),!g)return tt?null:Gt?Y:""}g&&wi&&we(g.firstChild);for(var qt=Ar(Dt?C:g);I=qt.nextNode();)I.nodeType===3&&I===ie||Er(I)||(I.content instanceof r&&ls(I.content),Fr(I),ie=I);if(ie=null,Dt)return C;if(tt){if(Qt)for(X=$t.call(g.ownerDocument);g.firstChild;)X.appendChild(g.firstChild);else X=g;return j.shadowroot&&(X=Ct.call(t,X,!0)),X}var Z=Ne?g.outerHTML:g.innerHTML;return Ne&&W["!doctype"]&&g.ownerDocument&&g.ownerDocument.doctype&&g.ownerDocument.doctype.name&&J(qo,g.ownerDocument.doctype.name)&&(Z="<!DOCTYPE "+g.ownerDocument.doctype.name+`>
`+Z),et&&(Z=De(Z,Re," "),Z=De(Z,Ie," ")),z&&Gt?z.createHTML(Z):Z},e.setConfig=function(C){ki(C),yi=!0},e.clearConfig=function(){st=null,yi=!1},e.isValidAttribute=function(C,c,g){st||ki({});var S=Pe(C),I=Pe(c);return Or(S,I,g)},e.addHook=function(C,c){typeof c=="function"&&(te[C]=te[C]||[],Lt(te[C],c))},e.removeHook=function(C){if(te[C])return aa(te[C])},e.removeHooks=function(C){te[C]&&(te[C]=[])},e.removeAllHooks=function(){te={}},e}var zt=Wa();function Va(a){switch(a){case"date":return"Published";case"reviewdate":return"Reviewed";case"addeddate":return"Added";default:return"Archived"}}function ja(a){return a?`Archivist since ${a.getFullYear()}`:""}function ar(a,e="short",t="en-US"){if(!a)return"";const i={timeZone:"UTC"};switch(e){case"short":i.month="short",i.year="numeric";break;case"long":i.year="numeric",i.month="short",i.day="2-digit";break}return new Intl.DateTimeFormat(t,i).format(a)}let ve=class extends P{constructor(){super(...arguments),this.sortParam=null,this.collectionLinks=[]}updated(e){e.has("model")&&this.fetchCollectionNames()}async fetchCollectionNames(){var e,t;if(!(!((e=this.model)===null||e===void 0)&&e.collections)||this.model.collections.length===0||!this.collectionNameCache)return;this.collectionLinks=[];const i=[],r=[];for(const s of this.model.collections)r.push((t=this.collectionNameCache)===null||t===void 0?void 0:t.collectionNameFor(s).then(o=>{i.push(this.detailsLink(s,o!=null?o:s))}));await Promise.all(r),this.collectionLinks=i}render(){return m`
    ...
    `:_}get volumeTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.volume,"Volume")}get issueTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.issue,"Issue")}get creatorTemplate(){var e,t,i;return((e=this.model)===null||e===void 0?void 0:e.mediatype)==="account"?m`
      ...
      <div id="creator" class="metadata">
        ...
        ${Ni(ia(this.model.creators,r=>this.searchLink("creator",r)),m`, `)}
      </div>
    `}get datePublishedTemplate(){var e;return this.metadataTemplate(ar((e=this.model)===null||e===void 0?void 0:e.datePublished,"long"),"Published")}get dateSortByTemplate(){return this.sortParam&&(this.sortParam.field==="addeddate"||this.sortParam.field==="reviewdate"||this.sortParam.field==="publicdate")?this.metadataTemplate(ar(this.date,"long"),Va(this.sortParam.field)):_}get viewsTemplate(){var e,t;return this.metadataTemplate(`${It((t=(e=this.model)===null||e===void 0?void 0:e.viewCount)!==null&&t!==void 0?t:0,this.formatSize)}`,"Views")}get ratingTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.averageRating,"Avg Rating")}get reviewsTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.commentCount,"Reviews")}get topicsTemplate(){var e;return!(!((e=this.model)===null||e===void 0)&&e.subjects)||this.model.subjects.length===0?_:m`
      <div id="topics" class="metadata">
        ${this.labelTemplate("Topics")}
        ${Ni(ia(this.model.subjects,t=>this.searchLink("subject",t)),m`, `)}
      </div>
    `}get collectionsTemplate(){return!this.collectionLinks||this.collectionLinks.length===0?_:m`
      <div id="collections" class="metadata">
        ${this.labelTemplate("Collections")}
        ${Ni(this.collectionLinks,m`, `)}
      </div>
    ...
    `}};n([u({type:Object})],ve.prototype,"model",void 0);n([u({type:String})],ve.prototype,"baseNavigationUrl",void 0);n([u({type:Object})],ve.prototype,"collectionNameCache",void 0);n([u({type:Number})],ve.prototype,"currentWidth",void 0);n([u({type:Number})],ve.prototype,"currentHeight",void 0);n([u({type:Object})],ve.prototype,"sortParam",void 0);n([u({type:Number})],ve.prototype,"mobileBreakpoint",void 0);n([D()],ve.prototype,"collectionLinks",void 0);n([u({type:String})],ve.prototype,"baseImageUrl",void 0);ve=n([V("tile-list")],ve);let _e=class extends P{constructor(){super(...arguments),this.sortParam=null}render(){var e,t,i,r,s,o,l,d,h,p,v;return m`
      <div id="list-line" class="${this.classSize}">
        ...
        <div id="creator">
          ${((r=this.model)===null||r===void 0?void 0:r.mediatype)==="account"?ja((s=this.model)===null||s===void 0?void 0:s.dateAdded):zt.sanitize((l=(o=this.model)===null||o===void 0?void 0:o.creator)!==null&&l!==void 0?l:"")}
        </div>
        <div id="date">${ar(this.date,this.formatSize)}</div>
        <div id="icon">
          <mediatype-icon
        ...
        <div id="views">
          ${It((v=(p=this.model)===null||p===void 0?void 0:p.viewCount)!==null&&v!==void 0?v:0,this.formatSize)}
        </div>
      </div>
    ...
    `}};n([u({type:Object})],gt.prototype,"model",void 0);n([u({type:Number})],gt.prototype,"currentWidth",void 0);n([u({type:Object})],gt.prototype,"sortParam",void 0);n([u({type:Number})],gt.prototype,"mobileBreakpoint",void 0);gt=n([V("tile-list-compact-header")],gt);let oe=class extends P{constructor(){super(...arguments),this.sortParam=null}render(){return m`
      <div id="container">
    ...
    `}};da=n([V("collection-browser-loading-tile")],da);var O;(function(a){a.relevance="relevance",a.views="views",a.title="title",a.datearchived="datearchived",a.date="date",a.datereviewed="datereviewed",a.dateadded="dateadded",a.creator="creator"})(O||(O={}));const Ft={relevance:"Relevance",views:"Views",title:"Title",datearchived:"Date Archived",date:"Date Published",datereviewed:"Date Reviewed",dateadded:"Date Added",creator:"Creator"},Jo={relevance:null,views:"week",title:"titleSorter",datearchived:"publicdate",date:"date",datereviewed:"reviewdate",dateadded:"addeddate",creator:"creatorSorter"},ca={titleSorter:O.title,date:O.date,publicdate:O.datearchived,reviewdate:O.datereviewed,addeddate:O.dateadded,creatorSorter:O.creator,week:O.views},ci={subject:{},mediatype:{},language:{},creator:{},collection:{},year:{}};let hi=class extends P{constructor(){super(...arguments),this.selectedLetter=null,this.alphabet="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("")}get selectedUppercaseLetter(){var e;return(e=this.selectedLetter)===null||e===void 0?void 0:e.toUpperCase()}render(){return m`
      <div id="container">
        <ul>
    ...
    `}letterClicked(e){e===this.selectedUppercaseLetter?this.selectedLetter=null:this.selectedLetter=e,this.dispatchEvent(new CustomEvent("letterChanged",{detail:{selectedLetter:this.selectedUppercaseLetter}}))}};hi.styles=b`
    h1 {
      font-size: 1.2rem;
    }
  ...
  `;n([u({type:String})],hi.prototype,"selectedLetter",void 0);hi=n([V("alpha-bar")],hi);const ha=L`
...
`;let q=class extends P{constructor(){super(...arguments),this.sortDirection=null,this.selectedSort=O.relevance,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.showRelevance=!0,this.alphaSelectorVisible=null,this.dateSortSelectorVisible=!1,this.desktopSelectorBarWidth=0,this.selectorBarContainerWidth=0,this.hoveringOverDateSortOptions=!1,this.boundDateSelectorEscapeListener=e=>{e.key==="Escape"&&(this.dateSortSelectorVisible=!1)}}render(){return m`
    ...
    `}getSortDisplayOption(e,t){var i,r;const s=(i=t==null?void 0:t.isSelected)!==null&&i!==void 0?i:()=>this.selectedSort===e,o=(r=t==null?void 0:t.displayName)!==null&&r!==void 0?r:Ft[e];return m`
      <a
        href="#"
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ua=hr(class extends ur{constructor(a){if(super(a),a.type!==Me.PROPERTY&&a.type!==Me.ATTRIBUTE&&a.type!==Me.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Gs(a))throw Error("`live` bindings can only contain a single expression")}render(a){return a}update(a,[e]){if(e===ce||e===_)return e;const t=a.element,i=a.name;if(a.type===Me.PROPERTY){if(e===t[i])return ce}else if(a.type===Me.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(i))return ce}else if(a.type===Me.ATTRIBUTE&&t.getAttribute(i)===e+"")return ce;return Pa(a),e}});var Qa=60,Ga=Qa*60,Ya=Ga*24,an=Ya*7,ft=1e3,Vi=Qa*ft,pa=Ga*ft,sn=Ya*ft,on=an*ft,pr="millisecond",lt="second",dt="minute",ct="hour",Ae="day",ai="week",ue="month",Ka="quarter",Ee="year",ht="date",nn="YYYY-MM-DDTHH:mm:ssZ",va="Invalid Date",ln=/^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/,dn=/\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g,cn={name:"en",weekdays:"Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),months:"January_February_March_April_May_June_July_August_September_October_November_December".split("_")},sr=function(e,t,i){var r=String(e);return!r||r.length>=t?e:""+Array(t+1-r.length).join(i)+e},hn=function(e){var t=-e.utcOffset(),i=Math.abs(t),r=Math.floor(i/60),s=i%60;return(t<=0?"+":"-")+sr(r,2,"0")+":"+sr(s,2,"0")},un=function a(e,t){if(e.date()<t.date())return-a(t,e);var i=(t.year()-e.year())*12+(t.month()-e.month()),r=e.clone().add(i,ue),s=t-r<0,o=e.clone().add(i+(s?-1:1),ue);return+(-(i+(t-r)/(s?r-o:o-r))||0)},pn=function(e){return e<0?Math.ceil(e)||0:Math.floor(e)},vn=function(e){var t={M:ue,y:Ee,w:ai,d:Ae,D:ht,h:ct,m:dt,s:lt,ms:pr,Q:Ka};return t[e]||String(e||"").toLowerCase().replace(/s$/,"")},mn=function(e){return e===void 0},gn={s:sr,z:hn,m:un,a:pn,p:vn,u:mn},Nt="en",Ge={};Ge[Nt]=cn;var vr=function(e){return e instanceof gi},ui=function a(e,t,i){var r;if(!e)return Nt;if(typeof e=="string"){var s=e.toLowerCase();Ge[s]&&(r=s),t&&(Ge[s]=t,r=s);var o=e.split("-");if(!r&&o.length>1)return a(o[0])}else{var l=e.name;Ge[l]=e,r=l}return!i&&r&&(Nt=r),r||!i&&Nt},G=function(e,t){if(vr(e))return e.clone();var i=typeof t=="object"?t:{};return i.date=e,i.args=arguments,new gi(i)},fn=function(e,t){return G(e,{locale:t.$L,utc:t.$u,x:t.$x,$offset:t.$offset})},N=gn;N.l=ui;N.i=vr;N.w=fn;var bn=function(e){var t=e.date,i=e.utc;if(t===null)return new Date(NaN);if(N.u(t))return new Date;if(t instanceof Date)return new Date(t);if(typeof t=="string"&&!/Z$/i.test(t)){var r=t.match(ln);if(r){var s=r[2]-1||0,o=(r[7]||"0").substring(0,3);return i?new Date(Date.UTC(r[1],s,r[3]||1,r[4]||0,r[5]||0,r[6]||0,o)):new Date(r[1],s,r[3]||1,r[4]||0,r[5]||0,r[6]||0,o)}}return new Date(t)},gi=function(){function a(t){this.$L=ui(t.locale,null,!0),this.parse(t)}var e=a.prototype;return e.parse=function(i){this.$d=bn(i),this.$x=i.x||{},this.init()},e.init=function(){var i=this.$d;this.$y=i.getFullYear(),this.$M=i.getMonth(),this.$D=i.getDate(),this.$W=i.getDay(),this.$H=i.getHours(),this.$m=i.getMinutes(),this.$s=i.getSeconds(),this.$ms=i.getMilliseconds()},e.$utils=function(){return N},e.isValid=function(){return this.$d.toString()!==va},e.isSame=function(i,r){var s=G(i);return this.startOf(r)<=s&&s<=this.endOf(r)},e.isAfter=function(i,r){return G(i)<this.startOf(r)},e.isBefore=function(i,r){return this.endOf(r)<G(i)},e.$g=function(i,r,s){return N.u(i)?this[r]:this.set(s,i)},e.unix=function(){return Math.floor(this.valueOf()/1e3)},e.valueOf=function(){return this.$d.getTime()},e.startOf=function(i,r){var s=this,o=N.u(r)?!0:r,l=N.p(i),d=function(A,R){var F=N.w(s.$u?Date.UTC(s.$y,R,A):new Date(s.$y,R,A),s);return o?F:F.endOf(Ae)},h=function(A,R){var F=[0,0,0,0],z=[23,59,59,999];return N.w(s.toDate()[A].apply(s.toDate("s"),(o?F:z).slice(R)),s)},p=this.$W,v=this.$M,f=this.$D,y="set"+(this.$u?"UTC":"");switch(l){case Ee:return o?d(1,0):d(31,11);case ue:return o?d(1,v):d(0,v+1);case ai:{var $=this.$locale().weekStart||0,k=(p<$?p+7:p)-$;return d(o?f-k:f+(6-k),v)}case Ae:case ht:return h(y+"Hours",0);case ct:return h(y+"Minutes",1);case dt:return h(y+"Seconds",2);case lt:return h(y+"Milliseconds",3);default:return this.clone()}},e.endOf=function(i){return this.startOf(i,!1)},e.$set=function(i,r){var s,o=N.p(i),l="set"+(this.$u?"UTC":""),d=(s={},s[Ae]=l+"Date",s[ht]=l+"Date",s[ue]=l+"Month",s[Ee]=l+"FullYear",s[ct]=l+"Hours",s[dt]=l+"Minutes",s[lt]=l+"Seconds",s[pr]=l+"Milliseconds",s)[o],h=o===Ae?this.$D+(r-this.$W):r;if(o===ue||o===Ee){var p=this.clone().set(ht,1);p.$d[d](h),p.init(),this.$d=p.set(ht,Math.min(this.$D,p.daysInMonth())).$d}else d&&this.$d[d](h);return this.init(),this},e.set=function(i,r){return this.clone().$set(i,r)},e.get=function(i){return this[N.p(i)]()},e.add=function(i,r){var s=this,o;i=Number(i);var l=N.p(r),d=function(f){var y=G(s);return N.w(y.date(y.date()+Math.round(f*i)),s)};if(l===ue)return this.set(ue,this.$M+i);if(l===Ee)return this.set(Ee,this.$y+i);if(l===Ae)return d(1);if(l===ai)return d(7);var h=(o={},o[dt]=Vi,o[ct]=pa,o[lt]=ft,o)[l]||1,p=this.$d.getTime()+i*h;return N.w(p,this)},e.subtract=function(i,r){return this.add(i*-1,r)},e.format=function(i){var r=this,s=this.$locale();if(!this.isValid())return s.invalidDate||va;var o=i||nn,l=N.z(this),d=this.$H,h=this.$m,p=this.$M,v=s.weekdays,f=s.months,y=s.meridiem,$=function(F,z,Y,se){return F&&(F[z]||F(r,o))||Y[z].slice(0,se)},k=function(F){return N.s(d%12||12,F,"0")},E=y||function(R,F,z){var Y=R<12?"AM":"PM";return z?Y.toLowerCase():Y},A={YY:String(this.$y).slice(-2),YYYY:this.$y,M:p+1,MM:N.s(p+1,2,"0"),MMM:$(s.monthsShort,p,f,3),MMMM:$(f,p),D:this.$D,DD:N.s(this.$D,2,"0"),d:String(this.$W),dd:$(s.weekdaysMin,this.$W,v,2),ddd:$(s.weekdaysShort,this.$W,v,3),dddd:v[this.$W],H:String(d),HH:N.s(d,2,"0"),h:k(1),hh:k(2),a:E(d,h,!0),A:E(d,h,!1),m:String(h),mm:N.s(h,2,"0"),s:String(this.$s),ss:N.s(this.$s,2,"0"),SSS:N.s(this.$ms,3,"0"),Z:l};return o.replace(dn,function(R,F){return F||A[R]||l.replace(":","")})},e.utcOffset=function(){return-Math.round(this.$d.getTimezoneOffset()/15)*15},e.diff=function(i,r,s){var o,l=N.p(r),d=G(i),h=(d.utcOffset()-this.utcOffset())*Vi,p=this-d,v=N.m(this,d);return v=(o={},o[Ee]=v/12,o[ue]=v,o[Ka]=v/3,o[ai]=(p-h)/on,o[Ae]=(p-h)/sn,o[ct]=p/pa,o[dt]=p/Vi,o[lt]=p/ft,o)[l]||p,s?v:N.a(v)},e.daysInMonth=function(){return this.endOf(ue).$D},e.$locale=function(){return Ge[this.$L]},e.locale=function(i,r){if(!i)return this.$L;var s=this.clone(),o=ui(i,r,!0);return o&&(s.$L=o),s},e.clone=function(){return N.w(this.$d,this)},e.toDate=function(){return new Date(this.valueOf())},e.toJSON=function(){return this.isValid()?this.toISOString():null},e.toISOString=function(){return this.$d.toISOString()},e.toString=function(){return this.$d.toUTCString()},a}(),qa=gi.prototype;G.prototype=qa;[["$ms",pr],["$s",lt],["$m",dt],["$H",ct],["$W",Ae],["$M",ue],["$y",Ee],["$D",ht]].forEach(function(a){qa[a[1]]=function(e){return this.$g(e,a[0],a[1])}});G.extend=function(a,e){return a.$i||(a(e,gi,G),a.$i=!0),G};G.locale=ui;G.isDayjs=vr;G.unix=function(a){return G(a*1e3)};G.en=Ge[Nt];G.Ls=Ge;G.p={};var yn=function(e){return e.replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g,function(t,i,r){return i||r.slice(1)})},wn={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"},Sn=function(e,t){return e.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g,function(i,r,s){var o=s&&s.toUpperCase();return r||t[s]||wn[s]||yn(t[o])})},$n=/(\[[^[]*\])|([-:/.()\s]+)|(A|a|YYYY|YY?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g,xn=/\d/,ei=/\d\d/,Cn=/\d{3}/,_n=/\d{4}/,be=/\d\d?/,kn=/[+-]?\d+/,Tn=/[+-]\d\d:?(\d\d)?|Z/,Rt=/\d*[^\s\d-_:/()]+/,Le={},Xa=function(e){return e=+e,e+(e>68?1900:2e3)};function Dn(a){if(!a||a==="Z")return 0;var e=a.match(/([+-]|\d\d)/g),t=+(e[1]*60)+(+e[2]||0);return t===0?0:e[0]==="+"?-t:t}var re=function(e){return function(t){this[e]=+t}},ma=[Tn,function(a){var e=this.zone||(this.zone={});e.offset=Dn(a)}],ji=function(e){var t=Le[e];return t&&(t.indexOf?t:t.s.concat(t.f))},ga=function(e,t){var i,r=Le,s=r.meridiem;if(!s)i=e===(t?"pm":"PM");else for(var o=1;o<=24;o+=1)if(e.indexOf(s(o,0,t))>-1){i=o>12;break}return i},Mn={A:[Rt,function(a){this.afternoon=ga(a,!1)}],a:[Rt,function(a){this.afternoon=ga(a,!0)}],S:[xn,function(a){this.milliseconds=+a*100}],SS:[ei,function(a){this.milliseconds=+a*10}],SSS:[Cn,function(a){this.milliseconds=+a}],s:[be,re("seconds")],ss:[be,re("seconds")],m:[be,re("minutes")],mm:[be,re("minutes")],H:[be,re("hours")],h:[be,re("hours")],HH:[be,re("hours")],hh:[be,re("hours")],D:[be,re("day")],DD:[ei,re("day")],Do:[Rt,function(a){var e=Le,t=e.ordinal,i=a.match(/\d+/);if(this.day=i[0],!!t)for(var r=1;r<=31;r+=1)t(r).replace(/\[|\]/g,"")===a&&(this.day=r)}],M:[be,re("month")],MM:[ei,re("month")],MMM:[Rt,function(a){var e=ji("months"),t=ji("monthsShort"),i=(t||e.map(function(r){return r.slice(0,3)})).indexOf(a)+1;if(i<1)throw new Error;this.month=i%12||i}],MMMM:[Rt,function(a){var e=ji("months"),t=e.indexOf(a)+1;if(t<1)throw new Error;this.month=t%12||t}],Y:[kn,re("year")],YY:[ei,function(a){this.year=Xa(a)}],YYYY:[_n,re("year")],Z:ma,ZZ:ma};function An(a){var e=a.afternoon;if(e!==void 0){var t=a.hours;e?t<12&&(a.hours+=12):t===12&&(a.hours=0),delete a.afternoon}}function En(a){a=Sn(a,Le&&Le.formats);for(var e=a.match($n),t=e.length,i=0;i<t;i+=1){var r=e[i],s=Mn[r],o=s&&s[0],l=s&&s[1];l?e[i]={regex:o,parser:l}:e[i]=r.replace(/^\[|\]$/g,"")}return function(d){for(var h={},p=0,v=0;p<t;p+=1){var f=e[p];if(typeof f=="string")v+=f.length;else{var y=f.regex,$=f.parser,k=d.slice(v),E=y.exec(k),A=E[0];$.call(h,A),d=d.replace(A,"")}}return An(h),h}}var On=function(e,t,i){try{if(["x","X"].indexOf(t)>-1)return new Date((t==="X"?1e3:1)*e);var r=En(t),s=r(e),o=s.year,l=s.month,d=s.day,h=s.hours,p=s.minutes,v=s.seconds,f=s.milliseconds,y=s.zone,$=new Date,k=d||(!o&&!l?$.getDate():1),E=o||$.getFullYear(),A=0;o&&!l||(A=l>0?l-1:$.getMonth());var R=h||0,F=p||0,z=v||0,Y=f||0;return y?new Date(Date.UTC(E,A,k,R,F,z,Y+y.offset*60*1e3)):i?new Date(Date.UTC(E,A,k,R,F,z,Y)):new Date(E,A,k,R,F,z,Y)}catch{return new Date("")}},Ln=function(a,e,t){t.p.customParseFormat=!0,a&&a.parseTwoDigitYear&&(Xa=a.parseTwoDigitYear);var i=e.prototype,r=i.parse;i.parse=function(s){var o=s.date,l=s.utc,d=s.args;this.$u=l;var h=d[1];if(typeof h=="string"){var p=d[2]===!0,v=d[3]===!0,f=p||v,y=d[2];v&&(y=d[2]),Le=this.$locale(),!p&&y&&(Le=t.Ls[y]),this.$d=On(o,h,l),this.init(),y&&y!==!0&&(this.$L=this.locale(y).$L),f&&o!=this.format(h)&&(this.$d=new Date("")),Le={}}else if(h instanceof Array)for(var $=h.length,k=1;k<=$;k+=1){d[1]=h[k-1];var E=t.apply(this,d);if(E.isValid()){this.$d=E.$d,this.$L=E.$L,this.init();break}k===$&&(this.$d=new Date(""))}else r.call(this,s)}};const Fn=Object.freeze({processing:"processing",complete:"complete"});class Rn extends P{static get properties(){return{mode:{type:String}}}constructor(){super(),this.mode=Fn.processing}render(){return m`
      <div class="${this.mode}">
        <svg
          viewBox="0 0 120 120"
    ...
    `}get selectedRangeTemplate(){return L`
      <rect
        ...
        height="${this.height}"
        fill="${Vn}"
      />`}get histogramTemplate(){const e=this._histWidth/this._numBins,t=e-1;let i=this.sliderWidth;return this._histData.map(r=>{const s=L`
        <rect
          class="bar"
...
`;let Q=class extends P{constructor(){super(...arguments),this.prompt="Do you find this feature useful?",this.buttonText="Beta",this.isOpen=!1,this.processing=!1,this.popupTopX=0,this.popupTopY=0,this.voteSubmitted=!1,this.voteNeedsChoosing=!1,this.resizingElement=document.body}render(){return m`
      <button
        id="beta-button"
    ...
    `}};n([u({type:String})],Q.prototype,"featureIdentifier",void 0);n([u({type:String})],Q.prototype,"prompt",void 0);n([u({type:String})],Q.prototype,"buttonText",void 0);n([u({type:Object})],Q.prototype,"recaptchaManager",void 0);n([u({type:Object})],Q.prototype,"resizeObserver",void 0);n([u({type:Boolean})],Q.prototype,"disabled",void 0);n([u({type:Object})],Q.prototype,"featureFeedbackService",void 0);n([le("#beta-button")],Q.prototype,"betaButton",void 0);n([le("#popup")],Q.prototype,"popup",void 0);n([D()],Q.prototype,"isOpen",void 0);n([D()],Q.prototype,"processing",void 0);n([D()],Q.prototype,"popupTopX",void 0);n([D()],Q.prototype,"popupTopY",void 0);n([D()],Q.prototype,"vote",void 0);n([D()],Q.prototype,"voteSubmitted",void 0);n([D()],Q.prototype,"error",void 0);n([D()],Q.prototype,"voteNeedsChoosing",void 0);n([D()],Q.prototype,"recaptchaWidget",void 0);n([le("#comments")],Q.prototype,"comments",void 0);Q=n([V("feature-feedback")],Q);var el=L`
...
`;const il=["mediatype","year","subject","collection","creator","language"],rl={subjectSorter:"subject",mediatypeSorter:"mediatype",languageSorter:"language",creatorSorter:"creator",collection:"collection",year:"year"},xa={subject:"Subject",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"};let ae=class extends P{constructor(){super(...arguments),this.facetsLoading=!1,this.fullYearAggregationLoading=!1,this.collapsableFacets=!1,this.showHistogramDatePicker=!1,this.openFacets={subject:!1,mediatype:!1,language:!1,creator:!1,collection:!1,year:!1}}render(){return m`
    ...
    `}getFacetTemplate(e){const i=e.buckets.filter(r=>r.key.startsWith("fav-")===!1).slice(0,6);return m`
      <ul class="facet-list">
        ${Ba(i,r=>`${e.key}:${r.key}`,r=>{var s,o;const l=`${e.key}:${r.key}-show-only`,d=`${e.key}:${r.key}-negative`,h=e.key!=="collection"?m`${(s=r.displayText)!==null&&s!==void 0?s:r.key}`:m`
    ...
    `}facetClicked(e,t,i){const r=e.target,{checked:s,name:o,value:l}=r;s?this.facetChecked(o,l,i):this.facetUnchecked(o,l)}facetChecked(e,t,i){const{selectedFacets:r}=this;let s;r?s=fe({},r):s=ci,s[e][t]=i?"hidden":"selected",this.selectedFacets=s}facetUnchecked(e,t){const{selectedFacets:i}=this;let r;i?r=fe({},i):r=ci,delete r[e][t],this.selectedFacets=r}getFacetOptionFromKey(e){const r=e.split("__")[2].split(":")[1],s=Object.entries(rl).find(([l])=>r.includes(l)),o=s==null?void 0:s[1];if(!o)throw new Error(`Could not find facet option for key: ${e}`);return o}static get styles(){return b`
      #container.loading {
        opacity: 0.5;
      }
