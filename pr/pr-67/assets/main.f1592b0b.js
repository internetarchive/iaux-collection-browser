...
`;let di=class extends F{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1}render(){return this.loginRequired&&!this.loggedIn?m`${ss} `:m`${os}`}static get styles(){return b`
      :host {
        position: absolute;
        top: 50%;
        left: 50%;
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const va=vr(class extends mr{constructor(a){if(super(a),a.type!==Me.PROPERTY&&a.type!==Me.ATTRIBUTE&&a.type!==Me.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!qo(a))throw Error("`live` bindings can only contain a single expression")}render(a){return a}update(a,[e]){if(e===ce||e===_)return e;const t=a.element,i=a.name;if(a.type===Me.PROPERTY){if(e===t[i])return ce}else if(a.type===Me.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(i))return ce}else if(a.type===Me.ATTRIBUTE&&t.getAttribute(i)===e+"")return ce;return Ua(a),e}});var Ya=60,Ka=Ya*60,qa=Ka*24,sn=qa*7,ft=1e3,Gi=Ya*ft,ma=Ka*ft,nn=qa*ft,ln=sn*ft,gr="millisecond",lt="second",dt="minute",ct="hour",Ae="day",ai="week",pe="month",Xa="quarter",Ee="year",ht="date",dn="YYYY-MM-DDTHH:mm:ssZ",ga="Invalid Date",cn=/^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/,hn=/\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g,un={name:"en",weekdays:"Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),months:"January_February_March_April_May_June_July_August_September_October_November_December".split("_")},lr=function(e,t,i){var r=String(e);return!r||r.length>=t?e:""+Array(t+1-r.length).join(i)+e},pn=function(e){var t=-e.utcOffset(),i=Math.abs(t),r=Math.floor(i/60),o=i%60;return(t<=0?"+":"-")+lr(r,2,"0")+":"+lr(o,2,"0")},vn=function a(e,t){if(e.date()<t.date())return-a(t,e);var i=(t.year()-e.year())*12+(t.month()-e.month()),r=e.clone().add(i,pe),o=t-r<0,s=e.clone().add(i+(o?-1:1),pe);return+(-(i+(t-r)/(o?r-s:s-r))||0)},mn=function(e){return e<0?Math.ceil(e)||0:Math.floor(e)},gn=function(e){var t={M:pe,y:Ee,w:ai,d:Ae,D:ht,h:ct,m:dt,s:lt,ms:gr,Q:Xa};return t[e]||String(e||"").toLowerCase().replace(/s$/,"")},fn=function(e){return e===void 0},bn={s:lr,z:pn,m:vn,a:mn,p:gn,u:fn},Nt="en",Ge={};Ge[Nt]=un;var fr=function(e){return e instanceof yi},vi=function a(e,t,i){var r;if(!e)return Nt;if(typeof e=="string"){var o=e.toLowerCase();Ge[o]&&(r=o),t&&(Ge[o]=t,r=o);var s=e.split("-");if(!r&&s.length>1)return a(s[0])}else{var l=e.name;Ge[l]=e,r=l}return!i&&r&&(Nt=r),r||!i&&Nt},G=function(e,t){if(fr(e))return e.clone();var i=typeof t=="object"?t:{};return i.date=e,i.args=arguments,new yi(i)},yn=function(e,t){return G(e,{locale:t.$L,utc:t.$u,x:t.$x,$offset:t.$offset})},P=bn;P.l=vi;P.i=fr;P.w=yn;var wn=function(e){var t=e.date,i=e.utc;if(t===null)return new Date(NaN);if(P.u(t))return new Date;if(t instanceof Date)return new Date(t);if(typeof t=="string"&&!/Z$/i.test(t)){var r=t.match(cn);if(r){var o=r[2]-1||0,s=(r[7]||"0").substring(0,3);return i?new Date(Date.UTC(r[1],o,r[3]||1,r[4]||0,r[5]||0,r[6]||0,s)):new Date(r[1],o,r[3]||1,r[4]||0,r[5]||0,r[6]||0,s)}}return new Date(t)},yi=function(){function a(t){this.$L=vi(t.locale,null,!0),this.parse(t)}var e=a.prototype;return e.parse=function(i){this.$d=wn(i),this.$x=i.x||{},this.init()},e.init=function(){var i=this.$d;this.$y=i.getFullYear(),this.$M=i.getMonth(),this.$D=i.getDate(),this.$W=i.getDay(),this.$H=i.getHours(),this.$m=i.getMinutes(),this.$s=i.getSeconds(),this.$ms=i.getMilliseconds()},e.$utils=function(){return P},e.isValid=function(){return this.$d.toString()!==ga},e.isSame=function(i,r){var o=G(i);return this.startOf(r)<=o&&o<=this.endOf(r)},e.isAfter=function(i,r){return G(i)<this.startOf(r)},e.isBefore=function(i,r){return this.endOf(r)<G(i)},e.$g=function(i,r,o){return P.u(i)?this[r]:this.set(o,i)},e.unix=function(){return Math.floor(this.valueOf()/1e3)},e.valueOf=function(){return this.$d.getTime()},e.startOf=function(i,r){var o=this,s=P.u(r)?!0:r,l=P.p(i),d=function(A,R){var I=P.w(o.$u?Date.UTC(o.$y,R,A):new Date(o.$y,R,A),o);return s?I:I.endOf(Ae)},h=function(A,R){var I=[0,0,0,0],N=[23,59,59,999];return P.w(o.toDate()[A].apply(o.toDate("s"),(s?I:N).slice(R)),o)},p=this.$W,v=this.$M,f=this.$D,y="set"+(this.$u?"UTC":"");switch(l){case Ee:return s?d(1,0):d(31,11);case pe:return s?d(1,v):d(0,v+1);case ai:{var $=this.$locale().weekStart||0,k=(p<$?p+7:p)-$;return d(s?f-k:f+(6-k),v)}case Ae:case ht:return h(y+"Hours",0);case ct:return h(y+"Minutes",1);case dt:return h(y+"Seconds",2);case lt:return h(y+"Milliseconds",3);default:return this.clone()}},e.endOf=function(i){return this.startOf(i,!1)},e.$set=function(i,r){var o,s=P.p(i),l="set"+(this.$u?"UTC":""),d=(o={},o[Ae]=l+"Date",o[ht]=l+"Date",o[pe]=l+"Month",o[Ee]=l+"FullYear",o[ct]=l+"Hours",o[dt]=l+"Minutes",o[lt]=l+"Seconds",o[gr]=l+"Milliseconds",o)[s],h=s===Ae?this.$D+(r-this.$W):r;if(s===pe||s===Ee){var p=this.clone().set(ht,1);p.$d[d](h),p.init(),this.$d=p.set(ht,Math.min(this.$D,p.daysInMonth())).$d}else d&&this.$d[d](h);return this.init(),this},e.set=function(i,r){return this.clone().$set(i,r)},e.get=function(i){return this[P.p(i)]()},e.add=function(i,r){var o=this,s;i=Number(i);var l=P.p(r),d=function(f){var y=G(o);return P.w(y.date(y.date()+Math.round(f*i)),o)};if(l===pe)return this.set(pe,this.$M+i);if(l===Ee)return this.set(Ee,this.$y+i);if(l===Ae)return d(1);if(l===ai)return d(7);var h=(s={},s[dt]=Gi,s[ct]=ma,s[lt]=ft,s)[l]||1,p=this.$d.getTime()+i*h;return P.w(p,this)},e.subtract=function(i,r){return this.add(i*-1,r)},e.format=function(i){var r=this,o=this.$locale();if(!this.isValid())return o.invalidDate||ga;var s=i||dn,l=P.z(this),d=this.$H,h=this.$m,p=this.$M,v=o.weekdays,f=o.months,y=o.meridiem,$=function(I,N,Y,se){return I&&(I[N]||I(r,s))||Y[N].slice(0,se)},k=function(I){return P.s(d%12||12,I,"0")},E=y||function(R,I,N){var Y=R<12?"AM":"PM";return N?Y.toLowerCase():Y},A={YY:String(this.$y).slice(-2),YYYY:this.$y,M:p+1,MM:P.s(p+1,2,"0"),MMM:$(o.monthsShort,p,f,3),MMMM:$(f,p),D:this.$D,DD:P.s(this.$D,2,"0"),d:String(this.$W),dd:$(o.weekdaysMin,this.$W,v,2),ddd:$(o.weekdaysShort,this.$W,v,3),dddd:v[this.$W],H:String(d),HH:P.s(d,2,"0"),h:k(1),hh:k(2),a:E(d,h,!0),A:E(d,h,!1),m:String(h),mm:P.s(h,2,"0"),s:String(this.$s),ss:P.s(this.$s,2,"0"),SSS:P.s(this.$ms,3,"0"),Z:l};return s.replace(hn,function(R,I){return I||A[R]||l.replace(":","")})},e.utcOffset=function(){return-Math.round(this.$d.getTimezoneOffset()/15)*15},e.diff=function(i,r,o){var s,l=P.p(r),d=G(i),h=(d.utcOffset()-this.utcOffset())*Gi,p=this-d,v=P.m(this,d);return v=(s={},s[Ee]=v/12,s[pe]=v,s[Xa]=v/3,s[ai]=(p-h)/ln,s[Ae]=(p-h)/nn,s[ct]=p/ma,s[dt]=p/Gi,s[lt]=p/ft,s)[l]||p,o?v:P.a(v)},e.daysInMonth=function(){return this.endOf(pe).$D},e.$locale=function(){return Ge[this.$L]},e.locale=function(i,r){if(!i)return this.$L;var o=this.clone(),s=vi(i,r,!0);return s&&(o.$L=s),o},e.clone=function(){return P.w(this.$d,this)},e.toDate=function(){return new Date(this.valueOf())},e.toJSON=function(){return this.isValid()?this.toISOString():null},e.toISOString=function(){return this.$d.toISOString()},e.toString=function(){return this.$d.toUTCString()},a}(),Za=yi.prototype;G.prototype=Za;[["$ms",gr],["$s",lt],["$m",dt],["$H",ct],["$W",Ae],["$M",pe],["$y",Ee],["$D",ht]].forEach(function(a){Za[a[1]]=function(e){return this.$g(e,a[0],a[1])}});G.extend=function(a,e){return a.$i||(a(e,yi,G),a.$i=!0),G};G.locale=vi;G.isDayjs=fr;G.unix=function(a){return G(a*1e3)};G.en=Ge[Nt];G.Ls=Ge;G.p={};var Sn=function(e){return e.replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g,function(t,i,r){return i||r.slice(1)})},$n={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"},xn=function(e,t){return e.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g,function(i,r,o){var s=o&&o.toUpperCase();return r||t[o]||$n[o]||Sn(t[s])})},Cn=/(\[[^[]*\])|([-:/.()\s]+)|(A|a|YYYY|YY?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g,_n=/\d/,ei=/\d\d/,kn=/\d{3}/,Tn=/\d{4}/,be=/\d\d?/,Dn=/[+-]?\d+/,Mn=/[+-]\d\d:?(\d\d)?|Z/,Ft=/\d*[^\s\d-_:/()]+/,Le={},Ja=function(e){return e=+e,e+(e>68?1900:2e3)};function An(a){if(!a||a==="Z")return 0;var e=a.match(/([+-]|\d\d)/g),t=+(e[1]*60)+(+e[2]||0);return t===0?0:e[0]==="+"?-t:t}var re=function(e){return function(t){this[e]=+t}},fa=[Mn,function(a){var e=this.zone||(this.zone={});e.offset=An(a)}],Yi=function(e){var t=Le[e];return t&&(t.indexOf?t:t.s.concat(t.f))},ba=function(e,t){var i,r=Le,o=r.meridiem;if(!o)i=e===(t?"pm":"PM");else for(var s=1;s<=24;s+=1)if(e.indexOf(o(s,0,t))>-1){i=s>12;break}return i},En={A:[Ft,function(a){this.afternoon=ba(a,!1)}],a:[Ft,function(a){this.afternoon=ba(a,!0)}],S:[_n,function(a){this.milliseconds=+a*100}],SS:[ei,function(a){this.milliseconds=+a*10}],SSS:[kn,function(a){this.milliseconds=+a}],s:[be,re("seconds")],ss:[be,re("seconds")],m:[be,re("minutes")],mm:[be,re("minutes")],H:[be,re("hours")],h:[be,re("hours")],HH:[be,re("hours")],hh:[be,re("hours")],D:[be,re("day")],DD:[ei,re("day")],Do:[Ft,function(a){var e=Le,t=e.ordinal,i=a.match(/\d+/);if(this.day=i[0],!!t)for(var r=1;r<=31;r+=1)t(r).replace(/\[|\]/g,"")===a&&(this.day=r)}],M:[be,re("month")],MM:[ei,re("month")],MMM:[Ft,function(a){var e=Yi("months"),t=Yi("monthsShort"),i=(t||e.map(function(r){return r.slice(0,3)})).indexOf(a)+1;if(i<1)throw new Error;this.month=i%12||i}],MMMM:[Ft,function(a){var e=Yi("months"),t=e.indexOf(a)+1;if(t<1)throw new Error;this.month=t%12||t}],Y:[Dn,re("year")],YY:[ei,function(a){this.year=Ja(a)}],YYYY:[Tn,re("year")],Z:fa,ZZ:fa};function On(a){var e=a.afternoon;if(e!==void 0){var t=a.hours;e?t<12&&(a.hours+=12):t===12&&(a.hours=0),delete a.afternoon}}function Ln(a){a=xn(a,Le&&Le.formats);for(var e=a.match(Cn),t=e.length,i=0;i<t;i+=1){var r=e[i],o=En[r],s=o&&o[0],l=o&&o[1];l?e[i]={regex:s,parser:l}:e[i]=r.replace(/^\[|\]$/g,"")}return function(d){for(var h={},p=0,v=0;p<t;p+=1){var f=e[p];if(typeof f=="string")v+=f.length;else{var y=f.regex,$=f.parser,k=d.slice(v),E=y.exec(k),A=E[0];$.call(h,A),d=d.replace(A,"")}}return On(h),h}}var In=function(e,t,i){try{if(["x","X"].indexOf(t)>-1)return new Date((t==="X"?1e3:1)*e);var r=Ln(t),o=r(e),s=o.year,l=o.month,d=o.day,h=o.hours,p=o.minutes,v=o.seconds,f=o.milliseconds,y=o.zone,$=new Date,k=d||(!s&&!l?$.getDate():1),E=s||$.getFullYear(),A=0;s&&!l||(A=l>0?l-1:$.getMonth());var R=h||0,I=p||0,N=v||0,Y=f||0;return y?new Date(Date.UTC(E,A,k,R,I,N,Y+y.offset*60*1e3)):i?new Date(Date.UTC(E,A,k,R,I,N,Y)):new Date(E,A,k,R,I,N,Y)}catch{return new Date("")}},Fn=function(a,e,t){t.p.customParseFormat=!0,a&&a.parseTwoDigitYear&&(Ja=a.parseTwoDigitYear);var i=e.prototype,r=i.parse;i.parse=function(o){var s=o.date,l=o.utc,d=o.args;this.$u=l;var h=d[1];if(typeof h=="string"){var p=d[2]===!0,v=d[3]===!0,f=p||v,y=d[2];v&&(y=d[2]),Le=this.$locale(),!p&&y&&(Le=t.Ls[y]),this.$d=In(s,h,l),this.init(),y&&y!==!0&&(this.$L=this.locale(y).$L),f&&s!=this.format(h)&&(this.$d=new Date("")),Le={}}else if(h instanceof Array)for(var $=h.length,k=1;k<=$;k+=1){d[1]=h[k-1];var E=t.apply(this,d);if(E.isValid()){this.$d=E.$d,this.$L=E.$L,this.init();break}k===$&&(this.$d=new Date(""))}else r.call(this,o)}};const Rn=Object.freeze({processing:"processing",complete:"complete"});class zn extends F{static get properties(){return{mode:{type:String}}}constructor(){super(),this.mode=Rn.processing}render(){return m`
      <div class="${this.mode}">
        <svg
          viewBox="0 0 120 120"
    ...
    `:this.noDataTemplate}};V.styles=b`
