 ...
 */const Zr=(a,e,t)=>{const i=new Map;for(let r=e;r<=t;r++)i.set(a[r],r);return i},Pa=cr(class extends hr{constructor(a){if(super(a),a.type!==Ae.CHILD)throw Error("repeat() can only be used in text expressions")}dt(a,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);const r=[],o=[];let s=0;for(const l of a)r[s]=i?i(l,s):s,o[s]=t(l,s),s++;return{values:o,keys:r}}render(a,e,t){return this.dt(a,e,t).values}update(a,[e,t,i]){var r;const o=Xo(a),{values:s,keys:l}=this.dt(e,t,i);if(!Array.isArray(o))return this.ut=l,s;const d=(r=this.ut)!==null&&r!==void 0?r:this.ut=[],h=[];let p,v,f=0,y=o.length-1,$=0,k=s.length-1;for(;f<=y&&$<=k;)if(o[f]===null)f++;else if(o[y]===null)y--;else if(d[f]===l[$])h[$]=He(o[f],s[$]),f++,$++;else if(d[y]===l[k])h[k]=He(o[y],s[k]),y--,k--;else if(d[f]===l[k])h[k]=He(o[f],s[k]),Et(a,h[k+1],o[f]),f++,k--;else if(d[y]===l[$])h[$]=He(o[y],s[$]),Et(a,o[f],o[y]),y--,$++;else if(p===void 0&&(p=Zr(l,$,k),v=Zr(d,f,y)),p.has(d[f]))if(p.has(d[y])){const E=v.get(l[$]),A=E!==void 0?o[E]:null;if(A===null){const I=Et(a,o[f]);He(I,s[$]),h[$]=I}else h[$]=He(A,s[$]),Et(a,o[f],A),o[E]=null;$++}else Ri(o[y]),y--;else Ri(o[f]),f++;for(;$<=k;){const E=Et(a,h[k+1]);He(E,s[$]),h[$++]=E}for(;f<=y;){const E=o[f++];E!==null&&Ri(E)}return this.ut=l,Na(a,h),ce}});function qt(a,e,t){return Array.from({length:(e-a)/t+1},(i,r)=>a+r*t)}let Ie=class extends B{constructor(){super(...arguments),this.itemCount=0,this.scrollOptimizationsDisabled=!1,this.intersectionObserver=new IntersectionObserver(e=>{e.forEach(t=>{if(t.target===this.sentinel){t.isIntersecting&&this.dispatchEvent(new Event("scrollThresholdReached"));return}const r=t.target.dataset.cellIndex;if(!r)return;const o=parseInt(r,10);t.isIntersecting?this.visibleCellIndices.add(o):this.visibleCellIndices.delete(o)}),this.scrollOptimizationsDisabled||this.processVisibleCells()}),this.renderedCellIndices=new Set,this.visibleCellIndices=new Set,this.placeholderCellIndices=new Set}reload(){qt(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.removeCell(t)),this.renderedCellIndices.clear(),this.visibleCellIndices.clear(),this.placeholderCellIndices.clear(),this.setupObservations()}scrollToCell(e,t){const i=this.cellContainers[e];if(!i)return!1;const r=t?"smooth":"auto";return i.scrollIntoView({behavior:r}),!0}getVisibleCellIndices(){return Array.from(this.visibleCellIndices)}updated(e){(e.has("itemCount")||e.has("scrollOptimizationsDisabled"))&&this.setupObservations()}disconnectedCallback(){this.intersectionObserver.disconnect()}setupObservations(){this.setupIntersectionObserver()}setupIntersectionObserver(){this.intersectionObserver.disconnect(),this.sentinel&&this.intersectionObserver.observe(this.sentinel),this.scrollOptimizationsDisabled?(qt(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.visibleCellIndices.add(t)),this.processVisibleCells()):this.cellContainers.forEach(e=>this.intersectionObserver.observe(e))}render(){const e=this.itemCount-1,t=qt(0,e,1);return m`
    ...
    `}};n([u({type:Number})],Ie.prototype,"itemCount",void 0);n([u({type:Object})],Ie.prototype,"cellProvider",void 0);n([u({type:Object})],Ie.prototype,"placeholderCellTemplate",void 0);n([u({type:Boolean})],Ie.prototype,"scrollOptimizationsDisabled",void 0);n([le("#sentinel")],Ie.prototype,"sentinel",void 0);n([jo(".cell-container")],Ie.prototype,"cellContainers",void 0);Ie=n([Q("infinite-scroller")],Ie);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Zo=(a,...e)=>({strTag:!0,strings:a,values:e}),ot=Zo,Jo=a=>typeof a!="string"&&"strTag"in a,es=(a,e,t)=>{let i=a[0];for(let r=1;r<a.length;r++)i+=e[t?t[r-1]:r-1],i+=a[r];return i};/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;let Zi=class extends B{render(){var e,t,i;return m`
    ...
    `}};n([u({type:Object})],Zi.prototype,"model",void 0);Zi=n([Q("collection-tile")],Zi);function as(a,e){let t=1;return a>=1e9?t=1e9:a>=1e6?t=1e6:a>=1e3&&e==="short"&&(t=1e3),t}function os(a=0,e){const t=a/e,i=t<10;let r=0;return i?r=Math.round((t+Number.EPSILON)*10)/10:r=Math.round(t),r}function ss(a,e,t,i){switch(e){case 1e9:return Ve(t==="short"?ot`${a}B`:ot`${a} billion`);case 1e6:return Ve(t==="short"?ot`${a}M`:ot`${a} million`);case 1e3:return Ve(t==="short"?ot`${a}K`:ot`${a} thousand`);default:return new Intl.NumberFormat(i).format(a)}}function It(a,e="long",t="short",i="en-US"){const r=a!=null?a:-1;if(r<0)return"";const o=as(r,e),s=os(r,o);return ss(s,o,t,i)}const Ua=O`
...
`,ys={account:{color:"#000000",icon:ls,text:"Account"},audio:{color:"#8fdaef",icon:ds,text:"Audio"},collection:{color:"#000000",icon:Ba,text:"Collection"},data:{color:"#333333",icon:cs,text:"Data"},etree:{color:"#3871c1",icon:hs,text:"E-tree"},film:{color:"#bf1b2c",icon:Jr,text:"Film"},image:{color:"#62c4a9",icon:us,text:"Image"},movies:{color:"#bf1b2c",icon:Jr,text:"Movie"},radio:{color:"#8fdaef",icon:ps,text:"Radio"},software:{color:"#80cc28",icon:vs,text:"Software"},texts:{color:"#f9a72b",icon:ms,text:"Text"},tv:{color:"#f25d54",icon:gs,text:"TV"},video:{color:"#bf1b2c",icon:fs,text:"Video"},web:{color:"#fddd10",icon:bs,text:"Web"}};let Wt=class extends B{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var e,t;const i=["tvnews","tvarchive","television"],r=["radio","radioprogram"];return this.mediatype==="movies"&&((e=this.collections)===null||e===void 0?void 0:e.some(o=>i.indexOf(o)>=0))?"tv":this.mediatype==="audio"&&((t=this.collections)===null||t===void 0?void 0:t.some(o=>r.indexOf(o)>=0))?"radio":this.mediatype||""}render(){const e=ys[this.displayMediatype];return e?m`
      <div
        id="icon"
    ...
    `}};n([u({type:String})],Wt.prototype,"mediatype",void 0);n([u({type:Array})],Wt.prototype,"collections",void 0);n([u({type:Boolean})],Wt.prototype,"showText",void 0);Wt=n([Q("mediatype-icon")],Wt);/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ea=cr(class extends hr{constructor(a){var e;if(super(a),a.type!==Ae.ATTRIBUTE||a.name!=="class"||((e=a.strings)===null||e===void 0?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(a){return" "+Object.keys(a).filter(e=>a[e]).join(" ")+" "}update(a,[e]){var t,i;if(this.et===void 0){this.et=new Set,a.strings!==void 0&&(this.st=new Set(a.strings.join(" ").split(/\s/).filter(o=>o!=="")));for(const o in e)e[o]&&!(!((t=this.st)===null||t===void 0)&&t.has(o))&&this.et.add(o);return this.render(e)}const r=a.element.classList;this.et.forEach(o=>{o in e||(r.remove(o),this.et.delete(o))});for(const o in e){const s=!!e[o];s===this.et.has(o)||((i=this.st)===null||i===void 0?void 0:i.has(o))||(s?(r.add(o),this.et.add(o)):(r.remove(o),this.et.delete(o)))}return ce}}),ws=b`
  .drop-shadow {
...
`;let vt=class extends B{constructor(){super(...arguments),this.isListTile=!1,this.loggedIn=!1,this.loginRequired=!1,this.contentWarning=!1}render(){return this.loginRequired&&!this.loggedIn?m` ${this.loginRequiredTemplate} `:m` ${this.contentWarningTemplate} `}get loginRequiredTemplate(){return this.isListTile?m` ${xs} `:m`
      <div class="tile-action no-preview">Log in to view this item</div>
    `}get contentWarningTemplate(){return this.isListTile?m` ${$s} `:m`
    ...
    `}};n([u({type:Boolean})],vt.prototype,"isListTile",void 0);n([u({type:Boolean})],vt.prototype,"loggedIn",void 0);n([u({type:Boolean})],vt.prototype,"loginRequired",void 0);n([u({type:Boolean})],vt.prototype,"contentWarning",void 0);vt=n([Q("item-image-overlay")],vt);let _e=class extends B{constructor(){super(...arguments),this.isListTile=!1,this.isCompactTile=!1,this.loggedIn=!1,this.isWaveform=!1}render(){return m`
    ...
    `}get itemImageOverlayTemplate(){var e,t,i,r;return!(!((e=this.model)===null||e===void 0)&&e.loginRequired)&&!(!((t=this.model)===null||t===void 0)&&t.contentWarning)?_:m`
      ...
      ></item-image-overlay>
    `}get imageSrc(){var e;return`${this.baseImageUrl}/services/img/${(e=this.model)===null||e===void 0?void 0:e.identifier}`}get hashBasedGradient(){var e;return!((e=this.model)===null||e===void 0)&&e.identifier?`waveform-grad${this.hashStrToInt(this.model.identifier)%6}`:"waveform-grad0"}hashStrToInt(e){return e.split("").reduce((t,i)=>t+i.charCodeAt(0),0)}get itemBaseClass(){return{"drop-shadow":!0,"list-box":this.isListTile,[this.hashBasedGradient]:this.isWaveform}}get itemImageClass(){var e,t;const i=((e=this.model)===null||e===void 0?void 0:e.contentWarning)||((t=this.model)===null||t===void 0?void 0:t.loginRequired);return{contain:!this.isCompactTile,cover:this.isCompactTile,blur:i||!1,waveform:this.isWaveform}}onLoad(){var e,t;(((e=this.model)===null||e===void 0?void 0:e.mediatype)==="audio"||((t=this.model)===null||t===void 0?void 0:t.mediatype)==="etree")&&this.baseImage.naturalWidth/this.baseImage.naturalHeight===4&&(this.isWaveform=!0)}static get styles(){return[ws,Ss,b`
        img {
          height: var(--imgHeight, 16rem);
          width: var(--imgWidth, 16rem);
        }
      `]}};n([u({type:Object})],_e.prototype,"model",void 0);n([u({type:String})],_e.prototype,"baseImageUrl",void 0);n([u({type:Boolean})],_e.prototype,"isListTile",void 0);n([u({type:Boolean})],_e.prototype,"isCompactTile",void 0);n([u({type:Boolean})],_e.prototype,"loggedIn",void 0);n([D()],_e.prototype,"isWaveform",void 0);n([le("img")],_e.prototype,"baseImage",void 0);_e=n([Q("item-image")],_e);let ni=class extends B{render(){var e,t,i,r,o,s,l;const d=(e=this.model)===null||e===void 0?void 0:e.title,h=(t=this.model)===null||t===void 0?void 0:t.creator;return m`
      <div id="container">
        <div id="title-image-container">
          <h1 id="item-title" title=${Ce(d)}>${d}</h1>
        ...
        <div id="item-stats-container">
          <div id="stats-holder">
            ...
            <div class="col">
              ${ns}
              <p class="status-text">
                ${It((o=this.model)===null||o===void 0?void 0:o.viewCount,"short","short")}
              </p>
            </div>
            <div class="col">
              ${Ua}
              <p class="status-text">
                ${It((s=this.model)===null||s===void 0?void 0:s.itemCount,"short","short")}
              </p>
            </div>
            <div class="col">
              ${Ha}
              <p class="status-text">
                ${It((l=this.model)===null||l===void 0?void 0:l.favCount,"short","short")}
              </p>
            </div>
          </div>
        </div>
    ...
    `}};n([u({type:Object})],ni.prototype,"model",void 0);n([u({type:String})],ni.prototype,"baseImageUrl",void 0);ni=n([Q("item-tile")],ni);const Cs=O`
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path
      d="m89.6854559 79.6500588c1.7300364 6.4823648 2.180423 13.3122689 3.3145441 20.3499412h-86c.5683151-15.8558542 2.98334063-30.7849367 15.1676149-41.6581341 22.9948067-20.518674 59.250299-9.0032844 67.517841 21.3081929zm-40.0998307-79.6500588c10.872402.0493248 19.9700408 9.25722341 19.917959 20.1421788-.0829413 11.042868-8.9616237 19.8492523-20.0602807 19.8578212-11.1181198 0-19.9397193-8.7904706-19.9397193-19.8908727-.0327543-11.11998815 9.0125781-20.17487063 20.082041-20.1091273z"
      fill="#333"
...
`;let Ji=class extends B{render(){var e,t,i,r,o,s,l;return m`
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*zi(a,e){const t=typeof e=="function";if(a!==void 0){let i=-1;for(const r of a)i>-1&&(yield t?e(i):e),i++,yield r}}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*ta(a,e){if(a!==void 0){let t=0;for(const i of a)yield e(i,t++)}}/*! @license DOMPurify 2.3.8 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/2.3.8/LICENSE */function je(a){return je=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},je(a)}function er(a,e){return er=Object.setPrototypeOf||function(i,r){return i.__proto__=r,i},er(a,e)}function ks(){if(typeof Reflect=="undefined"||!Reflect.construct||Reflect.construct.sham)return!1;if(typeof Proxy=="function")return!0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],function(){})),!0}catch{return!1}}function ti(a,e,t){return ks()?ti=Reflect.construct:ti=function(r,o,s){var l=[null];l.push.apply(l,o);var d=Function.bind.apply(r,l),h=new d;return s&&er(h,s.prototype),h},ti.apply(null,arguments)}function he(a){return Ts(a)||Ds(a)||Ms(a)||As()}function Ts(a){if(Array.isArray(a))return tr(a)}function Ds(a){if(typeof Symbol!="undefined"&&a[Symbol.iterator]!=null||a["@@iterator"]!=null)return Array.from(a)}function Ms(a,e){if(!!a){if(typeof a=="string")return tr(a,e);var t=Object.prototype.toString.call(a).slice(8,-1);if(t==="Object"&&a.constructor&&(t=a.constructor.name),t==="Map"||t==="Set")return Array.from(a);if(t==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t))return tr(a,e)}}function tr(a,e){(e==null||e>a.length)&&(e=a.length);for(var t=0,i=new Array(e);t<e;t++)i[t]=a[t];return i}function As(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}var Es=Object.hasOwnProperty,ia=Object.setPrototypeOf,Os=Object.isFrozen,Ls=Object.getPrototypeOf,Fs=Object.getOwnPropertyDescriptor,ee=Object.freeze,ye=Object.seal,Is=Object.create,Wa=typeof Reflect!="undefined"&&Reflect,li=Wa.apply,ir=Wa.construct;li||(li=function(e,t,i){return e.apply(t,i)});ee||(ee=function(e){return e});ye||(ye=function(e){return e});ir||(ir=function(e,t){return ti(e,he(t))});var Rs=pe(Array.prototype.forEach),ra=pe(Array.prototype.pop),Ot=pe(Array.prototype.push),ii=pe(String.prototype.toLowerCase),zs=pe(String.prototype.match),Me=pe(String.prototype.replace),Ns=pe(String.prototype.indexOf),Ps=pe(String.prototype.trim),J=pe(RegExp.prototype.test),Ni=Bs(TypeError);function pe(a){return function(e){for(var t=arguments.length,i=new Array(t>1?t-1:0),r=1;r<t;r++)i[r-1]=arguments[r];return li(a,e,i)}}function Bs(a){return function(){for(var e=arguments.length,t=new Array(e),i=0;i<e;i++)t[i]=arguments[i];return ir(a,t)}}function M(a,e){ia&&ia(a,null);for(var t=e.length;t--;){var i=e[t];if(typeof i=="string"){var r=ii(i);r!==i&&(Os(e)||(e[t]=r),i=r)}a[i]=!0}return a}function We(a){var e=Is(null),t;for(t in a)li(Es,a,[t])&&(e[t]=a[t]);return e}function Xt(a,e){for(;a!==null;){var t=Fs(a,e);if(t){if(t.get)return pe(t.get);if(typeof t.value=="function")return pe(t.value)}a=Ls(a)}function i(r){return console.warn("fallback value for",r),null}return i}var aa=ee(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","section","select","shadow","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),Pi=ee(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","filter","font","g","glyph","glyphref","hkern","image","line","lineargradient","marker","mask","metadata","mpath","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),Bi=ee(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),Us=ee(["animate","color-profile","cursor","discard","fedropshadow","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),Ui=ee(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover"]),Hs=ee(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),oa=ee(["#text"]),sa=ee(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","face","for","headers","height","hidden","high","href","hreflang","id","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","pattern","placeholder","playsinline","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","xmlns","slot"]),Hi=ee(["accent-height","accumulate","additive","alignment-baseline","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),na=ee(["accent","accentunder","align","bevelled","close","columnsalign","columnlines","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lspace","lquote","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),Zt=ee(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),Ws=ye(/\{\{[\w\W]*|[\w\W]*\}\}/gm),Vs=ye(/<%[\w\W]*|[\w\W]*%>/gm),js=ye(/^data-[\-\w.\u00B7-\uFFFF]/),Qs=ye(/^aria-[\-\w]+$/),Gs=ye(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|cid|xmpp):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),Ys=ye(/^(?:\w+script|data):/i),Ks=ye(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),qs=ye(/^html$/i),Xs=function(){return typeof window=="undefined"?null:window},Zs=function(e,t){if(je(e)!=="object"||typeof e.createPolicy!="function")return null;var i=null,r="data-tt-policy-suffix";t.currentScript&&t.currentScript.hasAttribute(r)&&(i=t.currentScript.getAttribute(r));var o="dompurify"+(i?"#"+i:"");try{return e.createPolicy(o,{createHTML:function(l){return l}})}catch{return console.warn("TrustedTypes policy "+o+" could not be created."),null}};function Va(){var a=arguments.length>0&&arguments[0]!==void 0?arguments[0]:Xs(),e=function(c){return Va(c)};if(e.version="2.3.8",e.removed=[],!a||!a.document||a.document.nodeType!==9)return e.isSupported=!1,e;var t=a.document,i=a.document,r=a.DocumentFragment,o=a.HTMLTemplateElement,s=a.Node,l=a.Element,d=a.NodeFilter,h=a.NamedNodeMap,p=h===void 0?a.NamedNodeMap||a.MozNamedAttrMap:h,v=a.HTMLFormElement,f=a.DOMParser,y=a.trustedTypes,$=l.prototype,k=Xt($,"cloneNode"),E=Xt($,"nextSibling"),A=Xt($,"childNodes"),I=Xt($,"parentNode");if(typeof o=="function"){var F=i.createElement("template");F.content&&F.content.ownerDocument&&(i=F.content.ownerDocument)}var z=Zs(y,t),Y=z?z.createHTML(""):"",oe=i,ge=oe.implementation,wt=oe.createNodeIterator,St=oe.createDocumentFragment,$t=oe.getElementsByTagName,xt=t.importNode,Ke={};try{Ke=We(i).documentMode?i.documentMode:{}}catch{}var te={};e.isSupported=typeof I=="function"&&ge&&typeof ge.createHTMLDocument!="undefined"&&Ke!==9;var Re=Ws,ze=Vs,Ct=js,_t=Qs,kt=Ys,qe=Ks,Ne=Gs,W=null,Xe=M({},[].concat(he(aa),he(Pi),he(Bi),he(Ui),he(oa))),V=null,Ze=M({},[].concat(he(sa),he(Hi),he(na),he(Zt))),U=Object.seal(Object.create(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),Te=null,gi=null,fr=!0,fi=!0,br=!1,Je=!1,Pe=!1,bi=!1,yi=!1,et=!1,jt=!1,Qt=!1,yr=!0,wi=!0,Tt=!1,tt={},it=null,wr=M({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","style","svg","template","thead","title","video","xmp"]),Sr=null,$r=M({},["audio","video","img","source","image","track"]),Si=null,xr=M({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),$i="http://www.w3.org/1998/Math/MathML",xi="http://www.w3.org/2000/svg",De="http://www.w3.org/1999/xhtml",Gt=De,Ci=!1,rt,ro=["application/xhtml+xml","text/html"],ao="text/html",Be,at=null,oo=i.createElement("form"),Cr=function(c){return c instanceof RegExp||c instanceof Function},_i=function(c){at&&at===c||((!c||je(c)!=="object")&&(c={}),c=We(c),W="ALLOWED_TAGS"in c?M({},c.ALLOWED_TAGS):Xe,V="ALLOWED_ATTR"in c?M({},c.ALLOWED_ATTR):Ze,Si="ADD_URI_SAFE_ATTR"in c?M(We(xr),c.ADD_URI_SAFE_ATTR):xr,Sr="ADD_DATA_URI_TAGS"in c?M(We($r),c.ADD_DATA_URI_TAGS):$r,it="FORBID_CONTENTS"in c?M({},c.FORBID_CONTENTS):wr,Te="FORBID_TAGS"in c?M({},c.FORBID_TAGS):{},gi="FORBID_ATTR"in c?M({},c.FORBID_ATTR):{},tt="USE_PROFILES"in c?c.USE_PROFILES:!1,fr=c.ALLOW_ARIA_ATTR!==!1,fi=c.ALLOW_DATA_ATTR!==!1,br=c.ALLOW_UNKNOWN_PROTOCOLS||!1,Je=c.SAFE_FOR_TEMPLATES||!1,Pe=c.WHOLE_DOCUMENT||!1,et=c.RETURN_DOM||!1,jt=c.RETURN_DOM_FRAGMENT||!1,Qt=c.RETURN_TRUSTED_TYPE||!1,yi=c.FORCE_BODY||!1,yr=c.SANITIZE_DOM!==!1,wi=c.KEEP_CONTENT!==!1,Tt=c.IN_PLACE||!1,Ne=c.ALLOWED_URI_REGEXP||Ne,Gt=c.NAMESPACE||De,c.CUSTOM_ELEMENT_HANDLING&&Cr(c.CUSTOM_ELEMENT_HANDLING.tagNameCheck)&&(U.tagNameCheck=c.CUSTOM_ELEMENT_HANDLING.tagNameCheck),c.CUSTOM_ELEMENT_HANDLING&&Cr(c.CUSTOM_ELEMENT_HANDLING.attributeNameCheck)&&(U.attributeNameCheck=c.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),c.CUSTOM_ELEMENT_HANDLING&&typeof c.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements=="boolean"&&(U.allowCustomizedBuiltInElements=c.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements),rt=ro.indexOf(c.PARSER_MEDIA_TYPE)===-1?rt=ao:rt=c.PARSER_MEDIA_TYPE,Be=rt==="application/xhtml+xml"?function(g){return g}:ii,Je&&(fi=!1),jt&&(et=!0),tt&&(W=M({},he(oa)),V=[],tt.html===!0&&(M(W,aa),M(V,sa)),tt.svg===!0&&(M(W,Pi),M(V,Hi),M(V,Zt)),tt.svgFilters===!0&&(M(W,Bi),M(V,Hi),M(V,Zt)),tt.mathMl===!0&&(M(W,Ui),M(V,na),M(V,Zt))),c.ADD_TAGS&&(W===Xe&&(W=We(W)),M(W,c.ADD_TAGS)),c.ADD_ATTR&&(V===Ze&&(V=We(V)),M(V,c.ADD_ATTR)),c.ADD_URI_SAFE_ATTR&&M(Si,c.ADD_URI_SAFE_ATTR),c.FORBID_CONTENTS&&(it===wr&&(it=We(it)),M(it,c.FORBID_CONTENTS)),wi&&(W["#text"]=!0),Pe&&M(W,["html","head","body"]),W.table&&(M(W,["tbody"]),delete Te.tbody),ee&&ee(c),at=c)},_r=M({},["mi","mo","mn","ms","mtext"]),kr=M({},["foreignobject","desc","title","annotation-xml"]),so=M({},["title","style","font","a","script"]),Yt=M({},Pi);M(Yt,Bi),M(Yt,Us);var ki=M({},Ui);M(ki,Hs);var no=function(c){var g=I(c);(!g||!g.tagName)&&(g={namespaceURI:De,tagName:"template"});var S=ii(c.tagName),R=ii(g.tagName);return c.namespaceURI===xi?g.namespaceURI===De?S==="svg":g.namespaceURI===$i?S==="svg"&&(R==="annotation-xml"||_r[R]):Boolean(Yt[S]):c.namespaceURI===$i?g.namespaceURI===De?S==="math":g.namespaceURI===xi?S==="math"&&kr[R]:Boolean(ki[S]):c.namespaceURI===De?g.namespaceURI===xi&&!kr[R]||g.namespaceURI===$i&&!_r[R]?!1:!ki[S]&&(so[S]||!Yt[S]):!1},we=function(c){Ot(e.removed,{element:c});try{c.parentNode.removeChild(c)}catch{try{c.outerHTML=Y}catch{c.remove()}}},Tr=function(c,g){try{Ot(e.removed,{attribute:g.getAttributeNode(c),from:g})}catch{Ot(e.removed,{attribute:null,from:g})}if(g.removeAttribute(c),c==="is"&&!V[c])if(et||jt)try{we(g)}catch{}else try{g.setAttribute(c,"")}catch{}},Dr=function(c){var g,S;if(yi)c="<remove></remove>"+c;else{var R=zs(c,/^[\r\n\t ]+/);S=R&&R[0]}rt==="application/xhtml+xml"&&(c='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+c+"</body></html>");var ie=z?z.createHTML(c):c;if(Gt===De)try{g=new f().parseFromString(ie,rt)}catch{}if(!g||!g.documentElement){g=ge.createDocument(Gt,"template",null);try{g.documentElement.innerHTML=Ci?"":ie}catch{}}var X=g.body||g.documentElement;return c&&S&&X.insertBefore(i.createTextNode(S),X.childNodes[0]||null),Gt===De?$t.call(g,Pe?"html":"body")[0]:Pe?g.documentElement:X},Mr=function(c){return wt.call(c.ownerDocument||c,c,d.SHOW_ELEMENT|d.SHOW_COMMENT|d.SHOW_TEXT,null,!1)},lo=function(c){return c instanceof v&&(typeof c.nodeName!="string"||typeof c.textContent!="string"||typeof c.removeChild!="function"||!(c.attributes instanceof p)||typeof c.removeAttribute!="function"||typeof c.setAttribute!="function"||typeof c.namespaceURI!="string"||typeof c.insertBefore!="function")},Dt=function(c){return je(s)==="object"?c instanceof s:c&&je(c)==="object"&&typeof c.nodeType=="number"&&typeof c.nodeName=="string"},Se=function(c,g,S){!te[c]||Rs(te[c],function(R){R.call(e,g,S,at)})},Ar=function(c){var g;if(Se("beforeSanitizeElements",c,null),lo(c)||J(/[\u0080-\uFFFF]/,c.nodeName))return we(c),!0;var S=Be(c.nodeName);if(Se("uponSanitizeElement",c,{tagName:S,allowedTags:W}),c.hasChildNodes()&&!Dt(c.firstElementChild)&&(!Dt(c.content)||!Dt(c.content.firstElementChild))&&J(/<[/\w]/g,c.innerHTML)&&J(/<[/\w]/g,c.textContent)||S==="select"&&J(/<template/i,c.innerHTML))return we(c),!0;if(!W[S]||Te[S]){if(!Te[S]&&Or(S)&&(U.tagNameCheck instanceof RegExp&&J(U.tagNameCheck,S)||U.tagNameCheck instanceof Function&&U.tagNameCheck(S)))return!1;if(wi&&!it[S]){var R=I(c)||c.parentNode,ie=A(c)||c.childNodes;if(ie&&R)for(var X=ie.length,K=X-1;K>=0;--K)R.insertBefore(k(ie[K],!0),E(c))}return we(c),!0}return c instanceof l&&!no(c)||(S==="noscript"||S==="noembed")&&J(/<\/no(script|embed)/i,c.innerHTML)?(we(c),!0):(Je&&c.nodeType===3&&(g=c.textContent,g=Me(g,Re," "),g=Me(g,ze," "),c.textContent!==g&&(Ot(e.removed,{element:c.cloneNode()}),c.textContent=g)),Se("afterSanitizeElements",c,null),!1)},Er=function(c,g,S){if(yr&&(g==="id"||g==="name")&&(S in i||S in oo))return!1;if(!(fi&&!gi[g]&&J(Ct,g))){if(!(fr&&J(_t,g))){if(!V[g]||gi[g]){if(!(Or(c)&&(U.tagNameCheck instanceof RegExp&&J(U.tagNameCheck,c)||U.tagNameCheck instanceof Function&&U.tagNameCheck(c))&&(U.attributeNameCheck instanceof RegExp&&J(U.attributeNameCheck,g)||U.attributeNameCheck instanceof Function&&U.attributeNameCheck(g))||g==="is"&&U.allowCustomizedBuiltInElements&&(U.tagNameCheck instanceof RegExp&&J(U.tagNameCheck,S)||U.tagNameCheck instanceof Function&&U.tagNameCheck(S))))return!1}else if(!Si[g]){if(!J(Ne,Me(S,qe,""))){if(!((g==="src"||g==="xlink:href"||g==="href")&&c!=="script"&&Ns(S,"data:")===0&&Sr[c])){if(!(br&&!J(kt,Me(S,qe,"")))){if(S)return!1}}}}}}return!0},Or=function(c){return c.indexOf("-")>0},Lr=function(c){var g,S,R,ie;Se("beforeSanitizeAttributes",c,null);var X=c.attributes;if(!!X){var K={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:V};for(ie=X.length;ie--;){g=X[ie];var Kt=g,Z=Kt.name,Fr=Kt.namespaceURI;if(S=Z==="value"?g.value:Ps(g.value),R=Be(Z),K.attrName=R,K.attrValue=S,K.keepAttr=!0,K.forceKeepAttr=void 0,Se("uponSanitizeAttribute",c,K),S=K.attrValue,!K.forceKeepAttr&&(Tr(Z,c),!!K.keepAttr)){if(J(/\/>/i,S)){Tr(Z,c);continue}Je&&(S=Me(S,Re," "),S=Me(S,ze," "));var ho=Be(c.nodeName);if(!!Er(ho,R,S))try{Fr?c.setAttributeNS(Fr,Z,S):c.setAttribute(Z,S),ra(e.removed)}catch{}}}Se("afterSanitizeAttributes",c,null)}},co=function C(c){var g,S=Mr(c);for(Se("beforeSanitizeShadowDOM",c,null);g=S.nextNode();)Se("uponSanitizeShadowNode",g,null),!Ar(g)&&(g.content instanceof r&&C(g.content),Lr(g));Se("afterSanitizeShadowDOM",c,null)};return e.sanitize=function(C,c){var g,S,R,ie,X;if(Ci=!C,Ci&&(C="<!-->"),typeof C!="string"&&!Dt(C)){if(typeof C.toString!="function")throw Ni("toString is not a function");if(C=C.toString(),typeof C!="string")throw Ni("dirty is not a string, aborting")}if(!e.isSupported){if(je(a.toStaticHTML)==="object"||typeof a.toStaticHTML=="function"){if(typeof C=="string")return a.toStaticHTML(C);if(Dt(C))return a.toStaticHTML(C.outerHTML)}return C}if(bi||_i(c),e.removed=[],typeof C=="string"&&(Tt=!1),Tt){if(C.nodeName){var K=Be(C.nodeName);if(!W[K]||Te[K])throw Ni("root node is forbidden and cannot be sanitized in-place")}}else if(C instanceof s)g=Dr("<!---->"),S=g.ownerDocument.importNode(C,!0),S.nodeType===1&&S.nodeName==="BODY"||S.nodeName==="HTML"?g=S:g.appendChild(S);else{if(!et&&!Je&&!Pe&&C.indexOf("<")===-1)return z&&Qt?z.createHTML(C):C;if(g=Dr(C),!g)return et?null:Qt?Y:""}g&&yi&&we(g.firstChild);for(var Kt=Mr(Tt?C:g);R=Kt.nextNode();)R.nodeType===3&&R===ie||Ar(R)||(R.content instanceof r&&co(R.content),Lr(R),ie=R);if(ie=null,Tt)return C;if(et){if(jt)for(X=St.call(g.ownerDocument);g.firstChild;)X.appendChild(g.firstChild);else X=g;return V.shadowroot&&(X=xt.call(t,X,!0)),X}var Z=Pe?g.outerHTML:g.innerHTML;return Pe&&W["!doctype"]&&g.ownerDocument&&g.ownerDocument.doctype&&g.ownerDocument.doctype.name&&J(qs,g.ownerDocument.doctype.name)&&(Z="<!DOCTYPE "+g.ownerDocument.doctype.name+`>
`+Z),Je&&(Z=Me(Z,Re," "),Z=Me(Z,ze," ")),z&&Qt?z.createHTML(Z):Z},e.setConfig=function(C){_i(C),bi=!0},e.clearConfig=function(){at=null,bi=!1},e.isValidAttribute=function(C,c,g){at||_i({});var S=Be(C),R=Be(c);return Er(S,R,g)},e.addHook=function(C,c){typeof c=="function"&&(te[C]=te[C]||[],Ot(te[C],c))},e.removeHook=function(C){if(te[C])return ra(te[C])},e.removeHooks=function(C){te[C]&&(te[C]=[])},e.removeAllHooks=function(){te={}},e}var Rt=Va();function ja(a){switch(a){case"date":return"Published";case"reviewdate":return"Reviewed";case"addeddate":return"Added";default:return"Archived"}}function Qa(a){return a?`Archivist since ${a.getFullYear()}`:""}function rr(a,e="short",t="en-US"){if(!a)return"";const i={timeZone:"UTC"};switch(e){case"short":i.month="short",i.year="numeric";break;case"long":i.year="numeric",i.month="short",i.day="2-digit";break}return new Intl.DateTimeFormat(t,i).format(a)}let ve=class extends B{constructor(){super(...arguments),this.sortParam=null,this.collectionLinks=[]}updated(e){e.has("model")&&this.fetchCollectionNames()}async fetchCollectionNames(){var e,t;if(!(!((e=this.model)===null||e===void 0)&&e.collections)||this.model.collections.length===0||!this.collectionNameCache)return;this.collectionLinks=[];const i=[],r=[];for(const o of this.model.collections)r.push((t=this.collectionNameCache)===null||t===void 0?void 0:t.collectionNameFor(o).then(s=>{i.push(this.detailsLink(o,s!=null?s:o))}));await Promise.all(r),this.collectionLinks=i}render(){return m`
    ...
    `}get mobileTemplate(){var e;return m`
      <div id="list-line-top">
        <div id="list-line-left">
          <div id="thumb" class="${Ce((e=this.model)===null||e===void 0?void 0:e.mediatype)}">
            ${this.imgTemplate}
          </div>
        </div>
    ...
    `:_}get iconRightTemplate(){var e,t;return m`
      <div id="icon-right">
        <mediatype-icon
          ...
          style="--iconCustomFillColor: ${Ce(this.collectionColor)}"
        >
        </mediatype-icon>
      </div>
    ...
    `}};n([u({type:Object})],mt.prototype,"model",void 0);n([u({type:Number})],mt.prototype,"currentWidth",void 0);n([u({type:Object})],mt.prototype,"sortParam",void 0);n([u({type:Number})],mt.prototype,"mobileBreakpoint",void 0);mt=n([Q("tile-list-compact-header")],mt);let se=class extends B{constructor(){super(...arguments),this.sortParam=null}render(){return m`
      <div id="container">
    ...
    `}get linkTileTemplate(){var e,t;return m`
      <a
        ...
        title=${Ce((t=this.model)===null||t===void 0?void 0:t.title)}
      >
        ${this.tile}
      </a>
    ...
    `}};n([u({type:String})],se.prototype,"tileDisplayMode",void 0);n([u({type:Object})],se.prototype,"model",void 0);n([u({type:String})],se.prototype,"baseNavigationUrl",void 0);n([u({type:Number})],se.prototype,"currentWidth",void 0);n([u({type:Number})],se.prototype,"currentHeight",void 0);n([u({type:Object})],se.prototype,"resizeObserver",void 0);n([u({type:Object})],se.prototype,"collectionNameCache",void 0);n([u({type:Object})],se.prototype,"sortParam",void 0);n([le("#container")],se.prototype,"container",void 0);n([u({type:Number})],se.prototype,"mobileBreakpoint",void 0);n([u({type:String})],se.prototype,"baseImageUrl",void 0);se=n([Q("tile-dispatcher")],se);let la=class extends B{render(){return m` <div id="container"></div> `}static get styles(){return b`
      :host {
        display: block;
        height: 100%;
      }
    ...
    `}};la=n([Q("collection-browser-loading-tile")],la);var L;(function(a){a.relevance="relevance",a.views="views",a.title="title",a.datearchived="datearchived",a.date="date",a.datereviewed="datereviewed",a.dateadded="dateadded",a.creator="creator"})(L||(L={}));const Lt={relevance:"Relevance",views:"Views",title:"Title",datearchived:"Date Archived",date:"Date Published",datereviewed:"Date Reviewed",dateadded:"Date Added",creator:"Creator"},Js={relevance:null,views:"week",title:"titleSorter",datearchived:"publicdate",date:"date",datereviewed:"reviewdate",dateadded:"addeddate",creator:"creatorSorter"},da={titleSorter:L.title,date:L.date,publicdate:L.datearchived,reviewdate:L.datereviewed,addeddate:L.dateadded,creatorSorter:L.creator,week:L.views},di={subject:{},mediatype:{},language:{},creator:{},collection:{},year:{}};let ci=class extends B{constructor(){super(...arguments),this.selectedLetter=null,this.alphabet="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("")}get selectedUppercaseLetter(){var e;return(e=this.selectedLetter)===null||e===void 0?void 0:e.toUpperCase()}render(){return m`
      <div id="container">
        <ul>
  ...
  `;n([u({type:String})],ci.prototype,"selectedLetter",void 0);ci=n([Q("alpha-bar")],ci);const ca=O`
...
`;let q=class extends B{constructor(){super(...arguments),this.sortDirection=null,this.selectedSort=L.relevance,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.showRelevance=!0,this.alphaSelectorVisible=null,this.dateSortSelectorVisible=!1,this.desktopSelectorBarWidth=0,this.selectorBarContainerWidth=0,this.hoveringOverDateSortOptions=!1,this.boundDateSelectorEscapeListener=e=>{e.key==="Escape"&&(this.dateSortSelectorVisible=!1)}}render(){return m`
    ...
    `}selectDateSort(e){this.dateSortSelectorVisible=!1,this.setSelectedSort(e)}setSortDirections(e){this.sortDirection=e,this.emitSortChangedEvent()}setSelectedSort(e){this.selectedSort=e,this.emitSortChangedEvent()}get dateOptionSelected(){return[L.datearchived,L.date,L.datereviewed,L.dateadded].includes(this.selectedSort)}get dateSortField(){var e;const t=Lt[L.date];return this.dateOptionSelected&&(e=Lt[this.selectedSort])!==null&&e!==void 0?e:t}get titleSelectorBar(){return m` <alpha-bar
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ha=cr(class extends hr{constructor(a){if(super(a),a.type!==Ae.PROPERTY&&a.type!==Ae.ATTRIBUTE&&a.type!==Ae.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Ko(a))throw Error("`live` bindings can only contain a single expression")}render(a){return a}update(a,[e]){if(e===ce||e===_)return e;const t=a.element,i=a.name;if(a.type===Ae.PROPERTY){if(e===t[i])return ce}else if(a.type===Ae.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(i))return ce}else if(a.type===Ae.ATTRIBUTE&&t.getAttribute(i)===e+"")return ce;return Na(a),e}});var Ga=60,Ya=Ga*60,Ka=Ya*24,an=Ka*7,gt=1e3,Wi=Ga*gt,ua=Ya*gt,on=Ka*gt,sn=an*gt,ur="millisecond",nt="second",lt="minute",dt="hour",Ee="day",ri="week",ue="month",qa="quarter",Oe="year",ct="date",nn="YYYY-MM-DDTHH:mm:ssZ",pa="Invalid Date",ln=/^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/,dn=/\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g,cn={name:"en",weekdays:"Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),months:"January_February_March_April_May_June_July_August_September_October_November_December".split("_")},ar=function(e,t,i){var r=String(e);return!r||r.length>=t?e:""+Array(t+1-r.length).join(i)+e},hn=function(e){var t=-e.utcOffset(),i=Math.abs(t),r=Math.floor(i/60),o=i%60;return(t<=0?"+":"-")+ar(r,2,"0")+":"+ar(o,2,"0")},un=function a(e,t){if(e.date()<t.date())return-a(t,e);var i=(t.year()-e.year())*12+(t.month()-e.month()),r=e.clone().add(i,ue),o=t-r<0,s=e.clone().add(i+(o?-1:1),ue);return+(-(i+(t-r)/(o?r-s:s-r))||0)},pn=function(e){return e<0?Math.ceil(e)||0:Math.floor(e)},vn=function(e){var t={M:ue,y:Oe,w:ri,d:Ee,D:ct,h:dt,m:lt,s:nt,ms:ur,Q:qa};return t[e]||String(e||"").toLowerCase().replace(/s$/,"")},mn=function(e){return e===void 0},gn={s:ar,z:hn,m:un,a:pn,p:vn,u:mn},zt="en",Ge={};Ge[zt]=cn;var pr=function(e){return e instanceof mi},hi=function a(e,t,i){var r;if(!e)return zt;if(typeof e=="string"){var o=e.toLowerCase();Ge[o]&&(r=o),t&&(Ge[o]=t,r=o);var s=e.split("-");if(!r&&s.length>1)return a(s[0])}else{var l=e.name;Ge[l]=e,r=l}return!i&&r&&(zt=r),r||!i&&zt},G=function(e,t){if(pr(e))return e.clone();var i=typeof t=="object"?t:{};return i.date=e,i.args=arguments,new mi(i)},fn=function(e,t){return G(e,{locale:t.$L,utc:t.$u,x:t.$x,$offset:t.$offset})},N=gn;N.l=hi;N.i=pr;N.w=fn;var bn=function(e){var t=e.date,i=e.utc;if(t===null)return new Date(NaN);if(N.u(t))return new Date;if(t instanceof Date)return new Date(t);if(typeof t=="string"&&!/Z$/i.test(t)){var r=t.match(ln);if(r){var o=r[2]-1||0,s=(r[7]||"0").substring(0,3);return i?new Date(Date.UTC(r[1],o,r[3]||1,r[4]||0,r[5]||0,r[6]||0,s)):new Date(r[1],o,r[3]||1,r[4]||0,r[5]||0,r[6]||0,s)}}return new Date(t)},mi=function(){function a(t){this.$L=hi(t.locale,null,!0),this.parse(t)}var e=a.prototype;return e.parse=function(i){this.$d=bn(i),this.$x=i.x||{},this.init()},e.init=function(){var i=this.$d;this.$y=i.getFullYear(),this.$M=i.getMonth(),this.$D=i.getDate(),this.$W=i.getDay(),this.$H=i.getHours(),this.$m=i.getMinutes(),this.$s=i.getSeconds(),this.$ms=i.getMilliseconds()},e.$utils=function(){return N},e.isValid=function(){return this.$d.toString()!==pa},e.isSame=function(i,r){var o=G(i);return this.startOf(r)<=o&&o<=this.endOf(r)},e.isAfter=function(i,r){return G(i)<this.startOf(r)},e.isBefore=function(i,r){return this.endOf(r)<G(i)},e.$g=function(i,r,o){return N.u(i)?this[r]:this.set(o,i)},e.unix=function(){return Math.floor(this.valueOf()/1e3)},e.valueOf=function(){return this.$d.getTime()},e.startOf=function(i,r){var o=this,s=N.u(r)?!0:r,l=N.p(i),d=function(A,I){var F=N.w(o.$u?Date.UTC(o.$y,I,A):new Date(o.$y,I,A),o);return s?F:F.endOf(Ee)},h=function(A,I){var F=[0,0,0,0],z=[23,59,59,999];return N.w(o.toDate()[A].apply(o.toDate("s"),(s?F:z).slice(I)),o)},p=this.$W,v=this.$M,f=this.$D,y="set"+(this.$u?"UTC":"");switch(l){case Oe:return s?d(1,0):d(31,11);case ue:return s?d(1,v):d(0,v+1);case ri:{var $=this.$locale().weekStart||0,k=(p<$?p+7:p)-$;return d(s?f-k:f+(6-k),v)}case Ee:case ct:return h(y+"Hours",0);case dt:return h(y+"Minutes",1);case lt:return h(y+"Seconds",2);case nt:return h(y+"Milliseconds",3);default:return this.clone()}},e.endOf=function(i){return this.startOf(i,!1)},e.$set=function(i,r){var o,s=N.p(i),l="set"+(this.$u?"UTC":""),d=(o={},o[Ee]=l+"Date",o[ct]=l+"Date",o[ue]=l+"Month",o[Oe]=l+"FullYear",o[dt]=l+"Hours",o[lt]=l+"Minutes",o[nt]=l+"Seconds",o[ur]=l+"Milliseconds",o)[s],h=s===Ee?this.$D+(r-this.$W):r;if(s===ue||s===Oe){var p=this.clone().set(ct,1);p.$d[d](h),p.init(),this.$d=p.set(ct,Math.min(this.$D,p.daysInMonth())).$d}else d&&this.$d[d](h);return this.init(),this},e.set=function(i,r){return this.clone().$set(i,r)},e.get=function(i){return this[N.p(i)]()},e.add=function(i,r){var o=this,s;i=Number(i);var l=N.p(r),d=function(f){var y=G(o);return N.w(y.date(y.date()+Math.round(f*i)),o)};if(l===ue)return this.set(ue,this.$M+i);if(l===Oe)return this.set(Oe,this.$y+i);if(l===Ee)return d(1);if(l===ri)return d(7);var h=(s={},s[lt]=Wi,s[dt]=ua,s[nt]=gt,s)[l]||1,p=this.$d.getTime()+i*h;return N.w(p,this)},e.subtract=function(i,r){return this.add(i*-1,r)},e.format=function(i){var r=this,o=this.$locale();if(!this.isValid())return o.invalidDate||pa;var s=i||nn,l=N.z(this),d=this.$H,h=this.$m,p=this.$M,v=o.weekdays,f=o.months,y=o.meridiem,$=function(F,z,Y,oe){return F&&(F[z]||F(r,s))||Y[z].slice(0,oe)},k=function(F){return N.s(d%12||12,F,"0")},E=y||function(I,F,z){var Y=I<12?"AM":"PM";return z?Y.toLowerCase():Y},A={YY:String(this.$y).slice(-2),YYYY:this.$y,M:p+1,MM:N.s(p+1,2,"0"),MMM:$(o.monthsShort,p,f,3),MMMM:$(f,p),D:this.$D,DD:N.s(this.$D,2,"0"),d:String(this.$W),dd:$(o.weekdaysMin,this.$W,v,2),ddd:$(o.weekdaysShort,this.$W,v,3),dddd:v[this.$W],H:String(d),HH:N.s(d,2,"0"),h:k(1),hh:k(2),a:E(d,h,!0),A:E(d,h,!1),m:String(h),mm:N.s(h,2,"0"),s:String(this.$s),ss:N.s(this.$s,2,"0"),SSS:N.s(this.$ms,3,"0"),Z:l};return s.replace(dn,function(I,F){return F||A[I]||l.replace(":","")})},e.utcOffset=function(){return-Math.round(this.$d.getTimezoneOffset()/15)*15},e.diff=function(i,r,o){var s,l=N.p(r),d=G(i),h=(d.utcOffset()-this.utcOffset())*Wi,p=this-d,v=N.m(this,d);return v=(s={},s[Oe]=v/12,s[ue]=v,s[qa]=v/3,s[ri]=(p-h)/sn,s[Ee]=(p-h)/on,s[dt]=p/ua,s[lt]=p/Wi,s[nt]=p/gt,s)[l]||p,o?v:N.a(v)},e.daysInMonth=function(){return this.endOf(ue).$D},e.$locale=function(){return Ge[this.$L]},e.locale=function(i,r){if(!i)return this.$L;var o=this.clone(),s=hi(i,r,!0);return s&&(o.$L=s),o},e.clone=function(){return N.w(this.$d,this)},e.toDate=function(){return new Date(this.valueOf())},e.toJSON=function(){return this.isValid()?this.toISOString():null},e.toISOString=function(){return this.$d.toISOString()},e.toString=function(){return this.$d.toUTCString()},a}(),Xa=mi.prototype;G.prototype=Xa;[["$ms",ur],["$s",nt],["$m",lt],["$H",dt],["$W",Ee],["$M",ue],["$y",Oe],["$D",ct]].forEach(function(a){Xa[a[1]]=function(e){return this.$g(e,a[0],a[1])}});G.extend=function(a,e){return a.$i||(a(e,mi,G),a.$i=!0),G};G.locale=hi;G.isDayjs=pr;G.unix=function(a){return G(a*1e3)};G.en=Ge[zt];G.Ls=Ge;G.p={};var yn=function(e){return e.replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g,function(t,i,r){return i||r.slice(1)})},wn={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"},Sn=function(e,t){return e.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g,function(i,r,o){var s=o&&o.toUpperCase();return r||t[o]||wn[o]||yn(t[s])})},$n=/(\[[^[]*\])|([-:/.()\s]+)|(A|a|YYYY|YY?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g,xn=/\d/,Jt=/\d\d/,Cn=/\d{3}/,_n=/\d{4}/,be=/\d\d?/,kn=/[+-]?\d+/,Tn=/[+-]\d\d:?(\d\d)?|Z/,Ft=/\d*[^\s\d-_:/()]+/,Fe={},Za=function(e){return e=+e,e+(e>68?1900:2e3)};function Dn(a){if(!a||a==="Z")return 0;var e=a.match(/([+-]|\d\d)/g),t=+(e[1]*60)+(+e[2]||0);return t===0?0:e[0]==="+"?-t:t}var re=function(e){return function(t){this[e]=+t}},va=[Tn,function(a){var e=this.zone||(this.zone={});e.offset=Dn(a)}],Vi=function(e){var t=Fe[e];return t&&(t.indexOf?t:t.s.concat(t.f))},ma=function(e,t){var i,r=Fe,o=r.meridiem;if(!o)i=e===(t?"pm":"PM");else for(var s=1;s<=24;s+=1)if(e.indexOf(o(s,0,t))>-1){i=s>12;break}return i},Mn={A:[Ft,function(a){this.afternoon=ma(a,!1)}],a:[Ft,function(a){this.afternoon=ma(a,!0)}],S:[xn,function(a){this.milliseconds=+a*100}],SS:[Jt,function(a){this.milliseconds=+a*10}],SSS:[Cn,function(a){this.milliseconds=+a}],s:[be,re("seconds")],ss:[be,re("seconds")],m:[be,re("minutes")],mm:[be,re("minutes")],H:[be,re("hours")],h:[be,re("hours")],HH:[be,re("hours")],hh:[be,re("hours")],D:[be,re("day")],DD:[Jt,re("day")],Do:[Ft,function(a){var e=Fe,t=e.ordinal,i=a.match(/\d+/);if(this.day=i[0],!!t)for(var r=1;r<=31;r+=1)t(r).replace(/\[|\]/g,"")===a&&(this.day=r)}],M:[be,re("month")],MM:[Jt,re("month")],MMM:[Ft,function(a){var e=Vi("months"),t=Vi("monthsShort"),i=(t||e.map(function(r){return r.slice(0,3)})).indexOf(a)+1;if(i<1)throw new Error;this.month=i%12||i}],MMMM:[Ft,function(a){var e=Vi("months"),t=e.indexOf(a)+1;if(t<1)throw new Error;this.month=t%12||t}],Y:[kn,re("year")],YY:[Jt,function(a){this.year=Za(a)}],YYYY:[_n,re("year")],Z:va,ZZ:va};function An(a){var e=a.afternoon;if(e!==void 0){var t=a.hours;e?t<12&&(a.hours+=12):t===12&&(a.hours=0),delete a.afternoon}}function En(a){a=Sn(a,Fe&&Fe.formats);for(var e=a.match($n),t=e.length,i=0;i<t;i+=1){var r=e[i],o=Mn[r],s=o&&o[0],l=o&&o[1];l?e[i]={regex:s,parser:l}:e[i]=r.replace(/^\[|\]$/g,"")}return function(d){for(var h={},p=0,v=0;p<t;p+=1){var f=e[p];if(typeof f=="string")v+=f.length;else{var y=f.regex,$=f.parser,k=d.slice(v),E=y.exec(k),A=E[0];$.call(h,A),d=d.replace(A,"")}}return An(h),h}}var On=function(e,t,i){try{if(["x","X"].indexOf(t)>-1)return new Date((t==="X"?1e3:1)*e);var r=En(t),o=r(e),s=o.year,l=o.month,d=o.day,h=o.hours,p=o.minutes,v=o.seconds,f=o.milliseconds,y=o.zone,$=new Date,k=d||(!s&&!l?$.getDate():1),E=s||$.getFullYear(),A=0;s&&!l||(A=l>0?l-1:$.getMonth());var I=h||0,F=p||0,z=v||0,Y=f||0;return y?new Date(Date.UTC(E,A,k,I,F,z,Y+y.offset*60*1e3)):i?new Date(Date.UTC(E,A,k,I,F,z,Y)):new Date(E,A,k,I,F,z,Y)}catch{return new Date("")}},Ln=function(a,e,t){t.p.customParseFormat=!0,a&&a.parseTwoDigitYear&&(Za=a.parseTwoDigitYear);var i=e.prototype,r=i.parse;i.parse=function(o){var s=o.date,l=o.utc,d=o.args;this.$u=l;var h=d[1];if(typeof h=="string"){var p=d[2]===!0,v=d[3]===!0,f=p||v,y=d[2];v&&(y=d[2]),Fe=this.$locale(),!p&&y&&(Fe=t.Ls[y]),this.$d=On(s,h,l),this.init(),y&&y!==!0&&(this.$L=this.locale(y).$L),f&&s!=this.format(h)&&(this.$d=new Date("")),Fe={}}else if(h instanceof Array)for(var $=h.length,k=1;k<=$;k+=1){d[1]=h[k-1];var E=t.apply(this,d);if(E.isValid()){this.$d=E.$d,this.$L=E.$L,this.init();break}k===$&&(this.$d=new Date(""))}else r.call(this,o)}};const Fn=Object.freeze({processing:"processing",complete:"complete"});class In extends B{static get properties(){return{mode:{type:String}}}constructor(){super(),this.mode=Fn.processing}render(){return m`
      <div class="${this.mode}">
        <svg
          viewBox="0 0 120 120"
...
`,Ja=O`<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><path d="m79.8883285 50.0035012.1116715-.1085359-43.1159942-46.61088155c-2.401537-2.18938917-4.6902018-3.28408375-6.8659943-3.28408375s-4.1642651.63837733-5.9654178 1.91513199c-1.8011528 1.27675467-3.1520173 2.97248092-4.0525937 5.08717877l39.4020173 42.99768924-39.4020173 42.9976892c.9005764 2.1146979 2.2514409 3.8104241 4.0525937 5.0871788 1.8011527 1.2767547 3.7896253 1.915132 5.9654178 1.915132 2.1013449 0 4.3900096-1.0573489 6.8659943-3.1720468l43.1159942-46.7194174z"/></svg>
`;const il=["mediatype","year","subject","collection","creator","language"],rl={subjectSorter:"subject",mediatypeSorter:"mediatype",languageSorter:"language",creatorSorter:"creator",collection:"collection",year:"year"},$a={subject:"Subject",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"};let ae=class extends B{constructor(){super(...arguments),this.facetsLoading=!1,this.fullYearAggregationLoading=!1,this.collapsableFacets=!1,this.showHistogramDatePicker=!1,this.openFacets={subject:!1,mediatype:!1,language:!1,creator:!1,collection:!1,year:!1}}render(){return m`
    ...
    `}getFacetTemplate(e){const i=e.buckets.filter(r=>r.key.startsWith("fav-")===!1).slice(0,6);return m`
      <ul class="facet-list">
        ${Pa(i,r=>`${e.key}:${r.key}`,r=>{var o,s;const l=`${e.key}:${r.key}-show-only`,d=`${e.key}:${r.key}-negative`,h=e.key!=="collection"?m`${(o=r.displayText)!==null&&o!==void 0?o:r.key}`:m`
    ...
    `}facetClicked(e,t,i){const r=e.target,{checked:o,name:s,value:l}=r;o?this.facetChecked(s,l,i):this.facetUnchecked(s,l)}facetChecked(e,t,i){const{selectedFacets:r}=this;let o;r?o=fe({},r):o=di,o[e][t]=i?"hidden":"selected",this.selectedFacets=o}facetUnchecked(e,t){const{selectedFacets:i}=this;let r;i?r=fe({},i):r=di,delete r[e][t],this.selectedFacets=r}getFacetOptionFromKey(e){const r=e.split("__")[2].split(":")[1],o=Object.entries(rl).find(([l])=>r.includes(l)),s=o==null?void 0:o[1];if(!s)throw new Error(`Could not find facet option for key: ${e}`);return s}static get styles(){return b`
      #container.loading {
        opacity: 0.5;
      }
