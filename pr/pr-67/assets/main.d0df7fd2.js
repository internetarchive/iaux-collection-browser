 ...
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ea=cr(class extends hr{constructor(a){var e;if(super(a),a.type!==Me.ATTRIBUTE||a.name!=="class"||((e=a.strings)===null||e===void 0?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(a){return" "+Object.keys(a).filter(e=>a[e]).join(" ")+" "}update(a,[e]){var t,i;if(this.et===void 0){this.et=new Set,a.strings!==void 0&&(this.st=new Set(a.strings.join(" ").split(/\s/).filter(o=>o!=="")));for(const o in e)e[o]&&!(!((t=this.st)===null||t===void 0)&&t.has(o))&&this.et.add(o);return this.render(e)}const r=a.element.classList;this.et.forEach(o=>{o in e||(r.remove(o),this.et.delete(o))});for(const o in e){const s=!!e[o];s===this.et.has(o)||((i=this.st)===null||i===void 0?void 0:i.has(o))||(s?(r.add(o),this.et.add(o)):(r.remove(o),this.et.delete(o)))}return ce}}),ws=b`
  .drop-shadow {
...
`;let vt=class extends B{constructor(){super(...arguments),this.isListTile=!1,this.loggedIn=!1,this.loginRequired=!1,this.contentWarning=!1}render(){return this.loginRequired&&!this.loggedIn?m` ${this.loginRequiredTemplate} `:m` ${this.contentWarningTemplate} `}get loginRequiredTemplate(){return this.isListTile?m`<div class="svg-overlay logged-in">
        ${xs}
      </div>`:m`
      <div class="tile-action no-preview">Log in to view this item</div>
    `}get contentWarningTemplate(){return this.isListTile?m`<div class="svg-overlay">${$s}</div>`:m`
