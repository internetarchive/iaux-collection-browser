var po=Object.defineProperty,vo=Object.defineProperties;var mo=Object.getOwnPropertyDescriptors;var Pr=Object.getOwnPropertySymbols;var go=Object.prototype.hasOwnProperty,fo=Object.prototype.propertyIsEnumerable;var Br=(a,e,t)=>e in a?po(a,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):a[e]=t,fe=(a,e)=>{for(var t in e||(e={}))go.call(e,t)&&Br(a,t,e[t]);if(Pr)for(var t of Pr(e))fo.call(e,t)&&Br(a,t,e[t]);return a},At=(a,e)=>vo(a,mo(e));const yo=function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const o of r)if(o.type==="childList")for(const s of o.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function t(r){const o={};return r.integrity&&(o.integrity=r.integrity),r.referrerpolicy&&(o.referrerPolicy=r.referrerpolicy),r.crossorigin==="use-credentials"?o.credentials="include":r.crossorigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(r){if(r.ep)return;r.ep=!0;const o=t(r);fetch(r.href,o)}};yo();function n(a,e,t,i){var r=arguments.length,o=r<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(a,e,t,i);else for(var l=a.length-1;l>=0;l--)(s=a[l])&&(o=(r<3?s(o):r>3?s(e,t,o):s(e,t))||o);return r>3&&o&&Object.defineProperty(e,t,o),o}function w(a){let e,t,i;return typeof a=="object"?(e=a.hashFunction,t=a.expiring,i=a.tags):e=a,(r,o,s)=>{if(s.value!=null)s.value=Ur(s.value,e,t,i);else if(s.get!=null)s.get=Ur(s.get,e,t,i);else throw"Only put a Memoize() decorator on a method or get accessor."}}const Ei=new Map;function Ur(a,e,t=0,i){const r=Symbol("__memoized_map__");return function(...o){let s;this.hasOwnProperty(r)||Object.defineProperty(this,r,{configurable:!1,enumerable:!1,writable:!1,value:new Map});let l=this[r];if(Array.isArray(i))for(const d of i)Ei.has(d)?Ei.get(d).push(l):Ei.set(d,[l]);if(e||o.length>0||t>0){let d;e===!0?d=o.map(v=>v.toString()).join("!"):e?d=e.apply(this,o):d=o[0];const h=`${d}__timestamp`;let p=!1;if(t>0)if(!l.has(h))p=!0;else{let v=l.get(h);p=Date.now()-v>t}l.has(d)&&!p?s=l.get(d):(s=a.apply(this,o),l.set(d,s),t>0&&l.set(h,Date.now()))}else{const d=this;l.has(d)?s=l.get(d):(s=a.apply(this,o),l.set(d,s))}return s}}class qi{parseValue(e){return typeof e=="string"&&(e==="false"||e==="0")?!1:Boolean(e)}}qi.shared=new qi;class Oe{parseValue(e){if(typeof e=="number")return e;if(typeof e=="boolean")return;const t=parseFloat(e);if(!Number.isNaN(t))return t}}Oe.shared=new Oe;class oi{parseValue(e){return Oe.shared.parseValue(e)}}oi.shared=new oi;class Pt{parseValue(e){return this.parseJSDate(e)||this.parseBracketDate(e)}parseBracketDate(e){if(typeof e!="string")return;const t=e.match(/\[([0-9]{4})\]/);if(!(!t||t.length<2))return this.parseJSDate(t[1])}parseJSDate(e){if(typeof e!="string")return;let t=e;t.match(/^[0-9]{4}-[0-9]{2}-[0-9]{2}\s{1}[0-9]{2}:[0-9]{2}:[0-9]{2}$/)&&(t=t.replace(" ","T"));const i=Date.parse(t);if(Number.isNaN(i))return;let r=new Date(t);return(t.indexOf("Z")>-1||t.indexOf("+")>-1||t.match(/^[0-9]{4}$/)||t.match(/^[0-9]{4}-[0-9]{2}-[0-9]{2}$/)||t.match(/^.*?-[0-9]{2}:[0-9]{2}$/)||t.match(/^.*?-[0-9]{4}$/))&&(r=new Date(r.getTime()+r.getTimezoneOffset()*1e3*60)),r}}Pt.shared=new Pt;class si{parseValue(e){if(typeof e=="number")return e;if(typeof e=="boolean")return;const t=e.split(":");let i;return t.length===1?i=this.parseNumberFormat(t[0]):i=this.parseColonSeparatedFormat(t),i}parseNumberFormat(e){let t=parseFloat(e);return Number.isNaN(t)&&(t=void 0),t}parseColonSeparatedFormat(e){let t=!1;const i=e.map((r,o)=>{const s=parseFloat(r);if(Number.isNaN(s))return t=!0,0;const l=e.length-1-o,d=60**l;return s*Math.floor(d)}).reduce((r,o)=>r+o,0);return t?void 0:i}}si.shared=new si;class Xi{parseValue(e){if(typeof e=="string")return e}}Xi.shared=new Xi;class bo{constructor(e,t){this.separators=[";",","],this.parser=e,t&&t.separators&&(this.separators=t.separators)}parseValue(e){const t=String(e);let i=[];for(const r of this.separators)if(i=t.split(r),i.length>1)break;return this.parseListValues(i)}parseListValues(e){const i=e.map(o=>o.trim()).map(o=>this.parser.parseValue(o)),r=[];return i.forEach(o=>{o!==void 0&&r.push(o)}),r}}class Zi{parseValue(e){if(typeof e=="string")return e}}Zi.shared=new Zi;class ni{parseValue(e){return String(e)}}ni.shared=new ni;class me{constructor(e,t){this.parser=e,this.rawValue=t}get values(){return this.parseRawValue()}get value(){return this.values[0]}parseRawValue(){if(this.rawValue===void 0)return[];const e=Array.isArray(this.rawValue)?this.rawValue:[this.rawValue],t=[];return e.forEach(i=>{const r=this.parser.parseValue(i);Array.isArray(r)?t.push(...r):r!==void 0&&t.push(r)}),t}}n([w()],me.prototype,"values",null);n([w()],me.prototype,"value",null);class wo extends me{constructor(e){super(qi.shared,e)}}class xe extends me{constructor(e){super(Pt.shared,e)}}class Oi extends me{constructor(e){super(si.shared,e)}}class de extends me{constructor(e){super(Oe.shared,e)}}class B extends me{constructor(e){super(ni.shared,e)}}class So extends me{constructor(e){super(Zi.shared,e)}}class Hr extends me{constructor(e){super(oi.shared,e)}}class $o extends me{constructor(e){super(Xi.shared,e)}}class xo extends me{constructor(e,t){super(t,e)}}class Co extends xo{constructor(e){const t=new bo(ni.shared);super(e,t)}}class x{constructor(e){this.rawMetadata=e}get identifier(){var e;return(e=this.rawMetadata)===null||e===void 0?void 0:e.identifier}get addeddate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.addeddate?new xe(this.rawMetadata.addeddate):void 0}get audio_codec(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.audio_codec?new B(this.rawMetadata.audio_codec):void 0}get audio_sample_rate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.audio_sample_rate?new de(this.rawMetadata.audio_sample_rate):void 0}get avg_rating(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.avg_rating?new de(this.rawMetadata.avg_rating):void 0}get collection(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.collection?new B(this.rawMetadata.collection):void 0}get collections_raw(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.collections_raw?new B(this.rawMetadata.collections_raw):void 0}get collection_size(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.collection_size?new Hr(this.rawMetadata.collection_size):void 0}get contributor(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.contributor?new B(this.rawMetadata.contributor):void 0}get coverage(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.coverage?new B(this.rawMetadata.coverage):void 0}get creator(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.creator?new B(this.rawMetadata.creator):void 0}get date(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.date?new xe(this.rawMetadata.date):void 0}get description(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.description?new B(this.rawMetadata.description):void 0}get downloads(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.downloads?new de(this.rawMetadata.downloads):void 0}get duration(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.duration?new Oi(this.rawMetadata.duration):void 0}get"external-identifier"(){var e,t;return!((e=this.rawMetadata)===null||e===void 0)&&e["external-identifier"]?new B((t=this.rawMetadata)===null||t===void 0?void 0:t["external-identifier"]):void 0}get files_count(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.files_count?new de(this.rawMetadata.files_count):void 0}get indexdate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.indexdate?new xe(this.rawMetadata.indexdate):void 0}get isbn(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.isbn?new B(this.rawMetadata.isbn):void 0}get issue(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.issue?new B(this.rawMetadata.issue):void 0}get item_count(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.item_count?new de(this.rawMetadata.item_count):void 0}get item_size(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.item_size?new Hr(this.rawMetadata.item_size):void 0}get language(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.language?new B(this.rawMetadata.language):void 0}get length(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.length?new Oi(this.rawMetadata.length):void 0}get lineage(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.lineage?new B(this.rawMetadata.lineage):void 0}get month(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.month?new de(this.rawMetadata.month):void 0}get mediatype(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.mediatype?new $o(this.rawMetadata.mediatype):void 0}get noindex(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.noindex?new wo(this.rawMetadata.noindex):void 0}get notes(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.notes?new B(this.rawMetadata.notes):void 0}get num_favorites(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.num_favorites?new de(this.rawMetadata.num_favorites):void 0}get num_reviews(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.num_reviews?new de(this.rawMetadata.num_reviews):void 0}get openlibrary_edition(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.openlibrary_edition?new B(this.rawMetadata.openlibrary_edition):void 0}get openlibrary_work(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.openlibrary_work?new B(this.rawMetadata.openlibrary_work):void 0}get page_progression(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.page_progression?new So(this.rawMetadata.page_progression):void 0}get partner(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.partner?new B(this.rawMetadata.partner):void 0}get ppi(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.ppi?new de(this.rawMetadata.ppi):void 0}get publicdate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.publicdate?new xe(this.rawMetadata.publicdate):void 0}get publisher(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.publisher?new B(this.rawMetadata.publisher):void 0}get reviewdate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.reviewdate?new xe(this.rawMetadata.reviewdate):void 0}get runtime(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.runtime?new Oi(this.rawMetadata.runtime):void 0}get scanner(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.scanner?new B(this.rawMetadata.scanner):void 0}get source(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.source?new B(this.rawMetadata.source):void 0}get start_localtime(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.start_localtime?new xe(this.rawMetadata.start_localtime):void 0}get start_time(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.start_time?new xe(this.rawMetadata.start_time):void 0}get stop_time(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.stop_time?new xe(this.rawMetadata.stop_time):void 0}get subject(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.subject?new Co(this.rawMetadata.subject):void 0}get taper(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.taper?new B(this.rawMetadata.taper):void 0}get title(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.title?new B(this.rawMetadata.title):void 0}get transferer(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.transferer?new B(this.rawMetadata.transferer):void 0}get track(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.track?new de(this.rawMetadata.track):void 0}get type(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.type?new B(this.rawMetadata.type):void 0}get uploader(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.uploader?new B(this.rawMetadata.uploader):void 0}get utc_offset(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.utc_offset?new de(this.rawMetadata.utc_offset):void 0}get venue(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.venue?new B(this.rawMetadata.venue):void 0}get volume(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.volume?new B(this.rawMetadata.volume):void 0}get week(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.week?new de(this.rawMetadata.week):void 0}get year(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.year?new xe(this.rawMetadata.year):void 0}}n([w()],x.prototype,"addeddate",null);n([w()],x.prototype,"audio_codec",null);n([w()],x.prototype,"audio_sample_rate",null);n([w()],x.prototype,"avg_rating",null);n([w()],x.prototype,"collection",null);n([w()],x.prototype,"collections_raw",null);n([w()],x.prototype,"collection_size",null);n([w()],x.prototype,"contributor",null);n([w()],x.prototype,"coverage",null);n([w()],x.prototype,"creator",null);n([w()],x.prototype,"date",null);n([w()],x.prototype,"description",null);n([w()],x.prototype,"downloads",null);n([w()],x.prototype,"duration",null);n([w()],x.prototype,"external-identifier",null);n([w()],x.prototype,"files_count",null);n([w()],x.prototype,"indexdate",null);n([w()],x.prototype,"isbn",null);n([w()],x.prototype,"issue",null);n([w()],x.prototype,"item_count",null);n([w()],x.prototype,"item_size",null);n([w()],x.prototype,"language",null);n([w()],x.prototype,"length",null);n([w()],x.prototype,"lineage",null);n([w()],x.prototype,"month",null);n([w()],x.prototype,"mediatype",null);n([w()],x.prototype,"noindex",null);n([w()],x.prototype,"notes",null);n([w()],x.prototype,"num_favorites",null);n([w()],x.prototype,"num_reviews",null);n([w()],x.prototype,"openlibrary_edition",null);n([w()],x.prototype,"openlibrary_work",null);n([w()],x.prototype,"page_progression",null);n([w()],x.prototype,"partner",null);n([w()],x.prototype,"ppi",null);n([w()],x.prototype,"publicdate",null);n([w()],x.prototype,"publisher",null);n([w()],x.prototype,"reviewdate",null);n([w()],x.prototype,"runtime",null);n([w()],x.prototype,"scanner",null);n([w()],x.prototype,"source",null);n([w()],x.prototype,"start_localtime",null);n([w()],x.prototype,"start_time",null);n([w()],x.prototype,"stop_time",null);n([w()],x.prototype,"subject",null);n([w()],x.prototype,"taper",null);n([w()],x.prototype,"title",null);n([w()],x.prototype,"transferer",null);n([w()],x.prototype,"track",null);n([w()],x.prototype,"type",null);n([w()],x.prototype,"uploader",null);n([w()],x.prototype,"utc_offset",null);n([w()],x.prototype,"venue",null);n([w()],x.prototype,"volume",null);n([w()],x.prototype,"week",null);n([w()],x.prototype,"year",null);class yt{constructor(e){this.rawValue=e}get name(){return this.rawValue.name}get source(){return this.rawValue.source}get btih(){return this.rawValue.btih}get md5(){return this.rawValue.md5}get format(){return this.rawValue.format}get mtime(){return this.rawValue.mtime}get crc32(){return this.rawValue.crc32}get sha1(){return this.rawValue.sha1}get original(){return this.rawValue.original}get size(){return this.rawValue.size?oi.shared.parseValue(this.rawValue.size):void 0}get title(){return this.rawValue.title}get length(){return this.rawValue.length?si.shared.parseValue(this.rawValue.length):void 0}get height(){return this.rawValue.height?Oe.shared.parseValue(this.rawValue.height):void 0}get width(){return this.rawValue.width?Oe.shared.parseValue(this.rawValue.width):void 0}get track(){return this.rawValue.track?Oe.shared.parseValue(this.rawValue.track):void 0}get external_identifier(){return this.rawValue.external_identifier}get creator(){return this.rawValue.creator}get album(){return this.rawValue.album}}n([w()],yt.prototype,"size",null);n([w()],yt.prototype,"length",null);n([w()],yt.prototype,"height",null);n([w()],yt.prototype,"width",null);n([w()],yt.prototype,"track",null);class gi{constructor(e){this.rawValue=e}get reviewbody(){return this.rawValue.reviewbody}get reviewtitle(){return this.rawValue.reviewtitle}get reviewer(){return this.rawValue.reviewer}get reviewdate(){return this.rawValue.reviewdate?Pt.shared.parseValue(this.rawValue.reviewdate):void 0}get createdate(){return this.rawValue.createdate?Pt.shared.parseValue(this.rawValue.createdate):void 0}get stars(){return this.rawValue.stars?Oe.shared.parseValue(this.rawValue.stars):void 0}}n([w()],gi.prototype,"reviewdate",null);n([w()],gi.prototype,"createdate",null);n([w()],gi.prototype,"stars",null);class _o{constructor(e){var t,i;this.rawResponse=e,this.created=e.created,this.d1=e.d1,this.d2=e.d2,this.dir=e.dir,this.files=(t=e.files)===null||t===void 0?void 0:t.map(r=>new yt(r)),this.files_count=e.files_count,this.item_last_updated=e.item_last_updated,this.item_size=e.item_size,this.metadata=new x(e.metadata),this.server=e.server,this.uniq=e.uniq,this.workable_servers=e.workable_servers,this.speech_vs_music_asr=e.speech_vs_music_asr,this.reviews=(i=e.reviews)===null||i===void 0?void 0:i.map(r=>new gi(r))}}class ko{constructor(e){this.numFound=e.numFound,this.start=e.start,this.docs=e.docs.map(t=>new x(t)),this.aggregations=e.aggregations}}class To{constructor(e){this.rawResponse=e,this.responseHeader=e.responseHeader,this.response=new ko(e.response)}}var Qe;(function(a){a.networkError="SearchService.NetworkError",a.itemNotFound="SearchService.ItemNotFound",a.decodingError="SearchService.DecodingError",a.searchEngineError="SearchService.SearchEngineError"})(Qe||(Qe={}));class Ji extends Error{constructor(e,t,i){super(t),this.name=e,this.type=e,this.details=i}}class Do{static aggregateSearchParamsAsString(e){if(e.advancedParams){const t=e.advancedParams.map(r=>({terms:r}));return JSON.stringify(t)}if(e.simpleParams)return e.simpleParams.join(",")}static sortParamsAsString(e){return`${e.field} ${e.direction}`}static generateURLSearchParams(e){const t=new URLSearchParams;if(t.append("q",e.query),t.append("output","json"),e.rows&&t.append("rows",String(e.rows)),e.page&&t.append("page",String(e.page)),e.fields&&t.append("fl",e.fields.join(",")),e.sort){const r=e.sort.map(o=>this.sortParamsAsString(o));t.append("sort",r.join(","))}const i=e.aggregations;if(i){const r=this.aggregateSearchParamsAsString(i);r&&t.append("user_aggs",r)}return t}}class Mo{constructor(e){var t;if(this.baseUrl=(t=e==null?void 0:e.baseUrl)!==null&&t!==void 0?t:"archive.org",(e==null?void 0:e.includeCredentials)!==void 0?this.includeCredentials=e.includeCredentials:this.includeCredentials=window.location.href.match(/^https?:\/\/.*archive\.org(:[0-9]+)?/)!==null,(e==null?void 0:e.scope)!==void 0)this.requestScope=e.scope;else{const r=new URL(window.location.href).searchParams.get("scope");r&&(this.requestScope=r)}}async performSearch(e){const i=Do.generateURLSearchParams(e).toString(),r=`https://${this.baseUrl}/advancedsearch.php?${i}`;return this.fetchUrl(r)}async fetchMetadata(e,t){const i=t?`/${t}`:"",r=`https://${this.baseUrl}/metadata/${e}${i}`;return this.fetchUrl(r,{requestOptions:{credentials:"omit"}})}async fetchUrl(e,t){var i;const r=new URL(e);this.requestScope&&r.searchParams.set("scope",this.requestScope);let o;try{const s=(i=t==null?void 0:t.requestOptions)!==null&&i!==void 0?i:{credentials:this.includeCredentials?"include":"same-origin"};o=await fetch(r.href,s)}catch(s){const l=s instanceof Error?s.message:typeof s=="string"?s:"Unknown error";return this.getErrorResult(Qe.networkError,l)}try{const s=await o.json(),l=s.error;if(l){const d=s.forensics;return this.getErrorResult(Qe.searchEngineError,l,d)}else return{success:s}}catch(s){const l=s instanceof Error?s.message:typeof s=="string"?s:"Unknown error";return this.getErrorResult(Qe.decodingError,l)}}getErrorResult(e,t,i){return{error:new Ji(e,t,i)}}}class er{constructor(e){this.searchBackend=e}async search(e){const t=await this.searchBackend.performSearch(e);return t.error?t:{success:new To(t.success)}}async fetchMetadata(e){var t;const i=await this.searchBackend.fetchMetadata(e);return i.error?i:((t=i.success)===null||t===void 0?void 0:t.metadata)===void 0?{error:new Ji(Qe.itemNotFound)}:{success:new _o(i.success)}}async fetchMetadataValue(e,t){var i;const r=await this.searchBackend.fetchMetadata(e,t);return r.error?r:((i=r.success)===null||i===void 0?void 0:i.result)===void 0?{error:new Ji(Qe.itemNotFound)}:{success:r.success.result}}}er.default=new er(new Mo);function Ao(){var a=!navigator.userAgentData&&/Safari\//.test(navigator.userAgent)&&!/Chrom(e|ium)\//.test(navigator.userAgent);if(!a||!indexedDB.databases)return Promise.resolve();var e;return new Promise(function(t){var i=function(){return indexedDB.databases().finally(t)};e=setInterval(i,100),i()}).finally(function(){return clearInterval(e)})}function bt(a){return new Promise((e,t)=>{a.oncomplete=a.onsuccess=()=>e(a.result),a.onabort=a.onerror=()=>t(a.error)})}function Eo(a,e){const t=Ao().then(()=>{const i=indexedDB.open(a);return i.onupgradeneeded=()=>i.result.createObjectStore(e),bt(i)});return(i,r)=>t.then(o=>r(o.transaction(e,i).objectStore(e)))}let Li;function fi(){return Li||(Li=Eo("keyval-store","keyval")),Li}function Oo(a,e=fi()){return e("readonly",t=>bt(t.get(a)))}function Lo(a,e,t=fi()){return t("readwrite",i=>(i.put(e,a),bt(i.transaction)))}function Io(a,e=fi()){return e("readwrite",t=>(t.delete(a),bt(t.transaction)))}function Fo(a,e){return a.openCursor().onsuccess=function(){!this.result||(e(this.result),this.result.continue())},bt(a.transaction)}function Ro(a=fi()){return a("readonly",e=>{if(e.getAllKeys)return bt(e.getAllKeys());const t=[];return Fo(e,i=>t.push(i.key)).then(()=>t)})}function zo(a,e){return a.setMilliseconds(a.getMilliseconds()+e*1e3),a}class No{constructor(e){var t,i,r,o;if(this.namespace=(t=e==null?void 0:e.namespace)!==null&&t!==void 0?t:"LocalCache",this.defaultTTL=(i=e==null?void 0:e.defaultTTL)!==null&&i!==void 0?i:15*60,(!((r=e==null?void 0:e.immediateClean)!==null&&r!==void 0)||r)&&this.cleanExpired(),!(e!=null&&e.disableCleaning)){const s=(o=e==null?void 0:e.cleaningInterval)!==null&&o!==void 0?o:60;setInterval(()=>{this.cleanExpired()},s*1e3)}}async set(e){var t;const i={value:e.value},r=(t=e.ttl)!==null&&t!==void 0?t:this.defaultTTL,o=zo(new Date,r);i.expires=o;const s=this.getNamespacedKey(e.key);try{await Lo(s,i)}catch{}}async get(e){const t=this.getNamespacedKey(e);let i;try{i=await Oo(t)}catch{}if(!i)return;const r=new Date;if(i.expires&&i.expires<r){await this.delete(e);return}return i.value}async delete(e){const t=this.getNamespacedKey(e);try{await Io(t)}catch{}}async cleanExpired(){const e=await this.getAllKeys();await Promise.all(e.map(async t=>this.get(t)))}async getAllKeys(){let e=[];try{e=await Ro()}catch{}const t=[];for(const o of e)typeof o=="string"&&t.push(o);return t.filter(o=>o.startsWith(this.namespace)).map(o=>this.removeNamespace(o))}getNamespacedKey(e){return`${this.namespace}-${e}`}removeNamespace(e){return e.replace(`${this.namespace}-`,"")}}/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const hr=window.ShadowRoot&&(window.ShadyCSS===void 0||window.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,ur=Symbol(),Vr=new Map;class Da{constructor(e,t){if(this._$cssResult$=!0,t!==ur)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e}get styleSheet(){let e=Vr.get(this.cssText);return hr&&e===void 0&&(Vr.set(this.cssText,e=new CSSStyleSheet),e.replaceSync(this.cssText)),e}toString(){return this.cssText}}const Po=a=>new Da(typeof a=="string"?a:a+"",ur),y=(a,...e)=>{const t=a.length===1?a[0]:e.reduce((i,r,o)=>i+(s=>{if(s._$cssResult$===!0)return s.cssText;if(typeof s=="number")return s;throw Error("Value passed to 'css' function must be a 'css' function result: "+s+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(r)+a[o+1],a[0]);return new Da(t,ur)},Bo=(a,e)=>{hr?a.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet):e.forEach(t=>{const i=document.createElement("style"),r=window.litNonce;r!==void 0&&i.setAttribute("nonce",r),i.textContent=t.cssText,a.appendChild(i)})},Wr=hr?a=>a:a=>a instanceof CSSStyleSheet?(e=>{let t="";for(const i of e.cssRules)t+=i.cssText;return Po(t)})(a):a;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Ii;const jr=window.trustedTypes,Uo=jr?jr.emptyScript:"",Qr=window.reactiveElementPolyfillSupport,tr={toAttribute(a,e){switch(e){case Boolean:a=a?Uo:null;break;case Object:case Array:a=a==null?a:JSON.stringify(a)}return a},fromAttribute(a,e){let t=a;switch(e){case Boolean:t=a!==null;break;case Number:t=a===null?null:Number(a);break;case Object:case Array:try{t=JSON.parse(a)}catch{t=null}}return t}},Ma=(a,e)=>e!==a&&(e==e||a==a),Fi={attribute:!0,type:String,converter:tr,reflect:!1,hasChanged:Ma};class nt extends HTMLElement{constructor(){super(),this._$Et=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Ei=null,this.o()}static addInitializer(e){var t;(t=this.l)!==null&&t!==void 0||(this.l=[]),this.l.push(e)}static get observedAttributes(){this.finalize();const e=[];return this.elementProperties.forEach((t,i)=>{const r=this._$Eh(i,t);r!==void 0&&(this._$Eu.set(r,i),e.push(r))}),e}static createProperty(e,t=Fi){if(t.state&&(t.attribute=!1),this.finalize(),this.elementProperties.set(e,t),!t.noAccessor&&!this.prototype.hasOwnProperty(e)){const i=typeof e=="symbol"?Symbol():"__"+e,r=this.getPropertyDescriptor(e,i,t);r!==void 0&&Object.defineProperty(this.prototype,e,r)}}static getPropertyDescriptor(e,t,i){return{get(){return this[t]},set(r){const o=this[e];this[t]=r,this.requestUpdate(e,o,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)||Fi}static finalize(){if(this.hasOwnProperty("finalized"))return!1;this.finalized=!0;const e=Object.getPrototypeOf(this);if(e.finalize(),this.elementProperties=new Map(e.elementProperties),this._$Eu=new Map,this.hasOwnProperty("properties")){const t=this.properties,i=[...Object.getOwnPropertyNames(t),...Object.getOwnPropertySymbols(t)];for(const r of i)this.createProperty(r,t[r])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const i=new Set(e.flat(1/0).reverse());for(const r of i)t.unshift(Wr(r))}else e!==void 0&&t.push(Wr(e));return t}static _$Eh(e,t){const i=t.attribute;return i===!1?void 0:typeof i=="string"?i:typeof e=="string"?e.toLowerCase():void 0}o(){var e;this._$Ep=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$Em(),this.requestUpdate(),(e=this.constructor.l)===null||e===void 0||e.forEach(t=>t(this))}addController(e){var t,i;((t=this._$Eg)!==null&&t!==void 0?t:this._$Eg=[]).push(e),this.renderRoot!==void 0&&this.isConnected&&((i=e.hostConnected)===null||i===void 0||i.call(e))}removeController(e){var t;(t=this._$Eg)===null||t===void 0||t.splice(this._$Eg.indexOf(e)>>>0,1)}_$Em(){this.constructor.elementProperties.forEach((e,t)=>{this.hasOwnProperty(t)&&(this._$Et.set(t,this[t]),delete this[t])})}createRenderRoot(){var e;const t=(e=this.shadowRoot)!==null&&e!==void 0?e:this.attachShadow(this.constructor.shadowRootOptions);return Bo(t,this.constructor.elementStyles),t}connectedCallback(){var e;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$Eg)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostConnected)===null||i===void 0?void 0:i.call(t)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$Eg)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostDisconnected)===null||i===void 0?void 0:i.call(t)})}attributeChangedCallback(e,t,i){this._$AK(e,i)}_$ES(e,t,i=Fi){var r,o;const s=this.constructor._$Eh(e,i);if(s!==void 0&&i.reflect===!0){const l=((o=(r=i.converter)===null||r===void 0?void 0:r.toAttribute)!==null&&o!==void 0?o:tr.toAttribute)(t,i.type);this._$Ei=e,l==null?this.removeAttribute(s):this.setAttribute(s,l),this._$Ei=null}}_$AK(e,t){var i,r,o;const s=this.constructor,l=s._$Eu.get(e);if(l!==void 0&&this._$Ei!==l){const d=s.getPropertyOptions(l),h=d.converter,p=(o=(r=(i=h)===null||i===void 0?void 0:i.fromAttribute)!==null&&r!==void 0?r:typeof h=="function"?h:null)!==null&&o!==void 0?o:tr.fromAttribute;this._$Ei=l,this[l]=p(t,d.type),this._$Ei=null}}requestUpdate(e,t,i){let r=!0;e!==void 0&&(((i=i||this.constructor.getPropertyOptions(e)).hasChanged||Ma)(this[e],t)?(this._$AL.has(e)||this._$AL.set(e,t),i.reflect===!0&&this._$Ei!==e&&(this._$EC===void 0&&(this._$EC=new Map),this._$EC.set(e,i))):r=!1),!this.isUpdatePending&&r&&(this._$Ep=this._$E_())}async _$E_(){this.isUpdatePending=!0;try{await this._$Ep}catch(t){Promise.reject(t)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var e;if(!this.isUpdatePending)return;this.hasUpdated,this._$Et&&(this._$Et.forEach((r,o)=>this[o]=r),this._$Et=void 0);let t=!1;const i=this._$AL;try{t=this.shouldUpdate(i),t?(this.willUpdate(i),(e=this._$Eg)===null||e===void 0||e.forEach(r=>{var o;return(o=r.hostUpdate)===null||o===void 0?void 0:o.call(r)}),this.update(i)):this._$EU()}catch(r){throw t=!1,this._$EU(),r}t&&this._$AE(i)}willUpdate(e){}_$AE(e){var t;(t=this._$Eg)===null||t===void 0||t.forEach(i=>{var r;return(r=i.hostUpdated)===null||r===void 0?void 0:r.call(i)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EU(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$Ep}shouldUpdate(e){return!0}update(e){this._$EC!==void 0&&(this._$EC.forEach((t,i)=>this._$ES(i,this[i],t)),this._$EC=void 0),this._$EU()}updated(e){}firstUpdated(e){}}nt.finalized=!0,nt.elementProperties=new Map,nt.elementStyles=[],nt.shadowRootOptions={mode:"open"},Qr==null||Qr({ReactiveElement:nt}),((Ii=globalThis.reactiveElementVersions)!==null&&Ii!==void 0?Ii:globalThis.reactiveElementVersions=[]).push("1.3.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Ri;const pt=globalThis.trustedTypes,Gr=pt?pt.createPolicy("lit-html",{createHTML:a=>a}):void 0,Ce=`lit$${(Math.random()+"").slice(9)}$`,pr="?"+Ce,Ho=`<${pr}>`,vt=document,Bt=(a="")=>vt.createComment(a),Ut=a=>a===null||typeof a!="object"&&typeof a!="function",Aa=Array.isArray,Ea=a=>{var e;return Aa(a)||typeof((e=a)===null||e===void 0?void 0:e[Symbol.iterator])=="function"},Et=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Yr=/-->/g,Kr=/>/g,Ue=/>|[ 	\n\r](?:([^\s"'>=/]+)([ 	\n\r]*=[ 	\n\r]*(?:[^ 	\n\r"'`<>=]|("|')|))|$)/g,qr=/'/g,Xr=/"/g,Oa=/^(?:script|style|textarea|title)$/i,La=a=>(e,...t)=>({_$litType$:a,strings:e,values:t}),m=La(1),L=La(2),ce=Symbol.for("lit-noChange"),_=Symbol.for("lit-nothing"),Zr=new WeakMap,ti=(a,e,t)=>{var i,r;const o=(i=t==null?void 0:t.renderBefore)!==null&&i!==void 0?i:e;let s=o._$litPart$;if(s===void 0){const l=(r=t==null?void 0:t.renderBefore)!==null&&r!==void 0?r:null;o._$litPart$=s=new wt(e.insertBefore(Bt(),l),l,void 0,t!=null?t:{})}return s._$AI(a),s},ut=vt.createTreeWalker(vt,129,null,!1),Ia=(a,e)=>{const t=a.length-1,i=[];let r,o=e===2?"<svg>":"",s=Et;for(let d=0;d<t;d++){const h=a[d];let p,v,f=-1,b=0;for(;b<h.length&&(s.lastIndex=b,v=s.exec(h),v!==null);)b=s.lastIndex,s===Et?v[1]==="!--"?s=Yr:v[1]!==void 0?s=Kr:v[2]!==void 0?(Oa.test(v[2])&&(r=RegExp("</"+v[2],"g")),s=Ue):v[3]!==void 0&&(s=Ue):s===Ue?v[0]===">"?(s=r!=null?r:Et,f=-1):v[1]===void 0?f=-2:(f=s.lastIndex-v[2].length,p=v[1],s=v[3]===void 0?Ue:v[3]==='"'?Xr:qr):s===Xr||s===qr?s=Ue:s===Yr||s===Kr?s=Et:(s=Ue,r=void 0);const $=s===Ue&&a[d+1].startsWith("/>")?" ":"";o+=s===Et?h+Ho:f>=0?(i.push(p),h.slice(0,f)+"$lit$"+h.slice(f)+Ce+$):h+Ce+(f===-2?(i.push(void 0),d):$)}const l=o+(a[t]||"<?>")+(e===2?"</svg>":"");if(!Array.isArray(a)||!a.hasOwnProperty("raw"))throw Error("invalid template strings array");return[Gr!==void 0?Gr.createHTML(l):l,i]};class Ht{constructor({strings:e,_$litType$:t},i){let r;this.parts=[];let o=0,s=0;const l=e.length-1,d=this.parts,[h,p]=Ia(e,t);if(this.el=Ht.createElement(h,i),ut.currentNode=this.el.content,t===2){const v=this.el.content,f=v.firstChild;f.remove(),v.append(...f.childNodes)}for(;(r=ut.nextNode())!==null&&d.length<l;){if(r.nodeType===1){if(r.hasAttributes()){const v=[];for(const f of r.getAttributeNames())if(f.endsWith("$lit$")||f.startsWith(Ce)){const b=p[s++];if(v.push(f),b!==void 0){const $=r.getAttribute(b.toLowerCase()+"$lit$").split(Ce),k=/([.?@])?(.*)/.exec(b);d.push({type:1,index:o,name:k[2],strings:$,ctor:k[1]==="."?Ra:k[1]==="?"?za:k[1]==="@"?Na:jt})}else d.push({type:6,index:o})}for(const f of v)r.removeAttribute(f)}if(Oa.test(r.tagName)){const v=r.textContent.split(Ce),f=v.length-1;if(f>0){r.textContent=pt?pt.emptyScript:"";for(let b=0;b<f;b++)r.append(v[b],Bt()),ut.nextNode(),d.push({type:2,index:++o});r.append(v[f],Bt())}}}else if(r.nodeType===8)if(r.data===pr)d.push({type:2,index:o});else{let v=-1;for(;(v=r.data.indexOf(Ce,v+1))!==-1;)d.push({type:7,index:o}),v+=Ce.length-1}o++}}static createElement(e,t){const i=vt.createElement("template");return i.innerHTML=e,i}}function Ye(a,e,t=a,i){var r,o,s,l;if(e===ce)return e;let d=i!==void 0?(r=t._$Cl)===null||r===void 0?void 0:r[i]:t._$Cu;const h=Ut(e)?void 0:e._$litDirective$;return(d==null?void 0:d.constructor)!==h&&((o=d==null?void 0:d._$AO)===null||o===void 0||o.call(d,!1),h===void 0?d=void 0:(d=new h(a),d._$AT(a,t,i)),i!==void 0?((s=(l=t)._$Cl)!==null&&s!==void 0?s:l._$Cl=[])[i]=d:t._$Cu=d),d!==void 0&&(e=Ye(a,d._$AS(a,e.values),d,i)),e}class Fa{constructor(e,t){this.v=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}p(e){var t;const{el:{content:i},parts:r}=this._$AD,o=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:vt).importNode(i,!0);ut.currentNode=o;let s=ut.nextNode(),l=0,d=0,h=r[0];for(;h!==void 0;){if(l===h.index){let p;h.type===2?p=new wt(s,s.nextSibling,this,e):h.type===1?p=new h.ctor(s,h.name,h.strings,this,e):h.type===6&&(p=new Pa(s,this,e)),this.v.push(p),h=r[++d]}l!==(h==null?void 0:h.index)&&(s=ut.nextNode(),l++)}return o}m(e){let t=0;for(const i of this.v)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class wt{constructor(e,t,i,r){var o;this.type=2,this._$AH=_,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=r,this._$Cg=(o=r==null?void 0:r.isConnected)===null||o===void 0||o}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cg}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&e.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Ye(this,e,t),Ut(e)?e===_||e==null||e===""?(this._$AH!==_&&this._$AR(),this._$AH=_):e!==this._$AH&&e!==ce&&this.$(e):e._$litType$!==void 0?this.T(e):e.nodeType!==void 0?this.k(e):Ea(e)?this.S(e):this.$(e)}M(e,t=this._$AB){return this._$AA.parentNode.insertBefore(e,t)}k(e){this._$AH!==e&&(this._$AR(),this._$AH=this.M(e))}$(e){this._$AH!==_&&Ut(this._$AH)?this._$AA.nextSibling.data=e:this.k(vt.createTextNode(e)),this._$AH=e}T(e){var t;const{values:i,_$litType$:r}=e,o=typeof r=="number"?this._$AC(e):(r.el===void 0&&(r.el=Ht.createElement(r.h,this.options)),r);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===o)this._$AH.m(i);else{const s=new Fa(o,this),l=s.p(this.options);s.m(i),this.k(l),this._$AH=s}}_$AC(e){let t=Zr.get(e.strings);return t===void 0&&Zr.set(e.strings,t=new Ht(e)),t}S(e){Aa(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,r=0;for(const o of e)r===t.length?t.push(i=new wt(this.M(Bt()),this.M(Bt()),this,this.options)):i=t[r],i._$AI(o),r++;r<t.length&&(this._$AR(i&&i._$AB.nextSibling,r),t.length=r)}_$AR(e=this._$AA.nextSibling,t){var i;for((i=this._$AP)===null||i===void 0||i.call(this,!1,!0,t);e&&e!==this._$AB;){const r=e.nextSibling;e.remove(),e=r}}setConnected(e){var t;this._$AM===void 0&&(this._$Cg=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}}class jt{constructor(e,t,i,r,o){this.type=1,this._$AH=_,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=o,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=_}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,i,r){const o=this.strings;let s=!1;if(o===void 0)e=Ye(this,e,t,0),s=!Ut(e)||e!==this._$AH&&e!==ce,s&&(this._$AH=e);else{const l=e;let d,h;for(e=o[0],d=0;d<o.length-1;d++)h=Ye(this,l[i+d],t,d),h===ce&&(h=this._$AH[d]),s||(s=!Ut(h)||h!==this._$AH[d]),h===_?e=_:e!==_&&(e+=(h!=null?h:"")+o[d+1]),this._$AH[d]=h}s&&!r&&this.C(e)}C(e){e===_?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e!=null?e:"")}}class Ra extends jt{constructor(){super(...arguments),this.type=3}C(e){this.element[this.name]=e===_?void 0:e}}const Vo=pt?pt.emptyScript:"";class za extends jt{constructor(){super(...arguments),this.type=4}C(e){e&&e!==_?this.element.setAttribute(this.name,Vo):this.element.removeAttribute(this.name)}}class Na extends jt{constructor(e,t,i,r,o){super(e,t,i,r,o),this.type=5}_$AI(e,t=this){var i;if((e=(i=Ye(this,e,t,0))!==null&&i!==void 0?i:_)===ce)return;const r=this._$AH,o=e===_&&r!==_||e.capture!==r.capture||e.once!==r.once||e.passive!==r.passive,s=e!==_&&(r===_||o);o&&this.element.removeEventListener(this.name,this,r),s&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,i;typeof this._$AH=="function"?this._$AH.call((i=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&i!==void 0?i:this.element,e):this._$AH.handleEvent(e)}}class Pa{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){Ye(this,e)}}const Wo={L:"$lit$",P:Ce,V:pr,I:1,N:Ia,R:Fa,j:Ea,D:Ye,H:wt,F:jt,O:za,W:Na,B:Ra,Z:Pa},Jr=window.litHtmlPolyfillSupport;Jr==null||Jr(Ht,wt),((Ri=globalThis.litHtmlVersions)!==null&&Ri!==void 0?Ri:globalThis.litHtmlVersions=[]).push("2.2.4");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var zi,Ni;class F extends nt{constructor(){super(...arguments),this.renderOptions={host:this},this._$Dt=void 0}createRenderRoot(){var e,t;const i=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=i.firstChild),i}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Dt=ti(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Dt)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Dt)===null||e===void 0||e.setConnected(!1)}render(){return ce}}F.finalized=!0,F._$litElement$=!0,(zi=globalThis.litElementHydrateSupport)===null||zi===void 0||zi.call(globalThis,{LitElement:F});const ea=globalThis.litElementPolyfillSupport;ea==null||ea({LitElement:F});((Ni=globalThis.litElementVersions)!==null&&Ni!==void 0?Ni:globalThis.litElementVersions=[]).push("3.2.0");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */const ia=(a,e,t)=>{const i=new Map;for(let r=e;r<=t;r++)i.set(a[r],r);return i},Ha=vr(class extends mr{constructor(a){if(super(a),a.type!==Me.CHILD)throw Error("repeat() can only be used in text expressions")}dt(a,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);const r=[],o=[];let s=0;for(const l of a)r[s]=i?i(l,s):s,o[s]=t(l,s),s++;return{values:o,keys:r}}render(a,e,t){return this.dt(a,e,t).values}update(a,[e,t,i]){var r;const o=Zo(a),{values:s,keys:l}=this.dt(e,t,i);if(!Array.isArray(o))return this.ut=l,s;const d=(r=this.ut)!==null&&r!==void 0?r:this.ut=[],h=[];let p,v,f=0,b=o.length-1,$=0,k=s.length-1;for(;f<=b&&$<=k;)if(o[f]===null)f++;else if(o[b]===null)b--;else if(d[f]===l[$])h[$]=He(o[f],s[$]),f++,$++;else if(d[b]===l[k])h[k]=He(o[b],s[k]),b--,k--;else if(d[f]===l[k])h[k]=He(o[f],s[k]),Ot(a,h[k+1],o[f]),f++,k--;else if(d[b]===l[$])h[$]=He(o[b],s[$]),Ot(a,o[f],o[b]),b--,$++;else if(p===void 0&&(p=ia(l,$,k),v=ia(d,f,b)),p.has(d[f]))if(p.has(d[b])){const E=v.get(l[$]),A=E!==void 0?o[E]:null;if(A===null){const R=Ot(a,o[f]);He(R,s[$]),h[$]=R}else h[$]=He(A,s[$]),Ot(a,o[f],A),o[E]=null;$++}else Bi(o[b]),b--;else Bi(o[f]),f++;for(;$<=k;){const E=Ot(a,h[k+1]);He(E,s[$]),h[$++]=E}for(;f<=b;){const E=o[f++];E!==null&&Bi(E)}return this.ut=l,Ua(a,h),ce}});function Xt(a,e,t){return Array.from({length:(e-a)/t+1},(i,r)=>a+r*t)}let Ie=class extends F{constructor(){super(...arguments),this.itemCount=0,this.scrollOptimizationsDisabled=!1,this.intersectionObserver=new IntersectionObserver(e=>{e.forEach(t=>{if(t.target===this.sentinel){t.isIntersecting&&this.dispatchEvent(new Event("scrollThresholdReached"));return}const r=t.target.dataset.cellIndex;if(!r)return;const o=parseInt(r,10);t.isIntersecting?this.visibleCellIndices.add(o):this.visibleCellIndices.delete(o)}),this.scrollOptimizationsDisabled||this.processVisibleCells()}),this.renderedCellIndices=new Set,this.visibleCellIndices=new Set,this.placeholderCellIndices=new Set}reload(){Xt(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.removeCell(t)),this.renderedCellIndices.clear(),this.visibleCellIndices.clear(),this.placeholderCellIndices.clear(),this.setupObservations()}scrollToCell(e,t){const i=this.cellContainers[e];if(!i)return!1;const r=t?"smooth":"auto";return i.scrollIntoView({behavior:r}),!0}getVisibleCellIndices(){return Array.from(this.visibleCellIndices)}updated(e){(e.has("itemCount")||e.has("scrollOptimizationsDisabled"))&&this.setupObservations()}disconnectedCallback(){this.intersectionObserver.disconnect()}setupObservations(){this.setupIntersectionObserver()}setupIntersectionObserver(){this.intersectionObserver.disconnect(),this.sentinel&&this.intersectionObserver.observe(this.sentinel),this.scrollOptimizationsDisabled?(Xt(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.visibleCellIndices.add(t)),this.processVisibleCells()):this.cellContainers.forEach(e=>this.intersectionObserver.observe(e))}render(){const e=this.itemCount-1,t=Xt(0,e,1);return m`
    ...
    `}};n([u({type:Number})],Ie.prototype,"itemCount",void 0);n([u({type:Object})],Ie.prototype,"cellProvider",void 0);n([u({type:Object})],Ie.prototype,"placeholderCellTemplate",void 0);n([u({type:Boolean})],Ie.prototype,"scrollOptimizationsDisabled",void 0);n([le("#sentinel")],Ie.prototype,"sentinel",void 0);n([Qo(".cell-container")],Ie.prototype,"cellContainers",void 0);Ie=n([H("infinite-scroller")],Ie);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Jo=(a,...e)=>({strTag:!0,strings:a,values:e}),st=Jo,es=a=>typeof a!="string"&&"strTag"in a,ts=(a,e,t)=>{let i=a[0];for(let r=1;r<a.length;r++)i+=e[t?t[r-1]:r-1],i+=a[r];return i};/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const is=a=>es(a)?ts(a.strings,a.values):a;/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let as=new rs;as.resolve();/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let We=is;const Va=L`
...
`;let ir=class extends F{render(){var e,t,i;return m`
      <div id="container">
        ...
        <div id="item-count-container">
          <div id="item-count-image-container">${Va}</div>
    ...
    `}};n([u({type:Object})],ir.prototype,"model",void 0);ir=n([H("collection-tile")],ir);function li(a,e="short",t="en-US"){if(!a)return"";const i={timeZone:"UTC"};switch(e){case"short":i.month="short",i.year="numeric";break;case"long":i.year="numeric",i.month="short",i.day="2-digit";break}return new Intl.DateTimeFormat(t,i).format(a)}/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const rr=vr(class extends mr{constructor(a){var e;if(super(a),a.type!==Me.ATTRIBUTE||a.name!=="class"||((e=a.strings)===null||e===void 0?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(a){return" "+Object.keys(a).filter(e=>a[e]).join(" ")+" "}update(a,[e]){var t,i;if(this.et===void 0){this.et=new Set,a.strings!==void 0&&(this.st=new Set(a.strings.join(" ").split(/\s/).filter(o=>o!=="")));for(const o in e)e[o]&&!(!((t=this.st)===null||t===void 0)&&t.has(o))&&this.et.add(o);return this.render(e)}const r=a.element.classList;this.et.forEach(o=>{o in e||(r.remove(o),this.et.delete(o))});for(const o in e){const s=!!e[o];s===this.et.has(o)||((i=this.st)===null||i===void 0?void 0:i.has(o))||(s?(r.add(o),this.et.add(o)):(r.remove(o),this.et.delete(o)))}return ce}}),os=L`
  <svg
    viewBox="0 0 100 100"
    xmlns="http://www.w3.org/2000/svg"
  >
...
`;let di=class extends F{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1}render(){return this.loginRequired&&!this.loggedIn?m`${ss} `:m`${os}`}static get styles(){return y`
      :host {
        position: absolute;
        top: 50%;
        left: 50%;
    ...
    `}};n([u({type:Boolean})],di.prototype,"loggedIn",void 0);n([u({type:Boolean})],di.prototype,"loginRequired",void 0);di=n([H("icon-overlay")],di);let ci=class extends F{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1}render(){return m` <div class="overlay no-preview">${this.textDisplay}</div> `}get textDisplay(){return this.loginRequired&&!this.loggedIn?`Log in
to view this item`:"Content may be inappropriate"}static get styles(){return y`
    ...
    `}};n([u({type:Boolean})],ci.prototype,"loggedIn",void 0);n([u({type:Boolean})],ci.prototype,"loginRequired",void 0);ci=n([H("text-overlay")],ci);let Fe=class extends F{constructor(){super(...arguments),this.isCompactTile=!1,this.isListTile=!1,this.loggedIn=!1,this.viewSize="desktop"}render(){var e;return!((e=this.model)===null||e===void 0)&&e.identifier?m`
      <div class=${rr(this.baseClass)}>
        <item-image
          .model=${this.model}
...
`,ws={account:{color:"#000000",icon:ds,text:"Account"},audio:{color:"#00adef",icon:cs,text:"Audio"},collection:{color:"#4666ff",icon:Va,text:"Collection"},data:{color:"#333333",icon:hs,text:"Data"},etree:{color:"#00adef",icon:us,text:"E-tree"},film:{color:"#bf1b2c",icon:ra,text:"Film"},image:{color:"#aa99c9",icon:ps,text:"Image"},movies:{color:"#f1644b",icon:ra,text:"Movie"},radio:{color:"#8fdaef",icon:vs,text:"Radio"},software:{color:"#9ecc4f",icon:ms,text:"Software"},texts:{color:"#faab3c",icon:gs,text:"Text"},tv:{color:"#f1644b",icon:fs,text:"TV"},video:{color:"#f1644b",icon:ys,text:"Video"},web:{color:"#ffcd27",icon:bs,text:"Web"}};let Wt=class extends F{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var e,t;const i=["tvnews","tvarchive","television"],r=["radio","radioprogram"];return this.mediatype==="movies"&&((e=this.collections)===null||e===void 0?void 0:e.some(o=>i.indexOf(o)>=0))?"tv":this.mediatype==="audio"&&((t=this.collections)===null||t===void 0?void 0:t.some(o=>r.indexOf(o)>=0))?"radio":this.mediatype||""}render(){const e=ws[this.displayMediatype];return e?m`
      <div
        id="icon"
    ...
    `}};n([u({type:String})],Wt.prototype,"mediatype",void 0);n([u({type:Array})],Wt.prototype,"collections",void 0);n([u({type:Boolean})],Wt.prototype,"showText",void 0);Wt=n([H("mediatype-icon")],Wt);const Ss=L`
...
`;function _s(a,e){let t=1;return a>=1e9?t=1e9:a>=1e6?t=1e6:a>=1e3&&e==="short"&&(t=1e3),t}function ks(a=0,e){const t=a/e,i=t<10;let r=0;return i?r=Math.round((t+Number.EPSILON)*10)/10:r=Math.round(t),r}function Ts(a,e,t,i){switch(e){case 1e9:return We(t==="short"?st`${a}B`:st`${a} billion`);case 1e6:return We(t==="short"?st`${a}M`:st`${a} million`);case 1e3:return We(t==="short"?st`${a}K`:st`${a} thousand`);default:return new Intl.NumberFormat(i).format(a)}}function Rt(a,e="long",t="short",i="en-US"){const r=a!=null?a:-1;if(r<0)return"";const o=_s(r,e),s=ks(r,o);return Ts(s,o,t,i)}let Ke=class extends F{render(){return m`
    ...
    `}};n([u({type:String})],mt.prototype,"baseImageUrl",void 0);n([u({type:Boolean})],mt.prototype,"loggedIn",void 0);n([u({type:Object})],mt.prototype,"model",void 0);n([u({type:Object})],mt.prototype,"sortParam",void 0);mt=n([H("item-tile")],mt);let ar=class extends F{render(){var e,t,i,r,o,s,l,d;return m`
    ...
    `}};n([u({type:Object})],ar.prototype,"model",void 0);ar=n([H("account-tile")],ar);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*aa(a,e){if(a!==void 0){let t=0;for(const i of a)yield e(i,t++)}}/*! @license DOMPurify 2.3.8 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/2.3.8/LICENSE */function je(a){return je=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},je(a)}function or(a,e){return or=Object.setPrototypeOf||function(i,r){return i.__proto__=r,i},or(a,e)}function Ds(){if(typeof Reflect=="undefined"||!Reflect.construct||Reflect.construct.sham)return!1;if(typeof Proxy=="function")return!0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],function(){})),!0}catch{return!1}}function ii(a,e,t){return Ds()?ii=Reflect.construct:ii=function(r,o,s){var l=[null];l.push.apply(l,o);var d=Function.bind.apply(r,l),h=new d;return s&&or(h,s.prototype),h},ii.apply(null,arguments)}function ue(a){return Ms(a)||As(a)||Es(a)||Os()}function Ms(a){if(Array.isArray(a))return sr(a)}function As(a){if(typeof Symbol!="undefined"&&a[Symbol.iterator]!=null||a["@@iterator"]!=null)return Array.from(a)}function Es(a,e){if(!!a){if(typeof a=="string")return sr(a,e);var t=Object.prototype.toString.call(a).slice(8,-1);if(t==="Object"&&a.constructor&&(t=a.constructor.name),t==="Map"||t==="Set")return Array.from(a);if(t==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t))return sr(a,e)}}function sr(a,e){(e==null||e>a.length)&&(e=a.length);for(var t=0,i=new Array(e);t<e;t++)i[t]=a[t];return i}function Os(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}var Ls=Object.hasOwnProperty,oa=Object.setPrototypeOf,Is=Object.isFrozen,Fs=Object.getPrototypeOf,Rs=Object.getOwnPropertyDescriptor,ee=Object.freeze,be=Object.seal,zs=Object.create,Wa=typeof Reflect!="undefined"&&Reflect,hi=Wa.apply,nr=Wa.construct;hi||(hi=function(e,t,i){return e.apply(t,i)});ee||(ee=function(e){return e});be||(be=function(e){return e});nr||(nr=function(e,t){return ii(e,ue(t))});var Ns=ve(Array.prototype.forEach),sa=ve(Array.prototype.pop),Lt=ve(Array.prototype.push),ri=ve(String.prototype.toLowerCase),Ps=ve(String.prototype.match),De=ve(String.prototype.replace),Bs=ve(String.prototype.indexOf),Us=ve(String.prototype.trim),J=ve(RegExp.prototype.test),Hi=Hs(TypeError);function ve(a){return function(e){for(var t=arguments.length,i=new Array(t>1?t-1:0),r=1;r<t;r++)i[r-1]=arguments[r];return hi(a,e,i)}}function Hs(a){return function(){for(var e=arguments.length,t=new Array(e),i=0;i<e;i++)t[i]=arguments[i];return nr(a,t)}}function M(a,e){oa&&oa(a,null);for(var t=e.length;t--;){var i=e[t];if(typeof i=="string"){var r=ri(i);r!==i&&(Is(e)||(e[t]=r),i=r)}a[i]=!0}return a}function Ve(a){var e=zs(null),t;for(t in a)hi(Ls,a,[t])&&(e[t]=a[t]);return e}function Zt(a,e){for(;a!==null;){var t=Rs(a,e);if(t){if(t.get)return ve(t.get);if(typeof t.value=="function")return ve(t.value)}a=Fs(a)}function i(r){return console.warn("fallback value for",r),null}return i}var na=ee(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","section","select","shadow","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),Vi=ee(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","filter","font","g","glyph","glyphref","hkern","image","line","lineargradient","marker","mask","metadata","mpath","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),Wi=ee(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),Vs=ee(["animate","color-profile","cursor","discard","fedropshadow","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),ji=ee(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover"]),Ws=ee(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),la=ee(["#text"]),da=ee(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","face","for","headers","height","hidden","high","href","hreflang","id","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","pattern","placeholder","playsinline","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","xmlns","slot"]),Qi=ee(["accent-height","accumulate","additive","alignment-baseline","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),ca=ee(["accent","accentunder","align","bevelled","close","columnsalign","columnlines","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lspace","lquote","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),Jt=ee(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),js=be(/\{\{[\w\W]*|[\w\W]*\}\}/gm),Qs=be(/<%[\w\W]*|[\w\W]*%>/gm),Gs=be(/^data-[\-\w.\u00B7-\uFFFF]/),Ys=be(/^aria-[\-\w]+$/),Ks=be(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|cid|xmpp):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),qs=be(/^(?:\w+script|data):/i),Xs=be(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),Zs=be(/^html$/i),Js=function(){return typeof window=="undefined"?null:window},en=function(e,t){if(je(e)!=="object"||typeof e.createPolicy!="function")return null;var i=null,r="data-tt-policy-suffix";t.currentScript&&t.currentScript.hasAttribute(r)&&(i=t.currentScript.getAttribute(r));var o="dompurify"+(i?"#"+i:"");try{return e.createPolicy(o,{createHTML:function(l){return l}})}catch{return console.warn("TrustedTypes policy "+o+" could not be created."),null}};function ja(){var a=arguments.length>0&&arguments[0]!==void 0?arguments[0]:Js(),e=function(c){return ja(c)};if(e.version="2.3.8",e.removed=[],!a||!a.document||a.document.nodeType!==9)return e.isSupported=!1,e;var t=a.document,i=a.document,r=a.DocumentFragment,o=a.HTMLTemplateElement,s=a.Node,l=a.Element,d=a.NodeFilter,h=a.NamedNodeMap,p=h===void 0?a.NamedNodeMap||a.MozNamedAttrMap:h,v=a.HTMLFormElement,f=a.DOMParser,b=a.trustedTypes,$=l.prototype,k=Zt($,"cloneNode"),E=Zt($,"nextSibling"),A=Zt($,"childNodes"),R=Zt($,"parentNode");if(typeof o=="function"){var I=i.createElement("template");I.content&&I.content.ownerDocument&&(i=I.content.ownerDocument)}var N=en(b,t),Y=N?N.createHTML(""):"",se=i,ge=se.implementation,St=se.createNodeIterator,$t=se.createDocumentFragment,xt=se.getElementsByTagName,Ct=t.importNode,qe={};try{qe=Ve(i).documentMode?i.documentMode:{}}catch{}var te={};e.isSupported=typeof R=="function"&&ge&&typeof ge.createHTMLDocument!="undefined"&&qe!==9;var Re=js,ze=Qs,_t=Gs,kt=Ys,Tt=qs,Xe=Xs,Ne=Ks,W=null,Ze=M({},[].concat(ue(na),ue(Vi),ue(Wi),ue(ji),ue(la))),j=null,Je=M({},[].concat(ue(da),ue(Qi),ue(ca),ue(Jt))),U=Object.seal(Object.create(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),ke=null,wi=null,Sr=!0,Si=!0,$r=!1,et=!1,Pe=!1,$i=!1,xi=!1,tt=!1,Qt=!1,Gt=!1,xr=!0,Ci=!0,Dt=!1,it={},rt=null,Cr=M({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","style","svg","template","thead","title","video","xmp"]),_r=null,kr=M({},["audio","video","img","source","image","track"]),_i=null,Tr=M({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),ki="http://www.w3.org/1998/Math/MathML",Ti="http://www.w3.org/2000/svg",Te="http://www.w3.org/1999/xhtml",Yt=Te,Di=!1,at,ao=["application/xhtml+xml","text/html"],oo="text/html",Be,ot=null,so=i.createElement("form"),Dr=function(c){return c instanceof RegExp||c instanceof Function},Mi=function(c){ot&&ot===c||((!c||je(c)!=="object")&&(c={}),c=Ve(c),W="ALLOWED_TAGS"in c?M({},c.ALLOWED_TAGS):Ze,j="ALLOWED_ATTR"in c?M({},c.ALLOWED_ATTR):Je,_i="ADD_URI_SAFE_ATTR"in c?M(Ve(Tr),c.ADD_URI_SAFE_ATTR):Tr,_r="ADD_DATA_URI_TAGS"in c?M(Ve(kr),c.ADD_DATA_URI_TAGS):kr,rt="FORBID_CONTENTS"in c?M({},c.FORBID_CONTENTS):Cr,ke="FORBID_TAGS"in c?M({},c.FORBID_TAGS):{},wi="FORBID_ATTR"in c?M({},c.FORBID_ATTR):{},it="USE_PROFILES"in c?c.USE_PROFILES:!1,Sr=c.ALLOW_ARIA_ATTR!==!1,Si=c.ALLOW_DATA_ATTR!==!1,$r=c.ALLOW_UNKNOWN_PROTOCOLS||!1,et=c.SAFE_FOR_TEMPLATES||!1,Pe=c.WHOLE_DOCUMENT||!1,tt=c.RETURN_DOM||!1,Qt=c.RETURN_DOM_FRAGMENT||!1,Gt=c.RETURN_TRUSTED_TYPE||!1,xi=c.FORCE_BODY||!1,xr=c.SANITIZE_DOM!==!1,Ci=c.KEEP_CONTENT!==!1,Dt=c.IN_PLACE||!1,Ne=c.ALLOWED_URI_REGEXP||Ne,Yt=c.NAMESPACE||Te,c.CUSTOM_ELEMENT_HANDLING&&Dr(c.CUSTOM_ELEMENT_HANDLING.tagNameCheck)&&(U.tagNameCheck=c.CUSTOM_ELEMENT_HANDLING.tagNameCheck),c.CUSTOM_ELEMENT_HANDLING&&Dr(c.CUSTOM_ELEMENT_HANDLING.attributeNameCheck)&&(U.attributeNameCheck=c.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),c.CUSTOM_ELEMENT_HANDLING&&typeof c.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements=="boolean"&&(U.allowCustomizedBuiltInElements=c.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements),at=ao.indexOf(c.PARSER_MEDIA_TYPE)===-1?at=oo:at=c.PARSER_MEDIA_TYPE,Be=at==="application/xhtml+xml"?function(g){return g}:ri,et&&(Si=!1),Qt&&(tt=!0),it&&(W=M({},ue(la)),j=[],it.html===!0&&(M(W,na),M(j,da)),it.svg===!0&&(M(W,Vi),M(j,Qi),M(j,Jt)),it.svgFilters===!0&&(M(W,Wi),M(j,Qi),M(j,Jt)),it.mathMl===!0&&(M(W,ji),M(j,ca),M(j,Jt))),c.ADD_TAGS&&(W===Ze&&(W=Ve(W)),M(W,c.ADD_TAGS)),c.ADD_ATTR&&(j===Je&&(j=Ve(j)),M(j,c.ADD_ATTR)),c.ADD_URI_SAFE_ATTR&&M(_i,c.ADD_URI_SAFE_ATTR),c.FORBID_CONTENTS&&(rt===Cr&&(rt=Ve(rt)),M(rt,c.FORBID_CONTENTS)),Ci&&(W["#text"]=!0),Pe&&M(W,["html","head","body"]),W.table&&(M(W,["tbody"]),delete ke.tbody),ee&&ee(c),ot=c)},Mr=M({},["mi","mo","mn","ms","mtext"]),Ar=M({},["foreignobject","desc","title","annotation-xml"]),no=M({},["title","style","font","a","script"]),Kt=M({},Vi);M(Kt,Wi),M(Kt,Vs);var Ai=M({},ji);M(Ai,Ws);var lo=function(c){var g=R(c);(!g||!g.tagName)&&(g={namespaceURI:Te,tagName:"template"});var S=ri(c.tagName),z=ri(g.tagName);return c.namespaceURI===Ti?g.namespaceURI===Te?S==="svg":g.namespaceURI===ki?S==="svg"&&(z==="annotation-xml"||Mr[z]):Boolean(Kt[S]):c.namespaceURI===ki?g.namespaceURI===Te?S==="math":g.namespaceURI===Ti?S==="math"&&Ar[z]:Boolean(Ai[S]):c.namespaceURI===Te?g.namespaceURI===Ti&&!Ar[z]||g.namespaceURI===ki&&!Mr[z]?!1:!Ai[S]&&(no[S]||!Kt[S]):!1},Se=function(c){Lt(e.removed,{element:c});try{c.parentNode.removeChild(c)}catch{try{c.outerHTML=Y}catch{c.remove()}}},Er=function(c,g){try{Lt(e.removed,{attribute:g.getAttributeNode(c),from:g})}catch{Lt(e.removed,{attribute:null,from:g})}if(g.removeAttribute(c),c==="is"&&!j[c])if(tt||Qt)try{Se(g)}catch{}else try{g.setAttribute(c,"")}catch{}},Or=function(c){var g,S;if(xi)c="<remove></remove>"+c;else{var z=Ps(c,/^[\r\n\t ]+/);S=z&&z[0]}at==="application/xhtml+xml"&&(c='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+c+"</body></html>");var ie=N?N.createHTML(c):c;if(Yt===Te)try{g=new f().parseFromString(ie,at)}catch{}if(!g||!g.documentElement){g=ge.createDocument(Yt,"template",null);try{g.documentElement.innerHTML=Di?"":ie}catch{}}var X=g.body||g.documentElement;return c&&S&&X.insertBefore(i.createTextNode(S),X.childNodes[0]||null),Yt===Te?xt.call(g,Pe?"html":"body")[0]:Pe?g.documentElement:X},Lr=function(c){return St.call(c.ownerDocument||c,c,d.SHOW_ELEMENT|d.SHOW_COMMENT|d.SHOW_TEXT,null,!1)},co=function(c){return c instanceof v&&(typeof c.nodeName!="string"||typeof c.textContent!="string"||typeof c.removeChild!="function"||!(c.attributes instanceof p)||typeof c.removeAttribute!="function"||typeof c.setAttribute!="function"||typeof c.namespaceURI!="string"||typeof c.insertBefore!="function")},Mt=function(c){return je(s)==="object"?c instanceof s:c&&je(c)==="object"&&typeof c.nodeType=="number"&&typeof c.nodeName=="string"},$e=function(c,g,S){!te[c]||Ns(te[c],function(z){z.call(e,g,S,ot)})},Ir=function(c){var g;if($e("beforeSanitizeElements",c,null),co(c)||J(/[\u0080-\uFFFF]/,c.nodeName))return Se(c),!0;var S=Be(c.nodeName);if($e("uponSanitizeElement",c,{tagName:S,allowedTags:W}),c.hasChildNodes()&&!Mt(c.firstElementChild)&&(!Mt(c.content)||!Mt(c.content.firstElementChild))&&J(/<[/\w]/g,c.innerHTML)&&J(/<[/\w]/g,c.textContent)||S==="select"&&J(/<template/i,c.innerHTML))return Se(c),!0;if(!W[S]||ke[S]){if(!ke[S]&&Rr(S)&&(U.tagNameCheck instanceof RegExp&&J(U.tagNameCheck,S)||U.tagNameCheck instanceof Function&&U.tagNameCheck(S)))return!1;if(Ci&&!rt[S]){var z=R(c)||c.parentNode,ie=A(c)||c.childNodes;if(ie&&z)for(var X=ie.length,K=X-1;K>=0;--K)z.insertBefore(k(ie[K],!0),E(c))}return Se(c),!0}return c instanceof l&&!lo(c)||(S==="noscript"||S==="noembed")&&J(/<\/no(script|embed)/i,c.innerHTML)?(Se(c),!0):(et&&c.nodeType===3&&(g=c.textContent,g=De(g,Re," "),g=De(g,ze," "),c.textContent!==g&&(Lt(e.removed,{element:c.cloneNode()}),c.textContent=g)),$e("afterSanitizeElements",c,null),!1)},Fr=function(c,g,S){if(xr&&(g==="id"||g==="name")&&(S in i||S in so))return!1;if(!(Si&&!wi[g]&&J(_t,g))){if(!(Sr&&J(kt,g))){if(!j[g]||wi[g]){if(!(Rr(c)&&(U.tagNameCheck instanceof RegExp&&J(U.tagNameCheck,c)||U.tagNameCheck instanceof Function&&U.tagNameCheck(c))&&(U.attributeNameCheck instanceof RegExp&&J(U.attributeNameCheck,g)||U.attributeNameCheck instanceof Function&&U.attributeNameCheck(g))||g==="is"&&U.allowCustomizedBuiltInElements&&(U.tagNameCheck instanceof RegExp&&J(U.tagNameCheck,S)||U.tagNameCheck instanceof Function&&U.tagNameCheck(S))))return!1}else if(!_i[g]){if(!J(Ne,De(S,Xe,""))){if(!((g==="src"||g==="xlink:href"||g==="href")&&c!=="script"&&Bs(S,"data:")===0&&_r[c])){if(!($r&&!J(Tt,De(S,Xe,"")))){if(S)return!1}}}}}}return!0},Rr=function(c){return c.indexOf("-")>0},zr=function(c){var g,S,z,ie;$e("beforeSanitizeAttributes",c,null);var X=c.attributes;if(!!X){var K={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:j};for(ie=X.length;ie--;){g=X[ie];var qt=g,Z=qt.name,Nr=qt.namespaceURI;if(S=Z==="value"?g.value:Us(g.value),z=Be(Z),K.attrName=z,K.attrValue=S,K.keepAttr=!0,K.forceKeepAttr=void 0,$e("uponSanitizeAttribute",c,K),S=K.attrValue,!K.forceKeepAttr&&(Er(Z,c),!!K.keepAttr)){if(J(/\/>/i,S)){Er(Z,c);continue}et&&(S=De(S,Re," "),S=De(S,ze," "));var uo=Be(c.nodeName);if(!!Fr(uo,z,S))try{Nr?c.setAttributeNS(Nr,Z,S):c.setAttribute(Z,S),sa(e.removed)}catch{}}}$e("afterSanitizeAttributes",c,null)}},ho=function C(c){var g,S=Lr(c);for($e("beforeSanitizeShadowDOM",c,null);g=S.nextNode();)$e("uponSanitizeShadowNode",g,null),!Ir(g)&&(g.content instanceof r&&C(g.content),zr(g));$e("afterSanitizeShadowDOM",c,null)};return e.sanitize=function(C,c){var g,S,z,ie,X;if(Di=!C,Di&&(C="<!-->"),typeof C!="string"&&!Mt(C)){if(typeof C.toString!="function")throw Hi("toString is not a function");if(C=C.toString(),typeof C!="string")throw Hi("dirty is not a string, aborting")}if(!e.isSupported){if(je(a.toStaticHTML)==="object"||typeof a.toStaticHTML=="function"){if(typeof C=="string")return a.toStaticHTML(C);if(Mt(C))return a.toStaticHTML(C.outerHTML)}return C}if($i||Mi(c),e.removed=[],typeof C=="string"&&(Dt=!1),Dt){if(C.nodeName){var K=Be(C.nodeName);if(!W[K]||ke[K])throw Hi("root node is forbidden and cannot be sanitized in-place")}}else if(C instanceof s)g=Or("<!---->"),S=g.ownerDocument.importNode(C,!0),S.nodeType===1&&S.nodeName==="BODY"||S.nodeName==="HTML"?g=S:g.appendChild(S);else{if(!tt&&!et&&!Pe&&C.indexOf("<")===-1)return N&&Gt?N.createHTML(C):C;if(g=Or(C),!g)return tt?null:Gt?Y:""}g&&xi&&Se(g.firstChild);for(var qt=Lr(Dt?C:g);z=qt.nextNode();)z.nodeType===3&&z===ie||Ir(z)||(z.content instanceof r&&ho(z.content),zr(z),ie=z);if(ie=null,Dt)return C;if(tt){if(Qt)for(X=$t.call(g.ownerDocument);g.firstChild;)X.appendChild(g.firstChild);else X=g;return j.shadowroot&&(X=Ct.call(t,X,!0)),X}var Z=Pe?g.outerHTML:g.innerHTML;return Pe&&W["!doctype"]&&g.ownerDocument&&g.ownerDocument.doctype&&g.ownerDocument.doctype.name&&J(Zs,g.ownerDocument.doctype.name)&&(Z="<!DOCTYPE "+g.ownerDocument.doctype.name+`>
`+Z),et&&(Z=De(Z,Re," "),Z=De(Z,ze," ")),N&&Gt?N.createHTML(Z):Z},e.setConfig=function(C){Mi(C),$i=!0},e.clearConfig=function(){ot=null,$i=!1},e.isValidAttribute=function(C,c,g){ot||Mi({});var S=Be(C),z=Be(c);return Fr(S,z,g)},e.addHook=function(C,c){typeof c=="function"&&(te[C]=te[C]||[],Lt(te[C],c))},e.removeHook=function(C){if(te[C])return sa(te[C])},e.removeHooks=function(C){te[C]&&(te[C]=[])},e.removeAllHooks=function(){te={}},e}var zt=ja();function Qa(a){switch(a){case"date":return"Published";case"reviewdate":return"Reviewed";case"addeddate":return"Added";default:return"Archived"}}function Ga(a){return a?`Archivist since ${a.getFullYear()}`:""}let he=class extends F{constructor(){super(...arguments),this.sortParam=null,this.collectionLinks=[],this.loggedIn=!1}updated(e){e.has("model")&&this.fetchCollectionNames()}async fetchCollectionNames(){var e,t;if(!(!((e=this.model)===null||e===void 0)&&e.collections)||this.model.collections.length===0||!this.collectionNameCache)return;this.collectionLinks=[];const i=[],r=[];for(const o of this.model.collections)r.push((t=this.collectionNameCache)===null||t===void 0?void 0:t.collectionNameFor(o).then(s=>{i.push(this.detailsLink(o,s!=null?s:o))}));await Promise.all(r),this.collectionLinks=i}render(){return m`
    ...
    `}get descriptionTemplate(){var e,t;return this.metadataTemplate(zt.sanitize((t=(e=this.model)===null||e===void 0?void 0:e.description)!==null&&t!==void 0?t:""),"","description")}metadataTemplate(e,t="",i){return e?m`
    ...
    `}};n([u({type:Object})],he.prototype,"model",void 0);n([u({type:String})],he.prototype,"baseNavigationUrl",void 0);n([u({type:Object})],he.prototype,"collectionNameCache",void 0);n([u({type:Number})],he.prototype,"currentWidth",void 0);n([u({type:Number})],he.prototype,"currentHeight",void 0);n([u({type:Object})],he.prototype,"sortParam",void 0);n([u({type:Number})],he.prototype,"mobileBreakpoint",void 0);n([D()],he.prototype,"collectionLinks",void 0);n([u({type:String})],he.prototype,"baseImageUrl",void 0);n([u({type:Boolean})],he.prototype,"loggedIn",void 0);he=n([H("tile-list")],he);let we=class extends F{constructor(){super(...arguments),this.sortParam=null,this.loggedIn=!1}render(){var e,t,i,r,o,s,l,d,h,p;return m`
      <div id="list-line" class="${this.classSize}">
        <image-block
          .model=${this.model}
          .baseImageUrl=${this.baseImageUrl}
        ...
        <div id="creator">
          ${((i=this.model)===null||i===void 0?void 0:i.mediatype)==="account"?Ga((r=this.model)===null||r===void 0?void 0:r.dateAdded):zt.sanitize((s=(o=this.model)===null||o===void 0?void 0:o.creator)!==null&&s!==void 0?s:"")}
        </div>
        ...
        <div id="views">
          ${Rt((p=(h=this.model)===null||h===void 0?void 0:h.viewCount)!==null&&p!==void 0?p:0,this.formatSize)}
        </div>
      </div>
    `}get date(){var e,t,i,r,o;switch((e=this.sortParam)===null||e===void 0?void 0:e.field){case"date":return(t=this.model)===null||t===void 0?void 0:t.datePublished;case"reviewdate":return(i=this.model)===null||i===void 0?void 0:i.dateReviewed;case"addeddate":return(r=this.model)===null||r===void 0?void 0:r.dateAdded;default:return(o=this.model)===null||o===void 0?void 0:o.dateArchived}}get classSize(){return this.mobileBreakpoint&&this.currentWidth&&this.currentWidth<this.mobileBreakpoint?"mobile":"desktop"}get formatSize(){return this.mobileBreakpoint&&this.currentWidth&&this.currentWidth<this.mobileBreakpoint?"short":"long"}static get styles(){return y`
      html {
    ...
    `}};n([u({type:Object})],we.prototype,"model",void 0);n([u({type:String})],we.prototype,"baseNavigationUrl",void 0);n([u({type:Number})],we.prototype,"currentWidth",void 0);n([u({type:Number})],we.prototype,"currentHeight",void 0);n([u({type:Object})],we.prototype,"sortParam",void 0);n([u({type:Number})],we.prototype,"mobileBreakpoint",void 0);n([u({type:String})],we.prototype,"baseImageUrl",void 0);n([u({type:Boolean})],we.prototype,"loggedIn",void 0);we=n([H("tile-list-compact")],we);let gt=class extends F{constructor(){super(...arguments),this.sortParam=null}render(){var e;return m`
    ...
    `}};n([u({type:Object})],gt.prototype,"model",void 0);n([u({type:Number})],gt.prototype,"currentWidth",void 0);n([u({type:Object})],gt.prototype,"sortParam",void 0);n([u({type:Number})],gt.prototype,"mobileBreakpoint",void 0);gt=n([H("tile-list-compact-header")],gt);let ae=class extends F{constructor(){super(...arguments),this.sortParam=null,this.loggedIn=!1}render(){return m`
      <div id="container">
    ...
    `}get linkTileTemplate(){var e,t;return m`
      <a
        ...
        title=${yi((t=this.model)===null||t===void 0?void 0:t.title)}
      >
        ${this.tile}
      </a>
    ...
    `}};n([u({type:String})],ae.prototype,"tileDisplayMode",void 0);n([u({type:Object})],ae.prototype,"model",void 0);n([u({type:String})],ae.prototype,"baseNavigationUrl",void 0);n([u({type:Number})],ae.prototype,"currentWidth",void 0);n([u({type:Number})],ae.prototype,"currentHeight",void 0);n([u({type:Object})],ae.prototype,"resizeObserver",void 0);n([u({type:Object})],ae.prototype,"collectionNameCache",void 0);n([u({type:Object})],ae.prototype,"sortParam",void 0);n([le("#container")],ae.prototype,"container",void 0);n([u({type:Number})],ae.prototype,"mobileBreakpoint",void 0);n([u({type:String})],ae.prototype,"baseImageUrl",void 0);n([u({type:Boolean})],ae.prototype,"loggedIn",void 0);ae=n([H("tile-dispatcher")],ae);let ha=class extends F{render(){return m` <div id="container"></div> `}static get styles(){return y`
      :host {
        display: block;
        height: 100%;
      }
    ...
    `}};ha=n([H("collection-browser-loading-tile")],ha);var O;(function(a){a.relevance="relevance",a.views="views",a.title="title",a.datearchived="datearchived",a.date="date",a.datereviewed="datereviewed",a.dateadded="dateadded",a.creator="creator"})(O||(O={}));const It={relevance:"Relevance",views:"Views",title:"Title",datearchived:"Date Archived",date:"Date Published",datereviewed:"Date Reviewed",dateadded:"Date Added",creator:"Creator"},tn={relevance:null,views:"week",title:"titleSorter",datearchived:"publicdate",date:"date",datereviewed:"reviewdate",dateadded:"addeddate",creator:"creatorSorter"},ua={titleSorter:O.title,date:O.date,publicdate:O.datearchived,reviewdate:O.datereviewed,addeddate:O.dateadded,creatorSorter:O.creator,week:O.views},ui={subject:{},mediatype:{},language:{},creator:{},collection:{},year:{}};let pi=class extends F{constructor(){super(...arguments),this.selectedLetter=null,this.alphabet="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("")}get selectedUppercaseLetter(){var e;return(e=this.selectedLetter)===null||e===void 0?void 0:e.toUpperCase()}render(){return m`
      <div id="container">
        <ul>
    ...
    `}letterClicked(e){e===this.selectedUppercaseLetter?this.selectedLetter=null:this.selectedLetter=e,this.dispatchEvent(new CustomEvent("letterChanged",{detail:{selectedLetter:this.selectedUppercaseLetter}}))}};pi.styles=y`
    h1 {
      font-size: 1.2rem;
    }
  ...
  `;n([u({type:String})],pi.prototype,"selectedLetter",void 0);pi=n([H("alpha-bar")],pi);const pa=L`
...
`;let q=class extends F{constructor(){super(...arguments),this.sortDirection=null,this.selectedSort=O.relevance,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.showRelevance=!0,this.alphaSelectorVisible=null,this.dateSortSelectorVisible=!1,this.desktopSelectorBarWidth=0,this.selectorBarContainerWidth=0,this.hoveringOverDateSortOptions=!1,this.boundDateSelectorEscapeListener=e=>{e.key==="Escape"&&(this.dateSortSelectorVisible=!1)}}render(){return m`
    ...
    `}getSortDisplayOption(e,t){var i,r;const o=(i=t==null?void 0:t.isSelected)!==null&&i!==void 0?i:()=>this.selectedSort===e,s=(r=t==null?void 0:t.displayName)!==null&&r!==void 0?r:It[e];return m`
      <a
        href="#"
  ...
  `;n([u({type:String})],q.prototype,"displayMode",void 0);n([u({type:String})],q.prototype,"sortDirection",void 0);n([u({type:String})],q.prototype,"selectedSort",void 0);n([u({type:String})],q.prototype,"selectedTitleFilter",void 0);n([u({type:String})],q.prototype,"selectedCreatorFilter",void 0);n([u({type:Boolean})],q.prototype,"showRelevance",void 0);n([u({type:Object})],q.prototype,"resizeObserver",void 0);n([D()],q.prototype,"alphaSelectorVisible",void 0);n([D()],q.prototype,"dateSortSelectorVisible",void 0);n([D()],q.prototype,"desktopSelectorBarWidth",void 0);n([D()],q.prototype,"selectorBarContainerWidth",void 0);n([D()],q.prototype,"hoveringOverDateSortOptions",void 0);n([le("#desktop-sort-selector")],q.prototype,"desktopSortSelector",void 0);n([le("#sort-selector-container")],q.prototype,"sortSelectorContainer",void 0);q=n([H("sort-filter-bar")],q);/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const va=vr(class extends mr{constructor(a){if(super(a),a.type!==Me.PROPERTY&&a.type!==Me.ATTRIBUTE&&a.type!==Me.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!qo(a))throw Error("`live` bindings can only contain a single expression")}render(a){return a}update(a,[e]){if(e===ce||e===_)return e;const t=a.element,i=a.name;if(a.type===Me.PROPERTY){if(e===t[i])return ce}else if(a.type===Me.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(i))return ce}else if(a.type===Me.ATTRIBUTE&&t.getAttribute(i)===e+"")return ce;return Ua(a),e}});var Ya=60,Ka=Ya*60,qa=Ka*24,sn=qa*7,ft=1e3,Gi=Ya*ft,ma=Ka*ft,nn=qa*ft,ln=sn*ft,gr="millisecond",lt="second",dt="minute",ct="hour",Ae="day",ai="week",pe="month",Xa="quarter",Ee="year",ht="date",dn="YYYY-MM-DDTHH:mm:ssZ",ga="Invalid Date",cn=/^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/,hn=/\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g,un={name:"en",weekdays:"Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),months:"January_February_March_April_May_June_July_August_September_October_November_December".split("_")},lr=function(e,t,i){var r=String(e);return!r||r.length>=t?e:""+Array(t+1-r.length).join(i)+e},pn=function(e){var t=-e.utcOffset(),i=Math.abs(t),r=Math.floor(i/60),o=i%60;return(t<=0?"+":"-")+lr(r,2,"0")+":"+lr(o,2,"0")},vn=function a(e,t){if(e.date()<t.date())return-a(t,e);var i=(t.year()-e.year())*12+(t.month()-e.month()),r=e.clone().add(i,pe),o=t-r<0,s=e.clone().add(i+(o?-1:1),pe);return+(-(i+(t-r)/(o?r-s:s-r))||0)},mn=function(e){return e<0?Math.ceil(e)||0:Math.floor(e)},gn=function(e){var t={M:pe,y:Ee,w:ai,d:Ae,D:ht,h:ct,m:dt,s:lt,ms:gr,Q:Xa};return t[e]||String(e||"").toLowerCase().replace(/s$/,"")},fn=function(e){return e===void 0},yn={s:lr,z:pn,m:vn,a:mn,p:gn,u:fn},Nt="en",Ge={};Ge[Nt]=un;var fr=function(e){return e instanceof bi},vi=function a(e,t,i){var r;if(!e)return Nt;if(typeof e=="string"){var o=e.toLowerCase();Ge[o]&&(r=o),t&&(Ge[o]=t,r=o);var s=e.split("-");if(!r&&s.length>1)return a(s[0])}else{var l=e.name;Ge[l]=e,r=l}return!i&&r&&(Nt=r),r||!i&&Nt},G=function(e,t){if(fr(e))return e.clone();var i=typeof t=="object"?t:{};return i.date=e,i.args=arguments,new bi(i)},bn=function(e,t){return G(e,{locale:t.$L,utc:t.$u,x:t.$x,$offset:t.$offset})},P=yn;P.l=vi;P.i=fr;P.w=bn;var wn=function(e){var t=e.date,i=e.utc;if(t===null)return new Date(NaN);if(P.u(t))return new Date;if(t instanceof Date)return new Date(t);if(typeof t=="string"&&!/Z$/i.test(t)){var r=t.match(cn);if(r){var o=r[2]-1||0,s=(r[7]||"0").substring(0,3);return i?new Date(Date.UTC(r[1],o,r[3]||1,r[4]||0,r[5]||0,r[6]||0,s)):new Date(r[1],o,r[3]||1,r[4]||0,r[5]||0,r[6]||0,s)}}return new Date(t)},bi=function(){function a(t){this.$L=vi(t.locale,null,!0),this.parse(t)}var e=a.prototype;return e.parse=function(i){this.$d=wn(i),this.$x=i.x||{},this.init()},e.init=function(){var i=this.$d;this.$y=i.getFullYear(),this.$M=i.getMonth(),this.$D=i.getDate(),this.$W=i.getDay(),this.$H=i.getHours(),this.$m=i.getMinutes(),this.$s=i.getSeconds(),this.$ms=i.getMilliseconds()},e.$utils=function(){return P},e.isValid=function(){return this.$d.toString()!==ga},e.isSame=function(i,r){var o=G(i);return this.startOf(r)<=o&&o<=this.endOf(r)},e.isAfter=function(i,r){return G(i)<this.startOf(r)},e.isBefore=function(i,r){return this.endOf(r)<G(i)},e.$g=function(i,r,o){return P.u(i)?this[r]:this.set(o,i)},e.unix=function(){return Math.floor(this.valueOf()/1e3)},e.valueOf=function(){return this.$d.getTime()},e.startOf=function(i,r){var o=this,s=P.u(r)?!0:r,l=P.p(i),d=function(A,R){var I=P.w(o.$u?Date.UTC(o.$y,R,A):new Date(o.$y,R,A),o);return s?I:I.endOf(Ae)},h=function(A,R){var I=[0,0,0,0],N=[23,59,59,999];return P.w(o.toDate()[A].apply(o.toDate("s"),(s?I:N).slice(R)),o)},p=this.$W,v=this.$M,f=this.$D,b="set"+(this.$u?"UTC":"");switch(l){case Ee:return s?d(1,0):d(31,11);case pe:return s?d(1,v):d(0,v+1);case ai:{var $=this.$locale().weekStart||0,k=(p<$?p+7:p)-$;return d(s?f-k:f+(6-k),v)}case Ae:case ht:return h(b+"Hours",0);case ct:return h(b+"Minutes",1);case dt:return h(b+"Seconds",2);case lt:return h(b+"Milliseconds",3);default:return this.clone()}},e.endOf=function(i){return this.startOf(i,!1)},e.$set=function(i,r){var o,s=P.p(i),l="set"+(this.$u?"UTC":""),d=(o={},o[Ae]=l+"Date",o[ht]=l+"Date",o[pe]=l+"Month",o[Ee]=l+"FullYear",o[ct]=l+"Hours",o[dt]=l+"Minutes",o[lt]=l+"Seconds",o[gr]=l+"Milliseconds",o)[s],h=s===Ae?this.$D+(r-this.$W):r;if(s===pe||s===Ee){var p=this.clone().set(ht,1);p.$d[d](h),p.init(),this.$d=p.set(ht,Math.min(this.$D,p.daysInMonth())).$d}else d&&this.$d[d](h);return this.init(),this},e.set=function(i,r){return this.clone().$set(i,r)},e.get=function(i){return this[P.p(i)]()},e.add=function(i,r){var o=this,s;i=Number(i);var l=P.p(r),d=function(f){var b=G(o);return P.w(b.date(b.date()+Math.round(f*i)),o)};if(l===pe)return this.set(pe,this.$M+i);if(l===Ee)return this.set(Ee,this.$y+i);if(l===Ae)return d(1);if(l===ai)return d(7);var h=(s={},s[dt]=Gi,s[ct]=ma,s[lt]=ft,s)[l]||1,p=this.$d.getTime()+i*h;return P.w(p,this)},e.subtract=function(i,r){return this.add(i*-1,r)},e.format=function(i){var r=this,o=this.$locale();if(!this.isValid())return o.invalidDate||ga;var s=i||dn,l=P.z(this),d=this.$H,h=this.$m,p=this.$M,v=o.weekdays,f=o.months,b=o.meridiem,$=function(I,N,Y,se){return I&&(I[N]||I(r,s))||Y[N].slice(0,se)},k=function(I){return P.s(d%12||12,I,"0")},E=b||function(R,I,N){var Y=R<12?"AM":"PM";return N?Y.toLowerCase():Y},A={YY:String(this.$y).slice(-2),YYYY:this.$y,M:p+1,MM:P.s(p+1,2,"0"),MMM:$(o.monthsShort,p,f,3),MMMM:$(f,p),D:this.$D,DD:P.s(this.$D,2,"0"),d:String(this.$W),dd:$(o.weekdaysMin,this.$W,v,2),ddd:$(o.weekdaysShort,this.$W,v,3),dddd:v[this.$W],H:String(d),HH:P.s(d,2,"0"),h:k(1),hh:k(2),a:E(d,h,!0),A:E(d,h,!1),m:String(h),mm:P.s(h,2,"0"),s:String(this.$s),ss:P.s(this.$s,2,"0"),SSS:P.s(this.$ms,3,"0"),Z:l};return s.replace(hn,function(R,I){return I||A[R]||l.replace(":","")})},e.utcOffset=function(){return-Math.round(this.$d.getTimezoneOffset()/15)*15},e.diff=function(i,r,o){var s,l=P.p(r),d=G(i),h=(d.utcOffset()-this.utcOffset())*Gi,p=this-d,v=P.m(this,d);return v=(s={},s[Ee]=v/12,s[pe]=v,s[Xa]=v/3,s[ai]=(p-h)/ln,s[Ae]=(p-h)/nn,s[ct]=p/ma,s[dt]=p/Gi,s[lt]=p/ft,s)[l]||p,o?v:P.a(v)},e.daysInMonth=function(){return this.endOf(pe).$D},e.$locale=function(){return Ge[this.$L]},e.locale=function(i,r){if(!i)return this.$L;var o=this.clone(),s=vi(i,r,!0);return s&&(o.$L=s),o},e.clone=function(){return P.w(this.$d,this)},e.toDate=function(){return new Date(this.valueOf())},e.toJSON=function(){return this.isValid()?this.toISOString():null},e.toISOString=function(){return this.$d.toISOString()},e.toString=function(){return this.$d.toUTCString()},a}(),Za=bi.prototype;G.prototype=Za;[["$ms",gr],["$s",lt],["$m",dt],["$H",ct],["$W",Ae],["$M",pe],["$y",Ee],["$D",ht]].forEach(function(a){Za[a[1]]=function(e){return this.$g(e,a[0],a[1])}});G.extend=function(a,e){return a.$i||(a(e,bi,G),a.$i=!0),G};G.locale=vi;G.isDayjs=fr;G.unix=function(a){return G(a*1e3)};G.en=Ge[Nt];G.Ls=Ge;G.p={};var Sn=function(e){return e.replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g,function(t,i,r){return i||r.slice(1)})},$n={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"},xn=function(e,t){return e.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g,function(i,r,o){var s=o&&o.toUpperCase();return r||t[o]||$n[o]||Sn(t[s])})},Cn=/(\[[^[]*\])|([-:/.()\s]+)|(A|a|YYYY|YY?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g,_n=/\d/,ei=/\d\d/,kn=/\d{3}/,Tn=/\d{4}/,ye=/\d\d?/,Dn=/[+-]?\d+/,Mn=/[+-]\d\d:?(\d\d)?|Z/,Ft=/\d*[^\s\d-_:/()]+/,Le={},Ja=function(e){return e=+e,e+(e>68?1900:2e3)};function An(a){if(!a||a==="Z")return 0;var e=a.match(/([+-]|\d\d)/g),t=+(e[1]*60)+(+e[2]||0);return t===0?0:e[0]==="+"?-t:t}var re=function(e){return function(t){this[e]=+t}},fa=[Mn,function(a){var e=this.zone||(this.zone={});e.offset=An(a)}],Yi=function(e){var t=Le[e];return t&&(t.indexOf?t:t.s.concat(t.f))},ya=function(e,t){var i,r=Le,o=r.meridiem;if(!o)i=e===(t?"pm":"PM");else for(var s=1;s<=24;s+=1)if(e.indexOf(o(s,0,t))>-1){i=s>12;break}return i},En={A:[Ft,function(a){this.afternoon=ya(a,!1)}],a:[Ft,function(a){this.afternoon=ya(a,!0)}],S:[_n,function(a){this.milliseconds=+a*100}],SS:[ei,function(a){this.milliseconds=+a*10}],SSS:[kn,function(a){this.milliseconds=+a}],s:[ye,re("seconds")],ss:[ye,re("seconds")],m:[ye,re("minutes")],mm:[ye,re("minutes")],H:[ye,re("hours")],h:[ye,re("hours")],HH:[ye,re("hours")],hh:[ye,re("hours")],D:[ye,re("day")],DD:[ei,re("day")],Do:[Ft,function(a){var e=Le,t=e.ordinal,i=a.match(/\d+/);if(this.day=i[0],!!t)for(var r=1;r<=31;r+=1)t(r).replace(/\[|\]/g,"")===a&&(this.day=r)}],M:[ye,re("month")],MM:[ei,re("month")],MMM:[Ft,function(a){var e=Yi("months"),t=Yi("monthsShort"),i=(t||e.map(function(r){return r.slice(0,3)})).indexOf(a)+1;if(i<1)throw new Error;this.month=i%12||i}],MMMM:[Ft,function(a){var e=Yi("months"),t=e.indexOf(a)+1;if(t<1)throw new Error;this.month=t%12||t}],Y:[Dn,re("year")],YY:[ei,function(a){this.year=Ja(a)}],YYYY:[Tn,re("year")],Z:fa,ZZ:fa};function On(a){var e=a.afternoon;if(e!==void 0){var t=a.hours;e?t<12&&(a.hours+=12):t===12&&(a.hours=0),delete a.afternoon}}function Ln(a){a=xn(a,Le&&Le.formats);for(var e=a.match(Cn),t=e.length,i=0;i<t;i+=1){var r=e[i],o=En[r],s=o&&o[0],l=o&&o[1];l?e[i]={regex:s,parser:l}:e[i]=r.replace(/^\[|\]$/g,"")}return function(d){for(var h={},p=0,v=0;p<t;p+=1){var f=e[p];if(typeof f=="string")v+=f.length;else{var b=f.regex,$=f.parser,k=d.slice(v),E=b.exec(k),A=E[0];$.call(h,A),d=d.replace(A,"")}}return On(h),h}}var In=function(e,t,i){try{if(["x","X"].indexOf(t)>-1)return new Date((t==="X"?1e3:1)*e);var r=Ln(t),o=r(e),s=o.year,l=o.month,d=o.day,h=o.hours,p=o.minutes,v=o.seconds,f=o.milliseconds,b=o.zone,$=new Date,k=d||(!s&&!l?$.getDate():1),E=s||$.getFullYear(),A=0;s&&!l||(A=l>0?l-1:$.getMonth());var R=h||0,I=p||0,N=v||0,Y=f||0;return b?new Date(Date.UTC(E,A,k,R,I,N,Y+b.offset*60*1e3)):i?new Date(Date.UTC(E,A,k,R,I,N,Y)):new Date(E,A,k,R,I,N,Y)}catch{return new Date("")}},Fn=function(a,e,t){t.p.customParseFormat=!0,a&&a.parseTwoDigitYear&&(Ja=a.parseTwoDigitYear);var i=e.prototype,r=i.parse;i.parse=function(o){var s=o.date,l=o.utc,d=o.args;this.$u=l;var h=d[1];if(typeof h=="string"){var p=d[2]===!0,v=d[3]===!0,f=p||v,b=d[2];v&&(b=d[2]),Le=this.$locale(),!p&&b&&(Le=t.Ls[b]),this.$d=In(s,h,l),this.init(),b&&b!==!0&&(this.$L=this.locale(b).$L),f&&s!=this.format(h)&&(this.$d=new Date("")),Le={}}else if(h instanceof Array)for(var $=h.length,k=1;k<=$;k+=1){d[1]=h[k-1];var E=t.apply(this,d);if(E.isValid()){this.$d=E.$d,this.$L=E.$L,this.init();break}k===$&&(this.$d=new Date(""))}else r.call(this,o)}};const Rn=Object.freeze({processing:"processing",complete:"complete"});class zn extends F{static get properties(){return{mode:{type:String}}}constructor(){super(),this.mode=Rn.processing}render(){return m`
      <div class="${this.mode}">
        <svg
          viewBox="0 0 120 120"
    ...
    `}get selectedRangeTemplate(){return L`
      ...
      />`}get histogramTemplate(){const e=this._histWidth/this._numBins,t=e-1;let i=this.sliderWidth;return this._histData.map(r=>{const o=L`
        <rect
          ...
          fill="${i+t>=this.minSliderX&&i<=this.maxSliderX?Gn:Kn}"
    ...
    #tooltip:after {
      ...
      /* arrow */
      border: 5px solid ${$a};
      border-color: ${Sa} transparent transparent
        transparent;
    }
    /****** slider ********/
    .draggable:hover {
...
`;let Q=class extends F{constructor(){super(...arguments),this.prompt="Do you find this feature useful?",this.buttonText="Beta",this.isOpen=!1,this.processing=!1,this.popupTopX=0,this.popupTopY=0,this.voteSubmitted=!1,this.voteNeedsChoosing=!1,this.resizingElement=document.body}render(){return m`
    ...
    `}};n([u({type:String})],Q.prototype,"featureIdentifier",void 0);n([u({type:String})],Q.prototype,"prompt",void 0);n([u({type:String})],Q.prototype,"buttonText",void 0);n([u({type:Object})],Q.prototype,"recaptchaManager",void 0);n([u({type:Object})],Q.prototype,"resizeObserver",void 0);n([u({type:Boolean})],Q.prototype,"disabled",void 0);n([u({type:Object})],Q.prototype,"featureFeedbackService",void 0);n([le("#beta-button")],Q.prototype,"betaButton",void 0);n([le("#popup")],Q.prototype,"popup",void 0);n([D()],Q.prototype,"isOpen",void 0);n([D()],Q.prototype,"processing",void 0);n([D()],Q.prototype,"popupTopX",void 0);n([D()],Q.prototype,"popupTopY",void 0);n([D()],Q.prototype,"vote",void 0);n([D()],Q.prototype,"voteSubmitted",void 0);n([D()],Q.prototype,"error",void 0);n([D()],Q.prototype,"voteNeedsChoosing",void 0);n([D()],Q.prototype,"recaptchaWidget",void 0);n([le("#comments")],Q.prototype,"comments",void 0);Q=n([H("feature-feedback")],Q);var il=L`
...
`,eo=L`<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><path d="m79.8883285 50.0035012.1116715-.1085359-43.1159942-46.61088155c-2.401537-2.18938917-4.6902018-3.28408375-6.8659943-3.28408375s-4.1642651.63837733-5.9654178 1.91513199c-1.8011528 1.27675467-3.1520173 2.97248092-4.0525937 5.08717877l39.4020173 42.99768924-39.4020173 42.9976892c.9005764 2.1146979 2.2514409 3.8104241 4.0525937 5.0871788 1.8011527 1.2767547 3.7896253 1.915132 5.9654178 1.915132 2.1013449 0 4.3900096-1.0573489 6.8659943-3.1720468l43.1159942-46.7194174z"/></svg>
`;const al=["mediatype","year","subject","collection","creator","language"],ol={subjectSorter:"subject",mediatypeSorter:"mediatype",languageSorter:"language",creatorSorter:"creator",collection:"collection",year:"year"},_a={subject:"Subject",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"};let oe=class extends F{constructor(){super(...arguments),this.facetsLoading=!1,this.fullYearAggregationLoading=!1,this.collapsableFacets=!1,this.showHistogramDatePicker=!1,this.openFacets={subject:!1,mediatype:!1,language:!1,creator:!1,collection:!1,year:!1}}render(){return m`
    ...
    `}updated(e){e.has("selectedFacets")&&this.dispatchFacetsChangedEvent()}dispatchFacetsChangedEvent(){const e=new CustomEvent("facetsChanged",{detail:this.selectedFacets});this.dispatchEvent(e)}get currentYearsHistogramAggregation(){var e;return(e=this.aggregations)===null||e===void 0?void 0:e.year_histogram}get histogramTemplate(){const{fullYearsHistogramAggregation:e}=this;return m`
      ...
      ></histogram-date-range>
    `}histogramDateRangeUpdated(e){const{minDate:t,maxDate:i}=e.detail,r=new CustomEvent("histogramDateRangeUpdated",{detail:{minDate:t,maxDate:i}});this.dispatchEvent(r)}get mergedFacets(){const e=[];return al.forEach(t=>{var i;const r=this.selectedFacetGroups.find(d=>d.key===t),o=this.aggregationFacetGroups.find(d=>d.key===t);if(r&&!o){e.push(r);return}if(!o)return;const s=r!=null?r:o,l=(i=r==null?void 0:r.buckets.map(d=>{const h=o.buckets.find(p=>p.key===d.key);return h?At(fe({},d),{count:h.count}):d}))!==null&&i!==void 0?i:[];o.buckets.forEach(d=>{l.find(p=>p.key===d.key)||l.push(d)}),s.buckets=l.splice(0,5),e.push(s)}),e}get selectedFacetGroups(){return this.selectedFacets?Object.entries(this.selectedFacets).map(([t,i])=>{const r=t,o=_a[r],s=Object.entries(i).map(([l,d])=>{var h,p;let v=l;return r==="language"&&(v=(p=(h=this.languageCodeHandler)===null||h===void 0?void 0:h.getLanguageNameFromCodeString(l))!==null&&p!==void 0?p:l),{displayText:v,key:l,count:0,state:d}});return{title:o,key:r,buckets:s}}):[]}get aggregationFacetGroups(){var e;const t=[];return Object.entries((e=this.aggregations)!==null&&e!==void 0?e:[]).forEach(([i,r])=>{if(i==="year_histogram")return;const o=this.getFacetOptionFromKey(i),s=_a[o],d=r.buckets.map(p=>{var v,f;let b=p.key;return o==="language"&&(b=(f=(v=this.languageCodeHandler)===null||v===void 0?void 0:v.getCodeStringFromLanguageName(`${p.key}`))!==null&&f!==void 0?f:p.key),{displayText:`${p.key}`,key:`${b}`,count:p.doc_count,state:"none"}}),h={title:s,key:o,buckets:d};t.push(h)}),t}getFacetGroupTemplate(e){if(e.buckets.length===0)return _;const{key:t}=e,i=this.openFacets[t],r=m`
    ...
    `}getFacetTemplate(e){const i=e.buckets.filter(r=>r.key.startsWith("fav-")===!1).slice(0,6);return m`
      <ul class="facet-list">
        ${Ha(i,r=>`${e.key}:${r.key}`,r=>{var o,s;const l=`${e.key}:${r.key}-show-only`,d=`${e.key}:${r.key}-negative`,h=e.key!=="collection"?m`${(o=r.displayText)!==null&&o!==void 0?o:r.key}`:m`
                    <async-collection-name
                      .collectionNameCache=${this.collectionNameCache}
                      .identifier=${r.key}
                      placeholder="-"
                    ></async-collection-name>
                  `,p=r.state==="hidden",v=r.state==="selected",f=`${e.key}: ${(s=r.displayText)!==null&&s!==void 0?s:r.key}`,b=v?`Show all ${e.key}s`:`Only show ${f}`,$=`Hide ${f}`,k=`Unhide ${f}`,E=p?k:$;return m`
              <li>
                <div class="facet-row">
    ...
    `}facetClicked(e,t,i){const r=e.target,{checked:o,name:s,value:l}=r;o?this.facetChecked(s,l,i):this.facetUnchecked(s,l)}facetChecked(e,t,i){const{selectedFacets:r}=this;let o;r?o=fe({},r):o=ui,o[e][t]=i?"hidden":"selected",this.selectedFacets=o}facetUnchecked(e,t){const{selectedFacets:i}=this;let r;i?r=fe({},i):r=ui,delete r[e][t],this.selectedFacets=r}getFacetOptionFromKey(e){const r=e.split("__")[2].split(":")[1],o=Object.entries(ol).find(([l])=>r.includes(l)),s=o==null?void 0:o[1];if(!s)throw new Error(`Could not find facet option for key: ${e}`);return s}static get styles(){return y`
      #container.loading {
        opacity: 0.5;
      }
    ...
    `}scrollThresholdReached(){this.pagesToRender+=1,this.fetchPage(this.pagesToRender)}};T.styles=y`
    :host {
      display: block;
    }
