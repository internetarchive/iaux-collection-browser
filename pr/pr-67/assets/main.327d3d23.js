...
`;let li=class extends z{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1}render(){return this.loginRequired&&!this.loggedIn?m`${ys} `:m`${bs}`}static get styles(){return b`
      :host {
        position: absolute;
        width: 100%;
        height: 100%;
    ...
    `}};n([u({type:Boolean})],li.prototype,"loggedIn",void 0);n([u({type:Boolean})],li.prototype,"loginRequired",void 0);li=n([V("icon-overlay")],li);let _e=class extends z{constructor(){super(...arguments),this.isListTile=!1,this.isCompactTile=!1,this.loggedIn=!1,this.isWaveform=!1}render(){return m`
...
to view this item`:"Content may be inappropriate"}static get styles(){return b`
    ...
    `}};n([u({type:Boolean})],di.prototype,"loggedIn",void 0);n([u({type:Boolean})],di.prototype,"loginRequired",void 0);di=n([V("text-overlay")],di);let Wt=class extends z{constructor(){super(...arguments),this.loggedIn=!1}render(){var e,t,i,r,o,s;const l=(e=this.model)===null||e===void 0?void 0:e.title,d=(t=this.model)===null||t===void 0?void 0:t.creator;return m`
      <div class="container">
        <div class="item-info">
          <div id="title">
    ...
    `}};n([u({type:Boolean})],Wt.prototype,"loggedIn",void 0);n([u({type:Object})],Wt.prototype,"model",void 0);n([u({type:String})],Wt.prototype,"baseImageUrl",void 0);Wt=n([V("item-tile")],Wt);let tr=class extends z{render(){var e,t,i,r,o,s,l,d;return m`
