 ...
 */const or=(s,e,t)=>{const i=new Map;for(let o=e;o<=t;o++)i.set(s[o],o);return i},sa=Wi(class extends ji{constructor(s){if(super(s),s.type!==Ge.CHILD)throw Error("repeat() can only be used in text expressions")}ct(s,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);const o=[],a=[];let r=0;for(const l of s)o[r]=i?i(l,r):r,a[r]=t(l,r),r++;return{values:a,keys:o}}render(s,e,t){return this.ct(s,e,t).values}update(s,[e,t,i]){var o;const a=Ul(s),{values:r,keys:l}=this.ct(e,t,i);if(!Array.isArray(a))return this.ut=l,r;const c=(o=this.ut)!==null&&o!==void 0?o:this.ut=[],u=[];let p,m,v=0,y=a.length-1,x=0,w=r.length-1;for(;v<=y&&x<=w;)if(a[v]===null)v++;else if(a[y]===null)y--;else if(c[v]===l[x])u[x]=St(a[v],r[x]),v++,x++;else if(c[y]===l[w])u[w]=St(a[y],r[w]),y--,w--;else if(c[v]===l[w])u[w]=St(a[v],r[w]),yi(s,u[w+1],a[v]),v++,w--;else if(c[y]===l[x])u[x]=St(a[y],r[x]),yi(s,a[v],a[y]),y--,x++;else if(p===void 0&&(p=or(l,x,w),m=or(c,v,y)),p.has(c[v]))if(p.has(c[y])){const C=m.get(l[x]),M=C!==void 0?a[C]:null;if(M===null){const E=yi(s,a[v]);St(E,r[x]),u[x]=E}else u[x]=St(M,r[x]),yi(s,a[v],M),a[C]=null;x++}else ts(a[y]),y--;else ts(a[v]),v++;for(;x<=w;){const C=yi(s,u[w+1]);St(C,r[x]),u[x++]=C}for(;v<=y;){const C=a[v++];C!==null&&ts(C)}return this.ut=l,sn(s,u),Ae}});function Ji(s,e,t){return Array.from({length:(e-s)/t+1},(i,o)=>s+o*t)}let st=class extends B{constructor(){super(...arguments),this.itemCount=0,this.scrollOptimizationsDisabled=!1,this.intersectionObserver=new IntersectionObserver(e=>{e.forEach(t=>{if(t.target===this.sentinel){t.isIntersecting&&this.dispatchEvent(new Event("scrollThresholdReached"));return}const o=t.target.dataset.cellIndex;if(!o)return;const a=parseInt(o,10);t.isIntersecting?this.visibleCellIndices.add(a):this.visibleCellIndices.delete(a)}),this.scrollOptimizationsDisabled||this.processVisibleCells()}),this.renderedCellIndices=new Set,this.visibleCellIndices=new Set,this.placeholderCellIndices=new Set}reload(){Ji(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.removeCell(t)),this.renderedCellIndices.clear(),this.visibleCellIndices.clear(),this.placeholderCellIndices.clear(),this.setupObservations()}refreshCell(e){this.removeCell(e),this.bufferRange.includes(e)&&this.renderCellBuffer([e])}refreshAllVisibleCells(){this.bufferRange.forEach(e=>this.removeCell(e)),this.renderCellBuffer(this.bufferRange)}scrollToCell(e,t){const i=this.cellContainers[e];if(!i)return!1;const o=t?"smooth":"auto";return i.scrollIntoView({behavior:o}),!0}getVisibleCellIndices(){return Array.from(this.visibleCellIndices)}updated(e){(e.has("itemCount")||e.has("scrollOptimizationsDisabled"))&&this.setupObservations()}disconnectedCallback(){this.intersectionObserver.disconnect()}setupObservations(){this.setupIntersectionObserver()}setupIntersectionObserver(){this.intersectionObserver.disconnect(),this.sentinel&&this.intersectionObserver.observe(this.sentinel),this.scrollOptimizationsDisabled?(Ji(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.visibleCellIndices.add(t)),this.processVisibleCells()):this.cellContainers.forEach(e=>this.intersectionObserver.observe(e))}render(){var e;const t=this.itemCount-1,i=Ji(0,t,1),o=(e=this.ariaLandmarkLabel)!==null&&e!==void 0?e:b;return h`
    ...
    `}};n([d({type:Number})],st.prototype,"itemCount",void 0);n([d({type:Object})],st.prototype,"cellProvider",void 0);n([d({type:Object})],st.prototype,"placeholderCellTemplate",void 0);n([d({type:Boolean})],st.prototype,"scrollOptimizationsDisabled",void 0);n([d({type:String})],st.prototype,"ariaLandmarkLabel",void 0);n([q("#sentinel")],st.prototype,"sentinel",void 0);n([Al(".cell-container")],st.prototype,"cellContainers",void 0);st=n([P("infinite-scroller")],st);function Hl(s){return s==null?void 0:s.replace(/%22%22(?!%22%22)(.+?)%22%22/g,"%22$1%22")}function Vl(s){var e,t,i;return((e=s==null?void 0:s.rawMetadata)===null||e===void 0?void 0:e.hit_type)==="favorited_search"?"search":(i=(t=s.mediatype)===null||t===void 0?void 0:t.value)!==null&&i!==void 0?i:"data"}const Wl=N`
  <svg
    viewBox="0 0 100 100"
...
`;function Ic(s,e){let t=1;return s>=1e9?t=1e9:s>=1e6?t=1e6:s>=1e3&&e==="short"&&(t=1e3),t}function Oc(s=0,e){const t=s/e,i=t<10;let o=0;return i?o=Math.round((t+Number.EPSILON)*10)/10:o=Math.round(t),o}function Nc(s,e,t,i){switch(e){case 1e9:return T(t==="short"?lt`${s}B`:lt`${s} billion`);case 1e6:return T(t==="short"?lt`${s}M`:lt`${s} million`);case 1e3:return T(t==="short"?lt`${s}K`:lt`${s} thousand`);default:return new Intl.NumberFormat(i).format(s)}}function ca(s,e="long",t="short",i="en-US"){const o=s??-1;if(o<0)return"";const a=Ic(o,e),r=Oc(o,a);return Nc(r,a,t,i)}let Oe=class extends B{constructor(){super(...arguments),this.showTvClips=!1}render(){return h`
    ...
    `}get sortedDateInfoTemplate(){var e,t,i,o,a;let r,l="long";switch((e=this.effectiveSort)===null||e===void 0?void 0:e.field){case"date":{const c=(t=this.model)===null||t===void 0?void 0:t.datePublished;r={field:"published",value:c},la(c)&&(l="year-only");break}case"reviewdate":r={field:"reviewed",value:(i=this.model)===null||i===void 0?void 0:i.dateReviewed};break;case"addeddate":r={field:"added",value:(o=this.model)===null||o===void 0?void 0:o.dateAdded};break;case"publicdate":r={field:"archived",value:(a=this.model)===null||a===void 0?void 0:a.dateArchived};break}return r!=null&&r.value?h`
