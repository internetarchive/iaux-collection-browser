 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const jo=(r,e)=>e.kind==="method"&&e.descriptor&&!("value"in e.descriptor)?ct(se({},e),{finisher(t){t.createProperty(e.key,r)}}):{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){typeof e.initializer=="function"&&(this[e.key]=e.initializer.call(this))},finisher(t){t.createProperty(e.key,r)}};function c(r){return(e,t)=>t!==void 0?((i,a,o)=>{a.constructor.createProperty(o,i)})(r,e,t):jo(r,e)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function T(r){return c(ct(se({},r),{state:!0}))}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Rr=({finisher:r,descriptor:e})=>(t,i)=>{var a;if(i===void 0){const o=(a=t.originalKey)!==null&&a!==void 0?a:t.key,n=e!=null?{kind:"method",placement:"prototype",key:o,descriptor:e(t.key)}:ct(se({},t),{key:o});return r!=null&&(n.finisher=function(l){r(l,o)}),n}{const o=t.constructor;e!==void 0&&Object.defineProperty(t,i,e(i)),r==null||r(o,i)}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`,us={account:{color:"#000000",icon:is,text:"Account"},audio:{color:"#00adef",icon:as,text:"Audio"},collection:{color:"#4666ff",icon:Ur,text:"Collection"},data:{color:"#333333",icon:rs,text:"Data"},etree:{color:"#00adef",icon:os,text:"E-tree"},film:{color:"#bf1b2c",icon:ir,text:"Film"},image:{color:"#aa99c9",icon:ss,text:"Image"},movies:{color:"#f1644b",icon:ir,text:"Movie"},radio:{color:"#8fdaef",icon:ns,text:"Radio"},software:{color:"#9ecc4f",icon:ls,text:"Software"},texts:{color:"#faab3c",icon:ds,text:"Text"},tv:{color:"#f1644b",icon:cs,text:"TV"},video:{color:"#f1644b",icon:hs,text:"Video"},web:{color:"#ffcd27",icon:ps,text:"Web"}};let qt=class extends A{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var e,t;const i=["tvnews","tvarchive","television"],a=["radio","radioprogram"];return this.mediatype==="movies"&&((e=this.collections)===null||e===void 0?void 0:e.some(o=>i.indexOf(o)>=0))?"tv":this.mediatype==="audio"&&((t=this.collections)===null||t===void 0?void 0:t.some(o=>a.indexOf(o)>=0))?"radio":this.mediatype||""}render(){const e=us[this.displayMediatype];return e?p`
    ...
    `}};s([c({type:String})],qt.prototype,"mediatype",void 0);s([c({type:Array})],qt.prototype,"collections",void 0);s([c({type:Boolean})],qt.prototype,"showText",void 0);qt=s([F("mediatype-icon")],qt);const ms=P`
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ys=(r,...e)=>({strTag:!0,strings:r,values:e}),ht=ys,bs=r=>typeof r!="string"&&"strTag"in r,ws=(r,e,t)=>{let i=r[0];for(let a=1;a<r.length;a++)i+=e[t?t[a-1]:a-1],i+=r[a];return i};/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let pt=xs;function Cs(r,e){let t=1;return r>=1e9?t=1e9:r>=1e6?t=1e6:r>=1e3&&e==="short"&&(t=1e3),t}function $s(r=0,e){const t=r/e,i=t<10;let a=0;return i?a=Math.round((t+Number.EPSILON)*10)/10:a=Math.round(t),a}function ks(r,e,t,i){switch(e){case 1e9:return pt(t==="short"?ht`${r}B`:ht`${r} billion`);case 1e6:return pt(t==="short"?ht`${r}M`:ht`${r} million`);case 1e3:return pt(t==="short"?ht`${r}K`:ht`${r} thousand`);default:return new Intl.NumberFormat(i).format(r)}}function Nt(r,e="long",t="short",i="en-US"){const a=r!=null?r:-1;if(a<0)return"";const o=Cs(a,e),n=$s(a,o);return ks(n,o,t,i)}let Je=class extends A{render(){const e=Nt(this.favCount,"short","short"),t=Nt(this.commentCount,"short","short"),i=this.mediatype==="account"?`${this.itemCount} uploads`:`${this.viewCount} all-time views`;return p`
    ...
    `}get doesSortedByDate(){var e;return["date","reviewdate","addeddate","publicdate"].includes((e=this.sortParam)===null||e===void 0?void 0:e.field)}get hasSnippets(){var e,t;return!!(!((t=(e=this.model)===null||e===void 0?void 0:e.snippets)===null||t===void 0)&&t.length)}static get styles(){const e=f`var(--tileBorderColor, #dddddd)`;return[ya,f`
      ...
      `]}};s([c({type:String})],wt.prototype,"baseImageUrl",void 0);s([c({type:Boolean})],wt.prototype,"loggedIn",void 0);s([c({type:Object})],wt.prototype,"model",void 0);s([c({type:Object})],wt.prototype,"sortParam",void 0);wt=s([F("item-tile")],wt);let gi=class extends A{render(){return p`
      <div class="container">
        <div class="tile-details">
          <div class="item-info">
...
`+oe),xe&&(oe=Ae(oe,Oe," "),oe=Ae(oe,Be," ")),K&&Zt?K.createHTML(oe):oe},e.setConfig=function(S){Li(S),Ue=!0},e.clearConfig=function(){dt=null,Ue=!1},e.isValidAttribute=function(S,h,b){dt||Li({});var _=Ve(S),O=Ve(h);return Fa(_,O,b)},e.addHook=function(S,h){typeof h=="function"&&(ce[S]=ce[S]||[],Bt(ce[S],h))},e.removeHook=function(S){if(ce[S])return rr(ce[S])},e.removeHooks=function(S){ce[S]&&(ce[S]=[])},e.removeAllHooks=function(){ce={}},e}var Ht=Gr(),L;(function(r){r.relevance="relevance",r.alltimeview="alltimeview",r.weeklyview="weeklyview",r.title="title",r.datearchived="datearchived",r.date="date",r.datereviewed="datereviewed",r.dateadded="dateadded",r.creator="creator"})(L||(L={}));const qe={relevance:"Relevance",alltimeview:"All-time Views",weeklyview:"Weekly Views",title:"Title",datearchived:"Date Archived",date:"Date Published",datereviewed:"Date Reviewed",dateadded:"Date Added",creator:"Creator"},tn={relevance:null,alltimeview:"downloads",weeklyview:"week",title:"titleSorter",datearchived:"publicdate",date:"date",datereviewed:"reviewdate",dateadded:"addeddate",creator:"creatorSorter"},dr={week:L.weeklyview,downloads:L.alltimeview,titleSorter:L.title,date:L.date,publicdate:L.datearchived,reviewdate:L.datereviewed,addeddate:L.dateadded,creatorSorter:L.creator},an={title:"firstTitle",creator:"firstCreator"},bi={subject:{},lending:{},mediatype:{},language:{},creator:{},collection:{},year:{}},rn=["mediatype","lending","year","subject","collection","creator","language"],wi={subject:"Subject",lending:"Availability",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"},on={is_lendable:!0,is_borrowable:!1,available_to_borrow:!0,is_browsable:!1,available_to_browse:!1,is_readable:!0,available_to_waitlist:!1},cr={is_lendable:"Lending Library",available_to_borrow:"Borrow 14 Days",is_readable:"Always Available"},ba={deemphasize:!0,community:!0,stream_only:!0,samples_only:!0,test_collection:!0,printdisabled:!0,"openlibrary-ol":!0,nationalemergencylibrary:!0,china:!0,americana:!0,toronto:!0};function Qr(r){switch(r){case"publicdate":return"Archived";case"reviewdate":return"Reviewed";case"addeddate":return"Added";default:return"Published"}}function qr(r){return r?`Archivist since ${r.getFullYear()}`:""}let ve=class extends A{constructor(){super(...arguments),this.sortParam=null,this.collectionLinks=[],this.loggedIn=!1}render(){return p`
    ...
    `}};pr=s([F("collection-browser-loading-tile")],pr);let Kt=class extends A{constructor(){super(...arguments),this.selectedLetter=null,this.alphabet="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("")}get selectedUppercaseLetter(){var e;return(e=this.selectedLetter)===null||e===void 0?void 0:e.toUpperCase()}render(){return p`
      <div id="container">
        <ul>
    ...
    `}letterClicked(e){e===this.selectedUppercaseLetter?this.selectedLetter=null:this.selectedLetter=e,this.dispatchEvent(new CustomEvent("letterChanged",{detail:{selectedLetter:this.selectedUppercaseLetter}}))}};Kt.styles=f`
    h1 {
      font-size: 1.2rem;
    }
  ...
  `;s([c({type:String})],Kt.prototype,"selectedLetter",void 0);s([c({type:Object})],Kt.prototype,"letterCounts",void 0);Kt=s([F("alpha-bar")],Kt);const ur=P`
