 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let cs=new ls;cs.resolve();/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let Qe=ns;const jr=O`
...
`;let oa=class extends I{render(){var e,t,i;return m`
      <div id="container">
 ...
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const sa=ga(class extends ya{constructor(r){var e;if(super(r),r.type!==Ae.ATTRIBUTE||r.name!=="class"||((e=r.strings)===null||e===void 0?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(r){return" "+Object.keys(r).filter(e=>r[e]).join(" ")+" "}update(r,[e]){var t,i;if(this.et===void 0){this.et=new Set,r.strings!==void 0&&(this.st=new Set(r.strings.join(" ").split(/\s/).filter(o=>o!=="")));for(const o in e)e[o]&&!(!((t=this.st)===null||t===void 0)&&t.has(o))&&this.et.add(o);return this.render(e)}const a=r.element.classList;this.et.forEach(o=>{o in e||(a.remove(o),this.et.delete(o))});for(const o in e){const s=!!e[o];s===this.et.has(o)||((i=this.st)===null||i===void 0?void 0:i.has(o))||(s?(a.add(o),this.et.add(o)):(a.remove(o),this.et.delete(o)))}return he}}),ds=O`
  <svg
    viewBox="0 0 100 100"
    xmlns="http://www.w3.org/2000/svg"
  >
...
`;let ui=class extends I{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1}render(){return this.loginRequired&&!this.loggedIn?m`${hs} `:m`${ds}`}static get styles(){return y`
      :host {
        position: absolute;
        top: 50%;
        left: 50%;
...
to view this item`:"Content may be inappropriate"}static get styles(){return y`
    ...
    `}};n([p({type:Boolean})],mi.prototype,"loggedIn",void 0);n([p({type:Boolean})],mi.prototype,"loginRequired",void 0);mi=n([U("text-overlay")],mi);let Le=class extends I{constructor(){super(...arguments),this.isCompactTile=!1,this.isListTile=!1,this.loggedIn=!1,this.viewSize="desktop"}render(){var e;return!((e=this.model)===null||e===void 0)&&e.identifier?m`
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*oi(r,e){const t=typeof e=="function";if(r!==void 0){let i=-1;for(const a of r)i>-1&&(yield t?e(i):e),i++,yield a}}let vi=class extends I{constructor(){super(...arguments),this.snippets=[],this.viewSize="desktop"}render(){var e;return!((e=this.snippets)===null||e===void 0)&&e.length?m`
      <div class="${this.containerClasses}">${this.ellipsisJoinedSnippets}</div>

      ${this.viewSize==="grid"?m`<div class="separator"></div>`:$}
    `:m`${$}`}get viewSizeClass(){return this.viewSize==="grid"?"grid":"list"}get containerClasses(){return`container ${this.viewSizeClass}`}get ellipsisJoinedSnippets(){return m`
      &hellip; ${oi(this.snippetTemplates,m` &hellip; `)} &hellip;
    ...
    `}};n([p({type:Array})],vi.prototype,"snippets",void 0);n([p({type:String})],vi.prototype,"viewSize",void 0);vi=n([U("text-snippet-block")],vi);const ps=y`
  .drop-shadow {
...
`;let ze=class extends I{constructor(){super(...arguments),this.isListTile=!1,this.isCompactTile=!1,this.loggedIn=!1,this.isWaveform=!1}render(){return m`
...
`,_s={account:{color:"#000000",icon:ms,text:"Account"},audio:{color:"#00adef",icon:vs,text:"Audio"},collection:{color:"#4666ff",icon:jr,text:"Collection"},data:{color:"#333333",icon:fs,text:"Data"},etree:{color:"#00adef",icon:gs,text:"E-tree"},film:{color:"#bf1b2c",icon:or,text:"Film"},image:{color:"#aa99c9",icon:ys,text:"Image"},movies:{color:"#f1644b",icon:or,text:"Movie"},radio:{color:"#8fdaef",icon:bs,text:"Radio"},software:{color:"#9ecc4f",icon:ws,text:"Software"},texts:{color:"#faab3c",icon:xs,text:"Text"},tv:{color:"#f1644b",icon:Ss,text:"TV"},video:{color:"#f1644b",icon:$s,text:"Video"},web:{color:"#ffcd27",icon:Cs,text:"Web"}};let Gt=class extends I{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var e,t;const i=["tvnews","tvarchive","television"],a=["radio","radioprogram"];return this.mediatype==="movies"&&((e=this.collections)===null||e===void 0?void 0:e.some(o=>i.indexOf(o)>=0))?"tv":this.mediatype==="audio"&&((t=this.collections)===null||t===void 0?void 0:t.some(o=>a.indexOf(o)>=0))?"radio":this.mediatype||""}render(){const e=_s[this.displayMediatype];return e?m`
      <div
        id="icon"
...
`;function Ms(r,e){let t=1;return r>=1e9?t=1e9:r>=1e6?t=1e6:r>=1e3&&e==="short"&&(t=1e3),t}function Ds(r=0,e){const t=r/e,i=t<10;let a=0;return i?a=Math.round((t+Number.EPSILON)*10)/10:a=Math.round(t),a}function Es(r,e,t,i){switch(e){case 1e9:return Qe(t==="short"?ct`${r}B`:ct`${r} billion`);case 1e6:return Qe(t==="short"?ct`${r}M`:ct`${r} million`);case 1e3:return Qe(t==="short"?ct`${r}K`:ct`${r} thousand`);default:return new Intl.NumberFormat(i).format(r)}}function Pt(r,e="long",t="short",i="en-US"){const a=r!=null?r:-1;if(a<0)return"";const o=Ms(a,e),s=Ds(a,o);return Es(s,o,t,i)}let Xe=class extends I{render(){return m`
    ...
    `}};n([p({type:String})],bt.prototype,"baseImageUrl",void 0);n([p({type:Boolean})],bt.prototype,"loggedIn",void 0);n([p({type:Object})],bt.prototype,"model",void 0);n([p({type:Object})],bt.prototype,"sortParam",void 0);bt=n([U("item-tile")],bt);let na=class extends I{render(){var e,t,i,a,o,s,l,c;return m`
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*sr(r,e){if(r!==void 0){let t=0;for(const i of r)yield e(i,t++)}}/*! @license DOMPurify 2.3.8 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/2.3.8/LICENSE */function Ge(r){return Ge=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},Ge(r)}function la(r,e){return la=Object.setPrototypeOf||function(i,a){return i.__proto__=a,i},la(r,e)}function Os(){if(typeof Reflect=="undefined"||!Reflect.construct||Reflect.construct.sham)return!1;if(typeof Proxy=="function")return!0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],function(){})),!0}catch{return!1}}function si(r,e,t){return Os()?si=Reflect.construct:si=function(a,o,s){var l=[null];l.push.apply(l,o);var c=Function.bind.apply(a,l),h=new c;return s&&la(h,s.prototype),h},si.apply(null,arguments)}function ue(r){return Is(r)||Ls(r)||Rs(r)||Fs()}function Is(r){if(Array.isArray(r))return ca(r)}function Ls(r){if(typeof Symbol!="undefined"&&r[Symbol.iterator]!=null||r["@@iterator"]!=null)return Array.from(r)}function Rs(r,e){if(!!r){if(typeof r=="string")return ca(r,e);var t=Object.prototype.toString.call(r).slice(8,-1);if(t==="Object"&&r.constructor&&(t=r.constructor.name),t==="Map"||t==="Set")return Array.from(r);if(t==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t))return ca(r,e)}}function ca(r,e){(e==null||e>r.length)&&(e=r.length);for(var t=0,i=new Array(e);t<e;t++)i[t]=r[t];return i}function Fs(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}var Ns=Object.hasOwnProperty,nr=Object.setPrototypeOf,Ps=Object.isFrozen,Bs=Object.getPrototypeOf,Us=Object.getOwnPropertyDescriptor,ee=Object.freeze,be=Object.seal,Hs=Object.create,Qr=typeof Reflect!="undefined"&&Reflect,fi=Qr.apply,da=Qr.construct;fi||(fi=function(e,t,i){return e.apply(t,i)});ee||(ee=function(e){return e});be||(be=function(e){return e});da||(da=function(e,t){return si(e,ue(t))});var Vs=ve(Array.prototype.forEach),lr=ve(Array.prototype.pop),Ft=ve(Array.prototype.push),ni=ve(String.prototype.toLowerCase),Ws=ve(String.prototype.match),Te=ve(String.prototype.replace),js=ve(String.prototype.indexOf),Qs=ve(String.prototype.trim),J=ve(RegExp.prototype.test),Qi=Gs(TypeError);function ve(r){return function(e){for(var t=arguments.length,i=new Array(t>1?t-1:0),a=1;a<t;a++)i[a-1]=arguments[a];return fi(r,e,i)}}function Gs(r){return function(){for(var e=arguments.length,t=new Array(e),i=0;i<e;i++)t[i]=arguments[i];return da(r,t)}}function A(r,e){nr&&nr(r,null);for(var t=e.length;t--;){var i=e[t];if(typeof i=="string"){var a=ni(i);a!==i&&(Ps(e)||(e[t]=a),i=a)}r[i]=!0}return r}function We(r){var e=Hs(null),t;for(t in r)fi(Ns,r,[t])&&(e[t]=r[t]);return e}function ti(r,e){for(;r!==null;){var t=Us(r,e);if(t){if(t.get)return ve(t.get);if(typeof t.value=="function")return ve(t.value)}r=Bs(r)}function i(a){return console.warn("fallback value for",a),null}return i}var cr=ee(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","section","select","shadow","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),Gi=ee(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","filter","font","g","glyph","glyphref","hkern","image","line","lineargradient","marker","mask","metadata","mpath","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),Yi=ee(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),Ys=ee(["animate","color-profile","cursor","discard","fedropshadow","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),Ki=ee(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover"]),Ks=ee(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),dr=ee(["#text"]),hr=ee(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","face","for","headers","height","hidden","high","href","hreflang","id","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","pattern","placeholder","playsinline","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","xmlns","slot"]),qi=ee(["accent-height","accumulate","additive","alignment-baseline","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),pr=ee(["accent","accentunder","align","bevelled","close","columnsalign","columnlines","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lspace","lquote","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),ii=ee(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),qs=be(/\{\{[\w\W]*|[\w\W]*\}\}/gm),Xs=be(/<%[\w\W]*|[\w\W]*%>/gm),Zs=be(/^data-[\-\w.\u00B7-\uFFFF]/),Js=be(/^aria-[\-\w]+$/),en=be(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|cid|xmpp):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),tn=be(/^(?:\w+script|data):/i),an=be(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),rn=be(/^html$/i),on=function(){return typeof window=="undefined"?null:window},sn=function(e,t){if(Ge(e)!=="object"||typeof e.createPolicy!="function")return null;var i=null,a="data-tt-policy-suffix";t.currentScript&&t.currentScript.hasAttribute(a)&&(i=t.currentScript.getAttribute(a));var o="dompurify"+(i?"#"+i:"");try{return e.createPolicy(o,{createHTML:function(l){return l}})}catch{return console.warn("TrustedTypes policy "+o+" could not be created."),null}};function Gr(){var r=arguments.length>0&&arguments[0]!==void 0?arguments[0]:on(),e=function(d){return Gr(d)};if(e.version="2.3.8",e.removed=[],!r||!r.document||r.document.nodeType!==9)return e.isSupported=!1,e;var t=r.document,i=r.document,a=r.DocumentFragment,o=r.HTMLTemplateElement,s=r.Node,l=r.Element,c=r.NodeFilter,h=r.NamedNodeMap,u=h===void 0?r.NamedNodeMap||r.MozNamedAttrMap:h,v=r.HTMLFormElement,g=r.DOMParser,b=r.trustedTypes,S=l.prototype,z=ti(S,"cloneNode"),E=ti(S,"nextSibling"),D=ti(S,"childNodes"),R=ti(S,"parentNode");if(typeof o=="function"){var L=i.createElement("template");L.content&&L.content.ownerDocument&&(i=L.content.ownerDocument)}var N=sn(b,t),K=N?N.createHTML(""):"",ne=i,ge=ne.implementation,_t=ne.createNodeIterator,zt=ne.createDocumentFragment,kt=ne.getElementsByTagName,Tt=t.importNode,Ze={};try{Ze=We(i).documentMode?i.documentMode:{}}catch{}var ie={};e.isSupported=typeof R=="function"&&ge&&typeof ge.createHTMLDocument!="undefined"&&Ze!==9;var Re=qs,Fe=Xs,At=Zs,Mt=Js,Dt=tn,Je=an,Ne=en,W=null,et=A({},[].concat(ue(cr),ue(Gi),ue(Yi),ue(Ki),ue(dr))),j=null,tt=A({},[].concat(ue(hr),ue(qi),ue(pr),ue(ii))),H=Object.seal(Object.create(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),xe=null,Pe=null,Et=!0,zi=!0,Ca=!1,it=!1,Be=!1,ki=!1,Ti=!1,at=!1,Kt=!1,qt=!1,_a=!0,Ai=!0,Ot=!1,rt={},ot=null,za=A({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","style","svg","template","thead","title","video","xmp"]),ka=null,Ta=A({},["audio","video","img","source","image","track"]),Mi=null,Aa=A({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),Di="http://www.w3.org/1998/Math/MathML",Ei="http://www.w3.org/2000/svg",ke="http://www.w3.org/1999/xhtml",Xt=ke,Oi=!1,st,lo=["application/xhtml+xml","text/html"],co="text/html",Ue,nt=null,ho=i.createElement("form"),Ma=function(d){return d instanceof RegExp||d instanceof Function},Ii=function(d){nt&&nt===d||((!d||Ge(d)!=="object")&&(d={}),d=We(d),W="ALLOWED_TAGS"in d?A({},d.ALLOWED_TAGS):et,j="ALLOWED_ATTR"in d?A({},d.ALLOWED_ATTR):tt,Mi="ADD_URI_SAFE_ATTR"in d?A(We(Aa),d.ADD_URI_SAFE_ATTR):Aa,ka="ADD_DATA_URI_TAGS"in d?A(We(Ta),d.ADD_DATA_URI_TAGS):Ta,ot="FORBID_CONTENTS"in d?A({},d.FORBID_CONTENTS):za,xe="FORBID_TAGS"in d?A({},d.FORBID_TAGS):{},Pe="FORBID_ATTR"in d?A({},d.FORBID_ATTR):{},rt="USE_PROFILES"in d?d.USE_PROFILES:!1,Et=d.ALLOW_ARIA_ATTR!==!1,zi=d.ALLOW_DATA_ATTR!==!1,Ca=d.ALLOW_UNKNOWN_PROTOCOLS||!1,it=d.SAFE_FOR_TEMPLATES||!1,Be=d.WHOLE_DOCUMENT||!1,at=d.RETURN_DOM||!1,Kt=d.RETURN_DOM_FRAGMENT||!1,qt=d.RETURN_TRUSTED_TYPE||!1,Ti=d.FORCE_BODY||!1,_a=d.SANITIZE_DOM!==!1,Ai=d.KEEP_CONTENT!==!1,Ot=d.IN_PLACE||!1,Ne=d.ALLOWED_URI_REGEXP||Ne,Xt=d.NAMESPACE||ke,d.CUSTOM_ELEMENT_HANDLING&&Ma(d.CUSTOM_ELEMENT_HANDLING.tagNameCheck)&&(H.tagNameCheck=d.CUSTOM_ELEMENT_HANDLING.tagNameCheck),d.CUSTOM_ELEMENT_HANDLING&&Ma(d.CUSTOM_ELEMENT_HANDLING.attributeNameCheck)&&(H.attributeNameCheck=d.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),d.CUSTOM_ELEMENT_HANDLING&&typeof d.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements=="boolean"&&(H.allowCustomizedBuiltInElements=d.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements),st=lo.indexOf(d.PARSER_MEDIA_TYPE)===-1?st=co:st=d.PARSER_MEDIA_TYPE,Ue=st==="application/xhtml+xml"?function(f){return f}:ni,it&&(zi=!1),Kt&&(at=!0),rt&&(W=A({},ue(dr)),j=[],rt.html===!0&&(A(W,cr),A(j,hr)),rt.svg===!0&&(A(W,Gi),A(j,qi),A(j,ii)),rt.svgFilters===!0&&(A(W,Yi),A(j,qi),A(j,ii)),rt.mathMl===!0&&(A(W,Ki),A(j,pr),A(j,ii))),d.ADD_TAGS&&(W===et&&(W=We(W)),A(W,d.ADD_TAGS)),d.ADD_ATTR&&(j===tt&&(j=We(j)),A(j,d.ADD_ATTR)),d.ADD_URI_SAFE_ATTR&&A(Mi,d.ADD_URI_SAFE_ATTR),d.FORBID_CONTENTS&&(ot===za&&(ot=We(ot)),A(ot,d.FORBID_CONTENTS)),Ai&&(W["#text"]=!0),Be&&A(W,["html","head","body"]),W.table&&(A(W,["tbody"]),delete xe.tbody),ee&&ee(d),nt=d)},Da=A({},["mi","mo","mn","ms","mtext"]),Ea=A({},["foreignobject","desc","title","annotation-xml"]),po=A({},["title","style","font","a","script"]),Zt=A({},Gi);A(Zt,Yi),A(Zt,Ys);var Li=A({},Ki);A(Li,Ks);var uo=function(d){var f=R(d);(!f||!f.tagName)&&(f={namespaceURI:ke,tagName:"template"});var x=ni(d.tagName),F=ni(f.tagName);return d.namespaceURI===Ei?f.namespaceURI===ke?x==="svg":f.namespaceURI===Di?x==="svg"&&(F==="annotation-xml"||Da[F]):Boolean(Zt[x]):d.namespaceURI===Di?f.namespaceURI===ke?x==="math":f.namespaceURI===Ei?x==="math"&&Ea[F]:Boolean(Li[x]):d.namespaceURI===ke?f.namespaceURI===Ei&&!Ea[F]||f.namespaceURI===Di&&!Da[F]?!1:!Li[x]&&(po[x]||!Zt[x]):!1},Se=function(d){Ft(e.removed,{element:d});try{d.parentNode.removeChild(d)}catch{try{d.outerHTML=K}catch{d.remove()}}},Oa=function(d,f){try{Ft(e.removed,{attribute:f.getAttributeNode(d),from:f})}catch{Ft(e.removed,{attribute:null,from:f})}if(f.removeAttribute(d),d==="is"&&!j[d])if(at||Kt)try{Se(f)}catch{}else try{f.setAttribute(d,"")}catch{}},Ia=function(d){var f,x;if(Ti)d="<remove></remove>"+d;else{var F=Ws(d,/^[\r\n\t ]+/);x=F&&F[0]}st==="application/xhtml+xml"&&(d='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+d+"</body></html>");var ae=N?N.createHTML(d):d;if(Xt===ke)try{f=new g().parseFromString(ae,st)}catch{}if(!f||!f.documentElement){f=ge.createDocument(Xt,"template",null);try{f.documentElement.innerHTML=Oi?"":ae}catch{}}var X=f.body||f.documentElement;return d&&x&&X.insertBefore(i.createTextNode(x),X.childNodes[0]||null),Xt===ke?kt.call(f,Be?"html":"body")[0]:Be?f.documentElement:X},La=function(d){return _t.call(d.ownerDocument||d,d,c.SHOW_ELEMENT|c.SHOW_COMMENT|c.SHOW_TEXT,null,!1)},mo=function(d){return d instanceof v&&(typeof d.nodeName!="string"||typeof d.textContent!="string"||typeof d.removeChild!="function"||!(d.attributes instanceof u)||typeof d.removeAttribute!="function"||typeof d.setAttribute!="function"||typeof d.namespaceURI!="string"||typeof d.insertBefore!="function")},It=function(d){return Ge(s)==="object"?d instanceof s:d&&Ge(d)==="object"&&typeof d.nodeType=="number"&&typeof d.nodeName=="string"},$e=function(d,f,x){!ie[d]||Vs(ie[d],function(F){F.call(e,f,x,nt)})},Ra=function(d){var f;if($e("beforeSanitizeElements",d,null),mo(d)||J(/[\u0080-\uFFFF]/,d.nodeName))return Se(d),!0;var x=Ue(d.nodeName);if($e("uponSanitizeElement",d,{tagName:x,allowedTags:W}),d.hasChildNodes()&&!It(d.firstElementChild)&&(!It(d.content)||!It(d.content.firstElementChild))&&J(/<[/\w]/g,d.innerHTML)&&J(/<[/\w]/g,d.textContent)||x==="select"&&J(/<template/i,d.innerHTML))return Se(d),!0;if(!W[x]||xe[x]){if(!xe[x]&&Na(x)&&(H.tagNameCheck instanceof RegExp&&J(H.tagNameCheck,x)||H.tagNameCheck instanceof Function&&H.tagNameCheck(x)))return!1;if(Ai&&!ot[x]){var F=R(d)||d.parentNode,ae=D(d)||d.childNodes;if(ae&&F)for(var X=ae.length,q=X-1;q>=0;--q)F.insertBefore(z(ae[q],!0),E(d))}return Se(d),!0}return d instanceof l&&!uo(d)||(x==="noscript"||x==="noembed")&&J(/<\/no(script|embed)/i,d.innerHTML)?(Se(d),!0):(it&&d.nodeType===3&&(f=d.textContent,f=Te(f,Re," "),f=Te(f,Fe," "),d.textContent!==f&&(Ft(e.removed,{element:d.cloneNode()}),d.textContent=f)),$e("afterSanitizeElements",d,null),!1)},Fa=function(d,f,x){if(_a&&(f==="id"||f==="name")&&(x in i||x in ho))return!1;if(!(zi&&!Pe[f]&&J(At,f))){if(!(Et&&J(Mt,f))){if(!j[f]||Pe[f]){if(!(Na(d)&&(H.tagNameCheck instanceof RegExp&&J(H.tagNameCheck,d)||H.tagNameCheck instanceof Function&&H.tagNameCheck(d))&&(H.attributeNameCheck instanceof RegExp&&J(H.attributeNameCheck,f)||H.attributeNameCheck instanceof Function&&H.attributeNameCheck(f))||f==="is"&&H.allowCustomizedBuiltInElements&&(H.tagNameCheck instanceof RegExp&&J(H.tagNameCheck,x)||H.tagNameCheck instanceof Function&&H.tagNameCheck(x))))return!1}else if(!Mi[f]){if(!J(Ne,Te(x,Je,""))){if(!((f==="src"||f==="xlink:href"||f==="href")&&d!=="script"&&js(x,"data:")===0&&ka[d])){if(!(Ca&&!J(Dt,Te(x,Je,"")))){if(x)return!1}}}}}}return!0},Na=function(d){return d.indexOf("-")>0},Pa=function(d){var f,x,F,ae;$e("beforeSanitizeAttributes",d,null);var X=d.attributes;if(!!X){var q={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:j};for(ae=X.length;ae--;){f=X[ae];var Jt=f,Z=Jt.name,Ba=Jt.namespaceURI;if(x=Z==="value"?f.value:Qs(f.value),F=Ue(Z),q.attrName=F,q.attrValue=x,q.keepAttr=!0,q.forceKeepAttr=void 0,$e("uponSanitizeAttribute",d,q),x=q.attrValue,!q.forceKeepAttr&&(Oa(Z,d),!!q.keepAttr)){if(J(/\/>/i,x)){Oa(Z,d);continue}it&&(x=Te(x,Re," "),x=Te(x,Fe," "));var fo=Ue(d.nodeName);if(!!Fa(fo,F,x))try{Ba?d.setAttributeNS(Ba,Z,x):d.setAttribute(Z,x),lr(e.removed)}catch{}}}$e("afterSanitizeAttributes",d,null)}},vo=function _(d){var f,x=La(d);for($e("beforeSanitizeShadowDOM",d,null);f=x.nextNode();)$e("uponSanitizeShadowNode",f,null),!Ra(f)&&(f.content instanceof a&&_(f.content),Pa(f));$e("afterSanitizeShadowDOM",d,null)};return e.sanitize=function(_,d){var f,x,F,ae,X;if(Oi=!_,Oi&&(_="<!-->"),typeof _!="string"&&!It(_)){if(typeof _.toString!="function")throw Qi("toString is not a function");if(_=_.toString(),typeof _!="string")throw Qi("dirty is not a string, aborting")}if(!e.isSupported){if(Ge(r.toStaticHTML)==="object"||typeof r.toStaticHTML=="function"){if(typeof _=="string")return r.toStaticHTML(_);if(It(_))return r.toStaticHTML(_.outerHTML)}return _}if(ki||Ii(d),e.removed=[],typeof _=="string"&&(Ot=!1),Ot){if(_.nodeName){var q=Ue(_.nodeName);if(!W[q]||xe[q])throw Qi("root node is forbidden and cannot be sanitized in-place")}}else if(_ instanceof s)f=Ia("<!---->"),x=f.ownerDocument.importNode(_,!0),x.nodeType===1&&x.nodeName==="BODY"||x.nodeName==="HTML"?f=x:f.appendChild(x);else{if(!at&&!it&&!Be&&_.indexOf("<")===-1)return N&&qt?N.createHTML(_):_;if(f=Ia(_),!f)return at?null:qt?K:""}f&&Ti&&Se(f.firstChild);for(var Jt=La(Ot?_:f);F=Jt.nextNode();)F.nodeType===3&&F===ae||Ra(F)||(F.content instanceof a&&vo(F.content),Pa(F),ae=F);if(ae=null,Ot)return _;if(at){if(Kt)for(X=zt.call(f.ownerDocument);f.firstChild;)X.appendChild(f.firstChild);else X=f;return j.shadowroot&&(X=Tt.call(t,X,!0)),X}var Z=Be?f.outerHTML:f.innerHTML;return Be&&W["!doctype"]&&f.ownerDocument&&f.ownerDocument.doctype&&f.ownerDocument.doctype.name&&J(rn,f.ownerDocument.doctype.name)&&(Z="<!DOCTYPE "+f.ownerDocument.doctype.name+`>
`+Z),it&&(Z=Te(Z,Re," "),Z=Te(Z,Fe," ")),N&&qt?N.createHTML(Z):Z},e.setConfig=function(_){Ii(_),ki=!0},e.clearConfig=function(){nt=null,ki=!1},e.isValidAttribute=function(_,d,f){nt||Ii({});var x=Ue(_),F=Ue(d);return Fa(x,F,f)},e.addHook=function(_,d){typeof d=="function"&&(ie[_]=ie[_]||[],Ft(ie[_],d))},e.removeHook=function(_){if(ie[_])return lr(ie[_])},e.removeHooks=function(_){ie[_]&&(ie[_]=[])},e.removeAllHooks=function(){ie={}},e}var Bt=Gr();function Yr(r){switch(r){case"date":return"Published";case"reviewdate":return"Reviewed";case"addeddate":return"Added";default:return"Archived"}}function Kr(r){return r?`Archivist since ${r.getFullYear()}`:""}let pe=class extends I{constructor(){super(...arguments),this.sortParam=null,this.collectionLinks=[],this.loggedIn=!1}updated(e){e.has("model")&&this.fetchCollectionNames()}async fetchCollectionNames(){var e,t;if(!(!((e=this.model)===null||e===void 0)&&e.collections)||this.model.collections.length===0||!this.collectionNameCache)return;this.collectionLinks=[];const i=[],a=[];for(const o of this.model.collections)a.push((t=this.collectionNameCache)===null||t===void 0?void 0:t.collectionNameFor(o).then(s=>{i.push(this.detailsLink(o,s!=null?s:o))}));await Promise.all(a),this.collectionLinks=i}render(){return m`
    ...
    `:$}get volumeTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.volume,"Volume")}get issueTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.issue,"Issue")}get creatorTemplate(){var e,t,i;return((e=this.model)===null||e===void 0?void 0:e.mediatype)==="account"?m`
      ...
      <div id="creator" class="metadata">
        ...
        ${oi(sr(this.model.creators,a=>this.searchLink("creator",a)),m`, `)}
      </div>
    `}get datePublishedTemplate(){var e;return this.metadataTemplate(pi((e=this.model)===null||e===void 0?void 0:e.datePublished,"long"),"Published")}get dateSortByTemplate(){return this.sortParam&&(this.sortParam.field==="addeddate"||this.sortParam.field==="reviewdate"||this.sortParam.field==="publicdate")?this.metadataTemplate(pi(this.date,"long"),Yr(this.sortParam.field)):$}get viewsTemplate(){var e,t;return this.metadataTemplate(`${Pt((t=(e=this.model)===null||e===void 0?void 0:e.viewCount)!==null&&t!==void 0?t:0,this.formatSize)}`,"Views")}get ratingTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.averageRating,"Avg Rating")}get reviewsTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.commentCount,"Reviews")}get topicsTemplate(){var e;return!(!((e=this.model)===null||e===void 0)&&e.subjects)||this.model.subjects.length===0?$:m`
      <div id="topics" class="metadata">
        ...
        ${oi(sr(this.model.subjects,t=>this.searchLink("subject",t)),m`, `)}
      </div>
    ...
    `}get descriptionTemplate(){var e,t;return this.metadataTemplate(Bt.sanitize((t=(e=this.model)===null||e===void 0?void 0:e.description)!==null&&t!==void 0?t:""),"","description")}get textSnippetsTemplate(){var e;return this.hasSnippets?m`<text-snippet-block
      viewsize="list"
      .snippets=${(e=this.model)===null||e===void 0?void 0:e.snippets}
    ></text-snippet-block>`:$}get hasSnippets(){var e,t;return!!(!((t=(e=this.model)===null||e===void 0?void 0:e.snippets)===null||t===void 0)&&t.length)}metadataTemplate(e,t="",i){return e?m`
    ...
    `}};n([p({type:Object})],pe.prototype,"model",void 0);n([p({type:String})],pe.prototype,"baseNavigationUrl",void 0);n([p({type:Object})],pe.prototype,"collectionNameCache",void 0);n([p({type:Number})],pe.prototype,"currentWidth",void 0);n([p({type:Number})],pe.prototype,"currentHeight",void 0);n([p({type:Object})],pe.prototype,"sortParam",void 0);n([p({type:Number})],pe.prototype,"mobileBreakpoint",void 0);n([T()],pe.prototype,"collectionLinks",void 0);n([p({type:String})],pe.prototype,"baseImageUrl",void 0);n([p({type:Boolean})],pe.prototype,"loggedIn",void 0);pe=n([U("tile-list")],pe);let we=class extends I{constructor(){super(...arguments),this.sortParam=null,this.loggedIn=!1}render(){var e,t,i,a,o,s,l,c,h,u;return m`
      <div id="list-line" class="${this.classSize}">
        ...
        <div id="views">
          ${Pt((u=(h=this.model)===null||h===void 0?void 0:h.viewCount)!==null&&u!==void 0?u:0,this.formatSize)}
        </div>
      </div>
    `}get date(){var e,t,i,a,o;switch((e=this.sortParam)===null||e===void 0?void 0:e.field){case"date":return(t=this.model)===null||t===void 0?void 0:t.datePublished;case"reviewdate":return(i=this.model)===null||i===void 0?void 0:i.dateReviewed;case"addeddate":return(a=this.model)===null||a===void 0?void 0:a.dateAdded;default:return(o=this.model)===null||o===void 0?void 0:o.dateArchived}}get classSize(){return this.mobileBreakpoint&&this.currentWidth&&this.currentWidth<this.mobileBreakpoint?"mobile":"desktop"}get formatSize(){return this.mobileBreakpoint&&this.currentWidth&&this.currentWidth<this.mobileBreakpoint?"short":"long"}static get styles(){return y`
      html {
  ...
  `;n([p({type:String})],yi.prototype,"selectedLetter",void 0);yi=n([U("alpha-bar")],yi);const vr=O`
...
`;let Y=class extends I{constructor(){super(...arguments),this.sortDirection=null,this.selectedSort=M.relevance,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.showRelevance=!0,this.alphaSelectorVisible=null,this.dateSortSelectorVisible=!1,this.viewSortSelectorVisible=!1,this.desktopSelectorBarWidth=0,this.selectorBarContainerWidth=0,this.hoveringOverDateSortOptions=!1,this.boundSortBarSelectorEscapeListener=e=>{e.key==="Escape"&&(this.viewSortSelectorVisible=!1,this.dateSortSelectorVisible=!1)}}render(){return m`
    ...
    `}getSortDisplayOption(e,t){var i,a;const o=(i=t==null?void 0:t.isSelected)!==null&&i!==void 0?i:()=>this.selectedSort===e,s=(a=t==null?void 0:t.displayName)!==null&&a!==void 0?a:je[e];return m`
      <a
        href="#"
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const fr=ga(class extends ya{constructor(r){if(super(r),r.type!==Ae.PROPERTY&&r.type!==Ae.ATTRIBUTE&&r.type!==Ae.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!ts(r))throw Error("`live` bindings can only contain a single expression")}render(r){return r}update(r,[e]){if(e===he||e===$)return e;const t=r.element,i=r.name;if(r.type===Ae.PROPERTY){if(e===t[i])return he}else if(r.type===Ae.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(i))return he}else if(r.type===Ae.ATTRIBUTE&&t.getAttribute(i)===e+"")return he;return Vr(r),e}});var qr=60,Xr=qr*60,Zr=Xr*24,hn=Zr*7,xt=1e3,Xi=qr*xt,gr=Xr*xt,pn=Zr*xt,un=hn*xt,ba="millisecond",pt="second",ut="minute",mt="hour",Me="day",li="week",me="month",Jr="quarter",De="year",vt="date",mn="YYYY-MM-DDTHH:mm:ssZ",yr="Invalid Date",vn=/^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/,fn=/\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g,gn={name:"en",weekdays:"Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),months:"January_February_March_April_May_June_July_August_September_October_November_December".split("_")},ha=function(e,t,i){var a=String(e);return!a||a.length>=t?e:""+Array(t+1-a.length).join(i)+e},yn=function(e){var t=-e.utcOffset(),i=Math.abs(t),a=Math.floor(i/60),o=i%60;return(t<=0?"+":"-")+ha(a,2,"0")+":"+ha(o,2,"0")},bn=function r(e,t){if(e.date()<t.date())return-r(t,e);var i=(t.year()-e.year())*12+(t.month()-e.month()),a=e.clone().add(i,me),o=t-a<0,s=e.clone().add(i+(o?-1:1),me);return+(-(i+(t-a)/(o?a-s:s-a))||0)},wn=function(e){return e<0?Math.ceil(e)||0:Math.floor(e)},xn=function(e){var t={M:me,y:De,w:li,d:Me,D:vt,h:mt,m:ut,s:pt,ms:ba,Q:Jr};return t[e]||String(e||"").toLowerCase().replace(/s$/,"")},Sn=function(e){return e===void 0},$n={s:ha,z:yn,m:bn,a:wn,p:xn,u:Sn},Ut="en",Ke={};Ke[Ut]=gn;var wa=function(e){return e instanceof _i},bi=function r(e,t,i){var a;if(!e)return Ut;if(typeof e=="string"){var o=e.toLowerCase();Ke[o]&&(a=o),t&&(Ke[o]=t,a=o);var s=e.split("-");if(!a&&s.length>1)return r(s[0])}else{var l=e.name;Ke[l]=e,a=l}return!i&&a&&(Ut=a),a||!i&&Ut},G=function(e,t){if(wa(e))return e.clone();var i=typeof t=="object"?t:{};return i.date=e,i.args=arguments,new _i(i)},Cn=function(e,t){return G(e,{locale:t.$L,utc:t.$u,x:t.$x,$offset:t.$offset})},B=$n;B.l=bi;B.i=wa;B.w=Cn;var _n=function(e){var t=e.date,i=e.utc;if(t===null)return new Date(NaN);if(B.u(t))return new Date;if(t instanceof Date)return new Date(t);if(typeof t=="string"&&!/Z$/i.test(t)){var a=t.match(vn);if(a){var o=a[2]-1||0,s=(a[7]||"0").substring(0,3);return i?new Date(Date.UTC(a[1],o,a[3]||1,a[4]||0,a[5]||0,a[6]||0,s)):new Date(a[1],o,a[3]||1,a[4]||0,a[5]||0,a[6]||0,s)}}return new Date(t)},_i=function(){function r(t){this.$L=bi(t.locale,null,!0),this.parse(t)}var e=r.prototype;return e.parse=function(i){this.$d=_n(i),this.$x=i.x||{},this.init()},e.init=function(){var i=this.$d;this.$y=i.getFullYear(),this.$M=i.getMonth(),this.$D=i.getDate(),this.$W=i.getDay(),this.$H=i.getHours(),this.$m=i.getMinutes(),this.$s=i.getSeconds(),this.$ms=i.getMilliseconds()},e.$utils=function(){return B},e.isValid=function(){return this.$d.toString()!==yr},e.isSame=function(i,a){var o=G(i);return this.startOf(a)<=o&&o<=this.endOf(a)},e.isAfter=function(i,a){return G(i)<this.startOf(a)},e.isBefore=function(i,a){return this.endOf(a)<G(i)},e.$g=function(i,a,o){return B.u(i)?this[a]:this.set(o,i)},e.unix=function(){return Math.floor(this.valueOf()/1e3)},e.valueOf=function(){return this.$d.getTime()},e.startOf=function(i,a){var o=this,s=B.u(a)?!0:a,l=B.p(i),c=function(D,R){var L=B.w(o.$u?Date.UTC(o.$y,R,D):new Date(o.$y,R,D),o);return s?L:L.endOf(Me)},h=function(D,R){var L=[0,0,0,0],N=[23,59,59,999];return B.w(o.toDate()[D].apply(o.toDate("s"),(s?L:N).slice(R)),o)},u=this.$W,v=this.$M,g=this.$D,b="set"+(this.$u?"UTC":"");switch(l){case De:return s?c(1,0):c(31,11);case me:return s?c(1,v):c(0,v+1);case li:{var S=this.$locale().weekStart||0,z=(u<S?u+7:u)-S;return c(s?g-z:g+(6-z),v)}case Me:case vt:return h(b+"Hours",0);case mt:return h(b+"Minutes",1);case ut:return h(b+"Seconds",2);case pt:return h(b+"Milliseconds",3);default:return this.clone()}},e.endOf=function(i){return this.startOf(i,!1)},e.$set=function(i,a){var o,s=B.p(i),l="set"+(this.$u?"UTC":""),c=(o={},o[Me]=l+"Date",o[vt]=l+"Date",o[me]=l+"Month",o[De]=l+"FullYear",o[mt]=l+"Hours",o[ut]=l+"Minutes",o[pt]=l+"Seconds",o[ba]=l+"Milliseconds",o)[s],h=s===Me?this.$D+(a-this.$W):a;if(s===me||s===De){var u=this.clone().set(vt,1);u.$d[c](h),u.init(),this.$d=u.set(vt,Math.min(this.$D,u.daysInMonth())).$d}else c&&this.$d[c](h);return this.init(),this},e.set=function(i,a){return this.clone().$set(i,a)},e.get=function(i){return this[B.p(i)]()},e.add=function(i,a){var o=this,s;i=Number(i);var l=B.p(a),c=function(g){var b=G(o);return B.w(b.date(b.date()+Math.round(g*i)),o)};if(l===me)return this.set(me,this.$M+i);if(l===De)return this.set(De,this.$y+i);if(l===Me)return c(1);if(l===li)return c(7);var h=(s={},s[ut]=Xi,s[mt]=gr,s[pt]=xt,s)[l]||1,u=this.$d.getTime()+i*h;return B.w(u,this)},e.subtract=function(i,a){return this.add(i*-1,a)},e.format=function(i){var a=this,o=this.$locale();if(!this.isValid())return o.invalidDate||yr;var s=i||mn,l=B.z(this),c=this.$H,h=this.$m,u=this.$M,v=o.weekdays,g=o.months,b=o.meridiem,S=function(L,N,K,ne){return L&&(L[N]||L(a,s))||K[N].slice(0,ne)},z=function(L){return B.s(c%12||12,L,"0")},E=b||function(R,L,N){var K=R<12?"AM":"PM";return N?K.toLowerCase():K},D={YY:String(this.$y).slice(-2),YYYY:this.$y,M:u+1,MM:B.s(u+1,2,"0"),MMM:S(o.monthsShort,u,g,3),MMMM:S(g,u),D:this.$D,DD:B.s(this.$D,2,"0"),d:String(this.$W),dd:S(o.weekdaysMin,this.$W,v,2),ddd:S(o.weekdaysShort,this.$W,v,3),dddd:v[this.$W],H:String(c),HH:B.s(c,2,"0"),h:z(1),hh:z(2),a:E(c,h,!0),A:E(c,h,!1),m:String(h),mm:B.s(h,2,"0"),s:String(this.$s),ss:B.s(this.$s,2,"0"),SSS:B.s(this.$ms,3,"0"),Z:l};return s.replace(fn,function(R,L){return L||D[R]||l.replace(":","")})},e.utcOffset=function(){return-Math.round(this.$d.getTimezoneOffset()/15)*15},e.diff=function(i,a,o){var s,l=B.p(a),c=G(i),h=(c.utcOffset()-this.utcOffset())*Xi,u=this-c,v=B.m(this,c);return v=(s={},s[De]=v/12,s[me]=v,s[Jr]=v/3,s[li]=(u-h)/un,s[Me]=(u-h)/pn,s[mt]=u/gr,s[ut]=u/Xi,s[pt]=u/xt,s)[l]||u,o?v:B.a(v)},e.daysInMonth=function(){return this.endOf(me).$D},e.$locale=function(){return Ke[this.$L]},e.locale=function(i,a){if(!i)return this.$L;var o=this.clone(),s=bi(i,a,!0);return s&&(o.$L=s),o},e.clone=function(){return B.w(this.$d,this)},e.toDate=function(){return new Date(this.valueOf())},e.toJSON=function(){return this.isValid()?this.toISOString():null},e.toISOString=function(){return this.$d.toISOString()},e.toString=function(){return this.$d.toUTCString()},r}(),eo=_i.prototype;G.prototype=eo;[["$ms",ba],["$s",pt],["$m",ut],["$H",mt],["$W",Me],["$M",me],["$y",De],["$D",vt]].forEach(function(r){eo[r[1]]=function(e){return this.$g(e,r[0],r[1])}});G.extend=function(r,e){return r.$i||(r(e,_i,G),r.$i=!0),G};G.locale=bi;G.isDayjs=wa;G.unix=function(r){return G(r*1e3)};G.en=Ke[Ut];G.Ls=Ke;G.p={};var zn=function(e){return e.replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g,function(t,i,a){return i||a.slice(1)})},kn={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"},Tn=function(e,t){return e.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g,function(i,a,o){var s=o&&o.toUpperCase();return a||t[o]||kn[o]||zn(t[s])})},An=/(\[[^[]*\])|([-:/.()\s]+)|(A|a|YYYY|YY?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g,Mn=/\d/,ai=/\d\d/,Dn=/\d{3}/,En=/\d{4}/,ye=/\d\d?/,On=/[+-]?\d+/,In=/[+-]\d\d:?(\d\d)?|Z/,Nt=/\d*[^\s\d-_:/()]+/,Oe={},to=function(e){return e=+e,e+(e>68?1900:2e3)};function Ln(r){if(!r||r==="Z")return 0;var e=r.match(/([+-]|\d\d)/g),t=+(e[1]*60)+(+e[2]||0);return t===0?0:e[0]==="+"?-t:t}var re=function(e){return function(t){this[e]=+t}},br=[In,function(r){var e=this.zone||(this.zone={});e.offset=Ln(r)}],Zi=function(e){var t=Oe[e];return t&&(t.indexOf?t:t.s.concat(t.f))},wr=function(e,t){var i,a=Oe,o=a.meridiem;if(!o)i=e===(t?"pm":"PM");else for(var s=1;s<=24;s+=1)if(e.indexOf(o(s,0,t))>-1){i=s>12;break}return i},Rn={A:[Nt,function(r){this.afternoon=wr(r,!1)}],a:[Nt,function(r){this.afternoon=wr(r,!0)}],S:[Mn,function(r){this.milliseconds=+r*100}],SS:[ai,function(r){this.milliseconds=+r*10}],SSS:[Dn,function(r){this.milliseconds=+r}],s:[ye,re("seconds")],ss:[ye,re("seconds")],m:[ye,re("minutes")],mm:[ye,re("minutes")],H:[ye,re("hours")],h:[ye,re("hours")],HH:[ye,re("hours")],hh:[ye,re("hours")],D:[ye,re("day")],DD:[ai,re("day")],Do:[Nt,function(r){var e=Oe,t=e.ordinal,i=r.match(/\d+/);if(this.day=i[0],!!t)for(var a=1;a<=31;a+=1)t(a).replace(/\[|\]/g,"")===r&&(this.day=a)}],M:[ye,re("month")],MM:[ai,re("month")],MMM:[Nt,function(r){var e=Zi("months"),t=Zi("monthsShort"),i=(t||e.map(function(a){return a.slice(0,3)})).indexOf(r)+1;if(i<1)throw new Error;this.month=i%12||i}],MMMM:[Nt,function(r){var e=Zi("months"),t=e.indexOf(r)+1;if(t<1)throw new Error;this.month=t%12||t}],Y:[On,re("year")],YY:[ai,function(r){this.year=to(r)}],YYYY:[En,re("year")],Z:br,ZZ:br};function Fn(r){var e=r.afternoon;if(e!==void 0){var t=r.hours;e?t<12&&(r.hours+=12):t===12&&(r.hours=0),delete r.afternoon}}function Nn(r){r=Tn(r,Oe&&Oe.formats);for(var e=r.match(An),t=e.length,i=0;i<t;i+=1){var a=e[i],o=Rn[a],s=o&&o[0],l=o&&o[1];l?e[i]={regex:s,parser:l}:e[i]=a.replace(/^\[|\]$/g,"")}return function(c){for(var h={},u=0,v=0;u<t;u+=1){var g=e[u];if(typeof g=="string")v+=g.length;else{var b=g.regex,S=g.parser,z=c.slice(v),E=b.exec(z),D=E[0];S.call(h,D),c=c.replace(D,"")}}return Fn(h),h}}var Pn=function(e,t,i){try{if(["x","X"].indexOf(t)>-1)return new Date((t==="X"?1e3:1)*e);var a=Nn(t),o=a(e),s=o.year,l=o.month,c=o.day,h=o.hours,u=o.minutes,v=o.seconds,g=o.milliseconds,b=o.zone,S=new Date,z=c||(!s&&!l?S.getDate():1),E=s||S.getFullYear(),D=0;s&&!l||(D=l>0?l-1:S.getMonth());var R=h||0,L=u||0,N=v||0,K=g||0;return b?new Date(Date.UTC(E,D,z,R,L,N,K+b.offset*60*1e3)):i?new Date(Date.UTC(E,D,z,R,L,N,K)):new Date(E,D,z,R,L,N,K)}catch{return new Date("")}},Bn=function(r,e,t){t.p.customParseFormat=!0,r&&r.parseTwoDigitYear&&(to=r.parseTwoDigitYear);var i=e.prototype,a=i.parse;i.parse=function(o){var s=o.date,l=o.utc,c=o.args;this.$u=l;var h=c[1];if(typeof h=="string"){var u=c[2]===!0,v=c[3]===!0,g=u||v,b=c[2];v&&(b=c[2]),Oe=this.$locale(),!u&&b&&(Oe=t.Ls[b]),this.$d=Pn(s,h,l),this.init(),b&&b!==!0&&(this.$L=this.locale(b).$L),g&&s!=this.format(h)&&(this.$d=new Date("")),Oe={}}else if(h instanceof Array)for(var S=h.length,z=1;z<=S;z+=1){c[1]=h[z-1];var E=t.apply(this,c);if(E.isValid()){this.$d=E.$d,this.$L=E.$L,this.init();break}z===S&&(this.$d=new Date(""))}else a.call(this,o)}};const Un=Object.freeze({processing:"processing",complete:"complete"});class Hn extends I{static get properties(){return{mode:{type:String}}}constructor(){super(),this.mode=Un.processing}render(){return m`
      <div class="${this.mode}">
        <svg
          viewBox="0 0 120 120"
...
`;const ao={default:"collection-browser"},ro={sortBy:"sortBy",sortByCreator:"sortByCreator",sortByTitle:"sortByTitle",displayMode:"displayMode",facetsChanged:"facetsChanged",histogramChanged:"histogramChanged"},cl=["mediatype","year","subject","collection","creator","language"],dl={subjectSorter:"subject",mediatypeSorter:"mediatype",languageSorter:"language",creatorSorter:"creator",collection:"collection",year:"year"},kr={subject:"Subject",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"};let te=class extends I{constructor(){super(...arguments),this.facetsLoading=!1,this.fullYearAggregationLoading=!1,this.collapsableFacets=!1,this.showHistogramDatePicker=!1,this.openFacets={subject:!1,mediatype:!1,language:!1,creator:!1,collection:!1,year:!1},this.analyticsCategories=ao,this.analyticsActions=ro}render(){return m`
    ...
    `}updated(e){e.has("selectedFacets")&&this.dispatchFacetsChangedEvent()}dispatchFacetsChangedEvent(){const e=new CustomEvent("facetsChanged",{detail:this.selectedFacets});this.dispatchEvent(e)}get currentYearsHistogramAggregation(){var e;return(e=this.aggregations)===null||e===void 0?void 0:e.year_histogram}get histogramTemplate(){const{fullYearsHistogramAggregation:e}=this;return m`
      ...
      ></histogram-date-range>
    `}histogramDateRangeUpdated(e){const{minDate:t,maxDate:i}=e.detail,a=new CustomEvent("histogramDateRangeUpdated",{detail:{minDate:t,maxDate:i}});this.dispatchEvent(a)}get mergedFacets(){const e=[];return cl.forEach(t=>{var i;const a=this.selectedFacetGroups.find(c=>c.key===t),o=this.aggregationFacetGroups.find(c=>c.key===t);if(a&&!o){e.push(a);return}if(!o)return;const s=a!=null?a:o,l=(i=a==null?void 0:a.buckets.map(c=>{const h=o.buckets.find(u=>u.key===c.key);return h?lt(ce({},c),{count:h.count}):c}))!==null&&i!==void 0?i:[];o.buckets.forEach(c=>{l.find(u=>u.key===c.key)||l.push(c)}),s.buckets=l.splice(0,5),e.push(s)}),e}get selectedFacetGroups(){return this.selectedFacets?Object.entries(this.selectedFacets).map(([t,i])=>{const a=t,o=kr[a],s=Object.entries(i).map(([l,c])=>{var h,u;let v=l;return a==="language"&&(v=(u=(h=this.languageCodeHandler)===null||h===void 0?void 0:h.getLanguageNameFromCodeString(l))!==null&&u!==void 0?u:l),{displayText:v,key:l,count:0,state:c}});return{title:o,key:a,buckets:s}}):[]}get aggregationFacetGroups(){var e;const t=[];return Object.entries((e=this.aggregations)!==null&&e!==void 0?e:[]).forEach(([i,a])=>{if(i==="year_histogram")return;const o=this.getFacetOptionFromKey(i),s=kr[o],c=a.buckets.map(u=>{var v,g;let b=u.key;return o==="language"&&(b=(g=(v=this.languageCodeHandler)===null||v===void 0?void 0:v.getCodeStringFromLanguageName(`${u.key}`))!==null&&g!==void 0?g:u.key),{displayText:`${u.key}`,key:`${b}`,count:u.doc_count,state:"none"}}),h={title:s,key:o,buckets:c};t.push(h)}),t}getFacetGroupTemplate(e){if(e.buckets.length===0)return $;const{key:t}=e,i=this.openFacets[t],a=m`
    ...
    `}getFacetTemplate(e){const i=e.buckets.filter(a=>a.key.startsWith("fav-")===!1).slice(0,6);return m`
      <ul class="facet-list">
        ${Wr(i,a=>`${e.key}:${a.key}`,a=>{var o,s;const l=`${e.key}:${a.key}-show-only`,c=`${e.key}:${a.key}-negative`,h=e.key!=="collection"?m`${(o=a.displayText)!==null&&o!==void 0?o:a.key}`:m`
                    <async-collection-name
                      .collectionNameCache=${this.collectionNameCache}
                      .identifier=${a.key}
                      placeholder="-"
                    ></async-collection-name>
                  `,u=a.state==="hidden",v=a.state==="selected",g=`${e.key}: ${(s=a.displayText)!==null&&s!==void 0?s:a.key}`,b=v?`Show all ${e.key}s`:`Only show ${g}`,S=`Hide ${g}`,z=`Unhide ${g}`,E=u?z:S;return m`
              <li>
                <div class="facet-row">
    ...
    `}facetClicked(e,t,i){var a,o,s;const l=e.target,{checked:c,name:h,value:u}=l;c?this.facetChecked(h,u,i):this.facetUnchecked(h,u),(a=this.analyticsHandler)===null||a===void 0||a.sendEventNoSampling({category:(o=this.analyticsCategories)===null||o===void 0?void 0:o.default,action:(s=this.analyticsActions)===null||s===void 0?void 0:s.facetsChanged,label:`${h} - ${u}`})}facetChecked(e,t,i){const{selectedFacets:a}=this;let o;a?o=ce({},a):o=gi,o[e][t]=i?"hidden":"selected",this.selectedFacets=o}facetUnchecked(e,t){const{selectedFacets:i}=this;let a;i?a=ce({},i):a=gi,delete a[e][t],this.selectedFacets=a}getFacetOptionFromKey(e){const a=e.split("__")[2].split(":")[1],o=Object.entries(dl).find(([l])=>a.includes(l)),s=o==null?void 0:o[1];if(!s)throw new Error(`Could not find facet option for key: ${e}`);return s}static get styles(){return y`
      #container.loading {
        opacity: 0.5;
      }
...
`;let xi=class extends I{constructor(){super(...arguments),this.placeholderType=null}render(){return this.placeholderType?m`${this.placeholderTemplate}`:$}get placeholderTemplate(){return m`
      <div
    ...
    `}userChangedSort(e){var t;const{selectedSort:i,sortDirection:a}=e.detail;this.selectedSort=i,this.sortDirection=a,((t=this.currentPage)!==null&&t!==void 0?t:1)>1&&this.goToPage(1),this.currentPage=1}selectedSortChanged(){var e;if(this.selectedSort==="relevance"||this.sortDirection===null){this.sortParam=null;return}const t=nn[this.selectedSort];!t||(this.sortParam={field:t,direction:this.sortDirection},(e=this.analyticsHandler)===null||e===void 0||e.sendEventNoSampling({category:this.analyticsCategories.default,action:this.analyticsActions.sortBy,label:`${t} - ${this.sortDirection}`}))}displayModeChanged(e){var t;this.displayMode=e.detail.displayMode,(t=this.analyticsHandler)===null||t===void 0||t.sendEventNoSampling({category:this.analyticsCategories.default,action:this.analyticsActions.displayMode,label:this.displayMode})}selectedTitleLetterChanged(){var e;this.titleQuery=this.selectedTitleFilter?`firstTitle:${this.selectedTitleFilter}`:void 0,(e=this.analyticsHandler)===null||e===void 0||e.sendEventNoSampling({category:this.analyticsCategories.default,action:this.analyticsActions.sortByTitle,label:`${this.titleQuery}`})}selectedCreatorLetterChanged(){var e;this.creatorQuery=this.selectedCreatorFilter?`firstCreator:${this.selectedCreatorFilter}`:void 0,(e=this.analyticsHandler)===null||e===void 0||e.sendEventNoSampling({category:this.analyticsCategories.default,action:this.analyticsActions.sortByCreator,label:`${this.creatorQuery}`})}titleLetterSelected(e){this.selectedCreatorFilter=null,this.selectedTitleFilter=e.detail.selectedLetter}creatorLetterSelected(e){this.selectedTitleFilter=null,this.selectedCreatorFilter=e.detail.selectedLetter}get facetDataLoading(){return this.facetsLoading||this.fullYearAggregationLoading}get mobileFacetsTemplate(){return m`
