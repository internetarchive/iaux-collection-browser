 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Hr=({finisher:r,descriptor:e})=>(t,i)=>{var a;if(i===void 0){const o=(a=t.originalKey)!==null&&a!==void 0?a:t.key,s=e!=null?{kind:"method",placement:"prototype",key:o,descriptor:e(t.key)}:lt(ce({},t),{key:o});return r!=null&&(s.finisher=function(l){r(l,o)}),s}{const o=t.constructor;e!==void 0&&Object.defineProperty(t,i,e(i)),r==null||r(o,i)}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function le(r,e){return Hr({descriptor:t=>{const i={get(){var a,o;return(o=(a=this.renderRoot)===null||a===void 0?void 0:a.querySelector(r))!==null&&o!==void 0?o:null},enumerable:!0,configurable:!0};if(e){const a=typeof t=="symbol"?Symbol():"__"+t;i.get=function(){var o,s;return this[a]===void 0&&(this[a]=(s=(o=this.renderRoot)===null||o===void 0?void 0:o.querySelector(r))!==null&&s!==void 0?s:null),this[a]}}return i}})}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Ko(r){return Hr({descriptor:e=>({get(){var t,i;return(i=(t=this.renderRoot)===null||t===void 0?void 0:t.querySelectorAll(r))!==null&&i!==void 0?i:[]},enumerable:!0,configurable:!0})})}/**
 * @license
...
`;let oa=class extends I{render(){var e,t,i;return u`
    ...
    `}};n([p({type:Object})],oa.prototype,"model",void 0);oa=n([U("collection-tile")],oa);function pi(r,e="short",t="en-US"){if(!r)return"";const i={timeZone:"UTC"};switch(e){case"short":i.month="short",i.year="numeric";break;case"long":i.year="numeric",i.month="short",i.day="2-digit";break}return new Intl.DateTimeFormat(t,i).format(r)}/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;let ui=class extends I{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1}render(){return this.loginRequired&&!this.loggedIn?u`${cs} `:u`${ls}`}static get styles(){return y`
    ...
    `}};n([p({type:Boolean})],ui.prototype,"loggedIn",void 0);n([p({type:Boolean})],ui.prototype,"loginRequired",void 0);ui=n([U("icon-overlay")],ui);let mi=class extends I{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1}render(){return u` <div class="overlay no-preview">${this.textDisplay}</div> `}get textDisplay(){return this.loginRequired&&!this.loggedIn?`Log in
to view this item`:"Content may be inappropriate"}static get styles(){return y`
    ...
    `}};n([p({type:Boolean})],mi.prototype,"loggedIn",void 0);n([p({type:Boolean})],mi.prototype,"loginRequired",void 0);mi=n([U("text-overlay")],mi);let Le=class extends I{constructor(){super(...arguments),this.isCompactTile=!1,this.isListTile=!1,this.loggedIn=!1,this.viewSize="desktop"}render(){var e;return!((e=this.model)===null||e===void 0)&&e.identifier?u`
 ...
 */function*oi(r,e){const t=typeof e=="function";if(r!==void 0){let i=-1;for(const a of r)i>-1&&(yield t?e(i):e),i++,yield a}}let fi=class extends I{constructor(){super(...arguments),this.snippets=[],this.viewSize="desktop"}render(){var e;return!((e=this.snippets)===null||e===void 0)&&e.length?u`
    ...
    `}};n([p({type:Array})],fi.prototype,"snippets",void 0);n([p({type:String})],fi.prototype,"viewSize",void 0);fi=n([U("text-snippet-block")],fi);const ds=y`
  .drop-shadow {
...
`,$s={account:{color:"#000000",icon:ps,text:"Account"},audio:{color:"#00adef",icon:us,text:"Audio"},collection:{color:"#4666ff",icon:jr,text:"Collection"},data:{color:"#333333",icon:ms,text:"Data"},etree:{color:"#00adef",icon:fs,text:"E-tree"},film:{color:"#bf1b2c",icon:or,text:"Film"},image:{color:"#aa99c9",icon:vs,text:"Image"},movies:{color:"#f1644b",icon:or,text:"Movie"},radio:{color:"#8fdaef",icon:gs,text:"Radio"},software:{color:"#9ecc4f",icon:ys,text:"Software"},texts:{color:"#faab3c",icon:bs,text:"Text"},tv:{color:"#f1644b",icon:ws,text:"TV"},video:{color:"#f1644b",icon:xs,text:"Video"},web:{color:"#ffcd27",icon:Ss,text:"Web"}};let Gt=class extends I{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var e,t;const i=["tvnews","tvarchive","television"],a=["radio","radioprogram"];return this.mediatype==="movies"&&((e=this.collections)===null||e===void 0?void 0:e.some(o=>i.indexOf(o)>=0))?"tv":this.mediatype==="audio"&&((t=this.collections)===null||t===void 0?void 0:t.some(o=>a.indexOf(o)>=0))?"radio":this.mediatype||""}render(){const e=$s[this.displayMediatype];return e?u`
    ...
    `}};n([p({type:String})],Gt.prototype,"mediatype",void 0);n([p({type:Array})],Gt.prototype,"collections",void 0);n([p({type:Boolean})],Gt.prototype,"showText",void 0);Gt=n([U("mediatype-icon")],Gt);const Cs=O`
...
`;function Ts(r,e){let t=1;return r>=1e9?t=1e9:r>=1e6?t=1e6:r>=1e3&&e==="short"&&(t=1e3),t}function As(r=0,e){const t=r/e,i=t<10;let a=0;return i?a=Math.round((t+Number.EPSILON)*10)/10:a=Math.round(t),a}function Ds(r,e,t,i){switch(e){case 1e9:return Qe(t==="short"?ct`${r}B`:ct`${r} billion`);case 1e6:return Qe(t==="short"?ct`${r}M`:ct`${r} million`);case 1e3:return Qe(t==="short"?ct`${r}K`:ct`${r} thousand`);default:return new Intl.NumberFormat(i).format(r)}}function Pt(r,e="long",t="short",i="en-US"){const a=r!=null?r:-1;if(a<0)return"";const o=Ts(a,e),s=As(a,o);return Ds(s,o,t,i)}let Xe=class extends I{render(){return u`
    ...
    `}};n([p({type:String})],bt.prototype,"baseImageUrl",void 0);n([p({type:Boolean})],bt.prototype,"loggedIn",void 0);n([p({type:Object})],bt.prototype,"model",void 0);n([p({type:Object})],bt.prototype,"sortParam",void 0);bt=n([U("item-tile")],bt);let na=class extends I{render(){var e,t,i,a,o,s,l,c;return u`
    ...
    `}};n([p({type:Object})],na.prototype,"model",void 0);na=n([U("account-tile")],na);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`+J),it&&(J=Te(J,Fe," "),J=Te(J,Re," ")),N&&qt?N.createHTML(J):J},e.setConfig=function(_){Ii(_),ki=!0},e.clearConfig=function(){nt=null,ki=!1},e.isValidAttribute=function(_,d,v){nt||Ii({});var x=Ue(_),R=Ue(d);return Ra(x,R,v)},e.addHook=function(_,d){typeof d=="function"&&(ie[_]=ie[_]||[],Rt(ie[_],d))},e.removeHook=function(_){if(ie[_])return lr(ie[_])},e.removeHooks=function(_){ie[_]&&(ie[_]=[])},e.removeAllHooks=function(){ie={}},e}var Bt=Gr();function Yr(r){switch(r){case"date":return"Published";case"reviewdate":return"Reviewed";case"addeddate":return"Added";default:return"Archived"}}function Kr(r){return r?`Archivist since ${r.getFullYear()}`:""}let pe=class extends I{constructor(){super(...arguments),this.sortParam=null,this.collectionLinks=[],this.loggedIn=!1}updated(e){e.has("model")&&this.fetchCollectionNames()}async fetchCollectionNames(){var e,t;if(!(!((e=this.model)===null||e===void 0)&&e.collections)||this.model.collections.length===0||!this.collectionNameCache)return;this.collectionLinks=[];const i=[],a=[];for(const o of this.model.collections)a.push((t=this.collectionNameCache)===null||t===void 0?void 0:t.collectionNameFor(o).then(s=>{i.push(this.detailsLink(o,s!=null?s:o))}));await Promise.all(a),this.collectionLinks=i}render(){return u`
    ...
    `}};n([p({type:Object})],wt.prototype,"model",void 0);n([p({type:Number})],wt.prototype,"currentWidth",void 0);n([p({type:Object})],wt.prototype,"sortParam",void 0);n([p({type:Number})],wt.prototype,"mobileBreakpoint",void 0);wt=n([U("tile-list-compact-header")],wt);let oe=class extends I{constructor(){super(...arguments),this.sortParam=null,this.loggedIn=!1}render(){return u`
      <div id="container">
  ...
  `;n([p({type:String})],yi.prototype,"selectedLetter",void 0);yi=n([U("alpha-bar")],yi);const fr=O`
...
${JSON.stringify(this.latestAction,null,2)}</pre
  ...
  `;n([T()],se.prototype,"currentPage",void 0);n([T()],se.prototype,"searchQuery",void 0);n([T()],se.prototype,"cellWidth",void 0);n([T()],se.prototype,"cellHeight",void 0);n([T()],se.prototype,"rowGap",void 0);n([T()],se.prototype,"colGap",void 0);n([T()],se.prototype,"loggedIn",void 0);n([p({type:Object,reflect:!1})],se.prototype,"latestAction",void 0);n([le("#base-query-field")],se.prototype,"baseQueryField",void 0);n([le("#page-number-input")],se.prototype,"pageNumberInput",void 0);n([le("collection-browser")],se.prototype,"collectionBrowser",void 0);se=n([U("app-root")],se);
