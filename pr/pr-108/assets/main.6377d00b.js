 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Ui;const gt=globalThis.trustedTypes,Ka=gt?gt.createPolicy("lit-html",{createHTML:r=>r}):void 0,_e=`lit$${(Math.random()+"").slice(9)}$`,fa="?"+_e,jo=`<${fa}>`,yt=document,Vt=(r="")=>yt.createComment(r),Wt=r=>r===null||typeof r!="object"&&typeof r!="function",Er=Array.isArray,Or=r=>{var e;return Er(r)||typeof((e=r)===null||e===void 0?void 0:e[Symbol.iterator])=="function"},Lt=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,qa=/-->/g,Xa=/>/g,He=/>|[ 	\n\r](?:([^\s"'>=/]+)([ 	\n\r]*=[ 	\n\r]*(?:[^ 	\n\r"'`<>=]|("|')|))|$)/g,Za=/'/g,Ja=/"/g,Ir=/^(?:script|style|textarea|title)$/i,Lr=r=>(e,...t)=>({_$litType$:r,strings:e,values:t}),u=Lr(1),O=Lr(2),he=Symbol.for("lit-noChange"),$=Symbol.for("lit-nothing"),er=new WeakMap,ri=(r,e,t)=>{var i,a;const o=(i=t==null?void 0:t.renderBefore)!==null&&i!==void 0?i:e;let s=o._$litPart$;if(s===void 0){const l=(a=t==null?void 0:t.renderBefore)!==null&&a!==void 0?a:null;o._$litPart$=s=new Ct(e.insertBefore(Vt(),l),l,void 0,t!=null?t:{})}return s._$AI(r),s},ft=yt.createTreeWalker(yt,129,null,!1),Fr=(r,e)=>{const t=r.length-1,i=[];let a,o=e===2?"<svg>":"",s=Lt;for(let c=0;c<t;c++){const h=r[c];let m,v,g=-1,b=0;for(;b<h.length&&(s.lastIndex=b,v=s.exec(h),v!==null);)b=s.lastIndex,s===Lt?v[1]==="!--"?s=qa:v[1]!==void 0?s=Xa:v[2]!==void 0?(Ir.test(v[2])&&(a=RegExp("</"+v[2],"g")),s=He):v[3]!==void 0&&(s=He):s===He?v[0]===">"?(s=a!=null?a:Lt,g=-1):v[1]===void 0?g=-2:(g=s.lastIndex-v[2].length,m=v[1],s=v[3]===void 0?He:v[3]==='"'?Ja:Za):s===Ja||s===Za?s=He:s===qa||s===Xa?s=Lt:(s=He,a=void 0);const S=s===He&&r[c+1].startsWith("/>")?" ":"";o+=s===Lt?h+jo:g>=0?(i.push(m),h.slice(0,g)+"$lit$"+h.slice(g)+_e+S):h+_e+(g===-2?(i.push(void 0),c):S)}const l=o+(r[t]||"<?>")+(e===2?"</svg>":"");if(!Array.isArray(r)||!r.hasOwnProperty("raw"))throw Error("invalid template strings array");return[Ka!==void 0?Ka.createHTML(l):l,i]};class jt{constructor({strings:e,_$litType$:t},i){let a;this.parts=[];let o=0,s=0;const l=e.length-1,c=this.parts,[h,m]=Fr(e,t);if(this.el=jt.createElement(h,i),ft.currentNode=this.el.content,t===2){const v=this.el.content,g=v.firstChild;g.remove(),v.append(...g.childNodes)}for(;(a=ft.nextNode())!==null&&c.length<l;){if(a.nodeType===1){if(a.hasAttributes()){const v=[];for(const g of a.getAttributeNames())if(g.endsWith("$lit$")||g.startsWith(_e)){const b=m[s++];if(v.push(g),b!==void 0){const S=a.getAttribute(b.toLowerCase()+"$lit$").split(_e),z=/([.?@])?(.*)/.exec(b);c.push({type:1,index:o,name:z[2],strings:S,ctor:z[1]==="."?Nr:z[1]==="?"?Pr:z[1]==="@"?Br:Yt})}else c.push({type:6,index:o})}for(const g of v)a.removeAttribute(g)}if(Ir.test(a.tagName)){const v=a.textContent.split(_e),g=v.length-1;if(g>0){a.textContent=gt?gt.emptyScript:"";for(let b=0;b<g;b++)a.append(v[b],Vt()),ft.nextNode(),c.push({type:2,index:++o});a.append(v[g],Vt())}}}else if(a.nodeType===8)if(a.data===fa)c.push({type:2,index:o});else{let v=-1;for(;(v=a.data.indexOf(_e,v+1))!==-1;)c.push({type:7,index:o}),v+=_e.length-1}o++}}static createElement(e,t){const i=yt.createElement("template");return i.innerHTML=e,i}}function qe(r,e,t=r,i){var a,o,s,l;if(e===he)return e;let c=i!==void 0?(a=t._$Cl)===null||a===void 0?void 0:a[i]:t._$Cu;const h=Wt(e)?void 0:e._$litDirective$;return(c==null?void 0:c.constructor)!==h&&((o=c==null?void 0:c._$AO)===null||o===void 0||o.call(c,!1),h===void 0?c=void 0:(c=new h(r),c._$AT(r,t,i)),i!==void 0?((s=(l=t)._$Cl)!==null&&s!==void 0?s:l._$Cl=[])[i]=c:t._$Cu=c),c!==void 0&&(e=qe(r,c._$AS(r,e.values),c,i)),e}class Rr{constructor(e,t){this.v=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}p(e){var t;const{el:{content:i},parts:a}=this._$AD,o=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:yt).importNode(i,!0);ft.currentNode=o;let s=ft.nextNode(),l=0,c=0,h=a[0];for(;h!==void 0;){if(l===h.index){let m;h.type===2?m=new Ct(s,s.nextSibling,this,e):h.type===1?m=new h.ctor(s,h.name,h.strings,this,e):h.type===6&&(m=new Ur(s,this,e)),this.v.push(m),h=a[++c]}l!==(h==null?void 0:h.index)&&(s=ft.nextNode(),l++)}return o}m(e){let t=0;for(const i of this.v)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class Ct{constructor(e,t,i,a){var o;this.type=2,this._$AH=$,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=a,this._$Cg=(o=a==null?void 0:a.isConnected)===null||o===void 0||o}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cg}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&e.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=qe(this,e,t),Wt(e)?e===$||e==null||e===""?(this._$AH!==$&&this._$AR(),this._$AH=$):e!==this._$AH&&e!==he&&this.$(e):e._$litType$!==void 0?this.T(e):e.nodeType!==void 0?this.k(e):Or(e)?this.S(e):this.$(e)}M(e,t=this._$AB){return this._$AA.parentNode.insertBefore(e,t)}k(e){this._$AH!==e&&(this._$AR(),this._$AH=this.M(e))}$(e){this._$AH!==$&&Wt(this._$AH)?this._$AA.nextSibling.data=e:this.k(yt.createTextNode(e)),this._$AH=e}T(e){var t;const{values:i,_$litType$:a}=e,o=typeof a=="number"?this._$AC(e):(a.el===void 0&&(a.el=jt.createElement(a.h,this.options)),a);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===o)this._$AH.m(i);else{const s=new Rr(o,this),l=s.p(this.options);s.m(i),this.k(l),this._$AH=s}}_$AC(e){let t=er.get(e.strings);return t===void 0&&er.set(e.strings,t=new jt(e)),t}S(e){Er(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,a=0;for(const o of e)a===t.length?t.push(i=new Ct(this.M(Vt()),this.M(Vt()),this,this.options)):i=t[a],i._$AI(o),a++;a<t.length&&(this._$AR(i&&i._$AB.nextSibling,a),t.length=a)}_$AR(e=this._$AA.nextSibling,t){var i;for((i=this._$AP)===null||i===void 0||i.call(this,!1,!0,t);e&&e!==this._$AB;){const a=e.nextSibling;e.remove(),e=a}}setConnected(e){var t;this._$AM===void 0&&(this._$Cg=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}}class Yt{constructor(e,t,i,a,o){this.type=1,this._$AH=$,this._$AN=void 0,this.element=e,this.name=t,this._$AM=a,this.options=o,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=$}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,i,a){const o=this.strings;let s=!1;if(o===void 0)e=qe(this,e,t,0),s=!Wt(e)||e!==this._$AH&&e!==he,s&&(this._$AH=e);else{const l=e;let c,h;for(e=o[0],c=0;c<o.length-1;c++)h=qe(this,l[i+c],t,c),h===he&&(h=this._$AH[c]),s||(s=!Wt(h)||h!==this._$AH[c]),h===$?e=$:e!==$&&(e+=(h!=null?h:"")+o[c+1]),this._$AH[c]=h}s&&!a&&this.C(e)}C(e){e===$?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e!=null?e:"")}}class Nr extends Yt{constructor(){super(...arguments),this.type=3}C(e){this.element[this.name]=e===$?void 0:e}}const Qo=gt?gt.emptyScript:"";class Pr extends Yt{constructor(){super(...arguments),this.type=4}C(e){e&&e!==$?this.element.setAttribute(this.name,Qo):this.element.removeAttribute(this.name)}}class Br extends Yt{constructor(e,t,i,a,o){super(e,t,i,a,o),this.type=5}_$AI(e,t=this){var i;if((e=(i=qe(this,e,t,0))!==null&&i!==void 0?i:$)===he)return;const a=this._$AH,o=e===$&&a!==$||e.capture!==a.capture||e.once!==a.once||e.passive!==a.passive,s=e!==$&&(a===$||o);o&&this.element.removeEventListener(this.name,this,a),s&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,i;typeof this._$AH=="function"?this._$AH.call((i=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&i!==void 0?i:this.element,e):this._$AH.handleEvent(e)}}class Ur{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){qe(this,e)}}const Go={L:"$lit$",P:_e,V:fa,I:1,N:Fr,R:Rr,j:Or,D:qe,H:Ct,F:Yt,O:Pr,W:Br,B:Nr,Z:Ur},tr=window.litHtmlPolyfillSupport;tr==null||tr(jt,Ct),((Ui=globalThis.litHtmlVersions)!==null&&Ui!==void 0?Ui:globalThis.litHtmlVersions=[]).push("2.2.4");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*oi(r,e){const t=typeof e=="function";if(r!==void 0){let i=-1;for(const a of r)i>-1&&(yield t?e(i):e),i++,yield a}}let vi=class extends I{constructor(){super(...arguments),this.snippets=[],this.viewSize="desktop"}render(){var e;return!((e=this.snippets)===null||e===void 0)&&e.length?u`
    ...
    `}};n([p({type:Array})],vi.prototype,"snippets",void 0);n([p({type:String})],vi.prototype,"viewSize",void 0);vi=n([U("text-snippet-block")],vi);const ds=y`
  .drop-shadow {
...
`;function Ts(r,e){let t=1;return r>=1e9?t=1e9:r>=1e6?t=1e6:r>=1e3&&e==="short"&&(t=1e3),t}function As(r=0,e){const t=r/e,i=t<10;let a=0;return i?a=Math.round((t+Number.EPSILON)*10)/10:a=Math.round(t),a}function Ms(r,e,t,i){switch(e){case 1e9:return Qe(t==="short"?ct`${r}B`:ct`${r} billion`);case 1e6:return Qe(t==="short"?ct`${r}M`:ct`${r} million`);case 1e3:return Qe(t==="short"?ct`${r}K`:ct`${r} thousand`);default:return new Intl.NumberFormat(i).format(r)}}function Pt(r,e="long",t="short",i="en-US"){const a=r!=null?r:-1;if(a<0)return"";const o=Ts(a,e),s=As(a,o);return Ms(s,o,t,i)}let Xe=class extends I{render(){return u`
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const fr=ga(class extends ya{constructor(r){if(super(r),r.type!==Ae.PROPERTY&&r.type!==Ae.ATTRIBUTE&&r.type!==Ae.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Jo(r))throw Error("`live` bindings can only contain a single expression")}render(r){return r}update(r,[e]){if(e===he||e===$)return e;const t=r.element,i=r.name;if(r.type===Ae.PROPERTY){if(e===t[i])return he}else if(r.type===Ae.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(i))return he}else if(r.type===Ae.ATTRIBUTE&&t.getAttribute(i)===e+"")return he;return Vr(r),e}});var qr=60,Xr=qr*60,Zr=Xr*24,cn=Zr*7,xt=1e3,Xi=qr*xt,gr=Xr*xt,dn=Zr*xt,hn=cn*xt,ba="millisecond",pt="second",ut="minute",mt="hour",Me="day",li="week",me="month",Jr="quarter",De="year",vt="date",pn="YYYY-MM-DDTHH:mm:ssZ",yr="Invalid Date",un=/^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/,mn=/\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g,vn={name:"en",weekdays:"Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),months:"January_February_March_April_May_June_July_August_September_October_November_December".split("_")},ha=function(e,t,i){var a=String(e);return!a||a.length>=t?e:""+Array(t+1-a.length).join(i)+e},fn=function(e){var t=-e.utcOffset(),i=Math.abs(t),a=Math.floor(i/60),o=i%60;return(t<=0?"+":"-")+ha(a,2,"0")+":"+ha(o,2,"0")},gn=function r(e,t){if(e.date()<t.date())return-r(t,e);var i=(t.year()-e.year())*12+(t.month()-e.month()),a=e.clone().add(i,me),o=t-a<0,s=e.clone().add(i+(o?-1:1),me);return+(-(i+(t-a)/(o?a-s:s-a))||0)},yn=function(e){return e<0?Math.ceil(e)||0:Math.floor(e)},bn=function(e){var t={M:me,y:De,w:li,d:Me,D:vt,h:mt,m:ut,s:pt,ms:ba,Q:Jr};return t[e]||String(e||"").toLowerCase().replace(/s$/,"")},wn=function(e){return e===void 0},xn={s:ha,z:fn,m:gn,a:yn,p:bn,u:wn},Ut="en",Ke={};Ke[Ut]=vn;var wa=function(e){return e instanceof _i},bi=function r(e,t,i){var a;if(!e)return Ut;if(typeof e=="string"){var o=e.toLowerCase();Ke[o]&&(a=o),t&&(Ke[o]=t,a=o);var s=e.split("-");if(!a&&s.length>1)return r(s[0])}else{var l=e.name;Ke[l]=e,a=l}return!i&&a&&(Ut=a),a||!i&&Ut},G=function(e,t){if(wa(e))return e.clone();var i=typeof t=="object"?t:{};return i.date=e,i.args=arguments,new _i(i)},Sn=function(e,t){return G(e,{locale:t.$L,utc:t.$u,x:t.$x,$offset:t.$offset})},B=xn;B.l=bi;B.i=wa;B.w=Sn;var $n=function(e){var t=e.date,i=e.utc;if(t===null)return new Date(NaN);if(B.u(t))return new Date;if(t instanceof Date)return new Date(t);if(typeof t=="string"&&!/Z$/i.test(t)){var a=t.match(un);if(a){var o=a[2]-1||0,s=(a[7]||"0").substring(0,3);return i?new Date(Date.UTC(a[1],o,a[3]||1,a[4]||0,a[5]||0,a[6]||0,s)):new Date(a[1],o,a[3]||1,a[4]||0,a[5]||0,a[6]||0,s)}}return new Date(t)},_i=function(){function r(t){this.$L=bi(t.locale,null,!0),this.parse(t)}var e=r.prototype;return e.parse=function(i){this.$d=$n(i),this.$x=i.x||{},this.init()},e.init=function(){var i=this.$d;this.$y=i.getFullYear(),this.$M=i.getMonth(),this.$D=i.getDate(),this.$W=i.getDay(),this.$H=i.getHours(),this.$m=i.getMinutes(),this.$s=i.getSeconds(),this.$ms=i.getMilliseconds()},e.$utils=function(){return B},e.isValid=function(){return this.$d.toString()!==yr},e.isSame=function(i,a){var o=G(i);return this.startOf(a)<=o&&o<=this.endOf(a)},e.isAfter=function(i,a){return G(i)<this.startOf(a)},e.isBefore=function(i,a){return this.endOf(a)<G(i)},e.$g=function(i,a,o){return B.u(i)?this[a]:this.set(o,i)},e.unix=function(){return Math.floor(this.valueOf()/1e3)},e.valueOf=function(){return this.$d.getTime()},e.startOf=function(i,a){var o=this,s=B.u(a)?!0:a,l=B.p(i),c=function(D,F){var L=B.w(o.$u?Date.UTC(o.$y,F,D):new Date(o.$y,F,D),o);return s?L:L.endOf(Me)},h=function(D,F){var L=[0,0,0,0],N=[23,59,59,999];return B.w(o.toDate()[D].apply(o.toDate("s"),(s?L:N).slice(F)),o)},m=this.$W,v=this.$M,g=this.$D,b="set"+(this.$u?"UTC":"");switch(l){case De:return s?c(1,0):c(31,11);case me:return s?c(1,v):c(0,v+1);case li:{var S=this.$locale().weekStart||0,z=(m<S?m+7:m)-S;return c(s?g-z:g+(6-z),v)}case Me:case vt:return h(b+"Hours",0);case mt:return h(b+"Minutes",1);case ut:return h(b+"Seconds",2);case pt:return h(b+"Milliseconds",3);default:return this.clone()}},e.endOf=function(i){return this.startOf(i,!1)},e.$set=function(i,a){var o,s=B.p(i),l="set"+(this.$u?"UTC":""),c=(o={},o[Me]=l+"Date",o[vt]=l+"Date",o[me]=l+"Month",o[De]=l+"FullYear",o[mt]=l+"Hours",o[ut]=l+"Minutes",o[pt]=l+"Seconds",o[ba]=l+"Milliseconds",o)[s],h=s===Me?this.$D+(a-this.$W):a;if(s===me||s===De){var m=this.clone().set(vt,1);m.$d[c](h),m.init(),this.$d=m.set(vt,Math.min(this.$D,m.daysInMonth())).$d}else c&&this.$d[c](h);return this.init(),this},e.set=function(i,a){return this.clone().$set(i,a)},e.get=function(i){return this[B.p(i)]()},e.add=function(i,a){var o=this,s;i=Number(i);var l=B.p(a),c=function(g){var b=G(o);return B.w(b.date(b.date()+Math.round(g*i)),o)};if(l===me)return this.set(me,this.$M+i);if(l===De)return this.set(De,this.$y+i);if(l===Me)return c(1);if(l===li)return c(7);var h=(s={},s[ut]=Xi,s[mt]=gr,s[pt]=xt,s)[l]||1,m=this.$d.getTime()+i*h;return B.w(m,this)},e.subtract=function(i,a){return this.add(i*-1,a)},e.format=function(i){var a=this,o=this.$locale();if(!this.isValid())return o.invalidDate||yr;var s=i||pn,l=B.z(this),c=this.$H,h=this.$m,m=this.$M,v=o.weekdays,g=o.months,b=o.meridiem,S=function(L,N,K,ne){return L&&(L[N]||L(a,s))||K[N].slice(0,ne)},z=function(L){return B.s(c%12||12,L,"0")},E=b||function(F,L,N){var K=F<12?"AM":"PM";return N?K.toLowerCase():K},D={YY:String(this.$y).slice(-2),YYYY:this.$y,M:m+1,MM:B.s(m+1,2,"0"),MMM:S(o.monthsShort,m,g,3),MMMM:S(g,m),D:this.$D,DD:B.s(this.$D,2,"0"),d:String(this.$W),dd:S(o.weekdaysMin,this.$W,v,2),ddd:S(o.weekdaysShort,this.$W,v,3),dddd:v[this.$W],H:String(c),HH:B.s(c,2,"0"),h:z(1),hh:z(2),a:E(c,h,!0),A:E(c,h,!1),m:String(h),mm:B.s(h,2,"0"),s:String(this.$s),ss:B.s(this.$s,2,"0"),SSS:B.s(this.$ms,3,"0"),Z:l};return s.replace(mn,function(F,L){return L||D[F]||l.replace(":","")})},e.utcOffset=function(){return-Math.round(this.$d.getTimezoneOffset()/15)*15},e.diff=function(i,a,o){var s,l=B.p(a),c=G(i),h=(c.utcOffset()-this.utcOffset())*Xi,m=this-c,v=B.m(this,c);return v=(s={},s[De]=v/12,s[me]=v,s[Jr]=v/3,s[li]=(m-h)/hn,s[Me]=(m-h)/dn,s[mt]=m/gr,s[ut]=m/Xi,s[pt]=m/xt,s)[l]||m,o?v:B.a(v)},e.daysInMonth=function(){return this.endOf(me).$D},e.$locale=function(){return Ke[this.$L]},e.locale=function(i,a){if(!i)return this.$L;var o=this.clone(),s=bi(i,a,!0);return s&&(o.$L=s),o},e.clone=function(){return B.w(this.$d,this)},e.toDate=function(){return new Date(this.valueOf())},e.toJSON=function(){return this.isValid()?this.toISOString():null},e.toISOString=function(){return this.$d.toISOString()},e.toString=function(){return this.$d.toUTCString()},r}(),eo=_i.prototype;G.prototype=eo;[["$ms",ba],["$s",pt],["$m",ut],["$H",mt],["$W",Me],["$M",me],["$y",De],["$D",vt]].forEach(function(r){eo[r[1]]=function(e){return this.$g(e,r[0],r[1])}});G.extend=function(r,e){return r.$i||(r(e,_i,G),r.$i=!0),G};G.locale=bi;G.isDayjs=wa;G.unix=function(r){return G(r*1e3)};G.en=Ke[Ut];G.Ls=Ke;G.p={};var Cn=function(e){return e.replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g,function(t,i,a){return i||a.slice(1)})},_n={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"},zn=function(e,t){return e.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g,function(i,a,o){var s=o&&o.toUpperCase();return a||t[o]||_n[o]||Cn(t[s])})},kn=/(\[[^[]*\])|([-:/.()\s]+)|(A|a|YYYY|YY?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g,Tn=/\d/,ai=/\d\d/,An=/\d{3}/,Mn=/\d{4}/,ye=/\d\d?/,Dn=/[+-]?\d+/,En=/[+-]\d\d:?(\d\d)?|Z/,Nt=/\d*[^\s\d-_:/()]+/,Oe={},to=function(e){return e=+e,e+(e>68?1900:2e3)};function On(r){if(!r||r==="Z")return 0;var e=r.match(/([+-]|\d\d)/g),t=+(e[1]*60)+(+e[2]||0);return t===0?0:e[0]==="+"?-t:t}var re=function(e){return function(t){this[e]=+t}},br=[En,function(r){var e=this.zone||(this.zone={});e.offset=On(r)}],Zi=function(e){var t=Oe[e];return t&&(t.indexOf?t:t.s.concat(t.f))},wr=function(e,t){var i,a=Oe,o=a.meridiem;if(!o)i=e===(t?"pm":"PM");else for(var s=1;s<=24;s+=1)if(e.indexOf(o(s,0,t))>-1){i=s>12;break}return i},In={A:[Nt,function(r){this.afternoon=wr(r,!1)}],a:[Nt,function(r){this.afternoon=wr(r,!0)}],S:[Tn,function(r){this.milliseconds=+r*100}],SS:[ai,function(r){this.milliseconds=+r*10}],SSS:[An,function(r){this.milliseconds=+r}],s:[ye,re("seconds")],ss:[ye,re("seconds")],m:[ye,re("minutes")],mm:[ye,re("minutes")],H:[ye,re("hours")],h:[ye,re("hours")],HH:[ye,re("hours")],hh:[ye,re("hours")],D:[ye,re("day")],DD:[ai,re("day")],Do:[Nt,function(r){var e=Oe,t=e.ordinal,i=r.match(/\d+/);if(this.day=i[0],!!t)for(var a=1;a<=31;a+=1)t(a).replace(/\[|\]/g,"")===r&&(this.day=a)}],M:[ye,re("month")],MM:[ai,re("month")],MMM:[Nt,function(r){var e=Zi("months"),t=Zi("monthsShort"),i=(t||e.map(function(a){return a.slice(0,3)})).indexOf(r)+1;if(i<1)throw new Error;this.month=i%12||i}],MMMM:[Nt,function(r){var e=Zi("months"),t=e.indexOf(r)+1;if(t<1)throw new Error;this.month=t%12||t}],Y:[Dn,re("year")],YY:[ai,function(r){this.year=to(r)}],YYYY:[Mn,re("year")],Z:br,ZZ:br};function Ln(r){var e=r.afternoon;if(e!==void 0){var t=r.hours;e?t<12&&(r.hours+=12):t===12&&(r.hours=0),delete r.afternoon}}function Fn(r){r=zn(r,Oe&&Oe.formats);for(var e=r.match(kn),t=e.length,i=0;i<t;i+=1){var a=e[i],o=In[a],s=o&&o[0],l=o&&o[1];l?e[i]={regex:s,parser:l}:e[i]=a.replace(/^\[|\]$/g,"")}return function(c){for(var h={},m=0,v=0;m<t;m+=1){var g=e[m];if(typeof g=="string")v+=g.length;else{var b=g.regex,S=g.parser,z=c.slice(v),E=b.exec(z),D=E[0];S.call(h,D),c=c.replace(D,"")}}return Ln(h),h}}var Rn=function(e,t,i){try{if(["x","X"].indexOf(t)>-1)return new Date((t==="X"?1e3:1)*e);var a=Fn(t),o=a(e),s=o.year,l=o.month,c=o.day,h=o.hours,m=o.minutes,v=o.seconds,g=o.milliseconds,b=o.zone,S=new Date,z=c||(!s&&!l?S.getDate():1),E=s||S.getFullYear(),D=0;s&&!l||(D=l>0?l-1:S.getMonth());var F=h||0,L=m||0,N=v||0,K=g||0;return b?new Date(Date.UTC(E,D,z,F,L,N,K+b.offset*60*1e3)):i?new Date(Date.UTC(E,D,z,F,L,N,K)):new Date(E,D,z,F,L,N,K)}catch{return new Date("")}},Nn=function(r,e,t){t.p.customParseFormat=!0,r&&r.parseTwoDigitYear&&(to=r.parseTwoDigitYear);var i=e.prototype,a=i.parse;i.parse=function(o){var s=o.date,l=o.utc,c=o.args;this.$u=l;var h=c[1];if(typeof h=="string"){var m=c[2]===!0,v=c[3]===!0,g=m||v,b=c[2];v&&(b=c[2]),Oe=this.$locale(),!m&&b&&(Oe=t.Ls[b]),this.$d=Rn(s,h,l),this.init(),b&&b!==!0&&(this.$L=this.locale(b).$L),g&&s!=this.format(h)&&(this.$d=new Date("")),Oe={}}else if(h instanceof Array)for(var S=h.length,z=1;z<=S;z+=1){c[1]=h[z-1];var E=t.apply(this,c);if(E.isValid()){this.$d=E.$d,this.$L=E.$L,this.init();break}z===S&&(this.$d=new Date(""))}else a.call(this,o)}};const Pn=Object.freeze({processing:"processing",complete:"complete"});class Bn extends I{static get properties(){return{mode:{type:String}}}constructor(){super(),this.mode=Pn.processing}render(){return u`
      <div class="${this.mode}">
        <svg
          viewBox="0 0 120 120"
