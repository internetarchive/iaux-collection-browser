...
`;const nl=["mediatype","year","subject","collection","creator","language"],ll={subjectSorter:"subject",mediatypeSorter:"mediatype",languageSorter:"language",creatorSorter:"creator",collection:"collection",year:"year"},kr={subject:"Subject",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"};let Z=class extends I{constructor(){super(...arguments),this.facetsLoading=!1,this.fullYearAggregationLoading=!1,this.collapsableFacets=!1,this.showHistogramDatePicker=!1,this.openFacets={subject:!1,mediatype:!1,language:!1,creator:!1,collection:!1,year:!1}}render(){return u`
    ...
    `}facetClicked(e,t,i){const a=e.target,{checked:o,name:s,value:l}=a;o?this.facetChecked(s,l,i):this.facetUnchecked(s,l),this.onFacetClick&&this.onFacetClick(s,i)}facetChecked(e,t,i){const{selectedFacets:a}=this;let o;a?o=ce({},a):o=gi,o[e][t]=i?"hidden":"selected",this.selectedFacets=o}facetUnchecked(e,t){const{selectedFacets:i}=this;let a;i?a=ce({},i):a=gi,delete a[e][t],this.selectedFacets=a}getFacetOptionFromKey(e){const a=e.split("__")[2].split(":")[1],o=Object.entries(ll).find(([l])=>a.includes(l)),s=o==null?void 0:o[1];if(!s)throw new Error(`Could not find facet option for key: ${e}`);return s}static get styles(){return y`
      #container.loading {
        opacity: 0.5;
      }
