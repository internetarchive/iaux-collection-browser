...
`+me),gt&&(me=Qe(me,et," "),me=Qe(me,tt," ")),O&&wi?O.createHTML(me):me},e.setConfig=function(M){co(M),io=!0},e.clearConfig=function(){$t=null,io=!1},e.isValidAttribute=function(M,v,x){$t||co({});var C=rt(M),V=rt(v);return Wr(C,V,x)},e.addHook=function(M,v){typeof v=="function"&&(xe[M]=xe[M]||[],Zt(xe[M],v))},e.removeHook=function(M){if(xe[M])return ga(xe[M])},e.removeHooks=function(M){xe[M]&&(xe[M]=[])},e.removeAllHooks=function(){xe={}},e}var Li=Ps();let Wi=class extends ne{constructor(){super(...arguments),this.collectionLinks=[]}render(){return c`
    ...
    >
      ${Li.sanitize(t)}</a
    >`}detailsLink(e,t,i=!1){if(!e)return y;const o=t!=null?t:e,a=this.displayValueProvider.itemPageUrl(e,i);return c`<a href=${a}> ${Li.sanitize(o)} </a>`}get mediatypeURL(){var e;if(this.baseNavigationUrl===void 0||!(!((e=this.model)===null||e===void 0)&&e.mediatype))return y;switch(this.model.mediatype){case"collection":return`${this.baseNavigationUrl}/search?query=mediatype:collection&sort=-downloads`;case"account":return y;default:return this.displayValueProvider.itemPageUrl(this.model.mediatype,!0)}}updated(e){(e.has("model")||e.has("collectionTitles"))&&this.buildCollectionLinks()}async buildCollectionLinks(){var e,t,i;if(!(!((e=this.model)===null||e===void 0)&&e.collections)||this.model.collections.length===0)return;this.collectionLinks=[];const o=[];for(const a of this.model.collections)!Yi[a]&&!a.startsWith("fav-")&&o.push(this.detailsLink(a,(i=(t=this.collectionTitles)===null||t===void 0?void 0:t.get(a))!==null&&i!==void 0?i:a,!0));this.collectionLinks=o}get date(){var e,t,i,o,a;switch((e=this.sortParam)===null||e===void 0?void 0:e.field){case"date":return(t=this.model)===null||t===void 0?void 0:t.datePublished;case"reviewdate":return(i=this.model)===null||i===void 0?void 0:i.dateReviewed;case"addeddate":return(o=this.model)===null||o===void 0?void 0:o.dateAdded;default:return(a=this.model)===null||a===void 0?void 0:a.dateArchived}}get classSize(){return this.mobileBreakpoint&&this.currentWidth&&this.currentWidth<this.mobileBreakpoint?"mobile":"desktop"}get formatSize(){return this.mobileBreakpoint&&this.currentWidth&&this.currentWidth<this.mobileBreakpoint?"short":"long"}static get styles(){return f`
      html {
        font-size: unset;
      }
