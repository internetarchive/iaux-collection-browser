 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Qo;const mo=window,Zt=mo.trustedTypes,Ur=Zt?Zt.createPolicy("lit-html",{createHTML:s=>s}):void 0,ks="$lit$",ct=`lit$${(Math.random()+"").slice(9)}$`,Wa="?"+ct,cl=`<${Wa}>`,Lt=document,vo=()=>Lt.createComment(""),Fi=s=>s===null||typeof s!="object"&&typeof s!="function",ja=Array.isArray,hl=s=>ja(s)||typeof(s==null?void 0:s[Symbol.iterator])=="function",Yo=`[ 	
 ...
 */const oa=(s,e,t)=>{const i=new Map;for(let o=e;o<=t;o++)i.set(s[o],o);return i},sr=Wi(class extends ji{constructor(s){if(super(s),s.type!==Ge.CHILD)throw Error("repeat() can only be used in text expressions")}ct(s,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);const o=[],r=[];let a=0;for(const l of s)o[a]=i?i(l,a):a,r[a]=t(l,a),a++;return{values:r,keys:o}}render(s,e,t){return this.ct(s,e,t).values}update(s,[e,t,i]){var o;const r=Ul(s),{values:a,keys:l}=this.ct(e,t,i);if(!Array.isArray(r))return this.ut=l,a;const d=(o=this.ut)!==null&&o!==void 0?o:this.ut=[],u=[];let p,v,g=0,y=r.length-1,w=0,$=a.length-1;for(;g<=y&&w<=$;)if(r[g]===null)g++;else if(r[y]===null)y--;else if(d[g]===l[w])u[w]=St(r[g],a[w]),g++,w++;else if(d[y]===l[$])u[$]=St(r[y],a[$]),y--,$--;else if(d[g]===l[$])u[$]=St(r[g],a[$]),bi(s,u[$+1],r[g]),g++,$--;else if(d[y]===l[w])u[w]=St(r[y],a[w]),bi(s,r[g],r[y]),y--,w++;else if(p===void 0&&(p=oa(l,w,$),v=oa(d,g,y)),p.has(d[g]))if(p.has(d[y])){const C=v.get(l[w]),A=C!==void 0?r[C]:null;if(A===null){const E=bi(s,r[g]);St(E,a[w]),u[w]=E}else u[w]=St(A,a[w]),bi(s,r[g],A),r[C]=null;w++}else ts(r[y]),y--;else ts(r[g]),g++;for(;w<=$;){const C=bi(s,u[$+1]);St(C,a[w]),u[w++]=C}for(;g<=y;){const C=r[g++];C!==null&&ts(C)}return this.ut=l,sn(s,u),Ae}});function Ji(s,e,t){return Array.from({length:(e-s)/t+1},(i,o)=>s+o*t)}let ot=class extends B{constructor(){super(...arguments),this.itemCount=0,this.scrollOptimizationsDisabled=!1,this.intersectionObserver=new IntersectionObserver(e=>{e.forEach(t=>{if(t.target===this.sentinel){t.isIntersecting&&this.dispatchEvent(new Event("scrollThresholdReached"));return}const o=t.target.dataset.cellIndex;if(!o)return;const r=parseInt(o,10);t.isIntersecting?this.visibleCellIndices.add(r):this.visibleCellIndices.delete(r)}),this.scrollOptimizationsDisabled||this.processVisibleCells()}),this.renderedCellIndices=new Set,this.visibleCellIndices=new Set,this.placeholderCellIndices=new Set}reload(){Ji(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.removeCell(t)),this.renderedCellIndices.clear(),this.visibleCellIndices.clear(),this.placeholderCellIndices.clear(),this.setupObservations()}refreshCell(e){this.removeCell(e),this.bufferRange.includes(e)&&this.renderCellBuffer([e])}refreshAllVisibleCells(){this.bufferRange.forEach(e=>this.removeCell(e)),this.renderCellBuffer(this.bufferRange)}scrollToCell(e,t){const i=this.cellContainers[e];if(!i)return!1;const o=t?"smooth":"auto";return i.scrollIntoView({behavior:o}),!0}getVisibleCellIndices(){return Array.from(this.visibleCellIndices)}updated(e){(e.has("itemCount")||e.has("scrollOptimizationsDisabled"))&&this.setupObservations()}disconnectedCallback(){this.intersectionObserver.disconnect()}setupObservations(){this.setupIntersectionObserver()}setupIntersectionObserver(){this.intersectionObserver.disconnect(),this.sentinel&&this.intersectionObserver.observe(this.sentinel),this.scrollOptimizationsDisabled?(Ji(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.visibleCellIndices.add(t)),this.processVisibleCells()):this.cellContainers.forEach(e=>this.intersectionObserver.observe(e))}render(){var e;const t=this.itemCount-1,i=Ji(0,t,1),o=(e=this.ariaLandmarkLabel)!==null&&e!==void 0?e:b;return h`
    ...
    `}};n([c({type:Number})],ot.prototype,"itemCount",void 0);n([c({type:Object})],ot.prototype,"cellProvider",void 0);n([c({type:Object})],ot.prototype,"placeholderCellTemplate",void 0);n([c({type:Boolean})],ot.prototype,"scrollOptimizationsDisabled",void 0);n([c({type:String})],ot.prototype,"ariaLandmarkLabel",void 0);n([G("#sentinel")],ot.prototype,"sentinel",void 0);n([Dl(".cell-container")],ot.prototype,"cellContainers",void 0);ot=n([R("infinite-scroller")],ot);function Hl(s){return s==null?void 0:s.replace(/%22%22(?!%22%22)(.+?)%22%22/g,"%22$1%22")}function Vl(s){var e,t,i;return((e=s==null?void 0:s.rawMetadata)===null||e===void 0?void 0:e.hit_type)==="favorited_search"?"search":(i=(t=s.mediatype)===null||t===void 0?void 0:t.value)!==null&&i!==void 0?i:"data"}const Wl=O`
  <svg
    viewBox="0 0 100 100"
...
`;var Ys;let Ui=Ys=class extends B{render(){return h`${this.facetRowTemplate}`}get facetRowTemplate(){var e,t,i,o;const{bucket:r,facetType:a}=this;if(!r||!a)return b;const l=`${a}:${r.key}-show-only`,d=`${a}:${r.key}-negative`,u=r.extraNote?h`<span class="facet-note">${r.extraNote}</span>`:b,p=a!=="collection"?h`${(e=r.displayText)!==null&&e!==void 0?e:r.key} ${u}`:h`<a href="/details/${r.key}">
    ...
    `}partOfCollectionClicked(e){var t;(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:Qe.default,action:ee.partOfCollectionClicked,label:e.target.dataset.id})}showDatePickerModal(){var e,t,i;const{fullYearsHistogramAggregation:o}=this,r=o==null?void 0:o.first_bucket_key,a=o==null?void 0:o.last_bucket_key,l=o==null?void 0:o.buckets,d=this.isTvSearch?"YYYY-MM":"YYYY",p=h`
