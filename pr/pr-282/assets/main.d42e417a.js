var Sr=Object.defineProperty,Cr=Object.defineProperties;var $r=Object.getOwnPropertyDescriptors;var Zo=Object.getOwnPropertySymbols;var kr=Object.prototype.hasOwnProperty,Tr=Object.prototype.propertyIsEnumerable;var Jo=(a,e,t)=>e in a?Sr(a,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):a[e]=t,re=(a,e)=>{for(var t in e||(e={}))kr.call(e,t)&&Jo(a,t,e[t]);if(Zo)for(var t of Zo(e))Tr.call(e,t)&&Jo(a,t,e[t]);return a},xe=(a,e)=>Cr(a,$r(e));import Ji from"https://esm.archive.org/dayjs@^1.10.7";import zr from"https://esm.archive.org/dayjs@1.9.4/esm/plugin/customParseFormat";const Mr=function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function t(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerpolicy&&(r.referrerPolicy=o.referrerpolicy),o.crossorigin==="use-credentials"?r.credentials="include":o.crossorigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(o){if(o.ep)return;o.ep=!0;const r=t(o);fetch(o.href,r)}};Mr();function s(a,e,t,i){var o=arguments.length,r=o<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(a,e,t,i);else for(var l=a.length-1;l>=0;l--)(n=a[l])&&(r=(o<3?n(r):o>3?n(e,t,r):n(e,t))||r);return o>3&&r&&Object.defineProperty(e,t,r),r}function Er(a,e,t,i){function o(r){return r instanceof t?r:new t(function(n){n(r)})}return new(t||(t=Promise))(function(r,n){function l(v){try{p(i.next(v))}catch(f){n(f)}}function d(v){try{p(i.throw(v))}catch(f){n(f)}}function p(v){v.done?r(v.value):o(v.value).then(l,d)}p((i=i.apply(a,e||[])).next())})}class Dr{constructor(e){var t,i,o,r;this.ARCHIVE_ANALYTICS_VERSION=2,this.DEFAULT_SERVICE="ao_2",this.NO_SAMPLING_SERVICE="ao_no_sampling",this.DEFAULT_IMAGE_URL="https://analytics.archive.org/0.gif",this.defaultService=(t=e==null?void 0:e.defaultService)!==null&&t!==void 0?t:this.DEFAULT_SERVICE,this.imageUrl=(i=e==null?void 0:e.imageUrl)!==null&&i!==void 0?i:this.DEFAULT_IMAGE_URL,this.imageContainer=(o=e==null?void 0:e.imageContainer)!==null&&o!==void 0?o:document.body,this.requireImagePing=(r=e==null?void 0:e.requireImagePing)!==null&&r!==void 0?r:!1}sendPing(e){const t=this.generateTrackingUrl(e).toString();if(this.requireImagePing){this.sendPingViaImage(t);return}const i=navigator.sendBeacon&&navigator.sendBeacon.bind(navigator);try{i(t)}catch{this.sendPingViaImage(t)}}sendEvent(e){const t=e.label&&e.label.trim().length>0?e.label:window.location.pathname,i=re({kind:"event",ec:e.category,ea:e.action,el:t,cache_bust:Math.random()},e.eventConfiguration);this.sendPing(i)}sendEventNoSampling(e){const t=e.eventConfiguration||{};t.service=this.NO_SAMPLING_SERVICE;const i=e;i.eventConfiguration=t,this.sendEvent(i)}sendPingViaImage(e){const t=new Image(1,1);t.src=e,t.alt="",this.imageContainer.appendChild(t)}generateTrackingUrl(e){var t;const i=e!=null?e:{};i.service=(t=i.service)!==null&&t!==void 0?t:this.defaultService;const o=new URL(this.imageUrl),r=Object.keys(i);return r.forEach(n=>{const l=i[n];o.searchParams.append(n,l)}),o.searchParams.append("version",`${this.ARCHIVE_ANALYTICS_VERSION}`),o.searchParams.append("count",`${r.length+2}`),o}}function b(a){let e,t,i;return typeof a=="object"?(e=a.hashFunction,t=a.expiring,i=a.tags):e=a,(o,r,n)=>{if(n.value!=null)n.value=ea(n.value,e,t,i);else if(n.get!=null)n.get=ea(n.get,e,t,i);else throw"Only put a Memoize() decorator on a method or get accessor."}}const Bi=new Map;function ea(a,e,t=0,i){const o=Symbol("__memoized_map__");return function(...r){let n;this.hasOwnProperty(o)||Object.defineProperty(this,o,{configurable:!1,enumerable:!1,writable:!1,value:new Map});let l=this[o];if(Array.isArray(i))for(const d of i)Bi.has(d)?Bi.get(d).push(l):Bi.set(d,[l]);if(e||r.length>0||t>0){let d;e===!0?d=r.map(f=>f.toString()).join("!"):e?d=e.apply(this,r):d=r[0];const p=`${d}__timestamp`;let v=!1;if(t>0)if(!l.has(p))v=!0;else{let f=l.get(p);v=Date.now()-f>t}l.has(d)&&!v?n=l.get(d):(n=a.apply(this,r),l.set(d,n),t>0&&l.set(p,Date.now()))}else{const d=this;l.has(d)?n=l.get(d):(n=a.apply(this,r),l.set(d,n))}return n}}class eo{parseValue(e){return typeof e=="string"&&(e==="false"||e==="0")?!1:Boolean(e)}}eo.shared=new eo;class bi{parseValue(e){if(typeof e=="number")return e;if(typeof e=="boolean")return;const t=parseFloat(e);if(!Number.isNaN(t))return t}}bi.shared=new bi;class to{parseValue(e){return bi.shared.parseValue(e)}}to.shared=new to;class io{parseValue(e){return this.parseJSDate(e)||this.parseBracketDate(e)}parseBracketDate(e){if(typeof e!="string")return;const t=e.match(/\[([0-9]{4})\]/);if(!(!t||t.length<2))return this.parseJSDate(t[1])}parseJSDate(e){if(typeof e!="string")return;let t=e;t.match(/^[0-9]{4}-[0-9]{2}-[0-9]{2}\s{1}[0-9]{2}:[0-9]{2}:[0-9]{2}$/)&&(t=t.replace(" ","T"));const i=Date.parse(t);if(Number.isNaN(i))return;let o=new Date(t);return(t.indexOf("Z")>-1||t.indexOf("+")>-1||t.match(/^[0-9]{4}$/)||t.match(/^[0-9]{4}-[0-9]{2}-[0-9]{2}$/)||t.match(/^.*?-[0-9]{2}:[0-9]{2}$/)||t.match(/^.*?-[0-9]{4}$/))&&(o=new Date(o.getTime()+o.getTimezoneOffset()*1e3*60)),o}}io.shared=new io;class oo{parseValue(e){if(typeof e=="number")return e;if(typeof e=="boolean")return;const t=e.split(":");let i;return t.length===1?i=this.parseNumberFormat(t[0]):i=this.parseColonSeparatedFormat(t),i}parseNumberFormat(e){let t=parseFloat(e);return Number.isNaN(t)&&(t=void 0),t}parseColonSeparatedFormat(e){let t=!1;const i=e.map((o,r)=>{const n=parseFloat(o);if(Number.isNaN(n))return t=!0,0;const l=e.length-1-r,d=60**l;return n*Math.floor(d)}).reduce((o,r)=>o+r,0);return t?void 0:i}}oo.shared=new oo;class ao{parseValue(e){if(typeof e=="string")return e}}ao.shared=new ao;class Lr{constructor(e,t){this.separators=[";",","],this.parser=e,t&&t.separators&&(this.separators=t.separators)}parseValue(e){const t=String(e);let i=[];for(const o of this.separators)if(i=t.split(o),i.length>1)break;return this.parseListValues(i)}parseListValues(e){const i=e.map(r=>r.trim()).map(r=>this.parser.parseValue(r)),o=[];return i.forEach(r=>{r!==void 0&&o.push(r)}),o}}class ro{parseValue(e){if(typeof e=="string")return e}}ro.shared=new ro;class yi{parseValue(e){return String(e)}}yi.shared=new yi;class ze{constructor(e,t){this.parser=e,this.rawValue=t}get values(){return this.parseRawValue()}get value(){return this.values[0]}parseRawValue(){if(this.rawValue===void 0)return[];const e=Array.isArray(this.rawValue)?this.rawValue:[this.rawValue],t=[];return e.forEach(i=>{const o=this.parser.parseValue(i);Array.isArray(o)?t.push(...o):o!==void 0&&t.push(o)}),t}}s([b()],ze.prototype,"values",null);s([b()],ze.prototype,"value",null);class Tt extends ze{constructor(e){super(eo.shared,e)}}class se extends ze{constructor(e){super(io.shared,e)}}class Oi extends ze{constructor(e){super(oo.shared,e)}}class W extends ze{constructor(e){super(bi.shared,e)}}class M extends ze{constructor(e){super(yi.shared,e)}}class Pr extends ze{constructor(e){super(ro.shared,e)}}class wi extends ze{constructor(e){super(to.shared,e)}}class Co extends ze{constructor(e){super(ao.shared,e)}}class Ar extends ze{constructor(e,t){super(t,e)}}class Fr extends Ar{constructor(e){const t=new Lr(yi.shared);super(e,t)}}class k{constructor(e){this.rawMetadata=e}get identifier(){var e;return(e=this.rawMetadata)===null||e===void 0?void 0:e.identifier}get addeddate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.addeddate?new se(this.rawMetadata.addeddate):void 0}get audio_codec(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.audio_codec?new M(this.rawMetadata.audio_codec):void 0}get audio_sample_rate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.audio_sample_rate?new W(this.rawMetadata.audio_sample_rate):void 0}get avg_rating(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.avg_rating?new W(this.rawMetadata.avg_rating):void 0}get collection(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.collection?new M(this.rawMetadata.collection):void 0}get collections_raw(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.collections_raw?new M(this.rawMetadata.collections_raw):void 0}get collection_size(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.collection_size?new wi(this.rawMetadata.collection_size):void 0}get contributor(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.contributor?new M(this.rawMetadata.contributor):void 0}get coverage(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.coverage?new M(this.rawMetadata.coverage):void 0}get creator(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.creator?new M(this.rawMetadata.creator):void 0}get date(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.date?new se(this.rawMetadata.date):void 0}get description(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.description?new M(this.rawMetadata.description):void 0}get downloads(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.downloads?new W(this.rawMetadata.downloads):void 0}get duration(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.duration?new Oi(this.rawMetadata.duration):void 0}get"external-identifier"(){var e,t;return!((e=this.rawMetadata)===null||e===void 0)&&e["external-identifier"]?new M((t=this.rawMetadata)===null||t===void 0?void 0:t["external-identifier"]):void 0}get files_count(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.files_count?new W(this.rawMetadata.files_count):void 0}get indexdate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.indexdate?new se(this.rawMetadata.indexdate):void 0}get isbn(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.isbn?new M(this.rawMetadata.isbn):void 0}get issue(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.issue?new M(this.rawMetadata.issue):void 0}get item_count(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.item_count?new W(this.rawMetadata.item_count):void 0}get item_size(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.item_size?new wi(this.rawMetadata.item_size):void 0}get language(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.language?new M(this.rawMetadata.language):void 0}get length(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.length?new Oi(this.rawMetadata.length):void 0}get lineage(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.lineage?new M(this.rawMetadata.lineage):void 0}get month(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.month?new W(this.rawMetadata.month):void 0}get mediatype(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.mediatype?new Co(this.rawMetadata.mediatype):void 0}get noindex(){var e;return((e=this.rawMetadata)===null||e===void 0?void 0:e.noindex)!=null?new Tt(this.rawMetadata.noindex):void 0}get notes(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.notes?new M(this.rawMetadata.notes):void 0}get num_favorites(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.num_favorites?new W(this.rawMetadata.num_favorites):void 0}get num_reviews(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.num_reviews?new W(this.rawMetadata.num_reviews):void 0}get openlibrary_edition(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.openlibrary_edition?new M(this.rawMetadata.openlibrary_edition):void 0}get openlibrary_work(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.openlibrary_work?new M(this.rawMetadata.openlibrary_work):void 0}get page_progression(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.page_progression?new Pr(this.rawMetadata.page_progression):void 0}get partner(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.partner?new M(this.rawMetadata.partner):void 0}get ppi(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.ppi?new W(this.rawMetadata.ppi):void 0}get publicdate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.publicdate?new se(this.rawMetadata.publicdate):void 0}get publisher(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.publisher?new M(this.rawMetadata.publisher):void 0}get reviewdate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.reviewdate?new se(this.rawMetadata.reviewdate):void 0}get runtime(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.runtime?new Oi(this.rawMetadata.runtime):void 0}get scanner(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.scanner?new M(this.rawMetadata.scanner):void 0}get source(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.source?new M(this.rawMetadata.source):void 0}get start_localtime(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.start_localtime?new se(this.rawMetadata.start_localtime):void 0}get start_time(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.start_time?new se(this.rawMetadata.start_time):void 0}get stop_time(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.stop_time?new se(this.rawMetadata.stop_time):void 0}get subject(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.subject?new Fr(this.rawMetadata.subject):void 0}get taper(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.taper?new M(this.rawMetadata.taper):void 0}get title(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.title?new M(this.rawMetadata.title):void 0}get transferer(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.transferer?new M(this.rawMetadata.transferer):void 0}get track(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.track?new W(this.rawMetadata.track):void 0}get type(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.type?new M(this.rawMetadata.type):void 0}get uploader(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.uploader?new M(this.rawMetadata.uploader):void 0}get utc_offset(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.utc_offset?new W(this.rawMetadata.utc_offset):void 0}get venue(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.venue?new M(this.rawMetadata.venue):void 0}get volume(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.volume?new M(this.rawMetadata.volume):void 0}get week(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.week?new W(this.rawMetadata.week):void 0}get year(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.year?new se(this.rawMetadata.year):void 0}}s([b()],k.prototype,"addeddate",null);s([b()],k.prototype,"audio_codec",null);s([b()],k.prototype,"audio_sample_rate",null);s([b()],k.prototype,"avg_rating",null);s([b()],k.prototype,"collection",null);s([b()],k.prototype,"collections_raw",null);s([b()],k.prototype,"collection_size",null);s([b()],k.prototype,"contributor",null);s([b()],k.prototype,"coverage",null);s([b()],k.prototype,"creator",null);s([b()],k.prototype,"date",null);s([b()],k.prototype,"description",null);s([b()],k.prototype,"downloads",null);s([b()],k.prototype,"duration",null);s([b()],k.prototype,"external-identifier",null);s([b()],k.prototype,"files_count",null);s([b()],k.prototype,"indexdate",null);s([b()],k.prototype,"isbn",null);s([b()],k.prototype,"issue",null);s([b()],k.prototype,"item_count",null);s([b()],k.prototype,"item_size",null);s([b()],k.prototype,"language",null);s([b()],k.prototype,"length",null);s([b()],k.prototype,"lineage",null);s([b()],k.prototype,"month",null);s([b()],k.prototype,"mediatype",null);s([b()],k.prototype,"noindex",null);s([b()],k.prototype,"notes",null);s([b()],k.prototype,"num_favorites",null);s([b()],k.prototype,"num_reviews",null);s([b()],k.prototype,"openlibrary_edition",null);s([b()],k.prototype,"openlibrary_work",null);s([b()],k.prototype,"page_progression",null);s([b()],k.prototype,"partner",null);s([b()],k.prototype,"ppi",null);s([b()],k.prototype,"publicdate",null);s([b()],k.prototype,"publisher",null);s([b()],k.prototype,"reviewdate",null);s([b()],k.prototype,"runtime",null);s([b()],k.prototype,"scanner",null);s([b()],k.prototype,"source",null);s([b()],k.prototype,"start_localtime",null);s([b()],k.prototype,"start_time",null);s([b()],k.prototype,"stop_time",null);s([b()],k.prototype,"subject",null);s([b()],k.prototype,"taper",null);s([b()],k.prototype,"title",null);s([b()],k.prototype,"transferer",null);s([b()],k.prototype,"track",null);s([b()],k.prototype,"type",null);s([b()],k.prototype,"uploader",null);s([b()],k.prototype,"utc_offset",null);s([b()],k.prototype,"venue",null);s([b()],k.prototype,"volume",null);s([b()],k.prototype,"week",null);s([b()],k.prototype,"year",null);class I{constructor(e){this.rawMetadata=e}get identifier(){var e,t;return(t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.identifier}get addeddate(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.addeddate?new se(this.rawMetadata.fields.addeddate):void 0}get avg_rating(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.avg_rating)!=null?new W(this.rawMetadata.fields.avg_rating):void 0}get collection(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.collection?new M(this.rawMetadata.fields.collection):void 0}get collection_files_count(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.collection_files_count)!=null?new W(this.rawMetadata.fields.collection_files_count):void 0}get collection_size(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.collection_size)!=null?new wi(this.rawMetadata.fields.collection_size):void 0}get creator(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.creator?new M(this.rawMetadata.fields.creator):void 0}get date(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.date?new se(this.rawMetadata.fields.date):void 0}get description(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.description?new M(this.rawMetadata.fields.description):void 0}get downloads(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.downloads)!=null?new W(this.rawMetadata.fields.downloads):void 0}get files_count(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.files_count)!=null?new W(this.rawMetadata.fields.files_count):void 0}get genre(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.genre?new M(this.rawMetadata.fields.genre):void 0}get indexflag(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.indexflag?new M(this.rawMetadata.fields.indexflag):void 0}get issue(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.issue?new M(this.rawMetadata.fields.issue):void 0}get item_count(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.item_count)!=null?new W(this.rawMetadata.fields.item_count):void 0}get item_size(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.item_size)!=null?new wi(this.rawMetadata.fields.item_size):void 0}get language(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.language?new M(this.rawMetadata.fields.language):void 0}get lending___available_to_borrow(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.lending___available_to_borrow)!=null?new Tt(this.rawMetadata.fields.lending___available_to_borrow):void 0}get lending___available_to_browse(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.lending___available_to_browse)!=null?new Tt(this.rawMetadata.fields.lending___available_to_browse):void 0}get lending___available_to_waitlist(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.lending___available_to_waitlist)!=null?new Tt(this.rawMetadata.fields.lending___available_to_waitlist):void 0}get lending___status(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.lending___status?new M(this.rawMetadata.fields.lending___status):void 0}get licenseurl(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.licenseurl?new M(this.rawMetadata.fields.licenseurl):void 0}get mediatype(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.mediatype?new Co(this.rawMetadata.fields.mediatype):void 0}get month(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.month)!=null?new W(this.rawMetadata.fields.month):void 0}get noindex(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.noindex)!=null?new Tt(this.rawMetadata.fields.noindex):void 0}get num_favorites(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.num_favorites)!=null?new W(this.rawMetadata.fields.num_favorites):void 0}get num_reviews(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.num_reviews)!=null?new W(this.rawMetadata.fields.num_reviews):void 0}get publicdate(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.publicdate?new se(this.rawMetadata.fields.publicdate):void 0}get reviewdate(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.reviewdate?new se(this.rawMetadata.fields.reviewdate):void 0}get source(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.source?new M(this.rawMetadata.fields.source):void 0}get subject(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.subject?new M(this.rawMetadata.fields.subject):void 0}get title(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.title?new M(this.rawMetadata.fields.title):void 0}get type(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.type?new M(this.rawMetadata.fields.type):void 0}get volume(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.volume?new M(this.rawMetadata.fields.volume):void 0}get week(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.week)!=null?new W(this.rawMetadata.fields.week):void 0}get year(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.year)!=null?new W(this.rawMetadata.fields.year):void 0}}s([b()],I.prototype,"addeddate",null);s([b()],I.prototype,"avg_rating",null);s([b()],I.prototype,"collection",null);s([b()],I.prototype,"collection_files_count",null);s([b()],I.prototype,"collection_size",null);s([b()],I.prototype,"creator",null);s([b()],I.prototype,"date",null);s([b()],I.prototype,"description",null);s([b()],I.prototype,"downloads",null);s([b()],I.prototype,"files_count",null);s([b()],I.prototype,"genre",null);s([b()],I.prototype,"indexflag",null);s([b()],I.prototype,"issue",null);s([b()],I.prototype,"item_count",null);s([b()],I.prototype,"item_size",null);s([b()],I.prototype,"language",null);s([b()],I.prototype,"lending___available_to_borrow",null);s([b()],I.prototype,"lending___available_to_browse",null);s([b()],I.prototype,"lending___available_to_waitlist",null);s([b()],I.prototype,"lending___status",null);s([b()],I.prototype,"licenseurl",null);s([b()],I.prototype,"mediatype",null);s([b()],I.prototype,"month",null);s([b()],I.prototype,"noindex",null);s([b()],I.prototype,"num_favorites",null);s([b()],I.prototype,"num_reviews",null);s([b()],I.prototype,"publicdate",null);s([b()],I.prototype,"reviewdate",null);s([b()],I.prototype,"source",null);s([b()],I.prototype,"subject",null);s([b()],I.prototype,"title",null);s([b()],I.prototype,"type",null);s([b()],I.prototype,"volume",null);s([b()],I.prototype,"week",null);s([b()],I.prototype,"year",null);class j{constructor(e){this.rawMetadata=e}get identifier(){var e,t;return(t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.identifier}get highlight(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.highlight)===null||t===void 0)&&t.text?new M(this.rawMetadata.highlight.text):void 0}get addeddate(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.addeddate?new se(this.rawMetadata.fields.addeddate):void 0}get avg_rating(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.avg_rating)!=null?new W(this.rawMetadata.fields.avg_rating):void 0}get collection(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.collection?new M(this.rawMetadata.fields.collection):void 0}get created_on(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.created_on?new se(this.rawMetadata.fields.created_on):void 0}get creator(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.creator?new M(this.rawMetadata.fields.creator):void 0}get date(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.date?new se(this.rawMetadata.fields.date):void 0}get description(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.description?new M(this.rawMetadata.fields.description):void 0}get downloads(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.downloads)!=null?new W(this.rawMetadata.fields.downloads):void 0}get filename(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.filename?new M(this.rawMetadata.fields.filename):void 0}get file_basename(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.file_basename?new M(this.rawMetadata.fields.file_basename):void 0}get file_creation_mtime(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.file_creation_mtime)!=null?new W(this.rawMetadata.fields.file_creation_mtime):void 0}get issue(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.issue?new M(this.rawMetadata.fields.issue):void 0}get mediatype(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.mediatype?new Co(this.rawMetadata.fields.mediatype):void 0}get page_num(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.page_num)!=null?new W(this.rawMetadata.fields.page_num):void 0}get publicdate(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.publicdate?new se(this.rawMetadata.fields.publicdate):void 0}get result_in_subfile(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.result_in_subfile)!=null?new Tt(this.rawMetadata.fields.result_in_subfile):void 0}get reviewdate(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.reviewdate?new se(this.rawMetadata.fields.reviewdate):void 0}get source(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.source?new M(this.rawMetadata.fields.source):void 0}get subject(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.subject?new M(this.rawMetadata.fields.subject):void 0}get title(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.title?new M(this.rawMetadata.fields.title):void 0}get updated_on(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.updated_on?new se(this.rawMetadata.fields.updated_on):void 0}get year(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.year)!=null?new W(this.rawMetadata.fields.year):void 0}get __href__(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.__href__?new M(this.rawMetadata.fields.__href__):void 0}}s([b()],j.prototype,"highlight",null);s([b()],j.prototype,"addeddate",null);s([b()],j.prototype,"avg_rating",null);s([b()],j.prototype,"collection",null);s([b()],j.prototype,"created_on",null);s([b()],j.prototype,"creator",null);s([b()],j.prototype,"date",null);s([b()],j.prototype,"description",null);s([b()],j.prototype,"downloads",null);s([b()],j.prototype,"filename",null);s([b()],j.prototype,"file_basename",null);s([b()],j.prototype,"file_creation_mtime",null);s([b()],j.prototype,"issue",null);s([b()],j.prototype,"mediatype",null);s([b()],j.prototype,"page_num",null);s([b()],j.prototype,"publicdate",null);s([b()],j.prototype,"result_in_subfile",null);s([b()],j.prototype,"reviewdate",null);s([b()],j.prototype,"source",null);s([b()],j.prototype,"subject",null);s([b()],j.prototype,"title",null);s([b()],j.prototype,"updated_on",null);s([b()],j.prototype,"year",null);s([b()],j.prototype,"__href__",null);var X;(function(a){a[a.COUNT=0]="COUNT",a[a.ALPHABETICAL=1]="ALPHABETICAL",a[a.NUMERIC=2]="NUMERIC"})(X||(X={}));class Ra{constructor(e){this.buckets=e.buckets,this.doc_count_error_upper_bound=e.doc_count_error_upper_bound,this.sum_other_doc_count=e.sum_other_doc_count,this.first_bucket_key=e.first_bucket_key,this.last_bucket_key=e.last_bucket_key,this.number_buckets=e.number_buckets,this.interval=e.interval}getSortedBuckets(e){const t=[...this.buckets];if(this.isRawNumberBuckets(t))return t;const i=new Intl.Collator;switch(e){case X.ALPHABETICAL:return t.sort((o,r)=>i.compare(o.key.toString(),r.key.toString()));case X.NUMERIC:return t.sort((o,r)=>Number(r.key)-Number(o.key));case X.COUNT:default:return t}}isRawNumberBuckets(e){return typeof this.buckets[0]=="number"}}s([b()],Ra.prototype,"getSortedBuckets",null);class $o{constructor(e,t){var i,o,r,n,l,d,p;this.schema=t;const v=t==null?void 0:t.hit_type;this.totalResults=(o=(i=e==null?void 0:e.hits)===null||i===void 0?void 0:i.total)!==null&&o!==void 0?o:0,this.returnedCount=(n=(r=e==null?void 0:e.hits)===null||r===void 0?void 0:r.returned)!==null&&n!==void 0?n:0,this.results=(p=(d=(l=e==null?void 0:e.hits)===null||l===void 0?void 0:l.hits)===null||d===void 0?void 0:d.map(f=>{var g;return $o.createResult((g=f.hit_type)!==null&&g!==void 0?g:v,f)}))!==null&&p!==void 0?p:[],e!=null&&e.aggregations&&(this.aggregations=Object.entries(e.aggregations).reduce((f,[g,w])=>(f[g]=new Ra(w),f),{})),e!=null&&e.collection_titles&&(this.collectionTitles=e.collection_titles),e!=null&&e.collection_extra_info&&(this.collectionExtraInfo=e.collection_extra_info)}static createResult(e,t){switch(e){case"item":return new I(t);case"text":return new j(t);default:return new I(t)}}}class Ir{constructor(e){this.clientParameters=e.client_parameters,this.backendRequests=e.backend_requests,this.kind=e.kind}}class Br{constructor(e){var t,i,o;this.rawResponse=e,this.request=new Ir(e.request),this.responseHeader=(t=e.response)===null||t===void 0?void 0:t.header,this.response=new $o((i=e.response)===null||i===void 0?void 0:i.body,(o=e.response)===null||o===void 0?void 0:o.hit_schema)}}class Na{static aggregateSearchParamsAsString(e){if(e.omit)return"false";if(e.advancedParams){const t=e.advancedParams.map(o=>({terms:o}));return JSON.stringify(t)}if(e.simpleParams)return e.simpleParams.join(",")}static sortParamsAsString(e){return`${e.field}:${e.direction}`}static filterParamsAsString(e){return JSON.stringify(e)}static generateURLSearchParams(e){const t=new URLSearchParams;if(t.append("user_query",e.query),e.pageType&&t.append("page_type",String(e.pageType)),e.pageTarget&&t.append("page_target",String(e.pageTarget)),e.rows!=null&&t.append("hits_per_page",String(e.rows)),e.page!=null&&t.append("page",String(e.page)),e.fields&&e.fields.length>0&&t.append("fields",e.fields.join(",")),e.filters&&Object.keys(e.filters).length>0){const o=this.filterParamsAsString(e.filters);o&&o!=="{}"&&t.append("filter_map",o)}if(e.sort&&e.sort.length>0){const o=e.sort.map(r=>this.sortParamsAsString(r));t.append("sort",o.join(","))}const i=e.aggregations;if(i){const o=this.aggregateSearchParamsAsString(i);o&&t.append("aggregations",o)}if(e.aggregationsSize!=null&&t.append("aggregations_size",String(e.aggregationsSize)),e.debugging&&t.append("debugging","true"),e.uid&&t.append("uid",e.uid),e.includeClientUrl!==!1){const o=window.location.href.slice(0,400);e.query.length<=1e3&&t.append("client_url",o)}return t}}var Wt;(function(a){a.networkError="SearchService.NetworkError",a.itemNotFound="SearchService.ItemNotFound",a.decodingError="SearchService.DecodingError",a.searchEngineError="SearchService.SearchEngineError"})(Wt||(Wt={}));class Or extends Error{constructor(e,t,i){super(t),this.name=e,this.type=e,this.details=i}}class Ua{constructor(e){var t,i;this.baseUrl=(t=e==null?void 0:e.baseUrl)!==null&&t!==void 0?t:"archive.org",this.debuggingEnabled=(i=e==null?void 0:e.debuggingEnabled)!==null&&i!==void 0?i:!1,(e==null?void 0:e.includeCredentials)!==void 0?this.includeCredentials=e.includeCredentials:this.includeCredentials=window.location.href.match(/^https?:\/\/.*archive\.org(:[0-9]+)?/)!==null;const o=new URL(window.location.href),r=o.searchParams.get("scope"),n=o.searchParams.get("caching"),l=o.searchParams.get("verbose");(e==null?void 0:e.scope)!==void 0?this.requestScope=e.scope:r&&(this.requestScope=r),(e==null?void 0:e.caching)!==void 0?this.cachingFlags=e.caching:n&&(this.cachingFlags=n),(e==null?void 0:e.verbose)!==void 0?this.verbose=e.verbose:l&&(this.verbose=!!l)}async fetchUrl(e,t){var i,o;const r=new URL(e);this.requestScope&&r.searchParams.set("scope",this.requestScope),this.cachingFlags&&r.searchParams.set("caching",this.cachingFlags);let n;try{const l=(i=t==null?void 0:t.requestOptions)!==null&&i!==void 0?i:{credentials:this.includeCredentials?"include":"same-origin"};n=await fetch(r.href,l)}catch(l){const d=l instanceof Error?l.message:typeof l=="string"?l:"Unknown error";return this.getErrorResult(Wt.networkError,d)}try{const l=await n.json();this.verbose&&this.printResponse(l),l.debugging&&this.printDebuggingInfo(l);const d=(o=l.response)===null||o===void 0?void 0:o.error;return d?this.getErrorResult(Wt.searchEngineError,d.message,d.forensics):{success:l}}catch(l){const d=l instanceof Error?l.message:typeof l=="string"?l:"Unknown error";return this.getErrorResult(Wt.decodingError,d)}}getErrorResult(e,t,i){return{error:new Or(e,t,i)}}printResponse(e){var t,i,o,r,n;try{const l=JSON.parse(JSON.stringify(e)),d=(o=(i=(t=l==null?void 0:l.response)===null||t===void 0?void 0:t.body)===null||i===void 0?void 0:i.hits)===null||o===void 0?void 0:o.hits;if(Array.isArray(d)&&d.length>1){const v=[];v.push(d[0]),v.push(`*** ${d.length-1} hits omitted ***`),l.response.body.hits.hits=v}const p=(n=(r=l==null?void 0:l.response)===null||r===void 0?void 0:r.body)===null||n===void 0?void 0:n.aggregations;p&&Object.entries(p).forEach(([v,f])=>{var g,w,C,E;if(((w=(g=f)===null||g===void 0?void 0:g.buckets)===null||w===void 0?void 0:w.length)>0){const L=JSON.parse(JSON.stringify(f));L.buckets=`*** ${(E=(C=L.buckets)===null||C===void 0?void 0:C.length)!==null&&E!==void 0?E:0} buckets omitted ***`,l.response.body.aggregations[v]=L}}),console.log("***** RESPONSE RECEIVED *****"),console.groupCollapsed("Response"),console.log(JSON.stringify(l,null,2)),console.groupEnd()}catch(l){console.error("Error printing search response:",l)}}printDebuggingInfo(e){var t,i;const o=e.debugging,r=(t=o.messages)!==null&&t!==void 0?t:[],n=(i=o.data)!==null&&i!==void 0?i:{};console.log("***** BEGIN DEBUGGING *****"),console.log("Full response:"),console.log(JSON.stringify(e,null,2)),console.group("Debug messages");for(const l of r)console.log(l);console.groupEnd(),console.group("Debug data");for(const[l,d]of Object.entries(n))console.log(l,d);console.groupEnd(),console.log("***** END DEBUGGING *****")}}class Rr extends Ua{constructor(e){var t;super(e),this.servicePath=(t=e==null?void 0:e.servicePath)!==null&&t!==void 0?t:"/services/search/beta/page_production"}async performSearch(e){this.debuggingEnabled&&e.debugging===void 0&&(e.debugging=!0);const i=Na.generateURLSearchParams(e).toString(),o=`https://${this.baseUrl}${this.servicePath}/?service_backend=metadata&${i}`;return this.fetchUrl(o)}}class Nr extends Ua{constructor(e){var t;super(e),this.servicePath=(t=e==null?void 0:e.servicePath)!==null&&t!==void 0?t:"/services/search/beta/page_production"}async performSearch(e){this.debuggingEnabled&&e.debugging===void 0&&(e.debugging=!0);const i=Na.generateURLSearchParams(e).toString(),o=`https://${this.baseUrl}${this.servicePath}/?service_backend=fts&${i}`;return this.fetchUrl(o)}}var pe;(function(a){a[a.METADATA=0]="METADATA",a[a.FULLTEXT=1]="FULLTEXT"})(pe||(pe={}));class Ye{constructor(e={}){this.backendOptions=e}async search(e,t=pe.METADATA){const o=await Ye.getBackendForSearchType(t,this.backendOptions).performSearch(e);return o.error?o:{success:new Br(o.success)}}static getBackendForSearchType(e,t={}){switch(e){case pe.FULLTEXT:return new Nr(t);case pe.METADATA:default:return new Rr(t)}}}Ye.default=new Ye;s([b((a,e={})=>{const{includeCredentials:t=!1,verbose:i=!1,scope:o="",baseUrl:r=""}=e;return`${a};${t};${i};${o};${r}`})],Ye,"getBackendForSearchType",null);var Ke;(function(a){a.INCLUDE="inc",a.EXCLUDE="exc",a.GREATER_THAN="gt",a.GREATER_OR_EQUAL="gte",a.LESS_THAN="lt",a.LESS_OR_EQUAL="lte"})(Ke||(Ke={}));class Ur{constructor(){this.filterMap={}}addFilter(e,t,i){if(this.filterMap[e]||(this.filterMap[e]={}),this.filterMap[e][t]){const o=[].concat(this.filterMap[e][t],i);this.filterMap[e][t]=Array.from(new Set(o))}else this.filterMap[e][t]=i;return this}removeSingleFilter(e,t,i){var o;if(!(!((o=this.filterMap[e])===null||o===void 0)&&o[t]))return this;const r=[].concat(this.filterMap[e][t]),n=r.indexOf(i);return n>=0&&r.splice(n,1),this.filterMap[e][t]=r.length===1?r[0]:r,r.length===0&&delete this.filterMap[e][t],this.deleteFieldIfEmpty(e),this}removeFilters(e,t){return this.filterMap[e]?(delete this.filterMap[e][t],this.deleteFieldIfEmpty(e),this):this}deleteFieldIfEmpty(e){const t=this.filterMap[e];t&&Object.keys(t).length===0&&delete this.filterMap[e]}setFilterMap(e){return this.filterMap=re({},e),this}mergeFilterMap(e){for(const[t,i]of Object.entries(e))for(const[o,r]of Object.entries(i))if(Array.isArray(r))for(const n of r)this.addFilter(t,o,n);else this.addFilter(t,o,r);return this}build(){return this.filterMap}}function Hr(){var a=!navigator.userAgentData&&/Safari\//.test(navigator.userAgent)&&!/Chrom(e|ium)\//.test(navigator.userAgent);if(!a||!indexedDB.databases)return Promise.resolve();var e;return new Promise(function(t){var i=function(){return indexedDB.databases().finally(t)};e=setInterval(i,100),i()}).finally(function(){return clearInterval(e)})}function Pt(a){return new Promise((e,t)=>{a.oncomplete=a.onsuccess=()=>e(a.result),a.onabort=a.onerror=()=>t(a.error)})}function Wr(a,e){const t=Hr().then(()=>{const i=indexedDB.open(a);return i.onupgradeneeded=()=>i.result.createObjectStore(e),Pt(i)});return(i,o)=>t.then(r=>o(r.transaction(e,i).objectStore(e)))}let Ri;function Mi(){return Ri||(Ri=Wr("keyval-store","keyval")),Ri}function Vr(a,e=Mi()){return e("readonly",t=>Pt(t.get(a)))}function jr(a,e,t=Mi()){return t("readwrite",i=>(i.put(e,a),Pt(i.transaction)))}function Gr(a,e=Mi()){return e("readwrite",t=>(t.delete(a),Pt(t.transaction)))}function Qr(a,e){return a.openCursor().onsuccess=function(){!this.result||(e(this.result),this.result.continue())},Pt(a.transaction)}function qr(a=Mi()){return a("readonly",e=>{if(e.getAllKeys)return Pt(e.getAllKeys());const t=[];return Qr(e,i=>t.push(i.key)).then(()=>t)})}function Kr(a,e){return a.setMilliseconds(a.getMilliseconds()+e*1e3),a}class Yr{constructor(e){var t,i,o,r;if(this.namespace=(t=e==null?void 0:e.namespace)!==null&&t!==void 0?t:"LocalCache",this.defaultTTL=(i=e==null?void 0:e.defaultTTL)!==null&&i!==void 0?i:15*60,(!((o=e==null?void 0:e.immediateClean)!==null&&o!==void 0)||o)&&this.cleanExpired(),!(e!=null&&e.disableCleaning)){const n=(r=e==null?void 0:e.cleaningInterval)!==null&&r!==void 0?r:60;setInterval(()=>{this.cleanExpired()},n*1e3)}}async set(e){var t;const i={value:e.value},o=(t=e.ttl)!==null&&t!==void 0?t:this.defaultTTL,r=Kr(new Date,o);i.expires=r;const n=this.getNamespacedKey(e.key);try{await jr(n,i)}catch{}}async get(e){const t=this.getNamespacedKey(e);let i;try{i=await Vr(t)}catch{}if(!i)return;const o=new Date;if(i.expires&&i.expires<o){await this.delete(e);return}return i.value}async delete(e){const t=this.getNamespacedKey(e);try{await Gr(t)}catch{}}async cleanExpired(){const e=await this.getAllKeys();await Promise.all(e.map(async t=>this.get(t)))}async getAllKeys(){let e=[];try{e=await qr()}catch{}const t=[];for(const r of e)typeof r=="string"&&t.push(r);return t.filter(r=>r.startsWith(this.namespace)).map(r=>this.removeNamespace(r))}getNamespacedKey(e){return`${this.namespace}-${e}`}removeNamespace(e){return e.replace(`${this.namespace}-`,"")}}/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ko=window.ShadowRoot&&(window.ShadyCSS===void 0||window.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,To=Symbol(),ta=new Map;class Ha{constructor(e,t){if(this._$cssResult$=!0,t!==To)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e}get styleSheet(){let e=ta.get(this.cssText);return ko&&e===void 0&&(ta.set(this.cssText,e=new CSSStyleSheet),e.replaceSync(this.cssText)),e}toString(){return this.cssText}}const Xr=a=>new Ha(typeof a=="string"?a:a+"",To),m=(a,...e)=>{const t=a.length===1?a[0]:e.reduce((i,o,r)=>i+(n=>{if(n._$cssResult$===!0)return n.cssText;if(typeof n=="number")return n;throw Error("Value passed to 'css' function must be a 'css' function result: "+n+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(o)+a[r+1],a[0]);return new Ha(t,To)},Zr=(a,e)=>{ko?a.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet):e.forEach(t=>{const i=document.createElement("style"),o=window.litNonce;o!==void 0&&i.setAttribute("nonce",o),i.textContent=t.cssText,a.appendChild(i)})},ia=ko?a=>a:a=>a instanceof CSSStyleSheet?(e=>{let t="";for(const i of e.cssRules)t+=i.cssText;return Xr(t)})(a):a;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Ni;const oa=window.trustedTypes,Jr=oa?oa.emptyScript:"",aa=window.reactiveElementPolyfillSupport,so={toAttribute(a,e){switch(e){case Boolean:a=a?Jr:null;break;case Object:case Array:a=a==null?a:JSON.stringify(a)}return a},fromAttribute(a,e){let t=a;switch(e){case Boolean:t=a!==null;break;case Number:t=a===null?null:Number(a);break;case Object:case Array:try{t=JSON.parse(a)}catch{t=null}}return t}},Wa=(a,e)=>e!==a&&(e==e||a==a),Ui={attribute:!0,type:String,converter:so,reflect:!1,hasChanged:Wa};class kt extends HTMLElement{constructor(){super(),this._$Et=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Ei=null,this.o()}static addInitializer(e){var t;(t=this.l)!==null&&t!==void 0||(this.l=[]),this.l.push(e)}static get observedAttributes(){this.finalize();const e=[];return this.elementProperties.forEach((t,i)=>{const o=this._$Eh(i,t);o!==void 0&&(this._$Eu.set(o,i),e.push(o))}),e}static createProperty(e,t=Ui){if(t.state&&(t.attribute=!1),this.finalize(),this.elementProperties.set(e,t),!t.noAccessor&&!this.prototype.hasOwnProperty(e)){const i=typeof e=="symbol"?Symbol():"__"+e,o=this.getPropertyDescriptor(e,i,t);o!==void 0&&Object.defineProperty(this.prototype,e,o)}}static getPropertyDescriptor(e,t,i){return{get(){return this[t]},set(o){const r=this[e];this[t]=o,this.requestUpdate(e,r,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)||Ui}static finalize(){if(this.hasOwnProperty("finalized"))return!1;this.finalized=!0;const e=Object.getPrototypeOf(this);if(e.finalize(),this.elementProperties=new Map(e.elementProperties),this._$Eu=new Map,this.hasOwnProperty("properties")){const t=this.properties,i=[...Object.getOwnPropertyNames(t),...Object.getOwnPropertySymbols(t)];for(const o of i)this.createProperty(o,t[o])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const i=new Set(e.flat(1/0).reverse());for(const o of i)t.unshift(ia(o))}else e!==void 0&&t.push(ia(e));return t}static _$Eh(e,t){const i=t.attribute;return i===!1?void 0:typeof i=="string"?i:typeof e=="string"?e.toLowerCase():void 0}o(){var e;this._$Ep=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$Em(),this.requestUpdate(),(e=this.constructor.l)===null||e===void 0||e.forEach(t=>t(this))}addController(e){var t,i;((t=this._$Eg)!==null&&t!==void 0?t:this._$Eg=[]).push(e),this.renderRoot!==void 0&&this.isConnected&&((i=e.hostConnected)===null||i===void 0||i.call(e))}removeController(e){var t;(t=this._$Eg)===null||t===void 0||t.splice(this._$Eg.indexOf(e)>>>0,1)}_$Em(){this.constructor.elementProperties.forEach((e,t)=>{this.hasOwnProperty(t)&&(this._$Et.set(t,this[t]),delete this[t])})}createRenderRoot(){var e;const t=(e=this.shadowRoot)!==null&&e!==void 0?e:this.attachShadow(this.constructor.shadowRootOptions);return Zr(t,this.constructor.elementStyles),t}connectedCallback(){var e;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$Eg)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostConnected)===null||i===void 0?void 0:i.call(t)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$Eg)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostDisconnected)===null||i===void 0?void 0:i.call(t)})}attributeChangedCallback(e,t,i){this._$AK(e,i)}_$ES(e,t,i=Ui){var o,r;const n=this.constructor._$Eh(e,i);if(n!==void 0&&i.reflect===!0){const l=((r=(o=i.converter)===null||o===void 0?void 0:o.toAttribute)!==null&&r!==void 0?r:so.toAttribute)(t,i.type);this._$Ei=e,l==null?this.removeAttribute(n):this.setAttribute(n,l),this._$Ei=null}}_$AK(e,t){var i,o,r;const n=this.constructor,l=n._$Eu.get(e);if(l!==void 0&&this._$Ei!==l){const d=n.getPropertyOptions(l),p=d.converter,v=(r=(o=(i=p)===null||i===void 0?void 0:i.fromAttribute)!==null&&o!==void 0?o:typeof p=="function"?p:null)!==null&&r!==void 0?r:so.fromAttribute;this._$Ei=l,this[l]=v(t,d.type),this._$Ei=null}}requestUpdate(e,t,i){let o=!0;e!==void 0&&(((i=i||this.constructor.getPropertyOptions(e)).hasChanged||Wa)(this[e],t)?(this._$AL.has(e)||this._$AL.set(e,t),i.reflect===!0&&this._$Ei!==e&&(this._$EC===void 0&&(this._$EC=new Map),this._$EC.set(e,i))):o=!1),!this.isUpdatePending&&o&&(this._$Ep=this._$E_())}async _$E_(){this.isUpdatePending=!0;try{await this._$Ep}catch(t){Promise.reject(t)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var e;if(!this.isUpdatePending)return;this.hasUpdated,this._$Et&&(this._$Et.forEach((o,r)=>this[r]=o),this._$Et=void 0);let t=!1;const i=this._$AL;try{t=this.shouldUpdate(i),t?(this.willUpdate(i),(e=this._$Eg)===null||e===void 0||e.forEach(o=>{var r;return(r=o.hostUpdate)===null||r===void 0?void 0:r.call(o)}),this.update(i)):this._$EU()}catch(o){throw t=!1,this._$EU(),o}t&&this._$AE(i)}willUpdate(e){}_$AE(e){var t;(t=this._$Eg)===null||t===void 0||t.forEach(i=>{var o;return(o=i.hostUpdated)===null||o===void 0?void 0:o.call(i)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EU(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$Ep}shouldUpdate(e){return!0}update(e){this._$EC!==void 0&&(this._$EC.forEach((t,i)=>this._$ES(i,this[i],t)),this._$EC=void 0),this._$EU()}updated(e){}firstUpdated(e){}}kt.finalized=!0,kt.elementProperties=new Map,kt.elementStyles=[],kt.shadowRootOptions={mode:"open"},aa==null||aa({ReactiveElement:kt}),((Ni=globalThis.reactiveElementVersions)!==null&&Ni!==void 0?Ni:globalThis.reactiveElementVersions=[]).push("1.3.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Hi;const Mt=globalThis.trustedTypes,ra=Mt?Mt.createPolicy("lit-html",{createHTML:a=>a}):void 0,Ue=`lit$${(Math.random()+"").slice(9)}$`,zo="?"+Ue,es=`<${zo}>`,Et=document,Gt=(a="")=>Et.createComment(a),Qt=a=>a===null||typeof a!="object"&&typeof a!="function",Va=Array.isArray,ja=a=>{var e;return Va(a)||typeof((e=a)===null||e===void 0?void 0:e[Symbol.iterator])=="function"},Nt=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,sa=/-->/g,na=/>/g,lt=/>|[ 	\n\r](?:([^\s"'>=/]+)([ 	\n\r]*=[ 	\n\r]*(?:[^ 	\n\r"'`<>=]|("|')|))|$)/g,la=/'/g,da=/"/g,Ga=/^(?:script|style|textarea|title)$/i,Qa=a=>(e,...t)=>({_$litType$:a,strings:e,values:t}),h=Qa(1),O=Qa(2),ye=Symbol.for("lit-noChange"),y=Symbol.for("lit-nothing"),ca=new WeakMap,ui=(a,e,t)=>{var i,o;const r=(i=t==null?void 0:t.renderBefore)!==null&&i!==void 0?i:e;let n=r._$litPart$;if(n===void 0){const l=(o=t==null?void 0:t.renderBefore)!==null&&o!==void 0?o:null;r._$litPart$=n=new At(e.insertBefore(Gt(),l),l,void 0,t!=null?t:{})}return n._$AI(a),n},zt=Et.createTreeWalker(Et,129,null,!1),qa=(a,e)=>{const t=a.length-1,i=[];let o,r=e===2?"<svg>":"",n=Nt;for(let d=0;d<t;d++){const p=a[d];let v,f,g=-1,w=0;for(;w<p.length&&(n.lastIndex=w,f=n.exec(p),f!==null);)w=n.lastIndex,n===Nt?f[1]==="!--"?n=sa:f[1]!==void 0?n=na:f[2]!==void 0?(Ga.test(f[2])&&(o=RegExp("</"+f[2],"g")),n=lt):f[3]!==void 0&&(n=lt):n===lt?f[0]===">"?(n=o!=null?o:Nt,g=-1):f[1]===void 0?g=-2:(g=n.lastIndex-f[2].length,v=f[1],n=f[3]===void 0?lt:f[3]==='"'?da:la):n===da||n===la?n=lt:n===sa||n===na?n=Nt:(n=lt,o=void 0);const C=n===lt&&a[d+1].startsWith("/>")?" ":"";r+=n===Nt?p+es:g>=0?(i.push(v),p.slice(0,g)+"$lit$"+p.slice(g)+Ue+C):p+Ue+(g===-2?(i.push(void 0),d):C)}const l=r+(a[t]||"<?>")+(e===2?"</svg>":"");if(!Array.isArray(a)||!a.hasOwnProperty("raw"))throw Error("invalid template strings array");return[ra!==void 0?ra.createHTML(l):l,i]};class qt{constructor({strings:e,_$litType$:t},i){let o;this.parts=[];let r=0,n=0;const l=e.length-1,d=this.parts,[p,v]=qa(e,t);if(this.el=qt.createElement(p,i),zt.currentNode=this.el.content,t===2){const f=this.el.content,g=f.firstChild;g.remove(),f.append(...g.childNodes)}for(;(o=zt.nextNode())!==null&&d.length<l;){if(o.nodeType===1){if(o.hasAttributes()){const f=[];for(const g of o.getAttributeNames())if(g.endsWith("$lit$")||g.startsWith(Ue)){const w=v[n++];if(f.push(g),w!==void 0){const C=o.getAttribute(w.toLowerCase()+"$lit$").split(Ue),E=/([.?@])?(.*)/.exec(w);d.push({type:1,index:r,name:E[2],strings:C,ctor:E[1]==="."?Ya:E[1]==="?"?Xa:E[1]==="@"?Za:ti})}else d.push({type:6,index:r})}for(const g of f)o.removeAttribute(g)}if(Ga.test(o.tagName)){const f=o.textContent.split(Ue),g=f.length-1;if(g>0){o.textContent=Mt?Mt.emptyScript:"";for(let w=0;w<g;w++)o.append(f[w],Gt()),zt.nextNode(),d.push({type:2,index:++r});o.append(f[g],Gt())}}}else if(o.nodeType===8)if(o.data===zo)d.push({type:2,index:r});else{let f=-1;for(;(f=o.data.indexOf(Ue,f+1))!==-1;)d.push({type:7,index:r}),f+=Ue.length-1}r++}}static createElement(e,t){const i=Et.createElement("template");return i.innerHTML=e,i}}function vt(a,e,t=a,i){var o,r,n,l;if(e===ye)return e;let d=i!==void 0?(o=t._$Cl)===null||o===void 0?void 0:o[i]:t._$Cu;const p=Qt(e)?void 0:e._$litDirective$;return(d==null?void 0:d.constructor)!==p&&((r=d==null?void 0:d._$AO)===null||r===void 0||r.call(d,!1),p===void 0?d=void 0:(d=new p(a),d._$AT(a,t,i)),i!==void 0?((n=(l=t)._$Cl)!==null&&n!==void 0?n:l._$Cl=[])[i]=d:t._$Cu=d),d!==void 0&&(e=vt(a,d._$AS(a,e.values),d,i)),e}class Ka{constructor(e,t){this.v=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}p(e){var t;const{el:{content:i},parts:o}=this._$AD,r=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:Et).importNode(i,!0);zt.currentNode=r;let n=zt.nextNode(),l=0,d=0,p=o[0];for(;p!==void 0;){if(l===p.index){let v;p.type===2?v=new At(n,n.nextSibling,this,e):p.type===1?v=new p.ctor(n,p.name,p.strings,this,e):p.type===6&&(v=new Ja(n,this,e)),this.v.push(v),p=o[++d]}l!==(p==null?void 0:p.index)&&(n=zt.nextNode(),l++)}return r}m(e){let t=0;for(const i of this.v)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class At{constructor(e,t,i,o){var r;this.type=2,this._$AH=y,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=o,this._$Cg=(r=o==null?void 0:o.isConnected)===null||r===void 0||r}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cg}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&e.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=vt(this,e,t),Qt(e)?e===y||e==null||e===""?(this._$AH!==y&&this._$AR(),this._$AH=y):e!==this._$AH&&e!==ye&&this.$(e):e._$litType$!==void 0?this.T(e):e.nodeType!==void 0?this.k(e):ja(e)?this.S(e):this.$(e)}M(e,t=this._$AB){return this._$AA.parentNode.insertBefore(e,t)}k(e){this._$AH!==e&&(this._$AR(),this._$AH=this.M(e))}$(e){this._$AH!==y&&Qt(this._$AH)?this._$AA.nextSibling.data=e:this.k(Et.createTextNode(e)),this._$AH=e}T(e){var t;const{values:i,_$litType$:o}=e,r=typeof o=="number"?this._$AC(e):(o.el===void 0&&(o.el=qt.createElement(o.h,this.options)),o);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===r)this._$AH.m(i);else{const n=new Ka(r,this),l=n.p(this.options);n.m(i),this.k(l),this._$AH=n}}_$AC(e){let t=ca.get(e.strings);return t===void 0&&ca.set(e.strings,t=new qt(e)),t}S(e){Va(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,o=0;for(const r of e)o===t.length?t.push(i=new At(this.M(Gt()),this.M(Gt()),this,this.options)):i=t[o],i._$AI(r),o++;o<t.length&&(this._$AR(i&&i._$AB.nextSibling,o),t.length=o)}_$AR(e=this._$AA.nextSibling,t){var i;for((i=this._$AP)===null||i===void 0||i.call(this,!1,!0,t);e&&e!==this._$AB;){const o=e.nextSibling;e.remove(),e=o}}setConnected(e){var t;this._$AM===void 0&&(this._$Cg=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}}class ti{constructor(e,t,i,o,r){this.type=1,this._$AH=y,this._$AN=void 0,this.element=e,this.name=t,this._$AM=o,this.options=r,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=y}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,i,o){const r=this.strings;let n=!1;if(r===void 0)e=vt(this,e,t,0),n=!Qt(e)||e!==this._$AH&&e!==ye,n&&(this._$AH=e);else{const l=e;let d,p;for(e=r[0],d=0;d<r.length-1;d++)p=vt(this,l[i+d],t,d),p===ye&&(p=this._$AH[d]),n||(n=!Qt(p)||p!==this._$AH[d]),p===y?e=y:e!==y&&(e+=(p!=null?p:"")+r[d+1]),this._$AH[d]=p}n&&!o&&this.C(e)}C(e){e===y?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e!=null?e:"")}}class Ya extends ti{constructor(){super(...arguments),this.type=3}C(e){this.element[this.name]=e===y?void 0:e}}const ts=Mt?Mt.emptyScript:"";class Xa extends ti{constructor(){super(...arguments),this.type=4}C(e){e&&e!==y?this.element.setAttribute(this.name,ts):this.element.removeAttribute(this.name)}}class Za extends ti{constructor(e,t,i,o,r){super(e,t,i,o,r),this.type=5}_$AI(e,t=this){var i;if((e=(i=vt(this,e,t,0))!==null&&i!==void 0?i:y)===ye)return;const o=this._$AH,r=e===y&&o!==y||e.capture!==o.capture||e.once!==o.once||e.passive!==o.passive,n=e!==y&&(o===y||r);r&&this.element.removeEventListener(this.name,this,o),n&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,i;typeof this._$AH=="function"?this._$AH.call((i=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&i!==void 0?i:this.element,e):this._$AH.handleEvent(e)}}class Ja{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){vt(this,e)}}const is={L:"$lit$",P:Ue,V:zo,I:1,N:qa,R:Ka,j:ja,D:vt,H:At,F:ti,O:Xa,W:Za,B:Ya,Z:Ja},ha=window.litHtmlPolyfillSupport;ha==null||ha(qt,At),((Hi=globalThis.litHtmlVersions)!==null&&Hi!==void 0?Hi:globalThis.litHtmlVersions=[]).push("2.2.4");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Wi,Vi;class F extends kt{constructor(){super(...arguments),this.renderOptions={host:this},this._$Dt=void 0}createRenderRoot(){var e,t;const i=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=i.firstChild),i}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Dt=ui(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Dt)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Dt)===null||e===void 0||e.setConnected(!1)}render(){return ye}}F.finalized=!0,F._$litElement$=!0,(Wi=globalThis.litElementHydrateSupport)===null||Wi===void 0||Wi.call(globalThis,{LitElement:F});const pa=globalThis.litElementPolyfillSupport;pa==null||pa({LitElement:F});((Vi=globalThis.litElementVersions)!==null&&Vi!==void 0?Vi:globalThis.litElementVersions=[]).push("3.2.0");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */const va=(a,e,t)=>{const i=new Map;for(let o=e;o<=t;o++)i.set(a[o],o);return i},or=ii(class extends oi{constructor(a){if(super(a),a.type!==Le.CHILD)throw Error("repeat() can only be used in text expressions")}dt(a,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);const o=[],r=[];let n=0;for(const l of a)o[n]=i?i(l,n):n,r[n]=t(l,n),n++;return{values:r,keys:o}}render(a,e,t){return this.dt(a,e,t).values}update(a,[e,t,i]){var o;const r=ds(a),{values:n,keys:l}=this.dt(e,t,i);if(!Array.isArray(r))return this.ut=l,n;const d=(o=this.ut)!==null&&o!==void 0?o:this.ut=[],p=[];let v,f,g=0,w=r.length-1,C=0,E=n.length-1;for(;g<=w&&C<=E;)if(r[g]===null)g++;else if(r[w]===null)w--;else if(d[g]===l[C])p[C]=dt(r[g],n[C]),g++,C++;else if(d[w]===l[E])p[E]=dt(r[w],n[E]),w--,E--;else if(d[g]===l[E])p[E]=dt(r[g],n[E]),Ut(a,p[E+1],r[g]),g++,E--;else if(d[w]===l[C])p[C]=dt(r[w],n[C]),Ut(a,r[g],r[w]),w--,C++;else if(v===void 0&&(v=va(l,C,E),f=va(d,g,w)),v.has(d[g]))if(v.has(d[w])){const L=f.get(l[C]),D=L!==void 0?r[L]:null;if(D===null){const N=Ut(a,r[g]);dt(N,n[C]),p[C]=N}else p[C]=dt(D,n[C]),Ut(a,r[g],D),r[L]=null;C++}else Gi(r[w]),w--;else Gi(r[g]),g++;for(;C<=E;){const L=Ut(a,p[E+1]);dt(L,n[C]),p[C++]=L}for(;g<=w;){const L=r[g++];L!==null&&Gi(L)}return this.ut=l,ir(a,p),ye}});function di(a,e,t){return Array.from({length:(e-a)/t+1},(i,o)=>a+o*t)}let He=class extends F{constructor(){super(...arguments),this.itemCount=0,this.scrollOptimizationsDisabled=!1,this.intersectionObserver=new IntersectionObserver(e=>{e.forEach(t=>{if(t.target===this.sentinel){t.isIntersecting&&this.dispatchEvent(new Event("scrollThresholdReached"));return}const o=t.target.dataset.cellIndex;if(!o)return;const r=parseInt(o,10);t.isIntersecting?this.visibleCellIndices.add(r):this.visibleCellIndices.delete(r)}),this.scrollOptimizationsDisabled||this.processVisibleCells()}),this.renderedCellIndices=new Set,this.visibleCellIndices=new Set,this.placeholderCellIndices=new Set}reload(){di(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.removeCell(t)),this.renderedCellIndices.clear(),this.visibleCellIndices.clear(),this.placeholderCellIndices.clear(),this.setupObservations()}scrollToCell(e,t){const i=this.cellContainers[e];if(!i)return!1;const o=t?"smooth":"auto";return i.scrollIntoView({behavior:o}),!0}getVisibleCellIndices(){return Array.from(this.visibleCellIndices)}updated(e){(e.has("itemCount")||e.has("scrollOptimizationsDisabled"))&&this.setupObservations()}disconnectedCallback(){this.intersectionObserver.disconnect()}setupObservations(){this.setupIntersectionObserver()}setupIntersectionObserver(){this.intersectionObserver.disconnect(),this.sentinel&&this.intersectionObserver.observe(this.sentinel),this.scrollOptimizationsDisabled?(di(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.visibleCellIndices.add(t)),this.processVisibleCells()):this.cellContainers.forEach(e=>this.intersectionObserver.observe(e))}render(){var e;const t=this.itemCount-1,i=di(0,t,1),o=(e=this.ariaLandmarkLabel)!==null&&e!==void 0?e:y;return h`
    ...
    `}};s([c({type:Number})],He.prototype,"itemCount",void 0);s([c({type:Object})],He.prototype,"cellProvider",void 0);s([c({type:Object})],He.prototype,"placeholderCellTemplate",void 0);s([c({type:Boolean})],He.prototype,"scrollOptimizationsDisabled",void 0);s([c({type:String})],He.prototype,"ariaLandmarkLabel",void 0);s([q("#sentinel")],He.prototype,"sentinel",void 0);s([as(".cell-container")],He.prototype,"cellContainers",void 0);He=s([A("infinite-scroller")],He);/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const cs=(a,...e)=>({strTag:!0,strings:a,values:e}),ht=cs,hs=a=>typeof a!="string"&&"strTag"in a,ps=(a,e,t)=>{let i=a[0];for(let o=1;o<a.length;o++)i+=e[t?t[o-1]:o-1],i+=a[o];return i};/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const us=a=>hs(a)?ps(a.strings,a.values):a;/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class vs{constructor(){this.settled=!1,this.promise=new Promise((e,t)=>{this._resolve=e,this._reject=t})}resolve(e){this.settled=!0,this._resolve(e)}reject(e){this.settled=!0,this._reject(e)}}/**
 * @license
...
`;var no;(function(a){a[a.bytes=0]="bytes",a[a.kilobytes=1]="kilobytes",a[a.megabytes=2]="megabytes",a[a.gigabytes=3]="gigabytes",a[a.terabytes=4]="terabytes",a[a.petabytes=5]="petabytes",a[a.exabytes=6]="exabytes",a[a.zettabytes=7]="zettabytes",a[a.yottabytes=8]="yottabytes"})(no||(no={}));function fs(a,e,t=" "){let i=a;if(i===void 0)return y;let o=0;for(;i>1024;)i/=1024,o+=1;const r=10**e;i=Math.round(i*r)/r;let n=no[o];return n=i===1?n.slice(0,-1):n,`${i.toLocaleString()+t+n}`}const tt=m`
  .sr-only {
...
`,gs=m`var(--tileBackgroundColor, #ffffff)`,bs=m`var(--tileCornerRadius, 4px)`,Eo=m`
...
`;class ma{constructor(e={}){var t;this.model=e.model,this.baseNavigationUrl=e.baseNavigationUrl,this.collectionPagePath=(t=e.collectionPagePath)!==null&&t!==void 0?t:"/details/",this.sortParam=e.sortParam,this.creatorFilter=e.creatorFilter}get firstCreatorMatchingFilter(){var e,t;let i;if(this.creatorFilter&&((e=this.model)===null||e===void 0?void 0:e.creators.length)){const o=this.creatorFilter;i=this.model.creators.find(r=>r.normalize("NFD").replace(/[^A-Z]+/gi,"").toUpperCase().startsWith(o))}return i!=null?i:(t=this.model)===null||t===void 0?void 0:t.creator}get accountLabel(){var e;return!((e=this.model)===null||e===void 0)&&e.dateAdded?B(ht`Archivist since ${this.model.dateAdded.getFullYear()}`):""}get dateLabel(){var e;switch((e=this.sortParam)===null||e===void 0?void 0:e.field){case"publicdate":return B("Archived");case"reviewdate":return B("Reviewed");case"addeddate":return B("Added");case"date":return B("Published");default:return""}}itemPageUrl(e,t=!1){if(!e||this.baseNavigationUrl==null)return y;const i=t?this.collectionPagePath:"/details/";return`${this.baseNavigationUrl}${i}${e}`}}class ce extends F{constructor(){super(...arguments),this.sortParam=null,this.loggedIn=!1,this.displayValueProvider=new ma}willUpdate(e){var t;(e.has("model")||e.has("baseNavigationUrl")||e.has("collectionPagePath")||e.has("sortParam")||e.has("creatorFilter"))&&(this.displayValueProvider=new ma({model:this.model,baseNavigationUrl:this.baseNavigationUrl,collectionPagePath:this.collectionPagePath,sortParam:(t=this.sortParam)!==null&&t!==void 0?t:void 0,creatorFilter:this.creatorFilter}))}}s([c({type:Object})],ce.prototype,"model",void 0);s([c({type:Number})],ce.prototype,"currentWidth",void 0);s([c({type:Number})],ce.prototype,"currentHeight",void 0);s([c({type:String})],ce.prototype,"baseNavigationUrl",void 0);s([c({type:String})],ce.prototype,"baseImageUrl",void 0);s([c({type:String})],ce.prototype,"collectionPagePath",void 0);s([c({type:Object})],ce.prototype,"sortParam",void 0);s([c({type:String})],ce.prototype,"creatorFilter",void 0);s([c({type:Number})],ce.prototype,"mobileBreakpoint",void 0);s([c({type:Boolean})],ce.prototype,"loggedIn",void 0);const rr=O`
  <svg
    viewBox="0 0 100 100"
    xmlns="http://www.w3.org/2000/svg"
  >
...
`;let Xt=class extends F{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1,this.isCompactTile=!1}render(){return h`<div class="icon-overlay ${this.getClass}">
      ${this.iconDisplay}
    </div>`}get getClass(){return this.isCompactTile?"list-compact":"list-detail"}get iconDisplay(){return this.loginRequired&&!this.loggedIn?h`${sr}`:h`${rr}`}static get styles(){return m`
      :host {
        position: absolute;
        top: 50%;
        left: 50%;
    ...
    `}};s([c({type:Boolean})],Xt.prototype,"loggedIn",void 0);s([c({type:Boolean})],Xt.prototype,"loginRequired",void 0);s([c({type:Boolean})],Xt.prototype,"isCompactTile",void 0);Xt=s([A("icon-overlay")],Xt);let Zt=class extends F{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1,this.iconRequired=!1}render(){return h`
      <div class="overlay no-preview">
        <div class="icon-overlay">${this.iconDisplay}</div>
        <p class="text-overlay">${this.textDisplay}</p>
      </div>
    `}get iconDisplay(){return this.loginRequired&&!this.loggedIn?h`${sr}`:h`${rr}`}get textDisplay(){return this.loginRequired&&!this.loggedIn?h`Log in to view this item`:h`Content may be inappropriate`}static get styles(){return m`
      :host {
        align-items: center;
        display: flex;
      }
    ...
    `}};s([c({type:Boolean})],Zt.prototype,"loggedIn",void 0);s([c({type:Boolean})],Zt.prototype,"loginRequired",void 0);s([c({type:Boolean})],Zt.prototype,"iconRequired",void 0);Zt=s([A("text-overlay")],Zt);let Xe=class extends F{constructor(){super(...arguments),this.isCompactTile=!1,this.isListTile=!1,this.loggedIn=!1,this.viewSize="desktop"}render(){var e;return!((e=this.model)===null||e===void 0)&&e.identifier?h`
    ...
    `}};s([c({type:String})],Xe.prototype,"baseImageUrl",void 0);s([c({type:Boolean})],Xe.prototype,"isCompactTile",void 0);s([c({type:Boolean})],Xe.prototype,"isListTile",void 0);s([c({type:Boolean})],Xe.prototype,"loggedIn",void 0);s([c({type:Object})],Xe.prototype,"model",void 0);s([c({type:String})],Xe.prototype,"viewSize",void 0);Xe=s([A("image-block")],Xe);let lo=class extends ce{constructor(){super(...arguments),this.showInfoButton=!1}render(){return h`
      <div class="container">
    ...
    >`}get getSizeTemplate(){var e,t;const i=(t=(e=this.model)===null||e===void 0?void 0:e.collectionSize)!==null&&t!==void 0?t:0;return i?h`<span id="item-size">${fs(i,1)}</span>`:""}get infoButtonTemplate(){return this.showInfoButton?h`<button class="info-button" @click=${this.infoButtonPressed}>
          &#9432;
          <span class="sr-only">${B("More info")}</span>
      ...
      `]}};s([c({type:Boolean})],lo.prototype,"showInfoButton",void 0);lo=s([A("collection-tile")],lo);function xi(a,e="short",t="en-US"){if(!a)return"";const i={};switch(e){case"year-only":i.year="numeric";break;case"short":i.month="short",i.year="numeric";break;case"long":i.year="numeric",i.month="short",i.day="2-digit";break}return new Intl.DateTimeFormat(t,i).format(a)}function ys(a){return new Date(a.getTime()-a.getTimezoneOffset()*1e3*60)}function Do(a){return a?ys(a).toISOString().endsWith("-01-01T00:00:00.000Z"):!1}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*vi(a,e){const t=typeof e=="function";if(a!==void 0){let i=-1;for(const o of a)i>-1&&(yield t?e(i):e),i++,yield o}}let _i=class extends F{constructor(){super(...arguments),this.snippets=[],this.viewSize="desktop"}render(){var e;return!((e=this.snippets)===null||e===void 0)&&e.length?h`
      <div class="container">
    ...
    `}};s([c({type:Array})],_i.prototype,"snippets",void 0);s([c({type:String})],_i.prototype,"viewSize",void 0);_i=s([A("text-snippet-block")],_i);const ws=m`
  .drop-shadow {
    overflow: hidden;
    height: 100%;
  }
...
`;let We=class extends F{constructor(){super(...arguments),this.isListTile=!1,this.isCompactTile=!1,this.loggedIn=!1,this.isWaveform=!1}render(){return h`
...
`,Ps={account:{color:"#000000",icon:_s,text:"Account"},audio:{color:"#00adef",icon:Ss,text:"Audio"},collection:{color:"#4666ff",icon:ar,text:"Collection"},data:{color:"#333333",icon:Cs,text:"Data"},etree:{color:"#00adef",icon:$s,text:"E-tree"},film:{color:"#bf1b2c",icon:fa,text:"Film"},image:{color:"#aa99c9",icon:ks,text:"Image"},movies:{color:"#f1644b",icon:fa,text:"Movie"},radio:{color:"#8fdaef",icon:Ts,text:"Radio"},software:{color:"#9ecc4f",icon:zs,text:"Software"},texts:{color:"#faab3c",icon:Ms,text:"Text"},tv:{color:"#f1644b",icon:Es,text:"TV"},video:{color:"#f1644b",icon:Ds,text:"Video"},web:{color:"#ffcd27",icon:Ls,text:"Web"}};let Jt=class extends F{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var e,t;const i=["tvnews","tvarchive","television"],o=["radio","radioprogram"];return this.mediatype==="movies"&&((e=this.collections)===null||e===void 0?void 0:e.some(r=>i.indexOf(r)>=0))?"tv":this.mediatype==="audio"&&((t=this.collections)===null||t===void 0?void 0:t.some(r=>o.indexOf(r)>=0))?"radio":this.mediatype||""}render(){const e=Ps[this.displayMediatype];return e?h`
      <div
        id="icon"
    ...
    `}};s([c({type:String})],Jt.prototype,"mediatype",void 0);s([c({type:Array})],Jt.prototype,"collections",void 0);s([c({type:Boolean})],Jt.prototype,"showText",void 0);Jt=s([A("mediatype-icon")],Jt);const As=O`
...
`;function Os(a,e){let t=1;return a>=1e9?t=1e9:a>=1e6?t=1e6:a>=1e3&&e==="short"&&(t=1e3),t}function Rs(a=0,e){const t=a/e,i=t<10;let o=0;return i?o=Math.round((t+Number.EPSILON)*10)/10:o=Math.round(t),o}function Ns(a,e,t,i){switch(e){case 1e9:return B(t==="short"?ht`${a}B`:ht`${a} billion`);case 1e6:return B(t==="short"?ht`${a}M`:ht`${a} million`);case 1e3:return B(t==="short"?ht`${a}K`:ht`${a} thousand`);default:return new Intl.NumberFormat(i).format(a)}}function Vt(a,e="long",t="short",i="en-US"){const o=a!=null?a:-1;if(o<0)return"";const r=Os(o,e),n=Rs(o,r);return Ns(n,r,t,i)}let Ze=class extends F{render(){var e;const t=Vt(this.favCount,"short","short"),i=Vt(this.commentCount,"short","short"),o=this.mediatype==="account"?`${this.itemCount} uploads`:`${this.viewCount} ${(e=this.viewLabel)!==null&&e!==void 0?e:"all-time views"}`;return h`
    ...
    `}static get styles(){return[tt,m`
      ...
      `]}};s([c({type:String})],Ze.prototype,"mediatype",void 0);s([c({type:Number})],Ze.prototype,"itemCount",void 0);s([c({type:Number})],Ze.prototype,"viewCount",void 0);s([c({type:String})],Ze.prototype,"viewLabel",void 0);s([c({type:Number})],Ze.prototype,"favCount",void 0);s([c({type:Number})],Ze.prototype,"commentCount",void 0);Ze=s([A("tile-stats")],Ze);let co=class extends ce{constructor(){super(...arguments),this.showInfoButton=!1}render(){var e,t,i,o,r,n,l;const d=(e=this.model)===null||e===void 0?void 0:e.title,[p,v]=((t=this.sortParam)===null||t===void 0?void 0:t.field)==="week"?[(i=this.model)===null||i===void 0?void 0:i.weeklyViewCount,"weekly views"]:[(o=this.model)===null||o===void 0?void 0:o.viewCount,"all-time views"];return h`
      <div class="container">
        ${this.infoButtonTemplate}
        <div class="tile-details">
          <div class="item-info">
    ...
    `}get sortedDateInfoTemplate(){var e,t,i,o,r;let n,l="long";switch((e=this.sortParam)===null||e===void 0?void 0:e.field){case"date":{const d=(t=this.model)===null||t===void 0?void 0:t.datePublished;n={field:"published",value:d},Do(d)&&(l="year-only");break}case"reviewdate":n={field:"reviewed",value:(i=this.model)===null||i===void 0?void 0:i.dateReviewed};break;case"addeddate":n={field:"added",value:(o=this.model)===null||o===void 0?void 0:o.dateAdded};break;case"publicdate":n={field:"archived",value:(r=this.model)===null||r===void 0?void 0:r.dateArchived};break}return n!=null&&n.value?h`
    ...
    `}get isSortedByDate(){var e;return["date","reviewdate","addeddate","publicdate"].includes((e=this.sortParam)===null||e===void 0?void 0:e.field)}get hasSnippets(){var e,t;return!!(!((t=(e=this.model)===null||e===void 0?void 0:e.snippets)===null||t===void 0)&&t.length)}infoButtonPressed(e){e.preventDefault();const t=new CustomEvent("infoButtonPressed",{detail:{x:e.clientX,y:e.clientY}});this.dispatchEvent(t)}static get styles(){const e=m`var(--tileBorderColor, #dddddd)`;return[Eo,m`
      ...
      `]}};s([c({type:Boolean})],co.prototype,"showInfoButton",void 0);co=s([A("item-tile")],co);let ho=class extends ce{constructor(){super(...arguments),this.showInfoButton=!1}render(){return h`
      <div class="container">
        ${this.infoButtonTemplate}
        <div class="tile-details">
          <div class="item-info">
    ...
    >
      ...
      `]}};s([c({type:Boolean})],ho.prototype,"showInfoButton",void 0);ho=s([A("account-tile")],ho);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class po extends oi{constructor(e){if(super(e),this.it=y,e.type!==Le.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===y||e==null)return this.ft=void 0,this.it=e;if(e===ye)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this.ft;this.it=e;const t=[e];return t.raw=t,this.ft={_$litType$:this.constructor.resultType,strings:t,values:[]}}}po.directiveName="unsafeHTML",po.resultType=1;const Us=ii(po);/*! @license DOMPurify 2.3.8 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/2.3.8/LICENSE */function pt(a){return pt=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},pt(a)}function uo(a,e){return uo=Object.setPrototypeOf||function(i,o){return i.__proto__=o,i},uo(a,e)}function Hs(){if(typeof Reflect=="undefined"||!Reflect.construct||Reflect.construct.sham)return!1;if(typeof Proxy=="function")return!0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],function(){})),!0}catch{return!1}}function mi(a,e,t){return Hs()?mi=Reflect.construct:mi=function(o,r,n){var l=[null];l.push.apply(l,r);var d=Function.bind.apply(o,l),p=new d;return n&&uo(p,n.prototype),p},mi.apply(null,arguments)}function ke(a){return Ws(a)||Vs(a)||js(a)||Gs()}function Ws(a){if(Array.isArray(a))return vo(a)}function Vs(a){if(typeof Symbol!="undefined"&&a[Symbol.iterator]!=null||a["@@iterator"]!=null)return Array.from(a)}function js(a,e){if(!!a){if(typeof a=="string")return vo(a,e);var t=Object.prototype.toString.call(a).slice(8,-1);if(t==="Object"&&a.constructor&&(t=a.constructor.name),t==="Map"||t==="Set")return Array.from(a);if(t==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t))return vo(a,e)}}function vo(a,e){(e==null||e>a.length)&&(e=a.length);for(var t=0,i=new Array(e);t<e;t++)i[t]=a[t];return i}function Gs(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}var Qs=Object.hasOwnProperty,ga=Object.setPrototypeOf,qs=Object.isFrozen,Ks=Object.getPrototypeOf,Ys=Object.getOwnPropertyDescriptor,fe=Object.freeze,Ae=Object.seal,Xs=Object.create,nr=typeof Reflect!="undefined"&&Reflect,Ci=nr.apply,mo=nr.construct;Ci||(Ci=function(e,t,i){return e.apply(t,i)});fe||(fe=function(e){return e});Ae||(Ae=function(e){return e});mo||(mo=function(e,t){return mi(e,ke(t))});var Zs=Te(Array.prototype.forEach),ba=Te(Array.prototype.pop),Ht=Te(Array.prototype.push),fi=Te(String.prototype.toLowerCase),Js=Te(String.prototype.match),qe=Te(String.prototype.replace),en=Te(String.prototype.indexOf),tn=Te(String.prototype.trim),ve=Te(RegExp.prototype.test),Qi=on(TypeError);function Te(a){return function(e){for(var t=arguments.length,i=new Array(t>1?t-1:0),o=1;o<t;o++)i[o-1]=arguments[o];return Ci(a,e,i)}}function on(a){return function(){for(var e=arguments.length,t=new Array(e),i=0;i<e;i++)t[i]=arguments[i];return mo(a,t)}}function P(a,e){ga&&ga(a,null);for(var t=e.length;t--;){var i=e[t];if(typeof i=="string"){var o=fi(i);o!==i&&(qs(e)||(e[t]=o),i=o)}a[i]=!0}return a}function ct(a){var e=Xs(null),t;for(t in a)Ci(Qs,a,[t])&&(e[t]=a[t]);return e}function ci(a,e){for(;a!==null;){var t=Ys(a,e);if(t){if(t.get)return Te(t.get);if(typeof t.value=="function")return Te(t.value)}a=Ks(a)}function i(o){return console.warn("fallback value for",o),null}return i}var ya=fe(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","section","select","shadow","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),qi=fe(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","filter","font","g","glyph","glyphref","hkern","image","line","lineargradient","marker","mask","metadata","mpath","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),Ki=fe(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),an=fe(["animate","color-profile","cursor","discard","fedropshadow","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),Yi=fe(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover"]),rn=fe(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),wa=fe(["#text"]),xa=fe(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","face","for","headers","height","hidden","high","href","hreflang","id","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","pattern","placeholder","playsinline","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","xmlns","slot"]),Xi=fe(["accent-height","accumulate","additive","alignment-baseline","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),_a=fe(["accent","accentunder","align","bevelled","close","columnsalign","columnlines","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lspace","lquote","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),hi=fe(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),sn=Ae(/\{\{[\w\W]*|[\w\W]*\}\}/gm),nn=Ae(/<%[\w\W]*|[\w\W]*%>/gm),ln=Ae(/^data-[\-\w.\u00B7-\uFFFF]/),dn=Ae(/^aria-[\-\w]+$/),cn=Ae(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|cid|xmpp):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),hn=Ae(/^(?:\w+script|data):/i),pn=Ae(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),un=Ae(/^html$/i),vn=function(){return typeof window=="undefined"?null:window},mn=function(e,t){if(pt(e)!=="object"||typeof e.createPolicy!="function")return null;var i=null,o="data-tt-policy-suffix";t.currentScript&&t.currentScript.hasAttribute(o)&&(i=t.currentScript.getAttribute(o));var r="dompurify"+(i?"#"+i:"");try{return e.createPolicy(r,{createHTML:function(l){return l}})}catch{return console.warn("TrustedTypes policy "+r+" could not be created."),null}};function lr(){var a=arguments.length>0&&arguments[0]!==void 0?arguments[0]:vn(),e=function(u){return lr(u)};if(e.version="2.3.8",e.removed=[],!a||!a.document||a.document.nodeType!==9)return e.isSupported=!1,e;var t=a.document,i=a.document,o=a.DocumentFragment,r=a.HTMLTemplateElement,n=a.Node,l=a.Element,d=a.NodeFilter,p=a.NamedNodeMap,v=p===void 0?a.NamedNodeMap||a.MozNamedAttrMap:p,f=a.HTMLFormElement,g=a.DOMParser,w=a.trustedTypes,C=l.prototype,E=ci(C,"cloneNode"),L=ci(C,"nextSibling"),D=ci(C,"childNodes"),N=ci(C,"parentNode");if(typeof r=="function"){var oe=i.createElement("template");oe.content&&oe.content.ownerDocument&&(i=oe.content.ownerDocument)}var K=mn(w,t),ne=K?K.createHTML(""):"",J=i,V=J.implementation,Me=J.createNodeIterator,ft=J.createDocumentFragment,Se=J.getElementsByTagName,Ge=t.importNode,Ie={};try{Ie=ct(i).documentMode?i.documentMode:{}}catch{}var R={};e.isSupported=typeof N=="function"&&V&&typeof V.createHTMLDocument!="undefined"&&Ie!==9;var be=sn,Ce=nn,Ft=ln,It=dn,Bt=hn,gt=pn,it=cn,Y=null,bt=P({},[].concat(ke(ya),ke(qi),ke(Ki),ke(Yi),ke(wa))),ee=null,yt=P({},[].concat(ke(xa),ke(Xi),ke(_a),ke(hi))),G=Object.seal(Object.create(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),Be=null,ot=null,wt=!0,at=!0,xt=!1,Ee=!1,$e=!1,rt=!1,st=!1,Oe=!1,ai=!1,ri=!1,Io=!0,Ei=!0,Ot=!1,_t={},St=null,Bo=P({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","style","svg","template","thead","title","video","xmp"]),Oo=null,Ro=P({},["audio","video","img","source","image","track"]),Di=null,No=P({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),Li="http://www.w3.org/1998/Math/MathML",Pi="http://www.w3.org/2000/svg",Qe="http://www.w3.org/1999/xhtml",si=Qe,Ai=!1,Ct,mr=["application/xhtml+xml","text/html"],fr="text/html",nt,$t=null,gr=i.createElement("form"),Uo=function(u){return u instanceof RegExp||u instanceof Function},Fi=function(u){$t&&$t===u||((!u||pt(u)!=="object")&&(u={}),u=ct(u),Y="ALLOWED_TAGS"in u?P({},u.ALLOWED_TAGS):bt,ee="ALLOWED_ATTR"in u?P({},u.ALLOWED_ATTR):yt,Di="ADD_URI_SAFE_ATTR"in u?P(ct(No),u.ADD_URI_SAFE_ATTR):No,Oo="ADD_DATA_URI_TAGS"in u?P(ct(Ro),u.ADD_DATA_URI_TAGS):Ro,St="FORBID_CONTENTS"in u?P({},u.FORBID_CONTENTS):Bo,Be="FORBID_TAGS"in u?P({},u.FORBID_TAGS):{},ot="FORBID_ATTR"in u?P({},u.FORBID_ATTR):{},_t="USE_PROFILES"in u?u.USE_PROFILES:!1,wt=u.ALLOW_ARIA_ATTR!==!1,at=u.ALLOW_DATA_ATTR!==!1,xt=u.ALLOW_UNKNOWN_PROTOCOLS||!1,Ee=u.SAFE_FOR_TEMPLATES||!1,$e=u.WHOLE_DOCUMENT||!1,Oe=u.RETURN_DOM||!1,ai=u.RETURN_DOM_FRAGMENT||!1,ri=u.RETURN_TRUSTED_TYPE||!1,st=u.FORCE_BODY||!1,Io=u.SANITIZE_DOM!==!1,Ei=u.KEEP_CONTENT!==!1,Ot=u.IN_PLACE||!1,it=u.ALLOWED_URI_REGEXP||it,si=u.NAMESPACE||Qe,u.CUSTOM_ELEMENT_HANDLING&&Uo(u.CUSTOM_ELEMENT_HANDLING.tagNameCheck)&&(G.tagNameCheck=u.CUSTOM_ELEMENT_HANDLING.tagNameCheck),u.CUSTOM_ELEMENT_HANDLING&&Uo(u.CUSTOM_ELEMENT_HANDLING.attributeNameCheck)&&(G.attributeNameCheck=u.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),u.CUSTOM_ELEMENT_HANDLING&&typeof u.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements=="boolean"&&(G.allowCustomizedBuiltInElements=u.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements),Ct=mr.indexOf(u.PARSER_MEDIA_TYPE)===-1?Ct=fr:Ct=u.PARSER_MEDIA_TYPE,nt=Ct==="application/xhtml+xml"?function(x){return x}:fi,Ee&&(at=!1),ai&&(Oe=!0),_t&&(Y=P({},ke(wa)),ee=[],_t.html===!0&&(P(Y,ya),P(ee,xa)),_t.svg===!0&&(P(Y,qi),P(ee,Xi),P(ee,hi)),_t.svgFilters===!0&&(P(Y,Ki),P(ee,Xi),P(ee,hi)),_t.mathMl===!0&&(P(Y,Yi),P(ee,_a),P(ee,hi))),u.ADD_TAGS&&(Y===bt&&(Y=ct(Y)),P(Y,u.ADD_TAGS)),u.ADD_ATTR&&(ee===yt&&(ee=ct(ee)),P(ee,u.ADD_ATTR)),u.ADD_URI_SAFE_ATTR&&P(Di,u.ADD_URI_SAFE_ATTR),u.FORBID_CONTENTS&&(St===Bo&&(St=ct(St)),P(St,u.FORBID_CONTENTS)),Ei&&(Y["#text"]=!0),$e&&P(Y,["html","head","body"]),Y.table&&(P(Y,["tbody"]),delete Be.tbody),fe&&fe(u),$t=u)},Ho=P({},["mi","mo","mn","ms","mtext"]),Wo=P({},["foreignobject","desc","title","annotation-xml"]),br=P({},["title","style","font","a","script"]),ni=P({},qi);P(ni,Ki),P(ni,an);var Ii=P({},Yi);P(Ii,rn);var yr=function(u){var x=N(u);(!x||!x.tagName)&&(x={namespaceURI:Qe,tagName:"template"});var S=fi(u.tagName),H=fi(x.tagName);return u.namespaceURI===Pi?x.namespaceURI===Qe?S==="svg":x.namespaceURI===Li?S==="svg"&&(H==="annotation-xml"||Ho[H]):Boolean(ni[S]):u.namespaceURI===Li?x.namespaceURI===Qe?S==="math":x.namespaceURI===Pi?S==="math"&&Wo[H]:Boolean(Ii[S]):u.namespaceURI===Qe?x.namespaceURI===Pi&&!Wo[H]||x.namespaceURI===Li&&!Ho[H]?!1:!Ii[S]&&(br[S]||!ni[S]):!1},Re=function(u){Ht(e.removed,{element:u});try{u.parentNode.removeChild(u)}catch{try{u.outerHTML=ne}catch{u.remove()}}},Vo=function(u,x){try{Ht(e.removed,{attribute:x.getAttributeNode(u),from:x})}catch{Ht(e.removed,{attribute:null,from:x})}if(x.removeAttribute(u),u==="is"&&!ee[u])if(Oe||ai)try{Re(x)}catch{}else try{x.setAttribute(u,"")}catch{}},jo=function(u){var x,S;if(st)u="<remove></remove>"+u;else{var H=Js(u,/^[\r\n\t ]+/);S=H&&H[0]}Ct==="application/xhtml+xml"&&(u='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+u+"</body></html>");var ge=K?K.createHTML(u):u;if(si===Qe)try{x=new g().parseFromString(ge,Ct)}catch{}if(!x||!x.documentElement){x=V.createDocument(si,"template",null);try{x.documentElement.innerHTML=Ai?"":ge}catch{}}var he=x.body||x.documentElement;return u&&S&&he.insertBefore(i.createTextNode(S),he.childNodes[0]||null),si===Qe?Se.call(x,$e?"html":"body")[0]:$e?x.documentElement:he},Go=function(u){return Me.call(u.ownerDocument||u,u,d.SHOW_ELEMENT|d.SHOW_COMMENT|d.SHOW_TEXT,null,!1)},wr=function(u){return u instanceof f&&(typeof u.nodeName!="string"||typeof u.textContent!="string"||typeof u.removeChild!="function"||!(u.attributes instanceof v)||typeof u.removeAttribute!="function"||typeof u.setAttribute!="function"||typeof u.namespaceURI!="string"||typeof u.insertBefore!="function")},Rt=function(u){return pt(n)==="object"?u instanceof n:u&&pt(u)==="object"&&typeof u.nodeType=="number"&&typeof u.nodeName=="string"},Ne=function(u,x,S){!R[u]||Zs(R[u],function(H){H.call(e,x,S,$t)})},Qo=function(u){var x;if(Ne("beforeSanitizeElements",u,null),wr(u)||ve(/[\u0080-\uFFFF]/,u.nodeName))return Re(u),!0;var S=nt(u.nodeName);if(Ne("uponSanitizeElement",u,{tagName:S,allowedTags:Y}),u.hasChildNodes()&&!Rt(u.firstElementChild)&&(!Rt(u.content)||!Rt(u.content.firstElementChild))&&ve(/<[/\w]/g,u.innerHTML)&&ve(/<[/\w]/g,u.textContent)||S==="select"&&ve(/<template/i,u.innerHTML))return Re(u),!0;if(!Y[S]||Be[S]){if(!Be[S]&&Ko(S)&&(G.tagNameCheck instanceof RegExp&&ve(G.tagNameCheck,S)||G.tagNameCheck instanceof Function&&G.tagNameCheck(S)))return!1;if(Ei&&!St[S]){var H=N(u)||u.parentNode,ge=D(u)||u.childNodes;if(ge&&H)for(var he=ge.length,de=he-1;de>=0;--de)H.insertBefore(E(ge[de],!0),L(u))}return Re(u),!0}return u instanceof l&&!yr(u)||(S==="noscript"||S==="noembed")&&ve(/<\/no(script|embed)/i,u.innerHTML)?(Re(u),!0):(Ee&&u.nodeType===3&&(x=u.textContent,x=qe(x,be," "),x=qe(x,Ce," "),u.textContent!==x&&(Ht(e.removed,{element:u.cloneNode()}),u.textContent=x)),Ne("afterSanitizeElements",u,null),!1)},qo=function(u,x,S){if(Io&&(x==="id"||x==="name")&&(S in i||S in gr))return!1;if(!(at&&!ot[x]&&ve(Ft,x))){if(!(wt&&ve(It,x))){if(!ee[x]||ot[x]){if(!(Ko(u)&&(G.tagNameCheck instanceof RegExp&&ve(G.tagNameCheck,u)||G.tagNameCheck instanceof Function&&G.tagNameCheck(u))&&(G.attributeNameCheck instanceof RegExp&&ve(G.attributeNameCheck,x)||G.attributeNameCheck instanceof Function&&G.attributeNameCheck(x))||x==="is"&&G.allowCustomizedBuiltInElements&&(G.tagNameCheck instanceof RegExp&&ve(G.tagNameCheck,S)||G.tagNameCheck instanceof Function&&G.tagNameCheck(S))))return!1}else if(!Di[x]){if(!ve(it,qe(S,gt,""))){if(!((x==="src"||x==="xlink:href"||x==="href")&&u!=="script"&&en(S,"data:")===0&&Oo[u])){if(!(xt&&!ve(Bt,qe(S,gt,"")))){if(S)return!1}}}}}}return!0},Ko=function(u){return u.indexOf("-")>0},Yo=function(u){var x,S,H,ge;Ne("beforeSanitizeAttributes",u,null);var he=u.attributes;if(!!he){var de={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:ee};for(ge=he.length;ge--;){x=he[ge];var li=x,ue=li.name,Xo=li.namespaceURI;if(S=ue==="value"?x.value:tn(x.value),H=nt(ue),de.attrName=H,de.attrValue=S,de.keepAttr=!0,de.forceKeepAttr=void 0,Ne("uponSanitizeAttribute",u,de),S=de.attrValue,!de.forceKeepAttr&&(Vo(ue,u),!!de.keepAttr)){if(ve(/\/>/i,S)){Vo(ue,u);continue}Ee&&(S=qe(S,be," "),S=qe(S,Ce," "));var _r=nt(u.nodeName);if(!!qo(_r,H,S))try{Xo?u.setAttributeNS(Xo,ue,S):u.setAttribute(ue,S),ba(e.removed)}catch{}}}Ne("afterSanitizeAttributes",u,null)}},xr=function $(u){var x,S=Go(u);for(Ne("beforeSanitizeShadowDOM",u,null);x=S.nextNode();)Ne("uponSanitizeShadowNode",x,null),!Qo(x)&&(x.content instanceof o&&$(x.content),Yo(x));Ne("afterSanitizeShadowDOM",u,null)};return e.sanitize=function($,u){var x,S,H,ge,he;if(Ai=!$,Ai&&($="<!-->"),typeof $!="string"&&!Rt($)){if(typeof $.toString!="function")throw Qi("toString is not a function");if($=$.toString(),typeof $!="string")throw Qi("dirty is not a string, aborting")}if(!e.isSupported){if(pt(a.toStaticHTML)==="object"||typeof a.toStaticHTML=="function"){if(typeof $=="string")return a.toStaticHTML($);if(Rt($))return a.toStaticHTML($.outerHTML)}return $}if(rt||Fi(u),e.removed=[],typeof $=="string"&&(Ot=!1),Ot){if($.nodeName){var de=nt($.nodeName);if(!Y[de]||Be[de])throw Qi("root node is forbidden and cannot be sanitized in-place")}}else if($ instanceof n)x=jo("<!---->"),S=x.ownerDocument.importNode($,!0),S.nodeType===1&&S.nodeName==="BODY"||S.nodeName==="HTML"?x=S:x.appendChild(S);else{if(!Oe&&!Ee&&!$e&&$.indexOf("<")===-1)return K&&ri?K.createHTML($):$;if(x=jo($),!x)return Oe?null:ri?ne:""}x&&st&&Re(x.firstChild);for(var li=Go(Ot?$:x);H=li.nextNode();)H.nodeType===3&&H===ge||Qo(H)||(H.content instanceof o&&xr(H.content),Yo(H),ge=H);if(ge=null,Ot)return $;if(Oe){if(ai)for(he=ft.call(x.ownerDocument);x.firstChild;)he.appendChild(x.firstChild);else he=x;return ee.shadowroot&&(he=Ge.call(t,he,!0)),he}var ue=$e?x.outerHTML:x.innerHTML;return $e&&Y["!doctype"]&&x.ownerDocument&&x.ownerDocument.doctype&&x.ownerDocument.doctype.name&&ve(un,x.ownerDocument.doctype.name)&&(ue="<!DOCTYPE "+x.ownerDocument.doctype.name+`>
`+ue),Ee&&(ue=qe(ue,be," "),ue=qe(ue,Ce," ")),K&&ri?K.createHTML(ue):ue},e.setConfig=function($){Fi($),rt=!0},e.clearConfig=function(){$t=null,rt=!1},e.isValidAttribute=function($,u,x){$t||Fi({});var S=nt($),H=nt(u);return qo(S,H,x)},e.addHook=function($,u){typeof u=="function"&&(R[$]=R[$]||[],Ht(R[$],u))},e.removeHook=function($){if(R[$])return ba(R[$])},e.removeHooks=function($){R[$]&&(R[$]=[])},e.removeAllHooks=function(){R={}},e}var gi=lr(),_;(function(a){a.default="default",a.unrecognized="unrecognized",a.relevance="relevance",a.alltimeview="alltimeview",a.weeklyview="weeklyview",a.title="title",a.date="date",a.datearchived="datearchived",a.datereviewed="datereviewed",a.dateadded="dateadded",a.datefavorited="datefavorited",a.creator="creator"})(_||(_={}));const me={[_.default]:{field:_.default,defaultSortDirection:null,canSetDirection:!1,shownInSortBar:!1,shownInURL:!1,handledBySearchService:!1,displayName:"",urlNames:["",null,void 0]},[_.unrecognized]:{field:_.unrecognized,defaultSortDirection:null,canSetDirection:!0,shownInSortBar:!1,shownInURL:!1,handledBySearchService:!0,displayName:"",urlNames:[]},[_.relevance]:{field:_.relevance,defaultSortDirection:null,canSetDirection:!1,shownInSortBar:!0,shownInURL:!1,handledBySearchService:!1,displayName:"Relevance",urlNames:["_score"]},[_.alltimeview]:{field:_.alltimeview,defaultSortDirection:"desc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"downloads",displayName:"All-time views",urlNames:["downloads"]},[_.weeklyview]:{field:_.weeklyview,defaultSortDirection:"desc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"week",displayName:"Weekly views",urlNames:["week"]},[_.title]:{field:_.title,defaultSortDirection:"asc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"titleSorter",displayName:"Title",urlNames:["title","titleSorter"]},[_.date]:{field:_.date,defaultSortDirection:"desc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"date",displayName:"Date published",urlNames:["date"]},[_.datearchived]:{field:_.datearchived,defaultSortDirection:"desc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"publicdate",displayName:"Date archived",urlNames:["publicdate"]},[_.datereviewed]:{field:_.datereviewed,defaultSortDirection:"desc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"reviewdate",displayName:"Date reviewed",urlNames:["reviewdate"]},[_.dateadded]:{field:_.dateadded,defaultSortDirection:"desc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"addeddate",displayName:"Date added",urlNames:["addeddate"]},[_.datefavorited]:{field:_.datefavorited,defaultSortDirection:"desc",canSetDirection:!1,shownInSortBar:!0,shownInURL:!1,handledBySearchService:!1,searchServiceKey:"favoritedate",displayName:"Date favorited",urlNames:["favoritedate"]},[_.creator]:{field:_.creator,defaultSortDirection:"asc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"creatorSorter",displayName:"Creator",urlNames:["creator","creatorSorter"]}};function dr(a){var e;return(e=Object.values(me).find(t=>t.urlNames.some(i=>a===i)))!==null&&e!==void 0?e:me[_.unrecognized]}const fn={title:"firstTitle",creator:"firstCreator"},ei=()=>({subject:{},lending:{},mediatype:{},language:{},creator:{},collection:{},year:{}}),gn=["mediatype","lending","year","subject","collection","creator","language"],$i={subject:"Subject",lending:"Availability",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"},fo={subject:X.COUNT,lending:X.COUNT,mediatype:X.COUNT,language:X.COUNT,creator:X.COUNT,collection:X.COUNT,year:X.NUMERIC},bn={subject:X.ALPHABETICAL,lending:X.ALPHABETICAL,mediatype:X.ALPHABETICAL,language:X.ALPHABETICAL,creator:X.ALPHABETICAL,collection:X.ALPHABETICAL,year:X.NUMERIC},yn={is_lendable:!0,is_borrowable:!1,available_to_borrow:!0,is_browsable:!1,available_to_browse:!1,is_readable:!0,available_to_waitlist:!1},Sa={is_lendable:"Lending Library",available_to_borrow:"Borrow 14 Days",is_readable:"Always Available"},Lo={deemphasize:!0,community:!0,stream_only:!0,samples_only:!0,test_collection:!0,printdisabled:!0,"openlibrary-ol":!0,nationalemergencylibrary:!0,china:!0,americana:!0,toronto:!0};let ki=class extends ce{constructor(){super(...arguments),this.collectionLinks=[]}render(){return h`
    ...
    `}get titleTemplate(){var e,t,i;return!((e=this.model)===null||e===void 0)&&e.title?!((t=this.model)===null||t===void 0)&&t.href?h`<a href="${this.baseNavigationUrl}${this.model.href}"
      ...
      <div id="source" class="metadata">
        ${this.labelTemplate(B("Source"))}
        ${this.searchLink("source",this.model.source)}
      </div>
    `:y}get volumeTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.volume,B("Volume"))}get issueTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.issue,B("Issue"))}get creatorTemplate(){var e,t,i;return((e=this.model)===null||e===void 0?void 0:e.mediatype)==="account"?h`
      ...
      <div id="creator" class="metadata">
        ${this.labelTemplate(B("By"))}
        ${vi(Si(this.model.creators,o=>this.searchLink("creator",o)),", ")}
      </div>
    `}get datePublishedTemplate(){var e;const t=(e=this.model)===null||e===void 0?void 0:e.datePublished;let i="long";return Do(t)&&(i="year-only"),this.metadataTemplate(xi(t,i),B("Published"))}get dateSortByTemplate(){return this.sortParam&&(this.sortParam.field==="addeddate"||this.sortParam.field==="reviewdate"||this.sortParam.field==="publicdate")?this.metadataTemplate(xi(this.date,"long"),this.displayValueProvider.dateLabel):y}get viewsTemplate(){var e,t,i;const o=((e=this.sortParam)===null||e===void 0?void 0:e.field)==="week"?(t=this.model)===null||t===void 0?void 0:t.weeklyViewCount:(i=this.model)===null||i===void 0?void 0:i.viewCount;return this.metadataTemplate(`${Vt(o!=null?o:0,this.formatSize)}`,B("Views"))}get ratingTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.averageRating,B("Avg Rating"))}get reviewsTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.commentCount,B("Reviews"))}get topicsTemplate(){var e;return!(!((e=this.model)===null||e===void 0)&&e.subjects)||this.model.subjects.length===0?y:h`
      <div id="topics" class="metadata">
        ${this.labelTemplate(B("Topics"))}
        ${vi(Si(this.model.subjects,t=>this.searchLink("subject",t)),", ")}
      </div>
    `}get collectionsTemplate(){return!this.collectionLinks||this.collectionLinks.length===0?y:h`
      <div id="collections" class="metadata">
        ${this.labelTemplate(B("Collections"))}
        ${vi(this.collectionLinks,", ")}
      </div>
    `}get descriptionTemplate(){var e,t,i;return this.metadataTemplate(Us(gi.sanitize((i=(t=(e=this.model)===null||e===void 0?void 0:e.description)===null||t===void 0?void 0:t.replace(/\n/g," "))!==null&&i!==void 0?i:"")),"","description")}get textSnippetsTemplate(){var e;return this.hasSnippets?h`<text-snippet-block
      viewsize="list"
    ...
    >
      ${gi.sanitize(t)}</a
    >`}detailsLink(e,t,i=!1){const o=t!=null?t:e,r=this.displayValueProvider.itemPageUrl(e,i);return h`<a href=${r}> ${gi.sanitize(o)} </a>`}get mediatypeURL(){var e;if(this.baseNavigationUrl===void 0||!(!((e=this.model)===null||e===void 0)&&e.mediatype))return y;switch(this.model.mediatype){case"collection":return`${this.baseNavigationUrl}/search?query=mediatype:collection&sort=-downloads`;case"account":return y;default:return this.displayValueProvider.itemPageUrl(this.model.mediatype,!0)}}updated(e){e.has("model")&&this.fetchCollectionNames()}async fetchCollectionNames(){var e,t;if(!(!((e=this.model)===null||e===void 0)&&e.collections)||this.model.collections.length===0||!this.collectionNameCache)return;this.collectionLinks=[];const i=[],o=[];for(const r of this.model.collections)!Lo[r]&&!r.startsWith("fav-")&&o.push((t=this.collectionNameCache)===null||t===void 0?void 0:t.collectionNameFor(r).then(n=>{i.push(this.detailsLink(r,n!=null?n:r,!0))}));await Promise.all(o),this.collectionLinks=i}get date(){var e,t,i,o,r;switch((e=this.sortParam)===null||e===void 0?void 0:e.field){case"date":return(t=this.model)===null||t===void 0?void 0:t.datePublished;case"reviewdate":return(i=this.model)===null||i===void 0?void 0:i.dateReviewed;case"addeddate":return(o=this.model)===null||o===void 0?void 0:o.dateAdded;default:return(r=this.model)===null||r===void 0?void 0:r.dateArchived}}get classSize(){return this.mobileBreakpoint&&this.currentWidth&&this.currentWidth<this.mobileBreakpoint?"mobile":"desktop"}get formatSize(){return this.mobileBreakpoint&&this.currentWidth&&this.currentWidth<this.mobileBreakpoint?"short":"long"}static get styles(){return m`
      html {
        font-size: unset;
      }
    ...
    `}};s([c({type:Object})],ki.prototype,"collectionNameCache",void 0);s([T()],ki.prototype,"collectionLinks",void 0);ki=s([A("tile-list")],ki);let Je=class extends F{constructor(){super(...arguments),this.loggedIn=!1}render(){return h`
      <div id="container">
        <tile-list
          .model=${this.model}
    ...
    `}};s([c({type:Object})],Je.prototype,"model",void 0);s([c({type:String})],Je.prototype,"baseNavigationUrl",void 0);s([c({type:String})],Je.prototype,"baseImageUrl",void 0);s([c({type:Boolean})],Je.prototype,"loggedIn",void 0);s([c({type:Object})],Je.prototype,"sortParam",void 0);s([c({type:Object})],Je.prototype,"collectionNameCache",void 0);Je=s([A("tile-hover-pane")],Je);let Ca=class extends ce{render(){var e,t,i,o,r,n;return h`
      <div id="list-line" class="${this.classSize}">
        <image-block
          .model=${this.model}
          .baseImageUrl=${this.baseImageUrl}
        ...
        <a href=${this.href} id="title"
          >${gi.sanitize((t=(e=this.model)===null||e===void 0?void 0:e.title)!==null&&t!==void 0?t:"")}</a
        >
        <div id="creator">
    ...
    `}};Ca=s([A("tile-list-compact")],Ca);let $a=class extends ce{render(){return h`
      <div id="list-line-header" class="${this.classSize}">
        <div id="thumb"></div>
        <div id="title">${B("Title")}</div>
        <div id="creator">${B("Creator")}</div>
        <div id="date">${this.displayValueProvider.dateLabel}</div>
        <div id="icon">${B("Type")}</div>
        <div id="views">${B("Views")}</div>
      </div>
    ...
    `}};Ve.HOVER_PANE_DISPLAY_MODES={grid:!0,"list-compact":!0,"list-detail":!1,"list-header":!1};s([c({type:String})],Ve.prototype,"tileDisplayMode",void 0);s([c({type:Object})],Ve.prototype,"resizeObserver",void 0);s([c({type:Object})],Ve.prototype,"collectionNameCache",void 0);s([c({type:Boolean})],Ve.prototype,"enableHoverPane",void 0);s([q("#container")],Ve.prototype,"container",void 0);s([q("tile-hover-pane")],Ve.prototype,"hoverPane",void 0);Ve=go=s([A("tile-dispatcher")],Ve);let Ta=class extends F{render(){return h` <div id="container"></div> `}static get styles(){return m`
      :host {
        display: block;
        height: 100%;
      }
  ...
  `;bo=s([A("ia-icon-label")],bo);let yo=class extends F{constructor(){super(...arguments),this.numResults=0}render(){return h`
    ...
    `}};s([c({type:Number})],yo.prototype,"numResults",void 0);yo=s([A("alpha-bar-tooltip")],yo);let je=class extends F{constructor(){super(...arguments),this.selectedLetter=null,this.tooltipShown=!1,this.alphabet="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("")}get selectedUppercaseLetter(){var e;return(e=this.selectedLetter)===null||e===void 0?void 0:e.toUpperCase()}render(){var e;return h`
  ...
  `;s([c({type:String})],je.prototype,"selectedLetter",void 0);s([c({type:Object})],je.prototype,"letterCounts",void 0);s([c({type:String})],je.prototype,"ariaLandmarkLabel",void 0);s([T()],je.prototype,"tooltipShown",void 0);s([T()],je.prototype,"hoveredLetter",void 0);s([q("alpha-bar-tooltip")],je.prototype,"tooltip",void 0);je=s([A("alpha-bar")],je);const xn=h`
...
`;let Z=class extends F{constructor(){super(...arguments),this.defaultSortDirection=null,this.defaultSortField=_.relevance,this.sortDirection=null,this.selectedSort=_.default,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.showRelevance=!0,this.showDateFavorited=!1,this.alphaSelectorVisible=null,this.dropdownBackdropVisible=!1,this.desktopSortContainerWidth=0,this.selectorBarContainerWidth=0,this.boundSortBarSelectorEscapeListener=e=>{e.key==="Escape"&&this.closeDropdowns()}}render(){return h`
      <div id="container">
    ...
    `}get sortDirectionIcon(){return this.canChangeSortDirection?h`
      <div class="sort-direction-icon">
        ${this.finalizedSortDirection==="asc"?xn:_n}
      </div>
    `:h`<div class="sort-direction-icon">${Sn}</div>`}get desktopSortSelectorTemplate(){return h`
      <div
    ...
    `}get mobileSortSelectorTemplate(){const e=Object.values(me).filter(t=>t.shownInSortBar).filter(t=>this.showRelevance||t.field!==_.relevance).filter(t=>this.showDateFavorited||t.field!==_.datefavorited);return h`
      <div
    ...
    `}getSortDisplayOption(e,t){var i,o;const r=(i=t==null?void 0:t.selected)!==null&&i!==void 0?i:this.finalizedSortField===e,n=(o=t==null?void 0:t.displayName)!==null&&o!==void 0?o:me[e].displayName;return h`
      <button
        class=${r?"selected":y}
        data-title="${n}"
    ...
    `}get dropdownBackdrop(){return h`
      ...
      ></div>
    `}closeDropdowns(){this.dropdownBackdropVisible=!1;const e=[this.viewsDropdown,this.dateDropdown,this.mobileDropdown];for(const t of e)t.open=!1,t.classList.remove("open")}selectDropdownSortField(e){this.dropdownBackdropVisible=!1,this.setSelectedSort(e)}clearAlphaBarFilters(){this.alphaSelectorVisible=null,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.emitTitleLetterChangedEvent(),this.emitCreatorLetterChangedEvent()}setSortDirection(e){this.sortDirection=e,this.emitSortChangedEvent()}toggleSortDirection(){this.setSortDirection(this.finalizedSortDirection==="desc"?"asc":"desc")}handleSortDirectionClicked(){!this.sortDirection&&this.defaultSortField&&this.defaultSortDirection&&(this.selectedSort=this.defaultSortField,this.sortDirection=this.defaultSortDirection),this.toggleSortDirection()}setSelectedSort(e){this.selectedSort=e;const t=me[e];this.sortDirection=t.defaultSortDirection,this.emitSortChangedEvent()}get finalizedSortField(){return this.selectedSort===_.default?this.defaultSortField:this.selectedSort}get finalizedSortDirection(){return this.sortDirection===null?this.defaultSortDirection:this.sortDirection}get canChangeSortDirection(){return me[this.finalizedSortField].canSetDirection}get dateOptionSelected(){return[_.datefavorited,_.datearchived,_.date,_.datereviewed,_.dateadded].includes(this.finalizedSortField)}get viewOptionSelected(){return[_.alltimeview,_.weeklyview].includes(this.finalizedSortField)}get defaultDateSortField(){return this.showDateFavorited?_.datefavorited:_.date}get dateSortField(){var e;const t=me[this.defaultDateSortField];return(this.dateOptionSelected&&(e=me[this.finalizedSortField])!==null&&e!==void 0?e:t).displayName}get viewSortField(){var e;const t=me[_.weeklyview];return(this.viewOptionSelected&&(e=me[this.finalizedSortField])!==null&&e!==void 0?e:t).displayName}get titleSelectorBar(){var e;return h` <alpha-bar
    ...
    ></alpha-bar>`}titleLetterChanged(e){var t;this.selectedTitleFilter=(t=e.detail.selectedLetter)!==null&&t!==void 0?t:null,this.emitTitleLetterChangedEvent()}creatorLetterChanged(e){var t;this.selectedCreatorFilter=(t=e.detail.selectedLetter)!==null&&t!==void 0?t:null,this.emitCreatorLetterChangedEvent()}emitTitleLetterChangedEvent(){const e=new CustomEvent("titleLetterChanged",{detail:{selectedLetter:this.selectedTitleFilter}});this.dispatchEvent(e)}emitCreatorLetterChangedEvent(){const e=new CustomEvent("creatorLetterChanged",{detail:{selectedLetter:this.selectedCreatorFilter}});this.dispatchEvent(e)}displayModeChanged(){const e=new CustomEvent("displayModeChanged",{detail:{displayMode:this.displayMode}});this.dispatchEvent(e)}emitSortChangedEvent(){const e=new CustomEvent("sortChanged",{detail:{selectedSort:this.selectedSort,sortDirection:this.sortDirection}});this.dispatchEvent(e)}static get styles(){return[tt,m`
      ...
      `]}};s([c({type:String})],Z.prototype,"displayMode",void 0);s([c({type:String})],Z.prototype,"defaultSortDirection",void 0);s([c({type:String})],Z.prototype,"defaultSortField",void 0);s([c({type:String})],Z.prototype,"sortDirection",void 0);s([c({type:String})],Z.prototype,"selectedSort",void 0);s([c({type:String})],Z.prototype,"selectedTitleFilter",void 0);s([c({type:String})],Z.prototype,"selectedCreatorFilter",void 0);s([c({type:Boolean})],Z.prototype,"showRelevance",void 0);s([c({type:Boolean})],Z.prototype,"showDateFavorited",void 0);s([c({type:Object})],Z.prototype,"prefixFilterCountMap",void 0);s([c({type:Object})],Z.prototype,"resizeObserver",void 0);s([T()],Z.prototype,"alphaSelectorVisible",void 0);s([T()],Z.prototype,"dropdownBackdropVisible",void 0);s([T()],Z.prototype,"desktopSortContainerWidth",void 0);s([T()],Z.prototype,"selectorBarContainerWidth",void 0);s([q("#desktop-sort-container")],Z.prototype,"desktopSortContainer",void 0);s([q("#sort-selector-container")],Z.prototype,"sortSelectorContainer",void 0);s([q("#views-dropdown")],Z.prototype,"viewsDropdown",void 0);s([q("#date-dropdown")],Z.prototype,"dateDropdown",void 0);s([q("#mobile-dropdown")],Z.prototype,"mobileDropdown",void 0);Z=s([A("sort-filter-bar")],Z);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const jt=(a,e)=>{var t,i;const o=a._$AN;if(o===void 0)return!1;for(const r of o)(i=(t=r)._$AO)===null||i===void 0||i.call(t,e,!1),jt(r,e);return!0},Ti=a=>{let e,t;do{if((e=a._$AM)===void 0)break;t=e._$AN,t.delete(a),a=e}while((t==null?void 0:t.size)===0)},cr=a=>{for(let e;e=a._$AM;a=e){let t=e._$AN;if(t===void 0)e._$AN=t=new Set;else if(t.has(a))break;t.add(a),Mn(e)}};function Tn(a){this._$AN!==void 0?(Ti(this),this._$AM=a,cr(this)):this._$AM=a}function zn(a,e=!1,t=0){const i=this._$AH,o=this._$AN;if(o!==void 0&&o.size!==0)if(e)if(Array.isArray(i))for(let r=t;r<i.length;r++)jt(i[r],!1),Ti(i[r]);else i!=null&&(jt(i,!1),Ti(i));else jt(this,a)}const Mn=a=>{var e,t,i,o;a.type==Le.CHILD&&((e=(i=a)._$AP)!==null&&e!==void 0||(i._$AP=zn),(t=(o=a)._$AQ)!==null&&t!==void 0||(o._$AQ=Tn))};class En extends oi{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,i){super._$AT(e,t,i),cr(this),this.isConnected=e._$AU}_$AO(e,t=!0){var i,o;e!==this.isConnected&&(this.isConnected=e,e?(i=this.reconnected)===null||i===void 0||i.call(this):(o=this.disconnected)===null||o===void 0||o.call(this)),t&&(jt(this,e),Ti(this))}setValue(e){if(tr(this._$Ct))this._$Ct._$AI(e,this);else{const t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}}const Zi=new WeakMap,Dn=ii(class extends En{render(a){return y}update(a,[e]){var t;const i=e!==this.U;return i&&this.U!==void 0&&this.ot(void 0),(i||this.rt!==this.lt)&&(this.U=e,this.ht=(t=a.options)===null||t===void 0?void 0:t.host,this.ot(this.lt=a.element)),y}ot(a){var e;if(typeof this.U=="function"){const t=(e=this.ht)!==null&&e!==void 0?e:globalThis;let i=Zi.get(t);i===void 0&&(i=new WeakMap,Zi.set(t,i)),i.get(this.U)!==void 0&&this.U.call(this.ht,void 0),i.set(this.U,a),a!==void 0&&this.U.call(this.ht,a)}else this.U.value=a}get rt(){var a,e,t;return typeof this.U=="function"?(e=Zi.get((a=this.ht)!==null&&a!==void 0?a:globalThis))===null||e===void 0?void 0:e.get(this.U):(t=this.U)===null||t===void 0?void 0:t.value}disconnected(){this.rt===this.lt&&this.ot(void 0)}reconnected(){this.ot(this.lt)}});/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const za=ii(class extends oi{constructor(a){if(super(a),a.type!==Le.PROPERTY&&a.type!==Le.ATTRIBUTE&&a.type!==Le.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!tr(a))throw Error("`live` bindings can only contain a single expression")}render(a){return a}update(a,[e]){if(e===ye||e===y)return e;const t=a.element,i=a.name;if(a.type===Le.PROPERTY){if(e===t[i])return ye}else if(a.type===Le.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(i))return ye}else if(a.type===Le.ATTRIBUTE&&t.getAttribute(i)===e+"")return ye;return ir(a),e}}),Ln=Object.freeze({processing:"processing",complete:"complete"});class Pn extends F{static get properties(){return{mode:{type:String}}}constructor(){super(),this.mode=Ln.processing}render(){return h`
      <div class="${this.mode}">
        <svg
          viewBox="0 0 120 120"
    ...
    `,this._tooltipVisible=!0}hideTooltip(){this._tooltipContent=void 0,this._tooltipVisible=!1}validMinSliderX(e){const t=Math.min(this.translateDateToPosition(this.maxSelectedDate),this.histogramRightEdgeX);return e=this.clamp(e,this.histogramLeftEdgeX,t),Number.isNaN(e)||t<this.histogramLeftEdgeX?this.histogramLeftEdgeX:e}validMaxSliderX(e){const t=Math.max(this.histogramLeftEdgeX,this.translateDateToPosition(this.minSelectedDate));return e=this.clamp(e,t,this.histogramRightEdgeX),Number.isNaN(e)||t>this.histogramRightEdgeX?this.histogramRightEdgeX:e}addListeners(){window.addEventListener("pointermove",this.move),window.addEventListener("pointerup",this.drop),window.addEventListener("pointercancel",this.drop)}removeListeners(){window.removeEventListener("pointermove",this.move),window.removeEventListener("pointerup",this.drop),window.removeEventListener("pointercancel",this.drop)}beginEmitUpdateProcess(){this.cancelPendingUpdateEvent(),this._emitUpdatedEventTimer=setTimeout(()=>{if(this.currentDateRangeString===this._previousDateRange)return;this._previousDateRange=this.currentDateRangeString;const e={detail:{minDate:this.minSelectedDate,maxDate:this.maxSelectedDate},bubbles:!0,composed:!0};this.dispatchEvent(new CustomEvent("histogramDateRangeUpdated",e))},this.updateDelay)}cancelPendingUpdateEvent(){this._emitUpdatedEventTimer!==void 0&&(clearTimeout(this._emitUpdatedEventTimer),this._emitUpdatedEventTimer=void 0)}setDragOffset(e){this._currentSlider=e.currentTarget;const t=this._currentSlider.id==="slider-min"?this.minSliderX:this.maxSliderX,i=this.getBoundingClientRect().x;this._dragOffset=e.clientX-i-t}translatePositionToDate(e){const t=Math.ceil((e-this.sliderWidth)*this.dateRangeMS/this._histWidth);return this.formatDate(this._minDateMS+t)}translateDateToPosition(e){const t=this.getMSFromString(e);return this.sliderWidth+(t-this._minDateMS)*this._histWidth/this.dateRangeMS}clamp(e,t,i){return Math.min(Math.max(e,t),i)}handleInputFocus(){this.updateWhileFocused||this.cancelPendingUpdateEvent()}handleMinDateInput(e){const t=e.currentTarget;t.value!==this.minSelectedDate&&(this.minSelectedDate=t.value,this.beginEmitUpdateProcess())}handleMaxDateInput(e){const t=e.currentTarget;t.value!==this.maxSelectedDate&&(this.maxSelectedDate=t.value,this.beginEmitUpdateProcess())}handleKeyUp(e){if(e.key==="Enter"){const t=e.currentTarget;t.blur(),t.id==="date-min"?this.handleMinDateInput(e):t.id==="date-max"&&this.handleMaxDateInput(e)}}get currentDateRangeString(){return`${this.minSelectedDate}:${this.maxSelectedDate}`}getMSFromString(e){const t=typeof e=="string"?e:String(e);if((t.split(/(\d+)/).length-1)/2===1){const o=new Date(0,0);return o.setFullYear(Number(t)),o.getTime()}return Ji(t,[this.dateFormat,Ma]).valueOf()}handleBarClick(e){const t=e.currentTarget.dataset,i=(this.getMSFromString(t.binStart)+this.getMSFromString(t.binEnd))/2,o=Math.abs(i-this.getMSFromString(this.minSelectedDate)),r=Math.abs(i-this.getMSFromString(this.maxSelectedDate));o<r?this.minSelectedDate=t.binStart:this.maxSelectedDate=t.binEnd,this.beginEmitUpdateProcess()}get minSliderTemplate(){const e=Ea,t=`
            ...
            q0,${e} ${e},${e}
            h${this.sliderWidth-e}
          `;return this.generateSliderSVG(this.minSliderX,"slider-min",t)}get maxSliderTemplate(){const e=Ea,t=`
            M${this.maxSliderX},0
            h${this.sliderWidth-e}
            q${e},0 ${e},${e}
            v${this.height-e*2}
    ...
    `}get selectedRangeTemplate(){return O`
      ...
      />`}get histogramTemplate(){const e=this._histWidth/this._numBins,t=e-1;let i=this.sliderWidth;return this._histData.map(o=>{const r=O`
        <rect
          ...
          fill="${i+t>=this.minSliderX&&i<=this.maxSliderX?Wn:jn}"
          data-num-items="${o.value}"
          data-bin-start="${o.binStart}"
          data-bin-end="${o.binEnd}"
        />`;return i+=e,r})}formatDate(e){if(Number.isNaN(e))return"";const t=Ji(e);return t.year()<1e3?String(t.year()):t.format(this.dateFormat)}get minInputTemplate(){return h`
      <input
        id="date-min"
...
`;let te=class extends F{constructor(){super(...arguments),this.prompt="Do you find this feature useful?",this.buttonText="Beta",this.isOpen=!1,this.processing=!1,this.popupTopX=0,this.popupTopY=0,this.voteSubmitted=!1,this.voteNeedsChoosing=!1,this.resizingElement=document.body}render(){return h`
      <button
        id="beta-button"
    ...
    `}};s([c({type:String})],te.prototype,"featureIdentifier",void 0);s([c({type:String})],te.prototype,"prompt",void 0);s([c({type:String})],te.prototype,"buttonText",void 0);s([c({type:Object})],te.prototype,"recaptchaManager",void 0);s([c({type:Object})],te.prototype,"resizeObserver",void 0);s([c({type:Boolean})],te.prototype,"disabled",void 0);s([c({type:Object})],te.prototype,"featureFeedbackService",void 0);s([q("#beta-button")],te.prototype,"betaButton",void 0);s([q("#popup")],te.prototype,"popup",void 0);s([T()],te.prototype,"isOpen",void 0);s([T()],te.prototype,"processing",void 0);s([T()],te.prototype,"popupTopX",void 0);s([T()],te.prototype,"popupTopY",void 0);s([T()],te.prototype,"vote",void 0);s([T()],te.prototype,"voteSubmitted",void 0);s([T()],te.prototype,"error",void 0);s([T()],te.prototype,"voteNeedsChoosing",void 0);s([T()],te.prototype,"recaptchaWidget",void 0);s([q("#comments")],te.prototype,"comments",void 0);te=s([A("feature-feedback")],te);class wo{constructor(e){var t,i,o,r,n,l,d;this.title=e==null?void 0:e.title,this.subtitle=e==null?void 0:e.subtitle,this.headline=e==null?void 0:e.headline,this.message=e==null?void 0:e.message,this.headerColor=(t=e==null?void 0:e.headerColor)!==null&&t!==void 0?t:"#55A183",this.bodyColor=(i=e==null?void 0:e.bodyColor)!==null&&i!==void 0?i:"#f5f5f7",this.showProcessingIndicator=(o=e==null?void 0:e.showProcessingIndicator)!==null&&o!==void 0?o:!1,this.processingImageMode=(r=e==null?void 0:e.processingImageMode)!==null&&r!==void 0?r:"complete",this.showCloseButton=(n=e==null?void 0:e.showCloseButton)!==null&&n!==void 0?n:!0,this.showHeaderLogo=(l=e==null?void 0:e.showHeaderLogo)!==null&&l!==void 0?l:!0,this.closeOnBackdropClick=(d=e==null?void 0:e.closeOnBackdropClick)!==null&&d!==void 0?d:!0}}var Jn=h`
<svg
  viewBox="0 0 40 40"
  version="1.1"
  xmlns="http://www.w3.org/2000/svg"
...
`;let xo=class extends F{constructor(){super(...arguments),this.config=new wo}render(){return h`
      <div class="modal-wrapper">
        <div class="modal-container">
          <header style="background-color: ${this.config.headerColor}">
            ${this.config.showCloseButton?this.closeButtonTemplate:""}
            ${this.config.showHeaderLogo?h`<div class="logo-icon">${el}</div>`:y}
    ...
    `}static get styles(){const e=m`var(--modalLogoSize, 6.5rem)`,t=m`var(--processingImageSize, 7.5rem)`,i=m`var(--modalCornerRadius, 1rem)`,o=m`var(--modalBorder, 2px solid black)`,r=m`var(--modalBottomMargin, 2.5rem)`,n=m`var(--modalTopMargin, 5rem)`,l=m`var(--modalHeaderBottomPadding, 0.5em)`,d=m`var(--modalBottomPadding, 2rem)`,p=m`var(--modalScrollOffset, 5px)`,v=m`var(--modalTitleFontSize, 1.8rem)`,f=m`var(--modalSubtitleFontSize, 1.4rem)`,g=m`var(--modalHeadlineFontSize, 1.6rem)`,w=m`var(--modalMessageFontSize, 1.4rem)`,C=m`var(--modalTitleLineHeight, normal)`,E=m`var(--modalSubtitleLineHeight, normal)`,L=m`var(--modalHeadlineLineHeight, normal)`,D=m`var(--modalMessageLineHeight, normal)`;return m`
      .processing-logo {
        margin: auto;
        width: ${t};
        height: ${t};
    ...
    `}};s([c({type:Object})],xo.prototype,"config",void 0);xo=s([A("modal-template")],xo);function tl(a,e,t){var i=t||{},o=i.noTrailing,r=o===void 0?!1:o,n=i.noLeading,l=n===void 0?!1:n,d=i.debounceMode,p=d===void 0?void 0:d,v,f=!1,g=0;function w(){v&&clearTimeout(v)}function C(L){var D=L||{},N=D.upcomingOnly,oe=N===void 0?!1:N;w(),f=!oe}function E(){for(var L=arguments.length,D=new Array(L),N=0;N<L;N++)D[N]=arguments[N];var oe=this,K=Date.now()-g;if(f)return;function ne(){g=Date.now(),e.apply(oe,D)}function J(){v=void 0}!l&&p&&!v&&ne(),w(),p===void 0&&K>a?l?(g=Date.now(),r||(v=setTimeout(p?J:ne,a))):ne():r!==!0&&(v=setTimeout(p?J:ne,p===void 0?a-K:a))}return E.cancel=C,E}var ut;(function(a){a.Open="open",a.Closed="closed"})(ut||(ut={}));class il{constructor(e){this.windowResizeThrottler=tl(100,this.updateModalContainerHeight,{noLeading:!1,noTrailing:!1}).bind(this),this.modalManager=e}handleModeChange(e){switch(e){case ut.Open:this.startResizeListener(),this.stopDocumentScroll();break;case ut.Closed:this.stopResizeListener(),this.resumeDocumentScroll();break}}updateModalContainerHeight(){this.modalManager.style.setProperty("--containerHeight",`${window.innerHeight}px`)}stopDocumentScroll(){document.body.classList.add("modal-manager-open")}resumeDocumentScroll(){document.body.classList.remove("modal-manager-open")}startResizeListener(){window.addEventListener("resize",this.windowResizeThrottler)}stopResizeListener(){window.removeEventListener("resize",this.windowResizeThrottler)}}let Dt=class extends F{constructor(){super(...arguments),this.mode=ut.Closed,this.hostBridge=new il(this),this.closeOnBackdropClick=!0}render(){return h`
      <div class="container">
    ...
    `}};s([c({type:String,reflect:!0})],Dt.prototype,"mode",void 0);s([c({type:Object})],Dt.prototype,"customModalContent",void 0);s([c({type:Object})],Dt.prototype,"hostBridge",void 0);s([q("modal-template")],Dt.prototype,"modalTemplate",void 0);Dt=s([A("modal-manager")],Dt);var hr=O`<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><path d="m79.8883285 50.0035012.1116715-.1085359-43.1159942-46.61088155c-2.401537-2.18938917-4.6902018-3.28408375-6.8659943-3.28408375s-4.1642651.63837733-5.9654178 1.91513199c-1.8011528 1.27675467-3.1520173 2.97248092-4.0525937 5.08717877l39.4020173 42.99768924-39.4020173 42.9976892c.9005764 2.1146979 2.2514409 3.8104241 4.0525937 5.0871788 1.8011527 1.2767547 3.7896253 1.915132 5.9654178 1.915132 2.1013449 0 4.3900096-1.0573489 6.8659943-3.1720468l43.1159942-46.7194174z"/></svg>
`,ol=h`
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path
...
`;let Lt=class extends F{constructor(){super(...arguments),this.step=2,this.currentPage=1,this.pages=[]}firstUpdated(){this.observePageCount()}updated(e){e.has("size")&&this.observePageCount(),e.has("currentPage")&&(this.observePageCount(),this.emitPageClick())}observePageCount(){this.pages=[];const e=7,t=this.size<=e;if(this.size<=5){this.pages=[...Array(this.size).keys()].map(r=>r+1);return}if(this.size===e){if(this.currentPage===2){this.pages=[1,2,3,4,0,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,4,5,this.size-1,this.size];return}}if(this.currentPage===1){this.pages=[1,2,3,0,this.size];return}if(this.currentPage===this.size){this.pages=[1,0,this.size-2,this.size-1,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,this.size-3,this.size-2,this.size-1,this.size];return}if(t&&this.currentPage>1&&this.currentPage<e){this.pages=[...Array(this.size).keys()].map(r=>r+1);return}let i=this.currentPage-this.step,o=this.currentPage+this.step;i<=0&&(o+=-i+1,i=1),o>=this.size&&(i=Math.max(i-(o-this.size),1),o=this.size),i===2&&(o-=1),o===this.size-1&&(i+=1),this.createFirstNode(i),this.createMiddelNode(i,o),this.createLastNode(o)}createFirstNode(e){var t,i;e>1&&((t=this.pages)===null||t===void 0||t.push(1)),e>2&&((i=this.pages)===null||i===void 0||i.push(0))}createMiddelNode(e,t){var i;for(let o=e;o<=t;o+=1)(i=this.pages)===null||i===void 0||i.push(o)}createLastNode(e){var t,i;e<this.size-1&&((t=this.pages)===null||t===void 0||t.push(0)),e<this.size&&((i=this.pages)===null||i===void 0||i.push(this.size))}get getEllipsisTemplate(){return h`<i class="ellipses">...</i>`}emitPageClick(){this.dispatchEvent(new CustomEvent("pageNumberClicked",{detail:{page:this.currentPage},bubbles:!0,composed:!0}))}onRewind(){this.currentPage-=1,this.currentPage<1&&(this.currentPage=1)}onForward(){this.currentPage+=1,this.currentPage>this.size&&(this.currentPage=this.size)}onChange(e){this.currentPage=e}getPageTemplate(e){return h`
    ...
    `}static get styles(){return[tt,m`
      ...
      `]}};s([c({type:Number})],Lt.prototype,"size",void 0);s([c({type:Number})],Lt.prototype,"step",void 0);s([c({type:Number})],Lt.prototype,"currentPage",void 0);s([T()],Lt.prototype,"pages",void 0);Lt=s([A("more-facets-pagination")],Lt);var sl=O`
...
`;let mt=class extends F{constructor(){super(...arguments),this.collectionPagePath="/details/"}facetClicked(e,t,i){const o=e.target,{checked:r,name:n,value:l}=o;r?this.facetChecked(n,l,t,i):this.facetUnchecked(n,l),this.dispatchFacetClickEvent(n,this.getFacetState(r,i),i)}facetChecked(e,t,i,o){const{selectedFacets:r}=this;let n;r?n=re({},r):n=ei(),n[e][t]={state:this.getFacetState(!0,o),count:i},this.selectedFacets=n,this.dispatchSelectedFacetsChanged()}facetUnchecked(e,t){const{selectedFacets:i}=this;let o;i?o=re({},i):o=ei(),delete o[e][t],this.selectedFacets=o,this.dispatchSelectedFacetsChanged()}getFacetState(e,t){let i;return e?i=t?"hidden":"selected":i="none",i}dispatchFacetClickEvent(e,t,i){const o=new CustomEvent("facetClick",{detail:{key:e,state:t,negative:i},composed:!0});this.dispatchEvent(o)}dispatchSelectedFacetsChanged(){const e=new CustomEvent("selectedFacetsChanged",{detail:this.selectedFacets,bubbles:!0,composed:!0});this.dispatchEvent(e)}getFacetsTemplate(e){let t=e==null?void 0:e.buckets;return t=[...t.filter(i=>i.state==="selected").sort((i,o)=>i.count<o.count?1:-1),...t.filter(i=>i.state==="hidden").sort((i,o)=>i.count<o.count?1:-1),...t.filter(i=>i.state==="none")],h`
      <div class="facets-on-${this.renderOn}">
        ${or(t,i=>`${e.key}:${i.key}`,i=>{var o,r;const n=`${e.key}:${i.key}-show-only`,l=`${e.key}:${i.key}-negative`,d=e.key!=="collection"?h`${(o=i.displayText)!==null&&o!==void 0?o:i.key}`:h`<a href="${this.collectionPagePath}${i.key}">
                    <async-collection-name
                      .collectionNameCache=${this.collectionNameCache}
                      .identifier=${i.key}
                      placeholder="-"
                    ></async-collection-name>
                  </a> `,p=i.state==="hidden",v=i.state==="selected",f=`${e.key}: ${(r=i.displayText)!==null&&r!==void 0?r:i.key}`,g=v?`Show all ${e.key}s`:`Only show ${f}`,w=`Hide ${f}`,C=`Unhide ${f}`,E=p?C:w,L=`${f}, ${i.count} results`;return h`
              <div class="facet-row">
    ...
    `}get value(){return this.side==="left"?this.leftValue:this.rightValue}get selectedLabel(){var e,t;return this.side==="left"?(e=this.leftLabel)!==null&&e!==void 0?e:this.leftValue:(t=this.rightLabel)!==null&&t!==void 0?t:this.rightValue}handleClick(){this.side=this.side==="left"?"right":"left",this.emitChangeEvent()}handleRadioChange(){this.side=this.leftRadio.checked?"left":"right",this.emitChangeEvent()}emitChangeEvent(){const e=new CustomEvent("change",{detail:this.value});this.dispatchEvent(e)}static get styles(){const e=m`var(--switchWidth, 30px)`,t=m`var(--switchHeight, 14px)`,i=m`var(--switchMarginLeft, 5px)`,o=m`var(--switchMarginRight, 5px)`,r=m`var(--switchBorderWidth, 3px)`,n=m`var(--switchBgColor, #194880)`,l=m`var(--switchBorderColor, #194880)`,d=m`var(--labelFontSize, 1.3rem)`,p=m`var(--knobColor, white)`,v=m`var(--knobTransitionDuration, 0.25s)`,f=m`var(--knobTransitionFn, ease)`;return[tt,m`
      ...
      `]}};s([c({type:String,attribute:!0})],et.prototype,"leftValue",void 0);s([c({type:String,attribute:!0})],et.prototype,"leftLabel",void 0);s([c({type:String,attribute:!0})],et.prototype,"rightValue",void 0);s([c({type:String,attribute:!0})],et.prototype,"rightLabel",void 0);s([c({type:String,attribute:!0})],et.prototype,"side",void 0);s([q("#switch-left")],et.prototype,"leftRadio",void 0);et=s([A("toggle-switch")],et);let ie=class extends F{constructor(){super(...arguments),this.sortedBy=X.COUNT,this.facetGroup=[],this.facetGroupTitle="",this.pageNumber=1,this.facetsLoading=!0,this.paginationSize=0,this.facetsType="modal",this.facetsPerPage=35}updated(e){(e.has("facetKey")||e.has("facetAggregationKey")||e.has("query")||e.has("searchType")||e.has("filterMap"))&&(this.facetsLoading=!0,this.pageNumber=1,this.updateSpecificFacets()),e.has("pageNumber")&&(this.facetGroup=this.aggregationFacetGroups)}firstUpdated(){this.setupEscapeListeners()}setupEscapeListeners(){this.modalManager?document.addEventListener("keydown",e=>{var t;e.key==="Escape"&&((t=this.modalManager)===null||t===void 0||t.closeModal())}):document.removeEventListener("keydown",()=>{})}async updateSpecificFacets(){var e,t,i;const o=(e=this.query)===null||e===void 0?void 0:e.trim();if(!o&&!this.withinCollection)return;const r={simpleParams:[this.facetAggregationKey]},n=65535,l=this.withinCollection?{pageType:"collection_details",pageTarget:this.withinCollection}:null,d=xe(re({},l),{query:o||"",filters:this.filterMap,aggregations:r,aggregationsSize:n,rows:0}),p=await((t=this.searchService)===null||t===void 0?void 0:t.search(d,this.searchType));this.aggregations=(i=p==null?void 0:p.success)===null||i===void 0?void 0:i.response.aggregations,this.facetGroup=this.aggregationFacetGroups,this.facetsLoading=!1}pageNumberClicked(e){var t,i;const o=(t=e==null?void 0:e.detail)===null||t===void 0?void 0:t.page;o&&(this.pageNumber=Number(o)),(i=this.analyticsHandler)===null||i===void 0||i.sendEvent({category:Pe.default,action:ae.moreFacetsPageChange,label:`${this.pageNumber}`})}get mergedFacets(){var e;const t=[],i=this.selectedFacetGroups.find(l=>l.key===this.facetKey),o=this.aggregationFacetGroups.find(l=>l.key===this.facetKey);if(i&&!o)return t.push(i),t;if(!o)return t;const r=i!=null?i:o,n=(e=i==null?void 0:i.buckets.map(l=>{const d=o.buckets.find(p=>p.key===l.key);return d?xe(re({},l),{count:d.count}):l}))!==null&&e!==void 0?e:[];return o.buckets.forEach(l=>{n.find(p=>p.key===l.key)||n.push(l)}),r.buckets=n,t.push(r),t}get selectedFacetGroups(){return this.selectedFacets?Object.entries(this.selectedFacets).map(([t,i])=>{const o=t,r=$i[o],n=Object.entries(i).map(([l,d])=>({displayText:l,key:l,count:d==null?void 0:d.count,state:d==null?void 0:d.state}));return{title:r,key:o,buckets:n}}):[]}get aggregationFacetGroups(){var e;const t=[];return Object.entries((e=this.aggregations)!==null&&e!==void 0?e:[]).forEach(([i,o])=>{if(i==="year_histogram")return;const r=i;this.facetGroupTitle=$i[r];let n=o.getSortedBuckets(this.sortedBy);r==="collection"&&(n=n==null?void 0:n.filter(f=>{var g;const w=(g=f==null?void 0:f.key)===null||g===void 0?void 0:g.toString();return!Lo[w]&&!(w!=null&&w.startsWith("fav-"))}),this.preloadCollectionNames(n));const{length:l}=Object.keys(n);this.paginationSize=Math.ceil(l/this.facetsPerPage);const p=(n==null?void 0:n.slice((this.pageNumber-1)*this.facetsPerPage,this.pageNumber*this.facetsPerPage)).map(f=>{const g=f.key;return{displayText:`${f.key}`,key:`${g}`,count:f.doc_count,state:"none"}}),v={title:this.facetGroupTitle,key:r,buckets:p};t.push(v)}),t}preloadCollectionNames(e){var t;const i=e==null?void 0:e.map(r=>r.key),o=Array.from(new Set(i));(t=this.collectionNameCache)===null||t===void 0||t.preloadIdentifiers(o)}get getMoreFacetsTemplate(){var e;return h`
      <facets-template
    ...
    `}get loaderTemplate(){return h`<div class="facets-loader">
      <ia-activity-indicator .mode=${"processing"}></ia-activity-indicator>
        ...
        </div> `:y}sortFacetAggregation(e){this.sortedBy=e,this.dispatchEvent(new CustomEvent("sortedFacets",{detail:this.sortedBy}))}get getModalHeaderTemplate(){const t=fo[this.facetKey]===X.COUNT?"left":"right";return h`<span class="sr-only">More facets for:</span>
      <span class="title">
    ...
    `}applySearchFacetsClicked(){var e,t;const i=new CustomEvent("facetsChanged",{detail:this.selectedFacets,bubbles:!0,composed:!0});this.dispatchEvent(i),(e=this.modalManager)===null||e===void 0||e.closeModal(),(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:Pe.default,action:`${ae.applyMoreFacetsModal}`,label:`${this.facetKey}`})}cancelClick(){var e,t;(e=this.modalManager)===null||e===void 0||e.closeModal(),(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:Pe.default,action:ae.closeMoreFacetsModal,label:`${this.facetKey}`})}static get styles(){const e=m`var(--primaryButtonBGColor, #194880)`;return[tt,m`
      ...
      `]}};s([c({type:String})],ie.prototype,"facetKey",void 0);s([c({type:String})],ie.prototype,"facetAggregationKey",void 0);s([c({type:String})],ie.prototype,"query",void 0);s([c({type:Object})],ie.prototype,"filterMap",void 0);s([c({type:Object})],ie.prototype,"modalManager",void 0);s([c({type:Object})],ie.prototype,"searchService",void 0);s([c({type:String})],ie.prototype,"searchType",void 0);s([c({type:String})],ie.prototype,"withinCollection",void 0);s([c({type:Object})],ie.prototype,"collectionNameCache",void 0);s([c({type:Object})],ie.prototype,"selectedFacets",void 0);s([c({type:String})],ie.prototype,"sortedBy",void 0);s([c({type:Object,attribute:!1})],ie.prototype,"analyticsHandler",void 0);s([T()],ie.prototype,"aggregations",void 0);s([T()],ie.prototype,"facetGroup",void 0);s([T()],ie.prototype,"facetGroupTitle",void 0);s([T()],ie.prototype,"pageNumber",void 0);s([T()],ie.prototype,"facetsLoading",void 0);s([T()],ie.prototype,"paginationSize",void 0);s([T()],ie.prototype,"facetsType",void 0);ie=s([A("more-facets-content")],ie);let Fa=class extends F{render(){return h`
      <div id="row">
    ...
    `}};Fa=s([A("facet-tombstone-row")],Fa);let Fe=class extends F{constructor(){super(...arguments),this.boundEscapeListener=e=>{e.key==="Escape"&&this.closeModal()}}render(){var e,t;return h`
      <div id="container">
    ...
    `}connectedCallback(){var e;(e=super.connectedCallback)===null||e===void 0||e.call(this),this.setupEscapeListener()}disconnectedCallback(){var e;(e=super.disconnectedCallback)===null||e===void 0||e.call(this),this.removeEscapeListener()}setupEscapeListener(){document.addEventListener("keydown",this.boundEscapeListener)}removeEscapeListener(){document.removeEventListener("keydown",this.boundEscapeListener)}histogramDateRangeUpdated(e){this.minSelectedDate=e.detail.minDate,this.maxSelectedDate=e.detail.maxDate}applyBtnClicked(){var e;const t=new CustomEvent("histogramDateRangeApplied",{detail:{minDate:this.minSelectedDate,maxDate:this.maxSelectedDate}});this.dispatchEvent(t),this.closeModal(),(e=this.analyticsHandler)===null||e===void 0||e.sendEvent({category:Pe.default,action:ae.histogramChangedFromModal,label:window.location.href})}closeModal(){this.modalManager&&(this.modalManager.closeModal(),this.dispatchEvent(new CustomEvent("modalClosed")))}static get styles(){return m`
      #container {
        display: flex;
        justify-content: center;
    ...
    `}};s([c({type:String})],Fe.prototype,"minDate",void 0);s([c({type:String})],Fe.prototype,"maxDate",void 0);s([c({type:String})],Fe.prototype,"minSelectedDate",void 0);s([c({type:String})],Fe.prototype,"maxSelectedDate",void 0);s([c({type:Array})],Fe.prototype,"buckets",void 0);s([c({type:Object,attribute:!1})],Fe.prototype,"modalManager",void 0);s([c({type:Object,attribute:!1})],Fe.prototype,"analyticsHandler",void 0);Fe=s([A("expanded-date-picker")],Fe);let U=class extends F{constructor(){super(...arguments),this.moreLinksVisible=!0,this.facetsLoading=!1,this.fullYearAggregationLoading=!1,this.collapsableFacets=!1,this.showHistogramDatePicker=!1,this.allowExpandingDatePicker=!1,this.parentCollections=[],this.collectionPagePath="/details/",this.openFacets={subject:!1,lending:!1,mediatype:!1,language:!1,creator:!1,collection:!1,year:!1},this.allowedFacetCount=6,this.handleExpandedDatePickerClosed=()=>{var e;(e=this.modalManager)===null||e===void 0||e.classList.remove("expanded-date-picker")},this.histogramDateRangeUpdated=e=>{const{minDate:t,maxDate:i}=e.detail,o=new CustomEvent("histogramDateRangeUpdated",{detail:{minDate:t,maxDate:i}});this.dispatchEvent(o)}}render(){const e="date-picker-label";return h`
    ...
    `}partOfCollectionClicked(e){var t;(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:Pe.default,action:ae.partOfCollectionClicked,label:e.target.dataset.id})}showDatePickerModal(){var e,t,i;const{fullYearsHistogramAggregation:o}=this,r=o==null?void 0:o.first_bucket_key,n=o==null?void 0:o.last_bucket_key,l=o==null?void 0:o.buckets,p=h`
      <expanded-date-picker
        ${Dn(f=>{if(f&&f instanceof Fe){const g=f;g.minSelectedDate=this.minSelectedDate,g.maxSelectedDate=this.maxSelectedDate}})}
        .minDate=${r}
        .maxDate=${n}
    ...
    `,v=new wo({bodyColor:"#fff",headerColor:"#194880",showHeaderLogo:!1,closeOnBackdropClick:!0,title:h`Select a date range`});(e=this.modalManager)===null||e===void 0||e.classList.add("expanded-date-picker"),(t=this.modalManager)===null||t===void 0||t.showModal({config:v,customModalContent:p,userClosedModalCallback:this.handleExpandedDatePickerClosed}),(i=this.analyticsHandler)===null||i===void 0||i.sendEvent({category:Pe.default,action:ae.histogramExpanded,label:window.location.href})}updated(e){e.has("selectedFacets")&&this.dispatchFacetsChangedEvent()}dispatchFacetsChangedEvent(){const e=new CustomEvent("facetsChanged",{detail:this.selectedFacets});this.dispatchEvent(e)}get expandDatePickerBtnTemplate(){return this.allowExpandingDatePicker&&!this.facetsLoading?h`<button
        ...
        >
          ...
          <histogram-date-range
            ...
            @histogramDateRangeUpdated=${this.histogramDateRangeUpdated}
          ></histogram-date-range>
        `}get mergedFacets(){const e=[];return gn.forEach(t=>{var i,o;const r=this.selectedFacetGroups.find(v=>v.key===t),n=this.aggregationFacetGroups.find(v=>v.key===t);if(r&&!n){e.push(r);return}if(!n)return;const l=r!=null?r:n;let d=(i=r==null?void 0:r.buckets.map(v=>{const f=n.buckets.find(g=>g.key===v.key);return f?xe(re({},v),{count:f.count}):v}))!==null&&i!==void 0?i:[];n.buckets.forEach(v=>{d.find(g=>g.key===v.key)||d.push(v)});let p=(o=Object.keys((r==null?void 0:r.buckets)||[]))===null||o===void 0?void 0:o.length;if(p<this.allowedFacetCount&&(p=this.allowedFacetCount),t==="lending"&&(d=d.filter(v=>yn[v.key])),t==="mediatype"){const v=d.findIndex(f=>f.key==="collection");if(v>=p){const[f]=d.splice(v,1);d.splice(p-1,0,f),p>this.allowedFacetCount&&(p+=1)}}l.buckets=d.splice(0,p),e.push(l)}),e}get selectedFacetGroups(){return this.selectedFacets?Object.entries(this.selectedFacets).map(([t,i])=>{const o=t,r=$i[o],n=Object.entries(i).map(([l,d])=>{var p;let v=l;return o==="lending"&&(v=(p=Sa[l])!==null&&p!==void 0?p:l),{displayText:v,key:l,count:d.count,state:d.state}});return{title:r,key:o,buckets:n}}):[]}get aggregationFacetGroups(){var e;const t=[];return Object.entries((e=this.aggregations)!==null&&e!==void 0?e:[]).forEach(([i,o])=>{if(i==="year_histogram")return;const r=i,n=$i[r];if(!n)return;let l=o.getSortedBuckets(fo[r]);r==="collection"&&(l=l==null?void 0:l.filter(v=>{var f;const g=(f=v==null?void 0:v.key)===null||f===void 0?void 0:f.toString();return!Lo[g]&&!(g!=null&&g.startsWith("fav-"))}));const d=l.map(v=>{var f;const g=v.key;let w=`${v.key}`;return r==="lending"&&(w=(f=Sa[v.key])!==null&&f!==void 0?f:`${v.key}`),{displayText:w,key:`${g}`,count:v.doc_count,state:"none"}}),p={title:n,key:r,buckets:d};t.push(p)}),t}getFacetGroupTemplate(e){if(!this.facetsLoading&&e.buckets.length===0)return y;const{key:t}=e,i=this.openFacets[t],o=h`
      <span class="collapser ${i?"open":""}"> ${hr} </span>
    `,r=()=>{const l=re({},this.openFacets);l[t]=!i,this.openFacets=l},n=`facet-group-header-label-${e.key}`;return h`
      <section
    ...
    `}searchMoreFacetsLink(e){if(!this.moreLinksVisible||e.key==="lending"||Object.keys(e.buckets).length<this.allowedFacetCount)return y;const t=fo[e.key];return h`<button
      class="more-link"
      @click=${()=>{var i;this.showMoreFacetsModal(e,t),(i=this.analyticsHandler)===null||i===void 0||i.sendEvent({category:Pe.default,action:ae.showMoreFacetsModal,label:e.key}),this.dispatchEvent(new CustomEvent("showMoreFacets",{detail:e.key}))}}
    >
      More...
    ...
    `}static get styles(){return[tt,m`
      ...
      `]}};s([c({type:Object})],U.prototype,"searchService",void 0);s([c({type:String})],U.prototype,"searchType",void 0);s([c({type:Object})],U.prototype,"aggregations",void 0);s([c({type:Object})],U.prototype,"fullYearsHistogramAggregation",void 0);s([c({type:String})],U.prototype,"minSelectedDate",void 0);s([c({type:String})],U.prototype,"maxSelectedDate",void 0);s([c({type:Boolean})],U.prototype,"moreLinksVisible",void 0);s([c({type:Boolean})],U.prototype,"facetsLoading",void 0);s([c({type:Boolean})],U.prototype,"fullYearAggregationLoading",void 0);s([c({type:Object})],U.prototype,"selectedFacets",void 0);s([c({type:Boolean})],U.prototype,"collapsableFacets",void 0);s([c({type:Number})],U.prototype,"contentWidth",void 0);s([c({type:Boolean})],U.prototype,"showHistogramDatePicker",void 0);s([c({type:Boolean})],U.prototype,"allowExpandingDatePicker",void 0);s([c({type:String})],U.prototype,"query",void 0);s([c({type:String})],U.prototype,"withinCollection",void 0);s([c({type:Array})],U.prototype,"parentCollections",void 0);s([c({type:Object})],U.prototype,"filterMap",void 0);s([c({type:String})],U.prototype,"baseNavigationUrl",void 0);s([c({type:String})],U.prototype,"collectionPagePath",void 0);s([c({type:Object,attribute:!1})],U.prototype,"modalManager",void 0);s([c({type:Object,attribute:!1})],U.prototype,"resizeObserver",void 0);s([c({type:Object,attribute:!1})],U.prototype,"featureFeedbackService",void 0);s([c({type:Object,attribute:!1})],U.prototype,"recaptchaManager",void 0);s([c({type:Object,attribute:!1})],U.prototype,"analyticsHandler",void 0);s([c({type:Object,attribute:!1})],U.prototype,"collectionNameCache",void 0);s([T()],U.prototype,"openFacets",void 0);U=s([A("collection-facets")],U);let Ia=class extends F{render(){return h`
      <div class="lds-ring">
        <div></div>
        <div></div>
        <div></div>
...
`,De;let we=De=class extends F{constructor(){super(...arguments),this.placeholderType=null,this.detailMessage=""}render(){return this.placeholderType?h`${this.placeholderTemplate}`:y}get placeholderTemplate(){return h`
      <div
        class="placeholder ${this.placeholderType} ${this.isMobileView?"mobile":"desktop"}"
      >
        ${ul(this.placeholderType,[["empty-query",()=>this.emptyQueryTemplate],["empty-collection",()=>this.emptyCollectionTemplate],["no-results",()=>this.noResultsTemplate],["query-error",()=>this.queryErrorTemplate],["collection-error",()=>this.collectionErrorTemplate]])}
      </div>
    ...
    ></infinite-scroller>`}get infiniteScrollerClasses(){var e;return Yt({[(e=this.displayMode)!==null&&e!==void 0?e:""]:!!this.displayMode,hidden:!!this.placeholderType})}get sortFilterBarTemplate(){var e;return h`
      <sort-filter-bar
    ...
    `}histogramDateRangeUpdated(e){var t;const{minDate:i,maxDate:o}=e.detail;[this.minSelectedDate,this.maxSelectedDate]=[i,o],(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:this.searchContext,action:ae.histogramChanged,label:this.dateRangeQueryClause})}get dateRangeQueryClause(){if(!(!this.minSelectedDate||!this.maxSelectedDate))return`year:[${this.minSelectedDate} TO ${this.maxSelectedDate}]`}firstUpdated(){this.setupStateRestorationObserver(),this.restoreState()}updated(e){var t;if(e.has("placeholderType")&&this.placeholderType===null&&(this.leftColIntersectionObserver||this.setupLeftColumnScrollListeners(),this.facetsIntersectionObserver||this.setupFacetsScrollListeners(),this.updateLeftColumnHeight()),(e.has("displayMode")||e.has("baseNavigationUrl")||e.has("baseImageUrl")||e.has("loggedIn"))&&((t=this.infiniteScroller)===null||t===void 0||t.reload()),(e.has("baseQuery")||e.has("searchType")||e.has("withinCollection"))&&!this.historyPopOccurred&&this.initialQueryChangeHappened){const i=e.has("withinCollection")&&!e.has("selectedSort")&&!e.has("sortDirection");this.clearFilters({sort:i,facets:!e.has("selectedFacets"),dateRange:!(e.has("minSelectedDate")||e.has("maxSelectedDate")),letterFilters:!(e.has("selectedTitleFilter")||e.has("selectedCreatorFilter"))})}if(e.has("baseQuery")&&this.emitBaseQueryChanged(),e.has("searchType")&&this.emitSearchTypeChanged(),(e.has("currentPage")||e.has("displayMode"))&&this.persistState(),(e.has("baseQuery")||e.has("minSelectedDate")||e.has("maxSelectedDate")||e.has("selectedFacets")||e.has("searchService")||e.has("withinCollection"))&&this.refreshLetterCounts(),e.has("selectedSort")||e.has("sortDirection")){const i=e.get("sortDirection");this.sendSortByAnalytics(i),this.selectedSortChanged()}if(e.has("selectedTitleFilter")&&this.sendFilterByTitleAnalytics(e.get("selectedTitleFilter")),e.has("selectedCreatorFilter")&&this.sendFilterByCreatorAnalytics(e.get("selectedCreatorFilter")),(e.has("baseQuery")||e.has("searchType")||e.has("selectedTitleFilter")||e.has("selectedCreatorFilter")||e.has("minSelectedDate")||e.has("maxSelectedDate")||e.has("sortParam")||e.has("selectedFacets")||e.has("searchService")||e.has("withinCollection"))&&this.handleQueryChange(),e.has("searchResultsLoading")&&this.emitSearchResultsLoadingChanged(),e.has("facetsLoading")&&this.facetsLoading&&this.collectionFacets&&(this.collectionFacets.moreLinksVisible=this.searchType!==pe.FULLTEXT),e.has("pagesToRender")&&!this.endOfDataReached&&this.infiniteScroller&&(this.infiniteScroller.itemCount=this.estimatedTileCount),e.has("resizeObserver")){const i=e.get("resizeObserver");i&&this.disconnectResizeObserver(i),this.setupResizeObserver()}}disconnectedCallback(){var e,t;this.resizeObserver&&this.disconnectResizeObserver(this.resizeObserver),this.boundNavigationHandler&&window.removeEventListener("popstate",this.boundNavigationHandler),(e=this.leftColIntersectionObserver)===null||e===void 0||e.disconnect(),(t=this.facetsIntersectionObserver)===null||t===void 0||t.disconnect(),window.removeEventListener("resize",this.updateLeftColumnHeight)}handleResize(e){const t=this.mobileView;e.target===this.contentContainer&&(this.contentWidth=e.contentRect.width,this.mobileView=this.contentWidth>0&&this.contentWidth<this.mobileBreakpoint,this.mobileView&&!t&&(this.isResizeToMobile=!0)),this.updateLeftColumnHeight()}setupLeftColumnScrollListeners(){var e;const t=(e=this.shadowRoot)===null||e===void 0?void 0:e.querySelector("#left-column-scroll-sentinel");t&&(this.leftColIntersectionObserver=new IntersectionObserver(this.updateLeftColumnHeight,{threshold:[...Array(101).keys()].map(i=>i/100)}),this.leftColIntersectionObserver.observe(t)),window.addEventListener("resize",this.updateLeftColumnHeight)}setupFacetsScrollListeners(){var e;const t=(e=this.shadowRoot)===null||e===void 0?void 0:e.querySelector("#facets-scroll-sentinel");t&&(this.facetsIntersectionObserver=new IntersectionObserver(this.updateFacetFadeOut),this.facetsIntersectionObserver.observe(t))}emitBaseQueryChanged(){this.dispatchEvent(new CustomEvent("baseQueryChanged",{detail:{baseQuery:this.baseQuery}}))}emitSearchTypeChanged(){this.dispatchEvent(new CustomEvent("searchTypeChanged",{detail:this.searchType}))}emitTabChanged(e){this.dispatchEvent(new CustomEvent("tabChanged",{detail:e}))}disconnectResizeObserver(e){e.removeObserver({target:this.contentContainer,handler:this})}setupResizeObserver(){!this.resizeObserver||this.resizeObserver.addObserver({target:this.contentContainer,handler:this})}visibleCellsChanged(e){if(this.isScrollingToCell)return;const{visibleCellIndices:t}=e.detail;if(t.length===0)return;const i=t[t.length-1],o=Math.floor(i/this.pageSize)+1;this.currentPage!==o&&(this.currentPage=o);const r=new CustomEvent("visiblePageChanged",{detail:{pageNumber:o}});this.dispatchEvent(r)}get initialSearchComplete(){return this._initialSearchCompletePromise}async handleQueryChange(){var e;!this.searchService||this.pageFetchQueryKey===this.previousQueryKey||!this.canPerformSearch||(this.previousQueryKey=this.pageFetchQueryKey,this.dataSource={},this.totalResults=void 0,this.aggregations=void 0,this.fullYearsHistogramAggregation=void 0,this.pageFetchesInProgress={},this.endOfDataReached=!1,this.pagesToRender=this.initialPageNumber===1?2:this.initialPageNumber,this.queryErrorMessage=void 0,this.infiniteScroller&&(this.infiniteScroller.itemCount=this.estimatedTileCount,this.infiniteScroller.reload()),this.withinCollection&&((e=this.baseQuery)===null||e===void 0?void 0:e.trim())&&(this.defaultSortField=_.relevance,this.defaultSortDirection=null),!this.initialQueryChangeHappened&&this.initialPageNumber>1&&this.scrollToPage(this.initialPageNumber),this.initialQueryChangeHappened=!0,this.historyPopOccurred||this.persistState(),this.historyPopOccurred=!1,this._initialSearchCompletePromise=new Promise(t=>{this._initialSearchCompleteResolver=t}),await Promise.all([this.doInitialPageFetch(),this.fetchFacets()]),this._initialSearchCompleteResolver(!0))}setupStateRestorationObserver(){this.boundNavigationHandler||(this.boundNavigationHandler=this.historyNavigationHandler.bind(this),window.addEventListener("popstate",this.boundNavigationHandler))}historyNavigationHandler(){this.historyPopOccurred=!0,this.restoreState()}restoreState(){var e,t,i,o,r;const n=this.restorationStateHandler.getRestorationState();this.displayMode=n.displayMode,n.searchType!=null&&(this.searchType=n.searchType),this.selectedSort=(e=n.selectedSort)!==null&&e!==void 0?e:_.default,this.sortDirection=(t=n.sortDirection)!==null&&t!==void 0?t:null,this.selectedTitleFilter=(i=n.selectedTitleFilter)!==null&&i!==void 0?i:null,this.selectedCreatorFilter=(o=n.selectedCreatorFilter)!==null&&o!==void 0?o:null,this.selectedFacets=n.selectedFacets,this.baseQuery=n.baseQuery,this.currentPage=(r=n.currentPage)!==null&&r!==void 0?r:1,this.minSelectedDate=n.minSelectedDate,this.maxSelectedDate=n.maxSelectedDate,this.currentPage>1&&this.goToPage(this.currentPage)}persistState(){var e,t,i,o;const r={displayMode:this.displayMode,searchType:this.searchType,selectedSort:this.selectedSort,sortDirection:(e=this.sortDirection)!==null&&e!==void 0?e:void 0,selectedFacets:(t=this.selectedFacets)!==null&&t!==void 0?t:ei(),baseQuery:this.baseQuery,currentPage:this.currentPage,titleQuery:this.titleQuery,creatorQuery:this.creatorQuery,minSelectedDate:this.minSelectedDate,maxSelectedDate:this.maxSelectedDate,selectedTitleFilter:(i=this.selectedTitleFilter)!==null&&i!==void 0?i:void 0,selectedCreatorFilter:(o=this.selectedCreatorFilter)!==null&&o!==void 0?o:void 0};this.restorationStateHandler.persistState(r)}async doInitialPageFetch(){this.searchResultsLoading=!0,await this.fetchPage(this.initialPageNumber,2),this.searchResultsLoading=!1}emitSearchResultsLoadingChanged(){this.dispatchEvent(new CustomEvent("searchResultsLoadingChanged",{detail:{loading:this.searchResultsLoading}}))}async requestUID(e,t){var i;const o=JSON.stringify({pageType:e.pageType,pageTarget:e.pageTarget,query:e.query,fields:e.fields,filters:e.filters,sort:e.sort,searchType:this.searchType}),r=(await Oa(o)).slice(0,20),n=(await this.getSessionId()).slice(0,20),l=(i=e.page)!==null&&i!==void 0?i:0,d=t.charAt(0),p=Date.now();return`R:${r}-S:${n}-P:${l}-K:${d}-T:${p}`}get filterMap(){const e=new Ur;if(this.minSelectedDate&&e.addFilter("year",this.minSelectedDate,Ke.GREATER_OR_EQUAL),this.maxSelectedDate&&e.addFilter("year",this.maxSelectedDate,Ke.LESS_OR_EQUAL),this.selectedFacets)for(const[i,o]of Object.entries(this.selectedFacets)){const{name:r,values:n}=this.prepareFacetForFetch(i,o);for(const[l,d]of Object.entries(n)){let p;d.state==="selected"?p=Ke.INCLUDE:d.state==="hidden"&&(p=Ke.EXCLUDE),p&&e.addFilter(r,l,p)}}return this.selectedTitleFilter&&e.addFilter("firstTitle",this.selectedTitleFilter,Ke.INCLUDE),this.selectedCreatorFilter&&e.addFilter("firstCreator",this.selectedCreatorFilter,Ke.INCLUDE),e.build()}get fullQuery(){var e,t;let i=(t=(e=this.baseQuery)===null||e===void 0?void 0:e.trim())!==null&&t!==void 0?t:"";const{facetQuery:o,dateRangeQueryClause:r,sortFilterQueries:n}=this;return o&&(i+=` AND ${o}`),r&&(i+=` AND ${r}`),n&&(i+=` AND ${n}`),i.trim()}get facetQuery(){var e;if(!this.selectedFacets)return;const t=[];for(const[i,o]of Object.entries(this.selectedFacets))t.push(this.buildFacetClause(i,o));return(e=this.joinFacetClauses(t))===null||e===void 0?void 0:e.trim()}buildFacetClause(e,t){const{name:i,values:o}=this.prepareFacetForFetch(e,t),r=Object.entries(o);if(r.length===0)return"";const n=[];for(const[d,p]of r){const v=p.state==="hidden"?"-":"";n.push(`${v}"${d}"`)}const l=n.join(" OR ");return`${i}:(${l})`}prepareFacetForFetch(e,t){let[i,o]=[e,t];return e==="lending"&&(i="lending___status"),{name:i,values:o}}joinFacetClauses(e){const t=e.filter(i=>i.length>0);return t.length>0?`(${t.join(" AND ")})`:void 0}facetsChanged(e){this.selectedFacets=e.detail}facetClickHandler({detail:{key:e,state:t,negative:i}}){var o,r;i?(o=this.analyticsHandler)===null||o===void 0||o.sendEvent({category:this.searchContext,action:t!=="none"?ae.facetNegativeSelected:ae.facetNegativeDeselected,label:e}):(r=this.analyticsHandler)===null||r===void 0||r.sendEvent({category:this.searchContext,action:t!=="none"?ae.facetSelected:ae.facetDeselected,label:e})}async fetchFacets(){var e,t,i,o,r,n,l,d,p,v,f,g;const w=(e=this.baseQuery)===null||e===void 0?void 0:e.trim();if(!this.canPerformSearch)return;const{facetFetchQueryKey:C}=this,E=this.sortParam?[this.sortParam]:[],L=xe(re({},this.collectionParams),{query:w||"",rows:0,filters:this.filterMap,aggregationsSize:10});L.uid=await this.requestUID(xe(re({},L),{sort:E}),"aggregations"),this.facetsLoading=!0;const D=await((t=this.searchService)===null||t===void 0?void 0:t.search(L,this.searchType)),N=D==null?void 0:D.success;if(C!==this.facetFetchQueryKey)return;if(!N){const J=(i=D==null?void 0:D.error)===null||i===void 0?void 0:i.message,V=(r=(o=D==null?void 0:D.error)===null||o===void 0?void 0:o.details)===null||r===void 0?void 0:r.message;!J&&!V&&((l=(n=window==null?void 0:window.Sentry)===null||n===void 0?void 0:n.captureMessage)===null||l===void 0||l.call(n,"Missing or malformed facet response from backend","error"));return}const{aggregations:K,collectionTitles:ne}=N.response;this.aggregations=K,ne?(d=this.collectionNameCache)===null||d===void 0||d.addKnownTitles(ne):!((p=this.aggregations)===null||p===void 0)&&p.collection&&((v=this.collectionNameCache)===null||v===void 0||v.preloadIdentifiers(this.aggregations.collection.buckets.map(J=>{var V;return(V=J.key)===null||V===void 0?void 0:V.toString()}))),this.fullYearsHistogramAggregation=(g=(f=N==null?void 0:N.response)===null||f===void 0?void 0:f.aggregations)===null||g===void 0?void 0:g.year_histogram,this.facetsLoading=!1}scrollToPage(e){return new Promise(t=>{const i=this.pageSize*(e-1);setTimeout(()=>{var o;this.isScrollingToCell=!0,(o=this.infiniteScroller)===null||o===void 0||o.scrollToCell(i,!0),setTimeout(()=>{var r;this.isScrollingToCell=!1,(r=this.infiniteScroller)===null||r===void 0||r.reload(),t()},500)},0)})}get isRelevanceSortAvailable(){var e;return!!(!((e=this.baseQuery)===null||e===void 0)&&e.trim())}get canPerformSearch(){var e;if(!this.searchService)return!1;const i=!!((e=this.baseQuery)===null||e===void 0?void 0:e.trim()),o=!!this.withinCollection,r=this.searchType===pe.METADATA;return i||o&&r}get collectionParams(){return this.withinCollection?{pageType:"collection_details",pageTarget:this.withinCollection}:null}get pageFetchQueryKey(){var e,t,i,o;const r=(t=(e=this.sortParam)===null||e===void 0?void 0:e.field)!==null&&t!==void 0?t:"none",n=(o=(i=this.sortParam)===null||i===void 0?void 0:i.direction)!==null&&o!==void 0?o:"none";return`${this.fullQuery}-${this.withinCollection}-${this.searchType}-${r}-${n}`}get facetFetchQueryKey(){return`${this.fullQuery}-${this.withinCollection}-${this.searchType}`}async fetchPage(e,t=1){var i,o,r,n,l,d,p,v,f,g,w,C,E;const L=(i=this.baseQuery)===null||i===void 0?void 0:i.trim();if(!this.canPerformSearch||this.dataSource[e]||this.endOfDataReached)return;const D=e===1?t:1,N=this.pageSize*D,{pageFetchQueryKey:oe}=this,K=(o=this.pageFetchesInProgress[oe])!==null&&o!==void 0?o:new Set;if(K.has(e))return;for(let R=0;R<D;R+=1)K.add(e+R);this.pageFetchesInProgress[oe]=K;const ne=this.sortParam?[this.sortParam]:[],J=xe(re({},this.collectionParams),{query:L||"",page:e,rows:N,sort:ne,filters:this.filterMap,aggregations:{omit:!0}});J.uid=await this.requestUID(J,"hits");const V=await((r=this.searchService)===null||r===void 0?void 0:r.search(J,this.searchType)),Me=V==null?void 0:V.success;if(oe!==this.pageFetchQueryKey)return;if(!Me){const R=(n=V==null?void 0:V.error)===null||n===void 0?void 0:n.message,be=(d=(l=V==null?void 0:V.error)===null||l===void 0?void 0:l.details)===null||d===void 0?void 0:d.message;this.queryErrorMessage=`${R!=null?R:""}${be?`; ${be}`:""}`,this.queryErrorMessage||(this.queryErrorMessage="Missing or malformed response from backend",(v=(p=window==null?void 0:window.Sentry)===null||p===void 0?void 0:p.captureMessage)===null||v===void 0||v.call(p,this.queryErrorMessage,"error"));for(let Ce=0;Ce<D;Ce+=1)(f=this.pageFetchesInProgress[oe])===null||f===void 0||f.delete(e+Ce);this.searchResultsLoading=!1;return}this.totalResults=Me.response.totalResults,this.totalResults===0&&this.emitTabChanged("about"),this.withinCollection&&(this.collectionInfo=Me.response.collectionExtraInfo,this.applyDefaultCollectionSort(this.collectionInfo),this.collectionInfo&&(this.parentCollections=[].concat((w=(g=this.collectionInfo.public_metadata)===null||g===void 0?void 0:g.collection)!==null&&w!==void 0?w:[])));const{results:Se,collectionTitles:Ge}=Me.response;if(Se&&Se.length>0){Ge?(C=this.collectionNameCache)===null||C===void 0||C.addKnownTitles(Ge):this.preloadCollectionNames(Se);for(let R=0;R<D;R+=1){const be=this.pageSize*R;this.updateDataSource(e+R,Se.slice(be,be+this.pageSize))}}const Ie=N-Se.length;Ie>0&&(this.endOfDataReached=!0,this.infiniteScroller&&(this.infiniteScroller.itemCount=this.estimatedTileCount-Ie));for(let R=0;R<D;R+=1)(E=this.pageFetchesInProgress[oe])===null||E===void 0||E.delete(e+R)}preloadCollectionNames(e){var t;const i=e.map(r=>{var n;return(n=r.collection)===null||n===void 0?void 0:n.values}).flat(),o=Array.from(new Set(i));(t=this.collectionNameCache)===null||t===void 0||t.preloadIdentifiers(o)}applyDefaultCollectionSort(e){var t,i,o;if(this.baseQuery){this.defaultSortField=_.relevance,this.defaultSortDirection=null;return}const r=!((i=(t=e==null?void 0:e.public_metadata)===null||t===void 0?void 0:t.identifier)===null||i===void 0)&&i.startsWith("fav-")?"-favoritedate":"-week",n=(o=e==null?void 0:e.public_metadata)===null||o===void 0?void 0:o["sort-by"],l=n!=null?n:r;let[d,p]=l.split(":");d.startsWith("-")?(d=d.slice(1),p="desc"):["asc","desc"].includes(p)||(p="asc");const f=dr(d).field;f&&f!==_.default&&(this.defaultSortField=f,this.defaultSortDirection=p)}get currentVisiblePageNumbers(){var e,t;const i=(t=(e=this.infiniteScroller)===null||e===void 0?void 0:e.getVisibleCellIndices())!==null&&t!==void 0?t:[],o=new Set;return i.forEach(r=>{const n=Math.floor(r/this.pageSize)+1;o.add(n)}),Array.from(o)}updateDataSource(e,t){var i;const o=re({},this.dataSource),r=[];t==null||t.forEach(d=>{var p,v,f,g,w,C,E,L,D,N,oe,K,ne,J,V,Me,ft,Se,Ge,Ie,R,be,Ce,Ft,It,Bt,gt,it,Y,bt,ee,yt,G,Be,ot,wt,at,xt,Ee,$e;if(!d.identifier)return;let rt=!1,st=!1;if(((p=d.collection)===null||p===void 0?void 0:p.values.length)&&((v=d.mediatype)===null||v===void 0?void 0:v.value)!=="collection"){for(const Oe of(g=(f=d.collection)===null||f===void 0?void 0:f.values)!==null&&g!==void 0?g:[])if(Oe==="loggedin"&&(rt=!0,st)||Oe==="no-preview"&&(st=!0,rt))break}r.push({averageRating:(w=d.avg_rating)===null||w===void 0?void 0:w.value,collections:(E=(C=d.collection)===null||C===void 0?void 0:C.values)!==null&&E!==void 0?E:[],collectionFilesCount:(D=(L=d.collection_files_count)===null||L===void 0?void 0:L.value)!==null&&D!==void 0?D:0,collectionSize:(oe=(N=d.collection_size)===null||N===void 0?void 0:N.value)!==null&&oe!==void 0?oe:0,commentCount:(ne=(K=d.num_reviews)===null||K===void 0?void 0:K.value)!==null&&ne!==void 0?ne:0,creator:(J=d.creator)===null||J===void 0?void 0:J.value,creators:(Me=(V=d.creator)===null||V===void 0?void 0:V.values)!==null&&Me!==void 0?Me:[],dateAdded:(ft=d.addeddate)===null||ft===void 0?void 0:ft.value,dateArchived:(Se=d.publicdate)===null||Se===void 0?void 0:Se.value,datePublished:(Ge=d.date)===null||Ge===void 0?void 0:Ge.value,dateReviewed:(Ie=d.reviewdate)===null||Ie===void 0?void 0:Ie.value,description:(R=d.description)===null||R===void 0?void 0:R.values.join(`
`),favCount:(Ce=(be=d.num_favorites)===null||be===void 0?void 0:be.value)!==null&&Ce!==void 0?Ce:0,href:this.collapseRepeatedQuotes((Ft=d.__href__)===null||Ft===void 0?void 0:Ft.value),identifier:d.identifier,issue:(It=d.issue)===null||It===void 0?void 0:It.value,itemCount:(gt=(Bt=d.item_count)===null||Bt===void 0?void 0:Bt.value)!==null&&gt!==void 0?gt:0,mediatype:(Y=(it=d.mediatype)===null||it===void 0?void 0:it.value)!==null&&Y!==void 0?Y:"data",snippets:(ee=(bt=d.highlight)===null||bt===void 0?void 0:bt.values)!==null&&ee!==void 0?ee:[],source:(yt=d.source)===null||yt===void 0?void 0:yt.value,subjects:(Be=(G=d.subject)===null||G===void 0?void 0:G.values)!==null&&Be!==void 0?Be:[],title:(wt=(ot=d.title)===null||ot===void 0?void 0:ot.value)!==null&&wt!==void 0?wt:"",volume:(at=d.volume)===null||at===void 0?void 0:at.value,viewCount:(Ee=(xt=d.downloads)===null||xt===void 0?void 0:xt.value)!==null&&Ee!==void 0?Ee:0,weeklyViewCount:($e=d.week)===null||$e===void 0?void 0:$e.value,loginRequired:rt,contentWarning:st})}),o[e]=r,this.dataSource=o,this.currentVisiblePageNumbers.includes(e)&&((i=this.infiniteScroller)===null||i===void 0||i.reload())}collapseRepeatedQuotes(e){return e==null?void 0:e.replace(/%22%22(?!%22%22)(.+?)%22%22/g,"%22$1%22")}async fetchPrefixFilterBuckets(e){var t,i,o,r,n,l,d;const p=(t=this.baseQuery)===null||t===void 0?void 0:t.trim();if(!this.canPerformSearch)return[];const v=fn[e],f=this.sortParam?[this.sortParam]:[],g=xe(re({},this.collectionParams),{query:p||"",rows:0,filters:this.filterMap,aggregations:{simpleParams:[v]},aggregationsSize:26});g.uid=await this.requestUID(xe(re({},g),{sort:f}),"aggregations");const w=await((i=this.searchService)===null||i===void 0?void 0:i.search(g,this.searchType));return(d=(l=(n=(r=(o=w==null?void 0:w.success)===null||o===void 0?void 0:o.response)===null||r===void 0?void 0:r.aggregations)===null||n===void 0?void 0:n[v])===null||l===void 0?void 0:l.buckets)!==null&&d!==void 0?d:[]}async updatePrefixFilterCounts(e){const{facetFetchQueryKey:t}=this,i=await this.fetchPrefixFilterBuckets(e);t===this.facetFetchQueryKey&&(this.prefixFilterCountMap=re({},this.prefixFilterCountMap),this.prefixFilterCountMap[e]=i.reduce((r,n)=>(r[n.key.toUpperCase()]=n.doc_count,r),{}))}async updatePrefixFiltersForCurrentSort(){if(["title","creator"].includes(this.selectedSort)){const e=this.selectedSort;this.prefixFilterCountMap[e]||this.updatePrefixFilterCounts(e)}}refreshLetterCounts(){Object.keys(this.prefixFilterCountMap).length>0&&(this.prefixFilterCountMap={}),this.updatePrefixFiltersForCurrentSort()}resultSelected(e){var t,i;(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:this.searchContext,action:ae.resultSelected,label:e.detail.mediatype}),(i=this.analyticsHandler)===null||i===void 0||i.sendEvent({category:this.searchContext,action:ae.resultSelected,label:`page-${this.currentPage}`})}cellForIndex(e){const t=this.tileModelAtCellIndex(e);if(!!t)return h`
      <tile-dispatcher
        .collectionPagePath=${this.collectionPagePath}
        .baseNavigationUrl=${this.baseNavigationUrl}
        .baseImageUrl=${this.baseImageUrl}
    ...
    `}scrollThresholdReached(){this.endOfDataReached||(this.pagesToRender+=1,this.fetchPage(this.pagesToRender))}static get styles(){return[tt,m`
        :host {
          display: block;
