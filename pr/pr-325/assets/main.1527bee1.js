...
`,Le;let xe=Le=class extends A{constructor(){super(...arguments),this.placeholderType=null,this.detailMessage=""}render(){return this.placeholderType?h`${this.placeholderTemplate}`:y}get placeholderTemplate(){return h`
    ...
    </infinite-scroller>`}get infiniteScrollerClasses(){var e;return zt({[(e=this.displayMode)!==null&&e!==void 0?e:""]:!!this.displayMode,hidden:!!this.placeholderType})}get navBarTemplate(){return this.isLoansTab?h`<slot
          name="cb-loans-topbar-slot"
          slot="cb-loans-topbar-slot"
        ></slot>`:this.sortFilterBarTemplate}get sortFilterBarTemplate(){var e;return h`
      <sort-filter-bar
