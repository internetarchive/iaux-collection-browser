...
`,na;let Fi=na=class extends O{render(){return h`${this.facetRowTemplate}`}get facetRowTemplate(){var e,t,i,o;const{bucket:a,facetType:r}=this;if(!a||!r)return b;const l=`${r}:${a.key}-show-only`,d=`${r}:${a.key}-negative`,c=r!=="collection"?h`${(e=a.displayText)!==null&&e!==void 0?e:a.key}`:h`<a href="/details/${a.key}">
    ...
    `}};$n=n([D("facet-tombstone-row")],$n);let Qe=class extends O{constructor(){super(...arguments),this.boundEscapeListener=e=>{e.key==="Escape"&&this.closeModal()}}render(){var e,t;return h`
      <div id="container">
    ...
    `}partOfCollectionClicked(e){var t;(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:Ve.default,action:ie.partOfCollectionClicked,label:e.target.dataset.id})}showDatePickerModal(){var e,t,i;const{fullYearsHistogramAggregation:o}=this,a=o==null?void 0:o.first_bucket_key,r=o==null?void 0:o.last_bucket_key,l=o==null?void 0:o.buckets,c=h`
      <expanded-date-picker
        ${y0(v=>{if(v&&v instanceof Qe){const m=v;m.minSelectedDate=this.minSelectedDate,m.maxSelectedDate=this.maxSelectedDate}})}
        .minDate=${a}
        .maxDate=${r}
...
`;function xh(s){return s&&s.charAt(0).toLocaleUpperCase()+s.slice(1)}let Oi=class extends O{constructor(){super(...arguments),this.selected=!1}render(){var e,t;if(!this.facetInfo)return b;const i=this.facetInfo.facets.length===1,o=this.facetInfo.facets[0],a=xh((this.labelPrefix?`${this.labelPrefix} `:"")+((t=(e=this.facetInfo.label)!==null&&e!==void 0?e:o.displayText)!==null&&t!==void 0?t:o.bucketKey));if(!a)return b;const r=i&&o.facetType==="mediatype"?Yn[o.bucketKey].icon:b;return h`
    ...
    `}};n([p({type:Array})],ti.prototype,"facetInfo",void 0);n([p({type:String})],ti.prototype,"labelPrefix",void 0);n([p({type:Object})],ti.prototype,"activeFacetRef",void 0);n([ee("ia-dropdown")],ti.prototype,"dropdown",void 0);ti=n([D("smart-facet-dropdown")],ti);const Sn={collection:"Collection: ",creator:"By: ",subject:"About: "};function Sh(s){return s.charAt(0).toUpperCase()+s.slice(1)}let Ke=class extends O{constructor(){super(...arguments),this.filterToggleActive=!1,this.heuristicRecs=[],this.smartFacets=[]}render(){return h`
