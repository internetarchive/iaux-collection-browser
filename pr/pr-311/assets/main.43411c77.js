var $l=Object.defineProperty,xl=Object.defineProperties;var Sl=Object.getOwnPropertyDescriptors;var Qr=Object.getOwnPropertySymbols;var Cl=Object.prototype.hasOwnProperty,kl=Object.prototype.propertyIsEnumerable;var Kr=(a,e,t)=>e in a?$l(a,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):a[e]=t,j=(a,e)=>{for(var t in e||(e={}))Cl.call(e,t)&&Kr(a,t,e[t]);if(Qr)for(var t of Qr(e))kl.call(e,t)&&Kr(a,t,e[t]);return a},oe=(a,e)=>xl(a,Sl(e));import ka from"https://esm.archive.org/dayjs@1.11.10";import Tl from"https://esm.archive.org/dayjs@1.9.4/esm/plugin/customParseFormat";const El=function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const s of r.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function t(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerpolicy&&(r.referrerPolicy=o.referrerpolicy),o.crossorigin==="use-credentials"?r.credentials="include":o.crossorigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(o){if(o.ep)return;o.ep=!0;const r=t(o);fetch(o.href,r)}};El();function n(a,e,t,i){var o=arguments.length,r=o<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(a,e,t,i);else for(var l=a.length-1;l>=0;l--)(s=a[l])&&(r=(o<3?s(r):o>3?s(e,t,r):s(e,t))||r);return o>3&&r&&Object.defineProperty(e,t,r),r}function Ml(a,e,t,i){function o(r){return r instanceof t?r:new t(function(s){s(r)})}return new(t||(t=Promise))(function(r,s){function l(u){try{c(i.next(u))}catch(v){s(v)}}function d(u){try{c(i.throw(u))}catch(v){s(v)}}function c(u){u.done?r(u.value):o(u.value).then(l,d)}c((i=i.apply(a,e||[])).next())})}class Al{constructor(e){var t,i,o,r;this.ARCHIVE_ANALYTICS_VERSION=2,this.DEFAULT_SERVICE="ao_2",this.NO_SAMPLING_SERVICE="ao_no_sampling",this.DEFAULT_IMAGE_URL="https://analytics.archive.org/0.gif",this.defaultService=(t=e==null?void 0:e.defaultService)!==null&&t!==void 0?t:this.DEFAULT_SERVICE,this.imageUrl=(i=e==null?void 0:e.imageUrl)!==null&&i!==void 0?i:this.DEFAULT_IMAGE_URL,this.imageContainer=(o=e==null?void 0:e.imageContainer)!==null&&o!==void 0?o:document.body,this.requireImagePing=(r=e==null?void 0:e.requireImagePing)!==null&&r!==void 0?r:!1}sendPing(e){const t=this.generateTrackingUrl(e).toString();if(this.requireImagePing){this.sendPingViaImage(t);return}const i=navigator.sendBeacon&&navigator.sendBeacon.bind(navigator);try{i(t)}catch{this.sendPingViaImage(t)}}sendEvent(e){const t=e.label&&e.label.trim().length>0?e.label:window.location.pathname,i=j({kind:"event",ec:e.category,ea:e.action,el:t,cache_bust:Math.random()},e.eventConfiguration);this.sendPing(i)}sendEventNoSampling(e){const t=e.eventConfiguration||{};t.service=this.NO_SAMPLING_SERVICE;const i=e;i.eventConfiguration=t,this.sendEvent(i)}sendPingViaImage(e){const t=new Image(1,1);t.src=e,t.alt="",this.imageContainer.appendChild(t)}generateTrackingUrl(e){var t;const i=e!=null?e:{};i.service=(t=i.service)!==null&&t!==void 0?t:this.defaultService;const o=new URL(this.imageUrl),r=Object.keys(i);return r.forEach(s=>{const l=i[s];o.searchParams.append(s,l)}),o.searchParams.append("version",`${this.ARCHIVE_ANALYTICS_VERSION}`),o.searchParams.append("count",`${r.length+2}`),o}}function g(a){let e,t,i;return typeof a=="object"?(e=a.hashFunction,t=a.expiring,i=a.tags):e=a,(o,r,s)=>{if(s.value!=null)s.value=qr(s.value,e,t,i);else if(s.get!=null)s.get=qr(s.get,e,t,i);else throw"Only put a Memoize() decorator on a method or get accessor."}}const jo=new Map;function qr(a,e,t=0,i){const o=Symbol("__memoized_map__");return function(...r){let s;this.hasOwnProperty(o)||Object.defineProperty(this,o,{configurable:!1,enumerable:!1,writable:!1,value:new Map});let l=this[o];if(Array.isArray(i))for(const d of i)jo.has(d)?jo.get(d).push(l):jo.set(d,[l]);if(e||r.length>0||t>0){let d;e===!0?d=r.map(v=>v.toString()).join("!"):e?d=e.apply(this,r):d=r[0];const c=`${d}__timestamp`;let u=!1;if(t>0)if(!l.has(c))u=!0;else{let v=l.get(c);u=Date.now()-v>t}l.has(d)&&!u?s=l.get(d):(s=a.apply(this,r),l.set(d,s),t>0&&l.set(c,Date.now()))}else{const d=this;l.has(d)?s=l.get(d):(s=a.apply(this,r),l.set(d,s))}return s}}class Ta{parseValue(e){return typeof e=="string"&&(e==="false"||e==="0")?!1:Boolean(e)}}Ta.shared=new Ta;class oo{parseValue(e){if(typeof e=="number")return e;if(typeof e=="boolean")return;const t=parseFloat(e);if(!Number.isNaN(t))return t}}oo.shared=new oo;class Ea{parseValue(e){return oo.shared.parseValue(e)}}Ea.shared=new Ea;class Ma{parseValue(e){return this.parseJSDate(e)||this.parseBracketDate(e)}parseBracketDate(e){if(typeof e!="string")return;const t=e.match(/\[([0-9]{4})\]/);if(!(!t||t.length<2))return this.parseJSDate(t[1])}parseJSDate(e){if(typeof e!="string")return;let t=e;t.match(/^[0-9]{4}-[0-9]{2}-[0-9]{2}\s{1}[0-9]{2}:[0-9]{2}:[0-9]{2}$/)&&(t=t.replace(" ","T"));const i=Date.parse(t);if(Number.isNaN(i))return;let o=new Date(t);return(t.indexOf("Z")>-1||t.indexOf("+")>-1||t.match(/^[0-9]{4}$/)||t.match(/^[0-9]{4}-[0-9]{2}-[0-9]{2}$/)||t.match(/^.*?-[0-9]{2}:[0-9]{2}$/)||t.match(/^.*?-[0-9]{4}$/))&&(o=new Date(o.getTime()+o.getTimezoneOffset()*1e3*60)),o}}Ma.shared=new Ma;class Aa{parseValue(e){if(typeof e=="number")return e;if(typeof e=="boolean")return;const t=e.split(":");let i;return t.length===1?i=this.parseNumberFormat(t[0]):i=this.parseColonSeparatedFormat(t),i}parseNumberFormat(e){let t=parseFloat(e);return Number.isNaN(t)&&(t=void 0),t}parseColonSeparatedFormat(e){let t=!1;const i=e.map((o,r)=>{const s=parseFloat(o);if(Number.isNaN(s))return t=!0,0;const l=e.length-1-r,d=60**l;return s*Math.floor(d)}).reduce((o,r)=>o+r,0);return t?void 0:i}}Aa.shared=new Aa;class za{parseValue(e){if(typeof e=="string")return e}}za.shared=new za;class zl{constructor(e,t){this.separators=[";",","],this.parser=e,t&&t.separators&&(this.separators=t.separators)}parseValue(e){const t=String(e);let i=[];for(const o of this.separators)if(i=t.split(o),i.length>1)break;return this.parseListValues(i)}parseListValues(e){const i=e.map(r=>r.trim()).map(r=>this.parser.parseValue(r)),o=[];return i.forEach(r=>{r!==void 0&&o.push(r)}),o}}class Pa{parseValue(e){if(typeof e=="string")return e}}Pa.shared=new Pa;class ao{parseValue(e){return String(e)}}ao.shared=new ao;class Le{constructor(e,t){this.parser=e,this.rawValue=t}get values(){return this.parseRawValue()}get value(){return this.values[0]}parseRawValue(){if(this.rawValue===void 0)return[];const e=Array.isArray(this.rawValue)?this.rawValue:[this.rawValue],t=[];return e.forEach(i=>{const o=this.parser.parseValue(i);Array.isArray(o)?t.push(...o):o!==void 0&&t.push(o)}),t}}n([g()],Le.prototype,"values",null);n([g()],Le.prototype,"value",null);class gt extends Le{constructor(e){super(Ta.shared,e)}}class W extends Le{constructor(e){super(Ma.shared,e)}}class Wo extends Le{constructor(e){super(Aa.shared,e)}}class N extends Le{constructor(e){super(oo.shared,e)}}class C extends Le{constructor(e){super(ao.shared,e)}}class Pl extends Le{constructor(e){super(Pa.shared,e)}}class ro extends Le{constructor(e){super(Ea.shared,e)}}class Li extends Le{constructor(e){super(za.shared,e)}}class Ll extends Le{constructor(e,t){super(t,e)}}class Dl extends Ll{constructor(e){const t=new zl(ao.shared);super(e,t)}}class E{constructor(e){this.rawMetadata=e}get identifier(){var e;return(e=this.rawMetadata)===null||e===void 0?void 0:e.identifier}get addeddate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.addeddate?new W(this.rawMetadata.addeddate):void 0}get audio_codec(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.audio_codec?new C(this.rawMetadata.audio_codec):void 0}get audio_sample_rate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.audio_sample_rate?new N(this.rawMetadata.audio_sample_rate):void 0}get avg_rating(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.avg_rating?new N(this.rawMetadata.avg_rating):void 0}get collection(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.collection?new C(this.rawMetadata.collection):void 0}get collections_raw(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.collections_raw?new C(this.rawMetadata.collections_raw):void 0}get collection_size(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.collection_size?new ro(this.rawMetadata.collection_size):void 0}get contributor(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.contributor?new C(this.rawMetadata.contributor):void 0}get coverage(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.coverage?new C(this.rawMetadata.coverage):void 0}get creator(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.creator?new C(this.rawMetadata.creator):void 0}get date(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.date?new W(this.rawMetadata.date):void 0}get description(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.description?new C(this.rawMetadata.description):void 0}get downloads(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.downloads?new N(this.rawMetadata.downloads):void 0}get duration(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.duration?new Wo(this.rawMetadata.duration):void 0}get"external-identifier"(){var e,t;return!((e=this.rawMetadata)===null||e===void 0)&&e["external-identifier"]?new C((t=this.rawMetadata)===null||t===void 0?void 0:t["external-identifier"]):void 0}get files_count(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.files_count?new N(this.rawMetadata.files_count):void 0}get indexdate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.indexdate?new W(this.rawMetadata.indexdate):void 0}get isbn(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.isbn?new C(this.rawMetadata.isbn):void 0}get issue(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.issue?new C(this.rawMetadata.issue):void 0}get item_count(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.item_count?new N(this.rawMetadata.item_count):void 0}get item_size(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.item_size?new ro(this.rawMetadata.item_size):void 0}get language(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.language?new C(this.rawMetadata.language):void 0}get length(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.length?new Wo(this.rawMetadata.length):void 0}get lineage(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.lineage?new C(this.rawMetadata.lineage):void 0}get month(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.month?new N(this.rawMetadata.month):void 0}get mediatype(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.mediatype?new Li(this.rawMetadata.mediatype):void 0}get noindex(){var e;return((e=this.rawMetadata)===null||e===void 0?void 0:e.noindex)!=null?new gt(this.rawMetadata.noindex):void 0}get notes(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.notes?new C(this.rawMetadata.notes):void 0}get num_favorites(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.num_favorites?new N(this.rawMetadata.num_favorites):void 0}get num_reviews(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.num_reviews?new N(this.rawMetadata.num_reviews):void 0}get openlibrary_edition(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.openlibrary_edition?new C(this.rawMetadata.openlibrary_edition):void 0}get openlibrary_work(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.openlibrary_work?new C(this.rawMetadata.openlibrary_work):void 0}get page_progression(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.page_progression?new Pl(this.rawMetadata.page_progression):void 0}get partner(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.partner?new C(this.rawMetadata.partner):void 0}get ppi(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.ppi?new N(this.rawMetadata.ppi):void 0}get publicdate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.publicdate?new W(this.rawMetadata.publicdate):void 0}get publisher(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.publisher?new C(this.rawMetadata.publisher):void 0}get reviewdate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.reviewdate?new W(this.rawMetadata.reviewdate):void 0}get runtime(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.runtime?new Wo(this.rawMetadata.runtime):void 0}get scanner(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.scanner?new C(this.rawMetadata.scanner):void 0}get source(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.source?new C(this.rawMetadata.source):void 0}get start_localtime(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.start_localtime?new W(this.rawMetadata.start_localtime):void 0}get start_time(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.start_time?new W(this.rawMetadata.start_time):void 0}get stop_time(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.stop_time?new W(this.rawMetadata.stop_time):void 0}get subject(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.subject?new Dl(this.rawMetadata.subject):void 0}get taper(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.taper?new C(this.rawMetadata.taper):void 0}get title(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.title?new C(this.rawMetadata.title):void 0}get transferer(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.transferer?new C(this.rawMetadata.transferer):void 0}get track(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.track?new N(this.rawMetadata.track):void 0}get type(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.type?new C(this.rawMetadata.type):void 0}get uploader(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.uploader?new C(this.rawMetadata.uploader):void 0}get utc_offset(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.utc_offset?new N(this.rawMetadata.utc_offset):void 0}get venue(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.venue?new C(this.rawMetadata.venue):void 0}get volume(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.volume?new C(this.rawMetadata.volume):void 0}get week(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.week?new N(this.rawMetadata.week):void 0}get year(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.year?new W(this.rawMetadata.year):void 0}get query(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.query?new C(this.rawMetadata.fields.query):void 0}get date_favorited(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.date_favorited?new W(this.rawMetadata.fields.date_favorited):void 0}get __href__(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.__href__?new C(this.rawMetadata.fields.__href__):void 0}}n([g()],E.prototype,"addeddate",null);n([g()],E.prototype,"audio_codec",null);n([g()],E.prototype,"audio_sample_rate",null);n([g()],E.prototype,"avg_rating",null);n([g()],E.prototype,"collection",null);n([g()],E.prototype,"collections_raw",null);n([g()],E.prototype,"collection_size",null);n([g()],E.prototype,"contributor",null);n([g()],E.prototype,"coverage",null);n([g()],E.prototype,"creator",null);n([g()],E.prototype,"date",null);n([g()],E.prototype,"description",null);n([g()],E.prototype,"downloads",null);n([g()],E.prototype,"duration",null);n([g()],E.prototype,"external-identifier",null);n([g()],E.prototype,"files_count",null);n([g()],E.prototype,"indexdate",null);n([g()],E.prototype,"isbn",null);n([g()],E.prototype,"issue",null);n([g()],E.prototype,"item_count",null);n([g()],E.prototype,"item_size",null);n([g()],E.prototype,"language",null);n([g()],E.prototype,"length",null);n([g()],E.prototype,"lineage",null);n([g()],E.prototype,"month",null);n([g()],E.prototype,"mediatype",null);n([g()],E.prototype,"noindex",null);n([g()],E.prototype,"notes",null);n([g()],E.prototype,"num_favorites",null);n([g()],E.prototype,"num_reviews",null);n([g()],E.prototype,"openlibrary_edition",null);n([g()],E.prototype,"openlibrary_work",null);n([g()],E.prototype,"page_progression",null);n([g()],E.prototype,"partner",null);n([g()],E.prototype,"ppi",null);n([g()],E.prototype,"publicdate",null);n([g()],E.prototype,"publisher",null);n([g()],E.prototype,"reviewdate",null);n([g()],E.prototype,"runtime",null);n([g()],E.prototype,"scanner",null);n([g()],E.prototype,"source",null);n([g()],E.prototype,"start_localtime",null);n([g()],E.prototype,"start_time",null);n([g()],E.prototype,"stop_time",null);n([g()],E.prototype,"subject",null);n([g()],E.prototype,"taper",null);n([g()],E.prototype,"title",null);n([g()],E.prototype,"transferer",null);n([g()],E.prototype,"track",null);n([g()],E.prototype,"type",null);n([g()],E.prototype,"uploader",null);n([g()],E.prototype,"utc_offset",null);n([g()],E.prototype,"venue",null);n([g()],E.prototype,"volume",null);n([g()],E.prototype,"week",null);n([g()],E.prototype,"year",null);n([g()],E.prototype,"query",null);n([g()],E.prototype,"date_favorited",null);n([g()],E.prototype,"__href__",null);class O{constructor(e){this.rawMetadata=e}get identifier(){var e,t;return(t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.identifier}get addeddate(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.addeddate?new W(this.rawMetadata.fields.addeddate):void 0}get avg_rating(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.avg_rating)!=null?new N(this.rawMetadata.fields.avg_rating):void 0}get collection(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.collection?new C(this.rawMetadata.fields.collection):void 0}get collection_files_count(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.collection_files_count)!=null?new N(this.rawMetadata.fields.collection_files_count):void 0}get collection_size(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.collection_size)!=null?new ro(this.rawMetadata.fields.collection_size):void 0}get creator(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.creator?new C(this.rawMetadata.fields.creator):void 0}get date(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.date?new W(this.rawMetadata.fields.date):void 0}get description(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.description?new C(this.rawMetadata.fields.description):void 0}get downloads(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.downloads)!=null?new N(this.rawMetadata.fields.downloads):void 0}get files_count(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.files_count)!=null?new N(this.rawMetadata.fields.files_count):void 0}get genre(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.genre?new C(this.rawMetadata.fields.genre):void 0}get indexflag(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.indexflag?new C(this.rawMetadata.fields.indexflag):void 0}get issue(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.issue?new C(this.rawMetadata.fields.issue):void 0}get item_count(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.item_count)!=null?new N(this.rawMetadata.fields.item_count):void 0}get item_size(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.item_size)!=null?new ro(this.rawMetadata.fields.item_size):void 0}get language(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.language?new C(this.rawMetadata.fields.language):void 0}get lending___available_to_borrow(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.lending___available_to_borrow)!=null?new gt(this.rawMetadata.fields.lending___available_to_borrow):void 0}get lending___available_to_browse(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.lending___available_to_browse)!=null?new gt(this.rawMetadata.fields.lending___available_to_browse):void 0}get lending___available_to_waitlist(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.lending___available_to_waitlist)!=null?new gt(this.rawMetadata.fields.lending___available_to_waitlist):void 0}get lending___status(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.lending___status?new C(this.rawMetadata.fields.lending___status):void 0}get licenseurl(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.licenseurl?new C(this.rawMetadata.fields.licenseurl):void 0}get mediatype(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.mediatype?new Li(this.rawMetadata.fields.mediatype):void 0}get month(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.month)!=null?new N(this.rawMetadata.fields.month):void 0}get noindex(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.noindex)!=null?new gt(this.rawMetadata.fields.noindex):void 0}get num_favorites(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.num_favorites)!=null?new N(this.rawMetadata.fields.num_favorites):void 0}get num_reviews(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.num_reviews)!=null?new N(this.rawMetadata.fields.num_reviews):void 0}get publicdate(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.publicdate?new W(this.rawMetadata.fields.publicdate):void 0}get reviewdate(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.reviewdate?new W(this.rawMetadata.fields.reviewdate):void 0}get review(){var e;const t=(e=this.rawMetadata)===null||e===void 0?void 0:e.review;return t?{body:t.reviewbody,title:t.reviewtitle,author:t.reviewer,authorItem:t.reviewer_itemname,updatedate:new Date(t.reviewdate),createdate:new Date(t.createdate),stars:Number(t.stars)||0,__href__:t.__href__}:void 0}get source(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.source?new C(this.rawMetadata.fields.source):void 0}get subject(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.subject?new C(this.rawMetadata.fields.subject):void 0}get title(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.title?new C(this.rawMetadata.fields.title):void 0}get type(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.type?new C(this.rawMetadata.fields.type):void 0}get volume(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.volume?new C(this.rawMetadata.fields.volume):void 0}get week(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.week)!=null?new N(this.rawMetadata.fields.week):void 0}get year(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.year)!=null?new N(this.rawMetadata.fields.year):void 0}}n([g()],O.prototype,"addeddate",null);n([g()],O.prototype,"avg_rating",null);n([g()],O.prototype,"collection",null);n([g()],O.prototype,"collection_files_count",null);n([g()],O.prototype,"collection_size",null);n([g()],O.prototype,"creator",null);n([g()],O.prototype,"date",null);n([g()],O.prototype,"description",null);n([g()],O.prototype,"downloads",null);n([g()],O.prototype,"files_count",null);n([g()],O.prototype,"genre",null);n([g()],O.prototype,"indexflag",null);n([g()],O.prototype,"issue",null);n([g()],O.prototype,"item_count",null);n([g()],O.prototype,"item_size",null);n([g()],O.prototype,"language",null);n([g()],O.prototype,"lending___available_to_borrow",null);n([g()],O.prototype,"lending___available_to_browse",null);n([g()],O.prototype,"lending___available_to_waitlist",null);n([g()],O.prototype,"lending___status",null);n([g()],O.prototype,"licenseurl",null);n([g()],O.prototype,"mediatype",null);n([g()],O.prototype,"month",null);n([g()],O.prototype,"noindex",null);n([g()],O.prototype,"num_favorites",null);n([g()],O.prototype,"num_reviews",null);n([g()],O.prototype,"publicdate",null);n([g()],O.prototype,"reviewdate",null);n([g()],O.prototype,"review",null);n([g()],O.prototype,"source",null);n([g()],O.prototype,"subject",null);n([g()],O.prototype,"title",null);n([g()],O.prototype,"type",null);n([g()],O.prototype,"volume",null);n([g()],O.prototype,"week",null);n([g()],O.prototype,"year",null);class Y{constructor(e){this.rawMetadata=e}get identifier(){var e,t;return(t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.identifier}get highlight(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.highlight)===null||t===void 0)&&t.text?new C(this.rawMetadata.highlight.text):void 0}get addeddate(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.addeddate?new W(this.rawMetadata.fields.addeddate):void 0}get avg_rating(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.avg_rating)!=null?new N(this.rawMetadata.fields.avg_rating):void 0}get collection(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.collection?new C(this.rawMetadata.fields.collection):void 0}get created_on(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.created_on?new W(this.rawMetadata.fields.created_on):void 0}get creator(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.creator?new C(this.rawMetadata.fields.creator):void 0}get date(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.date?new W(this.rawMetadata.fields.date):void 0}get description(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.description?new C(this.rawMetadata.fields.description):void 0}get downloads(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.downloads)!=null?new N(this.rawMetadata.fields.downloads):void 0}get filename(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.filename?new C(this.rawMetadata.fields.filename):void 0}get file_basename(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.file_basename?new C(this.rawMetadata.fields.file_basename):void 0}get file_creation_mtime(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.file_creation_mtime)!=null?new N(this.rawMetadata.fields.file_creation_mtime):void 0}get issue(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.issue?new C(this.rawMetadata.fields.issue):void 0}get mediatype(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.mediatype?new Li(this.rawMetadata.fields.mediatype):void 0}get page_num(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.page_num)!=null?new N(this.rawMetadata.fields.page_num):void 0}get publicdate(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.publicdate?new W(this.rawMetadata.fields.publicdate):void 0}get result_in_subfile(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.result_in_subfile)!=null?new gt(this.rawMetadata.fields.result_in_subfile):void 0}get reviewdate(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.reviewdate?new W(this.rawMetadata.fields.reviewdate):void 0}get source(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.source?new C(this.rawMetadata.fields.source):void 0}get subject(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.subject?new C(this.rawMetadata.fields.subject):void 0}get title(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.title?new C(this.rawMetadata.fields.title):void 0}get updated_on(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.updated_on?new W(this.rawMetadata.fields.updated_on):void 0}get year(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.year)!=null?new N(this.rawMetadata.fields.year):void 0}get __href__(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.__href__?new C(this.rawMetadata.fields.__href__):void 0}}n([g()],Y.prototype,"highlight",null);n([g()],Y.prototype,"addeddate",null);n([g()],Y.prototype,"avg_rating",null);n([g()],Y.prototype,"collection",null);n([g()],Y.prototype,"created_on",null);n([g()],Y.prototype,"creator",null);n([g()],Y.prototype,"date",null);n([g()],Y.prototype,"description",null);n([g()],Y.prototype,"downloads",null);n([g()],Y.prototype,"filename",null);n([g()],Y.prototype,"file_basename",null);n([g()],Y.prototype,"file_creation_mtime",null);n([g()],Y.prototype,"issue",null);n([g()],Y.prototype,"mediatype",null);n([g()],Y.prototype,"page_num",null);n([g()],Y.prototype,"publicdate",null);n([g()],Y.prototype,"result_in_subfile",null);n([g()],Y.prototype,"reviewdate",null);n([g()],Y.prototype,"source",null);n([g()],Y.prototype,"subject",null);n([g()],Y.prototype,"title",null);n([g()],Y.prototype,"updated_on",null);n([g()],Y.prototype,"year",null);n([g()],Y.prototype,"__href__",null);var G;(function(a){a[a.COUNT=0]="COUNT",a[a.ALPHABETICAL=1]="ALPHABETICAL",a[a.NUMERIC=2]="NUMERIC"})(G||(G={}));class gn{constructor(e){this.buckets=e.buckets,this.doc_count_error_upper_bound=e.doc_count_error_upper_bound,this.sum_other_doc_count=e.sum_other_doc_count,this.first_bucket_key=e.first_bucket_key,this.last_bucket_key=e.last_bucket_key,this.number_buckets=e.number_buckets,this.interval=e.interval}getSortedBuckets(e){const t=[...this.buckets];if(this.isRawNumberBuckets(t))return t;const i=new Intl.Collator;switch(e){case G.ALPHABETICAL:return t.sort((o,r)=>i.compare(o.key.toString(),r.key.toString()));case G.NUMERIC:return t.sort((o,r)=>Number(r.key)-Number(o.key));case G.COUNT:default:return t}}isRawNumberBuckets(e){return typeof this.buckets[0]=="number"}}n([g()],gn.prototype,"getSortedBuckets",null);class Di{constructor(e){this.rawMetadata=e}get identifier(){var e;return(e=this.rawMetadata)===null||e===void 0?void 0:e.fields.query}get title(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.title?new C(this.rawMetadata.fields.title):void 0}get query(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.query?new C(this.rawMetadata.fields.query):void 0}get date_favorited(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.date_favorited?new W(this.rawMetadata.fields.date_favorited):void 0}get __href__(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.__href__?new C(this.rawMetadata.fields.__href__):void 0}}n([g()],Di.prototype,"title",null);n([g()],Di.prototype,"query",null);n([g()],Di.prototype,"date_favorited",null);n([g()],Di.prototype,"__href__",null);class $o{constructor(e){this.rawMetadata=e}get identifier(){var e,t;return(t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.url}get mediatype(){return new Li("web")}get title(){var e,t,i;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.url?new C((i=this.rawMetadata.fields)===null||i===void 0?void 0:i.url):void 0}get capture_dates(){var e,t,i;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.capture_dates?new W((i=this.rawMetadata.fields)===null||i===void 0?void 0:i.capture_dates):void 0}get __href__(){var e,t,i;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.__href__?new C((i=this.rawMetadata.fields)===null||i===void 0?void 0:i.__href__):void 0}}n([g()],$o.prototype,"title",null);n([g()],$o.prototype,"capture_dates",null);n([g()],$o.prototype,"__href__",null);class X{constructor(e){this.rawMetadata=e}get identifier(){var e,t;return(t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.identifier}get highlight(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.highlight)===null||t===void 0)&&t.text?new C(this.rawMetadata.highlight.text):void 0}get addeddate(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.addeddate?new W(this.rawMetadata.fields.addeddate):void 0}get avg_rating(){var e,t,i;const o=(t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.avg_rating;return o||o===0?new N((i=this.rawMetadata)===null||i===void 0?void 0:i.fields.avg_rating):void 0}get collection(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.collection?new C(this.rawMetadata.fields.collection):void 0}get created_on(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.created_on?new W(this.rawMetadata.fields.created_on):void 0}get creator(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.creator?new C(this.rawMetadata.fields.creator):void 0}get date(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.date?new W(this.rawMetadata.fields.date):void 0}get description(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.description?new C(this.rawMetadata.fields.description):void 0}get downloads(){var e,t,i;const o=(t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.downloads;return o||o===0?new N((i=this.rawMetadata)===null||i===void 0?void 0:i.fields.downloads):void 0}get filename(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.filename?new C(this.rawMetadata.fields.filename):void 0}get file_basename(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.file_basename?new C(this.rawMetadata.fields.file_basename):void 0}get file_creation_mtime(){var e,t,i;const o=(t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.file_creation_mtime;return o||o===0?new N((i=this.rawMetadata)===null||i===void 0?void 0:i.fields.file_creation_mtime):void 0}get issue(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.issue?new C(this.rawMetadata.fields.issue):void 0}get mediatype(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.mediatype?new Li(this.rawMetadata.fields.mediatype):void 0}get publicdate(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.publicdate?new W(this.rawMetadata.fields.publicdate):void 0}get result_in_subfile(){var e,t,i;const o=(t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.result_in_subfile;return o||o===!1?new gt((i=this.rawMetadata)===null||i===void 0?void 0:i.fields.result_in_subfile):void 0}get reviewdate(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.reviewdate?new W(this.rawMetadata.fields.reviewdate):void 0}get source(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.source?new C(this.rawMetadata.fields.source):void 0}get subject(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.subject?new C(this.rawMetadata.fields.subject):void 0}get title(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.title?new C(this.rawMetadata.fields.title):void 0}get updated_on(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.updated_on?new W(this.rawMetadata.fields.updated_on):void 0}get year(){var e,t,i;const o=(t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.year;return o||o===0?new N((i=this.rawMetadata)===null||i===void 0?void 0:i.fields.year):void 0}get start(){var e,t,i;const o=(t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.start;return o||o===0?new C((i=this.rawMetadata)===null||i===void 0?void 0:i.fields.start):void 0}get __href__(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.__href__?new C(this.rawMetadata.fields.__href__):void 0}}n([g()],X.prototype,"highlight",null);n([g()],X.prototype,"addeddate",null);n([g()],X.prototype,"avg_rating",null);n([g()],X.prototype,"collection",null);n([g()],X.prototype,"created_on",null);n([g()],X.prototype,"creator",null);n([g()],X.prototype,"date",null);n([g()],X.prototype,"description",null);n([g()],X.prototype,"downloads",null);n([g()],X.prototype,"filename",null);n([g()],X.prototype,"file_basename",null);n([g()],X.prototype,"file_creation_mtime",null);n([g()],X.prototype,"issue",null);n([g()],X.prototype,"mediatype",null);n([g()],X.prototype,"publicdate",null);n([g()],X.prototype,"result_in_subfile",null);n([g()],X.prototype,"reviewdate",null);n([g()],X.prototype,"source",null);n([g()],X.prototype,"subject",null);n([g()],X.prototype,"title",null);n([g()],X.prototype,"updated_on",null);n([g()],X.prototype,"year",null);n([g()],X.prototype,"start",null);n([g()],X.prototype,"__href__",null);const Rl=["loans","waitlist","loan_history"];function Fl(a){const e=a.slice(0,4),t=a.slice(4,6),i=a.slice(6,8),o=a.slice(8,10),r=a.slice(10,12),s=a.slice(12,14);return`${e}-${t}-${i}T${o}:${r}:${s}Z`}function Bl(a){var e;const t=[];for(const i of a){if(!(!((e=i.captures)===null||e===void 0)&&e.length))continue;const o=encodeURIComponent(i.url),r=`https://web.archive.org/web/${i.captures[0]}/${o}`;t.push({hit_type:"web_archive",fields:{url:i.url,capture_dates:i.captures.map(s=>Fl(s)),__href__:r}})}return t}class cr{constructor(e,t){var i,o,r,s,l,d,c,u,v,m,w,$,x,P;this.schema=t,this.schemaHitType=t==null?void 0:t.hit_type;let R;e!=null&&e.page_elements&&(this.pageElements=e.page_elements,R=Object.values(this.pageElements)[0]);let L=(i=e==null?void 0:e.hits)===null||i===void 0?void 0:i.hits;this.totalResults=(r=(o=e==null?void 0:e.hits)===null||o===void 0?void 0:o.total)!==null&&r!==void 0?r:0,this.returnedCount=(l=(s=e==null?void 0:e.hits)===null||s===void 0?void 0:s.returned)!==null&&l!==void 0?l:0,!(L!=null&&L.length)&&((d=this.pageElements)===null||d===void 0?void 0:d.service___fts)?(this.totalResults=0,this.returnedCount=0,this.handleFederatedPageElements()):!(L!=null&&L.length)&&((c=R==null?void 0:R.hits)===null||c===void 0?void 0:c.hits)?(L=R.hits.hits,this.totalResults=(u=R.hits.total)!==null&&u!==void 0?u:0,this.returnedCount=(v=R.hits.returned)!==null&&v!==void 0?v:0):!((m=this.pageElements)===null||m===void 0)&&m.lending?L=this.handleLendingPageElement():!((w=this.pageElements)===null||w===void 0)&&w.web_archives&&(L=this.handleWebArchivesPageElement()),this.results=this.formatHits(L);let K=e==null?void 0:e.aggregations;!(this.aggregations&&Object.keys(this.aggregations).length>0)&&(R==null?void 0:R.aggregations)&&(K=R.aggregations),K&&this.buildAggregations(K),e!=null&&e.collection_titles&&(this.collectionTitles=($=e.collection_titles)!==null&&$!==void 0?$:{}),e!=null&&e.collection_extra_info&&(this.collectionExtraInfo=(x=e.collection_extra_info)!==null&&x!==void 0?x:null),e!=null&&e.account_extra_info&&(this.accountExtraInfo=(P=e.account_extra_info)!==null&&P!==void 0?P:null)}formatHits(e){var t;return(t=e==null?void 0:e.map(i=>{var o;return cr.createResult((o=i.hit_type)!==null&&o!==void 0?o:this.schemaHitType,i)}))!==null&&t!==void 0?t:[]}buildAggregations(e){this.aggregations=Object.entries(e).reduce((t,[i,o])=>(t[i]=new gn(o),t),{})}handleLendingPageElement(){var e,t;const i=(e=this.pageElements)===null||e===void 0?void 0:e.lending,o=(t=i.loans)!==null&&t!==void 0?t:[];this.totalResults=o.length,this.returnedCount=this.totalResults;for(const r of Rl)i[r]=this.formatHits(i[r]);return o}handleWebArchivesPageElement(){var e;const t=Bl((e=this.pageElements)===null||e===void 0?void 0:e.web_archives);return this.totalResults=t.length,this.returnedCount=this.totalResults,t}handleFederatedPageElements(){var e,t,i,o;const r=["service___fts","service___tvs","service___rcs","service___whisper"];for(const s of r){const l=this.removeServicePrefix(s);this.federatedResults?this.federatedResults[s]=[]:this.federatedResults={[l]:[]};const d=(t=(e=this.pageElements)===null||e===void 0?void 0:e[s])===null||t===void 0?void 0:t.hits;d!=null&&d.hits&&(this.federatedResults[l]=this.formatHits(d==null?void 0:d.hits)),this.totalResults+=(i=d==null?void 0:d.total)!==null&&i!==void 0?i:0,this.returnedCount+=(o=d==null?void 0:d.returned)!==null&&o!==void 0?o:0}}removeServicePrefix(e){return e.split("___")[1]}static createResult(e,t){switch(e){case"item":return new O(t);case"text":case"asr_text":return new Y(t);case"favorited_search":return new Di(t);case"web_archive":return new $o(t);case"tv_clip":return new X(t);default:return new O(t)}}}class Ol{constructor(e){this.clientParameters=e.client_parameters,this.backendRequests=e.backend_requests,this.kind=e.kind}}class Il{constructor(e){var t,i,o;this.rawResponse=e,this.request=new Ol(e.request),this.responseHeader=(t=e.response)===null||t===void 0?void 0:t.header,this.sessionContext=e.session_context,this.response=new cr((i=e.response)===null||i===void 0?void 0:i.body,(o=e.response)===null||o===void 0?void 0:o.hit_schema)}}class xo{static aggregateSearchParamsAsString(e){if(e.omit)return"false";if(e.advancedParams){const t=e.advancedParams.map(o=>({terms:o}));return JSON.stringify(t)}if(e.simpleParams)return e.simpleParams.join(",")}static sortParamsAsString(e){return`${e.field}:${e.direction}`}static filterParamsAsString(e){return JSON.stringify(e)}static generateURLSearchParams(e){const t=new URLSearchParams;if(t.append("user_query",e.query),e.pageType&&t.append("page_type",String(e.pageType)),e.pageTarget&&t.append("page_target",String(e.pageTarget)),e.pageElements&&e.pageElements.length>0){const r=`[${e.pageElements.map(s=>`"${s}"`).join(",")}]`;t.append("page_elements",r)}if(e.rows!=null&&t.append("hits_per_page",String(e.rows)),e.page!=null&&t.append("page",String(e.page)),e.fields&&e.fields.length>0&&t.append("fields",e.fields.join(",")),e.filters&&Object.keys(e.filters).length>0){const o=this.filterParamsAsString(e.filters);o&&o!=="{}"&&t.append("filter_map",o)}if(e.sort&&e.sort.length>0){const o=e.sort.map(r=>this.sortParamsAsString(r));t.append("sort",o.join(","))}const i=e.aggregations;if(i){const o=this.aggregateSearchParamsAsString(i);o&&t.append("aggregations",o)}if(e.aggregationsSize!=null&&t.append("aggregations_size",String(e.aggregationsSize)),e.debugging&&t.append("debugging","true"),e.uid&&t.append("uid",e.uid),e.includeClientUrl!==!1){const o=window.location.href.slice(0,400);e.query.length<=1e3&&t.append("client_url",o)}return t}}var yi;(function(a){a.networkError="SearchService.NetworkError",a.itemNotFound="SearchService.ItemNotFound",a.decodingError="SearchService.DecodingError",a.searchEngineError="SearchService.SearchEngineError"})(yi||(yi={}));class Ul extends Error{constructor(e,t,i){super(t),this.name=e,this.type=e,this.details=i}}const Gr={reCache:JSON.stringify({recompute:!0}),noCache:JSON.stringify({bypass:!0}),dontCache:JSON.stringify({no_compute:!0})};class So{constructor(e){var t,i;this.baseUrl=(t=e==null?void 0:e.baseUrl)!==null&&t!==void 0?t:"archive.org",(e==null?void 0:e.includeCredentials)!==void 0?this.includeCredentials=e.includeCredentials:this.includeCredentials=window.location.href.match(/^https?:\/\/.*archive\.org(:[0-9]+)?/)!==null;const o=new URL(window.location.href).searchParams,r=o.get("scope"),s=o.get("verbose"),l=o.get("debugging"),d=o.get("cacheDebug");let c="";for(const u of Object.keys(Gr))if(o.get(u)){c=Gr[u];break}c=(i=o.get("caching"))!==null&&i!==void 0?i:c,(e==null?void 0:e.caching)!==void 0?this.cachingFlags=e.caching:c&&(this.cachingFlags=c),(e==null?void 0:e.debuggingEnabled)!==void 0?this.debuggingEnabled=e.debuggingEnabled:(l||d)&&(this.debuggingEnabled=!0),(e==null?void 0:e.scope)!==void 0?this.requestScope=e.scope:r&&(this.requestScope=r),(e==null?void 0:e.verbose)!==void 0?this.verbose=e.verbose:s&&(this.verbose=!!s)}async fetchUrl(e,t){var i,o;const r=new URL(e);this.requestScope&&r.searchParams.set("scope",this.requestScope),this.cachingFlags&&r.searchParams.set("caching",this.cachingFlags);let s;try{const l=(i=t==null?void 0:t.requestOptions)!==null&&i!==void 0?i:{credentials:this.includeCredentials?"include":"same-origin"};s=await fetch(r.href,l)}catch(l){const d=l instanceof Error?l.message:typeof l=="string"?l:"Unknown error";return this.getErrorResult(yi.networkError,d)}try{const l=await s.json();this.verbose&&this.printResponse(l),l.debugging&&this.printDebuggingInfo(l);const d=(o=l.response)===null||o===void 0?void 0:o.error;return d?this.getErrorResult(yi.searchEngineError,d.message,d.forensics):{success:l}}catch(l){const d=l instanceof Error?l.message:typeof l=="string"?l:"Unknown error";return this.getErrorResult(yi.decodingError,d)}}getErrorResult(e,t,i){return{error:new Ul(e,t,i)}}printResponse(e){var t,i,o,r,s;try{const l=JSON.parse(JSON.stringify(e)),d=(o=(i=(t=l==null?void 0:l.response)===null||t===void 0?void 0:t.body)===null||i===void 0?void 0:i.hits)===null||o===void 0?void 0:o.hits;if(Array.isArray(d)&&d.length>1){const u=[];u.push(d[0]),u.push(`*** ${d.length-1} hits omitted ***`),l.response.body.hits.hits=u}const c=(s=(r=l==null?void 0:l.response)===null||r===void 0?void 0:r.body)===null||s===void 0?void 0:s.aggregations;c&&Object.entries(c).forEach(([u,v])=>{var m,w,$,x;if(((w=(m=v)===null||m===void 0?void 0:m.buckets)===null||w===void 0?void 0:w.length)>0){const P=JSON.parse(JSON.stringify(v));P.buckets=`*** ${(x=($=P.buckets)===null||$===void 0?void 0:$.length)!==null&&x!==void 0?x:0} buckets omitted ***`,l.response.body.aggregations[u]=P}}),console.log("***** RESPONSE RECEIVED *****"),console.groupCollapsed("Response"),console.log(JSON.stringify(l,null,2)),console.groupEnd()}catch(l){console.error("Error printing search response:",l)}}printDebuggingInfo(e){var t,i;const o=e.debugging,r=(t=o.messages)!==null&&t!==void 0?t:[],s=(i=o.data)!==null&&i!==void 0?i:{};console.log("***** BEGIN DEBUGGING *****"),console.log("Full response:"),console.log(JSON.stringify(e,null,2)),console.group("Debug messages");for(const l of r)console.log(l);console.groupEnd(),console.group("Debug data");for(const[l,d]of Object.entries(s))console.log(l,d);console.groupEnd(),console.log("***** END DEBUGGING *****")}}class Nl extends So{constructor(e){var t;super(e),this.servicePath=(t=e==null?void 0:e.servicePath)!==null&&t!==void 0?t:"/services/search/beta/page_production"}async performSearch(e){this.debuggingEnabled&&e.debugging===void 0&&(e.debugging=!0);const i=xo.generateURLSearchParams(e).toString(),o=`https://${this.baseUrl}${this.servicePath}/?${i}`;return this.fetchUrl(o)}}class Hl extends So{constructor(e){var t;super(e),this.servicePath=(t=e==null?void 0:e.servicePath)!==null&&t!==void 0?t:"/services/search/beta/page_production"}async performSearch(e){this.debuggingEnabled&&e.debugging===void 0&&(e.debugging=!0);const i=xo.generateURLSearchParams(e).toString(),o=`https://${this.baseUrl}${this.servicePath}/?service_backend=fts&${i}`;return this.fetchUrl(o)}}class Vl extends So{constructor(e){var t;super(e),this.servicePath=(t=e==null?void 0:e.servicePath)!==null&&t!==void 0?t:"/services/search/beta/page_production"}async performSearch(e){this.debuggingEnabled&&e.debugging===void 0&&(e.debugging=!0);const i=xo.generateURLSearchParams(e).toString(),o=`https://${this.baseUrl}${this.servicePath}/?service_backend=rcs&${i}`;return this.fetchUrl(o)}}var de;(function(a){a[a.METADATA=0]="METADATA",a[a.FULLTEXT=1]="FULLTEXT",a[a.RADIO=3]="RADIO",a[a.FEDERATED=4]="FEDERATED"})(de||(de={}));class jl extends So{constructor(e){var t;super(e),this.servicePath=(t=e==null?void 0:e.servicePath)!==null&&t!==void 0?t:"/services/search/beta/page_production"}async performSearch(e){this.debuggingEnabled&&e.debugging===void 0&&(e.debugging=!0);const i=xo.generateURLSearchParams(e).toString(),o=`https://${this.baseUrl}${this.servicePath}/?page_type=simple_federation&${i}`;return this.fetchUrl(o)}}class Fe{constructor(e={}){this.backendOptions=e}async search(e,t=de.METADATA){const o=await Fe.getBackendForSearchType(t,this.backendOptions).performSearch(e);return o.error?o:{success:new Il(o.success)}}static getBackendForSearchType(e,t={}){switch(e){case de.FULLTEXT:return new Hl(t);case de.RADIO:return new Vl(t);case de.FEDERATED:return new jl(t);case de.METADATA:default:return new Nl(t)}}}Fe.default=new Fe;n([g((a,e={})=>{const{includeCredentials:t=!1,verbose:i=!1,scope:o="",baseUrl:r=""}=e;return`${a};${t};${i};${o};${r}`})],Fe,"getBackendForSearchType",null);var et;(function(a){a.INCLUDE="inc",a.EXCLUDE="exc",a.GREATER_THAN="gt",a.GREATER_OR_EQUAL="gte",a.LESS_THAN="lt",a.LESS_OR_EQUAL="lte"})(et||(et={}));class Wl{constructor(){this.filterMap={}}addFilter(e,t,i){if(this.filterMap[e]||(this.filterMap[e]={}),this.filterMap[e][t]){const o=[].concat(this.filterMap[e][t],i);this.filterMap[e][t]=Array.from(new Set(o))}else this.filterMap[e][t]=i;return this}removeSingleFilter(e,t,i){var o;if(!(!((o=this.filterMap[e])===null||o===void 0)&&o[t]))return this;const r=[].concat(this.filterMap[e][t]),s=r.indexOf(i);return s>=0&&r.splice(s,1),this.filterMap[e][t]=r.length===1?r[0]:r,r.length===0&&delete this.filterMap[e][t],this.deleteFieldIfEmpty(e),this}removeFilters(e,t){return this.filterMap[e]?(delete this.filterMap[e][t],this.deleteFieldIfEmpty(e),this):this}deleteFieldIfEmpty(e){const t=this.filterMap[e];t&&Object.keys(t).length===0&&delete this.filterMap[e]}setFilterMap(e){return this.filterMap=j({},e),this}mergeFilterMap(e){for(const[t,i]of Object.entries(e))for(const[o,r]of Object.entries(i))if(Array.isArray(r))for(const s of r)this.addFilter(t,o,s);else this.addFilter(t,o,r);return this}build(){return this.filterMap}}/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const hr=window.ShadowRoot&&(window.ShadyCSS===void 0||window.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,pr=Symbol(),Yr=new Map;class yn{constructor(e,t){if(this._$cssResult$=!0,t!==pr)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e}get styleSheet(){let e=Yr.get(this.cssText);return hr&&e===void 0&&(Yr.set(this.cssText,e=new CSSStyleSheet),e.replaceSync(this.cssText)),e}toString(){return this.cssText}}const Ql=a=>new yn(typeof a=="string"?a:a+"",pr),b=(a,...e)=>{const t=a.length===1?a[0]:e.reduce((i,o,r)=>i+(s=>{if(s._$cssResult$===!0)return s.cssText;if(typeof s=="number")return s;throw Error("Value passed to 'css' function must be a 'css' function result: "+s+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(o)+a[r+1],a[0]);return new yn(t,pr)},Kl=(a,e)=>{hr?a.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet):e.forEach(t=>{const i=document.createElement("style"),o=window.litNonce;o!==void 0&&i.setAttribute("nonce",o),i.textContent=t.cssText,a.appendChild(i)})},Xr=hr?a=>a:a=>a instanceof CSSStyleSheet?(e=>{let t="";for(const i of e.cssRules)t+=i.cssText;return Ql(t)})(a):a;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Qo;const Zr=window.trustedTypes,ql=Zr?Zr.emptyScript:"",Jr=window.reactiveElementPolyfillSupport,La={toAttribute(a,e){switch(e){case Boolean:a=a?ql:null;break;case Object:case Array:a=a==null?a:JSON.stringify(a)}return a},fromAttribute(a,e){let t=a;switch(e){case Boolean:t=a!==null;break;case Number:t=a===null?null:Number(a);break;case Object:case Array:try{t=JSON.parse(a)}catch{t=null}}return t}},bn=(a,e)=>e!==a&&(e==e||a==a),Ko={attribute:!0,type:String,converter:La,reflect:!1,hasChanged:bn};class Lt extends HTMLElement{constructor(){super(),this._$Et=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Ei=null,this.o()}static addInitializer(e){var t;(t=this.l)!==null&&t!==void 0||(this.l=[]),this.l.push(e)}static get observedAttributes(){this.finalize();const e=[];return this.elementProperties.forEach((t,i)=>{const o=this._$Eh(i,t);o!==void 0&&(this._$Eu.set(o,i),e.push(o))}),e}static createProperty(e,t=Ko){if(t.state&&(t.attribute=!1),this.finalize(),this.elementProperties.set(e,t),!t.noAccessor&&!this.prototype.hasOwnProperty(e)){const i=typeof e=="symbol"?Symbol():"__"+e,o=this.getPropertyDescriptor(e,i,t);o!==void 0&&Object.defineProperty(this.prototype,e,o)}}static getPropertyDescriptor(e,t,i){return{get(){return this[t]},set(o){const r=this[e];this[t]=o,this.requestUpdate(e,r,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)||Ko}static finalize(){if(this.hasOwnProperty("finalized"))return!1;this.finalized=!0;const e=Object.getPrototypeOf(this);if(e.finalize(),this.elementProperties=new Map(e.elementProperties),this._$Eu=new Map,this.hasOwnProperty("properties")){const t=this.properties,i=[...Object.getOwnPropertyNames(t),...Object.getOwnPropertySymbols(t)];for(const o of i)this.createProperty(o,t[o])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const i=new Set(e.flat(1/0).reverse());for(const o of i)t.unshift(Xr(o))}else e!==void 0&&t.push(Xr(e));return t}static _$Eh(e,t){const i=t.attribute;return i===!1?void 0:typeof i=="string"?i:typeof e=="string"?e.toLowerCase():void 0}o(){var e;this._$Ep=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$Em(),this.requestUpdate(),(e=this.constructor.l)===null||e===void 0||e.forEach(t=>t(this))}addController(e){var t,i;((t=this._$Eg)!==null&&t!==void 0?t:this._$Eg=[]).push(e),this.renderRoot!==void 0&&this.isConnected&&((i=e.hostConnected)===null||i===void 0||i.call(e))}removeController(e){var t;(t=this._$Eg)===null||t===void 0||t.splice(this._$Eg.indexOf(e)>>>0,1)}_$Em(){this.constructor.elementProperties.forEach((e,t)=>{this.hasOwnProperty(t)&&(this._$Et.set(t,this[t]),delete this[t])})}createRenderRoot(){var e;const t=(e=this.shadowRoot)!==null&&e!==void 0?e:this.attachShadow(this.constructor.shadowRootOptions);return Kl(t,this.constructor.elementStyles),t}connectedCallback(){var e;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$Eg)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostConnected)===null||i===void 0?void 0:i.call(t)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$Eg)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostDisconnected)===null||i===void 0?void 0:i.call(t)})}attributeChangedCallback(e,t,i){this._$AK(e,i)}_$ES(e,t,i=Ko){var o,r;const s=this.constructor._$Eh(e,i);if(s!==void 0&&i.reflect===!0){const l=((r=(o=i.converter)===null||o===void 0?void 0:o.toAttribute)!==null&&r!==void 0?r:La.toAttribute)(t,i.type);this._$Ei=e,l==null?this.removeAttribute(s):this.setAttribute(s,l),this._$Ei=null}}_$AK(e,t){var i,o,r;const s=this.constructor,l=s._$Eu.get(e);if(l!==void 0&&this._$Ei!==l){const d=s.getPropertyOptions(l),c=d.converter,u=(r=(o=(i=c)===null||i===void 0?void 0:i.fromAttribute)!==null&&o!==void 0?o:typeof c=="function"?c:null)!==null&&r!==void 0?r:La.fromAttribute;this._$Ei=l,this[l]=u(t,d.type),this._$Ei=null}}requestUpdate(e,t,i){let o=!0;e!==void 0&&(((i=i||this.constructor.getPropertyOptions(e)).hasChanged||bn)(this[e],t)?(this._$AL.has(e)||this._$AL.set(e,t),i.reflect===!0&&this._$Ei!==e&&(this._$EC===void 0&&(this._$EC=new Map),this._$EC.set(e,i))):o=!1),!this.isUpdatePending&&o&&(this._$Ep=this._$E_())}async _$E_(){this.isUpdatePending=!0;try{await this._$Ep}catch(t){Promise.reject(t)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var e;if(!this.isUpdatePending)return;this.hasUpdated,this._$Et&&(this._$Et.forEach((o,r)=>this[r]=o),this._$Et=void 0);let t=!1;const i=this._$AL;try{t=this.shouldUpdate(i),t?(this.willUpdate(i),(e=this._$Eg)===null||e===void 0||e.forEach(o=>{var r;return(r=o.hostUpdate)===null||r===void 0?void 0:r.call(o)}),this.update(i)):this._$EU()}catch(o){throw t=!1,this._$EU(),o}t&&this._$AE(i)}willUpdate(e){}_$AE(e){var t;(t=this._$Eg)===null||t===void 0||t.forEach(i=>{var o;return(o=i.hostUpdated)===null||o===void 0?void 0:o.call(i)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EU(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$Ep}shouldUpdate(e){return!0}update(e){this._$EC!==void 0&&(this._$EC.forEach((t,i)=>this._$ES(i,this[i],t)),this._$EC=void 0),this._$EU()}updated(e){}firstUpdated(e){}}Lt.finalized=!0,Lt.elementProperties=new Map,Lt.elementStyles=[],Lt.shadowRootOptions={mode:"open"},Jr==null||Jr({ReactiveElement:Lt}),((Qo=globalThis.reactiveElementVersions)!==null&&Qo!==void 0?Qo:globalThis.reactiveElementVersions=[]).push("1.3.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var qo;const Ut=globalThis.trustedTypes,es=Ut?Ut.createPolicy("lit-html",{createHTML:a=>a}):void 0,Qe=`lit$${(Math.random()+"").slice(9)}$`,ur="?"+Qe,Gl=`<${ur}>`,Nt=document,_i=(a="")=>Nt.createComment(a),$i=a=>a===null||typeof a!="object"&&typeof a!="function",wn=Array.isArray,_n=a=>{var e;return wn(a)||typeof((e=a)===null||e===void 0?void 0:e[Symbol.iterator])=="function"},hi=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,ts=/-->/g,is=/>/g,ht=/>|[ 	\n\r](?:([^\s"'>=/]+)([ 	\n\r]*=[ 	\n\r]*(?:[^ 	\n\r"'`<>=]|("|')|))|$)/g,os=/'/g,as=/"/g,$n=/^(?:script|style|textarea|title)$/i,xn=a=>(e,...t)=>({_$litType$:a,strings:e,values:t}),h=xn(1),I=xn(2),Te=Symbol.for("lit-noChange"),y=Symbol.for("lit-nothing"),rs=new WeakMap,Gi=(a,e,t)=>{var i,o;const r=(i=t==null?void 0:t.renderBefore)!==null&&i!==void 0?i:e;let s=r._$litPart$;if(s===void 0){const l=(o=t==null?void 0:t.renderBefore)!==null&&o!==void 0?o:null;r._$litPart$=s=new ti(e.insertBefore(_i(),l),l,void 0,t!=null?t:{})}return s._$AI(a),s},Ft=Nt.createTreeWalker(Nt,129,null,!1),Sn=(a,e)=>{const t=a.length-1,i=[];let o,r=e===2?"<svg>":"",s=hi;for(let d=0;d<t;d++){const c=a[d];let u,v,m=-1,w=0;for(;w<c.length&&(s.lastIndex=w,v=s.exec(c),v!==null);)w=s.lastIndex,s===hi?v[1]==="!--"?s=ts:v[1]!==void 0?s=is:v[2]!==void 0?($n.test(v[2])&&(o=RegExp("</"+v[2],"g")),s=ht):v[3]!==void 0&&(s=ht):s===ht?v[0]===">"?(s=o!=null?o:hi,m=-1):v[1]===void 0?m=-2:(m=s.lastIndex-v[2].length,u=v[1],s=v[3]===void 0?ht:v[3]==='"'?as:os):s===as||s===os?s=ht:s===ts||s===is?s=hi:(s=ht,o=void 0);const $=s===ht&&a[d+1].startsWith("/>")?" ":"";r+=s===hi?c+Gl:m>=0?(i.push(u),c.slice(0,m)+"$lit$"+c.slice(m)+Qe+$):c+Qe+(m===-2?(i.push(void 0),d):$)}const l=r+(a[t]||"<?>")+(e===2?"</svg>":"");if(!Array.isArray(a)||!a.hasOwnProperty("raw"))throw Error("invalid template strings array");return[es!==void 0?es.createHTML(l):l,i]};class xi{constructor({strings:e,_$litType$:t},i){let o;this.parts=[];let r=0,s=0;const l=e.length-1,d=this.parts,[c,u]=Sn(e,t);if(this.el=xi.createElement(c,i),Ft.currentNode=this.el.content,t===2){const v=this.el.content,m=v.firstChild;m.remove(),v.append(...m.childNodes)}for(;(o=Ft.nextNode())!==null&&d.length<l;){if(o.nodeType===1){if(o.hasAttributes()){const v=[];for(const m of o.getAttributeNames())if(m.endsWith("$lit$")||m.startsWith(Qe)){const w=u[s++];if(v.push(m),w!==void 0){const $=o.getAttribute(w.toLowerCase()+"$lit$").split(Qe),x=/([.?@])?(.*)/.exec(w);d.push({type:1,index:r,name:x[2],strings:$,ctor:x[1]==="."?kn:x[1]==="?"?Tn:x[1]==="@"?En:Ri})}else d.push({type:6,index:r})}for(const m of v)o.removeAttribute(m)}if($n.test(o.tagName)){const v=o.textContent.split(Qe),m=v.length-1;if(m>0){o.textContent=Ut?Ut.emptyScript:"";for(let w=0;w<m;w++)o.append(v[w],_i()),Ft.nextNode(),d.push({type:2,index:++r});o.append(v[m],_i())}}}else if(o.nodeType===8)if(o.data===ur)d.push({type:2,index:r});else{let v=-1;for(;(v=o.data.indexOf(Qe,v+1))!==-1;)d.push({type:7,index:r}),v+=Qe.length-1}r++}}static createElement(e,t){const i=Nt.createElement("template");return i.innerHTML=e,i}}function $t(a,e,t=a,i){var o,r,s,l;if(e===Te)return e;let d=i!==void 0?(o=t._$Cl)===null||o===void 0?void 0:o[i]:t._$Cu;const c=$i(e)?void 0:e._$litDirective$;return(d==null?void 0:d.constructor)!==c&&((r=d==null?void 0:d._$AO)===null||r===void 0||r.call(d,!1),c===void 0?d=void 0:(d=new c(a),d._$AT(a,t,i)),i!==void 0?((s=(l=t)._$Cl)!==null&&s!==void 0?s:l._$Cl=[])[i]=d:t._$Cu=d),d!==void 0&&(e=$t(a,d._$AS(a,e.values),d,i)),e}class Cn{constructor(e,t){this.v=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}p(e){var t;const{el:{content:i},parts:o}=this._$AD,r=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:Nt).importNode(i,!0);Ft.currentNode=r;let s=Ft.nextNode(),l=0,d=0,c=o[0];for(;c!==void 0;){if(l===c.index){let u;c.type===2?u=new ti(s,s.nextSibling,this,e):c.type===1?u=new c.ctor(s,c.name,c.strings,this,e):c.type===6&&(u=new Mn(s,this,e)),this.v.push(u),c=o[++d]}l!==(c==null?void 0:c.index)&&(s=Ft.nextNode(),l++)}return r}m(e){let t=0;for(const i of this.v)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class ti{constructor(e,t,i,o){var r;this.type=2,this._$AH=y,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=o,this._$Cg=(r=o==null?void 0:o.isConnected)===null||r===void 0||r}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cg}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&e.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=$t(this,e,t),$i(e)?e===y||e==null||e===""?(this._$AH!==y&&this._$AR(),this._$AH=y):e!==this._$AH&&e!==Te&&this.$(e):e._$litType$!==void 0?this.T(e):e.nodeType!==void 0?this.k(e):_n(e)?this.S(e):this.$(e)}M(e,t=this._$AB){return this._$AA.parentNode.insertBefore(e,t)}k(e){this._$AH!==e&&(this._$AR(),this._$AH=this.M(e))}$(e){this._$AH!==y&&$i(this._$AH)?this._$AA.nextSibling.data=e:this.k(Nt.createTextNode(e)),this._$AH=e}T(e){var t;const{values:i,_$litType$:o}=e,r=typeof o=="number"?this._$AC(e):(o.el===void 0&&(o.el=xi.createElement(o.h,this.options)),o);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===r)this._$AH.m(i);else{const s=new Cn(r,this),l=s.p(this.options);s.m(i),this.k(l),this._$AH=s}}_$AC(e){let t=rs.get(e.strings);return t===void 0&&rs.set(e.strings,t=new xi(e)),t}S(e){wn(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,o=0;for(const r of e)o===t.length?t.push(i=new ti(this.M(_i()),this.M(_i()),this,this.options)):i=t[o],i._$AI(r),o++;o<t.length&&(this._$AR(i&&i._$AB.nextSibling,o),t.length=o)}_$AR(e=this._$AA.nextSibling,t){var i;for((i=this._$AP)===null||i===void 0||i.call(this,!1,!0,t);e&&e!==this._$AB;){const o=e.nextSibling;e.remove(),e=o}}setConnected(e){var t;this._$AM===void 0&&(this._$Cg=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}}class Ri{constructor(e,t,i,o,r){this.type=1,this._$AH=y,this._$AN=void 0,this.element=e,this.name=t,this._$AM=o,this.options=r,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=y}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,i,o){const r=this.strings;let s=!1;if(r===void 0)e=$t(this,e,t,0),s=!$i(e)||e!==this._$AH&&e!==Te,s&&(this._$AH=e);else{const l=e;let d,c;for(e=r[0],d=0;d<r.length-1;d++)c=$t(this,l[i+d],t,d),c===Te&&(c=this._$AH[d]),s||(s=!$i(c)||c!==this._$AH[d]),c===y?e=y:e!==y&&(e+=(c!=null?c:"")+r[d+1]),this._$AH[d]=c}s&&!o&&this.C(e)}C(e){e===y?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e!=null?e:"")}}class kn extends Ri{constructor(){super(...arguments),this.type=3}C(e){this.element[this.name]=e===y?void 0:e}}const Yl=Ut?Ut.emptyScript:"";class Tn extends Ri{constructor(){super(...arguments),this.type=4}C(e){e&&e!==y?this.element.setAttribute(this.name,Yl):this.element.removeAttribute(this.name)}}class En extends Ri{constructor(e,t,i,o,r){super(e,t,i,o,r),this.type=5}_$AI(e,t=this){var i;if((e=(i=$t(this,e,t,0))!==null&&i!==void 0?i:y)===Te)return;const o=this._$AH,r=e===y&&o!==y||e.capture!==o.capture||e.once!==o.once||e.passive!==o.passive,s=e!==y&&(o===y||r);r&&this.element.removeEventListener(this.name,this,o),s&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,i;typeof this._$AH=="function"?this._$AH.call((i=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&i!==void 0?i:this.element,e):this._$AH.handleEvent(e)}}class Mn{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){$t(this,e)}}const Xl={L:"$lit$",P:Qe,V:ur,I:1,N:Sn,R:Cn,j:_n,D:$t,H:ti,F:Ri,O:Tn,W:En,B:kn,Z:Mn},ss=window.litHtmlPolyfillSupport;ss==null||ss(xi,ti),((qo=globalThis.litHtmlVersions)!==null&&qo!==void 0?qo:globalThis.litHtmlVersions=[]).push("2.2.4");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Go,Yo;class F extends Lt{constructor(){super(...arguments),this.renderOptions={host:this},this._$Dt=void 0}createRenderRoot(){var e,t;const i=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=i.firstChild),i}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Dt=Gi(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Dt)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Dt)===null||e===void 0||e.setConnected(!1)}render(){return Te}}F.finalized=!0,F._$litElement$=!0,(Go=globalThis.litElementHydrateSupport)===null||Go===void 0||Go.call(globalThis,{LitElement:F});const ns=globalThis.litElementPolyfillSupport;ns==null||ns({LitElement:F});((Yo=globalThis.litElementVersions)!==null&&Yo!==void 0?Yo:globalThis.litElementVersions=[]).push("3.2.0");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const D=a=>e=>typeof e=="function"?((t,i)=>(window.customElements.define(t,i),i))(a,e):((t,i)=>{const{kind:o,elements:r}=i;return{kind:o,elements:r,finisher(s){window.customElements.define(t,s)}}})(a,e);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Zl=(a,e)=>e.kind==="method"&&e.descriptor&&!("value"in e.descriptor)?oe(j({},e),{finisher(t){t.createProperty(e.key,a)}}):{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){typeof e.initializer=="function"&&(this[e.key]=e.initializer.call(this))},finisher(t){t.createProperty(e.key,a)}};function p(a){return(e,t)=>t!==void 0?((i,o,r)=>{o.constructor.createProperty(r,i)})(a,e,t):Zl(a,e)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function z(a){return p(oe(j({},a),{state:!0}))}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const An=({finisher:a,descriptor:e})=>(t,i)=>{var o;if(i===void 0){const r=(o=t.originalKey)!==null&&o!==void 0?o:t.key,s=e!=null?{kind:"method",placement:"prototype",key:r,descriptor:e(t.key)}:oe(j({},t),{key:r});return a!=null&&(s.finisher=function(l){a(l,r)}),s}{const r=t.constructor;e!==void 0&&Object.defineProperty(t,i,e(i)),a==null||a(r,i)}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function ee(a,e){return An({descriptor:t=>{const i={get(){var o,r;return(r=(o=this.renderRoot)===null||o===void 0?void 0:o.querySelector(a))!==null&&r!==void 0?r:null},enumerable:!0,configurable:!0};if(e){const o=typeof t=="symbol"?Symbol():"__"+t;i.get=function(){var r,s;return this[o]===void 0&&(this[o]=(s=(r=this.renderRoot)===null||r===void 0?void 0:r.querySelector(a))!==null&&s!==void 0?s:null),this[o]}}return i}})}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Jl(a){return An({descriptor:e=>({get(){var t,i;return(i=(t=this.renderRoot)===null||t===void 0?void 0:t.querySelectorAll(a))!==null&&i!==void 0?i:[]},enumerable:!0,configurable:!0})})}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Xo;((Xo=window.HTMLSlotElement)===null||Xo===void 0?void 0:Xo.prototype.assignedElements)!=null;class ed{constructor(){this.resizeObserver=new ResizeObserver(e=>{window.requestAnimationFrame(()=>{for(const t of e){const i=this.resizeHandlers.get(t.target);i==null||i.forEach(o=>{o.handleResize(t)})}})}),this.resizeHandlers=new Map}shutdown(){this.resizeHandlers.forEach((e,t)=>{this.resizeObserver.unobserve(t)}),this.resizeHandlers.clear()}addObserver(e){var t;const i=(t=this.resizeHandlers.get(e.target))!==null&&t!==void 0?t:new Set;i.add(e.handler),this.resizeHandlers.set(e.target,i),this.resizeObserver.observe(e.target,e.options)}removeObserver(e){const t=this.resizeHandlers.get(e.target);!t||(t.delete(e.handler),t.size===0&&(this.resizeObserver.unobserve(e.target),this.resizeHandlers.delete(e.target)))}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Re={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Fi=a=>(...e)=>({_$litDirective$:a,values:e});class Bi{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ht=Fi(class extends Bi{constructor(a){var e;if(super(a),a.type!==Re.ATTRIBUTE||a.name!=="class"||((e=a.strings)===null||e===void 0?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(a){return" "+Object.keys(a).filter(e=>a[e]).join(" ")+" "}update(a,[e]){var t,i;if(this.et===void 0){this.et=new Set,a.strings!==void 0&&(this.st=new Set(a.strings.join(" ").split(/\s/).filter(r=>r!=="")));for(const r in e)e[r]&&!(!((t=this.st)===null||t===void 0)&&t.has(r))&&this.et.add(r);return this.render(e)}const o=a.element.classList;this.et.forEach(r=>{r in e||(o.remove(r),this.et.delete(r))});for(const r in e){const s=!!e[r];s===this.et.has(r)||((i=this.st)===null||i===void 0?void 0:i.has(r))||(s?(o.add(r),this.et.add(r)):(o.remove(r),this.et.delete(r)))}return Te}});/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const td=(a,...e)=>({strTag:!0,strings:a,values:e}),mt=td,id=a=>typeof a!="string"&&"strTag"in a,od=(a,e,t)=>{let i=a[0];for(let o=1;o<a.length;o++)i+=e[t?t[o-1]:o-1],i+=a[o];return i};/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ad=a=>id(a)?od(a.strings,a.values):a;/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class rd{constructor(){this.settled=!1,this.promise=new Promise((e,t)=>{this._resolve=e,this._reject=t})}resolve(e){this.settled=!0,this._resolve(e)}reject(e){this.settled=!0,this._reject(e)}}/**
 * @license
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{H:nd}=Xl,zn=a=>a.strings===void 0,ls=()=>document.createComment(""),pi=(a,e,t)=>{var i;const o=a._$AA.parentNode,r=e===void 0?a._$AB:e._$AA;if(t===void 0){const s=o.insertBefore(ls(),r),l=o.insertBefore(ls(),r);t=new nd(s,l,a,a.options)}else{const s=t._$AB.nextSibling,l=t._$AM,d=l!==a;if(d){let c;(i=t._$AQ)===null||i===void 0||i.call(t,a),t._$AM=a,t._$AP!==void 0&&(c=a._$AU)!==l._$AU&&t._$AP(c)}if(s!==r||d){let c=t._$AA;for(;c!==s;){const u=c.nextSibling;o.insertBefore(c,r),c=u}}}return t},pt=(a,e,t=a)=>(a._$AI(e,t),a),ld={},Pn=(a,e=ld)=>a._$AH=e,dd=a=>a._$AH,Zo=a=>{var e;(e=a._$AP)===null||e===void 0||e.call(a,!1,!0);let t=a._$AA;const i=a._$AB.nextSibling;for(;t!==i;){const o=t.nextSibling;t.remove(),t=o}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ds=(a,e,t)=>{const i=new Map;for(let o=e;o<=t;o++)i.set(a[o],o);return i},vr=Fi(class extends Bi{constructor(a){if(super(a),a.type!==Re.CHILD)throw Error("repeat() can only be used in text expressions")}dt(a,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);const o=[],r=[];let s=0;for(const l of a)o[s]=i?i(l,s):s,r[s]=t(l,s),s++;return{values:r,keys:o}}render(a,e,t){return this.dt(a,e,t).values}update(a,[e,t,i]){var o;const r=dd(a),{values:s,keys:l}=this.dt(e,t,i);if(!Array.isArray(r))return this.ut=l,s;const d=(o=this.ut)!==null&&o!==void 0?o:this.ut=[],c=[];let u,v,m=0,w=r.length-1,$=0,x=s.length-1;for(;m<=w&&$<=x;)if(r[m]===null)m++;else if(r[w]===null)w--;else if(d[m]===l[$])c[$]=pt(r[m],s[$]),m++,$++;else if(d[w]===l[x])c[x]=pt(r[w],s[x]),w--,x--;else if(d[m]===l[x])c[x]=pt(r[m],s[x]),pi(a,c[x+1],r[m]),m++,x--;else if(d[w]===l[$])c[$]=pt(r[w],s[$]),pi(a,r[m],r[w]),w--,$++;else if(u===void 0&&(u=ds(l,$,x),v=ds(d,m,w)),u.has(d[m]))if(u.has(d[w])){const P=v.get(l[$]),R=P!==void 0?r[P]:null;if(R===null){const L=pi(a,r[m]);pt(L,s[$]),c[$]=L}else c[$]=pt(R,s[$]),pi(a,r[m],R),r[P]=null;$++}else Zo(r[w]),w--;else Zo(r[m]),m++;for(;$<=x;){const P=pi(a,c[x+1]);pt(P,s[$]),c[$++]=P}for(;m<=w;){const P=r[m++];P!==null&&Zo(P)}return this.ut=l,Pn(a,c),Te}});function Wi(a,e,t){return Array.from({length:(e-a)/t+1},(i,o)=>a+o*t)}let qe=class extends F{constructor(){super(...arguments),this.itemCount=0,this.scrollOptimizationsDisabled=!1,this.intersectionObserver=new IntersectionObserver(e=>{e.forEach(t=>{if(t.target===this.sentinel){t.isIntersecting&&this.dispatchEvent(new Event("scrollThresholdReached"));return}const o=t.target.dataset.cellIndex;if(!o)return;const r=parseInt(o,10);t.isIntersecting?this.visibleCellIndices.add(r):this.visibleCellIndices.delete(r)}),this.scrollOptimizationsDisabled||this.processVisibleCells()}),this.renderedCellIndices=new Set,this.visibleCellIndices=new Set,this.placeholderCellIndices=new Set}reload(){Wi(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.removeCell(t)),this.renderedCellIndices.clear(),this.visibleCellIndices.clear(),this.placeholderCellIndices.clear(),this.setupObservations()}refreshCell(e){this.removeCell(e),this.bufferRange.includes(e)&&this.renderCellBuffer([e])}refreshAllVisibleCells(){this.bufferRange.forEach(e=>this.removeCell(e)),this.renderCellBuffer(this.bufferRange)}scrollToCell(e,t){const i=this.cellContainers[e];if(!i)return!1;const o=t?"smooth":"auto";return i.scrollIntoView({behavior:o}),!0}getVisibleCellIndices(){return Array.from(this.visibleCellIndices)}updated(e){(e.has("itemCount")||e.has("scrollOptimizationsDisabled"))&&this.setupObservations()}disconnectedCallback(){this.intersectionObserver.disconnect()}setupObservations(){this.setupIntersectionObserver()}setupIntersectionObserver(){this.intersectionObserver.disconnect(),this.sentinel&&this.intersectionObserver.observe(this.sentinel),this.scrollOptimizationsDisabled?(Wi(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.visibleCellIndices.add(t)),this.processVisibleCells()):this.cellContainers.forEach(e=>this.intersectionObserver.observe(e))}render(){var e;const t=this.itemCount-1,i=Wi(0,t,1),o=(e=this.ariaLandmarkLabel)!==null&&e!==void 0?e:y;return h`
    ...
    `}};n([p({type:Number})],qe.prototype,"itemCount",void 0);n([p({type:Object})],qe.prototype,"cellProvider",void 0);n([p({type:Object})],qe.prototype,"placeholderCellTemplate",void 0);n([p({type:Boolean})],qe.prototype,"scrollOptimizationsDisabled",void 0);n([p({type:String})],qe.prototype,"ariaLandmarkLabel",void 0);n([ee("#sentinel")],qe.prototype,"sentinel",void 0);n([Jl(".cell-container")],qe.prototype,"cellContainers",void 0);qe=n([D("infinite-scroller")],qe);function cd(a){return a==null?void 0:a.replace(/%22%22(?!%22%22)(.+?)%22%22/g,"%22$1%22")}function hd(a){var e,t,i;return((e=a==null?void 0:a.rawMetadata)===null||e===void 0?void 0:e.hit_type)==="favorited_search"?"search":(i=(t=a.mediatype)===null||t===void 0?void 0:t.value)!==null&&i!==void 0?i:"data"}const pd=I`
  <svg
    viewBox="0 0 100 100"
...
`;function Vt(a,e="short",t="en-US"){if(!a)return"";const i={};switch(e){case"year-only":i.year="numeric";break;case"short":i.month="short",i.year="numeric";break;case"long":i.year="numeric",i.month="short",i.day="2-digit";break}return new Intl.DateTimeFormat(t,i).format(a)}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Td=(a,e,t)=>{for(const i of e)if(i[0]===a)return(0,i[1])();return t==null?void 0:t()};var Ed=I`
...
`,De;let Ee=De=class extends F{constructor(){super(...arguments),this.placeholderType=null,this.detailMessage=""}render(){return this.placeholderType?h`${this.placeholderTemplate}`:y}get placeholderTemplate(){return h`
      <div
        class="placeholder ${this.placeholderType} ${this.isMobileView?"mobile":"desktop"}"
      >
        ${Td(this.placeholderType,[["empty-query",()=>this.emptyQueryTemplate],["empty-collection",()=>this.emptyCollectionTemplate],["no-results",()=>this.noResultsTemplate],["query-error",()=>this.queryErrorTemplate],["collection-error",()=>this.collectionErrorTemplate]])}
      </div>
    ...
    `}};Ee.MESSAGE_EMPTY_QUERY=M('To begin searching, enter a search term in the box above and hit "Go".');Ee.MESSAGE_NO_SEARCH_RESULTS=M("Your search did not match any items in the Archive. Try different keywords or a more general search.");Ee.MESSAGE_NO_COLLECTION_RESULTS=M("Your search did not match any items in this collection. Try different keywords or a more general search.");Ee.MESSAGE_NO_VIEWABLE_MEMBERS=M("This collection contains no viewable items.");Ee.MESSAGE_QUERY_ERROR=M(h`The search engine
    encountered an error, which might be related to your search query.
    <a
      href="https://help.archive.org/help/search-building-powerful-complex-queries/"
    >
      Tips for constructing search queries.
    </a> `);Ee.MESSAGE_COLLECTION_ERROR=M(h`The search engine
    encountered an error while loading this collection. If the problem persists,
    please let us know at
    <a href="mailto:info@archive.org">info@archive.org</a>.`);Ee.QUERY_ERROR_DETAILS_MESSAGE=M("Error details:");n([p({type:String})],Ee.prototype,"placeholderType",void 0);n([p({type:Boolean})],Ee.prototype,"isMobileView",void 0);n([p({type:Boolean})],Ee.prototype,"isCollection",void 0);n([p({type:String})],Ee.prototype,"detailMessage",void 0);Ee=De=n([D("empty-placeholder")],Ee);/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const yr=a=>a!=null?a:y,In=I`
...
`;var Oa;(function(a){a[a.bytes=0]="bytes",a[a.kilobytes=1]="kilobytes",a[a.megabytes=2]="megabytes",a[a.gigabytes=3]="gigabytes",a[a.terabytes=4]="terabytes",a[a.petabytes=5]="petabytes",a[a.exabytes=6]="exabytes",a[a.zettabytes=7]="zettabytes",a[a.yottabytes=8]="yottabytes"})(Oa||(Oa={}));function Md(a,e,t=" "){let i=a;if(i===void 0)return y;let o=0;for(;i>1024;)i/=1024,o+=1;const r=10**e;i=Math.round(i*r)/r;let s=Oa[o];return s=i===1?s.slice(0,-1):s,`${i.toLocaleString()+t+s}`}const Ad=b`var(--tileBackgroundColor, #ffffff)`,zd=b`var(--tileCornerRadius, 4px)`,ko=b`
...
`;class ps{constructor(e={}){var t;this.model=e.model,this.baseNavigationUrl=e.baseNavigationUrl,this.collectionPagePath=(t=e.collectionPagePath)!==null&&t!==void 0?t:"/details/",this.sortParam=e.sortParam,this.creatorFilter=e.creatorFilter}get firstCreatorMatchingFilter(){var e,t;let i;if(this.creatorFilter&&((e=this.model)===null||e===void 0?void 0:e.creators.length)){const o=this.creatorFilter;i=this.model.creators.find(r=>r.normalize("NFD").replace(/[^A-Z]+/gi,"").toUpperCase().startsWith(o))}return i!=null?i:(t=this.model)===null||t===void 0?void 0:t.creator}get accountLabel(){var e;return!((e=this.model)===null||e===void 0)&&e.dateAdded?M(mt`Archivist since ${this.model.dateAdded.getFullYear()}`):""}get dateLabel(){var e;switch((e=this.sortParam)===null||e===void 0?void 0:e.field){case"publicdate":return M("Archived");case"reviewdate":return M("Reviewed");case"addeddate":return M("Added");case"date":return M("Published");default:return""}}itemPageUrl(e,t=!1){if(!e||this.baseNavigationUrl==null)return y;const i=t?this.collectionPagePath:"/details/";return`${this.baseNavigationUrl}${i}${e}`}webArchivesCaptureLink(e,t){const o=`https://web.archive.org/web/${t.toISOString().replace(/[TZ:-]/g,"").replace(/\..*/,"")}/${encodeURIComponent(e)}`,r=Vt(t,"long");return h` <a href=${o}> ${r} </a> `}}class ue extends F{constructor(){super(...arguments),this.sortParam=null,this.defaultSortParam=null,this.loggedIn=!1,this.displayValueProvider=new ps}willUpdate(e){var t,i;(e.has("model")||e.has("baseNavigationUrl")||e.has("collectionPagePath")||e.has("sortParam")||e.has("defaultSortParam")||e.has("creatorFilter"))&&(this.displayValueProvider=new ps({model:this.model,baseNavigationUrl:this.baseNavigationUrl,collectionPagePath:this.collectionPagePath,sortParam:(i=(t=this.sortParam)!==null&&t!==void 0?t:this.defaultSortParam)!==null&&i!==void 0?i:void 0,creatorFilter:this.creatorFilter}))}}n([p({type:Object})],ue.prototype,"model",void 0);n([p({type:Number})],ue.prototype,"currentWidth",void 0);n([p({type:Number})],ue.prototype,"currentHeight",void 0);n([p({type:String})],ue.prototype,"baseNavigationUrl",void 0);n([p({type:String})],ue.prototype,"baseImageUrl",void 0);n([p({type:String})],ue.prototype,"collectionPagePath",void 0);n([p({type:Object})],ue.prototype,"sortParam",void 0);n([p({type:Object})],ue.prototype,"defaultSortParam",void 0);n([p({type:String})],ue.prototype,"creatorFilter",void 0);n([p({type:Number})],ue.prototype,"mobileBreakpoint",void 0);n([p({type:Boolean})],ue.prototype,"loggedIn",void 0);let Ia=class extends F{render(){return h`<div class="icon-overlay">${this.iconTemplate}</div>`}get iconTemplate(){var e;return this.type?h`${(e=Ln[this.type])!==null&&e!==void 0?e:y}`:y}static get styles(){return b`
      :host {
        position: absolute;
        top: 50%;
        left: 50%;
    ...
    `}};n([p({type:String})],Ia.prototype,"type",void 0);Ia=n([D("icon-overlay")],Ia);let Ua=class extends F{render(){return h`
      <div class="overlay no-preview">
        <div class="icon-overlay">${this.iconTemplate}</div>
        <p class="text-overlay">${this.textTemplate}</p>
      </div>
    `}get iconTemplate(){var e;return this.type?h`${(e=Ln[this.type])!==null&&e!==void 0?e:y}`:y}get textTemplate(){var e;return this.type?h`${(e=vd[this.type])!==null&&e!==void 0?e:y}`:y}static get styles(){return b`
      :host {
        align-items: center;
        display: flex;
      }
    ...
    `}};n([p({type:String})],Ua.prototype,"type",void 0);Ua=n([D("text-overlay")],Ua);let ot=class extends F{constructor(){super(...arguments),this.isCompactTile=!1,this.isListTile=!1,this.loggedIn=!1,this.viewSize="desktop"}render(){var e;return!((e=this.model)===null||e===void 0)&&e.identifier?h`
      <div class=${Ht(this.baseClass)}>
        <item-image
          .model=${this.model}
    ...
    `}};n([p({type:String})],ot.prototype,"baseImageUrl",void 0);n([p({type:Boolean})],ot.prototype,"isCompactTile",void 0);n([p({type:Boolean})],ot.prototype,"isListTile",void 0);n([p({type:Boolean})],ot.prototype,"loggedIn",void 0);n([p({type:Object})],ot.prototype,"model",void 0);n([p({type:String})],ot.prototype,"viewSize",void 0);ot=n([D("image-block")],ot);let Na=class extends ue{constructor(){super(...arguments),this.showInfoButton=!1}render(){return h`
      <div class="container">
    ...
    >`}get getSizeTemplate(){var e,t;const i=(t=(e=this.model)===null||e===void 0?void 0:e.collectionSize)!==null&&t!==void 0?t:0;return i?h`<span id="item-size">${Md(i,1)}</span>`:""}get infoButtonTemplate(){return this.showInfoButton?h`<button class="info-button" @click=${this.infoButtonPressed}>
        ...
        </button>`:y}infoButtonPressed(e){e.preventDefault();const t=new CustomEvent("infoButtonPressed",{detail:{x:e.clientX,y:e.clientY}});this.dispatchEvent(t)}static get styles(){const e=b`var(--tileBorderColor, #555555)`,t=b`var(--tileBackgroundColor, #666666)`,i=b`#fff`;return[ko,b`
        .container {
          background-color: ${t};
          border: 1px solid ${e};
        }
      ...
      `]}};n([p({type:Boolean})],Na.prototype,"showInfoButton",void 0);Na=n([D("collection-tile")],Na);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*Bt(a,e){if(a!==void 0){let t=0;for(const i of a)yield e(i,t++)}}function Pd(a){return new Date(a.getTime()-a.getTimezoneOffset()*1e3*60)}function br(a){return a?Pd(a).toISOString().endsWith("-01-01T00:00:00.000Z"):!1}const Un=h`
...
`;let jt=class extends F{constructor(){super(...arguments),this.title="",this.body="",this.starRating=0,this.viewSize="desktop"}render(){return!this.title&&!this.body&&!this.starRating?y:h`
    ...
    `}get filledStarTemplate(){return h`<span aria-hidden="true">${Un}</span>`}get unfilledStarTemplate(){return h`
      <span class="unfilled-star" aria-hidden="true">
        ${Ld}
      </span>
    `}static get styles(){return[Ye,b`
        .review-container {
          display: flex;
          flex-direction: row;
          flex-wrap: wrap;
      ...
      `]}};n([p({type:String})],jt.prototype,"title",void 0);n([p({type:String})],jt.prototype,"body",void 0);n([p({type:Number})],jt.prototype,"starRating",void 0);n([p({type:String})],jt.prototype,"viewSize",void 0);jt=n([D("review-block")],jt);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*Xi(a,e){const t=typeof e=="function";if(a!==void 0){let i=-1;for(const o of a)i>-1&&(yield t?e(i):e),i++,yield o}}let ho=class extends F{constructor(){super(...arguments),this.snippets=[],this.viewSize="desktop"}render(){var e;return!((e=this.snippets)===null||e===void 0)&&e.length?h`
      <div class="container">
        <div class="snippet-view ${this.viewSize}">
    ...
    `:h`${y}`}get ellipsisJoinedSnippets(){return h`
      &hellip; ${Xi(this.snippetTemplates,h` &hellip; `)} &hellip;
    `}get snippetTemplates(){var e;return(e=this.snippets)===null||e===void 0?void 0:e.map(t=>{const i=t.matchAll(/{{{(.+?)}}}/gs),o=[];let r=0;for(const s of i)s.index!=null&&(o.push(h`
            ${t.slice(r,s.index)}
            <mark>${s[1]}</mark>
          `),r=s.index+s[0].length);return o.push(h`${t.slice(r)}`),h`<span>${o}</span>`})}static get styles(){return b`
      .container {
        display: flex;
        flex-direction: row;
        flex-wrap: wrap;
    ...
    `}};n([p({type:Array})],ho.prototype,"snippets",void 0);n([p({type:String})],ho.prototype,"viewSize",void 0);ho=n([D("text-snippet-block")],ho);const Dd=b`
  .drop-shadow {
    overflow: hidden;
    height: 100%;
  }
...
`;let Oe=class extends F{constructor(){super(...arguments),this.isListTile=!1,this.isCompactTile=!1,this.loggedIn=!1,this.isWaveform=!1,this.isNotFound=!1}render(){return h`
    ...
    `}get imageSrc(){var e,t;if(this.isNotFound)return this.notFoundSrc;if(((e=this.model)===null||e===void 0?void 0:e.captureDates)&&this.model.identifier)try{const i=new URL(this.model.identifier),o=encodeURIComponent(i.hostname);return this.baseImageUrl?`https://web.archive.org/thumb/${o}?generate=1`:y}catch{return`${this.baseImageUrl}/images/notfound.png`}return this.baseImageUrl&&((t=this.model)===null||t===void 0?void 0:t.identifier)?`${this.baseImageUrl}/services/img/${this.model.identifier}`:y}get notFoundSrc(){return this.baseImageUrl?`${this.baseImageUrl}/images/notfound.png`:y}get hashBasedGradient(){var e;return!((e=this.model)===null||e===void 0)&&e.identifier?`waveform-grad${this.hashStrToInt(this.model.identifier)%6}`:"waveform-grad0"}hashStrToInt(e){return e.split("").reduce((t,i)=>t+i.charCodeAt(0),0)}get itemBaseClass(){var e;return{"drop-shadow":!0,"list-box":this.isListTile,"search-image":((e=this.model)===null||e===void 0?void 0:e.mediatype)==="search",[this.hashBasedGradient]:this.isWaveform}}get itemImageClass(){var e,t,i;const o=((e=this.model)===null||e===void 0?void 0:e.contentWarning)||((t=this.model)===null||t===void 0?void 0:t.loginRequired);return{contain:!this.isCompactTile&&!this.isWaveform,cover:this.isCompactTile,blur:o||!1,waveform:this.isWaveform,"account-image":this.isAccountImage,"collection-image":((i=this.model)===null||i===void 0?void 0:i.mediatype)==="collection"}}get isAccountImage(){var e;return((e=this.model)===null||e===void 0?void 0:e.mediatype)==="account"&&!this.isCompactTile&&!this.isListTile}onLoad(){var e,t;(((e=this.model)===null||e===void 0?void 0:e.mediatype)==="audio"||((t=this.model)===null||t===void 0?void 0:t.mediatype)==="etree")&&this.baseImage.naturalWidth/this.baseImage.naturalHeight===4&&(this.isWaveform=!0)}onError(){this.isNotFound=!0}static get styles(){return[Dd,Rd,b`
      ...
      `]}};n([p({type:Object})],Oe.prototype,"model",void 0);n([p({type:String})],Oe.prototype,"baseImageUrl",void 0);n([p({type:Boolean})],Oe.prototype,"isListTile",void 0);n([p({type:Boolean})],Oe.prototype,"isCompactTile",void 0);n([p({type:Boolean})],Oe.prototype,"loggedIn",void 0);n([z()],Oe.prototype,"isWaveform",void 0);n([z()],Oe.prototype,"isNotFound",void 0);n([ee("img")],Oe.prototype,"baseImage",void 0);Oe=n([D("item-image")],Oe);const Fd=I`
...
`,Hn={account:{color:"#000000",icon:Fd,text:"Account"},audio:{color:"#00adef",icon:Bd,text:"Audio"},collection:{color:"#4666ff",icon:In,text:"Collection"},data:{color:"#333333",icon:Od,text:"Data"},etree:{color:"#00adef",icon:Id,text:"E-tree"},film:{color:"#bf1b2c",icon:us,text:"Film"},image:{color:"#aa99c9",icon:Ud,text:"Image"},movies:{color:"#f1644b",icon:us,text:"Movie"},radio:{color:"#8fdaef",icon:Nd,text:"Radio"},software:{color:"#9ecc4f",icon:Hd,text:"Software"},texts:{color:"#faab3c",icon:Vd,text:"Text"},tv:{color:"#f1644b",icon:jd,text:"TV"},video:{color:"#f1644b",icon:Wd,text:"Video"},web:{color:"#ffcd27",icon:Qd,text:"Web"},search:{color:"#000000",icon:Nn,text:"Search"}};let Si=class extends F{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var e,t;const i=["tvnews","tvarchive","television"],o=["radio","radioprogram"];return this.mediatype==="movies"&&((e=this.collections)===null||e===void 0?void 0:e.some(r=>i.indexOf(r)>=0))?"tv":this.mediatype==="audio"&&((t=this.collections)===null||t===void 0?void 0:t.some(r=>o.indexOf(r)>=0))?"radio":this.mediatype||""}render(){const e=Hn[this.displayMediatype];return e?h`
      <div
        id="icon"
    ...
    `}};n([p({type:String})],Si.prototype,"mediatype",void 0);n([p({type:Array})],Si.prototype,"collections",void 0);n([p({type:Boolean})],Si.prototype,"showText",void 0);Si=n([D("mediatype-icon")],Si);const Kd=I`
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path
...
`;function Yd(a,e){let t=1;return a>=1e9?t=1e9:a>=1e6?t=1e6:a>=1e3&&e==="short"&&(t=1e3),t}function Xd(a=0,e){const t=a/e,i=t<10;let o=0;return i?o=Math.round((t+Number.EPSILON)*10)/10:o=Math.round(t),o}function Zd(a,e,t,i){switch(e){case 1e9:return M(t==="short"?mt`${a}B`:mt`${a} billion`);case 1e6:return M(t==="short"?mt`${a}M`:mt`${a} million`);case 1e3:return M(t==="short"?mt`${a}K`:mt`${a} thousand`);default:return new Intl.NumberFormat(i).format(a)}}function bi(a,e="long",t="short",i="en-US"){const o=a!=null?a:-1;if(o<0)return"";const r=Yd(o,e),s=Xd(o,r);return Zd(s,r,t,i)}let at=class extends F{render(){var e,t,i,o,r;const s=bi(this.favCount,"short","short"),l=bi(this.commentCount,"short","short"),d=this.mediatype==="account"?`${(e=this.itemCount)!==null&&e!==void 0?e:0} uploads`:`${(t=this.viewCount)!==null&&t!==void 0?t:0} ${(i=this.viewLabel)!==null&&i!==void 0?i:"all-time views"}`;return h`
      <div class="item-stats">
        ...
        <ul id="stats-row">
          ...
          <li class="col" title="${d}">
            ${this.mediatype==="account"?qd:Gd}
            <p class="status-text">
              <span class="sr-only">
                ${this.mediatype==="account"?M("Uploads:"):M("Views:")}
              </span>
              ${bi(this.mediatype==="account"?(o=this.itemCount)!==null&&o!==void 0?o:0:(r=this.viewCount)!==null&&r!==void 0?r:0,"short","short")}
            </p>
          </li>
    ...
    `}static get styles(){return[Ye,b`
      ...
      `]}};n([p({type:String})],at.prototype,"mediatype",void 0);n([p({type:Number})],at.prototype,"itemCount",void 0);n([p({type:Number})],at.prototype,"viewCount",void 0);n([p({type:String})],at.prototype,"viewLabel",void 0);n([p({type:Number})],at.prototype,"favCount",void 0);n([p({type:Number})],at.prototype,"commentCount",void 0);at=n([D("tile-stats")],at);let Ha=class extends ue{constructor(){super(...arguments),this.showInfoButton=!1}render(){var e,t,i,o,r,s,l;const d=(e=this.model)===null||e===void 0?void 0:e.title,c=(t=this.sortParam)!==null&&t!==void 0?t:this.defaultSortParam,[u,v]=(c==null?void 0:c.field)==="week"?[(i=this.model)===null||i===void 0?void 0:i.weeklyViewCount,"weekly views"]:[(o=this.model)===null||o===void 0?void 0:o.viewCount,"all-time views"];return h`
      <div class="container">
        ${this.infoButtonTemplate}
        <div class="tile-details">
          <div class="item-info">
    ...
    `}get sortedDateInfoTemplate(){var e,t,i,o,r;let s,l="long";switch((e=this.effectiveSort)===null||e===void 0?void 0:e.field){case"date":{const d=(t=this.model)===null||t===void 0?void 0:t.datePublished;s={field:"published",value:d},br(d)&&(l="year-only");break}case"reviewdate":s={field:"reviewed",value:(i=this.model)===null||i===void 0?void 0:i.dateReviewed};break;case"addeddate":s={field:"added",value:(o=this.model)===null||o===void 0?void 0:o.dateAdded};break;case"publicdate":s={field:"archived",value:(r=this.model)===null||r===void 0?void 0:r.dateArchived};break}return s!=null&&s.value?h`
      <div class="date-sorted-by truncated">
        <span>
          ${s==null?void 0:s.field} ${Vt(s==null?void 0:s.value,l)}
        </span>
      </div>
    ...
    `}get isSortedByDate(){var e;return["date","reviewdate","addeddate","publicdate"].includes((e=this.effectiveSort)===null||e===void 0?void 0:e.field)}get effectiveSort(){var e;return(e=this.sortParam)!==null&&e!==void 0?e:this.defaultSortParam}get hasSnippets(){var e,t;return!!(!((t=(e=this.model)===null||e===void 0?void 0:e.snippets)===null||t===void 0)&&t.length)}infoButtonPressed(e){e.preventDefault();const t=new CustomEvent("infoButtonPressed",{detail:{x:e.clientX,y:e.clientY}});this.dispatchEvent(t)}static get styles(){const e=b`var(--tileBorderColor, #dddddd)`;return[ko,b`
      ...
      `]}};n([p({type:Boolean})],Ha.prototype,"showInfoButton",void 0);Ha=n([D("item-tile")],Ha);let Va=class extends ue{constructor(){super(...arguments),this.showInfoButton=!1}render(){return h`
      <div class="container">
        ${this.infoButtonTemplate}
        <div class="tile-details">
          <div class="item-info">
    ...
    >
          ...
          &#9432;
          <span class="sr-only">${M("More info")}</span>
        </button>`:y}infoButtonPressed(e){e.preventDefault();const t=new CustomEvent("infoButtonPressed",{detail:{x:e.clientX,y:e.clientY}});this.dispatchEvent(t)}static get styles(){const e=b`var(--tileBorderColor, #dddddd)`;return[ko,b`
        .container {
          border: 1px solid ${e};
        }
      `]}};n([p({type:Boolean})],Va.prototype,"showInfoButton",void 0);Va=n([D("account-tile")],Va);let ja=class extends ue{constructor(){super(...arguments),this.showInfoButton=!1}render(){return h`
      <div class="container">
        <div class="tile-details">
          <div class="item-info">
            ${this.getImageBlockTemplate} ${this.getTitleTemplate}
    ...
    `}get getTitleTemplate(){var e;return h`<div id="title">
      <h4 class="truncated">${(e=this.model)===null||e===void 0?void 0:e.title}</h4>
    </div>`}static get styles(){const e=b`var(--tileBorderColor, #555555)`,t=b`var(--tileBackgroundColor, #666666)`,i=b`#fff`;return[ko,b`
        .container {
          background-color: ${t};
          border: 1px solid ${e};
        }
      ...
      `]}};n([p({type:Boolean})],ja.prototype,"showInfoButton",void 0);ja=n([D("search-tile")],ja);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class Wa extends Bi{constructor(e){if(super(e),this.it=y,e.type!==Re.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===y||e==null)return this.ft=void 0,this.it=e;if(e===Te)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this.ft;this.it=e;const t=[e];return t.raw=t,this.ft={_$litType$:this.constructor.resultType,strings:t,values:[]}}}Wa.directiveName="unsafeHTML",Wa.resultType=1;const Jd=Fi(Wa);/*! @license DOMPurify 2.3.8 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/2.3.8/LICENSE */function yt(a){return yt=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},yt(a)}function Qa(a,e){return Qa=Object.setPrototypeOf||function(i,o){return i.__proto__=o,i},Qa(a,e)}function ec(){if(typeof Reflect=="undefined"||!Reflect.construct||Reflect.construct.sham)return!1;if(typeof Proxy=="function")return!0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],function(){})),!0}catch{return!1}}function Zi(a,e,t){return ec()?Zi=Reflect.construct:Zi=function(o,r,s){var l=[null];l.push.apply(l,r);var d=Function.bind.apply(o,l),c=new d;return s&&Qa(c,s.prototype),c},Zi.apply(null,arguments)}function Ae(a){return tc(a)||ic(a)||oc(a)||ac()}function tc(a){if(Array.isArray(a))return Ka(a)}function ic(a){if(typeof Symbol!="undefined"&&a[Symbol.iterator]!=null||a["@@iterator"]!=null)return Array.from(a)}function oc(a,e){if(!!a){if(typeof a=="string")return Ka(a,e);var t=Object.prototype.toString.call(a).slice(8,-1);if(t==="Object"&&a.constructor&&(t=a.constructor.name),t==="Map"||t==="Set")return Array.from(a);if(t==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t))return Ka(a,e)}}function Ka(a,e){(e==null||e>a.length)&&(e=a.length);for(var t=0,i=new Array(e);t<e;t++)i[t]=a[t];return i}function ac(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}var rc=Object.hasOwnProperty,vs=Object.setPrototypeOf,sc=Object.isFrozen,nc=Object.getPrototypeOf,lc=Object.getOwnPropertyDescriptor,_e=Object.freeze,Ie=Object.seal,dc=Object.create,Vn=typeof Reflect!="undefined"&&Reflect,po=Vn.apply,qa=Vn.construct;po||(po=function(e,t,i){return e.apply(t,i)});_e||(_e=function(e){return e});Ie||(Ie=function(e){return e});qa||(qa=function(e,t){return Zi(e,Ae(t))});var cc=ze(Array.prototype.forEach),fs=ze(Array.prototype.pop),ui=ze(Array.prototype.push),Ji=ze(String.prototype.toLowerCase),hc=ze(String.prototype.match),Ze=ze(String.prototype.replace),pc=ze(String.prototype.indexOf),uc=ze(String.prototype.trim),be=ze(RegExp.prototype.test),Jo=vc(TypeError);function ze(a){return function(e){for(var t=arguments.length,i=new Array(t>1?t-1:0),o=1;o<t;o++)i[o-1]=arguments[o];return po(a,e,i)}}function vc(a){return function(){for(var e=arguments.length,t=new Array(e),i=0;i<e;i++)t[i]=arguments[i];return qa(a,t)}}function B(a,e){vs&&vs(a,null);for(var t=e.length;t--;){var i=e[t];if(typeof i=="string"){var o=Ji(i);o!==i&&(sc(e)||(e[t]=o),i=o)}a[i]=!0}return a}function ut(a){var e=dc(null),t;for(t in a)po(rc,a,[t])&&(e[t]=a[t]);return e}function Ki(a,e){for(;a!==null;){var t=lc(a,e);if(t){if(t.get)return ze(t.get);if(typeof t.value=="function")return ze(t.value)}a=nc(a)}function i(o){return console.warn("fallback value for",o),null}return i}var ms=_e(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","section","select","shadow","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),ea=_e(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","filter","font","g","glyph","glyphref","hkern","image","line","lineargradient","marker","mask","metadata","mpath","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),ta=_e(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),fc=_e(["animate","color-profile","cursor","discard","fedropshadow","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),ia=_e(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover"]),mc=_e(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),gs=_e(["#text"]),ys=_e(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","face","for","headers","height","hidden","high","href","hreflang","id","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","pattern","placeholder","playsinline","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","xmlns","slot"]),oa=_e(["accent-height","accumulate","additive","alignment-baseline","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),bs=_e(["accent","accentunder","align","bevelled","close","columnsalign","columnlines","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lspace","lquote","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),qi=_e(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),gc=Ie(/\{\{[\w\W]*|[\w\W]*\}\}/gm),yc=Ie(/<%[\w\W]*|[\w\W]*%>/gm),bc=Ie(/^data-[\-\w.\u00B7-\uFFFF]/),wc=Ie(/^aria-[\-\w]+$/),_c=Ie(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|cid|xmpp):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),$c=Ie(/^(?:\w+script|data):/i),xc=Ie(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),Sc=Ie(/^html$/i),Cc=function(){return typeof window=="undefined"?null:window},kc=function(e,t){if(yt(e)!=="object"||typeof e.createPolicy!="function")return null;var i=null,o="data-tt-policy-suffix";t.currentScript&&t.currentScript.hasAttribute(o)&&(i=t.currentScript.getAttribute(o));var r="dompurify"+(i?"#"+i:"");try{return e.createPolicy(r,{createHTML:function(l){return l}})}catch{return console.warn("TrustedTypes policy "+r+" could not be created."),null}};function jn(){var a=arguments.length>0&&arguments[0]!==void 0?arguments[0]:Cc(),e=function(f){return jn(f)};if(e.version="2.3.8",e.removed=[],!a||!a.document||a.document.nodeType!==9)return e.isSupported=!1,e;var t=a.document,i=a.document,o=a.DocumentFragment,r=a.HTMLTemplateElement,s=a.Node,l=a.Element,d=a.NodeFilter,c=a.NamedNodeMap,u=c===void 0?a.NamedNodeMap||a.MozNamedAttrMap:c,v=a.HTMLFormElement,m=a.DOMParser,w=a.trustedTypes,$=l.prototype,x=Ki($,"cloneNode"),P=Ki($,"nextSibling"),R=Ki($,"childNodes"),L=Ki($,"parentNode");if(typeof r=="function"){var K=i.createElement("template");K.content&&K.content.ownerDocument&&(i=K.content.ownerDocument)}var U=kc(w,t),re=U?U.createHTML(""):"",ce=i,Ce=ce.implementation,Q=ce.createNodeIterator,ke=ce.createDocumentFragment,ii=ce.getElementsByTagName,oi=t.importNode,Ct={};try{Ct=ut(i).documentMode?i.documentMode:{}}catch{}var xe={};e.isSupported=typeof L=="function"&&Ce&&typeof Ce.createHTMLDocument!="undefined"&&Ct!==9;var st=gc,nt=yc,ai=bc,ri=wc,si=$c,kt=xc,lt=_c,ie=null,ni=B({},[].concat(Ae(ms),Ae(ea),Ae(ta),Ae(ia),Ae(gs))),ve=null,Tr=B({},[].concat(Ae(ys),Ae(oa),Ae(bs),Ae(qi))),le=Object.seal(Object.create(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),li=null,Lo=null,Er=!0,Do=!0,Mr=!1,Tt=!1,dt=!1,Ro=!1,Fo=!1,Et=!1,Ui=!1,Ni=!1,Ar=!0,Bo=!0,di=!1,Mt={},At=null,zr=B({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","style","svg","template","thead","title","video","xmp"]),Pr=null,Lr=B({},["audio","video","img","source","image","track"]),Oo=null,Dr=B({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),Io="http://www.w3.org/1998/Math/MathML",Uo="http://www.w3.org/2000/svg",Xe="http://www.w3.org/1999/xhtml",Hi=Xe,No=!1,zt,vl=["application/xhtml+xml","text/html"],fl="text/html",ct,Pt=null,ml=i.createElement("form"),Rr=function(f){return f instanceof RegExp||f instanceof Function},Ho=function(f){Pt&&Pt===f||((!f||yt(f)!=="object")&&(f={}),f=ut(f),ie="ALLOWED_TAGS"in f?B({},f.ALLOWED_TAGS):ni,ve="ALLOWED_ATTR"in f?B({},f.ALLOWED_ATTR):Tr,Oo="ADD_URI_SAFE_ATTR"in f?B(ut(Dr),f.ADD_URI_SAFE_ATTR):Dr,Pr="ADD_DATA_URI_TAGS"in f?B(ut(Lr),f.ADD_DATA_URI_TAGS):Lr,At="FORBID_CONTENTS"in f?B({},f.FORBID_CONTENTS):zr,li="FORBID_TAGS"in f?B({},f.FORBID_TAGS):{},Lo="FORBID_ATTR"in f?B({},f.FORBID_ATTR):{},Mt="USE_PROFILES"in f?f.USE_PROFILES:!1,Er=f.ALLOW_ARIA_ATTR!==!1,Do=f.ALLOW_DATA_ATTR!==!1,Mr=f.ALLOW_UNKNOWN_PROTOCOLS||!1,Tt=f.SAFE_FOR_TEMPLATES||!1,dt=f.WHOLE_DOCUMENT||!1,Et=f.RETURN_DOM||!1,Ui=f.RETURN_DOM_FRAGMENT||!1,Ni=f.RETURN_TRUSTED_TYPE||!1,Fo=f.FORCE_BODY||!1,Ar=f.SANITIZE_DOM!==!1,Bo=f.KEEP_CONTENT!==!1,di=f.IN_PLACE||!1,lt=f.ALLOWED_URI_REGEXP||lt,Hi=f.NAMESPACE||Xe,f.CUSTOM_ELEMENT_HANDLING&&Rr(f.CUSTOM_ELEMENT_HANDLING.tagNameCheck)&&(le.tagNameCheck=f.CUSTOM_ELEMENT_HANDLING.tagNameCheck),f.CUSTOM_ELEMENT_HANDLING&&Rr(f.CUSTOM_ELEMENT_HANDLING.attributeNameCheck)&&(le.attributeNameCheck=f.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),f.CUSTOM_ELEMENT_HANDLING&&typeof f.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements=="boolean"&&(le.allowCustomizedBuiltInElements=f.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements),zt=vl.indexOf(f.PARSER_MEDIA_TYPE)===-1?zt=fl:zt=f.PARSER_MEDIA_TYPE,ct=zt==="application/xhtml+xml"?function(_){return _}:Ji,Tt&&(Do=!1),Ui&&(Et=!0),Mt&&(ie=B({},Ae(gs)),ve=[],Mt.html===!0&&(B(ie,ms),B(ve,ys)),Mt.svg===!0&&(B(ie,ea),B(ve,oa),B(ve,qi)),Mt.svgFilters===!0&&(B(ie,ta),B(ve,oa),B(ve,qi)),Mt.mathMl===!0&&(B(ie,ia),B(ve,bs),B(ve,qi))),f.ADD_TAGS&&(ie===ni&&(ie=ut(ie)),B(ie,f.ADD_TAGS)),f.ADD_ATTR&&(ve===Tr&&(ve=ut(ve)),B(ve,f.ADD_ATTR)),f.ADD_URI_SAFE_ATTR&&B(Oo,f.ADD_URI_SAFE_ATTR),f.FORBID_CONTENTS&&(At===zr&&(At=ut(At)),B(At,f.FORBID_CONTENTS)),Bo&&(ie["#text"]=!0),dt&&B(ie,["html","head","body"]),ie.table&&(B(ie,["tbody"]),delete li.tbody),_e&&_e(f),Pt=f)},Fr=B({},["mi","mo","mn","ms","mtext"]),Br=B({},["foreignobject","desc","title","annotation-xml"]),gl=B({},["title","style","font","a","script"]),Vi=B({},ea);B(Vi,ta),B(Vi,fc);var Vo=B({},ia);B(Vo,mc);var yl=function(f){var _=L(f);(!_||!_.tagName)&&(_={namespaceURI:Xe,tagName:"template"});var k=Ji(f.tagName),V=Ji(_.tagName);return f.namespaceURI===Uo?_.namespaceURI===Xe?k==="svg":_.namespaceURI===Io?k==="svg"&&(V==="annotation-xml"||Fr[V]):Boolean(Vi[k]):f.namespaceURI===Io?_.namespaceURI===Xe?k==="math":_.namespaceURI===Uo?k==="math"&&Br[V]:Boolean(Vo[k]):f.namespaceURI===Xe?_.namespaceURI===Uo&&!Br[V]||_.namespaceURI===Io&&!Fr[V]?!1:!Vo[k]&&(gl[k]||!Vi[k]):!1},Ve=function(f){ui(e.removed,{element:f});try{f.parentNode.removeChild(f)}catch{try{f.outerHTML=re}catch{f.remove()}}},Or=function(f,_){try{ui(e.removed,{attribute:_.getAttributeNode(f),from:_})}catch{ui(e.removed,{attribute:null,from:_})}if(_.removeAttribute(f),f==="is"&&!ve[f])if(Et||Ui)try{Ve(_)}catch{}else try{_.setAttribute(f,"")}catch{}},Ir=function(f){var _,k;if(Fo)f="<remove></remove>"+f;else{var V=hc(f,/^[\r\n\t ]+/);k=V&&V[0]}zt==="application/xhtml+xml"&&(f='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+f+"</body></html>");var Se=U?U.createHTML(f):f;if(Hi===Xe)try{_=new m().parseFromString(Se,zt)}catch{}if(!_||!_.documentElement){_=Ce.createDocument(Hi,"template",null);try{_.documentElement.innerHTML=No?"":Se}catch{}}var ge=_.body||_.documentElement;return f&&k&&ge.insertBefore(i.createTextNode(k),ge.childNodes[0]||null),Hi===Xe?ii.call(_,dt?"html":"body")[0]:dt?_.documentElement:ge},Ur=function(f){return Q.call(f.ownerDocument||f,f,d.SHOW_ELEMENT|d.SHOW_COMMENT|d.SHOW_TEXT,null,!1)},bl=function(f){return f instanceof v&&(typeof f.nodeName!="string"||typeof f.textContent!="string"||typeof f.removeChild!="function"||!(f.attributes instanceof u)||typeof f.removeAttribute!="function"||typeof f.setAttribute!="function"||typeof f.namespaceURI!="string"||typeof f.insertBefore!="function")},ci=function(f){return yt(s)==="object"?f instanceof s:f&&yt(f)==="object"&&typeof f.nodeType=="number"&&typeof f.nodeName=="string"},je=function(f,_,k){!xe[f]||cc(xe[f],function(V){V.call(e,_,k,Pt)})},Nr=function(f){var _;if(je("beforeSanitizeElements",f,null),bl(f)||be(/[\u0080-\uFFFF]/,f.nodeName))return Ve(f),!0;var k=ct(f.nodeName);if(je("uponSanitizeElement",f,{tagName:k,allowedTags:ie}),f.hasChildNodes()&&!ci(f.firstElementChild)&&(!ci(f.content)||!ci(f.content.firstElementChild))&&be(/<[/\w]/g,f.innerHTML)&&be(/<[/\w]/g,f.textContent)||k==="select"&&be(/<template/i,f.innerHTML))return Ve(f),!0;if(!ie[k]||li[k]){if(!li[k]&&Vr(k)&&(le.tagNameCheck instanceof RegExp&&be(le.tagNameCheck,k)||le.tagNameCheck instanceof Function&&le.tagNameCheck(k)))return!1;if(Bo&&!At[k]){var V=L(f)||f.parentNode,Se=R(f)||f.childNodes;if(Se&&V)for(var ge=Se.length,fe=ge-1;fe>=0;--fe)V.insertBefore(x(Se[fe],!0),P(f))}return Ve(f),!0}return f instanceof l&&!yl(f)||(k==="noscript"||k==="noembed")&&be(/<\/no(script|embed)/i,f.innerHTML)?(Ve(f),!0):(Tt&&f.nodeType===3&&(_=f.textContent,_=Ze(_,st," "),_=Ze(_,nt," "),f.textContent!==_&&(ui(e.removed,{element:f.cloneNode()}),f.textContent=_)),je("afterSanitizeElements",f,null),!1)},Hr=function(f,_,k){if(Ar&&(_==="id"||_==="name")&&(k in i||k in ml))return!1;if(!(Do&&!Lo[_]&&be(ai,_))){if(!(Er&&be(ri,_))){if(!ve[_]||Lo[_]){if(!(Vr(f)&&(le.tagNameCheck instanceof RegExp&&be(le.tagNameCheck,f)||le.tagNameCheck instanceof Function&&le.tagNameCheck(f))&&(le.attributeNameCheck instanceof RegExp&&be(le.attributeNameCheck,_)||le.attributeNameCheck instanceof Function&&le.attributeNameCheck(_))||_==="is"&&le.allowCustomizedBuiltInElements&&(le.tagNameCheck instanceof RegExp&&be(le.tagNameCheck,k)||le.tagNameCheck instanceof Function&&le.tagNameCheck(k))))return!1}else if(!Oo[_]){if(!be(lt,Ze(k,kt,""))){if(!((_==="src"||_==="xlink:href"||_==="href")&&f!=="script"&&pc(k,"data:")===0&&Pr[f])){if(!(Mr&&!be(si,Ze(k,kt,"")))){if(k)return!1}}}}}}return!0},Vr=function(f){return f.indexOf("-")>0},jr=function(f){var _,k,V,Se;je("beforeSanitizeAttributes",f,null);var ge=f.attributes;if(!!ge){var fe={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:ve};for(Se=ge.length;Se--;){_=ge[Se];var ji=_,ye=ji.name,Wr=ji.namespaceURI;if(k=ye==="value"?_.value:uc(_.value),V=ct(ye),fe.attrName=V,fe.attrValue=k,fe.keepAttr=!0,fe.forceKeepAttr=void 0,je("uponSanitizeAttribute",f,fe),k=fe.attrValue,!fe.forceKeepAttr&&(Or(ye,f),!!fe.keepAttr)){if(be(/\/>/i,k)){Or(ye,f);continue}Tt&&(k=Ze(k,st," "),k=Ze(k,nt," "));var _l=ct(f.nodeName);if(!!Hr(_l,V,k))try{Wr?f.setAttributeNS(Wr,ye,k):f.setAttribute(ye,k),fs(e.removed)}catch{}}}je("afterSanitizeAttributes",f,null)}},wl=function A(f){var _,k=Ur(f);for(je("beforeSanitizeShadowDOM",f,null);_=k.nextNode();)je("uponSanitizeShadowNode",_,null),!Nr(_)&&(_.content instanceof o&&A(_.content),jr(_));je("afterSanitizeShadowDOM",f,null)};return e.sanitize=function(A,f){var _,k,V,Se,ge;if(No=!A,No&&(A="<!-->"),typeof A!="string"&&!ci(A)){if(typeof A.toString!="function")throw Jo("toString is not a function");if(A=A.toString(),typeof A!="string")throw Jo("dirty is not a string, aborting")}if(!e.isSupported){if(yt(a.toStaticHTML)==="object"||typeof a.toStaticHTML=="function"){if(typeof A=="string")return a.toStaticHTML(A);if(ci(A))return a.toStaticHTML(A.outerHTML)}return A}if(Ro||Ho(f),e.removed=[],typeof A=="string"&&(di=!1),di){if(A.nodeName){var fe=ct(A.nodeName);if(!ie[fe]||li[fe])throw Jo("root node is forbidden and cannot be sanitized in-place")}}else if(A instanceof s)_=Ir("<!---->"),k=_.ownerDocument.importNode(A,!0),k.nodeType===1&&k.nodeName==="BODY"||k.nodeName==="HTML"?_=k:_.appendChild(k);else{if(!Et&&!Tt&&!dt&&A.indexOf("<")===-1)return U&&Ni?U.createHTML(A):A;if(_=Ir(A),!_)return Et?null:Ni?re:""}_&&Fo&&Ve(_.firstChild);for(var ji=Ur(di?A:_);V=ji.nextNode();)V.nodeType===3&&V===Se||Nr(V)||(V.content instanceof o&&wl(V.content),jr(V),Se=V);if(Se=null,di)return A;if(Et){if(Ui)for(ge=ke.call(_.ownerDocument);_.firstChild;)ge.appendChild(_.firstChild);else ge=_;return ve.shadowroot&&(ge=oi.call(t,ge,!0)),ge}var ye=dt?_.outerHTML:_.innerHTML;return dt&&ie["!doctype"]&&_.ownerDocument&&_.ownerDocument.doctype&&_.ownerDocument.doctype.name&&be(Sc,_.ownerDocument.doctype.name)&&(ye="<!DOCTYPE "+_.ownerDocument.doctype.name+`>
`+ye),Tt&&(ye=Ze(ye,st," "),ye=Ze(ye,nt," ")),U&&Ni?U.createHTML(ye):ye},e.setConfig=function(A){Ho(A),Ro=!0},e.clearConfig=function(){Pt=null,Ro=!1},e.isValidAttribute=function(A,f,_){Pt||Ho({});var k=ct(A),V=ct(f);return Hr(k,V,_)},e.addHook=function(A,f){typeof f=="function"&&(xe[A]=xe[A]||[],ui(xe[A],f))},e.removeHook=function(A){if(xe[A])return fs(xe[A])},e.removeHooks=function(A){xe[A]&&(xe[A]=[])},e.removeAllHooks=function(){xe={}},e}var eo=jn();let uo=class extends ue{constructor(){super(...arguments),this.collectionLinks=[]}render(){return h`
    ...
    `:y}get volumeTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.volume,M("Volume"))}get issueTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.issue,M("Issue"))}get creatorTemplate(){var e,t,i;return((e=this.model)===null||e===void 0?void 0:e.mediatype)==="account"?h`
      ...
      <div id="creator" class="metadata">
        ...
        ${Xi(Bt(this.model.creators,o=>this.searchLink("creator",o)),", ")}
      </div>
    `}get datePublishedTemplate(){var e;const t=(e=this.model)===null||e===void 0?void 0:e.datePublished;let i="long";return br(t)&&(i="year-only"),this.metadataTemplate(Vt(t,i),M("Published"))}get dateSortByTemplate(){return this.effectiveSort&&(this.effectiveSort.field==="addeddate"||this.effectiveSort.field==="reviewdate"||this.effectiveSort.field==="publicdate")?this.metadataTemplate(Vt(this.date,"long"),this.displayValueProvider.dateLabel):y}get viewsTemplate(){var e,t,i,o;const r=((e=this.effectiveSort)===null||e===void 0?void 0:e.field)==="week"?(t=this.model)===null||t===void 0?void 0:t.weeklyViewCount:(i=this.model)===null||i===void 0?void 0:i.viewCount;return r==null?y:((o=this.model)===null||o===void 0?void 0:o.mediatype)==="search"?this.metadataTemplate("(Favorited search query)",""):this.metadataTemplate(`${bi(r,this.formatSize)}`,M("Views"))}get ratingTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.averageRating,M("Avg Rating"))}get reviewsTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.commentCount,M("Reviews"))}get topicsTemplate(){var e;return!(!((e=this.model)===null||e===void 0)&&e.subjects)||this.model.subjects.length===0?y:h`
      <div id="topics" class="metadata">
        ${this.labelTemplate(M("Topics"))}
        ${Xi(Bt(this.model.subjects,t=>this.searchLink("subject",t)),", ")}
      </div>
    `}get collectionsTemplate(){return!this.collectionLinks||this.collectionLinks.length===0?y:h`
      <div id="collections" class="metadata">
        ...
        ${Xi(this.collectionLinks,", ")}
      </div>
    `}get descriptionTemplate(){var e,t,i;return this.metadataTemplate(Jd(eo.sanitize((i=(t=(e=this.model)===null||e===void 0?void 0:e.description)===null||t===void 0?void 0:t.replace(/\n/g," "))!==null&&i!==void 0?i:"")),"","description")}get reviewBlockTemplate(){var e;if(!(!((e=this.model)===null||e===void 0)&&e.review))return y;const{title:t,body:i,stars:o}=this.model.review;return h`
      <review-block
        viewsize="list"
        .title=${t}
        .body=${i}
    ...
    >
      ${eo.sanitize(t)}</a
    >`}detailsLink(e,t,i=!1){if(!e)return y;const o=t!=null?t:e,r=this.displayValueProvider.itemPageUrl(e,i);return h`<a href=${r}> ${eo.sanitize(o)} </a>`}get mediatypeURL(){var e;if(this.baseNavigationUrl===void 0||!(!((e=this.model)===null||e===void 0)&&e.mediatype))return y;switch(this.model.mediatype){case"collection":return`${this.baseNavigationUrl}/search?query=mediatype:collection&sort=-downloads`;case"account":return y;default:return this.displayValueProvider.itemPageUrl(this.model.mediatype,!0)}}updated(e){(e.has("model")||e.has("collectionTitles"))&&this.buildCollectionLinks()}async buildCollectionLinks(){var e,t,i;if(!(!((e=this.model)===null||e===void 0)&&e.collections)||this.model.collections.length===0)return;this.collectionLinks=[];const o=[];for(const r of this.model.collections)!Co[r]&&!r.startsWith("fav-")&&o.push(this.detailsLink(r,(i=(t=this.collectionTitles)===null||t===void 0?void 0:t.get(r))!==null&&i!==void 0?i:r,!0));this.collectionLinks=o}get date(){var e,t,i,o,r;switch((e=this.effectiveSort)===null||e===void 0?void 0:e.field){case"date":return(t=this.model)===null||t===void 0?void 0:t.datePublished;case"reviewdate":return(i=this.model)===null||i===void 0?void 0:i.dateReviewed;case"addeddate":return(o=this.model)===null||o===void 0?void 0:o.dateAdded;default:return(r=this.model)===null||r===void 0?void 0:r.dateArchived}}get effectiveSort(){var e;return(e=this.sortParam)!==null&&e!==void 0?e:this.defaultSortParam}get classSize(){return this.mobileBreakpoint&&this.currentWidth&&this.currentWidth<this.mobileBreakpoint?"mobile":"desktop"}get formatSize(){return this.mobileBreakpoint&&this.currentWidth&&this.currentWidth<this.mobileBreakpoint?"short":"long"}static get styles(){return b`
      html {
        font-size: unset;
      }
    ...
    `}};n([p({type:Object})],uo.prototype,"collectionTitles",void 0);n([z()],uo.prototype,"collectionLinks",void 0);uo=n([D("tile-list")],uo);let Ue=class extends F{constructor(){super(...arguments),this.loggedIn=!1}render(){return h`
      <div id="container">
        ${this.headerTemplate}
    ...
    `}get headerTemplate(){var e,t,i,o;if(((e=this.model)===null||e===void 0?void 0:e.collections.length)===0)return y;let r="",s="";for(const l of((t=this.model)===null||t===void 0?void 0:t.collections)||[])if(!Co[l]&&!l.startsWith("fav-")){r=(o=(i=this.collectionTitles)===null||i===void 0?void 0:i.get(l))!==null&&o!==void 0?o:l,s=l;break}return s?h`
    ...
    `}};n([p({type:Object})],Ue.prototype,"model",void 0);n([p({type:String})],Ue.prototype,"baseNavigationUrl",void 0);n([p({type:String})],Ue.prototype,"baseImageUrl",void 0);n([p({type:Boolean})],Ue.prototype,"loggedIn",void 0);n([p({type:Object})],Ue.prototype,"sortParam",void 0);n([p({type:Number})],Ue.prototype,"mobileBreakpoint",void 0);n([p({type:Number})],Ue.prototype,"currentWidth",void 0);n([p({type:Object})],Ue.prototype,"collectionTitles",void 0);Ue=n([D("tile-hover-pane")],Ue);let ws=class extends ue{render(){var e,t,i,o,r,s;return h`
      <div id="list-line" class="${this.classSize}">
        <image-block
          .model=${this.model}
          .baseImageUrl=${this.baseImageUrl}
        ...
        <a href=${this.href} id="title"
          >${eo.sanitize((t=(e=this.model)===null||e===void 0?void 0:e.title)!==null&&t!==void 0?t:"")}</a
        >
        <div id="creator">
          ${((i=this.model)===null||i===void 0?void 0:i.mediatype)==="account"?this.displayValueProvider.accountLabel:this.creator}
        </div>
        <div id="date">${Vt(this.date,this.dateFormatSize)}</div>
        <div id="icon">
          <mediatype-icon
        ...
        <div id="views">${bi((s=this.views)!==null&&s!==void 0?s:0,this.formatSize)}</div>
      </div>
    `}get href(){var e;return!(!((e=this.model)===null||e===void 0)&&e.identifier)||this.baseNavigationUrl==null?y:this.model.href?`${this.baseNavigationUrl}${this.model.href}`:this.displayValueProvider.itemPageUrl(this.model.identifier,this.model.mediatype==="collection")}get creator(){var e;return(e=this.displayValueProvider.firstCreatorMatchingFilter)!==null&&e!==void 0?e:y}get date(){var e,t,i,o,r;switch((e=this.effectiveSort)===null||e===void 0?void 0:e.field){case"publicdate":return(t=this.model)===null||t===void 0?void 0:t.dateArchived;case"reviewdate":return(i=this.model)===null||i===void 0?void 0:i.dateReviewed;case"addeddate":return(o=this.model)===null||o===void 0?void 0:o.dateAdded;default:return(r=this.model)===null||r===void 0?void 0:r.datePublished}}get views(){var e,t,i;return((e=this.effectiveSort)===null||e===void 0?void 0:e.field)==="week"?(t=this.model)===null||t===void 0?void 0:t.weeklyViewCount:(i=this.model)===null||i===void 0?void 0:i.viewCount}get effectiveSort(){var e;return(e=this.sortParam)!==null&&e!==void 0?e:this.defaultSortParam}get classSize(){return this.mobileBreakpoint&&this.currentWidth&&this.currentWidth<this.mobileBreakpoint?"mobile":"desktop"}get dateFormatSize(){var e,t;return(!this.isSortedByDate||((e=this.effectiveSort)===null||e===void 0?void 0:e.field)==="date")&&br((t=this.model)===null||t===void 0?void 0:t.datePublished)?"year-only":this.formatSize}get formatSize(){return this.mobileBreakpoint&&this.currentWidth&&this.currentWidth<this.mobileBreakpoint?"short":"long"}get isSortedByDate(){var e;return["date","reviewdate","addeddate","publicdate"].includes((e=this.effectiveSort)===null||e===void 0?void 0:e.field)}static get styles(){return b`
      html {
        font-size: unset;
      }
    ...
    `}};ws=n([D("tile-list-compact")],ws);let _s=class extends ue{render(){return h`
    ...
    `}firstUpdated(){this.shouldPrepareHoverPane&&(this.hoverPaneController=new Tc(this,{mobileBreakpoint:this.mobileBreakpoint,enableLongPress:!1}))}get headerTemplate(){const{currentWidth:e,sortParam:t,defaultSortParam:i,mobileBreakpoint:o}=this;return h`
    ...
    `}get linkTileTemplate(){var e,t,i;return h`
      <a
        ...
        title=${this.shouldPrepareHoverPane?y:yr((i=this.model)===null||i===void 0?void 0:i.title)}
    ...
    `}get shouldPrepareHoverPane(){var e,t;return this.enableHoverPane&&!!this.tileDisplayMode&&Ga.HOVER_PANE_DISPLAY_MODES[this.tileDisplayMode]&&((e=this.model)===null||e===void 0?void 0:e.mediatype)!=="search"&&!(!((t=this.model)===null||t===void 0)&&t.captureDates)}get isHoverEnabled(){return window.matchMedia("(hover: hover)").matches}getHoverPane(){return this.hoverPane}getHoverPaneProps(){return this}handleResize(e){this.currentWidth=e.contentRect.width,this.currentHeight=e.contentRect.height}disconnectedCallback(){this.stopResizeObservation(this.resizeObserver)}stopResizeObservation(e){e==null||e.removeObserver({handler:this,target:this.container})}startResizeObservation(){var e;this.stopResizeObservation(this.resizeObserver),(e=this.resizeObserver)===null||e===void 0||e.addObserver({handler:this,target:this.container})}updated(e){if(e.has("resizeObserver")){const t=e.get("resizeObserver");this.stopResizeObservation(t),this.startResizeObservation()}}handleLinkClicked(e){this.isManageView&&(e.preventDefault(),this.model&&(this.model.checked=!this.model.checked)),this.dispatchEvent(new CustomEvent("resultSelected",{detail:this.model}))}handleLinkContextMenu(e){this.isManageView&&this.linkTileHref!==y&&(e.preventDefault(),window.open(this.linkTileHref,"_blank"))}tileInfoButtonPressed(e){var t;(t=this.hoverPaneController)===null||t===void 0||t.toggleHoverPane({coords:e.detail,enableTouchBackdrop:!0})}get tile(){const{model:e,collectionPagePath:t,baseNavigationUrl:i,currentWidth:o,currentHeight:r,sortParam:s,creatorFilter:l,mobileBreakpoint:d,defaultSortParam:c}=this;if(!e)return y;switch(this.tileDisplayMode){case"grid":switch(e.mediatype){case"collection":return h`<collection-tile
              .model=${e}
    ...
    `}};Pe.HOVER_PANE_DISPLAY_MODES={grid:!0,"list-compact":!0,"list-detail":!1,"list-header":!1};n([p({type:String})],Pe.prototype,"tileDisplayMode",void 0);n([p({type:Boolean})],Pe.prototype,"isManageView",void 0);n([p({type:Object})],Pe.prototype,"resizeObserver",void 0);n([p({type:Object})],Pe.prototype,"collectionTitles",void 0);n([p({type:Boolean})],Pe.prototype,"enableHoverPane",void 0);n([p({type:String})],Pe.prototype,"manageCheckTitle",void 0);n([ee("#container")],Pe.prototype,"container",void 0);n([ee("tile-hover-pane")],Pe.prototype,"hoverPane",void 0);Pe=Ga=n([D("tile-dispatcher")],Pe);let xs=class extends F{render(){return h` <div id="container"></div> `}static get styles(){return b`
      :host {
        display: block;
        height: 100%;
      }
    ...
    `}};xs=n([D("collection-browser-loading-tile")],xs);/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const to=window,wr=to.ShadowRoot&&(to.ShadyCSS===void 0||to.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Wn=Symbol(),Ss=new WeakMap;class Ec{constructor(e,t,i){if(this._$cssResult$=!0,i!==Wn)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o;const t=this.t;if(wr&&e===void 0){const i=t!==void 0&&t.length===1;i&&(e=Ss.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),i&&Ss.set(t,e))}return e}toString(){return this.cssText}}const Mc=a=>new Ec(typeof a=="string"?a:a+"",void 0,Wn),Ac=(a,e)=>{wr?a.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet):e.forEach(t=>{const i=document.createElement("style"),o=to.litNonce;o!==void 0&&i.setAttribute("nonce",o),i.textContent=t.cssText,a.appendChild(i)})},Cs=wr?a=>a:a=>a instanceof CSSStyleSheet?(e=>{let t="";for(const i of e.cssRules)t+=i.cssText;return Mc(t)})(a):a;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var aa;const vo=window,ks=vo.trustedTypes,zc=ks?ks.emptyScript:"",Ts=vo.reactiveElementPolyfillSupport,Ya={toAttribute(a,e){switch(e){case Boolean:a=a?zc:null;break;case Object:case Array:a=a==null?a:JSON.stringify(a)}return a},fromAttribute(a,e){let t=a;switch(e){case Boolean:t=a!==null;break;case Number:t=a===null?null:Number(a);break;case Object:case Array:try{t=JSON.parse(a)}catch{t=null}}return t}},Qn=(a,e)=>e!==a&&(e==e||a==a),ra={attribute:!0,type:String,converter:Ya,reflect:!1,hasChanged:Qn},Xa="finalized";class vi extends HTMLElement{constructor(){super(),this._$Ei=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$El=null,this._$Eu()}static addInitializer(e){var t;this.finalize(),((t=this.h)!==null&&t!==void 0?t:this.h=[]).push(e)}static get observedAttributes(){this.finalize();const e=[];return this.elementProperties.forEach((t,i)=>{const o=this._$Ep(i,t);o!==void 0&&(this._$Ev.set(o,i),e.push(o))}),e}static createProperty(e,t=ra){if(t.state&&(t.attribute=!1),this.finalize(),this.elementProperties.set(e,t),!t.noAccessor&&!this.prototype.hasOwnProperty(e)){const i=typeof e=="symbol"?Symbol():"__"+e,o=this.getPropertyDescriptor(e,i,t);o!==void 0&&Object.defineProperty(this.prototype,e,o)}}static getPropertyDescriptor(e,t,i){return{get(){return this[t]},set(o){const r=this[e];this[t]=o,this.requestUpdate(e,r,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)||ra}static finalize(){if(this.hasOwnProperty(Xa))return!1;this[Xa]=!0;const e=Object.getPrototypeOf(this);if(e.finalize(),e.h!==void 0&&(this.h=[...e.h]),this.elementProperties=new Map(e.elementProperties),this._$Ev=new Map,this.hasOwnProperty("properties")){const t=this.properties,i=[...Object.getOwnPropertyNames(t),...Object.getOwnPropertySymbols(t)];for(const o of i)this.createProperty(o,t[o])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const i=new Set(e.flat(1/0).reverse());for(const o of i)t.unshift(Cs(o))}else e!==void 0&&t.push(Cs(e));return t}static _$Ep(e,t){const i=t.attribute;return i===!1?void 0:typeof i=="string"?i:typeof e=="string"?e.toLowerCase():void 0}_$Eu(){var e;this._$E_=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$Eg(),this.requestUpdate(),(e=this.constructor.h)===null||e===void 0||e.forEach(t=>t(this))}addController(e){var t,i;((t=this._$ES)!==null&&t!==void 0?t:this._$ES=[]).push(e),this.renderRoot!==void 0&&this.isConnected&&((i=e.hostConnected)===null||i===void 0||i.call(e))}removeController(e){var t;(t=this._$ES)===null||t===void 0||t.splice(this._$ES.indexOf(e)>>>0,1)}_$Eg(){this.constructor.elementProperties.forEach((e,t)=>{this.hasOwnProperty(t)&&(this._$Ei.set(t,this[t]),delete this[t])})}createRenderRoot(){var e;const t=(e=this.shadowRoot)!==null&&e!==void 0?e:this.attachShadow(this.constructor.shadowRootOptions);return Ac(t,this.constructor.elementStyles),t}connectedCallback(){var e;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$ES)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostConnected)===null||i===void 0?void 0:i.call(t)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$ES)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostDisconnected)===null||i===void 0?void 0:i.call(t)})}attributeChangedCallback(e,t,i){this._$AK(e,i)}_$EO(e,t,i=ra){var o;const r=this.constructor._$Ep(e,i);if(r!==void 0&&i.reflect===!0){const s=(((o=i.converter)===null||o===void 0?void 0:o.toAttribute)!==void 0?i.converter:Ya).toAttribute(t,i.type);this._$El=e,s==null?this.removeAttribute(r):this.setAttribute(r,s),this._$El=null}}_$AK(e,t){var i;const o=this.constructor,r=o._$Ev.get(e);if(r!==void 0&&this._$El!==r){const s=o.getPropertyOptions(r),l=typeof s.converter=="function"?{fromAttribute:s.converter}:((i=s.converter)===null||i===void 0?void 0:i.fromAttribute)!==void 0?s.converter:Ya;this._$El=r,this[r]=l.fromAttribute(t,s.type),this._$El=null}}requestUpdate(e,t,i){let o=!0;e!==void 0&&(((i=i||this.constructor.getPropertyOptions(e)).hasChanged||Qn)(this[e],t)?(this._$AL.has(e)||this._$AL.set(e,t),i.reflect===!0&&this._$El!==e&&(this._$EC===void 0&&(this._$EC=new Map),this._$EC.set(e,i))):o=!1),!this.isUpdatePending&&o&&(this._$E_=this._$Ej())}async _$Ej(){this.isUpdatePending=!0;try{await this._$E_}catch(t){Promise.reject(t)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var e;if(!this.isUpdatePending)return;this.hasUpdated,this._$Ei&&(this._$Ei.forEach((o,r)=>this[r]=o),this._$Ei=void 0);let t=!1;const i=this._$AL;try{t=this.shouldUpdate(i),t?(this.willUpdate(i),(e=this._$ES)===null||e===void 0||e.forEach(o=>{var r;return(r=o.hostUpdate)===null||r===void 0?void 0:r.call(o)}),this.update(i)):this._$Ek()}catch(o){throw t=!1,this._$Ek(),o}t&&this._$AE(i)}willUpdate(e){}_$AE(e){var t;(t=this._$ES)===null||t===void 0||t.forEach(i=>{var o;return(o=i.hostUpdated)===null||o===void 0?void 0:o.call(i)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$Ek(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$E_}shouldUpdate(e){return!0}update(e){this._$EC!==void 0&&(this._$EC.forEach((t,i)=>this._$EO(i,this[i],t)),this._$EC=void 0),this._$Ek()}updated(e){}firstUpdated(e){}}vi[Xa]=!0,vi.elementProperties=new Map,vi.elementStyles=[],vi.shadowRootOptions={mode:"open"},Ts==null||Ts({ReactiveElement:vi}),((aa=vo.reactiveElementVersions)!==null&&aa!==void 0?aa:vo.reactiveElementVersions=[]).push("1.6.3");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var sa;const fo=window,Wt=fo.trustedTypes,Es=Wt?Wt.createPolicy("lit-html",{createHTML:a=>a}):void 0,Za="$lit$",tt=`lit$${(Math.random()+"").slice(9)}$`,Kn="?"+tt,Pc=`<${Kn}>`,xt=document,Ci=()=>xt.createComment(""),ki=a=>a===null||typeof a!="object"&&typeof a!="function",qn=Array.isArray,Lc=a=>qn(a)||typeof(a==null?void 0:a[Symbol.iterator])=="function",na=`[ 	
\f\r]`,fi=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Ms=/-->/g,As=/>/g,vt=RegExp(`>|${na}(?:([^\\s"'>=/]+)(${na}*=${na}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),zs=/'/g,Ps=/"/g,Gn=/^(?:script|style|textarea|title)$/i,Yn=a=>(e,...t)=>({_$litType$:a,strings:e,values:t}),Me=Yn(1),Xn=Yn(2),Qt=Symbol.for("lit-noChange"),ae=Symbol.for("lit-nothing"),Ls=new WeakMap,bt=xt.createTreeWalker(xt,129,null,!1);function Zn(a,e){if(!Array.isArray(a)||!a.hasOwnProperty("raw"))throw Error("invalid template strings array");return Es!==void 0?Es.createHTML(e):e}const Dc=(a,e)=>{const t=a.length-1,i=[];let o,r=e===2?"<svg>":"",s=fi;for(let l=0;l<t;l++){const d=a[l];let c,u,v=-1,m=0;for(;m<d.length&&(s.lastIndex=m,u=s.exec(d),u!==null);)m=s.lastIndex,s===fi?u[1]==="!--"?s=Ms:u[1]!==void 0?s=As:u[2]!==void 0?(Gn.test(u[2])&&(o=RegExp("</"+u[2],"g")),s=vt):u[3]!==void 0&&(s=vt):s===vt?u[0]===">"?(s=o!=null?o:fi,v=-1):u[1]===void 0?v=-2:(v=s.lastIndex-u[2].length,c=u[1],s=u[3]===void 0?vt:u[3]==='"'?Ps:zs):s===Ps||s===zs?s=vt:s===Ms||s===As?s=fi:(s=vt,o=void 0);const w=s===vt&&a[l+1].startsWith("/>")?" ":"";r+=s===fi?d+Pc:v>=0?(i.push(c),d.slice(0,v)+Za+d.slice(v)+tt+w):d+tt+(v===-2?(i.push(void 0),l):w)}return[Zn(a,r+(a[t]||"<?>")+(e===2?"</svg>":"")),i]};class Ti{constructor({strings:e,_$litType$:t},i){let o;this.parts=[];let r=0,s=0;const l=e.length-1,d=this.parts,[c,u]=Dc(e,t);if(this.el=Ti.createElement(c,i),bt.currentNode=this.el.content,t===2){const v=this.el.content,m=v.firstChild;m.remove(),v.append(...m.childNodes)}for(;(o=bt.nextNode())!==null&&d.length<l;){if(o.nodeType===1){if(o.hasAttributes()){const v=[];for(const m of o.getAttributeNames())if(m.endsWith(Za)||m.startsWith(tt)){const w=u[s++];if(v.push(m),w!==void 0){const $=o.getAttribute(w.toLowerCase()+Za).split(tt),x=/([.?@])?(.*)/.exec(w);d.push({type:1,index:r,name:x[2],strings:$,ctor:x[1]==="."?Fc:x[1]==="?"?Oc:x[1]==="@"?Ic:To})}else d.push({type:6,index:r})}for(const m of v)o.removeAttribute(m)}if(Gn.test(o.tagName)){const v=o.textContent.split(tt),m=v.length-1;if(m>0){o.textContent=Wt?Wt.emptyScript:"";for(let w=0;w<m;w++)o.append(v[w],Ci()),bt.nextNode(),d.push({type:2,index:++r});o.append(v[m],Ci())}}}else if(o.nodeType===8)if(o.data===Kn)d.push({type:2,index:r});else{let v=-1;for(;(v=o.data.indexOf(tt,v+1))!==-1;)d.push({type:7,index:r}),v+=tt.length-1}r++}}static createElement(e,t){const i=xt.createElement("template");return i.innerHTML=e,i}}function Kt(a,e,t=a,i){var o,r,s,l;if(e===Qt)return e;let d=i!==void 0?(o=t._$Co)===null||o===void 0?void 0:o[i]:t._$Cl;const c=ki(e)?void 0:e._$litDirective$;return(d==null?void 0:d.constructor)!==c&&((r=d==null?void 0:d._$AO)===null||r===void 0||r.call(d,!1),c===void 0?d=void 0:(d=new c(a),d._$AT(a,t,i)),i!==void 0?((s=(l=t)._$Co)!==null&&s!==void 0?s:l._$Co=[])[i]=d:t._$Cl=d),d!==void 0&&(e=Kt(a,d._$AS(a,e.values),d,i)),e}class Rc{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){var t;const{el:{content:i},parts:o}=this._$AD,r=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:xt).importNode(i,!0);bt.currentNode=r;let s=bt.nextNode(),l=0,d=0,c=o[0];for(;c!==void 0;){if(l===c.index){let u;c.type===2?u=new Oi(s,s.nextSibling,this,e):c.type===1?u=new c.ctor(s,c.name,c.strings,this,e):c.type===6&&(u=new Uc(s,this,e)),this._$AV.push(u),c=o[++d]}l!==(c==null?void 0:c.index)&&(s=bt.nextNode(),l++)}return bt.currentNode=xt,r}v(e){let t=0;for(const i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class Oi{constructor(e,t,i,o){var r;this.type=2,this._$AH=ae,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=o,this._$Cp=(r=o==null?void 0:o.isConnected)===null||r===void 0||r}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cp}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Kt(this,e,t),ki(e)?e===ae||e==null||e===""?(this._$AH!==ae&&this._$AR(),this._$AH=ae):e!==this._$AH&&e!==Qt&&this._(e):e._$litType$!==void 0?this.g(e):e.nodeType!==void 0?this.$(e):Lc(e)?this.T(e):this._(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==ae&&ki(this._$AH)?this._$AA.nextSibling.data=e:this.$(xt.createTextNode(e)),this._$AH=e}g(e){var t;const{values:i,_$litType$:o}=e,r=typeof o=="number"?this._$AC(e):(o.el===void 0&&(o.el=Ti.createElement(Zn(o.h,o.h[0]),this.options)),o);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===r)this._$AH.v(i);else{const s=new Rc(r,this),l=s.u(this.options);s.v(i),this.$(l),this._$AH=s}}_$AC(e){let t=Ls.get(e.strings);return t===void 0&&Ls.set(e.strings,t=new Ti(e)),t}T(e){qn(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,o=0;for(const r of e)o===t.length?t.push(i=new Oi(this.k(Ci()),this.k(Ci()),this,this.options)):i=t[o],i._$AI(r),o++;o<t.length&&(this._$AR(i&&i._$AB.nextSibling,o),t.length=o)}_$AR(e=this._$AA.nextSibling,t){var i;for((i=this._$AP)===null||i===void 0||i.call(this,!1,!0,t);e&&e!==this._$AB;){const o=e.nextSibling;e.remove(),e=o}}setConnected(e){var t;this._$AM===void 0&&(this._$Cp=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}}class To{constructor(e,t,i,o,r){this.type=1,this._$AH=ae,this._$AN=void 0,this.element=e,this.name=t,this._$AM=o,this.options=r,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=ae}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,i,o){const r=this.strings;let s=!1;if(r===void 0)e=Kt(this,e,t,0),s=!ki(e)||e!==this._$AH&&e!==Qt,s&&(this._$AH=e);else{const l=e;let d,c;for(e=r[0],d=0;d<r.length-1;d++)c=Kt(this,l[i+d],t,d),c===Qt&&(c=this._$AH[d]),s||(s=!ki(c)||c!==this._$AH[d]),c===ae?e=ae:e!==ae&&(e+=(c!=null?c:"")+r[d+1]),this._$AH[d]=c}s&&!o&&this.j(e)}j(e){e===ae?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e!=null?e:"")}}class Fc extends To{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===ae?void 0:e}}const Bc=Wt?Wt.emptyScript:"";class Oc extends To{constructor(){super(...arguments),this.type=4}j(e){e&&e!==ae?this.element.setAttribute(this.name,Bc):this.element.removeAttribute(this.name)}}class Ic extends To{constructor(e,t,i,o,r){super(e,t,i,o,r),this.type=5}_$AI(e,t=this){var i;if((e=(i=Kt(this,e,t,0))!==null&&i!==void 0?i:ae)===Qt)return;const o=this._$AH,r=e===ae&&o!==ae||e.capture!==o.capture||e.once!==o.once||e.passive!==o.passive,s=e!==ae&&(o===ae||r);r&&this.element.removeEventListener(this.name,this,o),s&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,i;typeof this._$AH=="function"?this._$AH.call((i=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&i!==void 0?i:this.element,e):this._$AH.handleEvent(e)}}class Uc{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){Kt(this,e)}}const Ds=fo.litHtmlPolyfillSupport;Ds==null||Ds(Ti,Oi),((sa=fo.litHtmlVersions)!==null&&sa!==void 0?sa:fo.litHtmlVersions=[]).push("2.8.0");const Nc=(a,e,t)=>{var i,o;const r=(i=t==null?void 0:t.renderBefore)!==null&&i!==void 0?i:e;let s=r._$litPart$;if(s===void 0){const l=(o=t==null?void 0:t.renderBefore)!==null&&o!==void 0?o:null;r._$litPart$=s=new Oi(e.insertBefore(Ci(),l),l,void 0,t!=null?t:{})}return s._$AI(a),s};/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const _r=window.ShadowRoot&&(window.ShadyCSS===void 0||window.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,$r=Symbol(),Rs=new Map;class Jn{constructor(e,t){if(this._$cssResult$=!0,t!==$r)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e}get styleSheet(){let e=Rs.get(this.cssText);return _r&&e===void 0&&(Rs.set(this.cssText,e=new CSSStyleSheet),e.replaceSync(this.cssText)),e}toString(){return this.cssText}}const Hc=a=>new Jn(typeof a=="string"?a:a+"",$r),We=(a,...e)=>{const t=a.length===1?a[0]:e.reduce((i,o,r)=>i+(s=>{if(s._$cssResult$===!0)return s.cssText;if(typeof s=="number")return s;throw Error("Value passed to 'css' function must be a 'css' function result: "+s+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(o)+a[r+1],a[0]);return new Jn(t,$r)},Vc=(a,e)=>{_r?a.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet):e.forEach(t=>{const i=document.createElement("style"),o=window.litNonce;o!==void 0&&i.setAttribute("nonce",o),i.textContent=t.cssText,a.appendChild(i)})},Fs=_r?a=>a:a=>a instanceof CSSStyleSheet?(e=>{let t="";for(const i of e.cssRules)t+=i.cssText;return Hc(t)})(a):a;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var la;const Bs=window.trustedTypes,jc=Bs?Bs.emptyScript:"",Os=window.reactiveElementPolyfillSupport,Ja={toAttribute(a,e){switch(e){case Boolean:a=a?jc:null;break;case Object:case Array:a=a==null?a:JSON.stringify(a)}return a},fromAttribute(a,e){let t=a;switch(e){case Boolean:t=a!==null;break;case Number:t=a===null?null:Number(a);break;case Object:case Array:try{t=JSON.parse(a)}catch{t=null}}return t}},el=(a,e)=>e!==a&&(e==e||a==a),da={attribute:!0,type:String,converter:Ja,reflect:!1,hasChanged:el};class Dt extends HTMLElement{constructor(){super(),this._$Et=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Ei=null,this.o()}static addInitializer(e){var t;(t=this.l)!==null&&t!==void 0||(this.l=[]),this.l.push(e)}static get observedAttributes(){this.finalize();const e=[];return this.elementProperties.forEach((t,i)=>{const o=this._$Eh(i,t);o!==void 0&&(this._$Eu.set(o,i),e.push(o))}),e}static createProperty(e,t=da){if(t.state&&(t.attribute=!1),this.finalize(),this.elementProperties.set(e,t),!t.noAccessor&&!this.prototype.hasOwnProperty(e)){const i=typeof e=="symbol"?Symbol():"__"+e,o=this.getPropertyDescriptor(e,i,t);o!==void 0&&Object.defineProperty(this.prototype,e,o)}}static getPropertyDescriptor(e,t,i){return{get(){return this[t]},set(o){const r=this[e];this[t]=o,this.requestUpdate(e,r,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)||da}static finalize(){if(this.hasOwnProperty("finalized"))return!1;this.finalized=!0;const e=Object.getPrototypeOf(this);if(e.finalize(),this.elementProperties=new Map(e.elementProperties),this._$Eu=new Map,this.hasOwnProperty("properties")){const t=this.properties,i=[...Object.getOwnPropertyNames(t),...Object.getOwnPropertySymbols(t)];for(const o of i)this.createProperty(o,t[o])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const i=new Set(e.flat(1/0).reverse());for(const o of i)t.unshift(Fs(o))}else e!==void 0&&t.push(Fs(e));return t}static _$Eh(e,t){const i=t.attribute;return i===!1?void 0:typeof i=="string"?i:typeof e=="string"?e.toLowerCase():void 0}o(){var e;this._$Ep=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$Em(),this.requestUpdate(),(e=this.constructor.l)===null||e===void 0||e.forEach(t=>t(this))}addController(e){var t,i;((t=this._$Eg)!==null&&t!==void 0?t:this._$Eg=[]).push(e),this.renderRoot!==void 0&&this.isConnected&&((i=e.hostConnected)===null||i===void 0||i.call(e))}removeController(e){var t;(t=this._$Eg)===null||t===void 0||t.splice(this._$Eg.indexOf(e)>>>0,1)}_$Em(){this.constructor.elementProperties.forEach((e,t)=>{this.hasOwnProperty(t)&&(this._$Et.set(t,this[t]),delete this[t])})}createRenderRoot(){var e;const t=(e=this.shadowRoot)!==null&&e!==void 0?e:this.attachShadow(this.constructor.shadowRootOptions);return Vc(t,this.constructor.elementStyles),t}connectedCallback(){var e;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$Eg)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostConnected)===null||i===void 0?void 0:i.call(t)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$Eg)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostDisconnected)===null||i===void 0?void 0:i.call(t)})}attributeChangedCallback(e,t,i){this._$AK(e,i)}_$ES(e,t,i=da){var o,r;const s=this.constructor._$Eh(e,i);if(s!==void 0&&i.reflect===!0){const l=((r=(o=i.converter)===null||o===void 0?void 0:o.toAttribute)!==null&&r!==void 0?r:Ja.toAttribute)(t,i.type);this._$Ei=e,l==null?this.removeAttribute(s):this.setAttribute(s,l),this._$Ei=null}}_$AK(e,t){var i,o,r;const s=this.constructor,l=s._$Eu.get(e);if(l!==void 0&&this._$Ei!==l){const d=s.getPropertyOptions(l),c=d.converter,u=(r=(o=(i=c)===null||i===void 0?void 0:i.fromAttribute)!==null&&o!==void 0?o:typeof c=="function"?c:null)!==null&&r!==void 0?r:Ja.fromAttribute;this._$Ei=l,this[l]=u(t,d.type),this._$Ei=null}}requestUpdate(e,t,i){let o=!0;e!==void 0&&(((i=i||this.constructor.getPropertyOptions(e)).hasChanged||el)(this[e],t)?(this._$AL.has(e)||this._$AL.set(e,t),i.reflect===!0&&this._$Ei!==e&&(this._$EC===void 0&&(this._$EC=new Map),this._$EC.set(e,i))):o=!1),!this.isUpdatePending&&o&&(this._$Ep=this._$E_())}async _$E_(){this.isUpdatePending=!0;try{await this._$Ep}catch(t){Promise.reject(t)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var e;if(!this.isUpdatePending)return;this.hasUpdated,this._$Et&&(this._$Et.forEach((o,r)=>this[r]=o),this._$Et=void 0);let t=!1;const i=this._$AL;try{t=this.shouldUpdate(i),t?(this.willUpdate(i),(e=this._$Eg)===null||e===void 0||e.forEach(o=>{var r;return(r=o.hostUpdate)===null||r===void 0?void 0:r.call(o)}),this.update(i)):this._$EU()}catch(o){throw t=!1,this._$EU(),o}t&&this._$AE(i)}willUpdate(e){}_$AE(e){var t;(t=this._$Eg)===null||t===void 0||t.forEach(i=>{var o;return(o=i.hostUpdated)===null||o===void 0?void 0:o.call(i)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EU(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$Ep}shouldUpdate(e){return!0}update(e){this._$EC!==void 0&&(this._$EC.forEach((t,i)=>this._$ES(i,this[i],t)),this._$EC=void 0),this._$EU()}updated(e){}firstUpdated(e){}}Dt.finalized=!0,Dt.elementProperties=new Map,Dt.elementStyles=[],Dt.shadowRootOptions={mode:"open"},Os==null||Os({ReactiveElement:Dt}),((la=globalThis.reactiveElementVersions)!==null&&la!==void 0?la:globalThis.reactiveElementVersions=[]).push("1.3.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var ca,ha;class Ot extends Dt{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e,t;const i=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=i.firstChild),i}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Nc(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!1)}render(){return Qt}}Ot.finalized=!0,Ot._$litElement$=!0,(ca=globalThis.litElementHydrateSupport)===null||ca===void 0||ca.call(globalThis,{LitElement:Ot});const Is=globalThis.litElementPolyfillSupport;Is==null||Is({LitElement:Ot});((ha=globalThis.litElementVersions)!==null&&ha!==void 0?ha:globalThis.litElementVersions=[]).push("3.3.3");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const tl=a=>e=>typeof e=="function"?((t,i)=>(customElements.define(t,i),i))(a,e):((t,i)=>{const{kind:o,elements:r}=i;return{kind:o,elements:r,finisher(s){customElements.define(t,s)}}})(a,e);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Wc=(a,e)=>e.kind==="method"&&e.descriptor&&!("value"in e.descriptor)?oe(j({},e),{finisher(t){t.createProperty(e.key,a)}}):{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){typeof e.initializer=="function"&&(this[e.key]=e.initializer.call(this))},finisher(t){t.createProperty(e.key,a)}},Qc=(a,e,t)=>{e.constructor.createProperty(t,a)};function $e(a){return(e,t)=>t!==void 0?Qc(a,e,t):Wc(a,e)}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var pa;((pa=window.HTMLSlotElement)===null||pa===void 0?void 0:pa.prototype.assignedElements)!=null;/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Us=a=>a!=null?a:ae;var Kc=Xn`<svg class="caret-up-svg" viewBox="0 0 8 4" xmlns="http://www.w3.org/2000/svg">
<path d="m6.7226499 3.51689722c.22976435.15317623.54019902.0910893.69337525-.13867505.13615665-.20423497.10222882-.47220946-.06836249-.63681849l-.07031256-.05655675-3.2773501-2.18490007-3.2773501 2.18490007c-.22976434.15317623-.29185128.4636109-.13867505.69337524.13615665.20423498.39656688.27598409.61412572.18182636l.07924953-.04315131 2.7226499-1.81402514z"
  fill=""></path>
</svg>`,qc=Xn`<svg class="caret-down-svg" viewBox="0 0 8 4" xmlns="http://www.w3.org/2000/svg">
<path d="m6.7226499.58397485c.22976435-.15317623.54019902-.09108929.69337525.13867505.13615665.20423498.10222882.47220947-.06836249.63681849l-.07031256.05655676-3.2773501 2.18490006-3.2773501-2.18490006c-.22976434-.15317623-.29185128-.4636109-.13867505-.69337525.13615665-.20423497.39656688-.27598409.61412572-.18182636l.07924953.04315131 2.7226499 1.81402515z"
fill=""></path>
</svg>`;let me=class extends Ot{constructor(){super(...arguments),this.open=!1,this.isDisabled=!1,this.displayCaret=!1,this.closeOnSelect=!1,this.openViaButton=!0,this.openViaCaret=!0,this.includeSelectedOption=!1,this.selectedOption="",this.options=[],this.optionGroup="options",this.optionSelected=()=>{},this.isCustomList=!1,this.hasCustomClickHandler=!1,this.closeOnEscape=!1,this.closeOnBackdropClick=!1,this.boundKeyboardListener=e=>{switch(e.key){case"Escape":case"Esc":this.closeOptions();break}},this.closeOptions=e=>{e&&e.type==="click"&&e.stopPropagation(),this.open=!1},this.handlingCaretClick=!1}async firstUpdated(){await new Promise(e=>setTimeout(e,0)),this.addEventListener("closeDropdown",this.closeOptions)}disconnectedCallback(){var e;(e=super.disconnectedCallback)===null||e===void 0||e.call(this),this.removeKeyboardListener()}setupKeyboardListener(){this.closeOnEscape&&document.addEventListener("keydown",this.boundKeyboardListener)}removeKeyboardListener(){this.closeOnEscape&&document.removeEventListener("keydown",this.boundKeyboardListener)}get dropdownState(){return this.open?(this.setupKeyboardListener(),"open"):(this.removeKeyboardListener(),"closed")}toggleOptions(){this.open=!this.open}mainButtonClicked(){if(this.handlingCaretClick){this.handlingCaretClick=!1;return}this.openViaButton&&this.toggleOptions()}caretInteracted(){this.openViaCaret&&this.toggleOptions()}caretClicked(){this.handlingCaretClick=!0,this.caretInteracted()}caretKeyDown(e){(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),this.caretInteracted())}renderOption(e){const{label:t,url:i=void 0,id:o}=e;let r;const s=this.selectedOption===o?"selected":"";return i?r=Me`<a
        href=${i}
      ...
      >
        ${t}
      </button>`,Me`<li class=${s}>${r}</li>`}optionClicked(e,t){var i;e.stopPropagation(),this.selectedOption!==t.id&&(this.selectedOption=t.id,this.dispatchEvent(new CustomEvent("optionSelected",{detail:{option:t}})),(i=t.selectedHandler)===null||i===void 0||i.call(t,t)),this.closeOnSelect&&this.closeOptions()}get availableOptions(){return this.includeSelectedOption?this.options:this.options.filter(e=>this.selectedOption!==e.id)}get caretTemplate(){if(!this.displayCaret)return Me``;const e=this.openViaCaret&&!this.openViaButton?"0":void 0,t=this.openViaCaret?"button":void 0;return Me`
      <span
        class="caret"
        tabindex=${Us(e)}
        role=${Us(t)}
      ...
      >
        <span ?hidden=${!this.open} class="caret-up">
          <slot name="caret-up">${Kc}</slot>
        </span>
        <span ?hidden=${this.open} class="caret-down">
          <slot name="caret-down">${qc}</slot>
        </span>
      </span>
    `}get dropdownTemplate(){return this.isCustomList?Me`<slot name="list"></slot>`:Me`${this.availableOptions.map(e=>this.renderOption(e))}`}get backdropTemplate(){return this.closeOnBackdropClick?this.open?Me`
      <div
        id="dropdown-backdrop"
        @keyup=${this.closeOptions}
        @click=${this.closeOptions}
      ></div>
    `:Me``:Me``}render(){return Me`
    ...
    `}static get styles(){const e=We`var(--dropdownBorderWidth, 1px)`,t=We`var(--dropdownBorderRadius, 4px)`,i=We`var(--dropdownBorderColor, #fff)`,o=We`var(--dropdownBgColor, #333)`,r=We`var(--dropdownTextColor, #fff)`,s=We`var(--dropdownHoverBgColor, rgba(255, 255, 255, 0.3))`,l=We`var(--dropdownSelectedBgColor, #fff)`;return We`
      :host {
        display: inline;
        color: ${r};
      }
    ...
    `}};n([$e({type:Boolean,reflect:!0})],me.prototype,"open",void 0);n([$e({type:Boolean,reflect:!0})],me.prototype,"isDisabled",void 0);n([$e({type:Boolean})],me.prototype,"displayCaret",void 0);n([$e({type:Boolean})],me.prototype,"closeOnSelect",void 0);n([$e({type:Boolean})],me.prototype,"openViaButton",void 0);n([$e({type:Boolean})],me.prototype,"openViaCaret",void 0);n([$e({type:Boolean})],me.prototype,"includeSelectedOption",void 0);n([$e({type:String})],me.prototype,"selectedOption",void 0);n([$e({attribute:!1})],me.prototype,"options",void 0);n([$e({type:String})],me.prototype,"optionGroup",void 0);n([$e({attribute:!1})],me.prototype,"optionSelected",void 0);n([$e({type:Boolean,reflect:!0})],me.prototype,"isCustomList",void 0);n([$e({type:Boolean,reflect:!0})],me.prototype,"hasCustomClickHandler",void 0);n([$e({type:Boolean,reflect:!0})],me.prototype,"closeOnEscape",void 0);n([$e({type:Boolean,reflect:!0})],me.prototype,"closeOnBackdropClick",void 0);me=n([tl("ia-dropdown")],me);let er=class extends Ot{render(){return Me`
  ...
  `;er=n([tl("ia-icon-label")],er);let tr=class extends F{constructor(){super(...arguments),this.numResults=0}render(){return h`
    ...
    `}};n([p({type:Number})],tr.prototype,"numResults",void 0);tr=n([D("alpha-bar-tooltip")],tr);let Ge=class extends F{constructor(){super(...arguments),this.selectedLetter=null,this.tooltipShown=!1,this.alphabet="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("")}get selectedUppercaseLetter(){var e;return(e=this.selectedLetter)===null||e===void 0?void 0:e.toUpperCase()}render(){var e;return h`
  ...
  `;n([p({type:String})],Ge.prototype,"selectedLetter",void 0);n([p({type:Object})],Ge.prototype,"letterCounts",void 0);n([p({type:String})],Ge.prototype,"ariaLandmarkLabel",void 0);n([z()],Ge.prototype,"tooltipShown",void 0);n([z()],Ge.prototype,"hoveredLetter",void 0);n([ee("alpha-bar-tooltip")],Ge.prototype,"tooltip",void 0);Ge=n([D("alpha-bar")],Ge);const Gc=h`
...
`;let q=class extends F{constructor(){super(...arguments),this.defaultSortDirection=null,this.defaultSortField=S.relevance,this.sortDirection=null,this.selectedSort=S.default,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.showRelevance=!0,this.showDateFavorited=!1,this.enableSortOptionsSlot=!1,this.suppressDisplayModes=!1,this.lastSelectedViewSort=S.weeklyview,this.lastSelectedDateSort=this.defaultDateSortField,this.alphaSelectorVisible=null,this.dropdownBackdropVisible=!1,this.desktopSortContainerWidth=0,this.selectorBarContainerWidth=0,this.boundSortBarSelectorEscapeListener=e=>{e.key==="Escape"&&this.closeDropdowns()}}render(){return h`
    ...
    `:h`<div class="sort-direction-icon">${Xc}</div>`}get desktopSortSelectorTemplate(){return h`
      <div
    ...
    `}get mobileSortSelectorTemplate(){const e=Object.values(we).filter(t=>t.shownInSortBar).filter(t=>this.showRelevance||t.field!==S.relevance).filter(t=>this.showDateFavorited||t.field!==S.datefavorited);return h`
      <div
    ...
    `}getSortDisplayOption(e,t){var i,o;const r=(i=t==null?void 0:t.selected)!==null&&i!==void 0?i:this.finalizedSortField===e,s=(o=t==null?void 0:t.displayName)!==null&&o!==void 0?o:we[e].displayName;return h`
      <button
        class=${r?"selected":y}
        data-title="${s}"
    ...
    ></alpha-bar>`}titleLetterChanged(e){var t;this.selectedTitleFilter=(t=e.detail.selectedLetter)!==null&&t!==void 0?t:null,this.emitTitleLetterChangedEvent()}creatorLetterChanged(e){var t;this.selectedCreatorFilter=(t=e.detail.selectedLetter)!==null&&t!==void 0?t:null,this.emitCreatorLetterChangedEvent()}emitTitleLetterChangedEvent(){const e=new CustomEvent("titleLetterChanged",{detail:{selectedLetter:this.selectedTitleFilter}});this.dispatchEvent(e)}emitCreatorLetterChangedEvent(){const e=new CustomEvent("creatorLetterChanged",{detail:{selectedLetter:this.selectedCreatorFilter}});this.dispatchEvent(e)}displayModeChanged(){const e=new CustomEvent("displayModeChanged",{detail:{displayMode:this.displayMode}});this.dispatchEvent(e)}emitSortChangedEvent(){const e=new CustomEvent("sortChanged",{detail:{selectedSort:this.selectedSort,sortDirection:this.sortDirection}});this.dispatchEvent(e)}static get styles(){return[Ye,b`
      ...
      `]}};n([p({type:String})],q.prototype,"displayMode",void 0);n([p({type:String})],q.prototype,"defaultSortDirection",void 0);n([p({type:String})],q.prototype,"defaultSortField",void 0);n([p({type:String})],q.prototype,"sortDirection",void 0);n([p({type:String})],q.prototype,"selectedSort",void 0);n([p({type:String})],q.prototype,"selectedTitleFilter",void 0);n([p({type:String})],q.prototype,"selectedCreatorFilter",void 0);n([p({type:Boolean})],q.prototype,"showRelevance",void 0);n([p({type:Boolean})],q.prototype,"showDateFavorited",void 0);n([p({type:Boolean,reflect:!0})],q.prototype,"enableSortOptionsSlot",void 0);n([p({type:Boolean,reflect:!0})],q.prototype,"suppressDisplayModes",void 0);n([p({type:Object})],q.prototype,"prefixFilterCountMap",void 0);n([p({type:Object})],q.prototype,"resizeObserver",void 0);n([z()],q.prototype,"lastSelectedViewSort",void 0);n([z()],q.prototype,"lastSelectedDateSort",void 0);n([z()],q.prototype,"alphaSelectorVisible",void 0);n([z()],q.prototype,"dropdownBackdropVisible",void 0);n([z()],q.prototype,"desktopSortContainerWidth",void 0);n([z()],q.prototype,"selectorBarContainerWidth",void 0);n([ee("#desktop-sort-container")],q.prototype,"desktopSortContainer",void 0);n([ee("#sort-selector-container")],q.prototype,"sortSelectorContainer",void 0);n([ee("#views-dropdown")],q.prototype,"viewsDropdown",void 0);n([ee("#date-dropdown")],q.prototype,"dateDropdown",void 0);n([ee("#mobile-dropdown")],q.prototype,"mobileDropdown",void 0);q=n([D("sort-filter-bar")],q);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Ns(a,e,t){return a?e():t==null?void 0:t()}const Hs=b`var(--white, #fff)`,t0=b`var(--primaryDisableCTAFill, #767676)`,i0=b`var(--secondaryCTABorder, #999)`,o0=b`var(--primaryCTAFill, #194880)`,ua=b`var(--primaryCTAFillRGB, 25, 72, 128)`,a0=b`var(--primaryCTABorder, #c5d1df)`,r0=b`var(--primaryErrorCTAFill, #d9534f)`,va=b`var(--primaryErrorCTAFillRGB, 229, 28, 38)`,s0=b`var(--primaryErrorCTABorder, #d43f3a)`,n0=b`var(--secondaryCTAFill, #333)`,fa=b`var(--secondaryCTAFillRGB, 51, 51, 51)`,l0=b`var(--primaryCTABorder, #979797)`,d0=b`#ee8950`,c0=b`#ec7939`;var h0=b`
  .ia-button {
    min-height: 3rem;
    cursor: pointer;
    color: ${Hs};
...
`;let qt=class extends F{constructor(){super(...arguments),this.label=M("Select items to remove"),this.showSelectAll=!1,this.showUnselectAll=!1,this.removeAllowed=!1}render(){return h`
    ...
    `}cancelClicked(){this.dispatchEvent(new CustomEvent("cancel"))}removeClicked(){this.dispatchEvent(new CustomEvent("removeItems"))}selectAllClicked(){this.dispatchEvent(new CustomEvent("selectAll"))}unselectAllClicked(){this.dispatchEvent(new CustomEvent("unselectAll"))}static get styles(){return b`
      ${h0}
      .manage-container {
        display: flex;
        align-items: center;
    ...
    `}};n([p({type:String})],qt.prototype,"label",void 0);n([p({type:Boolean})],qt.prototype,"showSelectAll",void 0);n([p({type:Boolean})],qt.prototype,"showUnselectAll",void 0);n([p({type:Boolean})],qt.prototype,"removeAllowed",void 0);qt=n([D("manage-bar")],qt);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const wi=(a,e)=>{var t,i;const o=a._$AN;if(o===void 0)return!1;for(const r of o)(i=(t=r)._$AO)===null||i===void 0||i.call(t,e,!1),wi(r,e);return!0},mo=a=>{let e,t;do{if((e=a._$AM)===void 0)break;t=e._$AN,t.delete(a),a=e}while((t==null?void 0:t.size)===0)},il=a=>{for(let e;e=a._$AM;a=e){let t=e._$AN;if(t===void 0)e._$AN=t=new Set;else if(t.has(a))break;t.add(a),v0(e)}};function p0(a){this._$AN!==void 0?(mo(this),this._$AM=a,il(this)):this._$AM=a}function u0(a,e=!1,t=0){const i=this._$AH,o=this._$AN;if(o!==void 0&&o.size!==0)if(e)if(Array.isArray(i))for(let r=t;r<i.length;r++)wi(i[r],!1),mo(i[r]);else i!=null&&(wi(i,!1),mo(i));else wi(this,a)}const v0=a=>{var e,t,i,o;a.type==Re.CHILD&&((e=(i=a)._$AP)!==null&&e!==void 0||(i._$AP=u0),(t=(o=a)._$AQ)!==null&&t!==void 0||(o._$AQ=p0))};class f0 extends Bi{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,i){super._$AT(e,t,i),il(this),this.isConnected=e._$AU}_$AO(e,t=!0){var i,o;e!==this.isConnected&&(this.isConnected=e,e?(i=this.reconnected)===null||i===void 0||i.call(this):(o=this.disconnected)===null||o===void 0||o.call(this)),t&&(wi(this,e),mo(this))}setValue(e){if(zn(this._$Ct))this._$Ct._$AI(e,this);else{const t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}}const ma=new WeakMap,m0=Fi(class extends f0{render(a){return y}update(a,[e]){var t;const i=e!==this.U;return i&&this.U!==void 0&&this.ot(void 0),(i||this.rt!==this.lt)&&(this.U=e,this.ht=(t=a.options)===null||t===void 0?void 0:t.host,this.ot(this.lt=a.element)),y}ot(a){var e;if(typeof this.U=="function"){const t=(e=this.ht)!==null&&e!==void 0?e:globalThis;let i=ma.get(t);i===void 0&&(i=new WeakMap,ma.set(t,i)),i.get(this.U)!==void 0&&this.U.call(this.ht,void 0),i.set(this.U,a),a!==void 0&&this.U.call(this.ht,a)}else this.U.value=a}get rt(){var a,e,t;return typeof this.U=="function"?(e=ma.get((a=this.ht)!==null&&a!==void 0?a:globalThis))===null||e===void 0?void 0:e.get(this.U):(t=this.U)===null||t===void 0?void 0:t.value}disconnected(){this.rt===this.lt&&this.ot(void 0)}reconnected(){this.ot(this.lt)}});/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Vs=Fi(class extends Bi{constructor(a){if(super(a),a.type!==Re.PROPERTY&&a.type!==Re.ATTRIBUTE&&a.type!==Re.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!zn(a))throw Error("`live` bindings can only contain a single expression")}render(a){return a}update(a,[e]){if(e===Te||e===y)return e;const t=a.element,i=a.name;if(a.type===Re.PROPERTY){if(e===t[i])return Te}else if(a.type===Re.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(i))return Te}else if(a.type===Re.ATTRIBUTE&&t.getAttribute(i)===e+"")return Te;return Pn(a),e}}),g0=Object.freeze({processing:"processing",complete:"complete"});class y0 extends F{static get properties(){return{mode:{type:String}}}constructor(){super(),this.mode=g0.processing}render(){return h`
      <div class="${this.mode}">
        <svg
          viewBox="0 0 120 120"
    ...
    `,this._tooltipVisible=!0}hideTooltip(){this._tooltipContent=void 0,this._tooltipVisible=!1}validMinSliderX(e){const t=Math.min(this.translateDateToPosition(this.maxSelectedDate),this.histogramRightEdgeX);return e=this.clamp(e,this.histogramLeftEdgeX,t),Number.isNaN(e)||t<this.histogramLeftEdgeX?this.histogramLeftEdgeX:e}validMaxSliderX(e){const t=Math.max(this.histogramLeftEdgeX,this.translateDateToPosition(this.minSelectedDate));return e=this.clamp(e,t,this.histogramRightEdgeX),Number.isNaN(e)||t>this.histogramRightEdgeX?this.histogramRightEdgeX:e}addListeners(){window.addEventListener("pointermove",this.move),window.addEventListener("pointerup",this.drop),window.addEventListener("pointercancel",this.drop)}removeListeners(){window.removeEventListener("pointermove",this.move),window.removeEventListener("pointerup",this.drop),window.removeEventListener("pointercancel",this.drop)}beginEmitUpdateProcess(){this.cancelPendingUpdateEvent(),this._emitUpdatedEventTimer=setTimeout(()=>{if(this.currentDateRangeString===this._previousDateRange)return;this._previousDateRange=this.currentDateRangeString;const e={detail:{minDate:this.minSelectedDate,maxDate:this.maxSelectedDate},bubbles:!0,composed:!0};this.dispatchEvent(new CustomEvent("histogramDateRangeUpdated",e))},this.updateDelay)}cancelPendingUpdateEvent(){this._emitUpdatedEventTimer!==void 0&&(clearTimeout(this._emitUpdatedEventTimer),this._emitUpdatedEventTimer=void 0)}setDragOffset(e){this._currentSlider=e.currentTarget;const t=this._currentSlider.id==="slider-min"?this.minSliderX:this.maxSliderX,i=this.getBoundingClientRect().x;this._dragOffset=e.clientX-i-t}translatePositionToDate(e){const t=Math.ceil((e-this.sliderWidth)*this.dateRangeMS/this._histWidth);return this.formatDate(this._minDateMS+t)}translateDateToPosition(e){const t=this.getMSFromString(e);return this.sliderWidth+(t-this._minDateMS)*this._histWidth/this.dateRangeMS}clamp(e,t,i){return Math.min(Math.max(e,t),i)}handleInputFocus(){this.updateWhileFocused||this.cancelPendingUpdateEvent()}handleMinDateInput(e){const t=e.currentTarget;t.value!==this.minSelectedDate&&(this.minSelectedDate=t.value,this.beginEmitUpdateProcess())}handleMaxDateInput(e){const t=e.currentTarget;t.value!==this.maxSelectedDate&&(this.maxSelectedDate=t.value,this.beginEmitUpdateProcess())}handleKeyUp(e){if(e.key==="Enter"){const t=e.currentTarget;t.blur(),t.id==="date-min"?this.handleMinDateInput(e):t.id==="date-max"&&this.handleMaxDateInput(e)}}get currentDateRangeString(){return`${this.minSelectedDate}:${this.maxSelectedDate}`}getMSFromString(e){const t=typeof e=="string"?e:String(e);if((t.split(/(\d+)/).length-1)/2===1){const o=new Date(0,0);return o.setFullYear(Number(t)),o.getTime()}return ka(t,[this.dateFormat,js]).valueOf()}handleBarClick(e){const t=e.currentTarget.dataset,i=(this.getMSFromString(t.binStart)+this.getMSFromString(t.binEnd))/2,o=Math.abs(i-this.getMSFromString(this.minSelectedDate)),r=Math.abs(i-this.getMSFromString(this.maxSelectedDate));o<r?this.minSelectedDate=t.binStart:this.maxSelectedDate=t.binEnd,this.beginEmitUpdateProcess()}get minSliderTemplate(){const e=Ws,t=`
            ...
            q0,${e} ${e},${e}
            h${this.sliderWidth-e}
          `;return this.generateSliderSVG(this.minSliderX,"slider-min",t)}get maxSliderTemplate(){const e=Ws,t=`
            M${this.maxSliderX},0
            h${this.sliderWidth-e}
            q${e},0 ${e},${e}
            v${this.height-e*2}
    ...
    `}get selectedRangeTemplate(){return I`
      ...
      />`}get histogramTemplate(){const e=this._histWidth/this._numBins,t=e-1;let i=this.sliderWidth;return this._histData.map(o=>{const r=I`
        <rect
          ...
          fill="${i+t>=this.minSliderX&&i<=this.maxSliderX?E0:A0}"
          data-num-items="${o.value}"
          data-bin-start="${o.binStart}"
          data-bin-end="${o.binEnd}"
        />`;return i+=e,r})}formatDate(e){if(Number.isNaN(e))return"";const t=ka(e);return t.year()<1e3?String(t.year()):t.format(this.dateFormat)}get minInputTemplate(){return h`
      <input
        id="date-min"
    ...
    #tooltip:after {
      ...
      /* arrow */
      border: 5px solid ${Ks};
      border-color: ${Qs} transparent transparent
        transparent;
    }
    /****** slider ********/
    .draggable:hover {
...
`;let se=class extends F{constructor(){super(...arguments),this.prompt="Do you find this feature useful?",this.buttonText="Beta",this.isOpen=!1,this.processing=!1,this.popupTopX=0,this.popupTopY=0,this.voteSubmitted=!1,this.voteNeedsChoosing=!1,this.resizingElement=document.body}render(){return h`
    ...
    `}get upvoteSelected(){return this.vote==="up"}get downvoteSelected(){return this.vote==="down"}upvoteKeypressed(e){(e.key==="Enter"||e.key===" ")&&this.upvoteButtonSelected()}downvoteKeypressed(e){(e.key==="Enter"||e.key===" ")&&this.downvoteButtonSelected()}upvoteButtonSelected(){this.vote=this.vote==="up"?void 0:"up"}downvoteButtonSelected(){this.vote=this.vote==="down"?void 0:"down"}get chooseVoteErrorClass(){return this.voteNeedsChoosing?"error":""}get upvoteButtonClass(){switch(this.vote){case"up":return"selected";case"down":return"unselected";default:return"noselection"}}get downvoteButtonClass(){switch(this.vote){case"up":return"unselected";case"down":return"selected";default:return"noselection"}}backgroundClicked(e){var t;e.target instanceof Node&&(!((t=this.popup)===null||t===void 0)&&t.contains(e.target)||this.closePopup())}cancel(e){e.preventDefault(),this.vote=void 0,this.closePopup()}async submit(e){if(e.preventDefault(),!this.vote){this.voteNeedsChoosing=!0,this.error=h`Please select a vote.`;return}if(!this.featureIdentifier)throw new Error("featureIdentifier is required");if(!this.featureFeedbackService)throw new Error("featureFeedbackService is required");if(!this.recaptchaWidget)throw new Error("recaptchaWidget is required");this.processing=!0;try{const t=await this.recaptchaWidget.execute();(await this.featureFeedbackService.submitFeedback({featureIdentifier:this.featureIdentifier,vote:this.vote,comments:this.comments.value,recaptchaToken:t})).success?(this.voteSubmitted=!0,this.closePopup()):this.error=h`There was an error submitting your feedback.`}catch(t){this.error=h`There was an error submitting your feedback.<br />Error:
        ${t instanceof Error?t.message:t}`}this.processing=!1}static get styles(){const e=b`var(--featureFeedbackBlueColor, #194880)`,t=b`var(--featureFeedbackDarkGrayColor, #767676)`,i=b`var(--defaultColorSvgFilter, invert(52%) sepia(0%) saturate(1%) hue-rotate(331deg) brightness(87%) contrast(89%))`,o=b`var(--featureFeedbackBackdropZindex, 5)`,r=b`var(--featureFeedbackModalZindex, 6)`,s=b`var(--featureFeedbackPopupBorderColor, ${e})`,l=b`var(--featureFeedbackSubmitButtonColor, ${e})`,d=b`var(--featureFeedbackBetaButtonBorderColor, ${e})`,c=b`var(--featureFeedbackBetaButtonTextColor, ${e})`,u=b`var(--featureFeedbackBetaButtonSvgFilter, ${i})`,v=b`var(--featureFeedbackCancelButtonColor, #515151)`,m=b`var(--featureFeedbackPopupBlockerColor, rgba(255, 255, 255, 0.3))`,w=b`var(--featureFeedbackPopupBackgroundColor, #F5F5F7)`,$=b`var(--featureFeedbackPromptFontWeight, bold)`,x=b`var(--featureFeedbackPromptFontSize, 14px)`,P=b`var(--defaultColor, ${t});`,R=b`var(--defaultColorSvgFilter, ${i});`,L=b`var(--upvoteColor, #23765D);`,K=b`var(--upvoteColorSvgFilter, invert(34%) sepia(72%) saturate(357%) hue-rotate(111deg) brightness(97%) contrast(95%));`,U=b`var(--downvoteColor, #720D11);`,re=b`var(--downvoteColorSvgFilter, invert(5%) sepia(81%) saturate(5874%) hue-rotate(352deg) brightness(105%) contrast(95%));`,ce=b`var(--unselectedColor, #CCCCCC);`,Ce=b`var(--unselectedColorSvgFilter, invert(100%) sepia(0%) saturate(107%) hue-rotate(138deg) brightness(89%) contrast(77%));`;return b`
      #beta-button {
        font-size: 12px;
        font-weight: bold;
        font-style: italic;
    ...
    `}};n([p({type:String})],se.prototype,"featureIdentifier",void 0);n([p({type:String})],se.prototype,"prompt",void 0);n([p({type:String})],se.prototype,"buttonText",void 0);n([p({type:Object})],se.prototype,"recaptchaManager",void 0);n([p({type:Object})],se.prototype,"resizeObserver",void 0);n([p({type:Boolean})],se.prototype,"disabled",void 0);n([p({type:Object})],se.prototype,"featureFeedbackService",void 0);n([ee("#beta-button")],se.prototype,"betaButton",void 0);n([ee("#popup")],se.prototype,"popup",void 0);n([z()],se.prototype,"isOpen",void 0);n([z()],se.prototype,"processing",void 0);n([z()],se.prototype,"popupTopX",void 0);n([z()],se.prototype,"popupTopY",void 0);n([z()],se.prototype,"vote",void 0);n([z()],se.prototype,"voteSubmitted",void 0);n([z()],se.prototype,"error",void 0);n([z()],se.prototype,"voteNeedsChoosing",void 0);n([z()],se.prototype,"recaptchaWidget",void 0);n([ee("#comments")],se.prototype,"comments",void 0);se=n([D("feature-feedback")],se);class go{constructor(e){var t,i,o,r,s,l,d;this.title=e==null?void 0:e.title,this.subtitle=e==null?void 0:e.subtitle,this.headline=e==null?void 0:e.headline,this.message=e==null?void 0:e.message,this.headerColor=(t=e==null?void 0:e.headerColor)!==null&&t!==void 0?t:"#55A183",this.bodyColor=(i=e==null?void 0:e.bodyColor)!==null&&i!==void 0?i:"#f5f5f7",this.showProcessingIndicator=(o=e==null?void 0:e.showProcessingIndicator)!==null&&o!==void 0?o:!1,this.processingImageMode=(r=e==null?void 0:e.processingImageMode)!==null&&r!==void 0?r:"complete",this.showCloseButton=(s=e==null?void 0:e.showCloseButton)!==null&&s!==void 0?s:!0,this.showHeaderLogo=(l=e==null?void 0:e.showHeaderLogo)!==null&&l!==void 0?l:!0,this.closeOnBackdropClick=(d=e==null?void 0:e.closeOnBackdropClick)!==null&&d!==void 0?d:!0}}/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const io=window,xr=io.ShadowRoot&&(io.ShadyCSS===void 0||io.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,ol=Symbol(),Ys=new WeakMap;class O0{constructor(e,t,i){if(this._$cssResult$=!0,i!==ol)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o;const t=this.t;if(xr&&e===void 0){const i=t!==void 0&&t.length===1;i&&(e=Ys.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),i&&Ys.set(t,e))}return e}toString(){return this.cssText}}const I0=a=>new O0(typeof a=="string"?a:a+"",void 0,ol),U0=(a,e)=>{xr?a.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet):e.forEach(t=>{const i=document.createElement("style"),o=io.litNonce;o!==void 0&&i.setAttribute("nonce",o),i.textContent=t.cssText,a.appendChild(i)})},Xs=xr?a=>a:a=>a instanceof CSSStyleSheet?(e=>{let t="";for(const i of e.cssRules)t+=i.cssText;return I0(t)})(a):a;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var ga;const yo=window,Zs=yo.trustedTypes,N0=Zs?Zs.emptyScript:"",Js=yo.reactiveElementPolyfillSupport,ir={toAttribute(a,e){switch(e){case Boolean:a=a?N0:null;break;case Object:case Array:a=a==null?a:JSON.stringify(a)}return a},fromAttribute(a,e){let t=a;switch(e){case Boolean:t=a!==null;break;case Number:t=a===null?null:Number(a);break;case Object:case Array:try{t=JSON.parse(a)}catch{t=null}}return t}},al=(a,e)=>e!==a&&(e==e||a==a),ya={attribute:!0,type:String,converter:ir,reflect:!1,hasChanged:al},or="finalized";class mi extends HTMLElement{constructor(){super(),this._$Ei=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$El=null,this._$Eu()}static addInitializer(e){var t;this.finalize(),((t=this.h)!==null&&t!==void 0?t:this.h=[]).push(e)}static get observedAttributes(){this.finalize();const e=[];return this.elementProperties.forEach((t,i)=>{const o=this._$Ep(i,t);o!==void 0&&(this._$Ev.set(o,i),e.push(o))}),e}static createProperty(e,t=ya){if(t.state&&(t.attribute=!1),this.finalize(),this.elementProperties.set(e,t),!t.noAccessor&&!this.prototype.hasOwnProperty(e)){const i=typeof e=="symbol"?Symbol():"__"+e,o=this.getPropertyDescriptor(e,i,t);o!==void 0&&Object.defineProperty(this.prototype,e,o)}}static getPropertyDescriptor(e,t,i){return{get(){return this[t]},set(o){const r=this[e];this[t]=o,this.requestUpdate(e,r,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)||ya}static finalize(){if(this.hasOwnProperty(or))return!1;this[or]=!0;const e=Object.getPrototypeOf(this);if(e.finalize(),e.h!==void 0&&(this.h=[...e.h]),this.elementProperties=new Map(e.elementProperties),this._$Ev=new Map,this.hasOwnProperty("properties")){const t=this.properties,i=[...Object.getOwnPropertyNames(t),...Object.getOwnPropertySymbols(t)];for(const o of i)this.createProperty(o,t[o])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const i=new Set(e.flat(1/0).reverse());for(const o of i)t.unshift(Xs(o))}else e!==void 0&&t.push(Xs(e));return t}static _$Ep(e,t){const i=t.attribute;return i===!1?void 0:typeof i=="string"?i:typeof e=="string"?e.toLowerCase():void 0}_$Eu(){var e;this._$E_=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$Eg(),this.requestUpdate(),(e=this.constructor.h)===null||e===void 0||e.forEach(t=>t(this))}addController(e){var t,i;((t=this._$ES)!==null&&t!==void 0?t:this._$ES=[]).push(e),this.renderRoot!==void 0&&this.isConnected&&((i=e.hostConnected)===null||i===void 0||i.call(e))}removeController(e){var t;(t=this._$ES)===null||t===void 0||t.splice(this._$ES.indexOf(e)>>>0,1)}_$Eg(){this.constructor.elementProperties.forEach((e,t)=>{this.hasOwnProperty(t)&&(this._$Ei.set(t,this[t]),delete this[t])})}createRenderRoot(){var e;const t=(e=this.shadowRoot)!==null&&e!==void 0?e:this.attachShadow(this.constructor.shadowRootOptions);return U0(t,this.constructor.elementStyles),t}connectedCallback(){var e;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$ES)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostConnected)===null||i===void 0?void 0:i.call(t)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$ES)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostDisconnected)===null||i===void 0?void 0:i.call(t)})}attributeChangedCallback(e,t,i){this._$AK(e,i)}_$EO(e,t,i=ya){var o;const r=this.constructor._$Ep(e,i);if(r!==void 0&&i.reflect===!0){const s=(((o=i.converter)===null||o===void 0?void 0:o.toAttribute)!==void 0?i.converter:ir).toAttribute(t,i.type);this._$El=e,s==null?this.removeAttribute(r):this.setAttribute(r,s),this._$El=null}}_$AK(e,t){var i;const o=this.constructor,r=o._$Ev.get(e);if(r!==void 0&&this._$El!==r){const s=o.getPropertyOptions(r),l=typeof s.converter=="function"?{fromAttribute:s.converter}:((i=s.converter)===null||i===void 0?void 0:i.fromAttribute)!==void 0?s.converter:ir;this._$El=r,this[r]=l.fromAttribute(t,s.type),this._$El=null}}requestUpdate(e,t,i){let o=!0;e!==void 0&&(((i=i||this.constructor.getPropertyOptions(e)).hasChanged||al)(this[e],t)?(this._$AL.has(e)||this._$AL.set(e,t),i.reflect===!0&&this._$El!==e&&(this._$EC===void 0&&(this._$EC=new Map),this._$EC.set(e,i))):o=!1),!this.isUpdatePending&&o&&(this._$E_=this._$Ej())}async _$Ej(){this.isUpdatePending=!0;try{await this._$E_}catch(t){Promise.reject(t)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var e;if(!this.isUpdatePending)return;this.hasUpdated,this._$Ei&&(this._$Ei.forEach((o,r)=>this[r]=o),this._$Ei=void 0);let t=!1;const i=this._$AL;try{t=this.shouldUpdate(i),t?(this.willUpdate(i),(e=this._$ES)===null||e===void 0||e.forEach(o=>{var r;return(r=o.hostUpdate)===null||r===void 0?void 0:r.call(o)}),this.update(i)):this._$Ek()}catch(o){throw t=!1,this._$Ek(),o}t&&this._$AE(i)}willUpdate(e){}_$AE(e){var t;(t=this._$ES)===null||t===void 0||t.forEach(i=>{var o;return(o=i.hostUpdated)===null||o===void 0?void 0:o.call(i)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$Ek(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$E_}shouldUpdate(e){return!0}update(e){this._$EC!==void 0&&(this._$EC.forEach((t,i)=>this._$EO(i,this[i],t)),this._$EC=void 0),this._$Ek()}updated(e){}firstUpdated(e){}}mi[or]=!0,mi.elementProperties=new Map,mi.elementStyles=[],mi.shadowRootOptions={mode:"open"},Js==null||Js({ReactiveElement:mi}),((ga=yo.reactiveElementVersions)!==null&&ga!==void 0?ga:yo.reactiveElementVersions=[]).push("1.6.3");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var ba;const bo=window,Gt=bo.trustedTypes,en=Gt?Gt.createPolicy("lit-html",{createHTML:a=>a}):void 0,ar="$lit$",it=`lit$${(Math.random()+"").slice(9)}$`,rl="?"+it,H0=`<${rl}>`,St=document,Ei=()=>St.createComment(""),Mi=a=>a===null||typeof a!="object"&&typeof a!="function",sl=Array.isArray,V0=a=>sl(a)||typeof(a==null?void 0:a[Symbol.iterator])=="function",wa=`[ 	
\f\r]`,gi=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,tn=/-->/g,on=/>/g,ft=RegExp(`>|${wa}(?:([^\\s"'>=/]+)(${wa}*=${wa}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),an=/'/g,rn=/"/g,nl=/^(?:script|style|textarea|title)$/i,j0=a=>(e,...t)=>({_$litType$:a,strings:e,values:t}),Je=j0(1),Yt=Symbol.for("lit-noChange"),he=Symbol.for("lit-nothing"),sn=new WeakMap,wt=St.createTreeWalker(St,129,null,!1);function ll(a,e){if(!Array.isArray(a)||!a.hasOwnProperty("raw"))throw Error("invalid template strings array");return en!==void 0?en.createHTML(e):e}const W0=(a,e)=>{const t=a.length-1,i=[];let o,r=e===2?"<svg>":"",s=gi;for(let l=0;l<t;l++){const d=a[l];let c,u,v=-1,m=0;for(;m<d.length&&(s.lastIndex=m,u=s.exec(d),u!==null);)m=s.lastIndex,s===gi?u[1]==="!--"?s=tn:u[1]!==void 0?s=on:u[2]!==void 0?(nl.test(u[2])&&(o=RegExp("</"+u[2],"g")),s=ft):u[3]!==void 0&&(s=ft):s===ft?u[0]===">"?(s=o!=null?o:gi,v=-1):u[1]===void 0?v=-2:(v=s.lastIndex-u[2].length,c=u[1],s=u[3]===void 0?ft:u[3]==='"'?rn:an):s===rn||s===an?s=ft:s===tn||s===on?s=gi:(s=ft,o=void 0);const w=s===ft&&a[l+1].startsWith("/>")?" ":"";r+=s===gi?d+H0:v>=0?(i.push(c),d.slice(0,v)+ar+d.slice(v)+it+w):d+it+(v===-2?(i.push(void 0),l):w)}return[ll(a,r+(a[t]||"<?>")+(e===2?"</svg>":"")),i]};class Ai{constructor({strings:e,_$litType$:t},i){let o;this.parts=[];let r=0,s=0;const l=e.length-1,d=this.parts,[c,u]=W0(e,t);if(this.el=Ai.createElement(c,i),wt.currentNode=this.el.content,t===2){const v=this.el.content,m=v.firstChild;m.remove(),v.append(...m.childNodes)}for(;(o=wt.nextNode())!==null&&d.length<l;){if(o.nodeType===1){if(o.hasAttributes()){const v=[];for(const m of o.getAttributeNames())if(m.endsWith(ar)||m.startsWith(it)){const w=u[s++];if(v.push(m),w!==void 0){const $=o.getAttribute(w.toLowerCase()+ar).split(it),x=/([.?@])?(.*)/.exec(w);d.push({type:1,index:r,name:x[2],strings:$,ctor:x[1]==="."?K0:x[1]==="?"?G0:x[1]==="@"?Y0:Eo})}else d.push({type:6,index:r})}for(const m of v)o.removeAttribute(m)}if(nl.test(o.tagName)){const v=o.textContent.split(it),m=v.length-1;if(m>0){o.textContent=Gt?Gt.emptyScript:"";for(let w=0;w<m;w++)o.append(v[w],Ei()),wt.nextNode(),d.push({type:2,index:++r});o.append(v[m],Ei())}}}else if(o.nodeType===8)if(o.data===rl)d.push({type:2,index:r});else{let v=-1;for(;(v=o.data.indexOf(it,v+1))!==-1;)d.push({type:7,index:r}),v+=it.length-1}r++}}static createElement(e,t){const i=St.createElement("template");return i.innerHTML=e,i}}function Xt(a,e,t=a,i){var o,r,s,l;if(e===Yt)return e;let d=i!==void 0?(o=t._$Co)===null||o===void 0?void 0:o[i]:t._$Cl;const c=Mi(e)?void 0:e._$litDirective$;return(d==null?void 0:d.constructor)!==c&&((r=d==null?void 0:d._$AO)===null||r===void 0||r.call(d,!1),c===void 0?d=void 0:(d=new c(a),d._$AT(a,t,i)),i!==void 0?((s=(l=t)._$Co)!==null&&s!==void 0?s:l._$Co=[])[i]=d:t._$Cl=d),d!==void 0&&(e=Xt(a,d._$AS(a,e.values),d,i)),e}class Q0{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){var t;const{el:{content:i},parts:o}=this._$AD,r=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:St).importNode(i,!0);wt.currentNode=r;let s=wt.nextNode(),l=0,d=0,c=o[0];for(;c!==void 0;){if(l===c.index){let u;c.type===2?u=new Ii(s,s.nextSibling,this,e):c.type===1?u=new c.ctor(s,c.name,c.strings,this,e):c.type===6&&(u=new X0(s,this,e)),this._$AV.push(u),c=o[++d]}l!==(c==null?void 0:c.index)&&(s=wt.nextNode(),l++)}return wt.currentNode=St,r}v(e){let t=0;for(const i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class Ii{constructor(e,t,i,o){var r;this.type=2,this._$AH=he,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=o,this._$Cp=(r=o==null?void 0:o.isConnected)===null||r===void 0||r}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cp}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Xt(this,e,t),Mi(e)?e===he||e==null||e===""?(this._$AH!==he&&this._$AR(),this._$AH=he):e!==this._$AH&&e!==Yt&&this._(e):e._$litType$!==void 0?this.g(e):e.nodeType!==void 0?this.$(e):V0(e)?this.T(e):this._(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==he&&Mi(this._$AH)?this._$AA.nextSibling.data=e:this.$(St.createTextNode(e)),this._$AH=e}g(e){var t;const{values:i,_$litType$:o}=e,r=typeof o=="number"?this._$AC(e):(o.el===void 0&&(o.el=Ai.createElement(ll(o.h,o.h[0]),this.options)),o);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===r)this._$AH.v(i);else{const s=new Q0(r,this),l=s.u(this.options);s.v(i),this.$(l),this._$AH=s}}_$AC(e){let t=sn.get(e.strings);return t===void 0&&sn.set(e.strings,t=new Ai(e)),t}T(e){sl(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,o=0;for(const r of e)o===t.length?t.push(i=new Ii(this.k(Ei()),this.k(Ei()),this,this.options)):i=t[o],i._$AI(r),o++;o<t.length&&(this._$AR(i&&i._$AB.nextSibling,o),t.length=o)}_$AR(e=this._$AA.nextSibling,t){var i;for((i=this._$AP)===null||i===void 0||i.call(this,!1,!0,t);e&&e!==this._$AB;){const o=e.nextSibling;e.remove(),e=o}}setConnected(e){var t;this._$AM===void 0&&(this._$Cp=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}}class Eo{constructor(e,t,i,o,r){this.type=1,this._$AH=he,this._$AN=void 0,this.element=e,this.name=t,this._$AM=o,this.options=r,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=he}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,i,o){const r=this.strings;let s=!1;if(r===void 0)e=Xt(this,e,t,0),s=!Mi(e)||e!==this._$AH&&e!==Yt,s&&(this._$AH=e);else{const l=e;let d,c;for(e=r[0],d=0;d<r.length-1;d++)c=Xt(this,l[i+d],t,d),c===Yt&&(c=this._$AH[d]),s||(s=!Mi(c)||c!==this._$AH[d]),c===he?e=he:e!==he&&(e+=(c!=null?c:"")+r[d+1]),this._$AH[d]=c}s&&!o&&this.j(e)}j(e){e===he?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e!=null?e:"")}}class K0 extends Eo{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===he?void 0:e}}const q0=Gt?Gt.emptyScript:"";class G0 extends Eo{constructor(){super(...arguments),this.type=4}j(e){e&&e!==he?this.element.setAttribute(this.name,q0):this.element.removeAttribute(this.name)}}class Y0 extends Eo{constructor(e,t,i,o,r){super(e,t,i,o,r),this.type=5}_$AI(e,t=this){var i;if((e=(i=Xt(this,e,t,0))!==null&&i!==void 0?i:he)===Yt)return;const o=this._$AH,r=e===he&&o!==he||e.capture!==o.capture||e.once!==o.once||e.passive!==o.passive,s=e!==he&&(o===he||r);r&&this.element.removeEventListener(this.name,this,o),s&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,i;typeof this._$AH=="function"?this._$AH.call((i=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&i!==void 0?i:this.element,e):this._$AH.handleEvent(e)}}class X0{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){Xt(this,e)}}const nn=bo.litHtmlPolyfillSupport;nn==null||nn(Ai,Ii),((ba=bo.litHtmlVersions)!==null&&ba!==void 0?ba:bo.litHtmlVersions=[]).push("2.8.0");const Z0=(a,e,t)=>{var i,o;const r=(i=t==null?void 0:t.renderBefore)!==null&&i!==void 0?i:e;let s=r._$litPart$;if(s===void 0){const l=(o=t==null?void 0:t.renderBefore)!==null&&o!==void 0?o:null;r._$litPart$=s=new Ii(e.insertBefore(Ei(),l),l,void 0,t!=null?t:{})}return s._$AI(a),s};/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Sr=window.ShadowRoot&&(window.ShadyCSS===void 0||window.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Cr=Symbol(),ln=new Map;class dl{constructor(e,t){if(this._$cssResult$=!0,t!==Cr)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e}get styleSheet(){let e=ln.get(this.cssText);return Sr&&e===void 0&&(ln.set(this.cssText,e=new CSSStyleSheet),e.replaceSync(this.cssText)),e}toString(){return this.cssText}}const J0=a=>new dl(typeof a=="string"?a:a+"",Cr),Z=(a,...e)=>{const t=a.length===1?a[0]:e.reduce((i,o,r)=>i+(s=>{if(s._$cssResult$===!0)return s.cssText;if(typeof s=="number")return s;throw Error("Value passed to 'css' function must be a 'css' function result: "+s+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(o)+a[r+1],a[0]);return new dl(t,Cr)},eh=(a,e)=>{Sr?a.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet):e.forEach(t=>{const i=document.createElement("style"),o=window.litNonce;o!==void 0&&i.setAttribute("nonce",o),i.textContent=t.cssText,a.appendChild(i)})},dn=Sr?a=>a:a=>a instanceof CSSStyleSheet?(e=>{let t="";for(const i of e.cssRules)t+=i.cssText;return J0(t)})(a):a;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var _a;const cn=window.trustedTypes,th=cn?cn.emptyScript:"",hn=window.reactiveElementPolyfillSupport,rr={toAttribute(a,e){switch(e){case Boolean:a=a?th:null;break;case Object:case Array:a=a==null?a:JSON.stringify(a)}return a},fromAttribute(a,e){let t=a;switch(e){case Boolean:t=a!==null;break;case Number:t=a===null?null:Number(a);break;case Object:case Array:try{t=JSON.parse(a)}catch{t=null}}return t}},cl=(a,e)=>e!==a&&(e==e||a==a),$a={attribute:!0,type:String,converter:rr,reflect:!1,hasChanged:cl};class Rt extends HTMLElement{constructor(){super(),this._$Et=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Ei=null,this.o()}static addInitializer(e){var t;(t=this.l)!==null&&t!==void 0||(this.l=[]),this.l.push(e)}static get observedAttributes(){this.finalize();const e=[];return this.elementProperties.forEach((t,i)=>{const o=this._$Eh(i,t);o!==void 0&&(this._$Eu.set(o,i),e.push(o))}),e}static createProperty(e,t=$a){if(t.state&&(t.attribute=!1),this.finalize(),this.elementProperties.set(e,t),!t.noAccessor&&!this.prototype.hasOwnProperty(e)){const i=typeof e=="symbol"?Symbol():"__"+e,o=this.getPropertyDescriptor(e,i,t);o!==void 0&&Object.defineProperty(this.prototype,e,o)}}static getPropertyDescriptor(e,t,i){return{get(){return this[t]},set(o){const r=this[e];this[t]=o,this.requestUpdate(e,r,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)||$a}static finalize(){if(this.hasOwnProperty("finalized"))return!1;this.finalized=!0;const e=Object.getPrototypeOf(this);if(e.finalize(),this.elementProperties=new Map(e.elementProperties),this._$Eu=new Map,this.hasOwnProperty("properties")){const t=this.properties,i=[...Object.getOwnPropertyNames(t),...Object.getOwnPropertySymbols(t)];for(const o of i)this.createProperty(o,t[o])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const i=new Set(e.flat(1/0).reverse());for(const o of i)t.unshift(dn(o))}else e!==void 0&&t.push(dn(e));return t}static _$Eh(e,t){const i=t.attribute;return i===!1?void 0:typeof i=="string"?i:typeof e=="string"?e.toLowerCase():void 0}o(){var e;this._$Ep=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$Em(),this.requestUpdate(),(e=this.constructor.l)===null||e===void 0||e.forEach(t=>t(this))}addController(e){var t,i;((t=this._$Eg)!==null&&t!==void 0?t:this._$Eg=[]).push(e),this.renderRoot!==void 0&&this.isConnected&&((i=e.hostConnected)===null||i===void 0||i.call(e))}removeController(e){var t;(t=this._$Eg)===null||t===void 0||t.splice(this._$Eg.indexOf(e)>>>0,1)}_$Em(){this.constructor.elementProperties.forEach((e,t)=>{this.hasOwnProperty(t)&&(this._$Et.set(t,this[t]),delete this[t])})}createRenderRoot(){var e;const t=(e=this.shadowRoot)!==null&&e!==void 0?e:this.attachShadow(this.constructor.shadowRootOptions);return eh(t,this.constructor.elementStyles),t}connectedCallback(){var e;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$Eg)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostConnected)===null||i===void 0?void 0:i.call(t)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$Eg)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostDisconnected)===null||i===void 0?void 0:i.call(t)})}attributeChangedCallback(e,t,i){this._$AK(e,i)}_$ES(e,t,i=$a){var o,r;const s=this.constructor._$Eh(e,i);if(s!==void 0&&i.reflect===!0){const l=((r=(o=i.converter)===null||o===void 0?void 0:o.toAttribute)!==null&&r!==void 0?r:rr.toAttribute)(t,i.type);this._$Ei=e,l==null?this.removeAttribute(s):this.setAttribute(s,l),this._$Ei=null}}_$AK(e,t){var i,o,r;const s=this.constructor,l=s._$Eu.get(e);if(l!==void 0&&this._$Ei!==l){const d=s.getPropertyOptions(l),c=d.converter,u=(r=(o=(i=c)===null||i===void 0?void 0:i.fromAttribute)!==null&&o!==void 0?o:typeof c=="function"?c:null)!==null&&r!==void 0?r:rr.fromAttribute;this._$Ei=l,this[l]=u(t,d.type),this._$Ei=null}}requestUpdate(e,t,i){let o=!0;e!==void 0&&(((i=i||this.constructor.getPropertyOptions(e)).hasChanged||cl)(this[e],t)?(this._$AL.has(e)||this._$AL.set(e,t),i.reflect===!0&&this._$Ei!==e&&(this._$EC===void 0&&(this._$EC=new Map),this._$EC.set(e,i))):o=!1),!this.isUpdatePending&&o&&(this._$Ep=this._$E_())}async _$E_(){this.isUpdatePending=!0;try{await this._$Ep}catch(t){Promise.reject(t)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var e;if(!this.isUpdatePending)return;this.hasUpdated,this._$Et&&(this._$Et.forEach((o,r)=>this[r]=o),this._$Et=void 0);let t=!1;const i=this._$AL;try{t=this.shouldUpdate(i),t?(this.willUpdate(i),(e=this._$Eg)===null||e===void 0||e.forEach(o=>{var r;return(r=o.hostUpdate)===null||r===void 0?void 0:r.call(o)}),this.update(i)):this._$EU()}catch(o){throw t=!1,this._$EU(),o}t&&this._$AE(i)}willUpdate(e){}_$AE(e){var t;(t=this._$Eg)===null||t===void 0||t.forEach(i=>{var o;return(o=i.hostUpdated)===null||o===void 0?void 0:o.call(i)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EU(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$Ep}shouldUpdate(e){return!0}update(e){this._$EC!==void 0&&(this._$EC.forEach((t,i)=>this._$ES(i,this[i],t)),this._$EC=void 0),this._$EU()}updated(e){}firstUpdated(e){}}Rt.finalized=!0,Rt.elementProperties=new Map,Rt.elementStyles=[],Rt.shadowRootOptions={mode:"open"},hn==null||hn({ReactiveElement:Rt}),((_a=globalThis.reactiveElementVersions)!==null&&_a!==void 0?_a:globalThis.reactiveElementVersions=[]).push("1.3.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var xa,Sa;class It extends Rt{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e,t;const i=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=i.firstChild),i}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Z0(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!1)}render(){return Yt}}It.finalized=!0,It._$litElement$=!0,(xa=globalThis.litElementHydrateSupport)===null||xa===void 0||xa.call(globalThis,{LitElement:It});const pn=globalThis.litElementPolyfillSupport;pn==null||pn({LitElement:It});((Sa=globalThis.litElementVersions)!==null&&Sa!==void 0?Sa:globalThis.litElementVersions=[]).push("3.3.3");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const hl=a=>e=>typeof e=="function"?((t,i)=>(customElements.define(t,i),i))(a,e):((t,i)=>{const{kind:o,elements:r}=i;return{kind:o,elements:r,finisher(s){customElements.define(t,s)}}})(a,e);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ih=(a,e)=>e.kind==="method"&&e.descriptor&&!("value"in e.descriptor)?oe(j({},e),{finisher(t){t.createProperty(e.key,a)}}):{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){typeof e.initializer=="function"&&(this[e.key]=e.initializer.call(this))},finisher(t){t.createProperty(e.key,a)}},oh=(a,e,t)=>{e.constructor.createProperty(t,a)};function Mo(a){return(e,t)=>t!==void 0?oh(a,e,t):ih(a,e)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ah=({finisher:a,descriptor:e})=>(t,i)=>{var o;if(i===void 0){const r=(o=t.originalKey)!==null&&o!==void 0?o:t.key,s=e!=null?{kind:"method",placement:"prototype",key:r,descriptor:e(t.key)}:oe(j({},t),{key:r});return a!=null&&(s.finisher=function(l){a(l,r)}),s}{const r=t.constructor;e!==void 0&&Object.defineProperty(t,i,e(i)),a==null||a(r,i)}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function rh(a,e){return ah({descriptor:t=>{const i={get(){var o,r;return(r=(o=this.renderRoot)===null||o===void 0?void 0:o.querySelector(a))!==null&&r!==void 0?r:null},enumerable:!0,configurable:!0};if(e){const o=typeof t=="symbol"?Symbol():"__"+t;i.get=function(){var r,s;return this[o]===void 0&&(this[o]=(s=(r=this.renderRoot)===null||r===void 0?void 0:r.querySelector(a))!==null&&s!==void 0?s:null),this[o]}}return i}})}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Ca;((Ca=window.HTMLSlotElement)===null||Ca===void 0?void 0:Ca.prototype.assignedElements)!=null;var sh=h`
<svg
  viewBox="0 0 40 40"
  version="1.1"
  xmlns="http://www.w3.org/2000/svg"
...
`;class nh extends F{static get styles(){return b`
      :host {
    ...
    `}render(){return sh}}customElements.define("ia-icon-close",nh);var lh=h`
<svg
  class="ia-logo"
  viewBox="0 0 27 30"
  xmlns="http://www.w3.org/2000/svg"
...
`;let sr=class extends It{constructor(){super(...arguments),this.config=new go}render(){return Je`
      <div class="modal-wrapper">
        <div class="modal-container">
          <header style="background-color: ${this.config.headerColor}">
            ${this.config.showCloseButton?this.closeButtonTemplate:""}
            ${this.config.showHeaderLogo?Je`<div class="logo-icon">${lh}</div>`:he}
            ${this.config.title?Je`<h1 class="title">${this.config.title}</h1>`:""}
            ${this.config.subtitle?Je`<h2 class="subtitle">${this.config.subtitle}</h2>`:""}
          </header>
          <section
            class="modal-body"
          ...
          >
            <div class="content">
              ...
              ${this.config.headline?Je` <h1 class="headline">${this.config.headline}</h1> `:""}
              ${this.config.message?Je` <p class="message">${this.config.message}</p> `:""}
    ...
    `}handleCloseButton(){const e=new Event("closeButtonPressed");this.dispatchEvent(e)}get closeButtonTemplate(){return Je`
      <button
        type="button"
        class="close-button"
        tabindex="0"
    ...
    `}static get styles(){const e=Z`var(--modalLogoSize, 6.5rem)`,t=Z`var(--processingImageSize, 7.5rem)`,i=Z`var(--modalCornerRadius, 1rem)`,o=Z`var(--modalBorder, 2px solid black)`,r=Z`var(--modalBottomMargin, 2.5rem)`,s=Z`var(--modalTopMargin, 5rem)`,l=Z`var(--modalHeaderBottomPadding, 0.5em)`,d=Z`var(--modalBottomPadding, 2rem)`,c=Z`var(--modalScrollOffset, 5px)`,u=Z`var(--modalTitleFontSize, 1.8rem)`,v=Z`var(--modalSubtitleFontSize, 1.4rem)`,m=Z`var(--modalHeadlineFontSize, 1.6rem)`,w=Z`var(--modalMessageFontSize, 1.4rem)`,$=Z`var(--modalTitleLineHeight, normal)`,x=Z`var(--modalSubtitleLineHeight, normal)`,P=Z`var(--modalHeadlineLineHeight, normal)`,R=Z`var(--modalMessageLineHeight, normal)`;return Z`
      .processing-logo {
        margin: auto;
        width: ${t};
        height: ${t};
    ...
    `}};n([Mo({type:Object})],sr.prototype,"config",void 0);sr=n([hl("modal-template")],sr);function dh(a,e,t){var i=t||{},o=i.noTrailing,r=o===void 0?!1:o,s=i.noLeading,l=s===void 0?!1:s,d=i.debounceMode,c=d===void 0?void 0:d,u,v=!1,m=0;function w(){u&&clearTimeout(u)}function $(P){var R=P||{},L=R.upcomingOnly,K=L===void 0?!1:L;w(),v=!K}function x(){for(var P=arguments.length,R=new Array(P),L=0;L<P;L++)R[L]=arguments[L];var K=this,U=Date.now()-m;if(v)return;function re(){m=Date.now(),e.apply(K,R)}function ce(){u=void 0}!l&&c&&!u&&re(),w(),c===void 0&&U>a?l?(m=Date.now(),r||(u=setTimeout(c?ce:re,a))):re():r!==!0&&(u=setTimeout(c?ce:re,c===void 0?a-U:a))}return x.cancel=$,x}var _t;(function(a){a.Open="open",a.Closed="closed"})(_t||(_t={}));class ch{constructor(e){this.windowResizeThrottler=dh(100,this.updateModalContainerHeight,{noLeading:!1,noTrailing:!1}).bind(this),this.modalManager=e}handleModeChange(e){switch(e){case _t.Open:this.startResizeListener(),this.stopDocumentScroll();break;case _t.Closed:this.stopResizeListener(),this.resumeDocumentScroll();break}}updateModalContainerHeight(){this.modalManager.style.setProperty("--containerHeight",`${window.innerHeight}px`)}stopDocumentScroll(){document.body.classList.add("modal-manager-open")}resumeDocumentScroll(){document.body.classList.remove("modal-manager-open")}startResizeListener(){window.addEventListener("resize",this.windowResizeThrottler)}stopResizeListener(){window.removeEventListener("resize",this.windowResizeThrottler)}}let Zt=class extends It{constructor(){super(...arguments),this.mode=_t.Closed,this.hostBridge=new ch(this),this.closeOnBackdropClick=!0}render(){return Je`
      <div class="container">
    ...
    `}getMode(){return this.mode}closeModal(){this.mode=_t.Closed,this.customModalContent=void 0,this.modalTemplate.config=new go}callUserClosedModalCallback(){const e=this.userClosedModalCallback;this.userClosedModalCallback=void 0,e&&e()}showModal(e){return Ml(this,void 0,void 0,function*(){this.closeOnBackdropClick=e.config.closeOnBackdropClick,this.userClosedModalCallback=e.userClosedModalCallback,this.modalTemplate.config=e.config,this.customModalContent=e.customModalContent,this.mode=_t.Open,yield this.modalTemplate.updateComplete,this.modalTemplate.focus()})}updated(e){e.has("mode")&&this.handleModeChange()}backdropClicked(){this.closeOnBackdropClick&&(this.closeModal(),this.callUserClosedModalCallback())}handleModeChange(){this.hostBridge.handleModeChange(this.mode),this.emitModeChangeEvent()}emitModeChangeEvent(){const e=new CustomEvent("modeChanged",{detail:{mode:this.mode}});this.dispatchEvent(e)}closeButtonPressed(){this.closeModal(),this.callUserClosedModalCallback()}static get styles(){const e=Z`var(--modalBackdropColor, rgba(10, 10, 10, 0.9))`,t=Z`var(--modalBackdropZindex, 1000)`,i=Z`var(--modalWidth, 32rem)`,o=Z`var(--modalMaxWidth, 95%)`,r=Z`var(--modalZindex, 2000)`;return Z`
      .container {
        width: 100%;
        height: 100%;
      }
    ...
    `}};n([Mo({type:String,reflect:!0})],Zt.prototype,"mode",void 0);n([Mo({type:Object})],Zt.prototype,"customModalContent",void 0);n([Mo({type:Object})],Zt.prototype,"hostBridge",void 0);n([rh("modal-template")],Zt.prototype,"modalTemplate",void 0);Zt=n([hl("modal-manager")],Zt);var hh=h`
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path
...
`;let Jt=class extends F{constructor(){super(...arguments),this.step=2,this.currentPage=1,this.pages=[]}firstUpdated(){this.observePageCount()}updated(e){e.has("size")&&this.observePageCount(),e.has("currentPage")&&(this.observePageCount(),this.emitPageClick())}observePageCount(){this.pages=[];const e=7,t=this.size<=e;if(this.size<=5){this.pages=[...Array(this.size).keys()].map(r=>r+1);return}if(this.size===e){if(this.currentPage===2){this.pages=[1,2,3,4,0,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,4,5,this.size-1,this.size];return}}if(this.currentPage===1){this.pages=[1,2,3,0,this.size];return}if(this.currentPage===this.size){this.pages=[1,0,this.size-2,this.size-1,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,this.size-3,this.size-2,this.size-1,this.size];return}if(t&&this.currentPage>1&&this.currentPage<e){this.pages=[...Array(this.size).keys()].map(r=>r+1);return}let i=this.currentPage-this.step,o=this.currentPage+this.step;i<=0&&(o+=-i+1,i=1),o>=this.size&&(i=Math.max(i-(o-this.size),1),o=this.size),i===2&&(o-=1),o===this.size-1&&(i+=1),this.createFirstNode(i),this.createMiddelNode(i,o),this.createLastNode(o)}createFirstNode(e){var t,i;e>1&&((t=this.pages)===null||t===void 0||t.push(1)),e>2&&((i=this.pages)===null||i===void 0||i.push(0))}createMiddelNode(e,t){var i;for(let o=e;o<=t;o+=1)(i=this.pages)===null||i===void 0||i.push(o)}createLastNode(e){var t,i;e<this.size-1&&((t=this.pages)===null||t===void 0||t.push(0)),e<this.size&&((i=this.pages)===null||i===void 0||i.push(this.size))}get getEllipsisTemplate(){return h`<i class="ellipses">...</i>`}emitPageClick(){this.dispatchEvent(new CustomEvent("pageNumberClicked",{detail:{page:this.currentPage},bubbles:!0,composed:!0}))}onRewind(){this.currentPage-=1,this.currentPage<1&&(this.currentPage=1)}onForward(){this.currentPage+=1,this.currentPage>this.size&&(this.currentPage=this.size)}onChange(e){this.currentPage=e}getPageTemplate(e){return h`
    ...
    `}static get styles(){return[Ye,b`
      ...
      `]}};n([p({type:Number})],Jt.prototype,"size",void 0);n([p({type:Number})],Jt.prototype,"step",void 0);n([p({type:Number})],Jt.prototype,"currentPage",void 0);n([z()],Jt.prototype,"pages",void 0);Jt=n([D("more-facets-pagination")],Jt);var vh=I`
...
`,nr;let zi=nr=class extends F{render(){return h`${this.facetRowTemplate}`}get facetRowTemplate(){var e,t,i,o;const{bucket:r,facetType:s}=this;if(!r||!s)return y;const l=`${s}:${r.key}-show-only`,d=`${s}:${r.key}-negative`,c=s!=="collection"?h`${(e=r.displayText)!==null&&e!==void 0?e:r.key}`:h`<a href="/details/${r.key}">
            ${(i=(t=this.collectionTitles)===null||t===void 0?void 0:t.get(r.key))!==null&&i!==void 0?i:r.key}
          </a> `,u=r.state==="hidden",v=r.state==="selected",m=`${s}: ${(o=r.displayText)!==null&&o!==void 0?o:r.key}`,w=v?`Show all ${s}s`:`Only show ${m}`,$=`Hide ${m}`,x=`Unhide ${m}`,P=u?x:$,R=`${m}, ${r.count} results`;return h`
      <div class="facet-row-container">
        <div class="facet-checkboxes">
          ...
          <label
            ...
            data-testid=${d}
          >
            <span class="eye">${vh}</span>
            <span class="eye-closed">${fh}</span>
          </label>
        </div>
        <label
          for=${l}
    ...
    `}facetClicked(e,t){const{bucket:i,facetType:o}=this;if(!i||!o)return;const r=e.target,{checked:s}=r;this.bucket=oe(j({},i),{state:nr.getFacetState(s,t)}),this.dispatchFacetClickEvent({facetType:o,bucket:this.bucket,negative:t})}dispatchFacetClickEvent(e){const t=new CustomEvent("facetClick",{detail:e});this.dispatchEvent(t)}static getFacetState(e,t){let i;return e?i=t?"hidden":"selected":i="none",i}static get styles(){const e=b`var(--facet-row-border-top, 1px solid transparent)`,t=b`var(--facet-row-border-bottom, 1px solid transparent)`;return b`
    ...
    `}};n([p({type:String})],zi.prototype,"facetType",void 0);n([p({type:Object})],zi.prototype,"bucket",void 0);n([p({type:Object})],zi.prototype,"collectionTitles",void 0);zi=nr=n([D("facet-row")],zi);let wo=class extends F{facetClicked(e){this.dispatchFacetClickEvent(e.detail)}dispatchFacetClickEvent(e){const t=new CustomEvent("facetClick",{detail:e,composed:!0});this.dispatchEvent(t)}get facetsTemplate(){const{facetGroup:e}=this;if(!e)return y;const t=e.buckets;return h`
    ...
    `}};n([p({type:Object})],wo.prototype,"facetGroup",void 0);n([p({type:Object})],wo.prototype,"collectionTitles",void 0);wo=n([D("facets-template")],wo);let rt=class extends F{constructor(){super(...arguments),this.leftValue="",this.rightValue="",this.side="left"}render(){var e,t;return h`
      <div id="container">
    ...
    `}get value(){return this.side==="left"?this.leftValue:this.rightValue}get selectedLabel(){var e,t;return this.side==="left"?(e=this.leftLabel)!==null&&e!==void 0?e:this.leftValue:(t=this.rightLabel)!==null&&t!==void 0?t:this.rightValue}handleClick(){this.side=this.side==="left"?"right":"left",this.emitChangeEvent()}handleRadioChange(){this.side=this.leftRadio.checked?"left":"right",this.emitChangeEvent()}emitChangeEvent(){const e=new CustomEvent("change",{detail:this.value});this.dispatchEvent(e)}static get styles(){const e=b`var(--switchWidth, 30px)`,t=b`var(--switchHeight, 14px)`,i=b`var(--switchMarginLeft, 5px)`,o=b`var(--switchMarginRight, 5px)`,r=b`var(--switchBorderWidth, 3px)`,s=b`var(--switchBgColor, #194880)`,l=b`var(--switchBorderColor, #194880)`,d=b`var(--labelFontSize, 1.3rem)`,c=b`var(--knobColor, white)`,u=b`var(--knobTransitionDuration, 0.25s)`,v=b`var(--knobTransitionFn, ease)`;return[Ye,b`
      ...
      `]}};n([p({type:String,attribute:!0})],rt.prototype,"leftValue",void 0);n([p({type:String,attribute:!0})],rt.prototype,"leftLabel",void 0);n([p({type:String,attribute:!0})],rt.prototype,"rightValue",void 0);n([p({type:String,attribute:!0})],rt.prototype,"rightLabel",void 0);n([p({type:String,attribute:!0})],rt.prototype,"side",void 0);n([ee("#switch-left")],rt.prototype,"leftRadio",void 0);rt=n([D("toggle-switch")],rt);function lr(a,e){if(!!a)for(const[t,i]of Object.entries(a))for(const[o,r]of Object.entries(i))e(t,o,r,a)}function _o(a,e,t,i=!1){const o=a!=null?a:Ke(),r=oe(j({},o),{[e]:oe(j({},o[e]),{[t.key]:t})});return i&&t.state==="none"&&delete r[e][t.key],r}function mh(a){const e=Ke();return lr(a,(t,i,o)=>{e[t][i]=o}),e}function gh(a,e){const t=mh(a);return lr(e,(i,o,r)=>{t[i][o]=r}),lr(t,(i,o,r)=>{r.state==="none"&&delete t[i][o]}),t}const un=["selected","hidden","none"];function pl(a,e=G.COUNT){return a.sort((t,i)=>{const o=un.indexOf(t.state),r=un.indexOf(i.state),s=o-r;let l;return e===G.ALPHABETICAL?l=t.key.localeCompare(i.key):e===G.NUMERIC?l=Number(i.key)-Number(t.key):l=i.count-t.count,s||l})}let pe=class extends F{constructor(){super(...arguments),this.facetsPerPage=35,this.facetsLoading=!0,this.sortedBy=G.COUNT,this.unappliedFacetChanges=Ke(),this.pageNumber=1}willUpdate(e){(e.has("aggregations")||e.has("facetsPerPage")||e.has("sortedBy")||e.has("selectedFacets")||e.has("unappliedFacetChanges"))&&(this.facetGroup=this.mergedFacets)}updated(e){(e.has("facetKey")||e.has("query")||e.has("searchType")||e.has("filterMap"))&&(this.facetsLoading=!0,this.pageNumber=1,this.sortedBy=lo[this.facetKey],this.updateSpecificFacets())}firstUpdated(){this.setupEscapeListeners()}setupEscapeListeners(){this.modalManager?document.addEventListener("keydown",e=>{var t;e.key==="Escape"&&((t=this.modalManager)===null||t===void 0||t.closeModal())}):document.removeEventListener("keydown",()=>{})}get isSearchResultsPage(){var e;const t=(e=this.pageSpecifierParams)===null||e===void 0?void 0:e.pageType;return t===void 0||t==="search_results"}async updateSpecificFacets(){var e,t,i,o,r,s;if(!this.facetKey)return;const l=(e=this.query)===null||e===void 0?void 0:e.trim();if(!l&&this.isSearchResultsPage)return;const d={simpleParams:[this.facetKey]},c=65535,u=oe(j({},this.pageSpecifierParams),{query:l||"",filters:this.filterMap,aggregations:d,aggregationsSize:c,rows:0}),v=await((t=this.searchService)===null||t===void 0?void 0:t.search(u,this.searchType));this.aggregations=(i=v==null?void 0:v.success)===null||i===void 0?void 0:i.response.aggregations,this.facetsLoading=!1;const m=(r=(o=v==null?void 0:v.success)===null||o===void 0?void 0:o.response)===null||r===void 0?void 0:r.collectionTitles;if(m)for(const[w,$]of Object.entries(m))(s=this.collectionTitles)===null||s===void 0||s.set(w,$)}pageNumberClicked(e){var t,i;const o=(t=e==null?void 0:e.detail)===null||t===void 0?void 0:t.page;o&&(this.pageNumber=Number(o)),(i=this.analyticsHandler)===null||i===void 0||i.sendEvent({category:Be.default,action:te.moreFacetsPageChange,label:`${this.pageNumber}`})}get mergedFacets(){var e;if(!this.facetKey||!this.selectedFacets)return;const{selectedFacetGroup:t,aggregationFacetGroup:i}=this;if(!i)return;const o=j({},t!=null?t:i),r=(e=t==null?void 0:t.buckets.map(l=>{const d=i.buckets.find(c=>c.key===l.key);return d?oe(j({},l),{count:d.count}):l}))!==null&&e!==void 0?e:[];pl(r,this.sortedBy),i.buckets.forEach(l=>{t!=null&&t.buckets.find(c=>c.key===l.key)||r.push(l)});const s=this.unappliedFacetChanges[this.facetKey];for(const[l,d]of r.entries()){const c=s[d.key];c&&(r[l]=j({},c))}return o.buckets=r,o}get selectedFacetGroup(){if(!this.selectedFacets||!this.facetKey)return;const e=this.selectedFacets[this.facetKey];if(!e)return;const t=no[this.facetKey],i=Object.entries(e).map(([o,r])=>({displayText:o,key:o,count:r==null?void 0:r.count,state:r==null?void 0:r.state}));return{title:t,key:this.facetKey,buckets:i}}get aggregationFacetGroup(){if(!this.aggregations||!this.facetKey)return;const e=this.aggregations[this.facetKey];if(!e)return;const t=no[this.facetKey];let i=e.getSortedBuckets(this.sortedBy);this.facetKey==="collection"&&(i=i==null?void 0:i.filter(r=>{var s;const l=(s=r==null?void 0:r.key)===null||s===void 0?void 0:s.toString();return!Co[l]&&!(l!=null&&l.startsWith("fav-"))}));const o=i.map(r=>{const s=`${r.key}`;return{displayText:`${s}`,key:`${s}`,count:r.doc_count,state:"none"}});return{title:t,key:this.facetKey,buckets:o}}get facetGroupForCurrentPage(){const{facetGroup:e}=this;if(!e)return;const t=(this.pageNumber-1)*this.facetsPerPage,i=e.buckets.slice(t,t+this.facetsPerPage);return oe(j({},e),{buckets:i})}get moreFacetsTemplate(){return h`
      <facets-template
    ...
    `}get loaderTemplate(){return h`<div class="facets-loader">
      <ia-activity-indicator .mode=${"processing"}></ia-activity-indicator>
        ...
        </div> `:y}sortFacetAggregation(e){this.sortedBy=e,this.dispatchEvent(new CustomEvent("sortedFacets",{detail:this.sortedBy}))}get modalHeaderTemplate(){var e,t,i;const r=((e=this.sortedBy)!==null&&e!==void 0?e:lo[this.facetKey])===G.COUNT?"left":"right";return h`<span class="sr-only">${M("More facets for:")}</span>
      <span class="title">
      ...
      ${this.facetsLoading?this.loaderTemplate:h`
          ...
          `}
    `}applySearchFacetsClicked(){var e,t;const i=gh(this.selectedFacets,this.unappliedFacetChanges),o=new CustomEvent("facetsChanged",{detail:i,bubbles:!0,composed:!0});this.dispatchEvent(o),this.unappliedFacetChanges=Ke(),(e=this.modalManager)===null||e===void 0||e.closeModal(),(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:Be.default,action:`${te.applyMoreFacetsModal}`,label:`${this.facetKey}`})}cancelClick(){var e,t;this.unappliedFacetChanges=Ke(),(e=this.modalManager)===null||e===void 0||e.closeModal(),(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:Be.default,action:te.closeMoreFacetsModal,label:`${this.facetKey}`})}static get styles(){const e=b`var(--primaryButtonBGColor, #194880)`;return[Ye,b`
        section#more-facets {
          overflow: auto;
      ...
      `]}};n([p({type:String})],pe.prototype,"facetKey",void 0);n([p({type:String})],pe.prototype,"query",void 0);n([p({type:Object})],pe.prototype,"filterMap",void 0);n([p({type:String})],pe.prototype,"searchType",void 0);n([p({type:Object})],pe.prototype,"pageSpecifierParams",void 0);n([p({type:Object})],pe.prototype,"collectionTitles",void 0);n([p({type:Number})],pe.prototype,"facetsPerPage",void 0);n([p({type:Boolean})],pe.prototype,"facetsLoading",void 0);n([p({type:Object})],pe.prototype,"selectedFacets",void 0);n([p({type:String})],pe.prototype,"sortedBy",void 0);n([p({type:Object})],pe.prototype,"modalManager",void 0);n([p({type:Object})],pe.prototype,"searchService",void 0);n([p({type:Object,attribute:!1})],pe.prototype,"analyticsHandler",void 0);n([z()],pe.prototype,"aggregations",void 0);n([z()],pe.prototype,"facetGroup",void 0);n([z()],pe.prototype,"unappliedFacetChanges",void 0);n([z()],pe.prototype,"pageNumber",void 0);pe=n([D("more-facets-content")],pe);let vn=class extends F{render(){return h`
      <div id="row">
    ...
    `}};vn=n([D("facet-tombstone-row")],vn);let Ne=class extends F{constructor(){super(...arguments),this.boundEscapeListener=e=>{e.key==="Escape"&&this.closeModal()}}render(){var e,t;return h`
      <div id="container">
    ...
    `}};n([p({type:String})],Ne.prototype,"minDate",void 0);n([p({type:String})],Ne.prototype,"maxDate",void 0);n([p({type:String})],Ne.prototype,"minSelectedDate",void 0);n([p({type:String})],Ne.prototype,"maxSelectedDate",void 0);n([p({type:Array})],Ne.prototype,"buckets",void 0);n([p({type:Object,attribute:!1})],Ne.prototype,"modalManager",void 0);n([p({type:Object,attribute:!1})],Ne.prototype,"analyticsHandler",void 0);Ne=n([D("expanded-date-picker")],Ne);let H=class extends F{constructor(){super(...arguments),this.moreLinksVisible=!0,this.facetsLoading=!1,this.fullYearAggregationLoading=!1,this.collapsableFacets=!1,this.showHistogramDatePicker=!1,this.allowExpandingDatePicker=!1,this.parentCollections=[],this.collectionPagePath="/details/",this.isManageView=!1,this.openFacets={subject:!1,lending:!1,mediatype:!1,language:!1,creator:!1,collection:!1,year:!1},this.allowedFacetCount=6,this.handleExpandedDatePickerClosed=()=>{var e;(e=this.modalManager)===null||e===void 0||e.classList.remove("expanded-date-picker")},this.histogramDateRangeUpdated=e=>{const{minDate:t,maxDate:i}=e.detail,o=new CustomEvent("histogramDateRangeUpdated",{detail:{minDate:t,maxDate:i}});this.dispatchEvent(o)}}render(){const e=Ht({loading:this.facetsLoading,managing:this.isManageView}),t="date-picker-label";return h`
    ...
    `}get collectionPartOfTemplate(){var e;if(!(!((e=this.parentCollections)===null||e===void 0)&&e.length))return y;const t="partof-heading";return h`
      ...
      >
        ...
        <ul>
          ${Bt(this.parentCollections,i=>{var o,r;const s=`${this.baseNavigationUrl}${this.collectionPagePath}${i}`;return h` <li>
              <a
                href=${s}
                data-id=${i}
    ...
    `}partOfCollectionClicked(e){var t;(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:Be.default,action:te.partOfCollectionClicked,label:e.target.dataset.id})}showDatePickerModal(){var e,t,i;const{fullYearsHistogramAggregation:o}=this,r=o==null?void 0:o.first_bucket_key,s=o==null?void 0:o.last_bucket_key,l=o==null?void 0:o.buckets,c=h`
      <expanded-date-picker
        ${m0(v=>{if(v&&v instanceof Ne){const m=v;m.minSelectedDate=this.minSelectedDate,m.maxSelectedDate=this.maxSelectedDate}})}
        .minDate=${r}
        .maxDate=${s}
      ...
      ></expanded-date-picker>
    `,u=new go({bodyColor:"#fff",headerColor:"#194880",showHeaderLogo:!1,closeOnBackdropClick:!0,title:h`Select a date range`});(e=this.modalManager)===null||e===void 0||e.classList.add("expanded-date-picker"),(t=this.modalManager)===null||t===void 0||t.showModal({config:u,customModalContent:c,userClosedModalCallback:this.handleExpandedDatePickerClosed}),(i=this.analyticsHandler)===null||i===void 0||i.sendEvent({category:Be.default,action:te.histogramExpanded,label:window.location.href})}updated(e){e.has("selectedFacets")&&this.dispatchFacetsChangedEvent()}dispatchFacetsChangedEvent(){const e=new CustomEvent("facetsChanged",{detail:this.selectedFacets});this.dispatchEvent(e)}get expandDatePickerBtnTemplate(){return this.allowExpandingDatePicker&&!this.facetsLoading?h`<button
          class="expand-date-picker-btn"
          aria-hidden="true"
          @click=${this.showDatePickerModal}
        >
          ${hh}
        </button>`:y}get histogramTemplate(){var e,t;const{fullYearsHistogramAggregation:i}=this,o=i==null?void 0:i.first_bucket_key,r=i==null?void 0:i.last_bucket_key;return this.fullYearAggregationLoading?h`<div class="histogram-loading-indicator">&hellip;</div>`:h`
          <histogram-date-range
            .minDate=${o}
            .maxDate=${r}
            ...
            @histogramDateRangeUpdated=${this.histogramDateRangeUpdated}
          ></histogram-date-range>
        `}get mergedFacets(){const e=[];return gd.forEach(t=>{var i,o;const r=this.selectedFacetGroups.find(u=>u.key===t),s=this.aggregationFacetGroups.find(u=>u.key===t);if(r&&!s){e.push(r);return}if(!s)return;const l=r!=null?r:s;let d=(i=r==null?void 0:r.buckets.map(u=>{const v=s.buckets.find(m=>m.key===u.key);return v?oe(j({},u),{count:v.count}):u}))!==null&&i!==void 0?i:[];s.buckets.forEach(u=>{d.find(m=>m.key===u.key)||d.push(u)});let c=(o=Object.keys((r==null?void 0:r.buckets)||[]))===null||o===void 0?void 0:o.length;if(c<this.allowedFacetCount&&(c=this.allowedFacetCount),t==="lending"&&(d=d.filter(u=>bd[u.key])),pl(d),t==="mediatype"){const u=d.findIndex(v=>v.key==="collection");if(u>=c){const[v]=d.splice(u,1);c>this.allowedFacetCount&&(c+=1),d.splice(c-1,0,v)}}l.buckets=d.slice(0,c),e.push(l)}),e}get selectedFacetGroups(){return this.selectedFacets?Object.entries(this.selectedFacets).map(([t,i])=>{const o=t,r=no[o],s=Object.entries(i).map(([l,d])=>{var c;let u=l;return o==="lending"&&(u=(c=cs[l])!==null&&c!==void 0?c:l),{displayText:u,key:l,count:d.count,state:d.state}});return{title:r,key:o,buckets:s}}):[]}get aggregationFacetGroups(){var e;const t=[];return Object.entries((e=this.aggregations)!==null&&e!==void 0?e:[]).forEach(([i,o])=>{if(i==="year_histogram")return;const r=i,s=no[r];if(!s)return;let l=o.getSortedBuckets(lo[r]);r==="collection"&&(l=l==null?void 0:l.filter(u=>{var v;const m=(v=u==null?void 0:u.key)===null||v===void 0?void 0:v.toString();return!Co[m]&&!(m!=null&&m.startsWith("fav-"))}));const d=l.map(u=>{var v;const m=u.key;let w=`${u.key}`;return r==="lending"&&(w=(v=cs[u.key])!==null&&v!==void 0?v:`${u.key}`),{displayText:w,key:`${m}`,count:u.doc_count,state:"none"}}),c={title:s,key:r,buckets:d};t.push(c)}),t}getFacetGroupTemplate(e){if(!this.facetsLoading&&e.buckets.length===0)return y;const{key:t}=e,i=this.openFacets[t],o=h`
      <span class="collapser ${i?"open":""}"> ${Ba} </span>
    ...
    `}searchMoreFacetsLink(e){if(!this.moreLinksVisible||e.key==="lending"||Object.keys(e.buckets).length<this.allowedFacetCount)return y;const t=lo[e.key];return h`<button
      class="more-link"
      @click=${()=>{var i;this.showMoreFacetsModal(e,t),(i=this.analyticsHandler)===null||i===void 0||i.sendEvent({category:Be.default,action:te.showMoreFacetsModal,label:e.key}),this.dispatchEvent(new CustomEvent("showMoreFacets",{detail:e.key}))}}
    ...
    `}};fn=n([D("circular-activity-indicator")],fn);function yh(a,e){return a===void 0?e!==void 0:e===void 0?a!==void 0:a.facetType===e.facetType&&a.bucketKey===e.bucketKey}function dr(a,e){return a.label===e.label&&a.facets.length===e.facets.length&&a.facets.every((t,i)=>yh(t,e.facets[i]))}function ul(a){if(!Array.isArray(a[0])){const i=a;let o=[...i];for(const r of i)o=o.filter(s=>r===s||!dr(r,s));return o}const e=a,t=[];for(const i of e){const o=[];for(const r of i)t.find(l=>l.find(d=>dr(r,d)))||o.push(r);o.length>0&&t.push(o)}return t}class kr{async getRecommendedFacets(){const e=navigator.language,t=kr.getLanguageDisplayName(e);return t?[{facets:[{facetType:"language",bucketKey:t}]}]:[]}static getLanguageDisplayName(e){const t=e.split("-")[0];return new Intl.DisplayNames(["en"],{type:"language"}).of(t)}}class Ao{async getRecommendedFacets(e){const t=[];for(const[i,o]of Object.entries(Ao.KEYWORDS))e.includes(i)&&t.push(...o);return t}}Ao.KEYWORDS={text:[{facets:[{facetType:"mediatype",bucketKey:"texts"}]}],book:[{facets:[{facetType:"mediatype",bucketKey:"texts"}]}],pdf:[{facets:[{facetType:"mediatype",bucketKey:"texts"}]}],epub:[{facets:[{facetType:"mediatype",bucketKey:"texts"}]}],audio:[{facets:[{facetType:"mediatype",bucketKey:"audio"}]}],song:[{facets:[{facetType:"mediatype",bucketKey:"audio"}]}],music:[{facets:[{facetType:"mediatype",bucketKey:"audio"}]}],listen:[{facets:[{facetType:"mediatype",bucketKey:"audio"}]}],podcast:[{facets:[{facetType:"mediatype",bucketKey:"audio"}]}],radio:[{facets:[{facetType:"mediatype",bucketKey:"audio"}]}],stream:[{facets:[{facetType:"mediatype",bucketKey:"audio"}]},{facets:[{facetType:"mediatype",bucketKey:"movies"}]}],video:[{facets:[{facetType:"mediatype",bucketKey:"movies"}]}],movie:[{facets:[{facetType:"mediatype",bucketKey:"movies"}]}],film:[{facets:[{facetType:"mediatype",bucketKey:"movies"}]}],image:[{facets:[{facetType:"mediatype",bucketKey:"image"}]}],photo:[{facets:[{facetType:"mediatype",bucketKey:"image"}]}],picture:[{facets:[{facetType:"mediatype",bucketKey:"image"}]}],software:[{facets:[{facetType:"mediatype",bucketKey:"software"}]}],app:[{facets:[{facetType:"mediatype",bucketKey:"software"}]}],program:[{facets:[{facetType:"mediatype",bucketKey:"software"}]}],game:[{facets:[{facetType:"mediatype",bucketKey:"software"}]}],etree:[{facets:[{facetType:"mediatype",bucketKey:"etree"}]}],concert:[{facets:[{facetType:"mediatype",bucketKey:"etree"}]}],"live music":[{facets:[{facetType:"mediatype",bucketKey:"etree"}]}],dataset:[{facets:[{facetType:"mediatype",bucketKey:"data"}]}]};class zo{async getRecommendedFacets(e){var t;const i=[];try{const o=encodeURIComponent(e),s=await(await fetch(`https://www.wikidata.org/w/api.php?action=wbsearchentities&search=${o}&format=json&language=en&uselang=en&origin=*&type=item&limit=5`)).json();for(const[l,d]of Object.entries(zo.ENTITIES))if(new RegExp(`\\b${l}\\b`).test((t=s.search[0])===null||t===void 0?void 0:t.description)){const u=s.search[0].label;i.push(...d.map(v=>{var m;return{label:(m=v.label)===null||m===void 0?void 0:m.replace("__QUERY",u),facets:v.facets.map(w=>{var $;const x=oe(j({},w),{bucketKey:w.bucketKey.replace("__QUERY",e)});return w.displayText&&(x.displayText=($=x.displayText)===null||$===void 0?void 0:$.replace("__QUERY",u)),x})}}))}return i}catch{return[]}}}zo.ENTITIES={"written work":[{facets:[{facetType:"mediatype",bucketKey:"texts"}]}],literature:[{facets:[{facetType:"mediatype",bucketKey:"texts"}]}],book:[{facets:[{facetType:"mediatype",bucketKey:"texts"}]}],novel:[{facets:[{facetType:"mediatype",bucketKey:"texts"}]}],filmmaker:[{label:"Films by __QUERY",facets:[{facetType:"mediatype",bucketKey:"movies"},{facetType:"creator",bucketKey:"__QUERY"}]}],author:[{label:"Writing by __QUERY",facets:[{facetType:"mediatype",bucketKey:"texts"},{facetType:"creator",bucketKey:"__QUERY"}]}],writer:[{label:"Writing by __QUERY",facets:[{facetType:"mediatype",bucketKey:"texts"},{facetType:"creator",bucketKey:"__QUERY"}]}],poet:[{label:"Writing by __QUERY",facets:[{facetType:"mediatype",bucketKey:"texts"},{facetType:"creator",bucketKey:"__QUERY"}]}],photographer:[{label:"Images by __QUERY",facets:[{facetType:"mediatype",bucketKey:"image"},{facetType:"creator",bucketKey:"__QUERY"}]}],painter:[{label:"Images by __QUERY",facets:[{facetType:"mediatype",bucketKey:"image"},{facetType:"creator",bucketKey:"__QUERY"}]}],"visual artist":[{label:"Images by __QUERY",facets:[{facetType:"mediatype",bucketKey:"image"},{facetType:"creator",bucketKey:"__QUERY"}]}],"graphic artist":[{label:"Images by __QUERY",facets:[{facetType:"mediatype",bucketKey:"image"},{facetType:"creator",bucketKey:"__QUERY"}]}],singer:[{label:"Music by __QUERY",facets:[{facetType:"mediatype",bucketKey:"audio"},{facetType:"creator",bucketKey:"__QUERY"}]}],songwriter:[{label:"Music by __QUERY",facets:[{facetType:"mediatype",bucketKey:"audio"},{facetType:"creator",bucketKey:"__QUERY"}]}],musician:[{label:"Music by __QUERY",facets:[{facetType:"mediatype",bucketKey:"audio"},{facetType:"creator",bucketKey:"__QUERY"}]}],composer:[{label:"Music by __QUERY",facets:[{facetType:"mediatype",bucketKey:"audio"},{facetType:"creator",bucketKey:"__QUERY"}]}],pianist:[{label:"Music by __QUERY",facets:[{facetType:"mediatype",bucketKey:"audio"},{facetType:"creator",bucketKey:"__QUERY"}]}]};class Po{async getRecommendedFacets(e){const t=Po.HEURISTICS.map(i=>new i().getRecommendedFacets(e));return ul((await Promise.all(t)).flat())}}Po.HEURISTICS=[Ao,zo,kr];var bh=h`
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path
...
`;function wh(a){return a&&a.charAt(0).toLocaleUpperCase()+a.slice(1)}let Pi=class extends F{constructor(){super(...arguments),this.selected=!1}render(){var e,t;if(!this.facetInfo)return y;const i=this.facetInfo.facets.length===1,o=this.facetInfo.facets[0],r=wh((this.labelPrefix?`${this.labelPrefix} `:"")+((t=(e=this.facetInfo.label)!==null&&e!==void 0?e:o.displayText)!==null&&t!==void 0?t:o.bucketKey));if(!r)return y;const s=i&&o.facetType==="mediatype"?Hn[o.bucketKey].icon:y;return h`
      <a
    ...
    `}};n([p({type:Object})],Pi.prototype,"facetInfo",void 0);n([p({type:String})],Pi.prototype,"labelPrefix",void 0);n([p({type:Boolean})],Pi.prototype,"selected",void 0);Pi=n([D("smart-facet-button")],Pi);let ei=class extends F{render(){var e,t;if(!this.facetInfo||!this.activeFacetRef||this.facetInfo.length===0)return y;const i=(e=this.activeFacetRef.displayText)!==null&&e!==void 0?e:this.activeFacetRef.bucketKey;return i?h`
    ...
    `:y}get dropdownOptions(){var e,t;return(t=(e=this.facetInfo)===null||e===void 0?void 0:e.map(i=>{var o,r;const s=i.facets[0];return{id:s.bucketKey,label:(r=(o=i.label)!==null&&o!==void 0?o:s.displayText)!==null&&r!==void 0?r:s.bucketKey}}))!==null&&t!==void 0?t:[]}get activeDropdownOption(){if(!!this.activeFacetRef)return this.dropdownOptions.find(e=>{var t;return e.id===((t=this.activeFacetRef)===null||t===void 0?void 0:t.bucketKey)})}optionSelected(e){if(!this.facetInfo||!this.activeFacetRef)return;let t;for(const i of this.facetInfo){const o=i.facets.find(r=>r.bucketKey===e.detail.option.id);o&&(this.activeFacetRef=o,t=i)}!t||this.dispatchEvent(new CustomEvent("facetClick",{detail:{smartFacet:t,details:[{facetType:this.activeFacetRef.facetType,bucket:{key:this.activeFacetRef.bucketKey,count:0,state:"selected"},negative:!1}]}}))}static get styles(){return b`
      .dropdown-container {
        padding: 5px 8px;
        border-radius: 5px;
        background: #194880;
    ...
    `}};n([p({type:Array})],ei.prototype,"facetInfo",void 0);n([p({type:String})],ei.prototype,"labelPrefix",void 0);n([p({type:Object})],ei.prototype,"activeFacetRef",void 0);n([ee("ia-dropdown")],ei.prototype,"dropdown",void 0);ei=n([D("smart-facet-dropdown")],ei);const mn={collection:"Collection: ",creator:"By: ",subject:"About: "};function _h(a){return a.charAt(0).toUpperCase()+a.slice(1)}let He=class extends F{constructor(){super(...arguments),this.filterToggleActive=!1,this.heuristicRecs=[],this.smartFacets=[]}render(){return h`
      <div id="smart-facets-container">
        ${this.filtersToggleTemplate}
        ${vr(this.smartFacets,e=>`${e[0].label}|${e[0].facets[0].facetType}|${e[0].facets[0].bucketKey}`,e=>this.makeSmartFacet(e))}
      </div>
    `}willUpdate(e){e.has("query")&&(this.updateSmartFacets(),this.lastAggregations=void 0),e.has("aggregations")&&!this.lastAggregations&&this.aggregations&&Object.keys(this.aggregations).length>0&&(this.lastAggregations=this.aggregations)}async updateSmartFacets(){console.log("updating smart facets"),this.query&&(this.heuristicRecs=await new Po().getRecommendedFacets(this.query),this.smartFacets=ul(this.facetsToDisplay))}makeSmartFacet(e){return e.length===0?y:e.length===1?this.smartFacetButton(e[0]):this.smartFacetDropdown(e)}smartFacetButton(e){var t;return h`
      <smart-facet-button
        .facetInfo=${e}
        .labelPrefix=${mn[e.facets[0].facetType]}
    ...
    `}smartFacetDropdown(e){return h`
      <smart-facet-dropdown
        .facetInfo=${e}
        .labelPrefix=${mn[e[0].facets[0].facetType]}
    ...
    `}get facetsToDisplay(){if(!this.lastAggregations)return[];const e=[];if(this.heuristicRecs.length>0)for(const i of this.heuristicRecs)e.push([i]);const t=["mediatype","year","language","creator","subject","collection"];for(const i of t){const o=this.lastAggregations[i];if(!o||o.buckets.length===0||["lending","year_histogram"].includes(i)||typeof o.buckets[0]=="number"||i==="mediatype"&&this.selectedFacets&&Object.values(this.selectedFacets.mediatype).some(d=>d.state!=="none"))continue;const r=i,l=o.buckets.filter(d=>{var c;const u=(c=this.selectedFacets)===null||c===void 0?void 0:c[r][d.key];return!(u&&u.state!=="none")});if(r==="mediatype")e.push([this.toSmartFacet(r,[l[0]])],[this.toSmartFacet(r,[l[1]])]);else if(r==="collection"||r==="subject"){const d=l.slice(0,5);e.push(d.map(c=>this.toSmartFacet(r,[c])))}else e.push([this.toSmartFacet(r,[l[0]])])}return e}toSmartFacet(e,t){return{facets:t.map(i=>{var o;let r=_h(i.key.toString());if(e==="collection"){const s=(o=this.collectionTitles)===null||o===void 0?void 0:o.get(i.key.toString());s&&(r=s)}return{facetType:e,bucketKey:i.key.toString(),displayText:r}})}}facetClicked(e){this.smartFacets=[[oe(j({},e.detail.smartFacet),{selected:!e.detail.smartFacet.selected})],...this.smartFacets.filter(i=>i[0]!==e.detail.smartFacet)];for(const i of e.detail.details)this.selectedFacets=_o(this.selectedFacets,i.facetType,i.bucket,!0);const t=new CustomEvent("facetsChanged",{detail:this.selectedFacets});this.dispatchEvent(t)}facetDropdownClicked(e){if(this.smartFacets.find(i=>dr(i[0],e.detail.smartFacet)))return;this.smartFacets=[[oe(j({},e.detail.smartFacet),{selected:!0})],...this.smartFacets];for(const i of e.detail.details)this.selectedFacets=_o(this.selectedFacets,i.facetType,i.bucket,!0);const t=new CustomEvent("facetsChanged",{detail:this.selectedFacets});this.dispatchEvent(t)}filterToggleClicked(){this.dispatchEvent(new CustomEvent("filtersToggled"))}static get styles(){return b`
    ...
    `}};n([p({type:String})],He.prototype,"query",void 0);n([p({type:Object})],He.prototype,"aggregations",void 0);n([p({type:Object})],He.prototype,"selectedFacets",void 0);n([p({type:Object})],He.prototype,"collectionTitles",void 0);n([p({type:Boolean})],He.prototype,"filterToggleActive",void 0);n([z()],He.prototype,"heuristicRecs",void 0);n([z()],He.prototype,"smartFacets",void 0);n([z()],He.prototype,"lastAggregations",void 0);He=n([D("smart-facet-bar")],He);let T=class extends F{constructor(){super(),this.baseImageUrl="https://archive.org",this.searchType=de.METADATA,this.selectedSort=S.default,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.sortDirection=null,this.defaultSortField=S.relevance,this.defaultSortDirection=null,this.pageSize=50,this.showSmartFacetBar=!1,this.showHistogramDatePicker=!1,this.suppressPlaceholders=!1,this.suppressResultCount=!1,this.suppressResultTiles=!1,this.suppressURLQuery=!1,this.suppressSortBar=!1,this.suppressDisplayModes=!1,this.facetLoadStrategy="eager",this.facetPaneVisible=!1,this.clearResultsOnEmptyQuery=!1,this.collectionPagePath="/details/",this.searchContext=Be.default,this.pageContext="search",this.restorationStateHandler=new Sd({context:this.pageContext}),this.mobileBreakpoint=600,this.loggedIn=!1,this.modalManager=void 0,this.isManageView=!1,this.manageViewLabel="Select items to remove",this.enableSortOptionsSlot=!1,this.showSmartResults=!1,this.dataSource=new kd(this,this.pageSize),this.initialPageNumber=1,this.pagesToRender=this.initialPageNumber,this.searchResultsLoading=!1,this.facetsLoading=!1,this.mobileView=!1,this.collapsibleFacetsVisible=!1,this.placeholderType=null,this.layoutSizeAnalyticsSent=!1,this.isScrollingToCell=!1,this.isResizeToMobile=!1,this.dataSourceInstallInProgress=!1,this.placeholderCellTemplate=h`<collection-browser-loading-tile></collection-browser-loading-tile>`,this.updateLeftColumnHeight=()=>{var e,t,i,o,r;if(this.mobileView)(t=(e=this.leftColumn)===null||e===void 0?void 0:e.style)===null||t===void 0||t.removeProperty("height");else{const s=(i=this.leftColumn)===null||i===void 0?void 0:i.getBoundingClientRect().top;(r=(o=this.leftColumn)===null||o===void 0?void 0:o.style)===null||r===void 0||r.setProperty("height",`${window.innerHeight-(s!=null?s:0)-3}px`)}},this.updateFacetFadeOut=e=>{var t,i;const o=(t=this.shadowRoot)===null||t===void 0?void 0:t.getElementById("facets-bottom-fade");o==null||o.classList.toggle("hidden",(i=e==null?void 0:e[0])===null||i===void 0?void 0:i.isIntersecting)},this.initialQueryChangeHappened=!1,this.historyPopOccurred=!1,this.addController(this.dataSource)}tileModelAtCellIndex(e){const t=this.dataSource.getTileModelAt(e);if(!t&&!this.isScrollingToCell&&this.dataSource.queryInitialized){const i=Math.floor(e/this.pageSize)+1;this.dataSource.fetchPage(i)}return t}get estimatedTileCount(){return this.pagesToRender*this.pageSize}async getSessionId(){try{const e=sessionStorage==null?void 0:sessionStorage.getItem("cb-session");if(e)return e;if(this.sessionIdGenPromise)return this.sessionIdGenPromise;this.sessionIdGenPromise=On(Math.random().toString());const t=await this.sessionIdGenPromise;return sessionStorage==null||sessionStorage.setItem("cb-session",t),t}catch{return""}}goToPage(e){return this.initialPageNumber=e,this.pagesToRender=e,this.scrollToPage(e)}setSearchResultsLoading(e){this.searchResultsLoading=e}setFacetsLoading(e){this.facetsLoading=e}setTotalResultCount(e){this.totalResults=e}clearFilters({facets:e=!0,dateRange:t=!0,letterFilters:i=!0,sort:o=!1}={}){e&&this.hasCheckedFacets&&(this.selectedFacets=Ke()),t&&(this.minSelectedDate=void 0,this.maxSelectedDate=void 0),i&&(this.selectedTitleFilter=null,this.selectedCreatorFilter=null),o&&(this.sortDirection=null,this.selectedSort=S.default)}get hasCheckedFacets(){if(!this.selectedFacets)return!1;for(const e of Object.values(this.selectedFacets))for(const t of Object.values(e))if(t.state!=="none")return!0;return!1}get hasActiveFilters(){return!!(this.hasCheckedFacets||this.minSelectedDate||this.maxSelectedDate||this.selectedTitleFilter||this.selectedCreatorFilter)}willUpdate(){this.setPlaceholderType()}render(){return h`
    ...
    </infinite-scroller>`}get infiniteScrollerClasses(){var e;return Ht({[(e=this.displayMode)!==null&&e!==void 0?e:""]:!!this.displayMode,hidden:!!this.placeholderType})}get sortFilterBarTemplate(){var e;return this.suppressSortBar?y:h`
      <sort-filter-bar
    ...
    `}get manageBarTemplate(){return h`
      ...
      ></manage-bar>
    `}handleRemoveItems(){this.dispatchEvent(new CustomEvent("itemRemovalRequested",{detail:{items:this.dataSource.checkedTileModels.map(e=>{const t=e.clone();return t.dateStr=Vt(e.datePublished,"long"),t})}}))}removeCheckedTiles(){this.dataSource.removeCheckedTiles()}userChangedSort(e){var t;const{selectedSort:i,sortDirection:o}=e.detail;this.selectedSort=i,this.sortDirection=o,((t=this.currentPage)!==null&&t!==void 0?t:1)>1&&this.goToPage(1),this.currentPage=1}sendSortByAnalytics(e){var t;const i=e&&!this.sortDirection;(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:this.searchContext,action:te.sortBy,label:`${this.selectedSort}${this.sortDirection||i?`-${this.sortDirection}`:""}`})}selectedSortChanged(){this.dataSource.updatePrefixFiltersForCurrentSort()}get sortParam(){var e;const t=we[this.selectedSort];if(!(t!=null&&t.handledBySearchService))return null;const i=new URL(window.location.href).searchParams.get("sort"),o=(e=t.searchServiceKey)!==null&&e!==void 0?e:i==null?void 0:i.replace(/^-/,"");return this.sortDirection||(this.sortDirection="asc"),o?{field:o,direction:this.sortDirection}:null}get defaultSortParam(){var e;const t=(e=this.defaultSortDirection)!==null&&e!==void 0?e:"asc",i=we[this.defaultSortField].searchServiceKey;return i?{field:i,direction:t}:null}displayModeChanged(e){var t;this.displayMode=e.detail.displayMode,this.displayMode&&((t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:this.searchContext,action:te.displayMode,label:this.displayMode}))}get titleQuery(){return this.selectedTitleFilter?`firstTitle:${this.selectedTitleFilter}`:void 0}get creatorQuery(){return this.selectedCreatorFilter?`firstCreator:${this.selectedCreatorFilter}`:void 0}sendFilterByTitleAnalytics(e){var t;if(!e&&!this.selectedTitleFilter)return;const i=e&&!this.selectedTitleFilter;(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:this.searchContext,action:te.filterByTitle,label:i?`clear-${e}`:`${e||"start"}-${this.selectedTitleFilter}`})}sendFilterByCreatorAnalytics(e){var t;if(!e&&!this.selectedCreatorFilter)return;const i=e&&!this.selectedCreatorFilter;(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:this.searchContext,action:te.filterByCreator,label:i?`clear-${e}`:`${e||"start"}-${this.selectedCreatorFilter}`})}titleLetterSelected(e){this.selectedCreatorFilter=null,this.selectedTitleFilter=e.detail.selectedLetter}creatorLetterSelected(e){this.selectedTitleFilter=null,this.selectedCreatorFilter=e.detail.selectedLetter}get mobileFacetsTemplate(){return Fa.includes(this.profileElement)?y:h`
      <details id="mobile-filter-collapse" @toggle=${t=>{var i;const o=t.target;this.isResizeToMobile=!1,this.collapsibleFacetsVisible=o.open,(i=this.analyticsHandler)===null||i===void 0||i.sendEvent({category:this.searchContext,action:te.mobileFacetsToggled,label:o.open?"open":"closed"})}}>
        <summary>
          <span class="collapser-icon">${Ba}</span>
          <h2>${M("Filters")}</h2>
          ${this.clearFiltersBtnTemplate(!0)}
        </summary>
        ${this.facetsTemplate}
      </details>
    `}get facetsTemplate(){if(Fa.includes(this.profileElement))return y;if(this.facetLoadStrategy==="off")return h`
    ...
    `;return(this.facetLoadStrategy==="opt-in"||this.facetLoadStrategy==="opt-in-or-login"&&!this.loggedIn)&&!this.mobileView?h`
      ...
      `:e}clearFiltersBtnTemplate(e){if(!this.hasActiveFilters)return y;const t=Ht({"clear-filters-btn":!0,mobile:e}),i=e?"Clear all":"Clear all filters";return h`
    ...
    `}scrollThresholdReached(){!this.dataSource.endOfDataReached&&this.dataSource.queryInitialized&&(this.pagesToRender+=1,this.dataSource.fetchPage(this.pagesToRender))}static get styles(){return[Ye,b`
        :host {
          display: block;
