...
`;var uo;(function(a){a[a.bytes=0]="bytes",a[a.kilobytes=1]="kilobytes",a[a.megabytes=2]="megabytes",a[a.gigabytes=3]="gigabytes",a[a.terabytes=4]="terabytes",a[a.petabytes=5]="petabytes",a[a.exabytes=6]="exabytes",a[a.zettabytes=7]="zettabytes",a[a.yottabytes=8]="yottabytes"})(uo||(uo={}));function Cs(a,e,t=" "){let i=a;if(i===void 0)return y;let o=0;for(;i>1024;)i/=1024,o+=1;const r=10**e;i=Math.round(i*r)/r;let l=uo[o];return l=i===1?l.slice(0,-1):l,`${i.toLocaleString()+t+l}`}const Je=m`
  .sr-only {
...
`;let Xt=class extends A{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1,this.isCompactTile=!1}render(){return h`<div class="icon-overlay ${this.getClass}">
    ...
    `}};s([c({type:String})],Ke.prototype,"baseImageUrl",void 0);s([c({type:Boolean})],Ke.prototype,"isCompactTile",void 0);s([c({type:Boolean})],Ke.prototype,"isListTile",void 0);s([c({type:Boolean})],Ke.prototype,"loggedIn",void 0);s([c({type:Object})],Ke.prototype,"model",void 0);s([c({type:String})],Ke.prototype,"viewSize",void 0);Ke=s([L("image-block")],Ke);let vo=class extends le{constructor(){super(...arguments),this.showInfoButton=!1}render(){return h`
      <div class="container">
    ...
    >`}get getSizeTemplate(){var e,t;const i=(t=(e=this.model)===null||e===void 0?void 0:e.collectionSize)!==null&&t!==void 0?t:0;return i?h`<span id="item-size">${Cs(i,1)}</span>`:""}get infoButtonTemplate(){return this.showInfoButton?h`<button class="info-button" @click=${this.infoButtonPressed}>
      ...
      `]}};s([c({type:Boolean})],vo.prototype,"showInfoButton",void 0);vo=s([L("collection-tile")],vo);function Jt(a,e="short",t="en-US"){if(!a)return"";const i={};switch(e){case"year-only":i.year="numeric";break;case"short":i.month="short",i.year="numeric";break;case"long":i.year="numeric",i.month="short",i.day="2-digit";break}return new Intl.DateTimeFormat(t,i).format(a)}function ks(a){return new Date(a.getTime()-a.getTimezoneOffset()*1e3*60)}function Bo(a){return a?ks(a).toISOString().endsWith("-01-01T00:00:00.000Z"):!1}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;function js(a,e){let t=1;return a>=1e9?t=1e9:a>=1e6?t=1e6:a>=1e3&&e==="short"&&(t=1e3),t}function Gs(a=0,e){const t=a/e,i=t<10;let o=0;return i?o=Math.round((t+Number.EPSILON)*10)/10:o=Math.round(t),o}function qs(a,e,t,i){switch(e){case 1e9:return D(t==="short"?nt`${a}B`:nt`${a} billion`);case 1e6:return D(t==="short"?nt`${a}M`:nt`${a} million`);case 1e3:return D(t==="short"?nt`${a}K`:nt`${a} thousand`);default:return new Intl.NumberFormat(i).format(a)}}function jt(a,e="long",t="short",i="en-US"){const o=a!=null?a:-1;if(o<0)return"";const r=js(o,e),l=Gs(o,r);return qs(l,r,t,i)}let Ye=class extends A{render(){var e;const t=jt(this.favCount,"short","short"),i=jt(this.commentCount,"short","short"),o=this.mediatype==="account"?`${this.itemCount} uploads`:`${this.viewCount} ${(e=this.viewLabel)!==null&&e!==void 0?e:"all-time views"}`;return h`
    ...
    `}get isSortedByDate(){var e;return["date","reviewdate","addeddate","publicdate"].includes((e=this.sortParam)===null||e===void 0?void 0:e.field)}get hasSnippets(){var e,t;return!!(!((t=(e=this.model)===null||e===void 0?void 0:e.snippets)===null||t===void 0)&&t.length)}infoButtonPressed(e){e.preventDefault();const t=new CustomEvent("infoButtonPressed",{detail:{x:e.clientX,y:e.clientY}});this.dispatchEvent(t)}static get styles(){const e=m`var(--tileBorderColor, #dddddd)`;return[Pi,m`
      ...
      `]}};s([c({type:Boolean})],mo.prototype,"showInfoButton",void 0);mo=s([L("item-tile")],mo);let fo=class extends le{constructor(){super(...arguments),this.showInfoButton=!1}render(){return h`
      <div class="container">
        ${this.infoButtonTemplate}
        <div class="tile-details">
          <div class="item-info">
    ...
    >
      ...
      `]}};s([c({type:Boolean})],fo.prototype,"showInfoButton",void 0);fo=s([L("account-tile")],fo);let go=class extends le{constructor(){super(...arguments),this.showInfoButton=!1}render(){return h`
      <div class="container">
        <div class="tile-details">
          <div class="item-info">
            ${this.getImageBlockTemplate} ${this.getTitleTemplate}
    ...
    `}get getTitleTemplate(){var e;return h`<div id="title">
      ...
      `]}};s([c({type:Boolean})],go.prototype,"showInfoButton",void 0);go=s([L("search-tile")],go);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`+ve),De&&(ve=Ge(ve,ye," "),ve=Ge(ve,Se," ")),K&&ni?K.createHTML(ve):ve},e.setConfig=function(M){Ni(M),bt=!0},e.clearConfig=function(){Ct=null,bt=!1},e.isValidAttribute=function(M,u,x){Ct||Ni({});var C=at(M),H=at(u);return Jo(C,H,x)},e.addHook=function(M,u){typeof u=="function"&&(R[M]=R[M]||[],Vt(R[M],u))},e.removeHook=function(M){if(R[M])return Ca(R[M])},e.removeHooks=function(M){R[M]&&(R[M]=[])},e.removeAllHooks=function(){R={}},e}var wi=mr(),_;(function(a){a.default="default",a.unrecognized="unrecognized",a.relevance="relevance",a.alltimeview="alltimeview",a.weeklyview="weeklyview",a.title="title",a.date="date",a.datearchived="datearchived",a.datereviewed="datereviewed",a.dateadded="dateadded",a.datefavorited="datefavorited",a.creator="creator"})(_||(_={}));const fe={[_.default]:{field:_.default,defaultSortDirection:null,canSetDirection:!1,shownInSortBar:!1,shownInURL:!1,handledBySearchService:!1,displayName:"",urlNames:["",null,void 0]},[_.unrecognized]:{field:_.unrecognized,defaultSortDirection:null,canSetDirection:!0,shownInSortBar:!1,shownInURL:!1,handledBySearchService:!0,displayName:"",urlNames:[]},[_.relevance]:{field:_.relevance,defaultSortDirection:null,canSetDirection:!1,shownInSortBar:!0,shownInURL:!1,handledBySearchService:!1,displayName:"Relevance",urlNames:["_score"]},[_.alltimeview]:{field:_.alltimeview,defaultSortDirection:"desc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"downloads",displayName:"All-time views",urlNames:["downloads"]},[_.weeklyview]:{field:_.weeklyview,defaultSortDirection:"desc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"week",displayName:"Weekly views",urlNames:["week"]},[_.title]:{field:_.title,defaultSortDirection:"asc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"titleSorter",displayName:"Title",urlNames:["title","titleSorter"]},[_.date]:{field:_.date,defaultSortDirection:"desc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"date",displayName:"Date published",urlNames:["date"]},[_.datearchived]:{field:_.datearchived,defaultSortDirection:"desc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"publicdate",displayName:"Date archived",urlNames:["publicdate"]},[_.datereviewed]:{field:_.datereviewed,defaultSortDirection:"desc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"reviewdate",displayName:"Date reviewed",urlNames:["reviewdate"]},[_.dateadded]:{field:_.dateadded,defaultSortDirection:"desc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"addeddate",displayName:"Date added",urlNames:["addeddate"]},[_.datefavorited]:{field:_.datefavorited,defaultSortDirection:"desc",canSetDirection:!1,shownInSortBar:!0,shownInURL:!1,handledBySearchService:!1,searchServiceKey:"favoritedate",displayName:"Date favorited",urlNames:["favoritedate"]},[_.creator]:{field:_.creator,defaultSortDirection:"asc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"creatorSorter",displayName:"Creator",urlNames:["creator","creatorSorter"]}};function fr(a){var e;return(e=Object.values(fe).find(t=>t.urlNames.some(i=>a===i)))!==null&&e!==void 0?e:fe[_.unrecognized]}const _l={title:"firstTitle",creator:"firstCreator"},ti=()=>({subject:{},lending:{},mediatype:{},language:{},creator:{},collection:{},year:{}}),Cl=["mediatype","lending","year","subject","collection","creator","language"],Ti={subject:"Subject",lending:"Availability",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"},_o={subject:Z.COUNT,lending:Z.COUNT,mediatype:Z.COUNT,language:Z.COUNT,creator:Z.COUNT,collection:Z.COUNT,year:Z.NUMERIC},Sl={subject:Z.ALPHABETICAL,lending:Z.ALPHABETICAL,mediatype:Z.ALPHABETICAL,language:Z.ALPHABETICAL,creator:Z.ALPHABETICAL,collection:Z.ALPHABETICAL,year:Z.NUMERIC},$l={is_lendable:!0,is_borrowable:!1,available_to_borrow:!0,is_browsable:!1,available_to_browse:!1,is_readable:!0,available_to_waitlist:!1},Ma={is_lendable:"Lending Library",available_to_borrow:"Borrow 14 Days",is_readable:"Always Available"},Io={deemphasize:!0,community:!0,stream_only:!0,samples_only:!0,test_collection:!0,printdisabled:!0,"openlibrary-ol":!0,nationalemergencylibrary:!0,china:!0,americana:!0,toronto:!0};let Mi=class extends le{constructor(){super(...arguments),this.collectionLinks=[]}render(){return h`
    ...
    `}};s([c({type:Object})],Xe.prototype,"model",void 0);s([c({type:String})],Xe.prototype,"baseNavigationUrl",void 0);s([c({type:String})],Xe.prototype,"baseImageUrl",void 0);s([c({type:Boolean})],Xe.prototype,"loggedIn",void 0);s([c({type:Object})],Xe.prototype,"sortParam",void 0);s([c({type:Object})],Xe.prototype,"collectionNameCache",void 0);Xe=s([L("tile-hover-pane")],Xe);let za=class extends le{render(){var e,t,i,o,r,l;return h`
      <div id="list-line" class="${this.classSize}">
        <image-block
          .model=${this.model}
          .baseImageUrl=${this.baseImageUrl}
    ...
    `}};za=s([L("tile-list-compact")],za);let Ea=class extends le{render(){return h`
  ...
  `;So=s([L("ia-icon-label")],So);let $o=class extends A{constructor(){super(...arguments),this.numResults=0}render(){return h`
    ...
    `}};s([c({type:Number})],$o.prototype,"numResults",void 0);$o=s([L("alpha-bar-tooltip")],$o);let Ve=class extends A{constructor(){super(...arguments),this.selectedLetter=null,this.tooltipShown=!1,this.alphabet="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("")}get selectedUppercaseLetter(){var e;return(e=this.selectedLetter)===null||e===void 0?void 0:e.toUpperCase()}render(){var e;return h`
  ...
  `;s([c({type:String})],Ve.prototype,"selectedLetter",void 0);s([c({type:Object})],Ve.prototype,"letterCounts",void 0);s([c({type:String})],Ve.prototype,"ariaLandmarkLabel",void 0);s([z()],Ve.prototype,"tooltipShown",void 0);s([z()],Ve.prototype,"hoveredLetter",void 0);s([Q("alpha-bar-tooltip")],Ve.prototype,"tooltip",void 0);Ve=s([L("alpha-bar")],Ve);const Tl=h`
...
`;let J=class extends A{constructor(){super(...arguments),this.defaultSortDirection=null,this.defaultSortField=_.relevance,this.sortDirection=null,this.selectedSort=_.default,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.showRelevance=!0,this.showDateFavorited=!1,this.alphaSelectorVisible=null,this.dropdownBackdropVisible=!1,this.desktopSortContainerWidth=0,this.selectorBarContainerWidth=0,this.boundSortBarSelectorEscapeListener=e=>{e.key==="Escape"&&this.closeDropdowns()}}render(){return h`
    ...
    `:h`<div class="sort-direction-icon">${zl}</div>`}get desktopSortSelectorTemplate(){return h`
      <div
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Pa(a,e,t){return a?e():t==null?void 0:t()}let ii=class extends A{constructor(){super(...arguments),this.label=D("Select items to un-favorite"),this.showSelectAll=!1,this.showUnselectAll=!1}render(){return h`
      <div class="manage-container">
        ...
        <div class="manage-buttons">
          ...
          <div class="selection-buttons">
            ${Pa(this.showSelectAll,()=>h` <button
                class="link-styled select-all-btn"
                @click=${this.selectAllClicked}
              >
                ${D("Select all")}
              </button>`)}
            ${Pa(this.showUnselectAll,()=>h` <button
 ...
 */const Aa=ri(class extends si{constructor(a){if(super(a),a.type!==Pe.PROPERTY&&a.type!==Pe.ATTRIBUTE&&a.type!==Pe.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!lr(a))throw Error("`live` bindings can only contain a single expression")}render(a){return a}update(a,[e]){if(e===we||e===y)return e;const t=a.element,i=a.name;if(a.type===Pe.PROPERTY){if(e===t[i])return we}else if(a.type===Pe.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(i))return we}else if(a.type===Pe.ATTRIBUTE&&t.getAttribute(i)===e+"")return we;return nr(a),e}}),Ol=Object.freeze({processing:"processing",complete:"complete"});class Rl extends A{static get properties(){return{mode:{type:String}}}constructor(){super(),this.mode=Ol.processing}render(){return h`
    ...
    `}get selectedRangeTemplate(){return I`
      ...
      />`}get histogramTemplate(){const e=this._histWidth/this._numBins,t=e-1;let i=this.sliderWidth;return this._histData.map(o=>{const r=I`
        ...
        />`;return i+=e,r})}formatDate(e){if(Number.isNaN(e))return"";const t=ao(e);return t.year()<1e3?String(t.year()):t.format(this.dateFormat)}get minInputTemplate(){return h`
      <input
        id="date-min"
...
`;let oe=class extends A{constructor(){super(...arguments),this.prompt="Do you find this feature useful?",this.buttonText="Beta",this.isOpen=!1,this.processing=!1,this.popupTopX=0,this.popupTopY=0,this.voteSubmitted=!1,this.voteNeedsChoosing=!1,this.resizingElement=document.body}render(){return h`
    ...
    `}};s([c({type:String})],oe.prototype,"featureIdentifier",void 0);s([c({type:String})],oe.prototype,"prompt",void 0);s([c({type:String})],oe.prototype,"buttonText",void 0);s([c({type:Object})],oe.prototype,"recaptchaManager",void 0);s([c({type:Object})],oe.prototype,"resizeObserver",void 0);s([c({type:Boolean})],oe.prototype,"disabled",void 0);s([c({type:Object})],oe.prototype,"featureFeedbackService",void 0);s([Q("#beta-button")],oe.prototype,"betaButton",void 0);s([Q("#popup")],oe.prototype,"popup",void 0);s([z()],oe.prototype,"isOpen",void 0);s([z()],oe.prototype,"processing",void 0);s([z()],oe.prototype,"popupTopX",void 0);s([z()],oe.prototype,"popupTopY",void 0);s([z()],oe.prototype,"vote",void 0);s([z()],oe.prototype,"voteSubmitted",void 0);s([z()],oe.prototype,"error",void 0);s([z()],oe.prototype,"voteNeedsChoosing",void 0);s([z()],oe.prototype,"recaptchaWidget",void 0);s([Q("#comments")],oe.prototype,"comments",void 0);oe=s([L("feature-feedback")],oe);class Ei{constructor(e){var t,i,o,r,l,n,d;this.title=e==null?void 0:e.title,this.subtitle=e==null?void 0:e.subtitle,this.headline=e==null?void 0:e.headline,this.message=e==null?void 0:e.message,this.headerColor=(t=e==null?void 0:e.headerColor)!==null&&t!==void 0?t:"#55A183",this.bodyColor=(i=e==null?void 0:e.bodyColor)!==null&&i!==void 0?i:"#f5f5f7",this.showProcessingIndicator=(o=e==null?void 0:e.showProcessingIndicator)!==null&&o!==void 0?o:!1,this.processingImageMode=(r=e==null?void 0:e.processingImageMode)!==null&&r!==void 0?r:"complete",this.showCloseButton=(l=e==null?void 0:e.showCloseButton)!==null&&l!==void 0?l:!0,this.showHeaderLogo=(n=e==null?void 0:e.showHeaderLogo)!==null&&n!==void 0?n:!0,this.closeOnBackdropClick=(d=e==null?void 0:e.closeOnBackdropClick)!==null&&d!==void 0?d:!0}}var sn=h`
<svg
  viewBox="0 0 40 40"
  version="1.1"
  xmlns="http://www.w3.org/2000/svg"
...
`;let ko=class extends A{constructor(){super(...arguments),this.config=new Ei}render(){return h`
      <div class="modal-wrapper">
        <div class="modal-container">
          <header style="background-color: ${this.config.headerColor}">
            ${this.config.showCloseButton?this.closeButtonTemplate:""}
            ${this.config.showHeaderLogo?h`<div class="logo-icon">${ln}</div>`:y}
    ...
    `}};s([c({type:Object})],ko.prototype,"config",void 0);ko=s([L("modal-template")],ko);function nn(a,e,t){var i=t||{},o=i.noTrailing,r=o===void 0?!1:o,l=i.noLeading,n=l===void 0?!1:l,d=i.debounceMode,p=d===void 0?void 0:d,v,f=!1,g=0;function w(){v&&clearTimeout(v)}function S(P){var B=P||{},U=B.upcomingOnly,re=U===void 0?!1:U;w(),f=!re}function E(){for(var P=arguments.length,B=new Array(P),U=0;U<P;U++)B[U]=arguments[U];var re=this,K=Date.now()-g;if(f)return;function ne(){g=Date.now(),e.apply(re,B)}function ee(){v=void 0}!n&&p&&!v&&ne(),w(),p===void 0&&K>a?n?(g=Date.now(),r||(v=setTimeout(p?ee:ne,a))):ne():r!==!0&&(v=setTimeout(p?ee:ne,p===void 0?a-K:a))}return E.cancel=S,E}var ct;(function(a){a.Open="open",a.Closed="closed"})(ct||(ct={}));class dn{constructor(e){this.windowResizeThrottler=nn(100,this.updateModalContainerHeight,{noLeading:!1,noTrailing:!1}).bind(this),this.modalManager=e}handleModeChange(e){switch(e){case ct.Open:this.startResizeListener(),this.stopDocumentScroll();break;case ct.Closed:this.stopResizeListener(),this.resumeDocumentScroll();break}}updateModalContainerHeight(){this.modalManager.style.setProperty("--containerHeight",`${window.innerHeight}px`)}stopDocumentScroll(){document.body.classList.add("modal-manager-open")}resumeDocumentScroll(){document.body.classList.remove("modal-manager-open")}startResizeListener(){window.addEventListener("resize",this.windowResizeThrottler)}stopResizeListener(){window.removeEventListener("resize",this.windowResizeThrottler)}}let Et=class extends A{constructor(){super(...arguments),this.mode=ct.Closed,this.hostBridge=new dn(this),this.closeOnBackdropClick=!0}render(){return h`
      <div class="container">
...
`;let Dt=class extends A{constructor(){super(...arguments),this.step=2,this.currentPage=1,this.pages=[]}firstUpdated(){this.observePageCount()}updated(e){e.has("size")&&this.observePageCount(),e.has("currentPage")&&(this.observePageCount(),this.emitPageClick())}observePageCount(){this.pages=[];const e=7,t=this.size<=e;if(this.size<=5){this.pages=[...Array(this.size).keys()].map(r=>r+1);return}if(this.size===e){if(this.currentPage===2){this.pages=[1,2,3,4,0,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,4,5,this.size-1,this.size];return}}if(this.currentPage===1){this.pages=[1,2,3,0,this.size];return}if(this.currentPage===this.size){this.pages=[1,0,this.size-2,this.size-1,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,this.size-3,this.size-2,this.size-1,this.size];return}if(t&&this.currentPage>1&&this.currentPage<e){this.pages=[...Array(this.size).keys()].map(r=>r+1);return}let i=this.currentPage-this.step,o=this.currentPage+this.step;i<=0&&(o+=-i+1,i=1),o>=this.size&&(i=Math.max(i-(o-this.size),1),o=this.size),i===2&&(o-=1),o===this.size-1&&(i+=1),this.createFirstNode(i),this.createMiddelNode(i,o),this.createLastNode(o)}createFirstNode(e){var t,i;e>1&&((t=this.pages)===null||t===void 0||t.push(1)),e>2&&((i=this.pages)===null||i===void 0||i.push(0))}createMiddelNode(e,t){var i;for(let o=e;o<=t;o+=1)(i=this.pages)===null||i===void 0||i.push(o)}createLastNode(e){var t,i;e<this.size-1&&((t=this.pages)===null||t===void 0||t.push(0)),e<this.size&&((i=this.pages)===null||i===void 0||i.push(this.size))}get getEllipsisTemplate(){return h`<i class="ellipses">...</i>`}emitPageClick(){this.dispatchEvent(new CustomEvent("pageNumberClicked",{detail:{page:this.currentPage},bubbles:!0,composed:!0}))}onRewind(){this.currentPage-=1,this.currentPage<1&&(this.currentPage=1)}onForward(){this.currentPage+=1,this.currentPage>this.size&&(this.currentPage=this.size)}onChange(e){this.currentPage=e}getPageTemplate(e){return h`
    ...
    `}static get styles(){return[Je,m`
      ...
      `]}};s([c({type:Number})],Dt.prototype,"size",void 0);s([c({type:Number})],Dt.prototype,"step",void 0);s([c({type:Number})],Dt.prototype,"currentPage",void 0);s([z()],Dt.prototype,"pages",void 0);Dt=s([L("more-facets-pagination")],Dt);var un=I`
...
`,To;let Lt=To=class extends A{render(){return h`${this.facetRowTemplate}`}get facetRowTemplate(){var e,t;const{bucket:i,facetType:o}=this;if(!i||!o)return y;const r=`${o}:${i.key}-show-only`,l=`${o}:${i.key}-negative`,n=o!=="collection"?h`${(e=i.displayText)!==null&&e!==void 0?e:i.key}`:h`<a href="/details/${i.key}">
    ...
    `}get loaderTemplate(){return h`<div class="facets-loader">
      <ia-activity-indicator .mode=${"processing"}></ia-activity-indicator>
        ...
        </div> `:y}sortFacetAggregation(e){this.sortedBy=e,this.dispatchEvent(new CustomEvent("sortedFacets",{detail:this.sortedBy}))}get getModalHeaderTemplate(){const t=_o[this.facetKey]===Z.COUNT?"left":"right";return h`<span class="sr-only">More facets for:</span>
      <span class="title">
    ...
    `}applySearchFacetsClicked(){var e,t;const i=new CustomEvent("facetsChanged",{detail:this.selectedFacets,bubbles:!0,composed:!0});this.dispatchEvent(i),(e=this.modalManager)===null||e===void 0||e.closeModal(),(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:Ae.default,action:`${se.applyMoreFacetsModal}`,label:`${this.facetKey}`})}cancelClick(){var e,t;(e=this.modalManager)===null||e===void 0||e.closeModal(),(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:Ae.default,action:se.closeMoreFacetsModal,label:`${this.facetKey}`})}static get styles(){const e=m`var(--primaryButtonBGColor, #194880)`;return[Je,m`
      ...
      `]}};s([c({type:String})],ae.prototype,"facetKey",void 0);s([c({type:String})],ae.prototype,"facetAggregationKey",void 0);s([c({type:String})],ae.prototype,"query",void 0);s([c({type:Object})],ae.prototype,"filterMap",void 0);s([c({type:Object})],ae.prototype,"modalManager",void 0);s([c({type:Object})],ae.prototype,"searchService",void 0);s([c({type:String})],ae.prototype,"searchType",void 0);s([c({type:String})],ae.prototype,"withinCollection",void 0);s([c({type:Object})],ae.prototype,"collectionNameCache",void 0);s([c({type:Object})],ae.prototype,"selectedFacets",void 0);s([c({type:String})],ae.prototype,"sortedBy",void 0);s([c({type:Object,attribute:!1})],ae.prototype,"analyticsHandler",void 0);s([z()],ae.prototype,"aggregations",void 0);s([z()],ae.prototype,"facetGroup",void 0);s([z()],ae.prototype,"facetGroupTitle",void 0);s([z()],ae.prototype,"pageNumber",void 0);s([z()],ae.prototype,"facetsLoading",void 0);s([z()],ae.prototype,"paginationSize",void 0);s([z()],ae.prototype,"facetsType",void 0);ae=s([L("more-facets-content")],ae);let Ua=class extends A{render(){return h`
      <div id="row">
    ...
    `}};Ua=s([L("facet-tombstone-row")],Ua);let Be=class extends A{constructor(){super(...arguments),this.boundEscapeListener=e=>{e.key==="Escape"&&this.closeModal()}}render(){var e,t;return h`
      <div id="container">
    ...
    `}searchMoreFacetsLink(e){if(!this.moreLinksVisible||e.key==="lending"||Object.keys(e.buckets).length<this.allowedFacetCount)return y;const t=_o[e.key];return h`<button
      class="more-link"
