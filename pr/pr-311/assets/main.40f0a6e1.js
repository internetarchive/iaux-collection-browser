...
fill=""></path>
  ...
  `;n([p({type:String})],tt.prototype,"selectedLetter",void 0);n([p({type:Object})],tt.prototype,"letterCounts",void 0);n([p({type:String})],tt.prototype,"ariaLandmarkLabel",void 0);n([z()],tt.prototype,"tooltipShown",void 0);n([z()],tt.prototype,"hoveredLetter",void 0);n([X("alpha-bar-tooltip")],tt.prototype,"tooltip",void 0);tt=n([L("alpha-bar")],tt);const eh=h`
...
`;let K=class extends D{constructor(){super(...arguments),this.defaultSortDirection=null,this.defaultSortField=S.relevance,this.sortDirection=null,this.selectedSort=S.default,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.showRelevance=!0,this.showDateFavorited=!1,this.enableSortOptionsSlot=!1,this.suppressDisplayModes=!1,this.lastSelectedViewSort=S.weeklyview,this.lastSelectedDateSort=this.defaultDateSortField,this.alphaSelectorVisible=null,this.dropdownBackdropVisible=!1,this.desktopSortContainerWidth=0,this.selectorBarContainerWidth=0,this.boundSortBarSelectorEscapeListener=e=>{e.key==="Escape"&&this.closeDropdowns()}}render(){return h`
    ...
    `}get sortDirectionIcon(){return this.canChangeSortDirection?h`
      <div class="sort-direction-icon">
        ${this.finalizedSortDirection==="asc"?eh:th}
      </div>
    `:h`<div class="sort-direction-icon">${ih}</div>`}get desktopSortSelectorTemplate(){return h`
      <div
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Sh=(s,e)=>e.kind==="method"&&e.descriptor&&!("value"in e.descriptor)?se(V({},e),{finisher(t){t.createProperty(e.key,s)}}):{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){typeof e.initializer=="function"&&(this[e.key]=e.initializer.call(this))},finisher(t){t.createProperty(e.key,s)}},Ch=(s,e,t)=>{e.constructor.createProperty(t,s)};function Po(s){return(e,t)=>t!==void 0?Ch(s,e,t):Sh(s,e)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const kh=({finisher:s,descriptor:e})=>(t,i)=>{var o;if(i===void 0){const a=(o=t.originalKey)!==null&&o!==void 0?o:t.key,r=e!=null?{kind:"method",placement:"prototype",key:a,descriptor:e(t.key)}:se(V({},t),{key:a});return s!=null&&(r.finisher=function(l){s(l,a)}),r}{const a=t.constructor;e!==void 0&&Object.defineProperty(t,i,e(i)),s==null||s(a,i)}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Th(s,e){return kh({descriptor:t=>{const i={get(){var o,a;return(a=(o=this.renderRoot)===null||o===void 0?void 0:o.querySelector(s))!==null&&a!==void 0?a:null},enumerable:!0,configurable:!0};if(e){const o=typeof t=="symbol"?Symbol():"__"+t;i.get=function(){var a,r;return this[o]===void 0&&(this[o]=(r=(a=this.renderRoot)===null||a===void 0?void 0:a.querySelector(s))!==null&&r!==void 0?r:null),this[o]}}return i}})}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Ss;((Ss=window.HTMLSlotElement)===null||Ss===void 0?void 0:Ss.prototype.assignedElements)!=null;const Eh=Object.freeze({processing:"processing",complete:"complete"});class Mh extends D{static get properties(){return{mode:{type:String}}}constructor(){super(),this.mode=Eh.processing}render(){return h`
      <div class="${this.mode}">
        <svg
          viewBox="0 0 120 120"
    ...
    `}}window.customElements.define("ia-activity-indicator",Mh);var Ah=h`
<svg
  viewBox="0 0 40 40"
  version="1.1"
  xmlns="http://www.w3.org/2000/svg"
...
`;class zh extends D{static get styles(){return y`
      :host {
    ...
    `}render(){return Ah}}customElements.define("ia-icon-close",zh);var Ph=h`
<svg
  class="ia-logo"
  viewBox="0 0 27 30"
  xmlns="http://www.w3.org/2000/svg"
...
`;let da=class extends Ht{constructor(){super(...arguments),this.config=new St}render(){return ot`
      <div class="modal-wrapper">
        <div class="modal-container">
          <header style="background-color: ${this.config.headerColor}">
            ...
            ${this.config.showHeaderLogo?ot`<div class="logo-icon">${Ph}</div>`:ce}
    ...
    `}};n([Po({type:Object})],da.prototype,"config",void 0);da=n([xl("modal-template")],da);function Lh(s,e,t){var i=t||{},o=i.noTrailing,a=o===void 0?!1:o,r=i.noLeading,l=r===void 0?!1:r,d=i.debounceMode,c=d===void 0?void 0:d,u,f=!1,m=0;function w(){u&&clearTimeout(u)}function $(P){var B=P||{},R=B.upcomingOnly,j=R===void 0?!1:R;w(),f=!j}function x(){for(var P=arguments.length,B=new Array(P),R=0;R<P;R++)B[R]=arguments[R];var j=this,F=Date.now()-m;if(f)return;function Z(){m=Date.now(),e.apply(j,B)}function ue(){u=void 0}!l&&c&&!u&&Z(),w(),c===void 0&&F>s?l?(m=Date.now(),a||(u=setTimeout(c?ue:Z,s))):Z():a!==!0&&(u=setTimeout(c?ue:Z,c===void 0?s-F:s))}return x.cancel=$,x}var Ct;(function(s){s.Open="open",s.Closed="closed"})(Ct||(Ct={}));class Rh{constructor(e){this.windowResizeThrottler=Lh(100,this.updateModalContainerHeight,{noLeading:!1,noTrailing:!1}).bind(this),this.modalManager=e}handleModeChange(e){switch(e){case Ct.Open:this.startResizeListener(),this.stopDocumentScroll();break;case Ct.Closed:this.stopResizeListener(),this.resumeDocumentScroll();break}}updateModalContainerHeight(){this.modalManager.style.setProperty("--containerHeight",`${window.innerHeight}px`)}stopDocumentScroll(){document.body.classList.add("modal-manager-open")}resumeDocumentScroll(){document.body.classList.remove("modal-manager-open")}startResizeListener(){window.addEventListener("resize",this.windowResizeThrottler)}stopResizeListener(){window.removeEventListener("resize",this.windowResizeThrottler)}}let Jt=class extends Ht{constructor(){super(...arguments),this.mode=Ct.Closed,this.hostBridge=new Rh(this),this.closeOnBackdropClick=!0}render(){return ot`
      <div class="container">
    ...
    `}};n([Po({type:String,reflect:!0})],Jt.prototype,"mode",void 0);n([Po({type:Object})],Jt.prototype,"customModalContent",void 0);n([Po({type:Object})],Jt.prototype,"hostBridge",void 0);n([Th("modal-template")],Jt.prototype,"modalTemplate",void 0);Jt=n([xl("modal-manager")],Jt);const fn=y`var(--white, #fff)`,Dh=y`var(--primaryDisableCTAFill, #767676)`,Bh=y`var(--secondaryCTABorder, #999)`,Fh=y`var(--primaryCTAFill, #194880)`,Cs=y`var(--primaryCTAFillRGB, 25, 72, 128)`,Oh=y`var(--primaryCTABorder, #c5d1df)`,Ih=y`var(--primaryErrorCTAFill, #d9534f)`,ks=y`var(--primaryErrorCTAFillRGB, 229, 28, 38)`,Uh=y`var(--primaryErrorCTABorder, #d43f3a)`,Nh=y`var(--secondaryCTAFill, #333)`,Ts=y`var(--secondaryCTAFillRGB, 51, 51, 51)`,Hh=y`var(--primaryCTABorder, #979797)`,Vh=y`var(---primaryWarningFill, #ee8950)`,Es=y`var(--primaryWarningFillRGB, 238, 137, 80)`,Wh=y`var(--primaryWarningBorder, #ec7939)`;var jh=y`
  .ia-button {
    min-height: 3rem;
    cursor: pointer;
    color: ${fn};
    ...
    `}get selectedRangeTemplate(){return U`
      ...
      />`}get histogramTemplate(){const e=this._histWidth/this._numBins,t=e-1;let i=this.sliderWidth;return this._histData.map(o=>{const a=U`
        <rect
          ...
          fill="${i+t>=this.minSliderX&&i<=this.maxSliderX?r0:l0}"
...
`;let ei=class extends D{constructor(){super(...arguments),this.step=2,this.currentPage=1,this.pages=[]}firstUpdated(){this.observePageCount()}updated(e){e.has("size")&&this.observePageCount(),e.has("currentPage")&&(this.observePageCount(),this.emitPageClick())}observePageCount(){this.pages=[];const e=7,t=this.size<=e;if(this.size<=5){this.pages=[...Array(this.size).keys()].map(a=>a+1);return}if(this.size===e){if(this.currentPage===2){this.pages=[1,2,3,4,0,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,4,5,this.size-1,this.size];return}}if(this.currentPage===1){this.pages=[1,2,3,0,this.size];return}if(this.currentPage===this.size){this.pages=[1,0,this.size-2,this.size-1,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,this.size-3,this.size-2,this.size-1,this.size];return}if(t&&this.currentPage>1&&this.currentPage<e){this.pages=[...Array(this.size).keys()].map(a=>a+1);return}let i=this.currentPage-this.step,o=this.currentPage+this.step;i<=0&&(o+=-i+1,i=1),o>=this.size&&(i=Math.max(i-(o-this.size),1),o=this.size),i===2&&(o-=1),o===this.size-1&&(i+=1),this.createFirstNode(i),this.createMiddelNode(i,o),this.createLastNode(o)}createFirstNode(e){var t,i;e>1&&((t=this.pages)===null||t===void 0||t.push(1)),e>2&&((i=this.pages)===null||i===void 0||i.push(0))}createMiddelNode(e,t){var i;for(let o=e;o<=t;o+=1)(i=this.pages)===null||i===void 0||i.push(o)}createLastNode(e){var t,i;e<this.size-1&&((t=this.pages)===null||t===void 0||t.push(0)),e<this.size&&((i=this.pages)===null||i===void 0||i.push(this.size))}get getEllipsisTemplate(){return h`<i class="ellipses">...</i>`}emitPageClick(){this.dispatchEvent(new CustomEvent("pageNumberClicked",{detail:{page:this.currentPage},bubbles:!0,composed:!0}))}onRewind(){this.currentPage-=1,this.currentPage<1&&(this.currentPage=1)}onForward(){this.currentPage+=1,this.currentPage>this.size&&(this.currentPage=this.size)}onChange(e){this.currentPage=e}getPageTemplate(e){return h`
    ...
    `}static get styles(){return[it,y`
      ...
      `]}};n([p({type:Number})],ei.prototype,"size",void 0);n([p({type:Number})],ei.prototype,"step",void 0);n([p({type:Number})],ei.prototype,"currentPage",void 0);n([z()],ei.prototype,"pages",void 0);ei=n([L("more-facets-pagination")],ei);var y0=U`
...
`,ca;let Fi=ca=class extends D{render(){return h`${this.facetRowTemplate}`}get facetRowTemplate(){var e,t,i,o;const{bucket:a,facetType:r}=this;if(!a||!r)return b;const l=`${r}:${a.key}-show-only`,d=`${r}:${a.key}-negative`,c=r!=="collection"?h`${(e=a.displayText)!==null&&e!==void 0?e:a.key}`:h`<a href="/details/${a.key}">
      ...
      <div class="facet-row-container">
        <div class="facet-checkboxes">
          ...
          <label
            ...
            data-testid=${d}
          >
            <span class="eye">${y0}</span>
            <span class="eye-closed">${w0}</span>
          </label>
        </div>
        <label
          for=${l}
    ...
    `}partOfCollectionClicked(e){var t;(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:Ve.default,action:ie.partOfCollectionClicked,label:e.target.dataset.id})}showDatePickerModal(){var e,t,i;const{fullYearsHistogramAggregation:o}=this,a=o==null?void 0:o.first_bucket_key,r=o==null?void 0:o.last_bucket_key,l=o==null?void 0:o.buckets,c=h`
      <expanded-date-picker
        ${Yh(f=>{if(f&&f instanceof Ke){const m=f;m.minSelectedDate=this.minSelectedDate,m.maxSelectedDate=this.maxSelectedDate}})}
        .minDate=${a}
        .maxDate=${r}
...
`;function C0(s){return s&&s.charAt(0).toLocaleUpperCase()+s.slice(1)}let Oi=class extends D{constructor(){super(...arguments),this.selected=!1}render(){var e,t;if(!this.facetInfo)return b;const i=this.facetInfo.facets.length===1,o=this.facetInfo.facets[0],a=C0((this.labelPrefix?`${this.labelPrefix} `:"")+((t=(e=this.facetInfo.label)!==null&&e!==void 0?e:o.displayText)!==null&&t!==void 0?t:o.bucketKey));if(!a)return b;const r=i&&o.facetType==="mediatype"?Zn[o.bucketKey].icon:b;return h`
      <a
    ...
    `}};n([p({type:Array})],ti.prototype,"facetInfo",void 0);n([p({type:String})],ti.prototype,"labelPrefix",void 0);n([p({type:Object})],ti.prototype,"activeFacetRef",void 0);n([X("ia-dropdown")],ti.prototype,"dropdown",void 0);ti=n([L("smart-facet-dropdown")],ti);const kn={collection:"Collection: ",creator:"By: ",subject:"About: "};function k0(s){return s.charAt(0).toUpperCase()+s.slice(1)}let Qe=class extends D{constructor(){super(...arguments),this.filterToggleActive=!1,this.heuristicRecs=[],this.smartFacets=[]}render(){return h`
