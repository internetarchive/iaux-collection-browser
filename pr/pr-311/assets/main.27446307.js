...
fill=""></path>
  ...
  `;Wr=n([Wn("ia-icon-label")],Wr);let jr=class extends F{constructor(){super(...arguments),this.numResults=0}render(){return h`
    ...
    `}};n([p({type:Number})],jr.prototype,"numResults",void 0);jr=n([R("alpha-bar-tooltip")],jr);let Ge=class extends F{constructor(){super(...arguments),this.selectedLetter=null,this.tooltipShown=!1,this.alphabet="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("")}get selectedUppercaseLetter(){var e;return(e=this.selectedLetter)===null||e===void 0?void 0:e.toUpperCase()}render(){var e;return h`
  ...
  `;n([p({type:String})],Ge.prototype,"selectedLetter",void 0);n([p({type:Object})],Ge.prototype,"letterCounts",void 0);n([p({type:String})],Ge.prototype,"ariaLandmarkLabel",void 0);n([z()],Ge.prototype,"tooltipShown",void 0);n([z()],Ge.prototype,"hoveredLetter",void 0);n([J("alpha-bar-tooltip")],Ge.prototype,"tooltip",void 0);Ge=n([R("alpha-bar")],Ge);const Dc=h`
...
`;let Xr=class extends Ot{constructor(){super(...arguments),this.config=new vo}render(){return Ye`
      <div class="modal-wrapper">
        <div class="modal-container">
          <header style="background-color: ${this.config.headerColor}">
            ${this.config.showCloseButton?this.closeButtonTemplate:""}
            ${this.config.showHeaderLogo?Ye`<div class="logo-icon">${G0}</div>`:de}
            ${this.config.title?Ye`<h1 class="title">${this.config.title}</h1>`:""}
            ${this.config.subtitle?Ye`<h2 class="subtitle">${this.config.subtitle}</h2>`:""}
          </header>
          <section
            class="modal-body"
          ...
          >
            <div class="content">
              ...
              ${this.config.headline?Ye` <h1 class="headline">${this.config.headline}</h1> `:""}
              ${this.config.message?Ye` <p class="message">${this.config.message}</p> `:""}
    ...
    `}handleCloseButton(){const e=new Event("closeButtonPressed");this.dispatchEvent(e)}get closeButtonTemplate(){return Ye`
      <button
        type="button"
        class="close-button"
        tabindex="0"
