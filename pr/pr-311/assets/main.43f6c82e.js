 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var mo,go;class R extends $t{constructor(){super(...arguments),this.renderOptions={host:this},this._$Dt=void 0}createRenderRoot(){var e,t;const i=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=i.firstChild),i}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Dt=Mi(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Dt)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Dt)===null||e===void 0||e.setConnected(!1)}render(){return Se}}R.finalized=!0,R._$litElement$=!0,(mo=globalThis.litElementHydrateSupport)===null||mo===void 0||mo.call(globalThis,{LitElement:R});const oa=globalThis.litElementPolyfillSupport;oa==null||oa({LitElement:R});((go=globalThis.litElementVersions)!==null&&go!==void 0?go:globalThis.litElementVersions=[]).push("3.2.0");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;let ni=class extends R{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1,this.isCompactTile=!1}render(){return c`<div class="icon-overlay ${this.getClass}">
    ...
    `}};l([h({type:String})],Ke.prototype,"baseImageUrl",void 0);l([h({type:Boolean})],Ke.prototype,"isCompactTile",void 0);l([h({type:Boolean})],Ke.prototype,"isListTile",void 0);l([h({type:Boolean})],Ke.prototype,"loggedIn",void 0);l([h({type:Object})],Ke.prototype,"model",void 0);l([h({type:String})],Ke.prototype,"viewSize",void 0);Ke=l([L("image-block")],Ke);let qo=class extends de{constructor(){super(...arguments),this.showInfoButton=!1}render(){return c`
      <div class="container">
    ...
    >`}get getSizeTemplate(){var e,t;const i=(t=(e=this.model)===null||e===void 0?void 0:e.collectionSize)!==null&&t!==void 0?t:0;return i?c`<span id="item-size">${ql(i,1)}</span>`:""}get infoButtonTemplate(){return this.showInfoButton?c`<button class="info-button" @click=${this.infoButtonPressed}>
      ...
      `]}};l([h({type:Boolean})],qo.prototype,"showInfoButton",void 0);qo=l([L("collection-tile")],qo);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;function mn(r,e){let t=1;return r>=1e9?t=1e9:r>=1e6?t=1e6:r>=1e3&&e==="short"&&(t=1e3),t}function gn(r=0,e){const t=r/e,i=t<10;let o=0;return i?o=Math.round((t+Number.EPSILON)*10)/10:o=Math.round(t),o}function bn(r,e,t,i){switch(e){case 1e9:return P(t==="short"?nt`${r}B`:nt`${r} billion`);case 1e6:return P(t==="short"?nt`${r}M`:nt`${r} million`);case 1e3:return P(t==="short"?nt`${r}K`:nt`${r} thousand`);default:return new Intl.NumberFormat(i).format(r)}}function oi(r,e="long",t="short",i="en-US"){const o=r!=null?r:-1;if(o<0)return"";const a=mn(o,e),s=gn(o,a);return bn(s,a,t,i)}let Xe=class extends R{render(){var e,t,i,o,a;const s=oi(this.favCount,"short","short"),n=oi(this.commentCount,"short","short"),d=this.mediatype==="account"?`${(e=this.itemCount)!==null&&e!==void 0?e:0} uploads`:`${(t=this.viewCount)!==null&&t!==void 0?t:0} ${(i=this.viewLabel)!==null&&i!==void 0?i:"all-time views"}`;return c`
    ...
    `}get isSortedByDate(){var e;return["date","reviewdate","addeddate","publicdate"].includes((e=this.sortParam)===null||e===void 0?void 0:e.field)}get hasSnippets(){var e,t;return!!(!((t=(e=this.model)===null||e===void 0?void 0:e.snippets)===null||t===void 0)&&t.length)}infoButtonPressed(e){e.preventDefault();const t=new CustomEvent("infoButtonPressed",{detail:{x:e.clientX,y:e.clientY}});this.dispatchEvent(t)}static get styles(){const e=g`var(--tileBorderColor, #dddddd)`;return[Yi,g`
      ...
      `]}};l([h({type:Boolean})],Qo.prototype,"showInfoButton",void 0);Qo=l([L("item-tile")],Qo);let Ko=class extends de{constructor(){super(...arguments),this.showInfoButton=!1}render(){return c`
      <div class="container">
        ${this.infoButtonTemplate}
        <div class="tile-details">
          <div class="item-info">
    ...
    >
      ...
      `]}};l([h({type:Boolean})],Ko.prototype,"showInfoButton",void 0);Ko=l([L("account-tile")],Ko);let Xo=class extends de{constructor(){super(...arguments),this.showInfoButton=!1}render(){return c`
      <div class="container">
        <div class="tile-details">
          <div class="item-info">
            ${this.getImageBlockTemplate} ${this.getTitleTemplate}
    ...
    `}get getTitleTemplate(){var e;return c`<div id="title">
      ...
      `]}};l([h({type:Boolean})],Xo.prototype,"showInfoButton",void 0);Xo=l([L("search-tile")],Xo);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Do;((Do=window.HTMLSlotElement)===null||Do===void 0?void 0:Do.prototype.assignedElements)!=null;var md=zs`<svg class="caret-up-svg" viewBox="0 0 8 4" xmlns="http://www.w3.org/2000/svg">
...
fill=""></path>
  ...
  `;sr=l([Ls("ia-icon-label")],sr);let lr=class extends R{constructor(){super(...arguments),this.numResults=0}render(){return c`
    ...
    `}};l([h({type:Number})],lr.prototype,"numResults",void 0);lr=l([L("alpha-bar-tooltip")],lr);let Ve=class extends R{constructor(){super(...arguments),this.selectedLetter=null,this.tooltipShown=!1,this.alphabet="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("")}get selectedUppercaseLetter(){var e;return(e=this.selectedLetter)===null||e===void 0?void 0:e.toUpperCase()}render(){var e;return c`
...
`;let nr=class extends R{constructor(){super(...arguments),this.config=new Qi}render(){return c`
