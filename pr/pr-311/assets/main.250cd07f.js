...
`,De;let Te=De=class extends F{constructor(){super(...arguments),this.placeholderType=null,this.detailMessage=""}render(){return this.placeholderType?h`${this.placeholderTemplate}`:y}get placeholderTemplate(){return h`
    ...
    <a href="mailto:info@archive.org">info@archive.org</a>.`);Te.QUERY_ERROR_DETAILS_MESSAGE=z("Error details:");n([p({type:String})],Te.prototype,"placeholderType",void 0);n([p({type:Boolean})],Te.prototype,"isMobileView",void 0);n([p({type:Boolean})],Te.prototype,"isCollection",void 0);n([p({type:String})],Te.prototype,"detailMessage",void 0);Te=De=n([B("empty-placeholder")],Te);/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
