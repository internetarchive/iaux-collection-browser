 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const vn=({finisher:r,descriptor:e})=>(t,i)=>{var o;if(i===void 0){const s=(o=t.originalKey)!==null&&o!==void 0?o:t.key,a=e!=null?{kind:"method",placement:"prototype",key:s,descriptor:e(t.key)}:me(te({},t),{key:s});return r!=null&&(a.finisher=function(l){r(l,s)}),a}{const s=t.constructor;e!==void 0&&Object.defineProperty(t,i,e(i)),r==null||r(s,i)}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Y(r,e){return vn({descriptor:t=>{const i={get(){var o,s;return(s=(o=this.renderRoot)===null||o===void 0?void 0:o.querySelector(r))!==null&&s!==void 0?s:null},enumerable:!0,configurable:!0};if(e){const o=typeof t=="symbol"?Symbol():"__"+t;i.get=function(){var s,a;return this[o]===void 0&&(this[o]=(a=(s=this.renderRoot)===null||s===void 0?void 0:s.querySelector(r))!==null&&a!==void 0?a:null),this[o]}}return i}})}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;function Ad(r,e){let t=1;return r>=1e9?t=1e9:r>=1e6?t=1e6:r>=1e3&&e==="short"&&(t=1e3),t}function Pd(r=0,e){const t=r/e,i=t<10;let o=0;return i?o=Math.round((t+Number.EPSILON)*10)/10:o=Math.round(t),o}function Ld(r,e,t,i){switch(e){case 1e9:return A(t==="short"?ut`${r}B`:ut`${r} billion`);case 1e6:return A(t==="short"?ut`${r}M`:ut`${r} million`);case 1e3:return A(t==="short"?ut`${r}K`:ut`${r} thousand`);default:return new Intl.NumberFormat(i).format(r)}}function bi(r,e="long",t="short",i="en-US"){const o=r!=null?r:-1;if(o<0)return"";const s=Ad(o,e),a=Pd(o,s);return Ld(a,s,t,i)}let et=class extends F{render(){var e,t,i,o,s;const a=bi(this.favCount,"short","short"),l=bi(this.commentCount,"short","short"),d=this.mediatype==="account"?`${(e=this.itemCount)!==null&&e!==void 0?e:0} uploads`:`${(t=this.viewCount)!==null&&t!==void 0?t:0} ${(i=this.viewLabel)!==null&&i!==void 0?i:"all-time views"}`;return h`
    ...
    `}get isSortedByDate(){var e;return["date","reviewdate","addeddate","publicdate"].includes((e=this.sortParam)===null||e===void 0?void 0:e.field)}get hasSnippets(){var e,t;return!!(!((t=(e=this.model)===null||e===void 0?void 0:e.snippets)===null||t===void 0)&&t.length)}infoButtonPressed(e){e.preventDefault();const t=new CustomEvent("infoButtonPressed",{detail:{x:e.clientX,y:e.clientY}});this.dispatchEvent(t)}static get styles(){const e=g`var(--tileBorderColor, #dddddd)`;return[wo,g`
      ...
      `]}};n([p({type:Boolean})],Mr.prototype,"showInfoButton",void 0);Mr=n([B("item-tile")],Mr);let zr=class extends ce{constructor(){super(...arguments),this.showInfoButton=!1}render(){return h`
      <div class="container">
        ${this.infoButtonTemplate}
        <div class="tile-details">
          <div class="item-info">
    ...
    >
      ...
      `]}};n([p({type:Boolean})],zr.prototype,"showInfoButton",void 0);zr=n([B("account-tile")],zr);let Ar=class extends ce{constructor(){super(...arguments),this.showInfoButton=!1}render(){return h`
      <div class="container">
        <div class="tile-details">
          <div class="item-info">
            ${this.getImageBlockTemplate} ${this.getTitleTemplate}
    ...
    `}get getTitleTemplate(){var e;return h`<div id="title">
      ...
      `]}};n([p({type:Boolean})],Ar.prototype,"showInfoButton",void 0);Ar=n([B("search-tile")],Ar);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Sa=r=>r!=null?r:re;var Ec=On`<svg class="caret-up-svg" viewBox="0 0 8 4" xmlns="http://www.w3.org/2000/svg">
...
`,Qr;let Zt=Qr=class extends F{render(){return h`${this.facetRowTemplate}`}get facetRowTemplate(){var e,t,i,o;const{bucket:s,facetType:a}=this;if(!s||!a)return y;const l=`${a}:${s.key}-show-only`,d=`${a}:${s.key}-negative`,c=a!=="collection"?h`${(e=s.displayText)!==null&&e!==void 0?e:s.key}`:h`<a href="/details/${s.key}">
    ...
    `}applySearchFacetsClicked(){var e,t;const i=new CustomEvent("facetsChanged",{detail:this.selectedFacets,bubbles:!0,composed:!0});this.dispatchEvent(i),(e=this.modalManager)===null||e===void 0||e.closeModal(),(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:Be.default,action:`${X.applyMoreFacetsModal}`,label:`${this.facetKey}`})}cancelClick(){var e,t;(e=this.modalManager)===null||e===void 0||e.closeModal(),(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:Be.default,action:X.closeMoreFacetsModal,label:`${this.facetKey}`})}static get styles(){const e=g`var(--primaryButtonBGColor, #194880)`;return[Ge,g`
      ...
      `]}};n([p({type:String})],ae.prototype,"facetKey",void 0);n([p({type:String})],ae.prototype,"facetAggregationKey",void 0);n([p({type:String})],ae.prototype,"query",void 0);n([p({type:Object})],ae.prototype,"filterMap",void 0);n([p({type:Object})],ae.prototype,"modalManager",void 0);n([p({type:Object})],ae.prototype,"searchService",void 0);n([p({type:String})],ae.prototype,"searchType",void 0);n([p({type:Object})],ae.prototype,"pageSpecifierParams",void 0);n([p({type:Object})],ae.prototype,"collectionTitles",void 0);n([p({type:Object})],ae.prototype,"selectedFacets",void 0);n([p({type:String})],ae.prototype,"sortedBy",void 0);n([p({type:Object,attribute:!1})],ae.prototype,"analyticsHandler",void 0);n([z()],ae.prototype,"aggregations",void 0);n([z()],ae.prototype,"facetGroup",void 0);n([z()],ae.prototype,"facetGroupTitle",void 0);n([z()],ae.prototype,"pageNumber",void 0);n([z()],ae.prototype,"facetsLoading",void 0);n([z()],ae.prototype,"paginationSize",void 0);n([z()],ae.prototype,"facetsType",void 0);ae=n([B("more-facets-content")],ae);let Xa=class extends F{render(){return h`
      <div id="row">
