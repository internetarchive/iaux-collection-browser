...
`;function al(a,e){let t=1;return a>=1e9?t=1e9:a>=1e6?t=1e6:a>=1e3&&e==="short"&&(t=1e3),t}function rl(a=0,e){const t=a/e,i=t<10;let o=0;return i?o=Math.round((t+Number.EPSILON)*10)/10:o=Math.round(t),o}function sl(a,e,t,i){switch(e){case 1e9:return A(t==="short"?vt`${a}B`:vt`${a} billion`);case 1e6:return A(t==="short"?vt`${a}M`:vt`${a} million`);case 1e3:return A(t==="short"?vt`${a}K`:vt`${a} thousand`);default:return new Intl.NumberFormat(i).format(a)}}function si(a,e="long",t="short",i="en-US"){const o=a!=null?a:-1;if(o<0)return"";const r=al(o,e),s=rl(o,r);return sl(s,r,t,i)}let tt=class extends O{render(){var e;const t=si(this.favCount,"short","short"),i=si(this.commentCount,"short","short"),o=this.mediatype==="account"?`${this.itemCount} uploads`:`${this.viewCount} ${(e=this.viewLabel)!==null&&e!==void 0?e:"all-time views"}`;return h`
    ...
    `}get isSortedByDate(){var e;return["date","reviewdate","addeddate","publicdate"].includes((e=this.sortParam)===null||e===void 0?void 0:e.field)}get hasSnippets(){var e,t;return!!(!((t=(e=this.model)===null||e===void 0?void 0:e.snippets)===null||t===void 0)&&t.length)}infoButtonPressed(e){e.preventDefault();const t=new CustomEvent("infoButtonPressed",{detail:{x:e.clientX,y:e.clientY}});this.dispatchEvent(t)}static get styles(){const e=g`var(--tileBorderColor, #dddddd)`;return[to,g`
      ...
      `]}};n([p({type:Boolean})],qo.prototype,"showInfoButton",void 0);qo=n([L("item-tile")],qo);let Qo=class extends ce{constructor(){super(...arguments),this.showInfoButton=!1}render(){return h`
      <div class="container">
        ${this.infoButtonTemplate}
        <div class="tile-details">
          <div class="item-info">
    ...
    >
      ...
      `]}};n([p({type:Boolean})],Qo.prototype,"showInfoButton",void 0);Qo=n([L("account-tile")],Qo);let Ko=class extends ce{constructor(){super(...arguments),this.showInfoButton=!1}render(){return h`
      <div class="container">
        <div class="tile-details">
          <div class="item-info">
            ${this.getImageBlockTemplate} ${this.getTitleTemplate}
