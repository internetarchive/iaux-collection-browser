 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*Bt(r,e){if(r!==void 0){let t=0;for(const i of r)yield e(i,t++)}}function pd(r){return new Date(r.getTime()-r.getTimezoneOffset()*1e3*60)}function rs(r){return r?pd(r).toISOString().endsWith("-01-01T00:00:00.000Z"):!1}const Tn=h`
...
`;let Ht=class extends F{constructor(){super(...arguments),this.title="",this.body="",this.starRating=0,this.viewSize="desktop"}render(){return!this.title&&!this.body&&!this.starRating?y:h`
    ...
    `}static get styles(){return[Ge,g`
      ...
      `]}};n([p({type:String})],Ht.prototype,"title",void 0);n([p({type:String})],Ht.prototype,"body",void 0);n([p({type:Number})],Ht.prototype,"starRating",void 0);n([p({type:String})],Ht.prototype,"viewSize",void 0);Ht=n([O("review-block")],Ht);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`+be),xt&&(be=Qe(be,ot," "),be=Qe(be,rt," ")),R&&Ii?R.createHTML(be):be},e.setConfig=function(M){Po(M),Co=!0},e.clearConfig=function(){Et=null,Co=!1},e.isValidAttribute=function(M,f,$){Et||Po({});var C=nt(M),V=nt(f);return ks(C,V,$)},e.addHook=function(M,f){typeof f=="function"&&(_e[M]=_e[M]||[],pi(_e[M],f))},e.removeHook=function(M){if(_e[M])return Js(_e[M])},e.removeHooks=function(M){_e[M]&&(_e[M]=[])},e.removeAllHooks=function(){_e={}},e}var Zi=An();let co=class extends ce{constructor(){super(...arguments),this.collectionLinks=[]}render(){return h`
    ...
    `:y}get volumeTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.volume,z("Volume"))}get issueTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.issue,z("Issue"))}get creatorTemplate(){var e,t,i;return((e=this.model)===null||e===void 0?void 0:e.mediatype)==="account"?h`
      ...
      <div id="creator" class="metadata">
        ...
        ${Ki(Bt(this.model.creators,o=>this.searchLink("creator",o)),", ")}
      </div>
    `}get datePublishedTemplate(){var e;const t=(e=this.model)===null||e===void 0?void 0:e.datePublished;let i="long";return rs(t)&&(i="year-only"),this.metadataTemplate(Nt(t,i),z("Published"))}get dateSortByTemplate(){return this.sortParam&&(this.sortParam.field==="addeddate"||this.sortParam.field==="reviewdate"||this.sortParam.field==="publicdate")?this.metadataTemplate(Nt(this.date,"long"),this.displayValueProvider.dateLabel):y}get viewsTemplate(){var e,t,i,o;const s=((e=this.sortParam)===null||e===void 0?void 0:e.field)==="week"?(t=this.model)===null||t===void 0?void 0:t.weeklyViewCount:(i=this.model)===null||i===void 0?void 0:i.viewCount;return s==null?y:((o=this.model)===null||o===void 0?void 0:o.mediatype)==="search"?this.metadataTemplate("(Favorited search query)",""):this.metadataTemplate(`${bi(s,this.formatSize)}`,z("Views"))}get ratingTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.averageRating,z("Avg Rating"))}get reviewsTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.commentCount,z("Reviews"))}get topicsTemplate(){var e;return!(!((e=this.model)===null||e===void 0)&&e.subjects)||this.model.subjects.length===0?y:h`
      <div id="topics" class="metadata">
        ${this.labelTemplate(z("Topics"))}
        ${Ki(Bt(this.model.subjects,t=>this.searchLink("subject",t)),", ")}
      </div>
...
`;let Gt=class extends F{constructor(){super(...arguments),this.label=z("Select items to remove"),this.showSelectAll=!1,this.showUnselectAll=!1,this.removeAllowed=!1}render(){return h`
    ...
    `}};n([p({type:String})],Gt.prototype,"label",void 0);n([p({type:Boolean})],Gt.prototype,"showSelectAll",void 0);n([p({type:Boolean})],Gt.prototype,"showUnselectAll",void 0);n([p({type:Boolean})],Gt.prototype,"removeAllowed",void 0);Gt=n([O("manage-bar")],Gt);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;let qr=class extends Rt{constructor(){super(...arguments),this.config=new vo}render(){return Ke`
    ...
    `}};n([_o({type:String,reflect:!0})],Xt.prototype,"mode",void 0);n([_o({type:Object})],Xt.prototype,"customModalContent",void 0);n([_o({type:Object})],Xt.prototype,"hostBridge",void 0);n([U0("modal-template")],Xt.prototype,"modalTemplate",void 0);Xt=n([Yn("modal-manager")],Xt);var G0=h`
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path
...
`;let Yt=class extends F{constructor(){super(...arguments),this.step=2,this.currentPage=1,this.pages=[]}firstUpdated(){this.observePageCount()}updated(e){e.has("size")&&this.observePageCount(),e.has("currentPage")&&(this.observePageCount(),this.emitPageClick())}observePageCount(){this.pages=[];const e=7,t=this.size<=e;if(this.size<=5){this.pages=[...Array(this.size).keys()].map(s=>s+1);return}if(this.size===e){if(this.currentPage===2){this.pages=[1,2,3,4,0,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,4,5,this.size-1,this.size];return}}if(this.currentPage===1){this.pages=[1,2,3,0,this.size];return}if(this.currentPage===this.size){this.pages=[1,0,this.size-2,this.size-1,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,this.size-3,this.size-2,this.size-1,this.size];return}if(t&&this.currentPage>1&&this.currentPage<e){this.pages=[...Array(this.size).keys()].map(s=>s+1);return}let i=this.currentPage-this.step,o=this.currentPage+this.step;i<=0&&(o+=-i+1,i=1),o>=this.size&&(i=Math.max(i-(o-this.size),1),o=this.size),i===2&&(o-=1),o===this.size-1&&(i+=1),this.createFirstNode(i),this.createMiddelNode(i,o),this.createLastNode(o)}createFirstNode(e){var t,i;e>1&&((t=this.pages)===null||t===void 0||t.push(1)),e>2&&((i=this.pages)===null||i===void 0||i.push(0))}createMiddelNode(e,t){var i;for(let o=e;o<=t;o+=1)(i=this.pages)===null||i===void 0||i.push(o)}createLastNode(e){var t,i;e<this.size-1&&((t=this.pages)===null||t===void 0||t.push(0)),e<this.size&&((i=this.pages)===null||i===void 0||i.push(this.size))}get getEllipsisTemplate(){return h`<i class="ellipses">...</i>`}emitPageClick(){this.dispatchEvent(new CustomEvent("pageNumberClicked",{detail:{page:this.currentPage},bubbles:!0,composed:!0}))}onRewind(){this.currentPage-=1,this.currentPage<1&&(this.currentPage=1)}onForward(){this.currentPage+=1,this.currentPage>this.size&&(this.currentPage=this.size)}onChange(e){this.currentPage=e}getPageTemplate(e){return h`
    ...
    `}static get styles(){return[Ge,g`
      ...
      `]}};n([p({type:Number})],Yt.prototype,"size",void 0);n([p({type:Number})],Yt.prototype,"step",void 0);n([p({type:Number})],Yt.prototype,"currentPage",void 0);n([A()],Yt.prototype,"pages",void 0);Yt=n([O("more-facets-pagination")],Yt);var K0=I`
...
`,Qr;let Zt=Qr=class extends F{render(){return h`${this.facetRowTemplate}`}get facetRowTemplate(){var e,t,i,o;const{bucket:s,facetType:a}=this;if(!s||!a)return y;const l=`${a}:${s.key}-show-only`,d=`${a}:${s.key}-negative`,c=a!=="collection"?h`${(e=s.displayText)!==null&&e!==void 0?e:s.key}`:h`<a href="/details/${s.key}">
    ...
    `}};n([p({type:String})],Zt.prototype,"facetType",void 0);n([p({type:Object})],Zt.prototype,"bucket",void 0);n([p({type:Object})],Zt.prototype,"collectionTitles",void 0);Zt=Qr=n([O("facet-row")],Zt);let Jt=class extends F{facetClicked(e){const{bucket:t,negative:i}=e.detail;t.state==="none"?this.facetUnchecked(t):this.facetChecked(t,i),this.dispatchFacetClickEvent(e.detail)}facetChecked(e,t){const{facetGroup:i,selectedFacets:o}=this;if(!i)return;let s;o?s=ee({},o):s=Lt(),s[i.key][e.key]=me(ee({},e),{state:Zt.getFacetState(!0,t)}),this.selectedFacets=s,this.dispatchSelectedFacetsChanged()}facetUnchecked(e){const{facetGroup:t,selectedFacets:i}=this;if(!t)return;let o;i?o=ee({},i):o=Lt(),delete o[t.key][e.key],this.selectedFacets=o,this.dispatchSelectedFacetsChanged()}dispatchFacetClickEvent(e){const t=new CustomEvent("facetClick",{detail:e,composed:!0});this.dispatchEvent(t)}dispatchSelectedFacetsChanged(){const e=new CustomEvent("selectedFacetsChanged",{detail:this.selectedFacets,bubbles:!0,composed:!0});this.dispatchEvent(e)}get facetsTemplate(){const{facetGroup:e}=this;if(!e)return y;let t=e.buckets;return t=[...t.filter(i=>i.state==="selected").sort((i,o)=>i.count<o.count?1:-1),...t.filter(i=>i.state==="hidden").sort((i,o)=>i.count<o.count?1:-1),...t.filter(i=>i.state==="none")],h`
    ...
    `}};n([p({type:Object})],Jt.prototype,"facetGroup",void 0);n([p({type:Object})],Jt.prototype,"selectedFacets",void 0);n([p({type:String})],Jt.prototype,"renderOn",void 0);n([p({type:Object})],Jt.prototype,"collectionTitles",void 0);Jt=n([O("facets-template")],Jt);let it=class extends F{constructor(){super(...arguments),this.leftValue="",this.rightValue="",this.side="left"}render(){var e,t;return h`
      <div id="container">
    ...
    `}get collectionPartOfTemplate(){if(!this.withinCollection||this.parentCollections.length===0)return y;const e="partof-heading";return h`
      ...
      >
        ...
        <ul>
          ${Bt(this.parentCollections,t=>{var i,o;const s=`${this.baseNavigationUrl}${this.collectionPagePath}${t}`;return h` <li>
              <a
                href=${s}
                data-id=${t}
    ...
    `}clearFiltersBtnTemplate(e){if(!this.hasActiveFilters)return y;const t=Ut({"clear-filters-btn":!0,mobile:e}),i=e?"Clear all":"Clear all filters";return h`
    ...
    `:this.placeholderCellTemplate}scrollThresholdReached(){!this.dataSource.endOfDataReached&&this.dataSource.queryInitialized&&(this.pagesToRender+=1,this.dataSource.fetchPage(this.pagesToRender))}static get styles(){return[Ge,g`
        :host {
          display: block;
