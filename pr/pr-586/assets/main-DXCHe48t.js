...
`+d),De&&_o([le,ue,de],e=>{d=To(d,e,` `)}),_&&Ne?_.createHTML(d):d},t.setConfig=function(){ot(arguments.length>0&&arguments[0]!==void 0?arguments[0]:{}),Ae=!0},t.clearConfig=function(){rt=null,Ae=!1},t.isValidAttribute=function(e,t,n){return rt||ot({}),vt(S(e),S(t),n)},t.addHook=function(e,t){typeof t==`function`&&bo(ce[e],t)},t.removeHook=function(e,t){if(t!==void 0){let n=vo(ce[e],t);return n===-1?void 0:xo(ce[e],n,1)[0]}return yo(ce[e])},t.removeHooks=function(e){ce[e]=[]},t.removeAllHooks=function(){ce=ss()},t}var ls=cs(),us=class extends R{constructor(...e){super(...e),this.collectionLinks=[]}render(){return T`
    ...
    `}};L([A({type:Object})],us.prototype,`collectionTitles`,void 0),L([j()],us.prototype,`collectionLinks`,void 0),us=L([k(`tile-list`)],us);var ds=class extends O{constructor(...e){super(...e),this.loggedIn=!1,this.suppressBlurring=!1}render(){return T`
      <div id="container">
        <focus-trap>
          ${this.headerTemplate}
    ...
    `}};L([A({type:Object})],ds.prototype,`model`,void 0),L([A({type:String})],ds.prototype,`baseNavigationUrl`,void 0),L([A({type:String})],ds.prototype,`baseImageUrl`,void 0),L([A({type:Boolean})],ds.prototype,`loggedIn`,void 0),L([A({type:Boolean})],ds.prototype,`suppressBlurring`,void 0),L([A({type:Object})],ds.prototype,`sortParam`,void 0),L([A({type:Number})],ds.prototype,`mobileBreakpoint`,void 0),L([A({type:Number})],ds.prototype,`currentWidth`,void 0),L([A({type:Object})],ds.prototype,`collectionTitles`,void 0),ds=L([k(`tile-hover-pane`)],ds);var fs=class extends R{render(){return T`
      <div id="list-line" class="${this.classSize}">
        <image-block
          .model=${this.model}
          .baseImageUrl=${this.baseImageUrl}
    ...
    `}};fs=L([k(`tile-list-compact`)],fs);var ps=class extends R{render(){return T`
    ...
    `}firstUpdated(){this.shouldPrepareHoverPane&&(this.hoverPaneController=new hs(this,{mobileBreakpoint:this.mobileBreakpoint,enableLongPress:!1}))}get headerTemplate(){let{currentWidth:e,sortParam:t,defaultSortParam:n,mobileBreakpoint:r}=this;return T`
    ...
    `}get shouldPrepareHoverPane(){return this.enableHoverPane&&!!this.tileDisplayMode&&gs.HOVER_PANE_DISPLAY_MODES[this.tileDisplayMode]&&this.model?.mediatype!==`search`&&!this.model?.captureDates}get isHoverEnabled(){return window.matchMedia(`(hover: hover)`).matches}get shouldShowInfoButton(){return!this.isHoverEnabled&&this.shouldPrepareHoverPane}getHoverPane(){return this.hoverPane}getHoverPaneProps(){return this}handleResize(e){this.currentWidth=e.contentRect.width,this.currentHeight=e.contentRect.height}disconnectedCallback(){this.stopResizeObservation(this.resizeObserver)}stopResizeObservation(e){e?.removeObserver({handler:this,target:this.container})}startResizeObservation(){this.stopResizeObservation(this.resizeObserver),this.resizeObserver?.addObserver({handler:this,target:this.container})}updated(e){if(e.has(`resizeObserver`)){let t=e.get(`resizeObserver`);this.stopResizeObservation(t),this.startResizeObservation()}}handleLinkClicked(e){this.isManageView&&(e.preventDefault(),this.model&&(this.model.checked=!this.model.checked)),this.dispatchEvent(new CustomEvent(`resultSelected`,{detail:this.model}))}handleLinkContextMenu(e){this.isManageView&&this.linkTileHref!==D&&(e.preventDefault(),window.open(this.linkTileHref,`_blank`))}tileInfoButtonPressed(e){this.hoverPaneController?.toggleHoverPane({coords:e.detail,enableTouchBackdrop:!0})}get tile(){let{model:e,collectionPagePath:t,baseNavigationUrl:n,currentWidth:r,currentHeight:i,sortParam:a,creatorFilter:o,mobileBreakpoint:s,defaultSortParam:c}=this;if(!e)return D;switch(this.tileDisplayMode){case`grid`:switch(e.mediatype){case`collection`:return T`<collection-tile
        ...
        >
          ...
          ?useLocalTime=${this.useLocalTime}
        >
        </tile-list>`;default:return D}}static get styles(){return[Ai,w`
        :host {
          display: block;
          height: 100%;
        }
      ...
      `]}};L([A({type:String})],_s.prototype,`tileDisplayMode`,void 0),L([A({type:Boolean})],_s.prototype,`isManageView`,void 0),L([A({type:Object})],_s.prototype,`resizeObserver`,void 0),L([A({type:Object})],_s.prototype,`collectionTitles`,void 0),L([A({type:Boolean})],_s.prototype,`showTvClips`,void 0),L([A({type:String})],_s.prototype,`layoutType`,void 0),L([A({type:Boolean})],_s.prototype,`enableHoverPane`,void 0),L([A({type:String})],_s.prototype,`manageCheckTitle`,void 0),L([M(`#container`)],_s.prototype,`container`,void 0),L([M(`tile-hover-pane`)],_s.prototype,`hoverPane`,void 0),L([M(`.tile-link`)],_s.prototype,`tileLinkElement`,void 0),_s=gs=L([k(`tile-dispatcher`)],_s);var vs=class extends O{render(){return T` <div id="container"></div> `}static get styles(){return w`
      :host {
        display: block;
        height: 100%;
      }
    ...
    `}};vs=L([k(`collection-browser-loading-tile`)],vs);var ys=T`
...
`,Ts=window,Es=Ts.ShadowRoot&&(Ts.ShadyCSS===void 0||Ts.ShadyCSS.nativeShadow)&&`adoptedStyleSheets`in Document.prototype&&`replace`in CSSStyleSheet.prototype,Ds=Symbol(),Os=new WeakMap,ks=class{constructor(e,t,n){if(this._$cssResult$=!0,n!==Ds)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o,t=this.t;if(Es&&e===void 0){let n=t!==void 0&&t.length===1;n&&(e=Os.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),n&&Os.set(t,e))}return e}toString(){return this.cssText}},As=e=>new ks(typeof e==`string`?e:e+``,void 0,Ds),B=(e,...t)=>new ks(e.length===1?e[0]:t.reduce(((t,n,r)=>t+(e=>{if(!0===e._$cssResult$)return e.cssText;if(typeof e==`number`)return e;throw Error(`Value passed to 'css' function must be a 'css' function result: `+e+`. Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.`)})(n)+e[r+1]),e[0]),e,Ds),js=(e,t)=>{Es?e.adoptedStyleSheets=t.map((e=>e instanceof CSSStyleSheet?e:e.styleSheet)):t.forEach((t=>{let n=document.createElement(`style`),r=Ts.litNonce;r!==void 0&&n.setAttribute(`nonce`,r),n.textContent=t.cssText,e.appendChild(n)}))},Ms=Es?e=>e:e=>e instanceof CSSStyleSheet?(e=>{let t=``;for(let n of e.cssRules)t+=n.cssText;return As(t)})(e):e,Ns=window,Ps=Ns.trustedTypes,Fs=Ps?Ps.emptyScript:``,Is=Ns.reactiveElementPolyfillSupport,Ls={toAttribute(e,t){switch(t){case Boolean:e=e?Fs:null;break;case Object:case Array:e=e==null?e:JSON.stringify(e)}return e},fromAttribute(e,t){let n=e;switch(t){case Boolean:n=e!==null;break;case Number:n=e===null?null:Number(e);break;case Object:case Array:try{n=JSON.parse(e)}catch{n=null}}return n}},Rs=(e,t)=>t!==e&&(t==t||e==e),zs={attribute:!0,type:String,converter:Ls,reflect:!1,hasChanged:Rs},Bs=`finalized`,Vs=class extends HTMLElement{constructor(){super(),this._$Ei=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$El=null,this._$Eu()}static addInitializer(e){this.finalize(),(this.h??=[]).push(e)}static get observedAttributes(){this.finalize();let e=[];return this.elementProperties.forEach(((t,n)=>{let r=this._$Ep(n,t);r!==void 0&&(this._$Ev.set(r,n),e.push(r))})),e}static createProperty(e,t=zs){if(t.state&&(t.attribute=!1),this.finalize(),this.elementProperties.set(e,t),!t.noAccessor&&!this.prototype.hasOwnProperty(e)){let n=typeof e==`symbol`?Symbol():`__`+e,r=this.getPropertyDescriptor(e,n,t);r!==void 0&&Object.defineProperty(this.prototype,e,r)}}static getPropertyDescriptor(e,t,n){return{get(){return this[t]},set(r){let i=this[e];this[t]=r,this.requestUpdate(e,i,n)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)||zs}static finalize(){if(this.hasOwnProperty(Bs))return!1;this[Bs]=!0;let e=Object.getPrototypeOf(this);if(e.finalize(),e.h!==void 0&&(this.h=[...e.h]),this.elementProperties=new Map(e.elementProperties),this._$Ev=new Map,this.hasOwnProperty(`properties`)){let e=this.properties,t=[...Object.getOwnPropertyNames(e),...Object.getOwnPropertySymbols(e)];for(let n of t)this.createProperty(n,e[n])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(e){let t=[];if(Array.isArray(e)){let n=new Set(e.flat(1/0).reverse());for(let e of n)t.unshift(Ms(e))}else e!==void 0&&t.push(Ms(e));return t}static _$Ep(e,t){let n=t.attribute;return!1===n?void 0:typeof n==`string`?n:typeof e==`string`?e.toLowerCase():void 0}_$Eu(){var e;this._$E_=new Promise((e=>this.enableUpdating=e)),this._$AL=new Map,this._$Eg(),this.requestUpdate(),(e=this.constructor.h)==null||e.forEach((e=>e(this)))}addController(e){var t;(this._$ES??=[]).push(e),this.renderRoot!==void 0&&this.isConnected&&((t=e.hostConnected)==null||t.call(e))}removeController(e){var t;(t=this._$ES)==null||t.splice(this._$ES.indexOf(e)>>>0,1)}_$Eg(){this.constructor.elementProperties.forEach(((e,t)=>{this.hasOwnProperty(t)&&(this._$Ei.set(t,this[t]),delete this[t])}))}createRenderRoot(){let e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return js(e,this.constructor.elementStyles),e}connectedCallback(){var e;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$ES)==null||e.forEach((e=>e.hostConnected?.call(e)))}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$ES)==null||e.forEach((e=>e.hostDisconnected?.call(e)))}attributeChangedCallback(e,t,n){this._$AK(e,n)}_$EO(e,t,n=zs){let r=this.constructor._$Ep(e,n);if(r!==void 0&&!0===n.reflect){let i=(n.converter?.toAttribute===void 0?Ls:n.converter).toAttribute(t,n.type);this._$El=e,i==null?this.removeAttribute(r):this.setAttribute(r,i),this._$El=null}}_$AK(e,t){let n=this.constructor,r=n._$Ev.get(e);if(r!==void 0&&this._$El!==r){let e=n.getPropertyOptions(r),i=typeof e.converter==`function`?{fromAttribute:e.converter}:e.converter?.fromAttribute===void 0?Ls:e.converter;this._$El=r,this[r]=i.fromAttribute(t,e.type),this._$El=null}}requestUpdate(e,t,n){let r=!0;e!==void 0&&(((n||=this.constructor.getPropertyOptions(e)).hasChanged||Rs)(this[e],t)?(this._$AL.has(e)||this._$AL.set(e,t),!0===n.reflect&&this._$El!==e&&(this._$EC===void 0&&(this._$EC=new Map),this._$EC.set(e,n))):r=!1),!this.isUpdatePending&&r&&(this._$E_=this._$Ej())}async _$Ej(){this.isUpdatePending=!0;try{await this._$E_}catch(e){Promise.reject(e)}let e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var e;if(!this.isUpdatePending)return;this.hasUpdated,this._$Ei&&=(this._$Ei.forEach(((e,t)=>this[t]=e)),void 0);let t=!1,n=this._$AL;try{t=this.shouldUpdate(n),t?(this.willUpdate(n),(e=this._$ES)==null||e.forEach((e=>e.hostUpdate?.call(e))),this.update(n)):this._$Ek()}catch(e){throw t=!1,this._$Ek(),e}t&&this._$AE(n)}willUpdate(e){}_$AE(e){var t;(t=this._$ES)==null||t.forEach((e=>e.hostUpdated?.call(e))),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$Ek(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$E_}shouldUpdate(e){return!0}update(e){this._$EC!==void 0&&(this._$EC.forEach(((e,t)=>this._$EO(t,this[t],e))),this._$EC=void 0),this._$Ek()}updated(e){}firstUpdated(e){}};Vs[Bs]=!0,Vs.elementProperties=new Map,Vs.elementStyles=[],Vs.shadowRootOptions={mode:`open`},Is?.({ReactiveElement:Vs}),(Ns.reactiveElementVersions??=[]).push(`1.6.3`);var Hs=window,Us=Hs.trustedTypes,Ws=Us?Us.createPolicy(`lit-html`,{createHTML:e=>e}):void 0,Gs=`$lit$`,Ks=`lit$${(Math.random()+``).slice(9)}$`,qs=`?`+Ks,Js=`<${qs}>`,Ys=document,Xs=()=>Ys.createComment(``),Zs=e=>e===null||typeof e!=`object`&&typeof e!=`function`,Qs=Array.isArray,$s=e=>Qs(e)||typeof e?.[Symbol.iterator]==`function`,ec=`[ 	
\f\r]`,tc=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,nc=/-->/g,rc=/>/g,ic=RegExp(`>|${ec}(?:([^\\s"'>=/]+)(${ec}*=${ec}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,`g`),ac=/'/g,oc=/"/g,sc=/^(?:script|style|textarea|title)$/i,cc=e=>(t,...n)=>({_$litType$:e,strings:t,values:n}),lc=cc(1),uc=cc(2),dc=Symbol.for(`lit-noChange`),fc=Symbol.for(`lit-nothing`),pc=new WeakMap,mc=Ys.createTreeWalker(Ys,129,null,!1);function hc(e,t){if(!Array.isArray(e)||!e.hasOwnProperty(`raw`))throw Error(`invalid template strings array`);return Ws===void 0?t:Ws.createHTML(t)}var gc=(e,t)=>{let n=e.length-1,r=[],i,a=t===2?`<svg>`:``,o=tc;for(let t=0;t<n;t++){let n=e[t],s,c,l=-1,u=0;for(;u<n.length&&(o.lastIndex=u,c=o.exec(n),c!==null);)u=o.lastIndex,o===tc?c[1]===`!--`?o=nc:c[1]===void 0?c[2]===void 0?c[3]!==void 0&&(o=ic):(sc.test(c[2])&&(i=RegExp(`</`+c[2],`g`)),o=ic):o=rc:o===ic?c[0]===`>`?(o=i??tc,l=-1):c[1]===void 0?l=-2:(l=o.lastIndex-c[2].length,s=c[1],o=c[3]===void 0?ic:c[3]===`"`?oc:ac):o===oc||o===ac?o=ic:o===nc||o===rc?o=tc:(o=ic,i=void 0);let d=o===ic&&e[t+1].startsWith(`/>`)?` `:``;a+=o===tc?n+Js:l>=0?(r.push(s),n.slice(0,l)+Gs+n.slice(l)+Ks+d):n+Ks+(l===-2?(r.push(void 0),t):d)}return[hc(e,a+(e[n]||`<?>`)+(t===2?`</svg>`:``)),r]},_c=class e{constructor({strings:t,_$litType$:n},r){let i;this.parts=[];let a=0,o=0,s=t.length-1,c=this.parts,[l,u]=gc(t,n);if(this.el=e.createElement(l,r),mc.currentNode=this.el.content,n===2){let e=this.el.content,t=e.firstChild;t.remove(),e.append(...t.childNodes)}for(;(i=mc.nextNode())!==null&&c.length<s;){if(i.nodeType===1){if(i.hasAttributes()){let e=[];for(let t of i.getAttributeNames())if(t.endsWith(Gs)||t.startsWith(Ks)){let n=u[o++];if(e.push(t),n!==void 0){let e=i.getAttribute(n.toLowerCase()+Gs).split(Ks),t=/([.?@])?(.*)/.exec(n);c.push({type:1,index:a,name:t[2],strings:e,ctor:t[1]===`.`?Sc:t[1]===`?`?wc:t[1]===`@`?Tc:xc})}else c.push({type:6,index:a})}for(let t of e)i.removeAttribute(t)}if(sc.test(i.tagName)){let e=i.textContent.split(Ks),t=e.length-1;if(t>0){i.textContent=Us?Us.emptyScript:``;for(let n=0;n<t;n++)i.append(e[n],Xs()),mc.nextNode(),c.push({type:2,index:++a});i.append(e[t],Xs())}}}else if(i.nodeType===8)if(i.data===qs)c.push({type:2,index:a});else{let e=-1;for(;(e=i.data.indexOf(Ks,e+1))!==-1;)c.push({type:7,index:a}),e+=Ks.length-1}a++}}static createElement(e,t){let n=Ys.createElement(`template`);return n.innerHTML=e,n}};function vc(e,t,n=e,r){var i,a;if(t===dc)return t;let o=r===void 0?n._$Cl:n._$Co?.[r],s=Zs(t)?void 0:t._$litDirective$;return o?.constructor!==s&&((i=o?._$AO)==null||i.call(o,!1),s===void 0?o=void 0:(o=new s(e),o._$AT(e,n,r)),r===void 0?n._$Cl=o:((a=n)._$Co??(a._$Co=[]))[r]=o),o!==void 0&&(t=vc(e,o._$AS(e,t.values),o,r)),t}var yc=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:n}=this._$AD,r=(e?.creationScope??Ys).importNode(t,!0);mc.currentNode=r;let i=mc.nextNode(),a=0,o=0,s=n[0];for(;s!==void 0;){if(a===s.index){let t;s.type===2?t=new bc(i,i.nextSibling,this,e):s.type===1?t=new s.ctor(i,s.name,s.strings,this,e):s.type===6&&(t=new Ec(i,this,e)),this._$AV.push(t),s=n[++o]}a!==s?.index&&(i=mc.nextNode(),a++)}return mc.currentNode=Ys,r}v(e){let t=0;for(let n of this._$AV)n!==void 0&&(n.strings===void 0?n._$AI(e[t]):(n._$AI(e,n,t),t+=n.strings.length-2)),t++}},bc=class e{constructor(e,t,n,r){var i;this.type=2,this._$AH=fc,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=r,this._$Cp=(i=r?.isConnected)==null||i}get _$AU(){return this._$AM?._$AU??this._$Cp}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=vc(this,e,t),Zs(e)?e===fc||e==null||e===``?(this._$AH!==fc&&this._$AR(),this._$AH=fc):e!==this._$AH&&e!==dc&&this._(e):e._$litType$===void 0?e.nodeType===void 0?$s(e)?this.T(e):this._(e):this.$(e):this.g(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==fc&&Zs(this._$AH)?this._$AA.nextSibling.data=e:this.$(Ys.createTextNode(e)),this._$AH=e}g(e){let{values:t,_$litType$:n}=e,r=typeof n==`number`?this._$AC(e):(n.el===void 0&&(n.el=_c.createElement(hc(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===r)this._$AH.v(t);else{let e=new yc(r,this),n=e.u(this.options);e.v(t),this.$(n),this._$AH=e}}_$AC(e){let t=pc.get(e.strings);return t===void 0&&pc.set(e.strings,t=new _c(e)),t}T(t){Qs(this._$AH)||(this._$AH=[],this._$AR());let n=this._$AH,r,i=0;for(let a of t)i===n.length?n.push(r=new e(this.k(Xs()),this.k(Xs()),this,this.options)):r=n[i],r._$AI(a),i++;i<n.length&&(this._$AR(r&&r._$AB.nextSibling,i),n.length=i)}_$AR(e=this._$AA.nextSibling,t){var n;for((n=this._$AP)==null||n.call(this,!1,!0,t);e&&e!==this._$AB;){let t=e.nextSibling;e.remove(),e=t}}setConnected(e){var t;this._$AM===void 0&&(this._$Cp=e,(t=this._$AP)==null||t.call(this,e))}},xc=class{constructor(e,t,n,r,i){this.type=1,this._$AH=fc,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=i,n.length>2||n[0]!==``||n[1]!==``?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=fc}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,n,r){let i=this.strings,a=!1;if(i===void 0)e=vc(this,e,t,0),a=!Zs(e)||e!==this._$AH&&e!==dc,a&&(this._$AH=e);else{let r=e,o,s;for(e=i[0],o=0;o<i.length-1;o++)s=vc(this,r[n+o],t,o),s===dc&&(s=this._$AH[o]),a||=!Zs(s)||s!==this._$AH[o],s===fc?e=fc:e!==fc&&(e+=(s??``)+i[o+1]),this._$AH[o]=s}a&&!r&&this.j(e)}j(e){e===fc?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??``)}},Sc=class extends xc{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===fc?void 0:e}},Cc=Us?Us.emptyScript:``,wc=class extends xc{constructor(){super(...arguments),this.type=4}j(e){e&&e!==fc?this.element.setAttribute(this.name,Cc):this.element.removeAttribute(this.name)}},Tc=class extends xc{constructor(e,t,n,r,i){super(e,t,n,r,i),this.type=5}_$AI(e,t=this){if((e=vc(this,e,t,0)??fc)===dc)return;let n=this._$AH,r=e===fc&&n!==fc||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,i=e!==fc&&(n===fc||r);r&&this.element.removeEventListener(this.name,this,n),i&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH==`function`?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},Ec=class{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){vc(this,e)}},Dc=Hs.litHtmlPolyfillSupport;Dc?.(_c,bc),(Hs.litHtmlVersions??=[]).push(`2.8.0`);var Oc=(e,t,n)=>{let r=n?.renderBefore??t,i=r._$litPart$;if(i===void 0){let e=n?.renderBefore??null;r._$litPart$=i=new bc(t.insertBefore(Xs(),e),e,void 0,n??{})}return i._$AI(e),i},kc,Ac=class extends Vs{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e;let t=super.createRenderRoot();return(e=this.renderOptions).renderBefore??(e.renderBefore=t.firstChild),t}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Oc(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)==null||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)==null||e.setConnected(!1)}render(){return dc}};Ac.finalized=!0,Ac._$litElement$=!0,(kc=globalThis.litElementHydrateSupport)==null||kc.call(globalThis,{LitElement:Ac});var jc=globalThis.litElementPolyfillSupport;jc?.({LitElement:Ac}),(globalThis.litElementVersions??(globalThis.litElementVersions=[])).push(`3.3.3`);var Mc=e=>t=>typeof t==`function`?((e,t)=>(customElements.define(e,t),t))(e,t):((e,t)=>{let{kind:n,elements:r}=t;return{kind:n,elements:r,finisher(t){customElements.define(e,t)}}})(e,t),Nc=(e,t)=>t.kind===`method`&&t.descriptor&&!(`value`in t.descriptor)?{...t,finisher(n){n.createProperty(t.key,e)}}:{kind:`field`,key:Symbol(),placement:`own`,descriptor:{},originalKey:t.key,initializer(){typeof t.initializer==`function`&&(this[t.key]=t.initializer.call(this))},finisher(n){n.createProperty(t.key,e)}},Pc=(e,t,n)=>{t.constructor.createProperty(n,e)};function V(e){return(t,n)=>n===void 0?Nc(e,t):Pc(e,t,n)}function Fc(e){return V({...e,state:!0})}var Ic=({finisher:e,descriptor:t})=>(n,r)=>{if(r===void 0){let r=n.originalKey??n.key,i=t==null?{...n,key:r}:{kind:`method`,placement:`prototype`,key:r,descriptor:t(n.key)};return e!=null&&(i.finisher=function(t){e(t,r)}),i}{let i=n.constructor;t!==void 0&&Object.defineProperty(n,r,t(r)),e?.(i,r)}};function Lc(e,t){return Ic({descriptor:n=>{let r={get(){return this.renderRoot?.querySelector(e)??null},enumerable:!0,configurable:!0};if(t){let t=typeof n==`symbol`?Symbol():`__`+n;r.get=function(){return this[t]===void 0&&(this[t]=this.renderRoot?.querySelector(e)??null),this[t]}}return r}})}var Rc=window.HTMLSlotElement?.prototype.assignedElements==null?(e,t)=>e.assignedNodes(t).filter((e=>e.nodeType===Node.ELEMENT_NODE)):(e,t)=>e.assignedElements(t);function zc(e){let{slot:t,selector:n}=e??{};return Ic({descriptor:r=>({get(){let r=`slot`+(t?`[name=${t}]`:`:not([name])`),i=this.renderRoot?.querySelector(r),a=i==null?[]:Rc(i,e);return n?a.filter((e=>e.matches(n))):a},enumerable:!0,configurable:!0})})}function Bc(e,t,n){return e?t():n?.()}var Vc=uc`<svg class="caret-up-svg" viewBox="0 0 8 4" xmlns="http://www.w3.org/2000/svg">
<path d="m6.7226499 3.51689722c.22976435.15317623.54019902.0910893.69337525-.13867505.13615665-.20423497.10222882-.47220946-.06836249-.63681849l-.07031256-.05655675-3.2773501-2.18490007-3.2773501 2.18490007c-.22976434.15317623-.29185128.4636109-.13867505.69337524.13615665.20423498.39656688.27598409.61412572.18182636l.07924953-.04315131 2.7226499-1.81402514z"
  fill=""></path>
</svg>`,Hc=uc`<svg class="caret-down-svg" viewBox="0 0 8 4" xmlns="http://www.w3.org/2000/svg">
<path d="m6.7226499.58397485c.22976435-.15317623.54019902-.09108929.69337525.13867505.13615665.20423498.10222882.47220947-.06836249.63681849l-.07031256.05655676-3.2773501 2.18490006-3.2773501-2.18490006c-.22976434-.15317623-.29185128-.4636109-.13867505-.69337525.13615665-.20423497.39656688-.27598409.61412572-.18182636l.07924953.04315131 2.7226499 1.81402515z"
fill=""></path>
</svg>`,H=class extends Ac{constructor(){super(...arguments),this.open=!1,this.isDisabled=!1,this.displayCaret=!1,this.closeOnSelect=!1,this.openViaButton=!0,this.usePopover=!1,this.includeSelectedOption=!1,this.selectedOption=``,this.options=[],this.optionGroup=`options`,this.optionSelected=()=>{},this.isCustomList=!1,this.hasCustomClickHandler=!1,this.closeOnEscape=!1,this.closeOnBackdropClick=!1,this.boundKeyboardListener=e=>{switch(e.key){case`Escape`:case`Esc`:this.closeOptions();break;default:break}},this.closeOptions=e=>{e&&e.type===`click`&&e.stopPropagation(),this.open=!1,this.updatePopoverState()}}async firstUpdated(){await new Promise(e=>{setTimeout(e,0)}),this.addEventListener(`closeDropdown`,this.closeOptions)}willUpdate(e){e.has(`open`)&&this.updatePopoverState()}disconnectedCallback(){var e;(e=super.disconnectedCallback)==null||e.call(this),this.removeKeyboardListener()}setupKeyboardListener(){this.closeOnEscape&&document.addEventListener(`keydown`,this.boundKeyboardListener)}removeKeyboardListener(){this.closeOnEscape&&document.removeEventListener(`keydown`,this.boundKeyboardListener)}get dropdownState(){return this.open?(this.setupKeyboardListener(),`open`):(this.removeKeyboardListener(),`closed`)}toggleOptions(){this.open=!this.open,this.updatePopoverState()}updatePopoverState(){var e,t;this.usePopover&&((t=(e=this.dropdownMenu)?.togglePopover)==null||t.call(e,this.open),this.open&&this.positionDropdownMenu())}positionDropdownMenu(){if(!this.dropdownMenu)return;let e=this.container.getBoundingClientRect();this.dropdownMenu.style.left=`${e.left}px`,this.dropdownMenu.style.top=`${e.bottom}px`,this.dropdownMenu.style.minWidth=`${e.width}px`}mainButtonClicked(){var e;this.openViaButton?this.toggleOptions():(e=this.mainButtonLabelSlotted[0])==null||e.click()}mainButtonKeyDown(e){(e.key===`Enter`||e.key===` `)&&(this.mainButtonClicked(),e.preventDefault())}caretKeyDown(e){(e.key===`Enter`||e.key===` `)&&(this.toggleOptions(),e.preventDefault())}renderOption(e){let{label:t,url:n=void 0,id:r}=e,i,a=this.selectedOption===r?`selected`:``;return i=n?lc`<a
        href=${n}
      ...
      >
        ${t}
      </button>`,lc`<li role="menuitem" class=${a}>${i}</li>`}optionClicked(e,t){var n;e.stopPropagation(),this.selectedOption!==t.id&&(this.selectedOption=t.id,this.dispatchEvent(new CustomEvent(`optionSelected`,{detail:{option:t}})),(n=t.selectedHandler)==null||n.call(t,t)),this.closeOnSelect&&(this.closeOptions(),this.mainButton.focus())}get availableOptions(){return this.includeSelectedOption?this.options:this.options.filter(e=>this.selectedOption!==e.id)}get caretUpTemplate(){return lc`
      <span ?hidden=${!this.open} class="caret-up">
        <slot name="caret-up">${Vc}</slot>
      </span>
    `}get caretDownTemplate(){return lc`
      <span ?hidden=${this.open} class="caret-down">
        <slot name="caret-down">${Hc}</slot>
      </span>
    `}get caretTemplate(){return this.displayCaret?this.openViaButton?lc`
      ...
      <button
        ...
        aria-haspopup="true"
        aria-expanded=${this.open}
        @click=${Bc(this.shouldAttachEventHandlers,()=>this.toggleOptions)}
        @keydown=${Bc(this.shouldAttachEventHandlers,()=>this.caretKeyDown)}
        ?disabled=${this.isDisabled}
      >
        ${this.caretUpTemplate} ${this.caretDownTemplate}
      </button>
    `:lc``}get dropdownTemplate(){return this.isCustomList?lc`<slot name="list"></slot>`:lc`${this.availableOptions.map(e=>this.renderOption(e))}`}get backdropTemplate(){return!this.closeOnBackdropClick||!this.open?lc``:lc`
      <div
        id="dropdown-backdrop"
        @keyup=${this.closeOptions}
        @click=${this.closeOptions}
      ></div>
    `}get shouldNestCaretInButton(){return this.openViaButton}get shouldAttachEventHandlers(){return!this.isDisabled&&!this.hasCustomClickHandler}render(){return lc`
      <div class="ia-dropdown-group">
        <div class="button-row">
          <button
            ...
            aria-expanded=${this.open}
            @click=${Bc(this.shouldAttachEventHandlers,()=>this.mainButtonClicked)}
            @keydown=${Bc(this.shouldAttachEventHandlers,()=>this.mainButtonKeyDown)}
            ?disabled=${this.isDisabled}
          >
            ...
            ${Bc(this.shouldNestCaretInButton,()=>this.caretTemplate)}
          </button>
          ${Bc(!this.shouldNestCaretInButton,()=>this.caretTemplate)}
        </div>
  ...
  `,Uc=t([Mc(`ia-icon-label`)],Uc);var Wc=class extends O{constructor(...e){super(...e),this.numResults=0}render(){return T`
    ...
    `}};L([A({type:Number})],Wc.prototype,`numResults`,void 0),Wc=L([k(`alpha-bar-tooltip`)],Wc);var Gc=class extends O{constructor(...e){super(...e),this.selectedLetter=null,this.tooltipShown=!1,this.alphabet=`ABCDEFGHIJKLMNOPQRSTUVWXYZ`.split(``)}get selectedUppercaseLetter(){return this.selectedLetter?.toUpperCase()}render(){return T`
  ...
  `}};L([A({type:String})],Gc.prototype,`selectedLetter`,void 0),L([A({type:Object})],Gc.prototype,`letterCounts`,void 0),L([A({type:String})],Gc.prototype,`ariaLandmarkLabel`,void 0),L([j()],Gc.prototype,`tooltipShown`,void 0),L([j()],Gc.prototype,`hoveredLetter`,void 0),L([M(`alpha-bar-tooltip`)],Gc.prototype,`tooltip`,void 0),Gc=L([k(`alpha-bar`)],Gc);var Kc=class extends O{constructor(...e){super(...e),this.defaultSortDirection=null,this.defaultSortField=P.relevance,this.sortDirection=null,this.selectedSort=P.default,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.sortFieldAvailability=Vr,this.enableSortOptionsSlot=!1,this.suppressDisplayModes=!1,this.alphaSelectorVisible=null,this.dropdownBackdropVisible=!1,this.boundSortBarSelectorEscapeListener=e=>{e.key===`Escape`&&this.closeDropdown()}}render(){return T`
      <div id="container">
    ...
    `}get sortDirectionIcon(){return this.canChangeSortDirection?T`
      <div class="sort-direction-icon">
        ${this.finalizedSortDirection===`asc`?ys:bs}
      </div>
    `:T`<div class="sort-direction-icon">${xs}</div>`}get sortSelectorTemplate(){let e=Object.values(zr).filter(e=>e.shownInSortBar&&this.sortFieldAvailability[e.field]);return T`
    ...
    ></alpha-bar>`}titleLetterChanged(e){this.selectedTitleFilter=e.detail.selectedLetter??null,this.emitTitleLetterChangedEvent()}creatorLetterChanged(e){this.selectedCreatorFilter=e.detail.selectedLetter??null,this.emitCreatorLetterChangedEvent()}emitTitleLetterChangedEvent(){let e=new CustomEvent(`titleLetterChanged`,{detail:{selectedLetter:this.selectedTitleFilter}});this.dispatchEvent(e)}emitCreatorLetterChangedEvent(){let e=new CustomEvent(`creatorLetterChanged`,{detail:{selectedLetter:this.selectedCreatorFilter}});this.dispatchEvent(e)}displayModeChanged(){let e=new CustomEvent(`displayModeChanged`,{detail:{displayMode:this.displayMode}});this.dispatchEvent(e)}emitSortChangedEvent(){let e=new CustomEvent(`sortChanged`,{detail:{selectedSort:this.selectedSort,sortDirection:this.sortDirection}});this.dispatchEvent(e)}static get styles(){let e=w`#bbbbbb`;return[Ai,w`
      ...
      `]}};L([A({type:String})],Kc.prototype,`displayMode`,void 0),L([A({type:String})],Kc.prototype,`defaultSortDirection`,void 0),L([A({type:String})],Kc.prototype,`defaultSortField`,void 0),L([A({type:String})],Kc.prototype,`sortDirection`,void 0),L([A({type:String})],Kc.prototype,`selectedSort`,void 0),L([A({type:String})],Kc.prototype,`selectedTitleFilter`,void 0),L([A({type:String})],Kc.prototype,`selectedCreatorFilter`,void 0),L([A({type:Object})],Kc.prototype,`sortFieldAvailability`,void 0),L([A({type:Boolean,reflect:!0})],Kc.prototype,`enableSortOptionsSlot`,void 0),L([A({type:Boolean,reflect:!0})],Kc.prototype,`suppressDisplayModes`,void 0),L([A({type:Object})],Kc.prototype,`prefixFilterCountMap`,void 0),L([j()],Kc.prototype,`alphaSelectorVisible`,void 0),L([j()],Kc.prototype,`dropdownBackdropVisible`,void 0),L([M(`#sort-dropdown`)],Kc.prototype,`sortOptionsDropdown`,void 0),Kc=L([k(`sort-filter-bar`)],Kc);var qc=class{constructor(e){this.title=e?.title,this.subtitle=e?.subtitle,this.headline=e?.headline,this.message=e?.message,this.headerColor=e?.headerColor??`#55A183`,this.bodyColor=e?.bodyColor??`#fbfbfd`,this.showProcessingIndicator=e?.showProcessingIndicator??!1,this.processingImageMode=e?.processingImageMode??`complete`,this.showCloseButton=e?.showCloseButton??!0,this.showLeftNavButton=e?.showLeftNavButton??!1,this.leftNavButtonText=e?.leftNavButtonText??``,this.showHeaderLogo=e?.showHeaderLogo??!0,this.closeOnBackdropClick=e?.closeOnBackdropClick??!0}};function*Jc(e=document.activeElement){e!=null&&(yield e,`shadowRoot`in e&&e.shadowRoot&&e.shadowRoot.mode!==`closed`&&(yield*Jc(e.shadowRoot.activeElement)))}function Yc(){return[...Jc()].pop()}var Xc=new WeakMap;function Zc(e){let t=Xc.get(e);return t||(t=window.getComputedStyle(e,null),Xc.set(e,t)),t}function Qc(e){if(`checkVisibility`in e&&typeof e.checkVisibility==`function`)return e.checkVisibility({checkOpacity:!1,checkVisibilityCSS:!0});let t=Zc(e);return t.visibility!==`hidden`&&t.display!==`none`}function $c(e){let{overflowY:t,overflowX:n}=Zc(e);return t===`scroll`||n===`scroll`?!0:t!==`auto`||n!==`auto`?!1:e.scrollHeight>e.clientHeight&&t===`auto`||e.scrollWidth>e.clientWidth&&n===`auto`}function el(e){let t=e.tagName.toLowerCase(),n=Number(e.getAttribute(`tabindex`));return e.hasAttribute(`tabindex`)&&(isNaN(n)||n<=-1)||e.hasAttribute(`disabled`)||e.closest(`[inert]`)||t===`input`&&e.getAttribute(`type`)===`radio`&&!e.hasAttribute(`checked`)||!Qc(e)?!1:(t===`audio`||t===`video`)&&e.hasAttribute(`controls`)||e.hasAttribute(`tabindex`)||e.hasAttribute(`contenteditable`)&&e.getAttribute(`contenteditable`)!==`false`||[`button`,`input`,`select`,`textarea`,`a`,`audio`,`video`,`summary`,`iframe`].includes(t)?!0:$c(e)}function tl(e,t){return e.getRootNode({composed:!0})?.host!==t}function nl(e){let t=new WeakMap,n=[];function r(i){if(i instanceof Element){if(i.hasAttribute(`inert`)||i.closest(`[inert]`)||t.has(i))return;t.set(i,!0),!n.includes(i)&&el(i)&&n.push(i),i instanceof HTMLSlotElement&&tl(i,e)&&i.assignedElements({flatten:!0}).forEach(e=>{r(e)}),i.shadowRoot!==null&&i.shadowRoot.mode===`open`&&r(i.shadowRoot)}for(let e of Array.from(i.children))r(e)}return r(e),n.sort((e,t)=>{let n=Number(e.getAttribute(`tabindex`))||0;return(Number(t.getAttribute(`tabindex`))||0)-n})}var rl=[],il=class{constructor(e){this.isExternalActivated=!1,this.tabDirection=`forward`,this.currentFocus=null,this.previousFocus=null,this.handleFocusIn=()=>{this.isActive()&&this.checkFocus()},this.handleKeyDown=e=>{if(e.key!==`Tab`||this.isExternalActivated||!this.isActive())return;let t=Yc();if(this.previousFocus=t,this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus))return;e.shiftKey?this.tabDirection=`backward`:this.tabDirection=`forward`;let n=nl(this.element),r=n.findIndex(e=>e===t);this.previousFocus=this.currentFocus;let i=this.tabDirection===`forward`?1:-1;for(;;){r+i>=n.length?r=0:r+i<0?r=n.length-1:r+=i,this.previousFocus=this.currentFocus;let t=n[r];if(this.tabDirection===`backward`&&this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus)||t&&this.possiblyHasTabbableChildren(t))return;e.preventDefault(),this.currentFocus=t,this.currentFocus?.focus({preventScroll:!1});let a=[...Jc()];if(a.includes(this.currentFocus)||!a.includes(this.previousFocus))break}setTimeout(()=>this.checkFocus())},this.handleKeyUp=()=>{this.tabDirection=`forward`},this.element=e,this.elementsWithTabbableControls=[`iframe`]}activate(){rl.push(this.element),document.addEventListener(`focusin`,this.handleFocusIn),document.addEventListener(`keydown`,this.handleKeyDown),document.addEventListener(`keyup`,this.handleKeyUp)}deactivate(){rl=rl.filter(e=>e!==this.element),this.currentFocus=null,document.removeEventListener(`focusin`,this.handleFocusIn),document.removeEventListener(`keydown`,this.handleKeyDown),document.removeEventListener(`keyup`,this.handleKeyUp)}isActive(){return rl[rl.length-1]===this.element}activateExternal(){this.isExternalActivated=!0}deactivateExternal(){this.isExternalActivated=!1}checkFocus(){if(this.isActive()&&!this.isExternalActivated){let e=nl(this.element);if(!this.element.matches(`:focus-within`)){let t=e[0],n=e[e.length-1],r=this.tabDirection===`forward`?t:n;typeof r?.focus==`function`&&(this.currentFocus=r,r.focus({preventScroll:!1}))}}}possiblyHasTabbableChildren(e){return this.elementsWithTabbableControls.includes(e.tagName.toLowerCase())||e.hasAttribute(`controls`)}},al=window,ol=al.trustedTypes,sl=ol?ol.createPolicy(`lit-html`,{createHTML:e=>e}):void 0,cl=`$lit$`,ll=`lit$${(Math.random()+``).slice(9)}$`,ul=`?`+ll,dl=`<${ul}>`,fl=document,pl=()=>fl.createComment(``),ml=e=>e===null||typeof e!=`object`&&typeof e!=`function`,hl=Array.isArray,gl=e=>hl(e)||typeof e?.[Symbol.iterator]==`function`,_l=`[ 	
\f\r]`,vl=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,yl=/-->/g,bl=/>/g,xl=RegExp(`>|${_l}(?:([^\\s"'>=/]+)(${_l}*=${_l}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,`g`),Sl=/'/g,Cl=/"/g,wl=/^(?:script|style|textarea|title)$/i,Tl=(e=>(t,...n)=>({_$litType$:e,strings:t,values:n}))(1),El=Symbol.for(`lit-noChange`),Dl=Symbol.for(`lit-nothing`),Ol=new WeakMap,kl=fl.createTreeWalker(fl,129,null,!1);function Al(e,t){if(!Array.isArray(e)||!e.hasOwnProperty(`raw`))throw Error(`invalid template strings array`);return sl===void 0?t:sl.createHTML(t)}var jl=(e,t)=>{let n=e.length-1,r=[],i,a=t===2?`<svg>`:``,o=vl;for(let t=0;t<n;t++){let n=e[t],s,c,l=-1,u=0;for(;u<n.length&&(o.lastIndex=u,c=o.exec(n),c!==null);)u=o.lastIndex,o===vl?c[1]===`!--`?o=yl:c[1]===void 0?c[2]===void 0?c[3]!==void 0&&(o=xl):(wl.test(c[2])&&(i=RegExp(`</`+c[2],`g`)),o=xl):o=bl:o===xl?c[0]===`>`?(o=i??vl,l=-1):c[1]===void 0?l=-2:(l=o.lastIndex-c[2].length,s=c[1],o=c[3]===void 0?xl:c[3]===`"`?Cl:Sl):o===Cl||o===Sl?o=xl:o===yl||o===bl?o=vl:(o=xl,i=void 0);let d=o===xl&&e[t+1].startsWith(`/>`)?` `:``;a+=o===vl?n+dl:l>=0?(r.push(s),n.slice(0,l)+cl+n.slice(l)+ll+d):n+ll+(l===-2?(r.push(void 0),t):d)}return[Al(e,a+(e[n]||`<?>`)+(t===2?`</svg>`:``)),r]},Ml=class e{constructor({strings:t,_$litType$:n},r){let i;this.parts=[];let a=0,o=0,s=t.length-1,c=this.parts,[l,u]=jl(t,n);if(this.el=e.createElement(l,r),kl.currentNode=this.el.content,n===2){let e=this.el.content,t=e.firstChild;t.remove(),e.append(...t.childNodes)}for(;(i=kl.nextNode())!==null&&c.length<s;){if(i.nodeType===1){if(i.hasAttributes()){let e=[];for(let t of i.getAttributeNames())if(t.endsWith(cl)||t.startsWith(ll)){let n=u[o++];if(e.push(t),n!==void 0){let e=i.getAttribute(n.toLowerCase()+cl).split(ll),t=/([.?@])?(.*)/.exec(n);c.push({type:1,index:a,name:t[2],strings:e,ctor:t[1]===`.`?Ll:t[1]===`?`?zl:t[1]===`@`?Bl:Il})}else c.push({type:6,index:a})}for(let t of e)i.removeAttribute(t)}if(wl.test(i.tagName)){let e=i.textContent.split(ll),t=e.length-1;if(t>0){i.textContent=ol?ol.emptyScript:``;for(let n=0;n<t;n++)i.append(e[n],pl()),kl.nextNode(),c.push({type:2,index:++a});i.append(e[t],pl())}}}else if(i.nodeType===8)if(i.data===ul)c.push({type:2,index:a});else{let e=-1;for(;(e=i.data.indexOf(ll,e+1))!==-1;)c.push({type:7,index:a}),e+=ll.length-1}a++}}static createElement(e,t){let n=fl.createElement(`template`);return n.innerHTML=e,n}};function Nl(e,t,n=e,r){var i,a;if(t===El)return t;let o=r===void 0?n._$Cl:n._$Co?.[r],s=ml(t)?void 0:t._$litDirective$;return o?.constructor!==s&&((i=o?._$AO)==null||i.call(o,!1),s===void 0?o=void 0:(o=new s(e),o._$AT(e,n,r)),r===void 0?n._$Cl=o:((a=n)._$Co??(a._$Co=[]))[r]=o),o!==void 0&&(t=Nl(e,o._$AS(e,t.values),o,r)),t}var Pl=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:n}=this._$AD,r=(e?.creationScope??fl).importNode(t,!0);kl.currentNode=r;let i=kl.nextNode(),a=0,o=0,s=n[0];for(;s!==void 0;){if(a===s.index){let t;s.type===2?t=new Fl(i,i.nextSibling,this,e):s.type===1?t=new s.ctor(i,s.name,s.strings,this,e):s.type===6&&(t=new Vl(i,this,e)),this._$AV.push(t),s=n[++o]}a!==s?.index&&(i=kl.nextNode(),a++)}return kl.currentNode=fl,r}v(e){let t=0;for(let n of this._$AV)n!==void 0&&(n.strings===void 0?n._$AI(e[t]):(n._$AI(e,n,t),t+=n.strings.length-2)),t++}},Fl=class e{constructor(e,t,n,r){var i;this.type=2,this._$AH=Dl,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=r,this._$Cp=(i=r?.isConnected)==null||i}get _$AU(){return this._$AM?._$AU??this._$Cp}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Nl(this,e,t),ml(e)?e===Dl||e==null||e===``?(this._$AH!==Dl&&this._$AR(),this._$AH=Dl):e!==this._$AH&&e!==El&&this._(e):e._$litType$===void 0?e.nodeType===void 0?gl(e)?this.T(e):this._(e):this.$(e):this.g(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==Dl&&ml(this._$AH)?this._$AA.nextSibling.data=e:this.$(fl.createTextNode(e)),this._$AH=e}g(e){let{values:t,_$litType$:n}=e,r=typeof n==`number`?this._$AC(e):(n.el===void 0&&(n.el=Ml.createElement(Al(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===r)this._$AH.v(t);else{let e=new Pl(r,this),n=e.u(this.options);e.v(t),this.$(n),this._$AH=e}}_$AC(e){let t=Ol.get(e.strings);return t===void 0&&Ol.set(e.strings,t=new Ml(e)),t}T(t){hl(this._$AH)||(this._$AH=[],this._$AR());let n=this._$AH,r,i=0;for(let a of t)i===n.length?n.push(r=new e(this.k(pl()),this.k(pl()),this,this.options)):r=n[i],r._$AI(a),i++;i<n.length&&(this._$AR(r&&r._$AB.nextSibling,i),n.length=i)}_$AR(e=this._$AA.nextSibling,t){var n;for((n=this._$AP)==null||n.call(this,!1,!0,t);e&&e!==this._$AB;){let t=e.nextSibling;e.remove(),e=t}}setConnected(e){var t;this._$AM===void 0&&(this._$Cp=e,(t=this._$AP)==null||t.call(this,e))}},Il=class{constructor(e,t,n,r,i){this.type=1,this._$AH=Dl,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=i,n.length>2||n[0]!==``||n[1]!==``?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=Dl}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,n,r){let i=this.strings,a=!1;if(i===void 0)e=Nl(this,e,t,0),a=!ml(e)||e!==this._$AH&&e!==El,a&&(this._$AH=e);else{let r=e,o,s;for(e=i[0],o=0;o<i.length-1;o++)s=Nl(this,r[n+o],t,o),s===El&&(s=this._$AH[o]),a||=!ml(s)||s!==this._$AH[o],s===Dl?e=Dl:e!==Dl&&(e+=(s??``)+i[o+1]),this._$AH[o]=s}a&&!r&&this.j(e)}j(e){e===Dl?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??``)}},Ll=class extends Il{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===Dl?void 0:e}},Rl=ol?ol.emptyScript:``,zl=class extends Il{constructor(){super(...arguments),this.type=4}j(e){e&&e!==Dl?this.element.setAttribute(this.name,Rl):this.element.removeAttribute(this.name)}},Bl=class extends Il{constructor(e,t,n,r,i){super(e,t,n,r,i),this.type=5}_$AI(e,t=this){if((e=Nl(this,e,t,0)??Dl)===El)return;let n=this._$AH,r=e===Dl&&n!==Dl||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,i=e!==Dl&&(n===Dl||r);r&&this.element.removeEventListener(this.name,this,n),i&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH==`function`?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},Vl=class{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){Nl(this,e)}},Hl=al.litHtmlPolyfillSupport;Hl?.(Ml,Fl),(al.litHtmlVersions??=[]).push(`2.8.0`);var Ul=(e,t,n)=>{let r=n?.renderBefore??t,i=r._$litPart$;if(i===void 0){let e=n?.renderBefore??null;r._$litPart$=i=new Fl(t.insertBefore(pl(),e),e,void 0,n??{})}return i._$AI(e),i},Wl,Gl=class extends Vs{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e;let t=super.createRenderRoot();return(e=this.renderOptions).renderBefore??(e.renderBefore=t.firstChild),t}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Ul(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)==null||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)==null||e.setConnected(!1)}render(){return El}};Gl.finalized=!0,Gl._$litElement$=!0,(Wl=globalThis.litElementHydrateSupport)==null||Wl.call(globalThis,{LitElement:Gl});var Kl=globalThis.litElementPolyfillSupport;Kl?.({LitElement:Gl}),(globalThis.litElementVersions??(globalThis.litElementVersions=[])).push(`3.3.3`);var ql;(function(e){e.processing=`processing`,e.complete=`complete`})(ql||={});var Jl=class extends Gl{constructor(){super(...arguments),this.mode=`processing`}render(){return Tl`
      <div class="${this.mode}">
        <svg
          viewBox="0 0 120 120"
    ...
    `}};t([V({type:String})],Jl.prototype,`mode`,void 0),Jl=t([Mc(`ia-activity-indicator`)],Jl);var Yl=T`
<svg
  viewBox="0 0 40 40"
  version="1.1"
  xmlns="http://www.w3.org/2000/svg"
...
`,Xl=class extends O{static get styles(){return w`
      :host {
    ...
    `}render(){return Yl}};customElements.define(`ia-icon-close`,Xl);var Zl=T`
  <svg
    class="ia-logo"
    viewBox="0 0 27 30"
    xmlns="http://www.w3.org/2000/svg"
...
`,$l=class extends O{constructor(){super(...arguments),this.config=new qc}render(){return T`
      <div class="modal-wrapper">
        <div class="modal-container">
          <header style="background-color: ${this.config.headerColor}">
            ${this.config.showLeftNavButton?this.leftNavButtonTemplate:D}
            ${this.config.showCloseButton?this.closeButtonTemplate:``}
            ${this.config.showHeaderLogo?T`<div class="logo-icon">${Zl}</div>`:D}
    ...
    >
      ${Ql} ${this.config.leftNavButtonText??``}
    ...
    `}};t([A({type:Object})],$l.prototype,`config`,void 0),$l=t([k(`modal-template`)],$l);function eu(e,t,n){var r=n||{},i=r.noTrailing,a=i===void 0?!1:i,o=r.noLeading,s=o===void 0?!1:o,c=r.debounceMode,l=c===void 0?void 0:c,u,d=!1,f=0;function p(){u&&clearTimeout(u)}function m(e){var t=(e||{}).upcomingOnly,n=t===void 0?!1:t;p(),d=!n}function h(){var n=[...arguments],r=this,i=Date.now()-f;if(d)return;function o(){f=Date.now(),t.apply(r,n)}function c(){u=void 0}!s&&l&&!u&&o(),p(),l===void 0&&i>e?s?(f=Date.now(),a||(u=setTimeout(l?c:o,e))):o():a!==!0&&(u=setTimeout(l?c:o,l===void 0?e-i:e))}return h.cancel=m,h}var tu;(function(e){e.Open=`open`,e.Closed=`closed`})(tu||={});var nu=class{constructor(e){this.windowResizeThrottler=eu(100,this.updateModalContainerHeight,{noLeading:!1,noTrailing:!1}).bind(this),this.modalManager=e}handleModeChange(e){switch(e){case tu.Open:this.startResizeListener(),this.stopDocumentScroll();break;case tu.Closed:this.stopResizeListener(),this.resumeDocumentScroll();break}}updateModalContainerHeight(){this.modalManager.style.setProperty(`--containerHeight`,`${window.innerHeight}px`)}stopDocumentScroll(){document.body.classList.add(`modal-manager-open`)}resumeDocumentScroll(){document.body.classList.remove(`modal-manager-open`)}startResizeListener(){window.addEventListener(`resize`,this.windowResizeThrottler)}stopResizeListener(){window.removeEventListener(`resize`,this.windowResizeThrottler)}},ru=class extends O{constructor(){super(...arguments),this.mode=tu.Closed,this.hostBridge=new nu(this),this.modal=new il(this),this.closeOnBackdropClick=!0}async firstUpdated(){await new Promise(e=>setTimeout(e,0)),this.closeOnBackdropClick&&this.addEventListener(`keydown`,e=>{e.key===`Escape`&&this.backdropClicked()})}disconnectedCallback(){super.disconnectedCallback(),this.modal.deactivate()}render(){return T`
      <div class="container">
    ...
    `}};t([A({type:String,reflect:!0})],ru.prototype,`mode`,void 0),t([A({type:Object})],ru.prototype,`customModalContent`,void 0),t([A({type:Object})],ru.prototype,`hostBridge`,void 0),t([M(`modal-template`)],ru.prototype,`modalTemplate`,void 0),ru=t([k(`modal-manager`)],ru);var iu=w`var(--white, #fff)`,au=w`var(--primaryDisableCTAFill, #767676)`,ou=w`var(--secondaryCTABorder, #999)`,su=w`var(--primaryCTAFill, #194880)`,cu=w`var(--primaryCTAFillRGB, 25, 72, 128)`,lu=w`var(--primaryCTABorder, #c5d1df)`,uu=w`var(--primaryErrorCTAFill, #d9534f)`,du=w`var(--primaryErrorCTAFillRGB, 229, 28, 38)`,fu=w`var(--primaryErrorCTABorder, #d43f3a)`,pu=w`var(--secondaryCTAFill, #333)`,mu=w`var(--secondaryCTAFillRGB, 51, 51, 51)`,hu=w`var(--primaryCTABorder, #979797)`,gu=w`var(---primaryWarningFill, #ee8950)`,_u=w`var(--primaryWarningFillRGB, 238, 137, 80)`,vu=w`
  .ia-button {
    min-height: 3rem;
    cursor: pointer;
    color: ${iu};
  ...
  .ia-button.primary:hover {
    background-color: rgba(${cu}, 0.9);
  }
  .ia-button.primary:focus-visible {
    background-color: rgba(${cu}, 0.8);
  }
  .ia-button.primary:active {
    background-color: rgba(${cu}, 0.7);
  }
  ...
  .ia-button.danger:hover {
    background-color: rgba(${du}, 0.9);
  }
  .ia-button.danger:focus-visible {
    background-color: rgba(${du}, 0.8);
  }
  .ia-button.danger:active {
    background-color: rgba(${du}, 0.7);
  }
  ...
  .ia-button.warning:hover {
    background-color: rgba(${_u}, 0.9);
  }
  .ia-button.warning:focus-visible {
    background-color: rgba(${_u}, 0.8);
  }
  .ia-button.warning:active {
    background-color: rgba(${_u}, 0.7);
  }
  ...
  .ia-button.dark:hover {
    background-color: rgba(${mu}, 0.9);
  }
  .ia-button.dark:focus-visible {
    background-color: rgba(${mu}, 0.8);
  }
  .ia-button.dark:active {
    background-color: rgba(${mu}, 0.7);
  }
...
`,yu=class extends O{constructor(...e){super(...e),this.items=[]}render(){return T`
      <ul>
    ...
    `}};L([A({type:Object})],yu.prototype,`items`,void 0),L([A({type:String})],yu.prototype,`message`,void 0),yu=L([k(`remove-items-modal-content`)],yu);var bu=class extends O{constructor(...e){super(...e),this.label=N(`Select items to remove`),this.selectedItems=[],this.showSelectAll=!1,this.showUnselectAll=!1,this.showItemManageButton=!1,this.removeAllowed=!1}render(){return T`
    ...
    `}};L([A({type:String})],bu.prototype,`label`,void 0),L([A({type:Object})],bu.prototype,`modalManager`,void 0),L([A({type:Array})],bu.prototype,`selectedItems`,void 0),L([A({type:String})],bu.prototype,`profileElement`,void 0),L([A({type:Boolean})],bu.prototype,`showSelectAll`,void 0),L([A({type:Boolean})],bu.prototype,`showUnselectAll`,void 0),L([A({type:Boolean})],bu.prototype,`showItemManageButton`,void 0),L([A({type:Boolean})],bu.prototype,`removeAllowed`,void 0),bu=L([k(`manage-bar`)],bu);var xu=(e,t)=>{let n=e._$AN;if(n===void 0)return!1;for(let e of n)e._$AO?.(t,!1),xu(e,t);return!0},Su=e=>{let t,n;do{if((t=e._$AM)===void 0)break;n=t._$AN,n.delete(e),e=t}while(n?.size===0)},Cu=e=>{for(let t;t=e._$AM;e=t){let n=t._$AN;if(n===void 0)t._$AN=n=new Set;else if(n.has(e))break;n.add(e),Eu(t)}};function wu(e){this._$AN===void 0?this._$AM=e:(Su(this),this._$AM=e,Cu(this))}function Tu(e,t=!1,n=0){let r=this._$AH,i=this._$AN;if(i!==void 0&&i.size!==0)if(t)if(Array.isArray(r))for(let e=n;e<r.length;e++)xu(r[e],!1),Su(r[e]);else r!=null&&(xu(r,!1),Su(r));else xu(this,e)}var Eu=e=>{e.type==ir.CHILD&&(e._$AP??=Tu,e._$AQ??=wu)},Du=class extends or{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,n){super._$AT(e,t,n),Cu(this),this.isConnected=e._$AU}_$AO(e,t=!0){e!==this.isConnected&&(this.isConnected=e,e?this.reconnected?.():this.disconnected?.()),t&&(xu(this,e),Su(this))}setValue(e){if(hr(this._$Ct))this._$Ct._$AI(e,this);else{let t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}},Ou=new WeakMap,ku=ar(class extends Du{render(e){return C}update(e,[t]){let n=t!==this.G;return n&&this.G!==void 0&&this.rt(void 0),(n||this.lt!==this.ct)&&(this.G=t,this.ht=e.options?.host,this.rt(this.ct=e.element)),C}rt(e){if(this.isConnected||(e=void 0),typeof this.G==`function`){let t=this.ht??globalThis,n=Ou.get(t);n===void 0&&(n=new WeakMap,Ou.set(t,n)),n.get(this.G)!==void 0&&this.G.call(this.ht,void 0),n.set(this.G,e),e!==void 0&&this.G.call(this.ht,e)}else this.G.value=e}get lt(){return typeof this.G==`function`?Ou.get(this.ht??globalThis)?.get(this.G):this.G?.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}}),Au=3600,ju=Au*24,Mu=ju*7,Nu=1e3,Pu=60*Nu,Fu=Au*Nu,Iu=ju*Nu,Lu=Mu*Nu,Ru=`millisecond`,zu=`second`,Bu=`minute`,Vu=`hour`,Hu=`week`,Uu=`month`,Wu=`quarter`,Gu=`year`,Ku=`date`,qu=`Invalid Date`,Ju=/^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/,Yu=/\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g,Xu={name:`en`,weekdays:`Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday`.split(`_`),months:`January_February_March_April_May_June_July_August_September_October_November_December`.split(`_`),ordinal:function(e){var t=[`th`,`st`,`nd`,`rd`],n=e%100;return`[`+e+(t[(n-20)%10]||t[n]||t[0])+`]`}},Zu=function(e,t,n){var r=String(e);return!r||r.length>=t?e:``+Array(t+1-r.length).join(n)+e},Qu={s:Zu,z:function(e){var t=-e.utcOffset(),n=Math.abs(t),r=Math.floor(n/60),i=n%60;return(t<=0?`+`:`-`)+Zu(r,2,`0`)+`:`+Zu(i,2,`0`)},m:function e(t,n){if(t.date()<n.date())return-e(n,t);var r=(n.year()-t.year())*12+(n.month()-t.month()),i=t.clone().add(r,Uu),a=n-i<0,o=t.clone().add(r+(a?-1:1),Uu);return+(-(r+(n-i)/(a?i-o:o-i))||0)},a:function(e){return e<0?Math.ceil(e)||0:Math.floor(e)},p:function(e){return{M:`month`,y:`year`,w:`week`,d:`day`,D:`date`,h:`hour`,m:`minute`,s:`second`,ms:`millisecond`,Q:`quarter`}[e]||String(e||``).toLowerCase().replace(/s$/,``)},u:function(e){return e===void 0}},$u=`en`,ed={};ed[$u]=Xu;var td=`$isDayjsObject`,nd=function(e){return e instanceof od||!!(e&&e[td])},rd=function e(t,n,r){var i;if(!t)return $u;if(typeof t==`string`){var a=t.toLowerCase();ed[a]&&(i=a),n&&(ed[a]=n,i=a);var o=t.split(`-`);if(!i&&o.length>1)return e(o[0])}else{var s=t.name;ed[s]=t,i=s}return!r&&i&&($u=i),i||!r&&$u},U=function(e,t){if(nd(e))return e.clone();var n=typeof t==`object`?t:{};return n.date=e,n.args=arguments,new od(n)},id=function(e,t){return U(e,{locale:t.$L,utc:t.$u,x:t.$x,$offset:t.$offset})},W=Qu;W.l=rd,W.i=nd,W.w=id;var ad=function(e){var t=e.date,n=e.utc;if(t===null)return new Date(NaN);if(W.u(t))return new Date;if(t instanceof Date)return new Date(t);if(typeof t==`string`&&!/Z$/i.test(t)){var r=t.match(Ju);if(r){var i=r[2]-1||0,a=(r[7]||`0`).substring(0,3);return n?new Date(Date.UTC(r[1],i,r[3]||1,r[4]||0,r[5]||0,r[6]||0,a)):new Date(r[1],i,r[3]||1,r[4]||0,r[5]||0,r[6]||0,a)}}return new Date(t)},od=function(){function e(e){this.$L=rd(e.locale,null,!0),this.parse(e),this.$x=this.$x||e.x||{},this[td]=!0}var t=e.prototype;return t.parse=function(e){this.$d=ad(e),this.init()},t.init=function(){var e=this.$d;this.$y=e.getFullYear(),this.$M=e.getMonth(),this.$D=e.getDate(),this.$W=e.getDay(),this.$H=e.getHours(),this.$m=e.getMinutes(),this.$s=e.getSeconds(),this.$ms=e.getMilliseconds()},t.$utils=function(){return W},t.isValid=function(){return this.$d.toString()!==qu},t.isSame=function(e,t){var n=U(e);return this.startOf(t)<=n&&n<=this.endOf(t)},t.isAfter=function(e,t){return U(e)<this.startOf(t)},t.isBefore=function(e,t){return this.endOf(t)<U(e)},t.$g=function(e,t,n){return W.u(e)?this[t]:this.set(n,e)},t.unix=function(){return Math.floor(this.valueOf()/1e3)},t.valueOf=function(){return this.$d.getTime()},t.startOf=function(e,t){var n=this,r=W.u(t)?!0:t,i=W.p(e),a=function(e,t){var i=W.w(n.$u?Date.UTC(n.$y,t,e):new Date(n.$y,t,e),n);return r?i:i.endOf(`day`)},o=function(e,t){return W.w(n.toDate()[e].apply(n.toDate(`s`),(r?[0,0,0,0]:[23,59,59,999]).slice(t)),n)},s=this.$W,c=this.$M,l=this.$D,u=`set`+(this.$u?`UTC`:``);switch(i){case Gu:return r?a(1,0):a(31,11);case Uu:return r?a(1,c):a(0,c+1);case Hu:var d=this.$locale().weekStart||0,f=(s<d?s+7:s)-d;return a(r?l-f:l+(6-f),c);case`day`:case Ku:return o(u+`Hours`,0);case Vu:return o(u+`Minutes`,1);case Bu:return o(u+`Seconds`,2);case zu:return o(u+`Milliseconds`,3);default:return this.clone()}},t.endOf=function(e){return this.startOf(e,!1)},t.$set=function(e,t){var n,r=W.p(e),i=`set`+(this.$u?`UTC`:``),a=(n={},n.day=i+`Date`,n[Ku]=i+`Date`,n[Uu]=i+`Month`,n[Gu]=i+`FullYear`,n[Vu]=i+`Hours`,n[Bu]=i+`Minutes`,n[zu]=i+`Seconds`,n[Ru]=i+`Milliseconds`,n)[r],o=r===`day`?this.$D+(t-this.$W):t;if(r===`month`||r===`year`){var s=this.clone().set(Ku,1);s.$d[a](o),s.init(),this.$d=s.set(Ku,Math.min(this.$D,s.daysInMonth())).$d}else a&&this.$d[a](o);return this.init(),this},t.set=function(e,t){return this.clone().$set(e,t)},t.get=function(e){return this[W.p(e)]()},t.add=function(e,t){var n=this,r;e=Number(e);var i=W.p(t),a=function(t){var r=U(n);return W.w(r.date(r.date()+Math.round(t*e)),n)};if(i===`month`)return this.set(Uu,this.$M+e);if(i===`year`)return this.set(Gu,this.$y+e);if(i===`day`)return a(1);if(i===`week`)return a(7);var o=(r={},r.minute=6e4,r.hour=36e5,r.second=1e3,r)[i]||1,s=this.$d.getTime()+e*o;return W.w(s,this)},t.subtract=function(e,t){return this.add(e*-1,t)},t.format=function(e){var t=this,n=this.$locale();if(!this.isValid())return n.invalidDate||`Invalid Date`;var r=e||`YYYY-MM-DDTHH:mm:ssZ`,i=W.z(this),a=this.$H,o=this.$m,s=this.$M,c=n.weekdays,l=n.months,u=n.meridiem,d=function(e,n,i,a){return e&&(e[n]||e(t,r))||i[n].slice(0,a)},f=function(e){return W.s(a%12||12,e,`0`)},p=u||function(e,t,n){var r=e<12?`AM`:`PM`;return n?r.toLowerCase():r},m=function(e){switch(e){case`YY`:return String(t.$y).slice(-2);case`YYYY`:return W.s(t.$y,4,`0`);case`M`:return s+1;case`MM`:return W.s(s+1,2,`0`);case`MMM`:return d(n.monthsShort,s,l,3);case`MMMM`:return d(l,s);case`D`:return t.$D;case`DD`:return W.s(t.$D,2,`0`);case`d`:return String(t.$W);case`dd`:return d(n.weekdaysMin,t.$W,c,2);case`ddd`:return d(n.weekdaysShort,t.$W,c,3);case`dddd`:return c[t.$W];case`H`:return String(a);case`HH`:return W.s(a,2,`0`);case`h`:return f(1);case`hh`:return f(2);case`a`:return p(a,o,!0);case`A`:return p(a,o,!1);case`m`:return String(o);case`mm`:return W.s(o,2,`0`);case`s`:return String(t.$s);case`ss`:return W.s(t.$s,2,`0`);case`SSS`:return W.s(t.$ms,3,`0`);case`Z`:return i;default:break}return null};return r.replace(Yu,function(e,t){return t||m(e)||i.replace(`:`,``)})},t.utcOffset=function(){return-Math.round(this.$d.getTimezoneOffset()/15)*15},t.diff=function(e,t,n){var r=this,i=W.p(t),a=U(e),o=(a.utcOffset()-this.utcOffset())*Pu,s=this-a,c=function(){return W.m(r,a)},l;switch(i){case Gu:l=c()/12;break;case Uu:l=c();break;case Wu:l=c()/3;break;case Hu:l=(s-o)/Lu;break;case`day`:l=(s-o)/Iu;break;case Vu:l=s/Fu;break;case Bu:l=s/Pu;break;case zu:l=s/Nu;break;default:l=s;break}return n?l:W.a(l)},t.daysInMonth=function(){return this.endOf(Uu).$D},t.$locale=function(){return ed[this.$L]},t.locale=function(e,t){if(!e)return this.$L;var n=this.clone(),r=rd(e,t,!0);return r&&(n.$L=r),n},t.clone=function(){return W.w(this.$d,this)},t.toDate=function(){return new Date(this.valueOf())},t.toJSON=function(){return this.isValid()?this.toISOString():null},t.toISOString=function(){return this.$d.toISOString()},t.toString=function(){return this.$d.toUTCString()},e}(),sd=od.prototype;U.prototype=sd,[[`$ms`,Ru],[`$s`,zu],[`$m`,Bu],[`$H`,Vu],[`$W`,`day`],[`$M`,Uu],[`$y`,Gu],[`$D`,Ku]].forEach(function(e){sd[e[1]]=function(t){return this.$g(t,e[0],e[1])}}),U.extend=function(e,t){return e.$i||=(e(t,od,U),!0),U},U.locale=rd,U.isDayjs=nd,U.unix=function(e){return U(e*1e3)},U.en=ed[$u],U.Ls=ed,U.p={};var cd=function(e){return e.replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g,function(e,t,n){return t||n.slice(1)})},ld={LTS:`h:mm:ss A`,LT:`h:mm A`,L:`MM/DD/YYYY`,LL:`MMMM D, YYYY`,LLL:`MMMM D, YYYY h:mm A`,LLLL:`dddd, MMMM D, YYYY h:mm A`},ud=function(e,t){return e.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g,function(e,n,r){var i=r&&r.toUpperCase();return n||t[r]||ld[r]||cd(t[i])})},dd=/(\[[^[]*\])|([-_:/.,()\s]+)|(A|a|Q|YYYY|YY?|ww?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g,fd=/\d/,pd=/\d\d/,md=/\d{3}/,hd=/\d{4}/,gd=/\d\d?/,_d=/[+-]?\d+/,vd=/[+-]\d\d:?(\d\d)?|Z/,yd=/\d*[^-_:/,()\s\d]+/,bd={},xd=function(e){return e=+e,e+(e>68?1900:2e3)};function Sd(e){if(!e||e===`Z`)return 0;var t=e.match(/([+-]|\d\d)/g),n=+(t[1]*60)+(+t[2]||0);return n===0?0:t[0]===`+`?-n:n}var Cd=function(e){return function(t){this[e]=+t}},wd=[vd,function(e){var t=this.zone||={};t.offset=Sd(e)}],Td=function(e){var t=bd[e];return t&&(t.indexOf?t:t.s.concat(t.f))},Ed=function(e,t){var n,r=bd.meridiem;if(!r)n=e===(t?`pm`:`PM`);else for(var i=1;i<=24;i+=1)if(e.indexOf(r(i,0,t))>-1){n=i>12;break}return n},Dd={A:[yd,function(e){this.afternoon=Ed(e,!1)}],a:[yd,function(e){this.afternoon=Ed(e,!0)}],Q:[fd,function(e){this.month=(e-1)*3+1}],S:[fd,function(e){this.milliseconds=e*100}],SS:[pd,function(e){this.milliseconds=e*10}],SSS:[md,function(e){this.milliseconds=+e}],s:[gd,Cd(`seconds`)],ss:[gd,Cd(`seconds`)],m:[gd,Cd(`minutes`)],mm:[gd,Cd(`minutes`)],H:[gd,Cd(`hours`)],h:[gd,Cd(`hours`)],HH:[gd,Cd(`hours`)],hh:[gd,Cd(`hours`)],D:[gd,Cd(`day`)],DD:[pd,Cd(`day`)],Do:[yd,function(e){var t=bd.ordinal,n=e.match(/\d+/);if(this.day=n[0],t)for(var r=1;r<=31;r+=1)t(r).replace(/\[|\]/g,``)===e&&(this.day=r)}],w:[gd,Cd(`week`)],ww:[pd,Cd(`week`)],M:[gd,Cd(`month`)],MM:[pd,Cd(`month`)],MMM:[yd,function(e){var t=Td(`months`),n=(Td(`monthsShort`)||t.map(function(e){return e.slice(0,3)})).indexOf(e)+1;if(n<1)throw Error();this.month=n%12||n}],MMMM:[yd,function(e){var t=Td(`months`).indexOf(e)+1;if(t<1)throw Error();this.month=t%12||t}],Y:[_d,Cd(`year`)],YY:[pd,function(e){this.year=xd(e)}],YYYY:[hd,Cd(`year`)],Z:wd,ZZ:wd};function Od(e){var t=e.afternoon;if(t!==void 0){var n=e.hours;t?n<12&&(e.hours+=12):n===12&&(e.hours=0),delete e.afternoon}}function kd(e){e=ud(e,bd&&bd.formats);for(var t=e.match(dd),n=t.length,r=0;r<n;r+=1){var i=t[r],a=Dd[i],o=a&&a[0],s=a&&a[1];s?t[r]={regex:o,parser:s}:t[r]=i.replace(/^\[|\]$/g,``)}return function(e){for(var r={},i=0,a=0;i<n;i+=1){var o=t[i];if(typeof o==`string`)a+=o.length;else{var s=o.regex,c=o.parser,l=e.slice(a),u=s.exec(l)[0];c.call(r,u),e=e.replace(u,``)}}return Od(r),r}}var Ad=function(e,t,n,r){try{if([`x`,`X`].indexOf(t)>-1)return new Date((t===`X`?1e3:1)*e);var i=kd(t)(e),a=i.year,o=i.month,s=i.day,c=i.hours,l=i.minutes,u=i.seconds,d=i.milliseconds,f=i.zone,p=i.week,m=new Date,h=s||(!a&&!o?m.getDate():1),ee=a||m.getFullYear(),te=0;a&&!o||(te=o>0?o-1:m.getMonth());var ne=c||0,g=l||0,_=u||0,re=d||0;if(f)return new Date(Date.UTC(ee,te,h,ne,g,_,re+f.offset*60*1e3));if(n)return new Date(Date.UTC(ee,te,h,ne,g,_,re));var ie=new Date(ee,te,h,ne,g,_,re);return p&&(ie=r(ie).week(p).toDate()),ie}catch{return new Date(``)}},jd=(function(e,t,n){n.p.customParseFormat=!0,e&&e.parseTwoDigitYear&&(xd=e.parseTwoDigitYear);var r=t.prototype,i=r.parse;r.parse=function(e){var t=e.date,r=e.utc,a=e.args;this.$u=r;var o=a[1];if(typeof o==`string`){var s=a[2]===!0,c=a[3]===!0,l=s||c,u=a[2];c&&(u=a[2]),bd=this.$locale(),!s&&u&&(bd=n.Ls[u]),this.$d=Ad(t,o,r,n),this.init(),u&&u!==!0&&(this.$L=this.locale(u).$L),l&&t!=this.format(o)&&(this.$d=new Date(``)),bd={}}else if(o instanceof Array)for(var d=o.length,f=1;f<=d;f+=1){a[1]=o[f-1];var p=n.apply(this,a);if(p.isValid()){this.$d=p.$d,this.$L=p.$L,this.init();break}f===d&&(this.$d=new Date(``))}else i.call(this,e)}});function Md(e,t){let n=t.prototype,r=n.parse;n.parse=function(e){let t=e.date,n=e.args[1];r.call(this,e);let i=this.year(),a=i>=1900&&i<2e3,o=typeof n==`string`&&n.includes(`YYYY`),s=Array.isArray(n)&&typeof n[0]==`string`&&n[0].includes(`YYYY`),c=o||s,l=typeof t==`string`&&!t.includes(`${i}`);a&&c&&l&&(this.$d.setFullYear(i-1900),this.init())}}var Nd=window,Pd=Nd.trustedTypes,Fd=Pd?Pd.createPolicy(`lit-html`,{createHTML:e=>e}):void 0,Id=`$lit$`,Ld=`lit$${(Math.random()+``).slice(9)}$`,Rd=`?`+Ld,zd=`<${Rd}>`,Bd=document,Vd=()=>Bd.createComment(``),Hd=e=>e===null||typeof e!=`object`&&typeof e!=`function`,Ud=Array.isArray,Wd=e=>Ud(e)||typeof e?.[Symbol.iterator]==`function`,Gd=`[ 	
\f\r]`,Kd=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,qd=/-->/g,Jd=/>/g,Yd=RegExp(`>|${Gd}(?:([^\\s"'>=/]+)(${Gd}*=${Gd}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,`g`),Xd=/'/g,Zd=/"/g,Qd=/^(?:script|style|textarea|title)$/i,$d=e=>(t,...n)=>({_$litType$:e,strings:t,values:n}),ef=$d(1),tf=$d(2),nf=Symbol.for(`lit-noChange`),rf=Symbol.for(`lit-nothing`),af=new WeakMap,of=Bd.createTreeWalker(Bd,129,null,!1);function sf(e,t){if(!Array.isArray(e)||!e.hasOwnProperty(`raw`))throw Error(`invalid template strings array`);return Fd===void 0?t:Fd.createHTML(t)}var cf=(e,t)=>{let n=e.length-1,r=[],i,a=t===2?`<svg>`:``,o=Kd;for(let t=0;t<n;t++){let n=e[t],s,c,l=-1,u=0;for(;u<n.length&&(o.lastIndex=u,c=o.exec(n),c!==null);)u=o.lastIndex,o===Kd?c[1]===`!--`?o=qd:c[1]===void 0?c[2]===void 0?c[3]!==void 0&&(o=Yd):(Qd.test(c[2])&&(i=RegExp(`</`+c[2],`g`)),o=Yd):o=Jd:o===Yd?c[0]===`>`?(o=i??Kd,l=-1):c[1]===void 0?l=-2:(l=o.lastIndex-c[2].length,s=c[1],o=c[3]===void 0?Yd:c[3]===`"`?Zd:Xd):o===Zd||o===Xd?o=Yd:o===qd||o===Jd?o=Kd:(o=Yd,i=void 0);let d=o===Yd&&e[t+1].startsWith(`/>`)?` `:``;a+=o===Kd?n+zd:l>=0?(r.push(s),n.slice(0,l)+Id+n.slice(l)+Ld+d):n+Ld+(l===-2?(r.push(void 0),t):d)}return[sf(e,a+(e[n]||`<?>`)+(t===2?`</svg>`:``)),r]},lf=class e{constructor({strings:t,_$litType$:n},r){let i;this.parts=[];let a=0,o=0,s=t.length-1,c=this.parts,[l,u]=cf(t,n);if(this.el=e.createElement(l,r),of.currentNode=this.el.content,n===2){let e=this.el.content,t=e.firstChild;t.remove(),e.append(...t.childNodes)}for(;(i=of.nextNode())!==null&&c.length<s;){if(i.nodeType===1){if(i.hasAttributes()){let e=[];for(let t of i.getAttributeNames())if(t.endsWith(Id)||t.startsWith(Ld)){let n=u[o++];if(e.push(t),n!==void 0){let e=i.getAttribute(n.toLowerCase()+Id).split(Ld),t=/([.?@])?(.*)/.exec(n);c.push({type:1,index:a,name:t[2],strings:e,ctor:t[1]===`.`?mf:t[1]===`?`?gf:t[1]===`@`?_f:pf})}else c.push({type:6,index:a})}for(let t of e)i.removeAttribute(t)}if(Qd.test(i.tagName)){let e=i.textContent.split(Ld),t=e.length-1;if(t>0){i.textContent=Pd?Pd.emptyScript:``;for(let n=0;n<t;n++)i.append(e[n],Vd()),of.nextNode(),c.push({type:2,index:++a});i.append(e[t],Vd())}}}else if(i.nodeType===8)if(i.data===Rd)c.push({type:2,index:a});else{let e=-1;for(;(e=i.data.indexOf(Ld,e+1))!==-1;)c.push({type:7,index:a}),e+=Ld.length-1}a++}}static createElement(e,t){let n=Bd.createElement(`template`);return n.innerHTML=e,n}};function uf(e,t,n=e,r){var i,a;if(t===nf)return t;let o=r===void 0?n._$Cl:n._$Co?.[r],s=Hd(t)?void 0:t._$litDirective$;return o?.constructor!==s&&((i=o?._$AO)==null||i.call(o,!1),s===void 0?o=void 0:(o=new s(e),o._$AT(e,n,r)),r===void 0?n._$Cl=o:((a=n)._$Co??(a._$Co=[]))[r]=o),o!==void 0&&(t=uf(e,o._$AS(e,t.values),o,r)),t}var df=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:n}=this._$AD,r=(e?.creationScope??Bd).importNode(t,!0);of.currentNode=r;let i=of.nextNode(),a=0,o=0,s=n[0];for(;s!==void 0;){if(a===s.index){let t;s.type===2?t=new ff(i,i.nextSibling,this,e):s.type===1?t=new s.ctor(i,s.name,s.strings,this,e):s.type===6&&(t=new vf(i,this,e)),this._$AV.push(t),s=n[++o]}a!==s?.index&&(i=of.nextNode(),a++)}return of.currentNode=Bd,r}v(e){let t=0;for(let n of this._$AV)n!==void 0&&(n.strings===void 0?n._$AI(e[t]):(n._$AI(e,n,t),t+=n.strings.length-2)),t++}},ff=class e{constructor(e,t,n,r){var i;this.type=2,this._$AH=rf,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=r,this._$Cp=(i=r?.isConnected)==null||i}get _$AU(){return this._$AM?._$AU??this._$Cp}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=uf(this,e,t),Hd(e)?e===rf||e==null||e===``?(this._$AH!==rf&&this._$AR(),this._$AH=rf):e!==this._$AH&&e!==nf&&this._(e):e._$litType$===void 0?e.nodeType===void 0?Wd(e)?this.T(e):this._(e):this.$(e):this.g(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==rf&&Hd(this._$AH)?this._$AA.nextSibling.data=e:this.$(Bd.createTextNode(e)),this._$AH=e}g(e){let{values:t,_$litType$:n}=e,r=typeof n==`number`?this._$AC(e):(n.el===void 0&&(n.el=lf.createElement(sf(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===r)this._$AH.v(t);else{let e=new df(r,this),n=e.u(this.options);e.v(t),this.$(n),this._$AH=e}}_$AC(e){let t=af.get(e.strings);return t===void 0&&af.set(e.strings,t=new lf(e)),t}T(t){Ud(this._$AH)||(this._$AH=[],this._$AR());let n=this._$AH,r,i=0;for(let a of t)i===n.length?n.push(r=new e(this.k(Vd()),this.k(Vd()),this,this.options)):r=n[i],r._$AI(a),i++;i<n.length&&(this._$AR(r&&r._$AB.nextSibling,i),n.length=i)}_$AR(e=this._$AA.nextSibling,t){var n;for((n=this._$AP)==null||n.call(this,!1,!0,t);e&&e!==this._$AB;){let t=e.nextSibling;e.remove(),e=t}}setConnected(e){var t;this._$AM===void 0&&(this._$Cp=e,(t=this._$AP)==null||t.call(this,e))}},pf=class{constructor(e,t,n,r,i){this.type=1,this._$AH=rf,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=i,n.length>2||n[0]!==``||n[1]!==``?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=rf}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,n,r){let i=this.strings,a=!1;if(i===void 0)e=uf(this,e,t,0),a=!Hd(e)||e!==this._$AH&&e!==nf,a&&(this._$AH=e);else{let r=e,o,s;for(e=i[0],o=0;o<i.length-1;o++)s=uf(this,r[n+o],t,o),s===nf&&(s=this._$AH[o]),a||=!Hd(s)||s!==this._$AH[o],s===rf?e=rf:e!==rf&&(e+=(s??``)+i[o+1]),this._$AH[o]=s}a&&!r&&this.j(e)}j(e){e===rf?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??``)}},mf=class extends pf{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===rf?void 0:e}},hf=Pd?Pd.emptyScript:``,gf=class extends pf{constructor(){super(...arguments),this.type=4}j(e){e&&e!==rf?this.element.setAttribute(this.name,hf):this.element.removeAttribute(this.name)}},_f=class extends pf{constructor(e,t,n,r,i){super(e,t,n,r,i),this.type=5}_$AI(e,t=this){if((e=uf(this,e,t,0)??rf)===nf)return;let n=this._$AH,r=e===rf&&n!==rf||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,i=e!==rf&&(n===rf||r);r&&this.element.removeEventListener(this.name,this,n),i&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH==`function`?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},vf=class{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){uf(this,e)}},yf={O:Id,P:Ld,A:Rd,C:1,M:cf,L:df,R:Wd,D:uf,I:ff,V:pf,H:gf,N:_f,U:mf,F:vf},bf=Nd.litHtmlPolyfillSupport;bf?.(lf,ff),(Nd.litHtmlVersions??=[]).push(`2.8.0`);var xf=(e,t,n)=>{let r=n?.renderBefore??t,i=r._$litPart$;if(i===void 0){let e=n?.renderBefore??null;r._$litPart$=i=new ff(t.insertBefore(Vd(),e),e,void 0,n??{})}return i._$AI(e),i},Sf,Cf=class extends Vs{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e;let t=super.createRenderRoot();return(e=this.renderOptions).renderBefore??(e.renderBefore=t.firstChild),t}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=xf(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)==null||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)==null||e.setConnected(!1)}render(){return nf}};Cf.finalized=!0,Cf._$litElement$=!0,(Sf=globalThis.litElementHydrateSupport)==null||Sf.call(globalThis,{LitElement:Cf});var wf=globalThis.litElementPolyfillSupport;wf?.({LitElement:Cf}),(globalThis.litElementVersions??(globalThis.litElementVersions=[])).push(`3.3.3`);var Tf={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Ef=e=>(...t)=>({_$litDirective$:e,values:t}),Df=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,n){this._$Ct=e,this._$AM=t,this._$Ci=n}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}},{I:Of}=yf,kf=e=>e.strings===void 0,Af={},jf=(e,t=Af)=>e._$AH=t,Mf=Ef(class extends Df{constructor(e){if(super(e),e.type!==Tf.PROPERTY&&e.type!==Tf.ATTRIBUTE&&e.type!==Tf.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!kf(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===nf||t===rf)return t;let n=e.element,r=e.name;if(e.type===Tf.PROPERTY){if(t===n[r])return nf}else if(e.type===Tf.BOOLEAN_ATTRIBUTE){if(!!t===n.hasAttribute(r))return nf}else if(e.type===Tf.ATTRIBUTE&&n.getAttribute(r)===t+``)return nf;return jf(e),t}}),Nf=Ef(class extends Df{constructor(e){if(super(e),e.type!==Tf.ATTRIBUTE||e.name!==`class`||e.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return` `+Object.keys(e).filter((t=>e[t])).join(` `)+` `}update(e,[t]){var n;if(this.it===void 0){this.it=new Set,e.strings!==void 0&&(this.nt=new Set(e.strings.join(` `).split(/\s/).filter((e=>e!==``))));for(let e in t)t[e]&&!this.nt?.has(e)&&this.it.add(e);return this.render(t)}let r=e.element.classList;this.it.forEach((e=>{e in t||(r.remove(e),this.it.delete(e))}));for(let e in t){let i=!!t[e];i===this.it.has(e)||(n=this.nt)!=null&&n.has(e)||(i?(r.add(e),this.it.add(e)):(r.remove(e),this.it.delete(e)))}return nf}}),Pf=`important`,Ff=` !`+Pf,If=Ef(class extends Df{constructor(e){if(super(e),e.type!==Tf.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce(((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`}),``)}update(e,[t]){let{style:n}=e.element;if(this.ht===void 0){this.ht=new Set;for(let e in t)this.ht.add(e);return this.render(t)}this.ht.forEach((e=>{t[e]??(this.ht.delete(e),e.includes(`-`)?n.removeProperty(e):n[e]=``)}));for(let e in t){let r=t[e];if(r!=null){this.ht.add(e);let t=typeof r==`string`&&r.endsWith(Ff);e.includes(`-`)||t?n.setProperty(e,t?r.slice(0,-11):r,t?Pf:``):n[e]=r}}return nf}});U.extend(jd),U.extend(Md);var Lf=180,Rf=40,zf=10,Bf=125,Vf=30,Hf=`YYYY`,Uf=`no data`,Wf=0,Gf=`item`,Kf=4,qf={linear:e=>e,logarithmic:e=>Math.log1p(e)},Jf=B`var(--histogramDateRangeSliderColor, #4B65FE)`,Yf=B`var(--histogramDateRangeSelectedRangeColor, #DBE0FF)`,Xf=B`var(--histogramDateRangeBarIncludedFill, #2C2C2C)`,Zf=B`var(--histogramDateRangeActivityIndicator, #2C2C2C)`,Qf=B`var(--histogramDateRangeBarExcludedFill, #CCCCCC)`,$f=B`var(--histogramDateRangeInputRowMargin, 0)`,ep=B`var(--histogramDateRangeInputBorder, 0.5px solid #2C2C2C)`,tp=B`var(--histogramDateRangeInputWidth, 35px)`,np=B`var(--histogramDateRangeInputFontSize, 1.2rem)`,rp=B`var(--histogramDateRangeInputFontFamily, sans-serif)`,ip=B`var(--histogramDateRangeTooltipBackgroundColor, #2C2C2C)`,ap=B`var(--histogramDateRangeTooltipTextColor, #FFFFFF)`,op=B`var(--histogramDateRangeTooltipFontSize, 1.1rem)`,sp=B`var(--histogramDateRangeTooltipFontFamily, sans-serif)`,G=class extends Cf{constructor(){super(...arguments),this.width=Lf,this.height=Rf,this.sliderWidth=zf,this.tooltipWidth=Bf,this.tooltipHeight=Vf,this.updateDelay=Wf,this.dateFormat=Hf,this.missingDataMessage=Uf,this.minDate=``,this.maxDate=``,this.disabled=!1,this.bins=[],this.updateWhileFocused=!1,this.binSnapping=`none`,this.tooltipLabel=Gf,this.barScaling=`logarithmic`,this._tooltipOffsetX=0,this._tooltipOffsetY=0,this._isDragging=!1,this._isLoading=!1,this._minSelectedDate=``,this._maxSelectedDate=``,this._minDateMS=0,this._maxDateMS=0,this._dragOffset=0,this._histWidth=0,this._binWidth=0,this._histData=[],this._previousDateRange=``,this.drag=e=>{e.preventDefault(),!this.disabled&&(this.setDragOffset(e),this._isDragging=!0,this.addListeners(),this.cancelPendingUpdateEvent())},this.drop=()=>{this._isDragging&&(this.removeListeners(),this.beginEmitUpdateProcess()),this._isDragging=!1},this.move=e=>{let t=this.getBoundingClientRect().x,n=e.clientX-t-this._dragOffset;this._currentSlider.id===`slider-min`?this.minSelectedDate=this.translatePositionToDate(this.validMinSliderX(n)):(this.maxSelectedDate=this.translatePositionToDate(this.validMaxSliderX(n)),this.getMSFromString(this.maxSelectedDate)>this._maxDateMS&&(this.maxSelectedDate=this.maxDate))}}disconnectedCallback(){this.removeListeners(),super.disconnectedCallback()}willUpdate(e){(e.has(`bins`)||e.has(`minDate`)||e.has(`maxDate`)||e.has(`minSelectedDate`)||e.has(`maxSelectedDate`)||e.has(`width`)||e.has(`height`)||e.has(`binSnapping`)||e.has(`barScaling`))&&this.handleDataUpdate()}handleDataUpdate(){this.hasBinData&&(this._histWidth=this.width-this.sliderWidth*2,this._minDateMS=this.snapTimestamp(this.getMSFromString(this.minDate)),this._maxDateMS=this.snapTimestamp(this.getMSFromString(this.maxDate)+this.snapInterval)+this.snapEndOffset,this._binWidth=this._histWidth/this._numBins,this._histData=this.calculateHistData(),this.minSelectedDate=this.minSelectedDate?this.minSelectedDate:this.minDate,this.maxSelectedDate=this.maxSelectedDate?this.maxSelectedDate:this.maxDate)}snapToNextSecond(e){return Math.ceil(e/1e3)*1e3}snapToMonth(e){let t=U(e),n=t.date()<16?0:1;return t.add(n,`month`).date(1).hour(0).minute(0).second(0).millisecond(0).valueOf()}snapToYear(e){let t=U(e),n=t.month()<6?0:1;return t.add(n,`year`).month(0).date(1).hour(0).minute(0).second(0).millisecond(0).valueOf()}snapTimestamp(e){switch(this.binSnapping){case`year`:return this.snapToYear(e);case`month`:return this.snapToMonth(e);default:return this.snapToNextSecond(e)}}get barScalingFunction(){return typeof this.barScaling==`string`?qf[this.barScaling]:this.barScaling}calculateHistData(){let{bins:e,height:t,dateRangeMS:n,_numBins:r,_minDateMS:i}=this,a=Math.min(...this.bins),o=Math.max(...this.bins),s=t/(a===o?1:this.barScalingFunction(o)),c=n/r;return e.map((e,t)=>{let n=this.snapTimestamp(t*c+i),r=this.formatDate(n),a=this.snapTimestamp((t+1)*c+i)+this.snapEndOffset,o=this.formatDate(a),l=this.formatDate(n,this.tooltipDateFormat),u=this.formatDate(a,this.tooltipDateFormat),d=l===u?l:`${l} - ${u}`;return{value:e,height:Math.floor(this.barScalingFunction(e)*s),binStart:r,binEnd:o,tooltip:d}})}get hasBinData(){return this._numBins>0}get _numBins(){return!this.bins||!this.bins.length?0:this.bins.length}get histogramLeftEdgeX(){return this.sliderWidth}get histogramRightEdgeX(){return this.width-this.sliderWidth}get snapInterval(){switch(this.binSnapping){case`year`:return 31536e6;case`month`:return 2592e6;default:return 0}}get snapEndOffset(){return this.binSnapping!==`none`&&this._numBins>1?-1:0}get tooltipDateFormat(){return this._tooltipDateFormat??this.dateFormat}set tooltipDateFormat(e){this._tooltipDateFormat=e}get loading(){return this._isLoading}set loading(e){this.disabled=e,this._isLoading=e}get minSelectedDate(){return this.formatDate(this.getMSFromString(this._minSelectedDate))}set minSelectedDate(e){if(!this._minSelectedDate){this._minSelectedDate=e;return}let t=this.getMSFromString(e),n=!Number.isNaN(t),r=t<=this.getMSFromString(this.maxSelectedDate);n&&r&&(this._minSelectedDate=this.formatDate(t)),this.requestUpdate()}get maxSelectedDate(){return this.formatDate(this.getMSFromString(this._maxSelectedDate))}set maxSelectedDate(e){if(!this._maxSelectedDate){this._maxSelectedDate=e;return}let t=this.getMSFromString(e),n=!Number.isNaN(t),r=t>=this.getMSFromString(this.minSelectedDate);n&&r&&(this._maxSelectedDate=this.formatDate(t)),this.requestUpdate()}get minSliderX(){let e=this.translateDateToPosition(this.minSelectedDate);return this.validMinSliderX(e)}get maxSliderX(){let e=this.snapTimestamp(this.getMSFromString(this.maxSelectedDate)+this.snapInterval),t=this.translateDateToPosition(this.formatDate(e));return this.validMaxSliderX(t)}get dateRangeMS(){return this._maxDateMS-this._minDateMS}showTooltip(e){var t,n;if(this._isDragging||this.disabled)return;let r=e.currentTarget,i=r.x.baseVal.value+this.sliderWidth/2,a=r.dataset,o=`${this.tooltipLabel}${a.numItems===`1`?``:`s`}`,s=Number(a.numItems).toLocaleString(),c=9+this.tooltipHeight,l=this.getBoundingClientRect(),u=l.x+i,d=l.y;this._tooltipOffsetX=u-2+(this._binWidth-this.sliderWidth-this.tooltipWidth)/2+window.scrollX,this._tooltipOffsetY=d-c+window.scrollY,this._tooltipContent=ef`
      ${s} ${o}<br />
      ${a.tooltip}
    `,(n=(t=this._tooltip).showPopover)==null||n.call(t)}hideTooltip(){var e,t;this._tooltipContent=void 0,(t=(e=this._tooltip).hidePopover)==null||t.call(e)}validMinSliderX(e){let t=Math.min(this.translateDateToPosition(this.maxSelectedDate),this.histogramRightEdgeX);return e=this.clamp(e,this.histogramLeftEdgeX,t),Number.isNaN(e)||t<this.histogramLeftEdgeX?this.histogramLeftEdgeX:e}validMaxSliderX(e){let t=Math.max(this.histogramLeftEdgeX,this.translateDateToPosition(this.minSelectedDate));return e=this.clamp(e,t,this.histogramRightEdgeX),Number.isNaN(e)||t>this.histogramRightEdgeX?this.histogramRightEdgeX:e}addListeners(){window.addEventListener(`pointermove`,this.move),window.addEventListener(`pointerup`,this.drop),window.addEventListener(`pointercancel`,this.drop)}removeListeners(){window.removeEventListener(`pointermove`,this.move),window.removeEventListener(`pointerup`,this.drop),window.removeEventListener(`pointercancel`,this.drop)}beginEmitUpdateProcess(){this.cancelPendingUpdateEvent(),this._emitUpdatedEventTimer=setTimeout(()=>{if(this.currentDateRangeString===this._previousDateRange)return;this._previousDateRange=this.currentDateRangeString;let e={detail:{minDate:this.minSelectedDate,maxDate:this.maxSelectedDate},bubbles:!0,composed:!0};this.dispatchEvent(new CustomEvent(`histogramDateRangeUpdated`,e))},this.updateDelay)}cancelPendingUpdateEvent(){this._emitUpdatedEventTimer!==void 0&&(clearTimeout(this._emitUpdatedEventTimer),this._emitUpdatedEventTimer=void 0)}setDragOffset(e){this._currentSlider=e.currentTarget;let t=this._currentSlider.id===`slider-min`?this.minSliderX:this.maxSliderX,n=this.getBoundingClientRect().x;this._dragOffset=e.clientX-n-t}translatePositionToDate(e){let t=this.snapToNextSecond((e-this.sliderWidth)*this.dateRangeMS/this._histWidth);return this.formatDate(this._minDateMS+t)}translateDateToPosition(e){let t=this.getMSFromString(e);return this.sliderWidth+(t-this._minDateMS)*this._histWidth/this.dateRangeMS}clamp(e,t,n){return Math.min(Math.max(e,t),n)}handleInputFocus(){this.updateWhileFocused||this.cancelPendingUpdateEvent()}handleMinDateInput(e){let t=e.currentTarget;t.value!==this.minSelectedDate&&(this.minSelectedDate=t.value,this.beginEmitUpdateProcess())}handleMaxDateInput(e){let t=e.currentTarget;t.value!==this.maxSelectedDate&&(this.maxSelectedDate=t.value,this.beginEmitUpdateProcess())}handleKeyUp(e){if(e.key===`Enter`){let t=e.currentTarget;t.blur(),t.id===`date-min`?this.handleMinDateInput(e):t.id===`date-max`&&this.handleMaxDateInput(e)}}get currentDateRangeString(){return`${this.minSelectedDate}:${this.maxSelectedDate}`}getMSFromString(e){let t=typeof e==`string`?e:String(e);if((t.split(/(\d+)/).length-1)/2==1){let e=new Date(0,0);return e.setFullYear(Number(t)),e.getTime()}return U(t,[this.dateFormat,Hf]).valueOf()}handleBarClick(e){let t=e.currentTarget.dataset,n=(this.getMSFromString(t.binStart)+this.getMSFromString(t.binEnd))/2;Math.abs(n-this.getMSFromString(this.minSelectedDate))<Math.abs(n-this.getMSFromString(this.maxSelectedDate))?this.minSelectedDate=t.binStart:this.maxSelectedDate=t.binEnd,this.beginEmitUpdateProcess()}get minSliderTemplate(){let e=Kf,t=`
            M${this.minSliderX},0
            ...
            q0,${e} ${e},${e}
            h${this.sliderWidth-e}
          `;return this.generateSliderSVG(this.minSliderX,`slider-min`,t)}get maxSliderTemplate(){let e=Kf,t=`
            M${this.maxSliderX},0
            h${this.sliderWidth-e}
            q${e},0 ${e},${e}
            v${this.height-e*2}
            q0,${e} -${e},${e}
            h-${this.sliderWidth-e}
          `;return this.generateSliderSVG(this.maxSliderX,`slider-max`,t)}generateSliderSVG(e,t,n){let r=t===`slider-min`?1:-1;return tf`
    <svg
      id=${t}
      class=${Nf({slider:!0,draggable:!this.disabled,dragging:this._isDragging})}
    ...
    `}get selectedRangeTemplate(){return tf`
      <rect
        x="${this.minSliderX}"
        y="0"
        ...
        height="${this.height}"
        fill="${Yf}"
      />`}get histogramTemplate(){let e=this._histWidth/this._numBins,t=e-1,n=this.sliderWidth;return this._histData.map(r=>{let{minSelectedDate:i,maxSelectedDate:a}=this,o=r.height,s=this.isBefore(r.binEnd,i),c=this.isAfter(r.binStart,a),l=s||c?Qf:Xf,u=`stroke-dasharray: 0 ${t} ${o} ${t} 0 ${o}`,d=tf`
        <rect
        ...
        <rect
          ...
          height=${o}
          fill=${l}
        />`;return n+=e,d})}isBefore(e,t){return this.getMSFromString(e)<this.getMSFromString(t)}isAfter(e,t){return this.getMSFromString(e)>this.getMSFromString(t)}formatDate(e,t=this.dateFormat){if(Number.isNaN(e))return``;let n=U(e);return n.year()<1e3?n.year(199999).format(t).replace(/199999/g,n.year().toString()):n.format(t)}get minInputTemplate(){return ef`
      <input
        id="date-min"
        ...
        .value=${Mf(this.minSelectedDate)}
        ?disabled=${this.disabled}
      />
    `}get maxInputTemplate(){return ef`
      <input
        id="date-max"
        placeholder=${this.dateFormat}
        type="text"
        ...
        @keyup=${this.handleKeyUp}
        .value=${Mf(this.maxSelectedDate)}
        ?disabled=${this.disabled}
      />
    `}get minLabelTemplate(){return ef`<label for="date-min" class="sr-only">Minimum date:</label>`}get maxLabelTemplate(){return ef`<label for="date-max" class="sr-only">Maximum date:</label>`}get tooltipTemplate(){return ef`
      <div id="tooltip" style=${If({width:`${this.tooltipWidth}px`,height:`${this.tooltipHeight}px`,top:`${this._tooltipOffsetY}px`,left:`${this._tooltipOffsetX}px`})} popover>${this._tooltipContent}</div>
    `}get histogramAccessibilityTemplate(){let e=``;return this.minSelectedDate&&this.maxSelectedDate?e=` from ${this.minSelectedDate} to ${this.maxSelectedDate}`:this.minSelectedDate?e=` from ${this.minSelectedDate}`:this.maxSelectedDate&&(e=` up to ${this.maxSelectedDate}`),ef`<title id="histogram-title">${`Filter results for dates${e}`}</title
      ><desc id="histogram-desc">${`This histogram shows the distribution of dates${e}`}</desc>`}get noDataTemplate(){return ef`
      <div class="missing-data-message">${this.missingDataMessage}</div>
    `}get activityIndicatorTemplate(){return this.loading?ef`
      <ia-activity-indicator mode="processing"> </ia-activity-indicator>
    `:rf}render(){return this.hasBinData?ef`
      <div
        id="container"
        class="
          noselect
    ...
    ia-activity-indicator {
      ...
      --activityIndicatorLoadingRingColor: ${Zf};
    }
    ...
    #tooltip:after {
      ...
      /* arrow */
      border: 5px solid ${ap};
      border-color: ${ip} transparent transparent
        transparent;
    }
    /****** slider ********/
    .slider {
  ...
  `,t([V({type:Number})],G.prototype,`width`,void 0),t([V({type:Number})],G.prototype,`height`,void 0),t([V({type:Number})],G.prototype,`sliderWidth`,void 0),t([V({type:Number})],G.prototype,`tooltipWidth`,void 0),t([V({type:Number})],G.prototype,`tooltipHeight`,void 0),t([V({type:Number})],G.prototype,`updateDelay`,void 0),t([V({type:String})],G.prototype,`dateFormat`,void 0),t([V({type:String})],G.prototype,`missingDataMessage`,void 0),t([V({type:String})],G.prototype,`minDate`,void 0),t([V({type:String})],G.prototype,`maxDate`,void 0),t([V({type:Boolean})],G.prototype,`disabled`,void 0),t([V({type:Array})],G.prototype,`bins`,void 0),t([V({type:Boolean})],G.prototype,`updateWhileFocused`,void 0),t([V({type:String})],G.prototype,`binSnapping`,void 0),t([V({type:String})],G.prototype,`tooltipLabel`,void 0),t([V({type:String})],G.prototype,`barScaling`,void 0),t([Fc()],G.prototype,`_tooltipOffsetX`,void 0),t([Fc()],G.prototype,`_tooltipOffsetY`,void 0),t([Fc()],G.prototype,`_tooltipContent`,void 0),t([Fc()],G.prototype,`_tooltipDateFormat`,void 0),t([Fc()],G.prototype,`_isDragging`,void 0),t([Fc()],G.prototype,`_isLoading`,void 0),t([Lc(`#tooltip`)],G.prototype,`_tooltip`,void 0),t([V({type:String})],G.prototype,`tooltipDateFormat`,null),t([V({type:Boolean})],G.prototype,`loading`,null),t([V()],G.prototype,`minSelectedDate`,null),t([V()],G.prototype,`maxSelectedDate`,null),G=t([Mc(`histogram-date-range`)],G);var cp=window,lp=cp.trustedTypes,up=lp?lp.createPolicy(`lit-html`,{createHTML:e=>e}):void 0,dp=`$lit$`,fp=`lit$${(Math.random()+``).slice(9)}$`,pp=`?`+fp,mp=`<${pp}>`,hp=document,gp=()=>hp.createComment(``),_p=e=>e===null||typeof e!=`object`&&typeof e!=`function`,vp=Array.isArray,yp=e=>vp(e)||typeof e?.[Symbol.iterator]==`function`,bp=`[ 	
\f\r]`,xp=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Sp=/-->/g,Cp=/>/g,wp=RegExp(`>|${bp}(?:([^\\s"'>=/]+)(${bp}*=${bp}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,`g`),Tp=/'/g,Ep=/"/g,Dp=/^(?:script|style|textarea|title)$/i,Op=e=>(t,...n)=>({_$litType$:e,strings:t,values:n}),K=Op(1),kp=Op(2),Ap=Symbol.for(`lit-noChange`),q=Symbol.for(`lit-nothing`),jp=new WeakMap,Mp=hp.createTreeWalker(hp,129,null,!1);function Np(e,t){if(!Array.isArray(e)||!e.hasOwnProperty(`raw`))throw Error(`invalid template strings array`);return up===void 0?t:up.createHTML(t)}var Pp=(e,t)=>{let n=e.length-1,r=[],i,a=t===2?`<svg>`:``,o=xp;for(let t=0;t<n;t++){let n=e[t],s,c,l=-1,u=0;for(;u<n.length&&(o.lastIndex=u,c=o.exec(n),c!==null);)u=o.lastIndex,o===xp?c[1]===`!--`?o=Sp:c[1]===void 0?c[2]===void 0?c[3]!==void 0&&(o=wp):(Dp.test(c[2])&&(i=RegExp(`</`+c[2],`g`)),o=wp):o=Cp:o===wp?c[0]===`>`?(o=i??xp,l=-1):c[1]===void 0?l=-2:(l=o.lastIndex-c[2].length,s=c[1],o=c[3]===void 0?wp:c[3]===`"`?Ep:Tp):o===Ep||o===Tp?o=wp:o===Sp||o===Cp?o=xp:(o=wp,i=void 0);let d=o===wp&&e[t+1].startsWith(`/>`)?` `:``;a+=o===xp?n+mp:l>=0?(r.push(s),n.slice(0,l)+dp+n.slice(l)+fp+d):n+fp+(l===-2?(r.push(void 0),t):d)}return[Np(e,a+(e[n]||`<?>`)+(t===2?`</svg>`:``)),r]},Fp=class e{constructor({strings:t,_$litType$:n},r){let i;this.parts=[];let a=0,o=0,s=t.length-1,c=this.parts,[l,u]=Pp(t,n);if(this.el=e.createElement(l,r),Mp.currentNode=this.el.content,n===2){let e=this.el.content,t=e.firstChild;t.remove(),e.append(...t.childNodes)}for(;(i=Mp.nextNode())!==null&&c.length<s;){if(i.nodeType===1){if(i.hasAttributes()){let e=[];for(let t of i.getAttributeNames())if(t.endsWith(dp)||t.startsWith(fp)){let n=u[o++];if(e.push(t),n!==void 0){let e=i.getAttribute(n.toLowerCase()+dp).split(fp),t=/([.?@])?(.*)/.exec(n);c.push({type:1,index:a,name:t[2],strings:e,ctor:t[1]===`.`?Bp:t[1]===`?`?Hp:t[1]===`@`?Up:zp})}else c.push({type:6,index:a})}for(let t of e)i.removeAttribute(t)}if(Dp.test(i.tagName)){let e=i.textContent.split(fp),t=e.length-1;if(t>0){i.textContent=lp?lp.emptyScript:``;for(let n=0;n<t;n++)i.append(e[n],gp()),Mp.nextNode(),c.push({type:2,index:++a});i.append(e[t],gp())}}}else if(i.nodeType===8)if(i.data===pp)c.push({type:2,index:a});else{let e=-1;for(;(e=i.data.indexOf(fp,e+1))!==-1;)c.push({type:7,index:a}),e+=fp.length-1}a++}}static createElement(e,t){let n=hp.createElement(`template`);return n.innerHTML=e,n}};function Ip(e,t,n=e,r){var i,a;if(t===Ap)return t;let o=r===void 0?n._$Cl:n._$Co?.[r],s=_p(t)?void 0:t._$litDirective$;return o?.constructor!==s&&((i=o?._$AO)==null||i.call(o,!1),s===void 0?o=void 0:(o=new s(e),o._$AT(e,n,r)),r===void 0?n._$Cl=o:((a=n)._$Co??(a._$Co=[]))[r]=o),o!==void 0&&(t=Ip(e,o._$AS(e,t.values),o,r)),t}var Lp=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:n}=this._$AD,r=(e?.creationScope??hp).importNode(t,!0);Mp.currentNode=r;let i=Mp.nextNode(),a=0,o=0,s=n[0];for(;s!==void 0;){if(a===s.index){let t;s.type===2?t=new Rp(i,i.nextSibling,this,e):s.type===1?t=new s.ctor(i,s.name,s.strings,this,e):s.type===6&&(t=new Wp(i,this,e)),this._$AV.push(t),s=n[++o]}a!==s?.index&&(i=Mp.nextNode(),a++)}return Mp.currentNode=hp,r}v(e){let t=0;for(let n of this._$AV)n!==void 0&&(n.strings===void 0?n._$AI(e[t]):(n._$AI(e,n,t),t+=n.strings.length-2)),t++}},Rp=class e{constructor(e,t,n,r){var i;this.type=2,this._$AH=q,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=r,this._$Cp=(i=r?.isConnected)==null||i}get _$AU(){return this._$AM?._$AU??this._$Cp}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Ip(this,e,t),_p(e)?e===q||e==null||e===``?(this._$AH!==q&&this._$AR(),this._$AH=q):e!==this._$AH&&e!==Ap&&this._(e):e._$litType$===void 0?e.nodeType===void 0?yp(e)?this.T(e):this._(e):this.$(e):this.g(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==q&&_p(this._$AH)?this._$AA.nextSibling.data=e:this.$(hp.createTextNode(e)),this._$AH=e}g(e){let{values:t,_$litType$:n}=e,r=typeof n==`number`?this._$AC(e):(n.el===void 0&&(n.el=Fp.createElement(Np(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===r)this._$AH.v(t);else{let e=new Lp(r,this),n=e.u(this.options);e.v(t),this.$(n),this._$AH=e}}_$AC(e){let t=jp.get(e.strings);return t===void 0&&jp.set(e.strings,t=new Fp(e)),t}T(t){vp(this._$AH)||(this._$AH=[],this._$AR());let n=this._$AH,r,i=0;for(let a of t)i===n.length?n.push(r=new e(this.k(gp()),this.k(gp()),this,this.options)):r=n[i],r._$AI(a),i++;i<n.length&&(this._$AR(r&&r._$AB.nextSibling,i),n.length=i)}_$AR(e=this._$AA.nextSibling,t){var n;for((n=this._$AP)==null||n.call(this,!1,!0,t);e&&e!==this._$AB;){let t=e.nextSibling;e.remove(),e=t}}setConnected(e){var t;this._$AM===void 0&&(this._$Cp=e,(t=this._$AP)==null||t.call(this,e))}},zp=class{constructor(e,t,n,r,i){this.type=1,this._$AH=q,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=i,n.length>2||n[0]!==``||n[1]!==``?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=q}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,n,r){let i=this.strings,a=!1;if(i===void 0)e=Ip(this,e,t,0),a=!_p(e)||e!==this._$AH&&e!==Ap,a&&(this._$AH=e);else{let r=e,o,s;for(e=i[0],o=0;o<i.length-1;o++)s=Ip(this,r[n+o],t,o),s===Ap&&(s=this._$AH[o]),a||=!_p(s)||s!==this._$AH[o],s===q?e=q:e!==q&&(e+=(s??``)+i[o+1]),this._$AH[o]=s}a&&!r&&this.j(e)}j(e){e===q?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??``)}},Bp=class extends zp{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===q?void 0:e}},Vp=lp?lp.emptyScript:``,Hp=class extends zp{constructor(){super(...arguments),this.type=4}j(e){e&&e!==q?this.element.setAttribute(this.name,Vp):this.element.removeAttribute(this.name)}},Up=class extends zp{constructor(e,t,n,r,i){super(e,t,n,r,i),this.type=5}_$AI(e,t=this){if((e=Ip(this,e,t,0)??q)===Ap)return;let n=this._$AH,r=e===q&&n!==q||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,i=e!==q&&(n===q||r);r&&this.element.removeEventListener(this.name,this,n),i&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH==`function`?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},Wp=class{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){Ip(this,e)}},Gp=cp.litHtmlPolyfillSupport;Gp?.(Fp,Rp),(cp.litHtmlVersions??=[]).push(`2.8.0`);var Kp=(e,t,n)=>{let r=n?.renderBefore??t,i=r._$litPart$;if(i===void 0){let e=n?.renderBefore??null;r._$litPart$=i=new Rp(t.insertBefore(gp(),e),e,void 0,n??{})}return i._$AI(e),i},qp,Jp=class extends Vs{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e;let t=super.createRenderRoot();return(e=this.renderOptions).renderBefore??(e.renderBefore=t.firstChild),t}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Kp(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)==null||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)==null||e.setConnected(!1)}render(){return Ap}};Jp.finalized=!0,Jp._$litElement$=!0,(qp=globalThis.litElementHydrateSupport)==null||qp.call(globalThis,{LitElement:Jp});var Yp=globalThis.litElementPolyfillSupport;Yp?.({LitElement:Jp}),(globalThis.litElementVersions??(globalThis.litElementVersions=[])).push(`3.3.3`);var Xp=kp`
<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><path d="m51.5960452 0c5.420012 0 6.7920618 2.72313378 8.1300179 9.28391016 2.9793915 19.21608984-2.9793915 28.94849474 0 31.58229234 1.2215505 1.079857 1.8678662.7924226 3.2997314.0773518l.2153069-.1075882c2.1016905-1.0490161 5.8499713-2.8359661 14.9013153-2.8359661l2.3393989.00075c14.0694555.01425 14.2569231.29925 18.0062757 5.99925 0 3.2648986.9924719 9.5-3.9698878 9.5 4.9623597 0 7.9397755 15.5 0 15.5 7.9397755 0 6.9473035 15.5-.9924719 15.5 7.9397754 0 5.9548316 12 2.9774158 13-1.1342536.5714286-1.9876793 1.0011812-2.627102 1.3222794l-.3279542.1645673c-1.5889262.796641-1.5747062.7780161-1.4530457.6832252l.0244872-.0190992c.0041709-.0032756.0083532-.0065808.0124967-.0098908l.0239934-.0197196c.1060465-.0904428.1029348-.1457697-1.111471.3786377h-55.0821921c-3.3082398-3.0266004-4.9623597-5.0266004-4.9623597-6v-33.4737525c5.5882429-8.3508317 10.6469206-21.2754909 15.1760333-38.7739777v-17.92948326c0-2.54852436 1.8066707-3.82278654 5.4200119-3.82278654zm-27.5960452 56c2.209139 0 4 1.790861 4 4v36c0 2.209139-1.790861 4-4 4h-20c-2.209139 0-4-1.790861-4-4v-36c0-2.209139 1.790861-4 4-4z" fill-rule="evenodd"/></svg>`,Zp=kp`
<svg viewBox="0 0 100 100"
  xmlns="http://www.w3.org/2000/svg">
...
`,J=class extends Jp{constructor(){super(...arguments),this.prompt=`Do you find this feature useful?`,this.buttonText=`Beta`,this.displayMode=`button`,this.isOpen=!1,this.processing=!1,this.popupTopX=0,this.popupTopY=0,this.voteSubmitted=!1,this.voteNeedsChoosing=!1,this.resizingElement=document.body}render(){return K`
      <div id="container">
    ...
    `}};t([V({type:String})],J.prototype,`featureIdentifier`,void 0),t([V({type:String})],J.prototype,`prompt`,void 0),t([V({type:String})],J.prototype,`buttonText`,void 0),t([V({type:String})],J.prototype,`displayMode`,void 0),t([V({type:Object})],J.prototype,`recaptchaManager`,void 0),t([V({type:Object})],J.prototype,`resizeObserver`,void 0),t([V({type:Boolean})],J.prototype,`disabled`,void 0),t([V({type:Object})],J.prototype,`featureFeedbackService`,void 0),t([Fc()],J.prototype,`isOpen`,void 0),t([Fc()],J.prototype,`processing`,void 0),t([Fc()],J.prototype,`popupTopX`,void 0),t([Fc()],J.prototype,`popupTopY`,void 0),t([Fc()],J.prototype,`vote`,void 0),t([Fc()],J.prototype,`voteSubmitted`,void 0),t([Fc()],J.prototype,`error`,void 0),t([Fc()],J.prototype,`voteNeedsChoosing`,void 0),t([Fc()],J.prototype,`recaptchaWidget`,void 0),t([Lc(`#container`)],J.prototype,`container`,void 0),t([Lc(`#popup`)],J.prototype,`popup`,void 0),t([Lc(`#comments`)],J.prototype,`comments`,void 0),J=t([Mc(`feature-feedback`)],J);var Qp={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},$p=e=>(...t)=>({_$litDirective$:e,values:t}),em=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,n){this._$Ct=e,this._$AM=t,this._$Ci=n}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}},tm=`important`,nm=` !`+tm,rm=$p(class extends em{constructor(e){if(super(e),e.type!==Qp.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce(((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`}),``)}update(e,[t]){let{style:n}=e.element;if(this.ht===void 0){this.ht=new Set;for(let e in t)this.ht.add(e);return this.render(t)}this.ht.forEach((e=>{t[e]??(this.ht.delete(e),e.includes(`-`)?n.removeProperty(e):n[e]=``)}));for(let e in t){let r=t[e];if(r!=null){this.ht.add(e);let t=typeof r==`string`&&r.endsWith(nm);e.includes(`-`)||t?n.setProperty(e,t?r.slice(0,-11):r,t?tm:``):n[e]=r}}return Ap}}),im=e=>typeof e!=`string`&&`strTag`in e,am=(e,t,n)=>{let r=e[0];for(let i=1;i<e.length;i++)r+=t[n?n[i-1]:i-1],r+=e[i];return r},om=(e=>im(e)?am(e.strings,e.values):e),sm=class{constructor(){this.settled=!1,this.promise=new Promise((e,t)=>{this._resolve=e,this._reject=t})}resolve(e){this.settled=!0,this._resolve(e)}reject(e){this.settled=!0,this._reject(e)}},cm=[];for(let e=0;e<256;e++)cm[e]=(e>>4&15).toString(16)+(e&15).toString(16);new sm().resolve();var lm=om,um=window,dm=um.trustedTypes,fm=dm?dm.createPolicy(`lit-html`,{createHTML:e=>e}):void 0,pm=`$lit$`,mm=`lit$${(Math.random()+``).slice(9)}$`,hm=`?`+mm,gm=`<${hm}>`,_m=document,vm=()=>_m.createComment(``),ym=e=>e===null||typeof e!=`object`&&typeof e!=`function`,bm=Array.isArray,xm=e=>bm(e)||typeof e?.[Symbol.iterator]==`function`,Sm=`[ 	
\f\r]`,Cm=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,wm=/-->/g,Tm=/>/g,Em=RegExp(`>|${Sm}(?:([^\\s"'>=/]+)(${Sm}*=${Sm}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,`g`),Dm=/'/g,Om=/"/g,km=/^(?:script|style|textarea|title)$/i,Am=Symbol.for(`lit-noChange`),jm=Symbol.for(`lit-nothing`),Mm=new WeakMap,Nm=_m.createTreeWalker(_m,129,null,!1);function Pm(e,t){if(!Array.isArray(e)||!e.hasOwnProperty(`raw`))throw Error(`invalid template strings array`);return fm===void 0?t:fm.createHTML(t)}var Fm=(e,t)=>{let n=e.length-1,r=[],i,a=t===2?`<svg>`:``,o=Cm;for(let t=0;t<n;t++){let n=e[t],s,c,l=-1,u=0;for(;u<n.length&&(o.lastIndex=u,c=o.exec(n),c!==null);)u=o.lastIndex,o===Cm?c[1]===`!--`?o=wm:c[1]===void 0?c[2]===void 0?c[3]!==void 0&&(o=Em):(km.test(c[2])&&(i=RegExp(`</`+c[2],`g`)),o=Em):o=Tm:o===Em?c[0]===`>`?(o=i??Cm,l=-1):c[1]===void 0?l=-2:(l=o.lastIndex-c[2].length,s=c[1],o=c[3]===void 0?Em:c[3]===`"`?Om:Dm):o===Om||o===Dm?o=Em:o===wm||o===Tm?o=Cm:(o=Em,i=void 0);let d=o===Em&&e[t+1].startsWith(`/>`)?` `:``;a+=o===Cm?n+gm:l>=0?(r.push(s),n.slice(0,l)+pm+n.slice(l)+mm+d):n+mm+(l===-2?(r.push(void 0),t):d)}return[Pm(e,a+(e[n]||`<?>`)+(t===2?`</svg>`:``)),r]},Im=class e{constructor({strings:t,_$litType$:n},r){let i;this.parts=[];let a=0,o=0,s=t.length-1,c=this.parts,[l,u]=Fm(t,n);if(this.el=e.createElement(l,r),Nm.currentNode=this.el.content,n===2){let e=this.el.content,t=e.firstChild;t.remove(),e.append(...t.childNodes)}for(;(i=Nm.nextNode())!==null&&c.length<s;){if(i.nodeType===1){if(i.hasAttributes()){let e=[];for(let t of i.getAttributeNames())if(t.endsWith(pm)||t.startsWith(mm)){let n=u[o++];if(e.push(t),n!==void 0){let e=i.getAttribute(n.toLowerCase()+pm).split(mm),t=/([.?@])?(.*)/.exec(n);c.push({type:1,index:a,name:t[2],strings:e,ctor:t[1]===`.`?Vm:t[1]===`?`?Um:t[1]===`@`?Wm:Bm})}else c.push({type:6,index:a})}for(let t of e)i.removeAttribute(t)}if(km.test(i.tagName)){let e=i.textContent.split(mm),t=e.length-1;if(t>0){i.textContent=dm?dm.emptyScript:``;for(let n=0;n<t;n++)i.append(e[n],vm()),Nm.nextNode(),c.push({type:2,index:++a});i.append(e[t],vm())}}}else if(i.nodeType===8)if(i.data===hm)c.push({type:2,index:a});else{let e=-1;for(;(e=i.data.indexOf(mm,e+1))!==-1;)c.push({type:7,index:a}),e+=mm.length-1}a++}}static createElement(e,t){let n=_m.createElement(`template`);return n.innerHTML=e,n}};function Lm(e,t,n=e,r){var i,a;if(t===Am)return t;let o=r===void 0?n._$Cl:n._$Co?.[r],s=ym(t)?void 0:t._$litDirective$;return o?.constructor!==s&&((i=o?._$AO)==null||i.call(o,!1),s===void 0?o=void 0:(o=new s(e),o._$AT(e,n,r)),r===void 0?n._$Cl=o:((a=n)._$Co??(a._$Co=[]))[r]=o),o!==void 0&&(t=Lm(e,o._$AS(e,t.values),o,r)),t}var Rm=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:n}=this._$AD,r=(e?.creationScope??_m).importNode(t,!0);Nm.currentNode=r;let i=Nm.nextNode(),a=0,o=0,s=n[0];for(;s!==void 0;){if(a===s.index){let t;s.type===2?t=new zm(i,i.nextSibling,this,e):s.type===1?t=new s.ctor(i,s.name,s.strings,this,e):s.type===6&&(t=new Gm(i,this,e)),this._$AV.push(t),s=n[++o]}a!==s?.index&&(i=Nm.nextNode(),a++)}return Nm.currentNode=_m,r}v(e){let t=0;for(let n of this._$AV)n!==void 0&&(n.strings===void 0?n._$AI(e[t]):(n._$AI(e,n,t),t+=n.strings.length-2)),t++}},zm=class e{constructor(e,t,n,r){var i;this.type=2,this._$AH=jm,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=r,this._$Cp=(i=r?.isConnected)==null||i}get _$AU(){return this._$AM?._$AU??this._$Cp}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Lm(this,e,t),ym(e)?e===jm||e==null||e===``?(this._$AH!==jm&&this._$AR(),this._$AH=jm):e!==this._$AH&&e!==Am&&this._(e):e._$litType$===void 0?e.nodeType===void 0?xm(e)?this.T(e):this._(e):this.$(e):this.g(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==jm&&ym(this._$AH)?this._$AA.nextSibling.data=e:this.$(_m.createTextNode(e)),this._$AH=e}g(e){let{values:t,_$litType$:n}=e,r=typeof n==`number`?this._$AC(e):(n.el===void 0&&(n.el=Im.createElement(Pm(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===r)this._$AH.v(t);else{let e=new Rm(r,this),n=e.u(this.options);e.v(t),this.$(n),this._$AH=e}}_$AC(e){let t=Mm.get(e.strings);return t===void 0&&Mm.set(e.strings,t=new Im(e)),t}T(t){bm(this._$AH)||(this._$AH=[],this._$AR());let n=this._$AH,r,i=0;for(let a of t)i===n.length?n.push(r=new e(this.k(vm()),this.k(vm()),this,this.options)):r=n[i],r._$AI(a),i++;i<n.length&&(this._$AR(r&&r._$AB.nextSibling,i),n.length=i)}_$AR(e=this._$AA.nextSibling,t){var n;for((n=this._$AP)==null||n.call(this,!1,!0,t);e&&e!==this._$AB;){let t=e.nextSibling;e.remove(),e=t}}setConnected(e){var t;this._$AM===void 0&&(this._$Cp=e,(t=this._$AP)==null||t.call(this,e))}},Bm=class{constructor(e,t,n,r,i){this.type=1,this._$AH=jm,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=i,n.length>2||n[0]!==``||n[1]!==``?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=jm}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,n,r){let i=this.strings,a=!1;if(i===void 0)e=Lm(this,e,t,0),a=!ym(e)||e!==this._$AH&&e!==Am,a&&(this._$AH=e);else{let r=e,o,s;for(e=i[0],o=0;o<i.length-1;o++)s=Lm(this,r[n+o],t,o),s===Am&&(s=this._$AH[o]),a||=!ym(s)||s!==this._$AH[o],s===jm?e=jm:e!==jm&&(e+=(s??``)+i[o+1]),this._$AH[o]=s}a&&!r&&this.j(e)}j(e){e===jm?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??``)}},Vm=class extends Bm{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===jm?void 0:e}},Hm=dm?dm.emptyScript:``,Um=class extends Bm{constructor(){super(...arguments),this.type=4}j(e){e&&e!==jm?this.element.setAttribute(this.name,Hm):this.element.removeAttribute(this.name)}},Wm=class extends Bm{constructor(e,t,n,r,i){super(e,t,n,r,i),this.type=5}_$AI(e,t=this){if((e=Lm(this,e,t,0)??jm)===Am)return;let n=this._$AH,r=e===jm&&n!==jm||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,i=e!==jm&&(n===jm||r);r&&this.element.removeEventListener(this.name,this,n),i&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH==`function`?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},Gm=class{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){Lm(this,e)}},Km=um.litHtmlPolyfillSupport;Km?.(Im,zm),(um.litHtmlVersions??=[]).push(`2.8.0`);var qm=(e,t,n)=>{let r=n?.renderBefore??t,i=r._$litPart$;if(i===void 0){let e=n?.renderBefore??null;r._$litPart$=i=new zm(t.insertBefore(vm(),e),e,void 0,n??{})}return i._$AI(e),i},Jm,Ym=class extends Vs{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e;let t=super.createRenderRoot();return(e=this.renderOptions).renderBefore??(e.renderBefore=t.firstChild),t}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=qm(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)==null||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)==null||e.setConnected(!1)}render(){return Am}};Ym.finalized=!0,Ym._$litElement$=!0,(Jm=globalThis.litElementHydrateSupport)==null||Jm.call(globalThis,{LitElement:Ym});var Xm=globalThis.litElementPolyfillSupport;Xm?.({LitElement:Ym}),(globalThis.litElementVersions??(globalThis.litElementVersions=[])).push(`3.3.3`);var Zm=B`var(--white, #fff)`,Qm=B`var(--ia-theme-link-color, #4b64ff)`,$m=B`var(--primaryDisableCTAFill, #767676)`,eh=B`var(--secondaryCTABorder, #999)`,th=B`var(--primaryCTAFill, #194880)`,nh=B`var(--primaryCTAFillRGB, 25, 72, 128)`,rh=B`var(--primaryCTABorder, #c5d1df)`,ih=B`var(--primaryErrorCTAFill, #d9534f)`,ah=B`var(--primaryErrorCTAFillRGB, 229, 28, 38)`,oh=B`var(--primaryErrorCTABorder, #d43f3a)`,sh=B`var(--secondaryCTAFill, #333)`,ch=B`var(--secondaryCTAFillRGB, 51, 51, 51)`,lh=B`var(--primaryCTABorder, #979797)`,uh=B`var(---primaryWarningFill, #ee8950)`,dh=B`var(--primaryWarningFillRGB, 238, 137, 80)`,fh=B`
  .ia-button {
    min-height: 3rem;
    cursor: pointer;
    color: ${Zm};
  ...
  .ia-button.primary:hover {
    background-color: rgba(${nh}, 0.9);
  }
  .ia-button.primary:focus-visible {
    background-color: rgba(${nh}, 0.8);
  }
  .ia-button.primary:active {
    background-color: rgba(${nh}, 0.7);
  }
  ...
  .ia-button.danger:hover {
    background-color: rgba(${ah}, 0.9);
  }
  .ia-button.danger:focus-visible {
    background-color: rgba(${ah}, 0.8);
  }
  .ia-button.danger:active {
    background-color: rgba(${ah}, 0.7);
  }
  ...
  .ia-button.warning:hover {
    background-color: rgba(${dh}, 0.9);
  }
  .ia-button.warning:focus-visible {
    background-color: rgba(${dh}, 0.8);
  }
  .ia-button.warning:active {
    background-color: rgba(${dh}, 0.7);
  }
  ...
  .ia-button.dark:hover {
    background-color: rgba(${ch}, 0.9);
  }
  .ia-button.dark:focus-visible {
    background-color: rgba(${ch}, 0.8);
  }
  .ia-button.dark:active {
    background-color: rgba(${ch}, 0.7);
  }
...
`;function ph(e){return`disabled`in e&&typeof e.disabled==`boolean`}function mh(e){return`numbered`in e&&typeof e.numbered==`boolean`}function hh(e){return`validate`in e&&typeof e.validate==`function`}function gh(e){return`response`in e&&typeof e.response==`object`&&e.response!==null&&`name`in e.response&&typeof e.response.name==`string`}var _h=class extends Error{};async function vh(e,t,n=`Operation timed out`){let r=new Promise((e,r)=>setTimeout(r,t,new _h(n)));return Promise.race([e,r])}var yh,Y=yh=class extends Jp{constructor(){super(...arguments),this.buttonText=`Feedback`,this.showButtonThumbs=!1,this.showQuestionNumbers=!1,this.disabled=!1,this.submitTimeout=8e3,this.isOpen=!1,this.submissionState=`idle`,this.popupTopX=0,this.popupTopY=0,this.resizingElement=document.body,this.handleScroll=()=>{this.isOpen&&this.positionPopup()},this.handleEscape=e=>{e.key===`Escape`&&this.cancel(e)}}render(){return K`<div id="container">${this.feedbackButtonTemplate}</div>`}willUpdate(e){if(e.has(`submissionState`)&&(this.isProcessing||this.isSubmitted?this.disableSlottedChildren():this.restoreSlottedChildrenDisabledStates()),e.has(`resizeObserver`)){let t=e.get(`resizeObserver`);this.disconnectResizeObserver(t)}}updated(e){(e.has(`showQuestionNumbers`)||e.has(`assignedElements`))&&this.applyQuestionNumbers();let t=e.get(`submissionState`);t&&(this.submissionState===`error`||t===`error`)&&this.positionPopup(),e.has(`isOpen`)&&this.isOpen&&this.focusFirstFormElement()}disconnectedCallback(){this.removeEscapeListener(),this.stopScrollObserver(),this.disconnectResizeObserver(this.resizeObserver)}disableSlottedChildren(){this.assignedElements.filter(ph).forEach(e=>{e.dataset.originallyDisabled=e.disabled?`true`:`false`,e.disabled=!0})}restoreSlottedChildrenDisabledStates(){this.assignedElements.filter(ph).forEach(e=>{let{originallyDisabled:t}=e.dataset;if(t===void 0)return;let n=t===`true`;delete e.dataset.originallyDisabled,e.disabled=n})}handleResize(){this.isOpen&&this.positionPopup()}setupEscapeListener(){document.addEventListener(`keyup`,this.handleEscape)}removeEscapeListener(){document.removeEventListener(`keyup`,this.handleEscape)}setupScrollObserver(){document.addEventListener(`scroll`,this.handleScroll)}stopScrollObserver(){document.removeEventListener(`scroll`,this.handleScroll)}setupResizeObserver(){this.resizeObserver&&this.resizeObserver.addObserver({handler:this,target:this.resizingElement})}disconnectResizeObserver(e){(e??this.resizeObserver)?.removeObserver({handler:this,target:this.resizingElement})}getRecaptchaWidget(){if(this.recaptchaWidgetPromise)return this.recaptchaWidgetPromise;if(this.recaptchaManager)return this.recaptchaWidgetPromise=this.recaptchaManager.getRecaptchaWidget(),this.recaptchaWidgetPromise}resetSubmissionState(){this.setSubmissionState(`idle`),this.error=void 0}setSubmissionState(e){this.submissionState!==e&&(this.submissionState=e,this.emitSubmissionStateChanged())}emitSubmissionStateChanged(){this.dispatchEvent(new CustomEvent(`submissionStateChanged`,{detail:this.submissionState}))}get isProcessing(){return this.submissionState===`processing`}get isSubmitted(){return this.submissionState===`submitted`}showPopup(){this.isSubmitted||(this.setupResizeObserver(),this.setupScrollObserver(),this.setupEscapeListener(),this.positionPopup(),this.isOpen=!0,this.getRecaptchaWidget())}closePopup(){this.disconnectResizeObserver(),this.stopScrollObserver(),this.removeEscapeListener(),this.isOpen=!1}positionPopup(){let e=this.container.getBoundingClientRect(),t=this.popup.getBoundingClientRect(),n=window.innerWidth,r=window.innerHeight,i=n/2,a=r/2;e.left<i?this.popupTopX=e.right-20:this.popupTopX=e.left+20-t.width,this.popupTopX+t.width>n&&(this.popupTopX=n-t.width-5),e.top<a?this.popupTopY=e.bottom-10:this.popupTopY=e.top+10-t.height,this.popupTopY+t.height>r&&(this.popupTopY=r-t.height-5),this.popupTopX=Math.max(5,this.popupTopX),this.popupTopY=Math.max(5,this.popupTopY)}get feedbackButtonThumbsTemplate(){return this.showButtonThumbs?K`
    ...
    `:q}get feedbackButtonCheckTemplate(){return K`<span class="beta-button-icon success">&check;</span>`}get feedbackButtonTemplate(){return K`
      ...
      ${this.popupTemplate}
    `}get popupTemplate(){let e=this.isProcessing||this.isSubmitted,t=this.isProcessing?yh.SUBMIT_BUTTON_PROCESSING_TEXT:yh.SUBMIT_BUTTON_NORMAL_TEXT,n=this.error?K`<div id="error">${this.error}</div>`:q,r=rm({left:`${this.popupTopX}px`,top:`${this.popupTopY}px`}),i=e=>e.stopPropagation();return K`
      <div
        id="popup-background"
        class=${this.isOpen?`open`:`closed`}
        @click=${this.backgroundClicked}
      ...
      >
        ...
        <div
          ...
          style=${r}
        >
          <h2 id="survey-heading" class="sr-only">${lm(`Feedback Survey`)}</h2>
          <form
            id="form"
            ?disabled=${e}
            @click=${i}
    ...
    `}focusFirstFormElement(){let e=this.getRootNode();for(let t of this.assignedElements)if(t.focus(),e.activeElement===t)return;this.focusCancelButton()}focusCancelButton(){this.cancelButton.focus()}focusSubmitButton(){this.submitButton.focus()}applyQuestionNumbers(){if(!this.showQuestionNumbers){this.assignedElements.forEach(e=>{var t;(t=e.querySelector(`[slot=question-number]`))==null||t.remove()});return}let e=1;this.assignedElements.filter(e=>mh(e)&&e.numbered).forEach(t=>{let n=t.querySelector(`[slot=question-number]`);n||(n=document.createElement(`span`),n.setAttribute(`slot`,`question-number`)),n.textContent=`${e}. `,t.append(n),e+=1})}backgroundClicked(e){e.target instanceof Node&&(this.popup?.contains(e.target)||this.cancel(e))}cancel(e){e.preventDefault(),this.closePopup(),this.isSubmitted||this.resetSubmissionState()}validate(){return this.assignedElements.filter(hh).map(e=>e.validate()).every(e=>e)}async submit(e){if(e?.preventDefault(),!this.validate()){this.error=K`${yh.ERROR_MESSAGE_MISSING_REQUIRED_INPUT}`,this.setSubmissionState(`error`);return}let{surveyIdentifier:t,submitTimeout:n,featureFeedbackService:r}=this;if(this.error=void 0,!t)throw Error(`surveyIdentifier is required`);if(!r)throw Error(`featureFeedbackService is required`);let i=this.getRecaptchaWidget(),a;try{a=await vh(i,n)}catch(e){throw Error(`recaptchaWidget load failed: ${e}`)}if(!a)throw Error(`recaptchaWidget is required`);let o=this.isOpen;this.setSubmissionState(`processing`);try{let e=await vh(a.execute(),n);(await vh(r.submitSurvey({surveyIdentifier:t,responses:this.assignedElements.filter(gh).map(e=>e.response),recaptchaToken:e}),n)).success?(this.setSubmissionState(`submitted`),o&&this.closePopup()):(this.error=K`${yh.ERROR_MESSAGE_SUBMIT_REQUEST_FAILED}`,this.setSubmissionState(`error`))}catch(e){this.error=K`${yh.ERROR_MESSAGE_SUBMIT_REQUEST_FAILED}
        <br />
        ${lm(`Error: `)}${e instanceof Error?e.message:e}`,this.setSubmissionState(`error`)}}static get styles(){let e=B`var(--featureFeedbackBlueColor, #194880)`,t=B`var(--defaultColorSvgFilter, invert(52%) sepia(0%) saturate(1%) hue-rotate(331deg) brightness(87%) contrast(89%))`,n=B`var(--featureFeedbackBackdropZindex, 5)`,r=B`var(--featureFeedbackModalZindex, 6)`,i=B`var(--featureFeedbackPopupMaxWidth, 300px)`,a=B`var(--featureFeedbackPopupVerticalPadding, 10px)`,o=B`
      ${a} ${B`var(--featureFeedbackPopupHorizontalPadding, 10px)`}
    `,s=B`var(--featureFeedbackPopupBorderColor, ${e})`,c=B`var(--featureFeedbackBetaButtonBorderColor, ${e})`,l=B`var(--featureFeedbackBetaButtonTextColor, ${e})`,u=B`var(--featureFeedbackBetaButtonSvgFilter, ${t})`,d=B`var(--featureFeedbackPopupBlockerColor, rgba(255, 255, 255, 0.3))`,f=B`var(--featureFeedbackPopupBackgroundColor, #FBFBFD)`;return[fh,B`
      #container {
        display: inline-block;
      }
    ...
    `]}};Y.SUBMIT_BUTTON_NORMAL_TEXT=lm(`Submit feedback`),Y.SUBMIT_BUTTON_PROCESSING_TEXT=lm(`Submitting...`),Y.ERROR_MESSAGE_MISSING_REQUIRED_INPUT=lm(`Please respond to the indicated questions.`),Y.ERROR_MESSAGE_SUBMIT_REQUEST_FAILED=lm(`There was an error submitting your feedback.`),t([V({type:String})],Y.prototype,`surveyIdentifier`,void 0),t([V({type:String})],Y.prototype,`buttonText`,void 0),t([V({type:Boolean})],Y.prototype,`showButtonThumbs`,void 0),t([V({type:Boolean})],Y.prototype,`showQuestionNumbers`,void 0),t([V({type:Boolean})],Y.prototype,`disabled`,void 0),t([V({type:Number})],Y.prototype,`submitTimeout`,void 0),t([V({type:Object})],Y.prototype,`featureFeedbackService`,void 0),t([V({type:Object})],Y.prototype,`recaptchaManager`,void 0),t([V({type:Object})],Y.prototype,`resizeObserver`,void 0),t([Fc()],Y.prototype,`isOpen`,void 0),t([Fc()],Y.prototype,`submissionState`,void 0),t([Fc()],Y.prototype,`popupTopX`,void 0),t([Fc()],Y.prototype,`popupTopY`,void 0),t([Fc()],Y.prototype,`error`,void 0),t([Lc(`#container`)],Y.prototype,`container`,void 0),t([Lc(`#popup`)],Y.prototype,`popup`,void 0),t([Lc(`#cancel-button`)],Y.prototype,`cancelButton`,void 0),t([Lc(`#submit-button`)],Y.prototype,`submitButton`,void 0),t([zc()],Y.prototype,`assignedElements`,void 0),Y=yh=t([Mc(`ia-feedback-survey`)],Y);var bh,xh=bh=class extends Jp{constructor(){super(),this.prompt=``,this.value=``,this.required=!1,this.disabled=!1,this.skipNumber=!1,this.visible=!0,this.internals=this.attachInternals()}render(){return K`
      <div id="container">
        ${this.promptTextTemplate}${this.commentBoxTemplate}
      </div>
    `}willUpdate(e){e.has(`required`)&&(this.internals.ariaRequired=this.required.toString()),e.has(`disabled`)&&(this.internals.ariaDisabled=this.disabled.toString())}validate(){return!this.required||this.commentBox.value?this.internals.setValidity({}):this.internals.setValidity({valueMissing:!0},`A comment is required.`),this.internals.reportValidity()}get numbered(){return!this.skipNumber}get response(){return{name:this.prompt,comment:this.value}}get promptTextTemplate(){return this.prompt?K`<div id="prompt-text">${this.numbered?K`<slot name="question-number"></slot>`:q}${this.prompt}</div>`:q}get commentBoxTemplate(){let e=this.required?bh.DEFAULT_PLACEHOLDER_REQUIRED:bh.DEFAULT_PLACEHOLDER_OPTIONAL;return K`
      <textarea
        id="comments"
        tabindex="0"
    ...
    `}};xh.DEFAULT_PLACEHOLDER_REQUIRED=lm(`Comments`),xh.DEFAULT_PLACEHOLDER_OPTIONAL=lm(`Comments (optional)`),xh.formAssociated=!0,xh.shadowRootOptions={...Jp.shadowRootOptions,delegatesFocus:!0},t([V({type:String})],xh.prototype,`prompt`,void 0),t([V({type:String})],xh.prototype,`value`,void 0),t([V({type:Boolean,reflect:!0})],xh.prototype,`required`,void 0),t([V({type:Boolean,reflect:!0})],xh.prototype,`disabled`,void 0),t([V({type:Boolean,reflect:!0})],xh.prototype,`skipNumber`,void 0),t([V({type:String})],xh.prototype,`placeholder`,void 0),t([Lc(`#comments`)],xh.prototype,`commentBox`,void 0),xh=bh=t([Mc(`ia-survey-comment`)],xh);var Sh=$p(class extends em{constructor(e){if(super(e),e.type!==Qp.ATTRIBUTE||e.name!==`class`||e.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return` `+Object.keys(e).filter((t=>e[t])).join(` `)+` `}update(e,[t]){var n;if(this.it===void 0){this.it=new Set,e.strings!==void 0&&(this.nt=new Set(e.strings.join(` `).split(/\s/).filter((e=>e!==``))));for(let e in t)t[e]&&!this.nt?.has(e)&&this.it.add(e);return this.render(t)}let r=e.element.classList;this.it.forEach((e=>{e in t||(r.remove(e),this.it.delete(e))}));for(let e in t){let i=!!t[e];i===this.it.has(e)||(n=this.nt)!=null&&n.has(e)||(i?(r.add(e),this.it.add(e)):(r.remove(e),this.it.delete(e)))}return Ap}}),Ch,wh=Ch=class extends Jp{constructor(){super(),this.prompt=``,this.vote=void 0,this.required=!1,this.disabled=!1,this.skipNumber=!1,this.showComments=!1,this.visible=!0,this.internals=this.attachInternals()}render(){return K`
      <div id="container">
        <div
          id="prompt-row"
          role="radiogroup"
    ...
    `}willUpdate(e){e.has(`required`)&&(this.internals.ariaRequired=this.required.toString()),e.has(`disabled`)&&(this.internals.ariaDisabled=this.disabled.toString())}validate(){return!this.required||this.vote?this.internals.setValidity({}):this.internals.setValidity({valueMissing:!0},`A vote is required.`),this.internals.checkValidity()}get numbered(){return!this.skipNumber}get response(){return{...this.commentBox?.response,name:this.prompt,rating:this.vote}}get promptTextTemplate(){return this.prompt?K`<div id="prompt-text">${this.numbered?K`<slot name="question-number"></slot>`:q}${this.prompt}</div>`:q}get voteButtonsTemplate(){let e=this.vote===`up`,t=this.vote===`down`,n={"vote-button":!0,noselection:this.vote===void 0},r=Sh({...n,selected:e,unselected:t}),i=Sh({...n,selected:t,unselected:e});return K`
      ...
      >
        ...
        />
        ${Xp}
        <span class="sr-only">${Ch.UPVOTE_SR_LABEL}</span>
      </label>
      ...
      >
        ...
        />
        ${Zp}
        <span class="sr-only">${Ch.DOWNVOTE_SR_LABEL}</span>
      </label>
    ...
    `}};wh.UPVOTE_SR_LABEL=lm(`Vote up`),wh.DOWNVOTE_SR_LABEL=lm(`Vote down`),wh.formAssociated=!0,wh.shadowRootOptions={...Jp.shadowRootOptions,delegatesFocus:!0},t([V({type:String})],wh.prototype,`prompt`,void 0),t([V({type:String})],wh.prototype,`vote`,void 0),t([V({type:String})],wh.prototype,`comment`,void 0),t([V({type:String})],wh.prototype,`commentPlaceholder`,void 0),t([V({type:Boolean,reflect:!0})],wh.prototype,`required`,void 0),t([V({type:Boolean,reflect:!0})],wh.prototype,`disabled`,void 0),t([V({type:Boolean,reflect:!0})],wh.prototype,`skipNumber`,void 0),t([V({type:Boolean,reflect:!0})],wh.prototype,`showComments`,void 0),t([Lc(`#comments`)],wh.prototype,`commentBox`,void 0),wh=Ch=t([Mc(`ia-survey-vote`)],wh);var Th=class extends Jp{constructor(){super(...arguments),this.name=``,this.visible=!1,this.disabled=!1}createRenderRoot(){return this}render(){return q}validate(){return!0}get numbered(){return!1}get response(){return{name:this.name,comment:this.value}}};t([V({type:String,reflect:!0})],Th.prototype,`name`,void 0),t([V({type:String,reflect:!0})],Th.prototype,`value`,void 0),Th=t([Mc(`ia-survey-extra`)],Th);var Eh=T`
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path
...
`,Dh=class extends O{constructor(...e){super(...e),this.binSnapping=`none`,this.barScaling=`logarithmic`,this.boundEscapeListener=e=>{e.key===`Escape`&&this.closeModal()}}render(){return T`
      <div id="container">
    ...
    `}};L([A({type:String})],Dh.prototype,`minDate`,void 0),L([A({type:String})],Dh.prototype,`maxDate`,void 0),L([A({type:String})],Dh.prototype,`minSelectedDate`,void 0),L([A({type:String})],Dh.prototype,`maxSelectedDate`,void 0),L([A({type:Array})],Dh.prototype,`buckets`,void 0),L([A({type:String})],Dh.prototype,`customDateFormat`,void 0),L([A({type:String})],Dh.prototype,`customTooltipDateFormat`,void 0),L([A({type:String})],Dh.prototype,`customTooltipLabel`,void 0),L([A({type:String})],Dh.prototype,`binSnapping`,void 0),L([A({type:String})],Dh.prototype,`barScaling`,void 0),L([A({type:Object,attribute:!1})],Dh.prototype,`modalManager`,void 0),L([A({type:Object,attribute:!1})],Dh.prototype,`analyticsHandler`,void 0),Dh=L([k(`expanded-date-picker`)],Dh);var Oh=class extends O{constructor(){super(...arguments),this.loadingTitle=N(`Loading...`),this.successTitle=N(`Success`),this.errorTitle=N(`Error`),this.loadingStyle=`ring-dots`,this.mode=`loading`}render(){return T`${Gi(this.mode,[[`loading`,()=>this.loadingIndicatorTemplate],[`success`,()=>this.successIndicatorTemplate],[`error`,()=>this.errorIndicatorTemplate]])}`}get loadingIndicatorTemplate(){return T`
      <svg
    ...
    `}get shouldShowLoadingDots(){return this.loadingStyle!==`ring`}static get styles(){return[Ii,w`
      ...
      `]}};t([A({type:String})],Oh.prototype,`loadingTitle`,void 0),t([A({type:String})],Oh.prototype,`successTitle`,void 0),t([A({type:String})],Oh.prototype,`errorTitle`,void 0),t([A({type:String})],Oh.prototype,`loadingStyle`,void 0),t([A({type:String})],Oh.prototype,`mode`,void 0),Oh=t([k(`ia-status-indicator`)],Oh);var kh=E`
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path 
      d="m20.1116715 50.0035012-.1116715-.1085359 43.1159942-46.61088155c2.401537-2.18938917 4.6902018-3.28408375 6.8659943-3.28408375s4.1642651.63837733 5.9654178 1.91513199c1.8011528 1.27675467 3.1520173 2.97248092 4.0525937 5.08717877l-39.4020173 42.99768924 39.4020173 42.9976892c-.9005764 2.1146979-2.2514409 3.8104241-4.0525937 5.0871788-1.8011527 1.2767547-3.7896253 1.915132-5.9654178 1.915132-2.1013449 0-4.3900096-1.0573489-6.8659943-3.1720468l-43.1159942-46.7194174z"
    />
...
`,jh=class extends O{constructor(...e){super(...e),this.step=2,this.currentPage=1,this.pages=[]}firstUpdated(){this.observePageCount()}updated(e){e.has(`size`)&&this.observePageCount(),e.has(`currentPage`)&&(this.observePageCount(),this.emitPageClick())}observePageCount(){this.pages=[];let e=this.size<=7;if(this.size<=5){this.pages=[...Array(this.size).keys()].map(e=>e+1);return}if(this.size===7){if(this.currentPage===2){this.pages=[1,2,3,4,0,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,4,5,this.size-1,this.size];return}}if(this.currentPage===1){this.pages=[1,2,3,0,this.size];return}if(this.currentPage===this.size){this.pages=[1,0,this.size-2,this.size-1,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,this.size-3,this.size-2,this.size-1,this.size];return}if(e&&this.currentPage>1&&this.currentPage<7){this.pages=[...Array(this.size).keys()].map(e=>e+1);return}let t=this.currentPage-this.step,n=this.currentPage+this.step;t<=0&&(n+=-t+1,t=1),n>=this.size&&(t=Math.max(t-(n-this.size),1),n=this.size),t===2&&--n,n===this.size-1&&(t+=1),this.createFirstNode(t),this.createMiddelNode(t,n),this.createLastNode(n)}createFirstNode(e){e>1&&this.pages?.push(1),e>2&&this.pages?.push(0)}createMiddelNode(e,t){for(let n=e;n<=t;n+=1)this.pages?.push(n)}createLastNode(e){e<this.size-1&&this.pages?.push(0),e<this.size&&this.pages?.push(this.size)}get getEllipsisTemplate(){return T`<i class="ellipses">...</i>`}emitPageClick(){this.dispatchEvent(new CustomEvent(`pageNumberClicked`,{detail:{page:this.currentPage},bubbles:!0,composed:!0}))}onRewind(){--this.currentPage,this.currentPage<1&&(this.currentPage=1)}onForward(){this.currentPage+=1,this.currentPage>this.size&&(this.currentPage=this.size)}onChange(e){this.currentPage=e}getPageTemplate(e){return T`
    ...
    `}static get styles(){return[Ai,w`
      ...
      `]}};L([A({type:Number})],jh.prototype,`size`,void 0),L([A({type:Number})],jh.prototype,`step`,void 0),L([A({type:Number})],jh.prototype,`currentPage`,void 0),L([j()],jh.prototype,`pages`,void 0),jh=L([k(`more-facets-pagination`)],jh);var Mh=(e,t,n)=>{let r=new Map;for(let i=t;i<=n;i++)r.set(e[i],i);return r},Nh=ar(class extends or{constructor(e){if(super(e),e.type!==ir.CHILD)throw Error(`repeat() can only be used in text expressions`)}dt(e,t,n){let r;n===void 0?n=t:t!==void 0&&(r=t);let i=[],a=[],o=0;for(let t of e)i[o]=r?r(t,o):o,a[o]=n(t,o),o++;return{values:a,keys:i}}render(e,t,n){return this.dt(e,t,n).values}update(e,[t,n,r]){let i=xr(e),{values:a,keys:o}=this.dt(t,n,r);if(!Array.isArray(i))return this.ut=o,a;let s=this.ut??=[],c=[],l,u,d=0,f=i.length-1,p=0,m=a.length-1;for(;d<=f&&p<=m;)if(i[d]===null)d++;else if(i[f]===null)f--;else if(s[d]===o[p])c[p]=vr(i[d],a[p]),d++,p++;else if(s[f]===o[m])c[m]=vr(i[f],a[m]),f--,m--;else if(s[d]===o[m])c[m]=vr(i[d],a[m]),_r(e,c[m+1],i[d]),d++,m--;else if(s[f]===o[p])c[p]=vr(i[f],a[p]),_r(e,i[d],i[f]),f--,p++;else if(l===void 0&&(l=Mh(o,p,m),u=Mh(s,d,f)),l.has(s[d]))if(l.has(s[f])){let t=u.get(o[p]),n=t===void 0?null:i[t];if(n===null){let t=_r(e,i[d]);vr(t,a[p]),c[p]=t}else c[p]=vr(n,a[p]),_r(e,i[d],n),i[t]=null;p++}else Sr(i[f]),f--;else Sr(i[d]),d++;for(;p<=m;){let t=_r(e,c[m+1]);vr(t,a[p]),c[p++]=t}for(;d<=f;){let e=i[d++];e!==null&&Sr(e)}return this.ut=o,br(e,c),Et}}),Ph=E`
...
`,Ih,Lh=Ih=class extends O{render(){return T`${this.facetRowTemplate}`}get facetRowTemplate(){let{bucket:e,facetType:t}=this;if(!e||!t)return D;let n=`${t}:${e.key}-show-only`,r=`${t}:${e.key}-negative`,i=e.extraNote?T`<span class="facet-note">${e.extraNote}</span>`:D,a=t===`collection`?T`<a href="/details/${e.key}">
        ...
        <div class="facet-checkboxes">
          ...
          >
            ...
            >
              ...
              <span class="eye eye-open">${Ph}</span>
              <span class="eye eye-closed">${Fh}</span>
            </label>
          </div>
        </div>
        <label
    ...
    `}};L([A({type:Object})],Rh.prototype,`facetGroup`,void 0),L([A({type:Object})],Rh.prototype,`collectionTitles`,void 0),Rh=L([k(`facets-template`)],Rh);var zh=class extends O{constructor(...e){super(...e),this.leftValue=``,this.rightValue=``,this.side=`left`}render(){return T`
      <div id="container">
    ...
    `}partOfCollectionClicked(e){this.analyticsHandler?.sendEvent({category:Oi.default,action:F.partOfCollectionClicked,label:e.target.dataset.id})}get histogramProps(){let{histogramAggregation:e}=this;if(!e)return;let t=e.first_bucket_year??e.first_bucket_key,n=e.last_bucket_year??e.last_bucket_key;if(t==null||n==null)return;let r=e.first_bucket_month??1,i=e.last_bucket_month??12,a=e.interval??1,o=e.interval_in_months??12,s=e=>e.toString().padStart(2,`0`);if(this.isTvSearch){let a=o<12;return{buckets:e.buckets,dateFormat:`YYYY-MM`,tooltipDateFormat:a?`MMM YYYY`:`YYYY`,tooltipLabel:`broadcast`,binSnapping:a?`month`:`year`,barScaling:`linear`,minDate:`${t}-${s(r)}`,maxDate:`${n}-${s(i+o-1)}`}}return{buckets:e.buckets,dateFormat:`YYYY`,tooltipDateFormat:`YYYY`,tooltipLabel:`item`,binSnapping:`year`,barScaling:`logarithmic`,minDate:`${t}`,maxDate:`${n+a-1}`}}showDatePickerModal(){let{histogramProps:e}=this;if(!e)return;let{buckets:t,dateFormat:n,tooltipDateFormat:r,tooltipLabel:i,binSnapping:a,barScaling:o,minDate:s,maxDate:c}=e,l=T`
      <expanded-date-picker
        ${ku(e=>{if(e&&e instanceof Dh){let t=e;t.minSelectedDate=this.minSelectedDate,t.maxSelectedDate=this.maxSelectedDate}})}
        .minDate=${s}
        .maxDate=${c}
    ...
    `}};Hh=L([k(`circular-activity-indicator`)],Hh);function Uh(e,t){return e===void 0?t!==void 0:t===void 0?e!==void 0:e.facetType===t.facetType&&e.bucketKey===t.bucketKey}function Wh(e,t){return e.label===t.label&&e.facets.length===t.facets.length&&e.facets.every((e,n)=>Uh(e,t.facets[n]))}function Gh(e){if(!Array.isArray(e[0])){let t=[...e];for(let e=0;e<t.length;e++){let n=t[e];t=t.filter(e=>n===e||!Wh(n,e))}return t}let t=e,n=[];for(let e of t){let t=[];for(let r of e)n.find(e=>e.find(e=>Wh(r,e)))||t.push(r);t.length>0&&n.push(t)}return n}var Kh=class e{async getRecommendedFacets(){let t=navigator.language,n=e.getLanguageDisplayName(t);return n?[{facets:[{facetType:`language`,bucketKey:n}]}]:[]}static getLanguageDisplayName(e){let t=e.split(`-`)[0];return new Intl.DisplayNames([`en`],{type:`language`}).of(t)}},qh={facets:[{facetType:`mediatype`,bucketKey:`texts`}]},Jh={facets:[{facetType:`mediatype`,bucketKey:`audio`}]},Yh={facets:[{facetType:`mediatype`,bucketKey:`movies`}]},Xh={facets:[{facetType:`mediatype`,bucketKey:`image`}]},Zh={facets:[{facetType:`mediatype`,bucketKey:`software`}]},Qh={facets:[{facetType:`mediatype`,bucketKey:`etree`}]},$h={text:[qh],book:[qh],novel:[qh],magazine:[qh],newspaper:[qh],pdf:[qh],epub:[qh],audio:[Jh],song:[Jh],music:[Jh],listen:[Jh],podcast:[Jh],radio:[Jh],stream:[Jh,Yh],video:[Yh],movie:[Yh],film:[Yh],animation:[Yh],youtube:[Yh],image:[Xh],photo:[Xh],picture:[Xh],painting:[Xh],jpg:[Xh],jpeg:[Xh],png:[Xh],gif:[Xh],software:[Zh],app:[Zh],program:[Zh],game:[Zh],arcade:[Zh],etree:[Qh],concert:[Qh],"live music":[Qh],"web crawl":[{facets:[{facetType:`mediatype`,bucketKey:`web`}]}],dataset:[{facets:[{facetType:`mediatype`,bucketKey:`data`}]}]},eg=class{async getRecommendedFacets(e){let t=[];for(let[n,r]of Object.entries($h))e.includes(n)&&t.push(...r);return t}},tg=[{facets:[{facetType:`mediatype`,bucketKey:`texts`}]}],ng=[{label:`Films by __QUERY`,facets:[{facetType:`mediatype`,bucketKey:`movies`},{facetType:`creator`,bucketKey:`__QUERY`}]}],rg=[{label:`Writing by __QUERY`,facets:[{facetType:`mediatype`,bucketKey:`texts`},{facetType:`creator`,bucketKey:`__QUERY`}]}],ig=[{label:`Images by __QUERY`,facets:[{facetType:`mediatype`,bucketKey:`image`},{facetType:`creator`,bucketKey:`__QUERY`}]}],ag=[{label:`Music by __QUERY`,facets:[{facetType:`mediatype`,bucketKey:`audio`},{facetType:`creator`,bucketKey:`__QUERY`}]}],og={"written work":tg,literature:tg,book:tg,novel:tg,filmmaker:ng,director:ng,author:rg,writer:rg,novelist:rg,essayist:rg,poet:rg,"visual artist":ig,"graphic artist":ig,photographer:ig,painter:ig,singer:ag,songwriter:ag,musician:ag,composer:ag,pianist:ag},sg=class{constructor(){this.WIKIDATA_BASE_URL=`https://www.wikidata.org/w/api.php`,this.WIKIDATA_DEFAULT_ARGS=`?action=wbsearchentities&format=json&language=en&uselang=en&origin=*&type=item&limit=5`}getWikidataURL(e){let t=encodeURIComponent(e);return`${this.WIKIDATA_BASE_URL}${this.WIKIDATA_DEFAULT_ARGS}&search=${t}`}replaceQueryPlaceholders(e,t){return e.map(e=>({label:e.label?.replace(`__QUERY`,t),facets:e.facets.map(e=>{let n={...e,bucketKey:e.bucketKey.replace(`__QUERY`,t.toLowerCase())};return e.displayText&&(n.displayText=n.displayText?.replace(`__QUERY`,t)),n})}))}async getRecommendedFacets(e){let t=[];try{let n=this.getWikidataURL(e),r=await(await fetch(n)).json();for(let[e,n]of Object.entries(og))if(RegExp(`\\b${e}\\b`).test(r.search[0]?.description)){let e=r.search[0].label;t.push(...this.replaceQueryPlaceholders(n,e))}return t}catch(e){return console.warn(e),[]}}},cg=class e{static{this.DEFAULT_HEURISTICS=[eg,sg,Kh]}async getRecommendedFacets(t,n=e.DEFAULT_HEURISTICS){let r=n.map(e=>new e().getRecommendedFacets(t));return Gh((await Promise.all(r)).flat())}},lg=window.location&&(window.location.hostname===`localhost`||window.location.host.match(/^(www|cat)-[a-z0-9]+\.archive\.org$/)||window.location.host.match(/\.code\.archive\.org$/)||window.location.host.match(/\.dev\.archive\.org$/)||window.location.host.match(/^ia-petabox-/)||window.location.host.match(/^local\.archive\.org/)||window.location.host.match(/^internetarchive\.github\.io$/))?console.log.bind(console):()=>{},ug=T`
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path
...
`;function fg(e){return e&&e.charAt(0).toLocaleUpperCase()+e.slice(1)}var pg=class extends O{constructor(...e){super(...e),this.selected=!1}render(){if(!this.facetInfo)return D;let e=this.facetInfo.facets.length===1,t=this.facetInfo.facets[0],n=fg((this.labelPrefix?`${this.labelPrefix} `:``)+(this.facetInfo.label??t.displayText??t.bucketKey));if(!n)return D;let r=e&&t.facetType===`mediatype`?Ma[t.bucketKey].icon:D;return T`
      <a
      ...
      >
        ${r} ${n}
        ${this.selected?T`<span class="unselect-button">${dg}</span>`:D}
      </a>
    ...
    `}};L([A({type:Object})],pg.prototype,`facetInfo`,void 0),L([A({type:String})],pg.prototype,`labelPrefix`,void 0),L([A({type:Boolean})],pg.prototype,`selected`,void 0),pg=L([k(`smart-facet-button`)],pg);var mg=class extends O{render(){if(!this.facetInfo||!this.activeFacetRef||this.facetInfo.length===0)return D;let e=this.activeFacetRef.displayText??this.activeFacetRef.bucketKey;return e?T`
    ...
    `}};L([A({type:Array})],mg.prototype,`facetInfo`,void 0),L([A({type:String})],mg.prototype,`labelPrefix`,void 0),L([A({type:Object})],mg.prototype,`activeFacetRef`,void 0),L([M(`ia-dropdown`)],mg.prototype,`dropdown`,void 0),mg=L([k(`smart-facet-dropdown`)],mg);var hg={collection:`Collection: `,creator:`By: `,subject:`About: `};function gg(e){return e.charAt(0).toUpperCase()+e.slice(1)}var _g=class extends O{constructor(...e){super(...e),this.filterToggleShown=!1,this.filterToggleActive=!1,this.heuristicRecs=[],this.smartFacets=[]}render(){if(!this.query)return D;let e=!!this.label&&this.smartFacets.length>0;return T`
      <div id="smart-facets-container">
        ${this.filtersToggleTemplate}
        ${e?T`<p id="filters-label">${this.label}</p>`:D}
        ${Nh(this.smartFacets,e=>`${e[0].label}|${e[0].facets[0].facetType}|${e[0].facets[0].bucketKey}`,e=>this.makeSmartFacet(e))}
      </div>
    `}willUpdate(e){let t=!1;e.has(`query`)&&(lg(`query change`,e.get(`query`),this.query),this.lastAggregations=void 0,t=!0),e.has(`aggregations`)&&!this.lastAggregations&&this.aggregations&&Object.keys(this.aggregations).length>0&&(lg(`aggs change`,e.get(`aggregations`),this.aggregations),this.lastAggregations=this.aggregations,t=!0),t&&(lg(`should update smart facets, doing so...`),this.updateSmartFacets())}refresh(){this.lastAggregations=this.aggregations,this.updateSmartFacets()}deselectAll(){for(let e of this.smartFacets)for(let t of e)t.selected=!1;this.requestUpdate()}async updateSmartFacets(){lg(`updating smart facets`),this.query&&(this.heuristicRecs=await new cg().getRecommendedFacets(this.query),lg(`heuristic recs are`,this.heuristicRecs),this.smartFacets=Gh(this.facetsToDisplay),lg(`smart facets are`,this.smartFacets))}makeSmartFacet(e){return e.length===0?D:e.length===1?this.smartFacetButton(e[0]):this.smartFacetDropdown(e)}smartFacetButton(e){return T`
      <smart-facet-button
        .facetInfo=${e}
        .labelPrefix=${hg[e.facets[0].facetType]}
    ...
    `}smartFacetDropdown(e){return T`
      <smart-facet-dropdown
        .facetInfo=${e}
        .labelPrefix=${hg[e[0].facets[0].facetType]}
