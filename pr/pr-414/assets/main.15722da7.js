 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*At(a,e){if(a!==void 0){let t=0;for(const i of a)yield e(i,t++)}}function Dl(a){return new Date(a.getTime()-a.getTimezoneOffset()*1e3*60)}function Oa(a){return a?Dl(a).toISOString().endsWith("-01-01T00:00:00.000Z"):!1}const qs=c`
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*Bi(a,e){const t=typeof e=="function";if(a!==void 0){let i=-1;for(const o of a)i>-1&&(yield t?e(i):e),i++,yield o}}let Ki=class extends R{constructor(){super(...arguments),this.snippets=[],this.viewSize="desktop"}render(){var e;return!((e=this.snippets)===null||e===void 0)&&e.length?c`
      <div class="container">
        <div class="snippet-view ${this.viewSize}">
    ...
    `}};n([h({type:Array})],Ki.prototype,"snippets",void 0);n([h({type:String})],Ki.prototype,"viewSize",void 0);Ki=n([L("text-snippet-block")],Ki);const Fl=v`
  .drop-shadow {
    overflow: hidden;
    height: 100%;
  }
...
`,Gs={account:{color:"#000000",icon:Ol,text:"Account"},audio:{color:"#00adef",icon:Il,text:"Audio"},collection:{color:"#4666ff",icon:Qs,text:"Collection"},data:{color:"#333333",icon:Ul,text:"Data"},etree:{color:"#00adef",icon:Nl,text:"E-tree"},film:{color:"#bf1b2c",icon:Rr,text:"Film"},image:{color:"#aa99c9",icon:Hl,text:"Image"},movies:{color:"#f1644b",icon:Rr,text:"Movie"},radio:{color:"#8fdaef",icon:Vl,text:"Radio"},software:{color:"#9ecc4f",icon:Wl,text:"Software"},texts:{color:"#faab3c",icon:jl,text:"Text"},tv:{color:"#f1644b",icon:Ql,text:"TV"},video:{color:"#f1644b",icon:ql,text:"Video"},web:{color:"#ffcd27",icon:Kl,text:"Web"},search:{color:"#000000",icon:Ks,text:"Search"}};let vi=class extends R{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var e,t;const i=["tvnews","tvarchive","television"],o=["radio","radioprogram"];return this.mediatype==="movies"&&((e=this.collections)===null||e===void 0?void 0:e.some(r=>i.indexOf(r)>=0))?"tv":this.mediatype==="audio"&&((t=this.collections)===null||t===void 0?void 0:t.some(r=>o.indexOf(r)>=0))?"radio":this.mediatype||""}render(){const e=Gs[this.displayMediatype];return e?c`
      <div
        id="icon"
...
fill=""></path>
    ...
    `}static get styles(){const e=Ke`var(--dropdownBorderWidth, 1px)`,t=Ke`var(--dropdownBorderRadius, 4px)`,i=Ke`var(--dropdownBorderColor, #fff)`,o=Ke`var(--dropdownBgColor, #333)`,r=Ke`var(--dropdownTextColor, #fff)`,s=Ke`var(--dropdownHoverBgColor, rgba(255, 255, 255, 0.3))`,l=Ke`var(--dropdownSelectedBgColor, #fff)`;return Ke`
      :host {
        display: inline;
        color: ${r};
      }
...
`;let yt=class extends R{constructor(){super(...arguments),this.label=E("Select items to remove"),this.showSelectAll=!1,this.showUnselectAll=!1,this.removeAllowed=!1}render(){return c`
    ...
    `}cancelClicked(){this.dispatchEvent(new CustomEvent("cancel"))}removeClicked(){this.dispatchEvent(new CustomEvent("removeItems"))}itemsManagerClicked(){this.dispatchEvent(new CustomEvent("itemsManager"))}selectAllClicked(){this.dispatchEvent(new CustomEvent("selectAll"))}unselectAllClicked(){this.dispatchEvent(new CustomEvent("unselectAll"))}static get styles(){return v`
      ${rc}
      .manage-container {
        display: flex;
        align-items: center;
...
`,ka;let yi=ka=class extends R{render(){return c`${this.facetRowTemplate}`}get facetRowTemplate(){var e,t,i,o;const{bucket:r,facetType:s}=this;if(!r||!s)return b;const l=`${s}:${r.key}-show-only`,d=`${s}:${r.key}-negative`,p=s!=="collection"?c`${(e=r.displayText)!==null&&e!==void 0?e:r.key}`:c`<a href="/details/${r.key}">
    ...
    `}get loaderTemplate(){return c`<div class="facets-loader">
      <ia-activity-indicator .mode=${"processing"}></ia-activity-indicator>
        ...
        </div> `:b}sortFacetAggregation(e){this.sortedBy=e,this.dispatchEvent(new CustomEvent("sortedFacets",{detail:this.sortedBy}))}get modalHeaderTemplate(){var e,t,i;const r=((e=this.sortedBy)!==null&&e!==void 0?e:Qi[this.facetKey])===K.COUNT?"left":"right";return c`<span class="sr-only">${E("More facets for:")}</span>
      <span class="title">
    ...
    `}scrollThresholdReached(){!this.dataSource.endOfDataReached&&this.dataSource.queryInitialized&&(this.pagesToRender+=1,this.dataSource.fetchPage(this.pagesToRender))}static get styles(){return[Je,v`
      ...
      <div id="collection-browser-container">
        <collection-browser
          ...
          @itemsManagerRequested=${i=>console.log(i.detail.items)}
        >
