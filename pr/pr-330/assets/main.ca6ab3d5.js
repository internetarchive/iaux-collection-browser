...
`;var Fo;(function(r){r[r.bytes=0]="bytes",r[r.kilobytes=1]="kilobytes",r[r.megabytes=2]="megabytes",r[r.gigabytes=3]="gigabytes",r[r.terabytes=4]="terabytes",r[r.petabytes=5]="petabytes",r[r.exabytes=6]="exabytes",r[r.zettabytes=7]="zettabytes",r[r.yottabytes=8]="yottabytes"})(Fo||(Fo={}));function kl(r,e,t=" "){let i=r;if(i===void 0)return y;let o=0;for(;i>1024;)i/=1024,o+=1;const a=10**e;i=Math.round(i*a)/a;let s=Fo[o];return s=i===1?s.slice(0,-1):s,`${i.toLocaleString()+t+s}`}const Ze=g`
  .sr-only {
...
`;let Le=class extends O{constructor(){super(...arguments),this.isListTile=!1,this.isCompactTile=!1,this.loggedIn=!1,this.isWaveform=!1,this.isNotFound=!1}render(){return c`
    ...
    `}get imageSrc(){var e,t;if(this.isNotFound)return this.notFoundSrc;if(((e=this.model)===null||e===void 0?void 0:e.captureDates)&&this.model.identifier)try{const i=new URL(this.model.identifier),o=encodeURIComponent(i.hostname);return this.baseImageUrl?`https://web.archive.org/thumb/${o}?generate=1`:y}catch{return`${this.baseImageUrl}/images/notfound.png`}return this.baseImageUrl&&((t=this.model)===null||t===void 0?void 0:t.identifier)?`${this.baseImageUrl}/services/img/${this.model.identifier}`:y}get notFoundSrc(){return this.baseImageUrl?`${this.baseImageUrl}/images/notfound.png`:y}get hashBasedGradient(){var e;return!((e=this.model)===null||e===void 0)&&e.identifier?`waveform-grad${this.hashStrToInt(this.model.identifier)%6}`:"waveform-grad0"}hashStrToInt(e){return e.split("").reduce((t,i)=>t+i.charCodeAt(0),0)}get itemBaseClass(){var e;return{"drop-shadow":!0,"list-box":this.isListTile,"search-image":((e=this.model)===null||e===void 0?void 0:e.mediatype)==="search",[this.hashBasedGradient]:this.isWaveform}}get itemImageClass(){var e,t,i;const o=((e=this.model)===null||e===void 0?void 0:e.contentWarning)||((t=this.model)===null||t===void 0?void 0:t.loginRequired);return{contain:!this.isCompactTile&&!this.isWaveform,cover:this.isCompactTile,blur:o||!1,waveform:this.isWaveform,"account-image":this.isAccountImage,"collection-image":((i=this.model)===null||i===void 0?void 0:i.mediatype)==="collection"}}get isAccountImage(){var e;return((e=this.model)===null||e===void 0?void 0:e.mediatype)==="account"&&!this.isCompactTile&&!this.isListTile}onLoad(){var e,t;(((e=this.model)===null||e===void 0?void 0:e.mediatype)==="audio"||((t=this.model)===null||t===void 0?void 0:t.mediatype)==="etree")&&this.baseImage.naturalWidth/this.baseImage.naturalHeight===4&&(this.isWaveform=!0)}onError(){this.isNotFound=!0}static get styles(){return[zl,Pl,g`
      ...
      `]}};l([p({type:Object})],Le.prototype,"model",void 0);l([p({type:String})],Le.prototype,"baseImageUrl",void 0);l([p({type:Boolean})],Le.prototype,"isListTile",void 0);l([p({type:Boolean})],Le.prototype,"isCompactTile",void 0);l([p({type:Boolean})],Le.prototype,"loggedIn",void 0);l([z()],Le.prototype,"isWaveform",void 0);l([z()],Le.prototype,"isNotFound",void 0);l([Y("img")],Le.prototype,"baseImage",void 0);Le=l([D("item-image")],Le);const Al=F`
...
`,Vl={account:{color:"#000000",icon:Al,text:"Account"},audio:{color:"#00adef",icon:Ll,text:"Audio"},collection:{color:"#4666ff",icon:ds,text:"Collection"},data:{color:"#333333",icon:Dl,text:"Data"},etree:{color:"#00adef",icon:Bl,text:"E-tree"},film:{color:"#bf1b2c",icon:aa,text:"Film"},image:{color:"#aa99c9",icon:Ol,text:"Image"},movies:{color:"#f1644b",icon:aa,text:"Movie"},radio:{color:"#8fdaef",icon:Rl,text:"Radio"},software:{color:"#9ecc4f",icon:Fl,text:"Software"},texts:{color:"#faab3c",icon:Il,text:"Text"},tv:{color:"#f1644b",icon:Ul,text:"TV"},video:{color:"#f1644b",icon:Nl,text:"Video"},web:{color:"#ffcd27",icon:Hl,text:"Web"},search:{color:"#000000",icon:ps,text:"Search"}};let ni=class extends O{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var e,t;const i=["tvnews","tvarchive","television"],o=["radio","radioprogram"];return this.mediatype==="movies"&&((e=this.collections)===null||e===void 0?void 0:e.some(a=>i.indexOf(a)>=0))?"tv":this.mediatype==="audio"&&((t=this.collections)===null||t===void 0?void 0:t.some(a=>o.indexOf(a)>=0))?"radio":this.mediatype||""}render(){const e=Vl[this.displayMediatype];return e?c`
    ...
    `}};l([p({type:String})],ni.prototype,"mediatype",void 0);l([p({type:Array})],ni.prototype,"collections",void 0);l([p({type:Boolean})],ni.prototype,"showText",void 0);ni=l([D("mediatype-icon")],ni);const Wl=F`
...
fill=""></path>
    ...
    `}renderOption(e){const{label:t,url:i=void 0,id:o}=e;let a;const s=this.selectedOption===o?"selected":"";return i?a=Fe`<a
      ...
      >
        ${t}
      </button>`,Fe`<li class=${s}>${a}</li>`}optionClicked(e){var t;this.selectedOption!==e.id&&(this.selectedOption=e.id,this.dispatchEvent(new CustomEvent("optionSelected",{detail:{option:e}})),(t=e.selectedHandler)===null||t===void 0||t.call(e,e)),this.closeOnSelect&&this.closeOptions()}toggleOptions(){this.open=!this.open,this.dropdownBackdropVisible=this.open}mainButtonClicked(){if(!this.hasCustomClickHandler){if(this.handlingCaretClick){this.handlingCaretClick=!1;return}this.openViaButton&&this.toggleOptions()}}caretInteracted(){this.openViaCaret&&this.toggleOptions()}caretClicked(){this.handlingCaretClick=!0,this.caretInteracted()}caretKeyDown(e){(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),this.caretInteracted())}get caretTemplate(){return Fe`
      <span
        class="caret"
    ...
    `}get availableOptions(){return this.includeSelectedOption?this.options:this.options.filter(e=>this.selectedOption!==e.id)}get dropdownFormat(){return this.isCustomList?Fe`<slot name="list"></slot>`:Fe`${this.availableOptions.map(e=>this.renderOption(e))}`}render(){return Fe`
...
`;let ir=class extends O{constructor(){super(...arguments),this.config=new tr}render(){return c`
      <div class="modal-wrapper">
        <div class="modal-container">
          <header style="background-color: ${this.config.headerColor}">
            ...
            ${this.config.showHeaderLogo?c`<div class="logo-icon">${Rd}</div>`:y}
    ...
    `}};l([p({type:Object})],ir.prototype,"config",void 0);ir=l([D("modal-template")],ir);function Fd(r,e,t){var i=t||{},o=i.noTrailing,a=o===void 0?!1:o,s=i.noLeading,n=s===void 0?!1:s,d=i.debounceMode,h=d===void 0?void 0:d,u,f=!1,m=0;function w(){u&&clearTimeout(u)}function _(A){var N=A||{},H=N.upcomingOnly,q=H===void 0?!1:H;w(),f=!q}function S(){for(var A=arguments.length,N=new Array(A),H=0;H<A;H++)N[H]=arguments[H];var q=this,I=Date.now()-m;if(f)return;function R(){m=Date.now(),e.apply(q,N)}function W(){u=void 0}!n&&h&&!u&&R(),w(),h===void 0&&I>r?n?(m=Date.now(),a||(u=setTimeout(h?W:R,r))):R():a!==!0&&(u=setTimeout(h?W:R,h===void 0?r-I:r))}return S.cancel=_,S}var pt;(function(r){r.Open="open",r.Closed="closed"})(pt||(pt={}));class Id{constructor(e){this.windowResizeThrottler=Fd(100,this.updateModalContainerHeight,{noLeading:!1,noTrailing:!1}).bind(this),this.modalManager=e}handleModeChange(e){switch(e){case pt.Open:this.startResizeListener(),this.stopDocumentScroll();break;case pt.Closed:this.stopResizeListener(),this.resumeDocumentScroll();break}}updateModalContainerHeight(){this.modalManager.style.setProperty("--containerHeight",`${window.innerHeight}px`)}stopDocumentScroll(){document.body.classList.add("modal-manager-open")}resumeDocumentScroll(){document.body.classList.remove("modal-manager-open")}startResizeListener(){window.addEventListener("resize",this.windowResizeThrottler)}stopResizeListener(){window.removeEventListener("resize",this.windowResizeThrottler)}}let Ft=class extends O{constructor(){super(...arguments),this.mode=pt.Closed,this.hostBridge=new Id(this),this.closeOnBackdropClick=!0}render(){return c`
      <div class="container">
    ...
    `}};l([p({type:String,reflect:!0})],Ft.prototype,"mode",void 0);l([p({type:Object})],Ft.prototype,"customModalContent",void 0);l([p({type:Object})],Ft.prototype,"hostBridge",void 0);l([Y("modal-template")],Ft.prototype,"modalTemplate",void 0);Ft=l([D("modal-manager")],Ft);var Es=F`<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><path d="m79.8883285 50.0035012.1116715-.1085359-43.1159942-46.61088155c-2.401537-2.18938917-4.6902018-3.28408375-6.8659943-3.28408375s-4.1642651.63837733-5.9654178 1.91513199c-1.8011528 1.27675467-3.1520173 2.97248092-4.0525937 5.08717877l39.4020173 42.99768924-39.4020173 42.9976892c.9005764 2.1146979 2.2514409 3.8104241 4.0525937 5.0871788 1.8011527 1.2767547 3.7896253 1.915132 5.9654178 1.915132 2.1013449 0 4.3900096-1.0573489 6.8659943-3.1720468l43.1159942-46.7194174z"/></svg>
`,Ud=c`
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path
...
`;let It=class extends O{constructor(){super(...arguments),this.step=2,this.currentPage=1,this.pages=[]}firstUpdated(){this.observePageCount()}updated(e){e.has("size")&&this.observePageCount(),e.has("currentPage")&&(this.observePageCount(),this.emitPageClick())}observePageCount(){this.pages=[];const e=7,t=this.size<=e;if(this.size<=5){this.pages=[...Array(this.size).keys()].map(a=>a+1);return}if(this.size===e){if(this.currentPage===2){this.pages=[1,2,3,4,0,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,4,5,this.size-1,this.size];return}}if(this.currentPage===1){this.pages=[1,2,3,0,this.size];return}if(this.currentPage===this.size){this.pages=[1,0,this.size-2,this.size-1,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,this.size-3,this.size-2,this.size-1,this.size];return}if(t&&this.currentPage>1&&this.currentPage<e){this.pages=[...Array(this.size).keys()].map(a=>a+1);return}let i=this.currentPage-this.step,o=this.currentPage+this.step;i<=0&&(o+=-i+1,i=1),o>=this.size&&(i=Math.max(i-(o-this.size),1),o=this.size),i===2&&(o-=1),o===this.size-1&&(i+=1),this.createFirstNode(i),this.createMiddelNode(i,o),this.createLastNode(o)}createFirstNode(e){var t,i;e>1&&((t=this.pages)===null||t===void 0||t.push(1)),e>2&&((i=this.pages)===null||i===void 0||i.push(0))}createMiddelNode(e,t){var i;for(let o=e;o<=t;o+=1)(i=this.pages)===null||i===void 0||i.push(o)}createLastNode(e){var t,i;e<this.size-1&&((t=this.pages)===null||t===void 0||t.push(0)),e<this.size&&((i=this.pages)===null||i===void 0||i.push(this.size))}get getEllipsisTemplate(){return c`<i class="ellipses">...</i>`}emitPageClick(){this.dispatchEvent(new CustomEvent("pageNumberClicked",{detail:{page:this.currentPage},bubbles:!0,composed:!0}))}onRewind(){this.currentPage-=1,this.currentPage<1&&(this.currentPage=1)}onForward(){this.currentPage+=1,this.currentPage>this.size&&(this.currentPage=this.size)}onChange(e){this.currentPage=e}getPageTemplate(e){return c`
    ...
    `}static get styles(){return[Ze,g`
      ...
      `]}};l([p({type:Number})],It.prototype,"size",void 0);l([p({type:Number})],It.prototype,"step",void 0);l([p({type:Number})],It.prototype,"currentPage",void 0);l([z()],It.prototype,"pages",void 0);It=l([D("more-facets-pagination")],It);var Vd=F`
...
`)),e.has("placeholderType")&&this.placeholderType===null&&(this.leftColIntersectionObserver||this.setupLeftColumnScrollListeners(),this.facetsIntersectionObserver||this.setupFacetsScrollListeners(),this.updateLeftColumnHeight()),(e.has("displayMode")||e.has("baseNavigationUrl")||e.has("baseImageUrl")||e.has("loggedIn"))&&((t=this.infiniteScroller)===null||t===void 0||t.reload()),(e.has("baseQuery")||e.has("searchType")||e.has("withinCollection"))&&!this.historyPopOccurred&&this.initialQueryChangeHappened){const o=e.has("withinCollection")&&!e.has("selectedSort")&&!e.has("sortDirection");this.clearFilters({sort:o,facets:!e.has("selectedFacets"),dateRange:!(e.has("minSelectedDate")||e.has("maxSelectedDate")),letterFilters:!(e.has("selectedTitleFilter")||e.has("selectedCreatorFilter"))})}if(e.has("profileElement")&&this.applyDefaultProfileSort(),e.has("baseQuery")&&this.emitBaseQueryChanged(),e.has("searchType")&&this.emitSearchTypeChanged(),(e.has("currentPage")||e.has("displayMode"))&&this.persistState(),(e.has("baseQuery")||e.has("minSelectedDate")||e.has("maxSelectedDate")||e.has("selectedFacets")||e.has("searchService")||e.has("withinCollection")||e.has("withinProfile")||e.has("profileElement"))&&this.dataSource.refreshLetterCounts(),e.has("selectedSort")||e.has("sortDirection")){const o=e.get("sortDirection");this.sendSortByAnalytics(o),this.selectedSortChanged()}if(e.has("selectedTitleFilter")&&this.sendFilterByTitleAnalytics(e.get("selectedTitleFilter")),e.has("selectedCreatorFilter")&&this.sendFilterByCreatorAnalytics(e.get("selectedCreatorFilter")),(e.has("baseQuery")||e.has("searchType")||e.has("selectedTitleFilter")||e.has("selectedCreatorFilter")||e.has("minSelectedDate")||e.has("maxSelectedDate")||e.has("selectedSort")||e.has("sortDirection")||e.has("selectedFacets")||e.has("searchService")||e.has("withinCollection")||e.has("withinProfile")||e.has("profileElement"))&&this.handleQueryChange(),e.has("searchResultsLoading")&&this.emitSearchResultsLoadingChanged(),e.has("facetsLoading")&&this.facetsLoading&&this.collectionFacets&&(this.collectionFacets.moreLinksVisible=this.searchType!==ge.FULLTEXT),e.has("pagesToRender")&&!this.dataSource.endOfDataReached&&this.infiniteScroller&&(this.infiniteScroller.itemCount=this.estimatedTileCount),e.has("isManageView")&&(this.isManageView&&(this.displayMode="grid"),(i=this.infiniteScroller)===null||i===void 0||i.refreshAllVisibleCells(),this.emitManageModeChangedEvent()),e.has("resizeObserver")){const o=e.get("resizeObserver");o&&this.disconnectResizeObserver(o),this.setupResizeObserver()}}disconnectedCallback(){var e,t;this.resizeObserver&&this.disconnectResizeObserver(this.resizeObserver),this.boundNavigationHandler&&window.removeEventListener("popstate",this.boundNavigationHandler),(e=this.leftColIntersectionObserver)===null||e===void 0||e.disconnect(),(t=this.facetsIntersectionObserver)===null||t===void 0||t.disconnect(),window.removeEventListener("resize",this.updateLeftColumnHeight)}handleResize(e){const t=this.mobileView;e.target===this.contentContainer&&(this.contentWidth=e.contentRect.width,this.mobileView=this.contentWidth>0&&this.contentWidth<this.mobileBreakpoint,this.mobileView&&!t&&(this.isResizeToMobile=!0)),this.updateLeftColumnHeight()}setupLeftColumnScrollListeners(){var e;const t=(e=this.shadowRoot)===null||e===void 0?void 0:e.querySelector("#left-column-scroll-sentinel");t&&(this.leftColIntersectionObserver=new IntersectionObserver(this.updateLeftColumnHeight,{threshold:[...Array(101).keys()].map(i=>i/100)}),this.leftColIntersectionObserver.observe(t)),window.addEventListener("resize",this.updateLeftColumnHeight)}setupFacetsScrollListeners(){var e;const t=(e=this.shadowRoot)===null||e===void 0?void 0:e.querySelector("#facets-scroll-sentinel");t&&(this.facetsIntersectionObserver=new IntersectionObserver(this.updateFacetFadeOut),this.facetsIntersectionObserver.observe(t))}emitBaseQueryChanged(){this.dispatchEvent(new CustomEvent("baseQueryChanged",{detail:{baseQuery:this.baseQuery}}))}emitSearchTypeChanged(){this.dispatchEvent(new CustomEvent("searchTypeChanged",{detail:this.searchType}))}emitQueryStateChanged(){console.log("emitting query state changed event"),this.dispatchEvent(new CustomEvent("queryStateChanged",{detail:{baseQuery:this.baseQuery,withinCollection:this.withinCollection,withinProfile:this.withinProfile,profileElement:this.profileElement,searchType:this.searchType,selectedFacets:this.selectedFacets,minSelectedDate:this.minSelectedDate,maxSelectedDate:this.maxSelectedDate,selectedSort:this.selectedSort,sortDirection:this.sortDirection,selectedTitleFilter:this.selectedTitleFilter,selectedCreatorFilter:this.selectedCreatorFilter}}))}emitEmptyResults(){this.dispatchEvent(new Event("emptyResults"))}disconnectResizeObserver(e){e.removeObserver({target:this.contentContainer,handler:this})}setupResizeObserver(){!this.resizeObserver||this.resizeObserver.addObserver({target:this.contentContainer,handler:this})}visibleCellsChanged(e){if(this.isScrollingToCell)return;const{visibleCellIndices:t}=e.detail;if(t.length===0)return;const i=t[t.length-1],o=Math.floor(i/this.pageSize)+1;this.currentPage!==o&&(this.currentPage=o);const a=new CustomEvent("visiblePageChanged",{detail:{pageNumber:o}});this.dispatchEvent(a)}get initialSearchComplete(){return this.dataSource.initialSearchComplete}async handleQueryChange(){var e;!this.searchService||this.dataSource.pageFetchQueryKey===this.previousQueryKey||!this.dataSource.canPerformSearch&&!(this.clearResultsOnEmptyQuery&&this.baseQuery==="")||(console.log("CB will reset",this.baseQuery,JSON.stringify(this.selectedFacets)),this.previousQueryKey=this.dataSource.pageFetchQueryKey,this.tileModelOffset=0,this.totalResults=void 0,this.pagesToRender=this.initialPageNumber===1?2:this.initialPageNumber,this.infiniteScroller&&(this.infiniteScroller.itemCount=this.estimatedTileCount,this.infiniteScroller.reload()),this.withinCollection&&((e=this.baseQuery)===null||e===void 0?void 0:e.trim())&&(this.defaultSortField=$.relevance,this.defaultSortDirection=null),!this.initialQueryChangeHappened&&this.initialPageNumber>1&&this.scrollToPage(this.initialPageNumber),this.initialQueryChangeHappened=!0,this.historyPopOccurred||this.persistState(),this.historyPopOccurred=!1)}setupStateRestorationObserver(){this.boundNavigationHandler||(this.boundNavigationHandler=this.historyNavigationHandler.bind(this),window.addEventListener("popstate",this.boundNavigationHandler))}historyNavigationHandler(){this.historyPopOccurred=!0,this.restoreState()}restoreState(){var e,t,i,o,a;const s=this.restorationStateHandler.getRestorationState();this.displayMode=s.displayMode,s.searchType!=null&&(this.searchType=s.searchType),this.selectedSort=(e=s.selectedSort)!==null&&e!==void 0?e:$.default,this.sortDirection=(t=s.sortDirection)!==null&&t!==void 0?t:null,this.selectedTitleFilter=(i=s.selectedTitleFilter)!==null&&i!==void 0?i:null,this.selectedCreatorFilter=(o=s.selectedCreatorFilter)!==null&&o!==void 0?o:null,this.selectedFacets=s.selectedFacets,this.suppressURLQuery||(this.baseQuery=s.baseQuery),this.currentPage=(a=s.currentPage)!==null&&a!==void 0?a:1,this.minSelectedDate=s.minSelectedDate,this.maxSelectedDate=s.maxSelectedDate,console.log("state restored -- will go to page if greater than 1:",this.currentPage),this.currentPage>1&&this.goToPage(this.currentPage)}persistState(){var e,t,i,o;const a={displayMode:this.displayMode,searchType:this.searchType,selectedSort:this.selectedSort,sortDirection:(e=this.sortDirection)!==null&&e!==void 0?e:void 0,selectedFacets:(t=this.selectedFacets)!==null&&t!==void 0?t:Mt(),baseQuery:this.suppressURLQuery?void 0:this.baseQuery,currentPage:this.currentPage,titleQuery:this.titleQuery,creatorQuery:this.creatorQuery,minSelectedDate:this.minSelectedDate,maxSelectedDate:this.maxSelectedDate,selectedTitleFilter:(i=this.selectedTitleFilter)!==null&&i!==void 0?i:void 0,selectedCreatorFilter:(o=this.selectedCreatorFilter)!==null&&o!==void 0?o:void 0};this.restorationStateHandler.persistState(a)}emitSearchResultsLoadingChanged(){this.dispatchEvent(new CustomEvent("searchResultsLoadingChanged",{detail:{loading:this.searchResultsLoading}}))}facetsChanged(e){this.selectedFacets=e.detail}facetClickHandler({detail:{facetType:e,bucket:t,negative:i}}){var o;let a;i?a=t.state!=="none"?ae.facetNegativeSelected:ae.facetNegativeDeselected:a=t.state!=="none"?ae.facetSelected:ae.facetDeselected,(o=this.analyticsHandler)===null||o===void 0||o.sendEvent({category:this.searchContext,action:a,label:e})}scrollToPage(e){return new Promise(t=>{const i=this.pageSize*(e-1);setTimeout(()=>{var o;this.isScrollingToCell=!0,console.log("about to scroll infinite scroller to cell",i),(o=this.infiniteScroller)===null||o===void 0||o.scrollToCell(i,!0),setTimeout(()=>{var a;console.log("done scrolling, refreshing visible cells"),this.isScrollingToCell=!1,(a=this.infiniteScroller)===null||a===void 0||a.refreshAllVisibleCells(),t()},500)},0)})}get isRelevanceSortAvailable(){var e;return!!(!((e=this.baseQuery)===null||e===void 0)&&e.trim())}setTileCount(e){console.log("Setting scroller tile count to",e),this.infiniteScroller&&(this.infiniteScroller.itemCount=e)}applyDefaultCollectionSort(e){var t,i,o;if(this.baseQuery){this.defaultSortField=$.relevance,this.defaultSortDirection=null;return}const a=!((i=(t=e==null?void 0:e.public_metadata)===null||t===void 0?void 0:t.identifier)===null||i===void 0)&&i.startsWith("fav-")?"-favoritedate":"-week",s=(o=e==null?void 0:e.public_metadata)===null||o===void 0?void 0:o["sort-by"],n=s!=null?s:a;let[d,h]=n.split(":");d.startsWith("-")?(d=d.slice(1),h="desc"):["asc","desc"].includes(h)||(h="asc");const f=fs(d).field;f&&f!==$.default&&(this.defaultSortField=f,this.defaultSortDirection=h,this.defaultSortParam={field:this.defaultSortField,direction:this.defaultSortDirection})}applyDefaultProfileSort(){if(this.profileElement){const e=En[this.profileElement];this.defaultSortField=e!=null?e:$.weeklyview}else this.defaultSortField=$.weeklyview;this.defaultSortDirection="desc",this.defaultSortParam={field:this.defaultSortField,direction:this.defaultSortDirection}}get currentVisiblePageNumbers(){var e,t;const i=(t=(e=this.infiniteScroller)===null||e===void 0?void 0:e.getVisibleCellIndices())!==null&&t!==void 0?t:[],o=new Set;return i.forEach(a=>{const s=Math.floor(a/this.pageSize)+1;o.add(s)}),Array.from(o)}refreshVisibleResults(){var e;(e=this.infiniteScroller)===null||e===void 0||e.refreshAllVisibleCells()}resultSelected(e){var t,i,o;if(this.isManageView){const a=this.dataSource.indexOf(e.detail);a>=0&&((t=this.infiniteScroller)===null||t===void 0||t.refreshCell(a))}(i=this.analyticsHandler)===null||i===void 0||i.sendEvent({category:this.searchContext,action:ae.resultSelected,label:e.detail.mediatype}),(o=this.analyticsHandler)===null||o===void 0||o.sendEvent({category:this.searchContext,action:ae.resultSelected,label:`page-${this.currentPage}`})}cellForIndex(e){const t=this.tileModelAtCellIndex(e);if(!!t)return c`
    ...
    `}scrollThresholdReached(){!this.dataSource.endOfDataReached&&this.dataSource.queryInitialized&&(this.pagesToRender+=1,this.dataSource.fetchPage(this.pagesToRender))}static get styles(){return[Ze,g`
      ...
      `]}};l([p({type:String})],M.prototype,"baseNavigationUrl",void 0);l([p({type:String})],M.prototype,"baseImageUrl",void 0);l([p({type:Object})],M.prototype,"searchService",void 0);l([p({type:String})],M.prototype,"searchType",void 0);l([p({type:String})],M.prototype,"withinCollection",void 0);l([p({type:String})],M.prototype,"withinProfile",void 0);l([p({type:String})],M.prototype,"profileElement",void 0);l([p({type:String})],M.prototype,"baseQuery",void 0);l([p({type:String})],M.prototype,"displayMode",void 0);l([p({type:Object})],M.prototype,"defaultSortParam",void 0);l([p({type:String})],M.prototype,"selectedSort",void 0);l([p({type:String})],M.prototype,"selectedTitleFilter",void 0);l([p({type:String})],M.prototype,"selectedCreatorFilter",void 0);l([p({type:String})],M.prototype,"sortDirection",void 0);l([p({type:Number})],M.prototype,"pageSize",void 0);l([p({type:Number})],M.prototype,"currentPage",void 0);l([p({type:String})],M.prototype,"minSelectedDate",void 0);l([p({type:String})],M.prototype,"maxSelectedDate",void 0);l([p({type:Object})],M.prototype,"selectedFacets",void 0);l([p({type:Boolean})],M.prototype,"showHistogramDatePicker",void 0);l([p({type:Boolean})],M.prototype,"suppressPlaceholders",void 0);l([p({type:Boolean})],M.prototype,"suppressResultCount",void 0);l([p({type:Boolean})],M.prototype,"suppressURLQuery",void 0);l([p({type:Boolean})],M.prototype,"suppressFacets",void 0);l([p({type:Boolean})],M.prototype,"suppressSortBar",void 0);l([p({type:Boolean})],M.prototype,"clearResultsOnEmptyQuery",void 0);l([p({type:String})],M.prototype,"collectionPagePath",void 0);l([p({type:String,reflect:!0})],M.prototype,"searchContext",void 0);l([p({type:String})],M.prototype,"pageContext",void 0);l([p({type:Object})],M.prototype,"restorationStateHandler",void 0);l([p({type:Number})],M.prototype,"mobileBreakpoint",void 0);l([p({type:Boolean})],M.prototype,"loggedIn",void 0);l([p({type:Object})],M.prototype,"resizeObserver",void 0);l([p({type:Object})],M.prototype,"modalManager",void 0);l([p({type:Object})],M.prototype,"featureFeedbackService",void 0);l([p({type:Object})],M.prototype,"recaptchaManager",void 0);l([p({type:Boolean})],M.prototype,"isManageView",void 0);l([p({type:Boolean})],M.prototype,"isLoansTab",void 0);l([p({type:Object})],M.prototype,"dataSource",void 0);l([z()],M.prototype,"pagesToRender",void 0);l([z()],M.prototype,"searchResultsLoading",void 0);l([z()],M.prototype,"facetsLoading",void 0);l([z()],M.prototype,"totalResults",void 0);l([z()],M.prototype,"mobileView",void 0);l([z()],M.prototype,"mobileFacetsVisible",void 0);l([z()],M.prototype,"contentWidth",void 0);l([z()],M.prototype,"defaultSortField",void 0);l([z()],M.prototype,"defaultSortDirection",void 0);l([z()],M.prototype,"placeholderType",void 0);l([Y("#content-container")],M.prototype,"contentContainer",void 0);l([Y("#left-column")],M.prototype,"leftColumn",void 0);l([Y("collection-facets")],M.prototype,"collectionFacets",void 0);l([p({type:Object,attribute:!1})],M.prototype,"analyticsHandler",void 0);l([Y("infinite-scroller")],M.prototype,"infiniteScroller",void 0);M=l([D("collection-browser")],M);let ne=class extends O{constructor(){super(...arguments),this.searchService=this.initSearchServiceFromUrlParams(),this.resizeObserver=new ml,this.toggleSlots=!1,this.cellWidth=18,this.cellHeight=29,this.rowGap=1.7,this.colGap=1.7,this.loggedIn=!1,this.searchType=ge.METADATA,this.analyticsManager=new Ks,this.analyticsHandler={sendPing:this.sendAnalytics.bind(this),sendEvent:this.sendAnalytics.bind(this),sendEventNoSampling:this.sendAnalytics.bind(this)}}sendAnalytics(e){var t;console.log("Analytics Received ----",e),this.latestAction=e,(t=this.analyticsManager)===null||t===void 0||t.sendEvent(e)}initSearchServiceFromUrlParams(){var e,t,i;const o=new URL(window.location.href).searchParams;return new qe({includeCredentials:!1,baseUrl:(e=o.get("search_base_url"))!==null&&e!==void 0?e:void 0,servicePath:(t=o.get("search_service_path"))!==null&&t!==void 0?t:void 0,debuggingEnabled:(i=!!o.get("debugging"))!==null&&i!==void 0?i:void 0})}searchPressed(e){e.preventDefault(),this.searchQuery=this.baseQueryField.value,this.collectionBrowser.searchType=this.searchType,this.goToCurrentPage()}collectionChanged(e){e.preventDefault(),this.withinCollection=this.baseCollectionField.value,this.collectionBrowser.withinCollection=this.withinCollection,this.goToCurrentPage()}goToCurrentPage(){var e;const t=(e=this.currentPage)!==null&&e!==void 0?e:1;t>1&&this.collectionBrowser.goToPage(t)}changePagePressed(e){e.preventDefault(),this.currentPage=this.pageNumberInput.valueAsNumber,this.collectionBrowser.goToPage(this.currentPage)}updated(e){e.has("currentPage")&&this.currentPage&&(this.pageNumberInput.value=this.currentPage.toString()),e.has("searchQuery")&&this.queryUpdated()}queryUpdated(){this.collectionBrowser.baseQuery=this.searchQuery}get getClass(){return new URLSearchParams(window.location.search).get("hide-dev-tools")?"hidden":""}render(){var e,t;return c`
