...
`;let rr=class extends O{constructor(){super(...arguments),this.config=new or}render(){return c`
    ...
    `}static get styles(){const e=g`var(--modalLogoSize, 6.5rem)`,t=g`var(--processingImageSize, 7.5rem)`,i=g`var(--modalCornerRadius, 1rem)`,o=g`var(--modalBorder, 2px solid black)`,a=g`var(--modalBottomMargin, 2.5rem)`,s=g`var(--modalTopMargin, 5rem)`,n=g`var(--modalHeaderBottomPadding, 0.5em)`,d=g`var(--modalBottomPadding, 2rem)`,p=g`var(--modalScrollOffset, 5px)`,v=g`var(--modalTitleFontSize, 1.8rem)`,f=g`var(--modalSubtitleFontSize, 1.4rem)`,m=g`var(--modalHeadlineFontSize, 1.6rem)`,w=g`var(--modalMessageFontSize, 1.4rem)`,_=g`var(--modalTitleLineHeight, normal)`,C=g`var(--modalSubtitleLineHeight, normal)`,P=g`var(--modalHeadlineLineHeight, normal)`,N=g`var(--modalMessageLineHeight, normal)`;return g`
      .processing-logo {
        margin: auto;
        width: ${t};
        height: ${t};
...
`,ar;let Wt=ar=class extends O{render(){return c`${this.facetRowTemplate}`}get facetRowTemplate(){var e,t,i,o;const{bucket:a,facetType:s}=this;if(!a||!s)return y;const n=`${s}:${a.key}-show-only`,d=`${s}:${a.key}-negative`,p=s!=="collection"?c`${(e=a.displayText)!==null&&e!==void 0?e:a.key}`:c`<a href="/details/${a.key}">
          ...
          </a> `,v=a.state==="hidden",f=a.state==="selected",m=`${s}: ${(o=a.displayText)!==null&&o!==void 0?o:a.key}`,w=f?`Show all ${s}s`:`Only show ${m}`,_=`Hide ${m}`,C=`Unhide ${m}`,P=v?C:_,N=`${m}, ${a.count} results`;return c`
    ...
    `}partOfCollectionClicked(e){var t;(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:Le.default,action:le.partOfCollectionClicked,label:e.target.dataset.id})}showDatePickerModal(){var e,t,i;const{fullYearsHistogramAggregation:o}=this,a=o==null?void 0:o.first_bucket_key,s=o==null?void 0:o.last_bucket_key,n=o==null?void 0:o.buckets,p=c`
