 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Pe={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},wi=r=>(...e)=>({_$litDirective$:r,values:e});class xi{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}/**
 * @license
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Pa(r,e,t){return r?e():t==null?void 0:t()}let gi=class extends F{constructor(){super(...arguments),this.label=L("Select items to un-favorite"),this.showSelectAll=!1,this.showUnselectAll=!1}render(){return c`
      <div class="manage-container">
        ...
        <div class="manage-buttons">
          ...
          <div class="selection-buttons">
            ${Pa(this.showSelectAll,()=>c` <button
                class="link-styled select-all-btn"
                @click=${this.selectAllClicked}
              >
                ${L("Select all")}
              </button>`)}
            ${Pa(this.showUnselectAll,()=>c` <button
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ai=(r,e)=>{var t,i;const o=r._$AN;if(o===void 0)return!1;for(const a of o)(i=(t=a)._$AO)===null||i===void 0||i.call(t,e,!1),ai(a,e);return!0},Qi=r=>{let e,t;do{if((e=r._$AM)===void 0)break;t=e._$AN,t.delete(r),r=e}while((t==null?void 0:t.size)===0)},Cs=r=>{for(let e;e=r._$AM;r=e){let t=e._$AN;if(t===void 0)e._$AN=t=new Set;else if(t.has(r))break;t.add(r),od(e)}};function td(r){this._$AN!==void 0?(Qi(this),this._$AM=r,Cs(this)):this._$AM=r}function id(r,e=!1,t=0){const i=this._$AH,o=this._$AN;if(o!==void 0&&o.size!==0)if(e)if(Array.isArray(i))for(let a=t;a<i.length;a++)ai(i[a],!1),Qi(i[a]);else i!=null&&(ai(i,!1),Qi(i));else ai(this,r)}const od=r=>{var e,t,i,o;r.type==Pe.CHILD&&((e=(i=r)._$AP)!==null&&e!==void 0||(i._$AP=id),(t=(o=r)._$AQ)!==null&&t!==void 0||(o._$AQ=td))};class rd extends xi{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,i){super._$AT(e,t,i),Cs(this),this.isConnected=e._$AU}_$AO(e,t=!0){var i,o;e!==this.isConnected&&(this.isConnected=e,e?(i=this.reconnected)===null||i===void 0||i.call(this):(o=this.disconnected)===null||o===void 0||o.call(this)),t&&(ai(this,e),Qi(this))}setValue(e){if(as(this._$Ct))this._$Ct._$AI(e,this);else{const t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}}const Ao=new WeakMap,ad=wi(class extends rd{render(r){return y}update(r,[e]){var t;const i=e!==this.U;return i&&this.U!==void 0&&this.ot(void 0),(i||this.rt!==this.lt)&&(this.U=e,this.ht=(t=r.options)===null||t===void 0?void 0:t.host,this.ot(this.lt=r.element)),y}ot(r){var e;if(typeof this.U=="function"){const t=(e=this.ht)!==null&&e!==void 0?e:globalThis;let i=Ao.get(t);i===void 0&&(i=new WeakMap,Ao.set(t,i)),i.get(this.U)!==void 0&&this.U.call(this.ht,void 0),i.set(this.U,r),r!==void 0&&this.U.call(this.ht,r)}else this.U.value=r}get rt(){var r,e,t;return typeof this.U=="function"?(e=Ao.get((r=this.ht)!==null&&r!==void 0?r:globalThis))===null||e===void 0?void 0:e.get(this.U):(t=this.U)===null||t===void 0?void 0:t.value}disconnected(){this.rt===this.lt&&this.ot(void 0)}reconnected(){this.ot(this.lt)}});/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const La=wi(class extends xi{constructor(r){if(super(r),r.type!==Pe.PROPERTY&&r.type!==Pe.ATTRIBUTE&&r.type!==Pe.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!as(r))throw Error("`live` bindings can only contain a single expression")}render(r){return r}update(r,[e]){if(e===$e||e===y)return e;const t=r.element,i=r.name;if(r.type===Pe.PROPERTY){if(e===t[i])return $e}else if(r.type===Pe.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(i))return $e}else if(r.type===Pe.ATTRIBUTE&&t.getAttribute(i)===e+"")return $e;return ss(r),e}}),sd=Object.freeze({processing:"processing",complete:"complete"});class ld extends F{static get properties(){return{mode:{type:String}}}constructor(){super(),this.mode=sd.processing}render(){return c`
      <div class="${this.mode}">
        <svg
          viewBox="0 0 120 120"
    ...
    `}get selectedRangeTemplate(){return R`
      ...
      />`}get histogramTemplate(){const e=this._histWidth/this._numBins,t=e-1;let i=this.sliderWidth;return this._histData.map(o=>{const a=R`
        ...
        />`;return i+=e,a})}formatDate(e){if(Number.isNaN(e))return"";const t=Po(e);return t.year()<1e3?String(t.year()):t.format(this.dateFormat)}get minInputTemplate(){return c`
      <input
        id="date-min"
...
`;let rr=class extends F{constructor(){super(...arguments),this.config=new or}render(){return c`
    ...
    `}static get styles(){const e=g`var(--modalLogoSize, 6.5rem)`,t=g`var(--processingImageSize, 7.5rem)`,i=g`var(--modalCornerRadius, 1rem)`,o=g`var(--modalBorder, 2px solid black)`,a=g`var(--modalBottomMargin, 2.5rem)`,s=g`var(--modalTopMargin, 5rem)`,n=g`var(--modalHeaderBottomPadding, 0.5em)`,d=g`var(--modalBottomPadding, 2rem)`,h=g`var(--modalScrollOffset, 5px)`,u=g`var(--modalTitleFontSize, 1.8rem)`,f=g`var(--modalSubtitleFontSize, 1.4rem)`,m=g`var(--modalHeadlineFontSize, 1.6rem)`,w=g`var(--modalMessageFontSize, 1.4rem)`,_=g`var(--modalTitleLineHeight, normal)`,S=g`var(--modalSubtitleLineHeight, normal)`,P=g`var(--modalHeadlineLineHeight, normal)`,N=g`var(--modalMessageLineHeight, normal)`;return g`
      .processing-logo {
        margin: auto;
        width: ${t};
        height: ${t};
...
`,ar;let Wt=ar=class extends F{render(){return c`${this.facetRowTemplate}`}get facetRowTemplate(){var e,t,i,o;const{bucket:a,facetType:s}=this;if(!a||!s)return y;const n=`${s}:${a.key}-show-only`,d=`${s}:${a.key}-negative`,h=s!=="collection"?c`${(e=a.displayText)!==null&&e!==void 0?e:a.key}`:c`<a href="/details/${a.key}">
          ...
          </a> `,u=a.state==="hidden",f=a.state==="selected",m=`${s}: ${(o=a.displayText)!==null&&o!==void 0?o:a.key}`,w=f?`Show all ${s}s`:`Only show ${m}`,_=`Hide ${m}`,S=`Unhide ${m}`,P=u?S:_,N=`${m}, ${a.count} results`;return c`
...
`,Ae;let Se=Ae=class extends F{constructor(){super(...arguments),this.placeholderType=null,this.detailMessage=""}render(){return this.placeholderType?c`${this.placeholderTemplate}`:y}get placeholderTemplate(){return c`
      <div
    ...
    `}get emptyQueryTemplate(){return c`
      <h2 class="title">${Ae.MESSAGE_EMPTY_QUERY}</h2>
      <div>${Wd}</div>
    `}get emptyCollectionTemplate(){return c`
      <h2 class="title">${Ae.MESSAGE_NO_VIEWABLE_MEMBERS}</h2>
      <div>${Ai}</div>
