...
`;var Qo;(function(r){r[r.bytes=0]="bytes",r[r.kilobytes=1]="kilobytes",r[r.megabytes=2]="megabytes",r[r.gigabytes=3]="gigabytes",r[r.terabytes=4]="terabytes",r[r.petabytes=5]="petabytes",r[r.exabytes=6]="exabytes",r[r.zettabytes=7]="zettabytes",r[r.yottabytes=8]="yottabytes"})(Qo||(Qo={}));function Zl(r,e,t=" "){let i=r;if(i===void 0)return y;let o=0;for(;i>1024;)i/=1024,o+=1;const a=10**e;i=Math.round(i*a)/a;let s=Qo[o];return s=i===1?s.slice(0,-1):s,`${i.toLocaleString()+t+s}`}const Jl=f`var(--tileBackgroundColor, #ffffff)`,en=f`var(--tileCornerRadius, 4px)`,Xi=f`
...
`;let di=class extends O{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1,this.isCompactTile=!1}render(){return c`<div class="icon-overlay ${this.getClass}">
      ${this.iconDisplay}
    </div>`}get getClass(){return this.isCompactTile?"list-compact":"list-detail"}get iconDisplay(){return this.loginRequired&&!this.loggedIn?c`${Ss}`:c`${$s}`}static get styles(){return f`
      :host {
        position: absolute;
        top: 50%;
        left: 50%;
    ...
    `}};l([h({type:Boolean})],di.prototype,"loggedIn",void 0);l([h({type:Boolean})],di.prototype,"loginRequired",void 0);l([h({type:Boolean})],di.prototype,"isCompactTile",void 0);di=l([L("icon-overlay")],di);let ci=class extends O{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1,this.iconRequired=!1}render(){return c`
      <div class="overlay no-preview">
        <div class="icon-overlay">${this.iconDisplay}</div>
        <p class="text-overlay">${this.textDisplay}</p>
      </div>
    `}get iconDisplay(){return this.loginRequired&&!this.loggedIn?c`${Ss}`:c`${$s}`}get textDisplay(){return this.loginRequired&&!this.loggedIn?c`Log in to view this item`:c`Content may be inappropriate`}static get styles(){return f`
      :host {
        align-items: center;
        display: flex;
      }
    ...
    >`}get getSizeTemplate(){var e,t;const i=(t=(e=this.model)===null||e===void 0?void 0:e.collectionSize)!==null&&t!==void 0?t:0;return i?c`<span id="item-size">${Zl(i,1)}</span>`:""}get infoButtonTemplate(){return this.showInfoButton?c`<button class="info-button" @click=${this.infoButtonPressed}>
        ...
        </button>`:y}infoButtonPressed(e){e.preventDefault();const t=new CustomEvent("infoButtonPressed",{detail:{x:e.clientX,y:e.clientY}});this.dispatchEvent(t)}static get styles(){const e=f`var(--tileBorderColor, #555555)`,t=f`var(--tileBackgroundColor, #666666)`,i=f`#fff`;return[Xi,f`
        .container {
          background-color: ${t};
          border: 1px solid ${e};
        }
 ...
 */function*Pi(r,e){const t=typeof e=="function";if(r!==void 0){let i=-1;for(const o of r)i>-1&&(yield t?e(i):e),i++,yield o}}let Hi=class extends O{constructor(){super(...arguments),this.snippets=[],this.viewSize="desktop"}render(){var e;return!((e=this.snippets)===null||e===void 0)&&e.length?c`
    ...
    `}};l([h({type:Array})],Hi.prototype,"snippets",void 0);l([h({type:String})],Hi.prototype,"viewSize",void 0);Hi=l([L("text-snippet-block")],Hi);const rn=f`
  .drop-shadow {
    overflow: hidden;
    height: 100%;
  }
...
`;let Be=class extends O{constructor(){super(...arguments),this.isListTile=!1,this.isCompactTile=!1,this.loggedIn=!1,this.isWaveform=!1,this.isNotFound=!1}render(){return c`
...
`;function xn(r,e){let t=1;return r>=1e9?t=1e9:r>=1e6?t=1e6:r>=1e3&&e==="short"&&(t=1e3),t}function _n(r=0,e){const t=r/e,i=t<10;let o=0;return i?o=Math.round((t+Number.EPSILON)*10)/10:o=Math.round(t),o}function $n(r,e,t,i){switch(e){case 1e9:return P(t==="short"?nt`${r}B`:nt`${r} billion`);case 1e6:return P(t==="short"?nt`${r}M`:nt`${r} million`);case 1e3:return P(t==="short"?nt`${r}K`:nt`${r} thousand`);default:return new Intl.NumberFormat(i).format(r)}}function ri(r,e="long",t="short",i="en-US"){const o=r!=null?r:-1;if(o<0)return"";const a=xn(o,e),s=_n(o,a);return $n(s,a,t,i)}let Xe=class extends O{render(){var e,t,i,o,a;const s=ri(this.favCount,"short","short"),n=ri(this.commentCount,"short","short"),d=this.mediatype==="account"?`${(e=this.itemCount)!==null&&e!==void 0?e:0} uploads`:`${(t=this.viewCount)!==null&&t!==void 0?t:0} ${(i=this.viewLabel)!==null&&i!==void 0?i:"all-time views"}`;return c`
    ...
    >
          ...
          &#9432;
          <span class="sr-only">${P("More info")}</span>
        </button>`:y}infoButtonPressed(e){e.preventDefault();const t=new CustomEvent("infoButtonPressed",{detail:{x:e.clientX,y:e.clientY}});this.dispatchEvent(t)}static get styles(){const e=f`var(--tileBorderColor, #dddddd)`;return[Xi,f`
        .container {
          border: 1px solid ${e};
        }
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}var zn=Object.hasOwnProperty,ua=Object.setPrototypeOf,Pn=Object.isFrozen,An=Object.getPrototypeOf,Dn=Object.getOwnPropertyDescriptor,ge=Object.freeze,Re=Object.seal,Ln=Object.create,Ts=typeof Reflect!="undefined"&&Reflect,Vi=Ts.apply,ir=Ts.construct;Vi||(Vi=function(e,t,i){return e.apply(t,i)});ge||(ge=function(e){return e});Re||(Re=function(e){return e});ir||(ir=function(e,t){return Ai(e,Te(t))});var Bn=Ee(Array.prototype.forEach),va=Ee(Array.prototype.pop),ei=Ee(Array.prototype.push),Di=Ee(String.prototype.toLowerCase),Rn=Ee(String.prototype.match),Ge=Ee(String.prototype.replace),On=Ee(String.prototype.indexOf),Fn=Ee(String.prototype.trim),me=Ee(RegExp.prototype.test),yo=In(TypeError);function Ee(r){return function(e){for(var t=arguments.length,i=new Array(t>1?t-1:0),o=1;o<t;o++)i[o-1]=arguments[o];return Vi(r,e,i)}}function In(r){return function(){for(var e=arguments.length,t=new Array(e),i=0;i<e;i++)t[i]=arguments[i];return ir(r,t)}}function B(r,e){ua&&ua(r,null);for(var t=e.length;t--;){var i=e[t];if(typeof i=="string"){var o=Di(i);o!==i&&(Pn(e)||(e[t]=o),i=o)}r[i]=!0}return r}function st(r){var e=Ln(null),t;for(t in r)Vi(zn,r,[t])&&(e[t]=r[t]);return e}function Ti(r,e){for(;r!==null;){var t=Dn(r,e);if(t){if(t.get)return Ee(t.get);if(typeof t.value=="function")return Ee(t.value)}r=An(r)}function i(o){return console.warn("fallback value for",o),null}return i}var fa=ge(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","section","select","shadow","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),wo=ge(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","filter","font","g","glyph","glyphref","hkern","image","line","lineargradient","marker","mask","metadata","mpath","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),xo=ge(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),Nn=ge(["animate","color-profile","cursor","discard","fedropshadow","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),_o=ge(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover"]),Un=ge(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),ma=ge(["#text"]),ga=ge(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","face","for","headers","height","hidden","high","href","hreflang","id","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","pattern","placeholder","playsinline","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","xmlns","slot"]),$o=ge(["accent-height","accumulate","additive","alignment-baseline","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),ba=ge(["accent","accentunder","align","bevelled","close","columnsalign","columnlines","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lspace","lquote","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),Ei=ge(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),Hn=Re(/\{\{[\w\W]*|[\w\W]*\}\}/gm),Vn=Re(/<%[\w\W]*|[\w\W]*%>/gm),Wn=Re(/^data-[\-\w.\u00B7-\uFFFF]/),jn=Re(/^aria-[\-\w]+$/),Gn=Re(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|cid|xmpp):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),qn=Re(/^(?:\w+script|data):/i),Qn=Re(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),Kn=Re(/^html$/i),Xn=function(){return typeof window=="undefined"?null:window},Yn=function(e,t){if(dt(e)!=="object"||typeof e.createPolicy!="function")return null;var i=null,o="data-tt-policy-suffix";t.currentScript&&t.currentScript.hasAttribute(o)&&(i=t.currentScript.getAttribute(o));var a="dompurify"+(i?"#"+i:"");try{return e.createPolicy(a,{createHTML:function(n){return n}})}catch{return console.warn("TrustedTypes policy "+a+" could not be created."),null}};function Es(){var r=arguments.length>0&&arguments[0]!==void 0?arguments[0]:Xn(),e=function(v){return Es(v)};if(e.version="2.3.8",e.removed=[],!r||!r.document||r.document.nodeType!==9)return e.isSupported=!1,e;var t=r.document,i=r.document,o=r.DocumentFragment,a=r.HTMLTemplateElement,s=r.Node,n=r.Element,d=r.NodeFilter,p=r.NamedNodeMap,u=p===void 0?r.NamedNodeMap||r.MozNamedAttrMap:p,m=r.HTMLFormElement,g=r.DOMParser,w=r.trustedTypes,_=n.prototype,S=Ti(_,"cloneNode"),A=Ti(_,"nextSibling"),U=Ti(_,"childNodes"),D=Ti(_,"parentNode");if(typeof a=="function"){var N=i.createElement("template");N.content&&N.content.ownerDocument&&(i=N.content.ownerDocument)}var F=Yn(w,t),X=F?F.createHTML(""):"",Y=i,de=Y.implementation,W=Y.createNodeIterator,$e=Y.createDocumentFragment,Vt=Y.getElementsByTagName,Wt=t.importNode,vt={};try{vt=st(i).documentMode?i.documentMode:{}}catch{}var ye={};e.isSupported=typeof D=="function"&&de&&typeof de.createHTMLDocument!="undefined"&&vt!==9;var Je=Hn,et=Vn,jt=Wn,Gt=jn,qt=qn,ft=Qn,tt=Gn,Z=null,Qt=B({},[].concat(Te(fa),Te(wo),Te(xo),Te(_o),Te(ma))),ce=null,kr=B({},[].concat(Te(ga),Te($o),Te(ba),Te(Ei))),ae=Object.seal(Object.create(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),Kt=null,Zi=null,Tr=!0,Ji=!0,Er=!1,mt=!1,it=!1,eo=!1,to=!1,gt=!1,wi=!1,xi=!1,Mr=!0,io=!0,Xt=!1,bt={},yt=null,zr=B({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","style","svg","template","thead","title","video","xmp"]),Pr=null,Ar=B({},["audio","video","img","source","image","track"]),oo=null,Dr=B({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),ro="http://www.w3.org/1998/Math/MathML",ao="http://www.w3.org/2000/svg",je="http://www.w3.org/1999/xhtml",_i=je,so=!1,wt,Us=["application/xhtml+xml","text/html"],Hs="text/html",ot,xt=null,Vs=i.createElement("form"),Lr=function(v){return v instanceof RegExp||v instanceof Function},lo=function(v){xt&&xt===v||((!v||dt(v)!=="object")&&(v={}),v=st(v),Z="ALLOWED_TAGS"in v?B({},v.ALLOWED_TAGS):Qt,ce="ALLOWED_ATTR"in v?B({},v.ALLOWED_ATTR):kr,oo="ADD_URI_SAFE_ATTR"in v?B(st(Dr),v.ADD_URI_SAFE_ATTR):Dr,Pr="ADD_DATA_URI_TAGS"in v?B(st(Ar),v.ADD_DATA_URI_TAGS):Ar,yt="FORBID_CONTENTS"in v?B({},v.FORBID_CONTENTS):zr,Kt="FORBID_TAGS"in v?B({},v.FORBID_TAGS):{},Zi="FORBID_ATTR"in v?B({},v.FORBID_ATTR):{},bt="USE_PROFILES"in v?v.USE_PROFILES:!1,Tr=v.ALLOW_ARIA_ATTR!==!1,Ji=v.ALLOW_DATA_ATTR!==!1,Er=v.ALLOW_UNKNOWN_PROTOCOLS||!1,mt=v.SAFE_FOR_TEMPLATES||!1,it=v.WHOLE_DOCUMENT||!1,gt=v.RETURN_DOM||!1,wi=v.RETURN_DOM_FRAGMENT||!1,xi=v.RETURN_TRUSTED_TYPE||!1,to=v.FORCE_BODY||!1,Mr=v.SANITIZE_DOM!==!1,io=v.KEEP_CONTENT!==!1,Xt=v.IN_PLACE||!1,tt=v.ALLOWED_URI_REGEXP||tt,_i=v.NAMESPACE||je,v.CUSTOM_ELEMENT_HANDLING&&Lr(v.CUSTOM_ELEMENT_HANDLING.tagNameCheck)&&(ae.tagNameCheck=v.CUSTOM_ELEMENT_HANDLING.tagNameCheck),v.CUSTOM_ELEMENT_HANDLING&&Lr(v.CUSTOM_ELEMENT_HANDLING.attributeNameCheck)&&(ae.attributeNameCheck=v.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),v.CUSTOM_ELEMENT_HANDLING&&typeof v.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements=="boolean"&&(ae.allowCustomizedBuiltInElements=v.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements),wt=Us.indexOf(v.PARSER_MEDIA_TYPE)===-1?wt=Hs:wt=v.PARSER_MEDIA_TYPE,ot=wt==="application/xhtml+xml"?function(x){return x}:Di,mt&&(Ji=!1),wi&&(gt=!0),bt&&(Z=B({},Te(ma)),ce=[],bt.html===!0&&(B(Z,fa),B(ce,ga)),bt.svg===!0&&(B(Z,wo),B(ce,$o),B(ce,Ei)),bt.svgFilters===!0&&(B(Z,xo),B(ce,$o),B(ce,Ei)),bt.mathMl===!0&&(B(Z,_o),B(ce,ba),B(ce,Ei))),v.ADD_TAGS&&(Z===Qt&&(Z=st(Z)),B(Z,v.ADD_TAGS)),v.ADD_ATTR&&(ce===kr&&(ce=st(ce)),B(ce,v.ADD_ATTR)),v.ADD_URI_SAFE_ATTR&&B(oo,v.ADD_URI_SAFE_ATTR),v.FORBID_CONTENTS&&(yt===zr&&(yt=st(yt)),B(yt,v.FORBID_CONTENTS)),io&&(Z["#text"]=!0),it&&B(Z,["html","head","body"]),Z.table&&(B(Z,["tbody"]),delete Kt.tbody),ge&&ge(v),xt=v)},Br=B({},["mi","mo","mn","ms","mtext"]),Rr=B({},["foreignobject","desc","title","annotation-xml"]),Ws=B({},["title","style","font","a","script"]),$i=B({},wo);B($i,xo),B($i,Nn);var no=B({},_o);B(no,Un);var js=function(v){var x=D(v);(!x||!x.tagName)&&(x={namespaceURI:je,tagName:"template"});var C=Di(v.tagName),V=Di(x.tagName);return v.namespaceURI===ao?x.namespaceURI===je?C==="svg":x.namespaceURI===ro?C==="svg"&&(V==="annotation-xml"||Br[V]):Boolean($i[C]):v.namespaceURI===ro?x.namespaceURI===je?C==="math":x.namespaceURI===ao?C==="math"&&Rr[V]:Boolean(no[C]):v.namespaceURI===je?x.namespaceURI===ao&&!Rr[V]||x.namespaceURI===ro&&!Br[V]?!1:!no[C]&&(Ws[C]||!$i[C]):!1},Fe=function(v){ei(e.removed,{element:v});try{v.parentNode.removeChild(v)}catch{try{v.outerHTML=X}catch{v.remove()}}},Or=function(v,x){try{ei(e.removed,{attribute:x.getAttributeNode(v),from:x})}catch{ei(e.removed,{attribute:null,from:x})}if(x.removeAttribute(v),v==="is"&&!ce[v])if(gt||wi)try{Fe(x)}catch{}else try{x.setAttribute(v,"")}catch{}},Fr=function(v){var x,C;if(to)v="<remove></remove>"+v;else{var V=Rn(v,/^[\r\n\t ]+/);C=V&&V[0]}wt==="application/xhtml+xml"&&(v='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+v+"</body></html>");var we=F?F.createHTML(v):v;if(_i===je)try{x=new g().parseFromString(we,wt)}catch{}if(!x||!x.documentElement){x=de.createDocument(_i,"template",null);try{x.documentElement.innerHTML=so?"":we}catch{}}var ue=x.body||x.documentElement;return v&&C&&ue.insertBefore(i.createTextNode(C),ue.childNodes[0]||null),_i===je?Vt.call(x,it?"html":"body")[0]:it?x.documentElement:ue},Ir=function(v){return W.call(v.ownerDocument||v,v,d.SHOW_ELEMENT|d.SHOW_COMMENT|d.SHOW_TEXT,null,!1)},Gs=function(v){return v instanceof m&&(typeof v.nodeName!="string"||typeof v.textContent!="string"||typeof v.removeChild!="function"||!(v.attributes instanceof u)||typeof v.removeAttribute!="function"||typeof v.setAttribute!="function"||typeof v.namespaceURI!="string"||typeof v.insertBefore!="function")},Yt=function(v){return dt(s)==="object"?v instanceof s:v&&dt(v)==="object"&&typeof v.nodeType=="number"&&typeof v.nodeName=="string"},Ie=function(v,x,C){!ye[v]||Bn(ye[v],function(V){V.call(e,x,C,xt)})},Nr=function(v){var x;if(Ie("beforeSanitizeElements",v,null),Gs(v)||me(/[\u0080-\uFFFF]/,v.nodeName))return Fe(v),!0;var C=ot(v.nodeName);if(Ie("uponSanitizeElement",v,{tagName:C,allowedTags:Z}),v.hasChildNodes()&&!Yt(v.firstElementChild)&&(!Yt(v.content)||!Yt(v.content.firstElementChild))&&me(/<[/\w]/g,v.innerHTML)&&me(/<[/\w]/g,v.textContent)||C==="select"&&me(/<template/i,v.innerHTML))return Fe(v),!0;if(!Z[C]||Kt[C]){if(!Kt[C]&&Hr(C)&&(ae.tagNameCheck instanceof RegExp&&me(ae.tagNameCheck,C)||ae.tagNameCheck instanceof Function&&ae.tagNameCheck(C)))return!1;if(io&&!yt[C]){var V=D(v)||v.parentNode,we=U(v)||v.childNodes;if(we&&V)for(var ue=we.length,he=ue-1;he>=0;--he)V.insertBefore(S(we[he],!0),A(v))}return Fe(v),!0}return v instanceof n&&!js(v)||(C==="noscript"||C==="noembed")&&me(/<\/no(script|embed)/i,v.innerHTML)?(Fe(v),!0):(mt&&v.nodeType===3&&(x=v.textContent,x=Ge(x,Je," "),x=Ge(x,et," "),v.textContent!==x&&(ei(e.removed,{element:v.cloneNode()}),v.textContent=x)),Ie("afterSanitizeElements",v,null),!1)},Ur=function(v,x,C){if(Mr&&(x==="id"||x==="name")&&(C in i||C in Vs))return!1;if(!(Ji&&!Zi[x]&&me(jt,x))){if(!(Tr&&me(Gt,x))){if(!ce[x]||Zi[x]){if(!(Hr(v)&&(ae.tagNameCheck instanceof RegExp&&me(ae.tagNameCheck,v)||ae.tagNameCheck instanceof Function&&ae.tagNameCheck(v))&&(ae.attributeNameCheck instanceof RegExp&&me(ae.attributeNameCheck,x)||ae.attributeNameCheck instanceof Function&&ae.attributeNameCheck(x))||x==="is"&&ae.allowCustomizedBuiltInElements&&(ae.tagNameCheck instanceof RegExp&&me(ae.tagNameCheck,C)||ae.tagNameCheck instanceof Function&&ae.tagNameCheck(C))))return!1}else if(!oo[x]){if(!me(tt,Ge(C,ft,""))){if(!((x==="src"||x==="xlink:href"||x==="href")&&v!=="script"&&On(C,"data:")===0&&Pr[v])){if(!(Er&&!me(qt,Ge(C,ft,"")))){if(C)return!1}}}}}}return!0},Hr=function(v){return v.indexOf("-")>0},Vr=function(v){var x,C,V,we;Ie("beforeSanitizeAttributes",v,null);var ue=v.attributes;if(!!ue){var he={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:ce};for(we=ue.length;we--;){x=ue[we];var Si=x,fe=Si.name,Wr=Si.namespaceURI;if(C=fe==="value"?x.value:Fn(x.value),V=ot(fe),he.attrName=V,he.attrValue=C,he.keepAttr=!0,he.forceKeepAttr=void 0,Ie("uponSanitizeAttribute",v,he),C=he.attrValue,!he.forceKeepAttr&&(Or(fe,v),!!he.keepAttr)){if(me(/\/>/i,C)){Or(fe,v);continue}mt&&(C=Ge(C,Je," "),C=Ge(C,et," "));var Qs=ot(v.nodeName);if(!!Ur(Qs,V,C))try{Wr?v.setAttributeNS(Wr,fe,C):v.setAttribute(fe,C),va(e.removed)}catch{}}}Ie("afterSanitizeAttributes",v,null)}},qs=function M(v){var x,C=Ir(v);for(Ie("beforeSanitizeShadowDOM",v,null);x=C.nextNode();)Ie("uponSanitizeShadowNode",x,null),!Nr(x)&&(x.content instanceof o&&M(x.content),Vr(x));Ie("afterSanitizeShadowDOM",v,null)};return e.sanitize=function(M,v){var x,C,V,we,ue;if(so=!M,so&&(M="<!-->"),typeof M!="string"&&!Yt(M)){if(typeof M.toString!="function")throw yo("toString is not a function");if(M=M.toString(),typeof M!="string")throw yo("dirty is not a string, aborting")}if(!e.isSupported){if(dt(r.toStaticHTML)==="object"||typeof r.toStaticHTML=="function"){if(typeof M=="string")return r.toStaticHTML(M);if(Yt(M))return r.toStaticHTML(M.outerHTML)}return M}if(eo||lo(v),e.removed=[],typeof M=="string"&&(Xt=!1),Xt){if(M.nodeName){var he=ot(M.nodeName);if(!Z[he]||Kt[he])throw yo("root node is forbidden and cannot be sanitized in-place")}}else if(M instanceof s)x=Fr("<!---->"),C=x.ownerDocument.importNode(M,!0),C.nodeType===1&&C.nodeName==="BODY"||C.nodeName==="HTML"?x=C:x.appendChild(C);else{if(!gt&&!mt&&!it&&M.indexOf("<")===-1)return F&&xi?F.createHTML(M):M;if(x=Fr(M),!x)return gt?null:xi?X:""}x&&to&&Fe(x.firstChild);for(var Si=Ir(Xt?M:x);V=Si.nextNode();)V.nodeType===3&&V===we||Nr(V)||(V.content instanceof o&&qs(V.content),Vr(V),we=V);if(we=null,Xt)return M;if(gt){if(wi)for(ue=$e.call(x.ownerDocument);x.firstChild;)ue.appendChild(x.firstChild);else ue=x;return ce.shadowroot&&(ue=Wt.call(t,ue,!0)),ue}var fe=it?x.outerHTML:x.innerHTML;return it&&Z["!doctype"]&&x.ownerDocument&&x.ownerDocument.doctype&&x.ownerDocument.doctype.name&&me(Kn,x.ownerDocument.doctype.name)&&(fe="<!DOCTYPE "+x.ownerDocument.doctype.name+`>
`+fe),mt&&(fe=Ge(fe,Je," "),fe=Ge(fe,et," ")),F&&xi?F.createHTML(fe):fe},e.setConfig=function(M){lo(M),eo=!0},e.clearConfig=function(){xt=null,eo=!1},e.isValidAttribute=function(M,v,x){xt||lo({});var C=ot(M),V=ot(v);return Ur(C,V,x)},e.addHook=function(M,v){typeof v=="function"&&(ye[M]=ye[M]||[],ei(ye[M],v))},e.removeHook=function(M){if(ye[M])return va(ye[M])},e.removeHooks=function(M){ye[M]&&(ye[M]=[])},e.removeAllHooks=function(){ye={}},e}var Li=Es();let Wi=class extends ne{constructor(){super(...arguments),this.collectionLinks=[]}render(){return c`
    ...
    `}};l([h({type:Object})],Wi.prototype,"collectionTitles",void 0);l([z()],Wi.prototype,"collectionLinks",void 0);Wi=l([L("tile-list")],Wi);let Ye=class extends O{constructor(){super(...arguments),this.loggedIn=!1}render(){return c`
      <div id="container">
        <tile-list
          .model=${this.model}
...
fill=""></path>
  ...
  `;nr=l([Is("ia-icon-label")],nr);let dr=class extends O{constructor(){super(...arguments),this.numResults=0}render(){return c`
    ...
    `}};l([h({type:Number})],dr.prototype,"numResults",void 0);dr=l([L("alpha-bar-tooltip")],dr);let Ve=class extends O{constructor(){super(...arguments),this.selectedLetter=null,this.tooltipShown=!1,this.alphabet="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("")}get selectedUppercaseLetter(){var e;return(e=this.selectedLetter)===null||e===void 0?void 0:e.toUpperCase()}render(){var e;return c`
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Na(r,e,t){return r?e():t==null?void 0:t()}const Ua=f`var(--white, #fff)`,kd=f`var(--primaryDisableCTAFill, #767676)`,Td=f`var(--secondaryCTABorder, #999)`,Ed=f`var(--primaryCTAFill, #194880)`,Do=f`var(--primaryCTAFillRGB, 25, 72, 128)`,Md=f`var(--primaryCTABorder, #c5d1df)`,zd=f`var(--primaryErrorCTAFill, #d9534f)`,Lo=f`var(--primaryErrorCTAFillRGB, 229, 28, 38)`,Pd=f`var(--primaryErrorCTABorder, #d43f3a)`,Ad=f`var(--secondaryCTAFill, #333)`,Bo=f`var(--secondaryCTAFillRGB, 51, 51, 51)`,Dd=f`var(--primaryCTABorder, #979797)`,Ld=f`#ee8950`,Bd=f`#ec7939`;var Rd=f`
  .ia-button {
    min-height: 3rem;
    cursor: pointer;
    color: ${Ua};
...
`;let Ot=class extends O{constructor(){super(...arguments),this.label=P("Select items to remove"),this.showSelectAll=!1,this.showUnselectAll=!1,this.removeAllowed=!1}render(){return c`
...
`;let hr=class extends O{constructor(){super(...arguments),this.config=new cr}render(){return c`
    ...
    `}};l([h({type:String,reflect:!0})],Ft.prototype,"mode",void 0);l([h({type:Object})],Ft.prototype,"customModalContent",void 0);l([h({type:Object})],Ft.prototype,"hostBridge",void 0);l([K("modal-template")],Ft.prototype,"modalTemplate",void 0);Ft=l([L("modal-manager")],Ft);var uc=c`
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path
...
`,pr;let Nt=pr=class extends O{render(){return c`${this.facetRowTemplate}`}get facetRowTemplate(){var e,t,i,o;const{bucket:a,facetType:s}=this;if(!a||!s)return y;const n=`${s}:${a.key}-show-only`,d=`${s}:${a.key}-negative`,p=s!=="collection"?c`${(e=a.displayText)!==null&&e!==void 0?e:a.key}`:c`<a href="/details/${a.key}">
    ...
    `}};l([h({type:Object})],Ut.prototype,"facetGroup",void 0);l([h({type:Object})],Ut.prototype,"selectedFacets",void 0);l([h({type:String})],Ut.prototype,"renderOn",void 0);l([h({type:Object})],Ut.prototype,"collectionTitles",void 0);Ut=l([L("facets-template")],Ut);let Ze=class extends O{constructor(){super(...arguments),this.leftValue="",this.rightValue="",this.side="left"}render(){var e,t;return c`
      <div id="container">
    ...
    `}applySearchFacetsClicked(){var e,t;const i=new CustomEvent("facetsChanged",{detail:this.selectedFacets,bubbles:!0,composed:!0});this.dispatchEvent(i),(e=this.modalManager)===null||e===void 0||e.closeModal(),(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:Le.default,action:`${ie.applyMoreFacetsModal}`,label:`${this.facetKey}`})}cancelClick(){var e,t;(e=this.modalManager)===null||e===void 0||e.closeModal(),(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:Le.default,action:ie.closeMoreFacetsModal,label:`${this.facetKey}`})}static get styles(){const e=f`var(--primaryButtonBGColor, #194880)`;return[We,f`
      ...
      `]}};l([h({type:String})],re.prototype,"facetKey",void 0);l([h({type:String})],re.prototype,"facetAggregationKey",void 0);l([h({type:String})],re.prototype,"query",void 0);l([h({type:Object})],re.prototype,"filterMap",void 0);l([h({type:Object})],re.prototype,"modalManager",void 0);l([h({type:Object})],re.prototype,"searchService",void 0);l([h({type:String})],re.prototype,"searchType",void 0);l([h({type:String})],re.prototype,"withinCollection",void 0);l([h({type:Object})],re.prototype,"collectionTitles",void 0);l([h({type:Object})],re.prototype,"selectedFacets",void 0);l([h({type:String})],re.prototype,"sortedBy",void 0);l([h({type:Object,attribute:!1})],re.prototype,"analyticsHandler",void 0);l([z()],re.prototype,"aggregations",void 0);l([z()],re.prototype,"facetGroup",void 0);l([z()],re.prototype,"facetGroupTitle",void 0);l([z()],re.prototype,"pageNumber",void 0);l([z()],re.prototype,"facetsLoading",void 0);l([z()],re.prototype,"paginationSize",void 0);l([z()],re.prototype,"facetsType",void 0);re=l([L("more-facets-content")],re);let Ka=class extends O{render(){return c`
      <div id="row">
    ...
    `}};Ka=l([L("facet-tombstone-row")],Ka);let Oe=class extends O{constructor(){super(...arguments),this.boundEscapeListener=e=>{e.key==="Escape"&&this.closeModal()}}render(){var e,t;return c`
      <div id="container">
    ...
    `,u=new cr({bodyColor:"#fff",headerColor:"#194880",showHeaderLogo:!1,closeOnBackdropClick:!0,title:c`Select a date range`});(e=this.modalManager)===null||e===void 0||e.classList.add("expanded-date-picker"),(t=this.modalManager)===null||t===void 0||t.showModal({config:u,customModalContent:p,userClosedModalCallback:this.handleExpandedDatePickerClosed}),(i=this.analyticsHandler)===null||i===void 0||i.sendEvent({category:Le.default,action:ie.histogramExpanded,label:window.location.href})}updated(e){e.has("selectedFacets")&&this.dispatchFacetsChangedEvent()}dispatchFacetsChangedEvent(){const e=new CustomEvent("facetsChanged",{detail:this.selectedFacets});this.dispatchEvent(e)}get expandDatePickerBtnTemplate(){return this.allowExpandingDatePicker&&!this.facetsLoading?c`<button
        ...
        >
          ...
          <histogram-date-range
            ...
            @histogramDateRangeUpdated=${this.histogramDateRangeUpdated}
          ></histogram-date-range>
        `}get mergedFacets(){const e=[];return Il.forEach(t=>{var i,o;const a=this.selectedFacetGroups.find(u=>u.key===t),s=this.aggregationFacetGroups.find(u=>u.key===t);if(a&&!s){e.push(a);return}if(!s)return;const n=a!=null?a:s;let d=(i=a==null?void 0:a.buckets.map(u=>{const m=s.buckets.find(g=>g.key===u.key);return m?xe(se({},u),{count:m.count}):u}))!==null&&i!==void 0?i:[];s.buckets.forEach(u=>{d.find(g=>g.key===u.key)||d.push(u)});let p=(o=Object.keys((a==null?void 0:a.buckets)||[]))===null||o===void 0?void 0:o.length;if(p<this.allowedFacetCount&&(p=this.allowedFacetCount),t==="lending"&&(d=d.filter(u=>Ul[u.key])),t==="mediatype"){const u=d.findIndex(m=>m.key==="collection");if(u>=p){const[m]=d.splice(u,1);d.splice(p-1,0,m),p>this.allowedFacetCount&&(p+=1)}}n.buckets=d.splice(0,p),e.push(n)}),e}get selectedFacetGroups(){return this.selectedFacets?Object.entries(this.selectedFacets).map(([t,i])=>{const o=t,a=Ni[o],s=Object.entries(i).map(([n,d])=>{var p;let u=n;return o==="lending"&&(u=(p=da[n])!==null&&p!==void 0?p:n),{displayText:u,key:n,count:d.count,state:d.state}});return{title:a,key:o,buckets:s}}):[]}get aggregationFacetGroups(){var e;const t=[];return Object.entries((e=this.aggregations)!==null&&e!==void 0?e:[]).forEach(([i,o])=>{if(i==="year_histogram")return;const a=i,s=Ni[a];if(!s)return;let n=o.getSortedBuckets(jo[a]);a==="collection"&&(n=n==null?void 0:n.filter(u=>{var m;const g=(m=u==null?void 0:u.key)===null||m===void 0?void 0:m.toString();return!gr[g]&&!(g!=null&&g.startsWith("fav-"))}));const d=n.map(u=>{var m;const g=u.key;let w=`${u.key}`;return a==="lending"&&(w=(m=da[u.key])!==null&&m!==void 0?m:`${u.key}`),{displayText:w,key:`${g}`,count:u.doc_count,state:"none"}}),p={title:s,key:a,buckets:d};t.push(p)}),t}getFacetGroupTemplate(e){if(!this.facetsLoading&&e.buckets.length===0)return y;const{key:t}=e,i=this.openFacets[t],o=c`
    ...
    `:this.placeholderCellTemplate}scrollThresholdReached(){!this.dataSource.endOfDataReached&&this.dataSource.queryInitialized&&(this.pagesToRender+=1,this.dataSource.fetchPage(this.pagesToRender))}static get styles(){return[We,f`
        :host {
          display: block;
