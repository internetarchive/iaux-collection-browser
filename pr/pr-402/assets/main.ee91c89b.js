...
`,Pe;let Ce=Pe=class extends F{constructor(){super(...arguments),this.placeholderType=null,this.detailMessage=""}render(){return this.placeholderType?c`${this.placeholderTemplate}`:b}get placeholderTemplate(){return c`
      <div
...
`;let Lt=class extends F{constructor(){super(...arguments),this.title="",this.body="",this.starRating=0,this.viewSize="desktop"}render(){return!this.title&&!this.body&&!this.starRating?b:c`
...
`+me),gt&&(me=Qe(me,et," "),me=Qe(me,tt," ")),O&&bi?O.createHTML(me):me},e.setConfig=function(z){no(z),to=!0},e.clearConfig=function(){_t=null,to=!1},e.isValidAttribute=function(z,v,x){_t||no({});var C=rt(z),V=rt(v);return Gr(C,V,x)},e.addHook=function(z,v){typeof v=="function"&&(xe[z]=xe[z]||[],Zt(xe[z],v))},e.removeHook=function(z){if(xe[z])return ya(xe[z])},e.removeHooks=function(z){xe[z]&&(xe[z]=[])},e.removeAllHooks=function(){xe={}},e}var Pi=zs();let Vi=class extends de{constructor(){super(...arguments),this.collectionLinks=[]}render(){return c`
    ...
    `}get datePublishedTemplate(){var e;const t=(e=this.model)===null||e===void 0?void 0:e.datePublished;let i="long";return Tr(t)&&(i="year-only"),this.metadataTemplate(At(t,i),M("Published"))}get dateSortByTemplate(){return this.effectiveSort&&(this.effectiveSort.field==="addeddate"||this.effectiveSort.field==="reviewdate"||this.effectiveSort.field==="publicdate")?this.metadataTemplate(At(this.date,"long"),this.displayValueProvider.dateLabel):b}get viewsTemplate(){var e,t,i,o;const a=((e=this.effectiveSort)===null||e===void 0?void 0:e.field)==="week"?(t=this.model)===null||t===void 0?void 0:t.weeklyViewCount:(i=this.model)===null||i===void 0?void 0:i.viewCount;return a==null?b:((o=this.model)===null||o===void 0?void 0:o.mediatype)==="search"?this.metadataTemplate("(Favorited search query)",""):this.metadataTemplate(`${ii(a,this.formatSize)}`,M("Views"))}get ratingTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.averageRating,M("Avg Rating"))}get reviewsTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.commentCount,M("Reviews"))}get topicsTemplate(){var e;return!(!((e=this.model)===null||e===void 0)&&e.subjects)||this.model.subjects.length===0?b:c`
...
`,mr;let hi=mr=class extends F{render(){return c`${this.facetRowTemplate}`}get facetRowTemplate(){var e,t,i,o;const{bucket:a,facetType:s}=this;if(!a||!s)return b;const n=`${s}:${a.key}-show-only`,d=`${s}:${a.key}-negative`,p=s!=="collection"?c`${(e=a.displayText)!==null&&e!==void 0?e:a.key}`:c`<a href="/details/${a.key}">
    ...
    `}get loaderTemplate(){return c`<div class="facets-loader">
      <ia-activity-indicator .mode=${"processing"}></ia-activity-indicator>
        ...
        </div> `:b}sortFacetAggregation(e){this.sortedBy=e,this.dispatchEvent(new CustomEvent("sortedFacets",{detail:this.sortedBy}))}get modalHeaderTemplate(){var e,t,i;const a=((e=this.sortedBy)!==null&&e!==void 0?e:Ii[this.facetKey])===q.COUNT?"left":"right";return c`<span class="sr-only">${M("More facets for:")}</span>
      <span class="title">
    ...
    `}partOfCollectionClicked(e){var t;(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:De.default,action:Z.partOfCollectionClicked,label:e.target.dataset.id})}showDatePickerModal(){var e,t,i;const{fullYearsHistogramAggregation:o}=this,a=o==null?void 0:o.first_bucket_key,s=o==null?void 0:o.last_bucket_key,n=o==null?void 0:o.buckets,p=c`
      <expanded-date-picker
        ${Qd(m=>{if(m&&m instanceof Oe){const g=m;g.minSelectedDate=this.minSelectedDate,g.maxSelectedDate=this.maxSelectedDate}})}
        .minDate=${a}
        .maxDate=${s}
    ...
    `;return(this.facetLoadStrategy==="opt-in"||this.facetLoadStrategy==="opt-in-or-login"&&!this.loggedIn)&&!this.mobileView?c`
      ...
      `:e}clearFiltersBtnTemplate(e){if(!this.hasActiveFilters)return b;const t=Pt({"clear-filters-btn":!0,mobile:e}),i=e?"Clear all":"Clear all filters";return c`
