...
`+de),Ce&&(de=Ie(de,We," "),de=Ie(de,Ve," ")),B&&mi?B.createHTML(de):de},e.setConfig=function(C){qi(C),Ke=!0},e.clearConfig=function(){yt=null,Ke=!1},e.isValidAttribute=function(C,u,b){yt||qi({});var S=qe(C),H=qe(u);return or(S,H,b)},e.addHook=function(C,u){typeof u=="function"&&(ve[C]=ve[C]||[],Zt(ve[C],u))},e.removeHook=function(C){if(ve[C])return Mr(ve[C])},e.removeHooks=function(C){ve[C]&&(ve[C]=[])},e.removeAllHooks=function(){ve={}},e}var ii=wo(),A;(function(r){r.relevance="relevance",r.alltimeview="alltimeview",r.weeklyview="weeklyview",r.title="title",r.datearchived="datearchived",r.date="date",r.datereviewed="datereviewed",r.dateadded="dateadded",r.creator="creator"})(A||(A={}));const et={relevance:"Relevance",alltimeview:"All-time Views",weeklyview:"Weekly Views",title:"Title",datearchived:"Date Archived",date:"Date Published",datereviewed:"Date Reviewed",dateadded:"Date Added",creator:"Creator"},Fn={relevance:null,alltimeview:"downloads",weeklyview:"week",title:"titleSorter",datearchived:"publicdate",date:"date",datereviewed:"reviewdate",dateadded:"addeddate",creator:"creatorSorter"},Ar={week:A.weeklyview,downloads:A.alltimeview,titleSorter:A.title,date:A.date,publicdate:A.datearchived,reviewdate:A.datereviewed,addeddate:A.dateadded,creatorSorter:A.creator},Pn={title:"firstTitle",creator:"firstCreator"},Oi={subject:{},lending:{},mediatype:{},language:{},creator:{},collection:{},year:{}},On=["mediatype","lending","year","subject","collection","creator","language"],Ii={subject:"Subject",lending:"Availability",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"},In={is_lendable:!0,is_borrowable:!1,available_to_borrow:!0,is_browsable:!1,available_to_browse:!1,is_readable:!0,available_to_waitlist:!1},Fr={is_lendable:"Lending Library",available_to_borrow:"Borrow 14 Days",is_readable:"Always Available"},Ha={deemphasize:!0,community:!0,stream_only:!0,samples_only:!0,test_collection:!0,printdisabled:!0,"openlibrary-ol":!0,nationalemergencylibrary:!0,china:!0,americana:!0,toronto:!0};function xo(r){switch(r){case"date":return"Published";case"reviewdate":return"Reviewed";case"addeddate":return"Added";default:return"Archived"}}function _o(r){return r?`Archivist since ${r.getFullYear()}`:""}let ye=class extends F{constructor(){super(...arguments),this.sortParam=null,this.collectionLinks=[],this.loggedIn=!1}render(){return p`
    ...
    </a> `:x}get detailsTemplate(){return p`
    ...
    `}};n([h({type:Object})],Ft.prototype,"model",void 0);n([h({type:Number})],Ft.prototype,"currentWidth",void 0);n([h({type:Object})],Ft.prototype,"sortParam",void 0);n([h({type:Number})],Ft.prototype,"mobileBreakpoint",void 0);Ft=n([R("tile-list-compact-header")],Ft);class Nn{constructor(e,t={}){this.host=e,this.offsetX=-10,this.offsetY=15,this.showDelay=300,this.hideDelay=100,this.longPressDelay=800,this.enableLongPress=!0,this.hoverPaneState="hidden",this.lastMouseClientPos={x:0,y:0},this.handleMouseMove=i=>{var a;clearTimeout(this.hideTimer),this.hoverPaneState==="fading-out"&&(this.hoverPaneState="shown",(a=this.hoverPane)===null||a===void 0||a.classList.add("fade-in")),this.hoverPaneState==="hidden"&&(this.restartShowHoverPaneTimer(),this.lastMouseClientPos={x:i.clientX,y:i.clientY})},this.handleMouseLeave=()=>{clearTimeout(this.showTimer),clearTimeout(this.hideTimer),this.hoverPaneState!=="hidden"&&(this.hideTimer=window.setTimeout(()=>{this.fadeOutHoverPane()},this.hideDelay))},this.handleTouchStart=()=>{clearTimeout(this.longPressTimer),this.longPressTimer=window.setTimeout(()=>{this.hoverPaneState==="hidden"&&this.showHoverPane()},this.longPressDelay)},this.cancelLongPress=()=>{clearTimeout(this.longPressTimer)},this.clearHoverPane=()=>{this.hoverPaneState!=="hidden"&&this.fadeOutHoverPane()},this.host.addController(this),Object.assign(this,t)}hostConnected(){this.attachListeners()}hostDisconnected(){this.detachListeners()}hostUpdated(){this.hoverPane=this.host.getHoverPane(),this.hoverPaneProps=this.host.getHoverPaneProps()}getTemplate(){var e,t,i,a,o,s;return this.shouldRenderHoverPane?p` ${this.touchBackdropTemplate}
          <tile-hover-pane
