...
`;let _a=class extends F{render(){var e,t,i;return p`
      <div id="container">
        ...
        <div id="item-count-container">
          <div id="item-count-image-container">${mo}</div>
    ...
    `}};s([h({type:Object})],_a.prototype,"model",void 0);_a=s([R("collection-tile")],_a);function Mi(r,e="short",t="en-US"){if(!r)return"";const i={timeZone:"UTC"};switch(e){case"short":i.month="short",i.year="numeric";break;case"long":i.year="numeric",i.month="short",i.day="2-digit";break}return new Intl.DateTimeFormat(t,i).format(r)}const Fs=y`var(--collectionTileCornerRadius, 4px)`,Os=y`var(--tileBackgroundColor, #ffffff)`,vo=y`
  .container {
    background-color: ${Os};
    border: 1px #2c2c2c;
    border-radius: ${Fs};
 ...
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Sa=Ri(class extends Bi{constructor(r){var e;if(super(r),r.type!==De.ATTRIBUTE||r.name!=="class"||((e=r.strings)===null||e===void 0?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(r){return" "+Object.keys(r).filter(e=>r[e]).join(" ")+" "}update(r,[e]){var t,i;if(this.et===void 0){this.et=new Set,r.strings!==void 0&&(this.st=new Set(r.strings.join(" ").split(/\s/).filter(o=>o!=="")));for(const o in e)e[o]&&!(!((t=this.st)===null||t===void 0)&&t.has(o))&&this.et.add(o);return this.render(e)}const a=r.element.classList;this.et.forEach(o=>{o in e||(a.remove(o),this.et.delete(o))});for(const o in e){const n=!!e[o];n===this.et.has(o)||((i=this.st)===null||i===void 0?void 0:i.has(o))||(n?(a.add(o),this.et.add(o)):(a.remove(o),this.et.delete(o)))}return ge}}),fo=I`
  <svg
    viewBox="0 0 100 100"
    xmlns="http://www.w3.org/2000/svg"
  >
 ...
 */function*_i(r,e){const t=typeof e=="function";if(r!==void 0){let i=-1;for(const a of r)i>-1&&(yield t?e(i):e),i++,yield a}}let Di=class extends F{constructor(){super(...arguments),this.snippets=[],this.viewSize="desktop"}render(){var e;return!((e=this.snippets)===null||e===void 0)&&e.length?p`
    ...
    `}};s([h({type:Array})],Di.prototype,"snippets",void 0);s([h({type:String})],Di.prototype,"viewSize",void 0);Di=s([R("text-snippet-block")],Di);const Is=y`
  .drop-shadow {
...
`,Ks={account:{color:"#000000",icon:Ns,text:"Account"},audio:{color:"#00adef",icon:Rs,text:"Audio"},collection:{color:"#4666ff",icon:mo,text:"Collection"},data:{color:"#333333",icon:Bs,text:"Data"},etree:{color:"#00adef",icon:Hs,text:"E-tree"},film:{color:"#bf1b2c",icon:Sr,text:"Film"},image:{color:"#aa99c9",icon:Us,text:"Image"},movies:{color:"#f1644b",icon:Sr,text:"Movie"},radio:{color:"#8fdaef",icon:js,text:"Radio"},software:{color:"#9ecc4f",icon:Ws,text:"Software"},texts:{color:"#faab3c",icon:Vs,text:"Text"},tv:{color:"#f1644b",icon:Gs,text:"TV"},video:{color:"#f1644b",icon:Qs,text:"Video"},web:{color:"#ffcd27",icon:Ys,text:"Web"}};let di=class extends F{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var e,t;const i=["tvnews","tvarchive","television"],a=["radio","radioprogram"];return this.mediatype==="movies"&&((e=this.collections)===null||e===void 0?void 0:e.some(o=>i.indexOf(o)>=0))?"tv":this.mediatype==="audio"&&((t=this.collections)===null||t===void 0?void 0:t.some(o=>a.indexOf(o)>=0))?"radio":this.mediatype||""}render(){const e=Ks[this.displayMediatype];return e?p`
    ...
    `}};s([h({type:String})],di.prototype,"mediatype",void 0);s([h({type:Array})],di.prototype,"collections",void 0);s([h({type:Boolean})],di.prototype,"showText",void 0);di=s([R("mediatype-icon")],di);const qs=I`
...
`+de),ht&&(de=Fe(de,Ue," "),de=Fe(de,je," ")),B&&pi?B.createHTML(de):de},e.setConfig=function(C){Ki(C),Ui=!0},e.clearConfig=function(){ft=null,Ui=!1},e.isValidAttribute=function(C,u,b){ft||Ki({});var S=Ye(C),H=Ye(u);return ir(S,H,b)},e.addHook=function(C,u){typeof u=="function"&&(me[C]=me[C]||[],qt(me[C],u))},e.removeHook=function(C){if(me[C])return Cr(me[C])},e.removeHooks=function(C){me[C]&&(me[C]=[])},e.removeAllHooks=function(){me={}},e}var ei=bo(),L;(function(r){r.relevance="relevance",r.alltimeview="alltimeview",r.weeklyview="weeklyview",r.title="title",r.datearchived="datearchived",r.date="date",r.datereviewed="datereviewed",r.dateadded="dateadded",r.creator="creator"})(L||(L={}));const Ze={relevance:"Relevance",alltimeview:"All-time Views",weeklyview:"Weekly Views",title:"Title",datearchived:"Date Archived",date:"Date Published",datereviewed:"Date Reviewed",dateadded:"Date Added",creator:"Creator"},An={relevance:null,alltimeview:"downloads",weeklyview:"week",title:"titleSorter",datearchived:"publicdate",date:"date",datereviewed:"reviewdate",dateadded:"addeddate",creator:"creatorSorter"},Dr={week:L.weeklyview,downloads:L.alltimeview,titleSorter:L.title,date:L.date,publicdate:L.datearchived,reviewdate:L.datereviewed,addeddate:L.dateadded,creatorSorter:L.creator},Ln={title:"firstTitle",creator:"firstCreator"},Li={subject:{},lending:{},mediatype:{},language:{},creator:{},collection:{},year:{}},Fn=["mediatype","lending","year","subject","collection","creator","language"],Fi={subject:"Subject",lending:"Availability",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"},On={is_lendable:!0,is_borrowable:!1,available_to_borrow:!0,is_browsable:!1,available_to_browse:!1,is_readable:!0,available_to_waitlist:!1},Er={is_lendable:"Lending Library",available_to_borrow:"Borrow 14 Days",is_readable:"Always Available"},Na={deemphasize:!0,community:!0,stream_only:!0,samples_only:!0,test_collection:!0,printdisabled:!0,"openlibrary-ol":!0,nationalemergencylibrary:!0,china:!0,americana:!0,toronto:!0};function wo(r){switch(r){case"date":return"Published";case"reviewdate":return"Reviewed";case"addeddate":return"Added";default:return"Archived"}}function xo(r){return r?`Archivist since ${r.getFullYear()}`:""}let ye=class extends F{constructor(){super(...arguments),this.sortParam=null,this.collectionLinks=[],this.loggedIn=!1}updated(e){e.has("model")&&this.fetchCollectionNames()}async fetchCollectionNames(){var e,t;if(!(!((e=this.model)===null||e===void 0)&&e.collections)||this.model.collections.length===0||!this.collectionNameCache)return;this.collectionLinks=[];const i=[],a=[];for(const o of this.model.collections)!Na[o]&&!o.startsWith("fav-")&&a.push((t=this.collectionNameCache)===null||t===void 0?void 0:t.collectionNameFor(o).then(n=>{i.push(this.detailsLink(o,n!=null?n:o))}));await Promise.all(a),this.collectionLinks=i}render(){return p`
    ...
    `}};s([h({type:Object})],Et.prototype,"model",void 0);s([h({type:Number})],Et.prototype,"currentWidth",void 0);s([h({type:Object})],Et.prototype,"sortParam",void 0);s([h({type:Number})],Et.prototype,"mobileBreakpoint",void 0);Et=s([R("tile-list-compact-header")],Et);function Ar(r,e,t){return Math.min(t,Math.max(e,r))}let te=class extends F{constructor(){super(...arguments),this.sortParam=null,this.loggedIn=!1,this.showHoverPaneDelay=500,this.hoverPaneShown=!1,this.lastMouseClientPos={x:0,y:0}}render(){const e=this.tileDisplayMode==="grid";return p`
      <div
        id="container"
    ...
    `}get hoverPaneTemplate(){return this.hoverPaneShown?p`<tile-hover-pane
          ...
          .sortParam=${this.sortParam}
          .collectionNameCache=${this.collectionNameCache}
        ></tile-hover-pane>`:x}get hoverPaneDesiredOffsets(){var e;let[t,i]=[0,0];const a=(e=this.hoverPane)===null||e===void 0?void 0:e.getBoundingClientRect();if(a){t=Ar(this.lastMouseClientPos.y-10,10,window.innerHeight-a.height-10),i=Ar(this.lastMouseClientPos.x-10,10,window.innerWidth-a.width-30);const o=this.getBoundingClientRect();t-=o.top,i-=o.left}return{top:t,left:i}}handleResize(e){this.currentWidth=e.contentRect.width,this.currentHeight=e.contentRect.height}disconnectedCallback(){this.stopResizeObservation(this.resizeObserver)}stopResizeObservation(e){e==null||e.removeObserver({handler:this,target:this.container})}startResizeObservation(){var e;this.stopResizeObservation(this.resizeObserver),(e=this.resizeObserver)===null||e===void 0||e.addObserver({handler:this,target:this.container})}updated(e){if(e.has("resizeObserver")){const t=e.get("resizeObserver");this.stopResizeObservation(t),this.startResizeObservation()}}restartHoverPaneTimer(){clearTimeout(this.showHoverPaneTimer),this.showHoverPaneTimer=window.setTimeout(()=>{this.showHoverPane()},this.showHoverPaneDelay)}handleMouseMove(e){this.hoverPaneShown||(this.restartHoverPaneTimer(),this.lastMouseClientPos={x:e.clientX,y:e.clientY})}handleMouseLeave(){clearTimeout(this.showHoverPaneTimer),this.hideHoverPane()}async showHoverPane(){var e;this.hoverPaneShown=!0,await this.updateComplete,await new Promise(t=>{requestAnimationFrame(t)}),this.repositionHoverPane(),(e=this.hoverPane)===null||e===void 0||e.classList.add("visible")}hideHoverPane(){this.hoverPaneShown=!1}repositionHoverPane(){if(!this.hoverPane)return;const{top:e,left:t}=this.hoverPaneDesiredOffsets;this.hoverPane.style.top=`${e}px`,this.hoverPane.style.left=`${t}px`}get tile(){const{model:e,baseNavigationUrl:t,currentWidth:i,currentHeight:a,sortParam:o,mobileBreakpoint:n}=this;if(!e)return x;switch(this.tileDisplayMode){case"grid":switch(e.mediatype){case"collection":return p`<collection-tile
              .model=${e}
              .currentWidth=${i}
              .currentHeight=${a}
            >
  ...
  `;s([h({type:String})],ci.prototype,"selectedLetter",void 0);s([h({type:Object})],ci.prototype,"letterCounts",void 0);ci=s([R("alpha-bar")],ci);const Fr=I`
...
`;let ee=class extends F{constructor(){super(...arguments),this.sortDirection=null,this.selectedSort=L.relevance,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.showRelevance=!0,this.alphaSelectorVisible=null,this.dateSortSelectorVisible=!1,this.viewSortSelectorVisible=!1,this.desktopSelectorBarWidth=0,this.selectorBarContainerWidth=0,this.hoveringOverDateSortOptions=!1,this.boundSortBarSelectorEscapeListener=e=>{e.key==="Escape"&&(this.viewSortSelectorVisible=!1,this.dateSortSelectorVisible=!1)}}render(){return p`
  ...
  `;s([h({type:String})],ee.prototype,"displayMode",void 0);s([h({type:String})],ee.prototype,"sortDirection",void 0);s([h({type:String})],ee.prototype,"selectedSort",void 0);s([h({type:String})],ee.prototype,"selectedTitleFilter",void 0);s([h({type:String})],ee.prototype,"selectedCreatorFilter",void 0);s([h({type:Boolean})],ee.prototype,"showRelevance",void 0);s([h({type:Object})],ee.prototype,"prefixFilterCountMap",void 0);s([h({type:Object})],ee.prototype,"resizeObserver",void 0);s([T()],ee.prototype,"alphaSelectorVisible",void 0);s([T()],ee.prototype,"dateSortSelectorVisible",void 0);s([T()],ee.prototype,"viewSortSelectorVisible",void 0);s([T()],ee.prototype,"desktopSelectorBarWidth",void 0);s([T()],ee.prototype,"selectorBarContainerWidth",void 0);s([T()],ee.prototype,"hoveringOverDateSortOptions",void 0);s([le("#desktop-sort-selector")],ee.prototype,"desktopSortSelector",void 0);s([le("#sort-selector-container")],ee.prototype,"sortSelectorContainer",void 0);ee=s([R("sort-filter-bar")],ee);/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Or=Ri(class extends Bi{constructor(r){if(super(r),r.type!==De.PROPERTY&&r.type!==De.ATTRIBUTE&&r.type!==De.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Cs(r))throw Error("`live` bindings can only contain a single expression")}render(r){return r}update(r,[e]){if(e===ge||e===x)return e;const t=r.element,i=r.name;if(r.type===De.PROPERTY){if(e===t[i])return ge}else if(r.type===De.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(i))return ge}else if(r.type===De.ATTRIBUTE&&t.getAttribute(i)===e+"")return ge;return uo(r),e}});var _o=60,So=_o*60,$o=So*24,Rn=$o*7,At=1e3,ua=_o*At,Ir=So*At,Bn=$o*At,Hn=Rn*At,Ra="millisecond",_t="second",St="minute",$t="hour",Oe="day",Ci="week",we="month",Co="quarter",Ie="year",Ct="date",Un="YYYY-MM-DDTHH:mm:ssZ",Pr="Invalid Date",jn=/^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/,Wn=/\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g,Vn={name:"en",weekdays:"Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),months:"January_February_March_April_May_June_July_August_September_October_November_December".split("_")},Ma=function(e,t,i){var a=String(e);return!a||a.length>=t?e:""+Array(t+1-a.length).join(i)+e},Gn=function(e){var t=-e.utcOffset(),i=Math.abs(t),a=Math.floor(i/60),o=i%60;return(t<=0?"+":"-")+Ma(a,2,"0")+":"+Ma(o,2,"0")},Qn=function r(e,t){if(e.date()<t.date())return-r(t,e);var i=(t.year()-e.year())*12+(t.month()-e.month()),a=e.clone().add(i,we),o=t-a<0,n=e.clone().add(i+(o?-1:1),we);return+(-(i+(t-a)/(o?a-n:n-a))||0)},Yn=function(e){return e<0?Math.ceil(e)||0:Math.floor(e)},Kn=function(e){var t={M:we,y:Ie,w:Ci,d:Oe,D:Ct,h:$t,m:St,s:_t,ms:Ra,Q:Co};return t[e]||String(e||"").toLowerCase().replace(/s$/,"")},qn=function(e){return e===void 0},Xn={s:Ma,z:Gn,m:Qn,a:Yn,p:Kn,u:qn},ti="en",tt={};tt[ti]=Vn;var Ba=function(e){return e instanceof Hi},Oi=function r(e,t,i){var a;if(!e)return ti;if(typeof e=="string"){var o=e.toLowerCase();tt[o]&&(a=o),t&&(tt[o]=t,a=o);var n=e.split("-");if(!a&&n.length>1)return r(n[0])}else{var l=e.name;tt[l]=e,a=l}return!i&&a&&(ti=a),a||!i&&ti},J=function(e,t){if(Ba(e))return e.clone();var i=typeof t=="object"?t:{};return i.date=e,i.args=arguments,new Hi(i)},Zn=function(e,t){return J(e,{locale:t.$L,utc:t.$u,x:t.$x,$offset:t.$offset})},U=Xn;U.l=Oi;U.i=Ba;U.w=Zn;var Jn=function(e){var t=e.date,i=e.utc;if(t===null)return new Date(NaN);if(U.u(t))return new Date;if(t instanceof Date)return new Date(t);if(typeof t=="string"&&!/Z$/i.test(t)){var a=t.match(jn);if(a){var o=a[2]-1||0,n=(a[7]||"0").substring(0,3);return i?new Date(Date.UTC(a[1],o,a[3]||1,a[4]||0,a[5]||0,a[6]||0,n)):new Date(a[1],o,a[3]||1,a[4]||0,a[5]||0,a[6]||0,n)}}return new Date(t)},Hi=function(){function r(t){this.$L=Oi(t.locale,null,!0),this.parse(t)}var e=r.prototype;return e.parse=function(i){this.$d=Jn(i),this.$x=i.x||{},this.init()},e.init=function(){var i=this.$d;this.$y=i.getFullYear(),this.$M=i.getMonth(),this.$D=i.getDate(),this.$W=i.getDay(),this.$H=i.getHours(),this.$m=i.getMinutes(),this.$s=i.getSeconds(),this.$ms=i.getMilliseconds()},e.$utils=function(){return U},e.isValid=function(){return this.$d.toString()!==Pr},e.isSame=function(i,a){var o=J(i);return this.startOf(a)<=o&&o<=this.endOf(a)},e.isAfter=function(i,a){return J(i)<this.startOf(a)},e.isBefore=function(i,a){return this.endOf(a)<J(i)},e.$g=function(i,a,o){return U.u(i)?this[a]:this.set(o,i)},e.unix=function(){return Math.floor(this.valueOf()/1e3)},e.valueOf=function(){return this.$d.getTime()},e.startOf=function(i,a){var o=this,n=U.u(a)?!0:a,l=U.p(i),d=function(E,O){var N=U.w(o.$u?Date.UTC(o.$y,O,E):new Date(o.$y,O,E),o);return n?N:N.endOf(Oe)},c=function(E,O){var N=[0,0,0,0],B=[23,59,59,999];return U.w(o.toDate()[E].apply(o.toDate("s"),(n?N:B).slice(O)),o)},m=this.$W,v=this.$M,f=this.$D,w="set"+(this.$u?"UTC":"");switch(l){case Ie:return n?d(1,0):d(31,11);case we:return n?d(1,v):d(0,v+1);case Ci:{var _=this.$locale().weekStart||0,$=(m<_?m+7:m)-_;return d(n?f-$:f+(6-$),v)}case Oe:case Ct:return c(w+"Hours",0);case $t:return c(w+"Minutes",1);case St:return c(w+"Seconds",2);case _t:return c(w+"Milliseconds",3);default:return this.clone()}},e.endOf=function(i){return this.startOf(i,!1)},e.$set=function(i,a){var o,n=U.p(i),l="set"+(this.$u?"UTC":""),d=(o={},o[Oe]=l+"Date",o[Ct]=l+"Date",o[we]=l+"Month",o[Ie]=l+"FullYear",o[$t]=l+"Hours",o[St]=l+"Minutes",o[_t]=l+"Seconds",o[Ra]=l+"Milliseconds",o)[n],c=n===Oe?this.$D+(a-this.$W):a;if(n===we||n===Ie){var m=this.clone().set(Ct,1);m.$d[d](c),m.init(),this.$d=m.set(Ct,Math.min(this.$D,m.daysInMonth())).$d}else d&&this.$d[d](c);return this.init(),this},e.set=function(i,a){return this.clone().$set(i,a)},e.get=function(i){return this[U.p(i)]()},e.add=function(i,a){var o=this,n;i=Number(i);var l=U.p(a),d=function(f){var w=J(o);return U.w(w.date(w.date()+Math.round(f*i)),o)};if(l===we)return this.set(we,this.$M+i);if(l===Ie)return this.set(Ie,this.$y+i);if(l===Oe)return d(1);if(l===Ci)return d(7);var c=(n={},n[St]=ua,n[$t]=Ir,n[_t]=At,n)[l]||1,m=this.$d.getTime()+i*c;return U.w(m,this)},e.subtract=function(i,a){return this.add(i*-1,a)},e.format=function(i){var a=this,o=this.$locale();if(!this.isValid())return o.invalidDate||Pr;var n=i||Un,l=U.z(this),d=this.$H,c=this.$m,m=this.$M,v=o.weekdays,f=o.months,w=o.meridiem,_=function(N,B,Y,oe){return N&&(N[B]||N(a,n))||Y[B].slice(0,oe)},$=function(N){return U.s(d%12||12,N,"0")},D=w||function(O,N,B){var Y=O<12?"AM":"PM";return B?Y.toLowerCase():Y},E={YY:String(this.$y).slice(-2),YYYY:this.$y,M:m+1,MM:U.s(m+1,2,"0"),MMM:_(o.monthsShort,m,f,3),MMMM:_(f,m),D:this.$D,DD:U.s(this.$D,2,"0"),d:String(this.$W),dd:_(o.weekdaysMin,this.$W,v,2),ddd:_(o.weekdaysShort,this.$W,v,3),dddd:v[this.$W],H:String(d),HH:U.s(d,2,"0"),h:$(1),hh:$(2),a:D(d,c,!0),A:D(d,c,!1),m:String(c),mm:U.s(c,2,"0"),s:String(this.$s),ss:U.s(this.$s,2,"0"),SSS:U.s(this.$ms,3,"0"),Z:l};return n.replace(Wn,function(O,N){return N||E[O]||l.replace(":","")})},e.utcOffset=function(){return-Math.round(this.$d.getTimezoneOffset()/15)*15},e.diff=function(i,a,o){var n,l=U.p(a),d=J(i),c=(d.utcOffset()-this.utcOffset())*ua,m=this-d,v=U.m(this,d);return v=(n={},n[Ie]=v/12,n[we]=v,n[Co]=v/3,n[Ci]=(m-c)/Hn,n[Oe]=(m-c)/Bn,n[$t]=m/Ir,n[St]=m/ua,n[_t]=m/At,n)[l]||m,o?v:U.a(v)},e.daysInMonth=function(){return this.endOf(we).$D},e.$locale=function(){return tt[this.$L]},e.locale=function(i,a){if(!i)return this.$L;var o=this.clone(),n=Oi(i,a,!0);return n&&(o.$L=n),o},e.clone=function(){return U.w(this.$d,this)},e.toDate=function(){return new Date(this.valueOf())},e.toJSON=function(){return this.isValid()?this.toISOString():null},e.toISOString=function(){return this.$d.toISOString()},e.toString=function(){return this.$d.toUTCString()},r}(),ko=Hi.prototype;J.prototype=ko;[["$ms",Ra],["$s",_t],["$m",St],["$H",$t],["$W",Oe],["$M",we],["$y",Ie],["$D",Ct]].forEach(function(r){ko[r[1]]=function(e){return this.$g(e,r[0],r[1])}});J.extend=function(r,e){return r.$i||(r(e,Hi,J),r.$i=!0),J};J.locale=Oi;J.isDayjs=Ba;J.unix=function(r){return J(r*1e3)};J.en=tt[ti];J.Ls=tt;J.p={};var el=function(e){return e.replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g,function(t,i,a){return i||a.slice(1)})},tl={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"},il=function(e,t){return e.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g,function(i,a,o){var n=o&&o.toUpperCase();return a||t[o]||tl[o]||el(t[n])})},al=/(\[[^[]*\])|([-:/.()\s]+)|(A|a|YYYY|YY?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g,rl=/\d/,wi=/\d\d/,ol=/\d{3}/,sl=/\d{4}/,$e=/\d\d?/,nl=/[+-]?\d+/,ll=/[+-]\d\d:?(\d\d)?|Z/,Xt=/\d*[^\s\d-_:/()]+/,Ne={},To=function(e){return e=+e,e+(e>68?1900:2e3)};function dl(r){if(!r||r==="Z")return 0;var e=r.match(/([+-]|\d\d)/g),t=+(e[1]*60)+(+e[2]||0);return t===0?0:e[0]==="+"?-t:t}var fe=function(e){return function(t){this[e]=+t}},Nr=[ll,function(r){var e=this.zone||(this.zone={});e.offset=dl(r)}],pa=function(e){var t=Ne[e];return t&&(t.indexOf?t:t.s.concat(t.f))},Rr=function(e,t){var i,a=Ne,o=a.meridiem;if(!o)i=e===(t?"pm":"PM");else for(var n=1;n<=24;n+=1)if(e.indexOf(o(n,0,t))>-1){i=n>12;break}return i},cl={A:[Xt,function(r){this.afternoon=Rr(r,!1)}],a:[Xt,function(r){this.afternoon=Rr(r,!0)}],S:[rl,function(r){this.milliseconds=+r*100}],SS:[wi,function(r){this.milliseconds=+r*10}],SSS:[ol,function(r){this.milliseconds=+r}],s:[$e,fe("seconds")],ss:[$e,fe("seconds")],m:[$e,fe("minutes")],mm:[$e,fe("minutes")],H:[$e,fe("hours")],h:[$e,fe("hours")],HH:[$e,fe("hours")],hh:[$e,fe("hours")],D:[$e,fe("day")],DD:[wi,fe("day")],Do:[Xt,function(r){var e=Ne,t=e.ordinal,i=r.match(/\d+/);if(this.day=i[0],!!t)for(var a=1;a<=31;a+=1)t(a).replace(/\[|\]/g,"")===r&&(this.day=a)}],M:[$e,fe("month")],MM:[wi,fe("month")],MMM:[Xt,function(r){var e=pa("months"),t=pa("monthsShort"),i=(t||e.map(function(a){return a.slice(0,3)})).indexOf(r)+1;if(i<1)throw new Error;this.month=i%12||i}],MMMM:[Xt,function(r){var e=pa("months"),t=e.indexOf(r)+1;if(t<1)throw new Error;this.month=t%12||t}],Y:[nl,fe("year")],YY:[wi,function(r){this.year=To(r)}],YYYY:[sl,fe("year")],Z:Nr,ZZ:Nr};function hl(r){var e=r.afternoon;if(e!==void 0){var t=r.hours;e?t<12&&(r.hours+=12):t===12&&(r.hours=0),delete r.afternoon}}function ul(r){r=il(r,Ne&&Ne.formats);for(var e=r.match(al),t=e.length,i=0;i<t;i+=1){var a=e[i],o=cl[a],n=o&&o[0],l=o&&o[1];l?e[i]={regex:n,parser:l}:e[i]=a.replace(/^\[|\]$/g,"")}return function(d){for(var c={},m=0,v=0;m<t;m+=1){var f=e[m];if(typeof f=="string")v+=f.length;else{var w=f.regex,_=f.parser,$=d.slice(v),D=w.exec($),E=D[0];_.call(c,E),d=d.replace(E,"")}}return hl(c),c}}var pl=function(e,t,i){try{if(["x","X"].indexOf(t)>-1)return new Date((t==="X"?1e3:1)*e);var a=ul(t),o=a(e),n=o.year,l=o.month,d=o.day,c=o.hours,m=o.minutes,v=o.seconds,f=o.milliseconds,w=o.zone,_=new Date,$=d||(!n&&!l?_.getDate():1),D=n||_.getFullYear(),E=0;n&&!l||(E=l>0?l-1:_.getMonth());var O=c||0,N=m||0,B=v||0,Y=f||0;return w?new Date(Date.UTC(D,E,$,O,N,B,Y+w.offset*60*1e3)):i?new Date(Date.UTC(D,E,$,O,N,B,Y)):new Date(D,E,$,O,N,B,Y)}catch{return new Date("")}},ml=function(r,e,t){t.p.customParseFormat=!0,r&&r.parseTwoDigitYear&&(To=r.parseTwoDigitYear);var i=e.prototype,a=i.parse;i.parse=function(o){var n=o.date,l=o.utc,d=o.args;this.$u=l;var c=d[1];if(typeof c=="string"){var m=d[2]===!0,v=d[3]===!0,f=m||v,w=d[2];v&&(w=d[2]),Ne=this.$locale(),!m&&w&&(Ne=t.Ls[w]),this.$d=pl(n,c,l),this.init(),w&&w!==!0&&(this.$L=this.locale(w).$L),f&&n!=this.format(c)&&(this.$d=new Date("")),Ne={}}else if(c instanceof Array)for(var _=c.length,$=1;$<=_;$+=1){d[1]=c[$-1];var D=t.apply(this,d);if(D.isValid()){this.$d=D.$d,this.$L=D.$L,this.init();break}$===_&&(this.$d=new Date(""))}else a.call(this,o)}};const vl=Object.freeze({processing:"processing",complete:"complete"});class fl extends F{static get properties(){return{mode:{type:String}}}constructor(){super(),this.mode=vl.processing}render(){return p`
      <div class="${this.mode}">
        <svg
          viewBox="0 0 120 120"
    ...
    `}get selectedRangeTemplate(){return I`
      ...
      />`}get histogramTemplate(){const e=this._histWidth/this._numBins,t=e-1;let i=this.sliderWidth;return this._histData.map(a=>{const o=I`
        ...
        />`;return i+=e,o})}formatDate(e){if(Number.isNaN(e))return"";const t=J(e);return t.year()<1e3?String(t.year()):t.format(this.dateFormat)}get minInputTemplate(){return p`
      <input
        id="date-min"
...
`;let X=class extends F{constructor(){super(...arguments),this.prompt="Do you find this feature useful?",this.buttonText="Beta",this.isOpen=!1,this.processing=!1,this.popupTopX=0,this.popupTopY=0,this.voteSubmitted=!1,this.voteNeedsChoosing=!1,this.resizingElement=document.body}render(){return p`
      <button
        id="beta-button"
    ...
    `}};s([h({type:String})],X.prototype,"featureIdentifier",void 0);s([h({type:String})],X.prototype,"prompt",void 0);s([h({type:String})],X.prototype,"buttonText",void 0);s([h({type:Object})],X.prototype,"recaptchaManager",void 0);s([h({type:Object})],X.prototype,"resizeObserver",void 0);s([h({type:Boolean})],X.prototype,"disabled",void 0);s([h({type:Object})],X.prototype,"featureFeedbackService",void 0);s([le("#beta-button")],X.prototype,"betaButton",void 0);s([le("#popup")],X.prototype,"popup",void 0);s([T()],X.prototype,"isOpen",void 0);s([T()],X.prototype,"processing",void 0);s([T()],X.prototype,"popupTopX",void 0);s([T()],X.prototype,"popupTopY",void 0);s([T()],X.prototype,"vote",void 0);s([T()],X.prototype,"voteSubmitted",void 0);s([T()],X.prototype,"error",void 0);s([T()],X.prototype,"voteNeedsChoosing",void 0);s([T()],X.prototype,"recaptchaWidget",void 0);s([le("#comments")],X.prototype,"comments",void 0);X=s([R("feature-feedback")],X);class zo{constructor(e){var t,i,a,o,n,l,d;this.title=e==null?void 0:e.title,this.subtitle=e==null?void 0:e.subtitle,this.headline=e==null?void 0:e.headline,this.message=e==null?void 0:e.message,this.headerColor=(t=e==null?void 0:e.headerColor)!==null&&t!==void 0?t:"#55A183",this.bodyColor=(i=e==null?void 0:e.bodyColor)!==null&&i!==void 0?i:"#f5f5f7",this.showProcessingIndicator=(a=e==null?void 0:e.showProcessingIndicator)!==null&&a!==void 0?a:!1,this.processingImageMode=(o=e==null?void 0:e.processingImageMode)!==null&&o!==void 0?o:"complete",this.showCloseButton=(n=e==null?void 0:e.showCloseButton)!==null&&n!==void 0?n:!0,this.showHeaderLogo=(l=e==null?void 0:e.showHeaderLogo)!==null&&l!==void 0?l:!0,this.closeOnBackdropClick=(d=e==null?void 0:e.closeOnBackdropClick)!==null&&d!==void 0?d:!0}}var Ol=p`
<svg
  viewBox="0 0 40 40"
  version="1.1"
  xmlns="http://www.w3.org/2000/svg"
...
`;let Da=class extends F{constructor(){super(...arguments),this.config=new zo}render(){return p`
      <div class="modal-wrapper">
        <div class="modal-container">
          <header style="background-color: ${this.config.headerColor}">
            ...
            ${this.config.showHeaderLogo?p`<div class="logo-icon">${Il}</div>`:x}
    ...
    `}static get styles(){const e=y`var(--modalLogoSize, 6.5rem)`,t=y`var(--processingImageSize, 7.5rem)`,i=y`var(--modalCornerRadius, 1rem)`,a=y`var(--modalBorder, 2px solid black)`,o=y`var(--modalBottomMargin, 2.5rem)`,n=y`var(--modalTopMargin, 5rem)`,l=y`var(--modalHeaderBottomPadding, 0.5em)`,d=y`var(--modalBottomPadding, 2rem)`,c=y`var(--modalScrollOffset, 5px)`,m=y`var(--modalTitleFontSize, 1.8rem)`,v=y`var(--modalSubtitleFontSize, 1.4rem)`,f=y`var(--modalHeadlineFontSize, 1.6rem)`,w=y`var(--modalMessageFontSize, 1.4rem)`,_=y`var(--modalTitleLineHeight, normal)`,$=y`var(--modalSubtitleLineHeight, normal)`,D=y`var(--modalHeadlineLineHeight, normal)`,E=y`var(--modalMessageLineHeight, normal)`;return y`
      .processing-logo {
        margin: auto;
        width: ${t};
        height: ${t};
...
`;let Ft=class extends F{constructor(){super(...arguments),this.step=2,this.currentPage=1,this.pages=[]}firstUpdated(){this.observePageCount()}updated(e){e.has("size")&&this.observePageCount(),e.has("currentPage")&&(this.observePageCount(),this.emitPageClick())}observePageCount(){this.pages=[];const e=7,t=this.size<=e;if(this.size<=5){this.pages=[...Array(this.size).keys()].map(o=>o+1);return}if(this.size===e){if(this.currentPage===2){this.pages=[1,2,3,4,0,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,4,5,this.size-1,this.size];return}}if(this.currentPage===1){this.pages=[1,2,3,0,this.size];return}if(this.currentPage===this.size){this.pages=[1,0,this.size-2,this.size-1,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,this.size-3,this.size-2,this.size-1,this.size];return}if(t&&this.currentPage>1&&this.currentPage<e){this.pages=[...Array(this.size).keys()].map(o=>o+1);return}let i=this.currentPage-this.step,a=this.currentPage+this.step;i<=0&&(a+=-i+1,i=1),a>=this.size&&(i=Math.max(i-(a-this.size),1),a=this.size),i===2&&(a-=1),a===this.size-1&&(i+=1),this.createFirstNode(i),this.createMiddelNode(i,a),this.createLastNode(a)}createFirstNode(e){var t,i;e>1&&((t=this.pages)===null||t===void 0||t.push(1)),e>2&&((i=this.pages)===null||i===void 0||i.push(0))}createMiddelNode(e,t){var i;for(let a=e;a<=t;a+=1)(i=this.pages)===null||i===void 0||i.push(a)}createLastNode(e){var t,i;e<this.size-1&&((t=this.pages)===null||t===void 0||t.push(0)),e<this.size&&((i=this.pages)===null||i===void 0||i.push(this.size))}get getEllipsisTemplate(){return p`<i class="ellipses">...</i>`}emitPageClick(){this.dispatchEvent(new CustomEvent("pageNumberClicked",{detail:{page:this.currentPage},bubbles:!0,composed:!0}))}onRewind(){this.currentPage-=1,this.currentPage<1&&(this.currentPage=1)}onForward(){this.currentPage+=1,this.currentPage>this.size&&(this.currentPage=this.size)}onChange(e){this.currentPage=e}getPageTemplate(e){return p`
    ...
    `}};s([h({type:Number})],Ft.prototype,"size",void 0);s([h({type:Number})],Ft.prototype,"step",void 0);s([h({type:Number})],Ft.prototype,"currentPage",void 0);s([T()],Ft.prototype,"pages",void 0);Ft=s([R("more-facets-pagination")],Ft);var Hl=I`
...
`;let Ot=class extends F{facetClicked(e,t,i){const a=e.target,{checked:o,name:n,value:l}=a;o?this.facetChecked(n,l,t,i):this.facetUnchecked(n,l)}facetChecked(e,t,i,a){const{selectedFacets:o}=this;let n;o?n=ce({},o):n=Li,n[e][t]={state:a?"hidden":"selected",count:i},this.selectedFacets=n,this.dispatchSelectedFacetsChanged()}facetUnchecked(e,t){const{selectedFacets:i}=this;let a;i?a=ce({},i):a=Li,delete a[e][t],this.selectedFacets=a,this.dispatchSelectedFacetsChanged()}dispatchSelectedFacetsChanged(){const e=new CustomEvent("selectedFacetsChanged",{detail:this.selectedFacets,bubbles:!0,composed:!0});this.dispatchEvent(e)}getFacetsTemplate(e){let t=e==null?void 0:e.buckets;return t=[...t.filter(i=>i.state==="selected").sort((i,a)=>i.count<a.count?1:-1),...t.filter(i=>i.state==="hidden").sort((i,a)=>i.count<a.count?1:-1),...t.filter(i=>i.state==="none")],p`
      <div class="facets-on-${this.renderOn}">
        ${po(t,i=>`${e.key}:${i.key}`,i=>{var a,o;const n=`${e.key}:${i.key}-show-only`,l=`${e.key}:${i.key}-negative`,d=e.key!=="collection"?p`${(a=i.displayText)!==null&&a!==void 0?a:i.key}`:p`<a href="/details/${i.key}">
                    <async-collection-name
                      ...
                      placeholder="-"
                    ></async-collection-name>
                  </a> `,c=i.state==="hidden",m=i.state==="selected",v=`${e.key}: ${(o=i.displayText)!==null&&o!==void 0?o:i.key}`,f=m?`Show all ${e.key}s`:`Only show ${v}`,w=`Hide ${v}`,_=`Unhide ${v}`,$=c?_:w;return p`
              <div class="facet-row">
    ...
    `}};s([h({type:String})],Z.prototype,"facetKey",void 0);s([h({type:String})],Z.prototype,"facetAggregationKey",void 0);s([h({type:String})],Z.prototype,"query",void 0);s([h({type:Object})],Z.prototype,"filterMap",void 0);s([h({type:Object})],Z.prototype,"modalManager",void 0);s([h({type:Object})],Z.prototype,"searchService",void 0);s([h({type:String})],Z.prototype,"searchType",void 0);s([h({type:Object})],Z.prototype,"collectionNameCache",void 0);s([h({type:Object})],Z.prototype,"languageCodeHandler",void 0);s([h({type:Object})],Z.prototype,"selectedFacets",void 0);s([h({type:String})],Z.prototype,"sortedBy",void 0);s([h({type:Object,attribute:!1})],Z.prototype,"analyticsHandler",void 0);s([T()],Z.prototype,"aggregations",void 0);s([T()],Z.prototype,"facetGroup",void 0);s([T()],Z.prototype,"facetGroupTitle",void 0);s([T()],Z.prototype,"pageNumber",void 0);s([T()],Z.prototype,"facetsLoading",void 0);s([T()],Z.prototype,"paginationSize",void 0);s([T()],Z.prototype,"facetsType",void 0);Z=s([R("more-facets-content")],Z);let Gr=class extends F{render(){return p`
      <div id="row">
    ...
    `}updated(e){e.has("selectedFacets")&&this.dispatchFacetsChangedEvent()}dispatchFacetsChangedEvent(){const e=new CustomEvent("facetsChanged",{detail:this.selectedFacets});this.dispatchEvent(e)}get currentYearsHistogramAggregation(){var e;return(e=this.aggregations)===null||e===void 0?void 0:e.year_histogram}get histogramTemplate(){const{fullYearsHistogramAggregation:e}=this;return this.fullYearAggregationLoading?p`<div class="histogram-loading-indicator">&hellip;</div>`:p`
          ...
          ></histogram-date-range>
        `}histogramDateRangeUpdated(e){const{minDate:t,maxDate:i}=e.detail,a=new CustomEvent("histogramDateRangeUpdated",{detail:{minDate:t,maxDate:i}});this.dispatchEvent(a)}get mergedFacets(){const e=[];return Fn.forEach(t=>{var i,a;const o=this.selectedFacetGroups.find(m=>m.key===t),n=this.aggregationFacetGroups.find(m=>m.key===t);if(o&&!n){e.push(o);return}if(!n)return;const l=o!=null?o:n;let d=(i=o==null?void 0:o.buckets.map(m=>{const v=n.buckets.find(f=>f.key===m.key);return v?gt(ce({},m),{count:v.count}):m}))!==null&&i!==void 0?i:[];n.buckets.forEach(m=>{d.find(f=>f.key===m.key)||d.push(m)}),t==="lending"&&(d=d.filter(m=>On[m.key]));let c=(a=Object.keys((o==null?void 0:o.buckets)||[]))===null||a===void 0?void 0:a.length;c<this.allowedFacetCount&&(c=this.allowedFacetCount),l.buckets=d.splice(0,c),e.push(l)}),e}get selectedFacetGroups(){return this.selectedFacets?Object.entries(this.selectedFacets).map(([t,i])=>{const a=t,o=Fi[a],n=Object.entries(i).map(([l,d])=>{var c,m,v;let f=l;return a==="language"&&(f=(m=(c=this.languageCodeHandler)===null||c===void 0?void 0:c.getLanguageNameFromCodeString(l))!==null&&m!==void 0?m:l),a==="lending"&&(f=(v=Er[l])!==null&&v!==void 0?v:l),{displayText:f,key:l,count:d.count,state:d.state}});return{title:o,key:a,buckets:n}}):[]}get aggregationFacetGroups(){var e;const t=[];return Object.entries((e=this.aggregations)!==null&&e!==void 0?e:[]).forEach(([i,a])=>{if(i==="year_histogram")return;const o=i,n=Fi[o];if(!n)return;let l=a.buckets;o==="collection"&&(l=l==null?void 0:l.filter(m=>{var v;const f=(v=m==null?void 0:m.key)===null||v===void 0?void 0:v.toString();return!Na[f]&&!(f!=null&&f.startsWith("fav-"))}));const d=l.map(m=>{var v,f,w;let _=m.key,$=`${m.key}`;return o==="language"&&(_=(f=(v=this.languageCodeHandler)===null||v===void 0?void 0:v.getCodeStringFromLanguageName(`${m.key}`))!==null&&f!==void 0?f:m.key),o==="lending"&&($=(w=Er[m.key])!==null&&w!==void 0?w:`${m.key}`),{displayText:$,key:`${_}`,count:m.doc_count,state:"none"}}),c={title:n,key:o,buckets:d};t.push(c)}),t}getFacetGroupTemplate(e){if(!this.facetsLoading&&e.buckets.length===0)return x;const{key:t}=e,i=this.openFacets[t],a=p`
...
`;let Pi=class extends F{constructor(){super(...arguments),this.placeholderType=null}render(){return this.placeholderType?p`${this.placeholderTemplate}`:x}get placeholderTemplate(){return p`
      <div
