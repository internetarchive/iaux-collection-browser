 ...
 */const Cr=(r,e,t)=>{const i=new Map;for(let a=e;a<=t;a++)i.set(r[a],a);return i},mo=Ui(class extends ji{constructor(r){if(super(r),r.type!==Le.CHILD)throw Error("repeat() can only be used in text expressions")}dt(r,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);const a=[],o=[];let s=0;for(const l of r)a[s]=i?i(l,s):s,o[s]=t(l,s),s++;return{values:o,keys:a}}render(r,e,t){return this.dt(r,e,t).values}update(r,[e,t,i]){var a;const o=Ms(r),{values:s,keys:l}=this.dt(e,t,i);if(!Array.isArray(o))return this.ut=l,s;const d=(a=this.ut)!==null&&a!==void 0?a:this.ut=[],c=[];let v,m,f=0,w=o.length-1,_=0,$=s.length-1;for(;f<=w&&_<=$;)if(o[f]===null)f++;else if(o[w]===null)w--;else if(d[f]===l[_])c[_]=Ze(o[f],s[_]),f++,_++;else if(d[w]===l[$])c[$]=Ze(o[w],s[$]),w--,$--;else if(d[f]===l[$])c[$]=Ze(o[f],s[$]),Xt(r,c[$+1],o[f]),f++,$--;else if(d[w]===l[_])c[_]=Ze(o[w],s[_]),Xt(r,o[f],o[w]),w--,_++;else if(v===void 0&&(v=Cr(l,_,$),m=Cr(d,f,w)),v.has(d[f]))if(v.has(d[w])){const E=m.get(l[_]),D=E!==void 0?o[E]:null;if(D===null){const P=Xt(r,o[f]);Ze(P,s[_]),c[_]=P}else c[_]=Ze(D,s[_]),Xt(r,o[f],D),o[E]=null;_++}else na(o[w]),w--;else na(o[f]),f++;for(;_<=$;){const E=Xt(r,c[$+1]);Ze(E,s[_]),c[_++]=E}for(;f<=w;){const E=o[f++];E!==null&&na(E)}return this.ut=l,vo(r,c),ge}});function bi(r,e,t){return Array.from({length:(e-r)/t+1},(i,a)=>r+a*t)}let Ue=class extends F{constructor(){super(...arguments),this.itemCount=0,this.scrollOptimizationsDisabled=!1,this.intersectionObserver=new IntersectionObserver(e=>{e.forEach(t=>{if(t.target===this.sentinel){t.isIntersecting&&this.dispatchEvent(new Event("scrollThresholdReached"));return}const a=t.target.dataset.cellIndex;if(!a)return;const o=parseInt(a,10);t.isIntersecting?this.visibleCellIndices.add(o):this.visibleCellIndices.delete(o)}),this.scrollOptimizationsDisabled||this.processVisibleCells()}),this.renderedCellIndices=new Set,this.visibleCellIndices=new Set,this.placeholderCellIndices=new Set}reload(){bi(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.removeCell(t)),this.renderedCellIndices.clear(),this.visibleCellIndices.clear(),this.placeholderCellIndices.clear(),this.setupObservations()}scrollToCell(e,t){const i=this.cellContainers[e];if(!i)return!1;const a=t?"smooth":"auto";return i.scrollIntoView({behavior:a}),!0}getVisibleCellIndices(){return Array.from(this.visibleCellIndices)}updated(e){(e.has("itemCount")||e.has("scrollOptimizationsDisabled"))&&this.setupObservations()}disconnectedCallback(){this.intersectionObserver.disconnect()}setupObservations(){this.setupIntersectionObserver()}setupIntersectionObserver(){this.intersectionObserver.disconnect(),this.sentinel&&this.intersectionObserver.observe(this.sentinel),this.scrollOptimizationsDisabled?(bi(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.visibleCellIndices.add(t)),this.processVisibleCells()):this.cellContainers.forEach(e=>this.intersectionObserver.observe(e))}render(){const e=this.itemCount-1,t=bi(0,e,1);return p`
    ...
    `}};n([h({type:Number})],Ue.prototype,"itemCount",void 0);n([h({type:Object})],Ue.prototype,"cellProvider",void 0);n([h({type:Object})],Ue.prototype,"placeholderCellTemplate",void 0);n([h({type:Boolean})],Ue.prototype,"scrollOptimizationsDisabled",void 0);n([le("#sentinel")],Ue.prototype,"sentinel",void 0);n([_s(".cell-container")],Ue.prototype,"cellContainers",void 0);Ue=n([R("infinite-scroller")],Ue);const fo=O`
...
`;let di=class extends F{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1,this.isCompactTile=!1}render(){return p`<div class="icon-overlay ${this.getClass}">
      ${this.iconDisplay}
    </div>`}get getClass(){return this.isCompactTile?"list-compact":"list-detail"}get iconDisplay(){return this.loginRequired&&!this.loggedIn?p`${yo}`:p`${go}`}static get styles(){return g`
      :host {
        position: absolute;
        top: 50%;
        left: 50%;
    ...
    `}};n([h({type:Boolean})],di.prototype,"loggedIn",void 0);n([h({type:Boolean})],di.prototype,"loginRequired",void 0);n([h({type:Boolean})],di.prototype,"isCompactTile",void 0);di=n([R("icon-overlay")],di);let ci=class extends F{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1,this.iconRequired=!1}render(){return p`
      <div class="overlay no-preview">
        <div class="icon-overlay">${this.iconDisplay}</div>
        <p class="text-overlay">${this.textDisplay}</p>
      </div>
    `}get iconDisplay(){return this.loginRequired&&!this.loggedIn?p`${yo}`:p`${go}`}get textDisplay(){return this.loginRequired&&!this.loggedIn?p`Log in to view this item`:p`Content may be inappropriate`}static get styles(){return g`
      :host {
        align-items: center;
        display: flex;
      }
    ...
    `}};n([h({type:Boolean})],ci.prototype,"loggedIn",void 0);n([h({type:Boolean})],ci.prototype,"loginRequired",void 0);n([h({type:Boolean})],ci.prototype,"iconRequired",void 0);ci=n([R("text-overlay")],ci);let je=class extends F{constructor(){super(...arguments),this.isCompactTile=!1,this.isListTile=!1,this.loggedIn=!1,this.viewSize="desktop"}render(){var e;return!((e=this.model)===null||e===void 0)&&e.identifier?p`
    ...
    `}};n([h({type:String})],je.prototype,"baseImageUrl",void 0);n([h({type:Boolean})],je.prototype,"isCompactTile",void 0);n([h({type:Boolean})],je.prototype,"isListTile",void 0);n([h({type:Boolean})],je.prototype,"loggedIn",void 0);n([h({type:Object})],je.prototype,"model",void 0);n([h({type:String})],je.prototype,"viewSize",void 0);je=n([R("image-block")],je);let Di=class extends F{render(){return p`
      <div class="container">
    ...
    >`}get getSizeTemplate(){var e,t;const i=(t=(e=this.model)===null||e===void 0?void 0:e.collectionSize)!==null&&t!==void 0?t:0;return i?p`<span id="item-size">${zs(i,1)}</span>`:""}static get styles(){const e=g`var(--tileBorderColor, #555555)`,t=g`var(--tileBackgroundColor, #666666)`,i=g`#fff`;return[Ba,g`
        .container {
          background-color: ${t};
          border: 1px solid ${e};
        }
      ...
      `]}};n([h({type:Object})],Di.prototype,"model",void 0);n([h({type:String})],Di.prototype,"baseImageUrl",void 0);Di=n([R("collection-tile")],Di);function Li(r,e="short",t="en-US"){if(!r)return"";const i={timeZone:"UTC"};switch(e){case"short":i.month="short",i.year="numeric";break;case"long":i.year="numeric",i.month="short",i.day="2-digit";break}return new Intl.DateTimeFormat(t,i).format(r)}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*$i(r,e){const t=typeof e=="function";if(r!==void 0){let i=-1;for(const a of r)i>-1&&(yield t?e(i):e),i++,yield a}}let Ai=class extends F{constructor(){super(...arguments),this.snippets=[],this.viewSize="desktop"}render(){var e;return!((e=this.snippets)===null||e===void 0)&&e.length?p`
      <div class="container">
    ...
    `:p`${x}`}get ellipsisJoinedSnippets(){return p`
      &hellip; ${$i(this.snippetTemplates,p` &hellip; `)} &hellip;
    `}get snippetTemplates(){var e;return(e=this.snippets)===null||e===void 0?void 0:e.map(t=>{const i=t.matchAll(/{{{(.+?)}}}/gs),a=[];let o=0;for(const s of i)s.index!=null&&(a.push(p`
            ${t.slice(o,s.index)}
            <mark>${s[1]}</mark>
          `),o=s.index+s[0].length);return a.push(p`${t.slice(o)}`),p`<span>${a}</span>`})}static get styles(){return g`
      .container {
        display: flex;
        flex-direction: row;
        flex-wrap: wrap;
    ...
    `}};n([h({type:Array})],Ai.prototype,"snippets",void 0);n([h({type:String})],Ai.prototype,"viewSize",void 0);Ai=n([R("text-snippet-block")],Ai);const Ls=g`
  .drop-shadow {
    overflow: hidden;
    height: 100%;
  }
...
`;let Fe=class extends F{constructor(){super(...arguments),this.isListTile=!1,this.isCompactTile=!1,this.loggedIn=!1,this.isWaveform=!1}render(){return p`
...
`,Vs={account:{color:"#000000",icon:Fs,text:"Account"},audio:{color:"#00adef",icon:Ps,text:"Audio"},collection:{color:"#4666ff",icon:fo,text:"Collection"},data:{color:"#333333",icon:Os,text:"Data"},etree:{color:"#00adef",icon:Is,text:"E-tree"},film:{color:"#bf1b2c",icon:kr,text:"Film"},image:{color:"#aa99c9",icon:Ns,text:"Image"},movies:{color:"#f1644b",icon:kr,text:"Movie"},radio:{color:"#8fdaef",icon:Rs,text:"Radio"},software:{color:"#9ecc4f",icon:Bs,text:"Software"},texts:{color:"#faab3c",icon:Hs,text:"Text"},tv:{color:"#f1644b",icon:Us,text:"TV"},video:{color:"#f1644b",icon:js,text:"Video"},web:{color:"#ffcd27",icon:Ws,text:"Web"}};let hi=class extends F{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var e,t;const i=["tvnews","tvarchive","television"],a=["radio","radioprogram"];return this.mediatype==="movies"&&((e=this.collections)===null||e===void 0?void 0:e.some(o=>i.indexOf(o)>=0))?"tv":this.mediatype==="audio"&&((t=this.collections)===null||t===void 0?void 0:t.some(o=>a.indexOf(o)>=0))?"radio":this.mediatype||""}render(){const e=Vs[this.displayMediatype];return e?p`
    ...
    `}};n([h({type:String})],hi.prototype,"mediatype",void 0);n([h({type:Array})],hi.prototype,"collections",void 0);n([h({type:Boolean})],hi.prototype,"showText",void 0);hi=n([R("mediatype-icon")],hi);const Gs=O`
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let xt=Js;function an(r,e){let t=1;return r>=1e9?t=1e9:r>=1e6?t=1e6:r>=1e3&&e==="short"&&(t=1e3),t}function rn(r=0,e){const t=r/e,i=t<10;let a=0;return i?a=Math.round((t+Number.EPSILON)*10)/10:a=Math.round(t),a}function on(r,e,t,i){switch(e){case 1e9:return xt(t==="short"?wt`${r}B`:wt`${r} billion`);case 1e6:return xt(t==="short"?wt`${r}M`:wt`${r} million`);case 1e3:return xt(t==="short"?wt`${r}K`:wt`${r} thousand`);default:return new Intl.NumberFormat(i).format(r)}}function ti(r,e="long",t="short",i="en-US"){const a=r!=null?r:-1;if(a<0)return"";const o=an(a,e),s=rn(a,o);return on(s,o,t,i)}let st=class extends F{render(){const e=ti(this.favCount,"short","short"),t=ti(this.commentCount,"short","short"),i=this.mediatype==="account"?`${this.itemCount} uploads`:`${this.viewCount} all-time views`;return p`
    ...
    `}get doesSortedByDate(){var e;return["date","reviewdate","addeddate","publicdate"].includes((e=this.sortParam)===null||e===void 0?void 0:e.field)}get hasSnippets(){var e,t;return!!(!((t=(e=this.model)===null||e===void 0?void 0:e.snippets)===null||t===void 0)&&t.length)}static get styles(){const e=g`var(--tileBorderColor, #dddddd)`;return[Ba,g`
      ...
      `]}};n([h({type:String})],At.prototype,"baseImageUrl",void 0);n([h({type:Boolean})],At.prototype,"loggedIn",void 0);n([h({type:Object})],At.prototype,"model",void 0);n([h({type:Object})],At.prototype,"sortParam",void 0);At=n([R("item-tile")],At);let Fi=class extends F{render(){return p`
      <div class="container">
        <div class="tile-details">
          <div class="item-info">
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class ka extends ji{constructor(e){if(super(e),this.it=x,e.type!==Le.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===x||e==null)return this.ft=void 0,this.it=e;if(e===ge)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this.ft;this.it=e;const t=[e];return t.raw=t,this.ft={_$litType$:this.constructor.resultType,strings:t,values:[]}}}ka.directiveName="unsafeHTML",ka.resultType=1;const sn=Ui(ka);/*! @license DOMPurify 2.3.8 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/2.3.8/LICENSE */function tt(r){return tt=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},tt(r)}function Ta(r,e){return Ta=Object.setPrototypeOf||function(i,a){return i.__proto__=a,i},Ta(r,e)}function nn(){if(typeof Reflect=="undefined"||!Reflect.construct||Reflect.construct.sham)return!1;if(typeof Proxy=="function")return!0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],function(){})),!0}catch{return!1}}function Ci(r,e,t){return nn()?Ci=Reflect.construct:Ci=function(a,o,s){var l=[null];l.push.apply(l,o);var d=Function.bind.apply(a,l),c=new d;return s&&Ta(c,s.prototype),c},Ci.apply(null,arguments)}function we(r){return ln(r)||dn(r)||cn(r)||hn()}function ln(r){if(Array.isArray(r))return Ma(r)}function dn(r){if(typeof Symbol!="undefined"&&r[Symbol.iterator]!=null||r["@@iterator"]!=null)return Array.from(r)}function cn(r,e){if(!!r){if(typeof r=="string")return Ma(r,e);var t=Object.prototype.toString.call(r).slice(8,-1);if(t==="Object"&&r.constructor&&(t=r.constructor.name),t==="Map"||t==="Set")return Array.from(r);if(t==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t))return Ma(r,e)}}function Ma(r,e){(e==null||e>r.length)&&(e=r.length);for(var t=0,i=new Array(e);t<e;t++)i[t]=r[t];return i}function hn(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}var un=Object.hasOwnProperty,Tr=Object.setPrototypeOf,pn=Object.isFrozen,vn=Object.getPrototypeOf,mn=Object.getOwnPropertyDescriptor,pe=Object.freeze,Te=Object.seal,fn=Object.create,bo=typeof Reflect!="undefined"&&Reflect,Pi=bo.apply,za=bo.construct;Pi||(Pi=function(e,t,i){return e.apply(t,i)});pe||(pe=function(e){return e});Te||(Te=function(e){return e});za||(za=function(e,t){return Ci(e,we(t))});var gn=_e(Array.prototype.forEach),Mr=_e(Array.prototype.pop),Zt=_e(Array.prototype.push),ki=_e(String.prototype.toLowerCase),yn=_e(String.prototype.match),Ie=_e(String.prototype.replace),bn=_e(String.prototype.indexOf),wn=_e(String.prototype.trim),he=_e(RegExp.prototype.test),la=xn(TypeError);function _e(r){return function(e){for(var t=arguments.length,i=new Array(t>1?t-1:0),a=1;a<t;a++)i[a-1]=arguments[a];return Pi(r,e,i)}}function xn(r){return function(){for(var e=arguments.length,t=new Array(e),i=0;i<e;i++)t[i]=arguments[i];return za(r,t)}}function L(r,e){Tr&&Tr(r,null);for(var t=e.length;t--;){var i=e[t];if(typeof i=="string"){var a=ki(i);a!==i&&(pn(e)||(e[t]=a),i=a)}r[i]=!0}return r}function Je(r){var e=fn(null),t;for(t in r)Pi(un,r,[t])&&(e[t]=r[t]);return e}function wi(r,e){for(;r!==null;){var t=mn(r,e);if(t){if(t.get)return _e(t.get);if(typeof t.value=="function")return _e(t.value)}r=vn(r)}function i(a){return console.warn("fallback value for",a),null}return i}var zr=pe(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","section","select","shadow","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),da=pe(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","filter","font","g","glyph","glyphref","hkern","image","line","lineargradient","marker","mask","metadata","mpath","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),ca=pe(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),_n=pe(["animate","color-profile","cursor","discard","fedropshadow","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),ha=pe(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover"]),Sn=pe(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),Er=pe(["#text"]),Dr=pe(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","face","for","headers","height","hidden","high","href","hreflang","id","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","pattern","placeholder","playsinline","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","xmlns","slot"]),ua=pe(["accent-height","accumulate","additive","alignment-baseline","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),Lr=pe(["accent","accentunder","align","bevelled","close","columnsalign","columnlines","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lspace","lquote","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),xi=pe(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),$n=Te(/\{\{[\w\W]*|[\w\W]*\}\}/gm),Cn=Te(/<%[\w\W]*|[\w\W]*%>/gm),kn=Te(/^data-[\-\w.\u00B7-\uFFFF]/),Tn=Te(/^aria-[\-\w]+$/),Mn=Te(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|cid|xmpp):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),zn=Te(/^(?:\w+script|data):/i),En=Te(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),Dn=Te(/^html$/i),Ln=function(){return typeof window=="undefined"?null:window},An=function(e,t){if(tt(e)!=="object"||typeof e.createPolicy!="function")return null;var i=null,a="data-tt-policy-suffix";t.currentScript&&t.currentScript.hasAttribute(a)&&(i=t.currentScript.getAttribute(a));var o="dompurify"+(i?"#"+i:"");try{return e.createPolicy(o,{createHTML:function(l){return l}})}catch{return console.warn("TrustedTypes policy "+o+" could not be created."),null}};function wo(){var r=arguments.length>0&&arguments[0]!==void 0?arguments[0]:Ln(),e=function(u){return wo(u)};if(e.version="2.3.8",e.removed=[],!r||!r.document||r.document.nodeType!==9)return e.isSupported=!1,e;var t=r.document,i=r.document,a=r.DocumentFragment,o=r.HTMLTemplateElement,s=r.Node,l=r.Element,d=r.NodeFilter,c=r.NamedNodeMap,v=c===void 0?r.NamedNodeMap||r.MozNamedAttrMap:c,m=r.HTMLFormElement,f=r.DOMParser,w=r.trustedTypes,_=l.prototype,$=wi(_,"cloneNode"),E=wi(_,"nextSibling"),D=wi(_,"childNodes"),P=wi(_,"parentNode");if(typeof o=="function"){var N=i.createElement("template");N.content&&N.content.ownerDocument&&(i=N.content.ownerDocument)}var B=An(w,t),Y=B?B.createHTML(""):"",oe=i,$e=oe.implementation,Ht=oe.createNodeIterator,Ut=oe.createDocumentFragment,jt=oe.getElementsByTagName,Wt=t.importNode,nt={};try{nt=Je(i).documentMode?i.documentMode:{}}catch{}var ve={};e.isSupported=typeof P=="function"&&$e&&typeof $e.createHTMLDocument!="undefined"&&nt!==9;var We=$n,Ve=Cn,Vt=kn,Gt=Tn,Qt=zn,lt=En,Ge=Mn,K=null,dt=L({},[].concat(we(zr),we(da),we(ca),we(ha),we(Er))),q=null,ct=L({},[].concat(we(Dr),we(ua),we(Lr),we(xi))),V=Object.seal(Object.create(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),ze=null,Qe=null,ht=!0,Ye=!0,ut=!1,Ce=!1,be=!1,Ke=!1,pt=!1,vt=!1,vi=!1,mi=!1,Qa=!0,Vi=!0,Yt=!1,mt={},ft=null,Ya=L({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","style","svg","template","thead","title","video","xmp"]),Ka=null,qa=L({},["audio","video","img","source","image","track"]),Gi=null,Xa=L({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),Qi="http://www.w3.org/1998/Math/MathML",Yi="http://www.w3.org/2000/svg",Oe="http://www.w3.org/1999/xhtml",fi=Oe,Ki=!1,gt,Fo=["application/xhtml+xml","text/html"],Po="text/html",qe,yt=null,Oo=i.createElement("form"),Za=function(u){return u instanceof RegExp||u instanceof Function},qi=function(u){yt&&yt===u||((!u||tt(u)!=="object")&&(u={}),u=Je(u),K="ALLOWED_TAGS"in u?L({},u.ALLOWED_TAGS):dt,q="ALLOWED_ATTR"in u?L({},u.ALLOWED_ATTR):ct,Gi="ADD_URI_SAFE_ATTR"in u?L(Je(Xa),u.ADD_URI_SAFE_ATTR):Xa,Ka="ADD_DATA_URI_TAGS"in u?L(Je(qa),u.ADD_DATA_URI_TAGS):qa,ft="FORBID_CONTENTS"in u?L({},u.FORBID_CONTENTS):Ya,ze="FORBID_TAGS"in u?L({},u.FORBID_TAGS):{},Qe="FORBID_ATTR"in u?L({},u.FORBID_ATTR):{},mt="USE_PROFILES"in u?u.USE_PROFILES:!1,ht=u.ALLOW_ARIA_ATTR!==!1,Ye=u.ALLOW_DATA_ATTR!==!1,ut=u.ALLOW_UNKNOWN_PROTOCOLS||!1,Ce=u.SAFE_FOR_TEMPLATES||!1,be=u.WHOLE_DOCUMENT||!1,vt=u.RETURN_DOM||!1,vi=u.RETURN_DOM_FRAGMENT||!1,mi=u.RETURN_TRUSTED_TYPE||!1,pt=u.FORCE_BODY||!1,Qa=u.SANITIZE_DOM!==!1,Vi=u.KEEP_CONTENT!==!1,Yt=u.IN_PLACE||!1,Ge=u.ALLOWED_URI_REGEXP||Ge,fi=u.NAMESPACE||Oe,u.CUSTOM_ELEMENT_HANDLING&&Za(u.CUSTOM_ELEMENT_HANDLING.tagNameCheck)&&(V.tagNameCheck=u.CUSTOM_ELEMENT_HANDLING.tagNameCheck),u.CUSTOM_ELEMENT_HANDLING&&Za(u.CUSTOM_ELEMENT_HANDLING.attributeNameCheck)&&(V.attributeNameCheck=u.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),u.CUSTOM_ELEMENT_HANDLING&&typeof u.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements=="boolean"&&(V.allowCustomizedBuiltInElements=u.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements),gt=Fo.indexOf(u.PARSER_MEDIA_TYPE)===-1?gt=Po:gt=u.PARSER_MEDIA_TYPE,qe=gt==="application/xhtml+xml"?function(b){return b}:ki,Ce&&(Ye=!1),vi&&(vt=!0),mt&&(K=L({},we(Er)),q=[],mt.html===!0&&(L(K,zr),L(q,Dr)),mt.svg===!0&&(L(K,da),L(q,ua),L(q,xi)),mt.svgFilters===!0&&(L(K,ca),L(q,ua),L(q,xi)),mt.mathMl===!0&&(L(K,ha),L(q,Lr),L(q,xi))),u.ADD_TAGS&&(K===dt&&(K=Je(K)),L(K,u.ADD_TAGS)),u.ADD_ATTR&&(q===ct&&(q=Je(q)),L(q,u.ADD_ATTR)),u.ADD_URI_SAFE_ATTR&&L(Gi,u.ADD_URI_SAFE_ATTR),u.FORBID_CONTENTS&&(ft===Ya&&(ft=Je(ft)),L(ft,u.FORBID_CONTENTS)),Vi&&(K["#text"]=!0),be&&L(K,["html","head","body"]),K.table&&(L(K,["tbody"]),delete ze.tbody),pe&&pe(u),yt=u)},Ja=L({},["mi","mo","mn","ms","mtext"]),er=L({},["foreignobject","desc","title","annotation-xml"]),Io=L({},["title","style","font","a","script"]),gi=L({},da);L(gi,ca),L(gi,_n);var Xi=L({},ha);L(Xi,Sn);var No=function(u){var b=P(u);(!b||!b.tagName)&&(b={namespaceURI:Oe,tagName:"template"});var S=ki(u.tagName),H=ki(b.tagName);return u.namespaceURI===Yi?b.namespaceURI===Oe?S==="svg":b.namespaceURI===Qi?S==="svg"&&(H==="annotation-xml"||Ja[H]):Boolean(gi[S]):u.namespaceURI===Qi?b.namespaceURI===Oe?S==="math":b.namespaceURI===Yi?S==="math"&&er[H]:Boolean(Xi[S]):u.namespaceURI===Oe?b.namespaceURI===Yi&&!er[H]||b.namespaceURI===Qi&&!Ja[H]?!1:!Xi[S]&&(Io[S]||!gi[S]):!1},Ee=function(u){Zt(e.removed,{element:u});try{u.parentNode.removeChild(u)}catch{try{u.outerHTML=Y}catch{u.remove()}}},tr=function(u,b){try{Zt(e.removed,{attribute:b.getAttributeNode(u),from:b})}catch{Zt(e.removed,{attribute:null,from:b})}if(b.removeAttribute(u),u==="is"&&!q[u])if(vt||vi)try{Ee(b)}catch{}else try{b.setAttribute(u,"")}catch{}},ir=function(u){var b,S;if(pt)u="<remove></remove>"+u;else{var H=yn(u,/^[\r\n\t ]+/);S=H&&H[0]}gt==="application/xhtml+xml"&&(u='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+u+"</body></html>");var me=B?B.createHTML(u):u;if(fi===Oe)try{b=new f().parseFromString(me,gt)}catch{}if(!b||!b.documentElement){b=$e.createDocument(fi,"template",null);try{b.documentElement.innerHTML=Ki?"":me}catch{}}var se=b.body||b.documentElement;return u&&S&&se.insertBefore(i.createTextNode(S),se.childNodes[0]||null),fi===Oe?jt.call(b,be?"html":"body")[0]:be?b.documentElement:se},ar=function(u){return Ht.call(u.ownerDocument||u,u,d.SHOW_ELEMENT|d.SHOW_COMMENT|d.SHOW_TEXT,null,!1)},Ro=function(u){return u instanceof m&&(typeof u.nodeName!="string"||typeof u.textContent!="string"||typeof u.removeChild!="function"||!(u.attributes instanceof v)||typeof u.removeAttribute!="function"||typeof u.setAttribute!="function"||typeof u.namespaceURI!="string"||typeof u.insertBefore!="function")},Kt=function(u){return tt(s)==="object"?u instanceof s:u&&tt(u)==="object"&&typeof u.nodeType=="number"&&typeof u.nodeName=="string"},De=function(u,b,S){!ve[u]||gn(ve[u],function(H){H.call(e,b,S,yt)})},rr=function(u){var b;if(De("beforeSanitizeElements",u,null),Ro(u)||he(/[\u0080-\uFFFF]/,u.nodeName))return Ee(u),!0;var S=qe(u.nodeName);if(De("uponSanitizeElement",u,{tagName:S,allowedTags:K}),u.hasChildNodes()&&!Kt(u.firstElementChild)&&(!Kt(u.content)||!Kt(u.content.firstElementChild))&&he(/<[/\w]/g,u.innerHTML)&&he(/<[/\w]/g,u.textContent)||S==="select"&&he(/<template/i,u.innerHTML))return Ee(u),!0;if(!K[S]||ze[S]){if(!ze[S]&&sr(S)&&(V.tagNameCheck instanceof RegExp&&he(V.tagNameCheck,S)||V.tagNameCheck instanceof Function&&V.tagNameCheck(S)))return!1;if(Vi&&!ft[S]){var H=P(u)||u.parentNode,me=D(u)||u.childNodes;if(me&&H)for(var se=me.length,te=se-1;te>=0;--te)H.insertBefore($(me[te],!0),E(u))}return Ee(u),!0}return u instanceof l&&!No(u)||(S==="noscript"||S==="noembed")&&he(/<\/no(script|embed)/i,u.innerHTML)?(Ee(u),!0):(Ce&&u.nodeType===3&&(b=u.textContent,b=Ie(b,We," "),b=Ie(b,Ve," "),u.textContent!==b&&(Zt(e.removed,{element:u.cloneNode()}),u.textContent=b)),De("afterSanitizeElements",u,null),!1)},or=function(u,b,S){if(Qa&&(b==="id"||b==="name")&&(S in i||S in Oo))return!1;if(!(Ye&&!Qe[b]&&he(Vt,b))){if(!(ht&&he(Gt,b))){if(!q[b]||Qe[b]){if(!(sr(u)&&(V.tagNameCheck instanceof RegExp&&he(V.tagNameCheck,u)||V.tagNameCheck instanceof Function&&V.tagNameCheck(u))&&(V.attributeNameCheck instanceof RegExp&&he(V.attributeNameCheck,b)||V.attributeNameCheck instanceof Function&&V.attributeNameCheck(b))||b==="is"&&V.allowCustomizedBuiltInElements&&(V.tagNameCheck instanceof RegExp&&he(V.tagNameCheck,S)||V.tagNameCheck instanceof Function&&V.tagNameCheck(S))))return!1}else if(!Gi[b]){if(!he(Ge,Ie(S,lt,""))){if(!((b==="src"||b==="xlink:href"||b==="href")&&u!=="script"&&bn(S,"data:")===0&&Ka[u])){if(!(ut&&!he(Qt,Ie(S,lt,"")))){if(S)return!1}}}}}}return!0},sr=function(u){return u.indexOf("-")>0},nr=function(u){var b,S,H,me;De("beforeSanitizeAttributes",u,null);var se=u.attributes;if(!!se){var te={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:q};for(me=se.length;me--;){b=se[me];var yi=b,de=yi.name,lr=yi.namespaceURI;if(S=de==="value"?b.value:wn(b.value),H=qe(de),te.attrName=H,te.attrValue=S,te.keepAttr=!0,te.forceKeepAttr=void 0,De("uponSanitizeAttribute",u,te),S=te.attrValue,!te.forceKeepAttr&&(tr(de,u),!!te.keepAttr)){if(he(/\/>/i,S)){tr(de,u);continue}Ce&&(S=Ie(S,We," "),S=Ie(S,Ve," "));var Ho=qe(u.nodeName);if(!!or(Ho,H,S))try{lr?u.setAttributeNS(lr,de,S):u.setAttribute(de,S),Mr(e.removed)}catch{}}}De("afterSanitizeAttributes",u,null)}},Bo=function C(u){var b,S=ar(u);for(De("beforeSanitizeShadowDOM",u,null);b=S.nextNode();)De("uponSanitizeShadowNode",b,null),!rr(b)&&(b.content instanceof a&&C(b.content),nr(b));De("afterSanitizeShadowDOM",u,null)};return e.sanitize=function(C,u){var b,S,H,me,se;if(Ki=!C,Ki&&(C="<!-->"),typeof C!="string"&&!Kt(C)){if(typeof C.toString!="function")throw la("toString is not a function");if(C=C.toString(),typeof C!="string")throw la("dirty is not a string, aborting")}if(!e.isSupported){if(tt(r.toStaticHTML)==="object"||typeof r.toStaticHTML=="function"){if(typeof C=="string")return r.toStaticHTML(C);if(Kt(C))return r.toStaticHTML(C.outerHTML)}return C}if(Ke||qi(u),e.removed=[],typeof C=="string"&&(Yt=!1),Yt){if(C.nodeName){var te=qe(C.nodeName);if(!K[te]||ze[te])throw la("root node is forbidden and cannot be sanitized in-place")}}else if(C instanceof s)b=ir("<!---->"),S=b.ownerDocument.importNode(C,!0),S.nodeType===1&&S.nodeName==="BODY"||S.nodeName==="HTML"?b=S:b.appendChild(S);else{if(!vt&&!Ce&&!be&&C.indexOf("<")===-1)return B&&mi?B.createHTML(C):C;if(b=ir(C),!b)return vt?null:mi?Y:""}b&&pt&&Ee(b.firstChild);for(var yi=ar(Yt?C:b);H=yi.nextNode();)H.nodeType===3&&H===me||rr(H)||(H.content instanceof a&&Bo(H.content),nr(H),me=H);if(me=null,Yt)return C;if(vt){if(vi)for(se=Ut.call(b.ownerDocument);b.firstChild;)se.appendChild(b.firstChild);else se=b;return q.shadowroot&&(se=Wt.call(t,se,!0)),se}var de=be?b.outerHTML:b.innerHTML;return be&&K["!doctype"]&&b.ownerDocument&&b.ownerDocument.doctype&&b.ownerDocument.doctype.name&&he(Dn,b.ownerDocument.doctype.name)&&(de="<!DOCTYPE "+b.ownerDocument.doctype.name+`>
`+de),Ce&&(de=Ie(de,We," "),de=Ie(de,Ve," ")),B&&mi?B.createHTML(de):de},e.setConfig=function(C){qi(C),Ke=!0},e.clearConfig=function(){yt=null,Ke=!1},e.isValidAttribute=function(C,u,b){yt||qi({});var S=qe(C),H=qe(u);return or(S,H,b)},e.addHook=function(C,u){typeof u=="function"&&(ve[C]=ve[C]||[],Zt(ve[C],u))},e.removeHook=function(C){if(ve[C])return Mr(ve[C])},e.removeHooks=function(C){ve[C]&&(ve[C]=[])},e.removeAllHooks=function(){ve={}},e}var ii=wo(),A;(function(r){r.relevance="relevance",r.alltimeview="alltimeview",r.weeklyview="weeklyview",r.title="title",r.datearchived="datearchived",r.date="date",r.datereviewed="datereviewed",r.dateadded="dateadded",r.creator="creator"})(A||(A={}));const et={relevance:"Relevance",alltimeview:"All-time Views",weeklyview:"Weekly Views",title:"Title",datearchived:"Date Archived",date:"Date Published",datereviewed:"Date Reviewed",dateadded:"Date Added",creator:"Creator"},Fn={relevance:null,alltimeview:"downloads",weeklyview:"week",title:"titleSorter",datearchived:"publicdate",date:"date",datereviewed:"reviewdate",dateadded:"addeddate",creator:"creatorSorter"},Ar={week:A.weeklyview,downloads:A.alltimeview,titleSorter:A.title,date:A.date,publicdate:A.datearchived,reviewdate:A.datereviewed,addeddate:A.dateadded,creatorSorter:A.creator},Pn={title:"firstTitle",creator:"firstCreator"},Oi={subject:{},lending:{},mediatype:{},language:{},creator:{},collection:{},year:{}},On=["mediatype","lending","year","subject","collection","creator","language"],Ii={subject:"Subject",lending:"Availability",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"},In={is_lendable:!0,is_borrowable:!1,available_to_borrow:!0,is_browsable:!1,available_to_browse:!1,is_readable:!0,available_to_waitlist:!1},Fr={is_lendable:"Lending Library",available_to_borrow:"Borrow 14 Days",is_readable:"Always Available"},Ha={deemphasize:!0,community:!0,stream_only:!0,samples_only:!0,test_collection:!0,printdisabled:!0,"openlibrary-ol":!0,nationalemergencylibrary:!0,china:!0,americana:!0,toronto:!0};function xo(r){switch(r){case"date":return"Published";case"reviewdate":return"Reviewed";case"addeddate":return"Added";default:return"Archived"}}function _o(r){return r?`Archivist since ${r.getFullYear()}`:""}let ye=class extends F{constructor(){super(...arguments),this.sortParam=null,this.collectionLinks=[],this.loggedIn=!1,this.featureFeedbackSettings={enabled:!1,buttonText:"",featureIdentifier:"",prompt:""}}render(){return p`
    ...
    `}};n([h({type:Object})],Pe.prototype,"model",void 0);n([h({type:String})],Pe.prototype,"baseNavigationUrl",void 0);n([h({type:String})],Pe.prototype,"baseImageUrl",void 0);n([h({type:Boolean})],Pe.prototype,"loggedIn",void 0);n([h({type:Object})],Pe.prototype,"sortParam",void 0);n([h({type:Object})],Pe.prototype,"collectionNameCache",void 0);n([h({type:Object})],Pe.prototype,"featureFeedbackSettings",void 0);Pe=n([R("tile-hover-pane")],Pe);let Me=class extends F{constructor(){super(...arguments),this.sortParam=null,this.loggedIn=!1}render(){var e,t,i,a,o,s,l,d,c;return p`
      <div id="list-line" class="${this.classSize}">
        <image-block
          .model=${this.model}
          .baseImageUrl=${this.baseImageUrl}
    ...
    `}};n([h({type:Object})],Ft.prototype,"model",void 0);n([h({type:Number})],Ft.prototype,"currentWidth",void 0);n([h({type:Object})],Ft.prototype,"sortParam",void 0);n([h({type:Number})],Ft.prototype,"mobileBreakpoint",void 0);Ft=n([R("tile-list-compact-header")],Ft);class Nn{constructor(e,t,i={}){this.host=e,this.hoverPaneProps=t,this.offsetX=-10,this.offsetY=15,this.showDelay=300,this.hideDelay=100,this.longPressDelay=800,this.enableLongPress=!0,this.hoverPaneState="hidden",this.lastMouseClientPos={x:0,y:0},this.handleMouseMove=a=>{var o;clearTimeout(this.hideTimer),this.hoverPaneState==="fading-out"&&(this.hoverPaneState="shown",(o=this.hoverPane)===null||o===void 0||o.classList.add("fade-in")),this.hoverPaneState==="hidden"&&(this.restartShowHoverPaneTimer(),this.lastMouseClientPos={x:a.clientX,y:a.clientY})},this.handleMouseLeave=()=>{clearTimeout(this.showTimer),clearTimeout(this.hideTimer),this.hoverPaneState!=="hidden"&&(this.hideTimer=window.setTimeout(()=>{this.fadeOutHoverPane()},this.hideDelay))},this.handleTouchStart=()=>{clearTimeout(this.longPressTimer),this.longPressTimer=window.setTimeout(()=>{this.hoverPaneState==="hidden"&&this.showHoverPane()},this.longPressDelay)},this.cancelLongPress=()=>{clearTimeout(this.longPressTimer)},this.host.addController(this),Object.assign(this,i)}hostConnected(){this.attachListeners()}hostDisconnected(){this.detachListeners()}hostUpdated(){this.hoverPane=this.host.getHoverPane(),this.hoverPaneProps=this.host.getHoverPaneProps()}getTemplate(){var e,t,i,a,o,s;return this.shouldRenderHoverPane?p` ${this.touchBackdropTemplate}
          <tile-hover-pane
    ...
    `}};Pr=n([R("collection-browser-loading-tile")],Pr);let ui=class extends F{constructor(){super(...arguments),this.selectedLetter=null,this.alphabet="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("")}get selectedUppercaseLetter(){var e;return(e=this.selectedLetter)===null||e===void 0?void 0:e.toUpperCase()}render(){return p`
      <div id="container">
        <ul>
    ...
    `}letterClicked(e){e===this.selectedUppercaseLetter?this.selectedLetter=null:this.selectedLetter=e,this.dispatchEvent(new CustomEvent("letterChanged",{detail:{selectedLetter:this.selectedUppercaseLetter}}))}};ui.styles=g`
    h1 {
      font-size: 1.2rem;
    }
  ...
  `;n([h({type:String})],ui.prototype,"selectedLetter",void 0);n([h({type:Object})],ui.prototype,"letterCounts",void 0);ui=n([R("alpha-bar")],ui);const Or=O`
...
`;let ee=class extends F{constructor(){super(...arguments),this.sortDirection=null,this.selectedSort=A.relevance,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.showRelevance=!0,this.alphaSelectorVisible=null,this.dateSortSelectorVisible=!1,this.viewSortSelectorVisible=!1,this.desktopSelectorBarWidth=0,this.selectorBarContainerWidth=0,this.hoveringOverDateSortOptions=!1,this.boundSortBarSelectorEscapeListener=e=>{e.key==="Escape"&&(this.viewSortSelectorVisible=!1,this.dateSortSelectorVisible=!1)}}render(){return p`
    ...
    `}getSortDisplayOption(e,t){var i,a;const o=(i=t==null?void 0:t.isSelected)!==null&&i!==void 0?i:()=>this.selectedSort===e,s=(a=t==null?void 0:t.displayName)!==null&&a!==void 0?a:et[e];return p`
      <a
        href="#"
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ir=Ui(class extends ji{constructor(r){if(super(r),r.type!==Le.PROPERTY&&r.type!==Le.ATTRIBUTE&&r.type!==Le.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!ks(r))throw Error("`live` bindings can only contain a single expression")}render(r){return r}update(r,[e]){if(e===ge||e===x)return e;const t=r.element,i=r.name;if(r.type===Le.PROPERTY){if(e===t[i])return ge}else if(r.type===Le.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(i))return ge}else if(r.type===Le.ATTRIBUTE&&t.getAttribute(i)===e+"")return ge;return vo(r),e}});var So=60,$o=So*60,Co=$o*24,Un=Co*7,Pt=1e3,pa=So*Pt,Nr=$o*Pt,jn=Co*Pt,Wn=Un*Pt,Ua="millisecond",Ct="second",kt="minute",Tt="hour",Ne="day",Ti="week",xe="month",ko="quarter",Re="year",Mt="date",Vn="YYYY-MM-DDTHH:mm:ssZ",Rr="Invalid Date",Gn=/^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/,Qn=/\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g,Yn={name:"en",weekdays:"Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),months:"January_February_March_April_May_June_July_August_September_October_November_December".split("_")},Da=function(e,t,i){var a=String(e);return!a||a.length>=t?e:""+Array(t+1-a.length).join(i)+e},Kn=function(e){var t=-e.utcOffset(),i=Math.abs(t),a=Math.floor(i/60),o=i%60;return(t<=0?"+":"-")+Da(a,2,"0")+":"+Da(o,2,"0")},qn=function r(e,t){if(e.date()<t.date())return-r(t,e);var i=(t.year()-e.year())*12+(t.month()-e.month()),a=e.clone().add(i,xe),o=t-a<0,s=e.clone().add(i+(o?-1:1),xe);return+(-(i+(t-a)/(o?a-s:s-a))||0)},Xn=function(e){return e<0?Math.ceil(e)||0:Math.floor(e)},Zn=function(e){var t={M:xe,y:Re,w:Ti,d:Ne,D:Mt,h:Tt,m:kt,s:Ct,ms:Ua,Q:ko};return t[e]||String(e||"").toLowerCase().replace(/s$/,"")},Jn=function(e){return e===void 0},el={s:Da,z:Kn,m:qn,a:Xn,p:Zn,u:Jn},ai="en",it={};it[ai]=Yn;var ja=function(e){return e instanceof Wi},Ni=function r(e,t,i){var a;if(!e)return ai;if(typeof e=="string"){var o=e.toLowerCase();it[o]&&(a=o),t&&(it[o]=t,a=o);var s=e.split("-");if(!a&&s.length>1)return r(s[0])}else{var l=e.name;it[l]=e,a=l}return!i&&a&&(ai=a),a||!i&&ai},J=function(e,t){if(ja(e))return e.clone();var i=typeof t=="object"?t:{};return i.date=e,i.args=arguments,new Wi(i)},tl=function(e,t){return J(e,{locale:t.$L,utc:t.$u,x:t.$x,$offset:t.$offset})},U=el;U.l=Ni;U.i=ja;U.w=tl;var il=function(e){var t=e.date,i=e.utc;if(t===null)return new Date(NaN);if(U.u(t))return new Date;if(t instanceof Date)return new Date(t);if(typeof t=="string"&&!/Z$/i.test(t)){var a=t.match(Gn);if(a){var o=a[2]-1||0,s=(a[7]||"0").substring(0,3);return i?new Date(Date.UTC(a[1],o,a[3]||1,a[4]||0,a[5]||0,a[6]||0,s)):new Date(a[1],o,a[3]||1,a[4]||0,a[5]||0,a[6]||0,s)}}return new Date(t)},Wi=function(){function r(t){this.$L=Ni(t.locale,null,!0),this.parse(t)}var e=r.prototype;return e.parse=function(i){this.$d=il(i),this.$x=i.x||{},this.init()},e.init=function(){var i=this.$d;this.$y=i.getFullYear(),this.$M=i.getMonth(),this.$D=i.getDate(),this.$W=i.getDay(),this.$H=i.getHours(),this.$m=i.getMinutes(),this.$s=i.getSeconds(),this.$ms=i.getMilliseconds()},e.$utils=function(){return U},e.isValid=function(){return this.$d.toString()!==Rr},e.isSame=function(i,a){var o=J(i);return this.startOf(a)<=o&&o<=this.endOf(a)},e.isAfter=function(i,a){return J(i)<this.startOf(a)},e.isBefore=function(i,a){return this.endOf(a)<J(i)},e.$g=function(i,a,o){return U.u(i)?this[a]:this.set(o,i)},e.unix=function(){return Math.floor(this.valueOf()/1e3)},e.valueOf=function(){return this.$d.getTime()},e.startOf=function(i,a){var o=this,s=U.u(a)?!0:a,l=U.p(i),d=function(D,P){var N=U.w(o.$u?Date.UTC(o.$y,P,D):new Date(o.$y,P,D),o);return s?N:N.endOf(Ne)},c=function(D,P){var N=[0,0,0,0],B=[23,59,59,999];return U.w(o.toDate()[D].apply(o.toDate("s"),(s?N:B).slice(P)),o)},v=this.$W,m=this.$M,f=this.$D,w="set"+(this.$u?"UTC":"");switch(l){case Re:return s?d(1,0):d(31,11);case xe:return s?d(1,m):d(0,m+1);case Ti:{var _=this.$locale().weekStart||0,$=(v<_?v+7:v)-_;return d(s?f-$:f+(6-$),m)}case Ne:case Mt:return c(w+"Hours",0);case Tt:return c(w+"Minutes",1);case kt:return c(w+"Seconds",2);case Ct:return c(w+"Milliseconds",3);default:return this.clone()}},e.endOf=function(i){return this.startOf(i,!1)},e.$set=function(i,a){var o,s=U.p(i),l="set"+(this.$u?"UTC":""),d=(o={},o[Ne]=l+"Date",o[Mt]=l+"Date",o[xe]=l+"Month",o[Re]=l+"FullYear",o[Tt]=l+"Hours",o[kt]=l+"Minutes",o[Ct]=l+"Seconds",o[Ua]=l+"Milliseconds",o)[s],c=s===Ne?this.$D+(a-this.$W):a;if(s===xe||s===Re){var v=this.clone().set(Mt,1);v.$d[d](c),v.init(),this.$d=v.set(Mt,Math.min(this.$D,v.daysInMonth())).$d}else d&&this.$d[d](c);return this.init(),this},e.set=function(i,a){return this.clone().$set(i,a)},e.get=function(i){return this[U.p(i)]()},e.add=function(i,a){var o=this,s;i=Number(i);var l=U.p(a),d=function(f){var w=J(o);return U.w(w.date(w.date()+Math.round(f*i)),o)};if(l===xe)return this.set(xe,this.$M+i);if(l===Re)return this.set(Re,this.$y+i);if(l===Ne)return d(1);if(l===Ti)return d(7);var c=(s={},s[kt]=pa,s[Tt]=Nr,s[Ct]=Pt,s)[l]||1,v=this.$d.getTime()+i*c;return U.w(v,this)},e.subtract=function(i,a){return this.add(i*-1,a)},e.format=function(i){var a=this,o=this.$locale();if(!this.isValid())return o.invalidDate||Rr;var s=i||Vn,l=U.z(this),d=this.$H,c=this.$m,v=this.$M,m=o.weekdays,f=o.months,w=o.meridiem,_=function(N,B,Y,oe){return N&&(N[B]||N(a,s))||Y[B].slice(0,oe)},$=function(N){return U.s(d%12||12,N,"0")},E=w||function(P,N,B){var Y=P<12?"AM":"PM";return B?Y.toLowerCase():Y},D={YY:String(this.$y).slice(-2),YYYY:this.$y,M:v+1,MM:U.s(v+1,2,"0"),MMM:_(o.monthsShort,v,f,3),MMMM:_(f,v),D:this.$D,DD:U.s(this.$D,2,"0"),d:String(this.$W),dd:_(o.weekdaysMin,this.$W,m,2),ddd:_(o.weekdaysShort,this.$W,m,3),dddd:m[this.$W],H:String(d),HH:U.s(d,2,"0"),h:$(1),hh:$(2),a:E(d,c,!0),A:E(d,c,!1),m:String(c),mm:U.s(c,2,"0"),s:String(this.$s),ss:U.s(this.$s,2,"0"),SSS:U.s(this.$ms,3,"0"),Z:l};return s.replace(Qn,function(P,N){return N||D[P]||l.replace(":","")})},e.utcOffset=function(){return-Math.round(this.$d.getTimezoneOffset()/15)*15},e.diff=function(i,a,o){var s,l=U.p(a),d=J(i),c=(d.utcOffset()-this.utcOffset())*pa,v=this-d,m=U.m(this,d);return m=(s={},s[Re]=m/12,s[xe]=m,s[ko]=m/3,s[Ti]=(v-c)/Wn,s[Ne]=(v-c)/jn,s[Tt]=v/Nr,s[kt]=v/pa,s[Ct]=v/Pt,s)[l]||v,o?m:U.a(m)},e.daysInMonth=function(){return this.endOf(xe).$D},e.$locale=function(){return it[this.$L]},e.locale=function(i,a){if(!i)return this.$L;var o=this.clone(),s=Ni(i,a,!0);return s&&(o.$L=s),o},e.clone=function(){return U.w(this.$d,this)},e.toDate=function(){return new Date(this.valueOf())},e.toJSON=function(){return this.isValid()?this.toISOString():null},e.toISOString=function(){return this.$d.toISOString()},e.toString=function(){return this.$d.toUTCString()},r}(),To=Wi.prototype;J.prototype=To;[["$ms",Ua],["$s",Ct],["$m",kt],["$H",Tt],["$W",Ne],["$M",xe],["$y",Re],["$D",Mt]].forEach(function(r){To[r[1]]=function(e){return this.$g(e,r[0],r[1])}});J.extend=function(r,e){return r.$i||(r(e,Wi,J),r.$i=!0),J};J.locale=Ni;J.isDayjs=ja;J.unix=function(r){return J(r*1e3)};J.en=it[ai];J.Ls=it;J.p={};var al=function(e){return e.replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g,function(t,i,a){return i||a.slice(1)})},rl={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"},ol=function(e,t){return e.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g,function(i,a,o){var s=o&&o.toUpperCase();return a||t[o]||rl[o]||al(t[s])})},sl=/(\[[^[]*\])|([-:/.()\s]+)|(A|a|YYYY|YY?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g,nl=/\d/,_i=/\d\d/,ll=/\d{3}/,dl=/\d{4}/,ke=/\d\d?/,cl=/[+-]?\d+/,hl=/[+-]\d\d:?(\d\d)?|Z/,Jt=/\d*[^\s\d-_:/()]+/,He={},Mo=function(e){return e=+e,e+(e>68?1900:2e3)};function ul(r){if(!r||r==="Z")return 0;var e=r.match(/([+-]|\d\d)/g),t=+(e[1]*60)+(+e[2]||0);return t===0?0:e[0]==="+"?-t:t}var fe=function(e){return function(t){this[e]=+t}},Br=[hl,function(r){var e=this.zone||(this.zone={});e.offset=ul(r)}],va=function(e){var t=He[e];return t&&(t.indexOf?t:t.s.concat(t.f))},Hr=function(e,t){var i,a=He,o=a.meridiem;if(!o)i=e===(t?"pm":"PM");else for(var s=1;s<=24;s+=1)if(e.indexOf(o(s,0,t))>-1){i=s>12;break}return i},pl={A:[Jt,function(r){this.afternoon=Hr(r,!1)}],a:[Jt,function(r){this.afternoon=Hr(r,!0)}],S:[nl,function(r){this.milliseconds=+r*100}],SS:[_i,function(r){this.milliseconds=+r*10}],SSS:[ll,function(r){this.milliseconds=+r}],s:[ke,fe("seconds")],ss:[ke,fe("seconds")],m:[ke,fe("minutes")],mm:[ke,fe("minutes")],H:[ke,fe("hours")],h:[ke,fe("hours")],HH:[ke,fe("hours")],hh:[ke,fe("hours")],D:[ke,fe("day")],DD:[_i,fe("day")],Do:[Jt,function(r){var e=He,t=e.ordinal,i=r.match(/\d+/);if(this.day=i[0],!!t)for(var a=1;a<=31;a+=1)t(a).replace(/\[|\]/g,"")===r&&(this.day=a)}],M:[ke,fe("month")],MM:[_i,fe("month")],MMM:[Jt,function(r){var e=va("months"),t=va("monthsShort"),i=(t||e.map(function(a){return a.slice(0,3)})).indexOf(r)+1;if(i<1)throw new Error;this.month=i%12||i}],MMMM:[Jt,function(r){var e=va("months"),t=e.indexOf(r)+1;if(t<1)throw new Error;this.month=t%12||t}],Y:[cl,fe("year")],YY:[_i,function(r){this.year=Mo(r)}],YYYY:[dl,fe("year")],Z:Br,ZZ:Br};function vl(r){var e=r.afternoon;if(e!==void 0){var t=r.hours;e?t<12&&(r.hours+=12):t===12&&(r.hours=0),delete r.afternoon}}function ml(r){r=ol(r,He&&He.formats);for(var e=r.match(sl),t=e.length,i=0;i<t;i+=1){var a=e[i],o=pl[a],s=o&&o[0],l=o&&o[1];l?e[i]={regex:s,parser:l}:e[i]=a.replace(/^\[|\]$/g,"")}return function(d){for(var c={},v=0,m=0;v<t;v+=1){var f=e[v];if(typeof f=="string")m+=f.length;else{var w=f.regex,_=f.parser,$=d.slice(m),E=w.exec($),D=E[0];_.call(c,D),d=d.replace(D,"")}}return vl(c),c}}var fl=function(e,t,i){try{if(["x","X"].indexOf(t)>-1)return new Date((t==="X"?1e3:1)*e);var a=ml(t),o=a(e),s=o.year,l=o.month,d=o.day,c=o.hours,v=o.minutes,m=o.seconds,f=o.milliseconds,w=o.zone,_=new Date,$=d||(!s&&!l?_.getDate():1),E=s||_.getFullYear(),D=0;s&&!l||(D=l>0?l-1:_.getMonth());var P=c||0,N=v||0,B=m||0,Y=f||0;return w?new Date(Date.UTC(E,D,$,P,N,B,Y+w.offset*60*1e3)):i?new Date(Date.UTC(E,D,$,P,N,B,Y)):new Date(E,D,$,P,N,B,Y)}catch{return new Date("")}},gl=function(r,e,t){t.p.customParseFormat=!0,r&&r.parseTwoDigitYear&&(Mo=r.parseTwoDigitYear);var i=e.prototype,a=i.parse;i.parse=function(o){var s=o.date,l=o.utc,d=o.args;this.$u=l;var c=d[1];if(typeof c=="string"){var v=d[2]===!0,m=d[3]===!0,f=v||m,w=d[2];m&&(w=d[2]),He=this.$locale(),!v&&w&&(He=t.Ls[w]),this.$d=fl(s,c,l),this.init(),w&&w!==!0&&(this.$L=this.locale(w).$L),f&&s!=this.format(c)&&(this.$d=new Date("")),He={}}else if(c instanceof Array)for(var _=c.length,$=1;$<=_;$+=1){d[1]=c[$-1];var E=t.apply(this,d);if(E.isValid()){this.$d=E.$d,this.$L=E.$L,this.init();break}$===_&&(this.$d=new Date(""))}else a.call(this,o)}};const yl=Object.freeze({processing:"processing",complete:"complete"});class bl extends F{static get properties(){return{mode:{type:String}}}constructor(){super(),this.mode=yl.processing}render(){return p`
      <div class="${this.mode}">
        <svg
          viewBox="0 0 120 120"
    ...
    `}get selectedRangeTemplate(){return O`
      ...
      />`}get histogramTemplate(){const e=this._histWidth/this._numBins,t=e-1;let i=this.sliderWidth;return this._histData.map(a=>{const o=O`
        <rect
          ...
          fill="${i+t>=this.minSliderX&&i<=this.maxSliderX?zl:Dl}"
...
`;let La=class extends F{constructor(){super(...arguments),this.config=new zo}render(){return p`
      <div class="modal-wrapper">
        <div class="modal-container">
          <header style="background-color: ${this.config.headerColor}">
            ${this.config.showCloseButton?this.closeButtonTemplate:""}
            ${this.config.showHeaderLogo?p`<div class="logo-icon">${Rl}</div>`:x}
    ...
    `}static get styles(){const e=g`var(--modalLogoSize, 6.5rem)`,t=g`var(--processingImageSize, 7.5rem)`,i=g`var(--modalCornerRadius, 1rem)`,a=g`var(--modalBorder, 2px solid black)`,o=g`var(--modalBottomMargin, 2.5rem)`,s=g`var(--modalTopMargin, 5rem)`,l=g`var(--modalHeaderBottomPadding, 0.5em)`,d=g`var(--modalBottomPadding, 2rem)`,c=g`var(--modalScrollOffset, 5px)`,v=g`var(--modalTitleFontSize, 1.8rem)`,m=g`var(--modalSubtitleFontSize, 1.4rem)`,f=g`var(--modalHeadlineFontSize, 1.6rem)`,w=g`var(--modalMessageFontSize, 1.4rem)`,_=g`var(--modalTitleLineHeight, normal)`,$=g`var(--modalSubtitleLineHeight, normal)`,E=g`var(--modalHeadlineLineHeight, normal)`,D=g`var(--modalMessageLineHeight, normal)`;return g`
      .processing-logo {
        margin: auto;
        width: ${t};
        height: ${t};
    ...
    `}};n([h({type:Object})],La.prototype,"config",void 0);La=n([R("modal-template")],La);function Bl(r,e,t){var i=t||{},a=i.noTrailing,o=a===void 0?!1:a,s=i.noLeading,l=s===void 0?!1:s,d=i.debounceMode,c=d===void 0?void 0:d,v,m=!1,f=0;function w(){v&&clearTimeout(v)}function _(E){var D=E||{},P=D.upcomingOnly,N=P===void 0?!1:P;w(),m=!N}function $(){for(var E=arguments.length,D=new Array(E),P=0;P<E;P++)D[P]=arguments[P];var N=this,B=Date.now()-f;if(m)return;function Y(){f=Date.now(),e.apply(N,D)}function oe(){v=void 0}!l&&c&&!v&&Y(),w(),c===void 0&&B>r?l?(f=Date.now(),o||(v=setTimeout(c?oe:Y,r))):Y():o!==!0&&(v=setTimeout(c?oe:Y,c===void 0?r-B:r))}return $.cancel=_,$}var at;(function(r){r.Open="open",r.Closed="closed"})(at||(at={}));class Hl{constructor(e){this.windowResizeThrottler=Bl(100,this.updateModalContainerHeight).bind(this),this.modalManager=e}handleModeChange(e){switch(e){case at.Open:this.startResizeListener(),this.stopDocumentScroll();break;case at.Closed:this.stopResizeListener(),this.resumeDocumentScroll();break}}updateModalContainerHeight(){this.modalManager.style.setProperty("--containerHeight",`${window.innerHeight}px`)}stopDocumentScroll(){document.body.classList.add("modal-manager-open")}resumeDocumentScroll(){document.body.classList.remove("modal-manager-open")}startResizeListener(){window.addEventListener("resize",this.windowResizeThrottler)}stopResizeListener(){window.removeEventListener("resize",this.windowResizeThrottler)}}let Ot=class extends F{constructor(){super(...arguments),this.mode=at.Closed,this.hostBridge=new Hl(this),this.closeOnBackdropClick=!0}render(){return p`
      <div class="container">
...
`;let Nt=class extends F{facetClicked(e,t,i){const a=e.target,{checked:o,name:s,value:l}=a;o?this.facetChecked(s,l,t,i):this.facetUnchecked(s,l)}facetChecked(e,t,i,a){const{selectedFacets:o}=this;let s;o?s=ce({},o):s=Oi,s[e][t]={state:a?"hidden":"selected",count:i},this.selectedFacets=s,this.dispatchSelectedFacetsChanged()}facetUnchecked(e,t){const{selectedFacets:i}=this;let a;i?a=ce({},i):a=Oi,delete a[e][t],this.selectedFacets=a,this.dispatchSelectedFacetsChanged()}dispatchSelectedFacetsChanged(){const e=new CustomEvent("selectedFacetsChanged",{detail:this.selectedFacets,bubbles:!0,composed:!0});this.dispatchEvent(e)}getFacetsTemplate(e){let t=e==null?void 0:e.buckets;return t=[...t.filter(i=>i.state==="selected").sort((i,a)=>i.count<a.count?1:-1),...t.filter(i=>i.state==="hidden").sort((i,a)=>i.count<a.count?1:-1),...t.filter(i=>i.state==="none")],p`
      <div class="facets-on-${this.renderOn}">
        ${mo(t,i=>`${e.key}:${i.key}`,i=>{var a,o;const s=`${e.key}:${i.key}-show-only`,l=`${e.key}:${i.key}-negative`,d=e.key!=="collection"?p`${(a=i.displayText)!==null&&a!==void 0?a:i.key}`:p`<a href="/details/${i.key}">
    ...
    `}render(){return p`${this.getFacetsTemplate(this.facetGroup)}`}static get styles(){return g`
    ...
    `,l=new zo({bodyColor:"#fff",headerColor:"#194880",showHeaderLogo:!1,closeOnBackdropClick:!0,title:p`Select filters`});(i=this.modalManager)===null||i===void 0||i.classList.add("more-search-facets"),(a=this.modalManager)===null||a===void 0||a.showModal({config:l,customModalContent:s})}getFacetTemplate(e){return p`
      <facets-template
        .facetGroup=${e}
        .selectedFacets=${this.selectedFacets}
        .renderOn=${"page"}
...
`;let Bi=class extends F{constructor(){super(...arguments),this.placeholderType=null}render(){return this.placeholderType?p`${this.placeholderTemplate}`:x}get placeholderTemplate(){return p`
      <div
