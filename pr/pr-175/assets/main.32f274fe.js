 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const bs=(r,e)=>e.kind==="method"&&e.descriptor&&!("value"in e.descriptor)?gt(ce({},e),{finisher(t){t.createProperty(e.key,r)}}):{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){typeof e.initializer=="function"&&(this[e.key]=e.initializer.call(this))},finisher(t){t.createProperty(e.key,r)}};function c(r){return(e,t)=>t!==void 0?((i,a,o)=>{a.constructor.createProperty(o,i)})(r,e,t):bs(r,e)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */const _r=(r,e,t)=>{const i=new Map;for(let a=e;a<=t;a++)i.set(r[a],a);return i},uo=Ri(class extends Bi{constructor(r){if(super(r),r.type!==De.CHILD)throw Error("repeat() can only be used in text expressions")}dt(r,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);const a=[],o=[];let n=0;for(const l of r)a[n]=i?i(l,n):n,o[n]=t(l,n),n++;return{values:o,keys:a}}render(r,e,t){return this.dt(r,e,t).values}update(r,[e,t,i]){var a;const o=ks(r),{values:n,keys:l}=this.dt(e,t,i);if(!Array.isArray(o))return this.ut=l,n;const d=(a=this.ut)!==null&&a!==void 0?a:this.ut=[],h=[];let v,m,f=0,w=o.length-1,_=0,$=n.length-1;for(;f<=w&&_<=$;)if(o[f]===null)f++;else if(o[w]===null)w--;else if(d[f]===l[_])h[_]=qe(o[f],n[_]),f++,_++;else if(d[w]===l[$])h[$]=qe(o[w],n[$]),w--,$--;else if(d[f]===l[$])h[$]=qe(o[f],n[$]),Kt(r,h[$+1],o[f]),f++,$--;else if(d[w]===l[_])h[_]=qe(o[w],n[_]),Kt(r,o[f],o[w]),w--,_++;else if(v===void 0&&(v=_r(l,_,$),m=_r(d,f,w)),v.has(d[f]))if(v.has(d[w])){const D=m.get(l[_]),E=D!==void 0?o[D]:null;if(E===null){const O=Kt(r,o[f]);qe(O,n[_]),h[_]=O}else h[_]=qe(E,n[_]),Kt(r,o[f],E),o[D]=null;_++}else sa(o[w]),w--;else sa(o[f]),f++;for(;_<=$;){const D=Kt(r,h[$+1]);qe(D,n[_]),h[_++]=D}for(;f<=w;){const D=o[f++];D!==null&&sa(D)}return this.ut=l,ho(r,h),ge}});function gi(r,e,t){return Array.from({length:(e-r)/t+1},(i,a)=>r+a*t)}let Re=class extends F{constructor(){super(...arguments),this.itemCount=0,this.scrollOptimizationsDisabled=!1,this.intersectionObserver=new IntersectionObserver(e=>{e.forEach(t=>{if(t.target===this.sentinel){t.isIntersecting&&this.dispatchEvent(new Event("scrollThresholdReached"));return}const a=t.target.dataset.cellIndex;if(!a)return;const o=parseInt(a,10);t.isIntersecting?this.visibleCellIndices.add(o):this.visibleCellIndices.delete(o)}),this.scrollOptimizationsDisabled||this.processVisibleCells()}),this.renderedCellIndices=new Set,this.visibleCellIndices=new Set,this.placeholderCellIndices=new Set}reload(){gi(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.removeCell(t)),this.renderedCellIndices.clear(),this.visibleCellIndices.clear(),this.placeholderCellIndices.clear(),this.setupObservations()}scrollToCell(e,t){const i=this.cellContainers[e];if(!i)return!1;const a=t?"smooth":"auto";return i.scrollIntoView({behavior:a}),!0}getVisibleCellIndices(){return Array.from(this.visibleCellIndices)}updated(e){(e.has("itemCount")||e.has("scrollOptimizationsDisabled"))&&this.setupObservations()}disconnectedCallback(){this.intersectionObserver.disconnect()}setupObservations(){this.setupIntersectionObserver()}setupIntersectionObserver(){this.intersectionObserver.disconnect(),this.sentinel&&this.intersectionObserver.observe(this.sentinel),this.scrollOptimizationsDisabled?(gi(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.visibleCellIndices.add(t)),this.processVisibleCells()):this.cellContainers.forEach(e=>this.intersectionObserver.observe(e))}render(){const e=this.itemCount-1,t=gi(0,e,1);return p`
    ...
    `}};s([c({type:Number})],Re.prototype,"itemCount",void 0);s([c({type:Object})],Re.prototype,"cellProvider",void 0);s([c({type:Object})],Re.prototype,"placeholderCellTemplate",void 0);s([c({type:Boolean})],Re.prototype,"scrollOptimizationsDisabled",void 0);s([le("#sentinel")],Re.prototype,"sentinel",void 0);s([ws(".cell-container")],Re.prototype,"cellContainers",void 0);Re=s([R("infinite-scroller")],Re);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ts=(r,...e)=>({strTag:!0,strings:r,values:e}),yt=Ts,zs=r=>typeof r!="string"&&"strTag"in r,Ms=(r,e,t)=>{let i=r[0];for(let a=1;a<r.length;a++)i+=e[t?t[a-1]:a-1],i+=r[a];return i};/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ds=r=>zs(r)?Ms(r.strings,r.values):r;/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let As=new Es;As.resolve();/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let Je=Ds;const po=P`
...
`;let _a=class extends F{render(){var e,t,i;return p`
      <div id="container">
        ...
        <div id="item-count-container">
          <div id="item-count-image-container">${po}</div>
    ...
    `}};s([c({type:Object})],_a.prototype,"model",void 0);_a=s([R("collection-tile")],_a);function Mi(r,e="short",t="en-US"){if(!r)return"";const i={timeZone:"UTC"};switch(e){case"short":i.month="short",i.year="numeric";break;case"long":i.year="numeric",i.month="short",i.day="2-digit";break}return new Intl.DateTimeFormat(t,i).format(r)}const Ls=y`var(--collectionTileCornerRadius, 4px)`,Fs=y`var(--tileBackgroundColor, #ffffff)`,vo=y`
  .container {
    background-color: ${Fs};
    border: 1px #2c2c2c;
    border-radius: ${Ls};
 ...
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Sa=Ri(class extends Bi{constructor(r){var e;if(super(r),r.type!==De.ATTRIBUTE||r.name!=="class"||((e=r.strings)===null||e===void 0?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(r){return" "+Object.keys(r).filter(e=>r[e]).join(" ")+" "}update(r,[e]){var t,i;if(this.et===void 0){this.et=new Set,r.strings!==void 0&&(this.st=new Set(r.strings.join(" ").split(/\s/).filter(o=>o!=="")));for(const o in e)e[o]&&!(!((t=this.st)===null||t===void 0)&&t.has(o))&&this.et.add(o);return this.render(e)}const a=r.element.classList;this.et.forEach(o=>{o in e||(a.remove(o),this.et.delete(o))});for(const o in e){const n=!!e[o];n===this.et.has(o)||((i=this.st)===null||i===void 0?void 0:i.has(o))||(n?(a.add(o),this.et.add(o)):(a.remove(o),this.et.delete(o)))}return ge}}),mo=P`
  <svg
    viewBox="0 0 100 100"
    xmlns="http://www.w3.org/2000/svg"
  >
...
`;let ni=class extends F{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1,this.isCompactTile=!1}render(){return p`<div class="icon-overlay ${this.getClass}">
      ${this.iconDisplay}
    </div>`}get getClass(){return this.isCompactTile?"list-compact":"list-detail"}get iconDisplay(){return this.loginRequired&&!this.loggedIn?p`${fo}`:p`${mo}`}static get styles(){return y`
      :host {
        position: absolute;
        top: 50%;
        left: 50%;
    ...
    `}get iconDisplay(){return this.loginRequired&&!this.loggedIn?p`${fo}`:p`${mo}`}get textDisplay(){return this.loginRequired&&!this.loggedIn?p`Log in to view this item`:p`Content may be inappropriate`}static get styles(){return y`
      :host {
        align-items: center;
        display: flex;
      }
...
`,Ys={account:{color:"#000000",icon:Is,text:"Account"},audio:{color:"#00adef",icon:Ns,text:"Audio"},collection:{color:"#4666ff",icon:po,text:"Collection"},data:{color:"#333333",icon:Rs,text:"Data"},etree:{color:"#00adef",icon:Bs,text:"E-tree"},film:{color:"#bf1b2c",icon:Sr,text:"Film"},image:{color:"#aa99c9",icon:Hs,text:"Image"},movies:{color:"#f1644b",icon:Sr,text:"Movie"},radio:{color:"#8fdaef",icon:Us,text:"Radio"},software:{color:"#9ecc4f",icon:js,text:"Software"},texts:{color:"#faab3c",icon:Ws,text:"Text"},tv:{color:"#f1644b",icon:Vs,text:"TV"},video:{color:"#f1644b",icon:Gs,text:"Video"},web:{color:"#ffcd27",icon:Qs,text:"Web"}};let di=class extends F{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var e,t;const i=["tvnews","tvarchive","television"],a=["radio","radioprogram"];return this.mediatype==="movies"&&((e=this.collections)===null||e===void 0?void 0:e.some(o=>i.indexOf(o)>=0))?"tv":this.mediatype==="audio"&&((t=this.collections)===null||t===void 0?void 0:t.some(o=>a.indexOf(o)>=0))?"radio":this.mediatype||""}render(){const e=Ys[this.displayMediatype];return e?p`
      <div
        id="icon"
    ...
    `}};s([c({type:String})],di.prototype,"mediatype",void 0);s([c({type:Array})],di.prototype,"collections",void 0);s([c({type:Boolean})],di.prototype,"showText",void 0);di=s([R("mediatype-icon")],di);const Ks=P`
...
`;function Js(r,e){let t=1;return r>=1e9?t=1e9:r>=1e6?t=1e6:r>=1e3&&e==="short"&&(t=1e3),t}function en(r=0,e){const t=r/e,i=t<10;let a=0;return i?a=Math.round((t+Number.EPSILON)*10)/10:a=Math.round(t),a}function tn(r,e,t,i){switch(e){case 1e9:return Je(t==="short"?yt`${r}B`:yt`${r} billion`);case 1e6:return Je(t==="short"?yt`${r}M`:yt`${r} million`);case 1e3:return Je(t==="short"?yt`${r}K`:yt`${r} thousand`);default:return new Intl.NumberFormat(i).format(r)}}function Jt(r,e="long",t="short",i="en-US"){const a=r!=null?r:-1;if(a<0)return"";const o=Js(a,e),n=en(a,o);return tn(n,o,t,i)}let ot=class extends F{render(){const e=Jt(this.favCount,"short","short"),t=Jt(this.commentCount,"short","short"),i=this.mediatype==="account"?`${this.itemCount} uploads`:`${this.viewCount} all-time views`;return p`
    ...
    `}get doesSortedByDate(){var e;return["date","reviewdate","addeddate","publicdate"].includes((e=this.sortParam)===null||e===void 0?void 0:e.field)}get hasSnippets(){var e,t;return!!(!((t=(e=this.model)===null||e===void 0?void 0:e.snippets)===null||t===void 0)&&t.length)}static get styles(){return[vo,y`
        image-block {
    ...
    >
    </tile-stats>`}static get styles(){return[vo,y`
        image-block {
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class Ca extends Bi{constructor(e){if(super(e),this.it=x,e.type!==De.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===x||e==null)return this.ft=void 0,this.it=e;if(e===ge)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this.ft;this.it=e;const t=[e];return t.raw=t,this.ft={_$litType$:this.constructor.resultType,strings:t,values:[]}}}Ca.directiveName="unsafeHTML",Ca.resultType=1;const an=Ri(Ca);/*! @license DOMPurify 2.3.8 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/2.3.8/LICENSE */function et(r){return et=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},et(r)}function ka(r,e){return ka=Object.setPrototypeOf||function(i,a){return i.__proto__=a,i},ka(r,e)}function rn(){if(typeof Reflect=="undefined"||!Reflect.construct||Reflect.construct.sham)return!1;if(typeof Proxy=="function")return!0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],function(){})),!0}catch{return!1}}function Si(r,e,t){return rn()?Si=Reflect.construct:Si=function(a,o,n){var l=[null];l.push.apply(l,o);var d=Function.bind.apply(a,l),h=new d;return n&&ka(h,n.prototype),h},Si.apply(null,arguments)}function be(r){return on(r)||sn(r)||nn(r)||ln()}function on(r){if(Array.isArray(r))return Ta(r)}function sn(r){if(typeof Symbol!="undefined"&&r[Symbol.iterator]!=null||r["@@iterator"]!=null)return Array.from(r)}function nn(r,e){if(!!r){if(typeof r=="string")return Ta(r,e);var t=Object.prototype.toString.call(r).slice(8,-1);if(t==="Object"&&r.constructor&&(t=r.constructor.name),t==="Map"||t==="Set")return Array.from(r);if(t==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t))return Ta(r,e)}}function Ta(r,e){(e==null||e>r.length)&&(e=r.length);for(var t=0,i=new Array(e);t<e;t++)i[t]=r[t];return i}function ln(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}var dn=Object.hasOwnProperty,$r=Object.setPrototypeOf,cn=Object.isFrozen,hn=Object.getPrototypeOf,un=Object.getOwnPropertyDescriptor,pe=Object.freeze,Ce=Object.seal,pn=Object.create,go=typeof Reflect!="undefined"&&Reflect,Ai=go.apply,za=go.construct;Ai||(Ai=function(e,t,i){return e.apply(t,i)});pe||(pe=function(e){return e});Ce||(Ce=function(e){return e});za||(za=function(e,t){return Si(e,be(t))});var vn=xe(Array.prototype.forEach),Cr=xe(Array.prototype.pop),qt=xe(Array.prototype.push),$i=xe(String.prototype.toLowerCase),mn=xe(String.prototype.match),Fe=xe(String.prototype.replace),fn=xe(String.prototype.indexOf),gn=xe(String.prototype.trim),he=xe(RegExp.prototype.test),na=yn(TypeError);function xe(r){return function(e){for(var t=arguments.length,i=new Array(t>1?t-1:0),a=1;a<t;a++)i[a-1]=arguments[a];return Ai(r,e,i)}}function yn(r){return function(){for(var e=arguments.length,t=new Array(e),i=0;i<e;i++)t[i]=arguments[i];return za(r,t)}}function A(r,e){$r&&$r(r,null);for(var t=e.length;t--;){var i=e[t];if(typeof i=="string"){var a=$i(i);a!==i&&(cn(e)||(e[t]=a),i=a)}r[i]=!0}return r}function Xe(r){var e=pn(null),t;for(t in r)Ai(dn,r,[t])&&(e[t]=r[t]);return e}function yi(r,e){for(;r!==null;){var t=un(r,e);if(t){if(t.get)return xe(t.get);if(typeof t.value=="function")return xe(t.value)}r=hn(r)}function i(a){return console.warn("fallback value for",a),null}return i}var kr=pe(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","section","select","shadow","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),la=pe(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","filter","font","g","glyph","glyphref","hkern","image","line","lineargradient","marker","mask","metadata","mpath","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),da=pe(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),bn=pe(["animate","color-profile","cursor","discard","fedropshadow","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),ca=pe(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover"]),wn=pe(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),Tr=pe(["#text"]),zr=pe(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","face","for","headers","height","hidden","high","href","hreflang","id","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","pattern","placeholder","playsinline","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","xmlns","slot"]),ha=pe(["accent-height","accumulate","additive","alignment-baseline","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),Mr=pe(["accent","accentunder","align","bevelled","close","columnsalign","columnlines","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lspace","lquote","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),bi=pe(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),xn=Ce(/\{\{[\w\W]*|[\w\W]*\}\}/gm),_n=Ce(/<%[\w\W]*|[\w\W]*%>/gm),Sn=Ce(/^data-[\-\w.\u00B7-\uFFFF]/),$n=Ce(/^aria-[\-\w]+$/),Cn=Ce(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|cid|xmpp):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),kn=Ce(/^(?:\w+script|data):/i),Tn=Ce(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),zn=Ce(/^html$/i),Mn=function(){return typeof window=="undefined"?null:window},Dn=function(e,t){if(et(e)!=="object"||typeof e.createPolicy!="function")return null;var i=null,a="data-tt-policy-suffix";t.currentScript&&t.currentScript.hasAttribute(a)&&(i=t.currentScript.getAttribute(a));var o="dompurify"+(i?"#"+i:"");try{return e.createPolicy(o,{createHTML:function(l){return l}})}catch{return console.warn("TrustedTypes policy "+o+" could not be created."),null}};function yo(){var r=arguments.length>0&&arguments[0]!==void 0?arguments[0]:Mn(),e=function(u){return yo(u)};if(e.version="2.3.8",e.removed=[],!r||!r.document||r.document.nodeType!==9)return e.isSupported=!1,e;var t=r.document,i=r.document,a=r.DocumentFragment,o=r.HTMLTemplateElement,n=r.Node,l=r.Element,d=r.NodeFilter,h=r.NamedNodeMap,v=h===void 0?r.NamedNodeMap||r.MozNamedAttrMap:h,m=r.HTMLFormElement,f=r.DOMParser,w=r.trustedTypes,_=l.prototype,$=yi(_,"cloneNode"),D=yi(_,"nextSibling"),E=yi(_,"childNodes"),O=yi(_,"parentNode");if(typeof o=="function"){var N=i.createElement("template");N.content&&N.content.ownerDocument&&(i=N.content.ownerDocument)}var B=Dn(w,t),K=B?B.createHTML(""):"",oe=i,Se=oe.implementation,Nt=oe.createNodeIterator,Rt=oe.createDocumentFragment,Bt=oe.getElementsByTagName,Ht=t.importNode,st={};try{st=Xe(i).documentMode?i.documentMode:{}}catch{}var ve={};e.isSupported=typeof O=="function"&&Se&&typeof Se.createHTMLDocument!="undefined"&&st!==9;var Ue=xn,je=_n,Ut=Sn,jt=$n,Wt=kn,nt=Tn,We=Cn,q=null,lt=A({},[].concat(be(kr),be(la),be(da),be(ca),be(Tr))),X=null,dt=A({},[].concat(be(zr),be(ha),be(Mr),be(bi))),V=Object.seal(Object.create(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),Te=null,Ve=null,ct=!0,Ge=!0,Vt=!1,ht=!1,Qe=!1,Ui=!1,ji=!1,ut=!1,ui=!1,pi=!1,Wa=!0,Wi=!0,Gt=!1,pt={},vt=null,Va=A({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","style","svg","template","thead","title","video","xmp"]),Ga=null,Qa=A({},["audio","video","img","source","image","track"]),Vi=null,Ya=A({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),Gi="http://www.w3.org/1998/Math/MathML",Qi="http://www.w3.org/2000/svg",Le="http://www.w3.org/1999/xhtml",vi=Le,Yi=!1,mt,Ao=["application/xhtml+xml","text/html"],Lo="text/html",Ye,ft=null,Fo=i.createElement("form"),Ka=function(u){return u instanceof RegExp||u instanceof Function},Ki=function(u){ft&&ft===u||((!u||et(u)!=="object")&&(u={}),u=Xe(u),q="ALLOWED_TAGS"in u?A({},u.ALLOWED_TAGS):lt,X="ALLOWED_ATTR"in u?A({},u.ALLOWED_ATTR):dt,Vi="ADD_URI_SAFE_ATTR"in u?A(Xe(Ya),u.ADD_URI_SAFE_ATTR):Ya,Ga="ADD_DATA_URI_TAGS"in u?A(Xe(Qa),u.ADD_DATA_URI_TAGS):Qa,vt="FORBID_CONTENTS"in u?A({},u.FORBID_CONTENTS):Va,Te="FORBID_TAGS"in u?A({},u.FORBID_TAGS):{},Ve="FORBID_ATTR"in u?A({},u.FORBID_ATTR):{},pt="USE_PROFILES"in u?u.USE_PROFILES:!1,ct=u.ALLOW_ARIA_ATTR!==!1,Ge=u.ALLOW_DATA_ATTR!==!1,Vt=u.ALLOW_UNKNOWN_PROTOCOLS||!1,ht=u.SAFE_FOR_TEMPLATES||!1,Qe=u.WHOLE_DOCUMENT||!1,ut=u.RETURN_DOM||!1,ui=u.RETURN_DOM_FRAGMENT||!1,pi=u.RETURN_TRUSTED_TYPE||!1,ji=u.FORCE_BODY||!1,Wa=u.SANITIZE_DOM!==!1,Wi=u.KEEP_CONTENT!==!1,Gt=u.IN_PLACE||!1,We=u.ALLOWED_URI_REGEXP||We,vi=u.NAMESPACE||Le,u.CUSTOM_ELEMENT_HANDLING&&Ka(u.CUSTOM_ELEMENT_HANDLING.tagNameCheck)&&(V.tagNameCheck=u.CUSTOM_ELEMENT_HANDLING.tagNameCheck),u.CUSTOM_ELEMENT_HANDLING&&Ka(u.CUSTOM_ELEMENT_HANDLING.attributeNameCheck)&&(V.attributeNameCheck=u.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),u.CUSTOM_ELEMENT_HANDLING&&typeof u.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements=="boolean"&&(V.allowCustomizedBuiltInElements=u.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements),mt=Ao.indexOf(u.PARSER_MEDIA_TYPE)===-1?mt=Lo:mt=u.PARSER_MEDIA_TYPE,Ye=mt==="application/xhtml+xml"?function(b){return b}:$i,ht&&(Ge=!1),ui&&(ut=!0),pt&&(q=A({},be(Tr)),X=[],pt.html===!0&&(A(q,kr),A(X,zr)),pt.svg===!0&&(A(q,la),A(X,ha),A(X,bi)),pt.svgFilters===!0&&(A(q,da),A(X,ha),A(X,bi)),pt.mathMl===!0&&(A(q,ca),A(X,Mr),A(X,bi))),u.ADD_TAGS&&(q===lt&&(q=Xe(q)),A(q,u.ADD_TAGS)),u.ADD_ATTR&&(X===dt&&(X=Xe(X)),A(X,u.ADD_ATTR)),u.ADD_URI_SAFE_ATTR&&A(Vi,u.ADD_URI_SAFE_ATTR),u.FORBID_CONTENTS&&(vt===Va&&(vt=Xe(vt)),A(vt,u.FORBID_CONTENTS)),Wi&&(q["#text"]=!0),Qe&&A(q,["html","head","body"]),q.table&&(A(q,["tbody"]),delete Te.tbody),pe&&pe(u),ft=u)},qa=A({},["mi","mo","mn","ms","mtext"]),Xa=A({},["foreignobject","desc","title","annotation-xml"]),Oo=A({},["title","style","font","a","script"]),mi=A({},la);A(mi,da),A(mi,bn);var qi=A({},ca);A(qi,wn);var Po=function(u){var b=O(u);(!b||!b.tagName)&&(b={namespaceURI:Le,tagName:"template"});var S=$i(u.tagName),H=$i(b.tagName);return u.namespaceURI===Qi?b.namespaceURI===Le?S==="svg":b.namespaceURI===Gi?S==="svg"&&(H==="annotation-xml"||qa[H]):Boolean(mi[S]):u.namespaceURI===Gi?b.namespaceURI===Le?S==="math":b.namespaceURI===Qi?S==="math"&&Xa[H]:Boolean(qi[S]):u.namespaceURI===Le?b.namespaceURI===Qi&&!Xa[H]||b.namespaceURI===Gi&&!qa[H]?!1:!qi[S]&&(Oo[S]||!mi[S]):!1},ze=function(u){qt(e.removed,{element:u});try{u.parentNode.removeChild(u)}catch{try{u.outerHTML=K}catch{u.remove()}}},Za=function(u,b){try{qt(e.removed,{attribute:b.getAttributeNode(u),from:b})}catch{qt(e.removed,{attribute:null,from:b})}if(b.removeAttribute(u),u==="is"&&!X[u])if(ut||ui)try{ze(b)}catch{}else try{b.setAttribute(u,"")}catch{}},Ja=function(u){var b,S;if(ji)u="<remove></remove>"+u;else{var H=mn(u,/^[\r\n\t ]+/);S=H&&H[0]}mt==="application/xhtml+xml"&&(u='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+u+"</body></html>");var me=B?B.createHTML(u):u;if(vi===Le)try{b=new f().parseFromString(me,mt)}catch{}if(!b||!b.documentElement){b=Se.createDocument(vi,"template",null);try{b.documentElement.innerHTML=Yi?"":me}catch{}}var se=b.body||b.documentElement;return u&&S&&se.insertBefore(i.createTextNode(S),se.childNodes[0]||null),vi===Le?Bt.call(b,Qe?"html":"body")[0]:Qe?b.documentElement:se},er=function(u){return Nt.call(u.ownerDocument||u,u,d.SHOW_ELEMENT|d.SHOW_COMMENT|d.SHOW_TEXT,null,!1)},Io=function(u){return u instanceof m&&(typeof u.nodeName!="string"||typeof u.textContent!="string"||typeof u.removeChild!="function"||!(u.attributes instanceof v)||typeof u.removeAttribute!="function"||typeof u.setAttribute!="function"||typeof u.namespaceURI!="string"||typeof u.insertBefore!="function")},Qt=function(u){return et(n)==="object"?u instanceof n:u&&et(u)==="object"&&typeof u.nodeType=="number"&&typeof u.nodeName=="string"},Me=function(u,b,S){!ve[u]||vn(ve[u],function(H){H.call(e,b,S,ft)})},tr=function(u){var b;if(Me("beforeSanitizeElements",u,null),Io(u)||he(/[\u0080-\uFFFF]/,u.nodeName))return ze(u),!0;var S=Ye(u.nodeName);if(Me("uponSanitizeElement",u,{tagName:S,allowedTags:q}),u.hasChildNodes()&&!Qt(u.firstElementChild)&&(!Qt(u.content)||!Qt(u.content.firstElementChild))&&he(/<[/\w]/g,u.innerHTML)&&he(/<[/\w]/g,u.textContent)||S==="select"&&he(/<template/i,u.innerHTML))return ze(u),!0;if(!q[S]||Te[S]){if(!Te[S]&&ar(S)&&(V.tagNameCheck instanceof RegExp&&he(V.tagNameCheck,S)||V.tagNameCheck instanceof Function&&V.tagNameCheck(S)))return!1;if(Wi&&!vt[S]){var H=O(u)||u.parentNode,me=E(u)||u.childNodes;if(me&&H)for(var se=me.length,ie=se-1;ie>=0;--ie)H.insertBefore($(me[ie],!0),D(u))}return ze(u),!0}return u instanceof l&&!Po(u)||(S==="noscript"||S==="noembed")&&he(/<\/no(script|embed)/i,u.innerHTML)?(ze(u),!0):(ht&&u.nodeType===3&&(b=u.textContent,b=Fe(b,Ue," "),b=Fe(b,je," "),u.textContent!==b&&(qt(e.removed,{element:u.cloneNode()}),u.textContent=b)),Me("afterSanitizeElements",u,null),!1)},ir=function(u,b,S){if(Wa&&(b==="id"||b==="name")&&(S in i||S in Fo))return!1;if(!(Ge&&!Ve[b]&&he(Ut,b))){if(!(ct&&he(jt,b))){if(!X[b]||Ve[b]){if(!(ar(u)&&(V.tagNameCheck instanceof RegExp&&he(V.tagNameCheck,u)||V.tagNameCheck instanceof Function&&V.tagNameCheck(u))&&(V.attributeNameCheck instanceof RegExp&&he(V.attributeNameCheck,b)||V.attributeNameCheck instanceof Function&&V.attributeNameCheck(b))||b==="is"&&V.allowCustomizedBuiltInElements&&(V.tagNameCheck instanceof RegExp&&he(V.tagNameCheck,S)||V.tagNameCheck instanceof Function&&V.tagNameCheck(S))))return!1}else if(!Vi[b]){if(!he(We,Fe(S,nt,""))){if(!((b==="src"||b==="xlink:href"||b==="href")&&u!=="script"&&fn(S,"data:")===0&&Ga[u])){if(!(Vt&&!he(Wt,Fe(S,nt,"")))){if(S)return!1}}}}}}return!0},ar=function(u){return u.indexOf("-")>0},rr=function(u){var b,S,H,me;Me("beforeSanitizeAttributes",u,null);var se=u.attributes;if(!!se){var ie={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:X};for(me=se.length;me--;){b=se[me];var fi=b,de=fi.name,or=fi.namespaceURI;if(S=de==="value"?b.value:gn(b.value),H=Ye(de),ie.attrName=H,ie.attrValue=S,ie.keepAttr=!0,ie.forceKeepAttr=void 0,Me("uponSanitizeAttribute",u,ie),S=ie.attrValue,!ie.forceKeepAttr&&(Za(de,u),!!ie.keepAttr)){if(he(/\/>/i,S)){Za(de,u);continue}ht&&(S=Fe(S,Ue," "),S=Fe(S,je," "));var Ro=Ye(u.nodeName);if(!!ir(Ro,H,S))try{or?u.setAttributeNS(or,de,S):u.setAttribute(de,S),Cr(e.removed)}catch{}}}Me("afterSanitizeAttributes",u,null)}},No=function C(u){var b,S=er(u);for(Me("beforeSanitizeShadowDOM",u,null);b=S.nextNode();)Me("uponSanitizeShadowNode",b,null),!tr(b)&&(b.content instanceof a&&C(b.content),rr(b));Me("afterSanitizeShadowDOM",u,null)};return e.sanitize=function(C,u){var b,S,H,me,se;if(Yi=!C,Yi&&(C="<!-->"),typeof C!="string"&&!Qt(C)){if(typeof C.toString!="function")throw na("toString is not a function");if(C=C.toString(),typeof C!="string")throw na("dirty is not a string, aborting")}if(!e.isSupported){if(et(r.toStaticHTML)==="object"||typeof r.toStaticHTML=="function"){if(typeof C=="string")return r.toStaticHTML(C);if(Qt(C))return r.toStaticHTML(C.outerHTML)}return C}if(Ui||Ki(u),e.removed=[],typeof C=="string"&&(Gt=!1),Gt){if(C.nodeName){var ie=Ye(C.nodeName);if(!q[ie]||Te[ie])throw na("root node is forbidden and cannot be sanitized in-place")}}else if(C instanceof n)b=Ja("<!---->"),S=b.ownerDocument.importNode(C,!0),S.nodeType===1&&S.nodeName==="BODY"||S.nodeName==="HTML"?b=S:b.appendChild(S);else{if(!ut&&!ht&&!Qe&&C.indexOf("<")===-1)return B&&pi?B.createHTML(C):C;if(b=Ja(C),!b)return ut?null:pi?K:""}b&&ji&&ze(b.firstChild);for(var fi=er(Gt?C:b);H=fi.nextNode();)H.nodeType===3&&H===me||tr(H)||(H.content instanceof a&&No(H.content),rr(H),me=H);if(me=null,Gt)return C;if(ut){if(ui)for(se=Rt.call(b.ownerDocument);b.firstChild;)se.appendChild(b.firstChild);else se=b;return X.shadowroot&&(se=Ht.call(t,se,!0)),se}var de=Qe?b.outerHTML:b.innerHTML;return Qe&&q["!doctype"]&&b.ownerDocument&&b.ownerDocument.doctype&&b.ownerDocument.doctype.name&&he(zn,b.ownerDocument.doctype.name)&&(de="<!DOCTYPE "+b.ownerDocument.doctype.name+`>
`+de),ht&&(de=Fe(de,Ue," "),de=Fe(de,je," ")),B&&pi?B.createHTML(de):de},e.setConfig=function(C){Ki(C),Ui=!0},e.clearConfig=function(){ft=null,Ui=!1},e.isValidAttribute=function(C,u,b){ft||Ki({});var S=Ye(C),H=Ye(u);return ir(S,H,b)},e.addHook=function(C,u){typeof u=="function"&&(ve[C]=ve[C]||[],qt(ve[C],u))},e.removeHook=function(C){if(ve[C])return Cr(ve[C])},e.removeHooks=function(C){ve[C]&&(ve[C]=[])},e.removeAllHooks=function(){ve={}},e}var ei=yo(),L;(function(r){r.relevance="relevance",r.alltimeview="alltimeview",r.weeklyview="weeklyview",r.title="title",r.datearchived="datearchived",r.date="date",r.datereviewed="datereviewed",r.dateadded="dateadded",r.creator="creator"})(L||(L={}));const Ze={relevance:"Relevance",alltimeview:"All-time Views",weeklyview:"Weekly Views",title:"Title",datearchived:"Date Archived",date:"Date Published",datereviewed:"Date Reviewed",dateadded:"Date Added",creator:"Creator"},En={relevance:null,alltimeview:"downloads",weeklyview:"week",title:"titleSorter",datearchived:"publicdate",date:"date",datereviewed:"reviewdate",dateadded:"addeddate",creator:"creatorSorter"},Dr={week:L.weeklyview,downloads:L.alltimeview,titleSorter:L.title,date:L.date,publicdate:L.datearchived,reviewdate:L.datereviewed,addeddate:L.dateadded,creatorSorter:L.creator},An={title:"firstTitle",creator:"firstCreator"},Li={subject:{},lending:{},mediatype:{},language:{},creator:{},collection:{},year:{}},Ln=["mediatype","lending","year","subject","collection","creator","language"],Fi={subject:"Subject",lending:"Availability",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"},Fn={is_lendable:!0,is_borrowable:!1,available_to_borrow:!0,is_browsable:!1,available_to_browse:!1,is_readable:!0,available_to_waitlist:!1},Er={is_lendable:"Lending Library",available_to_borrow:"Borrow 14 Days",is_readable:"Always Available"},Na={deemphasize:!0,community:!0,stream_only:!0,samples_only:!0,test_collection:!0,printdisabled:!0,"openlibrary-ol":!0,nationalemergencylibrary:!0,china:!0,americana:!0,toronto:!0};function bo(r){switch(r){case"date":return"Published";case"reviewdate":return"Reviewed";case"addeddate":return"Added";default:return"Archived"}}function wo(r){return r?`Archivist since ${r.getFullYear()}`:""}let ye=class extends F{constructor(){super(...arguments),this.sortParam=null,this.collectionLinks=[],this.loggedIn=!1}updated(e){e.has("model")&&this.fetchCollectionNames()}async fetchCollectionNames(){var e,t;if(!(!((e=this.model)===null||e===void 0)&&e.collections)||this.model.collections.length===0||!this.collectionNameCache)return;this.collectionLinks=[];const i=[],a=[];for(const o of this.model.collections)!Na[o]&&!o.startsWith("fav-")&&a.push((t=this.collectionNameCache)===null||t===void 0?void 0:t.collectionNameFor(o).then(n=>{i.push(this.detailsLink(o,n!=null?n:o))}));await Promise.all(a),this.collectionLinks=i}render(){return p`
    ...
    `:x}get volumeTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.volume,"Volume")}get issueTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.issue,"Issue")}get creatorTemplate(){var e,t,i;return((e=this.model)===null||e===void 0?void 0:e.mediatype)==="account"?p`
        <div id="creator" class="metadata">
          <span class="label"> ${wo((t=this.model)===null||t===void 0?void 0:t.dateAdded)} </span>
        </div>
    ...
    `}get descriptionTemplate(){var e,t,i;return this.metadataTemplate(an(ei.sanitize((i=(t=(e=this.model)===null||e===void 0?void 0:e.description)===null||t===void 0?void 0:t.replace(/\n/g," "))!==null&&i!==void 0?i:"")),"","description")}get textSnippetsTemplate(){var e;return this.hasSnippets?p`<text-snippet-block
      viewsize="list"
    ...
    `}};s([c({type:Object})],He.prototype,"model",void 0);s([c({type:String})],He.prototype,"baseNavigationUrl",void 0);s([c({type:String})],He.prototype,"baseImageUrl",void 0);s([c({type:Boolean})],He.prototype,"loggedIn",void 0);s([c({type:Object})],He.prototype,"sortParam",void 0);s([c({type:Object})],He.prototype,"collectionNameCache",void 0);He=s([R("tile-hover-pane")],He);let ke=class extends F{constructor(){super(...arguments),this.sortParam=null,this.loggedIn=!1}render(){var e,t,i,a,o,n,l,d,h;return p`
      <div id="list-line" class="${this.classSize}">
        ...
        <div id="creator">
          ${((i=this.model)===null||i===void 0?void 0:i.mediatype)==="account"?wo((a=this.model)===null||a===void 0?void 0:a.dateAdded):ei.sanitize((n=(o=this.model)===null||o===void 0?void 0:o.creator)!==null&&n!==void 0?n:"")}
        </div>
    ...
    `}};s([c({type:Object})],ke.prototype,"model",void 0);s([c({type:String})],ke.prototype,"baseNavigationUrl",void 0);s([c({type:Number})],ke.prototype,"currentWidth",void 0);s([c({type:Number})],ke.prototype,"currentHeight",void 0);s([c({type:Object})],ke.prototype,"sortParam",void 0);s([c({type:Number})],ke.prototype,"mobileBreakpoint",void 0);s([c({type:String})],ke.prototype,"baseImageUrl",void 0);s([c({type:Boolean})],ke.prototype,"loggedIn",void 0);ke=s([R("tile-list-compact")],ke);let Et=class extends F{constructor(){super(...arguments),this.sortParam=null}render(){var e;return p`
      <div id="list-line-header" class="${this.classSize}">
        ...
        <div id="date">${bo((e=this.sortParam)===null||e===void 0?void 0:e.field)}</div>
        <div id="icon"></div>
    ...
    `}};s([c({type:Object})],Et.prototype,"model",void 0);s([c({type:Number})],Et.prototype,"currentWidth",void 0);s([c({type:Object})],Et.prototype,"sortParam",void 0);s([c({type:Number})],Et.prototype,"mobileBreakpoint",void 0);Et=s([R("tile-list-compact-header")],Et);let G=class extends F{constructor(){super(...arguments),this.sortParam=null,this.loggedIn=!1,this.enableHoverPane=!1,this.showHoverPaneDelay=300,this.hideHoverPaneDelay=100,this.hoverPaneOffsetX=-10,this.hoverPaneOffsetY=15,this.hoverPaneState="hidden",this.lastMouseClientPos={x:0,y:0}}render(){const e=this.tileDisplayMode==="grid";return p`
      <div
        id="container"
        class=${e?"hoverable":x}
        @mousemove=${e?this.handleMouseMove:x}
        @mouseleave=${e?this.handleMouseLeave:x}
      >
    ...
    `}};Ar=s([R("collection-browser-loading-tile")],Ar);let ci=class extends F{constructor(){super(...arguments),this.selectedLetter=null,this.alphabet="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("")}get selectedUppercaseLetter(){var e;return(e=this.selectedLetter)===null||e===void 0?void 0:e.toUpperCase()}render(){return p`
      <div id="container">
        <ul>
  ...
  `;s([c({type:String})],ci.prototype,"selectedLetter",void 0);s([c({type:Object})],ci.prototype,"letterCounts",void 0);ci=s([R("alpha-bar")],ci);const Lr=P`
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Fr=Ri(class extends Bi{constructor(r){if(super(r),r.type!==De.PROPERTY&&r.type!==De.ATTRIBUTE&&r.type!==De.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!$s(r))throw Error("`live` bindings can only contain a single expression")}render(r){return r}update(r,[e]){if(e===ge||e===x)return e;const t=r.element,i=r.name;if(r.type===De.PROPERTY){if(e===t[i])return ge}else if(r.type===De.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(i))return ge}else if(r.type===De.ATTRIBUTE&&t.getAttribute(i)===e+"")return ge;return ho(r),e}});var xo=60,_o=xo*60,So=_o*24,Nn=So*7,At=1e3,ua=xo*At,Or=_o*At,Rn=So*At,Bn=Nn*At,Ra="millisecond",_t="second",St="minute",$t="hour",Oe="day",Ci="week",we="month",$o="quarter",Pe="year",Ct="date",Hn="YYYY-MM-DDTHH:mm:ssZ",Pr="Invalid Date",Un=/^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/,jn=/\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g,Wn={name:"en",weekdays:"Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),months:"January_February_March_April_May_June_July_August_September_October_November_December".split("_")},Ma=function(e,t,i){var a=String(e);return!a||a.length>=t?e:""+Array(t+1-a.length).join(i)+e},Vn=function(e){var t=-e.utcOffset(),i=Math.abs(t),a=Math.floor(i/60),o=i%60;return(t<=0?"+":"-")+Ma(a,2,"0")+":"+Ma(o,2,"0")},Gn=function r(e,t){if(e.date()<t.date())return-r(t,e);var i=(t.year()-e.year())*12+(t.month()-e.month()),a=e.clone().add(i,we),o=t-a<0,n=e.clone().add(i+(o?-1:1),we);return+(-(i+(t-a)/(o?a-n:n-a))||0)},Qn=function(e){return e<0?Math.ceil(e)||0:Math.floor(e)},Yn=function(e){var t={M:we,y:Pe,w:Ci,d:Oe,D:Ct,h:$t,m:St,s:_t,ms:Ra,Q:$o};return t[e]||String(e||"").toLowerCase().replace(/s$/,"")},Kn=function(e){return e===void 0},qn={s:Ma,z:Vn,m:Gn,a:Qn,p:Yn,u:Kn},ti="en",tt={};tt[ti]=Wn;var Ba=function(e){return e instanceof Hi},Oi=function r(e,t,i){var a;if(!e)return ti;if(typeof e=="string"){var o=e.toLowerCase();tt[o]&&(a=o),t&&(tt[o]=t,a=o);var n=e.split("-");if(!a&&n.length>1)return r(n[0])}else{var l=e.name;tt[l]=e,a=l}return!i&&a&&(ti=a),a||!i&&ti},ee=function(e,t){if(Ba(e))return e.clone();var i=typeof t=="object"?t:{};return i.date=e,i.args=arguments,new Hi(i)},Xn=function(e,t){return ee(e,{locale:t.$L,utc:t.$u,x:t.$x,$offset:t.$offset})},U=qn;U.l=Oi;U.i=Ba;U.w=Xn;var Zn=function(e){var t=e.date,i=e.utc;if(t===null)return new Date(NaN);if(U.u(t))return new Date;if(t instanceof Date)return new Date(t);if(typeof t=="string"&&!/Z$/i.test(t)){var a=t.match(Un);if(a){var o=a[2]-1||0,n=(a[7]||"0").substring(0,3);return i?new Date(Date.UTC(a[1],o,a[3]||1,a[4]||0,a[5]||0,a[6]||0,n)):new Date(a[1],o,a[3]||1,a[4]||0,a[5]||0,a[6]||0,n)}}return new Date(t)},Hi=function(){function r(t){this.$L=Oi(t.locale,null,!0),this.parse(t)}var e=r.prototype;return e.parse=function(i){this.$d=Zn(i),this.$x=i.x||{},this.init()},e.init=function(){var i=this.$d;this.$y=i.getFullYear(),this.$M=i.getMonth(),this.$D=i.getDate(),this.$W=i.getDay(),this.$H=i.getHours(),this.$m=i.getMinutes(),this.$s=i.getSeconds(),this.$ms=i.getMilliseconds()},e.$utils=function(){return U},e.isValid=function(){return this.$d.toString()!==Pr},e.isSame=function(i,a){var o=ee(i);return this.startOf(a)<=o&&o<=this.endOf(a)},e.isAfter=function(i,a){return ee(i)<this.startOf(a)},e.isBefore=function(i,a){return this.endOf(a)<ee(i)},e.$g=function(i,a,o){return U.u(i)?this[a]:this.set(o,i)},e.unix=function(){return Math.floor(this.valueOf()/1e3)},e.valueOf=function(){return this.$d.getTime()},e.startOf=function(i,a){var o=this,n=U.u(a)?!0:a,l=U.p(i),d=function(E,O){var N=U.w(o.$u?Date.UTC(o.$y,O,E):new Date(o.$y,O,E),o);return n?N:N.endOf(Oe)},h=function(E,O){var N=[0,0,0,0],B=[23,59,59,999];return U.w(o.toDate()[E].apply(o.toDate("s"),(n?N:B).slice(O)),o)},v=this.$W,m=this.$M,f=this.$D,w="set"+(this.$u?"UTC":"");switch(l){case Pe:return n?d(1,0):d(31,11);case we:return n?d(1,m):d(0,m+1);case Ci:{var _=this.$locale().weekStart||0,$=(v<_?v+7:v)-_;return d(n?f-$:f+(6-$),m)}case Oe:case Ct:return h(w+"Hours",0);case $t:return h(w+"Minutes",1);case St:return h(w+"Seconds",2);case _t:return h(w+"Milliseconds",3);default:return this.clone()}},e.endOf=function(i){return this.startOf(i,!1)},e.$set=function(i,a){var o,n=U.p(i),l="set"+(this.$u?"UTC":""),d=(o={},o[Oe]=l+"Date",o[Ct]=l+"Date",o[we]=l+"Month",o[Pe]=l+"FullYear",o[$t]=l+"Hours",o[St]=l+"Minutes",o[_t]=l+"Seconds",o[Ra]=l+"Milliseconds",o)[n],h=n===Oe?this.$D+(a-this.$W):a;if(n===we||n===Pe){var v=this.clone().set(Ct,1);v.$d[d](h),v.init(),this.$d=v.set(Ct,Math.min(this.$D,v.daysInMonth())).$d}else d&&this.$d[d](h);return this.init(),this},e.set=function(i,a){return this.clone().$set(i,a)},e.get=function(i){return this[U.p(i)]()},e.add=function(i,a){var o=this,n;i=Number(i);var l=U.p(a),d=function(f){var w=ee(o);return U.w(w.date(w.date()+Math.round(f*i)),o)};if(l===we)return this.set(we,this.$M+i);if(l===Pe)return this.set(Pe,this.$y+i);if(l===Oe)return d(1);if(l===Ci)return d(7);var h=(n={},n[St]=ua,n[$t]=Or,n[_t]=At,n)[l]||1,v=this.$d.getTime()+i*h;return U.w(v,this)},e.subtract=function(i,a){return this.add(i*-1,a)},e.format=function(i){var a=this,o=this.$locale();if(!this.isValid())return o.invalidDate||Pr;var n=i||Hn,l=U.z(this),d=this.$H,h=this.$m,v=this.$M,m=o.weekdays,f=o.months,w=o.meridiem,_=function(N,B,K,oe){return N&&(N[B]||N(a,n))||K[B].slice(0,oe)},$=function(N){return U.s(d%12||12,N,"0")},D=w||function(O,N,B){var K=O<12?"AM":"PM";return B?K.toLowerCase():K},E={YY:String(this.$y).slice(-2),YYYY:this.$y,M:v+1,MM:U.s(v+1,2,"0"),MMM:_(o.monthsShort,v,f,3),MMMM:_(f,v),D:this.$D,DD:U.s(this.$D,2,"0"),d:String(this.$W),dd:_(o.weekdaysMin,this.$W,m,2),ddd:_(o.weekdaysShort,this.$W,m,3),dddd:m[this.$W],H:String(d),HH:U.s(d,2,"0"),h:$(1),hh:$(2),a:D(d,h,!0),A:D(d,h,!1),m:String(h),mm:U.s(h,2,"0"),s:String(this.$s),ss:U.s(this.$s,2,"0"),SSS:U.s(this.$ms,3,"0"),Z:l};return n.replace(jn,function(O,N){return N||E[O]||l.replace(":","")})},e.utcOffset=function(){return-Math.round(this.$d.getTimezoneOffset()/15)*15},e.diff=function(i,a,o){var n,l=U.p(a),d=ee(i),h=(d.utcOffset()-this.utcOffset())*ua,v=this-d,m=U.m(this,d);return m=(n={},n[Pe]=m/12,n[we]=m,n[$o]=m/3,n[Ci]=(v-h)/Bn,n[Oe]=(v-h)/Rn,n[$t]=v/Or,n[St]=v/ua,n[_t]=v/At,n)[l]||v,o?m:U.a(m)},e.daysInMonth=function(){return this.endOf(we).$D},e.$locale=function(){return tt[this.$L]},e.locale=function(i,a){if(!i)return this.$L;var o=this.clone(),n=Oi(i,a,!0);return n&&(o.$L=n),o},e.clone=function(){return U.w(this.$d,this)},e.toDate=function(){return new Date(this.valueOf())},e.toJSON=function(){return this.isValid()?this.toISOString():null},e.toISOString=function(){return this.$d.toISOString()},e.toString=function(){return this.$d.toUTCString()},r}(),Co=Hi.prototype;ee.prototype=Co;[["$ms",Ra],["$s",_t],["$m",St],["$H",$t],["$W",Oe],["$M",we],["$y",Pe],["$D",Ct]].forEach(function(r){Co[r[1]]=function(e){return this.$g(e,r[0],r[1])}});ee.extend=function(r,e){return r.$i||(r(e,Hi,ee),r.$i=!0),ee};ee.locale=Oi;ee.isDayjs=Ba;ee.unix=function(r){return ee(r*1e3)};ee.en=tt[ti];ee.Ls=tt;ee.p={};var Jn=function(e){return e.replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g,function(t,i,a){return i||a.slice(1)})},el={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"},tl=function(e,t){return e.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g,function(i,a,o){var n=o&&o.toUpperCase();return a||t[o]||el[o]||Jn(t[n])})},il=/(\[[^[]*\])|([-:/.()\s]+)|(A|a|YYYY|YY?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g,al=/\d/,wi=/\d\d/,rl=/\d{3}/,ol=/\d{4}/,$e=/\d\d?/,sl=/[+-]?\d+/,nl=/[+-]\d\d:?(\d\d)?|Z/,Xt=/\d*[^\s\d-_:/()]+/,Ne={},ko=function(e){return e=+e,e+(e>68?1900:2e3)};function ll(r){if(!r||r==="Z")return 0;var e=r.match(/([+-]|\d\d)/g),t=+(e[1]*60)+(+e[2]||0);return t===0?0:e[0]==="+"?-t:t}var fe=function(e){return function(t){this[e]=+t}},Ir=[nl,function(r){var e=this.zone||(this.zone={});e.offset=ll(r)}],pa=function(e){var t=Ne[e];return t&&(t.indexOf?t:t.s.concat(t.f))},Nr=function(e,t){var i,a=Ne,o=a.meridiem;if(!o)i=e===(t?"pm":"PM");else for(var n=1;n<=24;n+=1)if(e.indexOf(o(n,0,t))>-1){i=n>12;break}return i},dl={A:[Xt,function(r){this.afternoon=Nr(r,!1)}],a:[Xt,function(r){this.afternoon=Nr(r,!0)}],S:[al,function(r){this.milliseconds=+r*100}],SS:[wi,function(r){this.milliseconds=+r*10}],SSS:[rl,function(r){this.milliseconds=+r}],s:[$e,fe("seconds")],ss:[$e,fe("seconds")],m:[$e,fe("minutes")],mm:[$e,fe("minutes")],H:[$e,fe("hours")],h:[$e,fe("hours")],HH:[$e,fe("hours")],hh:[$e,fe("hours")],D:[$e,fe("day")],DD:[wi,fe("day")],Do:[Xt,function(r){var e=Ne,t=e.ordinal,i=r.match(/\d+/);if(this.day=i[0],!!t)for(var a=1;a<=31;a+=1)t(a).replace(/\[|\]/g,"")===r&&(this.day=a)}],M:[$e,fe("month")],MM:[wi,fe("month")],MMM:[Xt,function(r){var e=pa("months"),t=pa("monthsShort"),i=(t||e.map(function(a){return a.slice(0,3)})).indexOf(r)+1;if(i<1)throw new Error;this.month=i%12||i}],MMMM:[Xt,function(r){var e=pa("months"),t=e.indexOf(r)+1;if(t<1)throw new Error;this.month=t%12||t}],Y:[sl,fe("year")],YY:[wi,function(r){this.year=ko(r)}],YYYY:[ol,fe("year")],Z:Ir,ZZ:Ir};function cl(r){var e=r.afternoon;if(e!==void 0){var t=r.hours;e?t<12&&(r.hours+=12):t===12&&(r.hours=0),delete r.afternoon}}function hl(r){r=tl(r,Ne&&Ne.formats);for(var e=r.match(il),t=e.length,i=0;i<t;i+=1){var a=e[i],o=dl[a],n=o&&o[0],l=o&&o[1];l?e[i]={regex:n,parser:l}:e[i]=a.replace(/^\[|\]$/g,"")}return function(d){for(var h={},v=0,m=0;v<t;v+=1){var f=e[v];if(typeof f=="string")m+=f.length;else{var w=f.regex,_=f.parser,$=d.slice(m),D=w.exec($),E=D[0];_.call(h,E),d=d.replace(E,"")}}return cl(h),h}}var ul=function(e,t,i){try{if(["x","X"].indexOf(t)>-1)return new Date((t==="X"?1e3:1)*e);var a=hl(t),o=a(e),n=o.year,l=o.month,d=o.day,h=o.hours,v=o.minutes,m=o.seconds,f=o.milliseconds,w=o.zone,_=new Date,$=d||(!n&&!l?_.getDate():1),D=n||_.getFullYear(),E=0;n&&!l||(E=l>0?l-1:_.getMonth());var O=h||0,N=v||0,B=m||0,K=f||0;return w?new Date(Date.UTC(D,E,$,O,N,B,K+w.offset*60*1e3)):i?new Date(Date.UTC(D,E,$,O,N,B,K)):new Date(D,E,$,O,N,B,K)}catch{return new Date("")}},pl=function(r,e,t){t.p.customParseFormat=!0,r&&r.parseTwoDigitYear&&(ko=r.parseTwoDigitYear);var i=e.prototype,a=i.parse;i.parse=function(o){var n=o.date,l=o.utc,d=o.args;this.$u=l;var h=d[1];if(typeof h=="string"){var v=d[2]===!0,m=d[3]===!0,f=v||m,w=d[2];m&&(w=d[2]),Ne=this.$locale(),!v&&w&&(Ne=t.Ls[w]),this.$d=ul(n,h,l),this.init(),w&&w!==!0&&(this.$L=this.locale(w).$L),f&&n!=this.format(h)&&(this.$d=new Date("")),Ne={}}else if(h instanceof Array)for(var _=h.length,$=1;$<=_;$+=1){d[1]=h[$-1];var D=t.apply(this,d);if(D.isValid()){this.$d=D.$d,this.$L=D.$L,this.init();break}$===_&&(this.$d=new Date(""))}else a.call(this,o)}};const vl=Object.freeze({processing:"processing",complete:"complete"});class ml extends F{static get properties(){return{mode:{type:String}}}constructor(){super(),this.mode=vl.processing}render(){return p`
      <div class="${this.mode}">
        <svg
          viewBox="0 0 120 120"
    ...
    `}get selectedRangeTemplate(){return P`
      ...
      />`}get histogramTemplate(){const e=this._histWidth/this._numBins,t=e-1;let i=this.sliderWidth;return this._histData.map(a=>{const o=P`
        <rect
          ...
          fill="${i+t>=this.minSliderX&&i<=this.maxSliderX?Cl:Tl}"
    ...
    ia-activity-indicator {
      ...
      --activityIndicatorLoadingRingColor: ${kl};
    }
...
`;let Da=class extends F{constructor(){super(...arguments),this.config=new To}render(){return p`
    ...
    `}};s([c({type:Object})],Da.prototype,"config",void 0);Da=s([R("modal-template")],Da);function Pl(r,e,t){var i=t||{},a=i.noTrailing,o=a===void 0?!1:a,n=i.noLeading,l=n===void 0?!1:n,d=i.debounceMode,h=d===void 0?void 0:d,v,m=!1,f=0;function w(){v&&clearTimeout(v)}function _(D){var E=D||{},O=E.upcomingOnly,N=O===void 0?!1:O;w(),m=!N}function $(){for(var D=arguments.length,E=new Array(D),O=0;O<D;O++)E[O]=arguments[O];var N=this,B=Date.now()-f;if(m)return;function K(){f=Date.now(),e.apply(N,E)}function oe(){v=void 0}!l&&h&&!v&&K(),w(),h===void 0&&B>r?l?(f=Date.now(),o||(v=setTimeout(h?oe:K,r))):K():o!==!0&&(v=setTimeout(h?oe:K,h===void 0?r-B:r))}return $.cancel=_,$}var it;(function(r){r.Open="open",r.Closed="closed"})(it||(it={}));class Il{constructor(e){this.windowResizeThrottler=Pl(100,this.updateModalContainerHeight).bind(this),this.modalManager=e}handleModeChange(e){switch(e){case it.Open:this.startResizeListener(),this.stopDocumentScroll();break;case it.Closed:this.stopResizeListener(),this.resumeDocumentScroll();break}}updateModalContainerHeight(){this.modalManager.style.setProperty("--containerHeight",`${window.innerHeight}px`)}stopDocumentScroll(){document.body.classList.add("modal-manager-open")}resumeDocumentScroll(){document.body.classList.remove("modal-manager-open")}startResizeListener(){window.addEventListener("resize",this.windowResizeThrottler)}stopResizeListener(){window.removeEventListener("resize",this.windowResizeThrottler)}}let Lt=class extends F{constructor(){super(...arguments),this.mode=it.Closed,this.hostBridge=new Il(this),this.closeOnBackdropClick=!0}render(){return p`
      <div class="container">
...
`;let Ft=class extends F{constructor(){super(...arguments),this.step=2,this.currentPage=1,this.pages=[]}firstUpdated(){this.observePageCount()}updated(e){e.has("size")&&this.observePageCount(),e.has("currentPage")&&(this.observePageCount(),this.emitPageClick())}observePageCount(){this.pages=[];const e=7,t=this.size<=e;if(this.size<=5){this.pages=[...Array(this.size).keys()].map(o=>o+1);return}if(this.size===e){if(this.currentPage===2){this.pages=[1,2,3,4,0,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,4,5,this.size-1,this.size];return}}if(this.currentPage===1){this.pages=[1,2,3,0,this.size];return}if(this.currentPage===this.size){this.pages=[1,0,this.size-2,this.size-1,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,this.size-3,this.size-2,this.size-1,this.size];return}if(t&&this.currentPage>1&&this.currentPage<e){this.pages=[...Array(this.size).keys()].map(o=>o+1);return}let i=this.currentPage-this.step,a=this.currentPage+this.step;i<=0&&(a+=-i+1,i=1),a>=this.size&&(i=Math.max(i-(a-this.size),1),a=this.size),i===2&&(a-=1),a===this.size-1&&(i+=1),this.createFirstNode(i),this.createMiddelNode(i,a),this.createLastNode(a)}createFirstNode(e){var t,i;e>1&&((t=this.pages)===null||t===void 0||t.push(1)),e>2&&((i=this.pages)===null||i===void 0||i.push(0))}createMiddelNode(e,t){var i;for(let a=e;a<=t;a+=1)(i=this.pages)===null||i===void 0||i.push(a)}createLastNode(e){var t,i;e<this.size-1&&((t=this.pages)===null||t===void 0||t.push(0)),e<this.size&&((i=this.pages)===null||i===void 0||i.push(this.size))}get getEllipsisTemplate(){return p`<i class="ellipses">...</i>`}emitPageClick(){this.dispatchEvent(new CustomEvent("pageNumberClicked",{detail:{page:this.currentPage},bubbles:!0,composed:!0}))}onRewind(){this.currentPage-=1,this.currentPage<1&&(this.currentPage=1)}onForward(){this.currentPage+=1,this.currentPage>this.size&&(this.currentPage=this.size)}onChange(e){this.currentPage=e}getPageTemplate(e){return p`
    ...
    `}};s([c({type:Number})],Ft.prototype,"size",void 0);s([c({type:Number})],Ft.prototype,"step",void 0);s([c({type:Number})],Ft.prototype,"currentPage",void 0);s([T()],Ft.prototype,"pages",void 0);Ft=s([R("more-facets-pagination")],Ft);var Bl=P`
...
`;let Ot=class extends F{facetClicked(e,t,i){const a=e.target,{checked:o,name:n,value:l}=a;o?this.facetChecked(n,l,t,i):this.facetUnchecked(n,l)}facetChecked(e,t,i,a){const{selectedFacets:o}=this;let n;o?n=ce({},o):n=Li,n[e][t]={state:a?"hidden":"selected",count:i},this.selectedFacets=n,this.dispatchSelectedFacetsChanged()}facetUnchecked(e,t){const{selectedFacets:i}=this;let a;i?a=ce({},i):a=Li,delete a[e][t],this.selectedFacets=a,this.dispatchSelectedFacetsChanged()}dispatchSelectedFacetsChanged(){const e=new CustomEvent("selectedFacetsChanged",{detail:this.selectedFacets,bubbles:!0,composed:!0});this.dispatchEvent(e)}getFacetsTemplate(e){let t=e==null?void 0:e.buckets;return t=[...t.filter(i=>i.state==="selected").sort((i,a)=>i.count<a.count?1:-1),...t.filter(i=>i.state==="hidden").sort((i,a)=>i.count<a.count?1:-1),...t.filter(i=>i.state==="none")],p`
      <div class="facets-on-${this.renderOn}">
        ${uo(t,i=>`${e.key}:${i.key}`,i=>{var a,o;const n=`${e.key}:${i.key}-show-only`,l=`${e.key}:${i.key}-negative`,d=e.key!=="collection"?p`${(a=i.displayText)!==null&&a!==void 0?a:i.key}`:p`<a href="/details/${i.key}">
    ...
    `}updated(e){e.has("selectedFacets")&&this.dispatchFacetsChangedEvent()}dispatchFacetsChangedEvent(){const e=new CustomEvent("facetsChanged",{detail:this.selectedFacets});this.dispatchEvent(e)}get currentYearsHistogramAggregation(){var e;return(e=this.aggregations)===null||e===void 0?void 0:e.year_histogram}get histogramTemplate(){const{fullYearsHistogramAggregation:e}=this;return this.fullYearAggregationLoading?p`<div class="histogram-loading-indicator">&hellip;</div>`:p`
          ...
          ></histogram-date-range>
        `}histogramDateRangeUpdated(e){const{minDate:t,maxDate:i}=e.detail,a=new CustomEvent("histogramDateRangeUpdated",{detail:{minDate:t,maxDate:i}});this.dispatchEvent(a)}get mergedFacets(){const e=[];return Ln.forEach(t=>{var i,a;const o=this.selectedFacetGroups.find(v=>v.key===t),n=this.aggregationFacetGroups.find(v=>v.key===t);if(o&&!n){e.push(o);return}if(!n)return;const l=o!=null?o:n;let d=(i=o==null?void 0:o.buckets.map(v=>{const m=n.buckets.find(f=>f.key===v.key);return m?gt(ce({},v),{count:m.count}):v}))!==null&&i!==void 0?i:[];n.buckets.forEach(v=>{d.find(f=>f.key===v.key)||d.push(v)}),t==="lending"&&(d=d.filter(v=>Fn[v.key]));let h=(a=Object.keys((o==null?void 0:o.buckets)||[]))===null||a===void 0?void 0:a.length;h<this.allowedFacetCount&&(h=this.allowedFacetCount),l.buckets=d.splice(0,h),e.push(l)}),e}get selectedFacetGroups(){return this.selectedFacets?Object.entries(this.selectedFacets).map(([t,i])=>{const a=t,o=Fi[a],n=Object.entries(i).map(([l,d])=>{var h,v,m;let f=l;return a==="language"&&(f=(v=(h=this.languageCodeHandler)===null||h===void 0?void 0:h.getLanguageNameFromCodeString(l))!==null&&v!==void 0?v:l),a==="lending"&&(f=(m=Er[l])!==null&&m!==void 0?m:l),{displayText:f,key:l,count:d.count,state:d.state}});return{title:o,key:a,buckets:n}}):[]}get aggregationFacetGroups(){var e;const t=[];return Object.entries((e=this.aggregations)!==null&&e!==void 0?e:[]).forEach(([i,a])=>{if(i==="year_histogram")return;const o=i,n=Fi[o];if(!n)return;let l=a.buckets;o==="collection"&&(l=l==null?void 0:l.filter(v=>{var m;const f=(m=v==null?void 0:v.key)===null||m===void 0?void 0:m.toString();return!Na[f]&&!(f!=null&&f.startsWith("fav-"))}));const d=l.map(v=>{var m,f,w;let _=v.key,$=`${v.key}`;return o==="language"&&(_=(f=(m=this.languageCodeHandler)===null||m===void 0?void 0:m.getCodeStringFromLanguageName(`${v.key}`))!==null&&f!==void 0?f:v.key),o==="lending"&&($=(w=Er[v.key])!==null&&w!==void 0?w:`${v.key}`),{displayText:$,key:`${_}`,count:v.doc_count,state:"none"}}),h={title:n,key:o,buckets:d};t.push(h)}),t}getFacetGroupTemplate(e){if(!this.facetsLoading&&e.buckets.length===0)return x;const{key:t}=e,i=this.openFacets[t],a=p`
    ...
    `,l=new To({bodyColor:"#fff",headerColor:"#194880",showHeaderLogo:!1,closeOnBackdropClick:!0,title:p`Select filters`});(i=this.modalManager)===null||i===void 0||i.classList.add("more-search-facets"),(a=this.modalManager)===null||a===void 0||a.showModal({config:l,customModalContent:n})}getFacetTemplate(e){return p`
      <facets-template
        .facetGroup=${e}
        .selectedFacets=${this.selectedFacets}
        .renderOn=${"page"}
...
`;let Ii=class extends F{constructor(){super(...arguments),this.placeholderType=null}render(){return this.placeholderType?p`${this.placeholderTemplate}`:x}get placeholderTemplate(){return p`
      ...
      >
        ${Ql(this.placeholderType,[["empty-query",()=>this.emptyQueryTemplate],["null-result",()=>this.nullResultTemplate]])}
      </div>
