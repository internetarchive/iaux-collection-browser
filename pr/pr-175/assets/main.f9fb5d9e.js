 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var aa;const Lt=globalThis.trustedTypes,fr=Lt?Lt.createPolicy("lit-html",{createHTML:r=>r}):void 0,De=`lit$${(Math.random()+"").slice(9)}$`,Ra="?"+De,bs=`<${Ra}>`,At=document,ri=(r="")=>At.createComment(r),oi=r=>r===null||typeof r!="object"&&typeof r!="function",ao=Array.isArray,ro=r=>{var e;return ao(r)||typeof((e=r)===null||e===void 0?void 0:e[Symbol.iterator])=="function"},qt=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,gr=/-->/g,yr=/>/g,Xe=/>|[ 	\n\r](?:([^\s"'>=/]+)([ 	\n\r]*=[ 	\n\r]*(?:[^ 	\n\r"'`<>=]|("|')|))|$)/g,br=/'/g,wr=/"/g,oo=/^(?:script|style|textarea|title)$/i,so=r=>(e,...t)=>({_$litType$:r,strings:e,values:t}),u=so(1),O=so(2),ge=Symbol.for("lit-noChange"),x=Symbol.for("lit-nothing"),xr=new WeakMap,Si=(r,e,t)=>{var i,a;const o=(i=t==null?void 0:t.renderBefore)!==null&&i!==void 0?i:e;let s=o._$litPart$;if(s===void 0){const l=(a=t==null?void 0:t.renderBefore)!==null&&a!==void 0?a:null;o._$litPart$=s=new Bt(e.insertBefore(ri(),l),l,void 0,t!=null?t:{})}return s._$AI(r),s},zt=At.createTreeWalker(At,129,null,!1),no=(r,e)=>{const t=r.length-1,i=[];let a,o=e===2?"<svg>":"",s=qt;for(let d=0;d<t;d++){const h=r[d];let v,m,f=-1,w=0;for(;w<h.length&&(s.lastIndex=w,m=s.exec(h),m!==null);)w=s.lastIndex,s===qt?m[1]==="!--"?s=gr:m[1]!==void 0?s=yr:m[2]!==void 0?(oo.test(m[2])&&(a=RegExp("</"+m[2],"g")),s=Xe):m[3]!==void 0&&(s=Xe):s===Xe?m[0]===">"?(s=a!=null?a:qt,f=-1):m[1]===void 0?f=-2:(f=s.lastIndex-m[2].length,v=m[1],s=m[3]===void 0?Xe:m[3]==='"'?wr:br):s===wr||s===br?s=Xe:s===gr||s===yr?s=qt:(s=Xe,a=void 0);const _=s===Xe&&r[d+1].startsWith("/>")?" ":"";o+=s===qt?h+bs:f>=0?(i.push(v),h.slice(0,f)+"$lit$"+h.slice(f)+De+_):h+De+(f===-2?(i.push(void 0),d):_)}const l=o+(r[t]||"<?>")+(e===2?"</svg>":"");if(!Array.isArray(r)||!r.hasOwnProperty("raw"))throw Error("invalid template strings array");return[fr!==void 0?fr.createHTML(l):l,i]};class si{constructor({strings:e,_$litType$:t},i){let a;this.parts=[];let o=0,s=0;const l=e.length-1,d=this.parts,[h,v]=no(e,t);if(this.el=si.createElement(h,i),zt.currentNode=this.el.content,t===2){const m=this.el.content,f=m.firstChild;f.remove(),m.append(...f.childNodes)}for(;(a=zt.nextNode())!==null&&d.length<l;){if(a.nodeType===1){if(a.hasAttributes()){const m=[];for(const f of a.getAttributeNames())if(f.endsWith("$lit$")||f.startsWith(De)){const w=v[s++];if(m.push(f),w!==void 0){const _=a.getAttribute(w.toLowerCase()+"$lit$").split(De),$=/([.?@])?(.*)/.exec(w);d.push({type:1,index:o,name:$[2],strings:_,ctor:$[1]==="."?co:$[1]==="?"?ho:$[1]==="@"?po:ui})}else d.push({type:6,index:o})}for(const f of m)a.removeAttribute(f)}if(oo.test(a.tagName)){const m=a.textContent.split(De),f=m.length-1;if(f>0){a.textContent=Lt?Lt.emptyScript:"";for(let w=0;w<f;w++)a.append(m[w],ri()),zt.nextNode(),d.push({type:2,index:++o});a.append(m[f],ri())}}}else if(a.nodeType===8)if(a.data===Ra)d.push({type:2,index:o});else{let m=-1;for(;(m=a.data.indexOf(De,m+1))!==-1;)d.push({type:7,index:o}),m+=De.length-1}o++}}static createElement(e,t){const i=At.createElement("template");return i.innerHTML=e,i}}function ot(r,e,t=r,i){var a,o,s,l;if(e===ge)return e;let d=i!==void 0?(a=t._$Cl)===null||a===void 0?void 0:a[i]:t._$Cu;const h=oi(e)?void 0:e._$litDirective$;return(d==null?void 0:d.constructor)!==h&&((o=d==null?void 0:d._$AO)===null||o===void 0||o.call(d,!1),h===void 0?d=void 0:(d=new h(r),d._$AT(r,t,i)),i!==void 0?((s=(l=t)._$Cl)!==null&&s!==void 0?s:l._$Cl=[])[i]=d:t._$Cu=d),d!==void 0&&(e=ot(r,d._$AS(r,e.values),d,i)),e}class lo{constructor(e,t){this.v=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}p(e){var t;const{el:{content:i},parts:a}=this._$AD,o=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:At).importNode(i,!0);zt.currentNode=o;let s=zt.nextNode(),l=0,d=0,h=a[0];for(;h!==void 0;){if(l===h.index){let v;h.type===2?v=new Bt(s,s.nextSibling,this,e):h.type===1?v=new h.ctor(s,h.name,h.strings,this,e):h.type===6&&(v=new uo(s,this,e)),this.v.push(v),h=a[++d]}l!==(h==null?void 0:h.index)&&(s=zt.nextNode(),l++)}return o}m(e){let t=0;for(const i of this.v)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class Bt{constructor(e,t,i,a){var o;this.type=2,this._$AH=x,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=a,this._$Cg=(o=a==null?void 0:a.isConnected)===null||o===void 0||o}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cg}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&e.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=ot(this,e,t),oi(e)?e===x||e==null||e===""?(this._$AH!==x&&this._$AR(),this._$AH=x):e!==this._$AH&&e!==ge&&this.$(e):e._$litType$!==void 0?this.T(e):e.nodeType!==void 0?this.k(e):ro(e)?this.S(e):this.$(e)}M(e,t=this._$AB){return this._$AA.parentNode.insertBefore(e,t)}k(e){this._$AH!==e&&(this._$AR(),this._$AH=this.M(e))}$(e){this._$AH!==x&&oi(this._$AH)?this._$AA.nextSibling.data=e:this.k(At.createTextNode(e)),this._$AH=e}T(e){var t;const{values:i,_$litType$:a}=e,o=typeof a=="number"?this._$AC(e):(a.el===void 0&&(a.el=si.createElement(a.h,this.options)),a);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===o)this._$AH.m(i);else{const s=new lo(o,this),l=s.p(this.options);s.m(i),this.k(l),this._$AH=s}}_$AC(e){let t=xr.get(e.strings);return t===void 0&&xr.set(e.strings,t=new si(e)),t}S(e){ao(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,a=0;for(const o of e)a===t.length?t.push(i=new Bt(this.M(ri()),this.M(ri()),this,this.options)):i=t[a],i._$AI(o),a++;a<t.length&&(this._$AR(i&&i._$AB.nextSibling,a),t.length=a)}_$AR(e=this._$AA.nextSibling,t){var i;for((i=this._$AP)===null||i===void 0||i.call(this,!1,!0,t);e&&e!==this._$AB;){const a=e.nextSibling;e.remove(),e=a}}setConnected(e){var t;this._$AM===void 0&&(this._$Cg=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}}class ui{constructor(e,t,i,a,o){this.type=1,this._$AH=x,this._$AN=void 0,this.element=e,this.name=t,this._$AM=a,this.options=o,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=x}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,i,a){const o=this.strings;let s=!1;if(o===void 0)e=ot(this,e,t,0),s=!oi(e)||e!==this._$AH&&e!==ge,s&&(this._$AH=e);else{const l=e;let d,h;for(e=o[0],d=0;d<o.length-1;d++)h=ot(this,l[i+d],t,d),h===ge&&(h=this._$AH[d]),s||(s=!oi(h)||h!==this._$AH[d]),h===x?e=x:e!==x&&(e+=(h!=null?h:"")+o[d+1]),this._$AH[d]=h}s&&!a&&this.C(e)}C(e){e===x?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e!=null?e:"")}}class co extends ui{constructor(){super(...arguments),this.type=3}C(e){this.element[this.name]=e===x?void 0:e}}const ws=Lt?Lt.emptyScript:"";class ho extends ui{constructor(){super(...arguments),this.type=4}C(e){e&&e!==x?this.element.setAttribute(this.name,ws):this.element.removeAttribute(this.name)}}class po extends ui{constructor(e,t,i,a,o){super(e,t,i,a,o),this.type=5}_$AI(e,t=this){var i;if((e=(i=ot(this,e,t,0))!==null&&i!==void 0?i:x)===ge)return;const a=this._$AH,o=e===x&&a!==x||e.capture!==a.capture||e.once!==a.once||e.passive!==a.passive,s=e!==x&&(a===x||o);o&&this.element.removeEventListener(this.name,this,a),s&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,i;typeof this._$AH=="function"?this._$AH.call((i=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&i!==void 0?i:this.element,e):this._$AH.handleEvent(e)}}class uo{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){ot(this,e)}}const xs={L:"$lit$",P:De,V:Ra,I:1,N:no,R:lo,j:ro,D:ot,H:Bt,F:ui,O:ho,W:po,B:co,Z:uo},_r=window.litHtmlPolyfillSupport;_r==null||_r(si,Bt),((aa=globalThis.litHtmlVersions)!==null&&aa!==void 0?aa:globalThis.litHtmlVersions=[]).push("2.2.4");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */const Cr=(r,e,t)=>{const i=new Map;for(let a=e;a<=t;a++)i.set(r[a],a);return i},fo=Ui(class extends ji{constructor(r){if(super(r),r.type!==Ae.CHILD)throw Error("repeat() can only be used in text expressions")}dt(r,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);const a=[],o=[];let s=0;for(const l of r)a[s]=i?i(l,s):s,o[s]=t(l,s),s++;return{values:o,keys:a}}render(r,e,t){return this.dt(r,e,t).values}update(r,[e,t,i]){var a;const o=zs(r),{values:s,keys:l}=this.dt(e,t,i);if(!Array.isArray(o))return this.ut=l,s;const d=(a=this.ut)!==null&&a!==void 0?a:this.ut=[],h=[];let v,m,f=0,w=o.length-1,_=0,$=s.length-1;for(;f<=w&&_<=$;)if(o[f]===null)f++;else if(o[w]===null)w--;else if(d[f]===l[_])h[_]=Ze(o[f],s[_]),f++,_++;else if(d[w]===l[$])h[$]=Ze(o[w],s[$]),w--,$--;else if(d[f]===l[$])h[$]=Ze(o[f],s[$]),Xt(r,h[$+1],o[f]),f++,$--;else if(d[w]===l[_])h[_]=Ze(o[w],s[_]),Xt(r,o[f],o[w]),w--,_++;else if(v===void 0&&(v=Cr(l,_,$),m=Cr(d,f,w)),v.has(d[f]))if(v.has(d[w])){const E=m.get(l[_]),L=E!==void 0?o[E]:null;if(L===null){const P=Xt(r,o[f]);Ze(P,s[_]),h[_]=P}else h[_]=Ze(L,s[_]),Xt(r,o[f],L),o[E]=null;_++}else na(o[w]),w--;else na(o[f]),f++;for(;_<=$;){const E=Xt(r,h[$+1]);Ze(E,s[_]),h[_++]=E}for(;f<=w;){const E=o[f++];E!==null&&na(E)}return this.ut=l,mo(r,h),ge}});function bi(r,e,t){return Array.from({length:(e-r)/t+1},(i,a)=>r+a*t)}let He=class extends F{constructor(){super(...arguments),this.itemCount=0,this.scrollOptimizationsDisabled=!1,this.intersectionObserver=new IntersectionObserver(e=>{e.forEach(t=>{if(t.target===this.sentinel){t.isIntersecting&&this.dispatchEvent(new Event("scrollThresholdReached"));return}const a=t.target.dataset.cellIndex;if(!a)return;const o=parseInt(a,10);t.isIntersecting?this.visibleCellIndices.add(o):this.visibleCellIndices.delete(o)}),this.scrollOptimizationsDisabled||this.processVisibleCells()}),this.renderedCellIndices=new Set,this.visibleCellIndices=new Set,this.placeholderCellIndices=new Set}reload(){bi(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.removeCell(t)),this.renderedCellIndices.clear(),this.visibleCellIndices.clear(),this.placeholderCellIndices.clear(),this.setupObservations()}scrollToCell(e,t){const i=this.cellContainers[e];if(!i)return!1;const a=t?"smooth":"auto";return i.scrollIntoView({behavior:a}),!0}getVisibleCellIndices(){return Array.from(this.visibleCellIndices)}updated(e){(e.has("itemCount")||e.has("scrollOptimizationsDisabled"))&&this.setupObservations()}disconnectedCallback(){this.intersectionObserver.disconnect()}setupObservations(){this.setupIntersectionObserver()}setupIntersectionObserver(){this.intersectionObserver.disconnect(),this.sentinel&&this.intersectionObserver.observe(this.sentinel),this.scrollOptimizationsDisabled?(bi(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.visibleCellIndices.add(t)),this.processVisibleCells()):this.cellContainers.forEach(e=>this.intersectionObserver.observe(e))}render(){const e=this.itemCount-1,t=bi(0,e,1);return u`
    ...
    `}};n([c({type:Number})],He.prototype,"itemCount",void 0);n([c({type:Object})],He.prototype,"cellProvider",void 0);n([c({type:Object})],He.prototype,"placeholderCellTemplate",void 0);n([c({type:Boolean})],He.prototype,"scrollOptimizationsDisabled",void 0);n([le("#sentinel")],He.prototype,"sentinel",void 0);n([Ss(".cell-container")],He.prototype,"cellContainers",void 0);He=n([R("infinite-scroller")],He);const go=O`
...
`;var Sa;(function(r){r[r.bytes=0]="bytes",r[r.kilobytes=1]="kilobytes",r[r.megabytes=2]="megabytes",r[r.gigabytes=3]="gigabytes",r[r.terabytes=4]="terabytes",r[r.petabytes=5]="petabytes",r[r.exabytes=6]="exabytes",r[r.zettabytes=7]="zettabytes",r[r.yottabytes=8]="yottabytes"})(Sa||(Sa={}));function Es(r,e,t=" "){let i=r;if(i===void 0)return x;let a=0;for(;i>1024;)i/=1024,a+=1;const o=10**e;i=Math.round(i*o)/o;let s=Sa[a];return s=i===1?s.slice(0,-1):s,`${i.toLocaleString()+t+s}`}const Ls=g`var(--tileBackgroundColor, #ffffff)`,As=g`var(--tileCornerRadius, 4px)`,Ba=g`
  .container {
    background-color: ${Ls};
    border: 1px #2c2c2c;
    border-radius: ${As};
 ...
 */function*$i(r,e){const t=typeof e=="function";if(r!==void 0){let i=-1;for(const a of r)i>-1&&(yield t?e(i):e),i++,yield a}}let Di=class extends F{constructor(){super(...arguments),this.snippets=[],this.viewSize="desktop"}render(){var e;return!((e=this.snippets)===null||e===void 0)&&e.length?u`
    ...
    `}};n([c({type:Array})],Di.prototype,"snippets",void 0);n([c({type:String})],Di.prototype,"viewSize",void 0);Di=n([R("text-snippet-block")],Di);const Ds=g`
  .drop-shadow {
    overflow: hidden;
    height: 100%;
  }
...
`,Gs={account:{color:"#000000",icon:Ps,text:"Account"},audio:{color:"#00adef",icon:Os,text:"Audio"},collection:{color:"#4666ff",icon:go,text:"Collection"},data:{color:"#333333",icon:Is,text:"Data"},etree:{color:"#00adef",icon:Ns,text:"E-tree"},film:{color:"#bf1b2c",icon:kr,text:"Film"},image:{color:"#aa99c9",icon:Rs,text:"Image"},movies:{color:"#f1644b",icon:kr,text:"Movie"},radio:{color:"#8fdaef",icon:Bs,text:"Radio"},software:{color:"#9ecc4f",icon:Hs,text:"Software"},texts:{color:"#faab3c",icon:Us,text:"Text"},tv:{color:"#f1644b",icon:js,text:"TV"},video:{color:"#f1644b",icon:Vs,text:"Video"},web:{color:"#ffcd27",icon:Ws,text:"Web"}};let hi=class extends F{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var e,t;const i=["tvnews","tvarchive","television"],a=["radio","radioprogram"];return this.mediatype==="movies"&&((e=this.collections)===null||e===void 0?void 0:e.some(o=>i.indexOf(o)>=0))?"tv":this.mediatype==="audio"&&((t=this.collections)===null||t===void 0?void 0:t.some(o=>a.indexOf(o)>=0))?"radio":this.mediatype||""}render(){const e=Gs[this.displayMediatype];return e?u`
    ...
    `}};n([c({type:String})],hi.prototype,"mediatype",void 0);n([c({type:Array})],hi.prototype,"collections",void 0);n([c({type:Boolean})],hi.prototype,"showText",void 0);hi=n([R("mediatype-icon")],hi);const Qs=O`
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let xt=en;function rn(r,e){let t=1;return r>=1e9?t=1e9:r>=1e6?t=1e6:r>=1e3&&e==="short"&&(t=1e3),t}function on(r=0,e){const t=r/e,i=t<10;let a=0;return i?a=Math.round((t+Number.EPSILON)*10)/10:a=Math.round(t),a}function sn(r,e,t,i){switch(e){case 1e9:return xt(t==="short"?wt`${r}B`:wt`${r} billion`);case 1e6:return xt(t==="short"?wt`${r}M`:wt`${r} million`);case 1e3:return xt(t==="short"?wt`${r}K`:wt`${r} thousand`);default:return new Intl.NumberFormat(i).format(r)}}function ti(r,e="long",t="short",i="en-US"){const a=r!=null?r:-1;if(a<0)return"";const o=rn(a,e),s=on(a,o);return sn(s,o,t,i)}let st=class extends F{render(){const e=ti(this.favCount,"short","short"),t=ti(this.commentCount,"short","short"),i=this.mediatype==="account"?`${this.itemCount} uploads`:`${this.viewCount} all-time views`;return u`
...
`+de),Ce&&(de=Oe(de,Ve," "),de=Oe(de,We," ")),B&&mi?B.createHTML(de):de},e.setConfig=function(C){qi(C),Ke=!0},e.clearConfig=function(){yt=null,Ke=!1},e.isValidAttribute=function(C,p,b){yt||qi({});var S=qe(C),H=qe(p);return or(S,H,b)},e.addHook=function(C,p){typeof p=="function"&&(ve[C]=ve[C]||[],Zt(ve[C],p))},e.removeHook=function(C){if(ve[C])return Mr(ve[C])},e.removeHooks=function(C){ve[C]&&(ve[C]=[])},e.removeAllHooks=function(){ve={}},e}var ii=xo(),D;(function(r){r.relevance="relevance",r.alltimeview="alltimeview",r.weeklyview="weeklyview",r.title="title",r.datearchived="datearchived",r.date="date",r.datereviewed="datereviewed",r.dateadded="dateadded",r.creator="creator"})(D||(D={}));const et={relevance:"Relevance",alltimeview:"All-time Views",weeklyview:"Weekly Views",title:"Title",datearchived:"Date Archived",date:"Date Published",datereviewed:"Date Reviewed",dateadded:"Date Added",creator:"Creator"},Pn={relevance:null,alltimeview:"downloads",weeklyview:"week",title:"titleSorter",datearchived:"publicdate",date:"date",datereviewed:"reviewdate",dateadded:"addeddate",creator:"creatorSorter"},Dr={week:D.weeklyview,downloads:D.alltimeview,titleSorter:D.title,date:D.date,publicdate:D.datearchived,reviewdate:D.datereviewed,addeddate:D.dateadded,creatorSorter:D.creator},On={title:"firstTitle",creator:"firstCreator"},Oi={subject:{},lending:{},mediatype:{},language:{},creator:{},collection:{},year:{}},In=["mediatype","lending","year","subject","collection","creator","language"],Ii={subject:"Subject",lending:"Availability",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"},Nn={is_lendable:!0,is_borrowable:!1,available_to_borrow:!0,is_browsable:!1,available_to_browse:!1,is_readable:!0,available_to_waitlist:!1},Fr={is_lendable:"Lending Library",available_to_borrow:"Borrow 14 Days",is_readable:"Always Available"},Ha={deemphasize:!0,community:!0,stream_only:!0,samples_only:!0,test_collection:!0,printdisabled:!0,"openlibrary-ol":!0,nationalemergencylibrary:!0,china:!0,americana:!0,toronto:!0};function _o(r){switch(r){case"date":return"Published";case"reviewdate":return"Reviewed";case"addeddate":return"Added";default:return"Archived"}}function So(r){return r?`Archivist since ${r.getFullYear()}`:""}let ye=class extends F{constructor(){super(...arguments),this.sortParam=null,this.collectionLinks=[],this.loggedIn=!1}render(){return u`
    ...
    `}};Or=n([R("collection-browser-loading-tile")],Or);let pi=class extends F{constructor(){super(...arguments),this.selectedLetter=null,this.alphabet="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("")}get selectedUppercaseLetter(){var e;return(e=this.selectedLetter)===null||e===void 0?void 0:e.toUpperCase()}render(){return u`
      <div id="container">
        <ul>
  ...
  `;n([c({type:String})],pi.prototype,"selectedLetter",void 0);n([c({type:Object})],pi.prototype,"letterCounts",void 0);pi=n([R("alpha-bar")],pi);const Ir=O`
    ...
    `}get selectedRangeTemplate(){return O`
      ...
      />`}get histogramTemplate(){const e=this._histWidth/this._numBins,t=e-1;let i=this.sliderWidth;return this._histData.map(a=>{const o=O`
        <rect
          ...
          fill="${i+t>=this.minSliderX&&i<=this.maxSliderX?El:Al}"
...
`;let Aa=class extends F{constructor(){super(...arguments),this.config=new Eo}render(){return u`
