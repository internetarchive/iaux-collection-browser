...
`;var Sa;(function(r){r[r.bytes=0]="bytes",r[r.kilobytes=1]="kilobytes",r[r.megabytes=2]="megabytes",r[r.gigabytes=3]="gigabytes",r[r.terabytes=4]="terabytes",r[r.petabytes=5]="petabytes",r[r.exabytes=6]="exabytes",r[r.zettabytes=7]="zettabytes",r[r.yottabytes=8]="yottabytes"})(Sa||(Sa={}));function Es(r,e,t=" "){let i=r;if(i===void 0)return x;let a=0;for(;i>1024;)i/=1024,a+=1;const o=10**e;i=Math.round(i*o)/o;let s=Sa[a];return s=i===1?s.slice(0,-1):s,`${i.toLocaleString()+t+s}`}const Ls=g`var(--tileBackgroundColor, #ffffff)`,Ds=g`var(--tileCornerRadius, 4px)`,Ra=g`
  .container {
    background-color: ${Ls};
    border: 1px #2c2c2c;
    border-radius: ${Ds};
...
`;let di=class extends P{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1,this.isCompactTile=!1}render(){return u`<div class="icon-overlay ${this.getClass}">
    ...
    `}};n([h({type:Boolean})],di.prototype,"loggedIn",void 0);n([h({type:Boolean})],di.prototype,"loginRequired",void 0);n([h({type:Boolean})],di.prototype,"isCompactTile",void 0);di=n([N("icon-overlay")],di);let ci=class extends P{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1,this.iconRequired=!1}render(){return u`
    ...
    `}};n([h({type:String})],Ue.prototype,"baseImageUrl",void 0);n([h({type:Boolean})],Ue.prototype,"isCompactTile",void 0);n([h({type:Boolean})],Ue.prototype,"isListTile",void 0);n([h({type:Boolean})],Ue.prototype,"loggedIn",void 0);n([h({type:Object})],Ue.prototype,"model",void 0);n([h({type:String})],Ue.prototype,"viewSize",void 0);Ue=n([N("image-block")],Ue);let Li=class extends P{render(){return u`
      <div class="container">
    ...
    >`}get getSizeTemplate(){var e,t;const i=(t=(e=this.model)===null||e===void 0?void 0:e.collectionSize)!==null&&t!==void 0?t:0;return i?u`<span id="item-size">${Es(i,1)}</span>`:""}static get styles(){const e=g`var(--tileBorderColor, #555555)`,t=g`var(--tileBackgroundColor, #666666)`,i=g`#fff`;return[Ra,g`
        .container {
          background-color: ${t};
          border: 1px solid ${e};
        }
 ...
 */function*$i(r,e){const t=typeof e=="function";if(r!==void 0){let i=-1;for(const a of r)i>-1&&(yield t?e(i):e),i++,yield a}}let Ai=class extends P{constructor(){super(...arguments),this.snippets=[],this.viewSize="desktop"}render(){var e;return!((e=this.snippets)===null||e===void 0)&&e.length?u`
    ...
    `}};n([h({type:Array})],Ai.prototype,"snippets",void 0);n([h({type:String})],Ai.prototype,"viewSize",void 0);Ai=n([N("text-snippet-block")],Ai);const As=g`
  .drop-shadow {
    overflow: hidden;
    height: 100%;
  }
...
`,Gs={account:{color:"#000000",icon:Fs,text:"Account"},audio:{color:"#00adef",icon:Os,text:"Audio"},collection:{color:"#4666ff",icon:go,text:"Collection"},data:{color:"#333333",icon:Is,text:"Data"},etree:{color:"#00adef",icon:Bs,text:"E-tree"},film:{color:"#bf1b2c",icon:kr,text:"Film"},image:{color:"#aa99c9",icon:Ns,text:"Image"},movies:{color:"#f1644b",icon:kr,text:"Movie"},radio:{color:"#8fdaef",icon:Rs,text:"Radio"},software:{color:"#9ecc4f",icon:Hs,text:"Software"},texts:{color:"#faab3c",icon:Us,text:"Text"},tv:{color:"#f1644b",icon:js,text:"TV"},video:{color:"#f1644b",icon:Vs,text:"Video"},web:{color:"#ffcd27",icon:Ws,text:"Web"}};let hi=class extends P{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var e,t;const i=["tvnews","tvarchive","television"],a=["radio","radioprogram"];return this.mediatype==="movies"&&((e=this.collections)===null||e===void 0?void 0:e.some(o=>i.indexOf(o)>=0))?"tv":this.mediatype==="audio"&&((t=this.collections)===null||t===void 0?void 0:t.some(o=>a.indexOf(o)>=0))?"radio":this.mediatype||""}render(){const e=Gs[this.displayMediatype];return e?u`
    ...
    `}};n([h({type:String})],hi.prototype,"mediatype",void 0);n([h({type:Array})],hi.prototype,"collections",void 0);n([h({type:Boolean})],hi.prototype,"showText",void 0);hi=n([N("mediatype-icon")],hi);const Qs=O`
 ...
 */let xt=en;function rn(r,e){let t=1;return r>=1e9?t=1e9:r>=1e6?t=1e6:r>=1e3&&e==="short"&&(t=1e3),t}function on(r=0,e){const t=r/e,i=t<10;let a=0;return i?a=Math.round((t+Number.EPSILON)*10)/10:a=Math.round(t),a}function sn(r,e,t,i){switch(e){case 1e9:return xt(t==="short"?wt`${r}B`:wt`${r} billion`);case 1e6:return xt(t==="short"?wt`${r}M`:wt`${r} million`);case 1e3:return xt(t==="short"?wt`${r}K`:wt`${r} thousand`);default:return new Intl.NumberFormat(i).format(r)}}function ti(r,e="long",t="short",i="en-US"){const a=r!=null?r:-1;if(a<0)return"";const o=rn(a,e),s=on(a,o);return sn(s,o,t,i)}let st=class extends P{render(){const e=ti(this.favCount,"short","short"),t=ti(this.commentCount,"short","short"),i=this.mediatype==="account"?`${this.itemCount} uploads`:`${this.viewCount} all-time views`;return u`
    ...
    `}get doesSortedByDate(){var e;return["date","reviewdate","addeddate","publicdate"].includes((e=this.sortParam)===null||e===void 0?void 0:e.field)}get hasSnippets(){var e,t;return!!(!((t=(e=this.model)===null||e===void 0?void 0:e.snippets)===null||t===void 0)&&t.length)}static get styles(){const e=g`var(--tileBorderColor, #dddddd)`;return[Ra,g`
        .container {
          border: 1px solid ${e};
        }
    ...
    >
    </tile-stats>`}static get styles(){const e=g`var(--tileBorderColor, #dddddd)`;return[Ra,g`
        .container {
          border: 1px solid ${e};
        }
      `]}};n([h({type:Object})],Pi.prototype,"model",void 0);n([h({type:String})],Pi.prototype,"baseImageUrl",void 0);Pi=n([N("account-tile")],Pi);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`+de),Ce&&(de=Oe(de,Ve," "),de=Oe(de,We," ")),R&&mi?R.createHTML(de):de},e.setConfig=function(C){qi(C),Ke=!0},e.clearConfig=function(){yt=null,Ke=!1},e.isValidAttribute=function(C,p,b){yt||qi({});var S=qe(C),H=qe(p);return or(S,H,b)},e.addHook=function(C,p){typeof p=="function"&&(ve[C]=ve[C]||[],Zt(ve[C],p))},e.removeHook=function(C){if(ve[C])return Mr(ve[C])},e.removeHooks=function(C){ve[C]&&(ve[C]=[])},e.removeAllHooks=function(){ve={}},e}var ii=xo(),A;(function(r){r.relevance="relevance",r.alltimeview="alltimeview",r.weeklyview="weeklyview",r.title="title",r.datearchived="datearchived",r.date="date",r.datereviewed="datereviewed",r.dateadded="dateadded",r.creator="creator"})(A||(A={}));const et={relevance:"Relevance",alltimeview:"All-time Views",weeklyview:"Weekly Views",title:"Title",datearchived:"Date Archived",date:"Date Published",datereviewed:"Date Reviewed",dateadded:"Date Added",creator:"Creator"},Fn={relevance:null,alltimeview:"downloads",weeklyview:"week",title:"titleSorter",datearchived:"publicdate",date:"date",datereviewed:"reviewdate",dateadded:"addeddate",creator:"creatorSorter"},Ar={week:A.weeklyview,downloads:A.alltimeview,titleSorter:A.title,date:A.date,publicdate:A.datearchived,reviewdate:A.datereviewed,addeddate:A.dateadded,creatorSorter:A.creator},On={title:"firstTitle",creator:"firstCreator"},Oi={subject:{},lending:{},mediatype:{},language:{},creator:{},collection:{},year:{}},In=["mediatype","lending","year","subject","collection","creator","language"],Ii={subject:"Subject",lending:"Availability",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"},Bn={is_lendable:!0,is_borrowable:!1,available_to_borrow:!0,is_browsable:!1,available_to_browse:!1,is_readable:!0,available_to_waitlist:!1},Pr={is_lendable:"Lending Library",available_to_borrow:"Borrow 14 Days",is_readable:"Always Available"},Ha={deemphasize:!0,community:!0,stream_only:!0,samples_only:!0,test_collection:!0,printdisabled:!0,"openlibrary-ol":!0,nationalemergencylibrary:!0,china:!0,americana:!0,toronto:!0};function _o(r){switch(r){case"date":return"Published";case"reviewdate":return"Reviewed";case"addeddate":return"Added";default:return"Archived"}}function So(r){return r?`Archivist since ${r.getFullYear()}`:""}let ye=class extends P{constructor(){super(...arguments),this.sortParam=null,this.collectionLinks=[],this.loggedIn=!1}render(){return u`
    ...
    `}};n([h({type:Object})],je.prototype,"model",void 0);n([h({type:String})],je.prototype,"baseNavigationUrl",void 0);n([h({type:String})],je.prototype,"baseImageUrl",void 0);n([h({type:Boolean})],je.prototype,"loggedIn",void 0);n([h({type:Object})],je.prototype,"sortParam",void 0);n([h({type:Object})],je.prototype,"collectionNameCache",void 0);je=n([N("tile-hover-pane")],je);let Me=class extends P{constructor(){super(...arguments),this.sortParam=null,this.loggedIn=!1}render(){var e,t,i,a,o,s,l,d,c;return u`
      <div id="list-line" class="${this.classSize}">
        <image-block
          .model=${this.model}
          .baseImageUrl=${this.baseImageUrl}
    ...
    `}};Or=n([N("collection-browser-loading-tile")],Or);let pi=class extends P{constructor(){super(...arguments),this.selectedLetter=null,this.alphabet="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("")}get selectedUppercaseLetter(){var e;return(e=this.selectedLetter)===null||e===void 0?void 0:e.toUpperCase()}render(){return u`
      <div id="container">
        <ul>
  ...
  `;n([h({type:String})],pi.prototype,"selectedLetter",void 0);n([h({type:Object})],pi.prototype,"letterCounts",void 0);pi=n([N("alpha-bar")],pi);const Ir=O`
...
`;let ee=class extends P{constructor(){super(...arguments),this.sortDirection=null,this.selectedSort=A.relevance,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.showRelevance=!0,this.alphaSelectorVisible=null,this.dateSortSelectorVisible=!1,this.viewSortSelectorVisible=!1,this.desktopSelectorBarWidth=0,this.selectorBarContainerWidth=0,this.hoveringOverDateSortOptions=!1,this.boundSortBarSelectorEscapeListener=e=>{e.key==="Escape"&&(this.viewSortSelectorVisible=!1,this.dateSortSelectorVisible=!1)}}render(){return u`
  ...
  `;n([h({type:String})],ee.prototype,"displayMode",void 0);n([h({type:String})],ee.prototype,"sortDirection",void 0);n([h({type:String})],ee.prototype,"selectedSort",void 0);n([h({type:String})],ee.prototype,"selectedTitleFilter",void 0);n([h({type:String})],ee.prototype,"selectedCreatorFilter",void 0);n([h({type:Boolean})],ee.prototype,"showRelevance",void 0);n([h({type:Object})],ee.prototype,"prefixFilterCountMap",void 0);n([h({type:Object})],ee.prototype,"resizeObserver",void 0);n([M()],ee.prototype,"alphaSelectorVisible",void 0);n([M()],ee.prototype,"dateSortSelectorVisible",void 0);n([M()],ee.prototype,"viewSortSelectorVisible",void 0);n([M()],ee.prototype,"desktopSelectorBarWidth",void 0);n([M()],ee.prototype,"selectorBarContainerWidth",void 0);n([M()],ee.prototype,"hoveringOverDateSortOptions",void 0);n([le("#desktop-sort-selector")],ee.prototype,"desktopSortSelector",void 0);n([le("#sort-selector-container")],ee.prototype,"sortSelectorContainer",void 0);ee=n([N("sort-filter-bar")],ee);/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Br=Ui(class extends ji{constructor(r){if(super(r),r.type!==De.PROPERTY&&r.type!==De.ATTRIBUTE&&r.type!==De.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Ts(r))throw Error("`live` bindings can only contain a single expression")}render(r){return r}update(r,[e]){if(e===ge||e===x)return e;const t=r.element,i=r.name;if(r.type===De.PROPERTY){if(e===t[i])return ge}else if(r.type===De.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(i))return ge}else if(r.type===De.ATTRIBUTE&&t.getAttribute(i)===e+"")return ge;return mo(r),e}});var $o=60,Co=$o*60,ko=Co*24,jn=ko*7,Ft=1e3,ua=$o*Ft,Nr=Co*Ft,Vn=ko*Ft,Wn=jn*Ft,Ua="millisecond",Ct="second",kt="minute",Tt="hour",Ie="day",Ti="week",xe="month",To="quarter",Be="year",Mt="date",Gn="YYYY-MM-DDTHH:mm:ssZ",Rr="Invalid Date",Qn=/^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/,Yn=/\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g,Kn={name:"en",weekdays:"Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),months:"January_February_March_April_May_June_July_August_September_October_November_December".split("_")},La=function(e,t,i){var a=String(e);return!a||a.length>=t?e:""+Array(t+1-a.length).join(i)+e},qn=function(e){var t=-e.utcOffset(),i=Math.abs(t),a=Math.floor(i/60),o=i%60;return(t<=0?"+":"-")+La(a,2,"0")+":"+La(o,2,"0")},Xn=function r(e,t){if(e.date()<t.date())return-r(t,e);var i=(t.year()-e.year())*12+(t.month()-e.month()),a=e.clone().add(i,xe),o=t-a<0,s=e.clone().add(i+(o?-1:1),xe);return+(-(i+(t-a)/(o?a-s:s-a))||0)},Zn=function(e){return e<0?Math.ceil(e)||0:Math.floor(e)},Jn=function(e){var t={M:xe,y:Be,w:Ti,d:Ie,D:Mt,h:Tt,m:kt,s:Ct,ms:Ua,Q:To};return t[e]||String(e||"").toLowerCase().replace(/s$/,"")},el=function(e){return e===void 0},tl={s:La,z:qn,m:Xn,a:Zn,p:Jn,u:el},ai="en",it={};it[ai]=Kn;var ja=function(e){return e instanceof Vi},Bi=function r(e,t,i){var a;if(!e)return ai;if(typeof e=="string"){var o=e.toLowerCase();it[o]&&(a=o),t&&(it[o]=t,a=o);var s=e.split("-");if(!a&&s.length>1)return r(s[0])}else{var l=e.name;it[l]=e,a=l}return!i&&a&&(ai=a),a||!i&&ai},J=function(e,t){if(ja(e))return e.clone();var i=typeof t=="object"?t:{};return i.date=e,i.args=arguments,new Vi(i)},il=function(e,t){return J(e,{locale:t.$L,utc:t.$u,x:t.$x,$offset:t.$offset})},U=tl;U.l=Bi;U.i=ja;U.w=il;var al=function(e){var t=e.date,i=e.utc;if(t===null)return new Date(NaN);if(U.u(t))return new Date;if(t instanceof Date)return new Date(t);if(typeof t=="string"&&!/Z$/i.test(t)){var a=t.match(Qn);if(a){var o=a[2]-1||0,s=(a[7]||"0").substring(0,3);return i?new Date(Date.UTC(a[1],o,a[3]||1,a[4]||0,a[5]||0,a[6]||0,s)):new Date(a[1],o,a[3]||1,a[4]||0,a[5]||0,a[6]||0,s)}}return new Date(t)},Vi=function(){function r(t){this.$L=Bi(t.locale,null,!0),this.parse(t)}var e=r.prototype;return e.parse=function(i){this.$d=al(i),this.$x=i.x||{},this.init()},e.init=function(){var i=this.$d;this.$y=i.getFullYear(),this.$M=i.getMonth(),this.$D=i.getDate(),this.$W=i.getDay(),this.$H=i.getHours(),this.$m=i.getMinutes(),this.$s=i.getSeconds(),this.$ms=i.getMilliseconds()},e.$utils=function(){return U},e.isValid=function(){return this.$d.toString()!==Rr},e.isSame=function(i,a){var o=J(i);return this.startOf(a)<=o&&o<=this.endOf(a)},e.isAfter=function(i,a){return J(i)<this.startOf(a)},e.isBefore=function(i,a){return this.endOf(a)<J(i)},e.$g=function(i,a,o){return U.u(i)?this[a]:this.set(o,i)},e.unix=function(){return Math.floor(this.valueOf()/1e3)},e.valueOf=function(){return this.$d.getTime()},e.startOf=function(i,a){var o=this,s=U.u(a)?!0:a,l=U.p(i),d=function(L,F){var B=U.w(o.$u?Date.UTC(o.$y,F,L):new Date(o.$y,F,L),o);return s?B:B.endOf(Ie)},c=function(L,F){var B=[0,0,0,0],R=[23,59,59,999];return U.w(o.toDate()[L].apply(o.toDate("s"),(s?B:R).slice(F)),o)},v=this.$W,m=this.$M,f=this.$D,w="set"+(this.$u?"UTC":"");switch(l){case Be:return s?d(1,0):d(31,11);case xe:return s?d(1,m):d(0,m+1);case Ti:{var _=this.$locale().weekStart||0,$=(v<_?v+7:v)-_;return d(s?f-$:f+(6-$),m)}case Ie:case Mt:return c(w+"Hours",0);case Tt:return c(w+"Minutes",1);case kt:return c(w+"Seconds",2);case Ct:return c(w+"Milliseconds",3);default:return this.clone()}},e.endOf=function(i){return this.startOf(i,!1)},e.$set=function(i,a){var o,s=U.p(i),l="set"+(this.$u?"UTC":""),d=(o={},o[Ie]=l+"Date",o[Mt]=l+"Date",o[xe]=l+"Month",o[Be]=l+"FullYear",o[Tt]=l+"Hours",o[kt]=l+"Minutes",o[Ct]=l+"Seconds",o[Ua]=l+"Milliseconds",o)[s],c=s===Ie?this.$D+(a-this.$W):a;if(s===xe||s===Be){var v=this.clone().set(Mt,1);v.$d[d](c),v.init(),this.$d=v.set(Mt,Math.min(this.$D,v.daysInMonth())).$d}else d&&this.$d[d](c);return this.init(),this},e.set=function(i,a){return this.clone().$set(i,a)},e.get=function(i){return this[U.p(i)]()},e.add=function(i,a){var o=this,s;i=Number(i);var l=U.p(a),d=function(f){var w=J(o);return U.w(w.date(w.date()+Math.round(f*i)),o)};if(l===xe)return this.set(xe,this.$M+i);if(l===Be)return this.set(Be,this.$y+i);if(l===Ie)return d(1);if(l===Ti)return d(7);var c=(s={},s[kt]=ua,s[Tt]=Nr,s[Ct]=Ft,s)[l]||1,v=this.$d.getTime()+i*c;return U.w(v,this)},e.subtract=function(i,a){return this.add(i*-1,a)},e.format=function(i){var a=this,o=this.$locale();if(!this.isValid())return o.invalidDate||Rr;var s=i||Gn,l=U.z(this),d=this.$H,c=this.$m,v=this.$M,m=o.weekdays,f=o.months,w=o.meridiem,_=function(B,R,Y,oe){return B&&(B[R]||B(a,s))||Y[R].slice(0,oe)},$=function(B){return U.s(d%12||12,B,"0")},E=w||function(F,B,R){var Y=F<12?"AM":"PM";return R?Y.toLowerCase():Y},L={YY:String(this.$y).slice(-2),YYYY:this.$y,M:v+1,MM:U.s(v+1,2,"0"),MMM:_(o.monthsShort,v,f,3),MMMM:_(f,v),D:this.$D,DD:U.s(this.$D,2,"0"),d:String(this.$W),dd:_(o.weekdaysMin,this.$W,m,2),ddd:_(o.weekdaysShort,this.$W,m,3),dddd:m[this.$W],H:String(d),HH:U.s(d,2,"0"),h:$(1),hh:$(2),a:E(d,c,!0),A:E(d,c,!1),m:String(c),mm:U.s(c,2,"0"),s:String(this.$s),ss:U.s(this.$s,2,"0"),SSS:U.s(this.$ms,3,"0"),Z:l};return s.replace(Yn,function(F,B){return B||L[F]||l.replace(":","")})},e.utcOffset=function(){return-Math.round(this.$d.getTimezoneOffset()/15)*15},e.diff=function(i,a,o){var s,l=U.p(a),d=J(i),c=(d.utcOffset()-this.utcOffset())*ua,v=this-d,m=U.m(this,d);return m=(s={},s[Be]=m/12,s[xe]=m,s[To]=m/3,s[Ti]=(v-c)/Wn,s[Ie]=(v-c)/Vn,s[Tt]=v/Nr,s[kt]=v/ua,s[Ct]=v/Ft,s)[l]||v,o?m:U.a(m)},e.daysInMonth=function(){return this.endOf(xe).$D},e.$locale=function(){return it[this.$L]},e.locale=function(i,a){if(!i)return this.$L;var o=this.clone(),s=Bi(i,a,!0);return s&&(o.$L=s),o},e.clone=function(){return U.w(this.$d,this)},e.toDate=function(){return new Date(this.valueOf())},e.toJSON=function(){return this.isValid()?this.toISOString():null},e.toISOString=function(){return this.$d.toISOString()},e.toString=function(){return this.$d.toUTCString()},r}(),Mo=Vi.prototype;J.prototype=Mo;[["$ms",Ua],["$s",Ct],["$m",kt],["$H",Tt],["$W",Ie],["$M",xe],["$y",Be],["$D",Mt]].forEach(function(r){Mo[r[1]]=function(e){return this.$g(e,r[0],r[1])}});J.extend=function(r,e){return r.$i||(r(e,Vi,J),r.$i=!0),J};J.locale=Bi;J.isDayjs=ja;J.unix=function(r){return J(r*1e3)};J.en=it[ai];J.Ls=it;J.p={};var rl=function(e){return e.replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g,function(t,i,a){return i||a.slice(1)})},ol={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"},sl=function(e,t){return e.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g,function(i,a,o){var s=o&&o.toUpperCase();return a||t[o]||ol[o]||rl(t[s])})},nl=/(\[[^[]*\])|([-:/.()\s]+)|(A|a|YYYY|YY?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g,ll=/\d/,_i=/\d\d/,dl=/\d{3}/,cl=/\d{4}/,ke=/\d\d?/,hl=/[+-]?\d+/,pl=/[+-]\d\d:?(\d\d)?|Z/,Jt=/\d*[^\s\d-_:/()]+/,Re={},zo=function(e){return e=+e,e+(e>68?1900:2e3)};function ul(r){if(!r||r==="Z")return 0;var e=r.match(/([+-]|\d\d)/g),t=+(e[1]*60)+(+e[2]||0);return t===0?0:e[0]==="+"?-t:t}var fe=function(e){return function(t){this[e]=+t}},Hr=[pl,function(r){var e=this.zone||(this.zone={});e.offset=ul(r)}],va=function(e){var t=Re[e];return t&&(t.indexOf?t:t.s.concat(t.f))},Ur=function(e,t){var i,a=Re,o=a.meridiem;if(!o)i=e===(t?"pm":"PM");else for(var s=1;s<=24;s+=1)if(e.indexOf(o(s,0,t))>-1){i=s>12;break}return i},vl={A:[Jt,function(r){this.afternoon=Ur(r,!1)}],a:[Jt,function(r){this.afternoon=Ur(r,!0)}],S:[ll,function(r){this.milliseconds=+r*100}],SS:[_i,function(r){this.milliseconds=+r*10}],SSS:[dl,function(r){this.milliseconds=+r}],s:[ke,fe("seconds")],ss:[ke,fe("seconds")],m:[ke,fe("minutes")],mm:[ke,fe("minutes")],H:[ke,fe("hours")],h:[ke,fe("hours")],HH:[ke,fe("hours")],hh:[ke,fe("hours")],D:[ke,fe("day")],DD:[_i,fe("day")],Do:[Jt,function(r){var e=Re,t=e.ordinal,i=r.match(/\d+/);if(this.day=i[0],!!t)for(var a=1;a<=31;a+=1)t(a).replace(/\[|\]/g,"")===r&&(this.day=a)}],M:[ke,fe("month")],MM:[_i,fe("month")],MMM:[Jt,function(r){var e=va("months"),t=va("monthsShort"),i=(t||e.map(function(a){return a.slice(0,3)})).indexOf(r)+1;if(i<1)throw new Error;this.month=i%12||i}],MMMM:[Jt,function(r){var e=va("months"),t=e.indexOf(r)+1;if(t<1)throw new Error;this.month=t%12||t}],Y:[hl,fe("year")],YY:[_i,function(r){this.year=zo(r)}],YYYY:[cl,fe("year")],Z:Hr,ZZ:Hr};function ml(r){var e=r.afternoon;if(e!==void 0){var t=r.hours;e?t<12&&(r.hours+=12):t===12&&(r.hours=0),delete r.afternoon}}function fl(r){r=sl(r,Re&&Re.formats);for(var e=r.match(nl),t=e.length,i=0;i<t;i+=1){var a=e[i],o=vl[a],s=o&&o[0],l=o&&o[1];l?e[i]={regex:s,parser:l}:e[i]=a.replace(/^\[|\]$/g,"")}return function(d){for(var c={},v=0,m=0;v<t;v+=1){var f=e[v];if(typeof f=="string")m+=f.length;else{var w=f.regex,_=f.parser,$=d.slice(m),E=w.exec($),L=E[0];_.call(c,L),d=d.replace(L,"")}}return ml(c),c}}var gl=function(e,t,i){try{if(["x","X"].indexOf(t)>-1)return new Date((t==="X"?1e3:1)*e);var a=fl(t),o=a(e),s=o.year,l=o.month,d=o.day,c=o.hours,v=o.minutes,m=o.seconds,f=o.milliseconds,w=o.zone,_=new Date,$=d||(!s&&!l?_.getDate():1),E=s||_.getFullYear(),L=0;s&&!l||(L=l>0?l-1:_.getMonth());var F=c||0,B=v||0,R=m||0,Y=f||0;return w?new Date(Date.UTC(E,L,$,F,B,R,Y+w.offset*60*1e3)):i?new Date(Date.UTC(E,L,$,F,B,R,Y)):new Date(E,L,$,F,B,R,Y)}catch{return new Date("")}},yl=function(r,e,t){t.p.customParseFormat=!0,r&&r.parseTwoDigitYear&&(zo=r.parseTwoDigitYear);var i=e.prototype,a=i.parse;i.parse=function(o){var s=o.date,l=o.utc,d=o.args;this.$u=l;var c=d[1];if(typeof c=="string"){var v=d[2]===!0,m=d[3]===!0,f=v||m,w=d[2];m&&(w=d[2]),Re=this.$locale(),!v&&w&&(Re=t.Ls[w]),this.$d=gl(s,c,l),this.init(),w&&w!==!0&&(this.$L=this.locale(w).$L),f&&s!=this.format(c)&&(this.$d=new Date("")),Re={}}else if(c instanceof Array)for(var _=c.length,$=1;$<=_;$+=1){d[1]=c[$-1];var E=t.apply(this,d);if(E.isValid()){this.$d=E.$d,this.$L=E.$L,this.init();break}$===_&&(this.$d=new Date(""))}else a.call(this,o)}};const bl=Object.freeze({processing:"processing",complete:"complete"});class wl extends P{static get properties(){return{mode:{type:String}}}constructor(){super(),this.mode=bl.processing}render(){return u`
      <div class="${this.mode}">
        <svg
          viewBox="0 0 120 120"
...
`;let It=class extends P{constructor(){super(...arguments),this.step=2,this.currentPage=1,this.pages=[]}firstUpdated(){this.observePageCount()}updated(e){e.has("size")&&this.observePageCount(),e.has("currentPage")&&(this.observePageCount(),this.emitPageClick())}observePageCount(){this.pages=[];const e=7,t=this.size<=e;if(this.size<=5){this.pages=[...Array(this.size).keys()].map(o=>o+1);return}if(this.size===e){if(this.currentPage===2){this.pages=[1,2,3,4,0,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,4,5,this.size-1,this.size];return}}if(this.currentPage===1){this.pages=[1,2,3,0,this.size];return}if(this.currentPage===this.size){this.pages=[1,0,this.size-2,this.size-1,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,this.size-3,this.size-2,this.size-1,this.size];return}if(t&&this.currentPage>1&&this.currentPage<e){this.pages=[...Array(this.size).keys()].map(o=>o+1);return}let i=this.currentPage-this.step,a=this.currentPage+this.step;i<=0&&(a+=-i+1,i=1),a>=this.size&&(i=Math.max(i-(a-this.size),1),a=this.size),i===2&&(a-=1),a===this.size-1&&(i+=1),this.createFirstNode(i),this.createMiddelNode(i,a),this.createLastNode(a)}createFirstNode(e){var t,i;e>1&&((t=this.pages)===null||t===void 0||t.push(1)),e>2&&((i=this.pages)===null||i===void 0||i.push(0))}createMiddelNode(e,t){var i;for(let a=e;a<=t;a+=1)(i=this.pages)===null||i===void 0||i.push(a)}createLastNode(e){var t,i;e<this.size-1&&((t=this.pages)===null||t===void 0||t.push(0)),e<this.size&&((i=this.pages)===null||i===void 0||i.push(this.size))}get getEllipsisTemplate(){return u`<i class="ellipses">...</i>`}emitPageClick(){this.dispatchEvent(new CustomEvent("pageNumberClicked",{detail:{page:this.currentPage},bubbles:!0,composed:!0}))}onRewind(){this.currentPage-=1,this.currentPage<1&&(this.currentPage=1)}onForward(){this.currentPage+=1,this.currentPage>this.size&&(this.currentPage=this.size)}onChange(e){this.currentPage=e}getPageTemplate(e){return u`
    ...
    `}};n([h({type:Number})],It.prototype,"size",void 0);n([h({type:Number})],It.prototype,"step",void 0);n([h({type:Number})],It.prototype,"currentPage",void 0);n([M()],It.prototype,"pages",void 0);It=n([N("more-facets-pagination")],It);var Wl=O`
...
`;let Bt=class extends P{facetClicked(e,t,i){const a=e.target,{checked:o,name:s,value:l}=a;o?this.facetChecked(s,l,t,i):this.facetUnchecked(s,l)}facetChecked(e,t,i,a){const{selectedFacets:o}=this;let s;o?s=ce({},o):s=Oi,s[e][t]={state:a?"hidden":"selected",count:i},this.selectedFacets=s,this.dispatchSelectedFacetsChanged()}facetUnchecked(e,t){const{selectedFacets:i}=this;let a;i?a=ce({},i):a=Oi,delete a[e][t],this.selectedFacets=a,this.dispatchSelectedFacetsChanged()}dispatchSelectedFacetsChanged(){const e=new CustomEvent("selectedFacetsChanged",{detail:this.selectedFacets,bubbles:!0,composed:!0});this.dispatchEvent(e)}getFacetsTemplate(e){let t=e==null?void 0:e.buckets;return t=[...t.filter(i=>i.state==="selected").sort((i,a)=>i.count<a.count?1:-1),...t.filter(i=>i.state==="hidden").sort((i,a)=>i.count<a.count?1:-1),...t.filter(i=>i.state==="none")],u`
    ...
    `}};n([h({type:String})],Z.prototype,"facetKey",void 0);n([h({type:String})],Z.prototype,"facetAggregationKey",void 0);n([h({type:String})],Z.prototype,"query",void 0);n([h({type:Object})],Z.prototype,"filterMap",void 0);n([h({type:Object})],Z.prototype,"modalManager",void 0);n([h({type:Object})],Z.prototype,"searchService",void 0);n([h({type:String})],Z.prototype,"searchType",void 0);n([h({type:Object})],Z.prototype,"collectionNameCache",void 0);n([h({type:Object})],Z.prototype,"languageCodeHandler",void 0);n([h({type:Object})],Z.prototype,"selectedFacets",void 0);n([h({type:String})],Z.prototype,"sortedBy",void 0);n([h({type:Object,attribute:!1})],Z.prototype,"analyticsHandler",void 0);n([M()],Z.prototype,"aggregations",void 0);n([M()],Z.prototype,"facetGroup",void 0);n([M()],Z.prototype,"facetGroupTitle",void 0);n([M()],Z.prototype,"pageNumber",void 0);n([M()],Z.prototype,"facetsLoading",void 0);n([M()],Z.prototype,"paginationSize",void 0);n([M()],Z.prototype,"facetsType",void 0);Z=n([N("more-facets-content")],Z);let Kr=class extends P{render(){return u`
      <div id="row">
...
`;let Ri=class extends P{constructor(){super(...arguments),this.placeholderType=null}render(){return this.placeholderType?u`${this.placeholderTemplate}`:x}get placeholderTemplate(){return u`
      <div
