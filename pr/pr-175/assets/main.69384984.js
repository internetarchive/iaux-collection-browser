...
`+le),ht&&(le=Fe(le,Ue," "),le=Fe(le,je," ")),B&&pi?B.createHTML(le):le},e.setConfig=function(C){Yi(C),Hi=!0},e.clearConfig=function(){ft=null,Hi=!1},e.isValidAttribute=function(C,u,b){ft||Yi({});var S=Ye(C),H=Ye(u);return ir(S,H,b)},e.addHook=function(C,u){typeof u=="function"&&(me[C]=me[C]||[],qt(me[C],u))},e.removeHook=function(C){if(me[C])return Cr(me[C])},e.removeHooks=function(C){me[C]&&(me[C]=[])},e.removeAllHooks=function(){me={}},e}var ei=go(),L;(function(r){r.relevance="relevance",r.alltimeview="alltimeview",r.weeklyview="weeklyview",r.title="title",r.datearchived="datearchived",r.date="date",r.datereviewed="datereviewed",r.dateadded="dateadded",r.creator="creator"})(L||(L={}));const Ze={relevance:"Relevance",alltimeview:"All-time Views",weeklyview:"Weekly Views",title:"Title",datearchived:"Date Archived",date:"Date Published",datereviewed:"Date Reviewed",dateadded:"Date Added",creator:"Creator"},zn={relevance:null,alltimeview:"downloads",weeklyview:"week",title:"titleSorter",datearchived:"publicdate",date:"date",datereviewed:"reviewdate",dateadded:"addeddate",creator:"creatorSorter"},Er={week:L.weeklyview,downloads:L.alltimeview,titleSorter:L.title,date:L.date,publicdate:L.datearchived,reviewdate:L.datereviewed,addeddate:L.dateadded,creatorSorter:L.creator},Mn={title:"firstTitle",creator:"firstCreator"},Ai={subject:{},lending:{},mediatype:{},language:{},creator:{},collection:{},year:{}},En=["mediatype","lending","year","subject","collection","creator","language"],Li={subject:"Subject",lending:"Availability",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"},Dn={is_lendable:!0,is_borrowable:!1,available_to_borrow:!0,is_browsable:!1,available_to_browse:!1,is_readable:!0,available_to_waitlist:!1},Dr={is_lendable:"Lending Library",available_to_borrow:"Borrow 14 Days",is_readable:"Always Available"},Na={deemphasize:!0,community:!0,stream_only:!0,samples_only:!0,test_collection:!0,printdisabled:!0,"openlibrary-ol":!0,nationalemergencylibrary:!0,china:!0,americana:!0,toronto:!0};function yo(r){switch(r){case"date":return"Published";case"reviewdate":return"Reviewed";case"addeddate":return"Added";default:return"Archived"}}function bo(r){return r?`Archivist since ${r.getFullYear()}`:""}let ye=class extends F{constructor(){super(...arguments),this.sortParam=null,this.collectionLinks=[],this.loggedIn=!1}updated(e){e.has("model")&&this.fetchCollectionNames()}async fetchCollectionNames(){var e,t;if(!(!((e=this.model)===null||e===void 0)&&e.collections)||this.model.collections.length===0||!this.collectionNameCache)return;this.collectionLinks=[];const i=[],a=[];for(const o of this.model.collections)!Na[o]&&!o.startsWith("fav-")&&a.push((t=this.collectionNameCache)===null||t===void 0?void 0:t.collectionNameFor(o).then(n=>{i.push(this.detailsLink(o,n!=null?n:o))}));await Promise.all(a),this.collectionLinks=i}render(){return p`
    ...
    `}};s([h({type:Object})],Dt.prototype,"model",void 0);s([h({type:Number})],Dt.prototype,"currentWidth",void 0);s([h({type:Object})],Dt.prototype,"sortParam",void 0);s([h({type:Number})],Dt.prototype,"mobileBreakpoint",void 0);Dt=s([R("tile-list-compact-header")],Dt);let re=class extends F{constructor(){super(...arguments),this.sortParam=null,this.loggedIn=!1,this.hoverDelayMillis=1e3,this.hoverPaneShown=!1,this.lastMouseOffsetX=0,this.lastMouseClientX=0}render(){return p`
      <div
        id="container"
    ...
    `}};s([h({type:String})],re.prototype,"tileDisplayMode",void 0);s([h({type:Object})],re.prototype,"model",void 0);s([h({type:String})],re.prototype,"baseNavigationUrl",void 0);s([h({type:Number})],re.prototype,"currentWidth",void 0);s([h({type:Number})],re.prototype,"currentHeight",void 0);s([h({type:Object})],re.prototype,"resizeObserver",void 0);s([h({type:Object})],re.prototype,"collectionNameCache",void 0);s([h({type:Object})],re.prototype,"sortParam",void 0);s([h({type:Number})],re.prototype,"mobileBreakpoint",void 0);s([h({type:String})],re.prototype,"baseImageUrl",void 0);s([h({type:Boolean})],re.prototype,"loggedIn",void 0);s([h({type:Number})],re.prototype,"hoverDelayMillis",void 0);s([T()],re.prototype,"hoverTimer",void 0);s([T()],re.prototype,"hoverPaneShown",void 0);s([pe("#container")],re.prototype,"container",void 0);re=s([R("tile-dispatcher")],re);let Ar=class extends F{render(){return p` <div id="container"></div> `}static get styles(){return y`
      :host {
        display: block;
        height: 100%;
      }
