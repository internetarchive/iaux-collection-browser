...
`;let di=class extends F{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1,this.isCompactTile=!1}render(){return u`<div class="icon-overlay ${this.getClass}">
    ...
    `}};n([h({type:Boolean})],di.prototype,"loggedIn",void 0);n([h({type:Boolean})],di.prototype,"loginRequired",void 0);n([h({type:Boolean})],di.prototype,"isCompactTile",void 0);di=n([R("icon-overlay")],di);let ci=class extends F{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1,this.iconRequired=!1}render(){return u`
    ...
    `}};n([h({type:String})],Ue.prototype,"baseImageUrl",void 0);n([h({type:Boolean})],Ue.prototype,"isCompactTile",void 0);n([h({type:Boolean})],Ue.prototype,"isListTile",void 0);n([h({type:Boolean})],Ue.prototype,"loggedIn",void 0);n([h({type:Object})],Ue.prototype,"model",void 0);n([h({type:String})],Ue.prototype,"viewSize",void 0);Ue=n([R("image-block")],Ue);let Li=class extends F{render(){return u`
      <div class="container">
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*$i(r,e){const t=typeof e=="function";if(r!==void 0){let i=-1;for(const a of r)i>-1&&(yield t?e(i):e),i++,yield a}}let Ai=class extends F{constructor(){super(...arguments),this.snippets=[],this.viewSize="desktop"}render(){var e;return!((e=this.snippets)===null||e===void 0)&&e.length?u`
      <div class="container">
 ...
 */let xt=en;function rn(r,e){let t=1;return r>=1e9?t=1e9:r>=1e6?t=1e6:r>=1e3&&e==="short"&&(t=1e3),t}function on(r=0,e){const t=r/e,i=t<10;let a=0;return i?a=Math.round((t+Number.EPSILON)*10)/10:a=Math.round(t),a}function sn(r,e,t,i){switch(e){case 1e9:return xt(t==="short"?wt`${r}B`:wt`${r} billion`);case 1e6:return xt(t==="short"?wt`${r}M`:wt`${r} million`);case 1e3:return xt(t==="short"?wt`${r}K`:wt`${r} thousand`);default:return new Intl.NumberFormat(i).format(r)}}function ti(r,e="long",t="short",i="en-US"){const a=r!=null?r:-1;if(a<0)return"";const o=rn(a,e),s=on(a,o);return sn(s,o,t,i)}let st=class extends F{render(){const e=ti(this.favCount,"short","short"),t=ti(this.commentCount,"short","short"),i=this.mediatype==="account"?`${this.itemCount} uploads`:`${this.viewCount} all-time views`;return u`
    ...
    `}get doesSortedByDate(){var e;return["date","reviewdate","addeddate","publicdate"].includes((e=this.sortParam)===null||e===void 0?void 0:e.field)}get hasSnippets(){var e,t;return!!(!((t=(e=this.model)===null||e===void 0?void 0:e.snippets)===null||t===void 0)&&t.length)}static get styles(){const e=g`var(--tileBorderColor, #dddddd)`;return[Ba,g`
      ...
      `]}};n([h({type:String})],At.prototype,"baseImageUrl",void 0);n([h({type:Boolean})],At.prototype,"loggedIn",void 0);n([h({type:Object})],At.prototype,"model",void 0);n([h({type:Object})],At.prototype,"sortParam",void 0);At=n([R("item-tile")],At);let Fi=class extends F{render(){return u`
      <div class="container">
        <div class="tile-details">
          <div class="item-info">
...
`+de),Ce&&(de=Oe(de,Ve," "),de=Oe(de,We," ")),B&&mi?B.createHTML(de):de},e.setConfig=function(C){qi(C),Ke=!0},e.clearConfig=function(){yt=null,Ke=!1},e.isValidAttribute=function(C,p,b){yt||qi({});var S=qe(C),H=qe(p);return or(S,H,b)},e.addHook=function(C,p){typeof p=="function"&&(ve[C]=ve[C]||[],Zt(ve[C],p))},e.removeHook=function(C){if(ve[C])return Mr(ve[C])},e.removeHooks=function(C){ve[C]&&(ve[C]=[])},e.removeAllHooks=function(){ve={}},e}var ii=xo(),A;(function(r){r.relevance="relevance",r.alltimeview="alltimeview",r.weeklyview="weeklyview",r.title="title",r.datearchived="datearchived",r.date="date",r.datereviewed="datereviewed",r.dateadded="dateadded",r.creator="creator"})(A||(A={}));const et={relevance:"Relevance",alltimeview:"All-time Views",weeklyview:"Weekly Views",title:"Title",datearchived:"Date Archived",date:"Date Published",datereviewed:"Date Reviewed",dateadded:"Date Added",creator:"Creator"},Pn={relevance:null,alltimeview:"downloads",weeklyview:"week",title:"titleSorter",datearchived:"publicdate",date:"date",datereviewed:"reviewdate",dateadded:"addeddate",creator:"creatorSorter"},Ar={week:A.weeklyview,downloads:A.alltimeview,titleSorter:A.title,date:A.date,publicdate:A.datearchived,reviewdate:A.datereviewed,addeddate:A.dateadded,creatorSorter:A.creator},On={title:"firstTitle",creator:"firstCreator"},Oi={subject:{},lending:{},mediatype:{},language:{},creator:{},collection:{},year:{}},In=["mediatype","lending","year","subject","collection","creator","language"],Ii={subject:"Subject",lending:"Availability",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"},Nn={is_lendable:!0,is_borrowable:!1,available_to_borrow:!0,is_browsable:!1,available_to_browse:!1,is_readable:!0,available_to_waitlist:!1},Fr={is_lendable:"Lending Library",available_to_borrow:"Borrow 14 Days",is_readable:"Always Available"},Ha={deemphasize:!0,community:!0,stream_only:!0,samples_only:!0,test_collection:!0,printdisabled:!0,"openlibrary-ol":!0,nationalemergencylibrary:!0,china:!0,americana:!0,toronto:!0};function _o(r){switch(r){case"date":return"Published";case"reviewdate":return"Reviewed";case"addeddate":return"Added";default:return"Archived"}}function So(r){return r?`Archivist since ${r.getFullYear()}`:""}let ye=class extends F{constructor(){super(...arguments),this.sortParam=null,this.collectionLinks=[],this.loggedIn=!1}render(){return u`
    ...
    `}};n([h({type:Object})],Ft.prototype,"model",void 0);n([h({type:Number})],Ft.prototype,"currentWidth",void 0);n([h({type:Object})],Ft.prototype,"sortParam",void 0);n([h({type:Number})],Ft.prototype,"mobileBreakpoint",void 0);Ft=n([R("tile-list-compact-header")],Ft);const Pr=(r,e=-1/0,t=1/0)=>Math.max(e,Math.min(r,t));class Rn{constructor(e,t={}){var i,a,o,s,l,d,c;this.host=e,this.mobileBreakpoint=600,this.offsetX=-10,this.offsetY=15,this.showDelay=300,this.hideDelay=100,this.longPressDelay=600,this.enableLongPress=!0,this.hoverPaneState="hidden",this.lastMouseClientPos={x:0,y:0},this.handleMouseEnter=v=>{this.handleMouseMove(v)},this.handleMouseMove=v=>{var m;clearTimeout(this.hideTimer),this.hoverPaneState==="fading-out"&&(this.hoverPaneState="shown",(m=this.hoverPane)===null||m===void 0||m.classList.add("fade-in")),this.hoverPaneState==="hidden"&&(this.restartShowHoverPaneTimer(),this.lastMouseClientPos={x:v.clientX,y:v.clientY})},this.handleMouseLeave=()=>{clearTimeout(this.showTimer),clearTimeout(this.hideTimer),this.hoverPaneState!=="hidden"&&(this.hideTimer=window.setTimeout(()=>{this.fadeOutHoverPane()},this.hideDelay))},this.handleTouchStart=()=>{clearTimeout(this.longPressTimer),this.longPressTimer=window.setTimeout(()=>{this.hoverPaneState==="hidden"&&this.showHoverPane()},this.longPressDelay)},this.handleLongPressCancel=()=>{clearTimeout(this.longPressTimer)},this.handleContextMenu=v=>{v.preventDefault()},this.handleBackdropTouchStart=v=>{this.hoverPaneState!=="hidden"&&this.fadeOutHoverPane(),v.stopPropagation()},this.host.addController(this),this.mobileBreakpoint=(i=t.mobileBreakpoint)!==null&&i!==void 0?i:this.mobileBreakpoint,this.offsetX=(a=t.offsetX)!==null&&a!==void 0?a:this.offsetX,this.offsetY=(o=t.offsetY)!==null&&o!==void 0?o:this.offsetY,this.showDelay=(s=t.showDelay)!==null&&s!==void 0?s:this.showDelay,this.hideDelay=(l=t.hideDelay)!==null&&l!==void 0?l:this.hideDelay,this.longPressDelay=(d=t.longPressDelay)!==null&&d!==void 0?d:this.longPressDelay,this.enableLongPress=(c=t.enableLongPress)!==null&&c!==void 0?c:this.enableLongPress}hostConnected(){this.attachListeners()}hostDisconnected(){this.detachListeners()}hostUpdated(){this.hoverPane=this.host.getHoverPane(),this.hoverPaneProps=this.host.getHoverPaneProps()}getTemplate(){var e,t,i,a,o,s;return this.shouldRenderHoverPane?u` ${this.touchBackdropTemplate}
          <tile-hover-pane
...
`;let Da=class extends F{constructor(){super(...arguments),this.config=new Eo}render(){return u`
