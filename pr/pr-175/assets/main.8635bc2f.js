...
`,Ws={account:{color:"#000000",icon:Fs,text:"Account"},audio:{color:"#00adef",icon:Ps,text:"Audio"},collection:{color:"#4666ff",icon:fo,text:"Collection"},data:{color:"#333333",icon:Os,text:"Data"},etree:{color:"#00adef",icon:Is,text:"E-tree"},film:{color:"#bf1b2c",icon:kr,text:"Film"},image:{color:"#aa99c9",icon:Ns,text:"Image"},movies:{color:"#f1644b",icon:kr,text:"Movie"},radio:{color:"#8fdaef",icon:Rs,text:"Radio"},software:{color:"#9ecc4f",icon:Bs,text:"Software"},texts:{color:"#faab3c",icon:Hs,text:"Text"},tv:{color:"#f1644b",icon:Us,text:"TV"},video:{color:"#f1644b",icon:js,text:"Video"},web:{color:"#ffcd27",icon:Vs,text:"Web"}};let hi=class extends F{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var e,t;const i=["tvnews","tvarchive","television"],a=["radio","radioprogram"];return this.mediatype==="movies"&&((e=this.collections)===null||e===void 0?void 0:e.some(o=>i.indexOf(o)>=0))?"tv":this.mediatype==="audio"&&((t=this.collections)===null||t===void 0?void 0:t.some(o=>a.indexOf(o)>=0))?"radio":this.mediatype||""}render(){const e=Ws[this.displayMediatype];return e?u`
      <div
        id="icon"
 ...
 */const Ir=Ui(class extends ji{constructor(r){if(super(r),r.type!==Ae.PROPERTY&&r.type!==Ae.ATTRIBUTE&&r.type!==Ae.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!ks(r))throw Error("`live` bindings can only contain a single expression")}render(r){return r}update(r,[e]){if(e===ge||e===x)return e;const t=r.element,i=r.name;if(r.type===Ae.PROPERTY){if(e===t[i])return ge}else if(r.type===Ae.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(i))return ge}else if(r.type===Ae.ATTRIBUTE&&t.getAttribute(i)===e+"")return ge;return vo(r),e}});var So=60,$o=So*60,Co=$o*24,Un=Co*7,Pt=1e3,ua=So*Pt,Nr=$o*Pt,jn=Co*Pt,Vn=Un*Pt,Ua="millisecond",Ct="second",kt="minute",Tt="hour",Ie="day",Ti="week",xe="month",ko="quarter",Ne="year",Mt="date",Wn="YYYY-MM-DDTHH:mm:ssZ",Rr="Invalid Date",Gn=/^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/,Qn=/\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g,Yn={name:"en",weekdays:"Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),months:"January_February_March_April_May_June_July_August_September_October_November_December".split("_")},La=function(e,t,i){var a=String(e);return!a||a.length>=t?e:""+Array(t+1-a.length).join(i)+e},Kn=function(e){var t=-e.utcOffset(),i=Math.abs(t),a=Math.floor(i/60),o=i%60;return(t<=0?"+":"-")+La(a,2,"0")+":"+La(o,2,"0")},qn=function r(e,t){if(e.date()<t.date())return-r(t,e);var i=(t.year()-e.year())*12+(t.month()-e.month()),a=e.clone().add(i,xe),o=t-a<0,s=e.clone().add(i+(o?-1:1),xe);return+(-(i+(t-a)/(o?a-s:s-a))||0)},Xn=function(e){return e<0?Math.ceil(e)||0:Math.floor(e)},Zn=function(e){var t={M:xe,y:Ne,w:Ti,d:Ie,D:Mt,h:Tt,m:kt,s:Ct,ms:Ua,Q:ko};return t[e]||String(e||"").toLowerCase().replace(/s$/,"")},Jn=function(e){return e===void 0},el={s:La,z:Kn,m:qn,a:Xn,p:Zn,u:Jn},ai="en",it={};it[ai]=Yn;var ja=function(e){return e instanceof Vi},Ni=function r(e,t,i){var a;if(!e)return ai;if(typeof e=="string"){var o=e.toLowerCase();it[o]&&(a=o),t&&(it[o]=t,a=o);var s=e.split("-");if(!a&&s.length>1)return r(s[0])}else{var l=e.name;it[l]=e,a=l}return!i&&a&&(ai=a),a||!i&&ai},J=function(e,t){if(ja(e))return e.clone();var i=typeof t=="object"?t:{};return i.date=e,i.args=arguments,new Vi(i)},tl=function(e,t){return J(e,{locale:t.$L,utc:t.$u,x:t.$x,$offset:t.$offset})},U=el;U.l=Ni;U.i=ja;U.w=tl;var il=function(e){var t=e.date,i=e.utc;if(t===null)return new Date(NaN);if(U.u(t))return new Date;if(t instanceof Date)return new Date(t);if(typeof t=="string"&&!/Z$/i.test(t)){var a=t.match(Gn);if(a){var o=a[2]-1||0,s=(a[7]||"0").substring(0,3);return i?new Date(Date.UTC(a[1],o,a[3]||1,a[4]||0,a[5]||0,a[6]||0,s)):new Date(a[1],o,a[3]||1,a[4]||0,a[5]||0,a[6]||0,s)}}return new Date(t)},Vi=function(){function r(t){this.$L=Ni(t.locale,null,!0),this.parse(t)}var e=r.prototype;return e.parse=function(i){this.$d=il(i),this.$x=i.x||{},this.init()},e.init=function(){var i=this.$d;this.$y=i.getFullYear(),this.$M=i.getMonth(),this.$D=i.getDate(),this.$W=i.getDay(),this.$H=i.getHours(),this.$m=i.getMinutes(),this.$s=i.getSeconds(),this.$ms=i.getMilliseconds()},e.$utils=function(){return U},e.isValid=function(){return this.$d.toString()!==Rr},e.isSame=function(i,a){var o=J(i);return this.startOf(a)<=o&&o<=this.endOf(a)},e.isAfter=function(i,a){return J(i)<this.startOf(a)},e.isBefore=function(i,a){return this.endOf(a)<J(i)},e.$g=function(i,a,o){return U.u(i)?this[a]:this.set(o,i)},e.unix=function(){return Math.floor(this.valueOf()/1e3)},e.valueOf=function(){return this.$d.getTime()},e.startOf=function(i,a){var o=this,s=U.u(a)?!0:a,l=U.p(i),d=function(L,P){var N=U.w(o.$u?Date.UTC(o.$y,P,L):new Date(o.$y,P,L),o);return s?N:N.endOf(Ie)},h=function(L,P){var N=[0,0,0,0],B=[23,59,59,999];return U.w(o.toDate()[L].apply(o.toDate("s"),(s?N:B).slice(P)),o)},v=this.$W,m=this.$M,f=this.$D,w="set"+(this.$u?"UTC":"");switch(l){case Ne:return s?d(1,0):d(31,11);case xe:return s?d(1,m):d(0,m+1);case Ti:{var _=this.$locale().weekStart||0,$=(v<_?v+7:v)-_;return d(s?f-$:f+(6-$),m)}case Ie:case Mt:return h(w+"Hours",0);case Tt:return h(w+"Minutes",1);case kt:return h(w+"Seconds",2);case Ct:return h(w+"Milliseconds",3);default:return this.clone()}},e.endOf=function(i){return this.startOf(i,!1)},e.$set=function(i,a){var o,s=U.p(i),l="set"+(this.$u?"UTC":""),d=(o={},o[Ie]=l+"Date",o[Mt]=l+"Date",o[xe]=l+"Month",o[Ne]=l+"FullYear",o[Tt]=l+"Hours",o[kt]=l+"Minutes",o[Ct]=l+"Seconds",o[Ua]=l+"Milliseconds",o)[s],h=s===Ie?this.$D+(a-this.$W):a;if(s===xe||s===Ne){var v=this.clone().set(Mt,1);v.$d[d](h),v.init(),this.$d=v.set(Mt,Math.min(this.$D,v.daysInMonth())).$d}else d&&this.$d[d](h);return this.init(),this},e.set=function(i,a){return this.clone().$set(i,a)},e.get=function(i){return this[U.p(i)]()},e.add=function(i,a){var o=this,s;i=Number(i);var l=U.p(a),d=function(f){var w=J(o);return U.w(w.date(w.date()+Math.round(f*i)),o)};if(l===xe)return this.set(xe,this.$M+i);if(l===Ne)return this.set(Ne,this.$y+i);if(l===Ie)return d(1);if(l===Ti)return d(7);var h=(s={},s[kt]=ua,s[Tt]=Nr,s[Ct]=Pt,s)[l]||1,v=this.$d.getTime()+i*h;return U.w(v,this)},e.subtract=function(i,a){return this.add(i*-1,a)},e.format=function(i){var a=this,o=this.$locale();if(!this.isValid())return o.invalidDate||Rr;var s=i||Wn,l=U.z(this),d=this.$H,h=this.$m,v=this.$M,m=o.weekdays,f=o.months,w=o.meridiem,_=function(N,B,Y,oe){return N&&(N[B]||N(a,s))||Y[B].slice(0,oe)},$=function(N){return U.s(d%12||12,N,"0")},E=w||function(P,N,B){var Y=P<12?"AM":"PM";return B?Y.toLowerCase():Y},L={YY:String(this.$y).slice(-2),YYYY:this.$y,M:v+1,MM:U.s(v+1,2,"0"),MMM:_(o.monthsShort,v,f,3),MMMM:_(f,v),D:this.$D,DD:U.s(this.$D,2,"0"),d:String(this.$W),dd:_(o.weekdaysMin,this.$W,m,2),ddd:_(o.weekdaysShort,this.$W,m,3),dddd:m[this.$W],H:String(d),HH:U.s(d,2,"0"),h:$(1),hh:$(2),a:E(d,h,!0),A:E(d,h,!1),m:String(h),mm:U.s(h,2,"0"),s:String(this.$s),ss:U.s(this.$s,2,"0"),SSS:U.s(this.$ms,3,"0"),Z:l};return s.replace(Qn,function(P,N){return N||L[P]||l.replace(":","")})},e.utcOffset=function(){return-Math.round(this.$d.getTimezoneOffset()/15)*15},e.diff=function(i,a,o){var s,l=U.p(a),d=J(i),h=(d.utcOffset()-this.utcOffset())*ua,v=this-d,m=U.m(this,d);return m=(s={},s[Ne]=m/12,s[xe]=m,s[ko]=m/3,s[Ti]=(v-h)/Vn,s[Ie]=(v-h)/jn,s[Tt]=v/Nr,s[kt]=v/ua,s[Ct]=v/Pt,s)[l]||v,o?m:U.a(m)},e.daysInMonth=function(){return this.endOf(xe).$D},e.$locale=function(){return it[this.$L]},e.locale=function(i,a){if(!i)return this.$L;var o=this.clone(),s=Ni(i,a,!0);return s&&(o.$L=s),o},e.clone=function(){return U.w(this.$d,this)},e.toDate=function(){return new Date(this.valueOf())},e.toJSON=function(){return this.isValid()?this.toISOString():null},e.toISOString=function(){return this.$d.toISOString()},e.toString=function(){return this.$d.toUTCString()},r}(),To=Vi.prototype;J.prototype=To;[["$ms",Ua],["$s",Ct],["$m",kt],["$H",Tt],["$W",Ie],["$M",xe],["$y",Ne],["$D",Mt]].forEach(function(r){To[r[1]]=function(e){return this.$g(e,r[0],r[1])}});J.extend=function(r,e){return r.$i||(r(e,Vi,J),r.$i=!0),J};J.locale=Ni;J.isDayjs=ja;J.unix=function(r){return J(r*1e3)};J.en=it[ai];J.Ls=it;J.p={};var al=function(e){return e.replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g,function(t,i,a){return i||a.slice(1)})},rl={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"},ol=function(e,t){return e.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g,function(i,a,o){var s=o&&o.toUpperCase();return a||t[o]||rl[o]||al(t[s])})},sl=/(\[[^[]*\])|([-:/.()\s]+)|(A|a|YYYY|YY?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g,nl=/\d/,_i=/\d\d/,ll=/\d{3}/,dl=/\d{4}/,ke=/\d\d?/,cl=/[+-]?\d+/,hl=/[+-]\d\d:?(\d\d)?|Z/,Jt=/\d*[^\s\d-_:/()]+/,Be={},Mo=function(e){return e=+e,e+(e>68?1900:2e3)};function pl(r){if(!r||r==="Z")return 0;var e=r.match(/([+-]|\d\d)/g),t=+(e[1]*60)+(+e[2]||0);return t===0?0:e[0]==="+"?-t:t}var fe=function(e){return function(t){this[e]=+t}},Br=[hl,function(r){var e=this.zone||(this.zone={});e.offset=pl(r)}],va=function(e){var t=Be[e];return t&&(t.indexOf?t:t.s.concat(t.f))},Hr=function(e,t){var i,a=Be,o=a.meridiem;if(!o)i=e===(t?"pm":"PM");else for(var s=1;s<=24;s+=1)if(e.indexOf(o(s,0,t))>-1){i=s>12;break}return i},ul={A:[Jt,function(r){this.afternoon=Hr(r,!1)}],a:[Jt,function(r){this.afternoon=Hr(r,!0)}],S:[nl,function(r){this.milliseconds=+r*100}],SS:[_i,function(r){this.milliseconds=+r*10}],SSS:[ll,function(r){this.milliseconds=+r}],s:[ke,fe("seconds")],ss:[ke,fe("seconds")],m:[ke,fe("minutes")],mm:[ke,fe("minutes")],H:[ke,fe("hours")],h:[ke,fe("hours")],HH:[ke,fe("hours")],hh:[ke,fe("hours")],D:[ke,fe("day")],DD:[_i,fe("day")],Do:[Jt,function(r){var e=Be,t=e.ordinal,i=r.match(/\d+/);if(this.day=i[0],!!t)for(var a=1;a<=31;a+=1)t(a).replace(/\[|\]/g,"")===r&&(this.day=a)}],M:[ke,fe("month")],MM:[_i,fe("month")],MMM:[Jt,function(r){var e=va("months"),t=va("monthsShort"),i=(t||e.map(function(a){return a.slice(0,3)})).indexOf(r)+1;if(i<1)throw new Error;this.month=i%12||i}],MMMM:[Jt,function(r){var e=va("months"),t=e.indexOf(r)+1;if(t<1)throw new Error;this.month=t%12||t}],Y:[cl,fe("year")],YY:[_i,function(r){this.year=Mo(r)}],YYYY:[dl,fe("year")],Z:Br,ZZ:Br};function vl(r){var e=r.afternoon;if(e!==void 0){var t=r.hours;e?t<12&&(r.hours+=12):t===12&&(r.hours=0),delete r.afternoon}}function ml(r){r=ol(r,Be&&Be.formats);for(var e=r.match(sl),t=e.length,i=0;i<t;i+=1){var a=e[i],o=ul[a],s=o&&o[0],l=o&&o[1];l?e[i]={regex:s,parser:l}:e[i]=a.replace(/^\[|\]$/g,"")}return function(d){for(var h={},v=0,m=0;v<t;v+=1){var f=e[v];if(typeof f=="string")m+=f.length;else{var w=f.regex,_=f.parser,$=d.slice(m),E=w.exec($),L=E[0];_.call(h,L),d=d.replace(L,"")}}return vl(h),h}}var fl=function(e,t,i){try{if(["x","X"].indexOf(t)>-1)return new Date((t==="X"?1e3:1)*e);var a=ml(t),o=a(e),s=o.year,l=o.month,d=o.day,h=o.hours,v=o.minutes,m=o.seconds,f=o.milliseconds,w=o.zone,_=new Date,$=d||(!s&&!l?_.getDate():1),E=s||_.getFullYear(),L=0;s&&!l||(L=l>0?l-1:_.getMonth());var P=h||0,N=v||0,B=m||0,Y=f||0;return w?new Date(Date.UTC(E,L,$,P,N,B,Y+w.offset*60*1e3)):i?new Date(Date.UTC(E,L,$,P,N,B,Y)):new Date(E,L,$,P,N,B,Y)}catch{return new Date("")}},gl=function(r,e,t){t.p.customParseFormat=!0,r&&r.parseTwoDigitYear&&(Mo=r.parseTwoDigitYear);var i=e.prototype,a=i.parse;i.parse=function(o){var s=o.date,l=o.utc,d=o.args;this.$u=l;var h=d[1];if(typeof h=="string"){var v=d[2]===!0,m=d[3]===!0,f=v||m,w=d[2];m&&(w=d[2]),Be=this.$locale(),!v&&w&&(Be=t.Ls[w]),this.$d=fl(s,h,l),this.init(),w&&w!==!0&&(this.$L=this.locale(w).$L),f&&s!=this.format(h)&&(this.$d=new Date("")),Be={}}else if(h instanceof Array)for(var _=h.length,$=1;$<=_;$+=1){d[1]=h[$-1];var E=t.apply(this,d);if(E.isValid()){this.$d=E.$d,this.$L=E.$L,this.init();break}$===_&&(this.$d=new Date(""))}else a.call(this,o)}};const yl=Object.freeze({processing:"processing",complete:"complete"});class bl extends F{static get properties(){return{mode:{type:String}}}constructor(){super(),this.mode=yl.processing}render(){return u`
    ...
    #tooltip:after {
      ...
      /* arrow */
      border: 5px solid ${Wr};
      border-color: ${Vr} transparent transparent
        transparent;
    }
    /****** slider ********/
    .draggable:hover {
...
`;let It=class extends F{constructor(){super(...arguments),this.step=2,this.currentPage=1,this.pages=[]}firstUpdated(){this.observePageCount()}updated(e){e.has("size")&&this.observePageCount(),e.has("currentPage")&&(this.observePageCount(),this.emitPageClick())}observePageCount(){this.pages=[];const e=7,t=this.size<=e;if(this.size<=5){this.pages=[...Array(this.size).keys()].map(o=>o+1);return}if(this.size===e){if(this.currentPage===2){this.pages=[1,2,3,4,0,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,4,5,this.size-1,this.size];return}}if(this.currentPage===1){this.pages=[1,2,3,0,this.size];return}if(this.currentPage===this.size){this.pages=[1,0,this.size-2,this.size-1,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,this.size-3,this.size-2,this.size-1,this.size];return}if(t&&this.currentPage>1&&this.currentPage<e){this.pages=[...Array(this.size).keys()].map(o=>o+1);return}let i=this.currentPage-this.step,a=this.currentPage+this.step;i<=0&&(a+=-i+1,i=1),a>=this.size&&(i=Math.max(i-(a-this.size),1),a=this.size),i===2&&(a-=1),a===this.size-1&&(i+=1),this.createFirstNode(i),this.createMiddelNode(i,a),this.createLastNode(a)}createFirstNode(e){var t,i;e>1&&((t=this.pages)===null||t===void 0||t.push(1)),e>2&&((i=this.pages)===null||i===void 0||i.push(0))}createMiddelNode(e,t){var i;for(let a=e;a<=t;a+=1)(i=this.pages)===null||i===void 0||i.push(a)}createLastNode(e){var t,i;e<this.size-1&&((t=this.pages)===null||t===void 0||t.push(0)),e<this.size&&((i=this.pages)===null||i===void 0||i.push(this.size))}get getEllipsisTemplate(){return u`<i class="ellipses">...</i>`}emitPageClick(){this.dispatchEvent(new CustomEvent("pageNumberClicked",{detail:{page:this.currentPage},bubbles:!0,composed:!0}))}onRewind(){this.currentPage-=1,this.currentPage<1&&(this.currentPage=1)}onForward(){this.currentPage+=1,this.currentPage>this.size&&(this.currentPage=this.size)}onChange(e){this.currentPage=e}getPageTemplate(e){return u`
    ...
    `}};n([c({type:Number})],It.prototype,"size",void 0);n([c({type:Number})],It.prototype,"step",void 0);n([c({type:Number})],It.prototype,"currentPage",void 0);n([M()],It.prototype,"pages",void 0);It=n([R("more-facets-pagination")],It);var Vl=O`
              ...
              <div class="facet-row">
                <div class="facet-checkbox">
                  ...
                  <label
                    ...
                    title=${$}
                  >
                    <span class="eye">${Vl}</span>
                    <span class="eye-closed">${Wl}</span>
                  </label>
                </div>
                <label
                  for=${s}
