 ...
 */const sa=(a,e,t)=>{const i=new Map;for(let o=e;o<=t;o++)i.set(a[o],o);return i},Qa=Ti(class extends ki{constructor(a){if(super(a),a.type!==Ee.CHILD)throw Error("repeat() can only be used in text expressions")}dt(a,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);const o=[],r=[];let n=0;for(const l of a)o[n]=i?i(l,n):n,r[n]=t(l,n),n++;return{values:r,keys:o}}render(a,e,t){return this.dt(a,e,t).values}update(a,[e,t,i]){var o;const r=ts(a),{values:n,keys:l}=this.dt(e,t,i);if(!Array.isArray(r))return this.ut=l,n;const d=(o=this.ut)!==null&&o!==void 0?o:this.ut=[],u=[];let v,f,y=0,x=r.length-1,_=0,M=n.length-1;for(;y<=x&&_<=M;)if(r[y]===null)y++;else if(r[x]===null)x--;else if(d[y]===l[_])u[_]=Ye(r[y],n[_]),y++,_++;else if(d[x]===l[M])u[M]=Ye(r[x],n[M]),x--,M--;else if(d[y]===l[M])u[M]=Ye(r[y],n[M]),Nt(a,u[M+1],r[y]),y++,M--;else if(d[x]===l[_])u[_]=Ye(r[x],n[_]),Nt(a,r[y],r[x]),x--,_++;else if(v===void 0&&(v=sa(l,_,M),f=sa(d,y,x)),v.has(d[y]))if(v.has(d[x])){const P=f.get(l[_]),Z=P!==void 0?r[P]:null;if(Z===null){const R=Nt(a,r[y]);Ye(R,n[_]),u[_]=R}else u[_]=Ye(Z,n[_]),Nt(a,r[y],Z),r[P]=null;_++}else ji(r[x]),x--;else ji(r[y]),y++;for(;_<=M;){const P=Nt(a,u[M+1]);Ye(P,n[_]),u[_++]=P}for(;y<=x;){const P=r[y++];P!==null&&ji(P)}return this.ut=l,Ga(a,u),me}});function li(a,e,t){return Array.from({length:(e-a)/t+1},(i,o)=>a+o*t)}let Be=class extends L{constructor(){super(...arguments),this.itemCount=0,this.scrollOptimizationsDisabled=!1,this.intersectionObserver=new IntersectionObserver(e=>{e.forEach(t=>{if(t.target===this.sentinel){t.isIntersecting&&this.dispatchEvent(new Event("scrollThresholdReached"));return}const o=t.target.dataset.cellIndex;if(!o)return;const r=parseInt(o,10);t.isIntersecting?this.visibleCellIndices.add(r):this.visibleCellIndices.delete(r)}),this.scrollOptimizationsDisabled||this.processVisibleCells()}),this.renderedCellIndices=new Set,this.visibleCellIndices=new Set,this.placeholderCellIndices=new Set}reload(){li(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.removeCell(t)),this.renderedCellIndices.clear(),this.visibleCellIndices.clear(),this.placeholderCellIndices.clear(),this.setupObservations()}scrollToCell(e,t){const i=this.cellContainers[e];if(!i)return!1;const o=t?"smooth":"auto";return i.scrollIntoView({behavior:o}),!0}getVisibleCellIndices(){return Array.from(this.visibleCellIndices)}updated(e){(e.has("itemCount")||e.has("scrollOptimizationsDisabled"))&&this.setupObservations()}disconnectedCallback(){this.intersectionObserver.disconnect()}setupObservations(){this.setupIntersectionObserver()}setupIntersectionObserver(){this.intersectionObserver.disconnect(),this.sentinel&&this.intersectionObserver.observe(this.sentinel),this.scrollOptimizationsDisabled?(li(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.visibleCellIndices.add(t)),this.processVisibleCells()):this.cellContainers.forEach(e=>this.intersectionObserver.observe(e))}render(){const e=this.itemCount-1,t=li(0,e,1);return h`
    ...
    `}};s([c({type:Number})],Be.prototype,"itemCount",void 0);s([c({type:Object})],Be.prototype,"cellProvider",void 0);s([c({type:Object})],Be.prototype,"placeholderCellTemplate",void 0);s([c({type:Boolean})],Be.prototype,"scrollOptimizationsDisabled",void 0);s([q("#sentinel")],Be.prototype,"sentinel",void 0);s([Kr(".cell-container")],Be.prototype,"cellContainers",void 0);Be=s([A("infinite-scroller")],Be);/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`,ys={account:{color:"#000000",icon:ns,text:"Account"},audio:{color:"#00adef",icon:ls,text:"Audio"},collection:{color:"#4666ff",icon:qa,text:"Collection"},data:{color:"#333333",icon:ds,text:"Data"},etree:{color:"#00adef",icon:cs,text:"E-tree"},film:{color:"#bf1b2c",icon:na,text:"Film"},image:{color:"#aa99c9",icon:hs,text:"Image"},movies:{color:"#f1644b",icon:na,text:"Movie"},radio:{color:"#8fdaef",icon:ps,text:"Radio"},software:{color:"#9ecc4f",icon:us,text:"Software"},texts:{color:"#faab3c",icon:vs,text:"Text"},tv:{color:"#f1644b",icon:ms,text:"TV"},video:{color:"#f1644b",icon:fs,text:"Video"},web:{color:"#ffcd27",icon:gs,text:"Web"}};let Zt=class extends L{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var e,t;const i=["tvnews","tvarchive","television"],o=["radio","radioprogram"];return this.mediatype==="movies"&&((e=this.collections)===null||e===void 0?void 0:e.some(r=>i.indexOf(r)>=0))?"tv":this.mediatype==="audio"&&((t=this.collections)===null||t===void 0?void 0:t.some(r=>o.indexOf(r)>=0))?"radio":this.mediatype||""}render(){const e=ys[this.displayMediatype];return e?h`
    ...
    `}};s([c({type:String})],Zt.prototype,"mediatype",void 0);s([c({type:Array})],Zt.prototype,"collections",void 0);s([c({type:Boolean})],Zt.prototype,"showText",void 0);Zt=s([A("mediatype-icon")],Zt);const bs=F`
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const $s=(a,...e)=>({strTag:!0,strings:a,values:e}),ft=$s,Cs=a=>typeof a!="string"&&"strTag"in a,Ss=(a,e,t)=>{let i=a[0];for(let o=1;o<a.length;o++)i+=e[t?t[o-1]:o-1],i+=a[o];return i};/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let gt=Ts;function Ms(a,e){let t=1;return a>=1e9?t=1e9:a>=1e6?t=1e6:a>=1e3&&e==="short"&&(t=1e3),t}function Es(a=0,e){const t=a/e,i=t<10;let o=0;return i?o=Math.round((t+Number.EPSILON)*10)/10:o=Math.round(t),o}function Ls(a,e,t,i){switch(e){case 1e9:return gt(t==="short"?ft`${a}B`:ft`${a} billion`);case 1e6:return gt(t==="short"?ft`${a}M`:ft`${a} million`);case 1e3:return gt(t==="short"?ft`${a}K`:ft`${a} thousand`);default:return new Intl.NumberFormat(i).format(a)}}function Wt(a,e="long",t="short",i="en-US"){const o=a!=null?a:-1;if(o<0)return"";const r=Ms(o,e),n=Es(o,r);return Ls(n,r,t,i)}let Ie=class extends L{render(){var e;const t=Wt(this.favCount,"short","short"),i=Wt(this.commentCount,"short","short"),o=this.mediatype==="account"?`${this.itemCount} uploads`:`${this.viewCount} ${(e=this.viewLabel)!==null&&e!==void 0?e:"all-time views"}`;return h`
...
`+se),$e&&(se=Pe(se,He," "),se=Pe(se,We," ")),K&&ai?K.createHTML(se):se},e.setConfig=function(C){Ai(C),Qe=!0},e.clearConfig=function(){vt=null,Qe=!1},e.isValidAttribute=function(C,p,w){vt||Ai({});var $=Ke(C),O=Ke(p);return No($,O,w)},e.addHook=function(C,p){typeof p=="function"&&(ce[C]=ce[C]||[],Ut(ce[C],p))},e.removeHook=function(C){if(ce[C])return da(ce[C])},e.removeHooks=function(C){ce[C]&&(ce[C]=[])},e.removeAllHooks=function(){ce={}},e}var jt=Za(),z;(function(a){a.relevance="relevance",a.alltimeview="alltimeview",a.weeklyview="weeklyview",a.title="title",a.date="date",a.datearchived="datearchived",a.datereviewed="datereviewed",a.dateadded="dateadded",a.creator="creator"})(z||(z={}));const Je={relevance:"Relevance",alltimeview:"All-time views",weeklyview:"Weekly views",title:"Title",date:"Date published",datearchived:"Date archived",datereviewed:"Date reviewed",dateadded:"Date added",creator:"Creator"},va={relevance:"desc",alltimeview:"desc",weeklyview:"desc",title:"asc",date:"desc",datearchived:"desc",datereviewed:"desc",dateadded:"desc",creator:"asc"},nn={relevance:null,alltimeview:"downloads",weeklyview:"week",title:"titleSorter",date:"date",datearchived:"publicdate",datereviewed:"reviewdate",dateadded:"addeddate",creator:"creatorSorter"};z.weeklyview,z.alltimeview,z.title,z.date,z.datearchived,z.datereviewed,z.dateadded,z.creator;const ln={week:"week",downloads:"downloads",titleSorter:"title",date:"date",publicdate:"publicdate",reviewdate:"reviewdate",addeddate:"addeddate",creatorSorter:"creator"},ma={week:z.weeklyview,downloads:z.alltimeview,title:z.title,titleSorter:z.title,date:z.date,publicdate:z.datearchived,reviewdate:z.datereviewed,addeddate:z.dateadded,creator:z.creator,creatorSorter:z.creator},dn={title:"firstTitle",creator:"firstCreator"},ei=()=>({subject:{},lending:{},mediatype:{},language:{},creator:{},collection:{},year:{}}),cn=["mediatype","lending","year","subject","collection","creator","language"],$i={subject:"Subject",lending:"Availability",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"},ho={subject:V.COUNT,lending:V.COUNT,mediatype:V.COUNT,language:V.COUNT,creator:V.COUNT,collection:V.COUNT,year:V.NUMERIC},hn={subject:V.ALPHABETICAL,lending:V.ALPHABETICAL,mediatype:V.ALPHABETICAL,language:V.ALPHABETICAL,creator:V.ALPHABETICAL,collection:V.ALPHABETICAL,year:V.NUMERIC},pn={is_lendable:!0,is_borrowable:!1,available_to_borrow:!0,is_browsable:!1,available_to_browse:!1,is_readable:!0,available_to_waitlist:!1},fa={is_lendable:"Lending Library",available_to_borrow:"Borrow 14 Days",is_readable:"Always Available"},Co={deemphasize:!0,community:!0,stream_only:!0,samples_only:!0,test_collection:!0,printdisabled:!0,"openlibrary-ol":!0,nationalemergencylibrary:!0,china:!0,americana:!0,toronto:!0};function Ja(a){switch(a){case"publicdate":return"Archived";case"reviewdate":return"Reviewed";case"addeddate":return"Added";default:return"Published"}}function er(a){return a?`Archivist since ${a.getFullYear()}`:""}let fe=class extends L{constructor(){super(...arguments),this.sortParam=null,this.collectionLinks=[],this.loggedIn=!1}render(){return h`
  ...
  `;s([c({type:String})],Ne.prototype,"selectedLetter",void 0);s([c({type:Object})],Ne.prototype,"letterCounts",void 0);s([k()],Ne.prototype,"tooltipShown",void 0);s([k()],Ne.prototype,"hoveredLetter",void 0);s([q("alpha-bar-tooltip")],Ne.prototype,"tooltip",void 0);Ne=s([A("alpha-bar")],Ne);const vn=h`
...
`;let mo=class extends L{constructor(){super(...arguments),this.config=new tr}render(){return h`
    ...
    `}};s([c({type:Object})],mo.prototype,"config",void 0);mo=s([A("modal-template")],mo);function Hn(a,e,t){var i=t||{},o=i.noTrailing,r=o===void 0?!1:o,n=i.noLeading,l=n===void 0?!1:n,d=i.debounceMode,u=d===void 0?void 0:d,v,f=!1,y=0;function x(){v&&clearTimeout(v)}function _(P){var Z=P||{},R=Z.upcomingOnly,ee=R===void 0?!1:R;x(),f=!ee}function M(){for(var P=arguments.length,Z=new Array(P),R=0;R<P;R++)Z[R]=arguments[R];var ee=this,K=Date.now()-y;if(f)return;function ue(){y=Date.now(),e.apply(ee,Z)}function ve(){v=void 0}!l&&u&&!v&&ue(),x(),u===void 0&&K>a?l?(y=Date.now(),r||(v=setTimeout(u?ve:ue,a))):ue():r!==!0&&(v=setTimeout(u?ve:ue,u===void 0?a-K:a))}return M.cancel=_,M}var tt;(function(a){a.Open="open",a.Closed="closed"})(tt||(tt={}));class Wn{constructor(e){this.windowResizeThrottler=Hn(100,this.updateModalContainerHeight).bind(this),this.modalManager=e}handleModeChange(e){switch(e){case tt.Open:this.startResizeListener(),this.stopDocumentScroll();break;case tt.Closed:this.stopResizeListener(),this.resumeDocumentScroll();break}}updateModalContainerHeight(){this.modalManager.style.setProperty("--containerHeight",`${window.innerHeight}px`)}stopDocumentScroll(){document.body.classList.add("modal-manager-open")}resumeDocumentScroll(){document.body.classList.remove("modal-manager-open")}startResizeListener(){window.addEventListener("resize",this.windowResizeThrottler)}stopResizeListener(){window.removeEventListener("resize",this.windowResizeThrottler)}}let St=class extends L{constructor(){super(...arguments),this.mode=tt.Closed,this.hostBridge=new Wn(this),this.closeOnBackdropClick=!0}render(){return h`
      <div class="container">
...
`;let Tt=class extends L{constructor(){super(...arguments),this.step=2,this.currentPage=1,this.pages=[]}firstUpdated(){this.observePageCount()}updated(e){e.has("size")&&this.observePageCount(),e.has("currentPage")&&(this.observePageCount(),this.emitPageClick())}observePageCount(){this.pages=[];const e=7,t=this.size<=e;if(this.size<=5){this.pages=[...Array(this.size).keys()].map(r=>r+1);return}if(this.size===e){if(this.currentPage===2){this.pages=[1,2,3,4,0,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,4,5,this.size-1,this.size];return}}if(this.currentPage===1){this.pages=[1,2,3,0,this.size];return}if(this.currentPage===this.size){this.pages=[1,0,this.size-2,this.size-1,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,this.size-3,this.size-2,this.size-1,this.size];return}if(t&&this.currentPage>1&&this.currentPage<e){this.pages=[...Array(this.size).keys()].map(r=>r+1);return}let i=this.currentPage-this.step,o=this.currentPage+this.step;i<=0&&(o+=-i+1,i=1),o>=this.size&&(i=Math.max(i-(o-this.size),1),o=this.size),i===2&&(o-=1),o===this.size-1&&(i+=1),this.createFirstNode(i),this.createMiddelNode(i,o),this.createLastNode(o)}createFirstNode(e){var t,i;e>1&&((t=this.pages)===null||t===void 0||t.push(1)),e>2&&((i=this.pages)===null||i===void 0||i.push(0))}createMiddelNode(e,t){var i;for(let o=e;o<=t;o+=1)(i=this.pages)===null||i===void 0||i.push(o)}createLastNode(e){var t,i;e<this.size-1&&((t=this.pages)===null||t===void 0||t.push(0)),e<this.size&&((i=this.pages)===null||i===void 0||i.push(this.size))}get getEllipsisTemplate(){return h`<i class="ellipses">...</i>`}emitPageClick(){this.dispatchEvent(new CustomEvent("pageNumberClicked",{detail:{page:this.currentPage},bubbles:!0,composed:!0}))}onRewind(){this.currentPage-=1,this.currentPage<1&&(this.currentPage=1)}onForward(){this.currentPage+=1,this.currentPage>this.size&&(this.currentPage=this.size)}onChange(e){this.currentPage=e}getPageTemplate(e){return h`
    ...
    `}};s([c({type:Number})],Tt.prototype,"size",void 0);s([c({type:Number})],Tt.prototype,"step",void 0);s([c({type:Number})],Tt.prototype,"currentPage",void 0);s([k()],Tt.prototype,"pages",void 0);Tt=s([A("more-facets-pagination")],Tt);var Gn=F`
