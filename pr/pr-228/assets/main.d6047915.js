...
`;let Kt=class extends D{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1,this.isCompactTile=!1}render(){return h`<div class="icon-overlay ${this.getClass}">
    ...
    >`}get getSizeTemplate(){var e,t;const i=(t=(e=this.model)===null||e===void 0?void 0:e.collectionSize)!==null&&t!==void 0?t:0;return i?h`<span id="item-size">${is(i,1)}</span>`:""}get infoButtonTemplate(){return this.showInfoButton?h`<button class="info-button" @click=${this.infoButtonPressed}>
        ...
        </button>`:b}infoButtonPressed(e){e.preventDefault();const t=new CustomEvent("infoButtonPressed",{detail:{x:e.clientX,y:e.clientY}});this.dispatchEvent(t)}static get styles(){const e=m`var(--tileBorderColor, #555555)`,t=m`var(--tileBackgroundColor, #666666)`,i=m`#fff`;return[$o,m`
        .container {
          background-color: ${t};
          border: 1px solid ${e};
        }
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const $s=(a,...e)=>({strTag:!0,strings:a,values:e}),gt=$s,Cs=a=>typeof a!="string"&&"strTag"in a,Ss=(a,e,t)=>{let i=a[0];for(let o=1;o<a.length;o++)i+=e[t?t[o-1]:o-1],i+=a[o];return i};/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ts=a=>Cs(a)?Ss(a.strings,a.values):a;/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let yt=Ts;function Ms(a,e){let t=1;return a>=1e9?t=1e9:a>=1e6?t=1e6:a>=1e3&&e==="short"&&(t=1e3),t}function Es(a=0,e){const t=a/e,i=t<10;let o=0;return i?o=Math.round((t+Number.EPSILON)*10)/10:o=Math.round(t),o}function Ls(a,e,t,i){switch(e){case 1e9:return yt(t==="short"?gt`${a}B`:gt`${a} billion`);case 1e6:return yt(t==="short"?gt`${a}M`:gt`${a} million`);case 1e3:return yt(t==="short"?gt`${a}K`:gt`${a} thousand`);default:return new Intl.NumberFormat(i).format(a)}}function Wt(a,e="long",t="short",i="en-US"){const o=a!=null?a:-1;if(o<0)return"";const r=Ms(o,e),n=Es(o,r);return Ls(n,r,t,i)}let Re=class extends D{render(){var e;const t=Wt(this.favCount,"short","short"),i=Wt(this.commentCount,"short","short"),o=this.mediatype==="account"?`${this.itemCount} uploads`:`${this.viewCount} ${(e=this.viewLabel)!==null&&e!==void 0?e:"all-time views"}`;return h`
    ...
    >
          ...
          &#9432;
          <span class="sr-only">More info</span>
        </button>`:b}infoButtonPressed(e){e.preventDefault();const t=new CustomEvent("infoButtonPressed",{detail:{x:e.clientX,y:e.clientY}});this.dispatchEvent(t)}static get styles(){const e=m`var(--tileBorderColor, #dddddd)`;return[$o,m`
        .container {
          border: 1px solid ${e};
        }
...
`+ne),$e&&(ne=Pe(ne,We," "),ne=Pe(ne,je," ")),G&&ai?G.createHTML(ne):ne},e.setConfig=function(C){Ai(C),Qe=!0},e.clearConfig=function(){mt=null,Qe=!1},e.isValidAttribute=function(C,p,w){mt||Ai({});var _=Xe(C),O=Xe(p);return No(_,O,w)},e.addHook=function(C,p){typeof p=="function"&&(he[C]=he[C]||[],Ut(he[C],p))},e.removeHook=function(C){if(he[C])return da(he[C])},e.removeHooks=function(C){he[C]&&(he[C]=[])},e.removeAllHooks=function(){he={}},e}var jt=Za(),M;(function(a){a.relevance="relevance",a.alltimeview="alltimeview",a.weeklyview="weeklyview",a.title="title",a.date="date",a.datearchived="datearchived",a.datereviewed="datereviewed",a.dateadded="dateadded",a.creator="creator"})(M||(M={}));const et={relevance:"Relevance",alltimeview:"All-time views",weeklyview:"Weekly views",title:"Title",date:"Date published",datearchived:"Date archived",datereviewed:"Date reviewed",dateadded:"Date added",creator:"Creator"},va={relevance:"desc",alltimeview:"desc",weeklyview:"desc",title:"asc",date:"desc",datearchived:"desc",datereviewed:"desc",dateadded:"desc",creator:"asc"},nn={relevance:null,alltimeview:"downloads",weeklyview:"week",title:"titleSorter",date:"date",datearchived:"publicdate",datereviewed:"reviewdate",dateadded:"addeddate",creator:"creatorSorter"};M.weeklyview,M.alltimeview,M.title,M.date,M.datearchived,M.datereviewed,M.dateadded,M.creator;const ln={week:"week",downloads:"downloads",titleSorter:"title",date:"date",publicdate:"publicdate",reviewdate:"reviewdate",addeddate:"addeddate",creatorSorter:"creator"},ma={week:M.weeklyview,downloads:M.alltimeview,title:M.title,titleSorter:M.title,date:M.date,publicdate:M.datearchived,reviewdate:M.datereviewed,addeddate:M.dateadded,creator:M.creator,creatorSorter:M.creator},dn={title:"firstTitle",creator:"firstCreator"},ei=()=>({subject:{},lending:{},mediatype:{},language:{},creator:{},collection:{},year:{}}),cn=["mediatype","lending","year","subject","collection","creator","language"],$i={subject:"Subject",lending:"Availability",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"},ho={subject:j.COUNT,lending:j.COUNT,mediatype:j.COUNT,language:j.COUNT,creator:j.COUNT,collection:j.COUNT,year:j.NUMERIC},hn={subject:j.ALPHABETICAL,lending:j.ALPHABETICAL,mediatype:j.ALPHABETICAL,language:j.ALPHABETICAL,creator:j.ALPHABETICAL,collection:j.ALPHABETICAL,year:j.NUMERIC},pn={is_lendable:!0,is_borrowable:!1,available_to_borrow:!0,is_browsable:!1,available_to_browse:!1,is_readable:!0,available_to_waitlist:!1},fa={is_lendable:"Lending Library",available_to_borrow:"Borrow 14 Days",is_readable:"Always Available"},Co={deemphasize:!0,community:!0,stream_only:!0,samples_only:!0,test_collection:!0,printdisabled:!0,"openlibrary-ol":!0,nationalemergencylibrary:!0,china:!0,americana:!0,toronto:!0};function Ja(a){switch(a){case"publicdate":return"Archived";case"reviewdate":return"Reviewed";case"addeddate":return"Added";default:return"Published"}}function er(a){return a?`Archivist since ${a.getFullYear()}`:""}let fe=class extends D{constructor(){super(...arguments),this.sortParam=null,this.collectionLinks=[],this.loggedIn=!1}render(){return h`
    ...
    >`}detailsLink(e,t){const i=t!=null?t:e;return h`<a
      ...
      >${jt.sanitize(i)}</a
    >`}get mediatypeURL(){var e;if(this.baseNavigationUrl===void 0||!(!((e=this.model)===null||e===void 0)&&e.mediatype))return b;switch(this.model.mediatype){case"collection":return`${this.baseNavigationUrl}/search?query=mediatype:collection&sort=-downloads`;case"account":return b;default:return`${this.baseNavigationUrl}/details/${encodeURI(this.model.mediatype)}`}}updated(e){e.has("model")&&this.fetchCollectionNames()}async fetchCollectionNames(){var e,t;if(!(!((e=this.model)===null||e===void 0)&&e.collections)||this.model.collections.length===0||!this.collectionNameCache)return;this.collectionLinks=[];const i=[],o=[];for(const r of this.model.collections)!Co[r]&&!r.startsWith("fav-")&&o.push((t=this.collectionNameCache)===null||t===void 0?void 0:t.collectionNameFor(r).then(n=>{i.push(this.detailsLink(r,n!=null?n:r))}));await Promise.all(o),this.collectionLinks=i}get date(){var e,t,i,o,r;switch((e=this.sortParam)===null||e===void 0?void 0:e.field){case"date":return(t=this.model)===null||t===void 0?void 0:t.datePublished;case"reviewdate":return(i=this.model)===null||i===void 0?void 0:i.dateReviewed;case"addeddate":return(o=this.model)===null||o===void 0?void 0:o.dateAdded;default:return(r=this.model)===null||r===void 0?void 0:r.dateArchived}}get classSize(){return this.mobileBreakpoint&&this.currentWidth&&this.currentWidth<this.mobileBreakpoint?"mobile":"desktop"}get formatSize(){return this.mobileBreakpoint&&this.currentWidth&&this.currentWidth<this.mobileBreakpoint?"short":"long"}static get styles(){return m`
      html {
        font-size: unset;
      }
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ba=Ti(class extends ki{constructor(a){if(super(a),a.type!==Ee.PROPERTY&&a.type!==Ee.ATTRIBUTE&&a.type!==Ee.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Jr(a))throw Error("`live` bindings can only contain a single expression")}render(a){return a}update(a,[e]){if(e===me||e===b)return e;const t=a.element,i=a.name;if(a.type===Ee.PROPERTY){if(e===t[i])return me}else if(a.type===Ee.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(i))return me}else if(a.type===Ee.ATTRIBUTE&&t.getAttribute(i)===e+"")return me;return Ga(a),e}}),wn=Object.freeze({processing:"processing",complete:"complete"});class xn extends D{static get properties(){return{mode:{type:String}}}constructor(){super(),this.mode=wn.processing}render(){return h`
      <div class="${this.mode}">
        <svg
          viewBox="0 0 120 120"
    ...
    `}get selectedRangeTemplate(){return F`
      ...
      />`}get histogramTemplate(){const e=this._histWidth/this._numBins,t=e-1;let i=this.sliderWidth;return this._histData.map(o=>{const r=F`
        <rect
          ...
          fill="${i+t>=this.minSliderX&&i<=this.maxSliderX?Ln:An}"
...
`;let mo=class extends D{constructor(){super(...arguments),this.config=new tr}render(){return h`
    ...
    `}static get styles(){const e=m`var(--modalLogoSize, 6.5rem)`,t=m`var(--processingImageSize, 7.5rem)`,i=m`var(--modalCornerRadius, 1rem)`,o=m`var(--modalBorder, 2px solid black)`,r=m`var(--modalBottomMargin, 2.5rem)`,n=m`var(--modalTopMargin, 5rem)`,l=m`var(--modalHeaderBottomPadding, 0.5em)`,d=m`var(--modalBottomPadding, 2rem)`,u=m`var(--modalScrollOffset, 5px)`,v=m`var(--modalTitleFontSize, 1.8rem)`,f=m`var(--modalSubtitleFontSize, 1.4rem)`,g=m`var(--modalHeadlineFontSize, 1.6rem)`,x=m`var(--modalMessageFontSize, 1.4rem)`,$=m`var(--modalTitleLineHeight, normal)`,T=m`var(--modalSubtitleLineHeight, normal)`,L=m`var(--modalHeadlineLineHeight, normal)`,Z=m`var(--modalMessageLineHeight, normal)`;return m`
      .processing-logo {
        margin: auto;
        width: ${t};
        height: ${t};
    ...
    `}};s([c({type:Object})],mo.prototype,"config",void 0);mo=s([P("modal-template")],mo);function Hn(a,e,t){var i=t||{},o=i.noTrailing,r=o===void 0?!1:o,n=i.noLeading,l=n===void 0?!1:n,d=i.debounceMode,u=d===void 0?void 0:d,v,f=!1,g=0;function x(){v&&clearTimeout(v)}function $(L){var Z=L||{},V=Z.upcomingOnly,J=V===void 0?!1:V;x(),f=!J}function T(){for(var L=arguments.length,Z=new Array(L),V=0;V<L;V++)Z[V]=arguments[V];var J=this,G=Date.now()-g;if(f)return;function ae(){g=Date.now(),e.apply(J,Z)}function ve(){v=void 0}!l&&u&&!v&&ae(),x(),u===void 0&&G>a?l?(g=Date.now(),r||(v=setTimeout(u?ve:ae,a))):ae():r!==!0&&(v=setTimeout(u?ve:ae,u===void 0?a-G:a))}return T.cancel=$,T}var it;(function(a){a.Open="open",a.Closed="closed"})(it||(it={}));class Wn{constructor(e){this.windowResizeThrottler=Hn(100,this.updateModalContainerHeight).bind(this),this.modalManager=e}handleModeChange(e){switch(e){case it.Open:this.startResizeListener(),this.stopDocumentScroll();break;case it.Closed:this.stopResizeListener(),this.resumeDocumentScroll();break}}updateModalContainerHeight(){this.modalManager.style.setProperty("--containerHeight",`${window.innerHeight}px`)}stopDocumentScroll(){document.body.classList.add("modal-manager-open")}resumeDocumentScroll(){document.body.classList.remove("modal-manager-open")}startResizeListener(){window.addEventListener("resize",this.windowResizeThrottler)}stopResizeListener(){window.removeEventListener("resize",this.windowResizeThrottler)}}let St=class extends D{constructor(){super(...arguments),this.mode=it.Closed,this.hostBridge=new Wn(this),this.closeOnBackdropClick=!0}render(){return h`
      <div class="container">
      ...
      <div class="facets-on-${this.renderOn}">
        ${qa(t,i=>`${e.key}:${i.key}`,i=>{var o,r;const n=`${e.key}:${i.key}-show-only`,l=`${e.key}:${i.key}-negative`,d=e.key!=="collection"?h`${(o=i.displayText)!==null&&o!==void 0?o:i.key}`:h`<a href="/details/${i.key}">
                    <async-collection-name
                      ...
                      placeholder="-"
                    ></async-collection-name>
                  </a> `,u=i.state==="hidden",v=i.state==="selected",f=`${e.key}: ${(r=i.displayText)!==null&&r!==void 0?r:i.key}`,g=v?`Show all ${e.key}s`:`Only show ${f}`,x=`Hide ${f}`,$=`Unhide ${f}`,T=u?$:x;return h`
              <div class="facet-row">
