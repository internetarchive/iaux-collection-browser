 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const qr=(a,e)=>e.kind==="method"&&e.descriptor&&!("value"in e.descriptor)?ft(pe({},e),{finisher(t){t.createProperty(e.key,a)}}):{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){typeof e.initializer=="function"&&(this[e.key]=e.initializer.call(this))},finisher(t){t.createProperty(e.key,a)}};function c(a){return(e,t)=>t!==void 0?((i,o,r)=>{o.constructor.createProperty(r,i)})(a,e,t):qr(a,e)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function k(a){return c(ft(pe({},a),{state:!0}))}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Va=({finisher:a,descriptor:e})=>(t,i)=>{var o;if(i===void 0){const r=(o=t.originalKey)!==null&&o!==void 0?o:t.key,n=e!=null?{kind:"method",placement:"prototype",key:r,descriptor:e(t.key)}:ft(pe({},t),{key:r});return a!=null&&(n.finisher=function(l){a(l,r)}),n}{const r=t.constructor;e!==void 0&&Object.defineProperty(t,i,e(i)),a==null||a(r,i)}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */const sa=(a,e,t)=>{const i=new Map;for(let o=e;o<=t;o++)i.set(a[o],o);return i},Qa=Ti(class extends ki{constructor(a){if(super(a),a.type!==Le.CHILD)throw Error("repeat() can only be used in text expressions")}dt(a,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);const o=[],r=[];let n=0;for(const l of a)o[n]=i?i(l,n):n,r[n]=t(l,n),n++;return{values:r,keys:o}}render(a,e,t){return this.dt(a,e,t).values}update(a,[e,t,i]){var o;const r=ts(a),{values:n,keys:l}=this.dt(e,t,i);if(!Array.isArray(r))return this.ut=l,n;const d=(o=this.ut)!==null&&o!==void 0?o:this.ut=[],u=[];let v,f,y=0,x=r.length-1,_=0,M=n.length-1;for(;y<=x&&_<=M;)if(r[y]===null)y++;else if(r[x]===null)x--;else if(d[y]===l[_])u[_]=Ze(r[y],n[_]),y++,_++;else if(d[x]===l[M])u[M]=Ze(r[x],n[M]),x--,M--;else if(d[y]===l[M])u[M]=Ze(r[y],n[M]),Nt(a,u[M+1],r[y]),y++,M--;else if(d[x]===l[_])u[_]=Ze(r[x],n[_]),Nt(a,r[y],r[x]),x--,_++;else if(v===void 0&&(v=sa(l,_,M),f=sa(d,y,x)),v.has(d[y]))if(v.has(d[x])){const P=f.get(l[_]),Z=P!==void 0?r[P]:null;if(Z===null){const R=Nt(a,r[y]);Ze(R,n[_]),u[_]=R}else u[_]=Ze(Z,n[_]),Nt(a,r[y],Z),r[P]=null;_++}else ji(r[x]),x--;else ji(r[y]),y++;for(;_<=M;){const P=Nt(a,u[M+1]);Ze(P,n[_]),u[_++]=P}for(;y<=x;){const P=r[y++];P!==null&&ji(P)}return this.ut=l,Ga(a,u),me}});function li(a,e,t){return Array.from({length:(e-a)/t+1},(i,o)=>a+o*t)}let Oe=class extends E{constructor(){super(...arguments),this.itemCount=0,this.scrollOptimizationsDisabled=!1,this.intersectionObserver=new IntersectionObserver(e=>{e.forEach(t=>{if(t.target===this.sentinel){t.isIntersecting&&this.dispatchEvent(new Event("scrollThresholdReached"));return}const o=t.target.dataset.cellIndex;if(!o)return;const r=parseInt(o,10);t.isIntersecting?this.visibleCellIndices.add(r):this.visibleCellIndices.delete(r)}),this.scrollOptimizationsDisabled||this.processVisibleCells()}),this.renderedCellIndices=new Set,this.visibleCellIndices=new Set,this.placeholderCellIndices=new Set}reload(){li(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.removeCell(t)),this.renderedCellIndices.clear(),this.visibleCellIndices.clear(),this.placeholderCellIndices.clear(),this.setupObservations()}scrollToCell(e,t){const i=this.cellContainers[e];if(!i)return!1;const o=t?"smooth":"auto";return i.scrollIntoView({behavior:o}),!0}getVisibleCellIndices(){return Array.from(this.visibleCellIndices)}updated(e){(e.has("itemCount")||e.has("scrollOptimizationsDisabled"))&&this.setupObservations()}disconnectedCallback(){this.intersectionObserver.disconnect()}setupObservations(){this.setupIntersectionObserver()}setupIntersectionObserver(){this.intersectionObserver.disconnect(),this.sentinel&&this.intersectionObserver.observe(this.sentinel),this.scrollOptimizationsDisabled?(li(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.visibleCellIndices.add(t)),this.processVisibleCells()):this.cellContainers.forEach(e=>this.intersectionObserver.observe(e))}render(){const e=this.itemCount-1,t=li(0,e,1);return h`
    ...
    `}};s([c({type:Number})],Oe.prototype,"itemCount",void 0);s([c({type:Object})],Oe.prototype,"cellProvider",void 0);s([c({type:Object})],Oe.prototype,"placeholderCellTemplate",void 0);s([c({type:Boolean})],Oe.prototype,"scrollOptimizationsDisabled",void 0);s([q("#sentinel")],Oe.prototype,"sentinel",void 0);s([Kr(".cell-container")],Oe.prototype,"cellContainers",void 0);Oe=s([A("infinite-scroller")],Oe);/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`+se),Ce&&(se=Pe(se,We," "),se=Pe(se,je," ")),K&&ai?K.createHTML(se):se},e.setConfig=function($){Ai($),qe=!0},e.clearConfig=function(){mt=null,qe=!1},e.isValidAttribute=function($,p,w){mt||Ai({});var C=Xe($),O=Xe(p);return No(C,O,w)},e.addHook=function($,p){typeof p=="function"&&(ce[$]=ce[$]||[],Ut(ce[$],p))},e.removeHook=function($){if(ce[$])return da(ce[$])},e.removeHooks=function($){ce[$]&&(ce[$]=[])},e.removeAllHooks=function(){ce={}},e}var jt=Za(),z;(function(a){a.relevance="relevance",a.alltimeview="alltimeview",a.weeklyview="weeklyview",a.title="title",a.date="date",a.datearchived="datearchived",a.datereviewed="datereviewed",a.dateadded="dateadded",a.creator="creator"})(z||(z={}));const et={relevance:"Relevance",alltimeview:"All-time views",weeklyview:"Weekly views",title:"Title",date:"Date published",datearchived:"Date archived",datereviewed:"Date reviewed",dateadded:"Date added",creator:"Creator"},va={relevance:"desc",alltimeview:"desc",weeklyview:"desc",title:"asc",date:"desc",datearchived:"desc",datereviewed:"desc",dateadded:"desc",creator:"asc"},nn={relevance:null,alltimeview:"downloads",weeklyview:"week",title:"titleSorter",date:"date",datearchived:"publicdate",datereviewed:"reviewdate",dateadded:"addeddate",creator:"creatorSorter"};z.weeklyview,z.alltimeview,z.title,z.date,z.datearchived,z.datereviewed,z.dateadded,z.creator;const ln={week:"week",downloads:"downloads",titleSorter:"title",date:"date",publicdate:"publicdate",reviewdate:"reviewdate",addeddate:"addeddate",creatorSorter:"creator"},ma={week:z.weeklyview,downloads:z.alltimeview,title:z.title,titleSorter:z.title,date:z.date,publicdate:z.datearchived,reviewdate:z.datereviewed,addeddate:z.dateadded,creator:z.creator,creatorSorter:z.creator},dn={title:"firstTitle",creator:"firstCreator"},ei=()=>({subject:{},lending:{},mediatype:{},language:{},creator:{},collection:{},year:{}}),cn=["mediatype","lending","year","subject","collection","creator","language"],Ci={subject:"Subject",lending:"Availability",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"},ho={subject:V.COUNT,lending:V.COUNT,mediatype:V.COUNT,language:V.COUNT,creator:V.COUNT,collection:V.COUNT,year:V.NUMERIC},hn={subject:V.ALPHABETICAL,lending:V.ALPHABETICAL,mediatype:V.ALPHABETICAL,language:V.ALPHABETICAL,creator:V.ALPHABETICAL,collection:V.ALPHABETICAL,year:V.NUMERIC},pn={is_lendable:!0,is_borrowable:!1,available_to_borrow:!0,is_browsable:!1,available_to_browse:!1,is_readable:!0,available_to_waitlist:!1},fa={is_lendable:"Lending Library",available_to_borrow:"Borrow 14 Days",is_readable:"Always Available"},$o={deemphasize:!0,community:!0,stream_only:!0,samples_only:!0,test_collection:!0,printdisabled:!0,"openlibrary-ol":!0,nationalemergencylibrary:!0,china:!0,americana:!0,toronto:!0};function Ja(a){switch(a){case"publicdate":return"Archived";case"reviewdate":return"Reviewed";case"addeddate":return"Added";default:return"Published"}}function er(a){return a?`Archivist since ${a.getFullYear()}`:""}let fe=class extends E{constructor(){super(...arguments),this.sortParam=null,this.collectionLinks=[],this.loggedIn=!1}render(){return h`
  ...
  `;s([c({type:String})],Ue.prototype,"selectedLetter",void 0);s([c({type:Object})],Ue.prototype,"letterCounts",void 0);s([k()],Ue.prototype,"tooltipShown",void 0);s([k()],Ue.prototype,"hoveredLetter",void 0);s([q("alpha-bar-tooltip")],Ue.prototype,"tooltip",void 0);Ue=s([A("alpha-bar")],Ue);const vn=h`
...
`;let mo=class extends E{constructor(){super(...arguments),this.config=new tr}render(){return h`
    ...
    `}};s([c({type:Object})],mo.prototype,"config",void 0);mo=s([A("modal-template")],mo);function Hn(a,e,t){var i=t||{},o=i.noTrailing,r=o===void 0?!1:o,n=i.noLeading,l=n===void 0?!1:n,d=i.debounceMode,u=d===void 0?void 0:d,v,f=!1,y=0;function x(){v&&clearTimeout(v)}function _(P){var Z=P||{},R=Z.upcomingOnly,ee=R===void 0?!1:R;x(),f=!ee}function M(){for(var P=arguments.length,Z=new Array(P),R=0;R<P;R++)Z[R]=arguments[R];var ee=this,K=Date.now()-y;if(f)return;function ue(){y=Date.now(),e.apply(ee,Z)}function ve(){v=void 0}!l&&u&&!v&&ue(),x(),u===void 0&&K>a?l?(y=Date.now(),r||(v=setTimeout(u?ve:ue,a))):ue():r!==!0&&(v=setTimeout(u?ve:ue,u===void 0?a-K:a))}return M.cancel=_,M}var it;(function(a){a.Open="open",a.Closed="closed"})(it||(it={}));class Wn{constructor(e){this.windowResizeThrottler=Hn(100,this.updateModalContainerHeight).bind(this),this.modalManager=e}handleModeChange(e){switch(e){case it.Open:this.startResizeListener(),this.stopDocumentScroll();break;case it.Closed:this.stopResizeListener(),this.resumeDocumentScroll();break}}updateModalContainerHeight(){this.modalManager.style.setProperty("--containerHeight",`${window.innerHeight}px`)}stopDocumentScroll(){document.body.classList.add("modal-manager-open")}resumeDocumentScroll(){document.body.classList.remove("modal-manager-open")}startResizeListener(){window.addEventListener("resize",this.windowResizeThrottler)}stopResizeListener(){window.removeEventListener("resize",this.windowResizeThrottler)}}let St=class extends E{constructor(){super(...arguments),this.mode=it.Closed,this.hostBridge=new Wn(this),this.closeOnBackdropClick=!0}render(){return h`
      <div class="container">
