...
`;var it;let Ae=it=class extends P{constructor(){super(...arguments),this.placeholderType=null,this.detailMessage=""}render(){return this.placeholderType?h`${this.placeholderTemplate}`:b}get placeholderTemplate(){return h`
      <div
    ...
    `}};Ae.MESSAGE_EMPTY_QUERY=k('To begin searching, enter a search term in the box above and hit "Go".');Ae.MESSAGE_NO_SEARCH_RESULTS=k("Your search did not match any items in the Archive. Try different keywords or a more general search.");Ae.MESSAGE_NO_COLLECTION_RESULTS=k("Your search did not match any items in this collection. Try different keywords or a more general search.");Ae.MESSAGE_NO_VIEWABLE_MEMBERS=k("This collection contains no viewable items.");Ae.MESSAGE_QUERY_ERROR=k(h`The search engine encountered an error, which might be related to your
      ...
      </a> `);Ae.MESSAGE_COLLECTION_ERROR=k(h`The search engine encountered an error while loading this collection.
      If the problem persists, please let us know at
      <a href="mailto:info@archive.org">info@archive.org</a>.`);Ae.QUERY_ERROR_DETAILS_MESSAGE=k("Error details:");n([c({type:String})],Ae.prototype,"placeholderType",void 0);n([c({type:Boolean})],Ae.prototype,"isMobileView",void 0);n([c({type:Boolean})],Ae.prototype,"isCollection",void 0);n([c({type:String})],Ae.prototype,"detailMessage",void 0);Ae=it=n([R("empty-placeholder")],Ae);/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Pe=r=>r??ee,Bn=N`
...
`+Te),Gt&&ho([Ze,Je,K],tt=>{Te=Ai(Te,tt," ")}),O&&io?O.createHTML(Te):Te},e.setConfig=function(){let z=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};ir(z),Ko=!0},e.clearConfig=function(){Zt=null,Ko=!1},e.isValidAttribute=function(z,g,$){Zt||ir({});const L=fe(z),J=fe(g);return qs(L,J,$)},e.addHook=function(z,g){typeof g=="function"&&Mi(Q[z],g)},e.removeHook=function(z,g){if(g!==void 0){const $=bc(Q[z],g);return $===-1?void 0:yc(Q[z],$,1)[0]}return Aa(Q[z])},e.removeHooks=function(z){Q[z]=[]},e.removeAllHooks=function(){Q=Ra()},e}var yo=Wn();let Bo=class extends de{constructor(){super(...arguments),this.collectionLinks=[]}render(){return h`
    ...
    `}};De.HOVER_PANE_DISPLAY_MODES={grid:!0,"list-compact":!0,"list-detail":!1,"list-header":!1};n([c({type:String})],De.prototype,"tileDisplayMode",void 0);n([c({type:Boolean})],De.prototype,"isManageView",void 0);n([c({type:Object})],De.prototype,"resizeObserver",void 0);n([c({type:Object})],De.prototype,"collectionTitles",void 0);n([c({type:Boolean})],De.prototype,"showTvClips",void 0);n([c({type:String})],De.prototype,"simpleLayoutType",void 0);n([c({type:Boolean})],De.prototype,"enableHoverPane",void 0);n([c({type:String})],De.prototype,"manageCheckTitle",void 0);n([H("#container")],De.prototype,"container",void 0);n([H("tile-hover-pane")],De.prototype,"hoverPane",void 0);De=os=n([R("tile-dispatcher")],De);let Ua=class extends P{render(){return h` <div id="container"></div> `}static get styles(){return f`
      :host {
        display: block;
        height: 100%;
      }
...
fill=""></path>
    ...
    `}};n([c({type:Boolean,reflect:!0})],pe.prototype,"open",void 0);n([c({type:Boolean,reflect:!0})],pe.prototype,"isDisabled",void 0);n([c({type:Boolean})],pe.prototype,"displayCaret",void 0);n([c({type:Boolean})],pe.prototype,"closeOnSelect",void 0);n([c({type:Boolean})],pe.prototype,"openViaButton",void 0);n([c({type:Boolean})],pe.prototype,"usePopover",void 0);n([c({type:Boolean})],pe.prototype,"includeSelectedOption",void 0);n([c({type:String})],pe.prototype,"selectedOption",void 0);n([c({attribute:!1})],pe.prototype,"options",void 0);n([c({type:String})],pe.prototype,"optionGroup",void 0);n([c({attribute:!1})],pe.prototype,"optionSelected",void 0);n([c({type:Boolean,reflect:!0})],pe.prototype,"isCustomList",void 0);n([c({type:Boolean,reflect:!0})],pe.prototype,"hasCustomClickHandler",void 0);n([c({type:Boolean,reflect:!0})],pe.prototype,"closeOnEscape",void 0);n([c({type:Boolean,reflect:!0})],pe.prototype,"closeOnBackdropClick",void 0);n([H(".ia-dropdown-group")],pe.prototype,"container",void 0);n([H("#dropdown-main")],pe.prototype,"dropdownMenu",void 0);pe=n([R("ia-dropdown")],pe);let rs=class extends P{render(){return h`
