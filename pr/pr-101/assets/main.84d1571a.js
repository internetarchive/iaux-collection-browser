const fo=function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))i(a);new MutationObserver(a=>{for(const o of a)if(o.type==="childList")for(const s of o.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function t(a){const o={};return a.integrity&&(o.integrity=a.integrity),a.referrerpolicy&&(o.referrerPolicy=a.referrerpolicy),a.crossorigin==="use-credentials"?o.credentials="include":a.crossorigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(a){if(a.ep)return;a.ep=!0;const o=t(a);fetch(a.href,o)}};fo();function n(r,e,t,i){var a=arguments.length,o=a<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(r,e,t,i);else for(var l=r.length-1;l>=0;l--)(s=r[l])&&(o=(a<3?s(o):a>3?s(e,t,o):s(e,t))||o);return a>3&&o&&Object.defineProperty(e,t,o),o}function x(r){let e,t,i;return typeof r=="object"?(e=r.hashFunction,t=r.expiring,i=r.tags):e=r,(a,o,s)=>{if(s.value!=null)s.value=Wa(s.value,e,t,i);else if(s.get!=null)s.get=Wa(s.get,e,t,i);else throw"Only put a Memoize() decorator on a method or get accessor."}}const Ni=new Map;function Wa(r,e,t=0,i){const a=Symbol("__memoized_map__");return function(...o){let s;this.hasOwnProperty(a)||Object.defineProperty(this,a,{configurable:!1,enumerable:!1,writable:!1,value:new Map});let l=this[a];if(Array.isArray(i))for(const c of i)Ni.has(c)?Ni.get(c).push(l):Ni.set(c,[l]);if(e||o.length>0||t>0){let c;e===!0?c=o.map(v=>v.toString()).join("!"):e?c=e.apply(this,o):c=o[0];const h=`${c}__timestamp`;let m=!1;if(t>0)if(!l.has(h))m=!0;else{let v=l.get(h);m=Date.now()-v>t}l.has(c)&&!m?s=l.get(c):(s=r.apply(this,o),l.set(c,s),t>0&&l.set(h,Date.now()))}else{const c=this;l.has(c)?s=l.get(c):(s=r.apply(this,o),l.set(c,s))}return s}}class aa{parseValue(e){return typeof e=="string"&&(e==="false"||e==="0")?!1:Boolean(e)}}aa.shared=new aa;class Oe{parseValue(e){if(typeof e=="number")return e;if(typeof e=="boolean")return;const t=parseFloat(e);if(!Number.isNaN(t))return t}}Oe.shared=new Oe;class li{parseValue(e){return Oe.shared.parseValue(e)}}li.shared=new li;class Bt{parseValue(e){return this.parseJSDate(e)||this.parseBracketDate(e)}parseBracketDate(e){if(typeof e!="string")return;const t=e.match(/\[([0-9]{4})\]/);if(!(!t||t.length<2))return this.parseJSDate(t[1])}parseJSDate(e){if(typeof e!="string")return;let t=e;t.match(/^[0-9]{4}-[0-9]{2}-[0-9]{2}\s{1}[0-9]{2}:[0-9]{2}:[0-9]{2}$/)&&(t=t.replace(" ","T"));const i=Date.parse(t);if(Number.isNaN(i))return;let a=new Date(t);return(t.indexOf("Z")>-1||t.indexOf("+")>-1||t.match(/^[0-9]{4}$/)||t.match(/^[0-9]{4}-[0-9]{2}-[0-9]{2}$/)||t.match(/^.*?-[0-9]{2}:[0-9]{2}$/)||t.match(/^.*?-[0-9]{4}$/))&&(a=new Date(a.getTime()+a.getTimezoneOffset()*1e3*60)),a}}Bt.shared=new Bt;class ci{parseValue(e){if(typeof e=="number")return e;if(typeof e=="boolean")return;const t=e.split(":");let i;return t.length===1?i=this.parseNumberFormat(t[0]):i=this.parseColonSeparatedFormat(t),i}parseNumberFormat(e){let t=parseFloat(e);return Number.isNaN(t)&&(t=void 0),t}parseColonSeparatedFormat(e){let t=!1;const i=e.map((a,o)=>{const s=parseFloat(a);if(Number.isNaN(s))return t=!0,0;const l=e.length-1-o,c=60**l;return s*Math.floor(c)}).reduce((a,o)=>a+o,0);return t?void 0:i}}ci.shared=new ci;class ra{parseValue(e){if(typeof e=="string")return e}}ra.shared=new ra;class go{constructor(e,t){this.separators=[";",","],this.parser=e,t&&t.separators&&(this.separators=t.separators)}parseValue(e){const t=String(e);let i=[];for(const a of this.separators)if(i=t.split(a),i.length>1)break;return this.parseListValues(i)}parseListValues(e){const i=e.map(o=>o.trim()).map(o=>this.parser.parseValue(o)),a=[];return i.forEach(o=>{o!==void 0&&a.push(o)}),a}}class oa{parseValue(e){if(typeof e=="string")return e}}oa.shared=new oa;class di{parseValue(e){return String(e)}}di.shared=new di;class fe{constructor(e,t){this.parser=e,this.rawValue=t}get values(){return this.parseRawValue()}get value(){return this.values[0]}parseRawValue(){if(this.rawValue===void 0)return[];const e=Array.isArray(this.rawValue)?this.rawValue:[this.rawValue],t=[];return e.forEach(i=>{const a=this.parser.parseValue(i);Array.isArray(a)?t.push(...a):a!==void 0&&t.push(a)}),t}}n([x()],fe.prototype,"values",null);n([x()],fe.prototype,"value",null);class yo extends fe{constructor(e){super(aa.shared,e)}}class _e extends fe{constructor(e){super(Bt.shared,e)}}class Bi extends fe{constructor(e){super(ci.shared,e)}}class de extends fe{constructor(e){super(Oe.shared,e)}}class N extends fe{constructor(e){super(di.shared,e)}}class bo extends fe{constructor(e){super(oa.shared,e)}}class ja extends fe{constructor(e){super(li.shared,e)}}class wo extends fe{constructor(e){super(ra.shared,e)}}class xo extends fe{constructor(e,t){super(t,e)}}class So extends xo{constructor(e){const t=new go(di.shared);super(e,t)}}class _{constructor(e){this.rawMetadata=e}get identifier(){var e;return(e=this.rawMetadata)===null||e===void 0?void 0:e.identifier}get addeddate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.addeddate?new _e(this.rawMetadata.addeddate):void 0}get audio_codec(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.audio_codec?new N(this.rawMetadata.audio_codec):void 0}get audio_sample_rate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.audio_sample_rate?new de(this.rawMetadata.audio_sample_rate):void 0}get avg_rating(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.avg_rating?new de(this.rawMetadata.avg_rating):void 0}get collection(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.collection?new N(this.rawMetadata.collection):void 0}get collections_raw(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.collections_raw?new N(this.rawMetadata.collections_raw):void 0}get collection_size(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.collection_size?new ja(this.rawMetadata.collection_size):void 0}get contributor(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.contributor?new N(this.rawMetadata.contributor):void 0}get coverage(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.coverage?new N(this.rawMetadata.coverage):void 0}get creator(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.creator?new N(this.rawMetadata.creator):void 0}get date(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.date?new _e(this.rawMetadata.date):void 0}get description(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.description?new N(this.rawMetadata.description):void 0}get downloads(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.downloads?new de(this.rawMetadata.downloads):void 0}get duration(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.duration?new Bi(this.rawMetadata.duration):void 0}get"external-identifier"(){var e,t;return!((e=this.rawMetadata)===null||e===void 0)&&e["external-identifier"]?new N((t=this.rawMetadata)===null||t===void 0?void 0:t["external-identifier"]):void 0}get files_count(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.files_count?new de(this.rawMetadata.files_count):void 0}get indexdate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.indexdate?new _e(this.rawMetadata.indexdate):void 0}get isbn(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.isbn?new N(this.rawMetadata.isbn):void 0}get issue(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.issue?new N(this.rawMetadata.issue):void 0}get item_count(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.item_count?new de(this.rawMetadata.item_count):void 0}get item_size(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.item_size?new ja(this.rawMetadata.item_size):void 0}get language(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.language?new N(this.rawMetadata.language):void 0}get length(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.length?new Bi(this.rawMetadata.length):void 0}get lineage(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.lineage?new N(this.rawMetadata.lineage):void 0}get month(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.month?new de(this.rawMetadata.month):void 0}get mediatype(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.mediatype?new wo(this.rawMetadata.mediatype):void 0}get noindex(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.noindex?new yo(this.rawMetadata.noindex):void 0}get notes(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.notes?new N(this.rawMetadata.notes):void 0}get num_favorites(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.num_favorites?new de(this.rawMetadata.num_favorites):void 0}get num_reviews(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.num_reviews?new de(this.rawMetadata.num_reviews):void 0}get openlibrary_edition(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.openlibrary_edition?new N(this.rawMetadata.openlibrary_edition):void 0}get openlibrary_work(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.openlibrary_work?new N(this.rawMetadata.openlibrary_work):void 0}get page_progression(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.page_progression?new bo(this.rawMetadata.page_progression):void 0}get partner(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.partner?new N(this.rawMetadata.partner):void 0}get ppi(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.ppi?new de(this.rawMetadata.ppi):void 0}get publicdate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.publicdate?new _e(this.rawMetadata.publicdate):void 0}get publisher(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.publisher?new N(this.rawMetadata.publisher):void 0}get reviewdate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.reviewdate?new _e(this.rawMetadata.reviewdate):void 0}get runtime(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.runtime?new Bi(this.rawMetadata.runtime):void 0}get scanner(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.scanner?new N(this.rawMetadata.scanner):void 0}get snippets(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.snippets?new N(this.rawMetadata.snippets):void 0}get source(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.source?new N(this.rawMetadata.source):void 0}get start_localtime(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.start_localtime?new _e(this.rawMetadata.start_localtime):void 0}get start_time(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.start_time?new _e(this.rawMetadata.start_time):void 0}get stop_time(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.stop_time?new _e(this.rawMetadata.stop_time):void 0}get subject(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.subject?new So(this.rawMetadata.subject):void 0}get taper(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.taper?new N(this.rawMetadata.taper):void 0}get title(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.title?new N(this.rawMetadata.title):void 0}get transferer(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.transferer?new N(this.rawMetadata.transferer):void 0}get track(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.track?new de(this.rawMetadata.track):void 0}get type(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.type?new N(this.rawMetadata.type):void 0}get uploader(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.uploader?new N(this.rawMetadata.uploader):void 0}get utc_offset(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.utc_offset?new de(this.rawMetadata.utc_offset):void 0}get venue(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.venue?new N(this.rawMetadata.venue):void 0}get volume(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.volume?new N(this.rawMetadata.volume):void 0}get week(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.week?new de(this.rawMetadata.week):void 0}get year(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.year?new _e(this.rawMetadata.year):void 0}}n([x()],_.prototype,"addeddate",null);n([x()],_.prototype,"audio_codec",null);n([x()],_.prototype,"audio_sample_rate",null);n([x()],_.prototype,"avg_rating",null);n([x()],_.prototype,"collection",null);n([x()],_.prototype,"collections_raw",null);n([x()],_.prototype,"collection_size",null);n([x()],_.prototype,"contributor",null);n([x()],_.prototype,"coverage",null);n([x()],_.prototype,"creator",null);n([x()],_.prototype,"date",null);n([x()],_.prototype,"description",null);n([x()],_.prototype,"downloads",null);n([x()],_.prototype,"duration",null);n([x()],_.prototype,"external-identifier",null);n([x()],_.prototype,"files_count",null);n([x()],_.prototype,"indexdate",null);n([x()],_.prototype,"isbn",null);n([x()],_.prototype,"issue",null);n([x()],_.prototype,"item_count",null);n([x()],_.prototype,"item_size",null);n([x()],_.prototype,"language",null);n([x()],_.prototype,"length",null);n([x()],_.prototype,"lineage",null);n([x()],_.prototype,"month",null);n([x()],_.prototype,"mediatype",null);n([x()],_.prototype,"noindex",null);n([x()],_.prototype,"notes",null);n([x()],_.prototype,"num_favorites",null);n([x()],_.prototype,"num_reviews",null);n([x()],_.prototype,"openlibrary_edition",null);n([x()],_.prototype,"openlibrary_work",null);n([x()],_.prototype,"page_progression",null);n([x()],_.prototype,"partner",null);n([x()],_.prototype,"ppi",null);n([x()],_.prototype,"publicdate",null);n([x()],_.prototype,"publisher",null);n([x()],_.prototype,"reviewdate",null);n([x()],_.prototype,"runtime",null);n([x()],_.prototype,"scanner",null);n([x()],_.prototype,"snippets",null);n([x()],_.prototype,"source",null);n([x()],_.prototype,"start_localtime",null);n([x()],_.prototype,"start_time",null);n([x()],_.prototype,"stop_time",null);n([x()],_.prototype,"subject",null);n([x()],_.prototype,"taper",null);n([x()],_.prototype,"title",null);n([x()],_.prototype,"transferer",null);n([x()],_.prototype,"track",null);n([x()],_.prototype,"type",null);n([x()],_.prototype,"uploader",null);n([x()],_.prototype,"utc_offset",null);n([x()],_.prototype,"venue",null);n([x()],_.prototype,"volume",null);n([x()],_.prototype,"week",null);n([x()],_.prototype,"year",null);class wt{constructor(e){this.rawValue=e}get name(){return this.rawValue.name}get source(){return this.rawValue.source}get btih(){return this.rawValue.btih}get md5(){return this.rawValue.md5}get format(){return this.rawValue.format}get mtime(){return this.rawValue.mtime}get crc32(){return this.rawValue.crc32}get sha1(){return this.rawValue.sha1}get original(){return this.rawValue.original}get size(){return this.rawValue.size?li.shared.parseValue(this.rawValue.size):void 0}get title(){return this.rawValue.title}get length(){return this.rawValue.length?ci.shared.parseValue(this.rawValue.length):void 0}get height(){return this.rawValue.height?Oe.shared.parseValue(this.rawValue.height):void 0}get width(){return this.rawValue.width?Oe.shared.parseValue(this.rawValue.width):void 0}get track(){return this.rawValue.track?Oe.shared.parseValue(this.rawValue.track):void 0}get external_identifier(){return this.rawValue.external_identifier}get creator(){return this.rawValue.creator}get album(){return this.rawValue.album}}n([x()],wt.prototype,"size",null);n([x()],wt.prototype,"length",null);n([x()],wt.prototype,"height",null);n([x()],wt.prototype,"width",null);n([x()],wt.prototype,"track",null);class $i{constructor(e){this.rawValue=e}get reviewbody(){return this.rawValue.reviewbody}get reviewtitle(){return this.rawValue.reviewtitle}get reviewer(){return this.rawValue.reviewer}get reviewdate(){return this.rawValue.reviewdate?Bt.shared.parseValue(this.rawValue.reviewdate):void 0}get createdate(){return this.rawValue.createdate?Bt.shared.parseValue(this.rawValue.createdate):void 0}get stars(){return this.rawValue.stars?Oe.shared.parseValue(this.rawValue.stars):void 0}}n([x()],$i.prototype,"reviewdate",null);n([x()],$i.prototype,"createdate",null);n([x()],$i.prototype,"stars",null);class $o{constructor(e){var t,i;this.rawResponse=e,this.created=e.created,this.d1=e.d1,this.d2=e.d2,this.dir=e.dir,this.files=(t=e.files)===null||t===void 0?void 0:t.map(a=>new wt(a)),this.files_count=e.files_count,this.item_last_updated=e.item_last_updated,this.item_size=e.item_size,this.metadata=new _(e.metadata),this.server=e.server,this.uniq=e.uniq,this.workable_servers=e.workable_servers,this.speech_vs_music_asr=e.speech_vs_music_asr,this.reviews=(i=e.reviews)===null||i===void 0?void 0:i.map(a=>new $i(a))}}class _o{constructor(e){this.numFound=e.numFound,this.start=e.start,this.docs=e.docs.map(t=>new _(t)),this.aggregations=e.aggregations}}class Co{constructor(e){this.rawResponse=e,this.responseHeader=e.responseHeader,this.response=new _o(e.response)}}var Ge;(function(r){r.networkError="SearchService.NetworkError",r.itemNotFound="SearchService.ItemNotFound",r.decodingError="SearchService.DecodingError",r.searchEngineError="SearchService.SearchEngineError"})(Ge||(Ge={}));class sa extends Error{constructor(e,t,i){super(t),this.name=e,this.type=e,this.details=i}}class zo{static aggregateSearchParamsAsString(e){if(e.advancedParams){const t=e.advancedParams.map(a=>({terms:a}));return JSON.stringify(t)}if(e.simpleParams)return e.simpleParams.join(",")}static sortParamsAsString(e){return`${e.field} ${e.direction}`}static generateURLSearchParams(e){const t=new URLSearchParams;if(t.append("q",e.query),t.append("output","json"),e.rows&&t.append("rows",String(e.rows)),e.page&&t.append("page",String(e.page)),e.fields&&t.append("fl",e.fields.join(",")),e.sort){const a=e.sort.map(o=>this.sortParamsAsString(o));t.append("sort",a.join(","))}const i=e.aggregations;if(i){const a=this.aggregateSearchParamsAsString(i);a&&t.append("user_aggs",a)}return t}}class ko{constructor(e){var t;if(this.baseUrl=(t=e==null?void 0:e.baseUrl)!==null&&t!==void 0?t:"archive.org",(e==null?void 0:e.includeCredentials)!==void 0?this.includeCredentials=e.includeCredentials:this.includeCredentials=window.location.href.match(/^https?:\/\/.*archive\.org(:[0-9]+)?/)!==null,(e==null?void 0:e.scope)!==void 0)this.requestScope=e.scope;else{const a=new URL(window.location.href).searchParams.get("scope");a&&(this.requestScope=a)}}async performSearch(e){const i=zo.generateURLSearchParams(e).toString(),a=`https://${this.baseUrl}/advancedsearch.php?${i}`;return this.fetchUrl(a)}async fetchMetadata(e,t){const i=t?`/${t}`:"",a=`https://${this.baseUrl}/metadata/${e}${i}`;return this.fetchUrl(a,{requestOptions:{credentials:"omit"}})}async fetchUrl(e,t){var i;const a=new URL(e);this.requestScope&&a.searchParams.set("scope",this.requestScope);let o;try{const s=(i=t==null?void 0:t.requestOptions)!==null&&i!==void 0?i:{credentials:this.includeCredentials?"include":"same-origin"};o=await fetch(a.href,s)}catch(s){const l=s instanceof Error?s.message:typeof s=="string"?s:"Unknown error";return this.getErrorResult(Ge.networkError,l)}try{const s=await o.json(),l=s.error;if(l){const c=s.forensics;return this.getErrorResult(Ge.searchEngineError,l,c)}else return{success:s}}catch(s){const l=s instanceof Error?s.message:typeof s=="string"?s:"Unknown error";return this.getErrorResult(Ge.decodingError,l)}}getErrorResult(e,t,i){return{error:new sa(e,t,i)}}}class ct{constructor(e){this.searchBackend=e}async search(e){const t=await this.searchBackend.performSearch(e);return t.error?t:{success:new Co(t.success)}}async fetchMetadata(e){var t;const i=await this.searchBackend.fetchMetadata(e);return i.error?i:((t=i.success)===null||t===void 0?void 0:t.metadata)===void 0?{error:new sa(Ge.itemNotFound)}:{success:new $o(i.success)}}async fetchMetadataValue(e,t){var i;const a=await this.searchBackend.fetchMetadata(e,t);return a.error?a:((i=a.success)===null||i===void 0?void 0:i.result)===void 0?{error:new sa(Ge.itemNotFound)}:{success:a.success.result}}}ct.default=new ct(new ko);function xt(r){return new Promise((e,t)=>{r.oncomplete=r.onsuccess=()=>e(r.result),r.onabort=r.onerror=()=>t(r.error)})}function To(r,e){const t=indexedDB.open(r);t.onupgradeneeded=()=>t.result.createObjectStore(e);const i=xt(t);return(a,o)=>i.then(s=>o(s.transaction(e,a).objectStore(e)))}let Hi;function _i(){return Hi||(Hi=To("keyval-store","keyval")),Hi}function Ao(r,e=_i()){return e("readonly",t=>xt(t.get(r)))}function Mo(r,e,t=_i()){return t("readwrite",i=>(i.put(e,r),xt(i.transaction)))}function Eo(r,e=_i()){return e("readwrite",t=>(t.delete(r),xt(t.transaction)))}function Do(r,e){return r.openCursor().onsuccess=function(){!this.result||(e(this.result),this.result.continue())},xt(r.transaction)}function Oo(r=_i()){return r("readonly",e=>{if(e.getAllKeys)return xt(e.getAllKeys());const t=[];return Do(e,i=>t.push(i.key)).then(()=>t)})}function Lo(r,e){return r.setMilliseconds(r.getMilliseconds()+e*1e3),r}class Io{constructor(e){var t,i,a,o;if(this.namespace=(t=e==null?void 0:e.namespace)!==null&&t!==void 0?t:"LocalCache",this.defaultTTL=(i=e==null?void 0:e.defaultTTL)!==null&&i!==void 0?i:15*60,(!((a=e==null?void 0:e.immediateClean)!==null&&a!==void 0)||a)&&this.cleanExpired(),!(e!=null&&e.disableCleaning)){const s=(o=e==null?void 0:e.cleaningInterval)!==null&&o!==void 0?o:60;setInterval(()=>{this.cleanExpired()},s*1e3)}}async set(e){var t;const i={value:e.value},a=(t=e.ttl)!==null&&t!==void 0?t:this.defaultTTL,o=Lo(new Date,a);i.expires=o;const s=this.getNamespacedKey(e.key);try{await Mo(s,i)}catch{}}async get(e){const t=this.getNamespacedKey(e);let i;try{i=await Ao(t)}catch{}if(!i)return;const a=new Date;if(i.expires&&i.expires<a){await this.delete(e);return}return i.value}async delete(e){const t=this.getNamespacedKey(e);try{await Eo(t)}catch{}}async cleanExpired(){const e=await this.getAllKeys();await Promise.all(e.map(async t=>this.get(t)))}async getAllKeys(){let e=[];try{e=await Oo()}catch{}const t=[];for(const o of e)typeof o=="string"&&t.push(o);return t.filter(o=>o.startsWith(this.namespace)).map(o=>this.removeNamespace(o))}getNamespacedKey(e){return`${this.namespace}-${e}`}removeNamespace(e){return e.replace(`${this.namespace}-`,"")}}/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ii=window,ga=ii.ShadowRoot&&(ii.ShadyCSS===void 0||ii.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,ya=Symbol(),Qa=new WeakMap;class Er{constructor(e,t,i){if(this._$cssResult$=!0,i!==ya)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o;const t=this.t;if(ga&&e===void 0){const i=t!==void 0&&t.length===1;i&&(e=Qa.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),i&&Qa.set(t,e))}return e}toString(){return this.cssText}}const Ro=r=>new Er(typeof r=="string"?r:r+"",void 0,ya),y=(r,...e)=>{const t=r.length===1?r[0]:e.reduce((i,a,o)=>i+(s=>{if(s._$cssResult$===!0)return s.cssText;if(typeof s=="number")return s;throw Error("Value passed to 'css' function must be a 'css' function result: "+s+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(a)+r[o+1],r[0]);return new Er(t,r,ya)},Po=(r,e)=>{ga?r.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet):e.forEach(t=>{const i=document.createElement("style"),a=ii.litNonce;a!==void 0&&i.setAttribute("nonce",a),i.textContent=t.cssText,r.appendChild(i)})},Ga=ga?r=>r:r=>r instanceof CSSStyleSheet?(e=>{let t="";for(const i of e.cssRules)t+=i.cssText;return Ro(t)})(r):r;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Ui;const hi=window,Ya=hi.trustedTypes,Fo=Ya?Ya.emptyScript:"",Ka=hi.reactiveElementPolyfillSupport,na={toAttribute(r,e){switch(e){case Boolean:r=r?Fo:null;break;case Object:case Array:r=r==null?r:JSON.stringify(r)}return r},fromAttribute(r,e){let t=r;switch(e){case Boolean:t=r!==null;break;case Number:t=r===null?null:Number(r);break;case Object:case Array:try{t=JSON.parse(r)}catch{t=null}}return t}},Dr=(r,e)=>e!==r&&(e==e||r==r),Vi={attribute:!0,type:String,converter:na,reflect:!1,hasChanged:Dr};class lt extends HTMLElement{constructor(){super(),this._$Ei=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$El=null,this.u()}static addInitializer(e){var t;(t=this.h)!==null&&t!==void 0||(this.h=[]),this.h.push(e)}static get observedAttributes(){this.finalize();const e=[];return this.elementProperties.forEach((t,i)=>{const a=this._$Ep(i,t);a!==void 0&&(this._$Ev.set(a,i),e.push(a))}),e}static createProperty(e,t=Vi){if(t.state&&(t.attribute=!1),this.finalize(),this.elementProperties.set(e,t),!t.noAccessor&&!this.prototype.hasOwnProperty(e)){const i=typeof e=="symbol"?Symbol():"__"+e,a=this.getPropertyDescriptor(e,i,t);a!==void 0&&Object.defineProperty(this.prototype,e,a)}}static getPropertyDescriptor(e,t,i){return{get(){return this[t]},set(a){const o=this[e];this[t]=a,this.requestUpdate(e,o,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)||Vi}static finalize(){if(this.hasOwnProperty("finalized"))return!1;this.finalized=!0;const e=Object.getPrototypeOf(this);if(e.finalize(),this.elementProperties=new Map(e.elementProperties),this._$Ev=new Map,this.hasOwnProperty("properties")){const t=this.properties,i=[...Object.getOwnPropertyNames(t),...Object.getOwnPropertySymbols(t)];for(const a of i)this.createProperty(a,t[a])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const i=new Set(e.flat(1/0).reverse());for(const a of i)t.unshift(Ga(a))}else e!==void 0&&t.push(Ga(e));return t}static _$Ep(e,t){const i=t.attribute;return i===!1?void 0:typeof i=="string"?i:typeof e=="string"?e.toLowerCase():void 0}u(){var e;this._$E_=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$Eg(),this.requestUpdate(),(e=this.constructor.h)===null||e===void 0||e.forEach(t=>t(this))}addController(e){var t,i;((t=this._$ES)!==null&&t!==void 0?t:this._$ES=[]).push(e),this.renderRoot!==void 0&&this.isConnected&&((i=e.hostConnected)===null||i===void 0||i.call(e))}removeController(e){var t;(t=this._$ES)===null||t===void 0||t.splice(this._$ES.indexOf(e)>>>0,1)}_$Eg(){this.constructor.elementProperties.forEach((e,t)=>{this.hasOwnProperty(t)&&(this._$Ei.set(t,this[t]),delete this[t])})}createRenderRoot(){var e;const t=(e=this.shadowRoot)!==null&&e!==void 0?e:this.attachShadow(this.constructor.shadowRootOptions);return Po(t,this.constructor.elementStyles),t}connectedCallback(){var e;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$ES)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostConnected)===null||i===void 0?void 0:i.call(t)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$ES)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostDisconnected)===null||i===void 0?void 0:i.call(t)})}attributeChangedCallback(e,t,i){this._$AK(e,i)}_$EO(e,t,i=Vi){var a;const o=this.constructor._$Ep(e,i);if(o!==void 0&&i.reflect===!0){const s=(((a=i.converter)===null||a===void 0?void 0:a.toAttribute)!==void 0?i.converter:na).toAttribute(t,i.type);this._$El=e,s==null?this.removeAttribute(o):this.setAttribute(o,s),this._$El=null}}_$AK(e,t){var i;const a=this.constructor,o=a._$Ev.get(e);if(o!==void 0&&this._$El!==o){const s=a.getPropertyOptions(o),l=typeof s.converter=="function"?{fromAttribute:s.converter}:((i=s.converter)===null||i===void 0?void 0:i.fromAttribute)!==void 0?s.converter:na;this._$El=o,this[o]=l.fromAttribute(t,s.type),this._$El=null}}requestUpdate(e,t,i){let a=!0;e!==void 0&&(((i=i||this.constructor.getPropertyOptions(e)).hasChanged||Dr)(this[e],t)?(this._$AL.has(e)||this._$AL.set(e,t),i.reflect===!0&&this._$El!==e&&(this._$EC===void 0&&(this._$EC=new Map),this._$EC.set(e,i))):a=!1),!this.isUpdatePending&&a&&(this._$E_=this._$Ej())}async _$Ej(){this.isUpdatePending=!0;try{await this._$E_}catch(t){Promise.reject(t)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var e;if(!this.isUpdatePending)return;this.hasUpdated,this._$Ei&&(this._$Ei.forEach((a,o)=>this[o]=a),this._$Ei=void 0);let t=!1;const i=this._$AL;try{t=this.shouldUpdate(i),t?(this.willUpdate(i),(e=this._$ES)===null||e===void 0||e.forEach(a=>{var o;return(o=a.hostUpdate)===null||o===void 0?void 0:o.call(a)}),this.update(i)):this._$Ek()}catch(a){throw t=!1,this._$Ek(),a}t&&this._$AE(i)}willUpdate(e){}_$AE(e){var t;(t=this._$ES)===null||t===void 0||t.forEach(i=>{var a;return(a=i.hostUpdated)===null||a===void 0?void 0:a.call(i)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$Ek(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$E_}shouldUpdate(e){return!0}update(e){this._$EC!==void 0&&(this._$EC.forEach((t,i)=>this._$EO(i,this[i],t)),this._$EC=void 0),this._$Ek()}updated(e){}firstUpdated(e){}}lt.finalized=!0,lt.elementProperties=new Map,lt.elementStyles=[],lt.shadowRootOptions={mode:"open"},Ka==null||Ka({ReactiveElement:lt}),((Ui=hi.reactiveElementVersions)!==null&&Ui!==void 0?Ui:hi.reactiveElementVersions=[]).push("1.4.1");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Wi;const pi=window,vt=pi.trustedTypes,qa=vt?vt.createPolicy("lit-html",{createHTML:r=>r}):void 0,Ce=`lit$${(Math.random()+"").slice(9)}$`,ba="?"+Ce,No=`<${ba}>`,ft=document,Ht=(r="")=>ft.createComment(r),Ut=r=>r===null||typeof r!="object"&&typeof r!="function",Or=Array.isArray,Lr=r=>Or(r)||typeof(r==null?void 0:r[Symbol.iterator])=="function",Ot=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Xa=/-->/g,Za=/>/g,Ue=RegExp(`>|[ 	
\f\r](?:([^\\s"'>=/]+)([ 	
\f\r]*=[ 	
\f\r]*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Ja=/'/g,er=/"/g,Ir=/^(?:script|style|textarea|title)$/i,Rr=r=>(e,...t)=>({_$litType$:r,strings:e,values:t}),u=Rr(1),O=Rr(2),he=Symbol.for("lit-noChange"),$=Symbol.for("lit-nothing"),tr=new WeakMap,ai=(r,e,t)=>{var i,a;const o=(i=t==null?void 0:t.renderBefore)!==null&&i!==void 0?i:e;let s=o._$litPart$;if(s===void 0){const l=(a=t==null?void 0:t.renderBefore)!==null&&a!==void 0?a:null;o._$litPart$=s=new St(e.insertBefore(Ht(),l),l,void 0,t!=null?t:{})}return s._$AI(r),s},mt=ft.createTreeWalker(ft,129,null,!1),Pr=(r,e)=>{const t=r.length-1,i=[];let a,o=e===2?"<svg>":"",s=Ot;for(let c=0;c<t;c++){const h=r[c];let m,v,g=-1,b=0;for(;b<h.length&&(s.lastIndex=b,v=s.exec(h),v!==null);)b=s.lastIndex,s===Ot?v[1]==="!--"?s=Xa:v[1]!==void 0?s=Za:v[2]!==void 0?(Ir.test(v[2])&&(a=RegExp("</"+v[2],"g")),s=Ue):v[3]!==void 0&&(s=Ue):s===Ue?v[0]===">"?(s=a!=null?a:Ot,g=-1):v[1]===void 0?g=-2:(g=s.lastIndex-v[2].length,m=v[1],s=v[3]===void 0?Ue:v[3]==='"'?er:Ja):s===er||s===Ja?s=Ue:s===Xa||s===Za?s=Ot:(s=Ue,a=void 0);const S=s===Ue&&r[c+1].startsWith("/>")?" ":"";o+=s===Ot?h+No:g>=0?(i.push(m),h.slice(0,g)+"$lit$"+h.slice(g)+Ce+S):h+Ce+(g===-2?(i.push(void 0),c):S)}const l=o+(r[t]||"<?>")+(e===2?"</svg>":"");if(!Array.isArray(r)||!r.hasOwnProperty("raw"))throw Error("invalid template strings array");return[qa!==void 0?qa.createHTML(l):l,i]};class Vt{constructor({strings:e,_$litType$:t},i){let a;this.parts=[];let o=0,s=0;const l=e.length-1,c=this.parts,[h,m]=Pr(e,t);if(this.el=Vt.createElement(h,i),mt.currentNode=this.el.content,t===2){const v=this.el.content,g=v.firstChild;g.remove(),v.append(...g.childNodes)}for(;(a=mt.nextNode())!==null&&c.length<l;){if(a.nodeType===1){if(a.hasAttributes()){const v=[];for(const g of a.getAttributeNames())if(g.endsWith("$lit$")||g.startsWith(Ce)){const b=m[s++];if(v.push(g),b!==void 0){const S=a.getAttribute(b.toLowerCase()+"$lit$").split(Ce),z=/([.?@])?(.*)/.exec(b);c.push({type:1,index:o,name:z[2],strings:S,ctor:z[1]==="."?Nr:z[1]==="?"?Br:z[1]==="@"?Hr:Qt})}else c.push({type:6,index:o})}for(const g of v)a.removeAttribute(g)}if(Ir.test(a.tagName)){const v=a.textContent.split(Ce),g=v.length-1;if(g>0){a.textContent=vt?vt.emptyScript:"";for(let b=0;b<g;b++)a.append(v[b],Ht()),mt.nextNode(),c.push({type:2,index:++o});a.append(v[g],Ht())}}}else if(a.nodeType===8)if(a.data===ba)c.push({type:2,index:o});else{let v=-1;for(;(v=a.data.indexOf(Ce,v+1))!==-1;)c.push({type:7,index:o}),v+=Ce.length-1}o++}}static createElement(e,t){const i=ft.createElement("template");return i.innerHTML=e,i}}function Ke(r,e,t=r,i){var a,o,s,l;if(e===he)return e;let c=i!==void 0?(a=t._$Cl)===null||a===void 0?void 0:a[i]:t._$Cu;const h=Ut(e)?void 0:e._$litDirective$;return(c==null?void 0:c.constructor)!==h&&((o=c==null?void 0:c._$AO)===null||o===void 0||o.call(c,!1),h===void 0?c=void 0:(c=new h(r),c._$AT(r,t,i)),i!==void 0?((s=(l=t)._$Cl)!==null&&s!==void 0?s:l._$Cl=[])[i]=c:t._$Cu=c),c!==void 0&&(e=Ke(r,c._$AS(r,e.values),c,i)),e}class Fr{constructor(e,t){this.v=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}p(e){var t;const{el:{content:i},parts:a}=this._$AD,o=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:ft).importNode(i,!0);mt.currentNode=o;let s=mt.nextNode(),l=0,c=0,h=a[0];for(;h!==void 0;){if(l===h.index){let m;h.type===2?m=new St(s,s.nextSibling,this,e):h.type===1?m=new h.ctor(s,h.name,h.strings,this,e):h.type===6&&(m=new Ur(s,this,e)),this.v.push(m),h=a[++c]}l!==(h==null?void 0:h.index)&&(s=mt.nextNode(),l++)}return o}m(e){let t=0;for(const i of this.v)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class St{constructor(e,t,i,a){var o;this.type=2,this._$AH=$,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=a,this._$C_=(o=a==null?void 0:a.isConnected)===null||o===void 0||o}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$C_}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&e.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Ke(this,e,t),Ut(e)?e===$||e==null||e===""?(this._$AH!==$&&this._$AR(),this._$AH=$):e!==this._$AH&&e!==he&&this.$(e):e._$litType$!==void 0?this.T(e):e.nodeType!==void 0?this.k(e):Lr(e)?this.O(e):this.$(e)}S(e,t=this._$AB){return this._$AA.parentNode.insertBefore(e,t)}k(e){this._$AH!==e&&(this._$AR(),this._$AH=this.S(e))}$(e){this._$AH!==$&&Ut(this._$AH)?this._$AA.nextSibling.data=e:this.k(ft.createTextNode(e)),this._$AH=e}T(e){var t;const{values:i,_$litType$:a}=e,o=typeof a=="number"?this._$AC(e):(a.el===void 0&&(a.el=Vt.createElement(a.h,this.options)),a);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===o)this._$AH.m(i);else{const s=new Fr(o,this),l=s.p(this.options);s.m(i),this.k(l),this._$AH=s}}_$AC(e){let t=tr.get(e.strings);return t===void 0&&tr.set(e.strings,t=new Vt(e)),t}O(e){Or(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,a=0;for(const o of e)a===t.length?t.push(i=new St(this.S(Ht()),this.S(Ht()),this,this.options)):i=t[a],i._$AI(o),a++;a<t.length&&(this._$AR(i&&i._$AB.nextSibling,a),t.length=a)}_$AR(e=this._$AA.nextSibling,t){var i;for((i=this._$AP)===null||i===void 0||i.call(this,!1,!0,t);e&&e!==this._$AB;){const a=e.nextSibling;e.remove(),e=a}}setConnected(e){var t;this._$AM===void 0&&(this._$C_=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}}class Qt{constructor(e,t,i,a,o){this.type=1,this._$AH=$,this._$AN=void 0,this.element=e,this.name=t,this._$AM=a,this.options=o,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=$}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,i,a){const o=this.strings;let s=!1;if(o===void 0)e=Ke(this,e,t,0),s=!Ut(e)||e!==this._$AH&&e!==he,s&&(this._$AH=e);else{const l=e;let c,h;for(e=o[0],c=0;c<o.length-1;c++)h=Ke(this,l[i+c],t,c),h===he&&(h=this._$AH[c]),s||(s=!Ut(h)||h!==this._$AH[c]),h===$?e=$:e!==$&&(e+=(h!=null?h:"")+o[c+1]),this._$AH[c]=h}s&&!a&&this.P(e)}P(e){e===$?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e!=null?e:"")}}class Nr extends Qt{constructor(){super(...arguments),this.type=3}P(e){this.element[this.name]=e===$?void 0:e}}const Bo=vt?vt.emptyScript:"";class Br extends Qt{constructor(){super(...arguments),this.type=4}P(e){e&&e!==$?this.element.setAttribute(this.name,Bo):this.element.removeAttribute(this.name)}}class Hr extends Qt{constructor(e,t,i,a,o){super(e,t,i,a,o),this.type=5}_$AI(e,t=this){var i;if((e=(i=Ke(this,e,t,0))!==null&&i!==void 0?i:$)===he)return;const a=this._$AH,o=e===$&&a!==$||e.capture!==a.capture||e.once!==a.once||e.passive!==a.passive,s=e!==$&&(a===$||o);o&&this.element.removeEventListener(this.name,this,a),s&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,i;typeof this._$AH=="function"?this._$AH.call((i=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&i!==void 0?i:this.element,e):this._$AH.handleEvent(e)}}class Ur{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){Ke(this,e)}}const Ho={A:"$lit$",M:Ce,C:ba,L:1,R:Pr,D:Fr,V:Lr,I:Ke,H:St,N:Qt,U:Br,B:Hr,F:Nr,W:Ur},ir=pi.litHtmlPolyfillSupport;ir==null||ir(Vt,St),((Wi=pi.litHtmlVersions)!==null&&Wi!==void 0?Wi:pi.litHtmlVersions=[]).push("2.3.1");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var ji,Qi;class I extends lt{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e,t;const i=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=i.firstChild),i}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=ai(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!1)}render(){return he}}I.finalized=!0,I._$litElement$=!0,(ji=globalThis.litElementHydrateSupport)===null||ji===void 0||ji.call(globalThis,{LitElement:I});const ar=globalThis.litElementPolyfillSupport;ar==null||ar({LitElement:I});((Qi=globalThis.litElementVersions)!==null&&Qi!==void 0?Qi:globalThis.litElementVersions=[]).push("3.2.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const H=r=>e=>typeof e=="function"?((t,i)=>(customElements.define(t,i),i))(r,e):((t,i)=>{const{kind:a,elements:o}=i;return{kind:a,elements:o,finisher(s){customElements.define(t,s)}}})(r,e);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Uo=(r,e)=>e.kind==="method"&&e.descriptor&&!("value"in e.descriptor)?{...e,finisher(t){t.createProperty(e.key,r)}}:{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){typeof e.initializer=="function"&&(this[e.key]=e.initializer.call(this))},finisher(t){t.createProperty(e.key,r)}};function p(r){return(e,t)=>t!==void 0?((i,a,o)=>{a.constructor.createProperty(o,i)})(r,e,t):Uo(r,e)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function T(r){return p({...r,state:!0})}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Vr=({finisher:r,descriptor:e})=>(t,i)=>{var a;if(i===void 0){const o=(a=t.originalKey)!==null&&a!==void 0?a:t.key,s=e!=null?{kind:"method",placement:"prototype",key:o,descriptor:e(t.key)}:{...t,key:o};return r!=null&&(s.finisher=function(l){r(l,o)}),s}{const o=t.constructor;e!==void 0&&Object.defineProperty(t,i,e(i)),r==null||r(o,i)}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function ce(r,e){return Vr({descriptor:t=>{const i={get(){var a,o;return(o=(a=this.renderRoot)===null||a===void 0?void 0:a.querySelector(r))!==null&&o!==void 0?o:null},enumerable:!0,configurable:!0};if(e){const a=typeof t=="symbol"?Symbol():"__"+t;i.get=function(){var o,s;return this[a]===void 0&&(this[a]=(s=(o=this.renderRoot)===null||o===void 0?void 0:o.querySelector(r))!==null&&s!==void 0?s:null),this[a]}}return i}})}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Vo(r){return Vr({descriptor:e=>({get(){var t,i;return(i=(t=this.renderRoot)===null||t===void 0?void 0:t.querySelectorAll(r))!==null&&i!==void 0?i:[]},enumerable:!0,configurable:!0})})}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Gi;((Gi=window.HTMLSlotElement)===null||Gi===void 0?void 0:Gi.prototype.assignedElements)!=null;class Wo{constructor(){this.resizeObserver=new ResizeObserver(e=>{window.requestAnimationFrame(()=>{for(const t of e){const i=this.resizeHandlers.get(t.target);i==null||i.forEach(a=>{a.handleResize(t)})}})}),this.resizeHandlers=new Map}shutdown(){this.resizeHandlers.forEach((e,t)=>{this.resizeObserver.unobserve(t)}),this.resizeHandlers.clear()}addObserver(e){var t;const i=(t=this.resizeHandlers.get(e.target))!==null&&t!==void 0?t:new Set;i.add(e.handler),this.resizeHandlers.set(e.target,i),this.resizeObserver.observe(e.target,e.options)}removeObserver(e){const t=this.resizeHandlers.get(e.target);!t||(t.delete(e.handler),t.size===0&&(this.resizeObserver.unobserve(e.target),this.resizeHandlers.delete(e.target)))}}class jo{constructor(e){var t,i,a,o;this.cacheKeyName="collection-name-cache",this.cacheTtl=60*60*24*7,this.defaultLoadDelay=100,this.loadDelay=100,this.defaultPruningAge=1e3*60*60*24*7,this.defaultPruningInterval=1e3*30,this.fetchTimeout=null,this.pendingIdentifierQueue=new Set,this.pendingPromises={},this.collectionNameCache={},this.pruningAge=this.defaultPruningAge,this.maxCacheSize=2500,this.cacheLoaded=!1,this.searchService=e.searchService,this.localCache=e.localCache,this.loadDelay=(t=e.loadDelay)!==null&&t!==void 0?t:this.defaultLoadDelay,this.pruningAge=(i=e.pruningAge)!==null&&i!==void 0?i:this.pruningAge,this.maxCacheSize=(a=e.maxCacheSize)!==null&&a!==void 0?a:this.maxCacheSize,this.pruneCache(),setInterval(async()=>{await this.pruneCache()},(o=e.pruneInterval)!==null&&o!==void 0?o:this.defaultPruningInterval)}async collectionNameFor(e){this.cacheLoaded||await this.loadFromCache();const t=e.toLowerCase(),i=this.collectionNameCache[t];return i?(i.lastAccess=Date.now(),this.collectionNameCache[t]=i,i.name):(this.startPendingIdentifierTimer(),new Promise(a=>{var o;this.pendingIdentifierQueue.add(t);const s=(o=this.pendingPromises[t])!==null&&o!==void 0?o:[],l=async c=>{a(c)};s.push(l),this.pendingPromises[t]=s}))}async preloadIdentifiers(e){this.cacheLoaded||await this.loadFromCache();const t=e.filter(i=>i!==void 0).map(i=>i.toLowerCase());for(const i of t)this.collectionNameCache[i]||this.pendingIdentifierQueue.add(i);this.startPendingIdentifierTimer()}async startPendingIdentifierTimer(){this.fetchTimeout||(this.fetchTimeout=window.setTimeout(()=>{this.loadPendingIdentifiers(),this.fetchTimeout=null},this.loadDelay))}async loadFromCache(){if(!this.localCache||this.cacheLoaded)return;const e=await this.localCache.get(this.cacheKeyName);!e||(this.collectionNameCache=e,this.cacheLoaded=!0)}async loadPendingIdentifiers(){var e,t,i;await this.loadFromCache();const a=Array.from(this.pendingIdentifierQueue).splice(0,100);if(a.length===0)return;a.map(async c=>this.pendingIdentifierQueue.delete(c));const o={query:`identifier:(${a.join(" OR ")})`,fields:["title","identifier"],rows:a.length},l=(t=(e=(await this.searchService.search(o)).success)===null||e===void 0?void 0:e.response)===null||t===void 0?void 0:t.docs;if(l&&l.length>0)for(const c of l){const{identifier:h,title:m}=c;if(!h)continue;const v=h.toLowerCase();a.splice(a.indexOf(v),1);const g=(i=m==null?void 0:m.value)!==null&&i!==void 0?i:null;this.collectionNameCache[v]={name:g,lastAccess:Date.now()};const b=this.pendingPromises[v];if(b){for(const S of b)S(g);delete this.pendingPromises[v]}}for(const c of a){this.collectionNameCache[c]={name:null,lastAccess:Date.now()};const h=this.pendingPromises[c];if(h){for(const m of h)m(null);delete this.pendingPromises[c]}}await this.persistCache()}async pruneCache(){await this.loadFromCache();const e=Date.now(),t=Object.entries(this.collectionNameCache).sort((a,o)=>{var s,l,c,h;const m=(l=(s=a[1])===null||s===void 0?void 0:s.lastAccess)!==null&&l!==void 0?l:0,v=(h=(c=o[1])===null||c===void 0?void 0:c.lastAccess)!==null&&h!==void 0?h:0;return m-v}),i=new Set;for(const[a,o]of t){if(!o)continue;const{lastAccess:s}=o;s<e-this.pruningAge&&i.add(a)}if(t.length>this.maxCacheSize)for(let a=0;a<t.length-this.maxCacheSize;a+=1){const[o]=t[a];i.add(o)}for(const a of i)delete this.collectionNameCache[a];await this.persistCache()}async persistCache(){var e;await((e=this.localCache)===null||e===void 0?void 0:e.set({key:this.cacheKeyName,value:this.collectionNameCache,ttl:this.cacheTtl}))}}let Wt=class extends I{render(){return u` ${this.name?this.name:this.identifier} `}createRenderRoot(){return this}updated(e){(e.has("identifier")||e.has("collectionNameCache"))&&this.fetchName()}async fetchName(){!this.identifier||!this.collectionNameCache||(this.name=await this.collectionNameCache.collectionNameFor(this.identifier))}};n([p({type:Object})],Wt.prototype,"collectionNameCache",void 0);n([p({type:String})],Wt.prototype,"identifier",void 0);n([T()],Wt.prototype,"name",void 0);Wt=n([H("async-collection-name")],Wt);/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ae={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},wa=r=>(...e)=>({_$litDirective$:r,values:e});class xa{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{H:Qo}=Ho,Go=r=>r.strings===void 0,rr=()=>document.createComment(""),Lt=(r,e,t)=>{var i;const a=r._$AA.parentNode,o=e===void 0?r._$AB:e._$AA;if(t===void 0){const s=a.insertBefore(rr(),o),l=a.insertBefore(rr(),o);t=new Qo(s,l,r,r.options)}else{const s=t._$AB.nextSibling,l=t._$AM,c=l!==r;if(c){let h;(i=t._$AQ)===null||i===void 0||i.call(t,r),t._$AM=r,t._$AP!==void 0&&(h=r._$AU)!==l._$AU&&t._$AP(h)}if(s!==o||c){let h=t._$AA;for(;h!==s;){const m=h.nextSibling;a.insertBefore(h,o),h=m}}}return t},Ve=(r,e,t=r)=>(r._$AI(e,t),r),Yo={},Wr=(r,e=Yo)=>r._$AH=e,Ko=r=>r._$AH,Yi=r=>{var e;(e=r._$AP)===null||e===void 0||e.call(r,!1,!0);let t=r._$AA;const i=r._$AB.nextSibling;for(;t!==i;){const a=t.nextSibling;t.remove(),t=a}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const or=(r,e,t)=>{const i=new Map;for(let a=e;a<=t;a++)i.set(r[a],a);return i},jr=wa(class extends xa{constructor(r){if(super(r),r.type!==Ae.CHILD)throw Error("repeat() can only be used in text expressions")}ht(r,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);const a=[],o=[];let s=0;for(const l of r)a[s]=i?i(l,s):s,o[s]=t(l,s),s++;return{values:o,keys:a}}render(r,e,t){return this.ht(r,e,t).values}update(r,[e,t,i]){var a;const o=Ko(r),{values:s,keys:l}=this.ht(e,t,i);if(!Array.isArray(o))return this.ut=l,s;const c=(a=this.ut)!==null&&a!==void 0?a:this.ut=[],h=[];let m,v,g=0,b=o.length-1,S=0,z=s.length-1;for(;g<=b&&S<=z;)if(o[g]===null)g++;else if(o[b]===null)b--;else if(c[g]===l[S])h[S]=Ve(o[g],s[S]),g++,S++;else if(c[b]===l[z])h[z]=Ve(o[b],s[z]),b--,z--;else if(c[g]===l[z])h[z]=Ve(o[g],s[z]),Lt(r,h[z+1],o[g]),g++,z--;else if(c[b]===l[S])h[S]=Ve(o[b],s[S]),Lt(r,o[g],o[b]),b--,S++;else if(m===void 0&&(m=or(l,S,z),v=or(c,g,b)),m.has(c[g]))if(m.has(c[b])){const D=v.get(l[S]),E=D!==void 0?o[D]:null;if(E===null){const F=Lt(r,o[g]);Ve(F,s[S]),h[S]=F}else h[S]=Ve(E,s[S]),Lt(r,o[g],E),o[D]=null;S++}else Yi(o[b]),b--;else Yi(o[g]),g++;for(;S<=z;){const D=Lt(r,h[z+1]);Ve(D,s[S]),h[S++]=D}for(;g<=b;){const D=o[g++];D!==null&&Yi(D)}return this.ut=l,Wr(r,h),he}});function Zt(r,e,t){return Array.from({length:(e-r)/t+1},(i,a)=>r+a*t)}let Ie=class extends I{constructor(){super(...arguments),this.itemCount=0,this.scrollOptimizationsDisabled=!1,this.intersectionObserver=new IntersectionObserver(e=>{e.forEach(t=>{if(t.target===this.sentinel){t.isIntersecting&&this.dispatchEvent(new Event("scrollThresholdReached"));return}const a=t.target.dataset.cellIndex;if(!a)return;const o=parseInt(a,10);t.isIntersecting?this.visibleCellIndices.add(o):this.visibleCellIndices.delete(o)}),this.scrollOptimizationsDisabled||this.processVisibleCells()}),this.renderedCellIndices=new Set,this.visibleCellIndices=new Set,this.placeholderCellIndices=new Set}reload(){Zt(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.removeCell(t)),this.renderedCellIndices.clear(),this.visibleCellIndices.clear(),this.placeholderCellIndices.clear(),this.setupObservations()}scrollToCell(e,t){const i=this.cellContainers[e];if(!i)return!1;const a=t?"smooth":"auto";return i.scrollIntoView({behavior:a}),!0}getVisibleCellIndices(){return Array.from(this.visibleCellIndices)}updated(e){(e.has("itemCount")||e.has("scrollOptimizationsDisabled"))&&this.setupObservations()}disconnectedCallback(){this.intersectionObserver.disconnect()}setupObservations(){this.setupIntersectionObserver()}setupIntersectionObserver(){this.intersectionObserver.disconnect(),this.sentinel&&this.intersectionObserver.observe(this.sentinel),this.scrollOptimizationsDisabled?(Zt(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.visibleCellIndices.add(t)),this.processVisibleCells()):this.cellContainers.forEach(e=>this.intersectionObserver.observe(e))}render(){const e=this.itemCount-1,t=Zt(0,e,1);return u`
      <div id="container">
        <div id="sentinel"></div>
        ${jr(t,i=>i,i=>u`
            <div
    ...
    `}};n([p({type:Number})],Ie.prototype,"itemCount",void 0);n([p({type:Object})],Ie.prototype,"cellProvider",void 0);n([p({type:Object})],Ie.prototype,"placeholderCellTemplate",void 0);n([p({type:Boolean})],Ie.prototype,"scrollOptimizationsDisabled",void 0);n([ce("#sentinel")],Ie.prototype,"sentinel",void 0);n([Vo(".cell-container")],Ie.prototype,"cellContainers",void 0);Ie=n([H("infinite-scroller")],Ie);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const qo=(r,...e)=>({strTag:!0,strings:r,values:e}),nt=qo,Xo=r=>typeof r!="string"&&"strTag"in r,Zo=(r,e,t)=>{let i=r[0];for(let a=1;a<r.length;a++)i+=e[t?t[a-1]:a-1],i+=r[a];return i};/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;let la=class extends I{render(){var e,t,i;return u`
      <div id="container">
        ...
        <div id="item-count-container">
          ...
          <div id="item-count-stacked-text">
            ...
            <div id="items-text">${Qe("items")}</div>
          </div>
        </div>
      </div>
    ...
    `}};n([p({type:Object})],la.prototype,"model",void 0);la=n([H("collection-tile")],la);function ui(r,e="short",t="en-US"){if(!r)return"";const i={timeZone:"UTC"};switch(e){case"short":i.month="short",i.year="numeric";break;case"long":i.year="numeric",i.month="short",i.day="2-digit";break}return new Intl.DateTimeFormat(t,i).format(r)}/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ca=wa(class extends xa{constructor(r){var e;if(super(r),r.type!==Ae.ATTRIBUTE||r.name!=="class"||((e=r.strings)===null||e===void 0?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(r){return" "+Object.keys(r).filter(e=>r[e]).join(" ")+" "}update(r,[e]){var t,i;if(this.nt===void 0){this.nt=new Set,r.strings!==void 0&&(this.st=new Set(r.strings.join(" ").split(/\s/).filter(o=>o!=="")));for(const o in e)e[o]&&!(!((t=this.st)===null||t===void 0)&&t.has(o))&&this.nt.add(o);return this.render(e)}const a=r.element.classList;this.nt.forEach(o=>{o in e||(a.remove(o),this.nt.delete(o))});for(const o in e){const s=!!e[o];s===this.nt.has(o)||((i=this.st)===null||i===void 0?void 0:i.has(o))||(s?(a.add(o),this.nt.add(o)):(a.remove(o),this.nt.delete(o)))}return he}}),is=O`
  <svg
    viewBox="0 0 100 100"
    xmlns="http://www.w3.org/2000/svg"
  >
...
`;let mi=class extends I{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1}render(){return this.loginRequired&&!this.loggedIn?u`${as} `:u`${is}`}static get styles(){return y`
      :host {
        position: absolute;
        top: 50%;
        left: 50%;
...
to view this item`:"Content may be inappropriate"}static get styles(){return y`
    ...
    `}};n([p({type:Boolean})],vi.prototype,"loggedIn",void 0);n([p({type:Boolean})],vi.prototype,"loginRequired",void 0);vi=n([H("text-overlay")],vi);let Re=class extends I{constructor(){super(...arguments),this.isCompactTile=!1,this.isListTile=!1,this.loggedIn=!1,this.viewSize="desktop"}render(){var e;return!((e=this.model)===null||e===void 0)&&e.identifier?u`
      <div class=${ca(this.baseClass)}>
        <item-image
          .model=${this.model}
    ...
    `}};n([p({type:String})],Re.prototype,"baseImageUrl",void 0);n([p({type:Boolean})],Re.prototype,"isCompactTile",void 0);n([p({type:Boolean})],Re.prototype,"isListTile",void 0);n([p({type:Boolean})],Re.prototype,"loggedIn",void 0);n([p({type:Object})],Re.prototype,"model",void 0);n([p({type:String})],Re.prototype,"viewSize",void 0);Re=n([H("image-block")],Re);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*ri(r,e){const t=typeof e=="function";if(r!==void 0){let i=-1;for(const a of r)i>-1&&(yield t?e(i):e),i++,yield a}}let fi=class extends I{constructor(){super(...arguments),this.snippets=[],this.viewSize="desktop"}render(){var e;return!((e=this.snippets)===null||e===void 0)&&e.length?u`
    ...
    `:u`${$}`}get viewSizeClass(){return this.viewSize==="grid"?"grid":"list"}get containerClasses(){return`container ${this.viewSizeClass}`}get ellipsisJoinedSnippets(){return u`
      &hellip; ${ri(this.snippetTemplates,u` &hellip; `)} &hellip;
    ...
    `}};n([p({type:Array})],fi.prototype,"snippets",void 0);n([p({type:String})],fi.prototype,"viewSize",void 0);fi=n([H("text-snippet-block")],fi);const rs=y`
  .drop-shadow {
...
`,gs={account:{color:"#000000",icon:ss,text:"Account"},audio:{color:"#00adef",icon:ns,text:"Audio"},collection:{color:"#4666ff",icon:Qr,text:"Collection"},data:{color:"#333333",icon:ls,text:"Data"},etree:{color:"#00adef",icon:cs,text:"E-tree"},film:{color:"#bf1b2c",icon:sr,text:"Film"},image:{color:"#aa99c9",icon:ds,text:"Image"},movies:{color:"#f1644b",icon:sr,text:"Movie"},radio:{color:"#8fdaef",icon:hs,text:"Radio"},software:{color:"#9ecc4f",icon:ps,text:"Software"},texts:{color:"#faab3c",icon:us,text:"Text"},tv:{color:"#f1644b",icon:ms,text:"TV"},video:{color:"#f1644b",icon:vs,text:"Video"},web:{color:"#ffcd27",icon:fs,text:"Web"}};let jt=class extends I{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var e,t;const i=["tvnews","tvarchive","television"],a=["radio","radioprogram"];return this.mediatype==="movies"&&((e=this.collections)===null||e===void 0?void 0:e.some(o=>i.indexOf(o)>=0))?"tv":this.mediatype==="audio"&&((t=this.collections)===null||t===void 0?void 0:t.some(o=>a.indexOf(o)>=0))?"radio":this.mediatype||""}render(){const e=gs[this.displayMediatype];return e?u`
      <div
        id="icon"
    ...
    `}};n([p({type:String})],jt.prototype,"mediatype",void 0);n([p({type:Array})],jt.prototype,"collections",void 0);n([p({type:Boolean})],jt.prototype,"showText",void 0);jt=n([H("mediatype-icon")],jt);const ys=O`
...
`;function Ss(r,e){let t=1;return r>=1e9?t=1e9:r>=1e6?t=1e6:r>=1e3&&e==="short"&&(t=1e3),t}function $s(r=0,e){const t=r/e,i=t<10;let a=0;return i?a=Math.round((t+Number.EPSILON)*10)/10:a=Math.round(t),a}function _s(r,e,t,i){switch(e){case 1e9:return Qe(t==="short"?nt`${r}B`:nt`${r} billion`);case 1e6:return Qe(t==="short"?nt`${r}M`:nt`${r} million`);case 1e3:return Qe(t==="short"?nt`${r}K`:nt`${r} thousand`);default:return new Intl.NumberFormat(i).format(r)}}function Pt(r,e="long",t="short",i="en-US"){const a=r!=null?r:-1;if(a<0)return"";const o=Ss(a,e),s=$s(a,o);return _s(s,o,t,i)}let qe=class extends I{render(){return u`
        ...
        <ul id="stats-row">
          ...
          <li class="col">
            ...
            <p class="status-text">
              ...
              ${Pt(this.mediatype==="account"?this.itemCount:this.viewCount,"short","short")}
            </p>
          </li>
          <li class="col">
            ${ys}
          ...
          <li class="col">
            ...
            <p class="status-text">
              ...
              ${Pt(this.commentCount,"short","short")}
            </p>
          </li>
        </ul>
      </div>
    ...
    `}};n([p({type:String})],gt.prototype,"baseImageUrl",void 0);n([p({type:Boolean})],gt.prototype,"loggedIn",void 0);n([p({type:Object})],gt.prototype,"model",void 0);n([p({type:Object})],gt.prototype,"sortParam",void 0);gt=n([H("item-tile")],gt);let da=class extends I{render(){var e,t,i,a,o,s,l,c;return u`
    ...
    `}};n([p({type:Object})],da.prototype,"model",void 0);da=n([H("account-tile")],da);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*nr(r,e){if(r!==void 0){let t=0;for(const i of r)yield e(i,t++)}}/*! @license DOMPurify 2.4.0 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/2.4.0/LICENSE */function De(r){return De=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},De(r)}function ha(r,e){return ha=Object.setPrototypeOf||function(i,a){return i.__proto__=a,i},ha(r,e)}function Cs(){if(typeof Reflect=="undefined"||!Reflect.construct||Reflect.construct.sham)return!1;if(typeof Proxy=="function")return!0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],function(){})),!0}catch{return!1}}function oi(r,e,t){return Cs()?oi=Reflect.construct:oi=function(a,o,s){var l=[null];l.push.apply(l,o);var c=Function.bind.apply(a,l),h=new c;return s&&ha(h,s.prototype),h},oi.apply(null,arguments)}function ue(r){return zs(r)||ks(r)||Ts(r)||As()}function zs(r){if(Array.isArray(r))return pa(r)}function ks(r){if(typeof Symbol!="undefined"&&r[Symbol.iterator]!=null||r["@@iterator"]!=null)return Array.from(r)}function Ts(r,e){if(!!r){if(typeof r=="string")return pa(r,e);var t=Object.prototype.toString.call(r).slice(8,-1);if(t==="Object"&&r.constructor&&(t=r.constructor.name),t==="Map"||t==="Set")return Array.from(r);if(t==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t))return pa(r,e)}}function pa(r,e){(e==null||e>r.length)&&(e=r.length);for(var t=0,i=new Array(e);t<e;t++)i[t]=r[t];return i}function As(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}var Ms=Object.hasOwnProperty,lr=Object.setPrototypeOf,Es=Object.isFrozen,Ds=Object.getPrototypeOf,Os=Object.getOwnPropertyDescriptor,te=Object.freeze,be=Object.seal,Ls=Object.create,Gr=typeof Reflect!="undefined"&&Reflect,gi=Gr.apply,ua=Gr.construct;gi||(gi=function(e,t,i){return e.apply(t,i)});te||(te=function(e){return e});be||(be=function(e){return e});ua||(ua=function(e,t){return oi(e,ue(t))});var Is=ve(Array.prototype.forEach),cr=ve(Array.prototype.pop),It=ve(Array.prototype.push),si=ve(String.prototype.toLowerCase),Rs=ve(String.prototype.match),Te=ve(String.prototype.replace),Ps=ve(String.prototype.indexOf),Fs=ve(String.prototype.trim),ee=ve(RegExp.prototype.test),Ki=Ns(TypeError);function ve(r){return function(e){for(var t=arguments.length,i=new Array(t>1?t-1:0),a=1;a<t;a++)i[a-1]=arguments[a];return gi(r,e,i)}}function Ns(r){return function(){for(var e=arguments.length,t=new Array(e),i=0;i<e;i++)t[i]=arguments[i];return ua(r,t)}}function A(r,e,t){t=t||si,lr&&lr(r,null);for(var i=e.length;i--;){var a=e[i];if(typeof a=="string"){var o=t(a);o!==a&&(Es(e)||(e[i]=o),a=o)}r[a]=!0}return r}function We(r){var e=Ls(null),t;for(t in r)gi(Ms,r,[t])&&(e[t]=r[t]);return e}function Jt(r,e){for(;r!==null;){var t=Os(r,e);if(t){if(t.get)return ve(t.get);if(typeof t.value=="function")return ve(t.value)}r=Ds(r)}function i(a){return console.warn("fallback value for",a),null}return i}var dr=te(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","section","select","shadow","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),qi=te(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","filter","font","g","glyph","glyphref","hkern","image","line","lineargradient","marker","mask","metadata","mpath","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),Xi=te(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),Bs=te(["animate","color-profile","cursor","discard","fedropshadow","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),Zi=te(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover"]),Hs=te(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),hr=te(["#text"]),pr=te(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","face","for","headers","height","hidden","high","href","hreflang","id","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","pattern","placeholder","playsinline","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","xmlns","slot"]),Ji=te(["accent-height","accumulate","additive","alignment-baseline","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),ur=te(["accent","accentunder","align","bevelled","close","columnsalign","columnlines","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lspace","lquote","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),ei=te(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),Us=be(/\{\{[\w\W]*|[\w\W]*\}\}/gm),Vs=be(/<%[\w\W]*|[\w\W]*%>/gm),Ws=be(/^data-[\-\w.\u00B7-\uFFFF]/),js=be(/^aria-[\-\w]+$/),Qs=be(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|cid|xmpp):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),Gs=be(/^(?:\w+script|data):/i),Ys=be(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),Ks=be(/^html$/i),qs=function(){return typeof window=="undefined"?null:window},Xs=function(e,t){if(De(e)!=="object"||typeof e.createPolicy!="function")return null;var i=null,a="data-tt-policy-suffix";t.currentScript&&t.currentScript.hasAttribute(a)&&(i=t.currentScript.getAttribute(a));var o="dompurify"+(i?"#"+i:"");try{return e.createPolicy(o,{createHTML:function(l){return l},createScriptURL:function(l){return l}})}catch{return console.warn("TrustedTypes policy "+o+" could not be created."),null}};function Yr(){var r=arguments.length>0&&arguments[0]!==void 0?arguments[0]:qs(),e=function(d){return Yr(d)};if(e.version="2.4.0",e.removed=[],!r||!r.document||r.document.nodeType!==9)return e.isSupported=!1,e;var t=r.document,i=r.document,a=r.DocumentFragment,o=r.HTMLTemplateElement,s=r.Node,l=r.Element,c=r.NodeFilter,h=r.NamedNodeMap,m=h===void 0?r.NamedNodeMap||r.MozNamedAttrMap:h,v=r.HTMLFormElement,g=r.DOMParser,b=r.trustedTypes,S=l.prototype,z=Jt(S,"cloneNode"),D=Jt(S,"nextSibling"),E=Jt(S,"childNodes"),F=Jt(S,"parentNode");if(typeof o=="function"){var P=i.createElement("template");P.content&&P.content.ownerDocument&&(i=P.content.ownerDocument)}var R=Xs(b,t),q=R?R.createHTML(""):"",ne=i,ge=ne.implementation,$t=ne.createNodeIterator,_t=ne.createDocumentFragment,Ct=ne.getElementsByTagName,zt=t.importNode,Xe={};try{Xe=We(i).documentMode?i.documentMode:{}}catch{}var ie={};e.isSupported=typeof F=="function"&&ge&&typeof ge.createHTMLDocument!="undefined"&&Xe!==9;var Pe=Us,Fe=Vs,kt=Ws,Tt=js,At=Gs,Ze=Ys,Ne=Qs,W=null,Je=A({},[].concat(ue(dr),ue(qi),ue(Xi),ue(Zi),ue(hr))),j=null,et=A({},[].concat(ue(pr),ue(Ji),ue(ur),ue(ei))),U=Object.seal(Object.create(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),xe=null,Be=null,Mt=!0,ki=!0,ka=!1,tt=!1,He=!1,Ti=!1,Ai=!1,it=!1,Gt=!1,Yt=!1,Ta=!0,Aa=!1,no="user-content-",Mi=!0,Et=!1,at={},rt=null,Ma=A({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","style","svg","template","thead","title","video","xmp"]),Ea=null,Da=A({},["audio","video","img","source","image","track"]),Ei=null,Oa=A({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),Di="http://www.w3.org/1998/Math/MathML",Oi="http://www.w3.org/2000/svg",ke="http://www.w3.org/1999/xhtml",Kt=ke,Li=!1,ot,lo=["application/xhtml+xml","text/html"],co="text/html",Y,st=null,ho=i.createElement("form"),La=function(d){return d instanceof RegExp||d instanceof Function},Ii=function(d){st&&st===d||((!d||De(d)!=="object")&&(d={}),d=We(d),ot=lo.indexOf(d.PARSER_MEDIA_TYPE)===-1?ot=co:ot=d.PARSER_MEDIA_TYPE,Y=ot==="application/xhtml+xml"?function(f){return f}:si,W="ALLOWED_TAGS"in d?A({},d.ALLOWED_TAGS,Y):Je,j="ALLOWED_ATTR"in d?A({},d.ALLOWED_ATTR,Y):et,Ei="ADD_URI_SAFE_ATTR"in d?A(We(Oa),d.ADD_URI_SAFE_ATTR,Y):Oa,Ea="ADD_DATA_URI_TAGS"in d?A(We(Da),d.ADD_DATA_URI_TAGS,Y):Da,rt="FORBID_CONTENTS"in d?A({},d.FORBID_CONTENTS,Y):Ma,xe="FORBID_TAGS"in d?A({},d.FORBID_TAGS,Y):{},Be="FORBID_ATTR"in d?A({},d.FORBID_ATTR,Y):{},at="USE_PROFILES"in d?d.USE_PROFILES:!1,Mt=d.ALLOW_ARIA_ATTR!==!1,ki=d.ALLOW_DATA_ATTR!==!1,ka=d.ALLOW_UNKNOWN_PROTOCOLS||!1,tt=d.SAFE_FOR_TEMPLATES||!1,He=d.WHOLE_DOCUMENT||!1,it=d.RETURN_DOM||!1,Gt=d.RETURN_DOM_FRAGMENT||!1,Yt=d.RETURN_TRUSTED_TYPE||!1,Ai=d.FORCE_BODY||!1,Ta=d.SANITIZE_DOM!==!1,Aa=d.SANITIZE_NAMED_PROPS||!1,Mi=d.KEEP_CONTENT!==!1,Et=d.IN_PLACE||!1,Ne=d.ALLOWED_URI_REGEXP||Ne,Kt=d.NAMESPACE||ke,d.CUSTOM_ELEMENT_HANDLING&&La(d.CUSTOM_ELEMENT_HANDLING.tagNameCheck)&&(U.tagNameCheck=d.CUSTOM_ELEMENT_HANDLING.tagNameCheck),d.CUSTOM_ELEMENT_HANDLING&&La(d.CUSTOM_ELEMENT_HANDLING.attributeNameCheck)&&(U.attributeNameCheck=d.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),d.CUSTOM_ELEMENT_HANDLING&&typeof d.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements=="boolean"&&(U.allowCustomizedBuiltInElements=d.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements),tt&&(ki=!1),Gt&&(it=!0),at&&(W=A({},ue(hr)),j=[],at.html===!0&&(A(W,dr),A(j,pr)),at.svg===!0&&(A(W,qi),A(j,Ji),A(j,ei)),at.svgFilters===!0&&(A(W,Xi),A(j,Ji),A(j,ei)),at.mathMl===!0&&(A(W,Zi),A(j,ur),A(j,ei))),d.ADD_TAGS&&(W===Je&&(W=We(W)),A(W,d.ADD_TAGS,Y)),d.ADD_ATTR&&(j===et&&(j=We(j)),A(j,d.ADD_ATTR,Y)),d.ADD_URI_SAFE_ATTR&&A(Ei,d.ADD_URI_SAFE_ATTR,Y),d.FORBID_CONTENTS&&(rt===Ma&&(rt=We(rt)),A(rt,d.FORBID_CONTENTS,Y)),Mi&&(W["#text"]=!0),He&&A(W,["html","head","body"]),W.table&&(A(W,["tbody"]),delete xe.tbody),te&&te(d),st=d)},Ia=A({},["mi","mo","mn","ms","mtext"]),Ra=A({},["foreignobject","desc","title","annotation-xml"]),po=A({},["title","style","font","a","script"]),qt=A({},qi);A(qt,Xi),A(qt,Bs);var Ri=A({},Zi);A(Ri,Hs);var uo=function(d){var f=F(d);(!f||!f.tagName)&&(f={namespaceURI:ke,tagName:"template"});var w=si(d.tagName),L=si(f.tagName);return d.namespaceURI===Oi?f.namespaceURI===ke?w==="svg":f.namespaceURI===Di?w==="svg"&&(L==="annotation-xml"||Ia[L]):Boolean(qt[w]):d.namespaceURI===Di?f.namespaceURI===ke?w==="math":f.namespaceURI===Oi?w==="math"&&Ra[L]:Boolean(Ri[w]):d.namespaceURI===ke?f.namespaceURI===Oi&&!Ra[L]||f.namespaceURI===Di&&!Ia[L]?!1:!Ri[w]&&(po[w]||!qt[w]):!1},Se=function(d){It(e.removed,{element:d});try{d.parentNode.removeChild(d)}catch{try{d.outerHTML=q}catch{d.remove()}}},Pi=function(d,f){try{It(e.removed,{attribute:f.getAttributeNode(d),from:f})}catch{It(e.removed,{attribute:null,from:f})}if(f.removeAttribute(d),d==="is"&&!j[d])if(it||Gt)try{Se(f)}catch{}else try{f.setAttribute(d,"")}catch{}},Pa=function(d){var f,w;if(Ai)d="<remove></remove>"+d;else{var L=Rs(d,/^[\r\n\t ]+/);w=L&&L[0]}ot==="application/xhtml+xml"&&(d='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+d+"</body></html>");var ae=R?R.createHTML(d):d;if(Kt===ke)try{f=new g().parseFromString(ae,ot)}catch{}if(!f||!f.documentElement){f=ge.createDocument(Kt,"template",null);try{f.documentElement.innerHTML=Li?"":ae}catch{}}var Z=f.body||f.documentElement;return d&&w&&Z.insertBefore(i.createTextNode(w),Z.childNodes[0]||null),Kt===ke?Ct.call(f,He?"html":"body")[0]:He?f.documentElement:Z},Fa=function(d){return $t.call(d.ownerDocument||d,d,c.SHOW_ELEMENT|c.SHOW_COMMENT|c.SHOW_TEXT,null,!1)},mo=function(d){return d instanceof v&&(typeof d.nodeName!="string"||typeof d.textContent!="string"||typeof d.removeChild!="function"||!(d.attributes instanceof m)||typeof d.removeAttribute!="function"||typeof d.setAttribute!="function"||typeof d.namespaceURI!="string"||typeof d.insertBefore!="function")},Dt=function(d){return De(s)==="object"?d instanceof s:d&&De(d)==="object"&&typeof d.nodeType=="number"&&typeof d.nodeName=="string"},$e=function(d,f,w){!ie[d]||Is(ie[d],function(L){L.call(e,f,w,st)})},Na=function(d){var f;if($e("beforeSanitizeElements",d,null),mo(d)||ee(/[\u0080-\uFFFF]/,d.nodeName))return Se(d),!0;var w=Y(d.nodeName);if($e("uponSanitizeElement",d,{tagName:w,allowedTags:W}),d.hasChildNodes()&&!Dt(d.firstElementChild)&&(!Dt(d.content)||!Dt(d.content.firstElementChild))&&ee(/<[/\w]/g,d.innerHTML)&&ee(/<[/\w]/g,d.textContent)||w==="select"&&ee(/<template/i,d.innerHTML))return Se(d),!0;if(!W[w]||xe[w]){if(!xe[w]&&Ha(w)&&(U.tagNameCheck instanceof RegExp&&ee(U.tagNameCheck,w)||U.tagNameCheck instanceof Function&&U.tagNameCheck(w)))return!1;if(Mi&&!rt[w]){var L=F(d)||d.parentNode,ae=E(d)||d.childNodes;if(ae&&L)for(var Z=ae.length,X=Z-1;X>=0;--X)L.insertBefore(z(ae[X],!0),D(d))}return Se(d),!0}return d instanceof l&&!uo(d)||(w==="noscript"||w==="noembed")&&ee(/<\/no(script|embed)/i,d.innerHTML)?(Se(d),!0):(tt&&d.nodeType===3&&(f=d.textContent,f=Te(f,Pe," "),f=Te(f,Fe," "),d.textContent!==f&&(It(e.removed,{element:d.cloneNode()}),d.textContent=f)),$e("afterSanitizeElements",d,null),!1)},Ba=function(d,f,w){if(Ta&&(f==="id"||f==="name")&&(w in i||w in ho))return!1;if(!(ki&&!Be[f]&&ee(kt,f))){if(!(Mt&&ee(Tt,f))){if(!j[f]||Be[f]){if(!(Ha(d)&&(U.tagNameCheck instanceof RegExp&&ee(U.tagNameCheck,d)||U.tagNameCheck instanceof Function&&U.tagNameCheck(d))&&(U.attributeNameCheck instanceof RegExp&&ee(U.attributeNameCheck,f)||U.attributeNameCheck instanceof Function&&U.attributeNameCheck(f))||f==="is"&&U.allowCustomizedBuiltInElements&&(U.tagNameCheck instanceof RegExp&&ee(U.tagNameCheck,w)||U.tagNameCheck instanceof Function&&U.tagNameCheck(w))))return!1}else if(!Ei[f]){if(!ee(Ne,Te(w,Ze,""))){if(!((f==="src"||f==="xlink:href"||f==="href")&&d!=="script"&&Ps(w,"data:")===0&&Ea[d])){if(!(ka&&!ee(At,Te(w,Ze,"")))){if(w)return!1}}}}}}return!0},Ha=function(d){return d.indexOf("-")>0},Ua=function(d){var f,w,L,ae;$e("beforeSanitizeAttributes",d,null);var Z=d.attributes;if(!!Z){var X={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:j};for(ae=Z.length;ae--;){f=Z[ae];var Xt=f,J=Xt.name,Fi=Xt.namespaceURI;if(w=J==="value"?f.value:Fs(f.value),L=Y(J),X.attrName=L,X.attrValue=w,X.keepAttr=!0,X.forceKeepAttr=void 0,$e("uponSanitizeAttribute",d,X),w=X.attrValue,!X.forceKeepAttr&&(Pi(J,d),!!X.keepAttr)){if(ee(/\/>/i,w)){Pi(J,d);continue}tt&&(w=Te(w,Pe," "),w=Te(w,Fe," "));var Va=Y(d.nodeName);if(!!Ba(Va,L,w)){if(Aa&&(L==="id"||L==="name")&&(Pi(J,d),w=no+w),R&&De(b)==="object"&&typeof b.getAttributeType=="function"&&!Fi)switch(b.getAttributeType(Va,L)){case"TrustedHTML":w=R.createHTML(w);break;case"TrustedScriptURL":w=R.createScriptURL(w);break}try{Fi?d.setAttributeNS(Fi,J,w):d.setAttribute(J,w),cr(e.removed)}catch{}}}}$e("afterSanitizeAttributes",d,null)}},vo=function C(d){var f,w=Fa(d);for($e("beforeSanitizeShadowDOM",d,null);f=w.nextNode();)$e("uponSanitizeShadowNode",f,null),!Na(f)&&(f.content instanceof a&&C(f.content),Ua(f));$e("afterSanitizeShadowDOM",d,null)};return e.sanitize=function(C){var d=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},f,w,L,ae,Z;if(Li=!C,Li&&(C="<!-->"),typeof C!="string"&&!Dt(C)){if(typeof C.toString!="function")throw Ki("toString is not a function");if(C=C.toString(),typeof C!="string")throw Ki("dirty is not a string, aborting")}if(!e.isSupported){if(De(r.toStaticHTML)==="object"||typeof r.toStaticHTML=="function"){if(typeof C=="string")return r.toStaticHTML(C);if(Dt(C))return r.toStaticHTML(C.outerHTML)}return C}if(Ti||Ii(d),e.removed=[],typeof C=="string"&&(Et=!1),Et){if(C.nodeName){var X=Y(C.nodeName);if(!W[X]||xe[X])throw Ki("root node is forbidden and cannot be sanitized in-place")}}else if(C instanceof s)f=Pa("<!---->"),w=f.ownerDocument.importNode(C,!0),w.nodeType===1&&w.nodeName==="BODY"||w.nodeName==="HTML"?f=w:f.appendChild(w);else{if(!it&&!tt&&!He&&C.indexOf("<")===-1)return R&&Yt?R.createHTML(C):C;if(f=Pa(C),!f)return it?null:Yt?q:""}f&&Ai&&Se(f.firstChild);for(var Xt=Fa(Et?C:f);L=Xt.nextNode();)L.nodeType===3&&L===ae||Na(L)||(L.content instanceof a&&vo(L.content),Ua(L),ae=L);if(ae=null,Et)return C;if(it){if(Gt)for(Z=_t.call(f.ownerDocument);f.firstChild;)Z.appendChild(f.firstChild);else Z=f;return j.shadowroot&&(Z=zt.call(t,Z,!0)),Z}var J=He?f.outerHTML:f.innerHTML;return He&&W["!doctype"]&&f.ownerDocument&&f.ownerDocument.doctype&&f.ownerDocument.doctype.name&&ee(Ks,f.ownerDocument.doctype.name)&&(J="<!DOCTYPE "+f.ownerDocument.doctype.name+`>
`+J),tt&&(J=Te(J,Pe," "),J=Te(J,Fe," ")),R&&Yt?R.createHTML(J):J},e.setConfig=function(C){Ii(C),Ti=!0},e.clearConfig=function(){st=null,Ti=!1},e.isValidAttribute=function(C,d,f){st||Ii({});var w=Y(C),L=Y(d);return Ba(w,L,f)},e.addHook=function(C,d){typeof d=="function"&&(ie[C]=ie[C]||[],It(ie[C],d))},e.removeHook=function(C){if(ie[C])return cr(ie[C])},e.removeHooks=function(C){ie[C]&&(ie[C]=[])},e.removeAllHooks=function(){ie={}},e}var Ft=Yr();function Kr(r){switch(r){case"date":return"Published";case"reviewdate":return"Reviewed";case"addeddate":return"Added";default:return"Archived"}}function qr(r){return r?`Archivist since ${r.getFullYear()}`:""}let pe=class extends I{constructor(){super(...arguments),this.sortParam=null,this.collectionLinks=[],this.loggedIn=!1}updated(e){e.has("model")&&this.fetchCollectionNames()}async fetchCollectionNames(){var e,t;if(!(!((e=this.model)===null||e===void 0)&&e.collections)||this.model.collections.length===0||!this.collectionNameCache)return;this.collectionLinks=[];const i=[],a=[];for(const o of this.model.collections)a.push((t=this.collectionNameCache)===null||t===void 0?void 0:t.collectionNameFor(o).then(s=>{i.push(this.detailsLink(o,s!=null?s:o))}));await Promise.all(a),this.collectionLinks=i}render(){return u`
    ...
    `}};n([p({type:Object})],pe.prototype,"model",void 0);n([p({type:String})],pe.prototype,"baseNavigationUrl",void 0);n([p({type:Object})],pe.prototype,"collectionNameCache",void 0);n([p({type:Number})],pe.prototype,"currentWidth",void 0);n([p({type:Number})],pe.prototype,"currentHeight",void 0);n([p({type:Object})],pe.prototype,"sortParam",void 0);n([p({type:Number})],pe.prototype,"mobileBreakpoint",void 0);n([T()],pe.prototype,"collectionLinks",void 0);n([p({type:String})],pe.prototype,"baseImageUrl",void 0);n([p({type:Boolean})],pe.prototype,"loggedIn",void 0);pe=n([H("tile-list")],pe);let we=class extends I{constructor(){super(...arguments),this.sortParam=null,this.loggedIn=!1}render(){var e,t,i,a,o,s,l,c,h,m;return u`
      <div id="list-line" class="${this.classSize}">
        <image-block
          .model=${this.model}
          .baseImageUrl=${this.baseImageUrl}
        ...
        <div id="title">${Ft.sanitize((t=(e=this.model)===null||e===void 0?void 0:e.title)!==null&&t!==void 0?t:"")}</div>
        <div id="creator">
          ${((i=this.model)===null||i===void 0?void 0:i.mediatype)==="account"?qr((a=this.model)===null||a===void 0?void 0:a.dateAdded):Ft.sanitize((s=(o=this.model)===null||o===void 0?void 0:o.creator)!==null&&s!==void 0?s:"")}
        </div>
        ...
        <div id="views">
          ${Pt((m=(h=this.model)===null||h===void 0?void 0:h.viewCount)!==null&&m!==void 0?m:0,this.formatSize)}
        </div>
      </div>
    `}get date(){var e,t,i,a,o;switch((e=this.sortParam)===null||e===void 0?void 0:e.field){case"date":return(t=this.model)===null||t===void 0?void 0:t.datePublished;case"reviewdate":return(i=this.model)===null||i===void 0?void 0:i.dateReviewed;case"addeddate":return(a=this.model)===null||a===void 0?void 0:a.dateAdded;default:return(o=this.model)===null||o===void 0?void 0:o.dateArchived}}get classSize(){return this.mobileBreakpoint&&this.currentWidth&&this.currentWidth<this.mobileBreakpoint?"mobile":"desktop"}get formatSize(){return this.mobileBreakpoint&&this.currentWidth&&this.currentWidth<this.mobileBreakpoint?"short":"long"}static get styles(){return y`
      html {
    ...
    `}};n([p({type:Object})],yt.prototype,"model",void 0);n([p({type:Number})],yt.prototype,"currentWidth",void 0);n([p({type:Object})],yt.prototype,"sortParam",void 0);n([p({type:Number})],yt.prototype,"mobileBreakpoint",void 0);yt=n([H("tile-list-compact-header")],yt);let oe=class extends I{constructor(){super(...arguments),this.sortParam=null,this.loggedIn=!1}render(){return u`
      <div id="container">
    ...
    `}get linkTileTemplate(){var e,t;return u`
      <a
        ...
        title=${Ci((t=this.model)===null||t===void 0?void 0:t.title)}
      >
        ${this.tile}
      </a>
    ...
    `}};mr=n([H("collection-browser-loading-tile")],mr);var M;(function(r){r.relevance="relevance",r.alltimeview="alltimeview",r.weeklyview="weeklyview",r.title="title",r.datearchived="datearchived",r.date="date",r.datereviewed="datereviewed",r.dateadded="dateadded",r.creator="creator"})(M||(M={}));const je={relevance:"Relevance",alltimeview:"All-time Views",weeklyview:"Weekly Views",title:"Title",datearchived:"Date Archived",date:"Date Published",datereviewed:"Date Reviewed",dateadded:"Date Added",creator:"Creator"},Zs={relevance:null,alltimeview:"downloads",weeklyview:"week",title:"titleSorter",datearchived:"publicdate",date:"date",datereviewed:"reviewdate",dateadded:"addeddate",creator:"creatorSorter"},vr={week:M.weeklyview,downloads:M.alltimeview,titleSorter:M.title,date:M.date,publicdate:M.datearchived,reviewdate:M.datereviewed,addeddate:M.dateadded,creatorSorter:M.creator},yi={subject:{},mediatype:{},language:{},creator:{},collection:{},year:{}};let bi=class extends I{constructor(){super(...arguments),this.selectedLetter=null,this.alphabet="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("")}get selectedUppercaseLetter(){var e;return(e=this.selectedLetter)===null||e===void 0?void 0:e.toUpperCase()}render(){return u`
      <div id="container">
        <ul>
  ...
  `;n([p({type:String})],bi.prototype,"selectedLetter",void 0);bi=n([H("alpha-bar")],bi);const fr=O`
...
`;let K=class extends I{constructor(){super(...arguments),this.sortDirection=null,this.selectedSort=M.relevance,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.showRelevance=!0,this.alphaSelectorVisible=null,this.dateSortSelectorVisible=!1,this.viewSortSelectorVisible=!1,this.desktopSelectorBarWidth=0,this.selectorBarContainerWidth=0,this.hoveringOverDateSortOptions=!1,this.boundSortBarSelectorEscapeListener=e=>{e.key==="Escape"&&(this.viewSortSelectorVisible=!1,this.dateSortSelectorVisible=!1)}}render(){return u`
  ...
  `;n([p({type:String})],K.prototype,"displayMode",void 0);n([p({type:String})],K.prototype,"sortDirection",void 0);n([p({type:String})],K.prototype,"selectedSort",void 0);n([p({type:String})],K.prototype,"selectedTitleFilter",void 0);n([p({type:String})],K.prototype,"selectedCreatorFilter",void 0);n([p({type:Boolean})],K.prototype,"showRelevance",void 0);n([p({type:Object})],K.prototype,"resizeObserver",void 0);n([T()],K.prototype,"alphaSelectorVisible",void 0);n([T()],K.prototype,"dateSortSelectorVisible",void 0);n([T()],K.prototype,"viewSortSelectorVisible",void 0);n([T()],K.prototype,"desktopSelectorBarWidth",void 0);n([T()],K.prototype,"selectorBarContainerWidth",void 0);n([T()],K.prototype,"hoveringOverDateSortOptions",void 0);n([ce("#desktop-sort-selector")],K.prototype,"desktopSortSelector",void 0);n([ce("#sort-selector-container")],K.prototype,"sortSelectorContainer",void 0);K=n([H("sort-filter-bar")],K);/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const gr=wa(class extends xa{constructor(r){if(super(r),r.type!==Ae.PROPERTY&&r.type!==Ae.ATTRIBUTE&&r.type!==Ae.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Go(r))throw Error("`live` bindings can only contain a single expression")}render(r){return r}update(r,[e]){if(e===he||e===$)return e;const t=r.element,i=r.name;if(r.type===Ae.PROPERTY){if(e===t[i])return he}else if(r.type===Ae.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(i))return he}else if(r.type===Ae.ATTRIBUTE&&t.getAttribute(i)===e+"")return he;return Wr(r),e}});var Xr=60,Zr=Xr*60,Jr=Zr*24,an=Jr*7,bt=1e3,ea=Xr*bt,yr=Zr*bt,rn=Jr*bt,on=an*bt,Sa="millisecond",dt="second",ht="minute",pt="hour",Me="day",ni="week",me="month",eo="quarter",Ee="year",ut="date",sn="YYYY-MM-DDTHH:mm:ssZ",br="Invalid Date",nn=/^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/,ln=/\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g,cn={name:"en",weekdays:"Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),months:"January_February_March_April_May_June_July_August_September_October_November_December".split("_")},ma=function(e,t,i){var a=String(e);return!a||a.length>=t?e:""+Array(t+1-a.length).join(i)+e},dn=function(e){var t=-e.utcOffset(),i=Math.abs(t),a=Math.floor(i/60),o=i%60;return(t<=0?"+":"-")+ma(a,2,"0")+":"+ma(o,2,"0")},hn=function r(e,t){if(e.date()<t.date())return-r(t,e);var i=(t.year()-e.year())*12+(t.month()-e.month()),a=e.clone().add(i,me),o=t-a<0,s=e.clone().add(i+(o?-1:1),me);return+(-(i+(t-a)/(o?a-s:s-a))||0)},pn=function(e){return e<0?Math.ceil(e)||0:Math.floor(e)},un=function(e){var t={M:me,y:Ee,w:ni,d:Me,D:ut,h:pt,m:ht,s:dt,ms:Sa,Q:eo};return t[e]||String(e||"").toLowerCase().replace(/s$/,"")},mn=function(e){return e===void 0},vn={s:ma,z:dn,m:hn,a:pn,p:un,u:mn},Nt="en",Ye={};Ye[Nt]=cn;var $a=function(e){return e instanceof zi},wi=function r(e,t,i){var a;if(!e)return Nt;if(typeof e=="string"){var o=e.toLowerCase();Ye[o]&&(a=o),t&&(Ye[o]=t,a=o);var s=e.split("-");if(!a&&s.length>1)return r(s[0])}else{var l=e.name;Ye[l]=e,a=l}return!i&&a&&(Nt=a),a||!i&&Nt},G=function(e,t){if($a(e))return e.clone();var i=typeof t=="object"?t:{};return i.date=e,i.args=arguments,new zi(i)},fn=function(e,t){return G(e,{locale:t.$L,utc:t.$u,x:t.$x,$offset:t.$offset})},B=vn;B.l=wi;B.i=$a;B.w=fn;var gn=function(e){var t=e.date,i=e.utc;if(t===null)return new Date(NaN);if(B.u(t))return new Date;if(t instanceof Date)return new Date(t);if(typeof t=="string"&&!/Z$/i.test(t)){var a=t.match(nn);if(a){var o=a[2]-1||0,s=(a[7]||"0").substring(0,3);return i?new Date(Date.UTC(a[1],o,a[3]||1,a[4]||0,a[5]||0,a[6]||0,s)):new Date(a[1],o,a[3]||1,a[4]||0,a[5]||0,a[6]||0,s)}}return new Date(t)},zi=function(){function r(t){this.$L=wi(t.locale,null,!0),this.parse(t)}var e=r.prototype;return e.parse=function(i){this.$d=gn(i),this.$x=i.x||{},this.init()},e.init=function(){var i=this.$d;this.$y=i.getFullYear(),this.$M=i.getMonth(),this.$D=i.getDate(),this.$W=i.getDay(),this.$H=i.getHours(),this.$m=i.getMinutes(),this.$s=i.getSeconds(),this.$ms=i.getMilliseconds()},e.$utils=function(){return B},e.isValid=function(){return this.$d.toString()!==br},e.isSame=function(i,a){var o=G(i);return this.startOf(a)<=o&&o<=this.endOf(a)},e.isAfter=function(i,a){return G(i)<this.startOf(a)},e.isBefore=function(i,a){return this.endOf(a)<G(i)},e.$g=function(i,a,o){return B.u(i)?this[a]:this.set(o,i)},e.unix=function(){return Math.floor(this.valueOf()/1e3)},e.valueOf=function(){return this.$d.getTime()},e.startOf=function(i,a){var o=this,s=B.u(a)?!0:a,l=B.p(i),c=function(E,F){var P=B.w(o.$u?Date.UTC(o.$y,F,E):new Date(o.$y,F,E),o);return s?P:P.endOf(Me)},h=function(E,F){var P=[0,0,0,0],R=[23,59,59,999];return B.w(o.toDate()[E].apply(o.toDate("s"),(s?P:R).slice(F)),o)},m=this.$W,v=this.$M,g=this.$D,b="set"+(this.$u?"UTC":"");switch(l){case Ee:return s?c(1,0):c(31,11);case me:return s?c(1,v):c(0,v+1);case ni:{var S=this.$locale().weekStart||0,z=(m<S?m+7:m)-S;return c(s?g-z:g+(6-z),v)}case Me:case ut:return h(b+"Hours",0);case pt:return h(b+"Minutes",1);case ht:return h(b+"Seconds",2);case dt:return h(b+"Milliseconds",3);default:return this.clone()}},e.endOf=function(i){return this.startOf(i,!1)},e.$set=function(i,a){var o,s=B.p(i),l="set"+(this.$u?"UTC":""),c=(o={},o[Me]=l+"Date",o[ut]=l+"Date",o[me]=l+"Month",o[Ee]=l+"FullYear",o[pt]=l+"Hours",o[ht]=l+"Minutes",o[dt]=l+"Seconds",o[Sa]=l+"Milliseconds",o)[s],h=s===Me?this.$D+(a-this.$W):a;if(s===me||s===Ee){var m=this.clone().set(ut,1);m.$d[c](h),m.init(),this.$d=m.set(ut,Math.min(this.$D,m.daysInMonth())).$d}else c&&this.$d[c](h);return this.init(),this},e.set=function(i,a){return this.clone().$set(i,a)},e.get=function(i){return this[B.p(i)]()},e.add=function(i,a){var o=this,s;i=Number(i);var l=B.p(a),c=function(g){var b=G(o);return B.w(b.date(b.date()+Math.round(g*i)),o)};if(l===me)return this.set(me,this.$M+i);if(l===Ee)return this.set(Ee,this.$y+i);if(l===Me)return c(1);if(l===ni)return c(7);var h=(s={},s[ht]=ea,s[pt]=yr,s[dt]=bt,s)[l]||1,m=this.$d.getTime()+i*h;return B.w(m,this)},e.subtract=function(i,a){return this.add(i*-1,a)},e.format=function(i){var a=this,o=this.$locale();if(!this.isValid())return o.invalidDate||br;var s=i||sn,l=B.z(this),c=this.$H,h=this.$m,m=this.$M,v=o.weekdays,g=o.months,b=o.meridiem,S=function(P,R,q,ne){return P&&(P[R]||P(a,s))||q[R].slice(0,ne)},z=function(P){return B.s(c%12||12,P,"0")},D=b||function(F,P,R){var q=F<12?"AM":"PM";return R?q.toLowerCase():q},E={YY:String(this.$y).slice(-2),YYYY:this.$y,M:m+1,MM:B.s(m+1,2,"0"),MMM:S(o.monthsShort,m,g,3),MMMM:S(g,m),D:this.$D,DD:B.s(this.$D,2,"0"),d:String(this.$W),dd:S(o.weekdaysMin,this.$W,v,2),ddd:S(o.weekdaysShort,this.$W,v,3),dddd:v[this.$W],H:String(c),HH:B.s(c,2,"0"),h:z(1),hh:z(2),a:D(c,h,!0),A:D(c,h,!1),m:String(h),mm:B.s(h,2,"0"),s:String(this.$s),ss:B.s(this.$s,2,"0"),SSS:B.s(this.$ms,3,"0"),Z:l};return s.replace(ln,function(F,P){return P||E[F]||l.replace(":","")})},e.utcOffset=function(){return-Math.round(this.$d.getTimezoneOffset()/15)*15},e.diff=function(i,a,o){var s,l=B.p(a),c=G(i),h=(c.utcOffset()-this.utcOffset())*ea,m=this-c,v=B.m(this,c);return v=(s={},s[Ee]=v/12,s[me]=v,s[eo]=v/3,s[ni]=(m-h)/on,s[Me]=(m-h)/rn,s[pt]=m/yr,s[ht]=m/ea,s[dt]=m/bt,s)[l]||m,o?v:B.a(v)},e.daysInMonth=function(){return this.endOf(me).$D},e.$locale=function(){return Ye[this.$L]},e.locale=function(i,a){if(!i)return this.$L;var o=this.clone(),s=wi(i,a,!0);return s&&(o.$L=s),o},e.clone=function(){return B.w(this.$d,this)},e.toDate=function(){return new Date(this.valueOf())},e.toJSON=function(){return this.isValid()?this.toISOString():null},e.toISOString=function(){return this.$d.toISOString()},e.toString=function(){return this.$d.toUTCString()},r}(),to=zi.prototype;G.prototype=to;[["$ms",Sa],["$s",dt],["$m",ht],["$H",pt],["$W",Me],["$M",me],["$y",Ee],["$D",ut]].forEach(function(r){to[r[1]]=function(e){return this.$g(e,r[0],r[1])}});G.extend=function(r,e){return r.$i||(r(e,zi,G),r.$i=!0),G};G.locale=wi;G.isDayjs=$a;G.unix=function(r){return G(r*1e3)};G.en=Ye[Nt];G.Ls=Ye;G.p={};var yn=function(e){return e.replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g,function(t,i,a){return i||a.slice(1)})},bn={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"},wn=function(e,t){return e.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g,function(i,a,o){var s=o&&o.toUpperCase();return a||t[o]||bn[o]||yn(t[s])})},xn=/(\[[^[]*\])|([-_:/.,()\s]+)|(A|a|YYYY|YY?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g,Sn=/\d/,ti=/\d\d/,$n=/\d{3}/,_n=/\d{4}/,ye=/\d\d?/,Cn=/[+-]?\d+/,zn=/[+-]\d\d:?(\d\d)?|Z/,Rt=/\d*[^-_:/,()\s\d]+/,Le={},io=function(e){return e=+e,e+(e>68?1900:2e3)};function kn(r){if(!r||r==="Z")return 0;var e=r.match(/([+-]|\d\d)/g),t=+(e[1]*60)+(+e[2]||0);return t===0?0:e[0]==="+"?-t:t}var re=function(e){return function(t){this[e]=+t}},wr=[zn,function(r){var e=this.zone||(this.zone={});e.offset=kn(r)}],ta=function(e){var t=Le[e];return t&&(t.indexOf?t:t.s.concat(t.f))},xr=function(e,t){var i,a=Le,o=a.meridiem;if(!o)i=e===(t?"pm":"PM");else for(var s=1;s<=24;s+=1)if(e.indexOf(o(s,0,t))>-1){i=s>12;break}return i},Tn={A:[Rt,function(r){this.afternoon=xr(r,!1)}],a:[Rt,function(r){this.afternoon=xr(r,!0)}],S:[Sn,function(r){this.milliseconds=+r*100}],SS:[ti,function(r){this.milliseconds=+r*10}],SSS:[$n,function(r){this.milliseconds=+r}],s:[ye,re("seconds")],ss:[ye,re("seconds")],m:[ye,re("minutes")],mm:[ye,re("minutes")],H:[ye,re("hours")],h:[ye,re("hours")],HH:[ye,re("hours")],hh:[ye,re("hours")],D:[ye,re("day")],DD:[ti,re("day")],Do:[Rt,function(r){var e=Le,t=e.ordinal,i=r.match(/\d+/);if(this.day=i[0],!!t)for(var a=1;a<=31;a+=1)t(a).replace(/\[|\]/g,"")===r&&(this.day=a)}],M:[ye,re("month")],MM:[ti,re("month")],MMM:[Rt,function(r){var e=ta("months"),t=ta("monthsShort"),i=(t||e.map(function(a){return a.slice(0,3)})).indexOf(r)+1;if(i<1)throw new Error;this.month=i%12||i}],MMMM:[Rt,function(r){var e=ta("months"),t=e.indexOf(r)+1;if(t<1)throw new Error;this.month=t%12||t}],Y:[Cn,re("year")],YY:[ti,function(r){this.year=io(r)}],YYYY:[_n,re("year")],Z:wr,ZZ:wr};function An(r){var e=r.afternoon;if(e!==void 0){var t=r.hours;e?t<12&&(r.hours+=12):t===12&&(r.hours=0),delete r.afternoon}}function Mn(r){r=wn(r,Le&&Le.formats);for(var e=r.match(xn),t=e.length,i=0;i<t;i+=1){var a=e[i],o=Tn[a],s=o&&o[0],l=o&&o[1];l?e[i]={regex:s,parser:l}:e[i]=a.replace(/^\[|\]$/g,"")}return function(c){for(var h={},m=0,v=0;m<t;m+=1){var g=e[m];if(typeof g=="string")v+=g.length;else{var b=g.regex,S=g.parser,z=c.slice(v),D=b.exec(z),E=D[0];S.call(h,E),c=c.replace(E,"")}}return An(h),h}}var En=function(e,t,i){try{if(["x","X"].indexOf(t)>-1)return new Date((t==="X"?1e3:1)*e);var a=Mn(t),o=a(e),s=o.year,l=o.month,c=o.day,h=o.hours,m=o.minutes,v=o.seconds,g=o.milliseconds,b=o.zone,S=new Date,z=c||(!s&&!l?S.getDate():1),D=s||S.getFullYear(),E=0;s&&!l||(E=l>0?l-1:S.getMonth());var F=h||0,P=m||0,R=v||0,q=g||0;return b?new Date(Date.UTC(D,E,z,F,P,R,q+b.offset*60*1e3)):i?new Date(Date.UTC(D,E,z,F,P,R,q)):new Date(D,E,z,F,P,R,q)}catch{return new Date("")}},Dn=function(r,e,t){t.p.customParseFormat=!0,r&&r.parseTwoDigitYear&&(io=r.parseTwoDigitYear);var i=e.prototype,a=i.parse;i.parse=function(o){var s=o.date,l=o.utc,c=o.args;this.$u=l;var h=c[1];if(typeof h=="string"){var m=c[2]===!0,v=c[3]===!0,g=m||v,b=c[2];v&&(b=c[2]),Le=this.$locale(),!m&&b&&(Le=t.Ls[b]),this.$d=En(s,h,l),this.init(),b&&b!==!0&&(this.$L=this.locale(b).$L),g&&s!=this.format(h)&&(this.$d=new Date("")),Le={}}else if(h instanceof Array)for(var S=h.length,z=1;z<=S;z+=1){c[1]=h[z-1];var D=t.apply(this,c);if(D.isValid()){this.$d=D.$d,this.$L=D.$L,this.init();break}z===S&&(this.$d=new Date(""))}else a.call(this,o)}};const On=Object.freeze({processing:"processing",complete:"complete"});class Ln extends I{static get properties(){return{mode:{type:String}}}constructor(){super(),this.mode=On.processing}render(){return u`
      <div class="${this.mode}">
        <svg
          viewBox="0 0 120 120"
    ...
    `,this._tooltipVisible=!0}hideTooltip(){this._tooltipContent=void 0,this._tooltipVisible=!1}validMinSliderX(e){const t=Math.min(this.translateDateToPosition(this.maxSelectedDate),this.histogramRightEdgeX);return e=this.clamp(e,this.histogramLeftEdgeX,t),Number.isNaN(e)||t<this.histogramLeftEdgeX?this.histogramLeftEdgeX:e}validMaxSliderX(e){const t=Math.max(this.histogramLeftEdgeX,this.translateDateToPosition(this.minSelectedDate));return e=this.clamp(e,t,this.histogramRightEdgeX),Number.isNaN(e)||t>this.histogramRightEdgeX?this.histogramRightEdgeX:e}addListeners(){window.addEventListener("pointermove",this.move),window.addEventListener("pointerup",this.drop),window.addEventListener("pointercancel",this.drop)}removeListeners(){window.removeEventListener("pointermove",this.move),window.removeEventListener("pointerup",this.drop),window.removeEventListener("pointercancel",this.drop)}beginEmitUpdateProcess(){this.cancelPendingUpdateEvent(),this._emitUpdatedEventTimer=setTimeout(()=>{if(this.currentDateRangeString===this._previousDateRange)return;this._previousDateRange=this.currentDateRangeString;const e={detail:{minDate:this.minSelectedDate,maxDate:this.maxSelectedDate},bubbles:!0,composed:!0};this.dispatchEvent(new CustomEvent("histogramDateRangeUpdated",e))},this.updateDelay)}cancelPendingUpdateEvent(){this._emitUpdatedEventTimer!==void 0&&(clearTimeout(this._emitUpdatedEventTimer),this._emitUpdatedEventTimer=void 0)}setDragOffset(e){this._currentSlider=e.currentTarget;const t=this._currentSlider.id==="slider-min"?this.minSliderX:this.maxSliderX;this._dragOffset=e.offsetX-t,(this._dragOffset>this.sliderWidth||this._dragOffset<-this.sliderWidth)&&(this._dragOffset=0)}translatePositionToDate(e){const t=Math.ceil((e-this.sliderWidth)*this.dateRangeMS/this._histWidth);return this.formatDate(this._minDateMS+t)}translateDateToPosition(e){const t=this.getMSFromString(e);return this.sliderWidth+(t-this._minDateMS)*this._histWidth/this.dateRangeMS}clamp(e,t,i){return Math.min(Math.max(e,t),i)}handleMinDateInput(e){const t=e.currentTarget;this.minSelectedDate=t.value,this.beginEmitUpdateProcess()}handleMaxDateInput(e){const t=e.currentTarget;this.maxSelectedDate=t.value,this.beginEmitUpdateProcess()}handleKeyUp(e){if(e.key==="Enter"){const t=e.currentTarget;t.blur(),t.id==="date-min"?this.handleMinDateInput(e):t.id==="date-max"&&this.handleMaxDateInput(e)}}get currentDateRangeString(){return`${this.minSelectedDate}:${this.maxSelectedDate}`}getMSFromString(e){const t=typeof e=="string"?e:String(e);if((t.split(/(\d+)/).length-1)/2===1){const a=new Date(0,0);return a.setFullYear(Number(t)),a.getTime()}return G(t,[this.dateFormat,Sr]).valueOf()}handleBarClick(e){const t=e.currentTarget.dataset,i=(this.getMSFromString(t.binStart)+this.getMSFromString(t.binEnd))/2,a=Math.abs(i-this.getMSFromString(this.minSelectedDate)),o=Math.abs(i-this.getMSFromString(this.maxSelectedDate));a<o?this.minSelectedDate=t.binStart:this.maxSelectedDate=t.binEnd,this.beginEmitUpdateProcess()}get minSliderTemplate(){const e=$r,t=`
            ...
            q0,${e} ${e},${e}
            h${this.sliderWidth-e}
          `;return this.generateSliderSVG(this.minSliderX,"slider-min",t)}get maxSliderTemplate(){const e=$r,t=`
            M${this.maxSliderX},0
            h${this.sliderWidth-e}
            q${e},0 ${e},${e}
            v${this.height-e*2}
    ...
    `}get selectedRangeTemplate(){return O`
      ...
      />`}get histogramTemplate(){const e=this._histWidth/this._numBins,t=e-1;let i=this.sliderWidth;return this._histData.map(a=>{const o=O`
        <rect
          ...
          fill="${i+t>=this.minSliderX&&i<=this.maxSliderX?Wn:Qn}"
...
`,ao=O`<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><path d="m79.8883285 50.0035012.1116715-.1085359-43.1159942-46.61088155c-2.401537-2.18938917-4.6902018-3.28408375-6.8659943-3.28408375s-4.1642651.63837733-5.9654178 1.91513199c-1.8011528 1.27675467-3.1520173 2.97248092-4.0525937 5.08717877l39.4020173 42.99768924-39.4020173 42.9976892c.9005764 2.1146979 2.2514409 3.8104241 4.0525937 5.0871788 1.8011527 1.2767547 3.7896253 1.915132 5.9654178 1.915132 2.1013449 0 4.3900096-1.0573489 6.8659943-3.1720468l43.1159942-46.7194174z"/></svg>
`;const tl=["mediatype","year","subject","collection","creator","language"],il={subjectSorter:"subject",mediatypeSorter:"mediatype",languageSorter:"language",creatorSorter:"creator",collection:"collection",year:"year"},Tr={subject:"Subject",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"};let se=class extends I{constructor(){super(...arguments),this.facetsLoading=!1,this.fullYearAggregationLoading=!1,this.collapsableFacets=!1,this.showHistogramDatePicker=!1,this.openFacets={subject:!1,mediatype:!1,language:!1,creator:!1,collection:!1,year:!1}}render(){return u`
    ...
    `}updated(e){e.has("selectedFacets")&&this.dispatchFacetsChangedEvent()}dispatchFacetsChangedEvent(){var e;const t=new CustomEvent("facetsChanged",{detail:this.selectedFacets});this.dispatchEvent(t),(e=this.analyticsHandler)===null||e===void 0||e.sendEvent({category:"collection-browser",action:"facetsChanged"})}get currentYearsHistogramAggregation(){var e;return(e=this.aggregations)===null||e===void 0?void 0:e.year_histogram}get histogramTemplate(){const{fullYearsHistogramAggregation:e}=this;return u`
      ...
      ></histogram-date-range>
    `}histogramDateRangeUpdated(e){const{minDate:t,maxDate:i}=e.detail,a=new CustomEvent("histogramDateRangeUpdated",{detail:{minDate:t,maxDate:i}});this.dispatchEvent(a)}get mergedFacets(){const e=[];return tl.forEach(t=>{var i;const a=this.selectedFacetGroups.find(c=>c.key===t),o=this.aggregationFacetGroups.find(c=>c.key===t);if(a&&!o){e.push(a);return}if(!o)return;const s=a!=null?a:o,l=(i=a==null?void 0:a.buckets.map(c=>{const h=o.buckets.find(m=>m.key===c.key);return h?{...c,count:h.count}:c}))!==null&&i!==void 0?i:[];o.buckets.forEach(c=>{l.find(m=>m.key===c.key)||l.push(c)}),s.buckets=l.splice(0,5),e.push(s)}),e}get selectedFacetGroups(){return this.selectedFacets?Object.entries(this.selectedFacets).map(([t,i])=>{const a=t,o=Tr[a],s=Object.entries(i).map(([l,c])=>{var h,m;let v=l;return a==="language"&&(v=(m=(h=this.languageCodeHandler)===null||h===void 0?void 0:h.getLanguageNameFromCodeString(l))!==null&&m!==void 0?m:l),{displayText:v,key:l,count:0,state:c}});return{title:o,key:a,buckets:s}}):[]}get aggregationFacetGroups(){var e;const t=[];return Object.entries((e=this.aggregations)!==null&&e!==void 0?e:[]).forEach(([i,a])=>{if(i==="year_histogram")return;const o=this.getFacetOptionFromKey(i),s=Tr[o],c=a.buckets.map(m=>{var v,g;let b=m.key;return o==="language"&&(b=(g=(v=this.languageCodeHandler)===null||v===void 0?void 0:v.getCodeStringFromLanguageName(`${m.key}`))!==null&&g!==void 0?g:m.key),{displayText:`${m.key}`,key:`${b}`,count:m.doc_count,state:"none"}}),h={title:s,key:o,buckets:c};t.push(h)}),t}getFacetGroupTemplate(e){if(e.buckets.length===0)return $;const{key:t}=e,i=this.openFacets[t],a=u`
      <span class="collapser ${i?"open":""}"> ${ao} </span>
    `;return u`
      <div class="facet-group ${this.collapsableFacets?"mobile":""}">
        <h1
          @click=${()=>{const o={...this.openFacets};o[t]=!i,this.openFacets=o}}
          @keyup=${()=>{const o={...this.openFacets};o[t]=!i,this.openFacets=o}}
        >
    ...
    `}getFacetTemplate(e){const i=e.buckets.filter(a=>a.key.startsWith("fav-")===!1).slice(0,6);return u`
      <ul class="facet-list">
        ${jr(i,a=>`${e.key}:${a.key}`,a=>{var o,s;const l=`${e.key}:${a.key}-show-only`,c=`${e.key}:${a.key}-negative`,h=e.key!=="collection"?u`${(o=a.displayText)!==null&&o!==void 0?o:a.key}`:u`
                    <async-collection-name
                      .collectionNameCache=${this.collectionNameCache}
                      .identifier=${a.key}
                      placeholder="-"
                    ></async-collection-name>
                  `,m=a.state==="hidden",v=a.state==="selected",g=`${e.key}: ${(s=a.displayText)!==null&&s!==void 0?s:a.key}`,b=v?`Show all ${e.key}s`:`Only show ${g}`,S=`Hide ${g}`,z=`Unhide ${g}`,D=m?z:S;return u`
              <li>
                <div class="facet-row">
                  <div class="facet-checkbox">
                    <input
                      ...
                      .name=${e.key}
                      .value=${a.key}
                      @click=${E=>{this.facetClicked(E,a,!1)}}
                      .checked=${v}
                    ...
                    <input
                      ...
                      .name=${e.key}
                      .value=${a.key}
                      @click=${E=>{this.facetClicked(E,a,!0)}}
                      .checked=${m}
    ...
    `}facetClicked(e,t,i){const a=e.target,{checked:o,name:s,value:l}=a;o?this.facetChecked(s,l,i):this.facetUnchecked(s,l)}facetChecked(e,t,i){const{selectedFacets:a}=this;let o;a?o={...a}:o=yi,o[e][t]=i?"hidden":"selected",this.selectedFacets=o}facetUnchecked(e,t){const{selectedFacets:i}=this;let a;i?a={...i}:a=yi,delete a[e][t],this.selectedFacets=a}getFacetOptionFromKey(e){const a=e.split("__")[2].split(":")[1],o=Object.entries(il).find(([l])=>a.includes(l)),s=o==null?void 0:o[1];if(!s)throw new Error(`Could not find facet option for key: ${e}`);return s}static get styles(){return y`
      #container.loading {
        opacity: 0.5;
      }
    ...
    `}};n([p({type:Object})],se.prototype,"aggregations",void 0);n([p({type:Object})],se.prototype,"fullYearsHistogramAggregation",void 0);n([p({type:String})],se.prototype,"minSelectedDate",void 0);n([p({type:String})],se.prototype,"maxSelectedDate",void 0);n([p({type:Boolean})],se.prototype,"facetsLoading",void 0);n([p({type:Boolean})],se.prototype,"fullYearAggregationLoading",void 0);n([p({type:Object})],se.prototype,"selectedFacets",void 0);n([p({type:Boolean})],se.prototype,"collapsableFacets",void 0);n([p({type:Boolean})],se.prototype,"showHistogramDatePicker",void 0);n([p({type:Object})],se.prototype,"languageCodeHandler",void 0);n([p({type:Object})],se.prototype,"collectionNameCache",void 0);n([T()],se.prototype,"openFacets",void 0);se=n([H("collection-facets")],se);let Ar=class extends I{render(){return u`
      <div class="lds-ring">
        <div></div>
        <div></div>
        <div></div>
...
`;let Si=class extends I{constructor(){super(...arguments),this.placeholderType=null}render(){return this.placeholderType?u`${this.placeholderTemplate}`:$}get placeholderTemplate(){return u`
      ...
      >
        ${ll(this.placeholderType,[["empty-query",()=>this.emptyQueryTemplate],["null-result",()=>this.nullResultTemplate]])}
      </div>
    ...
    ></sort-filter-bar>`}userChangedSort(e){var t;const{selectedSort:i,sortDirection:a}=e.detail;this.selectedSort=i,this.sortDirection=a,((t=this.currentPage)!==null&&t!==void 0?t:1)>1&&this.goToPage(1),this.currentPage=1}selectedSortChanged(){var e;if(this.selectedSort==="relevance"||this.sortDirection===null){this.sortParam=null;return}const t=Zs[this.selectedSort];!t||(this.sortParam={field:t,direction:this.sortDirection},(e=this.analyticsHandler)===null||e===void 0||e.sendEvent({category:"collection-browser",action:`selectedSortChanged - sortParam: ${this.sortParam}`}))}displayModeChanged(e){var t;this.displayMode=e.detail.displayMode,(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:"collection-browser",action:`change viewMode: ${this.displayMode}`})}selectedTitleLetterChanged(){var e;this.titleQuery=this.selectedTitleFilter?`firstTitle:${this.selectedTitleFilter}`:void 0,(e=this.analyticsHandler)===null||e===void 0||e.sendEvent({category:"collection-browser",action:`selectedTitleLetterChanged: ${this.titleQuery}`})}selectedCreatorLetterChanged(){var e;this.creatorQuery=this.selectedCreatorFilter?`firstCreator:${this.selectedCreatorFilter}`:void 0,(e=this.analyticsHandler)===null||e===void 0||e.sendEvent({category:"collection-browser",action:`selectedCreatorLetterChanged: ${this.creatorQuery}`})}titleLetterSelected(e){this.selectedCreatorFilter=null,this.selectedTitleFilter=e.detail.selectedLetter}creatorLetterSelected(e){this.selectedTitleFilter=null,this.selectedCreatorFilter=e.detail.selectedLetter}get facetDataLoading(){return this.facetsLoading||this.fullYearAggregationLoading}get mobileFacetsTemplate(){return u`
  ...
  `;n([T()],le.prototype,"currentPage",void 0);n([T()],le.prototype,"searchQuery",void 0);n([T()],le.prototype,"cellWidth",void 0);n([T()],le.prototype,"cellHeight",void 0);n([T()],le.prototype,"rowGap",void 0);n([T()],le.prototype,"colGap",void 0);n([T()],le.prototype,"loggedIn",void 0);n([ce("#base-query-field")],le.prototype,"baseQueryField",void 0);n([ce("#page-number-input")],le.prototype,"pageNumberInput",void 0);n([ce("collection-browser")],le.prototype,"collectionBrowser",void 0);le=n([H("app-root")],le);
