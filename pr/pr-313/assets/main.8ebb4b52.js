 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Pl=(r,...e)=>({strTag:!0,strings:r,values:e}),lt=Pl,Ll=r=>typeof r!="string"&&"strTag"in r,Dl=(r,e,t)=>{let i=r[0];for(let o=1;o<r.length;o++)i+=e[t?t[o-1]:o-1],i+=r[o];return i};/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`,Le;let ke=Le=class extends F{constructor(){super(...arguments),this.placeholderType=null,this.detailMessage=""}render(){return this.placeholderType?c`${this.placeholderTemplate}`:y}get placeholderTemplate(){return c`
    ...
    <a href="mailto:info@archive.org">info@archive.org</a>.`);ke.QUERY_ERROR_DETAILS_MESSAGE=A("Error details:");l([h({type:String})],ke.prototype,"placeholderType",void 0);l([h({type:Boolean})],ke.prototype,"isMobileView",void 0);l([h({type:Boolean})],ke.prototype,"isCollection",void 0);l([h({type:String})],ke.prototype,"detailMessage",void 0);ke=Le=l([B("empty-placeholder")],ke);/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;var Go;(function(r){r[r.bytes=0]="bytes",r[r.kilobytes=1]="kilobytes",r[r.megabytes=2]="megabytes",r[r.gigabytes=3]="gigabytes",r[r.terabytes=4]="terabytes",r[r.petabytes=5]="petabytes",r[r.exabytes=6]="exabytes",r[r.zettabytes=7]="zettabytes",r[r.yottabytes=8]="yottabytes"})(Go||(Go={}));function an(r,e,t=" "){let i=r;if(i===void 0)return y;let o=0;for(;i>1024;)i/=1024,o+=1;const a=10**e;i=Math.round(i*a)/a;let s=Go[o];return s=i===1?s.slice(0,-1):s,`${i.toLocaleString()+t+s}`}const sn=f`var(--tileBackgroundColor, #ffffff)`,ln=f`var(--tileCornerRadius, 4px)`,Ki=f`
...
`;let ci=class extends F{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1,this.isCompactTile=!1}render(){return c`<div class="icon-overlay ${this.getClass}">
      ${this.iconDisplay}
    </div>`}get getClass(){return this.isCompactTile?"list-compact":"list-detail"}get iconDisplay(){return this.loginRequired&&!this.loggedIn?c`${ks}`:c`${Cs}`}static get styles(){return f`
      :host {
        position: absolute;
        top: 50%;
        left: 50%;
    ...
    `}get iconDisplay(){return this.loginRequired&&!this.loggedIn?c`${ks}`:c`${Cs}`}get textDisplay(){return this.loginRequired&&!this.loggedIn?c`Log in to view this item`:c`Content may be inappropriate`}static get styles(){return f`
      :host {
        align-items: center;
        display: flex;
      }
    ...
    >`}get getSizeTemplate(){var e,t;const i=(t=(e=this.model)===null||e===void 0?void 0:e.collectionSize)!==null&&t!==void 0?t:0;return i?c`<span id="item-size">${an(i,1)}</span>`:""}get infoButtonTemplate(){return this.showInfoButton?c`<button class="info-button" @click=${this.infoButtonPressed}>
        ...
        </button>`:y}infoButtonPressed(e){e.preventDefault();const t=new CustomEvent("infoButtonPressed",{detail:{x:e.clientX,y:e.clientY}});this.dispatchEvent(t)}static get styles(){const e=f`var(--tileBorderColor, #555555)`,t=f`var(--tileBackgroundColor, #666666)`,i=f`#fff`;return[Ki,f`
        .container {
          background-color: ${t};
          border: 1px solid ${e};
        }
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*Pi(r,e){const t=typeof e=="function";if(r!==void 0){let i=-1;for(const o of r)i>-1&&(yield t?e(i):e),i++,yield o}}let Hi=class extends F{constructor(){super(...arguments),this.snippets=[],this.viewSize="desktop"}render(){var e;return!((e=this.snippets)===null||e===void 0)&&e.length?c`
      <div class="container">
        <div class="snippet-view ${this.viewSize}">
    ...
    `}};l([h({type:Array})],Hi.prototype,"snippets",void 0);l([h({type:String})],Hi.prototype,"viewSize",void 0);Hi=l([B("text-snippet-block")],Hi);const cn=f`
  .drop-shadow {
    overflow: hidden;
    height: 100%;
  }
...
`;function Tn(r,e){let t=1;return r>=1e9?t=1e9:r>=1e6?t=1e6:r>=1e3&&e==="short"&&(t=1e3),t}function En(r=0,e){const t=r/e,i=t<10;let o=0;return i?o=Math.round((t+Number.EPSILON)*10)/10:o=Math.round(t),o}function Mn(r,e,t,i){switch(e){case 1e9:return A(t==="short"?lt`${r}B`:lt`${r} billion`);case 1e6:return A(t==="short"?lt`${r}M`:lt`${r} million`);case 1e3:return A(t==="short"?lt`${r}K`:lt`${r} thousand`);default:return new Intl.NumberFormat(i).format(r)}}function ai(r,e="long",t="short",i="en-US"){const o=r!=null?r:-1;if(o<0)return"";const a=Tn(o,e),s=En(o,a);return Mn(s,a,t,i)}let Ke=class extends F{render(){var e,t,i,o,a;const s=ai(this.favCount,"short","short"),n=ai(this.commentCount,"short","short"),d=this.mediatype==="account"?`${(e=this.itemCount)!==null&&e!==void 0?e:0} uploads`:`${(t=this.viewCount)!==null&&t!==void 0?t:0} ${(i=this.viewLabel)!==null&&i!==void 0?i:"all-time views"}`;return c`
    ...
    `}get isSortedByDate(){var e;return["date","reviewdate","addeddate","publicdate"].includes((e=this.sortParam)===null||e===void 0?void 0:e.field)}get hasSnippets(){var e,t;return!!(!((t=(e=this.model)===null||e===void 0?void 0:e.snippets)===null||t===void 0)&&t.length)}infoButtonPressed(e){e.preventDefault();const t=new CustomEvent("infoButtonPressed",{detail:{x:e.clientX,y:e.clientY}});this.dispatchEvent(t)}static get styles(){const e=f`var(--tileBorderColor, #dddddd)`;return[Ki,f`
        a:link {
          text-decoration: none;
          color: var(--ia-theme-link-color, #4b64ff);
        }
    ...
    >
          ...
          &#9432;
          <span class="sr-only">${A("More info")}</span>
        </button>`:y}infoButtonPressed(e){e.preventDefault();const t=new CustomEvent("infoButtonPressed",{detail:{x:e.clientX,y:e.clientY}});this.dispatchEvent(t)}static get styles(){const e=f`var(--tileBorderColor, #dddddd)`;return[Ki,f`
        .container {
          border: 1px solid ${e};
        }
    ...
    `}get getTitleTemplate(){var e;return c`<div id="title">
      <h4 class="truncated">${(e=this.model)===null||e===void 0?void 0:e.title}</h4>
    </div>`}static get styles(){const e=f`var(--tileBorderColor, #555555)`,t=f`var(--tileBackgroundColor, #666666)`,i=f`#fff`;return[Ki,f`
        .container {
          background-color: ${t};
          border: 1px solid ${e};
        }
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class Xo extends yi{constructor(e){if(super(e),this.it=y,e.type!==De.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===y||e==null)return this.ft=void 0,this.it=e;if(e===Ce)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this.ft;this.it=e;const t=[e];return t.raw=t,this.ft={_$litType$:this.constructor.resultType,strings:t,values:[]}}}Xo.directiveName="unsafeHTML",Xo.resultType=1;const zn=bi(Xo);/*! @license DOMPurify 3.0.9 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/3.0.9/LICENSE */const{entries:Ms,setPrototypeOf:va,isFrozen:An,getPrototypeOf:Pn,getOwnPropertyDescriptor:Ln}=Object;let{freeze:me,seal:ze,create:zs}=Object,{apply:Zo,construct:Jo}=typeof Reflect!="undefined"&&Reflect;me||(me=function(e){return e});ze||(ze=function(e){return e});Zo||(Zo=function(e,t,i){return e.apply(t,i)});Jo||(Jo=function(e,t){return new e(...t)});const Ti=Te(Array.prototype.forEach),fa=Te(Array.prototype.pop),Jt=Te(Array.prototype.push),Li=Te(String.prototype.toLowerCase),go=Te(String.prototype.toString),Dn=Te(String.prototype.match),ei=Te(String.prototype.replace),Bn=Te(String.prototype.indexOf),Rn=Te(String.prototype.trim),Me=Te(Object.prototype.hasOwnProperty),Se=Te(RegExp.prototype.test),ti=On(TypeError);function Te(r){return function(e){for(var t=arguments.length,i=new Array(t>1?t-1:0),o=1;o<t;o++)i[o-1]=arguments[o];return Zo(r,e,i)}}function On(r){return function(){for(var e=arguments.length,t=new Array(e),i=0;i<e;i++)t[i]=arguments[i];return Jo(r,t)}}function O(r,e){let t=arguments.length>2&&arguments[2]!==void 0?arguments[2]:Li;va&&va(r,null);let i=e.length;for(;i--;){let o=e[i];if(typeof o=="string"){const a=t(o);a!==o&&(An(e)||(e[i]=a),o=a)}r[o]=!0}return r}function Fn(r){for(let e=0;e<r.length;e++)Me(r,e)||(r[e]=null);return r}function nt(r){const e=zs(null);for(const[t,i]of Ms(r))Me(r,t)&&(Array.isArray(i)?e[t]=Fn(i):i&&typeof i=="object"&&i.constructor===Object?e[t]=nt(i):e[t]=i);return e}function Ei(r,e){for(;r!==null;){const i=Ln(r,e);if(i){if(i.get)return Te(i.get);if(typeof i.value=="function")return Te(i.value)}r=Pn(r)}function t(){return null}return t}const ma=me(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","section","select","shadow","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),bo=me(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","filter","font","g","glyph","glyphref","hkern","image","line","lineargradient","marker","mask","metadata","mpath","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),yo=me(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feDropShadow","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),In=me(["animate","color-profile","cursor","discard","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),wo=me(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover","mprescripts"]),Nn=me(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),ga=me(["#text"]),ba=me(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","face","for","headers","height","hidden","high","href","hreflang","id","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","pattern","placeholder","playsinline","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","xmlns","slot"]),xo=me(["accent-height","accumulate","additive","alignment-baseline","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),ya=me(["accent","accentunder","align","bevelled","close","columnsalign","columnlines","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lspace","lquote","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),Mi=me(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),Un=ze(/\{\{[\w\W]*|[\w\W]*\}\}/gm),Hn=ze(/<%[\w\W]*|[\w\W]*%>/gm),Vn=ze(/\${[\w\W]*}/gm),Wn=ze(/^data-[\-\w.\u00B7-\uFFFF]/),jn=ze(/^aria-[\-\w]+$/),As=ze(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),Gn=ze(/^(?:\w+script|data):/i),qn=ze(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),Ps=ze(/^html$/i);var wa=Object.freeze({__proto__:null,MUSTACHE_EXPR:Un,ERB_EXPR:Hn,TMPLIT_EXPR:Vn,DATA_ATTR:Wn,ARIA_ATTR:jn,IS_ALLOWED_URI:As,IS_SCRIPT_OR_DATA:Gn,ATTR_WHITESPACE:qn,DOCTYPE_NAME:Ps});const Qn=function(){return typeof window=="undefined"?null:window},Kn=function(e,t){if(typeof e!="object"||typeof e.createPolicy!="function")return null;let i=null;const o="data-tt-policy-suffix";t&&t.hasAttribute(o)&&(i=t.getAttribute(o));const a="dompurify"+(i?"#"+i:"");try{return e.createPolicy(a,{createHTML(s){return s},createScriptURL(s){return s}})}catch{return console.warn("TrustedTypes policy "+a+" could not be created."),null}};function Ls(){let r=arguments.length>0&&arguments[0]!==void 0?arguments[0]:Qn();const e=M=>Ls(M);if(e.version="3.0.9",e.removed=[],!r||!r.document||r.document.nodeType!==9)return e.isSupported=!1,e;let{document:t}=r;const i=t,o=i.currentScript,{DocumentFragment:a,HTMLTemplateElement:s,Node:n,Element:d,NodeFilter:p,NamedNodeMap:u=r.NamedNodeMap||r.MozNamedAttrMap,HTMLFormElement:m,DOMParser:g,trustedTypes:w}=r,_=d.prototype,S=Ei(_,"cloneNode"),L=Ei(_,"nextSibling"),U=Ei(_,"childNodes"),D=Ei(_,"parentNode");if(typeof s=="function"){const M=t.createElement("template");M.content&&M.content.ownerDocument&&(t=M.content.ownerDocument)}let P,N="";const{implementation:Y,createNodeIterator:le,createDocumentFragment:fe,getElementsByTagName:V}=t,{importNode:$e}=i;let be={};e.isSupported=typeof Ms=="function"&&typeof D=="function"&&Y&&Y.createHTMLDocument!==void 0;const{MUSTACHE_EXPR:Ze,ERB_EXPR:Je,TMPLIT_EXPR:et,DATA_ATTR:Vt,ARIA_ATTR:Wt,IS_SCRIPT_OR_DATA:jt,ATTR_WHITESPACE:ut}=wa;let{IS_ALLOWED_URI:vt}=wa,X=null;const ft=O({},[...ma,...bo,...yo,...wo,...ga]);let Z=null;const Gt=O({},[...ba,...xo,...ya,...Mi]);let ie=Object.seal(zs(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),qt=null,Xi=null,$r=!0,Zi=!0,Sr=!1,Cr=!0,mt=!1,tt=!1,Ji=!1,eo=!1,gt=!1,xi=!1,_i=!1,kr=!0,Tr=!1;const Gs="user-content-";let to=!0,Qt=!1,bt={},yt=null;const Er=O({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","style","svg","template","thead","title","video","xmp"]);let Mr=null;const zr=O({},["audio","video","img","source","image","track"]);let io=null;const Ar=O({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),$i="http://www.w3.org/1998/Math/MathML",Si="http://www.w3.org/2000/svg",Ie="http://www.w3.org/1999/xhtml";let wt=Ie,oo=!1,ro=null;const qs=O({},[$i,Si,Ie],go);let Kt=null;const Qs=["application/xhtml+xml","text/html"],Ks="text/html";let ce=null,xt=null;const Ys=t.createElement("form"),Pr=function(v){return v instanceof RegExp||v instanceof Function},ao=function(){let v=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if(!(xt&&xt===v)){if((!v||typeof v!="object")&&(v={}),v=nt(v),Kt=Qs.indexOf(v.PARSER_MEDIA_TYPE)===-1?Ks:v.PARSER_MEDIA_TYPE,ce=Kt==="application/xhtml+xml"?go:Li,X=Me(v,"ALLOWED_TAGS")?O({},v.ALLOWED_TAGS,ce):ft,Z=Me(v,"ALLOWED_ATTR")?O({},v.ALLOWED_ATTR,ce):Gt,ro=Me(v,"ALLOWED_NAMESPACES")?O({},v.ALLOWED_NAMESPACES,go):qs,io=Me(v,"ADD_URI_SAFE_ATTR")?O(nt(Ar),v.ADD_URI_SAFE_ATTR,ce):Ar,Mr=Me(v,"ADD_DATA_URI_TAGS")?O(nt(zr),v.ADD_DATA_URI_TAGS,ce):zr,yt=Me(v,"FORBID_CONTENTS")?O({},v.FORBID_CONTENTS,ce):Er,qt=Me(v,"FORBID_TAGS")?O({},v.FORBID_TAGS,ce):{},Xi=Me(v,"FORBID_ATTR")?O({},v.FORBID_ATTR,ce):{},bt=Me(v,"USE_PROFILES")?v.USE_PROFILES:!1,$r=v.ALLOW_ARIA_ATTR!==!1,Zi=v.ALLOW_DATA_ATTR!==!1,Sr=v.ALLOW_UNKNOWN_PROTOCOLS||!1,Cr=v.ALLOW_SELF_CLOSE_IN_ATTR!==!1,mt=v.SAFE_FOR_TEMPLATES||!1,tt=v.WHOLE_DOCUMENT||!1,gt=v.RETURN_DOM||!1,xi=v.RETURN_DOM_FRAGMENT||!1,_i=v.RETURN_TRUSTED_TYPE||!1,eo=v.FORCE_BODY||!1,kr=v.SANITIZE_DOM!==!1,Tr=v.SANITIZE_NAMED_PROPS||!1,to=v.KEEP_CONTENT!==!1,Qt=v.IN_PLACE||!1,vt=v.ALLOWED_URI_REGEXP||As,wt=v.NAMESPACE||Ie,ie=v.CUSTOM_ELEMENT_HANDLING||{},v.CUSTOM_ELEMENT_HANDLING&&Pr(v.CUSTOM_ELEMENT_HANDLING.tagNameCheck)&&(ie.tagNameCheck=v.CUSTOM_ELEMENT_HANDLING.tagNameCheck),v.CUSTOM_ELEMENT_HANDLING&&Pr(v.CUSTOM_ELEMENT_HANDLING.attributeNameCheck)&&(ie.attributeNameCheck=v.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),v.CUSTOM_ELEMENT_HANDLING&&typeof v.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements=="boolean"&&(ie.allowCustomizedBuiltInElements=v.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements),mt&&(Zi=!1),xi&&(gt=!0),bt&&(X=O({},ga),Z=[],bt.html===!0&&(O(X,ma),O(Z,ba)),bt.svg===!0&&(O(X,bo),O(Z,xo),O(Z,Mi)),bt.svgFilters===!0&&(O(X,yo),O(Z,xo),O(Z,Mi)),bt.mathMl===!0&&(O(X,wo),O(Z,ya),O(Z,Mi))),v.ADD_TAGS&&(X===ft&&(X=nt(X)),O(X,v.ADD_TAGS,ce)),v.ADD_ATTR&&(Z===Gt&&(Z=nt(Z)),O(Z,v.ADD_ATTR,ce)),v.ADD_URI_SAFE_ATTR&&O(io,v.ADD_URI_SAFE_ATTR,ce),v.FORBID_CONTENTS&&(yt===Er&&(yt=nt(yt)),O(yt,v.FORBID_CONTENTS,ce)),to&&(X["#text"]=!0),tt&&O(X,["html","head","body"]),X.table&&(O(X,["tbody"]),delete qt.tbody),v.TRUSTED_TYPES_POLICY){if(typeof v.TRUSTED_TYPES_POLICY.createHTML!="function")throw ti('TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.');if(typeof v.TRUSTED_TYPES_POLICY.createScriptURL!="function")throw ti('TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.');P=v.TRUSTED_TYPES_POLICY,N=P.createHTML("")}else P===void 0&&(P=Kn(w,o)),P!==null&&typeof N=="string"&&(N=P.createHTML(""));me&&me(v),xt=v}},Lr=O({},["mi","mo","mn","ms","mtext"]),Dr=O({},["foreignobject","desc","title","annotation-xml"]),Xs=O({},["title","style","font","a","script"]),Br=O({},[...bo,...yo,...In]),Rr=O({},[...wo,...Nn]),Zs=function(v){let x=D(v);(!x||!x.tagName)&&(x={namespaceURI:wt,tagName:"template"});const C=Li(v.tagName),j=Li(x.tagName);return ro[v.namespaceURI]?v.namespaceURI===Si?x.namespaceURI===Ie?C==="svg":x.namespaceURI===$i?C==="svg"&&(j==="annotation-xml"||Lr[j]):Boolean(Br[C]):v.namespaceURI===$i?x.namespaceURI===Ie?C==="math":x.namespaceURI===Si?C==="math"&&Dr[j]:Boolean(Rr[C]):v.namespaceURI===Ie?x.namespaceURI===Si&&!Dr[j]||x.namespaceURI===$i&&!Lr[j]?!1:!Rr[C]&&(Xs[C]||!Br[C]):!!(Kt==="application/xhtml+xml"&&ro[v.namespaceURI]):!1},it=function(v){Jt(e.removed,{element:v});try{v.parentNode.removeChild(v)}catch{v.remove()}},so=function(v,x){try{Jt(e.removed,{attribute:x.getAttributeNode(v),from:x})}catch{Jt(e.removed,{attribute:null,from:x})}if(x.removeAttribute(v),v==="is"&&!Z[v])if(gt||xi)try{it(x)}catch{}else try{x.setAttribute(v,"")}catch{}},Or=function(v){let x=null,C=null;if(eo)v="<remove></remove>"+v;else{const ue=Dn(v,/^[\r\n\t ]+/);C=ue&&ue[0]}Kt==="application/xhtml+xml"&&wt===Ie&&(v='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+v+"</body></html>");const j=P?P.createHTML(v):v;if(wt===Ie)try{x=new g().parseFromString(j,Kt)}catch{}if(!x||!x.documentElement){x=Y.createDocument(wt,"template",null);try{x.documentElement.innerHTML=oo?N:j}catch{}}const pe=x.body||x.documentElement;return v&&C&&pe.insertBefore(t.createTextNode(C),pe.childNodes[0]||null),wt===Ie?V.call(x,tt?"html":"body")[0]:tt?x.documentElement:pe},Fr=function(v){return le.call(v.ownerDocument||v,v,p.SHOW_ELEMENT|p.SHOW_COMMENT|p.SHOW_TEXT,null)},Js=function(v){return v instanceof m&&(typeof v.nodeName!="string"||typeof v.textContent!="string"||typeof v.removeChild!="function"||!(v.attributes instanceof u)||typeof v.removeAttribute!="function"||typeof v.setAttribute!="function"||typeof v.namespaceURI!="string"||typeof v.insertBefore!="function"||typeof v.hasChildNodes!="function")},Ir=function(v){return typeof n=="function"&&v instanceof n},Ne=function(v,x,C){!be[v]||Ti(be[v],j=>{j.call(e,x,C,xt)})},Nr=function(v){let x=null;if(Ne("beforeSanitizeElements",v,null),Js(v))return it(v),!0;const C=ce(v.nodeName);if(Ne("uponSanitizeElement",v,{tagName:C,allowedTags:X}),v.hasChildNodes()&&!Ir(v.firstElementChild)&&Se(/<[/\w]/g,v.innerHTML)&&Se(/<[/\w]/g,v.textContent))return it(v),!0;if(!X[C]||qt[C]){if(!qt[C]&&Hr(C)&&(ie.tagNameCheck instanceof RegExp&&Se(ie.tagNameCheck,C)||ie.tagNameCheck instanceof Function&&ie.tagNameCheck(C)))return!1;if(to&&!yt[C]){const j=D(v)||v.parentNode,pe=U(v)||v.childNodes;if(pe&&j){const ue=pe.length;for(let ye=ue-1;ye>=0;--ye)j.insertBefore(S(pe[ye],!0),L(v))}}return it(v),!0}return v instanceof d&&!Zs(v)||(C==="noscript"||C==="noembed"||C==="noframes")&&Se(/<\/no(script|embed|frames)/i,v.innerHTML)?(it(v),!0):(mt&&v.nodeType===3&&(x=v.textContent,Ti([Ze,Je,et],j=>{x=ei(x,j," ")}),v.textContent!==x&&(Jt(e.removed,{element:v.cloneNode()}),v.textContent=x)),Ne("afterSanitizeElements",v,null),!1)},Ur=function(v,x,C){if(kr&&(x==="id"||x==="name")&&(C in t||C in Ys))return!1;if(!(Zi&&!Xi[x]&&Se(Vt,x))){if(!($r&&Se(Wt,x))){if(!Z[x]||Xi[x]){if(!(Hr(v)&&(ie.tagNameCheck instanceof RegExp&&Se(ie.tagNameCheck,v)||ie.tagNameCheck instanceof Function&&ie.tagNameCheck(v))&&(ie.attributeNameCheck instanceof RegExp&&Se(ie.attributeNameCheck,x)||ie.attributeNameCheck instanceof Function&&ie.attributeNameCheck(x))||x==="is"&&ie.allowCustomizedBuiltInElements&&(ie.tagNameCheck instanceof RegExp&&Se(ie.tagNameCheck,C)||ie.tagNameCheck instanceof Function&&ie.tagNameCheck(C))))return!1}else if(!io[x]){if(!Se(vt,ei(C,ut,""))){if(!((x==="src"||x==="xlink:href"||x==="href")&&v!=="script"&&Bn(C,"data:")===0&&Mr[v])){if(!(Sr&&!Se(jt,ei(C,ut,"")))){if(C)return!1}}}}}}return!0},Hr=function(v){return v!=="annotation-xml"&&v.indexOf("-")>0},Vr=function(v){Ne("beforeSanitizeAttributes",v,null);const{attributes:x}=v;if(!x)return;const C={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:Z};let j=x.length;for(;j--;){const pe=x[j],{name:ue,namespaceURI:ye,value:ot}=pe,Yt=ce(ue);let we=ue==="value"?ot:Rn(ot);if(C.attrName=Yt,C.attrValue=we,C.keepAttr=!0,C.forceKeepAttr=void 0,Ne("uponSanitizeAttribute",v,C),we=C.attrValue,C.forceKeepAttr||(so(ue,v),!C.keepAttr))continue;if(!Cr&&Se(/\/>/i,we)){so(ue,v);continue}mt&&Ti([Ze,Je,et],jr=>{we=ei(we,jr," ")});const Wr=ce(v.nodeName);if(!!Ur(Wr,Yt,we)){if(Tr&&(Yt==="id"||Yt==="name")&&(so(ue,v),we=Gs+we),P&&typeof w=="object"&&typeof w.getAttributeType=="function"&&!ye)switch(w.getAttributeType(Wr,Yt)){case"TrustedHTML":{we=P.createHTML(we);break}case"TrustedScriptURL":{we=P.createScriptURL(we);break}}try{ye?v.setAttributeNS(ye,ue,we):v.setAttribute(ue,we),fa(e.removed)}catch{}}}Ne("afterSanitizeAttributes",v,null)},el=function M(v){let x=null;const C=Fr(v);for(Ne("beforeSanitizeShadowDOM",v,null);x=C.nextNode();)Ne("uponSanitizeShadowNode",x,null),!Nr(x)&&(x.content instanceof a&&M(x.content),Vr(x));Ne("afterSanitizeShadowDOM",v,null)};return e.sanitize=function(M){let v=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},x=null,C=null,j=null,pe=null;if(oo=!M,oo&&(M="<!-->"),typeof M!="string"&&!Ir(M))if(typeof M.toString=="function"){if(M=M.toString(),typeof M!="string")throw ti("dirty is not a string, aborting")}else throw ti("toString is not a function");if(!e.isSupported)return M;if(Ji||ao(v),e.removed=[],typeof M=="string"&&(Qt=!1),Qt){if(M.nodeName){const ot=ce(M.nodeName);if(!X[ot]||qt[ot])throw ti("root node is forbidden and cannot be sanitized in-place")}}else if(M instanceof n)x=Or("<!---->"),C=x.ownerDocument.importNode(M,!0),C.nodeType===1&&C.nodeName==="BODY"||C.nodeName==="HTML"?x=C:x.appendChild(C);else{if(!gt&&!mt&&!tt&&M.indexOf("<")===-1)return P&&_i?P.createHTML(M):M;if(x=Or(M),!x)return gt?null:_i?N:""}x&&eo&&it(x.firstChild);const ue=Fr(Qt?M:x);for(;j=ue.nextNode();)Nr(j)||(j.content instanceof a&&el(j.content),Vr(j));if(Qt)return M;if(gt){if(xi)for(pe=fe.call(x.ownerDocument);x.firstChild;)pe.appendChild(x.firstChild);else pe=x;return(Z.shadowroot||Z.shadowrootmode)&&(pe=$e.call(i,pe,!0)),pe}let ye=tt?x.outerHTML:x.innerHTML;return tt&&X["!doctype"]&&x.ownerDocument&&x.ownerDocument.doctype&&x.ownerDocument.doctype.name&&Se(Ps,x.ownerDocument.doctype.name)&&(ye="<!DOCTYPE "+x.ownerDocument.doctype.name+`>
`+ye),mt&&Ti([Ze,Je,et],ot=>{ye=ei(ye,ot," ")}),P&&_i?P.createHTML(ye):ye},e.setConfig=function(){let M=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};ao(M),Ji=!0},e.clearConfig=function(){xt=null,Ji=!1},e.isValidAttribute=function(M,v,x){xt||ao({});const C=ce(M),j=ce(v);return Ur(C,j,x)},e.addHook=function(M,v){typeof v=="function"&&(be[M]=be[M]||[],Jt(be[M],v))},e.removeHook=function(M){if(be[M])return fa(be[M])},e.removeHooks=function(M){be[M]&&(be[M]=[])},e.removeAllHooks=function(){be={}},e}var Di=Ls();let Vi=class extends de{constructor(){super(...arguments),this.collectionLinks=[]}render(){return c`
    ...
    `}};l([h({type:Object})],Vi.prototype,"collectionTitles",void 0);l([z()],Vi.prototype,"collectionLinks",void 0);Vi=l([B("tile-list")],Vi);let Ye=class extends F{constructor(){super(...arguments),this.loggedIn=!1}render(){return c`
      <div id="container">
        <tile-list
          .model=${this.model}
    ...
    `}};Ae.HOVER_PANE_DISPLAY_MODES={grid:!0,"list-compact":!0,"list-detail":!1,"list-header":!1};l([h({type:String})],Ae.prototype,"tileDisplayMode",void 0);l([h({type:Boolean})],Ae.prototype,"isManageView",void 0);l([h({type:Object})],Ae.prototype,"resizeObserver",void 0);l([h({type:Object})],Ae.prototype,"collectionTitles",void 0);l([h({type:Boolean})],Ae.prototype,"enableHoverPane",void 0);l([h({type:String})],Ae.prototype,"manageCheckTitle",void 0);l([K("#container")],Ae.prototype,"container",void 0);l([K("tile-hover-pane")],Ae.prototype,"hoverPane",void 0);Ae=er=l([B("tile-dispatcher")],Ae);let Sa=class extends F{render(){return c` <div id="container"></div> `}static get styles(){return f`
      :host {
        display: block;
        height: 100%;
      }
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var zo;((zo=window.HTMLSlotElement)===null||zo===void 0?void 0:zo.prototype.assignedElements)!=null;/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Ha(r,e,t){return r?e():t==null?void 0:t()}const Va=f`var(--white, #fff)`,Sd=f`var(--primaryDisableCTAFill, #767676)`,Cd=f`var(--secondaryCTABorder, #999)`,kd=f`var(--primaryCTAFill, #194880)`,Ao=f`var(--primaryCTAFillRGB, 25, 72, 128)`,Td=f`var(--primaryCTABorder, #c5d1df)`,Ed=f`var(--primaryErrorCTAFill, #d9534f)`,Po=f`var(--primaryErrorCTAFillRGB, 229, 28, 38)`,Md=f`var(--primaryErrorCTABorder, #d43f3a)`,zd=f`var(--secondaryCTAFill, #333)`,Lo=f`var(--secondaryCTAFillRGB, 51, 51, 51)`,Ad=f`var(--primaryCTABorder, #979797)`,Pd=f`#ee8950`,Ld=f`#ec7939`;var Dd=f`
  .ia-button {
    min-height: 3rem;
    cursor: pointer;
    color: ${Va};
...
`;let Ot=class extends F{constructor(){super(...arguments),this.label=A("Select items to remove"),this.showSelectAll=!1,this.showUnselectAll=!1,this.removeAllowed=!1}render(){return c`
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const si=(r,e)=>{var t,i;const o=r._$AN;if(o===void 0)return!1;for(const a of o)(i=(t=a)._$AO)===null||i===void 0||i.call(t,e,!1),si(a,e);return!0},Gi=r=>{let e,t;do{if((e=r._$AM)===void 0)break;t=e._$AN,t.delete(r),r=e}while((t==null?void 0:t.size)===0)},js=r=>{for(let e;e=r._$AM;r=e){let t=e._$AN;if(t===void 0)e._$AN=t=new Set;else if(t.has(r))break;t.add(r),Od(e)}};function Bd(r){this._$AN!==void 0?(Gi(this),this._$AM=r,js(this)):this._$AM=r}function Rd(r,e=!1,t=0){const i=this._$AH,o=this._$AN;if(o!==void 0&&o.size!==0)if(e)if(Array.isArray(i))for(let a=t;a<i.length;a++)si(i[a],!1),Gi(i[a]);else i!=null&&(si(i,!1),Gi(i));else si(this,r)}const Od=r=>{var e,t,i,o;r.type==De.CHILD&&((e=(i=r)._$AP)!==null&&e!==void 0||(i._$AP=Rd),(t=(o=r)._$AQ)!==null&&t!==void 0||(o._$AQ=Bd))};class Fd extends yi{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,i){super._$AT(e,t,i),js(this),this.isConnected=e._$AU}_$AO(e,t=!0){var i,o;e!==this.isConnected&&(this.isConnected=e,e?(i=this.reconnected)===null||i===void 0||i.call(this):(o=this.disconnected)===null||o===void 0||o.call(this)),t&&(si(this,e),Gi(this))}setValue(e){if(fs(this._$Ct))this._$Ct._$AI(e,this);else{const t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}}const Do=new WeakMap,Id=bi(class extends Fd{render(r){return y}update(r,[e]){var t;const i=e!==this.U;return i&&this.U!==void 0&&this.ot(void 0),(i||this.rt!==this.lt)&&(this.U=e,this.ht=(t=r.options)===null||t===void 0?void 0:t.host,this.ot(this.lt=r.element)),y}ot(r){var e;if(typeof this.U=="function"){const t=(e=this.ht)!==null&&e!==void 0?e:globalThis;let i=Do.get(t);i===void 0&&(i=new WeakMap,Do.set(t,i)),i.get(this.U)!==void 0&&this.U.call(this.ht,void 0),i.set(this.U,r),r!==void 0&&this.U.call(this.ht,r)}else this.U.value=r}get rt(){var r,e,t;return typeof this.U=="function"?(e=Do.get((r=this.ht)!==null&&r!==void 0?r:globalThis))===null||e===void 0?void 0:e.get(this.U):(t=this.U)===null||t===void 0?void 0:t.value}disconnected(){this.rt===this.lt&&this.ot(void 0)}reconnected(){this.ot(this.lt)}});/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;let nr=class extends F{constructor(){super(...arguments),this.config=new lr}render(){return c`
    ...
    `}static get styles(){const e=f`var(--modalLogoSize, 6.5rem)`,t=f`var(--processingImageSize, 7.5rem)`,i=f`var(--modalCornerRadius, 1rem)`,o=f`var(--modalBorder, 2px solid black)`,a=f`var(--modalBottomMargin, 2.5rem)`,s=f`var(--modalTopMargin, 5rem)`,n=f`var(--modalHeaderBottomPadding, 0.5em)`,d=f`var(--modalBottomPadding, 2rem)`,p=f`var(--modalScrollOffset, 5px)`,u=f`var(--modalTitleFontSize, 1.8rem)`,m=f`var(--modalSubtitleFontSize, 1.4rem)`,g=f`var(--modalHeadlineFontSize, 1.6rem)`,w=f`var(--modalMessageFontSize, 1.4rem)`,_=f`var(--modalTitleLineHeight, normal)`,S=f`var(--modalSubtitleLineHeight, normal)`,L=f`var(--modalHeadlineLineHeight, normal)`,U=f`var(--modalMessageLineHeight, normal)`;return f`
      .processing-logo {
        margin: auto;
        width: ${t};
        height: ${t};
...
`,dr;let Nt=dr=class extends F{render(){return c`${this.facetRowTemplate}`}get facetRowTemplate(){var e,t,i,o;const{bucket:a,facetType:s}=this;if(!a||!s)return y;const n=`${s}:${a.key}-show-only`,d=`${s}:${a.key}-negative`,p=s!=="collection"?c`${(e=a.displayText)!==null&&e!==void 0?e:a.key}`:c`<a href="/details/${a.key}">
          ...
          </a> `,u=a.state==="hidden",m=a.state==="selected",g=`${s}: ${(o=a.displayText)!==null&&o!==void 0?o:a.key}`,w=m?`Show all ${s}s`:`Only show ${g}`,_=`Hide ${g}`,S=`Unhide ${g}`,L=u?S:_,U=`${g}, ${a.count} results`;return c`
    ...
    `}render(){return c`${this.facetsTemplate}`}static get styles(){return f`
    ...
    `}get loaderTemplate(){return c`<div class="facets-loader">
      <ia-activity-indicator .mode=${"processing"}></ia-activity-indicator>
        ...
        </div> `:y}sortFacetAggregation(e){this.sortedBy=e,this.dispatchEvent(new CustomEvent("sortedFacets",{detail:this.sortedBy}))}get getModalHeaderTemplate(){const t=Vo[this.facetKey]===ee.COUNT?"left":"right";return c`<span class="sr-only">More facets for:</span>
      <span class="title">
    ...
    `}applySearchFacetsClicked(){var e,t;const i=new CustomEvent("facetsChanged",{detail:this.selectedFacets,bubbles:!0,composed:!0});this.dispatchEvent(i),(e=this.modalManager)===null||e===void 0||e.closeModal(),(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:Re.default,action:`${oe.applyMoreFacetsModal}`,label:`${this.facetKey}`})}cancelClick(){var e,t;(e=this.modalManager)===null||e===void 0||e.closeModal(),(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:Re.default,action:oe.closeMoreFacetsModal,label:`${this.facetKey}`})}static get styles(){const e=f`var(--primaryButtonBGColor, #194880)`;return[je,f`
      ...
      `]}};l([h({type:String})],ae.prototype,"facetKey",void 0);l([h({type:String})],ae.prototype,"facetAggregationKey",void 0);l([h({type:String})],ae.prototype,"query",void 0);l([h({type:Object})],ae.prototype,"filterMap",void 0);l([h({type:Object})],ae.prototype,"modalManager",void 0);l([h({type:Object})],ae.prototype,"searchService",void 0);l([h({type:String})],ae.prototype,"searchType",void 0);l([h({type:String})],ae.prototype,"withinCollection",void 0);l([h({type:Object})],ae.prototype,"collectionTitles",void 0);l([h({type:Object})],ae.prototype,"selectedFacets",void 0);l([h({type:String})],ae.prototype,"sortedBy",void 0);l([h({type:Object,attribute:!1})],ae.prototype,"analyticsHandler",void 0);l([z()],ae.prototype,"aggregations",void 0);l([z()],ae.prototype,"facetGroup",void 0);l([z()],ae.prototype,"facetGroupTitle",void 0);l([z()],ae.prototype,"pageNumber",void 0);l([z()],ae.prototype,"facetsLoading",void 0);l([z()],ae.prototype,"paginationSize",void 0);l([z()],ae.prototype,"facetsType",void 0);ae=l([B("more-facets-content")],ae);let Xa=class extends F{render(){return c`
      <div id="row">
    ...
    `}get collectionPartOfTemplate(){if(!this.withinCollection||this.parentCollections.length===0)return y;const e="partof-heading";return c`
      ...
      >
        ...
        <ul>
          ${Tt(this.parentCollections,t=>{var i,o;const a=`${this.baseNavigationUrl}${this.collectionPagePath}${t}`;return c` <li>
              <a
                href=${a}
                data-id=${t}
    ...
    `}partOfCollectionClicked(e){var t;(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:Re.default,action:oe.partOfCollectionClicked,label:e.target.dataset.id})}showDatePickerModal(){var e,t,i;const{fullYearsHistogramAggregation:o}=this,a=o==null?void 0:o.first_bucket_key,s=o==null?void 0:o.last_bucket_key,n=o==null?void 0:o.buckets,p=c`
      <expanded-date-picker
        ${Id(m=>{if(m&&m instanceof Fe){const g=m;g.minSelectedDate=this.minSelectedDate,g.maxSelectedDate=this.maxSelectedDate}})}
        .minDate=${a}
        .maxDate=${s}
    ...
    `:this.placeholderCellTemplate}scrollThresholdReached(){!this.dataSource.endOfDataReached&&this.dataSource.queryInitialized&&(this.pagesToRender+=1,this.dataSource.fetchPage(this.pagesToRender))}static get styles(){return[je,f`
        :host {
          display: block;
