...
`,ze;let Ce=ze=class extends F{constructor(){super(...arguments),this.placeholderType=null,this.detailMessage=""}render(){return this.placeholderType?c`${this.placeholderTemplate}`:y}get placeholderTemplate(){return c`
    ...
    <a href="mailto:info@archive.org">info@archive.org</a>.`);Ce.QUERY_ERROR_DETAILS_MESSAGE=P("Error details:");l([h({type:String})],Ce.prototype,"placeholderType",void 0);l([h({type:Boolean})],Ce.prototype,"isMobileView",void 0);l([h({type:Boolean})],Ce.prototype,"isCollection",void 0);l([h({type:String})],Ce.prototype,"detailMessage",void 0);Ce=ze=l([R("empty-placeholder")],Ce);/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;let At=class extends F{constructor(){super(...arguments),this.title="",this.body="",this.starRating=0,this.viewSize="desktop"}render(){return!this.title&&!this.body&&!this.starRating?y:c`
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*Pi(r,e){const t=typeof e=="function";if(r!==void 0){let i=-1;for(const o of r)i>-1&&(yield t?e(i):e),i++,yield o}}let Ui=class extends F{constructor(){super(...arguments),this.snippets=[],this.viewSize="desktop"}render(){var e;return!((e=this.snippets)===null||e===void 0)&&e.length?c`
      <div class="container">
        <div class="snippet-view ${this.viewSize}">
...
`;function _n(r,e){let t=1;return r>=1e9?t=1e9:r>=1e6?t=1e6:r>=1e3&&e==="short"&&(t=1e3),t}function $n(r=0,e){const t=r/e,i=t<10;let o=0;return i?o=Math.round((t+Number.EPSILON)*10)/10:o=Math.round(t),o}function Sn(r,e,t,i){switch(e){case 1e9:return P(t==="short"?at`${r}B`:at`${r} billion`);case 1e6:return P(t==="short"?at`${r}M`:at`${r} million`);case 1e3:return P(t==="short"?at`${r}K`:at`${r} thousand`);default:return new Intl.NumberFormat(i).format(r)}}function oi(r,e="long",t="short",i="en-US"){const o=r!=null?r:-1;if(o<0)return"";const a=_n(o,e),s=$n(o,a);return Sn(s,a,t,i)}let qe=class extends F{render(){var e,t,i,o,a;const s=oi(this.favCount,"short","short"),n=oi(this.commentCount,"short","short"),d=this.mediatype==="account"?`${(e=this.itemCount)!==null&&e!==void 0?e:0} uploads`:`${(t=this.viewCount)!==null&&t!==void 0?t:0} ${(i=this.viewLabel)!==null&&i!==void 0?i:"all-time views"}`;return c`
...
`+we),ft&&ki([Ye,Xe,Ze],tt=>{we=Zt(we,tt," ")}),A&&xi?A.createHTML(we):we},e.setConfig=function(){let M=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};ro(M),Zi=!0},e.clearConfig=function(){wt=null,Zi=!1},e.isValidAttribute=function(M,v,x){wt||ro({});const C=pe(M),j=pe(v);return Fr(C,j,x)},e.addHook=function(M,v){typeof v=="function"&&(Z[M]=Z[M]||[],Xt(Z[M],v))},e.removeHook=function(M){if(Z[M])return pa(Z[M])},e.removeHooks=function(M){Z[M]&&(Z[M]=[])},e.removeAllHooks=function(){Z={}},e}var Li=Es();let Hi=class extends he{constructor(){super(...arguments),this.collectionLinks=[]}render(){return c`
    ...
    `:y}get volumeTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.volume,P("Volume"))}get issueTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.issue,P("Issue"))}get creatorTemplate(){var e,t,i;return((e=this.model)===null||e===void 0?void 0:e.mediatype)==="account"?c`
      ...
      <div id="creator" class="metadata">
        ...
        ${Pi(kt(this.model.creators,o=>this.searchLink("creator",o)),", ")}
      </div>
    `}get datePublishedTemplate(){var e;const t=(e=this.model)===null||e===void 0?void 0:e.datePublished;let i="long";return fr(t)&&(i="year-only"),this.metadataTemplate(Pt(t,i),P("Published"))}get dateSortByTemplate(){return this.sortParam&&(this.sortParam.field==="addeddate"||this.sortParam.field==="reviewdate"||this.sortParam.field==="publicdate")?this.metadataTemplate(Pt(this.date,"long"),this.displayValueProvider.dateLabel):y}get viewsTemplate(){var e,t,i,o;const a=((e=this.sortParam)===null||e===void 0?void 0:e.field)==="week"?(t=this.model)===null||t===void 0?void 0:t.weeklyViewCount:(i=this.model)===null||i===void 0?void 0:i.viewCount;return a==null?y:((o=this.model)===null||o===void 0?void 0:o.mediatype)==="search"?this.metadataTemplate("(Favorited search query)",""):this.metadataTemplate(`${oi(a,this.formatSize)}`,P("Views"))}get ratingTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.averageRating,P("Avg Rating"))}get reviewsTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.commentCount,P("Reviews"))}get topicsTemplate(){var e;return!(!((e=this.model)===null||e===void 0)&&e.subjects)||this.model.subjects.length===0?y:c`
      <div id="topics" class="metadata">
        ${this.labelTemplate(P("Topics"))}
        ${Pi(kt(this.model.subjects,t=>this.searchLink("subject",t)),", ")}
      </div>
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Fa(r,e,t){return r?e():t==null?void 0:t()}let vi=class extends F{constructor(){super(...arguments),this.label=P("Select items to remove"),this.showSelectAll=!1,this.showUnselectAll=!1}render(){return c`
