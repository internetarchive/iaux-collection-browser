 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const vs=(a,e)=>e.kind==="method"&&e.descriptor&&!("value"in e.descriptor)?me(Z({},e),{finisher(t){t.createProperty(e.key,a)}}):{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){typeof e.initializer=="function"&&(this[e.key]=e.initializer.call(this))},finisher(t){t.createProperty(e.key,a)}};function c(a){return(e,t)=>t!==void 0?((i,o,r)=>{o.constructor.createProperty(r,i)})(a,e,t):vs(a,e)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function z(a){return c(me(Z({},a),{state:!0}))}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */const ga=(a,e,t)=>{const i=new Map;for(let o=e;o<=t;o++)i.set(a[o],o);return i},nr=ri(class extends si{constructor(a){if(super(a),a.type!==Ae.CHILD)throw Error("repeat() can only be used in text expressions")}dt(a,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);const o=[],r=[];let l=0;for(const n of a)o[l]=i?i(n,l):l,r[l]=t(n,l),l++;return{values:r,keys:o}}render(a,e,t){return this.dt(a,e,t).values}update(a,[e,t,i]){var o;const r=ws(a),{values:l,keys:n}=this.dt(e,t,i);if(!Array.isArray(r))return this.ut=n,l;const d=(o=this.ut)!==null&&o!==void 0?o:this.ut=[],p=[];let v,f,g=0,w=r.length-1,C=0,E=l.length-1;for(;g<=w&&C<=E;)if(r[g]===null)g++;else if(r[w]===null)w--;else if(d[g]===n[C])p[C]=st(r[g],l[C]),g++,C++;else if(d[w]===n[E])p[E]=st(r[w],l[E]),w--,E--;else if(d[g]===n[E])p[E]=st(r[g],l[E]),Nt(a,p[E+1],r[g]),g++,E--;else if(d[w]===n[C])p[C]=st(r[w],l[C]),Nt(a,r[g],r[w]),w--,C++;else if(v===void 0&&(v=ga(n,C,E),f=ga(d,g,w)),v.has(d[g]))if(v.has(d[w])){const F=f.get(n[C]),D=F!==void 0?r[F]:null;if(D===null){const U=Nt(a,r[g]);st(U,l[C]),p[C]=U}else p[C]=st(D,l[C]),Nt(a,r[g],D),r[F]=null;C++}else Qi(r[w]),w--;else Qi(r[g]),g++;for(;C<=E;){const F=Nt(a,p[E+1]);st(F,l[C]),p[C++]=F}for(;g<=w;){const F=r[g++];F!==null&&Qi(F)}return this.ut=n,lr(a,p),xe}});function pi(a,e,t){return Array.from({length:(e-a)/t+1},(i,o)=>a+o*t)}let He=class extends I{constructor(){super(...arguments),this.itemCount=0,this.scrollOptimizationsDisabled=!1,this.intersectionObserver=new IntersectionObserver(e=>{e.forEach(t=>{if(t.target===this.sentinel){t.isIntersecting&&this.dispatchEvent(new Event("scrollThresholdReached"));return}const o=t.target.dataset.cellIndex;if(!o)return;const r=parseInt(o,10);t.isIntersecting?this.visibleCellIndices.add(r):this.visibleCellIndices.delete(r)}),this.scrollOptimizationsDisabled||this.processVisibleCells()}),this.renderedCellIndices=new Set,this.visibleCellIndices=new Set,this.placeholderCellIndices=new Set}reload(){pi(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.removeCell(t)),this.renderedCellIndices.clear(),this.visibleCellIndices.clear(),this.placeholderCellIndices.clear(),this.setupObservations()}refreshCell(e){this.removeCell(e),this.bufferRange.includes(e)&&this.renderCellBuffer([e])}refreshAllVisibleCells(){this.bufferRange.forEach(e=>this.removeCell(e)),this.renderCellBuffer(this.bufferRange)}scrollToCell(e,t){const i=this.cellContainers[e];if(!i)return!1;const o=t?"smooth":"auto";return i.scrollIntoView({behavior:o}),!0}getVisibleCellIndices(){return Array.from(this.visibleCellIndices)}updated(e){(e.has("itemCount")||e.has("scrollOptimizationsDisabled"))&&this.setupObservations()}disconnectedCallback(){this.intersectionObserver.disconnect()}setupObservations(){this.setupIntersectionObserver()}setupIntersectionObserver(){this.intersectionObserver.disconnect(),this.sentinel&&this.intersectionObserver.observe(this.sentinel),this.scrollOptimizationsDisabled?(pi(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.visibleCellIndices.add(t)),this.processVisibleCells()):this.cellContainers.forEach(e=>this.intersectionObserver.observe(e))}render(){var e;const t=this.itemCount-1,i=pi(0,t,1),o=(e=this.ariaLandmarkLabel)!==null&&e!==void 0?e:y;return h`
    ...
    `}};s([c({type:Number})],He.prototype,"itemCount",void 0);s([c({type:Object})],He.prototype,"cellProvider",void 0);s([c({type:Object})],He.prototype,"placeholderCellTemplate",void 0);s([c({type:Boolean})],He.prototype,"scrollOptimizationsDisabled",void 0);s([c({type:String})],He.prototype,"ariaLandmarkLabel",void 0);s([K("#sentinel")],He.prototype,"sentinel",void 0);s([ms(".cell-container")],He.prototype,"cellContainers",void 0);He=s([A("infinite-scroller")],He);/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const xs=(a,...e)=>({strTag:!0,strings:a,values:e}),lt=xs,_s=a=>typeof a!="string"&&"strTag"in a,Cs=(a,e,t)=>{let i=a[0];for(let o=1;o<a.length;o++)i+=e[t?t[o-1]:o-1],i+=a[o];return i};/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ss=a=>_s(a)?Cs(a.strings,a.values):a;/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;let Xt=class extends I{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1,this.isCompactTile=!1}render(){return h`<div class="icon-overlay ${this.getClass}">
      ${this.iconDisplay}
    </div>`}get getClass(){return this.isCompactTile?"list-compact":"list-detail"}get iconDisplay(){return this.loginRequired&&!this.loggedIn?h`${hr}`:h`${cr}`}static get styles(){return m`
      :host {
        position: absolute;
        top: 50%;
        left: 50%;
    ...
    `}};s([c({type:Boolean})],Xt.prototype,"loggedIn",void 0);s([c({type:Boolean})],Xt.prototype,"loginRequired",void 0);s([c({type:Boolean})],Xt.prototype,"isCompactTile",void 0);Xt=s([A("icon-overlay")],Xt);let Zt=class extends I{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1,this.iconRequired=!1}render(){return h`
      <div class="overlay no-preview">
        <div class="icon-overlay">${this.iconDisplay}</div>
        <p class="text-overlay">${this.textDisplay}</p>
      </div>
    `}get iconDisplay(){return this.loginRequired&&!this.loggedIn?h`${hr}`:h`${cr}`}get textDisplay(){return this.loginRequired&&!this.loggedIn?h`Log in to view this item`:h`Content may be inappropriate`}static get styles(){return m`
      :host {
        align-items: center;
        display: flex;
      }
    ...
    `}};s([c({type:Boolean})],Zt.prototype,"loggedIn",void 0);s([c({type:Boolean})],Zt.prototype,"loginRequired",void 0);s([c({type:Boolean})],Zt.prototype,"iconRequired",void 0);Zt=s([A("text-overlay")],Zt);let Qe=class extends I{constructor(){super(...arguments),this.isCompactTile=!1,this.isListTile=!1,this.loggedIn=!1,this.viewSize="desktop"}render(){var e;return!((e=this.model)===null||e===void 0)&&e.identifier?h`
    ...
    `}};s([c({type:String})],Qe.prototype,"baseImageUrl",void 0);s([c({type:Boolean})],Qe.prototype,"isCompactTile",void 0);s([c({type:Boolean})],Qe.prototype,"isListTile",void 0);s([c({type:Boolean})],Qe.prototype,"loggedIn",void 0);s([c({type:Object})],Qe.prototype,"model",void 0);s([c({type:String})],Qe.prototype,"viewSize",void 0);Qe=s([A("image-block")],Qe);let ho=class extends ne{constructor(){super(...arguments),this.showInfoButton=!1}render(){return h`
      <div class="container">
    ...
    >`}get getSizeTemplate(){var e,t;const i=(t=(e=this.model)===null||e===void 0?void 0:e.collectionSize)!==null&&t!==void 0?t:0;return i?h`<span id="item-size">${Ts(i,1)}</span>`:""}get infoButtonTemplate(){return this.showInfoButton?h`<button class="info-button" @click=${this.infoButtonPressed}>
      ...
      `]}};s([c({type:Boolean})],ho.prototype,"showInfoButton",void 0);ho=s([A("collection-tile")],ho);function Jt(a,e="short",t="en-US"){if(!a)return"";const i={};switch(e){case"year-only":i.year="numeric";break;case"short":i.month="short",i.year="numeric";break;case"long":i.year="numeric",i.month="short",i.day="2-digit";break}return new Intl.DateTimeFormat(t,i).format(a)}function Es(a){return new Date(a.getTime()-a.getTimezoneOffset()*1e3*60)}function Do(a){return a?Es(a).toISOString().endsWith("-01-01T00:00:00.000Z"):!1}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*bi(a,e){const t=typeof e=="function";if(a!==void 0){let i=-1;for(const o of a)i>-1&&(yield t?e(i):e),i++,yield o}}let Si=class extends I{constructor(){super(...arguments),this.snippets=[],this.viewSize="desktop"}render(){var e;return!((e=this.snippets)===null||e===void 0)&&e.length?h`
      <div class="container">
    ...
    `}};s([c({type:Array})],Si.prototype,"snippets",void 0);s([c({type:String})],Si.prototype,"viewSize",void 0);Si=s([A("text-snippet-block")],Si);const Ls=m`
  .drop-shadow {
    overflow: hidden;
    height: 100%;
  }
...
`;let Ve=class extends I{constructor(){super(...arguments),this.isListTile=!1,this.isCompactTile=!1,this.loggedIn=!1,this.isWaveform=!1}render(){return h`
      <div class=${Lt(this.itemBaseClass)}>${this.imageTemplate}</div>
    `}get imageTemplate(){var e;return((e=this.model)===null||e===void 0?void 0:e.mediatype)==="search"?h`${pr}`:h`
      <img
...
`,Ws={account:{color:"#000000",icon:Ps,text:"Account"},audio:{color:"#00adef",icon:As,text:"Audio"},collection:{color:"#4666ff",icon:dr,text:"Collection"},data:{color:"#333333",icon:Fs,text:"Data"},etree:{color:"#00adef",icon:Is,text:"E-tree"},film:{color:"#bf1b2c",icon:ya,text:"Film"},image:{color:"#aa99c9",icon:Bs,text:"Image"},movies:{color:"#f1644b",icon:ya,text:"Movie"},radio:{color:"#8fdaef",icon:Rs,text:"Radio"},software:{color:"#9ecc4f",icon:Os,text:"Software"},texts:{color:"#faab3c",icon:Ns,text:"Text"},tv:{color:"#f1644b",icon:Us,text:"TV"},video:{color:"#f1644b",icon:Hs,text:"Video"},web:{color:"#ffcd27",icon:Vs,text:"Web"},search:{color:"#000000",icon:pr,text:"Search"}};let ei=class extends I{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var e,t;const i=["tvnews","tvarchive","television"],o=["radio","radioprogram"];return this.mediatype==="movies"&&((e=this.collections)===null||e===void 0?void 0:e.some(r=>i.indexOf(r)>=0))?"tv":this.mediatype==="audio"&&((t=this.collections)===null||t===void 0?void 0:t.some(r=>o.indexOf(r)>=0))?"radio":this.mediatype||""}render(){const e=Ws[this.displayMediatype];return e?h`
      <div
        id="icon"
    ...
    `}};s([c({type:String})],ei.prototype,"mediatype",void 0);s([c({type:Array})],ei.prototype,"collections",void 0);s([c({type:Boolean})],ei.prototype,"showText",void 0);ei=s([A("mediatype-icon")],ei);const js=B`
...
`;function Ks(a,e){let t=1;return a>=1e9?t=1e9:a>=1e6?t=1e6:a>=1e3&&e==="short"&&(t=1e3),t}function Ys(a=0,e){const t=a/e,i=t<10;let o=0;return i?o=Math.round((t+Number.EPSILON)*10)/10:o=Math.round(t),o}function Xs(a,e,t,i){switch(e){case 1e9:return L(t==="short"?lt`${a}B`:lt`${a} billion`);case 1e6:return L(t==="short"?lt`${a}M`:lt`${a} million`);case 1e3:return L(t==="short"?lt`${a}K`:lt`${a} thousand`);default:return new Intl.NumberFormat(i).format(a)}}function jt(a,e="long",t="short",i="en-US"){const o=a!=null?a:-1;if(o<0)return"";const r=Ks(o,e),l=Ys(o,r);return Xs(l,r,t,i)}let Ke=class extends I{render(){var e;const t=jt(this.favCount,"short","short"),i=jt(this.commentCount,"short","short"),o=this.mediatype==="account"?`${this.itemCount} uploads`:`${this.viewCount} ${(e=this.viewLabel)!==null&&e!==void 0?e:"all-time views"}`;return h`
    ...
    `}get sortedDateInfoTemplate(){var e,t,i,o,r;let l,n="long";switch((e=this.sortParam)===null||e===void 0?void 0:e.field){case"date":{const d=(t=this.model)===null||t===void 0?void 0:t.datePublished;l={field:"published",value:d},Do(d)&&(n="year-only");break}case"reviewdate":l={field:"reviewed",value:(i=this.model)===null||i===void 0?void 0:i.dateReviewed};break;case"addeddate":l={field:"added",value:(o=this.model)===null||o===void 0?void 0:o.dateAdded};break;case"publicdate":l={field:"archived",value:(r=this.model)===null||r===void 0?void 0:r.dateArchived};break}return l!=null&&l.value?h`
    ...
    `}get isSortedByDate(){var e;return["date","reviewdate","addeddate","publicdate"].includes((e=this.sortParam)===null||e===void 0?void 0:e.field)}get hasSnippets(){var e,t;return!!(!((t=(e=this.model)===null||e===void 0?void 0:e.snippets)===null||t===void 0)&&t.length)}infoButtonPressed(e){e.preventDefault();const t=new CustomEvent("infoButtonPressed",{detail:{x:e.clientX,y:e.clientY}});this.dispatchEvent(t)}static get styles(){const e=m`var(--tileBorderColor, #dddddd)`;return[Li,m`
      ...
      `]}};s([c({type:Boolean})],po.prototype,"showInfoButton",void 0);po=s([A("item-tile")],po);let uo=class extends ne{constructor(){super(...arguments),this.showInfoButton=!1}render(){return h`
      <div class="container">
        ${this.infoButtonTemplate}
        <div class="tile-details">
          <div class="item-info">
    ...
    >
      ...
      `]}};s([c({type:Boolean})],uo.prototype,"showInfoButton",void 0);uo=s([A("account-tile")],uo);let vo=class extends ne{constructor(){super(...arguments),this.showInfoButton=!1}render(){return h`
      <div class="container">
        <div class="tile-details">
          <div class="item-info">
            ${this.getImageBlockTemplate} ${this.getTitleTemplate}
    ...
    `}get getTitleTemplate(){var e;return h`<div id="title">
      ...
      `]}};s([c({type:Boolean})],vo.prototype,"showInfoButton",void 0);vo=s([A("search-tile")],vo);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`+be),De&&ui([Le,je,q],at=>{be=Ht(be,at," ")}),O&&ni?O.createHTML(be):be},e.setConfig=function(){let M=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};Ii(M),tt=!0},e.clearConfig=function(){St=null,tt=!1},e.isValidAttribute=function(M,u,x){St||Ii({});const S=ce(M),V=ce(u);return Yo(S,V,x)},e.addHook=function(M,u){typeof u=="function"&&(re[M]=re[M]||[],Ut(re[M],u))},e.removeHook=function(M){if(re[M])return xa(re[M])},e.removeHooks=function(M){re[M]&&(re[M]=[])},e.removeAllHooks=function(){re={}},e}var wi=br(),_;(function(a){a.default="default",a.unrecognized="unrecognized",a.relevance="relevance",a.alltimeview="alltimeview",a.weeklyview="weeklyview",a.title="title",a.date="date",a.datearchived="datearchived",a.datereviewed="datereviewed",a.dateadded="dateadded",a.datefavorited="datefavorited",a.creator="creator"})(_||(_={}));const fe={[_.default]:{field:_.default,defaultSortDirection:null,canSetDirection:!1,shownInSortBar:!1,shownInURL:!1,handledBySearchService:!1,displayName:"",urlNames:["",null,void 0]},[_.unrecognized]:{field:_.unrecognized,defaultSortDirection:null,canSetDirection:!0,shownInSortBar:!1,shownInURL:!1,handledBySearchService:!0,displayName:"",urlNames:[]},[_.relevance]:{field:_.relevance,defaultSortDirection:null,canSetDirection:!1,shownInSortBar:!0,shownInURL:!1,handledBySearchService:!1,displayName:"Relevance",urlNames:["_score"]},[_.alltimeview]:{field:_.alltimeview,defaultSortDirection:"desc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"downloads",displayName:"All-time views",urlNames:["downloads"]},[_.weeklyview]:{field:_.weeklyview,defaultSortDirection:"desc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"week",displayName:"Weekly views",urlNames:["week"]},[_.title]:{field:_.title,defaultSortDirection:"asc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"titleSorter",displayName:"Title",urlNames:["title","titleSorter"]},[_.date]:{field:_.date,defaultSortDirection:"desc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"date",displayName:"Date published",urlNames:["date"]},[_.datearchived]:{field:_.datearchived,defaultSortDirection:"desc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"publicdate",displayName:"Date archived",urlNames:["publicdate"]},[_.datereviewed]:{field:_.datereviewed,defaultSortDirection:"desc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"reviewdate",displayName:"Date reviewed",urlNames:["reviewdate"]},[_.dateadded]:{field:_.dateadded,defaultSortDirection:"desc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"addeddate",displayName:"Date added",urlNames:["addeddate"]},[_.datefavorited]:{field:_.datefavorited,defaultSortDirection:"desc",canSetDirection:!1,shownInSortBar:!0,shownInURL:!1,handledBySearchService:!1,searchServiceKey:"favoritedate",displayName:"Date favorited",urlNames:["favoritedate"]},[_.creator]:{field:_.creator,defaultSortDirection:"asc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"creatorSorter",displayName:"Creator",urlNames:["creator","creatorSorter"]}};function yr(a){var e;return(e=Object.values(fe).find(t=>t.urlNames.some(i=>a===i)))!==null&&e!==void 0?e:fe[_.unrecognized]}const fl={title:"firstTitle",creator:"firstCreator"},ti=()=>({subject:{},lending:{},mediatype:{},language:{},creator:{},collection:{},year:{}}),gl=["mediatype","lending","year","subject","collection","creator","language"],ki={subject:"Subject",lending:"Availability",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"},bo={subject:J.COUNT,lending:J.COUNT,mediatype:J.COUNT,language:J.COUNT,creator:J.COUNT,collection:J.COUNT,year:J.NUMERIC},bl={subject:J.ALPHABETICAL,lending:J.ALPHABETICAL,mediatype:J.ALPHABETICAL,language:J.ALPHABETICAL,creator:J.ALPHABETICAL,collection:J.ALPHABETICAL,year:J.NUMERIC},yl={is_lendable:!0,is_borrowable:!1,available_to_borrow:!0,is_browsable:!1,available_to_browse:!1,is_readable:!0,available_to_waitlist:!1},Ta={is_lendable:"Lending Library",available_to_borrow:"Borrow 14 Days",is_readable:"Always Available"},Po={deemphasize:!0,community:!0,stream_only:!0,samples_only:!0,test_collection:!0,printdisabled:!0,"openlibrary-ol":!0,nationalemergencylibrary:!0,china:!0,americana:!0,toronto:!0};let Ti=class extends ne{constructor(){super(...arguments),this.collectionLinks=[]}render(){return h`
    ...
    `}};s([c({type:Object})],Ti.prototype,"collectionNameCache",void 0);s([z()],Ti.prototype,"collectionLinks",void 0);Ti=s([A("tile-list")],Ti);let Ye=class extends I{constructor(){super(...arguments),this.loggedIn=!1}render(){return h`
      <div id="container">
        <tile-list
          .model=${this.model}
    ...
    `}};s([c({type:Object})],Ye.prototype,"model",void 0);s([c({type:String})],Ye.prototype,"baseNavigationUrl",void 0);s([c({type:String})],Ye.prototype,"baseImageUrl",void 0);s([c({type:Boolean})],Ye.prototype,"loggedIn",void 0);s([c({type:Object})],Ye.prototype,"sortParam",void 0);s([c({type:Object})],Ye.prototype,"collectionNameCache",void 0);Ye=s([A("tile-hover-pane")],Ye);let Ma=class extends ne{render(){var e,t,i,o,r,l;return h`
      <div id="list-line" class="${this.classSize}">
        <image-block
          .model=${this.model}
          .baseImageUrl=${this.baseImageUrl}
    ...
    `}};Ma=s([A("tile-list-compact")],Ma);let za=class extends ne{render(){return h`
    ...
    `}firstUpdated(){this.shouldPrepareHoverPane&&(this.hoverPaneController=new wl(this,{mobileBreakpoint:this.mobileBreakpoint,enableLongPress:!1}))}get headerTemplate(){const{currentWidth:e,sortParam:t,defaultSortParam:i,mobileBreakpoint:o}=this;return h`
  ...
  `;wo=s([A("ia-icon-label")],wo);let xo=class extends I{constructor(){super(...arguments),this.numResults=0}render(){return h`
  ...
  `;s([c({type:String})],We.prototype,"selectedLetter",void 0);s([c({type:Object})],We.prototype,"letterCounts",void 0);s([c({type:String})],We.prototype,"ariaLandmarkLabel",void 0);s([z()],We.prototype,"tooltipShown",void 0);s([z()],We.prototype,"hoveredLetter",void 0);s([K("alpha-bar-tooltip")],We.prototype,"tooltip",void 0);We=s([A("alpha-bar")],We);const xl=h`
...
`;let ee=class extends I{constructor(){super(...arguments),this.defaultSortDirection=null,this.defaultSortField=_.relevance,this.sortDirection=null,this.selectedSort=_.default,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.showRelevance=!0,this.showDateFavorited=!1,this.alphaSelectorVisible=null,this.dropdownBackdropVisible=!1,this.desktopSortContainerWidth=0,this.selectorBarContainerWidth=0,this.boundSortBarSelectorEscapeListener=e=>{e.key==="Escape"&&this.closeDropdowns()}}render(){return h`
    ...
    `:h`<div class="sort-direction-icon">${Cl}</div>`}get desktopSortSelectorTemplate(){return h`
      <div
    ...
    ></alpha-bar>`}titleLetterChanged(e){var t;this.selectedTitleFilter=(t=e.detail.selectedLetter)!==null&&t!==void 0?t:null,this.emitTitleLetterChangedEvent()}creatorLetterChanged(e){var t;this.selectedCreatorFilter=(t=e.detail.selectedLetter)!==null&&t!==void 0?t:null,this.emitCreatorLetterChangedEvent()}emitTitleLetterChangedEvent(){const e=new CustomEvent("titleLetterChanged",{detail:{selectedLetter:this.selectedTitleFilter}});this.dispatchEvent(e)}emitCreatorLetterChangedEvent(){const e=new CustomEvent("creatorLetterChanged",{detail:{selectedLetter:this.selectedCreatorFilter}});this.dispatchEvent(e)}displayModeChanged(){const e=new CustomEvent("displayModeChanged",{detail:{displayMode:this.displayMode}});this.dispatchEvent(e)}emitSortChangedEvent(){const e=new CustomEvent("sortChanged",{detail:{selectedSort:this.selectedSort,sortDirection:this.sortDirection}});this.dispatchEvent(e)}static get styles(){return[Ze,m`
      ...
      `]}};s([c({type:String})],ee.prototype,"displayMode",void 0);s([c({type:String})],ee.prototype,"defaultSortDirection",void 0);s([c({type:String})],ee.prototype,"defaultSortField",void 0);s([c({type:String})],ee.prototype,"sortDirection",void 0);s([c({type:String})],ee.prototype,"selectedSort",void 0);s([c({type:String})],ee.prototype,"selectedTitleFilter",void 0);s([c({type:String})],ee.prototype,"selectedCreatorFilter",void 0);s([c({type:Boolean})],ee.prototype,"showRelevance",void 0);s([c({type:Boolean})],ee.prototype,"showDateFavorited",void 0);s([c({type:Object})],ee.prototype,"prefixFilterCountMap",void 0);s([c({type:Object})],ee.prototype,"resizeObserver",void 0);s([z()],ee.prototype,"alphaSelectorVisible",void 0);s([z()],ee.prototype,"dropdownBackdropVisible",void 0);s([z()],ee.prototype,"desktopSortContainerWidth",void 0);s([z()],ee.prototype,"selectorBarContainerWidth",void 0);s([K("#desktop-sort-container")],ee.prototype,"desktopSortContainer",void 0);s([K("#sort-selector-container")],ee.prototype,"sortSelectorContainer",void 0);s([K("#views-dropdown")],ee.prototype,"viewsDropdown",void 0);s([K("#date-dropdown")],ee.prototype,"dateDropdown",void 0);s([K("#mobile-dropdown")],ee.prototype,"mobileDropdown",void 0);ee=s([A("sort-filter-bar")],ee);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Da(a,e,t){return a?e():t==null?void 0:t()}let ii=class extends I{constructor(){super(...arguments),this.label=L("Select items to un-favorite"),this.showSelectAll=!1,this.showUnselectAll=!1}render(){return h`
      <div class="manage-container">
        ...
        <div class="manage-buttons">
          ...
          <div class="selection-buttons">
            ${Da(this.showSelectAll,()=>h` <button
                class="link-styled select-all-btn"
                @click=${this.selectAllClicked}
              >
                ${L("Select all")}
              </button>`)}
            ${Da(this.showUnselectAll,()=>h` <button
    ...
    `}};s([c({type:String})],ii.prototype,"label",void 0);s([c({type:Boolean})],ii.prototype,"showSelectAll",void 0);s([c({type:Boolean})],ii.prototype,"showUnselectAll",void 0);ii=s([A("manage-bar")],ii);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;let ie=class extends I{constructor(){super(...arguments),this.prompt="Do you find this feature useful?",this.buttonText="Beta",this.isOpen=!1,this.processing=!1,this.popupTopX=0,this.popupTopY=0,this.voteSubmitted=!1,this.voteNeedsChoosing=!1,this.resizingElement=document.body}render(){return h`
      <button
        id="beta-button"
...
`;let Co=class extends I{constructor(){super(...arguments),this.config=new _o}render(){return h`
      <div class="modal-wrapper">
        <div class="modal-container">
          <header style="background-color: ${this.config.headerColor}">
            ${this.config.showCloseButton?this.closeButtonTemplate:""}
            ${this.config.showHeaderLogo?h`<div class="logo-icon">${en}</div>`:y}
    ...
    `}static get styles(){const e=m`var(--modalLogoSize, 6.5rem)`,t=m`var(--processingImageSize, 7.5rem)`,i=m`var(--modalCornerRadius, 1rem)`,o=m`var(--modalBorder, 2px solid black)`,r=m`var(--modalBottomMargin, 2.5rem)`,l=m`var(--modalTopMargin, 5rem)`,n=m`var(--modalHeaderBottomPadding, 0.5em)`,d=m`var(--modalBottomPadding, 2rem)`,p=m`var(--modalScrollOffset, 5px)`,v=m`var(--modalTitleFontSize, 1.8rem)`,f=m`var(--modalSubtitleFontSize, 1.4rem)`,g=m`var(--modalHeadlineFontSize, 1.6rem)`,w=m`var(--modalMessageFontSize, 1.4rem)`,C=m`var(--modalTitleLineHeight, normal)`,E=m`var(--modalSubtitleLineHeight, normal)`,F=m`var(--modalHeadlineLineHeight, normal)`,D=m`var(--modalMessageLineHeight, normal)`;return m`
      .processing-logo {
        margin: auto;
        width: ${t};
        height: ${t};
    ...
    `}};s([c({type:Object})],Co.prototype,"config",void 0);Co=s([A("modal-template")],Co);function tn(a,e,t){var i=t||{},o=i.noTrailing,r=o===void 0?!1:o,l=i.noLeading,n=l===void 0?!1:l,d=i.debounceMode,p=d===void 0?void 0:d,v,f=!1,g=0;function w(){v&&clearTimeout(v)}function C(F){var D=F||{},U=D.upcomingOnly,O=U===void 0?!1:U;w(),f=!O}function E(){for(var F=arguments.length,D=new Array(F),U=0;U<F;U++)D[U]=arguments[U];var O=this,ae=Date.now()-g;if(f)return;function le(){g=Date.now(),e.apply(O,D)}function de(){v=void 0}!n&&p&&!v&&le(),w(),p===void 0&&ae>a?n?(g=Date.now(),r||(v=setTimeout(p?de:le,a))):le():r!==!0&&(v=setTimeout(p?de:le,p===void 0?a-ae:a))}return E.cancel=C,E}var nt;(function(a){a.Open="open",a.Closed="closed"})(nt||(nt={}));class on{constructor(e){this.windowResizeThrottler=tn(100,this.updateModalContainerHeight,{noLeading:!1,noTrailing:!1}).bind(this),this.modalManager=e}handleModeChange(e){switch(e){case nt.Open:this.startResizeListener(),this.stopDocumentScroll();break;case nt.Closed:this.stopResizeListener(),this.resumeDocumentScroll();break}}updateModalContainerHeight(){this.modalManager.style.setProperty("--containerHeight",`${window.innerHeight}px`)}stopDocumentScroll(){document.body.classList.add("modal-manager-open")}resumeDocumentScroll(){document.body.classList.remove("modal-manager-open")}startResizeListener(){window.addEventListener("resize",this.windowResizeThrottler)}stopResizeListener(){window.removeEventListener("resize",this.windowResizeThrottler)}}let Dt=class extends I{constructor(){super(...arguments),this.mode=nt.Closed,this.hostBridge=new on(this),this.closeOnBackdropClick=!0}render(){return h`
      <div class="container">
...
`;let Pt=class extends I{constructor(){super(...arguments),this.step=2,this.currentPage=1,this.pages=[]}firstUpdated(){this.observePageCount()}updated(e){e.has("size")&&this.observePageCount(),e.has("currentPage")&&(this.observePageCount(),this.emitPageClick())}observePageCount(){this.pages=[];const e=7,t=this.size<=e;if(this.size<=5){this.pages=[...Array(this.size).keys()].map(r=>r+1);return}if(this.size===e){if(this.currentPage===2){this.pages=[1,2,3,4,0,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,4,5,this.size-1,this.size];return}}if(this.currentPage===1){this.pages=[1,2,3,0,this.size];return}if(this.currentPage===this.size){this.pages=[1,0,this.size-2,this.size-1,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,this.size-3,this.size-2,this.size-1,this.size];return}if(t&&this.currentPage>1&&this.currentPage<e){this.pages=[...Array(this.size).keys()].map(r=>r+1);return}let i=this.currentPage-this.step,o=this.currentPage+this.step;i<=0&&(o+=-i+1,i=1),o>=this.size&&(i=Math.max(i-(o-this.size),1),o=this.size),i===2&&(o-=1),o===this.size-1&&(i+=1),this.createFirstNode(i),this.createMiddelNode(i,o),this.createLastNode(o)}createFirstNode(e){var t,i;e>1&&((t=this.pages)===null||t===void 0||t.push(1)),e>2&&((i=this.pages)===null||i===void 0||i.push(0))}createMiddelNode(e,t){var i;for(let o=e;o<=t;o+=1)(i=this.pages)===null||i===void 0||i.push(o)}createLastNode(e){var t,i;e<this.size-1&&((t=this.pages)===null||t===void 0||t.push(0)),e<this.size&&((i=this.pages)===null||i===void 0||i.push(this.size))}get getEllipsisTemplate(){return h`<i class="ellipses">...</i>`}emitPageClick(){this.dispatchEvent(new CustomEvent("pageNumberClicked",{detail:{page:this.currentPage},bubbles:!0,composed:!0}))}onRewind(){this.currentPage-=1,this.currentPage<1&&(this.currentPage=1)}onForward(){this.currentPage+=1,this.currentPage>this.size&&(this.currentPage=this.size)}onChange(e){this.currentPage=e}getPageTemplate(e){return h`
    ...
    `}static get styles(){return[Ze,m`
      ...
      `]}};s([c({type:Number})],Pt.prototype,"size",void 0);s([c({type:Number})],Pt.prototype,"step",void 0);s([c({type:Number})],Pt.prototype,"currentPage",void 0);s([z()],Pt.prototype,"pages",void 0);Pt=s([A("more-facets-pagination")],Pt);var ln=B`
...
`;let ct=class extends I{constructor(){super(...arguments),this.collectionPagePath="/details/"}facetClicked(e,t,i){const o=e.target,{checked:r,name:l,value:n}=o;r?this.facetChecked(l,n,t,i):this.facetUnchecked(l,n),this.dispatchFacetClickEvent(l,this.getFacetState(r,i),i)}facetChecked(e,t,i,o){const{selectedFacets:r}=this;let l;r?l=Z({},r):l=ti(),l[e][t]={state:this.getFacetState(!0,o),count:i},this.selectedFacets=l,this.dispatchSelectedFacetsChanged()}facetUnchecked(e,t){const{selectedFacets:i}=this;let o;i?o=Z({},i):o=ti(),delete o[e][t],this.selectedFacets=o,this.dispatchSelectedFacetsChanged()}getFacetState(e,t){let i;return e?i=t?"hidden":"selected":i="none",i}dispatchFacetClickEvent(e,t,i){const o=new CustomEvent("facetClick",{detail:{key:e,state:t,negative:i},composed:!0});this.dispatchEvent(o)}dispatchSelectedFacetsChanged(){const e=new CustomEvent("selectedFacetsChanged",{detail:this.selectedFacets,bubbles:!0,composed:!0});this.dispatchEvent(e)}getFacetsTemplate(e){let t=e==null?void 0:e.buckets;return t=[...t.filter(i=>i.state==="selected").sort((i,o)=>i.count<o.count?1:-1),...t.filter(i=>i.state==="hidden").sort((i,o)=>i.count<o.count?1:-1),...t.filter(i=>i.state==="none")],h`
      <div class="facets-on-${this.renderOn}">
        ${nr(t,i=>`${e.key}:${i.key}`,i=>{var o,r;const l=`${e.key}:${i.key}-show-only`,n=`${e.key}:${i.key}-negative`,d=e.key!=="collection"?h`${(o=i.displayText)!==null&&o!==void 0?o:i.key}`:h`<a href="${this.collectionPagePath}${i.key}">
                    <async-collection-name
                      .collectionNameCache=${this.collectionNameCache}
                      .identifier=${i.key}
                      placeholder="-"
                    ></async-collection-name>
                  </a> `,p=i.state==="hidden",v=i.state==="selected",f=`${e.key}: ${(r=i.displayText)!==null&&r!==void 0?r:i.key}`,g=v?`Show all ${e.key}s`:`Only show ${f}`,w=`Hide ${f}`,C=`Unhide ${f}`,E=p?C:w,F=`${f}, ${i.count} results`;return h`
              <div class="facet-row">
    ...
    `}};s([c({type:Object})],ct.prototype,"facetGroup",void 0);s([c({type:Object})],ct.prototype,"selectedFacets",void 0);s([c({type:String})],ct.prototype,"renderOn",void 0);s([c({type:String})],ct.prototype,"collectionPagePath",void 0);s([c({type:Object})],ct.prototype,"collectionNameCache",void 0);ct=s([A("facets-template")],ct);var Fe;(function(a){a.default="collection-browser"})(Fe||(Fe={}));var se;(function(a){a.sortBy="sortBy",a.filterByCreator="filterByCreator",a.filterByTitle="filterByTitle",a.displayMode="displayMode",a.facetSelected="facetSelected",a.facetDeselected="facetDeselected",a.facetNegativeSelected="facetNegativeSelected",a.facetNegativeDeselected="facetNegativeDeselected",a.partOfCollectionClicked="partOfCollectionClicked",a.histogramChanged="histogramChanged",a.histogramChangedFromModal="histogramChangedFromModal",a.histogramExpanded="histogramExpanded",a.resultSelected="resultSelected",a.moreFacetsPageChange="moreFacetsPageChange",a.showMoreFacetsModal="showMoreFacetsModal",a.closeMoreFacetsModal="closeMoreFacetsModal",a.applyMoreFacetsModal="applyMoreFacetsModal"})(se||(se={}));let Xe=class extends I{constructor(){super(...arguments),this.leftValue="",this.rightValue="",this.side="left"}render(){var e,t;return h`
      <div id="container">
    ...
    `}get loaderTemplate(){return h`<div class="facets-loader">
      <ia-activity-indicator .mode=${"processing"}></ia-activity-indicator>
        ...
        </div> `:y}sortFacetAggregation(e){this.sortedBy=e,this.dispatchEvent(new CustomEvent("sortedFacets",{detail:this.sortedBy}))}get getModalHeaderTemplate(){const t=bo[this.facetKey]===J.COUNT?"left":"right";return h`<span class="sr-only">More facets for:</span>
      <span class="title">
    ...
    `}applySearchFacetsClicked(){var e,t;const i=new CustomEvent("facetsChanged",{detail:this.selectedFacets,bubbles:!0,composed:!0});this.dispatchEvent(i),(e=this.modalManager)===null||e===void 0||e.closeModal(),(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:Fe.default,action:`${se.applyMoreFacetsModal}`,label:`${this.facetKey}`})}cancelClick(){var e,t;(e=this.modalManager)===null||e===void 0||e.closeModal(),(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:Fe.default,action:se.closeMoreFacetsModal,label:`${this.facetKey}`})}static get styles(){const e=m`var(--primaryButtonBGColor, #194880)`;return[Ze,m`
      ...
      `]}};s([c({type:String})],oe.prototype,"facetKey",void 0);s([c({type:String})],oe.prototype,"facetAggregationKey",void 0);s([c({type:String})],oe.prototype,"query",void 0);s([c({type:Object})],oe.prototype,"filterMap",void 0);s([c({type:Object})],oe.prototype,"modalManager",void 0);s([c({type:Object})],oe.prototype,"searchService",void 0);s([c({type:String})],oe.prototype,"searchType",void 0);s([c({type:String})],oe.prototype,"withinCollection",void 0);s([c({type:Object})],oe.prototype,"collectionNameCache",void 0);s([c({type:Object})],oe.prototype,"selectedFacets",void 0);s([c({type:String})],oe.prototype,"sortedBy",void 0);s([c({type:Object,attribute:!1})],oe.prototype,"analyticsHandler",void 0);s([z()],oe.prototype,"aggregations",void 0);s([z()],oe.prototype,"facetGroup",void 0);s([z()],oe.prototype,"facetGroupTitle",void 0);s([z()],oe.prototype,"pageNumber",void 0);s([z()],oe.prototype,"facetsLoading",void 0);s([z()],oe.prototype,"paginationSize",void 0);s([z()],oe.prototype,"facetsType",void 0);oe=s([A("more-facets-content")],oe);let Na=class extends I{render(){return h`
      <div id="row">
    ...
    `}};Na=s([A("facet-tombstone-row")],Na);let Ie=class extends I{constructor(){super(...arguments),this.boundEscapeListener=e=>{e.key==="Escape"&&this.closeModal()}}render(){var e,t;return h`
      <div id="container">
    ...
    `,r=()=>{const n=Z({},this.openFacets);n[t]=!i,this.openFacets=n},l=`facet-group-header-label-${e.key}`;return h`
      <section
    ...
    `}searchMoreFacetsLink(e){if(!this.moreLinksVisible||e.key==="lending"||Object.keys(e.buckets).length<this.allowedFacetCount)return y;const t=bo[e.key];return h`<button
      class="more-link"
...
`,Pe;let _e=Pe=class extends I{constructor(){super(...arguments),this.placeholderType=null,this.detailMessage=""}render(){return this.placeholderType?h`${this.placeholderTemplate}`:y}get placeholderTemplate(){return h`
      <div
    ...
    ></infinite-scroller>`}get infiniteScrollerClasses(){var e;return Lt({[(e=this.displayMode)!==null&&e!==void 0?e:""]:!!this.displayMode,hidden:!!this.placeholderType})}get sortFilterBarTemplate(){var e;return h`
      <sort-filter-bar
    ...
    `}clearFiltersBtnTemplate(e){if(!this.hasActiveFilters)return y;const t=Lt({"clear-filters-btn":!0,mobile:e}),i=e?"Clear all":"Clear all filters";return h`
...
`),favCount:(Be=($e=d.num_favorites)===null||$e===void 0?void 0:$e.value)!==null&&Be!==void 0?Be:0,href:this.collapseRepeatedQuotes((It=d.__href__)===null||It===void 0?void 0:It.value),identifier:d.identifier,issue:(pt=d.issue)===null||pt===void 0?void 0:pt.value,itemCount:(Y=(ut=d.item_count)===null||ut===void 0?void 0:ut.value)!==null&&Y!==void 0?Y:0,mediatype:this.getMediatype(d),snippets:(X=(vt=d.highlight)===null||vt===void 0?void 0:vt.values)!==null&&X!==void 0?X:[],source:(mt=d.source)===null||mt===void 0?void 0:mt.value,subjects:(Re=(W=d.subject)===null||W===void 0?void 0:W.values)!==null&&Re!==void 0?Re:[],title:(ft=(Je=d.title)===null||Je===void 0?void 0:Je.value)!==null&&ft!==void 0?ft:"",volume:(et=d.volume)===null||et===void 0?void 0:et.value,viewCount:(bt=(gt=d.downloads)===null||gt===void 0?void 0:gt.value)!==null&&bt!==void 0?bt:0,weeklyViewCount:(De=d.week)===null||De===void 0?void 0:De.value,loginRequired:ke,contentWarning:tt})}),o[e]=r,this.dataSource=o,this.currentVisiblePageNumbers.includes(e)&&((i=this.infiniteScroller)===null||i===void 0||i.refreshAllVisibleCells())}getMediatype(e){var t,i,o;return((t=e==null?void 0:e.rawMetadata)===null||t===void 0?void 0:t.hit_type)==="favorited_search"?"search":(o=(i=e.mediatype)===null||i===void 0?void 0:i.value)!==null&&o!==void 0?o:"data"}collapseRepeatedQuotes(e){return e==null?void 0:e.replace(/%22%22(?!%22%22)(.+?)%22%22/g,"%22$1%22")}async fetchPrefixFilterBuckets(e){var t,i,o,r,l,n,d;const p=(t=this.baseQuery)===null||t===void 0?void 0:t.trim();if(!this.canPerformSearch)return[];const v=fl[e],f=this.sortParam?[this.sortParam]:[],g=me(Z({},this.collectionParams),{query:p||"",rows:0,filters:this.filterMap,aggregations:{simpleParams:[v]},aggregationsSize:26});g.uid=await this.requestUID(me(Z({},g),{sort:f}),"aggregations");const w=await((i=this.searchService)===null||i===void 0?void 0:i.search(g,this.searchType));return(d=(n=(l=(r=(o=w==null?void 0:w.success)===null||o===void 0?void 0:o.response)===null||r===void 0?void 0:r.aggregations)===null||l===void 0?void 0:l[v])===null||n===void 0?void 0:n.buckets)!==null&&d!==void 0?d:[]}async updatePrefixFilterCounts(e){const{facetFetchQueryKey:t}=this,i=await this.fetchPrefixFilterBuckets(e);t===this.facetFetchQueryKey&&(this.prefixFilterCountMap=Z({},this.prefixFilterCountMap),this.prefixFilterCountMap[e]=i.reduce((r,l)=>(r[l.key.toUpperCase()]=l.doc_count,r),{}))}async updatePrefixFiltersForCurrentSort(){if(["title","creator"].includes(this.selectedSort)){const e=this.selectedSort;this.prefixFilterCountMap[e]||this.updatePrefixFilterCounts(e)}}refreshLetterCounts(){Object.keys(this.prefixFilterCountMap).length>0&&(this.prefixFilterCountMap={}),this.updatePrefixFiltersForCurrentSort()}resultSelected(e){var t,i,o;if(this.isManageView){const r=Object.values(this.dataSource).flat().indexOf(e.detail);r>=0&&((t=this.infiniteScroller)===null||t===void 0||t.refreshCell(r-this.tileModelOffset))}(i=this.analyticsHandler)===null||i===void 0||i.sendEvent({category:this.searchContext,action:se.resultSelected,label:e.detail.mediatype}),(o=this.analyticsHandler)===null||o===void 0||o.sendEvent({category:this.searchContext,action:se.resultSelected,label:`page-${this.currentPage}`})}cellForIndex(e){const t=this.tileModelAtCellIndex(e);if(!!t)return h`
    ...
    `}scrollThresholdReached(){this.endOfDataReached||(this.pagesToRender+=1,this.fetchPage(this.pagesToRender))}static get styles(){return[Ze,m`
      ...
      `]}};s([c({type:String})],T.prototype,"baseNavigationUrl",void 0);s([c({type:String})],T.prototype,"baseImageUrl",void 0);s([c({type:Object})],T.prototype,"searchService",void 0);s([c({type:String})],T.prototype,"searchType",void 0);s([c({type:String})],T.prototype,"withinCollection",void 0);s([c({type:String})],T.prototype,"baseQuery",void 0);s([c({type:String})],T.prototype,"displayMode",void 0);s([c({type:Object})],T.prototype,"sortParam",void 0);s([c({type:Object})],T.prototype,"defaultSortParam",void 0);s([c({type:String})],T.prototype,"selectedSort",void 0);s([c({type:String})],T.prototype,"selectedTitleFilter",void 0);s([c({type:String})],T.prototype,"selectedCreatorFilter",void 0);s([c({type:String})],T.prototype,"sortDirection",void 0);s([c({type:Number})],T.prototype,"pageSize",void 0);s([c({type:Object})],T.prototype,"resizeObserver",void 0);s([c({type:Number})],T.prototype,"currentPage",void 0);s([c({type:String})],T.prototype,"minSelectedDate",void 0);s([c({type:String})],T.prototype,"maxSelectedDate",void 0);s([c({type:Object})],T.prototype,"selectedFacets",void 0);s([c({type:Boolean})],T.prototype,"showHistogramDatePicker",void 0);s([c({type:Boolean})],T.prototype,"suppressPlaceholders",void 0);s([c({type:Boolean})],T.prototype,"suppressResultCount",void 0);s([c({type:String})],T.prototype,"collectionPagePath",void 0);s([c({type:Object})],T.prototype,"collectionInfo",void 0);s([c({type:Array})],T.prototype,"parentCollections",void 0);s([c({type:String,reflect:!0})],T.prototype,"searchContext",void 0);s([c({type:Object})],T.prototype,"collectionNameCache",void 0);s([c({type:String})],T.prototype,"pageContext",void 0);s([c({type:Object})],T.prototype,"restorationStateHandler",void 0);s([c({type:Number})],T.prototype,"mobileBreakpoint",void 0);s([c({type:Boolean})],T.prototype,"loggedIn",void 0);s([c({type:Object})],T.prototype,"modalManager",void 0);s([c({type:Object})],T.prototype,"featureFeedbackService",void 0);s([c({type:Object})],T.prototype,"recaptchaManager",void 0);s([c({type:Boolean})],T.prototype,"isManageView",void 0);s([z()],T.prototype,"pagesToRender",void 0);s([z()],T.prototype,"searchResultsLoading",void 0);s([z()],T.prototype,"facetsLoading",void 0);s([z()],T.prototype,"fullYearAggregationLoading",void 0);s([z()],T.prototype,"aggregations",void 0);s([z()],T.prototype,"fullYearsHistogramAggregation",void 0);s([z()],T.prototype,"totalResults",void 0);s([z()],T.prototype,"queryErrorMessage",void 0);s([z()],T.prototype,"mobileView",void 0);s([z()],T.prototype,"mobileFacetsVisible",void 0);s([z()],T.prototype,"contentWidth",void 0);s([z()],T.prototype,"defaultSortField",void 0);s([z()],T.prototype,"defaultSortDirection",void 0);s([z()],T.prototype,"placeholderType",void 0);s([z()],T.prototype,"prefixFilterCountMap",void 0);s([K("#content-container")],T.prototype,"contentContainer",void 0);s([K("#left-column")],T.prototype,"leftColumn",void 0);s([K("collection-facets")],T.prototype,"collectionFacets",void 0);s([c({type:Object,attribute:!1})],T.prototype,"analyticsHandler",void 0);s([K("infinite-scroller")],T.prototype,"infiniteScroller",void 0);T=s([A("collection-browser")],T);let he=class extends I{constructor(){super(...arguments),this.searchService=this.initSearchServiceFromUrlParams(),this.resizeObserver=new fs,this.localCache=new ls,this.collectionNameCache=new gs({searchService:this.searchService,localCache:this.localCache}),this.cellWidth=18,this.cellHeight=29,this.rowGap=1.7,this.colGap=1.7,this.loggedIn=!1,this.searchType=ve.METADATA,this.analyticsManager=new Hr,this.analyticsHandler={sendPing:this.sendAnalytics.bind(this),sendEvent:this.sendAnalytics.bind(this),sendEventNoSampling:this.sendAnalytics.bind(this)}}sendAnalytics(e){var t;console.log("Analytics Received ----",e),this.latestAction=e,(t=this.analyticsManager)===null||t===void 0||t.sendEvent(e)}initSearchServiceFromUrlParams(){var e,t,i;const o=new URL(window.location.href).searchParams;return new qe({includeCredentials:!1,baseUrl:(e=o.get("search_base_url"))!==null&&e!==void 0?e:void 0,servicePath:(t=o.get("search_service_path"))!==null&&t!==void 0?t:void 0,debuggingEnabled:(i=!!o.get("debugging"))!==null&&i!==void 0?i:void 0})}searchPressed(e){e.preventDefault(),this.searchQuery=this.baseQueryField.value,this.collectionBrowser.searchType=this.searchType,this.goToCurrentPage()}collectionChanged(e){e.preventDefault(),this.withinCollection=this.baseCollectionField.value,this.collectionBrowser.withinCollection=this.withinCollection,this.goToCurrentPage()}goToCurrentPage(){var e;const t=(e=this.currentPage)!==null&&e!==void 0?e:1;t>1&&this.collectionBrowser.goToPage(t)}changePagePressed(e){e.preventDefault(),this.currentPage=this.pageNumberInput.valueAsNumber,this.collectionBrowser.goToPage(this.currentPage)}updated(e){e.has("currentPage")&&this.currentPage&&(this.pageNumberInput.value=this.currentPage.toString()),e.has("searchQuery")&&this.queryUpdated()}queryUpdated(){this.collectionBrowser.baseQuery=this.searchQuery}get getClass(){return new URLSearchParams(window.location.search).get("hide-dev-tools")?"hidden":""}render(){var e,t;return h`
