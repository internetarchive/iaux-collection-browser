 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ms=({finisher:r,descriptor:e})=>(t,i)=>{var o;if(i===void 0){const a=(o=t.originalKey)!==null&&o!==void 0?o:t.key,s=e!=null?{kind:"method",placement:"prototype",key:a,descriptor:e(t.key)}:xe(se({},t),{key:a});return r!=null&&(s.finisher=function(n){r(n,a)}),s}{const a=t.constructor;e!==void 0&&Object.defineProperty(t,i,e(i)),r==null||r(a,i)}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ol=r=>Rl(r)?Bl(r.strings,r.values):r;/**
 * @license
...
`;let ci=class extends F{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1,this.isCompactTile=!1}render(){return c`<div class="icon-overlay ${this.getClass}">
    ...
    `}};l([h({type:Boolean})],ci.prototype,"loggedIn",void 0);l([h({type:Boolean})],ci.prototype,"loginRequired",void 0);l([h({type:Boolean})],ci.prototype,"isCompactTile",void 0);ci=l([R("icon-overlay")],ci);let hi=class extends F{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1,this.iconRequired=!1}render(){return c`
...
`;let Oe=class extends F{constructor(){super(...arguments),this.isListTile=!1,this.isCompactTile=!1,this.loggedIn=!1,this.isWaveform=!1,this.isNotFound=!1}render(){return c`
    ...
    `}get imageSrc(){var e,t;if(this.isNotFound)return this.notFoundSrc;if(((e=this.model)===null||e===void 0?void 0:e.captureDates)&&this.model.identifier)try{const i=new URL(this.model.identifier),o=encodeURIComponent(i.hostname);return this.baseImageUrl?`https://web.archive.org/thumb/${o}?generate=1`:y}catch{return`${this.baseImageUrl}/images/notfound.png`}return this.baseImageUrl&&((t=this.model)===null||t===void 0?void 0:t.identifier)?`${this.baseImageUrl}/services/img/${this.model.identifier}`:y}get notFoundSrc(){return this.baseImageUrl?`${this.baseImageUrl}/images/notfound.png`:y}get hashBasedGradient(){var e;return!((e=this.model)===null||e===void 0)&&e.identifier?`waveform-grad${this.hashStrToInt(this.model.identifier)%6}`:"waveform-grad0"}hashStrToInt(e){return e.split("").reduce((t,i)=>t+i.charCodeAt(0),0)}get itemBaseClass(){var e;return{"drop-shadow":!0,"list-box":this.isListTile,"search-image":((e=this.model)===null||e===void 0?void 0:e.mediatype)==="search",[this.hashBasedGradient]:this.isWaveform}}get itemImageClass(){var e,t,i;const o=((e=this.model)===null||e===void 0?void 0:e.contentWarning)||((t=this.model)===null||t===void 0?void 0:t.loginRequired);return{contain:!this.isCompactTile&&!this.isWaveform,cover:this.isCompactTile,blur:o||!1,waveform:this.isWaveform,"account-image":this.isAccountImage,"collection-image":((i=this.model)===null||i===void 0?void 0:i.mediatype)==="collection"}}get isAccountImage(){var e;return((e=this.model)===null||e===void 0?void 0:e.mediatype)==="account"&&!this.isCompactTile&&!this.isListTile}onLoad(){var e,t;(((e=this.model)===null||e===void 0?void 0:e.mediatype)==="audio"||((t=this.model)===null||t===void 0?void 0:t.mediatype)==="etree")&&this.baseImage.naturalWidth/this.baseImage.naturalHeight===4&&(this.isWaveform=!0)}onError(){this.isNotFound=!0}static get styles(){return[pn,un,m`
      ...
      `]}};l([h({type:Object})],Oe.prototype,"model",void 0);l([h({type:String})],Oe.prototype,"baseImageUrl",void 0);l([h({type:Boolean})],Oe.prototype,"isListTile",void 0);l([h({type:Boolean})],Oe.prototype,"isCompactTile",void 0);l([h({type:Boolean})],Oe.prototype,"loggedIn",void 0);l([z()],Oe.prototype,"isWaveform",void 0);l([z()],Oe.prototype,"isNotFound",void 0);l([K("img")],Oe.prototype,"baseImage",void 0);Oe=l([R("item-image")],Oe);const vn=I`
...
`,Cn={account:{color:"#000000",icon:vn,text:"Account"},audio:{color:"#00adef",icon:fn,text:"Audio"},collection:{color:"#4666ff",icon:ks,text:"Collection"},data:{color:"#333333",icon:mn,text:"Data"},etree:{color:"#00adef",icon:gn,text:"E-tree"},film:{color:"#bf1b2c",icon:va,text:"Film"},image:{color:"#aa99c9",icon:bn,text:"Image"},movies:{color:"#f1644b",icon:va,text:"Movie"},radio:{color:"#8fdaef",icon:yn,text:"Radio"},software:{color:"#9ecc4f",icon:wn,text:"Software"},texts:{color:"#faab3c",icon:xn,text:"Text"},tv:{color:"#f1644b",icon:_n,text:"TV"},video:{color:"#f1644b",icon:$n,text:"Video"},web:{color:"#ffcd27",icon:Sn,text:"Web"},search:{color:"#000000",icon:zs,text:"Search"}};let pi=class extends F{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var e,t;const i=["tvnews","tvarchive","television"],o=["radio","radioprogram"];return this.mediatype==="movies"&&((e=this.collections)===null||e===void 0?void 0:e.some(a=>i.indexOf(a)>=0))?"tv":this.mediatype==="audio"&&((t=this.collections)===null||t===void 0?void 0:t.some(a=>o.indexOf(a)>=0))?"radio":this.mediatype||""}render(){const e=Cn[this.displayMediatype];return e?c`
      <div
        id="icon"
...
`;function Mn(r,e){let t=1;return r>=1e9?t=1e9:r>=1e6?t=1e6:r>=1e3&&e==="short"&&(t=1e3),t}function zn(r=0,e){const t=r/e,i=t<10;let o=0;return i?o=Math.round((t+Number.EPSILON)*10)/10:o=Math.round(t),o}function Pn(r,e,t,i){switch(e){case 1e9:return P(t==="short"?lt`${r}B`:lt`${r} billion`);case 1e6:return P(t==="short"?lt`${r}M`:lt`${r} million`);case 1e3:return P(t==="short"?lt`${r}K`:lt`${r} thousand`);default:return new Intl.NumberFormat(i).format(r)}}function ai(r,e="long",t="short",i="en-US"){const o=r!=null?r:-1;if(o<0)return"";const a=Mn(o,e),s=zn(o,a);return Pn(s,a,t,i)}let Ye=class extends F{render(){var e,t,i,o,a;const s=ai(this.favCount,"short","short"),n=ai(this.commentCount,"short","short"),d=this.mediatype==="account"?`${(e=this.itemCount)!==null&&e!==void 0?e:0} uploads`:`${(t=this.viewCount)!==null&&t!==void 0?t:0} ${(i=this.viewLabel)!==null&&i!==void 0?i:"all-time views"}`;return c`
...
`+ye),mt&&Ti([Je,et,tt],ot=>{ye=ei(ye,ot," ")}),A&&_i?A.createHTML(ye):ye},e.setConfig=function(){let M=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};so(M),eo=!0},e.clearConfig=function(){xt=null,eo=!1},e.isValidAttribute=function(M,v,x){xt||so({});const C=ce(M),j=ce(v);return Hr(C,j,x)},e.addHook=function(M,v){typeof v=="function"&&(be[M]=be[M]||[],Jt(be[M],v))},e.removeHook=function(M){if(be[M])return ma(be[M])},e.removeHooks=function(M){be[M]&&(be[M]=[])},e.removeAllHooks=function(){be={}},e}var Di=Rs();let Wi=class extends de{constructor(){super(...arguments),this.collectionLinks=[]}render(){return c`
    ...
    `}};l([h({type:Object})],Wi.prototype,"collectionTitles",void 0);l([z()],Wi.prototype,"collectionLinks",void 0);Wi=l([R("tile-list")],Wi);let Xe=class extends F{constructor(){super(...arguments),this.loggedIn=!1}render(){return c`
      <div id="container">
        <tile-list
          .model=${this.model}
...
fill=""></path>
  ...
  `;ar=l([Gs("ia-icon-label")],ar);let sr=class extends F{constructor(){super(...arguments),this.numResults=0}render(){return c`
    ...
    `}};l([h({type:Number})],sr.prototype,"numResults",void 0);sr=l([R("alpha-bar-tooltip")],sr);let We=class extends F{constructor(){super(...arguments),this.selectedLetter=null,this.tooltipShown=!1,this.alphabet="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("")}get selectedUppercaseLetter(){var e;return(e=this.selectedLetter)===null||e===void 0?void 0:e.toUpperCase()}render(){var e;return c`
...
`;let Ot=class extends F{constructor(){super(...arguments),this.label=P("Select items to remove"),this.showSelectAll=!1,this.showUnselectAll=!1,this.removeAllowed=!1}render(){return c`
    ...
    `}};l([h({type:String})],Ot.prototype,"label",void 0);l([h({type:Boolean})],Ot.prototype,"showSelectAll",void 0);l([h({type:Boolean})],Ot.prototype,"showUnselectAll",void 0);l([h({type:Boolean})],Ot.prototype,"removeAllowed",void 0);Ot=l([R("manage-bar")],Ot);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const si=(r,e)=>{var t,i;const o=r._$AN;if(o===void 0)return!1;for(const a of o)(i=(t=a)._$AO)===null||i===void 0||i.call(t,e,!1),si(a,e);return!0},qi=r=>{let e,t;do{if((e=r._$AM)===void 0)break;t=e._$AN,t.delete(r),r=e}while((t==null?void 0:t.size)===0)},qs=r=>{for(let e;e=r._$AM;r=e){let t=e._$AN;if(t===void 0)e._$AN=t=new Set;else if(t.has(r))break;t.add(r),Id(e)}};function Od(r){this._$AN!==void 0?(qi(this),this._$AM=r,qs(this)):this._$AM=r}function Fd(r,e=!1,t=0){const i=this._$AH,o=this._$AN;if(o!==void 0&&o.size!==0)if(e)if(Array.isArray(i))for(let a=t;a<i.length;a++)si(i[a],!1),qi(i[a]);else i!=null&&(si(i,!1),qi(i));else si(this,r)}const Id=r=>{var e,t,i,o;r.type==De.CHILD&&((e=(i=r)._$AP)!==null&&e!==void 0||(i._$AP=Fd),(t=(o=r)._$AQ)!==null&&t!==void 0||(o._$AQ=Od))};class Nd extends yi{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,i){super._$AT(e,t,i),qs(this),this.isConnected=e._$AU}_$AO(e,t=!0){var i,o;e!==this.isConnected&&(this.isConnected=e,e?(i=this.reconnected)===null||i===void 0||i.call(this):(o=this.disconnected)===null||o===void 0||o.call(this)),t&&(si(this,e),qi(this))}setValue(e){if(gs(this._$Ct))this._$Ct._$AI(e,this);else{const t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}}const Ro=new WeakMap,Ud=bi(class extends Nd{render(r){return y}update(r,[e]){var t;const i=e!==this.U;return i&&this.U!==void 0&&this.ot(void 0),(i||this.rt!==this.lt)&&(this.U=e,this.ht=(t=r.options)===null||t===void 0?void 0:t.host,this.ot(this.lt=r.element)),y}ot(r){var e;if(typeof this.U=="function"){const t=(e=this.ht)!==null&&e!==void 0?e:globalThis;let i=Ro.get(t);i===void 0&&(i=new WeakMap,Ro.set(t,i)),i.get(this.U)!==void 0&&this.U.call(this.ht,void 0),i.set(this.U,r),r!==void 0&&this.U.call(this.ht,r)}else this.U.value=r}get rt(){var r,e,t;return typeof this.U=="function"?(e=Ro.get((r=this.ht)!==null&&r!==void 0?r:globalThis))===null||e===void 0?void 0:e.get(this.U):(t=this.U)===null||t===void 0?void 0:t.value}disconnected(){this.rt===this.lt&&this.ot(void 0)}reconnected(){this.ot(this.lt)}});/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;let nr=class extends F{constructor(){super(...arguments),this.config=new lr}render(){return c`
    ...
    `}};l([h({type:String,reflect:!0})],Ft.prototype,"mode",void 0);l([h({type:Object})],Ft.prototype,"customModalContent",void 0);l([h({type:Object})],Ft.prototype,"hostBridge",void 0);l([K("modal-template")],Ft.prototype,"modalTemplate",void 0);Ft=l([R("modal-manager")],Ft);var uc=c`
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path
...
`,dr;let Nt=dr=class extends F{render(){return c`${this.facetRowTemplate}`}get facetRowTemplate(){var e,t,i,o;const{bucket:a,facetType:s}=this;if(!a||!s)return y;const n=`${s}:${a.key}-show-only`,d=`${s}:${a.key}-negative`,p=s!=="collection"?c`${(e=a.displayText)!==null&&e!==void 0?e:a.key}`:c`<a href="/details/${a.key}">
    ...
    `}};l([h({type:Object})],Ut.prototype,"facetGroup",void 0);l([h({type:Object})],Ut.prototype,"selectedFacets",void 0);l([h({type:String})],Ut.prototype,"renderOn",void 0);l([h({type:Object})],Ut.prototype,"collectionTitles",void 0);Ut=l([R("facets-template")],Ut);let Ze=class extends F{constructor(){super(...arguments),this.leftValue="",this.rightValue="",this.side="left"}render(){var e,t;return c`
      <div id="container">
    ...
    `}};Ja=l([R("facet-tombstone-row")],Ja);let Fe=class extends F{constructor(){super(...arguments),this.boundEscapeListener=e=>{e.key==="Escape"&&this.closeModal()}}render(){var e,t;return c`
      <div id="container">
