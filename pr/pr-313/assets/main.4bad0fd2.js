...
`;function Pt(r,e="short",t="en-US"){if(!r)return"";const i={};switch(e){case"year-only":i.year="numeric";break;case"short":i.month="short",i.year="numeric";break;case"long":i.year="numeric",i.month="short",i.day="2-digit";break}return new Intl.DateTimeFormat(t,i).format(r)}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*Tt(r,e){if(r!==void 0){let t=0;for(const i of r)yield e(i,t++)}}function pn(r){return new Date(r.getTime()-r.getTimezoneOffset()*1e3*60)}function yr(r){return r?pn(r).toISOString().endsWith("-01-01T00:00:00.000Z"):!1}const As=c`
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*Pi(r,e){const t=typeof e=="function";if(r!==void 0){let i=-1;for(const o of r)i>-1&&(yield t?e(i):e),i++,yield o}}let Vi=class extends I{constructor(){super(...arguments),this.snippets=[],this.viewSize="desktop"}render(){var e;return!((e=this.snippets)===null||e===void 0)&&e.length?c`
      <div class="container">
        <div class="snippet-view ${this.viewSize}">
...
`,Tn={account:{color:"#000000",icon:mn,text:"Account"},audio:{color:"#00adef",icon:gn,text:"Audio"},collection:{color:"#4666ff",icon:Es,text:"Collection"},data:{color:"#333333",icon:bn,text:"Data"},etree:{color:"#00adef",icon:yn,text:"E-tree"},film:{color:"#bf1b2c",icon:ma,text:"Film"},image:{color:"#aa99c9",icon:wn,text:"Image"},movies:{color:"#f1644b",icon:ma,text:"Movie"},radio:{color:"#8fdaef",icon:_n,text:"Radio"},software:{color:"#9ecc4f",icon:xn,text:"Software"},texts:{color:"#faab3c",icon:Sn,text:"Text"},tv:{color:"#f1644b",icon:$n,text:"TV"},video:{color:"#f1644b",icon:Cn,text:"Video"},web:{color:"#ffcd27",icon:kn,text:"Web"},search:{color:"#000000",icon:Ps,text:"Search"}};let pi=class extends I{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var e,t;const i=["tvnews","tvarchive","television"],o=["radio","radioprogram"];return this.mediatype==="movies"&&((e=this.collections)===null||e===void 0?void 0:e.some(a=>i.indexOf(a)>=0))?"tv":this.mediatype==="audio"&&((t=this.collections)===null||t===void 0?void 0:t.some(a=>o.indexOf(a)>=0))?"radio":this.mediatype||""}render(){const e=Tn[this.displayMediatype];return e?c`
      <div
        id="icon"
...
`;function An(r,e){let t=1;return r>=1e9?t=1e9:r>=1e6?t=1e6:r>=1e3&&e==="short"&&(t=1e3),t}function Pn(r=0,e){const t=r/e,i=t<10;let o=0;return i?o=Math.round((t+Number.EPSILON)*10)/10:o=Math.round(t),o}function Ln(r,e,t,i){switch(e){case 1e9:return A(t==="short"?lt`${r}B`:lt`${r} billion`);case 1e6:return A(t==="short"?lt`${r}M`:lt`${r} million`);case 1e3:return A(t==="short"?lt`${r}K`:lt`${r} thousand`);default:return new Intl.NumberFormat(i).format(r)}}function ai(r,e="long",t="short",i="en-US"){const o=r!=null?r:-1;if(o<0)return"";const a=An(o,e),s=Pn(o,a);return Ln(s,a,t,i)}let Xe=class extends I{render(){var e,t,i,o,a;const s=ai(this.favCount,"short","short"),n=ai(this.commentCount,"short","short"),d=this.mediatype==="account"?`${(e=this.itemCount)!==null&&e!==void 0?e:0} uploads`:`${(t=this.viewCount)!==null&&t!==void 0?t:0} ${(i=this.viewLabel)!==null&&i!==void 0?i:"all-time views"}`;return c`
...
`+ye),mt&&Ti([et,tt,it],we=>{ye=ei(ye,we," ")}),L&&xi?L.createHTML(ye):ye},e.setConfig=function(){let M=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};so(M),eo=!0},e.clearConfig=function(){_t=null,eo=!1},e.isValidAttribute=function(M,u,_){_t||so({});const C=ce(M),R=ce(u);return Wr(C,R,_)},e.addHook=function(M,u){typeof u=="function"&&(be[M]=be[M]||[],Jt(be[M],u))},e.removeHook=function(M){if(be[M])return ba(be[M])},e.removeHooks=function(M){be[M]&&(be[M]=[])},e.removeAllHooks=function(){be={}},e}var Di=Fs();let Wi=class extends de{constructor(){super(...arguments),this.collectionLinks=[]}render(){return c`
    ...
    `}get datePublishedTemplate(){var e;const t=(e=this.model)===null||e===void 0?void 0:e.datePublished;let i="long";return yr(t)&&(i="year-only"),this.metadataTemplate(Pt(t,i),A("Published"))}get dateSortByTemplate(){return this.sortParam&&(this.sortParam.field==="addeddate"||this.sortParam.field==="reviewdate"||this.sortParam.field==="publicdate")?this.metadataTemplate(Pt(this.date,"long"),this.displayValueProvider.dateLabel):y}get viewsTemplate(){var e,t,i,o;const a=((e=this.sortParam)===null||e===void 0?void 0:e.field)==="week"?(t=this.model)===null||t===void 0?void 0:t.weeklyViewCount:(i=this.model)===null||i===void 0?void 0:i.viewCount;return a==null?y:((o=this.model)===null||o===void 0?void 0:o.mediatype)==="search"?this.metadataTemplate("(Favorited search query)",""):this.metadataTemplate(`${ai(a,this.formatSize)}`,A("Views"))}get ratingTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.averageRating,A("Avg Rating"))}get reviewsTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.commentCount,A("Reviews"))}get topicsTemplate(){var e;return!(!((e=this.model)===null||e===void 0)&&e.subjects)||this.model.subjects.length===0?y:c`
...
`;let G=class extends I{constructor(){super(...arguments),this.defaultSortDirection=null,this.defaultSortField=S.relevance,this.sortDirection=null,this.selectedSort=S.default,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.showRelevance=!0,this.showDateFavorited=!1,this.enableSortOptionsSlot=!1,this.suppressDisplayModes=!1,this.lastSelectedViewSort=S.weeklyview,this.lastSelectedDateSort=this.defaultDateSortField,this.alphaSelectorVisible=null,this.dropdownBackdropVisible=!1,this.desktopSortContainerWidth=0,this.selectorBarContainerWidth=0,this.boundSortBarSelectorEscapeListener=e=>{e.key==="Escape"&&this.closeDropdowns()}}render(){return c`
    ...
    `}getSortDisplayOption(e,t){var i,o;const a=(i=t==null?void 0:t.selected)!==null&&i!==void 0?i:this.finalizedSortField===e,s=(o=t==null?void 0:t.displayName)!==null&&o!==void 0?o:$e[e].displayName;return c`
      <button
        class=${a?"selected":y}
        data-title="${s}"
...
`;let nr=class extends I{constructor(){super(...arguments),this.config=new lr}render(){return c`
    ...
    `}static get styles(){const e=m`var(--modalLogoSize, 6.5rem)`,t=m`var(--processingImageSize, 7.5rem)`,i=m`var(--modalCornerRadius, 1rem)`,o=m`var(--modalBorder, 2px solid black)`,a=m`var(--modalBottomMargin, 2.5rem)`,s=m`var(--modalTopMargin, 5rem)`,n=m`var(--modalHeaderBottomPadding, 0.5em)`,d=m`var(--modalBottomPadding, 2rem)`,p=m`var(--modalScrollOffset, 5px)`,v=m`var(--modalTitleFontSize, 1.8rem)`,f=m`var(--modalSubtitleFontSize, 1.4rem)`,g=m`var(--modalHeadlineFontSize, 1.6rem)`,w=m`var(--modalMessageFontSize, 1.4rem)`,x=m`var(--modalTitleLineHeight, normal)`,$=m`var(--modalSubtitleLineHeight, normal)`,D=m`var(--modalHeadlineLineHeight, normal)`,H=m`var(--modalMessageLineHeight, normal)`;return m`
      .processing-logo {
        margin: auto;
        width: ${t};
        height: ${t};
    ...
    `}};l([h({type:Object})],nr.prototype,"config",void 0);nr=l([B("modal-template")],nr);function uc(r,e,t){var i=t||{},o=i.noTrailing,a=o===void 0?!1:o,s=i.noLeading,n=s===void 0?!1:s,d=i.debounceMode,p=d===void 0?void 0:d,v,f=!1,g=0;function w(){v&&clearTimeout(v)}function x(D){var H=D||{},P=H.upcomingOnly,L=P===void 0?!1:P;w(),f=!L}function $(){for(var D=arguments.length,H=new Array(D),P=0;P<D;P++)H[P]=arguments[P];var L=this,U=Date.now()-g;if(f)return;function Y(){g=Date.now(),e.apply(L,H)}function ne(){v=void 0}!n&&p&&!v&&Y(),w(),p===void 0&&U>r?n?(g=Date.now(),a||(v=setTimeout(p?ne:Y,r))):Y():a!==!0&&(v=setTimeout(p?ne:Y,p===void 0?r-U:r))}return $.cancel=x,$}var ct;(function(r){r.Open="open",r.Closed="closed"})(ct||(ct={}));class vc{constructor(e){this.windowResizeThrottler=uc(100,this.updateModalContainerHeight,{noLeading:!1,noTrailing:!1}).bind(this),this.modalManager=e}handleModeChange(e){switch(e){case ct.Open:this.startResizeListener(),this.stopDocumentScroll();break;case ct.Closed:this.stopResizeListener(),this.resumeDocumentScroll();break}}updateModalContainerHeight(){this.modalManager.style.setProperty("--containerHeight",`${window.innerHeight}px`)}stopDocumentScroll(){document.body.classList.add("modal-manager-open")}resumeDocumentScroll(){document.body.classList.remove("modal-manager-open")}startResizeListener(){window.addEventListener("resize",this.windowResizeThrottler)}stopResizeListener(){window.removeEventListener("resize",this.windowResizeThrottler)}}let Ot=class extends I{constructor(){super(...arguments),this.mode=ct.Closed,this.hostBridge=new vc(this),this.closeOnBackdropClick=!0}render(){return c`
      <div class="container">
...
`,dr;let Nt=dr=class extends I{render(){return c`${this.facetRowTemplate}`}get facetRowTemplate(){var e,t,i,o;const{bucket:a,facetType:s}=this;if(!a||!s)return y;const n=`${s}:${a.key}-show-only`,d=`${s}:${a.key}-negative`,p=s!=="collection"?c`${(e=a.displayText)!==null&&e!==void 0?e:a.key}`:c`<a href="/details/${a.key}">
          ...
          </a> `,v=a.state==="hidden",f=a.state==="selected",g=`${s}: ${(o=a.displayText)!==null&&o!==void 0?o:a.key}`,w=f?`Show all ${s}s`:`Only show ${g}`,x=`Hide ${g}`,$=`Unhide ${g}`,D=v?$:x,H=`${g}, ${a.count} results`;return c`
