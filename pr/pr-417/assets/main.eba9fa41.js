 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ft=Ci(class extends ki{constructor(a){var e;if(super(a),a.type!==Ue.ATTRIBUTE||a.name!=="class"||((e=a.strings)===null||e===void 0?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(a){return" "+Object.keys(a).filter(e=>a[e]).join(" ")+" "}update(a,[e]){var t,i;if(this.et===void 0){this.et=new Set,a.strings!==void 0&&(this.st=new Set(a.strings.join(" ").split(/\s/).filter(s=>s!=="")));for(const s in e)e[s]&&!(!((t=this.st)===null||t===void 0)&&t.has(s))&&this.et.add(s);return this.render(e)}const o=a.element.classList;this.et.forEach(s=>{s in e||(o.remove(s),this.et.delete(s))});for(const s in e){const n=!!e[s];n===this.et.has(s)||((i=this.st)===null||i===void 0?void 0:i.has(s))||(n?(o.add(s),this.et.add(s)):(o.remove(s),this.et.delete(s)))}return Ce}});/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`,Ie;let ke=Ie=class extends D{constructor(){super(...arguments),this.placeholderType=null,this.detailMessage=""}render(){return this.placeholderType?c`${this.placeholderTemplate}`:b}get placeholderTemplate(){return c`
      <div
    ...
    <a href="mailto:info@archive.org">info@archive.org</a>.`);ke.QUERY_ERROR_DETAILS_MESSAGE=k("Error details:");r([h({type:String})],ke.prototype,"placeholderType",void 0);r([h({type:Boolean})],ke.prototype,"isMobileView",void 0);r([h({type:Boolean})],ke.prototype,"isCollection",void 0);r([h({type:String})],ke.prototype,"detailMessage",void 0);ke=Ie=r([L("empty-placeholder")],ke);/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;var ca;(function(a){a[a.bytes=0]="bytes",a[a.kilobytes=1]="kilobytes",a[a.megabytes=2]="megabytes",a[a.gigabytes=3]="gigabytes",a[a.terabytes=4]="terabytes",a[a.petabytes=5]="petabytes",a[a.exabytes=6]="exabytes",a[a.zettabytes=7]="zettabytes",a[a.yottabytes=8]="yottabytes"})(ca||(ca={}));function Pl(a,e,t=" "){let i=a;if(i===void 0)return b;let o=0;for(;i>1024;)i/=1024,o+=1;const s=10**e;i=Math.round(i*s)/s;let n=ca[o];return n=i===1?n.slice(0,-1):n,`${i.toLocaleString()+t+n}`}const Ll=v`var(--tileBackgroundColor, #ffffff)`,Dl=v`var(--tileCornerRadius, 4px)`,no=v`
...
`;let Ve=class extends D{constructor(){super(...arguments),this.isListTile=!1,this.isCompactTile=!1,this.loggedIn=!1,this.isWaveform=!1,this.isNotFound=!1}render(){return c`
    ...
    `}get imageSrc(){var e,t;if(this.isNotFound)return this.notFoundSrc;if(((e=this.model)===null||e===void 0?void 0:e.captureDates)&&this.model.identifier)try{const i=new URL(this.model.identifier),o=encodeURIComponent(i.hostname);return this.baseImageUrl?`https://web.archive.org/thumb/${o}?generate=1`:b}catch{return`${this.baseImageUrl}/images/notfound.png`}return this.baseImageUrl&&((t=this.model)===null||t===void 0?void 0:t.identifier)?`${this.baseImageUrl}/services/img/${this.model.identifier}`:b}get notFoundSrc(){return this.baseImageUrl?`${this.baseImageUrl}/images/notfound.png`:b}get hashBasedGradient(){var e;return!((e=this.model)===null||e===void 0)&&e.identifier?`waveform-grad${this.hashStrToInt(this.model.identifier)%6}`:"waveform-grad0"}hashStrToInt(e){return e.split("").reduce((t,i)=>t+i.charCodeAt(0),0)}get itemBaseClass(){var e;return{"drop-shadow":!0,"list-box":this.isListTile,"search-image":((e=this.model)===null||e===void 0?void 0:e.mediatype)==="search",[this.hashBasedGradient]:this.isWaveform}}get itemImageClass(){var e,t,i;const o=((e=this.model)===null||e===void 0?void 0:e.contentWarning)||((t=this.model)===null||t===void 0?void 0:t.loginRequired);return{contain:!this.isCompactTile&&!this.isWaveform,cover:this.isCompactTile,blur:o||!1,waveform:this.isWaveform,"account-image":this.isAccountImage,"collection-image":((i=this.model)===null||i===void 0?void 0:i.mediatype)==="collection"}}get isAccountImage(){var e;return((e=this.model)===null||e===void 0?void 0:e.mediatype)==="account"&&!this.isCompactTile&&!this.isListTile}onLoad(){var e,t;(((e=this.model)===null||e===void 0?void 0:e.mediatype)==="audio"||((t=this.model)===null||t===void 0?void 0:t.mediatype)==="etree")&&this.baseImage.naturalWidth/this.baseImage.naturalHeight===4&&(this.isWaveform=!0)}onError(){this.isNotFound=!0}static get styles(){return[Bl,Ol,v`
      ...
      `]}};r([h({type:Object})],Ve.prototype,"model",void 0);r([h({type:String})],Ve.prototype,"baseImageUrl",void 0);r([h({type:Boolean})],Ve.prototype,"isListTile",void 0);r([h({type:Boolean})],Ve.prototype,"isCompactTile",void 0);r([h({type:Boolean})],Ve.prototype,"loggedIn",void 0);r([A()],Ve.prototype,"isWaveform",void 0);r([A()],Ve.prototype,"isNotFound",void 0);r([G("img")],Ve.prototype,"baseImage",void 0);Ve=r([L("item-image")],Ve);const Il=U`
...
`+$e),St&&Ri([rt,nt,lt],Oe=>{$e=oi($e,Oe," ")}),B&&Mi?B.createHTML($e):$e},e.setConfig=function(){let z=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};xo(z),mo=!0},e.clearConfig=function(){Et=null,mo=!1},e.isValidAttribute=function(z,u,_){Et||xo({});const E=ue(z),j=ue(u);return hs(E,j,_)},e.addHook=function(z,u){typeof u=="function"&&(Se[z]=Se[z]||[],ii(Se[z],u))},e.removeHook=function(z){if(Se[z])return Is(Se[z])},e.removeHooks=function(z){Se[z]&&(Se[z]=[])},e.removeAllHooks=function(){Se={}},e}var Ui=tn();let Yi=class extends ce{constructor(){super(...arguments),this.collectionLinks=[]}render(){return c`
    ...
    `}};r([h({type:Object})],Yi.prototype,"collectionTitles",void 0);r([A()],Yi.prototype,"collectionLinks",void 0);Yi=r([L("tile-list")],Yi);let We=class extends D{constructor(){super(...arguments),this.loggedIn=!1}render(){return c`
      <div id="container">
        ${this.headerTemplate}
    ...
    `}};r([h({type:Object})],We.prototype,"model",void 0);r([h({type:String})],We.prototype,"baseNavigationUrl",void 0);r([h({type:String})],We.prototype,"baseImageUrl",void 0);r([h({type:Boolean})],We.prototype,"loggedIn",void 0);r([h({type:Object})],We.prototype,"sortParam",void 0);r([h({type:Number})],We.prototype,"mobileBreakpoint",void 0);r([h({type:Number})],We.prototype,"currentWidth",void 0);r([h({type:Object})],We.prototype,"collectionTitles",void 0);We=r([L("tile-hover-pane")],We);let qs=class extends ce{render(){var e,t,i,o,s,n;return c`
      <div id="list-line" class="${this.classSize}">
        <image-block
          .model=${this.model}
          .baseImageUrl=${this.baseImageUrl}
...
fill=""></path>
  ...
  `;r([h({type:String})],Je.prototype,"selectedLetter",void 0);r([h({type:Object})],Je.prototype,"letterCounts",void 0);r([h({type:String})],Je.prototype,"ariaLandmarkLabel",void 0);r([A()],Je.prototype,"tooltipShown",void 0);r([A()],Je.prototype,"hoveredLetter",void 0);r([G("alpha-bar-tooltip")],Je.prototype,"tooltip",void 0);Je=r([L("alpha-bar")],Je);const Wd=c`
...
`;let Ta=class extends D{constructor(){super(...arguments),this.config=new Lt}render(){return c`
    ...
    `}static get styles(){const e=v`var(--modalLogoSize, 6.5rem)`,t=v`var(--processingImageSize, 7.5rem)`,i=v`var(--modalCornerRadius, 1rem)`,o=v`var(--modalBorder, 2px solid black)`,s=v`var(--modalBottomMargin, 2.5rem)`,n=v`var(--modalTopMargin, 5rem)`,l=v`var(--modalHeaderBottomPadding, 0.5em)`,d=v`var(--modalBottomPadding, 2rem)`,p=v`var(--modalScrollOffset, 5px)`,f=v`var(--modalTitleFontSize, 1.8rem)`,m=v`var(--modalSubtitleFontSize, 1.4rem)`,y=v`var(--modalHeadlineFontSize, 1.6rem)`,w=v`var(--modalMessageFontSize, 1.4rem)`,x=v`var(--modalTitleLineHeight, normal)`,C=v`var(--modalSubtitleLineHeight, normal)`,P=v`var(--modalHeadlineLineHeight, normal)`,F=v`var(--modalMessageLineHeight, normal)`;return v`
      .processing-logo {
        margin: auto;
        width: ${t};
        height: ${t};
...
`;let Ji=class extends D{constructor(){super(...arguments),this.items=[]}render(){return c`
    ...
    `}};r([h({type:Object})],Ji.prototype,"items",void 0);r([h({type:String})],Ji.prototype,"message",void 0);Ji=r([L("remove-items-modal-content")],Ji);let De=class extends D{constructor(){super(...arguments),this.label=k("Select items to remove"),this.selectedItems=[],this.showSelectAll=!1,this.showUnselectAll=!1,this.showItemManageButton=!1,this.removeAllowed=!1}render(){return c`
...
`;let se=class extends D{constructor(){super(...arguments),this.prompt="Do you find this feature useful?",this.buttonText="Beta",this.isOpen=!1,this.processing=!1,this.popupTopX=0,this.popupTopY=0,this.voteSubmitted=!1,this.voteNeedsChoosing=!1,this.resizingElement=document.body}render(){return c`
    ...
    `}};r([h({type:String})],se.prototype,"featureIdentifier",void 0);r([h({type:String})],se.prototype,"prompt",void 0);r([h({type:String})],se.prototype,"buttonText",void 0);r([h({type:Object})],se.prototype,"recaptchaManager",void 0);r([h({type:Object})],se.prototype,"resizeObserver",void 0);r([h({type:Boolean})],se.prototype,"disabled",void 0);r([h({type:Object})],se.prototype,"featureFeedbackService",void 0);r([G("#beta-button")],se.prototype,"betaButton",void 0);r([G("#popup")],se.prototype,"popup",void 0);r([A()],se.prototype,"isOpen",void 0);r([A()],se.prototype,"processing",void 0);r([A()],se.prototype,"popupTopX",void 0);r([A()],se.prototype,"popupTopY",void 0);r([A()],se.prototype,"vote",void 0);r([A()],se.prototype,"voteSubmitted",void 0);r([A()],se.prototype,"error",void 0);r([A()],se.prototype,"voteNeedsChoosing",void 0);r([A()],se.prototype,"recaptchaWidget",void 0);r([G("#comments")],se.prototype,"comments",void 0);se=r([L("feature-feedback")],se);var Bc=c`
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path
...
`;let Ht=class extends D{constructor(){super(...arguments),this.step=2,this.currentPage=1,this.pages=[]}firstUpdated(){this.observePageCount()}updated(e){e.has("size")&&this.observePageCount(),e.has("currentPage")&&(this.observePageCount(),this.emitPageClick())}observePageCount(){this.pages=[];const e=7,t=this.size<=e;if(this.size<=5){this.pages=[...Array(this.size).keys()].map(s=>s+1);return}if(this.size===e){if(this.currentPage===2){this.pages=[1,2,3,4,0,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,4,5,this.size-1,this.size];return}}if(this.currentPage===1){this.pages=[1,2,3,0,this.size];return}if(this.currentPage===this.size){this.pages=[1,0,this.size-2,this.size-1,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,this.size-3,this.size-2,this.size-1,this.size];return}if(t&&this.currentPage>1&&this.currentPage<e){this.pages=[...Array(this.size).keys()].map(s=>s+1);return}let i=this.currentPage-this.step,o=this.currentPage+this.step;i<=0&&(o+=-i+1,i=1),o>=this.size&&(i=Math.max(i-(o-this.size),1),o=this.size),i===2&&(o-=1),o===this.size-1&&(i+=1),this.createFirstNode(i),this.createMiddelNode(i,o),this.createLastNode(o)}createFirstNode(e){var t,i;e>1&&((t=this.pages)===null||t===void 0||t.push(1)),e>2&&((i=this.pages)===null||i===void 0||i.push(0))}createMiddelNode(e,t){var i;for(let o=e;o<=t;o+=1)(i=this.pages)===null||i===void 0||i.push(o)}createLastNode(e){var t,i;e<this.size-1&&((t=this.pages)===null||t===void 0||t.push(0)),e<this.size&&((i=this.pages)===null||i===void 0||i.push(this.size))}get getEllipsisTemplate(){return c`<i class="ellipses">...</i>`}emitPageClick(){this.dispatchEvent(new CustomEvent("pageNumberClicked",{detail:{page:this.currentPage},bubbles:!0,composed:!0}))}onRewind(){this.currentPage-=1,this.currentPage<1&&(this.currentPage=1)}onForward(){this.currentPage+=1,this.currentPage>this.size&&(this.currentPage=this.size)}onChange(e){this.currentPage=e}getPageTemplate(e){return c`
    ...
    `}static get styles(){return[et,v`
      ...
      `]}};r([h({type:Number})],Ht.prototype,"size",void 0);r([h({type:Number})],Ht.prototype,"step",void 0);r([h({type:Number})],Ht.prototype,"currentPage",void 0);r([A()],Ht.prototype,"pages",void 0);Ht=r([L("more-facets-pagination")],Ht);var Uc=U`
...
`,Ea;let wi=Ea=class extends D{render(){return c`${this.facetRowTemplate}`}get facetRowTemplate(){var e,t,i,o;const{bucket:s,facetType:n}=this;if(!s||!n)return b;const l=`${n}:${s.key}-show-only`,d=`${n}:${s.key}-negative`,p=n!=="collection"?c`${(e=s.displayText)!==null&&e!==void 0?e:s.key}`:c`<a href="/details/${s.key}">
          ...
          </a> `,f=s.state==="hidden",m=s.state==="selected",y=`${n}: ${(o=s.displayText)!==null&&o!==void 0?o:s.key}`,w=m?`Show all ${n}s`:`Only show ${y}`,x=`Hide ${y}`,C=`Unhide ${y}`,P=f?C:x,F=`${y}, ${s.count} results`;return c`
...
`;function qc(a){return a&&a.charAt(0).toLocaleUpperCase()+a.slice(1)}let _i=class extends D{constructor(){super(...arguments),this.selected=!1}render(){var e,t;if(!this.facetInfo)return b;const i=this.facetInfo.facets.length===1,o=this.facetInfo.facets[0],s=qc((this.labelPrefix?`${this.labelPrefix} `:"")+((t=(e=this.facetInfo.label)!==null&&e!==void 0?e:o.displayText)!==null&&t!==void 0?t:o.bucketKey));if(!s)return b;const n=i&&o.facetType==="mediatype"?Yr[o.bucketKey].icon:b;return c`
  ...
  `;r([A()],re.prototype,"toggleSlots",void 0);r([A()],re.prototype,"currentPage",void 0);r([A()],re.prototype,"searchQuery",void 0);r([A()],re.prototype,"withinCollection",void 0);r([A()],re.prototype,"cellWidth",void 0);r([A()],re.prototype,"cellHeight",void 0);r([A()],re.prototype,"rowGap",void 0);r([A()],re.prototype,"colGap",void 0);r([A()],re.prototype,"suppressFacets",void 0);r([A()],re.prototype,"lazyLoadFacets",void 0);r([A()],re.prototype,"loggedIn",void 0);r([A()],re.prototype,"searchType",void 0);r([h({type:Object,reflect:!1})],re.prototype,"latestAction",void 0);r([G("#base-query-field")],re.prototype,"baseQueryField",void 0);r([G("#base-collection-field")],re.prototype,"baseCollectionField",void 0);r([G("#page-number-input")],re.prototype,"pageNumberInput",void 0);r([G("collection-browser")],re.prototype,"collectionBrowser",void 0);r([G("modal-manager")],re.prototype,"modalManager",void 0);re=r([L("app-root")],re);
