 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const zl=(r,...e)=>({strTag:!0,strings:r,values:e}),at=zl,Ll=r=>typeof r!="string"&&"strTag"in r,Pl=(r,e,t)=>{let i=r[0];for(let o=1;o<r.length;o++)i+=e[o-1],i+=r[o];return i};/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;function Fi(r,e="short",t="en-US"){if(!r)return"";const i={};switch(e){case"year-only":return`${r.getUTCFullYear()}`;case"short":i.month="short",i.year="numeric";break;case"long":i.year="numeric",i.month="short",i.day="2-digit";break}return new Intl.DateTimeFormat(t,i).format(r)}class ra{constructor(e={}){var t;this.model=e.model,this.baseNavigationUrl=e.baseNavigationUrl,this.collectionPagePath=(t=e.collectionPagePath)!==null&&t!==void 0?t:"/details/",this.sortParam=e.sortParam,this.creatorFilter=e.creatorFilter}get firstCreatorMatchingFilter(){var e,t;let i;if(this.creatorFilter&&(!((e=this.model)===null||e===void 0)&&e.creators.length)){const o=this.creatorFilter;i=this.model.creators.find(s=>s.normalize("NFD").replace(/[^A-Z]+/gi,"").toUpperCase().startsWith(o))}return i??((t=this.model)===null||t===void 0?void 0:t.creator)}get accountLabel(){var e;return!((e=this.model)===null||e===void 0)&&e.dateAdded?C(at`Archivist since ${this.model.dateAdded.getFullYear()}`):""}get dateLabel(){var e;switch((e=this.sortParam)===null||e===void 0?void 0:e.field){case"publicdate":return C("Archived");case"reviewdate":return C("Reviewed");case"addeddate":return C("Added");case"date":return C("Published");default:return""}}itemPageUrl(e,t=!1){if(!e||this.baseNavigationUrl==null)return b;const i=t?this.collectionPagePath:"/details/";return`${this.baseNavigationUrl}${i}${e}`}webArchivesCaptureLink(e,t){const o=`https://web.archive.org/web/${t.toISOString().replace(/[TZ:-]/g,"").replace(/\..*/,"")}/${encodeURIComponent(e)}`,s=Fi(t,"long");return h` <a href=${o}> ${s} </a> `}}class de extends B{constructor(){super(...arguments),this.sortParam=null,this.defaultSortParam=null,this.loggedIn=!1,this.displayValueProvider=new ra}willUpdate(e){var t,i;(e.has("model")||e.has("baseNavigationUrl")||e.has("collectionPagePath")||e.has("sortParam")||e.has("defaultSortParam")||e.has("creatorFilter"))&&(this.displayValueProvider=new ra({model:this.model,baseNavigationUrl:this.baseNavigationUrl,collectionPagePath:this.collectionPagePath,sortParam:(i=(t=this.sortParam)!==null&&t!==void 0?t:this.defaultSortParam)!==null&&i!==void 0?i:void 0,creatorFilter:this.creatorFilter}))}}n([c({type:Object})],de.prototype,"model",void 0);n([c({type:Number})],de.prototype,"currentWidth",void 0);n([c({type:Number})],de.prototype,"currentHeight",void 0);n([c({type:String})],de.prototype,"baseNavigationUrl",void 0);n([c({type:String})],de.prototype,"baseImageUrl",void 0);n([c({type:String})],de.prototype,"collectionPagePath",void 0);n([c({type:Object})],de.prototype,"sortParam",void 0);n([c({type:Object})],de.prototype,"defaultSortParam",void 0);n([c({type:String})],de.prototype,"creatorFilter",void 0);n([c({type:Number})],de.prototype,"mobileBreakpoint",void 0);n([c({type:Boolean})],de.prototype,"loggedIn",void 0);let Ar=class extends B{render(){return h`<div class="icon-overlay">${this.iconTemplate}</div>`}get iconTemplate(){var e;return this.type?h`${(e=sn[this.type])!==null&&e!==void 0?e:b}`:b}static get styles(){return m`
    ...
    `}get iconTemplate(){var e;return this.type?h`${(e=sn[this.type])!==null&&e!==void 0?e:b}`:b}get textTemplate(){var e;return this.type?h`${(e=jl[this.type])!==null&&e!==void 0?e:b}`:b}static get styles(){return m`
      :host {
        align-items: center;
        display: flex;
      }
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*Ct(r,e){if(r!==void 0){let t=0;for(const i of r)yield e(i,t++)}}function dd(r){return new Date(r.getTime()-r.getTimezoneOffset()*1e3*60)}function rs(r){return r?dd(r).toISOString().endsWith("-01-01T00:00:00.000Z"):!1}const fn=h`
...
`,vn={account:{color:"#000000",icon:ud,text:"Account"},audio:{color:"#00adef",icon:fd,text:"Audio"},collection:{color:"#4666ff",icon:un,text:"Collection"},data:{color:"#333333",icon:md,text:"Data"},etree:{color:"#00adef",icon:vd,text:"E-tree"},film:{color:"#bf1b2c",icon:sa,text:"Film"},image:{color:"#aa99c9",icon:gd,text:"Image"},movies:{color:"#f1644b",icon:sa,text:"Movie"},radio:{color:"#8fdaef",icon:bd,text:"Radio"},software:{color:"#9ecc4f",icon:yd,text:"Software"},texts:{color:"#faab3c",icon:wd,text:"Text"},tv:{color:"#f1644b",icon:xd,text:"TV"},video:{color:"#f1644b",icon:Sd,text:"Video"},web:{color:"#ffcd27",icon:$d,text:"Web"},search:{color:"#000000",icon:mn,text:"Search"}};let Ri=class extends B{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var e,t;const i=["tvnews","tvarchive","television"],o=["radio","radioprogram"];return this.mediatype==="movies"&&(!((e=this.collections)===null||e===void 0)&&e.some(s=>i.indexOf(s)>=0))?"tv":this.mediatype==="audio"&&(!((t=this.collections)===null||t===void 0)&&t.some(s=>o.indexOf(s)>=0))?"radio":this.mediatype||""}render(){const e=vn[this.displayMediatype];return e?h`
      <div
        id="icon"
...
`;var Wr;let Bi=Wr=class extends B{render(){return h`${this.facetRowTemplate}`}get facetRowTemplate(){var e,t,i,o;const{bucket:s,facetType:a}=this;if(!s||!a)return b;const l=`${a}:${s.key}-show-only`,d=`${a}:${s.key}-negative`,p=s.extraNote?h`<span class="facet-note">${s.extraNote}</span>`:b,u=a!=="collection"?h`${(e=s.displayText)!==null&&e!==void 0?e:s.key} ${p}`:h`<a href="/details/${s.key}">
            ${(i=(t=this.collectionTitles)===null||t===void 0?void 0:t.get(s.key))!==null&&i!==void 0?i:s.key}
          </a> `,v=s.state==="hidden",g=s.state==="selected",y=`${a}: ${(o=s.displayText)!==null&&o!==void 0?o:s.key}`,w=g?`Show all ${a}s`:`Only show ${y}`,$=`Hide ${y}`,T=`Unhide ${y}`,L=v?T:$,M=`${y}, ${s.count} results`;return h`
    ...
    `}get loaderTemplate(){return h`<div class="facets-loader">
      <ia-activity-indicator .mode=${"processing"}></ia-activity-indicator>
        ...
        </div> `:b}sortFacetAggregation(e){this.sortedBy=e,this.dispatchEvent(new CustomEvent("sortedFacets",{detail:this.sortedBy}))}get modalHeaderTemplate(){var e,t,i;const s=((e=this.sortedBy)!==null&&e!==void 0?e:Ti[this.facetKey])===V.COUNT?"left":"right";return h`<span class="sr-only">${C("More facets for:")}</span>
      <span class="title">
    ...
    `}};Ra=n([F("facet-tombstone-row")],Ra);let Be=class extends B{constructor(){super(...arguments),this.dateFormat="YYYY",this.boundEscapeListener=e=>{e.key==="Escape"&&this.closeModal()}}render(){var e,t;return h`
      <div id="container">
    ...
    `}partOfCollectionClicked(e){var t;(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:Ge.default,action:ee.partOfCollectionClicked,label:e.target.dataset.id})}showDatePickerModal(){var e,t,i;const{fullYearsHistogramAggregation:o}=this,s=o==null?void 0:o.first_bucket_key,a=o==null?void 0:o.last_bucket_key,l=o==null?void 0:o.buckets,d=this.isTvSearch?"YYYY-MM":"YYYY",u=h`
    ...
    `,v=new kt({bodyColor:"#fff",headerColor:"#194880",showHeaderLogo:!1,closeOnBackdropClick:!0,title:h`${C("Select a date range")}`});(e=this.modalManager)===null||e===void 0||e.classList.add("expanded-date-picker"),(t=this.modalManager)===null||t===void 0||t.showModal({config:v,customModalContent:u,userClosedModalCallback:this.handleExpandedDatePickerClosed}),(i=this.analyticsHandler)===null||i===void 0||i.sendEvent({category:Ge.default,action:ee.histogramExpanded,label:window.location.href})}updated(e){e.has("selectedFacets")&&this.dispatchFacetsChangedEvent()}dispatchFacetsChangedEvent(){const e=new CustomEvent("facetsChanged",{detail:this.selectedFacets});this.dispatchEvent(e)}get expandDatePickerBtnTemplate(){return this.allowExpandingDatePicker&&!this.facetsLoading?h`<button
        ...
        >
          ${M0}
        </button>`:b}get histogramTemplate(){var e,t;const{fullYearsHistogramAggregation:i}=this,o=i==null?void 0:i.first_bucket_key,s=i==null?void 0:i.last_bucket_key,a=this.isTvSearch?"YYYY-MM":"YYYY";return this.fullYearAggregationLoading?h`<div class="histogram-loading-indicator">&hellip;</div>`:h`
          <histogram-date-range
...
`;function j0(r){return r&&r.charAt(0).toLocaleUpperCase()+r.slice(1)}let Ii=class extends B{constructor(){super(...arguments),this.selected=!1}render(){var e,t;if(!this.facetInfo)return b;const i=this.facetInfo.facets.length===1,o=this.facetInfo.facets[0],s=j0((this.labelPrefix?`${this.labelPrefix} `:"")+((t=(e=this.facetInfo.label)!==null&&e!==void 0?e:o.displayText)!==null&&t!==void 0?t:o.bucketKey));if(!s)return b;const a=i&&o.facetType==="mediatype"?vn[o.bucketKey].icon:b;return h`
      <a
    ...
    `}};n([c({type:Array})],ii.prototype,"facetInfo",void 0);n([c({type:String})],ii.prototype,"labelPrefix",void 0);n([c({type:Object})],ii.prototype,"activeFacetRef",void 0);n([G("ia-dropdown")],ii.prototype,"dropdown",void 0);ii=n([F("smart-facet-dropdown")],ii);const Oa={collection:"Collection: ",creator:"By: ",subject:"About: "};function G0(r){return r.charAt(0).toUpperCase()+r.slice(1)}let Xe=class extends B{constructor(){super(...arguments),this.filterToggleActive=!1,this.heuristicRecs=[],this.smartFacets=[]}render(){return this.query?h`
