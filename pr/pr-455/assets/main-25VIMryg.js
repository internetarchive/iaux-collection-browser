 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*oo(r,e){const t=typeof e=="function";if(r!==void 0){let i=-1;for(const o of r)i>-1&&(yield t?e(i):e),i++,yield o}}let go=class extends B{constructor(){super(...arguments),this.snippets=[],this.viewSize="desktop"}render(){var e;return!((e=this.snippets)===null||e===void 0)&&e.length?c`
      <div class="container">
        <div class="snippet-view ${this.viewSize}">
...
`,mn={account:{color:"#000000",icon:ud,text:"Account"},audio:{color:"#00adef",icon:fd,text:"Audio"},collection:{color:"#4666ff",icon:pn,text:"Collection"},data:{color:"#333333",icon:md,text:"Data"},etree:{color:"#00adef",icon:vd,text:"E-tree"},film:{color:"#bf1b2c",icon:sa,text:"Film"},image:{color:"#aa99c9",icon:gd,text:"Image"},movies:{color:"#f1644b",icon:sa,text:"Movie"},radio:{color:"#8fdaef",icon:bd,text:"Radio"},software:{color:"#9ecc4f",icon:yd,text:"Software"},texts:{color:"#faab3c",icon:wd,text:"Text"},tv:{color:"#f1644b",icon:xd,text:"TV"},video:{color:"#f1644b",icon:Sd,text:"Video"},web:{color:"#ffcd27",icon:$d,text:"Web"},search:{color:"#000000",icon:fn,text:"Search"}};let Ri=class extends B{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var e,t;const i=["tvnews","tvarchive","television"],o=["radio","radioprogram"];return this.mediatype==="movies"&&(!((e=this.collections)===null||e===void 0)&&e.some(s=>i.indexOf(s)>=0))?"tv":this.mediatype==="audio"&&(!((t=this.collections)===null||t===void 0)&&t.some(s=>o.indexOf(s)>=0))?"radio":this.mediatype||""}render(){const e=mn[this.displayMediatype];return e?c`
      <div
        id="icon"
    ...
    `}};n([h({type:String})],Ri.prototype,"mediatype",void 0);n([h({type:Array})],Ri.prototype,"collections",void 0);n([h({type:Boolean})],Ri.prototype,"showText",void 0);Ri=n([F("mediatype-icon")],Ri);const _d=O`
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path
...
`;function Ed(r,e){let t=1;return r>=1e9?t=1e9:r>=1e6?t=1e6:r>=1e3&&e==="short"&&(t=1e3),t}function Md(r=0,e){const t=r/e,i=t<10;let o=0;return i?o=Math.round((t+Number.EPSILON)*10)/10:o=Math.round(t),o}function Ad(r,e,t,i){switch(e){case 1e9:return C(t==="short"?at`${r}B`:at`${r} billion`);case 1e6:return C(t==="short"?at`${r}M`:at`${r} million`);case 1e3:return C(t==="short"?at`${r}K`:at`${r} thousand`);default:return new Intl.NumberFormat(i).format(r)}}function ss(r,e="long",t="short",i="en-US"){const o=r??-1;if(o<0)return"";const s=Ed(o,e),a=Md(o,s);return Ad(a,s,t,i)}let Ye=class extends B{constructor(){super(...arguments),this.showTvClips=!1}render(){return c`
    ...
    `}get sortedDateInfoTemplate(){var e,t,i,o,s;let a,l="long";switch((e=this.effectiveSort)===null||e===void 0?void 0:e.field){case"date":{const d=(t=this.model)===null||t===void 0?void 0:t.datePublished;a={field:"published",value:d},rs(d)&&(l="year-only");break}case"reviewdate":a={field:"reviewed",value:(i=this.model)===null||i===void 0?void 0:i.dateReviewed};break;case"addeddate":a={field:"added",value:(o=this.model)===null||o===void 0?void 0:o.dateAdded};break;case"publicdate":a={field:"archived",value:(s=this.model)===null||s===void 0?void 0:s.dateArchived};break}return a!=null&&a.value?c`
      <div class="date-sorted-by truncated">
        <span>
          ${a==null?void 0:a.field} ${Fi(a==null?void 0:a.value,l)}
        </span>
      </div>
...
`+_e),Ft&&Xi([Oe,Q,ne],He=>{_e=mi(_e,He," ")}),R&&Vi?R.createHTML(_e):_e},e.setConfig=function(){let D=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};No(D),Po=!0},e.clearConfig=function(){Nt=null,Po=!1},e.isValidAttribute=function(D,f,x){Nt||No({});const E=ce(D),X=ce(f);return ks(E,X,x)},e.addHook=function(D,f){typeof f=="function"&&fi(Y[D],f)},e.removeHook=function(D,f){if(f!==void 0){const x=Fd(Y[D],f);return x===-1?void 0:Rd(Y[D],x,1)[0]}return na(Y[D])},e.removeHooks=function(D){Y[D]=[]},e.removeAllHooks=function(){Y=fa()},e}var so=wn();let yo=class extends de{constructor(){super(...arguments),this.collectionLinks=[]}render(){return c`
    ...
    `}get datePublishedTemplate(){var e;const t=(e=this.model)===null||e===void 0?void 0:e.datePublished;let i="long";return rs(t)&&(i="year-only"),this.metadataTemplate(Fi(t,i),C("Published"))}get dateSortByTemplate(){return this.effectiveSort&&(this.effectiveSort.field==="addeddate"||this.effectiveSort.field==="reviewdate"||this.effectiveSort.field==="publicdate")?this.metadataTemplate(Fi(this.date,"long"),this.displayValueProvider.dateLabel):b}get viewsTemplate(){var e,t,i,o;const s=((e=this.effectiveSort)===null||e===void 0?void 0:e.field)==="week"?(t=this.model)===null||t===void 0?void 0:t.weeklyViewCount:(i=this.model)===null||i===void 0?void 0:i.viewCount;return s==null?b:((o=this.model)===null||o===void 0?void 0:o.mediatype)==="search"?this.metadataTemplate("(Favorited search query)",""):this.metadataTemplate(`${ss(s,this.formatSize)}`,C("Views"))}get ratingTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.averageRating,C("Avg Rating"))}get reviewsTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.commentCount,C("Reviews"))}get topicsTemplate(){var e;return!(!((e=this.model)===null||e===void 0)&&e.subjects)||this.model.subjects.length===0?b:c`
...
`;var Wr;let Bi=Wr=class extends B{render(){return c`${this.facetRowTemplate}`}get facetRowTemplate(){var e,t,i,o;const{bucket:s,facetType:a}=this;if(!s||!a)return b;const l=`${a}:${s.key}-show-only`,d=`${a}:${s.key}-negative`,p=s.extraNote?c`<span class="facet-note">${s.extraNote}</span>`:b,u=a!=="collection"?c`${(e=s.displayText)!==null&&e!==void 0?e:s.key} ${p}`:c`<a href="/details/${s.key}">
    ...
    `}get loaderTemplate(){return c`<div class="facets-loader">
      <ia-activity-indicator .mode=${"processing"}></ia-activity-indicator>
        ...
        </div> `:b}sortFacetAggregation(e){this.sortedBy=e,this.dispatchEvent(new CustomEvent("sortedFacets",{detail:this.sortedBy}))}get modalHeaderTemplate(){var e,t,i;const s=((e=this.sortedBy)!==null&&e!==void 0?e:Ti[this.facetKey])===V.COUNT?"left":"right";return c`<span class="sr-only">${C("More facets for:")}</span>
      <span class="title">
    ...
    `}searchMoreFacetsLink(e){if(!this.moreLinksVisible||e.key==="lending"||Object.keys(e.buckets).length<this.allowedFacetCount)return b;const t=Ti[e.key];return c`<button
      class="more-link"
...
`;function j0(r){return r&&r.charAt(0).toLocaleUpperCase()+r.slice(1)}let Ii=class extends B{constructor(){super(...arguments),this.selected=!1}render(){var e,t;if(!this.facetInfo)return b;const i=this.facetInfo.facets.length===1,o=this.facetInfo.facets[0],s=j0((this.labelPrefix?`${this.labelPrefix} `:"")+((t=(e=this.facetInfo.label)!==null&&e!==void 0?e:o.displayText)!==null&&t!==void 0?t:o.bucketKey));if(!s)return b;const a=i&&o.facetType==="mediatype"?mn[o.bucketKey].icon:b;return c`
    ...
    `}};n([h({type:Object})],Ii.prototype,"facetInfo",void 0);n([h({type:String})],Ii.prototype,"labelPrefix",void 0);n([h({type:Boolean})],Ii.prototype,"selected",void 0);Ii=n([F("smart-facet-button")],Ii);let ii=class extends B{render(){var e,t;if(!this.facetInfo||!this.activeFacetRef||this.facetInfo.length===0)return b;const i=(e=this.activeFacetRef.displayText)!==null&&e!==void 0?e:this.activeFacetRef.bucketKey;return i?c`
