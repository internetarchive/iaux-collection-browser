...
`;var so;(function(a){a[a.bytes=0]="bytes",a[a.kilobytes=1]="kilobytes",a[a.megabytes=2]="megabytes",a[a.gigabytes=3]="gigabytes",a[a.terabytes=4]="terabytes",a[a.petabytes=5]="petabytes",a[a.exabytes=6]="exabytes",a[a.zettabytes=7]="zettabytes",a[a.yottabytes=8]="yottabytes"})(so||(so={}));function rs(a,e,t=" "){let i=a;if(i===void 0)return y;let o=0;for(;i>1024;)i/=1024,o+=1;const r=10**e;i=Math.round(i*r)/r;let n=so[o];return n=i===1?n.slice(0,-1):n,`${i.toLocaleString()+t+n}`}const Qe=m`
  .sr-only {
...
`,ss=m`var(--tileBackgroundColor, #ffffff)`,ns=m`var(--tileCornerRadius, 4px)`,ko=m`
...
`;let Zt=class extends D{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1,this.isCompactTile=!1}render(){return h`<div class="icon-overlay ${this.getClass}">
      ${this.iconDisplay}
    </div>`}get getClass(){return this.isCompactTile?"list-compact":"list-detail"}get iconDisplay(){return this.loginRequired&&!this.loggedIn?h`${er}`:h`${Ja}`}static get styles(){return m`
      :host {
        position: absolute;
        top: 50%;
        left: 50%;
    ...
    `}get iconDisplay(){return this.loginRequired&&!this.loggedIn?h`${er}`:h`${Ja}`}get textDisplay(){return this.loginRequired&&!this.loggedIn?h`Log in to view this item`:h`Content may be inappropriate`}static get styles(){return m`
      :host {
        align-items: center;
        display: flex;
      }
    ...
    >`}get getSizeTemplate(){var e,t;const i=(t=(e=this.model)===null||e===void 0?void 0:e.collectionSize)!==null&&t!==void 0?t:0;return i?h`<span id="item-size">${rs(i,1)}</span>`:""}get infoButtonTemplate(){return this.showInfoButton?h`<button class="info-button" @click=${this.infoButtonPressed}>
        ...
        </button>`:y}infoButtonPressed(e){e.preventDefault();const t=new CustomEvent("infoButtonPressed",{detail:{x:e.clientX,y:e.clientY}});this.dispatchEvent(t)}static get styles(){const e=m`var(--tileBorderColor, #555555)`,t=m`var(--tileBackgroundColor, #666666)`,i=m`#fff`;return[ko,m`
        .container {
          background-color: ${t};
          border: 1px solid ${e};
        }
      ...
      `]}};s([c({type:Object})],ei.prototype,"model",void 0);s([c({type:String})],ei.prototype,"baseImageUrl",void 0);s([c({type:Boolean})],ei.prototype,"showInfoButton",void 0);ei=s([A("collection-tile")],ei);function _i(a,e="short",t="en-US"){if(!a)return"";const i={timeZone:"UTC"};switch(e){case"year-only":i.year="numeric";break;case"short":i.month="short",i.year="numeric";break;case"long":i.year="numeric",i.month="short",i.day="2-digit";break}return new Intl.DateTimeFormat(t,i).format(a)}function ls(a){return new Date(a.getTime()-a.getTimezoneOffset()*1e3*60)}function To(a){return a?ls(a).toISOString().endsWith("-01-01T00:00:00.000Z"):!1}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*mi(a,e){const t=typeof e=="function";if(a!==void 0){let i=-1;for(const o of a)i>-1&&(yield t?e(i):e),i++,yield o}}let Ci=class extends D{constructor(){super(...arguments),this.snippets=[],this.viewSize="desktop"}render(){var e;return!((e=this.snippets)===null||e===void 0)&&e.length?h`
      <div class="container">
...
`,_s={account:{color:"#000000",icon:hs,text:"Account"},audio:{color:"#00adef",icon:ps,text:"Audio"},collection:{color:"#4666ff",icon:Za,text:"Collection"},data:{color:"#333333",icon:us,text:"Data"},etree:{color:"#00adef",icon:vs,text:"E-tree"},film:{color:"#bf1b2c",icon:ha,text:"Film"},image:{color:"#aa99c9",icon:ms,text:"Image"},movies:{color:"#f1644b",icon:ha,text:"Movie"},radio:{color:"#8fdaef",icon:fs,text:"Radio"},software:{color:"#9ecc4f",icon:gs,text:"Software"},texts:{color:"#faab3c",icon:bs,text:"Text"},tv:{color:"#f1644b",icon:ys,text:"TV"},video:{color:"#f1644b",icon:ws,text:"Video"},web:{color:"#ffcd27",icon:xs,text:"Web"}};let ti=class extends D{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var e,t;const i=["tvnews","tvarchive","television"],o=["radio","radioprogram"];return this.mediatype==="movies"&&((e=this.collections)===null||e===void 0?void 0:e.some(r=>i.indexOf(r)>=0))?"tv":this.mediatype==="audio"&&((t=this.collections)===null||t===void 0?void 0:t.some(r=>o.indexOf(r)>=0))?"radio":this.mediatype||""}render(){const e=_s[this.displayMediatype];return e?h`
      <div
        id="icon"
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ts=(a,...e)=>({strTag:!0,strings:a,values:e}),Ct=Ts,zs=a=>typeof a!="string"&&"strTag"in a,Ms=(a,e,t)=>{let i=a[0];for(let o=1;o<a.length;o++)i+=e[t?t[o-1]:o-1],i+=a[o];return i};/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ls=a=>zs(a)?Ms(a.strings,a.values):a;/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let $t=Ls;function Ps(a,e){let t=1;return a>=1e9?t=1e9:a>=1e6?t=1e6:a>=1e3&&e==="short"&&(t=1e3),t}function As(a=0,e){const t=a/e,i=t<10;let o=0;return i?o=Math.round((t+Number.EPSILON)*10)/10:o=Math.round(t),o}function Fs(a,e,t,i){switch(e){case 1e9:return $t(t==="short"?Ct`${a}B`:Ct`${a} billion`);case 1e6:return $t(t==="short"?Ct`${a}M`:Ct`${a} million`);case 1e3:return $t(t==="short"?Ct`${a}K`:Ct`${a} thousand`);default:return new Intl.NumberFormat(i).format(a)}}function Vt(a,e="long",t="short",i="en-US"){const o=a!=null?a:-1;if(o<0)return"";const r=Ps(o,e),n=As(o,r);return Fs(n,r,t,i)}let je=class extends D{render(){var e;const t=Vt(this.favCount,"short","short"),i=Vt(this.commentCount,"short","short"),o=this.mediatype==="account"?`${this.itemCount} uploads`:`${this.viewCount} ${(e=this.viewLabel)!==null&&e!==void 0?e:"all-time views"}`;return h`
    ...
    `}get sortedDateInfoTemplate(){var e,t,i,o,r;let n,l="long";switch((e=this.sortParam)===null||e===void 0?void 0:e.field){case"date":{const d=(t=this.model)===null||t===void 0?void 0:t.datePublished;n={field:"published",value:d},To(d)&&(l="year-only");break}case"reviewdate":n={field:"reviewed",value:(i=this.model)===null||i===void 0?void 0:i.dateReviewed};break;case"addeddate":n={field:"added",value:(o=this.model)===null||o===void 0?void 0:o.dateAdded};break;case"publicdate":n={field:"archived",value:(r=this.model)===null||r===void 0?void 0:r.dateArchived};break}return n!=null&&n.value?h`
    ...
    `}get doesSortedByDate(){var e;return["date","reviewdate","addeddate","publicdate"].includes((e=this.sortParam)===null||e===void 0?void 0:e.field)}get hasSnippets(){var e,t;return!!(!((t=(e=this.model)===null||e===void 0?void 0:e.snippets)===null||t===void 0)&&t.length)}infoButtonPressed(e){e.preventDefault();const t=new CustomEvent("infoButtonPressed",{detail:{x:e.clientX,y:e.clientY}});this.dispatchEvent(t)}static get styles(){const e=m`var(--tileBorderColor, #dddddd)`;return[ko,m`
        .container {
          border: 1px solid ${e};
        }
    ...
    >
          ...
          &#9432;
          <span class="sr-only">More info</span>
        </button>`:y}infoButtonPressed(e){e.preventDefault();const t=new CustomEvent("infoButtonPressed",{detail:{x:e.clientX,y:e.clientY}});this.dispatchEvent(t)}static get styles(){const e=m`var(--tileBorderColor, #dddddd)`;return[ko,m`
        .container {
          border: 1px solid ${e};
        }
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*no(a,e){if(a!==void 0){let t=0;for(const i of a)yield e(i,t++)}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class lo extends Mi{constructor(e){if(super(e),this.it=y,e.type!==Pe.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===y||e==null)return this.ft=void 0,this.it=e;if(e===ge)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this.ft;this.it=e;const t=[e];return t.raw=t,this.ft={_$litType$:this.constructor.resultType,strings:t,values:[]}}}lo.directiveName="unsafeHTML",lo.resultType=1;const Bs=zi(lo);/*! @license DOMPurify 2.3.8 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/2.3.8/LICENSE */function nt(a){return nt=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},nt(a)}function co(a,e){return co=Object.setPrototypeOf||function(i,o){return i.__proto__=o,i},co(a,e)}function Os(){if(typeof Reflect=="undefined"||!Reflect.construct||Reflect.construct.sham)return!1;if(typeof Proxy=="function")return!0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],function(){})),!0}catch{return!1}}function fi(a,e,t){return Os()?fi=Reflect.construct:fi=function(o,r,n){var l=[null];l.push.apply(l,r);var d=Function.bind.apply(o,l),u=new d;return n&&co(u,n.prototype),u},fi.apply(null,arguments)}function _e(a){return Is(a)||Rs(a)||Ns(a)||Us()}function Is(a){if(Array.isArray(a))return ho(a)}function Rs(a){if(typeof Symbol!="undefined"&&a[Symbol.iterator]!=null||a["@@iterator"]!=null)return Array.from(a)}function Ns(a,e){if(!!a){if(typeof a=="string")return ho(a,e);var t=Object.prototype.toString.call(a).slice(8,-1);if(t==="Object"&&a.constructor&&(t=a.constructor.name),t==="Map"||t==="Set")return Array.from(a);if(t==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t))return ho(a,e)}}function ho(a,e){(e==null||e>a.length)&&(e=a.length);for(var t=0,i=new Array(e);t<e;t++)i[t]=a[t];return i}function Us(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}var Hs=Object.hasOwnProperty,pa=Object.setPrototypeOf,Ws=Object.isFrozen,js=Object.getPrototypeOf,Vs=Object.getOwnPropertyDescriptor,pe=Object.freeze,ke=Object.seal,Gs=Object.create,tr=typeof Reflect!="undefined"&&Reflect,$i=tr.apply,po=tr.construct;$i||($i=function(e,t,i){return e.apply(t,i)});pe||(pe=function(e){return e});ke||(ke=function(e){return e});po||(po=function(e,t){return fi(e,_e(t))});var qs=Ce(Array.prototype.forEach),ua=Ce(Array.prototype.pop),Wt=Ce(Array.prototype.push),gi=Ce(String.prototype.toLowerCase),Qs=Ce(String.prototype.match),Ne=Ce(String.prototype.replace),Ks=Ce(String.prototype.indexOf),Xs=Ce(String.prototype.trim),ce=Ce(RegExp.prototype.test),qi=Ys(TypeError);function Ce(a){return function(e){for(var t=arguments.length,i=new Array(t>1?t-1:0),o=1;o<t;o++)i[o-1]=arguments[o];return $i(a,e,i)}}function Ys(a){return function(){for(var e=arguments.length,t=new Array(e),i=0;i<e;i++)t[i]=arguments[i];return po(a,t)}}function P(a,e){pa&&pa(a,null);for(var t=e.length;t--;){var i=e[t];if(typeof i=="string"){var o=gi(i);o!==i&&(Ws(e)||(e[t]=o),i=o)}a[i]=!0}return a}function rt(a){var e=Gs(null),t;for(t in a)$i(Hs,a,[t])&&(e[t]=a[t]);return e}function pi(a,e){for(;a!==null;){var t=Vs(a,e);if(t){if(t.get)return Ce(t.get);if(typeof t.value=="function")return Ce(t.value)}a=js(a)}function i(o){return console.warn("fallback value for",o),null}return i}var va=pe(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","section","select","shadow","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),Qi=pe(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","filter","font","g","glyph","glyphref","hkern","image","line","lineargradient","marker","mask","metadata","mpath","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),Ki=pe(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),Zs=pe(["animate","color-profile","cursor","discard","fedropshadow","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),Xi=pe(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover"]),Js=pe(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),ma=pe(["#text"]),fa=pe(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","face","for","headers","height","hidden","high","href","hreflang","id","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","pattern","placeholder","playsinline","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","xmlns","slot"]),Yi=pe(["accent-height","accumulate","additive","alignment-baseline","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),ga=pe(["accent","accentunder","align","bevelled","close","columnsalign","columnlines","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lspace","lquote","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),ui=pe(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),en=ke(/\{\{[\w\W]*|[\w\W]*\}\}/gm),tn=ke(/<%[\w\W]*|[\w\W]*%>/gm),on=ke(/^data-[\-\w.\u00B7-\uFFFF]/),an=ke(/^aria-[\-\w]+$/),rn=ke(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|cid|xmpp):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),sn=ke(/^(?:\w+script|data):/i),nn=ke(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),ln=ke(/^html$/i),dn=function(){return typeof window=="undefined"?null:window},cn=function(e,t){if(nt(e)!=="object"||typeof e.createPolicy!="function")return null;var i=null,o="data-tt-policy-suffix";t.currentScript&&t.currentScript.hasAttribute(o)&&(i=t.currentScript.getAttribute(o));var r="dompurify"+(i?"#"+i:"");try{return e.createPolicy(r,{createHTML:function(l){return l}})}catch{return console.warn("TrustedTypes policy "+r+" could not be created."),null}};function ir(){var a=arguments.length>0&&arguments[0]!==void 0?arguments[0]:dn(),e=function(p){return ir(p)};if(e.version="2.3.8",e.removed=[],!a||!a.document||a.document.nodeType!==9)return e.isSupported=!1,e;var t=a.document,i=a.document,o=a.DocumentFragment,r=a.HTMLTemplateElement,n=a.Node,l=a.Element,d=a.NodeFilter,u=a.NamedNodeMap,v=u===void 0?a.NamedNodeMap||a.MozNamedAttrMap:u,f=a.HTMLFormElement,b=a.DOMParser,x=a.trustedTypes,_=l.prototype,k=pi(_,"cloneNode"),E=pi(_,"nextSibling"),R=pi(_,"childNodes"),H=pi(_,"parentNode");if(typeof r=="function"){var ie=i.createElement("template");ie.content&&ie.content.ownerDocument&&(i=ie.content.ownerDocument)}var O=cn(x,t),V=O?O.createHTML(""):"",ue=i,se=ue.implementation,Ie=ue.createNodeIterator,q=ue.createDocumentFragment,we=ue.getElementsByTagName,ze=t.importNode,pt={};try{pt=rt(i).documentMode?i.documentMode:{}}catch{}var ve={};e.isSupported=typeof H=="function"&&se&&typeof se.createHTMLDocument!="undefined"&&pt!==9;var Ke=en,Xe=tn,Bt=on,Ot=an,It=sn,ut=nn,Ye=rn,Q=null,vt=P({},[].concat(_e(va),_e(Qi),_e(Ki),_e(Xi),_e(ma))),Y=null,mt=P({},[].concat(_e(fa),_e(Yi),_e(ga),_e(ui))),W=Object.seal(Object.create(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),Me=null,Ze=null,ft=!0,Je=!0,gt=!1,Se=!1,xe=!1,et=!1,tt=!1,Le=!1,si=!1,ni=!1,Do=!0,Li=!0,Rt=!1,bt={},yt=null,Po=P({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","style","svg","template","thead","title","video","xmp"]),Ao=null,Fo=P({},["audio","video","img","source","image","track"]),Ei=null,Bo=P({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),Di="http://www.w3.org/1998/Math/MathML",Pi="http://www.w3.org/2000/svg",Re="http://www.w3.org/1999/xhtml",li=Re,Ai=!1,wt,dr=["application/xhtml+xml","text/html"],cr="text/html",it,xt=null,hr=i.createElement("form"),Oo=function(p){return p instanceof RegExp||p instanceof Function},Fi=function(p){xt&&xt===p||((!p||nt(p)!=="object")&&(p={}),p=rt(p),Q="ALLOWED_TAGS"in p?P({},p.ALLOWED_TAGS):vt,Y="ALLOWED_ATTR"in p?P({},p.ALLOWED_ATTR):mt,Ei="ADD_URI_SAFE_ATTR"in p?P(rt(Bo),p.ADD_URI_SAFE_ATTR):Bo,Ao="ADD_DATA_URI_TAGS"in p?P(rt(Fo),p.ADD_DATA_URI_TAGS):Fo,yt="FORBID_CONTENTS"in p?P({},p.FORBID_CONTENTS):Po,Me="FORBID_TAGS"in p?P({},p.FORBID_TAGS):{},Ze="FORBID_ATTR"in p?P({},p.FORBID_ATTR):{},bt="USE_PROFILES"in p?p.USE_PROFILES:!1,ft=p.ALLOW_ARIA_ATTR!==!1,Je=p.ALLOW_DATA_ATTR!==!1,gt=p.ALLOW_UNKNOWN_PROTOCOLS||!1,Se=p.SAFE_FOR_TEMPLATES||!1,xe=p.WHOLE_DOCUMENT||!1,Le=p.RETURN_DOM||!1,si=p.RETURN_DOM_FRAGMENT||!1,ni=p.RETURN_TRUSTED_TYPE||!1,tt=p.FORCE_BODY||!1,Do=p.SANITIZE_DOM!==!1,Li=p.KEEP_CONTENT!==!1,Rt=p.IN_PLACE||!1,Ye=p.ALLOWED_URI_REGEXP||Ye,li=p.NAMESPACE||Re,p.CUSTOM_ELEMENT_HANDLING&&Oo(p.CUSTOM_ELEMENT_HANDLING.tagNameCheck)&&(W.tagNameCheck=p.CUSTOM_ELEMENT_HANDLING.tagNameCheck),p.CUSTOM_ELEMENT_HANDLING&&Oo(p.CUSTOM_ELEMENT_HANDLING.attributeNameCheck)&&(W.attributeNameCheck=p.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),p.CUSTOM_ELEMENT_HANDLING&&typeof p.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements=="boolean"&&(W.allowCustomizedBuiltInElements=p.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements),wt=dr.indexOf(p.PARSER_MEDIA_TYPE)===-1?wt=cr:wt=p.PARSER_MEDIA_TYPE,it=wt==="application/xhtml+xml"?function(w){return w}:gi,Se&&(Je=!1),si&&(Le=!0),bt&&(Q=P({},_e(ma)),Y=[],bt.html===!0&&(P(Q,va),P(Y,fa)),bt.svg===!0&&(P(Q,Qi),P(Y,Yi),P(Y,ui)),bt.svgFilters===!0&&(P(Q,Ki),P(Y,Yi),P(Y,ui)),bt.mathMl===!0&&(P(Q,Xi),P(Y,ga),P(Y,ui))),p.ADD_TAGS&&(Q===vt&&(Q=rt(Q)),P(Q,p.ADD_TAGS)),p.ADD_ATTR&&(Y===mt&&(Y=rt(Y)),P(Y,p.ADD_ATTR)),p.ADD_URI_SAFE_ATTR&&P(Ei,p.ADD_URI_SAFE_ATTR),p.FORBID_CONTENTS&&(yt===Po&&(yt=rt(yt)),P(yt,p.FORBID_CONTENTS)),Li&&(Q["#text"]=!0),xe&&P(Q,["html","head","body"]),Q.table&&(P(Q,["tbody"]),delete Me.tbody),pe&&pe(p),xt=p)},Io=P({},["mi","mo","mn","ms","mtext"]),Ro=P({},["foreignobject","desc","title","annotation-xml"]),pr=P({},["title","style","font","a","script"]),di=P({},Qi);P(di,Ki),P(di,Zs);var Bi=P({},Xi);P(Bi,Js);var ur=function(p){var w=H(p);(!w||!w.tagName)&&(w={namespaceURI:Re,tagName:"template"});var C=gi(p.tagName),I=gi(w.tagName);return p.namespaceURI===Pi?w.namespaceURI===Re?C==="svg":w.namespaceURI===Di?C==="svg"&&(I==="annotation-xml"||Io[I]):Boolean(di[C]):p.namespaceURI===Di?w.namespaceURI===Re?C==="math":w.namespaceURI===Pi?C==="math"&&Ro[I]:Boolean(Bi[C]):p.namespaceURI===Re?w.namespaceURI===Pi&&!Ro[I]||w.namespaceURI===Di&&!Io[I]?!1:!Bi[C]&&(pr[C]||!di[C]):!1},Ee=function(p){Wt(e.removed,{element:p});try{p.parentNode.removeChild(p)}catch{try{p.outerHTML=V}catch{p.remove()}}},No=function(p,w){try{Wt(e.removed,{attribute:w.getAttributeNode(p),from:w})}catch{Wt(e.removed,{attribute:null,from:w})}if(w.removeAttribute(p),p==="is"&&!Y[p])if(Le||si)try{Ee(w)}catch{}else try{w.setAttribute(p,"")}catch{}},Uo=function(p){var w,C;if(tt)p="<remove></remove>"+p;else{var I=Qs(p,/^[\r\n\t ]+/);C=I&&I[0]}wt==="application/xhtml+xml"&&(p='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+p+"</body></html>");var me=O?O.createHTML(p):p;if(li===Re)try{w=new b().parseFromString(me,wt)}catch{}if(!w||!w.documentElement){w=se.createDocument(li,"template",null);try{w.documentElement.innerHTML=Ai?"":me}catch{}}var ne=w.body||w.documentElement;return p&&C&&ne.insertBefore(i.createTextNode(C),ne.childNodes[0]||null),li===Re?we.call(w,xe?"html":"body")[0]:xe?w.documentElement:ne},Ho=function(p){return Ie.call(p.ownerDocument||p,p,d.SHOW_ELEMENT|d.SHOW_COMMENT|d.SHOW_TEXT,null,!1)},vr=function(p){return p instanceof f&&(typeof p.nodeName!="string"||typeof p.textContent!="string"||typeof p.removeChild!="function"||!(p.attributes instanceof v)||typeof p.removeAttribute!="function"||typeof p.setAttribute!="function"||typeof p.namespaceURI!="string"||typeof p.insertBefore!="function")},Nt=function(p){return nt(n)==="object"?p instanceof n:p&&nt(p)==="object"&&typeof p.nodeType=="number"&&typeof p.nodeName=="string"},De=function(p,w,C){!ve[p]||qs(ve[p],function(I){I.call(e,w,C,xt)})},Wo=function(p){var w;if(De("beforeSanitizeElements",p,null),vr(p)||ce(/[\u0080-\uFFFF]/,p.nodeName))return Ee(p),!0;var C=it(p.nodeName);if(De("uponSanitizeElement",p,{tagName:C,allowedTags:Q}),p.hasChildNodes()&&!Nt(p.firstElementChild)&&(!Nt(p.content)||!Nt(p.content.firstElementChild))&&ce(/<[/\w]/g,p.innerHTML)&&ce(/<[/\w]/g,p.textContent)||C==="select"&&ce(/<template/i,p.innerHTML))return Ee(p),!0;if(!Q[C]||Me[C]){if(!Me[C]&&Vo(C)&&(W.tagNameCheck instanceof RegExp&&ce(W.tagNameCheck,C)||W.tagNameCheck instanceof Function&&W.tagNameCheck(C)))return!1;if(Li&&!yt[C]){var I=H(p)||p.parentNode,me=R(p)||p.childNodes;if(me&&I)for(var ne=me.length,oe=ne-1;oe>=0;--oe)I.insertBefore(k(me[oe],!0),E(p))}return Ee(p),!0}return p instanceof l&&!ur(p)||(C==="noscript"||C==="noembed")&&ce(/<\/no(script|embed)/i,p.innerHTML)?(Ee(p),!0):(Se&&p.nodeType===3&&(w=p.textContent,w=Ne(w,Ke," "),w=Ne(w,Xe," "),p.textContent!==w&&(Wt(e.removed,{element:p.cloneNode()}),p.textContent=w)),De("afterSanitizeElements",p,null),!1)},jo=function(p,w,C){if(Do&&(w==="id"||w==="name")&&(C in i||C in hr))return!1;if(!(Je&&!Ze[w]&&ce(Bt,w))){if(!(ft&&ce(Ot,w))){if(!Y[w]||Ze[w]){if(!(Vo(p)&&(W.tagNameCheck instanceof RegExp&&ce(W.tagNameCheck,p)||W.tagNameCheck instanceof Function&&W.tagNameCheck(p))&&(W.attributeNameCheck instanceof RegExp&&ce(W.attributeNameCheck,w)||W.attributeNameCheck instanceof Function&&W.attributeNameCheck(w))||w==="is"&&W.allowCustomizedBuiltInElements&&(W.tagNameCheck instanceof RegExp&&ce(W.tagNameCheck,C)||W.tagNameCheck instanceof Function&&W.tagNameCheck(C))))return!1}else if(!Ei[w]){if(!ce(Ye,Ne(C,ut,""))){if(!((w==="src"||w==="xlink:href"||w==="href")&&p!=="script"&&Ks(C,"data:")===0&&Ao[p])){if(!(gt&&!ce(It,Ne(C,ut,"")))){if(C)return!1}}}}}}return!0},Vo=function(p){return p.indexOf("-")>0},Go=function(p){var w,C,I,me;De("beforeSanitizeAttributes",p,null);var ne=p.attributes;if(!!ne){var oe={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:Y};for(me=ne.length;me--;){w=ne[me];var ci=w,de=ci.name,qo=ci.namespaceURI;if(C=de==="value"?w.value:Xs(w.value),I=it(de),oe.attrName=I,oe.attrValue=C,oe.keepAttr=!0,oe.forceKeepAttr=void 0,De("uponSanitizeAttribute",p,oe),C=oe.attrValue,!oe.forceKeepAttr&&(No(de,p),!!oe.keepAttr)){if(ce(/\/>/i,C)){No(de,p);continue}Se&&(C=Ne(C,Ke," "),C=Ne(C,Xe," "));var fr=it(p.nodeName);if(!!jo(fr,I,C))try{qo?p.setAttributeNS(qo,de,C):p.setAttribute(de,C),ua(e.removed)}catch{}}}De("afterSanitizeAttributes",p,null)}},mr=function $(p){var w,C=Ho(p);for(De("beforeSanitizeShadowDOM",p,null);w=C.nextNode();)De("uponSanitizeShadowNode",w,null),!Wo(w)&&(w.content instanceof o&&$(w.content),Go(w));De("afterSanitizeShadowDOM",p,null)};return e.sanitize=function($,p){var w,C,I,me,ne;if(Ai=!$,Ai&&($="<!-->"),typeof $!="string"&&!Nt($)){if(typeof $.toString!="function")throw qi("toString is not a function");if($=$.toString(),typeof $!="string")throw qi("dirty is not a string, aborting")}if(!e.isSupported){if(nt(a.toStaticHTML)==="object"||typeof a.toStaticHTML=="function"){if(typeof $=="string")return a.toStaticHTML($);if(Nt($))return a.toStaticHTML($.outerHTML)}return $}if(et||Fi(p),e.removed=[],typeof $=="string"&&(Rt=!1),Rt){if($.nodeName){var oe=it($.nodeName);if(!Q[oe]||Me[oe])throw qi("root node is forbidden and cannot be sanitized in-place")}}else if($ instanceof n)w=Uo("<!---->"),C=w.ownerDocument.importNode($,!0),C.nodeType===1&&C.nodeName==="BODY"||C.nodeName==="HTML"?w=C:w.appendChild(C);else{if(!Le&&!Se&&!xe&&$.indexOf("<")===-1)return O&&ni?O.createHTML($):$;if(w=Uo($),!w)return Le?null:ni?V:""}w&&tt&&Ee(w.firstChild);for(var ci=Ho(Rt?$:w);I=ci.nextNode();)I.nodeType===3&&I===me||Wo(I)||(I.content instanceof o&&mr(I.content),Go(I),me=I);if(me=null,Rt)return $;if(Le){if(si)for(ne=q.call(w.ownerDocument);w.firstChild;)ne.appendChild(w.firstChild);else ne=w;return Y.shadowroot&&(ne=ze.call(t,ne,!0)),ne}var de=xe?w.outerHTML:w.innerHTML;return xe&&Q["!doctype"]&&w.ownerDocument&&w.ownerDocument.doctype&&w.ownerDocument.doctype.name&&ce(ln,w.ownerDocument.doctype.name)&&(de="<!DOCTYPE "+w.ownerDocument.doctype.name+`>
`+de),Se&&(de=Ne(de,Ke," "),de=Ne(de,Xe," ")),O&&ni?O.createHTML(de):de},e.setConfig=function($){Fi($),et=!0},e.clearConfig=function(){xt=null,et=!1},e.isValidAttribute=function($,p,w){xt||Fi({});var C=it($),I=it(p);return jo(C,I,w)},e.addHook=function($,p){typeof p=="function"&&(ve[$]=ve[$]||[],Wt(ve[$],p))},e.removeHook=function($){if(ve[$])return ua(ve[$])},e.removeHooks=function($){ve[$]&&(ve[$]=[])},e.removeAllHooks=function(){ve={}},e}var Gt=ir(),M;(function(a){a.relevance="relevance",a.alltimeview="alltimeview",a.weeklyview="weeklyview",a.title="title",a.date="date",a.datearchived="datearchived",a.datereviewed="datereviewed",a.dateadded="dateadded",a.creator="creator"})(M||(M={}));const st={relevance:"Relevance",alltimeview:"All-time views",weeklyview:"Weekly views",title:"Title",date:"Date published",datearchived:"Date archived",datereviewed:"Date reviewed",dateadded:"Date added",creator:"Creator"},ba={relevance:"desc",alltimeview:"desc",weeklyview:"desc",title:"asc",date:"desc",datearchived:"desc",datereviewed:"desc",dateadded:"desc",creator:"asc"},hn={relevance:null,alltimeview:"downloads",weeklyview:"week",title:"titleSorter",date:"date",datearchived:"publicdate",datereviewed:"reviewdate",dateadded:"addeddate",creator:"creatorSorter"};M.weeklyview,M.alltimeview,M.title,M.date,M.datearchived,M.datereviewed,M.dateadded,M.creator;const pn={week:"week",downloads:"downloads",titleSorter:"title",date:"date",publicdate:"publicdate",reviewdate:"reviewdate",addeddate:"addeddate",creatorSorter:"creator"},ya={week:M.weeklyview,downloads:M.alltimeview,title:M.title,titleSorter:M.title,date:M.date,publicdate:M.datearchived,reviewdate:M.datereviewed,addeddate:M.dateadded,creator:M.creator,creatorSorter:M.creator},un={title:"firstTitle",creator:"firstCreator"},oi=()=>({subject:{},lending:{},mediatype:{},language:{},creator:{},collection:{},year:{}}),vn=["mediatype","lending","year","subject","collection","creator","language"],Si={subject:"Subject",lending:"Availability",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"},uo={subject:K.COUNT,lending:K.COUNT,mediatype:K.COUNT,language:K.COUNT,creator:K.COUNT,collection:K.COUNT,year:K.NUMERIC},mn={subject:K.ALPHABETICAL,lending:K.ALPHABETICAL,mediatype:K.ALPHABETICAL,language:K.ALPHABETICAL,creator:K.ALPHABETICAL,collection:K.ALPHABETICAL,year:K.NUMERIC},fn={is_lendable:!0,is_borrowable:!1,available_to_borrow:!0,is_browsable:!1,available_to_browse:!1,is_readable:!0,available_to_waitlist:!1},wa={is_lendable:"Lending Library",available_to_borrow:"Borrow 14 Days",is_readable:"Always Available"},zo={deemphasize:!0,community:!0,stream_only:!0,samples_only:!0,test_collection:!0,printdisabled:!0,"openlibrary-ol":!0,nationalemergencylibrary:!0,china:!0,americana:!0,toronto:!0};function or(a){switch(a){case"publicdate":return"Archived";case"reviewdate":return"Reviewed";case"addeddate":return"Added";default:return"Published"}}function ar(a){return a?`Archivist since ${a.getFullYear()}`:""}let be=class extends D{constructor(){super(...arguments),this.sortParam=null,this.collectionLinks=[],this.loggedIn=!1}render(){return h`
    ...
    `:y}get volumeTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.volume,"Volume")}get issueTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.issue,"Issue")}get creatorTemplate(){var e,t,i;return((e=this.model)===null||e===void 0?void 0:e.mediatype)==="account"?h`
        <div id="creator" class="metadata">
          <span class="label"> ${ar((t=this.model)===null||t===void 0?void 0:t.dateAdded)} </span>
        </div>
      `:!(!((i=this.model)===null||i===void 0)&&i.creators)||this.model.creators.length===0?y:h`
      <div id="creator" class="metadata">
        ${this.labelTemplate("By")}
        ${mi(no(this.model.creators,o=>this.searchLink("creator",o)),h`, `)}
      </div>
    `}get datePublishedTemplate(){var e;const t=(e=this.model)===null||e===void 0?void 0:e.datePublished;let i="long";return To(t)&&(i="year-only"),this.metadataTemplate(_i(t,i),"Published")}get dateSortByTemplate(){return this.sortParam&&(this.sortParam.field==="addeddate"||this.sortParam.field==="reviewdate"||this.sortParam.field==="publicdate")?this.metadataTemplate(_i(this.date,"long"),or(this.sortParam.field)):y}get viewsTemplate(){var e,t,i;const o=((e=this.sortParam)===null||e===void 0?void 0:e.field)==="week"?(t=this.model)===null||t===void 0?void 0:t.weeklyViewCount:(i=this.model)===null||i===void 0?void 0:i.viewCount;return this.metadataTemplate(`${Vt(o!=null?o:0,this.formatSize)}`,"Views")}get ratingTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.averageRating,"Avg Rating")}get reviewsTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.commentCount,"Reviews")}get topicsTemplate(){var e;return!(!((e=this.model)===null||e===void 0)&&e.subjects)||this.model.subjects.length===0?y:h`
      <div id="topics" class="metadata">
        ${this.labelTemplate("Topics")}
        ${mi(no(this.model.subjects,t=>this.searchLink("subject",t)),h`, `)}
      </div>
    ...
    >`}detailsLink(e,t){const i=t!=null?t:e;return h`<a
      ...
      >${Gt.sanitize(i)}</a
    >`}get mediatypeURL(){var e;if(this.baseNavigationUrl===void 0||!(!((e=this.model)===null||e===void 0)&&e.mediatype))return y;switch(this.model.mediatype){case"collection":return`${this.baseNavigationUrl}/search?query=mediatype:collection&sort=-downloads`;case"account":return y;default:return`${this.baseNavigationUrl}/details/${encodeURI(this.model.mediatype)}`}}updated(e){e.has("model")&&this.fetchCollectionNames()}async fetchCollectionNames(){var e,t;if(!(!((e=this.model)===null||e===void 0)&&e.collections)||this.model.collections.length===0||!this.collectionNameCache)return;this.collectionLinks=[];const i=[],o=[];for(const r of this.model.collections)!zo[r]&&!r.startsWith("fav-")&&o.push((t=this.collectionNameCache)===null||t===void 0?void 0:t.collectionNameFor(r).then(n=>{i.push(this.detailsLink(r,n!=null?n:r))}));await Promise.all(o),this.collectionLinks=i}get date(){var e,t,i,o,r;switch((e=this.sortParam)===null||e===void 0?void 0:e.field){case"date":return(t=this.model)===null||t===void 0?void 0:t.datePublished;case"reviewdate":return(i=this.model)===null||i===void 0?void 0:i.dateReviewed;case"addeddate":return(o=this.model)===null||o===void 0?void 0:o.dateAdded;default:return(r=this.model)===null||r===void 0?void 0:r.dateArchived}}get classSize(){return this.mobileBreakpoint&&this.currentWidth&&this.currentWidth<this.mobileBreakpoint?"mobile":"desktop"}get formatSize(){return this.mobileBreakpoint&&this.currentWidth&&this.currentWidth<this.mobileBreakpoint?"short":"long"}static get styles(){return m`
      html {
        font-size: unset;
      }
    ...
    `}};s([c({type:Object})],Ve.prototype,"model",void 0);s([c({type:String})],Ve.prototype,"baseNavigationUrl",void 0);s([c({type:String})],Ve.prototype,"baseImageUrl",void 0);s([c({type:Boolean})],Ve.prototype,"loggedIn",void 0);s([c({type:Object})],Ve.prototype,"sortParam",void 0);s([c({type:Object})],Ve.prototype,"collectionNameCache",void 0);Ve=s([A("tile-hover-pane")],Ve);let Te=class extends D{constructor(){super(...arguments),this.sortParam=null,this.loggedIn=!1}render(){var e,t,i,o,r,n,l,d,u;return h`
      <div id="list-line" class="${this.classSize}">
        ...
        >
        <div id="creator">
          ${((i=this.model)===null||i===void 0?void 0:i.mediatype)==="account"?ar((o=this.model)===null||o===void 0?void 0:o.dateAdded):Gt.sanitize((n=(r=this.model)===null||r===void 0?void 0:r.creator)!==null&&n!==void 0?n:"")}
        </div>
    ...
    `}};s([c({type:Object})],Te.prototype,"model",void 0);s([c({type:String})],Te.prototype,"baseNavigationUrl",void 0);s([c({type:Number})],Te.prototype,"currentWidth",void 0);s([c({type:Number})],Te.prototype,"currentHeight",void 0);s([c({type:Object})],Te.prototype,"sortParam",void 0);s([c({type:Number})],Te.prototype,"mobileBreakpoint",void 0);s([c({type:String})],Te.prototype,"baseImageUrl",void 0);s([c({type:Boolean})],Te.prototype,"loggedIn",void 0);Te=s([A("tile-list-compact")],Te);let Lt=class extends D{constructor(){super(...arguments),this.sortParam=null}render(){var e;return h`
      <div id="list-line-header" class="${this.classSize}">
        ...
        <div id="date">${or((e=this.sortParam)===null||e===void 0?void 0:e.field)}</div>
    ...
    `}};_a=s([A("collection-browser-loading-tile")],_a);let ye=class extends D{constructor(){super(...arguments),this.open=!1,this.displayCaret=!1,this.closeOnSelect=!1,this.openViaButton=!0,this.openViaCaret=!0,this.includeSelectedOption=!1,this.selectedOption="",this.options=[],this.optionGroup="options",this.optionSelected=()=>{},this.handlingCaretClick=!1}renderOption(e){const{label:t,url:i=void 0,id:o}=e;let r;const n=this.selectedOption===o?"selected":"";return i?r=h`<a
        href=${i}
  ...
  `;mo=s([A("ia-icon-label")],mo);let fo=class extends D{constructor(){super(...arguments),this.numResults=0}render(){return h`
    ...
    `}};s([c({type:Number})],fo.prototype,"numResults",void 0);fo=s([A("alpha-bar-tooltip")],fo);let Oe=class extends D{constructor(){super(...arguments),this.selectedLetter=null,this.tooltipShown=!1,this.alphabet="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("")}get selectedUppercaseLetter(){var e;return(e=this.selectedLetter)===null||e===void 0?void 0:e.toUpperCase()}render(){var e;return h`
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ca=zi(class extends Mi{constructor(a){if(super(a),a.type!==Pe.PROPERTY&&a.type!==Pe.ATTRIBUTE&&a.type!==Pe.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!is(a))throw Error("`live` bindings can only contain a single expression")}render(a){return a}update(a,[e]){if(e===ge||e===y)return e;const t=a.element,i=a.name;if(a.type===Pe.PROPERTY){if(e===t[i])return ge}else if(a.type===Pe.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(i))return ge}else if(a.type===Pe.ATTRIBUTE&&t.getAttribute(i)===e+"")return ge;return Xa(a),e}}),$n=Object.freeze({processing:"processing",complete:"complete"});class Sn extends D{static get properties(){return{mode:{type:String}}}constructor(){super(),this.mode=$n.processing}render(){return h`
      <div class="${this.mode}">
        <svg
          viewBox="0 0 120 120"
    ...
    `,this._tooltipVisible=!0}hideTooltip(){this._tooltipContent=void 0,this._tooltipVisible=!1}validMinSliderX(e){const t=Math.min(this.translateDateToPosition(this.maxSelectedDate),this.histogramRightEdgeX);return e=this.clamp(e,this.histogramLeftEdgeX,t),Number.isNaN(e)||t<this.histogramLeftEdgeX?this.histogramLeftEdgeX:e}validMaxSliderX(e){const t=Math.max(this.histogramLeftEdgeX,this.translateDateToPosition(this.minSelectedDate));return e=this.clamp(e,t,this.histogramRightEdgeX),Number.isNaN(e)||t>this.histogramRightEdgeX?this.histogramRightEdgeX:e}addListeners(){window.addEventListener("pointermove",this.move),window.addEventListener("pointerup",this.drop),window.addEventListener("pointercancel",this.drop)}removeListeners(){window.removeEventListener("pointermove",this.move),window.removeEventListener("pointerup",this.drop),window.removeEventListener("pointercancel",this.drop)}beginEmitUpdateProcess(){this.cancelPendingUpdateEvent(),this._emitUpdatedEventTimer=setTimeout(()=>{if(this.currentDateRangeString===this._previousDateRange)return;this._previousDateRange=this.currentDateRangeString;const e={detail:{minDate:this.minSelectedDate,maxDate:this.maxSelectedDate},bubbles:!0,composed:!0};this.dispatchEvent(new CustomEvent("histogramDateRangeUpdated",e))},this.updateDelay)}cancelPendingUpdateEvent(){this._emitUpdatedEventTimer!==void 0&&(clearTimeout(this._emitUpdatedEventTimer),this._emitUpdatedEventTimer=void 0)}setDragOffset(e){this._currentSlider=e.currentTarget;const t=this._currentSlider.id==="slider-min"?this.minSliderX:this.maxSliderX,i=this.getBoundingClientRect().x;this._dragOffset=e.clientX-i-t}translatePositionToDate(e){const t=Math.ceil((e-this.sliderWidth)*this.dateRangeMS/this._histWidth);return this.formatDate(this._minDateMS+t)}translateDateToPosition(e){const t=this.getMSFromString(e);return this.sliderWidth+(t-this._minDateMS)*this._histWidth/this.dateRangeMS}clamp(e,t,i){return Math.min(Math.max(e,t),i)}handleMinDateInput(e){const t=e.currentTarget;t.value!==this.minSelectedDate&&(this.minSelectedDate=t.value,this.beginEmitUpdateProcess())}handleMaxDateInput(e){const t=e.currentTarget;t.value!==this.maxSelectedDate&&(this.maxSelectedDate=t.value,this.beginEmitUpdateProcess())}handleKeyUp(e){if(e.key==="Enter"){const t=e.currentTarget;t.blur(),t.id==="date-min"?this.handleMinDateInput(e):t.id==="date-max"&&this.handleMaxDateInput(e)}}get currentDateRangeString(){return`${this.minSelectedDate}:${this.maxSelectedDate}`}getMSFromString(e){const t=typeof e=="string"?e:String(e);if((t.split(/(\d+)/).length-1)/2===1){const o=new Date(0,0);return o.setFullYear(Number(t)),o.getTime()}return Zi(t,[this.dateFormat,$a]).valueOf()}handleBarClick(e){const t=e.currentTarget.dataset,i=(this.getMSFromString(t.binStart)+this.getMSFromString(t.binEnd))/2,o=Math.abs(i-this.getMSFromString(this.minSelectedDate)),r=Math.abs(i-this.getMSFromString(this.maxSelectedDate));o<r?this.minSelectedDate=t.binStart:this.maxSelectedDate=t.binEnd,this.beginEmitUpdateProcess()}get minSliderTemplate(){const e=Sa,t=`
            ...
            q0,${e} ${e},${e}
            h${this.sliderWidth-e}
          `;return this.generateSliderSVG(this.minSliderX,"slider-min",t)}get maxSliderTemplate(){const e=Sa,t=`
            M${this.maxSliderX},0
            h${this.sliderWidth-e}
            q${e},0 ${e},${e}
            v${this.height-e*2}
...
`;let bo=class extends D{constructor(){super(...arguments),this.config=new go}render(){return h`
      <div class="modal-wrapper">
        <div class="modal-container">
          <header style="background-color: ${this.config.headerColor}">
            ${this.config.showCloseButton?this.closeButtonTemplate:""}
            ${this.config.showHeaderLogo?h`<div class="logo-icon">${Vn}</div>`:y}
    ...
    `}};s([c({type:Object})],bo.prototype,"config",void 0);bo=s([A("modal-template")],bo);function Gn(a,e,t){var i=t||{},o=i.noTrailing,r=o===void 0?!1:o,n=i.noLeading,l=n===void 0?!1:n,d=i.debounceMode,u=d===void 0?void 0:d,v,f=!1,b=0;function x(){v&&clearTimeout(v)}function _(E){var R=E||{},H=R.upcomingOnly,ie=H===void 0?!1:H;x(),f=!ie}function k(){for(var E=arguments.length,R=new Array(E),H=0;H<E;H++)R[H]=arguments[H];var ie=this,O=Date.now()-b;if(f)return;function V(){b=Date.now(),e.apply(ie,R)}function ue(){v=void 0}!l&&u&&!v&&V(),x(),u===void 0&&O>a?l?(b=Date.now(),r||(v=setTimeout(u?ue:V,a))):V():r!==!0&&(v=setTimeout(u?ue:V,u===void 0?a-O:a))}return k.cancel=_,k}var lt;(function(a){a.Open="open",a.Closed="closed"})(lt||(lt={}));class qn{constructor(e){this.windowResizeThrottler=Gn(100,this.updateModalContainerHeight,{noLeading:!1,noTrailing:!1}).bind(this),this.modalManager=e}handleModeChange(e){switch(e){case lt.Open:this.startResizeListener(),this.stopDocumentScroll();break;case lt.Closed:this.stopResizeListener(),this.resumeDocumentScroll();break}}updateModalContainerHeight(){this.modalManager.style.setProperty("--containerHeight",`${window.innerHeight}px`)}stopDocumentScroll(){document.body.classList.add("modal-manager-open")}resumeDocumentScroll(){document.body.classList.remove("modal-manager-open")}startResizeListener(){window.addEventListener("resize",this.windowResizeThrottler)}stopResizeListener(){window.removeEventListener("resize",this.windowResizeThrottler)}}let Et=class extends D{constructor(){super(...arguments),this.mode=lt.Closed,this.hostBridge=new qn(this),this.closeOnBackdropClick=!0}render(){return h`
      <div class="container">
...
`;let Dt=class extends D{constructor(){super(...arguments),this.step=2,this.currentPage=1,this.pages=[]}firstUpdated(){this.observePageCount()}updated(e){e.has("size")&&this.observePageCount(),e.has("currentPage")&&(this.observePageCount(),this.emitPageClick())}observePageCount(){this.pages=[];const e=7,t=this.size<=e;if(this.size<=5){this.pages=[...Array(this.size).keys()].map(r=>r+1);return}if(this.size===e){if(this.currentPage===2){this.pages=[1,2,3,4,0,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,4,5,this.size-1,this.size];return}}if(this.currentPage===1){this.pages=[1,2,3,0,this.size];return}if(this.currentPage===this.size){this.pages=[1,0,this.size-2,this.size-1,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,this.size-3,this.size-2,this.size-1,this.size];return}if(t&&this.currentPage>1&&this.currentPage<e){this.pages=[...Array(this.size).keys()].map(r=>r+1);return}let i=this.currentPage-this.step,o=this.currentPage+this.step;i<=0&&(o+=-i+1,i=1),o>=this.size&&(i=Math.max(i-(o-this.size),1),o=this.size),i===2&&(o-=1),o===this.size-1&&(i+=1),this.createFirstNode(i),this.createMiddelNode(i,o),this.createLastNode(o)}createFirstNode(e){var t,i;e>1&&((t=this.pages)===null||t===void 0||t.push(1)),e>2&&((i=this.pages)===null||i===void 0||i.push(0))}createMiddelNode(e,t){var i;for(let o=e;o<=t;o+=1)(i=this.pages)===null||i===void 0||i.push(o)}createLastNode(e){var t,i;e<this.size-1&&((t=this.pages)===null||t===void 0||t.push(0)),e<this.size&&((i=this.pages)===null||i===void 0||i.push(this.size))}get getEllipsisTemplate(){return h`<i class="ellipses">...</i>`}emitPageClick(){this.dispatchEvent(new CustomEvent("pageNumberClicked",{detail:{page:this.currentPage},bubbles:!0,composed:!0}))}onRewind(){this.currentPage-=1,this.currentPage<1&&(this.currentPage=1)}onForward(){this.currentPage+=1,this.currentPage>this.size&&(this.currentPage=this.size)}onChange(e){this.currentPage=e}getPageTemplate(e){return h`
    ...
    `}static get styles(){return[Qe,m`
      ...
      `]}};s([c({type:Number})],Dt.prototype,"size",void 0);s([c({type:Number})],Dt.prototype,"step",void 0);s([c({type:Number})],Dt.prototype,"currentPage",void 0);s([z()],Dt.prototype,"pages",void 0);Dt=s([A("more-facets-pagination")],Dt);var Yn=F`
...
`;let Pt=class extends D{facetClicked(e,t,i){const o=e.target,{checked:r,name:n,value:l}=o;r?this.facetChecked(n,l,t,i):this.facetUnchecked(n,l),this.dispatchFacetClickEvent(n,this.getFacetState(r,i),i)}facetChecked(e,t,i,o){const{selectedFacets:r}=this;let n;r?n=fe({},r):n=oi(),n[e][t]={state:this.getFacetState(!0,o),count:i},this.selectedFacets=n,this.dispatchSelectedFacetsChanged()}facetUnchecked(e,t){const{selectedFacets:i}=this;let o;i?o=fe({},i):o=oi(),delete o[e][t],this.selectedFacets=o,this.dispatchSelectedFacetsChanged()}getFacetState(e,t){let i;return e?i=t?"hidden":"selected":i="none",i}dispatchFacetClickEvent(e,t,i){const o=new CustomEvent("facetClick",{detail:{key:e,state:t,negative:i},composed:!0});this.dispatchEvent(o)}dispatchSelectedFacetsChanged(){const e=new CustomEvent("selectedFacetsChanged",{detail:this.selectedFacets,bubbles:!0,composed:!0});this.dispatchEvent(e)}getFacetsTemplate(e){let t=e==null?void 0:e.buckets;return t=[...t.filter(i=>i.state==="selected").sort((i,o)=>i.count<o.count?1:-1),...t.filter(i=>i.state==="hidden").sort((i,o)=>i.count<o.count?1:-1),...t.filter(i=>i.state==="none")],h`
      <div class="facets-on-${this.renderOn}">
        ${Ya(t,i=>`${e.key}:${i.key}`,i=>{var o,r;const n=`${e.key}:${i.key}-show-only`,l=`${e.key}:${i.key}-negative`,d=e.key!=="collection"?h`${(o=i.displayText)!==null&&o!==void 0?o:i.key}`:h`<a href="/details/${i.key}">
    ...
    `}get loaderTemplate(){return h`<div class="facets-loader">
      <ia-activity-indicator .mode=${"processing"}></ia-activity-indicator>
        ...
        </div> `:y}sortFacetAggregation(e){this.sortedBy=e,this.dispatchEvent(new CustomEvent("sortedFacets",{detail:this.sortedBy}))}get getModalHeaderTemplate(){const t=uo[this.facetKey]===K.COUNT?"left":"right";return h`<span class="sr-only">More facets for:</span>
      <span class="title">
    ...
    `}};La=s([A("facet-tombstone-row")],La);let qe=class extends D{render(){return h`
      <div id="container">
    ...
    `,r=new go({bodyColor:"#fff",headerColor:"#194880",showHeaderLogo:!1,closeOnBackdropClick:!0,title:h`Select a date range`});(e=this.modalManager)===null||e===void 0||e.classList.add("expanded-date-picker"),(t=this.modalManager)===null||t===void 0||t.showModal({config:r,customModalContent:o,userClosedModalCallback:()=>{var n;(n=this.modalManager)===null||n===void 0||n.classList.remove("expanded-date-picker")}})}updated(e){e.has("selectedFacets")&&this.dispatchFacetsChangedEvent()}dispatchFacetsChangedEvent(){const e=new CustomEvent("facetsChanged",{detail:this.selectedFacets});this.dispatchEvent(e)}get expandDatePickerBtnTemplate(){return this.allowExpandingDatePicker?h`<button
        ...
        >
          ...
          <histogram-date-range
            ...
            @histogramDateRangeUpdated=${this.histogramDateRangeUpdated}
          ></histogram-date-range>
        `}histogramDateRangeUpdated(e){const{minDate:t,maxDate:i}=e.detail,o=new CustomEvent("histogramDateRangeUpdated",{detail:{minDate:t,maxDate:i}});this.dispatchEvent(o)}get mergedFacets(){const e=[];return vn.forEach(t=>{var i,o;const r=this.selectedFacetGroups.find(v=>v.key===t),n=this.aggregationFacetGroups.find(v=>v.key===t);if(r&&!n){e.push(r);return}if(!n)return;const l=r!=null?r:n;let d=(i=r==null?void 0:r.buckets.map(v=>{const f=n.buckets.find(b=>b.key===v.key);return f?_t(fe({},v),{count:f.count}):v}))!==null&&i!==void 0?i:[];n.buckets.forEach(v=>{d.find(b=>b.key===v.key)||d.push(v)}),t==="lending"&&(d=d.filter(v=>fn[v.key]));let u=(o=Object.keys((r==null?void 0:r.buckets)||[]))===null||o===void 0?void 0:o.length;u<this.allowedFacetCount&&(u=this.allowedFacetCount),l.buckets=d.splice(0,u),e.push(l)}),e}get selectedFacetGroups(){return this.selectedFacets?Object.entries(this.selectedFacets).map(([t,i])=>{const o=t,r=Si[o],n=Object.entries(i).map(([l,d])=>{var u;let v=l;return o==="lending"&&(v=(u=wa[l])!==null&&u!==void 0?u:l),{displayText:v,key:l,count:d.count,state:d.state}});return{title:r,key:o,buckets:n}}):[]}get aggregationFacetGroups(){var e;const t=[];return Object.entries((e=this.aggregations)!==null&&e!==void 0?e:[]).forEach(([i,o])=>{if(i==="year_histogram")return;const r=i,n=Si[r];if(!n)return;let l=o.getSortedBuckets(uo[r]);r==="collection"&&(l=l==null?void 0:l.filter(v=>{var f;const b=(f=v==null?void 0:v.key)===null||f===void 0?void 0:f.toString();return!zo[b]&&!(b!=null&&b.startsWith("fav-"))}));const d=l.map(v=>{var f;const b=v.key;let x=`${v.key}`;return r==="lending"&&(x=(f=wa[v.key])!==null&&f!==void 0?f:`${v.key}`),{displayText:x,key:`${b}`,count:v.doc_count,state:"none"}}),u={title:n,key:r,buckets:d};t.push(u)}),t}getFacetGroupTemplate(e){if(!this.facetsLoading&&e.buckets.length===0)return y;const{key:t}=e,i=this.openFacets[t],o=h`
    ...
    `}getTombstoneFacetGroupTemplate(){return h`
      ${no(Array(5).fill(null),()=>h`<facet-tombstone-row></facet-tombstone-row>`)}
    `}searchMoreFacetsLink(e){if(!this.moreLinksVisible||e.key==="lending"||Object.keys(e.buckets).length<this.allowedFacetCount)return y;const t=uo[e.key];return h`<button
      class="more-link"
      @click=${()=>{var i;this.showMoreFacetsModal(e,t),(i=this.analyticsHandler)===null||i===void 0||i.sendEvent({category:dt.default,action:ae.showMoreFacetsModal,label:e.key}),this.dispatchEvent(new CustomEvent("showMoreFacets",{detail:e.key}))}}
    >
      More...
    ...
    `}};Ea=s([A("circular-activity-indicator")],Ea);/*! typescript-cookie v1.0.3 | MIT */const sr=a=>encodeURIComponent(a).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),nr=a=>encodeURIComponent(a).replace(/%(2[346BF]|3[AC-F]|40|5[BDE]|60|7[BCD])/g,decodeURIComponent),Mo=decodeURIComponent,Lo=a=>(a[0]==='"'&&(a=a.slice(1,-1)),a.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent));function Jn(a){return a=Object.assign({},a),typeof a.expires=="number"&&(a.expires=new Date(Date.now()+a.expires*864e5)),a.expires!=null&&(a.expires=a.expires.toUTCString()),Object.entries(a).filter(([e,t])=>t!=null&&t!==!1).map(([e,t])=>t===!0?`; ${e}`:`; ${e}=${t.split(";")[0]}`).join("")}function lr(a,e,t){const i=/(?:^|; )([^=]*)=([^;]*)/g,o={};let r;for(;(r=i.exec(document.cookie))!=null;)try{const n=t(r[1]);if(o[n]=e(r[2],n),a===n)break}catch{}return a!=null?o[a]:o}const Da=Object.freeze({decodeName:Mo,decodeValue:Lo,encodeName:sr,encodeValue:nr}),Eo=Object.freeze({path:"/"});function ki(a,e,t=Eo,{encodeValue:i=nr,encodeName:o=sr}={}){return document.cookie=`${o(a)}=${i(e,a)}${Jn(t)}`}function yo(a,{decodeValue:e=Lo,decodeName:t=Mo}={}){return lr(a,e,t)}function el({decodeValue:a=Lo,decodeName:e=Mo}={}){return lr(void 0,a,e)}function tl(a,e=Eo){ki(a,"",Object.assign({},e,{expires:-1}))}function wo(a,e){const t={set:function(o,r,n){return ki(o,r,Object.assign({},this.attributes,n),{encodeValue:this.converter.write})},get:function(o){if(arguments.length===0)return el(this.converter.read);if(o!=null)return yo(o,this.converter.read)},remove:function(o,r){tl(o,Object.assign({},this.attributes,r))},withAttributes:function(o){return wo(this.converter,Object.assign({},this.attributes,o))},withConverter:function(o){return wo(Object.assign({},this.converter,o),this.attributes)}},i={attributes:{value:Object.freeze(e)},converter:{value:Object.freeze(a)}};return Object.create(t,i)}wo({read:Da.decodeValue,write:Da.encodeValue},Eo);function il(a,e){return a===e?!0:a.length!==e.length?!1:a.every((t,i)=>t===e[i])}class ol{constructor(e){this.cookieDomain=".archive.org",this.cookieExpiration=30,this.cookiePath="/",this.context=e.context}persistState(e){e.displayMode&&this.persistViewStateToCookies(e.displayMode),this.persistQueryStateToUrl(e)}getRestorationState(){const e=this.loadQueryStateFromUrl(),t=this.loadTileViewStateFromCookies();return e.displayMode=t,e}persistViewStateToCookies(e){const t=e==="grid"?"tiles":"lists";ki(`view-${this.context}`,t,{domain:this.cookieDomain,expires:this.cookieExpiration,path:this.cookiePath});const i=e==="list-detail"?"showdetails":"";ki(`showdetails-${this.context}`,i,{domain:this.cookieDomain,expires:this.cookieExpiration,path:this.cookiePath})}loadTileViewStateFromCookies(){const e=yo(`view-${this.context}`),t=yo(`showdetails-${this.context}`);return e==="tiles"||e===void 0?"grid":t==="showdetails"?"list-detail":"list-compact"}persistQueryStateToUrl(e){var t,i;const o=new URL(window.location.href),r=new URLSearchParams(o.searchParams),n=this.removeRecognizedParams(o.searchParams);let l=!1;if(e.baseQuery&&n.set("query",e.baseQuery),e.searchType===he.FULLTEXT&&n.set("sin","TXT"),r.get("sin")===""&&(r.delete("sin"),l=!0),e.currentPage&&(e.currentPage>1?n.set("page",e.currentPage.toString()):n.delete("page")),e.sortParam){const v=e.sortParam.direction==="desc"?"-":"",f=pn[e.sortParam.field];n.set("sort",`${v}${f}`)}if(e.selectedFacets)for(const[v,f]of Object.entries(e.selectedFacets)){const b=Object.entries(f);if(b.length!==0)for(const[x,_]of b){const k=_.state==="hidden",E=`${v}:"${x}"`;k?n.append("not[]",E):n.append("and[]",E)}}e.minSelectedDate&&e.maxSelectedDate&&n.append("and[]",`year:[${e.minSelectedDate} TO ${e.maxSelectedDate}]`),e.titleQuery&&n.append("and[]",e.titleQuery),e.creatorQuery&&n.append("and[]",e.creatorQuery);let d="pushState";const u=this.paramsMatch(r,n,["sin","sort","and[]","not[]"]);if(u&&this.paramsMatch(r,n,["query"])){if(l)n.delete("sin");else if(this.paramsMatch(r,n,["page"]))return;d="replaceState"}else u&&this.hasLegacyParam(r)&&(d="replaceState");(i=(t=window.history)[d])===null||i===void 0||i.call(t,{query:e.baseQuery,searchType:e.searchType,page:e.currentPage,sort:e.sortParam,minDate:e.minSelectedDate,maxDate:e.maxSelectedDate,facets:e.selectedFacets},"",o)}loadQueryStateFromUrl(){var e;const t=new URL(window.location.href),i=t.searchParams.get("sin"),o=t.searchParams.get("page"),r=t.searchParams.get("query"),n=t.searchParams.get("sort"),l=t.searchParams.getAll("and[]"),d=t.searchParams.getAll("not[]"),u=(e=t.searchParams.get("q"))!==null&&e!==void 0?e:t.searchParams.get("search"),v={selectedFacets:oi()};switch(r?v.baseQuery=r:u&&(v.baseQuery=u),i){case"TXT":v.searchType=he.FULLTEXT;break;default:v.searchType=he.METADATA;break}if(o){const f=parseInt(o,10);v.currentPage=f}else v.currentPage=1;if(n)if(n.indexOf(" ")>-1){const[b,x]=n.split(" "),_=ya[b];_&&(v.selectedSort=_),(x==="desc"||x==="asc")&&(v.sortDirection=x)}else{const b=n.startsWith("-")?"desc":"asc",x=n.startsWith("-")?n.slice(1):n,_=ya[x];_&&(v.selectedSort=_,v.sortDirection=b)}return l&&l.forEach(f=>{let[b,x]=f.split(":");switch(b=b.replace(/Sorter$/,""),b){case"year":{const[_,k]=x.split(" TO ");_&&k?(v.minSelectedDate=_.substring(1,_.length),v.maxSelectedDate=k.substring(0,k.length-1)):this.setSelectedFacetState(v.selectedFacets,b,x,"selected");break}case"firstTitle":v.selectedTitleFilter=x;break;case"firstCreator":v.selectedCreatorFilter=x;break;default:this.setSelectedFacetState(v.selectedFacets,b,x,"selected")}}),d&&d.forEach(f=>{const[b,x]=f.split(":");this.setSelectedFacetState(v.selectedFacets,b,x,"hidden")}),v}stripQuotes(e){return e.startsWith('"')&&e.endsWith('"')?e.substring(1,e.length-1):e}paramsMatch(e,t,i){return i.every(o=>il(e.getAll(o).sort(),t.getAll(o).sort()))}removeRecognizedParams(e){return e.delete("query"),e.delete("sin"),e.delete("page"),e.delete("sort"),e.delete("and[]"),e.delete("not[]"),e.delete("q"),e.delete("search"),e}hasLegacyParam(e){return e.has("q")||e.has("search")}setSelectedFacetState(e,t,i,o){var r;const n=e[t];if(!n)return;const l=this.stripQuotes(i);(r=n[l])!==null&&r!==void 0||(n[l]=this.getDefaultBucket(i)),n[l].state=o}getDefaultBucket(e){return{key:e,count:0,state:"none"}}}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const al=(a,e,t)=>{for(const i of e)if(i[0]===a)return(0,i[1])();return t==null?void 0:t()};var rl=F`
...
`;let ai=class extends D{constructor(){super(...arguments),this.placeholderType=null,this.detailMessage=""}render(){return this.placeholderType?h`${this.placeholderTemplate}`:y}get placeholderTemplate(){return h`
      <div
        class="placeholder ${this.placeholderType} ${this.isMobileView?"mobile":"desktop"}"
      >
        ${al(this.placeholderType,[["empty-query",()=>this.emptyQueryTemplate],["null-result",()=>this.nullResultTemplate],["query-error",()=>this.queryErrorTemplate]])}
      </div>
