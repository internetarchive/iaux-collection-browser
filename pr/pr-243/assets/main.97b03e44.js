...
`+de),Se&&(de=Ue(de,Ke," "),de=Ue(de,Xe," ")),O&&ci?O.createHTML(de):de},e.setConfig=function(C){Oi(C),et=!0},e.clearConfig=function(){xt=null,et=!1},e.isValidAttribute=function(C,p,w){xt||Oi({});var $=it(C),I=it(p);return qo($,I,w)},e.addHook=function(C,p){typeof p=="function"&&(ve[C]=ve[C]||[],Wt(ve[C],p))},e.removeHook=function(C){if(ve[C])return fa(ve[C])},e.removeHooks=function(C){ve[C]&&(ve[C]=[])},e.removeAllHooks=function(){ve={}},e}var Gt=sr(),M;(function(a){a.relevance="relevance",a.alltimeview="alltimeview",a.weeklyview="weeklyview",a.title="title",a.date="date",a.datearchived="datearchived",a.datereviewed="datereviewed",a.dateadded="dateadded",a.creator="creator"})(M||(M={}));const st={relevance:"Relevance",alltimeview:"All-time views",weeklyview:"Weekly views",title:"Title",date:"Date published",datearchived:"Date archived",datereviewed:"Date reviewed",dateadded:"Date added",creator:"Creator"},xa={relevance:"desc",alltimeview:"desc",weeklyview:"desc",title:"asc",date:"desc",datearchived:"desc",datereviewed:"desc",dateadded:"desc",creator:"asc"},mn={relevance:null,alltimeview:"downloads",weeklyview:"week",title:"titleSorter",date:"date",datearchived:"publicdate",datereviewed:"reviewdate",dateadded:"addeddate",creator:"creatorSorter"};M.weeklyview,M.alltimeview,M.title,M.date,M.datearchived,M.datereviewed,M.dateadded,M.creator;const fn={week:"week",downloads:"downloads",titleSorter:"title",date:"date",publicdate:"publicdate",reviewdate:"reviewdate",addeddate:"addeddate",creatorSorter:"creator"},_a={week:M.weeklyview,downloads:M.alltimeview,title:M.title,titleSorter:M.title,date:M.date,publicdate:M.datearchived,reviewdate:M.datereviewed,addeddate:M.dateadded,creator:M.creator,creatorSorter:M.creator},gn={title:"firstTitle",creator:"firstCreator"},ai=()=>({subject:{},lending:{},mediatype:{},language:{},creator:{},collection:{},year:{}}),bn=["mediatype","lending","year","subject","collection","creator","language"],zi={subject:"Subject",lending:"Availability",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"},fo={subject:K.COUNT,lending:K.COUNT,mediatype:K.COUNT,language:K.COUNT,creator:K.COUNT,collection:K.COUNT,year:K.NUMERIC},yn={subject:K.ALPHABETICAL,lending:K.ALPHABETICAL,mediatype:K.ALPHABETICAL,language:K.ALPHABETICAL,creator:K.ALPHABETICAL,collection:K.ALPHABETICAL,year:K.NUMERIC},wn={is_lendable:!0,is_borrowable:!1,available_to_borrow:!0,is_browsable:!1,available_to_browse:!1,is_readable:!0,available_to_waitlist:!1},$a={is_lendable:"Lending Library",available_to_borrow:"Borrow 14 Days",is_readable:"Always Available"},Eo={deemphasize:!0,community:!0,stream_only:!0,samples_only:!0,test_collection:!0,printdisabled:!0,"openlibrary-ol":!0,nationalemergencylibrary:!0,china:!0,americana:!0,toronto:!0};function nr(a){switch(a){case"publicdate":return"Archived";case"reviewdate":return"Reviewed";case"addeddate":return"Added";default:return"Published"}}function lr(a){return a?`Archivist since ${a.getFullYear()}`:""}let be=class extends D{constructor(){super(...arguments),this.sortParam=null,this.collectionLinks=[],this.loggedIn=!1}render(){return h`
  ...
  `;s([c({type:String})],Oe.prototype,"selectedLetter",void 0);s([c({type:Object})],Oe.prototype,"letterCounts",void 0);s([c({type:String})],Oe.prototype,"ariaLandmarkLabel",void 0);s([z()],Oe.prototype,"tooltipShown",void 0);s([z()],Oe.prototype,"hoveredLetter",void 0);s([X("alpha-bar-tooltip")],Oe.prototype,"tooltip",void 0);Oe=s([P("alpha-bar")],Oe);const _n=h`
...
`;let te=class extends D{constructor(){super(...arguments),this.sortDirection=null,this.selectedSort=M.relevance,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.showRelevance=!0,this.alphaSelectorVisible=null,this.dropdownBackdropVisible=!1,this.desktopSortContainerWidth=0,this.selectorBarContainerWidth=0,this.boundSortBarSelectorEscapeListener=e=>{e.key==="Escape"&&this.closeDropdowns()}}render(){return h`
    ...
    ></alpha-bar>`}titleLetterChanged(e){var t;this.selectedTitleFilter=(t=e.detail.selectedLetter)!==null&&t!==void 0?t:null,this.emitTitleLetterChangedEvent()}creatorLetterChanged(e){var t;this.selectedCreatorFilter=(t=e.detail.selectedLetter)!==null&&t!==void 0?t:null,this.emitCreatorLetterChangedEvent()}emitTitleLetterChangedEvent(){const e=new CustomEvent("titleLetterChanged",{detail:{selectedLetter:this.selectedTitleFilter}});this.dispatchEvent(e)}emitCreatorLetterChangedEvent(){const e=new CustomEvent("creatorLetterChanged",{detail:{selectedLetter:this.selectedCreatorFilter}});this.dispatchEvent(e)}displayModeChanged(){const e=new CustomEvent("displayModeChanged",{detail:{displayMode:this.displayMode}});this.dispatchEvent(e)}emitSortChangedEvent(){const e=new CustomEvent("sortChanged",{detail:{selectedSort:this.selectedSort,sortDirection:this.sortDirection}});this.dispatchEvent(e)}static get styles(){return[Qe,m`
      ...
      `]}};s([c({type:String})],te.prototype,"displayMode",void 0);s([c({type:String})],te.prototype,"sortDirection",void 0);s([c({type:String})],te.prototype,"selectedSort",void 0);s([c({type:String})],te.prototype,"selectedTitleFilter",void 0);s([c({type:String})],te.prototype,"selectedCreatorFilter",void 0);s([c({type:Boolean})],te.prototype,"showRelevance",void 0);s([c({type:Object})],te.prototype,"prefixFilterCountMap",void 0);s([c({type:Object})],te.prototype,"resizeObserver",void 0);s([z()],te.prototype,"alphaSelectorVisible",void 0);s([z()],te.prototype,"dropdownBackdropVisible",void 0);s([z()],te.prototype,"desktopSortContainerWidth",void 0);s([z()],te.prototype,"selectorBarContainerWidth",void 0);s([X("#desktop-sort-container")],te.prototype,"desktopSortContainer",void 0);s([X("#sort-selector-container")],te.prototype,"sortSelectorContainer",void 0);s([X("#views-dropdown")],te.prototype,"viewsDropdown",void 0);s([X("#date-dropdown")],te.prototype,"dateDropdown",void 0);s([X("#mobile-dropdown")],te.prototype,"mobileDropdown",void 0);te=s([P("sort-filter-bar")],te);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;let Dt=class extends D{constructor(){super(...arguments),this.step=2,this.currentPage=1,this.pages=[]}firstUpdated(){this.observePageCount()}updated(e){e.has("size")&&this.observePageCount(),e.has("currentPage")&&(this.observePageCount(),this.emitPageClick())}observePageCount(){this.pages=[];const e=7,t=this.size<=e;if(this.size<=5){this.pages=[...Array(this.size).keys()].map(r=>r+1);return}if(this.size===e){if(this.currentPage===2){this.pages=[1,2,3,4,0,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,4,5,this.size-1,this.size];return}}if(this.currentPage===1){this.pages=[1,2,3,0,this.size];return}if(this.currentPage===this.size){this.pages=[1,0,this.size-2,this.size-1,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,this.size-3,this.size-2,this.size-1,this.size];return}if(t&&this.currentPage>1&&this.currentPage<e){this.pages=[...Array(this.size).keys()].map(r=>r+1);return}let i=this.currentPage-this.step,o=this.currentPage+this.step;i<=0&&(o+=-i+1,i=1),o>=this.size&&(i=Math.max(i-(o-this.size),1),o=this.size),i===2&&(o-=1),o===this.size-1&&(i+=1),this.createFirstNode(i),this.createMiddelNode(i,o),this.createLastNode(o)}createFirstNode(e){var t,i;e>1&&((t=this.pages)===null||t===void 0||t.push(1)),e>2&&((i=this.pages)===null||i===void 0||i.push(0))}createMiddelNode(e,t){var i;for(let o=e;o<=t;o+=1)(i=this.pages)===null||i===void 0||i.push(o)}createLastNode(e){var t,i;e<this.size-1&&((t=this.pages)===null||t===void 0||t.push(0)),e<this.size&&((i=this.pages)===null||i===void 0||i.push(this.size))}get getEllipsisTemplate(){return h`<i class="ellipses">...</i>`}emitPageClick(){this.dispatchEvent(new CustomEvent("pageNumberClicked",{detail:{page:this.currentPage},bubbles:!0,composed:!0}))}onRewind(){this.currentPage-=1,this.currentPage<1&&(this.currentPage=1)}onForward(){this.currentPage+=1,this.currentPage>this.size&&(this.currentPage=this.size)}onChange(e){this.currentPage=e}getPageTemplate(e){return h`
    ...
    `}static get styles(){return[Qe,m`
      ...
      `]}};s([c({type:Number})],Dt.prototype,"size",void 0);s([c({type:Number})],Dt.prototype,"step",void 0);s([c({type:Number})],Dt.prototype,"currentPage",void 0);s([z()],Dt.prototype,"pages",void 0);Dt=s([P("more-facets-pagination")],Dt);var nl=F`
