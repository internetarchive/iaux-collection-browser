...
`;let ba=class extends O{render(){var e,t,i;return m`
      <div id="container">
    ...
    `}};n([u({type:Object})],ba.prototype,"model",void 0);ba=n([N("collection-tile")],ba);function Si(r,e="short",t="en-US"){if(!r)return"";const i={timeZone:"UTC"};switch(e){case"short":i.month="short",i.year="numeric";break;case"long":i.year="numeric",i.month="short",i.day="2-digit";break}return new Intl.DateTimeFormat(t,i).format(r)}/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const wa=Ii(class extends Pi{constructor(r){var e;if(super(r),r.type!==Ee.ATTRIBUTE||r.name!=="class"||((e=r.strings)===null||e===void 0?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(r){return" "+Object.keys(r).filter(e=>r[e]).join(" ")+" "}update(r,[e]){var t,i;if(this.et===void 0){this.et=new Set,r.strings!==void 0&&(this.st=new Set(r.strings.join(" ").split(/\s/).filter(o=>o!=="")));for(const o in e)e[o]&&!(!((t=this.st)===null||t===void 0)&&t.has(o))&&this.et.add(o);return this.render(e)}const a=r.element.classList;this.et.forEach(o=>{o in e||(a.remove(o),this.et.delete(o))});for(const o in e){const s=!!e[o];s===this.et.has(o)||((i=this.st)===null||i===void 0?void 0:i.has(o))||(s?(a.add(o),this.et.add(o)):(a.remove(o),this.et.delete(o)))}return fe}}),Ts=I`
  <svg
    viewBox="0 0 100 100"
    xmlns="http://www.w3.org/2000/svg"
  >
...
`;let $i=class extends O{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1}render(){return this.loginRequired&&!this.loggedIn?m`${zs}`:m`${Ts}`}static get styles(){return y`
      :host {
        position: absolute;
        top: 50%;
        left: 50%;
 ...
 */function*fi(r,e){const t=typeof e=="function";if(r!==void 0){let i=-1;for(const a of r)i>-1&&(yield t?e(i):e),i++,yield a}}let ki=class extends O{constructor(){super(...arguments),this.snippets=[],this.viewSize="desktop"}render(){var e;return!((e=this.snippets)===null||e===void 0)&&e.length?m`
    ...
    `}};n([u({type:Array})],ki.prototype,"snippets",void 0);n([u({type:String})],ki.prototype,"viewSize",void 0);ki=n([N("text-snippet-block")],ki);const Ms=y`
  .drop-shadow {
...
`;let De=class extends O{constructor(){super(...arguments),this.isListTile=!1,this.isCompactTile=!1,this.loggedIn=!1,this.isWaveform=!1}render(){return m`
...
`,Us={account:{color:"#000000",icon:As,text:"Account"},audio:{color:"#00adef",icon:Ds,text:"Audio"},collection:{color:"#4666ff",icon:ho,text:"Collection"},data:{color:"#333333",icon:Ls,text:"Data"},etree:{color:"#00adef",icon:Fs,text:"E-tree"},film:{color:"#bf1b2c",icon:xr,text:"Film"},image:{color:"#aa99c9",icon:Os,text:"Image"},movies:{color:"#f1644b",icon:xr,text:"Movie"},radio:{color:"#8fdaef",icon:Is,text:"Radio"},software:{color:"#9ecc4f",icon:Ps,text:"Software"},texts:{color:"#faab3c",icon:Rs,text:"Text"},tv:{color:"#f1644b",icon:Ns,text:"TV"},video:{color:"#f1644b",icon:Bs,text:"Video"},web:{color:"#ffcd27",icon:Hs,text:"Web"}};let ri=class extends O{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var e,t;const i=["tvnews","tvarchive","television"],a=["radio","radioprogram"];return this.mediatype==="movies"&&((e=this.collections)===null||e===void 0?void 0:e.some(o=>i.indexOf(o)>=0))?"tv":this.mediatype==="audio"&&((t=this.collections)===null||t===void 0?void 0:t.some(o=>a.indexOf(o)>=0))?"radio":this.mediatype||""}render(){const e=Us[this.displayMediatype];return e?m`
    ...
    `}};n([u({type:String})],ri.prototype,"mediatype",void 0);n([u({type:Array})],ri.prototype,"collections",void 0);n([u({type:Boolean})],ri.prototype,"showText",void 0);ri=n([N("mediatype-icon")],ri);const js=I`
...
`;function Qs(r,e){let t=1;return r>=1e9?t=1e9:r>=1e6?t=1e6:r>=1e3&&e==="short"&&(t=1e3),t}function Ys(r=0,e){const t=r/e,i=t<10;let a=0;return i?a=Math.round((t+Number.EPSILON)*10)/10:a=Math.round(t),a}function Ks(r,e,t,i){switch(e){case 1e9:return Ze(t==="short"?gt`${r}B`:gt`${r} billion`);case 1e6:return Ze(t==="short"?gt`${r}M`:gt`${r} million`);case 1e3:return Ze(t==="short"?gt`${r}K`:gt`${r} thousand`);default:return new Intl.NumberFormat(i).format(r)}}function Xt(r,e="long",t="short",i="en-US"){const a=r!=null?r:-1;if(a<0)return"";const o=Qs(a,e),s=Ys(a,o);return Ks(s,o,t,i)}let rt=class extends O{render(){const e=Xt(this.favCount,"short","short"),t=Xt(this.commentCount,"short","short"),i=this.mediatype==="account"?`${this.itemCount} uploads`:`${this.viewCount} all-time views`;return m`
    ...
    `}};n([u({type:String})],zt.prototype,"baseImageUrl",void 0);n([u({type:Boolean})],zt.prototype,"loggedIn",void 0);n([u({type:Object})],zt.prototype,"model",void 0);n([u({type:Object})],zt.prototype,"sortParam",void 0);zt=n([N("item-tile")],zt);let xa=class extends O{render(){var e,t,i,a,o,s,l,d;return m`
    ...
    `}};n([u({type:Object})],xa.prototype,"model",void 0);xa=n([N("account-tile")],xa);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`+ne),ct&&(ne=Fe(ne,He," "),ne=Fe(ne,Ue," ")),B&&ni?B.createHTML(ne):ne},e.setConfig=function(C){Gi(C),Ni=!0},e.clearConfig=function(){vt=null,Ni=!1},e.isValidAttribute=function(C,h,b){vt||Gi({});var S=Qe(C),H=Qe(h);return er(S,H,b)},e.addHook=function(C,h){typeof h=="function"&&(ue[C]=ue[C]||[],Yt(ue[C],h))},e.removeHook=function(C){if(ue[C])return Sr(ue[C])},e.removeHooks=function(C){ue[C]&&(ue[C]=[])},e.removeAllHooks=function(){ue={}},e}var Zt=po(),L;(function(r){r.relevance="relevance",r.alltimeview="alltimeview",r.weeklyview="weeklyview",r.title="title",r.datearchived="datearchived",r.date="date",r.datereviewed="datereviewed",r.dateadded="dateadded",r.creator="creator"})(L||(L={}));const Xe={relevance:"Relevance",alltimeview:"All-time Views",weeklyview:"Weekly Views",title:"Title",datearchived:"Date Archived",date:"Date Published",datereviewed:"Date Reviewed",dateadded:"Date Added",creator:"Creator"},Cn={relevance:null,alltimeview:"downloads",weeklyview:"week",title:"titleSorter",datearchived:"publicdate",date:"date",datereviewed:"reviewdate",dateadded:"addeddate",creator:"creatorSorter"},zr={week:L.weeklyview,downloads:L.alltimeview,titleSorter:L.title,date:L.date,publicdate:L.datearchived,reviewdate:L.datereviewed,addeddate:L.dateadded,creatorSorter:L.creator},zi={subject:{},lending:{},mediatype:{},language:{},creator:{},collection:{},year:{}},kn=["mediatype","lending","year","subject","collection","creator","language"],Mi={subject:"Subject",lending:"Availability",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"},Tn={is_lendable:!0,is_borrowable:!1,available_to_borrow:!0,is_browsable:!1,available_to_browse:!1,is_readable:!0,available_to_waitlist:!1},Mr={is_lendable:"Lending Library",available_to_borrow:"Borrow 14 Days",is_readable:"Always Available"},Ia={deemphasize:!0,community:!0,stream_only:!0,samples_only:!0,test_collection:!0,printdisabled:!0,"openlibrary-ol":!0,nationalemergencylibrary:!0,china:!0,americana:!0,toronto:!0};function mo(r){switch(r){case"date":return"Published";case"reviewdate":return"Reviewed";case"addeddate":return"Added";default:return"Archived"}}function vo(r){return r?`Archivist since ${r.getFullYear()}`:""}let ye=class extends O{constructor(){super(...arguments),this.sortParam=null,this.collectionLinks=[],this.loggedIn=!1}updated(e){e.has("model")&&this.fetchCollectionNames()}async fetchCollectionNames(){var e,t;if(!(!((e=this.model)===null||e===void 0)&&e.collections)||this.model.collections.length===0||!this.collectionNameCache)return;this.collectionLinks=[];const i=[],a=[];for(const o of this.model.collections)!Ia[o]&&!o.startsWith("fav-")&&a.push((t=this.collectionNameCache)===null||t===void 0?void 0:t.collectionNameFor(o).then(s=>{i.push(this.detailsLink(o,s!=null?s:o))}));await Promise.all(a),this.collectionLinks=i}render(){return m`
    ...
    `:_}get volumeTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.volume,"Volume")}get issueTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.issue,"Issue")}get creatorTemplate(){var e,t,i;return((e=this.model)===null||e===void 0?void 0:e.mediatype)==="account"?m`
      ...
      <div id="creator" class="metadata">
        ...
        ${fi(_a(this.model.creators,a=>this.searchLink("creator",a)),m`, `)}
      </div>
    `}get datePublishedTemplate(){var e;return this.metadataTemplate(Si((e=this.model)===null||e===void 0?void 0:e.datePublished,"long"),"Published")}get dateSortByTemplate(){return this.sortParam&&(this.sortParam.field==="addeddate"||this.sortParam.field==="reviewdate"||this.sortParam.field==="publicdate")?this.metadataTemplate(Si(this.date,"long"),mo(this.sortParam.field)):_}get viewsTemplate(){var e,t,i;const a=((e=this.sortParam)===null||e===void 0?void 0:e.field)==="week"?(t=this.model)===null||t===void 0?void 0:t.weeklyViewCount:(i=this.model)===null||i===void 0?void 0:i.viewCount;return this.metadataTemplate(`${Xt(a!=null?a:0,this.formatSize)}`,"Views")}get ratingTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.averageRating,"Avg Rating")}get reviewsTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.commentCount,"Reviews")}get topicsTemplate(){var e;return!(!((e=this.model)===null||e===void 0)&&e.subjects)||this.model.subjects.length===0?_:m`
      <div id="topics" class="metadata">
        ...
        ${fi(_a(this.model.subjects,t=>this.searchLink("subject",t)),m`, `)}
      </div>
    ...
    `}};n([u({type:Object})],ye.prototype,"model",void 0);n([u({type:String})],ye.prototype,"baseNavigationUrl",void 0);n([u({type:Object})],ye.prototype,"collectionNameCache",void 0);n([u({type:Number})],ye.prototype,"currentWidth",void 0);n([u({type:Number})],ye.prototype,"currentHeight",void 0);n([u({type:Object})],ye.prototype,"sortParam",void 0);n([u({type:Number})],ye.prototype,"mobileBreakpoint",void 0);n([z()],ye.prototype,"collectionLinks",void 0);n([u({type:String})],ye.prototype,"baseImageUrl",void 0);n([u({type:Boolean})],ye.prototype,"loggedIn",void 0);ye=n([N("tile-list")],ye);let ke=class extends O{constructor(){super(...arguments),this.sortParam=null,this.loggedIn=!1}render(){var e,t,i,a,o,s,l,d,c;return m`
      <div id="list-line" class="${this.classSize}">
        ...
        <div id="creator">
          ${((i=this.model)===null||i===void 0?void 0:i.mediatype)==="account"?vo((a=this.model)===null||a===void 0?void 0:a.dateAdded):Zt.sanitize((s=(o=this.model)===null||o===void 0?void 0:o.creator)!==null&&s!==void 0?s:"")}
        </div>
    ...
    `}};Er=n([N("collection-browser-loading-tile")],Er);let Ei=class extends O{constructor(){super(...arguments),this.selectedLetter=null,this.alphabet="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("")}get selectedUppercaseLetter(){var e;return(e=this.selectedLetter)===null||e===void 0?void 0:e.toUpperCase()}render(){return m`
      <div id="container">
        <ul>
  ...
  `;n([u({type:String})],Ei.prototype,"selectedLetter",void 0);Ei=n([N("alpha-bar")],Ei);const Ar=I`
...
`;let za=class extends O{constructor(){super(...arguments),this.config=new _o}render(){return m`
      <div class="modal-wrapper">
        <div class="modal-container">
          <header style="background-color: ${this.config.headerColor}">
            ${this.config.showCloseButton?this.closeButtonTemplate:""}
            ${this.config.showHeaderLogo?m`<div class="logo-icon">${zl}</div>`:_}
...
`;let Dt=class extends O{constructor(){super(...arguments),this.step=2,this.currentPage=1,this.pages=[]}firstUpdated(){this.observePageCount()}updated(e){e.has("size")&&this.observePageCount(),e.has("currentPage")&&(this.observePageCount(),this.emitPageClick())}observePageCount(){this.pages=[];const e=7,t=this.size<=e;if(this.size<=5){this.pages=[...Array(this.size).keys()].map(o=>o+1);return}if(this.size===e){if(this.currentPage===2){this.pages=[1,2,3,4,0,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,4,5,this.size-1,this.size];return}}if(this.currentPage===1){this.pages=[1,2,3,0,this.size];return}if(this.currentPage===this.size){this.pages=[1,0,this.size-2,this.size-1,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,this.size-3,this.size-2,this.size-1,this.size];return}if(t&&this.currentPage>1&&this.currentPage<e){this.pages=[...Array(this.size).keys()].map(o=>o+1);return}let i=this.currentPage-this.step,a=this.currentPage+this.step;i<=0&&(a+=-i+1,i=1),a>=this.size&&(i=Math.max(i-(a-this.size),1),a=this.size),i===2&&(a-=1),a===this.size-1&&(i+=1),this.createFirstNode(i),this.createMiddelNode(i,a),this.createLastNode(a)}createFirstNode(e){var t,i;e>1&&((t=this.pages)===null||t===void 0||t.push(1)),e>2&&((i=this.pages)===null||i===void 0||i.push(0))}createMiddelNode(e,t){var i;for(let a=e;a<=t;a+=1)(i=this.pages)===null||i===void 0||i.push(a)}createLastNode(e){var t,i;e<this.size-1&&((t=this.pages)===null||t===void 0||t.push(0)),e<this.size&&((i=this.pages)===null||i===void 0||i.push(this.size))}get getEllipsisTemplate(){return m`<i class="ellipses">...</i>`}emitPageClick(){this.dispatchEvent(new CustomEvent("pageNumberClicked",{detail:{page:this.currentPage},bubbles:!0,composed:!0}))}onRewind(){this.currentPage-=1,this.currentPage<1&&(this.currentPage=1)}onForward(){this.currentPage+=1,this.currentPage>this.size&&(this.currentPage=this.size)}onChange(e){this.currentPage=e}getPageTemplate(e){return m`
    ...
    `}};n([u({type:Number})],Dt.prototype,"size",void 0);n([u({type:Number})],Dt.prototype,"step",void 0);n([u({type:Number})],Dt.prototype,"currentPage",void 0);n([z()],Dt.prototype,"pages",void 0);Dt=n([N("more-facets-pagination")],Dt);var Ll=I`
...
`;let Lt=class extends O{facetClicked(e,t,i){const a=e.target,{checked:o,name:s,value:l}=a;o?this.facetChecked(s,l,t,i):this.facetUnchecked(s,l)}facetChecked(e,t,i,a){const{selectedFacets:o}=this;let s;o?s=ge({},o):s=zi,s[e][t]={state:a?"hidden":"selected",count:i},this.selectedFacets=s,this.dispatchSelectedFacetsChanged()}facetUnchecked(e,t){const{selectedFacets:i}=this;let a;i?a=ge({},i):a=zi,delete a[e][t],this.selectedFacets=a,this.dispatchSelectedFacetsChanged()}dispatchSelectedFacetsChanged(){const e=new CustomEvent("selectedFacetsChanged",{detail:this.selectedFacets,bubbles:!0,composed:!0});this.dispatchEvent(e)}getFacetsTemplate(e){let t=e==null?void 0:e.buckets;return t=[...t.filter(i=>i.state==="selected").sort((i,a)=>i.count<a.count?1:-1),...t.filter(i=>i.state==="hidden").sort((i,a)=>i.count<a.count?1:-1),...t.filter(i=>i.state==="none")],m`
      <div class="facets-on-${this.renderOn}">
        ${co(t,i=>`${e.key}:${i.key}`,i=>{var a,o;const s=`${e.key}:${i.key}-show-only`,l=`${e.key}:${i.key}-negative`,d=e.key!=="collection"?m`${(a=i.displayText)!==null&&a!==void 0?a:i.key}`:m`<a href="/details/${i.key}">
    ...
    `}getTombstoneFacetGroupTemplate(){return m`
      ${_a(Array(5).fill(null),()=>m`<facet-tombstone-row></facet-tombstone-row>`)}
    ...
    `,l=new _o({bodyColor:"#fff",headerColor:"#194880",showHeaderLogo:!1,closeOnBackdropClick:!0,title:m`Select filters`});(i=this.modalManager)===null||i===void 0||i.classList.add("more-search-facets"),(a=this.modalManager)===null||a===void 0||a.showModal({config:l,customModalContent:s})}getFacetTemplate(e){return m`
      <facets-template
        .facetGroup=${e}
        .selectedFacets=${this.selectedFacets}
        .renderOn=${"page"}
