...
`;let Li=class extends O{constructor(){super(...arguments),this.placeholderType=null}render(){return this.placeholderType?m`${this.placeholderTemplate}`:_}get placeholderTemplate(){return m`
    ...
    `}setPlaceholderType(){this.placeholderType=null,this.baseQuery||(this.placeholderType="empty-query"),(!this.searchResultsLoading&&this.totalResults===0||!this.searchService)&&(this.placeholderType="null-result")}get emptyPlaceholderTemplate(){return m`
      ...
      ></empty-placeholder>
    `}get collectionBrowserTemplate(){var e;const t=this.searchResultsLoading||this.totalResults===void 0,i=(e=this.totalResults)===null||e===void 0?void 0:e.toLocaleString(),a=this.totalResults===1?"Result":"Results";return m`<div
        id="left-column"
