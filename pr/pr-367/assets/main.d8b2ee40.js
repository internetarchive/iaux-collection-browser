 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ps=({finisher:r,descriptor:e})=>(t,i)=>{var o;if(i===void 0){const a=(o=t.originalKey)!==null&&o!==void 0?o:t.key,s=e!=null?{kind:"method",placement:"prototype",key:a,descriptor:e(t.key)}:xe(se({},t),{key:a});return r!=null&&(s.finisher=function(n){r(n,a)}),s}{const a=t.constructor;e!==void 0&&Object.defineProperty(t,i,e(i)),r==null||r(a,i)}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;let di=class extends F{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1,this.isCompactTile=!1}render(){return c`<div class="icon-overlay ${this.getClass}">
    ...
    `}};l([h({type:Boolean})],di.prototype,"loggedIn",void 0);l([h({type:Boolean})],di.prototype,"loginRequired",void 0);l([h({type:Boolean})],di.prototype,"isCompactTile",void 0);di=l([L("icon-overlay")],di);let ci=class extends F{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1,this.iconRequired=!1}render(){return c`
...
`;let Dt=class extends F{constructor(){super(...arguments),this.title="",this.body="",this.starRating=0,this.viewSize="desktop"}render(){return!this.title&&!this.body&&!this.starRating?y:c`
...
`+fe),mt&&(fe=Ge(fe,Je," "),fe=Ge(fe,et," ")),O&&xi?O.createHTML(fe):fe},e.setConfig=function(M){no(M),to=!0},e.clearConfig=function(){xt=null,to=!1},e.isValidAttribute=function(M,v,x){xt||no({});var C=ot(M),V=ot(v);return Ur(C,V,x)},e.addHook=function(M,v){typeof v=="function"&&(ye[M]=ye[M]||[],ei(ye[M],v))},e.removeHook=function(M){if(ye[M])return va(ye[M])},e.removeHooks=function(M){ye[M]&&(ye[M]=[])},e.removeAllHooks=function(){ye={}},e}var Li=Es();let ji=class extends ne{constructor(){super(...arguments),this.collectionLinks=[]}render(){return c`
    ...
    `}};l([h({type:Object})],ji.prototype,"collectionTitles",void 0);l([z()],ji.prototype,"collectionLinks",void 0);ji=l([L("tile-list")],ji);let Ye=class extends F{constructor(){super(...arguments),this.loggedIn=!1}render(){return c`
      <div id="container">
        <tile-list
          .model=${this.model}
...
fill=""></path>
  ...
  `;nr=l([Is("ia-icon-label")],nr);let dr=class extends F{constructor(){super(...arguments),this.numResults=0}render(){return c`
    ...
    `}};l([h({type:Number})],dr.prototype,"numResults",void 0);dr=l([L("alpha-bar-tooltip")],dr);let Ve=class extends F{constructor(){super(...arguments),this.selectedLetter=null,this.tooltipShown=!1,this.alphabet="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("")}get selectedUppercaseLetter(){var e;return(e=this.selectedLetter)===null||e===void 0?void 0:e.toUpperCase()}render(){var e;return c`
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Na(r,e,t){return r?e():t==null?void 0:t()}const Ua=m`var(--white, #fff)`,kd=m`var(--primaryDisableCTAFill, #767676)`,Td=m`var(--secondaryCTABorder, #999)`,Ed=m`var(--primaryCTAFill, #194880)`,Lo=m`var(--primaryCTAFillRGB, 25, 72, 128)`,Md=m`var(--primaryCTABorder, #c5d1df)`,zd=m`var(--primaryErrorCTAFill, #d9534f)`,Bo=m`var(--primaryErrorCTAFillRGB, 229, 28, 38)`,Pd=m`var(--primaryErrorCTABorder, #d43f3a)`,Ad=m`var(--secondaryCTAFill, #333)`,Ro=m`var(--secondaryCTAFillRGB, 51, 51, 51)`,Dd=m`var(--primaryCTABorder, #979797)`,Ld=m`#ee8950`,Bd=m`#ec7939`;var Rd=m`
  .ia-button {
    min-height: 3rem;
    cursor: pointer;
    color: ${Ua};
...
`;let hr=class extends F{constructor(){super(...arguments),this.config=new cr}render(){return c`
...
`,pr;let Nt=pr=class extends F{render(){return c`${this.facetRowTemplate}`}get facetRowTemplate(){var e,t,i,o;const{bucket:a,facetType:s}=this;if(!a||!s)return y;const n=`${s}:${a.key}-show-only`,d=`${s}:${a.key}-negative`,p=s!=="collection"?c`${(e=a.displayText)!==null&&e!==void 0?e:a.key}`:c`<a href="/details/${a.key}">
    ...
    `}};l([h({type:Object})],Ut.prototype,"facetGroup",void 0);l([h({type:Object})],Ut.prototype,"selectedFacets",void 0);l([h({type:String})],Ut.prototype,"renderOn",void 0);l([h({type:Object})],Ut.prototype,"collectionTitles",void 0);Ut=l([L("facets-template")],Ut);let Ze=class extends F{constructor(){super(...arguments),this.leftValue="",this.rightValue="",this.side="left"}render(){var e,t;return c`
      <div id="container">
    ...
    `}applySearchFacetsClicked(){var e,t;const i=new CustomEvent("facetsChanged",{detail:this.selectedFacets,bubbles:!0,composed:!0});this.dispatchEvent(i),(e=this.modalManager)===null||e===void 0||e.closeModal(),(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:Le.default,action:`${ie.applyMoreFacetsModal}`,label:`${this.facetKey}`})}cancelClick(){var e,t;(e=this.modalManager)===null||e===void 0||e.closeModal(),(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:Le.default,action:ie.closeMoreFacetsModal,label:`${this.facetKey}`})}static get styles(){const e=m`var(--primaryButtonBGColor, #194880)`;return[We,m`
      ...
      `]}};l([h({type:String})],re.prototype,"facetKey",void 0);l([h({type:String})],re.prototype,"facetAggregationKey",void 0);l([h({type:String})],re.prototype,"query",void 0);l([h({type:Object})],re.prototype,"filterMap",void 0);l([h({type:Object})],re.prototype,"modalManager",void 0);l([h({type:Object})],re.prototype,"searchService",void 0);l([h({type:String})],re.prototype,"searchType",void 0);l([h({type:Object})],re.prototype,"pageSpecifierParams",void 0);l([h({type:Object})],re.prototype,"collectionTitles",void 0);l([h({type:Object})],re.prototype,"selectedFacets",void 0);l([h({type:String})],re.prototype,"sortedBy",void 0);l([h({type:Object,attribute:!1})],re.prototype,"analyticsHandler",void 0);l([z()],re.prototype,"aggregations",void 0);l([z()],re.prototype,"facetGroup",void 0);l([z()],re.prototype,"facetGroupTitle",void 0);l([z()],re.prototype,"pageNumber",void 0);l([z()],re.prototype,"facetsLoading",void 0);l([z()],re.prototype,"paginationSize",void 0);l([z()],re.prototype,"facetsType",void 0);re=l([L("more-facets-content")],re);let Ka=class extends F{render(){return c`
      <div id="row">
    ...
    `}};Ka=l([L("facet-tombstone-row")],Ka);let Fe=class extends F{constructor(){super(...arguments),this.boundEscapeListener=e=>{e.key==="Escape"&&this.closeModal()}}render(){var e,t;return c`
      <div id="container">
    ...
    `}connectedCallback(){var e;(e=super.connectedCallback)===null||e===void 0||e.call(this),this.setupEscapeListener()}disconnectedCallback(){var e;(e=super.disconnectedCallback)===null||e===void 0||e.call(this),this.removeEscapeListener()}setupEscapeListener(){document.addEventListener("keydown",this.boundEscapeListener)}removeEscapeListener(){document.removeEventListener("keydown",this.boundEscapeListener)}histogramDateRangeUpdated(e){this.minSelectedDate=e.detail.minDate,this.maxSelectedDate=e.detail.maxDate}applyBtnClicked(){var e;const t=new CustomEvent("histogramDateRangeApplied",{detail:{minDate:this.minSelectedDate,maxDate:this.maxSelectedDate}});this.dispatchEvent(t),this.closeModal(),(e=this.analyticsHandler)===null||e===void 0||e.sendEvent({category:Le.default,action:ie.histogramChangedFromModal,label:window.location.href})}closeModal(){this.modalManager&&(this.modalManager.closeModal(),this.dispatchEvent(new CustomEvent("modalClosed")))}static get styles(){return m`
      #container {
        display: flex;
        justify-content: center;
    ...
    `}partOfCollectionClicked(e){var t;(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:Le.default,action:ie.partOfCollectionClicked,label:e.target.dataset.id})}showDatePickerModal(){var e,t,i;const{fullYearsHistogramAggregation:o}=this,a=o==null?void 0:o.first_bucket_key,s=o==null?void 0:o.last_bucket_key,n=o==null?void 0:o.buckets,p=c`
    ...
    `}searchMoreFacetsLink(e){if(!this.moreLinksVisible||e.key==="lending"||Object.keys(e.buckets).length<this.allowedFacetCount)return y;const t=Ui[e.key];return c`<button
      class="more-link"
      @click=${()=>{var i;this.showMoreFacetsModal(e,t),(i=this.analyticsHandler)===null||i===void 0||i.sendEvent({category:Le.default,action:ie.showMoreFacetsModal,label:e.key}),this.dispatchEvent(new CustomEvent("showMoreFacets",{detail:e.key}))}}
    >
      More...
  ...
  `;l([z()],le.prototype,"toggleSlots",void 0);l([z()],le.prototype,"currentPage",void 0);l([z()],le.prototype,"searchQuery",void 0);l([z()],le.prototype,"withinCollection",void 0);l([z()],le.prototype,"cellWidth",void 0);l([z()],le.prototype,"cellHeight",void 0);l([z()],le.prototype,"rowGap",void 0);l([z()],le.prototype,"colGap",void 0);l([z()],le.prototype,"loggedIn",void 0);l([z()],le.prototype,"searchType",void 0);l([h({type:Object,reflect:!1})],le.prototype,"latestAction",void 0);l([K("#base-query-field")],le.prototype,"baseQueryField",void 0);l([K("#base-collection-field")],le.prototype,"baseCollectionField",void 0);l([K("#page-number-input")],le.prototype,"pageNumberInput",void 0);l([K("collection-browser")],le.prototype,"collectionBrowser",void 0);l([K("modal-manager")],le.prototype,"modalManager",void 0);le=l([L("app-root")],le);
