 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Ki;const wt=globalThis.trustedTypes,or=wt?wt.createPolicy("lit-html",{createHTML:r=>r}):void 0,ze=`lit$${(Math.random()+"").slice(9)}$`,ka="?"+ze,as=`<${ka}>`,xt=document,Kt=(r="")=>xt.createComment(r),qt=r=>r===null||typeof r!="object"&&typeof r!="function",Hr=Array.isArray,Ur=r=>{var e;return Hr(r)||typeof((e=r)===null||e===void 0?void 0:e[Symbol.iterator])=="function"},Ht=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,sr=/-->/g,nr=/>/g,We=/>|[ 	\n\r](?:([^\s"'>=/]+)([ 	\n\r]*=[ 	\n\r]*(?:[^ 	\n\r"'`<>=]|("|')|))|$)/g,lr=/'/g,dr=/"/g,Vr=/^(?:script|style|textarea|title)$/i,jr=r=>(e,...t)=>({_$litType$:r,strings:e,values:t}),m=jr(1),F=jr(2),ue=Symbol.for("lit-noChange"),$=Symbol.for("lit-nothing"),cr=new WeakMap,ci=(r,e,t)=>{var i,a;const o=(i=t==null?void 0:t.renderBefore)!==null&&i!==void 0?i:e;let s=o._$litPart$;if(s===void 0){const l=(a=t==null?void 0:t.renderBefore)!==null&&a!==void 0?a:null;o._$litPart$=s=new Dt(e.insertBefore(Kt(),l),l,void 0,t!=null?t:{})}return s._$AI(r),s},bt=xt.createTreeWalker(xt,129,null,!1),Wr=(r,e)=>{const t=r.length-1,i=[];let a,o=e===2?"<svg>":"",s=Ht;for(let d=0;d<t;d++){const c=r[d];let u,v,f=-1,b=0;for(;b<c.length&&(s.lastIndex=b,v=s.exec(c),v!==null);)b=s.lastIndex,s===Ht?v[1]==="!--"?s=sr:v[1]!==void 0?s=nr:v[2]!==void 0?(Vr.test(v[2])&&(a=RegExp("</"+v[2],"g")),s=We):v[3]!==void 0&&(s=We):s===We?v[0]===">"?(s=a!=null?a:Ht,f=-1):v[1]===void 0?f=-2:(f=s.lastIndex-v[2].length,u=v[1],s=v[3]===void 0?We:v[3]==='"'?dr:lr):s===dr||s===lr?s=We:s===sr||s===nr?s=Ht:(s=We,a=void 0);const w=s===We&&r[d+1].startsWith("/>")?" ":"";o+=s===Ht?c+as:f>=0?(i.push(u),c.slice(0,f)+"$lit$"+c.slice(f)+ze+w):c+ze+(f===-2?(i.push(void 0),d):w)}const l=o+(r[t]||"<?>")+(e===2?"</svg>":"");if(!Array.isArray(r)||!r.hasOwnProperty("raw"))throw Error("invalid template strings array");return[or!==void 0?or.createHTML(l):l,i]};class Zt{constructor({strings:e,_$litType$:t},i){let a;this.parts=[];let o=0,s=0;const l=e.length-1,d=this.parts,[c,u]=Wr(e,t);if(this.el=Zt.createElement(c,i),bt.currentNode=this.el.content,t===2){const v=this.el.content,f=v.firstChild;f.remove(),v.append(...f.childNodes)}for(;(a=bt.nextNode())!==null&&d.length<l;){if(a.nodeType===1){if(a.hasAttributes()){const v=[];for(const f of a.getAttributeNames())if(f.endsWith("$lit$")||f.startsWith(ze)){const b=u[s++];if(v.push(f),b!==void 0){const w=a.getAttribute(b.toLowerCase()+"$lit$").split(ze),k=/([.?@])?(.*)/.exec(b);d.push({type:1,index:o,name:k[2],strings:w,ctor:k[1]==="."?Qr:k[1]==="?"?Yr:k[1]==="@"?Kr:ei})}else d.push({type:6,index:o})}for(const f of v)a.removeAttribute(f)}if(Vr.test(a.tagName)){const v=a.textContent.split(ze),f=v.length-1;if(f>0){a.textContent=wt?wt.emptyScript:"";for(let b=0;b<f;b++)a.append(v[b],Kt()),bt.nextNode(),d.push({type:2,index:++o});a.append(v[f],Kt())}}}else if(a.nodeType===8)if(a.data===ka)d.push({type:2,index:o});else{let v=-1;for(;(v=a.data.indexOf(ze,v+1))!==-1;)d.push({type:7,index:o}),v+=ze.length-1}o++}}static createElement(e,t){const i=xt.createElement("template");return i.innerHTML=e,i}}function et(r,e,t=r,i){var a,o,s,l;if(e===ue)return e;let d=i!==void 0?(a=t._$Cl)===null||a===void 0?void 0:a[i]:t._$Cu;const c=qt(e)?void 0:e._$litDirective$;return(d==null?void 0:d.constructor)!==c&&((o=d==null?void 0:d._$AO)===null||o===void 0||o.call(d,!1),c===void 0?d=void 0:(d=new c(r),d._$AT(r,t,i)),i!==void 0?((s=(l=t)._$Cl)!==null&&s!==void 0?s:l._$Cl=[])[i]=d:t._$Cu=d),d!==void 0&&(e=et(r,d._$AS(r,e.values),d,i)),e}class Gr{constructor(e,t){this.v=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}p(e){var t;const{el:{content:i},parts:a}=this._$AD,o=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:xt).importNode(i,!0);bt.currentNode=o;let s=bt.nextNode(),l=0,d=0,c=a[0];for(;c!==void 0;){if(l===c.index){let u;c.type===2?u=new Dt(s,s.nextSibling,this,e):c.type===1?u=new c.ctor(s,c.name,c.strings,this,e):c.type===6&&(u=new qr(s,this,e)),this.v.push(u),c=a[++d]}l!==(c==null?void 0:c.index)&&(s=bt.nextNode(),l++)}return o}m(e){let t=0;for(const i of this.v)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class Dt{constructor(e,t,i,a){var o;this.type=2,this._$AH=$,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=a,this._$Cg=(o=a==null?void 0:a.isConnected)===null||o===void 0||o}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cg}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&e.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=et(this,e,t),qt(e)?e===$||e==null||e===""?(this._$AH!==$&&this._$AR(),this._$AH=$):e!==this._$AH&&e!==ue&&this.$(e):e._$litType$!==void 0?this.T(e):e.nodeType!==void 0?this.k(e):Ur(e)?this.S(e):this.$(e)}M(e,t=this._$AB){return this._$AA.parentNode.insertBefore(e,t)}k(e){this._$AH!==e&&(this._$AR(),this._$AH=this.M(e))}$(e){this._$AH!==$&&qt(this._$AH)?this._$AA.nextSibling.data=e:this.k(xt.createTextNode(e)),this._$AH=e}T(e){var t;const{values:i,_$litType$:a}=e,o=typeof a=="number"?this._$AC(e):(a.el===void 0&&(a.el=Zt.createElement(a.h,this.options)),a);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===o)this._$AH.m(i);else{const s=new Gr(o,this),l=s.p(this.options);s.m(i),this.k(l),this._$AH=s}}_$AC(e){let t=cr.get(e.strings);return t===void 0&&cr.set(e.strings,t=new Zt(e)),t}S(e){Hr(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,a=0;for(const o of e)a===t.length?t.push(i=new Dt(this.M(Kt()),this.M(Kt()),this,this.options)):i=t[a],i._$AI(o),a++;a<t.length&&(this._$AR(i&&i._$AB.nextSibling,a),t.length=a)}_$AR(e=this._$AA.nextSibling,t){var i;for((i=this._$AP)===null||i===void 0||i.call(this,!1,!0,t);e&&e!==this._$AB;){const a=e.nextSibling;e.remove(),e=a}}setConnected(e){var t;this._$AM===void 0&&(this._$Cg=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}}class ei{constructor(e,t,i,a,o){this.type=1,this._$AH=$,this._$AN=void 0,this.element=e,this.name=t,this._$AM=a,this.options=o,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=$}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,i,a){const o=this.strings;let s=!1;if(o===void 0)e=et(this,e,t,0),s=!qt(e)||e!==this._$AH&&e!==ue,s&&(this._$AH=e);else{const l=e;let d,c;for(e=o[0],d=0;d<o.length-1;d++)c=et(this,l[i+d],t,d),c===ue&&(c=this._$AH[d]),s||(s=!qt(c)||c!==this._$AH[d]),c===$?e=$:e!==$&&(e+=(c!=null?c:"")+o[d+1]),this._$AH[d]=c}s&&!a&&this.C(e)}C(e){e===$?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e!=null?e:"")}}class Qr extends ei{constructor(){super(...arguments),this.type=3}C(e){this.element[this.name]=e===$?void 0:e}}const rs=wt?wt.emptyScript:"";class Yr extends ei{constructor(){super(...arguments),this.type=4}C(e){e&&e!==$?this.element.setAttribute(this.name,rs):this.element.removeAttribute(this.name)}}class Kr extends ei{constructor(e,t,i,a,o){super(e,t,i,a,o),this.type=5}_$AI(e,t=this){var i;if((e=(i=et(this,e,t,0))!==null&&i!==void 0?i:$)===ue)return;const a=this._$AH,o=e===$&&a!==$||e.capture!==a.capture||e.once!==a.once||e.passive!==a.passive,s=e!==$&&(a===$||o);o&&this.element.removeEventListener(this.name,this,a),s&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,i;typeof this._$AH=="function"?this._$AH.call((i=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&i!==void 0?i:this.element,e):this._$AH.handleEvent(e)}}class qr{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){et(this,e)}}const os={L:"$lit$",P:ze,V:ka,I:1,N:Wr,R:Gr,j:Ur,D:et,H:Dt,F:ei,O:Yr,W:Kr,B:Qr,Z:qr},hr=window.litHtmlPolyfillSupport;hr==null||hr(Zt,Dt),((Ki=globalThis.litHtmlVersions)!==null&&Ki!==void 0?Ki:globalThis.litHtmlVersions=[]).push("2.2.4");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ee={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},za=r=>(...e)=>({_$litDirective$:r,values:e});class Ta{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}/**
 * @license
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const kr=za(class extends Ta{constructor(r){if(super(r),r.type!==Ee.PROPERTY&&r.type!==Ee.ATTRIBUTE&&r.type!==Ee.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!hs(r))throw Error("`live` bindings can only contain a single expression")}render(r){return r}update(r,[e]){if(e===ue||e===$)return e;const t=r.element,i=r.name;if(r.type===Ee.PROPERTY){if(e===t[i])return ue}else if(r.type===Ee.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(i))return ue}else if(r.type===Ee.ATTRIBUTE&&t.getAttribute(i)===e+"")return ue;return Xr(r),e}});var oo=60,so=oo*60,no=so*24,Sn=no*7,Ct=1e3,oa=oo*Ct,zr=so*Ct,$n=no*Ct,Cn=Sn*Ct,Ma="millisecond",vt="second",ft="minute",gt="hour",Ae="day",vi="week",fe="month",lo="quarter",Le="year",yt="date",_n="YYYY-MM-DDTHH:mm:ssZ",Tr="Invalid Date",kn=/^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/,zn=/\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g,Tn={name:"en",weekdays:"Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),months:"January_February_March_April_May_June_July_August_September_October_November_December".split("_")},ba=function(e,t,i){var a=String(e);return!a||a.length>=t?e:""+Array(t+1-a.length).join(i)+e},Mn=function(e){var t=-e.utcOffset(),i=Math.abs(t),a=Math.floor(i/60),o=i%60;return(t<=0?"+":"-")+ba(a,2,"0")+":"+ba(o,2,"0")},Dn=function r(e,t){if(e.date()<t.date())return-r(t,e);var i=(t.year()-e.year())*12+(t.month()-e.month()),a=e.clone().add(i,fe),o=t-a<0,s=e.clone().add(i+(o?-1:1),fe);return+(-(i+(t-a)/(o?a-s:s-a))||0)},En=function(e){return e<0?Math.ceil(e)||0:Math.floor(e)},An=function(e){var t={M:fe,y:Le,w:vi,d:Ae,D:yt,h:gt,m:ft,s:vt,ms:Ma,Q:lo};return t[e]||String(e||"").toLowerCase().replace(/s$/,"")},Ln=function(e){return e===void 0},On={s:ba,z:Mn,m:Dn,a:En,p:An,u:Ln},Qt="en",Xe={};Xe[Qt]=Tn;var Da=function(e){return e instanceof Li},zi=function r(e,t,i){var a;if(!e)return Qt;if(typeof e=="string"){var o=e.toLowerCase();Xe[o]&&(a=o),t&&(Xe[o]=t,a=o);var s=e.split("-");if(!a&&s.length>1)return r(s[0])}else{var l=e.name;Xe[l]=e,a=l}return!i&&a&&(Qt=a),a||!i&&Qt},Y=function(e,t){if(Da(e))return e.clone();var i=typeof t=="object"?t:{};return i.date=e,i.args=arguments,new Li(i)},Fn=function(e,t){return Y(e,{locale:t.$L,utc:t.$u,x:t.$x,$offset:t.$offset})},H=On;H.l=zi;H.i=Da;H.w=Fn;var In=function(e){var t=e.date,i=e.utc;if(t===null)return new Date(NaN);if(H.u(t))return new Date;if(t instanceof Date)return new Date(t);if(typeof t=="string"&&!/Z$/i.test(t)){var a=t.match(kn);if(a){var o=a[2]-1||0,s=(a[7]||"0").substring(0,3);return i?new Date(Date.UTC(a[1],o,a[3]||1,a[4]||0,a[5]||0,a[6]||0,s)):new Date(a[1],o,a[3]||1,a[4]||0,a[5]||0,a[6]||0,s)}}return new Date(t)},Li=function(){function r(t){this.$L=zi(t.locale,null,!0),this.parse(t)}var e=r.prototype;return e.parse=function(i){this.$d=In(i),this.$x=i.x||{},this.init()},e.init=function(){var i=this.$d;this.$y=i.getFullYear(),this.$M=i.getMonth(),this.$D=i.getDate(),this.$W=i.getDay(),this.$H=i.getHours(),this.$m=i.getMinutes(),this.$s=i.getSeconds(),this.$ms=i.getMilliseconds()},e.$utils=function(){return H},e.isValid=function(){return this.$d.toString()!==Tr},e.isSame=function(i,a){var o=Y(i);return this.startOf(a)<=o&&o<=this.endOf(a)},e.isAfter=function(i,a){return Y(i)<this.startOf(a)},e.isBefore=function(i,a){return this.endOf(a)<Y(i)},e.$g=function(i,a,o){return H.u(i)?this[a]:this.set(o,i)},e.unix=function(){return Math.floor(this.valueOf()/1e3)},e.valueOf=function(){return this.$d.getTime()},e.startOf=function(i,a){var o=this,s=H.u(a)?!0:a,l=H.p(i),d=function(D,L){var I=H.w(o.$u?Date.UTC(o.$y,L,D):new Date(o.$y,L,D),o);return s?I:I.endOf(Ae)},c=function(D,L){var I=[0,0,0,0],N=[23,59,59,999];return H.w(o.toDate()[D].apply(o.toDate("s"),(s?I:N).slice(L)),o)},u=this.$W,v=this.$M,f=this.$D,b="set"+(this.$u?"UTC":"");switch(l){case Le:return s?d(1,0):d(31,11);case fe:return s?d(1,v):d(0,v+1);case vi:{var w=this.$locale().weekStart||0,k=(u<w?u+7:u)-w;return d(s?f-k:f+(6-k),v)}case Ae:case yt:return c(b+"Hours",0);case gt:return c(b+"Minutes",1);case ft:return c(b+"Seconds",2);case vt:return c(b+"Milliseconds",3);default:return this.clone()}},e.endOf=function(i){return this.startOf(i,!1)},e.$set=function(i,a){var o,s=H.p(i),l="set"+(this.$u?"UTC":""),d=(o={},o[Ae]=l+"Date",o[yt]=l+"Date",o[fe]=l+"Month",o[Le]=l+"FullYear",o[gt]=l+"Hours",o[ft]=l+"Minutes",o[vt]=l+"Seconds",o[Ma]=l+"Milliseconds",o)[s],c=s===Ae?this.$D+(a-this.$W):a;if(s===fe||s===Le){var u=this.clone().set(yt,1);u.$d[d](c),u.init(),this.$d=u.set(yt,Math.min(this.$D,u.daysInMonth())).$d}else d&&this.$d[d](c);return this.init(),this},e.set=function(i,a){return this.clone().$set(i,a)},e.get=function(i){return this[H.p(i)]()},e.add=function(i,a){var o=this,s;i=Number(i);var l=H.p(a),d=function(f){var b=Y(o);return H.w(b.date(b.date()+Math.round(f*i)),o)};if(l===fe)return this.set(fe,this.$M+i);if(l===Le)return this.set(Le,this.$y+i);if(l===Ae)return d(1);if(l===vi)return d(7);var c=(s={},s[ft]=oa,s[gt]=zr,s[vt]=Ct,s)[l]||1,u=this.$d.getTime()+i*c;return H.w(u,this)},e.subtract=function(i,a){return this.add(i*-1,a)},e.format=function(i){var a=this,o=this.$locale();if(!this.isValid())return o.invalidDate||Tr;var s=i||_n,l=H.z(this),d=this.$H,c=this.$m,u=this.$M,v=o.weekdays,f=o.months,b=o.meridiem,w=function(I,N,j,J){return I&&(I[N]||I(a,s))||j[N].slice(0,J)},k=function(I){return H.s(d%12||12,I,"0")},T=b||function(L,I,N){var j=L<12?"AM":"PM";return N?j.toLowerCase():j},D={YY:String(this.$y).slice(-2),YYYY:this.$y,M:u+1,MM:H.s(u+1,2,"0"),MMM:w(o.monthsShort,u,f,3),MMMM:w(f,u),D:this.$D,DD:H.s(this.$D,2,"0"),d:String(this.$W),dd:w(o.weekdaysMin,this.$W,v,2),ddd:w(o.weekdaysShort,this.$W,v,3),dddd:v[this.$W],H:String(d),HH:H.s(d,2,"0"),h:k(1),hh:k(2),a:T(d,c,!0),A:T(d,c,!1),m:String(c),mm:H.s(c,2,"0"),s:String(this.$s),ss:H.s(this.$s,2,"0"),SSS:H.s(this.$ms,3,"0"),Z:l};return s.replace(zn,function(L,I){return I||D[L]||l.replace(":","")})},e.utcOffset=function(){return-Math.round(this.$d.getTimezoneOffset()/15)*15},e.diff=function(i,a,o){var s,l=H.p(a),d=Y(i),c=(d.utcOffset()-this.utcOffset())*oa,u=this-d,v=H.m(this,d);return v=(s={},s[Le]=v/12,s[fe]=v,s[lo]=v/3,s[vi]=(u-c)/Cn,s[Ae]=(u-c)/$n,s[gt]=u/zr,s[ft]=u/oa,s[vt]=u/Ct,s)[l]||u,o?v:H.a(v)},e.daysInMonth=function(){return this.endOf(fe).$D},e.$locale=function(){return Xe[this.$L]},e.locale=function(i,a){if(!i)return this.$L;var o=this.clone(),s=zi(i,a,!0);return s&&(o.$L=s),o},e.clone=function(){return H.w(this.$d,this)},e.toDate=function(){return new Date(this.valueOf())},e.toJSON=function(){return this.isValid()?this.toISOString():null},e.toISOString=function(){return this.$d.toISOString()},e.toString=function(){return this.$d.toUTCString()},r}(),co=Li.prototype;Y.prototype=co;[["$ms",Ma],["$s",vt],["$m",ft],["$H",gt],["$W",Ae],["$M",fe],["$y",Le],["$D",yt]].forEach(function(r){co[r[1]]=function(e){return this.$g(e,r[0],r[1])}});Y.extend=function(r,e){return r.$i||(r(e,Li,Y),r.$i=!0),Y};Y.locale=zi;Y.isDayjs=Da;Y.unix=function(r){return Y(r*1e3)};Y.en=Xe[Qt];Y.Ls=Xe;Y.p={};var Pn=function(e){return e.replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g,function(t,i,a){return i||a.slice(1)})},Nn={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"},Rn=function(e,t){return e.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g,function(i,a,o){var s=o&&o.toUpperCase();return a||t[o]||Nn[o]||Pn(t[s])})},Bn=/(\[[^[]*\])|([-:/.()\s]+)|(A|a|YYYY|YY?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g,Hn=/\d/,di=/\d\d/,Un=/\d{3}/,Vn=/\d{4}/,we=/\d\d?/,jn=/[+-]?\d+/,Wn=/[+-]\d\d:?(\d\d)?|Z/,jt=/\d*[^\s\d-_:/()]+/,Fe={},ho=function(e){return e=+e,e+(e>68?1900:2e3)};function Gn(r){if(!r||r==="Z")return 0;var e=r.match(/([+-]|\d\d)/g),t=+(e[1]*60)+(+e[2]||0);return t===0?0:e[0]==="+"?-t:t}var le=function(e){return function(t){this[e]=+t}},Mr=[Wn,function(r){var e=this.zone||(this.zone={});e.offset=Gn(r)}],sa=function(e){var t=Fe[e];return t&&(t.indexOf?t:t.s.concat(t.f))},Dr=function(e,t){var i,a=Fe,o=a.meridiem;if(!o)i=e===(t?"pm":"PM");else for(var s=1;s<=24;s+=1)if(e.indexOf(o(s,0,t))>-1){i=s>12;break}return i},Qn={A:[jt,function(r){this.afternoon=Dr(r,!1)}],a:[jt,function(r){this.afternoon=Dr(r,!0)}],S:[Hn,function(r){this.milliseconds=+r*100}],SS:[di,function(r){this.milliseconds=+r*10}],SSS:[Un,function(r){this.milliseconds=+r}],s:[we,le("seconds")],ss:[we,le("seconds")],m:[we,le("minutes")],mm:[we,le("minutes")],H:[we,le("hours")],h:[we,le("hours")],HH:[we,le("hours")],hh:[we,le("hours")],D:[we,le("day")],DD:[di,le("day")],Do:[jt,function(r){var e=Fe,t=e.ordinal,i=r.match(/\d+/);if(this.day=i[0],!!t)for(var a=1;a<=31;a+=1)t(a).replace(/\[|\]/g,"")===r&&(this.day=a)}],M:[we,le("month")],MM:[di,le("month")],MMM:[jt,function(r){var e=sa("months"),t=sa("monthsShort"),i=(t||e.map(function(a){return a.slice(0,3)})).indexOf(r)+1;if(i<1)throw new Error;this.month=i%12||i}],MMMM:[jt,function(r){var e=sa("months"),t=e.indexOf(r)+1;if(t<1)throw new Error;this.month=t%12||t}],Y:[jn,le("year")],YY:[di,function(r){this.year=ho(r)}],YYYY:[Vn,le("year")],Z:Mr,ZZ:Mr};function Yn(r){var e=r.afternoon;if(e!==void 0){var t=r.hours;e?t<12&&(r.hours+=12):t===12&&(r.hours=0),delete r.afternoon}}function Kn(r){r=Rn(r,Fe&&Fe.formats);for(var e=r.match(Bn),t=e.length,i=0;i<t;i+=1){var a=e[i],o=Qn[a],s=o&&o[0],l=o&&o[1];l?e[i]={regex:s,parser:l}:e[i]=a.replace(/^\[|\]$/g,"")}return function(d){for(var c={},u=0,v=0;u<t;u+=1){var f=e[u];if(typeof f=="string")v+=f.length;else{var b=f.regex,w=f.parser,k=d.slice(v),T=b.exec(k),D=T[0];w.call(c,D),d=d.replace(D,"")}}return Yn(c),c}}var qn=function(e,t,i){try{if(["x","X"].indexOf(t)>-1)return new Date((t==="X"?1e3:1)*e);var a=Kn(t),o=a(e),s=o.year,l=o.month,d=o.day,c=o.hours,u=o.minutes,v=o.seconds,f=o.milliseconds,b=o.zone,w=new Date,k=d||(!s&&!l?w.getDate():1),T=s||w.getFullYear(),D=0;s&&!l||(D=l>0?l-1:w.getMonth());var L=c||0,I=u||0,N=v||0,j=f||0;return b?new Date(Date.UTC(T,D,k,L,I,N,j+b.offset*60*1e3)):i?new Date(Date.UTC(T,D,k,L,I,N,j)):new Date(T,D,k,L,I,N,j)}catch{return new Date("")}},Zn=function(r,e,t){t.p.customParseFormat=!0,r&&r.parseTwoDigitYear&&(ho=r.parseTwoDigitYear);var i=e.prototype,a=i.parse;i.parse=function(o){var s=o.date,l=o.utc,d=o.args;this.$u=l;var c=d[1];if(typeof c=="string"){var u=d[2]===!0,v=d[3]===!0,f=u||v,b=d[2];v&&(b=d[2]),Fe=this.$locale(),!u&&b&&(Fe=t.Ls[b]),this.$d=qn(s,c,l),this.init(),b&&b!==!0&&(this.$L=this.locale(b).$L),f&&s!=this.format(c)&&(this.$d=new Date("")),Fe={}}else if(c instanceof Array)for(var w=c.length,k=1;k<=w;k+=1){d[1]=c[k-1];var T=t.apply(this,d);if(T.isValid()){this.$d=T.$d,this.$L=T.$L,this.init();break}k===w&&(this.$d=new Date(""))}else a.call(this,o)}};const Xn=Object.freeze({processing:"processing",complete:"complete"});class Jn extends O{static get properties(){return{mode:{type:String}}}constructor(){super(),this.mode=Xn.processing}render(){return m`
      <div class="${this.mode}">
        <svg
          viewBox="0 0 120 120"
      ...
      <div class="modal-wrapper">
        <div class="modal-container">
          <header style="background-color: ${this.config.headerColor}">
            ...
            ${this.config.showHeaderLogo?m`<div class="logo-icon">${bl}</div>`:$}
...
`;let kt=class extends O{constructor(){super(...arguments),this.step=2,this.currentPage=1,this.pages=[]}firstUpdated(){this.observePageCount()}updated(e){e.has("size")&&this.observePageCount(),e.has("currentPage")&&(this.observePageCount(),this.emitPageClick())}observePageCount(){this.pages=[];const e=7,t=this.size<=e;if(this.size<=5){this.pages=[...Array(this.size).keys()].map(o=>o+1);return}if(this.size===e){if(this.currentPage===2){this.pages=[1,2,3,4,0,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,4,5,this.size-1,this.size];return}}if(this.currentPage===1){this.pages=[1,2,3,0,this.size];return}if(this.currentPage===this.size){this.pages=[1,0,this.size-2,this.size-1,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,this.size-3,this.size-2,this.size-1,this.size];return}if(t&&this.currentPage>1&&this.currentPage<e){this.pages=[...Array(this.size).keys()].map(o=>o+1);return}let i=this.currentPage-this.step,a=this.currentPage+this.step;i<=0&&(a+=-i+1,i=1),a>=this.size&&(i=Math.max(i-(a-this.size),1),a=this.size),i===2&&(a-=1),a===this.size-1&&(i+=1),this.createFirstNode(i),this.createMiddelNode(i,a),this.createLastNode(a)}createFirstNode(e){var t,i;e>1&&((t=this.pages)===null||t===void 0||t.push(1)),e>2&&((i=this.pages)===null||i===void 0||i.push(0))}createMiddelNode(e,t){var i;for(let a=e;a<=t;a+=1)(i=this.pages)===null||i===void 0||i.push(a)}createLastNode(e){var t,i;e<this.size-1&&((t=this.pages)===null||t===void 0||t.push(0)),e<this.size&&((i=this.pages)===null||i===void 0||i.push(this.size))}get getEllipsisTemplate(){return m`<i class="ellipses">...</i>`}emitPageClick(){this.dispatchEvent(new CustomEvent("pageNumberClicked",{detail:{page:this.currentPage},bubbles:!0,composed:!0}))}onRewind(){this.currentPage-=1,this.currentPage<1&&(this.currentPage=1)}onForward(){this.currentPage+=1,this.currentPage>this.size&&(this.currentPage=this.size)}onChange(e){this.currentPage=e}getPageTemplate(e){return m`
    ...
    `}get getPagesTemplate(){var e;return!this.pages||!this.pages.length?$:m`
    ...
    `}};n([p({type:Number})],kt.prototype,"size",void 0);n([p({type:Number})],kt.prototype,"step",void 0);n([p({type:Number})],kt.prototype,"currentPage",void 0);n([z()],kt.prototype,"pages",void 0);kt=n([P("more-facets-pagination")],kt);var Cl=F`
...
`;let zt=class extends O{facetClicked(e,t,i){const a=e.target,{checked:o,name:s,value:l}=a;o?this.facetChecked(s,l,t,i):this.facetUnchecked(s,l)}facetChecked(e,t,i,a){const{selectedFacets:o}=this;let s;o?s=ce({},o):s=Ci,s[e][t]={state:a?"hidden":"selected",count:i},this.selectedFacets=s,this.dispatchSelectedFacetsChanged()}facetUnchecked(e,t){const{selectedFacets:i}=this;let a;i?a=ce({},i):a=Ci,delete a[e][t],this.selectedFacets=a,this.dispatchSelectedFacetsChanged()}dispatchSelectedFacetsChanged(){const e=new CustomEvent("selectedFacetsChanged",{detail:this.selectedFacets,bubbles:!0,composed:!0});this.dispatchEvent(e)}getFacetsTemplate(e){let t=e==null?void 0:e.buckets;return t=[...t.filter(i=>i.state==="selected").sort((i,a)=>i.count<a.count?1:-1),...t.filter(i=>i.state==="hidden").sort((i,a)=>i.count<a.count?1:-1),...t.filter(i=>i.state==="none")],m`
    ...
    `}get loaderTemplate(){return m`<div class="facets-loader">
      <ia-activity-indicator .mode=${"processing"}></ia-activity-indicator>
        ...
        </div> `:$}sortFacetAggregation(){this.sortedBy=this.sortedBy==="count"?"alpha":"count",this.dispatchEvent(new CustomEvent("sortedFacets",{detail:this.sortedBy}))}get getModalHeaderTemplate(){const e=this.sortedBy==="alpha"?"Sort by count":"Sort by alphabetically",t=this.sortedBy==="alpha"?"https://archive.org/images/filter-alpha.png":"https://archive.org/images/filter-count.png";return m`<span class="sr-only">More facets for:</span>
      <span class="title">
...
`;let Mi=class extends O{constructor(){super(...arguments),this.placeholderType=null}render(){return this.placeholderType?m`${this.placeholderTemplate}`:$}get placeholderTemplate(){return m`
      <div
        class="placeholder ${this.placeholderType} ${this.isMobileView?"mobile":"desktop"}"
      >
        ${El(this.placeholderType,[["empty-query",()=>this.emptyQueryTemplate],["null-result",()=>this.nullResultTemplate]])}
      </div>
