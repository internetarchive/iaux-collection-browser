...
`,Rn=g`var(--tileBackgroundColor, #ffffff)`,In=g`var(--tileCornerRadius, 4px)`,eo=g`
...
`;let pi=class extends O{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1,this.isCompactTile=!1}render(){return h`<div class="icon-overlay ${this.getClass}">
    ...
    `}};n([p({type:String})],et.prototype,"baseImageUrl",void 0);n([p({type:Boolean})],et.prototype,"isCompactTile",void 0);n([p({type:Boolean})],et.prototype,"isListTile",void 0);n([p({type:Boolean})],et.prototype,"loggedIn",void 0);n([p({type:Object})],et.prototype,"model",void 0);n([p({type:String})],et.prototype,"viewSize",void 0);et=n([L("image-block")],et);let jo=class extends he{constructor(){super(...arguments),this.showInfoButton=!1}render(){return h`
      <div class="container">
    ...
    >`}get getSizeTemplate(){var e,t;const i=(t=(e=this.model)===null||e===void 0?void 0:e.collectionSize)!==null&&t!==void 0?t:0;return i?h`<span id="item-size">${Fn(i,1)}</span>`:""}get infoButtonTemplate(){return this.showInfoButton?h`<button class="info-button" @click=${this.infoButtonPressed}>
      ...
      `]}};n([p({type:Boolean})],jo.prototype,"showInfoButton",void 0);jo=n([L("collection-tile")],jo);function vi(a,e="short",t="en-US"){if(!a)return"";const i={};switch(e){case"year-only":i.year="numeric";break;case"short":i.month="short",i.year="numeric";break;case"long":i.year="numeric",i.month="short",i.day="2-digit";break}return new Intl.DateTimeFormat(t,i).format(a)}function Nn(a){return new Date(a.getTime()-a.getTimezoneOffset()*1e3*60)}function ba(a){return a?Nn(a).toISOString().endsWith("-01-01T00:00:00.000Z"):!1}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;function rl(a,e){let t=1;return a>=1e9?t=1e9:a>=1e6?t=1e6:a>=1e3&&e==="short"&&(t=1e3),t}function sl(a=0,e){const t=a/e,i=t<10;let o=0;return i?o=Math.round((t+Number.EPSILON)*10)/10:o=Math.round(t),o}function nl(a,e,t,i){switch(e){case 1e9:return A(t==="short"?vt`${a}B`:vt`${a} billion`);case 1e6:return A(t==="short"?vt`${a}M`:vt`${a} million`);case 1e3:return A(t==="short"?vt`${a}K`:vt`${a} thousand`);default:return new Intl.NumberFormat(i).format(a)}}function si(a,e="long",t="short",i="en-US"){const o=a!=null?a:-1;if(o<0)return"";const r=rl(o,e),s=sl(o,r);return nl(s,r,t,i)}let tt=class extends O{render(){var e;const t=si(this.favCount,"short","short"),i=si(this.commentCount,"short","short"),o=this.mediatype==="account"?`${this.itemCount} uploads`:`${this.viewCount} ${(e=this.viewLabel)!==null&&e!==void 0?e:"all-time views"}`;return h`
    ...
    `}get isSortedByDate(){var e;return["date","reviewdate","addeddate","publicdate"].includes((e=this.sortParam)===null||e===void 0?void 0:e.field)}get hasSnippets(){var e,t;return!!(!((t=(e=this.model)===null||e===void 0?void 0:e.snippets)===null||t===void 0)&&t.length)}infoButtonPressed(e){e.preventDefault();const t=new CustomEvent("infoButtonPressed",{detail:{x:e.clientX,y:e.clientY}});this.dispatchEvent(t)}static get styles(){const e=g`var(--tileBorderColor, #dddddd)`;return[eo,g`
      ...
      `]}};n([p({type:Boolean})],Go.prototype,"showInfoButton",void 0);Go=n([L("item-tile")],Go);let qo=class extends he{constructor(){super(...arguments),this.showInfoButton=!1}render(){return h`
      <div class="container">
        ${this.infoButtonTemplate}
        <div class="tile-details">
          <div class="item-info">
    ...
    >
      ...
      `]}};n([p({type:Boolean})],qo.prototype,"showInfoButton",void 0);qo=n([L("account-tile")],qo);let Qo=class extends he{constructor(){super(...arguments),this.showInfoButton=!1}render(){return h`
      <div class="container">
        <div class="tile-details">
          <div class="item-info">
            ${this.getImageBlockTemplate} ${this.getTitleTemplate}
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Do;((Do=window.HTMLSlotElement)===null||Do===void 0?void 0:Do.prototype.assignedElements)!=null;var dd=Ss`<svg class="caret-up-svg" viewBox="0 0 8 4" xmlns="http://www.w3.org/2000/svg">
...
fill=""></path>
  ...
  `;ra=n([Es("ia-icon-label")],ra);let sa=class extends O{constructor(){super(...arguments),this.numResults=0}render(){return h`
...
`;let la=class extends O{constructor(){super(...arguments),this.config=new na}render(){return h`
