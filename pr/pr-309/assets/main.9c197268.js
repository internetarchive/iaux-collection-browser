 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*Bi(a,e){const t=typeof e=="function";if(a!==void 0){let i=-1;for(const o of a)i>-1&&(yield t?e(i):e),i++,yield o}}let qi=class extends R{constructor(){super(...arguments),this.snippets=[],this.viewSize="desktop"}render(){var e;return!((e=this.snippets)===null||e===void 0)&&e.length?c`
      <div class="container">
        <div class="snippet-view ${this.viewSize}">
    ...
    `}};l([h({type:Array})],qi.prototype,"snippets",void 0);l([h({type:String})],qi.prototype,"viewSize",void 0);qi=l([L("text-snippet-block")],qi);const Rn=v`
  .drop-shadow {
    overflow: hidden;
    height: 100%;
  }
...
`,qs={account:{color:"#000000",icon:Bn,text:"Account"},audio:{color:"#00adef",icon:On,text:"Audio"},collection:{color:"#4666ff",icon:js,text:"Collection"},data:{color:"#333333",icon:In,text:"Data"},etree:{color:"#00adef",icon:Un,text:"E-tree"},film:{color:"#bf1b2c",icon:Dr,text:"Film"},image:{color:"#aa99c9",icon:Nn,text:"Image"},movies:{color:"#f1644b",icon:Dr,text:"Movie"},radio:{color:"#8fdaef",icon:Hn,text:"Radio"},software:{color:"#9ecc4f",icon:Vn,text:"Software"},texts:{color:"#faab3c",icon:Wn,text:"Text"},tv:{color:"#f1644b",icon:jn,text:"TV"},video:{color:"#f1644b",icon:Qn,text:"Video"},web:{color:"#ffcd27",icon:Kn,text:"Web"},search:{color:"#000000",icon:Ks,text:"Search"}};let vi=class extends R{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var e,t;const i=["tvnews","tvarchive","television"],o=["radio","radioprogram"];return this.mediatype==="movies"&&((e=this.collections)===null||e===void 0?void 0:e.some(r=>i.indexOf(r)>=0))?"tv":this.mediatype==="audio"&&((t=this.collections)===null||t===void 0?void 0:t.some(r=>o.indexOf(r)>=0))?"radio":this.mediatype||""}render(){const e=qs[this.displayMediatype];return e?c`
      <div
        id="icon"
    ...
    `}};l([h({type:String})],vi.prototype,"mediatype",void 0);l([h({type:Array})],vi.prototype,"collections",void 0);l([h({type:Boolean})],vi.prototype,"showText",void 0);vi=l([L("mediatype-icon")],vi);const qn=U`
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path
...
`+$e),_t&&Di([rt,st,lt],Be=>{$e=oi($e,Be," ")}),B&&Ei?B.createHTML($e):$e},e.setConfig=function(){let z=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};wo(z),fo=!0},e.clearConfig=function(){kt=null,fo=!1},e.isValidAttribute=function(z,u,_){kt||wo({});const T=ue(z),j=ue(u);return nr(T,j,_)},e.addHook=function(z,u){typeof u=="function"&&(Se[z]=Se[z]||[],ii(Se[z],u))},e.removeHook=function(z){if(Se[z])return Fr(Se[z])},e.removeHooks=function(z){Se[z]&&(Se[z]=[])},e.removeAllHooks=function(){Se={}},e}var Ii=Js();let Gi=class extends ce{constructor(){super(...arguments),this.collectionLinks=[]}render(){return c`
    ...
    `}};l([h({type:Object})],Gi.prototype,"collectionTitles",void 0);l([A()],Gi.prototype,"collectionLinks",void 0);Gi=l([L("tile-list")],Gi);let Ve=class extends R{constructor(){super(...arguments),this.loggedIn=!1}render(){return c`
      <div id="container">
        ${this.headerTemplate}
 ...
 */const ps=$i(class extends Ci{constructor(a){if(super(a),a.type!==Ie.PROPERTY&&a.type!==Ie.ATTRIBUTE&&a.type!==Ie.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Bs(a))throw Error("`live` bindings can only contain a single expression")}render(a){return a}update(a,[e]){if(e===Ce||e===b)return e;const t=a.element,i=a.name;if(a.type===Ie.PROPERTY){if(e===t[i])return Ce}else if(a.type===Ie.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(i))return Ce}else if(a.type===Ie.ATTRIBUTE&&t.getAttribute(i)===e+"")return Ce;return Os(a),e}}),cc=Object.freeze({processing:"processing",complete:"complete"});class hc extends R{static get properties(){return{mode:{type:String}}}constructor(){super(),this.mode=cc.processing}render(){return c`
    ...
    `}get selectedRangeTemplate(){return U`
      ...
      />`}get histogramTemplate(){const e=this._histWidth/this._numBins,t=e-1;let i=this.sliderWidth;return this._histData.map(o=>{const r=U`
        ...
        />`;return i+=e,r})}formatDate(e){if(Number.isNaN(e))return"";const t=qo(e);return t.year()<1e3?String(t.year()):t.format(this.dateFormat)}get minInputTemplate(){return c`
      <input
        id="date-min"
