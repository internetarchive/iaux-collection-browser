...
`;var aa;(function(r){r[r.bytes=0]="bytes",r[r.kilobytes=1]="kilobytes",r[r.megabytes=2]="megabytes",r[r.gigabytes=3]="gigabytes",r[r.terabytes=4]="terabytes",r[r.petabytes=5]="petabytes",r[r.exabytes=6]="exabytes",r[r.zettabytes=7]="zettabytes",r[r.yottabytes=8]="yottabytes"})(aa||(aa={}));function Xo(r,e,t=" "){let i=r;if(i===void 0)return w;let a=0;for(;i>1024;)i/=1024,a+=1;const o=10**e;i=Math.round(i*o)/o;let n=aa[a];return n=i===1?n.slice(0,-1):n,`${i.toLocaleString()+t+n}`}const Zo=f`var(--tileBackgroundColor, #ffffff)`,Jo=f`var(--tileCornerRadius, 4px)`,ya=f`
  .container {
    background-color: ${Zo};
    border: 1px #2c2c2c;
    border-radius: ${Jo};
...
`;let Qt=class extends A{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1,this.isCompactTile=!1}render(){return p`<div class="icon-overlay ${this.getClass}">
    ...
    >`}get getSizeTemplate(){var e,t;const i=(t=(e=this.model)===null||e===void 0?void 0:e.collectionSize)!==null&&t!==void 0?t:0;return i?p`<span id="item-size">${Xo(i,1)}</span>`:""}static get styles(){const e=f`var(--tileBorderColor, #555555)`,t=f`var(--tileBackgroundColor, #666666)`,i=f`#fff`;return[ya,f`
        .container {
          background-color: ${t};
          border: 1px solid ${e};
        }
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ys=(r,...e)=>({strTag:!0,strings:r,values:e}),pt=ys,bs=r=>typeof r!="string"&&"strTag"in r,ws=(r,e,t)=>{let i=r[0];for(let a=1;a<r.length;a++)i+=e[t?t[a-1]:a-1],i+=r[a];return i};/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */let ut=xs;function Cs(r,e){let t=1;return r>=1e9?t=1e9:r>=1e6?t=1e6:r>=1e3&&e==="short"&&(t=1e3),t}function $s(r=0,e){const t=r/e,i=t<10;let a=0;return i?a=Math.round((t+Number.EPSILON)*10)/10:a=Math.round(t),a}function ks(r,e,t,i){switch(e){case 1e9:return ut(t==="short"?pt`${r}B`:pt`${r} billion`);case 1e6:return ut(t==="short"?pt`${r}M`:pt`${r} million`);case 1e3:return ut(t==="short"?pt`${r}K`:pt`${r} thousand`);default:return new Intl.NumberFormat(i).format(r)}}function Ht(r,e="long",t="short",i="en-US"){const a=r!=null?r:-1;if(a<0)return"";const o=Cs(a,e),n=$s(a,o);return ks(n,o,t,i)}let et=class extends A{render(){const e=Ht(this.favCount,"short","short"),t=Ht(this.commentCount,"short","short"),i=this.mediatype==="account"?`${this.itemCount} uploads`:`${this.viewCount} all-time views`;return p`
    ...
    `}get doesSortedByDate(){var e;return["date","reviewdate","addeddate","publicdate"].includes((e=this.sortParam)===null||e===void 0?void 0:e.field)}get hasSnippets(){var e,t;return!!(!((t=(e=this.model)===null||e===void 0?void 0:e.snippets)===null||t===void 0)&&t.length)}static get styles(){const e=f`var(--tileBorderColor, #dddddd)`;return[ya,f`
        .container {
          border: 1px solid ${e};
        }
    ...
    >
    </tile-stats>`}static get styles(){const e=f`var(--tileBorderColor, #dddddd)`;return[ya,f`
        .container {
          border: 1px solid ${e};
        }
...
`+oe),xe&&(oe=Ae(oe,Oe," "),oe=Ae(oe,Be," ")),K&&Zt?K.createHTML(oe):oe},e.setConfig=function(S){Li(S),Ue=!0},e.clearConfig=function(){ct=null,Ue=!1},e.isValidAttribute=function(S,h,b){ct||Li({});var _=We(S),O=We(h);return Fa(_,O,b)},e.addHook=function(S,h){typeof h=="function"&&(ce[S]=ce[S]||[],Rt(ce[S],h))},e.removeHook=function(S){if(ce[S])return rr(ce[S])},e.removeHooks=function(S){ce[S]&&(ce[S]=[])},e.removeAllHooks=function(){ce={}},e}var Ut=Gr(),L;(function(r){r.relevance="relevance",r.alltimeview="alltimeview",r.weeklyview="weeklyview",r.title="title",r.datearchived="datearchived",r.date="date",r.datereviewed="datereviewed",r.dateadded="dateadded",r.creator="creator"})(L||(L={}));const Ke={relevance:"Relevance",alltimeview:"All-time Views",weeklyview:"Weekly Views",title:"Title",datearchived:"Date Archived",date:"Date Published",datereviewed:"Date Reviewed",dateadded:"Date Added",creator:"Creator"},tn={relevance:null,alltimeview:"downloads",weeklyview:"week",title:"titleSorter",datearchived:"publicdate",date:"date",datereviewed:"reviewdate",dateadded:"addeddate",creator:"creatorSorter"},dr={week:L.weeklyview,downloads:L.alltimeview,titleSorter:L.title,date:L.date,publicdate:L.datearchived,reviewdate:L.datereviewed,addeddate:L.dateadded,creatorSorter:L.creator},an={title:"firstTitle",creator:"firstCreator"},bi={subject:{},lending:{},mediatype:{},language:{},creator:{},collection:{},year:{}},rn=["mediatype","lending","year","subject","collection","creator","language"],wi={subject:"Subject",lending:"Availability",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"},on={is_lendable:!0,is_borrowable:!1,available_to_borrow:!0,is_browsable:!1,available_to_browse:!1,is_readable:!0,available_to_waitlist:!1},cr={is_lendable:"Lending Library",available_to_borrow:"Borrow 14 Days",is_readable:"Always Available"},ba={deemphasize:!0,community:!0,stream_only:!0,samples_only:!0,test_collection:!0,printdisabled:!0,"openlibrary-ol":!0,nationalemergencylibrary:!0,china:!0,americana:!0,toronto:!0};function Qr(r){switch(r){case"publicdate":return"Archived";case"reviewdate":return"Reviewed";case"addeddate":return"Added";default:return"Published"}}function qr(r){return r?`Archivist since ${r.getFullYear()}`:""}let ve=class extends A{constructor(){super(...arguments),this.sortParam=null,this.collectionLinks=[],this.loggedIn=!1}render(){return p`
    ...
    `}get titleTemplate(){var e;return!((e=this.model)===null||e===void 0)&&e.title?p` ${this.detailsLink(this.model.identifier,this.model.title)} `:w}get itemLineTemplate(){const e=this.sourceTemplate,t=this.volumeTemplate,i=this.issueTemplate;return!e&&!t&&!i?w:p` <div id="item-line">${e} ${t} ${i}</div> `}get sourceTemplate(){var e;return!((e=this.model)===null||e===void 0)&&e.source?p`
    ...
    >`}detailsLink(e,t){const i=t!=null?t:e;return p`<a
      ...
      >${Ut.sanitize(i)}</a
    >`}get mediatypeURL(){var e;if(this.baseNavigationUrl===void 0||!(!((e=this.model)===null||e===void 0)&&e.mediatype))return w;switch(this.model.mediatype){case"collection":return`${this.baseNavigationUrl}/search?query=mediatype:collection&sort=-downloads`;case"account":return w;default:return`${this.baseNavigationUrl}/details/${encodeURI(this.model.mediatype)}`}}updated(e){e.has("model")&&this.fetchCollectionNames()}async fetchCollectionNames(){var e,t;if(!(!((e=this.model)===null||e===void 0)&&e.collections)||this.model.collections.length===0||!this.collectionNameCache)return;this.collectionLinks=[];const i=[],a=[];for(const o of this.model.collections)!ba[o]&&!o.startsWith("fav-")&&a.push((t=this.collectionNameCache)===null||t===void 0?void 0:t.collectionNameFor(o).then(n=>{i.push(this.detailsLink(o,n!=null?n:o))}));await Promise.all(a),this.collectionLinks=i}get date(){var e,t,i,a,o;switch((e=this.sortParam)===null||e===void 0?void 0:e.field){case"date":return(t=this.model)===null||t===void 0?void 0:t.datePublished;case"reviewdate":return(i=this.model)===null||i===void 0?void 0:i.dateReviewed;case"addeddate":return(a=this.model)===null||a===void 0?void 0:a.dateAdded;default:return(o=this.model)===null||o===void 0?void 0:o.dateArchived}}get classSize(){return this.mobileBreakpoint&&this.currentWidth&&this.currentWidth<this.mobileBreakpoint?"mobile":"desktop"}get formatSize(){return this.mobileBreakpoint&&this.currentWidth&&this.currentWidth<this.mobileBreakpoint?"short":"long"}static get styles(){return f`
      html {
        font-size: unset;
      }
...
`;let ca=class extends A{constructor(){super(...arguments),this.config=new Kr}render(){return p`
    ...
    `}static get styles(){const e=f`var(--modalLogoSize, 6.5rem)`,t=f`var(--processingImageSize, 7.5rem)`,i=f`var(--modalCornerRadius, 1rem)`,a=f`var(--modalBorder, 2px solid black)`,o=f`var(--modalBottomMargin, 2.5rem)`,n=f`var(--modalTopMargin, 5rem)`,l=f`var(--modalHeaderBottomPadding, 0.5em)`,d=f`var(--modalBottomPadding, 2rem)`,u=f`var(--modalScrollOffset, 5px)`,m=f`var(--modalTitleFontSize, 1.8rem)`,v=f`var(--modalSubtitleFontSize, 1.4rem)`,y=f`var(--modalHeadlineFontSize, 1.6rem)`,x=f`var(--modalMessageFontSize, 1.4rem)`,$=f`var(--modalTitleLineHeight, normal)`,M=f`var(--modalSubtitleLineHeight, normal)`,I=f`var(--modalHeadlineLineHeight, normal)`,N=f`var(--modalMessageLineHeight, normal)`;return f`
      .processing-logo {
        margin: auto;
        width: ${t};
        height: ${t};
...
`;let $t=class extends A{facetClicked(e,t,i){const a=e.target,{checked:o,name:n,value:l}=a;o?this.facetChecked(n,l,t,i):this.facetUnchecked(n,l)}facetChecked(e,t,i,a){const{selectedFacets:o}=this;let n;o?n=se({},o):n=bi,n[e][t]={state:a?"hidden":"selected",count:i},this.selectedFacets=n,this.dispatchSelectedFacetsChanged()}facetUnchecked(e,t){const{selectedFacets:i}=this;let a;i?a=se({},i):a=bi,delete a[e][t],this.selectedFacets=a,this.dispatchSelectedFacetsChanged()}dispatchSelectedFacetsChanged(){const e=new CustomEvent("selectedFacetsChanged",{detail:this.selectedFacets,bubbles:!0,composed:!0});this.dispatchEvent(e)}getFacetsTemplate(e){let t=e==null?void 0:e.buckets;return t=[...t.filter(i=>i.state==="selected").sort((i,a)=>i.count<a.count?1:-1),...t.filter(i=>i.state==="hidden").sort((i,a)=>i.count<a.count?1:-1),...t.filter(i=>i.state==="none")],p`
      <div class="facets-on-${this.renderOn}">
        ${Hr(t,i=>`${e.key}:${i.key}`,i=>{var a,o;const n=`${e.key}:${i.key}-show-only`,l=`${e.key}:${i.key}-negative`,d=e.key!=="collection"?p`${(a=i.displayText)!==null&&a!==void 0?a:i.key}`:p`<a href="/details/${i.key}">
                    <async-collection-name
                      ...
                      placeholder="-"
                    ></async-collection-name>
                  </a> `,u=i.state==="hidden",m=i.state==="selected",v=`${e.key}: ${(o=i.displayText)!==null&&o!==void 0?o:i.key}`,y=m?`Show all ${e.key}s`:`Only show ${v}`,x=`Hide ${v}`,$=`Unhide ${v}`,M=u?$:x;return p`
              <div class="facet-row">
    ...
    `}updated(e){e.has("selectedFacets")&&this.dispatchFacetsChangedEvent()}dispatchFacetsChangedEvent(){const e=new CustomEvent("facetsChanged",{detail:this.selectedFacets});this.dispatchEvent(e)}get currentYearsHistogramAggregation(){var e;return(e=this.aggregations)===null||e===void 0?void 0:e.year_histogram}get histogramTemplate(){const{fullYearsHistogramAggregation:e}=this;return this.fullYearAggregationLoading?p`<div class="histogram-loading-indicator">&hellip;</div>`:p`
          ...
          ></histogram-date-range>
        `}histogramDateRangeUpdated(e){const{minDate:t,maxDate:i}=e.detail,a=new CustomEvent("histogramDateRangeUpdated",{detail:{minDate:t,maxDate:i}});this.dispatchEvent(a)}get mergedFacets(){const e=[];return rn.forEach(t=>{var i,a;const o=this.selectedFacetGroups.find(m=>m.key===t),n=this.aggregationFacetGroups.find(m=>m.key===t);if(o&&!n){e.push(o);return}if(!n)return;const l=o!=null?o:n;let d=(i=o==null?void 0:o.buckets.map(m=>{const v=n.buckets.find(y=>y.key===m.key);return v?ht(se({},m),{count:v.count}):m}))!==null&&i!==void 0?i:[];n.buckets.forEach(m=>{d.find(y=>y.key===m.key)||d.push(m)}),t==="lending"&&(d=d.filter(m=>on[m.key]));let u=(a=Object.keys((o==null?void 0:o.buckets)||[]))===null||a===void 0?void 0:a.length;u<this.allowedFacetCount&&(u=this.allowedFacetCount),l.buckets=d.splice(0,u),e.push(l)}),e}get selectedFacetGroups(){return this.selectedFacets?Object.entries(this.selectedFacets).map(([t,i])=>{const a=t,o=wi[a],n=Object.entries(i).map(([l,d])=>{var u,m,v;let y=l;return a==="language"&&(y=(m=(u=this.languageCodeHandler)===null||u===void 0?void 0:u.getLanguageNameFromCodeString(l))!==null&&m!==void 0?m:l),a==="lending"&&(y=(v=cr[l])!==null&&v!==void 0?v:l),{displayText:y,key:l,count:d.count,state:d.state}});return{title:o,key:a,buckets:n}}):[]}get aggregationFacetGroups(){var e;const t=[];return Object.entries((e=this.aggregations)!==null&&e!==void 0?e:[]).forEach(([i,a])=>{if(i==="year_histogram")return;const o=i,n=wi[o];if(!n)return;let l=a.buckets;o==="collection"&&(l=l==null?void 0:l.filter(m=>{var v;const y=(v=m==null?void 0:m.key)===null||v===void 0?void 0:v.toString();return!ba[y]&&!(y!=null&&y.startsWith("fav-"))}));const d=l.map(m=>{var v,y,x;let $=m.key,M=`${m.key}`;return o==="language"&&($=(y=(v=this.languageCodeHandler)===null||v===void 0?void 0:v.getCodeStringFromLanguageName(`${m.key}`))!==null&&y!==void 0?y:m.key),o==="lending"&&(M=(x=cr[m.key])!==null&&x!==void 0?x:`${m.key}`),{displayText:M,key:`${$}`,count:m.doc_count,state:"none"}}),u={title:n,key:o,buckets:d};t.push(u)}),t}getFacetGroupTemplate(e){if(!this.facetsLoading&&e.buckets.length===0)return w;const{key:t}=e,i=this.openFacets[t],a=p`
