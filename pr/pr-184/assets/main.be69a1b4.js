...
`;let li=class extends O{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1,this.isCompactTile=!1}render(){return p`<div class="icon-overlay ${this.getClass}">
    ...
    `}};n([h({type:String})],Ue.prototype,"baseImageUrl",void 0);n([h({type:Boolean})],Ue.prototype,"isCompactTile",void 0);n([h({type:Boolean})],Ue.prototype,"isListTile",void 0);n([h({type:Boolean})],Ue.prototype,"loggedIn",void 0);n([h({type:Object})],Ue.prototype,"model",void 0);n([h({type:String})],Ue.prototype,"viewSize",void 0);Ue=n([R("image-block")],Ue);let Ai=class extends O{render(){return p`
      <div class="container">
 ...
 */function*Si(r,e){const t=typeof e=="function";if(r!==void 0){let i=-1;for(const a of r)i>-1&&(yield t?e(i):e),i++,yield a}}let Di=class extends O{constructor(){super(...arguments),this.snippets=[],this.viewSize="desktop"}render(){var e;return!((e=this.snippets)===null||e===void 0)&&e.length?p`
    ...
    `}};n([h({type:Array})],Di.prototype,"snippets",void 0);n([h({type:String})],Di.prototype,"viewSize",void 0);Di=n([R("text-snippet-block")],Di);const As=y`
  .drop-shadow {
    overflow: hidden;
    height: 100%;
  }
...
`+ne),Ce&&(ne=Ie(ne,je," "),ne=Ie(ne,We," ")),B&&vi?B.createHTML(ne):ne},e.setConfig=function(C){Ki(C),Ye=!0},e.clearConfig=function(){gt=null,Ye=!1},e.isValidAttribute=function(C,u,b){gt||Ki({});var S=Ke(C),H=Ke(u);return ar(S,H,b)},e.addHook=function(C,u){typeof u=="function"&&(pe[C]=pe[C]||[],Xt(pe[C],u))},e.removeHook=function(C){if(pe[C])return kr(pe[C])},e.removeHooks=function(C){pe[C]&&(pe[C]=[])},e.removeAllHooks=function(){pe={}},e}var ti=yo(),L;(function(r){r.relevance="relevance",r.alltimeview="alltimeview",r.weeklyview="weeklyview",r.title="title",r.datearchived="datearchived",r.date="date",r.datereviewed="datereviewed",r.dateadded="dateadded",r.creator="creator"})(L||(L={}));const Je={relevance:"Relevance",alltimeview:"All-time Views",weeklyview:"Weekly Views",title:"Title",datearchived:"Date Archived",date:"Date Published",datereviewed:"Date Reviewed",dateadded:"Date Added",creator:"Creator"},Dn={relevance:null,alltimeview:"downloads",weeklyview:"week",title:"titleSorter",datearchived:"publicdate",date:"date",datereviewed:"reviewdate",dateadded:"addeddate",creator:"creatorSorter"},Er={week:L.weeklyview,downloads:L.alltimeview,titleSorter:L.title,date:L.date,publicdate:L.datearchived,reviewdate:L.datereviewed,addeddate:L.dateadded,creatorSorter:L.creator},Ln={title:"firstTitle",creator:"firstCreator"},Oi={subject:{},lending:{},mediatype:{},language:{},creator:{},collection:{},year:{}},Fn=["mediatype","lending","year","subject","collection","creator","language"],Ii={subject:"Subject",lending:"Availability",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"},On={is_lendable:!0,is_borrowable:!1,available_to_borrow:!0,is_browsable:!1,available_to_browse:!1,is_readable:!0,available_to_waitlist:!1},Dr={is_lendable:"Lending Library",available_to_borrow:"Borrow 14 Days",is_readable:"Always Available"},Ra={deemphasize:!0,community:!0,stream_only:!0,samples_only:!0,test_collection:!0,printdisabled:!0,"openlibrary-ol":!0,nationalemergencylibrary:!0,china:!0,americana:!0,toronto:!0};function bo(r){switch(r){case"date":return"Published";case"reviewdate":return"Reviewed";case"addeddate":return"Added";default:return"Archived"}}function wo(r){return r?`Archivist since ${r.getFullYear()}`:""}let ye=class extends O{constructor(){super(...arguments),this.sortParam=null,this.collectionLinks=[],this.loggedIn=!1}render(){return p`
    ...
    `}get datePublishedTemplate(){var e;return this.metadataTemplate(Ei((e=this.model)===null||e===void 0?void 0:e.datePublished,"long"),"Published")}get dateSortByTemplate(){return this.sortParam&&(this.sortParam.field==="addeddate"||this.sortParam.field==="reviewdate"||this.sortParam.field==="publicdate")?this.metadataTemplate(Ei(this.date,"long"),bo(this.sortParam.field)):x}get viewsTemplate(){var e,t,i;const a=((e=this.sortParam)===null||e===void 0?void 0:e.field)==="week"?(t=this.model)===null||t===void 0?void 0:t.weeklyViewCount:(i=this.model)===null||i===void 0?void 0:i.viewCount;return this.metadataTemplate(`${ei(a!=null?a:0,this.formatSize)}`,"Views")}get ratingTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.averageRating,"Avg Rating")}get reviewsTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.commentCount,"Reviews")}get topicsTemplate(){var e;return!(!((e=this.model)===null||e===void 0)&&e.subjects)||this.model.subjects.length===0?x:p`
    ...
    `}};n([h({type:Object})],ye.prototype,"model",void 0);n([h({type:String})],ye.prototype,"baseNavigationUrl",void 0);n([h({type:Object})],ye.prototype,"collectionNameCache",void 0);n([h({type:Number})],ye.prototype,"currentWidth",void 0);n([h({type:Number})],ye.prototype,"currentHeight",void 0);n([h({type:Object})],ye.prototype,"sortParam",void 0);n([h({type:Number})],ye.prototype,"mobileBreakpoint",void 0);n([z()],ye.prototype,"collectionLinks",void 0);n([h({type:String})],ye.prototype,"baseImageUrl",void 0);n([h({type:Boolean})],ye.prototype,"loggedIn",void 0);ye=n([R("tile-list")],ye);let ze=class extends O{constructor(){super(...arguments),this.sortParam=null,this.loggedIn=!1}render(){var e,t,i,a,o,s,l,d,c;return p`
      <div id="list-line" class="${this.classSize}">
        ...
        <div id="date">${Ei(this.date,this.formatSize)}</div>
        <div id="icon">
          <mediatype-icon
...
`;let Aa=class extends O{constructor(){super(...arguments),this.config=new To}render(){return p`
    ...
    `}static get styles(){const e=y`var(--modalLogoSize, 6.5rem)`,t=y`var(--processingImageSize, 7.5rem)`,i=y`var(--modalCornerRadius, 1rem)`,a=y`var(--modalBorder, 2px solid black)`,o=y`var(--modalBottomMargin, 2.5rem)`,s=y`var(--modalTopMargin, 5rem)`,l=y`var(--modalHeaderBottomPadding, 0.5em)`,d=y`var(--modalBottomPadding, 2rem)`,c=y`var(--modalScrollOffset, 5px)`,v=y`var(--modalTitleFontSize, 1.8rem)`,m=y`var(--modalSubtitleFontSize, 1.4rem)`,f=y`var(--modalHeadlineFontSize, 1.6rem)`,w=y`var(--modalMessageFontSize, 1.4rem)`,_=y`var(--modalTitleLineHeight, normal)`,$=y`var(--modalSubtitleLineHeight, normal)`,A=y`var(--modalHeadlineLineHeight, normal)`,E=y`var(--modalMessageLineHeight, normal)`;return y`
      .processing-logo {
        margin: auto;
        width: ${t};
        height: ${t};
