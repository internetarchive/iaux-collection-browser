...
`;function ac(r,e){let t=1;return r>=1e9?t=1e9:r>=1e6?t=1e6:r>=1e3&&e==="short"&&(t=1e3),t}function nc(r=0,e){const t=r/e,i=t<10;let o=0;return i?o=Math.round((t+Number.EPSILON)*10)/10:o=Math.round(t),o}function lc(r,e,t,i){switch(e){case 1e9:return E(t==="short"?mt`${r}B`:mt`${r} billion`);case 1e6:return E(t==="short"?mt`${r}M`:mt`${r} million`);case 1e3:return E(t==="short"?mt`${r}K`:mt`${r} thousand`);default:return new Intl.NumberFormat(i).format(r)}}function ks(r,e="long",t="short",i="en-US"){const o=r??-1;if(o<0)return"";const s=ac(o,e),a=nc(o,s);return lc(a,s,t,i)}let Qe=class extends P{constructor(){super(...arguments),this.showTvClips=!1}render(){return h`
    ...
    `}get viewsColumnTemplate(){var e;const t=(e=this.viewLabel)!==null&&e!==void 0?e:E("all-time views");return this.columnTemplate(this.viewCount,t,rc)}get uploadsColumnTemplate(){return this.columnTemplate(this.itemCount,E("uploads"),oc)}get favoritesColumnTemplate(){return this.columnTemplate(this.favCount,E("favorites"),zn)}get reviewsColumnTemplate(){return this.columnTemplate(this.commentCount,E("reviews"),ic,["reviews"])}get tvClipsColumnTemplate(){return this.columnTemplate(this.tvClipCount,E("clips"),sc)}static get styles(){return[ut,f`
      ...
      `]}};n([c({type:Object})],Qe.prototype,"model",void 0);n([c({type:String})],Qe.prototype,"mediatype",void 0);n([c({type:Number})],Qe.prototype,"itemCount",void 0);n([c({type:Number})],Qe.prototype,"viewCount",void 0);n([c({type:String})],Qe.prototype,"viewLabel",void 0);n([c({type:Number})],Qe.prototype,"favCount",void 0);n([c({type:Number})],Qe.prototype,"commentCount",void 0);n([c({type:Boolean})],Qe.prototype,"showTvClips",void 0);n([c({type:Number})],Qe.prototype,"tvClipCount",void 0);Qe=n([R("tile-stats")],Qe);let Zi=class extends de{constructor(){super(...arguments),this.showInfoButton=!1,this.showTvClips=!1,this.simpleLayoutType="none"}render(){var e;const t=(e=this.model)===null||e===void 0?void 0:e.title,i=je({container:!0,simple:this.simpleLayoutType!=="none","stats-only":this.simpleLayoutType==="stats-only","snippets-only":this.simpleLayoutType==="snippets-only"});return h`
      <div class=${i}>
        ${this.infoButtonTemplate}
        <div class="tile-details">
          <div class="item-info">
...
`+Te),Gt&&po([Ze,Je,K],tt=>{Te=Ai(Te,tt," ")}),O&&oo?O.createHTML(Te):Te},e.setConfig=function(){let z=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};ir(z),Ko=!0},e.clearConfig=function(){Zt=null,Ko=!1},e.isValidAttribute=function(z,g,$){Zt||ir({});const L=ue(z),J=ue(g);return js(L,J,$)},e.addHook=function(z,g){typeof g=="function"&&Mi(Q[z],g)},e.removeHook=function(z,g){if(g!==void 0){const $=uc(Q[z],g);return $===-1?void 0:fc(Q[z],$,1)[0]}return Ta(Q[z])},e.removeHooks=function(z){Q[z]=[]},e.removeAllHooks=function(){Q=za()},e}var wo=Un();let Po=class extends de{constructor(){super(...arguments),this.collectionLinks=[]}render(){return h`
    ...
    `}};n([c({type:Object})],Po.prototype,"collectionTitles",void 0);n([F()],Po.prototype,"collectionLinks",void 0);Po=n([R("tile-list")],Po);let Ke=class extends P{constructor(){super(...arguments),this.loggedIn=!1,this.suppressBlurring=!1}render(){return h`
      <div id="container">
        ${this.headerTemplate}
    ...
    `}};n([c({type:Object})],Ke.prototype,"model",void 0);n([c({type:String})],Ke.prototype,"baseNavigationUrl",void 0);n([c({type:String})],Ke.prototype,"baseImageUrl",void 0);n([c({type:Boolean})],Ke.prototype,"loggedIn",void 0);n([c({type:Boolean})],Ke.prototype,"suppressBlurring",void 0);n([c({type:Object})],Ke.prototype,"sortParam",void 0);n([c({type:Number})],Ke.prototype,"mobileBreakpoint",void 0);n([c({type:Number})],Ke.prototype,"currentWidth",void 0);n([c({type:Object})],Ke.prototype,"collectionTitles",void 0);Ke=n([R("tile-hover-pane")],Ke);let Ba=class extends de{render(){var e,t,i,o;return h`
      <div id="list-line" class="${this.classSize}">
        <image-block
          .model=${this.model}
          .baseImageUrl=${this.baseImageUrl}
...
`;function qh(r){return r&&r.charAt(0).toLocaleUpperCase()+r.slice(1)}let eo=class extends P{constructor(){super(...arguments),this.selected=!1}render(){var e,t;if(!this.facetInfo)return b;const i=this.facetInfo.facets.length===1,o=this.facetInfo.facets[0],s=qh((this.labelPrefix?`${this.labelPrefix} `:"")+((t=(e=this.facetInfo.label)!==null&&e!==void 0?e:o.displayText)!==null&&t!==void 0?t:o.bucketKey));if(!s)return b;const a=i&&o.facetType==="mediatype"?Pn[o.bucketKey].icon:b;return h`
    ...
    `}willUpdate(e){let t=!1;e.has("query")&&(He("query change",e.get("query"),this.query),this.lastAggregations=void 0,t=!0),e.has("aggregations")&&!this.lastAggregations&&this.aggregations&&Object.keys(this.aggregations).length>0&&(He("aggs change",e.get("aggregations"),this.aggregations),this.lastAggregations=this.aggregations,t=!0),t&&(He("should update smart facets, doing so..."),this.updateSmartFacets())}refresh(){this.lastAggregations=this.aggregations,this.updateSmartFacets()}async updateSmartFacets(){He("updating smart facets"),this.query&&(this.heuristicRecs=await new Yo().getRecommendedFacets(this.query),He("heuristic recs are",this.heuristicRecs),this.smartFacets=Jn(this.facetsToDisplay),He("smart facets are",this.smartFacets))}makeSmartFacet(e){return e.length===0?b:e.length===1?this.smartFacetButton(e[0]):this.smartFacetDropdown(e)}smartFacetButton(e){var t;return h`
      <smart-facet-button
        .facetInfo=${e}
    ...
    `}get rightColumnTemplate(){var e;const t=je({column:!0,"full-width":this.showSmartFacetBar&&!this.facetPaneVisible,"smart-results-spacing":!!this.showSmartResults});return h`
    ...
    </infinite-scroller>`}get infiniteScrollerClasses(){var e;return je({[(e=this.displayMode)!==null&&e!==void 0?e:""]:!!this.displayMode,hidden:!!this.placeholderType})}get sortFilterBarTemplate(){var e;return this.suppressSortBar?b:h`
      <sort-filter-bar
