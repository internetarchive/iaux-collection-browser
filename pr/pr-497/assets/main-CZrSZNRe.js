...
`;let Y=class extends P{constructor(){super(...arguments),this.defaultSortDirection=null,this.defaultSortField=C.relevance,this.sortDirection=null,this.selectedSort=C.default,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.showRelevance=!0,this.showDateFavorited=!1,this.enableSortOptionsSlot=!1,this.suppressDisplayModes=!1,this.lastSelectedViewSort=C.weeklyview,this.lastSelectedDateSort=this.defaultDateSortField,this.alphaSelectorVisible=null,this.dropdownBackdropVisible=!1,this.desktopSortContainerWidth=0,this.selectorBarContainerWidth=0,this.boundSortBarSelectorEscapeListener=e=>{e.key==="Escape"&&this.closeDropdowns()}}render(){return h`
    ...
    `}getSortDisplayOption(e,t){var i,o;const s=(i=t==null?void 0:t.selected)!==null&&i!==void 0?i:this.finalizedSortField===e,a=(o=t==null?void 0:t.displayName)!==null&&o!==void 0?o:xe[e].displayName;return h`
      <button
        class=${s?"selected":b}
        data-title="${a}"
...
`;let ls=class extends P{constructor(){super(...arguments),this.config=new Rt}render(){return h`
    ...
    `}static get styles(){const e=f`var(--modalLogoSize, 6.5rem)`,t=f`var(--processingImageSize, 7.5rem)`,i=f`var(--modalCornerRadius, 1rem)`,o=f`var(--modalBorder, 2px solid black)`,s=f`var(--modalBottomMargin, 2.5rem)`,a=f`var(--modalTopMargin, 5rem)`,l=f`var(--modalHeaderBottomPadding, 0.5em)`,d=f`var(--modalBottomPadding, 2rem)`,u=f`var(--modalScrollOffset, 5px)`,p=f`var(--modalTitleFontSize, 1.8rem)`,m=f`var(--modalSubtitleFontSize, 1.4rem)`,v=f`var(--modalHeadlineFontSize, 1.6rem)`,y=f`var(--modalMessageFontSize, 1.4rem)`,x=f`var(--modalTitleLineHeight, normal)`,S=f`var(--modalSubtitleLineHeight, normal)`,_=f`var(--modalHeadlineLineHeight, normal)`,D=f`var(--modalMessageLineHeight, normal)`;return f`
      .processing-logo {
        margin: auto;
        width: ${t};
        height: ${t};
    ...
    `}};n([c({type:Object})],Io.prototype,"items",void 0);n([c({type:String})],Io.prototype,"message",void 0);Io=n([R("remove-items-modal-content")],Io);let rt=class extends P{constructor(){super(...arguments),this.label=E("Select items to remove"),this.selectedItems=[],this.showSelectAll=!1,this.showUnselectAll=!1,this.showItemManageButton=!1,this.removeAllowed=!1}render(){return h`
      <div class="manage-container">
        ...
        <div class="manage-buttons">
          ...
          ${xr(this.showItemManageButton,()=>h` <button
          ...
          <div class="selection-buttons">
            ${xr(this.showSelectAll,()=>h` <button
                  class="ia-button link select-all-btn"
                  @click=${this.selectAllClicked}
                >
                  ${E("Select all")}
                </button>`)}
            ${xr(this.showUnselectAll,()=>h` <button
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let je=uh;const Ja=f`var(--white, #fff)`,vh=f`var(--ia-theme-link-color, #4b64ff)`,gh=f`var(--primaryDisableCTAFill, #767676)`,bh=f`var(--secondaryCTABorder, #999)`,yh=f`var(--primaryCTAFill, #194880)`,Ar=f`var(--primaryCTAFillRGB, 25, 72, 128)`,wh=f`var(--primaryCTABorder, #c5d1df)`,Sh=f`var(--primaryErrorCTAFill, #d9534f)`,Dr=f`var(--primaryErrorCTAFillRGB, 229, 28, 38)`,xh=f`var(--primaryErrorCTABorder, #d43f3a)`,$h=f`var(--secondaryCTAFill, #333)`,Fr=f`var(--secondaryCTAFillRGB, 51, 51, 51)`,_h=f`var(--primaryCTABorder, #979797)`,Ch=f`var(---primaryWarningFill, #ee8950)`,Lr=f`var(--primaryWarningFillRGB, 238, 137, 80)`,kh=f`var(--primaryWarningBorder, #ec7939)`,Th=f`
  .ia-button {
    min-height: 3rem;
    cursor: pointer;
    color: ${Ja};
...
`;var cs;let Ji=cs=class extends P{render(){return h`${this.facetRowTemplate}`}get facetRowTemplate(){var e,t,i,o;const{bucket:s,facetType:a}=this;if(!s||!a)return b;const l=`${a}:${s.key}-show-only`,d=`${a}:${s.key}-negative`,u=s.extraNote?h`<span class="facet-note">${s.extraNote}</span>`:b,p=a!=="collection"?h`${(e=s.displayText)!==null&&e!==void 0?e:s.key} ${u}`:h`<a href="/details/${s.key}">
          ...
          </a> `,m=s.state==="hidden",v=s.state==="selected",y=`${a}: ${(o=s.displayText)!==null&&o!==void 0?o:s.key}`,x=v?`Show all ${a}s`:`Only show ${y}`,S=`Hide ${y}`,_=`Unhide ${y}`,D=m?_:S,M=`${y}, ${s.count} results`;return h`
    ...
    `}};n([c({type:Object})],Ho.prototype,"facetGroup",void 0);n([c({type:Object})],Ho.prototype,"collectionTitles",void 0);Ho=n([R("facets-template")],Ho);let St=class extends P{constructor(){super(...arguments),this.leftValue="",this.rightValue="",this.side="left"}render(){var e,t;return h`
      <div id="container">
