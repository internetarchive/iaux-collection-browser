...
fill=""></path>
    ...
    `:h``:h``}render(){return h`
      <div class="ia-dropdown-group">
        ...
        <ul id="dropdown-main" class=${this.dropdownState} ?popover=${this.usePopover}>
...
`;function qh(r){return r&&r.charAt(0).toLocaleUpperCase()+r.slice(1)}let eo=class extends P{constructor(){super(...arguments),this.selected=!1}render(){var e,t;if(!this.facetInfo)return b;const i=this.facetInfo.facets.length===1,o=this.facetInfo.facets[0],s=qh((this.labelPrefix?`${this.labelPrefix} `:"")+((t=(e=this.facetInfo.label)!==null&&e!==void 0?e:o.displayText)!==null&&t!==void 0?t:o.bucketKey));if(!s)return b;const a=i&&o.facetType==="mediatype"?Pn[o.bucketKey].icon:b;return h`
    ...
    `}};n([c({type:Array})],mi.prototype,"facetInfo",void 0);n([c({type:String})],mi.prototype,"labelPrefix",void 0);n([c({type:Object})],mi.prototype,"activeFacetRef",void 0);n([H("ia-dropdown")],mi.prototype,"dropdown",void 0);mi=n([R("smart-facet-dropdown")],mi);const sn={collection:"Collection: ",creator:"By: ",subject:"About: "};function Gh(r){return r.charAt(0).toUpperCase()+r.slice(1)}let Oe=class extends P{constructor(){super(...arguments),this.filterToggleShown=!1,this.filterToggleActive=!1,this.heuristicRecs=[],this.smartFacets=[]}render(){if(!this.query)return b;const e=!!this.label&&this.smartFacets.length>0;return h`
