...
`;let mi=class extends I{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1}render(){return this.loginRequired&&!this.loggedIn?u`${hs} `:u`${cs}`}static get styles(){return y`
    ...
    `}};n([p({type:Boolean})],mi.prototype,"loggedIn",void 0);n([p({type:Boolean})],mi.prototype,"loginRequired",void 0);mi=n([H("icon-overlay")],mi);let fi=class extends I{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1}render(){return u` <div class="overlay no-preview">${this.textDisplay}</div> `}get textDisplay(){return this.loginRequired&&!this.loggedIn?`Log in
to view this item`:"Content may be inappropriate"}static get styles(){return y`
    ...
    `}};n([p({type:Boolean})],fi.prototype,"loggedIn",void 0);n([p({type:Boolean})],fi.prototype,"loginRequired",void 0);fi=n([H("text-overlay")],fi);let Fe=class extends I{constructor(){super(...arguments),this.isCompactTile=!1,this.isListTile=!1,this.loggedIn=!1,this.viewSize="desktop"}render(){var e;return!((e=this.model)===null||e===void 0)&&e.identifier?u`
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*si(r,e){const t=typeof e=="function";if(r!==void 0){let i=-1;for(const a of r)i>-1&&(yield t?e(i):e),i++,yield a}}let vi=class extends I{constructor(){super(...arguments),this.snippets=[],this.viewSize="desktop"}render(){var e;return!((e=this.snippets)===null||e===void 0)&&e.length?u`
    ...
    `}};n([p({type:Array})],vi.prototype,"snippets",void 0);n([p({type:String})],vi.prototype,"viewSize",void 0);vi=n([H("text-snippet-block")],vi);const ps=y`
  .drop-shadow {
