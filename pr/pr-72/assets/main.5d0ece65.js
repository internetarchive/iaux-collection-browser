 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ia=({finisher:a,descriptor:e})=>(t,i)=>{var r;if(i===void 0){const s=(r=t.originalKey)!==null&&r!==void 0?r:t.key,o=e!=null?{kind:"method",placement:"prototype",key:s,descriptor:e(t.key)}:Dt(fe({},t),{key:s});return a!=null&&(o.finisher=function(l){a(l,s)}),o}{const s=t.constructor;e!==void 0&&Object.defineProperty(t,i,e(i)),a==null||a(s,i)}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const{H:Qs}=Us,Gs=a=>a.strings===void 0,qr=()=>document.createComment(""),At=(a,e,t)=>{var i;const r=a._$AA.parentNode,s=e===void 0?a._$AB:e._$AA;if(t===void 0){const o=r.insertBefore(qr(),s),l=r.insertBefore(qr(),s);t=new Qs(o,l,a,a.options)}else{const o=t._$AB.nextSibling,l=t._$AM,d=l!==a;if(d){let h;(i=t._$AQ)===null||i===void 0||i.call(t,a),t._$AM=a,t._$AP!==void 0&&(h=a._$AU)!==l._$AU&&t._$AP(h)}if(o!==s||d){let h=t._$AA;for(;h!==o;){const u=h.nextSibling;r.insertBefore(h,s),h=u}}}return t},Ue=(a,e,t=a)=>(a._$AI(e,t),a),Ys={},Na=(a,e=Ys)=>a._$AH=e,Ks=a=>a._$AH,Ri=a=>{var e;(e=a._$AP)===null||e===void 0||e.call(a,!1,!0);let t=a._$AA;const i=a._$AB.nextSibling;for(;t!==i;){const r=t.nextSibling;t.remove(),t=r}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Xr=(a,e,t)=>{const i=new Map;for(let r=e;r<=t;r++)i.set(a[r],r);return i},za=dr(class extends cr{constructor(a){if(super(a),a.type!==Me.CHILD)throw Error("repeat() can only be used in text expressions")}dt(a,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);const r=[],s=[];let o=0;for(const l of a)r[o]=i?i(l,o):o,s[o]=t(l,o),o++;return{values:s,keys:r}}render(a,e,t){return this.dt(a,e,t).values}update(a,[e,t,i]){var r;const s=Ks(a),{values:o,keys:l}=this.dt(e,t,i);if(!Array.isArray(s))return this.ut=l,o;const d=(r=this.ut)!==null&&r!==void 0?r:this.ut=[],h=[];let u,v,f=0,y=s.length-1,$=0,k=o.length-1;for(;f<=y&&$<=k;)if(s[f]===null)f++;else if(s[y]===null)y--;else if(d[f]===l[$])h[$]=Ue(s[f],o[$]),f++,$++;else if(d[y]===l[k])h[k]=Ue(s[y],o[k]),y--,k--;else if(d[f]===l[k])h[k]=Ue(s[f],o[k]),At(a,h[k+1],s[f]),f++,k--;else if(d[y]===l[$])h[$]=Ue(s[y],o[$]),At(a,s[f],s[y]),y--,$++;else if(u===void 0&&(u=Xr(l,$,k),v=Xr(d,f,y)),u.has(d[f]))if(u.has(d[y])){const E=v.get(l[$]),A=E!==void 0?s[E]:null;if(A===null){const R=At(a,s[f]);Ue(R,o[$]),h[$]=R}else h[$]=Ue(A,o[$]),At(a,s[f],A),s[E]=null;$++}else Ri(s[y]),y--;else Ri(s[f]),f++;for(;$<=k;){const E=At(a,h[k+1]);Ue(E,o[$]),h[$++]=E}for(;f<=y;){const E=s[f++];E!==null&&Ri(E)}return this.ut=l,Na(a,h),ce}});function Kt(a,e,t){return Array.from({length:(e-a)/t+1},(i,r)=>a+r*t)}let Fe=class extends B{constructor(){super(...arguments),this.itemCount=0,this.scrollOptimizationsDisabled=!1,this.intersectionObserver=new IntersectionObserver(e=>{e.forEach(t=>{if(t.target===this.sentinel){t.isIntersecting&&this.dispatchEvent(new Event("scrollThresholdReached"));return}const r=t.target.dataset.cellIndex;if(!r)return;const s=parseInt(r,10);t.isIntersecting?this.visibleCellIndices.add(s):this.visibleCellIndices.delete(s)}),this.scrollOptimizationsDisabled||this.processVisibleCells()}),this.renderedCellIndices=new Set,this.visibleCellIndices=new Set,this.placeholderCellIndices=new Set}reload(){Kt(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.removeCell(t)),this.renderedCellIndices.clear(),this.visibleCellIndices.clear(),this.placeholderCellIndices.clear(),this.setupObservations()}scrollToCell(e,t){const i=this.cellContainers[e];if(!i)return!1;const r=t?"smooth":"auto";return i.scrollIntoView({behavior:r}),!0}getVisibleCellIndices(){return Array.from(this.visibleCellIndices)}updated(e){(e.has("itemCount")||e.has("scrollOptimizationsDisabled"))&&this.setupObservations()}disconnectedCallback(){this.intersectionObserver.disconnect()}setupObservations(){this.setupIntersectionObserver()}setupIntersectionObserver(){this.intersectionObserver.disconnect(),this.sentinel&&this.intersectionObserver.observe(this.sentinel),this.scrollOptimizationsDisabled?(Kt(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.visibleCellIndices.add(t)),this.processVisibleCells()):this.cellContainers.forEach(e=>this.intersectionObserver.observe(e))}render(){const e=this.itemCount-1,t=Kt(0,e,1);return m`
      <div id="container">
        <div id="sentinel"></div>
        ${za(t,i=>i,i=>m`
            <div
    ...
    `}};n([p({type:Number})],Fe.prototype,"itemCount",void 0);n([p({type:Object})],Fe.prototype,"cellProvider",void 0);n([p({type:Object})],Fe.prototype,"placeholderCellTemplate",void 0);n([p({type:Boolean})],Fe.prototype,"scrollOptimizationsDisabled",void 0);n([le("#sentinel")],Fe.prototype,"sentinel",void 0);n([Vs(".cell-container")],Fe.prototype,"cellContainers",void 0);Fe=n([G("infinite-scroller")],Fe);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const qs=(a,...e)=>({strTag:!0,strings:a,values:e}),st=qs,Xs=a=>typeof a!="string"&&"strTag"in a,Zs=(a,e,t)=>{let i=a[0];for(let r=1;r<a.length;r++)i+=e[t?t[r-1]:r-1],i+=a[r];return i};/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;let Xi=class extends B{render(){var e,t,i;return m`
    ...
    `}};n([p({type:Object})],Xi.prototype,"model",void 0);Xi=n([G("collection-tile")],Xi);function io(a,e){let t=1;return a>=1e9?t=1e9:a>=1e6?t=1e6:a>=1e3&&e==="short"&&(t=1e3),t}function ro(a=0,e){const t=a/e,i=t<10;let r=0;return i?r=Math.round((t+Number.EPSILON)*10)/10:r=Math.round(t),r}function ao(a,e,t,i){switch(e){case 1e9:return Ve(t==="short"?st`${a}B`:st`${a} billion`);case 1e6:return Ve(t==="short"?st`${a}M`:st`${a} million`);case 1e3:return Ve(t==="short"?st`${a}K`:st`${a} thousand`);default:return new Intl.NumberFormat(i).format(a)}}function Ft(a,e="long",t="short",i="en-US"){const r=a!=null?a:-1;if(r<0)return"";const s=io(r,e),o=ro(r,s);return ao(o,s,t,i)}const Ba=L`
...
`,bo={account:{color:"#000000",icon:oo,text:"Account"},audio:{color:"#00adef",icon:no,text:"Audio"},collection:{color:"#4666ff",icon:Pa,text:"Collection"},data:{color:"#333333",icon:lo,text:"Data"},etree:{color:"#00adef",icon:co,text:"E-tree"},film:{color:"#bf1b2c",icon:Zr,text:"Film"},image:{color:"#aa99c9",icon:ho,text:"Image"},movies:{color:"#f1644b",icon:Zr,text:"Movie"},radio:{color:"#8fdaef",icon:uo,text:"Radio"},software:{color:"#9ecc4f",icon:po,text:"Software"},texts:{color:"#faab3c",icon:vo,text:"Text"},tv:{color:"#f1644b",icon:mo,text:"TV"},video:{color:"#f1644b",icon:go,text:"Video"},web:{color:"#ffcd27",icon:fo,text:"Web"}};let Ht=class extends B{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var e,t;const i=["tvnews","tvarchive","television"],r=["radio","radioprogram"];return this.mediatype==="movies"&&((e=this.collections)===null||e===void 0?void 0:e.some(s=>i.indexOf(s)>=0))?"tv":this.mediatype==="audio"&&((t=this.collections)===null||t===void 0?void 0:t.some(s=>r.indexOf(s)>=0))?"radio":this.mediatype||""}render(){const e=bo[this.displayMediatype];return e?m`
      <div
        id="icon"
 ...
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Jr=dr(class extends cr{constructor(a){var e;if(super(a),a.type!==Me.ATTRIBUTE||a.name!=="class"||((e=a.strings)===null||e===void 0?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(a){return" "+Object.keys(a).filter(e=>a[e]).join(" ")+" "}update(a,[e]){var t,i;if(this.et===void 0){this.et=new Set,a.strings!==void 0&&(this.st=new Set(a.strings.join(" ").split(/\s/).filter(s=>s!=="")));for(const s in e)e[s]&&!(!((t=this.st)===null||t===void 0)&&t.has(s))&&this.et.add(s);return this.render(e)}const r=a.element.classList;this.et.forEach(s=>{s in e||(r.remove(s),this.et.delete(s))});for(const s in e){const o=!!e[s];o===this.et.has(s)||((i=this.st)===null||i===void 0?void 0:i.has(s))||(o?(r.add(s),this.et.add(s)):(r.remove(s),this.et.delete(s)))}return ce}}),yo=b`
  .drop-shadow {
...
`;let oi=class extends B{render(){var e,t,i,r,s,o,l;const d=(e=this.model)===null||e===void 0?void 0:e.title,h=(t=this.model)===null||t===void 0?void 0:t.creator;return m`
      <div id="container">
        <div class="title-wrapper">
          <h1 id="item-title" title=${Qe(d)}>${d}</h1>
        </div>
        ...
        <div class="stats-wrapper">
          ...
          <div id="stats-holder">
            ...
            <div class="col">
              ${Ba}
              <p class="status-text">
                ${Ft((o=this.model)===null||o===void 0?void 0:o.itemCount,"short","short")}
              </p>
            </div>
            <div class="col">
              ${Ua}
    ...
    `}static get styles(){return[So]}};n([p({type:Object})],oi.prototype,"model",void 0);n([p({type:String})],oi.prototype,"baseImageUrl",void 0);oi=n([G("item-tile")],oi);const $o=L`
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path
      d="m89.6854559 79.6500588c1.7300364 6.4823648 2.180423 13.3122689 3.3145441 20.3499412h-86c.5683151-15.8558542 2.98334063-30.7849367 15.1676149-41.6581341 22.9948067-20.518674 59.250299-9.0032844 67.517841 21.3081929zm-40.0998307-79.6500588c10.872402.0493248 19.9700408 9.25722341 19.917959 20.1421788-.0829413 11.042868-8.9616237 19.8492523-20.0602807 19.8578212-11.1181198 0-19.9397193-8.7904706-19.9397193-19.8908727-.0327543-11.11998815 9.0125781-20.17487063 20.082041-20.1091273z"
      fill="#333"
...
`;let Zi=class extends B{render(){var e,t,i,r,s,o,l;return m`
      <div class="outer-holder">
        <div class="inner-holder">
          ...
          <div id="status-holder">
            <div id="patron-icon">${$o}</div>
            <div class="stat-icon">
              ${xo}
              <h3>${(s=this.model)===null||s===void 0?void 0:s.itemCount}</h3>
            </div>
            <div class="stat-icon">
              ${Ba}
              <h3>${(o=this.model)===null||o===void 0?void 0:o.favCount}</h3>
            </div>
            <div class="stat-icon">
              ${Ua}
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*ea(a,e){if(a!==void 0){let t=0;for(const i of a)yield e(i,t++)}}/*! @license DOMPurify 2.3.8 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/2.3.8/LICENSE */function We(a){return We=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},We(a)}function Ji(a,e){return Ji=Object.setPrototypeOf||function(i,r){return i.__proto__=r,i},Ji(a,e)}function Co(){if(typeof Reflect=="undefined"||!Reflect.construct||Reflect.construct.sham)return!1;if(typeof Proxy=="function")return!0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],function(){})),!0}catch{return!1}}function ei(a,e,t){return Co()?ei=Reflect.construct:ei=function(r,s,o){var l=[null];l.push.apply(l,s);var d=Function.bind.apply(r,l),h=new d;return o&&Ji(h,o.prototype),h},ei.apply(null,arguments)}function he(a){return _o(a)||ko(a)||To(a)||Do()}function _o(a){if(Array.isArray(a))return er(a)}function ko(a){if(typeof Symbol!="undefined"&&a[Symbol.iterator]!=null||a["@@iterator"]!=null)return Array.from(a)}function To(a,e){if(!!a){if(typeof a=="string")return er(a,e);var t=Object.prototype.toString.call(a).slice(8,-1);if(t==="Object"&&a.constructor&&(t=a.constructor.name),t==="Map"||t==="Set")return Array.from(a);if(t==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t))return er(a,e)}}function er(a,e){(e==null||e>a.length)&&(e=a.length);for(var t=0,i=new Array(e);t<e;t++)i[t]=a[t];return i}function Do(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}var Mo=Object.hasOwnProperty,ta=Object.setPrototypeOf,Ao=Object.isFrozen,Eo=Object.getPrototypeOf,Oo=Object.getOwnPropertyDescriptor,ee=Object.freeze,ye=Object.seal,Lo=Object.create,Ha=typeof Reflect!="undefined"&&Reflect,ni=Ha.apply,tr=Ha.construct;ni||(ni=function(e,t,i){return e.apply(t,i)});ee||(ee=function(e){return e});ye||(ye=function(e){return e});tr||(tr=function(e,t){return ei(e,he(t))});var Fo=pe(Array.prototype.forEach),ia=pe(Array.prototype.pop),Et=pe(Array.prototype.push),ti=pe(String.prototype.toLowerCase),Ro=pe(String.prototype.match),De=pe(String.prototype.replace),Io=pe(String.prototype.indexOf),No=pe(String.prototype.trim),J=pe(RegExp.prototype.test),Ni=zo(TypeError);function pe(a){return function(e){for(var t=arguments.length,i=new Array(t>1?t-1:0),r=1;r<t;r++)i[r-1]=arguments[r];return ni(a,e,i)}}function zo(a){return function(){for(var e=arguments.length,t=new Array(e),i=0;i<e;i++)t[i]=arguments[i];return tr(a,t)}}function M(a,e){ta&&ta(a,null);for(var t=e.length;t--;){var i=e[t];if(typeof i=="string"){var r=ti(i);r!==i&&(Ao(e)||(e[t]=r),i=r)}a[i]=!0}return a}function He(a){var e=Lo(null),t;for(t in a)ni(Mo,a,[t])&&(e[t]=a[t]);return e}function qt(a,e){for(;a!==null;){var t=Oo(a,e);if(t){if(t.get)return pe(t.get);if(typeof t.value=="function")return pe(t.value)}a=Eo(a)}function i(r){return console.warn("fallback value for",r),null}return i}var ra=ee(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","section","select","shadow","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),zi=ee(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","filter","font","g","glyph","glyphref","hkern","image","line","lineargradient","marker","mask","metadata","mpath","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),Pi=ee(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),Po=ee(["animate","color-profile","cursor","discard","fedropshadow","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),Bi=ee(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover"]),Bo=ee(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),aa=ee(["#text"]),sa=ee(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","face","for","headers","height","hidden","high","href","hreflang","id","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","pattern","placeholder","playsinline","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","xmlns","slot"]),Ui=ee(["accent-height","accumulate","additive","alignment-baseline","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),oa=ee(["accent","accentunder","align","bevelled","close","columnsalign","columnlines","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lspace","lquote","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),Xt=ee(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),Uo=ye(/\{\{[\w\W]*|[\w\W]*\}\}/gm),Ho=ye(/<%[\w\W]*|[\w\W]*%>/gm),Vo=ye(/^data-[\-\w.\u00B7-\uFFFF]/),Wo=ye(/^aria-[\-\w]+$/),jo=ye(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|cid|xmpp):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),Qo=ye(/^(?:\w+script|data):/i),Go=ye(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),Yo=ye(/^html$/i),Ko=function(){return typeof window=="undefined"?null:window},qo=function(e,t){if(We(e)!=="object"||typeof e.createPolicy!="function")return null;var i=null,r="data-tt-policy-suffix";t.currentScript&&t.currentScript.hasAttribute(r)&&(i=t.currentScript.getAttribute(r));var s="dompurify"+(i?"#"+i:"");try{return e.createPolicy(s,{createHTML:function(l){return l}})}catch{return console.warn("TrustedTypes policy "+s+" could not be created."),null}};function Va(){var a=arguments.length>0&&arguments[0]!==void 0?arguments[0]:Ko(),e=function(c){return Va(c)};if(e.version="2.3.8",e.removed=[],!a||!a.document||a.document.nodeType!==9)return e.isSupported=!1,e;var t=a.document,i=a.document,r=a.DocumentFragment,s=a.HTMLTemplateElement,o=a.Node,l=a.Element,d=a.NodeFilter,h=a.NamedNodeMap,u=h===void 0?a.NamedNodeMap||a.MozNamedAttrMap:h,v=a.HTMLFormElement,f=a.DOMParser,y=a.trustedTypes,$=l.prototype,k=qt($,"cloneNode"),E=qt($,"nextSibling"),A=qt($,"childNodes"),R=qt($,"parentNode");if(typeof s=="function"){var F=i.createElement("template");F.content&&F.content.ownerDocument&&(i=F.content.ownerDocument)}var N=qo(y,t),Y=N?N.createHTML(""):"",se=i,ge=se.implementation,yt=se.createNodeIterator,wt=se.createDocumentFragment,St=se.getElementsByTagName,$t=t.importNode,Ke={};try{Ke=He(i).documentMode?i.documentMode:{}}catch{}var te={};e.isSupported=typeof R=="function"&&ge&&typeof ge.createHTMLDocument!="undefined"&&Ke!==9;var Re=Uo,Ie=Ho,xt=Vo,Ct=Wo,_t=Qo,qe=Go,Ne=jo,V=null,Xe=M({},[].concat(he(ra),he(zi),he(Pi),he(Bi),he(aa))),W=null,Ze=M({},[].concat(he(sa),he(Ui),he(oa),he(Xt))),U=Object.seal(Object.create(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),ke=null,mi=null,gr=!0,gi=!0,fr=!1,Je=!1,ze=!1,fi=!1,bi=!1,et=!1,Wt=!1,jt=!1,br=!0,yi=!0,kt=!1,tt={},it=null,yr=M({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","style","svg","template","thead","title","video","xmp"]),wr=null,Sr=M({},["audio","video","img","source","image","track"]),wi=null,$r=M({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),Si="http://www.w3.org/1998/Math/MathML",$i="http://www.w3.org/2000/svg",Te="http://www.w3.org/1999/xhtml",Qt=Te,xi=!1,rt,is=["application/xhtml+xml","text/html"],rs="text/html",Pe,at=null,as=i.createElement("form"),xr=function(c){return c instanceof RegExp||c instanceof Function},Ci=function(c){at&&at===c||((!c||We(c)!=="object")&&(c={}),c=He(c),V="ALLOWED_TAGS"in c?M({},c.ALLOWED_TAGS):Xe,W="ALLOWED_ATTR"in c?M({},c.ALLOWED_ATTR):Ze,wi="ADD_URI_SAFE_ATTR"in c?M(He($r),c.ADD_URI_SAFE_ATTR):$r,wr="ADD_DATA_URI_TAGS"in c?M(He(Sr),c.ADD_DATA_URI_TAGS):Sr,it="FORBID_CONTENTS"in c?M({},c.FORBID_CONTENTS):yr,ke="FORBID_TAGS"in c?M({},c.FORBID_TAGS):{},mi="FORBID_ATTR"in c?M({},c.FORBID_ATTR):{},tt="USE_PROFILES"in c?c.USE_PROFILES:!1,gr=c.ALLOW_ARIA_ATTR!==!1,gi=c.ALLOW_DATA_ATTR!==!1,fr=c.ALLOW_UNKNOWN_PROTOCOLS||!1,Je=c.SAFE_FOR_TEMPLATES||!1,ze=c.WHOLE_DOCUMENT||!1,et=c.RETURN_DOM||!1,Wt=c.RETURN_DOM_FRAGMENT||!1,jt=c.RETURN_TRUSTED_TYPE||!1,bi=c.FORCE_BODY||!1,br=c.SANITIZE_DOM!==!1,yi=c.KEEP_CONTENT!==!1,kt=c.IN_PLACE||!1,Ne=c.ALLOWED_URI_REGEXP||Ne,Qt=c.NAMESPACE||Te,c.CUSTOM_ELEMENT_HANDLING&&xr(c.CUSTOM_ELEMENT_HANDLING.tagNameCheck)&&(U.tagNameCheck=c.CUSTOM_ELEMENT_HANDLING.tagNameCheck),c.CUSTOM_ELEMENT_HANDLING&&xr(c.CUSTOM_ELEMENT_HANDLING.attributeNameCheck)&&(U.attributeNameCheck=c.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),c.CUSTOM_ELEMENT_HANDLING&&typeof c.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements=="boolean"&&(U.allowCustomizedBuiltInElements=c.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements),rt=is.indexOf(c.PARSER_MEDIA_TYPE)===-1?rt=rs:rt=c.PARSER_MEDIA_TYPE,Pe=rt==="application/xhtml+xml"?function(g){return g}:ti,Je&&(gi=!1),Wt&&(et=!0),tt&&(V=M({},he(aa)),W=[],tt.html===!0&&(M(V,ra),M(W,sa)),tt.svg===!0&&(M(V,zi),M(W,Ui),M(W,Xt)),tt.svgFilters===!0&&(M(V,Pi),M(W,Ui),M(W,Xt)),tt.mathMl===!0&&(M(V,Bi),M(W,oa),M(W,Xt))),c.ADD_TAGS&&(V===Xe&&(V=He(V)),M(V,c.ADD_TAGS)),c.ADD_ATTR&&(W===Ze&&(W=He(W)),M(W,c.ADD_ATTR)),c.ADD_URI_SAFE_ATTR&&M(wi,c.ADD_URI_SAFE_ATTR),c.FORBID_CONTENTS&&(it===yr&&(it=He(it)),M(it,c.FORBID_CONTENTS)),yi&&(V["#text"]=!0),ze&&M(V,["html","head","body"]),V.table&&(M(V,["tbody"]),delete ke.tbody),ee&&ee(c),at=c)},Cr=M({},["mi","mo","mn","ms","mtext"]),_r=M({},["foreignobject","desc","title","annotation-xml"]),ss=M({},["title","style","font","a","script"]),Gt=M({},zi);M(Gt,Pi),M(Gt,Po);var _i=M({},Bi);M(_i,Bo);var os=function(c){var g=R(c);(!g||!g.tagName)&&(g={namespaceURI:Te,tagName:"template"});var S=ti(c.tagName),I=ti(g.tagName);return c.namespaceURI===$i?g.namespaceURI===Te?S==="svg":g.namespaceURI===Si?S==="svg"&&(I==="annotation-xml"||Cr[I]):Boolean(Gt[S]):c.namespaceURI===Si?g.namespaceURI===Te?S==="math":g.namespaceURI===$i?S==="math"&&_r[I]:Boolean(_i[S]):c.namespaceURI===Te?g.namespaceURI===$i&&!_r[I]||g.namespaceURI===Si&&!Cr[I]?!1:!_i[S]&&(ss[S]||!Gt[S]):!1},we=function(c){Et(e.removed,{element:c});try{c.parentNode.removeChild(c)}catch{try{c.outerHTML=Y}catch{c.remove()}}},kr=function(c,g){try{Et(e.removed,{attribute:g.getAttributeNode(c),from:g})}catch{Et(e.removed,{attribute:null,from:g})}if(g.removeAttribute(c),c==="is"&&!W[c])if(et||Wt)try{we(g)}catch{}else try{g.setAttribute(c,"")}catch{}},Tr=function(c){var g,S;if(bi)c="<remove></remove>"+c;else{var I=Ro(c,/^[\r\n\t ]+/);S=I&&I[0]}rt==="application/xhtml+xml"&&(c='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+c+"</body></html>");var ie=N?N.createHTML(c):c;if(Qt===Te)try{g=new f().parseFromString(ie,rt)}catch{}if(!g||!g.documentElement){g=ge.createDocument(Qt,"template",null);try{g.documentElement.innerHTML=xi?"":ie}catch{}}var X=g.body||g.documentElement;return c&&S&&X.insertBefore(i.createTextNode(S),X.childNodes[0]||null),Qt===Te?St.call(g,ze?"html":"body")[0]:ze?g.documentElement:X},Dr=function(c){return yt.call(c.ownerDocument||c,c,d.SHOW_ELEMENT|d.SHOW_COMMENT|d.SHOW_TEXT,null,!1)},ns=function(c){return c instanceof v&&(typeof c.nodeName!="string"||typeof c.textContent!="string"||typeof c.removeChild!="function"||!(c.attributes instanceof u)||typeof c.removeAttribute!="function"||typeof c.setAttribute!="function"||typeof c.namespaceURI!="string"||typeof c.insertBefore!="function")},Tt=function(c){return We(o)==="object"?c instanceof o:c&&We(c)==="object"&&typeof c.nodeType=="number"&&typeof c.nodeName=="string"},Se=function(c,g,S){!te[c]||Fo(te[c],function(I){I.call(e,g,S,at)})},Mr=function(c){var g;if(Se("beforeSanitizeElements",c,null),ns(c)||J(/[\u0080-\uFFFF]/,c.nodeName))return we(c),!0;var S=Pe(c.nodeName);if(Se("uponSanitizeElement",c,{tagName:S,allowedTags:V}),c.hasChildNodes()&&!Tt(c.firstElementChild)&&(!Tt(c.content)||!Tt(c.content.firstElementChild))&&J(/<[/\w]/g,c.innerHTML)&&J(/<[/\w]/g,c.textContent)||S==="select"&&J(/<template/i,c.innerHTML))return we(c),!0;if(!V[S]||ke[S]){if(!ke[S]&&Er(S)&&(U.tagNameCheck instanceof RegExp&&J(U.tagNameCheck,S)||U.tagNameCheck instanceof Function&&U.tagNameCheck(S)))return!1;if(yi&&!it[S]){var I=R(c)||c.parentNode,ie=A(c)||c.childNodes;if(ie&&I)for(var X=ie.length,K=X-1;K>=0;--K)I.insertBefore(k(ie[K],!0),E(c))}return we(c),!0}return c instanceof l&&!os(c)||(S==="noscript"||S==="noembed")&&J(/<\/no(script|embed)/i,c.innerHTML)?(we(c),!0):(Je&&c.nodeType===3&&(g=c.textContent,g=De(g,Re," "),g=De(g,Ie," "),c.textContent!==g&&(Et(e.removed,{element:c.cloneNode()}),c.textContent=g)),Se("afterSanitizeElements",c,null),!1)},Ar=function(c,g,S){if(br&&(g==="id"||g==="name")&&(S in i||S in as))return!1;if(!(gi&&!mi[g]&&J(xt,g))){if(!(gr&&J(Ct,g))){if(!W[g]||mi[g]){if(!(Er(c)&&(U.tagNameCheck instanceof RegExp&&J(U.tagNameCheck,c)||U.tagNameCheck instanceof Function&&U.tagNameCheck(c))&&(U.attributeNameCheck instanceof RegExp&&J(U.attributeNameCheck,g)||U.attributeNameCheck instanceof Function&&U.attributeNameCheck(g))||g==="is"&&U.allowCustomizedBuiltInElements&&(U.tagNameCheck instanceof RegExp&&J(U.tagNameCheck,S)||U.tagNameCheck instanceof Function&&U.tagNameCheck(S))))return!1}else if(!wi[g]){if(!J(Ne,De(S,qe,""))){if(!((g==="src"||g==="xlink:href"||g==="href")&&c!=="script"&&Io(S,"data:")===0&&wr[c])){if(!(fr&&!J(_t,De(S,qe,"")))){if(S)return!1}}}}}}return!0},Er=function(c){return c.indexOf("-")>0},Or=function(c){var g,S,I,ie;Se("beforeSanitizeAttributes",c,null);var X=c.attributes;if(!!X){var K={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:W};for(ie=X.length;ie--;){g=X[ie];var Yt=g,Z=Yt.name,Lr=Yt.namespaceURI;if(S=Z==="value"?g.value:No(g.value),I=Pe(Z),K.attrName=I,K.attrValue=S,K.keepAttr=!0,K.forceKeepAttr=void 0,Se("uponSanitizeAttribute",c,K),S=K.attrValue,!K.forceKeepAttr&&(kr(Z,c),!!K.keepAttr)){if(J(/\/>/i,S)){kr(Z,c);continue}Je&&(S=De(S,Re," "),S=De(S,Ie," "));var ds=Pe(c.nodeName);if(!!Ar(ds,I,S))try{Lr?c.setAttributeNS(Lr,Z,S):c.setAttribute(Z,S),ia(e.removed)}catch{}}}Se("afterSanitizeAttributes",c,null)}},ls=function C(c){var g,S=Dr(c);for(Se("beforeSanitizeShadowDOM",c,null);g=S.nextNode();)Se("uponSanitizeShadowNode",g,null),!Mr(g)&&(g.content instanceof r&&C(g.content),Or(g));Se("afterSanitizeShadowDOM",c,null)};return e.sanitize=function(C,c){var g,S,I,ie,X;if(xi=!C,xi&&(C="<!-->"),typeof C!="string"&&!Tt(C)){if(typeof C.toString!="function")throw Ni("toString is not a function");if(C=C.toString(),typeof C!="string")throw Ni("dirty is not a string, aborting")}if(!e.isSupported){if(We(a.toStaticHTML)==="object"||typeof a.toStaticHTML=="function"){if(typeof C=="string")return a.toStaticHTML(C);if(Tt(C))return a.toStaticHTML(C.outerHTML)}return C}if(fi||Ci(c),e.removed=[],typeof C=="string"&&(kt=!1),kt){if(C.nodeName){var K=Pe(C.nodeName);if(!V[K]||ke[K])throw Ni("root node is forbidden and cannot be sanitized in-place")}}else if(C instanceof o)g=Tr("<!---->"),S=g.ownerDocument.importNode(C,!0),S.nodeType===1&&S.nodeName==="BODY"||S.nodeName==="HTML"?g=S:g.appendChild(S);else{if(!et&&!Je&&!ze&&C.indexOf("<")===-1)return N&&jt?N.createHTML(C):C;if(g=Tr(C),!g)return et?null:jt?Y:""}g&&bi&&we(g.firstChild);for(var Yt=Dr(kt?C:g);I=Yt.nextNode();)I.nodeType===3&&I===ie||Mr(I)||(I.content instanceof r&&ls(I.content),Or(I),ie=I);if(ie=null,kt)return C;if(et){if(Wt)for(X=wt.call(g.ownerDocument);g.firstChild;)X.appendChild(g.firstChild);else X=g;return W.shadowroot&&(X=$t.call(t,X,!0)),X}var Z=ze?g.outerHTML:g.innerHTML;return ze&&V["!doctype"]&&g.ownerDocument&&g.ownerDocument.doctype&&g.ownerDocument.doctype.name&&J(Yo,g.ownerDocument.doctype.name)&&(Z="<!DOCTYPE "+g.ownerDocument.doctype.name+`>
`+Z),Je&&(Z=De(Z,Re," "),Z=De(Z,Ie," ")),N&&jt?N.createHTML(Z):Z},e.setConfig=function(C){Ci(C),fi=!0},e.clearConfig=function(){at=null,fi=!1},e.isValidAttribute=function(C,c,g){at||Ci({});var S=Pe(C),I=Pe(c);return Ar(S,I,g)},e.addHook=function(C,c){typeof c=="function"&&(te[C]=te[C]||[],Et(te[C],c))},e.removeHook=function(C){if(te[C])return ia(te[C])},e.removeHooks=function(C){te[C]&&(te[C]=[])},e.removeAllHooks=function(){te={}},e}var Rt=Va();function Wa(a){switch(a){case"date":return"Published";case"reviewdate":return"Reviewed";case"addeddate":return"Added";default:return"Archived"}}function ja(a){return a?`Archivist since ${a.getFullYear()}`:""}function ir(a,e="short",t="en-US"){if(!a)return"";const i={timeZone:"UTC"};switch(e){case"short":i.month="short",i.year="numeric";break;case"long":i.year="numeric",i.month="short",i.day="2-digit";break}return new Intl.DateTimeFormat(t,i).format(a)}let ve=class extends B{constructor(){super(...arguments),this.sortParam=null,this.collectionLinks=[]}updated(e){e.has("model")&&this.fetchCollectionNames()}async fetchCollectionNames(){var e,t;if(!(!((e=this.model)===null||e===void 0)&&e.collections)||this.model.collections.length===0||!this.collectionNameCache)return;this.collectionLinks=[];const i=[],r=[];for(const s of this.model.collections)r.push((t=this.collectionNameCache)===null||t===void 0?void 0:t.collectionNameFor(s).then(o=>{i.push(this.detailsLink(s,o!=null?o:s))}));await Promise.all(r),this.collectionLinks=i}render(){return m`
    ...
    `}};n([p({type:Object})],ve.prototype,"model",void 0);n([p({type:String})],ve.prototype,"baseNavigationUrl",void 0);n([p({type:Object})],ve.prototype,"collectionNameCache",void 0);n([p({type:Number})],ve.prototype,"currentWidth",void 0);n([p({type:Number})],ve.prototype,"currentHeight",void 0);n([p({type:Object})],ve.prototype,"sortParam",void 0);n([p({type:Number})],ve.prototype,"mobileBreakpoint",void 0);n([D()],ve.prototype,"collectionLinks",void 0);n([p({type:String})],ve.prototype,"baseImageUrl",void 0);ve=n([G("tile-list")],ve);let _e=class extends B{constructor(){super(...arguments),this.sortParam=null}render(){var e,t,i,r,s,o,l,d,h,u,v;return m`
      <div id="list-line" class="${this.classSize}">
        ...
        <div id="creator">
          ${((r=this.model)===null||r===void 0?void 0:r.mediatype)==="account"?ja((s=this.model)===null||s===void 0?void 0:s.dateAdded):Rt.sanitize((l=(o=this.model)===null||o===void 0?void 0:o.creator)!==null&&l!==void 0?l:"")}
        </div>
    ...
    `}};n([p({type:Object})],vt.prototype,"model",void 0);n([p({type:Number})],vt.prototype,"currentWidth",void 0);n([p({type:Object})],vt.prototype,"sortParam",void 0);n([p({type:Number})],vt.prototype,"mobileBreakpoint",void 0);vt=n([G("tile-list-compact-header")],vt);let oe=class extends B{constructor(){super(...arguments),this.sortParam=null}render(){return m`
      <div id="container">
...
`;let q=class extends B{constructor(){super(...arguments),this.sortDirection=null,this.selectedSort=O.relevance,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.showRelevance=!0,this.alphaSelectorVisible=null,this.dateSortSelectorVisible=!1,this.desktopSelectorBarWidth=0,this.selectorBarContainerWidth=0,this.hoveringOverDateSortOptions=!1,this.boundDateSelectorEscapeListener=e=>{e.key==="Escape"&&(this.dateSortSelectorVisible=!1)}}render(){return m`
    ...
    `}getSortDisplayOption(e,t){var i,r;const s=(i=t==null?void 0:t.isSelected)!==null&&i!==void 0?i:()=>this.selectedSort===e,o=(r=t==null?void 0:t.displayName)!==null&&r!==void 0?r:Ot[e];return m`
      <a
        href="#"
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ca=dr(class extends cr{constructor(a){if(super(a),a.type!==Me.PROPERTY&&a.type!==Me.ATTRIBUTE&&a.type!==Me.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Gs(a))throw Error("`live` bindings can only contain a single expression")}render(a){return a}update(a,[e]){if(e===ce||e===_)return e;const t=a.element,i=a.name;if(a.type===Me.PROPERTY){if(e===t[i])return ce}else if(a.type===Me.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(i))return ce}else if(a.type===Me.ATTRIBUTE&&t.getAttribute(i)===e+"")return ce;return Na(a),e}});var Qa=60,Ga=Qa*60,Ya=Ga*24,tn=Ya*7,mt=1e3,Hi=Qa*mt,ha=Ga*mt,rn=Ya*mt,an=tn*mt,hr="millisecond",nt="second",lt="minute",dt="hour",Ae="day",ii="week",ue="month",Ka="quarter",Ee="year",ct="date",sn="YYYY-MM-DDTHH:mm:ssZ",ua="Invalid Date",on=/^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/,nn=/\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g,ln={name:"en",weekdays:"Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),months:"January_February_March_April_May_June_July_August_September_October_November_December".split("_")},rr=function(e,t,i){var r=String(e);return!r||r.length>=t?e:""+Array(t+1-r.length).join(i)+e},dn=function(e){var t=-e.utcOffset(),i=Math.abs(t),r=Math.floor(i/60),s=i%60;return(t<=0?"+":"-")+rr(r,2,"0")+":"+rr(s,2,"0")},cn=function a(e,t){if(e.date()<t.date())return-a(t,e);var i=(t.year()-e.year())*12+(t.month()-e.month()),r=e.clone().add(i,ue),s=t-r<0,o=e.clone().add(i+(s?-1:1),ue);return+(-(i+(t-r)/(s?r-o:o-r))||0)},hn=function(e){return e<0?Math.ceil(e)||0:Math.floor(e)},un=function(e){var t={M:ue,y:Ee,w:ii,d:Ae,D:ct,h:dt,m:lt,s:nt,ms:hr,Q:Ka};return t[e]||String(e||"").toLowerCase().replace(/s$/,"")},pn=function(e){return e===void 0},vn={s:rr,z:dn,m:cn,a:hn,p:un,u:pn},It="en",Ge={};Ge[It]=ln;var ur=function(e){return e instanceof vi},ci=function a(e,t,i){var r;if(!e)return It;if(typeof e=="string"){var s=e.toLowerCase();Ge[s]&&(r=s),t&&(Ge[s]=t,r=s);var o=e.split("-");if(!r&&o.length>1)return a(o[0])}else{var l=e.name;Ge[l]=e,r=l}return!i&&r&&(It=r),r||!i&&It},Q=function(e,t){if(ur(e))return e.clone();var i=typeof t=="object"?t:{};return i.date=e,i.args=arguments,new vi(i)},mn=function(e,t){return Q(e,{locale:t.$L,utc:t.$u,x:t.$x,$offset:t.$offset})},z=vn;z.l=ci;z.i=ur;z.w=mn;var gn=function(e){var t=e.date,i=e.utc;if(t===null)return new Date(NaN);if(z.u(t))return new Date;if(t instanceof Date)return new Date(t);if(typeof t=="string"&&!/Z$/i.test(t)){var r=t.match(on);if(r){var s=r[2]-1||0,o=(r[7]||"0").substring(0,3);return i?new Date(Date.UTC(r[1],s,r[3]||1,r[4]||0,r[5]||0,r[6]||0,o)):new Date(r[1],s,r[3]||1,r[4]||0,r[5]||0,r[6]||0,o)}}return new Date(t)},vi=function(){function a(t){this.$L=ci(t.locale,null,!0),this.parse(t)}var e=a.prototype;return e.parse=function(i){this.$d=gn(i),this.$x=i.x||{},this.init()},e.init=function(){var i=this.$d;this.$y=i.getFullYear(),this.$M=i.getMonth(),this.$D=i.getDate(),this.$W=i.getDay(),this.$H=i.getHours(),this.$m=i.getMinutes(),this.$s=i.getSeconds(),this.$ms=i.getMilliseconds()},e.$utils=function(){return z},e.isValid=function(){return this.$d.toString()!==ua},e.isSame=function(i,r){var s=Q(i);return this.startOf(r)<=s&&s<=this.endOf(r)},e.isAfter=function(i,r){return Q(i)<this.startOf(r)},e.isBefore=function(i,r){return this.endOf(r)<Q(i)},e.$g=function(i,r,s){return z.u(i)?this[r]:this.set(s,i)},e.unix=function(){return Math.floor(this.valueOf()/1e3)},e.valueOf=function(){return this.$d.getTime()},e.startOf=function(i,r){var s=this,o=z.u(r)?!0:r,l=z.p(i),d=function(A,R){var F=z.w(s.$u?Date.UTC(s.$y,R,A):new Date(s.$y,R,A),s);return o?F:F.endOf(Ae)},h=function(A,R){var F=[0,0,0,0],N=[23,59,59,999];return z.w(s.toDate()[A].apply(s.toDate("s"),(o?F:N).slice(R)),s)},u=this.$W,v=this.$M,f=this.$D,y="set"+(this.$u?"UTC":"");switch(l){case Ee:return o?d(1,0):d(31,11);case ue:return o?d(1,v):d(0,v+1);case ii:{var $=this.$locale().weekStart||0,k=(u<$?u+7:u)-$;return d(o?f-k:f+(6-k),v)}case Ae:case ct:return h(y+"Hours",0);case dt:return h(y+"Minutes",1);case lt:return h(y+"Seconds",2);case nt:return h(y+"Milliseconds",3);default:return this.clone()}},e.endOf=function(i){return this.startOf(i,!1)},e.$set=function(i,r){var s,o=z.p(i),l="set"+(this.$u?"UTC":""),d=(s={},s[Ae]=l+"Date",s[ct]=l+"Date",s[ue]=l+"Month",s[Ee]=l+"FullYear",s[dt]=l+"Hours",s[lt]=l+"Minutes",s[nt]=l+"Seconds",s[hr]=l+"Milliseconds",s)[o],h=o===Ae?this.$D+(r-this.$W):r;if(o===ue||o===Ee){var u=this.clone().set(ct,1);u.$d[d](h),u.init(),this.$d=u.set(ct,Math.min(this.$D,u.daysInMonth())).$d}else d&&this.$d[d](h);return this.init(),this},e.set=function(i,r){return this.clone().$set(i,r)},e.get=function(i){return this[z.p(i)]()},e.add=function(i,r){var s=this,o;i=Number(i);var l=z.p(r),d=function(f){var y=Q(s);return z.w(y.date(y.date()+Math.round(f*i)),s)};if(l===ue)return this.set(ue,this.$M+i);if(l===Ee)return this.set(Ee,this.$y+i);if(l===Ae)return d(1);if(l===ii)return d(7);var h=(o={},o[lt]=Hi,o[dt]=ha,o[nt]=mt,o)[l]||1,u=this.$d.getTime()+i*h;return z.w(u,this)},e.subtract=function(i,r){return this.add(i*-1,r)},e.format=function(i){var r=this,s=this.$locale();if(!this.isValid())return s.invalidDate||ua;var o=i||sn,l=z.z(this),d=this.$H,h=this.$m,u=this.$M,v=s.weekdays,f=s.months,y=s.meridiem,$=function(F,N,Y,se){return F&&(F[N]||F(r,o))||Y[N].slice(0,se)},k=function(F){return z.s(d%12||12,F,"0")},E=y||function(R,F,N){var Y=R<12?"AM":"PM";return N?Y.toLowerCase():Y},A={YY:String(this.$y).slice(-2),YYYY:this.$y,M:u+1,MM:z.s(u+1,2,"0"),MMM:$(s.monthsShort,u,f,3),MMMM:$(f,u),D:this.$D,DD:z.s(this.$D,2,"0"),d:String(this.$W),dd:$(s.weekdaysMin,this.$W,v,2),ddd:$(s.weekdaysShort,this.$W,v,3),dddd:v[this.$W],H:String(d),HH:z.s(d,2,"0"),h:k(1),hh:k(2),a:E(d,h,!0),A:E(d,h,!1),m:String(h),mm:z.s(h,2,"0"),s:String(this.$s),ss:z.s(this.$s,2,"0"),SSS:z.s(this.$ms,3,"0"),Z:l};return o.replace(nn,function(R,F){return F||A[R]||l.replace(":","")})},e.utcOffset=function(){return-Math.round(this.$d.getTimezoneOffset()/15)*15},e.diff=function(i,r,s){var o,l=z.p(r),d=Q(i),h=(d.utcOffset()-this.utcOffset())*Hi,u=this-d,v=z.m(this,d);return v=(o={},o[Ee]=v/12,o[ue]=v,o[Ka]=v/3,o[ii]=(u-h)/an,o[Ae]=(u-h)/rn,o[dt]=u/ha,o[lt]=u/Hi,o[nt]=u/mt,o)[l]||u,s?v:z.a(v)},e.daysInMonth=function(){return this.endOf(ue).$D},e.$locale=function(){return Ge[this.$L]},e.locale=function(i,r){if(!i)return this.$L;var s=this.clone(),o=ci(i,r,!0);return o&&(s.$L=o),s},e.clone=function(){return z.w(this.$d,this)},e.toDate=function(){return new Date(this.valueOf())},e.toJSON=function(){return this.isValid()?this.toISOString():null},e.toISOString=function(){return this.$d.toISOString()},e.toString=function(){return this.$d.toUTCString()},a}(),qa=vi.prototype;Q.prototype=qa;[["$ms",hr],["$s",nt],["$m",lt],["$H",dt],["$W",Ae],["$M",ue],["$y",Ee],["$D",ct]].forEach(function(a){qa[a[1]]=function(e){return this.$g(e,a[0],a[1])}});Q.extend=function(a,e){return a.$i||(a(e,vi,Q),a.$i=!0),Q};Q.locale=ci;Q.isDayjs=ur;Q.unix=function(a){return Q(a*1e3)};Q.en=Ge[It];Q.Ls=Ge;Q.p={};var fn=function(e){return e.replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g,function(t,i,r){return i||r.slice(1)})},bn={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"},yn=function(e,t){return e.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g,function(i,r,s){var o=s&&s.toUpperCase();return r||t[s]||bn[s]||fn(t[o])})},wn=/(\[[^[]*\])|([-:/.()\s]+)|(A|a|YYYY|YY?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g,Sn=/\d/,Zt=/\d\d/,$n=/\d{3}/,xn=/\d{4}/,be=/\d\d?/,Cn=/[+-]?\d+/,_n=/[+-]\d\d:?(\d\d)?|Z/,Lt=/\d*[^\s\d-_:/()]+/,Le={},Xa=function(e){return e=+e,e+(e>68?1900:2e3)};function kn(a){if(!a||a==="Z")return 0;var e=a.match(/([+-]|\d\d)/g),t=+(e[1]*60)+(+e[2]||0);return t===0?0:e[0]==="+"?-t:t}var re=function(e){return function(t){this[e]=+t}},pa=[_n,function(a){var e=this.zone||(this.zone={});e.offset=kn(a)}],Vi=function(e){var t=Le[e];return t&&(t.indexOf?t:t.s.concat(t.f))},va=function(e,t){var i,r=Le,s=r.meridiem;if(!s)i=e===(t?"pm":"PM");else for(var o=1;o<=24;o+=1)if(e.indexOf(s(o,0,t))>-1){i=o>12;break}return i},Tn={A:[Lt,function(a){this.afternoon=va(a,!1)}],a:[Lt,function(a){this.afternoon=va(a,!0)}],S:[Sn,function(a){this.milliseconds=+a*100}],SS:[Zt,function(a){this.milliseconds=+a*10}],SSS:[$n,function(a){this.milliseconds=+a}],s:[be,re("seconds")],ss:[be,re("seconds")],m:[be,re("minutes")],mm:[be,re("minutes")],H:[be,re("hours")],h:[be,re("hours")],HH:[be,re("hours")],hh:[be,re("hours")],D:[be,re("day")],DD:[Zt,re("day")],Do:[Lt,function(a){var e=Le,t=e.ordinal,i=a.match(/\d+/);if(this.day=i[0],!!t)for(var r=1;r<=31;r+=1)t(r).replace(/\[|\]/g,"")===a&&(this.day=r)}],M:[be,re("month")],MM:[Zt,re("month")],MMM:[Lt,function(a){var e=Vi("months"),t=Vi("monthsShort"),i=(t||e.map(function(r){return r.slice(0,3)})).indexOf(a)+1;if(i<1)throw new Error;this.month=i%12||i}],MMMM:[Lt,function(a){var e=Vi("months"),t=e.indexOf(a)+1;if(t<1)throw new Error;this.month=t%12||t}],Y:[Cn,re("year")],YY:[Zt,function(a){this.year=Xa(a)}],YYYY:[xn,re("year")],Z:pa,ZZ:pa};function Dn(a){var e=a.afternoon;if(e!==void 0){var t=a.hours;e?t<12&&(a.hours+=12):t===12&&(a.hours=0),delete a.afternoon}}function Mn(a){a=yn(a,Le&&Le.formats);for(var e=a.match(wn),t=e.length,i=0;i<t;i+=1){var r=e[i],s=Tn[r],o=s&&s[0],l=s&&s[1];l?e[i]={regex:o,parser:l}:e[i]=r.replace(/^\[|\]$/g,"")}return function(d){for(var h={},u=0,v=0;u<t;u+=1){var f=e[u];if(typeof f=="string")v+=f.length;else{var y=f.regex,$=f.parser,k=d.slice(v),E=y.exec(k),A=E[0];$.call(h,A),d=d.replace(A,"")}}return Dn(h),h}}var An=function(e,t,i){try{if(["x","X"].indexOf(t)>-1)return new Date((t==="X"?1e3:1)*e);var r=Mn(t),s=r(e),o=s.year,l=s.month,d=s.day,h=s.hours,u=s.minutes,v=s.seconds,f=s.milliseconds,y=s.zone,$=new Date,k=d||(!o&&!l?$.getDate():1),E=o||$.getFullYear(),A=0;o&&!l||(A=l>0?l-1:$.getMonth());var R=h||0,F=u||0,N=v||0,Y=f||0;return y?new Date(Date.UTC(E,A,k,R,F,N,Y+y.offset*60*1e3)):i?new Date(Date.UTC(E,A,k,R,F,N,Y)):new Date(E,A,k,R,F,N,Y)}catch{return new Date("")}},En=function(a,e,t){t.p.customParseFormat=!0,a&&a.parseTwoDigitYear&&(Xa=a.parseTwoDigitYear);var i=e.prototype,r=i.parse;i.parse=function(s){var o=s.date,l=s.utc,d=s.args;this.$u=l;var h=d[1];if(typeof h=="string"){var u=d[2]===!0,v=d[3]===!0,f=u||v,y=d[2];v&&(y=d[2]),Le=this.$locale(),!u&&y&&(Le=t.Ls[y]),this.$d=An(o,h,l),this.init(),y&&y!==!0&&(this.$L=this.locale(y).$L),f&&o!=this.format(h)&&(this.$d=new Date("")),Le={}}else if(h instanceof Array)for(var $=h.length,k=1;k<=$;k+=1){d[1]=h[k-1];var E=t.apply(this,d);if(E.isValid()){this.$d=E.$d,this.$L=E.$L,this.init();break}k===$&&(this.$d=new Date(""))}else r.call(this,s)}};const On=Object.freeze({processing:"processing",complete:"complete"});class Ln extends B{static get properties(){return{mode:{type:String}}}constructor(){super(),this.mode=On.processing}render(){return m`
      <div class="${this.mode}">
        <svg
          viewBox="0 0 120 120"
    ...
    `}get selectedRangeTemplate(){return L`
      ...
      />`}get histogramTemplate(){const e=this._histWidth/this._numBins,t=e-1;let i=this.sliderWidth;return this._histData.map(r=>{const s=L`
        ...
        />`;return i+=e,s})}formatDate(e){if(Number.isNaN(e))return"";const t=Q(e);return t.year()<1e3?String(t.year()):t.format(this.dateFormat)}get minInputTemplate(){return m`
      <input
        id="date-min"
...
`;const el=["mediatype","year","subject","collection","creator","language"],tl={subjectSorter:"subject",mediatypeSorter:"mediatype",languageSorter:"language",creatorSorter:"creator",collection:"collection",year:"year"},Sa={subject:"Subject",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"};let ae=class extends B{constructor(){super(...arguments),this.facetsLoading=!1,this.fullYearAggregationLoading=!1,this.collapsableFacets=!1,this.showHistogramDatePicker=!1,this.openFacets={subject:!1,mediatype:!1,language:!1,creator:!1,collection:!1,year:!1}}render(){return m`
    ...
    `}updated(e){e.has("selectedFacets")&&this.dispatchFacetsChangedEvent()}dispatchFacetsChangedEvent(){const e=new CustomEvent("facetsChanged",{detail:this.selectedFacets});this.dispatchEvent(e)}get currentYearsHistogramAggregation(){var e;return(e=this.aggregations)===null||e===void 0?void 0:e.year_histogram}get histogramTemplate(){const{fullYearsHistogramAggregation:e}=this;return m`
      ...
      ></histogram-date-range>
    `}histogramDateRangeUpdated(e){const{minDate:t,maxDate:i}=e.detail,r=new CustomEvent("histogramDateRangeUpdated",{detail:{minDate:t,maxDate:i}});this.dispatchEvent(r)}get mergedFacets(){const e=[];return el.forEach(t=>{var i;const r=this.selectedFacetGroups.find(d=>d.key===t),s=this.aggregationFacetGroups.find(d=>d.key===t);if(r&&!s){e.push(r);return}if(!s)return;const o=r!=null?r:s,l=(i=r==null?void 0:r.buckets.map(d=>{const h=s.buckets.find(u=>u.key===d.key);return h?Dt(fe({},d),{count:h.count}):d}))!==null&&i!==void 0?i:[];s.buckets.forEach(d=>{l.find(u=>u.key===d.key)||l.push(d)}),o.buckets=l.splice(0,5),e.push(o)}),e}get selectedFacetGroups(){return this.selectedFacets?Object.entries(this.selectedFacets).map(([t,i])=>{const r=t,s=Sa[r],o=Object.entries(i).map(([l,d])=>{var h,u;let v=l;return r==="language"&&(v=(u=(h=this.languageCodeHandler)===null||h===void 0?void 0:h.getLanguageNameFromCodeString(l))!==null&&u!==void 0?u:l),{displayText:v,key:l,count:0,state:d}});return{title:s,key:r,buckets:o}}):[]}get aggregationFacetGroups(){var e;const t=[];return Object.entries((e=this.aggregations)!==null&&e!==void 0?e:[]).forEach(([i,r])=>{if(i==="year_histogram")return;const s=this.getFacetOptionFromKey(i),o=Sa[s],d=r.buckets.map(u=>{var v,f;let y=u.key;return s==="language"&&(y=(f=(v=this.languageCodeHandler)===null||v===void 0?void 0:v.getCodeStringFromLanguageName(`${u.key}`))!==null&&f!==void 0?f:u.key),{displayText:`${u.key}`,key:`${y}`,count:u.doc_count,state:"none"}}),h={title:o,key:s,buckets:d};t.push(h)}),t}getFacetGroupTemplate(e){if(e.buckets.length===0)return _;const{key:t}=e,i=this.openFacets[t],r=m`
    ...
    `}getFacetTemplate(e){const i=e.buckets.filter(r=>r.key.startsWith("fav-")===!1).slice(0,6);return m`
      <ul class="facet-list">
        ${za(i,r=>`${e.key}:${r.key}`,r=>{var s,o;const l=`${e.key}:${r.key}-show-only`,d=`${e.key}:${r.key}-negative`,h=e.key!=="collection"?m`${(s=r.displayText)!==null&&s!==void 0?s:r.key}`:m`
                    <async-collection-name
                      .collectionNameCache=${this.collectionNameCache}
                      .identifier=${r.key}
                      placeholder="-"
                    ></async-collection-name>
                  `,u=r.state==="hidden",v=r.state==="selected",f=`${e.key}: ${(o=r.displayText)!==null&&o!==void 0?o:r.key}`,y=v?`Show all ${e.key}s`:`Only show ${f}`,$=`Hide ${f}`,k=`Unhide ${f}`,E=u?k:$;return m`
              <li>
                <div class="facet-row">
    ...
    `}facetClicked(e,t,i){const r=e.target,{checked:s,name:o,value:l}=r;s?this.facetChecked(o,l,i):this.facetUnchecked(o,l)}facetChecked(e,t,i){const{selectedFacets:r}=this;let s;r?s=fe({},r):s=li,s[e][t]=i?"hidden":"selected",this.selectedFacets=s}facetUnchecked(e,t){const{selectedFacets:i}=this;let r;i?r=fe({},i):r=li,delete r[e][t],this.selectedFacets=r}getFacetOptionFromKey(e){const r=e.split("__")[2].split(":")[1],s=Object.entries(tl).find(([l])=>r.includes(l)),o=s==null?void 0:s[1];if(!o)throw new Error(`Could not find facet option for key: ${e}`);return o}static get styles(){return b`
      #container.loading {
        opacity: 0.5;
      }
