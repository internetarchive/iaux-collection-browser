...
`+_e),Ot&&to([Ve,Y,ce],Ge=>{_e=wi(_e,Ge," ")}),P&&qi?P.createHTML(_e):_e},e.setConfig=function(){let L=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};Ho(L),Bo=!0},e.clearConfig=function(){Wt=null,Bo=!1},e.isValidAttribute=function(L,f,S){Wt||Ho({});const A=pe(L),X=pe(f);return Er(A,X,S)},e.addHook=function(L,f){typeof f=="function"&&yi(Q[L],f)},e.removeHook=function(L,f){if(f!==void 0){const S=jd(Q[L],f);return S===-1?void 0:Gd(Q[L],S,1)[0]}return ca(Q[L])},e.removeHooks=function(L){Q[L]=[]},e.removeAllHooks=function(){Q=ga()},e}var co=$n();let _o=class extends le{constructor(){super(...arguments),this.collectionLinks=[]}render(){return h`
    ...
    `}};n([c({type:Object})],_o.prototype,"collectionTitles",void 0);n([z()],_o.prototype,"collectionLinks",void 0);_o=n([B("tile-list")],_o);let Ne=class extends R{constructor(){super(...arguments),this.loggedIn=!1,this.suppressBlurring=!1}render(){return h`
      <div id="container">
        ${this.headerTemplate}
...
fill=""></path>
  ...
  `;n([c({type:String})],rt.prototype,"selectedLetter",void 0);n([c({type:Object})],rt.prototype,"letterCounts",void 0);n([c({type:String})],rt.prototype,"ariaLandmarkLabel",void 0);n([z()],rt.prototype,"tooltipShown",void 0);n([z()],rt.prototype,"hoveredLetter",void 0);n([G("alpha-bar-tooltip")],rt.prototype,"tooltip",void 0);rt=n([B("alpha-bar")],rt);const pc=h`
...
`;let ai=class extends R{constructor(){super(...arguments),this.step=2,this.currentPage=1,this.pages=[]}firstUpdated(){this.observePageCount()}updated(e){e.has("size")&&this.observePageCount(),e.has("currentPage")&&(this.observePageCount(),this.emitPageClick())}observePageCount(){this.pages=[];const e=7,t=this.size<=e;if(this.size<=5){this.pages=[...Array(this.size).keys()].map(r=>r+1);return}if(this.size===e){if(this.currentPage===2){this.pages=[1,2,3,4,0,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,4,5,this.size-1,this.size];return}}if(this.currentPage===1){this.pages=[1,2,3,0,this.size];return}if(this.currentPage===this.size){this.pages=[1,0,this.size-2,this.size-1,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,this.size-3,this.size-2,this.size-1,this.size];return}if(t&&this.currentPage>1&&this.currentPage<e){this.pages=[...Array(this.size).keys()].map(r=>r+1);return}let i=this.currentPage-this.step,o=this.currentPage+this.step;i<=0&&(o+=-i+1,i=1),o>=this.size&&(i=Math.max(i-(o-this.size),1),o=this.size),i===2&&(o-=1),o===this.size-1&&(i+=1),this.createFirstNode(i),this.createMiddelNode(i,o),this.createLastNode(o)}createFirstNode(e){var t,i;e>1&&((t=this.pages)===null||t===void 0||t.push(1)),e>2&&((i=this.pages)===null||i===void 0||i.push(0))}createMiddelNode(e,t){var i;for(let o=e;o<=t;o+=1)(i=this.pages)===null||i===void 0||i.push(o)}createLastNode(e){var t,i;e<this.size-1&&((t=this.pages)===null||t===void 0||t.push(0)),e<this.size&&((i=this.pages)===null||i===void 0||i.push(this.size))}get getEllipsisTemplate(){return h`<i class="ellipses">...</i>`}emitPageClick(){this.dispatchEvent(new CustomEvent("pageNumberClicked",{detail:{page:this.currentPage},bubbles:!0,composed:!0}))}onRewind(){this.currentPage-=1,this.currentPage<1&&(this.currentPage=1)}onForward(){this.currentPage+=1,this.currentPage>this.size&&(this.currentPage=this.size)}onChange(e){this.currentPage=e}getPageTemplate(e){return h`
    ...
    `}static get styles(){return[at,m`
      ...
      `]}};n([c({type:Number})],ai.prototype,"size",void 0);n([c({type:Number})],ai.prototype,"step",void 0);n([c({type:Number})],ai.prototype,"currentPage",void 0);n([z()],ai.prototype,"pages",void 0);ai=n([B("more-facets-pagination")],ai);const H0=O`
...
`;function J0(s){return s&&s.charAt(0).toLocaleUpperCase()+s.slice(1)}let Hi=class extends R{constructor(){super(...arguments),this.selected=!1}render(){var e,t;if(!this.facetInfo)return b;const i=this.facetInfo.facets.length===1,o=this.facetInfo.facets[0],r=J0((this.labelPrefix?`${this.labelPrefix} `:"")+((t=(e=this.facetInfo.label)!==null&&e!==void 0?e:o.displayText)!==null&&t!==void 0?t:o.bucketKey));if(!r)return b;const a=i&&o.facetType==="mediatype"?bn[o.bucketKey].icon:b;return h`
    ...
    `}get tileBlurringToggleTemplate(){const{sessionContext:e}=this.dataSource;if(!(e!=null&&e.is_archive_user))return b;const t=e==null?void 0:e.pps_relevant_user_preferences,i=(t==null?void 0:t.display__blur_moderated_content)==="on";return h`
    ...
    `}tileBlurringChanged(e){var t;const{checked:i}=e.target;this.tileBlurringEnabled=i,(t=this.infiniteScroller)===null||t===void 0||t.refreshAllVisibleCells()}get manageBarTemplate(){const e=this.profileElement==="uploads"?"Note: it may take a few minutes for these items to stop appearing in your uploads list.":b;return h`
      <manage-bar
