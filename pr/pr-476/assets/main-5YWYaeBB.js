...
`;var Ks;let Ui=Ks=class extends B{render(){return h`${this.facetRowTemplate}`}get facetRowTemplate(){var e,t,i,o;const{bucket:a,facetType:r}=this;if(!a||!r)return b;const l=`${r}:${a.key}-show-only`,c=`${r}:${a.key}-negative`,u=a.extraNote?h`<span class="facet-note">${a.extraNote}</span>`:b,p=r!=="collection"?h`${(e=a.displayText)!==null&&e!==void 0?e:a.key} ${u}`:h`<a href="/details/${a.key}">
    ...
    `}partOfCollectionClicked(e){var t;(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:Qe.default,action:ee.partOfCollectionClicked,label:e.target.dataset.id})}get histogramProps(){var e,t,i,o,a,r;const{histogramAggregation:l}=this;if(!l)return;const c=(e=l.first_bucket_year)!==null&&e!==void 0?e:l.first_bucket_key,u=(t=l.last_bucket_year)!==null&&t!==void 0?t:l.last_bucket_key;if(!c||!u)return;const p=(i=l.first_bucket_month)!==null&&i!==void 0?i:1,m=(o=l.last_bucket_month)!==null&&o!==void 0?o:12,v=(a=l.interval)!==null&&a!==void 0?a:1,y=(r=l.interval_in_months)!==null&&r!==void 0?r:12,x=E=>E.toString().padStart(2,"0"),w=this.isTvSearch?`${c}-${x(p)}`:`${c}`,C=this.isTvSearch?`${u}-${x(m+y-1)}`:`${u+v-1}`,D=this.isTvSearch&&y<12;return{buckets:l.buckets,dateFormat:this.isTvSearch?"YYYY-MM":"YYYY",tooltipDateFormat:D?"MMM YYYY":"YYYY",binSnapping:D?"month":"year",minDate:w,maxDate:C}}showDatePickerModal(){var e,t,i;const{histogramProps:o}=this;if(!o)return;const{buckets:a,dateFormat:r,tooltipDateFormat:l,binSnapping:c,minDate:u,maxDate:p}=o,v=h`
