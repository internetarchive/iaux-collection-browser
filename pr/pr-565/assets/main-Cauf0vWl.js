...
`;var Zg=Object.defineProperty,Jg=Object.getOwnPropertyDescriptor,ua=(i,e,t,s)=>{for(var r=s>1?void 0:s?Jg(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&Zg(e,t,r),r};function e6(i){return i&&i.charAt(0).toLocaleUpperCase()+i.slice(1)}let Vr=class extends H{constructor(){super(...arguments),this.selected=!1}render(){if(!this.facetInfo)return b;const i=this.facetInfo.facets.length===1,e=this.facetInfo.facets[0],t=e6((this.labelPrefix?`${this.labelPrefix} `:"")+(this.facetInfo.label??e.displayText??e.bucketKey));if(!t)return b;const s=i&&e.facetType==="mediatype"?P1[e.bucketKey].icon:b;return m`
  ...
  `;we([R()],ue.prototype,"toggleSlots",2);we([R()],ue.prototype,"currentPage",2);we([R()],ue.prototype,"searchQuery",2);we([R()],ue.prototype,"withinCollection",2);we([R()],ue.prototype,"cellWidth",2);we([R()],ue.prototype,"cellHeight",2);we([R()],ue.prototype,"rowGap",2);we([R()],ue.prototype,"colGap",2);we([R()],ue.prototype,"suppressFacets",2);we([R()],ue.prototype,"lazyLoadFacets",2);we([R()],ue.prototype,"loggedIn",2);we([R()],ue.prototype,"searchType",2);we([u({type:Object,reflect:!1})],ue.prototype,"latestAction",2);we([ee("#base-query-field")],ue.prototype,"baseQueryField",2);we([ee("#base-collection-field")],ue.prototype,"baseCollectionField",2);we([ee("#page-number-input")],ue.prototype,"pageNumberInput",2);we([ee("collection-browser")],ue.prototype,"collectionBrowser",2);we([ee("modal-manager")],ue.prototype,"modalManager",2);ue=we([N("app-root")],ue);
