...
`;let ea=class extends P{render(){var e,t,i;return f`
      <div id="container">
...
`;let Ce=class extends P{constructor(){super(...arguments),this.isListTile=!1,this.isCompactTile=!1,this.loggedIn=!1,this.isWaveform=!1}render(){return f`
...
`;function xs(r,e){let t=1;return r>=1e9?t=1e9:r>=1e6?t=1e6:r>=1e3&&e==="short"&&(t=1e3),t}function Ss(r=0,e){const t=r/e,i=t<10;let a=0;return i?a=Math.round((t+Number.EPSILON)*10)/10:a=Math.round(t),a}function $s(r,e,t,i){switch(e){case 1e9:return Ve(t==="short"?st`${r}B`:st`${r} billion`);case 1e6:return Ve(t==="short"?st`${r}M`:st`${r} million`);case 1e3:return Ve(t==="short"?st`${r}K`:st`${r} thousand`);default:return new Intl.NumberFormat(i).format(r)}}function Ft(r,e="long",t="short",i="en-US"){const a=r!=null?r:-1;if(a<0)return"";const o=xs(a,e),s=Ss(a,o);return $s(s,o,t,i)}let Ke=class extends P{render(){return f`
    ...
    `}};n([p({type:Object})],Wt.prototype,"model",void 0);n([p({type:String})],Wt.prototype,"baseImageUrl",void 0);n([p({type:Object})],Wt.prototype,"sortParam",void 0);Wt=n([W("item-tile")],Wt);let ta=class extends P{render(){var e,t,i,a,o,s,l,c;return f`
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*Pi(r,e){const t=typeof e=="function";if(r!==void 0){let i=-1;for(const a of r)i>-1&&(yield t?e(i):e),i++,yield a}}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`+Z),et&&(Z=Te(Z,Fe," "),Z=Te(Z,Re," ")),I&&Gt?I.createHTML(Z):Z},e.setConfig=function(C){ki(C),wi=!0},e.clearConfig=function(){ot=null,wi=!1},e.isValidAttribute=function(C,d,v){ot||ki({});var x=Pe(C),R=Pe(d);return Ea(x,R,v)},e.addHook=function(C,d){typeof d=="function"&&(te[C]=te[C]||[],Et(te[C],d))},e.removeHook=function(C){if(te[C])return rr(te[C])},e.removeHooks=function(C){te[C]&&(te[C]=[])},e.removeAllHooks=function(){te={}},e}var Rt=Vr();function Wr(r){switch(r){case"date":return"Published";case"reviewdate":return"Reviewed";case"addeddate":return"Added";default:return"Archived"}}function jr(r){return r?`Archivist since ${r.getFullYear()}`:""}let me=class extends P{constructor(){super(...arguments),this.sortParam=null,this.collectionLinks=[]}updated(e){e.has("model")&&this.fetchCollectionNames()}async fetchCollectionNames(){var e,t;if(!(!((e=this.model)===null||e===void 0)&&e.collections)||this.model.collections.length===0||!this.collectionNameCache)return;this.collectionLinks=[];const i=[],a=[];for(const o of this.model.collections)a.push((t=this.collectionNameCache)===null||t===void 0?void 0:t.collectionNameFor(o).then(s=>{i.push(this.detailsLink(o,s!=null?s:o))}));await Promise.all(a),this.collectionLinks=i}render(){return f`
    ...
    `:_}get volumeTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.volume,"Volume")}get issueTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.issue,"Issue")}get creatorTemplate(){var e,t,i;return((e=this.model)===null||e===void 0?void 0:e.mediatype)==="account"?f`
      ...
      <div id="creator" class="metadata">
        ...
        ${Pi(ir(this.model.creators,a=>this.searchLink("creator",a)),f`, `)}
      </div>
    ...
    `}};n([p({type:Object})],ft.prototype,"model",void 0);n([p({type:Number})],ft.prototype,"currentWidth",void 0);n([p({type:Object})],ft.prototype,"sortParam",void 0);n([p({type:Number})],ft.prototype,"mobileBreakpoint",void 0);ft=n([W("tile-list-compact-header")],ft);let se=class extends P{constructor(){super(...arguments),this.sortParam=null}render(){return f`
      <div id="container">
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const pr=ha(class extends pa{constructor(r){if(super(r),r.type!==De.PROPERTY&&r.type!==De.ATTRIBUTE&&r.type!==De.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Yo(r))throw Error("`live` bindings can only contain a single expression")}render(r){return r}update(r,[e]){if(e===de||e===_)return e;const t=r.element,i=r.name;if(r.type===De.PROPERTY){if(e===t[i])return de}else if(r.type===De.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(i))return de}else if(r.type===De.ATTRIBUTE&&t.getAttribute(i)===e+"")return de;return Pr(r),e}});var Qr=60,Gr=Qr*60,Yr=Gr*24,tn=Yr*7,vt=1e3,ji=Qr*vt,ur=Gr*vt,an=Yr*vt,rn=tn*vt,ua="millisecond",lt="second",ct="minute",dt="hour",Me="day",ri="week",pe="month",Kr="quarter",Ae="year",ht="date",on="YYYY-MM-DDTHH:mm:ssZ",mr="Invalid Date",sn=/^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/,nn=/\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g,ln={name:"en",weekdays:"Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),months:"January_February_March_April_May_June_July_August_September_October_November_December".split("_")},oa=function(e,t,i){var a=String(e);return!a||a.length>=t?e:""+Array(t+1-a.length).join(i)+e},cn=function(e){var t=-e.utcOffset(),i=Math.abs(t),a=Math.floor(i/60),o=i%60;return(t<=0?"+":"-")+oa(a,2,"0")+":"+oa(o,2,"0")},dn=function r(e,t){if(e.date()<t.date())return-r(t,e);var i=(t.year()-e.year())*12+(t.month()-e.month()),a=e.clone().add(i,pe),o=t-a<0,s=e.clone().add(i+(o?-1:1),pe);return+(-(i+(t-a)/(o?a-s:s-a))||0)},hn=function(e){return e<0?Math.ceil(e)||0:Math.floor(e)},pn=function(e){var t={M:pe,y:Ae,w:ri,d:Me,D:ht,h:dt,m:ct,s:lt,ms:ua,Q:Kr};return t[e]||String(e||"").toLowerCase().replace(/s$/,"")},un=function(e){return e===void 0},mn={s:oa,z:cn,m:dn,a:hn,p:pn,u:un},It="en",Ge={};Ge[It]=ln;var ma=function(e){return e instanceof gi},pi=function r(e,t,i){var a;if(!e)return It;if(typeof e=="string"){var o=e.toLowerCase();Ge[o]&&(a=o),t&&(Ge[o]=t,a=o);var s=e.split("-");if(!a&&s.length>1)return r(s[0])}else{var l=e.name;Ge[l]=e,a=l}return!i&&a&&(It=a),a||!i&&It},G=function(e,t){if(ma(e))return e.clone();var i=typeof t=="object"?t:{};return i.date=e,i.args=arguments,new gi(i)},fn=function(e,t){return G(e,{locale:t.$L,utc:t.$u,x:t.$x,$offset:t.$offset})},N=mn;N.l=pi;N.i=ma;N.w=fn;var vn=function(e){var t=e.date,i=e.utc;if(t===null)return new Date(NaN);if(N.u(t))return new Date;if(t instanceof Date)return new Date(t);if(typeof t=="string"&&!/Z$/i.test(t)){var a=t.match(sn);if(a){var o=a[2]-1||0,s=(a[7]||"0").substring(0,3);return i?new Date(Date.UTC(a[1],o,a[3]||1,a[4]||0,a[5]||0,a[6]||0,s)):new Date(a[1],o,a[3]||1,a[4]||0,a[5]||0,a[6]||0,s)}}return new Date(t)},gi=function(){function r(t){this.$L=pi(t.locale,null,!0),this.parse(t)}var e=r.prototype;return e.parse=function(i){this.$d=vn(i),this.$x=i.x||{},this.init()},e.init=function(){var i=this.$d;this.$y=i.getFullYear(),this.$M=i.getMonth(),this.$D=i.getDate(),this.$W=i.getDay(),this.$H=i.getHours(),this.$m=i.getMinutes(),this.$s=i.getSeconds(),this.$ms=i.getMilliseconds()},e.$utils=function(){return N},e.isValid=function(){return this.$d.toString()!==mr},e.isSame=function(i,a){var o=G(i);return this.startOf(a)<=o&&o<=this.endOf(a)},e.isAfter=function(i,a){return G(i)<this.startOf(a)},e.isBefore=function(i,a){return this.endOf(a)<G(i)},e.$g=function(i,a,o){return N.u(i)?this[a]:this.set(o,i)},e.unix=function(){return Math.floor(this.valueOf()/1e3)},e.valueOf=function(){return this.$d.getTime()},e.startOf=function(i,a){var o=this,s=N.u(a)?!0:a,l=N.p(i),c=function(M,F){var L=N.w(o.$u?Date.UTC(o.$y,F,M):new Date(o.$y,F,M),o);return s?L:L.endOf(Me)},h=function(M,F){var L=[0,0,0,0],I=[23,59,59,999];return N.w(o.toDate()[M].apply(o.toDate("s"),(s?L:I).slice(F)),o)},u=this.$W,m=this.$M,g=this.$D,b="set"+(this.$u?"UTC":"");switch(l){case Ae:return s?c(1,0):c(31,11);case pe:return s?c(1,m):c(0,m+1);case ri:{var S=this.$locale().weekStart||0,z=(u<S?u+7:u)-S;return c(s?g-z:g+(6-z),m)}case Me:case ht:return h(b+"Hours",0);case dt:return h(b+"Minutes",1);case ct:return h(b+"Seconds",2);case lt:return h(b+"Milliseconds",3);default:return this.clone()}},e.endOf=function(i){return this.startOf(i,!1)},e.$set=function(i,a){var o,s=N.p(i),l="set"+(this.$u?"UTC":""),c=(o={},o[Me]=l+"Date",o[ht]=l+"Date",o[pe]=l+"Month",o[Ae]=l+"FullYear",o[dt]=l+"Hours",o[ct]=l+"Minutes",o[lt]=l+"Seconds",o[ua]=l+"Milliseconds",o)[s],h=s===Me?this.$D+(a-this.$W):a;if(s===pe||s===Ae){var u=this.clone().set(ht,1);u.$d[c](h),u.init(),this.$d=u.set(ht,Math.min(this.$D,u.daysInMonth())).$d}else c&&this.$d[c](h);return this.init(),this},e.set=function(i,a){return this.clone().$set(i,a)},e.get=function(i){return this[N.p(i)]()},e.add=function(i,a){var o=this,s;i=Number(i);var l=N.p(a),c=function(g){var b=G(o);return N.w(b.date(b.date()+Math.round(g*i)),o)};if(l===pe)return this.set(pe,this.$M+i);if(l===Ae)return this.set(Ae,this.$y+i);if(l===Me)return c(1);if(l===ri)return c(7);var h=(s={},s[ct]=ji,s[dt]=ur,s[lt]=vt,s)[l]||1,u=this.$d.getTime()+i*h;return N.w(u,this)},e.subtract=function(i,a){return this.add(i*-1,a)},e.format=function(i){var a=this,o=this.$locale();if(!this.isValid())return o.invalidDate||mr;var s=i||on,l=N.z(this),c=this.$H,h=this.$m,u=this.$M,m=o.weekdays,g=o.months,b=o.meridiem,S=function(L,I,Y,oe){return L&&(L[I]||L(a,s))||Y[I].slice(0,oe)},z=function(L){return N.s(c%12||12,L,"0")},A=b||function(F,L,I){var Y=F<12?"AM":"PM";return I?Y.toLowerCase():Y},M={YY:String(this.$y).slice(-2),YYYY:this.$y,M:u+1,MM:N.s(u+1,2,"0"),MMM:S(o.monthsShort,u,g,3),MMMM:S(g,u),D:this.$D,DD:N.s(this.$D,2,"0"),d:String(this.$W),dd:S(o.weekdaysMin,this.$W,m,2),ddd:S(o.weekdaysShort,this.$W,m,3),dddd:m[this.$W],H:String(c),HH:N.s(c,2,"0"),h:z(1),hh:z(2),a:A(c,h,!0),A:A(c,h,!1),m:String(h),mm:N.s(h,2,"0"),s:String(this.$s),ss:N.s(this.$s,2,"0"),SSS:N.s(this.$ms,3,"0"),Z:l};return s.replace(nn,function(F,L){return L||M[F]||l.replace(":","")})},e.utcOffset=function(){return-Math.round(this.$d.getTimezoneOffset()/15)*15},e.diff=function(i,a,o){var s,l=N.p(a),c=G(i),h=(c.utcOffset()-this.utcOffset())*ji,u=this-c,m=N.m(this,c);return m=(s={},s[Ae]=m/12,s[pe]=m,s[Kr]=m/3,s[ri]=(u-h)/rn,s[Me]=(u-h)/an,s[dt]=u/ur,s[ct]=u/ji,s[lt]=u/vt,s)[l]||u,o?m:N.a(m)},e.daysInMonth=function(){return this.endOf(pe).$D},e.$locale=function(){return Ge[this.$L]},e.locale=function(i,a){if(!i)return this.$L;var o=this.clone(),s=pi(i,a,!0);return s&&(o.$L=s),o},e.clone=function(){return N.w(this.$d,this)},e.toDate=function(){return new Date(this.valueOf())},e.toJSON=function(){return this.isValid()?this.toISOString():null},e.toISOString=function(){return this.$d.toISOString()},e.toString=function(){return this.$d.toUTCString()},r}(),qr=gi.prototype;G.prototype=qr;[["$ms",ua],["$s",lt],["$m",ct],["$H",dt],["$W",Me],["$M",pe],["$y",Ae],["$D",ht]].forEach(function(r){qr[r[1]]=function(e){return this.$g(e,r[0],r[1])}});G.extend=function(r,e){return r.$i||(r(e,gi,G),r.$i=!0),G};G.locale=pi;G.isDayjs=ma;G.unix=function(r){return G(r*1e3)};G.en=Ge[It];G.Ls=Ge;G.p={};var gn=function(e){return e.replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g,function(t,i,a){return i||a.slice(1)})},yn={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"},bn=function(e,t){return e.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g,function(i,a,o){var s=o&&o.toUpperCase();return a||t[o]||yn[o]||gn(t[s])})},wn=/(\[[^[]*\])|([-:/.()\s]+)|(A|a|YYYY|YY?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g,xn=/\d/,ei=/\d\d/,Sn=/\d{3}/,$n=/\d{4}/,ye=/\d\d?/,Cn=/[+-]?\d+/,_n=/[+-]\d\d:?(\d\d)?|Z/,Lt=/\d*[^\s\d-_:/()]+/,Oe={},Xr=function(e){return e=+e,e+(e>68?1900:2e3)};function zn(r){if(!r||r==="Z")return 0;var e=r.match(/([+-]|\d\d)/g),t=+(e[1]*60)+(+e[2]||0);return t===0?0:e[0]==="+"?-t:t}var ae=function(e){return function(t){this[e]=+t}},fr=[_n,function(r){var e=this.zone||(this.zone={});e.offset=zn(r)}],Qi=function(e){var t=Oe[e];return t&&(t.indexOf?t:t.s.concat(t.f))},vr=function(e,t){var i,a=Oe,o=a.meridiem;if(!o)i=e===(t?"pm":"PM");else for(var s=1;s<=24;s+=1)if(e.indexOf(o(s,0,t))>-1){i=s>12;break}return i},kn={A:[Lt,function(r){this.afternoon=vr(r,!1)}],a:[Lt,function(r){this.afternoon=vr(r,!0)}],S:[xn,function(r){this.milliseconds=+r*100}],SS:[ei,function(r){this.milliseconds=+r*10}],SSS:[Sn,function(r){this.milliseconds=+r}],s:[ye,ae("seconds")],ss:[ye,ae("seconds")],m:[ye,ae("minutes")],mm:[ye,ae("minutes")],H:[ye,ae("hours")],h:[ye,ae("hours")],HH:[ye,ae("hours")],hh:[ye,ae("hours")],D:[ye,ae("day")],DD:[ei,ae("day")],Do:[Lt,function(r){var e=Oe,t=e.ordinal,i=r.match(/\d+/);if(this.day=i[0],!!t)for(var a=1;a<=31;a+=1)t(a).replace(/\[|\]/g,"")===r&&(this.day=a)}],M:[ye,ae("month")],MM:[ei,ae("month")],MMM:[Lt,function(r){var e=Qi("months"),t=Qi("monthsShort"),i=(t||e.map(function(a){return a.slice(0,3)})).indexOf(r)+1;if(i<1)throw new Error;this.month=i%12||i}],MMMM:[Lt,function(r){var e=Qi("months"),t=e.indexOf(r)+1;if(t<1)throw new Error;this.month=t%12||t}],Y:[Cn,ae("year")],YY:[ei,function(r){this.year=Xr(r)}],YYYY:[$n,ae("year")],Z:fr,ZZ:fr};function Tn(r){var e=r.afternoon;if(e!==void 0){var t=r.hours;e?t<12&&(r.hours+=12):t===12&&(r.hours=0),delete r.afternoon}}function Dn(r){r=bn(r,Oe&&Oe.formats);for(var e=r.match(wn),t=e.length,i=0;i<t;i+=1){var a=e[i],o=kn[a],s=o&&o[0],l=o&&o[1];l?e[i]={regex:s,parser:l}:e[i]=a.replace(/^\[|\]$/g,"")}return function(c){for(var h={},u=0,m=0;u<t;u+=1){var g=e[u];if(typeof g=="string")m+=g.length;else{var b=g.regex,S=g.parser,z=c.slice(m),A=b.exec(z),M=A[0];S.call(h,M),c=c.replace(M,"")}}return Tn(h),h}}var Mn=function(e,t,i){try{if(["x","X"].indexOf(t)>-1)return new Date((t==="X"?1e3:1)*e);var a=Dn(t),o=a(e),s=o.year,l=o.month,c=o.day,h=o.hours,u=o.minutes,m=o.seconds,g=o.milliseconds,b=o.zone,S=new Date,z=c||(!s&&!l?S.getDate():1),A=s||S.getFullYear(),M=0;s&&!l||(M=l>0?l-1:S.getMonth());var F=h||0,L=u||0,I=m||0,Y=g||0;return b?new Date(Date.UTC(A,M,z,F,L,I,Y+b.offset*60*1e3)):i?new Date(Date.UTC(A,M,z,F,L,I,Y)):new Date(A,M,z,F,L,I,Y)}catch{return new Date("")}},An=function(r,e,t){t.p.customParseFormat=!0,r&&r.parseTwoDigitYear&&(Xr=r.parseTwoDigitYear);var i=e.prototype,a=i.parse;i.parse=function(o){var s=o.date,l=o.utc,c=o.args;this.$u=l;var h=c[1];if(typeof h=="string"){var u=c[2]===!0,m=c[3]===!0,g=u||m,b=c[2];m&&(b=c[2]),Oe=this.$locale(),!u&&b&&(Oe=t.Ls[b]),this.$d=Mn(s,h,l),this.init(),b&&b!==!0&&(this.$L=this.locale(b).$L),g&&s!=this.format(h)&&(this.$d=new Date("")),Oe={}}else if(h instanceof Array)for(var S=h.length,z=1;z<=S;z+=1){c[1]=h[z-1];var A=t.apply(this,c);if(A.isValid()){this.$d=A.$d,this.$L=A.$L,this.init();break}z===S&&(this.$d=new Date(""))}else a.call(this,o)}};const En=Object.freeze({processing:"processing",complete:"complete"});class On extends P{static get properties(){return{mode:{type:String}}}constructor(){super(),this.mode=En.processing}render(){return f`
      <div class="${this.mode}">
        <svg
          viewBox="0 0 120 120"
...
`;let Q=class extends P{constructor(){super(...arguments),this.prompt="Do you find this feature useful?",this.buttonText="Beta",this.isOpen=!1,this.processing=!1,this.popupTopX=0,this.popupTopY=0,this.voteSubmitted=!1,this.voteNeedsChoosing=!1,this.resizingElement=document.body}render(){return f`
      <button
        id="beta-button"
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const n1=(r,e,t)=>{for(const i of e)if(i[0]===r)return(0,i[1])();return t==null?void 0:t()};var l1=O`
...
`;let mi=class extends P{constructor(){super(...arguments),this.placeholderType=null}render(){return this.placeholderType?f`${this.getPlaceholderTemplate}`:_}get getPlaceholderTemplate(){return f`
      <div
        class="placeholder ${this.placeholderType} ${this.isMobileView?"mobile":"desktop"}"
      >
        ${n1(this.placeholderType,[["empty-query",()=>this.emptyQueryTemplate],["null-result",()=>this.nullResultTemplate]])}
      </div>
    `}get emptyQueryTemplate(){return f`
      ...
      <div>${l1}</div>
    `}get nullResultTemplate(){return f`
      <h2 class="title">
    ...
    `}};n([p({type:String})],mi.prototype,"placeholderType",void 0);n([p({type:Boolean})],mi.prototype,"isMobileView",void 0);mi=n([W("empty-placeholder")],mi);let k=class extends P{constructor(){super(...arguments),this.baseImageUrl="https://archive.org",this.sortParam=null,this.selectedSort=E.relevance,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.sortDirection=null,this.pageSize=50,this.showHistogramDatePicker=!1,this.pageContext="search",this.restorationStateHandler=new o1({context:this.pageContext}),this.mobileBreakpoint=600,this.loggedIn=!1,this.isManageView=!1,this.initialPageNumber=1,this.pagesToRender=this.initialPageNumber,this.searchResultsLoading=!1,this.facetsLoading=!1,this.fullYearAggregationLoading=!1,this.mobileView=!1,this.mobileFacetsVisible=!1,this.placeholderType=null,this.languageCodeHandler=new s1,this.isScrollingToCell=!1,this.endOfDataReached=!1,this.isResizeToMobile=!1,this.placeholderCellTemplate=f`<collection-browser-loading-tile></collection-browser-loading-tile>`,this.dataSource={},this.initialQueryChangeHappened=!1,this.historyPopOccurred=!1,this.pageFetchesInProgress={}}tileModelAtCellIndex(e){var t;const i=Math.floor(e/this.pageSize)+1,a=e%this.pageSize,o=(t=this.dataSource[i])===null||t===void 0?void 0:t[a];return!o&&!this.isScrollingToCell&&this.fetchPage(i),o}get sortFilterQueries(){return[this.titleQuery,this.creatorQuery].filter(t=>t).join(" AND ")}get estimatedTileCount(){return this.pagesToRender*this.pageSize}get actualTileCount(){return Object.keys(this.dataSource).reduce((e,t)=>e+this.dataSource[t].length,0)}goToPage(e){this.initialPageNumber=e,this.pagesToRender=e,this.scrollToPage(e)}clearFilters(){this.selectedFacets=di,this.sortParam=null,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.titleQuery=void 0,this.creatorQuery=void 0,this.selectedSort=E.relevance,this.sortDirection=null}render(){return this.setPlaceholderType(),f`
    ...
    `}setPlaceholderType(){this.placeholderType=null,this.baseQuery||(this.placeholderType="empty-query"),!this.searchResultsLoading&&this.totalResults===0&&(this.placeholderType="null-result")}get emptyPlaceholderTemplate(){return f`
      <empty-placeholder
