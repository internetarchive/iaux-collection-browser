...
`;function xs(r,e){let t=1;return r>=1e9?t=1e9:r>=1e6?t=1e6:r>=1e3&&e==="short"&&(t=1e3),t}function Ss(r=0,e){const t=r/e,i=t<10;let a=0;return i?a=Math.round((t+Number.EPSILON)*10)/10:a=Math.round(t),a}function $s(r,e,t,i){switch(e){case 1e9:return Ve(t==="short"?st`${r}B`:st`${r} billion`);case 1e6:return Ve(t==="short"?st`${r}M`:st`${r} million`);case 1e3:return Ve(t==="short"?st`${r}K`:st`${r} thousand`);default:return new Intl.NumberFormat(i).format(r)}}function Ft(r,e="long",t="short",i="en-US"){const a=r!=null?r:-1;if(a<0)return"";const o=xs(a,e),s=Ss(a,o);return $s(s,o,t,i)}let Ke=class extends P{render(){return f`
    ...
    `}get creatorTemplate(){var e,t;return f`
      <div class="created-by truncated">
        ${!((e=this.model)===null||e===void 0)&&e.creator?f`<span>by&nbsp;${(t=this.model)===null||t===void 0?void 0:t.creator}</span>`:z}
      </div>
    `}static get styles(){return y`
      .container {
...
`;const e1=["mediatype","year","subject","collection","creator","language"],t1={subjectSorter:"subject",mediatypeSorter:"mediatype",languageSorter:"language",creatorSorter:"creator",collection:"collection",year:"year"},$r={subject:"Subject",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"};let re=class extends P{constructor(){super(...arguments),this.facetsLoading=!1,this.fullYearAggregationLoading=!1,this.collapsableFacets=!1,this.showHistogramDatePicker=!1,this.openFacets={subject:!1,mediatype:!1,language:!1,creator:!1,collection:!1,year:!1}}render(){return f`
    ...
    `}};Cr=n([W("circular-activity-indicator")],Cr);var i1=O`
...
`;let ui=class extends P{render(){return f`
    ...
    `}setEmptyPlaceholder(){this.emptyPlaceholder="",this.baseQuery||(this.emptyPlaceholder="no-search-term"),!this.searchResultsLoading&&this.totalResults===0&&(this.emptyPlaceholder="no-search-result")}get emptyPlaceholderTemplate(){return f`
      <empty-placeholder
