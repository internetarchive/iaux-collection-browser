...
`;function Ks(r,e){let t=1;return r>=1e9?t=1e9:r>=1e6?t=1e6:r>=1e3&&e==="short"&&(t=1e3),t}function qs(r=0,e){const t=r/e,i=t<10;let a=0;return i?a=Math.round((t+Number.EPSILON)*10)/10:a=Math.round(t),a}function Xs(r,e,t,i){switch(e){case 1e9:return Ze(t==="short"?gt`${r}B`:gt`${r} billion`);case 1e6:return Ze(t==="short"?gt`${r}M`:gt`${r} million`);case 1e3:return Ze(t==="short"?gt`${r}K`:gt`${r} thousand`);default:return new Intl.NumberFormat(i).format(r)}}function Zt(r,e="long",t="short",i="en-US"){const a=r!=null?r:-1;if(a<0)return"";const o=Ks(a,e),s=qs(a,o);return Xs(s,o,t,i)}let rt=class extends O{render(){const e=Zt(this.favCount,"short","short"),t=Zt(this.commentCount,"short","short"),i=this.mediatype==="account"?`${this.itemCount} uploads`:`${this.viewCount} all-time views`;return p`
    ...
    `}get creatorTemplate(){var e,t;return!((e=this.model)===null||e===void 0)&&e.creator?p`
      <div class="created-by">
        <span class="truncated">by&nbsp;${(t=this.model)===null||t===void 0?void 0:t.creator}</span>
      </div>
