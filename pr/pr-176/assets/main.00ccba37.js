 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ae={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Ni=r=>(...e)=>({_$litDirective$:r,values:e});class Bi{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}/**
 * @license
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*xi(r,e){const t=typeof e=="function";if(r!==void 0){let i=-1;for(const a of r)i>-1&&(yield t?e(i):e),i++,yield a}}let Ai=class extends O{constructor(){super(...arguments),this.snippets=[],this.viewSize="desktop"}render(){var e;return!((e=this.snippets)===null||e===void 0)&&e.length?p`
    ...
    `}};n([h({type:Array})],Ai.prototype,"snippets",void 0);n([h({type:String})],Ai.prototype,"viewSize",void 0);Ai=n([N("text-snippet-block")],Ai);const zs=y`
  .drop-shadow {
...
`+ne),dt&&(ne=Fe(ne,He," "),ne=Fe(ne,Ue," ")),B&&ui?B.createHTML(ne):ne},e.setConfig=function(C){Ki(C),Ui=!0},e.clearConfig=function(){vt=null,Ui=!1},e.isValidAttribute=function(C,u,b){vt||Ki({});var S=Qe(C),H=Qe(u);return ir(S,H,b)},e.addHook=function(C,u){typeof u=="function"&&(pe[C]=pe[C]||[],Kt(pe[C],u))},e.removeHook=function(C){if(pe[C])return Cr(pe[C])},e.removeHooks=function(C){pe[C]&&(pe[C]=[])},e.removeAllHooks=function(){pe={}},e}var Jt=go(),L;(function(r){r.relevance="relevance",r.alltimeview="alltimeview",r.weeklyview="weeklyview",r.title="title",r.datearchived="datearchived",r.date="date",r.datereviewed="datereviewed",r.dateadded="dateadded",r.creator="creator"})(L||(L={}));const Xe={relevance:"Relevance",alltimeview:"All-time Views",weeklyview:"Weekly Views",title:"Title",datearchived:"Date Archived",date:"Date Published",datereviewed:"Date Reviewed",dateadded:"Date Added",creator:"Creator"},An={relevance:null,alltimeview:"downloads",weeklyview:"week",title:"titleSorter",datearchived:"publicdate",date:"date",datereviewed:"reviewdate",dateadded:"addeddate",creator:"creatorSorter"},Ar={week:L.weeklyview,downloads:L.alltimeview,titleSorter:L.title,date:L.date,publicdate:L.datearchived,reviewdate:L.datereviewed,addeddate:L.dateadded,creatorSorter:L.creator},En={title:"firstTitle",creator:"firstCreator"},Li={subject:{},lending:{},mediatype:{},language:{},creator:{},collection:{},year:{}},Dn=["mediatype","lending","year","subject","collection","creator","language"],Fi={subject:"Subject",lending:"Availability",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"},Ln={is_lendable:!0,is_borrowable:!1,available_to_borrow:!0,is_browsable:!1,available_to_browse:!1,is_readable:!0,available_to_waitlist:!1},Er={is_lendable:"Lending Library",available_to_borrow:"Borrow 14 Days",is_readable:"Always Available"},Ra={deemphasize:!0,community:!0,stream_only:!0,samples_only:!0,test_collection:!0,printdisabled:!0,"openlibrary-ol":!0,nationalemergencylibrary:!0,china:!0,americana:!0,toronto:!0};function yo(r){switch(r){case"date":return"Published";case"reviewdate":return"Reviewed";case"addeddate":return"Added";default:return"Archived"}}function bo(r){return r?`Archivist since ${r.getFullYear()}`:""}let ye=class extends O{constructor(){super(...arguments),this.sortParam=null,this.collectionLinks=[],this.loggedIn=!1}updated(e){e.has("model")&&this.fetchCollectionNames()}async fetchCollectionNames(){var e,t;if(!(!((e=this.model)===null||e===void 0)&&e.collections)||this.model.collections.length===0||!this.collectionNameCache)return;this.collectionLinks=[];const i=[],a=[];for(const o of this.model.collections)!Ra[o]&&!o.startsWith("fav-")&&a.push((t=this.collectionNameCache)===null||t===void 0?void 0:t.collectionNameFor(o).then(s=>{i.push(this.detailsLink(o,s!=null?s:o))}));await Promise.all(a),this.collectionLinks=i}render(){return p`
    ...
    `}};n([h({type:Object})],At.prototype,"model",void 0);n([h({type:Number})],At.prototype,"currentWidth",void 0);n([h({type:Object})],At.prototype,"sortParam",void 0);n([h({type:Number})],At.prototype,"mobileBreakpoint",void 0);At=n([N("tile-list-compact-header")],At);let fe=class extends O{constructor(){super(...arguments),this.sortParam=null,this.loggedIn=!1}render(){return p`
      <div id="container">
