 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ys=(r,e)=>e.kind==="method"&&e.descriptor&&!("value"in e.descriptor)?mt(le({},e),{finisher(t){t.createProperty(e.key,r)}}):{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){typeof e.initializer=="function"&&(this[e.key]=e.initializer.call(this))},finisher(t){t.createProperty(e.key,r)}};function h(r){return(e,t)=>t!==void 0?((i,a,o)=>{a.constructor.createProperty(o,i)})(r,e,t):ys(r,e)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function z(r){return h(mt(le({},r),{state:!0}))}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const co=({finisher:r,descriptor:e})=>(t,i)=>{var a;if(i===void 0){const o=(a=t.originalKey)!==null&&a!==void 0?a:t.key,s=e!=null?{kind:"method",placement:"prototype",key:o,descriptor:e(t.key)}:mt(le({},t),{key:o});return r!=null&&(s.finisher=function(l){r(l,o)}),s}{const o=t.constructor;e!==void 0&&Object.defineProperty(t,i,e(i)),r==null||r(o,i)}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;let si=class extends O{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1,this.isCompactTile=!1}render(){return p`<div class="icon-overlay ${this.getClass}">
    ...
    `}static get styles(){const e=y`var(--tileBorderColor, #555555)`,t=y`var(--tileBackgroundColor, #666666)`,i=y`#fff`;return[Pa,y`
        .container {
          background-color: ${t};
          border: 1px solid ${e};
        }
...
`;let Ft=class extends O{facetClicked(e,t,i){const a=e.target,{checked:o,name:s,value:l}=a;o?this.facetChecked(s,l,t,i):this.facetUnchecked(s,l)}facetChecked(e,t,i,a){const{selectedFacets:o}=this;let s;o?s=le({},o):s=Li,s[e][t]={state:a?"hidden":"selected",count:i},this.selectedFacets=s,this.dispatchSelectedFacetsChanged()}facetUnchecked(e,t){const{selectedFacets:i}=this;let a;i?a=le({},i):a=Li,delete a[e][t],this.selectedFacets=a,this.dispatchSelectedFacetsChanged()}dispatchSelectedFacetsChanged(){const e=new CustomEvent("selectedFacetsChanged",{detail:this.selectedFacets,bubbles:!0,composed:!0});this.dispatchEvent(e)}getFacetsTemplate(e){let t=e==null?void 0:e.buckets;return t=[...t.filter(i=>i.state==="selected").sort((i,a)=>i.count<a.count?1:-1),...t.filter(i=>i.state==="hidden").sort((i,a)=>i.count<a.count?1:-1),...t.filter(i=>i.state==="none")],p`
    ...
    `}updated(e){e.has("selectedFacets")&&this.dispatchFacetsChangedEvent()}dispatchFacetsChangedEvent(){const e=new CustomEvent("facetsChanged",{detail:this.selectedFacets});this.dispatchEvent(e)}get currentYearsHistogramAggregation(){var e;return(e=this.aggregations)===null||e===void 0?void 0:e.year_histogram}get histogramTemplate(){const{fullYearsHistogramAggregation:e}=this;return this.fullYearAggregationLoading?p`<div class="histogram-loading-indicator">&hellip;</div>`:p`
          ...
          ></histogram-date-range>
        `}histogramDateRangeUpdated(e){const{minDate:t,maxDate:i}=e.detail,a=new CustomEvent("histogramDateRangeUpdated",{detail:{minDate:t,maxDate:i}});this.dispatchEvent(a)}get mergedFacets(){const e=[];return Dn.forEach(t=>{var i,a;const o=this.selectedFacetGroups.find(v=>v.key===t),s=this.aggregationFacetGroups.find(v=>v.key===t);if(o&&!s){e.push(o);return}if(!s)return;const l=o!=null?o:s;let d=(i=o==null?void 0:o.buckets.map(v=>{const m=s.buckets.find(f=>f.key===v.key);return m?mt(le({},v),{count:m.count}):v}))!==null&&i!==void 0?i:[];s.buckets.forEach(v=>{d.find(f=>f.key===v.key)||d.push(v)}),t==="lending"&&(d=d.filter(v=>Ln[v.key]));let c=(a=Object.keys((o==null?void 0:o.buckets)||[]))===null||a===void 0?void 0:a.length;c<this.allowedFacetCount&&(c=this.allowedFacetCount),l.buckets=d.splice(0,c),e.push(l)}),e}get selectedFacetGroups(){return this.selectedFacets?Object.entries(this.selectedFacets).map(([t,i])=>{const a=t,o=Fi[a],s=Object.entries(i).map(([l,d])=>{var c,v,m;let f=l;return a==="language"&&(f=(v=(c=this.languageCodeHandler)===null||c===void 0?void 0:c.getLanguageNameFromCodeString(l))!==null&&v!==void 0?v:l),a==="lending"&&(f=(m=Ar[l])!==null&&m!==void 0?m:l),{displayText:f,key:l,count:d.count,state:d.state}});return{title:o,key:a,buckets:s}}):[]}get aggregationFacetGroups(){var e;const t=[];return Object.entries((e=this.aggregations)!==null&&e!==void 0?e:[]).forEach(([i,a])=>{if(i==="year_histogram")return;const o=i,s=Fi[o];if(!s)return;let l=a.buckets;o==="collection"&&(l=l==null?void 0:l.filter(v=>{var m;const f=(m=v==null?void 0:v.key)===null||m===void 0?void 0:m.toString();return!Ra[f]&&!(f!=null&&f.startsWith("fav-"))}));const d=l.map(v=>{var m,f,w;let _=v.key,$=`${v.key}`;return o==="language"&&(_=(f=(m=this.languageCodeHandler)===null||m===void 0?void 0:m.getCodeStringFromLanguageName(`${v.key}`))!==null&&f!==void 0?f:v.key),o==="lending"&&($=(w=Ar[v.key])!==null&&w!==void 0?w:`${v.key}`),{displayText:$,key:`${_}`,count:v.doc_count,state:"none"}}),c={title:s,key:o,buckets:d};t.push(c)}),t}getFacetGroupTemplate(e){if(!this.facetsLoading&&e.buckets.length===0)return x;const{key:t}=e,i=this.openFacets[t],a=p`
