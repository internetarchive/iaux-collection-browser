 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ao=({finisher:r,descriptor:e})=>(t,i)=>{var a;if(i===void 0){const o=(a=t.originalKey)!==null&&a!==void 0?a:t.key,s=e!=null?{kind:"method",placement:"prototype",key:o,descriptor:e(t.key)}:ct(ve({},t),{key:o});return r!=null&&(s.finisher=function(l){r(l,o)}),s}{const o=t.constructor;e!==void 0&&Object.defineProperty(t,i,e(i)),r==null||r(o,i)}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;function js(r,e){let t=1;return r>=1e9?t=1e9:r>=1e6?t=1e6:r>=1e3&&e==="short"&&(t=1e3),t}function Ws(r=0,e){const t=r/e,i=t<10;let a=0;return i?a=Math.round((t+Number.EPSILON)*10)/10:a=Math.round(t),a}function Vs(r,e,t,i){switch(e){case 1e9:return Ke(t==="short"?ht`${r}B`:ht`${r} billion`);case 1e6:return Ke(t==="short"?ht`${r}M`:ht`${r} million`);case 1e3:return Ke(t==="short"?ht`${r}K`:ht`${r} thousand`);default:return new Intl.NumberFormat(i).format(r)}}function Vt(r,e="long",t="short",i="en-US"){const a=r!=null?r:-1;if(a<0)return"";const o=js(a,e),s=Ws(a,o);return Vs(s,o,t,i)}let et=class extends F{render(){return m`
...
`;let ki=class extends F{constructor(){super(...arguments),this.placeholderType=null}render(){return this.placeholderType?m`${this.placeholderTemplate}`:_}get placeholderTemplate(){return m`
  ...
  `;n([z()],re.prototype,"currentPage",void 0);n([z()],re.prototype,"searchQuery",void 0);n([z()],re.prototype,"cellWidth",void 0);n([z()],re.prototype,"cellHeight",void 0);n([z()],re.prototype,"rowGap",void 0);n([z()],re.prototype,"colGap",void 0);n([z()],re.prototype,"loggedIn",void 0);n([z()],re.prototype,"searchTarget",void 0);n([p({type:Object,reflect:!1})],re.prototype,"latestAction",void 0);n([de("#base-query-field")],re.prototype,"baseQueryField",void 0);n([de("#page-number-input")],re.prototype,"pageNumberInput",void 0);n([de("collection-browser")],re.prototype,"collectionBrowser",void 0);n([de("modal-manager")],re.prototype,"modalManager",void 0);re=n([N("app-root")],re);
