...
`+fe),mt&&(fe=Ge(fe,Je," "),fe=Ge(fe,et," ")),O&&xi?O.createHTML(fe):fe},e.setConfig=function(M){no(M),to=!0},e.clearConfig=function(){xt=null,to=!1},e.isValidAttribute=function(M,v,x){xt||no({});var C=ot(M),V=ot(v);return Hr(C,V,x)},e.addHook=function(M,v){typeof v=="function"&&(ye[M]=ye[M]||[],ei(ye[M],v))},e.removeHook=function(M){if(ye[M])return fa(ye[M])},e.removeHooks=function(M){ye[M]&&(ye[M]=[])},e.removeAllHooks=function(){ye={}},e}var Di=Es();let ji=class extends ne{constructor(){super(...arguments),this.collectionLinks=[]}render(){return c`
    ...
    `}};l([h({type:Object})],ji.prototype,"collectionTitles",void 0);l([z()],ji.prototype,"collectionLinks",void 0);ji=l([D("tile-list")],ji);let Ye=class extends F{constructor(){super(...arguments),this.loggedIn=!1}render(){return c`
      <div id="container">
        <tile-list
          .model=${this.model}
...
`,ur;let Nt=ur=class extends F{render(){return c`${this.facetRowTemplate}`}get facetRowTemplate(){var e,t,i,o;const{bucket:a,facetType:s}=this;if(!a||!s)return y;const n=`${s}:${a.key}-show-only`,d=`${s}:${a.key}-negative`,p=s!=="collection"?c`${(e=a.displayText)!==null&&e!==void 0?e:a.key}`:c`<a href="/details/${a.key}">
    ...
    `}applySearchFacetsClicked(){var e,t;const i=new CustomEvent("facetsChanged",{detail:this.selectedFacets,bubbles:!0,composed:!0});this.dispatchEvent(i),(e=this.modalManager)===null||e===void 0||e.closeModal(),(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:De.default,action:`${X.applyMoreFacetsModal}`,label:`${this.facetKey}`})}cancelClick(){var e,t;(e=this.modalManager)===null||e===void 0||e.closeModal(),(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:De.default,action:X.closeMoreFacetsModal,label:`${this.facetKey}`})}static get styles(){const e=m`var(--primaryButtonBGColor, #194880)`;return[We,m`
      ...
      `]}};l([h({type:String})],re.prototype,"facetKey",void 0);l([h({type:String})],re.prototype,"facetAggregationKey",void 0);l([h({type:String})],re.prototype,"query",void 0);l([h({type:Object})],re.prototype,"filterMap",void 0);l([h({type:Object})],re.prototype,"modalManager",void 0);l([h({type:Object})],re.prototype,"searchService",void 0);l([h({type:String})],re.prototype,"searchType",void 0);l([h({type:Object})],re.prototype,"pageSpecifierParams",void 0);l([h({type:Object})],re.prototype,"collectionTitles",void 0);l([h({type:Object})],re.prototype,"selectedFacets",void 0);l([h({type:String})],re.prototype,"sortedBy",void 0);l([h({type:Object,attribute:!1})],re.prototype,"analyticsHandler",void 0);l([z()],re.prototype,"aggregations",void 0);l([z()],re.prototype,"facetGroup",void 0);l([z()],re.prototype,"facetGroupTitle",void 0);l([z()],re.prototype,"pageNumber",void 0);l([z()],re.prototype,"facetsLoading",void 0);l([z()],re.prototype,"paginationSize",void 0);l([z()],re.prototype,"facetsType",void 0);re=l([D("more-facets-content")],re);let Xa=class extends F{render(){return c`
      <div id="row">
