 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function pe(r,e){return lo({descriptor:t=>{const i={get(){var a,o;return(o=(a=this.renderRoot)===null||a===void 0?void 0:a.querySelector(r))!==null&&o!==void 0?o:null},enumerable:!0,configurable:!0};if(e){const a=typeof t=="symbol"?Symbol():"__"+t;i.get=function(){var o,s;return this[a]===void 0&&(this[a]=(s=(o=this.renderRoot)===null||o===void 0?void 0:o.querySelector(r))!==null&&s!==void 0?s:null),this[a]}}return i}})}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */const xr=(r,e,t)=>{const i=new Map;for(let a=e;a<=t;a++)i.set(r[a],a);return i},ho=Ri(class extends Ni{constructor(r){if(super(r),r.type!==Ee.CHILD)throw Error("repeat() can only be used in text expressions")}dt(r,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);const a=[],o=[];let s=0;for(const l of r)a[s]=i?i(l,s):s,o[s]=t(l,s),s++;return{values:o,keys:a}}render(r,e,t){return this.dt(r,e,t).values}update(r,[e,t,i]){var a;const o=Cs(r),{values:s,keys:l}=this.dt(e,t,i);if(!Array.isArray(o))return this.ut=l,s;const d=(a=this.ut)!==null&&a!==void 0?a:this.ut=[],c=[];let m,v,f=0,w=o.length-1,x=0,$=s.length-1;for(;f<=w&&x<=$;)if(o[f]===null)f++;else if(o[w]===null)w--;else if(d[f]===l[x])c[x]=Ye(o[f],s[x]),f++,x++;else if(d[w]===l[$])c[$]=Ye(o[w],s[$]),w--,$--;else if(d[f]===l[$])c[$]=Ye(o[f],s[$]),Kt(r,c[$+1],o[f]),f++,$--;else if(d[w]===l[x])c[x]=Ye(o[w],s[x]),Kt(r,o[f],o[w]),w--,x++;else if(m===void 0&&(m=xr(l,x,$),v=xr(d,f,w)),m.has(d[f]))if(m.has(d[w])){const E=v.get(l[x]),A=E!==void 0?o[E]:null;if(A===null){const F=Kt(r,o[f]);Ye(F,s[x]),c[x]=F}else c[x]=Ye(A,s[x]),Kt(r,o[f],A),o[E]=null;x++}else oa(o[w]),w--;else oa(o[f]),f++;for(;x<=$;){const E=Kt(r,c[$+1]);Ye(E,s[x]),c[x++]=E}for(;f<=w;){const E=o[f++];E!==null&&oa(E)}return this.ut=l,co(r,c),ge}});function fi(r,e,t){return Array.from({length:(e-r)/t+1},(i,a)=>r+a*t)}let Ne=class extends O{constructor(){super(...arguments),this.itemCount=0,this.scrollOptimizationsDisabled=!1,this.intersectionObserver=new IntersectionObserver(e=>{e.forEach(t=>{if(t.target===this.sentinel){t.isIntersecting&&this.dispatchEvent(new Event("scrollThresholdReached"));return}const a=t.target.dataset.cellIndex;if(!a)return;const o=parseInt(a,10);t.isIntersecting?this.visibleCellIndices.add(o):this.visibleCellIndices.delete(o)}),this.scrollOptimizationsDisabled||this.processVisibleCells()}),this.renderedCellIndices=new Set,this.visibleCellIndices=new Set,this.placeholderCellIndices=new Set}reload(){fi(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.removeCell(t)),this.renderedCellIndices.clear(),this.visibleCellIndices.clear(),this.placeholderCellIndices.clear(),this.setupObservations()}scrollToCell(e,t){const i=this.cellContainers[e];if(!i)return!1;const a=t?"smooth":"auto";return i.scrollIntoView({behavior:a}),!0}getVisibleCellIndices(){return Array.from(this.visibleCellIndices)}updated(e){(e.has("itemCount")||e.has("scrollOptimizationsDisabled"))&&this.setupObservations()}disconnectedCallback(){this.intersectionObserver.disconnect()}setupObservations(){this.setupIntersectionObserver()}setupIntersectionObserver(){this.intersectionObserver.disconnect(),this.sentinel&&this.intersectionObserver.observe(this.sentinel),this.scrollOptimizationsDisabled?(fi(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.visibleCellIndices.add(t)),this.processVisibleCells()):this.cellContainers.forEach(e=>this.intersectionObserver.observe(e))}render(){const e=this.itemCount-1,t=fi(0,e,1);return u`
    ...
    `}};n([h({type:Number})],Ne.prototype,"itemCount",void 0);n([h({type:Object})],Ne.prototype,"cellProvider",void 0);n([h({type:Object})],Ne.prototype,"placeholderCellTemplate",void 0);n([h({type:Boolean})],Ne.prototype,"scrollOptimizationsDisabled",void 0);n([pe("#sentinel")],Ne.prototype,"sentinel",void 0);n([bs(".cell-container")],Ne.prototype,"cellContainers",void 0);Ne=n([N("infinite-scroller")],Ne);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;let xa=class extends O{render(){var e,t,i;return u`
      <div id="container">
    ...
    `}};n([h({type:Object})],xa.prototype,"model",void 0);xa=n([N("collection-tile")],xa);function zi(r,e="short",t="en-US"){if(!r)return"";const i={timeZone:"UTC"};switch(e){case"short":i.month="short",i.year="numeric";break;case"long":i.year="numeric",i.month="short",i.day="2-digit";break}return new Intl.DateTimeFormat(t,i).format(r)}const Ds=y`var(--collectionTileCornerRadius, 4px)`,Ls=y`var(--tileBackgroundColor, #ffffff)`,uo=y`
  .container {
    background-color: ${Ls};
    border: 1px #2c2c2c;
    border-radius: ${Ds};
...
`;let si=class extends O{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1,this.isCompactTile=!1}render(){return u`<div class="icon-overlay ${this.getClass}">
      ${this.iconDisplay}
    </div>`}get getClass(){return this.isCompactTile?"list-compact":"list-detail"}get iconDisplay(){return this.loginRequired&&!this.loggedIn?u`${vo}`:u`${mo}`}static get styles(){return y`
      :host {
        position: absolute;
        top: 50%;
        left: 50%;
    ...
    `}};n([h({type:Boolean})],si.prototype,"loggedIn",void 0);n([h({type:Boolean})],si.prototype,"loginRequired",void 0);n([h({type:Boolean})],si.prototype,"isCompactTile",void 0);si=n([N("icon-overlay")],si);let ni=class extends O{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1,this.iconRequired=!1}render(){return u`
      <div class="overlay no-preview">
        <div class="icon-overlay">${this.iconDisplay}</div>
        <p class="text-overlay">${this.textDisplay}</p>
      </div>
    `}get iconDisplay(){return this.loginRequired&&!this.loggedIn?u`${vo}`:u`${mo}`}get textDisplay(){return this.loginRequired&&!this.loggedIn?u`Log in to view this item`:u`Content may be inappropriate`}static get styles(){return y`
      :host {
        align-items: center;
        display: flex;
      }
    ...
    `}};n([h({type:Boolean})],ni.prototype,"loggedIn",void 0);n([h({type:Boolean})],ni.prototype,"loginRequired",void 0);n([h({type:Boolean})],ni.prototype,"iconRequired",void 0);ni=n([N("text-overlay")],ni);let Be=class extends O{constructor(){super(...arguments),this.isCompactTile=!1,this.isListTile=!1,this.loggedIn=!1,this.viewSize="desktop"}render(){var e;return!((e=this.model)===null||e===void 0)&&e.identifier?u`
    ...
    `:_}get baseClass(){return{list:this.isListTile&&!this.isCompactTile,"list-compact":this.isListTile&&this.isCompactTile,[this.viewSize]:!0}}get iconOverlayTemplate(){var e,t,i;return!this.isListTile||!(!((e=this.model)===null||e===void 0)&&e.loginRequired)&&!(!((t=this.model)===null||t===void 0)&&t.contentWarning)?_:u`
      <icon-overlay
        .loggedIn=${this.loggedIn}
    ...
    `}get textOverlayTemplate(){var e,t,i;return this.isListTile||!(!((e=this.model)===null||e===void 0)&&e.loginRequired)&&!(!((t=this.model)===null||t===void 0)&&t.contentWarning)?_:u`
      <text-overlay
        .loggedIn=${this.loggedIn}
        .loginRequired=${(i=this.model)===null||i===void 0?void 0:i.loginRequired}
        ?iconRequired=${!0}
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*xi(r,e){const t=typeof e=="function";if(r!==void 0){let i=-1;for(const a of r)i>-1&&(yield t?e(i):e),i++,yield a}}let Mi=class extends O{constructor(){super(...arguments),this.snippets=[],this.viewSize="desktop"}render(){var e;return!((e=this.snippets)===null||e===void 0)&&e.length?u`
      <div class="container">
        <div class="snippet-view ${this.viewSize}">
          ${this.ellipsisJoinedSnippets}
        </div>
      </div>
    `:u`${_}`}get ellipsisJoinedSnippets(){return u`
      &hellip; ${xi(this.snippetTemplates,u` &hellip; `)} &hellip;
...
`;let De=class extends O{constructor(){super(...arguments),this.isListTile=!1,this.isCompactTile=!1,this.loggedIn=!1,this.isWaveform=!1}render(){return u`
...
`,Qs={account:{color:"#000000",icon:Is,text:"Account"},audio:{color:"#00adef",icon:Ps,text:"Audio"},collection:{color:"#4666ff",icon:po,text:"Collection"},data:{color:"#333333",icon:Rs,text:"Data"},etree:{color:"#00adef",icon:Ns,text:"E-tree"},film:{color:"#bf1b2c",icon:_r,text:"Film"},image:{color:"#aa99c9",icon:Bs,text:"Image"},movies:{color:"#f1644b",icon:_r,text:"Movie"},radio:{color:"#8fdaef",icon:Hs,text:"Radio"},software:{color:"#9ecc4f",icon:Us,text:"Software"},texts:{color:"#faab3c",icon:js,text:"Text"},tv:{color:"#f1644b",icon:Ws,text:"TV"},video:{color:"#f1644b",icon:Vs,text:"Video"},web:{color:"#ffcd27",icon:Gs,text:"Web"}};let li=class extends O{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var e,t;const i=["tvnews","tvarchive","television"],a=["radio","radioprogram"];return this.mediatype==="movies"&&((e=this.collections)===null||e===void 0?void 0:e.some(o=>i.indexOf(o)>=0))?"tv":this.mediatype==="audio"&&((t=this.collections)===null||t===void 0?void 0:t.some(o=>a.indexOf(o)>=0))?"radio":this.mediatype||""}render(){const e=Qs[this.displayMediatype];return e?u`
      <div
        id="icon"
    ...
    `}};n([h({type:String})],li.prototype,"mediatype",void 0);n([h({type:Array})],li.prototype,"collections",void 0);n([h({type:Boolean})],li.prototype,"showText",void 0);li=n([N("mediatype-icon")],li);const Ks=I`
...
`;function Zs(r,e){let t=1;return r>=1e9?t=1e9:r>=1e6?t=1e6:r>=1e3&&e==="short"&&(t=1e3),t}function Js(r=0,e){const t=r/e,i=t<10;let a=0;return i?a=Math.round((t+Number.EPSILON)*10)/10:a=Math.round(t),a}function en(r,e,t,i){switch(e){case 1e9:return Ze(t==="short"?gt`${r}B`:gt`${r} billion`);case 1e6:return Ze(t==="short"?gt`${r}M`:gt`${r} million`);case 1e3:return Ze(t==="short"?gt`${r}K`:gt`${r} thousand`);default:return new Intl.NumberFormat(i).format(r)}}function Zt(r,e="long",t="short",i="en-US"){const a=r!=null?r:-1;if(a<0)return"";const o=Zs(a,e),s=Js(a,o);return en(s,o,t,i)}let rt=class extends O{render(){const e=Zt(this.favCount,"short","short"),t=Zt(this.commentCount,"short","short"),i=this.mediatype==="account"?`${this.itemCount} uploads`:`${this.viewCount} all-time views`;return u`
    ...
    `:_}get imageBlockTemplate(){return u`
      <image-block
    ...
    `}get textSnippetsTemplate(){var e;return this.hasSnippets?u`
      <text-snippet-block viewsize="grid" .snippets=${(e=this.model)===null||e===void 0?void 0:e.snippets}>
      </text-snippet-block>
    `:_}get volumeIssueTemplate(){var e,t,i,a;return!(!((e=this.model)===null||e===void 0)&&e.volume)||!(!((t=this.model)===null||t===void 0)&&t.issue)?_:u`
      <div class="volume-issue">
        <span class="truncated" title="volume|issue">
          Volume&nbsp;${(i=this.model)===null||i===void 0?void 0:i.volume}, Issue&nbsp;${(a=this.model)===null||a===void 0?void 0:a.issue}
        </span>
      </div>
    `}get doesSortedByDate(){var e;return["date","reviewdate","addeddate","publicdate"].includes((e=this.sortParam)===null||e===void 0?void 0:e.field)}get hasSnippets(){var e,t;return!!(!((t=(e=this.model)===null||e===void 0?void 0:e.snippets)===null||t===void 0)&&t.length)}static get styles(){return[uo,y`
        image-block {
      ...
      `]}};n([h({type:String})],Mt.prototype,"baseImageUrl",void 0);n([h({type:Boolean})],Mt.prototype,"loggedIn",void 0);n([h({type:Object})],Mt.prototype,"model",void 0);n([h({type:Object})],Mt.prototype,"sortParam",void 0);Mt=n([N("item-tile")],Mt);let Ei=class extends O{render(){return u`
      <div class="container">
        <div class="tile-details">
          <div class="item-info">
    ...
    >
    </tile-stats>`}static get styles(){return[uo,y`
        image-block {
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}var ln=Object.hasOwnProperty,Sr=Object.setPrototypeOf,dn=Object.isFrozen,cn=Object.getPrototypeOf,hn=Object.getOwnPropertyDescriptor,he=Object.freeze,Ce=Object.seal,pn=Object.create,fo=typeof Reflect!="undefined"&&Reflect,Ai=fo.apply,Ta=fo.construct;Ai||(Ai=function(e,t,i){return e.apply(t,i)});he||(he=function(e){return e});Ce||(Ce=function(e){return e});Ta||(Ta=function(e,t){return _i(e,be(t))});var un=xe(Array.prototype.forEach),$r=xe(Array.prototype.pop),Yt=xe(Array.prototype.push),Si=xe(String.prototype.toLowerCase),mn=xe(String.prototype.match),Fe=xe(String.prototype.replace),vn=xe(String.prototype.indexOf),fn=xe(String.prototype.trim),de=xe(RegExp.prototype.test),sa=gn(TypeError);function xe(r){return function(e){for(var t=arguments.length,i=new Array(t>1?t-1:0),a=1;a<t;a++)i[a-1]=arguments[a];return Ai(r,e,i)}}function gn(r){return function(){for(var e=arguments.length,t=new Array(e),i=0;i<e;i++)t[i]=arguments[i];return Ta(r,t)}}function D(r,e){Sr&&Sr(r,null);for(var t=e.length;t--;){var i=e[t];if(typeof i=="string"){var a=Si(i);a!==i&&(dn(e)||(e[t]=a),i=a)}r[i]=!0}return r}function qe(r){var e=pn(null),t;for(t in r)Ai(ln,r,[t])&&(e[t]=r[t]);return e}function gi(r,e){for(;r!==null;){var t=hn(r,e);if(t){if(t.get)return xe(t.get);if(typeof t.value=="function")return xe(t.value)}r=cn(r)}function i(a){return console.warn("fallback value for",a),null}return i}var Cr=he(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","section","select","shadow","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),na=he(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","filter","font","g","glyph","glyphref","hkern","image","line","lineargradient","marker","mask","metadata","mpath","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),la=he(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),yn=he(["animate","color-profile","cursor","discard","fedropshadow","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),da=he(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover"]),bn=he(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),kr=he(["#text"]),Tr=he(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","face","for","headers","height","hidden","high","href","hreflang","id","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","pattern","placeholder","playsinline","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","xmlns","slot"]),ca=he(["accent-height","accumulate","additive","alignment-baseline","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),zr=he(["accent","accentunder","align","bevelled","close","columnsalign","columnlines","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lspace","lquote","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),yi=he(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),wn=Ce(/\{\{[\w\W]*|[\w\W]*\}\}/gm),xn=Ce(/<%[\w\W]*|[\w\W]*%>/gm),_n=Ce(/^data-[\-\w.\u00B7-\uFFFF]/),Sn=Ce(/^aria-[\-\w]+$/),$n=Ce(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|cid|xmpp):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),Cn=Ce(/^(?:\w+script|data):/i),kn=Ce(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),Tn=Ce(/^html$/i),zn=function(){return typeof window=="undefined"?null:window},Mn=function(e,t){if(Je(e)!=="object"||typeof e.createPolicy!="function")return null;var i=null,a="data-tt-policy-suffix";t.currentScript&&t.currentScript.hasAttribute(a)&&(i=t.currentScript.getAttribute(a));var o="dompurify"+(i?"#"+i:"");try{return e.createPolicy(o,{createHTML:function(l){return l}})}catch{return console.warn("TrustedTypes policy "+o+" could not be created."),null}};function go(){var r=arguments.length>0&&arguments[0]!==void 0?arguments[0]:zn(),e=function(p){return go(p)};if(e.version="2.3.8",e.removed=[],!r||!r.document||r.document.nodeType!==9)return e.isSupported=!1,e;var t=r.document,i=r.document,a=r.DocumentFragment,o=r.HTMLTemplateElement,s=r.Node,l=r.Element,d=r.NodeFilter,c=r.NamedNodeMap,m=c===void 0?r.NamedNodeMap||r.MozNamedAttrMap:c,v=r.HTMLFormElement,f=r.DOMParser,w=r.trustedTypes,x=l.prototype,$=gi(x,"cloneNode"),E=gi(x,"nextSibling"),A=gi(x,"childNodes"),F=gi(x,"parentNode");if(typeof o=="function"){var R=i.createElement("template");R.content&&R.content.ownerDocument&&(i=R.content.ownerDocument)}var B=Mn(w,t),K=B?B.createHTML(""):"",re=i,Se=re.implementation,Pt=re.createNodeIterator,Rt=re.createDocumentFragment,Nt=re.getElementsByTagName,Bt=t.importNode,ot={};try{ot=qe(i).documentMode?i.documentMode:{}}catch{}var ue={};e.isSupported=typeof F=="function"&&Se&&typeof Se.createHTMLDocument!="undefined"&&ot!==9;var He=wn,Ue=xn,Ht=_n,Ut=Sn,jt=Cn,st=kn,je=$n,Y=null,nt=D({},[].concat(be(Cr),be(na),be(la),be(da),be(kr))),q=null,lt=D({},[].concat(be(Tr),be(ca),be(zr),be(yi))),V=Object.seal(Object.create(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),Te=null,We=null,dt=!0,Ve=!0,Wt=!1,ct=!1,Ge=!1,Hi=!1,Ui=!1,ht=!1,hi=!1,pi=!1,ja=!0,ji=!0,Vt=!1,pt={},ut=null,Wa=D({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","style","svg","template","thead","title","video","xmp"]),Va=null,Ga=D({},["audio","video","img","source","image","track"]),Wi=null,Qa=D({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),Vi="http://www.w3.org/1998/Math/MathML",Gi="http://www.w3.org/2000/svg",Le="http://www.w3.org/1999/xhtml",ui=Le,Qi=!1,mt,Ao=["application/xhtml+xml","text/html"],Do="text/html",Qe,vt=null,Lo=i.createElement("form"),Ka=function(p){return p instanceof RegExp||p instanceof Function},Ki=function(p){vt&&vt===p||((!p||Je(p)!=="object")&&(p={}),p=qe(p),Y="ALLOWED_TAGS"in p?D({},p.ALLOWED_TAGS):nt,q="ALLOWED_ATTR"in p?D({},p.ALLOWED_ATTR):lt,Wi="ADD_URI_SAFE_ATTR"in p?D(qe(Qa),p.ADD_URI_SAFE_ATTR):Qa,Va="ADD_DATA_URI_TAGS"in p?D(qe(Ga),p.ADD_DATA_URI_TAGS):Ga,ut="FORBID_CONTENTS"in p?D({},p.FORBID_CONTENTS):Wa,Te="FORBID_TAGS"in p?D({},p.FORBID_TAGS):{},We="FORBID_ATTR"in p?D({},p.FORBID_ATTR):{},pt="USE_PROFILES"in p?p.USE_PROFILES:!1,dt=p.ALLOW_ARIA_ATTR!==!1,Ve=p.ALLOW_DATA_ATTR!==!1,Wt=p.ALLOW_UNKNOWN_PROTOCOLS||!1,ct=p.SAFE_FOR_TEMPLATES||!1,Ge=p.WHOLE_DOCUMENT||!1,ht=p.RETURN_DOM||!1,hi=p.RETURN_DOM_FRAGMENT||!1,pi=p.RETURN_TRUSTED_TYPE||!1,Ui=p.FORCE_BODY||!1,ja=p.SANITIZE_DOM!==!1,ji=p.KEEP_CONTENT!==!1,Vt=p.IN_PLACE||!1,je=p.ALLOWED_URI_REGEXP||je,ui=p.NAMESPACE||Le,p.CUSTOM_ELEMENT_HANDLING&&Ka(p.CUSTOM_ELEMENT_HANDLING.tagNameCheck)&&(V.tagNameCheck=p.CUSTOM_ELEMENT_HANDLING.tagNameCheck),p.CUSTOM_ELEMENT_HANDLING&&Ka(p.CUSTOM_ELEMENT_HANDLING.attributeNameCheck)&&(V.attributeNameCheck=p.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),p.CUSTOM_ELEMENT_HANDLING&&typeof p.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements=="boolean"&&(V.allowCustomizedBuiltInElements=p.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements),mt=Ao.indexOf(p.PARSER_MEDIA_TYPE)===-1?mt=Do:mt=p.PARSER_MEDIA_TYPE,Qe=mt==="application/xhtml+xml"?function(b){return b}:Si,ct&&(Ve=!1),hi&&(ht=!0),pt&&(Y=D({},be(kr)),q=[],pt.html===!0&&(D(Y,Cr),D(q,Tr)),pt.svg===!0&&(D(Y,na),D(q,ca),D(q,yi)),pt.svgFilters===!0&&(D(Y,la),D(q,ca),D(q,yi)),pt.mathMl===!0&&(D(Y,da),D(q,zr),D(q,yi))),p.ADD_TAGS&&(Y===nt&&(Y=qe(Y)),D(Y,p.ADD_TAGS)),p.ADD_ATTR&&(q===lt&&(q=qe(q)),D(q,p.ADD_ATTR)),p.ADD_URI_SAFE_ATTR&&D(Wi,p.ADD_URI_SAFE_ATTR),p.FORBID_CONTENTS&&(ut===Wa&&(ut=qe(ut)),D(ut,p.FORBID_CONTENTS)),ji&&(Y["#text"]=!0),Ge&&D(Y,["html","head","body"]),Y.table&&(D(Y,["tbody"]),delete Te.tbody),he&&he(p),vt=p)},Ya=D({},["mi","mo","mn","ms","mtext"]),qa=D({},["foreignobject","desc","title","annotation-xml"]),Fo=D({},["title","style","font","a","script"]),mi=D({},na);D(mi,la),D(mi,yn);var Yi=D({},da);D(Yi,bn);var Oo=function(p){var b=F(p);(!b||!b.tagName)&&(b={namespaceURI:Le,tagName:"template"});var S=Si(p.tagName),H=Si(b.tagName);return p.namespaceURI===Gi?b.namespaceURI===Le?S==="svg":b.namespaceURI===Vi?S==="svg"&&(H==="annotation-xml"||Ya[H]):Boolean(mi[S]):p.namespaceURI===Vi?b.namespaceURI===Le?S==="math":b.namespaceURI===Gi?S==="math"&&qa[H]:Boolean(Yi[S]):p.namespaceURI===Le?b.namespaceURI===Gi&&!qa[H]||b.namespaceURI===Vi&&!Ya[H]?!1:!Yi[S]&&(Fo[S]||!mi[S]):!1},ze=function(p){Yt(e.removed,{element:p});try{p.parentNode.removeChild(p)}catch{try{p.outerHTML=K}catch{p.remove()}}},Xa=function(p,b){try{Yt(e.removed,{attribute:b.getAttributeNode(p),from:b})}catch{Yt(e.removed,{attribute:null,from:b})}if(b.removeAttribute(p),p==="is"&&!q[p])if(ht||hi)try{ze(b)}catch{}else try{b.setAttribute(p,"")}catch{}},Za=function(p){var b,S;if(Ui)p="<remove></remove>"+p;else{var H=mn(p,/^[\r\n\t ]+/);S=H&&H[0]}mt==="application/xhtml+xml"&&(p='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+p+"</body></html>");var me=B?B.createHTML(p):p;if(ui===Le)try{b=new f().parseFromString(me,mt)}catch{}if(!b||!b.documentElement){b=Se.createDocument(ui,"template",null);try{b.documentElement.innerHTML=Qi?"":me}catch{}}var oe=b.body||b.documentElement;return p&&S&&oe.insertBefore(i.createTextNode(S),oe.childNodes[0]||null),ui===Le?Nt.call(b,Ge?"html":"body")[0]:Ge?b.documentElement:oe},Ja=function(p){return Pt.call(p.ownerDocument||p,p,d.SHOW_ELEMENT|d.SHOW_COMMENT|d.SHOW_TEXT,null,!1)},Io=function(p){return p instanceof v&&(typeof p.nodeName!="string"||typeof p.textContent!="string"||typeof p.removeChild!="function"||!(p.attributes instanceof m)||typeof p.removeAttribute!="function"||typeof p.setAttribute!="function"||typeof p.namespaceURI!="string"||typeof p.insertBefore!="function")},Gt=function(p){return Je(s)==="object"?p instanceof s:p&&Je(p)==="object"&&typeof p.nodeType=="number"&&typeof p.nodeName=="string"},Me=function(p,b,S){!ue[p]||un(ue[p],function(H){H.call(e,b,S,vt)})},er=function(p){var b;if(Me("beforeSanitizeElements",p,null),Io(p)||de(/[\u0080-\uFFFF]/,p.nodeName))return ze(p),!0;var S=Qe(p.nodeName);if(Me("uponSanitizeElement",p,{tagName:S,allowedTags:Y}),p.hasChildNodes()&&!Gt(p.firstElementChild)&&(!Gt(p.content)||!Gt(p.content.firstElementChild))&&de(/<[/\w]/g,p.innerHTML)&&de(/<[/\w]/g,p.textContent)||S==="select"&&de(/<template/i,p.innerHTML))return ze(p),!0;if(!Y[S]||Te[S]){if(!Te[S]&&ir(S)&&(V.tagNameCheck instanceof RegExp&&de(V.tagNameCheck,S)||V.tagNameCheck instanceof Function&&V.tagNameCheck(S)))return!1;if(ji&&!ut[S]){var H=F(p)||p.parentNode,me=A(p)||p.childNodes;if(me&&H)for(var oe=me.length,te=oe-1;te>=0;--te)H.insertBefore($(me[te],!0),E(p))}return ze(p),!0}return p instanceof l&&!Oo(p)||(S==="noscript"||S==="noembed")&&de(/<\/no(script|embed)/i,p.innerHTML)?(ze(p),!0):(ct&&p.nodeType===3&&(b=p.textContent,b=Fe(b,He," "),b=Fe(b,Ue," "),p.textContent!==b&&(Yt(e.removed,{element:p.cloneNode()}),p.textContent=b)),Me("afterSanitizeElements",p,null),!1)},tr=function(p,b,S){if(ja&&(b==="id"||b==="name")&&(S in i||S in Lo))return!1;if(!(Ve&&!We[b]&&de(Ht,b))){if(!(dt&&de(Ut,b))){if(!q[b]||We[b]){if(!(ir(p)&&(V.tagNameCheck instanceof RegExp&&de(V.tagNameCheck,p)||V.tagNameCheck instanceof Function&&V.tagNameCheck(p))&&(V.attributeNameCheck instanceof RegExp&&de(V.attributeNameCheck,b)||V.attributeNameCheck instanceof Function&&V.attributeNameCheck(b))||b==="is"&&V.allowCustomizedBuiltInElements&&(V.tagNameCheck instanceof RegExp&&de(V.tagNameCheck,S)||V.tagNameCheck instanceof Function&&V.tagNameCheck(S))))return!1}else if(!Wi[b]){if(!de(je,Fe(S,st,""))){if(!((b==="src"||b==="xlink:href"||b==="href")&&p!=="script"&&vn(S,"data:")===0&&Va[p])){if(!(Wt&&!de(jt,Fe(S,st,"")))){if(S)return!1}}}}}}return!0},ir=function(p){return p.indexOf("-")>0},ar=function(p){var b,S,H,me;Me("beforeSanitizeAttributes",p,null);var oe=p.attributes;if(!!oe){var te={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:q};for(me=oe.length;me--;){b=oe[me];var vi=b,ne=vi.name,rr=vi.namespaceURI;if(S=ne==="value"?b.value:fn(b.value),H=Qe(ne),te.attrName=H,te.attrValue=S,te.keepAttr=!0,te.forceKeepAttr=void 0,Me("uponSanitizeAttribute",p,te),S=te.attrValue,!te.forceKeepAttr&&(Xa(ne,p),!!te.keepAttr)){if(de(/\/>/i,S)){Xa(ne,p);continue}ct&&(S=Fe(S,He," "),S=Fe(S,Ue," "));var Ro=Qe(p.nodeName);if(!!tr(Ro,H,S))try{rr?p.setAttributeNS(rr,ne,S):p.setAttribute(ne,S),$r(e.removed)}catch{}}}Me("afterSanitizeAttributes",p,null)}},Po=function C(p){var b,S=Ja(p);for(Me("beforeSanitizeShadowDOM",p,null);b=S.nextNode();)Me("uponSanitizeShadowNode",b,null),!er(b)&&(b.content instanceof a&&C(b.content),ar(b));Me("afterSanitizeShadowDOM",p,null)};return e.sanitize=function(C,p){var b,S,H,me,oe;if(Qi=!C,Qi&&(C="<!-->"),typeof C!="string"&&!Gt(C)){if(typeof C.toString!="function")throw sa("toString is not a function");if(C=C.toString(),typeof C!="string")throw sa("dirty is not a string, aborting")}if(!e.isSupported){if(Je(r.toStaticHTML)==="object"||typeof r.toStaticHTML=="function"){if(typeof C=="string")return r.toStaticHTML(C);if(Gt(C))return r.toStaticHTML(C.outerHTML)}return C}if(Hi||Ki(p),e.removed=[],typeof C=="string"&&(Vt=!1),Vt){if(C.nodeName){var te=Qe(C.nodeName);if(!Y[te]||Te[te])throw sa("root node is forbidden and cannot be sanitized in-place")}}else if(C instanceof s)b=Za("<!---->"),S=b.ownerDocument.importNode(C,!0),S.nodeType===1&&S.nodeName==="BODY"||S.nodeName==="HTML"?b=S:b.appendChild(S);else{if(!ht&&!ct&&!Ge&&C.indexOf("<")===-1)return B&&pi?B.createHTML(C):C;if(b=Za(C),!b)return ht?null:pi?K:""}b&&Ui&&ze(b.firstChild);for(var vi=Ja(Vt?C:b);H=vi.nextNode();)H.nodeType===3&&H===me||er(H)||(H.content instanceof a&&Po(H.content),ar(H),me=H);if(me=null,Vt)return C;if(ht){if(hi)for(oe=Rt.call(b.ownerDocument);b.firstChild;)oe.appendChild(b.firstChild);else oe=b;return q.shadowroot&&(oe=Bt.call(t,oe,!0)),oe}var ne=Ge?b.outerHTML:b.innerHTML;return Ge&&Y["!doctype"]&&b.ownerDocument&&b.ownerDocument.doctype&&b.ownerDocument.doctype.name&&de(Tn,b.ownerDocument.doctype.name)&&(ne="<!DOCTYPE "+b.ownerDocument.doctype.name+`>
`+ne),ct&&(ne=Fe(ne,He," "),ne=Fe(ne,Ue," ")),B&&pi?B.createHTML(ne):ne},e.setConfig=function(C){Ki(C),Hi=!0},e.clearConfig=function(){vt=null,Hi=!1},e.isValidAttribute=function(C,p,b){vt||Ki({});var S=Qe(C),H=Qe(p);return tr(S,H,b)},e.addHook=function(C,p){typeof p=="function"&&(ue[C]=ue[C]||[],Yt(ue[C],p))},e.removeHook=function(C){if(ue[C])return $r(ue[C])},e.removeHooks=function(C){ue[C]&&(ue[C]=[])},e.removeAllHooks=function(){ue={}},e}var Jt=go(),L;(function(r){r.relevance="relevance",r.alltimeview="alltimeview",r.weeklyview="weeklyview",r.title="title",r.datearchived="datearchived",r.date="date",r.datereviewed="datereviewed",r.dateadded="dateadded",r.creator="creator"})(L||(L={}));const Xe={relevance:"Relevance",alltimeview:"All-time Views",weeklyview:"Weekly Views",title:"Title",datearchived:"Date Archived",date:"Date Published",datereviewed:"Date Reviewed",dateadded:"Date Added",creator:"Creator"},En={relevance:null,alltimeview:"downloads",weeklyview:"week",title:"titleSorter",datearchived:"publicdate",date:"date",datereviewed:"reviewdate",dateadded:"addeddate",creator:"creatorSorter"},Mr={week:L.weeklyview,downloads:L.alltimeview,titleSorter:L.title,date:L.date,publicdate:L.datearchived,reviewdate:L.datereviewed,addeddate:L.dateadded,creatorSorter:L.creator},An={title:"firstTitle",creator:"firstCreator"},Di={subject:{},lending:{},mediatype:{},language:{},creator:{},collection:{},year:{}},Dn=["mediatype","lending","year","subject","collection","creator","language"],Li={subject:"Subject",lending:"Availability",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"},Ln={is_lendable:!0,is_borrowable:!1,available_to_borrow:!0,is_browsable:!1,available_to_browse:!1,is_readable:!0,available_to_waitlist:!1},Er={is_lendable:"Lending Library",available_to_borrow:"Borrow 14 Days",is_readable:"Always Available"},Pa={deemphasize:!0,community:!0,stream_only:!0,samples_only:!0,test_collection:!0,printdisabled:!0,"openlibrary-ol":!0,nationalemergencylibrary:!0,china:!0,americana:!0,toronto:!0};function yo(r){switch(r){case"date":return"Published";case"reviewdate":return"Reviewed";case"addeddate":return"Added";default:return"Archived"}}function bo(r){return r?`Archivist since ${r.getFullYear()}`:""}let ye=class extends O{constructor(){super(...arguments),this.sortParam=null,this.collectionLinks=[],this.loggedIn=!1}render(){return u`
    ...
    `}get titleTemplate(){var e;return!((e=this.model)===null||e===void 0)&&e.title?u` ${this.detailsLink(this.model.identifier,this.model.title)} `:_}get itemLineTemplate(){const e=this.sourceTemplate,t=this.volumeTemplate,i=this.issueTemplate;return!e&&!t&&!i?_:u` <div id="item-line">${e} ${t} ${i}</div> `}get sourceTemplate(){var e;return!((e=this.model)===null||e===void 0)&&e.source?u`
      <div id="source" class="metadata">
        ${this.labelTemplate("Source")}
        ${this.searchLink("source",this.model.source)}
      </div>
    `:_}get volumeTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.volume,"Volume")}get issueTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.issue,"Issue")}get creatorTemplate(){var e,t,i;return((e=this.model)===null||e===void 0?void 0:e.mediatype)==="account"?u`
        <div id="creator" class="metadata">
          <span class="label"> ${bo((t=this.model)===null||t===void 0?void 0:t.dateAdded)} </span>
        </div>
      `:!(!((i=this.model)===null||i===void 0)&&i.creators)||this.model.creators.length===0?_:u`
      <div id="creator" class="metadata">
        ${this.labelTemplate("By")}
        ${xi(Sa(this.model.creators,a=>this.searchLink("creator",a)),u`, `)}
      </div>
    `}get datePublishedTemplate(){var e;return this.metadataTemplate(zi((e=this.model)===null||e===void 0?void 0:e.datePublished,"long"),"Published")}get dateSortByTemplate(){return this.sortParam&&(this.sortParam.field==="addeddate"||this.sortParam.field==="reviewdate"||this.sortParam.field==="publicdate")?this.metadataTemplate(zi(this.date,"long"),yo(this.sortParam.field)):_}get viewsTemplate(){var e,t,i;const a=((e=this.sortParam)===null||e===void 0?void 0:e.field)==="week"?(t=this.model)===null||t===void 0?void 0:t.weeklyViewCount:(i=this.model)===null||i===void 0?void 0:i.viewCount;return this.metadataTemplate(`${Zt(a!=null?a:0,this.formatSize)}`,"Views")}get ratingTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.averageRating,"Avg Rating")}get reviewsTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.commentCount,"Reviews")}get topicsTemplate(){var e;return!(!((e=this.model)===null||e===void 0)&&e.subjects)||this.model.subjects.length===0?_:u`
      <div id="topics" class="metadata">
        ${this.labelTemplate("Topics")}
        ${xi(Sa(this.model.subjects,t=>this.searchLink("subject",t)),u`, `)}
      </div>
    `}get collectionsTemplate(){return!this.collectionLinks||this.collectionLinks.length===0?_:u`
      <div id="collections" class="metadata">
        ${this.labelTemplate("Collections")}
        ${xi(this.collectionLinks,u`, `)}
      </div>
    ...
    ></text-snippet-block>`:_}get hasSnippets(){var e,t;return!!(!((t=(e=this.model)===null||e===void 0?void 0:e.snippets)===null||t===void 0)&&t.length)}metadataTemplate(e,t="",i){return e?u`
      <div id=${oi(i)} class="metadata">
        ${this.labelTemplate(t)} ${e}
      </div>
    `:_}labelTemplate(e){return u` ${e?u`<span class="label">${e}: </span>`:_}`}searchLink(e,t){if(!e||!t)return _;const i=encodeURIComponent(`${e}:"${t}"`);return u`<a
    ...
    `}};Ar=n([N("collection-browser-loading-tile")],Ar);let di=class extends O{constructor(){super(...arguments),this.selectedLetter=null,this.alphabet="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("")}get selectedUppercaseLetter(){var e;return(e=this.selectedLetter)===null||e===void 0?void 0:e.toUpperCase()}render(){return u`
      <div id="container">
        <ul>
...
`;let ee=class extends O{constructor(){super(...arguments),this.sortDirection=null,this.selectedSort=L.relevance,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.showRelevance=!0,this.alphaSelectorVisible=null,this.dateSortSelectorVisible=!1,this.viewSortSelectorVisible=!1,this.desktopSelectorBarWidth=0,this.selectorBarContainerWidth=0,this.hoveringOverDateSortOptions=!1,this.boundSortBarSelectorEscapeListener=e=>{e.key==="Escape"&&(this.viewSortSelectorVisible=!1,this.dateSortSelectorVisible=!1)}}render(){return u`
    ...
    `}getSortDisplayOption(e,t){var i,a;const o=(i=t==null?void 0:t.isSelected)!==null&&i!==void 0?i:()=>this.selectedSort===e,s=(a=t==null?void 0:t.displayName)!==null&&a!==void 0?a:Xe[e];return u`
      <a
        href="#"
    ...
    `}selectDateSort(e){this.dateSortSelectorVisible=!1,this.viewSortSelectorVisible=!1,this.setSelectedSort(e)}setSortDirections(e){this.sortDirection=e,this.emitSortChangedEvent()}setSelectedSort(e){this.selectedSort=e,this.emitSortChangedEvent()}get dateOptionSelected(){return[L.datearchived,L.date,L.datereviewed,L.dateadded].includes(this.selectedSort)}get viewOptionSelected(){return[L.alltimeview,L.weeklyview].includes(this.selectedSort)}get dateSortField(){var e;const t=Xe[L.date];return this.dateOptionSelected&&(e=Xe[this.selectedSort])!==null&&e!==void 0?e:t}get viewSortField(){var e;const t=Xe[L.weeklyview];return this.viewOptionSelected&&(e=Xe[this.selectedSort])!==null&&e!==void 0?e:t}get titleSelectorBar(){var e;return u` <alpha-bar
 ...
 */const Lr=Ri(class extends Ni{constructor(r){if(super(r),r.type!==Ee.PROPERTY&&r.type!==Ee.ATTRIBUTE&&r.type!==Ee.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Ss(r))throw Error("`live` bindings can only contain a single expression")}render(r){return r}update(r,[e]){if(e===ge||e===_)return e;const t=r.element,i=r.name;if(r.type===Ee.PROPERTY){if(e===t[i])return ge}else if(r.type===Ee.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(i))return ge}else if(r.type===Ee.ATTRIBUTE&&t.getAttribute(i)===e+"")return ge;return co(r),e}});var wo=60,xo=wo*60,_o=xo*24,Pn=_o*7,At=1e3,ha=wo*At,Fr=xo*At,Rn=_o*At,Nn=Pn*At,Ra="millisecond",xt="second",_t="minute",St="hour",Oe="day",$i="week",we="month",So="quarter",Ie="year",$t="date",Bn="YYYY-MM-DDTHH:mm:ssZ",Or="Invalid Date",Hn=/^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/,Un=/\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g,jn={name:"en",weekdays:"Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),months:"January_February_March_April_May_June_July_August_September_October_November_December".split("_")},za=function(e,t,i){var a=String(e);return!a||a.length>=t?e:""+Array(t+1-a.length).join(i)+e},Wn=function(e){var t=-e.utcOffset(),i=Math.abs(t),a=Math.floor(i/60),o=i%60;return(t<=0?"+":"-")+za(a,2,"0")+":"+za(o,2,"0")},Vn=function r(e,t){if(e.date()<t.date())return-r(t,e);var i=(t.year()-e.year())*12+(t.month()-e.month()),a=e.clone().add(i,we),o=t-a<0,s=e.clone().add(i+(o?-1:1),we);return+(-(i+(t-a)/(o?a-s:s-a))||0)},Gn=function(e){return e<0?Math.ceil(e)||0:Math.floor(e)},Qn=function(e){var t={M:we,y:Ie,w:$i,d:Oe,D:$t,h:St,m:_t,s:xt,ms:Ra,Q:So};return t[e]||String(e||"").toLowerCase().replace(/s$/,"")},Kn=function(e){return e===void 0},Yn={s:za,z:Wn,m:Vn,a:Gn,p:Qn,u:Kn},ei="en",et={};et[ei]=jn;var Na=function(e){return e instanceof Bi},Fi=function r(e,t,i){var a;if(!e)return ei;if(typeof e=="string"){var o=e.toLowerCase();et[o]&&(a=o),t&&(et[o]=t,a=o);var s=e.split("-");if(!a&&s.length>1)return r(s[0])}else{var l=e.name;et[l]=e,a=l}return!i&&a&&(ei=a),a||!i&&ei},J=function(e,t){if(Na(e))return e.clone();var i=typeof t=="object"?t:{};return i.date=e,i.args=arguments,new Bi(i)},qn=function(e,t){return J(e,{locale:t.$L,utc:t.$u,x:t.$x,$offset:t.$offset})},U=Yn;U.l=Fi;U.i=Na;U.w=qn;var Xn=function(e){var t=e.date,i=e.utc;if(t===null)return new Date(NaN);if(U.u(t))return new Date;if(t instanceof Date)return new Date(t);if(typeof t=="string"&&!/Z$/i.test(t)){var a=t.match(Hn);if(a){var o=a[2]-1||0,s=(a[7]||"0").substring(0,3);return i?new Date(Date.UTC(a[1],o,a[3]||1,a[4]||0,a[5]||0,a[6]||0,s)):new Date(a[1],o,a[3]||1,a[4]||0,a[5]||0,a[6]||0,s)}}return new Date(t)},Bi=function(){function r(t){this.$L=Fi(t.locale,null,!0),this.parse(t)}var e=r.prototype;return e.parse=function(i){this.$d=Xn(i),this.$x=i.x||{},this.init()},e.init=function(){var i=this.$d;this.$y=i.getFullYear(),this.$M=i.getMonth(),this.$D=i.getDate(),this.$W=i.getDay(),this.$H=i.getHours(),this.$m=i.getMinutes(),this.$s=i.getSeconds(),this.$ms=i.getMilliseconds()},e.$utils=function(){return U},e.isValid=function(){return this.$d.toString()!==Or},e.isSame=function(i,a){var o=J(i);return this.startOf(a)<=o&&o<=this.endOf(a)},e.isAfter=function(i,a){return J(i)<this.startOf(a)},e.isBefore=function(i,a){return this.endOf(a)<J(i)},e.$g=function(i,a,o){return U.u(i)?this[a]:this.set(o,i)},e.unix=function(){return Math.floor(this.valueOf()/1e3)},e.valueOf=function(){return this.$d.getTime()},e.startOf=function(i,a){var o=this,s=U.u(a)?!0:a,l=U.p(i),d=function(A,F){var R=U.w(o.$u?Date.UTC(o.$y,F,A):new Date(o.$y,F,A),o);return s?R:R.endOf(Oe)},c=function(A,F){var R=[0,0,0,0],B=[23,59,59,999];return U.w(o.toDate()[A].apply(o.toDate("s"),(s?R:B).slice(F)),o)},m=this.$W,v=this.$M,f=this.$D,w="set"+(this.$u?"UTC":"");switch(l){case Ie:return s?d(1,0):d(31,11);case we:return s?d(1,v):d(0,v+1);case $i:{var x=this.$locale().weekStart||0,$=(m<x?m+7:m)-x;return d(s?f-$:f+(6-$),v)}case Oe:case $t:return c(w+"Hours",0);case St:return c(w+"Minutes",1);case _t:return c(w+"Seconds",2);case xt:return c(w+"Milliseconds",3);default:return this.clone()}},e.endOf=function(i){return this.startOf(i,!1)},e.$set=function(i,a){var o,s=U.p(i),l="set"+(this.$u?"UTC":""),d=(o={},o[Oe]=l+"Date",o[$t]=l+"Date",o[we]=l+"Month",o[Ie]=l+"FullYear",o[St]=l+"Hours",o[_t]=l+"Minutes",o[xt]=l+"Seconds",o[Ra]=l+"Milliseconds",o)[s],c=s===Oe?this.$D+(a-this.$W):a;if(s===we||s===Ie){var m=this.clone().set($t,1);m.$d[d](c),m.init(),this.$d=m.set($t,Math.min(this.$D,m.daysInMonth())).$d}else d&&this.$d[d](c);return this.init(),this},e.set=function(i,a){return this.clone().$set(i,a)},e.get=function(i){return this[U.p(i)]()},e.add=function(i,a){var o=this,s;i=Number(i);var l=U.p(a),d=function(f){var w=J(o);return U.w(w.date(w.date()+Math.round(f*i)),o)};if(l===we)return this.set(we,this.$M+i);if(l===Ie)return this.set(Ie,this.$y+i);if(l===Oe)return d(1);if(l===$i)return d(7);var c=(s={},s[_t]=ha,s[St]=Fr,s[xt]=At,s)[l]||1,m=this.$d.getTime()+i*c;return U.w(m,this)},e.subtract=function(i,a){return this.add(i*-1,a)},e.format=function(i){var a=this,o=this.$locale();if(!this.isValid())return o.invalidDate||Or;var s=i||Bn,l=U.z(this),d=this.$H,c=this.$m,m=this.$M,v=o.weekdays,f=o.months,w=o.meridiem,x=function(R,B,K,re){return R&&(R[B]||R(a,s))||K[B].slice(0,re)},$=function(R){return U.s(d%12||12,R,"0")},E=w||function(F,R,B){var K=F<12?"AM":"PM";return B?K.toLowerCase():K},A={YY:String(this.$y).slice(-2),YYYY:this.$y,M:m+1,MM:U.s(m+1,2,"0"),MMM:x(o.monthsShort,m,f,3),MMMM:x(f,m),D:this.$D,DD:U.s(this.$D,2,"0"),d:String(this.$W),dd:x(o.weekdaysMin,this.$W,v,2),ddd:x(o.weekdaysShort,this.$W,v,3),dddd:v[this.$W],H:String(d),HH:U.s(d,2,"0"),h:$(1),hh:$(2),a:E(d,c,!0),A:E(d,c,!1),m:String(c),mm:U.s(c,2,"0"),s:String(this.$s),ss:U.s(this.$s,2,"0"),SSS:U.s(this.$ms,3,"0"),Z:l};return s.replace(Un,function(F,R){return R||A[F]||l.replace(":","")})},e.utcOffset=function(){return-Math.round(this.$d.getTimezoneOffset()/15)*15},e.diff=function(i,a,o){var s,l=U.p(a),d=J(i),c=(d.utcOffset()-this.utcOffset())*ha,m=this-d,v=U.m(this,d);return v=(s={},s[Ie]=v/12,s[we]=v,s[So]=v/3,s[$i]=(m-c)/Nn,s[Oe]=(m-c)/Rn,s[St]=m/Fr,s[_t]=m/ha,s[xt]=m/At,s)[l]||m,o?v:U.a(v)},e.daysInMonth=function(){return this.endOf(we).$D},e.$locale=function(){return et[this.$L]},e.locale=function(i,a){if(!i)return this.$L;var o=this.clone(),s=Fi(i,a,!0);return s&&(o.$L=s),o},e.clone=function(){return U.w(this.$d,this)},e.toDate=function(){return new Date(this.valueOf())},e.toJSON=function(){return this.isValid()?this.toISOString():null},e.toISOString=function(){return this.$d.toISOString()},e.toString=function(){return this.$d.toUTCString()},r}(),$o=Bi.prototype;J.prototype=$o;[["$ms",Ra],["$s",xt],["$m",_t],["$H",St],["$W",Oe],["$M",we],["$y",Ie],["$D",$t]].forEach(function(r){$o[r[1]]=function(e){return this.$g(e,r[0],r[1])}});J.extend=function(r,e){return r.$i||(r(e,Bi,J),r.$i=!0),J};J.locale=Fi;J.isDayjs=Na;J.unix=function(r){return J(r*1e3)};J.en=et[ei];J.Ls=et;J.p={};var Zn=function(e){return e.replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g,function(t,i,a){return i||a.slice(1)})},Jn={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"},el=function(e,t){return e.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g,function(i,a,o){var s=o&&o.toUpperCase();return a||t[o]||Jn[o]||Zn(t[s])})},tl=/(\[[^[]*\])|([-:/.()\s]+)|(A|a|YYYY|YY?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g,il=/\d/,bi=/\d\d/,al=/\d{3}/,rl=/\d{4}/,$e=/\d\d?/,ol=/[+-]?\d+/,sl=/[+-]\d\d:?(\d\d)?|Z/,qt=/\d*[^\s\d-_:/()]+/,Re={},Co=function(e){return e=+e,e+(e>68?1900:2e3)};function nl(r){if(!r||r==="Z")return 0;var e=r.match(/([+-]|\d\d)/g),t=+(e[1]*60)+(+e[2]||0);return t===0?0:e[0]==="+"?-t:t}var ve=function(e){return function(t){this[e]=+t}},Ir=[sl,function(r){var e=this.zone||(this.zone={});e.offset=nl(r)}],pa=function(e){var t=Re[e];return t&&(t.indexOf?t:t.s.concat(t.f))},Pr=function(e,t){var i,a=Re,o=a.meridiem;if(!o)i=e===(t?"pm":"PM");else for(var s=1;s<=24;s+=1)if(e.indexOf(o(s,0,t))>-1){i=s>12;break}return i},ll={A:[qt,function(r){this.afternoon=Pr(r,!1)}],a:[qt,function(r){this.afternoon=Pr(r,!0)}],S:[il,function(r){this.milliseconds=+r*100}],SS:[bi,function(r){this.milliseconds=+r*10}],SSS:[al,function(r){this.milliseconds=+r}],s:[$e,ve("seconds")],ss:[$e,ve("seconds")],m:[$e,ve("minutes")],mm:[$e,ve("minutes")],H:[$e,ve("hours")],h:[$e,ve("hours")],HH:[$e,ve("hours")],hh:[$e,ve("hours")],D:[$e,ve("day")],DD:[bi,ve("day")],Do:[qt,function(r){var e=Re,t=e.ordinal,i=r.match(/\d+/);if(this.day=i[0],!!t)for(var a=1;a<=31;a+=1)t(a).replace(/\[|\]/g,"")===r&&(this.day=a)}],M:[$e,ve("month")],MM:[bi,ve("month")],MMM:[qt,function(r){var e=pa("months"),t=pa("monthsShort"),i=(t||e.map(function(a){return a.slice(0,3)})).indexOf(r)+1;if(i<1)throw new Error;this.month=i%12||i}],MMMM:[qt,function(r){var e=pa("months"),t=e.indexOf(r)+1;if(t<1)throw new Error;this.month=t%12||t}],Y:[ol,ve("year")],YY:[bi,function(r){this.year=Co(r)}],YYYY:[rl,ve("year")],Z:Ir,ZZ:Ir};function dl(r){var e=r.afternoon;if(e!==void 0){var t=r.hours;e?t<12&&(r.hours+=12):t===12&&(r.hours=0),delete r.afternoon}}function cl(r){r=el(r,Re&&Re.formats);for(var e=r.match(tl),t=e.length,i=0;i<t;i+=1){var a=e[i],o=ll[a],s=o&&o[0],l=o&&o[1];l?e[i]={regex:s,parser:l}:e[i]=a.replace(/^\[|\]$/g,"")}return function(d){for(var c={},m=0,v=0;m<t;m+=1){var f=e[m];if(typeof f=="string")v+=f.length;else{var w=f.regex,x=f.parser,$=d.slice(v),E=w.exec($),A=E[0];x.call(c,A),d=d.replace(A,"")}}return dl(c),c}}var hl=function(e,t,i){try{if(["x","X"].indexOf(t)>-1)return new Date((t==="X"?1e3:1)*e);var a=cl(t),o=a(e),s=o.year,l=o.month,d=o.day,c=o.hours,m=o.minutes,v=o.seconds,f=o.milliseconds,w=o.zone,x=new Date,$=d||(!s&&!l?x.getDate():1),E=s||x.getFullYear(),A=0;s&&!l||(A=l>0?l-1:x.getMonth());var F=c||0,R=m||0,B=v||0,K=f||0;return w?new Date(Date.UTC(E,A,$,F,R,B,K+w.offset*60*1e3)):i?new Date(Date.UTC(E,A,$,F,R,B,K)):new Date(E,A,$,F,R,B,K)}catch{return new Date("")}},pl=function(r,e,t){t.p.customParseFormat=!0,r&&r.parseTwoDigitYear&&(Co=r.parseTwoDigitYear);var i=e.prototype,a=i.parse;i.parse=function(o){var s=o.date,l=o.utc,d=o.args;this.$u=l;var c=d[1];if(typeof c=="string"){var m=d[2]===!0,v=d[3]===!0,f=m||v,w=d[2];v&&(w=d[2]),Re=this.$locale(),!m&&w&&(Re=t.Ls[w]),this.$d=hl(s,c,l),this.init(),w&&w!==!0&&(this.$L=this.locale(w).$L),f&&s!=this.format(c)&&(this.$d=new Date("")),Re={}}else if(c instanceof Array)for(var x=c.length,$=1;$<=x;$+=1){d[1]=c[$-1];var E=t.apply(this,d);if(E.isValid()){this.$d=E.$d,this.$L=E.$L,this.init();break}$===x&&(this.$d=new Date(""))}else a.call(this,o)}};const ul=Object.freeze({processing:"processing",complete:"complete"});class ml extends O{static get properties(){return{mode:{type:String}}}constructor(){super(),this.mode=ul.processing}render(){return u`
    ...
    `:_}render(){return this.hasBinData?u`
      <div
        id="container"
        class="
          noselect
...
`;let X=class extends O{constructor(){super(...arguments),this.prompt="Do you find this feature useful?",this.buttonText="Beta",this.isOpen=!1,this.processing=!1,this.popupTopX=0,this.popupTopY=0,this.voteSubmitted=!1,this.voteNeedsChoosing=!1,this.resizingElement=document.body}render(){return u`
      ...
      >
        ...
        >
          <form @submit=${this.submit} id="form" ?disabled=${this.processing}>
            ...
            ${this.error?u`<div id="error">${this.error}</div>`:_}
            <div id="actions">
              <button
                @click=${this.cancel}
                id="cancel-button"
    ...
    `}};n([h({type:String})],X.prototype,"featureIdentifier",void 0);n([h({type:String})],X.prototype,"prompt",void 0);n([h({type:String})],X.prototype,"buttonText",void 0);n([h({type:Object})],X.prototype,"recaptchaManager",void 0);n([h({type:Object})],X.prototype,"resizeObserver",void 0);n([h({type:Boolean})],X.prototype,"disabled",void 0);n([h({type:Object})],X.prototype,"featureFeedbackService",void 0);n([pe("#beta-button")],X.prototype,"betaButton",void 0);n([pe("#popup")],X.prototype,"popup",void 0);n([z()],X.prototype,"isOpen",void 0);n([z()],X.prototype,"processing",void 0);n([z()],X.prototype,"popupTopX",void 0);n([z()],X.prototype,"popupTopY",void 0);n([z()],X.prototype,"vote",void 0);n([z()],X.prototype,"voteSubmitted",void 0);n([z()],X.prototype,"error",void 0);n([z()],X.prototype,"voteNeedsChoosing",void 0);n([z()],X.prototype,"recaptchaWidget",void 0);n([pe("#comments")],X.prototype,"comments",void 0);X=n([N("feature-feedback")],X);class ko{constructor(e){var t,i,a,o,s,l,d;this.title=e==null?void 0:e.title,this.subtitle=e==null?void 0:e.subtitle,this.headline=e==null?void 0:e.headline,this.message=e==null?void 0:e.message,this.headerColor=(t=e==null?void 0:e.headerColor)!==null&&t!==void 0?t:"#55A183",this.bodyColor=(i=e==null?void 0:e.bodyColor)!==null&&i!==void 0?i:"#f5f5f7",this.showProcessingIndicator=(a=e==null?void 0:e.showProcessingIndicator)!==null&&a!==void 0?a:!1,this.processingImageMode=(o=e==null?void 0:e.processingImageMode)!==null&&o!==void 0?o:"complete",this.showCloseButton=(s=e==null?void 0:e.showCloseButton)!==null&&s!==void 0?s:!0,this.showHeaderLogo=(l=e==null?void 0:e.showHeaderLogo)!==null&&l!==void 0?l:!0,this.closeOnBackdropClick=(d=e==null?void 0:e.closeOnBackdropClick)!==null&&d!==void 0?d:!0}}var Ll=u`
<svg
  viewBox="0 0 40 40"
  version="1.1"
  xmlns="http://www.w3.org/2000/svg"
...
`;let Ma=class extends O{constructor(){super(...arguments),this.config=new ko}render(){return u`
      <div class="modal-wrapper">
        <div class="modal-container">
          <header style="background-color: ${this.config.headerColor}">
            ${this.config.showCloseButton?this.closeButtonTemplate:""}
            ${this.config.showHeaderLogo?u`<div class="logo-icon">${Fl}</div>`:_}
...
`;let Lt=class extends O{constructor(){super(...arguments),this.step=2,this.currentPage=1,this.pages=[]}firstUpdated(){this.observePageCount()}updated(e){e.has("size")&&this.observePageCount(),e.has("currentPage")&&(this.observePageCount(),this.emitPageClick())}observePageCount(){this.pages=[];const e=7,t=this.size<=e;if(this.size<=5){this.pages=[...Array(this.size).keys()].map(o=>o+1);return}if(this.size===e){if(this.currentPage===2){this.pages=[1,2,3,4,0,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,4,5,this.size-1,this.size];return}}if(this.currentPage===1){this.pages=[1,2,3,0,this.size];return}if(this.currentPage===this.size){this.pages=[1,0,this.size-2,this.size-1,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,this.size-3,this.size-2,this.size-1,this.size];return}if(t&&this.currentPage>1&&this.currentPage<e){this.pages=[...Array(this.size).keys()].map(o=>o+1);return}let i=this.currentPage-this.step,a=this.currentPage+this.step;i<=0&&(a+=-i+1,i=1),a>=this.size&&(i=Math.max(i-(a-this.size),1),a=this.size),i===2&&(a-=1),a===this.size-1&&(i+=1),this.createFirstNode(i),this.createMiddelNode(i,a),this.createLastNode(a)}createFirstNode(e){var t,i;e>1&&((t=this.pages)===null||t===void 0||t.push(1)),e>2&&((i=this.pages)===null||i===void 0||i.push(0))}createMiddelNode(e,t){var i;for(let a=e;a<=t;a+=1)(i=this.pages)===null||i===void 0||i.push(a)}createLastNode(e){var t,i;e<this.size-1&&((t=this.pages)===null||t===void 0||t.push(0)),e<this.size&&((i=this.pages)===null||i===void 0||i.push(this.size))}get getEllipsisTemplate(){return u`<i class="ellipses">...</i>`}emitPageClick(){this.dispatchEvent(new CustomEvent("pageNumberClicked",{detail:{page:this.currentPage},bubbles:!0,composed:!0}))}onRewind(){this.currentPage-=1,this.currentPage<1&&(this.currentPage=1)}onForward(){this.currentPage+=1,this.currentPage>this.size&&(this.currentPage=this.size)}onChange(e){this.currentPage=e}getPageTemplate(e){return u`
    ...
    `}get getPagesTemplate(){var e;return!this.pages||!this.pages.length?_:u`
...
`;let Ft=class extends O{facetClicked(e,t,i){const a=e.target,{checked:o,name:s,value:l}=a;o?this.facetChecked(s,l,t,i):this.facetUnchecked(s,l)}facetChecked(e,t,i,a){const{selectedFacets:o}=this;let s;o?s=le({},o):s=Di,s[e][t]={state:a?"hidden":"selected",count:i},this.selectedFacets=s,this.dispatchSelectedFacetsChanged()}facetUnchecked(e,t){const{selectedFacets:i}=this;let a;i?a=le({},i):a=Di,delete a[e][t],this.selectedFacets=a,this.dispatchSelectedFacetsChanged()}dispatchSelectedFacetsChanged(){const e=new CustomEvent("selectedFacetsChanged",{detail:this.selectedFacets,bubbles:!0,composed:!0});this.dispatchEvent(e)}getFacetsTemplate(e){let t=e==null?void 0:e.buckets;return t=[...t.filter(i=>i.state==="selected").sort((i,a)=>i.count<a.count?1:-1),...t.filter(i=>i.state==="hidden").sort((i,a)=>i.count<a.count?1:-1),...t.filter(i=>i.state==="none")],u`
      <div class="facets-on-${this.renderOn}">
        ${ho(t,i=>`${e.key}:${i.key}`,i=>{var a,o;const s=`${e.key}:${i.key}-show-only`,l=`${e.key}:${i.key}-negative`,d=e.key!=="collection"?u`${(a=i.displayText)!==null&&a!==void 0?a:i.key}`:u`<a href="/details/${i.key}">
                    <async-collection-name
                      .collectionNameCache=${this.collectionNameCache}
                      .identifier=${i.key}
                      placeholder="-"
                    ></async-collection-name>
                  </a> `,c=i.state==="hidden",m=i.state==="selected",v=`${e.key}: ${(o=i.displayText)!==null&&o!==void 0?o:i.key}`,f=m?`Show all ${e.key}s`:`Only show ${v}`,w=`Hide ${v}`,x=`Unhide ${v}`,$=c?x:w;return u`
              <div class="facet-row">
    ...
    `}get loaderTemplate(){return u`<div class="facets-loader">
      <ia-activity-indicator .mode=${"processing"}></ia-activity-indicator>
        ...
        ></more-facets-pagination>`:_}get footerTemplate(){return this.paginationSize>0?u`${this.facetsPaginationTemplate}
        <div class="footer">
          <button
        ...
        </div> `:_}sortFacetAggregation(){this.sortedBy=this.sortedBy==="count"?"alpha":"count",this.dispatchEvent(new CustomEvent("sortedFacets",{detail:this.sortedBy}))}get getModalHeaderTemplate(){const e=this.sortedBy==="alpha"?"Sort by count":"Sort by alphabetically",t=this.sortedBy==="alpha"?"https://archive.org/images/filter-alpha.png":"https://archive.org/images/filter-count.png";return u`<span class="sr-only">More facets for:</span>
      <span class="title">
    ...
    `}getTombstoneFacetGroupTemplate(){return u`
      ${Sa(Array(5).fill(null),()=>u`<facet-tombstone-row></facet-tombstone-row>`)}
    `}moreFacetsSortingIcon(e){return e.key==="lending"?_:u`
          <input
            class="sorting-icon"
            type="image"
          ...
          />
        `}searchMoreFacetsLink(e){return!this.moreLinksVisible||e.key==="lending"||Object.keys(e.buckets).length<this.allowedFacetCount?_:u`<button
      class="more-link"
    ...
    `,l=new ko({bodyColor:"#fff",headerColor:"#194880",showHeaderLogo:!1,closeOnBackdropClick:!0,title:u`Select filters`});(i=this.modalManager)===null||i===void 0||i.classList.add("more-search-facets"),(a=this.modalManager)===null||a===void 0||a.showModal({config:l,customModalContent:s})}getFacetTemplate(e){return u`
      <facets-template
        .facetGroup=${e}
        .selectedFacets=${this.selectedFacets}
        .renderOn=${"page"}
...
`;let Ii=class extends O{constructor(){super(...arguments),this.placeholderType=null}render(){return this.placeholderType?u`${this.placeholderTemplate}`:_}get placeholderTemplate(){return u`
      <div
