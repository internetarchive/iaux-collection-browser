 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{I:t0}=Rh,Bl=i=>i,dd=i=>i.strings===void 0,Rl=()=>document.createComment(""),ds=(i,e,t)=>{var o;const s=i._$AA.parentNode,r=e===void 0?i._$AB:e._$AA;if(t===void 0){const a=s.insertBefore(Rl(),r),l=s.insertBefore(Rl(),r);t=new t0(a,l,i,i.options)}else{const a=t._$AB.nextSibling,l=t._$AM,n=l!==i;if(n){let c;(o=t._$AQ)==null||o.call(t,i),t._$AM=i,t._$AP!==void 0&&(c=i._$AU)!==l._$AU&&t._$AP(c)}if(a!==r||n){let c=t._$AA;for(;c!==a;){const u=Bl(c).nextSibling;Bl(s).insertBefore(c,r),c=u}}}return t},ei=(i,e,t=i)=>(i._$AI(e,t),i),i0={},hd=(i,e=i0)=>i._$AH=e,s0=i=>i._$AH,Do=i=>{i._$AR(),i._$AA.remove()};/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function fr(i,e,t){return i?e(i):t==null?void 0:t(i)}function o0(i,e){return e.some(t=>i.has(t))}function a0(i,e){const t=[...i],s=[...e],r=t.length,o=s.length;if(r===0)return!0;let a=0,l=0;for(;l<o;){if(s[l]===t[a]&&(a+=1),a>=r)return!0;l+=1}return!1}const pd=S`
  :host {
    /*
    BASE STYLES
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ud=(i,e,t)=>{for(const s of e)if(s[0]===i)return(0,s[1])();return t==null?void 0:t()},m0=Q`
...
`;var md=(i=>(i[i.bytes=0]="bytes",i[i.kilobytes=1]="kilobytes",i[i.megabytes=2]="megabytes",i[i.gigabytes=3]="gigabytes",i[i.terabytes=4]="terabytes",i[i.petabytes=5]="petabytes",i[i.exabytes=6]="exabytes",i[i.zettabytes=7]="zettabytes",i[i.yottabytes=8]="yottabytes",i))(md||{});function b0(i,e,t=" "){let s=i;if(s===void 0)return b;let r=0;for(;s>1024;)s/=1024,r+=1;const o=10**e;s=Math.round(s*o)/o;let a=md[r];return a=s===1?a.slice(0,-1):a,`${s.toLocaleString()+t+a}`}const y0=S`var(--tileBackgroundColor, #ffffff)`,w0=S`var(--tileCornerRadius, 4px)`,Jr=S`
...
`;function gd(i,e="short",{locale:t="en-US",useLocalTime:s=!1}={}){if(!i)return"";const r=s?{}:{timeZone:"UTC"};switch(e){case"year-only":return`${i.getUTCFullYear()}`;case"short":r.month="short",r.year="numeric";break;case"long":r.year="numeric",r.month="short",r.day="2-digit";break}return new Intl.DateTimeFormat(t,r).format(i)}class zl{constructor(e={}){this.model=e.model,this.baseNavigationUrl=e.baseNavigationUrl,this.collectionPagePath=e.collectionPagePath??"/details/",this.sortParam=e.sortParam,this.creatorFilter=e.creatorFilter}get firstCreatorMatchingFilter(){var t,s;let e;if(this.creatorFilter&&((t=this.model)!=null&&t.creators.length)){const r=this.creatorFilter;e=this.model.creators.find(o=>o.normalize("NFD").replace(/[^A-Z]+/gi,"").toUpperCase().startsWith(r))}return e??((s=this.model)==null?void 0:s.creator)}get accountLabel(){var e;return(e=this.model)!=null&&e.dateAdded?C(wt`Archivist since ${this.model.dateAdded.getFullYear()}`):""}get dateLabel(){var e;switch((e=this.sortParam)==null?void 0:e.field){case"publicdate":return C("Archived");case"reviewdate":return C("Reviewed");case"addeddate":return C("Added");case"date":return C("Published");default:return""}}itemPageUrl(e,t=!1){if(!e||this.baseNavigationUrl==null)return b;const s=t?this.collectionPagePath:"/details/";return`${this.baseNavigationUrl}${s}${e}`}webArchivesCaptureLink(e,t){const r=`https://web.archive.org/web/${t.toISOString().replace(/[TZ:-]/g,"").replace(/\..*/,"")}/${encodeURIComponent(e)}`,o=gd(t,"long");return p` <a href=${r}> ${o} </a> `}}var $0=Object.defineProperty,Ge=(i,e,t,s)=>{for(var r=void 0,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=a(e,t,r)||r);return r&&$0(e,t,r),r};class ge extends H{constructor(){super(...arguments),this.sortParam=null,this.defaultSortParam=null,this.loggedIn=!1,this.suppressBlurring=!1,this.useLocalTime=!1,this.displayValueProvider=new zl}willUpdate(e){(e.has("model")||e.has("baseNavigationUrl")||e.has("collectionPagePath")||e.has("sortParam")||e.has("defaultSortParam")||e.has("creatorFilter"))&&(this.displayValueProvider=new zl({model:this.model,baseNavigationUrl:this.baseNavigationUrl,collectionPagePath:this.collectionPagePath,sortParam:this.sortParam??this.defaultSortParam??void 0,creatorFilter:this.creatorFilter}))}getFormattedDate(e,t){const{useLocalTime:s}=this;return gd(e,t,{useLocalTime:s})}}Ge([h({type:Object})],ge.prototype,"model");Ge([h({type:Number})],ge.prototype,"currentWidth");Ge([h({type:Number})],ge.prototype,"currentHeight");Ge([h({type:String})],ge.prototype,"baseNavigationUrl");Ge([h({type:String})],ge.prototype,"baseImageUrl");Ge([h({type:String})],ge.prototype,"collectionPagePath");Ge([h({type:Object})],ge.prototype,"sortParam");Ge([h({type:Object})],ge.prototype,"defaultSortParam");Ge([h({type:String})],ge.prototype,"creatorFilter");Ge([h({type:Number})],ge.prototype,"mobileBreakpoint");Ge([h({type:Boolean})],ge.prototype,"loggedIn");Ge([h({type:Boolean})],ge.prototype,"suppressBlurring");Ge([h({type:Boolean})],ge.prototype,"useLocalTime");var S0=Object.defineProperty,x0=Object.getOwnPropertyDescriptor,vd=(i,e,t,s)=>{for(var r=s>1?void 0:s?x0(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&S0(e,t,r),r};let ka=class extends H{render(){return p`<div class="icon-overlay">${this.iconTemplate}</div>`}get iconTemplate(){return this.type?p`${td[this.type]??b}`:b}static get styles(){return S`
    ...
    `}};vd([h({type:String})],ka.prototype,"type",2);ka=vd([U("icon-overlay")],ka);var C0=Object.defineProperty,_0=Object.getOwnPropertyDescriptor,bd=(i,e,t,s)=>{for(var r=s>1?void 0:s?_0(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&C0(e,t,r),r};let Ea=class extends H{render(){return p`
    ...
    `}};Gt([h({type:String})],Dt.prototype,"baseImageUrl",2);Gt([h({type:Boolean})],Dt.prototype,"isCompactTile",2);Gt([h({type:Boolean})],Dt.prototype,"isListTile",2);Gt([h({type:Boolean})],Dt.prototype,"loggedIn",2);Gt([h({type:Boolean})],Dt.prototype,"suppressBlurring",2);Gt([h({type:Object})],Dt.prototype,"model",2);Gt([h({type:String})],Dt.prototype,"viewSize",2);Dt=Gt([U("image-block")],Dt);var E0=Object.defineProperty,A0=Object.getOwnPropertyDescriptor,cn=(i,e,t,s)=>{for(var r=s>1?void 0:s?A0(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&E0(e,t,r),r};let Fr=class extends ge{constructor(){super(...arguments),this.showInfoButton=!1,this.layoutType="default"}render(){const i=We({container:!0,minimal:this.layoutType==="minimal"});return p`
      <div class=${i}>
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*mr(i,e){const t=typeof e=="function";if(i!==void 0){let s=-1;for(const r of i)s>-1&&(yield t?e(s):e),s++,yield r}}var D0=Object.defineProperty,L0=Object.getOwnPropertyDescriptor,hn=(i,e,t,s)=>{for(var r=s>1?void 0:s?L0(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&D0(e,t,r),r};let Br=class extends H{constructor(){super(...arguments),this.snippets=[],this.viewSize="desktop"}render(){var i;return(i=this.snippets)!=null&&i.length?p`
      <div class="container">
        <div class="snippet-view ${this.viewSize}">
    ...
    `}};hn([h({type:Array})],Br.prototype,"snippets",2);hn([h({type:String})],Br.prototype,"viewSize",2);Br=hn([U("text-snippet-block")],Br);const F0=S`
  .drop-shadow {
    overflow: hidden;
    height: 100%;
  }
...
`,$d={account:{color:"#000000",icon:I0,text:"Account"},audio:{color:"#00adef",icon:N0,text:"Audio"},collection:{color:"#4666ff",icon:fd,text:"Collection"},data:{color:"#333333",icon:U0,text:"Data"},etree:{color:"#00adef",icon:H0,text:"E-tree"},film:{color:"#bf1b2c",icon:Il,text:"Film"},image:{color:"#aa99c9",icon:V0,text:"Image"},movies:{color:"#f1644b",icon:Il,text:"Movie"},none:{color:"#00000000",icon:p``,text:""},radio:{color:"#8fdaef",icon:j0,text:"Radio"},software:{color:"#9ecc4f",icon:W0,text:"Software"},texts:{color:"#faab3c",icon:q0,text:"Text"},tv:{color:"#f1644b",icon:G0,text:"TV"},tvCommercial:{color:"#84b648",icon:Y0,text:"TV Commercial"},tvFactCheck:{color:"#f1644b",icon:Q0,text:"TV Fact Check"},tvQuote:{color:"#fe7a5f",icon:Z0,text:"TV Quote"},video:{color:"#f1644b",icon:K0,text:"Video"},web:{color:"#ffcd27",icon:X0,text:"Web"},search:{color:"#000000",icon:wd,text:"Search"}};var J0=Object.defineProperty,ep=Object.getOwnPropertyDescriptor,pn=(i,e,t,s)=>{for(var r=s>1?void 0:s?ep(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&J0(e,t,r),r};const tp="tv_ads",ip="factchecked",sp=new Set(["tvnews","tvarchive","television"]),rp=new Set(["radio","radioprogram"]);let Rr=class extends H{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var i;return this.isTvItem?this.tvDisplayMediatype:this.isRadioItem?"radio":((i=this.model)==null?void 0:i.mediatype)??"none"}get tvDisplayMediatype(){var i,e;return this.isTvCommercial?"tvCommercial":(i=this.model)!=null&&i.isTvSearchResult&&this.isTvFactCheck?"tvFactCheck":(e=this.model)!=null&&e.isTvSearchResult&&this.isTvQuote?"tvQuote":"tv"}get isTvItem(){var i,e;return!!(((i=this.model)==null?void 0:i.mediatype)==="movies"&&((e=this.model)!=null&&e.collections.some(t=>sp.has(t))))}get isTvCommercial(){var i,e,t;return!!((e=(i=this.model)==null?void 0:i.adIds)!=null&&e.length||(t=this.model)!=null&&t.collections.includes(tp))}get isTvFactCheck(){var i,e,t;return!!((e=(i=this.model)==null?void 0:i.factChecks)!=null&&e.length||(t=this.model)!=null&&t.collections.includes(ip))}get isTvQuote(){var i;return!!((i=this.model)!=null&&i.isClip)}get isRadioItem(){var i,e;return!!(((i=this.model)==null?void 0:i.mediatype)==="audio"&&((e=this.model)!=null&&e.collections.some(t=>rp.has(t))))}render(){const i=$d[this.displayMediatype];return i?p`
      <div
        id="icon"
    ...
    `}};pn([h({type:Object})],Rr.prototype,"model",2);pn([h({type:Boolean})],Rr.prototype,"showText",2);Rr=pn([U("tile-mediatype-icon")],Rr);const op=Q`
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path
...
`;function cp(i,e){let t=1;return i>=1e9?t=1e9:i>=1e6?t=1e6:i>=1e3&&e==="short"&&(t=1e3),t}function dp(i=0,e){const t=i/e,s=t<10;let r=0;return s?r=Math.round((t+Number.EPSILON)*10)/10:r=Math.round(t),r}function hp(i,e,t,s){switch(e){case 1e9:return C(t==="short"?wt`${i}B`:wt`${i} billion`);case 1e6:return C(t==="short"?wt`${i}M`:wt`${i} million`);case 1e3:return C(t==="short"?wt`${i}K`:wt`${i} thousand`);default:return new Intl.NumberFormat(s).format(i)}}function un(i,e="long",t="short",s="en-US"){const r=i??-1;if(r<0)return"";const o=cp(r,e),a=dp(r,o);return hp(a,o,t,s)}var pp=Object.defineProperty,up=Object.getOwnPropertyDescriptor,xt=(i,e,t,s)=>{for(var r=s>1?void 0:s?up(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&pp(e,t,r),r};let pt=class extends H{constructor(){super(...arguments),this.showTvClips=!1}render(){return p`
    ...
    `}get isSortedByDate(){var i;return["date","reviewdate","addeddate","publicdate"].includes((i=this.effectiveSort)==null?void 0:i.field)}get effectiveSort(){return this.sortParam??this.defaultSortParam}get hasSnippets(){var i,e;return!!((e=(i=this.model)==null?void 0:i.snippets)!=null&&e.length)}infoButtonPressed(i){i.preventDefault();const e=new CustomEvent("infoButtonPressed",{detail:{x:i.clientX,y:i.clientY}});this.dispatchEvent(e)}static get styles(){const i=S`var(--tileBorderColor, #dddddd)`;return[Jr,S`
      ...
      `]}};eo([h({type:Boolean})],Vs.prototype,"showInfoButton",2);eo([h({type:Boolean})],Vs.prototype,"showTvClips",2);eo([h({type:String})],Vs.prototype,"layoutType",2);Vs=eo([U("item-tile")],Vs);var gp=Object.defineProperty,vp=Object.getOwnPropertyDescriptor,Sd=(i,e,t,s)=>{for(var r=s>1?void 0:s?vp(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&gp(e,t,r),r};let Aa=class extends ge{constructor(){super(...arguments),this.showInfoButton=!1}render(){return p`
      <div class="container">
        ${this.infoButtonTemplate}
        <div class="tile-details">
          <div class="item-info">
...
`+He),xi&&nr([_t,ne,ye],bt=>{He=ps(He,bt," ")}),I&&Js?I.createHTML(He):He},e.setConfig=function(){let B=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};fo(B),no=!0},e.clearConfig=function(){Ei=null,no=!1},e.isValidAttribute=function(B,m,_){Ei||fo({});const F=_e(B),re=_e(m);return Nn(F,re,_)},e.addHook=function(B,m){typeof m=="function"&&hs(he[B],m)},e.removeHook=function(B,m){if(m!==void 0){const _=Ep(he[B],m);return _===-1?void 0:Ap(he[B],_,1)[0]}return Ul(he[B])},e.removeHooks=function(B){he[B]=[]},e.removeAllHooks=function(){he=Yl()},e}var br=Md(),qp=Object.defineProperty,Gp=Object.getOwnPropertyDescriptor,fn=(i,e,t,s)=>{for(var r=s>1?void 0:s?Gp(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&qp(e,t,r),r};let zr=class extends ge{constructor(){super(...arguments),this.collectionLinks=[]}render(){return p`
    ...
    `}};Ql=Xp([U("tile-list-compact")],Ql);var Zp=Object.getOwnPropertyDescriptor,Jp=(i,e,t,s)=>{for(var r=s>1?void 0:s?Zp(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=a(r)||r);return r};let Kl=class extends ge{render(){return p`
