...
`;function cp(i,e){let t=1;return i>=1e9?t=1e9:i>=1e6?t=1e6:i>=1e3&&e==="short"&&(t=1e3),t}function dp(i=0,e){const t=i/e,s=t<10;let r=0;return s?r=Math.round((t+Number.EPSILON)*10)/10:r=Math.round(t),r}function hp(i,e,t,s){switch(e){case 1e9:return C(t==="short"?wt`${i}B`:wt`${i} billion`);case 1e6:return C(t==="short"?wt`${i}M`:wt`${i} million`);case 1e3:return C(t==="short"?wt`${i}K`:wt`${i} thousand`);default:return new Intl.NumberFormat(s).format(i)}}function un(i,e="long",t="short",s="en-US"){const r=i??-1;if(r<0)return"";const o=cp(r,e),a=dp(r,o);return hp(a,o,t,s)}var pp=Object.defineProperty,up=Object.getOwnPropertyDescriptor,xt=(i,e,t,s)=>{for(var r=s>1?void 0:s?up(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&pp(e,t,r),r};let pt=class extends H{constructor(){super(...arguments),this.showTvClips=!1}render(){return p`
    ...
    `}get isSortedByDate(){var i;return["date","reviewdate","addeddate","publicdate"].includes((i=this.effectiveSort)==null?void 0:i.field)}get effectiveSort(){return this.sortParam??this.defaultSortParam}get hasSnippets(){var i,e;return!!((e=(i=this.model)==null?void 0:i.snippets)!=null&&e.length)}infoButtonPressed(i){i.preventDefault();const e=new CustomEvent("infoButtonPressed",{detail:{x:i.clientX,y:i.clientY}});this.dispatchEvent(e)}static get styles(){const i=S`var(--tileBorderColor, #dddddd)`;return[Jr,S`
      ...
      `]}};eo([h({type:Boolean})],Vs.prototype,"showInfoButton",2);eo([h({type:Boolean})],Vs.prototype,"showTvClips",2);eo([h({type:String})],Vs.prototype,"simpleLayoutType",2);Vs=eo([U("item-tile")],Vs);var gp=Object.defineProperty,vp=Object.getOwnPropertyDescriptor,Sd=(i,e,t,s)=>{for(var r=s>1?void 0:s?vp(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&gp(e,t,r),r};let Aa=class extends ge{constructor(){super(...arguments),this.showInfoButton=!1}render(){return p`
      <div class="container">
        ${this.infoButtonTemplate}
        <div class="tile-details">
          <div class="item-info">
