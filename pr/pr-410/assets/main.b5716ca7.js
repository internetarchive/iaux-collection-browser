var xl=Object.defineProperty,Sl=Object.defineProperties;var $l=Object.getOwnPropertyDescriptors;var ur=Object.getOwnPropertySymbols;var Cl=Object.prototype.hasOwnProperty,kl=Object.prototype.propertyIsEnumerable;var fr=(a,e,t)=>e in a?xl(a,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):a[e]=t,G=(a,e)=>{for(var t in e||(e={}))Cl.call(e,t)&&fr(a,t,e[t]);if(ur)for(var t of ur(e))kl.call(e,t)&&fr(a,t,e[t]);return a},le=(a,e)=>Sl(a,$l(e));import Ko from"https://esm.archive.org/dayjs@1.11.10";import Tl from"https://esm.archive.org/dayjs@1.9.4/esm/plugin/customParseFormat";const El=function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const s of r.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function t(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerpolicy&&(r.referrerPolicy=o.referrerpolicy),o.crossorigin==="use-credentials"?r.credentials="include":o.crossorigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(o){if(o.ep)return;o.ep=!0;const r=t(o);fetch(o.href,r)}};El();function l(a,e,t,i){var o=arguments.length,r=o<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(a,e,t,i);else for(var n=a.length-1;n>=0;n--)(s=a[n])&&(r=(o<3?s(r):o>3?s(e,t,r):s(e,t))||r);return o>3&&r&&Object.defineProperty(e,t,r),r}function Ml(a,e,t,i){function o(r){return r instanceof t?r:new t(function(s){s(r)})}return new(t||(t=Promise))(function(r,s){function n(f){try{p(i.next(f))}catch(m){s(m)}}function d(f){try{p(i.throw(f))}catch(m){s(m)}}function p(f){f.done?r(f.value):o(f.value).then(n,d)}p((i=i.apply(a,e||[])).next())})}class zl{constructor(e){var t,i,o,r;this.ARCHIVE_ANALYTICS_VERSION=2,this.DEFAULT_SERVICE="ao_2",this.NO_SAMPLING_SERVICE="ao_no_sampling",this.DEFAULT_IMAGE_URL="https://analytics.archive.org/0.gif",this.defaultService=(t=e==null?void 0:e.defaultService)!==null&&t!==void 0?t:this.DEFAULT_SERVICE,this.imageUrl=(i=e==null?void 0:e.imageUrl)!==null&&i!==void 0?i:this.DEFAULT_IMAGE_URL,this.imageContainer=(o=e==null?void 0:e.imageContainer)!==null&&o!==void 0?o:document.body,this.requireImagePing=(r=e==null?void 0:e.requireImagePing)!==null&&r!==void 0?r:!1}sendPing(e){const t=this.generateTrackingUrl(e).toString();if(this.requireImagePing){this.sendPingViaImage(t);return}const i=navigator.sendBeacon&&navigator.sendBeacon.bind(navigator);try{i(t)}catch{this.sendPingViaImage(t)}}sendEvent(e){const t=e.label&&e.label.trim().length>0?e.label:window.location.pathname,i=G({kind:"event",ec:e.category,ea:e.action,el:t,cache_bust:Math.random()},e.eventConfiguration);this.sendPing(i)}sendEventNoSampling(e){const t=e.eventConfiguration||{};t.service=this.NO_SAMPLING_SERVICE;const i=e;i.eventConfiguration=t,this.sendEvent(i)}sendPingViaImage(e){const t=new Image(1,1);t.src=e,t.alt="",this.imageContainer.appendChild(t)}generateTrackingUrl(e){var t;const i=e!=null?e:{};i.service=(t=i.service)!==null&&t!==void 0?t:this.defaultService;const o=new URL(this.imageUrl),r=Object.keys(i);return r.forEach(s=>{const n=i[s];o.searchParams.append(s,n)}),o.searchParams.append("version",`${this.ARCHIVE_ANALYTICS_VERSION}`),o.searchParams.append("count",`${r.length+2}`),o}}function g(a){let e,t,i;return typeof a=="object"?(e=a.hashFunction,t=a.expiring,i=a.tags):e=a,(o,r,s)=>{if(s.value!=null)s.value=vr(s.value,e,t,i);else if(s.get!=null)s.get=vr(s.get,e,t,i);else throw"Only put a Memoize() decorator on a method or get accessor."}}const _o=new Map;function vr(a,e,t=0,i){const o=Symbol("__memoized_map__");return function(...r){let s;this.hasOwnProperty(o)||Object.defineProperty(this,o,{configurable:!1,enumerable:!1,writable:!1,value:new Map});let n=this[o];if(Array.isArray(i))for(const d of i)_o.has(d)?_o.get(d).push(n):_o.set(d,[n]);if(e||r.length>0||t>0){let d;e===!0?d=r.map(m=>m.toString()).join("!"):e?d=e.apply(this,r):d=r[0];const p=`${d}__timestamp`;let f=!1;if(t>0)if(!n.has(p))f=!0;else{let m=n.get(p);f=Date.now()-m>t}n.has(d)&&!f?s=n.get(d):(s=a.apply(this,r),n.set(d,s),t>0&&n.set(p,Date.now()))}else{const d=this;n.has(d)?s=n.get(d):(s=a.apply(this,r),n.set(d,s))}return s}}class qo{parseValue(e){return typeof e=="string"&&(e==="false"||e==="0")?!1:Boolean(e)}}qo.shared=new qo;class Ni{parseValue(e){if(typeof e=="number")return e;if(typeof e=="boolean")return;const t=parseFloat(e);if(!Number.isNaN(t))return t}}Ni.shared=new Ni;class Yo{parseValue(e){return Ni.shared.parseValue(e)}}Yo.shared=new Yo;class Xo{parseValue(e){return this.parseJSDate(e)||this.parseBracketDate(e)}parseBracketDate(e){if(typeof e!="string")return;const t=e.match(/\[([0-9]{4})\]/);if(!(!t||t.length<2))return this.parseJSDate(t[1])}parseJSDate(e){if(typeof e!="string")return;let t=e;t.match(/^[0-9]{4}-[0-9]{2}-[0-9]{2}\s{1}[0-9]{2}:[0-9]{2}:[0-9]{2}$/)&&(t=t.replace(" ","T"));const i=Date.parse(t);if(Number.isNaN(i))return;let o=new Date(t);return(t.indexOf("Z")>-1||t.indexOf("+")>-1||t.match(/^[0-9]{4}$/)||t.match(/^[0-9]{4}-[0-9]{2}-[0-9]{2}$/)||t.match(/^.*?-[0-9]{2}:[0-9]{2}$/)||t.match(/^.*?-[0-9]{4}$/))&&(o=new Date(o.getTime()+o.getTimezoneOffset()*1e3*60)),o}}Xo.shared=new Xo;class Zo{parseValue(e){if(typeof e=="number")return e;if(typeof e=="boolean")return;const t=e.split(":");let i;return t.length===1?i=this.parseNumberFormat(t[0]):i=this.parseColonSeparatedFormat(t),i}parseNumberFormat(e){let t=parseFloat(e);return Number.isNaN(t)&&(t=void 0),t}parseColonSeparatedFormat(e){let t=!1;const i=e.map((o,r)=>{const s=parseFloat(o);if(Number.isNaN(s))return t=!0,0;const n=e.length-1-r,d=60**n;return s*Math.floor(d)}).reduce((o,r)=>o+r,0);return t?void 0:i}}Zo.shared=new Zo;class Jo{parseValue(e){if(typeof e=="string")return e}}Jo.shared=new Jo;class Pl{constructor(e,t){this.separators=[";",","],this.parser=e,t&&t.separators&&(this.separators=t.separators)}parseValue(e){const t=String(e);let i=[];for(const o of this.separators)if(i=t.split(o),i.length>1)break;return this.parseListValues(i)}parseListValues(e){const i=e.map(r=>r.trim()).map(r=>this.parser.parseValue(r)),o=[];return i.forEach(r=>{r!==void 0&&o.push(r)}),o}}class ea{parseValue(e){if(typeof e=="string")return e}}ea.shared=new ea;class Hi{parseValue(e){return String(e)}}Hi.shared=new Hi;class De{constructor(e,t){this.parser=e,this.rawValue=t}get values(){return this.parseRawValue()}get value(){return this.values[0]}parseRawValue(){if(this.rawValue===void 0)return[];const e=Array.isArray(this.rawValue)?this.rawValue:[this.rawValue],t=[];return e.forEach(i=>{const o=this.parser.parseValue(i);Array.isArray(o)?t.push(...o):o!==void 0&&t.push(o)}),t}}l([g()],De.prototype,"values",null);l([g()],De.prototype,"value",null);class ut extends De{constructor(e){super(qo.shared,e)}}class V extends De{constructor(e){super(Xo.shared,e)}}class xo extends De{constructor(e){super(Zo.shared,e)}}class N extends De{constructor(e){super(Ni.shared,e)}}class $ extends De{constructor(e){super(Hi.shared,e)}}class Al extends De{constructor(e){super(ea.shared,e)}}class Vi extends De{constructor(e){super(Yo.shared,e)}}class _i extends De{constructor(e){super(Jo.shared,e)}}class Ll extends De{constructor(e,t){super(t,e)}}class Dl extends Ll{constructor(e){const t=new Pl(Hi.shared);super(e,t)}}class E{constructor(e){this.rawMetadata=e}get identifier(){var e;return(e=this.rawMetadata)===null||e===void 0?void 0:e.identifier}get addeddate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.addeddate?new V(this.rawMetadata.addeddate):void 0}get audio_codec(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.audio_codec?new $(this.rawMetadata.audio_codec):void 0}get audio_sample_rate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.audio_sample_rate?new N(this.rawMetadata.audio_sample_rate):void 0}get avg_rating(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.avg_rating?new N(this.rawMetadata.avg_rating):void 0}get collection(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.collection?new $(this.rawMetadata.collection):void 0}get collections_raw(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.collections_raw?new $(this.rawMetadata.collections_raw):void 0}get collection_size(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.collection_size?new Vi(this.rawMetadata.collection_size):void 0}get contributor(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.contributor?new $(this.rawMetadata.contributor):void 0}get coverage(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.coverage?new $(this.rawMetadata.coverage):void 0}get creator(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.creator?new $(this.rawMetadata.creator):void 0}get date(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.date?new V(this.rawMetadata.date):void 0}get description(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.description?new $(this.rawMetadata.description):void 0}get downloads(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.downloads?new N(this.rawMetadata.downloads):void 0}get duration(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.duration?new xo(this.rawMetadata.duration):void 0}get"external-identifier"(){var e,t;return!((e=this.rawMetadata)===null||e===void 0)&&e["external-identifier"]?new $((t=this.rawMetadata)===null||t===void 0?void 0:t["external-identifier"]):void 0}get files_count(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.files_count?new N(this.rawMetadata.files_count):void 0}get indexdate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.indexdate?new V(this.rawMetadata.indexdate):void 0}get isbn(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.isbn?new $(this.rawMetadata.isbn):void 0}get issue(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.issue?new $(this.rawMetadata.issue):void 0}get item_count(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.item_count?new N(this.rawMetadata.item_count):void 0}get item_size(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.item_size?new Vi(this.rawMetadata.item_size):void 0}get language(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.language?new $(this.rawMetadata.language):void 0}get length(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.length?new xo(this.rawMetadata.length):void 0}get lineage(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.lineage?new $(this.rawMetadata.lineage):void 0}get month(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.month?new N(this.rawMetadata.month):void 0}get mediatype(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.mediatype?new _i(this.rawMetadata.mediatype):void 0}get noindex(){var e;return((e=this.rawMetadata)===null||e===void 0?void 0:e.noindex)!=null?new ut(this.rawMetadata.noindex):void 0}get notes(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.notes?new $(this.rawMetadata.notes):void 0}get num_favorites(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.num_favorites?new N(this.rawMetadata.num_favorites):void 0}get num_reviews(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.num_reviews?new N(this.rawMetadata.num_reviews):void 0}get openlibrary_edition(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.openlibrary_edition?new $(this.rawMetadata.openlibrary_edition):void 0}get openlibrary_work(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.openlibrary_work?new $(this.rawMetadata.openlibrary_work):void 0}get page_progression(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.page_progression?new Al(this.rawMetadata.page_progression):void 0}get partner(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.partner?new $(this.rawMetadata.partner):void 0}get ppi(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.ppi?new N(this.rawMetadata.ppi):void 0}get publicdate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.publicdate?new V(this.rawMetadata.publicdate):void 0}get publisher(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.publisher?new $(this.rawMetadata.publisher):void 0}get reviewdate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.reviewdate?new V(this.rawMetadata.reviewdate):void 0}get runtime(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.runtime?new xo(this.rawMetadata.runtime):void 0}get scanner(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.scanner?new $(this.rawMetadata.scanner):void 0}get source(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.source?new $(this.rawMetadata.source):void 0}get start_localtime(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.start_localtime?new V(this.rawMetadata.start_localtime):void 0}get start_time(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.start_time?new V(this.rawMetadata.start_time):void 0}get stop_time(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.stop_time?new V(this.rawMetadata.stop_time):void 0}get subject(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.subject?new Dl(this.rawMetadata.subject):void 0}get taper(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.taper?new $(this.rawMetadata.taper):void 0}get title(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.title?new $(this.rawMetadata.title):void 0}get transferer(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.transferer?new $(this.rawMetadata.transferer):void 0}get track(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.track?new N(this.rawMetadata.track):void 0}get type(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.type?new $(this.rawMetadata.type):void 0}get uploader(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.uploader?new $(this.rawMetadata.uploader):void 0}get utc_offset(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.utc_offset?new N(this.rawMetadata.utc_offset):void 0}get venue(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.venue?new $(this.rawMetadata.venue):void 0}get volume(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.volume?new $(this.rawMetadata.volume):void 0}get week(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.week?new N(this.rawMetadata.week):void 0}get year(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.year?new V(this.rawMetadata.year):void 0}get query(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.query?new $(this.rawMetadata.fields.query):void 0}get date_favorited(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.date_favorited?new V(this.rawMetadata.fields.date_favorited):void 0}get __href__(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.__href__?new $(this.rawMetadata.fields.__href__):void 0}}l([g()],E.prototype,"addeddate",null);l([g()],E.prototype,"audio_codec",null);l([g()],E.prototype,"audio_sample_rate",null);l([g()],E.prototype,"avg_rating",null);l([g()],E.prototype,"collection",null);l([g()],E.prototype,"collections_raw",null);l([g()],E.prototype,"collection_size",null);l([g()],E.prototype,"contributor",null);l([g()],E.prototype,"coverage",null);l([g()],E.prototype,"creator",null);l([g()],E.prototype,"date",null);l([g()],E.prototype,"description",null);l([g()],E.prototype,"downloads",null);l([g()],E.prototype,"duration",null);l([g()],E.prototype,"external-identifier",null);l([g()],E.prototype,"files_count",null);l([g()],E.prototype,"indexdate",null);l([g()],E.prototype,"isbn",null);l([g()],E.prototype,"issue",null);l([g()],E.prototype,"item_count",null);l([g()],E.prototype,"item_size",null);l([g()],E.prototype,"language",null);l([g()],E.prototype,"length",null);l([g()],E.prototype,"lineage",null);l([g()],E.prototype,"month",null);l([g()],E.prototype,"mediatype",null);l([g()],E.prototype,"noindex",null);l([g()],E.prototype,"notes",null);l([g()],E.prototype,"num_favorites",null);l([g()],E.prototype,"num_reviews",null);l([g()],E.prototype,"openlibrary_edition",null);l([g()],E.prototype,"openlibrary_work",null);l([g()],E.prototype,"page_progression",null);l([g()],E.prototype,"partner",null);l([g()],E.prototype,"ppi",null);l([g()],E.prototype,"publicdate",null);l([g()],E.prototype,"publisher",null);l([g()],E.prototype,"reviewdate",null);l([g()],E.prototype,"runtime",null);l([g()],E.prototype,"scanner",null);l([g()],E.prototype,"source",null);l([g()],E.prototype,"start_localtime",null);l([g()],E.prototype,"start_time",null);l([g()],E.prototype,"stop_time",null);l([g()],E.prototype,"subject",null);l([g()],E.prototype,"taper",null);l([g()],E.prototype,"title",null);l([g()],E.prototype,"transferer",null);l([g()],E.prototype,"track",null);l([g()],E.prototype,"type",null);l([g()],E.prototype,"uploader",null);l([g()],E.prototype,"utc_offset",null);l([g()],E.prototype,"venue",null);l([g()],E.prototype,"volume",null);l([g()],E.prototype,"week",null);l([g()],E.prototype,"year",null);l([g()],E.prototype,"query",null);l([g()],E.prototype,"date_favorited",null);l([g()],E.prototype,"__href__",null);class O{constructor(e){this.rawMetadata=e}get identifier(){var e,t;return(t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.identifier}get addeddate(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.addeddate?new V(this.rawMetadata.fields.addeddate):void 0}get avg_rating(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.avg_rating)!=null?new N(this.rawMetadata.fields.avg_rating):void 0}get collection(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.collection?new $(this.rawMetadata.fields.collection):void 0}get collection_files_count(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.collection_files_count)!=null?new N(this.rawMetadata.fields.collection_files_count):void 0}get collection_size(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.collection_size)!=null?new Vi(this.rawMetadata.fields.collection_size):void 0}get creator(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.creator?new $(this.rawMetadata.fields.creator):void 0}get date(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.date?new V(this.rawMetadata.fields.date):void 0}get description(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.description?new $(this.rawMetadata.fields.description):void 0}get downloads(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.downloads)!=null?new N(this.rawMetadata.fields.downloads):void 0}get files_count(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.files_count)!=null?new N(this.rawMetadata.fields.files_count):void 0}get genre(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.genre?new $(this.rawMetadata.fields.genre):void 0}get indexflag(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.indexflag?new $(this.rawMetadata.fields.indexflag):void 0}get issue(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.issue?new $(this.rawMetadata.fields.issue):void 0}get item_count(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.item_count)!=null?new N(this.rawMetadata.fields.item_count):void 0}get item_size(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.item_size)!=null?new Vi(this.rawMetadata.fields.item_size):void 0}get language(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.language?new $(this.rawMetadata.fields.language):void 0}get lending___available_to_borrow(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.lending___available_to_borrow)!=null?new ut(this.rawMetadata.fields.lending___available_to_borrow):void 0}get lending___available_to_browse(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.lending___available_to_browse)!=null?new ut(this.rawMetadata.fields.lending___available_to_browse):void 0}get lending___available_to_waitlist(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.lending___available_to_waitlist)!=null?new ut(this.rawMetadata.fields.lending___available_to_waitlist):void 0}get lending___status(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.lending___status?new $(this.rawMetadata.fields.lending___status):void 0}get licenseurl(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.licenseurl?new $(this.rawMetadata.fields.licenseurl):void 0}get mediatype(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.mediatype?new _i(this.rawMetadata.fields.mediatype):void 0}get month(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.month)!=null?new N(this.rawMetadata.fields.month):void 0}get noindex(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.noindex)!=null?new ut(this.rawMetadata.fields.noindex):void 0}get num_favorites(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.num_favorites)!=null?new N(this.rawMetadata.fields.num_favorites):void 0}get num_reviews(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.num_reviews)!=null?new N(this.rawMetadata.fields.num_reviews):void 0}get publicdate(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.publicdate?new V(this.rawMetadata.fields.publicdate):void 0}get reviewdate(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.reviewdate?new V(this.rawMetadata.fields.reviewdate):void 0}get review(){var e;const t=(e=this.rawMetadata)===null||e===void 0?void 0:e.review;return t?{body:t.reviewbody,title:t.reviewtitle,author:t.reviewer,authorItem:t.reviewer_itemname,updatedate:new Date(t.reviewdate),createdate:new Date(t.createdate),stars:Number(t.stars)||0,__href__:t.__href__}:void 0}get source(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.source?new $(this.rawMetadata.fields.source):void 0}get subject(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.subject?new $(this.rawMetadata.fields.subject):void 0}get title(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.title?new $(this.rawMetadata.fields.title):void 0}get type(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.type?new $(this.rawMetadata.fields.type):void 0}get volume(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.volume?new $(this.rawMetadata.fields.volume):void 0}get week(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.week)!=null?new N(this.rawMetadata.fields.week):void 0}get year(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.year)!=null?new N(this.rawMetadata.fields.year):void 0}}l([g()],O.prototype,"addeddate",null);l([g()],O.prototype,"avg_rating",null);l([g()],O.prototype,"collection",null);l([g()],O.prototype,"collection_files_count",null);l([g()],O.prototype,"collection_size",null);l([g()],O.prototype,"creator",null);l([g()],O.prototype,"date",null);l([g()],O.prototype,"description",null);l([g()],O.prototype,"downloads",null);l([g()],O.prototype,"files_count",null);l([g()],O.prototype,"genre",null);l([g()],O.prototype,"indexflag",null);l([g()],O.prototype,"issue",null);l([g()],O.prototype,"item_count",null);l([g()],O.prototype,"item_size",null);l([g()],O.prototype,"language",null);l([g()],O.prototype,"lending___available_to_borrow",null);l([g()],O.prototype,"lending___available_to_browse",null);l([g()],O.prototype,"lending___available_to_waitlist",null);l([g()],O.prototype,"lending___status",null);l([g()],O.prototype,"licenseurl",null);l([g()],O.prototype,"mediatype",null);l([g()],O.prototype,"month",null);l([g()],O.prototype,"noindex",null);l([g()],O.prototype,"num_favorites",null);l([g()],O.prototype,"num_reviews",null);l([g()],O.prototype,"publicdate",null);l([g()],O.prototype,"reviewdate",null);l([g()],O.prototype,"review",null);l([g()],O.prototype,"source",null);l([g()],O.prototype,"subject",null);l([g()],O.prototype,"title",null);l([g()],O.prototype,"type",null);l([g()],O.prototype,"volume",null);l([g()],O.prototype,"week",null);l([g()],O.prototype,"year",null);class Y{constructor(e){this.rawMetadata=e}get identifier(){var e,t;return(t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.identifier}get highlight(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.highlight)===null||t===void 0)&&t.text?new $(this.rawMetadata.highlight.text):void 0}get addeddate(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.addeddate?new V(this.rawMetadata.fields.addeddate):void 0}get avg_rating(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.avg_rating)!=null?new N(this.rawMetadata.fields.avg_rating):void 0}get collection(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.collection?new $(this.rawMetadata.fields.collection):void 0}get created_on(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.created_on?new V(this.rawMetadata.fields.created_on):void 0}get creator(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.creator?new $(this.rawMetadata.fields.creator):void 0}get date(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.date?new V(this.rawMetadata.fields.date):void 0}get description(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.description?new $(this.rawMetadata.fields.description):void 0}get downloads(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.downloads)!=null?new N(this.rawMetadata.fields.downloads):void 0}get filename(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.filename?new $(this.rawMetadata.fields.filename):void 0}get file_basename(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.file_basename?new $(this.rawMetadata.fields.file_basename):void 0}get file_creation_mtime(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.file_creation_mtime)!=null?new N(this.rawMetadata.fields.file_creation_mtime):void 0}get issue(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.issue?new $(this.rawMetadata.fields.issue):void 0}get mediatype(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.mediatype?new _i(this.rawMetadata.fields.mediatype):void 0}get page_num(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.page_num)!=null?new N(this.rawMetadata.fields.page_num):void 0}get publicdate(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.publicdate?new V(this.rawMetadata.fields.publicdate):void 0}get result_in_subfile(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.result_in_subfile)!=null?new ut(this.rawMetadata.fields.result_in_subfile):void 0}get reviewdate(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.reviewdate?new V(this.rawMetadata.fields.reviewdate):void 0}get source(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.source?new $(this.rawMetadata.fields.source):void 0}get subject(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.subject?new $(this.rawMetadata.fields.subject):void 0}get title(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.title?new $(this.rawMetadata.fields.title):void 0}get updated_on(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.updated_on?new V(this.rawMetadata.fields.updated_on):void 0}get year(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.year)!=null?new N(this.rawMetadata.fields.year):void 0}get __href__(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.__href__?new $(this.rawMetadata.fields.__href__):void 0}}l([g()],Y.prototype,"highlight",null);l([g()],Y.prototype,"addeddate",null);l([g()],Y.prototype,"avg_rating",null);l([g()],Y.prototype,"collection",null);l([g()],Y.prototype,"created_on",null);l([g()],Y.prototype,"creator",null);l([g()],Y.prototype,"date",null);l([g()],Y.prototype,"description",null);l([g()],Y.prototype,"downloads",null);l([g()],Y.prototype,"filename",null);l([g()],Y.prototype,"file_basename",null);l([g()],Y.prototype,"file_creation_mtime",null);l([g()],Y.prototype,"issue",null);l([g()],Y.prototype,"mediatype",null);l([g()],Y.prototype,"page_num",null);l([g()],Y.prototype,"publicdate",null);l([g()],Y.prototype,"result_in_subfile",null);l([g()],Y.prototype,"reviewdate",null);l([g()],Y.prototype,"source",null);l([g()],Y.prototype,"subject",null);l([g()],Y.prototype,"title",null);l([g()],Y.prototype,"updated_on",null);l([g()],Y.prototype,"year",null);l([g()],Y.prototype,"__href__",null);var q;(function(a){a[a.COUNT=0]="COUNT",a[a.ALPHABETICAL=1]="ALPHABETICAL",a[a.NUMERIC=2]="NUMERIC"})(q||(q={}));class Ss{constructor(e){this.buckets=e.buckets,this.doc_count_error_upper_bound=e.doc_count_error_upper_bound,this.sum_other_doc_count=e.sum_other_doc_count,this.first_bucket_key=e.first_bucket_key,this.last_bucket_key=e.last_bucket_key,this.number_buckets=e.number_buckets,this.interval=e.interval}getSortedBuckets(e){const t=[...this.buckets];if(this.isRawNumberBuckets(t))return t;const i=new Intl.Collator;switch(e){case q.ALPHABETICAL:return t.sort((o,r)=>i.compare(o.key.toString(),r.key.toString()));case q.NUMERIC:return t.sort((o,r)=>Number(r.key)-Number(o.key));case q.COUNT:default:return t}}isRawNumberBuckets(e){return typeof this.buckets[0]=="number"}}l([g()],Ss.prototype,"getSortedBuckets",null);class xi{constructor(e){this.rawMetadata=e}get identifier(){var e;return(e=this.rawMetadata)===null||e===void 0?void 0:e.fields.query}get title(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.title?new $(this.rawMetadata.fields.title):void 0}get query(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.query?new $(this.rawMetadata.fields.query):void 0}get date_favorited(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.date_favorited?new V(this.rawMetadata.fields.date_favorited):void 0}get __href__(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.__href__?new $(this.rawMetadata.fields.__href__):void 0}}l([g()],xi.prototype,"title",null);l([g()],xi.prototype,"query",null);l([g()],xi.prototype,"date_favorited",null);l([g()],xi.prototype,"__href__",null);class to{constructor(e){this.rawMetadata=e}get identifier(){var e,t;return(t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.url}get mediatype(){return new _i("web")}get title(){var e,t,i;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.url?new $((i=this.rawMetadata.fields)===null||i===void 0?void 0:i.url):void 0}get capture_dates(){var e,t,i;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.capture_dates?new V((i=this.rawMetadata.fields)===null||i===void 0?void 0:i.capture_dates):void 0}get __href__(){var e,t,i;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.__href__?new $((i=this.rawMetadata.fields)===null||i===void 0?void 0:i.__href__):void 0}}l([g()],to.prototype,"title",null);l([g()],to.prototype,"capture_dates",null);l([g()],to.prototype,"__href__",null);class X{constructor(e){this.rawMetadata=e}get identifier(){var e,t;return(t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.identifier}get highlight(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.highlight)===null||t===void 0)&&t.text?new $(this.rawMetadata.highlight.text):void 0}get addeddate(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.addeddate?new V(this.rawMetadata.fields.addeddate):void 0}get avg_rating(){var e,t,i;const o=(t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.avg_rating;return o||o===0?new N((i=this.rawMetadata)===null||i===void 0?void 0:i.fields.avg_rating):void 0}get collection(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.collection?new $(this.rawMetadata.fields.collection):void 0}get created_on(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.created_on?new V(this.rawMetadata.fields.created_on):void 0}get creator(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.creator?new $(this.rawMetadata.fields.creator):void 0}get date(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.date?new V(this.rawMetadata.fields.date):void 0}get description(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.description?new $(this.rawMetadata.fields.description):void 0}get downloads(){var e,t,i;const o=(t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.downloads;return o||o===0?new N((i=this.rawMetadata)===null||i===void 0?void 0:i.fields.downloads):void 0}get filename(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.filename?new $(this.rawMetadata.fields.filename):void 0}get file_basename(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.file_basename?new $(this.rawMetadata.fields.file_basename):void 0}get file_creation_mtime(){var e,t,i;const o=(t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.file_creation_mtime;return o||o===0?new N((i=this.rawMetadata)===null||i===void 0?void 0:i.fields.file_creation_mtime):void 0}get issue(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.issue?new $(this.rawMetadata.fields.issue):void 0}get mediatype(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.mediatype?new _i(this.rawMetadata.fields.mediatype):void 0}get publicdate(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.publicdate?new V(this.rawMetadata.fields.publicdate):void 0}get result_in_subfile(){var e,t,i;const o=(t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.result_in_subfile;return o||o===!1?new ut((i=this.rawMetadata)===null||i===void 0?void 0:i.fields.result_in_subfile):void 0}get reviewdate(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.reviewdate?new V(this.rawMetadata.fields.reviewdate):void 0}get source(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.source?new $(this.rawMetadata.fields.source):void 0}get subject(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.subject?new $(this.rawMetadata.fields.subject):void 0}get title(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.title?new $(this.rawMetadata.fields.title):void 0}get updated_on(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.updated_on?new V(this.rawMetadata.fields.updated_on):void 0}get year(){var e,t,i;const o=(t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.year;return o||o===0?new N((i=this.rawMetadata)===null||i===void 0?void 0:i.fields.year):void 0}get start(){var e,t,i;const o=(t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.start;return o||o===0?new $((i=this.rawMetadata)===null||i===void 0?void 0:i.fields.start):void 0}get __href__(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.__href__?new $(this.rawMetadata.fields.__href__):void 0}}l([g()],X.prototype,"highlight",null);l([g()],X.prototype,"addeddate",null);l([g()],X.prototype,"avg_rating",null);l([g()],X.prototype,"collection",null);l([g()],X.prototype,"created_on",null);l([g()],X.prototype,"creator",null);l([g()],X.prototype,"date",null);l([g()],X.prototype,"description",null);l([g()],X.prototype,"downloads",null);l([g()],X.prototype,"filename",null);l([g()],X.prototype,"file_basename",null);l([g()],X.prototype,"file_creation_mtime",null);l([g()],X.prototype,"issue",null);l([g()],X.prototype,"mediatype",null);l([g()],X.prototype,"publicdate",null);l([g()],X.prototype,"result_in_subfile",null);l([g()],X.prototype,"reviewdate",null);l([g()],X.prototype,"source",null);l([g()],X.prototype,"subject",null);l([g()],X.prototype,"title",null);l([g()],X.prototype,"updated_on",null);l([g()],X.prototype,"year",null);l([g()],X.prototype,"start",null);l([g()],X.prototype,"__href__",null);const Rl=["loans","waitlist","loan_history"];function Fl(a){const e=a.slice(0,4),t=a.slice(4,6),i=a.slice(6,8),o=a.slice(8,10),r=a.slice(10,12),s=a.slice(12,14);return`${e}-${t}-${i}T${o}:${r}:${s}Z`}function Bl(a){var e;const t=[];for(const i of a){if(!(!((e=i.captures)===null||e===void 0)&&e.length))continue;const o=encodeURIComponent(i.url),r=`https://web.archive.org/web/${i.captures[0]}/${o}`;t.push({hit_type:"web_archive",fields:{url:i.url,capture_dates:i.captures.map(s=>Fl(s)),__href__:r}})}return t}class Ea{constructor(e,t){var i,o,r,s,n,d,p,f,m,y,w,x,C,A;this.schema=t,this.schemaHitType=t==null?void 0:t.hit_type;let B;e!=null&&e.page_elements&&(this.pageElements=e.page_elements,B=Object.values(this.pageElements)[0]);let D=(i=e==null?void 0:e.hits)===null||i===void 0?void 0:i.hits;this.totalResults=(r=(o=e==null?void 0:e.hits)===null||o===void 0?void 0:o.total)!==null&&r!==void 0?r:0,this.returnedCount=(n=(s=e==null?void 0:e.hits)===null||s===void 0?void 0:s.returned)!==null&&n!==void 0?n:0,!(D!=null&&D.length)&&((d=this.pageElements)===null||d===void 0?void 0:d.service___fts)?(this.totalResults=0,this.returnedCount=0,this.handleFederatedPageElements()):!(D!=null&&D.length)&&((p=B==null?void 0:B.hits)===null||p===void 0?void 0:p.hits)?(D=B.hits.hits,this.totalResults=(f=B.hits.total)!==null&&f!==void 0?f:0,this.returnedCount=(m=B.hits.returned)!==null&&m!==void 0?m:0):!((y=this.pageElements)===null||y===void 0)&&y.lending?D=this.handleLendingPageElement():!((w=this.pageElements)===null||w===void 0)&&w.web_archives&&(D=this.handleWebArchivesPageElement()),this.results=this.formatHits(D);let W=e==null?void 0:e.aggregations;!(this.aggregations&&Object.keys(this.aggregations).length>0)&&(B==null?void 0:B.aggregations)&&(W=B.aggregations),W&&this.buildAggregations(W),e!=null&&e.collection_titles&&(this.collectionTitles=(x=e.collection_titles)!==null&&x!==void 0?x:{}),e!=null&&e.collection_extra_info&&(this.collectionExtraInfo=(C=e.collection_extra_info)!==null&&C!==void 0?C:null),e!=null&&e.account_extra_info&&(this.accountExtraInfo=(A=e.account_extra_info)!==null&&A!==void 0?A:null)}formatHits(e){var t;return(t=e==null?void 0:e.map(i=>{var o;return Ea.createResult((o=i.hit_type)!==null&&o!==void 0?o:this.schemaHitType,i)}))!==null&&t!==void 0?t:[]}buildAggregations(e){this.aggregations=Object.entries(e).reduce((t,[i,o])=>(t[i]=new Ss(o),t),{})}handleLendingPageElement(){var e,t;const i=(e=this.pageElements)===null||e===void 0?void 0:e.lending,o=(t=i.loans)!==null&&t!==void 0?t:[];this.totalResults=o.length,this.returnedCount=this.totalResults;for(const r of Rl)i[r]=this.formatHits(i[r]);return o}handleWebArchivesPageElement(){var e;const t=Bl((e=this.pageElements)===null||e===void 0?void 0:e.web_archives);return this.totalResults=t.length,this.returnedCount=this.totalResults,t}handleFederatedPageElements(){var e,t,i,o;const r=["service___fts","service___tvs","service___rcs","service___whisper"];for(const s of r){const n=this.removeServicePrefix(s);this.federatedResults?this.federatedResults[s]=[]:this.federatedResults={[n]:[]};const d=(t=(e=this.pageElements)===null||e===void 0?void 0:e[s])===null||t===void 0?void 0:t.hits;d!=null&&d.hits&&(this.federatedResults[n]=this.formatHits(d==null?void 0:d.hits)),this.totalResults+=(i=d==null?void 0:d.total)!==null&&i!==void 0?i:0,this.returnedCount+=(o=d==null?void 0:d.returned)!==null&&o!==void 0?o:0}}removeServicePrefix(e){return e.split("___")[1]}static createResult(e,t){switch(e){case"item":return new O(t);case"text":case"asr_text":return new Y(t);case"favorited_search":return new xi(t);case"web_archive":return new to(t);case"tv_clip":return new X(t);default:return new O(t)}}}class Ol{constructor(e){this.clientParameters=e.client_parameters,this.backendRequests=e.backend_requests,this.kind=e.kind}}class Il{constructor(e){var t,i,o;this.rawResponse=e,this.request=new Ol(e.request),this.responseHeader=(t=e.response)===null||t===void 0?void 0:t.header,this.sessionContext=e.session_context,this.response=new Ea((i=e.response)===null||i===void 0?void 0:i.body,(o=e.response)===null||o===void 0?void 0:o.hit_schema)}}class io{static aggregateSearchParamsAsString(e){if(e.omit)return"false";if(e.advancedParams){const t=e.advancedParams.map(o=>({terms:o}));return JSON.stringify(t)}if(e.simpleParams)return e.simpleParams.join(",")}static sortParamsAsString(e){return`${e.field}:${e.direction}`}static filterParamsAsString(e){return JSON.stringify(e)}static generateURLSearchParams(e){const t=new URLSearchParams;if(t.append("user_query",e.query),e.pageType&&t.append("page_type",String(e.pageType)),e.pageTarget&&t.append("page_target",String(e.pageTarget)),e.pageElements&&e.pageElements.length>0){const r=`[${e.pageElements.map(s=>`"${s}"`).join(",")}]`;t.append("page_elements",r)}if(e.rows!=null&&t.append("hits_per_page",String(e.rows)),e.page!=null&&t.append("page",String(e.page)),e.fields&&e.fields.length>0&&t.append("fields",e.fields.join(",")),e.filters&&Object.keys(e.filters).length>0){const o=this.filterParamsAsString(e.filters);o&&o!=="{}"&&t.append("filter_map",o)}if(e.sort&&e.sort.length>0){const o=e.sort.map(r=>this.sortParamsAsString(r));t.append("sort",o.join(","))}const i=e.aggregations;if(i){const o=this.aggregateSearchParamsAsString(i);o&&t.append("aggregations",o)}if(e.aggregationsSize!=null&&t.append("aggregations_size",String(e.aggregationsSize)),e.debugging&&t.append("debugging","true"),e.uid&&t.append("uid",e.uid),e.includeClientUrl!==!1){const o=window.location.href.slice(0,400);e.query.length<=1e3&&t.append("client_url",o)}return t}}var di;(function(a){a.networkError="SearchService.NetworkError",a.itemNotFound="SearchService.ItemNotFound",a.decodingError="SearchService.DecodingError",a.searchEngineError="SearchService.SearchEngineError"})(di||(di={}));class Ul extends Error{constructor(e,t,i){super(t),this.name=e,this.type=e,this.details=i}}const mr={reCache:JSON.stringify({recompute:!0}),noCache:JSON.stringify({bypass:!0}),dontCache:JSON.stringify({no_compute:!0})};class oo{constructor(e){var t,i;this.baseUrl=(t=e==null?void 0:e.baseUrl)!==null&&t!==void 0?t:"archive.org",(e==null?void 0:e.includeCredentials)!==void 0?this.includeCredentials=e.includeCredentials:this.includeCredentials=window.location.href.match(/^https?:\/\/.*archive\.org(:[0-9]+)?/)!==null;const o=new URL(window.location.href).searchParams,r=o.get("scope"),s=o.get("verbose"),n=o.get("debugging"),d=o.get("cacheDebug");let p="";for(const f of Object.keys(mr))if(o.get(f)){p=mr[f];break}p=(i=o.get("caching"))!==null&&i!==void 0?i:p,(e==null?void 0:e.caching)!==void 0?this.cachingFlags=e.caching:p&&(this.cachingFlags=p),(e==null?void 0:e.debuggingEnabled)!==void 0?this.debuggingEnabled=e.debuggingEnabled:(n||d)&&(this.debuggingEnabled=!0),(e==null?void 0:e.scope)!==void 0?this.requestScope=e.scope:r&&(this.requestScope=r),(e==null?void 0:e.verbose)!==void 0?this.verbose=e.verbose:s&&(this.verbose=!!s)}async fetchUrl(e,t){var i,o;const r=new URL(e);this.requestScope&&r.searchParams.set("scope",this.requestScope),this.cachingFlags&&r.searchParams.set("caching",this.cachingFlags);let s;try{const n=(i=t==null?void 0:t.requestOptions)!==null&&i!==void 0?i:{credentials:this.includeCredentials?"include":"same-origin"};s=await fetch(r.href,n)}catch(n){const d=n instanceof Error?n.message:typeof n=="string"?n:"Unknown error";return this.getErrorResult(di.networkError,d)}try{const n=await s.json();this.verbose&&this.printResponse(n),n.debugging&&this.printDebuggingInfo(n);const d=(o=n.response)===null||o===void 0?void 0:o.error;return d?this.getErrorResult(di.searchEngineError,d.message,d.forensics):{success:n}}catch(n){const d=n instanceof Error?n.message:typeof n=="string"?n:"Unknown error";return this.getErrorResult(di.decodingError,d)}}getErrorResult(e,t,i){return{error:new Ul(e,t,i)}}printResponse(e){var t,i,o,r,s;try{const n=JSON.parse(JSON.stringify(e)),d=(o=(i=(t=n==null?void 0:n.response)===null||t===void 0?void 0:t.body)===null||i===void 0?void 0:i.hits)===null||o===void 0?void 0:o.hits;if(Array.isArray(d)&&d.length>1){const f=[];f.push(d[0]),f.push(`*** ${d.length-1} hits omitted ***`),n.response.body.hits.hits=f}const p=(s=(r=n==null?void 0:n.response)===null||r===void 0?void 0:r.body)===null||s===void 0?void 0:s.aggregations;p&&Object.entries(p).forEach(([f,m])=>{var y,w,x,C;if(((w=(y=m)===null||y===void 0?void 0:y.buckets)===null||w===void 0?void 0:w.length)>0){const A=JSON.parse(JSON.stringify(m));A.buckets=`*** ${(C=(x=A.buckets)===null||x===void 0?void 0:x.length)!==null&&C!==void 0?C:0} buckets omitted ***`,n.response.body.aggregations[f]=A}}),console.log("***** RESPONSE RECEIVED *****"),console.groupCollapsed("Response"),console.log(JSON.stringify(n,null,2)),console.groupEnd()}catch(n){console.error("Error printing search response:",n)}}printDebuggingInfo(e){var t,i;const o=e.debugging,r=(t=o.messages)!==null&&t!==void 0?t:[],s=(i=o.data)!==null&&i!==void 0?i:{};console.log("***** BEGIN DEBUGGING *****"),console.log("Full response:"),console.log(JSON.stringify(e,null,2)),console.group("Debug messages");for(const n of r)console.log(n);console.groupEnd(),console.group("Debug data");for(const[n,d]of Object.entries(s))console.log(n,d);console.groupEnd(),console.log("***** END DEBUGGING *****")}}class Nl extends oo{constructor(e){var t;super(e),this.servicePath=(t=e==null?void 0:e.servicePath)!==null&&t!==void 0?t:"/services/search/beta/page_production"}async performSearch(e){this.debuggingEnabled&&e.debugging===void 0&&(e.debugging=!0);const i=io.generateURLSearchParams(e).toString(),o=`https://${this.baseUrl}${this.servicePath}/?${i}`;return this.fetchUrl(o)}}class Hl extends oo{constructor(e){var t;super(e),this.servicePath=(t=e==null?void 0:e.servicePath)!==null&&t!==void 0?t:"/services/search/beta/page_production"}async performSearch(e){this.debuggingEnabled&&e.debugging===void 0&&(e.debugging=!0);const i=io.generateURLSearchParams(e).toString(),o=`https://${this.baseUrl}${this.servicePath}/?service_backend=fts&${i}`;return this.fetchUrl(o)}}class Vl extends oo{constructor(e){var t;super(e),this.servicePath=(t=e==null?void 0:e.servicePath)!==null&&t!==void 0?t:"/services/search/beta/page_production"}async performSearch(e){this.debuggingEnabled&&e.debugging===void 0&&(e.debugging=!0);const i=io.generateURLSearchParams(e).toString(),o=`https://${this.baseUrl}${this.servicePath}/?service_backend=rcs&${i}`;return this.fetchUrl(o)}}var ne;(function(a){a[a.METADATA=0]="METADATA",a[a.FULLTEXT=1]="FULLTEXT",a[a.RADIO=3]="RADIO",a[a.FEDERATED=4]="FEDERATED"})(ne||(ne={}));class Wl extends oo{constructor(e){var t;super(e),this.servicePath=(t=e==null?void 0:e.servicePath)!==null&&t!==void 0?t:"/services/search/beta/page_production"}async performSearch(e){this.debuggingEnabled&&e.debugging===void 0&&(e.debugging=!0);const i=io.generateURLSearchParams(e).toString(),o=`https://${this.baseUrl}${this.servicePath}/?page_type=simple_federation&${i}`;return this.fetchUrl(o)}}class Ie{constructor(e={}){this.backendOptions=e}async search(e,t=ne.METADATA){const o=await Ie.getBackendForSearchType(t,this.backendOptions).performSearch(e);return o.error?o:{success:new Il(o.success)}}static getBackendForSearchType(e,t={}){switch(e){case ne.FULLTEXT:return new Hl(t);case ne.RADIO:return new Vl(t);case ne.FEDERATED:return new Wl(t);case ne.METADATA:default:return new Nl(t)}}}Ie.default=new Ie;l([g((a,e={})=>{const{includeCredentials:t=!1,verbose:i=!1,scope:o="",baseUrl:r=""}=e;return`${a};${t};${i};${o};${r}`})],Ie,"getBackendForSearchType",null);var Je;(function(a){a.INCLUDE="inc",a.EXCLUDE="exc",a.GREATER_THAN="gt",a.GREATER_OR_EQUAL="gte",a.LESS_THAN="lt",a.LESS_OR_EQUAL="lte"})(Je||(Je={}));class jl{constructor(){this.filterMap={}}addFilter(e,t,i){if(this.filterMap[e]||(this.filterMap[e]={}),this.filterMap[e][t]){const o=[].concat(this.filterMap[e][t],i);this.filterMap[e][t]=Array.from(new Set(o))}else this.filterMap[e][t]=i;return this}removeSingleFilter(e,t,i){var o;if(!(!((o=this.filterMap[e])===null||o===void 0)&&o[t]))return this;const r=[].concat(this.filterMap[e][t]),s=r.indexOf(i);return s>=0&&r.splice(s,1),this.filterMap[e][t]=r.length===1?r[0]:r,r.length===0&&delete this.filterMap[e][t],this.deleteFieldIfEmpty(e),this}removeFilters(e,t){return this.filterMap[e]?(delete this.filterMap[e][t],this.deleteFieldIfEmpty(e),this):this}deleteFieldIfEmpty(e){const t=this.filterMap[e];t&&Object.keys(t).length===0&&delete this.filterMap[e]}setFilterMap(e){return this.filterMap=G({},e),this}mergeFilterMap(e){for(const[t,i]of Object.entries(e))for(const[o,r]of Object.entries(i))if(Array.isArray(r))for(const s of r)this.addFilter(t,o,s);else this.addFilter(t,o,r);return this}build(){return this.filterMap}}/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ma=window.ShadowRoot&&(window.ShadyCSS===void 0||window.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,za=Symbol(),gr=new Map;class $s{constructor(e,t){if(this._$cssResult$=!0,t!==za)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e}get styleSheet(){let e=gr.get(this.cssText);return Ma&&e===void 0&&(gr.set(this.cssText,e=new CSSStyleSheet),e.replaceSync(this.cssText)),e}toString(){return this.cssText}}const Ql=a=>new $s(typeof a=="string"?a:a+"",za),v=(a,...e)=>{const t=a.length===1?a[0]:e.reduce((i,o,r)=>i+(s=>{if(s._$cssResult$===!0)return s.cssText;if(typeof s=="number")return s;throw Error("Value passed to 'css' function must be a 'css' function result: "+s+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(o)+a[r+1],a[0]);return new $s(t,za)},Gl=(a,e)=>{Ma?a.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet):e.forEach(t=>{const i=document.createElement("style"),o=window.litNonce;o!==void 0&&i.setAttribute("nonce",o),i.textContent=t.cssText,a.appendChild(i)})},br=Ma?a=>a:a=>a instanceof CSSStyleSheet?(e=>{let t="";for(const i of e.cssRules)t+=i.cssText;return Ql(t)})(a):a;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var So;const yr=window.trustedTypes,Kl=yr?yr.emptyScript:"",wr=window.reactiveElementPolyfillSupport,ta={toAttribute(a,e){switch(e){case Boolean:a=a?Kl:null;break;case Object:case Array:a=a==null?a:JSON.stringify(a)}return a},fromAttribute(a,e){let t=a;switch(e){case Boolean:t=a!==null;break;case Number:t=a===null?null:Number(a);break;case Object:case Array:try{t=JSON.parse(a)}catch{t=null}}return t}},Cs=(a,e)=>e!==a&&(e==e||a==a),$o={attribute:!0,type:String,converter:ta,reflect:!1,hasChanged:Cs};class kt extends HTMLElement{constructor(){super(),this._$Et=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Ei=null,this.o()}static addInitializer(e){var t;(t=this.l)!==null&&t!==void 0||(this.l=[]),this.l.push(e)}static get observedAttributes(){this.finalize();const e=[];return this.elementProperties.forEach((t,i)=>{const o=this._$Eh(i,t);o!==void 0&&(this._$Eu.set(o,i),e.push(o))}),e}static createProperty(e,t=$o){if(t.state&&(t.attribute=!1),this.finalize(),this.elementProperties.set(e,t),!t.noAccessor&&!this.prototype.hasOwnProperty(e)){const i=typeof e=="symbol"?Symbol():"__"+e,o=this.getPropertyDescriptor(e,i,t);o!==void 0&&Object.defineProperty(this.prototype,e,o)}}static getPropertyDescriptor(e,t,i){return{get(){return this[t]},set(o){const r=this[e];this[t]=o,this.requestUpdate(e,r,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)||$o}static finalize(){if(this.hasOwnProperty("finalized"))return!1;this.finalized=!0;const e=Object.getPrototypeOf(this);if(e.finalize(),this.elementProperties=new Map(e.elementProperties),this._$Eu=new Map,this.hasOwnProperty("properties")){const t=this.properties,i=[...Object.getOwnPropertyNames(t),...Object.getOwnPropertySymbols(t)];for(const o of i)this.createProperty(o,t[o])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const i=new Set(e.flat(1/0).reverse());for(const o of i)t.unshift(br(o))}else e!==void 0&&t.push(br(e));return t}static _$Eh(e,t){const i=t.attribute;return i===!1?void 0:typeof i=="string"?i:typeof e=="string"?e.toLowerCase():void 0}o(){var e;this._$Ep=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$Em(),this.requestUpdate(),(e=this.constructor.l)===null||e===void 0||e.forEach(t=>t(this))}addController(e){var t,i;((t=this._$Eg)!==null&&t!==void 0?t:this._$Eg=[]).push(e),this.renderRoot!==void 0&&this.isConnected&&((i=e.hostConnected)===null||i===void 0||i.call(e))}removeController(e){var t;(t=this._$Eg)===null||t===void 0||t.splice(this._$Eg.indexOf(e)>>>0,1)}_$Em(){this.constructor.elementProperties.forEach((e,t)=>{this.hasOwnProperty(t)&&(this._$Et.set(t,this[t]),delete this[t])})}createRenderRoot(){var e;const t=(e=this.shadowRoot)!==null&&e!==void 0?e:this.attachShadow(this.constructor.shadowRootOptions);return Gl(t,this.constructor.elementStyles),t}connectedCallback(){var e;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$Eg)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostConnected)===null||i===void 0?void 0:i.call(t)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$Eg)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostDisconnected)===null||i===void 0?void 0:i.call(t)})}attributeChangedCallback(e,t,i){this._$AK(e,i)}_$ES(e,t,i=$o){var o,r;const s=this.constructor._$Eh(e,i);if(s!==void 0&&i.reflect===!0){const n=((r=(o=i.converter)===null||o===void 0?void 0:o.toAttribute)!==null&&r!==void 0?r:ta.toAttribute)(t,i.type);this._$Ei=e,n==null?this.removeAttribute(s):this.setAttribute(s,n),this._$Ei=null}}_$AK(e,t){var i,o,r;const s=this.constructor,n=s._$Eu.get(e);if(n!==void 0&&this._$Ei!==n){const d=s.getPropertyOptions(n),p=d.converter,f=(r=(o=(i=p)===null||i===void 0?void 0:i.fromAttribute)!==null&&o!==void 0?o:typeof p=="function"?p:null)!==null&&r!==void 0?r:ta.fromAttribute;this._$Ei=n,this[n]=f(t,d.type),this._$Ei=null}}requestUpdate(e,t,i){let o=!0;e!==void 0&&(((i=i||this.constructor.getPropertyOptions(e)).hasChanged||Cs)(this[e],t)?(this._$AL.has(e)||this._$AL.set(e,t),i.reflect===!0&&this._$Ei!==e&&(this._$EC===void 0&&(this._$EC=new Map),this._$EC.set(e,i))):o=!1),!this.isUpdatePending&&o&&(this._$Ep=this._$E_())}async _$E_(){this.isUpdatePending=!0;try{await this._$Ep}catch(t){Promise.reject(t)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var e;if(!this.isUpdatePending)return;this.hasUpdated,this._$Et&&(this._$Et.forEach((o,r)=>this[r]=o),this._$Et=void 0);let t=!1;const i=this._$AL;try{t=this.shouldUpdate(i),t?(this.willUpdate(i),(e=this._$Eg)===null||e===void 0||e.forEach(o=>{var r;return(r=o.hostUpdate)===null||r===void 0?void 0:r.call(o)}),this.update(i)):this._$EU()}catch(o){throw t=!1,this._$EU(),o}t&&this._$AE(i)}willUpdate(e){}_$AE(e){var t;(t=this._$Eg)===null||t===void 0||t.forEach(i=>{var o;return(o=i.hostUpdated)===null||o===void 0?void 0:o.call(i)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EU(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$Ep}shouldUpdate(e){return!0}update(e){this._$EC!==void 0&&(this._$EC.forEach((t,i)=>this._$ES(i,this[i],t)),this._$EC=void 0),this._$EU()}updated(e){}firstUpdated(e){}}kt.finalized=!0,kt.elementProperties=new Map,kt.elementStyles=[],kt.shadowRootOptions={mode:"open"},wr==null||wr({ReactiveElement:kt}),((So=globalThis.reactiveElementVersions)!==null&&So!==void 0?So:globalThis.reactiveElementVersions=[]).push("1.3.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Co;const Pt=globalThis.trustedTypes,_r=Pt?Pt.createPolicy("lit-html",{createHTML:a=>a}):void 0,Ke=`lit$${(Math.random()+"").slice(9)}$`,Pa="?"+Ke,ql=`<${Pa}>`,At=document,pi=(a="")=>At.createComment(a),ui=a=>a===null||typeof a!="object"&&typeof a!="function",ks=Array.isArray,Ts=a=>{var e;return ks(a)||typeof((e=a)===null||e===void 0?void 0:e[Symbol.iterator])=="function"},ei=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,xr=/-->/g,Sr=/>/g,nt=/>|[ 	\n\r](?:([^\s"'>=/]+)([ 	\n\r]*=[ 	\n\r]*(?:[^ 	\n\r"'`<>=]|("|')|))|$)/g,$r=/'/g,Cr=/"/g,Es=/^(?:script|style|textarea|title)$/i,Ms=a=>(e,...t)=>({_$litType$:a,strings:e,values:t}),c=Ms(1),U=Ms(2),ke=Symbol.for("lit-noChange"),b=Symbol.for("lit-nothing"),kr=new WeakMap,Fi=(a,e,t)=>{var i,o;const r=(i=t==null?void 0:t.renderBefore)!==null&&i!==void 0?i:e;let s=r._$litPart$;if(s===void 0){const n=(o=t==null?void 0:t.renderBefore)!==null&&o!==void 0?o:null;r._$litPart$=s=new Vt(e.insertBefore(pi(),n),n,void 0,t!=null?t:{})}return s._$AI(a),s},Et=At.createTreeWalker(At,129,null,!1),zs=(a,e)=>{const t=a.length-1,i=[];let o,r=e===2?"<svg>":"",s=ei;for(let d=0;d<t;d++){const p=a[d];let f,m,y=-1,w=0;for(;w<p.length&&(s.lastIndex=w,m=s.exec(p),m!==null);)w=s.lastIndex,s===ei?m[1]==="!--"?s=xr:m[1]!==void 0?s=Sr:m[2]!==void 0?(Es.test(m[2])&&(o=RegExp("</"+m[2],"g")),s=nt):m[3]!==void 0&&(s=nt):s===nt?m[0]===">"?(s=o!=null?o:ei,y=-1):m[1]===void 0?y=-2:(y=s.lastIndex-m[2].length,f=m[1],s=m[3]===void 0?nt:m[3]==='"'?Cr:$r):s===Cr||s===$r?s=nt:s===xr||s===Sr?s=ei:(s=nt,o=void 0);const x=s===nt&&a[d+1].startsWith("/>")?" ":"";r+=s===ei?p+ql:y>=0?(i.push(f),p.slice(0,y)+"$lit$"+p.slice(y)+Ke+x):p+Ke+(y===-2?(i.push(void 0),d):x)}const n=r+(a[t]||"<?>")+(e===2?"</svg>":"");if(!Array.isArray(a)||!a.hasOwnProperty("raw"))throw Error("invalid template strings array");return[_r!==void 0?_r.createHTML(n):n,i]};class fi{constructor({strings:e,_$litType$:t},i){let o;this.parts=[];let r=0,s=0;const n=e.length-1,d=this.parts,[p,f]=zs(e,t);if(this.el=fi.createElement(p,i),Et.currentNode=this.el.content,t===2){const m=this.el.content,y=m.firstChild;y.remove(),m.append(...y.childNodes)}for(;(o=Et.nextNode())!==null&&d.length<n;){if(o.nodeType===1){if(o.hasAttributes()){const m=[];for(const y of o.getAttributeNames())if(y.endsWith("$lit$")||y.startsWith(Ke)){const w=f[s++];if(m.push(y),w!==void 0){const x=o.getAttribute(w.toLowerCase()+"$lit$").split(Ke),C=/([.?@])?(.*)/.exec(w);d.push({type:1,index:r,name:C[2],strings:x,ctor:C[1]==="."?As:C[1]==="?"?Ls:C[1]==="@"?Ds:Si})}else d.push({type:6,index:r})}for(const y of m)o.removeAttribute(y)}if(Es.test(o.tagName)){const m=o.textContent.split(Ke),y=m.length-1;if(y>0){o.textContent=Pt?Pt.emptyScript:"";for(let w=0;w<y;w++)o.append(m[w],pi()),Et.nextNode(),d.push({type:2,index:++r});o.append(m[y],pi())}}}else if(o.nodeType===8)if(o.data===Pa)d.push({type:2,index:r});else{let m=-1;for(;(m=o.data.indexOf(Ke,m+1))!==-1;)d.push({type:7,index:r}),m+=Ke.length-1}r++}}static createElement(e,t){const i=At.createElement("template");return i.innerHTML=e,i}}function mt(a,e,t=a,i){var o,r,s,n;if(e===ke)return e;let d=i!==void 0?(o=t._$Cl)===null||o===void 0?void 0:o[i]:t._$Cu;const p=ui(e)?void 0:e._$litDirective$;return(d==null?void 0:d.constructor)!==p&&((r=d==null?void 0:d._$AO)===null||r===void 0||r.call(d,!1),p===void 0?d=void 0:(d=new p(a),d._$AT(a,t,i)),i!==void 0?((s=(n=t)._$Cl)!==null&&s!==void 0?s:n._$Cl=[])[i]=d:t._$Cu=d),d!==void 0&&(e=mt(a,d._$AS(a,e.values),d,i)),e}class Ps{constructor(e,t){this.v=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}p(e){var t;const{el:{content:i},parts:o}=this._$AD,r=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:At).importNode(i,!0);Et.currentNode=r;let s=Et.nextNode(),n=0,d=0,p=o[0];for(;p!==void 0;){if(n===p.index){let f;p.type===2?f=new Vt(s,s.nextSibling,this,e):p.type===1?f=new p.ctor(s,p.name,p.strings,this,e):p.type===6&&(f=new Rs(s,this,e)),this.v.push(f),p=o[++d]}n!==(p==null?void 0:p.index)&&(s=Et.nextNode(),n++)}return r}m(e){let t=0;for(const i of this.v)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class Vt{constructor(e,t,i,o){var r;this.type=2,this._$AH=b,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=o,this._$Cg=(r=o==null?void 0:o.isConnected)===null||r===void 0||r}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cg}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&e.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=mt(this,e,t),ui(e)?e===b||e==null||e===""?(this._$AH!==b&&this._$AR(),this._$AH=b):e!==this._$AH&&e!==ke&&this.$(e):e._$litType$!==void 0?this.T(e):e.nodeType!==void 0?this.k(e):Ts(e)?this.S(e):this.$(e)}M(e,t=this._$AB){return this._$AA.parentNode.insertBefore(e,t)}k(e){this._$AH!==e&&(this._$AR(),this._$AH=this.M(e))}$(e){this._$AH!==b&&ui(this._$AH)?this._$AA.nextSibling.data=e:this.k(At.createTextNode(e)),this._$AH=e}T(e){var t;const{values:i,_$litType$:o}=e,r=typeof o=="number"?this._$AC(e):(o.el===void 0&&(o.el=fi.createElement(o.h,this.options)),o);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===r)this._$AH.m(i);else{const s=new Ps(r,this),n=s.p(this.options);s.m(i),this.k(n),this._$AH=s}}_$AC(e){let t=kr.get(e.strings);return t===void 0&&kr.set(e.strings,t=new fi(e)),t}S(e){ks(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,o=0;for(const r of e)o===t.length?t.push(i=new Vt(this.M(pi()),this.M(pi()),this,this.options)):i=t[o],i._$AI(r),o++;o<t.length&&(this._$AR(i&&i._$AB.nextSibling,o),t.length=o)}_$AR(e=this._$AA.nextSibling,t){var i;for((i=this._$AP)===null||i===void 0||i.call(this,!1,!0,t);e&&e!==this._$AB;){const o=e.nextSibling;e.remove(),e=o}}setConnected(e){var t;this._$AM===void 0&&(this._$Cg=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}}class Si{constructor(e,t,i,o,r){this.type=1,this._$AH=b,this._$AN=void 0,this.element=e,this.name=t,this._$AM=o,this.options=r,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=b}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,i,o){const r=this.strings;let s=!1;if(r===void 0)e=mt(this,e,t,0),s=!ui(e)||e!==this._$AH&&e!==ke,s&&(this._$AH=e);else{const n=e;let d,p;for(e=r[0],d=0;d<r.length-1;d++)p=mt(this,n[i+d],t,d),p===ke&&(p=this._$AH[d]),s||(s=!ui(p)||p!==this._$AH[d]),p===b?e=b:e!==b&&(e+=(p!=null?p:"")+r[d+1]),this._$AH[d]=p}s&&!o&&this.C(e)}C(e){e===b?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e!=null?e:"")}}class As extends Si{constructor(){super(...arguments),this.type=3}C(e){this.element[this.name]=e===b?void 0:e}}const Yl=Pt?Pt.emptyScript:"";class Ls extends Si{constructor(){super(...arguments),this.type=4}C(e){e&&e!==b?this.element.setAttribute(this.name,Yl):this.element.removeAttribute(this.name)}}class Ds extends Si{constructor(e,t,i,o,r){super(e,t,i,o,r),this.type=5}_$AI(e,t=this){var i;if((e=(i=mt(this,e,t,0))!==null&&i!==void 0?i:b)===ke)return;const o=this._$AH,r=e===b&&o!==b||e.capture!==o.capture||e.once!==o.once||e.passive!==o.passive,s=e!==b&&(o===b||r);r&&this.element.removeEventListener(this.name,this,o),s&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,i;typeof this._$AH=="function"?this._$AH.call((i=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&i!==void 0?i:this.element,e):this._$AH.handleEvent(e)}}class Rs{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){mt(this,e)}}const Xl={L:"$lit$",P:Ke,V:Pa,I:1,N:zs,R:Ps,j:Ts,D:mt,H:Vt,F:Si,O:Ls,W:Ds,B:As,Z:Rs},Tr=window.litHtmlPolyfillSupport;Tr==null||Tr(fi,Vt),((Co=globalThis.litHtmlVersions)!==null&&Co!==void 0?Co:globalThis.litHtmlVersions=[]).push("2.2.4");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var ko,To;class F extends kt{constructor(){super(...arguments),this.renderOptions={host:this},this._$Dt=void 0}createRenderRoot(){var e,t;const i=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=i.firstChild),i}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Dt=Fi(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Dt)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Dt)===null||e===void 0||e.setConnected(!1)}render(){return ke}}F.finalized=!0,F._$litElement$=!0,(ko=globalThis.litElementHydrateSupport)===null||ko===void 0||ko.call(globalThis,{LitElement:F});const Er=globalThis.litElementPolyfillSupport;Er==null||Er({LitElement:F});((To=globalThis.litElementVersions)!==null&&To!==void 0?To:globalThis.litElementVersions=[]).push("3.2.0");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Zl=(a,e)=>e.kind==="method"&&e.descriptor&&!("value"in e.descriptor)?le(G({},e),{finisher(t){t.createProperty(e.key,a)}}):{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){typeof e.initializer=="function"&&(this[e.key]=e.initializer.call(this))},finisher(t){t.createProperty(e.key,a)}};function h(a){return(e,t)=>t!==void 0?((i,o,r)=>{o.constructor.createProperty(r,i)})(a,e,t):Zl(a,e)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Fs=({finisher:a,descriptor:e})=>(t,i)=>{var o;if(i===void 0){const r=(o=t.originalKey)!==null&&o!==void 0?o:t.key,s=e!=null?{kind:"method",placement:"prototype",key:r,descriptor:e(t.key)}:le(G({},t),{key:r});return a!=null&&(s.finisher=function(n){a(n,r)}),s}{const r=t.constructor;e!==void 0&&Object.defineProperty(t,i,e(i)),a==null||a(r,i)}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Z(a,e){return Fs({descriptor:t=>{const i={get(){var o,r;return(r=(o=this.renderRoot)===null||o===void 0?void 0:o.querySelector(a))!==null&&r!==void 0?r:null},enumerable:!0,configurable:!0};if(e){const o=typeof t=="symbol"?Symbol():"__"+t;i.get=function(){var r,s;return this[o]===void 0&&(this[o]=(s=(r=this.renderRoot)===null||r===void 0?void 0:r.querySelector(a))!==null&&s!==void 0?s:null),this[o]}}return i}})}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Jl(a){return Fs({descriptor:e=>({get(){var t,i;return(i=(t=this.renderRoot)===null||t===void 0?void 0:t.querySelectorAll(a))!==null&&i!==void 0?i:[]},enumerable:!0,configurable:!0})})}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Eo;((Eo=window.HTMLSlotElement)===null||Eo===void 0?void 0:Eo.prototype.assignedElements)!=null;class en{constructor(){this.resizeObserver=new ResizeObserver(e=>{window.requestAnimationFrame(()=>{for(const t of e){const i=this.resizeHandlers.get(t.target);i==null||i.forEach(o=>{o.handleResize(t)})}})}),this.resizeHandlers=new Map}shutdown(){this.resizeHandlers.forEach((e,t)=>{this.resizeObserver.unobserve(t)}),this.resizeHandlers.clear()}addObserver(e){var t;const i=(t=this.resizeHandlers.get(e.target))!==null&&t!==void 0?t:new Set;i.add(e.handler),this.resizeHandlers.set(e.target,i),this.resizeObserver.observe(e.target,e.options)}removeObserver(e){const t=this.resizeHandlers.get(e.target);!t||(t.delete(e.handler),t.size===0&&(this.resizeObserver.unobserve(e.target),this.resizeHandlers.delete(e.target)))}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Oe={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},$i=a=>(...e)=>({_$litDirective$:a,values:e});class Ci{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Lt=$i(class extends Ci{constructor(a){var e;if(super(a),a.type!==Oe.ATTRIBUTE||a.name!=="class"||((e=a.strings)===null||e===void 0?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(a){return" "+Object.keys(a).filter(e=>a[e]).join(" ")+" "}update(a,[e]){var t,i;if(this.et===void 0){this.et=new Set,a.strings!==void 0&&(this.st=new Set(a.strings.join(" ").split(/\s/).filter(r=>r!=="")));for(const r in e)e[r]&&!(!((t=this.st)===null||t===void 0)&&t.has(r))&&this.et.add(r);return this.render(e)}const o=a.element.classList;this.et.forEach(r=>{r in e||(o.remove(r),this.et.delete(r))});for(const r in e){const s=!!e[r];s===this.et.has(r)||((i=this.st)===null||i===void 0?void 0:i.has(r))||(s?(o.add(r),this.et.add(r)):(o.remove(r),this.et.delete(r)))}return ke}});/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const tn=(a,...e)=>({strTag:!0,strings:a,values:e}),ht=tn,on=a=>typeof a!="string"&&"strTag"in a,an=(a,e,t)=>{let i=a[0];for(let o=1;o<a.length;o++)i+=e[t?t[o-1]:o-1],i+=a[o];return i};/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const rn=a=>on(a)?an(a.strings,a.values):a;/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class sn{constructor(){this.settled=!1,this.promise=new Promise((e,t)=>{this._resolve=e,this._reject=t})}resolve(e){this.settled=!0,this._resolve(e)}reject(e){this.settled=!0,this._reject(e)}}/**
 * @license
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{H:nn}=Xl,Bs=a=>a.strings===void 0,Mr=()=>document.createComment(""),ti=(a,e,t)=>{var i;const o=a._$AA.parentNode,r=e===void 0?a._$AB:e._$AA;if(t===void 0){const s=o.insertBefore(Mr(),r),n=o.insertBefore(Mr(),r);t=new nn(s,n,a,a.options)}else{const s=t._$AB.nextSibling,n=t._$AM,d=n!==a;if(d){let p;(i=t._$AQ)===null||i===void 0||i.call(t,a),t._$AM=a,t._$AP!==void 0&&(p=a._$AU)!==n._$AU&&t._$AP(p)}if(s!==r||d){let p=t._$AA;for(;p!==s;){const f=p.nextSibling;o.insertBefore(p,r),p=f}}}return t},dt=(a,e,t=a)=>(a._$AI(e,t),a),dn={},Os=(a,e=dn)=>a._$AH=e,cn=a=>a._$AH,Mo=a=>{var e;(e=a._$AP)===null||e===void 0||e.call(a,!1,!0);let t=a._$AA;const i=a._$AB.nextSibling;for(;t!==i;){const o=t.nextSibling;t.remove(),t=o}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const zr=(a,e,t)=>{const i=new Map;for(let o=e;o<=t;o++)i.set(a[o],o);return i},Aa=$i(class extends Ci{constructor(a){if(super(a),a.type!==Oe.CHILD)throw Error("repeat() can only be used in text expressions")}dt(a,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);const o=[],r=[];let s=0;for(const n of a)o[s]=i?i(n,s):s,r[s]=t(n,s),s++;return{values:r,keys:o}}render(a,e,t){return this.dt(a,e,t).values}update(a,[e,t,i]){var o;const r=cn(a),{values:s,keys:n}=this.dt(e,t,i);if(!Array.isArray(r))return this.ut=n,s;const d=(o=this.ut)!==null&&o!==void 0?o:this.ut=[],p=[];let f,m,y=0,w=r.length-1,x=0,C=s.length-1;for(;y<=w&&x<=C;)if(r[y]===null)y++;else if(r[w]===null)w--;else if(d[y]===n[x])p[x]=dt(r[y],s[x]),y++,x++;else if(d[w]===n[C])p[C]=dt(r[w],s[C]),w--,C--;else if(d[y]===n[C])p[C]=dt(r[y],s[C]),ti(a,p[C+1],r[y]),y++,C--;else if(d[w]===n[x])p[x]=dt(r[w],s[x]),ti(a,r[y],r[w]),w--,x++;else if(f===void 0&&(f=zr(n,x,C),m=zr(d,y,w)),f.has(d[y]))if(f.has(d[w])){const A=m.get(n[x]),B=A!==void 0?r[A]:null;if(B===null){const D=ti(a,r[y]);dt(D,s[x]),p[x]=D}else p[x]=dt(B,s[x]),ti(a,r[y],B),r[A]=null;x++}else Mo(r[w]),w--;else Mo(r[y]),y++;for(;x<=C;){const A=ti(a,p[C+1]);dt(A,s[x]),p[x++]=A}for(;y<=w;){const A=r[y++];A!==null&&Mo(A)}return this.ut=n,Os(a,p),ke}});function Ai(a,e,t){return Array.from({length:(e-a)/t+1},(i,o)=>a+o*t)}let Ye=class extends F{constructor(){super(...arguments),this.itemCount=0,this.scrollOptimizationsDisabled=!1,this.intersectionObserver=new IntersectionObserver(e=>{e.forEach(t=>{if(t.target===this.sentinel){t.isIntersecting&&this.dispatchEvent(new Event("scrollThresholdReached"));return}const o=t.target.dataset.cellIndex;if(!o)return;const r=parseInt(o,10);t.isIntersecting?this.visibleCellIndices.add(r):this.visibleCellIndices.delete(r)}),this.scrollOptimizationsDisabled||this.processVisibleCells()}),this.renderedCellIndices=new Set,this.visibleCellIndices=new Set,this.placeholderCellIndices=new Set}reload(){Ai(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.removeCell(t)),this.renderedCellIndices.clear(),this.visibleCellIndices.clear(),this.placeholderCellIndices.clear(),this.setupObservations()}refreshCell(e){this.removeCell(e),this.bufferRange.includes(e)&&this.renderCellBuffer([e])}refreshAllVisibleCells(){this.bufferRange.forEach(e=>this.removeCell(e)),this.renderCellBuffer(this.bufferRange)}scrollToCell(e,t){const i=this.cellContainers[e];if(!i)return!1;const o=t?"smooth":"auto";return i.scrollIntoView({behavior:o}),!0}getVisibleCellIndices(){return Array.from(this.visibleCellIndices)}updated(e){(e.has("itemCount")||e.has("scrollOptimizationsDisabled"))&&this.setupObservations()}disconnectedCallback(){this.intersectionObserver.disconnect()}setupObservations(){this.setupIntersectionObserver()}setupIntersectionObserver(){this.intersectionObserver.disconnect(),this.sentinel&&this.intersectionObserver.observe(this.sentinel),this.scrollOptimizationsDisabled?(Ai(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.visibleCellIndices.add(t)),this.processVisibleCells()):this.cellContainers.forEach(e=>this.intersectionObserver.observe(e))}render(){var e;const t=this.itemCount-1,i=Ai(0,t,1),o=(e=this.ariaLandmarkLabel)!==null&&e!==void 0?e:b;return c`
    ...
    `}};l([h({type:Number})],Ye.prototype,"itemCount",void 0);l([h({type:Object})],Ye.prototype,"cellProvider",void 0);l([h({type:Object})],Ye.prototype,"placeholderCellTemplate",void 0);l([h({type:Boolean})],Ye.prototype,"scrollOptimizationsDisabled",void 0);l([h({type:String})],Ye.prototype,"ariaLandmarkLabel",void 0);l([Z("#sentinel")],Ye.prototype,"sentinel",void 0);l([Jl(".cell-container")],Ye.prototype,"cellContainers",void 0);Ye=l([L("infinite-scroller")],Ye);function hn(a){return a==null?void 0:a.replace(/%22%22(?!%22%22)(.+?)%22%22/g,"%22$1%22")}function pn(a){var e,t,i;return((e=a==null?void 0:a.rawMetadata)===null||e===void 0?void 0:e.hit_type)==="favorited_search"?"search":(i=(t=a.mediatype)===null||t===void 0?void 0:t.value)!==null&&i!==void 0?i:"data"}const un=U`
  <svg
    viewBox="0 0 100 100"
...
`;function Dt(a,e="short",t="en-US"){if(!a)return"";const i={};switch(e){case"year-only":i.year="numeric";break;case"short":i.month="short",i.year="numeric";break;case"long":i.year="numeric",i.month="short",i.day="2-digit";break}return new Intl.DateTimeFormat(t,i).format(a)}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const En=(a,e,t)=>{for(const i of e)if(i[0]===a)return(0,i[1])();return t==null?void 0:t()};var Mn=U`
...
`,Be;let Te=Be=class extends F{constructor(){super(...arguments),this.placeholderType=null,this.detailMessage=""}render(){return this.placeholderType?c`${this.placeholderTemplate}`:b}get placeholderTemplate(){return c`
      <div
        class="placeholder ${this.placeholderType} ${this.isMobileView?"mobile":"desktop"}"
      >
        ${En(this.placeholderType,[["empty-query",()=>this.emptyQueryTemplate],["empty-collection",()=>this.emptyCollectionTemplate],["no-results",()=>this.noResultsTemplate],["query-error",()=>this.queryErrorTemplate],["collection-error",()=>this.collectionErrorTemplate]])}
      </div>
    `}get emptyQueryTemplate(){return c`
      <h2 class="title" data-testid="empty-query-text-msg">
        ${Be.MESSAGE_EMPTY_QUERY}
      </h2>
      <div>${Mn}</div>
    `}get emptyCollectionTemplate(){return c`
      <h2 class="title" data-testid="empty-collection-text-msg">
        ${Be.MESSAGE_NO_VIEWABLE_MEMBERS}
      </h2>
      <div>${Li}</div>
    `}get noResultsTemplate(){return c`
      <h2 class="title" data-testid="empty-results-text-msg">
        ${this.isCollection?Be.MESSAGE_NO_COLLECTION_RESULTS:Be.MESSAGE_NO_SEARCH_RESULTS}
      </h2>
      <div>${Li}</div>
    `}get queryErrorTemplate(){return c`
      <h2 class="title" data-testid="error-query-text-msg">
        ${Be.MESSAGE_QUERY_ERROR}
      </h2>
      <div>${Li}</div>
      <p class="error-details">
        ${Be.QUERY_ERROR_DETAILS_MESSAGE} ${this.detailMessage}
      </p>
    `}get collectionErrorTemplate(){return c`
      <h2 class="title" data-testid="error-collection-text-msg">
        ${Be.MESSAGE_COLLECTION_ERROR}
      </h2>
      <div>${Li}</div>
      <p class="error-details">
        ${Be.QUERY_ERROR_DETAILS_MESSAGE} ${this.detailMessage}
...
`;var sa;(function(a){a[a.bytes=0]="bytes",a[a.kilobytes=1]="kilobytes",a[a.megabytes=2]="megabytes",a[a.gigabytes=3]="gigabytes",a[a.terabytes=4]="terabytes",a[a.petabytes=5]="petabytes",a[a.exabytes=6]="exabytes",a[a.zettabytes=7]="zettabytes",a[a.yottabytes=8]="yottabytes"})(sa||(sa={}));function zn(a,e,t=" "){let i=a;if(i===void 0)return b;let o=0;for(;i>1024;)i/=1024,o+=1;const r=10**e;i=Math.round(i*r)/r;let s=sa[o];return s=i===1?s.slice(0,-1):s,`${i.toLocaleString()+t+s}`}const Pn=v`var(--tileBackgroundColor, #ffffff)`,An=v`var(--tileCornerRadius, 4px)`,ro=v`
...
`;class Lr{constructor(e={}){var t;this.model=e.model,this.baseNavigationUrl=e.baseNavigationUrl,this.collectionPagePath=(t=e.collectionPagePath)!==null&&t!==void 0?t:"/details/",this.sortParam=e.sortParam,this.creatorFilter=e.creatorFilter}get firstCreatorMatchingFilter(){var e,t;let i;if(this.creatorFilter&&((e=this.model)===null||e===void 0?void 0:e.creators.length)){const o=this.creatorFilter;i=this.model.creators.find(r=>r.normalize("NFD").replace(/[^A-Z]+/gi,"").toUpperCase().startsWith(o))}return i!=null?i:(t=this.model)===null||t===void 0?void 0:t.creator}get accountLabel(){var e;return!((e=this.model)===null||e===void 0)&&e.dateAdded?M(ht`Archivist since ${this.model.dateAdded.getFullYear()}`):""}get dateLabel(){var e;switch((e=this.sortParam)===null||e===void 0?void 0:e.field){case"publicdate":return M("Archived");case"reviewdate":return M("Reviewed");case"addeddate":return M("Added");case"date":return M("Published");default:return""}}itemPageUrl(e,t=!1){if(!e||this.baseNavigationUrl==null)return b;const i=t?this.collectionPagePath:"/details/";return`${this.baseNavigationUrl}${i}${e}`}webArchivesCaptureLink(e,t){const o=`https://web.archive.org/web/${t.toISOString().replace(/[TZ:-]/g,"").replace(/\..*/,"")}/${encodeURIComponent(e)}`,r=Dt(t,"long");return c` <a href=${o}> ${r} </a> `}}class ce extends F{constructor(){super(...arguments),this.sortParam=null,this.defaultSortParam=null,this.loggedIn=!1,this.displayValueProvider=new Lr}willUpdate(e){var t,i;(e.has("model")||e.has("baseNavigationUrl")||e.has("collectionPagePath")||e.has("sortParam")||e.has("defaultSortParam")||e.has("creatorFilter"))&&(this.displayValueProvider=new Lr({model:this.model,baseNavigationUrl:this.baseNavigationUrl,collectionPagePath:this.collectionPagePath,sortParam:(i=(t=this.sortParam)!==null&&t!==void 0?t:this.defaultSortParam)!==null&&i!==void 0?i:void 0,creatorFilter:this.creatorFilter}))}}l([h({type:Object})],ce.prototype,"model",void 0);l([h({type:Number})],ce.prototype,"currentWidth",void 0);l([h({type:Number})],ce.prototype,"currentHeight",void 0);l([h({type:String})],ce.prototype,"baseNavigationUrl",void 0);l([h({type:String})],ce.prototype,"baseImageUrl",void 0);l([h({type:String})],ce.prototype,"collectionPagePath",void 0);l([h({type:Object})],ce.prototype,"sortParam",void 0);l([h({type:Object})],ce.prototype,"defaultSortParam",void 0);l([h({type:String})],ce.prototype,"creatorFilter",void 0);l([h({type:Number})],ce.prototype,"mobileBreakpoint",void 0);l([h({type:Boolean})],ce.prototype,"loggedIn",void 0);let la=class extends F{render(){return c`<div class="icon-overlay">${this.iconTemplate}</div>`}get iconTemplate(){var e;return this.type?c`${(e=Is[this.type])!==null&&e!==void 0?e:b}`:b}static get styles(){return v`
    ...
    `}};l([h({type:String})],la.prototype,"type",void 0);la=l([L("icon-overlay")],la);let na=class extends F{render(){return c`
      <div class="overlay no-preview">
        <div class="icon-overlay">${this.iconTemplate}</div>
        <p class="text-overlay">${this.textTemplate}</p>
      </div>
    `}get iconTemplate(){var e;return this.type?c`${(e=Is[this.type])!==null&&e!==void 0?e:b}`:b}get textTemplate(){var e;return this.type?c`${(e=vn[this.type])!==null&&e!==void 0?e:b}`:b}static get styles(){return v`
      :host {
        align-items: center;
        display: flex;
      }
    ...
    `}};l([h({type:String})],na.prototype,"type",void 0);na=l([L("text-overlay")],na);let tt=class extends F{constructor(){super(...arguments),this.isCompactTile=!1,this.isListTile=!1,this.loggedIn=!1,this.viewSize="desktop"}render(){var e;return!((e=this.model)===null||e===void 0)&&e.identifier?c`
      <div class=${Lt(this.baseClass)}>
        <item-image
          .model=${this.model}
    ...
    `}};l([h({type:String})],tt.prototype,"baseImageUrl",void 0);l([h({type:Boolean})],tt.prototype,"isCompactTile",void 0);l([h({type:Boolean})],tt.prototype,"isListTile",void 0);l([h({type:Boolean})],tt.prototype,"loggedIn",void 0);l([h({type:Object})],tt.prototype,"model",void 0);l([h({type:String})],tt.prototype,"viewSize",void 0);tt=l([L("image-block")],tt);let da=class extends ce{constructor(){super(...arguments),this.showInfoButton=!1}render(){return c`
      <div class="container">
    ...
    >`}get getSizeTemplate(){var e,t;const i=(t=(e=this.model)===null||e===void 0?void 0:e.collectionSize)!==null&&t!==void 0?t:0;return i?c`<span id="item-size">${zn(i,1)}</span>`:""}get infoButtonTemplate(){return this.showInfoButton?c`<button class="info-button" @click=${this.infoButtonPressed}>
          &#9432;
          <span class="sr-only">${M("More info")}</span>
        </button>`:b}infoButtonPressed(e){e.preventDefault();const t=new CustomEvent("infoButtonPressed",{detail:{x:e.clientX,y:e.clientY}});this.dispatchEvent(t)}static get styles(){const e=v`var(--tileBorderColor, #555555)`,t=v`var(--tileBackgroundColor, #666666)`,i=v`#fff`;return[ro,v`
        .container {
          background-color: ${t};
          border: 1px solid ${e};
        }
      ...
      `]}};l([h({type:Boolean})],da.prototype,"showInfoButton",void 0);da=l([L("collection-tile")],da);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*Mt(a,e){if(a!==void 0){let t=0;for(const i of a)yield e(i,t++)}}function Ln(a){return new Date(a.getTime()-a.getTimezoneOffset()*1e3*60)}function Ba(a){return a?Ln(a).toISOString().endsWith("-01-01T00:00:00.000Z"):!1}const Qs=c`
...
`;let Rt=class extends F{constructor(){super(...arguments),this.title="",this.body="",this.starRating=0,this.viewSize="desktop"}render(){return!this.title&&!this.body&&!this.starRating?b:c`
    ...
    `}get filledStarTemplate(){return c`<span aria-hidden="true">${Qs}</span>`}get unfilledStarTemplate(){return c`
      <span class="unfilled-star" aria-hidden="true">
        ${Dn}
      </span>
    `}static get styles(){return[Ze,v`
        .review-container {
          display: flex;
          flex-direction: row;
          flex-wrap: wrap;
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*Bi(a,e){const t=typeof e=="function";if(a!==void 0){let i=-1;for(const o of a)i>-1&&(yield t?e(i):e),i++,yield o}}let Ki=class extends F{constructor(){super(...arguments),this.snippets=[],this.viewSize="desktop"}render(){var e;return!((e=this.snippets)===null||e===void 0)&&e.length?c`
      <div class="container">
        <div class="snippet-view ${this.viewSize}">
    ...
    `:c`${b}`}get ellipsisJoinedSnippets(){return c`
      &hellip; ${Bi(this.snippetTemplates,c` &hellip; `)} &hellip;
    `}get snippetTemplates(){var e;return(e=this.snippets)===null||e===void 0?void 0:e.map(t=>{const i=t.matchAll(/{{{(.+?)}}}/gs),o=[];let r=0;for(const s of i)s.index!=null&&(o.push(c`
            ${t.slice(r,s.index)}
            <mark>${s[1]}</mark>
          `),r=s.index+s[0].length);return o.push(c`${t.slice(r)}`),c`<span>${o}</span>`})}static get styles(){return v`
      .container {
        display: flex;
        flex-direction: row;
        flex-wrap: wrap;
    ...
    `}};l([h({type:Array})],Ki.prototype,"snippets",void 0);l([h({type:String})],Ki.prototype,"viewSize",void 0);Ki=l([L("text-snippet-block")],Ki);const Rn=v`
  .drop-shadow {
    overflow: hidden;
    height: 100%;
  }
...
`;let Ne=class extends F{constructor(){super(...arguments),this.isListTile=!1,this.isCompactTile=!1,this.loggedIn=!1,this.isWaveform=!1,this.isNotFound=!1}render(){return c`
    ...
    `}get imageSrc(){var e,t;if(this.isNotFound)return this.notFoundSrc;if(((e=this.model)===null||e===void 0?void 0:e.captureDates)&&this.model.identifier)try{const i=new URL(this.model.identifier),o=encodeURIComponent(i.hostname);return this.baseImageUrl?`https://web.archive.org/thumb/${o}?generate=1`:b}catch{return`${this.baseImageUrl}/images/notfound.png`}return this.baseImageUrl&&((t=this.model)===null||t===void 0?void 0:t.identifier)?`${this.baseImageUrl}/services/img/${this.model.identifier}`:b}get notFoundSrc(){return this.baseImageUrl?`${this.baseImageUrl}/images/notfound.png`:b}get hashBasedGradient(){var e;return!((e=this.model)===null||e===void 0)&&e.identifier?`waveform-grad${this.hashStrToInt(this.model.identifier)%6}`:"waveform-grad0"}hashStrToInt(e){return e.split("").reduce((t,i)=>t+i.charCodeAt(0),0)}get itemBaseClass(){var e;return{"drop-shadow":!0,"list-box":this.isListTile,"search-image":((e=this.model)===null||e===void 0?void 0:e.mediatype)==="search",[this.hashBasedGradient]:this.isWaveform}}get itemImageClass(){var e,t,i;const o=((e=this.model)===null||e===void 0?void 0:e.contentWarning)||((t=this.model)===null||t===void 0?void 0:t.loginRequired);return{contain:!this.isCompactTile&&!this.isWaveform,cover:this.isCompactTile,blur:o||!1,waveform:this.isWaveform,"account-image":this.isAccountImage,"collection-image":((i=this.model)===null||i===void 0?void 0:i.mediatype)==="collection"}}get isAccountImage(){var e;return((e=this.model)===null||e===void 0?void 0:e.mediatype)==="account"&&!this.isCompactTile&&!this.isListTile}onLoad(){var e,t;(((e=this.model)===null||e===void 0?void 0:e.mediatype)==="audio"||((t=this.model)===null||t===void 0?void 0:t.mediatype)==="etree")&&this.baseImage.naturalWidth/this.baseImage.naturalHeight===4&&(this.isWaveform=!0)}onError(){this.isNotFound=!0}static get styles(){return[Rn,Fn,v`
      ...
      `]}};l([h({type:Object})],Ne.prototype,"model",void 0);l([h({type:String})],Ne.prototype,"baseImageUrl",void 0);l([h({type:Boolean})],Ne.prototype,"isListTile",void 0);l([h({type:Boolean})],Ne.prototype,"isCompactTile",void 0);l([h({type:Boolean})],Ne.prototype,"loggedIn",void 0);l([P()],Ne.prototype,"isWaveform",void 0);l([P()],Ne.prototype,"isNotFound",void 0);l([Z("img")],Ne.prototype,"baseImage",void 0);Ne=l([L("item-image")],Ne);const Bn=U`
...
`,Ks={account:{color:"#000000",icon:Bn,text:"Account"},audio:{color:"#00adef",icon:On,text:"Audio"},collection:{color:"#4666ff",icon:js,text:"Collection"},data:{color:"#333333",icon:In,text:"Data"},etree:{color:"#00adef",icon:Un,text:"E-tree"},film:{color:"#bf1b2c",icon:Dr,text:"Film"},image:{color:"#aa99c9",icon:Nn,text:"Image"},movies:{color:"#f1644b",icon:Dr,text:"Movie"},radio:{color:"#8fdaef",icon:Hn,text:"Radio"},software:{color:"#9ecc4f",icon:Vn,text:"Software"},texts:{color:"#faab3c",icon:Wn,text:"Text"},tv:{color:"#f1644b",icon:jn,text:"TV"},video:{color:"#f1644b",icon:Qn,text:"Video"},web:{color:"#ffcd27",icon:Gn,text:"Web"},search:{color:"#000000",icon:Gs,text:"Search"}};let vi=class extends F{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var e,t;const i=["tvnews","tvarchive","television"],o=["radio","radioprogram"];return this.mediatype==="movies"&&((e=this.collections)===null||e===void 0?void 0:e.some(r=>i.indexOf(r)>=0))?"tv":this.mediatype==="audio"&&((t=this.collections)===null||t===void 0?void 0:t.some(r=>o.indexOf(r)>=0))?"radio":this.mediatype||""}render(){const e=Ks[this.displayMediatype];return e?c`
      <div
        id="icon"
    ...
    `}};l([h({type:String})],vi.prototype,"mediatype",void 0);l([h({type:Array})],vi.prototype,"collections",void 0);l([h({type:Boolean})],vi.prototype,"showText",void 0);vi=l([L("mediatype-icon")],vi);const Kn=U`
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path
...
`;function Xn(a,e){let t=1;return a>=1e9?t=1e9:a>=1e6?t=1e6:a>=1e3&&e==="short"&&(t=1e3),t}function Zn(a=0,e){const t=a/e,i=t<10;let o=0;return i?o=Math.round((t+Number.EPSILON)*10)/10:o=Math.round(t),o}function Jn(a,e,t,i){switch(e){case 1e9:return M(t==="short"?ht`${a}B`:ht`${a} billion`);case 1e6:return M(t==="short"?ht`${a}M`:ht`${a} million`);case 1e3:return M(t==="short"?ht`${a}K`:ht`${a} thousand`);default:return new Intl.NumberFormat(i).format(a)}}function ci(a,e="long",t="short",i="en-US"){const o=a!=null?a:-1;if(o<0)return"";const r=Xn(o,e),s=Zn(o,r);return Jn(s,r,t,i)}let it=class extends F{render(){var e,t,i,o,r;const s=ci(this.favCount,"short","short"),n=ci(this.commentCount,"short","short"),d=this.mediatype==="account"?`${(e=this.itemCount)!==null&&e!==void 0?e:0} uploads`:`${(t=this.viewCount)!==null&&t!==void 0?t:0} ${(i=this.viewLabel)!==null&&i!==void 0?i:"all-time views"}`;return c`
      <div class="item-stats">
        ...
        <ul id="stats-row">
          ...
          <li class="col" title="${d}">
            ${this.mediatype==="account"?qn:Yn}
            <p class="status-text">
              <span class="sr-only">
                ${this.mediatype==="account"?M("Uploads:"):M("Views:")}
              </span>
              ${ci(this.mediatype==="account"?(o=this.itemCount)!==null&&o!==void 0?o:0:(r=this.viewCount)!==null&&r!==void 0?r:0,"short","short")}
            </p>
          </li>
    ...
    `}static get styles(){return[Ze,v`
      ...
      `]}};l([h({type:String})],it.prototype,"mediatype",void 0);l([h({type:Number})],it.prototype,"itemCount",void 0);l([h({type:Number})],it.prototype,"viewCount",void 0);l([h({type:String})],it.prototype,"viewLabel",void 0);l([h({type:Number})],it.prototype,"favCount",void 0);l([h({type:Number})],it.prototype,"commentCount",void 0);it=l([L("tile-stats")],it);let ca=class extends ce{constructor(){super(...arguments),this.showInfoButton=!1}render(){var e,t,i,o,r,s,n;const d=(e=this.model)===null||e===void 0?void 0:e.title,p=(t=this.sortParam)!==null&&t!==void 0?t:this.defaultSortParam,[f,m]=(p==null?void 0:p.field)==="week"?[(i=this.model)===null||i===void 0?void 0:i.weeklyViewCount,"weekly views"]:[(o=this.model)===null||o===void 0?void 0:o.viewCount,"all-time views"];return c`
      <div class="container">
        ${this.infoButtonTemplate}
        <div class="tile-details">
          <div class="item-info">
    ...
    `}get sortedDateInfoTemplate(){var e,t,i,o,r;let s,n="long";switch((e=this.effectiveSort)===null||e===void 0?void 0:e.field){case"date":{const d=(t=this.model)===null||t===void 0?void 0:t.datePublished;s={field:"published",value:d},Ba(d)&&(n="year-only");break}case"reviewdate":s={field:"reviewed",value:(i=this.model)===null||i===void 0?void 0:i.dateReviewed};break;case"addeddate":s={field:"added",value:(o=this.model)===null||o===void 0?void 0:o.dateAdded};break;case"publicdate":s={field:"archived",value:(r=this.model)===null||r===void 0?void 0:r.dateArchived};break}return s!=null&&s.value?c`
      <div class="date-sorted-by truncated">
        <span>
          ${s==null?void 0:s.field} ${Dt(s==null?void 0:s.value,n)}
        </span>
      </div>
    ...
    `}get isSortedByDate(){var e;return["date","reviewdate","addeddate","publicdate"].includes((e=this.effectiveSort)===null||e===void 0?void 0:e.field)}get effectiveSort(){var e;return(e=this.sortParam)!==null&&e!==void 0?e:this.defaultSortParam}get hasSnippets(){var e,t;return!!(!((t=(e=this.model)===null||e===void 0?void 0:e.snippets)===null||t===void 0)&&t.length)}infoButtonPressed(e){e.preventDefault();const t=new CustomEvent("infoButtonPressed",{detail:{x:e.clientX,y:e.clientY}});this.dispatchEvent(t)}static get styles(){const e=v`var(--tileBorderColor, #dddddd)`;return[ro,v`
      ...
      `]}};l([h({type:Boolean})],ca.prototype,"showInfoButton",void 0);ca=l([L("item-tile")],ca);let ha=class extends ce{constructor(){super(...arguments),this.showInfoButton=!1}render(){return c`
      <div class="container">
        ${this.infoButtonTemplate}
        <div class="tile-details">
          <div class="item-info">
    ...
    >
          ...
          &#9432;
          <span class="sr-only">${M("More info")}</span>
        </button>`:b}infoButtonPressed(e){e.preventDefault();const t=new CustomEvent("infoButtonPressed",{detail:{x:e.clientX,y:e.clientY}});this.dispatchEvent(t)}static get styles(){const e=v`var(--tileBorderColor, #dddddd)`;return[ro,v`
        .container {
          border: 1px solid ${e};
        }
      `]}};l([h({type:Boolean})],ha.prototype,"showInfoButton",void 0);ha=l([L("account-tile")],ha);let pa=class extends ce{constructor(){super(...arguments),this.showInfoButton=!1}render(){return c`
      <div class="container">
        <div class="tile-details">
          <div class="item-info">
            ${this.getImageBlockTemplate} ${this.getTitleTemplate}
    ...
    `}get getTitleTemplate(){var e;return c`<div id="title">
      <h4 class="truncated">${(e=this.model)===null||e===void 0?void 0:e.title}</h4>
    </div>`}static get styles(){const e=v`var(--tileBorderColor, #555555)`,t=v`var(--tileBackgroundColor, #666666)`,i=v`#fff`;return[ro,v`
        .container {
          background-color: ${t};
          border: 1px solid ${e};
        }
      ...
      `]}};l([h({type:Boolean})],pa.prototype,"showInfoButton",void 0);pa=l([L("search-tile")],pa);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class ua extends Ci{constructor(e){if(super(e),this.it=b,e.type!==Oe.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===b||e==null)return this.ft=void 0,this.it=e;if(e===ke)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this.ft;this.it=e;const t=[e];return t.raw=t,this.ft={_$litType$:this.constructor.resultType,strings:t,values:[]}}}ua.directiveName="unsafeHTML",ua.resultType=1;const ed=$i(ua);/*! @license DOMPurify 3.1.7 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/3.1.7/LICENSE */const{entries:qs,setPrototypeOf:Rr,isFrozen:td,getPrototypeOf:id,getOwnPropertyDescriptor:od}=Object;let{freeze:we,seal:ze,create:Ys}=Object,{apply:fa,construct:va}=typeof Reflect!="undefined"&&Reflect;we||(we=function(e){return e});ze||(ze=function(e){return e});fa||(fa=function(e,t,i){return e.apply(t,i)});va||(va=function(e,t){return new e(...t)});const Di=Ee(Array.prototype.forEach),Fr=Ee(Array.prototype.pop),ii=Ee(Array.prototype.push),Oi=Ee(String.prototype.toLowerCase),zo=Ee(String.prototype.toString),Br=Ee(String.prototype.match),oi=Ee(String.prototype.replace),ad=Ee(String.prototype.indexOf),rd=Ee(String.prototype.trim),Ae=Ee(Object.prototype.hasOwnProperty),be=Ee(RegExp.prototype.test),ai=sd(TypeError);function Ee(a){return function(e){for(var t=arguments.length,i=new Array(t>1?t-1:0),o=1;o<t;o++)i[o-1]=arguments[o];return fa(a,e,i)}}function sd(a){return function(){for(var e=arguments.length,t=new Array(e),i=0;i<e;i++)t[i]=arguments[i];return va(a,t)}}function I(a,e){let t=arguments.length>2&&arguments[2]!==void 0?arguments[2]:Oi;Rr&&Rr(a,null);let i=e.length;for(;i--;){let o=e[i];if(typeof o=="string"){const r=t(o);r!==o&&(td(e)||(e[i]=r),o=r)}a[o]=!0}return a}function ld(a){for(let e=0;e<a.length;e++)Ae(a,e)||(a[e]=null);return a}function pt(a){const e=Ys(null);for(const[t,i]of qs(a))Ae(a,t)&&(Array.isArray(i)?e[t]=ld(i):i&&typeof i=="object"&&i.constructor===Object?e[t]=pt(i):e[t]=i);return e}function ri(a,e){for(;a!==null;){const i=od(a,e);if(i){if(i.get)return Ee(i.get);if(typeof i.value=="function")return Ee(i.value)}a=id(a)}function t(){return null}return t}const Or=we(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","section","select","shadow","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),Po=we(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","filter","font","g","glyph","glyphref","hkern","image","line","lineargradient","marker","mask","metadata","mpath","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),Ao=we(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feDropShadow","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),nd=we(["animate","color-profile","cursor","discard","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),Lo=we(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover","mprescripts"]),dd=we(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),Ir=we(["#text"]),Ur=we(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","face","for","headers","height","hidden","high","href","hreflang","id","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","pattern","placeholder","playsinline","popover","popovertarget","popovertargetaction","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","wrap","xmlns","slot"]),Do=we(["accent-height","accumulate","additive","alignment-baseline","amplitude","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","exponent","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","intercept","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","slope","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","tablevalues","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),Nr=we(["accent","accentunder","align","bevelled","close","columnsalign","columnlines","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lspace","lquote","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),Ri=we(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),cd=ze(/\{\{[\w\W]*|[\w\W]*\}\}/gm),hd=ze(/<%[\w\W]*|[\w\W]*%>/gm),pd=ze(/\${[\w\W]*}/gm),ud=ze(/^data-[\-\w.\u00B7-\uFFFF]/),fd=ze(/^aria-[\-\w]+$/),Xs=ze(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),vd=ze(/^(?:\w+script|data):/i),md=ze(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),Zs=ze(/^html$/i),gd=ze(/^[a-z][.\w]*(-[.\w]+)+$/i);var Hr=Object.freeze({__proto__:null,MUSTACHE_EXPR:cd,ERB_EXPR:hd,TMPLIT_EXPR:pd,DATA_ATTR:ud,ARIA_ATTR:fd,IS_ALLOWED_URI:Xs,IS_SCRIPT_OR_DATA:vd,ATTR_WHITESPACE:md,DOCTYPE_NAME:Zs,CUSTOM_ELEMENT:gd});const si={element:1,attribute:2,text:3,cdataSection:4,entityReference:5,entityNode:6,progressingInstruction:7,comment:8,document:9,documentType:10,documentFragment:11,notation:12},bd=function(){return typeof window=="undefined"?null:window},yd=function(e,t){if(typeof e!="object"||typeof e.createPolicy!="function")return null;let i=null;const o="data-tt-policy-suffix";t&&t.hasAttribute(o)&&(i=t.getAttribute(o));const r="dompurify"+(i?"#"+i:"");try{return e.createPolicy(r,{createHTML(s){return s},createScriptURL(s){return s}})}catch{return console.warn("TrustedTypes policy "+r+" could not be created."),null}};function Js(){let a=arguments.length>0&&arguments[0]!==void 0?arguments[0]:bd();const e=z=>Js(z);if(e.version="3.1.7",e.removed=[],!a||!a.document||a.document.nodeType!==si.document)return e.isSupported=!1,e;let{document:t}=a;const i=t,o=i.currentScript,{DocumentFragment:r,HTMLTemplateElement:s,Node:n,Element:d,NodeFilter:p,NamedNodeMap:f=a.NamedNodeMap||a.MozNamedAttrMap,HTMLFormElement:m,DOMParser:y,trustedTypes:w}=a,x=d.prototype,C=ri(x,"cloneNode"),A=ri(x,"remove"),B=ri(x,"nextSibling"),D=ri(x,"childNodes"),W=ri(x,"parentNode");if(typeof s=="function"){const z=t.createElement("template");z.content&&z.content.ownerDocument&&(t=z.content.ownerDocument)}let R,J="";const{implementation:he,createNodeIterator:Pe,createDocumentFragment:j,getElementsByTagName:$e}=t,{importNode:Wt}=i;let xe={};e.isSupported=typeof qs=="function"&&typeof W=="function"&&he&&he.createHTMLDocument!==void 0;const{MUSTACHE_EXPR:at,ERB_EXPR:rt,TMPLIT_EXPR:st,DATA_ATTR:jt,ARIA_ATTR:Qt,IS_SCRIPT_OR_DATA:Gt,ATTR_WHITESPACE:bt,CUSTOM_ELEMENT:Kt}=Hr;let{IS_ALLOWED_URI:yt}=Hr,ie=null;const qt=I({},[...Or,...Po,...Ao,...Lo,...Ir]);let pe=null;const Ha=I({},[...Ur,...Do,...Nr,...Ri]);let ae=Object.seal(Ys(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),Yt=null,ho=null,Va=!0,po=!0,Wa=!1,ja=!0,wt=!1,uo=!0,lt=!1,fo=!1,vo=!1,_t=!1,Ti=!1,Ei=!1,Qa=!0,Ga=!1;const fl="user-content-";let mo=!0,Xt=!1,xt={},St=null;const Ka=I({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","style","svg","template","thead","title","video","xmp"]);let qa=null;const Ya=I({},["audio","video","img","source","image","track"]);let go=null;const Xa=I({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),Mi="http://www.w3.org/1998/Math/MathML",zi="http://www.w3.org/2000/svg",je="http://www.w3.org/1999/xhtml";let $t=je,bo=!1,yo=null;const vl=I({},[Mi,zi,je],zo);let Zt=null;const ml=["application/xhtml+xml","text/html"],gl="text/html";let ue=null,Ct=null;const bl=t.createElement("form"),Za=function(u){return u instanceof RegExp||u instanceof Function},wo=function(){let u=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if(!(Ct&&Ct===u)){if((!u||typeof u!="object")&&(u={}),u=pt(u),Zt=ml.indexOf(u.PARSER_MEDIA_TYPE)===-1?gl:u.PARSER_MEDIA_TYPE,ue=Zt==="application/xhtml+xml"?zo:Oi,ie=Ae(u,"ALLOWED_TAGS")?I({},u.ALLOWED_TAGS,ue):qt,pe=Ae(u,"ALLOWED_ATTR")?I({},u.ALLOWED_ATTR,ue):Ha,yo=Ae(u,"ALLOWED_NAMESPACES")?I({},u.ALLOWED_NAMESPACES,zo):vl,go=Ae(u,"ADD_URI_SAFE_ATTR")?I(pt(Xa),u.ADD_URI_SAFE_ATTR,ue):Xa,qa=Ae(u,"ADD_DATA_URI_TAGS")?I(pt(Ya),u.ADD_DATA_URI_TAGS,ue):Ya,St=Ae(u,"FORBID_CONTENTS")?I({},u.FORBID_CONTENTS,ue):Ka,Yt=Ae(u,"FORBID_TAGS")?I({},u.FORBID_TAGS,ue):{},ho=Ae(u,"FORBID_ATTR")?I({},u.FORBID_ATTR,ue):{},xt=Ae(u,"USE_PROFILES")?u.USE_PROFILES:!1,Va=u.ALLOW_ARIA_ATTR!==!1,po=u.ALLOW_DATA_ATTR!==!1,Wa=u.ALLOW_UNKNOWN_PROTOCOLS||!1,ja=u.ALLOW_SELF_CLOSE_IN_ATTR!==!1,wt=u.SAFE_FOR_TEMPLATES||!1,uo=u.SAFE_FOR_XML!==!1,lt=u.WHOLE_DOCUMENT||!1,_t=u.RETURN_DOM||!1,Ti=u.RETURN_DOM_FRAGMENT||!1,Ei=u.RETURN_TRUSTED_TYPE||!1,vo=u.FORCE_BODY||!1,Qa=u.SANITIZE_DOM!==!1,Ga=u.SANITIZE_NAMED_PROPS||!1,mo=u.KEEP_CONTENT!==!1,Xt=u.IN_PLACE||!1,yt=u.ALLOWED_URI_REGEXP||Xs,$t=u.NAMESPACE||je,ae=u.CUSTOM_ELEMENT_HANDLING||{},u.CUSTOM_ELEMENT_HANDLING&&Za(u.CUSTOM_ELEMENT_HANDLING.tagNameCheck)&&(ae.tagNameCheck=u.CUSTOM_ELEMENT_HANDLING.tagNameCheck),u.CUSTOM_ELEMENT_HANDLING&&Za(u.CUSTOM_ELEMENT_HANDLING.attributeNameCheck)&&(ae.attributeNameCheck=u.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),u.CUSTOM_ELEMENT_HANDLING&&typeof u.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements=="boolean"&&(ae.allowCustomizedBuiltInElements=u.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements),wt&&(po=!1),Ti&&(_t=!0),xt&&(ie=I({},Ir),pe=[],xt.html===!0&&(I(ie,Or),I(pe,Ur)),xt.svg===!0&&(I(ie,Po),I(pe,Do),I(pe,Ri)),xt.svgFilters===!0&&(I(ie,Ao),I(pe,Do),I(pe,Ri)),xt.mathMl===!0&&(I(ie,Lo),I(pe,Nr),I(pe,Ri))),u.ADD_TAGS&&(ie===qt&&(ie=pt(ie)),I(ie,u.ADD_TAGS,ue)),u.ADD_ATTR&&(pe===Ha&&(pe=pt(pe)),I(pe,u.ADD_ATTR,ue)),u.ADD_URI_SAFE_ATTR&&I(go,u.ADD_URI_SAFE_ATTR,ue),u.FORBID_CONTENTS&&(St===Ka&&(St=pt(St)),I(St,u.FORBID_CONTENTS,ue)),mo&&(ie["#text"]=!0),lt&&I(ie,["html","head","body"]),ie.table&&(I(ie,["tbody"]),delete Yt.tbody),u.TRUSTED_TYPES_POLICY){if(typeof u.TRUSTED_TYPES_POLICY.createHTML!="function")throw ai('TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.');if(typeof u.TRUSTED_TYPES_POLICY.createScriptURL!="function")throw ai('TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.');R=u.TRUSTED_TYPES_POLICY,J=R.createHTML("")}else R===void 0&&(R=yd(w,o)),R!==null&&typeof J=="string"&&(J=R.createHTML(""));we&&we(u),Ct=u}},Ja=I({},["mi","mo","mn","ms","mtext"]),er=I({},["annotation-xml"]),yl=I({},["title","style","font","a","script"]),tr=I({},[...Po,...Ao,...nd]),ir=I({},[...Lo,...dd]),wl=function(u){let _=W(u);(!_||!_.tagName)&&(_={namespaceURI:$t,tagName:"template"});const T=Oi(u.tagName),Q=Oi(_.tagName);return yo[u.namespaceURI]?u.namespaceURI===zi?_.namespaceURI===je?T==="svg":_.namespaceURI===Mi?T==="svg"&&(Q==="annotation-xml"||Ja[Q]):Boolean(tr[T]):u.namespaceURI===Mi?_.namespaceURI===je?T==="math":_.namespaceURI===zi?T==="math"&&er[Q]:Boolean(ir[T]):u.namespaceURI===je?_.namespaceURI===zi&&!er[Q]||_.namespaceURI===Mi&&!Ja[Q]?!1:!ir[T]&&(yl[T]||!tr[T]):!!(Zt==="application/xhtml+xml"&&yo[u.namespaceURI]):!1},Re=function(u){ii(e.removed,{element:u});try{W(u).removeChild(u)}catch{A(u)}},Pi=function(u,_){try{ii(e.removed,{attribute:_.getAttributeNode(u),from:_})}catch{ii(e.removed,{attribute:null,from:_})}if(_.removeAttribute(u),u==="is"&&!pe[u])if(_t||Ti)try{Re(_)}catch{}else try{_.setAttribute(u,"")}catch{}},or=function(u){let _=null,T=null;if(vo)u="<remove></remove>"+u;else{const fe=Br(u,/^[\r\n\t ]+/);T=fe&&fe[0]}Zt==="application/xhtml+xml"&&$t===je&&(u='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+u+"</body></html>");const Q=R?R.createHTML(u):u;if($t===je)try{_=new y().parseFromString(Q,Zt)}catch{}if(!_||!_.documentElement){_=he.createDocument($t,"template",null);try{_.documentElement.innerHTML=bo?J:Q}catch{}}const me=_.body||_.documentElement;return u&&T&&me.insertBefore(t.createTextNode(T),me.childNodes[0]||null),$t===je?$e.call(_,lt?"html":"body")[0]:lt?_.documentElement:me},ar=function(u){return Pe.call(u.ownerDocument||u,u,p.SHOW_ELEMENT|p.SHOW_COMMENT|p.SHOW_TEXT|p.SHOW_PROCESSING_INSTRUCTION|p.SHOW_CDATA_SECTION,null)},rr=function(u){return u instanceof m&&(typeof u.nodeName!="string"||typeof u.textContent!="string"||typeof u.removeChild!="function"||!(u.attributes instanceof f)||typeof u.removeAttribute!="function"||typeof u.setAttribute!="function"||typeof u.namespaceURI!="string"||typeof u.insertBefore!="function"||typeof u.hasChildNodes!="function")},sr=function(u){return typeof n=="function"&&u instanceof n},Qe=function(u,_,T){!xe[u]||Di(xe[u],Q=>{Q.call(e,_,T,Ct)})},lr=function(u){let _=null;if(Qe("beforeSanitizeElements",u,null),rr(u))return Re(u),!0;const T=ue(u.nodeName);if(Qe("uponSanitizeElement",u,{tagName:T,allowedTags:ie}),u.hasChildNodes()&&!sr(u.firstElementChild)&&be(/<[/\w]/g,u.innerHTML)&&be(/<[/\w]/g,u.textContent)||u.nodeType===si.progressingInstruction||uo&&u.nodeType===si.comment&&be(/<[/\w]/g,u.data))return Re(u),!0;if(!ie[T]||Yt[T]){if(!Yt[T]&&dr(T)&&(ae.tagNameCheck instanceof RegExp&&be(ae.tagNameCheck,T)||ae.tagNameCheck instanceof Function&&ae.tagNameCheck(T)))return!1;if(mo&&!St[T]){const Q=W(u)||u.parentNode,me=D(u)||u.childNodes;if(me&&Q){const fe=me.length;for(let Se=fe-1;Se>=0;--Se){const Fe=C(me[Se],!0);Fe.__removalCount=(u.__removalCount||0)+1,Q.insertBefore(Fe,B(u))}}}return Re(u),!0}return u instanceof d&&!wl(u)||(T==="noscript"||T==="noembed"||T==="noframes")&&be(/<\/no(script|embed|frames)/i,u.innerHTML)?(Re(u),!0):(wt&&u.nodeType===si.text&&(_=u.textContent,Di([at,rt,st],Q=>{_=oi(_,Q," ")}),u.textContent!==_&&(ii(e.removed,{element:u.cloneNode()}),u.textContent=_)),Qe("afterSanitizeElements",u,null),!1)},nr=function(u,_,T){if(Qa&&(_==="id"||_==="name")&&(T in t||T in bl))return!1;if(!(po&&!ho[_]&&be(jt,_))){if(!(Va&&be(Qt,_))){if(!pe[_]||ho[_]){if(!(dr(u)&&(ae.tagNameCheck instanceof RegExp&&be(ae.tagNameCheck,u)||ae.tagNameCheck instanceof Function&&ae.tagNameCheck(u))&&(ae.attributeNameCheck instanceof RegExp&&be(ae.attributeNameCheck,_)||ae.attributeNameCheck instanceof Function&&ae.attributeNameCheck(_))||_==="is"&&ae.allowCustomizedBuiltInElements&&(ae.tagNameCheck instanceof RegExp&&be(ae.tagNameCheck,T)||ae.tagNameCheck instanceof Function&&ae.tagNameCheck(T))))return!1}else if(!go[_]){if(!be(yt,oi(T,bt,""))){if(!((_==="src"||_==="xlink:href"||_==="href")&&u!=="script"&&ad(T,"data:")===0&&qa[u])){if(!(Wa&&!be(Gt,oi(T,bt,"")))){if(T)return!1}}}}}}return!0},dr=function(u){return u!=="annotation-xml"&&Br(u,Kt)},cr=function(u){Qe("beforeSanitizeAttributes",u,null);const{attributes:_}=u;if(!_)return;const T={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:pe};let Q=_.length;for(;Q--;){const me=_[Q],{name:fe,namespaceURI:Se,value:Fe}=me,Jt=ue(fe);let ge=fe==="value"?Fe:rd(Fe);if(T.attrName=Jt,T.attrValue=ge,T.keepAttr=!0,T.forceKeepAttr=void 0,Qe("uponSanitizeAttribute",u,T),ge=T.attrValue,T.forceKeepAttr||(Pi(fe,u),!T.keepAttr))continue;if(!ja&&be(/\/>/i,ge)){Pi(fe,u);continue}wt&&Di([at,rt,st],pr=>{ge=oi(ge,pr," ")});const hr=ue(u.nodeName);if(!!nr(hr,Jt,ge)){if(Ga&&(Jt==="id"||Jt==="name")&&(Pi(fe,u),ge=fl+ge),uo&&be(/((--!?|])>)|<\/(style|title)/i,ge)){Pi(fe,u);continue}if(R&&typeof w=="object"&&typeof w.getAttributeType=="function"&&!Se)switch(w.getAttributeType(hr,Jt)){case"TrustedHTML":{ge=R.createHTML(ge);break}case"TrustedScriptURL":{ge=R.createScriptURL(ge);break}}try{Se?u.setAttributeNS(Se,fe,ge):u.setAttribute(fe,ge),rr(u)?Re(u):Fr(e.removed)}catch{}}}Qe("afterSanitizeAttributes",u,null)},_l=function z(u){let _=null;const T=ar(u);for(Qe("beforeSanitizeShadowDOM",u,null);_=T.nextNode();)Qe("uponSanitizeShadowNode",_,null),!lr(_)&&(_.content instanceof r&&z(_.content),cr(_));Qe("afterSanitizeShadowDOM",u,null)};return e.sanitize=function(z){let u=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},_=null,T=null,Q=null,me=null;if(bo=!z,bo&&(z="<!-->"),typeof z!="string"&&!sr(z))if(typeof z.toString=="function"){if(z=z.toString(),typeof z!="string")throw ai("dirty is not a string, aborting")}else throw ai("toString is not a function");if(!e.isSupported)return z;if(fo||wo(u),e.removed=[],typeof z=="string"&&(Xt=!1),Xt){if(z.nodeName){const Fe=ue(z.nodeName);if(!ie[Fe]||Yt[Fe])throw ai("root node is forbidden and cannot be sanitized in-place")}}else if(z instanceof n)_=or("<!---->"),T=_.ownerDocument.importNode(z,!0),T.nodeType===si.element&&T.nodeName==="BODY"||T.nodeName==="HTML"?_=T:_.appendChild(T);else{if(!_t&&!wt&&!lt&&z.indexOf("<")===-1)return R&&Ei?R.createHTML(z):z;if(_=or(z),!_)return _t?null:Ei?J:""}_&&vo&&Re(_.firstChild);const fe=ar(Xt?z:_);for(;Q=fe.nextNode();)lr(Q)||(Q.content instanceof r&&_l(Q.content),cr(Q));if(Xt)return z;if(_t){if(Ti)for(me=j.call(_.ownerDocument);_.firstChild;)me.appendChild(_.firstChild);else me=_;return(pe.shadowroot||pe.shadowrootmode)&&(me=Wt.call(i,me,!0)),me}let Se=lt?_.outerHTML:_.innerHTML;return lt&&ie["!doctype"]&&_.ownerDocument&&_.ownerDocument.doctype&&_.ownerDocument.doctype.name&&be(Zs,_.ownerDocument.doctype.name)&&(Se="<!DOCTYPE "+_.ownerDocument.doctype.name+`>
`+Se),wt&&Di([at,rt,st],Fe=>{Se=oi(Se,Fe," ")}),R&&Ei?R.createHTML(Se):Se},e.setConfig=function(){let z=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};wo(z),fo=!0},e.clearConfig=function(){Ct=null,fo=!1},e.isValidAttribute=function(z,u,_){Ct||wo({});const T=ue(z),Q=ue(u);return nr(T,Q,_)},e.addHook=function(z,u){typeof u=="function"&&(xe[z]=xe[z]||[],ii(xe[z],u))},e.removeHook=function(z){if(xe[z])return Fr(xe[z])},e.removeHooks=function(z){xe[z]&&(xe[z]=[])},e.removeAllHooks=function(){xe={}},e}var Ii=Js();let qi=class extends ce{constructor(){super(...arguments),this.collectionLinks=[]}render(){return c`
    ...
    `:b}get volumeTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.volume,M("Volume"))}get issueTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.issue,M("Issue"))}get creatorTemplate(){var e,t,i;return((e=this.model)===null||e===void 0?void 0:e.mediatype)==="account"?c`
      ...
      <div id="creator" class="metadata">
        ...
        ${Bi(Mt(this.model.creators,o=>this.searchLink("creator",o)),", ")}
      </div>
    `}get datePublishedTemplate(){var e;const t=(e=this.model)===null||e===void 0?void 0:e.datePublished;let i="long";return Ba(t)&&(i="year-only"),this.metadataTemplate(Dt(t,i),M("Published"))}get dateSortByTemplate(){return this.effectiveSort&&(this.effectiveSort.field==="addeddate"||this.effectiveSort.field==="reviewdate"||this.effectiveSort.field==="publicdate")?this.metadataTemplate(Dt(this.date,"long"),this.displayValueProvider.dateLabel):b}get viewsTemplate(){var e,t,i,o;const r=((e=this.effectiveSort)===null||e===void 0?void 0:e.field)==="week"?(t=this.model)===null||t===void 0?void 0:t.weeklyViewCount:(i=this.model)===null||i===void 0?void 0:i.viewCount;return r==null?b:((o=this.model)===null||o===void 0?void 0:o.mediatype)==="search"?this.metadataTemplate("(Favorited search query)",""):this.metadataTemplate(`${ci(r,this.formatSize)}`,M("Views"))}get ratingTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.averageRating,M("Avg Rating"))}get reviewsTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.commentCount,M("Reviews"))}get topicsTemplate(){var e;return!(!((e=this.model)===null||e===void 0)&&e.subjects)||this.model.subjects.length===0?b:c`
      <div id="topics" class="metadata">
        ${this.labelTemplate(M("Topics"))}
        ${Bi(Mt(this.model.subjects,t=>this.searchLink("subject",t)),", ")}
      </div>
    `}get collectionsTemplate(){return!this.collectionLinks||this.collectionLinks.length===0?b:c`
      <div id="collections" class="metadata">
        ...
        ${Bi(this.collectionLinks,", ")}
      </div>
    `}get descriptionTemplate(){var e,t,i;return this.metadataTemplate(ed(Ii.sanitize((i=(t=(e=this.model)===null||e===void 0?void 0:e.description)===null||t===void 0?void 0:t.replace(/\n/g," "))!==null&&i!==void 0?i:"")),"","description")}get reviewBlockTemplate(){var e;if(!(!((e=this.model)===null||e===void 0)&&e.review))return b;const{title:t,body:i,stars:o}=this.model.review;return c`
      <review-block
        viewsize="list"
        .title=${t}
        .body=${i}
    ...
    `}};l([h({type:Object})],qi.prototype,"collectionTitles",void 0);l([P()],qi.prototype,"collectionLinks",void 0);qi=l([L("tile-list")],qi);let He=class extends F{constructor(){super(...arguments),this.loggedIn=!1}render(){return c`
      <div id="container">
        ${this.headerTemplate}
    ...
    `}get headerTemplate(){var e,t,i,o;if(((e=this.model)===null||e===void 0?void 0:e.collections.length)===0)return b;let r="",s="";for(const n of((t=this.model)===null||t===void 0?void 0:t.collections)||[])if(!ao[n]&&!n.startsWith("fav-")){r=(o=(i=this.collectionTitles)===null||i===void 0?void 0:i.get(n))!==null&&o!==void 0?o:n,s=n;break}return s?c`
    ...
    `}};l([h({type:Object})],He.prototype,"model",void 0);l([h({type:String})],He.prototype,"baseNavigationUrl",void 0);l([h({type:String})],He.prototype,"baseImageUrl",void 0);l([h({type:Boolean})],He.prototype,"loggedIn",void 0);l([h({type:Object})],He.prototype,"sortParam",void 0);l([h({type:Number})],He.prototype,"mobileBreakpoint",void 0);l([h({type:Number})],He.prototype,"currentWidth",void 0);l([h({type:Object})],He.prototype,"collectionTitles",void 0);He=l([L("tile-hover-pane")],He);let Vr=class extends ce{render(){var e,t,i,o,r,s;return c`
      <div id="list-line" class="${this.classSize}">
        <image-block
          .model=${this.model}
          .baseImageUrl=${this.baseImageUrl}
        ...
        <div id="date">${Dt(this.date,this.dateFormatSize)}</div>
        <div id="icon">
          <mediatype-icon
    ...
    `}};Vr=l([L("tile-list-compact")],Vr);let Wr=class extends ce{render(){return c`
    ...
    `}firstUpdated(){this.shouldPrepareHoverPane&&(this.hoverPaneController=new wd(this,{mobileBreakpoint:this.mobileBreakpoint,enableLongPress:!1}))}get headerTemplate(){const{currentWidth:e,sortParam:t,defaultSortParam:i,mobileBreakpoint:o}=this;return c`
    ...
    `}};Le.HOVER_PANE_DISPLAY_MODES={grid:!0,"list-compact":!0,"list-detail":!1,"list-header":!1};l([h({type:String})],Le.prototype,"tileDisplayMode",void 0);l([h({type:Boolean})],Le.prototype,"isManageView",void 0);l([h({type:Object})],Le.prototype,"resizeObserver",void 0);l([h({type:Object})],Le.prototype,"collectionTitles",void 0);l([h({type:Boolean})],Le.prototype,"enableHoverPane",void 0);l([h({type:String})],Le.prototype,"manageCheckTitle",void 0);l([Z("#container")],Le.prototype,"container",void 0);l([Z("tile-hover-pane")],Le.prototype,"hoverPane",void 0);Le=ma=l([L("tile-dispatcher")],Le);let Qr=class extends F{render(){return c` <div id="container"></div> `}static get styles(){return v`
      :host {
        display: block;
        height: 100%;
      }
    ...
    `}};Qr=l([L("collection-browser-loading-tile")],Qr);/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ui=window,Oa=Ui.ShadowRoot&&(Ui.ShadyCSS===void 0||Ui.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,el=Symbol(),Gr=new WeakMap;class _d{constructor(e,t,i){if(this._$cssResult$=!0,i!==el)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o;const t=this.t;if(Oa&&e===void 0){const i=t!==void 0&&t.length===1;i&&(e=Gr.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),i&&Gr.set(t,e))}return e}toString(){return this.cssText}}const xd=a=>new _d(typeof a=="string"?a:a+"",void 0,el),Sd=(a,e)=>{Oa?a.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet):e.forEach(t=>{const i=document.createElement("style"),o=Ui.litNonce;o!==void 0&&i.setAttribute("nonce",o),i.textContent=t.cssText,a.appendChild(i)})},Kr=Oa?a=>a:a=>a instanceof CSSStyleSheet?(e=>{let t="";for(const i of e.cssRules)t+=i.cssText;return xd(t)})(a):a;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Ro;const Yi=window,qr=Yi.trustedTypes,$d=qr?qr.emptyScript:"",Yr=Yi.reactiveElementPolyfillSupport,ga={toAttribute(a,e){switch(e){case Boolean:a=a?$d:null;break;case Object:case Array:a=a==null?a:JSON.stringify(a)}return a},fromAttribute(a,e){let t=a;switch(e){case Boolean:t=a!==null;break;case Number:t=a===null?null:Number(a);break;case Object:case Array:try{t=JSON.parse(a)}catch{t=null}}return t}},tl=(a,e)=>e!==a&&(e==e||a==a),Fo={attribute:!0,type:String,converter:ga,reflect:!1,hasChanged:tl},ba="finalized";class li extends HTMLElement{constructor(){super(),this._$Ei=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$El=null,this._$Eu()}static addInitializer(e){var t;this.finalize(),((t=this.h)!==null&&t!==void 0?t:this.h=[]).push(e)}static get observedAttributes(){this.finalize();const e=[];return this.elementProperties.forEach((t,i)=>{const o=this._$Ep(i,t);o!==void 0&&(this._$Ev.set(o,i),e.push(o))}),e}static createProperty(e,t=Fo){if(t.state&&(t.attribute=!1),this.finalize(),this.elementProperties.set(e,t),!t.noAccessor&&!this.prototype.hasOwnProperty(e)){const i=typeof e=="symbol"?Symbol():"__"+e,o=this.getPropertyDescriptor(e,i,t);o!==void 0&&Object.defineProperty(this.prototype,e,o)}}static getPropertyDescriptor(e,t,i){return{get(){return this[t]},set(o){const r=this[e];this[t]=o,this.requestUpdate(e,r,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)||Fo}static finalize(){if(this.hasOwnProperty(ba))return!1;this[ba]=!0;const e=Object.getPrototypeOf(this);if(e.finalize(),e.h!==void 0&&(this.h=[...e.h]),this.elementProperties=new Map(e.elementProperties),this._$Ev=new Map,this.hasOwnProperty("properties")){const t=this.properties,i=[...Object.getOwnPropertyNames(t),...Object.getOwnPropertySymbols(t)];for(const o of i)this.createProperty(o,t[o])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const i=new Set(e.flat(1/0).reverse());for(const o of i)t.unshift(Kr(o))}else e!==void 0&&t.push(Kr(e));return t}static _$Ep(e,t){const i=t.attribute;return i===!1?void 0:typeof i=="string"?i:typeof e=="string"?e.toLowerCase():void 0}_$Eu(){var e;this._$E_=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$Eg(),this.requestUpdate(),(e=this.constructor.h)===null||e===void 0||e.forEach(t=>t(this))}addController(e){var t,i;((t=this._$ES)!==null&&t!==void 0?t:this._$ES=[]).push(e),this.renderRoot!==void 0&&this.isConnected&&((i=e.hostConnected)===null||i===void 0||i.call(e))}removeController(e){var t;(t=this._$ES)===null||t===void 0||t.splice(this._$ES.indexOf(e)>>>0,1)}_$Eg(){this.constructor.elementProperties.forEach((e,t)=>{this.hasOwnProperty(t)&&(this._$Ei.set(t,this[t]),delete this[t])})}createRenderRoot(){var e;const t=(e=this.shadowRoot)!==null&&e!==void 0?e:this.attachShadow(this.constructor.shadowRootOptions);return Sd(t,this.constructor.elementStyles),t}connectedCallback(){var e;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$ES)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostConnected)===null||i===void 0?void 0:i.call(t)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$ES)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostDisconnected)===null||i===void 0?void 0:i.call(t)})}attributeChangedCallback(e,t,i){this._$AK(e,i)}_$EO(e,t,i=Fo){var o;const r=this.constructor._$Ep(e,i);if(r!==void 0&&i.reflect===!0){const s=(((o=i.converter)===null||o===void 0?void 0:o.toAttribute)!==void 0?i.converter:ga).toAttribute(t,i.type);this._$El=e,s==null?this.removeAttribute(r):this.setAttribute(r,s),this._$El=null}}_$AK(e,t){var i;const o=this.constructor,r=o._$Ev.get(e);if(r!==void 0&&this._$El!==r){const s=o.getPropertyOptions(r),n=typeof s.converter=="function"?{fromAttribute:s.converter}:((i=s.converter)===null||i===void 0?void 0:i.fromAttribute)!==void 0?s.converter:ga;this._$El=r,this[r]=n.fromAttribute(t,s.type),this._$El=null}}requestUpdate(e,t,i){let o=!0;e!==void 0&&(((i=i||this.constructor.getPropertyOptions(e)).hasChanged||tl)(this[e],t)?(this._$AL.has(e)||this._$AL.set(e,t),i.reflect===!0&&this._$El!==e&&(this._$EC===void 0&&(this._$EC=new Map),this._$EC.set(e,i))):o=!1),!this.isUpdatePending&&o&&(this._$E_=this._$Ej())}async _$Ej(){this.isUpdatePending=!0;try{await this._$E_}catch(t){Promise.reject(t)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var e;if(!this.isUpdatePending)return;this.hasUpdated,this._$Ei&&(this._$Ei.forEach((o,r)=>this[r]=o),this._$Ei=void 0);let t=!1;const i=this._$AL;try{t=this.shouldUpdate(i),t?(this.willUpdate(i),(e=this._$ES)===null||e===void 0||e.forEach(o=>{var r;return(r=o.hostUpdate)===null||r===void 0?void 0:r.call(o)}),this.update(i)):this._$Ek()}catch(o){throw t=!1,this._$Ek(),o}t&&this._$AE(i)}willUpdate(e){}_$AE(e){var t;(t=this._$ES)===null||t===void 0||t.forEach(i=>{var o;return(o=i.hostUpdated)===null||o===void 0?void 0:o.call(i)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$Ek(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$E_}shouldUpdate(e){return!0}update(e){this._$EC!==void 0&&(this._$EC.forEach((t,i)=>this._$EO(i,this[i],t)),this._$EC=void 0),this._$Ek()}updated(e){}firstUpdated(e){}}li[ba]=!0,li.elementProperties=new Map,li.elementStyles=[],li.shadowRootOptions={mode:"open"},Yr==null||Yr({ReactiveElement:li}),((Ro=Yi.reactiveElementVersions)!==null&&Ro!==void 0?Ro:Yi.reactiveElementVersions=[]).push("1.6.3");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Bo;const Xi=window,Ft=Xi.trustedTypes,Xr=Ft?Ft.createPolicy("lit-html",{createHTML:a=>a}):void 0,ya="$lit$",et=`lit$${(Math.random()+"").slice(9)}$`,il="?"+et,Cd=`<${il}>`,gt=document,mi=()=>gt.createComment(""),gi=a=>a===null||typeof a!="object"&&typeof a!="function",ol=Array.isArray,kd=a=>ol(a)||typeof(a==null?void 0:a[Symbol.iterator])=="function",Oo=`[ 	
\f\r]`,ni=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Zr=/-->/g,Jr=/>/g,ct=RegExp(`>|${Oo}(?:([^\\s"'>=/]+)(${Oo}*=${Oo}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),es=/'/g,ts=/"/g,al=/^(?:script|style|textarea|title)$/i,rl=a=>(e,...t)=>({_$litType$:a,strings:e,values:t}),Me=rl(1),sl=rl(2),Bt=Symbol.for("lit-noChange"),oe=Symbol.for("lit-nothing"),is=new WeakMap,ft=gt.createTreeWalker(gt,129,null,!1);function ll(a,e){if(!Array.isArray(a)||!a.hasOwnProperty("raw"))throw Error("invalid template strings array");return Xr!==void 0?Xr.createHTML(e):e}const Td=(a,e)=>{const t=a.length-1,i=[];let o,r=e===2?"<svg>":"",s=ni;for(let n=0;n<t;n++){const d=a[n];let p,f,m=-1,y=0;for(;y<d.length&&(s.lastIndex=y,f=s.exec(d),f!==null);)y=s.lastIndex,s===ni?f[1]==="!--"?s=Zr:f[1]!==void 0?s=Jr:f[2]!==void 0?(al.test(f[2])&&(o=RegExp("</"+f[2],"g")),s=ct):f[3]!==void 0&&(s=ct):s===ct?f[0]===">"?(s=o!=null?o:ni,m=-1):f[1]===void 0?m=-2:(m=s.lastIndex-f[2].length,p=f[1],s=f[3]===void 0?ct:f[3]==='"'?ts:es):s===ts||s===es?s=ct:s===Zr||s===Jr?s=ni:(s=ct,o=void 0);const w=s===ct&&a[n+1].startsWith("/>")?" ":"";r+=s===ni?d+Cd:m>=0?(i.push(p),d.slice(0,m)+ya+d.slice(m)+et+w):d+et+(m===-2?(i.push(void 0),n):w)}return[ll(a,r+(a[t]||"<?>")+(e===2?"</svg>":"")),i]};class bi{constructor({strings:e,_$litType$:t},i){let o;this.parts=[];let r=0,s=0;const n=e.length-1,d=this.parts,[p,f]=Td(e,t);if(this.el=bi.createElement(p,i),ft.currentNode=this.el.content,t===2){const m=this.el.content,y=m.firstChild;y.remove(),m.append(...y.childNodes)}for(;(o=ft.nextNode())!==null&&d.length<n;){if(o.nodeType===1){if(o.hasAttributes()){const m=[];for(const y of o.getAttributeNames())if(y.endsWith(ya)||y.startsWith(et)){const w=f[s++];if(m.push(y),w!==void 0){const x=o.getAttribute(w.toLowerCase()+ya).split(et),C=/([.?@])?(.*)/.exec(w);d.push({type:1,index:r,name:C[2],strings:x,ctor:C[1]==="."?Md:C[1]==="?"?Pd:C[1]==="@"?Ad:so})}else d.push({type:6,index:r})}for(const y of m)o.removeAttribute(y)}if(al.test(o.tagName)){const m=o.textContent.split(et),y=m.length-1;if(y>0){o.textContent=Ft?Ft.emptyScript:"";for(let w=0;w<y;w++)o.append(m[w],mi()),ft.nextNode(),d.push({type:2,index:++r});o.append(m[y],mi())}}}else if(o.nodeType===8)if(o.data===il)d.push({type:2,index:r});else{let m=-1;for(;(m=o.data.indexOf(et,m+1))!==-1;)d.push({type:7,index:r}),m+=et.length-1}r++}}static createElement(e,t){const i=gt.createElement("template");return i.innerHTML=e,i}}function Ot(a,e,t=a,i){var o,r,s,n;if(e===Bt)return e;let d=i!==void 0?(o=t._$Co)===null||o===void 0?void 0:o[i]:t._$Cl;const p=gi(e)?void 0:e._$litDirective$;return(d==null?void 0:d.constructor)!==p&&((r=d==null?void 0:d._$AO)===null||r===void 0||r.call(d,!1),p===void 0?d=void 0:(d=new p(a),d._$AT(a,t,i)),i!==void 0?((s=(n=t)._$Co)!==null&&s!==void 0?s:n._$Co=[])[i]=d:t._$Cl=d),d!==void 0&&(e=Ot(a,d._$AS(a,e.values),d,i)),e}class Ed{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){var t;const{el:{content:i},parts:o}=this._$AD,r=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:gt).importNode(i,!0);ft.currentNode=r;let s=ft.nextNode(),n=0,d=0,p=o[0];for(;p!==void 0;){if(n===p.index){let f;p.type===2?f=new ki(s,s.nextSibling,this,e):p.type===1?f=new p.ctor(s,p.name,p.strings,this,e):p.type===6&&(f=new Ld(s,this,e)),this._$AV.push(f),p=o[++d]}n!==(p==null?void 0:p.index)&&(s=ft.nextNode(),n++)}return ft.currentNode=gt,r}v(e){let t=0;for(const i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class ki{constructor(e,t,i,o){var r;this.type=2,this._$AH=oe,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=o,this._$Cp=(r=o==null?void 0:o.isConnected)===null||r===void 0||r}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cp}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Ot(this,e,t),gi(e)?e===oe||e==null||e===""?(this._$AH!==oe&&this._$AR(),this._$AH=oe):e!==this._$AH&&e!==Bt&&this._(e):e._$litType$!==void 0?this.g(e):e.nodeType!==void 0?this.$(e):kd(e)?this.T(e):this._(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==oe&&gi(this._$AH)?this._$AA.nextSibling.data=e:this.$(gt.createTextNode(e)),this._$AH=e}g(e){var t;const{values:i,_$litType$:o}=e,r=typeof o=="number"?this._$AC(e):(o.el===void 0&&(o.el=bi.createElement(ll(o.h,o.h[0]),this.options)),o);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===r)this._$AH.v(i);else{const s=new Ed(r,this),n=s.u(this.options);s.v(i),this.$(n),this._$AH=s}}_$AC(e){let t=is.get(e.strings);return t===void 0&&is.set(e.strings,t=new bi(e)),t}T(e){ol(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,o=0;for(const r of e)o===t.length?t.push(i=new ki(this.k(mi()),this.k(mi()),this,this.options)):i=t[o],i._$AI(r),o++;o<t.length&&(this._$AR(i&&i._$AB.nextSibling,o),t.length=o)}_$AR(e=this._$AA.nextSibling,t){var i;for((i=this._$AP)===null||i===void 0||i.call(this,!1,!0,t);e&&e!==this._$AB;){const o=e.nextSibling;e.remove(),e=o}}setConnected(e){var t;this._$AM===void 0&&(this._$Cp=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}}class so{constructor(e,t,i,o,r){this.type=1,this._$AH=oe,this._$AN=void 0,this.element=e,this.name=t,this._$AM=o,this.options=r,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=oe}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,i,o){const r=this.strings;let s=!1;if(r===void 0)e=Ot(this,e,t,0),s=!gi(e)||e!==this._$AH&&e!==Bt,s&&(this._$AH=e);else{const n=e;let d,p;for(e=r[0],d=0;d<r.length-1;d++)p=Ot(this,n[i+d],t,d),p===Bt&&(p=this._$AH[d]),s||(s=!gi(p)||p!==this._$AH[d]),p===oe?e=oe:e!==oe&&(e+=(p!=null?p:"")+r[d+1]),this._$AH[d]=p}s&&!o&&this.j(e)}j(e){e===oe?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e!=null?e:"")}}class Md extends so{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===oe?void 0:e}}const zd=Ft?Ft.emptyScript:"";class Pd extends so{constructor(){super(...arguments),this.type=4}j(e){e&&e!==oe?this.element.setAttribute(this.name,zd):this.element.removeAttribute(this.name)}}class Ad extends so{constructor(e,t,i,o,r){super(e,t,i,o,r),this.type=5}_$AI(e,t=this){var i;if((e=(i=Ot(this,e,t,0))!==null&&i!==void 0?i:oe)===Bt)return;const o=this._$AH,r=e===oe&&o!==oe||e.capture!==o.capture||e.once!==o.once||e.passive!==o.passive,s=e!==oe&&(o===oe||r);r&&this.element.removeEventListener(this.name,this,o),s&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,i;typeof this._$AH=="function"?this._$AH.call((i=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&i!==void 0?i:this.element,e):this._$AH.handleEvent(e)}}class Ld{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){Ot(this,e)}}const os=Xi.litHtmlPolyfillSupport;os==null||os(bi,ki),((Bo=Xi.litHtmlVersions)!==null&&Bo!==void 0?Bo:Xi.litHtmlVersions=[]).push("2.8.0");const Dd=(a,e,t)=>{var i,o;const r=(i=t==null?void 0:t.renderBefore)!==null&&i!==void 0?i:e;let s=r._$litPart$;if(s===void 0){const n=(o=t==null?void 0:t.renderBefore)!==null&&o!==void 0?o:null;r._$litPart$=s=new ki(e.insertBefore(mi(),n),n,void 0,t!=null?t:{})}return s._$AI(a),s};/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ia=window.ShadowRoot&&(window.ShadyCSS===void 0||window.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Ua=Symbol(),as=new Map;class nl{constructor(e,t){if(this._$cssResult$=!0,t!==Ua)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e}get styleSheet(){let e=as.get(this.cssText);return Ia&&e===void 0&&(as.set(this.cssText,e=new CSSStyleSheet),e.replaceSync(this.cssText)),e}toString(){return this.cssText}}const Rd=a=>new nl(typeof a=="string"?a:a+"",Ua),Ge=(a,...e)=>{const t=a.length===1?a[0]:e.reduce((i,o,r)=>i+(s=>{if(s._$cssResult$===!0)return s.cssText;if(typeof s=="number")return s;throw Error("Value passed to 'css' function must be a 'css' function result: "+s+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(o)+a[r+1],a[0]);return new nl(t,Ua)},Fd=(a,e)=>{Ia?a.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet):e.forEach(t=>{const i=document.createElement("style"),o=window.litNonce;o!==void 0&&i.setAttribute("nonce",o),i.textContent=t.cssText,a.appendChild(i)})},rs=Ia?a=>a:a=>a instanceof CSSStyleSheet?(e=>{let t="";for(const i of e.cssRules)t+=i.cssText;return Rd(t)})(a):a;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Io;const ss=window.trustedTypes,Bd=ss?ss.emptyScript:"",ls=window.reactiveElementPolyfillSupport,wa={toAttribute(a,e){switch(e){case Boolean:a=a?Bd:null;break;case Object:case Array:a=a==null?a:JSON.stringify(a)}return a},fromAttribute(a,e){let t=a;switch(e){case Boolean:t=a!==null;break;case Number:t=a===null?null:Number(a);break;case Object:case Array:try{t=JSON.parse(a)}catch{t=null}}return t}},dl=(a,e)=>e!==a&&(e==e||a==a),Uo={attribute:!0,type:String,converter:wa,reflect:!1,hasChanged:dl};class Tt extends HTMLElement{constructor(){super(),this._$Et=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Ei=null,this.o()}static addInitializer(e){var t;(t=this.l)!==null&&t!==void 0||(this.l=[]),this.l.push(e)}static get observedAttributes(){this.finalize();const e=[];return this.elementProperties.forEach((t,i)=>{const o=this._$Eh(i,t);o!==void 0&&(this._$Eu.set(o,i),e.push(o))}),e}static createProperty(e,t=Uo){if(t.state&&(t.attribute=!1),this.finalize(),this.elementProperties.set(e,t),!t.noAccessor&&!this.prototype.hasOwnProperty(e)){const i=typeof e=="symbol"?Symbol():"__"+e,o=this.getPropertyDescriptor(e,i,t);o!==void 0&&Object.defineProperty(this.prototype,e,o)}}static getPropertyDescriptor(e,t,i){return{get(){return this[t]},set(o){const r=this[e];this[t]=o,this.requestUpdate(e,r,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)||Uo}static finalize(){if(this.hasOwnProperty("finalized"))return!1;this.finalized=!0;const e=Object.getPrototypeOf(this);if(e.finalize(),this.elementProperties=new Map(e.elementProperties),this._$Eu=new Map,this.hasOwnProperty("properties")){const t=this.properties,i=[...Object.getOwnPropertyNames(t),...Object.getOwnPropertySymbols(t)];for(const o of i)this.createProperty(o,t[o])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const i=new Set(e.flat(1/0).reverse());for(const o of i)t.unshift(rs(o))}else e!==void 0&&t.push(rs(e));return t}static _$Eh(e,t){const i=t.attribute;return i===!1?void 0:typeof i=="string"?i:typeof e=="string"?e.toLowerCase():void 0}o(){var e;this._$Ep=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$Em(),this.requestUpdate(),(e=this.constructor.l)===null||e===void 0||e.forEach(t=>t(this))}addController(e){var t,i;((t=this._$Eg)!==null&&t!==void 0?t:this._$Eg=[]).push(e),this.renderRoot!==void 0&&this.isConnected&&((i=e.hostConnected)===null||i===void 0||i.call(e))}removeController(e){var t;(t=this._$Eg)===null||t===void 0||t.splice(this._$Eg.indexOf(e)>>>0,1)}_$Em(){this.constructor.elementProperties.forEach((e,t)=>{this.hasOwnProperty(t)&&(this._$Et.set(t,this[t]),delete this[t])})}createRenderRoot(){var e;const t=(e=this.shadowRoot)!==null&&e!==void 0?e:this.attachShadow(this.constructor.shadowRootOptions);return Fd(t,this.constructor.elementStyles),t}connectedCallback(){var e;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$Eg)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostConnected)===null||i===void 0?void 0:i.call(t)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$Eg)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostDisconnected)===null||i===void 0?void 0:i.call(t)})}attributeChangedCallback(e,t,i){this._$AK(e,i)}_$ES(e,t,i=Uo){var o,r;const s=this.constructor._$Eh(e,i);if(s!==void 0&&i.reflect===!0){const n=((r=(o=i.converter)===null||o===void 0?void 0:o.toAttribute)!==null&&r!==void 0?r:wa.toAttribute)(t,i.type);this._$Ei=e,n==null?this.removeAttribute(s):this.setAttribute(s,n),this._$Ei=null}}_$AK(e,t){var i,o,r;const s=this.constructor,n=s._$Eu.get(e);if(n!==void 0&&this._$Ei!==n){const d=s.getPropertyOptions(n),p=d.converter,f=(r=(o=(i=p)===null||i===void 0?void 0:i.fromAttribute)!==null&&o!==void 0?o:typeof p=="function"?p:null)!==null&&r!==void 0?r:wa.fromAttribute;this._$Ei=n,this[n]=f(t,d.type),this._$Ei=null}}requestUpdate(e,t,i){let o=!0;e!==void 0&&(((i=i||this.constructor.getPropertyOptions(e)).hasChanged||dl)(this[e],t)?(this._$AL.has(e)||this._$AL.set(e,t),i.reflect===!0&&this._$Ei!==e&&(this._$EC===void 0&&(this._$EC=new Map),this._$EC.set(e,i))):o=!1),!this.isUpdatePending&&o&&(this._$Ep=this._$E_())}async _$E_(){this.isUpdatePending=!0;try{await this._$Ep}catch(t){Promise.reject(t)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var e;if(!this.isUpdatePending)return;this.hasUpdated,this._$Et&&(this._$Et.forEach((o,r)=>this[r]=o),this._$Et=void 0);let t=!1;const i=this._$AL;try{t=this.shouldUpdate(i),t?(this.willUpdate(i),(e=this._$Eg)===null||e===void 0||e.forEach(o=>{var r;return(r=o.hostUpdate)===null||r===void 0?void 0:r.call(o)}),this.update(i)):this._$EU()}catch(o){throw t=!1,this._$EU(),o}t&&this._$AE(i)}willUpdate(e){}_$AE(e){var t;(t=this._$Eg)===null||t===void 0||t.forEach(i=>{var o;return(o=i.hostUpdated)===null||o===void 0?void 0:o.call(i)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EU(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$Ep}shouldUpdate(e){return!0}update(e){this._$EC!==void 0&&(this._$EC.forEach((t,i)=>this._$ES(i,this[i],t)),this._$EC=void 0),this._$EU()}updated(e){}firstUpdated(e){}}Tt.finalized=!0,Tt.elementProperties=new Map,Tt.elementStyles=[],Tt.shadowRootOptions={mode:"open"},ls==null||ls({ReactiveElement:Tt}),((Io=globalThis.reactiveElementVersions)!==null&&Io!==void 0?Io:globalThis.reactiveElementVersions=[]).push("1.3.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var No,Ho;class zt extends Tt{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e,t;const i=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=i.firstChild),i}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Dd(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!1)}render(){return Bt}}zt.finalized=!0,zt._$litElement$=!0,(No=globalThis.litElementHydrateSupport)===null||No===void 0||No.call(globalThis,{LitElement:zt});const ns=globalThis.litElementPolyfillSupport;ns==null||ns({LitElement:zt});((Ho=globalThis.litElementVersions)!==null&&Ho!==void 0?Ho:globalThis.litElementVersions=[]).push("3.3.3");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const cl=a=>e=>typeof e=="function"?((t,i)=>(customElements.define(t,i),i))(a,e):((t,i)=>{const{kind:o,elements:r}=i;return{kind:o,elements:r,finisher(s){customElements.define(t,s)}}})(a,e);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Od=(a,e)=>e.kind==="method"&&e.descriptor&&!("value"in e.descriptor)?le(G({},e),{finisher(t){t.createProperty(e.key,a)}}):{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){typeof e.initializer=="function"&&(this[e.key]=e.initializer.call(this))},finisher(t){t.createProperty(e.key,a)}},Id=(a,e,t)=>{e.constructor.createProperty(t,a)};function _e(a){return(e,t)=>t!==void 0?Id(a,e,t):Od(a,e)}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Vo;((Vo=window.HTMLSlotElement)===null||Vo===void 0?void 0:Vo.prototype.assignedElements)!=null;/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ds=a=>a!=null?a:oe;var Ud=sl`<svg class="caret-up-svg" viewBox="0 0 8 4" xmlns="http://www.w3.org/2000/svg">
<path d="m6.7226499 3.51689722c.22976435.15317623.54019902.0910893.69337525-.13867505.13615665-.20423497.10222882-.47220946-.06836249-.63681849l-.07031256-.05655675-3.2773501-2.18490007-3.2773501 2.18490007c-.22976434.15317623-.29185128.4636109-.13867505.69337524.13615665.20423498.39656688.27598409.61412572.18182636l.07924953-.04315131 2.7226499-1.81402514z"
  fill=""></path>
</svg>`,Nd=sl`<svg class="caret-down-svg" viewBox="0 0 8 4" xmlns="http://www.w3.org/2000/svg">
...
fill=""></path>
      ...
      >
        <span ?hidden=${!this.open} class="caret-up">
          <slot name="caret-up">${Ud}</slot>
        </span>
        <span ?hidden=${this.open} class="caret-down">
          <slot name="caret-down">${Nd}</slot>
        </span>
      </span>
    ...
    `}static get styles(){const e=Ge`var(--dropdownBorderWidth, 1px)`,t=Ge`var(--dropdownBorderRadius, 4px)`,i=Ge`var(--dropdownBorderColor, #fff)`,o=Ge`var(--dropdownBgColor, #333)`,r=Ge`var(--dropdownTextColor, #fff)`,s=Ge`var(--dropdownHoverBgColor, rgba(255, 255, 255, 0.3))`,n=Ge`var(--dropdownSelectedBgColor, #fff)`;return Ge`
      :host {
        display: inline;
        color: ${r};
      }
    ...
    `}};l([_e({type:Boolean,reflect:!0})],ve.prototype,"open",void 0);l([_e({type:Boolean,reflect:!0})],ve.prototype,"isDisabled",void 0);l([_e({type:Boolean})],ve.prototype,"displayCaret",void 0);l([_e({type:Boolean})],ve.prototype,"closeOnSelect",void 0);l([_e({type:Boolean})],ve.prototype,"openViaButton",void 0);l([_e({type:Boolean})],ve.prototype,"openViaCaret",void 0);l([_e({type:Boolean})],ve.prototype,"includeSelectedOption",void 0);l([_e({type:String})],ve.prototype,"selectedOption",void 0);l([_e({attribute:!1})],ve.prototype,"options",void 0);l([_e({type:String})],ve.prototype,"optionGroup",void 0);l([_e({attribute:!1})],ve.prototype,"optionSelected",void 0);l([_e({type:Boolean,reflect:!0})],ve.prototype,"isCustomList",void 0);l([_e({type:Boolean,reflect:!0})],ve.prototype,"hasCustomClickHandler",void 0);l([_e({type:Boolean,reflect:!0})],ve.prototype,"closeOnEscape",void 0);l([_e({type:Boolean,reflect:!0})],ve.prototype,"closeOnBackdropClick",void 0);ve=l([cl("ia-dropdown")],ve);let _a=class extends zt{render(){return Me`
  ...
  `;_a=l([cl("ia-icon-label")],_a);let xa=class extends F{constructor(){super(...arguments),this.numResults=0}render(){return c`
    ...
    `}};l([h({type:Number})],xa.prototype,"numResults",void 0);xa=l([L("alpha-bar-tooltip")],xa);let Xe=class extends F{constructor(){super(...arguments),this.selectedLetter=null,this.tooltipShown=!1,this.alphabet="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("")}get selectedUppercaseLetter(){var e;return(e=this.selectedLetter)===null||e===void 0?void 0:e.toUpperCase()}render(){var e;return c`
  ...
  `;l([h({type:String})],Xe.prototype,"selectedLetter",void 0);l([h({type:Object})],Xe.prototype,"letterCounts",void 0);l([h({type:String})],Xe.prototype,"ariaLandmarkLabel",void 0);l([P()],Xe.prototype,"tooltipShown",void 0);l([P()],Xe.prototype,"hoveredLetter",void 0);l([Z("alpha-bar-tooltip")],Xe.prototype,"tooltip",void 0);Xe=l([L("alpha-bar")],Xe);const Hd=c`
...
`;let K=class extends F{constructor(){super(...arguments),this.defaultSortDirection=null,this.defaultSortField=S.relevance,this.sortDirection=null,this.selectedSort=S.default,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.showRelevance=!0,this.showDateFavorited=!1,this.enableSortOptionsSlot=!1,this.suppressDisplayModes=!1,this.lastSelectedViewSort=S.weeklyview,this.lastSelectedDateSort=this.defaultDateSortField,this.alphaSelectorVisible=null,this.dropdownBackdropVisible=!1,this.desktopSortContainerWidth=0,this.selectorBarContainerWidth=0,this.boundSortBarSelectorEscapeListener=e=>{e.key==="Escape"&&this.closeDropdowns()}}render(){return c`
    ...
    `}get sortDirectionIcon(){return this.canChangeSortDirection?c`
      <div class="sort-direction-icon">
        ${this.finalizedSortDirection==="asc"?Hd:Vd}
      </div>
    ...
    `}get mobileSortSelectorTemplate(){const e=Object.values(ye).filter(t=>t.shownInSortBar).filter(t=>this.showRelevance||t.field!==S.relevance).filter(t=>this.showDateFavorited||t.field!==S.datefavorited);return c`
      <div
        id="mobile-sort-container"
        class=${this.mobileSelectorVisible?"visible":"hidden"}
      >
        ${this.getSortDropdown({displayName:c`${ye[this.finalizedSortField].displayName}`,id:"mobile-dropdown",selected:!0,dropdownOptions:e.map(t=>this.getDropdownOption(t.field)),selectedOption:this.finalizedSortField,onOptionSelected:this.mobileSortChanged,onDropdownClick:()=>{this.dropdownBackdropVisible=this.mobileDropdown.open,this.mobileDropdown.classList.toggle("open",this.mobileDropdown.open)}})}
      </div>
    `}getSortDisplayOption(e,t){var i,o;const r=(i=t==null?void 0:t.selected)!==null&&i!==void 0?i:this.finalizedSortField===e,s=(o=t==null?void 0:t.displayName)!==null&&o!==void 0?o:ye[e].displayName;return c`
      <button
        class=${r?"selected":b}
        data-title="${s}"
    ...
    `}get dropdownBackdrop(){return c`
      ...
      ></div>
    `}closeDropdowns(){this.dropdownBackdropVisible=!1;const e=[this.viewsDropdown,this.dateDropdown,this.mobileDropdown];for(const t of e)t.open=!1,t.classList.remove("open")}selectDropdownSortField(e){this.dropdownBackdropVisible=!1,this.setSelectedSort(e)}clearAlphaBarFilters(){this.alphaSelectorVisible=null,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.emitTitleLetterChangedEvent(),this.emitCreatorLetterChangedEvent()}setSortDirection(e){this.sortDirection=e,this.emitSortChangedEvent()}toggleSortDirection(){this.setSortDirection(this.finalizedSortDirection==="desc"?"asc":"desc")}handleSortDirectionClicked(){!this.sortDirection&&this.defaultSortField&&this.defaultSortDirection&&(this.selectedSort=this.defaultSortField,this.sortDirection=this.defaultSortDirection),this.toggleSortDirection()}setSelectedSort(e){this.selectedSort=e;const t=ye[e];this.sortDirection=t.defaultSortDirection,this.emitSortChangedEvent()}get finalizedSortField(){return this.selectedSort===S.default?this.defaultSortField:this.selectedSort}get finalizedSortDirection(){return this.sortDirection===null?this.defaultSortDirection:this.sortDirection}get canChangeSortDirection(){return ye[this.finalizedSortField].canSetDirection}get dateOptionSelected(){return[S.datefavorited,S.datearchived,S.date,S.datereviewed,S.dateadded].includes(this.finalizedSortField)}get viewOptionSelected(){return[S.alltimeview,S.weeklyview].includes(this.finalizedSortField)}get defaultDateSortField(){return this.showDateFavorited?S.datefavorited:S.date}get dateSortDisplayName(){return ye[this.lastSelectedDateSort].displayName}get viewSortDisplayName(){return ye[this.lastSelectedViewSort].displayName}get titleSelectorBar(){var e;return c` <alpha-bar
    ...
    ></alpha-bar>`}titleLetterChanged(e){var t;this.selectedTitleFilter=(t=e.detail.selectedLetter)!==null&&t!==void 0?t:null,this.emitTitleLetterChangedEvent()}creatorLetterChanged(e){var t;this.selectedCreatorFilter=(t=e.detail.selectedLetter)!==null&&t!==void 0?t:null,this.emitCreatorLetterChangedEvent()}emitTitleLetterChangedEvent(){const e=new CustomEvent("titleLetterChanged",{detail:{selectedLetter:this.selectedTitleFilter}});this.dispatchEvent(e)}emitCreatorLetterChangedEvent(){const e=new CustomEvent("creatorLetterChanged",{detail:{selectedLetter:this.selectedCreatorFilter}});this.dispatchEvent(e)}displayModeChanged(){const e=new CustomEvent("displayModeChanged",{detail:{displayMode:this.displayMode}});this.dispatchEvent(e)}emitSortChangedEvent(){const e=new CustomEvent("sortChanged",{detail:{selectedSort:this.selectedSort,sortDirection:this.sortDirection}});this.dispatchEvent(e)}static get styles(){return[Ze,v`
      ...
      `]}};l([h({type:String})],K.prototype,"displayMode",void 0);l([h({type:String})],K.prototype,"defaultSortDirection",void 0);l([h({type:String})],K.prototype,"defaultSortField",void 0);l([h({type:String})],K.prototype,"sortDirection",void 0);l([h({type:String})],K.prototype,"selectedSort",void 0);l([h({type:String})],K.prototype,"selectedTitleFilter",void 0);l([h({type:String})],K.prototype,"selectedCreatorFilter",void 0);l([h({type:Boolean})],K.prototype,"showRelevance",void 0);l([h({type:Boolean})],K.prototype,"showDateFavorited",void 0);l([h({type:Boolean,reflect:!0})],K.prototype,"enableSortOptionsSlot",void 0);l([h({type:Boolean,reflect:!0})],K.prototype,"suppressDisplayModes",void 0);l([h({type:Object})],K.prototype,"prefixFilterCountMap",void 0);l([h({type:Object})],K.prototype,"resizeObserver",void 0);l([P()],K.prototype,"lastSelectedViewSort",void 0);l([P()],K.prototype,"lastSelectedDateSort",void 0);l([P()],K.prototype,"alphaSelectorVisible",void 0);l([P()],K.prototype,"dropdownBackdropVisible",void 0);l([P()],K.prototype,"desktopSortContainerWidth",void 0);l([P()],K.prototype,"selectorBarContainerWidth",void 0);l([Z("#desktop-sort-container")],K.prototype,"desktopSortContainer",void 0);l([Z("#sort-selector-container")],K.prototype,"sortSelectorContainer",void 0);l([Z("#views-dropdown")],K.prototype,"viewsDropdown",void 0);l([Z("#date-dropdown")],K.prototype,"dateDropdown",void 0);l([Z("#mobile-dropdown")],K.prototype,"mobileDropdown",void 0);K=l([L("sort-filter-bar")],K);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function cs(a,e,t){return a?e():t==null?void 0:t()}const hs=v`var(--white, #fff)`,Kd=v`var(--primaryDisableCTAFill, #767676)`,qd=v`var(--secondaryCTABorder, #999)`,Yd=v`var(--primaryCTAFill, #194880)`,Wo=v`var(--primaryCTAFillRGB, 25, 72, 128)`,Xd=v`var(--primaryCTABorder, #c5d1df)`,Zd=v`var(--primaryErrorCTAFill, #d9534f)`,jo=v`var(--primaryErrorCTAFillRGB, 229, 28, 38)`,Jd=v`var(--primaryErrorCTABorder, #d43f3a)`,ec=v`var(--secondaryCTAFill, #333)`,Qo=v`var(--secondaryCTAFillRGB, 51, 51, 51)`,tc=v`var(--primaryCTABorder, #979797)`,ic=v`#ee8950`,oc=v`#ec7939`;var ac=v`
  .ia-button {
    min-height: 3rem;
    cursor: pointer;
    color: ${hs};
...
`;let It=class extends F{constructor(){super(...arguments),this.label=M("Select items to remove"),this.showSelectAll=!1,this.showUnselectAll=!1,this.removeAllowed=!1}render(){return c`
      <div class="manage-container">
        ...
        <div class="manage-buttons">
          ...
          <div class="selection-buttons">
            ${cs(this.showSelectAll,()=>c` <button
                class="link-styled select-all-btn"
                @click=${this.selectAllClicked}
              >
                ${M("Select all")}
              </button>`)}
            ${cs(this.showUnselectAll,()=>c` <button
    ...
    `}cancelClicked(){this.dispatchEvent(new CustomEvent("cancel"))}removeClicked(){this.dispatchEvent(new CustomEvent("removeItems"))}selectAllClicked(){this.dispatchEvent(new CustomEvent("selectAll"))}unselectAllClicked(){this.dispatchEvent(new CustomEvent("unselectAll"))}static get styles(){return v`
      ${ac}
      .manage-container {
        display: flex;
        align-items: center;
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const hi=(a,e)=>{var t,i;const o=a._$AN;if(o===void 0)return!1;for(const r of o)(i=(t=r)._$AO)===null||i===void 0||i.call(t,e,!1),hi(r,e);return!0},Zi=a=>{let e,t;do{if((e=a._$AM)===void 0)break;t=e._$AN,t.delete(a),a=e}while((t==null?void 0:t.size)===0)},hl=a=>{for(let e;e=a._$AM;a=e){let t=e._$AN;if(t===void 0)e._$AN=t=new Set;else if(t.has(a))break;t.add(a),lc(e)}};function rc(a){this._$AN!==void 0?(Zi(this),this._$AM=a,hl(this)):this._$AM=a}function sc(a,e=!1,t=0){const i=this._$AH,o=this._$AN;if(o!==void 0&&o.size!==0)if(e)if(Array.isArray(i))for(let r=t;r<i.length;r++)hi(i[r],!1),Zi(i[r]);else i!=null&&(hi(i,!1),Zi(i));else hi(this,a)}const lc=a=>{var e,t,i,o;a.type==Oe.CHILD&&((e=(i=a)._$AP)!==null&&e!==void 0||(i._$AP=sc),(t=(o=a)._$AQ)!==null&&t!==void 0||(o._$AQ=rc))};class nc extends Ci{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,i){super._$AT(e,t,i),hl(this),this.isConnected=e._$AU}_$AO(e,t=!0){var i,o;e!==this.isConnected&&(this.isConnected=e,e?(i=this.reconnected)===null||i===void 0||i.call(this):(o=this.disconnected)===null||o===void 0||o.call(this)),t&&(hi(this,e),Zi(this))}setValue(e){if(Bs(this._$Ct))this._$Ct._$AI(e,this);else{const t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}}const Go=new WeakMap,dc=$i(class extends nc{render(a){return b}update(a,[e]){var t;const i=e!==this.U;return i&&this.U!==void 0&&this.ot(void 0),(i||this.rt!==this.lt)&&(this.U=e,this.ht=(t=a.options)===null||t===void 0?void 0:t.host,this.ot(this.lt=a.element)),b}ot(a){var e;if(typeof this.U=="function"){const t=(e=this.ht)!==null&&e!==void 0?e:globalThis;let i=Go.get(t);i===void 0&&(i=new WeakMap,Go.set(t,i)),i.get(this.U)!==void 0&&this.U.call(this.ht,void 0),i.set(this.U,a),a!==void 0&&this.U.call(this.ht,a)}else this.U.value=a}get rt(){var a,e,t;return typeof this.U=="function"?(e=Go.get((a=this.ht)!==null&&a!==void 0?a:globalThis))===null||e===void 0?void 0:e.get(this.U):(t=this.U)===null||t===void 0?void 0:t.value}disconnected(){this.rt===this.lt&&this.ot(void 0)}reconnected(){this.ot(this.lt)}});/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ps=$i(class extends Ci{constructor(a){if(super(a),a.type!==Oe.PROPERTY&&a.type!==Oe.ATTRIBUTE&&a.type!==Oe.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Bs(a))throw Error("`live` bindings can only contain a single expression")}render(a){return a}update(a,[e]){if(e===ke||e===b)return e;const t=a.element,i=a.name;if(a.type===Oe.PROPERTY){if(e===t[i])return ke}else if(a.type===Oe.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(i))return ke}else if(a.type===Oe.ATTRIBUTE&&t.getAttribute(i)===e+"")return ke;return Os(a),e}}),cc=Object.freeze({processing:"processing",complete:"complete"});class hc extends F{static get properties(){return{mode:{type:String}}}constructor(){super(),this.mode=cc.processing}render(){return c`
      <div class="${this.mode}">
        <svg
          viewBox="0 0 120 120"
    ...
    `,this._tooltipVisible=!0}hideTooltip(){this._tooltipContent=void 0,this._tooltipVisible=!1}validMinSliderX(e){const t=Math.min(this.translateDateToPosition(this.maxSelectedDate),this.histogramRightEdgeX);return e=this.clamp(e,this.histogramLeftEdgeX,t),Number.isNaN(e)||t<this.histogramLeftEdgeX?this.histogramLeftEdgeX:e}validMaxSliderX(e){const t=Math.max(this.histogramLeftEdgeX,this.translateDateToPosition(this.minSelectedDate));return e=this.clamp(e,t,this.histogramRightEdgeX),Number.isNaN(e)||t>this.histogramRightEdgeX?this.histogramRightEdgeX:e}addListeners(){window.addEventListener("pointermove",this.move),window.addEventListener("pointerup",this.drop),window.addEventListener("pointercancel",this.drop)}removeListeners(){window.removeEventListener("pointermove",this.move),window.removeEventListener("pointerup",this.drop),window.removeEventListener("pointercancel",this.drop)}beginEmitUpdateProcess(){this.cancelPendingUpdateEvent(),this._emitUpdatedEventTimer=setTimeout(()=>{if(this.currentDateRangeString===this._previousDateRange)return;this._previousDateRange=this.currentDateRangeString;const e={detail:{minDate:this.minSelectedDate,maxDate:this.maxSelectedDate},bubbles:!0,composed:!0};this.dispatchEvent(new CustomEvent("histogramDateRangeUpdated",e))},this.updateDelay)}cancelPendingUpdateEvent(){this._emitUpdatedEventTimer!==void 0&&(clearTimeout(this._emitUpdatedEventTimer),this._emitUpdatedEventTimer=void 0)}setDragOffset(e){this._currentSlider=e.currentTarget;const t=this._currentSlider.id==="slider-min"?this.minSliderX:this.maxSliderX,i=this.getBoundingClientRect().x;this._dragOffset=e.clientX-i-t}translatePositionToDate(e){const t=Math.ceil((e-this.sliderWidth)*this.dateRangeMS/this._histWidth);return this.formatDate(this._minDateMS+t)}translateDateToPosition(e){const t=this.getMSFromString(e);return this.sliderWidth+(t-this._minDateMS)*this._histWidth/this.dateRangeMS}clamp(e,t,i){return Math.min(Math.max(e,t),i)}handleInputFocus(){this.updateWhileFocused||this.cancelPendingUpdateEvent()}handleMinDateInput(e){const t=e.currentTarget;t.value!==this.minSelectedDate&&(this.minSelectedDate=t.value,this.beginEmitUpdateProcess())}handleMaxDateInput(e){const t=e.currentTarget;t.value!==this.maxSelectedDate&&(this.maxSelectedDate=t.value,this.beginEmitUpdateProcess())}handleKeyUp(e){if(e.key==="Enter"){const t=e.currentTarget;t.blur(),t.id==="date-min"?this.handleMinDateInput(e):t.id==="date-max"&&this.handleMaxDateInput(e)}}get currentDateRangeString(){return`${this.minSelectedDate}:${this.maxSelectedDate}`}getMSFromString(e){const t=typeof e=="string"?e:String(e);if((t.split(/(\d+)/).length-1)/2===1){const o=new Date(0,0);return o.setFullYear(Number(t)),o.getTime()}return Ko(t,[this.dateFormat,us]).valueOf()}handleBarClick(e){const t=e.currentTarget.dataset,i=(this.getMSFromString(t.binStart)+this.getMSFromString(t.binEnd))/2,o=Math.abs(i-this.getMSFromString(this.minSelectedDate)),r=Math.abs(i-this.getMSFromString(this.maxSelectedDate));o<r?this.minSelectedDate=t.binStart:this.maxSelectedDate=t.binEnd,this.beginEmitUpdateProcess()}get minSliderTemplate(){const e=fs,t=`
            ...
            q0,${e} ${e},${e}
            h${this.sliderWidth-e}
          `;return this.generateSliderSVG(this.minSliderX,"slider-min",t)}get maxSliderTemplate(){const e=fs,t=`
            M${this.maxSliderX},0
            h${this.sliderWidth-e}
            q${e},0 ${e},${e}
            v${this.height-e*2}
    ...
    `}get selectedRangeTemplate(){return U`
      <rect
        ...
        height="${this.height}"
        fill="${wc}"
      />`}get histogramTemplate(){const e=this._histWidth/this._numBins,t=e-1;let i=this.sliderWidth;return this._histData.map(o=>{const r=U`
        <rect
          class="bar"
          ...
          fill="${i+t>=this.minSliderX&&i<=this.maxSliderX?_c:Sc}"
    ...
    `:this.noDataTemplate}};ee.styles=v`
    ...
    ia-activity-indicator {
      ...
      --activityIndicatorLoadingRingColor: ${xc};
    }
    ...
    #tooltip:after {
      ...
      /* arrow */
      border: 5px solid ${ms};
      border-color: ${vs} transparent transparent
        transparent;
    }
    /****** slider ********/
    .draggable:hover {
  ...
  `;l([h({type:Number})],ee.prototype,"width",void 0);l([h({type:Number})],ee.prototype,"height",void 0);l([h({type:Number})],ee.prototype,"sliderWidth",void 0);l([h({type:Number})],ee.prototype,"tooltipWidth",void 0);l([h({type:Number})],ee.prototype,"tooltipHeight",void 0);l([h({type:Number})],ee.prototype,"updateDelay",void 0);l([h({type:String})],ee.prototype,"dateFormat",void 0);l([h({type:String})],ee.prototype,"missingDataMessage",void 0);l([h({type:String})],ee.prototype,"minDate",void 0);l([h({type:String})],ee.prototype,"maxDate",void 0);l([h({type:Boolean})],ee.prototype,"disabled",void 0);l([h({type:Object})],ee.prototype,"bins",void 0);l([h({type:Boolean})],ee.prototype,"updateWhileFocused",void 0);l([P()],ee.prototype,"_tooltipOffset",void 0);l([P()],ee.prototype,"_tooltipContent",void 0);l([P()],ee.prototype,"_tooltipVisible",void 0);l([P()],ee.prototype,"_isDragging",void 0);l([P()],ee.prototype,"_isLoading",void 0);l([h({type:Boolean})],ee.prototype,"loading",null);l([h()],ee.prototype,"minSelectedDate",null);l([h()],ee.prototype,"maxSelectedDate",null);ee=l([L("histogram-date-range")],ee);const gs=U`
<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><path d="m51.5960452 0c5.420012 0 6.7920618 2.72313378 8.1300179 9.28391016 2.9793915 19.21608984-2.9793915 28.94849474 0 31.58229234 1.2215505 1.079857 1.8678662.7924226 3.2997314.0773518l.2153069-.1075882c2.1016905-1.0490161 5.8499713-2.8359661 14.9013153-2.8359661l2.3393989.00075c14.0694555.01425 14.2569231.29925 18.0062757 5.99925 0 3.2648986.9924719 9.5-3.9698878 9.5 4.9623597 0 7.9397755 15.5 0 15.5 7.9397755 0 6.9473035 15.5-.9924719 15.5 7.9397754 0 5.9548316 12 2.9774158 13-1.1342536.5714286-1.9876793 1.0011812-2.627102 1.3222794l-.3279542.1645673c-1.5889262.796641-1.5747062.7780161-1.4530457.6832252l.0244872-.0190992c.0041709-.0032756.0083532-.0065808.0124967-.0098908l.0239934-.0197196c.1060465-.0904428.1029348-.1457697-1.111471.3786377h-55.0821921c-3.3082398-3.0266004-4.9623597-5.0266004-4.9623597-6v-33.4737525c5.5882429-8.3508317 10.6469206-21.2754909 15.1760333-38.7739777v-17.92948326c0-2.54852436 1.8066707-3.82278654 5.4200119-3.82278654zm-27.5960452 56c2.209139 0 4 1.790861 4 4v36c0 2.209139-1.790861 4-4 4h-20c-2.209139 0-4-1.790861-4-4v-36c0-2.209139 1.790861-4 4-4z" fill-rule="evenodd"/></svg>`,bs=U`
<svg viewBox="0 0 100 100"
  xmlns="http://www.w3.org/2000/svg">
...
`;let re=class extends F{constructor(){super(...arguments),this.prompt="Do you find this feature useful?",this.buttonText="Beta",this.isOpen=!1,this.processing=!1,this.popupTopX=0,this.popupTopY=0,this.voteSubmitted=!1,this.voteNeedsChoosing=!1,this.resizingElement=document.body}render(){return c`
      <button
        id="beta-button"
    ...
    `}get upvoteSelected(){return this.vote==="up"}get downvoteSelected(){return this.vote==="down"}upvoteKeypressed(e){(e.key==="Enter"||e.key===" ")&&this.upvoteButtonSelected()}downvoteKeypressed(e){(e.key==="Enter"||e.key===" ")&&this.downvoteButtonSelected()}upvoteButtonSelected(){this.vote=this.vote==="up"?void 0:"up"}downvoteButtonSelected(){this.vote=this.vote==="down"?void 0:"down"}get chooseVoteErrorClass(){return this.voteNeedsChoosing?"error":""}get upvoteButtonClass(){switch(this.vote){case"up":return"selected";case"down":return"unselected";default:return"noselection"}}get downvoteButtonClass(){switch(this.vote){case"up":return"unselected";case"down":return"selected";default:return"noselection"}}backgroundClicked(e){var t;e.target instanceof Node&&(!((t=this.popup)===null||t===void 0)&&t.contains(e.target)||this.closePopup())}cancel(e){e.preventDefault(),this.vote=void 0,this.closePopup()}async submit(e){if(e.preventDefault(),!this.vote){this.voteNeedsChoosing=!0,this.error=c`Please select a vote.`;return}if(!this.featureIdentifier)throw new Error("featureIdentifier is required");if(!this.featureFeedbackService)throw new Error("featureFeedbackService is required");if(!this.recaptchaWidget)throw new Error("recaptchaWidget is required");this.processing=!0;try{const t=await this.recaptchaWidget.execute();(await this.featureFeedbackService.submitFeedback({featureIdentifier:this.featureIdentifier,vote:this.vote,comments:this.comments.value,recaptchaToken:t})).success?(this.voteSubmitted=!0,this.closePopup()):this.error=c`There was an error submitting your feedback.`}catch(t){this.error=c`There was an error submitting your feedback.<br />Error:
        ${t instanceof Error?t.message:t}`}this.processing=!1}static get styles(){const e=v`var(--featureFeedbackBlueColor, #194880)`,t=v`var(--featureFeedbackDarkGrayColor, #767676)`,i=v`var(--defaultColorSvgFilter, invert(52%) sepia(0%) saturate(1%) hue-rotate(331deg) brightness(87%) contrast(89%))`,o=v`var(--featureFeedbackBackdropZindex, 5)`,r=v`var(--featureFeedbackModalZindex, 6)`,s=v`var(--featureFeedbackPopupBorderColor, ${e})`,n=v`var(--featureFeedbackSubmitButtonColor, ${e})`,d=v`var(--featureFeedbackBetaButtonBorderColor, ${e})`,p=v`var(--featureFeedbackBetaButtonTextColor, ${e})`,f=v`var(--featureFeedbackBetaButtonSvgFilter, ${i})`,m=v`var(--featureFeedbackCancelButtonColor, #515151)`,y=v`var(--featureFeedbackPopupBlockerColor, rgba(255, 255, 255, 0.3))`,w=v`var(--featureFeedbackPopupBackgroundColor, #F5F5F7)`,x=v`var(--featureFeedbackPromptFontWeight, bold)`,C=v`var(--featureFeedbackPromptFontSize, 14px)`,A=v`var(--defaultColor, ${t});`,B=v`var(--defaultColorSvgFilter, ${i});`,D=v`var(--upvoteColor, #23765D);`,W=v`var(--upvoteColorSvgFilter, invert(34%) sepia(72%) saturate(357%) hue-rotate(111deg) brightness(97%) contrast(95%));`,R=v`var(--downvoteColor, #720D11);`,J=v`var(--downvoteColorSvgFilter, invert(5%) sepia(81%) saturate(5874%) hue-rotate(352deg) brightness(105%) contrast(95%));`,he=v`var(--unselectedColor, #CCCCCC);`,Pe=v`var(--unselectedColorSvgFilter, invert(100%) sepia(0%) saturate(107%) hue-rotate(138deg) brightness(89%) contrast(77%));`;return v`
      #beta-button {
        font-size: 12px;
        font-weight: bold;
        font-style: italic;
    ...
    `}};l([h({type:String})],re.prototype,"featureIdentifier",void 0);l([h({type:String})],re.prototype,"prompt",void 0);l([h({type:String})],re.prototype,"buttonText",void 0);l([h({type:Object})],re.prototype,"recaptchaManager",void 0);l([h({type:Object})],re.prototype,"resizeObserver",void 0);l([h({type:Boolean})],re.prototype,"disabled",void 0);l([h({type:Object})],re.prototype,"featureFeedbackService",void 0);l([Z("#beta-button")],re.prototype,"betaButton",void 0);l([Z("#popup")],re.prototype,"popup",void 0);l([P()],re.prototype,"isOpen",void 0);l([P()],re.prototype,"processing",void 0);l([P()],re.prototype,"popupTopX",void 0);l([P()],re.prototype,"popupTopY",void 0);l([P()],re.prototype,"vote",void 0);l([P()],re.prototype,"voteSubmitted",void 0);l([P()],re.prototype,"error",void 0);l([P()],re.prototype,"voteNeedsChoosing",void 0);l([P()],re.prototype,"recaptchaWidget",void 0);l([Z("#comments")],re.prototype,"comments",void 0);re=l([L("feature-feedback")],re);class Sa{constructor(e){var t,i,o,r,s,n,d;this.title=e==null?void 0:e.title,this.subtitle=e==null?void 0:e.subtitle,this.headline=e==null?void 0:e.headline,this.message=e==null?void 0:e.message,this.headerColor=(t=e==null?void 0:e.headerColor)!==null&&t!==void 0?t:"#55A183",this.bodyColor=(i=e==null?void 0:e.bodyColor)!==null&&i!==void 0?i:"#f5f5f7",this.showProcessingIndicator=(o=e==null?void 0:e.showProcessingIndicator)!==null&&o!==void 0?o:!1,this.processingImageMode=(r=e==null?void 0:e.processingImageMode)!==null&&r!==void 0?r:"complete",this.showCloseButton=(s=e==null?void 0:e.showCloseButton)!==null&&s!==void 0?s:!0,this.showHeaderLogo=(n=e==null?void 0:e.showHeaderLogo)!==null&&n!==void 0?n:!0,this.closeOnBackdropClick=(d=e==null?void 0:e.closeOnBackdropClick)!==null&&d!==void 0?d:!0}}var Pc=c`
<svg
  viewBox="0 0 40 40"
  version="1.1"
  xmlns="http://www.w3.org/2000/svg"
...
`;let $a=class extends F{constructor(){super(...arguments),this.config=new Sa}render(){return c`
      <div class="modal-wrapper">
        <div class="modal-container">
          <header style="background-color: ${this.config.headerColor}">
            ${this.config.showCloseButton?this.closeButtonTemplate:""}
            ${this.config.showHeaderLogo?c`<div class="logo-icon">${Ac}</div>`:b}
    ...
    `}static get styles(){const e=v`var(--modalLogoSize, 6.5rem)`,t=v`var(--processingImageSize, 7.5rem)`,i=v`var(--modalCornerRadius, 1rem)`,o=v`var(--modalBorder, 2px solid black)`,r=v`var(--modalBottomMargin, 2.5rem)`,s=v`var(--modalTopMargin, 5rem)`,n=v`var(--modalHeaderBottomPadding, 0.5em)`,d=v`var(--modalBottomPadding, 2rem)`,p=v`var(--modalScrollOffset, 5px)`,f=v`var(--modalTitleFontSize, 1.8rem)`,m=v`var(--modalSubtitleFontSize, 1.4rem)`,y=v`var(--modalHeadlineFontSize, 1.6rem)`,w=v`var(--modalMessageFontSize, 1.4rem)`,x=v`var(--modalTitleLineHeight, normal)`,C=v`var(--modalSubtitleLineHeight, normal)`,A=v`var(--modalHeadlineLineHeight, normal)`,B=v`var(--modalMessageLineHeight, normal)`;return v`
      .processing-logo {
        margin: auto;
        width: ${t};
        height: ${t};
    ...
    `}};l([h({type:Object})],$a.prototype,"config",void 0);$a=l([L("modal-template")],$a);function Lc(a,e,t){var i=t||{},o=i.noTrailing,r=o===void 0?!1:o,s=i.noLeading,n=s===void 0?!1:s,d=i.debounceMode,p=d===void 0?void 0:d,f,m=!1,y=0;function w(){f&&clearTimeout(f)}function x(A){var B=A||{},D=B.upcomingOnly,W=D===void 0?!1:D;w(),m=!W}function C(){for(var A=arguments.length,B=new Array(A),D=0;D<A;D++)B[D]=arguments[D];var W=this,R=Date.now()-y;if(m)return;function J(){y=Date.now(),e.apply(W,B)}function he(){f=void 0}!n&&p&&!f&&J(),w(),p===void 0&&R>a?n?(y=Date.now(),r||(f=setTimeout(p?he:J,a))):J():r!==!0&&(f=setTimeout(p?he:J,p===void 0?a-R:a))}return C.cancel=x,C}var vt;(function(a){a.Open="open",a.Closed="closed"})(vt||(vt={}));class Dc{constructor(e){this.windowResizeThrottler=Lc(100,this.updateModalContainerHeight,{noLeading:!1,noTrailing:!1}).bind(this),this.modalManager=e}handleModeChange(e){switch(e){case vt.Open:this.startResizeListener(),this.stopDocumentScroll();break;case vt.Closed:this.stopResizeListener(),this.resumeDocumentScroll();break}}updateModalContainerHeight(){this.modalManager.style.setProperty("--containerHeight",`${window.innerHeight}px`)}stopDocumentScroll(){document.body.classList.add("modal-manager-open")}resumeDocumentScroll(){document.body.classList.remove("modal-manager-open")}startResizeListener(){window.addEventListener("resize",this.windowResizeThrottler)}stopResizeListener(){window.removeEventListener("resize",this.windowResizeThrottler)}}let Ut=class extends F{constructor(){super(...arguments),this.mode=vt.Closed,this.hostBridge=new Dc(this),this.closeOnBackdropClick=!0}render(){return c`
      <div class="container">
    ...
    `}};l([h({type:String,reflect:!0})],Ut.prototype,"mode",void 0);l([h({type:Object})],Ut.prototype,"customModalContent",void 0);l([h({type:Object})],Ut.prototype,"hostBridge",void 0);l([Z("modal-template")],Ut.prototype,"modalTemplate",void 0);Ut=l([L("modal-manager")],Ut);var Rc=c`
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path
...
`;let Nt=class extends F{constructor(){super(...arguments),this.step=2,this.currentPage=1,this.pages=[]}firstUpdated(){this.observePageCount()}updated(e){e.has("size")&&this.observePageCount(),e.has("currentPage")&&(this.observePageCount(),this.emitPageClick())}observePageCount(){this.pages=[];const e=7,t=this.size<=e;if(this.size<=5){this.pages=[...Array(this.size).keys()].map(r=>r+1);return}if(this.size===e){if(this.currentPage===2){this.pages=[1,2,3,4,0,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,4,5,this.size-1,this.size];return}}if(this.currentPage===1){this.pages=[1,2,3,0,this.size];return}if(this.currentPage===this.size){this.pages=[1,0,this.size-2,this.size-1,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,this.size-3,this.size-2,this.size-1,this.size];return}if(t&&this.currentPage>1&&this.currentPage<e){this.pages=[...Array(this.size).keys()].map(r=>r+1);return}let i=this.currentPage-this.step,o=this.currentPage+this.step;i<=0&&(o+=-i+1,i=1),o>=this.size&&(i=Math.max(i-(o-this.size),1),o=this.size),i===2&&(o-=1),o===this.size-1&&(i+=1),this.createFirstNode(i),this.createMiddelNode(i,o),this.createLastNode(o)}createFirstNode(e){var t,i;e>1&&((t=this.pages)===null||t===void 0||t.push(1)),e>2&&((i=this.pages)===null||i===void 0||i.push(0))}createMiddelNode(e,t){var i;for(let o=e;o<=t;o+=1)(i=this.pages)===null||i===void 0||i.push(o)}createLastNode(e){var t,i;e<this.size-1&&((t=this.pages)===null||t===void 0||t.push(0)),e<this.size&&((i=this.pages)===null||i===void 0||i.push(this.size))}get getEllipsisTemplate(){return c`<i class="ellipses">...</i>`}emitPageClick(){this.dispatchEvent(new CustomEvent("pageNumberClicked",{detail:{page:this.currentPage},bubbles:!0,composed:!0}))}onRewind(){this.currentPage-=1,this.currentPage<1&&(this.currentPage=1)}onForward(){this.currentPage+=1,this.currentPage>this.size&&(this.currentPage=this.size)}onChange(e){this.currentPage=e}getPageTemplate(e){return c`
    ...
    `}static get styles(){return[Ze,v`
      ...
      `]}};l([h({type:Number})],Nt.prototype,"size",void 0);l([h({type:Number})],Nt.prototype,"step",void 0);l([h({type:Number})],Nt.prototype,"currentPage",void 0);l([P()],Nt.prototype,"pages",void 0);Nt=l([L("more-facets-pagination")],Nt);var Oc=U`
...
`,Ca;let yi=Ca=class extends F{render(){return c`${this.facetRowTemplate}`}get facetRowTemplate(){var e,t,i,o;const{bucket:r,facetType:s}=this;if(!r||!s)return b;const n=`${s}:${r.key}-show-only`,d=`${s}:${r.key}-negative`,p=s!=="collection"?c`${(e=r.displayText)!==null&&e!==void 0?e:r.key}`:c`<a href="/details/${r.key}">
            ${(i=(t=this.collectionTitles)===null||t===void 0?void 0:t.get(r.key))!==null&&i!==void 0?i:r.key}
          </a> `,f=r.state==="hidden",m=r.state==="selected",y=`${s}: ${(o=r.displayText)!==null&&o!==void 0?o:r.key}`,w=m?`Show all ${s}s`:`Only show ${y}`,x=`Hide ${y}`,C=`Unhide ${y}`,A=f?C:x,B=`${y}, ${r.count} results`;return c`
    ...
    `}facetClicked(e,t){const{bucket:i,facetType:o}=this;if(!i||!o)return;const r=e.target,{checked:s}=r;this.bucket=le(G({},i),{state:Ca.getFacetState(s,t)}),this.dispatchFacetClickEvent({facetType:o,bucket:this.bucket,negative:t})}dispatchFacetClickEvent(e){const t=new CustomEvent("facetClick",{detail:e});this.dispatchEvent(t)}static getFacetState(e,t){let i;return e?i=t?"hidden":"selected":i="none",i}static get styles(){const e=v`var(--facet-row-border-top, 1px solid transparent)`,t=v`var(--facet-row-border-bottom, 1px solid transparent)`;return v`
    ...
    `}};l([h({type:String})],yi.prototype,"facetType",void 0);l([h({type:Object})],yi.prototype,"bucket",void 0);l([h({type:Object})],yi.prototype,"collectionTitles",void 0);yi=Ca=l([L("facet-row")],yi);let Ji=class extends F{facetClicked(e){this.dispatchFacetClickEvent(e.detail)}dispatchFacetClickEvent(e){const t=new CustomEvent("facetClick",{detail:e,composed:!0});this.dispatchEvent(t)}get facetsTemplate(){const{facetGroup:e}=this;if(!e)return b;const t=e.buckets;return c`
    ...
    `}};l([h({type:Object})],Ji.prototype,"facetGroup",void 0);l([h({type:Object})],Ji.prototype,"collectionTitles",void 0);Ji=l([L("facets-template")],Ji);let ot=class extends F{constructor(){super(...arguments),this.leftValue="",this.rightValue="",this.side="left"}render(){var e,t;return c`
      <div id="container">
    ...
    `}get value(){return this.side==="left"?this.leftValue:this.rightValue}get selectedLabel(){var e,t;return this.side==="left"?(e=this.leftLabel)!==null&&e!==void 0?e:this.leftValue:(t=this.rightLabel)!==null&&t!==void 0?t:this.rightValue}handleClick(){this.side=this.side==="left"?"right":"left",this.emitChangeEvent()}handleRadioChange(){this.side=this.leftRadio.checked?"left":"right",this.emitChangeEvent()}emitChangeEvent(){const e=new CustomEvent("change",{detail:this.value});this.dispatchEvent(e)}static get styles(){const e=v`var(--switchWidth, 30px)`,t=v`var(--switchHeight, 14px)`,i=v`var(--switchMarginLeft, 5px)`,o=v`var(--switchMarginRight, 5px)`,r=v`var(--switchBorderWidth, 3px)`,s=v`var(--switchBgColor, #194880)`,n=v`var(--switchBorderColor, #194880)`,d=v`var(--labelFontSize, 1.3rem)`,p=v`var(--knobColor, white)`,f=v`var(--knobTransitionDuration, 0.25s)`,m=v`var(--knobTransitionFn, ease)`;return[Ze,v`
      ...
      `]}};l([h({type:String,attribute:!0})],ot.prototype,"leftValue",void 0);l([h({type:String,attribute:!0})],ot.prototype,"leftLabel",void 0);l([h({type:String,attribute:!0})],ot.prototype,"rightValue",void 0);l([h({type:String,attribute:!0})],ot.prototype,"rightLabel",void 0);l([h({type:String,attribute:!0})],ot.prototype,"side",void 0);l([Z("#switch-left")],ot.prototype,"leftRadio",void 0);ot=l([L("toggle-switch")],ot);function ka(a,e){if(!!a)for(const[t,i]of Object.entries(a))for(const[o,r]of Object.entries(i))e(t,o,r,a)}function eo(a,e,t,i=!1){const o=a!=null?a:qe(),r=le(G({},o),{[e]:le(G({},o[e]),{[t.key]:t})});return i&&t.state==="none"&&delete r[e][t.key],r}function Uc(a){const e=qe();return ka(a,(t,i,o)=>{e[t][i]=o}),e}function Nc(a,e){const t=Uc(a);return ka(e,(i,o,r)=>{t[i][o]=r}),ka(t,(i,o,r)=>{r.state==="none"&&delete t[i][o]}),t}const ys=["selected","hidden","none"];function pl(a,e=q.COUNT){return a.sort((t,i)=>{const o=ys.indexOf(t.state),r=ys.indexOf(i.state),s=o-r;let n;return e===q.ALPHABETICAL?n=t.key.localeCompare(i.key):e===q.NUMERIC?n=Number(i.key)-Number(t.key):n=i.count-t.count,s||n})}let de=class extends F{constructor(){super(...arguments),this.facetsPerPage=35,this.facetsLoading=!0,this.sortedBy=q.COUNT,this.unappliedFacetChanges=qe(),this.pageNumber=1}willUpdate(e){(e.has("aggregations")||e.has("facetsPerPage")||e.has("sortedBy")||e.has("selectedFacets")||e.has("unappliedFacetChanges"))&&(this.facetGroup=this.mergedFacets)}updated(e){(e.has("facetKey")||e.has("query")||e.has("searchType")||e.has("filterMap"))&&(this.facetsLoading=!0,this.pageNumber=1,this.sortedBy=Qi[this.facetKey],this.updateSpecificFacets())}firstUpdated(){this.setupEscapeListeners()}setupEscapeListeners(){this.modalManager?document.addEventListener("keydown",e=>{var t;e.key==="Escape"&&((t=this.modalManager)===null||t===void 0||t.closeModal())}):document.removeEventListener("keydown",()=>{})}get isSearchResultsPage(){var e;const t=(e=this.pageSpecifierParams)===null||e===void 0?void 0:e.pageType;return t===void 0||t==="search_results"}async updateSpecificFacets(){var e,t,i,o,r,s;if(!this.facetKey)return;const n=(e=this.query)===null||e===void 0?void 0:e.trim();if(!n&&this.isSearchResultsPage)return;const d={simpleParams:[this.facetKey]},p=65535,f=le(G({},this.pageSpecifierParams),{query:n||"",filters:this.filterMap,aggregations:d,aggregationsSize:p,rows:0}),m=await((t=this.searchService)===null||t===void 0?void 0:t.search(f,this.searchType));this.aggregations=(i=m==null?void 0:m.success)===null||i===void 0?void 0:i.response.aggregations,this.facetsLoading=!1;const y=(r=(o=m==null?void 0:m.success)===null||o===void 0?void 0:o.response)===null||r===void 0?void 0:r.collectionTitles;if(y)for(const[w,x]of Object.entries(y))(s=this.collectionTitles)===null||s===void 0||s.set(w,x)}pageNumberClicked(e){var t,i;const o=(t=e==null?void 0:e.detail)===null||t===void 0?void 0:t.page;o&&(this.pageNumber=Number(o)),(i=this.analyticsHandler)===null||i===void 0||i.sendEvent({category:Ue.default,action:te.moreFacetsPageChange,label:`${this.pageNumber}`})}get mergedFacets(){var e;if(!this.facetKey||!this.selectedFacets)return;const{selectedFacetGroup:t,aggregationFacetGroup:i}=this;if(!i)return;const o=G({},t!=null?t:i),r=(e=t==null?void 0:t.buckets.map(n=>{const d=i.buckets.find(p=>p.key===n.key);return d?le(G({},n),{count:d.count}):n}))!==null&&e!==void 0?e:[];pl(r,this.sortedBy),i.buckets.forEach(n=>{t!=null&&t.buckets.find(p=>p.key===n.key)||r.push(n)});const s=this.unappliedFacetChanges[this.facetKey];for(const[n,d]of r.entries()){const p=s[d.key];p&&(r[n]=G({},p))}return o.buckets=r,o}get selectedFacetGroup(){if(!this.selectedFacets||!this.facetKey)return;const e=this.selectedFacets[this.facetKey];if(!e)return;const t=ji[this.facetKey],i=Object.entries(e).map(([o,r])=>({displayText:o,key:o,count:r==null?void 0:r.count,state:r==null?void 0:r.state}));return{title:t,key:this.facetKey,buckets:i}}get aggregationFacetGroup(){if(!this.aggregations||!this.facetKey)return;const e=this.aggregations[this.facetKey];if(!e)return;const t=ji[this.facetKey];let i=e.getSortedBuckets(this.sortedBy);this.facetKey==="collection"&&(i=i==null?void 0:i.filter(r=>{var s;const n=(s=r==null?void 0:r.key)===null||s===void 0?void 0:s.toString();return!ao[n]&&!(n!=null&&n.startsWith("fav-"))}));const o=i.map(r=>{const s=`${r.key}`;return{displayText:`${s}`,key:`${s}`,count:r.doc_count,state:"none"}});return{title:t,key:this.facetKey,buckets:o}}get facetGroupForCurrentPage(){const{facetGroup:e}=this;if(!e)return;const t=(this.pageNumber-1)*this.facetsPerPage,i=e.buckets.slice(t,t+this.facetsPerPage);return le(G({},e),{buckets:i})}get moreFacetsTemplate(){return c`
      <facets-template
    ...
    `}get loaderTemplate(){return c`<div class="facets-loader">
      <ia-activity-indicator .mode=${"processing"}></ia-activity-indicator>
        ...
        </div> `:b}sortFacetAggregation(e){this.sortedBy=e,this.dispatchEvent(new CustomEvent("sortedFacets",{detail:this.sortedBy}))}get modalHeaderTemplate(){var e,t,i;const r=((e=this.sortedBy)!==null&&e!==void 0?e:Qi[this.facetKey])===q.COUNT?"left":"right";return c`<span class="sr-only">${M("More facets for:")}</span>
      <span class="title">
      ...
      ${this.facetsLoading?this.loaderTemplate:c`
          ...
          `}
    `}applySearchFacetsClicked(){var e,t;const i=Nc(this.selectedFacets,this.unappliedFacetChanges),o=new CustomEvent("facetsChanged",{detail:i,bubbles:!0,composed:!0});this.dispatchEvent(o),this.unappliedFacetChanges=qe(),(e=this.modalManager)===null||e===void 0||e.closeModal(),(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:Ue.default,action:`${te.applyMoreFacetsModal}`,label:`${this.facetKey}`})}cancelClick(){var e,t;this.unappliedFacetChanges=qe(),(e=this.modalManager)===null||e===void 0||e.closeModal(),(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:Ue.default,action:te.closeMoreFacetsModal,label:`${this.facetKey}`})}static get styles(){const e=v`var(--primaryButtonBGColor, #194880)`;return[Ze,v`
        section#more-facets {
          overflow: auto;
    ...
    `}};ws=l([L("facet-tombstone-row")],ws);let Ve=class extends F{constructor(){super(...arguments),this.boundEscapeListener=e=>{e.key==="Escape"&&this.closeModal()}}render(){var e,t;return c`
      <div id="container">
    ...
    `}connectedCallback(){var e;(e=super.connectedCallback)===null||e===void 0||e.call(this),this.setupEscapeListener()}disconnectedCallback(){var e;(e=super.disconnectedCallback)===null||e===void 0||e.call(this),this.removeEscapeListener()}setupEscapeListener(){document.addEventListener("keydown",this.boundEscapeListener)}removeEscapeListener(){document.removeEventListener("keydown",this.boundEscapeListener)}histogramDateRangeUpdated(e){this.minSelectedDate=e.detail.minDate,this.maxSelectedDate=e.detail.maxDate}applyBtnClicked(){var e;const t=new CustomEvent("histogramDateRangeApplied",{detail:{minDate:this.minSelectedDate,maxDate:this.maxSelectedDate}});this.dispatchEvent(t),this.closeModal(),(e=this.analyticsHandler)===null||e===void 0||e.sendEvent({category:Ue.default,action:te.histogramChangedFromModal,label:window.location.href})}closeModal(){this.modalManager&&(this.modalManager.closeModal(),this.dispatchEvent(new CustomEvent("modalClosed")))}static get styles(){return v`
      #container {
        display: flex;
        justify-content: center;
    ...
    `}};l([h({type:String})],Ve.prototype,"minDate",void 0);l([h({type:String})],Ve.prototype,"maxDate",void 0);l([h({type:String})],Ve.prototype,"minSelectedDate",void 0);l([h({type:String})],Ve.prototype,"maxSelectedDate",void 0);l([h({type:Array})],Ve.prototype,"buckets",void 0);l([h({type:Object,attribute:!1})],Ve.prototype,"modalManager",void 0);l([h({type:Object,attribute:!1})],Ve.prototype,"analyticsHandler",void 0);Ve=l([L("expanded-date-picker")],Ve);let H=class extends F{constructor(){super(...arguments),this.moreLinksVisible=!0,this.facetsLoading=!1,this.fullYearAggregationLoading=!1,this.collapsableFacets=!1,this.showHistogramDatePicker=!1,this.allowExpandingDatePicker=!1,this.parentCollections=[],this.collectionPagePath="/details/",this.isManageView=!1,this.openFacets={subject:!1,lending:!1,mediatype:!1,language:!1,creator:!1,collection:!1,year:!1},this.allowedFacetCount=6,this.handleExpandedDatePickerClosed=()=>{var e;(e=this.modalManager)===null||e===void 0||e.classList.remove("expanded-date-picker")},this.histogramDateRangeUpdated=e=>{const{minDate:t,maxDate:i}=e.detail,o=new CustomEvent("histogramDateRangeUpdated",{detail:{minDate:t,maxDate:i}});this.dispatchEvent(o)}}render(){const e=Lt({loading:this.facetsLoading,managing:this.isManageView}),t="date-picker-label";return c`
    ...
    `}partOfCollectionClicked(e){var t;(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:Ue.default,action:te.partOfCollectionClicked,label:e.target.dataset.id})}showDatePickerModal(){var e,t,i;const{fullYearsHistogramAggregation:o}=this,r=o==null?void 0:o.first_bucket_key,s=o==null?void 0:o.last_bucket_key,n=o==null?void 0:o.buckets,p=c`
      <expanded-date-picker
        ${dc(m=>{if(m&&m instanceof Ve){const y=m;y.minSelectedDate=this.minSelectedDate,y.maxSelectedDate=this.maxSelectedDate}})}
        .minDate=${r}
        .maxDate=${s}
    ...
    `,f=new Sa({bodyColor:"#fff",headerColor:"#194880",showHeaderLogo:!1,closeOnBackdropClick:!0,title:c`Select a date range`});(e=this.modalManager)===null||e===void 0||e.classList.add("expanded-date-picker"),(t=this.modalManager)===null||t===void 0||t.showModal({config:f,customModalContent:p,userClosedModalCallback:this.handleExpandedDatePickerClosed}),(i=this.analyticsHandler)===null||i===void 0||i.sendEvent({category:Ue.default,action:te.histogramExpanded,label:window.location.href})}updated(e){e.has("selectedFacets")&&this.dispatchFacetsChangedEvent()}dispatchFacetsChangedEvent(){const e=new CustomEvent("facetsChanged",{detail:this.selectedFacets});this.dispatchEvent(e)}get expandDatePickerBtnTemplate(){return this.allowExpandingDatePicker&&!this.facetsLoading?c`<button
        ...
        >
          ...
          <histogram-date-range
            ...
            @histogramDateRangeUpdated=${this.histogramDateRangeUpdated}
          ></histogram-date-range>
        `}get mergedFacets(){const e=[];return bn.forEach(t=>{var i,o;const r=this.selectedFacetGroups.find(f=>f.key===t),s=this.aggregationFacetGroups.find(f=>f.key===t);if(r&&!s){e.push(r);return}if(!s)return;const n=r!=null?r:s;let d=(i=r==null?void 0:r.buckets.map(f=>{const m=s.buckets.find(y=>y.key===f.key);return m?le(G({},f),{count:m.count}):f}))!==null&&i!==void 0?i:[];s.buckets.forEach(f=>{d.find(y=>y.key===f.key)||d.push(f)});let p=(o=Object.keys((r==null?void 0:r.buckets)||[]))===null||o===void 0?void 0:o.length;if(p<this.allowedFacetCount&&(p=this.allowedFacetCount),t==="lending"&&(d=d.filter(f=>wn[f.key])),pl(d),t==="mediatype"){const f=d.findIndex(m=>m.key==="collection");if(f>=p){const[m]=d.splice(f,1);p>this.allowedFacetCount&&(p+=1),d.splice(p-1,0,m)}}n.buckets=d.slice(0,p),e.push(n)}),e}get selectedFacetGroups(){return this.selectedFacets?Object.entries(this.selectedFacets).map(([t,i])=>{const o=t,r=ji[o],s=Object.entries(i).map(([n,d])=>{var p;let f=n;return o==="lending"&&(f=(p=Pr[n])!==null&&p!==void 0?p:n),{displayText:f,key:n,count:d.count,state:d.state}});return{title:r,key:o,buckets:s}}):[]}get aggregationFacetGroups(){var e;const t=[];return Object.entries((e=this.aggregations)!==null&&e!==void 0?e:[]).forEach(([i,o])=>{if(i==="year_histogram")return;const r=i,s=ji[r];if(!s)return;let n=o.getSortedBuckets(Qi[r]);r==="collection"&&(n=n==null?void 0:n.filter(f=>{var m;const y=(m=f==null?void 0:f.key)===null||m===void 0?void 0:m.toString();return!ao[y]&&!(y!=null&&y.startsWith("fav-"))}));const d=n.map(f=>{var m;const y=f.key;let w=`${f.key}`;return r==="lending"&&(w=(m=Pr[f.key])!==null&&m!==void 0?m:`${f.key}`),{displayText:w,key:`${y}`,count:f.doc_count,state:"none"}}),p={title:s,key:r,buckets:d};t.push(p)}),t}getFacetGroupTemplate(e){if(!this.facetsLoading&&e.buckets.length===0)return b;const{key:t}=e,i=this.openFacets[t],o=c`
      <span class="collapser ${i?"open":""}"> ${ra} </span>
    ...
    `}searchMoreFacetsLink(e){if(!this.moreLinksVisible||e.key==="lending"||Object.keys(e.buckets).length<this.allowedFacetCount)return b;const t=Qi[e.key];return c`<button
      class="more-link"
      @click=${()=>{var i;this.showMoreFacetsModal(e,t),(i=this.analyticsHandler)===null||i===void 0||i.sendEvent({category:Ue.default,action:te.showMoreFacetsModal,label:e.key}),this.dispatchEvent(new CustomEvent("showMoreFacets",{detail:e.key}))}}
...
`;function Wc(a){return a&&a.charAt(0).toLocaleUpperCase()+a.slice(1)}let wi=class extends F{constructor(){super(...arguments),this.selected=!1}render(){var e,t;if(!this.facetInfo)return b;const i=this.facetInfo.facets.length===1,o=this.facetInfo.facets[0],r=Wc((this.labelPrefix?`${this.labelPrefix} `:"")+((t=(e=this.facetInfo.label)!==null&&e!==void 0?e:o.displayText)!==null&&t!==void 0?t:o.bucketKey));if(!r)return b;const s=i&&o.facetType==="mediatype"?Ks[o.bucketKey].icon:b;return c`
      <a
    ...
    `}};l([h({type:Array})],Ht.prototype,"facetInfo",void 0);l([h({type:String})],Ht.prototype,"labelPrefix",void 0);l([h({type:Object})],Ht.prototype,"activeFacetRef",void 0);l([Z("ia-dropdown")],Ht.prototype,"dropdown",void 0);Ht=l([L("smart-facet-dropdown")],Ht);const xs={collection:"Collection: ",creator:"By: ",subject:"About: "};function jc(a){return a.charAt(0).toUpperCase()+a.slice(1)}let We=class extends F{constructor(){super(...arguments),this.filterToggleActive=!1,this.heuristicRecs=[],this.smartFacets=[]}render(){return c`
      <div id="smart-facets-container">
        ${this.filtersToggleTemplate}
        ${Aa(this.smartFacets,e=>`${e[0].label}|${e[0].facets[0].facetType}|${e[0].facets[0].bucketKey}`,e=>this.makeSmartFacet(e))}
      </div>
    `}willUpdate(e){let t=!1;e.has("query")&&(Ce("query change",e.get("query"),this.query),this.lastAggregations=void 0,t=!0),e.has("aggregations")&&!this.lastAggregations&&this.aggregations&&Object.keys(this.aggregations).length>0&&(Ce("aggs change",e.get("aggregations"),this.aggregations),this.lastAggregations=this.aggregations,t=!0),t&&(Ce("should update smart facets, doing so..."),this.updateSmartFacets())}async updateSmartFacets(){Ce("updating smart facets"),this.query&&(this.heuristicRecs=await new co().getRecommendedFacets(this.query),Ce("heuristic recs are",this.heuristicRecs),this.smartFacets=ul(this.facetsToDisplay),Ce("smart facets are",this.smartFacets))}makeSmartFacet(e){return e.length===0?b:e.length===1?this.smartFacetButton(e[0]):this.smartFacetDropdown(e)}smartFacetButton(e){var t;return c`
      <smart-facet-button
        .facetInfo=${e}
        .labelPrefix=${xs[e.facets[0].facetType]}
    ...
    `}smartFacetDropdown(e){return c`
      <smart-facet-dropdown
        .facetInfo=${e}
        .labelPrefix=${xs[e[0].facets[0].facetType]}
    ...
    `}get facetsToDisplay(){const e=[];if(this.heuristicRecs.length>0)for(const t of this.heuristicRecs)e.push([t]);if(this.lastAggregations){const t=["mediatype","year","language","creator","subject","collection"];for(const i of t){const o=this.lastAggregations[i];if(!o||o.buckets.length===0||["lending","year_histogram"].includes(i)||typeof o.buckets[0]=="number"||i==="mediatype"&&this.selectedFacets&&Object.values(this.selectedFacets.mediatype).some(d=>d.state!=="none"))continue;const r=i,n=o.buckets.filter(d=>{var p;const f=(p=this.selectedFacets)===null||p===void 0?void 0:p[r][d.key];return!(f&&f.state!=="none")});if(r==="mediatype")e.push([this.toSmartFacet(r,[n[0]])],[this.toSmartFacet(r,[n[1]])]);else if(r==="collection"||r==="subject"){const d=n.slice(0,5);e.push(d.map(p=>this.toSmartFacet(r,[p])))}else e.push([this.toSmartFacet(r,[n[0]])])}}return e}toSmartFacet(e,t){return{facets:t.map(i=>{var o;let r=jc(i.key.toString());if(e==="collection"){const s=(o=this.collectionTitles)===null||o===void 0?void 0:o.get(i.key.toString());s&&(r=s)}return{facetType:e,bucketKey:i.key.toString(),displayText:r}})}}facetClicked(e){e.detail.smartFacet.selected||(this.smartFacets=[[le(G({},e.detail.smartFacet),{selected:!0})],...this.smartFacets.filter(i=>i[0]!==e.detail.smartFacet)]);for(const i of e.detail.details)this.selectedFacets=eo(this.selectedFacets,i.facetType,i.bucket,!0);const t=new CustomEvent("facetsChanged",{detail:this.selectedFacets});this.dispatchEvent(t)}facetDropdownClicked(e){if(this.smartFacets.find(i=>Ta(i[0],e.detail.smartFacet)))return;this.smartFacets=[[le(G({},e.detail.smartFacet),{selected:!0})],...this.smartFacets];for(const i of e.detail.details)this.selectedFacets=eo(this.selectedFacets,i.facetType,i.bucket,!0);const t=new CustomEvent("facetsChanged",{detail:this.selectedFacets});this.dispatchEvent(t)}onDropdownClick(e){var t;Ce("smart bar: onDropdownClick",e.detail),(t=this.shadowRoot)===null||t===void 0||t.querySelectorAll("smart-facet-dropdown").forEach(i=>{i!==e.detail&&(Ce("closing",i),i.close())})}filterToggleClicked(){this.dispatchEvent(new CustomEvent("filtersToggled"))}static get styles(){return v`
    ...
    `}};l([h({type:String})],We.prototype,"query",void 0);l([h({type:Object})],We.prototype,"aggregations",void 0);l([h({type:Object})],We.prototype,"selectedFacets",void 0);l([h({type:Object})],We.prototype,"collectionTitles",void 0);l([h({type:Boolean})],We.prototype,"filterToggleActive",void 0);l([P()],We.prototype,"heuristicRecs",void 0);l([P()],We.prototype,"smartFacets",void 0);l([P()],We.prototype,"lastAggregations",void 0);We=l([L("smart-facet-bar")],We);let k=class extends F{constructor(){super(),this.baseImageUrl="https://archive.org",this.searchType=ne.METADATA,this.selectedSort=S.default,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.sortDirection=null,this.defaultSortField=S.relevance,this.defaultSortDirection=null,this.pageSize=50,this.showSmartFacetBar=!1,this.showHistogramDatePicker=!1,this.suppressPlaceholders=!1,this.suppressResultCount=!1,this.suppressResultTiles=!1,this.suppressURLQuery=!1,this.suppressSortBar=!1,this.suppressDisplayModes=!1,this.facetLoadStrategy="eager",this.facetPaneVisible=!1,this.clearResultsOnEmptyQuery=!1,this.collectionPagePath="/details/",this.searchContext=Ue.default,this.pageContext="search",this.restorationStateHandler=new Cn({context:this.pageContext}),this.mobileBreakpoint=600,this.loggedIn=!1,this.modalManager=void 0,this.isManageView=!1,this.manageViewLabel="Select items to remove",this.enableSortOptionsSlot=!1,this.showSmartResults=!1,this.dataSource=new Tn(this,this.pageSize),this.initialPageNumber=1,this.pagesToRender=this.initialPageNumber,this.searchResultsLoading=!1,this.facetsLoading=!1,this.mobileView=!1,this.collapsibleFacetsVisible=!1,this.placeholderType=null,this.layoutSizeAnalyticsSent=!1,this.isScrollingToCell=!1,this.isResizeToMobile=!1,this.dataSourceInstallInProgress=!1,this.placeholderCellTemplate=c`<collection-browser-loading-tile></collection-browser-loading-tile>`,this.updateLeftColumnHeight=()=>{var e,t,i,o,r;if(this.mobileView)(t=(e=this.leftColumn)===null||e===void 0?void 0:e.style)===null||t===void 0||t.removeProperty("height");else{const s=(i=this.leftColumn)===null||i===void 0?void 0:i.getBoundingClientRect().top;(r=(o=this.leftColumn)===null||o===void 0?void 0:o.style)===null||r===void 0||r.setProperty("height",`${window.innerHeight-(s!=null?s:0)-3}px`)}},this.updateFacetFadeOut=e=>{var t,i;const o=(t=this.shadowRoot)===null||t===void 0?void 0:t.getElementById("facets-bottom-fade");o==null||o.classList.toggle("hidden",(i=e==null?void 0:e[0])===null||i===void 0?void 0:i.isIntersecting)},this.initialQueryChangeHappened=!1,this.historyPopOccurred=!1,this.addController(this.dataSource)}tileModelAtCellIndex(e){const t=this.dataSource.getTileModelAt(e);if(!t&&!this.isScrollingToCell&&this.dataSource.queryInitialized){const i=Math.floor(e/this.pageSize)+1;this.dataSource.fetchPage(i)}return t}get estimatedTileCount(){return this.pagesToRender*this.pageSize}async getSessionId(){try{const e=sessionStorage==null?void 0:sessionStorage.getItem("cb-session");if(e)return e;if(this.sessionIdGenPromise)return this.sessionIdGenPromise;this.sessionIdGenPromise=Ws(Math.random().toString());const t=await this.sessionIdGenPromise;return sessionStorage==null||sessionStorage.setItem("cb-session",t),t}catch{return""}}goToPage(e){return this.initialPageNumber=e,this.pagesToRender=e,this.scrollToPage(e)}setSearchResultsLoading(e){this.searchResultsLoading=e}setFacetsLoading(e){this.facetsLoading=e}setTotalResultCount(e){this.totalResults=e}clearFilters({facets:e=!0,dateRange:t=!0,letterFilters:i=!0,sort:o=!1}={}){e&&this.hasCheckedFacets&&(this.selectedFacets=qe()),t&&(this.minSelectedDate=void 0,this.maxSelectedDate=void 0),i&&(this.selectedTitleFilter=null,this.selectedCreatorFilter=null),o&&(this.sortDirection=null,this.selectedSort=S.default)}get hasCheckedFacets(){if(!this.selectedFacets)return!1;for(const e of Object.values(this.selectedFacets))for(const t of Object.values(e))if(t.state!=="none")return!0;return!1}get hasActiveFilters(){return!!(this.hasCheckedFacets||this.minSelectedDate||this.maxSelectedDate||this.selectedTitleFilter||this.selectedCreatorFilter)}willUpdate(){this.setPlaceholderType()}render(){return c`
    ...
    </infinite-scroller>`}get infiniteScrollerClasses(){var e;return Lt({[(e=this.displayMode)!==null&&e!==void 0?e:""]:!!this.displayMode,hidden:!!this.placeholderType})}get sortFilterBarTemplate(){var e;return this.suppressSortBar?b:c`
      <sort-filter-bar
    ...
    `}get manageBarTemplate(){return c`
      ...
      ></manage-bar>
    `}handleRemoveItems(){this.dispatchEvent(new CustomEvent("itemRemovalRequested",{detail:{items:this.dataSource.checkedTileModels.map(e=>{const t=e.clone();return t.dateStr=Dt(e.datePublished,"long"),t})}}))}removeCheckedTiles(){this.dataSource.removeCheckedTiles()}userChangedSort(e){var t;const{selectedSort:i,sortDirection:o}=e.detail;this.selectedSort=i,this.sortDirection=o,((t=this.currentPage)!==null&&t!==void 0?t:1)>1&&this.goToPage(1),this.currentPage=1}sendSortByAnalytics(e){var t;const i=e&&!this.sortDirection;(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:this.searchContext,action:te.sortBy,label:`${this.selectedSort}${this.sortDirection||i?`-${this.sortDirection}`:""}`})}selectedSortChanged(){this.dataSource.updatePrefixFiltersForCurrentSort()}get sortParam(){var e;const t=ye[this.selectedSort];if(!(t!=null&&t.handledBySearchService))return null;const i=new URL(window.location.href).searchParams.get("sort"),o=(e=t.searchServiceKey)!==null&&e!==void 0?e:i==null?void 0:i.replace(/^-/,"");return this.sortDirection||(this.sortDirection="asc"),o?{field:o,direction:this.sortDirection}:null}get defaultSortParam(){var e;const t=(e=this.defaultSortDirection)!==null&&e!==void 0?e:"asc",i=ye[this.defaultSortField].searchServiceKey;return i?{field:i,direction:t}:null}displayModeChanged(e){var t;this.displayMode=e.detail.displayMode,this.displayMode&&((t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:this.searchContext,action:te.displayMode,label:this.displayMode}))}get titleQuery(){return this.selectedTitleFilter?`firstTitle:${this.selectedTitleFilter}`:void 0}get creatorQuery(){return this.selectedCreatorFilter?`firstCreator:${this.selectedCreatorFilter}`:void 0}sendFilterByTitleAnalytics(e){var t;if(!e&&!this.selectedTitleFilter)return;const i=e&&!this.selectedTitleFilter;(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:this.searchContext,action:te.filterByTitle,label:i?`clear-${e}`:`${e||"start"}-${this.selectedTitleFilter}`})}sendFilterByCreatorAnalytics(e){var t;if(!e&&!this.selectedCreatorFilter)return;const i=e&&!this.selectedCreatorFilter;(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:this.searchContext,action:te.filterByCreator,label:i?`clear-${e}`:`${e||"start"}-${this.selectedCreatorFilter}`})}titleLetterSelected(e){this.selectedCreatorFilter=null,this.selectedTitleFilter=e.detail.selectedLetter}creatorLetterSelected(e){this.selectedTitleFilter=null,this.selectedCreatorFilter=e.detail.selectedLetter}get mobileFacetsTemplate(){return aa.includes(this.profileElement)?b:c`
      <details id="mobile-filter-collapse" @toggle=${t=>{var i;const o=t.target;this.isResizeToMobile=!1,this.collapsibleFacetsVisible=o.open,(i=this.analyticsHandler)===null||i===void 0||i.sendEvent({category:this.searchContext,action:te.mobileFacetsToggled,label:o.open?"open":"closed"})}}>
        <summary>
          <span class="collapser-icon">${ra}</span>
          <h2>${M("Filters")}</h2>
          ${this.clearFiltersBtnTemplate(!0)}
        </summary>
        ${this.facetsTemplate}
      </details>
    `}get facetsTemplate(){if(aa.includes(this.profileElement))return b;if(this.facetLoadStrategy==="off")return c`
    ...
    `;return(this.facetLoadStrategy==="opt-in"||this.facetLoadStrategy==="opt-in-or-login"&&!this.loggedIn)&&!this.mobileView?c`
      ...
      `:e}clearFiltersBtnTemplate(e){if(!this.hasActiveFilters)return b;const t=Lt({"clear-filters-btn":!0,mobile:e}),i=e?"Clear all":"Clear all filters";return c`
    ...
    `}scrollThresholdReached(){!this.dataSource.endOfDataReached&&this.dataSource.queryInitialized&&(this.pagesToRender+=1,this.dataSource.fetchPage(this.pagesToRender))}static get styles(){return[Ze,v`
        :host {
          display: block;
  ...
  `;l([P()],se.prototype,"toggleSlots",void 0);l([P()],se.prototype,"currentPage",void 0);l([P()],se.prototype,"searchQuery",void 0);l([P()],se.prototype,"withinCollection",void 0);l([P()],se.prototype,"cellWidth",void 0);l([P()],se.prototype,"cellHeight",void 0);l([P()],se.prototype,"rowGap",void 0);l([P()],se.prototype,"colGap",void 0);l([P()],se.prototype,"suppressFacets",void 0);l([P()],se.prototype,"lazyLoadFacets",void 0);l([P()],se.prototype,"loggedIn",void 0);l([P()],se.prototype,"searchType",void 0);l([h({type:Object,reflect:!1})],se.prototype,"latestAction",void 0);l([Z("#base-query-field")],se.prototype,"baseQueryField",void 0);l([Z("#base-collection-field")],se.prototype,"baseCollectionField",void 0);l([Z("#page-number-input")],se.prototype,"pageNumberInput",void 0);l([Z("collection-browser")],se.prototype,"collectionBrowser",void 0);l([Z("modal-manager")],se.prototype,"modalManager",void 0);se=l([L("app-root")],se);
