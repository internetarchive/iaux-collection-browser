...
fill=""></path>
  ...
  `;pr=l([Hs("ia-icon-label")],pr);let ur=class extends F{constructor(){super(...arguments),this.numResults=0}render(){return c`
    ...
    `}};l([h({type:Number})],ur.prototype,"numResults",void 0);ur=l([D("alpha-bar-tooltip")],ur);let We=class extends F{constructor(){super(...arguments),this.selectedLetter=null,this.tooltipShown=!1,this.alphabet="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("")}get selectedUppercaseLetter(){var e;return(e=this.selectedLetter)===null||e===void 0?void 0:e.toUpperCase()}render(){var e;return c`
  ...
  `;l([h({type:String})],We.prototype,"selectedLetter",void 0);l([h({type:Object})],We.prototype,"letterCounts",void 0);l([h({type:String})],We.prototype,"ariaLandmarkLabel",void 0);l([P()],We.prototype,"tooltipShown",void 0);l([P()],We.prototype,"hoveredLetter",void 0);l([X("alpha-bar-tooltip")],We.prototype,"tooltip",void 0);We=l([D("alpha-bar")],We);const Cd=c`
...
`,mr;let ui=mr=class extends F{render(){return c`${this.facetRowTemplate}`}get facetRowTemplate(){var e,t,i,o;const{bucket:a,facetType:s}=this;if(!a||!s)return y;const n=`${s}:${a.key}-show-only`,d=`${s}:${a.key}-negative`,p=s!=="collection"?c`${(e=a.displayText)!==null&&e!==void 0?e:a.key}`:c`<a href="/details/${a.key}">
    ...
    `}scrollThresholdReached(){!this.dataSource.endOfDataReached&&this.dataSource.queryInitialized&&(this.pagesToRender+=1,this.dataSource.fetchPage(this.pagesToRender))}static get styles(){return[je,f`
        :host {
          display: block;
