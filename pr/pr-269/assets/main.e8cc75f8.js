...
`;let xo=class extends F{constructor(){super(...arguments),this.config=new wo}render(){return h`
    ...
    `}static get styles(){const e=m`var(--modalLogoSize, 6.5rem)`,t=m`var(--processingImageSize, 7.5rem)`,i=m`var(--modalCornerRadius, 1rem)`,o=m`var(--modalBorder, 2px solid black)`,r=m`var(--modalBottomMargin, 2.5rem)`,n=m`var(--modalTopMargin, 5rem)`,l=m`var(--modalHeaderBottomPadding, 0.5em)`,d=m`var(--modalBottomPadding, 2rem)`,u=m`var(--modalScrollOffset, 5px)`,v=m`var(--modalTitleFontSize, 1.8rem)`,f=m`var(--modalSubtitleFontSize, 1.4rem)`,g=m`var(--modalHeadlineFontSize, 1.6rem)`,x=m`var(--modalMessageFontSize, 1.4rem)`,C=m`var(--modalTitleLineHeight, normal)`,E=m`var(--modalSubtitleLineHeight, normal)`,L=m`var(--modalHeadlineLineHeight, normal)`,D=m`var(--modalMessageLineHeight, normal)`;return m`
      .processing-logo {
        margin: auto;
        width: ${t};
        height: ${t};
    ...
    `}};s([c({type:Object})],xo.prototype,"config",void 0);xo=s([A("modal-template")],xo);function tl(a,e,t){var i=t||{},o=i.noTrailing,r=o===void 0?!1:o,n=i.noLeading,l=n===void 0?!1:n,d=i.debounceMode,u=d===void 0?void 0:d,v,f=!1,g=0;function x(){v&&clearTimeout(v)}function C(L){var D=L||{},R=D.upcomingOnly,he=R===void 0?!1:R;x(),f=!he}function E(){for(var L=arguments.length,D=new Array(L),R=0;R<L;R++)D[R]=arguments[R];var he=this,q=Date.now()-g;if(f)return;function H(){g=Date.now(),e.apply(he,D)}function K(){v=void 0}!l&&u&&!v&&H(),x(),u===void 0&&q>a?l?(g=Date.now(),r||(v=setTimeout(u?K:H,a))):H():r!==!0&&(v=setTimeout(u?K:H,u===void 0?a-q:a))}return E.cancel=C,E}var vt;(function(a){a.Open="open",a.Closed="closed"})(vt||(vt={}));class il{constructor(e){this.windowResizeThrottler=tl(100,this.updateModalContainerHeight,{noLeading:!1,noTrailing:!1}).bind(this),this.modalManager=e}handleModeChange(e){switch(e){case vt.Open:this.startResizeListener(),this.stopDocumentScroll();break;case vt.Closed:this.stopResizeListener(),this.resumeDocumentScroll();break}}updateModalContainerHeight(){this.modalManager.style.setProperty("--containerHeight",`${window.innerHeight}px`)}stopDocumentScroll(){document.body.classList.add("modal-manager-open")}resumeDocumentScroll(){document.body.classList.remove("modal-manager-open")}startResizeListener(){window.addEventListener("resize",this.windowResizeThrottler)}stopResizeListener(){window.removeEventListener("resize",this.windowResizeThrottler)}}let Lt=class extends F{constructor(){super(...arguments),this.mode=vt.Closed,this.hostBridge=new il(this),this.closeOnBackdropClick=!0}render(){return h`
      <div class="container">
      ...
      <div class="facets-on-${this.renderOn}">
        ${or(t,i=>`${e.key}:${i.key}`,i=>{var o,r;const n=`${e.key}:${i.key}-show-only`,l=`${e.key}:${i.key}-negative`,d=e.key!=="collection"?h`${(o=i.displayText)!==null&&o!==void 0?o:i.key}`:h`<a href="${this.collectionPagePath}${i.key}">
                    <async-collection-name
                      ...
                      placeholder="-"
                    ></async-collection-name>
                  </a> `,u=i.state==="hidden",v=i.state==="selected",f=`${e.key}: ${(r=i.displayText)!==null&&r!==void 0?r:i.key}`,g=v?`Show all ${e.key}s`:`Only show ${f}`,x=`Hide ${f}`,C=`Unhide ${f}`,E=u?C:x,L=`${f}, ${i.count} results`;return h`
              <div class="facet-row">
