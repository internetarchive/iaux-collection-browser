...
`,ka;let Lt=ka=class extends A{render(){return h`${this.facetRowTemplate}`}get facetRowTemplate(){var e,t;const{bucket:i,facetType:a}=this;if(!i||!a)return y;const r=`${a}:${i.key}-show-only`,n=`${a}:${i.key}-negative`,l=a!=="collection"?h`${(e=i.displayText)!==null&&e!==void 0?e:i.key}`:h`<a href="/details/${i.key}">
    ...
    `}};s([c({type:String})],Lt.prototype,"facetType",void 0);s([c({type:Object})],Lt.prototype,"bucket",void 0);s([c({type:Object})],Lt.prototype,"collectionNameCache",void 0);Lt=ka=s([L("facet-row")],Lt);let Pt=class extends A{facetClicked(e){const{bucket:t,negative:i}=e.detail;t.state==="none"?this.facetUnchecked(t):this.facetChecked(t,i),this.dispatchFacetClickEvent(e.detail)}facetChecked(e,t){const{facetGroup:i,selectedFacets:a}=this;if(!i)return;let r;a?r=Y({},a):r=ti(),r[i.key][e.key]=pe(Y({},e),{state:Lt.getFacetState(!0,t)}),this.selectedFacets=r,this.dispatchSelectedFacetsChanged()}facetUnchecked(e){const{facetGroup:t,selectedFacets:i}=this;if(!t)return;let a;i?a=Y({},i):a=ti(),delete a[t.key][e.key],this.selectedFacets=a,this.dispatchSelectedFacetsChanged()}dispatchFacetClickEvent(e){const t=new CustomEvent("facetClick",{detail:e,composed:!0});this.dispatchEvent(t)}dispatchSelectedFacetsChanged(){const e=new CustomEvent("selectedFacetsChanged",{detail:this.selectedFacets,bubbles:!0,composed:!0});this.dispatchEvent(e)}get facetsTemplate(){const{facetGroup:e}=this;if(!e)return y;let t=e.buckets;return t=[...t.filter(i=>i.state==="selected").sort((i,a)=>i.count<a.count?1:-1),...t.filter(i=>i.state==="hidden").sort((i,a)=>i.count<a.count?1:-1),...t.filter(i=>i.state==="none")],h`
