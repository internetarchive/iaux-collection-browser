 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Ei;const ut=globalThis.trustedTypes,Hr=ut?ut.createPolicy("lit-html",{createHTML:a=>a}):void 0,xe=`lit$${(Math.random()+"").slice(9)}$`,lr="?"+xe,Ps=`<${lr}>`,pt=document,zt=(a="")=>pt.createComment(a),Pt=a=>a===null||typeof a!="object"&&typeof a!="function",ka=Array.isArray,Ta=a=>{var e;return ka(a)||typeof((e=a)===null||e===void 0?void 0:e[Symbol.iterator])=="function"},Mt=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Vr=/-->/g,Wr=/>/g,Be=/>|[ 	\n\r](?:([^\s"'>=/]+)([ 	\n\r]*=[ 	\n\r]*(?:[^ 	\n\r"'`<>=]|("|')|))|$)/g,jr=/'/g,Qr=/"/g,Da=/^(?:script|style|textarea|title)$/i,Ma=a=>(e,...t)=>({_$litType$:a,strings:e,values:t}),m=Ma(1),L=Ma(2),ce=Symbol.for("lit-noChange"),_=Symbol.for("lit-nothing"),Gr=new WeakMap,Jt=(a,e,t)=>{var i,r;const s=(i=t==null?void 0:t.renderBefore)!==null&&i!==void 0?i:e;let o=s._$litPart$;if(o===void 0){const l=(r=t==null?void 0:t.renderBefore)!==null&&r!==void 0?r:null;s._$litPart$=o=new bt(e.insertBefore(zt(),l),l,void 0,t!=null?t:{})}return o._$AI(a),o},ct=pt.createTreeWalker(pt,129,null,!1),Aa=(a,e)=>{const t=a.length-1,i=[];let r,s=e===2?"<svg>":"",o=Mt;for(let d=0;d<t;d++){const h=a[d];let u,v,f=-1,y=0;for(;y<h.length&&(o.lastIndex=y,v=o.exec(h),v!==null);)y=o.lastIndex,o===Mt?v[1]==="!--"?o=Vr:v[1]!==void 0?o=Wr:v[2]!==void 0?(Da.test(v[2])&&(r=RegExp("</"+v[2],"g")),o=Be):v[3]!==void 0&&(o=Be):o===Be?v[0]===">"?(o=r!=null?r:Mt,f=-1):v[1]===void 0?f=-2:(f=o.lastIndex-v[2].length,u=v[1],o=v[3]===void 0?Be:v[3]==='"'?Qr:jr):o===Qr||o===jr?o=Be:o===Vr||o===Wr?o=Mt:(o=Be,r=void 0);const $=o===Be&&a[d+1].startsWith("/>")?" ":"";s+=o===Mt?h+Ps:f>=0?(i.push(u),h.slice(0,f)+"$lit$"+h.slice(f)+xe+$):h+xe+(f===-2?(i.push(void 0),d):$)}const l=s+(a[t]||"<?>")+(e===2?"</svg>":"");if(!Array.isArray(a)||!a.hasOwnProperty("raw"))throw Error("invalid template strings array");return[Hr!==void 0?Hr.createHTML(l):l,i]};class Bt{constructor({strings:e,_$litType$:t},i){let r;this.parts=[];let s=0,o=0;const l=e.length-1,d=this.parts,[h,u]=Aa(e,t);if(this.el=Bt.createElement(h,i),ct.currentNode=this.el.content,t===2){const v=this.el.content,f=v.firstChild;f.remove(),v.append(...f.childNodes)}for(;(r=ct.nextNode())!==null&&d.length<l;){if(r.nodeType===1){if(r.hasAttributes()){const v=[];for(const f of r.getAttributeNames())if(f.endsWith("$lit$")||f.startsWith(xe)){const y=u[o++];if(v.push(f),y!==void 0){const $=r.getAttribute(y.toLowerCase()+"$lit$").split(xe),k=/([.?@])?(.*)/.exec(y);d.push({type:1,index:s,name:k[2],strings:$,ctor:k[1]==="."?Oa:k[1]==="?"?La:k[1]==="@"?Fa:Vt})}else d.push({type:6,index:s})}for(const f of v)r.removeAttribute(f)}if(Da.test(r.tagName)){const v=r.textContent.split(xe),f=v.length-1;if(f>0){r.textContent=ut?ut.emptyScript:"";for(let y=0;y<f;y++)r.append(v[y],zt()),ct.nextNode(),d.push({type:2,index:++s});r.append(v[f],zt())}}}else if(r.nodeType===8)if(r.data===lr)d.push({type:2,index:s});else{let v=-1;for(;(v=r.data.indexOf(xe,v+1))!==-1;)d.push({type:7,index:s}),v+=xe.length-1}s++}}static createElement(e,t){const i=pt.createElement("template");return i.innerHTML=e,i}}function Ge(a,e,t=a,i){var r,s,o,l;if(e===ce)return e;let d=i!==void 0?(r=t._$Cl)===null||r===void 0?void 0:r[i]:t._$Cu;const h=Pt(e)?void 0:e._$litDirective$;return(d==null?void 0:d.constructor)!==h&&((s=d==null?void 0:d._$AO)===null||s===void 0||s.call(d,!1),h===void 0?d=void 0:(d=new h(a),d._$AT(a,t,i)),i!==void 0?((o=(l=t)._$Cl)!==null&&o!==void 0?o:l._$Cl=[])[i]=d:t._$Cu=d),d!==void 0&&(e=Ge(a,d._$AS(a,e.values),d,i)),e}class Ea{constructor(e,t){this.v=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}p(e){var t;const{el:{content:i},parts:r}=this._$AD,s=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:pt).importNode(i,!0);ct.currentNode=s;let o=ct.nextNode(),l=0,d=0,h=r[0];for(;h!==void 0;){if(l===h.index){let u;h.type===2?u=new bt(o,o.nextSibling,this,e):h.type===1?u=new h.ctor(o,h.name,h.strings,this,e):h.type===6&&(u=new Ra(o,this,e)),this.v.push(u),h=r[++d]}l!==(h==null?void 0:h.index)&&(o=ct.nextNode(),l++)}return s}m(e){let t=0;for(const i of this.v)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class bt{constructor(e,t,i,r){var s;this.type=2,this._$AH=_,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=r,this._$Cg=(s=r==null?void 0:r.isConnected)===null||s===void 0||s}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cg}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&e.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Ge(this,e,t),Pt(e)?e===_||e==null||e===""?(this._$AH!==_&&this._$AR(),this._$AH=_):e!==this._$AH&&e!==ce&&this.$(e):e._$litType$!==void 0?this.T(e):e.nodeType!==void 0?this.k(e):Ta(e)?this.S(e):this.$(e)}M(e,t=this._$AB){return this._$AA.parentNode.insertBefore(e,t)}k(e){this._$AH!==e&&(this._$AR(),this._$AH=this.M(e))}$(e){this._$AH!==_&&Pt(this._$AH)?this._$AA.nextSibling.data=e:this.k(pt.createTextNode(e)),this._$AH=e}T(e){var t;const{values:i,_$litType$:r}=e,s=typeof r=="number"?this._$AC(e):(r.el===void 0&&(r.el=Bt.createElement(r.h,this.options)),r);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===s)this._$AH.m(i);else{const o=new Ea(s,this),l=o.p(this.options);o.m(i),this.k(l),this._$AH=o}}_$AC(e){let t=Gr.get(e.strings);return t===void 0&&Gr.set(e.strings,t=new Bt(e)),t}S(e){ka(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,r=0;for(const s of e)r===t.length?t.push(i=new bt(this.M(zt()),this.M(zt()),this,this.options)):i=t[r],i._$AI(s),r++;r<t.length&&(this._$AR(i&&i._$AB.nextSibling,r),t.length=r)}_$AR(e=this._$AA.nextSibling,t){var i;for((i=this._$AP)===null||i===void 0||i.call(this,!1,!0,t);e&&e!==this._$AB;){const r=e.nextSibling;e.remove(),e=r}}setConnected(e){var t;this._$AM===void 0&&(this._$Cg=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}}class Vt{constructor(e,t,i,r,s){this.type=1,this._$AH=_,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=s,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=_}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,i,r){const s=this.strings;let o=!1;if(s===void 0)e=Ge(this,e,t,0),o=!Pt(e)||e!==this._$AH&&e!==ce,o&&(this._$AH=e);else{const l=e;let d,h;for(e=s[0],d=0;d<s.length-1;d++)h=Ge(this,l[i+d],t,d),h===ce&&(h=this._$AH[d]),o||(o=!Pt(h)||h!==this._$AH[d]),h===_?e=_:e!==_&&(e+=(h!=null?h:"")+s[d+1]),this._$AH[d]=h}o&&!r&&this.C(e)}C(e){e===_?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e!=null?e:"")}}class Oa extends Vt{constructor(){super(...arguments),this.type=3}C(e){this.element[this.name]=e===_?void 0:e}}const Bs=ut?ut.emptyScript:"";class La extends Vt{constructor(){super(...arguments),this.type=4}C(e){e&&e!==_?this.element.setAttribute(this.name,Bs):this.element.removeAttribute(this.name)}}class Fa extends Vt{constructor(e,t,i,r,s){super(e,t,i,r,s),this.type=5}_$AI(e,t=this){var i;if((e=(i=Ge(this,e,t,0))!==null&&i!==void 0?i:_)===ce)return;const r=this._$AH,s=e===_&&r!==_||e.capture!==r.capture||e.once!==r.once||e.passive!==r.passive,o=e!==_&&(r===_||s);s&&this.element.removeEventListener(this.name,this,r),o&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,i;typeof this._$AH=="function"?this._$AH.call((i=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&i!==void 0?i:this.element,e):this._$AH.handleEvent(e)}}class Ra{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){Ge(this,e)}}const Us={L:"$lit$",P:xe,V:lr,I:1,N:Aa,R:Ea,j:Ta,D:Ge,H:bt,F:Vt,O:La,W:Fa,B:Oa,Z:Ra},Yr=window.litHtmlPolyfillSupport;Yr==null||Yr(Bt,bt),((Ei=globalThis.litHtmlVersions)!==null&&Ei!==void 0?Ei:globalThis.litHtmlVersions=[]).push("2.2.4");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const qs=(a,...e)=>({strTag:!0,strings:a,values:e}),at=qs,Xs=a=>typeof a!="string"&&"strTag"in a,Zs=(a,e,t)=>{let i=a[0];for(let r=1;r<a.length;r++)i+=e[t?t[r-1]:r-1],i+=a[r];return i};/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;let Xi=class extends B{render(){var e,t,i;return m`
    ...
    `}};n([p({type:Object})],Xi.prototype,"model",void 0);Xi=n([G("collection-tile")],Xi);function io(a,e){let t=1;return a>=1e9?t=1e9:a>=1e6?t=1e6:a>=1e3&&e==="short"&&(t=1e3),t}function ro(a=0,e){const t=a/e,i=t<10;let r=0;return i?r=Math.round((t+Number.EPSILON)*10)/10:r=Math.round(t),r}function ao(a,e,t,i){switch(e){case 1e9:return Ve(t==="short"?at`${a}B`:at`${a} billion`);case 1e6:return Ve(t==="short"?at`${a}M`:at`${a} million`);case 1e3:return Ve(t==="short"?at`${a}K`:at`${a} thousand`);default:return new Intl.NumberFormat(i).format(a)}}function Ft(a,e="long",t="short",i="en-US"){const r=a!=null?a:-1;if(r<0)return"";const s=io(r,e),o=ro(r,s);return ao(o,s,t,i)}const Ba=L`
...
`;let Ce=class extends B{constructor(){super(...arguments),this.isListTile=!1,this.isCompactTile=!1,this.loggedIn=!1,this.isWaveform=!1}render(){return m`
    ...
    `}get imageSrc(){var e;return`${this.baseImageUrl}/services/img/${(e=this.model)===null||e===void 0?void 0:e.identifier}`}get hashBasedGradient(){var e;return!((e=this.model)===null||e===void 0)&&e.identifier?`waveform-grad${this.hashStrToInt(this.model.identifier)%6}`:"waveform-grad0"}hashStrToInt(e){return e.split("").reduce((t,i)=>t+i.charCodeAt(0),0)}get itemBaseClass(){return{"drop-shadow":!0,"list-box":this.isListTile,[this.hashBasedGradient]:this.isWaveform}}get itemImageClass(){var e;return{contain:!this.isCompactTile&&!this.isWaveform,cover:this.isCompactTile,blur:((e=this.model)===null||e===void 0?void 0:e.contentWarning)||!1,waveform:this.isWaveform}}onLoad(){var e,t;(((e=this.model)===null||e===void 0?void 0:e.mediatype)==="audio"||((t=this.model)===null||t===void 0?void 0:t.mediatype)==="etree")&&this.baseImage.naturalWidth/this.baseImage.naturalHeight===4&&(this.isWaveform=!0)}static get styles(){return[yo,wo,b`
      ...
      `]}};n([p({type:Object})],Ce.prototype,"model",void 0);n([p({type:String})],Ce.prototype,"baseImageUrl",void 0);n([p({type:Boolean})],Ce.prototype,"isListTile",void 0);n([p({type:Boolean})],Ce.prototype,"isCompactTile",void 0);n([p({type:Boolean})],Ce.prototype,"loggedIn",void 0);n([D()],Ce.prototype,"isWaveform",void 0);n([le("img")],Ce.prototype,"baseImage",void 0);Ce=n([G("item-image")],Ce);let oi=class extends B{render(){var e,t,i,r,s,o,l;const d=((e=this.model)===null||e===void 0?void 0:e.title)||_,h=(t=this.model)===null||t===void 0?void 0:t.creator;return m`
      <div id="container">
...
`+Z),Ze&&(Z=De(Z,Re," "),Z=De(Z,Ie," ")),N&&jt?N.createHTML(Z):Z},e.setConfig=function(C){Ci(C),fi=!0},e.clearConfig=function(){rt=null,fi=!1},e.isValidAttribute=function(C,c,g){rt||Ci({});var S=Pe(C),I=Pe(c);return Ar(S,I,g)},e.addHook=function(C,c){typeof c=="function"&&(te[C]=te[C]||[],Et(te[C],c))},e.removeHook=function(C){if(te[C])return ia(te[C])},e.removeHooks=function(C){te[C]&&(te[C]=[])},e.removeAllHooks=function(){te={}},e}var Rt=Va();function Wa(a){switch(a){case"date":return"Published";case"reviewdate":return"Reviewed";case"addeddate":return"Added";default:return"Archived"}}function ja(a){return a?`Archivist since ${a.getFullYear()}`:""}function ir(a,e="short",t="en-US"){if(!a)return"";const i={timeZone:"UTC"};switch(e){case"short":i.month="short",i.year="numeric";break;case"long":i.year="numeric",i.month="short",i.day="2-digit";break}return new Intl.DateTimeFormat(t,i).format(a)}let ve=class extends B{constructor(){super(...arguments),this.sortParam=null,this.collectionLinks=[]}updated(e){e.has("model")&&this.fetchCollectionNames()}async fetchCollectionNames(){var e,t;if(!(!((e=this.model)===null||e===void 0)&&e.collections)||this.model.collections.length===0||!this.collectionNameCache)return;this.collectionLinks=[];const i=[],r=[];for(const s of this.model.collections)r.push((t=this.collectionNameCache)===null||t===void 0?void 0:t.collectionNameFor(s).then(o=>{i.push(this.detailsLink(s,o!=null?o:s))}));await Promise.all(r),this.collectionLinks=i}render(){return m`
    ...
    `}get mobileTemplate(){var e;return m`
      <div id="list-line-top">
        <div id="list-line-left">
          <div id="thumb" class="${ht((e=this.model)===null||e===void 0?void 0:e.mediatype)}">
            ${this.imgTemplate}
          </div>
        </div>
    ...
    `}get linkTileTemplate(){var e,t;return m`
      <a
        ...
        title=${ht((t=this.model)===null||t===void 0?void 0:t.title)}
      >
        ${this.tile}
      </a>
