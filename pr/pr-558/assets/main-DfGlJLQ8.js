...
`;function a3(i,e){let t=1;return i>=1e9?t=1e9:i>=1e6?t=1e6:i>=1e3&&e==="short"&&(t=1e3),t}function n3(i=0,e){const t=i/e,s=t<10;let r=0;return s?r=Math.round((t+Number.EPSILON)*10)/10:r=Math.round(t),r}function l3(i,e,t,s){switch(e){case 1e9:return S(t==="short"?Ct`${i}B`:Ct`${i} billion`);case 1e6:return S(t==="short"?Ct`${i}M`:Ct`${i} million`);case 1e3:return S(t==="short"?Ct`${i}K`:Ct`${i} thousand`);default:return new Intl.NumberFormat(s).format(i)}}function zl(i,e="long",t="short",s="en-US"){const r=i??-1;if(r<0)return"";const o=a3(r,e),a=n3(r,o);return l3(a,o,t,s)}var c3=Object.defineProperty,h3=Object.getOwnPropertyDescriptor,Et=(i,e,t,s)=>{for(var r=s>1?void 0:s?h3(e,t):e,o=i.length-1,a;o>=0;o--)(a=i[o])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&c3(e,t,r),r};let gt=class extends H{constructor(){super(...arguments),this.showTvClips=!1}render(){return m`
