 ...
 */const br=(r,e,t)=>{const i=new Map;for(let a=e;a<=t;a++)i.set(r[a],a);return i},lo=La(class extends Fa{constructor(r){if(super(r),r.type!==Fe.CHILD)throw Error("repeat() can only be used in text expressions")}dt(r,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);const a=[],o=[];let n=0;for(const l of r)a[n]=i?i(l,n):n,o[n]=t(l,n),n++;return{values:o,keys:a}}render(r,e,t){return this.dt(r,e,t).values}update(r,[e,t,i]){var a;const o=bs(r),{values:n,keys:l}=this.dt(e,t,i);if(!Array.isArray(o))return this.ut=l,n;const d=(a=this.ut)!==null&&a!==void 0?a:this.ut=[],c=[];let m,v,f=0,w=o.length-1,x=0,$=n.length-1;for(;f<=w&&x<=$;)if(o[f]===null)f++;else if(o[w]===null)w--;else if(d[f]===l[x])c[x]=Ke(o[f],n[x]),f++,x++;else if(d[w]===l[$])c[$]=Ke(o[w],n[$]),w--,$--;else if(d[f]===l[$])c[$]=Ke(o[f],n[$]),Qt(r,c[$+1],o[f]),f++,$--;else if(d[w]===l[x])c[x]=Ke(o[w],n[x]),Qt(r,o[f],o[w]),w--,x++;else if(m===void 0&&(m=br(l,x,$),v=br(d,f,w)),m.has(d[f]))if(m.has(d[w])){const E=v.get(l[x]),A=E!==void 0?o[E]:null;if(A===null){const F=Qt(r,o[f]);Ke(F,n[x]),c[x]=F}else c[x]=Ke(A,n[x]),Qt(r,o[f],A),o[E]=null;x++}else ta(o[w]),w--;else ta(o[f]),f++;for(;x<=$;){const E=Qt(r,c[$+1]);Ke(E,n[x]),c[x++]=E}for(;f<=w;){const E=o[f++];E!==null&&ta(E)}return this.ut=l,no(r,c),ge}});function hi(r,e,t){return Array.from({length:(e-r)/t+1},(i,a)=>r+a*t)}let Re=class extends O{constructor(){super(...arguments),this.itemCount=0,this.scrollOptimizationsDisabled=!1,this.intersectionObserver=new IntersectionObserver(e=>{e.forEach(t=>{if(t.target===this.sentinel){t.isIntersecting&&this.dispatchEvent(new Event("scrollThresholdReached"));return}const a=t.target.dataset.cellIndex;if(!a)return;const o=parseInt(a,10);t.isIntersecting?this.visibleCellIndices.add(o):this.visibleCellIndices.delete(o)}),this.scrollOptimizationsDisabled||this.processVisibleCells()}),this.renderedCellIndices=new Set,this.visibleCellIndices=new Set,this.placeholderCellIndices=new Set}reload(){hi(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.removeCell(t)),this.renderedCellIndices.clear(),this.visibleCellIndices.clear(),this.placeholderCellIndices.clear(),this.setupObservations()}scrollToCell(e,t){const i=this.cellContainers[e];if(!i)return!1;const a=t?"smooth":"auto";return i.scrollIntoView({behavior:a}),!0}getVisibleCellIndices(){return Array.from(this.visibleCellIndices)}updated(e){(e.has("itemCount")||e.has("scrollOptimizationsDisabled"))&&this.setupObservations()}disconnectedCallback(){this.intersectionObserver.disconnect()}setupObservations(){this.setupIntersectionObserver()}setupIntersectionObserver(){this.intersectionObserver.disconnect(),this.sentinel&&this.intersectionObserver.observe(this.sentinel),this.scrollOptimizationsDisabled?(hi(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.visibleCellIndices.add(t)),this.processVisibleCells()):this.cellContainers.forEach(e=>this.intersectionObserver.observe(e))}render(){const e=this.itemCount-1,t=hi(0,e,1);return p`
    ...
    `}};s([u({type:Number})],Re.prototype,"itemCount",void 0);s([u({type:Object})],Re.prototype,"cellProvider",void 0);s([u({type:Object})],Re.prototype,"placeholderCellTemplate",void 0);s([u({type:Boolean})],Re.prototype,"scrollOptimizationsDisabled",void 0);s([he("#sentinel")],Re.prototype,"sentinel",void 0);s([ps(".cell-container")],Re.prototype,"cellContainers",void 0);Re=s([R("infinite-scroller")],Re);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;let ga=class extends O{render(){var e,t,i;return p`
    ...
    `}};s([u({type:Object})],ga.prototype,"model",void 0);ga=s([R("collection-tile")],ga);function Si(r,e="short",t="en-US"){if(!r)return"";const i={timeZone:"UTC"};switch(e){case"short":i.month="short",i.year="numeric";break;case"long":i.year="numeric",i.month="short",i.day="2-digit";break}return new Intl.DateTimeFormat(t,i).format(r)}/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;let $i=class extends O{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1}render(){return this.loginRequired&&!this.loggedIn?p`${Ts}`:p`${ks}`}static get styles(){return y`
    ...
    `}};s([u({type:Boolean})],$i.prototype,"loggedIn",void 0);s([u({type:Boolean})],$i.prototype,"loginRequired",void 0);$i=s([R("icon-overlay")],$i);let Ci=class extends O{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1}render(){return p` <div class="overlay no-preview">${this.textDisplay}</div> `}get textDisplay(){return this.loginRequired&&!this.loggedIn?`Log in
 ...
 */function*fi(r,e){const t=typeof e=="function";if(r!==void 0){let i=-1;for(const a of r)i>-1&&(yield t?e(i):e),i++,yield a}}let ki=class extends O{constructor(){super(...arguments),this.snippets=[],this.viewSize="desktop"}render(){var e;return!((e=this.snippets)===null||e===void 0)&&e.length?p`
    ...
    `}};s([u({type:Array})],ki.prototype,"snippets",void 0);s([u({type:String})],ki.prototype,"viewSize",void 0);ki=s([R("text-snippet-block")],ki);const zs=y`
  .drop-shadow {
...
`,Hs={account:{color:"#000000",icon:Es,text:"Account"},audio:{color:"#00adef",icon:As,text:"Audio"},collection:{color:"#4666ff",icon:co,text:"Collection"},data:{color:"#333333",icon:Ds,text:"Data"},etree:{color:"#00adef",icon:Ls,text:"E-tree"},film:{color:"#bf1b2c",icon:wr,text:"Film"},image:{color:"#aa99c9",icon:Fs,text:"Image"},movies:{color:"#f1644b",icon:wr,text:"Movie"},radio:{color:"#8fdaef",icon:Os,text:"Radio"},software:{color:"#9ecc4f",icon:Is,text:"Software"},texts:{color:"#faab3c",icon:Ps,text:"Text"},tv:{color:"#f1644b",icon:Ns,text:"TV"},video:{color:"#f1644b",icon:Rs,text:"Video"},web:{color:"#ffcd27",icon:Bs,text:"Web"}};let ri=class extends O{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var e,t;const i=["tvnews","tvarchive","television"],a=["radio","radioprogram"];return this.mediatype==="movies"&&((e=this.collections)===null||e===void 0?void 0:e.some(o=>i.indexOf(o)>=0))?"tv":this.mediatype==="audio"&&((t=this.collections)===null||t===void 0?void 0:t.some(o=>a.indexOf(o)>=0))?"radio":this.mediatype||""}render(){const e=Hs[this.displayMediatype];return e?p`
      <div
        id="icon"
    ...
    `}};s([u({type:String})],ri.prototype,"mediatype",void 0);s([u({type:Array})],ri.prototype,"collections",void 0);s([u({type:Boolean})],ri.prototype,"showText",void 0);ri=s([R("mediatype-icon")],ri);const Us=I`
...
`;function Gs(r,e){let t=1;return r>=1e9?t=1e9:r>=1e6?t=1e6:r>=1e3&&e==="short"&&(t=1e3),t}function Qs(r=0,e){const t=r/e,i=t<10;let a=0;return i?a=Math.round((t+Number.EPSILON)*10)/10:a=Math.round(t),a}function Ys(r,e,t,i){switch(e){case 1e9:return Ze(t==="short"?gt`${r}B`:gt`${r} billion`);case 1e6:return Ze(t==="short"?gt`${r}M`:gt`${r} million`);case 1e3:return Ze(t==="short"?gt`${r}K`:gt`${r} thousand`);default:return new Intl.NumberFormat(i).format(r)}}function Xt(r,e="long",t="short",i="en-US"){const a=r!=null?r:-1;if(a<0)return"";const o=Gs(a,e),n=Qs(a,o);return Ys(n,o,t,i)}let rt=class extends O{render(){const e=Xt(this.favCount,"short","short"),t=Xt(this.commentCount,"short","short"),i=this.mediatype==="account"?`${this.itemCount} uploads`:`${this.viewCount} all-time views`;return p`
    ...
    `}};s([u({type:String})],zt.prototype,"baseImageUrl",void 0);s([u({type:Boolean})],zt.prototype,"loggedIn",void 0);s([u({type:Object})],zt.prototype,"model",void 0);s([u({type:Object})],zt.prototype,"sortParam",void 0);zt=s([R("item-tile")],zt);let ba=class extends O{render(){var e,t,i,a,o,n,l,d;return p`
    ...
    `}};s([u({type:Object})],ba.prototype,"model",void 0);ba=s([R("account-tile")],ba);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`+ne),ct&&(ne=Le(ne,He," "),ne=Le(ne,Ue," ")),B&&ni?B.createHTML(ne):ne},e.setConfig=function(C){Wi(C),Pi=!0},e.clearConfig=function(){vt=null,Pi=!1},e.isValidAttribute=function(C,h,b){vt||Wi({});var S=Qe(C),H=Qe(h);return Ja(S,H,b)},e.addHook=function(C,h){typeof h=="function"&&(ue[C]=ue[C]||[],Yt(ue[C],h))},e.removeHook=function(C){if(ue[C])return _r(ue[C])},e.removeHooks=function(C){ue[C]&&(ue[C]=[])},e.removeAllHooks=function(){ue={}},e}var Zt=uo(),L;(function(r){r.relevance="relevance",r.alltimeview="alltimeview",r.weeklyview="weeklyview",r.title="title",r.datearchived="datearchived",r.date="date",r.datereviewed="datereviewed",r.dateadded="dateadded",r.creator="creator"})(L||(L={}));const Xe={relevance:"Relevance",alltimeview:"All-time Views",weeklyview:"Weekly Views",title:"Title",datearchived:"Date Archived",date:"Date Published",datereviewed:"Date Reviewed",dateadded:"Date Added",creator:"Creator"},Sn={relevance:null,alltimeview:"downloads",weeklyview:"week",title:"titleSorter",datearchived:"publicdate",date:"date",datereviewed:"reviewdate",dateadded:"addeddate",creator:"creatorSorter"},Tr={week:L.weeklyview,downloads:L.alltimeview,titleSorter:L.title,date:L.date,publicdate:L.datearchived,reviewdate:L.datereviewed,addeddate:L.dateadded,creatorSorter:L.creator},zi={subject:{},lending:{},mediatype:{},language:{},creator:{},collection:{},year:{}},$n=["mediatype","lending","year","subject","collection","creator","language"],Mi={subject:"Subject",lending:"Availability",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"},Cn={is_lendable:!0,is_borrowable:!1,available_to_borrow:!0,is_browsable:!1,available_to_browse:!1,is_readable:!0,available_to_waitlist:!1},zr={is_lendable:"Lending Library",available_to_borrow:"Borrow 14 Days",is_readable:"Always Available"},Oa={deemphasize:!0,community:!0,stream_only:!0,samples_only:!0,test_collection:!0,printdisabled:!0,"openlibrary-ol":!0,nationalemergencylibrary:!0,china:!0,americana:!0,toronto:!0};function po(r){switch(r){case"date":return"Published";case"reviewdate":return"Reviewed";case"addeddate":return"Added";default:return"Archived"}}function mo(r){return r?`Archivist since ${r.getFullYear()}`:""}let ye=class extends O{constructor(){super(...arguments),this.sortParam=null,this.collectionLinks=[],this.loggedIn=!1}updated(e){e.has("model")&&this.fetchCollectionNames()}async fetchCollectionNames(){var e,t;if(!(!((e=this.model)===null||e===void 0)&&e.collections)||this.model.collections.length===0||!this.collectionNameCache)return;this.collectionLinks=[];const i=[],a=[];for(const o of this.model.collections)Oa[o]||a.push((t=this.collectionNameCache)===null||t===void 0?void 0:t.collectionNameFor(o).then(n=>{i.push(this.detailsLink(o,n!=null?n:o))}));await Promise.all(a),this.collectionLinks=i}render(){return p`
    ...
    `}};Mr=s([R("collection-browser-loading-tile")],Mr);let Ei=class extends O{constructor(){super(...arguments),this.selectedLetter=null,this.alphabet="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("")}get selectedUppercaseLetter(){var e;return(e=this.selectedLetter)===null||e===void 0?void 0:e.toUpperCase()}render(){return p`
      <div id="container">
        <ul>
  ...
  `;s([u({type:String})],Ei.prototype,"selectedLetter",void 0);Ei=s([R("alpha-bar")],Ei);const Er=I`
...
`;let Dt=class extends O{constructor(){super(...arguments),this.step=2,this.currentPage=1,this.pages=[]}firstUpdated(){this.observePageCount()}updated(e){e.has("size")&&this.observePageCount(),e.has("currentPage")&&(this.observePageCount(),this.emitPageClick())}observePageCount(){this.pages=[];const e=7,t=this.size<=e;if(this.size<=5){this.pages=[...Array(this.size).keys()].map(o=>o+1);return}if(this.size===e){if(this.currentPage===2){this.pages=[1,2,3,4,0,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,4,5,this.size-1,this.size];return}}if(this.currentPage===1){this.pages=[1,2,3,0,this.size];return}if(this.currentPage===this.size){this.pages=[1,0,this.size-2,this.size-1,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,this.size-3,this.size-2,this.size-1,this.size];return}if(t&&this.currentPage>1&&this.currentPage<e){this.pages=[...Array(this.size).keys()].map(o=>o+1);return}let i=this.currentPage-this.step,a=this.currentPage+this.step;i<=0&&(a+=-i+1,i=1),a>=this.size&&(i=Math.max(i-(a-this.size),1),a=this.size),i===2&&(a-=1),a===this.size-1&&(i+=1),this.createFirstNode(i),this.createMiddelNode(i,a),this.createLastNode(a)}createFirstNode(e){var t,i;e>1&&((t=this.pages)===null||t===void 0||t.push(1)),e>2&&((i=this.pages)===null||i===void 0||i.push(0))}createMiddelNode(e,t){var i;for(let a=e;a<=t;a+=1)(i=this.pages)===null||i===void 0||i.push(a)}createLastNode(e){var t,i;e<this.size-1&&((t=this.pages)===null||t===void 0||t.push(0)),e<this.size&&((i=this.pages)===null||i===void 0||i.push(this.size))}get getEllipsisTemplate(){return p`<i class="ellipses">...</i>`}emitPageClick(){this.dispatchEvent(new CustomEvent("pageNumberClicked",{detail:{page:this.currentPage},bubbles:!0,composed:!0}))}onRewind(){this.currentPage-=1,this.currentPage<1&&(this.currentPage=1)}onForward(){this.currentPage+=1,this.currentPage>this.size&&(this.currentPage=this.size)}onChange(e){this.currentPage=e}getPageTemplate(e){return p`
    ...
    `}};s([u({type:Number})],Dt.prototype,"size",void 0);s([u({type:Number})],Dt.prototype,"step",void 0);s([u({type:Number})],Dt.prototype,"currentPage",void 0);s([z()],Dt.prototype,"pages",void 0);Dt=s([R("more-facets-pagination")],Dt);var Al=I`
...
`;let Lt=class extends O{facetClicked(e,t,i){const a=e.target,{checked:o,name:n,value:l}=a;o?this.facetChecked(n,l,t,i):this.facetUnchecked(n,l)}facetChecked(e,t,i,a){const{selectedFacets:o}=this;let n;o?n=fe({},o):n=zi,n[e][t]={state:a?"hidden":"selected",count:i},this.selectedFacets=n,this.dispatchSelectedFacetsChanged()}facetUnchecked(e,t){const{selectedFacets:i}=this;let a;i?a=fe({},i):a=zi,delete a[e][t],this.selectedFacets=a,this.dispatchSelectedFacetsChanged()}dispatchSelectedFacetsChanged(){const e=new CustomEvent("selectedFacetsChanged",{detail:this.selectedFacets,bubbles:!0,composed:!0});this.dispatchEvent(e)}getFacetsTemplate(e){let t=e==null?void 0:e.buckets;return t=[...t.filter(i=>i.state==="selected").sort((i,a)=>i.count<a.count?1:-1),...t.filter(i=>i.state==="hidden").sort((i,a)=>i.count<a.count?1:-1),...t.filter(i=>i.state==="none")],p`
    ...
    `}get loaderTemplate(){return p`<div class="facets-loader">
      ...
      ${this.facetsLoading?this.loaderTemplate:p`
          ...
          `}
    `}applySearchFacetsClicked(){var e,t;const i=new CustomEvent("facetsChanged",{detail:this.selectedFacets,bubbles:!0,composed:!0});this.dispatchEvent(i),(e=this.modalManager)===null||e===void 0||e.closeModal(),(t=this.analyticsHandler)===null||t===void 0||t.sendEventNoSampling({category:it.default,action:`${ie.applyMoreFacetsModal}`,label:`${this.facetKey}`})}cancelClick(){var e,t;(e=this.modalManager)===null||e===void 0||e.closeModal(),(t=this.analyticsHandler)===null||t===void 0||t.sendEventNoSampling({category:it.default,action:ie.closeMoreFacetsModal,label:`${this.facetKey}`})}static get styles(){const e=y`var(--primaryButtonBGColor, #194880)`;return y`
      @media (max-width: 560px) {
        section#more-facets {
          max-height: 450px;
        }
    ...
    `}moreFacetsSortingIcon(e){return e.key==="lending"?_:p`
      ...
      class="more-link"
      @click=${()=>{var t;this.showMoreFacetsModal(e,"count"),(t=this.analyticsHandler)===null||t===void 0||t.sendEventNoSampling({category:it.default,action:ie.showMoreFacetsModal,label:e.key}),this.dispatchEvent(new CustomEvent("showMoreFacets",{detail:e.key}))}}
    >
      More...
...
`;let Li=class extends O{constructor(){super(...arguments),this.placeholderType=null}render(){return this.placeholderType?p`${this.placeholderTemplate}`:_}get placeholderTemplate(){return p`
      ...
      >
        ${Nl(this.placeholderType,[["empty-query",()=>this.emptyQueryTemplate],["null-result",()=>this.nullResultTemplate]])}
      </div>
