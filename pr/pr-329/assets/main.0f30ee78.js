 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Sn=(a,e)=>e.kind==="method"&&e.descriptor&&!("value"in e.descriptor)?le(j({},e),{finisher(t){t.createProperty(e.key,a)}}):{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){typeof e.initializer=="function"&&(this[e.key]=e.initializer.call(this))},finisher(t){t.createProperty(e.key,a)}};function p(a){return(e,t)=>t!==void 0?((i,o,r)=>{o.constructor.createProperty(r,i)})(a,e,t):Sn(a,e)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Cn(a){return ds({descriptor:e=>({get(){var t,i;return(i=(t=this.renderRoot)===null||t===void 0?void 0:t.querySelectorAll(a))!==null&&i!==void 0?i:[]},enumerable:!0,configurable:!0})})}/**
 * @license
...
`,da;let jt=da=class extends O{render(){return h`${this.facetRowTemplate}`}get facetRowTemplate(){var e,t;const{bucket:i,facetType:o}=this;if(!i||!o)return y;const r=`${o}:${i.key}-show-only`,s=`${o}:${i.key}-negative`,l=o!=="collection"?h`${(e=i.displayText)!==null&&e!==void 0?e:i.key}`:h`<a href="/details/${i.key}">
    ...
    `}get loaderTemplate(){return h`<div class="facets-loader">
      <ia-activity-indicator .mode=${"processing"}></ia-activity-indicator>
        ...
        </div> `:y}sortFacetAggregation(e){this.sortedBy=e,this.dispatchEvent(new CustomEvent("sortedFacets",{detail:this.sortedBy}))}get getModalHeaderTemplate(){const t=Jo[this.facetKey]===J.COUNT?"left":"right";return h`<span class="sr-only">More facets for:</span>
      <span class="title">
