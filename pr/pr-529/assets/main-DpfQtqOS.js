(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function t(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerPolicy&&(r.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?r.credentials="include":o.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(o){if(o.ep)return;o.ep=!0;const r=t(o);fetch(o.href,r)}})();function n(s,e,t,i){var o=arguments.length,r=o<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(s,e,t,i);else for(var l=s.length-1;l>=0;l--)(a=s[l])&&(r=(o<3?a(r):o>3?a(e,t,r):a(e,t))||r);return o>3&&r&&Object.defineProperty(e,t,r),r}function Rr(s,e,t,i){function o(r){return r instanceof t?r:new t(function(a){a(r)})}return new(t||(t=Promise))(function(r,a){function l(h){try{p(i.next(h))}catch(f){a(f)}}function d(h){try{p(i.throw(h))}catch(f){a(f)}}function p(h){h.done?r(h.value):o(h.value).then(l,d)}p((i=i.apply(s,e||[])).next())})}class Qn{constructor(e){var t,i,o,r;this.ARCHIVE_ANALYTICS_VERSION=2,this.DEFAULT_SERVICE="ao_2",this.NO_SAMPLING_SERVICE="ao_no_sampling",this.DEFAULT_IMAGE_URL="https://athena.archive.org/0.gif",this.defaultService=(t=e==null?void 0:e.defaultService)!==null&&t!==void 0?t:this.DEFAULT_SERVICE,this.imageUrl=(i=e==null?void 0:e.imageUrl)!==null&&i!==void 0?i:this.DEFAULT_IMAGE_URL,this.imageContainer=(o=e==null?void 0:e.imageContainer)!==null&&o!==void 0?o:document.body,this.requireImagePing=(r=e==null?void 0:e.requireImagePing)!==null&&r!==void 0?r:!1}sendPing(e){const t=this.generateTrackingUrl(e).toString();if(this.requireImagePing){this.sendPingViaImage(t);return}const i=navigator.sendBeacon&&navigator.sendBeacon.bind(navigator);try{i(t)}catch{this.sendPingViaImage(t)}}sendEvent(e){const t=e.label&&e.label.trim().length>0?e.label:window.location.pathname,i={kind:"event",ec:e.category,ea:e.action,el:t,cache_bust:Math.random(),...e.eventConfiguration};this.sendPing(i)}sendEventNoSampling(e){const t=e.eventConfiguration||{};t.service=this.NO_SAMPLING_SERVICE;const i=e;i.eventConfiguration=t,this.sendEvent(i)}sendPingViaImage(e){const t=new Image(1,1);t.src=e,t.alt="",this.imageContainer.appendChild(t)}generateTrackingUrl(e){var t;const i=e??{};i.service=(t=i.service)!==null&&t!==void 0?t:this.defaultService;const o=new URL(this.imageUrl),r=Object.keys(i);return r.forEach(a=>{const l=i[a];o.searchParams.append(a,l)}),o.searchParams.append("version",`${this.ARCHIVE_ANALYTICS_VERSION}`),o.searchParams.append("count",`${r.length+2}`),o}}function w(s){let e,t,i;return typeof s=="object"?(e=s.hashFunction,t=s.expiring,i=s.tags):e=s,(o,r,a)=>{if(a.value!=null)a.value=Ir(a.value,e,t,i);else if(a.get!=null)a.get=Ir(a.get,e,t,i);else throw"Only put a Memoize() decorator on a method or get accessor."}}const Yo=new Map;function Ir(s,e,t=0,i){const o=Symbol("__memoized_map__");return function(...r){let a;this.hasOwnProperty(o)||Object.defineProperty(this,o,{configurable:!1,enumerable:!1,writable:!1,value:new Map});let l=this[o];if(Array.isArray(i))for(const d of i)Yo.has(d)?Yo.get(d).push(l):Yo.set(d,[l]);if(e||r.length>0||t>0){let d;e===!0?d=r.map(f=>f.toString()).join("!"):e?d=e.apply(this,r):d=r[0];const p=`${d}__timestamp`;let h=!1;if(t>0)if(!l.has(p))h=!0;else{let f=l.get(p);h=Date.now()-f>t}l.has(d)&&!h?a=l.get(d):(a=s.apply(this,r),l.set(d,a),t>0&&l.set(p,Date.now()))}else{const d=this;l.has(d)?a=l.get(d):(a=s.apply(this,r),l.set(d,a))}return a}}class xs{parseValue(e){return typeof e=="string"&&(e==="false"||e==="0")?!1:!!e}}xs.shared=new xs;class rt{parseValue(e){if(typeof e=="number")return e;if(typeof e=="boolean")return;const t=parseFloat(e);if(!Number.isNaN(t))return t}}rt.shared=new rt;class fo{parseValue(e){return rt.shared.parseValue(e)}}fo.shared=new fo;class Oi{parseValue(e){return this.parseJSDate(e)||this.parseBracketDate(e)}parseBracketDate(e){if(typeof e!="string")return;const t=e.match(/\[([0-9]{4})\]/);if(!(!t||t.length<2))return this.parseJSDate(t[1])}parseJSDate(e){if(typeof e!="string")return;let t=e;t.match(/^[0-9]{4}-[0-9]{2}-[0-9]{2}\s{1}[0-9]{2}:[0-9]{2}:[0-9]{2}$/)&&(t=t.replace(" ","T"));const i=Date.parse(t);if(Number.isNaN(i))return;let o=new Date(t);return(t.match(/^[0-9]{4}$/)||t.match(/^[0-9]{4}-[0-9]{2}-[0-9]{2}$/))&&(o=new Date(o.getTime()+o.getTimezoneOffset()*1e3*60)),o}}Oi.shared=new Oi;class mo{parseValue(e){if(typeof e=="number")return e;if(typeof e=="boolean")return;const t=e.split(":");let i;return t.length===1?i=this.parseNumberFormat(t[0]):i=this.parseColonSeparatedFormat(t),i}parseNumberFormat(e){let t=parseFloat(e);return Number.isNaN(t)&&(t=void 0),t}parseColonSeparatedFormat(e){let t=!1;const i=e.map((o,r)=>{const a=parseFloat(o);if(Number.isNaN(a))return t=!0,0;const d=60**(e.length-1-r);return a*Math.floor(d)}).reduce((o,r)=>o+r,0);return t?void 0:i}}mo.shared=new mo;class _s{parseValue(e){if(typeof e=="string")return e}}_s.shared=new _s;class Kn{constructor(e,t){this.separators=[";",","],this.parser=e,t&&t.separators&&(this.separators=t.separators)}parseValue(e){const t=String(e);let i=[];for(const o of this.separators)if(i=t.split(o),i.length>1)break;return this.parseListValues(i)}parseListValues(e){const i=e.map(r=>r.trim()).map(r=>this.parser.parseValue(r)),o=[];return i.forEach(r=>{r!==void 0&&o.push(r)}),o}}class $s{parseValue(e){if(typeof e=="string")return e}}$s.shared=new $s;class vo{parseValue(e){return String(e)}}vo.shared=new vo;class hi{get name(){return this.rawValue.name}get source(){return this.rawValue.source}get btih(){return this.rawValue.btih}get md5(){return this.rawValue.md5}get format(){return this.rawValue.format}get mtime(){if(this.rawValue.mtime==null)return;const e=rt.shared.parseValue(this.rawValue.mtime);if(e)return new Date(e*1e3)}get crc32(){return this.rawValue.crc32}get sha1(){return this.rawValue.sha1}get original(){return this.rawValue.original}get size(){return this.rawValue.size!=null?fo.shared.parseValue(this.rawValue.size):void 0}get title(){return this.rawValue.title}get length(){return this.rawValue.length!=null?mo.shared.parseValue(this.rawValue.length):void 0}get height(){return this.rawValue.height!=null?rt.shared.parseValue(this.rawValue.height):void 0}get width(){return this.rawValue.width!=null?rt.shared.parseValue(this.rawValue.width):void 0}get track(){return this.rawValue.track!=null?rt.shared.parseValue(this.rawValue.track):void 0}get external_identifier(){return this.rawValue.external_identifier}get creator(){return this.rawValue.creator}get album(){return this.rawValue.album}constructor(e={}){this.rawValue=e}}n([w()],hi.prototype,"mtime",null);n([w()],hi.prototype,"size",null);n([w()],hi.prototype,"length",null);n([w()],hi.prototype,"height",null);n([w()],hi.prototype,"width",null);n([w()],hi.prototype,"track",null);class Ge{get values(){return this.parseRawValue()}get value(){return this.values[0]}constructor(e,t){this.parser=e,this.rawValue=t}parseRawValue(){const e=Array.isArray(this.rawValue)?this.rawValue:[this.rawValue],t=[];return e.forEach(i=>{const o=this.parser.parseValue(i);Array.isArray(o)?t.push(...o):o!==void 0&&t.push(o)}),t}}n([w()],Ge.prototype,"values",null);n([w()],Ge.prototype,"value",null);class At extends Ge{constructor(e){super(xs.shared,e)}}class ze extends Ge{constructor(e){super(Oi.shared,e)}}class Qo extends Ge{constructor(e){super(mo.shared,e)}}class me extends Ge{constructor(e){super(rt.shared,e)}}class P extends Ge{constructor(e){super(vo.shared,e)}}class Xn extends Ge{constructor(e){super($s.shared,e)}}class Or extends Ge{constructor(e){super(fo.shared,e)}}class Ga extends Ge{constructor(e){super(_s.shared,e)}}class Zn extends Ge{constructor(e,t){super(t,e)}}class Jn extends Zn{constructor(e){const t=new Kn(vo.shared);super(e,t)}}class M{get identifier(){return this.rawMetadata.identifier}get addeddate(){return this.rawMetadata.addeddate!=null?new ze(this.rawMetadata.addeddate):void 0}get audio_codec(){return this.rawMetadata.audio_codec!=null?new P(this.rawMetadata.audio_codec):void 0}get audio_sample_rate(){return this.rawMetadata.audio_sample_rate!=null?new me(this.rawMetadata.audio_sample_rate):void 0}get avg_rating(){return this.rawMetadata.avg_rating!=null?new me(this.rawMetadata.avg_rating):void 0}get collection(){return this.rawMetadata.collection!=null?new P(this.rawMetadata.collection):void 0}get collections_raw(){return this.rawMetadata.collections_raw!=null?new P(this.rawMetadata.collections_raw):void 0}get collection_size(){return this.rawMetadata.collection_size!=null?new Or(this.rawMetadata.collection_size):void 0}get contact(){return this.rawMetadata.contact!=null?new P(this.rawMetadata.contact):void 0}get contributor(){return this.rawMetadata.contributor!=null?new P(this.rawMetadata.contributor):void 0}get coverage(){return this.rawMetadata.coverage!=null?new P(this.rawMetadata.coverage):void 0}get creator(){return this.rawMetadata.creator!=null?new P(this.rawMetadata.creator):void 0}get creator_alt_script(){return this.rawMetadata["creator-alt-script"]!=null?new P(this.rawMetadata["creator-alt-script"]):void 0}get credits(){return this.rawMetadata.credits!=null?new P(this.rawMetadata.credits):void 0}get collection_layout(){return this.rawMetadata.collection_layout!=null?new P(this.rawMetadata.collection_layout):void 0}get date(){return this.rawMetadata.date!=null?new ze(this.rawMetadata.date):void 0}get description(){return this.rawMetadata.description!=null?new P(this.rawMetadata.description):void 0}get downloads(){return this.rawMetadata.downloads!=null?new me(this.rawMetadata.downloads):void 0}get duration(){return this.rawMetadata.duration!=null?new Qo(this.rawMetadata.duration):void 0}get external_identifier(){return this.rawMetadata["external-identifier"]!=null?new P(this.rawMetadata["external-identifier"]):void 0}get external_link(){return this.rawMetadata["external-link"]!=null?new P(this.rawMetadata["external-link"]):void 0}get files_count(){return this.rawMetadata.files_count!=null?new me(this.rawMetadata.files_count):void 0}get indexdate(){return this.rawMetadata.indexdate!=null?new ze(this.rawMetadata.indexdate):void 0}get isbn(){return this.rawMetadata.isbn!=null?new P(this.rawMetadata.isbn):void 0}get issue(){return this.rawMetadata.issue!=null?new P(this.rawMetadata.issue):void 0}get item_count(){return this.rawMetadata.item_count!=null?new me(this.rawMetadata.item_count):void 0}get item_size(){return this.rawMetadata.item_size!=null?new Or(this.rawMetadata.item_size):void 0}get language(){return this.rawMetadata.language!=null?new P(this.rawMetadata.language):void 0}get length(){return this.rawMetadata.length!=null?new Qo(this.rawMetadata.length):void 0}get licenseurl(){return this.rawMetadata.licenseurl!=null?new P(this.rawMetadata.licenseurl):void 0}get lineage(){return this.rawMetadata.lineage!=null?new P(this.rawMetadata.lineage):void 0}get month(){return this.rawMetadata.month!=null?new me(this.rawMetadata.month):void 0}get mediatype(){return this.rawMetadata.mediatype!=null?new Ga(this.rawMetadata.mediatype):void 0}get noindex(){return this.rawMetadata.noindex!=null?new At(this.rawMetadata.noindex):void 0}get notes(){return this.rawMetadata.notes!=null?new P(this.rawMetadata.notes):void 0}get num_favorites(){return this.rawMetadata.num_favorites!=null?new me(this.rawMetadata.num_favorites):void 0}get num_reviews(){return this.rawMetadata.num_reviews!=null?new me(this.rawMetadata.num_reviews):void 0}get openlibrary_edition(){return this.rawMetadata.openlibrary_edition!=null?new P(this.rawMetadata.openlibrary_edition):void 0}get openlibrary_work(){return this.rawMetadata.openlibrary_work!=null?new P(this.rawMetadata.openlibrary_work):void 0}get page_progression(){return this.rawMetadata.page_progression!=null?new Xn(this.rawMetadata.page_progression):void 0}get paginated(){return this.rawMetadata.paginated!=null?new At(this.rawMetadata.paginated):void 0}get partner(){return this.rawMetadata.partner!=null?new P(this.rawMetadata.partner):void 0}get post_text(){return this.rawMetadata.post_text!=null?new P(this.rawMetadata.post_text):void 0}get ppi(){return this.rawMetadata.ppi!=null?new me(this.rawMetadata.ppi):void 0}get publicdate(){return this.rawMetadata.publicdate!=null?new ze(this.rawMetadata.publicdate):void 0}get publisher(){return this.rawMetadata.publisher!=null?new P(this.rawMetadata.publisher):void 0}get reviewdate(){return this.rawMetadata.reviewdate!=null?new ze(this.rawMetadata.reviewdate):void 0}get rights(){return this.rawMetadata.rights!=null?new P(this.rawMetadata.rights):void 0}get rights_holder(){var e;const t=(e=this.rawMetadata["rights-holder"])!==null&&e!==void 0?e:this.rawMetadata.rights_holder;return t!=null?new P(t):void 0}get runtime(){return this.rawMetadata.runtime!=null?new Qo(this.rawMetadata.runtime):void 0}get scanner(){return this.rawMetadata.scanner!=null?new P(this.rawMetadata.scanner):void 0}get segments(){return this.rawMetadata.segments!=null?new P(this.rawMetadata.segments):void 0}get shotlist(){return this.rawMetadata.shotlist!=null?new P(this.rawMetadata.shotlist):void 0}get source(){return this.rawMetadata.source!=null?new P(this.rawMetadata.source):void 0}get sponsor(){return this.rawMetadata.sponsor!=null?new P(this.rawMetadata.sponsor):void 0}get start_localtime(){return this.rawMetadata.start_localtime!=null?new ze(this.rawMetadata.start_localtime):void 0}get start_time(){return this.rawMetadata.start_time!=null?new ze(this.rawMetadata.start_time):void 0}get stop_time(){return this.rawMetadata.stop_time!=null?new ze(this.rawMetadata.stop_time):void 0}get subject(){return this.rawMetadata.subject!=null?new Jn(this.rawMetadata.subject):void 0}get taper(){return this.rawMetadata.taper!=null?new P(this.rawMetadata.taper):void 0}get title(){return this.rawMetadata.title!=null?new P(this.rawMetadata.title):void 0}get title_alt_script(){return this.rawMetadata["title-alt-script"]!=null?new P(this.rawMetadata["title-alt-script"]):void 0}get transferer(){return this.rawMetadata.transferer!=null?new P(this.rawMetadata.transferer):void 0}get track(){return this.rawMetadata.track!=null?new me(this.rawMetadata.track):void 0}get type(){return this.rawMetadata.type!=null?new P(this.rawMetadata.type):void 0}get uploader(){return this.rawMetadata.uploader!=null?new P(this.rawMetadata.uploader):void 0}get utc_offset(){return this.rawMetadata.utc_offset!=null?new me(this.rawMetadata.utc_offset):void 0}get venue(){return this.rawMetadata.venue!=null?new P(this.rawMetadata.venue):void 0}get volume(){return this.rawMetadata.volume!=null?new P(this.rawMetadata.volume):void 0}get week(){return this.rawMetadata.week!=null?new me(this.rawMetadata.week):void 0}get year(){return this.rawMetadata.year!=null?new me(this.rawMetadata.year):void 0}constructor(e={}){this.rawMetadata=e}}n([w()],M.prototype,"addeddate",null);n([w()],M.prototype,"audio_codec",null);n([w()],M.prototype,"audio_sample_rate",null);n([w()],M.prototype,"avg_rating",null);n([w()],M.prototype,"collection",null);n([w()],M.prototype,"collections_raw",null);n([w()],M.prototype,"collection_size",null);n([w()],M.prototype,"contact",null);n([w()],M.prototype,"contributor",null);n([w()],M.prototype,"coverage",null);n([w()],M.prototype,"creator",null);n([w()],M.prototype,"creator_alt_script",null);n([w()],M.prototype,"credits",null);n([w()],M.prototype,"collection_layout",null);n([w()],M.prototype,"date",null);n([w()],M.prototype,"description",null);n([w()],M.prototype,"downloads",null);n([w()],M.prototype,"duration",null);n([w()],M.prototype,"external_identifier",null);n([w()],M.prototype,"external_link",null);n([w()],M.prototype,"files_count",null);n([w()],M.prototype,"indexdate",null);n([w()],M.prototype,"isbn",null);n([w()],M.prototype,"issue",null);n([w()],M.prototype,"item_count",null);n([w()],M.prototype,"item_size",null);n([w()],M.prototype,"language",null);n([w()],M.prototype,"length",null);n([w()],M.prototype,"licenseurl",null);n([w()],M.prototype,"lineage",null);n([w()],M.prototype,"month",null);n([w()],M.prototype,"mediatype",null);n([w()],M.prototype,"noindex",null);n([w()],M.prototype,"notes",null);n([w()],M.prototype,"num_favorites",null);n([w()],M.prototype,"num_reviews",null);n([w()],M.prototype,"openlibrary_edition",null);n([w()],M.prototype,"openlibrary_work",null);n([w()],M.prototype,"page_progression",null);n([w()],M.prototype,"paginated",null);n([w()],M.prototype,"partner",null);n([w()],M.prototype,"post_text",null);n([w()],M.prototype,"ppi",null);n([w()],M.prototype,"publicdate",null);n([w()],M.prototype,"publisher",null);n([w()],M.prototype,"reviewdate",null);n([w()],M.prototype,"rights",null);n([w()],M.prototype,"rights_holder",null);n([w()],M.prototype,"runtime",null);n([w()],M.prototype,"scanner",null);n([w()],M.prototype,"segments",null);n([w()],M.prototype,"shotlist",null);n([w()],M.prototype,"source",null);n([w()],M.prototype,"sponsor",null);n([w()],M.prototype,"start_localtime",null);n([w()],M.prototype,"start_time",null);n([w()],M.prototype,"stop_time",null);n([w()],M.prototype,"subject",null);n([w()],M.prototype,"taper",null);n([w()],M.prototype,"title",null);n([w()],M.prototype,"title_alt_script",null);n([w()],M.prototype,"transferer",null);n([w()],M.prototype,"track",null);n([w()],M.prototype,"type",null);n([w()],M.prototype,"uploader",null);n([w()],M.prototype,"utc_offset",null);n([w()],M.prototype,"venue",null);n([w()],M.prototype,"volume",null);n([w()],M.prototype,"week",null);n([w()],M.prototype,"year",null);class Do{get reviewbody(){return this.rawValue.reviewbody}get reviewtitle(){return this.rawValue.reviewtitle}get reviewer(){return this.rawValue.reviewer}get reviewer_itemname(){return this.rawValue.reviewer_itemname}get reviewdate(){return this.rawValue.reviewdate!=null?Oi.shared.parseValue(this.rawValue.reviewdate):void 0}get createdate(){return this.rawValue.createdate!=null?Oi.shared.parseValue(this.rawValue.createdate):void 0}get stars(){return this.rawValue.stars!=null?rt.shared.parseValue(this.rawValue.stars):void 0}constructor(e={}){this.rawValue=e}}n([w()],Do.prototype,"reviewdate",null);n([w()],Do.prototype,"createdate",null);n([w()],Do.prototype,"stars",null);class Zs extends Do{get reviewer_account_status(){var e;return(e=this.account_status)===null||e===void 0?void 0:e.status}get reviewer_account_status_reason(){var e;return(e=this.account_status)===null||e===void 0?void 0:e.reason}get __href__(){return this.rawValue.__href__}get account_status(){const e=this.rawValue.reviewer_account_status;if(!e)return;let t="unknown",i;e.startsWith("ok")&&(t="ok"),e.startsWith("locked")&&(t="locked");const o=e.split("__");return o.length>1&&(i=o.slice(1).join("__")),{status:t,reason:i}}}n([w()],Zs.prototype,"account_status",null);const el=["loans","waitlist","loan_history"];function tl(s){const e=s.slice(0,4),t=s.slice(4,6),i=s.slice(6,8),o=s.slice(8,10),r=s.slice(10,12),a=s.slice(12,14);return`${e}-${t}-${i}T${o}:${r}:${a}Z`}function il(s){var e;const t=[];for(const i of s){if(!(!((e=i.captures)===null||e===void 0)&&e.length))continue;const o=encodeURIComponent(i.url),r=`https://web.archive.org/web/${i.captures[0]}/${o}`;t.push({hit_type:"web_archive",fields:{url:i.url,capture_dates:i.captures.map(a=>tl(a)),__href__:r}})}return t}class pe extends M{get created_on(){return this.rawMetadata.created_on!=null?new ze(this.rawMetadata.created_on):void 0}get file_creation_mtime(){return this.rawMetadata.file_creation_mtime!=null?new me(this.rawMetadata.file_creation_mtime):void 0}get filename(){return this.rawMetadata.filename!=null?new P(this.rawMetadata.filename):void 0}get file_basename(){return this.rawMetadata.file_basename!=null?new P(this.rawMetadata.file_basename):void 0}get result_in_subfile(){return this.rawMetadata.result_in_subfile!=null?new At(this.rawMetadata.result_in_subfile):void 0}get query(){return this.rawMetadata.query!=null?new P(this.rawMetadata.query):void 0}get date_favorited(){return this.rawMetadata.date_favorited!=null?new ze(this.rawMetadata.date_favorited):void 0}get updated_on(){return this.rawMetadata.updated_on!=null?new ze(this.rawMetadata.updated_on):void 0}get ad_id(){return this.rawMetadata.ad_id!=null?new P(this.rawMetadata.ad_id):void 0}get factcheck(){return this.rawMetadata.factcheck!=null?new P(this.rawMetadata.factcheck):void 0}get is_clip(){return this.rawMetadata.clip!=null?new At(this.rawMetadata.clip):void 0}get num_clips(){return this.rawMetadata.nclips!=null?new me(this.rawMetadata.nclips):void 0}get __href__(){return this.rawMetadata.__href__!=null?new P(this.rawMetadata.__href__):void 0}get __img__(){return this.rawMetadata.__img__!=null?new P(this.rawMetadata.__img__):void 0}}n([w()],pe.prototype,"created_on",null);n([w()],pe.prototype,"file_creation_mtime",null);n([w()],pe.prototype,"filename",null);n([w()],pe.prototype,"file_basename",null);n([w()],pe.prototype,"result_in_subfile",null);n([w()],pe.prototype,"query",null);n([w()],pe.prototype,"date_favorited",null);n([w()],pe.prototype,"updated_on",null);n([w()],pe.prototype,"ad_id",null);n([w()],pe.prototype,"factcheck",null);n([w()],pe.prototype,"is_clip",null);n([w()],pe.prototype,"num_clips",null);n([w()],pe.prototype,"__href__",null);n([w()],pe.prototype,"__img__",null);class He{constructor(e){var t;this.rawMetadata=e,this.fields=new pe((t=e.fields)!==null&&t!==void 0?t:{})}get identifier(){return this.fields.identifier}get addeddate(){return this.fields.addeddate}get avg_rating(){return this.fields.avg_rating}get collection(){return this.fields.collection}get collection_files_count(){var e;return((e=this.rawMetadata.fields)===null||e===void 0?void 0:e.collection_files_count)!=null?new me(this.rawMetadata.fields.collection_files_count):void 0}get collection_size(){return this.fields.collection_size}get creator(){return this.fields.creator}get date(){return this.fields.date}get description(){return this.fields.description}get downloads(){return this.fields.downloads}get files_count(){return this.fields.files_count}get genre(){var e;return((e=this.rawMetadata.fields)===null||e===void 0?void 0:e.genre)!=null?new P(this.rawMetadata.fields.genre):void 0}get indexflag(){var e;return((e=this.rawMetadata.fields)===null||e===void 0?void 0:e.indexflag)!=null?new P(this.rawMetadata.fields.indexflag):void 0}get issue(){return this.fields.issue}get item_count(){return this.fields.item_count}get item_size(){return this.fields.item_size}get language(){return this.fields.language}get lending___available_to_borrow(){var e;return((e=this.rawMetadata.fields)===null||e===void 0?void 0:e.lending___available_to_borrow)!=null?new At(this.rawMetadata.fields.lending___available_to_borrow):void 0}get lending___available_to_browse(){var e;return((e=this.rawMetadata.fields)===null||e===void 0?void 0:e.lending___available_to_browse)!=null?new At(this.rawMetadata.fields.lending___available_to_browse):void 0}get lending___available_to_waitlist(){var e;return((e=this.rawMetadata.fields)===null||e===void 0?void 0:e.lending___available_to_waitlist)!=null?new At(this.rawMetadata.fields.lending___available_to_waitlist):void 0}get lending___status(){var e;return((e=this.rawMetadata.fields)===null||e===void 0?void 0:e.lending___status)!=null?new P(this.rawMetadata.fields.lending___status):void 0}get licenseurl(){var e;return((e=this.rawMetadata.fields)===null||e===void 0?void 0:e.licenseurl)!=null?new P(this.rawMetadata.fields.licenseurl):void 0}get mediatype(){return this.fields.mediatype}get month(){return this.fields.month}get noindex(){return this.fields.noindex}get num_favorites(){return this.fields.num_favorites}get num_reviews(){return this.fields.num_reviews}get publicdate(){return this.fields.publicdate}get reviewdate(){return this.fields.reviewdate}get review(){const e=this.rawMetadata.review;return e?new Zs(e):void 0}get source(){return this.fields.source}get subject(){return this.fields.subject}get title(){return this.fields.title}get type(){return this.fields.type}get volume(){return this.fields.volume}get week(){return this.fields.week}get year(){return this.fields.year}}n([w()],He.prototype,"collection_files_count",null);n([w()],He.prototype,"genre",null);n([w()],He.prototype,"indexflag",null);n([w()],He.prototype,"lending___available_to_borrow",null);n([w()],He.prototype,"lending___available_to_browse",null);n([w()],He.prototype,"lending___available_to_waitlist",null);n([w()],He.prototype,"lending___status",null);n([w()],He.prototype,"licenseurl",null);n([w()],He.prototype,"review",null);class Js{constructor(e){var t;this.rawMetadata=e,this.fields=new pe((t=e.fields)!==null&&t!==void 0?t:{})}get identifier(){return this.fields.identifier}get highlight(){var e;return!((e=this.rawMetadata.highlight)===null||e===void 0)&&e.text?new P(this.rawMetadata.highlight.text):void 0}get addeddate(){return this.fields.addeddate}get avg_rating(){return this.fields.avg_rating}get collection(){return this.fields.collection}get created_on(){return this.fields.created_on}get creator(){return this.fields.creator}get date(){return this.fields.date}get description(){return this.fields.description}get downloads(){return this.fields.downloads}get filename(){return this.fields.filename}get file_basename(){return this.fields.file_basename}get file_creation_mtime(){return this.fields.file_creation_mtime}get issue(){return this.fields.issue}get mediatype(){return this.fields.mediatype}get page_num(){var e;return((e=this.rawMetadata.fields)===null||e===void 0?void 0:e.page_num)!=null?new me(this.rawMetadata.fields.page_num):void 0}get publicdate(){return this.fields.publicdate}get result_in_subfile(){return this.fields.result_in_subfile}get reviewdate(){return this.fields.reviewdate}get source(){return this.fields.source}get subject(){return this.fields.subject}get title(){return this.fields.title}get updated_on(){return this.fields.updated_on}get year(){return this.fields.year}get __href__(){return this.fields.__href__}}n([w()],Js.prototype,"highlight",null);n([w()],Js.prototype,"page_num",null);var W;(function(s){s[s.COUNT=0]="COUNT",s[s.ALPHABETICAL=1]="ALPHABETICAL",s[s.NUMERIC=2]="NUMERIC"})(W||(W={}));class qa{constructor(e){this.buckets=e.buckets,this.first_bucket_key=e.first_bucket_key,this.last_bucket_key=e.last_bucket_key,this.number_buckets=e.number_buckets,this.interval=e.interval,this.first_bucket_year=e.first_bucket_year,this.first_bucket_month=e.first_bucket_month,this.last_bucket_year=e.last_bucket_year,this.last_bucket_month=e.last_bucket_month,this.interval_in_months=e.interval_in_months}getSortedBuckets(e){const t=[...this.buckets];if(this.isRawNumberBuckets(t))return t;const i=new Intl.Collator;switch(e){case W.ALPHABETICAL:return t.sort((o,r)=>i.compare(o.key.toString(),r.key.toString()));case W.NUMERIC:return t.sort((o,r)=>Number(r.key)-Number(o.key));case W.COUNT:default:return t}}isRawNumberBuckets(e){return typeof e[0]=="number"}}n([w()],qa.prototype,"getSortedBuckets",null);class ol{constructor(e){var t;this.rawMetadata=e,this.fields=new pe((t=e.fields)!==null&&t!==void 0?t:{})}get identifier(){var e;return(e=this.fields.query)===null||e===void 0?void 0:e.value}get title(){return this.fields.title}get query(){return this.fields.query}get date_favorited(){return this.fields.date_favorited}get __href__(){return this.fields.__href__}}class er{constructor(e){var t;this.rawMetadata=e,this.fields=new pe((t=e.fields)!==null&&t!==void 0?t:{})}get identifier(){var e;return(e=this.rawMetadata.fields)===null||e===void 0?void 0:e.url}get mediatype(){return new Ga("web")}get title(){var e,t;return!((e=this.rawMetadata.fields)===null||e===void 0)&&e.url?new P((t=this.rawMetadata.fields)===null||t===void 0?void 0:t.url):void 0}get capture_dates(){var e,t;return!((e=this.rawMetadata.fields)===null||e===void 0)&&e.capture_dates?new ze((t=this.rawMetadata.fields)===null||t===void 0?void 0:t.capture_dates):void 0}get __href__(){return this.fields.__href__}}n([w()],er.prototype,"title",null);n([w()],er.prototype,"capture_dates",null);class tr{constructor(e){var t;this.rawMetadata=e,this.fields=new pe((t=e.fields)!==null&&t!==void 0?t:{})}get identifier(){return this.fields.identifier}get highlight(){var e;return!((e=this.rawMetadata.highlight)===null||e===void 0)&&e.text?new P(this.rawMetadata.highlight.text):void 0}get addeddate(){return this.fields.addeddate}get ad_id(){return this.fields.ad_id}get avg_rating(){return this.fields.avg_rating}get collection(){return this.fields.collection}get created_on(){return this.fields.created_on}get creator(){return this.fields.creator}get date(){return this.fields.date}get description(){return this.fields.description}get downloads(){return this.fields.downloads}get factcheck(){return this.fields.factcheck}get filename(){return this.fields.filename}get file_basename(){return this.fields.file_basename}get file_creation_mtime(){return this.fields.file_creation_mtime}get files_count(){return this.fields.files_count}get is_clip(){return this.fields.is_clip}get issue(){return this.fields.issue}get item_count(){return this.fields.item_count}get item_size(){return this.fields.item_size}get language(){return this.fields.language}get mediatype(){return this.fields.mediatype}get num_clips(){return this.fields.num_clips}get num_favorites(){return this.fields.num_favorites}get publicdate(){return this.fields.publicdate}get result_in_subfile(){return this.fields.result_in_subfile}get reviewdate(){return this.fields.reviewdate}get source(){return this.fields.source}get subject(){return this.fields.subject}get title(){return this.fields.title}get updated_on(){return this.fields.updated_on}get week(){return this.fields.week}get year(){return this.fields.year}get start(){var e;return((e=this.rawMetadata.fields)===null||e===void 0?void 0:e.start)!=null?new P(this.rawMetadata.fields.start):void 0}get __href__(){return this.fields.__href__}get __img__(){return this.fields.__img__}}n([w()],tr.prototype,"highlight",null);n([w()],tr.prototype,"start",null);class ir{constructor(e){this.rawResponse=e}get item_size(){return this.rawResponse.item_size}get files_count(){return this.rawResponse.files_count}get month(){return this.rawResponse.month}get week(){return this.rawResponse.week}get downloads(){return this.rawResponse.downloads}get num_favorites(){return this.rawResponse.num_favorites}get title_message(){return this.rawResponse.title_message}get primary_collection(){return this.rawResponse.primary_collection}get thumbnail_url(){return this.rawResponse.thumbnail_url}get num_reviews(){return this.rawResponse.num_reviews}get uploader_details(){return this.rawResponse.uploader_details}get public_metadata(){if(this.rawResponse.public_metadata)return new M(this.rawResponse.public_metadata)}get part_of(){return this.rawResponse.part_of}get speech_vs_music_asr_metadata(){return this.rawResponse.speech_vs_music_asr_metadata}get reviews_metadata(){var e;return((e=this.rawResponse.reviews_metadata)!==null&&e!==void 0?e:[]).map(i=>new Zs(i))}}n([w()],ir.prototype,"public_metadata",null);n([w()],ir.prototype,"reviews_metadata",null);class or{constructor(e,t){var i,o,r,a,l,d,p,h,f,v,y,x,S,k,D;this.extraInfo=null,this.schema=t,this.schemaHitType=t==null?void 0:t.hit_type;let E;e!=null&&e.page_elements&&(this.pageElements=e.page_elements,E=Object.values(this.pageElements)[0]);let A=(i=e==null?void 0:e.hits)===null||i===void 0?void 0:i.hits;this.totalResults=(r=(o=e==null?void 0:e.hits)===null||o===void 0?void 0:o.total)!==null&&r!==void 0?r:0,this.returnedCount=(l=(a=e==null?void 0:e.hits)===null||a===void 0?void 0:a.returned)!==null&&l!==void 0?l:0,!(A!=null&&A.length)&&(!((d=this.pageElements)===null||d===void 0)&&d.service___fts)?(this.totalResults=0,this.returnedCount=0,this.handleFederatedPageElements()):!(A!=null&&A.length)&&(!((p=E==null?void 0:E.hits)===null||p===void 0)&&p.hits)?(A=E.hits.hits,this.totalResults=(h=E.hits.total)!==null&&h!==void 0?h:0,this.returnedCount=(f=E.hits.returned)!==null&&f!==void 0?f:0):!((v=this.pageElements)===null||v===void 0)&&v.lending?A=this.handleLendingPageElement():!((y=this.pageElements)===null||y===void 0)&&y.web_archives&&(A=this.handleWebArchivesPageElement()),this.results=this.formatHits(A);let R=e==null?void 0:e.aggregations;!(this.aggregations&&Object.keys(this.aggregations).length>0)&&(E!=null&&E.aggregations)&&(R=E.aggregations),R&&this.buildAggregations(R),e!=null&&e.collection_titles&&(this.collectionTitles=(x=e.collection_titles)!==null&&x!==void 0?x:{}),e!=null&&e.tv_channel_aliases&&(this.tvChannelAliases=(S=e.tv_channel_aliases)!==null&&S!==void 0?S:{}),e!=null&&e.collection_extra_info&&(this.collectionExtraInfo=(k=e.collection_extra_info)!==null&&k!==void 0?k:null),e!=null&&e.account_extra_info&&(this.accountExtraInfo=(D=e.account_extra_info)!==null&&D!==void 0?D:null),e!=null&&e.extra_info&&(this.extraInfo=new ir(e.extra_info))}formatHits(e){var t;return(t=e==null?void 0:e.map(i=>{var o;return or.createResult((o=i.hit_type)!==null&&o!==void 0?o:this.schemaHitType,i)}))!==null&&t!==void 0?t:[]}buildAggregations(e){this.aggregations=Object.entries(e).reduce((t,[i,o])=>(t[i]=new qa(o),t),{})}handleLendingPageElement(){var e,t;const i=(e=this.pageElements)===null||e===void 0?void 0:e.lending,o=(t=i.loans)!==null&&t!==void 0?t:[];this.totalResults=o.length,this.returnedCount=this.totalResults;for(const r of el)i[r]=this.formatHits(i[r]);return o}handleWebArchivesPageElement(){var e;const t=il((e=this.pageElements)===null||e===void 0?void 0:e.web_archives);return this.totalResults=t.length,this.returnedCount=this.totalResults,t}handleFederatedPageElements(){var e,t,i,o;const r=["service___fts","service___tvs","service___rcs","service___whisper","metadata___mediatype___texts","metadata___mediatype___movies","metadata___mediatype___audio","metadata___mediatype___software","metadata___mediatype___image","metadata___mediatype___etree"];for(const a of r){const l=this.removePageElementPrefix(a);this.federatedResults?this.federatedResults[a]=[]:this.federatedResults={[l]:[]};const d=(t=(e=this.pageElements)===null||e===void 0?void 0:e[a])===null||t===void 0?void 0:t.hits;d!=null&&d.hits&&(this.federatedResults[l]=this.formatHits(d==null?void 0:d.hits)),this.totalResults+=(i=d==null?void 0:d.total)!==null&&i!==void 0?i:0,this.returnedCount+=(o=d==null?void 0:d.returned)!==null&&o!==void 0?o:0}}removePageElementPrefix(e){return e.split("___").pop()}static createResult(e,t){switch(e){case"item":return new He(t);case"text":case"asr_text":return new Js(t);case"favorited_search":return new ol(t);case"web_archive":return new er(t);case"tv_clip":return new tr(t);default:return new He(t)}}}class sl{constructor(e){this.clientParameters=e.client_parameters,this.backendRequests=e.backend_requests,this.kind=e.kind}}class rl{constructor(e){var t,i,o;this.rawResponse=e,this.request=new sl(e.request),this.responseHeader=(t=e.response)===null||t===void 0?void 0:t.header,this.sessionContext=e.session_context,this.response=new or((i=e.response)===null||i===void 0?void 0:i.body,(o=e.response)===null||o===void 0?void 0:o.hit_schema)}}class pi{static aggregateSearchParamsAsString(e){if(e.omit)return"false";if(e.advancedParams){const t=e.advancedParams.map(o=>({terms:o}));return JSON.stringify(t)}if(e.simpleParams)return e.simpleParams.join(",")}static sortParamsAsString(e){return`${e.field}:${e.direction}`}static filterParamsAsString(e){return JSON.stringify(e)}static generateURLSearchParams(e){const t=new URLSearchParams;if(e.query&&t.append("user_query",e.query),e.pageType&&t.append("page_type",String(e.pageType)),e.pageTarget&&t.append("page_target",String(e.pageTarget)),e.pageElements&&e.pageElements.length>0){const r=`[${e.pageElements.map(a=>`"${a}"`).join(",")}]`;t.append("page_elements",r)}if(e.rows!=null&&t.append("hits_per_page",String(e.rows)),e.page!=null&&t.append("page",String(e.page)),e.fields&&e.fields.length>0&&t.append("fields",e.fields.join(",")),e.filters&&Object.keys(e.filters).length>0){const o=this.filterParamsAsString(e.filters);o&&o!=="{}"&&t.append("filter_map",o)}if(e.sort&&e.sort.length>0){const o=e.sort.map(r=>this.sortParamsAsString(r));t.append("sort",o.join(","))}const i=e.aggregations;if(i){const o=this.aggregateSearchParamsAsString(i);o&&t.append("aggregations",o)}if(e.aggregationsSize!=null&&t.append("aggregations_size",String(e.aggregationsSize)),e.debugging&&t.append("debugging","true"),e.uid&&t.append("uid",e.uid),e.includeClientUrl!==!1){const o=e.query==null,r=e.query&&e.query.length<=1e3;if(o||r){const l=window.location.href.slice(0,400);t.append("client_url",l)}}return t}}var Pi;(function(s){s.networkError="SearchService.NetworkError",s.itemNotFound="SearchService.ItemNotFound",s.decodingError="SearchService.DecodingError",s.searchEngineError="SearchService.SearchEngineError"})(Pi||(Pi={}));class al extends Error{constructor(e,t,i){super(t),this.name=e,this.type=e,this.details=i}}const Nr={reCache:JSON.stringify({recompute:!0}),noCache:JSON.stringify({bypass:!0}),dontCache:JSON.stringify({no_compute:!0})};class ui{constructor(e){var t,i;this.baseUrl=(t=e==null?void 0:e.baseUrl)!==null&&t!==void 0?t:"archive.org",(e==null?void 0:e.includeCredentials)!==void 0?this.includeCredentials=e.includeCredentials:this.includeCredentials=window.location.href.match(/^https?:\/\/.*archive\.org(:[0-9]+)?/)!==null;const o=new URL(window.location.href).searchParams,r=o.get("scope"),a=o.get("verbose"),l=o.get("debugging"),d=o.get("cacheDebug");let p="";for(const h of Object.keys(Nr))if(o.get(h)){p=Nr[h];break}p=(i=o.get("caching"))!==null&&i!==void 0?i:p,(e==null?void 0:e.caching)!==void 0?this.cachingFlags=e.caching:p&&(this.cachingFlags=p),(e==null?void 0:e.debuggingEnabled)!==void 0?this.debuggingEnabled=e.debuggingEnabled:(l||d)&&(this.debuggingEnabled=!0),(e==null?void 0:e.scope)!==void 0?this.requestScope=e.scope:r&&(this.requestScope=r),(e==null?void 0:e.verbose)!==void 0?this.verbose=e.verbose:a&&(this.verbose=!!a)}async fetchUrl(e,t){var i,o;const r=new URL(e);this.requestScope&&r.searchParams.set("scope",this.requestScope),this.cachingFlags&&r.searchParams.set("caching",this.cachingFlags);let a;try{const l=(i=t==null?void 0:t.requestOptions)!==null&&i!==void 0?i:{credentials:this.includeCredentials?"include":"same-origin"};a=await fetch(r.href,l)}catch(l){const d=l instanceof Error?l.message:typeof l=="string"?l:"Unknown error";return this.getErrorResult(Pi.networkError,d)}try{const l=await a.json();this.verbose&&this.printResponse(l),l.debugging&&this.printDebuggingInfo(l);const d=(o=l.response)===null||o===void 0?void 0:o.error;return d?this.getErrorResult(Pi.searchEngineError,d.message,d.forensics):{success:l}}catch(l){const d=l instanceof Error?l.message:typeof l=="string"?l:"Unknown error";return this.getErrorResult(Pi.decodingError,d)}}getErrorResult(e,t,i){return{error:new al(e,t,i)}}printResponse(e){var t,i,o,r,a;try{const l=JSON.parse(JSON.stringify(e)),d=(o=(i=(t=l==null?void 0:l.response)===null||t===void 0?void 0:t.body)===null||i===void 0?void 0:i.hits)===null||o===void 0?void 0:o.hits;if(Array.isArray(d)&&d.length>1){const h=[];h.push(d[0]),h.push(`*** ${d.length-1} hits omitted ***`),l.response.body.hits.hits=h}const p=(a=(r=l==null?void 0:l.response)===null||r===void 0?void 0:r.body)===null||a===void 0?void 0:a.aggregations;p&&Object.entries(p).forEach(([h,f])=>{var v,y,x,S;if(((y=(v=f)===null||v===void 0?void 0:v.buckets)===null||y===void 0?void 0:y.length)>0){const k=JSON.parse(JSON.stringify(f));k.buckets=`*** ${(S=(x=k.buckets)===null||x===void 0?void 0:x.length)!==null&&S!==void 0?S:0} buckets omitted ***`,l.response.body.aggregations[h]=k}}),console.log("***** RESPONSE RECEIVED *****"),console.groupCollapsed("Response"),console.log(JSON.stringify(l,null,2)),console.groupEnd()}catch(l){console.error("Error printing search response:",l)}}printDebuggingInfo(e){var t,i;const o=e.debugging,r=(t=o.messages)!==null&&t!==void 0?t:[],a=(i=o.data)!==null&&i!==void 0?i:{};console.log("***** BEGIN DEBUGGING *****"),console.log("Full response:"),console.log(JSON.stringify(e,null,2)),console.group("Debug messages");for(const l of r)console.log(l);console.groupEnd(),console.group("Debug data");for(const[l,d]of Object.entries(a))console.log(l,d);console.groupEnd(),console.log("***** END DEBUGGING *****")}}class nl extends ui{constructor(e){var t;super(e),this.servicePath=(t=e==null?void 0:e.servicePath)!==null&&t!==void 0?t:"/services/search/beta/page_production"}async performSearch(e){this.debuggingEnabled&&e.debugging===void 0&&(e.debugging=!0);const i=pi.generateURLSearchParams(e).toString(),o=`https://${this.baseUrl}${this.servicePath}/?service_backend=metadata&${i}`;return this.fetchUrl(o)}}class ll extends ui{constructor(e){var t;super(e),this.servicePath=(t=e==null?void 0:e.servicePath)!==null&&t!==void 0?t:"/services/search/beta/page_production"}async performSearch(e){this.debuggingEnabled&&e.debugging===void 0&&(e.debugging=!0);const i=pi.generateURLSearchParams(e).toString(),o=`https://${this.baseUrl}${this.servicePath}/?service_backend=fts&${i}`;return this.fetchUrl(o)}}class dl extends ui{constructor(e){var t;super(e),this.servicePath=(t=e==null?void 0:e.servicePath)!==null&&t!==void 0?t:"/services/search/beta/page_production"}async performSearch(e){this.debuggingEnabled&&e.debugging===void 0&&(e.debugging=!0);const i=pi.generateURLSearchParams(e).toString(),o=`https://${this.baseUrl}${this.servicePath}/?service_backend=rcs&${i}`;return this.fetchUrl(o)}}var O;(function(s){s[s.DEFAULT=0]="DEFAULT",s[s.METADATA=1]="METADATA",s[s.FULLTEXT=2]="FULLTEXT",s[s.TV=3]="TV",s[s.RADIO=4]="RADIO",s[s.FEDERATED=5]="FEDERATED"})(O||(O={}));class cl extends ui{constructor(e){var t;super(e),this.servicePath=(t=e==null?void 0:e.servicePath)!==null&&t!==void 0?t:"/services/search/beta/page_production"}async performSearch(e){this.debuggingEnabled&&e.debugging===void 0&&(e.debugging=!0);const i=pi.generateURLSearchParams(e).toString(),o=`https://${this.baseUrl}${this.servicePath}/?service_backend=tvs&${i}`;return this.fetchUrl(o)}}class hl extends ui{constructor(e){var t;super(e),this.servicePath=(t=e==null?void 0:e.servicePath)!==null&&t!==void 0?t:"/services/search/beta/page_production"}async performSearch(e){this.debuggingEnabled&&e.debugging===void 0&&(e.debugging=!0);const i=pi.generateURLSearchParams(e).toString(),o=`https://${this.baseUrl}${this.servicePath}/?page_type=simple_federation&${i}`;return this.fetchUrl(o)}}class pl extends ui{constructor(e){var t;super(e),this.servicePath=(t=e==null?void 0:e.servicePath)!==null&&t!==void 0?t:"/services/search/beta/page_production"}async performSearch(e){this.debuggingEnabled&&e.debugging===void 0&&(e.debugging=!0);const i=pi.generateURLSearchParams(e).toString(),o=`https://${this.baseUrl}${this.servicePath}/?${i}`,{pageType:r,identifiers:a}=e,d=r==="client_document_fetch"&&!!(a!=null&&a.length)?{requestOptions:{method:"POST",body:JSON.stringify({doc_ids:a}),credentials:"include"}}:void 0;return this.fetchUrl(o,d)}}class ei{constructor(e={}){this.backendOptions=e}async search(e,t=O.METADATA){const o=await ei.getBackendForSearchType(t,this.backendOptions).performSearch(e);return o.error?o:{success:new rl(o.success)}}itemDetails(e){const t={pageType:"item_details",pageTarget:e};return this.search(t,O.DEFAULT)}static getBackendForSearchType(e,t={}){switch(e){case O.METADATA:return new nl(t);case O.FULLTEXT:return new ll(t);case O.RADIO:return new dl(t);case O.TV:return new cl(t);case O.FEDERATED:return new hl(t);default:return new pl(t)}}}ei.default=new ei;n([w((s,e={})=>{const{includeCredentials:t=!1,verbose:i=!1,scope:o="",baseUrl:r=""}=e;return`${s};${t};${i};${o};${r}`})],ei,"getBackendForSearchType",null);var Re;(function(s){s.INCLUDE="inc",s.EXCLUDE="exc",s.GREATER_THAN="gt",s.GREATER_OR_EQUAL="gte",s.LESS_THAN="lt",s.LESS_OR_EQUAL="lte"})(Re||(Re={}));class ul{constructor(){this.filterMap={}}addFilter(e,t,i){if(this.filterMap[e]||(this.filterMap[e]={}),this.filterMap[e][t]){const o=[].concat(this.filterMap[e][t],i);this.filterMap[e][t]=Array.from(new Set(o))}else this.filterMap[e][t]=i;return this}removeSingleFilter(e,t,i){var o;if(!(!((o=this.filterMap[e])===null||o===void 0)&&o[t]))return this;const r=[].concat(this.filterMap[e][t]),a=r.indexOf(i);return a>=0&&r.splice(a,1),this.filterMap[e][t]=r.length===1?r[0]:r,r.length===0&&delete this.filterMap[e][t],this.deleteFieldIfEmpty(e),this}removeFilters(e,t){return this.filterMap[e]?(delete this.filterMap[e][t],this.deleteFieldIfEmpty(e),this):this}deleteFieldIfEmpty(e){const t=this.filterMap[e];t&&Object.keys(t).length===0&&delete this.filterMap[e]}setFilterMap(e){return this.filterMap={...e},this}mergeFilterMap(e){for(const[t,i]of Object.entries(e))for(const[o,r]of Object.entries(i))if(Array.isArray(r))for(const a of r)this.addFilter(t,o,a);else this.addFilter(t,o,r);return this}build(){return this.filterMap}}/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const no=window,sr=no.ShadowRoot&&(no.ShadyCSS===void 0||no.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,rr=Symbol(),Ur=new WeakMap;let Ya=class{constructor(e,t,i){if(this._$cssResult$=!0,i!==rr)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o;const t=this.t;if(sr&&e===void 0){const i=t!==void 0&&t.length===1;i&&(e=Ur.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),i&&Ur.set(t,e))}return e}toString(){return this.cssText}};const fl=s=>new Ya(typeof s=="string"?s:s+"",void 0,rr),g=(s,...e)=>{const t=s.length===1?s[0]:e.reduce((i,o,r)=>i+(a=>{if(a._$cssResult$===!0)return a.cssText;if(typeof a=="number")return a;throw Error("Value passed to 'css' function must be a 'css' function result: "+a+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(o)+s[r+1],s[0]);return new Ya(t,s,rr)},ml=(s,e)=>{sr?s.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet):e.forEach(t=>{const i=document.createElement("style"),o=no.litNonce;o!==void 0&&i.setAttribute("nonce",o),i.textContent=t.cssText,s.appendChild(i)})},Hr=sr?s=>s:s=>s instanceof CSSStyleSheet?(e=>{let t="";for(const i of e.cssRules)t+=i.cssText;return fl(t)})(s):s;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Ko;const go=window,Vr=go.trustedTypes,vl=Vr?Vr.emptyScript:"",Wr=go.reactiveElementPolyfillSupport,Cs={toAttribute(s,e){switch(e){case Boolean:s=s?vl:null;break;case Object:case Array:s=s==null?s:JSON.stringify(s)}return s},fromAttribute(s,e){let t=s;switch(e){case Boolean:t=s!==null;break;case Number:t=s===null?null:Number(s);break;case Object:case Array:try{t=JSON.parse(s)}catch{t=null}}return t}},Qa=(s,e)=>e!==s&&(e==e||s==s),Xo={attribute:!0,type:String,converter:Cs,reflect:!1,hasChanged:Qa},ks="finalized";let Qt=class extends HTMLElement{constructor(){super(),this._$Ei=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$El=null,this._$Eu()}static addInitializer(e){var t;this.finalize(),((t=this.h)!==null&&t!==void 0?t:this.h=[]).push(e)}static get observedAttributes(){this.finalize();const e=[];return this.elementProperties.forEach((t,i)=>{const o=this._$Ep(i,t);o!==void 0&&(this._$Ev.set(o,i),e.push(o))}),e}static createProperty(e,t=Xo){if(t.state&&(t.attribute=!1),this.finalize(),this.elementProperties.set(e,t),!t.noAccessor&&!this.prototype.hasOwnProperty(e)){const i=typeof e=="symbol"?Symbol():"__"+e,o=this.getPropertyDescriptor(e,i,t);o!==void 0&&Object.defineProperty(this.prototype,e,o)}}static getPropertyDescriptor(e,t,i){return{get(){return this[t]},set(o){const r=this[e];this[t]=o,this.requestUpdate(e,r,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)||Xo}static finalize(){if(this.hasOwnProperty(ks))return!1;this[ks]=!0;const e=Object.getPrototypeOf(this);if(e.finalize(),e.h!==void 0&&(this.h=[...e.h]),this.elementProperties=new Map(e.elementProperties),this._$Ev=new Map,this.hasOwnProperty("properties")){const t=this.properties,i=[...Object.getOwnPropertyNames(t),...Object.getOwnPropertySymbols(t)];for(const o of i)this.createProperty(o,t[o])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const i=new Set(e.flat(1/0).reverse());for(const o of i)t.unshift(Hr(o))}else e!==void 0&&t.push(Hr(e));return t}static _$Ep(e,t){const i=t.attribute;return i===!1?void 0:typeof i=="string"?i:typeof e=="string"?e.toLowerCase():void 0}_$Eu(){var e;this._$E_=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$Eg(),this.requestUpdate(),(e=this.constructor.h)===null||e===void 0||e.forEach(t=>t(this))}addController(e){var t,i;((t=this._$ES)!==null&&t!==void 0?t:this._$ES=[]).push(e),this.renderRoot!==void 0&&this.isConnected&&((i=e.hostConnected)===null||i===void 0||i.call(e))}removeController(e){var t;(t=this._$ES)===null||t===void 0||t.splice(this._$ES.indexOf(e)>>>0,1)}_$Eg(){this.constructor.elementProperties.forEach((e,t)=>{this.hasOwnProperty(t)&&(this._$Ei.set(t,this[t]),delete this[t])})}createRenderRoot(){var e;const t=(e=this.shadowRoot)!==null&&e!==void 0?e:this.attachShadow(this.constructor.shadowRootOptions);return ml(t,this.constructor.elementStyles),t}connectedCallback(){var e;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$ES)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostConnected)===null||i===void 0?void 0:i.call(t)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$ES)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostDisconnected)===null||i===void 0?void 0:i.call(t)})}attributeChangedCallback(e,t,i){this._$AK(e,i)}_$EO(e,t,i=Xo){var o;const r=this.constructor._$Ep(e,i);if(r!==void 0&&i.reflect===!0){const a=(((o=i.converter)===null||o===void 0?void 0:o.toAttribute)!==void 0?i.converter:Cs).toAttribute(t,i.type);this._$El=e,a==null?this.removeAttribute(r):this.setAttribute(r,a),this._$El=null}}_$AK(e,t){var i;const o=this.constructor,r=o._$Ev.get(e);if(r!==void 0&&this._$El!==r){const a=o.getPropertyOptions(r),l=typeof a.converter=="function"?{fromAttribute:a.converter}:((i=a.converter)===null||i===void 0?void 0:i.fromAttribute)!==void 0?a.converter:Cs;this._$El=r,this[r]=l.fromAttribute(t,a.type),this._$El=null}}requestUpdate(e,t,i){let o=!0;e!==void 0&&(((i=i||this.constructor.getPropertyOptions(e)).hasChanged||Qa)(this[e],t)?(this._$AL.has(e)||this._$AL.set(e,t),i.reflect===!0&&this._$El!==e&&(this._$EC===void 0&&(this._$EC=new Map),this._$EC.set(e,i))):o=!1),!this.isUpdatePending&&o&&(this._$E_=this._$Ej())}async _$Ej(){this.isUpdatePending=!0;try{await this._$E_}catch(t){Promise.reject(t)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var e;if(!this.isUpdatePending)return;this.hasUpdated,this._$Ei&&(this._$Ei.forEach((o,r)=>this[r]=o),this._$Ei=void 0);let t=!1;const i=this._$AL;try{t=this.shouldUpdate(i),t?(this.willUpdate(i),(e=this._$ES)===null||e===void 0||e.forEach(o=>{var r;return(r=o.hostUpdate)===null||r===void 0?void 0:r.call(o)}),this.update(i)):this._$Ek()}catch(o){throw t=!1,this._$Ek(),o}t&&this._$AE(i)}willUpdate(e){}_$AE(e){var t;(t=this._$ES)===null||t===void 0||t.forEach(i=>{var o;return(o=i.hostUpdated)===null||o===void 0?void 0:o.call(i)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$Ek(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$E_}shouldUpdate(e){return!0}update(e){this._$EC!==void 0&&(this._$EC.forEach((t,i)=>this._$EO(i,this[i],t)),this._$EC=void 0),this._$Ek()}updated(e){}firstUpdated(e){}};Qt[ks]=!0,Qt.elementProperties=new Map,Qt.elementStyles=[],Qt.shadowRootOptions={mode:"open"},Wr==null||Wr({ReactiveElement:Qt}),((Ko=go.reactiveElementVersions)!==null&&Ko!==void 0?Ko:go.reactiveElementVersions=[]).push("1.6.3");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Zo;const bo=window,ti=bo.trustedTypes,jr=ti?ti.createPolicy("lit-html",{createHTML:s=>s}):void 0,Ts="$lit$",ft=`lit$${(Math.random()+"").slice(9)}$`,Ka="?"+ft,gl=`<${Ka}>`,Pt=document,yo=()=>Pt.createComment(""),Ni=s=>s===null||typeof s!="object"&&typeof s!="function",Xa=Array.isArray,bl=s=>Xa(s)||typeof(s==null?void 0:s[Symbol.iterator])=="function",Jo=`[ 	
\f\r]`,Si=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Gr=/-->/g,qr=/>/g,xt=RegExp(`>|${Jo}(?:([^\\s"'>=/]+)(${Jo}*=${Jo}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Yr=/'/g,Qr=/"/g,Za=/^(?:script|style|textarea|title)$/i,Me=Symbol.for("lit-noChange"),J=Symbol.for("lit-nothing"),Kr=new WeakMap,Mt=Pt.createTreeWalker(Pt,129,null,!1);function Ja(s,e){if(!Array.isArray(s)||!s.hasOwnProperty("raw"))throw Error("invalid template strings array");return jr!==void 0?jr.createHTML(e):e}const yl=(s,e)=>{const t=s.length-1,i=[];let o,r=e===2?"<svg>":"",a=Si;for(let l=0;l<t;l++){const d=s[l];let p,h,f=-1,v=0;for(;v<d.length&&(a.lastIndex=v,h=a.exec(d),h!==null);)v=a.lastIndex,a===Si?h[1]==="!--"?a=Gr:h[1]!==void 0?a=qr:h[2]!==void 0?(Za.test(h[2])&&(o=RegExp("</"+h[2],"g")),a=xt):h[3]!==void 0&&(a=xt):a===xt?h[0]===">"?(a=o??Si,f=-1):h[1]===void 0?f=-2:(f=a.lastIndex-h[2].length,p=h[1],a=h[3]===void 0?xt:h[3]==='"'?Qr:Yr):a===Qr||a===Yr?a=xt:a===Gr||a===qr?a=Si:(a=xt,o=void 0);const y=a===xt&&s[l+1].startsWith("/>")?" ":"";r+=a===Si?d+gl:f>=0?(i.push(p),d.slice(0,f)+Ts+d.slice(f)+ft+y):d+ft+(f===-2?(i.push(void 0),l):y)}return[Ja(s,r+(s[t]||"<?>")+(e===2?"</svg>":"")),i]};let Ms=class en{constructor({strings:e,_$litType$:t},i){let o;this.parts=[];let r=0,a=0;const l=e.length-1,d=this.parts,[p,h]=yl(e,t);if(this.el=en.createElement(p,i),Mt.currentNode=this.el.content,t===2){const f=this.el.content,v=f.firstChild;v.remove(),f.append(...v.childNodes)}for(;(o=Mt.nextNode())!==null&&d.length<l;){if(o.nodeType===1){if(o.hasAttributes()){const f=[];for(const v of o.getAttributeNames())if(v.endsWith(Ts)||v.startsWith(ft)){const y=h[a++];if(f.push(v),y!==void 0){const x=o.getAttribute(y.toLowerCase()+Ts).split(ft),S=/([.?@])?(.*)/.exec(y);d.push({type:1,index:r,name:S[2],strings:x,ctor:S[1]==="."?Sl:S[1]==="?"?_l:S[1]==="@"?$l:Lo})}else d.push({type:6,index:r})}for(const v of f)o.removeAttribute(v)}if(Za.test(o.tagName)){const f=o.textContent.split(ft),v=f.length-1;if(v>0){o.textContent=ti?ti.emptyScript:"";for(let y=0;y<v;y++)o.append(f[y],yo()),Mt.nextNode(),d.push({type:2,index:++r});o.append(f[v],yo())}}}else if(o.nodeType===8)if(o.data===Ka)d.push({type:2,index:r});else{let f=-1;for(;(f=o.data.indexOf(ft,f+1))!==-1;)d.push({type:7,index:r}),f+=ft.length-1}r++}}static createElement(e,t){const i=Pt.createElement("template");return i.innerHTML=e,i}};function ii(s,e,t=s,i){var o,r,a,l;if(e===Me)return e;let d=i!==void 0?(o=t._$Co)===null||o===void 0?void 0:o[i]:t._$Cl;const p=Ni(e)?void 0:e._$litDirective$;return(d==null?void 0:d.constructor)!==p&&((r=d==null?void 0:d._$AO)===null||r===void 0||r.call(d,!1),p===void 0?d=void 0:(d=new p(s),d._$AT(s,t,i)),i!==void 0?((a=(l=t)._$Co)!==null&&a!==void 0?a:l._$Co=[])[i]=d:t._$Cl=d),d!==void 0&&(e=ii(s,d._$AS(s,e.values),d,i)),e}let wl=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){var t;const{el:{content:i},parts:o}=this._$AD,r=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:Pt).importNode(i,!0);Mt.currentNode=r;let a=Mt.nextNode(),l=0,d=0,p=o[0];for(;p!==void 0;){if(l===p.index){let h;p.type===2?h=new ar(a,a.nextSibling,this,e):p.type===1?h=new p.ctor(a,p.name,p.strings,this,e):p.type===6&&(h=new Cl(a,this,e)),this._$AV.push(h),p=o[++d]}l!==(p==null?void 0:p.index)&&(a=Mt.nextNode(),l++)}return Mt.currentNode=Pt,r}v(e){let t=0;for(const i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}},ar=class tn{constructor(e,t,i,o){var r;this.type=2,this._$AH=J,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=o,this._$Cp=(r=o==null?void 0:o.isConnected)===null||r===void 0||r}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cp}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=ii(this,e,t),Ni(e)?e===J||e==null||e===""?(this._$AH!==J&&this._$AR(),this._$AH=J):e!==this._$AH&&e!==Me&&this._(e):e._$litType$!==void 0?this.g(e):e.nodeType!==void 0?this.$(e):bl(e)?this.T(e):this._(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==J&&Ni(this._$AH)?this._$AA.nextSibling.data=e:this.$(Pt.createTextNode(e)),this._$AH=e}g(e){var t;const{values:i,_$litType$:o}=e,r=typeof o=="number"?this._$AC(e):(o.el===void 0&&(o.el=Ms.createElement(Ja(o.h,o.h[0]),this.options)),o);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===r)this._$AH.v(i);else{const a=new wl(r,this),l=a.u(this.options);a.v(i),this.$(l),this._$AH=a}}_$AC(e){let t=Kr.get(e.strings);return t===void 0&&Kr.set(e.strings,t=new Ms(e)),t}T(e){Xa(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,o=0;for(const r of e)o===t.length?t.push(i=new tn(this.k(yo()),this.k(yo()),this,this.options)):i=t[o],i._$AI(r),o++;o<t.length&&(this._$AR(i&&i._$AB.nextSibling,o),t.length=o)}_$AR(e=this._$AA.nextSibling,t){var i;for((i=this._$AP)===null||i===void 0||i.call(this,!1,!0,t);e&&e!==this._$AB;){const o=e.nextSibling;e.remove(),e=o}}setConnected(e){var t;this._$AM===void 0&&(this._$Cp=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}},Lo=class{constructor(e,t,i,o,r){this.type=1,this._$AH=J,this._$AN=void 0,this.element=e,this.name=t,this._$AM=o,this.options=r,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=J}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,i,o){const r=this.strings;let a=!1;if(r===void 0)e=ii(this,e,t,0),a=!Ni(e)||e!==this._$AH&&e!==Me,a&&(this._$AH=e);else{const l=e;let d,p;for(e=r[0],d=0;d<r.length-1;d++)p=ii(this,l[i+d],t,d),p===Me&&(p=this._$AH[d]),a||(a=!Ni(p)||p!==this._$AH[d]),p===J?e=J:e!==J&&(e+=(p??"")+r[d+1]),this._$AH[d]=p}a&&!o&&this.j(e)}j(e){e===J?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},Sl=class extends Lo{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===J?void 0:e}};const xl=ti?ti.emptyScript:"";let _l=class extends Lo{constructor(){super(...arguments),this.type=4}j(e){e&&e!==J?this.element.setAttribute(this.name,xl):this.element.removeAttribute(this.name)}},$l=class extends Lo{constructor(e,t,i,o,r){super(e,t,i,o,r),this.type=5}_$AI(e,t=this){var i;if((e=(i=ii(this,e,t,0))!==null&&i!==void 0?i:J)===Me)return;const o=this._$AH,r=e===J&&o!==J||e.capture!==o.capture||e.once!==o.once||e.passive!==o.passive,a=e!==J&&(o===J||r);r&&this.element.removeEventListener(this.name,this,o),a&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,i;typeof this._$AH=="function"?this._$AH.call((i=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&i!==void 0?i:this.element,e):this._$AH.handleEvent(e)}},Cl=class{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){ii(this,e)}};const kl={I:ar},Xr=bo.litHtmlPolyfillSupport;Xr==null||Xr(Ms,ar),((Zo=bo.litHtmlVersions)!==null&&Zo!==void 0?Zo:bo.litHtmlVersions=[]).push("2.8.0");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var es;const wo=window,oi=wo.trustedTypes,Zr=oi?oi.createPolicy("lit-html",{createHTML:s=>s}):void 0,Es="$lit$",mt=`lit$${(Math.random()+"").slice(9)}$`,on="?"+mt,Tl=`<${on}>`,Bt=document,Ui=()=>Bt.createComment(""),Hi=s=>s===null||typeof s!="object"&&typeof s!="function",sn=Array.isArray,Ml=s=>sn(s)||typeof(s==null?void 0:s[Symbol.iterator])=="function",ts=`[ 	
\f\r]`,xi=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Jr=/-->/g,ea=/>/g,_t=RegExp(`>|${ts}(?:([^\\s"'>=/]+)(${ts}*=${ts}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),ta=/'/g,ia=/"/g,rn=/^(?:script|style|textarea|title)$/i,an=s=>(e,...t)=>({_$litType$:s,strings:e,values:t}),u=an(1),N=an(2),si=Symbol.for("lit-noChange"),b=Symbol.for("lit-nothing"),oa=new WeakMap,Et=Bt.createTreeWalker(Bt,129,null,!1);function nn(s,e){if(!Array.isArray(s)||!s.hasOwnProperty("raw"))throw Error("invalid template strings array");return Zr!==void 0?Zr.createHTML(e):e}const El=(s,e)=>{const t=s.length-1,i=[];let o,r=e===2?"<svg>":"",a=xi;for(let l=0;l<t;l++){const d=s[l];let p,h,f=-1,v=0;for(;v<d.length&&(a.lastIndex=v,h=a.exec(d),h!==null);)v=a.lastIndex,a===xi?h[1]==="!--"?a=Jr:h[1]!==void 0?a=ea:h[2]!==void 0?(rn.test(h[2])&&(o=RegExp("</"+h[2],"g")),a=_t):h[3]!==void 0&&(a=_t):a===_t?h[0]===">"?(a=o??xi,f=-1):h[1]===void 0?f=-2:(f=a.lastIndex-h[2].length,p=h[1],a=h[3]===void 0?_t:h[3]==='"'?ia:ta):a===ia||a===ta?a=_t:a===Jr||a===ea?a=xi:(a=_t,o=void 0);const y=a===_t&&s[l+1].startsWith("/>")?" ":"";r+=a===xi?d+Tl:f>=0?(i.push(p),d.slice(0,f)+Es+d.slice(f)+mt+y):d+mt+(f===-2?(i.push(void 0),l):y)}return[nn(s,r+(s[t]||"<?>")+(e===2?"</svg>":"")),i]};class Vi{constructor({strings:e,_$litType$:t},i){let o;this.parts=[];let r=0,a=0;const l=e.length-1,d=this.parts,[p,h]=El(e,t);if(this.el=Vi.createElement(p,i),Et.currentNode=this.el.content,t===2){const f=this.el.content,v=f.firstChild;v.remove(),f.append(...v.childNodes)}for(;(o=Et.nextNode())!==null&&d.length<l;){if(o.nodeType===1){if(o.hasAttributes()){const f=[];for(const v of o.getAttributeNames())if(v.endsWith(Es)||v.startsWith(mt)){const y=h[a++];if(f.push(v),y!==void 0){const x=o.getAttribute(y.toLowerCase()+Es).split(mt),S=/([.?@])?(.*)/.exec(y);d.push({type:1,index:r,name:S[2],strings:x,ctor:S[1]==="."?Dl:S[1]==="?"?zl:S[1]==="@"?Fl:zo})}else d.push({type:6,index:r})}for(const v of f)o.removeAttribute(v)}if(rn.test(o.tagName)){const f=o.textContent.split(mt),v=f.length-1;if(v>0){o.textContent=oi?oi.emptyScript:"";for(let y=0;y<v;y++)o.append(f[y],Ui()),Et.nextNode(),d.push({type:2,index:++r});o.append(f[v],Ui())}}}else if(o.nodeType===8)if(o.data===on)d.push({type:2,index:r});else{let f=-1;for(;(f=o.data.indexOf(mt,f+1))!==-1;)d.push({type:7,index:r}),f+=mt.length-1}r++}}static createElement(e,t){const i=Bt.createElement("template");return i.innerHTML=e,i}}function ri(s,e,t=s,i){var o,r,a,l;if(e===si)return e;let d=i!==void 0?(o=t._$Co)===null||o===void 0?void 0:o[i]:t._$Cl;const p=Hi(e)?void 0:e._$litDirective$;return(d==null?void 0:d.constructor)!==p&&((r=d==null?void 0:d._$AO)===null||r===void 0||r.call(d,!1),p===void 0?d=void 0:(d=new p(s),d._$AT(s,t,i)),i!==void 0?((a=(l=t)._$Co)!==null&&a!==void 0?a:l._$Co=[])[i]=d:t._$Cl=d),d!==void 0&&(e=ri(s,d._$AS(s,e.values),d,i)),e}let Al=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){var t;const{el:{content:i},parts:o}=this._$AD,r=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:Bt).importNode(i,!0);Et.currentNode=r;let a=Et.nextNode(),l=0,d=0,p=o[0];for(;p!==void 0;){if(l===p.index){let h;p.type===2?h=new qi(a,a.nextSibling,this,e):p.type===1?h=new p.ctor(a,p.name,p.strings,this,e):p.type===6&&(h=new Pl(a,this,e)),this._$AV.push(h),p=o[++d]}l!==(p==null?void 0:p.index)&&(a=Et.nextNode(),l++)}return Et.currentNode=Bt,r}v(e){let t=0;for(const i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}};class qi{constructor(e,t,i,o){var r;this.type=2,this._$AH=b,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=o,this._$Cp=(r=o==null?void 0:o.isConnected)===null||r===void 0||r}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cp}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=ri(this,e,t),Hi(e)?e===b||e==null||e===""?(this._$AH!==b&&this._$AR(),this._$AH=b):e!==this._$AH&&e!==si&&this._(e):e._$litType$!==void 0?this.g(e):e.nodeType!==void 0?this.$(e):Ml(e)?this.T(e):this._(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==b&&Hi(this._$AH)?this._$AA.nextSibling.data=e:this.$(Bt.createTextNode(e)),this._$AH=e}g(e){var t;const{values:i,_$litType$:o}=e,r=typeof o=="number"?this._$AC(e):(o.el===void 0&&(o.el=Vi.createElement(nn(o.h,o.h[0]),this.options)),o);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===r)this._$AH.v(i);else{const a=new Al(r,this),l=a.u(this.options);a.v(i),this.$(l),this._$AH=a}}_$AC(e){let t=oa.get(e.strings);return t===void 0&&oa.set(e.strings,t=new Vi(e)),t}T(e){sn(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,o=0;for(const r of e)o===t.length?t.push(i=new qi(this.k(Ui()),this.k(Ui()),this,this.options)):i=t[o],i._$AI(r),o++;o<t.length&&(this._$AR(i&&i._$AB.nextSibling,o),t.length=o)}_$AR(e=this._$AA.nextSibling,t){var i;for((i=this._$AP)===null||i===void 0||i.call(this,!1,!0,t);e&&e!==this._$AB;){const o=e.nextSibling;e.remove(),e=o}}setConnected(e){var t;this._$AM===void 0&&(this._$Cp=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}}class zo{constructor(e,t,i,o,r){this.type=1,this._$AH=b,this._$AN=void 0,this.element=e,this.name=t,this._$AM=o,this.options=r,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=b}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,i,o){const r=this.strings;let a=!1;if(r===void 0)e=ri(this,e,t,0),a=!Hi(e)||e!==this._$AH&&e!==si,a&&(this._$AH=e);else{const l=e;let d,p;for(e=r[0],d=0;d<r.length-1;d++)p=ri(this,l[i+d],t,d),p===si&&(p=this._$AH[d]),a||(a=!Hi(p)||p!==this._$AH[d]),p===b?e=b:e!==b&&(e+=(p??"")+r[d+1]),this._$AH[d]=p}a&&!o&&this.j(e)}j(e){e===b?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}let Dl=class extends zo{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===b?void 0:e}};const Ll=oi?oi.emptyScript:"";let zl=class extends zo{constructor(){super(...arguments),this.type=4}j(e){e&&e!==b?this.element.setAttribute(this.name,Ll):this.element.removeAttribute(this.name)}};class Fl extends zo{constructor(e,t,i,o,r){super(e,t,i,o,r),this.type=5}_$AI(e,t=this){var i;if((e=(i=ri(this,e,t,0))!==null&&i!==void 0?i:b)===si)return;const o=this._$AH,r=e===b&&o!==b||e.capture!==o.capture||e.once!==o.once||e.passive!==o.passive,a=e!==b&&(o===b||r);r&&this.element.removeEventListener(this.name,this,o),a&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,i;typeof this._$AH=="function"?this._$AH.call((i=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&i!==void 0?i:this.element,e):this._$AH.handleEvent(e)}}class Pl{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){ri(this,e)}}const sa=wo.litHtmlPolyfillSupport;sa==null||sa(Vi,qi),((es=wo.litHtmlVersions)!==null&&es!==void 0?es:wo.litHtmlVersions=[]).push("2.8.0");const lo=(s,e,t)=>{var i,o;const r=(i=t==null?void 0:t.renderBefore)!==null&&i!==void 0?i:e;let a=r._$litPart$;if(a===void 0){const l=(o=t==null?void 0:t.renderBefore)!==null&&o!==void 0?o:null;r._$litPart$=a=new qi(e.insertBefore(Ui(),l),l,void 0,t??{})}return a._$AI(s),a};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var is,os;let I=class extends Qt{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e,t;const i=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=i.firstChild),i}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=lo(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!1)}render(){return si}};I.finalized=!0,I._$litElement$=!0,(is=globalThis.litElementHydrateSupport)===null||is===void 0||is.call(globalThis,{LitElement:I});const ra=globalThis.litElementPolyfillSupport;ra==null||ra({LitElement:I});((os=globalThis.litElementVersions)!==null&&os!==void 0?os:globalThis.litElementVersions=[]).push("3.3.3");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const B=s=>e=>typeof e=="function"?((t,i)=>(customElements.define(t,i),i))(s,e):((t,i)=>{const{kind:o,elements:r}=i;return{kind:o,elements:r,finisher(a){customElements.define(t,a)}}})(s,e);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Bl=(s,e)=>e.kind==="method"&&e.descriptor&&!("value"in e.descriptor)?{...e,finisher(t){t.createProperty(e.key,s)}}:{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){typeof e.initializer=="function"&&(this[e.key]=e.initializer.call(this))},finisher(t){t.createProperty(e.key,s)}},Rl=(s,e,t)=>{e.constructor.createProperty(t,s)};function c(s){return(e,t)=>t!==void 0?Rl(s,e,t):Bl(s,e)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function z(s){return c({...s,state:!0})}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ln=({finisher:s,descriptor:e})=>(t,i)=>{var o;if(i===void 0){const r=(o=t.originalKey)!==null&&o!==void 0?o:t.key,a=e!=null?{kind:"method",placement:"prototype",key:r,descriptor:e(t.key)}:{...t,key:r};return s!=null&&(a.finisher=function(l){s(l,r)}),a}{const r=t.constructor;e!==void 0&&Object.defineProperty(t,i,e(i)),s==null||s(r,i)}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function G(s,e){return ln({descriptor:t=>({get(){var o,r;return(r=(o=this.renderRoot)===null||o===void 0?void 0:o.querySelector(s))!==null&&r!==void 0?r:null},enumerable:!0,configurable:!0})})}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Il(s){return ln({descriptor:e=>({get(){var t,i;return(i=(t=this.renderRoot)===null||t===void 0?void 0:t.querySelectorAll(s))!==null&&i!==void 0?i:[]},enumerable:!0,configurable:!0})})}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var ss;((ss=window.HTMLSlotElement)===null||ss===void 0?void 0:ss.prototype.assignedElements)!=null;class Ol{constructor(){this.resizeObserver=new ResizeObserver(e=>{window.requestAnimationFrame(()=>{for(const t of e){const i=this.resizeHandlers.get(t.target);i==null||i.forEach(o=>{o.handleResize(t)})}})}),this.resizeHandlers=new Map}shutdown(){this.resizeHandlers.forEach((e,t)=>{this.resizeObserver.unobserve(t)}),this.resizeHandlers.clear()}addObserver(e){var t;const i=(t=this.resizeHandlers.get(e.target))!==null&&t!==void 0?t:new Set;i.add(e.handler),this.resizeHandlers.set(e.target,i),this.resizeObserver.observe(e.target,e.options)}removeObserver(e){const t=this.resizeHandlers.get(e.target);t&&(t.delete(e.handler),t.size===0&&(this.resizeObserver.unobserve(e.target),this.resizeHandlers.delete(e.target)))}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ue={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4},fi=s=>(...e)=>({_$litDirective$:s,values:e});let mi=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}};/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const at=fi(class extends mi{constructor(s){var e;if(super(s),s.type!==Ue.ATTRIBUTE||s.name!=="class"||((e=s.strings)===null||e===void 0?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(s){return" "+Object.keys(s).filter(e=>s[e]).join(" ")+" "}update(s,[e]){var t,i;if(this.it===void 0){this.it=new Set,s.strings!==void 0&&(this.nt=new Set(s.strings.join(" ").split(/\s/).filter(r=>r!=="")));for(const r in e)e[r]&&!(!((t=this.nt)===null||t===void 0)&&t.has(r))&&this.it.add(r);return this.render(e)}const o=s.element.classList;this.it.forEach(r=>{r in e||(o.remove(r),this.it.delete(r))});for(const r in e){const a=!!e[r];a===this.it.has(r)||!((i=this.nt)===null||i===void 0)&&i.has(r)||(a?(o.add(r),this.it.add(r)):(o.remove(r),this.it.delete(r)))}return Me}});/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Nl=(s,...e)=>({strTag:!0,strings:s,values:e}),Ze=Nl,Ul=s=>typeof s!="string"&&"strTag"in s,Hl=(s,e,t)=>{let i=s[0];for(let o=1;o<s.length;o++)i+=e[o-1],i+=s[o];return i};/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Vl=s=>Ul(s)?Hl(s.strings,s.values):s;let C=Vl;/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class Wl{constructor(){this.settled=!1,this.promise=new Promise((e,t)=>{this._resolve=e,this._reject=t})}resolve(e){this.settled=!0,this._resolve(e)}reject(e){this.settled=!0,this._reject(e)}}/**
 * @license
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let jl=new Wl;jl.resolve();/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{I:Gl}=kl,dn=s=>s.strings===void 0,aa=()=>document.createComment(""),_i=(s,e,t)=>{var i;const o=s._$AA.parentNode,r=e===void 0?s._$AB:e._$AA;if(t===void 0){const a=o.insertBefore(aa(),r),l=o.insertBefore(aa(),r);t=new Gl(a,l,s,s.options)}else{const a=t._$AB.nextSibling,l=t._$AM,d=l!==s;if(d){let p;(i=t._$AQ)===null||i===void 0||i.call(t,s),t._$AM=s,t._$AP!==void 0&&(p=s._$AU)!==l._$AU&&t._$AP(p)}if(a!==r||d){let p=t._$AA;for(;p!==a;){const h=p.nextSibling;o.insertBefore(p,r),p=h}}}return t},$t=(s,e,t=s)=>(s._$AI(e,t),s),ql={},cn=(s,e=ql)=>s._$AH=e,Yl=s=>s._$AH,rs=s=>{var e;(e=s._$AP)===null||e===void 0||e.call(s,!1,!0);let t=s._$AA;const i=s._$AB.nextSibling;for(;t!==i;){const o=t.nextSibling;t.remove(),t=o}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const na=(s,e,t)=>{const i=new Map;for(let o=e;o<=t;o++)i.set(s[o],o);return i},nr=fi(class extends mi{constructor(s){if(super(s),s.type!==Ue.CHILD)throw Error("repeat() can only be used in text expressions")}ct(s,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);const o=[],r=[];let a=0;for(const l of s)o[a]=i?i(l,a):a,r[a]=t(l,a),a++;return{values:r,keys:o}}render(s,e,t){return this.ct(s,e,t).values}update(s,[e,t,i]){var o;const r=Yl(s),{values:a,keys:l}=this.ct(e,t,i);if(!Array.isArray(r))return this.ut=l,a;const d=(o=this.ut)!==null&&o!==void 0?o:this.ut=[],p=[];let h,f,v=0,y=r.length-1,x=0,S=a.length-1;for(;v<=y&&x<=S;)if(r[v]===null)v++;else if(r[y]===null)y--;else if(d[v]===l[x])p[x]=$t(r[v],a[x]),v++,x++;else if(d[y]===l[S])p[S]=$t(r[y],a[S]),y--,S--;else if(d[v]===l[S])p[S]=$t(r[v],a[S]),_i(s,p[S+1],r[v]),v++,S--;else if(d[y]===l[x])p[x]=$t(r[y],a[x]),_i(s,r[v],r[y]),y--,x++;else if(h===void 0&&(h=na(l,x,S),f=na(d,v,y)),h.has(d[v]))if(h.has(d[y])){const k=f.get(l[x]),D=k!==void 0?r[k]:null;if(D===null){const E=_i(s,r[v]);$t(E,a[x]),p[x]=E}else p[x]=$t(D,a[x]),_i(s,r[v],D),r[k]=null;x++}else rs(r[y]),y--;else rs(r[v]),v++;for(;x<=S;){const k=_i(s,p[S+1]);$t(k,a[x]),p[x++]=k}for(;v<=y;){const k=r[v++];k!==null&&rs(k)}return this.ut=l,cn(s,p),Me}});function to(s,e,t){return Array.from({length:(e-s)/t+1},(i,o)=>s+o*t)}let lt=class extends I{constructor(){super(...arguments),this.itemCount=0,this.scrollOptimizationsDisabled=!1,this.intersectionObserver=new IntersectionObserver(e=>{e.forEach(t=>{if(t.target===this.sentinel){t.isIntersecting&&this.dispatchEvent(new Event("scrollThresholdReached"));return}const o=t.target.dataset.cellIndex;if(!o)return;const r=parseInt(o,10);t.isIntersecting?this.visibleCellIndices.add(r):this.visibleCellIndices.delete(r)}),this.scrollOptimizationsDisabled||this.processVisibleCells()}),this.renderedCellIndices=new Set,this.visibleCellIndices=new Set,this.placeholderCellIndices=new Set}reload(){to(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.removeCell(t)),this.renderedCellIndices.clear(),this.visibleCellIndices.clear(),this.placeholderCellIndices.clear(),this.setupObservations()}refreshCell(e){this.removeCell(e),this.bufferRange.includes(e)&&this.renderCellBuffer([e])}refreshAllVisibleCells(){this.bufferRange.forEach(e=>this.removeCell(e)),this.renderCellBuffer(this.bufferRange)}scrollToCell(e,t){const i=this.cellContainers[e];if(!i)return!1;const o=t?"smooth":"auto";return i.scrollIntoView({behavior:o}),!0}getVisibleCellIndices(){return Array.from(this.visibleCellIndices)}updated(e){(e.has("itemCount")||e.has("scrollOptimizationsDisabled"))&&this.setupObservations()}disconnectedCallback(){this.intersectionObserver.disconnect()}setupObservations(){this.setupIntersectionObserver()}setupIntersectionObserver(){this.intersectionObserver.disconnect(),this.sentinel&&this.intersectionObserver.observe(this.sentinel),this.scrollOptimizationsDisabled?(to(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.visibleCellIndices.add(t)),this.processVisibleCells()):this.cellContainers.forEach(e=>this.intersectionObserver.observe(e))}render(){var e;const t=this.itemCount-1,i=to(0,t,1),o=(e=this.ariaLandmarkLabel)!==null&&e!==void 0?e:b;return u`
    ...
    `}};n([c({type:Number})],lt.prototype,"itemCount",void 0);n([c({type:Object})],lt.prototype,"cellProvider",void 0);n([c({type:Object})],lt.prototype,"placeholderCellTemplate",void 0);n([c({type:Boolean})],lt.prototype,"scrollOptimizationsDisabled",void 0);n([c({type:String})],lt.prototype,"ariaLandmarkLabel",void 0);n([G("#sentinel")],lt.prototype,"sentinel",void 0);n([Il(".cell-container")],lt.prototype,"cellContainers",void 0);lt=n([B("infinite-scroller")],lt);function Ql(s){return s==null?void 0:s.replace(/%22%22(?!%22%22)(.+?)%22%22/g,"%22$1%22")}function Kl(s){var e,t,i;return((e=s==null?void 0:s.rawMetadata)===null||e===void 0?void 0:e.hit_type)==="favorited_search"?"search":(i=(t=s.mediatype)===null||t===void 0?void 0:t.value)!==null&&i!==void 0?i:"data"}const Xl=N`
  <svg
    viewBox="0 0 100 100"
...
`,Jl={"login-required":C("Log in to view this item"),"content-warning":C("Content may be inappropriate")},hn={"login-required":Xl,"content-warning":Zl};class So{constructor(e,t="unknown"){var i,o,r,a,l,d,p,h,f,v,y,x,S,k,D,E,A,R,V,re,De,ve,ce,Te,Q,qe,Ye,K,he,Le,bt,Rt,vi,It,ie,Ot,ae,Nt,X,it,yt,Ut,wt;const gi=this.getFlags(e);this.adIds=(i=e.ad_id)===null||i===void 0?void 0:i.values,this.averageRating=(o=e.avg_rating)===null||o===void 0?void 0:o.value,this.captureDates=(r=e.capture_dates)===null||r===void 0?void 0:r.values,this.checked=!1,this.collections=(l=(a=e.collection)===null||a===void 0?void 0:a.values)!==null&&l!==void 0?l:[],this.collectionFilesCount=(p=(d=e.collection_files_count)===null||d===void 0?void 0:d.value)!==null&&p!==void 0?p:0,this.collectionSize=(f=(h=e.collection_size)===null||h===void 0?void 0:h.value)!==null&&f!==void 0?f:0,this.commentCount=(y=(v=e.num_reviews)===null||v===void 0?void 0:v.value)!==null&&y!==void 0?y:0,this.creator=(x=e.creator)===null||x===void 0?void 0:x.value,this.creators=(k=(S=e.creator)===null||S===void 0?void 0:S.values)!==null&&k!==void 0?k:[],this.dateAdded=(D=e.addeddate)===null||D===void 0?void 0:D.value,this.dateArchived=(E=e.publicdate)===null||E===void 0?void 0:E.value,this.datePublished=(A=e.date)===null||A===void 0?void 0:A.value,this.dateReviewed=(R=e.reviewdate)===null||R===void 0?void 0:R.value,this.description=(V=e.description)===null||V===void 0?void 0:V.values.join(`
`),this.factChecks=(re=e.factcheck)===null||re===void 0?void 0:re.values,this.favCount=(ve=(De=e.num_favorites)===null||De===void 0?void 0:De.value)!==null&&ve!==void 0?ve:0,this.hitRequestSource=t,this.hitType=(ce=e.rawMetadata)===null||ce===void 0?void 0:ce.hit_type,this.href=Ql((Q=(Te=e.review)===null||Te===void 0?void 0:Te.__href__)!==null&&Q!==void 0?Q:(qe=e.__href__)===null||qe===void 0?void 0:qe.value),this.identifier=So.cleanIdentifier(e.identifier),this.isClip=(Ye=e.is_clip)===null||Ye===void 0?void 0:Ye.value,this.issue=(K=e.issue)===null||K===void 0?void 0:K.value,this.itemCount=(Le=(he=e.item_count)===null||he===void 0?void 0:he.value)!==null&&Le!==void 0?Le:0,this.mediatype=Kl(e),this.review=e.review,this.snippets=(Rt=(bt=e.highlight)===null||bt===void 0?void 0:bt.values)!==null&&Rt!==void 0?Rt:[],this.source=(vi=e.source)===null||vi===void 0?void 0:vi.value,this.subjects=(ie=(It=e.subject)===null||It===void 0?void 0:It.values)!==null&&ie!==void 0?ie:[],this.thumbnailUrl=(Ot=e.__img__)===null||Ot===void 0?void 0:Ot.value,this.title=(Nt=(ae=e.title)===null||ae===void 0?void 0:ae.value)!==null&&Nt!==void 0?Nt:"",this.tvClipCount=(it=(X=e.num_clips)===null||X===void 0?void 0:X.value)!==null&&it!==void 0?it:0,this.volume=(yt=e.volume)===null||yt===void 0?void 0:yt.value,this.viewCount=(Ut=e.downloads)===null||Ut===void 0?void 0:Ut.value,this.weeklyViewCount=(wt=e.week)===null||wt===void 0?void 0:wt.value,this.loginRequired=gi.loginRequired,this.contentWarning=gi.contentWarning}clone(){const e=new So({});return e.adIds=this.adIds,e.averageRating=this.averageRating,e.captureDates=this.captureDates,e.checked=this.checked,e.collections=this.collections,e.collectionFilesCount=this.collectionFilesCount,e.collectionSize=this.collectionSize,e.commentCount=this.commentCount,e.creator=this.creator,e.creators=this.creators,e.dateStr=this.dateStr,e.dateAdded=this.dateAdded,e.dateArchived=this.dateArchived,e.datePublished=this.datePublished,e.dateReviewed=this.dateReviewed,e.description=this.description,e.factChecks=this.factChecks,e.favCount=this.favCount,e.hitRequestSource=this.hitRequestSource,e.hitType=this.hitType,e.href=this.href,e.identifier=this.identifier,e.isClip=this.isClip,e.issue=this.issue,e.itemCount=this.itemCount,e.mediatype=this.mediatype,e.snippets=this.snippets,e.source=this.source,e.subjects=this.subjects,e.thumbnailUrl=this.thumbnailUrl,e.title=this.title,e.tvClipCount=this.tvClipCount,e.volume=this.volume,e.viewCount=this.viewCount,e.weeklyViewCount=this.weeklyViewCount,e.loginRequired=this.loginRequired,e.contentWarning=this.contentWarning,e}get isTvSearchResult(){return this.hitType==="tv_clip"&&this.hitRequestSource==="search_query"}getFlags(e){var t,i,o,r;const a={loginRequired:!1,contentWarning:!1};if(!((t=e.collection)===null||t===void 0)&&t.values.length&&((i=e.mediatype)===null||i===void 0?void 0:i.value)!=="collection"){for(const l of(r=(o=e.collection)===null||o===void 0?void 0:o.values)!==null&&r!==void 0?r:[])if(l==="loggedin"&&(a.loginRequired=!0,a.contentWarning)||l==="no-preview"&&(a.contentWarning=!0,a.loginRequired))break}return a}static cleanIdentifier(e){var t;const i=(t=e==null?void 0:e.indexOf("|"))!==null&&t!==void 0?t:-1;return i>0?e==null?void 0:e.slice(0,i):e}}var $;(function(s){s.default="default",s.unrecognized="unrecognized",s.relevance="relevance",s.alltimeview="alltimeview",s.weeklyview="weeklyview",s.title="title",s.date="date",s.datearchived="datearchived",s.datereviewed="datereviewed",s.dateadded="dateadded",s.datefavorited="datefavorited",s.creator="creator"})($||($={}));const la=[$.weeklyview,$.alltimeview],da=[$.datefavorited,$.date,$.datearchived,$.datereviewed,$.dateadded],Se={[$.default]:{field:$.default,defaultSortDirection:null,canSetDirection:!1,shownInSortBar:!1,shownInURL:!1,handledBySearchService:!1,displayName:"",urlNames:["",null,void 0]},[$.unrecognized]:{field:$.unrecognized,defaultSortDirection:null,canSetDirection:!0,shownInSortBar:!1,shownInURL:!1,handledBySearchService:!0,displayName:"",urlNames:[]},[$.relevance]:{field:$.relevance,defaultSortDirection:null,canSetDirection:!1,shownInSortBar:!0,shownInURL:!1,handledBySearchService:!1,displayName:"Relevance",urlNames:["_score"]},[$.alltimeview]:{field:$.alltimeview,defaultSortDirection:"desc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"downloads",displayName:"All-time views",urlNames:["downloads"]},[$.weeklyview]:{field:$.weeklyview,defaultSortDirection:"desc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"week",displayName:"Weekly views",urlNames:["week"]},[$.title]:{field:$.title,defaultSortDirection:"asc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"titleSorter",displayName:"Title",urlNames:["title","titleSorter"]},[$.date]:{field:$.date,defaultSortDirection:"desc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"date",displayName:"Date published",urlNames:["date"]},[$.datearchived]:{field:$.datearchived,defaultSortDirection:"desc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"publicdate",displayName:"Date archived",urlNames:["publicdate"]},[$.datereviewed]:{field:$.datereviewed,defaultSortDirection:"desc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"reviewdate",displayName:"Date reviewed",urlNames:["reviewdate"]},[$.dateadded]:{field:$.dateadded,defaultSortDirection:"desc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"addeddate",displayName:"Date added",urlNames:["addeddate"]},[$.datefavorited]:{field:$.datefavorited,defaultSortDirection:"desc",canSetDirection:!1,shownInSortBar:!0,shownInURL:!1,handledBySearchService:!1,searchServiceKey:"favoritedate",displayName:"Date favorited",urlNames:["favoritedate"]},[$.creator]:{field:$.creator,defaultSortDirection:"asc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"creatorSorter",displayName:"Creator",urlNames:["creator","creatorSorter"]}};function pn(s){var e;return(e=Object.values(Se).find(t=>t.urlNames.some(i=>s===i)))!==null&&e!==void 0?e:Se[$.unrecognized]}const Fo={[$.relevance]:!0,[$.weeklyview]:!0,[$.alltimeview]:!0,[$.title]:!0,[$.datefavorited]:!1,[$.date]:!0,[$.datearchived]:!0,[$.datereviewed]:!0,[$.dateadded]:!0,[$.creator]:!0,[$.default]:!1,[$.unrecognized]:!1},ed={...Fo,[$.datefavorited]:!0},td={...Fo,[$.date]:!1,[$.datereviewed]:!1,[$.dateadded]:!1},id={uploads:$.datearchived,reviews:$.datereviewed,collections:$.datearchived,web_archives:$.datearchived},od={title:"firstTitle",creator:"firstCreator"},nt=()=>({subject:{},lending:{},mediatype:{},language:{},creator:{},collection:{},year:{},program:{},person:{},sponsor:{}}),sd={all:"",commercials:"only_commercials",factchecks:"only_factchecks",quotes:"only_quotes"},rd={only_commercials:"commercials",only_factchecks:"factchecks",only_quotes:"quotes"},un=["mediatype","year","subject","collection","creator","language"],ad=["program","creator","year","subject","collection","person","sponsor","language"],xo={subject:"Subject",lending:"Availability",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year",program:"Program",person:"Person",sponsor:"Sponsor"},Bi={subject:W.COUNT,lending:W.COUNT,mediatype:W.COUNT,language:W.COUNT,creator:W.COUNT,collection:W.COUNT,year:W.NUMERIC,program:W.COUNT,person:W.COUNT,sponsor:W.COUNT},nd={subject:W.ALPHABETICAL,lending:W.ALPHABETICAL,mediatype:W.ALPHABETICAL,language:W.ALPHABETICAL,creator:W.ALPHABETICAL,collection:W.ALPHABETICAL,year:W.NUMERIC,program:W.ALPHABETICAL,person:W.ALPHABETICAL,sponsor:W.ALPHABETICAL},ld={is_lendable:!0,is_borrowable:!1,available_to_borrow:!0,is_browsable:!1,available_to_browse:!1,is_readable:!0,available_to_waitlist:!1},ca={is_lendable:"Lending Library",available_to_borrow:"Borrow 14 Days",is_readable:"Always Available"},Po={deemphasize:!0,community:!0,stream_only:!0,samples_only:!0,test_collection:!0,printdisabled:!0,"openlibrary-ol":!0,nationalemergencylibrary:!0,china:!0,americana:!0,toronto:!0};/*! typescript-cookie v1.0.6 | MIT */const fn=s=>encodeURIComponent(s).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),mn=s=>encodeURIComponent(s).replace(/%(2[346BF]|3[AC-F]|40|5[BDE]|60|7[BCD])/g,decodeURIComponent),lr=decodeURIComponent,dr=s=>(s[0]==='"'&&(s=s.slice(1,-1)),s.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent));function dd(s){return s=Object.assign({},s),typeof s.expires=="number"&&(s.expires=new Date(Date.now()+s.expires*864e5)),s.expires!=null&&(s.expires=s.expires.toUTCString()),Object.entries(s).filter(([e,t])=>t!=null&&t!==!1).map(([e,t])=>t===!0?`; ${e}`:`; ${e}=${t.split(";")[0]}`).join("")}function vn(s,e,t){const i=/(?:^|; )([^=]*)=([^;]*)/g,o={};let r;for(;(r=i.exec(document.cookie))!=null;)try{const a=t(r[1]);if(o[a]=e(r[2],a),s===a)break}catch{}return s!=null?o[s]:o}const ha=Object.freeze({decodeName:lr,decodeValue:dr,encodeName:fn,encodeValue:mn}),cr=Object.freeze({path:"/"});function _o(s,e,t=cr,{encodeValue:i=mn,encodeName:o=fn}={}){return document.cookie=`${o(s)}=${i(e,s)}${dd(t)}`}function As(s,{decodeValue:e=dr,decodeName:t=lr}={}){return vn(s,e,t)}function cd({decodeValue:s=dr,decodeName:e=lr}={}){return vn(void 0,s,e)}function hd(s,e=cr){_o(s,"",Object.assign({},e,{expires:-1}))}function Ds(s,e){const t={set:function(o,r,a){return _o(o,r,Object.assign({},this.attributes,a),{encodeValue:this.converter.write})},get:function(o){if(arguments.length===0)return cd(this.converter.read);if(o!=null)return As(o,this.converter.read)},remove:function(o,r){hd(o,Object.assign({},this.attributes,r))},withAttributes:function(o){return Ds(this.converter,Object.assign({},this.attributes,o))},withConverter:function(o){return Ds(Object.assign({},this.converter,o),this.attributes)}},i={attributes:{value:Object.freeze(e)},converter:{value:Object.freeze(s)}};return Object.create(t,i)}Ds({read:ha.decodeValue,write:ha.encodeValue},cr);function pd(s,e){return s===e?!0:s.length!==e.length?!1:s.every((t,i)=>t===e[i])}class ud{constructor(e){this.cookieDomain=".archive.org",this.cookieExpiration=30,this.cookiePath="/",this.context=e.context}persistState(e,t={}){e.displayMode&&this.persistViewStateToCookies(e.displayMode),this.persistQueryStateToUrl(e,t)}getRestorationState(){const e=this.loadQueryStateFromUrl(),t=this.loadTileViewStateFromCookies();return e.displayMode=t,e}persistViewStateToCookies(e){const t=e==="grid"?"tiles":"lists";_o(`view-${this.context}`,t,{domain:this.cookieDomain,expires:this.cookieExpiration,path:this.cookiePath});const i=e==="list-detail"?"showdetails":"";_o(`showdetails-${this.context}`,i,{domain:this.cookieDomain,expires:this.cookieExpiration,path:this.cookiePath})}loadTileViewStateFromCookies(){const e=As(`view-${this.context}`),t=As(`showdetails-${this.context}`);return e==="tiles"||e===void 0?"grid":t==="showdetails"?"list-detail":"list-compact"}persistQueryStateToUrl(e,t={}){var i,o,r,a,l;const d=new URL(window.location.href),p=new URLSearchParams(d.searchParams),h=this.removeRecognizedParams(d.searchParams);let f=!1;switch(e.baseQuery&&h.set("query",e.baseQuery),e.searchType){case O.FULLTEXT:h.set("sin","TXT");break;case O.RADIO:h.set("sin","RADIO");break;case O.TV:h.set("sin","TV");break;case O.METADATA:(t.persistMetadataSearchType||p.get("sin")==="MD")&&h.set("sin","MD");break}if(p.get("sin")===""&&(p.delete("sin"),f=!0),e.currentPage&&(e.currentPage>1?h.set("page",e.currentPage.toString()):h.delete("page")),e.selectedSort){const S=Se[e.selectedSort];let k=this.sortDirectionPrefix(e.sortDirection);if(S.field===$.unrecognized){const D=(i=p.get("sort"))!==null&&i!==void 0?i:"",{field:E,direction:A}=this.getSortFieldAndDirection(D);e.sortDirection||(k=this.sortDirectionPrefix(A)),E?h.set("sort",`${k}${E}`):h.set("sort",D)}else if(S.shownInURL){const D=S.urlNames[0];h.set("sort",`${k}${D}`)}}if(e.selectedFacets)for(const[S,k]of Object.entries(e.selectedFacets)){const D=Object.entries(k);if(D.length!==0)for(const[E,A]of D){const R=A.state==="hidden",V=`${S}:"${E}"`;R?h.append("not[]",V):h.append("and[]",V)}}const v=!((o=e.minSelectedDate)===null||o===void 0)&&o.includes("-")||!((r=e.maxSelectedDate)===null||r===void 0)&&r.includes("-")?"date":"year";if(e.minSelectedDate&&e.maxSelectedDate&&h.append("and[]",`${v}:[${e.minSelectedDate} TO ${e.maxSelectedDate}]`),e.titleQuery&&h.append("and[]",e.titleQuery),e.creatorQuery&&h.append("and[]",e.creatorQuery),e.tvClipFilter){const S=sd[e.tvClipFilter];S&&h.append(S,"1")}let y=t.forceReplace?"replaceState":"pushState";const x=this.paramsMatch(p,h,["sin","sort","and[]","not[]","only_commercials","only_factchecks","only_quotes"]);if(x&&this.paramsMatch(p,h,["query"])){if(f)h.delete("sin");else if(this.paramsMatch(p,h,["page"]))return;y="replaceState"}else x&&this.hasLegacyParam(p)&&(y="replaceState");(l=(a=window.history)[y])===null||l===void 0||l.call(a,{query:e.baseQuery,searchType:e.searchType,page:e.currentPage,sort:{field:e.selectedSort,direction:e.sortDirection},minDate:e.minSelectedDate,maxDate:e.maxSelectedDate,facets:e.selectedFacets},"",d)}loadQueryStateFromUrl(){var e;const t=new URL(window.location.href),i=t.searchParams.get("sin"),o=t.searchParams.get("page"),r=t.searchParams.get("query"),a=t.searchParams.get("sort"),l=t.searchParams.getAll("and[]"),d=t.searchParams.getAll("not[]");for(const[f,v]of t.searchParams.entries())/and\[\d+\]/.test(f)?l.push(v):/not\[\d+\]/.test(f)&&d.push(v);const p=(e=t.searchParams.get("q"))!==null&&e!==void 0?e:t.searchParams.get("search"),h={selectedFacets:nt()};switch(r?h.baseQuery=r:p&&(h.baseQuery=p),i){case"TXT":h.searchType=O.FULLTEXT;break;case"RADIO":h.searchType=O.RADIO;break;case"TV":h.searchType=O.TV;break;case"MD":h.searchType=O.METADATA;break;default:h.searchType=O.DEFAULT;break}if(o){const f=parseInt(o,10);h.currentPage=f}else h.currentPage=1;if(a){const{field:f,direction:v}=this.getSortFieldAndDirection(a),y=pn(f);h.selectedSort=y.field,["asc","desc"].includes(v)&&(h.sortDirection=v)}l&&l.forEach(f=>{let[v,y]=f.split(":");if(v=v.replace(/Sorter$/,""),v.startsWith("-")){d.push(f.slice(1));return}switch(v){case"date":case"year":{const[x,S]=y.split(" TO ");x&&S?(h.minSelectedDate=x.substring(1,x.length),h.maxSelectedDate=S.substring(0,S.length-1)):this.setSelectedFacetState(h.selectedFacets,v,y,"selected");break}case"firstTitle":h.selectedTitleFilter=y;break;case"firstCreator":h.selectedCreatorFilter=y;break;default:this.setSelectedFacetState(h.selectedFacets,v,y,"selected")}}),d&&d.forEach(f=>{const[v,y]=f.split(":");this.setSelectedFacetState(h.selectedFacets,v,y,"hidden")});for(const[f,v]of Object.entries(rd))if(t.searchParams.get(f)){h.tvClipFilter=v;break}return h}getSortFieldAndDirection(e){const t=e.indexOf(" ")>-1;let i,o;return t?[i,o]=e.split(" "):(i=e.startsWith("-")?e.slice(1):e,o=e.startsWith("-")?"desc":"asc"),{field:i,direction:o}}sortDirectionPrefix(e){return e==="desc"?"-":""}stripQuotes(e){return e.startsWith('"')&&e.endsWith('"')?e.substring(1,e.length-1):e}paramsMatch(e,t,i){return i.every(o=>pd(e.getAll(o).sort(),t.getAll(o).sort()))}removeRecognizedParams(e){e.delete("query"),e.delete("sin"),e.delete("page"),e.delete("sort"),e.delete("and[]"),e.delete("not[]");for(const t of e.keys())/(and|not)\[\d+\]/.test(t)&&e.delete(t);return e.delete("q"),e.delete("search"),e.delete("only_commercials"),e.delete("only_factchecks"),e.delete("only_quotes"),e}hasLegacyParam(e){return e.has("q")||e.has("search")}setSelectedFacetState(e,t,i,o){var r;const a=e[t];if(!a)return;const l=this.stripQuotes(i);(r=a[l])!==null&&r!==void 0||(a[l]=this.getDefaultBucket(i)),a[l].state=o}getDefaultBucket(e){return{key:e,count:0,state:"none"}}}const Ls=["forum_posts","lending","web_archives"],fd=new TextEncoder;async function gn(s){const e=await crypto.subtle.digest("SHA-1",fd.encode(s));return[...new Uint8Array(e)].map(t=>t.toString(16).padStart(2,"0")).join("")}const Oe=window.location&&(window.location.hostname==="localhost"||window.location.host.match(/^(www|cat)-[a-z0-9]+\.archive\.org$/)||window.location.host.match(/\.code\.archive\.org$/)||window.location.host.match(/\.dev\.archive\.org$/)||window.location.host.match(/^ia-petabox-/)||window.location.host.match(/^local\.archive\.org/)||window.location.host.match(/^internetarchive\.github\.io$/))?console.log.bind(console):()=>{};function zs(s,e){if(s)for(const[t,i]of Object.entries(s))for(const[o,r]of Object.entries(i))e(t,o,r,s)}function hr(s,e,t,i=!1){var o;const r=s??nt(),a={...r,[e]:{...r[e],[t.key]:t}};return i&&t.state==="none"&&((o=a[e])===null||o===void 0||delete o[t.key]),a}function md(s){const e=nt();return zs(s,(t,i,o)=>{e[t]||(e[t]={}),e[t][i]=o}),e}function bn(s,e){const t=md(s);return zs(e,(i,o,r)=>{t[i]||(t[i]={}),t[i][o]=r}),zs(t,(i,o,r)=>{var a;r.state==="none"&&((a=t[i])===null||a===void 0||delete a[o])}),t}const pa=["selected","hidden","none"];function yn(s,e=W.COUNT){return s.sort((t,i)=>{const o=pa.indexOf(t.state),r=pa.indexOf(i.state),a=o-r;let l;return e===W.ALPHABETICAL?l=t.key.localeCompare(i.key):e===W.NUMERIC?l=Number(i.key)-Number(t.key):l=i.count-t.count,a||l})}class vd{get initialSearchComplete(){return this._initialSearchCompletePromise}constructor(e,t=50){this.host=e,this.pageSize=t,this.pages={},this.offset=0,this.numTileModels=0,this.numInitialPages=2,this.fetchesInProgress=new Set,this.previousQueryKey="",this.searchResultsLoading=!1,this.facetsLoading=!1,this.facetsReadyToLoad=!1,this.suppressFetches=!1,this.totalResults=0,this.endOfDataReached=!1,this.queryInitialized=!1,this.collectionTitles=new Map,this.tvChannelAliases=new Map,this.parentCollections=[],this.prefixFilterCountMap={},this._initialSearchCompletePromise=Promise.resolve(!0),this.checkAllTiles=()=>{this.map(i=>{const o=i.clone();return o.checked=!0,o})},this.uncheckAllTiles=()=>{this.map(i=>{const o=i.clone();return o.checked=!1,o})},this.removeCheckedTiles=()=>{const{checkedTileModels:i,uncheckedTileModels:o}=this,r=i.length;if(r===0)return;this.offset+=r;const a={};let l=Math.floor(this.offset/this.pageSize)+1,d=this.offset%this.pageSize;for(let p=1;p<=l;p+=1){const h=this.offset-this.pageSize*(p-1),f=Math.min(this.pageSize,h);a[p]=Array(f).fill(void 0)}for(const p of o)a[l]||(a[l]=[]),a[l].push(p),d+=1,d>=this.pageSize&&(l+=1,d=0);this.pages=a,this.numTileModels-=r,this.totalResults-=r,this.host.setTileCount(this.size),this.host.setTotalResultCount(this.totalResults),this.requestHostUpdate(),this.refreshVisibleResults()}}hostConnected(){this.setSearchResultsLoading(this.searchResultsLoading),this.setFacetsLoading(this.facetsLoading)}hostUpdate(){if(!this.activeOnHost||(this.setSearchResultsLoading(this.searchResultsLoading),this.setFacetsLoading(this.facetsLoading),!this.host.searchService)||!(this.pageFetchQueryKey!==this.previousQueryKey))return;const t=!this.host.baseQuery;(this.canPerformSearch||t)&&(this.activeOnHost&&this.host.emitQueryStateChanged(),this.handleQueryChange())}get activeOnHost(){return this.host.dataSource===this}get size(){return this.numTileModels}reset(){Oe("Resetting CB data source"),this.pages={},this.aggregations={},this.histogramAggregation=void 0,this.pageElements=void 0,this.parentCollections=[],this.previousQueryKey="",this.queryErrorMessage=void 0,this.offset=0,this.numTileModels=0,this.endOfDataReached=!1,this.queryInitialized=!1,this.facetsLoading=!1,this.fetchesInProgress.clear(),this.setTotalResultCount(0),this.requestHostUpdate()}resetPages(){Object.keys(this.pages).length<this.host.maxPagesToManage&&(this.pages={},this.fetchesInProgress.forEach(e=>{e.startsWith("facets-")||this.fetchesInProgress.delete(e)}),this.requestHostUpdate())}addPage(e,t){this.pages[e]=t,this.numTileModels+=t.length,this.requestHostUpdate()}addMultiplePages(e,t){const i=Math.ceil(t.length/this.pageSize);for(let a=0;a<i;a+=1){const l=this.pageSize*a;this.addPage(e+a,t.slice(l,l+this.pageSize))}this.host.currentVisiblePageNumbers.some(a=>a>=e&&a<=e+i)&&this.refreshVisibleResults()}getPage(e){return this.pages[e]}getAllPages(){return this.pages}hasPage(e){return!!this.pages[e]}getTileModelAt(e){var t,i;const o=e+this.offset,r=Math.floor(o/this.pageSize)+1,a=o%this.pageSize;let l=1,d=0;for(;d<=o;){if(!this.pages[l])return(t=this.pages[r])===null||t===void 0?void 0:t[a];if(d+this.pages[l].length>o)return this.pages[l][o-d];d+=this.pages[l].length,l+=1}return(i=this.pages[r])===null||i===void 0?void 0:i[a]}indexOf(e){return Object.values(this.pages).flat().indexOf(e)-this.offset}getPageSize(){return this.pageSize}setPageSize(e){this.reset(),this.pageSize=e}setNumInitialPages(e){this.numInitialPages=e}setTotalResultCount(e){this.totalResults=e,this.activeOnHost&&this.host.setTotalResultCount(e)}setFetchesSuppressed(e){this.suppressFetches=e}setEndOfDataReached(e){this.endOfDataReached=e}async handleQueryChange(){if(this.suppressFetches)return;this.reset();let e;this._initialSearchCompletePromise=new Promise(t=>{e=t}),this.queryInitialized=!0,await Promise.all([this.doInitialPageFetch(),this.canFetchFacets?this.fetchFacets():null]),e(!0)}async handleFacetReadinessChange(e){const t=!this.facetsReadyToLoad&&e;this.facetsReadyToLoad=e,t&&this.canFetchFacets&&this.fetchFacets()}get canFetchFacets(){var e;if(this.host.facetLoadStrategy==="off"||Ls.includes(this.host.profileElement)||this.host.facetLoadStrategy!=="eager"&&!this.facetsReadyToLoad)return!1;const t=Object.keys((e=this.aggregations)!==null&&e!==void 0?e:{}).length>0;return!(this.facetsLoading||t)}map(e){Object.keys(this.pages).length&&(this.pages=Object.fromEntries(Object.entries(this.pages).map(([t,i])=>[t,i.map((o,r,a)=>o&&e(o,r,a))])),this.requestHostUpdate(),this.refreshVisibleResults())}get checkedTileModels(){return this.getFilteredTileModels(e=>e.checked)}get uncheckedTileModels(){return this.getFilteredTileModels(e=>!e.checked)}getFilteredTileModels(e){return Object.values(this.pages).flat().filter((t,i,o)=>t?e(t,i,o):!1)}get canPerformSearch(){var e,t;if(!this.host.searchService)return!1;const o=!!((e=this.host.baseQuery)===null||e===void 0?void 0:e.trim()),r=!!(!((t=this.host.identifiers)===null||t===void 0)&&t.length),a=!!this.host.withinCollection,l=!!this.host.withinProfile,d=!!this.host.profileElement,p=this.host.searchType===O.DEFAULT,h=this.host.searchType===O.METADATA,f=this.host.searchType===O.TV;return o||r||a&&(p||h||f)||l&&(d&&(p||h))}setSearchResultsLoading(e){this.searchResultsLoading=e,this.activeOnHost&&this.host.setSearchResultsLoading(e)}setFacetsLoading(e){this.facetsLoading=e,this.activeOnHost&&this.host.setFacetsLoading(e)}requestHostUpdate(){this.activeOnHost&&this.host.requestUpdate()}refreshVisibleResults(){this.activeOnHost&&this.host.refreshVisibleResults()}get pageFetchQueryKey(){var e,t,i;const o=`pf;${this.host.withinProfile}--pe;${this.host.profileElement}`,r=(e=this.host.withinCollection)!==null&&e!==void 0?e:o,a=(t=this.host.selectedSort)!==null&&t!==void 0?t:"none",l=(i=this.host.sortDirection)!==null&&i!==void 0?i:"none";return`fq:${this.fullQuery}-pt:${r}-st:${this.host.searchType}-sf:${a}-sd:${l}`}get facetFetchQueryKey(){var e;const t=`pf;${this.host.withinProfile}--pe;${this.host.profileElement}`,i=(e=this.host.withinCollection)!==null&&e!==void 0?e:t;return`facets-fq:${this.fullQuery}-pt:${i}-st:${this.host.searchType}`}get filterMap(){const e=new ul,{minSelectedDate:t,maxSelectedDate:i,selectedFacets:o,internalFilters:r,selectedTitleFilter:a,selectedCreatorFilter:l}=this.host,d=this.host.searchType===O.TV?"date":"year";t&&e.addFilter(d,t,Re.GREATER_OR_EQUAL),i&&e.addFilter(d,i,Re.LESS_OR_EQUAL);const p=bn(r,o);if(p)for(const[f,v]of Object.entries(p)){const{name:y,values:x}=this.prepareFacetForFetch(f,v);for(const[S,k]of Object.entries(x)){let D;k.state==="selected"?D=Re.INCLUDE:k.state==="hidden"&&(D=Re.EXCLUDE),D&&e.addFilter(y,S,D)}}if(a&&e.addFilter("firstTitle",a,Re.INCLUDE),l&&e.addFilter("firstCreator",l,Re.INCLUDE),this.host.searchType===O.TV)switch(this.host.tvClipFilter){case"commercials":e.addFilter("ad_id","*",Re.INCLUDE);break;case"factchecks":e.addFilter("factcheck","*",Re.INCLUDE);break;case"quotes":e.addFilter("clip","1",Re.INCLUDE);break}return e.build()}async requestUID(e,t){var i;const o=JSON.stringify({pageType:e.pageType,pageTarget:e.pageTarget,query:e.query,fields:e.fields,filters:e.filters,sort:e.sort,searchType:this.host.searchType}),r=(await gn(o)).slice(0,20),a=(await this.host.getSessionId()).slice(0,20),l=(i=e.page)!==null&&i!==void 0?i:0,d=t.charAt(0),p=Date.now();return`R:${r}-S:${a}-P:${l}-K:${d}-T:${p}`}get pageSpecifierParams(){var e;return!((e=this.host.identifiers)===null||e===void 0)&&e.length?{pageType:"client_document_fetch"}:this.host.withinCollection?{pageType:"collection_details",pageTarget:this.host.withinCollection}:this.host.withinProfile?{pageType:"account_details",pageTarget:this.host.withinProfile,pageElements:this.host.profileElement?[this.host.profileElement]:[]}:null}get fullQuery(){var e;const t=[],i=(e=this.host.baseQuery)===null||e===void 0?void 0:e.trim();i&&t.push(i),this.host.identifiers&&t.push(`identifier:(${this.host.identifiers.join(" OR ")})`);const{facetQuery:o,dateRangeQueryClause:r,sortFilterQueries:a}=this;return o&&t.push(o),r&&t.push(r),a&&t.push(a),t.join(" AND ").trim()}get facetQuery(){var e;if(!this.host.selectedFacets)return;const t=[];for(const[i,o]of Object.entries(this.host.selectedFacets))t.push(this.buildFacetClause(i,o));return(e=this.joinFacetClauses(t))===null||e===void 0?void 0:e.trim()}get dateRangeQueryClause(){if(!(!this.host.minSelectedDate||!this.host.maxSelectedDate))return`year:[${this.host.minSelectedDate} TO ${this.host.maxSelectedDate}]`}get sortFilterQueries(){return[this.titleQuery,this.creatorQuery].filter(t=>t).join(" AND ")}get titleQuery(){return this.host.selectedTitleFilter?`firstTitle:${this.host.selectedTitleFilter}`:void 0}get creatorQuery(){return this.host.selectedCreatorFilter?`firstCreator:${this.host.selectedCreatorFilter}`:void 0}buildFacetClause(e,t){const{name:i,values:o}=this.prepareFacetForFetch(e,t),r=Object.entries(o);if(r.length===0)return"";const a=[];for(const[d,p]of r){const h=p.state==="hidden"?"-":"";a.push(`${h}"${d}"`)}const l=a.join(" OR ");return`${i}:(${l})`}prepareFacetForFetch(e,t){let[i,o]=[e,t];return e==="lending"&&(i="lending___status"),{name:i,values:o}}joinFacetClauses(e){const t=e.filter(i=>i.length>0);return t.length>0?`(${t.join(" AND ")})`:void 0}async fetchFacets(){var e,t,i,o,r,a,l;const d=(e=this.host.baseQuery)===null||e===void 0?void 0:e.trim();if(!this.canPerformSearch)return;const{facetFetchQueryKey:p}=this;if(this.fetchesInProgress.has(p))return;this.fetchesInProgress.add(p),this.setFacetsLoading(!0);const h=this.host.sortParam?[this.host.sortParam]:[],f={...this.pageSpecifierParams,query:d||"",identifiers:this.host.identifiers,rows:0,filters:this.filterMap,aggregationsSize:10};f.uid=await this.requestUID({...f,sort:h},"aggregations");const v=await((t=this.host.searchService)===null||t===void 0?void 0:t.search(f,this.host.searchType)),y=v==null?void 0:v.success,x=!this.fetchesInProgress.has(p);if(this.fetchesInProgress.delete(p),x)return;if(!y){const E=(i=v==null?void 0:v.error)===null||i===void 0?void 0:i.message,A=(r=(o=v==null?void 0:v.error)===null||o===void 0?void 0:o.details)===null||r===void 0?void 0:r.message;!E&&!A&&((l=(a=window==null?void 0:window.Sentry)===null||a===void 0?void 0:a.captureMessage)===null||l===void 0||l.call(a,"Missing or malformed facet response from backend","error")),this.setFacetsLoading(!1);return}const{aggregations:S,collectionTitles:k,tvChannelAliases:D}=y.response;if(this.aggregations=S,this.histogramAggregation=this.host.searchType===O.TV?S==null?void 0:S.date_histogram:S==null?void 0:S.year_histogram,k)for(const[E,A]of Object.entries(k))this.collectionTitles.set(E,A);if(D)for(const[E,A]of Object.entries(D))this.tvChannelAliases.set(E,A);this.setFacetsLoading(!1),this.requestHostUpdate()}async doInitialPageFetch(){this.setSearchResultsLoading(!0),await this.fetchPage(this.host.initialPageNumber,this.numInitialPages)}async fetchPage(e,t=1){var i,o,r,a,l,d,p,h,f,v,y,x;const S=(i=this.host.baseQuery)===null||i===void 0?void 0:i.trim();if(!this.canPerformSearch){this.setSearchResultsLoading(!1);return}if(this.hasPage(e)||this.endOfDataReached)return;let k=e===1?t:1;const D=this.pageSize*k,{pageFetchQueryKey:E}=this,A=`${E}-p:${e}`;if(this.fetchesInProgress.has(A))return;for(let K=0;K<k;K+=1)this.fetchesInProgress.add(`${E}-p:${e+K}`);this.previousQueryKey=E;const{withinCollection:R,withinProfile:V}=this.host;let re=this.host.sortParam?[this.host.sortParam]:[];if(V&&this.host.selectedSort===$.default&&this.host.defaultSortField){const K=Se[this.host.defaultSortField];K.searchServiceKey&&(re=[{field:K.searchServiceKey,direction:"desc"}])}const ve={...this.pageSpecifierParams,query:S||"",identifiers:this.host.identifiers,page:e,rows:D,sort:re,filters:this.filterMap,aggregations:{omit:!0}};ve.uid=await this.requestUID(ve,"hits");const ce=await((o=this.host.searchService)===null||o===void 0?void 0:o.search(ve,this.host.searchType)),Te=ce==null?void 0:ce.success;if(!this.fetchesInProgress.has(A))return;for(let K=0;K<k;K+=1)this.fetchesInProgress.delete(`${E}-p:${e+K}`);if(!Te){const K=(r=ce==null?void 0:ce.error)===null||r===void 0?void 0:r.message,he=(l=(a=ce==null?void 0:ce.error)===null||a===void 0?void 0:a.details)===null||l===void 0?void 0:l.message;this.queryErrorMessage=`${K??""}${he?`; ${he}`:""}`,this.queryErrorMessage||(this.queryErrorMessage="Missing or malformed response from backend",(p=(d=window==null?void 0:window.Sentry)===null||d===void 0?void 0:d.captureMessage)===null||p===void 0||p.call(d,this.queryErrorMessage,"error")),this.setSearchResultsLoading(!1),this.requestHostUpdate(),this.host.emitSearchError();return}this.setTotalResultCount(Te.response.totalResults-this.offset),this.activeOnHost&&this.totalResults===0&&this.host.emitEmptyResults(),this.sessionContext=Te.sessionContext,R?(this.collectionExtraInfo=Te.response.collectionExtraInfo,this.activeOnHost&&this.host.applyDefaultCollectionSort(this.collectionExtraInfo),this.collectionExtraInfo&&(this.parentCollections=[].concat((f=(h=this.collectionExtraInfo.public_metadata)===null||h===void 0?void 0:h.collection)!==null&&f!==void 0?f:[]),this.host.isTVCollection=((v=this.host.withinCollection)===null||v===void 0?void 0:v.startsWith("TV-"))||this.host.withinCollection==="tvnews"||this.host.withinCollection==="tvarchive"||this.parentCollections.includes("tvnews")||this.parentCollections.includes("tvarchive"))):V&&(this.accountExtraInfo=Te.response.accountExtraInfo,this.pageElements=Te.response.pageElements);const{results:Q,collectionTitles:qe,tvChannelAliases:Ye}=Te.response;if(Q&&Q.length>0){if(qe){for(const[Le,bt]of Object.entries(qe))this.collectionTitles.set(Le,bt);const he=(x=(y=this.collectionExtraInfo)===null||y===void 0?void 0:y.public_metadata)===null||x===void 0?void 0:x.title;R&&he&&this.collectionTitles.set(R,he)}if(Ye)for(const[he,Le]of Object.entries(Ye))this.tvChannelAliases.set(he,Le);const K=["lending","web_archives"].includes(this.host.profileElement);K&&(k=Math.ceil(Q.length/this.pageSize),this.endOfDataReached=!0,this.activeOnHost&&this.host.setTileCount(this.totalResults));for(let he=0;he<k;he+=1){const Le=this.pageSize*he;this.addFetchedResultsToDataSource(e+he,Q.slice(Le,Le+this.pageSize),!K||he===k-1)}}(this.size>=this.totalResults||Q.length===0)&&(this.endOfDataReached=!0,this.activeOnHost&&this.host.setTileCount(this.size)),this.setSearchResultsLoading(!1),this.requestHostUpdate()}get hitRequestSource(){const{host:e}=this;return e.baseQuery?"search_query":e.withinProfile?"profile_tab":e.withinCollection?"collection_members":"unknown"}addFetchedResultsToDataSource(e,t,i=!0){const o=[],r=this.hitRequestSource;t==null||t.forEach(a=>{a.identifier&&o.push(new So(a,r))}),this.addPage(e,o),i&&this.refreshVisibleResults()}async fetchPrefixFilterBuckets(e){var t,i,o,r,a,l,d;const p=(t=this.host.baseQuery)===null||t===void 0?void 0:t.trim();if(!this.canPerformSearch)return[];const h=od[e],f=this.host.sortParam?[this.host.sortParam]:[],v={...this.pageSpecifierParams,query:p||"",identifiers:this.host.identifiers,rows:0,filters:this.filterMap,aggregations:{simpleParams:[h]},aggregationsSize:26};v.uid=await this.requestUID({...v,sort:f},"aggregations");const y=await((i=this.host.searchService)===null||i===void 0?void 0:i.search(v,this.host.searchType));return(d=(l=(a=(r=(o=y==null?void 0:y.success)===null||o===void 0?void 0:o.response)===null||r===void 0?void 0:r.aggregations)===null||a===void 0?void 0:a[h])===null||l===void 0?void 0:l.buckets)!==null&&d!==void 0?d:[]}async updatePrefixFilterCounts(e){const{facetFetchQueryKey:t}=this,i=await this.fetchPrefixFilterBuckets(e);t===this.facetFetchQueryKey&&(this.prefixFilterCountMap={...this.prefixFilterCountMap},this.prefixFilterCountMap[e]=i.reduce((r,a)=>(r[a.key.toUpperCase()]=a.doc_count,r),{}),this.requestHostUpdate())}async updatePrefixFiltersForCurrentSort(){if(["title","creator"].includes(this.host.selectedSort)){const e=this.host.selectedSort;this.prefixFilterCountMap[e]||this.updatePrefixFilterCounts(e)}}refreshLetterCounts(){Object.keys(this.prefixFilterCountMap).length>0&&(this.prefixFilterCountMap={}),this.updatePrefixFiltersForCurrentSort(),this.requestHostUpdate()}}var Je;(function(s){s.default="collection-browser"})(Je||(Je={}));var ee;(function(s){s.sortBy="sortBy",s.filterByCreator="filterByCreator",s.filterByTitle="filterByTitle",s.displayMode="displayMode",s.loadDesktopView="loadDesktopView",s.loadMobileView="loadMobileView",s.facetSelected="facetSelected",s.facetDeselected="facetDeselected",s.facetNegativeSelected="facetNegativeSelected",s.facetNegativeDeselected="facetNegativeDeselected",s.mobileFacetsToggled="mobileFacetsToggled",s.partOfCollectionClicked="partOfCollectionClicked",s.histogramChanged="histogramChanged",s.histogramChangedFromModal="histogramChangedFromModal",s.histogramExpanded="histogramExpanded",s.resultSelected="resultSelected",s.moreFacetsPageChange="moreFacetsPageChange",s.showMoreFacetsModal="showMoreFacetsModal",s.closeMoreFacetsModal="closeMoreFacetsModal",s.applyMoreFacetsModal="applyMoreFacetsModal"})(ee||(ee={}));const Fs=N`<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><path d="m79.8883285 50.0035012.1116715-.1085359-43.1159942-46.61088155c-2.401537-2.18938917-4.6902018-3.28408375-6.8659943-3.28408375s-4.1642651.63837733-5.9654178 1.91513199c-1.8011528 1.27675467-3.1520173 2.97248092-4.0525937 5.08717877l39.4020173 42.99768924-39.4020173 42.9976892c.9005764 2.1146979 2.2514409 3.8104241 4.0525937 5.0871788 1.8011527 1.2767547 3.7896253 1.915132 5.9654178 1.915132 2.1013449 0 4.3900096-1.0573489 6.8659943-3.1720468l43.1159942-46.7194174z"/></svg>
`,tt=g`
  .sr-only {
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const gd=(s,e,t)=>{for(const i of e)if(i[0]===s)return(0,i[1])();return t==null?void 0:t()},bd=N`
...
`;var Xe;let Ee=Xe=class extends I{constructor(){super(...arguments),this.placeholderType=null,this.detailMessage=""}render(){return this.placeholderType?u`${this.placeholderTemplate}`:b}get placeholderTemplate(){return u`
      <div
        class="placeholder ${this.placeholderType} ${this.isMobileView?"mobile":"desktop"}"
      >
        ${gd(this.placeholderType,[["empty-query",()=>this.emptyQueryTemplate],["empty-collection",()=>this.emptyCollectionTemplate],["no-results",()=>this.noResultsTemplate],["query-error",()=>this.queryErrorTemplate],["collection-error",()=>this.collectionErrorTemplate]])}
      </div>
    `}get emptyQueryTemplate(){return u`
      <h2 class="title" data-testid="empty-query-text-msg">
        ${Xe.MESSAGE_EMPTY_QUERY}
      </h2>
      <div>${bd}</div>
    `}get emptyCollectionTemplate(){return u`
      <h2 class="title" data-testid="empty-collection-text-msg">
        ${Xe.MESSAGE_NO_VIEWABLE_MEMBERS}
      </h2>
      <div>${io}</div>
    `}get noResultsTemplate(){return u`
      <h2 class="title" data-testid="empty-results-text-msg">
        ${this.isCollection?Xe.MESSAGE_NO_COLLECTION_RESULTS:Xe.MESSAGE_NO_SEARCH_RESULTS}
      </h2>
      <div>${io}</div>
    `}get queryErrorTemplate(){return u`
      <h2 class="title" data-testid="error-query-text-msg">
        ${Xe.MESSAGE_QUERY_ERROR}
      </h2>
      <div>${io}</div>
      <p class="error-details">
        ${Xe.QUERY_ERROR_DETAILS_MESSAGE} ${this.detailMessage}
      </p>
    `}get collectionErrorTemplate(){return u`
      <h2 class="title" data-testid="error-collection-text-msg">
        ${Xe.MESSAGE_COLLECTION_ERROR}
      </h2>
      <div>${io}</div>
      <p class="error-details">
        ${Xe.QUERY_ERROR_DETAILS_MESSAGE} ${this.detailMessage}
    ...
    `}};Ee.MESSAGE_EMPTY_QUERY=C('To begin searching, enter a search term in the box above and hit "Go".');Ee.MESSAGE_NO_SEARCH_RESULTS=C("Your search did not match any items in the Archive. Try different keywords or a more general search.");Ee.MESSAGE_NO_COLLECTION_RESULTS=C("Your search did not match any items in this collection. Try different keywords or a more general search.");Ee.MESSAGE_NO_VIEWABLE_MEMBERS=C("This collection contains no viewable items.");Ee.MESSAGE_QUERY_ERROR=C(u`The search engine encountered an error, which might be related to your
      search query.
      <a
        href="https://help.archive.org/help/search-building-powerful-complex-queries/"
      >
        Tips for constructing search queries.
      </a> `);Ee.MESSAGE_COLLECTION_ERROR=C(u`The search engine encountered an error while loading this collection.
      If the problem persists, please let us know at
      <a href="mailto:info@archive.org">info@archive.org</a>.`);Ee.QUERY_ERROR_DETAILS_MESSAGE=C("Error details:");n([c({type:String})],Ee.prototype,"placeholderType",void 0);n([c({type:Boolean})],Ee.prototype,"isMobileView",void 0);n([c({type:Boolean})],Ee.prototype,"isCollection",void 0);n([c({type:String})],Ee.prototype,"detailMessage",void 0);Ee=Xe=n([B("empty-placeholder")],Ee);/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ke=s=>s??J,wn=N`
...
`;var Ps;(function(s){s[s.bytes=0]="bytes",s[s.kilobytes=1]="kilobytes",s[s.megabytes=2]="megabytes",s[s.gigabytes=3]="gigabytes",s[s.terabytes=4]="terabytes",s[s.petabytes=5]="petabytes",s[s.exabytes=6]="exabytes",s[s.zettabytes=7]="zettabytes",s[s.yottabytes=8]="yottabytes"})(Ps||(Ps={}));function yd(s,e,t=" "){let i=s;if(i===void 0)return b;let o=0;for(;i>1024;)i/=1024,o+=1;const r=10**e;i=Math.round(i*r)/r;let a=Ps[o];return a=i===1?a.slice(0,-1):a,`${i.toLocaleString()+t+a}`}const wd=g`var(--tileBackgroundColor, #ffffff)`,Sd=g`var(--tileCornerRadius, 4px)`,Bo=g`
...
`;function Sn(s,e="short",{locale:t="en-US",useLocalTime:i=!1}={}){if(!s)return"";const o=i?{}:{timeZone:"UTC"};switch(e){case"year-only":return`${s.getUTCFullYear()}`;case"short":o.month="short",o.year="numeric";break;case"long":o.year="numeric",o.month="short",o.day="2-digit";break}return new Intl.DateTimeFormat(t,o).format(s)}class ua{constructor(e={}){var t;this.model=e.model,this.baseNavigationUrl=e.baseNavigationUrl,this.collectionPagePath=(t=e.collectionPagePath)!==null&&t!==void 0?t:"/details/",this.sortParam=e.sortParam,this.creatorFilter=e.creatorFilter}get firstCreatorMatchingFilter(){var e,t;let i;if(this.creatorFilter&&(!((e=this.model)===null||e===void 0)&&e.creators.length)){const o=this.creatorFilter;i=this.model.creators.find(r=>r.normalize("NFD").replace(/[^A-Z]+/gi,"").toUpperCase().startsWith(o))}return i??((t=this.model)===null||t===void 0?void 0:t.creator)}get accountLabel(){var e;return!((e=this.model)===null||e===void 0)&&e.dateAdded?C(Ze`Archivist since ${this.model.dateAdded.getFullYear()}`):""}get dateLabel(){var e;switch((e=this.sortParam)===null||e===void 0?void 0:e.field){case"publicdate":return C("Archived");case"reviewdate":return C("Reviewed");case"addeddate":return C("Added");case"date":return C("Published");default:return""}}itemPageUrl(e,t=!1){if(!e||this.baseNavigationUrl==null)return b;const i=t?this.collectionPagePath:"/details/";return`${this.baseNavigationUrl}${i}${e}`}webArchivesCaptureLink(e,t){const o=`https://web.archive.org/web/${t.toISOString().replace(/[TZ:-]/g,"").replace(/\..*/,"")}/${encodeURIComponent(e)}`,r=Sn(t,"long");return u` <a href=${o}> ${r} </a> `}}class le extends I{constructor(){super(...arguments),this.sortParam=null,this.defaultSortParam=null,this.loggedIn=!1,this.suppressBlurring=!1,this.useLocalTime=!1,this.displayValueProvider=new ua}willUpdate(e){var t,i;(e.has("model")||e.has("baseNavigationUrl")||e.has("collectionPagePath")||e.has("sortParam")||e.has("defaultSortParam")||e.has("creatorFilter"))&&(this.displayValueProvider=new ua({model:this.model,baseNavigationUrl:this.baseNavigationUrl,collectionPagePath:this.collectionPagePath,sortParam:(i=(t=this.sortParam)!==null&&t!==void 0?t:this.defaultSortParam)!==null&&i!==void 0?i:void 0,creatorFilter:this.creatorFilter}))}getFormattedDate(e,t){const{useLocalTime:i}=this;return Sn(e,t,{useLocalTime:i})}}n([c({type:Object})],le.prototype,"model",void 0);n([c({type:Number})],le.prototype,"currentWidth",void 0);n([c({type:Number})],le.prototype,"currentHeight",void 0);n([c({type:String})],le.prototype,"baseNavigationUrl",void 0);n([c({type:String})],le.prototype,"baseImageUrl",void 0);n([c({type:String})],le.prototype,"collectionPagePath",void 0);n([c({type:Object})],le.prototype,"sortParam",void 0);n([c({type:Object})],le.prototype,"defaultSortParam",void 0);n([c({type:String})],le.prototype,"creatorFilter",void 0);n([c({type:Number})],le.prototype,"mobileBreakpoint",void 0);n([c({type:Boolean})],le.prototype,"loggedIn",void 0);n([c({type:Boolean})],le.prototype,"suppressBlurring",void 0);n([c({type:Boolean})],le.prototype,"useLocalTime",void 0);let Bs=class extends I{render(){return u`<div class="icon-overlay">${this.iconTemplate}</div>`}get iconTemplate(){var e;return this.type?u`${(e=hn[this.type])!==null&&e!==void 0?e:b}`:b}static get styles(){return g`
      :host {
        position: absolute;
        top: 50%;
        left: 50%;
    ...
    `}};n([c({type:String})],Bs.prototype,"type",void 0);Bs=n([B("icon-overlay")],Bs);let Rs=class extends I{render(){return u`
      <div class="overlay no-preview">
        <div class="icon-overlay">${this.iconTemplate}</div>
        <p class="text-overlay">${this.textTemplate}</p>
      </div>
    `}get iconTemplate(){var e;return this.type?u`${(e=hn[this.type])!==null&&e!==void 0?e:b}`:b}get textTemplate(){var e;return this.type?u`${(e=Jl[this.type])!==null&&e!==void 0?e:b}`:b}static get styles(){return g`
      :host {
        align-items: center;
        display: flex;
      }
    ...
    `}};n([c({type:String})],Rs.prototype,"type",void 0);Rs=n([B("text-overlay")],Rs);let dt=class extends I{constructor(){super(...arguments),this.isCompactTile=!1,this.isListTile=!1,this.loggedIn=!1,this.suppressBlurring=!1,this.viewSize="desktop"}render(){var e;return!((e=this.model)===null||e===void 0)&&e.identifier?u`
    ...
    `}};n([c({type:String})],dt.prototype,"baseImageUrl",void 0);n([c({type:Boolean})],dt.prototype,"isCompactTile",void 0);n([c({type:Boolean})],dt.prototype,"isListTile",void 0);n([c({type:Boolean})],dt.prototype,"loggedIn",void 0);n([c({type:Boolean})],dt.prototype,"suppressBlurring",void 0);n([c({type:Object})],dt.prototype,"model",void 0);n([c({type:String})],dt.prototype,"viewSize",void 0);dt=n([B("image-block")],dt);let Is=class extends le{constructor(){super(...arguments),this.showInfoButton=!1}render(){return u`
      <div class="container">
    ...
    >`}get getSizeTemplate(){var e,t;const i=(t=(e=this.model)===null||e===void 0?void 0:e.collectionSize)!==null&&t!==void 0?t:0;return i?u`<span id="item-size">${yd(i,1)}</span>`:""}get infoButtonTemplate(){return this.showInfoButton?u`<button class="info-button" @click=${this.infoButtonPressed}>
          &#9432;
          <span class="sr-only">${C("More info")}</span>
        </button>`:b}infoButtonPressed(e){e.preventDefault();const t=new CustomEvent("infoButtonPressed",{detail:{x:e.clientX,y:e.clientY}});this.dispatchEvent(t)}static get styles(){const e=g`var(--tileBorderColor, #555555)`,t=g`var(--tileBackgroundColor, #666666)`,i=g`#fff`;return[Bo,g`
        .container {
          background-color: ${t};
          border: 1px solid ${e};
        }
      ...
      `]}};n([c({type:Boolean})],Is.prototype,"showInfoButton",void 0);Is=n([B("collection-tile")],Is);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*Dt(s,e){if(s!==void 0){let t=0;for(const i of s)yield e(i,t++)}}function pr(s){return s?s.toISOString().endsWith("-01-01T00:00:00.000Z"):!1}const xn=u`
...
`;let ai=class extends I{constructor(){super(...arguments),this.title="",this.body="",this.starRating=0,this.viewSize="desktop"}render(){return!this.title&&!this.body&&!this.starRating?b:u`
    ...
    `}get filledStarTemplate(){return u`<span aria-hidden="true">${xn}</span>`}get unfilledStarTemplate(){return u`
      <span class="unfilled-star" aria-hidden="true">
        ${xd}
      </span>
    `}static get styles(){return[tt,g`
        .review-container {
          display: flex;
          flex-direction: row;
          flex-wrap: wrap;
      ...
      `]}};n([c({type:String})],ai.prototype,"title",void 0);n([c({type:String})],ai.prototype,"body",void 0);n([c({type:Number})],ai.prototype,"starRating",void 0);n([c({type:String})],ai.prototype,"viewSize",void 0);ai=n([B("review-block")],ai);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*co(s,e){const t=typeof e=="function";if(s!==void 0){let i=-1;for(const o of s)i>-1&&(yield t?e(i):e),i++,yield o}}let $o=class extends I{constructor(){super(...arguments),this.snippets=[],this.viewSize="desktop"}render(){var e;return!((e=this.snippets)===null||e===void 0)&&e.length?u`
      <div class="container">
        <div class="snippet-view ${this.viewSize}">
    ...
    `:u`${b}`}get ellipsisJoinedSnippets(){return u`
      &hellip; ${co(this.snippetTemplates,u` &hellip; `)} &hellip;
    `}get snippetTemplates(){var e;return(e=this.snippets)===null||e===void 0?void 0:e.map(t=>{const i=t.matchAll(/{{{(.+?)}}}/gs),o=[];let r=0;for(const a of i)a.index!=null&&(o.push(u`
            ${t.slice(r,a.index)}
            <mark>${a[1]}</mark>
          `),r=a.index+a[0].length);return o.push(u`${t.slice(r)}`),u`<span>${o}</span>`})}static get styles(){return g`
      .container {
        display: flex;
        flex-direction: row;
        flex-wrap: wrap;
    ...
    `}};n([c({type:Array})],$o.prototype,"snippets",void 0);n([c({type:String})],$o.prototype,"viewSize",void 0);$o=n([B("text-snippet-block")],$o);const _d=g`
  .drop-shadow {
    overflow: hidden;
    height: 100%;
  }
...
`;let Ve=class extends I{constructor(){super(...arguments),this.isListTile=!1,this.isCompactTile=!1,this.loggedIn=!1,this.suppressBlurring=!1,this.isWaveform=!1,this.isNotFound=!1}render(){return u`
      <div class=${at(this.itemBaseClass)}>${this.imageTemplate}</div>
    `}get imageTemplate(){var e;return((e=this.model)===null||e===void 0?void 0:e.mediatype)==="search"?u`${_n}`:u`
      <img
    ...
    `}get imageSrc(){var e,t,i;if(this.isNotFound)return this.notFoundSrc;if(!((e=this.model)===null||e===void 0)&&e.captureDates&&this.model.identifier)try{const o=new URL(this.model.identifier),r=encodeURIComponent(o.hostname);return this.baseImageUrl?`https://web.archive.org/thumb/${r}?generate=1`:b}catch{return`${this.baseImageUrl}/images/notfound.png`}return!((t=this.model)===null||t===void 0)&&t.thumbnailUrl?this.model.thumbnailUrl:this.baseImageUrl&&(!((i=this.model)===null||i===void 0)&&i.identifier)?`${this.baseImageUrl}/services/img/${this.model.identifier}`:b}get notFoundSrc(){return this.baseImageUrl?`${this.baseImageUrl}/images/notfound.png`:b}get hashBasedGradient(){var e;return!((e=this.model)===null||e===void 0)&&e.identifier?`waveform-grad${this.hashStrToInt(this.model.identifier)%6}`:"waveform-grad0"}hashStrToInt(e){return e.split("").reduce((t,i)=>t+i.charCodeAt(0),0)}get itemBaseClass(){var e;return{"drop-shadow":!0,"list-box":this.isListTile,"search-image":((e=this.model)===null||e===void 0?void 0:e.mediatype)==="search",[this.hashBasedGradient]:this.isWaveform}}get itemImageClass(){var e,t,i;const r=!!(!((e=this.model)===null||e===void 0)&&e.contentWarning||!((t=this.model)===null||t===void 0)&&t.loginRequired)&&!this.suppressBlurring;return{contain:!this.isCompactTile&&!this.isWaveform,cover:this.isCompactTile,blur:r,waveform:this.isWaveform,"account-image":this.isAccountImage,"collection-image":((i=this.model)===null||i===void 0?void 0:i.mediatype)==="collection"}}get isAccountImage(){var e;return((e=this.model)===null||e===void 0?void 0:e.mediatype)==="account"&&!this.isCompactTile&&!this.isListTile}onLoad(){var e,t;(((e=this.model)===null||e===void 0?void 0:e.mediatype)==="audio"||((t=this.model)===null||t===void 0?void 0:t.mediatype)==="etree")&&this.baseImage.naturalWidth/this.baseImage.naturalHeight===4&&(this.isWaveform=!0)}onError(){this.isNotFound=!0}static get styles(){return[_d,$d,g`
      ...
      `]}};n([c({type:Object})],Ve.prototype,"model",void 0);n([c({type:String})],Ve.prototype,"baseImageUrl",void 0);n([c({type:Boolean})],Ve.prototype,"isListTile",void 0);n([c({type:Boolean})],Ve.prototype,"isCompactTile",void 0);n([c({type:Boolean})],Ve.prototype,"loggedIn",void 0);n([c({type:Boolean})],Ve.prototype,"suppressBlurring",void 0);n([z()],Ve.prototype,"isWaveform",void 0);n([z()],Ve.prototype,"isNotFound",void 0);n([G("img")],Ve.prototype,"baseImage",void 0);Ve=n([B("item-image")],Ve);const Cd=N`
...
`,$n={account:{color:"#000000",icon:Cd,text:"Account"},audio:{color:"#00adef",icon:kd,text:"Audio"},collection:{color:"#4666ff",icon:wn,text:"Collection"},data:{color:"#333333",icon:Td,text:"Data"},etree:{color:"#00adef",icon:Md,text:"E-tree"},film:{color:"#bf1b2c",icon:fa,text:"Film"},image:{color:"#aa99c9",icon:Ed,text:"Image"},movies:{color:"#f1644b",icon:fa,text:"Movie"},none:{color:"#00000000",icon:u``,text:""},radio:{color:"#8fdaef",icon:Ad,text:"Radio"},software:{color:"#9ecc4f",icon:Dd,text:"Software"},texts:{color:"#faab3c",icon:Ld,text:"Text"},tv:{color:"#f1644b",icon:zd,text:"TV"},tvCommercial:{color:"#84b648",icon:Fd,text:"TV Commercial"},tvFactCheck:{color:"#f1644b",icon:Pd,text:"TV Fact Check"},tvQuote:{color:"#fe7a5f",icon:Id,text:"TV Quote"},video:{color:"#f1644b",icon:Bd,text:"Video"},web:{color:"#ffcd27",icon:Rd,text:"Web"},search:{color:"#000000",icon:_n,text:"Search"}},Od="tv_ads",Nd="factchecked",Ud=new Set(["tvnews","tvarchive","television"]),Hd=new Set(["radio","radioprogram"]);let Co=class extends I{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var e,t;return this.isTvItem?this.tvDisplayMediatype:this.isRadioItem?"radio":(t=(e=this.model)===null||e===void 0?void 0:e.mediatype)!==null&&t!==void 0?t:"none"}get tvDisplayMediatype(){var e,t;return this.isTvCommercial?"tvCommercial":!((e=this.model)===null||e===void 0)&&e.isTvSearchResult&&this.isTvFactCheck?"tvFactCheck":!((t=this.model)===null||t===void 0)&&t.isTvSearchResult&&this.isTvQuote?"tvQuote":"tv"}get isTvItem(){var e,t;return!!(((e=this.model)===null||e===void 0?void 0:e.mediatype)==="movies"&&(!((t=this.model)===null||t===void 0)&&t.collections.some(i=>Ud.has(i))))}get isTvCommercial(){var e,t,i;return!!(!((t=(e=this.model)===null||e===void 0?void 0:e.adIds)===null||t===void 0)&&t.length||!((i=this.model)===null||i===void 0)&&i.collections.includes(Od))}get isTvFactCheck(){var e,t,i;return!!(!((t=(e=this.model)===null||e===void 0?void 0:e.factChecks)===null||t===void 0)&&t.length||!((i=this.model)===null||i===void 0)&&i.collections.includes(Nd))}get isTvQuote(){var e;return!!(!((e=this.model)===null||e===void 0)&&e.isClip)}get isRadioItem(){var e,t;return!!(((e=this.model)===null||e===void 0?void 0:e.mediatype)==="audio"&&(!((t=this.model)===null||t===void 0)&&t.collections.some(i=>Hd.has(i))))}render(){const e=$n[this.displayMediatype];return e?u`
      <div
        id="icon"
    ...
    `}};n([c({type:Object})],Co.prototype,"model",void 0);n([c({type:Boolean})],Co.prototype,"showText",void 0);Co=n([B("tile-mediatype-icon")],Co);const Vd=N`
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path
...
`;function qd(s,e){let t=1;return s>=1e9?t=1e9:s>=1e6?t=1e6:s>=1e3&&e==="short"&&(t=1e3),t}function Yd(s=0,e){const t=s/e,i=t<10;let o=0;return i?o=Math.round((t+Number.EPSILON)*10)/10:o=Math.round(t),o}function Qd(s,e,t,i){switch(e){case 1e9:return C(t==="short"?Ze`${s}B`:Ze`${s} billion`);case 1e6:return C(t==="short"?Ze`${s}M`:Ze`${s} million`);case 1e3:return C(t==="short"?Ze`${s}K`:Ze`${s} thousand`);default:return new Intl.NumberFormat(i).format(s)}}function ur(s,e="long",t="short",i="en-US"){const o=s??-1;if(o<0)return"";const r=qd(o,e),a=Yd(o,r);return Qd(a,r,t,i)}let We=class extends I{constructor(){super(...arguments),this.showTvClips=!1}render(){return u`
    ...
    `}columnTemplate(e,t,i,o=[]){const r=ur(e??0,"short","short"),a=C(Ze`${r} ${t}`),l=t+":";return u`
    ...
    `}get viewsColumnTemplate(){var e;const t=(e=this.viewLabel)!==null&&e!==void 0?e:C("all-time views");return this.columnTemplate(this.viewCount,t,jd)}get uploadsColumnTemplate(){return this.columnTemplate(this.itemCount,C("uploads"),Wd)}get favoritesColumnTemplate(){return this.columnTemplate(this.favCount,C("favorites"),xn)}get reviewsColumnTemplate(){return this.columnTemplate(this.commentCount,C("reviews"),Vd,["reviews"])}get tvClipsColumnTemplate(){return this.columnTemplate(this.tvClipCount,C("clips"),Gd)}static get styles(){return[tt,g`
        tile-mediatype-icon {
          --iconHeight: 25px;
          --iconWidth: 25px;
        }
      ...
      `]}};n([c({type:Object})],We.prototype,"model",void 0);n([c({type:String})],We.prototype,"mediatype",void 0);n([c({type:Number})],We.prototype,"itemCount",void 0);n([c({type:Number})],We.prototype,"viewCount",void 0);n([c({type:String})],We.prototype,"viewLabel",void 0);n([c({type:Number})],We.prototype,"favCount",void 0);n([c({type:Number})],We.prototype,"commentCount",void 0);n([c({type:Boolean})],We.prototype,"showTvClips",void 0);n([c({type:Number})],We.prototype,"tvClipCount",void 0);We=n([B("tile-stats")],We);let Wi=class extends le{constructor(){super(...arguments),this.showInfoButton=!1,this.showTvClips=!1,this.simpleLayoutType="none"}render(){var e;const t=(e=this.model)===null||e===void 0?void 0:e.title,i=at({container:!0,simple:this.simpleLayoutType!=="none","stats-only":this.simpleLayoutType==="stats-only","snippets-only":this.simpleLayoutType==="snippets-only"});return u`
      <div class=${i}>
        ${this.infoButtonTemplate}
        <div class="tile-details">
          <div class="item-info">
    ...
    `}get sortedDateInfoTemplate(){var e,t,i,o,r;let a,l="long";switch((e=this.effectiveSort)===null||e===void 0?void 0:e.field){case"date":{const p=(t=this.model)===null||t===void 0?void 0:t.datePublished;a={field:"published",value:p},pr(p)&&(l="year-only");break}case"reviewdate":a={field:"reviewed",value:(i=this.model)===null||i===void 0?void 0:i.dateReviewed};break;case"addeddate":a={field:"added",value:(o=this.model)===null||o===void 0?void 0:o.dateAdded};break;case"publicdate":a={field:"archived",value:(r=this.model)===null||r===void 0?void 0:r.dateArchived};break}if(!(a!=null&&a.value))return b;const d=this.getFormattedDate(a.value,l);return u`
    ...
    `}get webArchivesCaptureDatesTemplate(){var e;return!(!((e=this.model)===null||e===void 0)&&e.captureDates)||!this.model.title?b:u`
      <ul class="capture-dates">
        ${Dt(this.model.captureDates,t=>u`<li>
    ...
    `}get isSortedByDate(){var e;return["date","reviewdate","addeddate","publicdate"].includes((e=this.effectiveSort)===null||e===void 0?void 0:e.field)}get effectiveSort(){var e;return(e=this.sortParam)!==null&&e!==void 0?e:this.defaultSortParam}get hasSnippets(){var e,t;return!!(!((t=(e=this.model)===null||e===void 0?void 0:e.snippets)===null||t===void 0)&&t.length)}infoButtonPressed(e){e.preventDefault();const t=new CustomEvent("infoButtonPressed",{detail:{x:e.clientX,y:e.clientY}});this.dispatchEvent(t)}static get styles(){const e=g`var(--tileBorderColor, #dddddd)`;return[Bo,g`
      ...
      `]}};n([c({type:Boolean})],Wi.prototype,"showInfoButton",void 0);n([c({type:Boolean})],Wi.prototype,"showTvClips",void 0);n([c({type:String})],Wi.prototype,"simpleLayoutType",void 0);Wi=n([B("item-tile")],Wi);let Os=class extends le{constructor(){super(...arguments),this.showInfoButton=!1}render(){return u`
      <div class="container">
        ${this.infoButtonTemplate}
        <div class="tile-details">
          <div class="item-info">
    ...
    >
          ...
          &#9432;
          <span class="sr-only">${C("More info")}</span>
        </button>`:b}infoButtonPressed(e){e.preventDefault();const t=new CustomEvent("infoButtonPressed",{detail:{x:e.clientX,y:e.clientY}});this.dispatchEvent(t)}static get styles(){const e=g`var(--tileBorderColor, #dddddd)`;return[Bo,g`
        .container {
          border: 1px solid ${e};
        }
      `]}};n([c({type:Boolean})],Os.prototype,"showInfoButton",void 0);Os=n([B("account-tile")],Os);let Ns=class extends le{constructor(){super(...arguments),this.showInfoButton=!1}render(){return u`
      <div class="container">
        <div class="tile-details">
          <div class="item-info">
            ${this.getImageBlockTemplate} ${this.getTitleTemplate}
    ...
    `}get getTitleTemplate(){var e;return u`<div id="title">
      <h3 class="truncated">${(e=this.model)===null||e===void 0?void 0:e.title}</h3>
    </div>`}static get styles(){const e=g`var(--tileBorderColor, #555555)`,t=g`var(--tileBackgroundColor, #666666)`,i=g`#fff`;return[Bo,g`
        .container {
          background-color: ${t};
          border: 1px solid ${e};
        }
      ...
      `]}};n([c({type:Boolean})],Ns.prototype,"showInfoButton",void 0);Ns=n([B("search-tile")],Ns);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class Us extends mi{constructor(e){if(super(e),this.et=J,e.type!==Ue.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===J||e==null)return this.ft=void 0,this.et=e;if(e===Me)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.et)return this.ft;this.et=e;const t=[e];return t.raw=t,this.ft={_$litType$:this.constructor.resultType,strings:t,values:[]}}}Us.directiveName="unsafeHTML",Us.resultType=1;const Kd=fi(Us);/*! @license DOMPurify 3.2.4 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/3.2.4/LICENSE */const{entries:Cn,setPrototypeOf:ma,isFrozen:Xd,getPrototypeOf:Zd,getOwnPropertyDescriptor:Jd}=Object;let{freeze:xe,seal:Fe,create:kn}=Object,{apply:Hs,construct:Vs}=typeof Reflect<"u"&&Reflect;xe||(xe=function(e){return e});Fe||(Fe=function(e){return e});Hs||(Hs=function(e,t,i){return e.apply(t,i)});Vs||(Vs=function(e,t){return new e(...t)});const oo=_e(Array.prototype.forEach),ec=_e(Array.prototype.lastIndexOf),va=_e(Array.prototype.pop),$i=_e(Array.prototype.push),tc=_e(Array.prototype.splice),ho=_e(String.prototype.toLowerCase),as=_e(String.prototype.toString),ga=_e(String.prototype.match),Ci=_e(String.prototype.replace),ic=_e(String.prototype.indexOf),oc=_e(String.prototype.trim),Ie=_e(Object.prototype.hasOwnProperty),we=_e(RegExp.prototype.test),ki=sc(TypeError);function _e(s){return function(e){for(var t=arguments.length,i=new Array(t>1?t-1:0),o=1;o<t;o++)i[o-1]=arguments[o];return Hs(s,e,i)}}function sc(s){return function(){for(var e=arguments.length,t=new Array(e),i=0;i<e;i++)t[i]=arguments[i];return Vs(s,t)}}function U(s,e){let t=arguments.length>2&&arguments[2]!==void 0?arguments[2]:ho;ma&&ma(s,null);let i=e.length;for(;i--;){let o=e[i];if(typeof o=="string"){const r=t(o);r!==o&&(Xd(e)||(e[i]=r),o=r)}s[o]=!0}return s}function rc(s){for(let e=0;e<s.length;e++)Ie(s,e)||(s[e]=null);return s}function Tt(s){const e=kn(null);for(const[t,i]of Cn(s))Ie(s,t)&&(Array.isArray(i)?e[t]=rc(i):i&&typeof i=="object"&&i.constructor===Object?e[t]=Tt(i):e[t]=i);return e}function Ti(s,e){for(;s!==null;){const i=Jd(s,e);if(i){if(i.get)return _e(i.get);if(typeof i.value=="function")return _e(i.value)}s=Zd(s)}function t(){return null}return t}const ba=xe(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","section","select","shadow","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),ns=xe(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","filter","font","g","glyph","glyphref","hkern","image","line","lineargradient","marker","mask","metadata","mpath","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),ls=xe(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feDropShadow","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),ac=xe(["animate","color-profile","cursor","discard","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),ds=xe(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover","mprescripts"]),nc=xe(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),ya=xe(["#text"]),wa=xe(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","face","for","headers","height","hidden","high","href","hreflang","id","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","pattern","placeholder","playsinline","popover","popovertarget","popovertargetaction","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","wrap","xmlns","slot"]),cs=xe(["accent-height","accumulate","additive","alignment-baseline","amplitude","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","exponent","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","intercept","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","slope","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","tablevalues","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),Sa=xe(["accent","accentunder","align","bevelled","close","columnsalign","columnlines","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lspace","lquote","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),so=xe(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),lc=Fe(/\{\{[\w\W]*|[\w\W]*\}\}/gm),dc=Fe(/<%[\w\W]*|[\w\W]*%>/gm),cc=Fe(/\$\{[\w\W]*/gm),hc=Fe(/^data-[\-\w.\u00B7-\uFFFF]+$/),pc=Fe(/^aria-[\-\w]+$/),Tn=Fe(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),uc=Fe(/^(?:\w+script|data):/i),fc=Fe(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),Mn=Fe(/^html$/i),mc=Fe(/^[a-z][.\w]*(-[.\w]+)+$/i);var xa=Object.freeze({__proto__:null,ARIA_ATTR:pc,ATTR_WHITESPACE:fc,CUSTOM_ELEMENT:mc,DATA_ATTR:hc,DOCTYPE_NAME:Mn,ERB_EXPR:dc,IS_ALLOWED_URI:Tn,IS_SCRIPT_OR_DATA:uc,MUSTACHE_EXPR:lc,TMPLIT_EXPR:cc});const Mi={element:1,text:3,progressingInstruction:7,comment:8,document:9},vc=function(){return typeof window>"u"?null:window},gc=function(e,t){if(typeof e!="object"||typeof e.createPolicy!="function")return null;let i=null;const o="data-tt-policy-suffix";t&&t.hasAttribute(o)&&(i=t.getAttribute(o));const r="dompurify"+(i?"#"+i:"");try{return e.createPolicy(r,{createHTML(a){return a},createScriptURL(a){return a}})}catch{return console.warn("TrustedTypes policy "+r+" could not be created."),null}},_a=function(){return{afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}};function En(){let s=arguments.length>0&&arguments[0]!==void 0?arguments[0]:vc();const e=F=>En(F);if(e.version="3.2.4",e.removed=[],!s||!s.document||s.document.nodeType!==Mi.document||!s.Element)return e.isSupported=!1,e;let{document:t}=s;const i=t,o=i.currentScript,{DocumentFragment:r,HTMLTemplateElement:a,Node:l,Element:d,NodeFilter:p,NamedNodeMap:h=s.NamedNodeMap||s.MozNamedAttrMap,HTMLFormElement:f,DOMParser:v,trustedTypes:y}=s,x=d.prototype,S=Ti(x,"cloneNode"),k=Ti(x,"remove"),D=Ti(x,"nextSibling"),E=Ti(x,"childNodes"),A=Ti(x,"parentNode");if(typeof a=="function"){const F=t.createElement("template");F.content&&F.content.ownerDocument&&(t=F.content.ownerDocument)}let R,V="";const{implementation:re,createNodeIterator:De,createDocumentFragment:ve,getElementsByTagName:ce}=t,{importNode:Te}=i;let Q=_a();e.isSupported=typeof Cn=="function"&&typeof A=="function"&&re&&re.createHTMLDocument!==void 0;const{MUSTACHE_EXPR:qe,ERB_EXPR:Ye,TMPLIT_EXPR:K,DATA_ATTR:he,ARIA_ATTR:Le,IS_SCRIPT_OR_DATA:bt,ATTR_WHITESPACE:Rt,CUSTOM_ELEMENT:vi}=xa;let{IS_ALLOWED_URI:It}=xa,ie=null;const Ot=U({},[...ba,...ns,...ls,...ds,...ya]);let ae=null;const Nt=U({},[...wa,...cs,...Sa,...so]);let X=Object.seal(kn(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),it=null,yt=null,Ut=!0,wt=!0,gi=!1,br=!0,Ht=!1,Oo=!0,St=!1,No=!1,Uo=!1,Vt=!1,Yi=!1,Qi=!1,yr=!0,wr=!1;const Un="user-content-";let Ho=!0,bi=!1,Wt={},jt=null;const Sr=U({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","style","svg","template","thead","title","video","xmp"]);let xr=null;const _r=U({},["audio","video","img","source","image","track"]);let Vo=null;const $r=U({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),Ki="http://www.w3.org/1998/Math/MathML",Xi="http://www.w3.org/2000/svg",ot="http://www.w3.org/1999/xhtml";let Gt=ot,Wo=!1,jo=null;const Hn=U({},[Ki,Xi,ot],as);let Zi=U({},["mi","mo","mn","ms","mtext"]),Ji=U({},["annotation-xml"]);const Vn=U({},["title","style","font","a","script"]);let yi=null;const Wn=["application/xhtml+xml","text/html"],jn="text/html";let ue=null,qt=null;const Gn=t.createElement("form"),Cr=function(m){return m instanceof RegExp||m instanceof Function},Go=function(){let m=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if(!(qt&&qt===m)){if((!m||typeof m!="object")&&(m={}),m=Tt(m),yi=Wn.indexOf(m.PARSER_MEDIA_TYPE)===-1?jn:m.PARSER_MEDIA_TYPE,ue=yi==="application/xhtml+xml"?as:ho,ie=Ie(m,"ALLOWED_TAGS")?U({},m.ALLOWED_TAGS,ue):Ot,ae=Ie(m,"ALLOWED_ATTR")?U({},m.ALLOWED_ATTR,ue):Nt,jo=Ie(m,"ALLOWED_NAMESPACES")?U({},m.ALLOWED_NAMESPACES,as):Hn,Vo=Ie(m,"ADD_URI_SAFE_ATTR")?U(Tt($r),m.ADD_URI_SAFE_ATTR,ue):$r,xr=Ie(m,"ADD_DATA_URI_TAGS")?U(Tt(_r),m.ADD_DATA_URI_TAGS,ue):_r,jt=Ie(m,"FORBID_CONTENTS")?U({},m.FORBID_CONTENTS,ue):Sr,it=Ie(m,"FORBID_TAGS")?U({},m.FORBID_TAGS,ue):{},yt=Ie(m,"FORBID_ATTR")?U({},m.FORBID_ATTR,ue):{},Wt=Ie(m,"USE_PROFILES")?m.USE_PROFILES:!1,Ut=m.ALLOW_ARIA_ATTR!==!1,wt=m.ALLOW_DATA_ATTR!==!1,gi=m.ALLOW_UNKNOWN_PROTOCOLS||!1,br=m.ALLOW_SELF_CLOSE_IN_ATTR!==!1,Ht=m.SAFE_FOR_TEMPLATES||!1,Oo=m.SAFE_FOR_XML!==!1,St=m.WHOLE_DOCUMENT||!1,Vt=m.RETURN_DOM||!1,Yi=m.RETURN_DOM_FRAGMENT||!1,Qi=m.RETURN_TRUSTED_TYPE||!1,Uo=m.FORCE_BODY||!1,yr=m.SANITIZE_DOM!==!1,wr=m.SANITIZE_NAMED_PROPS||!1,Ho=m.KEEP_CONTENT!==!1,bi=m.IN_PLACE||!1,It=m.ALLOWED_URI_REGEXP||Tn,Gt=m.NAMESPACE||ot,Zi=m.MATHML_TEXT_INTEGRATION_POINTS||Zi,Ji=m.HTML_INTEGRATION_POINTS||Ji,X=m.CUSTOM_ELEMENT_HANDLING||{},m.CUSTOM_ELEMENT_HANDLING&&Cr(m.CUSTOM_ELEMENT_HANDLING.tagNameCheck)&&(X.tagNameCheck=m.CUSTOM_ELEMENT_HANDLING.tagNameCheck),m.CUSTOM_ELEMENT_HANDLING&&Cr(m.CUSTOM_ELEMENT_HANDLING.attributeNameCheck)&&(X.attributeNameCheck=m.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),m.CUSTOM_ELEMENT_HANDLING&&typeof m.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements=="boolean"&&(X.allowCustomizedBuiltInElements=m.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements),Ht&&(wt=!1),Yi&&(Vt=!0),Wt&&(ie=U({},ya),ae=[],Wt.html===!0&&(U(ie,ba),U(ae,wa)),Wt.svg===!0&&(U(ie,ns),U(ae,cs),U(ae,so)),Wt.svgFilters===!0&&(U(ie,ls),U(ae,cs),U(ae,so)),Wt.mathMl===!0&&(U(ie,ds),U(ae,Sa),U(ae,so))),m.ADD_TAGS&&(ie===Ot&&(ie=Tt(ie)),U(ie,m.ADD_TAGS,ue)),m.ADD_ATTR&&(ae===Nt&&(ae=Tt(ae)),U(ae,m.ADD_ATTR,ue)),m.ADD_URI_SAFE_ATTR&&U(Vo,m.ADD_URI_SAFE_ATTR,ue),m.FORBID_CONTENTS&&(jt===Sr&&(jt=Tt(jt)),U(jt,m.FORBID_CONTENTS,ue)),Ho&&(ie["#text"]=!0),St&&U(ie,["html","head","body"]),ie.table&&(U(ie,["tbody"]),delete it.tbody),m.TRUSTED_TYPES_POLICY){if(typeof m.TRUSTED_TYPES_POLICY.createHTML!="function")throw ki('TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.');if(typeof m.TRUSTED_TYPES_POLICY.createScriptURL!="function")throw ki('TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.');R=m.TRUSTED_TYPES_POLICY,V=R.createHTML("")}else R===void 0&&(R=gc(y,o)),R!==null&&typeof V=="string"&&(V=R.createHTML(""));xe&&xe(m),qt=m}},kr=U({},[...ns,...ls,...ac]),Tr=U({},[...ds,...nc]),qn=function(m){let _=A(m);(!_||!_.tagName)&&(_={namespaceURI:Gt,tagName:"template"});const L=ho(m.tagName),Z=ho(_.tagName);return jo[m.namespaceURI]?m.namespaceURI===Xi?_.namespaceURI===ot?L==="svg":_.namespaceURI===Ki?L==="svg"&&(Z==="annotation-xml"||Zi[Z]):!!kr[L]:m.namespaceURI===Ki?_.namespaceURI===ot?L==="math":_.namespaceURI===Xi?L==="math"&&Ji[Z]:!!Tr[L]:m.namespaceURI===ot?_.namespaceURI===Xi&&!Ji[Z]||_.namespaceURI===Ki&&!Zi[Z]?!1:!Tr[L]&&(Vn[L]||!kr[L]):!!(yi==="application/xhtml+xml"&&jo[m.namespaceURI]):!1},Qe=function(m){$i(e.removed,{element:m});try{A(m).removeChild(m)}catch{k(m)}},eo=function(m,_){try{$i(e.removed,{attribute:_.getAttributeNode(m),from:_})}catch{$i(e.removed,{attribute:null,from:_})}if(_.removeAttribute(m),m==="is")if(Vt||Yi)try{Qe(_)}catch{}else try{_.setAttribute(m,"")}catch{}},Mr=function(m){let _=null,L=null;if(Uo)m="<remove></remove>"+m;else{const fe=ga(m,/^[\r\n\t ]+/);L=fe&&fe[0]}yi==="application/xhtml+xml"&&Gt===ot&&(m='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+m+"</body></html>");const Z=R?R.createHTML(m):m;if(Gt===ot)try{_=new v().parseFromString(Z,yi)}catch{}if(!_||!_.documentElement){_=re.createDocument(Gt,"template",null);try{_.documentElement.innerHTML=Wo?V:Z}catch{}}const ge=_.body||_.documentElement;return m&&L&&ge.insertBefore(t.createTextNode(L),ge.childNodes[0]||null),Gt===ot?ce.call(_,St?"html":"body")[0]:St?_.documentElement:ge},Er=function(m){return De.call(m.ownerDocument||m,m,p.SHOW_ELEMENT|p.SHOW_COMMENT|p.SHOW_TEXT|p.SHOW_PROCESSING_INSTRUCTION|p.SHOW_CDATA_SECTION,null)},qo=function(m){return m instanceof f&&(typeof m.nodeName!="string"||typeof m.textContent!="string"||typeof m.removeChild!="function"||!(m.attributes instanceof h)||typeof m.removeAttribute!="function"||typeof m.setAttribute!="function"||typeof m.namespaceURI!="string"||typeof m.insertBefore!="function"||typeof m.hasChildNodes!="function")},Ar=function(m){return typeof l=="function"&&m instanceof l};function st(F,m,_){oo(F,L=>{L.call(e,m,_,qt)})}const Dr=function(m){let _=null;if(st(Q.beforeSanitizeElements,m,null),qo(m))return Qe(m),!0;const L=ue(m.nodeName);if(st(Q.uponSanitizeElement,m,{tagName:L,allowedTags:ie}),m.hasChildNodes()&&!Ar(m.firstElementChild)&&we(/<[/\w]/g,m.innerHTML)&&we(/<[/\w]/g,m.textContent)||m.nodeType===Mi.progressingInstruction||Oo&&m.nodeType===Mi.comment&&we(/<[/\w]/g,m.data))return Qe(m),!0;if(!ie[L]||it[L]){if(!it[L]&&zr(L)&&(X.tagNameCheck instanceof RegExp&&we(X.tagNameCheck,L)||X.tagNameCheck instanceof Function&&X.tagNameCheck(L)))return!1;if(Ho&&!jt[L]){const Z=A(m)||m.parentNode,ge=E(m)||m.childNodes;if(ge&&Z){const fe=ge.length;for(let Ce=fe-1;Ce>=0;--Ce){const Ke=S(ge[Ce],!0);Ke.__removalCount=(m.__removalCount||0)+1,Z.insertBefore(Ke,D(m))}}}return Qe(m),!0}return m instanceof d&&!qn(m)||(L==="noscript"||L==="noembed"||L==="noframes")&&we(/<\/no(script|embed|frames)/i,m.innerHTML)?(Qe(m),!0):(Ht&&m.nodeType===Mi.text&&(_=m.textContent,oo([qe,Ye,K],Z=>{_=Ci(_,Z," ")}),m.textContent!==_&&($i(e.removed,{element:m.cloneNode()}),m.textContent=_)),st(Q.afterSanitizeElements,m,null),!1)},Lr=function(m,_,L){if(yr&&(_==="id"||_==="name")&&(L in t||L in Gn))return!1;if(!(wt&&!yt[_]&&we(he,_))){if(!(Ut&&we(Le,_))){if(!ae[_]||yt[_]){if(!(zr(m)&&(X.tagNameCheck instanceof RegExp&&we(X.tagNameCheck,m)||X.tagNameCheck instanceof Function&&X.tagNameCheck(m))&&(X.attributeNameCheck instanceof RegExp&&we(X.attributeNameCheck,_)||X.attributeNameCheck instanceof Function&&X.attributeNameCheck(_))||_==="is"&&X.allowCustomizedBuiltInElements&&(X.tagNameCheck instanceof RegExp&&we(X.tagNameCheck,L)||X.tagNameCheck instanceof Function&&X.tagNameCheck(L))))return!1}else if(!Vo[_]){if(!we(It,Ci(L,Rt,""))){if(!((_==="src"||_==="xlink:href"||_==="href")&&m!=="script"&&ic(L,"data:")===0&&xr[m])){if(!(gi&&!we(bt,Ci(L,Rt,"")))){if(L)return!1}}}}}}return!0},zr=function(m){return m!=="annotation-xml"&&ga(m,vi)},Fr=function(m){st(Q.beforeSanitizeAttributes,m,null);const{attributes:_}=m;if(!_||qo(m))return;const L={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:ae,forceKeepAttr:void 0};let Z=_.length;for(;Z--;){const ge=_[Z],{name:fe,namespaceURI:Ce,value:Ke}=ge,wi=ue(fe);let ye=fe==="value"?Ke:oc(Ke);if(L.attrName=wi,L.attrValue=ye,L.keepAttr=!0,L.forceKeepAttr=void 0,st(Q.uponSanitizeAttribute,m,L),ye=L.attrValue,wr&&(wi==="id"||wi==="name")&&(eo(fe,m),ye=Un+ye),Oo&&we(/((--!?|])>)|<\/(style|title)/i,ye)){eo(fe,m);continue}if(L.forceKeepAttr||(eo(fe,m),!L.keepAttr))continue;if(!br&&we(/\/>/i,ye)){eo(fe,m);continue}Ht&&oo([qe,Ye,K],Br=>{ye=Ci(ye,Br," ")});const Pr=ue(m.nodeName);if(Lr(Pr,wi,ye)){if(R&&typeof y=="object"&&typeof y.getAttributeType=="function"&&!Ce)switch(y.getAttributeType(Pr,wi)){case"TrustedHTML":{ye=R.createHTML(ye);break}case"TrustedScriptURL":{ye=R.createScriptURL(ye);break}}try{Ce?m.setAttributeNS(Ce,fe,ye):m.setAttribute(fe,ye),qo(m)?Qe(m):va(e.removed)}catch{}}}st(Q.afterSanitizeAttributes,m,null)},Yn=function F(m){let _=null;const L=Er(m);for(st(Q.beforeSanitizeShadowDOM,m,null);_=L.nextNode();)st(Q.uponSanitizeShadowNode,_,null),Dr(_),Fr(_),_.content instanceof r&&F(_.content);st(Q.afterSanitizeShadowDOM,m,null)};return e.sanitize=function(F){let m=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},_=null,L=null,Z=null,ge=null;if(Wo=!F,Wo&&(F="<!-->"),typeof F!="string"&&!Ar(F))if(typeof F.toString=="function"){if(F=F.toString(),typeof F!="string")throw ki("dirty is not a string, aborting")}else throw ki("toString is not a function");if(!e.isSupported)return F;if(No||Go(m),e.removed=[],typeof F=="string"&&(bi=!1),bi){if(F.nodeName){const Ke=ue(F.nodeName);if(!ie[Ke]||it[Ke])throw ki("root node is forbidden and cannot be sanitized in-place")}}else if(F instanceof l)_=Mr("<!---->"),L=_.ownerDocument.importNode(F,!0),L.nodeType===Mi.element&&L.nodeName==="BODY"||L.nodeName==="HTML"?_=L:_.appendChild(L);else{if(!Vt&&!Ht&&!St&&F.indexOf("<")===-1)return R&&Qi?R.createHTML(F):F;if(_=Mr(F),!_)return Vt?null:Qi?V:""}_&&Uo&&Qe(_.firstChild);const fe=Er(bi?F:_);for(;Z=fe.nextNode();)Dr(Z),Fr(Z),Z.content instanceof r&&Yn(Z.content);if(bi)return F;if(Vt){if(Yi)for(ge=ve.call(_.ownerDocument);_.firstChild;)ge.appendChild(_.firstChild);else ge=_;return(ae.shadowroot||ae.shadowrootmode)&&(ge=Te.call(i,ge,!0)),ge}let Ce=St?_.outerHTML:_.innerHTML;return St&&ie["!doctype"]&&_.ownerDocument&&_.ownerDocument.doctype&&_.ownerDocument.doctype.name&&we(Mn,_.ownerDocument.doctype.name)&&(Ce="<!DOCTYPE "+_.ownerDocument.doctype.name+`>
`+Ce),Ht&&oo([qe,Ye,K],Ke=>{Ce=Ci(Ce,Ke," ")}),R&&Qi?R.createHTML(Ce):Ce},e.setConfig=function(){let F=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};Go(F),No=!0},e.clearConfig=function(){qt=null,No=!1},e.isValidAttribute=function(F,m,_){qt||Go({});const L=ue(F),Z=ue(m);return Lr(L,Z,_)},e.addHook=function(F,m){typeof m=="function"&&$i(Q[F],m)},e.removeHook=function(F,m){if(m!==void 0){const _=ec(Q[F],m);return _===-1?void 0:tc(Q[F],_,1)[0]}return va(Q[F])},e.removeHooks=function(F){Q[F]=[]},e.removeAllHooks=function(){Q=_a()},e}var po=En();let ko=class extends le{constructor(){super(...arguments),this.collectionLinks=[]}render(){return u`
    ...
    `}get imageBlockTemplate(){var e;if(!this.model)return b;const t=this.model.mediatype==="collection",i=this.displayValueProvider.itemPageUrl(this.model.identifier,t);return u`<a
      id="image-link"
      title=${C(Ze`View ${(e=this.model)===null||e===void 0?void 0:e.title}`)}
      href=${i}
    >
      <image-block
        .model=${this.model}
    ...
    `}get iconRightTemplate(){var e;return u`
      <a
        ...
        title=${C(Ze`See more: ${(e=this.model)===null||e===void 0?void 0:e.mediatype}`)}
      >
        <tile-mediatype-icon .model=${this.model}> </tile-mediatype-icon>
      </a>
    ...
    `:b}get volumeTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.volume,C("Volume"))}get issueTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.issue,C("Issue"))}get creatorTemplate(){var e,t,i;return((e=this.model)===null||e===void 0?void 0:e.mediatype)==="account"?u`
      ...
      <div id="creator" class="metadata">
        ...
        ${co(Dt(this.model.creators,o=>this.searchLink("creator",o)),", ")}
      </div>
    `}get datePublishedTemplate(){var e;const t=(e=this.model)===null||e===void 0?void 0:e.datePublished;let i="long";return pr(t)&&(i="year-only"),this.metadataTemplate(this.getFormattedDate(t,i),C("Published"))}get dateSortByTemplate(){return this.effectiveSort&&(this.effectiveSort.field==="addeddate"||this.effectiveSort.field==="reviewdate"||this.effectiveSort.field==="publicdate")?this.metadataTemplate(this.getFormattedDate(this.date,"long"),this.displayValueProvider.dateLabel):b}get viewsTemplate(){var e,t,i,o;const r=((e=this.effectiveSort)===null||e===void 0?void 0:e.field)==="week"?(t=this.model)===null||t===void 0?void 0:t.weeklyViewCount:(i=this.model)===null||i===void 0?void 0:i.viewCount;return r==null?b:((o=this.model)===null||o===void 0?void 0:o.mediatype)==="search"?this.metadataTemplate("(Favorited search query)",""):this.metadataTemplate(`${ur(r,this.formatSize)}`,C("Views"))}get ratingTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.averageRating,C("Avg Rating"))}get reviewsTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.commentCount,C("Reviews"))}get topicsTemplate(){var e;return!(!((e=this.model)===null||e===void 0)&&e.subjects)||this.model.subjects.length===0?b:u`
      <div id="topics" class="metadata">
        ${this.labelTemplate(C("Topics"))}
        ${co(Dt(this.model.subjects,t=>this.searchLink("subject",t)),", ")}
      </div>
    `}get collectionsTemplate(){return!this.collectionLinks||this.collectionLinks.length===0?b:u`
      <div id="collections" class="metadata">
        ...
        ${co(this.collectionLinks,", ")}
      </div>
    `}get descriptionTemplate(){var e,t,i;return this.metadataTemplate(Kd(po.sanitize((i=(t=(e=this.model)===null||e===void 0?void 0:e.description)===null||t===void 0?void 0:t.replace(/\n/g," "))!==null&&i!==void 0?i:"")),"","description")}get reviewBlockTemplate(){var e;if(!(!((e=this.model)===null||e===void 0)&&e.review))return b;const{reviewtitle:t,reviewbody:i,stars:o}=this.model.review;return u`
      <review-block
        viewsize="list"
        title=${ke(t)}
        body=${ke(i)}
    ...
    >
      ${po.sanitize(t)}</a
    >`}detailsLink(e,t,i=!1){if(!e)return b;const o=t??e,r=this.displayValueProvider.itemPageUrl(e,i);return u`<a href=${r}> ${po.sanitize(o)} </a>`}get mediatypeURL(){var e;if(this.baseNavigationUrl===void 0||!(!((e=this.model)===null||e===void 0)&&e.mediatype))return b;switch(this.model.mediatype){case"collection":return`${this.baseNavigationUrl}/search?query=mediatype:collection&sort=-downloads`;case"account":return b;default:return this.displayValueProvider.itemPageUrl(this.model.mediatype,!0)}}updated(e){(e.has("model")||e.has("collectionTitles"))&&this.buildCollectionLinks()}async buildCollectionLinks(){var e,t,i;if(!(!((e=this.model)===null||e===void 0)&&e.collections)||this.model.collections.length===0)return;this.collectionLinks=[];const o=[];for(const r of this.model.collections)!Po[r]&&!r.startsWith("fav-")&&o.push(this.detailsLink(r,(i=(t=this.collectionTitles)===null||t===void 0?void 0:t.get(r))!==null&&i!==void 0?i:r,!0));this.collectionLinks=o}get date(){var e,t,i,o,r;switch((e=this.effectiveSort)===null||e===void 0?void 0:e.field){case"date":return(t=this.model)===null||t===void 0?void 0:t.datePublished;case"reviewdate":return(i=this.model)===null||i===void 0?void 0:i.dateReviewed;case"addeddate":return(o=this.model)===null||o===void 0?void 0:o.dateAdded;default:return(r=this.model)===null||r===void 0?void 0:r.dateArchived}}get effectiveSort(){var e;return(e=this.sortParam)!==null&&e!==void 0?e:this.defaultSortParam}get classSize(){return this.mobileBreakpoint&&this.currentWidth&&this.currentWidth<this.mobileBreakpoint?"mobile":"desktop"}get formatSize(){return this.mobileBreakpoint&&this.currentWidth&&this.currentWidth<this.mobileBreakpoint?"short":"long"}static get styles(){return g`
      html {
        font-size: unset;
      }
    ...
    `}};n([c({type:Object})],ko.prototype,"collectionTitles",void 0);n([z()],ko.prototype,"collectionLinks",void 0);ko=n([B("tile-list")],ko);let je=class extends I{constructor(){super(...arguments),this.loggedIn=!1,this.suppressBlurring=!1}render(){return u`
      <div id="container">
        ${this.headerTemplate}
    ...
    `}get headerTemplate(){var e,t,i,o;if(((e=this.model)===null||e===void 0?void 0:e.collections.length)===0)return b;let r="",a="";for(const l of((t=this.model)===null||t===void 0?void 0:t.collections)||[])if(!Po[l]&&!l.startsWith("fav-")){r=(o=(i=this.collectionTitles)===null||i===void 0?void 0:i.get(l))!==null&&o!==void 0?o:l,a=l;break}return a?u`
    ...
    `}};n([c({type:Object})],je.prototype,"model",void 0);n([c({type:String})],je.prototype,"baseNavigationUrl",void 0);n([c({type:String})],je.prototype,"baseImageUrl",void 0);n([c({type:Boolean})],je.prototype,"loggedIn",void 0);n([c({type:Boolean})],je.prototype,"suppressBlurring",void 0);n([c({type:Object})],je.prototype,"sortParam",void 0);n([c({type:Number})],je.prototype,"mobileBreakpoint",void 0);n([c({type:Number})],je.prototype,"currentWidth",void 0);n([c({type:Object})],je.prototype,"collectionTitles",void 0);je=n([B("tile-hover-pane")],je);let $a=class extends le{render(){var e,t,i,o;return u`
      <div id="list-line" class="${this.classSize}">
        <image-block
          .model=${this.model}
          .baseImageUrl=${this.baseImageUrl}
        ...
        <a href=${this.href} id="title"
          >${po.sanitize((t=(e=this.model)===null||e===void 0?void 0:e.title)!==null&&t!==void 0?t:"")}</a
        >
        <div id="creator">
    ...
    `}};$a=n([B("tile-list-compact")],$a);let Ca=class extends le{render(){return u`
    ...
    `}};Ca=n([B("tile-list-compact-header")],Ca);const ka=(s,e=-1/0,t=1/0)=>Math.max(e,Math.min(s,t));class bc{constructor(e,t={}){var i,o,r,a,l,d,p;this.host=e,this.mobileBreakpoint=600,this.offsetX=-10,this.offsetY=15,this.showDelay=300,this.hideDelay=100,this.longPressDelay=600,this.enableLongPress=!1,this.hoverPaneState="hidden",this.forceTouchBackdrop=!1,this.lastPointerClientPos={x:0,y:0},this.handleMouseEnter=h=>{this.handleMouseMove(h)},this.handleMouseMove=h=>{var f;clearTimeout(this.hideTimer),this.hoverPaneState==="fading-out"&&(this.hoverPaneState="shown",(f=this.hoverPane)===null||f===void 0||f.classList.add("fade-in")),this.hoverPaneState==="hidden"&&(this.restartShowHoverPaneTimer(),this.lastPointerClientPos={x:h.clientX,y:h.clientY})},this.handleMouseLeave=()=>{clearTimeout(this.showTimer),clearTimeout(this.hideTimer),this.hoverPaneState!=="hidden"&&(this.hideTimer=window.setTimeout(()=>{this.fadeOutHoverPane()},this.hideDelay))},this.handleTouchStart=h=>{clearTimeout(this.longPressTimer),h.touches.length===1&&(this.longPressTimer=window.setTimeout(()=>{this.hoverPaneState==="hidden"&&this.showHoverPane()},this.longPressDelay),this.lastPointerClientPos={x:h.touches[0].clientX,y:h.touches[0].clientY})},this.handleLongPressCancel=()=>{clearTimeout(this.longPressTimer)},this.handleContextMenu=h=>{h.preventDefault()},this.handleBackdropInteraction=h=>{this.hoverPaneState!=="hidden"&&this.fadeOutHoverPane(),h.stopPropagation()},this.mobileBreakpoint=(i=t.mobileBreakpoint)!==null&&i!==void 0?i:this.mobileBreakpoint,this.offsetX=(o=t.offsetX)!==null&&o!==void 0?o:this.offsetX,this.offsetY=(r=t.offsetY)!==null&&r!==void 0?r:this.offsetY,this.showDelay=(a=t.showDelay)!==null&&a!==void 0?a:this.showDelay,this.hideDelay=(l=t.hideDelay)!==null&&l!==void 0?l:this.hideDelay,this.longPressDelay=(d=t.longPressDelay)!==null&&d!==void 0?d:this.longPressDelay,this.enableLongPress=(p=t.enableLongPress)!==null&&p!==void 0?p:this.enableLongPress,this.host.addController(this)}hostConnected(){this.attachListeners()}hostDisconnected(){this.detachListeners()}hostUpdated(){this.hoverPane=this.host.getHoverPane(),this.hoverPaneProps=this.host.getHoverPaneProps()}getTemplate(){var e,t,i,o,r,a,l;return this.hoverPaneProps=this.host.getHoverPaneProps(),this.shouldRenderHoverPane?u` ${this.touchBackdropTemplate}
          ...
          ></tile-hover-pane>`:b}toggleHoverPane(e){var t;this.hoverPaneState==="shown"?(this.fadeOutHoverPane(),this.forceTouchBackdrop=!1):(this.lastPointerClientPos=e.coords,this.forceTouchBackdrop=(t=e.enableTouchBackdrop)!==null&&t!==void 0?t:!1,this.showHoverPane())}get touchBackdropTemplate(){return this.showTouchBackdrop?u`<div
          id="touch-backdrop"
    ...
    `}firstUpdated(){this.shouldPrepareHoverPane&&(this.hoverPaneController=new bc(this,{mobileBreakpoint:this.mobileBreakpoint,enableLongPress:!1}))}get headerTemplate(){const{currentWidth:e,sortParam:t,defaultSortParam:i,mobileBreakpoint:o}=this;return u`
    ...
    `}get linkTileTemplate(){var e,t,i;return u`
      <a
        ...
        title=${this.shouldPrepareHoverPane?b:ke((i=this.model)===null||i===void 0?void 0:i.title)}
    ...
    `}};Ae.HOVER_PANE_DISPLAY_MODES={grid:!0,"list-compact":!0,"list-detail":!1,"list-header":!1};n([c({type:String})],Ae.prototype,"tileDisplayMode",void 0);n([c({type:Boolean})],Ae.prototype,"isManageView",void 0);n([c({type:Object})],Ae.prototype,"resizeObserver",void 0);n([c({type:Object})],Ae.prototype,"collectionTitles",void 0);n([c({type:Boolean})],Ae.prototype,"showTvClips",void 0);n([c({type:String})],Ae.prototype,"simpleLayoutType",void 0);n([c({type:Boolean})],Ae.prototype,"enableHoverPane",void 0);n([c({type:String})],Ae.prototype,"manageCheckTitle",void 0);n([G("#container")],Ae.prototype,"container",void 0);n([G("tile-hover-pane")],Ae.prototype,"hoverPane",void 0);Ae=Ws=n([B("tile-dispatcher")],Ae);let Ta=class extends I{render(){return u` <div id="container"></div> `}static get styles(){return g`
      :host {
        display: block;
        height: 100%;
      }
...
fill=""></path>
      ...
      >
        <span ?hidden=${!this.open} class="caret-up">
          <slot name="caret-up">${yc}</slot>
        </span>
        <span ?hidden=${this.open} class="caret-down">
          <slot name="caret-down">${wc}</slot>
        </span>
      </span>
    ...
    `}static get styles(){const e=g`var(--dropdownBorderWidth, 1px)`,t=g`var(--dropdownBorderRadius, 4px)`,i=g`var(--dropdownBorderColor, #fff)`,o=g`var(--dropdownBgColor, #333)`,r=g`var(--dropdownTextColor, #fff)`,a=g`var(--dropdownHoverBgColor, rgba(255, 255, 255, 0.3))`,l=g`var(--dropdownSelectedBgColor, #fff)`;return g`
      :host {
        display: inline;
        color: ${r};
      }
    ...
    `}};n([c({type:Boolean,reflect:!0})],de.prototype,"open",void 0);n([c({type:Boolean,reflect:!0})],de.prototype,"isDisabled",void 0);n([c({type:Boolean})],de.prototype,"displayCaret",void 0);n([c({type:Boolean})],de.prototype,"closeOnSelect",void 0);n([c({type:Boolean})],de.prototype,"openViaButton",void 0);n([c({type:Boolean})],de.prototype,"openViaCaret",void 0);n([c({type:Boolean})],de.prototype,"usePopover",void 0);n([c({type:Boolean})],de.prototype,"includeSelectedOption",void 0);n([c({type:String})],de.prototype,"selectedOption",void 0);n([c({attribute:!1})],de.prototype,"options",void 0);n([c({type:String})],de.prototype,"optionGroup",void 0);n([c({attribute:!1})],de.prototype,"optionSelected",void 0);n([c({type:Boolean,reflect:!0})],de.prototype,"isCustomList",void 0);n([c({type:Boolean,reflect:!0})],de.prototype,"hasCustomClickHandler",void 0);n([c({type:Boolean,reflect:!0})],de.prototype,"closeOnEscape",void 0);n([c({type:Boolean,reflect:!0})],de.prototype,"closeOnBackdropClick",void 0);n([G(".ia-dropdown-group")],de.prototype,"container",void 0);n([G("#dropdown-main")],de.prototype,"dropdownMenu",void 0);de=n([B("ia-dropdown")],de);let js=class extends I{render(){return u`
  ...
  `;js=n([B("ia-icon-label")],js);let Gs=class extends I{constructor(){super(...arguments),this.numResults=0}render(){return u`
    ...
    `}};n([c({type:Number})],Gs.prototype,"numResults",void 0);Gs=n([B("alpha-bar-tooltip")],Gs);let ct=class extends I{constructor(){super(...arguments),this.selectedLetter=null,this.tooltipShown=!1,this.alphabet="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("")}get selectedUppercaseLetter(){var e;return(e=this.selectedLetter)===null||e===void 0?void 0:e.toUpperCase()}render(){var e;return u`
  ...
  `;n([c({type:String})],ct.prototype,"selectedLetter",void 0);n([c({type:Object})],ct.prototype,"letterCounts",void 0);n([c({type:String})],ct.prototype,"ariaLandmarkLabel",void 0);n([z()],ct.prototype,"tooltipShown",void 0);n([z()],ct.prototype,"hoveredLetter",void 0);n([G("alpha-bar-tooltip")],ct.prototype,"tooltip",void 0);ct=n([B("alpha-bar")],ct);const Sc=u`
...
`;let Y=class extends I{constructor(){super(...arguments),this.defaultSortDirection=null,this.defaultSortField=$.relevance,this.defaultViewSort=$.weeklyview,this.defaultDateSort=$.date,this.sortDirection=null,this.selectedSort=$.default,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.sortFieldAvailability=Fo,this.enableSortOptionsSlot=!1,this.suppressDisplayModes=!1,this.lastSelectedViewSort=this.defaultViewSort,this.lastSelectedDateSort=this.defaultDateSort,this.alphaSelectorVisible=null,this.dropdownBackdropVisible=!1,this.desktopSortContainerWidth=0,this.selectorBarContainerWidth=0,this.boundSortBarSelectorEscapeListener=e=>{e.key==="Escape"&&this.closeDropdowns()}}render(){return u`
      <div id="container">
    ...
    `}get sortDirectionIcon(){return this.canChangeSortDirection?u`
      <div class="sort-direction-icon">
        ${this.finalizedSortDirection==="asc"?Sc:xc}
      </div>
    `:u`<div class="sort-direction-icon">${_c}</div>`}get desktopSortSelectorTemplate(){return u`
      <div
    ...
    `}get mobileSortSelectorTemplate(){const e=Object.values(Se).filter(t=>t.shownInSortBar&&this.sortFieldAvailability[t.field]);return u`
      <div
        id="mobile-sort-container"
        class=${this.mobileSelectorVisible?"visible":"hidden"}
      >
        ${this.getSortDropdown({displayName:Se[this.finalizedSortField].displayName,id:"mobile-dropdown",selected:!0,dropdownOptions:e.map(t=>this.getDropdownOption(t.field)),selectedOption:this.finalizedSortField,onOptionSelected:this.mobileSortChanged,onDropdownClick:()=>{this.dropdownBackdropVisible=this.mobileDropdown.open,this.mobileDropdown.classList.toggle("open",this.mobileDropdown.open)}})}
      </div>
    `}getSortSelectorButton(e,t){var i;const o=this.finalizedSortField===e,r=Se[e].displayName,a=(i=t==null?void 0:t.onSelected)!==null&&i!==void 0?i:()=>this.clearAlphaBarFilters();return u`
      <button
        class=${o?"selected":""}
        data-title=${r}
    ...
    `}get dropdownBackdrop(){return u`
      ...
      ></div>
    `}closeDropdowns(){this.dropdownBackdropVisible=!1;const e=[this.viewsDropdown,this.dateDropdown,this.mobileDropdown];for(const t of e)t&&(t.open=!1,t.classList.remove("open"))}selectDropdownSortField(e){this.dropdownBackdropVisible=!1,this.setSelectedSort(e)}clearAlphaBarFilters(){this.alphaSelectorVisible=null,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.emitTitleLetterChangedEvent(),this.emitCreatorLetterChangedEvent()}setSortDirection(e){this.sortDirection=e,this.emitSortChangedEvent()}toggleSortDirection(){this.setSortDirection(this.finalizedSortDirection==="desc"?"asc":"desc")}handleSortDirectionClicked(){!this.sortDirection&&this.defaultSortField&&this.defaultSortDirection&&(this.selectedSort=this.defaultSortField,this.sortDirection=this.defaultSortDirection),this.toggleSortDirection()}setSelectedSort(e){this.selectedSort=e;const t=Se[e];this.sortDirection=t.defaultSortDirection,this.emitSortChangedEvent()}get finalizedSortField(){return this.selectedSort===$.default?this.defaultSortField:this.selectedSort}get finalizedSortDirection(){return this.sortDirection===null?this.defaultSortDirection:this.sortDirection}get canChangeSortDirection(){return Se[this.finalizedSortField].canSetDirection}get dateOptionSelected(){return[$.datefavorited,$.datearchived,$.date,$.datereviewed,$.dateadded].includes(this.finalizedSortField)}get viewOptionSelected(){return[$.alltimeview,$.weeklyview].includes(this.finalizedSortField)}get dateSortDisplayName(){return Se[this.lastSelectedDateSort].displayName}get viewSortDisplayName(){return Se[this.lastSelectedViewSort].displayName}get availableViewsFields(){return la.filter(e=>this.sortFieldAvailability[e])}get availableDateFields(){return da.filter(e=>this.sortFieldAvailability[e])}get titleSelectorBar(){var e;return u` <alpha-bar
    ...
    ></alpha-bar>`}titleLetterChanged(e){var t;this.selectedTitleFilter=(t=e.detail.selectedLetter)!==null&&t!==void 0?t:null,this.emitTitleLetterChangedEvent()}creatorLetterChanged(e){var t;this.selectedCreatorFilter=(t=e.detail.selectedLetter)!==null&&t!==void 0?t:null,this.emitCreatorLetterChangedEvent()}emitTitleLetterChangedEvent(){const e=new CustomEvent("titleLetterChanged",{detail:{selectedLetter:this.selectedTitleFilter}});this.dispatchEvent(e)}emitCreatorLetterChangedEvent(){const e=new CustomEvent("creatorLetterChanged",{detail:{selectedLetter:this.selectedCreatorFilter}});this.dispatchEvent(e)}displayModeChanged(){const e=new CustomEvent("displayModeChanged",{detail:{displayMode:this.displayMode}});this.dispatchEvent(e)}emitSortChangedEvent(){const e=new CustomEvent("sortChanged",{detail:{selectedSort:this.selectedSort,sortDirection:this.sortDirection}});this.dispatchEvent(e)}static get styles(){return[tt,g`
      ...
      `]}};n([c({type:String})],Y.prototype,"displayMode",void 0);n([c({type:String})],Y.prototype,"defaultSortDirection",void 0);n([c({type:String})],Y.prototype,"defaultSortField",void 0);n([c({type:String})],Y.prototype,"defaultViewSort",void 0);n([c({type:String})],Y.prototype,"defaultDateSort",void 0);n([c({type:String})],Y.prototype,"sortDirection",void 0);n([c({type:String})],Y.prototype,"selectedSort",void 0);n([c({type:String})],Y.prototype,"selectedTitleFilter",void 0);n([c({type:String})],Y.prototype,"selectedCreatorFilter",void 0);n([c({type:Object})],Y.prototype,"sortFieldAvailability",void 0);n([c({type:Boolean,reflect:!0})],Y.prototype,"enableSortOptionsSlot",void 0);n([c({type:Boolean,reflect:!0})],Y.prototype,"suppressDisplayModes",void 0);n([c({type:Object})],Y.prototype,"prefixFilterCountMap",void 0);n([c({type:Object})],Y.prototype,"resizeObserver",void 0);n([z()],Y.prototype,"lastSelectedViewSort",void 0);n([z()],Y.prototype,"lastSelectedDateSort",void 0);n([z()],Y.prototype,"alphaSelectorVisible",void 0);n([z()],Y.prototype,"dropdownBackdropVisible",void 0);n([z()],Y.prototype,"desktopSortContainerWidth",void 0);n([z()],Y.prototype,"selectorBarContainerWidth",void 0);n([G("#desktop-sort-container")],Y.prototype,"desktopSortContainer",void 0);n([G("#sort-selector-container")],Y.prototype,"sortSelectorContainer",void 0);n([G("#views-dropdown")],Y.prototype,"viewsDropdown",void 0);n([G("#date-dropdown")],Y.prototype,"dateDropdown",void 0);n([G("#mobile-dropdown")],Y.prototype,"mobileDropdown",void 0);Y=n([B("sort-filter-bar")],Y);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function hs(s,e,t){return s?e():t==null?void 0:t()}class Lt{constructor(e){var t,i,o,r,a,l,d;this.title=e==null?void 0:e.title,this.subtitle=e==null?void 0:e.subtitle,this.headline=e==null?void 0:e.headline,this.message=e==null?void 0:e.message,this.headerColor=(t=e==null?void 0:e.headerColor)!==null&&t!==void 0?t:"#55A183",this.bodyColor=(i=e==null?void 0:e.bodyColor)!==null&&i!==void 0?i:"#f5f5f7",this.showProcessingIndicator=(o=e==null?void 0:e.showProcessingIndicator)!==null&&o!==void 0?o:!1,this.processingImageMode=(r=e==null?void 0:e.processingImageMode)!==null&&r!==void 0?r:"complete",this.showCloseButton=(a=e==null?void 0:e.showCloseButton)!==null&&a!==void 0?a:!0,this.showHeaderLogo=(l=e==null?void 0:e.showHeaderLogo)!==null&&l!==void 0?l:!0,this.closeOnBackdropClick=(d=e==null?void 0:e.closeOnBackdropClick)!==null&&d!==void 0?d:!0}}function*fr(s=document.activeElement){s!=null&&(yield s,"shadowRoot"in s&&s.shadowRoot&&s.shadowRoot.mode!=="closed"&&(yield*fr(s.shadowRoot.activeElement)))}function Tc(){return[...fr()].pop()}const Ma=new WeakMap;function An(s){let e=Ma.get(s);return e||(e=window.getComputedStyle(s,null),Ma.set(s,e)),e}function Mc(s){if("checkVisibility"in s&&typeof s.checkVisibility=="function")return s.checkVisibility({checkOpacity:!1,checkVisibilityCSS:!0});const e=An(s);return e.visibility!=="hidden"&&e.display!=="none"}function Ec(s){const e=An(s),{overflowY:t,overflowX:i}=e;return t==="scroll"||i==="scroll"?!0:t!=="auto"||i!=="auto"?!1:s.scrollHeight>s.clientHeight&&t==="auto"||s.scrollWidth>s.clientWidth&&i==="auto"}function Ac(s){const e=s.tagName.toLowerCase(),t=Number(s.getAttribute("tabindex"));return s.hasAttribute("tabindex")&&(isNaN(t)||t<=-1)||s.hasAttribute("disabled")||s.closest("[inert]")||e==="input"&&s.getAttribute("type")==="radio"&&!s.hasAttribute("checked")||!Mc(s)?!1:(e==="audio"||e==="video")&&s.hasAttribute("controls")||s.hasAttribute("tabindex")||s.hasAttribute("contenteditable")&&s.getAttribute("contenteditable")!=="false"||["button","input","select","textarea","a","audio","video","summary","iframe"].includes(e)?!0:Ec(s)}function Dc(s,e){var t;return((t=s.getRootNode({composed:!0}))===null||t===void 0?void 0:t.host)!==e}function Ea(s){const e=new WeakMap,t=[];function i(o){if(o instanceof Element){if(o.hasAttribute("inert")||o.closest("[inert]")||e.has(o))return;e.set(o,!0),!t.includes(o)&&Ac(o)&&t.push(o),o instanceof HTMLSlotElement&&Dc(o,s)&&o.assignedElements({flatten:!0}).forEach(r=>{i(r)}),o.shadowRoot!==null&&o.shadowRoot.mode==="open"&&i(o.shadowRoot)}for(const r of Array.from(o.children))i(r)}return i(s),t.sort((o,r)=>{const a=Number(o.getAttribute("tabindex"))||0;return(Number(r.getAttribute("tabindex"))||0)-a})}let Ei=[];class Lc{constructor(e){this.isExternalActivated=!1,this.tabDirection="forward",this.currentFocus=null,this.previousFocus=null,this.handleFocusIn=()=>{this.isActive()&&this.checkFocus()},this.handleKeyDown=t=>{var i;if(t.key!=="Tab"||this.isExternalActivated||!this.isActive())return;const o=Tc();if(this.previousFocus=o,this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus))return;t.shiftKey?this.tabDirection="backward":this.tabDirection="forward";const r=Ea(this.element);let a=r.findIndex(d=>d===o);this.previousFocus=this.currentFocus;const l=this.tabDirection==="forward"?1:-1;for(;;){a+l>=r.length?a=0:a+l<0?a=r.length-1:a+=l,this.previousFocus=this.currentFocus;const d=r[a];if(this.tabDirection==="backward"&&this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus)||d&&this.possiblyHasTabbableChildren(d))return;t.preventDefault(),this.currentFocus=d,(i=this.currentFocus)===null||i===void 0||i.focus({preventScroll:!1});const p=[...fr()];if(p.includes(this.currentFocus)||!p.includes(this.previousFocus))break}setTimeout(()=>this.checkFocus())},this.handleKeyUp=()=>{this.tabDirection="forward"},this.element=e,this.elementsWithTabbableControls=["iframe"]}activate(){Ei.push(this.element),document.addEventListener("focusin",this.handleFocusIn),document.addEventListener("keydown",this.handleKeyDown),document.addEventListener("keyup",this.handleKeyUp)}deactivate(){Ei=Ei.filter(e=>e!==this.element),this.currentFocus=null,document.removeEventListener("focusin",this.handleFocusIn),document.removeEventListener("keydown",this.handleKeyDown),document.removeEventListener("keyup",this.handleKeyUp)}isActive(){return Ei[Ei.length-1]===this.element}activateExternal(){this.isExternalActivated=!0}deactivateExternal(){this.isExternalActivated=!1}checkFocus(){if(this.isActive()&&!this.isExternalActivated){const e=Ea(this.element);if(!this.element.matches(":focus-within")){const t=e[0],i=e[e.length-1],o=this.tabDirection==="forward"?t:i;typeof(o==null?void 0:o.focus)=="function"&&(this.currentFocus=o,o.focus({preventScroll:!1}))}}}possiblyHasTabbableChildren(e){return this.elementsWithTabbableControls.includes(e.tagName.toLowerCase())||e.hasAttribute("controls")}}var Aa;(function(s){s.processing="processing",s.complete="complete"})(Aa||(Aa={}));let qs=class extends I{constructor(){super(...arguments),this.mode="processing"}render(){return u`
      <div class="${this.mode}">
        <svg
          viewBox="0 0 120 120"
    ...
    `}};n([c({type:String})],qs.prototype,"mode",void 0);qs=n([B("ia-activity-indicator")],qs);const zc=u`
<svg
  viewBox="0 0 40 40"
  version="1.1"
  xmlns="http://www.w3.org/2000/svg"
...
`;class Fc extends I{static get styles(){return g`
      :host {
    ...
    `}render(){return zc}}customElements.define("ia-icon-close",Fc);const Pc=u`
  <svg
    class="ia-logo"
    viewBox="0 0 27 30"
    xmlns="http://www.w3.org/2000/svg"
...
`;let Ys=class extends I{constructor(){super(...arguments),this.config=new Lt}render(){return u`
      <div class="modal-wrapper">
        <div class="modal-container">
          <header style="background-color: ${this.config.headerColor}">
            ${this.config.showCloseButton?this.closeButtonTemplate:""}
            ${this.config.showHeaderLogo?u`<div class="logo-icon">${Pc}</div>`:b}
    ...
    `}static get styles(){const e=g`var(--modalLogoSize, 6.5rem)`,t=g`var(--processingImageSize, 7.5rem)`,i=g`var(--modalCornerRadius, 1rem)`,o=g`var(--modalBorder, 2px solid black)`,r=g`var(--modalBottomMargin, 2.5rem)`,a=g`var(--modalTopMargin, 5rem)`,l=g`var(--modalHeaderBottomPadding, 0.5em)`,d=g`var(--modalBottomPadding, 2rem)`,p=g`var(--modalScrollOffset, 5px)`,h=g`var(--modalTitleFontSize, 1.8rem)`,f=g`var(--modalSubtitleFontSize, 1.4rem)`,v=g`var(--modalHeadlineFontSize, 1.6rem)`,y=g`var(--modalMessageFontSize, 1.4rem)`,x=g`var(--modalTitleLineHeight, normal)`,S=g`var(--modalSubtitleLineHeight, normal)`,k=g`var(--modalHeadlineLineHeight, normal)`,D=g`var(--modalMessageLineHeight, normal)`;return g`
      .processing-logo {
        margin: auto;
        width: ${t};
        height: ${t};
    ...
    `}};n([c({type:Object})],Ys.prototype,"config",void 0);Ys=n([B("modal-template")],Ys);function Bc(s,e,t){var i=t||{},o=i.noTrailing,r=o===void 0?!1:o,a=i.noLeading,l=a===void 0?!1:a,d=i.debounceMode,p=d===void 0?void 0:d,h,f=!1,v=0;function y(){h&&clearTimeout(h)}function x(k){var D=k||{},E=D.upcomingOnly,A=E===void 0?!1:E;y(),f=!A}function S(){for(var k=arguments.length,D=new Array(k),E=0;E<k;E++)D[E]=arguments[E];var A=this,R=Date.now()-v;if(f)return;function V(){v=Date.now(),e.apply(A,D)}function re(){h=void 0}!l&&p&&!h&&V(),y(),p===void 0&&R>s?l?(v=Date.now(),r||(h=setTimeout(p?re:V,s))):V():r!==!0&&(h=setTimeout(p?re:V,p===void 0?s-R:s))}return S.cancel=x,S}var zt;(function(s){s.Open="open",s.Closed="closed"})(zt||(zt={}));class Rc{constructor(e){this.windowResizeThrottler=Bc(100,this.updateModalContainerHeight,{noLeading:!1,noTrailing:!1}).bind(this),this.modalManager=e}handleModeChange(e){switch(e){case zt.Open:this.startResizeListener(),this.stopDocumentScroll();break;case zt.Closed:this.stopResizeListener(),this.resumeDocumentScroll();break}}updateModalContainerHeight(){this.modalManager.style.setProperty("--containerHeight",`${window.innerHeight}px`)}stopDocumentScroll(){document.body.classList.add("modal-manager-open")}resumeDocumentScroll(){document.body.classList.remove("modal-manager-open")}startResizeListener(){window.addEventListener("resize",this.windowResizeThrottler)}stopResizeListener(){window.removeEventListener("resize",this.windowResizeThrottler)}}let ni=class extends I{constructor(){super(...arguments),this.mode=zt.Closed,this.hostBridge=new Rc(this),this.modal=new Lc(this),this.closeOnBackdropClick=!0}firstUpdated(){return Rr(this,void 0,void 0,function*(){yield new Promise(e=>setTimeout(e,0)),this.closeOnBackdropClick&&this.addEventListener("keydown",e=>{e.key==="Escape"&&this.backdropClicked()})})}disconnectedCallback(){super.disconnectedCallback(),this.modal.deactivate()}render(){return u`
      <div class="container">
    ...
    `}getMode(){return this.mode}closeModal(){this.mode=zt.Closed,this.customModalContent=void 0,this.modalTemplate.config=new Lt,this.modal.deactivate()}callUserClosedModalCallback(){const e=this.userClosedModalCallback;this.userClosedModalCallback=void 0,e&&e()}showModal(e){return Rr(this,void 0,void 0,function*(){this.closeOnBackdropClick=e.config.closeOnBackdropClick,this.userClosedModalCallback=e.userClosedModalCallback,this.modalTemplate.config=e.config,this.customModalContent=e.customModalContent,this.mode=zt.Open,yield this.modalTemplate.updateComplete,this.modalTemplate.focus(),this.modal.activate()})}updated(e){e.has("mode")&&this.handleModeChange()}backdropClicked(){this.closeOnBackdropClick&&(this.closeModal(),this.callUserClosedModalCallback())}handleModeChange(){this.hostBridge.handleModeChange(this.mode),this.emitModeChangeEvent()}emitModeChangeEvent(){const e=new CustomEvent("modeChanged",{detail:{mode:this.mode}});this.dispatchEvent(e)}closeButtonPressed(){this.closeModal(),this.callUserClosedModalCallback()}static get styles(){const e=g`var(--modalBackdropColor, rgba(10, 10, 10, 0.9))`,t=g`var(--modalBackdropZindex, 1000)`,i=g`var(--modalWidth, 32rem)`,o=g`var(--modalMaxWidth, 95%)`,r=g`var(--modalZindex, 2000)`;return g`
      .container {
        width: 100%;
        height: 100%;
      }
    ...
    `}};n([c({type:String,reflect:!0})],ni.prototype,"mode",void 0);n([c({type:Object})],ni.prototype,"customModalContent",void 0);n([c({type:Object})],ni.prototype,"hostBridge",void 0);n([G("modal-template")],ni.prototype,"modalTemplate",void 0);ni=n([B("modal-manager")],ni);const Da=g`var(--white, #fff)`,Ic=g`var(--primaryDisableCTAFill, #767676)`,Oc=g`var(--secondaryCTABorder, #999)`,Nc=g`var(--primaryCTAFill, #194880)`,ps=g`var(--primaryCTAFillRGB, 25, 72, 128)`,Uc=g`var(--primaryCTABorder, #c5d1df)`,Hc=g`var(--primaryErrorCTAFill, #d9534f)`,us=g`var(--primaryErrorCTAFillRGB, 229, 28, 38)`,Vc=g`var(--primaryErrorCTABorder, #d43f3a)`,Wc=g`var(--secondaryCTAFill, #333)`,fs=g`var(--secondaryCTAFillRGB, 51, 51, 51)`,jc=g`var(--primaryCTABorder, #979797)`,Gc=g`var(---primaryWarningFill, #ee8950)`,ms=g`var(--primaryWarningFillRGB, 238, 137, 80)`,qc=g`var(--primaryWarningBorder, #ec7939)`,Yc=g`
  .ia-button {
    min-height: 3rem;
    cursor: pointer;
    color: ${Da};
  ...
  .ia-button.primary:hover {
    background-color: rgba(${ps}, 0.9);
  }
  .ia-button.primary:focus-visible {
    background-color: rgba(${ps}, 0.8);
  }
  .ia-button.primary:active {
    background-color: rgba(${ps}, 0.7);
  }
  ...
  .ia-button.danger:hover {
    background-color: rgba(${us}, 0.9);
  }
  .ia-button.danger:focus-visible {
    background-color: rgba(${us}, 0.8);
  }
  .ia-button.danger:active {
    background-color: rgba(${us}, 0.7);
  }
...
`;let To=class extends I{constructor(){super(...arguments),this.items=[]}render(){return u`
      <ul>
        ${Dt(this.items,({title:e,date:t})=>u`
            <li>
    ...
    `}};n([c({type:Object})],To.prototype,"items",void 0);n([c({type:String})],To.prototype,"message",void 0);To=n([B("remove-items-modal-content")],To);let et=class extends I{constructor(){super(...arguments),this.label=C("Select items to remove"),this.selectedItems=[],this.showSelectAll=!1,this.showUnselectAll=!1,this.showItemManageButton=!1,this.removeAllowed=!1}render(){return u`
      <div class="manage-container">
        ...
        <div class="manage-buttons">
          ...
          ${hs(this.showItemManageButton,()=>u` <button
          ...
          <div class="selection-buttons">
            ${hs(this.showSelectAll,()=>u` <button
                  class="ia-button link select-all-btn"
                  @click=${this.selectAllClicked}
                >
                  ${C("Select all")}
                </button>`)}
            ${hs(this.showUnselectAll,()=>u` <button
    ...
    `}};n([c({type:String})],et.prototype,"label",void 0);n([c({type:Object})],et.prototype,"modalManager",void 0);n([c({type:Object})],et.prototype,"selectedItems",void 0);n([c({type:String})],et.prototype,"manageViewModalMsg",void 0);n([c({type:Boolean})],et.prototype,"showSelectAll",void 0);n([c({type:Boolean})],et.prototype,"showUnselectAll",void 0);n([c({type:Boolean})],et.prototype,"showItemManageButton",void 0);n([c({type:Boolean})],et.prototype,"removeAllowed",void 0);et=n([B("manage-bar")],et);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ri=(s,e)=>{var t,i;const o=s._$AN;if(o===void 0)return!1;for(const r of o)(i=(t=r)._$AO)===null||i===void 0||i.call(t,e,!1),Ri(r,e);return!0},Mo=s=>{let e,t;do{if((e=s._$AM)===void 0)break;t=e._$AN,t.delete(s),s=e}while((t==null?void 0:t.size)===0)},Dn=s=>{for(let e;e=s._$AM;s=e){let t=e._$AN;if(t===void 0)e._$AN=t=new Set;else if(t.has(s))break;t.add(s),Xc(e)}};function Qc(s){this._$AN!==void 0?(Mo(this),this._$AM=s,Dn(this)):this._$AM=s}function Kc(s,e=!1,t=0){const i=this._$AH,o=this._$AN;if(o!==void 0&&o.size!==0)if(e)if(Array.isArray(i))for(let r=t;r<i.length;r++)Ri(i[r],!1),Mo(i[r]);else i!=null&&(Ri(i,!1),Mo(i));else Ri(this,s)}const Xc=s=>{var e,t,i,o;s.type==Ue.CHILD&&((e=(i=s)._$AP)!==null&&e!==void 0||(i._$AP=Kc),(t=(o=s)._$AQ)!==null&&t!==void 0||(o._$AQ=Qc))};class Zc extends mi{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,i){super._$AT(e,t,i),Dn(this),this.isConnected=e._$AU}_$AO(e,t=!0){var i,o;e!==this.isConnected&&(this.isConnected=e,e?(i=this.reconnected)===null||i===void 0||i.call(this):(o=this.disconnected)===null||o===void 0||o.call(this)),t&&(Ri(this,e),Mo(this))}setValue(e){if(dn(this._$Ct))this._$Ct._$AI(e,this);else{const t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}}const vs=new WeakMap,Jc=fi(class extends Zc{render(s){return J}update(s,[e]){var t;const i=e!==this.G;return i&&this.G!==void 0&&this.ot(void 0),(i||this.rt!==this.lt)&&(this.G=e,this.dt=(t=s.options)===null||t===void 0?void 0:t.host,this.ot(this.lt=s.element)),J}ot(s){var e;if(typeof this.G=="function"){const t=(e=this.dt)!==null&&e!==void 0?e:globalThis;let i=vs.get(t);i===void 0&&(i=new WeakMap,vs.set(t,i)),i.get(this.G)!==void 0&&this.G.call(this.dt,void 0),i.set(this.G,s),s!==void 0&&this.G.call(this.dt,s)}else this.G.value=s}get rt(){var s,e,t;return typeof this.G=="function"?(e=vs.get((s=this.dt)!==null&&s!==void 0?s:globalThis))===null||e===void 0?void 0:e.get(this.G):(t=this.G)===null||t===void 0?void 0:t.value}disconnected(){this.rt===this.lt&&this.ot(void 0)}reconnected(){this.ot(this.lt)}});var Ln=60,zn=Ln*60,Fn=zn*24,e0=Fn*7,li=1e3,gs=Ln*li,La=zn*li,t0=Fn*li,i0=e0*li,mr="millisecond",Kt="second",Xt="minute",Zt="hour",pt="day",uo="week",Ne="month",Pn="quarter",ut="year",Jt="date",o0="YYYY-MM-DDTHH:mm:ssZ",za="Invalid Date",s0=/^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/,r0=/\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g;const a0={name:"en",weekdays:"Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),months:"January_February_March_April_May_June_July_August_September_October_November_December".split("_"),ordinal:function(e){var t=["th","st","nd","rd"],i=e%100;return"["+e+(t[(i-20)%10]||t[i]||t[0])+"]"}};var Qs=function(e,t,i){var o=String(e);return!o||o.length>=t?e:""+Array(t+1-o.length).join(i)+e},n0=function(e){var t=-e.utcOffset(),i=Math.abs(t),o=Math.floor(i/60),r=i%60;return(t<=0?"+":"-")+Qs(o,2,"0")+":"+Qs(r,2,"0")},l0=function s(e,t){if(e.date()<t.date())return-s(t,e);var i=(t.year()-e.year())*12+(t.month()-e.month()),o=e.clone().add(i,Ne),r=t-o<0,a=e.clone().add(i+(r?-1:1),Ne);return+(-(i+(t-o)/(r?o-a:a-o))||0)},d0=function(e){return e<0?Math.ceil(e)||0:Math.floor(e)},c0=function(e){var t={M:Ne,y:ut,w:uo,d:pt,D:Jt,h:Zt,m:Xt,s:Kt,ms:mr,Q:Pn};return t[e]||String(e||"").toLowerCase().replace(/s$/,"")},h0=function(e){return e===void 0};const p0={s:Qs,z:n0,m:l0,a:d0,p:c0,u:h0};var Ii="en",Ft={};Ft[Ii]=a0;var Bn="$isDayjsObject",vr=function(e){return e instanceof Ro||!!(e&&e[Bn])},Eo=function s(e,t,i){var o;if(!e)return Ii;if(typeof e=="string"){var r=e.toLowerCase();Ft[r]&&(o=r),t&&(Ft[r]=t,o=r);var a=e.split("-");if(!o&&a.length>1)return s(a[0])}else{var l=e.name;Ft[l]=e,o=l}return!i&&o&&(Ii=o),o||!i&&Ii},te=function(e,t){if(vr(e))return e.clone();var i=typeof t=="object"?t:{};return i.date=e,i.args=arguments,new Ro(i)},u0=function(e,t){return te(e,{locale:t.$L,utc:t.$u,x:t.$x,$offset:t.$offset})},q=p0;q.l=Eo;q.i=vr;q.w=u0;var f0=function(e){var t=e.date,i=e.utc;if(t===null)return new Date(NaN);if(q.u(t))return new Date;if(t instanceof Date)return new Date(t);if(typeof t=="string"&&!/Z$/i.test(t)){var o=t.match(s0);if(o){var r=o[2]-1||0,a=(o[7]||"0").substring(0,3);return i?new Date(Date.UTC(o[1],r,o[3]||1,o[4]||0,o[5]||0,o[6]||0,a)):new Date(o[1],r,o[3]||1,o[4]||0,o[5]||0,o[6]||0,a)}}return new Date(t)},Ro=function(){function s(t){this.$L=Eo(t.locale,null,!0),this.parse(t),this.$x=this.$x||t.x||{},this[Bn]=!0}var e=s.prototype;return e.parse=function(i){this.$d=f0(i),this.init()},e.init=function(){var i=this.$d;this.$y=i.getFullYear(),this.$M=i.getMonth(),this.$D=i.getDate(),this.$W=i.getDay(),this.$H=i.getHours(),this.$m=i.getMinutes(),this.$s=i.getSeconds(),this.$ms=i.getMilliseconds()},e.$utils=function(){return q},e.isValid=function(){return this.$d.toString()!==za},e.isSame=function(i,o){var r=te(i);return this.startOf(o)<=r&&r<=this.endOf(o)},e.isAfter=function(i,o){return te(i)<this.startOf(o)},e.isBefore=function(i,o){return this.endOf(o)<te(i)},e.$g=function(i,o,r){return q.u(i)?this[o]:this.set(r,i)},e.unix=function(){return Math.floor(this.valueOf()/1e3)},e.valueOf=function(){return this.$d.getTime()},e.startOf=function(i,o){var r=this,a=q.u(o)?!0:o,l=q.p(i),d=function(D,E){var A=q.w(r.$u?Date.UTC(r.$y,E,D):new Date(r.$y,E,D),r);return a?A:A.endOf(pt)},p=function(D,E){var A=[0,0,0,0],R=[23,59,59,999];return q.w(r.toDate()[D].apply(r.toDate("s"),(a?A:R).slice(E)),r)},h=this.$W,f=this.$M,v=this.$D,y="set"+(this.$u?"UTC":"");switch(l){case ut:return a?d(1,0):d(31,11);case Ne:return a?d(1,f):d(0,f+1);case uo:{var x=this.$locale().weekStart||0,S=(h<x?h+7:h)-x;return d(a?v-S:v+(6-S),f)}case pt:case Jt:return p(y+"Hours",0);case Zt:return p(y+"Minutes",1);case Xt:return p(y+"Seconds",2);case Kt:return p(y+"Milliseconds",3);default:return this.clone()}},e.endOf=function(i){return this.startOf(i,!1)},e.$set=function(i,o){var r,a=q.p(i),l="set"+(this.$u?"UTC":""),d=(r={},r[pt]=l+"Date",r[Jt]=l+"Date",r[Ne]=l+"Month",r[ut]=l+"FullYear",r[Zt]=l+"Hours",r[Xt]=l+"Minutes",r[Kt]=l+"Seconds",r[mr]=l+"Milliseconds",r)[a],p=a===pt?this.$D+(o-this.$W):o;if(a===Ne||a===ut){var h=this.clone().set(Jt,1);h.$d[d](p),h.init(),this.$d=h.set(Jt,Math.min(this.$D,h.daysInMonth())).$d}else d&&this.$d[d](p);return this.init(),this},e.set=function(i,o){return this.clone().$set(i,o)},e.get=function(i){return this[q.p(i)]()},e.add=function(i,o){var r=this,a;i=Number(i);var l=q.p(o),d=function(v){var y=te(r);return q.w(y.date(y.date()+Math.round(v*i)),r)};if(l===Ne)return this.set(Ne,this.$M+i);if(l===ut)return this.set(ut,this.$y+i);if(l===pt)return d(1);if(l===uo)return d(7);var p=(a={},a[Xt]=gs,a[Zt]=La,a[Kt]=li,a)[l]||1,h=this.$d.getTime()+i*p;return q.w(h,this)},e.subtract=function(i,o){return this.add(i*-1,o)},e.format=function(i){var o=this,r=this.$locale();if(!this.isValid())return r.invalidDate||za;var a=i||o0,l=q.z(this),d=this.$H,p=this.$m,h=this.$M,f=r.weekdays,v=r.months,y=r.meridiem,x=function(A,R,V,re){return A&&(A[R]||A(o,a))||V[R].slice(0,re)},S=function(A){return q.s(d%12||12,A,"0")},k=y||function(E,A,R){var V=E<12?"AM":"PM";return R?V.toLowerCase():V},D=function(A){switch(A){case"YY":return String(o.$y).slice(-2);case"YYYY":return q.s(o.$y,4,"0");case"M":return h+1;case"MM":return q.s(h+1,2,"0");case"MMM":return x(r.monthsShort,h,v,3);case"MMMM":return x(v,h);case"D":return o.$D;case"DD":return q.s(o.$D,2,"0");case"d":return String(o.$W);case"dd":return x(r.weekdaysMin,o.$W,f,2);case"ddd":return x(r.weekdaysShort,o.$W,f,3);case"dddd":return f[o.$W];case"H":return String(d);case"HH":return q.s(d,2,"0");case"h":return S(1);case"hh":return S(2);case"a":return k(d,p,!0);case"A":return k(d,p,!1);case"m":return String(p);case"mm":return q.s(p,2,"0");case"s":return String(o.$s);case"ss":return q.s(o.$s,2,"0");case"SSS":return q.s(o.$ms,3,"0");case"Z":return l}return null};return a.replace(r0,function(E,A){return A||D(E)||l.replace(":","")})},e.utcOffset=function(){return-Math.round(this.$d.getTimezoneOffset()/15)*15},e.diff=function(i,o,r){var a=this,l=q.p(o),d=te(i),p=(d.utcOffset()-this.utcOffset())*gs,h=this-d,f=function(){return q.m(a,d)},v;switch(l){case ut:v=f()/12;break;case Ne:v=f();break;case Pn:v=f()/3;break;case uo:v=(h-p)/i0;break;case pt:v=(h-p)/t0;break;case Zt:v=h/La;break;case Xt:v=h/gs;break;case Kt:v=h/li;break;default:v=h;break}return r?v:q.a(v)},e.daysInMonth=function(){return this.endOf(Ne).$D},e.$locale=function(){return Ft[this.$L]},e.locale=function(i,o){if(!i)return this.$L;var r=this.clone(),a=Eo(i,o,!0);return a&&(r.$L=a),r},e.clone=function(){return q.w(this.$d,this)},e.toDate=function(){return new Date(this.valueOf())},e.toJSON=function(){return this.isValid()?this.toISOString():null},e.toISOString=function(){return this.$d.toISOString()},e.toString=function(){return this.$d.toUTCString()},s}(),Rn=Ro.prototype;te.prototype=Rn;[["$ms",mr],["$s",Kt],["$m",Xt],["$H",Zt],["$W",pt],["$M",Ne],["$y",ut],["$D",Jt]].forEach(function(s){Rn[s[1]]=function(e){return this.$g(e,s[0],s[1])}});te.extend=function(s,e){return s.$i||(s(e,Ro,te),s.$i=!0),te};te.locale=Eo;te.isDayjs=vr;te.unix=function(s){return te(s*1e3)};te.en=Ft[Ii];te.Ls=Ft;te.p={};var m0=function(e){return e.replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g,function(t,i,o){return i||o.slice(1)})},v0={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"},g0=function(e,t){return e.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g,function(i,o,r){var a=r&&r.toUpperCase();return o||t[r]||v0[r]||m0(t[a])})},b0=/(\[[^[]*\])|([-_:/.,()\s]+)|(A|a|Q|YYYY|YY?|ww?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g,Fa=/\d/,Ai=/\d\d/,y0=/\d{3}/,w0=/\d{4}/,Be=/\d\d?/,S0=/[+-]?\d+/,x0=/[+-]\d\d:?(\d\d)?|Z/,Di=/\d*[^-_:/,()\s\d]+/,vt={},In=function(e){return e=+e,e+(e>68?1900:2e3)};function _0(s){if(!s||s==="Z")return 0;var e=s.match(/([+-]|\d\d)/g),t=+(e[1]*60)+(+e[2]||0);return t===0?0:e[0]==="+"?-t:t}var be=function(e){return function(t){this[e]=+t}},Pa=[x0,function(s){var e=this.zone||(this.zone={});e.offset=_0(s)}],bs=function(e){var t=vt[e];return t&&(t.indexOf?t:t.s.concat(t.f))},Ba=function(e,t){var i,o=vt,r=o.meridiem;if(!r)i=e===(t?"pm":"PM");else for(var a=1;a<=24;a+=1)if(e.indexOf(r(a,0,t))>-1){i=a>12;break}return i},$0={A:[Di,function(s){this.afternoon=Ba(s,!1)}],a:[Di,function(s){this.afternoon=Ba(s,!0)}],Q:[Fa,function(s){this.month=(s-1)*3+1}],S:[Fa,function(s){this.milliseconds=+s*100}],SS:[Ai,function(s){this.milliseconds=+s*10}],SSS:[y0,function(s){this.milliseconds=+s}],s:[Be,be("seconds")],ss:[Be,be("seconds")],m:[Be,be("minutes")],mm:[Be,be("minutes")],H:[Be,be("hours")],h:[Be,be("hours")],HH:[Be,be("hours")],hh:[Be,be("hours")],D:[Be,be("day")],DD:[Ai,be("day")],Do:[Di,function(s){var e=vt,t=e.ordinal,i=s.match(/\d+/);if(this.day=i[0],!!t)for(var o=1;o<=31;o+=1)t(o).replace(/\[|\]/g,"")===s&&(this.day=o)}],w:[Be,be("week")],ww:[Ai,be("week")],M:[Be,be("month")],MM:[Ai,be("month")],MMM:[Di,function(s){var e=bs("months"),t=bs("monthsShort"),i=(t||e.map(function(o){return o.slice(0,3)})).indexOf(s)+1;if(i<1)throw new Error;this.month=i%12||i}],MMMM:[Di,function(s){var e=bs("months"),t=e.indexOf(s)+1;if(t<1)throw new Error;this.month=t%12||t}],Y:[S0,be("year")],YY:[Ai,function(s){this.year=In(s)}],YYYY:[w0,be("year")],Z:Pa,ZZ:Pa};function C0(s){var e=s.afternoon;if(e!==void 0){var t=s.hours;e?t<12&&(s.hours+=12):t===12&&(s.hours=0),delete s.afternoon}}function k0(s){s=g0(s,vt&&vt.formats);for(var e=s.match(b0),t=e.length,i=0;i<t;i+=1){var o=e[i],r=$0[o],a=r&&r[0],l=r&&r[1];l?e[i]={regex:a,parser:l}:e[i]=o.replace(/^\[|\]$/g,"")}return function(d){for(var p={},h=0,f=0;h<t;h+=1){var v=e[h];if(typeof v=="string")f+=v.length;else{var y=v.regex,x=v.parser,S=d.slice(f),k=y.exec(S),D=k[0];x.call(p,D),d=d.replace(D,"")}}return C0(p),p}}var T0=function(e,t,i,o){try{if(["x","X"].indexOf(t)>-1)return new Date((t==="X"?1e3:1)*e);var r=k0(t),a=r(e),l=a.year,d=a.month,p=a.day,h=a.hours,f=a.minutes,v=a.seconds,y=a.milliseconds,x=a.zone,S=a.week,k=new Date,D=p||(!l&&!d?k.getDate():1),E=l||k.getFullYear(),A=0;l&&!d||(A=d>0?d-1:k.getMonth());var R=h||0,V=f||0,re=v||0,De=y||0;if(x)return new Date(Date.UTC(E,A,D,R,V,re,De+x.offset*60*1e3));if(i)return new Date(Date.UTC(E,A,D,R,V,re,De));var ve;return ve=new Date(E,A,D,R,V,re,De),S&&(ve=o(ve).week(S).toDate()),ve}catch{return new Date("")}};const M0=function(s,e,t){t.p.customParseFormat=!0,s&&s.parseTwoDigitYear&&(In=s.parseTwoDigitYear);var i=e.prototype,o=i.parse;i.parse=function(r){var a=r.date,l=r.utc,d=r.args;this.$u=l;var p=d[1];if(typeof p=="string"){var h=d[2]===!0,f=d[3]===!0,v=h||f,y=d[2];f&&(y=d[2]),vt=this.$locale(),!h&&y&&(vt=t.Ls[y]),this.$d=T0(a,p,l,t),this.init(),y&&y!==!0&&(this.$L=this.locale(y).$L),v&&a!=this.format(p)&&(this.$d=new Date("")),vt={}}else if(p instanceof Array)for(var x=p.length,S=1;S<=x;S+=1){d[1]=p[S-1];var k=t.apply(this,d);if(k.isValid()){this.$d=k.$d,this.$L=k.$L,this.init();break}S===x&&(this.$d=new Date(""))}else o.call(this,r)}};function E0(s,e){const t=e.prototype,i=t.parse;t.parse=function(o){const r=o.date,a=o.args[1];i.call(this,o);const l=this.year(),d=l>=1900&&l<2e3,p=typeof a=="string"&&a.includes("YYYY"),h=Array.isArray(a)&&typeof a[0]=="string"&&a[0].includes("YYYY"),f=p||h,v=typeof r=="string"&&!r.includes(`${l}`);d&&f&&v&&(this.$d.setFullYear(l-1900),this.init())}}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ra=fi(class extends mi{constructor(s){if(super(s),s.type!==Ue.PROPERTY&&s.type!==Ue.ATTRIBUTE&&s.type!==Ue.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!dn(s))throw Error("`live` bindings can only contain a single expression")}render(s){return s}update(s,[e]){if(e===Me||e===J)return e;const t=s.element,i=s.name;if(s.type===Ue.PROPERTY){if(e===t[i])return Me}else if(s.type===Ue.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(i))return Me}else if(s.type===Ue.ATTRIBUTE&&t.getAttribute(i)===e+"")return Me;return cn(s),e}});/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const On="important",A0=" !"+On,D0=fi(class extends mi{constructor(s){var e;if(super(s),s.type!==Ue.ATTRIBUTE||s.name!=="style"||((e=s.strings)===null||e===void 0?void 0:e.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(s){return Object.keys(s).reduce((e,t)=>{const i=s[t];return i==null?e:e+`${t=t.includes("-")?t:t.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${i};`},"")}update(s,[e]){const{style:t}=s.element;if(this.ht===void 0){this.ht=new Set;for(const i in e)this.ht.add(i);return this.render(e)}this.ht.forEach(i=>{e[i]==null&&(this.ht.delete(i),i.includes("-")?t.removeProperty(i):t[i]="")});for(const i in e){const o=e[i];if(o!=null){this.ht.add(i);const r=typeof o=="string"&&o.endsWith(A0);i.includes("-")||r?t.setProperty(i,r?o.slice(0,-11):o,r?On:""):t[i]=o}}return Me}});te.extend(M0);te.extend(E0);const L0=180,z0=40,F0=10,P0=125,B0=30,Ia="YYYY",R0="no data",I0=0,O0="item",Oa=4,N0={linear:s=>s,logarithmic:s=>Math.log1p(s)},U0=g`var(--histogramDateRangeSliderColor, #4B65FE)`,H0=g`var(--histogramDateRangeSelectedRangeColor, #DBE0FF)`,V0=g`var(--histogramDateRangeBarIncludedFill, #2C2C2C)`,W0=g`var(--histogramDateRangeActivityIndicator, #2C2C2C)`,j0=g`var(--histogramDateRangeBarExcludedFill, #CCCCCC)`,G0=g`var(--histogramDateRangeInputRowMargin, 0)`,q0=g`var(--histogramDateRangeInputBorder, 0.5px solid #2C2C2C)`,Y0=g`var(--histogramDateRangeInputWidth, 35px)`,Q0=g`var(--histogramDateRangeInputFontSize, 1.2rem)`,K0=g`var(--histogramDateRangeInputFontFamily, sans-serif)`,Na=g`var(--histogramDateRangeTooltipBackgroundColor, #2C2C2C)`,Ua=g`var(--histogramDateRangeTooltipTextColor, #FFFFFF)`,X0=g`var(--histogramDateRangeTooltipFontSize, 1.1rem)`,Z0=g`var(--histogramDateRangeTooltipFontFamily, sans-serif)`;let j=class extends I{constructor(){super(...arguments),this.width=L0,this.height=z0,this.sliderWidth=F0,this.tooltipWidth=P0,this.tooltipHeight=B0,this.updateDelay=I0,this.dateFormat=Ia,this.missingDataMessage=R0,this.minDate="",this.maxDate="",this.disabled=!1,this.bins=[],this.updateWhileFocused=!1,this.binSnapping="none",this.tooltipLabel=O0,this.barScaling="logarithmic",this._tooltipOffsetX=0,this._tooltipOffsetY=0,this._isDragging=!1,this._isLoading=!1,this._minSelectedDate="",this._maxSelectedDate="",this._minDateMS=0,this._maxDateMS=0,this._dragOffset=0,this._histWidth=0,this._binWidth=0,this._histData=[],this._previousDateRange="",this.drag=e=>{e.preventDefault(),!this.disabled&&(this.setDragOffset(e),this._isDragging=!0,this.addListeners(),this.cancelPendingUpdateEvent())},this.drop=()=>{this._isDragging&&(this.removeListeners(),this.beginEmitUpdateProcess()),this._isDragging=!1},this.move=e=>{const t=this.getBoundingClientRect().x,i=e.clientX-t-this._dragOffset;this._currentSlider.id==="slider-min"?this.minSelectedDate=this.translatePositionToDate(this.validMinSliderX(i)):(this.maxSelectedDate=this.translatePositionToDate(this.validMaxSliderX(i)),this.getMSFromString(this.maxSelectedDate)>this._maxDateMS&&(this.maxSelectedDate=this.maxDate))}}disconnectedCallback(){this.removeListeners(),super.disconnectedCallback()}willUpdate(e){(e.has("bins")||e.has("minDate")||e.has("maxDate")||e.has("minSelectedDate")||e.has("maxSelectedDate")||e.has("width")||e.has("height")||e.has("binSnapping")||e.has("barScaling"))&&this.handleDataUpdate()}handleDataUpdate(){this.hasBinData&&(this._histWidth=this.width-this.sliderWidth*2,this._minDateMS=this.snapTimestamp(this.getMSFromString(this.minDate)),this._maxDateMS=this.snapTimestamp(this.getMSFromString(this.maxDate)+this.snapInterval)+this.snapEndOffset,this._binWidth=this._histWidth/this._numBins,this._previousDateRange=this.currentDateRangeString,this._histData=this.calculateHistData(),this.minSelectedDate=this.minSelectedDate?this.minSelectedDate:this.minDate,this.maxSelectedDate=this.maxSelectedDate?this.maxSelectedDate:this.maxDate)}snapToNextSecond(e){return Math.ceil(e/1e3)*1e3}snapToMonth(e){const t=te(e),i=t.date()<16?0:1;return t.add(i,"month").date(1).hour(0).minute(0).second(0).millisecond(0).valueOf()}snapToYear(e){const t=te(e),i=t.month()<6?0:1;return t.add(i,"year").month(0).date(1).hour(0).minute(0).second(0).millisecond(0).valueOf()}snapTimestamp(e){switch(this.binSnapping){case"year":return this.snapToYear(e);case"month":return this.snapToMonth(e);case"none":default:return this.snapToNextSecond(e)}}get barScalingFunction(){return typeof this.barScaling=="string"?N0[this.barScaling]:this.barScaling}calculateHistData(){const{bins:e,height:t,dateRangeMS:i,_numBins:o,_minDateMS:r}=this,a=Math.min(...this.bins),l=Math.max(...this.bins),d=a===l?1:this.barScalingFunction(l),p=t/d,h=i/o;return e.map((f,v)=>{const y=this.snapTimestamp(v*h+r),x=this.formatDate(y),S=this.snapTimestamp((v+1)*h+r)+this.snapEndOffset,k=this.formatDate(S),D=this.formatDate(y,this.tooltipDateFormat),E=this.formatDate(S,this.tooltipDateFormat),A=D===E?D:`${D} - ${E}`;return{value:f,height:Math.floor(this.barScalingFunction(f)*p),binStart:x,binEnd:k,tooltip:A}})}get hasBinData(){return this._numBins>0}get _numBins(){return!this.bins||!this.bins.length?0:this.bins.length}get histogramLeftEdgeX(){return this.sliderWidth}get histogramRightEdgeX(){return this.width-this.sliderWidth}get snapInterval(){switch(this.binSnapping){case"year":return 31536e6;case"month":return 2592e6;case"none":default:return 0}}get snapEndOffset(){return this.binSnapping!=="none"&&this._numBins>1?-1:0}get tooltipDateFormat(){var e;return(e=this._tooltipDateFormat)!==null&&e!==void 0?e:this.dateFormat}set tooltipDateFormat(e){this._tooltipDateFormat=e}get loading(){return this._isLoading}set loading(e){this.disabled=e,this._isLoading=e}get minSelectedDate(){return this.formatDate(this.getMSFromString(this._minSelectedDate))}set minSelectedDate(e){if(!this._minSelectedDate){this._minSelectedDate=e;return}const t=this.getMSFromString(e),i=!Number.isNaN(t),o=t<=this.getMSFromString(this.maxSelectedDate);i&&o&&(this._minSelectedDate=this.formatDate(t)),this.requestUpdate()}get maxSelectedDate(){return this.formatDate(this.getMSFromString(this._maxSelectedDate))}set maxSelectedDate(e){if(!this._maxSelectedDate){this._maxSelectedDate=e;return}const t=this.getMSFromString(e),i=!Number.isNaN(t),o=t>=this.getMSFromString(this.minSelectedDate);i&&o&&(this._maxSelectedDate=this.formatDate(t)),this.requestUpdate()}get minSliderX(){const e=this.translateDateToPosition(this.minSelectedDate);return this.validMinSliderX(e)}get maxSliderX(){const e=this.snapTimestamp(this.getMSFromString(this.maxSelectedDate)+this.snapInterval),t=this.translateDateToPosition(this.formatDate(e));return this.validMaxSliderX(t)}get dateRangeMS(){return this._maxDateMS-this._minDateMS}showTooltip(e){var t,i;if(this._isDragging||this.disabled)return;const o=e.currentTarget,r=o.x.baseVal.value+this.sliderWidth/2,a=o.dataset,l=`${this.tooltipLabel}${a.numItems!=="1"?"s":""}`,d=Number(a.numItems).toLocaleString(),p=2,f=9+this.tooltipHeight,v=this.getBoundingClientRect(),y=v.x+r,x=v.y;this._tooltipOffsetX=y-p+(this._binWidth-this.sliderWidth-this.tooltipWidth)/2+window.scrollX,this._tooltipOffsetY=x-f+window.scrollY,this._tooltipContent=u`
      ${d} ${l}<br />
      ${a.tooltip}
    `,(i=(t=this._tooltip).showPopover)===null||i===void 0||i.call(t)}hideTooltip(){var e,t;this._tooltipContent=void 0,(t=(e=this._tooltip).hidePopover)===null||t===void 0||t.call(e)}validMinSliderX(e){const t=Math.min(this.translateDateToPosition(this.maxSelectedDate),this.histogramRightEdgeX);return e=this.clamp(e,this.histogramLeftEdgeX,t),Number.isNaN(e)||t<this.histogramLeftEdgeX?this.histogramLeftEdgeX:e}validMaxSliderX(e){const t=Math.max(this.histogramLeftEdgeX,this.translateDateToPosition(this.minSelectedDate));return e=this.clamp(e,t,this.histogramRightEdgeX),Number.isNaN(e)||t>this.histogramRightEdgeX?this.histogramRightEdgeX:e}addListeners(){window.addEventListener("pointermove",this.move),window.addEventListener("pointerup",this.drop),window.addEventListener("pointercancel",this.drop)}removeListeners(){window.removeEventListener("pointermove",this.move),window.removeEventListener("pointerup",this.drop),window.removeEventListener("pointercancel",this.drop)}beginEmitUpdateProcess(){this.cancelPendingUpdateEvent(),this._emitUpdatedEventTimer=setTimeout(()=>{if(this.currentDateRangeString===this._previousDateRange)return;this._previousDateRange=this.currentDateRangeString;const e={detail:{minDate:this.minSelectedDate,maxDate:this.maxSelectedDate},bubbles:!0,composed:!0};this.dispatchEvent(new CustomEvent("histogramDateRangeUpdated",e))},this.updateDelay)}cancelPendingUpdateEvent(){this._emitUpdatedEventTimer!==void 0&&(clearTimeout(this._emitUpdatedEventTimer),this._emitUpdatedEventTimer=void 0)}setDragOffset(e){this._currentSlider=e.currentTarget;const t=this._currentSlider.id==="slider-min"?this.minSliderX:this.maxSliderX,i=this.getBoundingClientRect().x;this._dragOffset=e.clientX-i-t}translatePositionToDate(e){const t=this.snapToNextSecond((e-this.sliderWidth)*this.dateRangeMS/this._histWidth);return this.formatDate(this._minDateMS+t)}translateDateToPosition(e){const t=this.getMSFromString(e);return this.sliderWidth+(t-this._minDateMS)*this._histWidth/this.dateRangeMS}clamp(e,t,i){return Math.min(Math.max(e,t),i)}handleInputFocus(){this.updateWhileFocused||this.cancelPendingUpdateEvent()}handleMinDateInput(e){const t=e.currentTarget;t.value!==this.minSelectedDate&&(this.minSelectedDate=t.value,this.beginEmitUpdateProcess())}handleMaxDateInput(e){const t=e.currentTarget;t.value!==this.maxSelectedDate&&(this.maxSelectedDate=t.value,this.beginEmitUpdateProcess())}handleKeyUp(e){if(e.key==="Enter"){const t=e.currentTarget;t.blur(),t.id==="date-min"?this.handleMinDateInput(e):t.id==="date-max"&&this.handleMaxDateInput(e)}}get currentDateRangeString(){return`${this.minSelectedDate}:${this.maxSelectedDate}`}getMSFromString(e){const t=typeof e=="string"?e:String(e);if((t.split(/(\d+)/).length-1)/2===1){const o=new Date(0,0);return o.setFullYear(Number(t)),o.getTime()}return te(t,[this.dateFormat,Ia]).valueOf()}handleBarClick(e){const t=e.currentTarget.dataset,i=(this.getMSFromString(t.binStart)+this.getMSFromString(t.binEnd))/2,o=Math.abs(i-this.getMSFromString(this.minSelectedDate)),r=Math.abs(i-this.getMSFromString(this.maxSelectedDate));o<r?this.minSelectedDate=t.binStart:this.maxSelectedDate=t.binEnd,this.beginEmitUpdateProcess()}get minSliderTemplate(){const e=Oa,t=`
            M${this.minSliderX},0
            ...
            q0,${e} ${e},${e}
            h${this.sliderWidth-e}
          `;return this.generateSliderSVG(this.minSliderX,"slider-min",t)}get maxSliderTemplate(){const e=Oa,t=`
            M${this.maxSliderX},0
            h${this.sliderWidth-e}
            q${e},0 ${e},${e}
            v${this.height-e*2}
            q0,${e} -${e},${e}
            h-${this.sliderWidth-e}
          `;return this.generateSliderSVG(this.maxSliderX,"slider-max",t)}generateSliderSVG(e,t,i){const o=t==="slider-min"?1:-1,r=at({slider:!0,draggable:!this.disabled,dragging:this._isDragging});return N`
    <svg
      id=${t}
      class=${r}
    ...
    `}get selectedRangeTemplate(){return N`
      <rect
        ...
        height="${this.height}"
        fill="${H0}"
      />`}get histogramTemplate(){const e=this._histWidth/this._numBins,t=e-1;let i=this.sliderWidth;return this._histData.map(o=>{const{minSelectedDate:r,maxSelectedDate:a}=this,l=o.height,d=this.isBefore(o.binEnd,r),p=this.isAfter(o.binStart,a),h=d||p?j0:V0,f=`stroke-dasharray: 0 ${t} ${l} ${t} 0 ${l}`,v=N`
        <rect
        ...
        <rect
          ...
          height=${l}
          fill=${h}
        />`;return i+=e,v})}isBefore(e,t){const i=this.getMSFromString(e),o=this.getMSFromString(t);return i<o}isAfter(e,t){const i=this.getMSFromString(e),o=this.getMSFromString(t);return i>o}formatDate(e,t=this.dateFormat){if(Number.isNaN(e))return"";const i=te(e);return i.year()<1e3?i.year(199999).format(t).replace(/199999/g,i.year().toString()):i.format(t)}get minInputTemplate(){return u`
      <input
        id="date-min"
    ...
    `}get maxInputTemplate(){return u`
      <input
        ...
        @keyup=${this.handleKeyUp}
        .value=${Ra(this.maxSelectedDate)}
        ?disabled=${this.disabled}
      />
    `}get minLabelTemplate(){return u`<label for="date-min" class="sr-only">Minimum date:</label>`}get maxLabelTemplate(){return u`<label for="date-max" class="sr-only">Maximum date:</label>`}get tooltipTemplate(){const e=D0({width:`${this.tooltipWidth}px`,height:`${this.tooltipHeight}px`,top:`${this._tooltipOffsetY}px`,left:`${this._tooltipOffsetX}px`});return u`
    ...
    `:this.noDataTemplate}};j.styles=g`
...
`;let oe=class extends I{constructor(){super(...arguments),this.prompt="Do you find this feature useful?",this.buttonText="Beta",this.displayMode="button",this.isOpen=!1,this.processing=!1,this.popupTopX=0,this.popupTopY=0,this.voteSubmitted=!1,this.voteNeedsChoosing=!1,this.resizingElement=document.body}render(){return u`
    ...
    `}get upvoteSelected(){return this.vote==="up"}get downvoteSelected(){return this.vote==="down"}upvoteKeypressed(e){(e.key==="Enter"||e.key===" ")&&this.upvoteButtonSelected()}downvoteKeypressed(e){(e.key==="Enter"||e.key===" ")&&this.downvoteButtonSelected()}upvoteButtonSelected(){this.processing||this.voteSubmitted||(this.vote=this.vote==="up"?void 0:"up",this.handleButtonSelection())}downvoteButtonSelected(){this.processing||this.voteSubmitted||(this.vote=this.vote==="down"?void 0:"down",this.handleButtonSelection())}async handleButtonSelection(){this.isOpen||(await this.setupRecaptcha(),this.submit())}get chooseVoteErrorClass(){return this.voteNeedsChoosing?"error":""}get upvoteButtonClass(){switch(this.vote){case"up":return"selected";case"down":return"unselected";default:return"noselection"}}get downvoteButtonClass(){switch(this.vote){case"up":return"unselected";case"down":return"selected";default:return"noselection"}}backgroundClicked(e){var t;e.target instanceof Node&&(!((t=this.popup)===null||t===void 0)&&t.contains(e.target)||this.cancel(e))}cancel(e){e.preventDefault(),this.closePopup(),this.voteSubmitted||this.resetState()}async submit(e){if(e==null||e.preventDefault(),!this.vote){this.voteNeedsChoosing=!0,this.error=u`Please select a vote.`;return}if(!this.featureIdentifier)throw new Error("featureIdentifier is required");if(!this.featureFeedbackService)throw new Error("featureFeedbackService is required");if(!this.recaptchaWidget)throw new Error("recaptchaWidget is required");const t=this.isOpen;this.processing=!0;try{const i=await this.recaptchaWidget.execute();(await this.featureFeedbackService.submitFeedback({featureIdentifier:this.featureIdentifier,vote:this.vote,comments:this.comments.value,recaptchaToken:i})).success?(this.voteSubmitted=!0,t&&this.closePopup()):this.error=u`There was an error submitting your feedback.`}catch(i){this.error=u`There was an error submitting your feedback.<br />Error:
        ${i instanceof Error?i.message:i}`}this.processing=!1}static get styles(){const e=g`var(--featureFeedbackBlueColor, #194880)`,t=g`var(--featureFeedbackDarkGrayColor, #767676)`,i=g`var(--defaultColorSvgFilter, invert(52%) sepia(0%) saturate(1%) hue-rotate(331deg) brightness(87%) contrast(89%))`,o=g`var(--featureFeedbackBackdropZindex, 5)`,r=g`var(--featureFeedbackModalZindex, 6)`,a=g`var(--featureFeedbackPopupBorderColor, ${e})`,l=g`var(--featureFeedbackSubmitButtonColor, ${e})`,d=g`var(--featureFeedbackBetaButtonBorderColor, ${e})`,p=g`var(--featureFeedbackBetaButtonTextColor, ${e})`,h=g`var(--featureFeedbackBetaButtonSvgFilter, ${i})`,f=g`var(--featureFeedbackCancelButtonColor, #515151)`,v=g`var(--featureFeedbackPopupBlockerColor, rgba(255, 255, 255, 0.3))`,y=g`var(--featureFeedbackPopupBackgroundColor, #F5F5F7)`,x=g`var(--featureFeedbackPromptFontWeight, bold)`,S=g`var(--featureFeedbackPromptFontSize, 1.4rem)`,k=g`var(--featureFeedbackCommentButtonFontWeight, normal)`,D=g`var(--featureFeedbackCommentButtonFontWeight, 1.4rem)`,E=g`var(--defaultColor, ${t});`,A=g`var(--defaultColorSvgFilter, ${i});`,R=g`var(--upvoteColor, #23765D);`,V=g`var(--upvoteColorSvgFilter, invert(34%) sepia(72%) saturate(357%) hue-rotate(111deg) brightness(97%) contrast(95%));`,re=g`var(--downvoteColor, #720D11);`,De=g`var(--downvoteColorSvgFilter, invert(5%) sepia(81%) saturate(5874%) hue-rotate(352deg) brightness(105%) contrast(95%));`,ve=g`var(--unselectedColor, #CCCCCC);`,ce=g`var(--unselectedColorSvgFilter, invert(100%) sepia(0%) saturate(107%) hue-rotate(138deg) brightness(89%) contrast(77%));`;return g`
      #container {
        display: inline-block;
      }
    ...
    `}};n([c({type:String})],oe.prototype,"featureIdentifier",void 0);n([c({type:String})],oe.prototype,"prompt",void 0);n([c({type:String})],oe.prototype,"buttonText",void 0);n([c({type:String})],oe.prototype,"displayMode",void 0);n([c({type:Object})],oe.prototype,"recaptchaManager",void 0);n([c({type:Object})],oe.prototype,"resizeObserver",void 0);n([c({type:Boolean})],oe.prototype,"disabled",void 0);n([c({type:Object})],oe.prototype,"featureFeedbackService",void 0);n([z()],oe.prototype,"isOpen",void 0);n([z()],oe.prototype,"processing",void 0);n([z()],oe.prototype,"popupTopX",void 0);n([z()],oe.prototype,"popupTopY",void 0);n([z()],oe.prototype,"vote",void 0);n([z()],oe.prototype,"voteSubmitted",void 0);n([z()],oe.prototype,"error",void 0);n([z()],oe.prototype,"voteNeedsChoosing",void 0);n([z()],oe.prototype,"recaptchaWidget",void 0);n([G("#container")],oe.prototype,"container",void 0);n([G("#popup")],oe.prototype,"popup",void 0);n([G("#comments")],oe.prototype,"comments",void 0);oe=n([B("feature-feedback")],oe);const J0=u`
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path
...
`;let $e=class extends I{constructor(){super(...arguments),this.binSnapping="none",this.barScaling="logarithmic",this.boundEscapeListener=e=>{e.key==="Escape"&&this.closeModal()}}render(){var e,t,i;return u`
      <div id="container">
        <histogram-date-range
          ...
          dateFormat=${ke(this.customDateFormat)}
          tooltipDateFormat=${ke(this.customTooltipDateFormat)}
          tooltipLabel=${ke(this.customTooltipLabel)}
    ...
    `}connectedCallback(){var e;(e=super.connectedCallback)===null||e===void 0||e.call(this),this.setupEscapeListener()}disconnectedCallback(){var e;(e=super.disconnectedCallback)===null||e===void 0||e.call(this),this.removeEscapeListener()}setupEscapeListener(){document.addEventListener("keydown",this.boundEscapeListener)}removeEscapeListener(){document.removeEventListener("keydown",this.boundEscapeListener)}histogramDateRangeUpdated(e){this.minSelectedDate=e.detail.minDate,this.maxSelectedDate=e.detail.maxDate}applyBtnClicked(){var e;const t=new CustomEvent("histogramDateRangeApplied",{detail:{minDate:this.minSelectedDate,maxDate:this.maxSelectedDate}});this.dispatchEvent(t),this.closeModal(),(e=this.analyticsHandler)===null||e===void 0||e.sendEvent({category:Je.default,action:ee.histogramChangedFromModal,label:window.location.href})}closeModal(){this.modalManager&&(this.modalManager.closeModal(),this.dispatchEvent(new CustomEvent("modalClosed")))}static get styles(){return g`
      #container {
        display: flex;
        justify-content: center;
    ...
    `}};n([c({type:String})],$e.prototype,"minDate",void 0);n([c({type:String})],$e.prototype,"maxDate",void 0);n([c({type:String})],$e.prototype,"minSelectedDate",void 0);n([c({type:String})],$e.prototype,"maxSelectedDate",void 0);n([c({type:Array})],$e.prototype,"buckets",void 0);n([c({type:String})],$e.prototype,"customDateFormat",void 0);n([c({type:String})],$e.prototype,"customTooltipDateFormat",void 0);n([c({type:String})],$e.prototype,"customTooltipLabel",void 0);n([c({type:String})],$e.prototype,"binSnapping",void 0);n([c({type:String})],$e.prototype,"barScaling",void 0);n([c({type:Object,attribute:!1})],$e.prototype,"modalManager",void 0);n([c({type:Object,attribute:!1})],$e.prototype,"analyticsHandler",void 0);$e=n([B("expanded-date-picker")],$e);const eh=N`
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path 
...
`;let di=class extends I{constructor(){super(...arguments),this.step=2,this.currentPage=1,this.pages=[]}firstUpdated(){this.observePageCount()}updated(e){e.has("size")&&this.observePageCount(),e.has("currentPage")&&(this.observePageCount(),this.emitPageClick())}observePageCount(){this.pages=[];const e=7,t=this.size<=e;if(this.size<=5){this.pages=[...Array(this.size).keys()].map(r=>r+1);return}if(this.size===e){if(this.currentPage===2){this.pages=[1,2,3,4,0,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,4,5,this.size-1,this.size];return}}if(this.currentPage===1){this.pages=[1,2,3,0,this.size];return}if(this.currentPage===this.size){this.pages=[1,0,this.size-2,this.size-1,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,this.size-3,this.size-2,this.size-1,this.size];return}if(t&&this.currentPage>1&&this.currentPage<e){this.pages=[...Array(this.size).keys()].map(r=>r+1);return}let i=this.currentPage-this.step,o=this.currentPage+this.step;i<=0&&(o+=-i+1,i=1),o>=this.size&&(i=Math.max(i-(o-this.size),1),o=this.size),i===2&&(o-=1),o===this.size-1&&(i+=1),this.createFirstNode(i),this.createMiddelNode(i,o),this.createLastNode(o)}createFirstNode(e){var t,i;e>1&&((t=this.pages)===null||t===void 0||t.push(1)),e>2&&((i=this.pages)===null||i===void 0||i.push(0))}createMiddelNode(e,t){var i;for(let o=e;o<=t;o+=1)(i=this.pages)===null||i===void 0||i.push(o)}createLastNode(e){var t,i;e<this.size-1&&((t=this.pages)===null||t===void 0||t.push(0)),e<this.size&&((i=this.pages)===null||i===void 0||i.push(this.size))}get getEllipsisTemplate(){return u`<i class="ellipses">...</i>`}emitPageClick(){this.dispatchEvent(new CustomEvent("pageNumberClicked",{detail:{page:this.currentPage},bubbles:!0,composed:!0}))}onRewind(){this.currentPage-=1,this.currentPage<1&&(this.currentPage=1)}onForward(){this.currentPage+=1,this.currentPage>this.size&&(this.currentPage=this.size)}onChange(e){this.currentPage=e}getPageTemplate(e){return u`
    ...
    `}static get styles(){return[tt,g`
      ...
      `]}};n([c({type:Number})],di.prototype,"size",void 0);n([c({type:Number})],di.prototype,"step",void 0);n([c({type:Number})],di.prototype,"currentPage",void 0);n([z()],di.prototype,"pages",void 0);di=n([B("more-facets-pagination")],di);const ih=N`
...
`;var Ks;let ji=Ks=class extends I{render(){return u`${this.facetRowTemplate}`}get facetRowTemplate(){var e,t,i,o;const{bucket:r,facetType:a}=this;if(!r||!a)return b;const l=`${a}:${r.key}-show-only`,d=`${a}:${r.key}-negative`,p=r.extraNote?u`<span class="facet-note">${r.extraNote}</span>`:b,h=a!=="collection"?u`${(e=r.displayText)!==null&&e!==void 0?e:r.key} ${p}`:u`<a href="/details/${r.key}">
            ${(i=(t=this.collectionTitles)===null||t===void 0?void 0:t.get(r.key))!==null&&i!==void 0?i:r.key}
          </a> `,f=r.state==="hidden",v=r.state==="selected",y=`${a}: ${(o=r.displayText)!==null&&o!==void 0?o:r.key}`,x=v?`Show all ${a}s`:`Only show ${y}`,S=`Hide ${y}`,k=`Unhide ${y}`,D=f?k:S,E=`${y}, ${r.count} results`;return u`
        ...
        <div class="facet-checkboxes">
          ...
          <div class="hide-facet-container">
            ...
            >
              ...
              <span class="eye eye-open">${ih}</span>
              <span class="eye eye-closed">${oh}</span>
            </label>
          </div>
        </div>
        <label
    ...
    `}facetClicked(e,t){const{bucket:i,facetType:o}=this;if(!i||!o)return;const r=e.target,{checked:a}=r;this.bucket={...i,state:Ks.getFacetState(a,t)},this.dispatchFacetClickEvent({facetType:o,bucket:this.bucket,negative:t})}dispatchFacetClickEvent(e){const t=new CustomEvent("facetClick",{detail:e});this.dispatchEvent(t)}static getFacetState(e,t){let i;return e?i=t?"hidden":"selected":i="none",i}static get styles(){const e=g`var(--facet-row-border-top, 1px solid transparent)`,t=g`var(--facet-row-border-bottom, 1px solid transparent)`,i=g`15px`,o=g`
      .facet-checkboxes {
        margin: 0 5px 0 0;
        display: flex;
        height: ${i};
    ...
    `;return[tt,o]}};n([c({type:String})],ji.prototype,"facetType",void 0);n([c({type:Object})],ji.prototype,"bucket",void 0);n([c({type:Object})],ji.prototype,"collectionTitles",void 0);ji=Ks=n([B("facet-row")],ji);let Ao=class extends I{facetClicked(e){this.dispatchFacetClickEvent(e.detail)}dispatchFacetClickEvent(e){const t=new CustomEvent("facetClick",{detail:e,composed:!0});this.dispatchEvent(t)}get facetsTemplate(){const{facetGroup:e}=this;if(!e)return b;const t=e.buckets;return u`
      <div class="facet-rows" data-testid="facets-on-${e.key}">
        ${nr(t,i=>`${e.key}:${i.key}`,i=>u`<facet-row
              .facetType=${e.key}
              .bucket=${i}
              .collectionTitles=${this.collectionTitles}
    ...
    `}render(){return u`${this.facetsTemplate}`}static get styles(){const e=g`var(--facetsColumnCount, 1)`,t=g`var(--facetsColumnGap, 15px)`;return g`
      .facet-rows {
        column-count: ${e};
        column-gap: ${t};
      }
    ...
    `}};n([c({type:Object})],Ao.prototype,"facetGroup",void 0);n([c({type:Object})],Ao.prototype,"collectionTitles",void 0);Ao=n([B("facets-template")],Ao);let gt=class extends I{constructor(){super(...arguments),this.leftValue="",this.rightValue="",this.side="left"}render(){var e,t;return u`
      <div id="container">
    ...
    `}get value(){return this.side==="left"?this.leftValue:this.rightValue}get selectedLabel(){var e,t;return this.side==="left"?(e=this.leftLabel)!==null&&e!==void 0?e:this.leftValue:(t=this.rightLabel)!==null&&t!==void 0?t:this.rightValue}handleClick(){this.side=this.side==="left"?"right":"left",this.emitChangeEvent()}handleRadioChange(){this.side=this.leftRadio.checked?"left":"right",this.emitChangeEvent()}emitChangeEvent(){const e=new CustomEvent("change",{detail:this.value});this.dispatchEvent(e)}static get styles(){const e=g`var(--switchWidth, 30px)`,t=g`var(--switchHeight, 14px)`,i=g`var(--switchMarginLeft, 5px)`,o=g`var(--switchMarginRight, 5px)`,r=g`var(--switchBorderWidth, 3px)`,a=g`var(--switchBgColor, #194880)`,l=g`var(--switchBorderColor, #194880)`,d=g`var(--labelFontSize, 1.3rem)`,p=g`var(--knobColor, white)`,h=g`var(--knobTransitionDuration, 0.25s)`,f=g`var(--knobTransitionFn, ease)`;return[tt,g`
      ...
      `]}};n([c({type:String,attribute:!0})],gt.prototype,"leftValue",void 0);n([c({type:String,attribute:!0})],gt.prototype,"leftLabel",void 0);n([c({type:String,attribute:!0})],gt.prototype,"rightValue",void 0);n([c({type:String,attribute:!0})],gt.prototype,"rightLabel",void 0);n([c({type:String,attribute:!0})],gt.prototype,"side",void 0);n([G("#switch-left")],gt.prototype,"leftRadio",void 0);gt=n([B("toggle-switch")],gt);const sh=1e4,rh=35;let se=class extends I{constructor(){super(...arguments),this.facetsPerPage=rh,this.facetsLoading=!0,this.sortedBy=W.COUNT,this.isTvSearch=!1,this.unappliedFacetChanges=nt(),this.pageNumber=1}willUpdate(e){(e.has("aggregations")||e.has("facetsPerPage")||e.has("sortedBy")||e.has("selectedFacets")||e.has("unappliedFacetChanges"))&&(this.facetGroup=this.mergedFacets)}updated(e){(e.has("facetKey")||e.has("query")||e.has("searchType")||e.has("filterMap"))&&(this.facetsLoading=!0,this.pageNumber=1,this.sortedBy=Bi[this.facetKey],this.updateSpecificFacets())}firstUpdated(){this.setupEscapeListeners()}setupEscapeListeners(){this.modalManager?document.addEventListener("keydown",e=>{var t;e.key==="Escape"&&((t=this.modalManager)===null||t===void 0||t.closeModal())}):document.removeEventListener("keydown",()=>{})}get isSearchResultsPage(){var e;const t=(e=this.pageSpecifierParams)===null||e===void 0?void 0:e.pageType;return t===void 0||t==="search_results"}async updateSpecificFacets(){var e,t,i,o,r,a;if(!this.facetKey)return;const l=(e=this.query)===null||e===void 0?void 0:e.trim();if(!l&&this.isSearchResultsPage)return;const d={simpleParams:[this.facetKey]},p=sh,h={...this.pageSpecifierParams,query:l||"",identifiers:this.identifiers,filters:this.filterMap,aggregations:d,aggregationsSize:p,rows:0},f=await((t=this.searchService)===null||t===void 0?void 0:t.search(h,this.searchType));this.aggregations=(i=f==null?void 0:f.success)===null||i===void 0?void 0:i.response.aggregations,this.facetsLoading=!1;const v=(r=(o=f==null?void 0:f.success)===null||o===void 0?void 0:o.response)===null||r===void 0?void 0:r.collectionTitles;if(v)for(const[y,x]of Object.entries(v))(a=this.collectionTitles)===null||a===void 0||a.set(y,x)}pageNumberClicked(e){var t,i;const o=(t=e==null?void 0:e.detail)===null||t===void 0?void 0:t.page;o&&(this.pageNumber=Number(o)),(i=this.analyticsHandler)===null||i===void 0||i.sendEvent({category:Je.default,action:ee.moreFacetsPageChange,label:`${this.pageNumber}`})}get mergedFacets(){var e;if(!this.facetKey||!this.selectedFacets)return;const{selectedFacetGroup:t,aggregationFacetGroup:i}=this;if(!i)return;const o={...t??i},r=(e=t==null?void 0:t.buckets.map(l=>{const d=i.buckets.find(p=>p.key===l.key);return d?{...l,count:d.count}:l}))!==null&&e!==void 0?e:[];yn(r,this.sortedBy),i.buckets.forEach(l=>{t!=null&&t.buckets.find(p=>p.key===l.key)||r.push(l)});const a=this.unappliedFacetChanges[this.facetKey];for(const[l,d]of r.entries()){const p=a==null?void 0:a[d.key];p&&(r[l]={...p})}return this.facetKey==="creator"&&this.isTvSearch&&r.forEach(l=>{var d,p,h;l.displayText=(p=(d=l.displayText)!==null&&d!==void 0?d:l.key)===null||p===void 0?void 0:p.toLocaleUpperCase();const f=(h=this.tvChannelAliases)===null||h===void 0?void 0:h.get(l.displayText);f&&f!==l.displayText&&(l.extraNote=`(${f})`)}),o.buckets=r,o}get selectedFacetGroup(){if(!this.selectedFacets||!this.facetKey)return;const e=this.selectedFacets[this.facetKey];if(!e)return;const t=xo[this.facetKey],i=Object.entries(e).map(([o,r])=>({displayText:o,key:o,count:r==null?void 0:r.count,state:r==null?void 0:r.state}));return{title:t,key:this.facetKey,buckets:i}}get aggregationFacetGroup(){if(!this.aggregations||!this.facetKey)return;const e=this.aggregations[this.facetKey];if(!e)return;const t=xo[this.facetKey];let i=e.getSortedBuckets(this.sortedBy);this.facetKey==="collection"&&(i=i==null?void 0:i.filter(r=>{var a;const l=(a=r==null?void 0:r.key)===null||a===void 0?void 0:a.toString();return!Po[l]&&!(l!=null&&l.startsWith("fav-"))}));const o=i.map(r=>{const a=`${r.key}`;return{displayText:`${a}`,key:`${a}`,count:r.doc_count,state:"none"}});return{title:t,key:this.facetKey,buckets:o}}get facetGroupForCurrentPage(){const{facetGroup:e}=this;if(!e)return;const t=(this.pageNumber-1)*this.facetsPerPage,i=e.buckets.slice(t,t+this.facetsPerPage);return{...e,buckets:i}}get moreFacetsTemplate(){return u`
      <facets-template
        .facetGroup=${this.facetGroupForCurrentPage}
        .selectedFacets=${this.selectedFacets}
        .collectionTitles=${this.collectionTitles}
        @facetClick=${e=>{this.facetKey&&(this.unappliedFacetChanges=hr(this.unappliedFacetChanges,this.facetKey,e.detail.bucket))}}
      ></facets-template>
    `}get loaderTemplate(){return u`<div class="facets-loader">
      <ia-activity-indicator .mode=${"processing"}></ia-activity-indicator>
    </div> `}get paginationSize(){var e;if(!this.aggregations||!this.facetKey)return 0;const t=(e=this.aggregations[this.facetKey])===null||e===void 0?void 0:e.buckets.length;return Math.ceil(t/this.facetsPerPage)}get facetsPaginationTemplate(){return this.paginationSize>1?u`<more-facets-pagination
        ...
        </div> `:b}sortFacetAggregation(e){this.sortedBy=e,this.dispatchEvent(new CustomEvent("sortedFacets",{detail:this.sortedBy}))}get modalHeaderTemplate(){var e,t,i;const r=((e=this.sortedBy)!==null&&e!==void 0?e:Bi[this.facetKey])===W.COUNT?"left":"right";return u`<span class="sr-only">${C("More facets for:")}</span>
      <span class="title">
      ...
      ${this.facetsLoading?this.loaderTemplate:u`
          ...
          `}
    `}applySearchFacetsClicked(){var e,t;const i=bn(this.selectedFacets,this.unappliedFacetChanges),o=new CustomEvent("facetsChanged",{detail:i,bubbles:!0,composed:!0});this.dispatchEvent(o),this.unappliedFacetChanges=nt(),(e=this.modalManager)===null||e===void 0||e.closeModal(),(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:Je.default,action:`${ee.applyMoreFacetsModal}`,label:`${this.facetKey}`})}cancelClick(){var e,t;this.unappliedFacetChanges=nt(),(e=this.modalManager)===null||e===void 0||e.closeModal(),(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:Je.default,action:ee.closeMoreFacetsModal,label:`${this.facetKey}`})}static get styles(){const e=g`var(--primaryButtonBGColor, #194880)`;return[tt,g`
        section#more-facets {
          overflow: auto;
    ...
    `}};Ha=n([B("facet-tombstone-row")],Ha);let H=class extends I{constructor(){super(...arguments),this.moreLinksVisible=!0,this.facetsLoading=!1,this.histogramAggregationLoading=!1,this.collapsableFacets=!1,this.showHistogramDatePicker=!1,this.allowExpandingDatePicker=!1,this.suppressMediatypeFacets=!1,this.parentCollections=[],this.collectionPagePath="/details/",this.isManageView=!1,this.isTvSearch=!1,this.facetDisplayOrder=un,this.openFacets={subject:!1,lending:!1,mediatype:!1,language:!1,creator:!1,collection:!1,year:!1,program:!1,person:!1,sponsor:!1},this.allowedFacetCount=6,this.handleExpandedDatePickerClosed=()=>{var e;(e=this.modalManager)===null||e===void 0||e.classList.remove("expanded-date-picker")},this.histogramDateRangeUpdated=e=>{const{minDate:t,maxDate:i}=e.detail,o=new CustomEvent("histogramDateRangeUpdated",{detail:{minDate:t,maxDate:i}});this.dispatchEvent(o)}}render(){const e=at({loading:this.facetsLoading,managing:this.isManageView}),t="date-picker-label";return u`
    ...
    `}get collectionPartOfTemplate(){var e;if(!(!((e=this.parentCollections)===null||e===void 0)&&e.length))return b;const t="partof-heading";return u`
      ...
      >
        ...
        <ul>
          ${Dt(this.parentCollections,i=>{var o,r;const a=`${this.baseNavigationUrl}${this.collectionPagePath}${i}`;return u` <li>
              <a
                href=${a}
                data-id=${i}
    ...
    `}partOfCollectionClicked(e){var t;(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:Je.default,action:ee.partOfCollectionClicked,label:e.target.dataset.id})}get histogramProps(){var e,t,i,o,r,a;const{histogramAggregation:l}=this;if(!l)return;const d=(e=l.first_bucket_year)!==null&&e!==void 0?e:l.first_bucket_key,p=(t=l.last_bucket_year)!==null&&t!==void 0?t:l.last_bucket_key;if(d==null||p==null)return;const h=(i=l.first_bucket_month)!==null&&i!==void 0?i:1,f=(o=l.last_bucket_month)!==null&&o!==void 0?o:12,v=(r=l.interval)!==null&&r!==void 0?r:1,y=(a=l.interval_in_months)!==null&&a!==void 0?a:12,x=S=>S.toString().padStart(2,"0");if(this.isTvSearch){const S=y<12;return{buckets:l.buckets,dateFormat:"YYYY-MM",tooltipDateFormat:S?"MMM YYYY":"YYYY",tooltipLabel:"broadcast",binSnapping:S?"month":"year",barScaling:"linear",minDate:`${d}-${x(h)}`,maxDate:`${p}-${x(f+y-1)}`}}return{buckets:l.buckets,dateFormat:"YYYY",tooltipDateFormat:"YYYY",tooltipLabel:"item",binSnapping:"year",barScaling:"logarithmic",minDate:`${d}`,maxDate:`${p+v-1}`}}showDatePickerModal(){var e,t,i;const{histogramProps:o}=this;if(!o)return;const{buckets:r,dateFormat:a,tooltipDateFormat:l,tooltipLabel:d,binSnapping:p,barScaling:h,minDate:f,maxDate:v}=o,x=u`
      <expanded-date-picker
        ${Jc(k=>{if(k&&k instanceof $e){const D=k;D.minSelectedDate=this.minSelectedDate,D.maxSelectedDate=this.maxSelectedDate}})}
        .minDate=${f}
        .maxDate=${v}
    ...
    `,S=new Lt({bodyColor:"#fff",headerColor:"#194880",showHeaderLogo:!1,closeOnBackdropClick:!0,title:u`${C("Select a date range")}`});(e=this.modalManager)===null||e===void 0||e.classList.add("expanded-date-picker"),(t=this.modalManager)===null||t===void 0||t.showModal({config:S,customModalContent:x,userClosedModalCallback:this.handleExpandedDatePickerClosed}),(i=this.analyticsHandler)===null||i===void 0||i.sendEvent({category:Je.default,action:ee.histogramExpanded,label:window.location.href})}updated(e){e.has("selectedFacets")&&this.dispatchFacetsChangedEvent()}dispatchFacetsChangedEvent(){const e=new CustomEvent("facetsChanged",{detail:this.selectedFacets});this.dispatchEvent(e)}get expandDatePickerBtnTemplate(){return this.allowExpandingDatePicker&&!this.facetsLoading?u`<button
        ...
        >
          ${J0}
        </button>`:b}get histogramTemplate(){var e,t;if(this.histogramAggregationLoading)return u` <div class="histogram-loading-indicator">&hellip;</div> `;const{histogramProps:i}=this;if(!i)return b;const{buckets:o,dateFormat:r,tooltipDateFormat:a,tooltipLabel:l,binSnapping:d,barScaling:p,minDate:h,maxDate:f}=i;return u`
      <histogram-date-range
        class=${this.isTvSearch?"wide-inputs":""}
        .minDate=${h}
        .maxDate=${f}
        .minSelectedDate=${(e=this.minSelectedDate)!==null&&e!==void 0?e:h}
        .maxSelectedDate=${(t=this.maxSelectedDate)!==null&&t!==void 0?t:f}
        .updateDelay=${100}
        .dateFormat=${r}
        .tooltipDateFormat=${a}
        .tooltipLabel=${l}
        ...
        @histogramDateRangeUpdated=${this.histogramDateRangeUpdated}
      ></histogram-date-range>
    `}get mergedFacets(){const e=[];return this.facetDisplayOrder.forEach(t=>{var i,o;if(t==="mediatype"&&this.suppressMediatypeFacets)return;const r=this.selectedFacetGroups.find(h=>h.key===t),a=this.aggregationFacetGroups.find(h=>h.key===t);if(r&&!a){e.push(r);return}if(!a)return;const l=r??a;let d=(i=r==null?void 0:r.buckets.map(h=>{const f=a.buckets.find(v=>v.key===h.key);return f?{...h,count:f.count}:h}))!==null&&i!==void 0?i:[];a.buckets.forEach(h=>{d.find(v=>v.key===h.key)||d.push(h)});let p=(o=Object.keys((r==null?void 0:r.buckets)||[]))===null||o===void 0?void 0:o.length;if(p<this.allowedFacetCount&&(p=this.allowedFacetCount),t==="lending"&&(d=d.filter(h=>ld[h.key])),yn(d,Bi[t]),t==="mediatype"){const h=d.findIndex(f=>f.key==="collection");if(h>=p){const[f]=d.splice(h,1);p>this.allowedFacetCount&&(p+=1),d.splice(p-1,0,f)}}t==="creator"&&this.isTvSearch&&d.forEach(h=>{var f,v,y;h.displayText=(v=(f=h.displayText)!==null&&f!==void 0?f:h.key)===null||v===void 0?void 0:v.toLocaleUpperCase();const x=(y=this.tvChannelAliases)===null||y===void 0?void 0:y.get(h.displayText);x&&x!==h.displayText&&(h.extraNote=`(${x})`)}),l.buckets=d.slice(0,p),e.push(l)}),e}get selectedFacetGroups(){return this.selectedFacets?Object.entries(this.selectedFacets).map(([t,i])=>{const o=t,r=xo[o],a=Object.entries(i).map(([l,d])=>{var p;let h=l;return o==="lending"&&(h=(p=ca[l])!==null&&p!==void 0?p:l),{displayText:h,key:l,count:d.count,state:d.state}});return{title:r,key:o,buckets:a}}):[]}get aggregationFacetGroups(){var e;const t=[];return Object.entries((e=this.aggregations)!==null&&e!==void 0?e:[]).forEach(([i,o])=>{if(["year_histogram","date_histogram"].includes(i))return;const r=i,a=xo[r];if(!a)return;let l=o.getSortedBuckets(Bi[r]);r==="collection"&&(l=l==null?void 0:l.filter(h=>{var f;const v=(f=h==null?void 0:h.key)===null||f===void 0?void 0:f.toString();return!Po[v]&&!(v!=null&&v.startsWith("fav-"))}));const d=l.map(h=>{var f;const v=h.key;let y=`${h.key}`;return r==="lending"&&(y=(f=ca[h.key])!==null&&f!==void 0?f:`${h.key}`),{displayText:y,key:`${v}`,count:h.doc_count,state:"none"}}),p={title:a,key:r,buckets:d};t.push(p)}),t}getFacetGroupTemplate(e){if(!this.facetsLoading&&e.buckets.length===0)return b;const{key:t}=e,i=this.openFacets[t],o=u`
    ...
    `}getTombstoneFacetGroupTemplate(){return u`
      ${Dt(Array(5).fill(null),()=>u`<facet-tombstone-row></facet-tombstone-row>`)}
    `}searchMoreFacetsLink(e){if(!this.moreLinksVisible||e.key==="lending"||Object.keys(e.buckets).length<this.allowedFacetCount)return b;const t=Bi[e.key];return u`<button
      class="more-link"
      @click=${()=>{var i;this.showMoreFacetsModal(e,t),(i=this.analyticsHandler)===null||i===void 0||i.sendEvent({category:Je.default,action:ee.showMoreFacetsModal,label:e.key}),this.dispatchEvent(new CustomEvent("showMoreFacets",{detail:e.key}))}}
    ...
    `,a=new Lt({bodyColor:"#fff",headerColor:"#194880",showHeaderLogo:!1,closeOnBackdropClick:!0,title:u`Select filters`});(i=this.modalManager)===null||i===void 0||i.classList.add("more-search-facets"),(o=this.modalManager)===null||o===void 0||o.showModal({config:a,customModalContent:r,userClosedModalCallback:()=>{var l;(l=this.modalManager)===null||l===void 0||l.classList.remove("more-search-facets")}})}getFacetTemplate(e){return u`
      <facets-template
        .collectionPagePath=${this.collectionPagePath}
        .facetGroup=${e}
        .selectedFacets=${this.selectedFacets}
        .collectionTitles=${this.collectionTitles}
        @facetClick=${t=>{this.selectedFacets=hr(this.selectedFacets,e.key,t.detail.bucket,!0);const i=new CustomEvent("facetsChanged",{detail:this.selectedFacets,bubbles:!0,composed:!0});this.dispatchEvent(i)}}
      ></facets-template>
    `}static get styles(){return[tt,g`
        a:link {
          text-decoration: none;
      ...
      `]}};n([c({type:Object})],H.prototype,"searchService",void 0);n([c({type:Number})],H.prototype,"searchType",void 0);n([c({type:Object})],H.prototype,"aggregations",void 0);n([c({type:Object})],H.prototype,"histogramAggregation",void 0);n([c({type:String})],H.prototype,"minSelectedDate",void 0);n([c({type:String})],H.prototype,"maxSelectedDate",void 0);n([c({type:Boolean})],H.prototype,"moreLinksVisible",void 0);n([c({type:Boolean})],H.prototype,"facetsLoading",void 0);n([c({type:Boolean})],H.prototype,"histogramAggregationLoading",void 0);n([c({type:Object})],H.prototype,"selectedFacets",void 0);n([c({type:Boolean})],H.prototype,"collapsableFacets",void 0);n([c({type:Number})],H.prototype,"contentWidth",void 0);n([c({type:Boolean})],H.prototype,"showHistogramDatePicker",void 0);n([c({type:Boolean})],H.prototype,"allowExpandingDatePicker",void 0);n([c({type:Boolean})],H.prototype,"suppressMediatypeFacets",void 0);n([c({type:String})],H.prototype,"query",void 0);n([c({type:Array})],H.prototype,"identifiers",void 0);n([c({type:Object})],H.prototype,"pageSpecifierParams",void 0);n([c({type:Array})],H.prototype,"parentCollections",void 0);n([c({type:Object})],H.prototype,"filterMap",void 0);n([c({type:String})],H.prototype,"baseNavigationUrl",void 0);n([c({type:String})],H.prototype,"collectionPagePath",void 0);n([c({type:Boolean})],H.prototype,"isManageView",void 0);n([c({type:Boolean})],H.prototype,"isTvSearch",void 0);n([c({type:Array})],H.prototype,"facetDisplayOrder",void 0);n([c({type:Object,attribute:!1})],H.prototype,"modalManager",void 0);n([c({type:Object,attribute:!1})],H.prototype,"resizeObserver",void 0);n([c({type:Object,attribute:!1})],H.prototype,"featureFeedbackService",void 0);n([c({type:Object,attribute:!1})],H.prototype,"recaptchaManager",void 0);n([c({type:Object,attribute:!1})],H.prototype,"analyticsHandler",void 0);n([c({type:Object,attribute:!1})],H.prototype,"collectionTitles",void 0);n([c({type:Object,attribute:!1})],H.prototype,"tvChannelAliases",void 0);n([z()],H.prototype,"openFacets",void 0);H=n([B("collection-facets")],H);let Va=class extends I{render(){return u`
      <div class="lds-ring">
        <div></div>
        <div></div>
        <div></div>
    ...
    `}};Va=n([B("circular-activity-indicator")],Va);function ah(s,e){return s===void 0?e!==void 0:e===void 0?s!==void 0:s.facetType===e.facetType&&s.bucketKey===e.bucketKey}function Xs(s,e){return s.label===e.label&&s.facets.length===e.facets.length&&s.facets.every((t,i)=>ah(t,e.facets[i]))}function Nn(s){if(!Array.isArray(s[0])){let o=[...s];for(let r=0;r<o.length;r++){const a=o[r];o=o.filter(l=>a===l||!Xs(a,l))}return o}const e=s,t=[];for(const i of e){const o=[];for(const r of i)t.find(l=>l.find(d=>Xs(r,d)))||o.push(r);o.length>0&&t.push(o)}return t}class gr{async getRecommendedFacets(){const e=navigator.language,t=gr.getLanguageDisplayName(e);return t?[{facets:[{facetType:"language",bucketKey:t}]}]:[]}static getLanguageDisplayName(e){const t=e.split("-")[0];return new Intl.DisplayNames(["en"],{type:"language"}).of(t)}}const Ct={facets:[{facetType:"mediatype",bucketKey:"texts"}]},kt={facets:[{facetType:"mediatype",bucketKey:"audio"}]},Yt={facets:[{facetType:"mediatype",bucketKey:"movies"}]},ht={facets:[{facetType:"mediatype",bucketKey:"image"}]},Li={facets:[{facetType:"mediatype",bucketKey:"software"}]},Ss={facets:[{facetType:"mediatype",bucketKey:"etree"}]},nh={facets:[{facetType:"mediatype",bucketKey:"web"}]},lh={facets:[{facetType:"mediatype",bucketKey:"data"}]},dh={text:[Ct],book:[Ct],novel:[Ct],magazine:[Ct],newspaper:[Ct],pdf:[Ct],epub:[Ct],audio:[kt],song:[kt],music:[kt],listen:[kt],podcast:[kt],radio:[kt],stream:[kt,Yt],video:[Yt],movie:[Yt],film:[Yt],animation:[Yt],youtube:[Yt],image:[ht],photo:[ht],picture:[ht],painting:[ht],jpg:[ht],jpeg:[ht],png:[ht],gif:[ht],software:[Li],app:[Li],program:[Li],game:[Li],arcade:[Li],etree:[Ss],concert:[Ss],"live music":[Ss],"web crawl":[nh],dataset:[lh]};class ch{async getRecommendedFacets(e){const t=[];for(const[i,o]of Object.entries(dh))e.includes(i)&&t.push(...o);return t}}const ro=[{facets:[{facetType:"mediatype",bucketKey:"texts"}]}],Wa=[{label:"Films by __QUERY",facets:[{facetType:"mediatype",bucketKey:"movies"},{facetType:"creator",bucketKey:"__QUERY"}]}],zi=[{label:"Writing by __QUERY",facets:[{facetType:"mediatype",bucketKey:"texts"},{facetType:"creator",bucketKey:"__QUERY"}]}],ao=[{label:"Images by __QUERY",facets:[{facetType:"mediatype",bucketKey:"image"},{facetType:"creator",bucketKey:"__QUERY"}]}],Fi=[{label:"Music by __QUERY",facets:[{facetType:"mediatype",bucketKey:"audio"},{facetType:"creator",bucketKey:"__QUERY"}]}],hh={"written work":ro,literature:ro,book:ro,novel:ro,filmmaker:Wa,director:Wa,author:zi,writer:zi,novelist:zi,essayist:zi,poet:zi,"visual artist":ao,"graphic artist":ao,photographer:ao,painter:ao,singer:Fi,songwriter:Fi,musician:Fi,composer:Fi,pianist:Fi};class ph{constructor(){this.WIKIDATA_BASE_URL="https://www.wikidata.org/w/api.php",this.WIKIDATA_DEFAULT_ARGS="?action=wbsearchentities&format=json&language=en&uselang=en&origin=*&type=item&limit=5"}getWikidataURL(e){const t=encodeURIComponent(e);return`${this.WIKIDATA_BASE_URL}${this.WIKIDATA_DEFAULT_ARGS}&search=${t}`}replaceQueryPlaceholders(e,t){return e.map(i=>{var o;return{label:(o=i.label)===null||o===void 0?void 0:o.replace("__QUERY",t),facets:i.facets.map(r=>{var a;const l={...r,bucketKey:r.bucketKey.replace("__QUERY",t.toLowerCase())};return r.displayText&&(l.displayText=(a=l.displayText)===null||a===void 0?void 0:a.replace("__QUERY",t)),l})}})}async getRecommendedFacets(e){var t;const i=[];try{const o=this.getWikidataURL(e),a=await(await fetch(o)).json();for(const[l,d]of Object.entries(hh))if(new RegExp(`\\b${l}\\b`).test((t=a.search[0])===null||t===void 0?void 0:t.description)){const h=a.search[0].label;i.push(...this.replaceQueryPlaceholders(d,h))}return i}catch(o){return console.warn(o),[]}}}class Io{async getRecommendedFacets(e,t=Io.DEFAULT_HEURISTICS){const i=t.map(o=>new o().getRecommendedFacets(e));return Nn((await Promise.all(i)).flat())}}Io.DEFAULT_HEURISTICS=[ch,ph,gr];const uh=u`
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path
...
`;function mh(s){return s&&s.charAt(0).toLocaleUpperCase()+s.slice(1)}let Gi=class extends I{constructor(){super(...arguments),this.selected=!1}render(){var e,t;if(!this.facetInfo)return b;const i=this.facetInfo.facets.length===1,o=this.facetInfo.facets[0],r=mh((this.labelPrefix?`${this.labelPrefix} `:"")+((t=(e=this.facetInfo.label)!==null&&e!==void 0?e:o.displayText)!==null&&t!==void 0?t:o.bucketKey));if(!r)return b;const a=i&&o.facetType==="mediatype"?$n[o.bucketKey].icon:b;return u`
      <a
      ...
      >
        ${a} ${r}
        ${this.selected?u`<span class="unselect-button">${fh}</span>`:b}
      </a>
    ...
    `}};n([c({type:Object})],Gi.prototype,"facetInfo",void 0);n([c({type:String})],Gi.prototype,"labelPrefix",void 0);n([c({type:Boolean})],Gi.prototype,"selected",void 0);Gi=n([B("smart-facet-button")],Gi);let ci=class extends I{render(){var e,t;if(!this.facetInfo||!this.activeFacetRef||this.facetInfo.length===0)return b;const i=(e=this.activeFacetRef.displayText)!==null&&e!==void 0?e:this.activeFacetRef.bucketKey;return i?u`
    ...
    `}};n([c({type:Array})],ci.prototype,"facetInfo",void 0);n([c({type:String})],ci.prototype,"labelPrefix",void 0);n([c({type:Object})],ci.prototype,"activeFacetRef",void 0);n([G("ia-dropdown")],ci.prototype,"dropdown",void 0);ci=n([B("smart-facet-dropdown")],ci);const ja={collection:"Collection: ",creator:"By: ",subject:"About: "};function vh(s){return s.charAt(0).toUpperCase()+s.slice(1)}let Pe=class extends I{constructor(){super(...arguments),this.filterToggleShown=!1,this.filterToggleActive=!1,this.heuristicRecs=[],this.smartFacets=[]}render(){if(!this.query)return b;const e=!!this.label&&this.smartFacets.length>0;return u`
      <div id="smart-facets-container">
        ${this.filtersToggleTemplate}
        ${e?u`<p id="filters-label">${this.label}</p>`:b}
        ${nr(this.smartFacets,t=>`${t[0].label}|${t[0].facets[0].facetType}|${t[0].facets[0].bucketKey}`,t=>this.makeSmartFacet(t))}
      </div>
    `}willUpdate(e){let t=!1;e.has("query")&&(Oe("query change",e.get("query"),this.query),this.lastAggregations=void 0,t=!0),e.has("aggregations")&&!this.lastAggregations&&this.aggregations&&Object.keys(this.aggregations).length>0&&(Oe("aggs change",e.get("aggregations"),this.aggregations),this.lastAggregations=this.aggregations,t=!0),t&&(Oe("should update smart facets, doing so..."),this.updateSmartFacets())}refresh(){this.lastAggregations=this.aggregations,this.updateSmartFacets()}deselectAll(){for(const e of this.smartFacets)for(const t of e)t.selected=!1;this.requestUpdate()}async updateSmartFacets(){Oe("updating smart facets"),this.query&&(this.heuristicRecs=await new Io().getRecommendedFacets(this.query),Oe("heuristic recs are",this.heuristicRecs),this.smartFacets=Nn(this.facetsToDisplay),Oe("smart facets are",this.smartFacets))}makeSmartFacet(e){return e.length===0?b:e.length===1?this.smartFacetButton(e[0]):this.smartFacetDropdown(e)}smartFacetButton(e){var t;return u`
      <smart-facet-button
        .facetInfo=${e}
        .labelPrefix=${ja[e.facets[0].facetType]}
    ...
    `}smartFacetDropdown(e){return u`
      <smart-facet-dropdown
        .facetInfo=${e}
        .labelPrefix=${ja[e[0].facets[0].facetType]}
    ...
    `}};n([c({type:String})],Pe.prototype,"query",void 0);n([c({type:Object})],Pe.prototype,"aggregations",void 0);n([c({type:Object})],Pe.prototype,"selectedFacets",void 0);n([c({type:Object})],Pe.prototype,"collectionTitles",void 0);n([c({type:Boolean})],Pe.prototype,"filterToggleShown",void 0);n([c({type:Boolean})],Pe.prototype,"filterToggleActive",void 0);n([c({type:String})],Pe.prototype,"label",void 0);n([z()],Pe.prototype,"heuristicRecs",void 0);n([z()],Pe.prototype,"smartFacets",void 0);n([z()],Pe.prototype,"lastAggregations",void 0);Pe=n([B("smart-facet-bar")],Pe);let T=class extends I{constructor(){super(),this.baseImageUrl="https://archive.org",this.searchType=O.DEFAULT,this.selectedSort=$.default,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.tvClipFilter="all",this.sortDirection=null,this.defaultSortField=$.relevance,this.defaultSortDirection=null,this.pageSize=50,this.showSmartFacetBar=!1,this.showHistogramDatePicker=!1,this.suppressPlaceholders=!1,this.suppressResultCount=!1,this.suppressResultTiles=!1,this.suppressURLQuery=!1,this.suppressURLSinParam=!1,this.suppressSortBar=!1,this.suppressDisplayModes=!1,this.suppressMediatypeFacets=!1,this.facetLoadStrategy="eager",this.facetPaneVisible=!1,this.clearResultsOnEmptyQuery=!1,this.collectionPagePath="/details/",this.searchContext=Je.default,this.pageContext="search",this.restorationStateHandler=new ud({context:this.pageContext}),this.mobileBreakpoint=600,this.loggedIn=!1,this.modalManager=void 0,this.isTVCollection=!1,this.isManageView=!1,this.manageViewLabel="Select items to remove",this.enableSortOptionsSlot=!1,this.showSmartResults=!1,this.maxPagesToManage=15,this.dataSource=new vd(this,this.pageSize),this.initialPageNumber=1,this.pagesToRender=this.initialPageNumber,this.searchResultsLoading=!1,this.facetsLoading=!1,this.mobileView=!1,this.tileBlurOverrideState="no-override",this.collapsibleFacetsVisible=!1,this.placeholderType=null,this.layoutSizeAnalyticsSent=!1,this.isScrollingToCell=!1,this.isResizeToMobile=!1,this.dataSourceInstallInProgress=!1,this.placeholderCellTemplate=u`<collection-browser-loading-tile></collection-browser-loading-tile>`,this.updateLeftColumnHeight=()=>{var e,t,i,o,r;if(this.mobileView)(t=(e=this.leftColumn)===null||e===void 0?void 0:e.style)===null||t===void 0||t.removeProperty("height");else{const a=(i=this.leftColumn)===null||i===void 0?void 0:i.getBoundingClientRect().top,l=window.innerHeight-(a??0),d=a===0?null:`calc(${l}px - var(--leftColumnPaddingTop, 2rem))`;(r=(o=this.leftColumn)===null||o===void 0?void 0:o.style)===null||r===void 0||r.setProperty("height",d)}},this.updateFacetFadeOut=e=>{var t,i;const o=(t=this.shadowRoot)===null||t===void 0?void 0:t.getElementById("facets-bottom-fade");o==null||o.classList.toggle("hidden",(i=e==null?void 0:e[0])===null||i===void 0?void 0:i.isIntersecting)},this.initialQueryChangeHappened=!1,this.historyPopOccurred=!1,this.addController(this.dataSource)}tileModelAtCellIndex(e){const t=this.dataSource.getTileModelAt(e);if(!t&&!this.isScrollingToCell&&this.dataSource.queryInitialized){const i=Math.floor(e/this.pageSize)+1;this.dataSource.fetchPage(i)}return t}get estimatedTileCount(){return this.pagesToRender*this.pageSize}async getSessionId(){try{const e=sessionStorage==null?void 0:sessionStorage.getItem("cb-session");if(e)return e;if(this.sessionIdGenPromise)return this.sessionIdGenPromise;this.sessionIdGenPromise=gn(Math.random().toString());const t=await this.sessionIdGenPromise;return sessionStorage==null||sessionStorage.setItem("cb-session",t),t}catch{return""}}goToPage(e){return this.initialPageNumber=e,this.pagesToRender=e,this.scrollToPage(e)}setSearchResultsLoading(e){this.searchResultsLoading=e}setFacetsLoading(e){this.facetsLoading=e}setTotalResultCount(e){this.totalResults=e}clearFilters({facets:e=!0,dateRange:t=!0,letterFilters:i=!0,sort:o=!1}={}){e&&this.hasCheckedFacets&&(this.selectedFacets=nt()),t&&(this.minSelectedDate=void 0,this.maxSelectedDate=void 0),i&&(this.selectedTitleFilter=null,this.selectedCreatorFilter=null),o&&(this.sortDirection=null,this.selectedSort=$.default),this.smartFacetBar&&this.smartFacetBar.deselectAll()}get hasCheckedFacets(){if(!this.selectedFacets)return!1;for(const e of Object.values(this.selectedFacets))for(const t of Object.values(e))if(t.state!=="none")return!0;return!1}get hasActiveFilters(){return!!(this.hasCheckedFacets||this.minSelectedDate||this.maxSelectedDate||this.selectedTitleFilter||this.selectedCreatorFilter)}willUpdate(){this.setPlaceholderType()}render(){return u`
    ...
    `}get rightColumnTemplate(){const e=at({column:!0,"full-width":!this.facetPaneVisible,"smart-results-spacing":!!this.showSmartResults});return u`
    ...
    </infinite-scroller>`}get infiniteScrollerClasses(){var e;return at({[(e=this.displayMode)!==null&&e!==void 0?e:""]:!!this.displayMode,hidden:!!this.placeholderType})}get sortFilterBarTemplate(){var e;if(this.suppressSortBar)return b;let t=$.weeklyview,i=$.date,o=Fo;return!((e=this.withinCollection)===null||e===void 0)&&e.startsWith("fav-")?(i=$.datefavorited,o=ed):!this.withinCollection&&this.searchType===O.TV&&(t=$.alltimeview,i=$.datearchived,o=td),o.relevance=this.isRelevanceSortAvailable,u`
      <sort-filter-bar
    ...
    `}handleRemoveItems(){this.dispatchEvent(new CustomEvent("itemRemovalRequested",{detail:{items:this.dataSource.checkedTileModels.map(e=>{var t;const i=(e==null?void 0:e.mediatype)==="search"?"search:":"",o=(t=e==null?void 0:e.identifier)!==null&&t!==void 0?t:"";return`${i}${o}`})}}))}handleManageItems(){this.dispatchEvent(new CustomEvent("itemManagerRequested",{detail:{items:this.dataSource.checkedTileModels.map(e=>e!=null&&e.identifier?e.identifier:"")}}))}refreshSmartFacets(){var e;(e=this.smartFacetBar)===null||e===void 0||e.refresh()}showRemoveItemsProcessingModal(){var e;(e=this.manageBar)===null||e===void 0||e.showRemoveItemsProcessingModal()}showRemoveItemsErrorModal(){var e;(e=this.manageBar)===null||e===void 0||e.showRemoveItemsErrorModal()}removeCheckedTiles(){this.dataSource.removeCheckedTiles()}tileBlurCheckboxChanged(e){var t;const{checked:i}=e.target;this.tileBlurOverrideState=i?"on":"off",(t=this.infiniteScroller)===null||t===void 0||t.refreshAllVisibleCells()}get shouldSuppressTileBlurring(){if(this.tileBlurOverrideState!=="no-override")return this.tileBlurOverrideState==="off";const{sessionContext:e}=this.dataSource,t=e==null?void 0:e.pps_relevant_user_preferences;return(t==null?void 0:t.display__blur_moderated_content)==="off"}userChangedSort(e){var t;const{selectedSort:i,sortDirection:o}=e.detail;this.selectedSort=i,this.sortDirection=o,((t=this.currentPage)!==null&&t!==void 0?t:1)>1&&this.goToPage(1),this.currentPage=1}sendSortByAnalytics(e){var t;const i=e&&!this.sortDirection;(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:this.searchContext,action:ee.sortBy,label:`${this.selectedSort}${this.sortDirection||i?`-${this.sortDirection}`:""}`})}selectedSortChanged(){this.dataSource.updatePrefixFiltersForCurrentSort()}get sortParam(){var e;const t=Se[this.selectedSort];if(!(t!=null&&t.handledBySearchService))return null;const i=new URL(window.location.href).searchParams.get("sort"),o=(e=t.searchServiceKey)!==null&&e!==void 0?e:i==null?void 0:i.replace(/^-/,"");return this.sortDirection||(this.sortDirection="asc"),o?{field:o,direction:this.sortDirection}:null}get defaultSortParam(){var e;const t=(e=this.defaultSortDirection)!==null&&e!==void 0?e:"asc",i=Se[this.defaultSortField].searchServiceKey;return i?{field:i,direction:t}:null}displayModeChanged(e){var t;this.displayMode=e.detail.displayMode,this.displayMode&&((t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:this.searchContext,action:ee.displayMode,label:this.displayMode}))}get titleQuery(){return this.selectedTitleFilter?`firstTitle:${this.selectedTitleFilter}`:void 0}get creatorQuery(){return this.selectedCreatorFilter?`firstCreator:${this.selectedCreatorFilter}`:void 0}sendFilterByTitleAnalytics(e){var t;if(!e&&!this.selectedTitleFilter)return;const i=e&&!this.selectedTitleFilter;(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:this.searchContext,action:ee.filterByTitle,label:i?`clear-${e}`:`${e||"start"}-${this.selectedTitleFilter}`})}sendFilterByCreatorAnalytics(e){var t;if(!e&&!this.selectedCreatorFilter)return;const i=e&&!this.selectedCreatorFilter;(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:this.searchContext,action:ee.filterByCreator,label:i?`clear-${e}`:`${e||"start"}-${this.selectedCreatorFilter}`})}titleLetterSelected(e){this.selectedCreatorFilter=null,this.selectedTitleFilter=e.detail.selectedLetter}creatorLetterSelected(e){this.selectedTitleFilter=null,this.selectedCreatorFilter=e.detail.selectedLetter}get mobileFacetsTemplate(){return Ls.includes(this.profileElement)?b:u`
      <details id="mobile-filter-collapse" @toggle=${t=>{var i;const o=t.target;this.isResizeToMobile=!1,this.collapsibleFacetsVisible=o.open,(i=this.analyticsHandler)===null||i===void 0||i.sendEvent({category:this.searchContext,action:ee.mobileFacetsToggled,label:o.open?"open":"closed"})}}>
        <summary>
          <span class="collapser-icon">${Fs}</span>
          <h2>${C("Filters")}</h2>
          ${this.clearFiltersBtnTemplate(!0)}
        </summary>
        ${this.facetsTemplate}
      </details>
    `}get facetsTemplate(){if(Ls.includes(this.profileElement))return b;if(this.facetLoadStrategy==="off")return u`
        <p class="facets-message">
          ${C("Facets are temporarily unavailable.")}
        </p>
      `;const e=this.isTVCollection||!this.withinCollection&&this.searchType===O.TV,t=e?ad:un,i=u`
      <collection-facets
        .collectionPagePath=${this.collectionPagePath}
    ...
    `;return(this.facetLoadStrategy==="opt-in"||this.facetLoadStrategy==="opt-in-or-login"&&!this.loggedIn)&&!this.mobileView?u`
      ...
      `:i}clearFiltersBtnTemplate(e){if(!this.hasActiveFilters)return b;const t=at({"clear-filters-btn":!0,mobile:e}),i=e?"Clear all":"Clear all filters";return u`
  ...
  `;n([z()],ne.prototype,"toggleSlots",void 0);n([z()],ne.prototype,"currentPage",void 0);n([z()],ne.prototype,"searchQuery",void 0);n([z()],ne.prototype,"withinCollection",void 0);n([z()],ne.prototype,"cellWidth",void 0);n([z()],ne.prototype,"cellHeight",void 0);n([z()],ne.prototype,"rowGap",void 0);n([z()],ne.prototype,"colGap",void 0);n([z()],ne.prototype,"suppressFacets",void 0);n([z()],ne.prototype,"lazyLoadFacets",void 0);n([z()],ne.prototype,"loggedIn",void 0);n([z()],ne.prototype,"searchType",void 0);n([c({type:Object,reflect:!1})],ne.prototype,"latestAction",void 0);n([G("#base-query-field")],ne.prototype,"baseQueryField",void 0);n([G("#base-collection-field")],ne.prototype,"baseCollectionField",void 0);n([G("#page-number-input")],ne.prototype,"pageNumberInput",void 0);n([G("collection-browser")],ne.prototype,"collectionBrowser",void 0);n([G("modal-manager")],ne.prototype,"modalManager",void 0);ne=n([B("app-root")],ne);
