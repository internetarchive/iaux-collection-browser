...
fill=""></path>
  ...
  `}};B([A({type:String})],Rl.prototype,`selectedLetter`,void 0),B([A({type:Object})],Rl.prototype,`letterCounts`,void 0),B([A({type:String})],Rl.prototype,`ariaLandmarkLabel`,void 0),B([j()],Rl.prototype,`tooltipShown`,void 0),B([j()],Rl.prototype,`hoveredLetter`,void 0),B([M(`alpha-bar-tooltip`)],Rl.prototype,`tooltip`,void 0),Rl=B([k(`alpha-bar`)],Rl);var zl=class extends O{constructor(...e){super(...e),this.defaultSortDirection=null,this.defaultSortField=L.relevance,this.sortDirection=null,this.selectedSort=L.default,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.sortFieldAvailability=Yi,this.enableSortOptionsSlot=!1,this.suppressDisplayModes=!1,this.alphaSelectorVisible=null,this.dropdownBackdropVisible=!1,this.boundSortBarSelectorEscapeListener=e=>{e.key===`Escape`&&this.closeDropdown()}}render(){return T`
    ...
    `}get dropdownBackdrop(){return T`
      ...
      ></div>
    `}closeDropdown(){this.dropdownBackdropVisible=!1,this.sortOptionsDropdown&&(this.sortOptionsDropdown.open=!1,this.sortOptionsDropdown.classList.remove(`open`))}setSortDirection(e){this.sortDirection=e,this.emitSortChangedEvent()}toggleSortDirection(){this.setSortDirection(this.finalizedSortDirection===`desc`?`asc`:`desc`)}handleSortDirectionClicked(){!this.sortDirection&&this.defaultSortField&&this.defaultSortDirection&&(this.selectedSort=this.defaultSortField,this.sortDirection=this.defaultSortDirection),this.toggleSortDirection()}setSelectedSort(e){this.selectedSort=e;let t=qi[e];this.sortDirection=t.defaultSortDirection,this.emitSortChangedEvent()}get finalizedSortField(){let e=this.selectedSort===L.default?this.defaultSortField:this.selectedSort;return this.sortFieldAvailability[e]?e:this.firstAvailableOption?.field??e}get finalizedSortDirection(){return this.sortDirection===null?this.defaultSortDirection:this.sortDirection}get firstAvailableOption(){return Object.values(qi).find(e=>e.shownInSortBar&&this.sortFieldAvailability[e.field])}get canChangeSortDirection(){return qi[this.finalizedSortField].canSetDirection}get titleSelectorBar(){return T` <alpha-bar
...
`,kg,Ag=kg=class extends O{render(){return T`${this.facetRowTemplate}`}get facetRowTemplate(){let{bucket:e,facetType:t}=this;if(!e||!t)return D;let n=`${t}:${e.key}-show-only`,r=`${t}:${e.key}-negative`,i=e.extraNote?T`<span class="facet-note">${e.extraNote}</span>`:D,a=t===`collection`?T`<a href="/details/${e.key}">
    ...
    `}};Fg=B([k(`circular-activity-indicator`)],Fg);function Ig(e,t){return e===void 0?t!==void 0:t===void 0?e!==void 0:e.facetType===t.facetType&&e.bucketKey===t.bucketKey}function Lg(e,t){return e.label===t.label&&e.facets.length===t.facets.length&&e.facets.every((e,n)=>Ig(e,t.facets[n]))}function Rg(e){if(!Array.isArray(e[0])){let t=[...e];for(let e=0;e<t.length;e++){let n=t[e];t=t.filter(e=>n===e||!Lg(n,e))}return t}let t=e,n=[];for(let e of t){let t=[];for(let r of e)n.find(e=>e.find(e=>Lg(r,e)))||t.push(r);t.length>0&&n.push(t)}return n}var zg=class e{async getRecommendedFacets(){let t=navigator.language,n=e.getLanguageDisplayName(t);return n?[{facets:[{facetType:`language`,bucketKey:n}]}]:[]}static getLanguageDisplayName(e){let t=e.split(`-`)[0];return new Intl.DisplayNames([`en`],{type:`language`}).of(t)}},Bg={facets:[{facetType:`mediatype`,bucketKey:`texts`}]},Vg={facets:[{facetType:`mediatype`,bucketKey:`audio`}]},Hg={facets:[{facetType:`mediatype`,bucketKey:`movies`}]},Ug={facets:[{facetType:`mediatype`,bucketKey:`image`}]},Wg={facets:[{facetType:`mediatype`,bucketKey:`software`}]},Gg={facets:[{facetType:`mediatype`,bucketKey:`etree`}]},Kg={text:[Bg],book:[Bg],novel:[Bg],magazine:[Bg],newspaper:[Bg],pdf:[Bg],epub:[Bg],audio:[Vg],song:[Vg],music:[Vg],listen:[Vg],podcast:[Vg],radio:[Vg],stream:[Vg,Hg],video:[Hg],movie:[Hg],film:[Hg],animation:[Hg],youtube:[Hg],image:[Ug],photo:[Ug],picture:[Ug],painting:[Ug],jpg:[Ug],jpeg:[Ug],png:[Ug],gif:[Ug],software:[Wg],app:[Wg],program:[Wg],game:[Wg],arcade:[Wg],etree:[Gg],concert:[Gg],"live music":[Gg],"web crawl":[{facets:[{facetType:`mediatype`,bucketKey:`web`}]}],dataset:[{facets:[{facetType:`mediatype`,bucketKey:`data`}]}]},qg=class{async getRecommendedFacets(e){let t=[];for(let[n,r]of Object.entries(Kg))e.includes(n)&&t.push(...r);return t}},Jg=[{facets:[{facetType:`mediatype`,bucketKey:`texts`}]}],Yg=[{label:`Films by __QUERY`,facets:[{facetType:`mediatype`,bucketKey:`movies`},{facetType:`creator`,bucketKey:`__QUERY`}]}],Xg=[{label:`Writing by __QUERY`,facets:[{facetType:`mediatype`,bucketKey:`texts`},{facetType:`creator`,bucketKey:`__QUERY`}]}],Zg=[{label:`Images by __QUERY`,facets:[{facetType:`mediatype`,bucketKey:`image`},{facetType:`creator`,bucketKey:`__QUERY`}]}],Qg=[{label:`Music by __QUERY`,facets:[{facetType:`mediatype`,bucketKey:`audio`},{facetType:`creator`,bucketKey:`__QUERY`}]}],$g={"written work":Jg,literature:Jg,book:Jg,novel:Jg,filmmaker:Yg,director:Yg,author:Xg,writer:Xg,novelist:Xg,essayist:Xg,poet:Xg,"visual artist":Zg,"graphic artist":Zg,photographer:Zg,painter:Zg,singer:Qg,songwriter:Qg,musician:Qg,composer:Qg,pianist:Qg},e_=class{constructor(){this.WIKIDATA_BASE_URL=`https://www.wikidata.org/w/api.php`,this.WIKIDATA_DEFAULT_ARGS=`?action=wbsearchentities&format=json&language=en&uselang=en&origin=*&type=item&limit=5`}getWikidataURL(e){let t=encodeURIComponent(e);return`${this.WIKIDATA_BASE_URL}${this.WIKIDATA_DEFAULT_ARGS}&search=${t}`}replaceQueryPlaceholders(e,t){return e.map(e=>({label:e.label?.replace(`__QUERY`,t),facets:e.facets.map(e=>{let n={...e,bucketKey:e.bucketKey.replace(`__QUERY`,t.toLowerCase())};return e.displayText&&(n.displayText=n.displayText?.replace(`__QUERY`,t)),n})}))}async getRecommendedFacets(e){let t=[];try{let n=this.getWikidataURL(e),r=await(await fetch(n)).json();for(let[e,n]of Object.entries($g))if(RegExp(`\\b${e}\\b`).test(r.search[0]?.description)){let e=r.search[0].label;t.push(...this.replaceQueryPlaceholders(n,e))}return t}catch(e){return console.warn(e),[]}}},t_=class e{static{this.DEFAULT_HEURISTICS=[qg,e_,zg]}async getRecommendedFacets(t,n=e.DEFAULT_HEURISTICS){let r=n.map(e=>new e().getRecommendedFacets(t));return Rg((await Promise.all(r)).flat())}},n_=window.location&&(window.location.hostname===`localhost`||window.location.host.match(/^(www|cat)-[a-z0-9]+\.archive\.org$/)||window.location.host.match(/\.code\.archive\.org$/)||window.location.host.match(/\.dev\.archive\.org$/)||window.location.host.match(/^ia-petabox-/)||window.location.host.match(/^local\.archive\.org/)||window.location.host.match(/^internetarchive\.github\.io$/))?console.log.bind(console):()=>{},r_=T`
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path
...
`;function a_(e){return e&&e.charAt(0).toLocaleUpperCase()+e.slice(1)}var o_=class extends O{constructor(...e){super(...e),this.selected=!1}render(){if(!this.facetInfo)return D;let e=this.facetInfo.facets.length===1,t=this.facetInfo.facets[0],n=a_((this.labelPrefix?`${this.labelPrefix} `:``)+(this.facetInfo.label??t.displayText??t.bucketKey));if(!n)return D;let r=e&&t.facetType===`mediatype`?Zo[t.bucketKey].icon:D;return T`
      <a
      ...
      >
        ${r} ${n}
        ${this.selected?T`<span class="unselect-button">${i_}</span>`:D}
      </a>
    ...
    `}};B([A({type:Object})],o_.prototype,`facetInfo`,void 0),B([A({type:String})],o_.prototype,`labelPrefix`,void 0),B([A({type:Boolean})],o_.prototype,`selected`,void 0),o_=B([k(`smart-facet-button`)],o_);var s_=class extends O{render(){if(!this.facetInfo||!this.activeFacetRef||this.facetInfo.length===0)return D;let e=this.activeFacetRef.displayText??this.activeFacetRef.bucketKey;return e?T`
    ...
    `}};B([A({type:Array})],s_.prototype,`facetInfo`,void 0),B([A({type:String})],s_.prototype,`labelPrefix`,void 0),B([A({type:Object})],s_.prototype,`activeFacetRef`,void 0),B([M(`ia-dropdown`)],s_.prototype,`dropdown`,void 0),s_=B([k(`smart-facet-dropdown`)],s_);var c_={collection:`Collection: `,creator:`By: `,subject:`About: `};function l_(e){return e.charAt(0).toUpperCase()+e.slice(1)}var u_=class extends O{constructor(...e){super(...e),this.filterToggleShown=!1,this.filterToggleActive=!1,this.heuristicRecs=[],this.smartFacets=[]}render(){if(!this.query)return D;let e=!!this.label&&this.smartFacets.length>0;return T`
    ...
    `}willUpdate(e){let t=!1;e.has(`query`)&&(n_(`query change`,e.get(`query`),this.query),this.lastAggregations=void 0,t=!0),e.has(`aggregations`)&&!this.lastAggregations&&this.aggregations&&Object.keys(this.aggregations).length>0&&(n_(`aggs change`,e.get(`aggregations`),this.aggregations),this.lastAggregations=this.aggregations,t=!0),t&&(n_(`should update smart facets, doing so...`),this.updateSmartFacets())}refresh(){this.lastAggregations=this.aggregations,this.updateSmartFacets()}deselectAll(){for(let e of this.smartFacets)for(let t of e)t.selected=!1;this.requestUpdate()}async updateSmartFacets(){n_(`updating smart facets`),this.query&&(this.heuristicRecs=await new t_().getRecommendedFacets(this.query),n_(`heuristic recs are`,this.heuristicRecs),this.smartFacets=Rg(this.facetsToDisplay),n_(`smart facets are`,this.smartFacets))}makeSmartFacet(e){return e.length===0?D:e.length===1?this.smartFacetButton(e[0]):this.smartFacetDropdown(e)}smartFacetButton(e){return T`
      <smart-facet-button
        .facetInfo=${e}
        .labelPrefix=${c_[e.facets[0].facetType]}
    ...
    `}smartFacetDropdown(e){return T`
      <smart-facet-dropdown
        .facetInfo=${e}
        .labelPrefix=${c_[e[0].facets[0].facetType]}
    ...
    </infinite-scroller>`}get infiniteScrollerClasses(){return ar({[this.displayMode??``]:!!this.displayMode,hidden:!!this.placeholderType})}get sortFilterBarTemplate(){if(this.suppressSortBar)return D;let e=Yi;return this.withinCollection?.startsWith(`fav-`)||this.profileElement===`favorites`?e=Xi:!this.withinCollection&&this.searchType===x.TV&&(e=Zi),e.relevance=this.isRelevanceSortAvailable,T`
      <sort-filter-bar
    ...
    `}async tvDropdownToggled(e){if(e.detail&&!this.tvMapsPopulated){this.tvMapsLoading=!0,this.tvMapsErrored=!1;try{await this.dataSource.populateTVChannelMaps(),this.tvMapsPopulated=!0}catch{this.tvMapsErrored=!0}this.tvMapsLoading=!1}}async networksDropdownChanged(){let e=this.selectedTVNetwork,t=this.tvNetworksDropdown.selectedOption?.text;this.selectedTVNetwork=t??void 0;let n=this.dataSource.tvChannelMaps.channelToNetwork.entries();for(let[t,r]of n)if(r===e){let e={key:t.toLowerCase(),count:0,state:`none`};this.selectedFacets=Aa(this.selectedFacets,`creator`,e,!0)}else if(r===this.selectedTVNetwork){let e={key:t.toLowerCase(),count:0,state:`selected`};this.selectedFacets=Aa(this.selectedFacets,`creator`,e)}}async showsDropdownChanged(){let e=this.selectedTVShow,t=this.tvShowsDropdown.selectedOption?.text;if(this.selectedTVShow=t??void 0,e!==void 0){let t={key:e,count:0,state:`none`};this.selectedFacets=Aa(this.selectedFacets,`program`,t,!0)}if(this.selectedTVShow){let e={key:this.selectedTVShow,count:0,state:`selected`};this.selectedFacets=Aa(this.selectedFacets,`program`,e)}}get tvDropdownFiltersTemplate(){if(this.searchType!==x.TV)return D;let{channelToNetwork:e,programToChannels:t}=this.dataSource.tvChannelMaps,n=e?[...new Set(e.values())]:[],r=t?[...t.entries()]:[];e&&this.selectedTVNetwork&&(r=r.filter(([,t])=>Object.keys(t).some(t=>e.get(t)===this.selectedTVNetwork)));let i=N(`Filter by Network`),a=N(`Filter by Show`),o=r.map(([e])=>e),s=T`
  ...
  `}};B([j()],d_.prototype,`toggleSlots`,void 0),B([j()],d_.prototype,`currentPage`,void 0),B([j()],d_.prototype,`searchQuery`,void 0),B([j()],d_.prototype,`withinCollection`,void 0),B([j()],d_.prototype,`cellWidth`,void 0),B([j()],d_.prototype,`cellHeight`,void 0),B([j()],d_.prototype,`rowGap`,void 0),B([j()],d_.prototype,`colGap`,void 0),B([j()],d_.prototype,`suppressFacets`,void 0),B([j()],d_.prototype,`lazyLoadFacets`,void 0),B([j()],d_.prototype,`loggedIn`,void 0),B([j()],d_.prototype,`searchType`,void 0),B([A({type:Object,reflect:!1})],d_.prototype,`latestAction`,void 0),B([M(`#base-query-field`)],d_.prototype,`baseQueryField`,void 0),B([M(`#base-collection-field`)],d_.prototype,`baseCollectionField`,void 0),B([M(`#page-number-input`)],d_.prototype,`pageNumberInput`,void 0),B([M(`collection-browser`)],d_.prototype,`collectionBrowser`,void 0),B([M(`modal-manager`)],d_.prototype,`modalManager`,void 0),d_=B([k(`app-root`)],d_);