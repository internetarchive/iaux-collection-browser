...
`;let si=class extends O{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1,this.isCompactTile=!1}render(){return p`<div class="icon-overlay ${this.getClass}">
      ${this.iconDisplay}
    </div>`}get getClass(){return this.isCompactTile?"list-compact":"list-detail"}get iconDisplay(){return this.loginRequired&&!this.loggedIn?p`${vo}`:p`${po}`}static get styles(){return y`
      :host {
        position: absolute;
        top: 50%;
        left: 50%;
    ...
    `}get iconDisplay(){return this.loginRequired&&!this.loggedIn?p`${vo}`:p`${po}`}get textDisplay(){return this.loginRequired&&!this.loggedIn?p`Log in to view this item`:p`Content may be inappropriate`}static get styles(){return y`
      :host {
        align-items: center;
        display: flex;
      }
