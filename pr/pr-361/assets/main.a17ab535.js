...
`;let hr=class extends O{constructor(){super(...arguments),this.config=new cr}render(){return c`
    ...
    `}static get styles(){const e=m`var(--modalLogoSize, 6.5rem)`,t=m`var(--processingImageSize, 7.5rem)`,i=m`var(--modalCornerRadius, 1rem)`,o=m`var(--modalBorder, 2px solid black)`,a=m`var(--modalBottomMargin, 2.5rem)`,s=m`var(--modalTopMargin, 5rem)`,n=m`var(--modalHeaderBottomPadding, 0.5em)`,d=m`var(--modalBottomPadding, 2rem)`,p=m`var(--modalScrollOffset, 5px)`,u=m`var(--modalTitleFontSize, 1.8rem)`,f=m`var(--modalSubtitleFontSize, 1.4rem)`,g=m`var(--modalHeadlineFontSize, 1.6rem)`,w=m`var(--modalMessageFontSize, 1.4rem)`,_=m`var(--modalTitleLineHeight, normal)`,S=m`var(--modalSubtitleLineHeight, normal)`,A=m`var(--modalHeadlineLineHeight, normal)`,H=m`var(--modalMessageLineHeight, normal)`;return m`
      .processing-logo {
        margin: auto;
        width: ${t};
        height: ${t};
...
`,pr;let Nt=pr=class extends O{render(){return c`${this.facetRowTemplate}`}get facetRowTemplate(){var e,t,i,o;const{bucket:a,facetType:s}=this;if(!a||!s)return y;const n=`${s}:${a.key}-show-only`,d=`${s}:${a.key}-negative`,p=s!=="collection"?c`${(e=a.displayText)!==null&&e!==void 0?e:a.key}`:c`<a href="/details/${a.key}">
          ...
          </a> `,u=a.state==="hidden",f=a.state==="selected",g=`${s}: ${(o=a.displayText)!==null&&o!==void 0?o:a.key}`,w=f?`Show all ${s}s`:`Only show ${g}`,_=`Hide ${g}`,S=`Unhide ${g}`,A=u?S:_,H=`${g}, ${a.count} results`;return c`
    ...
    `}get loaderTemplate(){return c`<div class="facets-loader">
      <ia-activity-indicator .mode=${"processing"}></ia-activity-indicator>
        ...
        </div> `:y}sortFacetAggregation(e){this.sortedBy=e,this.dispatchEvent(new CustomEvent("sortedFacets",{detail:this.sortedBy}))}get getModalHeaderTemplate(){const t=jo[this.facetKey]===te.COUNT?"left":"right";return c`<span class="sr-only">More facets for:</span>
      <span class="title">
    ...
    `}applySearchFacetsClicked(){var e,t;const i=new CustomEvent("facetsChanged",{detail:this.selectedFacets,bubbles:!0,composed:!0});this.dispatchEvent(i),(e=this.modalManager)===null||e===void 0||e.closeModal(),(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:Le.default,action:`${oe.applyMoreFacetsModal}`,label:`${this.facetKey}`})}cancelClick(){var e,t;(e=this.modalManager)===null||e===void 0||e.closeModal(),(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:Le.default,action:oe.closeMoreFacetsModal,label:`${this.facetKey}`})}static get styles(){const e=m`var(--primaryButtonBGColor, #194880)`;return[We,m`
      ...
      `]}};l([h({type:String})],X.prototype,"facetKey",void 0);l([h({type:String})],X.prototype,"facetAggregationKey",void 0);l([h({type:String})],X.prototype,"query",void 0);l([h({type:Object})],X.prototype,"filterMap",void 0);l([h({type:Object})],X.prototype,"modalManager",void 0);l([h({type:Object})],X.prototype,"searchService",void 0);l([h({type:String})],X.prototype,"searchType",void 0);l([h({type:String})],X.prototype,"withinCollection",void 0);l([h({type:String})],X.prototype,"withinProfile",void 0);l([h({type:String})],X.prototype,"profileElement",void 0);l([h({type:Object})],X.prototype,"collectionTitles",void 0);l([h({type:Object})],X.prototype,"selectedFacets",void 0);l([h({type:String})],X.prototype,"sortedBy",void 0);l([h({type:Object,attribute:!1})],X.prototype,"analyticsHandler",void 0);l([z()],X.prototype,"aggregations",void 0);l([z()],X.prototype,"facetGroup",void 0);l([z()],X.prototype,"facetGroupTitle",void 0);l([z()],X.prototype,"pageNumber",void 0);l([z()],X.prototype,"facetsLoading",void 0);l([z()],X.prototype,"paginationSize",void 0);l([z()],X.prototype,"facetsType",void 0);X=l([L("more-facets-content")],X);let Ka=class extends O{render(){return c`
      <div id="row">
    ...
    `}connectedCallback(){var e;(e=super.connectedCallback)===null||e===void 0||e.call(this),this.setupEscapeListener()}disconnectedCallback(){var e;(e=super.disconnectedCallback)===null||e===void 0||e.call(this),this.removeEscapeListener()}setupEscapeListener(){document.addEventListener("keydown",this.boundEscapeListener)}removeEscapeListener(){document.removeEventListener("keydown",this.boundEscapeListener)}histogramDateRangeUpdated(e){this.minSelectedDate=e.detail.minDate,this.maxSelectedDate=e.detail.maxDate}applyBtnClicked(){var e;const t=new CustomEvent("histogramDateRangeApplied",{detail:{minDate:this.minSelectedDate,maxDate:this.maxSelectedDate}});this.dispatchEvent(t),this.closeModal(),(e=this.analyticsHandler)===null||e===void 0||e.sendEvent({category:Le.default,action:oe.histogramChangedFromModal,label:window.location.href})}closeModal(){this.modalManager&&(this.modalManager.closeModal(),this.dispatchEvent(new CustomEvent("modalClosed")))}static get styles(){return m`
      #container {
        display: flex;
        justify-content: center;
    ...
    `}partOfCollectionClicked(e){var t;(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:Le.default,action:oe.partOfCollectionClicked,label:e.target.dataset.id})}showDatePickerModal(){var e,t,i;const{fullYearsHistogramAggregation:o}=this,a=o==null?void 0:o.first_bucket_key,s=o==null?void 0:o.last_bucket_key,n=o==null?void 0:o.buckets,p=c`
    ...
    `}searchMoreFacetsLink(e){if(!this.moreLinksVisible||e.key==="lending"||Object.keys(e.buckets).length<this.allowedFacetCount)return y;const t=jo[e.key];return c`<button
      class="more-link"
      @click=${()=>{var i;this.showMoreFacetsModal(e,t),(i=this.analyticsHandler)===null||i===void 0||i.sendEvent({category:Le.default,action:oe.showMoreFacetsModal,label:e.key}),this.dispatchEvent(new CustomEvent("showMoreFacets",{detail:e.key}))}}
    >
      More...
    ...
    `}static get styles(){return[We,m`
      ...
      `]}};l([h({type:Object})],U.prototype,"searchService",void 0);l([h({type:String})],U.prototype,"searchType",void 0);l([h({type:Object})],U.prototype,"aggregations",void 0);l([h({type:Object})],U.prototype,"fullYearsHistogramAggregation",void 0);l([h({type:String})],U.prototype,"minSelectedDate",void 0);l([h({type:String})],U.prototype,"maxSelectedDate",void 0);l([h({type:Boolean})],U.prototype,"moreLinksVisible",void 0);l([h({type:Boolean})],U.prototype,"facetsLoading",void 0);l([h({type:Boolean})],U.prototype,"fullYearAggregationLoading",void 0);l([h({type:Object})],U.prototype,"selectedFacets",void 0);l([h({type:Boolean})],U.prototype,"collapsableFacets",void 0);l([h({type:Number})],U.prototype,"contentWidth",void 0);l([h({type:Boolean})],U.prototype,"showHistogramDatePicker",void 0);l([h({type:Boolean})],U.prototype,"allowExpandingDatePicker",void 0);l([h({type:String})],U.prototype,"query",void 0);l([h({type:String})],U.prototype,"withinCollection",void 0);l([h({type:String})],U.prototype,"withinProfile",void 0);l([h({type:String})],U.prototype,"profileElement",void 0);l([h({type:Array})],U.prototype,"parentCollections",void 0);l([h({type:Object})],U.prototype,"filterMap",void 0);l([h({type:String})],U.prototype,"baseNavigationUrl",void 0);l([h({type:String})],U.prototype,"collectionPagePath",void 0);l([h({type:Boolean})],U.prototype,"isManageView",void 0);l([h({type:Object,attribute:!1})],U.prototype,"modalManager",void 0);l([h({type:Object,attribute:!1})],U.prototype,"resizeObserver",void 0);l([h({type:Object,attribute:!1})],U.prototype,"featureFeedbackService",void 0);l([h({type:Object,attribute:!1})],U.prototype,"recaptchaManager",void 0);l([h({type:Object,attribute:!1})],U.prototype,"analyticsHandler",void 0);l([h({type:Object,attribute:!1})],U.prototype,"collectionTitles",void 0);l([z()],U.prototype,"openFacets",void 0);U=l([L("collection-facets")],U);let Xa=class extends O{render(){return c`
      <div class="lds-ring">
        <div></div>
        <div></div>
        <div></div>
