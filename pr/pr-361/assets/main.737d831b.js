...
`;var Qo;(function(r){r[r.bytes=0]="bytes",r[r.kilobytes=1]="kilobytes",r[r.megabytes=2]="megabytes",r[r.gigabytes=3]="gigabytes",r[r.terabytes=4]="terabytes",r[r.petabytes=5]="petabytes",r[r.exabytes=6]="exabytes",r[r.zettabytes=7]="zettabytes",r[r.yottabytes=8]="yottabytes"})(Qo||(Qo={}));function Zl(r,e,t=" "){let i=r;if(i===void 0)return y;let o=0;for(;i>1024;)i/=1024,o+=1;const a=10**e;i=Math.round(i*a)/a;let s=Qo[o];return s=i===1?s.slice(0,-1):s,`${i.toLocaleString()+t+s}`}const Jl=m`var(--tileBackgroundColor, #ffffff)`,en=m`var(--tileCornerRadius, 4px)`,Xi=m`
...
`;let di=class extends O{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1,this.isCompactTile=!1}render(){return c`<div class="icon-overlay ${this.getClass}">
    ...
    >`}get getSizeTemplate(){var e,t;const i=(t=(e=this.model)===null||e===void 0?void 0:e.collectionSize)!==null&&t!==void 0?t:0;return i?c`<span id="item-size">${Zl(i,1)}</span>`:""}get infoButtonTemplate(){return this.showInfoButton?c`<button class="info-button" @click=${this.infoButtonPressed}>
        ...
        </button>`:y}infoButtonPressed(e){e.preventDefault();const t=new CustomEvent("infoButtonPressed",{detail:{x:e.clientX,y:e.clientY}});this.dispatchEvent(t)}static get styles(){const e=m`var(--tileBorderColor, #555555)`,t=m`var(--tileBackgroundColor, #666666)`,i=m`#fff`;return[Xi,m`
        .container {
          background-color: ${t};
          border: 1px solid ${e};
        }
 ...
 */function*Pi(r,e){const t=typeof e=="function";if(r!==void 0){let i=-1;for(const o of r)i>-1&&(yield t?e(i):e),i++,yield o}}let Hi=class extends O{constructor(){super(...arguments),this.snippets=[],this.viewSize="desktop"}render(){var e;return!((e=this.snippets)===null||e===void 0)&&e.length?c`
    ...
    `}};l([h({type:Array})],Hi.prototype,"snippets",void 0);l([h({type:String})],Hi.prototype,"viewSize",void 0);Hi=l([L("text-snippet-block")],Hi);const rn=m`
  .drop-shadow {
    overflow: hidden;
    height: 100%;
  }
...
`;function xn(r,e){let t=1;return r>=1e9?t=1e9:r>=1e6?t=1e6:r>=1e3&&e==="short"&&(t=1e3),t}function _n(r=0,e){const t=r/e,i=t<10;let o=0;return i?o=Math.round((t+Number.EPSILON)*10)/10:o=Math.round(t),o}function $n(r,e,t,i){switch(e){case 1e9:return P(t==="short"?nt`${r}B`:nt`${r} billion`);case 1e6:return P(t==="short"?nt`${r}M`:nt`${r} million`);case 1e3:return P(t==="short"?nt`${r}K`:nt`${r} thousand`);default:return new Intl.NumberFormat(i).format(r)}}function ri(r,e="long",t="short",i="en-US"){const o=r!=null?r:-1;if(o<0)return"";const a=xn(o,e),s=_n(o,a);return $n(s,a,t,i)}let Xe=class extends O{render(){var e,t,i,o,a;const s=ri(this.favCount,"short","short"),n=ri(this.commentCount,"short","short"),d=this.mediatype==="account"?`${(e=this.itemCount)!==null&&e!==void 0?e:0} uploads`:`${(t=this.viewCount)!==null&&t!==void 0?t:0} ${(i=this.viewLabel)!==null&&i!==void 0?i:"all-time views"}`;return c`
    ...
    `}get isSortedByDate(){var e;return["date","reviewdate","addeddate","publicdate"].includes((e=this.sortParam)===null||e===void 0?void 0:e.field)}get hasSnippets(){var e,t;return!!(!((t=(e=this.model)===null||e===void 0?void 0:e.snippets)===null||t===void 0)&&t.length)}infoButtonPressed(e){e.preventDefault();const t=new CustomEvent("infoButtonPressed",{detail:{x:e.clientX,y:e.clientY}});this.dispatchEvent(t)}static get styles(){const e=m`var(--tileBorderColor, #dddddd)`;return[Xi,m`
        a:link {
          text-decoration: none;
          color: var(--ia-theme-link-color, #4b64ff);
        }
    ...
    >
          ...
          &#9432;
          <span class="sr-only">${P("More info")}</span>
        </button>`:y}infoButtonPressed(e){e.preventDefault();const t=new CustomEvent("infoButtonPressed",{detail:{x:e.clientX,y:e.clientY}});this.dispatchEvent(t)}static get styles(){const e=m`var(--tileBorderColor, #dddddd)`;return[Xi,m`
        .container {
          border: 1px solid ${e};
        }
    ...
    `}get getTitleTemplate(){var e;return c`<div id="title">
      <h4 class="truncated">${(e=this.model)===null||e===void 0?void 0:e.title}</h4>
    </div>`}static get styles(){const e=m`var(--tileBorderColor, #555555)`,t=m`var(--tileBackgroundColor, #666666)`,i=m`#fff`;return[Xi,m`
        .container {
          background-color: ${t};
          border: 1px solid ${e};
        }
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Na(r,e,t){return r?e():t==null?void 0:t()}const Ua=m`var(--white, #fff)`,kd=m`var(--primaryDisableCTAFill, #767676)`,Td=m`var(--secondaryCTABorder, #999)`,Ed=m`var(--primaryCTAFill, #194880)`,Do=m`var(--primaryCTAFillRGB, 25, 72, 128)`,Md=m`var(--primaryCTABorder, #c5d1df)`,zd=m`var(--primaryErrorCTAFill, #d9534f)`,Lo=m`var(--primaryErrorCTAFillRGB, 229, 28, 38)`,Pd=m`var(--primaryErrorCTABorder, #d43f3a)`,Ad=m`var(--secondaryCTAFill, #333)`,Bo=m`var(--secondaryCTAFillRGB, 51, 51, 51)`,Dd=m`var(--primaryCTABorder, #979797)`,Ld=m`#ee8950`,Bd=m`#ec7939`;var Rd=m`
  .ia-button {
    min-height: 3rem;
    cursor: pointer;
    color: ${Ua};
