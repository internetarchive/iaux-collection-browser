var Lo=Object.defineProperty,Fo=Object.defineProperties;var Oo=Object.getOwnPropertyDescriptors;var ir=Object.getOwnPropertySymbols;var Io=Object.prototype.hasOwnProperty,Po=Object.prototype.propertyIsEnumerable;var ar=(r,e,t)=>e in r?Lo(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t,ve=(r,e)=>{for(var t in e||(e={}))Io.call(e,t)&&ar(r,t,e[t]);if(ir)for(var t of ir(e))Po.call(e,t)&&ar(r,t,e[t]);return r},ft=(r,e)=>Fo(r,Oo(e));const No=function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))i(a);new MutationObserver(a=>{for(const o of a)if(o.type==="childList")for(const s of o.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function t(a){const o={};return a.integrity&&(o.integrity=a.integrity),a.referrerpolicy&&(o.referrerPolicy=a.referrerpolicy),a.crossorigin==="use-credentials"?o.credentials="include":a.crossorigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(a){if(a.ep)return;a.ep=!0;const o=t(a);fetch(a.href,o)}};No();function n(r,e,t,i){var a=arguments.length,o=a<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(r,e,t,i);else for(var l=r.length-1;l>=0;l--)(s=r[l])&&(o=(a<3?s(o):a>3?s(e,t,o):s(e,t))||o);return a>3&&o&&Object.defineProperty(e,t,o),o}function Ro(r,e,t,i){function a(o){return o instanceof t?o:new t(function(s){s(o)})}return new(t||(t=Promise))(function(o,s){function l(p){try{c(i.next(p))}catch(v){s(v)}}function d(p){try{c(i.throw(p))}catch(v){s(v)}}function c(p){p.done?o(p.value):a(p.value).then(l,d)}c((i=i.apply(r,e||[])).next())})}class Bo{constructor(e){var t,i,a,o;this.ARCHIVE_ANALYTICS_VERSION=2,this.DEFAULT_SERVICE="ao_2",this.NO_SAMPLING_SERVICE="ao_no_sampling",this.DEFAULT_IMAGE_URL="https://analytics.archive.org/0.gif",this.defaultService=(t=e==null?void 0:e.defaultService)!==null&&t!==void 0?t:this.DEFAULT_SERVICE,this.imageUrl=(i=e==null?void 0:e.imageUrl)!==null&&i!==void 0?i:this.DEFAULT_IMAGE_URL,this.imageContainer=(a=e==null?void 0:e.imageContainer)!==null&&a!==void 0?a:document.body,this.requireImagePing=(o=e==null?void 0:e.requireImagePing)!==null&&o!==void 0?o:!1}sendPing(e){const t=this.generateTrackingUrl(e).toString();if(this.requireImagePing){this.sendPingViaImage(t);return}const i=navigator.sendBeacon&&navigator.sendBeacon.bind(navigator);try{i(t)}catch{this.sendPingViaImage(t)}}sendEvent(e){const t=e.label&&e.label.trim().length>0?e.label:window.location.pathname,i=ve({kind:"event",ec:e.category,ea:e.action,el:t,cache_bust:Math.random()},e.eventConfiguration);this.sendPing(i)}sendEventNoSampling(e){const t=e.eventConfiguration||{};t.service=this.NO_SAMPLING_SERVICE;const i=e;i.eventConfiguration=t,this.sendEvent(i)}sendPingViaImage(e){const t=new Image(1,1);t.src=e,t.alt="",this.imageContainer.appendChild(t)}generateTrackingUrl(e){var t;const i=e!=null?e:{};i.service=(t=i.service)!==null&&t!==void 0?t:this.defaultService;const a=new URL(this.imageUrl),o=Object.keys(i);return o.forEach(s=>{const l=i[s];a.searchParams.append(s,l)}),a.searchParams.append("version",`${this.ARCHIVE_ANALYTICS_VERSION}`),a.searchParams.append("count",`${o.length+2}`),a}}function g(r){let e,t,i;return typeof r=="object"?(e=r.hashFunction,t=r.expiring,i=r.tags):e=r,(a,o,s)=>{if(s.value!=null)s.value=rr(s.value,e,t,i);else if(s.get!=null)s.get=rr(s.get,e,t,i);else throw"Only put a Memoize() decorator on a method or get accessor."}}const Gi=new Map;function rr(r,e,t=0,i){const a=Symbol("__memoized_map__");return function(...o){let s;this.hasOwnProperty(a)||Object.defineProperty(this,a,{configurable:!1,enumerable:!1,writable:!1,value:new Map});let l=this[a];if(Array.isArray(i))for(const d of i)Gi.has(d)?Gi.get(d).push(l):Gi.set(d,[l]);if(e||o.length>0||t>0){let d;e===!0?d=o.map(v=>v.toString()).join("!"):e?d=e.apply(this,o):d=o[0];const c=`${d}__timestamp`;let p=!1;if(t>0)if(!l.has(c))p=!0;else{let v=l.get(c);p=Date.now()-v>t}l.has(d)&&!p?s=l.get(d):(s=r.apply(this,o),l.set(d,s),t>0&&l.set(c,Date.now()))}else{const d=this;l.has(d)?s=l.get(d):(s=r.apply(this,o),l.set(d,s))}return s}}class ca{parseValue(e){return typeof e=="string"&&(e==="false"||e==="0")?!1:Boolean(e)}}ca.shared=new ca;class wi{parseValue(e){if(typeof e=="number")return e;if(typeof e=="boolean")return;const t=parseFloat(e);if(!Number.isNaN(t))return t}}wi.shared=new wi;class ha{parseValue(e){return wi.shared.parseValue(e)}}ha.shared=new ha;class ua{parseValue(e){return this.parseJSDate(e)||this.parseBracketDate(e)}parseBracketDate(e){if(typeof e!="string")return;const t=e.match(/\[([0-9]{4})\]/);if(!(!t||t.length<2))return this.parseJSDate(t[1])}parseJSDate(e){if(typeof e!="string")return;let t=e;t.match(/^[0-9]{4}-[0-9]{2}-[0-9]{2}\s{1}[0-9]{2}:[0-9]{2}:[0-9]{2}$/)&&(t=t.replace(" ","T"));const i=Date.parse(t);if(Number.isNaN(i))return;let a=new Date(t);return(t.indexOf("Z")>-1||t.indexOf("+")>-1||t.match(/^[0-9]{4}$/)||t.match(/^[0-9]{4}-[0-9]{2}-[0-9]{2}$/)||t.match(/^.*?-[0-9]{2}:[0-9]{2}$/)||t.match(/^.*?-[0-9]{4}$/))&&(a=new Date(a.getTime()+a.getTimezoneOffset()*1e3*60)),a}}ua.shared=new ua;class pa{parseValue(e){if(typeof e=="number")return e;if(typeof e=="boolean")return;const t=e.split(":");let i;return t.length===1?i=this.parseNumberFormat(t[0]):i=this.parseColonSeparatedFormat(t),i}parseNumberFormat(e){let t=parseFloat(e);return Number.isNaN(t)&&(t=void 0),t}parseColonSeparatedFormat(e){let t=!1;const i=e.map((a,o)=>{const s=parseFloat(a);if(Number.isNaN(s))return t=!0,0;const l=e.length-1-o,d=60**l;return s*Math.floor(d)}).reduce((a,o)=>a+o,0);return t?void 0:i}}pa.shared=new pa;class ma{parseValue(e){if(typeof e=="string")return e}}ma.shared=new ma;class Ho{constructor(e,t){this.separators=[";",","],this.parser=e,t&&t.separators&&(this.separators=t.separators)}parseValue(e){const t=String(e);let i=[];for(const a of this.separators)if(i=t.split(a),i.length>1)break;return this.parseListValues(i)}parseListValues(e){const i=e.map(o=>o.trim()).map(o=>this.parser.parseValue(o)),a=[];return i.forEach(o=>{o!==void 0&&a.push(o)}),a}}class va{parseValue(e){if(typeof e=="string")return e}}va.shared=new va;class xi{parseValue(e){return String(e)}}xi.shared=new xi;class xe{constructor(e,t){this.parser=e,this.rawValue=t}get values(){return this.parseRawValue()}get value(){return this.values[0]}parseRawValue(){if(this.rawValue===void 0)return[];const e=Array.isArray(this.rawValue)?this.rawValue:[this.rawValue],t=[];return e.forEach(i=>{const a=this.parser.parseValue(i);Array.isArray(a)?t.push(...a):a!==void 0&&t.push(a)}),t}}n([g()],xe.prototype,"values",null);n([g()],xe.prototype,"value",null);class bt extends xe{constructor(e){super(ca.shared,e)}}class ae extends xe{constructor(e){super(ua.shared,e)}}class Qi extends xe{constructor(e){super(pa.shared,e)}}class j extends xe{constructor(e){super(wi.shared,e)}}class z extends xe{constructor(e){super(xi.shared,e)}}class Uo extends xe{constructor(e){super(va.shared,e)}}class _i extends xe{constructor(e){super(ha.shared,e)}}class za extends xe{constructor(e){super(ma.shared,e)}}class jo extends xe{constructor(e,t){super(t,e)}}class Wo extends jo{constructor(e){const t=new Ho(xi.shared);super(e,t)}}class k{constructor(e){this.rawMetadata=e}get identifier(){var e;return(e=this.rawMetadata)===null||e===void 0?void 0:e.identifier}get addeddate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.addeddate?new ae(this.rawMetadata.addeddate):void 0}get audio_codec(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.audio_codec?new z(this.rawMetadata.audio_codec):void 0}get audio_sample_rate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.audio_sample_rate?new j(this.rawMetadata.audio_sample_rate):void 0}get avg_rating(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.avg_rating?new j(this.rawMetadata.avg_rating):void 0}get collection(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.collection?new z(this.rawMetadata.collection):void 0}get collections_raw(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.collections_raw?new z(this.rawMetadata.collections_raw):void 0}get collection_size(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.collection_size?new _i(this.rawMetadata.collection_size):void 0}get contributor(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.contributor?new z(this.rawMetadata.contributor):void 0}get coverage(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.coverage?new z(this.rawMetadata.coverage):void 0}get creator(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.creator?new z(this.rawMetadata.creator):void 0}get date(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.date?new ae(this.rawMetadata.date):void 0}get description(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.description?new z(this.rawMetadata.description):void 0}get downloads(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.downloads?new j(this.rawMetadata.downloads):void 0}get duration(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.duration?new Qi(this.rawMetadata.duration):void 0}get"external-identifier"(){var e,t;return!((e=this.rawMetadata)===null||e===void 0)&&e["external-identifier"]?new z((t=this.rawMetadata)===null||t===void 0?void 0:t["external-identifier"]):void 0}get files_count(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.files_count?new j(this.rawMetadata.files_count):void 0}get indexdate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.indexdate?new ae(this.rawMetadata.indexdate):void 0}get isbn(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.isbn?new z(this.rawMetadata.isbn):void 0}get issue(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.issue?new z(this.rawMetadata.issue):void 0}get item_count(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.item_count?new j(this.rawMetadata.item_count):void 0}get item_size(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.item_size?new _i(this.rawMetadata.item_size):void 0}get language(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.language?new z(this.rawMetadata.language):void 0}get length(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.length?new Qi(this.rawMetadata.length):void 0}get lineage(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.lineage?new z(this.rawMetadata.lineage):void 0}get month(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.month?new j(this.rawMetadata.month):void 0}get mediatype(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.mediatype?new za(this.rawMetadata.mediatype):void 0}get noindex(){var e;return((e=this.rawMetadata)===null||e===void 0?void 0:e.noindex)!=null?new bt(this.rawMetadata.noindex):void 0}get notes(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.notes?new z(this.rawMetadata.notes):void 0}get num_favorites(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.num_favorites?new j(this.rawMetadata.num_favorites):void 0}get num_reviews(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.num_reviews?new j(this.rawMetadata.num_reviews):void 0}get openlibrary_edition(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.openlibrary_edition?new z(this.rawMetadata.openlibrary_edition):void 0}get openlibrary_work(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.openlibrary_work?new z(this.rawMetadata.openlibrary_work):void 0}get page_progression(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.page_progression?new Uo(this.rawMetadata.page_progression):void 0}get partner(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.partner?new z(this.rawMetadata.partner):void 0}get ppi(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.ppi?new j(this.rawMetadata.ppi):void 0}get publicdate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.publicdate?new ae(this.rawMetadata.publicdate):void 0}get publisher(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.publisher?new z(this.rawMetadata.publisher):void 0}get reviewdate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.reviewdate?new ae(this.rawMetadata.reviewdate):void 0}get runtime(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.runtime?new Qi(this.rawMetadata.runtime):void 0}get scanner(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.scanner?new z(this.rawMetadata.scanner):void 0}get source(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.source?new z(this.rawMetadata.source):void 0}get start_localtime(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.start_localtime?new ae(this.rawMetadata.start_localtime):void 0}get start_time(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.start_time?new ae(this.rawMetadata.start_time):void 0}get stop_time(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.stop_time?new ae(this.rawMetadata.stop_time):void 0}get subject(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.subject?new Wo(this.rawMetadata.subject):void 0}get taper(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.taper?new z(this.rawMetadata.taper):void 0}get title(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.title?new z(this.rawMetadata.title):void 0}get transferer(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.transferer?new z(this.rawMetadata.transferer):void 0}get track(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.track?new j(this.rawMetadata.track):void 0}get type(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.type?new z(this.rawMetadata.type):void 0}get uploader(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.uploader?new z(this.rawMetadata.uploader):void 0}get utc_offset(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.utc_offset?new j(this.rawMetadata.utc_offset):void 0}get venue(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.venue?new z(this.rawMetadata.venue):void 0}get volume(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.volume?new z(this.rawMetadata.volume):void 0}get week(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.week?new j(this.rawMetadata.week):void 0}get year(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.year?new ae(this.rawMetadata.year):void 0}}n([g()],k.prototype,"addeddate",null);n([g()],k.prototype,"audio_codec",null);n([g()],k.prototype,"audio_sample_rate",null);n([g()],k.prototype,"avg_rating",null);n([g()],k.prototype,"collection",null);n([g()],k.prototype,"collections_raw",null);n([g()],k.prototype,"collection_size",null);n([g()],k.prototype,"contributor",null);n([g()],k.prototype,"coverage",null);n([g()],k.prototype,"creator",null);n([g()],k.prototype,"date",null);n([g()],k.prototype,"description",null);n([g()],k.prototype,"downloads",null);n([g()],k.prototype,"duration",null);n([g()],k.prototype,"external-identifier",null);n([g()],k.prototype,"files_count",null);n([g()],k.prototype,"indexdate",null);n([g()],k.prototype,"isbn",null);n([g()],k.prototype,"issue",null);n([g()],k.prototype,"item_count",null);n([g()],k.prototype,"item_size",null);n([g()],k.prototype,"language",null);n([g()],k.prototype,"length",null);n([g()],k.prototype,"lineage",null);n([g()],k.prototype,"month",null);n([g()],k.prototype,"mediatype",null);n([g()],k.prototype,"noindex",null);n([g()],k.prototype,"notes",null);n([g()],k.prototype,"num_favorites",null);n([g()],k.prototype,"num_reviews",null);n([g()],k.prototype,"openlibrary_edition",null);n([g()],k.prototype,"openlibrary_work",null);n([g()],k.prototype,"page_progression",null);n([g()],k.prototype,"partner",null);n([g()],k.prototype,"ppi",null);n([g()],k.prototype,"publicdate",null);n([g()],k.prototype,"publisher",null);n([g()],k.prototype,"reviewdate",null);n([g()],k.prototype,"runtime",null);n([g()],k.prototype,"scanner",null);n([g()],k.prototype,"source",null);n([g()],k.prototype,"start_localtime",null);n([g()],k.prototype,"start_time",null);n([g()],k.prototype,"stop_time",null);n([g()],k.prototype,"subject",null);n([g()],k.prototype,"taper",null);n([g()],k.prototype,"title",null);n([g()],k.prototype,"transferer",null);n([g()],k.prototype,"track",null);n([g()],k.prototype,"type",null);n([g()],k.prototype,"uploader",null);n([g()],k.prototype,"utc_offset",null);n([g()],k.prototype,"venue",null);n([g()],k.prototype,"volume",null);n([g()],k.prototype,"week",null);n([g()],k.prototype,"year",null);class P{constructor(e){this.rawMetadata=e}get identifier(){var e,t;return(t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.identifier}get addeddate(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.addeddate?new ae(this.rawMetadata.fields.addeddate):void 0}get avg_rating(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.avg_rating)!=null?new j(this.rawMetadata.fields.avg_rating):void 0}get collection(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.collection?new z(this.rawMetadata.fields.collection):void 0}get collection_files_count(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.collection_files_count)!=null?new j(this.rawMetadata.fields.collection_files_count):void 0}get collection_size(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.collection_size)!=null?new _i(this.rawMetadata.fields.collection_size):void 0}get creator(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.creator?new z(this.rawMetadata.fields.creator):void 0}get date(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.date?new ae(this.rawMetadata.fields.date):void 0}get description(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.description?new z(this.rawMetadata.fields.description):void 0}get downloads(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.downloads)!=null?new j(this.rawMetadata.fields.downloads):void 0}get files_count(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.files_count)!=null?new j(this.rawMetadata.fields.files_count):void 0}get genre(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.genre?new z(this.rawMetadata.fields.genre):void 0}get indexflag(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.indexflag?new z(this.rawMetadata.fields.indexflag):void 0}get issue(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.issue?new z(this.rawMetadata.fields.issue):void 0}get item_count(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.item_count)!=null?new j(this.rawMetadata.fields.item_count):void 0}get item_size(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.item_size)!=null?new _i(this.rawMetadata.fields.item_size):void 0}get language(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.language?new z(this.rawMetadata.fields.language):void 0}get lending___available_to_borrow(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.lending___available_to_borrow)!=null?new bt(this.rawMetadata.fields.lending___available_to_borrow):void 0}get lending___available_to_browse(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.lending___available_to_browse)!=null?new bt(this.rawMetadata.fields.lending___available_to_browse):void 0}get lending___available_to_waitlist(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.lending___available_to_waitlist)!=null?new bt(this.rawMetadata.fields.lending___available_to_waitlist):void 0}get lending___status(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.lending___status?new z(this.rawMetadata.fields.lending___status):void 0}get licenseurl(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.licenseurl?new z(this.rawMetadata.fields.licenseurl):void 0}get mediatype(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.mediatype?new za(this.rawMetadata.fields.mediatype):void 0}get month(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.month)!=null?new j(this.rawMetadata.fields.month):void 0}get noindex(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.noindex)!=null?new bt(this.rawMetadata.fields.noindex):void 0}get num_favorites(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.num_favorites)!=null?new j(this.rawMetadata.fields.num_favorites):void 0}get num_reviews(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.num_reviews)!=null?new j(this.rawMetadata.fields.num_reviews):void 0}get source(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.source?new z(this.rawMetadata.fields.source):void 0}get subject(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.subject?new z(this.rawMetadata.fields.subject):void 0}get title(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.title?new z(this.rawMetadata.fields.title):void 0}get type(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.type?new z(this.rawMetadata.fields.type):void 0}get volume(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.volume?new z(this.rawMetadata.fields.volume):void 0}get week(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.week)!=null?new j(this.rawMetadata.fields.week):void 0}get year(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.year)!=null?new j(this.rawMetadata.fields.year):void 0}}n([g()],P.prototype,"addeddate",null);n([g()],P.prototype,"avg_rating",null);n([g()],P.prototype,"collection",null);n([g()],P.prototype,"collection_files_count",null);n([g()],P.prototype,"collection_size",null);n([g()],P.prototype,"creator",null);n([g()],P.prototype,"date",null);n([g()],P.prototype,"description",null);n([g()],P.prototype,"downloads",null);n([g()],P.prototype,"files_count",null);n([g()],P.prototype,"genre",null);n([g()],P.prototype,"indexflag",null);n([g()],P.prototype,"issue",null);n([g()],P.prototype,"item_count",null);n([g()],P.prototype,"item_size",null);n([g()],P.prototype,"language",null);n([g()],P.prototype,"lending___available_to_borrow",null);n([g()],P.prototype,"lending___available_to_browse",null);n([g()],P.prototype,"lending___available_to_waitlist",null);n([g()],P.prototype,"lending___status",null);n([g()],P.prototype,"licenseurl",null);n([g()],P.prototype,"mediatype",null);n([g()],P.prototype,"month",null);n([g()],P.prototype,"noindex",null);n([g()],P.prototype,"num_favorites",null);n([g()],P.prototype,"num_reviews",null);n([g()],P.prototype,"source",null);n([g()],P.prototype,"subject",null);n([g()],P.prototype,"title",null);n([g()],P.prototype,"type",null);n([g()],P.prototype,"volume",null);n([g()],P.prototype,"week",null);n([g()],P.prototype,"year",null);class W{constructor(e){this.rawMetadata=e}get identifier(){var e,t;return(t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.identifier}get highlight(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.highlight)===null||t===void 0)&&t.text?new z(this.rawMetadata.highlight.text):void 0}get addeddate(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.addeddate?new ae(this.rawMetadata.fields.addeddate):void 0}get avg_rating(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.avg_rating)!=null?new j(this.rawMetadata.fields.avg_rating):void 0}get collection(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.collection?new z(this.rawMetadata.fields.collection):void 0}get created_on(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.created_on?new ae(this.rawMetadata.fields.created_on):void 0}get creator(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.creator?new z(this.rawMetadata.fields.creator):void 0}get date(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.date?new ae(this.rawMetadata.fields.date):void 0}get description(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.description?new z(this.rawMetadata.fields.description):void 0}get downloads(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.downloads)!=null?new j(this.rawMetadata.fields.downloads):void 0}get filename(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.filename?new z(this.rawMetadata.fields.filename):void 0}get file_basename(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.file_basename?new z(this.rawMetadata.fields.file_basename):void 0}get file_creation_mtime(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.file_creation_mtime)!=null?new j(this.rawMetadata.fields.file_creation_mtime):void 0}get issue(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.issue?new z(this.rawMetadata.fields.issue):void 0}get mediatype(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.mediatype?new za(this.rawMetadata.fields.mediatype):void 0}get page_num(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.page_num)!=null?new j(this.rawMetadata.fields.page_num):void 0}get publicdate(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.publicdate?new ae(this.rawMetadata.fields.publicdate):void 0}get result_in_subfile(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.result_in_subfile)!=null?new bt(this.rawMetadata.fields.result_in_subfile):void 0}get reviewdate(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.reviewdate?new ae(this.rawMetadata.fields.reviewdate):void 0}get source(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.source?new z(this.rawMetadata.fields.source):void 0}get subject(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.subject?new z(this.rawMetadata.fields.subject):void 0}get title(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.title?new z(this.rawMetadata.fields.title):void 0}get updated_on(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.updated_on?new ae(this.rawMetadata.fields.updated_on):void 0}get year(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.year)!=null?new j(this.rawMetadata.fields.year):void 0}get __href__(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.__href__?new z(this.rawMetadata.fields.__href__):void 0}}n([g()],W.prototype,"highlight",null);n([g()],W.prototype,"addeddate",null);n([g()],W.prototype,"avg_rating",null);n([g()],W.prototype,"collection",null);n([g()],W.prototype,"created_on",null);n([g()],W.prototype,"creator",null);n([g()],W.prototype,"date",null);n([g()],W.prototype,"description",null);n([g()],W.prototype,"downloads",null);n([g()],W.prototype,"filename",null);n([g()],W.prototype,"file_basename",null);n([g()],W.prototype,"file_creation_mtime",null);n([g()],W.prototype,"issue",null);n([g()],W.prototype,"mediatype",null);n([g()],W.prototype,"page_num",null);n([g()],W.prototype,"publicdate",null);n([g()],W.prototype,"result_in_subfile",null);n([g()],W.prototype,"reviewdate",null);n([g()],W.prototype,"source",null);n([g()],W.prototype,"subject",null);n([g()],W.prototype,"title",null);n([g()],W.prototype,"updated_on",null);n([g()],W.prototype,"year",null);n([g()],W.prototype,"__href__",null);var Ct;(function(r){r[r.COUNT=0]="COUNT",r[r.ALPHABETICAL=1]="ALPHABETICAL"})(Ct||(Ct={}));class Wr{constructor(e){this.buckets=e.buckets,this.doc_count_error_upper_bound=e.doc_count_error_upper_bound,this.sum_other_doc_count=e.sum_other_doc_count,this.first_bucket_key=e.first_bucket_key,this.last_bucket_key=e.last_bucket_key,this.number_buckets=e.number_buckets,this.interval=e.interval}getSortedBuckets(e){if(typeof this.buckets[0]=="number")return[...this.buckets];const t=new Intl.Collator;switch(e){case Ct.ALPHABETICAL:return[...this.buckets].sort((i,a)=>t.compare(i.key.toString(),a.key.toString()));case Ct.COUNT:default:return[...this.buckets]}}}n([g()],Wr.prototype,"getSortedBuckets",null);class Ta{constructor(e,t){var i,a,o,s,l,d,c;this.schema=t;const p=t==null?void 0:t.hit_type;this.totalResults=(a=(i=e==null?void 0:e.hits)===null||i===void 0?void 0:i.total)!==null&&a!==void 0?a:0,this.returnedCount=(s=(o=e==null?void 0:e.hits)===null||o===void 0?void 0:o.returned)!==null&&s!==void 0?s:0,this.results=(c=(d=(l=e==null?void 0:e.hits)===null||l===void 0?void 0:l.hits)===null||d===void 0?void 0:d.map(v=>Ta.createResult(p,v)))!==null&&c!==void 0?c:[],e!=null&&e.aggregations&&(this.aggregations=Object.entries(e.aggregations).reduce((v,[f,w])=>(v[f]=new Wr(w),v),{}))}static createResult(e,t){switch(e){case"item":return new P(t);case"text":return new W(t);default:return t}}}class Vo{constructor(e){this.clientParameters=e.client_parameters,this.finalizedParameters=e.finalized_parameters}}class Go{constructor(e){var t,i,a;this.rawResponse=e,this.request=new Vo(e.request),this.responseHeader=(t=e.response)===null||t===void 0?void 0:t.header,this.response=new Ta((i=e.response)===null||i===void 0?void 0:i.body,(a=e.response)===null||a===void 0?void 0:a.hit_schema)}}class Vr{static aggregateSearchParamsAsString(e){if(e.omit)return"false";if(e.advancedParams){const t=e.advancedParams.map(a=>({terms:a}));return JSON.stringify(t)}if(e.simpleParams)return e.simpleParams.join(",")}static sortParamsAsString(e){return`${e.field}:${e.direction}`}static generateURLSearchParams(e){const t=new URLSearchParams;if(t.append("user_query",e.query),e.pageType&&t.append("page_type",String(e.pageType)),e.pageTarget&&t.append("page_target",String(e.pageTarget)),e.rows!=null&&t.append("hits_per_page",String(e.rows)),e.page!=null&&t.append("page",String(e.page)),e.fields&&t.append("fields",e.fields.join(",")),e.sort){const a=e.sort.map(o=>this.sortParamsAsString(o));t.append("sort",a.join(","))}const i=e.aggregations;if(i){const a=this.aggregateSearchParamsAsString(i);a&&t.append("aggregations",a)}return e.aggregationsSize!=null&&t.append("aggregations_size",String(e.aggregationsSize)),e.debugging&&t.append("debugging","true"),t}}var qt;(function(r){r.networkError="SearchService.NetworkError",r.itemNotFound="SearchService.ItemNotFound",r.decodingError="SearchService.DecodingError",r.searchEngineError="SearchService.SearchEngineError"})(qt||(qt={}));class Qo extends Error{constructor(e,t,i){super(t),this.name=e,this.type=e,this.details=i}}class Gr{constructor(e){var t;if(this.baseUrl=(t=e==null?void 0:e.baseUrl)!==null&&t!==void 0?t:"archive.org",(e==null?void 0:e.includeCredentials)!==void 0?this.includeCredentials=e.includeCredentials:this.includeCredentials=window.location.href.match(/^https?:\/\/.*archive\.org(:[0-9]+)?/)!==null,(e==null?void 0:e.scope)!==void 0)this.requestScope=e.scope;else{const a=new URL(window.location.href).searchParams.get("scope");a&&(this.requestScope=a)}}async fetchUrl(e,t){var i;const a=new URL(e);this.requestScope&&a.searchParams.set("scope",this.requestScope);let o;try{const s=(i=t==null?void 0:t.requestOptions)!==null&&i!==void 0?i:{credentials:this.includeCredentials?"include":"same-origin"};o=await fetch(a.href,s)}catch(s){const l=s instanceof Error?s.message:typeof s=="string"?s:"Unknown error";return this.getErrorResult(qt.networkError,l)}try{const s=await o.json();s.debugging&&this.printDebuggingInfo(s);const l=s.error;if(l){const d=s.forensics;return this.getErrorResult(qt.searchEngineError,l,d)}else return{success:s}}catch(s){const l=s instanceof Error?s.message:typeof s=="string"?s:"Unknown error";return this.getErrorResult(qt.decodingError,l)}}getErrorResult(e,t,i){return{error:new Qo(e,t,i)}}printDebuggingInfo(e){var t,i,a;const o=(t=e.debugging)===null||t===void 0?void 0:t.debugging,s=(i=o==null?void 0:o.messages)!==null&&i!==void 0?i:[],l=(a=o==null?void 0:o.data)!==null&&a!==void 0?a:{};console.group("Debug messages");for(const d of s)console.log(d);console.groupEnd(),console.group("Debug data");for(const[d,c]of Object.entries(l))console.log(d,c);console.groupEnd()}}class Yo extends Gr{constructor(e){var t;super(e),this.servicePath=(t=e==null?void 0:e.servicePath)!==null&&t!==void 0?t:"/services/search/beta/page_production"}async performSearch(e){const i=Vr.generateURLSearchParams(e).toString(),a=`https://${this.baseUrl}${this.servicePath}/?service_backend=metadata&${i}`;return this.fetchUrl(a)}}class Ko extends Gr{constructor(e){var t;super(e),this.servicePath=(t=e==null?void 0:e.servicePath)!==null&&t!==void 0?t:"/services/search/beta/page_production"}async performSearch(e){const i=Vr.generateURLSearchParams(e).toString(),a=`https://${this.baseUrl}${this.servicePath}/?service_backend=fts&${i}`;return this.fetchUrl(a)}}var $e;(function(r){r[r.METADATA=0]="METADATA",r[r.FULLTEXT=1]="FULLTEXT"})($e||($e={}));class Pe{constructor(e={}){this.backendOptions=e}async search(e,t=$e.METADATA){const a=await Pe.getBackendForSearchType(t,this.backendOptions).performSearch(e);return a.error?a:{success:new Go(a.success)}}static getBackendForSearchType(e,t={}){switch(e){case $e.FULLTEXT:return new Ko(t);case $e.METADATA:default:return new Yo(t)}}}Pe.default=new Pe;n([g((r,e={})=>{const{includeCredentials:t="",scope:i="",baseUrl:a=""}=e;return`${r};${t};${i};${a}`})],Pe,"getBackendForSearchType",null);function qo(){var r=!navigator.userAgentData&&/Safari\//.test(navigator.userAgent)&&!/Chrom(e|ium)\//.test(navigator.userAgent);if(!r||!indexedDB.databases)return Promise.resolve();var e;return new Promise(function(t){var i=function(){return indexedDB.databases().finally(t)};e=setInterval(i,100),i()}).finally(function(){return clearInterval(e)})}function Ft(r){return new Promise((e,t)=>{r.oncomplete=r.onsuccess=()=>e(r.result),r.onabort=r.onerror=()=>t(r.error)})}function Zo(r,e){const t=qo().then(()=>{const i=indexedDB.open(r);return i.onupgradeneeded=()=>i.result.createObjectStore(e),Ft(i)});return(i,a)=>t.then(o=>a(o.transaction(e,i).objectStore(e)))}let Yi;function Fi(){return Yi||(Yi=Zo("keyval-store","keyval")),Yi}function Xo(r,e=Fi()){return e("readonly",t=>Ft(t.get(r)))}function Jo(r,e,t=Fi()){return t("readwrite",i=>(i.put(e,r),Ft(i.transaction)))}function es(r,e=Fi()){return e("readwrite",t=>(t.delete(r),Ft(t.transaction)))}function ts(r,e){return r.openCursor().onsuccess=function(){!this.result||(e(this.result),this.result.continue())},Ft(r.transaction)}function is(r=Fi()){return r("readonly",e=>{if(e.getAllKeys)return Ft(e.getAllKeys());const t=[];return ts(e,i=>t.push(i.key)).then(()=>t)})}function as(r,e){return r.setMilliseconds(r.getMilliseconds()+e*1e3),r}class rs{constructor(e){var t,i,a,o;if(this.namespace=(t=e==null?void 0:e.namespace)!==null&&t!==void 0?t:"LocalCache",this.defaultTTL=(i=e==null?void 0:e.defaultTTL)!==null&&i!==void 0?i:15*60,(!((a=e==null?void 0:e.immediateClean)!==null&&a!==void 0)||a)&&this.cleanExpired(),!(e!=null&&e.disableCleaning)){const s=(o=e==null?void 0:e.cleaningInterval)!==null&&o!==void 0?o:60;setInterval(()=>{this.cleanExpired()},s*1e3)}}async set(e){var t;const i={value:e.value},a=(t=e.ttl)!==null&&t!==void 0?t:this.defaultTTL,o=as(new Date,a);i.expires=o;const s=this.getNamespacedKey(e.key);try{await Jo(s,i)}catch{}}async get(e){const t=this.getNamespacedKey(e);let i;try{i=await Xo(t)}catch{}if(!i)return;const a=new Date;if(i.expires&&i.expires<a){await this.delete(e);return}return i.value}async delete(e){const t=this.getNamespacedKey(e);try{await es(t)}catch{}}async cleanExpired(){const e=await this.getAllKeys();await Promise.all(e.map(async t=>this.get(t)))}async getAllKeys(){let e=[];try{e=await is()}catch{}const t=[];for(const o of e)typeof o=="string"&&t.push(o);return t.filter(o=>o.startsWith(this.namespace)).map(o=>this.removeNamespace(o))}getNamespacedKey(e){return`${this.namespace}-${e}`}removeNamespace(e){return e.replace(`${this.namespace}-`,"")}}/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ma=window.ShadowRoot&&(window.ShadyCSS===void 0||window.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Aa=Symbol(),or=new Map;class Qr{constructor(e,t){if(this._$cssResult$=!0,t!==Aa)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e}get styleSheet(){let e=or.get(this.cssText);return Ma&&e===void 0&&(or.set(this.cssText,e=new CSSStyleSheet),e.replaceSync(this.cssText)),e}toString(){return this.cssText}}const os=r=>new Qr(typeof r=="string"?r:r+"",Aa),y=(r,...e)=>{const t=r.length===1?r[0]:e.reduce((i,a,o)=>i+(s=>{if(s._$cssResult$===!0)return s.cssText;if(typeof s=="number")return s;throw Error("Value passed to 'css' function must be a 'css' function result: "+s+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(a)+r[o+1],r[0]);return new Qr(t,Aa)},ss=(r,e)=>{Ma?r.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet):e.forEach(t=>{const i=document.createElement("style"),a=window.litNonce;a!==void 0&&i.setAttribute("nonce",a),i.textContent=t.cssText,r.appendChild(i)})},sr=Ma?r=>r:r=>r instanceof CSSStyleSheet?(e=>{let t="";for(const i of e.cssRules)t+=i.cssText;return os(t)})(r):r;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Ki;const nr=window.trustedTypes,ns=nr?nr.emptyScript:"",lr=window.reactiveElementPolyfillSupport,fa={toAttribute(r,e){switch(e){case Boolean:r=r?ns:null;break;case Object:case Array:r=r==null?r:JSON.stringify(r)}return r},fromAttribute(r,e){let t=r;switch(e){case Boolean:t=r!==null;break;case Number:t=r===null?null:Number(r);break;case Object:case Array:try{t=JSON.parse(r)}catch{t=null}}return t}},Yr=(r,e)=>e!==r&&(e==e||r==r),qi={attribute:!0,type:String,converter:fa,reflect:!1,hasChanged:Yr};class yt extends HTMLElement{constructor(){super(),this._$Et=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Ei=null,this.o()}static addInitializer(e){var t;(t=this.l)!==null&&t!==void 0||(this.l=[]),this.l.push(e)}static get observedAttributes(){this.finalize();const e=[];return this.elementProperties.forEach((t,i)=>{const a=this._$Eh(i,t);a!==void 0&&(this._$Eu.set(a,i),e.push(a))}),e}static createProperty(e,t=qi){if(t.state&&(t.attribute=!1),this.finalize(),this.elementProperties.set(e,t),!t.noAccessor&&!this.prototype.hasOwnProperty(e)){const i=typeof e=="symbol"?Symbol():"__"+e,a=this.getPropertyDescriptor(e,i,t);a!==void 0&&Object.defineProperty(this.prototype,e,a)}}static getPropertyDescriptor(e,t,i){return{get(){return this[t]},set(a){const o=this[e];this[t]=a,this.requestUpdate(e,o,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)||qi}static finalize(){if(this.hasOwnProperty("finalized"))return!1;this.finalized=!0;const e=Object.getPrototypeOf(this);if(e.finalize(),this.elementProperties=new Map(e.elementProperties),this._$Eu=new Map,this.hasOwnProperty("properties")){const t=this.properties,i=[...Object.getOwnPropertyNames(t),...Object.getOwnPropertySymbols(t)];for(const a of i)this.createProperty(a,t[a])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const i=new Set(e.flat(1/0).reverse());for(const a of i)t.unshift(sr(a))}else e!==void 0&&t.push(sr(e));return t}static _$Eh(e,t){const i=t.attribute;return i===!1?void 0:typeof i=="string"?i:typeof e=="string"?e.toLowerCase():void 0}o(){var e;this._$Ep=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$Em(),this.requestUpdate(),(e=this.constructor.l)===null||e===void 0||e.forEach(t=>t(this))}addController(e){var t,i;((t=this._$Eg)!==null&&t!==void 0?t:this._$Eg=[]).push(e),this.renderRoot!==void 0&&this.isConnected&&((i=e.hostConnected)===null||i===void 0||i.call(e))}removeController(e){var t;(t=this._$Eg)===null||t===void 0||t.splice(this._$Eg.indexOf(e)>>>0,1)}_$Em(){this.constructor.elementProperties.forEach((e,t)=>{this.hasOwnProperty(t)&&(this._$Et.set(t,this[t]),delete this[t])})}createRenderRoot(){var e;const t=(e=this.shadowRoot)!==null&&e!==void 0?e:this.attachShadow(this.constructor.shadowRootOptions);return ss(t,this.constructor.elementStyles),t}connectedCallback(){var e;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$Eg)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostConnected)===null||i===void 0?void 0:i.call(t)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$Eg)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostDisconnected)===null||i===void 0?void 0:i.call(t)})}attributeChangedCallback(e,t,i){this._$AK(e,i)}_$ES(e,t,i=qi){var a,o;const s=this.constructor._$Eh(e,i);if(s!==void 0&&i.reflect===!0){const l=((o=(a=i.converter)===null||a===void 0?void 0:a.toAttribute)!==null&&o!==void 0?o:fa.toAttribute)(t,i.type);this._$Ei=e,l==null?this.removeAttribute(s):this.setAttribute(s,l),this._$Ei=null}}_$AK(e,t){var i,a,o;const s=this.constructor,l=s._$Eu.get(e);if(l!==void 0&&this._$Ei!==l){const d=s.getPropertyOptions(l),c=d.converter,p=(o=(a=(i=c)===null||i===void 0?void 0:i.fromAttribute)!==null&&a!==void 0?a:typeof c=="function"?c:null)!==null&&o!==void 0?o:fa.fromAttribute;this._$Ei=l,this[l]=p(t,d.type),this._$Ei=null}}requestUpdate(e,t,i){let a=!0;e!==void 0&&(((i=i||this.constructor.getPropertyOptions(e)).hasChanged||Yr)(this[e],t)?(this._$AL.has(e)||this._$AL.set(e,t),i.reflect===!0&&this._$Ei!==e&&(this._$EC===void 0&&(this._$EC=new Map),this._$EC.set(e,i))):a=!1),!this.isUpdatePending&&a&&(this._$Ep=this._$E_())}async _$E_(){this.isUpdatePending=!0;try{await this._$Ep}catch(t){Promise.reject(t)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var e;if(!this.isUpdatePending)return;this.hasUpdated,this._$Et&&(this._$Et.forEach((a,o)=>this[o]=a),this._$Et=void 0);let t=!1;const i=this._$AL;try{t=this.shouldUpdate(i),t?(this.willUpdate(i),(e=this._$Eg)===null||e===void 0||e.forEach(a=>{var o;return(o=a.hostUpdate)===null||o===void 0?void 0:o.call(a)}),this.update(i)):this._$EU()}catch(a){throw t=!1,this._$EU(),a}t&&this._$AE(i)}willUpdate(e){}_$AE(e){var t;(t=this._$Eg)===null||t===void 0||t.forEach(i=>{var a;return(a=i.hostUpdated)===null||a===void 0?void 0:a.call(i)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EU(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$Ep}shouldUpdate(e){return!0}update(e){this._$EC!==void 0&&(this._$EC.forEach((t,i)=>this._$ES(i,this[i],t)),this._$EC=void 0),this._$EU()}updated(e){}firstUpdated(e){}}yt.finalized=!0,yt.elementProperties=new Map,yt.elementStyles=[],yt.shadowRootOptions={mode:"open"},lr==null||lr({ReactiveElement:yt}),((Ki=globalThis.reactiveElementVersions)!==null&&Ki!==void 0?Ki:globalThis.reactiveElementVersions=[]).push("1.3.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Zi;const kt=globalThis.trustedTypes,dr=kt?kt.createPolicy("lit-html",{createHTML:r=>r}):void 0,Ae=`lit$${(Math.random()+"").slice(9)}$`,Ea="?"+Ae,ls=`<${Ea}>`,zt=document,ei=(r="")=>zt.createComment(r),ti=r=>r===null||typeof r!="object"&&typeof r!="function",Kr=Array.isArray,qr=r=>{var e;return Kr(r)||typeof((e=r)===null||e===void 0?void 0:e[Symbol.iterator])=="function"},Gt=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,cr=/-->/g,hr=/>/g,Ye=/>|[ 	\n\r](?:([^\s"'>=/]+)([ 	\n\r]*=[ 	\n\r]*(?:[^ 	\n\r"'`<>=]|("|')|))|$)/g,ur=/'/g,pr=/"/g,Zr=/^(?:script|style|textarea|title)$/i,Xr=r=>(e,...t)=>({_$litType$:r,strings:e,values:t}),m=Xr(1),I=Xr(2),fe=Symbol.for("lit-noChange"),_=Symbol.for("lit-nothing"),mr=new WeakMap,vi=(r,e,t)=>{var i,a;const o=(i=t==null?void 0:t.renderBefore)!==null&&i!==void 0?i:e;let s=o._$litPart$;if(s===void 0){const l=(a=t==null?void 0:t.renderBefore)!==null&&a!==void 0?a:null;o._$litPart$=s=new Ot(e.insertBefore(ei(),l),l,void 0,t!=null?t:{})}return s._$AI(r),s},$t=zt.createTreeWalker(zt,129,null,!1),Jr=(r,e)=>{const t=r.length-1,i=[];let a,o=e===2?"<svg>":"",s=Gt;for(let d=0;d<t;d++){const c=r[d];let p,v,f=-1,w=0;for(;w<c.length&&(s.lastIndex=w,v=s.exec(c),v!==null);)w=s.lastIndex,s===Gt?v[1]==="!--"?s=cr:v[1]!==void 0?s=hr:v[2]!==void 0?(Zr.test(v[2])&&(a=RegExp("</"+v[2],"g")),s=Ye):v[3]!==void 0&&(s=Ye):s===Ye?v[0]===">"?(s=a!=null?a:Gt,f=-1):v[1]===void 0?f=-2:(f=s.lastIndex-v[2].length,p=v[1],s=v[3]===void 0?Ye:v[3]==='"'?pr:ur):s===pr||s===ur?s=Ye:s===cr||s===hr?s=Gt:(s=Ye,a=void 0);const x=s===Ye&&r[d+1].startsWith("/>")?" ":"";o+=s===Gt?c+ls:f>=0?(i.push(p),c.slice(0,f)+"$lit$"+c.slice(f)+Ae+x):c+Ae+(f===-2?(i.push(void 0),d):x)}const l=o+(r[t]||"<?>")+(e===2?"</svg>":"");if(!Array.isArray(r)||!r.hasOwnProperty("raw"))throw Error("invalid template strings array");return[dr!==void 0?dr.createHTML(l):l,i]};class ii{constructor({strings:e,_$litType$:t},i){let a;this.parts=[];let o=0,s=0;const l=e.length-1,d=this.parts,[c,p]=Jr(e,t);if(this.el=ii.createElement(c,i),$t.currentNode=this.el.content,t===2){const v=this.el.content,f=v.firstChild;f.remove(),v.append(...f.childNodes)}for(;(a=$t.nextNode())!==null&&d.length<l;){if(a.nodeType===1){if(a.hasAttributes()){const v=[];for(const f of a.getAttributeNames())if(f.endsWith("$lit$")||f.startsWith(Ae)){const w=p[s++];if(v.push(f),w!==void 0){const x=a.getAttribute(w.toLowerCase()+"$lit$").split(Ae),$=/([.?@])?(.*)/.exec(w);d.push({type:1,index:o,name:$[2],strings:x,ctor:$[1]==="."?to:$[1]==="?"?io:$[1]==="@"?ao:oi})}else d.push({type:6,index:o})}for(const f of v)a.removeAttribute(f)}if(Zr.test(a.tagName)){const v=a.textContent.split(Ae),f=v.length-1;if(f>0){a.textContent=kt?kt.emptyScript:"";for(let w=0;w<f;w++)a.append(v[w],ei()),$t.nextNode(),d.push({type:2,index:++o});a.append(v[f],ei())}}}else if(a.nodeType===8)if(a.data===Ea)d.push({type:2,index:o});else{let v=-1;for(;(v=a.data.indexOf(Ae,v+1))!==-1;)d.push({type:7,index:o}),v+=Ae.length-1}o++}}static createElement(e,t){const i=zt.createElement("template");return i.innerHTML=e,i}}function at(r,e,t=r,i){var a,o,s,l;if(e===fe)return e;let d=i!==void 0?(a=t._$Cl)===null||a===void 0?void 0:a[i]:t._$Cu;const c=ti(e)?void 0:e._$litDirective$;return(d==null?void 0:d.constructor)!==c&&((o=d==null?void 0:d._$AO)===null||o===void 0||o.call(d,!1),c===void 0?d=void 0:(d=new c(r),d._$AT(r,t,i)),i!==void 0?((s=(l=t)._$Cl)!==null&&s!==void 0?s:l._$Cl=[])[i]=d:t._$Cu=d),d!==void 0&&(e=at(r,d._$AS(r,e.values),d,i)),e}class eo{constructor(e,t){this.v=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}p(e){var t;const{el:{content:i},parts:a}=this._$AD,o=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:zt).importNode(i,!0);$t.currentNode=o;let s=$t.nextNode(),l=0,d=0,c=a[0];for(;c!==void 0;){if(l===c.index){let p;c.type===2?p=new Ot(s,s.nextSibling,this,e):c.type===1?p=new c.ctor(s,c.name,c.strings,this,e):c.type===6&&(p=new ro(s,this,e)),this.v.push(p),c=a[++d]}l!==(c==null?void 0:c.index)&&(s=$t.nextNode(),l++)}return o}m(e){let t=0;for(const i of this.v)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class Ot{constructor(e,t,i,a){var o;this.type=2,this._$AH=_,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=a,this._$Cg=(o=a==null?void 0:a.isConnected)===null||o===void 0||o}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cg}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&e.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=at(this,e,t),ti(e)?e===_||e==null||e===""?(this._$AH!==_&&this._$AR(),this._$AH=_):e!==this._$AH&&e!==fe&&this.$(e):e._$litType$!==void 0?this.T(e):e.nodeType!==void 0?this.k(e):qr(e)?this.S(e):this.$(e)}M(e,t=this._$AB){return this._$AA.parentNode.insertBefore(e,t)}k(e){this._$AH!==e&&(this._$AR(),this._$AH=this.M(e))}$(e){this._$AH!==_&&ti(this._$AH)?this._$AA.nextSibling.data=e:this.k(zt.createTextNode(e)),this._$AH=e}T(e){var t;const{values:i,_$litType$:a}=e,o=typeof a=="number"?this._$AC(e):(a.el===void 0&&(a.el=ii.createElement(a.h,this.options)),a);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===o)this._$AH.m(i);else{const s=new eo(o,this),l=s.p(this.options);s.m(i),this.k(l),this._$AH=s}}_$AC(e){let t=mr.get(e.strings);return t===void 0&&mr.set(e.strings,t=new ii(e)),t}S(e){Kr(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,a=0;for(const o of e)a===t.length?t.push(i=new Ot(this.M(ei()),this.M(ei()),this,this.options)):i=t[a],i._$AI(o),a++;a<t.length&&(this._$AR(i&&i._$AB.nextSibling,a),t.length=a)}_$AR(e=this._$AA.nextSibling,t){var i;for((i=this._$AP)===null||i===void 0||i.call(this,!1,!0,t);e&&e!==this._$AB;){const a=e.nextSibling;e.remove(),e=a}}setConnected(e){var t;this._$AM===void 0&&(this._$Cg=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}}class oi{constructor(e,t,i,a,o){this.type=1,this._$AH=_,this._$AN=void 0,this.element=e,this.name=t,this._$AM=a,this.options=o,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=_}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,i,a){const o=this.strings;let s=!1;if(o===void 0)e=at(this,e,t,0),s=!ti(e)||e!==this._$AH&&e!==fe,s&&(this._$AH=e);else{const l=e;let d,c;for(e=o[0],d=0;d<o.length-1;d++)c=at(this,l[i+d],t,d),c===fe&&(c=this._$AH[d]),s||(s=!ti(c)||c!==this._$AH[d]),c===_?e=_:e!==_&&(e+=(c!=null?c:"")+o[d+1]),this._$AH[d]=c}s&&!a&&this.C(e)}C(e){e===_?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e!=null?e:"")}}class to extends oi{constructor(){super(...arguments),this.type=3}C(e){this.element[this.name]=e===_?void 0:e}}const ds=kt?kt.emptyScript:"";class io extends oi{constructor(){super(...arguments),this.type=4}C(e){e&&e!==_?this.element.setAttribute(this.name,ds):this.element.removeAttribute(this.name)}}class ao extends oi{constructor(e,t,i,a,o){super(e,t,i,a,o),this.type=5}_$AI(e,t=this){var i;if((e=(i=at(this,e,t,0))!==null&&i!==void 0?i:_)===fe)return;const a=this._$AH,o=e===_&&a!==_||e.capture!==a.capture||e.once!==a.once||e.passive!==a.passive,s=e!==_&&(a===_||o);o&&this.element.removeEventListener(this.name,this,a),s&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,i;typeof this._$AH=="function"?this._$AH.call((i=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&i!==void 0?i:this.element,e):this._$AH.handleEvent(e)}}class ro{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){at(this,e)}}const cs={L:"$lit$",P:Ae,V:Ea,I:1,N:Jr,R:eo,j:qr,D:at,H:Ot,F:oi,O:io,W:ao,B:to,Z:ro},vr=window.litHtmlPolyfillSupport;vr==null||vr(ii,Ot),((Zi=globalThis.litHtmlVersions)!==null&&Zi!==void 0?Zi:globalThis.litHtmlVersions=[]).push("2.2.4");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Xi,Ji;class O extends yt{constructor(){super(...arguments),this.renderOptions={host:this},this._$Dt=void 0}createRenderRoot(){var e,t;const i=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=i.firstChild),i}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Dt=vi(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Dt)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Dt)===null||e===void 0||e.setConnected(!1)}render(){return fe}}O.finalized=!0,O._$litElement$=!0,(Xi=globalThis.litElementHydrateSupport)===null||Xi===void 0||Xi.call(globalThis,{LitElement:O});const fr=globalThis.litElementPolyfillSupport;fr==null||fr({LitElement:O});((Ji=globalThis.litElementVersions)!==null&&Ji!==void 0?Ji:globalThis.litElementVersions=[]).push("3.2.0");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Fe={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Da=r=>(...e)=>({_$litDirective$:r,values:e});class La{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{H:vs}=cs,fs=r=>r.strings===void 0,gr=()=>document.createComment(""),Qt=(r,e,t)=>{var i;const a=r._$AA.parentNode,o=e===void 0?r._$AB:e._$AA;if(t===void 0){const s=a.insertBefore(gr(),o),l=a.insertBefore(gr(),o);t=new vs(s,l,r,r.options)}else{const s=t._$AB.nextSibling,l=t._$AM,d=l!==r;if(d){let c;(i=t._$AQ)===null||i===void 0||i.call(t,r),t._$AM=r,t._$AP!==void 0&&(c=r._$AU)!==l._$AU&&t._$AP(c)}if(s!==o||d){let c=t._$AA;for(;c!==s;){const p=c.nextSibling;a.insertBefore(c,o),c=p}}}return t},Ke=(r,e,t=r)=>(r._$AI(e,t),r),gs={},so=(r,e=gs)=>r._$AH=e,ys=r=>r._$AH,ta=r=>{var e;(e=r._$AP)===null||e===void 0||e.call(r,!1,!0);let t=r._$AA;const i=r._$AB.nextSibling;for(;t!==i;){const a=t.nextSibling;t.remove(),t=a}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const yr=(r,e,t)=>{const i=new Map;for(let a=e;a<=t;a++)i.set(r[a],a);return i},no=Da(class extends La{constructor(r){if(super(r),r.type!==Fe.CHILD)throw Error("repeat() can only be used in text expressions")}dt(r,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);const a=[],o=[];let s=0;for(const l of r)a[s]=i?i(l,s):s,o[s]=t(l,s),s++;return{values:o,keys:a}}render(r,e,t){return this.dt(r,e,t).values}update(r,[e,t,i]){var a;const o=ys(r),{values:s,keys:l}=this.dt(e,t,i);if(!Array.isArray(o))return this.ut=l,s;const d=(a=this.ut)!==null&&a!==void 0?a:this.ut=[],c=[];let p,v,f=0,w=o.length-1,x=0,$=s.length-1;for(;f<=w&&x<=$;)if(o[f]===null)f++;else if(o[w]===null)w--;else if(d[f]===l[x])c[x]=Ke(o[f],s[x]),f++,x++;else if(d[w]===l[$])c[$]=Ke(o[w],s[$]),w--,$--;else if(d[f]===l[$])c[$]=Ke(o[f],s[$]),Qt(r,c[$+1],o[f]),f++,$--;else if(d[w]===l[x])c[x]=Ke(o[w],s[x]),Qt(r,o[f],o[w]),w--,x++;else if(p===void 0&&(p=yr(l,x,$),v=yr(d,f,w)),p.has(d[f]))if(p.has(d[w])){const A=v.get(l[x]),E=A!==void 0?o[A]:null;if(E===null){const F=Qt(r,o[f]);Ke(F,s[x]),c[x]=F}else c[x]=Ke(E,s[x]),Qt(r,o[f],E),o[A]=null;x++}else ta(o[w]),w--;else ta(o[f]),f++;for(;x<=$;){const A=Qt(r,c[$+1]);Ke(A,s[x]),c[x++]=A}for(;f<=w;){const A=o[f++];A!==null&&ta(A)}return this.ut=l,so(r,c),fe}});function hi(r,e,t){return Array.from({length:(e-r)/t+1},(i,a)=>r+a*t)}let Re=class extends O{constructor(){super(...arguments),this.itemCount=0,this.scrollOptimizationsDisabled=!1,this.intersectionObserver=new IntersectionObserver(e=>{e.forEach(t=>{if(t.target===this.sentinel){t.isIntersecting&&this.dispatchEvent(new Event("scrollThresholdReached"));return}const a=t.target.dataset.cellIndex;if(!a)return;const o=parseInt(a,10);t.isIntersecting?this.visibleCellIndices.add(o):this.visibleCellIndices.delete(o)}),this.scrollOptimizationsDisabled||this.processVisibleCells()}),this.renderedCellIndices=new Set,this.visibleCellIndices=new Set,this.placeholderCellIndices=new Set}reload(){hi(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.removeCell(t)),this.renderedCellIndices.clear(),this.visibleCellIndices.clear(),this.placeholderCellIndices.clear(),this.setupObservations()}scrollToCell(e,t){const i=this.cellContainers[e];if(!i)return!1;const a=t?"smooth":"auto";return i.scrollIntoView({behavior:a}),!0}getVisibleCellIndices(){return Array.from(this.visibleCellIndices)}updated(e){(e.has("itemCount")||e.has("scrollOptimizationsDisabled"))&&this.setupObservations()}disconnectedCallback(){this.intersectionObserver.disconnect()}setupObservations(){this.setupIntersectionObserver()}setupIntersectionObserver(){this.intersectionObserver.disconnect(),this.sentinel&&this.intersectionObserver.observe(this.sentinel),this.scrollOptimizationsDisabled?(hi(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.visibleCellIndices.add(t)),this.processVisibleCells()):this.cellContainers.forEach(e=>this.intersectionObserver.observe(e))}render(){const e=this.itemCount-1,t=hi(0,e,1);return m`
      <div id="container">
        <div id="sentinel"></div>
        ${no(t,i=>i,i=>m`
            <div
    ...
    `}};n([u({type:Number})],Re.prototype,"itemCount",void 0);n([u({type:Object})],Re.prototype,"cellProvider",void 0);n([u({type:Object})],Re.prototype,"placeholderCellTemplate",void 0);n([u({type:Boolean})],Re.prototype,"scrollOptimizationsDisabled",void 0);n([ce("#sentinel")],Re.prototype,"sentinel",void 0);n([us(".cell-container")],Re.prototype,"cellContainers",void 0);Re=n([R("infinite-scroller")],Re);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const bs=(r,...e)=>({strTag:!0,strings:r,values:e}),gt=bs,ws=r=>typeof r!="string"&&"strTag"in r,xs=(r,e,t)=>{let i=r[0];for(let a=1;a<r.length;a++)i+=e[t?t[a-1]:a-1],i+=r[a];return i};/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;let ga=class extends O{render(){var e,t,i;return m`
      <div id="container">
        ...
        <div id="item-count-container">
          ...
          <div id="item-count-stacked-text">
            ...
            <div id="items-text">${Xe("items")}</div>
          </div>
        </div>
      </div>
    ...
    `}};n([u({type:Object})],ga.prototype,"model",void 0);ga=n([R("collection-tile")],ga);function Si(r,e="short",t="en-US"){if(!r)return"";const i={timeZone:"UTC"};switch(e){case"short":i.month="short",i.year="numeric";break;case"long":i.year="numeric",i.month="short",i.day="2-digit";break}return new Intl.DateTimeFormat(t,i).format(r)}/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ya=Da(class extends La{constructor(r){var e;if(super(r),r.type!==Fe.ATTRIBUTE||r.name!=="class"||((e=r.strings)===null||e===void 0?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(r){return" "+Object.keys(r).filter(e=>r[e]).join(" ")+" "}update(r,[e]){var t,i;if(this.et===void 0){this.et=new Set,r.strings!==void 0&&(this.st=new Set(r.strings.join(" ").split(/\s/).filter(o=>o!=="")));for(const o in e)e[o]&&!(!((t=this.st)===null||t===void 0)&&t.has(o))&&this.et.add(o);return this.render(e)}const a=r.element.classList;this.et.forEach(o=>{o in e||(a.remove(o),this.et.delete(o))});for(const o in e){const s=!!e[o];s===this.et.has(o)||((i=this.st)===null||i===void 0?void 0:i.has(o))||(s?(a.add(o),this.et.add(o)):(a.remove(o),this.et.delete(o)))}return fe}}),Cs=I`
  <svg
    viewBox="0 0 100 100"
    xmlns="http://www.w3.org/2000/svg"
  >
...
`;let $i=class extends O{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1}render(){return this.loginRequired&&!this.loggedIn?m`${ks}`:m`${Cs}`}static get styles(){return y`
      :host {
        position: absolute;
        top: 50%;
        left: 50%;
    ...
    `}};n([u({type:Boolean})],$i.prototype,"loggedIn",void 0);n([u({type:Boolean})],$i.prototype,"loginRequired",void 0);$i=n([R("icon-overlay")],$i);let Ci=class extends O{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1}render(){return m` <div class="overlay no-preview">${this.textDisplay}</div> `}get textDisplay(){return this.loginRequired&&!this.loggedIn?`Log in
to view this item`:"Content may be inappropriate"}static get styles(){return y`
    ...
    `}};n([u({type:Boolean})],Ci.prototype,"loggedIn",void 0);n([u({type:Boolean})],Ci.prototype,"loginRequired",void 0);Ci=n([R("text-overlay")],Ci);let Be=class extends O{constructor(){super(...arguments),this.isCompactTile=!1,this.isListTile=!1,this.loggedIn=!1,this.viewSize="desktop"}render(){var e;return!((e=this.model)===null||e===void 0)&&e.identifier?m`
    ...
    `}};n([u({type:String})],Be.prototype,"baseImageUrl",void 0);n([u({type:Boolean})],Be.prototype,"isCompactTile",void 0);n([u({type:Boolean})],Be.prototype,"isListTile",void 0);n([u({type:Boolean})],Be.prototype,"loggedIn",void 0);n([u({type:Object})],Be.prototype,"model",void 0);n([u({type:String})],Be.prototype,"viewSize",void 0);Be=n([R("image-block")],Be);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*fi(r,e){const t=typeof e=="function";if(r!==void 0){let i=-1;for(const a of r)i>-1&&(yield t?e(i):e),i++,yield a}}let ki=class extends O{constructor(){super(...arguments),this.snippets=[],this.viewSize="desktop"}render(){var e;return!((e=this.snippets)===null||e===void 0)&&e.length?m`
    ...
    `:m`${_}`}get viewSizeClass(){return this.viewSize==="grid"?"grid":"list"}get containerClasses(){return`container ${this.viewSizeClass}`}get ellipsisJoinedSnippets(){return m`
      &hellip; ${fi(this.snippetTemplates,m` &hellip; `)} &hellip;
    ...
    `}};n([u({type:Array})],ki.prototype,"snippets",void 0);n([u({type:String})],ki.prototype,"viewSize",void 0);ki=n([R("text-snippet-block")],ki);const zs=y`
  .drop-shadow {
...
`,Bs={account:{color:"#000000",icon:Ms,text:"Account"},audio:{color:"#00adef",icon:As,text:"Audio"},collection:{color:"#4666ff",icon:lo,text:"Collection"},data:{color:"#333333",icon:Es,text:"Data"},etree:{color:"#00adef",icon:Ds,text:"E-tree"},film:{color:"#bf1b2c",icon:br,text:"Film"},image:{color:"#aa99c9",icon:Ls,text:"Image"},movies:{color:"#f1644b",icon:br,text:"Movie"},radio:{color:"#8fdaef",icon:Fs,text:"Radio"},software:{color:"#9ecc4f",icon:Os,text:"Software"},texts:{color:"#faab3c",icon:Is,text:"Text"},tv:{color:"#f1644b",icon:Ps,text:"TV"},video:{color:"#f1644b",icon:Ns,text:"Video"},web:{color:"#ffcd27",icon:Rs,text:"Web"}};let ri=class extends O{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var e,t;const i=["tvnews","tvarchive","television"],a=["radio","radioprogram"];return this.mediatype==="movies"&&((e=this.collections)===null||e===void 0?void 0:e.some(o=>i.indexOf(o)>=0))?"tv":this.mediatype==="audio"&&((t=this.collections)===null||t===void 0?void 0:t.some(o=>a.indexOf(o)>=0))?"radio":this.mediatype||""}render(){const e=Bs[this.displayMediatype];return e?m`
      <div
        id="icon"
    ...
    `}};n([u({type:String})],ri.prototype,"mediatype",void 0);n([u({type:Array})],ri.prototype,"collections",void 0);n([u({type:Boolean})],ri.prototype,"showText",void 0);ri=n([R("mediatype-icon")],ri);const Hs=I`
...
`;function Vs(r,e){let t=1;return r>=1e9?t=1e9:r>=1e6?t=1e6:r>=1e3&&e==="short"&&(t=1e3),t}function Gs(r=0,e){const t=r/e,i=t<10;let a=0;return i?a=Math.round((t+Number.EPSILON)*10)/10:a=Math.round(t),a}function Qs(r,e,t,i){switch(e){case 1e9:return Xe(t==="short"?gt`${r}B`:gt`${r} billion`);case 1e6:return Xe(t==="short"?gt`${r}M`:gt`${r} million`);case 1e3:return Xe(t==="short"?gt`${r}K`:gt`${r} thousand`);default:return new Intl.NumberFormat(i).format(r)}}function Zt(r,e="long",t="short",i="en-US"){const a=r!=null?r:-1;if(a<0)return"";const o=Vs(a,e),s=Gs(a,o);return Qs(s,o,t,i)}let rt=class extends O{render(){return m`
        ...
        <ul id="stats-row">
          ...
          <li class="col">
            ...
            <p class="status-text">
              ...
              ${Zt(this.commentCount,"short","short")}
            </p>
          </li>
        </ul>
      </div>
    ...
    `}get doesSortedByDate(){var e;return["date","reviewdate","addeddate","publicdate"].includes((e=this.sortParam)===null||e===void 0?void 0:e.field)}get sortedDateInfoTemplate(){var e,t,i,a,o;let s;switch((e=this.sortParam)===null||e===void 0?void 0:e.field){case"date":s={field:"published",value:(t=this.model)===null||t===void 0?void 0:t.datePublished};break;case"reviewdate":s={field:"reviewed",value:(i=this.model)===null||i===void 0?void 0:i.dateReviewed};break;case"addeddate":s={field:"added",value:(a=this.model)===null||a===void 0?void 0:a.dateAdded};break;case"publicdate":s={field:"archived",value:(o=this.model)===null||o===void 0?void 0:o.dateArchived};break}return m`
      <div class="date-sorted-by truncated">
        <span>
          ${s==null?void 0:s.field} ${Si(s==null?void 0:s.value,"long")}
        </span>
      </div>
    ...
    `}};n([u({type:String})],Tt.prototype,"baseImageUrl",void 0);n([u({type:Boolean})],Tt.prototype,"loggedIn",void 0);n([u({type:Object})],Tt.prototype,"model",void 0);n([u({type:Object})],Tt.prototype,"sortParam",void 0);Tt=n([R("item-tile")],Tt);let ba=class extends O{render(){var e,t,i,a,o,s,l,d;return m`
    ...
    `}};n([u({type:Object})],ba.prototype,"model",void 0);ba=n([R("account-tile")],ba);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*wr(r,e){if(r!==void 0){let t=0;for(const i of r)yield e(i,t++)}}/*! @license DOMPurify 2.3.8 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/2.3.8/LICENSE */function Je(r){return Je=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},Je(r)}function wa(r,e){return wa=Object.setPrototypeOf||function(i,a){return i.__proto__=a,i},wa(r,e)}function Ys(){if(typeof Reflect=="undefined"||!Reflect.construct||Reflect.construct.sham)return!1;if(typeof Proxy=="function")return!0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],function(){})),!0}catch{return!1}}function gi(r,e,t){return Ys()?gi=Reflect.construct:gi=function(a,o,s){var l=[null];l.push.apply(l,o);var d=Function.bind.apply(a,l),c=new d;return s&&wa(c,s.prototype),c},gi.apply(null,arguments)}function ye(r){return Ks(r)||qs(r)||Zs(r)||Xs()}function Ks(r){if(Array.isArray(r))return xa(r)}function qs(r){if(typeof Symbol!="undefined"&&r[Symbol.iterator]!=null||r["@@iterator"]!=null)return Array.from(r)}function Zs(r,e){if(!!r){if(typeof r=="string")return xa(r,e);var t=Object.prototype.toString.call(r).slice(8,-1);if(t==="Object"&&r.constructor&&(t=r.constructor.name),t==="Map"||t==="Set")return Array.from(r);if(t==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t))return xa(r,e)}}function xa(r,e){(e==null||e>r.length)&&(e=r.length);for(var t=0,i=new Array(e);t<e;t++)i[t]=r[t];return i}function Xs(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}var Js=Object.hasOwnProperty,xr=Object.setPrototypeOf,en=Object.isFrozen,tn=Object.getPrototypeOf,an=Object.getOwnPropertyDescriptor,de=Object.freeze,Ce=Object.seal,rn=Object.create,co=typeof Reflect!="undefined"&&Reflect,zi=co.apply,_a=co.construct;zi||(zi=function(e,t,i){return e.apply(t,i)});de||(de=function(e){return e});Ce||(Ce=function(e){return e});_a||(_a=function(e,t){return gi(e,ye(t))});var on=we(Array.prototype.forEach),_r=we(Array.prototype.pop),Yt=we(Array.prototype.push),yi=we(String.prototype.toLowerCase),sn=we(String.prototype.match),Le=we(String.prototype.replace),nn=we(String.prototype.indexOf),ln=we(String.prototype.trim),le=we(RegExp.prototype.test),ia=dn(TypeError);function we(r){return function(e){for(var t=arguments.length,i=new Array(t>1?t-1:0),a=1;a<t;a++)i[a-1]=arguments[a];return zi(r,e,i)}}function dn(r){return function(){for(var e=arguments.length,t=new Array(e),i=0;i<e;i++)t[i]=arguments[i];return _a(r,t)}}function D(r,e){xr&&xr(r,null);for(var t=e.length;t--;){var i=e[t];if(typeof i=="string"){var a=yi(i);a!==i&&(en(e)||(e[t]=a),i=a)}r[i]=!0}return r}function qe(r){var e=rn(null),t;for(t in r)zi(Js,r,[t])&&(e[t]=r[t]);return e}function ui(r,e){for(;r!==null;){var t=an(r,e);if(t){if(t.get)return we(t.get);if(typeof t.value=="function")return we(t.value)}r=tn(r)}function i(a){return console.warn("fallback value for",a),null}return i}var Sr=de(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","section","select","shadow","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),aa=de(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","filter","font","g","glyph","glyphref","hkern","image","line","lineargradient","marker","mask","metadata","mpath","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),ra=de(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),cn=de(["animate","color-profile","cursor","discard","fedropshadow","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),oa=de(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover"]),hn=de(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),$r=de(["#text"]),Cr=de(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","face","for","headers","height","hidden","high","href","hreflang","id","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","pattern","placeholder","playsinline","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","xmlns","slot"]),sa=de(["accent-height","accumulate","additive","alignment-baseline","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),kr=de(["accent","accentunder","align","bevelled","close","columnsalign","columnlines","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lspace","lquote","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),pi=de(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),un=Ce(/\{\{[\w\W]*|[\w\W]*\}\}/gm),pn=Ce(/<%[\w\W]*|[\w\W]*%>/gm),mn=Ce(/^data-[\-\w.\u00B7-\uFFFF]/),vn=Ce(/^aria-[\-\w]+$/),fn=Ce(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|cid|xmpp):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),gn=Ce(/^(?:\w+script|data):/i),yn=Ce(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),bn=Ce(/^html$/i),wn=function(){return typeof window=="undefined"?null:window},xn=function(e,t){if(Je(e)!=="object"||typeof e.createPolicy!="function")return null;var i=null,a="data-tt-policy-suffix";t.currentScript&&t.currentScript.hasAttribute(a)&&(i=t.currentScript.getAttribute(a));var o="dompurify"+(i?"#"+i:"");try{return e.createPolicy(o,{createHTML:function(l){return l}})}catch{return console.warn("TrustedTypes policy "+o+" could not be created."),null}};function ho(){var r=arguments.length>0&&arguments[0]!==void 0?arguments[0]:wn(),e=function(h){return ho(h)};if(e.version="2.3.8",e.removed=[],!r||!r.document||r.document.nodeType!==9)return e.isSupported=!1,e;var t=r.document,i=r.document,a=r.DocumentFragment,o=r.HTMLTemplateElement,s=r.Node,l=r.Element,d=r.NodeFilter,c=r.NamedNodeMap,p=c===void 0?r.NamedNodeMap||r.MozNamedAttrMap:c,v=r.HTMLFormElement,f=r.DOMParser,w=r.trustedTypes,x=l.prototype,$=ui(x,"cloneNode"),A=ui(x,"nextSibling"),E=ui(x,"childNodes"),F=ui(x,"parentNode");if(typeof o=="function"){var N=i.createElement("template");N.content&&N.content.ownerDocument&&(i=N.content.ownerDocument)}var B=xn(w,t),Q=B?B.createHTML(""):"",re=i,_e=re.implementation,It=re.createNodeIterator,Pt=re.createDocumentFragment,Nt=re.getElementsByTagName,Rt=t.importNode,ot={};try{ot=qe(i).documentMode?i.documentMode:{}}catch{}var he={};e.isSupported=typeof F=="function"&&_e&&typeof _e.createHTMLDocument!="undefined"&&ot!==9;var He=un,Ue=pn,Bt=mn,Ht=vn,Ut=gn,st=yn,je=fn,Y=null,nt=D({},[].concat(ye(Sr),ye(aa),ye(ra),ye(oa),ye($r))),q=null,lt=D({},[].concat(ye(Cr),ye(sa),ye(kr),ye(pi))),V=Object.seal(Object.create(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),ze=null,We=null,dt=!0,Ve=!0,jt=!1,ct=!1,Ge=!1,Pi=!1,Ni=!1,ht=!1,si=!1,ni=!1,Ba=!0,Ri=!0,Wt=!1,ut={},pt=null,Ha=D({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","style","svg","template","thead","title","video","xmp"]),Ua=null,ja=D({},["audio","video","img","source","image","track"]),Bi=null,Wa=D({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),Hi="http://www.w3.org/1998/Math/MathML",Ui="http://www.w3.org/2000/svg",De="http://www.w3.org/1999/xhtml",li=De,ji=!1,mt,Co=["application/xhtml+xml","text/html"],ko="text/html",Qe,vt=null,zo=i.createElement("form"),Va=function(h){return h instanceof RegExp||h instanceof Function},Wi=function(h){vt&&vt===h||((!h||Je(h)!=="object")&&(h={}),h=qe(h),Y="ALLOWED_TAGS"in h?D({},h.ALLOWED_TAGS):nt,q="ALLOWED_ATTR"in h?D({},h.ALLOWED_ATTR):lt,Bi="ADD_URI_SAFE_ATTR"in h?D(qe(Wa),h.ADD_URI_SAFE_ATTR):Wa,Ua="ADD_DATA_URI_TAGS"in h?D(qe(ja),h.ADD_DATA_URI_TAGS):ja,pt="FORBID_CONTENTS"in h?D({},h.FORBID_CONTENTS):Ha,ze="FORBID_TAGS"in h?D({},h.FORBID_TAGS):{},We="FORBID_ATTR"in h?D({},h.FORBID_ATTR):{},ut="USE_PROFILES"in h?h.USE_PROFILES:!1,dt=h.ALLOW_ARIA_ATTR!==!1,Ve=h.ALLOW_DATA_ATTR!==!1,jt=h.ALLOW_UNKNOWN_PROTOCOLS||!1,ct=h.SAFE_FOR_TEMPLATES||!1,Ge=h.WHOLE_DOCUMENT||!1,ht=h.RETURN_DOM||!1,si=h.RETURN_DOM_FRAGMENT||!1,ni=h.RETURN_TRUSTED_TYPE||!1,Ni=h.FORCE_BODY||!1,Ba=h.SANITIZE_DOM!==!1,Ri=h.KEEP_CONTENT!==!1,Wt=h.IN_PLACE||!1,je=h.ALLOWED_URI_REGEXP||je,li=h.NAMESPACE||De,h.CUSTOM_ELEMENT_HANDLING&&Va(h.CUSTOM_ELEMENT_HANDLING.tagNameCheck)&&(V.tagNameCheck=h.CUSTOM_ELEMENT_HANDLING.tagNameCheck),h.CUSTOM_ELEMENT_HANDLING&&Va(h.CUSTOM_ELEMENT_HANDLING.attributeNameCheck)&&(V.attributeNameCheck=h.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),h.CUSTOM_ELEMENT_HANDLING&&typeof h.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements=="boolean"&&(V.allowCustomizedBuiltInElements=h.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements),mt=Co.indexOf(h.PARSER_MEDIA_TYPE)===-1?mt=ko:mt=h.PARSER_MEDIA_TYPE,Qe=mt==="application/xhtml+xml"?function(b){return b}:yi,ct&&(Ve=!1),si&&(ht=!0),ut&&(Y=D({},ye($r)),q=[],ut.html===!0&&(D(Y,Sr),D(q,Cr)),ut.svg===!0&&(D(Y,aa),D(q,sa),D(q,pi)),ut.svgFilters===!0&&(D(Y,ra),D(q,sa),D(q,pi)),ut.mathMl===!0&&(D(Y,oa),D(q,kr),D(q,pi))),h.ADD_TAGS&&(Y===nt&&(Y=qe(Y)),D(Y,h.ADD_TAGS)),h.ADD_ATTR&&(q===lt&&(q=qe(q)),D(q,h.ADD_ATTR)),h.ADD_URI_SAFE_ATTR&&D(Bi,h.ADD_URI_SAFE_ATTR),h.FORBID_CONTENTS&&(pt===Ha&&(pt=qe(pt)),D(pt,h.FORBID_CONTENTS)),Ri&&(Y["#text"]=!0),Ge&&D(Y,["html","head","body"]),Y.table&&(D(Y,["tbody"]),delete ze.tbody),de&&de(h),vt=h)},Ga=D({},["mi","mo","mn","ms","mtext"]),Qa=D({},["foreignobject","desc","title","annotation-xml"]),To=D({},["title","style","font","a","script"]),di=D({},aa);D(di,ra),D(di,cn);var Vi=D({},oa);D(Vi,hn);var Mo=function(h){var b=F(h);(!b||!b.tagName)&&(b={namespaceURI:De,tagName:"template"});var S=yi(h.tagName),H=yi(b.tagName);return h.namespaceURI===Ui?b.namespaceURI===De?S==="svg":b.namespaceURI===Hi?S==="svg"&&(H==="annotation-xml"||Ga[H]):Boolean(di[S]):h.namespaceURI===Hi?b.namespaceURI===De?S==="math":b.namespaceURI===Ui?S==="math"&&Qa[H]:Boolean(Vi[S]):h.namespaceURI===De?b.namespaceURI===Ui&&!Qa[H]||b.namespaceURI===Hi&&!Ga[H]?!1:!Vi[S]&&(To[S]||!di[S]):!1},Te=function(h){Yt(e.removed,{element:h});try{h.parentNode.removeChild(h)}catch{try{h.outerHTML=Q}catch{h.remove()}}},Ya=function(h,b){try{Yt(e.removed,{attribute:b.getAttributeNode(h),from:b})}catch{Yt(e.removed,{attribute:null,from:b})}if(b.removeAttribute(h),h==="is"&&!q[h])if(ht||si)try{Te(b)}catch{}else try{b.setAttribute(h,"")}catch{}},Ka=function(h){var b,S;if(Ni)h="<remove></remove>"+h;else{var H=sn(h,/^[\r\n\t ]+/);S=H&&H[0]}mt==="application/xhtml+xml"&&(h='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+h+"</body></html>");var ue=B?B.createHTML(h):h;if(li===De)try{b=new f().parseFromString(ue,mt)}catch{}if(!b||!b.documentElement){b=_e.createDocument(li,"template",null);try{b.documentElement.innerHTML=ji?"":ue}catch{}}var oe=b.body||b.documentElement;return h&&S&&oe.insertBefore(i.createTextNode(S),oe.childNodes[0]||null),li===De?Nt.call(b,Ge?"html":"body")[0]:Ge?b.documentElement:oe},qa=function(h){return It.call(h.ownerDocument||h,h,d.SHOW_ELEMENT|d.SHOW_COMMENT|d.SHOW_TEXT,null,!1)},Ao=function(h){return h instanceof v&&(typeof h.nodeName!="string"||typeof h.textContent!="string"||typeof h.removeChild!="function"||!(h.attributes instanceof p)||typeof h.removeAttribute!="function"||typeof h.setAttribute!="function"||typeof h.namespaceURI!="string"||typeof h.insertBefore!="function")},Vt=function(h){return Je(s)==="object"?h instanceof s:h&&Je(h)==="object"&&typeof h.nodeType=="number"&&typeof h.nodeName=="string"},Me=function(h,b,S){!he[h]||on(he[h],function(H){H.call(e,b,S,vt)})},Za=function(h){var b;if(Me("beforeSanitizeElements",h,null),Ao(h)||le(/[\u0080-\uFFFF]/,h.nodeName))return Te(h),!0;var S=Qe(h.nodeName);if(Me("uponSanitizeElement",h,{tagName:S,allowedTags:Y}),h.hasChildNodes()&&!Vt(h.firstElementChild)&&(!Vt(h.content)||!Vt(h.content.firstElementChild))&&le(/<[/\w]/g,h.innerHTML)&&le(/<[/\w]/g,h.textContent)||S==="select"&&le(/<template/i,h.innerHTML))return Te(h),!0;if(!Y[S]||ze[S]){if(!ze[S]&&Ja(S)&&(V.tagNameCheck instanceof RegExp&&le(V.tagNameCheck,S)||V.tagNameCheck instanceof Function&&V.tagNameCheck(S)))return!1;if(Ri&&!pt[S]){var H=F(h)||h.parentNode,ue=E(h)||h.childNodes;if(ue&&H)for(var oe=ue.length,te=oe-1;te>=0;--te)H.insertBefore($(ue[te],!0),A(h))}return Te(h),!0}return h instanceof l&&!Mo(h)||(S==="noscript"||S==="noembed")&&le(/<\/no(script|embed)/i,h.innerHTML)?(Te(h),!0):(ct&&h.nodeType===3&&(b=h.textContent,b=Le(b,He," "),b=Le(b,Ue," "),h.textContent!==b&&(Yt(e.removed,{element:h.cloneNode()}),h.textContent=b)),Me("afterSanitizeElements",h,null),!1)},Xa=function(h,b,S){if(Ba&&(b==="id"||b==="name")&&(S in i||S in zo))return!1;if(!(Ve&&!We[b]&&le(Bt,b))){if(!(dt&&le(Ht,b))){if(!q[b]||We[b]){if(!(Ja(h)&&(V.tagNameCheck instanceof RegExp&&le(V.tagNameCheck,h)||V.tagNameCheck instanceof Function&&V.tagNameCheck(h))&&(V.attributeNameCheck instanceof RegExp&&le(V.attributeNameCheck,b)||V.attributeNameCheck instanceof Function&&V.attributeNameCheck(b))||b==="is"&&V.allowCustomizedBuiltInElements&&(V.tagNameCheck instanceof RegExp&&le(V.tagNameCheck,S)||V.tagNameCheck instanceof Function&&V.tagNameCheck(S))))return!1}else if(!Bi[b]){if(!le(je,Le(S,st,""))){if(!((b==="src"||b==="xlink:href"||b==="href")&&h!=="script"&&nn(S,"data:")===0&&Ua[h])){if(!(jt&&!le(Ut,Le(S,st,"")))){if(S)return!1}}}}}}return!0},Ja=function(h){return h.indexOf("-")>0},er=function(h){var b,S,H,ue;Me("beforeSanitizeAttributes",h,null);var oe=h.attributes;if(!!oe){var te={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:q};for(ue=oe.length;ue--;){b=oe[ue];var ci=b,ne=ci.name,tr=ci.namespaceURI;if(S=ne==="value"?b.value:ln(b.value),H=Qe(ne),te.attrName=H,te.attrValue=S,te.keepAttr=!0,te.forceKeepAttr=void 0,Me("uponSanitizeAttribute",h,te),S=te.attrValue,!te.forceKeepAttr&&(Ya(ne,h),!!te.keepAttr)){if(le(/\/>/i,S)){Ya(ne,h);continue}ct&&(S=Le(S,He," "),S=Le(S,Ue," "));var Do=Qe(h.nodeName);if(!!Xa(Do,H,S))try{tr?h.setAttributeNS(tr,ne,S):h.setAttribute(ne,S),_r(e.removed)}catch{}}}Me("afterSanitizeAttributes",h,null)}},Eo=function C(h){var b,S=qa(h);for(Me("beforeSanitizeShadowDOM",h,null);b=S.nextNode();)Me("uponSanitizeShadowNode",b,null),!Za(b)&&(b.content instanceof a&&C(b.content),er(b));Me("afterSanitizeShadowDOM",h,null)};return e.sanitize=function(C,h){var b,S,H,ue,oe;if(ji=!C,ji&&(C="<!-->"),typeof C!="string"&&!Vt(C)){if(typeof C.toString!="function")throw ia("toString is not a function");if(C=C.toString(),typeof C!="string")throw ia("dirty is not a string, aborting")}if(!e.isSupported){if(Je(r.toStaticHTML)==="object"||typeof r.toStaticHTML=="function"){if(typeof C=="string")return r.toStaticHTML(C);if(Vt(C))return r.toStaticHTML(C.outerHTML)}return C}if(Pi||Wi(h),e.removed=[],typeof C=="string"&&(Wt=!1),Wt){if(C.nodeName){var te=Qe(C.nodeName);if(!Y[te]||ze[te])throw ia("root node is forbidden and cannot be sanitized in-place")}}else if(C instanceof s)b=Ka("<!---->"),S=b.ownerDocument.importNode(C,!0),S.nodeType===1&&S.nodeName==="BODY"||S.nodeName==="HTML"?b=S:b.appendChild(S);else{if(!ht&&!ct&&!Ge&&C.indexOf("<")===-1)return B&&ni?B.createHTML(C):C;if(b=Ka(C),!b)return ht?null:ni?Q:""}b&&Ni&&Te(b.firstChild);for(var ci=qa(Wt?C:b);H=ci.nextNode();)H.nodeType===3&&H===ue||Za(H)||(H.content instanceof a&&Eo(H.content),er(H),ue=H);if(ue=null,Wt)return C;if(ht){if(si)for(oe=Pt.call(b.ownerDocument);b.firstChild;)oe.appendChild(b.firstChild);else oe=b;return q.shadowroot&&(oe=Rt.call(t,oe,!0)),oe}var ne=Ge?b.outerHTML:b.innerHTML;return Ge&&Y["!doctype"]&&b.ownerDocument&&b.ownerDocument.doctype&&b.ownerDocument.doctype.name&&le(bn,b.ownerDocument.doctype.name)&&(ne="<!DOCTYPE "+b.ownerDocument.doctype.name+`>
`+ne),ct&&(ne=Le(ne,He," "),ne=Le(ne,Ue," ")),B&&ni?B.createHTML(ne):ne},e.setConfig=function(C){Wi(C),Pi=!0},e.clearConfig=function(){vt=null,Pi=!1},e.isValidAttribute=function(C,h,b){vt||Wi({});var S=Qe(C),H=Qe(h);return Xa(S,H,b)},e.addHook=function(C,h){typeof h=="function"&&(he[C]=he[C]||[],Yt(he[C],h))},e.removeHook=function(C){if(he[C])return _r(he[C])},e.removeHooks=function(C){he[C]&&(he[C]=[])},e.removeAllHooks=function(){he={}},e}var Xt=ho(),L;(function(r){r.relevance="relevance",r.alltimeview="alltimeview",r.weeklyview="weeklyview",r.title="title",r.datearchived="datearchived",r.date="date",r.datereviewed="datereviewed",r.dateadded="dateadded",r.creator="creator"})(L||(L={}));const Ze={relevance:"Relevance",alltimeview:"All-time Views",weeklyview:"Weekly Views",title:"Title",datearchived:"Date Archived",date:"Date Published",datereviewed:"Date Reviewed",dateadded:"Date Added",creator:"Creator"},_n={relevance:null,alltimeview:"downloads",weeklyview:"week",title:"titleSorter",datearchived:"publicdate",date:"date",datereviewed:"reviewdate",dateadded:"addeddate",creator:"creatorSorter"},zr={week:L.weeklyview,downloads:L.alltimeview,titleSorter:L.title,date:L.date,publicdate:L.datearchived,reviewdate:L.datereviewed,addeddate:L.dateadded,creatorSorter:L.creator},Ti={subject:{},lending:{},mediatype:{},language:{},creator:{},collection:{},year:{}},Sn=["mediatype","lending","year","subject","collection","creator","language"],Mi={subject:"Subject",lending:"Availability",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"},$n={is_lendable:!0,is_borrowable:!1,available_to_borrow:!0,is_browsable:!1,available_to_browse:!1,is_readable:!0,available_to_waitlist:!1},Tr={is_lendable:"Lending Library",available_to_borrow:"Borrow 14 Days",is_readable:"Always Available"},Fa={deemphasize:!0,community:!0,stream_only:!0,samples_only:!0,test_collection:!0,printdisabled:!0,"openlibrary-ol":!0,nationalemergencylibrary:!0,china:!0,americana:!0,toronto:!0};function uo(r){switch(r){case"date":return"Published";case"reviewdate":return"Reviewed";case"addeddate":return"Added";default:return"Archived"}}function po(r){return r?`Archivist since ${r.getFullYear()}`:""}let ge=class extends O{constructor(){super(...arguments),this.sortParam=null,this.collectionLinks=[],this.loggedIn=!1}updated(e){e.has("model")&&this.fetchCollectionNames()}async fetchCollectionNames(){var e,t;if(!(!((e=this.model)===null||e===void 0)&&e.collections)||this.model.collections.length===0||!this.collectionNameCache)return;this.collectionLinks=[];const i=[],a=[];for(const o of this.model.collections)Fa[o]||a.push((t=this.collectionNameCache)===null||t===void 0?void 0:t.collectionNameFor(o).then(s=>{i.push(this.detailsLink(o,s!=null?s:o))}));await Promise.all(a),this.collectionLinks=i}render(){return m`
    ...
    `}};n([u({type:Object})],ge.prototype,"model",void 0);n([u({type:String})],ge.prototype,"baseNavigationUrl",void 0);n([u({type:Object})],ge.prototype,"collectionNameCache",void 0);n([u({type:Number})],ge.prototype,"currentWidth",void 0);n([u({type:Number})],ge.prototype,"currentHeight",void 0);n([u({type:Object})],ge.prototype,"sortParam",void 0);n([u({type:Number})],ge.prototype,"mobileBreakpoint",void 0);n([T()],ge.prototype,"collectionLinks",void 0);n([u({type:String})],ge.prototype,"baseImageUrl",void 0);n([u({type:Boolean})],ge.prototype,"loggedIn",void 0);ge=n([R("tile-list")],ge);let ke=class extends O{constructor(){super(...arguments),this.sortParam=null,this.loggedIn=!1}render(){var e,t,i,a,o,s,l,d,c;return m`
      <div id="list-line" class="${this.classSize}">
        <image-block
          .model=${this.model}
          .baseImageUrl=${this.baseImageUrl}
        ...
        <div id="title">${Xt.sanitize((t=(e=this.model)===null||e===void 0?void 0:e.title)!==null&&t!==void 0?t:"")}</div>
        <div id="creator">
          ${((i=this.model)===null||i===void 0?void 0:i.mediatype)==="account"?po((a=this.model)===null||a===void 0?void 0:a.dateAdded):Xt.sanitize((s=(o=this.model)===null||o===void 0?void 0:o.creator)!==null&&s!==void 0?s:"")}
        </div>
    ...
    `}};n([u({type:Object})],Mt.prototype,"model",void 0);n([u({type:Number})],Mt.prototype,"currentWidth",void 0);n([u({type:Object})],Mt.prototype,"sortParam",void 0);n([u({type:Number})],Mt.prototype,"mobileBreakpoint",void 0);Mt=n([R("tile-list-compact-header")],Mt);let me=class extends O{constructor(){super(...arguments),this.sortParam=null,this.loggedIn=!1}render(){return m`
      <div id="container">
    ...
    `}};n([u({type:String})],me.prototype,"tileDisplayMode",void 0);n([u({type:Object})],me.prototype,"model",void 0);n([u({type:String})],me.prototype,"baseNavigationUrl",void 0);n([u({type:Number})],me.prototype,"currentWidth",void 0);n([u({type:Number})],me.prototype,"currentHeight",void 0);n([u({type:Object})],me.prototype,"resizeObserver",void 0);n([u({type:Object})],me.prototype,"collectionNameCache",void 0);n([u({type:Object})],me.prototype,"sortParam",void 0);n([ce("#container")],me.prototype,"container",void 0);n([u({type:Number})],me.prototype,"mobileBreakpoint",void 0);n([u({type:String})],me.prototype,"baseImageUrl",void 0);n([u({type:Boolean})],me.prototype,"loggedIn",void 0);me=n([R("tile-dispatcher")],me);let Mr=class extends O{render(){return m` <div id="container"></div> `}static get styles(){return y`
      :host {
        display: block;
        height: 100%;
      }
    ...
    `}};Mr=n([R("collection-browser-loading-tile")],Mr);let Ai=class extends O{constructor(){super(...arguments),this.selectedLetter=null,this.alphabet="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("")}get selectedUppercaseLetter(){var e;return(e=this.selectedLetter)===null||e===void 0?void 0:e.toUpperCase()}render(){return m`
      <div id="container">
        <ul>
  ...
  `;n([u({type:String})],Ai.prototype,"selectedLetter",void 0);Ai=n([R("alpha-bar")],Ai);const Ar=I`
...
`;let ee=class extends O{constructor(){super(...arguments),this.sortDirection=null,this.selectedSort=L.relevance,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.showRelevance=!0,this.alphaSelectorVisible=null,this.dateSortSelectorVisible=!1,this.viewSortSelectorVisible=!1,this.desktopSelectorBarWidth=0,this.selectorBarContainerWidth=0,this.hoveringOverDateSortOptions=!1,this.boundSortBarSelectorEscapeListener=e=>{e.key==="Escape"&&(this.viewSortSelectorVisible=!1,this.dateSortSelectorVisible=!1)}}render(){return m`
  ...
  `;n([u({type:String})],ee.prototype,"displayMode",void 0);n([u({type:String})],ee.prototype,"sortDirection",void 0);n([u({type:String})],ee.prototype,"selectedSort",void 0);n([u({type:String})],ee.prototype,"selectedTitleFilter",void 0);n([u({type:String})],ee.prototype,"selectedCreatorFilter",void 0);n([u({type:Boolean})],ee.prototype,"showRelevance",void 0);n([u({type:Object})],ee.prototype,"resizeObserver",void 0);n([T()],ee.prototype,"alphaSelectorVisible",void 0);n([T()],ee.prototype,"dateSortSelectorVisible",void 0);n([T()],ee.prototype,"viewSortSelectorVisible",void 0);n([T()],ee.prototype,"desktopSelectorBarWidth",void 0);n([T()],ee.prototype,"selectorBarContainerWidth",void 0);n([T()],ee.prototype,"hoveringOverDateSortOptions",void 0);n([ce("#desktop-sort-selector")],ee.prototype,"desktopSortSelector",void 0);n([ce("#sort-selector-container")],ee.prototype,"sortSelectorContainer",void 0);ee=n([R("sort-filter-bar")],ee);/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Er=Da(class extends La{constructor(r){if(super(r),r.type!==Fe.PROPERTY&&r.type!==Fe.ATTRIBUTE&&r.type!==Fe.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!fs(r))throw Error("`live` bindings can only contain a single expression")}render(r){return r}update(r,[e]){if(e===fe||e===_)return e;const t=r.element,i=r.name;if(r.type===Fe.PROPERTY){if(e===t[i])return fe}else if(r.type===Fe.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(i))return fe}else if(r.type===Fe.ATTRIBUTE&&t.getAttribute(i)===e+"")return fe;return so(r),e}});var mo=60,vo=mo*60,fo=vo*24,Tn=fo*7,At=1e3,na=mo*At,Dr=vo*At,Mn=fo*At,An=Tn*At,Oa="millisecond",wt="second",xt="minute",_t="hour",Oe="day",bi="week",be="month",go="quarter",Ie="year",St="date",En="YYYY-MM-DDTHH:mm:ssZ",Lr="Invalid Date",Dn=/^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/,Ln=/\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g,Fn={name:"en",weekdays:"Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),months:"January_February_March_April_May_June_July_August_September_October_November_December".split("_")},Sa=function(e,t,i){var a=String(e);return!a||a.length>=t?e:""+Array(t+1-a.length).join(i)+e},On=function(e){var t=-e.utcOffset(),i=Math.abs(t),a=Math.floor(i/60),o=i%60;return(t<=0?"+":"-")+Sa(a,2,"0")+":"+Sa(o,2,"0")},In=function r(e,t){if(e.date()<t.date())return-r(t,e);var i=(t.year()-e.year())*12+(t.month()-e.month()),a=e.clone().add(i,be),o=t-a<0,s=e.clone().add(i+(o?-1:1),be);return+(-(i+(t-a)/(o?a-s:s-a))||0)},Pn=function(e){return e<0?Math.ceil(e)||0:Math.floor(e)},Nn=function(e){var t={M:be,y:Ie,w:bi,d:Oe,D:St,h:_t,m:xt,s:wt,ms:Oa,Q:go};return t[e]||String(e||"").toLowerCase().replace(/s$/,"")},Rn=function(e){return e===void 0},Bn={s:Sa,z:On,m:In,a:Pn,p:Nn,u:Rn},Jt="en",et={};et[Jt]=Fn;var Ia=function(e){return e instanceof Ii},Ei=function r(e,t,i){var a;if(!e)return Jt;if(typeof e=="string"){var o=e.toLowerCase();et[o]&&(a=o),t&&(et[o]=t,a=o);var s=e.split("-");if(!a&&s.length>1)return r(s[0])}else{var l=e.name;et[l]=e,a=l}return!i&&a&&(Jt=a),a||!i&&Jt},X=function(e,t){if(Ia(e))return e.clone();var i=typeof t=="object"?t:{};return i.date=e,i.args=arguments,new Ii(i)},Hn=function(e,t){return X(e,{locale:t.$L,utc:t.$u,x:t.$x,$offset:t.$offset})},U=Bn;U.l=Ei;U.i=Ia;U.w=Hn;var Un=function(e){var t=e.date,i=e.utc;if(t===null)return new Date(NaN);if(U.u(t))return new Date;if(t instanceof Date)return new Date(t);if(typeof t=="string"&&!/Z$/i.test(t)){var a=t.match(Dn);if(a){var o=a[2]-1||0,s=(a[7]||"0").substring(0,3);return i?new Date(Date.UTC(a[1],o,a[3]||1,a[4]||0,a[5]||0,a[6]||0,s)):new Date(a[1],o,a[3]||1,a[4]||0,a[5]||0,a[6]||0,s)}}return new Date(t)},Ii=function(){function r(t){this.$L=Ei(t.locale,null,!0),this.parse(t)}var e=r.prototype;return e.parse=function(i){this.$d=Un(i),this.$x=i.x||{},this.init()},e.init=function(){var i=this.$d;this.$y=i.getFullYear(),this.$M=i.getMonth(),this.$D=i.getDate(),this.$W=i.getDay(),this.$H=i.getHours(),this.$m=i.getMinutes(),this.$s=i.getSeconds(),this.$ms=i.getMilliseconds()},e.$utils=function(){return U},e.isValid=function(){return this.$d.toString()!==Lr},e.isSame=function(i,a){var o=X(i);return this.startOf(a)<=o&&o<=this.endOf(a)},e.isAfter=function(i,a){return X(i)<this.startOf(a)},e.isBefore=function(i,a){return this.endOf(a)<X(i)},e.$g=function(i,a,o){return U.u(i)?this[a]:this.set(o,i)},e.unix=function(){return Math.floor(this.valueOf()/1e3)},e.valueOf=function(){return this.$d.getTime()},e.startOf=function(i,a){var o=this,s=U.u(a)?!0:a,l=U.p(i),d=function(E,F){var N=U.w(o.$u?Date.UTC(o.$y,F,E):new Date(o.$y,F,E),o);return s?N:N.endOf(Oe)},c=function(E,F){var N=[0,0,0,0],B=[23,59,59,999];return U.w(o.toDate()[E].apply(o.toDate("s"),(s?N:B).slice(F)),o)},p=this.$W,v=this.$M,f=this.$D,w="set"+(this.$u?"UTC":"");switch(l){case Ie:return s?d(1,0):d(31,11);case be:return s?d(1,v):d(0,v+1);case bi:{var x=this.$locale().weekStart||0,$=(p<x?p+7:p)-x;return d(s?f-$:f+(6-$),v)}case Oe:case St:return c(w+"Hours",0);case _t:return c(w+"Minutes",1);case xt:return c(w+"Seconds",2);case wt:return c(w+"Milliseconds",3);default:return this.clone()}},e.endOf=function(i){return this.startOf(i,!1)},e.$set=function(i,a){var o,s=U.p(i),l="set"+(this.$u?"UTC":""),d=(o={},o[Oe]=l+"Date",o[St]=l+"Date",o[be]=l+"Month",o[Ie]=l+"FullYear",o[_t]=l+"Hours",o[xt]=l+"Minutes",o[wt]=l+"Seconds",o[Oa]=l+"Milliseconds",o)[s],c=s===Oe?this.$D+(a-this.$W):a;if(s===be||s===Ie){var p=this.clone().set(St,1);p.$d[d](c),p.init(),this.$d=p.set(St,Math.min(this.$D,p.daysInMonth())).$d}else d&&this.$d[d](c);return this.init(),this},e.set=function(i,a){return this.clone().$set(i,a)},e.get=function(i){return this[U.p(i)]()},e.add=function(i,a){var o=this,s;i=Number(i);var l=U.p(a),d=function(f){var w=X(o);return U.w(w.date(w.date()+Math.round(f*i)),o)};if(l===be)return this.set(be,this.$M+i);if(l===Ie)return this.set(Ie,this.$y+i);if(l===Oe)return d(1);if(l===bi)return d(7);var c=(s={},s[xt]=na,s[_t]=Dr,s[wt]=At,s)[l]||1,p=this.$d.getTime()+i*c;return U.w(p,this)},e.subtract=function(i,a){return this.add(i*-1,a)},e.format=function(i){var a=this,o=this.$locale();if(!this.isValid())return o.invalidDate||Lr;var s=i||En,l=U.z(this),d=this.$H,c=this.$m,p=this.$M,v=o.weekdays,f=o.months,w=o.meridiem,x=function(N,B,Q,re){return N&&(N[B]||N(a,s))||Q[B].slice(0,re)},$=function(N){return U.s(d%12||12,N,"0")},A=w||function(F,N,B){var Q=F<12?"AM":"PM";return B?Q.toLowerCase():Q},E={YY:String(this.$y).slice(-2),YYYY:this.$y,M:p+1,MM:U.s(p+1,2,"0"),MMM:x(o.monthsShort,p,f,3),MMMM:x(f,p),D:this.$D,DD:U.s(this.$D,2,"0"),d:String(this.$W),dd:x(o.weekdaysMin,this.$W,v,2),ddd:x(o.weekdaysShort,this.$W,v,3),dddd:v[this.$W],H:String(d),HH:U.s(d,2,"0"),h:$(1),hh:$(2),a:A(d,c,!0),A:A(d,c,!1),m:String(c),mm:U.s(c,2,"0"),s:String(this.$s),ss:U.s(this.$s,2,"0"),SSS:U.s(this.$ms,3,"0"),Z:l};return s.replace(Ln,function(F,N){return N||E[F]||l.replace(":","")})},e.utcOffset=function(){return-Math.round(this.$d.getTimezoneOffset()/15)*15},e.diff=function(i,a,o){var s,l=U.p(a),d=X(i),c=(d.utcOffset()-this.utcOffset())*na,p=this-d,v=U.m(this,d);return v=(s={},s[Ie]=v/12,s[be]=v,s[go]=v/3,s[bi]=(p-c)/An,s[Oe]=(p-c)/Mn,s[_t]=p/Dr,s[xt]=p/na,s[wt]=p/At,s)[l]||p,o?v:U.a(v)},e.daysInMonth=function(){return this.endOf(be).$D},e.$locale=function(){return et[this.$L]},e.locale=function(i,a){if(!i)return this.$L;var o=this.clone(),s=Ei(i,a,!0);return s&&(o.$L=s),o},e.clone=function(){return U.w(this.$d,this)},e.toDate=function(){return new Date(this.valueOf())},e.toJSON=function(){return this.isValid()?this.toISOString():null},e.toISOString=function(){return this.$d.toISOString()},e.toString=function(){return this.$d.toUTCString()},r}(),yo=Ii.prototype;X.prototype=yo;[["$ms",Oa],["$s",wt],["$m",xt],["$H",_t],["$W",Oe],["$M",be],["$y",Ie],["$D",St]].forEach(function(r){yo[r[1]]=function(e){return this.$g(e,r[0],r[1])}});X.extend=function(r,e){return r.$i||(r(e,Ii,X),r.$i=!0),X};X.locale=Ei;X.isDayjs=Ia;X.unix=function(r){return X(r*1e3)};X.en=et[Jt];X.Ls=et;X.p={};var jn=function(e){return e.replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g,function(t,i,a){return i||a.slice(1)})},Wn={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"},Vn=function(e,t){return e.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g,function(i,a,o){var s=o&&o.toUpperCase();return a||t[o]||Wn[o]||jn(t[s])})},Gn=/(\[[^[]*\])|([-:/.()\s]+)|(A|a|YYYY|YY?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g,Qn=/\d/,mi=/\d\d/,Yn=/\d{3}/,Kn=/\d{4}/,Se=/\d\d?/,qn=/[+-]?\d+/,Zn=/[+-]\d\d:?(\d\d)?|Z/,Kt=/\d*[^\s\d-_:/()]+/,Ne={},bo=function(e){return e=+e,e+(e>68?1900:2e3)};function Xn(r){if(!r||r==="Z")return 0;var e=r.match(/([+-]|\d\d)/g),t=+(e[1]*60)+(+e[2]||0);return t===0?0:e[0]==="+"?-t:t}var pe=function(e){return function(t){this[e]=+t}},Fr=[Zn,function(r){var e=this.zone||(this.zone={});e.offset=Xn(r)}],la=function(e){var t=Ne[e];return t&&(t.indexOf?t:t.s.concat(t.f))},Or=function(e,t){var i,a=Ne,o=a.meridiem;if(!o)i=e===(t?"pm":"PM");else for(var s=1;s<=24;s+=1)if(e.indexOf(o(s,0,t))>-1){i=s>12;break}return i},Jn={A:[Kt,function(r){this.afternoon=Or(r,!1)}],a:[Kt,function(r){this.afternoon=Or(r,!0)}],S:[Qn,function(r){this.milliseconds=+r*100}],SS:[mi,function(r){this.milliseconds=+r*10}],SSS:[Yn,function(r){this.milliseconds=+r}],s:[Se,pe("seconds")],ss:[Se,pe("seconds")],m:[Se,pe("minutes")],mm:[Se,pe("minutes")],H:[Se,pe("hours")],h:[Se,pe("hours")],HH:[Se,pe("hours")],hh:[Se,pe("hours")],D:[Se,pe("day")],DD:[mi,pe("day")],Do:[Kt,function(r){var e=Ne,t=e.ordinal,i=r.match(/\d+/);if(this.day=i[0],!!t)for(var a=1;a<=31;a+=1)t(a).replace(/\[|\]/g,"")===r&&(this.day=a)}],M:[Se,pe("month")],MM:[mi,pe("month")],MMM:[Kt,function(r){var e=la("months"),t=la("monthsShort"),i=(t||e.map(function(a){return a.slice(0,3)})).indexOf(r)+1;if(i<1)throw new Error;this.month=i%12||i}],MMMM:[Kt,function(r){var e=la("months"),t=e.indexOf(r)+1;if(t<1)throw new Error;this.month=t%12||t}],Y:[qn,pe("year")],YY:[mi,function(r){this.year=bo(r)}],YYYY:[Kn,pe("year")],Z:Fr,ZZ:Fr};function el(r){var e=r.afternoon;if(e!==void 0){var t=r.hours;e?t<12&&(r.hours+=12):t===12&&(r.hours=0),delete r.afternoon}}function tl(r){r=Vn(r,Ne&&Ne.formats);for(var e=r.match(Gn),t=e.length,i=0;i<t;i+=1){var a=e[i],o=Jn[a],s=o&&o[0],l=o&&o[1];l?e[i]={regex:s,parser:l}:e[i]=a.replace(/^\[|\]$/g,"")}return function(d){for(var c={},p=0,v=0;p<t;p+=1){var f=e[p];if(typeof f=="string")v+=f.length;else{var w=f.regex,x=f.parser,$=d.slice(v),A=w.exec($),E=A[0];x.call(c,E),d=d.replace(E,"")}}return el(c),c}}var il=function(e,t,i){try{if(["x","X"].indexOf(t)>-1)return new Date((t==="X"?1e3:1)*e);var a=tl(t),o=a(e),s=o.year,l=o.month,d=o.day,c=o.hours,p=o.minutes,v=o.seconds,f=o.milliseconds,w=o.zone,x=new Date,$=d||(!s&&!l?x.getDate():1),A=s||x.getFullYear(),E=0;s&&!l||(E=l>0?l-1:x.getMonth());var F=c||0,N=p||0,B=v||0,Q=f||0;return w?new Date(Date.UTC(A,E,$,F,N,B,Q+w.offset*60*1e3)):i?new Date(Date.UTC(A,E,$,F,N,B,Q)):new Date(A,E,$,F,N,B,Q)}catch{return new Date("")}},al=function(r,e,t){t.p.customParseFormat=!0,r&&r.parseTwoDigitYear&&(bo=r.parseTwoDigitYear);var i=e.prototype,a=i.parse;i.parse=function(o){var s=o.date,l=o.utc,d=o.args;this.$u=l;var c=d[1];if(typeof c=="string"){var p=d[2]===!0,v=d[3]===!0,f=p||v,w=d[2];v&&(w=d[2]),Ne=this.$locale(),!p&&w&&(Ne=t.Ls[w]),this.$d=il(s,c,l),this.init(),w&&w!==!0&&(this.$L=this.locale(w).$L),f&&s!=this.format(c)&&(this.$d=new Date("")),Ne={}}else if(c instanceof Array)for(var x=c.length,$=1;$<=x;$+=1){d[1]=c[$-1];var A=t.apply(this,d);if(A.isValid()){this.$d=A.$d,this.$L=A.$L,this.init();break}$===x&&(this.$d=new Date(""))}else a.call(this,o)}};const rl=Object.freeze({processing:"processing",complete:"complete"});class ol extends O{static get properties(){return{mode:{type:String}}}constructor(){super(),this.mode=rl.processing}render(){return m`
      <div class="${this.mode}">
        <svg
          viewBox="0 0 120 120"
    ...
    `}get selectedRangeTemplate(){return I`
      ...
      />`}get histogramTemplate(){const e=this._histWidth/this._numBins,t=e-1;let i=this.sliderWidth;return this._histData.map(a=>{const o=I`
        <rect
          ...
          fill="${i+t>=this.minSliderX&&i<=this.maxSliderX?vl:gl}"
    ...
    ia-activity-indicator {
      ...
      --activityIndicatorLoadingRingColor: ${fl};
    }
...
`;let Z=class extends O{constructor(){super(...arguments),this.prompt="Do you find this feature useful?",this.buttonText="Beta",this.isOpen=!1,this.processing=!1,this.popupTopX=0,this.popupTopY=0,this.voteSubmitted=!1,this.voteNeedsChoosing=!1,this.resizingElement=document.body}render(){return m`
    ...
    `}};n([u({type:String})],Z.prototype,"featureIdentifier",void 0);n([u({type:String})],Z.prototype,"prompt",void 0);n([u({type:String})],Z.prototype,"buttonText",void 0);n([u({type:Object})],Z.prototype,"recaptchaManager",void 0);n([u({type:Object})],Z.prototype,"resizeObserver",void 0);n([u({type:Boolean})],Z.prototype,"disabled",void 0);n([u({type:Object})],Z.prototype,"featureFeedbackService",void 0);n([ce("#beta-button")],Z.prototype,"betaButton",void 0);n([ce("#popup")],Z.prototype,"popup",void 0);n([T()],Z.prototype,"isOpen",void 0);n([T()],Z.prototype,"processing",void 0);n([T()],Z.prototype,"popupTopX",void 0);n([T()],Z.prototype,"popupTopY",void 0);n([T()],Z.prototype,"vote",void 0);n([T()],Z.prototype,"voteSubmitted",void 0);n([T()],Z.prototype,"error",void 0);n([T()],Z.prototype,"voteNeedsChoosing",void 0);n([T()],Z.prototype,"recaptchaWidget",void 0);n([ce("#comments")],Z.prototype,"comments",void 0);Z=n([R("feature-feedback")],Z);class wo{constructor(e){var t,i,a,o,s,l,d;this.title=e==null?void 0:e.title,this.subtitle=e==null?void 0:e.subtitle,this.headline=e==null?void 0:e.headline,this.message=e==null?void 0:e.message,this.headerColor=(t=e==null?void 0:e.headerColor)!==null&&t!==void 0?t:"#55A183",this.bodyColor=(i=e==null?void 0:e.bodyColor)!==null&&i!==void 0?i:"#f5f5f7",this.showProcessingIndicator=(a=e==null?void 0:e.showProcessingIndicator)!==null&&a!==void 0?a:!1,this.processingImageMode=(o=e==null?void 0:e.processingImageMode)!==null&&o!==void 0?o:"complete",this.showCloseButton=(s=e==null?void 0:e.showCloseButton)!==null&&s!==void 0?s:!0,this.showHeaderLogo=(l=e==null?void 0:e.showHeaderLogo)!==null&&l!==void 0?l:!0,this.closeOnBackdropClick=(d=e==null?void 0:e.closeOnBackdropClick)!==null&&d!==void 0?d:!0}}var $l=m`
<svg
  viewBox="0 0 40 40"
  version="1.1"
  xmlns="http://www.w3.org/2000/svg"
...
`;let $a=class extends O{constructor(){super(...arguments),this.config=new wo}render(){return m`
      <div class="modal-wrapper">
        <div class="modal-container">
          <header style="background-color: ${this.config.headerColor}">
            ${this.config.showCloseButton?this.closeButtonTemplate:""}
            ${this.config.showHeaderLogo?m`<div class="logo-icon">${Cl}</div>`:_}
    ...
    `}static get styles(){const e=y`var(--modalLogoSize, 6.5rem)`,t=y`var(--processingImageSize, 7.5rem)`,i=y`var(--modalCornerRadius, 1rem)`,a=y`var(--modalBorder, 2px solid black)`,o=y`var(--modalBottomMargin, 2.5rem)`,s=y`var(--modalTopMargin, 5rem)`,l=y`var(--modalHeaderBottomPadding, 0.5em)`,d=y`var(--modalBottomPadding, 2rem)`,c=y`var(--modalScrollOffset, 5px)`,p=y`var(--modalTitleFontSize, 1.8rem)`,v=y`var(--modalSubtitleFontSize, 1.4rem)`,f=y`var(--modalHeadlineFontSize, 1.6rem)`,w=y`var(--modalMessageFontSize, 1.4rem)`,x=y`var(--modalTitleLineHeight, normal)`,$=y`var(--modalSubtitleLineHeight, normal)`,A=y`var(--modalHeadlineLineHeight, normal)`,E=y`var(--modalMessageLineHeight, normal)`;return y`
      .processing-logo {
        margin: auto;
        width: ${t};
        height: ${t};
    ...
    `}};n([u({type:Object})],$a.prototype,"config",void 0);$a=n([R("modal-template")],$a);function kl(r,e,t){var i=t||{},a=i.noTrailing,o=a===void 0?!1:a,s=i.noLeading,l=s===void 0?!1:s,d=i.debounceMode,c=d===void 0?void 0:d,p,v=!1,f=0;function w(){p&&clearTimeout(p)}function x(A){var E=A||{},F=E.upcomingOnly,N=F===void 0?!1:F;w(),v=!N}function $(){for(var A=arguments.length,E=new Array(A),F=0;F<A;F++)E[F]=arguments[F];var N=this,B=Date.now()-f;if(v)return;function Q(){f=Date.now(),e.apply(N,E)}function re(){p=void 0}!l&&c&&!p&&Q(),w(),c===void 0&&B>r?l?(f=Date.now(),o||(p=setTimeout(c?re:Q,r))):Q():o!==!0&&(p=setTimeout(c?re:Q,c===void 0?r-B:r))}return $.cancel=x,$}var tt;(function(r){r.Open="open",r.Closed="closed"})(tt||(tt={}));class zl{constructor(e){this.windowResizeThrottler=kl(100,this.updateModalContainerHeight).bind(this),this.modalManager=e}handleModeChange(e){switch(e){case tt.Open:this.startResizeListener(),this.stopDocumentScroll();break;case tt.Closed:this.stopResizeListener(),this.resumeDocumentScroll();break}}updateModalContainerHeight(){this.modalManager.style.setProperty("--containerHeight",`${window.innerHeight}px`)}stopDocumentScroll(){document.body.classList.add("modal-manager-open")}resumeDocumentScroll(){document.body.classList.remove("modal-manager-open")}startResizeListener(){window.addEventListener("resize",this.windowResizeThrottler)}stopResizeListener(){window.removeEventListener("resize",this.windowResizeThrottler)}}let Et=class extends O{constructor(){super(...arguments),this.mode=tt.Closed,this.hostBridge=new zl(this),this.closeOnBackdropClick=!0}render(){return m`
      <div class="container">
    ...
    `}};n([u({type:String,reflect:!0})],Et.prototype,"mode",void 0);n([u({type:Object})],Et.prototype,"customModalContent",void 0);n([u({type:Object})],Et.prototype,"hostBridge",void 0);n([ce("modal-template")],Et.prototype,"modalTemplate",void 0);Et=n([R("modal-manager")],Et);var xo=I`<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><path d="m79.8883285 50.0035012.1116715-.1085359-43.1159942-46.61088155c-2.401537-2.18938917-4.6902018-3.28408375-6.8659943-3.28408375s-4.1642651.63837733-5.9654178 1.91513199c-1.8011528 1.27675467-3.1520173 2.97248092-4.0525937 5.08717877l39.4020173 42.99768924-39.4020173 42.9976892c.9005764 2.1146979 2.2514409 3.8104241 4.0525937 5.0871788 1.8011527 1.2767547 3.7896253 1.915132 5.9654178 1.915132 2.1013449 0 4.3900096-1.0573489 6.8659943-3.1720468l43.1159942-46.7194174z"/></svg>
`,Tl=I`
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path 
...
`;let Dt=class extends O{constructor(){super(...arguments),this.step=2,this.currentPage=1,this.pages=[]}firstUpdated(){this.observePageCount()}updated(e){e.has("size")&&this.observePageCount(),e.has("currentPage")&&(this.observePageCount(),this.emitPageClick())}observePageCount(){this.pages=[];const e=7,t=this.size<=e;if(this.size<=5){this.pages=[...Array(this.size).keys()].map(o=>o+1);return}if(this.size===e){if(this.currentPage===2){this.pages=[1,2,3,4,0,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,4,5,this.size-1,this.size];return}}if(this.currentPage===1){this.pages=[1,2,3,0,this.size];return}if(this.currentPage===this.size){this.pages=[1,0,this.size-2,this.size-1,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,this.size-3,this.size-2,this.size-1,this.size];return}if(t&&this.currentPage>1&&this.currentPage<e){this.pages=[...Array(this.size).keys()].map(o=>o+1);return}let i=this.currentPage-this.step,a=this.currentPage+this.step;i<=0&&(a+=-i+1,i=1),a>=this.size&&(i=Math.max(i-(a-this.size),1),a=this.size),i===2&&(a-=1),a===this.size-1&&(i+=1),this.createFirstNode(i),this.createMiddelNode(i,a),this.createLastNode(a)}createFirstNode(e){var t,i;e>1&&((t=this.pages)===null||t===void 0||t.push(1)),e>2&&((i=this.pages)===null||i===void 0||i.push(0))}createMiddelNode(e,t){var i;for(let a=e;a<=t;a+=1)(i=this.pages)===null||i===void 0||i.push(a)}createLastNode(e){var t,i;e<this.size-1&&((t=this.pages)===null||t===void 0||t.push(0)),e<this.size&&((i=this.pages)===null||i===void 0||i.push(this.size))}get getEllipsisTemplate(){return m`<i class="ellipses">...</i>`}emitPageClick(){this.dispatchEvent(new CustomEvent("pageNumberClicked",{detail:{page:this.currentPage},bubbles:!0,composed:!0}))}onRewind(){this.currentPage-=1,this.currentPage<1&&(this.currentPage=1)}onForward(){this.currentPage+=1,this.currentPage>this.size&&(this.currentPage=this.size)}onChange(e){this.currentPage=e}getPageTemplate(e){return m`
    ...
    `}};n([u({type:Number})],Dt.prototype,"size",void 0);n([u({type:Number})],Dt.prototype,"step",void 0);n([u({type:Number})],Dt.prototype,"currentPage",void 0);n([T()],Dt.prototype,"pages",void 0);Dt=n([R("more-facets-pagination")],Dt);var Al=I`
...
`;let Lt=class extends O{facetClicked(e,t,i){const a=e.target,{checked:o,name:s,value:l}=a;o?this.facetChecked(s,l,t,i):this.facetUnchecked(s,l)}facetChecked(e,t,i,a){const{selectedFacets:o}=this;let s;o?s=ve({},o):s=Ti,s[e][t]={state:a?"hidden":"selected",count:i},this.selectedFacets=s,this.dispatchSelectedFacetsChanged()}facetUnchecked(e,t){const{selectedFacets:i}=this;let a;i?a=ve({},i):a=Ti,delete a[e][t],this.selectedFacets=a,this.dispatchSelectedFacetsChanged()}dispatchSelectedFacetsChanged(){const e=new CustomEvent("selectedFacetsChanged",{detail:this.selectedFacets,bubbles:!0,composed:!0});this.dispatchEvent(e)}getFacetsTemplate(e){let t=e==null?void 0:e.buckets;return t=[...t.filter(i=>i.state==="selected").sort((i,a)=>i.count<a.count?1:-1),...t.filter(i=>i.state==="hidden").sort((i,a)=>i.count<a.count?1:-1),...t.filter(i=>i.state==="none")],m`
      <div class="facets-on-${this.renderOn}">
        ${no(t,i=>`${e.key}:${i.key}`,i=>{var a,o;const s=`${e.key}:${i.key}-show-only`,l=`${e.key}:${i.key}-negative`,d=e.key!=="collection"?m`${(a=i.displayText)!==null&&a!==void 0?a:i.key}`:m`<a href="/details/${i.key}">
                    <async-collection-name
                      .collectionNameCache=${this.collectionNameCache}
                      .identifier=${i.key}
                      placeholder="-"
                    ></async-collection-name>
                  </a> `,c=i.state==="hidden",p=i.state==="selected",v=`${e.key}: ${(o=i.displayText)!==null&&o!==void 0?o:i.key}`,f=p?`Show all ${e.key}s`:`Only show ${v}`,w=`Hide ${v}`,x=`Unhide ${v}`,$=c?x:w;return m`
              <div class="facet-row">
    ...
    `}updated(e){e.has("selectedFacets")&&this.dispatchFacetsChangedEvent()}dispatchFacetsChangedEvent(){const e=new CustomEvent("facetsChanged",{detail:this.selectedFacets});this.dispatchEvent(e)}get currentYearsHistogramAggregation(){var e;return(e=this.aggregations)===null||e===void 0?void 0:e.year_histogram}get histogramTemplate(){const{fullYearsHistogramAggregation:e}=this;return m`
      ...
      ></histogram-date-range>
    `}histogramDateRangeUpdated(e){const{minDate:t,maxDate:i}=e.detail,a=new CustomEvent("histogramDateRangeUpdated",{detail:{minDate:t,maxDate:i}});this.dispatchEvent(a)}get mergedFacets(){const e=[];return Sn.forEach(t=>{var i,a;const o=this.selectedFacetGroups.find(p=>p.key===t),s=this.aggregationFacetGroups.find(p=>p.key===t);if(o&&!s){e.push(o);return}if(!s)return;const l=o!=null?o:s;let d=(i=o==null?void 0:o.buckets.map(p=>{const v=s.buckets.find(f=>f.key===p.key);return v?ft(ve({},p),{count:v.count}):p}))!==null&&i!==void 0?i:[];s.buckets.forEach(p=>{d.find(f=>f.key===p.key)||d.push(p)}),t==="lending"&&(d=d.filter(p=>$n[p.key]));let c=(a=Object.keys((o==null?void 0:o.buckets)||[]))===null||a===void 0?void 0:a.length;c<this.allowedFacetCount&&(c=this.allowedFacetCount),l.buckets=d.splice(0,c),e.push(l)}),e}get selectedFacetGroups(){return this.selectedFacets?Object.entries(this.selectedFacets).map(([t,i])=>{const a=t,o=Mi[a],s=Object.entries(i).map(([l,d])=>{var c,p,v;let f=l;return a==="language"&&(f=(p=(c=this.languageCodeHandler)===null||c===void 0?void 0:c.getLanguageNameFromCodeString(l))!==null&&p!==void 0?p:l),a==="lending"&&(f=(v=Tr[l])!==null&&v!==void 0?v:l),{displayText:f,key:l,count:d.count,state:d.state}});return{title:o,key:a,buckets:s}}):[]}get aggregationFacetGroups(){var e;const t=[];return Object.entries((e=this.aggregations)!==null&&e!==void 0?e:[]).forEach(([i,a])=>{if(i==="year_histogram")return;const o=i,s=Mi[o];if(!s)return;let l=a.buckets;o==="collection"&&(l=l==null?void 0:l.filter(p=>{var v;const f=(v=p==null?void 0:p.key)===null||v===void 0?void 0:v.toString();return!Fa[f]&&!(f!=null&&f.startsWith("fav-"))}));const d=l.map(p=>{var v,f,w;let x=p.key,$=`${p.key}`;return o==="language"&&(x=(f=(v=this.languageCodeHandler)===null||v===void 0?void 0:v.getCodeStringFromLanguageName(`${p.key}`))!==null&&f!==void 0?f:p.key),o==="lending"&&($=(w=Tr[p.key])!==null&&w!==void 0?w:`${p.key}`),{displayText:$,key:`${x}`,count:p.doc_count,state:"none"}}),c={title:s,key:o,buckets:d};t.push(c)}),t}getFacetGroupTemplate(e){if(e.buckets.length===0)return _;const{key:t}=e,i=this.openFacets[t],a=m`
    ...
    `,l=new wo({bodyColor:"#fff",headerColor:"#194880",showHeaderLogo:!1,closeOnBackdropClick:!0,title:m`Select filters`});(i=this.modalManager)===null||i===void 0||i.classList.add("more-search-facets"),(a=this.modalManager)===null||a===void 0||a.showModal({config:l,customModalContent:s})}getFacetTemplate(e){return m`
      <facets-template
        .facetGroup=${e}
        .selectedFacets=${this.selectedFacets}
        .renderOn=${"page"}
...
`;let Li=class extends O{constructor(){super(...arguments),this.placeholderType=null}render(){return this.placeholderType?m`${this.placeholderTemplate}`:_}get placeholderTemplate(){return m`
      <div
        class="placeholder ${this.placeholderType} ${this.isMobileView?"mobile":"desktop"}"
      >
        ${Pl(this.placeholderType,[["empty-query",()=>this.emptyQueryTemplate],["null-result",()=>this.nullResultTemplate]])}
      </div>
    ...
    `}userChangedSort(e){var t;const{selectedSort:i,sortDirection:a}=e.detail;this.selectedSort=i,this.sortDirection=a,((t=this.currentPage)!==null&&t!==void 0?t:1)>1&&this.goToPage(1),this.currentPage=1}sendSortByAnalytics(e){var t;const i=e&&!this.sortDirection;(t=this.analyticsHandler)===null||t===void 0||t.sendEventNoSampling({category:this.searchContext,action:ie.sortBy,label:`${this.selectedSort}${this.sortDirection||i?`-${this.sortDirection}`:""}`})}selectedSortChanged(){if(this.selectedSort==="relevance"||this.sortDirection===null){this.sortParam=null;return}const e=_n[this.selectedSort];!e||(this.sortParam={field:e,direction:this.sortDirection})}displayModeChanged(e){var t;this.displayMode=e.detail.displayMode,this.displayMode&&((t=this.analyticsHandler)===null||t===void 0||t.sendEventNoSampling({category:this.searchContext,action:ie.displayMode,label:this.displayMode}))}sendFilterByTitleAnalytics(e){var t;if(!e&&!this.selectedTitleFilter)return;const i=e&&this.selectedTitleFilter===null;(t=this.analyticsHandler)===null||t===void 0||t.sendEventNoSampling({category:this.searchContext,action:ie.filterByTitle,label:i?`clear-${e}`:`${e||"start"}-${this.selectedTitleFilter}`})}selectedTitleLetterChanged(){this.titleQuery=this.selectedTitleFilter?`firstTitle:${this.selectedTitleFilter}`:void 0}sendFilterByCreatorAnalytics(e){var t;if(!e&&!this.selectedCreatorFilter)return;const i=e&&this.selectedCreatorFilter===null;(t=this.analyticsHandler)===null||t===void 0||t.sendEventNoSampling({category:this.searchContext,action:ie.filterByCreator,label:i?`clear-${e}`:`${e||"start"}-${this.selectedCreatorFilter}`})}selectedCreatorLetterChanged(){this.creatorQuery=this.selectedCreatorFilter?`firstCreator:${this.selectedCreatorFilter}`:void 0}titleLetterSelected(e){this.selectedCreatorFilter=null,this.selectedTitleFilter=e.detail.selectedLetter}creatorLetterSelected(e){this.selectedTitleFilter=null,this.selectedCreatorFilter=e.detail.selectedLetter}get facetDataLoading(){return this.facetsLoading||this.fullYearAggregationLoading}get mobileFacetsTemplate(){return m`
    ...
    `}get facetsTemplate(){return m`
      ...
      <collection-facets
        ...
        .moreLinksVisible=${this.previousSearchType!==$e.FULLTEXT}
        .minSelectedDate=${this.minSelectedDate}
        .maxSelectedDate=${this.maxSelectedDate}
        .selectedFacets=${this.selectedFacets}
        .collectionNameCache=${this.collectionNameCache}
  ...
  `;n([T()],se.prototype,"currentPage",void 0);n([T()],se.prototype,"searchQuery",void 0);n([T()],se.prototype,"cellWidth",void 0);n([T()],se.prototype,"cellHeight",void 0);n([T()],se.prototype,"rowGap",void 0);n([T()],se.prototype,"colGap",void 0);n([T()],se.prototype,"loggedIn",void 0);n([T()],se.prototype,"searchType",void 0);n([u({type:Object,reflect:!1})],se.prototype,"latestAction",void 0);n([ce("#base-query-field")],se.prototype,"baseQueryField",void 0);n([ce("#page-number-input")],se.prototype,"pageNumberInput",void 0);n([ce("collection-browser")],se.prototype,"collectionBrowser",void 0);n([ce("modal-manager")],se.prototype,"modalManager",void 0);se=n([R("app-root")],se);
