...
`+de),Ce&&(de=Ie(de,We," "),de=Ie(de,Ge," ")),B&&vi?B.createHTML(de):de},e.setConfig=function(C){Xi(C),qe=!0},e.clearConfig=function(){yt=null,qe=!1},e.isValidAttribute=function(C,p,b){yt||Xi({});var S=Ze(C),H=Ze(p);return or(S,H,b)},e.addHook=function(C,p){typeof p=="function"&&(ve[C]=ve[C]||[],Zt(ve[C],p))},e.removeHook=function(C){if(ve[C])return Mr(ve[C])},e.removeHooks=function(C){ve[C]&&(ve[C]=[])},e.removeAllHooks=function(){ve={}},e}var ii=xo(),A;(function(r){r.relevance="relevance",r.alltimeview="alltimeview",r.weeklyview="weeklyview",r.title="title",r.datearchived="datearchived",r.date="date",r.datereviewed="datereviewed",r.dateadded="dateadded",r.creator="creator"})(A||(A={}));const it={relevance:"Relevance",alltimeview:"All-time Views",weeklyview:"Weekly Views",title:"Title",datearchived:"Date Archived",date:"Date Published",datereviewed:"Date Reviewed",dateadded:"Date Added",creator:"Creator"},Fn={relevance:null,alltimeview:"downloads",weeklyview:"week",title:"titleSorter",datearchived:"publicdate",date:"date",datereviewed:"reviewdate",dateadded:"addeddate",creator:"creatorSorter"},Ar={week:A.weeklyview,downloads:A.alltimeview,titleSorter:A.title,date:A.date,publicdate:A.datearchived,reviewdate:A.datereviewed,addeddate:A.dateadded,creatorSorter:A.creator},On={title:"firstTitle",creator:"firstCreator"},Ii={subject:{},lending:{},mediatype:{},language:{},creator:{},collection:{},year:{}},In=["mediatype","lending","year","subject","collection","creator","language"],Ni={subject:"Subject",lending:"Availability",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"},Nn={is_lendable:!0,is_borrowable:!1,available_to_borrow:!0,is_browsable:!1,available_to_browse:!1,is_readable:!0,available_to_waitlist:!1},Pr={is_lendable:"Lending Library",available_to_borrow:"Borrow 14 Days",is_readable:"Always Available"},Ha={deemphasize:!0,community:!0,stream_only:!0,samples_only:!0,test_collection:!0,printdisabled:!0,"openlibrary-ol":!0,nationalemergencylibrary:!0,china:!0,americana:!0,toronto:!0};function _o(r){switch(r){case"publicdate":return"Archived";case"reviewdate":return"Reviewed";case"addeddate":return"Added";default:return"Published"}}function So(r){return r?`Archivist since ${r.getFullYear()}`:""}let ye=class extends P{constructor(){super(...arguments),this.sortParam=null,this.collectionLinks=[],this.loggedIn=!1}render(){return u`
    ...
    `}};n([h({type:Object})],Ve.prototype,"model",void 0);n([h({type:String})],Ve.prototype,"baseNavigationUrl",void 0);n([h({type:String})],Ve.prototype,"baseImageUrl",void 0);n([h({type:Boolean})],Ve.prototype,"loggedIn",void 0);n([h({type:Object})],Ve.prototype,"sortParam",void 0);n([h({type:Object})],Ve.prototype,"collectionNameCache",void 0);Ve=n([R("tile-hover-pane")],Ve);let Me=class extends P{constructor(){super(...arguments),this.sortParam=null,this.loggedIn=!1}render(){var e,t,i,a,o,s,l,d,c;return u`
      <div id="list-line" class="${this.classSize}">
        <image-block
          .model=${this.model}
          .baseImageUrl=${this.baseImageUrl}
...
`;let Nt=class extends P{facetClicked(e,t,i){const a=e.target,{checked:o,name:s,value:l}=a;o?this.facetChecked(s,l,t,i):this.facetUnchecked(s,l)}facetChecked(e,t,i,a){const{selectedFacets:o}=this;let s;o?s=ce({},o):s=Ii,s[e][t]={state:a?"hidden":"selected",count:i},this.selectedFacets=s,this.dispatchSelectedFacetsChanged()}facetUnchecked(e,t){const{selectedFacets:i}=this;let a;i?a=ce({},i):a=Ii,delete a[e][t],this.selectedFacets=a,this.dispatchSelectedFacetsChanged()}dispatchSelectedFacetsChanged(){const e=new CustomEvent("selectedFacetsChanged",{detail:this.selectedFacets,bubbles:!0,composed:!0});this.dispatchEvent(e)}getFacetsTemplate(e){let t=e==null?void 0:e.buckets;return t=[...t.filter(i=>i.state==="selected").sort((i,a)=>i.count<a.count?1:-1),...t.filter(i=>i.state==="hidden").sort((i,a)=>i.count<a.count?1:-1),...t.filter(i=>i.state==="none")],u`
    ...
    `}get loaderTemplate(){return u`<div class="facets-loader">
      <ia-activity-indicator .mode=${"processing"}></ia-activity-indicator>
        ...
        </div> `:x}sortFacetAggregation(){this.sortedBy=this.sortedBy==="count"?"alpha":"count",this.dispatchEvent(new CustomEvent("sortedFacets",{detail:this.sortedBy}))}get getModalHeaderTemplate(){const e=this.sortedBy==="alpha"?"Sort by count":"Sort by value";return u`<span class="sr-only">More facets for:</span>
      <span class="title">
