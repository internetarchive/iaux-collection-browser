...
`,Ps={account:{color:"#000000",icon:_s,text:"Account"},audio:{color:"#00adef",icon:Ss,text:"Audio"},collection:{color:"#4666ff",icon:or,text:"Collection"},data:{color:"#333333",icon:Cs,text:"Data"},etree:{color:"#00adef",icon:$s,text:"E-tree"},film:{color:"#bf1b2c",icon:ma,text:"Film"},image:{color:"#aa99c9",icon:ks,text:"Image"},movies:{color:"#f1644b",icon:ma,text:"Movie"},radio:{color:"#8fdaef",icon:Ts,text:"Radio"},software:{color:"#9ecc4f",icon:zs,text:"Software"},texts:{color:"#faab3c",icon:Ms,text:"Text"},tv:{color:"#f1644b",icon:Ds,text:"TV"},video:{color:"#f1644b",icon:Es,text:"Video"},web:{color:"#ffcd27",icon:Ls,text:"Web"}};let Jt=class extends A{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var e,t;const i=["tvnews","tvarchive","television"],o=["radio","radioprogram"];return this.mediatype==="movies"&&((e=this.collections)===null||e===void 0?void 0:e.some(r=>i.indexOf(r)>=0))?"tv":this.mediatype==="audio"&&((t=this.collections)===null||t===void 0?void 0:t.some(r=>o.indexOf(r)>=0))?"radio":this.mediatype||""}render(){const e=Ps[this.displayMediatype];return e?h`
    ...
    `}};s([c({type:String})],Jt.prototype,"mediatype",void 0);s([c({type:Array})],Jt.prototype,"collections",void 0);s([c({type:Boolean})],Jt.prototype,"showText",void 0);Jt=s([F("mediatype-icon")],Jt);const Fs=I`
...
`;let Lt=class extends A{constructor(){super(...arguments),this.step=2,this.currentPage=1,this.pages=[]}firstUpdated(){this.observePageCount()}updated(e){e.has("size")&&this.observePageCount(),e.has("currentPage")&&(this.observePageCount(),this.emitPageClick())}observePageCount(){this.pages=[];const e=7,t=this.size<=e;if(this.size<=5){this.pages=[...Array(this.size).keys()].map(r=>r+1);return}if(this.size===e){if(this.currentPage===2){this.pages=[1,2,3,4,0,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,4,5,this.size-1,this.size];return}}if(this.currentPage===1){this.pages=[1,2,3,0,this.size];return}if(this.currentPage===this.size){this.pages=[1,0,this.size-2,this.size-1,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,this.size-3,this.size-2,this.size-1,this.size];return}if(t&&this.currentPage>1&&this.currentPage<e){this.pages=[...Array(this.size).keys()].map(r=>r+1);return}let i=this.currentPage-this.step,o=this.currentPage+this.step;i<=0&&(o+=-i+1,i=1),o>=this.size&&(i=Math.max(i-(o-this.size),1),o=this.size),i===2&&(o-=1),o===this.size-1&&(i+=1),this.createFirstNode(i),this.createMiddelNode(i,o),this.createLastNode(o)}createFirstNode(e){var t,i;e>1&&((t=this.pages)===null||t===void 0||t.push(1)),e>2&&((i=this.pages)===null||i===void 0||i.push(0))}createMiddelNode(e,t){var i;for(let o=e;o<=t;o+=1)(i=this.pages)===null||i===void 0||i.push(o)}createLastNode(e){var t,i;e<this.size-1&&((t=this.pages)===null||t===void 0||t.push(0)),e<this.size&&((i=this.pages)===null||i===void 0||i.push(this.size))}get getEllipsisTemplate(){return h`<i class="ellipses">...</i>`}emitPageClick(){this.dispatchEvent(new CustomEvent("pageNumberClicked",{detail:{page:this.currentPage},bubbles:!0,composed:!0}))}onRewind(){this.currentPage-=1,this.currentPage<1&&(this.currentPage=1)}onForward(){this.currentPage+=1,this.currentPage>this.size&&(this.currentPage=this.size)}onChange(e){this.currentPage=e}getPageTemplate(e){return h`
    ...
    `}static get styles(){return[et,f`
      ...
      `]}};s([c({type:Number})],Lt.prototype,"size",void 0);s([c({type:Number})],Lt.prototype,"step",void 0);s([c({type:Number})],Lt.prototype,"currentPage",void 0);s([T()],Lt.prototype,"pages",void 0);Lt=s([F("more-facets-pagination")],Lt);var sl=I`
