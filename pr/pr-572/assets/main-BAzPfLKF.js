...
`,Ac=class extends B{constructor(...e){super(...e),this.collectionLinks=[]}render(){return T`
    ...
    >`}detailsLink(e,t,n=!1){if(!e)return D;let r=t??e;return T`<a href=${this.displayValueProvider.itemPageUrl(e,n)}> ${Oc.sanitize(r)} </a>`}get mediatypeURL(){if(this.baseNavigationUrl===void 0||!this.model?.mediatype)return D;switch(this.model.mediatype){case`collection`:return`${this.baseNavigationUrl}/search?query=mediatype:collection&sort=-downloads`;case`account`:return D;default:return this.displayValueProvider.itemPageUrl(this.model.mediatype,!0)}}updated(e){(e.has(`model`)||e.has(`collectionTitles`))&&this.buildCollectionLinks()}async buildCollectionLinks(){if(!this.model?.collections||this.model.collections.length===0)return;this.collectionLinks=[];let e=[];for(let t of this.model.collections)!da[t]&&!t.startsWith(`fav-`)&&e.push(this.detailsLink(t,this.collectionTitles?.get(t)??t,!0));this.collectionLinks=e}get date(){switch(this.effectiveSort?.field){case`date`:return this.model?.datePublished;case`reviewdate`:return this.model?.dateReviewed;case`addeddate`:return this.model?.dateAdded;default:return this.model?.dateArchived}}get effectiveSort(){return this.sortParam??this.defaultSortParam}get classSize(){return this.mobileBreakpoint&&this.currentWidth&&this.currentWidth<this.mobileBreakpoint?`mobile`:`desktop`}get formatSize(){return this.mobileBreakpoint&&this.currentWidth&&this.currentWidth<this.mobileBreakpoint?`short`:`long`}static get styles(){return[kc,w`
      ...
      `]}};z([A({type:Object})],Ac.prototype,`collectionTitles`,void 0),z([j()],Ac.prototype,`collectionLinks`,void 0),Ac=z([k(`tile-list`)],Ac);var jc=class extends O{constructor(...e){super(...e),this.loggedIn=!1,this.suppressBlurring=!1}render(){return T`
      <div id="container">
        <focus-trap>
          ${this.headerTemplate}
    ...
    `}};z([A({type:Object})],jc.prototype,`model`,void 0),z([A({type:String})],jc.prototype,`baseNavigationUrl`,void 0),z([A({type:String})],jc.prototype,`baseImageUrl`,void 0),z([A({type:Boolean})],jc.prototype,`loggedIn`,void 0),z([A({type:Boolean})],jc.prototype,`suppressBlurring`,void 0),z([A({type:Object})],jc.prototype,`sortParam`,void 0),z([A({type:Number})],jc.prototype,`mobileBreakpoint`,void 0),z([A({type:Number})],jc.prototype,`currentWidth`,void 0),z([A({type:Object})],jc.prototype,`collectionTitles`,void 0),jc=z([k(`tile-hover-pane`)],jc);var Mc=class extends B{render(){let e=this.tileActions.length>0;return T`
      <div id="list-line" class=${ar({mobile:this.classSize===`mobile`,desktop:this.classSize===`desktop`,"has-actions":e})}>
        <image-block
          .model=${this.model}
          .baseImageUrl=${this.baseImageUrl}
          .isCompactTile=${!0}
    ...
    `}get href(){return!this.model?.identifier||this.baseNavigationUrl==null?D:this.model.href?`${this.baseNavigationUrl}${this.model.href}`:this.displayValueProvider.itemPageUrl(this.model.identifier,this.model.mediatype===`collection`)}get creator(){return this.displayValueProvider.firstCreatorMatchingFilter??D}get date(){switch(this.effectiveSort?.field){case`publicdate`:return this.model?.dateArchived;case`reviewdate`:return this.model?.dateReviewed;case`addeddate`:return this.model?.dateAdded;default:return this.model?.datePublished}}get views(){return this.effectiveSort?.field===`week`?this.model?.weeklyViewCount:this.model?.viewCount}get effectiveSort(){return this.sortParam??this.defaultSortParam}get classSize(){return this.mobileBreakpoint&&this.currentWidth&&this.currentWidth<this.mobileBreakpoint?`mobile`:`desktop`}get dateFormatSize(){return(!this.isSortedByDate||this.effectiveSort?.field===`date`)&&Do(this.model?.datePublished)?`year-only`:this.formatSize}get formatSize(){return this.mobileBreakpoint&&this.currentWidth&&this.currentWidth<this.mobileBreakpoint?`short`:`long`}get isSortedByDate(){return[`date`,`reviewdate`,`addeddate`,`publicdate`].includes(this.effectiveSort?.field)}static get styles(){return[kc,w`
      ...
      `]}};Mc=z([k(`tile-list-compact`)],Mc);var Nc=class extends B{render(){let e=this.tileActions.length>0;return T`
      <div id="list-line-header" class=${ar({mobile:this.classSize===`mobile`,desktop:this.classSize===`desktop`,"has-actions":e})}>
        <div id="thumb"></div>
    ...
    `}firstUpdated(){this.shouldPrepareHoverPane&&(this.hoverPaneController=new Fc(this,{mobileBreakpoint:this.mobileBreakpoint,enableLongPress:!1}))}get headerTemplate(){let{currentWidth:e,sortParam:t,defaultSortParam:n,mobileBreakpoint:r}=this;return T`
    ...
    `:D}get tile(){let{model:e,collectionPagePath:t,baseNavigationUrl:n,currentWidth:r,currentHeight:i,sortParam:a,creatorFilter:o,mobileBreakpoint:s,defaultSortParam:c}=this;if(!e)return D;switch(this.tileDisplayMode){case`grid`:switch(e.mediatype){case`collection`:return T`<collection-tile
        ...
        >
          ...
          ?useLocalTime=${this.useLocalTime}
        >
        </tile-list>`;default:return D}}static get styles(){return[za,kc,w`
        :host {
          display: block;
          height: 100%;
        }
      ...
      `]}};z([A({type:String})],Lc.prototype,`tileDisplayMode`,void 0),z([A({type:Boolean})],Lc.prototype,`isManageView`,void 0),z([A({type:Object})],Lc.prototype,`resizeObserver`,void 0),z([A({type:Object})],Lc.prototype,`collectionTitles`,void 0),z([A({type:Boolean})],Lc.prototype,`showTvClips`,void 0),z([A({type:String})],Lc.prototype,`layoutType`,void 0),z([A({type:Boolean})],Lc.prototype,`enableHoverPane`,void 0),z([A({type:String})],Lc.prototype,`manageCheckTitle`,void 0),z([M(`#container`)],Lc.prototype,`container`,void 0),z([M(`tile-hover-pane`)],Lc.prototype,`hoverPane`,void 0),z([M(`.tile-link`)],Lc.prototype,`tileLinkElement`,void 0),Lc=Ic=z([k(`tile-dispatcher`)],Lc);var Rc=class extends O{render(){return T` <div id="container"></div> `}static get styles(){return w`
      :host {
        display: block;
        height: 100%;
      }
    ...
    `}};Rc=z([k(`collection-browser-loading-tile`)],Rc);var zc=T`
...
`,Gc=window,Kc=Gc.trustedTypes,qc=Kc?Kc.createPolicy(`lit-html`,{createHTML:e=>e}):void 0,Jc=`$lit$`,Yc=`lit$${(Math.random()+``).slice(9)}$`,Xc=`?`+Yc,Zc=`<${Xc}>`,Qc=document,$c=()=>Qc.createComment(``),el=e=>e===null||typeof e!=`object`&&typeof e!=`function`,tl=Array.isArray,nl=e=>tl(e)||typeof e?.[Symbol.iterator]==`function`,rl=`[ 	
\f\r]`,il=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,al=/-->/g,ol=/>/g,sl=RegExp(`>|${rl}(?:([^\\s"'>=/]+)(${rl}*=${rl}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,`g`),cl=/'/g,ll=/"/g,ul=/^(?:script|style|textarea|title)$/i,dl=e=>(t,...n)=>({_$litType$:e,strings:t,values:n}),fl=dl(1),pl=dl(2),ml=Symbol.for(`lit-noChange`),hl=Symbol.for(`lit-nothing`),gl=new WeakMap,_l=Qc.createTreeWalker(Qc,129,null,!1);function vl(e,t){if(!Array.isArray(e)||!e.hasOwnProperty(`raw`))throw Error(`invalid template strings array`);return qc===void 0?t:qc.createHTML(t)}var yl=(e,t)=>{let n=e.length-1,r=[],i,a=t===2?`<svg>`:``,o=il;for(let t=0;t<n;t++){let n=e[t],s,c,l=-1,u=0;for(;u<n.length&&(o.lastIndex=u,c=o.exec(n),c!==null);)u=o.lastIndex,o===il?c[1]===`!--`?o=al:c[1]===void 0?c[2]===void 0?c[3]!==void 0&&(o=sl):(ul.test(c[2])&&(i=RegExp(`</`+c[2],`g`)),o=sl):o=ol:o===sl?c[0]===`>`?(o=i??il,l=-1):c[1]===void 0?l=-2:(l=o.lastIndex-c[2].length,s=c[1],o=c[3]===void 0?sl:c[3]===`"`?ll:cl):o===ll||o===cl?o=sl:o===al||o===ol?o=il:(o=sl,i=void 0);let d=o===sl&&e[t+1].startsWith(`/>`)?` `:``;a+=o===il?n+Zc:l>=0?(r.push(s),n.slice(0,l)+Jc+n.slice(l)+Yc+d):n+Yc+(l===-2?(r.push(void 0),t):d)}return[vl(e,a+(e[n]||`<?>`)+(t===2?`</svg>`:``)),r]},bl=class e{constructor({strings:t,_$litType$:n},r){let i;this.parts=[];let a=0,o=0,s=t.length-1,c=this.parts,[l,u]=yl(t,n);if(this.el=e.createElement(l,r),_l.currentNode=this.el.content,n===2){let e=this.el.content,t=e.firstChild;t.remove(),e.append(...t.childNodes)}for(;(i=_l.nextNode())!==null&&c.length<s;){if(i.nodeType===1){if(i.hasAttributes()){let e=[];for(let t of i.getAttributeNames())if(t.endsWith(Jc)||t.startsWith(Yc)){let n=u[o++];if(e.push(t),n!==void 0){let e=i.getAttribute(n.toLowerCase()+Jc).split(Yc),t=/([.?@])?(.*)/.exec(n);c.push({type:1,index:a,name:t[2],strings:e,ctor:t[1]===`.`?Tl:t[1]===`?`?Dl:t[1]===`@`?Ol:wl})}else c.push({type:6,index:a})}for(let t of e)i.removeAttribute(t)}if(ul.test(i.tagName)){let e=i.textContent.split(Yc),t=e.length-1;if(t>0){i.textContent=Kc?Kc.emptyScript:``;for(let n=0;n<t;n++)i.append(e[n],$c()),_l.nextNode(),c.push({type:2,index:++a});i.append(e[t],$c())}}}else if(i.nodeType===8)if(i.data===Xc)c.push({type:2,index:a});else{let e=-1;for(;(e=i.data.indexOf(Yc,e+1))!==-1;)c.push({type:7,index:a}),e+=Yc.length-1}a++}}static createElement(e,t){let n=Qc.createElement(`template`);return n.innerHTML=e,n}};function xl(e,t,n=e,r){var i,a;if(t===ml)return t;let o=r===void 0?n._$Cl:n._$Co?.[r],s=el(t)?void 0:t._$litDirective$;return o?.constructor!==s&&((i=o?._$AO)==null||i.call(o,!1),s===void 0?o=void 0:(o=new s(e),o._$AT(e,n,r)),r===void 0?n._$Cl=o:((a=n)._$Co??(a._$Co=[]))[r]=o),o!==void 0&&(t=xl(e,o._$AS(e,t.values),o,r)),t}var Sl=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:n}=this._$AD,r=(e?.creationScope??Qc).importNode(t,!0);_l.currentNode=r;let i=_l.nextNode(),a=0,o=0,s=n[0];for(;s!==void 0;){if(a===s.index){let t;s.type===2?t=new Cl(i,i.nextSibling,this,e):s.type===1?t=new s.ctor(i,s.name,s.strings,this,e):s.type===6&&(t=new kl(i,this,e)),this._$AV.push(t),s=n[++o]}a!==s?.index&&(i=_l.nextNode(),a++)}return _l.currentNode=Qc,r}v(e){let t=0;for(let n of this._$AV)n!==void 0&&(n.strings===void 0?n._$AI(e[t]):(n._$AI(e,n,t),t+=n.strings.length-2)),t++}},Cl=class e{constructor(e,t,n,r){var i;this.type=2,this._$AH=hl,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=r,this._$Cp=(i=r?.isConnected)==null||i}get _$AU(){return this._$AM?._$AU??this._$Cp}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=xl(this,e,t),el(e)?e===hl||e==null||e===``?(this._$AH!==hl&&this._$AR(),this._$AH=hl):e!==this._$AH&&e!==ml&&this._(e):e._$litType$===void 0?e.nodeType===void 0?nl(e)?this.T(e):this._(e):this.$(e):this.g(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==hl&&el(this._$AH)?this._$AA.nextSibling.data=e:this.$(Qc.createTextNode(e)),this._$AH=e}g(e){let{values:t,_$litType$:n}=e,r=typeof n==`number`?this._$AC(e):(n.el===void 0&&(n.el=bl.createElement(vl(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===r)this._$AH.v(t);else{let e=new Sl(r,this),n=e.u(this.options);e.v(t),this.$(n),this._$AH=e}}_$AC(e){let t=gl.get(e.strings);return t===void 0&&gl.set(e.strings,t=new bl(e)),t}T(t){tl(this._$AH)||(this._$AH=[],this._$AR());let n=this._$AH,r,i=0;for(let a of t)i===n.length?n.push(r=new e(this.k($c()),this.k($c()),this,this.options)):r=n[i],r._$AI(a),i++;i<n.length&&(this._$AR(r&&r._$AB.nextSibling,i),n.length=i)}_$AR(e=this._$AA.nextSibling,t){var n;for((n=this._$AP)==null||n.call(this,!1,!0,t);e&&e!==this._$AB;){let t=e.nextSibling;e.remove(),e=t}}setConnected(e){var t;this._$AM===void 0&&(this._$Cp=e,(t=this._$AP)==null||t.call(this,e))}},wl=class{constructor(e,t,n,r,i){this.type=1,this._$AH=hl,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=i,n.length>2||n[0]!==``||n[1]!==``?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=hl}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,n,r){let i=this.strings,a=!1;if(i===void 0)e=xl(this,e,t,0),a=!el(e)||e!==this._$AH&&e!==ml,a&&(this._$AH=e);else{let r=e,o,s;for(e=i[0],o=0;o<i.length-1;o++)s=xl(this,r[n+o],t,o),s===ml&&(s=this._$AH[o]),a||=!el(s)||s!==this._$AH[o],s===hl?e=hl:e!==hl&&(e+=(s??``)+i[o+1]),this._$AH[o]=s}a&&!r&&this.j(e)}j(e){e===hl?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??``)}},Tl=class extends wl{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===hl?void 0:e}},El=Kc?Kc.emptyScript:``,Dl=class extends wl{constructor(){super(...arguments),this.type=4}j(e){e&&e!==hl?this.element.setAttribute(this.name,El):this.element.removeAttribute(this.name)}},Ol=class extends wl{constructor(e,t,n,r,i){super(e,t,n,r,i),this.type=5}_$AI(e,t=this){if((e=xl(this,e,t,0)??hl)===ml)return;let n=this._$AH,r=e===hl&&n!==hl||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,i=e!==hl&&(n===hl||r);r&&this.element.removeEventListener(this.name,this,n),i&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH==`function`?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},kl=class{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){xl(this,e)}},Al=Gc.litHtmlPolyfillSupport;Al?.(bl,Cl),(Gc.litHtmlVersions??=[]).push(`2.8.0`);var jl=(e,t,n)=>{let r=n?.renderBefore??t,i=r._$litPart$;if(i===void 0){let e=n?.renderBefore??null;r._$litPart$=i=new Cl(t.insertBefore($c(),e),e,void 0,n??{})}return i._$AI(e),i},Ml,Nl=class extends Dr{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e;let t=super.createRenderRoot();return(e=this.renderOptions).renderBefore??(e.renderBefore=t.firstChild),t}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=jl(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)==null||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)==null||e.setConnected(!1)}render(){return ml}};Nl.finalized=!0,Nl._$litElement$=!0,(Ml=globalThis.litElementHydrateSupport)==null||Ml.call(globalThis,{LitElement:Nl});var Pl=globalThis.litElementPolyfillSupport;Pl?.({LitElement:Nl}),(globalThis.litElementVersions??(globalThis.litElementVersions=[])).push(`3.3.3`);function Fl(e,t,n){return e?t():n?.()}var Il=pl`<svg class="caret-up-svg" viewBox="0 0 8 4" xmlns="http://www.w3.org/2000/svg">
<path d="m6.7226499 3.51689722c.22976435.15317623.54019902.0910893.69337525-.13867505.13615665-.20423497.10222882-.47220946-.06836249-.63681849l-.07031256-.05655675-3.2773501-2.18490007-3.2773501 2.18490007c-.22976434.15317623-.29185128.4636109-.13867505.69337524.13615665.20423498.39656688.27598409.61412572.18182636l.07924953-.04315131 2.7226499-1.81402514z"
  fill=""></path>
</svg>`,Ll=pl`<svg class="caret-down-svg" viewBox="0 0 8 4" xmlns="http://www.w3.org/2000/svg">
<path d="m6.7226499.58397485c.22976435-.15317623.54019902-.09108929.69337525.13867505.13615665.20423498.10222882.47220947-.06836249.63681849l-.07031256.05655676-3.2773501 2.18490006-3.2773501-2.18490006c-.22976434-.15317623-.29185128-.4636109-.13867505-.69337525.13615665-.20423497.39656688-.27598409.61412572-.18182636l.07924953.04315131 2.7226499 1.81402515z"
fill=""></path>
</svg>`,H=class extends Nl{constructor(){super(...arguments),this.open=!1,this.isDisabled=!1,this.displayCaret=!1,this.closeOnSelect=!1,this.openViaButton=!0,this.usePopover=!1,this.includeSelectedOption=!1,this.selectedOption=``,this.options=[],this.optionGroup=`options`,this.optionSelected=()=>{},this.isCustomList=!1,this.hasCustomClickHandler=!1,this.closeOnEscape=!1,this.closeOnBackdropClick=!1,this.boundKeyboardListener=e=>{switch(e.key){case`Escape`:case`Esc`:this.closeOptions();break;default:break}},this.closeOptions=e=>{e&&e.type===`click`&&e.stopPropagation(),this.open=!1,this.updatePopoverState()}}async firstUpdated(){await new Promise(e=>{setTimeout(e,0)}),this.addEventListener(`closeDropdown`,this.closeOptions)}willUpdate(e){e.has(`open`)&&this.updatePopoverState()}disconnectedCallback(){var e;(e=super.disconnectedCallback)==null||e.call(this),this.removeKeyboardListener()}setupKeyboardListener(){this.closeOnEscape&&document.addEventListener(`keydown`,this.boundKeyboardListener)}removeKeyboardListener(){this.closeOnEscape&&document.removeEventListener(`keydown`,this.boundKeyboardListener)}get dropdownState(){return this.open?(this.setupKeyboardListener(),`open`):(this.removeKeyboardListener(),`closed`)}toggleOptions(){this.open=!this.open,this.updatePopoverState()}updatePopoverState(){var e,t;this.usePopover&&((t=(e=this.dropdownMenu)?.togglePopover)==null||t.call(e,this.open),this.open&&this.positionDropdownMenu())}positionDropdownMenu(){if(!this.dropdownMenu)return;let e=this.container.getBoundingClientRect();this.dropdownMenu.style.left=`${e.left}px`,this.dropdownMenu.style.top=`${e.bottom}px`,this.dropdownMenu.style.minWidth=`${e.width}px`}mainButtonClicked(){var e;this.openViaButton?this.toggleOptions():(e=this.mainButtonLabelSlotted[0])==null||e.click()}mainButtonKeyDown(e){(e.key===`Enter`||e.key===` `)&&(this.mainButtonClicked(),e.preventDefault())}caretKeyDown(e){(e.key===`Enter`||e.key===` `)&&(this.toggleOptions(),e.preventDefault())}renderOption(e){let{label:t,url:n=void 0,id:r}=e,i,a=this.selectedOption===r?`selected`:``;return i=n?fl`<a
        href=${n}
      ...
      >
        ${t}
      </button>`,fl`<li role="menuitem" class=${a}>${i}</li>`}optionClicked(e,t){var n;e.stopPropagation(),this.selectedOption!==t.id&&(this.selectedOption=t.id,this.dispatchEvent(new CustomEvent(`optionSelected`,{detail:{option:t}})),(n=t.selectedHandler)==null||n.call(t,t)),this.closeOnSelect&&(this.closeOptions(),this.mainButton.focus())}get availableOptions(){return this.includeSelectedOption?this.options:this.options.filter(e=>this.selectedOption!==e.id)}get caretUpTemplate(){return fl`
      <span ?hidden=${!this.open} class="caret-up">
        <slot name="caret-up">${Il}</slot>
      </span>
    `}get caretDownTemplate(){return fl`
      <span ?hidden=${this.open} class="caret-down">
        <slot name="caret-down">${Ll}</slot>
      </span>
    `}get caretTemplate(){return this.displayCaret?this.openViaButton?fl`
      ...
      <button
        ...
        aria-haspopup="true"
        aria-expanded=${this.open}
        @click=${Fl(this.shouldAttachEventHandlers,()=>this.toggleOptions)}
        @keydown=${Fl(this.shouldAttachEventHandlers,()=>this.caretKeyDown)}
        ?disabled=${this.isDisabled}
      >
        ${this.caretUpTemplate} ${this.caretDownTemplate}
      </button>
    `:fl``}get dropdownTemplate(){return this.isCustomList?fl`<slot name="list"></slot>`:fl`${this.availableOptions.map(e=>this.renderOption(e))}`}get backdropTemplate(){return!this.closeOnBackdropClick||!this.open?fl``:fl`
      <div
        id="dropdown-backdrop"
        @keyup=${this.closeOptions}
        @click=${this.closeOptions}
      ></div>
    `}get shouldNestCaretInButton(){return this.openViaButton}get shouldAttachEventHandlers(){return!this.isDisabled&&!this.hasCustomClickHandler}render(){return fl`
      <div class="ia-dropdown-group">
        <div class="button-row">
          <button
            ...
            aria-expanded=${this.open}
            @click=${Fl(this.shouldAttachEventHandlers,()=>this.mainButtonClicked)}
            @keydown=${Fl(this.shouldAttachEventHandlers,()=>this.mainButtonKeyDown)}
            ?disabled=${this.isDisabled}
          >
            ...
            ${Fl(this.shouldNestCaretInButton,()=>this.caretTemplate)}
          </button>
          ${Fl(!this.shouldNestCaretInButton,()=>this.caretTemplate)}
        </div>
  ...
  `,Rl=t([_i(`ia-icon-label`)],Rl);var zl=class extends O{constructor(...e){super(...e),this.numResults=0}render(){return T`
    ...
    `}};z([A({type:Number})],zl.prototype,`numResults`,void 0),zl=z([k(`alpha-bar-tooltip`)],zl);var Bl=class extends O{constructor(...e){super(...e),this.selectedLetter=null,this.tooltipShown=!1,this.alphabet=`ABCDEFGHIJKLMNOPQRSTUVWXYZ`.split(``)}get selectedUppercaseLetter(){return this.selectedLetter?.toUpperCase()}render(){return T`
  ...
  `}};z([A({type:String})],Bl.prototype,`selectedLetter`,void 0),z([A({type:Object})],Bl.prototype,`letterCounts`,void 0),z([A({type:String})],Bl.prototype,`ariaLandmarkLabel`,void 0),z([j()],Bl.prototype,`tooltipShown`,void 0),z([j()],Bl.prototype,`hoveredLetter`,void 0),z([M(`alpha-bar-tooltip`)],Bl.prototype,`tooltip`,void 0),Bl=z([k(`alpha-bar`)],Bl);var Vl=class extends O{constructor(...e){super(...e),this.defaultSortDirection=null,this.defaultSortField=I.relevance,this.sortDirection=null,this.selectedSort=I.default,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.sortFieldAvailability=Xi,this.enableSortOptionsSlot=!1,this.suppressDisplayModes=!1,this.alphaSelectorVisible=null,this.dropdownBackdropVisible=!1,this.boundSortBarSelectorEscapeListener=e=>{e.key===`Escape`&&this.closeDropdown()}}render(){return T`
      <div id="container">
    ...
    `:T`<div class="sort-direction-icon">${Vc}</div>`}get sortSelectorTemplate(){let e=Object.values(Ji).filter(e=>e.shownInSortBar&&this.sortFieldAvailability[e.field]);return T`
    ...
    ></alpha-bar>`}titleLetterChanged(e){this.selectedTitleFilter=e.detail.selectedLetter??null,this.emitTitleLetterChangedEvent()}creatorLetterChanged(e){this.selectedCreatorFilter=e.detail.selectedLetter??null,this.emitCreatorLetterChangedEvent()}emitTitleLetterChangedEvent(){let e=new CustomEvent(`titleLetterChanged`,{detail:{selectedLetter:this.selectedTitleFilter}});this.dispatchEvent(e)}emitCreatorLetterChangedEvent(){let e=new CustomEvent(`creatorLetterChanged`,{detail:{selectedLetter:this.selectedCreatorFilter}});this.dispatchEvent(e)}displayModeChanged(){let e=new CustomEvent(`displayModeChanged`,{detail:{displayMode:this.displayMode}});this.dispatchEvent(e)}emitSortChangedEvent(){let e=new CustomEvent(`sortChanged`,{detail:{selectedSort:this.selectedSort,sortDirection:this.sortDirection}});this.dispatchEvent(e)}static get styles(){let e=w`#bbbbbb`;return[za,w`
      ...
      `]}};z([A({type:String})],Vl.prototype,`displayMode`,void 0),z([A({type:String})],Vl.prototype,`defaultSortDirection`,void 0),z([A({type:String})],Vl.prototype,`defaultSortField`,void 0),z([A({type:String})],Vl.prototype,`sortDirection`,void 0),z([A({type:String})],Vl.prototype,`selectedSort`,void 0),z([A({type:String})],Vl.prototype,`selectedTitleFilter`,void 0),z([A({type:String})],Vl.prototype,`selectedCreatorFilter`,void 0),z([A({type:Object})],Vl.prototype,`sortFieldAvailability`,void 0),z([A({type:Boolean,reflect:!0})],Vl.prototype,`enableSortOptionsSlot`,void 0),z([A({type:Boolean,reflect:!0})],Vl.prototype,`suppressDisplayModes`,void 0),z([A({type:Object})],Vl.prototype,`prefixFilterCountMap`,void 0),z([j()],Vl.prototype,`alphaSelectorVisible`,void 0),z([j()],Vl.prototype,`dropdownBackdropVisible`,void 0),z([M(`#sort-dropdown`)],Vl.prototype,`sortOptionsDropdown`,void 0),Vl=z([k(`sort-filter-bar`)],Vl);var Hl=class{constructor(e){this.title=e?.title,this.subtitle=e?.subtitle,this.headline=e?.headline,this.message=e?.message,this.headerColor=e?.headerColor??`#55A183`,this.bodyColor=e?.bodyColor??`#fbfbfd`,this.showProcessingIndicator=e?.showProcessingIndicator??!1,this.processingImageMode=e?.processingImageMode??`complete`,this.showCloseButton=e?.showCloseButton??!0,this.showLeftNavButton=e?.showLeftNavButton??!1,this.leftNavButtonText=e?.leftNavButtonText??``,this.showHeaderLogo=e?.showHeaderLogo??!0,this.closeOnBackdropClick=e?.closeOnBackdropClick??!0}};function*Ul(e=document.activeElement){e!=null&&(yield e,`shadowRoot`in e&&e.shadowRoot&&e.shadowRoot.mode!==`closed`&&(yield*Ul(e.shadowRoot.activeElement)))}function Wl(){return[...Ul()].pop()}var Gl=new WeakMap;function Kl(e){let t=Gl.get(e);return t||(t=window.getComputedStyle(e,null),Gl.set(e,t)),t}function ql(e){if(`checkVisibility`in e&&typeof e.checkVisibility==`function`)return e.checkVisibility({checkOpacity:!1,checkVisibilityCSS:!0});let t=Kl(e);return t.visibility!==`hidden`&&t.display!==`none`}function Jl(e){let{overflowY:t,overflowX:n}=Kl(e);return t===`scroll`||n===`scroll`?!0:t!==`auto`||n!==`auto`?!1:e.scrollHeight>e.clientHeight&&t===`auto`||e.scrollWidth>e.clientWidth&&n===`auto`}function Yl(e){let t=e.tagName.toLowerCase(),n=Number(e.getAttribute(`tabindex`));return e.hasAttribute(`tabindex`)&&(isNaN(n)||n<=-1)||e.hasAttribute(`disabled`)||e.closest(`[inert]`)||t===`input`&&e.getAttribute(`type`)===`radio`&&!e.hasAttribute(`checked`)||!ql(e)?!1:(t===`audio`||t===`video`)&&e.hasAttribute(`controls`)||e.hasAttribute(`tabindex`)||e.hasAttribute(`contenteditable`)&&e.getAttribute(`contenteditable`)!==`false`||[`button`,`input`,`select`,`textarea`,`a`,`audio`,`video`,`summary`,`iframe`].includes(t)?!0:Jl(e)}function Xl(e,t){return e.getRootNode({composed:!0})?.host!==t}function Zl(e){let t=new WeakMap,n=[];function r(i){if(i instanceof Element){if(i.hasAttribute(`inert`)||i.closest(`[inert]`)||t.has(i))return;t.set(i,!0),!n.includes(i)&&Yl(i)&&n.push(i),i instanceof HTMLSlotElement&&Xl(i,e)&&i.assignedElements({flatten:!0}).forEach(e=>{r(e)}),i.shadowRoot!==null&&i.shadowRoot.mode===`open`&&r(i.shadowRoot)}for(let e of Array.from(i.children))r(e)}return r(e),n.sort((e,t)=>{let n=Number(e.getAttribute(`tabindex`))||0;return(Number(t.getAttribute(`tabindex`))||0)-n})}var Ql=[],$l=class{constructor(e){this.isExternalActivated=!1,this.tabDirection=`forward`,this.currentFocus=null,this.previousFocus=null,this.handleFocusIn=()=>{this.isActive()&&this.checkFocus()},this.handleKeyDown=e=>{if(e.key!==`Tab`||this.isExternalActivated||!this.isActive())return;let t=Wl();if(this.previousFocus=t,this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus))return;e.shiftKey?this.tabDirection=`backward`:this.tabDirection=`forward`;let n=Zl(this.element),r=n.findIndex(e=>e===t);this.previousFocus=this.currentFocus;let i=this.tabDirection===`forward`?1:-1;for(;;){r+i>=n.length?r=0:r+i<0?r=n.length-1:r+=i,this.previousFocus=this.currentFocus;let t=n[r];if(this.tabDirection===`backward`&&this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus)||t&&this.possiblyHasTabbableChildren(t))return;e.preventDefault(),this.currentFocus=t,this.currentFocus?.focus({preventScroll:!1});let a=[...Ul()];if(a.includes(this.currentFocus)||!a.includes(this.previousFocus))break}setTimeout(()=>this.checkFocus())},this.handleKeyUp=()=>{this.tabDirection=`forward`},this.element=e,this.elementsWithTabbableControls=[`iframe`]}activate(){Ql.push(this.element),document.addEventListener(`focusin`,this.handleFocusIn),document.addEventListener(`keydown`,this.handleKeyDown),document.addEventListener(`keyup`,this.handleKeyUp)}deactivate(){Ql=Ql.filter(e=>e!==this.element),this.currentFocus=null,document.removeEventListener(`focusin`,this.handleFocusIn),document.removeEventListener(`keydown`,this.handleKeyDown),document.removeEventListener(`keyup`,this.handleKeyUp)}isActive(){return Ql[Ql.length-1]===this.element}activateExternal(){this.isExternalActivated=!0}deactivateExternal(){this.isExternalActivated=!1}checkFocus(){if(this.isActive()&&!this.isExternalActivated){let e=Zl(this.element);if(!this.element.matches(`:focus-within`)){let t=e[0],n=e[e.length-1],r=this.tabDirection===`forward`?t:n;typeof r?.focus==`function`&&(this.currentFocus=r,r.focus({preventScroll:!1}))}}}possiblyHasTabbableChildren(e){return this.elementsWithTabbableControls.includes(e.tagName.toLowerCase())||e.hasAttribute(`controls`)}},eu=window,tu=eu.trustedTypes,nu=tu?tu.createPolicy(`lit-html`,{createHTML:e=>e}):void 0,ru=`$lit$`,iu=`lit$${(Math.random()+``).slice(9)}$`,au=`?`+iu,ou=`<${au}>`,su=document,cu=()=>su.createComment(``),lu=e=>e===null||typeof e!=`object`&&typeof e!=`function`,uu=Array.isArray,du=e=>uu(e)||typeof e?.[Symbol.iterator]==`function`,fu=`[ 	
\f\r]`,pu=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,mu=/-->/g,hu=/>/g,gu=RegExp(`>|${fu}(?:([^\\s"'>=/]+)(${fu}*=${fu}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,`g`),_u=/'/g,vu=/"/g,yu=/^(?:script|style|textarea|title)$/i,bu=(e=>(t,...n)=>({_$litType$:e,strings:t,values:n}))(1),xu=Symbol.for(`lit-noChange`),Su=Symbol.for(`lit-nothing`),Cu=new WeakMap,wu=su.createTreeWalker(su,129,null,!1);function Tu(e,t){if(!Array.isArray(e)||!e.hasOwnProperty(`raw`))throw Error(`invalid template strings array`);return nu===void 0?t:nu.createHTML(t)}var Eu=(e,t)=>{let n=e.length-1,r=[],i,a=t===2?`<svg>`:``,o=pu;for(let t=0;t<n;t++){let n=e[t],s,c,l=-1,u=0;for(;u<n.length&&(o.lastIndex=u,c=o.exec(n),c!==null);)u=o.lastIndex,o===pu?c[1]===`!--`?o=mu:c[1]===void 0?c[2]===void 0?c[3]!==void 0&&(o=gu):(yu.test(c[2])&&(i=RegExp(`</`+c[2],`g`)),o=gu):o=hu:o===gu?c[0]===`>`?(o=i??pu,l=-1):c[1]===void 0?l=-2:(l=o.lastIndex-c[2].length,s=c[1],o=c[3]===void 0?gu:c[3]===`"`?vu:_u):o===vu||o===_u?o=gu:o===mu||o===hu?o=pu:(o=gu,i=void 0);let d=o===gu&&e[t+1].startsWith(`/>`)?` `:``;a+=o===pu?n+ou:l>=0?(r.push(s),n.slice(0,l)+ru+n.slice(l)+iu+d):n+iu+(l===-2?(r.push(void 0),t):d)}return[Tu(e,a+(e[n]||`<?>`)+(t===2?`</svg>`:``)),r]},Du=class e{constructor({strings:t,_$litType$:n},r){let i;this.parts=[];let a=0,o=0,s=t.length-1,c=this.parts,[l,u]=Eu(t,n);if(this.el=e.createElement(l,r),wu.currentNode=this.el.content,n===2){let e=this.el.content,t=e.firstChild;t.remove(),e.append(...t.childNodes)}for(;(i=wu.nextNode())!==null&&c.length<s;){if(i.nodeType===1){if(i.hasAttributes()){let e=[];for(let t of i.getAttributeNames())if(t.endsWith(ru)||t.startsWith(iu)){let n=u[o++];if(e.push(t),n!==void 0){let e=i.getAttribute(n.toLowerCase()+ru).split(iu),t=/([.?@])?(.*)/.exec(n);c.push({type:1,index:a,name:t[2],strings:e,ctor:t[1]===`.`?Mu:t[1]===`?`?Pu:t[1]===`@`?Fu:ju})}else c.push({type:6,index:a})}for(let t of e)i.removeAttribute(t)}if(yu.test(i.tagName)){let e=i.textContent.split(iu),t=e.length-1;if(t>0){i.textContent=tu?tu.emptyScript:``;for(let n=0;n<t;n++)i.append(e[n],cu()),wu.nextNode(),c.push({type:2,index:++a});i.append(e[t],cu())}}}else if(i.nodeType===8)if(i.data===au)c.push({type:2,index:a});else{let e=-1;for(;(e=i.data.indexOf(iu,e+1))!==-1;)c.push({type:7,index:a}),e+=iu.length-1}a++}}static createElement(e,t){let n=su.createElement(`template`);return n.innerHTML=e,n}};function Ou(e,t,n=e,r){var i,a;if(t===xu)return t;let o=r===void 0?n._$Cl:n._$Co?.[r],s=lu(t)?void 0:t._$litDirective$;return o?.constructor!==s&&((i=o?._$AO)==null||i.call(o,!1),s===void 0?o=void 0:(o=new s(e),o._$AT(e,n,r)),r===void 0?n._$Cl=o:((a=n)._$Co??(a._$Co=[]))[r]=o),o!==void 0&&(t=Ou(e,o._$AS(e,t.values),o,r)),t}var ku=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:n}=this._$AD,r=(e?.creationScope??su).importNode(t,!0);wu.currentNode=r;let i=wu.nextNode(),a=0,o=0,s=n[0];for(;s!==void 0;){if(a===s.index){let t;s.type===2?t=new Au(i,i.nextSibling,this,e):s.type===1?t=new s.ctor(i,s.name,s.strings,this,e):s.type===6&&(t=new Iu(i,this,e)),this._$AV.push(t),s=n[++o]}a!==s?.index&&(i=wu.nextNode(),a++)}return wu.currentNode=su,r}v(e){let t=0;for(let n of this._$AV)n!==void 0&&(n.strings===void 0?n._$AI(e[t]):(n._$AI(e,n,t),t+=n.strings.length-2)),t++}},Au=class e{constructor(e,t,n,r){var i;this.type=2,this._$AH=Su,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=r,this._$Cp=(i=r?.isConnected)==null||i}get _$AU(){return this._$AM?._$AU??this._$Cp}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Ou(this,e,t),lu(e)?e===Su||e==null||e===``?(this._$AH!==Su&&this._$AR(),this._$AH=Su):e!==this._$AH&&e!==xu&&this._(e):e._$litType$===void 0?e.nodeType===void 0?du(e)?this.T(e):this._(e):this.$(e):this.g(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==Su&&lu(this._$AH)?this._$AA.nextSibling.data=e:this.$(su.createTextNode(e)),this._$AH=e}g(e){let{values:t,_$litType$:n}=e,r=typeof n==`number`?this._$AC(e):(n.el===void 0&&(n.el=Du.createElement(Tu(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===r)this._$AH.v(t);else{let e=new ku(r,this),n=e.u(this.options);e.v(t),this.$(n),this._$AH=e}}_$AC(e){let t=Cu.get(e.strings);return t===void 0&&Cu.set(e.strings,t=new Du(e)),t}T(t){uu(this._$AH)||(this._$AH=[],this._$AR());let n=this._$AH,r,i=0;for(let a of t)i===n.length?n.push(r=new e(this.k(cu()),this.k(cu()),this,this.options)):r=n[i],r._$AI(a),i++;i<n.length&&(this._$AR(r&&r._$AB.nextSibling,i),n.length=i)}_$AR(e=this._$AA.nextSibling,t){var n;for((n=this._$AP)==null||n.call(this,!1,!0,t);e&&e!==this._$AB;){let t=e.nextSibling;e.remove(),e=t}}setConnected(e){var t;this._$AM===void 0&&(this._$Cp=e,(t=this._$AP)==null||t.call(this,e))}},ju=class{constructor(e,t,n,r,i){this.type=1,this._$AH=Su,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=i,n.length>2||n[0]!==``||n[1]!==``?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=Su}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,n,r){let i=this.strings,a=!1;if(i===void 0)e=Ou(this,e,t,0),a=!lu(e)||e!==this._$AH&&e!==xu,a&&(this._$AH=e);else{let r=e,o,s;for(e=i[0],o=0;o<i.length-1;o++)s=Ou(this,r[n+o],t,o),s===xu&&(s=this._$AH[o]),a||=!lu(s)||s!==this._$AH[o],s===Su?e=Su:e!==Su&&(e+=(s??``)+i[o+1]),this._$AH[o]=s}a&&!r&&this.j(e)}j(e){e===Su?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??``)}},Mu=class extends ju{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===Su?void 0:e}},Nu=tu?tu.emptyScript:``,Pu=class extends ju{constructor(){super(...arguments),this.type=4}j(e){e&&e!==Su?this.element.setAttribute(this.name,Nu):this.element.removeAttribute(this.name)}},Fu=class extends ju{constructor(e,t,n,r,i){super(e,t,n,r,i),this.type=5}_$AI(e,t=this){if((e=Ou(this,e,t,0)??Su)===xu)return;let n=this._$AH,r=e===Su&&n!==Su||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,i=e!==Su&&(n===Su||r);r&&this.element.removeEventListener(this.name,this,n),i&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH==`function`?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},Iu=class{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){Ou(this,e)}},Lu=eu.litHtmlPolyfillSupport;Lu?.(Du,Au),(eu.litHtmlVersions??=[]).push(`2.8.0`);var Ru=(e,t,n)=>{let r=n?.renderBefore??t,i=r._$litPart$;if(i===void 0){let e=n?.renderBefore??null;r._$litPart$=i=new Au(t.insertBefore(cu(),e),e,void 0,n??{})}return i._$AI(e),i},zu,Bu=class extends Dr{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e;let t=super.createRenderRoot();return(e=this.renderOptions).renderBefore??(e.renderBefore=t.firstChild),t}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Ru(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)==null||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)==null||e.setConnected(!1)}render(){return xu}};Bu.finalized=!0,Bu._$litElement$=!0,(zu=globalThis.litElementHydrateSupport)==null||zu.call(globalThis,{LitElement:Bu});var Vu=globalThis.litElementPolyfillSupport;Vu?.({LitElement:Bu}),(globalThis.litElementVersions??(globalThis.litElementVersions=[])).push(`3.3.3`);var Hu;(function(e){e.processing=`processing`,e.complete=`complete`})(Hu||={});var Uu=class extends Bu{constructor(){super(...arguments),this.mode=`processing`}render(){return bu`
      <div class="${this.mode}">
        <svg
          viewBox="0 0 120 120"
    ...
    `}};t([F({type:String})],Uu.prototype,`mode`,void 0),Uu=t([_i(`ia-activity-indicator`)],Uu);var Wu=T`
<svg
  viewBox="0 0 40 40"
  version="1.1"
  xmlns="http://www.w3.org/2000/svg"
...
`,Gu=class extends O{static get styles(){return w`
      :host {
    ...
    `}render(){return Wu}};customElements.define(`ia-icon-close`,Gu);var Ku=T`
  <svg
    class="ia-logo"
    viewBox="0 0 27 30"
    xmlns="http://www.w3.org/2000/svg"
...
`,Ju=class extends O{constructor(){super(...arguments),this.config=new Hl}render(){return T`
      <div class="modal-wrapper">
        <div class="modal-container">
          <header style="background-color: ${this.config.headerColor}">
            ${this.config.showLeftNavButton?this.leftNavButtonTemplate:D}
            ${this.config.showCloseButton?this.closeButtonTemplate:``}
            ${this.config.showHeaderLogo?T`<div class="logo-icon">${Ku}</div>`:D}
    ...
    >
      ${qu} ${this.config.leftNavButtonText??``}
    ...
    `}};t([A({type:Object})],Ju.prototype,`config`,void 0),Ju=t([k(`modal-template`)],Ju);function Yu(e,t,n){var r=n||{},i=r.noTrailing,a=i===void 0?!1:i,o=r.noLeading,s=o===void 0?!1:o,c=r.debounceMode,l=c===void 0?void 0:c,u,d=!1,f=0;function p(){u&&clearTimeout(u)}function m(e){var t=(e||{}).upcomingOnly,n=t===void 0?!1:t;p(),d=!n}function h(){var n=[...arguments],r=this,i=Date.now()-f;if(d)return;function o(){f=Date.now(),t.apply(r,n)}function c(){u=void 0}!s&&l&&!u&&o(),p(),l===void 0&&i>e?s?(f=Date.now(),a||(u=setTimeout(l?c:o,e))):o():a!==!0&&(u=setTimeout(l?c:o,l===void 0?e-i:e))}return h.cancel=m,h}var Xu;(function(e){e.Open=`open`,e.Closed=`closed`})(Xu||={});var Zu=class{constructor(e){this.windowResizeThrottler=Yu(100,this.updateModalContainerHeight,{noLeading:!1,noTrailing:!1}).bind(this),this.modalManager=e}handleModeChange(e){switch(e){case Xu.Open:this.startResizeListener(),this.stopDocumentScroll();break;case Xu.Closed:this.stopResizeListener(),this.resumeDocumentScroll();break}}updateModalContainerHeight(){this.modalManager.style.setProperty(`--containerHeight`,`${window.innerHeight}px`)}stopDocumentScroll(){document.body.classList.add(`modal-manager-open`)}resumeDocumentScroll(){document.body.classList.remove(`modal-manager-open`)}startResizeListener(){window.addEventListener(`resize`,this.windowResizeThrottler)}stopResizeListener(){window.removeEventListener(`resize`,this.windowResizeThrottler)}},Qu=class extends O{constructor(){super(...arguments),this.mode=Xu.Closed,this.hostBridge=new Zu(this),this.modal=new $l(this),this.closeOnBackdropClick=!0}async firstUpdated(){await new Promise(e=>setTimeout(e,0)),this.closeOnBackdropClick&&this.addEventListener(`keydown`,e=>{e.key===`Escape`&&this.backdropClicked()})}disconnectedCallback(){super.disconnectedCallback(),this.modal.deactivate()}render(){return T`
      <div class="container">
    ...
    `}};t([A({type:String,reflect:!0})],Qu.prototype,`mode`,void 0),t([A({type:Object})],Qu.prototype,`customModalContent`,void 0),t([A({type:Object})],Qu.prototype,`hostBridge`,void 0),t([M(`modal-template`)],Qu.prototype,`modalTemplate`,void 0),Qu=t([k(`modal-manager`)],Qu);var $u=w`var(--white, #fff)`,ed=w`var(--primaryDisableCTAFill, #767676)`,td=w`var(--secondaryCTABorder, #999)`,nd=w`var(--primaryCTAFill, #194880)`,rd=w`var(--primaryCTAFillRGB, 25, 72, 128)`,id=w`var(--primaryCTABorder, #c5d1df)`,ad=w`var(--primaryErrorCTAFill, #d9534f)`,od=w`var(--primaryErrorCTAFillRGB, 229, 28, 38)`,sd=w`var(--primaryErrorCTABorder, #d43f3a)`,cd=w`var(--secondaryCTAFill, #333)`,ld=w`var(--secondaryCTAFillRGB, 51, 51, 51)`,ud=w`var(--primaryCTABorder, #979797)`,dd=w`var(---primaryWarningFill, #ee8950)`,fd=w`var(--primaryWarningFillRGB, 238, 137, 80)`,pd=w`
  .ia-button {
    min-height: 3rem;
    cursor: pointer;
    color: ${$u};
  ...
  .ia-button.primary:hover {
    background-color: rgba(${rd}, 0.9);
  }
  .ia-button.primary:focus-visible {
    background-color: rgba(${rd}, 0.8);
  }
  .ia-button.primary:active {
    background-color: rgba(${rd}, 0.7);
  }
  ...
  .ia-button.danger:hover {
    background-color: rgba(${od}, 0.9);
  }
  .ia-button.danger:focus-visible {
    background-color: rgba(${od}, 0.8);
  }
  .ia-button.danger:active {
    background-color: rgba(${od}, 0.7);
  }
  ...
  .ia-button.warning:hover {
    background-color: rgba(${fd}, 0.9);
  }
  .ia-button.warning:focus-visible {
    background-color: rgba(${fd}, 0.8);
  }
  .ia-button.warning:active {
    background-color: rgba(${fd}, 0.7);
  }
  ...
  .ia-button.dark:hover {
    background-color: rgba(${ld}, 0.9);
  }
  .ia-button.dark:focus-visible {
    background-color: rgba(${ld}, 0.8);
  }
  .ia-button.dark:active {
    background-color: rgba(${ld}, 0.7);
  }
...
`,md=class extends O{constructor(...e){super(...e),this.items=[]}render(){return T`
      <ul>
    ...
    `}};z([A({type:Object})],md.prototype,`items`,void 0),z([A({type:String})],md.prototype,`message`,void 0),md=z([k(`remove-items-modal-content`)],md);var hd=class extends O{constructor(...e){super(...e),this.label=N(`Select items to remove`),this.selectedItems=[],this.showSelectAll=!1,this.showUnselectAll=!1,this.showItemManageButton=!1,this.removeAllowed=!1}render(){return T`
    ...
    `}};z([A({type:String})],hd.prototype,`label`,void 0),z([A({type:Object})],hd.prototype,`modalManager`,void 0),z([A({type:Array})],hd.prototype,`selectedItems`,void 0),z([A({type:String})],hd.prototype,`profileElement`,void 0),z([A({type:Boolean})],hd.prototype,`showSelectAll`,void 0),z([A({type:Boolean})],hd.prototype,`showUnselectAll`,void 0),z([A({type:Boolean})],hd.prototype,`showItemManageButton`,void 0),z([A({type:Boolean})],hd.prototype,`removeAllowed`,void 0),hd=z([k(`manage-bar`)],hd);var gd=(e,t)=>{let n=e._$AN;if(n===void 0)return!1;for(let e of n)e._$AO?.(t,!1),gd(e,t);return!0},_d=e=>{let t,n;do{if((t=e._$AM)===void 0)break;n=t._$AN,n.delete(e),e=t}while(n?.size===0)},vd=e=>{for(let t;t=e._$AM;e=t){let n=t._$AN;if(n===void 0)t._$AN=n=new Set;else if(n.has(e))break;n.add(e),xd(t)}};function yd(e){this._$AN===void 0?this._$AM=e:(_d(this),this._$AM=e,vd(this))}function bd(e,t=!1,n=0){let r=this._$AH,i=this._$AN;if(i!==void 0&&i.size!==0)if(t)if(Array.isArray(r))for(let e=n;e<r.length;e++)gd(r[e],!1),_d(r[e]);else r!=null&&(gd(r,!1),_d(r));else gd(this,e)}var xd=e=>{e.type==nr.CHILD&&(e._$AP??=bd,e._$AQ??=yd)},Sd=class extends ir{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,n){super._$AT(e,t,n),vd(this),this.isConnected=e._$AU}_$AO(e,t=!0){e!==this.isConnected&&(this.isConnected=e,e?this.reconnected?.():this.disconnected?.()),t&&(gd(this,e),_d(this))}setValue(e){if(Ua(this._$Ct))this._$Ct._$AI(e,this);else{let t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}},Cd=new WeakMap,wd=rr(class extends Sd{render(e){return C}update(e,[t]){let n=t!==this.G;return n&&this.G!==void 0&&this.rt(void 0),(n||this.lt!==this.ct)&&(this.G=t,this.ht=e.options?.host,this.rt(this.ct=e.element)),C}rt(e){if(this.isConnected||(e=void 0),typeof this.G==`function`){let t=this.ht??globalThis,n=Cd.get(t);n===void 0&&(n=new WeakMap,Cd.set(t,n)),n.get(this.G)!==void 0&&this.G.call(this.ht,void 0),n.set(this.G,e),e!==void 0&&this.G.call(this.ht,e)}else this.G.value=e}get lt(){return typeof this.G==`function`?Cd.get(this.ht??globalThis)?.get(this.G):this.G?.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}}),Td=3600,Ed=Td*24,Dd=Ed*7,Od=1e3,kd=60*Od,Ad=Td*Od,jd=Ed*Od,Md=Dd*Od,Nd=`millisecond`,Pd=`second`,Fd=`minute`,Id=`hour`,Ld=`week`,Rd=`month`,zd=`quarter`,Bd=`year`,Vd=`date`,Hd=`Invalid Date`,Ud=/^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/,Wd=/\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g,Gd={name:`en`,weekdays:`Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday`.split(`_`),months:`January_February_March_April_May_June_July_August_September_October_November_December`.split(`_`),ordinal:function(e){var t=[`th`,`st`,`nd`,`rd`],n=e%100;return`[`+e+(t[(n-20)%10]||t[n]||t[0])+`]`}},Kd=function(e,t,n){var r=String(e);return!r||r.length>=t?e:``+Array(t+1-r.length).join(n)+e},qd={s:Kd,z:function(e){var t=-e.utcOffset(),n=Math.abs(t),r=Math.floor(n/60),i=n%60;return(t<=0?`+`:`-`)+Kd(r,2,`0`)+`:`+Kd(i,2,`0`)},m:function e(t,n){if(t.date()<n.date())return-e(n,t);var r=(n.year()-t.year())*12+(n.month()-t.month()),i=t.clone().add(r,Rd),a=n-i<0,o=t.clone().add(r+(a?-1:1),Rd);return+(-(r+(n-i)/(a?i-o:o-i))||0)},a:function(e){return e<0?Math.ceil(e)||0:Math.floor(e)},p:function(e){return{M:`month`,y:`year`,w:`week`,d:`day`,D:`date`,h:`hour`,m:`minute`,s:`second`,ms:`millisecond`,Q:`quarter`}[e]||String(e||``).toLowerCase().replace(/s$/,``)},u:function(e){return e===void 0}},Jd=`en`,Yd={};Yd[Jd]=Gd;var Xd=`$isDayjsObject`,Zd=function(e){return e instanceof tf||!!(e&&e[Xd])},Qd=function e(t,n,r){var i;if(!t)return Jd;if(typeof t==`string`){var a=t.toLowerCase();Yd[a]&&(i=a),n&&(Yd[a]=n,i=a);var o=t.split(`-`);if(!i&&o.length>1)return e(o[0])}else{var s=t.name;Yd[s]=t,i=s}return!r&&i&&(Jd=i),i||!r&&Jd},U=function(e,t){if(Zd(e))return e.clone();var n=typeof t==`object`?t:{};return n.date=e,n.args=arguments,new tf(n)},$d=function(e,t){return U(e,{locale:t.$L,utc:t.$u,x:t.$x,$offset:t.$offset})},W=qd;W.l=Qd,W.i=Zd,W.w=$d;var ef=function(e){var t=e.date,n=e.utc;if(t===null)return new Date(NaN);if(W.u(t))return new Date;if(t instanceof Date)return new Date(t);if(typeof t==`string`&&!/Z$/i.test(t)){var r=t.match(Ud);if(r){var i=r[2]-1||0,a=(r[7]||`0`).substring(0,3);return n?new Date(Date.UTC(r[1],i,r[3]||1,r[4]||0,r[5]||0,r[6]||0,a)):new Date(r[1],i,r[3]||1,r[4]||0,r[5]||0,r[6]||0,a)}}return new Date(t)},tf=function(){function e(e){this.$L=Qd(e.locale,null,!0),this.parse(e),this.$x=this.$x||e.x||{},this[Xd]=!0}var t=e.prototype;return t.parse=function(e){this.$d=ef(e),this.init()},t.init=function(){var e=this.$d;this.$y=e.getFullYear(),this.$M=e.getMonth(),this.$D=e.getDate(),this.$W=e.getDay(),this.$H=e.getHours(),this.$m=e.getMinutes(),this.$s=e.getSeconds(),this.$ms=e.getMilliseconds()},t.$utils=function(){return W},t.isValid=function(){return this.$d.toString()!==Hd},t.isSame=function(e,t){var n=U(e);return this.startOf(t)<=n&&n<=this.endOf(t)},t.isAfter=function(e,t){return U(e)<this.startOf(t)},t.isBefore=function(e,t){return this.endOf(t)<U(e)},t.$g=function(e,t,n){return W.u(e)?this[t]:this.set(n,e)},t.unix=function(){return Math.floor(this.valueOf()/1e3)},t.valueOf=function(){return this.$d.getTime()},t.startOf=function(e,t){var n=this,r=W.u(t)?!0:t,i=W.p(e),a=function(e,t){var i=W.w(n.$u?Date.UTC(n.$y,t,e):new Date(n.$y,t,e),n);return r?i:i.endOf(`day`)},o=function(e,t){return W.w(n.toDate()[e].apply(n.toDate(`s`),(r?[0,0,0,0]:[23,59,59,999]).slice(t)),n)},s=this.$W,c=this.$M,l=this.$D,u=`set`+(this.$u?`UTC`:``);switch(i){case Bd:return r?a(1,0):a(31,11);case Rd:return r?a(1,c):a(0,c+1);case Ld:var d=this.$locale().weekStart||0,f=(s<d?s+7:s)-d;return a(r?l-f:l+(6-f),c);case`day`:case Vd:return o(u+`Hours`,0);case Id:return o(u+`Minutes`,1);case Fd:return o(u+`Seconds`,2);case Pd:return o(u+`Milliseconds`,3);default:return this.clone()}},t.endOf=function(e){return this.startOf(e,!1)},t.$set=function(e,t){var n,r=W.p(e),i=`set`+(this.$u?`UTC`:``),a=(n={},n.day=i+`Date`,n[Vd]=i+`Date`,n[Rd]=i+`Month`,n[Bd]=i+`FullYear`,n[Id]=i+`Hours`,n[Fd]=i+`Minutes`,n[Pd]=i+`Seconds`,n[Nd]=i+`Milliseconds`,n)[r],o=r===`day`?this.$D+(t-this.$W):t;if(r===`month`||r===`year`){var s=this.clone().set(Vd,1);s.$d[a](o),s.init(),this.$d=s.set(Vd,Math.min(this.$D,s.daysInMonth())).$d}else a&&this.$d[a](o);return this.init(),this},t.set=function(e,t){return this.clone().$set(e,t)},t.get=function(e){return this[W.p(e)]()},t.add=function(e,t){var n=this,r;e=Number(e);var i=W.p(t),a=function(t){var r=U(n);return W.w(r.date(r.date()+Math.round(t*e)),n)};if(i===`month`)return this.set(Rd,this.$M+e);if(i===`year`)return this.set(Bd,this.$y+e);if(i===`day`)return a(1);if(i===`week`)return a(7);var o=(r={},r.minute=6e4,r.hour=36e5,r.second=1e3,r)[i]||1,s=this.$d.getTime()+e*o;return W.w(s,this)},t.subtract=function(e,t){return this.add(e*-1,t)},t.format=function(e){var t=this,n=this.$locale();if(!this.isValid())return n.invalidDate||`Invalid Date`;var r=e||`YYYY-MM-DDTHH:mm:ssZ`,i=W.z(this),a=this.$H,o=this.$m,s=this.$M,c=n.weekdays,l=n.months,u=n.meridiem,d=function(e,n,i,a){return e&&(e[n]||e(t,r))||i[n].slice(0,a)},f=function(e){return W.s(a%12||12,e,`0`)},p=u||function(e,t,n){var r=e<12?`AM`:`PM`;return n?r.toLowerCase():r},m=function(e){switch(e){case`YY`:return String(t.$y).slice(-2);case`YYYY`:return W.s(t.$y,4,`0`);case`M`:return s+1;case`MM`:return W.s(s+1,2,`0`);case`MMM`:return d(n.monthsShort,s,l,3);case`MMMM`:return d(l,s);case`D`:return t.$D;case`DD`:return W.s(t.$D,2,`0`);case`d`:return String(t.$W);case`dd`:return d(n.weekdaysMin,t.$W,c,2);case`ddd`:return d(n.weekdaysShort,t.$W,c,3);case`dddd`:return c[t.$W];case`H`:return String(a);case`HH`:return W.s(a,2,`0`);case`h`:return f(1);case`hh`:return f(2);case`a`:return p(a,o,!0);case`A`:return p(a,o,!1);case`m`:return String(o);case`mm`:return W.s(o,2,`0`);case`s`:return String(t.$s);case`ss`:return W.s(t.$s,2,`0`);case`SSS`:return W.s(t.$ms,3,`0`);case`Z`:return i;default:break}return null};return r.replace(Wd,function(e,t){return t||m(e)||i.replace(`:`,``)})},t.utcOffset=function(){return-Math.round(this.$d.getTimezoneOffset()/15)*15},t.diff=function(e,t,n){var r=this,i=W.p(t),a=U(e),o=(a.utcOffset()-this.utcOffset())*kd,s=this-a,c=function(){return W.m(r,a)},l;switch(i){case Bd:l=c()/12;break;case Rd:l=c();break;case zd:l=c()/3;break;case Ld:l=(s-o)/Md;break;case`day`:l=(s-o)/jd;break;case Id:l=s/Ad;break;case Fd:l=s/kd;break;case Pd:l=s/Od;break;default:l=s;break}return n?l:W.a(l)},t.daysInMonth=function(){return this.endOf(Rd).$D},t.$locale=function(){return Yd[this.$L]},t.locale=function(e,t){if(!e)return this.$L;var n=this.clone(),r=Qd(e,t,!0);return r&&(n.$L=r),n},t.clone=function(){return W.w(this.$d,this)},t.toDate=function(){return new Date(this.valueOf())},t.toJSON=function(){return this.isValid()?this.toISOString():null},t.toISOString=function(){return this.$d.toISOString()},t.toString=function(){return this.$d.toUTCString()},e}(),nf=tf.prototype;U.prototype=nf,[[`$ms`,Nd],[`$s`,Pd],[`$m`,Fd],[`$H`,Id],[`$W`,`day`],[`$M`,Rd],[`$y`,Bd],[`$D`,Vd]].forEach(function(e){nf[e[1]]=function(t){return this.$g(t,e[0],e[1])}}),U.extend=function(e,t){return e.$i||=(e(t,tf,U),!0),U},U.locale=Qd,U.isDayjs=Zd,U.unix=function(e){return U(e*1e3)},U.en=Yd[Jd],U.Ls=Yd,U.p={};var rf=function(e){return e.replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g,function(e,t,n){return t||n.slice(1)})},af={LTS:`h:mm:ss A`,LT:`h:mm A`,L:`MM/DD/YYYY`,LL:`MMMM D, YYYY`,LLL:`MMMM D, YYYY h:mm A`,LLLL:`dddd, MMMM D, YYYY h:mm A`},of=function(e,t){return e.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g,function(e,n,r){var i=r&&r.toUpperCase();return n||t[r]||af[r]||rf(t[i])})},sf=/(\[[^[]*\])|([-_:/.,()\s]+)|(A|a|Q|YYYY|YY?|ww?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g,cf=/\d/,lf=/\d\d/,uf=/\d{3}/,df=/\d{4}/,ff=/\d\d?/,pf=/[+-]?\d+/,mf=/[+-]\d\d:?(\d\d)?|Z/,hf=/\d*[^-_:/,()\s\d]+/,gf={},_f=function(e){return e=+e,e+(e>68?1900:2e3)};function vf(e){if(!e||e===`Z`)return 0;var t=e.match(/([+-]|\d\d)/g),n=+(t[1]*60)+(+t[2]||0);return n===0?0:t[0]===`+`?-n:n}var yf=function(e){return function(t){this[e]=+t}},bf=[mf,function(e){var t=this.zone||={};t.offset=vf(e)}],xf=function(e){var t=gf[e];return t&&(t.indexOf?t:t.s.concat(t.f))},Sf=function(e,t){var n,r=gf.meridiem;if(!r)n=e===(t?`pm`:`PM`);else for(var i=1;i<=24;i+=1)if(e.indexOf(r(i,0,t))>-1){n=i>12;break}return n},Cf={A:[hf,function(e){this.afternoon=Sf(e,!1)}],a:[hf,function(e){this.afternoon=Sf(e,!0)}],Q:[cf,function(e){this.month=(e-1)*3+1}],S:[cf,function(e){this.milliseconds=e*100}],SS:[lf,function(e){this.milliseconds=e*10}],SSS:[uf,function(e){this.milliseconds=+e}],s:[ff,yf(`seconds`)],ss:[ff,yf(`seconds`)],m:[ff,yf(`minutes`)],mm:[ff,yf(`minutes`)],H:[ff,yf(`hours`)],h:[ff,yf(`hours`)],HH:[ff,yf(`hours`)],hh:[ff,yf(`hours`)],D:[ff,yf(`day`)],DD:[lf,yf(`day`)],Do:[hf,function(e){var t=gf.ordinal,n=e.match(/\d+/);if(this.day=n[0],t)for(var r=1;r<=31;r+=1)t(r).replace(/\[|\]/g,``)===e&&(this.day=r)}],w:[ff,yf(`week`)],ww:[lf,yf(`week`)],M:[ff,yf(`month`)],MM:[lf,yf(`month`)],MMM:[hf,function(e){var t=xf(`months`),n=(xf(`monthsShort`)||t.map(function(e){return e.slice(0,3)})).indexOf(e)+1;if(n<1)throw Error();this.month=n%12||n}],MMMM:[hf,function(e){var t=xf(`months`).indexOf(e)+1;if(t<1)throw Error();this.month=t%12||t}],Y:[pf,yf(`year`)],YY:[lf,function(e){this.year=_f(e)}],YYYY:[df,yf(`year`)],Z:bf,ZZ:bf};function wf(e){var t=e.afternoon;if(t!==void 0){var n=e.hours;t?n<12&&(e.hours+=12):n===12&&(e.hours=0),delete e.afternoon}}function Tf(e){e=of(e,gf&&gf.formats);for(var t=e.match(sf),n=t.length,r=0;r<n;r+=1){var i=t[r],a=Cf[i],o=a&&a[0],s=a&&a[1];s?t[r]={regex:o,parser:s}:t[r]=i.replace(/^\[|\]$/g,``)}return function(e){for(var r={},i=0,a=0;i<n;i+=1){var o=t[i];if(typeof o==`string`)a+=o.length;else{var s=o.regex,c=o.parser,l=e.slice(a),u=s.exec(l)[0];c.call(r,u),e=e.replace(u,``)}}return wf(r),r}}var Ef=function(e,t,n,r){try{if([`x`,`X`].indexOf(t)>-1)return new Date((t===`X`?1e3:1)*e);var i=Tf(t)(e),a=i.year,o=i.month,s=i.day,c=i.hours,l=i.minutes,u=i.seconds,d=i.milliseconds,f=i.zone,p=i.week,m=new Date,h=s||(!a&&!o?m.getDate():1),ee=a||m.getFullYear(),te=0;a&&!o||(te=o>0?o-1:m.getMonth());var ne=c||0,g=l||0,_=u||0,re=d||0;if(f)return new Date(Date.UTC(ee,te,h,ne,g,_,re+f.offset*60*1e3));if(n)return new Date(Date.UTC(ee,te,h,ne,g,_,re));var ie=new Date(ee,te,h,ne,g,_,re);return p&&(ie=r(ie).week(p).toDate()),ie}catch{return new Date(``)}},Df=(function(e,t,n){n.p.customParseFormat=!0,e&&e.parseTwoDigitYear&&(_f=e.parseTwoDigitYear);var r=t.prototype,i=r.parse;r.parse=function(e){var t=e.date,r=e.utc,a=e.args;this.$u=r;var o=a[1];if(typeof o==`string`){var s=a[2]===!0,c=a[3]===!0,l=s||c,u=a[2];c&&(u=a[2]),gf=this.$locale(),!s&&u&&(gf=n.Ls[u]),this.$d=Ef(t,o,r,n),this.init(),u&&u!==!0&&(this.$L=this.locale(u).$L),l&&t!=this.format(o)&&(this.$d=new Date(``)),gf={}}else if(o instanceof Array)for(var d=o.length,f=1;f<=d;f+=1){a[1]=o[f-1];var p=n.apply(this,a);if(p.isValid()){this.$d=p.$d,this.$L=p.$L,this.init();break}f===d&&(this.$d=new Date(``))}else i.call(this,e)}});function Of(e,t){let n=t.prototype,r=n.parse;n.parse=function(e){let t=e.date,n=e.args[1];r.call(this,e);let i=this.year(),a=i>=1900&&i<2e3,o=typeof n==`string`&&n.includes(`YYYY`),s=Array.isArray(n)&&typeof n[0]==`string`&&n[0].includes(`YYYY`),c=o||s,l=typeof t==`string`&&!t.includes(`${i}`);a&&c&&l&&(this.$d.setFullYear(i-1900),this.init())}}var kf=window,Af=kf.trustedTypes,jf=Af?Af.createPolicy(`lit-html`,{createHTML:e=>e}):void 0,Mf=`$lit$`,Nf=`lit$${(Math.random()+``).slice(9)}$`,Pf=`?`+Nf,Ff=`<${Pf}>`,If=document,Lf=()=>If.createComment(``),Rf=e=>e===null||typeof e!=`object`&&typeof e!=`function`,zf=Array.isArray,Bf=e=>zf(e)||typeof e?.[Symbol.iterator]==`function`,Vf=`[ 	
\f\r]`,Hf=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Uf=/-->/g,Wf=/>/g,Gf=RegExp(`>|${Vf}(?:([^\\s"'>=/]+)(${Vf}*=${Vf}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,`g`),Kf=/'/g,qf=/"/g,Jf=/^(?:script|style|textarea|title)$/i,Yf=e=>(t,...n)=>({_$litType$:e,strings:t,values:n}),Xf=Yf(1),Zf=Yf(2),Qf=Symbol.for(`lit-noChange`),$f=Symbol.for(`lit-nothing`),ep=new WeakMap,tp=If.createTreeWalker(If,129,null,!1);function np(e,t){if(!Array.isArray(e)||!e.hasOwnProperty(`raw`))throw Error(`invalid template strings array`);return jf===void 0?t:jf.createHTML(t)}var rp=(e,t)=>{let n=e.length-1,r=[],i,a=t===2?`<svg>`:``,o=Hf;for(let t=0;t<n;t++){let n=e[t],s,c,l=-1,u=0;for(;u<n.length&&(o.lastIndex=u,c=o.exec(n),c!==null);)u=o.lastIndex,o===Hf?c[1]===`!--`?o=Uf:c[1]===void 0?c[2]===void 0?c[3]!==void 0&&(o=Gf):(Jf.test(c[2])&&(i=RegExp(`</`+c[2],`g`)),o=Gf):o=Wf:o===Gf?c[0]===`>`?(o=i??Hf,l=-1):c[1]===void 0?l=-2:(l=o.lastIndex-c[2].length,s=c[1],o=c[3]===void 0?Gf:c[3]===`"`?qf:Kf):o===qf||o===Kf?o=Gf:o===Uf||o===Wf?o=Hf:(o=Gf,i=void 0);let d=o===Gf&&e[t+1].startsWith(`/>`)?` `:``;a+=o===Hf?n+Ff:l>=0?(r.push(s),n.slice(0,l)+Mf+n.slice(l)+Nf+d):n+Nf+(l===-2?(r.push(void 0),t):d)}return[np(e,a+(e[n]||`<?>`)+(t===2?`</svg>`:``)),r]},ip=class e{constructor({strings:t,_$litType$:n},r){let i;this.parts=[];let a=0,o=0,s=t.length-1,c=this.parts,[l,u]=rp(t,n);if(this.el=e.createElement(l,r),tp.currentNode=this.el.content,n===2){let e=this.el.content,t=e.firstChild;t.remove(),e.append(...t.childNodes)}for(;(i=tp.nextNode())!==null&&c.length<s;){if(i.nodeType===1){if(i.hasAttributes()){let e=[];for(let t of i.getAttributeNames())if(t.endsWith(Mf)||t.startsWith(Nf)){let n=u[o++];if(e.push(t),n!==void 0){let e=i.getAttribute(n.toLowerCase()+Mf).split(Nf),t=/([.?@])?(.*)/.exec(n);c.push({type:1,index:a,name:t[2],strings:e,ctor:t[1]===`.`?lp:t[1]===`?`?dp:t[1]===`@`?fp:cp})}else c.push({type:6,index:a})}for(let t of e)i.removeAttribute(t)}if(Jf.test(i.tagName)){let e=i.textContent.split(Nf),t=e.length-1;if(t>0){i.textContent=Af?Af.emptyScript:``;for(let n=0;n<t;n++)i.append(e[n],Lf()),tp.nextNode(),c.push({type:2,index:++a});i.append(e[t],Lf())}}}else if(i.nodeType===8)if(i.data===Pf)c.push({type:2,index:a});else{let e=-1;for(;(e=i.data.indexOf(Nf,e+1))!==-1;)c.push({type:7,index:a}),e+=Nf.length-1}a++}}static createElement(e,t){let n=If.createElement(`template`);return n.innerHTML=e,n}};function ap(e,t,n=e,r){var i,a;if(t===Qf)return t;let o=r===void 0?n._$Cl:n._$Co?.[r],s=Rf(t)?void 0:t._$litDirective$;return o?.constructor!==s&&((i=o?._$AO)==null||i.call(o,!1),s===void 0?o=void 0:(o=new s(e),o._$AT(e,n,r)),r===void 0?n._$Cl=o:((a=n)._$Co??(a._$Co=[]))[r]=o),o!==void 0&&(t=ap(e,o._$AS(e,t.values),o,r)),t}var op=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:n}=this._$AD,r=(e?.creationScope??If).importNode(t,!0);tp.currentNode=r;let i=tp.nextNode(),a=0,o=0,s=n[0];for(;s!==void 0;){if(a===s.index){let t;s.type===2?t=new sp(i,i.nextSibling,this,e):s.type===1?t=new s.ctor(i,s.name,s.strings,this,e):s.type===6&&(t=new pp(i,this,e)),this._$AV.push(t),s=n[++o]}a!==s?.index&&(i=tp.nextNode(),a++)}return tp.currentNode=If,r}v(e){let t=0;for(let n of this._$AV)n!==void 0&&(n.strings===void 0?n._$AI(e[t]):(n._$AI(e,n,t),t+=n.strings.length-2)),t++}},sp=class e{constructor(e,t,n,r){var i;this.type=2,this._$AH=$f,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=r,this._$Cp=(i=r?.isConnected)==null||i}get _$AU(){return this._$AM?._$AU??this._$Cp}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=ap(this,e,t),Rf(e)?e===$f||e==null||e===``?(this._$AH!==$f&&this._$AR(),this._$AH=$f):e!==this._$AH&&e!==Qf&&this._(e):e._$litType$===void 0?e.nodeType===void 0?Bf(e)?this.T(e):this._(e):this.$(e):this.g(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==$f&&Rf(this._$AH)?this._$AA.nextSibling.data=e:this.$(If.createTextNode(e)),this._$AH=e}g(e){let{values:t,_$litType$:n}=e,r=typeof n==`number`?this._$AC(e):(n.el===void 0&&(n.el=ip.createElement(np(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===r)this._$AH.v(t);else{let e=new op(r,this),n=e.u(this.options);e.v(t),this.$(n),this._$AH=e}}_$AC(e){let t=ep.get(e.strings);return t===void 0&&ep.set(e.strings,t=new ip(e)),t}T(t){zf(this._$AH)||(this._$AH=[],this._$AR());let n=this._$AH,r,i=0;for(let a of t)i===n.length?n.push(r=new e(this.k(Lf()),this.k(Lf()),this,this.options)):r=n[i],r._$AI(a),i++;i<n.length&&(this._$AR(r&&r._$AB.nextSibling,i),n.length=i)}_$AR(e=this._$AA.nextSibling,t){var n;for((n=this._$AP)==null||n.call(this,!1,!0,t);e&&e!==this._$AB;){let t=e.nextSibling;e.remove(),e=t}}setConnected(e){var t;this._$AM===void 0&&(this._$Cp=e,(t=this._$AP)==null||t.call(this,e))}},cp=class{constructor(e,t,n,r,i){this.type=1,this._$AH=$f,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=i,n.length>2||n[0]!==``||n[1]!==``?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=$f}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,n,r){let i=this.strings,a=!1;if(i===void 0)e=ap(this,e,t,0),a=!Rf(e)||e!==this._$AH&&e!==Qf,a&&(this._$AH=e);else{let r=e,o,s;for(e=i[0],o=0;o<i.length-1;o++)s=ap(this,r[n+o],t,o),s===Qf&&(s=this._$AH[o]),a||=!Rf(s)||s!==this._$AH[o],s===$f?e=$f:e!==$f&&(e+=(s??``)+i[o+1]),this._$AH[o]=s}a&&!r&&this.j(e)}j(e){e===$f?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??``)}},lp=class extends cp{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===$f?void 0:e}},up=Af?Af.emptyScript:``,dp=class extends cp{constructor(){super(...arguments),this.type=4}j(e){e&&e!==$f?this.element.setAttribute(this.name,up):this.element.removeAttribute(this.name)}},fp=class extends cp{constructor(e,t,n,r,i){super(e,t,n,r,i),this.type=5}_$AI(e,t=this){if((e=ap(this,e,t,0)??$f)===Qf)return;let n=this._$AH,r=e===$f&&n!==$f||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,i=e!==$f&&(n===$f||r);r&&this.element.removeEventListener(this.name,this,n),i&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH==`function`?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},pp=class{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){ap(this,e)}},mp={O:Mf,P:Nf,A:Pf,C:1,M:rp,L:op,R:Bf,D:ap,I:sp,V:cp,H:dp,N:fp,U:lp,F:pp},hp=kf.litHtmlPolyfillSupport;hp?.(ip,sp),(kf.litHtmlVersions??=[]).push(`2.8.0`);var gp=(e,t,n)=>{let r=n?.renderBefore??t,i=r._$litPart$;if(i===void 0){let e=n?.renderBefore??null;r._$litPart$=i=new sp(t.insertBefore(Lf(),e),e,void 0,n??{})}return i._$AI(e),i},_p,vp=class extends Dr{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e;let t=super.createRenderRoot();return(e=this.renderOptions).renderBefore??(e.renderBefore=t.firstChild),t}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=gp(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)==null||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)==null||e.setConnected(!1)}render(){return Qf}};vp.finalized=!0,vp._$litElement$=!0,(_p=globalThis.litElementHydrateSupport)==null||_p.call(globalThis,{LitElement:vp});var yp=globalThis.litElementPolyfillSupport;yp?.({LitElement:vp}),(globalThis.litElementVersions??(globalThis.litElementVersions=[])).push(`3.3.3`);var bp={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},xp=e=>(...t)=>({_$litDirective$:e,values:t}),Sp=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,n){this._$Ct=e,this._$AM=t,this._$Ci=n}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}},{I:Cp}=mp,wp=e=>e.strings===void 0,Tp={},Ep=(e,t=Tp)=>e._$AH=t,Dp=xp(class extends Sp{constructor(e){if(super(e),e.type!==bp.PROPERTY&&e.type!==bp.ATTRIBUTE&&e.type!==bp.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!wp(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===Qf||t===$f)return t;let n=e.element,r=e.name;if(e.type===bp.PROPERTY){if(t===n[r])return Qf}else if(e.type===bp.BOOLEAN_ATTRIBUTE){if(!!t===n.hasAttribute(r))return Qf}else if(e.type===bp.ATTRIBUTE&&n.getAttribute(r)===t+``)return Qf;return Ep(e),t}}),Op=xp(class extends Sp{constructor(e){if(super(e),e.type!==bp.ATTRIBUTE||e.name!==`class`||e.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return` `+Object.keys(e).filter((t=>e[t])).join(` `)+` `}update(e,[t]){var n;if(this.it===void 0){this.it=new Set,e.strings!==void 0&&(this.nt=new Set(e.strings.join(` `).split(/\s/).filter((e=>e!==``))));for(let e in t)t[e]&&!this.nt?.has(e)&&this.it.add(e);return this.render(t)}let r=e.element.classList;this.it.forEach((e=>{e in t||(r.remove(e),this.it.delete(e))}));for(let e in t){let i=!!t[e];i===this.it.has(e)||(n=this.nt)!=null&&n.has(e)||(i?(r.add(e),this.it.add(e)):(r.remove(e),this.it.delete(e)))}return Qf}}),kp=`important`,Ap=` !`+kp,jp=xp(class extends Sp{constructor(e){if(super(e),e.type!==bp.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce(((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`}),``)}update(e,[t]){let{style:n}=e.element;if(this.ht===void 0){this.ht=new Set;for(let e in t)this.ht.add(e);return this.render(t)}this.ht.forEach((e=>{t[e]??(this.ht.delete(e),e.includes(`-`)?n.removeProperty(e):n[e]=``)}));for(let e in t){let r=t[e];if(r!=null){this.ht.add(e);let t=typeof r==`string`&&r.endsWith(Ap);e.includes(`-`)||t?n.setProperty(e,t?r.slice(0,-11):r,t?kp:``):n[e]=r}}return Qf}});U.extend(Df),U.extend(Of);var Mp=180,Np=40,Pp=10,Fp=125,Ip=30,Lp=`YYYY`,Rp=`no data`,zp=0,Bp=`item`,Vp=4,Hp={linear:e=>e,logarithmic:e=>Math.log1p(e)},Up=P`var(--histogramDateRangeSliderColor, #4B65FE)`,Wp=P`var(--histogramDateRangeSelectedRangeColor, #DBE0FF)`,Gp=P`var(--histogramDateRangeBarIncludedFill, #2C2C2C)`,Kp=P`var(--histogramDateRangeActivityIndicator, #2C2C2C)`,qp=P`var(--histogramDateRangeBarExcludedFill, #CCCCCC)`,Jp=P`var(--histogramDateRangeInputRowMargin, 0)`,Yp=P`var(--histogramDateRangeInputBorder, 0.5px solid #2C2C2C)`,Xp=P`var(--histogramDateRangeInputWidth, 35px)`,Zp=P`var(--histogramDateRangeInputFontSize, 1.2rem)`,Qp=P`var(--histogramDateRangeInputFontFamily, sans-serif)`,$p=P`var(--histogramDateRangeTooltipBackgroundColor, #2C2C2C)`,em=P`var(--histogramDateRangeTooltipTextColor, #FFFFFF)`,tm=P`var(--histogramDateRangeTooltipFontSize, 1.1rem)`,nm=P`var(--histogramDateRangeTooltipFontFamily, sans-serif)`,G=class extends vp{constructor(){super(...arguments),this.width=Mp,this.height=Np,this.sliderWidth=Pp,this.tooltipWidth=Fp,this.tooltipHeight=Ip,this.updateDelay=zp,this.dateFormat=Lp,this.missingDataMessage=Rp,this.minDate=``,this.maxDate=``,this.disabled=!1,this.bins=[],this.updateWhileFocused=!1,this.binSnapping=`none`,this.tooltipLabel=Bp,this.barScaling=`logarithmic`,this._tooltipOffsetX=0,this._tooltipOffsetY=0,this._isDragging=!1,this._isLoading=!1,this._minSelectedDate=``,this._maxSelectedDate=``,this._minDateMS=0,this._maxDateMS=0,this._dragOffset=0,this._histWidth=0,this._binWidth=0,this._histData=[],this._previousDateRange=``,this.drag=e=>{e.preventDefault(),!this.disabled&&(this.setDragOffset(e),this._isDragging=!0,this.addListeners(),this.cancelPendingUpdateEvent())},this.drop=()=>{this._isDragging&&(this.removeListeners(),this.beginEmitUpdateProcess()),this._isDragging=!1},this.move=e=>{let t=this.getBoundingClientRect().x,n=e.clientX-t-this._dragOffset;this._currentSlider.id===`slider-min`?this.minSelectedDate=this.translatePositionToDate(this.validMinSliderX(n)):(this.maxSelectedDate=this.translatePositionToDate(this.validMaxSliderX(n)),this.getMSFromString(this.maxSelectedDate)>this._maxDateMS&&(this.maxSelectedDate=this.maxDate))}}disconnectedCallback(){this.removeListeners(),super.disconnectedCallback()}willUpdate(e){(e.has(`bins`)||e.has(`minDate`)||e.has(`maxDate`)||e.has(`minSelectedDate`)||e.has(`maxSelectedDate`)||e.has(`width`)||e.has(`height`)||e.has(`binSnapping`)||e.has(`barScaling`))&&this.handleDataUpdate()}handleDataUpdate(){this.hasBinData&&(this._histWidth=this.width-this.sliderWidth*2,this._minDateMS=this.snapTimestamp(this.getMSFromString(this.minDate)),this._maxDateMS=this.snapTimestamp(this.getMSFromString(this.maxDate)+this.snapInterval)+this.snapEndOffset,this._binWidth=this._histWidth/this._numBins,this._previousDateRange=this.currentDateRangeString,this._histData=this.calculateHistData(),this.minSelectedDate=this.minSelectedDate?this.minSelectedDate:this.minDate,this.maxSelectedDate=this.maxSelectedDate?this.maxSelectedDate:this.maxDate)}snapToNextSecond(e){return Math.ceil(e/1e3)*1e3}snapToMonth(e){let t=U(e),n=t.date()<16?0:1;return t.add(n,`month`).date(1).hour(0).minute(0).second(0).millisecond(0).valueOf()}snapToYear(e){let t=U(e),n=t.month()<6?0:1;return t.add(n,`year`).month(0).date(1).hour(0).minute(0).second(0).millisecond(0).valueOf()}snapTimestamp(e){switch(this.binSnapping){case`year`:return this.snapToYear(e);case`month`:return this.snapToMonth(e);default:return this.snapToNextSecond(e)}}get barScalingFunction(){return typeof this.barScaling==`string`?Hp[this.barScaling]:this.barScaling}calculateHistData(){let{bins:e,height:t,dateRangeMS:n,_numBins:r,_minDateMS:i}=this,a=Math.min(...this.bins),o=Math.max(...this.bins),s=t/(a===o?1:this.barScalingFunction(o)),c=n/r;return e.map((e,t)=>{let n=this.snapTimestamp(t*c+i),r=this.formatDate(n),a=this.snapTimestamp((t+1)*c+i)+this.snapEndOffset,o=this.formatDate(a),l=this.formatDate(n,this.tooltipDateFormat),u=this.formatDate(a,this.tooltipDateFormat),d=l===u?l:`${l} - ${u}`;return{value:e,height:Math.floor(this.barScalingFunction(e)*s),binStart:r,binEnd:o,tooltip:d}})}get hasBinData(){return this._numBins>0}get _numBins(){return!this.bins||!this.bins.length?0:this.bins.length}get histogramLeftEdgeX(){return this.sliderWidth}get histogramRightEdgeX(){return this.width-this.sliderWidth}get snapInterval(){switch(this.binSnapping){case`year`:return 31536e6;case`month`:return 2592e6;default:return 0}}get snapEndOffset(){return this.binSnapping!==`none`&&this._numBins>1?-1:0}get tooltipDateFormat(){return this._tooltipDateFormat??this.dateFormat}set tooltipDateFormat(e){this._tooltipDateFormat=e}get loading(){return this._isLoading}set loading(e){this.disabled=e,this._isLoading=e}get minSelectedDate(){return this.formatDate(this.getMSFromString(this._minSelectedDate))}set minSelectedDate(e){if(!this._minSelectedDate){this._minSelectedDate=e;return}let t=this.getMSFromString(e),n=!Number.isNaN(t),r=t<=this.getMSFromString(this.maxSelectedDate);n&&r&&(this._minSelectedDate=this.formatDate(t)),this.requestUpdate()}get maxSelectedDate(){return this.formatDate(this.getMSFromString(this._maxSelectedDate))}set maxSelectedDate(e){if(!this._maxSelectedDate){this._maxSelectedDate=e;return}let t=this.getMSFromString(e),n=!Number.isNaN(t),r=t>=this.getMSFromString(this.minSelectedDate);n&&r&&(this._maxSelectedDate=this.formatDate(t)),this.requestUpdate()}get minSliderX(){let e=this.translateDateToPosition(this.minSelectedDate);return this.validMinSliderX(e)}get maxSliderX(){let e=this.snapTimestamp(this.getMSFromString(this.maxSelectedDate)+this.snapInterval),t=this.translateDateToPosition(this.formatDate(e));return this.validMaxSliderX(t)}get dateRangeMS(){return this._maxDateMS-this._minDateMS}showTooltip(e){var t,n;if(this._isDragging||this.disabled)return;let r=e.currentTarget,i=r.x.baseVal.value+this.sliderWidth/2,a=r.dataset,o=`${this.tooltipLabel}${a.numItems===`1`?``:`s`}`,s=Number(a.numItems).toLocaleString(),c=9+this.tooltipHeight,l=this.getBoundingClientRect(),u=l.x+i,d=l.y;this._tooltipOffsetX=u-2+(this._binWidth-this.sliderWidth-this.tooltipWidth)/2+window.scrollX,this._tooltipOffsetY=d-c+window.scrollY,this._tooltipContent=Xf`
      ${s} ${o}<br />
      ${a.tooltip}
    `,(n=(t=this._tooltip).showPopover)==null||n.call(t)}hideTooltip(){var e,t;this._tooltipContent=void 0,(t=(e=this._tooltip).hidePopover)==null||t.call(e)}validMinSliderX(e){let t=Math.min(this.translateDateToPosition(this.maxSelectedDate),this.histogramRightEdgeX);return e=this.clamp(e,this.histogramLeftEdgeX,t),Number.isNaN(e)||t<this.histogramLeftEdgeX?this.histogramLeftEdgeX:e}validMaxSliderX(e){let t=Math.max(this.histogramLeftEdgeX,this.translateDateToPosition(this.minSelectedDate));return e=this.clamp(e,t,this.histogramRightEdgeX),Number.isNaN(e)||t>this.histogramRightEdgeX?this.histogramRightEdgeX:e}addListeners(){window.addEventListener(`pointermove`,this.move),window.addEventListener(`pointerup`,this.drop),window.addEventListener(`pointercancel`,this.drop)}removeListeners(){window.removeEventListener(`pointermove`,this.move),window.removeEventListener(`pointerup`,this.drop),window.removeEventListener(`pointercancel`,this.drop)}beginEmitUpdateProcess(){this.cancelPendingUpdateEvent(),this._emitUpdatedEventTimer=setTimeout(()=>{if(this.currentDateRangeString===this._previousDateRange)return;this._previousDateRange=this.currentDateRangeString;let e={detail:{minDate:this.minSelectedDate,maxDate:this.maxSelectedDate},bubbles:!0,composed:!0};this.dispatchEvent(new CustomEvent(`histogramDateRangeUpdated`,e))},this.updateDelay)}cancelPendingUpdateEvent(){this._emitUpdatedEventTimer!==void 0&&(clearTimeout(this._emitUpdatedEventTimer),this._emitUpdatedEventTimer=void 0)}setDragOffset(e){this._currentSlider=e.currentTarget;let t=this._currentSlider.id===`slider-min`?this.minSliderX:this.maxSliderX,n=this.getBoundingClientRect().x;this._dragOffset=e.clientX-n-t}translatePositionToDate(e){let t=this.snapToNextSecond((e-this.sliderWidth)*this.dateRangeMS/this._histWidth);return this.formatDate(this._minDateMS+t)}translateDateToPosition(e){let t=this.getMSFromString(e);return this.sliderWidth+(t-this._minDateMS)*this._histWidth/this.dateRangeMS}clamp(e,t,n){return Math.min(Math.max(e,t),n)}handleInputFocus(){this.updateWhileFocused||this.cancelPendingUpdateEvent()}handleMinDateInput(e){let t=e.currentTarget;t.value!==this.minSelectedDate&&(this.minSelectedDate=t.value,this.beginEmitUpdateProcess())}handleMaxDateInput(e){let t=e.currentTarget;t.value!==this.maxSelectedDate&&(this.maxSelectedDate=t.value,this.beginEmitUpdateProcess())}handleKeyUp(e){if(e.key===`Enter`){let t=e.currentTarget;t.blur(),t.id===`date-min`?this.handleMinDateInput(e):t.id===`date-max`&&this.handleMaxDateInput(e)}}get currentDateRangeString(){return`${this.minSelectedDate}:${this.maxSelectedDate}`}getMSFromString(e){let t=typeof e==`string`?e:String(e);if((t.split(/(\d+)/).length-1)/2==1){let e=new Date(0,0);return e.setFullYear(Number(t)),e.getTime()}return U(t,[this.dateFormat,Lp]).valueOf()}handleBarClick(e){let t=e.currentTarget.dataset,n=(this.getMSFromString(t.binStart)+this.getMSFromString(t.binEnd))/2;Math.abs(n-this.getMSFromString(this.minSelectedDate))<Math.abs(n-this.getMSFromString(this.maxSelectedDate))?this.minSelectedDate=t.binStart:this.maxSelectedDate=t.binEnd,this.beginEmitUpdateProcess()}get minSliderTemplate(){let e=Vp,t=`
            M${this.minSliderX},0
            ...
            q0,${e} ${e},${e}
            h${this.sliderWidth-e}
          `;return this.generateSliderSVG(this.minSliderX,`slider-min`,t)}get maxSliderTemplate(){let e=Vp,t=`
            M${this.maxSliderX},0
            h${this.sliderWidth-e}
            q${e},0 ${e},${e}
            v${this.height-e*2}
            q0,${e} -${e},${e}
            h-${this.sliderWidth-e}
          `;return this.generateSliderSVG(this.maxSliderX,`slider-max`,t)}generateSliderSVG(e,t,n){let r=t===`slider-min`?1:-1;return Zf`
    <svg
      id=${t}
      class=${Op({slider:!0,draggable:!this.disabled,dragging:this._isDragging})}
    ...
    `}get selectedRangeTemplate(){return Zf`
      <rect
        x="${this.minSliderX}"
        y="0"
        ...
        height="${this.height}"
        fill="${Wp}"
      />`}get histogramTemplate(){let e=this._histWidth/this._numBins,t=e-1,n=this.sliderWidth;return this._histData.map(r=>{let{minSelectedDate:i,maxSelectedDate:a}=this,o=r.height,s=this.isBefore(r.binEnd,i),c=this.isAfter(r.binStart,a),l=s||c?qp:Gp,u=`stroke-dasharray: 0 ${t} ${o} ${t} 0 ${o}`,d=Zf`
        <rect
        ...
        <rect
          ...
          height=${o}
          fill=${l}
        />`;return n+=e,d})}isBefore(e,t){return this.getMSFromString(e)<this.getMSFromString(t)}isAfter(e,t){return this.getMSFromString(e)>this.getMSFromString(t)}formatDate(e,t=this.dateFormat){if(Number.isNaN(e))return``;let n=U(e);return n.year()<1e3?n.year(199999).format(t).replace(/199999/g,n.year().toString()):n.format(t)}get minInputTemplate(){return Xf`
      <input
        id="date-min"
        ...
        .value=${Dp(this.minSelectedDate)}
        ?disabled=${this.disabled}
      />
    `}get maxInputTemplate(){return Xf`
      <input
        id="date-max"
        placeholder=${this.dateFormat}
        type="text"
        ...
        @keyup=${this.handleKeyUp}
        .value=${Dp(this.maxSelectedDate)}
        ?disabled=${this.disabled}
      />
    `}get minLabelTemplate(){return Xf`<label for="date-min" class="sr-only">Minimum date:</label>`}get maxLabelTemplate(){return Xf`<label for="date-max" class="sr-only">Maximum date:</label>`}get tooltipTemplate(){return Xf`
      <div id="tooltip" style=${jp({width:`${this.tooltipWidth}px`,height:`${this.tooltipHeight}px`,top:`${this._tooltipOffsetY}px`,left:`${this._tooltipOffsetX}px`})} popover>${this._tooltipContent}</div>
    `}get histogramAccessibilityTemplate(){let e=``;return this.minSelectedDate&&this.maxSelectedDate?e=` from ${this.minSelectedDate} to ${this.maxSelectedDate}`:this.minSelectedDate?e=` from ${this.minSelectedDate}`:this.maxSelectedDate&&(e=` up to ${this.maxSelectedDate}`),Xf`<title id="histogram-title">${`Filter results for dates${e}`}</title
      ><desc id="histogram-desc">${`This histogram shows the distribution of dates${e}`}</desc>`}get noDataTemplate(){return Xf`
      <div class="missing-data-message">${this.missingDataMessage}</div>
    `}get activityIndicatorTemplate(){return this.loading?Xf`
      <ia-activity-indicator mode="processing"> </ia-activity-indicator>
    `:$f}render(){return this.hasBinData?Xf`
      <div
        id="container"
        class="
          noselect
    ...
    ia-activity-indicator {
      ...
      --activityIndicatorLoadingRingColor: ${Kp};
    }
  ...
  `,t([F({type:Number})],G.prototype,`width`,void 0),t([F({type:Number})],G.prototype,`height`,void 0),t([F({type:Number})],G.prototype,`sliderWidth`,void 0),t([F({type:Number})],G.prototype,`tooltipWidth`,void 0),t([F({type:Number})],G.prototype,`tooltipHeight`,void 0),t([F({type:Number})],G.prototype,`updateDelay`,void 0),t([F({type:String})],G.prototype,`dateFormat`,void 0),t([F({type:String})],G.prototype,`missingDataMessage`,void 0),t([F({type:String})],G.prototype,`minDate`,void 0),t([F({type:String})],G.prototype,`maxDate`,void 0),t([F({type:Boolean})],G.prototype,`disabled`,void 0),t([F({type:Array})],G.prototype,`bins`,void 0),t([F({type:Boolean})],G.prototype,`updateWhileFocused`,void 0),t([F({type:String})],G.prototype,`binSnapping`,void 0),t([F({type:String})],G.prototype,`tooltipLabel`,void 0),t([F({type:String})],G.prototype,`barScaling`,void 0),t([bi()],G.prototype,`_tooltipOffsetX`,void 0),t([bi()],G.prototype,`_tooltipOffsetY`,void 0),t([bi()],G.prototype,`_tooltipContent`,void 0),t([bi()],G.prototype,`_tooltipDateFormat`,void 0),t([bi()],G.prototype,`_isDragging`,void 0),t([bi()],G.prototype,`_isLoading`,void 0),t([Si(`#tooltip`)],G.prototype,`_tooltip`,void 0),t([F({type:String})],G.prototype,`tooltipDateFormat`,null),t([F({type:Boolean})],G.prototype,`loading`,null),t([F()],G.prototype,`minSelectedDate`,null),t([F()],G.prototype,`maxSelectedDate`,null),G=t([_i(`histogram-date-range`)],G);var rm=window,im=rm.trustedTypes,am=im?im.createPolicy(`lit-html`,{createHTML:e=>e}):void 0,om=`$lit$`,sm=`lit$${(Math.random()+``).slice(9)}$`,cm=`?`+sm,lm=`<${cm}>`,um=document,dm=()=>um.createComment(``),fm=e=>e===null||typeof e!=`object`&&typeof e!=`function`,pm=Array.isArray,mm=e=>pm(e)||typeof e?.[Symbol.iterator]==`function`,hm=`[ 	
\f\r]`,gm=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,_m=/-->/g,vm=/>/g,ym=RegExp(`>|${hm}(?:([^\\s"'>=/]+)(${hm}*=${hm}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,`g`),bm=/'/g,xm=/"/g,Sm=/^(?:script|style|textarea|title)$/i,Cm=e=>(t,...n)=>({_$litType$:e,strings:t,values:n}),K=Cm(1),wm=Cm(2),Tm=Symbol.for(`lit-noChange`),q=Symbol.for(`lit-nothing`),Em=new WeakMap,Dm=um.createTreeWalker(um,129,null,!1);function Om(e,t){if(!Array.isArray(e)||!e.hasOwnProperty(`raw`))throw Error(`invalid template strings array`);return am===void 0?t:am.createHTML(t)}var km=(e,t)=>{let n=e.length-1,r=[],i,a=t===2?`<svg>`:``,o=gm;for(let t=0;t<n;t++){let n=e[t],s,c,l=-1,u=0;for(;u<n.length&&(o.lastIndex=u,c=o.exec(n),c!==null);)u=o.lastIndex,o===gm?c[1]===`!--`?o=_m:c[1]===void 0?c[2]===void 0?c[3]!==void 0&&(o=ym):(Sm.test(c[2])&&(i=RegExp(`</`+c[2],`g`)),o=ym):o=vm:o===ym?c[0]===`>`?(o=i??gm,l=-1):c[1]===void 0?l=-2:(l=o.lastIndex-c[2].length,s=c[1],o=c[3]===void 0?ym:c[3]===`"`?xm:bm):o===xm||o===bm?o=ym:o===_m||o===vm?o=gm:(o=ym,i=void 0);let d=o===ym&&e[t+1].startsWith(`/>`)?` `:``;a+=o===gm?n+lm:l>=0?(r.push(s),n.slice(0,l)+om+n.slice(l)+sm+d):n+sm+(l===-2?(r.push(void 0),t):d)}return[Om(e,a+(e[n]||`<?>`)+(t===2?`</svg>`:``)),r]},Am=class e{constructor({strings:t,_$litType$:n},r){let i;this.parts=[];let a=0,o=0,s=t.length-1,c=this.parts,[l,u]=km(t,n);if(this.el=e.createElement(l,r),Dm.currentNode=this.el.content,n===2){let e=this.el.content,t=e.firstChild;t.remove(),e.append(...t.childNodes)}for(;(i=Dm.nextNode())!==null&&c.length<s;){if(i.nodeType===1){if(i.hasAttributes()){let e=[];for(let t of i.getAttributeNames())if(t.endsWith(om)||t.startsWith(sm)){let n=u[o++];if(e.push(t),n!==void 0){let e=i.getAttribute(n.toLowerCase()+om).split(sm),t=/([.?@])?(.*)/.exec(n);c.push({type:1,index:a,name:t[2],strings:e,ctor:t[1]===`.`?Fm:t[1]===`?`?Lm:t[1]===`@`?Rm:Pm})}else c.push({type:6,index:a})}for(let t of e)i.removeAttribute(t)}if(Sm.test(i.tagName)){let e=i.textContent.split(sm),t=e.length-1;if(t>0){i.textContent=im?im.emptyScript:``;for(let n=0;n<t;n++)i.append(e[n],dm()),Dm.nextNode(),c.push({type:2,index:++a});i.append(e[t],dm())}}}else if(i.nodeType===8)if(i.data===cm)c.push({type:2,index:a});else{let e=-1;for(;(e=i.data.indexOf(sm,e+1))!==-1;)c.push({type:7,index:a}),e+=sm.length-1}a++}}static createElement(e,t){let n=um.createElement(`template`);return n.innerHTML=e,n}};function jm(e,t,n=e,r){var i,a;if(t===Tm)return t;let o=r===void 0?n._$Cl:n._$Co?.[r],s=fm(t)?void 0:t._$litDirective$;return o?.constructor!==s&&((i=o?._$AO)==null||i.call(o,!1),s===void 0?o=void 0:(o=new s(e),o._$AT(e,n,r)),r===void 0?n._$Cl=o:((a=n)._$Co??(a._$Co=[]))[r]=o),o!==void 0&&(t=jm(e,o._$AS(e,t.values),o,r)),t}var Mm=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:n}=this._$AD,r=(e?.creationScope??um).importNode(t,!0);Dm.currentNode=r;let i=Dm.nextNode(),a=0,o=0,s=n[0];for(;s!==void 0;){if(a===s.index){let t;s.type===2?t=new Nm(i,i.nextSibling,this,e):s.type===1?t=new s.ctor(i,s.name,s.strings,this,e):s.type===6&&(t=new zm(i,this,e)),this._$AV.push(t),s=n[++o]}a!==s?.index&&(i=Dm.nextNode(),a++)}return Dm.currentNode=um,r}v(e){let t=0;for(let n of this._$AV)n!==void 0&&(n.strings===void 0?n._$AI(e[t]):(n._$AI(e,n,t),t+=n.strings.length-2)),t++}},Nm=class e{constructor(e,t,n,r){var i;this.type=2,this._$AH=q,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=r,this._$Cp=(i=r?.isConnected)==null||i}get _$AU(){return this._$AM?._$AU??this._$Cp}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=jm(this,e,t),fm(e)?e===q||e==null||e===``?(this._$AH!==q&&this._$AR(),this._$AH=q):e!==this._$AH&&e!==Tm&&this._(e):e._$litType$===void 0?e.nodeType===void 0?mm(e)?this.T(e):this._(e):this.$(e):this.g(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==q&&fm(this._$AH)?this._$AA.nextSibling.data=e:this.$(um.createTextNode(e)),this._$AH=e}g(e){let{values:t,_$litType$:n}=e,r=typeof n==`number`?this._$AC(e):(n.el===void 0&&(n.el=Am.createElement(Om(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===r)this._$AH.v(t);else{let e=new Mm(r,this),n=e.u(this.options);e.v(t),this.$(n),this._$AH=e}}_$AC(e){let t=Em.get(e.strings);return t===void 0&&Em.set(e.strings,t=new Am(e)),t}T(t){pm(this._$AH)||(this._$AH=[],this._$AR());let n=this._$AH,r,i=0;for(let a of t)i===n.length?n.push(r=new e(this.k(dm()),this.k(dm()),this,this.options)):r=n[i],r._$AI(a),i++;i<n.length&&(this._$AR(r&&r._$AB.nextSibling,i),n.length=i)}_$AR(e=this._$AA.nextSibling,t){var n;for((n=this._$AP)==null||n.call(this,!1,!0,t);e&&e!==this._$AB;){let t=e.nextSibling;e.remove(),e=t}}setConnected(e){var t;this._$AM===void 0&&(this._$Cp=e,(t=this._$AP)==null||t.call(this,e))}},Pm=class{constructor(e,t,n,r,i){this.type=1,this._$AH=q,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=i,n.length>2||n[0]!==``||n[1]!==``?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=q}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,n,r){let i=this.strings,a=!1;if(i===void 0)e=jm(this,e,t,0),a=!fm(e)||e!==this._$AH&&e!==Tm,a&&(this._$AH=e);else{let r=e,o,s;for(e=i[0],o=0;o<i.length-1;o++)s=jm(this,r[n+o],t,o),s===Tm&&(s=this._$AH[o]),a||=!fm(s)||s!==this._$AH[o],s===q?e=q:e!==q&&(e+=(s??``)+i[o+1]),this._$AH[o]=s}a&&!r&&this.j(e)}j(e){e===q?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??``)}},Fm=class extends Pm{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===q?void 0:e}},Im=im?im.emptyScript:``,Lm=class extends Pm{constructor(){super(...arguments),this.type=4}j(e){e&&e!==q?this.element.setAttribute(this.name,Im):this.element.removeAttribute(this.name)}},Rm=class extends Pm{constructor(e,t,n,r,i){super(e,t,n,r,i),this.type=5}_$AI(e,t=this){if((e=jm(this,e,t,0)??q)===Tm)return;let n=this._$AH,r=e===q&&n!==q||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,i=e!==q&&(n===q||r);r&&this.element.removeEventListener(this.name,this,n),i&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH==`function`?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},zm=class{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){jm(this,e)}},Bm=rm.litHtmlPolyfillSupport;Bm?.(Am,Nm),(rm.litHtmlVersions??=[]).push(`2.8.0`);var Vm=(e,t,n)=>{let r=n?.renderBefore??t,i=r._$litPart$;if(i===void 0){let e=n?.renderBefore??null;r._$litPart$=i=new Nm(t.insertBefore(dm(),e),e,void 0,n??{})}return i._$AI(e),i},Hm,Um=class extends Dr{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e;let t=super.createRenderRoot();return(e=this.renderOptions).renderBefore??(e.renderBefore=t.firstChild),t}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Vm(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)==null||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)==null||e.setConnected(!1)}render(){return Tm}};Um.finalized=!0,Um._$litElement$=!0,(Hm=globalThis.litElementHydrateSupport)==null||Hm.call(globalThis,{LitElement:Um});var Wm=globalThis.litElementPolyfillSupport;Wm?.({LitElement:Um}),(globalThis.litElementVersions??(globalThis.litElementVersions=[])).push(`3.3.3`);var Gm=wm`
<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><path d="m51.5960452 0c5.420012 0 6.7920618 2.72313378 8.1300179 9.28391016 2.9793915 19.21608984-2.9793915 28.94849474 0 31.58229234 1.2215505 1.079857 1.8678662.7924226 3.2997314.0773518l.2153069-.1075882c2.1016905-1.0490161 5.8499713-2.8359661 14.9013153-2.8359661l2.3393989.00075c14.0694555.01425 14.2569231.29925 18.0062757 5.99925 0 3.2648986.9924719 9.5-3.9698878 9.5 4.9623597 0 7.9397755 15.5 0 15.5 7.9397755 0 6.9473035 15.5-.9924719 15.5 7.9397754 0 5.9548316 12 2.9774158 13-1.1342536.5714286-1.9876793 1.0011812-2.627102 1.3222794l-.3279542.1645673c-1.5889262.796641-1.5747062.7780161-1.4530457.6832252l.0244872-.0190992c.0041709-.0032756.0083532-.0065808.0124967-.0098908l.0239934-.0197196c.1060465-.0904428.1029348-.1457697-1.111471.3786377h-55.0821921c-3.3082398-3.0266004-4.9623597-5.0266004-4.9623597-6v-33.4737525c5.5882429-8.3508317 10.6469206-21.2754909 15.1760333-38.7739777v-17.92948326c0-2.54852436 1.8066707-3.82278654 5.4200119-3.82278654zm-27.5960452 56c2.209139 0 4 1.790861 4 4v36c0 2.209139-1.790861 4-4 4h-20c-2.209139 0-4-1.790861-4-4v-36c0-2.209139 1.790861-4 4-4z" fill-rule="evenodd"/></svg>`,Km=wm`
<svg viewBox="0 0 100 100"
  xmlns="http://www.w3.org/2000/svg">
...
`,J=class extends Um{constructor(){super(...arguments),this.prompt=`Do you find this feature useful?`,this.buttonText=`Beta`,this.displayMode=`button`,this.isOpen=!1,this.processing=!1,this.popupTopX=0,this.popupTopY=0,this.voteSubmitted=!1,this.voteNeedsChoosing=!1,this.resizingElement=document.body}render(){return K`
      <div id="container">
    ...
    `}};t([F({type:String})],J.prototype,`featureIdentifier`,void 0),t([F({type:String})],J.prototype,`prompt`,void 0),t([F({type:String})],J.prototype,`buttonText`,void 0),t([F({type:String})],J.prototype,`displayMode`,void 0),t([F({type:Object})],J.prototype,`recaptchaManager`,void 0),t([F({type:Object})],J.prototype,`resizeObserver`,void 0),t([F({type:Boolean})],J.prototype,`disabled`,void 0),t([F({type:Object})],J.prototype,`featureFeedbackService`,void 0),t([bi()],J.prototype,`isOpen`,void 0),t([bi()],J.prototype,`processing`,void 0),t([bi()],J.prototype,`popupTopX`,void 0),t([bi()],J.prototype,`popupTopY`,void 0),t([bi()],J.prototype,`vote`,void 0),t([bi()],J.prototype,`voteSubmitted`,void 0),t([bi()],J.prototype,`error`,void 0),t([bi()],J.prototype,`voteNeedsChoosing`,void 0),t([bi()],J.prototype,`recaptchaWidget`,void 0),t([Si(`#container`)],J.prototype,`container`,void 0),t([Si(`#popup`)],J.prototype,`popup`,void 0),t([Si(`#comments`)],J.prototype,`comments`,void 0),J=t([_i(`feature-feedback`)],J);var qm={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Jm=e=>(...t)=>({_$litDirective$:e,values:t}),Ym=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,n){this._$Ct=e,this._$AM=t,this._$Ci=n}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}},Xm=`important`,Zm=` !`+Xm,Qm=Jm(class extends Ym{constructor(e){if(super(e),e.type!==qm.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce(((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`}),``)}update(e,[t]){let{style:n}=e.element;if(this.ht===void 0){this.ht=new Set;for(let e in t)this.ht.add(e);return this.render(t)}this.ht.forEach((e=>{t[e]??(this.ht.delete(e),e.includes(`-`)?n.removeProperty(e):n[e]=``)}));for(let e in t){let r=t[e];if(r!=null){this.ht.add(e);let t=typeof r==`string`&&r.endsWith(Zm);e.includes(`-`)||t?n.setProperty(e,t?r.slice(0,-11):r,t?Xm:``):n[e]=r}}return Tm}}),$m=e=>typeof e!=`string`&&`strTag`in e,eh=(e,t,n)=>{let r=e[0];for(let i=1;i<e.length;i++)r+=t[n?n[i-1]:i-1],r+=e[i];return r},th=(e=>$m(e)?eh(e.strings,e.values):e),nh=class{constructor(){this.settled=!1,this.promise=new Promise((e,t)=>{this._resolve=e,this._reject=t})}resolve(e){this.settled=!0,this._resolve(e)}reject(e){this.settled=!0,this._reject(e)}},rh=[];for(let e=0;e<256;e++)rh[e]=(e>>4&15).toString(16)+(e&15).toString(16);new nh().resolve();var ih=th,ah=window,oh=ah.trustedTypes,sh=oh?oh.createPolicy(`lit-html`,{createHTML:e=>e}):void 0,ch=`$lit$`,lh=`lit$${(Math.random()+``).slice(9)}$`,uh=`?`+lh,dh=`<${uh}>`,fh=document,ph=()=>fh.createComment(``),mh=e=>e===null||typeof e!=`object`&&typeof e!=`function`,hh=Array.isArray,gh=e=>hh(e)||typeof e?.[Symbol.iterator]==`function`,_h=`[ 	
\f\r]`,vh=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,yh=/-->/g,bh=/>/g,xh=RegExp(`>|${_h}(?:([^\\s"'>=/]+)(${_h}*=${_h}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,`g`),Sh=/'/g,Ch=/"/g,wh=/^(?:script|style|textarea|title)$/i,Th=Symbol.for(`lit-noChange`),Eh=Symbol.for(`lit-nothing`),Dh=new WeakMap,Oh=fh.createTreeWalker(fh,129,null,!1);function kh(e,t){if(!Array.isArray(e)||!e.hasOwnProperty(`raw`))throw Error(`invalid template strings array`);return sh===void 0?t:sh.createHTML(t)}var Ah=(e,t)=>{let n=e.length-1,r=[],i,a=t===2?`<svg>`:``,o=vh;for(let t=0;t<n;t++){let n=e[t],s,c,l=-1,u=0;for(;u<n.length&&(o.lastIndex=u,c=o.exec(n),c!==null);)u=o.lastIndex,o===vh?c[1]===`!--`?o=yh:c[1]===void 0?c[2]===void 0?c[3]!==void 0&&(o=xh):(wh.test(c[2])&&(i=RegExp(`</`+c[2],`g`)),o=xh):o=bh:o===xh?c[0]===`>`?(o=i??vh,l=-1):c[1]===void 0?l=-2:(l=o.lastIndex-c[2].length,s=c[1],o=c[3]===void 0?xh:c[3]===`"`?Ch:Sh):o===Ch||o===Sh?o=xh:o===yh||o===bh?o=vh:(o=xh,i=void 0);let d=o===xh&&e[t+1].startsWith(`/>`)?` `:``;a+=o===vh?n+dh:l>=0?(r.push(s),n.slice(0,l)+ch+n.slice(l)+lh+d):n+lh+(l===-2?(r.push(void 0),t):d)}return[kh(e,a+(e[n]||`<?>`)+(t===2?`</svg>`:``)),r]},jh=class e{constructor({strings:t,_$litType$:n},r){let i;this.parts=[];let a=0,o=0,s=t.length-1,c=this.parts,[l,u]=Ah(t,n);if(this.el=e.createElement(l,r),Oh.currentNode=this.el.content,n===2){let e=this.el.content,t=e.firstChild;t.remove(),e.append(...t.childNodes)}for(;(i=Oh.nextNode())!==null&&c.length<s;){if(i.nodeType===1){if(i.hasAttributes()){let e=[];for(let t of i.getAttributeNames())if(t.endsWith(ch)||t.startsWith(lh)){let n=u[o++];if(e.push(t),n!==void 0){let e=i.getAttribute(n.toLowerCase()+ch).split(lh),t=/([.?@])?(.*)/.exec(n);c.push({type:1,index:a,name:t[2],strings:e,ctor:t[1]===`.`?Ih:t[1]===`?`?Rh:t[1]===`@`?zh:Fh})}else c.push({type:6,index:a})}for(let t of e)i.removeAttribute(t)}if(wh.test(i.tagName)){let e=i.textContent.split(lh),t=e.length-1;if(t>0){i.textContent=oh?oh.emptyScript:``;for(let n=0;n<t;n++)i.append(e[n],ph()),Oh.nextNode(),c.push({type:2,index:++a});i.append(e[t],ph())}}}else if(i.nodeType===8)if(i.data===uh)c.push({type:2,index:a});else{let e=-1;for(;(e=i.data.indexOf(lh,e+1))!==-1;)c.push({type:7,index:a}),e+=lh.length-1}a++}}static createElement(e,t){let n=fh.createElement(`template`);return n.innerHTML=e,n}};function Mh(e,t,n=e,r){var i,a;if(t===Th)return t;let o=r===void 0?n._$Cl:n._$Co?.[r],s=mh(t)?void 0:t._$litDirective$;return o?.constructor!==s&&((i=o?._$AO)==null||i.call(o,!1),s===void 0?o=void 0:(o=new s(e),o._$AT(e,n,r)),r===void 0?n._$Cl=o:((a=n)._$Co??(a._$Co=[]))[r]=o),o!==void 0&&(t=Mh(e,o._$AS(e,t.values),o,r)),t}var Nh=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:n}=this._$AD,r=(e?.creationScope??fh).importNode(t,!0);Oh.currentNode=r;let i=Oh.nextNode(),a=0,o=0,s=n[0];for(;s!==void 0;){if(a===s.index){let t;s.type===2?t=new Ph(i,i.nextSibling,this,e):s.type===1?t=new s.ctor(i,s.name,s.strings,this,e):s.type===6&&(t=new Bh(i,this,e)),this._$AV.push(t),s=n[++o]}a!==s?.index&&(i=Oh.nextNode(),a++)}return Oh.currentNode=fh,r}v(e){let t=0;for(let n of this._$AV)n!==void 0&&(n.strings===void 0?n._$AI(e[t]):(n._$AI(e,n,t),t+=n.strings.length-2)),t++}},Ph=class e{constructor(e,t,n,r){var i;this.type=2,this._$AH=Eh,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=r,this._$Cp=(i=r?.isConnected)==null||i}get _$AU(){return this._$AM?._$AU??this._$Cp}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Mh(this,e,t),mh(e)?e===Eh||e==null||e===``?(this._$AH!==Eh&&this._$AR(),this._$AH=Eh):e!==this._$AH&&e!==Th&&this._(e):e._$litType$===void 0?e.nodeType===void 0?gh(e)?this.T(e):this._(e):this.$(e):this.g(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==Eh&&mh(this._$AH)?this._$AA.nextSibling.data=e:this.$(fh.createTextNode(e)),this._$AH=e}g(e){let{values:t,_$litType$:n}=e,r=typeof n==`number`?this._$AC(e):(n.el===void 0&&(n.el=jh.createElement(kh(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===r)this._$AH.v(t);else{let e=new Nh(r,this),n=e.u(this.options);e.v(t),this.$(n),this._$AH=e}}_$AC(e){let t=Dh.get(e.strings);return t===void 0&&Dh.set(e.strings,t=new jh(e)),t}T(t){hh(this._$AH)||(this._$AH=[],this._$AR());let n=this._$AH,r,i=0;for(let a of t)i===n.length?n.push(r=new e(this.k(ph()),this.k(ph()),this,this.options)):r=n[i],r._$AI(a),i++;i<n.length&&(this._$AR(r&&r._$AB.nextSibling,i),n.length=i)}_$AR(e=this._$AA.nextSibling,t){var n;for((n=this._$AP)==null||n.call(this,!1,!0,t);e&&e!==this._$AB;){let t=e.nextSibling;e.remove(),e=t}}setConnected(e){var t;this._$AM===void 0&&(this._$Cp=e,(t=this._$AP)==null||t.call(this,e))}},Fh=class{constructor(e,t,n,r,i){this.type=1,this._$AH=Eh,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=i,n.length>2||n[0]!==``||n[1]!==``?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=Eh}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,n,r){let i=this.strings,a=!1;if(i===void 0)e=Mh(this,e,t,0),a=!mh(e)||e!==this._$AH&&e!==Th,a&&(this._$AH=e);else{let r=e,o,s;for(e=i[0],o=0;o<i.length-1;o++)s=Mh(this,r[n+o],t,o),s===Th&&(s=this._$AH[o]),a||=!mh(s)||s!==this._$AH[o],s===Eh?e=Eh:e!==Eh&&(e+=(s??``)+i[o+1]),this._$AH[o]=s}a&&!r&&this.j(e)}j(e){e===Eh?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??``)}},Ih=class extends Fh{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===Eh?void 0:e}},Lh=oh?oh.emptyScript:``,Rh=class extends Fh{constructor(){super(...arguments),this.type=4}j(e){e&&e!==Eh?this.element.setAttribute(this.name,Lh):this.element.removeAttribute(this.name)}},zh=class extends Fh{constructor(e,t,n,r,i){super(e,t,n,r,i),this.type=5}_$AI(e,t=this){if((e=Mh(this,e,t,0)??Eh)===Th)return;let n=this._$AH,r=e===Eh&&n!==Eh||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,i=e!==Eh&&(n===Eh||r);r&&this.element.removeEventListener(this.name,this,n),i&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH==`function`?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},Bh=class{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){Mh(this,e)}},Vh=ah.litHtmlPolyfillSupport;Vh?.(jh,Ph),(ah.litHtmlVersions??=[]).push(`2.8.0`);var Hh=(e,t,n)=>{let r=n?.renderBefore??t,i=r._$litPart$;if(i===void 0){let e=n?.renderBefore??null;r._$litPart$=i=new Ph(t.insertBefore(ph(),e),e,void 0,n??{})}return i._$AI(e),i},Uh,Wh=class extends Dr{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e;let t=super.createRenderRoot();return(e=this.renderOptions).renderBefore??(e.renderBefore=t.firstChild),t}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Hh(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)==null||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)==null||e.setConnected(!1)}render(){return Th}};Wh.finalized=!0,Wh._$litElement$=!0,(Uh=globalThis.litElementHydrateSupport)==null||Uh.call(globalThis,{LitElement:Wh});var Gh=globalThis.litElementPolyfillSupport;Gh?.({LitElement:Wh}),(globalThis.litElementVersions??(globalThis.litElementVersions=[])).push(`3.3.3`);var Kh=P`var(--white, #fff)`,qh=P`var(--ia-theme-link-color, #4b64ff)`,Jh=P`var(--primaryDisableCTAFill, #767676)`,Yh=P`var(--secondaryCTABorder, #999)`,Xh=P`var(--primaryCTAFill, #194880)`,Zh=P`var(--primaryCTAFillRGB, 25, 72, 128)`,Qh=P`var(--primaryCTABorder, #c5d1df)`,$h=P`var(--primaryErrorCTAFill, #d9534f)`,eg=P`var(--primaryErrorCTAFillRGB, 229, 28, 38)`,tg=P`var(--primaryErrorCTABorder, #d43f3a)`,ng=P`var(--secondaryCTAFill, #333)`,rg=P`var(--secondaryCTAFillRGB, 51, 51, 51)`,ig=P`var(--primaryCTABorder, #979797)`,ag=P`var(---primaryWarningFill, #ee8950)`,og=P`var(--primaryWarningFillRGB, 238, 137, 80)`,sg=P`
  .ia-button {
    min-height: 3rem;
    cursor: pointer;
    color: ${Kh};
  ...
  .ia-button.primary:hover {
    background-color: rgba(${Zh}, 0.9);
  }
  .ia-button.primary:focus-visible {
    background-color: rgba(${Zh}, 0.8);
  }
  .ia-button.primary:active {
    background-color: rgba(${Zh}, 0.7);
  }
  ...
  .ia-button.danger:hover {
    background-color: rgba(${eg}, 0.9);
  }
  .ia-button.danger:focus-visible {
    background-color: rgba(${eg}, 0.8);
  }
  .ia-button.danger:active {
    background-color: rgba(${eg}, 0.7);
  }
  ...
  .ia-button.warning:hover {
    background-color: rgba(${og}, 0.9);
  }
  .ia-button.warning:focus-visible {
    background-color: rgba(${og}, 0.8);
  }
  .ia-button.warning:active {
    background-color: rgba(${og}, 0.7);
  }
  ...
  .ia-button.dark:hover {
    background-color: rgba(${rg}, 0.9);
  }
  .ia-button.dark:focus-visible {
    background-color: rgba(${rg}, 0.8);
  }
  .ia-button.dark:active {
    background-color: rgba(${rg}, 0.7);
  }
...
`;function cg(e){return`disabled`in e&&typeof e.disabled==`boolean`}function lg(e){return`numbered`in e&&typeof e.numbered==`boolean`}function ug(e){return`validate`in e&&typeof e.validate==`function`}function dg(e){return`response`in e&&typeof e.response==`object`&&e.response!==null&&`name`in e.response&&typeof e.response.name==`string`}var fg=class extends Error{};async function pg(e,t,n=`Operation timed out`){let r=new Promise((e,r)=>setTimeout(r,t,new fg(n)));return Promise.race([e,r])}var mg,Y=mg=class extends Um{constructor(){super(...arguments),this.buttonText=`Feedback`,this.showButtonThumbs=!1,this.showQuestionNumbers=!1,this.disabled=!1,this.submitTimeout=8e3,this.isOpen=!1,this.submissionState=`idle`,this.popupTopX=0,this.popupTopY=0,this.resizingElement=document.body,this.handleScroll=()=>{this.isOpen&&this.positionPopup()},this.handleEscape=e=>{e.key===`Escape`&&this.cancel(e)}}render(){return K`<div id="container">${this.feedbackButtonTemplate}</div>`}willUpdate(e){if(e.has(`submissionState`)&&(this.isProcessing||this.isSubmitted?this.disableSlottedChildren():this.restoreSlottedChildrenDisabledStates()),e.has(`resizeObserver`)){let t=e.get(`resizeObserver`);this.disconnectResizeObserver(t)}}updated(e){(e.has(`showQuestionNumbers`)||e.has(`assignedElements`))&&this.applyQuestionNumbers();let t=e.get(`submissionState`);t&&(this.submissionState===`error`||t===`error`)&&this.positionPopup(),e.has(`isOpen`)&&this.isOpen&&this.focusFirstFormElement()}disconnectedCallback(){this.removeEscapeListener(),this.stopScrollObserver(),this.disconnectResizeObserver(this.resizeObserver)}disableSlottedChildren(){this.assignedElements.filter(cg).forEach(e=>{e.dataset.originallyDisabled=e.disabled?`true`:`false`,e.disabled=!0})}restoreSlottedChildrenDisabledStates(){this.assignedElements.filter(cg).forEach(e=>{let{originallyDisabled:t}=e.dataset;if(t===void 0)return;let n=t===`true`;delete e.dataset.originallyDisabled,e.disabled=n})}handleResize(){this.isOpen&&this.positionPopup()}setupEscapeListener(){document.addEventListener(`keyup`,this.handleEscape)}removeEscapeListener(){document.removeEventListener(`keyup`,this.handleEscape)}setupScrollObserver(){document.addEventListener(`scroll`,this.handleScroll)}stopScrollObserver(){document.removeEventListener(`scroll`,this.handleScroll)}setupResizeObserver(){this.resizeObserver&&this.resizeObserver.addObserver({handler:this,target:this.resizingElement})}disconnectResizeObserver(e){(e??this.resizeObserver)?.removeObserver({handler:this,target:this.resizingElement})}getRecaptchaWidget(){if(this.recaptchaWidgetPromise)return this.recaptchaWidgetPromise;if(this.recaptchaManager)return this.recaptchaWidgetPromise=this.recaptchaManager.getRecaptchaWidget(),this.recaptchaWidgetPromise}resetSubmissionState(){this.setSubmissionState(`idle`),this.error=void 0}setSubmissionState(e){this.submissionState!==e&&(this.submissionState=e,this.emitSubmissionStateChanged())}emitSubmissionStateChanged(){this.dispatchEvent(new CustomEvent(`submissionStateChanged`,{detail:this.submissionState}))}get isProcessing(){return this.submissionState===`processing`}get isSubmitted(){return this.submissionState===`submitted`}showPopup(){this.isSubmitted||(this.setupResizeObserver(),this.setupScrollObserver(),this.setupEscapeListener(),this.positionPopup(),this.isOpen=!0,this.getRecaptchaWidget())}closePopup(){this.disconnectResizeObserver(),this.stopScrollObserver(),this.removeEscapeListener(),this.isOpen=!1}positionPopup(){let e=this.container.getBoundingClientRect(),t=this.popup.getBoundingClientRect(),n=window.innerWidth,r=window.innerHeight,i=n/2,a=r/2;e.left<i?this.popupTopX=e.right-20:this.popupTopX=e.left+20-t.width,this.popupTopX+t.width>n&&(this.popupTopX=n-t.width-5),e.top<a?this.popupTopY=e.bottom-10:this.popupTopY=e.top+10-t.height,this.popupTopY+t.height>r&&(this.popupTopY=r-t.height-5),this.popupTopX=Math.max(5,this.popupTopX),this.popupTopY=Math.max(5,this.popupTopY)}get feedbackButtonThumbsTemplate(){return this.showButtonThumbs?K`
    ...
    `:q}get feedbackButtonCheckTemplate(){return K`<span class="beta-button-icon success">&check;</span>`}get feedbackButtonTemplate(){return K`
      ...
      ${this.popupTemplate}
    `}get popupTemplate(){let e=this.isProcessing||this.isSubmitted,t=this.isProcessing?mg.SUBMIT_BUTTON_PROCESSING_TEXT:mg.SUBMIT_BUTTON_NORMAL_TEXT,n=this.error?K`<div id="error">${this.error}</div>`:q,r=Qm({left:`${this.popupTopX}px`,top:`${this.popupTopY}px`}),i=e=>e.stopPropagation();return K`
      <div
        id="popup-background"
        class=${this.isOpen?`open`:`closed`}
        @click=${this.backgroundClicked}
      ...
      >
        ...
        <div
          ...
          style=${r}
        >
          <h2 id="survey-heading" class="sr-only">${ih(`Feedback Survey`)}</h2>
          <form
            id="form"
            ?disabled=${e}
            @click=${i}
    ...
    `}focusFirstFormElement(){let e=this.getRootNode();for(let t of this.assignedElements)if(t.focus(),e.activeElement===t)return;this.focusCancelButton()}focusCancelButton(){this.cancelButton.focus()}focusSubmitButton(){this.submitButton.focus()}applyQuestionNumbers(){if(!this.showQuestionNumbers){this.assignedElements.forEach(e=>{var t;(t=e.querySelector(`[slot=question-number]`))==null||t.remove()});return}let e=1;this.assignedElements.filter(e=>lg(e)&&e.numbered).forEach(t=>{let n=t.querySelector(`[slot=question-number]`);n||(n=document.createElement(`span`),n.setAttribute(`slot`,`question-number`)),n.textContent=`${e}. `,t.append(n),e+=1})}backgroundClicked(e){e.target instanceof Node&&(this.popup?.contains(e.target)||this.cancel(e))}cancel(e){e.preventDefault(),this.closePopup(),this.isSubmitted||this.resetSubmissionState()}validate(){return this.assignedElements.filter(ug).map(e=>e.validate()).every(e=>e)}async submit(e){if(e?.preventDefault(),!this.validate()){this.error=K`${mg.ERROR_MESSAGE_MISSING_REQUIRED_INPUT}`,this.setSubmissionState(`error`);return}let{surveyIdentifier:t,submitTimeout:n,featureFeedbackService:r}=this;if(this.error=void 0,!t)throw Error(`surveyIdentifier is required`);if(!r)throw Error(`featureFeedbackService is required`);let i=this.getRecaptchaWidget(),a;try{a=await pg(i,n)}catch(e){throw Error(`recaptchaWidget load failed: ${e}`)}if(!a)throw Error(`recaptchaWidget is required`);let o=this.isOpen;this.setSubmissionState(`processing`);try{let e=await pg(a.execute(),n);(await pg(r.submitSurvey({surveyIdentifier:t,responses:this.assignedElements.filter(dg).map(e=>e.response),recaptchaToken:e}),n)).success?(this.setSubmissionState(`submitted`),o&&this.closePopup()):(this.error=K`${mg.ERROR_MESSAGE_SUBMIT_REQUEST_FAILED}`,this.setSubmissionState(`error`))}catch(e){this.error=K`${mg.ERROR_MESSAGE_SUBMIT_REQUEST_FAILED}
        <br />
        ${ih(`Error: `)}${e instanceof Error?e.message:e}`,this.setSubmissionState(`error`)}}static get styles(){let e=P`var(--featureFeedbackBlueColor, #194880)`,t=P`var(--defaultColorSvgFilter, invert(52%) sepia(0%) saturate(1%) hue-rotate(331deg) brightness(87%) contrast(89%))`,n=P`var(--featureFeedbackBackdropZindex, 5)`,r=P`var(--featureFeedbackModalZindex, 6)`,i=P`var(--featureFeedbackPopupMaxWidth, 300px)`,a=P`var(--featureFeedbackPopupVerticalPadding, 10px)`,o=P`
      ${a} ${P`var(--featureFeedbackPopupHorizontalPadding, 10px)`}
    `,s=P`var(--featureFeedbackPopupBorderColor, ${e})`,c=P`var(--featureFeedbackBetaButtonBorderColor, ${e})`,l=P`var(--featureFeedbackBetaButtonTextColor, ${e})`,u=P`var(--featureFeedbackBetaButtonSvgFilter, ${t})`,d=P`var(--featureFeedbackPopupBlockerColor, rgba(255, 255, 255, 0.3))`,f=P`var(--featureFeedbackPopupBackgroundColor, #FBFBFD)`;return[sg,P`
      #container {
        display: inline-block;
      }
    ...
    `}};gg.DEFAULT_PLACEHOLDER_REQUIRED=ih(`Comments`),gg.DEFAULT_PLACEHOLDER_OPTIONAL=ih(`Comments (optional)`),gg.formAssociated=!0,gg.shadowRootOptions={...Um.shadowRootOptions,delegatesFocus:!0},t([F({type:String})],gg.prototype,`prompt`,void 0),t([F({type:String})],gg.prototype,`value`,void 0),t([F({type:Boolean,reflect:!0})],gg.prototype,`required`,void 0),t([F({type:Boolean,reflect:!0})],gg.prototype,`disabled`,void 0),t([F({type:Boolean,reflect:!0})],gg.prototype,`skipNumber`,void 0),t([F({type:String})],gg.prototype,`placeholder`,void 0),t([Si(`#comments`)],gg.prototype,`commentBox`,void 0),gg=hg=t([_i(`ia-survey-comment`)],gg);var _g=Jm(class extends Ym{constructor(e){if(super(e),e.type!==qm.ATTRIBUTE||e.name!==`class`||e.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return` `+Object.keys(e).filter((t=>e[t])).join(` `)+` `}update(e,[t]){var n;if(this.it===void 0){this.it=new Set,e.strings!==void 0&&(this.nt=new Set(e.strings.join(` `).split(/\s/).filter((e=>e!==``))));for(let e in t)t[e]&&!this.nt?.has(e)&&this.it.add(e);return this.render(t)}let r=e.element.classList;this.it.forEach((e=>{e in t||(r.remove(e),this.it.delete(e))}));for(let e in t){let i=!!t[e];i===this.it.has(e)||(n=this.nt)!=null&&n.has(e)||(i?(r.add(e),this.it.add(e)):(r.remove(e),this.it.delete(e)))}return Tm}}),vg,yg=vg=class extends Um{constructor(){super(),this.prompt=``,this.vote=void 0,this.required=!1,this.disabled=!1,this.skipNumber=!1,this.showComments=!1,this.visible=!0,this.internals=this.attachInternals()}render(){return K`
      <div id="container">
        <div
          id="prompt-row"
          role="radiogroup"
    ...
    `}willUpdate(e){e.has(`required`)&&(this.internals.ariaRequired=this.required.toString()),e.has(`disabled`)&&(this.internals.ariaDisabled=this.disabled.toString())}validate(){return!this.required||this.vote?this.internals.setValidity({}):this.internals.setValidity({valueMissing:!0},`A vote is required.`),this.internals.checkValidity()}get numbered(){return!this.skipNumber}get response(){return{...this.commentBox?.response,name:this.prompt,rating:this.vote}}get promptTextTemplate(){return this.prompt?K`<div id="prompt-text">${this.numbered?K`<slot name="question-number"></slot>`:q}${this.prompt}</div>`:q}get voteButtonsTemplate(){let e=this.vote===`up`,t=this.vote===`down`,n={"vote-button":!0,noselection:this.vote===void 0},r=_g({...n,selected:e,unselected:t}),i=_g({...n,selected:t,unselected:e});return K`
      ...
      >
        ...
        />
        ${Gm}
        <span class="sr-only">${vg.UPVOTE_SR_LABEL}</span>
      </label>
      ...
      >
        ...
        />
        ${Km}
        <span class="sr-only">${vg.DOWNVOTE_SR_LABEL}</span>
      </label>
    ...
    `}};yg.UPVOTE_SR_LABEL=ih(`Vote up`),yg.DOWNVOTE_SR_LABEL=ih(`Vote down`),yg.formAssociated=!0,yg.shadowRootOptions={...Um.shadowRootOptions,delegatesFocus:!0},t([F({type:String})],yg.prototype,`prompt`,void 0),t([F({type:String})],yg.prototype,`vote`,void 0),t([F({type:String})],yg.prototype,`comment`,void 0),t([F({type:String})],yg.prototype,`commentPlaceholder`,void 0),t([F({type:Boolean,reflect:!0})],yg.prototype,`required`,void 0),t([F({type:Boolean,reflect:!0})],yg.prototype,`disabled`,void 0),t([F({type:Boolean,reflect:!0})],yg.prototype,`skipNumber`,void 0),t([F({type:Boolean,reflect:!0})],yg.prototype,`showComments`,void 0),t([Si(`#comments`)],yg.prototype,`commentBox`,void 0),yg=vg=t([_i(`ia-survey-vote`)],yg);var bg=class extends Um{constructor(){super(...arguments),this.name=``,this.visible=!1,this.disabled=!1}createRenderRoot(){return this}render(){return q}validate(){return!0}get numbered(){return!1}get response(){return{name:this.name,comment:this.value}}};t([F({type:String,reflect:!0})],bg.prototype,`name`,void 0),t([F({type:String,reflect:!0})],bg.prototype,`value`,void 0),bg=t([_i(`ia-survey-extra`)],bg);var xg=T`
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path
...
`,Sg=class extends O{constructor(...e){super(...e),this.binSnapping=`none`,this.barScaling=`logarithmic`,this.boundEscapeListener=e=>{e.key===`Escape`&&this.closeModal()}}render(){return T`
      <div id="container">
    ...
    `}};z([A({type:String})],Sg.prototype,`minDate`,void 0),z([A({type:String})],Sg.prototype,`maxDate`,void 0),z([A({type:String})],Sg.prototype,`minSelectedDate`,void 0),z([A({type:String})],Sg.prototype,`maxSelectedDate`,void 0),z([A({type:Array})],Sg.prototype,`buckets`,void 0),z([A({type:String})],Sg.prototype,`customDateFormat`,void 0),z([A({type:String})],Sg.prototype,`customTooltipDateFormat`,void 0),z([A({type:String})],Sg.prototype,`customTooltipLabel`,void 0),z([A({type:String})],Sg.prototype,`binSnapping`,void 0),z([A({type:String})],Sg.prototype,`barScaling`,void 0),z([A({type:Object,attribute:!1})],Sg.prototype,`modalManager`,void 0),z([A({type:Object,attribute:!1})],Sg.prototype,`analyticsHandler`,void 0),Sg=z([k(`expanded-date-picker`)],Sg);var Cg=class extends O{constructor(){super(...arguments),this.loadingTitle=N(`Loading...`),this.successTitle=N(`Success`),this.errorTitle=N(`Error`),this.loadingStyle=`ring-dots`,this.mode=`loading`}render(){return T`${uo(this.mode,[[`loading`,()=>this.loadingIndicatorTemplate],[`success`,()=>this.successIndicatorTemplate],[`error`,()=>this.errorIndicatorTemplate]])}`}get loadingIndicatorTemplate(){return T`
      <svg
    ...
    `}get shouldShowLoadingDots(){return this.loadingStyle!==`ring`}static get styles(){return[to,w`
      ...
      `]}};t([A({type:String})],Cg.prototype,`loadingTitle`,void 0),t([A({type:String})],Cg.prototype,`successTitle`,void 0),t([A({type:String})],Cg.prototype,`errorTitle`,void 0),t([A({type:String})],Cg.prototype,`loadingStyle`,void 0),t([A({type:String})],Cg.prototype,`mode`,void 0),Cg=t([k(`ia-status-indicator`)],Cg);var wg=E`
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path 
      d="m20.1116715 50.0035012-.1116715-.1085359 43.1159942-46.61088155c2.401537-2.18938917 4.6902018-3.28408375 6.8659943-3.28408375s4.1642651.63837733 5.9654178 1.91513199c1.8011528 1.27675467 3.1520173 2.97248092 4.0525937 5.08717877l-39.4020173 42.99768924 39.4020173 42.9976892c-.9005764 2.1146979-2.2514409 3.8104241-4.0525937 5.0871788-1.8011527 1.2767547-3.7896253 1.915132-5.9654178 1.915132-2.1013449 0-4.3900096-1.0573489-6.8659943-3.1720468l-43.1159942-46.7194174z"
    />
...
`,Eg=class extends O{constructor(...e){super(...e),this.step=2,this.currentPage=1,this.pages=[]}firstUpdated(){this.observePageCount()}updated(e){e.has(`size`)&&this.observePageCount(),e.has(`currentPage`)&&(this.observePageCount(),this.emitPageClick())}observePageCount(){this.pages=[];let e=this.size<=7;if(this.size<=5){this.pages=[...Array(this.size).keys()].map(e=>e+1);return}if(this.size===7){if(this.currentPage===2){this.pages=[1,2,3,4,0,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,4,5,this.size-1,this.size];return}}if(this.currentPage===1){this.pages=[1,2,3,0,this.size];return}if(this.currentPage===this.size){this.pages=[1,0,this.size-2,this.size-1,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,this.size-3,this.size-2,this.size-1,this.size];return}if(e&&this.currentPage>1&&this.currentPage<7){this.pages=[...Array(this.size).keys()].map(e=>e+1);return}let t=this.currentPage-this.step,n=this.currentPage+this.step;t<=0&&(n+=-t+1,t=1),n>=this.size&&(t=Math.max(t-(n-this.size),1),n=this.size),t===2&&--n,n===this.size-1&&(t+=1),this.createFirstNode(t),this.createMiddelNode(t,n),this.createLastNode(n)}createFirstNode(e){e>1&&this.pages?.push(1),e>2&&this.pages?.push(0)}createMiddelNode(e,t){for(let n=e;n<=t;n+=1)this.pages?.push(n)}createLastNode(e){e<this.size-1&&this.pages?.push(0),e<this.size&&this.pages?.push(this.size)}get getEllipsisTemplate(){return T`<i class="ellipses">...</i>`}emitPageClick(){this.dispatchEvent(new CustomEvent(`pageNumberClicked`,{detail:{page:this.currentPage},bubbles:!0,composed:!0}))}onRewind(){--this.currentPage,this.currentPage<1&&(this.currentPage=1)}onForward(){this.currentPage+=1,this.currentPage>this.size&&(this.currentPage=this.size)}onChange(e){this.currentPage=e}getPageTemplate(e){return T`
    ...
    `}static get styles(){return[za,w`
      ...
      `]}};z([A({type:Number})],Eg.prototype,`size`,void 0),z([A({type:Number})],Eg.prototype,`step`,void 0),z([A({type:Number})],Eg.prototype,`currentPage`,void 0),z([j()],Eg.prototype,`pages`,void 0),Eg=z([k(`more-facets-pagination`)],Eg);var Dg=(e,t,n)=>{let r=new Map;for(let i=t;i<=n;i++)r.set(e[i],i);return r},Og=rr(class extends ir{constructor(e){if(super(e),e.type!==nr.CHILD)throw Error(`repeat() can only be used in text expressions`)}dt(e,t,n){let r;n===void 0?n=t:t!==void 0&&(r=t);let i=[],a=[],o=0;for(let t of e)i[o]=r?r(t,o):o,a[o]=n(t,o),o++;return{values:a,keys:i}}render(e,t,n){return this.dt(e,t,n).values}update(e,[t,n,r]){let i=Ya(e),{values:a,keys:o}=this.dt(t,n,r);if(!Array.isArray(i))return this.ut=o,a;let s=this.ut??=[],c=[],l,u,d=0,f=i.length-1,p=0,m=a.length-1;for(;d<=f&&p<=m;)if(i[d]===null)d++;else if(i[f]===null)f--;else if(s[d]===o[p])c[p]=Ka(i[d],a[p]),d++,p++;else if(s[f]===o[m])c[m]=Ka(i[f],a[m]),f--,m--;else if(s[d]===o[m])c[m]=Ka(i[d],a[m]),Ga(e,c[m+1],i[d]),d++,m--;else if(s[f]===o[p])c[p]=Ka(i[f],a[p]),Ga(e,i[d],i[f]),f--,p++;else if(l===void 0&&(l=Dg(o,p,m),u=Dg(s,d,f)),l.has(s[d]))if(l.has(s[f])){let t=u.get(o[p]),n=t===void 0?null:i[t];if(n===null){let t=Ga(e,i[d]);Ka(t,a[p]),c[p]=t}else c[p]=Ka(n,a[p]),Ga(e,i[d],n),i[t]=null;p++}else Xa(i[f]),f--;else Xa(i[d]),d++;for(;p<=m;){let t=Ga(e,c[m+1]);Ka(t,a[p]),c[p++]=t}for(;d<=f;){let e=i[d++];e!==null&&Xa(e)}return this.ut=o,Ja(e,c),Et}}),kg=E`
...
`,jg,Mg=jg=class extends O{render(){return T`${this.facetRowTemplate}`}get facetRowTemplate(){let{bucket:e,facetType:t}=this;if(!e||!t)return D;let n=`${t}:${e.key}-show-only`,r=`${t}:${e.key}-negative`,i=e.extraNote?T`<span class="facet-note">${e.extraNote}</span>`:D,a=t===`collection`?T`<a href="/details/${e.key}">
        ...
        <div class="facet-checkboxes">
          ...
          <div class="hide-facet-container">
            ...
            >
              ...
              <span class="eye eye-open">${kg}</span>
              <span class="eye eye-closed">${Ag}</span>
            </label>
          </div>
        </div>
        <label
    ...
    `]}};z([A({type:String})],Mg.prototype,`facetType`,void 0),z([A({type:Object})],Mg.prototype,`bucket`,void 0),z([A({type:Object})],Mg.prototype,`collectionTitles`,void 0),Mg=jg=z([k(`facet-row`)],Mg);var Ng=class extends O{facetClicked(e){this.dispatchFacetClickEvent(e.detail)}dispatchFacetClickEvent(e){let t=new CustomEvent(`facetClick`,{detail:e,composed:!0});this.dispatchEvent(t)}get facetsTemplate(){let{facetGroup:e}=this;if(!e)return D;let t=e.buckets;return T`
      <div class="facet-rows" data-testid="facets-on-${e.key}">
        ${Og(t,t=>`${e.key}:${t.key}`,t=>T`<facet-row
              .facetType=${e.key}
              .bucket=${t}
              .collectionTitles=${this.collectionTitles}
    ...
    `}};z([A({type:Object})],Ng.prototype,`facetGroup`,void 0),z([A({type:Object})],Ng.prototype,`collectionTitles`,void 0),Ng=z([k(`facets-template`)],Ng);var Pg=class extends O{constructor(...e){super(...e),this.leftValue=``,this.rightValue=``,this.side=`left`}render(){return T`
      <div id="container">
    ...
    `}partOfCollectionClicked(e){this.analyticsHandler?.sendEvent({category:La.default,action:L.partOfCollectionClicked,label:e.target.dataset.id})}get histogramProps(){let{histogramAggregation:e}=this;if(!e)return;let t=e.first_bucket_year??e.first_bucket_key,n=e.last_bucket_year??e.last_bucket_key;if(t==null||n==null)return;let r=e.first_bucket_month??1,i=e.last_bucket_month??12,a=e.interval??1,o=e.interval_in_months??12,s=e=>e.toString().padStart(2,`0`);if(this.isTvSearch){let a=o<12;return{buckets:e.buckets,dateFormat:`YYYY-MM`,tooltipDateFormat:a?`MMM YYYY`:`YYYY`,tooltipLabel:`broadcast`,binSnapping:a?`month`:`year`,barScaling:`linear`,minDate:`${t}-${s(r)}`,maxDate:`${n}-${s(i+o-1)}`}}return{buckets:e.buckets,dateFormat:`YYYY`,tooltipDateFormat:`YYYY`,tooltipLabel:`item`,binSnapping:`year`,barScaling:`logarithmic`,minDate:`${t}`,maxDate:`${n+a-1}`}}showDatePickerModal(){let{histogramProps:e}=this;if(!e)return;let{buckets:t,dateFormat:n,tooltipDateFormat:r,tooltipLabel:i,binSnapping:a,barScaling:o,minDate:s,maxDate:c}=e,l=T`
      <expanded-date-picker
        ${wd(e=>{if(e&&e instanceof Sg){let t=e;t.minSelectedDate=this.minSelectedDate,t.maxSelectedDate=this.maxSelectedDate}})}
        .minDate=${s}
        .maxDate=${c}
    ...
    `}};Lg=z([k(`circular-activity-indicator`)],Lg);function Rg(e,t){return e===void 0?t!==void 0:t===void 0?e!==void 0:e.facetType===t.facetType&&e.bucketKey===t.bucketKey}function zg(e,t){return e.label===t.label&&e.facets.length===t.facets.length&&e.facets.every((e,n)=>Rg(e,t.facets[n]))}function Bg(e){if(!Array.isArray(e[0])){let t=[...e];for(let e=0;e<t.length;e++){let n=t[e];t=t.filter(e=>n===e||!zg(n,e))}return t}let t=e,n=[];for(let e of t){let t=[];for(let r of e)n.find(e=>e.find(e=>zg(r,e)))||t.push(r);t.length>0&&n.push(t)}return n}var Vg=class e{async getRecommendedFacets(){let t=navigator.language,n=e.getLanguageDisplayName(t);return n?[{facets:[{facetType:`language`,bucketKey:n}]}]:[]}static getLanguageDisplayName(e){let t=e.split(`-`)[0];return new Intl.DisplayNames([`en`],{type:`language`}).of(t)}},Hg={facets:[{facetType:`mediatype`,bucketKey:`texts`}]},Ug={facets:[{facetType:`mediatype`,bucketKey:`audio`}]},Wg={facets:[{facetType:`mediatype`,bucketKey:`movies`}]},Gg={facets:[{facetType:`mediatype`,bucketKey:`image`}]},Kg={facets:[{facetType:`mediatype`,bucketKey:`software`}]},qg={facets:[{facetType:`mediatype`,bucketKey:`etree`}]},Jg={text:[Hg],book:[Hg],novel:[Hg],magazine:[Hg],newspaper:[Hg],pdf:[Hg],epub:[Hg],audio:[Ug],song:[Ug],music:[Ug],listen:[Ug],podcast:[Ug],radio:[Ug],stream:[Ug,Wg],video:[Wg],movie:[Wg],film:[Wg],animation:[Wg],youtube:[Wg],image:[Gg],photo:[Gg],picture:[Gg],painting:[Gg],jpg:[Gg],jpeg:[Gg],png:[Gg],gif:[Gg],software:[Kg],app:[Kg],program:[Kg],game:[Kg],arcade:[Kg],etree:[qg],concert:[qg],"live music":[qg],"web crawl":[{facets:[{facetType:`mediatype`,bucketKey:`web`}]}],dataset:[{facets:[{facetType:`mediatype`,bucketKey:`data`}]}]},Yg=class{async getRecommendedFacets(e){let t=[];for(let[n,r]of Object.entries(Jg))e.includes(n)&&t.push(...r);return t}},Xg=[{facets:[{facetType:`mediatype`,bucketKey:`texts`}]}],Zg=[{label:`Films by __QUERY`,facets:[{facetType:`mediatype`,bucketKey:`movies`},{facetType:`creator`,bucketKey:`__QUERY`}]}],Qg=[{label:`Writing by __QUERY`,facets:[{facetType:`mediatype`,bucketKey:`texts`},{facetType:`creator`,bucketKey:`__QUERY`}]}],$g=[{label:`Images by __QUERY`,facets:[{facetType:`mediatype`,bucketKey:`image`},{facetType:`creator`,bucketKey:`__QUERY`}]}],e_=[{label:`Music by __QUERY`,facets:[{facetType:`mediatype`,bucketKey:`audio`},{facetType:`creator`,bucketKey:`__QUERY`}]}],t_={"written work":Xg,literature:Xg,book:Xg,novel:Xg,filmmaker:Zg,director:Zg,author:Qg,writer:Qg,novelist:Qg,essayist:Qg,poet:Qg,"visual artist":$g,"graphic artist":$g,photographer:$g,painter:$g,singer:e_,songwriter:e_,musician:e_,composer:e_,pianist:e_},n_=class{constructor(){this.WIKIDATA_BASE_URL=`https://www.wikidata.org/w/api.php`,this.WIKIDATA_DEFAULT_ARGS=`?action=wbsearchentities&format=json&language=en&uselang=en&origin=*&type=item&limit=5`}getWikidataURL(e){let t=encodeURIComponent(e);return`${this.WIKIDATA_BASE_URL}${this.WIKIDATA_DEFAULT_ARGS}&search=${t}`}replaceQueryPlaceholders(e,t){return e.map(e=>({label:e.label?.replace(`__QUERY`,t),facets:e.facets.map(e=>{let n={...e,bucketKey:e.bucketKey.replace(`__QUERY`,t.toLowerCase())};return e.displayText&&(n.displayText=n.displayText?.replace(`__QUERY`,t)),n})}))}async getRecommendedFacets(e){let t=[];try{let n=this.getWikidataURL(e),r=await(await fetch(n)).json();for(let[e,n]of Object.entries(t_))if(RegExp(`\\b${e}\\b`).test(r.search[0]?.description)){let e=r.search[0].label;t.push(...this.replaceQueryPlaceholders(n,e))}return t}catch(e){return console.warn(e),[]}}},r_=class e{static{this.DEFAULT_HEURISTICS=[Yg,n_,Vg]}async getRecommendedFacets(t,n=e.DEFAULT_HEURISTICS){let r=n.map(e=>new e().getRecommendedFacets(t));return Bg((await Promise.all(r)).flat())}},i_=window.location&&(window.location.hostname===`localhost`||window.location.host.match(/^(www|cat)-[a-z0-9]+\.archive\.org$/)||window.location.host.match(/\.code\.archive\.org$/)||window.location.host.match(/\.dev\.archive\.org$/)||window.location.host.match(/^ia-petabox-/)||window.location.host.match(/^local\.archive\.org/)||window.location.host.match(/^internetarchive\.github\.io$/))?console.log.bind(console):()=>{},a_=T`
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path
