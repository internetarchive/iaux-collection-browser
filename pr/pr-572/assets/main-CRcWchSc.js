...
`;function bo(e,t=`short`,{locale:n=`en-US`,useLocalTime:r=!1}={}){if(!e)return``;let i=r?{}:{timeZone:`UTC`};switch(t){case`year-only`:return`${e.getUTCFullYear()}`;case`short`:i.month=`short`,i.year=`numeric`;break;case`long`:i.year=`numeric`,i.month=`short`,i.day=`2-digit`;break;default:break}return new Intl.DateTimeFormat(n,i).format(e)}var xo=class{constructor(e={}){this.model=e.model,this.baseNavigationUrl=e.baseNavigationUrl,this.collectionPagePath=e.collectionPagePath??`/details/`,this.sortParam=e.sortParam,this.creatorFilter=e.creatorFilter}get firstCreatorMatchingFilter(){let e;if(this.creatorFilter&&this.model?.creators.length){let t=this.creatorFilter;e=this.model.creators.find(e=>e.normalize(`NFD`).replace(/[^A-Z]+/gi,``).toUpperCase().startsWith(t))}return e??this.model?.creator}get accountLabel(){return this.model?.dateAdded?N(or`Archivist since ${this.model.dateAdded.getFullYear()}`):``}get dateLabel(){switch(this.sortParam?.field){case`publicdate`:return N(`Archived`);case`reviewdate`:return N(`Reviewed`);case`addeddate`:return N(`Added`);case`date`:return N(`Published`);default:return``}}get viewsLabel(){return this.sortParam?.field===`week`?N(`Weekly views`):N(`All-time views`)}itemPageUrl(e,t=!1){if(!e||this.baseNavigationUrl==null)return D;let n=t?this.collectionPagePath:`/details/`;return`${this.baseNavigationUrl}${n}${e}`}webArchivesCaptureLink(e,t){return T` <a href=${`https://web.archive.org/web/${t.toISOString().replace(/[TZ:-]/g,``).replace(/\..*/,``)}/${encodeURIComponent(e)}`}> ${bo(t,`long`)} </a> `}},B=class extends O{constructor(...e){super(...e),this.tileActions=[],this.sortParam=null,this.defaultSortParam=null,this.loggedIn=!1,this.suppressBlurring=!1,this.useLocalTime=!1,this.displayValueProvider=new xo}willUpdate(e){(e.has(`model`)||e.has(`baseNavigationUrl`)||e.has(`collectionPagePath`)||e.has(`sortParam`)||e.has(`defaultSortParam`)||e.has(`creatorFilter`))&&(this.displayValueProvider=new xo({model:this.model,baseNavigationUrl:this.baseNavigationUrl,collectionPagePath:this.collectionPagePath,sortParam:this.sortParam??this.defaultSortParam??void 0,creatorFilter:this.creatorFilter}))}getFormattedDate(e,t){let{useLocalTime:n}=this;return bo(e,t,{useLocalTime:n})}renderTileActions(e=``){return this.tileActions.length?T`
      <div class=${e?`tile-actions ${e}`:`tile-actions`}>
...
`,Ac=class extends B{constructor(...e){super(...e),this.collectionLinks=[]}render(){return T`
    ...
    `}};z([A({type:Object})],jc.prototype,`model`,void 0),z([A({type:String})],jc.prototype,`baseNavigationUrl`,void 0),z([A({type:String})],jc.prototype,`baseImageUrl`,void 0),z([A({type:Boolean})],jc.prototype,`loggedIn`,void 0),z([A({type:Boolean})],jc.prototype,`suppressBlurring`,void 0),z([A({type:Object})],jc.prototype,`sortParam`,void 0),z([A({type:Number})],jc.prototype,`mobileBreakpoint`,void 0),z([A({type:Number})],jc.prototype,`currentWidth`,void 0),z([A({type:Object})],jc.prototype,`collectionTitles`,void 0),jc=z([k(`tile-hover-pane`)],jc);var Mc=class extends B{render(){return T`
      <div id="list-line" class="${`${this.classSize}${this.tileActions.length>0?` has-actions`:``}`}">
        <image-block
          .model=${this.model}
          .baseImageUrl=${this.baseImageUrl}
          .isCompactTile=${!0}
        ...
        ${this.tileActions.length>0?T`<div id="actions">
    ...
    `}get href(){return!this.model?.identifier||this.baseNavigationUrl==null?D:this.model.href?`${this.baseNavigationUrl}${this.model.href}`:this.displayValueProvider.itemPageUrl(this.model.identifier,this.model.mediatype===`collection`)}get creator(){return this.displayValueProvider.firstCreatorMatchingFilter??D}get date(){switch(this.effectiveSort?.field){case`publicdate`:return this.model?.dateArchived;case`reviewdate`:return this.model?.dateReviewed;case`addeddate`:return this.model?.dateAdded;default:return this.model?.datePublished}}get views(){return this.effectiveSort?.field===`week`?this.model?.weeklyViewCount:this.model?.viewCount}get effectiveSort(){return this.sortParam??this.defaultSortParam}get classSize(){return this.mobileBreakpoint&&this.currentWidth&&this.currentWidth<this.mobileBreakpoint?`mobile`:`desktop`}get dateFormatSize(){return(!this.isSortedByDate||this.effectiveSort?.field===`date`)&&Do(this.model?.datePublished)?`year-only`:this.formatSize}get formatSize(){return this.mobileBreakpoint&&this.currentWidth&&this.currentWidth<this.mobileBreakpoint?`short`:`long`}get isSortedByDate(){return[`date`,`reviewdate`,`addeddate`,`publicdate`].includes(this.effectiveSort?.field)}static get styles(){return[kc,w`
      ...
      <div id="list-line-header" class="${`${this.classSize}${e?` has-actions`:``}`}">
        <div id="thumb"></div>
