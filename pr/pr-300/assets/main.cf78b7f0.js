var Er=Object.defineProperty,Dr=Object.defineProperties;var Lr=Object.getOwnPropertyDescriptors;var to=Object.getOwnPropertySymbols;var Pr=Object.prototype.hasOwnProperty,Ar=Object.prototype.propertyIsEnumerable;var io=(o,e,t)=>e in o?Er(o,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):o[e]=t,X=(o,e)=>{for(var t in e||(e={}))Pr.call(e,t)&&io(o,t,e[t]);if(to)for(var t of to(e))Ar.call(e,t)&&io(o,t,e[t]);return o},ve=(o,e)=>Dr(o,Lr(e));import aa from"https://esm.archive.org/dayjs@^1.10.7";import Fr from"https://esm.archive.org/dayjs@1.9.4/esm/plugin/customParseFormat";const Br=function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))i(a);new MutationObserver(a=>{for(const r of a)if(r.type==="childList")for(const l of r.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&i(l)}).observe(document,{childList:!0,subtree:!0});function t(a){const r={};return a.integrity&&(r.integrity=a.integrity),a.referrerpolicy&&(r.referrerPolicy=a.referrerpolicy),a.crossorigin==="use-credentials"?r.credentials="include":a.crossorigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(a){if(a.ep)return;a.ep=!0;const r=t(a);fetch(a.href,r)}};Br();function s(o,e,t,i){var a=arguments.length,r=a<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,l;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(o,e,t,i);else for(var n=o.length-1;n>=0;n--)(l=o[n])&&(r=(a<3?l(r):a>3?l(e,t,r):l(e,t))||r);return a>3&&r&&Object.defineProperty(e,t,r),r}function Ir(o,e,t,i){function a(r){return r instanceof t?r:new t(function(l){l(r)})}return new(t||(t=Promise))(function(r,l){function n(v){try{p(i.next(v))}catch(f){l(f)}}function d(v){try{p(i.throw(v))}catch(f){l(f)}}function p(v){v.done?r(v.value):a(v.value).then(n,d)}p((i=i.apply(o,e||[])).next())})}class Or{constructor(e){var t,i,a,r;this.ARCHIVE_ANALYTICS_VERSION=2,this.DEFAULT_SERVICE="ao_2",this.NO_SAMPLING_SERVICE="ao_no_sampling",this.DEFAULT_IMAGE_URL="https://analytics.archive.org/0.gif",this.defaultService=(t=e==null?void 0:e.defaultService)!==null&&t!==void 0?t:this.DEFAULT_SERVICE,this.imageUrl=(i=e==null?void 0:e.imageUrl)!==null&&i!==void 0?i:this.DEFAULT_IMAGE_URL,this.imageContainer=(a=e==null?void 0:e.imageContainer)!==null&&a!==void 0?a:document.body,this.requireImagePing=(r=e==null?void 0:e.requireImagePing)!==null&&r!==void 0?r:!1}sendPing(e){const t=this.generateTrackingUrl(e).toString();if(this.requireImagePing){this.sendPingViaImage(t);return}const i=navigator.sendBeacon&&navigator.sendBeacon.bind(navigator);try{i(t)}catch{this.sendPingViaImage(t)}}sendEvent(e){const t=e.label&&e.label.trim().length>0?e.label:window.location.pathname,i=X({kind:"event",ec:e.category,ea:e.action,el:t,cache_bust:Math.random()},e.eventConfiguration);this.sendPing(i)}sendEventNoSampling(e){const t=e.eventConfiguration||{};t.service=this.NO_SAMPLING_SERVICE;const i=e;i.eventConfiguration=t,this.sendEvent(i)}sendPingViaImage(e){const t=new Image(1,1);t.src=e,t.alt="",this.imageContainer.appendChild(t)}generateTrackingUrl(e){var t;const i=e!=null?e:{};i.service=(t=i.service)!==null&&t!==void 0?t:this.defaultService;const a=new URL(this.imageUrl),r=Object.keys(i);return r.forEach(l=>{const n=i[l];a.searchParams.append(l,n)}),a.searchParams.append("version",`${this.ARCHIVE_ANALYTICS_VERSION}`),a.searchParams.append("count",`${r.length+2}`),a}}function g(o){let e,t,i;return typeof o=="object"?(e=o.hashFunction,t=o.expiring,i=o.tags):e=o,(a,r,l)=>{if(l.value!=null)l.value=ao(l.value,e,t,i);else if(l.get!=null)l.get=ao(l.get,e,t,i);else throw"Only put a Memoize() decorator on a method or get accessor."}}const Ui=new Map;function ao(o,e,t=0,i){const a=Symbol("__memoized_map__");return function(...r){let l;this.hasOwnProperty(a)||Object.defineProperty(this,a,{configurable:!1,enumerable:!1,writable:!1,value:new Map});let n=this[a];if(Array.isArray(i))for(const d of i)Ui.has(d)?Ui.get(d).push(n):Ui.set(d,[n]);if(e||r.length>0||t>0){let d;e===!0?d=r.map(f=>f.toString()).join("!"):e?d=e.apply(this,r):d=r[0];const p=`${d}__timestamp`;let v=!1;if(t>0)if(!n.has(p))v=!0;else{let f=n.get(p);v=Date.now()-f>t}n.has(d)&&!v?l=n.get(d):(l=o.apply(this,r),n.set(d,l),t>0&&n.set(p,Date.now()))}else{const d=this;n.has(d)?l=n.get(d):(l=o.apply(this,r),n.set(d,l))}return l}}class oa{parseValue(e){return typeof e=="string"&&(e==="false"||e==="0")?!1:Boolean(e)}}oa.shared=new oa;class _i{parseValue(e){if(typeof e=="number")return e;if(typeof e=="boolean")return;const t=parseFloat(e);if(!Number.isNaN(t))return t}}_i.shared=new _i;class ra{parseValue(e){return _i.shared.parseValue(e)}}ra.shared=new ra;class sa{parseValue(e){return this.parseJSDate(e)||this.parseBracketDate(e)}parseBracketDate(e){if(typeof e!="string")return;const t=e.match(/\[([0-9]{4})\]/);if(!(!t||t.length<2))return this.parseJSDate(t[1])}parseJSDate(e){if(typeof e!="string")return;let t=e;t.match(/^[0-9]{4}-[0-9]{2}-[0-9]{2}\s{1}[0-9]{2}:[0-9]{2}:[0-9]{2}$/)&&(t=t.replace(" ","T"));const i=Date.parse(t);if(Number.isNaN(i))return;let a=new Date(t);return(t.indexOf("Z")>-1||t.indexOf("+")>-1||t.match(/^[0-9]{4}$/)||t.match(/^[0-9]{4}-[0-9]{2}-[0-9]{2}$/)||t.match(/^.*?-[0-9]{2}:[0-9]{2}$/)||t.match(/^.*?-[0-9]{4}$/))&&(a=new Date(a.getTime()+a.getTimezoneOffset()*1e3*60)),a}}sa.shared=new sa;class la{parseValue(e){if(typeof e=="number")return e;if(typeof e=="boolean")return;const t=e.split(":");let i;return t.length===1?i=this.parseNumberFormat(t[0]):i=this.parseColonSeparatedFormat(t),i}parseNumberFormat(e){let t=parseFloat(e);return Number.isNaN(t)&&(t=void 0),t}parseColonSeparatedFormat(e){let t=!1;const i=e.map((a,r)=>{const l=parseFloat(a);if(Number.isNaN(l))return t=!0,0;const n=e.length-1-r,d=60**n;return l*Math.floor(d)}).reduce((a,r)=>a+r,0);return t?void 0:i}}la.shared=new la;class na{parseValue(e){if(typeof e=="string")return e}}na.shared=new na;class Rr{constructor(e,t){this.separators=[";",","],this.parser=e,t&&t.separators&&(this.separators=t.separators)}parseValue(e){const t=String(e);let i=[];for(const a of this.separators)if(i=t.split(a),i.length>1)break;return this.parseListValues(i)}parseListValues(e){const i=e.map(r=>r.trim()).map(r=>this.parser.parseValue(r)),a=[];return i.forEach(r=>{r!==void 0&&a.push(r)}),a}}class da{parseValue(e){if(typeof e=="string")return e}}da.shared=new da;class Ci{parseValue(e){return String(e)}}Ci.shared=new Ci;class ze{constructor(e,t){this.parser=e,this.rawValue=t}get values(){return this.parseRawValue()}get value(){return this.values[0]}parseRawValue(){if(this.rawValue===void 0)return[];const e=Array.isArray(this.rawValue)?this.rawValue:[this.rawValue],t=[];return e.forEach(i=>{const a=this.parser.parseValue(i);Array.isArray(a)?t.push(...a):a!==void 0&&t.push(a)}),t}}s([g()],ze.prototype,"values",null);s([g()],ze.prototype,"value",null);class Mt extends ze{constructor(e){super(oa.shared,e)}}class Z extends ze{constructor(e){super(sa.shared,e)}}class Hi extends ze{constructor(e){super(la.shared,e)}}class V extends ze{constructor(e){super(_i.shared,e)}}class $ extends ze{constructor(e){super(Ci.shared,e)}}class Nr extends ze{constructor(e){super(da.shared,e)}}class Si extends ze{constructor(e){super(ra.shared,e)}}class Ma extends ze{constructor(e){super(na.shared,e)}}class Ur extends ze{constructor(e,t){super(t,e)}}class Hr extends Ur{constructor(e){const t=new Rr(Ci.shared);super(e,t)}}class k{constructor(e){this.rawMetadata=e}get identifier(){var e;return(e=this.rawMetadata)===null||e===void 0?void 0:e.identifier}get addeddate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.addeddate?new Z(this.rawMetadata.addeddate):void 0}get audio_codec(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.audio_codec?new $(this.rawMetadata.audio_codec):void 0}get audio_sample_rate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.audio_sample_rate?new V(this.rawMetadata.audio_sample_rate):void 0}get avg_rating(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.avg_rating?new V(this.rawMetadata.avg_rating):void 0}get collection(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.collection?new $(this.rawMetadata.collection):void 0}get collections_raw(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.collections_raw?new $(this.rawMetadata.collections_raw):void 0}get collection_size(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.collection_size?new Si(this.rawMetadata.collection_size):void 0}get contributor(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.contributor?new $(this.rawMetadata.contributor):void 0}get coverage(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.coverage?new $(this.rawMetadata.coverage):void 0}get creator(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.creator?new $(this.rawMetadata.creator):void 0}get date(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.date?new Z(this.rawMetadata.date):void 0}get description(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.description?new $(this.rawMetadata.description):void 0}get downloads(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.downloads?new V(this.rawMetadata.downloads):void 0}get duration(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.duration?new Hi(this.rawMetadata.duration):void 0}get"external-identifier"(){var e,t;return!((e=this.rawMetadata)===null||e===void 0)&&e["external-identifier"]?new $((t=this.rawMetadata)===null||t===void 0?void 0:t["external-identifier"]):void 0}get files_count(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.files_count?new V(this.rawMetadata.files_count):void 0}get indexdate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.indexdate?new Z(this.rawMetadata.indexdate):void 0}get isbn(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.isbn?new $(this.rawMetadata.isbn):void 0}get issue(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.issue?new $(this.rawMetadata.issue):void 0}get item_count(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.item_count?new V(this.rawMetadata.item_count):void 0}get item_size(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.item_size?new Si(this.rawMetadata.item_size):void 0}get language(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.language?new $(this.rawMetadata.language):void 0}get length(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.length?new Hi(this.rawMetadata.length):void 0}get lineage(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.lineage?new $(this.rawMetadata.lineage):void 0}get month(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.month?new V(this.rawMetadata.month):void 0}get mediatype(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.mediatype?new Ma(this.rawMetadata.mediatype):void 0}get noindex(){var e;return((e=this.rawMetadata)===null||e===void 0?void 0:e.noindex)!=null?new Mt(this.rawMetadata.noindex):void 0}get notes(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.notes?new $(this.rawMetadata.notes):void 0}get num_favorites(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.num_favorites?new V(this.rawMetadata.num_favorites):void 0}get num_reviews(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.num_reviews?new V(this.rawMetadata.num_reviews):void 0}get openlibrary_edition(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.openlibrary_edition?new $(this.rawMetadata.openlibrary_edition):void 0}get openlibrary_work(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.openlibrary_work?new $(this.rawMetadata.openlibrary_work):void 0}get page_progression(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.page_progression?new Nr(this.rawMetadata.page_progression):void 0}get partner(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.partner?new $(this.rawMetadata.partner):void 0}get ppi(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.ppi?new V(this.rawMetadata.ppi):void 0}get publicdate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.publicdate?new Z(this.rawMetadata.publicdate):void 0}get publisher(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.publisher?new $(this.rawMetadata.publisher):void 0}get reviewdate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.reviewdate?new Z(this.rawMetadata.reviewdate):void 0}get runtime(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.runtime?new Hi(this.rawMetadata.runtime):void 0}get scanner(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.scanner?new $(this.rawMetadata.scanner):void 0}get source(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.source?new $(this.rawMetadata.source):void 0}get start_localtime(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.start_localtime?new Z(this.rawMetadata.start_localtime):void 0}get start_time(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.start_time?new Z(this.rawMetadata.start_time):void 0}get stop_time(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.stop_time?new Z(this.rawMetadata.stop_time):void 0}get subject(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.subject?new Hr(this.rawMetadata.subject):void 0}get taper(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.taper?new $(this.rawMetadata.taper):void 0}get title(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.title?new $(this.rawMetadata.title):void 0}get transferer(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.transferer?new $(this.rawMetadata.transferer):void 0}get track(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.track?new V(this.rawMetadata.track):void 0}get type(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.type?new $(this.rawMetadata.type):void 0}get uploader(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.uploader?new $(this.rawMetadata.uploader):void 0}get utc_offset(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.utc_offset?new V(this.rawMetadata.utc_offset):void 0}get venue(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.venue?new $(this.rawMetadata.venue):void 0}get volume(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.volume?new $(this.rawMetadata.volume):void 0}get week(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.week?new V(this.rawMetadata.week):void 0}get year(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.year?new Z(this.rawMetadata.year):void 0}get query(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.query?new $(this.rawMetadata.fields.query):void 0}get date_favorited(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.date_favorited?new Z(this.rawMetadata.fields.date_favorited):void 0}get __href__(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.__href__?new $(this.rawMetadata.fields.__href__):void 0}}s([g()],k.prototype,"addeddate",null);s([g()],k.prototype,"audio_codec",null);s([g()],k.prototype,"audio_sample_rate",null);s([g()],k.prototype,"avg_rating",null);s([g()],k.prototype,"collection",null);s([g()],k.prototype,"collections_raw",null);s([g()],k.prototype,"collection_size",null);s([g()],k.prototype,"contributor",null);s([g()],k.prototype,"coverage",null);s([g()],k.prototype,"creator",null);s([g()],k.prototype,"date",null);s([g()],k.prototype,"description",null);s([g()],k.prototype,"downloads",null);s([g()],k.prototype,"duration",null);s([g()],k.prototype,"external-identifier",null);s([g()],k.prototype,"files_count",null);s([g()],k.prototype,"indexdate",null);s([g()],k.prototype,"isbn",null);s([g()],k.prototype,"issue",null);s([g()],k.prototype,"item_count",null);s([g()],k.prototype,"item_size",null);s([g()],k.prototype,"language",null);s([g()],k.prototype,"length",null);s([g()],k.prototype,"lineage",null);s([g()],k.prototype,"month",null);s([g()],k.prototype,"mediatype",null);s([g()],k.prototype,"noindex",null);s([g()],k.prototype,"notes",null);s([g()],k.prototype,"num_favorites",null);s([g()],k.prototype,"num_reviews",null);s([g()],k.prototype,"openlibrary_edition",null);s([g()],k.prototype,"openlibrary_work",null);s([g()],k.prototype,"page_progression",null);s([g()],k.prototype,"partner",null);s([g()],k.prototype,"ppi",null);s([g()],k.prototype,"publicdate",null);s([g()],k.prototype,"publisher",null);s([g()],k.prototype,"reviewdate",null);s([g()],k.prototype,"runtime",null);s([g()],k.prototype,"scanner",null);s([g()],k.prototype,"source",null);s([g()],k.prototype,"start_localtime",null);s([g()],k.prototype,"start_time",null);s([g()],k.prototype,"stop_time",null);s([g()],k.prototype,"subject",null);s([g()],k.prototype,"taper",null);s([g()],k.prototype,"title",null);s([g()],k.prototype,"transferer",null);s([g()],k.prototype,"track",null);s([g()],k.prototype,"type",null);s([g()],k.prototype,"uploader",null);s([g()],k.prototype,"utc_offset",null);s([g()],k.prototype,"venue",null);s([g()],k.prototype,"volume",null);s([g()],k.prototype,"week",null);s([g()],k.prototype,"year",null);s([g()],k.prototype,"query",null);s([g()],k.prototype,"date_favorited",null);s([g()],k.prototype,"__href__",null);class P{constructor(e){this.rawMetadata=e}get identifier(){var e,t;return(t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.identifier}get addeddate(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.addeddate?new Z(this.rawMetadata.fields.addeddate):void 0}get avg_rating(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.avg_rating)!=null?new V(this.rawMetadata.fields.avg_rating):void 0}get collection(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.collection?new $(this.rawMetadata.fields.collection):void 0}get collection_files_count(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.collection_files_count)!=null?new V(this.rawMetadata.fields.collection_files_count):void 0}get collection_size(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.collection_size)!=null?new Si(this.rawMetadata.fields.collection_size):void 0}get creator(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.creator?new $(this.rawMetadata.fields.creator):void 0}get date(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.date?new Z(this.rawMetadata.fields.date):void 0}get date_favorited(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.date_favorited?new Z(this.rawMetadata.fields.date_favorited):void 0}get description(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.description?new $(this.rawMetadata.fields.description):void 0}get downloads(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.downloads)!=null?new V(this.rawMetadata.fields.downloads):void 0}get files_count(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.files_count)!=null?new V(this.rawMetadata.fields.files_count):void 0}get genre(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.genre?new $(this.rawMetadata.fields.genre):void 0}get indexflag(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.indexflag?new $(this.rawMetadata.fields.indexflag):void 0}get issue(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.issue?new $(this.rawMetadata.fields.issue):void 0}get item_count(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.item_count)!=null?new V(this.rawMetadata.fields.item_count):void 0}get item_size(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.item_size)!=null?new Si(this.rawMetadata.fields.item_size):void 0}get language(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.language?new $(this.rawMetadata.fields.language):void 0}get lending___available_to_borrow(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.lending___available_to_borrow)!=null?new Mt(this.rawMetadata.fields.lending___available_to_borrow):void 0}get lending___available_to_browse(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.lending___available_to_browse)!=null?new Mt(this.rawMetadata.fields.lending___available_to_browse):void 0}get lending___available_to_waitlist(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.lending___available_to_waitlist)!=null?new Mt(this.rawMetadata.fields.lending___available_to_waitlist):void 0}get lending___status(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.lending___status?new $(this.rawMetadata.fields.lending___status):void 0}get licenseurl(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.licenseurl?new $(this.rawMetadata.fields.licenseurl):void 0}get mediatype(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.mediatype?new Ma(this.rawMetadata.fields.mediatype):void 0}get month(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.month)!=null?new V(this.rawMetadata.fields.month):void 0}get noindex(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.noindex)!=null?new Mt(this.rawMetadata.fields.noindex):void 0}get num_favorites(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.num_favorites)!=null?new V(this.rawMetadata.fields.num_favorites):void 0}get num_reviews(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.num_reviews)!=null?new V(this.rawMetadata.fields.num_reviews):void 0}get publicdate(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.publicdate?new Z(this.rawMetadata.fields.publicdate):void 0}get reviewbody(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.reviewbody?new $(this.rawMetadata.fields.reviewbody):void 0}get reviewdate(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.reviewdate?new Z(this.rawMetadata.fields.reviewdate):void 0}get reviewer(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.reviewer?new $(this.rawMetadata.fields.reviewer):void 0}get reviewtitle(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.reviewtitle?new $(this.rawMetadata.fields.reviewtitle):void 0}get source(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.source?new $(this.rawMetadata.fields.source):void 0}get subject(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.subject?new $(this.rawMetadata.fields.subject):void 0}get title(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.title?new $(this.rawMetadata.fields.title):void 0}get type(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.type?new $(this.rawMetadata.fields.type):void 0}get volume(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.volume?new $(this.rawMetadata.fields.volume):void 0}get week(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.week)!=null?new V(this.rawMetadata.fields.week):void 0}get year(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.year)!=null?new V(this.rawMetadata.fields.year):void 0}}s([g()],P.prototype,"addeddate",null);s([g()],P.prototype,"avg_rating",null);s([g()],P.prototype,"collection",null);s([g()],P.prototype,"collection_files_count",null);s([g()],P.prototype,"collection_size",null);s([g()],P.prototype,"creator",null);s([g()],P.prototype,"date",null);s([g()],P.prototype,"date_favorited",null);s([g()],P.prototype,"description",null);s([g()],P.prototype,"downloads",null);s([g()],P.prototype,"files_count",null);s([g()],P.prototype,"genre",null);s([g()],P.prototype,"indexflag",null);s([g()],P.prototype,"issue",null);s([g()],P.prototype,"item_count",null);s([g()],P.prototype,"item_size",null);s([g()],P.prototype,"language",null);s([g()],P.prototype,"lending___available_to_borrow",null);s([g()],P.prototype,"lending___available_to_browse",null);s([g()],P.prototype,"lending___available_to_waitlist",null);s([g()],P.prototype,"lending___status",null);s([g()],P.prototype,"licenseurl",null);s([g()],P.prototype,"mediatype",null);s([g()],P.prototype,"month",null);s([g()],P.prototype,"noindex",null);s([g()],P.prototype,"num_favorites",null);s([g()],P.prototype,"num_reviews",null);s([g()],P.prototype,"publicdate",null);s([g()],P.prototype,"reviewbody",null);s([g()],P.prototype,"reviewdate",null);s([g()],P.prototype,"reviewer",null);s([g()],P.prototype,"reviewtitle",null);s([g()],P.prototype,"source",null);s([g()],P.prototype,"subject",null);s([g()],P.prototype,"title",null);s([g()],P.prototype,"type",null);s([g()],P.prototype,"volume",null);s([g()],P.prototype,"week",null);s([g()],P.prototype,"year",null);class j{constructor(e){this.rawMetadata=e}get identifier(){var e,t;return(t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.identifier}get highlight(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.highlight)===null||t===void 0)&&t.text?new $(this.rawMetadata.highlight.text):void 0}get addeddate(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.addeddate?new Z(this.rawMetadata.fields.addeddate):void 0}get avg_rating(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.avg_rating)!=null?new V(this.rawMetadata.fields.avg_rating):void 0}get collection(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.collection?new $(this.rawMetadata.fields.collection):void 0}get created_on(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.created_on?new Z(this.rawMetadata.fields.created_on):void 0}get creator(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.creator?new $(this.rawMetadata.fields.creator):void 0}get date(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.date?new Z(this.rawMetadata.fields.date):void 0}get description(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.description?new $(this.rawMetadata.fields.description):void 0}get downloads(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.downloads)!=null?new V(this.rawMetadata.fields.downloads):void 0}get filename(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.filename?new $(this.rawMetadata.fields.filename):void 0}get file_basename(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.file_basename?new $(this.rawMetadata.fields.file_basename):void 0}get file_creation_mtime(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.file_creation_mtime)!=null?new V(this.rawMetadata.fields.file_creation_mtime):void 0}get issue(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.issue?new $(this.rawMetadata.fields.issue):void 0}get mediatype(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.mediatype?new Ma(this.rawMetadata.fields.mediatype):void 0}get page_num(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.page_num)!=null?new V(this.rawMetadata.fields.page_num):void 0}get publicdate(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.publicdate?new Z(this.rawMetadata.fields.publicdate):void 0}get result_in_subfile(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.result_in_subfile)!=null?new Mt(this.rawMetadata.fields.result_in_subfile):void 0}get reviewdate(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.reviewdate?new Z(this.rawMetadata.fields.reviewdate):void 0}get source(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.source?new $(this.rawMetadata.fields.source):void 0}get subject(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.subject?new $(this.rawMetadata.fields.subject):void 0}get title(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.title?new $(this.rawMetadata.fields.title):void 0}get updated_on(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.updated_on?new Z(this.rawMetadata.fields.updated_on):void 0}get year(){var e,t;return((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0?void 0:t.year)!=null?new V(this.rawMetadata.fields.year):void 0}get __href__(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.__href__?new $(this.rawMetadata.fields.__href__):void 0}}s([g()],j.prototype,"highlight",null);s([g()],j.prototype,"addeddate",null);s([g()],j.prototype,"avg_rating",null);s([g()],j.prototype,"collection",null);s([g()],j.prototype,"created_on",null);s([g()],j.prototype,"creator",null);s([g()],j.prototype,"date",null);s([g()],j.prototype,"description",null);s([g()],j.prototype,"downloads",null);s([g()],j.prototype,"filename",null);s([g()],j.prototype,"file_basename",null);s([g()],j.prototype,"file_creation_mtime",null);s([g()],j.prototype,"issue",null);s([g()],j.prototype,"mediatype",null);s([g()],j.prototype,"page_num",null);s([g()],j.prototype,"publicdate",null);s([g()],j.prototype,"result_in_subfile",null);s([g()],j.prototype,"reviewdate",null);s([g()],j.prototype,"source",null);s([g()],j.prototype,"subject",null);s([g()],j.prototype,"title",null);s([g()],j.prototype,"updated_on",null);s([g()],j.prototype,"year",null);s([g()],j.prototype,"__href__",null);var J;(function(o){o[o.COUNT=0]="COUNT",o[o.ALPHABETICAL=1]="ALPHABETICAL",o[o.NUMERIC=2]="NUMERIC"})(J||(J={}));class Wo{constructor(e){this.buckets=e.buckets,this.doc_count_error_upper_bound=e.doc_count_error_upper_bound,this.sum_other_doc_count=e.sum_other_doc_count,this.first_bucket_key=e.first_bucket_key,this.last_bucket_key=e.last_bucket_key,this.number_buckets=e.number_buckets,this.interval=e.interval}getSortedBuckets(e){const t=[...this.buckets];if(this.isRawNumberBuckets(t))return t;const i=new Intl.Collator;switch(e){case J.ALPHABETICAL:return t.sort((a,r)=>i.compare(a.key.toString(),r.key.toString()));case J.NUMERIC:return t.sort((a,r)=>Number(r.key)-Number(a.key));case J.COUNT:default:return t}}isRawNumberBuckets(e){return typeof this.buckets[0]=="number"}}s([g()],Wo.prototype,"getSortedBuckets",null);class oi{constructor(e){this.rawMetadata=e}get identifier(){var e;return(e=this.rawMetadata)===null||e===void 0?void 0:e.fields.query}get title(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.title?new $(this.rawMetadata.fields.title):void 0}get query(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.query?new $(this.rawMetadata.fields.query):void 0}get date_favorited(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.date_favorited?new Z(this.rawMetadata.fields.date_favorited):void 0}get __href__(){var e,t;return!((t=(e=this.rawMetadata)===null||e===void 0?void 0:e.fields)===null||t===void 0)&&t.__href__?new $(this.rawMetadata.fields.__href__):void 0}}s([g()],oi.prototype,"title",null);s([g()],oi.prototype,"query",null);s([g()],oi.prototype,"date_favorited",null);s([g()],oi.prototype,"__href__",null);class za{constructor(e,t){var i,a,r,l,n,d,p;this.schema=t;const v=t==null?void 0:t.hit_type;this.totalResults=(a=(i=e==null?void 0:e.hits)===null||i===void 0?void 0:i.total)!==null&&a!==void 0?a:0,this.returnedCount=(l=(r=e==null?void 0:e.hits)===null||r===void 0?void 0:r.returned)!==null&&l!==void 0?l:0,this.results=(p=(d=(n=e==null?void 0:e.hits)===null||n===void 0?void 0:n.hits)===null||d===void 0?void 0:d.map(f=>{var b;return za.createResult((b=f.hit_type)!==null&&b!==void 0?b:v,f)}))!==null&&p!==void 0?p:[],e!=null&&e.aggregations&&(this.aggregations=Object.entries(e.aggregations).reduce((f,[b,w])=>(f[b]=new Wo(w),f),{})),e!=null&&e.collection_titles&&(this.collectionTitles=e.collection_titles),e!=null&&e.collection_extra_info&&(this.collectionExtraInfo=e.collection_extra_info)}static createResult(e,t){switch(e){case"item":return new P(t);case"text":return new j(t);case"favorited_search":return new oi(t);default:return new P(t)}}}class Vr{constructor(e){this.clientParameters=e.client_parameters,this.backendRequests=e.backend_requests,this.kind=e.kind}}class Wr{constructor(e){var t,i,a;this.rawResponse=e,this.request=new Vr(e.request),this.responseHeader=(t=e.response)===null||t===void 0?void 0:t.header,this.response=new za((i=e.response)===null||i===void 0?void 0:i.body,(a=e.response)===null||a===void 0?void 0:a.hit_schema)}}class jo{static aggregateSearchParamsAsString(e){if(e.omit)return"false";if(e.advancedParams){const t=e.advancedParams.map(a=>({terms:a}));return JSON.stringify(t)}if(e.simpleParams)return e.simpleParams.join(",")}static sortParamsAsString(e){return`${e.field}:${e.direction}`}static filterParamsAsString(e){return JSON.stringify(e)}static generateURLSearchParams(e){const t=new URLSearchParams;if(t.append("user_query",e.query),e.pageType&&t.append("page_type",String(e.pageType)),e.pageTarget&&t.append("page_target",String(e.pageTarget)),e.rows!=null&&t.append("hits_per_page",String(e.rows)),e.page!=null&&t.append("page",String(e.page)),e.fields&&e.fields.length>0&&t.append("fields",e.fields.join(",")),e.filters&&Object.keys(e.filters).length>0){const a=this.filterParamsAsString(e.filters);a&&a!=="{}"&&t.append("filter_map",a)}if(e.sort&&e.sort.length>0){const a=e.sort.map(r=>this.sortParamsAsString(r));t.append("sort",a.join(","))}const i=e.aggregations;if(i){const a=this.aggregateSearchParamsAsString(i);a&&t.append("aggregations",a)}if(e.aggregationsSize!=null&&t.append("aggregations_size",String(e.aggregationsSize)),e.debugging&&t.append("debugging","true"),e.uid&&t.append("uid",e.uid),e.includeClientUrl!==!1){const a=window.location.href.slice(0,400);e.query.length<=1e3&&t.append("client_url",a)}return t}}var jt;(function(o){o.networkError="SearchService.NetworkError",o.itemNotFound="SearchService.ItemNotFound",o.decodingError="SearchService.DecodingError",o.searchEngineError="SearchService.SearchEngineError"})(jt||(jt={}));class jr extends Error{constructor(e,t,i){super(t),this.name=e,this.type=e,this.details=i}}class Go{constructor(e){var t,i;this.baseUrl=(t=e==null?void 0:e.baseUrl)!==null&&t!==void 0?t:"archive.org",this.debuggingEnabled=(i=e==null?void 0:e.debuggingEnabled)!==null&&i!==void 0?i:!1,(e==null?void 0:e.includeCredentials)!==void 0?this.includeCredentials=e.includeCredentials:this.includeCredentials=window.location.href.match(/^https?:\/\/.*archive\.org(:[0-9]+)?/)!==null;const a=new URL(window.location.href),r=a.searchParams.get("scope"),l=a.searchParams.get("caching"),n=a.searchParams.get("verbose");(e==null?void 0:e.scope)!==void 0?this.requestScope=e.scope:r&&(this.requestScope=r),(e==null?void 0:e.caching)!==void 0?this.cachingFlags=e.caching:l&&(this.cachingFlags=l),(e==null?void 0:e.verbose)!==void 0?this.verbose=e.verbose:n&&(this.verbose=!!n)}async fetchUrl(e,t){var i,a;const r=new URL(e);this.requestScope&&r.searchParams.set("scope",this.requestScope),this.cachingFlags&&r.searchParams.set("caching",this.cachingFlags);let l;try{const n=(i=t==null?void 0:t.requestOptions)!==null&&i!==void 0?i:{credentials:this.includeCredentials?"include":"same-origin"};l=await fetch(r.href,n)}catch(n){const d=n instanceof Error?n.message:typeof n=="string"?n:"Unknown error";return this.getErrorResult(jt.networkError,d)}try{const n=await l.json();this.verbose&&this.printResponse(n),n.debugging&&this.printDebuggingInfo(n);const d=(a=n.response)===null||a===void 0?void 0:a.error;return d?this.getErrorResult(jt.searchEngineError,d.message,d.forensics):{success:n}}catch(n){const d=n instanceof Error?n.message:typeof n=="string"?n:"Unknown error";return this.getErrorResult(jt.decodingError,d)}}getErrorResult(e,t,i){return{error:new jr(e,t,i)}}printResponse(e){var t,i,a,r,l;try{const n=JSON.parse(JSON.stringify(e)),d=(a=(i=(t=n==null?void 0:n.response)===null||t===void 0?void 0:t.body)===null||i===void 0?void 0:i.hits)===null||a===void 0?void 0:a.hits;if(Array.isArray(d)&&d.length>1){const v=[];v.push(d[0]),v.push(`*** ${d.length-1} hits omitted ***`),n.response.body.hits.hits=v}const p=(l=(r=n==null?void 0:n.response)===null||r===void 0?void 0:r.body)===null||l===void 0?void 0:l.aggregations;p&&Object.entries(p).forEach(([v,f])=>{var b,w,S,E;if(((w=(b=f)===null||b===void 0?void 0:b.buckets)===null||w===void 0?void 0:w.length)>0){const B=JSON.parse(JSON.stringify(f));B.buckets=`*** ${(E=(S=B.buckets)===null||S===void 0?void 0:S.length)!==null&&E!==void 0?E:0} buckets omitted ***`,n.response.body.aggregations[v]=B}}),console.log("***** RESPONSE RECEIVED *****"),console.groupCollapsed("Response"),console.log(JSON.stringify(n,null,2)),console.groupEnd()}catch(n){console.error("Error printing search response:",n)}}printDebuggingInfo(e){var t,i;const a=e.debugging,r=(t=a.messages)!==null&&t!==void 0?t:[],l=(i=a.data)!==null&&i!==void 0?i:{};console.log("***** BEGIN DEBUGGING *****"),console.log("Full response:"),console.log(JSON.stringify(e,null,2)),console.group("Debug messages");for(const n of r)console.log(n);console.groupEnd(),console.group("Debug data");for(const[n,d]of Object.entries(l))console.log(n,d);console.groupEnd(),console.log("***** END DEBUGGING *****")}}class Gr extends Go{constructor(e){var t;super(e),this.servicePath=(t=e==null?void 0:e.servicePath)!==null&&t!==void 0?t:"/services/search/beta/page_production"}async performSearch(e){this.debuggingEnabled&&e.debugging===void 0&&(e.debugging=!0);const i=jo.generateURLSearchParams(e).toString(),a=`https://${this.baseUrl}${this.servicePath}/?service_backend=metadata&${i}`;return this.fetchUrl(a)}}class qr extends Go{constructor(e){var t;super(e),this.servicePath=(t=e==null?void 0:e.servicePath)!==null&&t!==void 0?t:"/services/search/beta/page_production"}async performSearch(e){this.debuggingEnabled&&e.debugging===void 0&&(e.debugging=!0);const i=jo.generateURLSearchParams(e).toString(),a=`https://${this.baseUrl}${this.servicePath}/?service_backend=fts&${i}`;return this.fetchUrl(a)}}var pe;(function(o){o[o.METADATA=0]="METADATA",o[o.FULLTEXT=1]="FULLTEXT"})(pe||(pe={}));class Ae{constructor(e={}){this.backendOptions=e}async search(e,t=pe.METADATA){const a=await Ae.getBackendForSearchType(t,this.backendOptions).performSearch(e);return a.error?a:{success:new Wr(a.success)}}static getBackendForSearchType(e,t={}){switch(e){case pe.FULLTEXT:return new qr(t);case pe.METADATA:default:return new Gr(t)}}}Ae.default=new Ae;s([g((o,e={})=>{const{includeCredentials:t=!1,verbose:i=!1,scope:a="",baseUrl:r=""}=e;return`${o};${t};${i};${a};${r}`})],Ae,"getBackendForSearchType",null);var Ye;(function(o){o.INCLUDE="inc",o.EXCLUDE="exc",o.GREATER_THAN="gt",o.GREATER_OR_EQUAL="gte",o.LESS_THAN="lt",o.LESS_OR_EQUAL="lte"})(Ye||(Ye={}));class Qr{constructor(){this.filterMap={}}addFilter(e,t,i){if(this.filterMap[e]||(this.filterMap[e]={}),this.filterMap[e][t]){const a=[].concat(this.filterMap[e][t],i);this.filterMap[e][t]=Array.from(new Set(a))}else this.filterMap[e][t]=i;return this}removeSingleFilter(e,t,i){var a;if(!(!((a=this.filterMap[e])===null||a===void 0)&&a[t]))return this;const r=[].concat(this.filterMap[e][t]),l=r.indexOf(i);return l>=0&&r.splice(l,1),this.filterMap[e][t]=r.length===1?r[0]:r,r.length===0&&delete this.filterMap[e][t],this.deleteFieldIfEmpty(e),this}removeFilters(e,t){return this.filterMap[e]?(delete this.filterMap[e][t],this.deleteFieldIfEmpty(e),this):this}deleteFieldIfEmpty(e){const t=this.filterMap[e];t&&Object.keys(t).length===0&&delete this.filterMap[e]}setFilterMap(e){return this.filterMap=X({},e),this}mergeFilterMap(e){for(const[t,i]of Object.entries(e))for(const[a,r]of Object.entries(i))if(Array.isArray(r))for(const l of r)this.addFilter(t,a,l);else this.addFilter(t,a,r);return this}build(){return this.filterMap}}function Kr(){var o=!navigator.userAgentData&&/Safari\//.test(navigator.userAgent)&&!/Chrom(e|ium)\//.test(navigator.userAgent);if(!o||!indexedDB.databases)return Promise.resolve();var e;return new Promise(function(t){var i=function(){return indexedDB.databases().finally(t)};e=setInterval(i,100),i()}).finally(function(){return clearInterval(e)})}function Ft(o){return new Promise((e,t)=>{o.oncomplete=o.onsuccess=()=>e(o.result),o.onabort=o.onerror=()=>t(o.error)})}function Yr(o,e){const t=Kr().then(()=>{const i=indexedDB.open(o);return i.onupgradeneeded=()=>i.result.createObjectStore(e),Ft(i)});return(i,a)=>t.then(r=>a(r.transaction(e,i).objectStore(e)))}let Vi;function Li(){return Vi||(Vi=Yr("keyval-store","keyval")),Vi}function Xr(o,e=Li()){return e("readonly",t=>Ft(t.get(o)))}function Zr(o,e,t=Li()){return t("readwrite",i=>(i.put(e,o),Ft(i.transaction)))}function Jr(o,e=Li()){return e("readwrite",t=>(t.delete(o),Ft(t.transaction)))}function es(o,e){return o.openCursor().onsuccess=function(){!this.result||(e(this.result),this.result.continue())},Ft(o.transaction)}function ts(o=Li()){return o("readonly",e=>{if(e.getAllKeys)return Ft(e.getAllKeys());const t=[];return es(e,i=>t.push(i.key)).then(()=>t)})}function is(o,e){return o.setMilliseconds(o.getMilliseconds()+e*1e3),o}class as{constructor(e){var t,i,a,r;if(this.namespace=(t=e==null?void 0:e.namespace)!==null&&t!==void 0?t:"LocalCache",this.defaultTTL=(i=e==null?void 0:e.defaultTTL)!==null&&i!==void 0?i:15*60,(!((a=e==null?void 0:e.immediateClean)!==null&&a!==void 0)||a)&&this.cleanExpired(),!(e!=null&&e.disableCleaning)){const l=(r=e==null?void 0:e.cleaningInterval)!==null&&r!==void 0?r:60;setInterval(()=>{this.cleanExpired()},l*1e3)}}async set(e){var t;const i={value:e.value},a=(t=e.ttl)!==null&&t!==void 0?t:this.defaultTTL,r=is(new Date,a);i.expires=r;const l=this.getNamespacedKey(e.key);try{await Zr(l,i)}catch{}}async get(e){const t=this.getNamespacedKey(e);let i;try{i=await Xr(t)}catch{}if(!i)return;const a=new Date;if(i.expires&&i.expires<a){await this.delete(e);return}return i.value}async delete(e){const t=this.getNamespacedKey(e);try{await Jr(t)}catch{}}async cleanExpired(){const e=await this.getAllKeys();await Promise.all(e.map(async t=>this.get(t)))}async getAllKeys(){let e=[];try{e=await ts()}catch{}const t=[];for(const r of e)typeof r=="string"&&t.push(r);return t.filter(r=>r.startsWith(this.namespace)).map(r=>this.removeNamespace(r))}getNamespacedKey(e){return`${this.namespace}-${e}`}removeNamespace(e){return e.replace(`${this.namespace}-`,"")}}/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ea=window.ShadowRoot&&(window.ShadyCSS===void 0||window.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Da=Symbol(),oo=new Map;class qo{constructor(e,t){if(this._$cssResult$=!0,t!==Da)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e}get styleSheet(){let e=oo.get(this.cssText);return Ea&&e===void 0&&(oo.set(this.cssText,e=new CSSStyleSheet),e.replaceSync(this.cssText)),e}toString(){return this.cssText}}const os=o=>new qo(typeof o=="string"?o:o+"",Da),m=(o,...e)=>{const t=o.length===1?o[0]:e.reduce((i,a,r)=>i+(l=>{if(l._$cssResult$===!0)return l.cssText;if(typeof l=="number")return l;throw Error("Value passed to 'css' function must be a 'css' function result: "+l+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(a)+o[r+1],o[0]);return new qo(t,Da)},rs=(o,e)=>{Ea?o.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet):e.forEach(t=>{const i=document.createElement("style"),a=window.litNonce;a!==void 0&&i.setAttribute("nonce",a),i.textContent=t.cssText,o.appendChild(i)})},ro=Ea?o=>o:o=>o instanceof CSSStyleSheet?(e=>{let t="";for(const i of e.cssRules)t+=i.cssText;return os(t)})(o):o;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Wi;const so=window.trustedTypes,ss=so?so.emptyScript:"",lo=window.reactiveElementPolyfillSupport,ca={toAttribute(o,e){switch(e){case Boolean:o=o?ss:null;break;case Object:case Array:o=o==null?o:JSON.stringify(o)}return o},fromAttribute(o,e){let t=o;switch(e){case Boolean:t=o!==null;break;case Number:t=o===null?null:Number(o);break;case Object:case Array:try{t=JSON.parse(o)}catch{t=null}}return t}},Qo=(o,e)=>e!==o&&(e==e||o==o),ji={attribute:!0,type:String,converter:ca,reflect:!1,hasChanged:Qo};class Tt extends HTMLElement{constructor(){super(),this._$Et=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Ei=null,this.o()}static addInitializer(e){var t;(t=this.l)!==null&&t!==void 0||(this.l=[]),this.l.push(e)}static get observedAttributes(){this.finalize();const e=[];return this.elementProperties.forEach((t,i)=>{const a=this._$Eh(i,t);a!==void 0&&(this._$Eu.set(a,i),e.push(a))}),e}static createProperty(e,t=ji){if(t.state&&(t.attribute=!1),this.finalize(),this.elementProperties.set(e,t),!t.noAccessor&&!this.prototype.hasOwnProperty(e)){const i=typeof e=="symbol"?Symbol():"__"+e,a=this.getPropertyDescriptor(e,i,t);a!==void 0&&Object.defineProperty(this.prototype,e,a)}}static getPropertyDescriptor(e,t,i){return{get(){return this[t]},set(a){const r=this[e];this[t]=a,this.requestUpdate(e,r,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)||ji}static finalize(){if(this.hasOwnProperty("finalized"))return!1;this.finalized=!0;const e=Object.getPrototypeOf(this);if(e.finalize(),this.elementProperties=new Map(e.elementProperties),this._$Eu=new Map,this.hasOwnProperty("properties")){const t=this.properties,i=[...Object.getOwnPropertyNames(t),...Object.getOwnPropertySymbols(t)];for(const a of i)this.createProperty(a,t[a])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const i=new Set(e.flat(1/0).reverse());for(const a of i)t.unshift(ro(a))}else e!==void 0&&t.push(ro(e));return t}static _$Eh(e,t){const i=t.attribute;return i===!1?void 0:typeof i=="string"?i:typeof e=="string"?e.toLowerCase():void 0}o(){var e;this._$Ep=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$Em(),this.requestUpdate(),(e=this.constructor.l)===null||e===void 0||e.forEach(t=>t(this))}addController(e){var t,i;((t=this._$Eg)!==null&&t!==void 0?t:this._$Eg=[]).push(e),this.renderRoot!==void 0&&this.isConnected&&((i=e.hostConnected)===null||i===void 0||i.call(e))}removeController(e){var t;(t=this._$Eg)===null||t===void 0||t.splice(this._$Eg.indexOf(e)>>>0,1)}_$Em(){this.constructor.elementProperties.forEach((e,t)=>{this.hasOwnProperty(t)&&(this._$Et.set(t,this[t]),delete this[t])})}createRenderRoot(){var e;const t=(e=this.shadowRoot)!==null&&e!==void 0?e:this.attachShadow(this.constructor.shadowRootOptions);return rs(t,this.constructor.elementStyles),t}connectedCallback(){var e;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$Eg)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostConnected)===null||i===void 0?void 0:i.call(t)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$Eg)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostDisconnected)===null||i===void 0?void 0:i.call(t)})}attributeChangedCallback(e,t,i){this._$AK(e,i)}_$ES(e,t,i=ji){var a,r;const l=this.constructor._$Eh(e,i);if(l!==void 0&&i.reflect===!0){const n=((r=(a=i.converter)===null||a===void 0?void 0:a.toAttribute)!==null&&r!==void 0?r:ca.toAttribute)(t,i.type);this._$Ei=e,n==null?this.removeAttribute(l):this.setAttribute(l,n),this._$Ei=null}}_$AK(e,t){var i,a,r;const l=this.constructor,n=l._$Eu.get(e);if(n!==void 0&&this._$Ei!==n){const d=l.getPropertyOptions(n),p=d.converter,v=(r=(a=(i=p)===null||i===void 0?void 0:i.fromAttribute)!==null&&a!==void 0?a:typeof p=="function"?p:null)!==null&&r!==void 0?r:ca.fromAttribute;this._$Ei=n,this[n]=v(t,d.type),this._$Ei=null}}requestUpdate(e,t,i){let a=!0;e!==void 0&&(((i=i||this.constructor.getPropertyOptions(e)).hasChanged||Qo)(this[e],t)?(this._$AL.has(e)||this._$AL.set(e,t),i.reflect===!0&&this._$Ei!==e&&(this._$EC===void 0&&(this._$EC=new Map),this._$EC.set(e,i))):a=!1),!this.isUpdatePending&&a&&(this._$Ep=this._$E_())}async _$E_(){this.isUpdatePending=!0;try{await this._$Ep}catch(t){Promise.reject(t)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var e;if(!this.isUpdatePending)return;this.hasUpdated,this._$Et&&(this._$Et.forEach((a,r)=>this[r]=a),this._$Et=void 0);let t=!1;const i=this._$AL;try{t=this.shouldUpdate(i),t?(this.willUpdate(i),(e=this._$Eg)===null||e===void 0||e.forEach(a=>{var r;return(r=a.hostUpdate)===null||r===void 0?void 0:r.call(a)}),this.update(i)):this._$EU()}catch(a){throw t=!1,this._$EU(),a}t&&this._$AE(i)}willUpdate(e){}_$AE(e){var t;(t=this._$Eg)===null||t===void 0||t.forEach(i=>{var a;return(a=i.hostUpdated)===null||a===void 0?void 0:a.call(i)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EU(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$Ep}shouldUpdate(e){return!0}update(e){this._$EC!==void 0&&(this._$EC.forEach((t,i)=>this._$ES(i,this[i],t)),this._$EC=void 0),this._$EU()}updated(e){}firstUpdated(e){}}Tt.finalized=!0,Tt.elementProperties=new Map,Tt.elementStyles=[],Tt.shadowRootOptions={mode:"open"},lo==null||lo({ReactiveElement:Tt}),((Wi=globalThis.reactiveElementVersions)!==null&&Wi!==void 0?Wi:globalThis.reactiveElementVersions=[]).push("1.3.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Gi;const Et=globalThis.trustedTypes,no=Et?Et.createPolicy("lit-html",{createHTML:o=>o}):void 0,He=`lit$${(Math.random()+"").slice(9)}$`,La="?"+He,ls=`<${La}>`,Dt=document,Qt=(o="")=>Dt.createComment(o),Kt=o=>o===null||typeof o!="object"&&typeof o!="function",Ko=Array.isArray,Yo=o=>{var e;return Ko(o)||typeof((e=o)===null||e===void 0?void 0:e[Symbol.iterator])=="function"},Ht=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,co=/-->/g,ho=/>/g,dt=/>|[ 	\n\r](?:([^\s"'>=/]+)([ 	\n\r]*=[ 	\n\r]*(?:[^ 	\n\r"'`<>=]|("|')|))|$)/g,po=/'/g,uo=/"/g,Xo=/^(?:script|style|textarea|title)$/i,Zo=o=>(e,...t)=>({_$litType$:o,strings:e,values:t}),c=Zo(1),O=Zo(2),we=Symbol.for("lit-noChange"),y=Symbol.for("lit-nothing"),vo=new WeakMap,gi=(o,e,t)=>{var i,a;const r=(i=t==null?void 0:t.renderBefore)!==null&&i!==void 0?i:e;let l=r._$litPart$;if(l===void 0){const n=(a=t==null?void 0:t.renderBefore)!==null&&a!==void 0?a:null;r._$litPart$=l=new Bt(e.insertBefore(Qt(),n),n,void 0,t!=null?t:{})}return l._$AI(o),l},zt=Dt.createTreeWalker(Dt,129,null,!1),Jo=(o,e)=>{const t=o.length-1,i=[];let a,r=e===2?"<svg>":"",l=Ht;for(let d=0;d<t;d++){const p=o[d];let v,f,b=-1,w=0;for(;w<p.length&&(l.lastIndex=w,f=l.exec(p),f!==null);)w=l.lastIndex,l===Ht?f[1]==="!--"?l=co:f[1]!==void 0?l=ho:f[2]!==void 0?(Xo.test(f[2])&&(a=RegExp("</"+f[2],"g")),l=dt):f[3]!==void 0&&(l=dt):l===dt?f[0]===">"?(l=a!=null?a:Ht,b=-1):f[1]===void 0?b=-2:(b=l.lastIndex-f[2].length,v=f[1],l=f[3]===void 0?dt:f[3]==='"'?uo:po):l===uo||l===po?l=dt:l===co||l===ho?l=Ht:(l=dt,a=void 0);const S=l===dt&&o[d+1].startsWith("/>")?" ":"";r+=l===Ht?p+ls:b>=0?(i.push(v),p.slice(0,b)+"$lit$"+p.slice(b)+He+S):p+He+(b===-2?(i.push(void 0),d):S)}const n=r+(o[t]||"<?>")+(e===2?"</svg>":"");if(!Array.isArray(o)||!o.hasOwnProperty("raw"))throw Error("invalid template strings array");return[no!==void 0?no.createHTML(n):n,i]};class Yt{constructor({strings:e,_$litType$:t},i){let a;this.parts=[];let r=0,l=0;const n=e.length-1,d=this.parts,[p,v]=Jo(e,t);if(this.el=Yt.createElement(p,i),zt.currentNode=this.el.content,t===2){const f=this.el.content,b=f.firstChild;b.remove(),f.append(...b.childNodes)}for(;(a=zt.nextNode())!==null&&d.length<n;){if(a.nodeType===1){if(a.hasAttributes()){const f=[];for(const b of a.getAttributeNames())if(b.endsWith("$lit$")||b.startsWith(He)){const w=v[l++];if(f.push(b),w!==void 0){const S=a.getAttribute(w.toLowerCase()+"$lit$").split(He),E=/([.?@])?(.*)/.exec(w);d.push({type:1,index:r,name:E[2],strings:S,ctor:E[1]==="."?tr:E[1]==="?"?ir:E[1]==="@"?ar:ri})}else d.push({type:6,index:r})}for(const b of f)a.removeAttribute(b)}if(Xo.test(a.tagName)){const f=a.textContent.split(He),b=f.length-1;if(b>0){a.textContent=Et?Et.emptyScript:"";for(let w=0;w<b;w++)a.append(f[w],Qt()),zt.nextNode(),d.push({type:2,index:++r});a.append(f[b],Qt())}}}else if(a.nodeType===8)if(a.data===La)d.push({type:2,index:r});else{let f=-1;for(;(f=a.data.indexOf(He,f+1))!==-1;)d.push({type:7,index:r}),f+=He.length-1}r++}}static createElement(e,t){const i=Dt.createElement("template");return i.innerHTML=e,i}}function mt(o,e,t=o,i){var a,r,l,n;if(e===we)return e;let d=i!==void 0?(a=t._$Cl)===null||a===void 0?void 0:a[i]:t._$Cu;const p=Kt(e)?void 0:e._$litDirective$;return(d==null?void 0:d.constructor)!==p&&((r=d==null?void 0:d._$AO)===null||r===void 0||r.call(d,!1),p===void 0?d=void 0:(d=new p(o),d._$AT(o,t,i)),i!==void 0?((l=(n=t)._$Cl)!==null&&l!==void 0?l:n._$Cl=[])[i]=d:t._$Cu=d),d!==void 0&&(e=mt(o,d._$AS(o,e.values),d,i)),e}class er{constructor(e,t){this.v=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}p(e){var t;const{el:{content:i},parts:a}=this._$AD,r=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:Dt).importNode(i,!0);zt.currentNode=r;let l=zt.nextNode(),n=0,d=0,p=a[0];for(;p!==void 0;){if(n===p.index){let v;p.type===2?v=new Bt(l,l.nextSibling,this,e):p.type===1?v=new p.ctor(l,p.name,p.strings,this,e):p.type===6&&(v=new or(l,this,e)),this.v.push(v),p=a[++d]}n!==(p==null?void 0:p.index)&&(l=zt.nextNode(),n++)}return r}m(e){let t=0;for(const i of this.v)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class Bt{constructor(e,t,i,a){var r;this.type=2,this._$AH=y,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=a,this._$Cg=(r=a==null?void 0:a.isConnected)===null||r===void 0||r}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cg}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&e.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=mt(this,e,t),Kt(e)?e===y||e==null||e===""?(this._$AH!==y&&this._$AR(),this._$AH=y):e!==this._$AH&&e!==we&&this.$(e):e._$litType$!==void 0?this.T(e):e.nodeType!==void 0?this.k(e):Yo(e)?this.S(e):this.$(e)}M(e,t=this._$AB){return this._$AA.parentNode.insertBefore(e,t)}k(e){this._$AH!==e&&(this._$AR(),this._$AH=this.M(e))}$(e){this._$AH!==y&&Kt(this._$AH)?this._$AA.nextSibling.data=e:this.k(Dt.createTextNode(e)),this._$AH=e}T(e){var t;const{values:i,_$litType$:a}=e,r=typeof a=="number"?this._$AC(e):(a.el===void 0&&(a.el=Yt.createElement(a.h,this.options)),a);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===r)this._$AH.m(i);else{const l=new er(r,this),n=l.p(this.options);l.m(i),this.k(n),this._$AH=l}}_$AC(e){let t=vo.get(e.strings);return t===void 0&&vo.set(e.strings,t=new Yt(e)),t}S(e){Ko(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,a=0;for(const r of e)a===t.length?t.push(i=new Bt(this.M(Qt()),this.M(Qt()),this,this.options)):i=t[a],i._$AI(r),a++;a<t.length&&(this._$AR(i&&i._$AB.nextSibling,a),t.length=a)}_$AR(e=this._$AA.nextSibling,t){var i;for((i=this._$AP)===null||i===void 0||i.call(this,!1,!0,t);e&&e!==this._$AB;){const a=e.nextSibling;e.remove(),e=a}}setConnected(e){var t;this._$AM===void 0&&(this._$Cg=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}}class ri{constructor(e,t,i,a,r){this.type=1,this._$AH=y,this._$AN=void 0,this.element=e,this.name=t,this._$AM=a,this.options=r,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=y}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,i,a){const r=this.strings;let l=!1;if(r===void 0)e=mt(this,e,t,0),l=!Kt(e)||e!==this._$AH&&e!==we,l&&(this._$AH=e);else{const n=e;let d,p;for(e=r[0],d=0;d<r.length-1;d++)p=mt(this,n[i+d],t,d),p===we&&(p=this._$AH[d]),l||(l=!Kt(p)||p!==this._$AH[d]),p===y?e=y:e!==y&&(e+=(p!=null?p:"")+r[d+1]),this._$AH[d]=p}l&&!a&&this.C(e)}C(e){e===y?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e!=null?e:"")}}class tr extends ri{constructor(){super(...arguments),this.type=3}C(e){this.element[this.name]=e===y?void 0:e}}const ns=Et?Et.emptyScript:"";class ir extends ri{constructor(){super(...arguments),this.type=4}C(e){e&&e!==y?this.element.setAttribute(this.name,ns):this.element.removeAttribute(this.name)}}class ar extends ri{constructor(e,t,i,a,r){super(e,t,i,a,r),this.type=5}_$AI(e,t=this){var i;if((e=(i=mt(this,e,t,0))!==null&&i!==void 0?i:y)===we)return;const a=this._$AH,r=e===y&&a!==y||e.capture!==a.capture||e.once!==a.once||e.passive!==a.passive,l=e!==y&&(a===y||r);r&&this.element.removeEventListener(this.name,this,a),l&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,i;typeof this._$AH=="function"?this._$AH.call((i=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&i!==void 0?i:this.element,e):this._$AH.handleEvent(e)}}class or{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){mt(this,e)}}const ds={L:"$lit$",P:He,V:La,I:1,N:Jo,R:er,j:Yo,D:mt,H:Bt,F:ri,O:ir,W:ar,B:tr,Z:or},mo=window.litHtmlPolyfillSupport;mo==null||mo(Yt,Bt),((Gi=globalThis.litHtmlVersions)!==null&&Gi!==void 0?Gi:globalThis.litHtmlVersions=[]).push("2.2.4");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var qi,Qi;class F extends Tt{constructor(){super(...arguments),this.renderOptions={host:this},this._$Dt=void 0}createRenderRoot(){var e,t;const i=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=i.firstChild),i}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Dt=gi(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Dt)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Dt)===null||e===void 0||e.setConnected(!1)}render(){return we}}F.finalized=!0,F._$litElement$=!0,(qi=globalThis.litElementHydrateSupport)===null||qi===void 0||qi.call(globalThis,{LitElement:F});const fo=globalThis.litElementPolyfillSupport;fo==null||fo({LitElement:F});((Qi=globalThis.litElementVersions)!==null&&Qi!==void 0?Qi:globalThis.litElementVersions=[]).push("3.2.0");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const A=o=>e=>typeof e=="function"?((t,i)=>(window.customElements.define(t,i),i))(o,e):((t,i)=>{const{kind:a,elements:r}=i;return{kind:a,elements:r,finisher(l){window.customElements.define(t,l)}}})(o,e);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const cs=(o,e)=>e.kind==="method"&&e.descriptor&&!("value"in e.descriptor)?ve(X({},e),{finisher(t){t.createProperty(e.key,o)}}):{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){typeof e.initializer=="function"&&(this[e.key]=e.initializer.call(this))},finisher(t){t.createProperty(e.key,o)}};function h(o){return(e,t)=>t!==void 0?((i,a,r)=>{a.constructor.createProperty(r,i)})(o,e,t):cs(o,e)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function M(o){return h(ve(X({},o),{state:!0}))}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const rr=({finisher:o,descriptor:e})=>(t,i)=>{var a;if(i===void 0){const r=(a=t.originalKey)!==null&&a!==void 0?a:t.key,l=e!=null?{kind:"method",placement:"prototype",key:r,descriptor:e(t.key)}:ve(X({},t),{key:r});return o!=null&&(l.finisher=function(n){o(n,r)}),l}{const r=t.constructor;e!==void 0&&Object.defineProperty(t,i,e(i)),o==null||o(r,i)}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Q(o,e){return rr({descriptor:t=>{const i={get(){var a,r;return(r=(a=this.renderRoot)===null||a===void 0?void 0:a.querySelector(o))!==null&&r!==void 0?r:null},enumerable:!0,configurable:!0};if(e){const a=typeof t=="symbol"?Symbol():"__"+t;i.get=function(){var r,l;return this[a]===void 0&&(this[a]=(l=(r=this.renderRoot)===null||r===void 0?void 0:r.querySelector(o))!==null&&l!==void 0?l:null),this[a]}}return i}})}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function hs(o){return rr({descriptor:e=>({get(){var t,i;return(i=(t=this.renderRoot)===null||t===void 0?void 0:t.querySelectorAll(o))!==null&&i!==void 0?i:[]},enumerable:!0,configurable:!0})})}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Ki;((Ki=window.HTMLSlotElement)===null||Ki===void 0?void 0:Ki.prototype.assignedElements)!=null;class ps{constructor(){this.resizeObserver=new ResizeObserver(e=>{window.requestAnimationFrame(()=>{for(const t of e){const i=this.resizeHandlers.get(t.target);i==null||i.forEach(a=>{a.handleResize(t)})}})}),this.resizeHandlers=new Map}shutdown(){this.resizeHandlers.forEach((e,t)=>{this.resizeObserver.unobserve(t)}),this.resizeHandlers.clear()}addObserver(e){var t;const i=(t=this.resizeHandlers.get(e.target))!==null&&t!==void 0?t:new Set;i.add(e.handler),this.resizeHandlers.set(e.target,i),this.resizeObserver.observe(e.target,e.options)}removeObserver(e){const t=this.resizeHandlers.get(e.target);!t||(t.delete(e.handler),t.size===0&&(this.resizeObserver.unobserve(e.target),this.resizeHandlers.delete(e.target)))}}class us{constructor(e){var t,i,a,r;this.cacheKeyName="collection-name-cache",this.cacheTtl=60*60*24*7,this.defaultLoadDelay=100,this.loadDelay=100,this.defaultPruningAge=1e3*60*60*24*7,this.defaultPruningInterval=1e3*30,this.fetchTimeout=null,this.addKnownTitlesComplete=Promise.resolve(),this.pendingIdentifierQueue=new Set,this.pendingPromises={},this.collectionNameCache={},this.pruningAge=this.defaultPruningAge,this.maxCacheSize=2500,this.cacheLoaded=!1,this.searchService=e.searchService,this.localCache=e.localCache,this.loadDelay=(t=e.loadDelay)!==null&&t!==void 0?t:this.defaultLoadDelay,this.pruningAge=(i=e.pruningAge)!==null&&i!==void 0?i:this.pruningAge,this.maxCacheSize=(a=e.maxCacheSize)!==null&&a!==void 0?a:this.maxCacheSize,this.pruneCache(),setInterval(async()=>{await this.pruneCache()},(r=e.pruneInterval)!==null&&r!==void 0?r:this.defaultPruningInterval)}async collectionNameFor(e){await this.addKnownTitlesComplete,this.cacheLoaded||await this.loadFromCache();const t=e.toLowerCase(),i=this.collectionNameCache[t];return i?(i.lastAccess=Date.now(),this.collectionNameCache[t]=i,i.name):(this.startPendingIdentifierTimer(),new Promise(a=>{var r;this.pendingIdentifierQueue.add(t);const l=(r=this.pendingPromises[t])!==null&&r!==void 0?r:[],n=async d=>{a(d)};l.push(n),this.pendingPromises[t]=l}))}async preloadIdentifiers(e){await this.addKnownTitlesComplete,this.cacheLoaded||await this.loadFromCache();const t=e.filter(i=>i!==void 0).map(i=>i.toLowerCase());for(const i of t)this.collectionNameCache[i]||this.pendingIdentifierQueue.add(i);this.startPendingIdentifierTimer()}async addKnownTitles(e){let t;this.addKnownTitlesComplete=new Promise(i=>{t=i}),this.cacheLoaded||await this.loadFromCache(),Object.entries(e).forEach(([i,a])=>{const r=i.toLowerCase();this.collectionNameCache[r]={name:a,lastAccess:Date.now()}}),await this.persistCache(),t()}async startPendingIdentifierTimer(){this.fetchTimeout||(this.fetchTimeout=window.setTimeout(()=>{this.loadPendingIdentifiers(),this.fetchTimeout=null},this.loadDelay))}async loadFromCache(){if(!this.localCache||this.cacheLoaded)return;const e=await this.localCache.get(this.cacheKeyName);!e||(this.collectionNameCache=e,this.cacheLoaded=!0)}async loadPendingIdentifiers(){var e,t,i;await this.loadFromCache();const a=Array.from(this.pendingIdentifierQueue).splice(0,100);if(a.length===0)return;a.map(async d=>this.pendingIdentifierQueue.delete(d));const r={query:`identifier:(${a.join(" OR ")})`,fields:["title","identifier"],rows:a.length,aggregations:{omit:!0}},n=(t=(e=(await this.searchService.search(r)).success)===null||e===void 0?void 0:e.response)===null||t===void 0?void 0:t.results;if(n&&n.length>0)for(const d of n){const{identifier:p,title:v}=d;if(!p)continue;const f=p.toLowerCase();a.splice(a.indexOf(f),1);const b=(i=v==null?void 0:v.value)!==null&&i!==void 0?i:null;this.collectionNameCache[f]={name:b,lastAccess:Date.now()};const w=this.pendingPromises[f];if(w){for(const S of w)S(b);delete this.pendingPromises[f]}}for(const d of a){this.collectionNameCache[d]={name:null,lastAccess:Date.now()};const p=this.pendingPromises[d];if(p){for(const v of p)v(null);delete this.pendingPromises[d]}}await this.persistCache()}async pruneCache(){await this.loadFromCache();const e=Date.now(),t=Object.entries(this.collectionNameCache).sort((a,r)=>{var l,n,d,p;const v=(n=(l=a[1])===null||l===void 0?void 0:l.lastAccess)!==null&&n!==void 0?n:0,f=(p=(d=r[1])===null||d===void 0?void 0:d.lastAccess)!==null&&p!==void 0?p:0;return v-f}),i=new Set;for(const[a,r]of t){if(!r)continue;const{lastAccess:l}=r;l<e-this.pruningAge&&i.add(a)}if(t.length>this.maxCacheSize)for(let a=0;a<t.length-this.maxCacheSize;a+=1){const[r]=t[a];i.add(r)}for(const a of i)delete this.collectionNameCache[a];await this.persistCache()}async persistCache(){var e;await((e=this.localCache)===null||e===void 0?void 0:e.set({key:this.cacheKeyName,value:this.collectionNameCache,ttl:this.cacheTtl}))}}let Xt=class extends F{render(){return c` ${this.name?this.name:this.identifier} `}createRenderRoot(){return this}updated(e){(e.has("identifier")||e.has("collectionNameCache"))&&this.fetchName()}async fetchName(){!this.identifier||!this.collectionNameCache||(this.name=await this.collectionNameCache.collectionNameFor(this.identifier))}};s([h({type:Object})],Xt.prototype,"collectionNameCache",void 0);s([h({type:String})],Xt.prototype,"identifier",void 0);s([M()],Xt.prototype,"name",void 0);Xt=s([A("async-collection-name")],Xt);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Pe={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},si=o=>(...e)=>({_$litDirective$:o,values:e});class li{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Lt=si(class extends li{constructor(o){var e;if(super(o),o.type!==Pe.ATTRIBUTE||o.name!=="class"||((e=o.strings)===null||e===void 0?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(o){return" "+Object.keys(o).filter(e=>o[e]).join(" ")+" "}update(o,[e]){var t,i;if(this.et===void 0){this.et=new Set,o.strings!==void 0&&(this.st=new Set(o.strings.join(" ").split(/\s/).filter(r=>r!=="")));for(const r in e)e[r]&&!(!((t=this.st)===null||t===void 0)&&t.has(r))&&this.et.add(r);return this.render(e)}const a=o.element.classList;this.et.forEach(r=>{r in e||(a.remove(r),this.et.delete(r))});for(const r in e){const l=!!e[r];l===this.et.has(r)||((i=this.st)===null||i===void 0?void 0:i.has(r))||(l?(a.add(r),this.et.add(r)):(a.remove(r),this.et.delete(r)))}return we}});/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{H:vs}=ds,sr=o=>o.strings===void 0,go=()=>document.createComment(""),Vt=(o,e,t)=>{var i;const a=o._$AA.parentNode,r=e===void 0?o._$AB:e._$AA;if(t===void 0){const l=a.insertBefore(go(),r),n=a.insertBefore(go(),r);t=new vs(l,n,o,o.options)}else{const l=t._$AB.nextSibling,n=t._$AM,d=n!==o;if(d){let p;(i=t._$AQ)===null||i===void 0||i.call(t,o),t._$AM=o,t._$AP!==void 0&&(p=o._$AU)!==n._$AU&&t._$AP(p)}if(l!==r||d){let p=t._$AA;for(;p!==l;){const v=p.nextSibling;a.insertBefore(p,r),p=v}}}return t},ct=(o,e,t=o)=>(o._$AI(e,t),o),ms={},lr=(o,e=ms)=>o._$AH=e,fs=o=>o._$AH,Yi=o=>{var e;(e=o._$AP)===null||e===void 0||e.call(o,!1,!0);let t=o._$AA;const i=o._$AB.nextSibling;for(;t!==i;){const a=t.nextSibling;t.remove(),t=a}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const bo=(o,e,t)=>{const i=new Map;for(let a=e;a<=t;a++)i.set(o[a],a);return i},nr=si(class extends li{constructor(o){if(super(o),o.type!==Pe.CHILD)throw Error("repeat() can only be used in text expressions")}dt(o,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);const a=[],r=[];let l=0;for(const n of o)a[l]=i?i(n,l):l,r[l]=t(n,l),l++;return{values:r,keys:a}}render(o,e,t){return this.dt(o,e,t).values}update(o,[e,t,i]){var a;const r=fs(o),{values:l,keys:n}=this.dt(e,t,i);if(!Array.isArray(r))return this.ut=n,l;const d=(a=this.ut)!==null&&a!==void 0?a:this.ut=[],p=[];let v,f,b=0,w=r.length-1,S=0,E=l.length-1;for(;b<=w&&S<=E;)if(r[b]===null)b++;else if(r[w]===null)w--;else if(d[b]===n[S])p[S]=ct(r[b],l[S]),b++,S++;else if(d[w]===n[E])p[E]=ct(r[w],l[E]),w--,E--;else if(d[b]===n[E])p[E]=ct(r[b],l[E]),Vt(o,p[E+1],r[b]),b++,E--;else if(d[w]===n[S])p[S]=ct(r[w],l[S]),Vt(o,r[b],r[w]),w--,S++;else if(v===void 0&&(v=bo(n,S,E),f=bo(d,b,w)),v.has(d[b]))if(v.has(d[w])){const B=f.get(n[S]),L=B!==void 0?r[B]:null;if(L===null){const U=Vt(o,r[b]);ct(U,l[S]),p[S]=U}else p[S]=ct(L,l[S]),Vt(o,r[b],L),r[B]=null;S++}else Yi(r[w]),w--;else Yi(r[b]),b++;for(;S<=E;){const B=Vt(o,p[E+1]);ct(B,l[S]),p[S++]=B}for(;b<=w;){const B=r[b++];B!==null&&Yi(B)}return this.ut=n,lr(o,p),we}});function ui(o,e,t){return Array.from({length:(e-o)/t+1},(i,a)=>o+a*t)}let Ve=class extends F{constructor(){super(...arguments),this.itemCount=0,this.scrollOptimizationsDisabled=!1,this.intersectionObserver=new IntersectionObserver(e=>{e.forEach(t=>{if(t.target===this.sentinel){t.isIntersecting&&this.dispatchEvent(new Event("scrollThresholdReached"));return}const a=t.target.dataset.cellIndex;if(!a)return;const r=parseInt(a,10);t.isIntersecting?this.visibleCellIndices.add(r):this.visibleCellIndices.delete(r)}),this.scrollOptimizationsDisabled||this.processVisibleCells()}),this.renderedCellIndices=new Set,this.visibleCellIndices=new Set,this.placeholderCellIndices=new Set}reload(){ui(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.removeCell(t)),this.renderedCellIndices.clear(),this.visibleCellIndices.clear(),this.placeholderCellIndices.clear(),this.setupObservations()}refreshCell(e){this.removeCell(e),this.bufferRange.includes(e)&&this.renderCellBuffer([e])}refreshAllVisibleCells(){this.bufferRange.forEach(e=>this.removeCell(e)),this.renderCellBuffer(this.bufferRange)}scrollToCell(e,t){const i=this.cellContainers[e];if(!i)return!1;const a=t?"smooth":"auto";return i.scrollIntoView({behavior:a}),!0}getVisibleCellIndices(){return Array.from(this.visibleCellIndices)}updated(e){(e.has("itemCount")||e.has("scrollOptimizationsDisabled"))&&this.setupObservations()}disconnectedCallback(){this.intersectionObserver.disconnect()}setupObservations(){this.setupIntersectionObserver()}setupIntersectionObserver(){this.intersectionObserver.disconnect(),this.sentinel&&this.intersectionObserver.observe(this.sentinel),this.scrollOptimizationsDisabled?(ui(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.visibleCellIndices.add(t)),this.processVisibleCells()):this.cellContainers.forEach(e=>this.intersectionObserver.observe(e))}render(){var e;const t=this.itemCount-1,i=ui(0,t,1),a=(e=this.ariaLandmarkLabel)!==null&&e!==void 0?e:y;return c`
      <section id="container" role="feed" aria-label=${a}>
    ...
    `}};s([h({type:Number})],Ve.prototype,"itemCount",void 0);s([h({type:Object})],Ve.prototype,"cellProvider",void 0);s([h({type:Object})],Ve.prototype,"placeholderCellTemplate",void 0);s([h({type:Boolean})],Ve.prototype,"scrollOptimizationsDisabled",void 0);s([h({type:String})],Ve.prototype,"ariaLandmarkLabel",void 0);s([Q("#sentinel")],Ve.prototype,"sentinel",void 0);s([hs(".cell-container")],Ve.prototype,"cellContainers",void 0);Ve=s([A("infinite-scroller")],Ve);/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Pa=o=>o!=null?o:y;/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const gs=(o,...e)=>({strTag:!0,strings:o,values:e}),pt=gs,bs=o=>typeof o!="string"&&"strTag"in o,ys=(o,e,t)=>{let i=o[0];for(let a=1;a<o.length;a++)i+=e[t?t[a-1]:a-1],i+=o[a];return i};/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ws=o=>bs(o)?ys(o.strings,o.values):o;/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;var ha;(function(o){o[o.bytes=0]="bytes",o[o.kilobytes=1]="kilobytes",o[o.megabytes=2]="megabytes",o[o.gigabytes=3]="gigabytes",o[o.terabytes=4]="terabytes",o[o.petabytes=5]="petabytes",o[o.exabytes=6]="exabytes",o[o.zettabytes=7]="zettabytes",o[o.yottabytes=8]="yottabytes"})(ha||(ha={}));function Cs(o,e,t=" "){let i=o;if(i===void 0)return y;let a=0;for(;i>1024;)i/=1024,a+=1;const r=10**e;i=Math.round(i*r)/r;let l=ha[a];return l=i===1?l.slice(0,-1):l,`${i.toLocaleString()+t+l}`}const Ge=m`
  .sr-only {
...
`,Ss=m`var(--tileBackgroundColor, #ffffff)`,$s=m`var(--tileCornerRadius, 4px)`,Pi=m`
...
`;class yo{constructor(e={}){var t;this.model=e.model,this.baseNavigationUrl=e.baseNavigationUrl,this.collectionPagePath=(t=e.collectionPagePath)!==null&&t!==void 0?t:"/details/",this.sortParam=e.sortParam,this.creatorFilter=e.creatorFilter}get firstCreatorMatchingFilter(){var e,t;let i;if(this.creatorFilter&&((e=this.model)===null||e===void 0?void 0:e.creators.length)){const a=this.creatorFilter;i=this.model.creators.find(r=>r.normalize("NFD").replace(/[^A-Z]+/gi,"").toUpperCase().startsWith(a))}return i!=null?i:(t=this.model)===null||t===void 0?void 0:t.creator}get accountLabel(){var e;return!((e=this.model)===null||e===void 0)&&e.dateAdded?D(pt`Archivist since ${this.model.dateAdded.getFullYear()}`):""}get dateLabel(){var e;switch((e=this.sortParam)===null||e===void 0?void 0:e.field){case"publicdate":return D("Archived");case"reviewdate":return D("Reviewed");case"addeddate":return D("Added");case"date":return D("Published");default:return""}}itemPageUrl(e,t=!1,i=""){if(!e||this.baseNavigationUrl==null)return y;const a=t?this.collectionPagePath:"/details/";return`${this.baseNavigationUrl}${a}${e}${i}`}}class le extends F{constructor(){super(...arguments),this.sortParam=null,this.defaultSortParam=null,this.loggedIn=!1,this.displayValueProvider=new yo}willUpdate(e){var t;(e.has("model")||e.has("baseNavigationUrl")||e.has("collectionPagePath")||e.has("sortParam")||e.has("creatorFilter"))&&(this.displayValueProvider=new yo({model:this.model,baseNavigationUrl:this.baseNavigationUrl,collectionPagePath:this.collectionPagePath,sortParam:(t=this.sortParam)!==null&&t!==void 0?t:void 0,creatorFilter:this.creatorFilter}))}}s([h({type:Object})],le.prototype,"model",void 0);s([h({type:Number})],le.prototype,"currentWidth",void 0);s([h({type:Number})],le.prototype,"currentHeight",void 0);s([h({type:String})],le.prototype,"baseNavigationUrl",void 0);s([h({type:String})],le.prototype,"baseImageUrl",void 0);s([h({type:String})],le.prototype,"collectionPagePath",void 0);s([h({type:Object})],le.prototype,"sortParam",void 0);s([h({type:Object})],le.prototype,"defaultSortParam",void 0);s([h({type:String})],le.prototype,"creatorFilter",void 0);s([h({type:Number})],le.prototype,"mobileBreakpoint",void 0);s([h({type:Boolean})],le.prototype,"loggedIn",void 0);const cr=O`
  <svg
    viewBox="0 0 100 100"
    xmlns="http://www.w3.org/2000/svg"
  >
...
`;let Zt=class extends F{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1,this.isCompactTile=!1}render(){return c`<div class="icon-overlay ${this.getClass}">
      ${this.iconDisplay}
    </div>`}get getClass(){return this.isCompactTile?"list-compact":"list-detail"}get iconDisplay(){return this.loginRequired&&!this.loggedIn?c`${hr}`:c`${cr}`}static get styles(){return m`
      :host {
        position: absolute;
        top: 50%;
        left: 50%;
    ...
    `}};s([h({type:Boolean})],Zt.prototype,"loggedIn",void 0);s([h({type:Boolean})],Zt.prototype,"loginRequired",void 0);s([h({type:Boolean})],Zt.prototype,"isCompactTile",void 0);Zt=s([A("icon-overlay")],Zt);let Jt=class extends F{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1,this.iconRequired=!1}render(){return c`
      <div class="overlay no-preview">
        <div class="icon-overlay">${this.iconDisplay}</div>
        <p class="text-overlay">${this.textDisplay}</p>
      </div>
    `}get iconDisplay(){return this.loginRequired&&!this.loggedIn?c`${hr}`:c`${cr}`}get textDisplay(){return this.loginRequired&&!this.loggedIn?c`Log in to view this item`:c`Content may be inappropriate`}static get styles(){return m`
      :host {
        align-items: center;
        display: flex;
      }
    ...
    `}};s([h({type:Boolean})],Jt.prototype,"loggedIn",void 0);s([h({type:Boolean})],Jt.prototype,"loginRequired",void 0);s([h({type:Boolean})],Jt.prototype,"iconRequired",void 0);Jt=s([A("text-overlay")],Jt);let Xe=class extends F{constructor(){super(...arguments),this.isCompactTile=!1,this.isListTile=!1,this.loggedIn=!1,this.viewSize="desktop"}render(){var e;return!((e=this.model)===null||e===void 0)&&e.identifier?c`
    ...
    `}};s([h({type:String})],Xe.prototype,"baseImageUrl",void 0);s([h({type:Boolean})],Xe.prototype,"isCompactTile",void 0);s([h({type:Boolean})],Xe.prototype,"isListTile",void 0);s([h({type:Boolean})],Xe.prototype,"loggedIn",void 0);s([h({type:Object})],Xe.prototype,"model",void 0);s([h({type:String})],Xe.prototype,"viewSize",void 0);Xe=s([A("image-block")],Xe);let pa=class extends le{constructor(){super(...arguments),this.showInfoButton=!1}render(){return c`
      <div class="container">
    ...
    >`}get getSizeTemplate(){var e,t;const i=(t=(e=this.model)===null||e===void 0?void 0:e.collectionSize)!==null&&t!==void 0?t:0;return i?c`<span id="item-size">${Cs(i,1)}</span>`:""}get infoButtonTemplate(){return this.showInfoButton?c`<button class="info-button" @click=${this.infoButtonPressed}>
          &#9432;
          <span class="sr-only">${D("More info")}</span>
        </button>`:y}infoButtonPressed(e){e.preventDefault();const t=new CustomEvent("infoButtonPressed",{detail:{x:e.clientX,y:e.clientY}});this.dispatchEvent(t)}static get styles(){const e=m`var(--tileBorderColor, #555555)`,t=m`var(--tileBackgroundColor, #666666)`,i=m`#fff`;return[Pi,m`
        .container {
          background-color: ${t};
          border: 1px solid ${e};
        }
      ...
      `]}};s([h({type:Boolean})],pa.prototype,"showInfoButton",void 0);pa=s([A("collection-tile")],pa);function ei(o,e="short",t="en-US"){if(!o)return"";const i={};switch(e){case"year-only":i.year="numeric";break;case"short":i.month="short",i.year="numeric";break;case"long":i.year="numeric",i.month="short",i.day="2-digit";break}return new Intl.DateTimeFormat(t,i).format(o)}function ks(o){return new Date(o.getTime()-o.getTimezoneOffset()*1e3*60)}function Aa(o){return o?ks(o).toISOString().endsWith("-01-01T00:00:00.000Z"):!1}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*bi(o,e){const t=typeof e=="function";if(o!==void 0){let i=-1;for(const a of o)i>-1&&(yield t?e(i):e),i++,yield a}}let $i=class extends F{constructor(){super(...arguments),this.snippets=[],this.viewSize="desktop"}render(){var e;return!((e=this.snippets)===null||e===void 0)&&e.length?c`
      <div class="container">
    ...
    `}get snippetTemplates(){var e;return(e=this.snippets)===null||e===void 0?void 0:e.map(t=>{const i=t.matchAll(/{{{(.+?)}}}/gs),a=[];let r=0;for(const l of i)l.index!=null&&(a.push(c`
            ${t.slice(r,l.index)}
            <mark>${l[1]}</mark>
          `),r=l.index+l[0].length);return a.push(c`${t.slice(r)}`),c`<span>${a}</span>`})}static get styles(){return m`
      .container {
        display: flex;
        flex-direction: row;
        flex-wrap: wrap;
    ...
    `}};s([h({type:Array})],$i.prototype,"snippets",void 0);s([h({type:String})],$i.prototype,"viewSize",void 0);$i=s([A("text-snippet-block")],$i);const pr=c`
...
`;let Ze=class extends F{constructor(){super(...arguments),this.reviewTitle="",this.reviewBody="",this.reviewId="",this.starRating=0,this.viewSize="desktop"}render(){return!this.reviewTitle&&!this.reviewBody&&!this.starRating?y:c`
    ...
    `}get filledStarTemplate(){return c`<span aria-hidden="true">${pr}</span>`}get unfilledStarTemplate(){return c`
      <span class="unfilled-star" aria-hidden="true">
        ${Ts}
      </span>
    `}static get styles(){return[Ge,m`
        .review-container {
          display: flex;
          flex-direction: row;
          flex-wrap: wrap;
      ...
      `]}};s([h({type:String})],Ze.prototype,"identifier",void 0);s([h({type:String})],Ze.prototype,"reviewTitle",void 0);s([h({type:String})],Ze.prototype,"reviewBody",void 0);s([h({type:String})],Ze.prototype,"reviewId",void 0);s([h({type:Number})],Ze.prototype,"starRating",void 0);s([h({type:String})],Ze.prototype,"viewSize",void 0);Ze=s([A("review-block")],Ze);const Ms=m`
  .drop-shadow {
    overflow: hidden;
    height: 100%;
  }
...
`;let We=class extends F{constructor(){super(...arguments),this.isListTile=!1,this.isCompactTile=!1,this.loggedIn=!1,this.isWaveform=!1}render(){return c`
    ...
    `}get imageTemplate(){var e;return((e=this.model)===null||e===void 0?void 0:e.mediatype)==="search"?c`${ur}`:c`
      <img
    ...
    `}get imageSrc(){var e;return this.baseImageUrl&&((e=this.model)===null||e===void 0?void 0:e.identifier)?`${this.baseImageUrl}/services/img/${this.model.identifier}`:y}get hashBasedGradient(){var e;return!((e=this.model)===null||e===void 0)&&e.identifier?`waveform-grad${this.hashStrToInt(this.model.identifier)%6}`:"waveform-grad0"}hashStrToInt(e){return e.split("").reduce((t,i)=>t+i.charCodeAt(0),0)}get itemBaseClass(){var e;return{"drop-shadow":!0,"list-box":this.isListTile,"search-image":((e=this.model)===null||e===void 0?void 0:e.mediatype)==="search",[this.hashBasedGradient]:this.isWaveform}}get itemImageClass(){var e,t,i;const a=((e=this.model)===null||e===void 0?void 0:e.contentWarning)||((t=this.model)===null||t===void 0?void 0:t.loginRequired);return{contain:!this.isCompactTile&&!this.isWaveform,cover:this.isCompactTile,blur:a||!1,waveform:this.isWaveform,"account-image":this.isAccountImage,"collection-image":((i=this.model)===null||i===void 0?void 0:i.mediatype)==="collection"}}get isAccountImage(){var e;return((e=this.model)===null||e===void 0?void 0:e.mediatype)==="account"&&!this.isCompactTile&&!this.isListTile}onLoad(){var e,t;(((e=this.model)===null||e===void 0?void 0:e.mediatype)==="audio"||((t=this.model)===null||t===void 0?void 0:t.mediatype)==="etree")&&this.baseImage.naturalWidth/this.baseImage.naturalHeight===4&&(this.isWaveform=!0)}static get styles(){return[Ms,zs,m`
      ...
      `]}};s([h({type:Object})],We.prototype,"model",void 0);s([h({type:String})],We.prototype,"baseImageUrl",void 0);s([h({type:Boolean})],We.prototype,"isListTile",void 0);s([h({type:Boolean})],We.prototype,"isCompactTile",void 0);s([h({type:Boolean})],We.prototype,"loggedIn",void 0);s([M()],We.prototype,"isWaveform",void 0);s([Q("img")],We.prototype,"baseImage",void 0);We=s([A("item-image")],We);const Es=O`
...
`,Us={account:{color:"#000000",icon:Es,text:"Account"},audio:{color:"#00adef",icon:Ds,text:"Audio"},collection:{color:"#4666ff",icon:dr,text:"Collection"},data:{color:"#333333",icon:Ls,text:"Data"},etree:{color:"#00adef",icon:Ps,text:"E-tree"},film:{color:"#bf1b2c",icon:wo,text:"Film"},image:{color:"#aa99c9",icon:As,text:"Image"},movies:{color:"#f1644b",icon:wo,text:"Movie"},radio:{color:"#8fdaef",icon:Fs,text:"Radio"},software:{color:"#9ecc4f",icon:Bs,text:"Software"},texts:{color:"#faab3c",icon:Is,text:"Text"},tv:{color:"#f1644b",icon:Os,text:"TV"},video:{color:"#f1644b",icon:Rs,text:"Video"},web:{color:"#ffcd27",icon:Ns,text:"Web"},search:{color:"#000000",icon:ur,text:"Search"}};let ti=class extends F{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var e,t;const i=["tvnews","tvarchive","television"],a=["radio","radioprogram"];return this.mediatype==="movies"&&((e=this.collections)===null||e===void 0?void 0:e.some(r=>i.indexOf(r)>=0))?"tv":this.mediatype==="audio"&&((t=this.collections)===null||t===void 0?void 0:t.some(r=>a.indexOf(r)>=0))?"radio":this.mediatype||""}render(){const e=Us[this.displayMediatype];return e?c`
      <div
        id="icon"
    ...
    `}};s([h({type:String})],ti.prototype,"mediatype",void 0);s([h({type:Array})],ti.prototype,"collections",void 0);s([h({type:Boolean})],ti.prototype,"showText",void 0);ti=s([A("mediatype-icon")],ti);const Hs=O`
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path
...
`;function js(o,e){let t=1;return o>=1e9?t=1e9:o>=1e6?t=1e6:o>=1e3&&e==="short"&&(t=1e3),t}function Gs(o=0,e){const t=o/e,i=t<10;let a=0;return i?a=Math.round((t+Number.EPSILON)*10)/10:a=Math.round(t),a}function qs(o,e,t,i){switch(e){case 1e9:return D(t==="short"?pt`${o}B`:pt`${o} billion`);case 1e6:return D(t==="short"?pt`${o}M`:pt`${o} million`);case 1e3:return D(t==="short"?pt`${o}K`:pt`${o} thousand`);default:return new Intl.NumberFormat(i).format(o)}}function Gt(o,e="long",t="short",i="en-US"){const a=o!=null?o:-1;if(a<0)return"";const r=js(a,e),l=Gs(a,r);return qs(l,r,t,i)}let Je=class extends F{render(){var e;const t=Gt(this.favCount,"short","short"),i=Gt(this.commentCount,"short","short"),a=this.mediatype==="account"?`${this.itemCount} uploads`:`${this.viewCount} ${(e=this.viewLabel)!==null&&e!==void 0?e:"all-time views"}`;return c`
      <div class="item-stats">
        ...
        <ul id="stats-row">
          ...
          <li class="col" title="${a}">
            ${this.mediatype==="account"?Vs:Ws}
            <p class="status-text">
              <span class="sr-only">
                ${this.mediatype==="account"?"Uploads:":"Views:"}
              </span>
              ${Gt(this.mediatype==="account"?this.itemCount:this.viewCount,"short","short")}
            </p>
          </li>
    ...
    `}static get styles(){return[Ge,m`
      ...
      `]}};s([h({type:String})],Je.prototype,"mediatype",void 0);s([h({type:Number})],Je.prototype,"itemCount",void 0);s([h({type:Number})],Je.prototype,"viewCount",void 0);s([h({type:String})],Je.prototype,"viewLabel",void 0);s([h({type:Number})],Je.prototype,"favCount",void 0);s([h({type:Number})],Je.prototype,"commentCount",void 0);Je=s([A("tile-stats")],Je);let ua=class extends le{constructor(){super(...arguments),this.showInfoButton=!1}render(){var e,t,i,a,r,l,n;const d=(e=this.model)===null||e===void 0?void 0:e.title,[p,v]=((t=this.sortParam)===null||t===void 0?void 0:t.field)==="week"?[(i=this.model)===null||i===void 0?void 0:i.weeklyViewCount,"weekly views"]:[(a=this.model)===null||a===void 0?void 0:a.viewCount,"all-time views"];return c`
      <div class="container">
        ${this.infoButtonTemplate}
        <div class="tile-details">
          <div class="item-info">
    ...
    `}get sortedDateInfoTemplate(){var e,t,i,a,r;let l,n="long";switch((e=this.sortParam)===null||e===void 0?void 0:e.field){case"date":{const d=(t=this.model)===null||t===void 0?void 0:t.datePublished;l={field:"published",value:d},Aa(d)&&(n="year-only");break}case"reviewdate":l={field:"reviewed",value:(i=this.model)===null||i===void 0?void 0:i.dateReviewed};break;case"addeddate":l={field:"added",value:(a=this.model)===null||a===void 0?void 0:a.dateAdded};break;case"publicdate":l={field:"archived",value:(r=this.model)===null||r===void 0?void 0:r.dateArchived};break}return l!=null&&l.value?c`
      <div class="date-sorted-by truncated">
        <span>
          ${l==null?void 0:l.field} ${ei(l==null?void 0:l.value,n)}
        </span>
      </div>
    ...
    `:y}get reviewBlockTemplate(){var e;if(!(!((e=this.model)===null||e===void 0)&&e.review))return y;const{id:t,title:i,body:a,starRating:r}=this.model.review;return c`
      <review-block
        viewsize="grid"
    ...
    `}get volumeIssueTemplate(){var e,t,i,a;return!(!((e=this.model)===null||e===void 0)&&e.volume)||!(!((t=this.model)===null||t===void 0)&&t.issue)?y:c`
      <div class="volume-issue">
        <span class="truncated" title="volume|issue">
          Volume&nbsp;${(i=this.model)===null||i===void 0?void 0:i.volume}, Issue&nbsp;${(a=this.model)===null||a===void 0?void 0:a.issue}
        </span>
      </div>
    `}get isSortedByDate(){var e;return["date","reviewdate","addeddate","publicdate"].includes((e=this.sortParam)===null||e===void 0?void 0:e.field)}get hasSnippets(){var e,t;return!!(!((t=(e=this.model)===null||e===void 0?void 0:e.snippets)===null||t===void 0)&&t.length)}infoButtonPressed(e){e.preventDefault();const t=new CustomEvent("infoButtonPressed",{detail:{x:e.clientX,y:e.clientY}});this.dispatchEvent(t)}static get styles(){const e=m`var(--tileBorderColor, #dddddd)`;return[Pi,m`
        .container {
          border: 1px solid ${e};
        }
      ...
      `]}};s([h({type:Boolean})],ua.prototype,"showInfoButton",void 0);ua=s([A("item-tile")],ua);let va=class extends le{constructor(){super(...arguments),this.showInfoButton=!1}render(){return c`
      <div class="container">
        ${this.infoButtonTemplate}
        <div class="tile-details">
          <div class="item-info">
    ...
    </div>`}get getTileStatsTemplate(){var e,t,i,a;return c`<tile-stats
    ...
    >
          ...
          &#9432;
          <span class="sr-only">${D("More info")}</span>
        </button>`:y}infoButtonPressed(e){e.preventDefault();const t=new CustomEvent("infoButtonPressed",{detail:{x:e.clientX,y:e.clientY}});this.dispatchEvent(t)}static get styles(){const e=m`var(--tileBorderColor, #dddddd)`;return[Pi,m`
        .container {
          border: 1px solid ${e};
        }
      `]}};s([h({type:Boolean})],va.prototype,"showInfoButton",void 0);va=s([A("account-tile")],va);let ma=class extends le{constructor(){super(...arguments),this.showInfoButton=!1}render(){return c`
      <div class="container">
        <div class="tile-details">
          <div class="item-info">
            ${this.getImageBlockTemplate} ${this.getTitleTemplate}
    ...
    `}get getTitleTemplate(){var e;return c`<div id="title">
      <h4 class="truncated">${(e=this.model)===null||e===void 0?void 0:e.title}</h4>
    </div>`}static get styles(){const e=m`var(--tileBorderColor, #555555)`,t=m`var(--tileBackgroundColor, #666666)`,i=m`#fff`;return[Pi,m`
        .container {
          background-color: ${t};
          border: 1px solid ${e};
        }
      ...
      `]}};s([h({type:Boolean})],ma.prototype,"showInfoButton",void 0);ma=s([A("search-tile")],ma);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*ki(o,e){if(o!==void 0){let t=0;for(const i of o)yield e(i,t++)}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class fa extends li{constructor(e){if(super(e),this.it=y,e.type!==Pe.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===y||e==null)return this.ft=void 0,this.it=e;if(e===we)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this.ft;this.it=e;const t=[e];return t.raw=t,this.ft={_$litType$:this.constructor.resultType,strings:t,values:[]}}}fa.directiveName="unsafeHTML",fa.resultType=1;const Qs=si(fa);/*! @license DOMPurify 2.3.8 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/2.3.8/LICENSE */function ut(o){return ut=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},ut(o)}function ga(o,e){return ga=Object.setPrototypeOf||function(i,a){return i.__proto__=a,i},ga(o,e)}function Ks(){if(typeof Reflect=="undefined"||!Reflect.construct||Reflect.construct.sham)return!1;if(typeof Proxy=="function")return!0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],function(){})),!0}catch{return!1}}function yi(o,e,t){return Ks()?yi=Reflect.construct:yi=function(a,r,l){var n=[null];n.push.apply(n,r);var d=Function.bind.apply(a,n),p=new d;return l&&ga(p,l.prototype),p},yi.apply(null,arguments)}function ke(o){return Ys(o)||Xs(o)||Zs(o)||Js()}function Ys(o){if(Array.isArray(o))return ba(o)}function Xs(o){if(typeof Symbol!="undefined"&&o[Symbol.iterator]!=null||o["@@iterator"]!=null)return Array.from(o)}function Zs(o,e){if(!!o){if(typeof o=="string")return ba(o,e);var t=Object.prototype.toString.call(o).slice(8,-1);if(t==="Object"&&o.constructor&&(t=o.constructor.name),t==="Map"||t==="Set")return Array.from(o);if(t==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t))return ba(o,e)}}function ba(o,e){(e==null||e>o.length)&&(e=o.length);for(var t=0,i=new Array(e);t<e;t++)i[t]=o[t];return i}function Js(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}var el=Object.hasOwnProperty,xo=Object.setPrototypeOf,tl=Object.isFrozen,il=Object.getPrototypeOf,al=Object.getOwnPropertyDescriptor,ge=Object.freeze,Be=Object.seal,ol=Object.create,vr=typeof Reflect!="undefined"&&Reflect,Ti=vr.apply,ya=vr.construct;Ti||(Ti=function(e,t,i){return e.apply(t,i)});ge||(ge=function(e){return e});Be||(Be=function(e){return e});ya||(ya=function(e,t){return yi(e,ke(t))});var rl=Te(Array.prototype.forEach),_o=Te(Array.prototype.pop),Wt=Te(Array.prototype.push),wi=Te(String.prototype.toLowerCase),sl=Te(String.prototype.match),Ke=Te(String.prototype.replace),ll=Te(String.prototype.indexOf),nl=Te(String.prototype.trim),me=Te(RegExp.prototype.test),Xi=dl(TypeError);function Te(o){return function(e){for(var t=arguments.length,i=new Array(t>1?t-1:0),a=1;a<t;a++)i[a-1]=arguments[a];return Ti(o,e,i)}}function dl(o){return function(){for(var e=arguments.length,t=new Array(e),i=0;i<e;i++)t[i]=arguments[i];return ya(o,t)}}function I(o,e){xo&&xo(o,null);for(var t=e.length;t--;){var i=e[t];if(typeof i=="string"){var a=wi(i);a!==i&&(tl(e)||(e[t]=a),i=a)}o[i]=!0}return o}function ht(o){var e=ol(null),t;for(t in o)Ti(el,o,[t])&&(e[t]=o[t]);return e}function vi(o,e){for(;o!==null;){var t=al(o,e);if(t){if(t.get)return Te(t.get);if(typeof t.value=="function")return Te(t.value)}o=il(o)}function i(a){return console.warn("fallback value for",a),null}return i}var Co=ge(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","section","select","shadow","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),Zi=ge(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","filter","font","g","glyph","glyphref","hkern","image","line","lineargradient","marker","mask","metadata","mpath","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),Ji=ge(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),cl=ge(["animate","color-profile","cursor","discard","fedropshadow","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),ea=ge(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover"]),hl=ge(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),So=ge(["#text"]),$o=ge(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","face","for","headers","height","hidden","high","href","hreflang","id","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","pattern","placeholder","playsinline","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","xmlns","slot"]),ta=ge(["accent-height","accumulate","additive","alignment-baseline","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),ko=ge(["accent","accentunder","align","bevelled","close","columnsalign","columnlines","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lspace","lquote","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),mi=ge(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),pl=Be(/\{\{[\w\W]*|[\w\W]*\}\}/gm),ul=Be(/<%[\w\W]*|[\w\W]*%>/gm),vl=Be(/^data-[\-\w.\u00B7-\uFFFF]/),ml=Be(/^aria-[\-\w]+$/),fl=Be(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|cid|xmpp):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),gl=Be(/^(?:\w+script|data):/i),bl=Be(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),yl=Be(/^html$/i),wl=function(){return typeof window=="undefined"?null:window},xl=function(e,t){if(ut(e)!=="object"||typeof e.createPolicy!="function")return null;var i=null,a="data-tt-policy-suffix";t.currentScript&&t.currentScript.hasAttribute(a)&&(i=t.currentScript.getAttribute(a));var r="dompurify"+(i?"#"+i:"");try{return e.createPolicy(r,{createHTML:function(n){return n}})}catch{return console.warn("TrustedTypes policy "+r+" could not be created."),null}};function mr(){var o=arguments.length>0&&arguments[0]!==void 0?arguments[0]:wl(),e=function(u){return mr(u)};if(e.version="2.3.8",e.removed=[],!o||!o.document||o.document.nodeType!==9)return e.isSupported=!1,e;var t=o.document,i=o.document,a=o.DocumentFragment,r=o.HTMLTemplateElement,l=o.Node,n=o.Element,d=o.NodeFilter,p=o.NamedNodeMap,v=p===void 0?o.NamedNodeMap||o.MozNamedAttrMap:p,f=o.HTMLFormElement,b=o.DOMParser,w=o.trustedTypes,S=n.prototype,E=vi(S,"cloneNode"),B=vi(S,"nextSibling"),L=vi(S,"childNodes"),U=vi(S,"parentNode");if(typeof r=="function"){var re=i.createElement("template");re.content&&re.content.ownerDocument&&(i=re.content.ownerDocument)}var K=xl(w,t),ne=K?K.createHTML(""):"",te=i,W=te.implementation,Ee=te.createNodeIterator,gt=te.createDocumentFragment,Ce=te.getElementsByTagName,qe=t.importNode,it={};try{it=ht(i).documentMode?i.documentMode:{}}catch{}var R={};e.isSupported=typeof U=="function"&&W&&typeof W.createHTMLDocument!="undefined"&&it!==9;var ye=pl,Se=ul,It=vl,Ot=ml,Rt=gl,bt=bl,at=fl,Y=null,yt=I({},[].concat(ke(Co),ke(Zi),ke(Ji),ke(ea),ke(So))),ie=null,wt=I({},[].concat(ke($o),ke(ta),ke(ko),ke(mi))),G=Object.seal(Object.create(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),Oe=null,ot=null,xt=!0,rt=!0,_t=!1,De=!1,$e=!1,st=!1,lt=!1,Re=!1,ni=!1,di=!1,Ra=!0,Ai=!0,Nt=!1,Ct={},St=null,Na=I({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","style","svg","template","thead","title","video","xmp"]),Ua=null,Ha=I({},["audio","video","img","source","image","track"]),Fi=null,Va=I({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),Bi="http://www.w3.org/1998/Math/MathML",Ii="http://www.w3.org/2000/svg",Qe="http://www.w3.org/1999/xhtml",ci=Qe,Oi=!1,$t,_r=["application/xhtml+xml","text/html"],Cr="text/html",nt,kt=null,Sr=i.createElement("form"),Wa=function(u){return u instanceof RegExp||u instanceof Function},Ri=function(u){kt&&kt===u||((!u||ut(u)!=="object")&&(u={}),u=ht(u),Y="ALLOWED_TAGS"in u?I({},u.ALLOWED_TAGS):yt,ie="ALLOWED_ATTR"in u?I({},u.ALLOWED_ATTR):wt,Fi="ADD_URI_SAFE_ATTR"in u?I(ht(Va),u.ADD_URI_SAFE_ATTR):Va,Ua="ADD_DATA_URI_TAGS"in u?I(ht(Ha),u.ADD_DATA_URI_TAGS):Ha,St="FORBID_CONTENTS"in u?I({},u.FORBID_CONTENTS):Na,Oe="FORBID_TAGS"in u?I({},u.FORBID_TAGS):{},ot="FORBID_ATTR"in u?I({},u.FORBID_ATTR):{},Ct="USE_PROFILES"in u?u.USE_PROFILES:!1,xt=u.ALLOW_ARIA_ATTR!==!1,rt=u.ALLOW_DATA_ATTR!==!1,_t=u.ALLOW_UNKNOWN_PROTOCOLS||!1,De=u.SAFE_FOR_TEMPLATES||!1,$e=u.WHOLE_DOCUMENT||!1,Re=u.RETURN_DOM||!1,ni=u.RETURN_DOM_FRAGMENT||!1,di=u.RETURN_TRUSTED_TYPE||!1,lt=u.FORCE_BODY||!1,Ra=u.SANITIZE_DOM!==!1,Ai=u.KEEP_CONTENT!==!1,Nt=u.IN_PLACE||!1,at=u.ALLOWED_URI_REGEXP||at,ci=u.NAMESPACE||Qe,u.CUSTOM_ELEMENT_HANDLING&&Wa(u.CUSTOM_ELEMENT_HANDLING.tagNameCheck)&&(G.tagNameCheck=u.CUSTOM_ELEMENT_HANDLING.tagNameCheck),u.CUSTOM_ELEMENT_HANDLING&&Wa(u.CUSTOM_ELEMENT_HANDLING.attributeNameCheck)&&(G.attributeNameCheck=u.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),u.CUSTOM_ELEMENT_HANDLING&&typeof u.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements=="boolean"&&(G.allowCustomizedBuiltInElements=u.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements),$t=_r.indexOf(u.PARSER_MEDIA_TYPE)===-1?$t=Cr:$t=u.PARSER_MEDIA_TYPE,nt=$t==="application/xhtml+xml"?function(x){return x}:wi,De&&(rt=!1),ni&&(Re=!0),Ct&&(Y=I({},ke(So)),ie=[],Ct.html===!0&&(I(Y,Co),I(ie,$o)),Ct.svg===!0&&(I(Y,Zi),I(ie,ta),I(ie,mi)),Ct.svgFilters===!0&&(I(Y,Ji),I(ie,ta),I(ie,mi)),Ct.mathMl===!0&&(I(Y,ea),I(ie,ko),I(ie,mi))),u.ADD_TAGS&&(Y===yt&&(Y=ht(Y)),I(Y,u.ADD_TAGS)),u.ADD_ATTR&&(ie===wt&&(ie=ht(ie)),I(ie,u.ADD_ATTR)),u.ADD_URI_SAFE_ATTR&&I(Fi,u.ADD_URI_SAFE_ATTR),u.FORBID_CONTENTS&&(St===Na&&(St=ht(St)),I(St,u.FORBID_CONTENTS)),Ai&&(Y["#text"]=!0),$e&&I(Y,["html","head","body"]),Y.table&&(I(Y,["tbody"]),delete Oe.tbody),ge&&ge(u),kt=u)},ja=I({},["mi","mo","mn","ms","mtext"]),Ga=I({},["foreignobject","desc","title","annotation-xml"]),$r=I({},["title","style","font","a","script"]),hi=I({},Zi);I(hi,Ji),I(hi,cl);var Ni=I({},ea);I(Ni,hl);var kr=function(u){var x=U(u);(!x||!x.tagName)&&(x={namespaceURI:Qe,tagName:"template"});var C=wi(u.tagName),H=wi(x.tagName);return u.namespaceURI===Ii?x.namespaceURI===Qe?C==="svg":x.namespaceURI===Bi?C==="svg"&&(H==="annotation-xml"||ja[H]):Boolean(hi[C]):u.namespaceURI===Bi?x.namespaceURI===Qe?C==="math":x.namespaceURI===Ii?C==="math"&&Ga[H]:Boolean(Ni[C]):u.namespaceURI===Qe?x.namespaceURI===Ii&&!Ga[H]||x.namespaceURI===Bi&&!ja[H]?!1:!Ni[C]&&($r[C]||!hi[C]):!1},Ne=function(u){Wt(e.removed,{element:u});try{u.parentNode.removeChild(u)}catch{try{u.outerHTML=ne}catch{u.remove()}}},qa=function(u,x){try{Wt(e.removed,{attribute:x.getAttributeNode(u),from:x})}catch{Wt(e.removed,{attribute:null,from:x})}if(x.removeAttribute(u),u==="is"&&!ie[u])if(Re||ni)try{Ne(x)}catch{}else try{x.setAttribute(u,"")}catch{}},Qa=function(u){var x,C;if(lt)u="<remove></remove>"+u;else{var H=sl(u,/^[\r\n\t ]+/);C=H&&H[0]}$t==="application/xhtml+xml"&&(u='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+u+"</body></html>");var be=K?K.createHTML(u):u;if(ci===Qe)try{x=new b().parseFromString(be,$t)}catch{}if(!x||!x.documentElement){x=W.createDocument(ci,"template",null);try{x.documentElement.innerHTML=Oi?"":be}catch{}}var he=x.body||x.documentElement;return u&&C&&he.insertBefore(i.createTextNode(C),he.childNodes[0]||null),ci===Qe?Ce.call(x,$e?"html":"body")[0]:$e?x.documentElement:he},Ka=function(u){return Ee.call(u.ownerDocument||u,u,d.SHOW_ELEMENT|d.SHOW_COMMENT|d.SHOW_TEXT,null,!1)},Tr=function(u){return u instanceof f&&(typeof u.nodeName!="string"||typeof u.textContent!="string"||typeof u.removeChild!="function"||!(u.attributes instanceof v)||typeof u.removeAttribute!="function"||typeof u.setAttribute!="function"||typeof u.namespaceURI!="string"||typeof u.insertBefore!="function")},Ut=function(u){return ut(l)==="object"?u instanceof l:u&&ut(u)==="object"&&typeof u.nodeType=="number"&&typeof u.nodeName=="string"},Ue=function(u,x,C){!R[u]||rl(R[u],function(H){H.call(e,x,C,kt)})},Ya=function(u){var x;if(Ue("beforeSanitizeElements",u,null),Tr(u)||me(/[\u0080-\uFFFF]/,u.nodeName))return Ne(u),!0;var C=nt(u.nodeName);if(Ue("uponSanitizeElement",u,{tagName:C,allowedTags:Y}),u.hasChildNodes()&&!Ut(u.firstElementChild)&&(!Ut(u.content)||!Ut(u.content.firstElementChild))&&me(/<[/\w]/g,u.innerHTML)&&me(/<[/\w]/g,u.textContent)||C==="select"&&me(/<template/i,u.innerHTML))return Ne(u),!0;if(!Y[C]||Oe[C]){if(!Oe[C]&&Za(C)&&(G.tagNameCheck instanceof RegExp&&me(G.tagNameCheck,C)||G.tagNameCheck instanceof Function&&G.tagNameCheck(C)))return!1;if(Ai&&!St[C]){var H=U(u)||u.parentNode,be=L(u)||u.childNodes;if(be&&H)for(var he=be.length,ce=he-1;ce>=0;--ce)H.insertBefore(E(be[ce],!0),B(u))}return Ne(u),!0}return u instanceof n&&!kr(u)||(C==="noscript"||C==="noembed")&&me(/<\/no(script|embed)/i,u.innerHTML)?(Ne(u),!0):(De&&u.nodeType===3&&(x=u.textContent,x=Ke(x,ye," "),x=Ke(x,Se," "),u.textContent!==x&&(Wt(e.removed,{element:u.cloneNode()}),u.textContent=x)),Ue("afterSanitizeElements",u,null),!1)},Xa=function(u,x,C){if(Ra&&(x==="id"||x==="name")&&(C in i||C in Sr))return!1;if(!(rt&&!ot[x]&&me(It,x))){if(!(xt&&me(Ot,x))){if(!ie[x]||ot[x]){if(!(Za(u)&&(G.tagNameCheck instanceof RegExp&&me(G.tagNameCheck,u)||G.tagNameCheck instanceof Function&&G.tagNameCheck(u))&&(G.attributeNameCheck instanceof RegExp&&me(G.attributeNameCheck,x)||G.attributeNameCheck instanceof Function&&G.attributeNameCheck(x))||x==="is"&&G.allowCustomizedBuiltInElements&&(G.tagNameCheck instanceof RegExp&&me(G.tagNameCheck,C)||G.tagNameCheck instanceof Function&&G.tagNameCheck(C))))return!1}else if(!Fi[x]){if(!me(at,Ke(C,bt,""))){if(!((x==="src"||x==="xlink:href"||x==="href")&&u!=="script"&&ll(C,"data:")===0&&Ua[u])){if(!(_t&&!me(Rt,Ke(C,bt,"")))){if(C)return!1}}}}}}return!0},Za=function(u){return u.indexOf("-")>0},Ja=function(u){var x,C,H,be;Ue("beforeSanitizeAttributes",u,null);var he=u.attributes;if(!!he){var ce={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:ie};for(be=he.length;be--;){x=he[be];var pi=x,ue=pi.name,eo=pi.namespaceURI;if(C=ue==="value"?x.value:nl(x.value),H=nt(ue),ce.attrName=H,ce.attrValue=C,ce.keepAttr=!0,ce.forceKeepAttr=void 0,Ue("uponSanitizeAttribute",u,ce),C=ce.attrValue,!ce.forceKeepAttr&&(qa(ue,u),!!ce.keepAttr)){if(me(/\/>/i,C)){qa(ue,u);continue}De&&(C=Ke(C,ye," "),C=Ke(C,Se," "));var zr=nt(u.nodeName);if(!!Xa(zr,H,C))try{eo?u.setAttributeNS(eo,ue,C):u.setAttribute(ue,C),_o(e.removed)}catch{}}}Ue("afterSanitizeAttributes",u,null)}},Mr=function T(u){var x,C=Ka(u);for(Ue("beforeSanitizeShadowDOM",u,null);x=C.nextNode();)Ue("uponSanitizeShadowNode",x,null),!Ya(x)&&(x.content instanceof a&&T(x.content),Ja(x));Ue("afterSanitizeShadowDOM",u,null)};return e.sanitize=function(T,u){var x,C,H,be,he;if(Oi=!T,Oi&&(T="<!-->"),typeof T!="string"&&!Ut(T)){if(typeof T.toString!="function")throw Xi("toString is not a function");if(T=T.toString(),typeof T!="string")throw Xi("dirty is not a string, aborting")}if(!e.isSupported){if(ut(o.toStaticHTML)==="object"||typeof o.toStaticHTML=="function"){if(typeof T=="string")return o.toStaticHTML(T);if(Ut(T))return o.toStaticHTML(T.outerHTML)}return T}if(st||Ri(u),e.removed=[],typeof T=="string"&&(Nt=!1),Nt){if(T.nodeName){var ce=nt(T.nodeName);if(!Y[ce]||Oe[ce])throw Xi("root node is forbidden and cannot be sanitized in-place")}}else if(T instanceof l)x=Qa("<!---->"),C=x.ownerDocument.importNode(T,!0),C.nodeType===1&&C.nodeName==="BODY"||C.nodeName==="HTML"?x=C:x.appendChild(C);else{if(!Re&&!De&&!$e&&T.indexOf("<")===-1)return K&&di?K.createHTML(T):T;if(x=Qa(T),!x)return Re?null:di?ne:""}x&&lt&&Ne(x.firstChild);for(var pi=Ka(Nt?T:x);H=pi.nextNode();)H.nodeType===3&&H===be||Ya(H)||(H.content instanceof a&&Mr(H.content),Ja(H),be=H);if(be=null,Nt)return T;if(Re){if(ni)for(he=gt.call(x.ownerDocument);x.firstChild;)he.appendChild(x.firstChild);else he=x;return ie.shadowroot&&(he=qe.call(t,he,!0)),he}var ue=$e?x.outerHTML:x.innerHTML;return $e&&Y["!doctype"]&&x.ownerDocument&&x.ownerDocument.doctype&&x.ownerDocument.doctype.name&&me(yl,x.ownerDocument.doctype.name)&&(ue="<!DOCTYPE "+x.ownerDocument.doctype.name+`>
`+ue),De&&(ue=Ke(ue,ye," "),ue=Ke(ue,Se," ")),K&&di?K.createHTML(ue):ue},e.setConfig=function(T){Ri(T),st=!0},e.clearConfig=function(){kt=null,st=!1},e.isValidAttribute=function(T,u,x){kt||Ri({});var C=nt(T),H=nt(u);return Xa(C,H,x)},e.addHook=function(T,u){typeof u=="function"&&(R[T]=R[T]||[],Wt(R[T],u))},e.removeHook=function(T){if(R[T])return _o(R[T])},e.removeHooks=function(T){R[T]&&(R[T]=[])},e.removeAllHooks=function(){R={}},e}var xi=mr(),_;(function(o){o.default="default",o.unrecognized="unrecognized",o.relevance="relevance",o.alltimeview="alltimeview",o.weeklyview="weeklyview",o.title="title",o.date="date",o.datearchived="datearchived",o.datereviewed="datereviewed",o.dateadded="dateadded",o.datefavorited="datefavorited",o.creator="creator"})(_||(_={}));const fe={[_.default]:{field:_.default,defaultSortDirection:null,canSetDirection:!1,shownInSortBar:!1,shownInURL:!1,handledBySearchService:!1,displayName:"",urlNames:["",null,void 0]},[_.unrecognized]:{field:_.unrecognized,defaultSortDirection:null,canSetDirection:!0,shownInSortBar:!1,shownInURL:!1,handledBySearchService:!0,displayName:"",urlNames:[]},[_.relevance]:{field:_.relevance,defaultSortDirection:null,canSetDirection:!1,shownInSortBar:!0,shownInURL:!1,handledBySearchService:!1,displayName:"Relevance",urlNames:["_score"]},[_.alltimeview]:{field:_.alltimeview,defaultSortDirection:"desc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"downloads",displayName:"All-time views",urlNames:["downloads"]},[_.weeklyview]:{field:_.weeklyview,defaultSortDirection:"desc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"week",displayName:"Weekly views",urlNames:["week"]},[_.title]:{field:_.title,defaultSortDirection:"asc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"titleSorter",displayName:"Title",urlNames:["title","titleSorter"]},[_.date]:{field:_.date,defaultSortDirection:"desc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"date",displayName:"Date published",urlNames:["date"]},[_.datearchived]:{field:_.datearchived,defaultSortDirection:"desc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"publicdate",displayName:"Date archived",urlNames:["publicdate"]},[_.datereviewed]:{field:_.datereviewed,defaultSortDirection:"desc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"reviewdate",displayName:"Date reviewed",urlNames:["reviewdate"]},[_.dateadded]:{field:_.dateadded,defaultSortDirection:"desc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"addeddate",displayName:"Date added",urlNames:["addeddate"]},[_.datefavorited]:{field:_.datefavorited,defaultSortDirection:"desc",canSetDirection:!1,shownInSortBar:!0,shownInURL:!1,handledBySearchService:!1,searchServiceKey:"favoritedate",displayName:"Date favorited",urlNames:["favoritedate"]},[_.creator]:{field:_.creator,defaultSortDirection:"asc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"creatorSorter",displayName:"Creator",urlNames:["creator","creatorSorter"]}};function fr(o){var e;return(e=Object.values(fe).find(t=>t.urlNames.some(i=>o===i)))!==null&&e!==void 0?e:fe[_.unrecognized]}const _l={title:"firstTitle",creator:"firstCreator"},ii=()=>({subject:{},lending:{},mediatype:{},language:{},creator:{},collection:{},year:{}}),Cl=["mediatype","lending","year","subject","collection","creator","language"],Mi={subject:"Subject",lending:"Availability",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"},wa={subject:J.COUNT,lending:J.COUNT,mediatype:J.COUNT,language:J.COUNT,creator:J.COUNT,collection:J.COUNT,year:J.NUMERIC},Sl={subject:J.ALPHABETICAL,lending:J.ALPHABETICAL,mediatype:J.ALPHABETICAL,language:J.ALPHABETICAL,creator:J.ALPHABETICAL,collection:J.ALPHABETICAL,year:J.NUMERIC},$l={is_lendable:!0,is_borrowable:!1,available_to_borrow:!0,is_browsable:!1,available_to_browse:!1,is_readable:!0,available_to_waitlist:!1},To={is_lendable:"Lending Library",available_to_borrow:"Borrow 14 Days",is_readable:"Always Available"},Fa={deemphasize:!0,community:!0,stream_only:!0,samples_only:!0,test_collection:!0,printdisabled:!0,"openlibrary-ol":!0,nationalemergencylibrary:!0,china:!0,americana:!0,toronto:!0};let zi=class extends le{constructor(){super(...arguments),this.collectionLinks=[]}render(){return c`
    ...
    `:y}get volumeTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.volume,D("Volume"))}get issueTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.issue,D("Issue"))}get creatorTemplate(){var e,t,i;return((e=this.model)===null||e===void 0?void 0:e.mediatype)==="account"?c`
      ...
      <div id="creator" class="metadata">
        ...
        ${bi(ki(this.model.creators,a=>this.searchLink("creator",a)),", ")}
      </div>
    `}get datePublishedTemplate(){var e;const t=(e=this.model)===null||e===void 0?void 0:e.datePublished;let i="long";return Aa(t)&&(i="year-only"),this.metadataTemplate(ei(t,i),D("Published"))}get dateSortByTemplate(){return this.sortParam&&(this.sortParam.field==="addeddate"||this.sortParam.field==="reviewdate"||this.sortParam.field==="publicdate")?this.metadataTemplate(ei(this.date,"long"),this.displayValueProvider.dateLabel):y}get viewsTemplate(){var e,t,i,a;const r=((e=this.sortParam)===null||e===void 0?void 0:e.field)==="week"?(t=this.model)===null||t===void 0?void 0:t.weeklyViewCount:(i=this.model)===null||i===void 0?void 0:i.viewCount;return((a=this.model)===null||a===void 0?void 0:a.mediatype)==="search"?this.metadataTemplate("(Favorited search query)",""):this.metadataTemplate(`${Gt(r!=null?r:0,this.formatSize)}`,D("Views"))}get ratingTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.averageRating,D("Avg Rating"))}get reviewsTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.commentCount,D("Reviews"))}get topicsTemplate(){var e;return!(!((e=this.model)===null||e===void 0)&&e.subjects)||this.model.subjects.length===0?y:c`
      <div id="topics" class="metadata">
        ${this.labelTemplate(D("Topics"))}
        ${bi(ki(this.model.subjects,t=>this.searchLink("subject",t)),", ")}
      </div>
    ...
    `}get descriptionTemplate(){var e,t,i;return this.metadataTemplate(Qs(xi.sanitize((i=(t=(e=this.model)===null||e===void 0?void 0:e.description)===null||t===void 0?void 0:t.replace(/\n/g," "))!==null&&i!==void 0?i:"")),"","description")}get textSnippetsTemplate(){var e;return this.hasSnippets?c`<text-snippet-block
      viewsize="list"
      .snippets=${(e=this.model)===null||e===void 0?void 0:e.snippets}
    ></text-snippet-block>`:y}get reviewBlockTemplate(){var e;if(!(!((e=this.model)===null||e===void 0)&&e.review))return y;const{id:t,title:i,body:a,starRating:r}=this.model.review;return c`
      <review-block
        viewsize="list"
        .identifier=${this.model.identifier}
        .reviewId=${t}
    ...
    `}get hasSnippets(){var e,t;return!!(!((t=(e=this.model)===null||e===void 0?void 0:e.snippets)===null||t===void 0)&&t.length)}metadataTemplate(e,t="",i){return e?c`
      <div id=${Pa(i)} class="metadata">
    ...
    >
      ${xi.sanitize(t)}</a
    >`}detailsLink(e,t,i=!1){const a=t!=null?t:e,r=this.displayValueProvider.itemPageUrl(e,i);return c`<a href=${r}> ${xi.sanitize(a)} </a>`}get mediatypeURL(){var e;if(this.baseNavigationUrl===void 0||!(!((e=this.model)===null||e===void 0)&&e.mediatype))return y;switch(this.model.mediatype){case"collection":return`${this.baseNavigationUrl}/search?query=mediatype:collection&sort=-downloads`;case"account":return y;default:return this.displayValueProvider.itemPageUrl(this.model.mediatype,!0)}}updated(e){e.has("model")&&this.fetchCollectionNames()}async fetchCollectionNames(){var e,t;if(!(!((e=this.model)===null||e===void 0)&&e.collections)||this.model.collections.length===0||!this.collectionNameCache)return;this.collectionLinks=[];const i=[],a=[];for(const r of this.model.collections)!Fa[r]&&!r.startsWith("fav-")&&a.push((t=this.collectionNameCache)===null||t===void 0?void 0:t.collectionNameFor(r).then(l=>{i.push(this.detailsLink(r,l!=null?l:r,!0))}));await Promise.all(a),this.collectionLinks=i}get date(){var e,t,i,a,r;switch((e=this.sortParam)===null||e===void 0?void 0:e.field){case"date":return(t=this.model)===null||t===void 0?void 0:t.datePublished;case"reviewdate":return(i=this.model)===null||i===void 0?void 0:i.dateReviewed;case"addeddate":return(a=this.model)===null||a===void 0?void 0:a.dateAdded;default:return(r=this.model)===null||r===void 0?void 0:r.dateArchived}}get classSize(){return this.mobileBreakpoint&&this.currentWidth&&this.currentWidth<this.mobileBreakpoint?"mobile":"desktop"}get formatSize(){return this.mobileBreakpoint&&this.currentWidth&&this.currentWidth<this.mobileBreakpoint?"short":"long"}static get styles(){return m`
      html {
        font-size: unset;
      }
    ...
    `}};s([h({type:Object})],zi.prototype,"collectionNameCache",void 0);s([M()],zi.prototype,"collectionLinks",void 0);zi=s([A("tile-list")],zi);let et=class extends F{constructor(){super(...arguments),this.loggedIn=!1}render(){return c`
      <div id="container">
        <tile-list
          .model=${this.model}
    ...
    `}};s([h({type:Object})],et.prototype,"model",void 0);s([h({type:String})],et.prototype,"baseNavigationUrl",void 0);s([h({type:String})],et.prototype,"baseImageUrl",void 0);s([h({type:Boolean})],et.prototype,"loggedIn",void 0);s([h({type:Object})],et.prototype,"sortParam",void 0);s([h({type:Object})],et.prototype,"collectionNameCache",void 0);et=s([A("tile-hover-pane")],et);let Mo=class extends le{render(){var e,t,i,a,r,l;return c`
      <div id="list-line" class="${this.classSize}">
        <image-block
          .model=${this.model}
          .baseImageUrl=${this.baseImageUrl}
        ...
        <div id="date">${ei(this.date,this.dateFormatSize)}</div>
        <div id="icon">
          <mediatype-icon
        ...
        <div id="views">${Gt((l=this.views)!==null&&l!==void 0?l:0,this.formatSize)}</div>
      </div>
    `}get href(){var e;return!(!((e=this.model)===null||e===void 0)&&e.identifier)||this.baseNavigationUrl==null?y:this.model.href?`${this.baseNavigationUrl}${this.model.href}`:this.displayValueProvider.itemPageUrl(this.model.identifier,this.model.mediatype==="collection")}get creator(){var e;return(e=this.displayValueProvider.firstCreatorMatchingFilter)!==null&&e!==void 0?e:y}get date(){var e,t,i,a,r;switch((e=this.sortParam)===null||e===void 0?void 0:e.field){case"publicdate":return(t=this.model)===null||t===void 0?void 0:t.dateArchived;case"reviewdate":return(i=this.model)===null||i===void 0?void 0:i.dateReviewed;case"addeddate":return(a=this.model)===null||a===void 0?void 0:a.dateAdded;default:return(r=this.model)===null||r===void 0?void 0:r.datePublished}}get views(){var e,t,i;return((e=this.sortParam)===null||e===void 0?void 0:e.field)==="week"?(t=this.model)===null||t===void 0?void 0:t.weeklyViewCount:(i=this.model)===null||i===void 0?void 0:i.viewCount}get classSize(){return this.mobileBreakpoint&&this.currentWidth&&this.currentWidth<this.mobileBreakpoint?"mobile":"desktop"}get dateFormatSize(){var e,t;return(!this.isSortedByDate||((e=this.sortParam)===null||e===void 0?void 0:e.field)==="date")&&Aa((t=this.model)===null||t===void 0?void 0:t.datePublished)?"year-only":this.formatSize}get formatSize(){return this.mobileBreakpoint&&this.currentWidth&&this.currentWidth<this.mobileBreakpoint?"short":"long"}get isSortedByDate(){var e;return["date","reviewdate","addeddate","publicdate"].includes((e=this.sortParam)===null||e===void 0?void 0:e.field)}static get styles(){return m`
      html {
        font-size: unset;
      }
    ...
    `}};Mo=s([A("tile-list-compact")],Mo);let zo=class extends le{render(){return c`
    ...
    `}get linkTileTemplate(){var e,t,i;return c`
      <a
        ...
        title=${this.shouldPrepareHoverPane?y:Pa((i=this.model)===null||i===void 0?void 0:i.title)}
        @click=${this.handleLinkClicked}
        @contextmenu=${this.handleLinkContextMenu}
      >
        ${this.tile}
      </a>
    `}get linkTileHref(){var e,t;if(!(!((e=this.model)===null||e===void 0)&&e.identifier)||this.baseNavigationUrl==null)return y;let i="";return!((t=this.model.review)===null||t===void 0)&&t.id&&(i=`#review-${this.model.review.id}`),this.model.href?`${this.baseNavigationUrl}${this.model.href}${i}`:this.displayValueProvider.itemPageUrl(this.model.identifier,this.model.mediatype==="collection",i)}get manageCheckTemplate(){var e;return!this.isManageView||this.tileDisplayMode!=="grid"?y:c`
    ...
    `}get shouldPrepareHoverPane(){var e;return this.enableHoverPane&&!!this.tileDisplayMode&&xa.HOVER_PANE_DISPLAY_MODES[this.tileDisplayMode]&&((e=this.model)===null||e===void 0?void 0:e.mediatype)!=="search"}get isHoverEnabled(){return window.matchMedia("(hover: hover)").matches}getHoverPane(){return this.hoverPane}getHoverPaneProps(){return this}handleResize(e){this.currentWidth=e.contentRect.width,this.currentHeight=e.contentRect.height}disconnectedCallback(){this.stopResizeObservation(this.resizeObserver)}stopResizeObservation(e){e==null||e.removeObserver({handler:this,target:this.container})}startResizeObservation(){var e;this.stopResizeObservation(this.resizeObserver),(e=this.resizeObserver)===null||e===void 0||e.addObserver({handler:this,target:this.container})}updated(e){if(e.has("resizeObserver")){const t=e.get("resizeObserver");this.stopResizeObservation(t),this.startResizeObservation()}}handleLinkClicked(e){this.isManageView&&(e.preventDefault(),this.model&&(this.model.checked=!this.model.checked)),this.dispatchEvent(new CustomEvent("resultSelected",{detail:this.model}))}handleLinkContextMenu(e){this.isManageView&&this.linkTileHref!==y&&(e.preventDefault(),window.open(this.linkTileHref,"_blank"))}tileInfoButtonPressed(e){var t;(t=this.hoverPaneController)===null||t===void 0||t.toggleHoverPane({coords:e.detail,enableTouchBackdrop:!0})}get tile(){const{model:e,collectionPagePath:t,baseNavigationUrl:i,currentWidth:a,currentHeight:r,sortParam:l,creatorFilter:n,mobileBreakpoint:d,defaultSortParam:p}=this;if(!e)return y;switch(this.tileDisplayMode){case"grid":switch(e.mediatype){case"collection":return c`<collection-tile
              .model=${e}
    ...
    `}};Me.HOVER_PANE_DISPLAY_MODES={grid:!0,"list-compact":!0,"list-detail":!1,"list-header":!1};s([h({type:String})],Me.prototype,"tileDisplayMode",void 0);s([h({type:Boolean})],Me.prototype,"isManageView",void 0);s([h({type:Object})],Me.prototype,"resizeObserver",void 0);s([h({type:Object})],Me.prototype,"collectionNameCache",void 0);s([h({type:Boolean})],Me.prototype,"enableHoverPane",void 0);s([h({type:String})],Me.prototype,"manageCheckTitle",void 0);s([Q("#container")],Me.prototype,"container",void 0);s([Q("tile-hover-pane")],Me.prototype,"hoverPane",void 0);Me=xa=s([A("tile-dispatcher")],Me);let Do=class extends F{render(){return c` <div id="container"></div> `}static get styles(){return m`
      :host {
        display: block;
        height: 100%;
      }
    ...
    `}};Do=s([A("collection-browser-loading-tile")],Do);let _e=class extends F{constructor(){super(...arguments),this.open=!1,this.displayCaret=!1,this.closeOnSelect=!1,this.openViaButton=!0,this.openViaCaret=!0,this.includeSelectedOption=!1,this.selectedOption="",this.options=[],this.optionGroup="options",this.optionSelected=()=>{},this.handlingCaretClick=!1}renderOption(e){const{label:t,url:i=void 0,id:a}=e;let r;const l=this.selectedOption===a?"selected":"";return i?r=c`<a
        href=${i}
      ...
      >
        ${t}
      </button>`,c`<li class=${l}>${r}</li>`}optionClicked(e){var t;this.selectedOption!==e.id&&(this.selectedOption=e.id,this.dispatchEvent(new CustomEvent("optionSelected",{detail:{option:e}})),(t=e.selectedHandler)===null||t===void 0||t.call(e,e)),this.closeOnSelect&&(this.open=!1)}toggleOptions(){this.open=!this.open}mainButtonClicked(){if(this.handlingCaretClick){this.handlingCaretClick=!1;return}this.openViaButton&&this.toggleOptions()}caretInteracted(){this.openViaCaret&&this.toggleOptions()}caretClicked(){this.handlingCaretClick=!0,this.caretInteracted()}caretKeyDown(e){(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),this.caretInteracted())}get caret(){return this.open?this.caretUp:this.caretDown}get dropdownState(){return this.open?"open":"closed"}get caretUp(){return O`<svg class="caret-up-svg" viewBox="0 0 8 4" xmlns="http://www.w3.org/2000/svg">
    <path d="m6.7226499 3.51689722c.22976435.15317623.54019902.0910893.69337525-.13867505.13615665-.20423497.10222882-.47220946-.06836249-.63681849l-.07031256-.05655675-3.2773501-2.18490007-3.2773501 2.18490007c-.22976434.15317623-.29185128.4636109-.13867505.69337524.13615665.20423498.39656688.27598409.61412572.18182636l.07924953-.04315131 2.7226499-1.81402514z"
      fill=""></path>
  </svg>`}get caretDown(){return O`<svg class="caret-down-svg" viewBox="0 0 8 4" xmlns="http://www.w3.org/2000/svg">
    <path d="m6.7226499.58397485c.22976435-.15317623.54019902-.09108929.69337525.13867505.13615665.20423498.10222882.47220947-.06836249.63681849l-.07031256.05655676-3.2773501 2.18490006-3.2773501-2.18490006c-.22976434-.15317623-.29185128-.4636109-.13867505-.69337525.13615665-.20423497.39656688-.27598409.61412572-.18182636l.07924953.04315131 2.7226499 1.81402515z"
    fill=""></path>
  </svg>`}get availableOptions(){return this.includeSelectedOption?this.options:this.options.filter(e=>this.selectedOption!==e.id)}render(){return c`
    ...
    `}static get styles(){const e=m`var(--dropdownBorderWidth, 1px)`,t=m`var(--dropdownBorderRadius, 4px)`,i=m`var(--dropdownBorderColor, #fff)`,a=m`var(--dropdownBgColor, #333)`,r=m`var(--dropdownTextColor, #fff)`,l=m`var(--dropdownHoverBgColor, rgba(255, 255, 255, 0.3))`,n=m`var(--dropdownSelectedBgColor, #fff)`;return m`
      :host {
        display: inline;
        color: ${r};
      }
    ...
    `}};s([h({type:Boolean,attribute:!0})],_e.prototype,"open",void 0);s([h({type:Boolean,attribute:!0})],_e.prototype,"displayCaret",void 0);s([h({type:Boolean,attribute:!0})],_e.prototype,"closeOnSelect",void 0);s([h({type:Boolean,attribute:!0})],_e.prototype,"openViaButton",void 0);s([h({type:Boolean,attribute:!0})],_e.prototype,"openViaCaret",void 0);s([h({type:Boolean,attribute:!0})],_e.prototype,"includeSelectedOption",void 0);s([h({type:String,attribute:!0})],_e.prototype,"selectedOption",void 0);s([h({type:Array})],_e.prototype,"options",void 0);s([h({type:String})],_e.prototype,"optionGroup",void 0);s([h({type:Function})],_e.prototype,"optionSelected",void 0);_e=s([A("ia-dropdown")],_e);let _a=class extends F{render(){return c`
  ...
  `;_a=s([A("ia-icon-label")],_a);let Ca=class extends F{constructor(){super(...arguments),this.numResults=0}render(){return c`
    ...
    `}};s([h({type:Number})],Ca.prototype,"numResults",void 0);Ca=s([A("alpha-bar-tooltip")],Ca);let je=class extends F{constructor(){super(...arguments),this.selectedLetter=null,this.tooltipShown=!1,this.alphabet="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("")}get selectedUppercaseLetter(){var e;return(e=this.selectedLetter)===null||e===void 0?void 0:e.toUpperCase()}render(){var e;return c`
    ...
    `}letterButtonTemplate(e){var t,i,a;const r=`${e}: ${(i=(t=this.letterCounts)===null||t===void 0?void 0:t[e])!==null&&i!==void 0?i:0} results`;return c`
      <button
        aria-label=${r}
        ?disabled=${!(!((a=this.letterCounts)===null||a===void 0)&&a[e])}
    ...
    `}tooltipTemplate(e){var t,i;return this.hoveredLetter!==e?y:this.tooltipShown?c`<alpha-bar-tooltip
        ...
        ></alpha-bar-tooltip>`:y}letterClicked(e){e===this.selectedUppercaseLetter?this.selectedLetter=null:this.selectedLetter=e,this.dispatchEvent(new CustomEvent("letterChanged",{detail:{selectedLetter:this.selectedUppercaseLetter}}))}async handleMouseMove(e){var t,i;const a=e.target;if(a&&!this.tooltipShown){const r=(i=(t=a.textContent)===null||t===void 0?void 0:t.trim())!==null&&i!==void 0?i:void 0;this.tooltipShown=!0,this.hoveredLetter=r,await this.updateComplete,await new Promise(l=>{setTimeout(l,0)}),this.tooltip&&this.tooltip.dataset.letter===r&&this.positionTooltip(a)}}handleMouseLeave(){this.tooltipShown=!1,this.hoveredLetter=void 0}positionTooltip(e){if(!this.tooltip)return;const t=this.tooltip.clientWidth;let a=e.clientWidth/2-t/2;const r=getComputedStyle(document.body),l=parseFloat(r.getPropertyValue("margin-left")),n=parseFloat(r.getPropertyValue("margin-right")),d=document.body.clientWidth+l+n,v=e.getBoundingClientRect().left+a,f=v+t,b=1;let w;v<b?w=v-b:f>d-b&&(w=f-d+b),w&&(a-=w,this.tooltip.style.setProperty("--tooltipArrowOffset",`${w}px`)),this.tooltip.style.left=`${a}px`,this.tooltip.classList.add("fade-in")}};je.styles=m`
    h1 {
      font-size: 1.2rem;
    }
  ...
  `;s([h({type:String})],je.prototype,"selectedLetter",void 0);s([h({type:Object})],je.prototype,"letterCounts",void 0);s([h({type:String})],je.prototype,"ariaLandmarkLabel",void 0);s([M()],je.prototype,"tooltipShown",void 0);s([M()],je.prototype,"hoveredLetter",void 0);s([Q("alpha-bar-tooltip")],je.prototype,"tooltip",void 0);je=s([A("alpha-bar")],je);const Tl=c`
...
`;let ee=class extends F{constructor(){super(...arguments),this.defaultSortDirection=null,this.defaultSortField=_.relevance,this.sortDirection=null,this.selectedSort=_.default,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.showRelevance=!0,this.showDateFavorited=!1,this.alphaSelectorVisible=null,this.dropdownBackdropVisible=!1,this.desktopSortContainerWidth=0,this.selectorBarContainerWidth=0,this.boundSortBarSelectorEscapeListener=e=>{e.key==="Escape"&&this.closeDropdowns()}}render(){return c`
      <div id="container">
    ...
    `}get sortDirectionIcon(){return this.canChangeSortDirection?c`
      <div class="sort-direction-icon">
        ${this.finalizedSortDirection==="asc"?Tl:Ml}
      </div>
    `:c`<div class="sort-direction-icon">${zl}</div>`}get desktopSortSelectorTemplate(){return c`
      <div
    ...
    `}get mobileSortSelectorTemplate(){const e=Object.values(fe).filter(t=>t.shownInSortBar).filter(t=>this.showRelevance||t.field!==_.relevance).filter(t=>this.showDateFavorited||t.field!==_.datefavorited);return c`
      <div
    ...
    `}getSortDisplayOption(e,t){var i,a;const r=(i=t==null?void 0:t.selected)!==null&&i!==void 0?i:this.finalizedSortField===e,l=(a=t==null?void 0:t.displayName)!==null&&a!==void 0?a:fe[e].displayName;return c`
      <button
        class=${r?"selected":y}
        data-title="${l}"
    ...
    `}getSortDropdown(e){var t,i,a,r,l;return c`
      <ia-dropdown
        ...
        @optionSelected=${(a=e.onOptionSelected)!==null&&a!==void 0?a:y}
    ...
    ></alpha-bar>`}titleLetterChanged(e){var t;this.selectedTitleFilter=(t=e.detail.selectedLetter)!==null&&t!==void 0?t:null,this.emitTitleLetterChangedEvent()}creatorLetterChanged(e){var t;this.selectedCreatorFilter=(t=e.detail.selectedLetter)!==null&&t!==void 0?t:null,this.emitCreatorLetterChangedEvent()}emitTitleLetterChangedEvent(){const e=new CustomEvent("titleLetterChanged",{detail:{selectedLetter:this.selectedTitleFilter}});this.dispatchEvent(e)}emitCreatorLetterChangedEvent(){const e=new CustomEvent("creatorLetterChanged",{detail:{selectedLetter:this.selectedCreatorFilter}});this.dispatchEvent(e)}displayModeChanged(){const e=new CustomEvent("displayModeChanged",{detail:{displayMode:this.displayMode}});this.dispatchEvent(e)}emitSortChangedEvent(){const e=new CustomEvent("sortChanged",{detail:{selectedSort:this.selectedSort,sortDirection:this.sortDirection}});this.dispatchEvent(e)}static get styles(){return[Ge,m`
      ...
      `]}};s([h({type:String})],ee.prototype,"displayMode",void 0);s([h({type:String})],ee.prototype,"defaultSortDirection",void 0);s([h({type:String})],ee.prototype,"defaultSortField",void 0);s([h({type:String})],ee.prototype,"sortDirection",void 0);s([h({type:String})],ee.prototype,"selectedSort",void 0);s([h({type:String})],ee.prototype,"selectedTitleFilter",void 0);s([h({type:String})],ee.prototype,"selectedCreatorFilter",void 0);s([h({type:Boolean})],ee.prototype,"showRelevance",void 0);s([h({type:Boolean})],ee.prototype,"showDateFavorited",void 0);s([h({type:Object})],ee.prototype,"prefixFilterCountMap",void 0);s([h({type:Object})],ee.prototype,"resizeObserver",void 0);s([M()],ee.prototype,"alphaSelectorVisible",void 0);s([M()],ee.prototype,"dropdownBackdropVisible",void 0);s([M()],ee.prototype,"desktopSortContainerWidth",void 0);s([M()],ee.prototype,"selectorBarContainerWidth",void 0);s([Q("#desktop-sort-container")],ee.prototype,"desktopSortContainer",void 0);s([Q("#sort-selector-container")],ee.prototype,"sortSelectorContainer",void 0);s([Q("#views-dropdown")],ee.prototype,"viewsDropdown",void 0);s([Q("#date-dropdown")],ee.prototype,"dateDropdown",void 0);s([Q("#mobile-dropdown")],ee.prototype,"mobileDropdown",void 0);ee=s([A("sort-filter-bar")],ee);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Lo(o,e,t){return o?e():t==null?void 0:t()}let ai=class extends F{constructor(){super(...arguments),this.label=D("Select items to un-favorite"),this.showSelectAll=!1,this.showUnselectAll=!1}render(){return c`
      <div class="manage-container">
        ...
        <div class="manage-buttons">
          ...
          <div class="selection-buttons">
            ${Lo(this.showSelectAll,()=>c` <button
                class="link-styled select-all-btn"
                @click=${this.selectAllClicked}
              >
                ${D("Select all")}
              </button>`)}
            ${Lo(this.showUnselectAll,()=>c` <button
    ...
    `}};s([h({type:String})],ai.prototype,"label",void 0);s([h({type:Boolean})],ai.prototype,"showSelectAll",void 0);s([h({type:Boolean})],ai.prototype,"showUnselectAll",void 0);ai=s([A("manage-bar")],ai);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const qt=(o,e)=>{var t,i;const a=o._$AN;if(a===void 0)return!1;for(const r of a)(i=(t=r)._$AO)===null||i===void 0||i.call(t,e,!1),qt(r,e);return!0},Ei=o=>{let e,t;do{if((e=o._$AM)===void 0)break;t=e._$AN,t.delete(o),o=e}while((t==null?void 0:t.size)===0)},gr=o=>{for(let e;e=o._$AM;o=e){let t=e._$AN;if(t===void 0)e._$AN=t=new Set;else if(t.has(o))break;t.add(o),Fl(e)}};function Pl(o){this._$AN!==void 0?(Ei(this),this._$AM=o,gr(this)):this._$AM=o}function Al(o,e=!1,t=0){const i=this._$AH,a=this._$AN;if(a!==void 0&&a.size!==0)if(e)if(Array.isArray(i))for(let r=t;r<i.length;r++)qt(i[r],!1),Ei(i[r]);else i!=null&&(qt(i,!1),Ei(i));else qt(this,o)}const Fl=o=>{var e,t,i,a;o.type==Pe.CHILD&&((e=(i=o)._$AP)!==null&&e!==void 0||(i._$AP=Al),(t=(a=o)._$AQ)!==null&&t!==void 0||(a._$AQ=Pl))};class Bl extends li{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,i){super._$AT(e,t,i),gr(this),this.isConnected=e._$AU}_$AO(e,t=!0){var i,a;e!==this.isConnected&&(this.isConnected=e,e?(i=this.reconnected)===null||i===void 0||i.call(this):(a=this.disconnected)===null||a===void 0||a.call(this)),t&&(qt(this,e),Ei(this))}setValue(e){if(sr(this._$Ct))this._$Ct._$AI(e,this);else{const t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}}const ia=new WeakMap,Il=si(class extends Bl{render(o){return y}update(o,[e]){var t;const i=e!==this.U;return i&&this.U!==void 0&&this.ot(void 0),(i||this.rt!==this.lt)&&(this.U=e,this.ht=(t=o.options)===null||t===void 0?void 0:t.host,this.ot(this.lt=o.element)),y}ot(o){var e;if(typeof this.U=="function"){const t=(e=this.ht)!==null&&e!==void 0?e:globalThis;let i=ia.get(t);i===void 0&&(i=new WeakMap,ia.set(t,i)),i.get(this.U)!==void 0&&this.U.call(this.ht,void 0),i.set(this.U,o),o!==void 0&&this.U.call(this.ht,o)}else this.U.value=o}get rt(){var o,e,t;return typeof this.U=="function"?(e=ia.get((o=this.ht)!==null&&o!==void 0?o:globalThis))===null||e===void 0?void 0:e.get(this.U):(t=this.U)===null||t===void 0?void 0:t.value}disconnected(){this.rt===this.lt&&this.ot(void 0)}reconnected(){this.ot(this.lt)}});/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Po=si(class extends li{constructor(o){if(super(o),o.type!==Pe.PROPERTY&&o.type!==Pe.ATTRIBUTE&&o.type!==Pe.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!sr(o))throw Error("`live` bindings can only contain a single expression")}render(o){return o}update(o,[e]){if(e===we||e===y)return e;const t=o.element,i=o.name;if(o.type===Pe.PROPERTY){if(e===t[i])return we}else if(o.type===Pe.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(i))return we}else if(o.type===Pe.ATTRIBUTE&&t.getAttribute(i)===e+"")return we;return lr(o),e}}),Ol=Object.freeze({processing:"processing",complete:"complete"});class Rl extends F{static get properties(){return{mode:{type:String}}}constructor(){super(),this.mode=Ol.processing}render(){return c`
      <div class="${this.mode}">
        <svg
          viewBox="0 0 120 120"
    ...
    `,this._tooltipVisible=!0}hideTooltip(){this._tooltipContent=void 0,this._tooltipVisible=!1}validMinSliderX(e){const t=Math.min(this.translateDateToPosition(this.maxSelectedDate),this.histogramRightEdgeX);return e=this.clamp(e,this.histogramLeftEdgeX,t),Number.isNaN(e)||t<this.histogramLeftEdgeX?this.histogramLeftEdgeX:e}validMaxSliderX(e){const t=Math.max(this.histogramLeftEdgeX,this.translateDateToPosition(this.minSelectedDate));return e=this.clamp(e,t,this.histogramRightEdgeX),Number.isNaN(e)||t>this.histogramRightEdgeX?this.histogramRightEdgeX:e}addListeners(){window.addEventListener("pointermove",this.move),window.addEventListener("pointerup",this.drop),window.addEventListener("pointercancel",this.drop)}removeListeners(){window.removeEventListener("pointermove",this.move),window.removeEventListener("pointerup",this.drop),window.removeEventListener("pointercancel",this.drop)}beginEmitUpdateProcess(){this.cancelPendingUpdateEvent(),this._emitUpdatedEventTimer=setTimeout(()=>{if(this.currentDateRangeString===this._previousDateRange)return;this._previousDateRange=this.currentDateRangeString;const e={detail:{minDate:this.minSelectedDate,maxDate:this.maxSelectedDate},bubbles:!0,composed:!0};this.dispatchEvent(new CustomEvent("histogramDateRangeUpdated",e))},this.updateDelay)}cancelPendingUpdateEvent(){this._emitUpdatedEventTimer!==void 0&&(clearTimeout(this._emitUpdatedEventTimer),this._emitUpdatedEventTimer=void 0)}setDragOffset(e){this._currentSlider=e.currentTarget;const t=this._currentSlider.id==="slider-min"?this.minSliderX:this.maxSliderX,i=this.getBoundingClientRect().x;this._dragOffset=e.clientX-i-t}translatePositionToDate(e){const t=Math.ceil((e-this.sliderWidth)*this.dateRangeMS/this._histWidth);return this.formatDate(this._minDateMS+t)}translateDateToPosition(e){const t=this.getMSFromString(e);return this.sliderWidth+(t-this._minDateMS)*this._histWidth/this.dateRangeMS}clamp(e,t,i){return Math.min(Math.max(e,t),i)}handleInputFocus(){this.updateWhileFocused||this.cancelPendingUpdateEvent()}handleMinDateInput(e){const t=e.currentTarget;t.value!==this.minSelectedDate&&(this.minSelectedDate=t.value,this.beginEmitUpdateProcess())}handleMaxDateInput(e){const t=e.currentTarget;t.value!==this.maxSelectedDate&&(this.maxSelectedDate=t.value,this.beginEmitUpdateProcess())}handleKeyUp(e){if(e.key==="Enter"){const t=e.currentTarget;t.blur(),t.id==="date-min"?this.handleMinDateInput(e):t.id==="date-max"&&this.handleMaxDateInput(e)}}get currentDateRangeString(){return`${this.minSelectedDate}:${this.maxSelectedDate}`}getMSFromString(e){const t=typeof e=="string"?e:String(e);if((t.split(/(\d+)/).length-1)/2===1){const a=new Date(0,0);return a.setFullYear(Number(t)),a.getTime()}return aa(t,[this.dateFormat,Ao]).valueOf()}handleBarClick(e){const t=e.currentTarget.dataset,i=(this.getMSFromString(t.binStart)+this.getMSFromString(t.binEnd))/2,a=Math.abs(i-this.getMSFromString(this.minSelectedDate)),r=Math.abs(i-this.getMSFromString(this.maxSelectedDate));a<r?this.minSelectedDate=t.binStart:this.maxSelectedDate=t.binEnd,this.beginEmitUpdateProcess()}get minSliderTemplate(){const e=Fo,t=`
            ...
            q0,${e} ${e},${e}
            h${this.sliderWidth-e}
          `;return this.generateSliderSVG(this.minSliderX,"slider-min",t)}get maxSliderTemplate(){const e=Fo,t=`
            M${this.maxSliderX},0
            h${this.sliderWidth-e}
            q${e},0 ${e},${e}
            v${this.height-e*2}
    ...
    `}get selectedRangeTemplate(){return O`
      <rect
        ...
        height="${this.height}"
        fill="${Ql}"
      />`}get histogramTemplate(){const e=this._histWidth/this._numBins,t=e-1;let i=this.sliderWidth;return this._histData.map(a=>{const r=O`
        <rect
          class="bar"
          ...
          fill="${i+t>=this.minSliderX&&i<=this.maxSliderX?Kl:Xl}"
          data-num-items="${a.value}"
          data-bin-start="${a.binStart}"
          data-bin-end="${a.binEnd}"
        />`;return i+=e,r})}formatDate(e){if(Number.isNaN(e))return"";const t=aa(e);return t.year()<1e3?String(t.year()):t.format(this.dateFormat)}get minInputTemplate(){return c`
      <input
        id="date-min"
    ...
    ia-activity-indicator {
      ...
      --activityIndicatorLoadingRingColor: ${Yl};
    }
    ...
    #tooltip:after {
      ...
      /* arrow */
      border: 5px solid ${Io};
      border-color: ${Bo} transparent transparent
        transparent;
    }
    /****** slider ********/
    .draggable:hover {
...
`;let ae=class extends F{constructor(){super(...arguments),this.prompt="Do you find this feature useful?",this.buttonText="Beta",this.isOpen=!1,this.processing=!1,this.popupTopX=0,this.popupTopY=0,this.voteSubmitted=!1,this.voteNeedsChoosing=!1,this.resizingElement=document.body}render(){return c`
    ...
    `}get upvoteSelected(){return this.vote==="up"}get downvoteSelected(){return this.vote==="down"}upvoteKeypressed(e){(e.key==="Enter"||e.key===" ")&&this.upvoteButtonSelected()}downvoteKeypressed(e){(e.key==="Enter"||e.key===" ")&&this.downvoteButtonSelected()}upvoteButtonSelected(){this.vote=this.vote==="up"?void 0:"up"}downvoteButtonSelected(){this.vote=this.vote==="down"?void 0:"down"}get chooseVoteErrorClass(){return this.voteNeedsChoosing?"error":""}get upvoteButtonClass(){switch(this.vote){case"up":return"selected";case"down":return"unselected";default:return"noselection"}}get downvoteButtonClass(){switch(this.vote){case"up":return"unselected";case"down":return"selected";default:return"noselection"}}backgroundClicked(e){var t;e.target instanceof Node&&(!((t=this.popup)===null||t===void 0)&&t.contains(e.target)||this.closePopup())}cancel(e){e.preventDefault(),this.vote=void 0,this.closePopup()}async submit(e){if(e.preventDefault(),!this.vote){this.voteNeedsChoosing=!0,this.error=c`Please select a vote.`;return}if(!this.featureIdentifier)throw new Error("featureIdentifier is required");if(!this.featureFeedbackService)throw new Error("featureFeedbackService is required");if(!this.recaptchaWidget)throw new Error("recaptchaWidget is required");this.processing=!0;try{const t=await this.recaptchaWidget.execute();(await this.featureFeedbackService.submitFeedback({featureIdentifier:this.featureIdentifier,vote:this.vote,comments:this.comments.value,recaptchaToken:t})).success?(this.voteSubmitted=!0,this.closePopup()):this.error=c`There was an error submitting your feedback.`}catch(t){this.error=c`There was an error submitting your feedback.<br />Error:
        ${t instanceof Error?t.message:t}`}this.processing=!1}static get styles(){const e=m`var(--featureFeedbackBlueColor, #194880)`,t=m`var(--featureFeedbackDarkGrayColor, #767676)`,i=m`var(--defaultColorSvgFilter, invert(52%) sepia(0%) saturate(1%) hue-rotate(331deg) brightness(87%) contrast(89%))`,a=m`var(--featureFeedbackBackdropZindex, 5)`,r=m`var(--featureFeedbackModalZindex, 6)`,l=m`var(--featureFeedbackPopupBorderColor, ${e})`,n=m`var(--featureFeedbackSubmitButtonColor, ${e})`,d=m`var(--featureFeedbackBetaButtonBorderColor, ${e})`,p=m`var(--featureFeedbackBetaButtonTextColor, ${e})`,v=m`var(--featureFeedbackBetaButtonSvgFilter, ${i})`,f=m`var(--featureFeedbackCancelButtonColor, #515151)`,b=m`var(--featureFeedbackPopupBlockerColor, rgba(255, 255, 255, 0.3))`,w=m`var(--featureFeedbackPopupBackgroundColor, #F5F5F7)`,S=m`var(--featureFeedbackPromptFontWeight, bold)`,E=m`var(--featureFeedbackPromptFontSize, 14px)`,B=m`var(--defaultColor, ${t});`,L=m`var(--defaultColorSvgFilter, ${i});`,U=m`var(--upvoteColor, #23765D);`,re=m`var(--upvoteColorSvgFilter, invert(34%) sepia(72%) saturate(357%) hue-rotate(111deg) brightness(97%) contrast(95%));`,K=m`var(--downvoteColor, #720D11);`,ne=m`var(--downvoteColorSvgFilter, invert(5%) sepia(81%) saturate(5874%) hue-rotate(352deg) brightness(105%) contrast(95%));`,te=m`var(--unselectedColor, #CCCCCC);`,W=m`var(--unselectedColorSvgFilter, invert(100%) sepia(0%) saturate(107%) hue-rotate(138deg) brightness(89%) contrast(77%));`;return m`
      #beta-button {
        font-size: 12px;
        font-weight: bold;
        font-style: italic;
    ...
    `}};s([h({type:String})],ae.prototype,"featureIdentifier",void 0);s([h({type:String})],ae.prototype,"prompt",void 0);s([h({type:String})],ae.prototype,"buttonText",void 0);s([h({type:Object})],ae.prototype,"recaptchaManager",void 0);s([h({type:Object})],ae.prototype,"resizeObserver",void 0);s([h({type:Boolean})],ae.prototype,"disabled",void 0);s([h({type:Object})],ae.prototype,"featureFeedbackService",void 0);s([Q("#beta-button")],ae.prototype,"betaButton",void 0);s([Q("#popup")],ae.prototype,"popup",void 0);s([M()],ae.prototype,"isOpen",void 0);s([M()],ae.prototype,"processing",void 0);s([M()],ae.prototype,"popupTopX",void 0);s([M()],ae.prototype,"popupTopY",void 0);s([M()],ae.prototype,"vote",void 0);s([M()],ae.prototype,"voteSubmitted",void 0);s([M()],ae.prototype,"error",void 0);s([M()],ae.prototype,"voteNeedsChoosing",void 0);s([M()],ae.prototype,"recaptchaWidget",void 0);s([Q("#comments")],ae.prototype,"comments",void 0);ae=s([A("feature-feedback")],ae);class Sa{constructor(e){var t,i,a,r,l,n,d;this.title=e==null?void 0:e.title,this.subtitle=e==null?void 0:e.subtitle,this.headline=e==null?void 0:e.headline,this.message=e==null?void 0:e.message,this.headerColor=(t=e==null?void 0:e.headerColor)!==null&&t!==void 0?t:"#55A183",this.bodyColor=(i=e==null?void 0:e.bodyColor)!==null&&i!==void 0?i:"#f5f5f7",this.showProcessingIndicator=(a=e==null?void 0:e.showProcessingIndicator)!==null&&a!==void 0?a:!1,this.processingImageMode=(r=e==null?void 0:e.processingImageMode)!==null&&r!==void 0?r:"complete",this.showCloseButton=(l=e==null?void 0:e.showCloseButton)!==null&&l!==void 0?l:!0,this.showHeaderLogo=(n=e==null?void 0:e.showHeaderLogo)!==null&&n!==void 0?n:!0,this.closeOnBackdropClick=(d=e==null?void 0:e.closeOnBackdropClick)!==null&&d!==void 0?d:!0}}var sn=c`
<svg
  viewBox="0 0 40 40"
  version="1.1"
  xmlns="http://www.w3.org/2000/svg"
...
`;let $a=class extends F{constructor(){super(...arguments),this.config=new Sa}render(){return c`
      <div class="modal-wrapper">
        <div class="modal-container">
          <header style="background-color: ${this.config.headerColor}">
            ...
            ${this.config.showHeaderLogo?c`<div class="logo-icon">${ln}</div>`:y}
    ...
    `}static get styles(){const e=m`var(--modalLogoSize, 6.5rem)`,t=m`var(--processingImageSize, 7.5rem)`,i=m`var(--modalCornerRadius, 1rem)`,a=m`var(--modalBorder, 2px solid black)`,r=m`var(--modalBottomMargin, 2.5rem)`,l=m`var(--modalTopMargin, 5rem)`,n=m`var(--modalHeaderBottomPadding, 0.5em)`,d=m`var(--modalBottomPadding, 2rem)`,p=m`var(--modalScrollOffset, 5px)`,v=m`var(--modalTitleFontSize, 1.8rem)`,f=m`var(--modalSubtitleFontSize, 1.4rem)`,b=m`var(--modalHeadlineFontSize, 1.6rem)`,w=m`var(--modalMessageFontSize, 1.4rem)`,S=m`var(--modalTitleLineHeight, normal)`,E=m`var(--modalSubtitleLineHeight, normal)`,B=m`var(--modalHeadlineLineHeight, normal)`,L=m`var(--modalMessageLineHeight, normal)`;return m`
      .processing-logo {
        margin: auto;
        width: ${t};
        height: ${t};
    ...
    `}};s([h({type:Object})],$a.prototype,"config",void 0);$a=s([A("modal-template")],$a);function nn(o,e,t){var i=t||{},a=i.noTrailing,r=a===void 0?!1:a,l=i.noLeading,n=l===void 0?!1:l,d=i.debounceMode,p=d===void 0?void 0:d,v,f=!1,b=0;function w(){v&&clearTimeout(v)}function S(B){var L=B||{},U=L.upcomingOnly,re=U===void 0?!1:U;w(),f=!re}function E(){for(var B=arguments.length,L=new Array(B),U=0;U<B;U++)L[U]=arguments[U];var re=this,K=Date.now()-b;if(f)return;function ne(){b=Date.now(),e.apply(re,L)}function te(){v=void 0}!n&&p&&!v&&ne(),w(),p===void 0&&K>o?n?(b=Date.now(),r||(v=setTimeout(p?te:ne,o))):ne():r!==!0&&(v=setTimeout(p?te:ne,p===void 0?o-K:o))}return E.cancel=S,E}var vt;(function(o){o.Open="open",o.Closed="closed"})(vt||(vt={}));class dn{constructor(e){this.windowResizeThrottler=nn(100,this.updateModalContainerHeight,{noLeading:!1,noTrailing:!1}).bind(this),this.modalManager=e}handleModeChange(e){switch(e){case vt.Open:this.startResizeListener(),this.stopDocumentScroll();break;case vt.Closed:this.stopResizeListener(),this.resumeDocumentScroll();break}}updateModalContainerHeight(){this.modalManager.style.setProperty("--containerHeight",`${window.innerHeight}px`)}stopDocumentScroll(){document.body.classList.add("modal-manager-open")}resumeDocumentScroll(){document.body.classList.remove("modal-manager-open")}startResizeListener(){window.addEventListener("resize",this.windowResizeThrottler)}stopResizeListener(){window.removeEventListener("resize",this.windowResizeThrottler)}}let Pt=class extends F{constructor(){super(...arguments),this.mode=vt.Closed,this.hostBridge=new dn(this),this.closeOnBackdropClick=!0}render(){return c`
      <div class="container">
    ...
    `}};s([h({type:String,reflect:!0})],Pt.prototype,"mode",void 0);s([h({type:Object})],Pt.prototype,"customModalContent",void 0);s([h({type:Object})],Pt.prototype,"hostBridge",void 0);s([Q("modal-template")],Pt.prototype,"modalTemplate",void 0);Pt=s([A("modal-manager")],Pt);var br=O`<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><path d="m79.8883285 50.0035012.1116715-.1085359-43.1159942-46.61088155c-2.401537-2.18938917-4.6902018-3.28408375-6.8659943-3.28408375s-4.1642651.63837733-5.9654178 1.91513199c-1.8011528 1.27675467-3.1520173 2.97248092-4.0525937 5.08717877l39.4020173 42.99768924-39.4020173 42.9976892c.9005764 2.1146979 2.2514409 3.8104241 4.0525937 5.0871788 1.8011527 1.2767547 3.7896253 1.915132 5.9654178 1.915132 2.1013449 0 4.3900096-1.0573489 6.8659943-3.1720468l43.1159942-46.7194174z"/></svg>
`,cn=c`
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path
...
`;let At=class extends F{constructor(){super(...arguments),this.step=2,this.currentPage=1,this.pages=[]}firstUpdated(){this.observePageCount()}updated(e){e.has("size")&&this.observePageCount(),e.has("currentPage")&&(this.observePageCount(),this.emitPageClick())}observePageCount(){this.pages=[];const e=7,t=this.size<=e;if(this.size<=5){this.pages=[...Array(this.size).keys()].map(r=>r+1);return}if(this.size===e){if(this.currentPage===2){this.pages=[1,2,3,4,0,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,4,5,this.size-1,this.size];return}}if(this.currentPage===1){this.pages=[1,2,3,0,this.size];return}if(this.currentPage===this.size){this.pages=[1,0,this.size-2,this.size-1,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,this.size-3,this.size-2,this.size-1,this.size];return}if(t&&this.currentPage>1&&this.currentPage<e){this.pages=[...Array(this.size).keys()].map(r=>r+1);return}let i=this.currentPage-this.step,a=this.currentPage+this.step;i<=0&&(a+=-i+1,i=1),a>=this.size&&(i=Math.max(i-(a-this.size),1),a=this.size),i===2&&(a-=1),a===this.size-1&&(i+=1),this.createFirstNode(i),this.createMiddelNode(i,a),this.createLastNode(a)}createFirstNode(e){var t,i;e>1&&((t=this.pages)===null||t===void 0||t.push(1)),e>2&&((i=this.pages)===null||i===void 0||i.push(0))}createMiddelNode(e,t){var i;for(let a=e;a<=t;a+=1)(i=this.pages)===null||i===void 0||i.push(a)}createLastNode(e){var t,i;e<this.size-1&&((t=this.pages)===null||t===void 0||t.push(0)),e<this.size&&((i=this.pages)===null||i===void 0||i.push(this.size))}get getEllipsisTemplate(){return c`<i class="ellipses">...</i>`}emitPageClick(){this.dispatchEvent(new CustomEvent("pageNumberClicked",{detail:{page:this.currentPage},bubbles:!0,composed:!0}))}onRewind(){this.currentPage-=1,this.currentPage<1&&(this.currentPage=1)}onForward(){this.currentPage+=1,this.currentPage>this.size&&(this.currentPage=this.size)}onChange(e){this.currentPage=e}getPageTemplate(e){return c`
      <button
    ...
    `}static get styles(){return[Ge,m`
      ...
      `]}};s([h({type:Number})],At.prototype,"size",void 0);s([h({type:Number})],At.prototype,"step",void 0);s([h({type:Number})],At.prototype,"currentPage",void 0);s([M()],At.prototype,"pages",void 0);At=s([A("more-facets-pagination")],At);var un=O`
...
`;let ft=class extends F{constructor(){super(...arguments),this.collectionPagePath="/details/"}facetClicked(e,t,i){const a=e.target,{checked:r,name:l,value:n}=a;r?this.facetChecked(l,n,t,i):this.facetUnchecked(l,n),this.dispatchFacetClickEvent(l,this.getFacetState(r,i),i)}facetChecked(e,t,i,a){const{selectedFacets:r}=this;let l;r?l=X({},r):l=ii(),l[e][t]={state:this.getFacetState(!0,a),count:i},this.selectedFacets=l,this.dispatchSelectedFacetsChanged()}facetUnchecked(e,t){const{selectedFacets:i}=this;let a;i?a=X({},i):a=ii(),delete a[e][t],this.selectedFacets=a,this.dispatchSelectedFacetsChanged()}getFacetState(e,t){let i;return e?i=t?"hidden":"selected":i="none",i}dispatchFacetClickEvent(e,t,i){const a=new CustomEvent("facetClick",{detail:{key:e,state:t,negative:i},composed:!0});this.dispatchEvent(a)}dispatchSelectedFacetsChanged(){const e=new CustomEvent("selectedFacetsChanged",{detail:this.selectedFacets,bubbles:!0,composed:!0});this.dispatchEvent(e)}getFacetsTemplate(e){let t=e==null?void 0:e.buckets;return t=[...t.filter(i=>i.state==="selected").sort((i,a)=>i.count<a.count?1:-1),...t.filter(i=>i.state==="hidden").sort((i,a)=>i.count<a.count?1:-1),...t.filter(i=>i.state==="none")],c`
      <div class="facets-on-${this.renderOn}">
        ${nr(t,i=>`${e.key}:${i.key}`,i=>{var a,r;const l=`${e.key}:${i.key}-show-only`,n=`${e.key}:${i.key}-negative`,d=e.key!=="collection"?c`${(a=i.displayText)!==null&&a!==void 0?a:i.key}`:c`<a href="${this.collectionPagePath}${i.key}">
                    <async-collection-name
                      .collectionNameCache=${this.collectionNameCache}
                      .identifier=${i.key}
                      placeholder="-"
                    ></async-collection-name>
                  </a> `,p=i.state==="hidden",v=i.state==="selected",f=`${e.key}: ${(r=i.displayText)!==null&&r!==void 0?r:i.key}`,b=v?`Show all ${e.key}s`:`Only show ${f}`,w=`Hide ${f}`,S=`Unhide ${f}`,E=p?S:w,B=`${f}, ${i.count} results`;return c`
              <div class="facet-row">
                <div class="facet-checkbox">
                  ...
                  <label
                    ...
                    title=${E}
                  >
                    <span class="eye">${un}</span>
                    <span class="eye-closed">${vn}</span>
                  </label>
                </div>
                <label
                  for=${l}
    ...
    `}render(){return c`${this.getFacetsTemplate(this.facetGroup)}`}static get styles(){return m`
    ...
    `}};s([h({type:Object})],ft.prototype,"facetGroup",void 0);s([h({type:Object})],ft.prototype,"selectedFacets",void 0);s([h({type:String})],ft.prototype,"renderOn",void 0);s([h({type:String})],ft.prototype,"collectionPagePath",void 0);s([h({type:Object})],ft.prototype,"collectionNameCache",void 0);ft=s([A("facets-template")],ft);var Fe;(function(o){o.default="collection-browser"})(Fe||(Fe={}));var se;(function(o){o.sortBy="sortBy",o.filterByCreator="filterByCreator",o.filterByTitle="filterByTitle",o.displayMode="displayMode",o.facetSelected="facetSelected",o.facetDeselected="facetDeselected",o.facetNegativeSelected="facetNegativeSelected",o.facetNegativeDeselected="facetNegativeDeselected",o.partOfCollectionClicked="partOfCollectionClicked",o.histogramChanged="histogramChanged",o.histogramChangedFromModal="histogramChangedFromModal",o.histogramExpanded="histogramExpanded",o.resultSelected="resultSelected",o.moreFacetsPageChange="moreFacetsPageChange",o.showMoreFacetsModal="showMoreFacetsModal",o.closeMoreFacetsModal="closeMoreFacetsModal",o.applyMoreFacetsModal="applyMoreFacetsModal"})(se||(se={}));let tt=class extends F{constructor(){super(...arguments),this.leftValue="",this.rightValue="",this.side="left"}render(){var e,t;return c`
      <div id="container">
    ...
    `}get value(){return this.side==="left"?this.leftValue:this.rightValue}get selectedLabel(){var e,t;return this.side==="left"?(e=this.leftLabel)!==null&&e!==void 0?e:this.leftValue:(t=this.rightLabel)!==null&&t!==void 0?t:this.rightValue}handleClick(){this.side=this.side==="left"?"right":"left",this.emitChangeEvent()}handleRadioChange(){this.side=this.leftRadio.checked?"left":"right",this.emitChangeEvent()}emitChangeEvent(){const e=new CustomEvent("change",{detail:this.value});this.dispatchEvent(e)}static get styles(){const e=m`var(--switchWidth, 30px)`,t=m`var(--switchHeight, 14px)`,i=m`var(--switchMarginLeft, 5px)`,a=m`var(--switchMarginRight, 5px)`,r=m`var(--switchBorderWidth, 3px)`,l=m`var(--switchBgColor, #194880)`,n=m`var(--switchBorderColor, #194880)`,d=m`var(--labelFontSize, 1.3rem)`,p=m`var(--knobColor, white)`,v=m`var(--knobTransitionDuration, 0.25s)`,f=m`var(--knobTransitionFn, ease)`;return[Ge,m`
      ...
      `]}};s([h({type:String,attribute:!0})],tt.prototype,"leftValue",void 0);s([h({type:String,attribute:!0})],tt.prototype,"leftLabel",void 0);s([h({type:String,attribute:!0})],tt.prototype,"rightValue",void 0);s([h({type:String,attribute:!0})],tt.prototype,"rightLabel",void 0);s([h({type:String,attribute:!0})],tt.prototype,"side",void 0);s([Q("#switch-left")],tt.prototype,"leftRadio",void 0);tt=s([A("toggle-switch")],tt);let oe=class extends F{constructor(){super(...arguments),this.sortedBy=J.COUNT,this.facetGroup=[],this.facetGroupTitle="",this.pageNumber=1,this.facetsLoading=!0,this.paginationSize=0,this.facetsType="modal",this.facetsPerPage=35}updated(e){(e.has("facetKey")||e.has("facetAggregationKey")||e.has("query")||e.has("searchType")||e.has("filterMap"))&&(this.facetsLoading=!0,this.pageNumber=1,this.updateSpecificFacets()),e.has("pageNumber")&&(this.facetGroup=this.aggregationFacetGroups)}firstUpdated(){this.setupEscapeListeners()}setupEscapeListeners(){this.modalManager?document.addEventListener("keydown",e=>{var t;e.key==="Escape"&&((t=this.modalManager)===null||t===void 0||t.closeModal())}):document.removeEventListener("keydown",()=>{})}async updateSpecificFacets(){var e,t,i;const a=(e=this.query)===null||e===void 0?void 0:e.trim();if(!a&&!this.withinCollection)return;const r={simpleParams:[this.facetAggregationKey]},l=65535,n=this.withinCollection?{pageType:"collection_details",pageTarget:this.withinCollection}:null,d=ve(X({},n),{query:a||"",filters:this.filterMap,aggregations:r,aggregationsSize:l,rows:0}),p=await((t=this.searchService)===null||t===void 0?void 0:t.search(d,this.searchType));this.aggregations=(i=p==null?void 0:p.success)===null||i===void 0?void 0:i.response.aggregations,this.facetGroup=this.aggregationFacetGroups,this.facetsLoading=!1}pageNumberClicked(e){var t,i;const a=(t=e==null?void 0:e.detail)===null||t===void 0?void 0:t.page;a&&(this.pageNumber=Number(a)),(i=this.analyticsHandler)===null||i===void 0||i.sendEvent({category:Fe.default,action:se.moreFacetsPageChange,label:`${this.pageNumber}`})}get mergedFacets(){var e;const t=[],i=this.selectedFacetGroups.find(n=>n.key===this.facetKey),a=this.aggregationFacetGroups.find(n=>n.key===this.facetKey);if(i&&!a)return t.push(i),t;if(!a)return t;const r=i!=null?i:a,l=(e=i==null?void 0:i.buckets.map(n=>{const d=a.buckets.find(p=>p.key===n.key);return d?ve(X({},n),{count:d.count}):n}))!==null&&e!==void 0?e:[];return a.buckets.forEach(n=>{l.find(p=>p.key===n.key)||l.push(n)}),r.buckets=l,t.push(r),t}get selectedFacetGroups(){return this.selectedFacets?Object.entries(this.selectedFacets).map(([t,i])=>{const a=t,r=Mi[a],l=Object.entries(i).map(([n,d])=>({displayText:n,key:n,count:d==null?void 0:d.count,state:d==null?void 0:d.state}));return{title:r,key:a,buckets:l}}):[]}get aggregationFacetGroups(){var e;const t=[];return Object.entries((e=this.aggregations)!==null&&e!==void 0?e:[]).forEach(([i,a])=>{if(i==="year_histogram")return;const r=i;this.facetGroupTitle=Mi[r];let l=a.getSortedBuckets(this.sortedBy);r==="collection"&&(l=l==null?void 0:l.filter(f=>{var b;const w=(b=f==null?void 0:f.key)===null||b===void 0?void 0:b.toString();return!Fa[w]&&!(w!=null&&w.startsWith("fav-"))}),this.preloadCollectionNames(l));const{length:n}=Object.keys(l);this.paginationSize=Math.ceil(n/this.facetsPerPage);const p=(l==null?void 0:l.slice((this.pageNumber-1)*this.facetsPerPage,this.pageNumber*this.facetsPerPage)).map(f=>{const b=f.key;return{displayText:`${f.key}`,key:`${b}`,count:f.doc_count,state:"none"}}),v={title:this.facetGroupTitle,key:r,buckets:p};t.push(v)}),t}preloadCollectionNames(e){var t;const i=e==null?void 0:e.map(r=>r.key),a=Array.from(new Set(i));(t=this.collectionNameCache)===null||t===void 0||t.preloadIdentifiers(a)}get getMoreFacetsTemplate(){var e;return c`
      <facets-template
    ...
    `}get loaderTemplate(){return c`<div class="facets-loader">
      <ia-activity-indicator .mode=${"processing"}></ia-activity-indicator>
        ...
        </div> `:y}sortFacetAggregation(e){this.sortedBy=e,this.dispatchEvent(new CustomEvent("sortedFacets",{detail:this.sortedBy}))}get getModalHeaderTemplate(){const t=wa[this.facetKey]===J.COUNT?"left":"right";return c`<span class="sr-only">More facets for:</span>
      <span class="title">
      ...
      ${this.facetsLoading?this.loaderTemplate:c`
          ...
          `}
    `}applySearchFacetsClicked(){var e,t;const i=new CustomEvent("facetsChanged",{detail:this.selectedFacets,bubbles:!0,composed:!0});this.dispatchEvent(i),(e=this.modalManager)===null||e===void 0||e.closeModal(),(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:Fe.default,action:`${se.applyMoreFacetsModal}`,label:`${this.facetKey}`})}cancelClick(){var e,t;(e=this.modalManager)===null||e===void 0||e.closeModal(),(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:Fe.default,action:se.closeMoreFacetsModal,label:`${this.facetKey}`})}static get styles(){const e=m`var(--primaryButtonBGColor, #194880)`;return[Ge,m`
        @media (max-width: 560px) {
          section#more-facets {
            max-height: 450px;
          }
      ...
      `]}};s([h({type:String})],oe.prototype,"facetKey",void 0);s([h({type:String})],oe.prototype,"facetAggregationKey",void 0);s([h({type:String})],oe.prototype,"query",void 0);s([h({type:Object})],oe.prototype,"filterMap",void 0);s([h({type:Object})],oe.prototype,"modalManager",void 0);s([h({type:Object})],oe.prototype,"searchService",void 0);s([h({type:String})],oe.prototype,"searchType",void 0);s([h({type:String})],oe.prototype,"withinCollection",void 0);s([h({type:Object})],oe.prototype,"collectionNameCache",void 0);s([h({type:Object})],oe.prototype,"selectedFacets",void 0);s([h({type:String})],oe.prototype,"sortedBy",void 0);s([h({type:Object,attribute:!1})],oe.prototype,"analyticsHandler",void 0);s([M()],oe.prototype,"aggregations",void 0);s([M()],oe.prototype,"facetGroup",void 0);s([M()],oe.prototype,"facetGroupTitle",void 0);s([M()],oe.prototype,"pageNumber",void 0);s([M()],oe.prototype,"facetsLoading",void 0);s([M()],oe.prototype,"paginationSize",void 0);s([M()],oe.prototype,"facetsType",void 0);oe=s([A("more-facets-content")],oe);let No=class extends F{render(){return c`
      <div id="row">
    ...
    `}};No=s([A("facet-tombstone-row")],No);let Ie=class extends F{constructor(){super(...arguments),this.boundEscapeListener=e=>{e.key==="Escape"&&this.closeModal()}}render(){var e,t;return c`
      <div id="container">
    ...
    `}connectedCallback(){var e;(e=super.connectedCallback)===null||e===void 0||e.call(this),this.setupEscapeListener()}disconnectedCallback(){var e;(e=super.disconnectedCallback)===null||e===void 0||e.call(this),this.removeEscapeListener()}setupEscapeListener(){document.addEventListener("keydown",this.boundEscapeListener)}removeEscapeListener(){document.removeEventListener("keydown",this.boundEscapeListener)}histogramDateRangeUpdated(e){this.minSelectedDate=e.detail.minDate,this.maxSelectedDate=e.detail.maxDate}applyBtnClicked(){var e;const t=new CustomEvent("histogramDateRangeApplied",{detail:{minDate:this.minSelectedDate,maxDate:this.maxSelectedDate}});this.dispatchEvent(t),this.closeModal(),(e=this.analyticsHandler)===null||e===void 0||e.sendEvent({category:Fe.default,action:se.histogramChangedFromModal,label:window.location.href})}closeModal(){this.modalManager&&(this.modalManager.closeModal(),this.dispatchEvent(new CustomEvent("modalClosed")))}static get styles(){return m`
      #container {
        display: flex;
        justify-content: center;
    ...
    `}};s([h({type:String})],Ie.prototype,"minDate",void 0);s([h({type:String})],Ie.prototype,"maxDate",void 0);s([h({type:String})],Ie.prototype,"minSelectedDate",void 0);s([h({type:String})],Ie.prototype,"maxSelectedDate",void 0);s([h({type:Array})],Ie.prototype,"buckets",void 0);s([h({type:Object,attribute:!1})],Ie.prototype,"modalManager",void 0);s([h({type:Object,attribute:!1})],Ie.prototype,"analyticsHandler",void 0);Ie=s([A("expanded-date-picker")],Ie);let N=class extends F{constructor(){super(...arguments),this.moreLinksVisible=!0,this.facetsLoading=!1,this.fullYearAggregationLoading=!1,this.collapsableFacets=!1,this.showHistogramDatePicker=!1,this.allowExpandingDatePicker=!1,this.parentCollections=[],this.collectionPagePath="/details/",this.isManageView=!1,this.openFacets={subject:!1,lending:!1,mediatype:!1,language:!1,creator:!1,collection:!1,year:!1},this.allowedFacetCount=6,this.handleExpandedDatePickerClosed=()=>{var e;(e=this.modalManager)===null||e===void 0||e.classList.remove("expanded-date-picker")},this.histogramDateRangeUpdated=e=>{const{minDate:t,maxDate:i}=e.detail,a=new CustomEvent("histogramDateRangeUpdated",{detail:{minDate:t,maxDate:i}});this.dispatchEvent(a)}}render(){const e=Lt({loading:this.facetsLoading,managing:this.isManageView}),t="date-picker-label";return c`
    ...
    `}get collectionPartOfTemplate(){if(!this.withinCollection||this.parentCollections.length===0)return y;const e="partof-heading";return c`
      ...
      >
        ...
        <ul>
          ${ki(this.parentCollections,t=>{const i=`${this.baseNavigationUrl}${this.collectionPagePath}${t}`;return c` <li>
              <a
                href=${i}
                data-id=${t}
    ...
    `}partOfCollectionClicked(e){var t;(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:Fe.default,action:se.partOfCollectionClicked,label:e.target.dataset.id})}showDatePickerModal(){var e,t,i;const{fullYearsHistogramAggregation:a}=this,r=a==null?void 0:a.first_bucket_key,l=a==null?void 0:a.last_bucket_key,n=a==null?void 0:a.buckets,p=c`
      <expanded-date-picker
        ${Il(f=>{if(f&&f instanceof Ie){const b=f;b.minSelectedDate=this.minSelectedDate,b.maxSelectedDate=this.maxSelectedDate}})}
        .minDate=${r}
        .maxDate=${l}
    ...
    `,v=new Sa({bodyColor:"#fff",headerColor:"#194880",showHeaderLogo:!1,closeOnBackdropClick:!0,title:c`Select a date range`});(e=this.modalManager)===null||e===void 0||e.classList.add("expanded-date-picker"),(t=this.modalManager)===null||t===void 0||t.showModal({config:v,customModalContent:p,userClosedModalCallback:this.handleExpandedDatePickerClosed}),(i=this.analyticsHandler)===null||i===void 0||i.sendEvent({category:Fe.default,action:se.histogramExpanded,label:window.location.href})}updated(e){e.has("selectedFacets")&&this.dispatchFacetsChangedEvent()}dispatchFacetsChangedEvent(){const e=new CustomEvent("facetsChanged",{detail:this.selectedFacets});this.dispatchEvent(e)}get expandDatePickerBtnTemplate(){return this.allowExpandingDatePicker&&!this.facetsLoading?c`<button
        ...
        >
          ...
          <histogram-date-range
            ...
            @histogramDateRangeUpdated=${this.histogramDateRangeUpdated}
          ></histogram-date-range>
        `}get mergedFacets(){const e=[];return Cl.forEach(t=>{var i,a;const r=this.selectedFacetGroups.find(v=>v.key===t),l=this.aggregationFacetGroups.find(v=>v.key===t);if(r&&!l){e.push(r);return}if(!l)return;const n=r!=null?r:l;let d=(i=r==null?void 0:r.buckets.map(v=>{const f=l.buckets.find(b=>b.key===v.key);return f?ve(X({},v),{count:f.count}):v}))!==null&&i!==void 0?i:[];l.buckets.forEach(v=>{d.find(b=>b.key===v.key)||d.push(v)});let p=(a=Object.keys((r==null?void 0:r.buckets)||[]))===null||a===void 0?void 0:a.length;if(p<this.allowedFacetCount&&(p=this.allowedFacetCount),t==="lending"&&(d=d.filter(v=>$l[v.key])),t==="mediatype"){const v=d.findIndex(f=>f.key==="collection");if(v>=p){const[f]=d.splice(v,1);d.splice(p-1,0,f),p>this.allowedFacetCount&&(p+=1)}}n.buckets=d.splice(0,p),e.push(n)}),e}get selectedFacetGroups(){return this.selectedFacets?Object.entries(this.selectedFacets).map(([t,i])=>{const a=t,r=Mi[a],l=Object.entries(i).map(([n,d])=>{var p;let v=n;return a==="lending"&&(v=(p=To[n])!==null&&p!==void 0?p:n),{displayText:v,key:n,count:d.count,state:d.state}});return{title:r,key:a,buckets:l}}):[]}get aggregationFacetGroups(){var e;const t=[];return Object.entries((e=this.aggregations)!==null&&e!==void 0?e:[]).forEach(([i,a])=>{if(i==="year_histogram")return;const r=i,l=Mi[r];if(!l)return;let n=a.getSortedBuckets(wa[r]);r==="collection"&&(n=n==null?void 0:n.filter(v=>{var f;const b=(f=v==null?void 0:v.key)===null||f===void 0?void 0:f.toString();return!Fa[b]&&!(b!=null&&b.startsWith("fav-"))}));const d=n.map(v=>{var f;const b=v.key;let w=`${v.key}`;return r==="lending"&&(w=(f=To[v.key])!==null&&f!==void 0?f:`${v.key}`),{displayText:w,key:`${b}`,count:v.doc_count,state:"none"}}),p={title:l,key:r,buckets:d};t.push(p)}),t}getFacetGroupTemplate(e){if(!this.facetsLoading&&e.buckets.length===0)return y;const{key:t}=e,i=this.openFacets[t],a=c`
      <span class="collapser ${i?"open":""}"> ${br} </span>
    `,r=()=>{const n=X({},this.openFacets);n[t]=!i,this.openFacets=n},l=`facet-group-header-label-${e.key}`;return c`
      <section
      ...
      >
        <div class="facet-group-header">
          <h3
            ...
            @keyup=${r}
          >
            ${this.collapsableFacets?a:y} ${e.title}
    ...
    `}getTombstoneFacetGroupTemplate(){return c`
      ${ki(Array(5).fill(null),()=>c`<facet-tombstone-row></facet-tombstone-row>`)}
    `}searchMoreFacetsLink(e){if(!this.moreLinksVisible||e.key==="lending"||Object.keys(e.buckets).length<this.allowedFacetCount)return y;const t=wa[e.key];return c`<button
      class="more-link"
      @click=${()=>{var i;this.showMoreFacetsModal(e,t),(i=this.analyticsHandler)===null||i===void 0||i.sendEvent({category:Fe.default,action:se.showMoreFacetsModal,label:e.key}),this.dispatchEvent(new CustomEvent("showMoreFacets",{detail:e.key}))}}
    >
      More...
    </button>`}async showMoreFacetsModal(e,t){var i,a;const r=e.key,l=c`
      <more-facets-content
        .analyticsHandler=${this.analyticsHandler}
        .facetKey=${e.key}
    ...
    `,n=new Sa({bodyColor:"#fff",headerColor:"#194880",showHeaderLogo:!1,closeOnBackdropClick:!0,title:c`Select filters`});(i=this.modalManager)===null||i===void 0||i.classList.add("more-search-facets"),(a=this.modalManager)===null||a===void 0||a.showModal({config:n,customModalContent:l,userClosedModalCallback:()=>{var d;(d=this.modalManager)===null||d===void 0||d.classList.remove("more-search-facets")}})}getFacetTemplate(e){return c`
      <facets-template
    ...
    `}static get styles(){return[Ge,m`
      ...
      `]}};s([h({type:Object})],N.prototype,"searchService",void 0);s([h({type:String})],N.prototype,"searchType",void 0);s([h({type:Object})],N.prototype,"aggregations",void 0);s([h({type:Object})],N.prototype,"fullYearsHistogramAggregation",void 0);s([h({type:String})],N.prototype,"minSelectedDate",void 0);s([h({type:String})],N.prototype,"maxSelectedDate",void 0);s([h({type:Boolean})],N.prototype,"moreLinksVisible",void 0);s([h({type:Boolean})],N.prototype,"facetsLoading",void 0);s([h({type:Boolean})],N.prototype,"fullYearAggregationLoading",void 0);s([h({type:Object})],N.prototype,"selectedFacets",void 0);s([h({type:Boolean})],N.prototype,"collapsableFacets",void 0);s([h({type:Number})],N.prototype,"contentWidth",void 0);s([h({type:Boolean})],N.prototype,"showHistogramDatePicker",void 0);s([h({type:Boolean})],N.prototype,"allowExpandingDatePicker",void 0);s([h({type:String})],N.prototype,"query",void 0);s([h({type:String})],N.prototype,"withinCollection",void 0);s([h({type:Array})],N.prototype,"parentCollections",void 0);s([h({type:Object})],N.prototype,"filterMap",void 0);s([h({type:String})],N.prototype,"baseNavigationUrl",void 0);s([h({type:String})],N.prototype,"collectionPagePath",void 0);s([h({type:Boolean})],N.prototype,"isManageView",void 0);s([h({type:Object,attribute:!1})],N.prototype,"modalManager",void 0);s([h({type:Object,attribute:!1})],N.prototype,"resizeObserver",void 0);s([h({type:Object,attribute:!1})],N.prototype,"featureFeedbackService",void 0);s([h({type:Object,attribute:!1})],N.prototype,"recaptchaManager",void 0);s([h({type:Object,attribute:!1})],N.prototype,"analyticsHandler",void 0);s([h({type:Object,attribute:!1})],N.prototype,"collectionNameCache",void 0);s([M()],N.prototype,"openFacets",void 0);N=s([A("collection-facets")],N);let Uo=class extends F{render(){return c`
      <div class="lds-ring">
        <div></div>
        <div></div>
        <div></div>
    ...
    `}};Uo=s([A("circular-activity-indicator")],Uo);/*! typescript-cookie v1.0.3 | MIT */const yr=o=>encodeURIComponent(o).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),wr=o=>encodeURIComponent(o).replace(/%(2[346BF]|3[AC-F]|40|5[BDE]|60|7[BCD])/g,decodeURIComponent),Ba=decodeURIComponent,Ia=o=>(o[0]==='"'&&(o=o.slice(1,-1)),o.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent));function mn(o){return o=Object.assign({},o),typeof o.expires=="number"&&(o.expires=new Date(Date.now()+o.expires*864e5)),o.expires!=null&&(o.expires=o.expires.toUTCString()),Object.entries(o).filter(([e,t])=>t!=null&&t!==!1).map(([e,t])=>t===!0?`; ${e}`:`; ${e}=${t.split(";")[0]}`).join("")}function xr(o,e,t){const i=/(?:^|; )([^=]*)=([^;]*)/g,a={};let r;for(;(r=i.exec(document.cookie))!=null;)try{const l=t(r[1]);if(a[l]=e(r[2],l),o===l)break}catch{}return o!=null?a[o]:a}const Ho=Object.freeze({decodeName:Ba,decodeValue:Ia,encodeName:yr,encodeValue:wr}),Oa=Object.freeze({path:"/"});function Di(o,e,t=Oa,{encodeValue:i=wr,encodeName:a=yr}={}){return document.cookie=`${a(o)}=${i(e,o)}${mn(t)}`}function ka(o,{decodeValue:e=Ia,decodeName:t=Ba}={}){return xr(o,e,t)}function fn({decodeValue:o=Ia,decodeName:e=Ba}={}){return xr(void 0,o,e)}function gn(o,e=Oa){Di(o,"",Object.assign({},e,{expires:-1}))}function Ta(o,e){const t={set:function(a,r,l){return Di(a,r,Object.assign({},this.attributes,l),{encodeValue:this.converter.write})},get:function(a){if(arguments.length===0)return fn(this.converter.read);if(a!=null)return ka(a,this.converter.read)},remove:function(a,r){gn(a,Object.assign({},this.attributes,r))},withAttributes:function(a){return Ta(this.converter,Object.assign({},this.attributes,a))},withConverter:function(a){return Ta(Object.assign({},this.converter,a),this.attributes)}},i={attributes:{value:Object.freeze(e)},converter:{value:Object.freeze(o)}};return Object.create(t,i)}Ta({read:Ho.decodeValue,write:Ho.encodeValue},Oa);function bn(o,e){return o===e?!0:o.length!==e.length?!1:o.every((t,i)=>t===e[i])}class yn{constructor(e){this.cookieDomain=".archive.org",this.cookieExpiration=30,this.cookiePath="/",this.context=e.context}persistState(e){e.displayMode&&this.persistViewStateToCookies(e.displayMode),this.persistQueryStateToUrl(e)}getRestorationState(){const e=this.loadQueryStateFromUrl(),t=this.loadTileViewStateFromCookies();return e.displayMode=t,e}persistViewStateToCookies(e){const t=e==="grid"?"tiles":"lists";Di(`view-${this.context}`,t,{domain:this.cookieDomain,expires:this.cookieExpiration,path:this.cookiePath});const i=e==="list-detail"?"showdetails":"";Di(`showdetails-${this.context}`,i,{domain:this.cookieDomain,expires:this.cookieExpiration,path:this.cookiePath})}loadTileViewStateFromCookies(){const e=ka(`view-${this.context}`),t=ka(`showdetails-${this.context}`);return e==="tiles"||e===void 0?"grid":t==="showdetails"?"list-detail":"list-compact"}persistQueryStateToUrl(e){var t,i,a;const r=new URL(window.location.href),l=new URLSearchParams(r.searchParams),n=this.removeRecognizedParams(r.searchParams);let d=!1;if(e.baseQuery&&n.set("query",e.baseQuery),e.searchType===pe.FULLTEXT&&n.set("sin","TXT"),l.get("sin")===""&&(l.delete("sin"),d=!0),e.currentPage&&(e.currentPage>1?n.set("page",e.currentPage.toString()):n.delete("page")),e.selectedSort){const f=fe[e.selectedSort];let b=this.sortDirectionPrefix(e.sortDirection);if(f.field===_.unrecognized){const w=(t=l.get("sort"))!==null&&t!==void 0?t:"",{field:S,direction:E}=this.getSortFieldAndDirection(w);e.sortDirection||(b=this.sortDirectionPrefix(E)),S?n.set("sort",`${b}${S}`):n.set("sort",w)}else if(f.shownInURL){const w=f.urlNames[0];n.set("sort",`${b}${w}`)}}if(e.selectedFacets)for(const[f,b]of Object.entries(e.selectedFacets)){const w=Object.entries(b);if(w.length!==0)for(const[S,E]of w){const B=E.state==="hidden",L=`${f}:"${S}"`;B?n.append("not[]",L):n.append("and[]",L)}}e.minSelectedDate&&e.maxSelectedDate&&n.append("and[]",`year:[${e.minSelectedDate} TO ${e.maxSelectedDate}]`),e.titleQuery&&n.append("and[]",e.titleQuery),e.creatorQuery&&n.append("and[]",e.creatorQuery);let p="pushState";const v=this.paramsMatch(l,n,["sin","sort","and[]","not[]"]);if(v&&this.paramsMatch(l,n,["query"])){if(d)n.delete("sin");else if(this.paramsMatch(l,n,["page"]))return;p="replaceState"}else v&&this.hasLegacyParam(l)&&(p="replaceState");(a=(i=window.history)[p])===null||a===void 0||a.call(i,{query:e.baseQuery,searchType:e.searchType,page:e.currentPage,sort:{field:e.selectedSort,direction:e.sortDirection},minDate:e.minSelectedDate,maxDate:e.maxSelectedDate,facets:e.selectedFacets},"",r)}loadQueryStateFromUrl(){var e;const t=new URL(window.location.href),i=t.searchParams.get("sin"),a=t.searchParams.get("page"),r=t.searchParams.get("query"),l=t.searchParams.get("sort"),n=t.searchParams.getAll("and[]"),d=t.searchParams.getAll("not[]");for(const[f,b]of t.searchParams.entries())/and\[\d+\]/.test(f)?n.push(b):/not\[\d+\]/.test(f)&&d.push(b);const p=(e=t.searchParams.get("q"))!==null&&e!==void 0?e:t.searchParams.get("search"),v={selectedFacets:ii()};switch(r?v.baseQuery=r:p&&(v.baseQuery=p),i){case"TXT":v.searchType=pe.FULLTEXT;break;default:v.searchType=pe.METADATA;break}if(a){const f=parseInt(a,10);v.currentPage=f}else v.currentPage=1;if(l){const{field:f,direction:b}=this.getSortFieldAndDirection(l),w=fr(f);v.selectedSort=w.field,["asc","desc"].includes(b)&&(v.sortDirection=b)}return n&&n.forEach(f=>{let[b,w]=f.split(":");if(b=b.replace(/Sorter$/,""),b.startsWith("-")){d.push(f.slice(1));return}switch(b){case"year":{const[S,E]=w.split(" TO ");S&&E?(v.minSelectedDate=S.substring(1,S.length),v.maxSelectedDate=E.substring(0,E.length-1)):this.setSelectedFacetState(v.selectedFacets,b,w,"selected");break}case"firstTitle":v.selectedTitleFilter=w;break;case"firstCreator":v.selectedCreatorFilter=w;break;default:this.setSelectedFacetState(v.selectedFacets,b,w,"selected")}}),d&&d.forEach(f=>{const[b,w]=f.split(":");this.setSelectedFacetState(v.selectedFacets,b,w,"hidden")}),v}getSortFieldAndDirection(e){const t=e.indexOf(" ")>-1;let i,a;return t?[i,a]=e.split(" "):(i=e.startsWith("-")?e.slice(1):e,a=e.startsWith("-")?"desc":"asc"),{field:i,direction:a}}sortDirectionPrefix(e){return e==="desc"?"-":""}stripQuotes(e){return e.startsWith('"')&&e.endsWith('"')?e.substring(1,e.length-1):e}paramsMatch(e,t,i){return i.every(a=>bn(e.getAll(a).sort(),t.getAll(a).sort()))}removeRecognizedParams(e){e.delete("query"),e.delete("sin"),e.delete("page"),e.delete("sort"),e.delete("and[]"),e.delete("not[]");for(const t of e.keys())/(and|not)\[\d+\]/.test(t)&&e.delete(t);return e.delete("q"),e.delete("search"),e}hasLegacyParam(e){return e.has("q")||e.has("search")}setSelectedFacetState(e,t,i,a){var r;const l=e[t];if(!l)return;const n=this.stripQuotes(i);(r=l[n])!==null&&r!==void 0||(l[n]=this.getDefaultBucket(i)),l[n].state=a}getDefaultBucket(e){return{key:e,count:0,state:"none"}}}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const wn=(o,e,t)=>{for(const i of e)if(i[0]===o)return(0,i[1])();return t==null?void 0:t()};var xn=O`
...
`,Le;let xe=Le=class extends F{constructor(){super(...arguments),this.placeholderType=null,this.detailMessage=""}render(){return this.placeholderType?c`${this.placeholderTemplate}`:y}get placeholderTemplate(){return c`
      <div
        class="placeholder ${this.placeholderType} ${this.isMobileView?"mobile":"desktop"}"
      >
        ${wn(this.placeholderType,[["empty-query",()=>this.emptyQueryTemplate],["empty-collection",()=>this.emptyCollectionTemplate],["no-results",()=>this.noResultsTemplate],["query-error",()=>this.queryErrorTemplate],["collection-error",()=>this.collectionErrorTemplate]])}
      </div>
    ...
    `}};xe.MESSAGE_EMPTY_QUERY=D('To begin searching, enter a search term in the box above and hit "Go".');xe.MESSAGE_NO_SEARCH_RESULTS=D("Your search did not match any items in the Archive. Try different keywords or a more general search.");xe.MESSAGE_NO_COLLECTION_RESULTS=D("Your search did not match any items in this collection. Try different keywords or a more general search.");xe.MESSAGE_NO_VIEWABLE_MEMBERS=D("This collection contains no viewable items.");xe.MESSAGE_QUERY_ERROR=D(c`The search engine
    encountered an error, which might be related to your search query.
    <a
      href="https://help.archive.org/help/search-building-powerful-complex-queries/"
    >
      Tips for constructing search queries.
    </a> `);xe.MESSAGE_COLLECTION_ERROR=D(c`The search engine
    encountered an error while loading this collection. If the problem persists,
    please let us know at
    <a href="mailto:info@archive.org">info@archive.org</a>.`);xe.QUERY_ERROR_DETAILS_MESSAGE=D("Error details:");s([h({type:String})],xe.prototype,"placeholderType",void 0);s([h({type:Boolean})],xe.prototype,"isMobileView",void 0);s([h({type:Boolean})],xe.prototype,"isCollection",void 0);s([h({type:String})],xe.prototype,"detailMessage",void 0);xe=Le=s([A("empty-placeholder")],xe);const _n=new TextEncoder;async function Vo(o){const e=await crypto.subtle.digest("SHA-1",_n.encode(o));return[...new Uint8Array(e)].map(t=>t.toString(16).padStart(2,"0")).join("")}let z=class extends F{constructor(){super(...arguments),this.baseImageUrl="https://archive.org",this.searchType=pe.METADATA,this.sortParam=null,this.defaultSortParam=null,this.selectedSort=_.default,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.sortDirection=null,this.pageSize=50,this.showHistogramDatePicker=!1,this.collectionPagePath="/details/",this.parentCollections=[],this.searchContext=Fe.default,this.pageContext="search",this.restorationStateHandler=new yn({context:this.pageContext}),this.mobileBreakpoint=600,this.loggedIn=!1,this.modalManager=void 0,this.isManageView=!1,this.initialPageNumber=1,this.pagesToRender=this.initialPageNumber,this.searchResultsLoading=!1,this.facetsLoading=!1,this.fullYearAggregationLoading=!1,this.mobileView=!1,this.mobileFacetsVisible=!1,this.defaultSortField=_.relevance,this.defaultSortDirection=null,this.placeholderType=null,this.prefixFilterCountMap={},this.isScrollingToCell=!1,this.endOfDataReached=!1,this.isResizeToMobile=!1,this.placeholderCellTemplate=c`<collection-browser-loading-tile></collection-browser-loading-tile>`,this.dataSource={},this.tileModelOffset=0,this.updateLeftColumnHeight=()=>{var e,t,i,a,r;if(this.mobileView)(t=(e=this.leftColumn)===null||e===void 0?void 0:e.style)===null||t===void 0||t.removeProperty("height");else{const l=(i=this.leftColumn)===null||i===void 0?void 0:i.getBoundingClientRect().top;(r=(a=this.leftColumn)===null||a===void 0?void 0:a.style)===null||r===void 0||r.setProperty("height",`${window.innerHeight-(l!=null?l:0)-3}px`)}},this.updateFacetFadeOut=e=>{var t,i;const a=(t=this.shadowRoot)===null||t===void 0?void 0:t.getElementById("facets-bottom-fade");a==null||a.classList.toggle("hidden",(i=e==null?void 0:e[0])===null||i===void 0?void 0:i.isIntersecting)},this.initialQueryChangeHappened=!1,this.historyPopOccurred=!1,this._initialSearchCompletePromise=new Promise(e=>{this._initialSearchCompleteResolver=e}),this.pageFetchesInProgress={}}tileModelAtCellIndex(e){var t;const i=e+this.tileModelOffset,a=Math.floor(i/this.pageSize)+1,r=i%this.pageSize,l=(t=this.dataSource[a])===null||t===void 0?void 0:t[r];return!l&&!this.isScrollingToCell&&this.fetchPage(a),l}get sortFilterQueries(){return[this.titleQuery,this.creatorQuery].filter(t=>t).join(" AND ")}get estimatedTileCount(){return this.pagesToRender*this.pageSize}async getSessionId(){try{const e=sessionStorage==null?void 0:sessionStorage.getItem("cb-session");if(e)return e;if(this.sessionIdGenPromise)return this.sessionIdGenPromise;this.sessionIdGenPromise=Vo(Math.random().toString());const t=await this.sessionIdGenPromise;return sessionStorage==null||sessionStorage.setItem("cb-session",t),t}catch{return""}}goToPage(e){return this.initialPageNumber=e,this.pagesToRender=e,this.scrollToPage(e)}clearFilters({facets:e=!0,dateRange:t=!0,letterFilters:i=!0,sort:a=!1}={}){e&&this.hasCheckedFacets&&(this.selectedFacets=ii()),t&&(this.minSelectedDate=void 0,this.maxSelectedDate=void 0),i&&(this.selectedTitleFilter=null,this.selectedCreatorFilter=null),a&&(this.sortParam=null,this.sortDirection=null,this.selectedSort=_.default)}get hasCheckedFacets(){if(!this.selectedFacets)return!1;for(const e of Object.values(this.selectedFacets))for(const t of Object.values(e))if(t.state!=="none")return!0;return!1}get hasActiveFilters(){return!!(this.hasCheckedFacets||this.minSelectedDate||this.maxSelectedDate||this.selectedTitleFilter||this.selectedCreatorFilter)}render(){return this.setPlaceholderType(),c`
      <div
    ...
    </div>`}get resultsCountTemplate(){var e;const t=this.searchResultsLoading||this.totalResults===void 0,i=(e=this.totalResults)===null||e===void 0?void 0:e.toLocaleString(),a=this.totalResults===1?"Result":"Results";return c`
    ...
    ></infinite-scroller>`}get infiniteScrollerClasses(){var e;return Lt({[(e=this.displayMode)!==null&&e!==void 0?e:""]:!!this.displayMode,hidden:!!this.placeholderType})}get sortFilterBarTemplate(){var e;return c`
      <sort-filter-bar
    ...
    `}get manageBarTemplate(){return c`
      ...
      ></manage-bar>
    `}handleRemoveItems(){this.dispatchEvent(new CustomEvent("itemRemovalRequested",{detail:{items:this.checkedTileModels.map(e=>ve(X({},e),{date:ei(e.datePublished,"long")}))}}))}removeCheckedTiles(){const{checkedTileModels:e,uncheckedTileModels:t}=this,i=e.length;if(i===0)return;this.tileModelOffset+=i;const a={};let r=Math.floor(this.tileModelOffset/this.pageSize)+1,l=this.tileModelOffset%this.pageSize;for(let n=1;n<=r;n+=1){const d=this.tileModelOffset-this.pageSize*(n-1),p=Math.min(this.pageSize,d);a[n]=Array(p).fill(void 0)}for(const n of t)a[r]||(a[r]=[]),a[r].push(n),l+=1,l>=this.pageSize&&(r+=1,l=0);this.dataSource=a,this.totalResults&&(this.totalResults-=i),this.infiniteScroller&&(this.infiniteScroller.itemCount-=i,this.infiniteScroller.refreshAllVisibleCells())}checkAllTiles(){this.mapDataSource(e=>ve(X({},e),{checked:!0}))}uncheckAllTiles(){this.mapDataSource(e=>ve(X({},e),{checked:!1}))}mapDataSource(e){var t;this.dataSource=Object.fromEntries(Object.entries(this.dataSource).map(([i,a])=>[i,a.map((r,l,n)=>r&&e(r,l,n))])),(t=this.infiniteScroller)===null||t===void 0||t.refreshAllVisibleCells()}get checkedTileModels(){return this.getFilteredTileModels(e=>e.checked)}get uncheckedTileModels(){return this.getFilteredTileModels(e=>!e.checked)}getFilteredTileModels(e){return Object.values(this.dataSource).flat().filter((t,i,a)=>t?e(t,i,a):!1)}userChangedSort(e){var t;const{selectedSort:i,sortDirection:a}=e.detail;this.selectedSort=i,this.sortDirection=a,((t=this.currentPage)!==null&&t!==void 0?t:1)>1&&this.goToPage(1),this.currentPage=1}sendSortByAnalytics(e){var t;const i=e&&!this.sortDirection;(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:this.searchContext,action:se.sortBy,label:`${this.selectedSort}${this.sortDirection||i?`-${this.sortDirection}`:""}`})}selectedSortChanged(){var e;const t=fe[this.selectedSort];if(!t.handledBySearchService){this.sortParam=null;return}const i=new URL(window.location.href).searchParams.get("sort"),a=(e=t.searchServiceKey)!==null&&e!==void 0?e:i==null?void 0:i.replace(/^-/,"");this.sortDirection||(this.sortDirection="asc"),a&&(this.sortParam={field:a,direction:this.sortDirection},this.updatePrefixFiltersForCurrentSort())}displayModeChanged(e){var t;this.displayMode=e.detail.displayMode,this.displayMode&&((t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:this.searchContext,action:se.displayMode,label:this.displayMode}))}get titleQuery(){return this.selectedTitleFilter?`firstTitle:${this.selectedTitleFilter}`:void 0}get creatorQuery(){return this.selectedCreatorFilter?`firstCreator:${this.selectedCreatorFilter}`:void 0}sendFilterByTitleAnalytics(e){var t;if(!e&&!this.selectedTitleFilter)return;const i=e&&!this.selectedTitleFilter;(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:this.searchContext,action:se.filterByTitle,label:i?`clear-${e}`:`${e||"start"}-${this.selectedTitleFilter}`})}sendFilterByCreatorAnalytics(e){var t;if(!e&&!this.selectedCreatorFilter)return;const i=e&&!this.selectedCreatorFilter;(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:this.searchContext,action:se.filterByCreator,label:i?`clear-${e}`:`${e||"start"}-${this.selectedCreatorFilter}`})}titleLetterSelected(e){this.selectedCreatorFilter=null,this.selectedTitleFilter=e.detail.selectedLetter}creatorLetterSelected(e){this.selectedTitleFilter=null,this.selectedCreatorFilter=e.detail.selectedLetter}get mobileFacetsTemplate(){const e=()=>{this.isResizeToMobile=!1,this.mobileFacetsVisible=!this.mobileFacetsVisible};return c`
      <details
    ...
    `}histogramDateRangeUpdated(e){var t;const{minDate:i,maxDate:a}=e.detail;[this.minSelectedDate,this.maxSelectedDate]=[i,a],(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:this.searchContext,action:se.histogramChanged,label:this.dateRangeQueryClause})}get dateRangeQueryClause(){if(!(!this.minSelectedDate||!this.maxSelectedDate))return`year:[${this.minSelectedDate} TO ${this.maxSelectedDate}]`}emitManageModeChangedEvent(){this.dispatchEvent(new CustomEvent("manageModeChanged",{detail:this.isManageView}))}firstUpdated(){this.setupStateRestorationObserver(),this.restoreState()}updated(e){var t,i;if(e.has("placeholderType")&&this.placeholderType===null&&(this.leftColIntersectionObserver||this.setupLeftColumnScrollListeners(),this.facetsIntersectionObserver||this.setupFacetsScrollListeners(),this.updateLeftColumnHeight()),(e.has("displayMode")||e.has("baseNavigationUrl")||e.has("baseImageUrl")||e.has("loggedIn"))&&((t=this.infiniteScroller)===null||t===void 0||t.reload()),(e.has("baseQuery")||e.has("searchType")||e.has("withinCollection"))&&!this.historyPopOccurred&&this.initialQueryChangeHappened){const a=e.has("withinCollection")&&!e.has("selectedSort")&&!e.has("sortDirection");this.clearFilters({sort:a,facets:!e.has("selectedFacets"),dateRange:!(e.has("minSelectedDate")||e.has("maxSelectedDate")),letterFilters:!(e.has("selectedTitleFilter")||e.has("selectedCreatorFilter"))})}if(e.has("baseQuery")&&this.emitBaseQueryChanged(),e.has("searchType")&&this.emitSearchTypeChanged(),(e.has("currentPage")||e.has("displayMode"))&&this.persistState(),(e.has("baseQuery")||e.has("minSelectedDate")||e.has("maxSelectedDate")||e.has("selectedFacets")||e.has("searchService")||e.has("withinCollection"))&&this.refreshLetterCounts(),e.has("selectedSort")||e.has("sortDirection")){const a=e.get("sortDirection");this.sendSortByAnalytics(a),this.selectedSortChanged()}if(e.has("selectedTitleFilter")&&this.sendFilterByTitleAnalytics(e.get("selectedTitleFilter")),e.has("selectedCreatorFilter")&&this.sendFilterByCreatorAnalytics(e.get("selectedCreatorFilter")),(e.has("baseQuery")||e.has("searchType")||e.has("selectedTitleFilter")||e.has("selectedCreatorFilter")||e.has("minSelectedDate")||e.has("maxSelectedDate")||e.has("sortParam")||e.has("selectedFacets")||e.has("searchService")||e.has("withinCollection"))&&this.handleQueryChange(),e.has("searchResultsLoading")&&this.emitSearchResultsLoadingChanged(),e.has("facetsLoading")&&this.facetsLoading&&this.collectionFacets&&(this.collectionFacets.moreLinksVisible=this.searchType!==pe.FULLTEXT),e.has("pagesToRender")&&!this.endOfDataReached&&this.infiniteScroller&&(this.infiniteScroller.itemCount=this.estimatedTileCount),e.has("isManageView")&&(this.isManageView&&(this.displayMode="grid"),(i=this.infiniteScroller)===null||i===void 0||i.refreshAllVisibleCells(),this.emitManageModeChangedEvent()),e.has("resizeObserver")){const a=e.get("resizeObserver");a&&this.disconnectResizeObserver(a),this.setupResizeObserver()}}disconnectedCallback(){var e,t;this.resizeObserver&&this.disconnectResizeObserver(this.resizeObserver),this.boundNavigationHandler&&window.removeEventListener("popstate",this.boundNavigationHandler),(e=this.leftColIntersectionObserver)===null||e===void 0||e.disconnect(),(t=this.facetsIntersectionObserver)===null||t===void 0||t.disconnect(),window.removeEventListener("resize",this.updateLeftColumnHeight)}handleResize(e){const t=this.mobileView;e.target===this.contentContainer&&(this.contentWidth=e.contentRect.width,this.mobileView=this.contentWidth>0&&this.contentWidth<this.mobileBreakpoint,this.mobileView&&!t&&(this.isResizeToMobile=!0)),this.updateLeftColumnHeight()}setupLeftColumnScrollListeners(){var e;const t=(e=this.shadowRoot)===null||e===void 0?void 0:e.querySelector("#left-column-scroll-sentinel");t&&(this.leftColIntersectionObserver=new IntersectionObserver(this.updateLeftColumnHeight,{threshold:[...Array(101).keys()].map(i=>i/100)}),this.leftColIntersectionObserver.observe(t)),window.addEventListener("resize",this.updateLeftColumnHeight)}setupFacetsScrollListeners(){var e;const t=(e=this.shadowRoot)===null||e===void 0?void 0:e.querySelector("#facets-scroll-sentinel");t&&(this.facetsIntersectionObserver=new IntersectionObserver(this.updateFacetFadeOut),this.facetsIntersectionObserver.observe(t))}emitBaseQueryChanged(){this.dispatchEvent(new CustomEvent("baseQueryChanged",{detail:{baseQuery:this.baseQuery}}))}emitSearchTypeChanged(){this.dispatchEvent(new CustomEvent("searchTypeChanged",{detail:this.searchType}))}emitEmptyResults(){this.dispatchEvent(new Event("emptyResults"))}disconnectResizeObserver(e){e.removeObserver({target:this.contentContainer,handler:this})}setupResizeObserver(){!this.resizeObserver||this.resizeObserver.addObserver({target:this.contentContainer,handler:this})}visibleCellsChanged(e){if(this.isScrollingToCell)return;const{visibleCellIndices:t}=e.detail;if(t.length===0)return;const i=t[t.length-1],a=Math.floor(i/this.pageSize)+1;this.currentPage!==a&&(this.currentPage=a);const r=new CustomEvent("visiblePageChanged",{detail:{pageNumber:a}});this.dispatchEvent(r)}get initialSearchComplete(){return this._initialSearchCompletePromise}async handleQueryChange(){var e;!this.searchService||this.pageFetchQueryKey===this.previousQueryKey||!this.canPerformSearch||(this.previousQueryKey=this.pageFetchQueryKey,this.dataSource={},this.tileModelOffset=0,this.totalResults=void 0,this.aggregations=void 0,this.fullYearsHistogramAggregation=void 0,this.pageFetchesInProgress={},this.endOfDataReached=!1,this.pagesToRender=this.initialPageNumber===1?2:this.initialPageNumber,this.queryErrorMessage=void 0,this.infiniteScroller&&(this.infiniteScroller.itemCount=this.estimatedTileCount,this.infiniteScroller.reload()),this.withinCollection&&((e=this.baseQuery)===null||e===void 0?void 0:e.trim())&&(this.defaultSortField=_.relevance,this.defaultSortDirection=null),!this.initialQueryChangeHappened&&this.initialPageNumber>1&&this.scrollToPage(this.initialPageNumber),this.initialQueryChangeHappened=!0,this.historyPopOccurred||this.persistState(),this.historyPopOccurred=!1,this._initialSearchCompletePromise=new Promise(t=>{this._initialSearchCompleteResolver=t}),await Promise.all([this.doInitialPageFetch(),this.fetchFacets()]),this._initialSearchCompleteResolver(!0))}setupStateRestorationObserver(){this.boundNavigationHandler||(this.boundNavigationHandler=this.historyNavigationHandler.bind(this),window.addEventListener("popstate",this.boundNavigationHandler))}historyNavigationHandler(){this.historyPopOccurred=!0,this.restoreState()}restoreState(){var e,t,i,a,r;const l=this.restorationStateHandler.getRestorationState();this.displayMode=l.displayMode,l.searchType!=null&&(this.searchType=l.searchType),this.selectedSort=(e=l.selectedSort)!==null&&e!==void 0?e:_.default,this.sortDirection=(t=l.sortDirection)!==null&&t!==void 0?t:null,this.selectedTitleFilter=(i=l.selectedTitleFilter)!==null&&i!==void 0?i:null,this.selectedCreatorFilter=(a=l.selectedCreatorFilter)!==null&&a!==void 0?a:null,this.selectedFacets=l.selectedFacets,this.baseQuery=l.baseQuery,this.currentPage=(r=l.currentPage)!==null&&r!==void 0?r:1,this.minSelectedDate=l.minSelectedDate,this.maxSelectedDate=l.maxSelectedDate,this.currentPage>1&&this.goToPage(this.currentPage)}persistState(){var e,t,i,a;const r={displayMode:this.displayMode,searchType:this.searchType,selectedSort:this.selectedSort,sortDirection:(e=this.sortDirection)!==null&&e!==void 0?e:void 0,selectedFacets:(t=this.selectedFacets)!==null&&t!==void 0?t:ii(),baseQuery:this.baseQuery,currentPage:this.currentPage,titleQuery:this.titleQuery,creatorQuery:this.creatorQuery,minSelectedDate:this.minSelectedDate,maxSelectedDate:this.maxSelectedDate,selectedTitleFilter:(i=this.selectedTitleFilter)!==null&&i!==void 0?i:void 0,selectedCreatorFilter:(a=this.selectedCreatorFilter)!==null&&a!==void 0?a:void 0};this.restorationStateHandler.persistState(r)}async doInitialPageFetch(){this.searchResultsLoading=!0,await this.fetchPage(this.initialPageNumber,2),this.searchResultsLoading=!1}emitSearchResultsLoadingChanged(){this.dispatchEvent(new CustomEvent("searchResultsLoadingChanged",{detail:{loading:this.searchResultsLoading}}))}async requestUID(e,t){var i;const a=JSON.stringify({pageType:e.pageType,pageTarget:e.pageTarget,query:e.query,fields:e.fields,filters:e.filters,sort:e.sort,searchType:this.searchType}),r=(await Vo(a)).slice(0,20),l=(await this.getSessionId()).slice(0,20),n=(i=e.page)!==null&&i!==void 0?i:0,d=t.charAt(0),p=Date.now();return`R:${r}-S:${l}-P:${n}-K:${d}-T:${p}`}get filterMap(){const e=new Qr;if(this.minSelectedDate&&e.addFilter("year",this.minSelectedDate,Ye.GREATER_OR_EQUAL),this.maxSelectedDate&&e.addFilter("year",this.maxSelectedDate,Ye.LESS_OR_EQUAL),this.selectedFacets)for(const[i,a]of Object.entries(this.selectedFacets)){const{name:r,values:l}=this.prepareFacetForFetch(i,a);for(const[n,d]of Object.entries(l)){let p;d.state==="selected"?p=Ye.INCLUDE:d.state==="hidden"&&(p=Ye.EXCLUDE),p&&e.addFilter(r,n,p)}}return this.selectedTitleFilter&&e.addFilter("firstTitle",this.selectedTitleFilter,Ye.INCLUDE),this.selectedCreatorFilter&&e.addFilter("firstCreator",this.selectedCreatorFilter,Ye.INCLUDE),e.build()}get fullQuery(){var e,t;let i=(t=(e=this.baseQuery)===null||e===void 0?void 0:e.trim())!==null&&t!==void 0?t:"";const{facetQuery:a,dateRangeQueryClause:r,sortFilterQueries:l}=this;return a&&(i+=` AND ${a}`),r&&(i+=` AND ${r}`),l&&(i+=` AND ${l}`),i.trim()}get facetQuery(){var e;if(!this.selectedFacets)return;const t=[];for(const[i,a]of Object.entries(this.selectedFacets))t.push(this.buildFacetClause(i,a));return(e=this.joinFacetClauses(t))===null||e===void 0?void 0:e.trim()}buildFacetClause(e,t){const{name:i,values:a}=this.prepareFacetForFetch(e,t),r=Object.entries(a);if(r.length===0)return"";const l=[];for(const[d,p]of r){const v=p.state==="hidden"?"-":"";l.push(`${v}"${d}"`)}const n=l.join(" OR ");return`${i}:(${n})`}prepareFacetForFetch(e,t){let[i,a]=[e,t];return e==="lending"&&(i="lending___status"),{name:i,values:a}}joinFacetClauses(e){const t=e.filter(i=>i.length>0);return t.length>0?`(${t.join(" AND ")})`:void 0}facetsChanged(e){this.selectedFacets=e.detail}facetClickHandler({detail:{key:e,state:t,negative:i}}){var a,r;i?(a=this.analyticsHandler)===null||a===void 0||a.sendEvent({category:this.searchContext,action:t!=="none"?se.facetNegativeSelected:se.facetNegativeDeselected,label:e}):(r=this.analyticsHandler)===null||r===void 0||r.sendEvent({category:this.searchContext,action:t!=="none"?se.facetSelected:se.facetDeselected,label:e})}async fetchFacets(){var e,t,i,a,r,l,n,d,p,v,f,b;const w=(e=this.baseQuery)===null||e===void 0?void 0:e.trim();if(!this.canPerformSearch)return;const{facetFetchQueryKey:S}=this,E=this.sortParam?[this.sortParam]:[],B=ve(X({},this.collectionParams),{query:w||"",rows:0,filters:this.filterMap,aggregationsSize:10});B.uid=await this.requestUID(ve(X({},B),{sort:E}),"aggregations"),this.facetsLoading=!0;const L=await((t=this.searchService)===null||t===void 0?void 0:t.search(B,this.searchType)),U=L==null?void 0:L.success;if(S!==this.facetFetchQueryKey)return;if(!U){const te=(i=L==null?void 0:L.error)===null||i===void 0?void 0:i.message,W=(r=(a=L==null?void 0:L.error)===null||a===void 0?void 0:a.details)===null||r===void 0?void 0:r.message;!te&&!W&&((n=(l=window==null?void 0:window.Sentry)===null||l===void 0?void 0:l.captureMessage)===null||n===void 0||n.call(l,"Missing or malformed facet response from backend","error"));return}const{aggregations:K,collectionTitles:ne}=U.response;this.aggregations=K,ne?(d=this.collectionNameCache)===null||d===void 0||d.addKnownTitles(ne):!((p=this.aggregations)===null||p===void 0)&&p.collection&&((v=this.collectionNameCache)===null||v===void 0||v.preloadIdentifiers(this.aggregations.collection.buckets.map(te=>{var W;return(W=te.key)===null||W===void 0?void 0:W.toString()}))),this.fullYearsHistogramAggregation=(b=(f=U==null?void 0:U.response)===null||f===void 0?void 0:f.aggregations)===null||b===void 0?void 0:b.year_histogram,this.facetsLoading=!1}scrollToPage(e){return new Promise(t=>{const i=this.pageSize*(e-1);setTimeout(()=>{var a;this.isScrollingToCell=!0,(a=this.infiniteScroller)===null||a===void 0||a.scrollToCell(i,!0),setTimeout(()=>{var r;this.isScrollingToCell=!1,(r=this.infiniteScroller)===null||r===void 0||r.refreshAllVisibleCells(),t()},500)},0)})}get isRelevanceSortAvailable(){var e;return!!(!((e=this.baseQuery)===null||e===void 0)&&e.trim())}get canPerformSearch(){var e;if(!this.searchService)return!1;const i=!!((e=this.baseQuery)===null||e===void 0?void 0:e.trim()),a=!!this.withinCollection,r=this.searchType===pe.METADATA;return i||a&&r}get collectionParams(){return this.withinCollection?{pageType:"collection_details",pageTarget:this.withinCollection}:null}get pageFetchQueryKey(){var e,t,i,a;const r=(t=(e=this.sortParam)===null||e===void 0?void 0:e.field)!==null&&t!==void 0?t:"none",l=(a=(i=this.sortParam)===null||i===void 0?void 0:i.direction)!==null&&a!==void 0?a:"none";return`${this.fullQuery}-${this.withinCollection}-${this.searchType}-${r}-${l}`}get facetFetchQueryKey(){return`${this.fullQuery}-${this.withinCollection}-${this.searchType}`}async fetchPage(e,t=1){var i,a,r,l,n,d,p,v,f,b,w,S,E;const B=(i=this.baseQuery)===null||i===void 0?void 0:i.trim();if(!this.canPerformSearch||this.dataSource[e]||this.endOfDataReached)return;const L=e===1?t:1,U=this.pageSize*L,{pageFetchQueryKey:re}=this,K=(a=this.pageFetchesInProgress[re])!==null&&a!==void 0?a:new Set;if(K.has(e))return;for(let R=0;R<L;R+=1)K.add(e+R);this.pageFetchesInProgress[re]=K;const ne=this.sortParam?[this.sortParam]:[],te=ve(X({},this.collectionParams),{query:B||"",page:e,rows:U,sort:ne,filters:this.filterMap,aggregations:{omit:!0}});te.uid=await this.requestUID(te,"hits");const W=await((r=this.searchService)===null||r===void 0?void 0:r.search(te,this.searchType)),Ee=W==null?void 0:W.success;if(re!==this.pageFetchQueryKey)return;if(!Ee){const R=(l=W==null?void 0:W.error)===null||l===void 0?void 0:l.message,ye=(d=(n=W==null?void 0:W.error)===null||n===void 0?void 0:n.details)===null||d===void 0?void 0:d.message;this.queryErrorMessage=`${R!=null?R:""}${ye?`; ${ye}`:""}`,this.queryErrorMessage||(this.queryErrorMessage="Missing or malformed response from backend",(v=(p=window==null?void 0:window.Sentry)===null||p===void 0?void 0:p.captureMessage)===null||v===void 0||v.call(p,this.queryErrorMessage,"error"));for(let Se=0;Se<L;Se+=1)(f=this.pageFetchesInProgress[re])===null||f===void 0||f.delete(e+Se);this.searchResultsLoading=!1;return}this.totalResults=Ee.response.totalResults-this.tileModelOffset,this.totalResults===0&&this.emitEmptyResults(),this.withinCollection&&(this.collectionInfo=Ee.response.collectionExtraInfo,this.applyDefaultCollectionSort(this.collectionInfo),this.collectionInfo&&(this.parentCollections=[].concat((w=(b=this.collectionInfo.public_metadata)===null||b===void 0?void 0:b.collection)!==null&&w!==void 0?w:[])));const{results:Ce,collectionTitles:qe}=Ee.response;if(Ce&&Ce.length>0){qe?(S=this.collectionNameCache)===null||S===void 0||S.addKnownTitles(qe):this.preloadCollectionNames(Ce);for(let R=0;R<L;R+=1){const ye=this.pageSize*R;this.updateDataSource(e+R,Ce.slice(ye,ye+this.pageSize))}}U-Ce.length>0&&(this.endOfDataReached=!0,this.infiniteScroller&&(this.infiniteScroller.itemCount=this.totalResults));for(let R=0;R<L;R+=1)(E=this.pageFetchesInProgress[re])===null||E===void 0||E.delete(e+R)}preloadCollectionNames(e){var t;const i=e.map(r=>{var l;return(l=r.collection)===null||l===void 0?void 0:l.values}).flat(),a=Array.from(new Set(i));(t=this.collectionNameCache)===null||t===void 0||t.preloadIdentifiers(a)}applyDefaultCollectionSort(e){var t,i,a;if(this.baseQuery){this.defaultSortField=_.relevance,this.defaultSortDirection=null;return}const r=!((i=(t=e==null?void 0:e.public_metadata)===null||t===void 0?void 0:t.identifier)===null||i===void 0)&&i.startsWith("fav-")?"-favoritedate":"-week",l=(a=e==null?void 0:e.public_metadata)===null||a===void 0?void 0:a["sort-by"],n=l!=null?l:r;let[d,p]=n.split(":");d.startsWith("-")?(d=d.slice(1),p="desc"):["asc","desc"].includes(p)||(p="asc");const f=fr(d).field;f&&f!==_.default&&(this.defaultSortField=f,this.defaultSortDirection=p,this.defaultSortParam={field:this.defaultSortField,direction:this.defaultSortDirection})}get currentVisiblePageNumbers(){var e,t;const i=(t=(e=this.infiniteScroller)===null||e===void 0?void 0:e.getVisibleCellIndices())!==null&&t!==void 0?t:[],a=new Set;return i.forEach(r=>{const l=Math.floor(r/this.pageSize)+1;a.add(l)}),Array.from(a)}updateDataSource(e,t){var i;const a=X({},this.dataSource),r=[];t==null||t.forEach(d=>{var p,v,f,b,w,S,E,B,L,U,re,K,ne,te,W,Ee,gt,Ce,qe,it,R,ye,Se,It,Ot,Rt,bt,at,Y,yt,ie,wt,G,Oe,ot,xt,rt,_t,De,$e;if(!d.identifier)return;let st=!1,lt=!1;if(((p=d.collection)===null||p===void 0?void 0:p.values.length)&&((v=d.mediatype)===null||v===void 0?void 0:v.value)!=="collection"){for(const Re of(b=(f=d.collection)===null||f===void 0?void 0:f.values)!==null&&b!==void 0?b:[])if(Re==="loggedin"&&(st=!0,lt)||Re==="no-preview"&&(lt=!0,st))break}r.push({averageRating:(w=d.avg_rating)===null||w===void 0?void 0:w.value,checked:!1,collections:(E=(S=d.collection)===null||S===void 0?void 0:S.values)!==null&&E!==void 0?E:[],collectionFilesCount:(L=(B=d.collection_files_count)===null||B===void 0?void 0:B.value)!==null&&L!==void 0?L:0,collectionSize:(re=(U=d.collection_size)===null||U===void 0?void 0:U.value)!==null&&re!==void 0?re:0,commentCount:(ne=(K=d.num_reviews)===null||K===void 0?void 0:K.value)!==null&&ne!==void 0?ne:0,creator:(te=d.creator)===null||te===void 0?void 0:te.value,creators:(Ee=(W=d.creator)===null||W===void 0?void 0:W.values)!==null&&Ee!==void 0?Ee:[],dateAdded:(gt=d.addeddate)===null||gt===void 0?void 0:gt.value,dateArchived:(Ce=d.publicdate)===null||Ce===void 0?void 0:Ce.value,datePublished:(qe=d.date)===null||qe===void 0?void 0:qe.value,dateReviewed:(it=d.reviewdate)===null||it===void 0?void 0:it.value,description:(R=d.description)===null||R===void 0?void 0:R.values.join(`
`),favCount:(Se=(ye=d.num_favorites)===null||ye===void 0?void 0:ye.value)!==null&&Se!==void 0?Se:0,href:this.collapseRepeatedQuotes((It=d.__href__)===null||It===void 0?void 0:It.value),identifier:d.identifier,issue:(Ot=d.issue)===null||Ot===void 0?void 0:Ot.value,itemCount:(bt=(Rt=d.item_count)===null||Rt===void 0?void 0:Rt.value)!==null&&bt!==void 0?bt:0,mediatype:this.getMediatype(d),review:d.reviewtitle&&d.reviewbody?{id:"",title:(at=d.reviewtitle.value)!==null&&at!==void 0?at:"",body:(Y=d.reviewbody.value)!==null&&Y!==void 0?Y:"",starRating:5}:void 0,snippets:(ie=(yt=d.highlight)===null||yt===void 0?void 0:yt.values)!==null&&ie!==void 0?ie:[],source:(wt=d.source)===null||wt===void 0?void 0:wt.value,subjects:(Oe=(G=d.subject)===null||G===void 0?void 0:G.values)!==null&&Oe!==void 0?Oe:[],title:(xt=(ot=d.title)===null||ot===void 0?void 0:ot.value)!==null&&xt!==void 0?xt:"",volume:(rt=d.volume)===null||rt===void 0?void 0:rt.value,viewCount:(De=(_t=d.downloads)===null||_t===void 0?void 0:_t.value)!==null&&De!==void 0?De:0,weeklyViewCount:($e=d.week)===null||$e===void 0?void 0:$e.value,loginRequired:st,contentWarning:lt})}),a[e]=r,this.dataSource=a,this.currentVisiblePageNumbers.includes(e)&&((i=this.infiniteScroller)===null||i===void 0||i.refreshAllVisibleCells())}getMediatype(e){var t,i,a;return((t=e==null?void 0:e.rawMetadata)===null||t===void 0?void 0:t.hit_type)==="favorited_search"?"search":(a=(i=e.mediatype)===null||i===void 0?void 0:i.value)!==null&&a!==void 0?a:"data"}collapseRepeatedQuotes(e){return e==null?void 0:e.replace(/%22%22(?!%22%22)(.+?)%22%22/g,"%22$1%22")}async fetchPrefixFilterBuckets(e){var t,i,a,r,l,n,d;const p=(t=this.baseQuery)===null||t===void 0?void 0:t.trim();if(!this.canPerformSearch)return[];const v=_l[e],f=this.sortParam?[this.sortParam]:[],b=ve(X({},this.collectionParams),{query:p||"",rows:0,filters:this.filterMap,aggregations:{simpleParams:[v]},aggregationsSize:26});b.uid=await this.requestUID(ve(X({},b),{sort:f}),"aggregations");const w=await((i=this.searchService)===null||i===void 0?void 0:i.search(b,this.searchType));return(d=(n=(l=(r=(a=w==null?void 0:w.success)===null||a===void 0?void 0:a.response)===null||r===void 0?void 0:r.aggregations)===null||l===void 0?void 0:l[v])===null||n===void 0?void 0:n.buckets)!==null&&d!==void 0?d:[]}async updatePrefixFilterCounts(e){const{facetFetchQueryKey:t}=this,i=await this.fetchPrefixFilterBuckets(e);t===this.facetFetchQueryKey&&(this.prefixFilterCountMap=X({},this.prefixFilterCountMap),this.prefixFilterCountMap[e]=i.reduce((r,l)=>(r[l.key.toUpperCase()]=l.doc_count,r),{}))}async updatePrefixFiltersForCurrentSort(){if(["title","creator"].includes(this.selectedSort)){const e=this.selectedSort;this.prefixFilterCountMap[e]||this.updatePrefixFilterCounts(e)}}refreshLetterCounts(){Object.keys(this.prefixFilterCountMap).length>0&&(this.prefixFilterCountMap={}),this.updatePrefixFiltersForCurrentSort()}resultSelected(e){var t,i,a;if(this.isManageView){const r=Object.values(this.dataSource).flat().indexOf(e.detail);r>=0&&((t=this.infiniteScroller)===null||t===void 0||t.refreshCell(r-this.tileModelOffset))}(i=this.analyticsHandler)===null||i===void 0||i.sendEvent({category:this.searchContext,action:se.resultSelected,label:e.detail.mediatype}),(a=this.analyticsHandler)===null||a===void 0||a.sendEvent({category:this.searchContext,action:se.resultSelected,label:`page-${this.currentPage}`})}cellForIndex(e){const t=this.tileModelAtCellIndex(e);if(!!t)return c`
      <tile-dispatcher
        .collectionPagePath=${this.collectionPagePath}
        .baseNavigationUrl=${this.baseNavigationUrl}
        .baseImageUrl=${this.baseImageUrl}
    ...
    `}scrollThresholdReached(){this.endOfDataReached||(this.pagesToRender+=1,this.fetchPage(this.pagesToRender))}static get styles(){return[Ge,m`
        :host {
          display: block;
      ...
      `]}};s([h({type:String})],z.prototype,"baseNavigationUrl",void 0);s([h({type:String})],z.prototype,"baseImageUrl",void 0);s([h({type:Object})],z.prototype,"searchService",void 0);s([h({type:String})],z.prototype,"searchType",void 0);s([h({type:String})],z.prototype,"withinCollection",void 0);s([h({type:String})],z.prototype,"baseQuery",void 0);s([h({type:String})],z.prototype,"displayMode",void 0);s([h({type:Object})],z.prototype,"sortParam",void 0);s([h({type:Object})],z.prototype,"defaultSortParam",void 0);s([h({type:String})],z.prototype,"selectedSort",void 0);s([h({type:String})],z.prototype,"selectedTitleFilter",void 0);s([h({type:String})],z.prototype,"selectedCreatorFilter",void 0);s([h({type:String})],z.prototype,"sortDirection",void 0);s([h({type:Number})],z.prototype,"pageSize",void 0);s([h({type:Object})],z.prototype,"resizeObserver",void 0);s([h({type:Number})],z.prototype,"currentPage",void 0);s([h({type:String})],z.prototype,"minSelectedDate",void 0);s([h({type:String})],z.prototype,"maxSelectedDate",void 0);s([h({type:Object})],z.prototype,"selectedFacets",void 0);s([h({type:Boolean})],z.prototype,"showHistogramDatePicker",void 0);s([h({type:String})],z.prototype,"collectionPagePath",void 0);s([h({type:Object})],z.prototype,"collectionInfo",void 0);s([h({type:Array})],z.prototype,"parentCollections",void 0);s([h({type:String,reflect:!0})],z.prototype,"searchContext",void 0);s([h({type:Object})],z.prototype,"collectionNameCache",void 0);s([h({type:String})],z.prototype,"pageContext",void 0);s([h({type:Object})],z.prototype,"restorationStateHandler",void 0);s([h({type:Number})],z.prototype,"mobileBreakpoint",void 0);s([h({type:Boolean})],z.prototype,"loggedIn",void 0);s([h({type:Object})],z.prototype,"modalManager",void 0);s([h({type:Object})],z.prototype,"featureFeedbackService",void 0);s([h({type:Object})],z.prototype,"recaptchaManager",void 0);s([h({type:Boolean})],z.prototype,"isManageView",void 0);s([M()],z.prototype,"pagesToRender",void 0);s([M()],z.prototype,"searchResultsLoading",void 0);s([M()],z.prototype,"facetsLoading",void 0);s([M()],z.prototype,"fullYearAggregationLoading",void 0);s([M()],z.prototype,"aggregations",void 0);s([M()],z.prototype,"fullYearsHistogramAggregation",void 0);s([M()],z.prototype,"totalResults",void 0);s([M()],z.prototype,"queryErrorMessage",void 0);s([M()],z.prototype,"mobileView",void 0);s([M()],z.prototype,"mobileFacetsVisible",void 0);s([M()],z.prototype,"contentWidth",void 0);s([M()],z.prototype,"defaultSortField",void 0);s([M()],z.prototype,"defaultSortDirection",void 0);s([M()],z.prototype,"placeholderType",void 0);s([M()],z.prototype,"prefixFilterCountMap",void 0);s([Q("#content-container")],z.prototype,"contentContainer",void 0);s([Q("#left-column")],z.prototype,"leftColumn",void 0);s([Q("collection-facets")],z.prototype,"collectionFacets",void 0);s([h({type:Object,attribute:!1})],z.prototype,"analyticsHandler",void 0);s([Q("infinite-scroller")],z.prototype,"infiniteScroller",void 0);z=s([A("collection-browser")],z);let de=class extends F{constructor(){super(...arguments),this.searchService=this.initSearchServiceFromUrlParams(),this.resizeObserver=new ps,this.localCache=new as,this.collectionNameCache=new us({searchService:this.searchService,localCache:this.localCache}),this.cellWidth=18,this.cellHeight=29,this.rowGap=1.7,this.colGap=1.7,this.loggedIn=!1,this.searchType=pe.METADATA,this.analyticsManager=new Or,this.analyticsHandler={sendPing:this.sendAnalytics.bind(this),sendEvent:this.sendAnalytics.bind(this),sendEventNoSampling:this.sendAnalytics.bind(this)}}sendAnalytics(e){var t;console.log("Analytics Received ----",e),this.latestAction=e,(t=this.analyticsManager)===null||t===void 0||t.sendEvent(e)}initSearchServiceFromUrlParams(){var e,t,i;const a=new URL(window.location.href).searchParams;return new Ae({includeCredentials:!1,baseUrl:(e=a.get("search_base_url"))!==null&&e!==void 0?e:void 0,servicePath:(t=a.get("search_service_path"))!==null&&t!==void 0?t:void 0,debuggingEnabled:(i=!!a.get("debugging"))!==null&&i!==void 0?i:void 0})}searchPressed(e){e.preventDefault(),this.searchQuery=this.baseQueryField.value,this.collectionBrowser.searchType=this.searchType,this.goToCurrentPage()}collectionChanged(e){e.preventDefault(),this.withinCollection=this.baseCollectionField.value,this.collectionBrowser.withinCollection=this.withinCollection,this.goToCurrentPage()}goToCurrentPage(){var e;const t=(e=this.currentPage)!==null&&e!==void 0?e:1;t>1&&this.collectionBrowser.goToPage(t)}changePagePressed(e){e.preventDefault(),this.currentPage=this.pageNumberInput.valueAsNumber,this.collectionBrowser.goToPage(this.currentPage)}updated(e){e.has("currentPage")&&this.currentPage&&(this.pageNumberInput.value=this.currentPage.toString()),e.has("searchQuery")&&this.queryUpdated()}queryUpdated(){this.collectionBrowser.baseQuery=this.searchQuery}get getClass(){return new URLSearchParams(window.location.search).get("hide-dev-tools")?"hidden":""}render(){var e,t;return c`
      <div class="dev-tool-container">
        <div id="dev-tools" class=${this.getClass}>
          ...
          <div id="toggle-controls">
            <button
              @click=${()=>{var i,a;const r=(i=this.shadowRoot)===null||i===void 0?void 0:i.getElementById("cell-size-control");r==null||r.classList.toggle("hidden");const l=(a=this.shadowRoot)===null||a===void 0?void 0:a.getElementById("cell-gap-control");l==null||l.classList.toggle("hidden")}}
            >
              Toggle Cell Controls
            </button>
            <button
              @click=${()=>{var i;const a=(i=this.shadowRoot)===null||i===void 0?void 0:i.getElementById("latest-event-details");a==null||a.classList.toggle("hidden")}}
            >
              Last Event Captured
            </button>
          </div>
  ...
  `;s([M()],de.prototype,"currentPage",void 0);s([M()],de.prototype,"searchQuery",void 0);s([M()],de.prototype,"withinCollection",void 0);s([M()],de.prototype,"cellWidth",void 0);s([M()],de.prototype,"cellHeight",void 0);s([M()],de.prototype,"rowGap",void 0);s([M()],de.prototype,"colGap",void 0);s([M()],de.prototype,"loggedIn",void 0);s([M()],de.prototype,"searchType",void 0);s([h({type:Object,reflect:!1})],de.prototype,"latestAction",void 0);s([Q("#base-query-field")],de.prototype,"baseQueryField",void 0);s([Q("#base-collection-field")],de.prototype,"baseCollectionField",void 0);s([Q("#page-number-input")],de.prototype,"pageNumberInput",void 0);s([Q("collection-browser")],de.prototype,"collectionBrowser",void 0);s([Q("modal-manager")],de.prototype,"modalManager",void 0);de=s([A("app-root")],de);
