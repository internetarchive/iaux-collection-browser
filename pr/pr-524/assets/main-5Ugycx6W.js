 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function H(r,e){return Ss({descriptor:t=>({get(){var o,s;return(s=(o=this.renderRoot)===null||o===void 0?void 0:o.querySelector(r))!==null&&s!==void 0?s:null},enumerable:!0,configurable:!0})})}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;var it;let De=it=class extends P{constructor(){super(...arguments),this.placeholderType=null,this.detailMessage=""}render(){return this.placeholderType?h`${this.placeholderTemplate}`:b}get placeholderTemplate(){return h`
    ...
    `}};De.MESSAGE_EMPTY_QUERY=k('To begin searching, enter a search term in the box above and hit "Go".');De.MESSAGE_NO_SEARCH_RESULTS=k("Your search did not match any items in the Archive. Try different keywords or a more general search.");De.MESSAGE_NO_COLLECTION_RESULTS=k("Your search did not match any items in this collection. Try different keywords or a more general search.");De.MESSAGE_NO_VIEWABLE_MEMBERS=k("This collection contains no viewable items.");De.MESSAGE_QUERY_ERROR=k(h`The search engine encountered an error, which might be related to your
      ...
      <a href="mailto:info@archive.org">info@archive.org</a>.`);De.QUERY_ERROR_DETAILS_MESSAGE=k("Error details:");n([c({type:String})],De.prototype,"placeholderType",void 0);n([c({type:Boolean})],De.prototype,"isMobileView",void 0);n([c({type:Boolean})],De.prototype,"isCollection",void 0);n([c({type:String})],De.prototype,"detailMessage",void 0);De=it=n([R("empty-placeholder")],De);/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*Pt(r,e){if(r!==void 0){let t=0;for(const i of r)yield e(i,t++)}}function Ts(r){return r?r.toISOString().endsWith("-01-01T00:00:00.000Z"):!1}const Rn=h`
...
`+Te),Gt&&po([Ze,Je,K],tt=>{Te=Ai(Te,tt," ")}),I&&oo?I.createHTML(Te):Te},e.setConfig=function(){let z=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};or(z),Xo=!0},e.clearConfig=function(){Zt=null,Xo=!1},e.isValidAttribute=function(z,g,$){Zt||or({});const L=fe(z),J=fe(g);return Gs(L,J,$)},e.addHook=function(z,g){typeof g=="function"&&Mi(Q[z],g)},e.removeHook=function(z,g){if(g!==void 0){const $=bc(Q[z],g);return $===-1?void 0:yc(Q[z],$,1)[0]}return Da(Q[z])},e.removeHooks=function(z){Q[z]=[]},e.removeAllHooks=function(){Q=Ia()},e}var wo=Wn();let Po=class extends ce{constructor(){super(...arguments),this.collectionLinks=[]}render(){return h`
    ...
    `}};Oa=n([R("tile-list-compact")],Oa);let Na=class extends ce{render(){return h`
...
`;let ls=class extends P{constructor(){super(...arguments),this.config=new Rt}render(){return h`
    ...
    `}};n([c({type:Object})],ls.prototype,"config",void 0);ls=n([R("modal-template")],ls);function eh(r,e,t){var i=t||{},o=i.noTrailing,s=o===void 0?!1:o,a=i.noLeading,l=a===void 0?!1:a,d=i.debounceMode,u=d===void 0?void 0:d,p,m=!1,v=0;function y(){p&&clearTimeout(p)}function x(C){var D=C||{},M=D.upcomingOnly,A=M===void 0?!1:M;y(),m=!A}function S(){for(var C=arguments.length,D=new Array(C),M=0;M<C;M++)D[M]=arguments[M];var A=this,I=Date.now()-v;if(m)return;function W(){v=Date.now(),e.apply(A,D)}function ae(){p=void 0}!l&&u&&!p&&W(),y(),u===void 0&&I>r?l?(v=Date.now(),s||(p=setTimeout(u?ae:W,r))):W():s!==!0&&(p=setTimeout(u?ae:W,u===void 0?r-I:r))}return S.cancel=x,S}var It;(function(r){r.Open="open",r.Closed="closed"})(It||(It={}));class th{constructor(e){this.windowResizeThrottler=eh(100,this.updateModalContainerHeight,{noLeading:!1,noTrailing:!1}).bind(this),this.modalManager=e}handleModeChange(e){switch(e){case It.Open:this.startResizeListener(),this.stopDocumentScroll();break;case It.Closed:this.stopResizeListener(),this.resumeDocumentScroll();break}}updateModalContainerHeight(){this.modalManager.style.setProperty("--containerHeight",`${window.innerHeight}px`)}stopDocumentScroll(){document.body.classList.add("modal-manager-open")}resumeDocumentScroll(){document.body.classList.remove("modal-manager-open")}startResizeListener(){window.addEventListener("resize",this.windowResizeThrottler)}stopResizeListener(){window.removeEventListener("resize",this.windowResizeThrottler)}}let pi=class extends P{constructor(){super(...arguments),this.mode=It.Closed,this.hostBridge=new th(this),this.modal=new Kc(this),this.closeOnBackdropClick=!0}firstUpdated(){return Zs(this,void 0,void 0,function*(){yield new Promise(e=>setTimeout(e,0)),this.closeOnBackdropClick&&this.addEventListener("keydown",e=>{e.key==="Escape"&&this.backdropClicked()})})}disconnectedCallback(){super.disconnectedCallback(),this.modal.deactivate()}render(){return h`
      <div class="container">
