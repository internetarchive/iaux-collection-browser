...
`;function Bo(a,e){let t=1;return a>=1e9?t=1e9:a>=1e6?t=1e6:a>=1e3&&e==="short"&&(t=1e3),t}function Ho(a=0,e){const t=a/e,i=t<10;let r=0;return i?r=Math.round((t+Number.EPSILON)*10)/10:r=Math.round(t),r}function Uo(a,e,t,i){switch(e){case 1e9:return Oe(t==="short"?Ze`${a}B`:Ze`${a} billion`);case 1e6:return Oe(t==="short"?Ze`${a}M`:Ze`${a} million`);case 1e3:return Oe(t==="short"?Ze`${a}K`:Ze`${a} thousand`);default:return new Intl.NumberFormat(i).format(a)}}function xt(a,e="long",t="short",i="en-US"){const r=a!=null?a:-1;if(r<0)return"";const o=Bo(r,e),s=Ho(r,o);return Uo(s,o,t,i)}let Be=class extends E{render(){return p`
    ...
    `}};n([u({type:Object})],Lt.prototype,"model",void 0);n([u({type:String})],Lt.prototype,"baseImageUrl",void 0);n([u({type:Object})],Lt.prototype,"sortParam",void 0);Lt=n([R("item-tile")],Lt);let Fi=class extends E{render(){var e,t,i,r,o,s,l,c;return p`
...
`+K),We&&(K=xe(K,_e," "),K=xe(K,Te," ")),W&&Ot?W.createHTML(K):K},e.setConfig=function(x){li(x),ti=!0},e.clearConfig=function(){Ye=null,ti=!1},e.isValidAttribute=function(x,d,m){Ye||li({});var w=Le(x),z=Le(d);return dr(w,z,m)},e.addHook=function(x,d){typeof d=="function"&&(X[x]=X[x]||[],wt(X[x],d))},e.removeHook=function(x){if(X[x])return Nr(X[x])},e.removeHooks=function(x){X[x]&&(X[x]=[])},e.removeAllHooks=function(){X={}},e}var St=ua();function pa(a){switch(a){case"date":return"Published";case"reviewdate":return"Reviewed";case"addeddate":return"Added";default:return"Archived"}}function va(a){return a?`Archivist since ${a.getFullYear()}`:""}let le=class extends E{constructor(){super(...arguments),this.sortParam=null,this.collectionLinks=[]}updated(e){e.has("model")&&this.fetchCollectionNames()}async fetchCollectionNames(){var e,t;if(!(!((e=this.model)===null||e===void 0)&&e.collections)||this.model.collections.length===0||!this.collectionNameCache)return;this.collectionLinks=[];const i=[],r=[];for(const o of this.model.collections)r.push((t=this.collectionNameCache)===null||t===void 0?void 0:t.collectionNameFor(o).then(s=>{i.push(this.detailsLink(o,s!=null?s:o))}));await Promise.all(r),this.collectionLinks=i}render(){return p`
    ...
    `}};n([u({type:Object})],it.prototype,"model",void 0);n([u({type:Number})],it.prototype,"currentWidth",void 0);n([u({type:Object})],it.prototype,"sortParam",void 0);n([u({type:Number})],it.prototype,"mobileBreakpoint",void 0);it=n([R("tile-list-compact-header")],it);let ie=class extends E{constructor(){super(...arguments),this.sortParam=null}render(){return p`
      <div id="container">
    ...
    `}};n([u({type:String})],ie.prototype,"tileDisplayMode",void 0);n([u({type:Object})],ie.prototype,"model",void 0);n([u({type:String})],ie.prototype,"baseNavigationUrl",void 0);n([u({type:Number})],ie.prototype,"currentWidth",void 0);n([u({type:Number})],ie.prototype,"currentHeight",void 0);n([u({type:Object})],ie.prototype,"resizeObserver",void 0);n([u({type:Object})],ie.prototype,"collectionNameCache",void 0);n([u({type:Object})],ie.prototype,"sortParam",void 0);n([G("#container")],ie.prototype,"container",void 0);n([u({type:Number})],ie.prototype,"mobileBreakpoint",void 0);n([u({type:String})],ie.prototype,"baseImageUrl",void 0);ie=n([R("tile-dispatcher")],ie);let Br=class extends E{render(){return p` <div id="container"></div> `}static get styles(){return f`
      :host {
        display: block;
        height: 100%;
      }
...
`;let at=class extends E{constructor(){super(...arguments),this.currentPage=1}firstUpdated(){this.buildPagination()}buildPagination(){this.pageNumberElement.innerHTML="";let e=this.currentPage-this.step,t=this.currentPage+this.step;e<=0&&(t+=-e+1,e=1),t>=this.paginationSize&&(e=Math.max(e-(t-this.paginationSize),1),t=this.paginationSize),e>1&&(this.addPageNumber(1),this.addEllipsis());for(let i=e;i<=t;i+=1)this.addPageNumber(i);t<this.paginationSize&&(this.addEllipsis(),this.addPageNumber(this.paginationSize))}addPageNumber(e){const t=document.createElement("button");t.innerText=e,this.currentPage===e&&t.classList.add("current"),t.addEventListener("click",()=>{this.currentPage=e,this.buildPagination(),this.emitPageNumberClick()}),this.pageNumberElement.appendChild(t)}addEllipsis(){const e=document.createElement("i");e.innerText="...",this.pageNumberElement.appendChild(e)}emitPageNumberClick(){this.dispatchEvent(new CustomEvent("pageNumberClicked",{detail:{page:this.currentPage}}))}previousPageClicked(){this.currentPage-=1,this.currentPage<1&&(this.currentPage=1),this.buildPagination(),this.emitPageNumberClick()}nextPageClicked(){this.currentPage+=1,this.currentPage>this.paginationSize&&(this.currentPage=this.paginationSize),this.buildPagination(),this.emitPageNumberClick()}render(){return p`
    ...
    >
      More...
    </button>`}emitSortingFacets(){}async showMoreFacets(e){var t,i;const r=Object.keys(_i).find(c=>_i[c]===e.key),o=p`
      <span
  ...
  `;n([T()],ee.prototype,"currentPage",void 0);n([T()],ee.prototype,"searchQuery",void 0);n([T()],ee.prototype,"cellWidth",void 0);n([T()],ee.prototype,"cellHeight",void 0);n([T()],ee.prototype,"rowGap",void 0);n([T()],ee.prototype,"colGap",void 0);n([T()],ee.prototype,"loggedIn",void 0);n([G("#base-query-field")],ee.prototype,"baseQueryField",void 0);n([G("#page-number-input")],ee.prototype,"pageNumberInput",void 0);n([G("collection-browser")],ee.prototype,"collectionBrowser",void 0);n([G("modal-manager")],ee.prototype,"modalManager",void 0);ee=n([R("app-root")],ee);
