 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function L(a){return u(ft(oe({},a),{state:!0}))}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function K(a,e){return oa({descriptor:t=>{const i={get(){var r,o;return(o=(r=this.renderRoot)===null||r===void 0?void 0:r.querySelector(a))!==null&&o!==void 0?o:null},enumerable:!0,configurable:!0};if(e){const r=typeof t=="symbol"?Symbol():"__"+t;i.get=function(){var o,s;return this[r]===void 0&&(this[r]=(s=(o=this.renderRoot)===null||o===void 0?void 0:o.querySelector(a))!==null&&s!==void 0?s:null),this[r]}}return i}})}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */const Mr=(a,e,t)=>{const i=new Map;for(let r=e;r<=t;r++)i.set(a[r],r);return i},da=na(class extends la{constructor(a){if(super(a),a.type!==sa.CHILD)throw Error("repeat() can only be used in text expressions")}dt(a,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);const r=[],o=[];let s=0;for(const l of a)r[s]=i?i(l,s):s,o[s]=t(l,s),s++;return{values:o,keys:r}}render(a,e,t){return this.dt(a,e,t).values}update(a,[e,t,i]){var r;const o=mo(a),{values:s,keys:l}=this.dt(e,t,i);if(!Array.isArray(o))return this.ut=l,s;const c=(r=this.ut)!==null&&r!==void 0?r:this.ut=[],h=[];let v,g,b=0,S=o.length-1,$=0,T=s.length-1;for(;b<=S&&$<=T;)if(o[b]===null)b++;else if(o[S]===null)S--;else if(c[b]===l[$])h[$]=ze(o[b],s[$]),b++,$++;else if(c[S]===l[T])h[T]=ze(o[S],s[T]),S--,T--;else if(c[b]===l[T])h[T]=ze(o[b],s[T]),yt(a,h[T+1],o[b]),b++,T--;else if(c[S]===l[$])h[$]=ze(o[S],s[$]),yt(a,o[b],o[S]),S--,$++;else if(v===void 0&&(v=Mr(l,$,T),g=Mr(c,b,S)),v.has(c[b]))if(v.has(c[S])){const F=g.get(l[$]),D=F!==void 0?o[F]:null;if(D===null){const ee=yt(a,o[b]);ze(ee,s[$]),h[$]=ee}else h[$]=ze(D,s[$]),yt(a,o[b],D),o[F]=null;$++}else yi(o[S]),S--;else yi(o[b]),b++;for(;$<=T;){const F=yt(a,h[T+1]);ze(F,s[$]),h[$++]=F}for(;b<=S;){const F=o[b++];F!==null&&yi(F)}return this.ut=l,vo(a,h),$e}});function Dt(a,e,t){return Array.from({length:(e-a)/t+1},(i,r)=>a+r*t)}let ke=class extends E{constructor(){super(...arguments),this.itemCount=0,this.scrollOptimizationsDisabled=!1,this.intersectionObserver=new IntersectionObserver(e=>{e.forEach(t=>{if(t.target===this.sentinel){t.isIntersecting&&this.dispatchEvent(new Event("scrollThresholdReached"));return}const r=t.target.dataset.cellIndex;if(!r)return;const o=parseInt(r,10);t.isIntersecting?this.visibleCellIndices.add(o):this.visibleCellIndices.delete(o)}),this.scrollOptimizationsDisabled||this.processVisibleCells()}),this.renderedCellIndices=new Set,this.visibleCellIndices=new Set,this.placeholderCellIndices=new Set}reload(){Dt(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.removeCell(t)),this.renderedCellIndices.clear(),this.visibleCellIndices.clear(),this.placeholderCellIndices.clear(),this.setupObservations()}scrollToCell(e,t){const i=this.cellContainers[e];if(!i)return!1;const r=t?"smooth":"auto";return i.scrollIntoView({behavior:r}),!0}getVisibleCellIndices(){return Array.from(this.visibleCellIndices)}updated(e){(e.has("itemCount")||e.has("scrollOptimizationsDisabled"))&&this.setupObservations()}disconnectedCallback(){this.intersectionObserver.disconnect()}setupObservations(){this.setupIntersectionObserver()}setupIntersectionObserver(){this.intersectionObserver.disconnect(),this.sentinel&&this.intersectionObserver.observe(this.sentinel),this.scrollOptimizationsDisabled?(Dt(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.visibleCellIndices.add(t)),this.processVisibleCells()):this.cellContainers.forEach(e=>this.intersectionObserver.observe(e))}render(){const e=this.itemCount-1,t=Dt(0,e,1);return p`
    ...
    `}};n([u({type:Number})],ke.prototype,"itemCount",void 0);n([u({type:Object})],ke.prototype,"cellProvider",void 0);n([u({type:Object})],ke.prototype,"placeholderCellTemplate",void 0);n([u({type:Boolean})],ke.prototype,"scrollOptimizationsDisabled",void 0);n([K("#sentinel")],ke.prototype,"sentinel",void 0);n([lo(".cell-container")],ke.prototype,"cellContainers",void 0);ke=n([R("infinite-scroller")],ke);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`+q),Qe&&(q=xe(q,_e," "),q=xe(q,Te," ")),Q&&Pt?Q.createHTML(q):q},e.setConfig=function(x){li(x),ti=!0},e.clearConfig=function(){Ze=null,ti=!1},e.isValidAttribute=function(x,d,m){Ze||li({});var w=Me(x),z=Me(d);return dr(w,z,m)},e.addHook=function(x,d){typeof d=="function"&&(X[x]=X[x]||[],wt(X[x],d))},e.removeHook=function(x){if(X[x])return Fr(X[x])},e.removeHooks=function(x){X[x]&&(X[x]=[])},e.removeAllHooks=function(){X={}},e}var St=ua();function pa(a){switch(a){case"date":return"Published";case"reviewdate":return"Reviewed";case"addeddate":return"Added";default:return"Archived"}}function va(a){return a?`Archivist since ${a.getFullYear()}`:""}let le=class extends E{constructor(){super(...arguments),this.sortParam=null,this.collectionLinks=[]}updated(e){e.has("model")&&this.fetchCollectionNames()}async fetchCollectionNames(){var e,t;if(!(!((e=this.model)===null||e===void 0)&&e.collections)||this.model.collections.length===0||!this.collectionNameCache)return;this.collectionLinks=[];const i=[],r=[];for(const o of this.model.collections)r.push((t=this.collectionNameCache)===null||t===void 0?void 0:t.collectionNameFor(o).then(s=>{i.push(this.detailsLink(o,s!=null?s:o))}));await Promise.all(r),this.collectionLinks=i}render(){return p`
    ...
    `}};n([u({type:Object})],le.prototype,"model",void 0);n([u({type:String})],le.prototype,"baseNavigationUrl",void 0);n([u({type:Object})],le.prototype,"collectionNameCache",void 0);n([u({type:Number})],le.prototype,"currentWidth",void 0);n([u({type:Number})],le.prototype,"currentHeight",void 0);n([u({type:Object})],le.prototype,"sortParam",void 0);n([u({type:Number})],le.prototype,"mobileBreakpoint",void 0);n([L()],le.prototype,"collectionLinks",void 0);n([u({type:String})],le.prototype,"baseImageUrl",void 0);le=n([R("tile-list")],le);let be=class extends E{constructor(){super(...arguments),this.sortParam=null}render(){var e,t,i,r,o,s,l,c,h,v,g;return p`
      <div id="list-line" class="${this.classSize}">
        <div id="thumb" class="${Re((e=this.model)===null||e===void 0?void 0:e.mediatype)}">
          ${this.imageTemplate}
        </div>
...
`;let Bi=class extends E{constructor(){super(...arguments),this.config=new ma}render(){return p`
    ...
    `}};n([u({type:String,reflect:!0})],at.prototype,"mode",void 0);n([u({type:Object})],at.prototype,"customModalContent",void 0);n([u({type:Object})],at.prototype,"hostBridge",void 0);n([K("modal-template")],at.prototype,"modalTemplate",void 0);at=n([R("modal-manager")],at);var _s=P`
...
`;let He=class extends E{constructor(){super(...arguments),this.page=1}firstUpdated(){this.buildPagination()}buildPagination(){const e=document.createRange().createContextualFragment(`
    ...
    </ul>`}facetClicked(e){const{selectedFacets:t}=this,i=e.target,{checked:r,value:o}=i;let s;t?s=oe({},t):s=Et,r?s[this.facetKey][o]="selected":delete s[this.facetKey][o],this.selectedFacets=s}get loaderTemplate(){return this.facetsLoading?p`<div class="loader-facets">
    ...
    `}};n([u({type:String})],V.prototype,"facetKey",void 0);n([u({type:String})],V.prototype,"facetAggregationKey",void 0);n([u({type:String})],V.prototype,"fullQuery",void 0);n([u({type:Object})],V.prototype,"modalManager",void 0);n([u({type:Object})],V.prototype,"searchService",void 0);n([u({type:Object})],V.prototype,"selectedFacets",void 0);n([u({type:Object,attribute:!1})],V.prototype,"aggr",void 0);n([u({type:Object})],V.prototype,"castedBuckets",void 0);n([u({type:Object})],V.prototype,"selectedFacet",void 0);n([u({type:Object})],V.prototype,"languageCodeHandler",void 0);n([u({type:Object})],V.prototype,"collectionNameCache",void 0);n([u({type:Object})],V.prototype,"allFacetGroups",void 0);n([L()],V.prototype,"pageNumber",void 0);n([L()],V.prototype,"facetsLoading",void 0);n([L()],V.prototype,"paginationSize",void 0);V=n([R("more-facets-content")],V);const As=["mediatype","year","subject","collection","creator","language"],_i={subjectSorter:"subject",mediatypeSorter:"mediatype",languageSorter:"language",creatorSorter:"creator",collection:"collection",year:"year"},Ti={subject:"Subject",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"};let W=class extends E{constructor(){super(...arguments),this.facetsLoading=!1,this.fullYearAggregationLoading=!1,this.collapsableFacets=!1,this.showHistogramDatePicker=!1,this.openFacets={subject:!1,mediatype:!1,language:!1,creator:!1,collection:!1,year:!1}}render(){return p`
    ...
    >
      More...
    </button>`}async showMoreFacets(e){const t=Object.keys(_i).find(s=>_i[s]===e.key),i=p`<span
  ...
  `;n([L()],ie.prototype,"currentPage",void 0);n([L()],ie.prototype,"searchQuery",void 0);n([L()],ie.prototype,"cellWidth",void 0);n([L()],ie.prototype,"cellHeight",void 0);n([L()],ie.prototype,"rowGap",void 0);n([L()],ie.prototype,"colGap",void 0);n([L()],ie.prototype,"loggedIn",void 0);n([K("#base-query-field")],ie.prototype,"baseQueryField",void 0);n([K("#page-number-input")],ie.prototype,"pageNumberInput",void 0);n([K("collection-browser")],ie.prototype,"collectionBrowser",void 0);ie=n([R("app-root")],ie);
