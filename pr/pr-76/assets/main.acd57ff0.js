var xo=Object.defineProperty,$o=Object.defineProperties;var So=Object.getOwnPropertyDescriptors;var Ga=Object.getOwnPropertySymbols;var Co=Object.prototype.hasOwnProperty,_o=Object.prototype.propertyIsEnumerable;var Ka=(r,e,t)=>e in r?xo(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t,ue=(r,e)=>{for(var t in e||(e={}))Co.call(e,t)&&Ka(r,t,e[t]);if(Ga)for(var t of Ga(e))_o.call(e,t)&&Ka(r,t,e[t]);return r},Ot=(r,e)=>$o(r,So(e));const zo=function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))i(a);new MutationObserver(a=>{for(const o of a)if(o.type==="childList")for(const s of o.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function t(a){const o={};return a.integrity&&(o.integrity=a.integrity),a.referrerpolicy&&(o.referrerPolicy=a.referrerpolicy),a.crossorigin==="use-credentials"?o.credentials="include":a.crossorigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(a){if(a.ep)return;a.ep=!0;const o=t(a);fetch(a.href,o)}};zo();function n(r,e,t,i){var a=arguments.length,o=a<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(r,e,t,i);else for(var l=r.length-1;l>=0;l--)(s=r[l])&&(o=(a<3?s(o):a>3?s(e,t,o):s(e,t))||o);return a>3&&o&&Object.defineProperty(e,t,o),o}function ko(r,e,t,i){function a(o){return o instanceof t?o:new t(function(s){s(o)})}return new(t||(t=Promise))(function(o,s){function l(m){try{h(i.next(m))}catch(f){s(f)}}function c(m){try{h(i.throw(m))}catch(f){s(f)}}function h(m){m.done?o(m.value):a(m.value).then(l,c)}h((i=i.apply(r,e||[])).next())})}function w(r){let e,t,i;return typeof r=="object"?(e=r.hashFunction,t=r.expiring,i=r.tags):e=r,(a,o,s)=>{if(s.value!=null)s.value=Ya(s.value,e,t,i);else if(s.get!=null)s.get=Ya(s.get,e,t,i);else throw"Only put a Memoize() decorator on a method or get accessor."}}const Fi=new Map;function Ya(r,e,t=0,i){const a=Symbol("__memoized_map__");return function(...o){let s;this.hasOwnProperty(a)||Object.defineProperty(this,a,{configurable:!1,enumerable:!1,writable:!1,value:new Map});let l=this[a];if(Array.isArray(i))for(const c of i)Fi.has(c)?Fi.get(c).push(l):Fi.set(c,[l]);if(e||o.length>0||t>0){let c;e===!0?c=o.map(f=>f.toString()).join("!"):e?c=e.apply(this,o):c=o[0];const h=`${c}__timestamp`;let m=!1;if(t>0)if(!l.has(h))m=!0;else{let f=l.get(h);m=Date.now()-f>t}l.has(c)&&!m?s=l.get(c):(s=r.apply(this,o),l.set(c,s),t>0&&l.set(h,Date.now()))}else{const c=this;l.has(c)?s=l.get(c):(s=r.apply(this,o),l.set(c,s))}return s}}class aa{parseValue(e){return typeof e=="string"&&(e==="false"||e==="0")?!1:Boolean(e)}}aa.shared=new aa;class Ee{parseValue(e){if(typeof e=="number")return e;if(typeof e=="boolean")return;const t=parseFloat(e);if(!Number.isNaN(t))return t}}Ee.shared=new Ee;class di{parseValue(e){return Ee.shared.parseValue(e)}}di.shared=new di;class Vt{parseValue(e){return this.parseJSDate(e)||this.parseBracketDate(e)}parseBracketDate(e){if(typeof e!="string")return;const t=e.match(/\[([0-9]{4})\]/);if(!(!t||t.length<2))return this.parseJSDate(t[1])}parseJSDate(e){if(typeof e!="string")return;let t=e;t.match(/^[0-9]{4}-[0-9]{2}-[0-9]{2}\s{1}[0-9]{2}:[0-9]{2}:[0-9]{2}$/)&&(t=t.replace(" ","T"));const i=Date.parse(t);if(Number.isNaN(i))return;let a=new Date(t);return(t.indexOf("Z")>-1||t.indexOf("+")>-1||t.match(/^[0-9]{4}$/)||t.match(/^[0-9]{4}-[0-9]{2}-[0-9]{2}$/)||t.match(/^.*?-[0-9]{2}:[0-9]{2}$/)||t.match(/^.*?-[0-9]{4}$/))&&(a=new Date(a.getTime()+a.getTimezoneOffset()*1e3*60)),a}}Vt.shared=new Vt;class hi{parseValue(e){if(typeof e=="number")return e;if(typeof e=="boolean")return;const t=e.split(":");let i;return t.length===1?i=this.parseNumberFormat(t[0]):i=this.parseColonSeparatedFormat(t),i}parseNumberFormat(e){let t=parseFloat(e);return Number.isNaN(t)&&(t=void 0),t}parseColonSeparatedFormat(e){let t=!1;const i=e.map((a,o)=>{const s=parseFloat(a);if(Number.isNaN(s))return t=!0,0;const l=e.length-1-o,c=60**l;return s*Math.floor(c)}).reduce((a,o)=>a+o,0);return t?void 0:i}}hi.shared=new hi;class ra{parseValue(e){if(typeof e=="string")return e}}ra.shared=new ra;class To{constructor(e,t){this.separators=[";",","],this.parser=e,t&&t.separators&&(this.separators=t.separators)}parseValue(e){const t=String(e);let i=[];for(const a of this.separators)if(i=t.split(a),i.length>1)break;return this.parseListValues(i)}parseListValues(e){const i=e.map(o=>o.trim()).map(o=>this.parser.parseValue(o)),a=[];return i.forEach(o=>{o!==void 0&&a.push(o)}),a}}class oa{parseValue(e){if(typeof e=="string")return e}}oa.shared=new oa;class pi{parseValue(e){return String(e)}}pi.shared=new pi;class ge{constructor(e,t){this.parser=e,this.rawValue=t}get values(){return this.parseRawValue()}get value(){return this.values[0]}parseRawValue(){if(this.rawValue===void 0)return[];const e=Array.isArray(this.rawValue)?this.rawValue:[this.rawValue],t=[];return e.forEach(i=>{const a=this.parser.parseValue(i);Array.isArray(a)?t.push(...a):a!==void 0&&t.push(a)}),t}}n([w()],ge.prototype,"values",null);n([w()],ge.prototype,"value",null);class Mo extends ge{constructor(e){super(aa.shared,e)}}class Ce extends ge{constructor(e){super(Vt.shared,e)}}class Pi extends ge{constructor(e){super(hi.shared,e)}}class de extends ge{constructor(e){super(Ee.shared,e)}}class H extends ge{constructor(e){super(pi.shared,e)}}class Do extends ge{constructor(e){super(oa.shared,e)}}class qa extends ge{constructor(e){super(di.shared,e)}}class Ao extends ge{constructor(e){super(ra.shared,e)}}class Lo extends ge{constructor(e,t){super(t,e)}}class Eo extends Lo{constructor(e){const t=new To(pi.shared);super(e,t)}}class S{constructor(e){this.rawMetadata=e}get identifier(){var e;return(e=this.rawMetadata)===null||e===void 0?void 0:e.identifier}get addeddate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.addeddate?new Ce(this.rawMetadata.addeddate):void 0}get audio_codec(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.audio_codec?new H(this.rawMetadata.audio_codec):void 0}get audio_sample_rate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.audio_sample_rate?new de(this.rawMetadata.audio_sample_rate):void 0}get avg_rating(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.avg_rating?new de(this.rawMetadata.avg_rating):void 0}get collection(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.collection?new H(this.rawMetadata.collection):void 0}get collections_raw(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.collections_raw?new H(this.rawMetadata.collections_raw):void 0}get collection_size(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.collection_size?new qa(this.rawMetadata.collection_size):void 0}get contributor(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.contributor?new H(this.rawMetadata.contributor):void 0}get coverage(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.coverage?new H(this.rawMetadata.coverage):void 0}get creator(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.creator?new H(this.rawMetadata.creator):void 0}get date(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.date?new Ce(this.rawMetadata.date):void 0}get description(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.description?new H(this.rawMetadata.description):void 0}get downloads(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.downloads?new de(this.rawMetadata.downloads):void 0}get duration(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.duration?new Pi(this.rawMetadata.duration):void 0}get"external-identifier"(){var e,t;return!((e=this.rawMetadata)===null||e===void 0)&&e["external-identifier"]?new H((t=this.rawMetadata)===null||t===void 0?void 0:t["external-identifier"]):void 0}get files_count(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.files_count?new de(this.rawMetadata.files_count):void 0}get indexdate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.indexdate?new Ce(this.rawMetadata.indexdate):void 0}get isbn(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.isbn?new H(this.rawMetadata.isbn):void 0}get issue(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.issue?new H(this.rawMetadata.issue):void 0}get item_count(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.item_count?new de(this.rawMetadata.item_count):void 0}get item_size(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.item_size?new qa(this.rawMetadata.item_size):void 0}get language(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.language?new H(this.rawMetadata.language):void 0}get length(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.length?new Pi(this.rawMetadata.length):void 0}get lineage(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.lineage?new H(this.rawMetadata.lineage):void 0}get month(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.month?new de(this.rawMetadata.month):void 0}get mediatype(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.mediatype?new Ao(this.rawMetadata.mediatype):void 0}get noindex(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.noindex?new Mo(this.rawMetadata.noindex):void 0}get notes(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.notes?new H(this.rawMetadata.notes):void 0}get num_favorites(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.num_favorites?new de(this.rawMetadata.num_favorites):void 0}get num_reviews(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.num_reviews?new de(this.rawMetadata.num_reviews):void 0}get openlibrary_edition(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.openlibrary_edition?new H(this.rawMetadata.openlibrary_edition):void 0}get openlibrary_work(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.openlibrary_work?new H(this.rawMetadata.openlibrary_work):void 0}get page_progression(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.page_progression?new Do(this.rawMetadata.page_progression):void 0}get partner(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.partner?new H(this.rawMetadata.partner):void 0}get ppi(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.ppi?new de(this.rawMetadata.ppi):void 0}get publicdate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.publicdate?new Ce(this.rawMetadata.publicdate):void 0}get publisher(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.publisher?new H(this.rawMetadata.publisher):void 0}get reviewdate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.reviewdate?new Ce(this.rawMetadata.reviewdate):void 0}get runtime(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.runtime?new Pi(this.rawMetadata.runtime):void 0}get scanner(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.scanner?new H(this.rawMetadata.scanner):void 0}get source(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.source?new H(this.rawMetadata.source):void 0}get start_localtime(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.start_localtime?new Ce(this.rawMetadata.start_localtime):void 0}get start_time(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.start_time?new Ce(this.rawMetadata.start_time):void 0}get stop_time(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.stop_time?new Ce(this.rawMetadata.stop_time):void 0}get subject(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.subject?new Eo(this.rawMetadata.subject):void 0}get taper(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.taper?new H(this.rawMetadata.taper):void 0}get title(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.title?new H(this.rawMetadata.title):void 0}get transferer(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.transferer?new H(this.rawMetadata.transferer):void 0}get track(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.track?new de(this.rawMetadata.track):void 0}get type(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.type?new H(this.rawMetadata.type):void 0}get uploader(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.uploader?new H(this.rawMetadata.uploader):void 0}get utc_offset(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.utc_offset?new de(this.rawMetadata.utc_offset):void 0}get venue(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.venue?new H(this.rawMetadata.venue):void 0}get volume(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.volume?new H(this.rawMetadata.volume):void 0}get week(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.week?new de(this.rawMetadata.week):void 0}get year(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.year?new Ce(this.rawMetadata.year):void 0}}n([w()],S.prototype,"addeddate",null);n([w()],S.prototype,"audio_codec",null);n([w()],S.prototype,"audio_sample_rate",null);n([w()],S.prototype,"avg_rating",null);n([w()],S.prototype,"collection",null);n([w()],S.prototype,"collections_raw",null);n([w()],S.prototype,"collection_size",null);n([w()],S.prototype,"contributor",null);n([w()],S.prototype,"coverage",null);n([w()],S.prototype,"creator",null);n([w()],S.prototype,"date",null);n([w()],S.prototype,"description",null);n([w()],S.prototype,"downloads",null);n([w()],S.prototype,"duration",null);n([w()],S.prototype,"external-identifier",null);n([w()],S.prototype,"files_count",null);n([w()],S.prototype,"indexdate",null);n([w()],S.prototype,"isbn",null);n([w()],S.prototype,"issue",null);n([w()],S.prototype,"item_count",null);n([w()],S.prototype,"item_size",null);n([w()],S.prototype,"language",null);n([w()],S.prototype,"length",null);n([w()],S.prototype,"lineage",null);n([w()],S.prototype,"month",null);n([w()],S.prototype,"mediatype",null);n([w()],S.prototype,"noindex",null);n([w()],S.prototype,"notes",null);n([w()],S.prototype,"num_favorites",null);n([w()],S.prototype,"num_reviews",null);n([w()],S.prototype,"openlibrary_edition",null);n([w()],S.prototype,"openlibrary_work",null);n([w()],S.prototype,"page_progression",null);n([w()],S.prototype,"partner",null);n([w()],S.prototype,"ppi",null);n([w()],S.prototype,"publicdate",null);n([w()],S.prototype,"publisher",null);n([w()],S.prototype,"reviewdate",null);n([w()],S.prototype,"runtime",null);n([w()],S.prototype,"scanner",null);n([w()],S.prototype,"source",null);n([w()],S.prototype,"start_localtime",null);n([w()],S.prototype,"start_time",null);n([w()],S.prototype,"stop_time",null);n([w()],S.prototype,"subject",null);n([w()],S.prototype,"taper",null);n([w()],S.prototype,"title",null);n([w()],S.prototype,"transferer",null);n([w()],S.prototype,"track",null);n([w()],S.prototype,"type",null);n([w()],S.prototype,"uploader",null);n([w()],S.prototype,"utc_offset",null);n([w()],S.prototype,"venue",null);n([w()],S.prototype,"volume",null);n([w()],S.prototype,"week",null);n([w()],S.prototype,"year",null);class $t{constructor(e){this.rawValue=e}get name(){return this.rawValue.name}get source(){return this.rawValue.source}get btih(){return this.rawValue.btih}get md5(){return this.rawValue.md5}get format(){return this.rawValue.format}get mtime(){return this.rawValue.mtime}get crc32(){return this.rawValue.crc32}get sha1(){return this.rawValue.sha1}get original(){return this.rawValue.original}get size(){return this.rawValue.size?di.shared.parseValue(this.rawValue.size):void 0}get title(){return this.rawValue.title}get length(){return this.rawValue.length?hi.shared.parseValue(this.rawValue.length):void 0}get height(){return this.rawValue.height?Ee.shared.parseValue(this.rawValue.height):void 0}get width(){return this.rawValue.width?Ee.shared.parseValue(this.rawValue.width):void 0}get track(){return this.rawValue.track?Ee.shared.parseValue(this.rawValue.track):void 0}get external_identifier(){return this.rawValue.external_identifier}get creator(){return this.rawValue.creator}get album(){return this.rawValue.album}}n([w()],$t.prototype,"size",null);n([w()],$t.prototype,"length",null);n([w()],$t.prototype,"height",null);n([w()],$t.prototype,"width",null);n([w()],$t.prototype,"track",null);class xi{constructor(e){this.rawValue=e}get reviewbody(){return this.rawValue.reviewbody}get reviewtitle(){return this.rawValue.reviewtitle}get reviewer(){return this.rawValue.reviewer}get reviewdate(){return this.rawValue.reviewdate?Vt.shared.parseValue(this.rawValue.reviewdate):void 0}get createdate(){return this.rawValue.createdate?Vt.shared.parseValue(this.rawValue.createdate):void 0}get stars(){return this.rawValue.stars?Ee.shared.parseValue(this.rawValue.stars):void 0}}n([w()],xi.prototype,"reviewdate",null);n([w()],xi.prototype,"createdate",null);n([w()],xi.prototype,"stars",null);class Oo{constructor(e){var t,i;this.rawResponse=e,this.created=e.created,this.d1=e.d1,this.d2=e.d2,this.dir=e.dir,this.files=(t=e.files)===null||t===void 0?void 0:t.map(a=>new $t(a)),this.files_count=e.files_count,this.item_last_updated=e.item_last_updated,this.item_size=e.item_size,this.metadata=new S(e.metadata),this.server=e.server,this.uniq=e.uniq,this.workable_servers=e.workable_servers,this.speech_vs_music_asr=e.speech_vs_music_asr,this.reviews=(i=e.reviews)===null||i===void 0?void 0:i.map(a=>new xi(a))}}class Io{constructor(e){this.numFound=e.numFound,this.start=e.start,this.docs=e.docs.map(t=>new S(t)),this.aggregations=e.aggregations}}class Fo{constructor(e){this.rawResponse=e,this.responseHeader=e.responseHeader,this.response=new Io(e.response)}}var Ge;(function(r){r.networkError="SearchService.NetworkError",r.itemNotFound="SearchService.ItemNotFound",r.decodingError="SearchService.DecodingError",r.searchEngineError="SearchService.SearchEngineError"})(Ge||(Ge={}));class sa extends Error{constructor(e,t,i){super(t),this.name=e,this.type=e,this.details=i}}class Po{static aggregateSearchParamsAsString(e){if(e.advancedParams){const t=e.advancedParams.map(a=>({terms:a}));return JSON.stringify(t)}if(e.simpleParams)return e.simpleParams.join(",")}static sortParamsAsString(e){return`${e.field} ${e.direction}`}static generateURLSearchParams(e){const t=new URLSearchParams;if(t.append("q",e.query),t.append("output","json"),e.rows&&t.append("rows",String(e.rows)),e.page&&t.append("page",String(e.page)),e.fields&&t.append("fl",e.fields.join(",")),e.sort){const a=e.sort.map(o=>this.sortParamsAsString(o));t.append("sort",a.join(","))}const i=e.aggregations;if(i){const a=this.aggregateSearchParamsAsString(i);a&&t.append("user_aggs",a)}return t}}class Ro{constructor(e){var t;if(this.baseUrl=(t=e==null?void 0:e.baseUrl)!==null&&t!==void 0?t:"archive.org",(e==null?void 0:e.includeCredentials)!==void 0?this.includeCredentials=e.includeCredentials:this.includeCredentials=window.location.href.match(/^https?:\/\/.*archive\.org(:[0-9]+)?/)!==null,(e==null?void 0:e.scope)!==void 0)this.requestScope=e.scope;else{const a=new URL(window.location.href).searchParams.get("scope");a&&(this.requestScope=a)}}async performSearch(e){const i=Po.generateURLSearchParams(e).toString(),a=`https://${this.baseUrl}/advancedsearch.php?${i}`;return this.fetchUrl(a)}async fetchMetadata(e,t){const i=t?`/${t}`:"",a=`https://${this.baseUrl}/metadata/${e}${i}`;return this.fetchUrl(a,{requestOptions:{credentials:"omit"}})}async fetchUrl(e,t){var i;const a=new URL(e);this.requestScope&&a.searchParams.set("scope",this.requestScope);let o;try{const s=(i=t==null?void 0:t.requestOptions)!==null&&i!==void 0?i:{credentials:this.includeCredentials?"include":"same-origin"};o=await fetch(a.href,s)}catch(s){const l=s instanceof Error?s.message:typeof s=="string"?s:"Unknown error";return this.getErrorResult(Ge.networkError,l)}try{const s=await o.json(),l=s.error;if(l){const c=s.forensics;return this.getErrorResult(Ge.searchEngineError,l,c)}else return{success:s}}catch(s){const l=s instanceof Error?s.message:typeof s=="string"?s:"Unknown error";return this.getErrorResult(Ge.decodingError,l)}}getErrorResult(e,t,i){return{error:new sa(e,t,i)}}}class na{constructor(e){this.searchBackend=e}async search(e){const t=await this.searchBackend.performSearch(e);return t.error?t:{success:new Fo(t.success)}}async fetchMetadata(e){var t;const i=await this.searchBackend.fetchMetadata(e);return i.error?i:((t=i.success)===null||t===void 0?void 0:t.metadata)===void 0?{error:new sa(Ge.itemNotFound)}:{success:new Oo(i.success)}}async fetchMetadataValue(e,t){var i;const a=await this.searchBackend.fetchMetadata(e,t);return a.error?a:((i=a.success)===null||i===void 0?void 0:i.result)===void 0?{error:new sa(Ge.itemNotFound)}:{success:a.success.result}}}na.default=new na(new Ro);function No(){var r=!navigator.userAgentData&&/Safari\//.test(navigator.userAgent)&&!/Chrom(e|ium)\//.test(navigator.userAgent);if(!r||!indexedDB.databases)return Promise.resolve();var e;return new Promise(function(t){var i=function(){return indexedDB.databases().finally(t)};e=setInterval(i,100),i()}).finally(function(){return clearInterval(e)})}function St(r){return new Promise((e,t)=>{r.oncomplete=r.onsuccess=()=>e(r.result),r.onabort=r.onerror=()=>t(r.error)})}function Bo(r,e){const t=No().then(()=>{const i=indexedDB.open(r);return i.onupgradeneeded=()=>i.result.createObjectStore(e),St(i)});return(i,a)=>t.then(o=>a(o.transaction(e,i).objectStore(e)))}let Ri;function $i(){return Ri||(Ri=Bo("keyval-store","keyval")),Ri}function Ho(r,e=$i()){return e("readonly",t=>St(t.get(r)))}function Uo(r,e,t=$i()){return t("readwrite",i=>(i.put(e,r),St(i.transaction)))}function Vo(r,e=$i()){return e("readwrite",t=>(t.delete(r),St(t.transaction)))}function Wo(r,e){return r.openCursor().onsuccess=function(){!this.result||(e(this.result),this.result.continue())},St(r.transaction)}function jo(r=$i()){return r("readonly",e=>{if(e.getAllKeys)return St(e.getAllKeys());const t=[];return Wo(e,i=>t.push(i.key)).then(()=>t)})}function Qo(r,e){return r.setMilliseconds(r.getMilliseconds()+e*1e3),r}class Go{constructor(e){var t,i,a,o;if(this.namespace=(t=e==null?void 0:e.namespace)!==null&&t!==void 0?t:"LocalCache",this.defaultTTL=(i=e==null?void 0:e.defaultTTL)!==null&&i!==void 0?i:15*60,(!((a=e==null?void 0:e.immediateClean)!==null&&a!==void 0)||a)&&this.cleanExpired(),!(e!=null&&e.disableCleaning)){const s=(o=e==null?void 0:e.cleaningInterval)!==null&&o!==void 0?o:60;setInterval(()=>{this.cleanExpired()},s*1e3)}}async set(e){var t;const i={value:e.value},a=(t=e.ttl)!==null&&t!==void 0?t:this.defaultTTL,o=Qo(new Date,a);i.expires=o;const s=this.getNamespacedKey(e.key);try{await Uo(s,i)}catch{}}async get(e){const t=this.getNamespacedKey(e);let i;try{i=await Ho(t)}catch{}if(!i)return;const a=new Date;if(i.expires&&i.expires<a){await this.delete(e);return}return i.value}async delete(e){const t=this.getNamespacedKey(e);try{await Vo(t)}catch{}}async cleanExpired(){const e=await this.getAllKeys();await Promise.all(e.map(async t=>this.get(t)))}async getAllKeys(){let e=[];try{e=await jo()}catch{}const t=[];for(const o of e)typeof o=="string"&&t.push(o);return t.filter(o=>o.startsWith(this.namespace)).map(o=>this.removeNamespace(o))}getNamespacedKey(e){return`${this.namespace}-${e}`}removeNamespace(e){return e.replace(`${this.namespace}-`,"")}}/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ba=window.ShadowRoot&&(window.ShadyCSS===void 0||window.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,wa=Symbol(),Za=new Map;class Ir{constructor(e,t){if(this._$cssResult$=!0,t!==wa)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e}get styleSheet(){let e=Za.get(this.cssText);return ba&&e===void 0&&(Za.set(this.cssText,e=new CSSStyleSheet),e.replaceSync(this.cssText)),e}toString(){return this.cssText}}const Ko=r=>new Ir(typeof r=="string"?r:r+"",wa),v=(r,...e)=>{const t=r.length===1?r[0]:e.reduce((i,a,o)=>i+(s=>{if(s._$cssResult$===!0)return s.cssText;if(typeof s=="number")return s;throw Error("Value passed to 'css' function must be a 'css' function result: "+s+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(a)+r[o+1],r[0]);return new Ir(t,wa)},Yo=(r,e)=>{ba?r.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet):e.forEach(t=>{const i=document.createElement("style"),a=window.litNonce;a!==void 0&&i.setAttribute("nonce",a),i.textContent=t.cssText,r.appendChild(i)})},Xa=ba?r=>r:r=>r instanceof CSSStyleSheet?(e=>{let t="";for(const i of e.cssRules)t+=i.cssText;return Ko(t)})(r):r;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Ni;const Ja=window.trustedTypes,qo=Ja?Ja.emptyScript:"",er=window.reactiveElementPolyfillSupport,la={toAttribute(r,e){switch(e){case Boolean:r=r?qo:null;break;case Object:case Array:r=r==null?r:JSON.stringify(r)}return r},fromAttribute(r,e){let t=r;switch(e){case Boolean:t=r!==null;break;case Number:t=r===null?null:Number(r);break;case Object:case Array:try{t=JSON.parse(r)}catch{t=null}}return t}},Fr=(r,e)=>e!==r&&(e==e||r==r),Bi={attribute:!0,type:String,converter:la,reflect:!1,hasChanged:Fr};class ct extends HTMLElement{constructor(){super(),this._$Et=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Ei=null,this.o()}static addInitializer(e){var t;(t=this.l)!==null&&t!==void 0||(this.l=[]),this.l.push(e)}static get observedAttributes(){this.finalize();const e=[];return this.elementProperties.forEach((t,i)=>{const a=this._$Eh(i,t);a!==void 0&&(this._$Eu.set(a,i),e.push(a))}),e}static createProperty(e,t=Bi){if(t.state&&(t.attribute=!1),this.finalize(),this.elementProperties.set(e,t),!t.noAccessor&&!this.prototype.hasOwnProperty(e)){const i=typeof e=="symbol"?Symbol():"__"+e,a=this.getPropertyDescriptor(e,i,t);a!==void 0&&Object.defineProperty(this.prototype,e,a)}}static getPropertyDescriptor(e,t,i){return{get(){return this[t]},set(a){const o=this[e];this[t]=a,this.requestUpdate(e,o,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)||Bi}static finalize(){if(this.hasOwnProperty("finalized"))return!1;this.finalized=!0;const e=Object.getPrototypeOf(this);if(e.finalize(),this.elementProperties=new Map(e.elementProperties),this._$Eu=new Map,this.hasOwnProperty("properties")){const t=this.properties,i=[...Object.getOwnPropertyNames(t),...Object.getOwnPropertySymbols(t)];for(const a of i)this.createProperty(a,t[a])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const i=new Set(e.flat(1/0).reverse());for(const a of i)t.unshift(Xa(a))}else e!==void 0&&t.push(Xa(e));return t}static _$Eh(e,t){const i=t.attribute;return i===!1?void 0:typeof i=="string"?i:typeof e=="string"?e.toLowerCase():void 0}o(){var e;this._$Ep=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$Em(),this.requestUpdate(),(e=this.constructor.l)===null||e===void 0||e.forEach(t=>t(this))}addController(e){var t,i;((t=this._$Eg)!==null&&t!==void 0?t:this._$Eg=[]).push(e),this.renderRoot!==void 0&&this.isConnected&&((i=e.hostConnected)===null||i===void 0||i.call(e))}removeController(e){var t;(t=this._$Eg)===null||t===void 0||t.splice(this._$Eg.indexOf(e)>>>0,1)}_$Em(){this.constructor.elementProperties.forEach((e,t)=>{this.hasOwnProperty(t)&&(this._$Et.set(t,this[t]),delete this[t])})}createRenderRoot(){var e;const t=(e=this.shadowRoot)!==null&&e!==void 0?e:this.attachShadow(this.constructor.shadowRootOptions);return Yo(t,this.constructor.elementStyles),t}connectedCallback(){var e;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$Eg)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostConnected)===null||i===void 0?void 0:i.call(t)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$Eg)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostDisconnected)===null||i===void 0?void 0:i.call(t)})}attributeChangedCallback(e,t,i){this._$AK(e,i)}_$ES(e,t,i=Bi){var a,o;const s=this.constructor._$Eh(e,i);if(s!==void 0&&i.reflect===!0){const l=((o=(a=i.converter)===null||a===void 0?void 0:a.toAttribute)!==null&&o!==void 0?o:la.toAttribute)(t,i.type);this._$Ei=e,l==null?this.removeAttribute(s):this.setAttribute(s,l),this._$Ei=null}}_$AK(e,t){var i,a,o;const s=this.constructor,l=s._$Eu.get(e);if(l!==void 0&&this._$Ei!==l){const c=s.getPropertyOptions(l),h=c.converter,m=(o=(a=(i=h)===null||i===void 0?void 0:i.fromAttribute)!==null&&a!==void 0?a:typeof h=="function"?h:null)!==null&&o!==void 0?o:la.fromAttribute;this._$Ei=l,this[l]=m(t,c.type),this._$Ei=null}}requestUpdate(e,t,i){let a=!0;e!==void 0&&(((i=i||this.constructor.getPropertyOptions(e)).hasChanged||Fr)(this[e],t)?(this._$AL.has(e)||this._$AL.set(e,t),i.reflect===!0&&this._$Ei!==e&&(this._$EC===void 0&&(this._$EC=new Map),this._$EC.set(e,i))):a=!1),!this.isUpdatePending&&a&&(this._$Ep=this._$E_())}async _$E_(){this.isUpdatePending=!0;try{await this._$Ep}catch(t){Promise.reject(t)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var e;if(!this.isUpdatePending)return;this.hasUpdated,this._$Et&&(this._$Et.forEach((a,o)=>this[o]=a),this._$Et=void 0);let t=!1;const i=this._$AL;try{t=this.shouldUpdate(i),t?(this.willUpdate(i),(e=this._$Eg)===null||e===void 0||e.forEach(a=>{var o;return(o=a.hostUpdate)===null||o===void 0?void 0:o.call(a)}),this.update(i)):this._$EU()}catch(a){throw t=!1,this._$EU(),a}t&&this._$AE(i)}willUpdate(e){}_$AE(e){var t;(t=this._$Eg)===null||t===void 0||t.forEach(i=>{var a;return(a=i.hostUpdated)===null||a===void 0?void 0:a.call(i)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EU(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$Ep}shouldUpdate(e){return!0}update(e){this._$EC!==void 0&&(this._$EC.forEach((t,i)=>this._$ES(i,this[i],t)),this._$EC=void 0),this._$EU()}updated(e){}firstUpdated(e){}}ct.finalized=!0,ct.elementProperties=new Map,ct.elementStyles=[],ct.shadowRootOptions={mode:"open"},er==null||er({ReactiveElement:ct}),((Ni=globalThis.reactiveElementVersions)!==null&&Ni!==void 0?Ni:globalThis.reactiveElementVersions=[]).push("1.3.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Hi;const ft=globalThis.trustedTypes,tr=ft?ft.createPolicy("lit-html",{createHTML:r=>r}):void 0,_e=`lit$${(Math.random()+"").slice(9)}$`,xa="?"+_e,Zo=`<${xa}>`,vt=document,Wt=(r="")=>vt.createComment(r),jt=r=>r===null||typeof r!="object"&&typeof r!="function",Pr=Array.isArray,Rr=r=>{var e;return Pr(r)||typeof((e=r)===null||e===void 0?void 0:e[Symbol.iterator])=="function"},It=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,ir=/-->/g,ar=/>/g,Ue=/>|[ 	\n\r](?:([^\s"'>=/]+)([ 	\n\r]*=[ 	\n\r]*(?:[^ 	\n\r"'`<>=]|("|')|))|$)/g,rr=/'/g,or=/"/g,Nr=/^(?:script|style|textarea|title)$/i,Br=r=>(e,...t)=>({_$litType$:r,strings:e,values:t}),u=Br(1),E=Br(2),he=Symbol.for("lit-noChange"),C=Symbol.for("lit-nothing"),sr=new WeakMap,si=(r,e,t)=>{var i,a;const o=(i=t==null?void 0:t.renderBefore)!==null&&i!==void 0?i:e;let s=o._$litPart$;if(s===void 0){const l=(a=t==null?void 0:t.renderBefore)!==null&&a!==void 0?a:null;o._$litPart$=s=new Ct(e.insertBefore(Wt(),l),l,void 0,t!=null?t:{})}return s._$AI(r),s},mt=vt.createTreeWalker(vt,129,null,!1),Hr=(r,e)=>{const t=r.length-1,i=[];let a,o=e===2?"<svg>":"",s=It;for(let c=0;c<t;c++){const h=r[c];let m,f,g=-1,b=0;for(;b<h.length&&(s.lastIndex=b,f=s.exec(h),f!==null);)b=s.lastIndex,s===It?f[1]==="!--"?s=ir:f[1]!==void 0?s=ar:f[2]!==void 0?(Nr.test(f[2])&&(a=RegExp("</"+f[2],"g")),s=Ue):f[3]!==void 0&&(s=Ue):s===Ue?f[0]===">"?(s=a!=null?a:It,g=-1):f[1]===void 0?g=-2:(g=s.lastIndex-f[2].length,m=f[1],s=f[3]===void 0?Ue:f[3]==='"'?or:rr):s===or||s===rr?s=Ue:s===ir||s===ar?s=It:(s=Ue,a=void 0);const x=s===Ue&&r[c+1].startsWith("/>")?" ":"";o+=s===It?h+Zo:g>=0?(i.push(m),h.slice(0,g)+"$lit$"+h.slice(g)+_e+x):h+_e+(g===-2?(i.push(void 0),c):x)}const l=o+(r[t]||"<?>")+(e===2?"</svg>":"");if(!Array.isArray(r)||!r.hasOwnProperty("raw"))throw Error("invalid template strings array");return[tr!==void 0?tr.createHTML(l):l,i]};class Qt{constructor({strings:e,_$litType$:t},i){let a;this.parts=[];let o=0,s=0;const l=e.length-1,c=this.parts,[h,m]=Hr(e,t);if(this.el=Qt.createElement(h,i),mt.currentNode=this.el.content,t===2){const f=this.el.content,g=f.firstChild;g.remove(),f.append(...g.childNodes)}for(;(a=mt.nextNode())!==null&&c.length<l;){if(a.nodeType===1){if(a.hasAttributes()){const f=[];for(const g of a.getAttributeNames())if(g.endsWith("$lit$")||g.startsWith(_e)){const b=m[s++];if(f.push(g),b!==void 0){const x=a.getAttribute(b.toLowerCase()+"$lit$").split(_e),z=/([.?@])?(.*)/.exec(b);c.push({type:1,index:o,name:z[2],strings:x,ctor:z[1]==="."?Vr:z[1]==="?"?Wr:z[1]==="@"?jr:qt})}else c.push({type:6,index:o})}for(const g of f)a.removeAttribute(g)}if(Nr.test(a.tagName)){const f=a.textContent.split(_e),g=f.length-1;if(g>0){a.textContent=ft?ft.emptyScript:"";for(let b=0;b<g;b++)a.append(f[b],Wt()),mt.nextNode(),c.push({type:2,index:++o});a.append(f[g],Wt())}}}else if(a.nodeType===8)if(a.data===xa)c.push({type:2,index:o});else{let f=-1;for(;(f=a.data.indexOf(_e,f+1))!==-1;)c.push({type:7,index:o}),f+=_e.length-1}o++}}static createElement(e,t){const i=vt.createElement("template");return i.innerHTML=e,i}}function qe(r,e,t=r,i){var a,o,s,l;if(e===he)return e;let c=i!==void 0?(a=t._$Cl)===null||a===void 0?void 0:a[i]:t._$Cu;const h=jt(e)?void 0:e._$litDirective$;return(c==null?void 0:c.constructor)!==h&&((o=c==null?void 0:c._$AO)===null||o===void 0||o.call(c,!1),h===void 0?c=void 0:(c=new h(r),c._$AT(r,t,i)),i!==void 0?((s=(l=t)._$Cl)!==null&&s!==void 0?s:l._$Cl=[])[i]=c:t._$Cu=c),c!==void 0&&(e=qe(r,c._$AS(r,e.values),c,i)),e}class Ur{constructor(e,t){this.v=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}p(e){var t;const{el:{content:i},parts:a}=this._$AD,o=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:vt).importNode(i,!0);mt.currentNode=o;let s=mt.nextNode(),l=0,c=0,h=a[0];for(;h!==void 0;){if(l===h.index){let m;h.type===2?m=new Ct(s,s.nextSibling,this,e):h.type===1?m=new h.ctor(s,h.name,h.strings,this,e):h.type===6&&(m=new Qr(s,this,e)),this.v.push(m),h=a[++c]}l!==(h==null?void 0:h.index)&&(s=mt.nextNode(),l++)}return o}m(e){let t=0;for(const i of this.v)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class Ct{constructor(e,t,i,a){var o;this.type=2,this._$AH=C,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=a,this._$Cg=(o=a==null?void 0:a.isConnected)===null||o===void 0||o}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cg}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&e.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=qe(this,e,t),jt(e)?e===C||e==null||e===""?(this._$AH!==C&&this._$AR(),this._$AH=C):e!==this._$AH&&e!==he&&this.$(e):e._$litType$!==void 0?this.T(e):e.nodeType!==void 0?this.k(e):Rr(e)?this.S(e):this.$(e)}M(e,t=this._$AB){return this._$AA.parentNode.insertBefore(e,t)}k(e){this._$AH!==e&&(this._$AR(),this._$AH=this.M(e))}$(e){this._$AH!==C&&jt(this._$AH)?this._$AA.nextSibling.data=e:this.k(vt.createTextNode(e)),this._$AH=e}T(e){var t;const{values:i,_$litType$:a}=e,o=typeof a=="number"?this._$AC(e):(a.el===void 0&&(a.el=Qt.createElement(a.h,this.options)),a);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===o)this._$AH.m(i);else{const s=new Ur(o,this),l=s.p(this.options);s.m(i),this.k(l),this._$AH=s}}_$AC(e){let t=sr.get(e.strings);return t===void 0&&sr.set(e.strings,t=new Qt(e)),t}S(e){Pr(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,a=0;for(const o of e)a===t.length?t.push(i=new Ct(this.M(Wt()),this.M(Wt()),this,this.options)):i=t[a],i._$AI(o),a++;a<t.length&&(this._$AR(i&&i._$AB.nextSibling,a),t.length=a)}_$AR(e=this._$AA.nextSibling,t){var i;for((i=this._$AP)===null||i===void 0||i.call(this,!1,!0,t);e&&e!==this._$AB;){const a=e.nextSibling;e.remove(),e=a}}setConnected(e){var t;this._$AM===void 0&&(this._$Cg=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}}class qt{constructor(e,t,i,a,o){this.type=1,this._$AH=C,this._$AN=void 0,this.element=e,this.name=t,this._$AM=a,this.options=o,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=C}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,i,a){const o=this.strings;let s=!1;if(o===void 0)e=qe(this,e,t,0),s=!jt(e)||e!==this._$AH&&e!==he,s&&(this._$AH=e);else{const l=e;let c,h;for(e=o[0],c=0;c<o.length-1;c++)h=qe(this,l[i+c],t,c),h===he&&(h=this._$AH[c]),s||(s=!jt(h)||h!==this._$AH[c]),h===C?e=C:e!==C&&(e+=(h!=null?h:"")+o[c+1]),this._$AH[c]=h}s&&!a&&this.C(e)}C(e){e===C?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e!=null?e:"")}}class Vr extends qt{constructor(){super(...arguments),this.type=3}C(e){this.element[this.name]=e===C?void 0:e}}const Xo=ft?ft.emptyScript:"";class Wr extends qt{constructor(){super(...arguments),this.type=4}C(e){e&&e!==C?this.element.setAttribute(this.name,Xo):this.element.removeAttribute(this.name)}}class jr extends qt{constructor(e,t,i,a,o){super(e,t,i,a,o),this.type=5}_$AI(e,t=this){var i;if((e=(i=qe(this,e,t,0))!==null&&i!==void 0?i:C)===he)return;const a=this._$AH,o=e===C&&a!==C||e.capture!==a.capture||e.once!==a.once||e.passive!==a.passive,s=e!==C&&(a===C||o);o&&this.element.removeEventListener(this.name,this,a),s&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,i;typeof this._$AH=="function"?this._$AH.call((i=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&i!==void 0?i:this.element,e):this._$AH.handleEvent(e)}}class Qr{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){qe(this,e)}}const Jo={L:"$lit$",P:_e,V:xa,I:1,N:Hr,R:Ur,j:Rr,D:qe,H:Ct,F:qt,O:Wr,W:jr,B:Vr,Z:Qr},nr=window.litHtmlPolyfillSupport;nr==null||nr(Qt,Ct),((Hi=globalThis.litHtmlVersions)!==null&&Hi!==void 0?Hi:globalThis.litHtmlVersions=[]).push("2.2.4");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Ui,Vi;class O extends ct{constructor(){super(...arguments),this.renderOptions={host:this},this._$Dt=void 0}createRenderRoot(){var e,t;const i=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=i.firstChild),i}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Dt=si(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Dt)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Dt)===null||e===void 0||e.setConnected(!1)}render(){return he}}O.finalized=!0,O._$litElement$=!0,(Ui=globalThis.litElementHydrateSupport)===null||Ui===void 0||Ui.call(globalThis,{LitElement:O});const lr=globalThis.litElementPolyfillSupport;lr==null||lr({LitElement:O});((Vi=globalThis.litElementVersions)!==null&&Vi!==void 0?Vi:globalThis.litElementVersions=[]).push("3.2.0");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const es=(r,e)=>e.kind==="method"&&e.descriptor&&!("value"in e.descriptor)?Ot(ue({},e),{finisher(t){t.createProperty(e.key,r)}}):{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){typeof e.initializer=="function"&&(this[e.key]=e.initializer.call(this))},finisher(t){t.createProperty(e.key,r)}};function p(r){return(e,t)=>t!==void 0?((i,a,o)=>{a.constructor.createProperty(o,i)})(r,e,t):es(r,e)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function k(r){return p(Ot(ue({},r),{state:!0}))}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Gr=({finisher:r,descriptor:e})=>(t,i)=>{var a;if(i===void 0){const o=(a=t.originalKey)!==null&&a!==void 0?a:t.key,s=e!=null?{kind:"method",placement:"prototype",key:o,descriptor:e(t.key)}:Ot(ue({},t),{key:o});return r!=null&&(s.finisher=function(l){r(l,o)}),s}{const o=t.constructor;e!==void 0&&Object.defineProperty(t,i,e(i)),r==null||r(o,i)}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function re(r,e){return Gr({descriptor:t=>{const i={get(){var a,o;return(o=(a=this.renderRoot)===null||a===void 0?void 0:a.querySelector(r))!==null&&o!==void 0?o:null},enumerable:!0,configurable:!0};if(e){const a=typeof t=="symbol"?Symbol():"__"+t;i.get=function(){var o,s;return this[a]===void 0&&(this[a]=(s=(o=this.renderRoot)===null||o===void 0?void 0:o.querySelector(r))!==null&&s!==void 0?s:null),this[a]}}return i}})}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function ts(r){return Gr({descriptor:e=>({get(){var t,i;return(i=(t=this.renderRoot)===null||t===void 0?void 0:t.querySelectorAll(r))!==null&&i!==void 0?i:[]},enumerable:!0,configurable:!0})})}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Wi;((Wi=window.HTMLSlotElement)===null||Wi===void 0?void 0:Wi.prototype.assignedElements)!=null;class is{constructor(){this.resizeObserver=new ResizeObserver(e=>{window.requestAnimationFrame(()=>{for(const t of e){const i=this.resizeHandlers.get(t.target);i==null||i.forEach(a=>{a.handleResize(t)})}})}),this.resizeHandlers=new Map}shutdown(){this.resizeHandlers.forEach((e,t)=>{this.resizeObserver.unobserve(t)}),this.resizeHandlers.clear()}addObserver(e){var t;const i=(t=this.resizeHandlers.get(e.target))!==null&&t!==void 0?t:new Set;i.add(e.handler),this.resizeHandlers.set(e.target,i),this.resizeObserver.observe(e.target,e.options)}removeObserver(e){const t=this.resizeHandlers.get(e.target);!t||(t.delete(e.handler),t.size===0&&(this.resizeObserver.unobserve(e.target),this.resizeHandlers.delete(e.target)))}}class as{constructor(e){var t,i,a,o;this.cacheKeyName="collection-name-cache",this.cacheTtl=60*60*24*7,this.defaultLoadDelay=100,this.loadDelay=100,this.defaultPruningAge=1e3*60*60*24*7,this.defaultPruningInterval=1e3*30,this.fetchTimeout=null,this.pendingIdentifierQueue=new Set,this.pendingPromises={},this.collectionNameCache={},this.pruningAge=this.defaultPruningAge,this.maxCacheSize=2500,this.cacheLoaded=!1,this.searchService=e.searchService,this.localCache=e.localCache,this.loadDelay=(t=e.loadDelay)!==null&&t!==void 0?t:this.defaultLoadDelay,this.pruningAge=(i=e.pruningAge)!==null&&i!==void 0?i:this.pruningAge,this.maxCacheSize=(a=e.maxCacheSize)!==null&&a!==void 0?a:this.maxCacheSize,this.pruneCache(),setInterval(async()=>{await this.pruneCache()},(o=e.pruneInterval)!==null&&o!==void 0?o:this.defaultPruningInterval)}async collectionNameFor(e){this.cacheLoaded||await this.loadFromCache();const t=e.toLowerCase(),i=this.collectionNameCache[t];return i?(i.lastAccess=Date.now(),this.collectionNameCache[t]=i,i.name):(this.startPendingIdentifierTimer(),new Promise(a=>{var o;this.pendingIdentifierQueue.add(t);const s=(o=this.pendingPromises[t])!==null&&o!==void 0?o:[],l=async c=>{a(c)};s.push(l),this.pendingPromises[t]=s}))}async preloadIdentifiers(e){this.cacheLoaded||await this.loadFromCache();const t=e.filter(i=>i!==void 0).map(i=>i.toLowerCase());for(const i of t)this.collectionNameCache[i]||this.pendingIdentifierQueue.add(i);this.startPendingIdentifierTimer()}async startPendingIdentifierTimer(){this.fetchTimeout||(this.fetchTimeout=window.setTimeout(()=>{this.loadPendingIdentifiers(),this.fetchTimeout=null},this.loadDelay))}async loadFromCache(){if(!this.localCache||this.cacheLoaded)return;const e=await this.localCache.get(this.cacheKeyName);!e||(this.collectionNameCache=e,this.cacheLoaded=!0)}async loadPendingIdentifiers(){var e,t,i;await this.loadFromCache();const a=Array.from(this.pendingIdentifierQueue).splice(0,100);if(a.length===0)return;a.map(async c=>this.pendingIdentifierQueue.delete(c));const o={query:`identifier:(${a.join(" OR ")})`,fields:["title","identifier"],rows:a.length},l=(t=(e=(await this.searchService.search(o)).success)===null||e===void 0?void 0:e.response)===null||t===void 0?void 0:t.docs;if(l&&l.length>0)for(const c of l){const{identifier:h,title:m}=c;if(!h)continue;const f=h.toLowerCase();a.splice(a.indexOf(f),1);const g=(i=m==null?void 0:m.value)!==null&&i!==void 0?i:null;this.collectionNameCache[f]={name:g,lastAccess:Date.now()};const b=this.pendingPromises[f];if(b){for(const x of b)x(g);delete this.pendingPromises[f]}}for(const c of a){this.collectionNameCache[c]={name:null,lastAccess:Date.now()};const h=this.pendingPromises[c];if(h){for(const m of h)m(null);delete this.pendingPromises[c]}}await this.persistCache()}async pruneCache(){await this.loadFromCache();const e=Date.now(),t=Object.entries(this.collectionNameCache).sort((a,o)=>{var s,l,c,h;const m=(l=(s=a[1])===null||s===void 0?void 0:s.lastAccess)!==null&&l!==void 0?l:0,f=(h=(c=o[1])===null||c===void 0?void 0:c.lastAccess)!==null&&h!==void 0?h:0;return m-f}),i=new Set;for(const[a,o]of t){if(!o)continue;const{lastAccess:s}=o;s<e-this.pruningAge&&i.add(a)}if(t.length>this.maxCacheSize)for(let a=0;a<t.length-this.maxCacheSize;a+=1){const[o]=t[a];i.add(o)}for(const a of i)delete this.collectionNameCache[a];await this.persistCache()}async persistCache(){var e;await((e=this.localCache)===null||e===void 0?void 0:e.set({key:this.cacheKeyName,value:this.collectionNameCache,ttl:this.cacheTtl}))}}let Gt=class extends O{render(){return u` ${this.name?this.name:this.identifier} `}createRenderRoot(){return this}updated(e){(e.has("identifier")||e.has("collectionNameCache"))&&this.fetchName()}async fetchName(){!this.identifier||!this.collectionNameCache||(this.name=await this.collectionNameCache.collectionNameFor(this.identifier))}};n([p({type:Object})],Gt.prototype,"collectionNameCache",void 0);n([p({type:String})],Gt.prototype,"identifier",void 0);n([k()],Gt.prototype,"name",void 0);Gt=n([R("async-collection-name")],Gt);/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Si=r=>r!=null?r:C;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const De={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},$a=r=>(...e)=>({_$litDirective$:r,values:e});class Sa{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{H:rs}=Jo,os=r=>r.strings===void 0,cr=()=>document.createComment(""),Ft=(r,e,t)=>{var i;const a=r._$AA.parentNode,o=e===void 0?r._$AB:e._$AA;if(t===void 0){const s=a.insertBefore(cr(),o),l=a.insertBefore(cr(),o);t=new rs(s,l,r,r.options)}else{const s=t._$AB.nextSibling,l=t._$AM,c=l!==r;if(c){let h;(i=t._$AQ)===null||i===void 0||i.call(t,r),t._$AM=r,t._$AP!==void 0&&(h=r._$AU)!==l._$AU&&t._$AP(h)}if(s!==o||c){let h=t._$AA;for(;h!==s;){const m=h.nextSibling;a.insertBefore(h,o),h=m}}}return t},Ve=(r,e,t=r)=>(r._$AI(e,t),r),ss={},Kr=(r,e=ss)=>r._$AH=e,ns=r=>r._$AH,ji=r=>{var e;(e=r._$AP)===null||e===void 0||e.call(r,!1,!0);let t=r._$AA;const i=r._$AB.nextSibling;for(;t!==i;){const a=t.nextSibling;t.remove(),t=a}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const dr=(r,e,t)=>{const i=new Map;for(let a=e;a<=t;a++)i.set(r[a],a);return i},Yr=$a(class extends Sa{constructor(r){if(super(r),r.type!==De.CHILD)throw Error("repeat() can only be used in text expressions")}dt(r,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);const a=[],o=[];let s=0;for(const l of r)a[s]=i?i(l,s):s,o[s]=t(l,s),s++;return{values:o,keys:a}}render(r,e,t){return this.dt(r,e,t).values}update(r,[e,t,i]){var a;const o=ns(r),{values:s,keys:l}=this.dt(e,t,i);if(!Array.isArray(o))return this.ut=l,s;const c=(a=this.ut)!==null&&a!==void 0?a:this.ut=[],h=[];let m,f,g=0,b=o.length-1,x=0,z=s.length-1;for(;g<=b&&x<=z;)if(o[g]===null)g++;else if(o[b]===null)b--;else if(c[g]===l[x])h[x]=Ve(o[g],s[x]),g++,x++;else if(c[b]===l[z])h[z]=Ve(o[b],s[z]),b--,z--;else if(c[g]===l[z])h[z]=Ve(o[g],s[z]),Ft(r,h[z+1],o[g]),g++,z--;else if(c[b]===l[x])h[x]=Ve(o[b],s[x]),Ft(r,o[g],o[b]),b--,x++;else if(m===void 0&&(m=dr(l,x,z),f=dr(c,g,b)),m.has(c[g]))if(m.has(c[b])){const M=f.get(l[x]),T=M!==void 0?o[M]:null;if(T===null){const L=Ft(r,o[g]);Ve(L,s[x]),h[x]=L}else h[x]=Ve(T,s[x]),Ft(r,o[g],T),o[M]=null;x++}else ji(o[b]),b--;else ji(o[g]),g++;for(;x<=z;){const M=Ft(r,h[z+1]);Ve(M,s[x]),h[x++]=M}for(;g<=b;){const M=o[g++];M!==null&&ji(M)}return this.ut=l,Kr(r,h),he}});function ii(r,e,t){return Array.from({length:(e-r)/t+1},(i,a)=>r+a*t)}let Ie=class extends O{constructor(){super(...arguments),this.itemCount=0,this.scrollOptimizationsDisabled=!1,this.intersectionObserver=new IntersectionObserver(e=>{e.forEach(t=>{if(t.target===this.sentinel){t.isIntersecting&&this.dispatchEvent(new Event("scrollThresholdReached"));return}const a=t.target.dataset.cellIndex;if(!a)return;const o=parseInt(a,10);t.isIntersecting?this.visibleCellIndices.add(o):this.visibleCellIndices.delete(o)}),this.scrollOptimizationsDisabled||this.processVisibleCells()}),this.renderedCellIndices=new Set,this.visibleCellIndices=new Set,this.placeholderCellIndices=new Set}reload(){ii(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.removeCell(t)),this.renderedCellIndices.clear(),this.visibleCellIndices.clear(),this.placeholderCellIndices.clear(),this.setupObservations()}scrollToCell(e,t){const i=this.cellContainers[e];if(!i)return!1;const a=t?"smooth":"auto";return i.scrollIntoView({behavior:a}),!0}getVisibleCellIndices(){return Array.from(this.visibleCellIndices)}updated(e){(e.has("itemCount")||e.has("scrollOptimizationsDisabled"))&&this.setupObservations()}disconnectedCallback(){this.intersectionObserver.disconnect()}setupObservations(){this.setupIntersectionObserver()}setupIntersectionObserver(){this.intersectionObserver.disconnect(),this.sentinel&&this.intersectionObserver.observe(this.sentinel),this.scrollOptimizationsDisabled?(ii(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.visibleCellIndices.add(t)),this.processVisibleCells()):this.cellContainers.forEach(e=>this.intersectionObserver.observe(e))}render(){const e=this.itemCount-1,t=ii(0,e,1);return u`
      <div id="container">
        <div id="sentinel"></div>
        ${Yr(t,i=>i,i=>u`
            <div
    ...
    `}};n([p({type:Number})],Ie.prototype,"itemCount",void 0);n([p({type:Object})],Ie.prototype,"cellProvider",void 0);n([p({type:Object})],Ie.prototype,"placeholderCellTemplate",void 0);n([p({type:Boolean})],Ie.prototype,"scrollOptimizationsDisabled",void 0);n([re("#sentinel")],Ie.prototype,"sentinel",void 0);n([ts(".cell-container")],Ie.prototype,"cellContainers",void 0);Ie=n([R("infinite-scroller")],Ie);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ls=(r,...e)=>({strTag:!0,strings:r,values:e}),lt=ls,cs=r=>typeof r!="string"&&"strTag"in r,ds=(r,e,t)=>{let i=r[0];for(let a=1;a<r.length;a++)i+=e[t?t[a-1]:a-1],i+=r[a];return i};/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const hs=r=>cs(r)?ds(r.strings,r.values):r;/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let us=new ps;us.resolve();/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let je=hs;const qr=E`
...
`;let ca=class extends O{render(){var e,t,i;return u`
      <div id="container">
        ...
        <div id="item-count-container">
          <div id="item-count-image-container">${qr}</div>
    ...
    `}};n([p({type:Object})],ca.prototype,"model",void 0);ca=n([R("collection-tile")],ca);function ui(r,e="short",t="en-US"){if(!r)return"";const i={timeZone:"UTC"};switch(e){case"short":i.month="short",i.year="numeric";break;case"long":i.year="numeric",i.month="short",i.day="2-digit";break}return new Intl.DateTimeFormat(t,i).format(r)}/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const da=$a(class extends Sa{constructor(r){var e;if(super(r),r.type!==De.ATTRIBUTE||r.name!=="class"||((e=r.strings)===null||e===void 0?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(r){return" "+Object.keys(r).filter(e=>r[e]).join(" ")+" "}update(r,[e]){var t,i;if(this.et===void 0){this.et=new Set,r.strings!==void 0&&(this.st=new Set(r.strings.join(" ").split(/\s/).filter(o=>o!=="")));for(const o in e)e[o]&&!(!((t=this.st)===null||t===void 0)&&t.has(o))&&this.et.add(o);return this.render(e)}const a=r.element.classList;this.et.forEach(o=>{o in e||(a.remove(o),this.et.delete(o))});for(const o in e){const s=!!e[o];s===this.et.has(o)||((i=this.st)===null||i===void 0?void 0:i.has(o))||(s?(a.add(o),this.et.add(o)):(a.remove(o),this.et.delete(o)))}return he}}),ms=E`
  <svg
    viewBox="0 0 100 100"
    xmlns="http://www.w3.org/2000/svg"
  >
...
`;let mi=class extends O{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1}render(){return this.loginRequired&&!this.loggedIn?u`${fs} `:u`${ms}`}static get styles(){return v`
      :host {
        position: absolute;
        top: 50%;
        left: 50%;
    ...
    `}};n([p({type:Boolean})],mi.prototype,"loggedIn",void 0);n([p({type:Boolean})],mi.prototype,"loginRequired",void 0);mi=n([R("icon-overlay")],mi);let fi=class extends O{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1}render(){return u` <div class="overlay no-preview">${this.textDisplay}</div> `}get textDisplay(){return this.loginRequired&&!this.loggedIn?`Log in
to view this item`:"Content may be inappropriate"}static get styles(){return v`
    ...
    `}};n([p({type:Boolean})],fi.prototype,"loggedIn",void 0);n([p({type:Boolean})],fi.prototype,"loginRequired",void 0);fi=n([R("text-overlay")],fi);let Fe=class extends O{constructor(){super(...arguments),this.isCompactTile=!1,this.isListTile=!1,this.loggedIn=!1,this.viewSize="desktop"}render(){var e;return!((e=this.model)===null||e===void 0)&&e.identifier?u`
      <div class=${da(this.baseClass)}>
        <item-image
          .model=${this.model}
    ...
    `:C}get baseClass(){return{list:this.isListTile&&!this.isCompactTile,"list-compact":this.isListTile&&this.isCompactTile,[this.viewSize]:!0}}get iconOverlayTemplate(){var e,t,i;return!this.isListTile||!(!((e=this.model)===null||e===void 0)&&e.loginRequired)&&!(!((t=this.model)===null||t===void 0)&&t.contentWarning)?C:u`
      <icon-overlay
        .loggedIn=${this.loggedIn}
        .loginRequired=${(i=this.model)===null||i===void 0?void 0:i.loginRequired}
      >
      </icon-overlay>
    `}get textOverlayTemplate(){var e,t,i;return this.isListTile||!(!((e=this.model)===null||e===void 0)&&e.loginRequired)&&!(!((t=this.model)===null||t===void 0)&&t.contentWarning)?C:u`
      <text-overlay
        .loggedIn=${this.loggedIn}
        .loginRequired=${(i=this.model)===null||i===void 0?void 0:i.loginRequired}
      >
...
`,Ms={account:{color:"#000000",icon:ys,text:"Account"},audio:{color:"#00adef",icon:bs,text:"Audio"},collection:{color:"#4666ff",icon:qr,text:"Collection"},data:{color:"#333333",icon:ws,text:"Data"},etree:{color:"#00adef",icon:xs,text:"E-tree"},film:{color:"#bf1b2c",icon:hr,text:"Film"},image:{color:"#aa99c9",icon:$s,text:"Image"},movies:{color:"#f1644b",icon:hr,text:"Movie"},radio:{color:"#8fdaef",icon:Ss,text:"Radio"},software:{color:"#9ecc4f",icon:Cs,text:"Software"},texts:{color:"#faab3c",icon:_s,text:"Text"},tv:{color:"#f1644b",icon:zs,text:"TV"},video:{color:"#f1644b",icon:ks,text:"Video"},web:{color:"#ffcd27",icon:Ts,text:"Web"}};let Kt=class extends O{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var e,t;const i=["tvnews","tvarchive","television"],a=["radio","radioprogram"];return this.mediatype==="movies"&&((e=this.collections)===null||e===void 0?void 0:e.some(o=>i.indexOf(o)>=0))?"tv":this.mediatype==="audio"&&((t=this.collections)===null||t===void 0?void 0:t.some(o=>a.indexOf(o)>=0))?"radio":this.mediatype||""}render(){const e=Ms[this.displayMediatype];return e?u`
      <div
        id="icon"
    ...
    `}};n([p({type:String})],Kt.prototype,"mediatype",void 0);n([p({type:Array})],Kt.prototype,"collections",void 0);n([p({type:Boolean})],Kt.prototype,"showText",void 0);Kt=n([R("mediatype-icon")],Kt);const Ds=E`
...
`;function Os(r,e){let t=1;return r>=1e9?t=1e9:r>=1e6?t=1e6:r>=1e3&&e==="short"&&(t=1e3),t}function Is(r=0,e){const t=r/e,i=t<10;let a=0;return i?a=Math.round((t+Number.EPSILON)*10)/10:a=Math.round(t),a}function Fs(r,e,t,i){switch(e){case 1e9:return je(t==="short"?lt`${r}B`:lt`${r} billion`);case 1e6:return je(t==="short"?lt`${r}M`:lt`${r} million`);case 1e3:return je(t==="short"?lt`${r}K`:lt`${r} thousand`);default:return new Intl.NumberFormat(i).format(r)}}function Bt(r,e="long",t="short",i="en-US"){const a=r!=null?r:-1;if(a<0)return"";const o=Os(a,e),s=Is(a,o);return Fs(s,o,t,i)}let Ze=class extends O{render(){return u`
    ...
    `}get creatorTemplate(){var e,t;return u`
      <div class="created-by truncated">
        ${!((e=this.model)===null||e===void 0)&&e.creator?u`<span>by&nbsp;${(t=this.model)===null||t===void 0?void 0:t.creator}</span>`:C}
      </div>
    `}static get styles(){return v`
      .container {
    ...
    `}};n([p({type:String})],gt.prototype,"baseImageUrl",void 0);n([p({type:Boolean})],gt.prototype,"loggedIn",void 0);n([p({type:Object})],gt.prototype,"model",void 0);n([p({type:Object})],gt.prototype,"sortParam",void 0);gt=n([R("item-tile")],gt);let ha=class extends O{render(){var e,t,i,a,o,s,l,c;return u`
    ...
    `}};n([p({type:Object})],ha.prototype,"model",void 0);ha=n([R("account-tile")],ha);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*Qi(r,e){const t=typeof e=="function";if(r!==void 0){let i=-1;for(const a of r)i>-1&&(yield t?e(i):e),i++,yield a}}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*pr(r,e){if(r!==void 0){let t=0;for(const i of r)yield e(i,t++)}}/*! @license DOMPurify 2.3.8 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/2.3.8/LICENSE */function Qe(r){return Qe=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},Qe(r)}function pa(r,e){return pa=Object.setPrototypeOf||function(i,a){return i.__proto__=a,i},pa(r,e)}function Ps(){if(typeof Reflect=="undefined"||!Reflect.construct||Reflect.construct.sham)return!1;if(typeof Proxy=="function")return!0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],function(){})),!0}catch{return!1}}function ni(r,e,t){return Ps()?ni=Reflect.construct:ni=function(a,o,s){var l=[null];l.push.apply(l,o);var c=Function.bind.apply(a,l),h=new c;return s&&pa(h,s.prototype),h},ni.apply(null,arguments)}function me(r){return Rs(r)||Ns(r)||Bs(r)||Hs()}function Rs(r){if(Array.isArray(r))return ua(r)}function Ns(r){if(typeof Symbol!="undefined"&&r[Symbol.iterator]!=null||r["@@iterator"]!=null)return Array.from(r)}function Bs(r,e){if(!!r){if(typeof r=="string")return ua(r,e);var t=Object.prototype.toString.call(r).slice(8,-1);if(t==="Object"&&r.constructor&&(t=r.constructor.name),t==="Map"||t==="Set")return Array.from(r);if(t==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t))return ua(r,e)}}function ua(r,e){(e==null||e>r.length)&&(e=r.length);for(var t=0,i=new Array(e);t<e;t++)i[t]=r[t];return i}function Hs(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}var Us=Object.hasOwnProperty,ur=Object.setPrototypeOf,Vs=Object.isFrozen,Ws=Object.getPrototypeOf,js=Object.getOwnPropertyDescriptor,ie=Object.freeze,we=Object.seal,Qs=Object.create,Zr=typeof Reflect!="undefined"&&Reflect,vi=Zr.apply,ma=Zr.construct;vi||(vi=function(e,t,i){return e.apply(t,i)});ie||(ie=function(e){return e});we||(we=function(e){return e});ma||(ma=function(e,t){return ni(e,me(t))});var Gs=ve(Array.prototype.forEach),mr=ve(Array.prototype.pop),Pt=ve(Array.prototype.push),li=ve(String.prototype.toLowerCase),Ks=ve(String.prototype.match),Me=ve(String.prototype.replace),Ys=ve(String.prototype.indexOf),qs=ve(String.prototype.trim),te=ve(RegExp.prototype.test),Gi=Zs(TypeError);function ve(r){return function(e){for(var t=arguments.length,i=new Array(t>1?t-1:0),a=1;a<t;a++)i[a-1]=arguments[a];return vi(r,e,i)}}function Zs(r){return function(){for(var e=arguments.length,t=new Array(e),i=0;i<e;i++)t[i]=arguments[i];return ma(r,t)}}function A(r,e){ur&&ur(r,null);for(var t=e.length;t--;){var i=e[t];if(typeof i=="string"){var a=li(i);a!==i&&(Vs(e)||(e[t]=a),i=a)}r[i]=!0}return r}function We(r){var e=Qs(null),t;for(t in r)vi(Us,r,[t])&&(e[t]=r[t]);return e}function ai(r,e){for(;r!==null;){var t=js(r,e);if(t){if(t.get)return ve(t.get);if(typeof t.value=="function")return ve(t.value)}r=Ws(r)}function i(a){return console.warn("fallback value for",a),null}return i}var fr=ie(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","section","select","shadow","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),Ki=ie(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","filter","font","g","glyph","glyphref","hkern","image","line","lineargradient","marker","mask","metadata","mpath","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),Yi=ie(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),Xs=ie(["animate","color-profile","cursor","discard","fedropshadow","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),qi=ie(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover"]),Js=ie(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),vr=ie(["#text"]),gr=ie(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","face","for","headers","height","hidden","high","href","hreflang","id","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","pattern","placeholder","playsinline","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","xmlns","slot"]),Zi=ie(["accent-height","accumulate","additive","alignment-baseline","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),yr=ie(["accent","accentunder","align","bevelled","close","columnsalign","columnlines","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lspace","lquote","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),ri=ie(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),en=we(/\{\{[\w\W]*|[\w\W]*\}\}/gm),tn=we(/<%[\w\W]*|[\w\W]*%>/gm),an=we(/^data-[\-\w.\u00B7-\uFFFF]/),rn=we(/^aria-[\-\w]+$/),on=we(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|cid|xmpp):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),sn=we(/^(?:\w+script|data):/i),nn=we(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),ln=we(/^html$/i),cn=function(){return typeof window=="undefined"?null:window},dn=function(e,t){if(Qe(e)!=="object"||typeof e.createPolicy!="function")return null;var i=null,a="data-tt-policy-suffix";t.currentScript&&t.currentScript.hasAttribute(a)&&(i=t.currentScript.getAttribute(a));var o="dompurify"+(i?"#"+i:"");try{return e.createPolicy(o,{createHTML:function(l){return l}})}catch{return console.warn("TrustedTypes policy "+o+" could not be created."),null}};function Xr(){var r=arguments.length>0&&arguments[0]!==void 0?arguments[0]:cn(),e=function(d){return Xr(d)};if(e.version="2.3.8",e.removed=[],!r||!r.document||r.document.nodeType!==9)return e.isSupported=!1,e;var t=r.document,i=r.document,a=r.DocumentFragment,o=r.HTMLTemplateElement,s=r.Node,l=r.Element,c=r.NodeFilter,h=r.NamedNodeMap,m=h===void 0?r.NamedNodeMap||r.MozNamedAttrMap:h,f=r.HTMLFormElement,g=r.DOMParser,b=r.trustedTypes,x=l.prototype,z=ai(x,"cloneNode"),M=ai(x,"nextSibling"),T=ai(x,"childNodes"),L=ai(x,"parentNode");if(typeof o=="function"){var I=i.createElement("template");I.content&&I.content.ownerDocument&&(i=I.content.ownerDocument)}var P=dn(b,t),W=P?P.createHTML(""):"",X=i,ye=X.implementation,_t=X.createNodeIterator,zt=X.createDocumentFragment,kt=X.getElementsByTagName,Tt=t.importNode,Xe={};try{Xe=We(i).documentMode?i.documentMode:{}}catch{}var oe={};e.isSupported=typeof L=="function"&&ye&&typeof ye.createHTMLDocument!="undefined"&&Xe!==9;var Pe=en,Re=tn,Mt=an,Dt=rn,At=sn,Je=nn,Ne=on,j=null,et=A({},[].concat(me(fr),me(Ki),me(Yi),me(qi),me(vr))),Q=null,tt=A({},[].concat(me(gr),me(Zi),me(yr),me(ri))),U=Object.seal(Object.create(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),ke=null,_i=null,Ma=!0,zi=!0,Da=!1,it=!1,Be=!1,ki=!1,Ti=!1,at=!1,Zt=!1,Xt=!1,Aa=!0,Mi=!0,Lt=!1,rt={},ot=null,La=A({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","style","svg","template","thead","title","video","xmp"]),Ea=null,Oa=A({},["audio","video","img","source","image","track"]),Di=null,Ia=A({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),Ai="http://www.w3.org/1998/Math/MathML",Li="http://www.w3.org/2000/svg",Te="http://www.w3.org/1999/xhtml",Jt=Te,Ei=!1,st,uo=["application/xhtml+xml","text/html"],mo="text/html",He,nt=null,fo=i.createElement("form"),Fa=function(d){return d instanceof RegExp||d instanceof Function},Oi=function(d){nt&&nt===d||((!d||Qe(d)!=="object")&&(d={}),d=We(d),j="ALLOWED_TAGS"in d?A({},d.ALLOWED_TAGS):et,Q="ALLOWED_ATTR"in d?A({},d.ALLOWED_ATTR):tt,Di="ADD_URI_SAFE_ATTR"in d?A(We(Ia),d.ADD_URI_SAFE_ATTR):Ia,Ea="ADD_DATA_URI_TAGS"in d?A(We(Oa),d.ADD_DATA_URI_TAGS):Oa,ot="FORBID_CONTENTS"in d?A({},d.FORBID_CONTENTS):La,ke="FORBID_TAGS"in d?A({},d.FORBID_TAGS):{},_i="FORBID_ATTR"in d?A({},d.FORBID_ATTR):{},rt="USE_PROFILES"in d?d.USE_PROFILES:!1,Ma=d.ALLOW_ARIA_ATTR!==!1,zi=d.ALLOW_DATA_ATTR!==!1,Da=d.ALLOW_UNKNOWN_PROTOCOLS||!1,it=d.SAFE_FOR_TEMPLATES||!1,Be=d.WHOLE_DOCUMENT||!1,at=d.RETURN_DOM||!1,Zt=d.RETURN_DOM_FRAGMENT||!1,Xt=d.RETURN_TRUSTED_TYPE||!1,Ti=d.FORCE_BODY||!1,Aa=d.SANITIZE_DOM!==!1,Mi=d.KEEP_CONTENT!==!1,Lt=d.IN_PLACE||!1,Ne=d.ALLOWED_URI_REGEXP||Ne,Jt=d.NAMESPACE||Te,d.CUSTOM_ELEMENT_HANDLING&&Fa(d.CUSTOM_ELEMENT_HANDLING.tagNameCheck)&&(U.tagNameCheck=d.CUSTOM_ELEMENT_HANDLING.tagNameCheck),d.CUSTOM_ELEMENT_HANDLING&&Fa(d.CUSTOM_ELEMENT_HANDLING.attributeNameCheck)&&(U.attributeNameCheck=d.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),d.CUSTOM_ELEMENT_HANDLING&&typeof d.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements=="boolean"&&(U.allowCustomizedBuiltInElements=d.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements),st=uo.indexOf(d.PARSER_MEDIA_TYPE)===-1?st=mo:st=d.PARSER_MEDIA_TYPE,He=st==="application/xhtml+xml"?function(y){return y}:li,it&&(zi=!1),Zt&&(at=!0),rt&&(j=A({},me(vr)),Q=[],rt.html===!0&&(A(j,fr),A(Q,gr)),rt.svg===!0&&(A(j,Ki),A(Q,Zi),A(Q,ri)),rt.svgFilters===!0&&(A(j,Yi),A(Q,Zi),A(Q,ri)),rt.mathMl===!0&&(A(j,qi),A(Q,yr),A(Q,ri))),d.ADD_TAGS&&(j===et&&(j=We(j)),A(j,d.ADD_TAGS)),d.ADD_ATTR&&(Q===tt&&(Q=We(Q)),A(Q,d.ADD_ATTR)),d.ADD_URI_SAFE_ATTR&&A(Di,d.ADD_URI_SAFE_ATTR),d.FORBID_CONTENTS&&(ot===La&&(ot=We(ot)),A(ot,d.FORBID_CONTENTS)),Mi&&(j["#text"]=!0),Be&&A(j,["html","head","body"]),j.table&&(A(j,["tbody"]),delete ke.tbody),ie&&ie(d),nt=d)},Pa=A({},["mi","mo","mn","ms","mtext"]),Ra=A({},["foreignobject","desc","title","annotation-xml"]),vo=A({},["title","style","font","a","script"]),ei=A({},Ki);A(ei,Yi),A(ei,Xs);var Ii=A({},qi);A(Ii,Js);var go=function(d){var y=L(d);(!y||!y.tagName)&&(y={namespaceURI:Te,tagName:"template"});var $=li(d.tagName),N=li(y.tagName);return d.namespaceURI===Li?y.namespaceURI===Te?$==="svg":y.namespaceURI===Ai?$==="svg"&&(N==="annotation-xml"||Pa[N]):Boolean(ei[$]):d.namespaceURI===Ai?y.namespaceURI===Te?$==="math":y.namespaceURI===Li?$==="math"&&Ra[N]:Boolean(Ii[$]):d.namespaceURI===Te?y.namespaceURI===Li&&!Ra[N]||y.namespaceURI===Ai&&!Pa[N]?!1:!Ii[$]&&(vo[$]||!ei[$]):!1},$e=function(d){Pt(e.removed,{element:d});try{d.parentNode.removeChild(d)}catch{try{d.outerHTML=W}catch{d.remove()}}},Na=function(d,y){try{Pt(e.removed,{attribute:y.getAttributeNode(d),from:y})}catch{Pt(e.removed,{attribute:null,from:y})}if(y.removeAttribute(d),d==="is"&&!Q[d])if(at||Zt)try{$e(y)}catch{}else try{y.setAttribute(d,"")}catch{}},Ba=function(d){var y,$;if(Ti)d="<remove></remove>"+d;else{var N=Ks(d,/^[\r\n\t ]+/);$=N&&N[0]}st==="application/xhtml+xml"&&(d='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+d+"</body></html>");var se=P?P.createHTML(d):d;if(Jt===Te)try{y=new g().parseFromString(se,st)}catch{}if(!y||!y.documentElement){y=ye.createDocument(Jt,"template",null);try{y.documentElement.innerHTML=Ei?"":se}catch{}}var J=y.body||y.documentElement;return d&&$&&J.insertBefore(i.createTextNode($),J.childNodes[0]||null),Jt===Te?kt.call(y,Be?"html":"body")[0]:Be?y.documentElement:J},Ha=function(d){return _t.call(d.ownerDocument||d,d,c.SHOW_ELEMENT|c.SHOW_COMMENT|c.SHOW_TEXT,null,!1)},yo=function(d){return d instanceof f&&(typeof d.nodeName!="string"||typeof d.textContent!="string"||typeof d.removeChild!="function"||!(d.attributes instanceof m)||typeof d.removeAttribute!="function"||typeof d.setAttribute!="function"||typeof d.namespaceURI!="string"||typeof d.insertBefore!="function")},Et=function(d){return Qe(s)==="object"?d instanceof s:d&&Qe(d)==="object"&&typeof d.nodeType=="number"&&typeof d.nodeName=="string"},Se=function(d,y,$){!oe[d]||Gs(oe[d],function(N){N.call(e,y,$,nt)})},Ua=function(d){var y;if(Se("beforeSanitizeElements",d,null),yo(d)||te(/[\u0080-\uFFFF]/,d.nodeName))return $e(d),!0;var $=He(d.nodeName);if(Se("uponSanitizeElement",d,{tagName:$,allowedTags:j}),d.hasChildNodes()&&!Et(d.firstElementChild)&&(!Et(d.content)||!Et(d.content.firstElementChild))&&te(/<[/\w]/g,d.innerHTML)&&te(/<[/\w]/g,d.textContent)||$==="select"&&te(/<template/i,d.innerHTML))return $e(d),!0;if(!j[$]||ke[$]){if(!ke[$]&&Wa($)&&(U.tagNameCheck instanceof RegExp&&te(U.tagNameCheck,$)||U.tagNameCheck instanceof Function&&U.tagNameCheck($)))return!1;if(Mi&&!ot[$]){var N=L(d)||d.parentNode,se=T(d)||d.childNodes;if(se&&N)for(var J=se.length,Y=J-1;Y>=0;--Y)N.insertBefore(z(se[Y],!0),M(d))}return $e(d),!0}return d instanceof l&&!go(d)||($==="noscript"||$==="noembed")&&te(/<\/no(script|embed)/i,d.innerHTML)?($e(d),!0):(it&&d.nodeType===3&&(y=d.textContent,y=Me(y,Pe," "),y=Me(y,Re," "),d.textContent!==y&&(Pt(e.removed,{element:d.cloneNode()}),d.textContent=y)),Se("afterSanitizeElements",d,null),!1)},Va=function(d,y,$){if(Aa&&(y==="id"||y==="name")&&($ in i||$ in fo))return!1;if(!(zi&&!_i[y]&&te(Mt,y))){if(!(Ma&&te(Dt,y))){if(!Q[y]||_i[y]){if(!(Wa(d)&&(U.tagNameCheck instanceof RegExp&&te(U.tagNameCheck,d)||U.tagNameCheck instanceof Function&&U.tagNameCheck(d))&&(U.attributeNameCheck instanceof RegExp&&te(U.attributeNameCheck,y)||U.attributeNameCheck instanceof Function&&U.attributeNameCheck(y))||y==="is"&&U.allowCustomizedBuiltInElements&&(U.tagNameCheck instanceof RegExp&&te(U.tagNameCheck,$)||U.tagNameCheck instanceof Function&&U.tagNameCheck($))))return!1}else if(!Di[y]){if(!te(Ne,Me($,Je,""))){if(!((y==="src"||y==="xlink:href"||y==="href")&&d!=="script"&&Ys($,"data:")===0&&Ea[d])){if(!(Da&&!te(At,Me($,Je,"")))){if($)return!1}}}}}}return!0},Wa=function(d){return d.indexOf("-")>0},ja=function(d){var y,$,N,se;Se("beforeSanitizeAttributes",d,null);var J=d.attributes;if(!!J){var Y={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:Q};for(se=J.length;se--;){y=J[se];var ti=y,ee=ti.name,Qa=ti.namespaceURI;if($=ee==="value"?y.value:qs(y.value),N=He(ee),Y.attrName=N,Y.attrValue=$,Y.keepAttr=!0,Y.forceKeepAttr=void 0,Se("uponSanitizeAttribute",d,Y),$=Y.attrValue,!Y.forceKeepAttr&&(Na(ee,d),!!Y.keepAttr)){if(te(/\/>/i,$)){Na(ee,d);continue}it&&($=Me($,Pe," "),$=Me($,Re," "));var wo=He(d.nodeName);if(!!Va(wo,N,$))try{Qa?d.setAttributeNS(Qa,ee,$):d.setAttribute(ee,$),mr(e.removed)}catch{}}}Se("afterSanitizeAttributes",d,null)}},bo=function _(d){var y,$=Ha(d);for(Se("beforeSanitizeShadowDOM",d,null);y=$.nextNode();)Se("uponSanitizeShadowNode",y,null),!Ua(y)&&(y.content instanceof a&&_(y.content),ja(y));Se("afterSanitizeShadowDOM",d,null)};return e.sanitize=function(_,d){var y,$,N,se,J;if(Ei=!_,Ei&&(_="<!-->"),typeof _!="string"&&!Et(_)){if(typeof _.toString!="function")throw Gi("toString is not a function");if(_=_.toString(),typeof _!="string")throw Gi("dirty is not a string, aborting")}if(!e.isSupported){if(Qe(r.toStaticHTML)==="object"||typeof r.toStaticHTML=="function"){if(typeof _=="string")return r.toStaticHTML(_);if(Et(_))return r.toStaticHTML(_.outerHTML)}return _}if(ki||Oi(d),e.removed=[],typeof _=="string"&&(Lt=!1),Lt){if(_.nodeName){var Y=He(_.nodeName);if(!j[Y]||ke[Y])throw Gi("root node is forbidden and cannot be sanitized in-place")}}else if(_ instanceof s)y=Ba("<!---->"),$=y.ownerDocument.importNode(_,!0),$.nodeType===1&&$.nodeName==="BODY"||$.nodeName==="HTML"?y=$:y.appendChild($);else{if(!at&&!it&&!Be&&_.indexOf("<")===-1)return P&&Xt?P.createHTML(_):_;if(y=Ba(_),!y)return at?null:Xt?W:""}y&&Ti&&$e(y.firstChild);for(var ti=Ha(Lt?_:y);N=ti.nextNode();)N.nodeType===3&&N===se||Ua(N)||(N.content instanceof a&&bo(N.content),ja(N),se=N);if(se=null,Lt)return _;if(at){if(Zt)for(J=zt.call(y.ownerDocument);y.firstChild;)J.appendChild(y.firstChild);else J=y;return Q.shadowroot&&(J=Tt.call(t,J,!0)),J}var ee=Be?y.outerHTML:y.innerHTML;return Be&&j["!doctype"]&&y.ownerDocument&&y.ownerDocument.doctype&&y.ownerDocument.doctype.name&&te(ln,y.ownerDocument.doctype.name)&&(ee="<!DOCTYPE "+y.ownerDocument.doctype.name+`>
`+ee),it&&(ee=Me(ee,Pe," "),ee=Me(ee,Re," ")),P&&Xt?P.createHTML(ee):ee},e.setConfig=function(_){Oi(_),ki=!0},e.clearConfig=function(){nt=null,ki=!1},e.isValidAttribute=function(_,d,y){nt||Oi({});var $=He(_),N=He(d);return Va($,N,y)},e.addHook=function(_,d){typeof d=="function"&&(oe[_]=oe[_]||[],Pt(oe[_],d))},e.removeHook=function(_){if(oe[_])return mr(oe[_])},e.removeHooks=function(_){oe[_]&&(oe[_]=[])},e.removeAllHooks=function(){oe={}},e}var Ht=Xr();function Jr(r){switch(r){case"date":return"Published";case"reviewdate":return"Reviewed";case"addeddate":return"Added";default:return"Archived"}}function eo(r){return r?`Archivist since ${r.getFullYear()}`:""}let pe=class extends O{constructor(){super(...arguments),this.sortParam=null,this.collectionLinks=[],this.loggedIn=!1}updated(e){e.has("model")&&this.fetchCollectionNames()}async fetchCollectionNames(){var e,t;if(!(!((e=this.model)===null||e===void 0)&&e.collections)||this.model.collections.length===0||!this.collectionNameCache)return;this.collectionLinks=[];const i=[],a=[];for(const o of this.model.collections)a.push((t=this.collectionNameCache)===null||t===void 0?void 0:t.collectionNameFor(o).then(s=>{i.push(this.detailsLink(o,s!=null?s:o))}));await Promise.all(a),this.collectionLinks=i}render(){return u`
    ...
    `}get titleTemplate(){var e;return!((e=this.model)===null||e===void 0)&&e.title?u` ${this.detailsLink(this.model.identifier,this.model.title)} `:C}get itemLineTemplate(){const e=this.sourceTemplate,t=this.volumeTemplate,i=this.issueTemplate;return!e&&!t&&!i?C:u` <div id="item-line">${e} ${t} ${i}</div> `}get sourceTemplate(){var e;return!((e=this.model)===null||e===void 0)&&e.source?u`
      <div id="source" class="metadata">
        ${this.labelTemplate("Source")}
        ${this.searchLink("source",this.model.source)}
      </div>
    `:C}get volumeTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.volume,"Volume")}get issueTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.issue,"Issue")}get creatorTemplate(){var e,t,i;return((e=this.model)===null||e===void 0?void 0:e.mediatype)==="account"?u`
        <div id="creator" class="metadata">
          <span class="label"> ${eo((t=this.model)===null||t===void 0?void 0:t.dateAdded)} </span>
        </div>
      `:!(!((i=this.model)===null||i===void 0)&&i.creators)||this.model.creators.length===0?C:u`
      <div id="creator" class="metadata">
        ${this.labelTemplate("By")}
        ${Qi(pr(this.model.creators,a=>this.searchLink("creator",a)),u`, `)}
      </div>
    `}get datePublishedTemplate(){var e;return this.metadataTemplate(ui((e=this.model)===null||e===void 0?void 0:e.datePublished,"long"),"Published")}get dateSortByTemplate(){return this.sortParam&&(this.sortParam.field==="addeddate"||this.sortParam.field==="reviewdate"||this.sortParam.field==="publicdate")?this.metadataTemplate(ui(this.date,"long"),Jr(this.sortParam.field)):C}get viewsTemplate(){var e,t;return this.metadataTemplate(`${Bt((t=(e=this.model)===null||e===void 0?void 0:e.viewCount)!==null&&t!==void 0?t:0,this.formatSize)}`,"Views")}get ratingTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.averageRating,"Avg Rating")}get reviewsTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.commentCount,"Reviews")}get topicsTemplate(){var e;return!(!((e=this.model)===null||e===void 0)&&e.subjects)||this.model.subjects.length===0?C:u`
      <div id="topics" class="metadata">
        ${this.labelTemplate("Topics")}
        ${Qi(pr(this.model.subjects,t=>this.searchLink("subject",t)),u`, `)}
      </div>
    `}get collectionsTemplate(){return!this.collectionLinks||this.collectionLinks.length===0?C:u`
      <div id="collections" class="metadata">
        ${this.labelTemplate("Collections")}
        ${Qi(this.collectionLinks,u`, `)}
      </div>
    `}get descriptionTemplate(){var e,t;return this.metadataTemplate(Ht.sanitize((t=(e=this.model)===null||e===void 0?void 0:e.description)!==null&&t!==void 0?t:""),"","description")}metadataTemplate(e,t="",i){return e?u`
      <div id=${Si(i)} class="metadata">
        ${this.labelTemplate(t)} ${e}
      </div>
    `:C}labelTemplate(e){return u` ${e?u`<span class="label">${e}: </span>`:C}`}searchLink(e,t){if(!e||!t)return C;const i=encodeURIComponent(`${e}:"${t}"`);return u`<a href="${this.baseNavigationUrl}/search.php?query=${i}">
      ${Ht.sanitize(t)}</a
    ...
    `}};n([p({type:Object})],pe.prototype,"model",void 0);n([p({type:String})],pe.prototype,"baseNavigationUrl",void 0);n([p({type:Object})],pe.prototype,"collectionNameCache",void 0);n([p({type:Number})],pe.prototype,"currentWidth",void 0);n([p({type:Number})],pe.prototype,"currentHeight",void 0);n([p({type:Object})],pe.prototype,"sortParam",void 0);n([p({type:Number})],pe.prototype,"mobileBreakpoint",void 0);n([k()],pe.prototype,"collectionLinks",void 0);n([p({type:String})],pe.prototype,"baseImageUrl",void 0);n([p({type:Boolean})],pe.prototype,"loggedIn",void 0);pe=n([R("tile-list")],pe);let xe=class extends O{constructor(){super(...arguments),this.sortParam=null,this.loggedIn=!1}render(){var e,t,i,a,o,s,l,c,h,m;return u`
      <div id="list-line" class="${this.classSize}">
        <image-block
          .model=${this.model}
          .baseImageUrl=${this.baseImageUrl}
        ...
        <div id="creator">
          ${((i=this.model)===null||i===void 0?void 0:i.mediatype)==="account"?eo((a=this.model)===null||a===void 0?void 0:a.dateAdded):Ht.sanitize((s=(o=this.model)===null||o===void 0?void 0:o.creator)!==null&&s!==void 0?s:"")}
        </div>
    ...
    `}};n([p({type:Object})],yt.prototype,"model",void 0);n([p({type:Number})],yt.prototype,"currentWidth",void 0);n([p({type:Object})],yt.prototype,"sortParam",void 0);n([p({type:Number})],yt.prototype,"mobileBreakpoint",void 0);yt=n([R("tile-list-compact-header")],yt);let le=class extends O{constructor(){super(...arguments),this.sortParam=null,this.loggedIn=!1}render(){return u`
      <div id="container">
    ...
    `}handleResize(e){this.currentWidth=e.contentRect.width,this.currentHeight=e.contentRect.height}disconnectedCallback(){this.stopResizeObservation(this.resizeObserver)}stopResizeObservation(e){e==null||e.removeObserver({handler:this,target:this.container})}startResizeObservation(){var e;this.stopResizeObservation(this.resizeObserver),(e=this.resizeObserver)===null||e===void 0||e.addObserver({handler:this,target:this.container})}updated(e){if(e.has("resizeObserver")){const t=e.get("resizeObserver");this.stopResizeObservation(t),this.startResizeObservation()}}get tile(){const{model:e,baseNavigationUrl:t,currentWidth:i,currentHeight:a,sortParam:o,mobileBreakpoint:s}=this;if(!e)return C;switch(this.tileDisplayMode){case"grid":switch(e.mediatype){case"collection":return u`<collection-tile
        ...
        >
          ...
          .loggedIn=${this.loggedIn}
        >
        </tile-list>`;default:return C}}static get styles(){return v`
      :host {
        display: block;
        height: 100%;
      }
    ...
    `}};br=n([R("collection-browser-loading-tile")],br);var F;(function(r){r.relevance="relevance",r.views="views",r.title="title",r.datearchived="datearchived",r.date="date",r.datereviewed="datereviewed",r.dateadded="dateadded",r.creator="creator"})(F||(F={}));const Rt={relevance:"Relevance",views:"Views",title:"Title",datearchived:"Date Archived",date:"Date Published",datereviewed:"Date Reviewed",dateadded:"Date Added",creator:"Creator"},hn={relevance:null,views:"week",title:"titleSorter",datearchived:"publicdate",date:"date",datereviewed:"reviewdate",dateadded:"addeddate",creator:"creatorSorter"},wr={titleSorter:F.title,date:F.date,publicdate:F.datearchived,reviewdate:F.datereviewed,addeddate:F.dateadded,creatorSorter:F.creator,week:F.views},Yt={subject:{},mediatype:{},language:{},creator:{},collection:{},year:{}};let gi=class extends O{constructor(){super(...arguments),this.selectedLetter=null,this.alphabet="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("")}get selectedUppercaseLetter(){var e;return(e=this.selectedLetter)===null||e===void 0?void 0:e.toUpperCase()}render(){return u`
      <div id="container">
        <ul>
    ...
    `}letterClicked(e){e===this.selectedUppercaseLetter?this.selectedLetter=null:this.selectedLetter=e,this.dispatchEvent(new CustomEvent("letterChanged",{detail:{selectedLetter:this.selectedUppercaseLetter}}))}};gi.styles=v`
    h1 {
      font-size: 1.2rem;
    }
  ...
  `;n([p({type:String})],gi.prototype,"selectedLetter",void 0);gi=n([R("alpha-bar")],gi);const xr=E`
...
`;let q=class extends O{constructor(){super(...arguments),this.sortDirection=null,this.selectedSort=F.relevance,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.showRelevance=!0,this.alphaSelectorVisible=null,this.dateSortSelectorVisible=!1,this.desktopSelectorBarWidth=0,this.selectorBarContainerWidth=0,this.hoveringOverDateSortOptions=!1,this.boundDateSelectorEscapeListener=e=>{e.key==="Escape"&&(this.dateSortSelectorVisible=!1)}}render(){return u`
    ...
    `}get desktopSortSelectorTemplate(){return u`
      ...
      >
        ...
        <li>
          ${this.showRelevance?this.getSortDisplayOption(F.relevance):C}
        </li>
        <li>${this.getSortDisplayOption(F.views)}</li>
        <li>
          ${this.getSortDisplayOption(F.title,{clickEvent:()=>{this.alphaSelectorVisible="title",this.selectedCreatorFilter=null,this.dateSortSelectorVisible=!1,this.setSelectedSort(F.title),this.emitCreatorLetterChangedEvent()}})}
        </li>
        <li>
          ${this.getSortDisplayOption(F.date,{clickEvent:()=>{this.dateOptionSelected||this.setSelectedSort(F.date),this.dateSortSelectorVisible=!this.dateSortSelectorVisible,this.alphaSelectorVisible=null,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.emitTitleLetterChangedEvent(),this.emitCreatorLetterChangedEvent()},displayName:u`${this.dateSortField}`,isSelected:()=>this.dateOptionSelected})}
        </li>
        <li>
          ${this.getSortDisplayOption(F.creator,{clickEvent:()=>{this.alphaSelectorVisible="creator",this.selectedTitleFilter=null,this.dateSortSelectorVisible=!1,this.setSelectedSort(F.creator),this.emitTitleLetterChangedEvent()}})}
        </li>
      </ul>
    `}getSortDisplayOption(e,t){var i,a;const o=(i=t==null?void 0:t.isSelected)!==null&&i!==void 0?i:()=>this.selectedSort===e,s=(a=t==null?void 0:t.displayName)!==null&&a!==void 0?a:Rt[e];return u`
      <a
        href="#"
    ...
    `}get dateSortSelector(){return u`
      ...
      <div id="date-sort-selector">
        <ul>
          <li>${this.getDateSortButton(F.datearchived)}</li>
          <li>${this.getDateSortButton(F.date)}</li>
          <li>${this.getDateSortButton(F.datereviewed)}</li>
          <li>${this.getDateSortButton(F.dateadded)}</li>
        </ul>
      </div>
  ...
  `;n([p({type:String})],q.prototype,"displayMode",void 0);n([p({type:String})],q.prototype,"sortDirection",void 0);n([p({type:String})],q.prototype,"selectedSort",void 0);n([p({type:String})],q.prototype,"selectedTitleFilter",void 0);n([p({type:String})],q.prototype,"selectedCreatorFilter",void 0);n([p({type:Boolean})],q.prototype,"showRelevance",void 0);n([p({type:Object})],q.prototype,"resizeObserver",void 0);n([k()],q.prototype,"alphaSelectorVisible",void 0);n([k()],q.prototype,"dateSortSelectorVisible",void 0);n([k()],q.prototype,"desktopSelectorBarWidth",void 0);n([k()],q.prototype,"selectorBarContainerWidth",void 0);n([k()],q.prototype,"hoveringOverDateSortOptions",void 0);n([re("#desktop-sort-selector")],q.prototype,"desktopSortSelector",void 0);n([re("#sort-selector-container")],q.prototype,"sortSelectorContainer",void 0);q=n([R("sort-filter-bar")],q);/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const $r=$a(class extends Sa{constructor(r){if(super(r),r.type!==De.PROPERTY&&r.type!==De.ATTRIBUTE&&r.type!==De.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!os(r))throw Error("`live` bindings can only contain a single expression")}render(r){return r}update(r,[e]){if(e===he||e===C)return e;const t=r.element,i=r.name;if(r.type===De.PROPERTY){if(e===t[i])return he}else if(r.type===De.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(i))return he}else if(r.type===De.ATTRIBUTE&&t.getAttribute(i)===e+"")return he;return Kr(r),e}});var to=60,io=to*60,ao=io*24,fn=ao*7,bt=1e3,Xi=to*bt,Sr=io*bt,vn=ao*bt,gn=fn*bt,Ca="millisecond",dt="second",ht="minute",pt="hour",Ae="day",ci="week",fe="month",ro="quarter",Le="year",ut="date",yn="YYYY-MM-DDTHH:mm:ssZ",Cr="Invalid Date",bn=/^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/,wn=/\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g,xn={name:"en",weekdays:"Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),months:"January_February_March_April_May_June_July_August_September_October_November_December".split("_")},fa=function(e,t,i){var a=String(e);return!a||a.length>=t?e:""+Array(t+1-a.length).join(i)+e},$n=function(e){var t=-e.utcOffset(),i=Math.abs(t),a=Math.floor(i/60),o=i%60;return(t<=0?"+":"-")+fa(a,2,"0")+":"+fa(o,2,"0")},Sn=function r(e,t){if(e.date()<t.date())return-r(t,e);var i=(t.year()-e.year())*12+(t.month()-e.month()),a=e.clone().add(i,fe),o=t-a<0,s=e.clone().add(i+(o?-1:1),fe);return+(-(i+(t-a)/(o?a-s:s-a))||0)},Cn=function(e){return e<0?Math.ceil(e)||0:Math.floor(e)},_n=function(e){var t={M:fe,y:Le,w:ci,d:Ae,D:ut,h:pt,m:ht,s:dt,ms:Ca,Q:ro};return t[e]||String(e||"").toLowerCase().replace(/s$/,"")},zn=function(e){return e===void 0},kn={s:fa,z:$n,m:Sn,a:Cn,p:_n,u:zn},Ut="en",Ke={};Ke[Ut]=xn;var _a=function(e){return e instanceof Ci},yi=function r(e,t,i){var a;if(!e)return Ut;if(typeof e=="string"){var o=e.toLowerCase();Ke[o]&&(a=o),t&&(Ke[o]=t,a=o);var s=e.split("-");if(!a&&s.length>1)return r(s[0])}else{var l=e.name;Ke[l]=e,a=l}return!i&&a&&(Ut=a),a||!i&&Ut},K=function(e,t){if(_a(e))return e.clone();var i=typeof t=="object"?t:{};return i.date=e,i.args=arguments,new Ci(i)},Tn=function(e,t){return K(e,{locale:t.$L,utc:t.$u,x:t.$x,$offset:t.$offset})},B=kn;B.l=yi;B.i=_a;B.w=Tn;var Mn=function(e){var t=e.date,i=e.utc;if(t===null)return new Date(NaN);if(B.u(t))return new Date;if(t instanceof Date)return new Date(t);if(typeof t=="string"&&!/Z$/i.test(t)){var a=t.match(bn);if(a){var o=a[2]-1||0,s=(a[7]||"0").substring(0,3);return i?new Date(Date.UTC(a[1],o,a[3]||1,a[4]||0,a[5]||0,a[6]||0,s)):new Date(a[1],o,a[3]||1,a[4]||0,a[5]||0,a[6]||0,s)}}return new Date(t)},Ci=function(){function r(t){this.$L=yi(t.locale,null,!0),this.parse(t)}var e=r.prototype;return e.parse=function(i){this.$d=Mn(i),this.$x=i.x||{},this.init()},e.init=function(){var i=this.$d;this.$y=i.getFullYear(),this.$M=i.getMonth(),this.$D=i.getDate(),this.$W=i.getDay(),this.$H=i.getHours(),this.$m=i.getMinutes(),this.$s=i.getSeconds(),this.$ms=i.getMilliseconds()},e.$utils=function(){return B},e.isValid=function(){return this.$d.toString()!==Cr},e.isSame=function(i,a){var o=K(i);return this.startOf(a)<=o&&o<=this.endOf(a)},e.isAfter=function(i,a){return K(i)<this.startOf(a)},e.isBefore=function(i,a){return this.endOf(a)<K(i)},e.$g=function(i,a,o){return B.u(i)?this[a]:this.set(o,i)},e.unix=function(){return Math.floor(this.valueOf()/1e3)},e.valueOf=function(){return this.$d.getTime()},e.startOf=function(i,a){var o=this,s=B.u(a)?!0:a,l=B.p(i),c=function(T,L){var I=B.w(o.$u?Date.UTC(o.$y,L,T):new Date(o.$y,L,T),o);return s?I:I.endOf(Ae)},h=function(T,L){var I=[0,0,0,0],P=[23,59,59,999];return B.w(o.toDate()[T].apply(o.toDate("s"),(s?I:P).slice(L)),o)},m=this.$W,f=this.$M,g=this.$D,b="set"+(this.$u?"UTC":"");switch(l){case Le:return s?c(1,0):c(31,11);case fe:return s?c(1,f):c(0,f+1);case ci:{var x=this.$locale().weekStart||0,z=(m<x?m+7:m)-x;return c(s?g-z:g+(6-z),f)}case Ae:case ut:return h(b+"Hours",0);case pt:return h(b+"Minutes",1);case ht:return h(b+"Seconds",2);case dt:return h(b+"Milliseconds",3);default:return this.clone()}},e.endOf=function(i){return this.startOf(i,!1)},e.$set=function(i,a){var o,s=B.p(i),l="set"+(this.$u?"UTC":""),c=(o={},o[Ae]=l+"Date",o[ut]=l+"Date",o[fe]=l+"Month",o[Le]=l+"FullYear",o[pt]=l+"Hours",o[ht]=l+"Minutes",o[dt]=l+"Seconds",o[Ca]=l+"Milliseconds",o)[s],h=s===Ae?this.$D+(a-this.$W):a;if(s===fe||s===Le){var m=this.clone().set(ut,1);m.$d[c](h),m.init(),this.$d=m.set(ut,Math.min(this.$D,m.daysInMonth())).$d}else c&&this.$d[c](h);return this.init(),this},e.set=function(i,a){return this.clone().$set(i,a)},e.get=function(i){return this[B.p(i)]()},e.add=function(i,a){var o=this,s;i=Number(i);var l=B.p(a),c=function(g){var b=K(o);return B.w(b.date(b.date()+Math.round(g*i)),o)};if(l===fe)return this.set(fe,this.$M+i);if(l===Le)return this.set(Le,this.$y+i);if(l===Ae)return c(1);if(l===ci)return c(7);var h=(s={},s[ht]=Xi,s[pt]=Sr,s[dt]=bt,s)[l]||1,m=this.$d.getTime()+i*h;return B.w(m,this)},e.subtract=function(i,a){return this.add(i*-1,a)},e.format=function(i){var a=this,o=this.$locale();if(!this.isValid())return o.invalidDate||Cr;var s=i||yn,l=B.z(this),c=this.$H,h=this.$m,m=this.$M,f=o.weekdays,g=o.months,b=o.meridiem,x=function(I,P,W,X){return I&&(I[P]||I(a,s))||W[P].slice(0,X)},z=function(I){return B.s(c%12||12,I,"0")},M=b||function(L,I,P){var W=L<12?"AM":"PM";return P?W.toLowerCase():W},T={YY:String(this.$y).slice(-2),YYYY:this.$y,M:m+1,MM:B.s(m+1,2,"0"),MMM:x(o.monthsShort,m,g,3),MMMM:x(g,m),D:this.$D,DD:B.s(this.$D,2,"0"),d:String(this.$W),dd:x(o.weekdaysMin,this.$W,f,2),ddd:x(o.weekdaysShort,this.$W,f,3),dddd:f[this.$W],H:String(c),HH:B.s(c,2,"0"),h:z(1),hh:z(2),a:M(c,h,!0),A:M(c,h,!1),m:String(h),mm:B.s(h,2,"0"),s:String(this.$s),ss:B.s(this.$s,2,"0"),SSS:B.s(this.$ms,3,"0"),Z:l};return s.replace(wn,function(L,I){return I||T[L]||l.replace(":","")})},e.utcOffset=function(){return-Math.round(this.$d.getTimezoneOffset()/15)*15},e.diff=function(i,a,o){var s,l=B.p(a),c=K(i),h=(c.utcOffset()-this.utcOffset())*Xi,m=this-c,f=B.m(this,c);return f=(s={},s[Le]=f/12,s[fe]=f,s[ro]=f/3,s[ci]=(m-h)/gn,s[Ae]=(m-h)/vn,s[pt]=m/Sr,s[ht]=m/Xi,s[dt]=m/bt,s)[l]||m,o?f:B.a(f)},e.daysInMonth=function(){return this.endOf(fe).$D},e.$locale=function(){return Ke[this.$L]},e.locale=function(i,a){if(!i)return this.$L;var o=this.clone(),s=yi(i,a,!0);return s&&(o.$L=s),o},e.clone=function(){return B.w(this.$d,this)},e.toDate=function(){return new Date(this.valueOf())},e.toJSON=function(){return this.isValid()?this.toISOString():null},e.toISOString=function(){return this.$d.toISOString()},e.toString=function(){return this.$d.toUTCString()},r}(),oo=Ci.prototype;K.prototype=oo;[["$ms",Ca],["$s",dt],["$m",ht],["$H",pt],["$W",Ae],["$M",fe],["$y",Le],["$D",ut]].forEach(function(r){oo[r[1]]=function(e){return this.$g(e,r[0],r[1])}});K.extend=function(r,e){return r.$i||(r(e,Ci,K),r.$i=!0),K};K.locale=yi;K.isDayjs=_a;K.unix=function(r){return K(r*1e3)};K.en=Ke[Ut];K.Ls=Ke;K.p={};var Dn=function(e){return e.replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g,function(t,i,a){return i||a.slice(1)})},An={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"},Ln=function(e,t){return e.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g,function(i,a,o){var s=o&&o.toUpperCase();return a||t[o]||An[o]||Dn(t[s])})},En=/(\[[^[]*\])|([-:/.()\s]+)|(A|a|YYYY|YY?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g,On=/\d/,oi=/\d\d/,In=/\d{3}/,Fn=/\d{4}/,be=/\d\d?/,Pn=/[+-]?\d+/,Rn=/[+-]\d\d:?(\d\d)?|Z/,Nt=/\d*[^\s\d-_:/()]+/,Oe={},so=function(e){return e=+e,e+(e>68?1900:2e3)};function Nn(r){if(!r||r==="Z")return 0;var e=r.match(/([+-]|\d\d)/g),t=+(e[1]*60)+(+e[2]||0);return t===0?0:e[0]==="+"?-t:t}var ne=function(e){return function(t){this[e]=+t}},_r=[Rn,function(r){var e=this.zone||(this.zone={});e.offset=Nn(r)}],Ji=function(e){var t=Oe[e];return t&&(t.indexOf?t:t.s.concat(t.f))},zr=function(e,t){var i,a=Oe,o=a.meridiem;if(!o)i=e===(t?"pm":"PM");else for(var s=1;s<=24;s+=1)if(e.indexOf(o(s,0,t))>-1){i=s>12;break}return i},Bn={A:[Nt,function(r){this.afternoon=zr(r,!1)}],a:[Nt,function(r){this.afternoon=zr(r,!0)}],S:[On,function(r){this.milliseconds=+r*100}],SS:[oi,function(r){this.milliseconds=+r*10}],SSS:[In,function(r){this.milliseconds=+r}],s:[be,ne("seconds")],ss:[be,ne("seconds")],m:[be,ne("minutes")],mm:[be,ne("minutes")],H:[be,ne("hours")],h:[be,ne("hours")],HH:[be,ne("hours")],hh:[be,ne("hours")],D:[be,ne("day")],DD:[oi,ne("day")],Do:[Nt,function(r){var e=Oe,t=e.ordinal,i=r.match(/\d+/);if(this.day=i[0],!!t)for(var a=1;a<=31;a+=1)t(a).replace(/\[|\]/g,"")===r&&(this.day=a)}],M:[be,ne("month")],MM:[oi,ne("month")],MMM:[Nt,function(r){var e=Ji("months"),t=Ji("monthsShort"),i=(t||e.map(function(a){return a.slice(0,3)})).indexOf(r)+1;if(i<1)throw new Error;this.month=i%12||i}],MMMM:[Nt,function(r){var e=Ji("months"),t=e.indexOf(r)+1;if(t<1)throw new Error;this.month=t%12||t}],Y:[Pn,ne("year")],YY:[oi,function(r){this.year=so(r)}],YYYY:[Fn,ne("year")],Z:_r,ZZ:_r};function Hn(r){var e=r.afternoon;if(e!==void 0){var t=r.hours;e?t<12&&(r.hours+=12):t===12&&(r.hours=0),delete r.afternoon}}function Un(r){r=Ln(r,Oe&&Oe.formats);for(var e=r.match(En),t=e.length,i=0;i<t;i+=1){var a=e[i],o=Bn[a],s=o&&o[0],l=o&&o[1];l?e[i]={regex:s,parser:l}:e[i]=a.replace(/^\[|\]$/g,"")}return function(c){for(var h={},m=0,f=0;m<t;m+=1){var g=e[m];if(typeof g=="string")f+=g.length;else{var b=g.regex,x=g.parser,z=c.slice(f),M=b.exec(z),T=M[0];x.call(h,T),c=c.replace(T,"")}}return Hn(h),h}}var Vn=function(e,t,i){try{if(["x","X"].indexOf(t)>-1)return new Date((t==="X"?1e3:1)*e);var a=Un(t),o=a(e),s=o.year,l=o.month,c=o.day,h=o.hours,m=o.minutes,f=o.seconds,g=o.milliseconds,b=o.zone,x=new Date,z=c||(!s&&!l?x.getDate():1),M=s||x.getFullYear(),T=0;s&&!l||(T=l>0?l-1:x.getMonth());var L=h||0,I=m||0,P=f||0,W=g||0;return b?new Date(Date.UTC(M,T,z,L,I,P,W+b.offset*60*1e3)):i?new Date(Date.UTC(M,T,z,L,I,P,W)):new Date(M,T,z,L,I,P,W)}catch{return new Date("")}},Wn=function(r,e,t){t.p.customParseFormat=!0,r&&r.parseTwoDigitYear&&(so=r.parseTwoDigitYear);var i=e.prototype,a=i.parse;i.parse=function(o){var s=o.date,l=o.utc,c=o.args;this.$u=l;var h=c[1];if(typeof h=="string"){var m=c[2]===!0,f=c[3]===!0,g=m||f,b=c[2];f&&(b=c[2]),Oe=this.$locale(),!m&&b&&(Oe=t.Ls[b]),this.$d=Vn(s,h,l),this.init(),b&&b!==!0&&(this.$L=this.locale(b).$L),g&&s!=this.format(h)&&(this.$d=new Date("")),Oe={}}else if(h instanceof Array)for(var x=h.length,z=1;z<=x;z+=1){c[1]=h[z-1];var M=t.apply(this,c);if(M.isValid()){this.$d=M.$d,this.$L=M.$L,this.init();break}z===x&&(this.$d=new Date(""))}else a.call(this,o)}};const jn=Object.freeze({processing:"processing",complete:"complete"});class Qn extends O{static get properties(){return{mode:{type:String}}}constructor(){super(),this.mode=jn.processing}render(){return u`
      <div class="${this.mode}">
        <svg
          viewBox="0 0 120 120"
    ...
    `,this._tooltipVisible=!0}hideTooltip(){this._tooltipContent=void 0,this._tooltipVisible=!1}validMinSliderX(e){const t=Math.min(this.translateDateToPosition(this.maxSelectedDate),this.histogramRightEdgeX);return e=this.clamp(e,this.histogramLeftEdgeX,t),Number.isNaN(e)||t<this.histogramLeftEdgeX?this.histogramLeftEdgeX:e}validMaxSliderX(e){const t=Math.max(this.histogramLeftEdgeX,this.translateDateToPosition(this.minSelectedDate));return e=this.clamp(e,t,this.histogramRightEdgeX),Number.isNaN(e)||t>this.histogramRightEdgeX?this.histogramRightEdgeX:e}addListeners(){window.addEventListener("pointermove",this.move),window.addEventListener("pointerup",this.drop),window.addEventListener("pointercancel",this.drop)}removeListeners(){window.removeEventListener("pointermove",this.move),window.removeEventListener("pointerup",this.drop),window.removeEventListener("pointercancel",this.drop)}beginEmitUpdateProcess(){this.cancelPendingUpdateEvent(),this._emitUpdatedEventTimer=setTimeout(()=>{if(this.currentDateRangeString===this._previousDateRange)return;this._previousDateRange=this.currentDateRangeString;const e={detail:{minDate:this.minSelectedDate,maxDate:this.maxSelectedDate},bubbles:!0,composed:!0};this.dispatchEvent(new CustomEvent("histogramDateRangeUpdated",e))},this.updateDelay)}cancelPendingUpdateEvent(){this._emitUpdatedEventTimer!==void 0&&(clearTimeout(this._emitUpdatedEventTimer),this._emitUpdatedEventTimer=void 0)}setDragOffset(e){this._currentSlider=e.currentTarget;const t=this._currentSlider.id==="slider-min"?this.minSliderX:this.maxSliderX;this._dragOffset=e.offsetX-t,(this._dragOffset>this.sliderWidth||this._dragOffset<-this.sliderWidth)&&(this._dragOffset=0)}translatePositionToDate(e){const t=Math.ceil((e-this.sliderWidth)*this.dateRangeMS/this._histWidth);return this.formatDate(this._minDateMS+t)}translateDateToPosition(e){const t=this.getMSFromString(e);return this.sliderWidth+(t-this._minDateMS)*this._histWidth/this.dateRangeMS}clamp(e,t,i){return Math.min(Math.max(e,t),i)}handleMinDateInput(e){const t=e.currentTarget;this.minSelectedDate=t.value,this.beginEmitUpdateProcess()}handleMaxDateInput(e){const t=e.currentTarget;this.maxSelectedDate=t.value,this.beginEmitUpdateProcess()}handleKeyUp(e){if(e.key==="Enter"){const t=e.currentTarget;t.blur(),t.id==="date-min"?this.handleMinDateInput(e):t.id==="date-max"&&this.handleMaxDateInput(e)}}get currentDateRangeString(){return`${this.minSelectedDate}:${this.maxSelectedDate}`}getMSFromString(e){const t=typeof e=="string"?e:String(e);if((t.split(/(\d+)/).length-1)/2===1){const a=new Date(0,0);return a.setFullYear(Number(t)),a.getTime()}return K(t,[this.dateFormat,kr]).valueOf()}handleBarClick(e){const t=e.currentTarget.dataset,i=(this.getMSFromString(t.binStart)+this.getMSFromString(t.binEnd))/2,a=Math.abs(i-this.getMSFromString(this.minSelectedDate)),o=Math.abs(i-this.getMSFromString(this.maxSelectedDate));a<o?this.minSelectedDate=t.binStart:this.maxSelectedDate=t.binEnd,this.beginEmitUpdateProcess()}get minSliderTemplate(){const e=Tr,t=`
            ...
            q0,${e} ${e},${e}
            h${this.sliderWidth-e}
          `;return this.generateSliderSVG(this.minSliderX,"slider-min",t)}get maxSliderTemplate(){const e=Tr,t=`
            M${this.maxSliderX},0
            h${this.sliderWidth-e}
            q${e},0 ${e},${e}
            v${this.height-e*2}
            q0,${e} -${e},${e}
            h-${this.sliderWidth-e}
          `;return this.generateSliderSVG(this.maxSliderX,"slider-max",t)}generateSliderSVG(e,t,i){const a=t==="slider-min"?1:-1;return E`
    <svg
      id="${t}"
      class="
    ...
    `}get selectedRangeTemplate(){return E`
      <rect
        x="${this.minSliderX}"
        y="0"
        ...
        height="${this.height}"
        fill="${tl}"
      />`}get histogramTemplate(){const e=this._histWidth/this._numBins,t=e-1;let i=this.sliderWidth;return this._histData.map(a=>{const o=E`
        <rect
          class="bar"
          ...
          fill="${i+t>=this.minSliderX&&i<=this.maxSliderX?il:rl}"
          data-num-items="${a.value}"
          data-bin-start="${a.binStart}"
          data-bin-end="${a.binEnd}"
        />`;return i+=e,o})}formatDate(e){if(Number.isNaN(e))return"";const t=K(e);return t.year()<1e3?String(t.year()):t.format(this.dateFormat)}get minInputTemplate(){return u`
      <input
        id="date-min"
    ...
    `:C}render(){return this.hasBinData?u`
      <div
        id="container"
        class="
          noselect
    ...
    ia-activity-indicator {
      ...
      --activityIndicatorLoadingRingColor: ${al};
    }
    ...
    #tooltip:after {
      ...
      /* arrow */
      border: 5px solid ${Dr};
      border-color: ${Mr} transparent transparent
        transparent;
    }
    /****** slider ********/
    .draggable:hover {
...
`;let G=class extends O{constructor(){super(...arguments),this.prompt="Do you find this feature useful?",this.buttonText="Beta",this.isOpen=!1,this.processing=!1,this.popupTopX=0,this.popupTopY=0,this.voteSubmitted=!1,this.voteNeedsChoosing=!1,this.resizingElement=document.body}render(){return u`
      <button
        id="beta-button"
      ...
      >
        ...
        >
          <form @submit=${this.submit} id="form" ?disabled=${this.processing}>
            ...
            ${this.error?u`<div id="error">${this.error}</div>`:C}
            <div id="actions">
              <button
                @click=${this.cancel}
                id="cancel-button"
    ...
    `}get upvoteSelected(){return this.vote==="up"}get downvoteSelected(){return this.vote==="down"}upvoteKeypressed(e){(e.key==="Enter"||e.key===" ")&&this.upvoteButtonSelected()}downvoteKeypressed(e){(e.key==="Enter"||e.key===" ")&&this.downvoteButtonSelected()}upvoteButtonSelected(){this.vote=this.vote==="up"?void 0:"up"}downvoteButtonSelected(){this.vote=this.vote==="down"?void 0:"down"}get chooseVoteErrorClass(){return this.voteNeedsChoosing?"error":""}get upvoteButtonClass(){switch(this.vote){case"up":return"selected";case"down":return"unselected";default:return"noselection"}}get downvoteButtonClass(){switch(this.vote){case"up":return"unselected";case"down":return"selected";default:return"noselection"}}backgroundClicked(e){var t;e.target instanceof Node&&(!((t=this.popup)===null||t===void 0)&&t.contains(e.target)||this.closePopup())}cancel(e){e.preventDefault(),this.vote=void 0,this.closePopup()}async submit(e){if(e.preventDefault(),!this.vote){this.voteNeedsChoosing=!0,this.error=u`Please select a vote.`;return}if(!this.featureIdentifier)throw new Error("featureIdentifier is required");if(!this.featureFeedbackService)throw new Error("featureFeedbackService is required");if(!this.recaptchaWidget)throw new Error("recaptchaWidget is required");this.processing=!0;try{const t=await this.recaptchaWidget.execute();(await this.featureFeedbackService.submitFeedback({featureIdentifier:this.featureIdentifier,vote:this.vote,comments:this.comments.value,recaptchaToken:t})).success?(this.voteSubmitted=!0,this.closePopup()):this.error=u`There was an error submitting your feedback.`}catch(t){this.error=u`There was an error submitting your feedback.<br />Error:
        ${t instanceof Error?t.message:t}`}this.processing=!1}static get styles(){const e=v`var(--featureFeedbackBlueColor, #194880)`,t=v`var(--featureFeedbackDarkGrayColor, #767676)`,i=v`var(--defaultColorSvgFilter, invert(52%) sepia(0%) saturate(1%) hue-rotate(331deg) brightness(87%) contrast(89%))`,a=v`var(--featureFeedbackBackdropZindex, 5)`,o=v`var(--featureFeedbackModalZindex, 6)`,s=v`var(--featureFeedbackPopupBorderColor, ${e})`,l=v`var(--featureFeedbackSubmitButtonColor, ${e})`,c=v`var(--featureFeedbackBetaButtonBorderColor, ${e})`,h=v`var(--featureFeedbackBetaButtonTextColor, ${e})`,m=v`var(--featureFeedbackBetaButtonSvgFilter, ${i})`,f=v`var(--featureFeedbackCancelButtonColor, #515151)`,g=v`var(--featureFeedbackPopupBlockerColor, rgba(255, 255, 255, 0.3))`,b=v`var(--featureFeedbackPopupBackgroundColor, #F5F5F7)`,x=v`var(--featureFeedbackPromptFontWeight, bold)`,z=v`var(--featureFeedbackPromptFontSize, 14px)`,M=v`var(--defaultColor, ${t});`,T=v`var(--defaultColorSvgFilter, ${i});`,L=v`var(--upvoteColor, #23765D);`,I=v`var(--upvoteColorSvgFilter, invert(34%) sepia(72%) saturate(357%) hue-rotate(111deg) brightness(97%) contrast(95%));`,P=v`var(--downvoteColor, #720D11);`,W=v`var(--downvoteColorSvgFilter, invert(5%) sepia(81%) saturate(5874%) hue-rotate(352deg) brightness(105%) contrast(95%));`,X=v`var(--unselectedColor, #CCCCCC);`,ye=v`var(--unselectedColorSvgFilter, invert(100%) sepia(0%) saturate(107%) hue-rotate(138deg) brightness(89%) contrast(77%));`;return v`
      #beta-button {
        font-size: 12px;
        font-weight: bold;
        font-style: italic;
    ...
    `}};n([p({type:String})],G.prototype,"featureIdentifier",void 0);n([p({type:String})],G.prototype,"prompt",void 0);n([p({type:String})],G.prototype,"buttonText",void 0);n([p({type:Object})],G.prototype,"recaptchaManager",void 0);n([p({type:Object})],G.prototype,"resizeObserver",void 0);n([p({type:Boolean})],G.prototype,"disabled",void 0);n([p({type:Object})],G.prototype,"featureFeedbackService",void 0);n([re("#beta-button")],G.prototype,"betaButton",void 0);n([re("#popup")],G.prototype,"popup",void 0);n([k()],G.prototype,"isOpen",void 0);n([k()],G.prototype,"processing",void 0);n([k()],G.prototype,"popupTopX",void 0);n([k()],G.prototype,"popupTopY",void 0);n([k()],G.prototype,"vote",void 0);n([k()],G.prototype,"voteSubmitted",void 0);n([k()],G.prototype,"error",void 0);n([k()],G.prototype,"voteNeedsChoosing",void 0);n([k()],G.prototype,"recaptchaWidget",void 0);n([re("#comments")],G.prototype,"comments",void 0);G=n([R("feature-feedback")],G);class no{constructor(e){var t,i,a,o,s,l,c;this.title=e==null?void 0:e.title,this.subtitle=e==null?void 0:e.subtitle,this.headline=e==null?void 0:e.headline,this.message=e==null?void 0:e.message,this.headerColor=(t=e==null?void 0:e.headerColor)!==null&&t!==void 0?t:"#55A183",this.bodyColor=(i=e==null?void 0:e.bodyColor)!==null&&i!==void 0?i:"#f5f5f7",this.showProcessingIndicator=(a=e==null?void 0:e.showProcessingIndicator)!==null&&a!==void 0?a:!1,this.processingImageMode=(o=e==null?void 0:e.processingImageMode)!==null&&o!==void 0?o:"complete",this.showCloseButton=(s=e==null?void 0:e.showCloseButton)!==null&&s!==void 0?s:!0,this.showHeaderLogo=(l=e==null?void 0:e.showHeaderLogo)!==null&&l!==void 0?l:!0,this.closeOnBackdropClick=(c=e==null?void 0:e.closeOnBackdropClick)!==null&&c!==void 0?c:!0}}var hl=u`
<svg
  viewBox="0 0 40 40"
  version="1.1"
  xmlns="http://www.w3.org/2000/svg"
...
`;let va=class extends O{constructor(){super(...arguments),this.config=new no}render(){return u`
      <div class="modal-wrapper">
        <div class="modal-container">
          <header style="background-color: ${this.config.headerColor}">
            ${this.config.showCloseButton?this.closeButtonTemplate:""}
            ${this.config.showHeaderLogo?u`<div class="logo-icon">${pl}</div>`:C}
    ...
    `}static get styles(){const e=v`var(--modalLogoSize, 6.5rem)`,t=v`var(--processingImageSize, 7.5rem)`,i=v`var(--modalCornerRadius, 1rem)`,a=v`var(--modalBorder, 2px solid black)`,o=v`var(--modalBottomMargin, 2.5rem)`,s=v`var(--modalTopMargin, 5rem)`,l=v`var(--modalHeaderBottomPadding, 0.5em)`,c=v`var(--modalBottomPadding, 2rem)`,h=v`var(--modalScrollOffset, 5px)`,m=v`var(--modalTitleFontSize, 1.8rem)`,f=v`var(--modalSubtitleFontSize, 1.4rem)`,g=v`var(--modalHeadlineFontSize, 1.6rem)`,b=v`var(--modalMessageFontSize, 1.4rem)`,x=v`var(--modalTitleLineHeight, normal)`,z=v`var(--modalSubtitleLineHeight, normal)`,M=v`var(--modalHeadlineLineHeight, normal)`,T=v`var(--modalMessageLineHeight, normal)`;return v`
      .processing-logo {
        margin: auto;
        width: ${t};
        height: ${t};
    ...
    `}};n([p({type:Object})],va.prototype,"config",void 0);va=n([R("modal-template")],va);function ul(r,e,t){var i=t||{},a=i.noTrailing,o=a===void 0?!1:a,s=i.noLeading,l=s===void 0?!1:s,c=i.debounceMode,h=c===void 0?void 0:c,m,f=!1,g=0;function b(){m&&clearTimeout(m)}function x(M){var T=M||{},L=T.upcomingOnly,I=L===void 0?!1:L;b(),f=!I}function z(){for(var M=arguments.length,T=new Array(M),L=0;L<M;L++)T[L]=arguments[L];var I=this,P=Date.now()-g;if(f)return;function W(){g=Date.now(),e.apply(I,T)}function X(){m=void 0}!l&&h&&!m&&W(),b(),h===void 0&&P>r?l?(g=Date.now(),o||(m=setTimeout(h?X:W,r))):W():o!==!0&&(m=setTimeout(h?X:W,h===void 0?r-P:r))}return z.cancel=x,z}var Ye;(function(r){r.Open="open",r.Closed="closed"})(Ye||(Ye={}));class ml{constructor(e){this.windowResizeThrottler=ul(100,this.updateModalContainerHeight,{noLeading:!1,noTrailing:!1}).bind(this),this.modalManager=e}handleModeChange(e){switch(e){case Ye.Open:this.startResizeListener(),this.stopDocumentScroll();break;case Ye.Closed:this.stopResizeListener(),this.resumeDocumentScroll();break}}updateModalContainerHeight(){this.modalManager.style.setProperty("--containerHeight",`${window.innerHeight}px`)}stopDocumentScroll(){document.body.classList.add("modal-manager-open")}resumeDocumentScroll(){document.body.classList.remove("modal-manager-open")}startResizeListener(){window.addEventListener("resize",this.windowResizeThrottler)}stopResizeListener(){window.removeEventListener("resize",this.windowResizeThrottler)}}let wt=class extends O{constructor(){super(...arguments),this.mode=Ye.Closed,this.hostBridge=new ml(this),this.closeOnBackdropClick=!0}render(){return u`
      <div class="container">
    ...
    `}};n([p({type:String,reflect:!0})],wt.prototype,"mode",void 0);n([p({type:Object})],wt.prototype,"customModalContent",void 0);n([p({type:Object})],wt.prototype,"hostBridge",void 0);n([re("modal-template")],wt.prototype,"modalTemplate",void 0);wt=n([R("modal-manager")],wt);var fl=E`
...
`,lo=E`<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><path d="m79.8883285 50.0035012.1116715-.1085359-43.1159942-46.61088155c-2.401537-2.18938917-4.6902018-3.28408375-6.8659943-3.28408375s-4.1642651.63837733-5.9654178 1.91513199c-1.8011528 1.27675467-3.1520173 2.97248092-4.0525937 5.08717877l39.4020173 42.99768924-39.4020173 42.9976892c.9005764 2.1146979 2.2514409 3.8104241 4.0525937 5.0871788 1.8011527 1.2767547 3.7896253 1.915132 5.9654178 1.915132 2.1013449 0 4.3900096-1.0573489 6.8659943-3.1720468l43.1159942-46.7194174z"/></svg>
`,gl=E`
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path 
...
`;let xt=class extends O{constructor(){super(...arguments),this.step=2,this.pages=[],this.currentPage=1}firstUpdated(){this.observePageCount()}observePageCount(){this.pages=[];let e=this.currentPage-this.step,t=this.currentPage+this.step;e<=0&&(t+=-e+1,e=1),t>=this.size&&(e=Math.max(e-(t-this.size),1),t=this.size),this.createFirstNode(e),this.createMiddelNode(e,t),this.createLastNode(t)}createFirstNode(e){var t,i;e>1&&((t=this.pages)===null||t===void 0||t.push(1),(i=this.pages)===null||i===void 0||i.push(0))}createMiddelNode(e,t){var i;for(let a=e;a<=t;a+=1)(i=this.pages)===null||i===void 0||i.push(a)}createLastNode(e){var t,i;e<this.size&&((t=this.pages)===null||t===void 0||t.push(0),(i=this.pages)===null||i===void 0||i.push(this.size))}get getEllipsisTemplate(){return u`<i>...</i>`}emitPageClick(){this.dispatchEvent(new CustomEvent("pageNumberClicked",{detail:{page:this.currentPage}}))}onRewind(){this.currentPage-=1,this.currentPage<1&&(this.currentPage=1),this.observePageCount(),this.emitPageClick()}onForward(){this.currentPage+=1,this.currentPage>this.size&&(this.currentPage=this.size),this.observePageCount(),this.emitPageClick()}onChange(e){this.currentPage=e,this.observePageCount(),this.emitPageClick()}getPageTemplate(e){return u`
      <button
        @click="${()=>this.onChange(e)}"
        class="${this.currentPage===e?"current":C}"
      >
        ${e}
      </button>
          ...
          <li class="facet-row">
            <label class="facet-info-display" title=${i.key}>
              ...
              <div class="facet-title">
                ${this.facetKey!=="collection"?u`${s}`:u`<async-collection-name
                      .collectionNameCache=${this.collectionNameCache}
                      .identifier=${s}
                      placeholder="-"
                    ></async-collection-name>`}
              </div>
              <div class="facet-count">${i.doc_count}</div>
            </label>
          </li>
        `})}
    </ul>`}facetClicked(e){const{selectedFacets:t}=this,i=e.target,{checked:a,value:o}=i;let s;t?s=ue({},t):s=Yt,a?s[this.facetKey][o]="selected":delete s[this.facetKey][o],this.selectedFacets=s}get loaderTemplate(){return this.facetsLoading?u`<div class="facets-loader">
          <ia-activity-indicator .mode="processing"></ia-activity-indicator>
        </div>`:""}get facetsPaginationTemplate(){return this.paginationSize>1?u`<more-facets-pagination
          .size=${this.paginationSize}
          @pageNumberClicked=${this.pageNumberClicked}
        ></more-facets-pagination>`:C}get facetsContentTemplate(){return u`
      <div class="facets-content">${this.getMoreFacetsTemplate}</div>
      ${this.paginationSize>0?u`${this.facetsPaginationTemplate}
            <div class="footer">
              <button
            ...
            </div>`:u`No result found. please try again later.`}
    `}render(){return u`
      <div id="more-facets-page">
        <form>
          ${this.facetsLoading?this.loaderTemplate:this.facetsContentTemplate}
        </form>
      </div>
    `}applySearchFacetsClicked(){var e;const t=new CustomEvent("facetsChanged",{detail:this.selectedFacets,bubbles:!0,composed:!0});this.dispatchEvent(t),(e=this.modalManager)===null||e===void 0||e.closeModal()}cancelClick(){var e;(e=this.modalManager)===null||e===void 0||e.closeModal()}static get styles(){return v`
      #more-facets-page {
        margin-bottom: 2rem;
      }
      .modal-content {
    ...
    `}};n([p({type:String})],ae.prototype,"facetKey",void 0);n([p({type:String})],ae.prototype,"facetAggregationKey",void 0);n([p({type:String})],ae.prototype,"fullQuery",void 0);n([p({type:Object})],ae.prototype,"modalManager",void 0);n([p({type:Object})],ae.prototype,"searchService",void 0);n([p({type:Object})],ae.prototype,"collectionNameCache",void 0);n([p({type:Object})],ae.prototype,"languageCodeHandler",void 0);n([p({type:Object})],ae.prototype,"selectedFacets",void 0);n([k()],ae.prototype,"aggregations",void 0);n([k()],ae.prototype,"castedBuckets",void 0);n([k()],ae.prototype,"pageNumber",void 0);n([k()],ae.prototype,"facetsLoading",void 0);n([k()],ae.prototype,"paginationSize",void 0);ae=n([R("more-facets-content")],ae);const bl=["mediatype","year","subject","collection","creator","language"],ea={subjectSorter:"subject",mediatypeSorter:"mediatype",languageSorter:"language",creatorSorter:"creator",collection:"collection",year:"year"},ta={subject:"Subject",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"};let Z=class extends O{constructor(){super(...arguments),this.facetsLoading=!1,this.fullYearAggregationLoading=!1,this.collapsableFacets=!1,this.showHistogramDatePicker=!1,this.openFacets={subject:!1,mediatype:!1,language:!1,creator:!1,collection:!1,year:!1},this.moreLinkEligibilityCount=5}render(){return u`
    ...
    `}updated(e){e.has("selectedFacets")&&this.dispatchFacetsChangedEvent()}dispatchFacetsChangedEvent(){const e=new CustomEvent("facetsChanged",{detail:this.selectedFacets});this.dispatchEvent(e)}get currentYearsHistogramAggregation(){var e;return(e=this.aggregations)===null||e===void 0?void 0:e.year_histogram}get histogramTemplate(){const{fullYearsHistogramAggregation:e}=this;return u`
      ...
      ></histogram-date-range>
    `}histogramDateRangeUpdated(e){const{minDate:t,maxDate:i}=e.detail,a=new CustomEvent("histogramDateRangeUpdated",{detail:{minDate:t,maxDate:i}});this.dispatchEvent(a)}get mergedFacets(){const e=[];return bl.forEach(t=>{var i;const a=this.selectedFacetGroups.find(c=>c.key===t),o=this.aggregationFacetGroups.find(c=>c.key===t);if(a&&!o){e.push(a);return}if(!o)return;const s=a!=null?a:o,l=(i=a==null?void 0:a.buckets.map(c=>{const h=o.buckets.find(m=>m.key===c.key);return h?Ot(ue({},c),{count:h.count}):c}))!==null&&i!==void 0?i:[];o.buckets.forEach(c=>{l.find(m=>m.key===c.key)||l.push(c)}),s.buckets=l.splice(0,5),e.push(s)}),e}get selectedFacetGroups(){return this.selectedFacets?Object.entries(this.selectedFacets).map(([t,i])=>{const a=t,o=ta[a],s=Object.entries(i).map(([l,c])=>{var h,m;let f=l;return a==="language"&&(f=(m=(h=this.languageCodeHandler)===null||h===void 0?void 0:h.getLanguageNameFromCodeString(l))!==null&&m!==void 0?m:l),{displayText:f,key:l,count:0,state:c}});return{title:o,key:a,buckets:s}}):[]}get aggregationFacetGroups(){var e;const t=[];return Object.entries((e=this.aggregations)!==null&&e!==void 0?e:[]).forEach(([i,a])=>{if(i==="year_histogram")return;const o=this.getFacetOptionFromKey(i),s=ta[o],c=a.buckets.map(m=>{var f,g;let b=m.key;return o==="language"&&(b=(g=(f=this.languageCodeHandler)===null||f===void 0?void 0:f.getCodeStringFromLanguageName(`${m.key}`))!==null&&g!==void 0?g:m.key),{displayText:`${m.key}`,key:`${b}`,count:m.doc_count,state:"none"}}),h={title:s,key:o,buckets:c};t.push(h)}),t}getFacetGroupTemplate(e){if(e.buckets.length===0)return C;const{key:t}=e,i=this.openFacets[t],a=u`
    ...
    `;return u`
      <div class="facet-group ${this.collapsableFacets?"mobile":""}">
        ...
        >
          ${this.collapsableFacets?a:C} ${e.title}
        </h1>
    ...
    `}searchMoreFacetsLink(e){return Object.keys(e.buckets).length<this.moreLinkEligibilityCount?C:u`<button
      class="more-link"
      @click=${()=>{this.showMoreFacetsModal(e)}}
    >
      More...
    </button>`}async showMoreFacetsModal(e){var t,i;const a=Object.keys(ea).find(c=>ea[c]===e.key),o=u`
      <span
    ...
    `,s=u`
      <more-facets-content
        @facetsChanged=${c=>{const h=new CustomEvent("facetsChanged",{detail:c.detail,bubbles:!0,composed:!0});this.dispatchEvent(h)}}
        .facetKey=${e.key}
    ...
    `,l=new no({bodyColor:"#fff",headerColor:"#194880",showHeaderLogo:!1,closeOnBackdropClick:!0,title:u`Select filters`,headline:o,message:s});(t=this.modalManager)===null||t===void 0||t.classList.add("more-search-facets"),(i=this.modalManager)===null||i===void 0||i.showModal({config:l})}getFacetTemplate(e){const i=e.buckets.filter(a=>a.key.startsWith("fav-")===!1).slice(0,6);return u`
      <ul class="facet-list">
        ${Yr(i,a=>`${e.key}:${a.key}`,a=>{var o,s;const l=`${e.key}:${a.key}-show-only`,c=`${e.key}:${a.key}-negative`,h=e.key!=="collection"?u`${(o=a.displayText)!==null&&o!==void 0?o:a.key}`:u`
                    <async-collection-name
                      .collectionNameCache=${this.collectionNameCache}
                      .identifier=${a.key}
                      placeholder="-"
                    ></async-collection-name>
                  `,m=a.state==="hidden",f=a.state==="selected",g=`${e.key}: ${(s=a.displayText)!==null&&s!==void 0?s:a.key}`,b=f?`Show all ${e.key}s`:`Only show ${g}`,x=`Hide ${g}`,z=`Unhide ${g}`,M=m?z:x;return u`
              <li>
                <div class="facet-row">
                  <div class="facet-checkbox">
                    <input
                      ...
                      .name=${e.key}
                      .value=${a.key}
                      @click=${T=>{this.facetClicked(T,a,!1)}}
                      .checked=${f}
                    ...
                    <input
                      ...
                      .name=${e.key}
                      .value=${a.key}
                      @click=${T=>{this.facetClicked(T,a,!0)}}
                      .checked=${m}
    ...
    `}facetClicked(e,t,i){const a=e.target,{checked:o,name:s,value:l}=a;o?this.facetChecked(s,l,i):this.facetUnchecked(s,l)}facetChecked(e,t,i){const{selectedFacets:a}=this;let o;a?o=ue({},a):o=Yt,o[e][t]=i?"hidden":"selected",this.selectedFacets=o}facetUnchecked(e,t){const{selectedFacets:i}=this;let a;i?a=ue({},i):a=Yt,delete a[e][t],this.selectedFacets=a}getFacetOptionFromKey(e){const a=e.split("__")[2].split(":")[1],o=Object.entries(ea).find(([l])=>a.includes(l)),s=o==null?void 0:o[1];if(!s)throw new Error(`Could not find facet option for key: ${e}`);return s}static get styles(){return v`
      #container.loading {
        opacity: 0.5;
      }
...
`;let wi=class extends O{constructor(){super(...arguments),this.placeholderType=null}render(){return this.placeholderType?u`${this.placeholderTemplate}`:C}get placeholderTemplate(){return u`
      <div
        class="placeholder ${this.placeholderType} ${this.isMobileView?"mobile":"desktop"}"
      >
        ${_l(this.placeholderType,[["empty-query",()=>this.emptyQueryTemplate],["null-result",()=>this.nullResultTemplate]])}
      </div>
    ...
    `}get collectionBrowserTemplate(){return u`<div
      ...
      >
        <div id="mobile-header-container">
          ${this.mobileView?this.mobileFacetsTemplate:C}
      ...
      <div id="right-column" class="column">
        ${this.searchResultsLoading?this.loadingTemplate:C}
        ${this.sortFilterBarTemplate}
        ${this.displayMode==="list-compact"?this.listHeaderTemplate:C}
    ...
    `}get facetsTemplate(){return u`
      ${this.facetsLoading?this.loadingTemplate:C}
      <collection-facets
  ...
  `;n([k()],ce.prototype,"currentPage",void 0);n([k()],ce.prototype,"searchQuery",void 0);n([k()],ce.prototype,"cellWidth",void 0);n([k()],ce.prototype,"cellHeight",void 0);n([k()],ce.prototype,"rowGap",void 0);n([k()],ce.prototype,"colGap",void 0);n([k()],ce.prototype,"loggedIn",void 0);n([re("#base-query-field")],ce.prototype,"baseQueryField",void 0);n([re("#page-number-input")],ce.prototype,"pageNumberInput",void 0);n([re("collection-browser")],ce.prototype,"collectionBrowser",void 0);n([re("modal-manager")],ce.prototype,"modalManager",void 0);ce=n([R("app-root")],ce);
