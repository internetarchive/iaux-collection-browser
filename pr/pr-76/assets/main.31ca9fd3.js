var Ta=Object.defineProperty,Aa=Object.defineProperties;var Ma=Object.getOwnPropertyDescriptors;var ur=Object.getOwnPropertySymbols;var La=Object.prototype.hasOwnProperty,Ea=Object.prototype.propertyIsEnumerable;var pr=(a,e,t)=>e in a?Ta(a,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):a[e]=t,oe=(a,e)=>{for(var t in e||(e={}))La.call(e,t)&&pr(a,t,e[t]);if(ur)for(var t of ur(e))Ea.call(e,t)&&pr(a,t,e[t]);return a},gt=(a,e)=>Aa(a,Ma(e));const Oa=function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const o of r)if(o.type==="childList")for(const s of o.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function t(r){const o={};return r.integrity&&(o.integrity=r.integrity),r.referrerpolicy&&(o.referrerPolicy=r.referrerpolicy),r.crossorigin==="use-credentials"?o.credentials="include":r.crossorigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(r){if(r.ep)return;r.ep=!0;const o=t(r);fetch(r.href,o)}};Oa();function n(a,e,t,i){var r=arguments.length,o=r<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(a,e,t,i);else for(var l=a.length-1;l>=0;l--)(s=a[l])&&(o=(r<3?s(o):r>3?s(e,t,o):s(e,t))||o);return r>3&&o&&Object.defineProperty(e,t,o),o}function za(a,e,t,i){function r(o){return o instanceof t?o:new t(function(s){s(o)})}return new(t||(t=Promise))(function(o,s){function l(v){try{h(i.next(v))}catch(g){s(g)}}function c(v){try{h(i.throw(v))}catch(g){s(g)}}function h(v){v.done?o(v.value):r(v.value).then(l,c)}h((i=i.apply(a,e||[])).next())})}function y(a){let e,t,i;return typeof a=="object"?(e=a.hashFunction,t=a.expiring,i=a.tags):e=a,(r,o,s)=>{if(s.value!=null)s.value=vr(s.value,e,t,i);else if(s.get!=null)s.get=vr(s.get,e,t,i);else throw"Only put a Memoize() decorator on a method or get accessor."}}const li=new Map;function vr(a,e,t=0,i){const r=Symbol("__memoized_map__");return function(...o){let s;this.hasOwnProperty(r)||Object.defineProperty(this,r,{configurable:!1,enumerable:!1,writable:!1,value:new Map});let l=this[r];if(Array.isArray(i))for(const c of i)li.has(c)?li.get(c).push(l):li.set(c,[l]);if(e||o.length>0||t>0){let c;e===!0?c=o.map(g=>g.toString()).join("!"):e?c=e.apply(this,o):c=o[0];const h=`${c}__timestamp`;let v=!1;if(t>0)if(!l.has(h))v=!0;else{let g=l.get(h);v=Date.now()-g>t}l.has(c)&&!v?s=l.get(c):(s=a.apply(this,o),l.set(c,s),t>0&&l.set(h,Date.now()))}else{const c=this;l.has(c)?s=l.get(c):(s=a.apply(this,o),l.set(c,s))}return s}}class Ti{parseValue(e){return typeof e=="string"&&(e==="false"||e==="0")?!1:Boolean(e)}}Ti.shared=new Ti;class Se{parseValue(e){if(typeof e=="number")return e;if(typeof e=="boolean")return;const t=parseFloat(e);if(!Number.isNaN(t))return t}}Se.shared=new Se;class Ut{parseValue(e){return Se.shared.parseValue(e)}}Ut.shared=new Ut;class St{parseValue(e){return this.parseJSDate(e)||this.parseBracketDate(e)}parseBracketDate(e){if(typeof e!="string")return;const t=e.match(/\[([0-9]{4})\]/);if(!(!t||t.length<2))return this.parseJSDate(t[1])}parseJSDate(e){if(typeof e!="string")return;let t=e;t.match(/^[0-9]{4}-[0-9]{2}-[0-9]{2}\s{1}[0-9]{2}:[0-9]{2}:[0-9]{2}$/)&&(t=t.replace(" ","T"));const i=Date.parse(t);if(Number.isNaN(i))return;let r=new Date(t);return(t.indexOf("Z")>-1||t.indexOf("+")>-1||t.match(/^[0-9]{4}$/)||t.match(/^[0-9]{4}-[0-9]{2}-[0-9]{2}$/)||t.match(/^.*?-[0-9]{2}:[0-9]{2}$/)||t.match(/^.*?-[0-9]{4}$/))&&(r=new Date(r.getTime()+r.getTimezoneOffset()*1e3*60)),r}}St.shared=new St;class jt{parseValue(e){if(typeof e=="number")return e;if(typeof e=="boolean")return;const t=e.split(":");let i;return t.length===1?i=this.parseNumberFormat(t[0]):i=this.parseColonSeparatedFormat(t),i}parseNumberFormat(e){let t=parseFloat(e);return Number.isNaN(t)&&(t=void 0),t}parseColonSeparatedFormat(e){let t=!1;const i=e.map((r,o)=>{const s=parseFloat(r);if(Number.isNaN(s))return t=!0,0;const l=e.length-1-o,c=60**l;return s*Math.floor(c)}).reduce((r,o)=>r+o,0);return t?void 0:i}}jt.shared=new jt;class Ai{parseValue(e){if(typeof e=="string")return e}}Ai.shared=new Ai;class Pa{constructor(e,t){this.separators=[";",","],this.parser=e,t&&t.separators&&(this.separators=t.separators)}parseValue(e){const t=String(e);let i=[];for(const r of this.separators)if(i=t.split(r),i.length>1)break;return this.parseListValues(i)}parseListValues(e){const i=e.map(o=>o.trim()).map(o=>this.parser.parseValue(o)),r=[];return i.forEach(o=>{o!==void 0&&r.push(o)}),r}}class Mi{parseValue(e){if(typeof e=="string")return e}}Mi.shared=new Mi;class Vt{parseValue(e){return String(e)}}Vt.shared=new Vt;class de{constructor(e,t){this.parser=e,this.rawValue=t}get values(){return this.parseRawValue()}get value(){return this.values[0]}parseRawValue(){if(this.rawValue===void 0)return[];const e=Array.isArray(this.rawValue)?this.rawValue:[this.rawValue],t=[];return e.forEach(i=>{const r=this.parser.parseValue(i);Array.isArray(r)?t.push(...r):r!==void 0&&t.push(r)}),t}}n([y()],de.prototype,"values",null);n([y()],de.prototype,"value",null);class Fa extends de{constructor(e){super(Ti.shared,e)}}class me extends de{constructor(e){super(St.shared,e)}}class di extends de{constructor(e){super(jt.shared,e)}}class re extends de{constructor(e){super(Se.shared,e)}}class z extends de{constructor(e){super(Vt.shared,e)}}class Na extends de{constructor(e){super(Mi.shared,e)}}class mr extends de{constructor(e){super(Ut.shared,e)}}class Ra extends de{constructor(e){super(Ai.shared,e)}}class Da extends de{constructor(e,t){super(t,e)}}class Ia extends Da{constructor(e){const t=new Pa(Vt.shared);super(e,t)}}class C{constructor(e){this.rawMetadata=e}get identifier(){var e;return(e=this.rawMetadata)===null||e===void 0?void 0:e.identifier}get addeddate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.addeddate?new me(this.rawMetadata.addeddate):void 0}get audio_codec(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.audio_codec?new z(this.rawMetadata.audio_codec):void 0}get audio_sample_rate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.audio_sample_rate?new re(this.rawMetadata.audio_sample_rate):void 0}get avg_rating(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.avg_rating?new re(this.rawMetadata.avg_rating):void 0}get collection(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.collection?new z(this.rawMetadata.collection):void 0}get collections_raw(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.collections_raw?new z(this.rawMetadata.collections_raw):void 0}get collection_size(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.collection_size?new mr(this.rawMetadata.collection_size):void 0}get contributor(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.contributor?new z(this.rawMetadata.contributor):void 0}get coverage(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.coverage?new z(this.rawMetadata.coverage):void 0}get creator(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.creator?new z(this.rawMetadata.creator):void 0}get date(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.date?new me(this.rawMetadata.date):void 0}get description(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.description?new z(this.rawMetadata.description):void 0}get downloads(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.downloads?new re(this.rawMetadata.downloads):void 0}get duration(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.duration?new di(this.rawMetadata.duration):void 0}get"external-identifier"(){var e,t;return!((e=this.rawMetadata)===null||e===void 0)&&e["external-identifier"]?new z((t=this.rawMetadata)===null||t===void 0?void 0:t["external-identifier"]):void 0}get files_count(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.files_count?new re(this.rawMetadata.files_count):void 0}get indexdate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.indexdate?new me(this.rawMetadata.indexdate):void 0}get isbn(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.isbn?new z(this.rawMetadata.isbn):void 0}get issue(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.issue?new z(this.rawMetadata.issue):void 0}get item_count(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.item_count?new re(this.rawMetadata.item_count):void 0}get item_size(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.item_size?new mr(this.rawMetadata.item_size):void 0}get language(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.language?new z(this.rawMetadata.language):void 0}get length(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.length?new di(this.rawMetadata.length):void 0}get lineage(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.lineage?new z(this.rawMetadata.lineage):void 0}get month(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.month?new re(this.rawMetadata.month):void 0}get mediatype(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.mediatype?new Ra(this.rawMetadata.mediatype):void 0}get noindex(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.noindex?new Fa(this.rawMetadata.noindex):void 0}get notes(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.notes?new z(this.rawMetadata.notes):void 0}get num_favorites(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.num_favorites?new re(this.rawMetadata.num_favorites):void 0}get num_reviews(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.num_reviews?new re(this.rawMetadata.num_reviews):void 0}get openlibrary_edition(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.openlibrary_edition?new z(this.rawMetadata.openlibrary_edition):void 0}get openlibrary_work(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.openlibrary_work?new z(this.rawMetadata.openlibrary_work):void 0}get page_progression(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.page_progression?new Na(this.rawMetadata.page_progression):void 0}get partner(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.partner?new z(this.rawMetadata.partner):void 0}get ppi(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.ppi?new re(this.rawMetadata.ppi):void 0}get publicdate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.publicdate?new me(this.rawMetadata.publicdate):void 0}get publisher(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.publisher?new z(this.rawMetadata.publisher):void 0}get reviewdate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.reviewdate?new me(this.rawMetadata.reviewdate):void 0}get runtime(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.runtime?new di(this.rawMetadata.runtime):void 0}get scanner(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.scanner?new z(this.rawMetadata.scanner):void 0}get source(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.source?new z(this.rawMetadata.source):void 0}get start_localtime(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.start_localtime?new me(this.rawMetadata.start_localtime):void 0}get start_time(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.start_time?new me(this.rawMetadata.start_time):void 0}get stop_time(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.stop_time?new me(this.rawMetadata.stop_time):void 0}get subject(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.subject?new Ia(this.rawMetadata.subject):void 0}get taper(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.taper?new z(this.rawMetadata.taper):void 0}get title(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.title?new z(this.rawMetadata.title):void 0}get transferer(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.transferer?new z(this.rawMetadata.transferer):void 0}get track(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.track?new re(this.rawMetadata.track):void 0}get type(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.type?new z(this.rawMetadata.type):void 0}get uploader(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.uploader?new z(this.rawMetadata.uploader):void 0}get utc_offset(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.utc_offset?new re(this.rawMetadata.utc_offset):void 0}get venue(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.venue?new z(this.rawMetadata.venue):void 0}get volume(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.volume?new z(this.rawMetadata.volume):void 0}get week(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.week?new re(this.rawMetadata.week):void 0}get year(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.year?new me(this.rawMetadata.year):void 0}}n([y()],C.prototype,"addeddate",null);n([y()],C.prototype,"audio_codec",null);n([y()],C.prototype,"audio_sample_rate",null);n([y()],C.prototype,"avg_rating",null);n([y()],C.prototype,"collection",null);n([y()],C.prototype,"collections_raw",null);n([y()],C.prototype,"collection_size",null);n([y()],C.prototype,"contributor",null);n([y()],C.prototype,"coverage",null);n([y()],C.prototype,"creator",null);n([y()],C.prototype,"date",null);n([y()],C.prototype,"description",null);n([y()],C.prototype,"downloads",null);n([y()],C.prototype,"duration",null);n([y()],C.prototype,"external-identifier",null);n([y()],C.prototype,"files_count",null);n([y()],C.prototype,"indexdate",null);n([y()],C.prototype,"isbn",null);n([y()],C.prototype,"issue",null);n([y()],C.prototype,"item_count",null);n([y()],C.prototype,"item_size",null);n([y()],C.prototype,"language",null);n([y()],C.prototype,"length",null);n([y()],C.prototype,"lineage",null);n([y()],C.prototype,"month",null);n([y()],C.prototype,"mediatype",null);n([y()],C.prototype,"noindex",null);n([y()],C.prototype,"notes",null);n([y()],C.prototype,"num_favorites",null);n([y()],C.prototype,"num_reviews",null);n([y()],C.prototype,"openlibrary_edition",null);n([y()],C.prototype,"openlibrary_work",null);n([y()],C.prototype,"page_progression",null);n([y()],C.prototype,"partner",null);n([y()],C.prototype,"ppi",null);n([y()],C.prototype,"publicdate",null);n([y()],C.prototype,"publisher",null);n([y()],C.prototype,"reviewdate",null);n([y()],C.prototype,"runtime",null);n([y()],C.prototype,"scanner",null);n([y()],C.prototype,"source",null);n([y()],C.prototype,"start_localtime",null);n([y()],C.prototype,"start_time",null);n([y()],C.prototype,"stop_time",null);n([y()],C.prototype,"subject",null);n([y()],C.prototype,"taper",null);n([y()],C.prototype,"title",null);n([y()],C.prototype,"transferer",null);n([y()],C.prototype,"track",null);n([y()],C.prototype,"type",null);n([y()],C.prototype,"uploader",null);n([y()],C.prototype,"utc_offset",null);n([y()],C.prototype,"venue",null);n([y()],C.prototype,"volume",null);n([y()],C.prototype,"week",null);n([y()],C.prototype,"year",null);class at{constructor(e){this.rawValue=e}get name(){return this.rawValue.name}get source(){return this.rawValue.source}get btih(){return this.rawValue.btih}get md5(){return this.rawValue.md5}get format(){return this.rawValue.format}get mtime(){return this.rawValue.mtime}get crc32(){return this.rawValue.crc32}get sha1(){return this.rawValue.sha1}get original(){return this.rawValue.original}get size(){return this.rawValue.size?Ut.shared.parseValue(this.rawValue.size):void 0}get title(){return this.rawValue.title}get length(){return this.rawValue.length?jt.shared.parseValue(this.rawValue.length):void 0}get height(){return this.rawValue.height?Se.shared.parseValue(this.rawValue.height):void 0}get width(){return this.rawValue.width?Se.shared.parseValue(this.rawValue.width):void 0}get track(){return this.rawValue.track?Se.shared.parseValue(this.rawValue.track):void 0}get external_identifier(){return this.rawValue.external_identifier}get creator(){return this.rawValue.creator}get album(){return this.rawValue.album}}n([y()],at.prototype,"size",null);n([y()],at.prototype,"length",null);n([y()],at.prototype,"height",null);n([y()],at.prototype,"width",null);n([y()],at.prototype,"track",null);class qt{constructor(e){this.rawValue=e}get reviewbody(){return this.rawValue.reviewbody}get reviewtitle(){return this.rawValue.reviewtitle}get reviewer(){return this.rawValue.reviewer}get reviewdate(){return this.rawValue.reviewdate?St.shared.parseValue(this.rawValue.reviewdate):void 0}get createdate(){return this.rawValue.createdate?St.shared.parseValue(this.rawValue.createdate):void 0}get stars(){return this.rawValue.stars?Se.shared.parseValue(this.rawValue.stars):void 0}}n([y()],qt.prototype,"reviewdate",null);n([y()],qt.prototype,"createdate",null);n([y()],qt.prototype,"stars",null);class Ba{constructor(e){var t,i;this.rawResponse=e,this.created=e.created,this.d1=e.d1,this.d2=e.d2,this.dir=e.dir,this.files=(t=e.files)===null||t===void 0?void 0:t.map(r=>new at(r)),this.files_count=e.files_count,this.item_last_updated=e.item_last_updated,this.item_size=e.item_size,this.metadata=new C(e.metadata),this.server=e.server,this.uniq=e.uniq,this.workable_servers=e.workable_servers,this.speech_vs_music_asr=e.speech_vs_music_asr,this.reviews=(i=e.reviews)===null||i===void 0?void 0:i.map(r=>new qt(r))}}class Ha{constructor(e){this.numFound=e.numFound,this.start=e.start,this.docs=e.docs.map(t=>new C(t)),this.aggregations=e.aggregations}}class Ua{constructor(e){this.rawResponse=e,this.responseHeader=e.responseHeader,this.response=new Ha(e.response)}}var Ne;(function(a){a.networkError="SearchService.NetworkError",a.itemNotFound="SearchService.ItemNotFound",a.decodingError="SearchService.DecodingError",a.searchEngineError="SearchService.SearchEngineError"})(Ne||(Ne={}));class Li extends Error{constructor(e,t,i){super(t),this.name=e,this.type=e,this.details=i}}class ja{static aggregateSearchParamsAsString(e){if(e.advancedParams){const t=e.advancedParams.map(r=>({terms:r}));return JSON.stringify(t)}if(e.simpleParams)return e.simpleParams.join(",")}static sortParamsAsString(e){return`${e.field} ${e.direction}`}static generateURLSearchParams(e){const t=new URLSearchParams;if(t.append("q",e.query),t.append("output","json"),e.rows&&t.append("rows",String(e.rows)),e.page&&t.append("page",String(e.page)),e.fields&&t.append("fl",e.fields.join(",")),e.sort){const r=e.sort.map(o=>this.sortParamsAsString(o));t.append("sort",r.join(","))}const i=e.aggregations;if(i){const r=this.aggregateSearchParamsAsString(i);r&&t.append("user_aggs",r)}return t}}class Va{constructor(e){var t;if(this.baseUrl=(t=e==null?void 0:e.baseUrl)!==null&&t!==void 0?t:"archive.org",(e==null?void 0:e.includeCredentials)!==void 0?this.includeCredentials=e.includeCredentials:this.includeCredentials=window.location.href.match(/^https?:\/\/.*archive\.org(:[0-9]+)?/)!==null,(e==null?void 0:e.scope)!==void 0)this.requestScope=e.scope;else{const r=new URL(window.location.href).searchParams.get("scope");r&&(this.requestScope=r)}}async performSearch(e){const i=ja.generateURLSearchParams(e).toString(),r=`https://${this.baseUrl}/advancedsearch.php?${i}`;return this.fetchUrl(r)}async fetchMetadata(e,t){const i=t?`/${t}`:"",r=`https://${this.baseUrl}/metadata/${e}${i}`;return this.fetchUrl(r,{requestOptions:{credentials:"omit"}})}async fetchUrl(e,t){var i;const r=new URL(e);this.requestScope&&r.searchParams.set("scope",this.requestScope);let o;try{const s=(i=t==null?void 0:t.requestOptions)!==null&&i!==void 0?i:{credentials:this.includeCredentials?"include":"same-origin"};o=await fetch(r.href,s)}catch(s){const l=s instanceof Error?s.message:typeof s=="string"?s:"Unknown error";return this.getErrorResult(Ne.networkError,l)}try{const s=await o.json(),l=s.error;if(l){const c=s.forensics;return this.getErrorResult(Ne.searchEngineError,l,c)}else return{success:s}}catch(s){const l=s instanceof Error?s.message:typeof s=="string"?s:"Unknown error";return this.getErrorResult(Ne.decodingError,l)}}getErrorResult(e,t,i){return{error:new Li(e,t,i)}}}class Ei{constructor(e){this.searchBackend=e}async search(e){const t=await this.searchBackend.performSearch(e);return t.error?t:{success:new Ua(t.success)}}async fetchMetadata(e){var t;const i=await this.searchBackend.fetchMetadata(e);return i.error?i:((t=i.success)===null||t===void 0?void 0:t.metadata)===void 0?{error:new Li(Ne.itemNotFound)}:{success:new Ba(i.success)}}async fetchMetadataValue(e,t){var i;const r=await this.searchBackend.fetchMetadata(e,t);return r.error?r:((i=r.success)===null||i===void 0?void 0:i.result)===void 0?{error:new Li(Ne.itemNotFound)}:{success:r.success.result}}}Ei.default=new Ei(new Va);function Wa(){var a=!navigator.userAgentData&&/Safari\//.test(navigator.userAgent)&&!/Chrom(e|ium)\//.test(navigator.userAgent);if(!a||!indexedDB.databases)return Promise.resolve();var e;return new Promise(function(t){var i=function(){return indexedDB.databases().finally(t)};e=setInterval(i,100),i()}).finally(function(){return clearInterval(e)})}function ot(a){return new Promise((e,t)=>{a.oncomplete=a.onsuccess=()=>e(a.result),a.onabort=a.onerror=()=>t(a.error)})}function Qa(a,e){const t=Wa().then(()=>{const i=indexedDB.open(a);return i.onupgradeneeded=()=>i.result.createObjectStore(e),ot(i)});return(i,r)=>t.then(o=>r(o.transaction(e,i).objectStore(e)))}let ci;function Yt(){return ci||(ci=Qa("keyval-store","keyval")),ci}function Ga(a,e=Yt()){return e("readonly",t=>ot(t.get(a)))}function Ka(a,e,t=Yt()){return t("readwrite",i=>(i.put(e,a),ot(i.transaction)))}function qa(a,e=Yt()){return e("readwrite",t=>(t.delete(a),ot(t.transaction)))}function Ya(a,e){return a.openCursor().onsuccess=function(){!this.result||(e(this.result),this.result.continue())},ot(a.transaction)}function Za(a=Yt()){return a("readonly",e=>{if(e.getAllKeys)return ot(e.getAllKeys());const t=[];return Ya(e,i=>t.push(i.key)).then(()=>t)})}function Xa(a,e){return a.setMilliseconds(a.getMilliseconds()+e*1e3),a}class Ja{constructor(e){var t,i,r,o;if(this.namespace=(t=e==null?void 0:e.namespace)!==null&&t!==void 0?t:"LocalCache",this.defaultTTL=(i=e==null?void 0:e.defaultTTL)!==null&&i!==void 0?i:15*60,(!((r=e==null?void 0:e.immediateClean)!==null&&r!==void 0)||r)&&this.cleanExpired(),!(e!=null&&e.disableCleaning)){const s=(o=e==null?void 0:e.cleaningInterval)!==null&&o!==void 0?o:60;setInterval(()=>{this.cleanExpired()},s*1e3)}}async set(e){var t;const i={value:e.value},r=(t=e.ttl)!==null&&t!==void 0?t:this.defaultTTL,o=Xa(new Date,r);i.expires=o;const s=this.getNamespacedKey(e.key);try{await Ka(s,i)}catch{}}async get(e){const t=this.getNamespacedKey(e);let i;try{i=await Ga(t)}catch{}if(!i)return;const r=new Date;if(i.expires&&i.expires<r){await this.delete(e);return}return i.value}async delete(e){const t=this.getNamespacedKey(e);try{await qa(t)}catch{}}async cleanExpired(){const e=await this.getAllKeys();await Promise.all(e.map(async t=>this.get(t)))}async getAllKeys(){let e=[];try{e=await Za()}catch{}const t=[];for(const o of e)typeof o=="string"&&t.push(o);return t.filter(o=>o.startsWith(this.namespace)).map(o=>this.removeNamespace(o))}getNamespacedKey(e){return`${this.namespace}-${e}`}removeNamespace(e){return e.replace(`${this.namespace}-`,"")}}/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ui=window.ShadowRoot&&(window.ShadyCSS===void 0||window.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,ji=Symbol(),gr=new Map;class Qr{constructor(e,t){if(this._$cssResult$=!0,t!==ji)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e}get styleSheet(){let e=gr.get(this.cssText);return Ui&&e===void 0&&(gr.set(this.cssText,e=new CSSStyleSheet),e.replaceSync(this.cssText)),e}toString(){return this.cssText}}const eo=a=>new Qr(typeof a=="string"?a:a+"",ji),f=(a,...e)=>{const t=a.length===1?a[0]:e.reduce((i,r,o)=>i+(s=>{if(s._$cssResult$===!0)return s.cssText;if(typeof s=="number")return s;throw Error("Value passed to 'css' function must be a 'css' function result: "+s+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(r)+a[o+1],a[0]);return new Qr(t,ji)},to=(a,e)=>{Ui?a.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet):e.forEach(t=>{const i=document.createElement("style"),r=window.litNonce;r!==void 0&&i.setAttribute("nonce",r),i.textContent=t.cssText,a.appendChild(i)})},fr=Ui?a=>a:a=>a instanceof CSSStyleSheet?(e=>{let t="";for(const i of e.cssRules)t+=i.cssText;return eo(t)})(a):a;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var hi;const br=window.trustedTypes,io=br?br.emptyScript:"",yr=window.reactiveElementPolyfillSupport,Oi={toAttribute(a,e){switch(e){case Boolean:a=a?io:null;break;case Object:case Array:a=a==null?a:JSON.stringify(a)}return a},fromAttribute(a,e){let t=a;switch(e){case Boolean:t=a!==null;break;case Number:t=a===null?null:Number(a);break;case Object:case Array:try{t=JSON.parse(a)}catch{t=null}}return t}},Gr=(a,e)=>e!==a&&(e==e||a==a),ui={attribute:!0,type:String,converter:Oi,reflect:!1,hasChanged:Gr};class Xe extends HTMLElement{constructor(){super(),this._$Et=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Ei=null,this.o()}static addInitializer(e){var t;(t=this.l)!==null&&t!==void 0||(this.l=[]),this.l.push(e)}static get observedAttributes(){this.finalize();const e=[];return this.elementProperties.forEach((t,i)=>{const r=this._$Eh(i,t);r!==void 0&&(this._$Eu.set(r,i),e.push(r))}),e}static createProperty(e,t=ui){if(t.state&&(t.attribute=!1),this.finalize(),this.elementProperties.set(e,t),!t.noAccessor&&!this.prototype.hasOwnProperty(e)){const i=typeof e=="symbol"?Symbol():"__"+e,r=this.getPropertyDescriptor(e,i,t);r!==void 0&&Object.defineProperty(this.prototype,e,r)}}static getPropertyDescriptor(e,t,i){return{get(){return this[t]},set(r){const o=this[e];this[t]=r,this.requestUpdate(e,o,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)||ui}static finalize(){if(this.hasOwnProperty("finalized"))return!1;this.finalized=!0;const e=Object.getPrototypeOf(this);if(e.finalize(),this.elementProperties=new Map(e.elementProperties),this._$Eu=new Map,this.hasOwnProperty("properties")){const t=this.properties,i=[...Object.getOwnPropertyNames(t),...Object.getOwnPropertySymbols(t)];for(const r of i)this.createProperty(r,t[r])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const i=new Set(e.flat(1/0).reverse());for(const r of i)t.unshift(fr(r))}else e!==void 0&&t.push(fr(e));return t}static _$Eh(e,t){const i=t.attribute;return i===!1?void 0:typeof i=="string"?i:typeof e=="string"?e.toLowerCase():void 0}o(){var e;this._$Ep=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$Em(),this.requestUpdate(),(e=this.constructor.l)===null||e===void 0||e.forEach(t=>t(this))}addController(e){var t,i;((t=this._$Eg)!==null&&t!==void 0?t:this._$Eg=[]).push(e),this.renderRoot!==void 0&&this.isConnected&&((i=e.hostConnected)===null||i===void 0||i.call(e))}removeController(e){var t;(t=this._$Eg)===null||t===void 0||t.splice(this._$Eg.indexOf(e)>>>0,1)}_$Em(){this.constructor.elementProperties.forEach((e,t)=>{this.hasOwnProperty(t)&&(this._$Et.set(t,this[t]),delete this[t])})}createRenderRoot(){var e;const t=(e=this.shadowRoot)!==null&&e!==void 0?e:this.attachShadow(this.constructor.shadowRootOptions);return to(t,this.constructor.elementStyles),t}connectedCallback(){var e;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$Eg)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostConnected)===null||i===void 0?void 0:i.call(t)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$Eg)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostDisconnected)===null||i===void 0?void 0:i.call(t)})}attributeChangedCallback(e,t,i){this._$AK(e,i)}_$ES(e,t,i=ui){var r,o;const s=this.constructor._$Eh(e,i);if(s!==void 0&&i.reflect===!0){const l=((o=(r=i.converter)===null||r===void 0?void 0:r.toAttribute)!==null&&o!==void 0?o:Oi.toAttribute)(t,i.type);this._$Ei=e,l==null?this.removeAttribute(s):this.setAttribute(s,l),this._$Ei=null}}_$AK(e,t){var i,r,o;const s=this.constructor,l=s._$Eu.get(e);if(l!==void 0&&this._$Ei!==l){const c=s.getPropertyOptions(l),h=c.converter,v=(o=(r=(i=h)===null||i===void 0?void 0:i.fromAttribute)!==null&&r!==void 0?r:typeof h=="function"?h:null)!==null&&o!==void 0?o:Oi.fromAttribute;this._$Ei=l,this[l]=v(t,c.type),this._$Ei=null}}requestUpdate(e,t,i){let r=!0;e!==void 0&&(((i=i||this.constructor.getPropertyOptions(e)).hasChanged||Gr)(this[e],t)?(this._$AL.has(e)||this._$AL.set(e,t),i.reflect===!0&&this._$Ei!==e&&(this._$EC===void 0&&(this._$EC=new Map),this._$EC.set(e,i))):r=!1),!this.isUpdatePending&&r&&(this._$Ep=this._$E_())}async _$E_(){this.isUpdatePending=!0;try{await this._$Ep}catch(t){Promise.reject(t)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var e;if(!this.isUpdatePending)return;this.hasUpdated,this._$Et&&(this._$Et.forEach((r,o)=>this[o]=r),this._$Et=void 0);let t=!1;const i=this._$AL;try{t=this.shouldUpdate(i),t?(this.willUpdate(i),(e=this._$Eg)===null||e===void 0||e.forEach(r=>{var o;return(o=r.hostUpdate)===null||o===void 0?void 0:o.call(r)}),this.update(i)):this._$EU()}catch(r){throw t=!1,this._$EU(),r}t&&this._$AE(i)}willUpdate(e){}_$AE(e){var t;(t=this._$Eg)===null||t===void 0||t.forEach(i=>{var r;return(r=i.hostUpdated)===null||r===void 0?void 0:r.call(i)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EU(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$Ep}shouldUpdate(e){return!0}update(e){this._$EC!==void 0&&(this._$EC.forEach((t,i)=>this._$ES(i,this[i],t)),this._$EC=void 0),this._$EU()}updated(e){}firstUpdated(e){}}Xe.finalized=!0,Xe.elementProperties=new Map,Xe.elementStyles=[],Xe.shadowRootOptions={mode:"open"},yr==null||yr({ReactiveElement:Xe}),((hi=globalThis.reactiveElementVersions)!==null&&hi!==void 0?hi:globalThis.reactiveElementVersions=[]).push("1.3.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var pi;const et=globalThis.trustedTypes,wr=et?et.createPolicy("lit-html",{createHTML:a=>a}):void 0,ge=`lit$${(Math.random()+"").slice(9)}$`,Vi="?"+ge,ro=`<${Vi}>`,tt=document,$t=(a="")=>tt.createComment(a),kt=a=>a===null||typeof a!="object"&&typeof a!="function",Kr=Array.isArray,qr=a=>{var e;return Kr(a)||typeof((e=a)===null||e===void 0?void 0:e[Symbol.iterator])=="function"},ft=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Cr=/-->/g,xr=/>/g,Ee=/>|[ 	\n\r](?:([^\s"'>=/]+)([ 	\n\r]*=[ 	\n\r]*(?:[^ 	\n\r"'`<>=]|("|')|))|$)/g,Sr=/'/g,$r=/"/g,Yr=/^(?:script|style|textarea|title)$/i,Zr=a=>(e,...t)=>({_$litType$:a,strings:e,values:t}),p=Zr(1),P=Zr(2),$e=Symbol.for("lit-noChange"),k=Symbol.for("lit-nothing"),kr=new WeakMap,It=(a,e,t)=>{var i,r;const o=(i=t==null?void 0:t.renderBefore)!==null&&i!==void 0?i:e;let s=o._$litPart$;if(s===void 0){const l=(r=t==null?void 0:t.renderBefore)!==null&&r!==void 0?r:null;o._$litPart$=s=new st(e.insertBefore($t(),l),l,void 0,t!=null?t:{})}return s._$AI(a),s},Je=tt.createTreeWalker(tt,129,null,!1),Xr=(a,e)=>{const t=a.length-1,i=[];let r,o=e===2?"<svg>":"",s=ft;for(let c=0;c<t;c++){const h=a[c];let v,g,b=-1,S=0;for(;S<h.length&&(s.lastIndex=S,g=s.exec(h),g!==null);)S=s.lastIndex,s===ft?g[1]==="!--"?s=Cr:g[1]!==void 0?s=xr:g[2]!==void 0?(Yr.test(g[2])&&(r=RegExp("</"+g[2],"g")),s=Ee):g[3]!==void 0&&(s=Ee):s===Ee?g[0]===">"?(s=r!=null?r:ft,b=-1):g[1]===void 0?b=-2:(b=s.lastIndex-g[2].length,v=g[1],s=g[3]===void 0?Ee:g[3]==='"'?$r:Sr):s===$r||s===Sr?s=Ee:s===Cr||s===xr?s=ft:(s=Ee,r=void 0);const $=s===Ee&&a[c+1].startsWith("/>")?" ":"";o+=s===ft?h+ro:b>=0?(i.push(v),h.slice(0,b)+"$lit$"+h.slice(b)+ge+$):h+ge+(b===-2?(i.push(void 0),c):$)}const l=o+(a[t]||"<?>")+(e===2?"</svg>":"");if(!Array.isArray(a)||!a.hasOwnProperty("raw"))throw Error("invalid template strings array");return[wr!==void 0?wr.createHTML(l):l,i]};class _t{constructor({strings:e,_$litType$:t},i){let r;this.parts=[];let o=0,s=0;const l=e.length-1,c=this.parts,[h,v]=Xr(e,t);if(this.el=_t.createElement(h,i),Je.currentNode=this.el.content,t===2){const g=this.el.content,b=g.firstChild;b.remove(),g.append(...b.childNodes)}for(;(r=Je.nextNode())!==null&&c.length<l;){if(r.nodeType===1){if(r.hasAttributes()){const g=[];for(const b of r.getAttributeNames())if(b.endsWith("$lit$")||b.startsWith(ge)){const S=v[s++];if(g.push(b),S!==void 0){const $=r.getAttribute(S.toLowerCase()+"$lit$").split(ge),T=/([.?@])?(.*)/.exec(S);c.push({type:1,index:o,name:T[2],strings:$,ctor:T[1]==="."?ea:T[1]==="?"?ta:T[1]==="@"?ia:Lt})}else c.push({type:6,index:o})}for(const b of g)r.removeAttribute(b)}if(Yr.test(r.tagName)){const g=r.textContent.split(ge),b=g.length-1;if(b>0){r.textContent=et?et.emptyScript:"";for(let S=0;S<b;S++)r.append(g[S],$t()),Je.nextNode(),c.push({type:2,index:++o});r.append(g[b],$t())}}}else if(r.nodeType===8)if(r.data===Vi)c.push({type:2,index:o});else{let g=-1;for(;(g=r.data.indexOf(ge,g+1))!==-1;)c.push({type:7,index:o}),g+=ge.length-1}o++}}static createElement(e,t){const i=tt.createElement("template");return i.innerHTML=e,i}}function Ie(a,e,t=a,i){var r,o,s,l;if(e===$e)return e;let c=i!==void 0?(r=t._$Cl)===null||r===void 0?void 0:r[i]:t._$Cu;const h=kt(e)?void 0:e._$litDirective$;return(c==null?void 0:c.constructor)!==h&&((o=c==null?void 0:c._$AO)===null||o===void 0||o.call(c,!1),h===void 0?c=void 0:(c=new h(a),c._$AT(a,t,i)),i!==void 0?((s=(l=t)._$Cl)!==null&&s!==void 0?s:l._$Cl=[])[i]=c:t._$Cu=c),c!==void 0&&(e=Ie(a,c._$AS(a,e.values),c,i)),e}class Jr{constructor(e,t){this.v=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}p(e){var t;const{el:{content:i},parts:r}=this._$AD,o=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:tt).importNode(i,!0);Je.currentNode=o;let s=Je.nextNode(),l=0,c=0,h=r[0];for(;h!==void 0;){if(l===h.index){let v;h.type===2?v=new st(s,s.nextSibling,this,e):h.type===1?v=new h.ctor(s,h.name,h.strings,this,e):h.type===6&&(v=new ra(s,this,e)),this.v.push(v),h=r[++c]}l!==(h==null?void 0:h.index)&&(s=Je.nextNode(),l++)}return o}m(e){let t=0;for(const i of this.v)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class st{constructor(e,t,i,r){var o;this.type=2,this._$AH=k,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=r,this._$Cg=(o=r==null?void 0:r.isConnected)===null||o===void 0||o}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cg}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&e.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Ie(this,e,t),kt(e)?e===k||e==null||e===""?(this._$AH!==k&&this._$AR(),this._$AH=k):e!==this._$AH&&e!==$e&&this.$(e):e._$litType$!==void 0?this.T(e):e.nodeType!==void 0?this.k(e):qr(e)?this.S(e):this.$(e)}M(e,t=this._$AB){return this._$AA.parentNode.insertBefore(e,t)}k(e){this._$AH!==e&&(this._$AR(),this._$AH=this.M(e))}$(e){this._$AH!==k&&kt(this._$AH)?this._$AA.nextSibling.data=e:this.k(tt.createTextNode(e)),this._$AH=e}T(e){var t;const{values:i,_$litType$:r}=e,o=typeof r=="number"?this._$AC(e):(r.el===void 0&&(r.el=_t.createElement(r.h,this.options)),r);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===o)this._$AH.m(i);else{const s=new Jr(o,this),l=s.p(this.options);s.m(i),this.k(l),this._$AH=s}}_$AC(e){let t=kr.get(e.strings);return t===void 0&&kr.set(e.strings,t=new _t(e)),t}S(e){Kr(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,r=0;for(const o of e)r===t.length?t.push(i=new st(this.M($t()),this.M($t()),this,this.options)):i=t[r],i._$AI(o),r++;r<t.length&&(this._$AR(i&&i._$AB.nextSibling,r),t.length=r)}_$AR(e=this._$AA.nextSibling,t){var i;for((i=this._$AP)===null||i===void 0||i.call(this,!1,!0,t);e&&e!==this._$AB;){const r=e.nextSibling;e.remove(),e=r}}setConnected(e){var t;this._$AM===void 0&&(this._$Cg=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}}class Lt{constructor(e,t,i,r,o){this.type=1,this._$AH=k,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=o,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=k}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,i,r){const o=this.strings;let s=!1;if(o===void 0)e=Ie(this,e,t,0),s=!kt(e)||e!==this._$AH&&e!==$e,s&&(this._$AH=e);else{const l=e;let c,h;for(e=o[0],c=0;c<o.length-1;c++)h=Ie(this,l[i+c],t,c),h===$e&&(h=this._$AH[c]),s||(s=!kt(h)||h!==this._$AH[c]),h===k?e=k:e!==k&&(e+=(h!=null?h:"")+o[c+1]),this._$AH[c]=h}s&&!r&&this.C(e)}C(e){e===k?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e!=null?e:"")}}class ea extends Lt{constructor(){super(...arguments),this.type=3}C(e){this.element[this.name]=e===k?void 0:e}}const ao=et?et.emptyScript:"";class ta extends Lt{constructor(){super(...arguments),this.type=4}C(e){e&&e!==k?this.element.setAttribute(this.name,ao):this.element.removeAttribute(this.name)}}class ia extends Lt{constructor(e,t,i,r,o){super(e,t,i,r,o),this.type=5}_$AI(e,t=this){var i;if((e=(i=Ie(this,e,t,0))!==null&&i!==void 0?i:k)===$e)return;const r=this._$AH,o=e===k&&r!==k||e.capture!==r.capture||e.once!==r.once||e.passive!==r.passive,s=e!==k&&(r===k||o);o&&this.element.removeEventListener(this.name,this,r),s&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,i;typeof this._$AH=="function"?this._$AH.call((i=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&i!==void 0?i:this.element,e):this._$AH.handleEvent(e)}}class ra{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){Ie(this,e)}}const oo={L:"$lit$",P:ge,V:Vi,I:1,N:Xr,R:Jr,j:qr,D:Ie,H:st,F:Lt,O:ta,W:ia,B:ea,Z:ra},_r=window.litHtmlPolyfillSupport;_r==null||_r(_t,st),((pi=globalThis.litHtmlVersions)!==null&&pi!==void 0?pi:globalThis.litHtmlVersions=[]).push("2.2.4");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var vi,mi;class O extends Xe{constructor(){super(...arguments),this.renderOptions={host:this},this._$Dt=void 0}createRenderRoot(){var e,t;const i=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=i.firstChild),i}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Dt=It(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Dt)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Dt)===null||e===void 0||e.setConnected(!1)}render(){return $e}}O.finalized=!0,O._$litElement$=!0,(vi=globalThis.litElementHydrateSupport)===null||vi===void 0||vi.call(globalThis,{LitElement:O});const Tr=globalThis.litElementPolyfillSupport;Tr==null||Tr({LitElement:O});((mi=globalThis.litElementVersions)!==null&&mi!==void 0?mi:globalThis.litElementVersions=[]).push("3.2.0");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const D=a=>e=>typeof e=="function"?((t,i)=>(window.customElements.define(t,i),i))(a,e):((t,i)=>{const{kind:r,elements:o}=i;return{kind:r,elements:o,finisher(s){window.customElements.define(t,s)}}})(a,e);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const so=(a,e)=>e.kind==="method"&&e.descriptor&&!("value"in e.descriptor)?gt(oe({},e),{finisher(t){t.createProperty(e.key,a)}}):{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){typeof e.initializer=="function"&&(this[e.key]=e.initializer.call(this))},finisher(t){t.createProperty(e.key,a)}};function u(a){return(e,t)=>t!==void 0?((i,r,o)=>{r.constructor.createProperty(o,i)})(a,e,t):so(a,e)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function M(a){return u(gt(oe({},a),{state:!0}))}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const aa=({finisher:a,descriptor:e})=>(t,i)=>{var r;if(i===void 0){const o=(r=t.originalKey)!==null&&r!==void 0?r:t.key,s=e!=null?{kind:"method",placement:"prototype",key:o,descriptor:e(t.key)}:gt(oe({},t),{key:o});return a!=null&&(s.finisher=function(l){a(l,o)}),s}{const o=t.constructor;e!==void 0&&Object.defineProperty(t,i,e(i)),a==null||a(o,i)}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Z(a,e){return aa({descriptor:t=>{const i={get(){var r,o;return(o=(r=this.renderRoot)===null||r===void 0?void 0:r.querySelector(a))!==null&&o!==void 0?o:null},enumerable:!0,configurable:!0};if(e){const r=typeof t=="symbol"?Symbol():"__"+t;i.get=function(){var o,s;return this[r]===void 0&&(this[r]=(s=(o=this.renderRoot)===null||o===void 0?void 0:o.querySelector(a))!==null&&s!==void 0?s:null),this[r]}}return i}})}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function no(a){return aa({descriptor:e=>({get(){var t,i;return(i=(t=this.renderRoot)===null||t===void 0?void 0:t.querySelectorAll(a))!==null&&i!==void 0?i:[]},enumerable:!0,configurable:!0})})}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var gi;((gi=window.HTMLSlotElement)===null||gi===void 0?void 0:gi.prototype.assignedElements)!=null;class lo{constructor(){this.resizeObserver=new ResizeObserver(e=>{window.requestAnimationFrame(()=>{for(const t of e){const i=this.resizeHandlers.get(t.target);i==null||i.forEach(r=>{r.handleResize(t)})}})}),this.resizeHandlers=new Map}shutdown(){this.resizeHandlers.forEach((e,t)=>{this.resizeObserver.unobserve(t)}),this.resizeHandlers.clear()}addObserver(e){var t;const i=(t=this.resizeHandlers.get(e.target))!==null&&t!==void 0?t:new Set;i.add(e.handler),this.resizeHandlers.set(e.target,i),this.resizeObserver.observe(e.target,e.options)}removeObserver(e){const t=this.resizeHandlers.get(e.target);!t||(t.delete(e.handler),t.size===0&&(this.resizeObserver.unobserve(e.target),this.resizeHandlers.delete(e.target)))}}class co{constructor(e){var t,i,r,o;this.cacheKeyName="collection-name-cache",this.cacheTtl=60*60*24*7,this.defaultLoadDelay=100,this.loadDelay=100,this.defaultPruningAge=1e3*60*60*24*7,this.defaultPruningInterval=1e3*30,this.fetchTimeout=null,this.pendingIdentifierQueue=new Set,this.pendingPromises={},this.collectionNameCache={},this.pruningAge=this.defaultPruningAge,this.maxCacheSize=2500,this.cacheLoaded=!1,this.searchService=e.searchService,this.localCache=e.localCache,this.loadDelay=(t=e.loadDelay)!==null&&t!==void 0?t:this.defaultLoadDelay,this.pruningAge=(i=e.pruningAge)!==null&&i!==void 0?i:this.pruningAge,this.maxCacheSize=(r=e.maxCacheSize)!==null&&r!==void 0?r:this.maxCacheSize,this.pruneCache(),setInterval(async()=>{await this.pruneCache()},(o=e.pruneInterval)!==null&&o!==void 0?o:this.defaultPruningInterval)}async collectionNameFor(e){this.cacheLoaded||await this.loadFromCache();const t=e.toLowerCase(),i=this.collectionNameCache[t];return i?(i.lastAccess=Date.now(),this.collectionNameCache[t]=i,i.name):(this.startPendingIdentifierTimer(),new Promise(r=>{var o;this.pendingIdentifierQueue.add(t);const s=(o=this.pendingPromises[t])!==null&&o!==void 0?o:[],l=async c=>{r(c)};s.push(l),this.pendingPromises[t]=s}))}async preloadIdentifiers(e){this.cacheLoaded||await this.loadFromCache();const t=e.filter(i=>i!==void 0).map(i=>i.toLowerCase());for(const i of t)this.collectionNameCache[i]||this.pendingIdentifierQueue.add(i);this.startPendingIdentifierTimer()}async startPendingIdentifierTimer(){this.fetchTimeout||(this.fetchTimeout=window.setTimeout(()=>{this.loadPendingIdentifiers(),this.fetchTimeout=null},this.loadDelay))}async loadFromCache(){if(!this.localCache||this.cacheLoaded)return;const e=await this.localCache.get(this.cacheKeyName);!e||(this.collectionNameCache=e,this.cacheLoaded=!0)}async loadPendingIdentifiers(){var e,t,i;await this.loadFromCache();const r=Array.from(this.pendingIdentifierQueue).splice(0,100);if(r.length===0)return;r.map(async c=>this.pendingIdentifierQueue.delete(c));const o={query:`identifier:(${r.join(" OR ")})`,fields:["title","identifier"],rows:r.length},l=(t=(e=(await this.searchService.search(o)).success)===null||e===void 0?void 0:e.response)===null||t===void 0?void 0:t.docs;if(l&&l.length>0)for(const c of l){const{identifier:h,title:v}=c;if(!h)continue;const g=h.toLowerCase();r.splice(r.indexOf(g),1);const b=(i=v==null?void 0:v.value)!==null&&i!==void 0?i:null;this.collectionNameCache[g]={name:b,lastAccess:Date.now()};const S=this.pendingPromises[g];if(S){for(const $ of S)$(b);delete this.pendingPromises[g]}}for(const c of r){this.collectionNameCache[c]={name:null,lastAccess:Date.now()};const h=this.pendingPromises[c];if(h){for(const v of h)v(null);delete this.pendingPromises[c]}}await this.persistCache()}async pruneCache(){await this.loadFromCache();const e=Date.now(),t=Object.entries(this.collectionNameCache).sort((r,o)=>{var s,l,c,h;const v=(l=(s=r[1])===null||s===void 0?void 0:s.lastAccess)!==null&&l!==void 0?l:0,g=(h=(c=o[1])===null||c===void 0?void 0:c.lastAccess)!==null&&h!==void 0?h:0;return v-g}),i=new Set;for(const[r,o]of t){if(!o)continue;const{lastAccess:s}=o;s<e-this.pruningAge&&i.add(r)}if(t.length>this.maxCacheSize)for(let r=0;r<t.length-this.maxCacheSize;r+=1){const[o]=t[r];i.add(o)}for(const r of i)delete this.collectionNameCache[r];await this.persistCache()}async persistCache(){var e;await((e=this.localCache)===null||e===void 0?void 0:e.set({key:this.cacheKeyName,value:this.collectionNameCache,ttl:this.cacheTtl}))}}let Tt=class extends O{render(){return p` ${this.name?this.name:this.identifier} `}createRenderRoot(){return this}updated(e){(e.has("identifier")||e.has("collectionNameCache"))&&this.fetchName()}async fetchName(){!this.identifier||!this.collectionNameCache||(this.name=await this.collectionNameCache.collectionNameFor(this.identifier))}};n([u({type:Object})],Tt.prototype,"collectionNameCache",void 0);n([u({type:String})],Tt.prototype,"identifier",void 0);n([M()],Tt.prototype,"name",void 0);Tt=n([D("async-collection-name")],Tt);/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const oa={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},sa=a=>(...e)=>({_$litDirective$:a,values:e});class na{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{H:ho}=oo,Ar=()=>document.createComment(""),bt=(a,e,t)=>{var i;const r=a._$AA.parentNode,o=e===void 0?a._$AB:e._$AA;if(t===void 0){const s=r.insertBefore(Ar(),o),l=r.insertBefore(Ar(),o);t=new ho(s,l,a,a.options)}else{const s=t._$AB.nextSibling,l=t._$AM,c=l!==a;if(c){let h;(i=t._$AQ)===null||i===void 0||i.call(t,a),t._$AM=a,t._$AP!==void 0&&(h=a._$AU)!==l._$AU&&t._$AP(h)}if(s!==o||c){let h=t._$AA;for(;h!==s;){const v=h.nextSibling;r.insertBefore(h,o),h=v}}}return t},Oe=(a,e,t=a)=>(a._$AI(e,t),a),uo={},po=(a,e=uo)=>a._$AH=e,vo=a=>a._$AH,fi=a=>{var e;(e=a._$AP)===null||e===void 0||e.call(a,!1,!0);let t=a._$AA;const i=a._$AB.nextSibling;for(;t!==i;){const r=t.nextSibling;t.remove(),t=r}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Mr=(a,e,t)=>{const i=new Map;for(let r=e;r<=t;r++)i.set(a[r],r);return i},la=sa(class extends na{constructor(a){if(super(a),a.type!==oa.CHILD)throw Error("repeat() can only be used in text expressions")}dt(a,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);const r=[],o=[];let s=0;for(const l of a)r[s]=i?i(l,s):s,o[s]=t(l,s),s++;return{values:o,keys:r}}render(a,e,t){return this.dt(a,e,t).values}update(a,[e,t,i]){var r;const o=vo(a),{values:s,keys:l}=this.dt(e,t,i);if(!Array.isArray(o))return this.ut=l,s;const c=(r=this.ut)!==null&&r!==void 0?r:this.ut=[],h=[];let v,g,b=0,S=o.length-1,$=0,T=s.length-1;for(;b<=S&&$<=T;)if(o[b]===null)b++;else if(o[S]===null)S--;else if(c[b]===l[$])h[$]=Oe(o[b],s[$]),b++,$++;else if(c[S]===l[T])h[T]=Oe(o[S],s[T]),S--,T--;else if(c[b]===l[T])h[T]=Oe(o[b],s[T]),bt(a,h[T+1],o[b]),b++,T--;else if(c[S]===l[$])h[$]=Oe(o[S],s[$]),bt(a,o[b],o[S]),S--,$++;else if(v===void 0&&(v=Mr(l,$,T),g=Mr(c,b,S)),v.has(c[b]))if(v.has(c[S])){const F=g.get(l[$]),R=F!==void 0?o[F]:null;if(R===null){const ee=bt(a,o[b]);Oe(ee,s[$]),h[$]=ee}else h[$]=Oe(R,s[$]),bt(a,o[b],R),o[F]=null;$++}else fi(o[S]),S--;else fi(o[b]),b++;for(;$<=T;){const F=bt(a,h[T+1]);Oe(F,s[$]),h[$++]=F}for(;b<=S;){const F=o[b++];F!==null&&fi(F)}return this.ut=l,po(a,h),$e}});function Nt(a,e,t){return Array.from({length:(e-a)/t+1},(i,r)=>a+r*t)}let ke=class extends O{constructor(){super(...arguments),this.itemCount=0,this.scrollOptimizationsDisabled=!1,this.intersectionObserver=new IntersectionObserver(e=>{e.forEach(t=>{if(t.target===this.sentinel){t.isIntersecting&&this.dispatchEvent(new Event("scrollThresholdReached"));return}const r=t.target.dataset.cellIndex;if(!r)return;const o=parseInt(r,10);t.isIntersecting?this.visibleCellIndices.add(o):this.visibleCellIndices.delete(o)}),this.scrollOptimizationsDisabled||this.processVisibleCells()}),this.renderedCellIndices=new Set,this.visibleCellIndices=new Set,this.placeholderCellIndices=new Set}reload(){Nt(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.removeCell(t)),this.renderedCellIndices.clear(),this.visibleCellIndices.clear(),this.placeholderCellIndices.clear(),this.setupObservations()}scrollToCell(e,t){const i=this.cellContainers[e];if(!i)return!1;const r=t?"smooth":"auto";return i.scrollIntoView({behavior:r}),!0}getVisibleCellIndices(){return Array.from(this.visibleCellIndices)}updated(e){(e.has("itemCount")||e.has("scrollOptimizationsDisabled"))&&this.setupObservations()}disconnectedCallback(){this.intersectionObserver.disconnect()}setupObservations(){this.setupIntersectionObserver()}setupIntersectionObserver(){this.intersectionObserver.disconnect(),this.sentinel&&this.intersectionObserver.observe(this.sentinel),this.scrollOptimizationsDisabled?(Nt(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.visibleCellIndices.add(t)),this.processVisibleCells()):this.cellContainers.forEach(e=>this.intersectionObserver.observe(e))}render(){const e=this.itemCount-1,t=Nt(0,e,1);return p`
      <div id="container">
        <div id="sentinel"></div>
        ${la(t,i=>i,i=>p`
            <div
    ...
    `}};n([u({type:Number})],ke.prototype,"itemCount",void 0);n([u({type:Object})],ke.prototype,"cellProvider",void 0);n([u({type:Object})],ke.prototype,"placeholderCellTemplate",void 0);n([u({type:Boolean})],ke.prototype,"scrollOptimizationsDisabled",void 0);n([Z("#sentinel")],ke.prototype,"sentinel",void 0);n([no(".cell-container")],ke.prototype,"cellContainers",void 0);ke=n([D("infinite-scroller")],ke);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const mo=(a,...e)=>({strTag:!0,strings:a,values:e}),Ze=mo,go=a=>typeof a!="string"&&"strTag"in a,fo=(a,e,t)=>{let i=a[0];for(let r=1;r<a.length;r++)i+=e[t?t[r-1]:r-1],i+=a[r];return i};/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const bo=a=>go(a)?fo(a.strings,a.values):a;/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class yo{constructor(){this.settled=!1,this.promise=new Promise((e,t)=>{this._resolve=e,this._reject=t})}resolve(e){this.settled=!0,this._resolve(e)}reject(e){this.settled=!0,this._reject(e)}}/**
 * @license
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let wo=new yo;wo.resolve();/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let Pe=bo;const da=P`
...
`;let zi=class extends O{render(){var e,t,i;return p`
      <div id="container">
        ...
        <div id="item-count-container">
          <div id="item-count-image-container">${da}</div>
    ...
    `}};n([u({type:Object})],zi.prototype,"model",void 0);zi=n([D("collection-tile")],zi);const Co=P`
...
`,Oo={account:{color:"#000000",icon:Co,text:"Account"},audio:{color:"#00adef",icon:xo,text:"Audio"},collection:{color:"#4666ff",icon:da,text:"Collection"},data:{color:"#333333",icon:So,text:"Data"},etree:{color:"#00adef",icon:$o,text:"E-tree"},film:{color:"#bf1b2c",icon:Lr,text:"Film"},image:{color:"#aa99c9",icon:ko,text:"Image"},movies:{color:"#f1644b",icon:Lr,text:"Movie"},radio:{color:"#8fdaef",icon:_o,text:"Radio"},software:{color:"#9ecc4f",icon:To,text:"Software"},texts:{color:"#faab3c",icon:Ao,text:"Text"},tv:{color:"#f1644b",icon:Mo,text:"TV"},video:{color:"#f1644b",icon:Lo,text:"Video"},web:{color:"#ffcd27",icon:Eo,text:"Web"}};let At=class extends O{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var e,t;const i=["tvnews","tvarchive","television"],r=["radio","radioprogram"];return this.mediatype==="movies"&&((e=this.collections)===null||e===void 0?void 0:e.some(o=>i.indexOf(o)>=0))?"tv":this.mediatype==="audio"&&((t=this.collections)===null||t===void 0?void 0:t.some(o=>r.indexOf(o)>=0))?"radio":this.mediatype||""}render(){const e=Oo[this.displayMediatype];return e?p`
      <div
        id="icon"
    ...
    `}};n([u({type:String})],At.prototype,"mediatype",void 0);n([u({type:Array})],At.prototype,"collections",void 0);n([u({type:Boolean})],At.prototype,"showText",void 0);At=n([D("mediatype-icon")],At);/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Er=sa(class extends na{constructor(a){var e;if(super(a),a.type!==oa.ATTRIBUTE||a.name!=="class"||((e=a.strings)===null||e===void 0?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(a){return" "+Object.keys(a).filter(e=>a[e]).join(" ")+" "}update(a,[e]){var t,i;if(this.et===void 0){this.et=new Set,a.strings!==void 0&&(this.st=new Set(a.strings.join(" ").split(/\s/).filter(o=>o!=="")));for(const o in e)e[o]&&!(!((t=this.st)===null||t===void 0)&&t.has(o))&&this.et.add(o);return this.render(e)}const r=a.element.classList;this.et.forEach(o=>{o in e||(r.remove(o),this.et.delete(o))});for(const o in e){const s=!!e[o];s===this.et.has(o)||((i=this.st)===null||i===void 0?void 0:i.has(o))||(s?(r.add(o),this.et.add(o)):(r.remove(o),this.et.delete(o)))}return $e}}),zo=f`
  .drop-shadow {
...
`;function Io(a,e){let t=1;return a>=1e9?t=1e9:a>=1e6?t=1e6:a>=1e3&&e==="short"&&(t=1e3),t}function Bo(a=0,e){const t=a/e,i=t<10;let r=0;return i?r=Math.round((t+Number.EPSILON)*10)/10:r=Math.round(t),r}function Ho(a,e,t,i){switch(e){case 1e9:return Pe(t==="short"?Ze`${a}B`:Ze`${a} billion`);case 1e6:return Pe(t==="short"?Ze`${a}M`:Ze`${a} million`);case 1e3:return Pe(t==="short"?Ze`${a}K`:Ze`${a} thousand`);default:return new Intl.NumberFormat(i).format(a)}}function Ct(a,e="long",t="short",i="en-US"){const r=a!=null?a:-1;if(r<0)return"";const o=Io(r,e),s=Bo(r,o);return Ho(s,o,t,i)}let Be=class extends O{render(){return p`
      <div class="item-stats">
        ...
        <ul id="stats-row">
          ...
          <li class="col">
            ${this.mediatype==="account"?Ro:Do}
            <p class="status-text">
              <span class="sr-only">
                ${this.mediatype==="account"?"Uploads:":"Views:"}
              </span>
              ${Ct(this.mediatype==="account"?this.itemCount:this.viewCount,"short","short")}
            </p>
          </li>
          <li class="col">
            ${Fo}
          ...
          <li class="col">
            ...
            <p class="status-text">
              ...
              ${Ct(this.commentCount,"short","short")}
            </p>
          </li>
        </ul>
      </div>
    ...
    `}};n([u({type:Object})],Wt.prototype,"model",void 0);n([u({type:String})],Wt.prototype,"baseImageUrl",void 0);Wt=n([D("item-tile")],Wt);let Pi=class extends O{render(){var e,t,i,r,o,s,l,c;return p`
    ...
    `}};n([u({type:Object})],Pi.prototype,"model",void 0);Pi=n([D("account-tile")],Pi);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*Or(a,e){if(a!==void 0){let t=0;for(const i of a)yield e(i,t++)}}/*! @license DOMPurify 2.3.8 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/2.3.8/LICENSE */function Fe(a){return Fe=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},Fe(a)}function Fi(a,e){return Fi=Object.setPrototypeOf||function(i,r){return i.__proto__=r,i},Fi(a,e)}function Uo(){if(typeof Reflect=="undefined"||!Reflect.construct||Reflect.construct.sham)return!1;if(typeof Proxy=="function")return!0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],function(){})),!0}catch{return!1}}function Bt(a,e,t){return Uo()?Bt=Reflect.construct:Bt=function(r,o,s){var l=[null];l.push.apply(l,o);var c=Function.bind.apply(r,l),h=new c;return s&&Fi(h,s.prototype),h},Bt.apply(null,arguments)}function se(a){return jo(a)||Vo(a)||Wo(a)||Qo()}function jo(a){if(Array.isArray(a))return Ni(a)}function Vo(a){if(typeof Symbol!="undefined"&&a[Symbol.iterator]!=null||a["@@iterator"]!=null)return Array.from(a)}function Wo(a,e){if(!!a){if(typeof a=="string")return Ni(a,e);var t=Object.prototype.toString.call(a).slice(8,-1);if(t==="Object"&&a.constructor&&(t=a.constructor.name),t==="Map"||t==="Set")return Array.from(a);if(t==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t))return Ni(a,e)}}function Ni(a,e){(e==null||e>a.length)&&(e=a.length);for(var t=0,i=new Array(e);t<e;t++)i[t]=a[t];return i}function Qo(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}var Go=Object.hasOwnProperty,zr=Object.setPrototypeOf,Ko=Object.isFrozen,qo=Object.getPrototypeOf,Yo=Object.getOwnPropertyDescriptor,Y=Object.freeze,ue=Object.seal,Zo=Object.create,ca=typeof Reflect!="undefined"&&Reflect,Qt=ca.apply,Ri=ca.construct;Qt||(Qt=function(e,t,i){return e.apply(t,i)});Y||(Y=function(e){return e});ue||(ue=function(e){return e});Ri||(Ri=function(e,t){return Bt(e,se(t))});var Xo=ne(Array.prototype.forEach),Pr=ne(Array.prototype.pop),yt=ne(Array.prototype.push),Ht=ne(String.prototype.toLowerCase),Jo=ne(String.prototype.match),xe=ne(String.prototype.replace),es=ne(String.prototype.indexOf),ts=ne(String.prototype.trim),q=ne(RegExp.prototype.test),yi=is(TypeError);function ne(a){return function(e){for(var t=arguments.length,i=new Array(t>1?t-1:0),r=1;r<t;r++)i[r-1]=arguments[r];return Qt(a,e,i)}}function is(a){return function(){for(var e=arguments.length,t=new Array(e),i=0;i<e;i++)t[i]=arguments[i];return Ri(a,t)}}function A(a,e){zr&&zr(a,null);for(var t=e.length;t--;){var i=e[t];if(typeof i=="string"){var r=Ht(i);r!==i&&(Ko(e)||(e[t]=r),i=r)}a[i]=!0}return a}function ze(a){var e=Zo(null),t;for(t in a)Qt(Go,a,[t])&&(e[t]=a[t]);return e}function Rt(a,e){for(;a!==null;){var t=Yo(a,e);if(t){if(t.get)return ne(t.get);if(typeof t.value=="function")return ne(t.value)}a=qo(a)}function i(r){return console.warn("fallback value for",r),null}return i}var Fr=Y(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","section","select","shadow","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),wi=Y(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","filter","font","g","glyph","glyphref","hkern","image","line","lineargradient","marker","mask","metadata","mpath","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),Ci=Y(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),rs=Y(["animate","color-profile","cursor","discard","fedropshadow","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),xi=Y(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover"]),as=Y(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),Nr=Y(["#text"]),Rr=Y(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","face","for","headers","height","hidden","high","href","hreflang","id","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","pattern","placeholder","playsinline","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","xmlns","slot"]),Si=Y(["accent-height","accumulate","additive","alignment-baseline","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),Dr=Y(["accent","accentunder","align","bevelled","close","columnsalign","columnlines","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lspace","lquote","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),Dt=Y(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),os=ue(/\{\{[\w\W]*|[\w\W]*\}\}/gm),ss=ue(/<%[\w\W]*|[\w\W]*%>/gm),ns=ue(/^data-[\-\w.\u00B7-\uFFFF]/),ls=ue(/^aria-[\-\w]+$/),ds=ue(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|cid|xmpp):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),cs=ue(/^(?:\w+script|data):/i),hs=ue(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),us=ue(/^html$/i),ps=function(){return typeof window=="undefined"?null:window},vs=function(e,t){if(Fe(e)!=="object"||typeof e.createPolicy!="function")return null;var i=null,r="data-tt-policy-suffix";t.currentScript&&t.currentScript.hasAttribute(r)&&(i=t.currentScript.getAttribute(r));var o="dompurify"+(i?"#"+i:"");try{return e.createPolicy(o,{createHTML:function(l){return l}})}catch{return console.warn("TrustedTypes policy "+o+" could not be created."),null}};function ha(){var a=arguments.length>0&&arguments[0]!==void 0?arguments[0]:ps(),e=function(d){return ha(d)};if(e.version="2.3.8",e.removed=[],!a||!a.document||a.document.nodeType!==9)return e.isSupported=!1,e;var t=a.document,i=a.document,r=a.DocumentFragment,o=a.HTMLTemplateElement,s=a.Node,l=a.Element,c=a.NodeFilter,h=a.NamedNodeMap,v=h===void 0?a.NamedNodeMap||a.MozNamedAttrMap:h,g=a.HTMLFormElement,b=a.DOMParser,S=a.trustedTypes,$=l.prototype,T=Rt($,"cloneNode"),F=Rt($,"nextSibling"),R=Rt($,"childNodes"),ee=Rt($,"parentNode");if(typeof o=="function"){var ae=i.createElement("template");ae.content&&ae.content.ownerDocument&&(i=ae.content.ownerDocument)}var W=vs(S,t),ye=W?W.createHTML(""):"",ce=i,he=ce.implementation,nt=ce.createNodeIterator,lt=ce.createDocumentFragment,dt=ce.getElementsByTagName,ct=t.importNode,He={};try{He=ze(i).documentMode?i.documentMode:{}}catch{}var X={};e.isSupported=typeof ee=="function"&&he&&typeof he.createHTMLDocument!="undefined"&&He!==9;var _e=os,Te=ss,ht=ns,ut=ls,pt=cs,Ue=hs,Ae=ds,I=null,je=A({},[].concat(se(Fr),se(wi),se(Ci),se(xi),se(Nr))),B=null,Ve=A({},[].concat(se(Rr),se(Si),se(Dr),se(Dt))),N=Object.seal(Object.create(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),we=null,Zt=null,Ki=!0,Xt=!0,qi=!1,We=!1,Me=!1,Jt=!1,ei=!1,Qe=!1,Et=!1,Ot=!1,Yi=!0,ti=!0,vt=!1,Ge={},Ke=null,Zi=A({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","style","svg","template","thead","title","video","xmp"]),Xi=null,Ji=A({},["audio","video","img","source","image","track"]),ii=null,er=A({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),ri="http://www.w3.org/1998/Math/MathML",ai="http://www.w3.org/2000/svg",Ce="http://www.w3.org/1999/xhtml",zt=Ce,oi=!1,qe,ya=["application/xhtml+xml","text/html"],wa="text/html",Le,Ye=null,Ca=i.createElement("form"),tr=function(d){return d instanceof RegExp||d instanceof Function},si=function(d){Ye&&Ye===d||((!d||Fe(d)!=="object")&&(d={}),d=ze(d),I="ALLOWED_TAGS"in d?A({},d.ALLOWED_TAGS):je,B="ALLOWED_ATTR"in d?A({},d.ALLOWED_ATTR):Ve,ii="ADD_URI_SAFE_ATTR"in d?A(ze(er),d.ADD_URI_SAFE_ATTR):er,Xi="ADD_DATA_URI_TAGS"in d?A(ze(Ji),d.ADD_DATA_URI_TAGS):Ji,Ke="FORBID_CONTENTS"in d?A({},d.FORBID_CONTENTS):Zi,we="FORBID_TAGS"in d?A({},d.FORBID_TAGS):{},Zt="FORBID_ATTR"in d?A({},d.FORBID_ATTR):{},Ge="USE_PROFILES"in d?d.USE_PROFILES:!1,Ki=d.ALLOW_ARIA_ATTR!==!1,Xt=d.ALLOW_DATA_ATTR!==!1,qi=d.ALLOW_UNKNOWN_PROTOCOLS||!1,We=d.SAFE_FOR_TEMPLATES||!1,Me=d.WHOLE_DOCUMENT||!1,Qe=d.RETURN_DOM||!1,Et=d.RETURN_DOM_FRAGMENT||!1,Ot=d.RETURN_TRUSTED_TYPE||!1,ei=d.FORCE_BODY||!1,Yi=d.SANITIZE_DOM!==!1,ti=d.KEEP_CONTENT!==!1,vt=d.IN_PLACE||!1,Ae=d.ALLOWED_URI_REGEXP||Ae,zt=d.NAMESPACE||Ce,d.CUSTOM_ELEMENT_HANDLING&&tr(d.CUSTOM_ELEMENT_HANDLING.tagNameCheck)&&(N.tagNameCheck=d.CUSTOM_ELEMENT_HANDLING.tagNameCheck),d.CUSTOM_ELEMENT_HANDLING&&tr(d.CUSTOM_ELEMENT_HANDLING.attributeNameCheck)&&(N.attributeNameCheck=d.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),d.CUSTOM_ELEMENT_HANDLING&&typeof d.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements=="boolean"&&(N.allowCustomizedBuiltInElements=d.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements),qe=ya.indexOf(d.PARSER_MEDIA_TYPE)===-1?qe=wa:qe=d.PARSER_MEDIA_TYPE,Le=qe==="application/xhtml+xml"?function(m){return m}:Ht,We&&(Xt=!1),Et&&(Qe=!0),Ge&&(I=A({},se(Nr)),B=[],Ge.html===!0&&(A(I,Fr),A(B,Rr)),Ge.svg===!0&&(A(I,wi),A(B,Si),A(B,Dt)),Ge.svgFilters===!0&&(A(I,Ci),A(B,Si),A(B,Dt)),Ge.mathMl===!0&&(A(I,xi),A(B,Dr),A(B,Dt))),d.ADD_TAGS&&(I===je&&(I=ze(I)),A(I,d.ADD_TAGS)),d.ADD_ATTR&&(B===Ve&&(B=ze(B)),A(B,d.ADD_ATTR)),d.ADD_URI_SAFE_ATTR&&A(ii,d.ADD_URI_SAFE_ATTR),d.FORBID_CONTENTS&&(Ke===Zi&&(Ke=ze(Ke)),A(Ke,d.FORBID_CONTENTS)),ti&&(I["#text"]=!0),Me&&A(I,["html","head","body"]),I.table&&(A(I,["tbody"]),delete we.tbody),Y&&Y(d),Ye=d)},ir=A({},["mi","mo","mn","ms","mtext"]),rr=A({},["foreignobject","desc","title","annotation-xml"]),xa=A({},["title","style","font","a","script"]),Pt=A({},wi);A(Pt,Ci),A(Pt,rs);var ni=A({},xi);A(ni,as);var Sa=function(d){var m=ee(d);(!m||!m.tagName)&&(m={namespaceURI:Ce,tagName:"template"});var w=Ht(d.tagName),E=Ht(m.tagName);return d.namespaceURI===ai?m.namespaceURI===Ce?w==="svg":m.namespaceURI===ri?w==="svg"&&(E==="annotation-xml"||ir[E]):Boolean(Pt[w]):d.namespaceURI===ri?m.namespaceURI===Ce?w==="math":m.namespaceURI===ai?w==="math"&&rr[E]:Boolean(ni[w]):d.namespaceURI===Ce?m.namespaceURI===ai&&!rr[E]||m.namespaceURI===ri&&!ir[E]?!1:!ni[w]&&(xa[w]||!Pt[w]):!1},pe=function(d){yt(e.removed,{element:d});try{d.parentNode.removeChild(d)}catch{try{d.outerHTML=ye}catch{d.remove()}}},ar=function(d,m){try{yt(e.removed,{attribute:m.getAttributeNode(d),from:m})}catch{yt(e.removed,{attribute:null,from:m})}if(m.removeAttribute(d),d==="is"&&!B[d])if(Qe||Et)try{pe(m)}catch{}else try{m.setAttribute(d,"")}catch{}},or=function(d){var m,w;if(ei)d="<remove></remove>"+d;else{var E=Jo(d,/^[\r\n\t ]+/);w=E&&E[0]}qe==="application/xhtml+xml"&&(d='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+d+"</body></html>");var J=W?W.createHTML(d):d;if(zt===Ce)try{m=new b().parseFromString(J,qe)}catch{}if(!m||!m.documentElement){m=he.createDocument(zt,"template",null);try{m.documentElement.innerHTML=oi?"":J}catch{}}var Q=m.body||m.documentElement;return d&&w&&Q.insertBefore(i.createTextNode(w),Q.childNodes[0]||null),zt===Ce?dt.call(m,Me?"html":"body")[0]:Me?m.documentElement:Q},sr=function(d){return nt.call(d.ownerDocument||d,d,c.SHOW_ELEMENT|c.SHOW_COMMENT|c.SHOW_TEXT,null,!1)},$a=function(d){return d instanceof g&&(typeof d.nodeName!="string"||typeof d.textContent!="string"||typeof d.removeChild!="function"||!(d.attributes instanceof v)||typeof d.removeAttribute!="function"||typeof d.setAttribute!="function"||typeof d.namespaceURI!="string"||typeof d.insertBefore!="function")},mt=function(d){return Fe(s)==="object"?d instanceof s:d&&Fe(d)==="object"&&typeof d.nodeType=="number"&&typeof d.nodeName=="string"},ve=function(d,m,w){!X[d]||Xo(X[d],function(E){E.call(e,m,w,Ye)})},nr=function(d){var m;if(ve("beforeSanitizeElements",d,null),$a(d)||q(/[\u0080-\uFFFF]/,d.nodeName))return pe(d),!0;var w=Le(d.nodeName);if(ve("uponSanitizeElement",d,{tagName:w,allowedTags:I}),d.hasChildNodes()&&!mt(d.firstElementChild)&&(!mt(d.content)||!mt(d.content.firstElementChild))&&q(/<[/\w]/g,d.innerHTML)&&q(/<[/\w]/g,d.textContent)||w==="select"&&q(/<template/i,d.innerHTML))return pe(d),!0;if(!I[w]||we[w]){if(!we[w]&&dr(w)&&(N.tagNameCheck instanceof RegExp&&q(N.tagNameCheck,w)||N.tagNameCheck instanceof Function&&N.tagNameCheck(w)))return!1;if(ti&&!Ke[w]){var E=ee(d)||d.parentNode,J=R(d)||d.childNodes;if(J&&E)for(var Q=J.length,U=Q-1;U>=0;--U)E.insertBefore(T(J[U],!0),F(d))}return pe(d),!0}return d instanceof l&&!Sa(d)||(w==="noscript"||w==="noembed")&&q(/<\/no(script|embed)/i,d.innerHTML)?(pe(d),!0):(We&&d.nodeType===3&&(m=d.textContent,m=xe(m,_e," "),m=xe(m,Te," "),d.textContent!==m&&(yt(e.removed,{element:d.cloneNode()}),d.textContent=m)),ve("afterSanitizeElements",d,null),!1)},lr=function(d,m,w){if(Yi&&(m==="id"||m==="name")&&(w in i||w in Ca))return!1;if(!(Xt&&!Zt[m]&&q(ht,m))){if(!(Ki&&q(ut,m))){if(!B[m]||Zt[m]){if(!(dr(d)&&(N.tagNameCheck instanceof RegExp&&q(N.tagNameCheck,d)||N.tagNameCheck instanceof Function&&N.tagNameCheck(d))&&(N.attributeNameCheck instanceof RegExp&&q(N.attributeNameCheck,m)||N.attributeNameCheck instanceof Function&&N.attributeNameCheck(m))||m==="is"&&N.allowCustomizedBuiltInElements&&(N.tagNameCheck instanceof RegExp&&q(N.tagNameCheck,w)||N.tagNameCheck instanceof Function&&N.tagNameCheck(w))))return!1}else if(!ii[m]){if(!q(Ae,xe(w,Ue,""))){if(!((m==="src"||m==="xlink:href"||m==="href")&&d!=="script"&&es(w,"data:")===0&&Xi[d])){if(!(qi&&!q(pt,xe(w,Ue,"")))){if(w)return!1}}}}}}return!0},dr=function(d){return d.indexOf("-")>0},cr=function(d){var m,w,E,J;ve("beforeSanitizeAttributes",d,null);var Q=d.attributes;if(!!Q){var U={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:B};for(J=Q.length;J--;){m=Q[J];var Ft=m,K=Ft.name,hr=Ft.namespaceURI;if(w=K==="value"?m.value:ts(m.value),E=Le(K),U.attrName=E,U.attrValue=w,U.keepAttr=!0,U.forceKeepAttr=void 0,ve("uponSanitizeAttribute",d,U),w=U.attrValue,!U.forceKeepAttr&&(ar(K,d),!!U.keepAttr)){if(q(/\/>/i,w)){ar(K,d);continue}We&&(w=xe(w,_e," "),w=xe(w,Te," "));var _a=Le(d.nodeName);if(!!lr(_a,E,w))try{hr?d.setAttributeNS(hr,K,w):d.setAttribute(K,w),Pr(e.removed)}catch{}}}ve("afterSanitizeAttributes",d,null)}},ka=function x(d){var m,w=sr(d);for(ve("beforeSanitizeShadowDOM",d,null);m=w.nextNode();)ve("uponSanitizeShadowNode",m,null),!nr(m)&&(m.content instanceof r&&x(m.content),cr(m));ve("afterSanitizeShadowDOM",d,null)};return e.sanitize=function(x,d){var m,w,E,J,Q;if(oi=!x,oi&&(x="<!-->"),typeof x!="string"&&!mt(x)){if(typeof x.toString!="function")throw yi("toString is not a function");if(x=x.toString(),typeof x!="string")throw yi("dirty is not a string, aborting")}if(!e.isSupported){if(Fe(a.toStaticHTML)==="object"||typeof a.toStaticHTML=="function"){if(typeof x=="string")return a.toStaticHTML(x);if(mt(x))return a.toStaticHTML(x.outerHTML)}return x}if(Jt||si(d),e.removed=[],typeof x=="string"&&(vt=!1),vt){if(x.nodeName){var U=Le(x.nodeName);if(!I[U]||we[U])throw yi("root node is forbidden and cannot be sanitized in-place")}}else if(x instanceof s)m=or("<!---->"),w=m.ownerDocument.importNode(x,!0),w.nodeType===1&&w.nodeName==="BODY"||w.nodeName==="HTML"?m=w:m.appendChild(w);else{if(!Qe&&!We&&!Me&&x.indexOf("<")===-1)return W&&Ot?W.createHTML(x):x;if(m=or(x),!m)return Qe?null:Ot?ye:""}m&&ei&&pe(m.firstChild);for(var Ft=sr(vt?x:m);E=Ft.nextNode();)E.nodeType===3&&E===J||nr(E)||(E.content instanceof r&&ka(E.content),cr(E),J=E);if(J=null,vt)return x;if(Qe){if(Et)for(Q=lt.call(m.ownerDocument);m.firstChild;)Q.appendChild(m.firstChild);else Q=m;return B.shadowroot&&(Q=ct.call(t,Q,!0)),Q}var K=Me?m.outerHTML:m.innerHTML;return Me&&I["!doctype"]&&m.ownerDocument&&m.ownerDocument.doctype&&m.ownerDocument.doctype.name&&q(us,m.ownerDocument.doctype.name)&&(K="<!DOCTYPE "+m.ownerDocument.doctype.name+`>
`+K),We&&(K=xe(K,_e," "),K=xe(K,Te," ")),W&&Ot?W.createHTML(K):K},e.setConfig=function(x){si(x),Jt=!0},e.clearConfig=function(){Ye=null,Jt=!1},e.isValidAttribute=function(x,d,m){Ye||si({});var w=Le(x),E=Le(d);return lr(w,E,m)},e.addHook=function(x,d){typeof d=="function"&&(X[x]=X[x]||[],yt(X[x],d))},e.removeHook=function(x){if(X[x])return Pr(X[x])},e.removeHooks=function(x){X[x]&&(X[x]=[])},e.removeAllHooks=function(){X={}},e}var xt=ha();function ua(a){switch(a){case"date":return"Published";case"reviewdate":return"Reviewed";case"addeddate":return"Added";default:return"Archived"}}function pa(a){return a?`Archivist since ${a.getFullYear()}`:""}function Di(a,e="short",t="en-US"){if(!a)return"";const i={timeZone:"UTC"};switch(e){case"short":i.month="short",i.year="numeric";break;case"long":i.year="numeric",i.month="short",i.day="2-digit";break}return new Intl.DateTimeFormat(t,i).format(a)}let le=class extends O{constructor(){super(...arguments),this.sortParam=null,this.collectionLinks=[]}updated(e){e.has("model")&&this.fetchCollectionNames()}async fetchCollectionNames(){var e,t;if(!(!((e=this.model)===null||e===void 0)&&e.collections)||this.model.collections.length===0||!this.collectionNameCache)return;this.collectionLinks=[];const i=[],r=[];for(const o of this.model.collections)r.push((t=this.collectionNameCache)===null||t===void 0?void 0:t.collectionNameFor(o).then(s=>{i.push(this.detailsLink(o,s!=null?s:o))}));await Promise.all(r),this.collectionLinks=i}render(){return p`
    ...
    `}get descriptionTemplate(){var e,t;return this.metadataTemplate(xt.sanitize((t=(e=this.model)===null||e===void 0?void 0:e.description)!==null&&t!==void 0?t:""),"","description")}metadataTemplate(e,t="",i){return e?p`
    ...
    `}};n([u({type:Object})],le.prototype,"model",void 0);n([u({type:String})],le.prototype,"baseNavigationUrl",void 0);n([u({type:Object})],le.prototype,"collectionNameCache",void 0);n([u({type:Number})],le.prototype,"currentWidth",void 0);n([u({type:Number})],le.prototype,"currentHeight",void 0);n([u({type:Object})],le.prototype,"sortParam",void 0);n([u({type:Number})],le.prototype,"mobileBreakpoint",void 0);n([M()],le.prototype,"collectionLinks",void 0);n([u({type:String})],le.prototype,"baseImageUrl",void 0);le=n([D("tile-list")],le);let be=class extends O{constructor(){super(...arguments),this.sortParam=null}render(){var e,t,i,r,o,s,l,c,h,v,g;return p`
      <div id="list-line" class="${this.classSize}">
        ...
        <div id="views">
          ${Ct((g=(v=this.model)===null||v===void 0?void 0:v.viewCount)!==null&&g!==void 0?g:0,this.formatSize)}
        </div>
      </div>
    ...
    `}};n([u({type:Object})],be.prototype,"model",void 0);n([u({type:String})],be.prototype,"baseNavigationUrl",void 0);n([u({type:Number})],be.prototype,"currentWidth",void 0);n([u({type:Number})],be.prototype,"currentHeight",void 0);n([u({type:Object})],be.prototype,"sortParam",void 0);n([u({type:Number})],be.prototype,"mobileBreakpoint",void 0);n([u({type:String})],be.prototype,"baseImageUrl",void 0);be=n([D("tile-list-compact")],be);let it=class extends O{constructor(){super(...arguments),this.sortParam=null}render(){var e;return p`
      <div id="list-line-header" class="${this.classSize}">
        ...
        <div id="date">${ua((e=this.sortParam)===null||e===void 0?void 0:e.field)}</div>
        <div id="icon"></div>
    ...
    `}};Ir=n([D("collection-browser-loading-tile")],Ir);var L;(function(a){a.relevance="relevance",a.views="views",a.title="title",a.datearchived="datearchived",a.date="date",a.datereviewed="datereviewed",a.dateadded="dateadded",a.creator="creator"})(L||(L={}));const wt={relevance:"Relevance",views:"Views",title:"Title",datearchived:"Date Archived",date:"Date Published",datereviewed:"Date Reviewed",dateadded:"Date Added",creator:"Creator"},ms={relevance:null,views:"week",title:"titleSorter",datearchived:"publicdate",date:"date",datereviewed:"reviewdate",dateadded:"addeddate",creator:"creatorSorter"},Br={titleSorter:L.title,date:L.date,publicdate:L.datearchived,reviewdate:L.datereviewed,addeddate:L.dateadded,creatorSorter:L.creator,week:L.views},Mt={subject:{},mediatype:{},language:{},creator:{},collection:{},year:{}};let Gt=class extends O{constructor(){super(...arguments),this.selectedLetter=null,this.alphabet="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("")}get selectedUppercaseLetter(){var e;return(e=this.selectedLetter)===null||e===void 0?void 0:e.toUpperCase()}render(){return p`
      <div id="container">
        <ul>
    ...
    `}letterClicked(e){e===this.selectedUppercaseLetter?this.selectedLetter=null:this.selectedLetter=e,this.dispatchEvent(new CustomEvent("letterChanged",{detail:{selectedLetter:this.selectedUppercaseLetter}}))}};Gt.styles=f`
    h1 {
      font-size: 1.2rem;
    }
  ...
  `;n([u({type:String})],Gt.prototype,"selectedLetter",void 0);Gt=n([D("alpha-bar")],Gt);const Hr=P`
...
`;let j=class extends O{constructor(){super(...arguments),this.sortDirection=null,this.selectedSort=L.relevance,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.showRelevance=!0,this.alphaSelectorVisible=null,this.dateSortSelectorVisible=!1,this.desktopSelectorBarWidth=0,this.selectorBarContainerWidth=0,this.hoveringOverDateSortOptions=!1,this.boundDateSelectorEscapeListener=e=>{e.key==="Escape"&&(this.dateSortSelectorVisible=!1)}}render(){return p`
    ...
    `}getSortDisplayOption(e,t){var i,r;const o=(i=t==null?void 0:t.isSelected)!==null&&i!==void 0?i:()=>this.selectedSort===e,s=(r=t==null?void 0:t.displayName)!==null&&r!==void 0?r:wt[e];return p`
      <a
        href="#"
...
`;let H=class extends O{constructor(){super(...arguments),this.prompt="Do you find this feature useful?",this.buttonText="Beta",this.isOpen=!1,this.processing=!1,this.popupTopX=0,this.popupTopY=0,this.voteSubmitted=!1,this.voteNeedsChoosing=!1,this.resizingElement=document.body}render(){return p`
    ...
    `}};n([u({type:String})],H.prototype,"featureIdentifier",void 0);n([u({type:String})],H.prototype,"prompt",void 0);n([u({type:String})],H.prototype,"buttonText",void 0);n([u({type:Object})],H.prototype,"recaptchaManager",void 0);n([u({type:Object})],H.prototype,"resizeObserver",void 0);n([u({type:Boolean})],H.prototype,"disabled",void 0);n([u({type:Object})],H.prototype,"featureFeedbackService",void 0);n([Z("#beta-button")],H.prototype,"betaButton",void 0);n([Z("#popup")],H.prototype,"popup",void 0);n([M()],H.prototype,"isOpen",void 0);n([M()],H.prototype,"processing",void 0);n([M()],H.prototype,"popupTopX",void 0);n([M()],H.prototype,"popupTopY",void 0);n([M()],H.prototype,"vote",void 0);n([M()],H.prototype,"voteSubmitted",void 0);n([M()],H.prototype,"error",void 0);n([M()],H.prototype,"voteNeedsChoosing",void 0);n([M()],H.prototype,"recaptchaWidget",void 0);n([Z("#comments")],H.prototype,"comments",void 0);H=n([D("feature-feedback")],H);class va{constructor(e){var t,i,r,o,s,l;this.title=e==null?void 0:e.title,this.subtitle=e==null?void 0:e.subtitle,this.headline=e==null?void 0:e.headline,this.message=e==null?void 0:e.message,this.headerColor=(t=e==null?void 0:e.headerColor)!==null&&t!==void 0?t:"#55A183",this.bodyColor=(i=e==null?void 0:e.bodyColor)!==null&&i!==void 0?i:"#f5f5f7",this.showProcessingIndicator=(r=e==null?void 0:e.showProcessingIndicator)!==null&&r!==void 0?r:!1,this.processingImageMode=(o=e==null?void 0:e.processingImageMode)!==null&&o!==void 0?o:"complete",this.showCloseButton=(s=e==null?void 0:e.showCloseButton)!==null&&s!==void 0?s:!0,this.closeOnBackdropClick=(l=e==null?void 0:e.closeOnBackdropClick)!==null&&l!==void 0?l:!0}}const ys=Object.freeze({processing:"processing",complete:"complete"});class ws extends O{static get properties(){return{mode:{type:String}}}constructor(){super(),this.mode=ys.processing}render(){return p`
      <div class="${this.mode}">
        <svg
          viewBox="0 0 120 120"
    ...
    `}}window.customElements.define("ia-activity-indicator",ws);var Cs=p`
<svg
  viewBox="0 0 40 40"
  version="1.1"
  xmlns="http://www.w3.org/2000/svg"
...
`;let Ii=class extends O{constructor(){super(...arguments),this.config=new va}render(){return p`
    ...
    `}};n([u({type:Object})],Ii.prototype,"config",void 0);Ii=n([D("modal-template")],Ii);function Ss(a,e,t,i){var r,o=!1,s=0;function l(){r&&clearTimeout(r)}function c(){l(),o=!0}typeof e!="boolean"&&(i=t,t=e,e=void 0);function h(){for(var v=arguments.length,g=new Array(v),b=0;b<v;b++)g[b]=arguments[b];var S=this,$=Date.now()-s;if(o)return;function T(){s=Date.now(),t.apply(S,g)}function F(){r=void 0}i&&!r&&T(),l(),i===void 0&&$>a?T():e!==!0&&(r=setTimeout(i?F:T,i===void 0?a-$:a))}return h.cancel=c,h}var De;(function(a){a.Open="open",a.Closed="closed"})(De||(De={}));class $s{constructor(e){this.windowResizeThrottler=Ss(100,!1,this.updateModalContainerHeight).bind(this),this.modalManager=e}handleModeChange(e){switch(e){case De.Open:this.startResizeListener(),this.stopDocumentScroll();break;case De.Closed:this.stopResizeListener(),this.resumeDocumentScroll();break}}updateModalContainerHeight(){this.modalManager.style.setProperty("--containerHeight",`${window.innerHeight}px`)}stopDocumentScroll(){document.body.classList.add("modal-manager-open")}resumeDocumentScroll(){document.body.classList.remove("modal-manager-open")}startResizeListener(){window.addEventListener("resize",this.windowResizeThrottler)}stopResizeListener(){window.removeEventListener("resize",this.windowResizeThrottler)}}let rt=class extends O{constructor(){super(...arguments),this.mode=De.Closed,this.hostBridge=new $s(this),this.closeOnBackdropClick=!0}render(){return p`
      <div class="container">
    ...
    `}};n([u({type:String,reflect:!0})],rt.prototype,"mode",void 0);n([u({type:Object})],rt.prototype,"customModalContent",void 0);n([u({type:Object})],rt.prototype,"hostBridge",void 0);n([Z("modal-template")],rt.prototype,"modalTemplate",void 0);rt=n([D("modal-manager")],rt);var ks=P`
...
`,ma=P`<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><path d="m79.8883285 50.0035012.1116715-.1085359-43.1159942-46.61088155c-2.401537-2.18938917-4.6902018-3.28408375-6.8659943-3.28408375s-4.1642651.63837733-5.9654178 1.91513199c-1.8011528 1.27675467-3.1520173 2.97248092-4.0525937 5.08717877l39.4020173 42.99768924-39.4020173 42.9976892c.9005764 2.1146979 2.2514409 3.8104241 4.0525937 5.0871788 1.8011527 1.2767547 3.7896253 1.915132 5.9654178 1.915132 2.1013449 0 4.3900096-1.0573489 6.8659943-3.1720468l43.1159942-46.7194174z"/></svg>
`;let G=class extends O{constructor(){super(...arguments),this.aggr=[],this.castedBuckets=[],this.allFacetGroups=[],this.pageNumber=1,this.loading=1,this.facetsPerPage=25}async updated(e){e.has("facetKey")&&(this.loading=1,this.pageNumber=1,await this.fetchSpecificFacets(this.facetAggregationKey),this.loading=0),e.has("aggr")&&this.filterFacets()}async fetchSpecificFacets(e){var t,i;const r={advancedParams:[{field:e,size:1e3}]},o={query:this.fullQuery,fields:["identifier"],aggregations:r,rows:1},s=await((t=this.searchService)===null||t===void 0?void 0:t.search(o));this.aggr=(i=s==null?void 0:s.success)===null||i===void 0?void 0:i.response.aggregations}async filterFacets(){var e;Object.entries((e=this.aggr)!==null&&e!==void 0?e:[]).forEach(([t,i])=>{t!=="year_histogram"&&(this.castedBuckets=i.buckets)})}get renderPaginations(){const e=[],t=Object.keys(this.castedBuckets).length,i=Math.ceil(t/this.facetsPerPage),r=s=>{this.pageClick(s)};let o=1;for(o=1;o<=i;o+=1)this.pageNumber===o?e.push(p`<button
            class="page-number current-page"
            @click="${r}"
          >
            ${o}
          </button>`):e.push(p`<button class="page-number" @click="${r}">
            ${o}
          </button>`);return e}pageClick(e){e.stopPropagation(),e.preventDefault();const t=e.target,{textContent:i}=t;i&&(this.pageNumber=Number(i))}get renderMoreFacets(){var e;const t=(this.pageNumber-1)*this.facetsPerPage,i=t+this.facetsPerPage-1;return this.loading=0,p`<ul class="facet-list">
      ${(e=this.castedBuckets)===null||e===void 0?void 0:e.map((r,o)=>{const s=o>=t&&o<=i?"farow":"farow hidden";return p` <li class=${s}>
          <div class="facet-row">
    ...
    </ul>`}facetClicked(e){const{selectedFacets:t}=this,i=e.target,{checked:r,value:o,dataset:s}=i,l=s.facet;let c;t?c=oe({},t):c=Mt,r?c[l][o]="selected":delete c[l][o],this.selectedFacets=c}get loaderTemplate(){return this.loading?p`<div class="loading">
          loading facets...
    ...
    `}};n([u({type:String})],G.prototype,"facetKey",void 0);n([u({type:String})],G.prototype,"facetAggregationKey",void 0);n([u({type:String})],G.prototype,"fullQuery",void 0);n([u({type:Object})],G.prototype,"modalManager",void 0);n([u({type:Object})],G.prototype,"searchService",void 0);n([u({type:Object})],G.prototype,"selectedFacets",void 0);n([u({type:Object,attribute:!1})],G.prototype,"aggr",void 0);n([u({type:Object})],G.prototype,"castedBuckets",void 0);n([u({type:Object})],G.prototype,"selectedFacet",void 0);n([u({type:Object})],G.prototype,"languageCodeHandler",void 0);n([u({type:Object})],G.prototype,"allFacetGroups",void 0);n([M()],G.prototype,"pageNumber",void 0);n([M()],G.prototype,"loading",void 0);n([u({type:Object})],G.prototype,"collectionNameCache",void 0);G=n([D("facets-more-content")],G);const Ts=["mediatype","year","subject","collection","creator","language"],$i={subjectSorter:"subject",mediatypeSorter:"mediatype",languageSorter:"language",creatorSorter:"creator",collection:"collection",year:"year"},ki={subject:"Subject",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"};let V=class extends O{constructor(){super(...arguments),this.facetsLoading=!1,this.fullYearAggregationLoading=!1,this.collapsableFacets=!1,this.showHistogramDatePicker=!1,this.openFacets={subject:!1,mediatype:!1,language:!1,creator:!1,collection:!1,year:!1}}render(){return p`
    ...
    `}updated(e){e.has("selectedFacets")&&this.dispatchFacetsChangedEvent()}dispatchFacetsChangedEvent(){const e=new CustomEvent("facetsChanged",{detail:this.selectedFacets});this.dispatchEvent(e)}get currentYearsHistogramAggregation(){var e;return(e=this.aggregations)===null||e===void 0?void 0:e.year_histogram}get histogramTemplate(){const{fullYearsHistogramAggregation:e}=this;return p`
      ...
      ></histogram-date-range>
    `}histogramDateRangeUpdated(e){const{minDate:t,maxDate:i}=e.detail,r=new CustomEvent("histogramDateRangeUpdated",{detail:{minDate:t,maxDate:i}});this.dispatchEvent(r)}get mergedFacets(){const e=[];return Ts.forEach(t=>{var i;const r=this.selectedFacetGroups.find(c=>c.key===t),o=this.aggregationFacetGroups.find(c=>c.key===t);if(r&&!o){e.push(r);return}if(!o)return;const s=r!=null?r:o,l=(i=r==null?void 0:r.buckets.map(c=>{const h=o.buckets.find(v=>v.key===c.key);return h?gt(oe({},c),{count:h.count}):c}))!==null&&i!==void 0?i:[];o.buckets.forEach(c=>{l.find(v=>v.key===c.key)||l.push(c)}),s.buckets=l.splice(0,5),e.push(s)}),e}get selectedFacetGroups(){return this.selectedFacets?Object.entries(this.selectedFacets).map(([t,i])=>{const r=t,o=ki[r],s=Object.entries(i).map(([l,c])=>{var h,v;let g=l;return r==="language"&&(g=(v=(h=this.languageCodeHandler)===null||h===void 0?void 0:h.getLanguageNameFromCodeString(l))!==null&&v!==void 0?v:l),{displayText:g,key:l,count:0,state:c}});return{title:o,key:r,buckets:s}}):[]}get aggregationFacetGroups(){var e;const t=[];return Object.entries((e=this.aggregations)!==null&&e!==void 0?e:[]).forEach(([i,r])=>{if(i==="year_histogram")return;const o=this.getFacetOptionFromKey(i),s=ki[o],c=r.buckets.map(v=>{var g,b;let S=v.key;return o==="language"&&(S=(b=(g=this.languageCodeHandler)===null||g===void 0?void 0:g.getCodeStringFromLanguageName(`${v.key}`))!==null&&b!==void 0?b:v.key),{displayText:`${v.key}`,key:`${S}`,count:v.doc_count,state:"none"}}),h={title:s,key:o,buckets:c};t.push(h)}),t}getFacetGroupTemplate(e){if(e.buckets.length===0)return k;const{key:t}=e,i=this.openFacets[t],r=p`
      <span class="collapser ${i?"open":""}"> ${ma} </span>
    `;return p`
    ...
    >
      More...
    </button>`}async emitMoreLinkClickedEvent(e){const t=new va;t.closeOnBackdropClick=!0,t.headline=p`<span
        style="display:block;text-align:left;font-size:2rem;padding-left:1rem;"
      >
        ${ki[e.key]}
      </span>
      <hr />`;const i=Object.keys($i).find(r=>$i[r]===e.key);t.message=p`
      <facets-more-content
        .facetKey=${e.key}
    ...
    `,this.modalManager.showModal({config:t})}getFacetTemplate(e){const i=e.buckets.filter(r=>r.key.startsWith("fav-")===!1).slice(0,6);return p`
      <ul class="facet-list">
        ${la(i,r=>`${e.key}:${r.key}`,r=>{var o,s;const l=`${e.key}:${r.key}-show-only`,c=`${e.key}:${r.key}-negative`,h=e.key!=="collection"?p`${(o=r.displayText)!==null&&o!==void 0?o:r.key}`:p`
    ...
    `}facetClicked(e,t,i){const r=e.target,{checked:o,name:s,value:l}=r;o?this.facetChecked(s,l,i):this.facetUnchecked(s,l)}facetChecked(e,t,i){const{selectedFacets:r}=this;let o;r?o=oe({},r):o=Mt,o[e][t]=i?"hidden":"selected",this.selectedFacets=o}facetUnchecked(e,t){const{selectedFacets:i}=this;let r;i?r=oe({},i):r=Mt,delete r[e][t],this.selectedFacets=r}getFacetOptionFromKey(e){const r=e.split("__")[2].split(":")[1],o=Object.entries($i).find(([l])=>r.includes(l)),s=o==null?void 0:o[1];if(!s)throw new Error(`Could not find facet option for key: ${e}`);return s}static get styles(){return f`
      #container.loading {
        opacity: 0.5;
      }
  ...
  `;n([M()],ie.prototype,"currentPage",void 0);n([M()],ie.prototype,"searchQuery",void 0);n([M()],ie.prototype,"cellWidth",void 0);n([M()],ie.prototype,"cellHeight",void 0);n([M()],ie.prototype,"rowGap",void 0);n([M()],ie.prototype,"colGap",void 0);n([M()],ie.prototype,"loggedIn",void 0);n([Z("#base-query-field")],ie.prototype,"baseQueryField",void 0);n([Z("#page-number-input")],ie.prototype,"pageNumberInput",void 0);n([Z("collection-browser")],ie.prototype,"collectionBrowser",void 0);ie=n([D("app-root")],ie);
