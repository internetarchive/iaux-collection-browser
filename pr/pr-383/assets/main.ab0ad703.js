...
`;function xn(r,e){let t=1;return r>=1e9?t=1e9:r>=1e6?t=1e6:r>=1e3&&e==="short"&&(t=1e3),t}function $n(r=0,e){const t=r/e,i=t<10;let o=0;return i?o=Math.round((t+Number.EPSILON)*10)/10:o=Math.round(t),o}function _n(r,e,t,i){switch(e){case 1e9:return P(t==="short"?nt`${r}B`:nt`${r} billion`);case 1e6:return P(t==="short"?nt`${r}M`:nt`${r} million`);case 1e3:return P(t==="short"?nt`${r}K`:nt`${r} thousand`);default:return new Intl.NumberFormat(i).format(r)}}function ri(r,e="long",t="short",i="en-US"){const o=r!=null?r:-1;if(o<0)return"";const a=xn(o,e),s=$n(o,a);return _n(s,a,t,i)}let Ye=class extends F{render(){var e,t,i,o,a;const s=ri(this.favCount,"short","short"),n=ri(this.commentCount,"short","short"),d=this.mediatype==="account"?`${(e=this.itemCount)!==null&&e!==void 0?e:0} uploads`:`${(t=this.viewCount)!==null&&t!==void 0?t:0} ${(i=this.viewLabel)!==null&&i!==void 0?i:"all-time views"}`;return c`
 ...
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ua=r=>r!=null?r:ie;var bd=Rs`<svg class="caret-up-svg" viewBox="0 0 8 4" xmlns="http://www.w3.org/2000/svg">
<path d="m6.7226499 3.51689722c.22976435.15317623.54019902.0910893.69337525-.13867505.13615665-.20423497.10222882-.47220946-.06836249-.63681849l-.07031256-.05655675-3.2773501-2.18490007-3.2773501 2.18490007c-.22976434.15317623-.29185128.4636109-.13867505.69337524.13615665.20423498.39656688.27598409.61412572.18182636l.07924953-.04315131 2.7226499-1.81402514z"
  fill=""></path>
</svg>`,yd=Rs`<svg class="caret-down-svg" viewBox="0 0 8 4" xmlns="http://www.w3.org/2000/svg">
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Ha(r,e,t){return r?e():t==null?void 0:t()}const Va=f`var(--white, #fff)`,kd=f`var(--primaryDisableCTAFill, #767676)`,Td=f`var(--secondaryCTABorder, #999)`,Ed=f`var(--primaryCTAFill, #194880)`,Bo=f`var(--primaryCTAFillRGB, 25, 72, 128)`,Md=f`var(--primaryCTABorder, #c5d1df)`,zd=f`var(--primaryErrorCTAFill, #d9534f)`,Ro=f`var(--primaryErrorCTAFillRGB, 229, 28, 38)`,Pd=f`var(--primaryErrorCTABorder, #d43f3a)`,Ad=f`var(--secondaryCTAFill, #333)`,Fo=f`var(--secondaryCTAFillRGB, 51, 51, 51)`,Ld=f`var(--primaryCTABorder, #979797)`,Dd=f`#ee8950`,Bd=f`#ec7939`;var Rd=f`
  .ia-button {
    min-height: 3rem;
    cursor: pointer;
    color: ${Va};
...
`,fr;let Nt=fr=class extends F{render(){return c`${this.facetRowTemplate}`}get facetRowTemplate(){var e,t,i,o;const{bucket:a,facetType:s}=this;if(!a||!s)return y;const n=`${s}:${a.key}-show-only`,d=`${s}:${a.key}-negative`,p=s!=="collection"?c`${(e=a.displayText)!==null&&e!==void 0?e:a.key}`:c`<a href="/details/${a.key}">
    ...
    `}};Ya=l([D("facet-tombstone-row")],Ya);let Oe=class extends F{constructor(){super(...arguments),this.boundEscapeListener=e=>{e.key==="Escape"&&this.closeModal()}}render(){var e,t;return c`
      <div id="container">
