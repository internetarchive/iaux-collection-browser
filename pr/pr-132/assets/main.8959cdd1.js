 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function he(r,e){return ro({descriptor:t=>{const i={get(){var a,o;return(o=(a=this.renderRoot)===null||a===void 0?void 0:a.querySelector(r))!==null&&o!==void 0?o:null},enumerable:!0,configurable:!0};if(e){const a=typeof t=="symbol"?Symbol():"__"+t;i.get=function(){var o,s;return this[a]===void 0&&(this[a]=(s=(o=this.renderRoot)===null||o===void 0?void 0:o.querySelector(r))!==null&&s!==void 0?s:null),this[a]}}return i}})}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */const gr=(r,e,t)=>{const i=new Map;for(let a=e;a<=t;a++)i.set(r[a],a);return i},so=za(class extends Ma{constructor(r){if(super(r),r.type!==De.CHILD)throw Error("repeat() can only be used in text expressions")}dt(r,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);const a=[],o=[];let s=0;for(const l of r)a[s]=i?i(l,s):s,o[s]=t(l,s),s++;return{values:o,keys:a}}render(r,e,t){return this.dt(r,e,t).values}update(r,[e,t,i]){var a;const o=gs(r),{values:s,keys:l}=this.dt(e,t,i);if(!Array.isArray(o))return this.ut=l,s;const d=(a=this.ut)!==null&&a!==void 0?a:this.ut=[],c=[];let u,v,f=0,w=o.length-1,x=0,$=s.length-1;for(;f<=w&&x<=$;)if(o[f]===null)f++;else if(o[w]===null)w--;else if(d[f]===l[x])c[x]=Ge(o[f],s[x]),f++,x++;else if(d[w]===l[$])c[$]=Ge(o[w],s[$]),w--,$--;else if(d[f]===l[$])c[$]=Ge(o[f],s[$]),Ht(r,c[$+1],o[f]),f++,$--;else if(d[w]===l[x])c[x]=Ge(o[w],s[x]),Ht(r,o[f],o[w]),w--,x++;else if(u===void 0&&(u=gr(l,x,$),v=gr(d,f,w)),u.has(d[f]))if(u.has(d[w])){const A=v.get(l[x]),E=A!==void 0?o[A]:null;if(E===null){const F=Ht(r,o[f]);Ge(F,s[x]),c[x]=F}else c[x]=Ge(E,s[x]),Ht(r,o[f],E),o[A]=null;x++}else qi(o[w]),w--;else qi(o[f]),f++;for(;x<=$;){const A=Ht(r,c[$+1]);Ge(A,s[x]),c[x++]=A}for(;f<=w;){const A=o[f++];A!==null&&qi(A)}return this.ut=l,oo(r,c),ge}});function oi(r,e,t){return Array.from({length:(e-r)/t+1},(i,a)=>r+a*t)}let Ne=class extends O{constructor(){super(...arguments),this.itemCount=0,this.scrollOptimizationsDisabled=!1,this.intersectionObserver=new IntersectionObserver(e=>{e.forEach(t=>{if(t.target===this.sentinel){t.isIntersecting&&this.dispatchEvent(new Event("scrollThresholdReached"));return}const a=t.target.dataset.cellIndex;if(!a)return;const o=parseInt(a,10);t.isIntersecting?this.visibleCellIndices.add(o):this.visibleCellIndices.delete(o)}),this.scrollOptimizationsDisabled||this.processVisibleCells()}),this.renderedCellIndices=new Set,this.visibleCellIndices=new Set,this.placeholderCellIndices=new Set}reload(){oi(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.removeCell(t)),this.renderedCellIndices.clear(),this.visibleCellIndices.clear(),this.placeholderCellIndices.clear(),this.setupObservations()}scrollToCell(e,t){const i=this.cellContainers[e];if(!i)return!1;const a=t?"smooth":"auto";return i.scrollIntoView({behavior:a}),!0}getVisibleCellIndices(){return Array.from(this.visibleCellIndices)}updated(e){(e.has("itemCount")||e.has("scrollOptimizationsDisabled"))&&this.setupObservations()}disconnectedCallback(){this.intersectionObserver.disconnect()}setupObservations(){this.setupIntersectionObserver()}setupIntersectionObserver(){this.intersectionObserver.disconnect(),this.sentinel&&this.intersectionObserver.observe(this.sentinel),this.scrollOptimizationsDisabled?(oi(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.visibleCellIndices.add(t)),this.processVisibleCells()):this.cellContainers.forEach(e=>this.intersectionObserver.observe(e))}render(){const e=this.itemCount-1,t=oi(0,e,1);return m`
    ...
    `}};n([p({type:Number})],Ne.prototype,"itemCount",void 0);n([p({type:Object})],Ne.prototype,"cellProvider",void 0);n([p({type:Object})],Ne.prototype,"placeholderCellTemplate",void 0);n([p({type:Boolean})],Ne.prototype,"scrollOptimizationsDisabled",void 0);n([he("#sentinel")],Ne.prototype,"sentinel",void 0);n([hs(".cell-container")],Ne.prototype,"cellContainers",void 0);Ne=n([N("infinite-scroller")],Ne);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;let ki=class extends O{constructor(){super(...arguments),this.placeholderType=null}render(){return this.placeholderType?m`${this.placeholderTemplate}`:S}get placeholderTemplate(){return m`
    ...
    `}get facetsTemplate(){return m`
      ...
      <collection-facets
        ...
        .moreLinksVisible=${this.previousSearchType!==oe.FULLTEXT}
        .minSelectedDate=${this.minSelectedDate}
        .maxSelectedDate=${this.maxSelectedDate}
        .selectedFacets=${this.selectedFacets}
        .collectionNameCache=${this.collectionNameCache}
  ...
  `;n([p({type:String})],M.prototype,"baseNavigationUrl",void 0);n([p({type:String})],M.prototype,"baseImageUrl",void 0);n([p({type:Object})],M.prototype,"searchService",void 0);n([p({type:String})],M.prototype,"searchType",void 0);n([p({type:String})],M.prototype,"baseQuery",void 0);n([p({type:String})],M.prototype,"displayMode",void 0);n([p({type:Object})],M.prototype,"sortParam",void 0);n([p({type:String})],M.prototype,"selectedSort",void 0);n([p({type:String})],M.prototype,"selectedTitleFilter",void 0);n([p({type:String})],M.prototype,"selectedCreatorFilter",void 0);n([p({type:String})],M.prototype,"sortDirection",void 0);n([p({type:String})],M.prototype,"dateRangeQueryClause",void 0);n([p({type:Number})],M.prototype,"pageSize",void 0);n([p({type:Object})],M.prototype,"resizeObserver",void 0);n([p({type:String})],M.prototype,"titleQuery",void 0);n([p({type:String})],M.prototype,"creatorQuery",void 0);n([p({type:Number})],M.prototype,"currentPage",void 0);n([p({type:String})],M.prototype,"minSelectedDate",void 0);n([p({type:String})],M.prototype,"maxSelectedDate",void 0);n([p({type:Object})],M.prototype,"selectedFacets",void 0);n([p({type:Boolean})],M.prototype,"showHistogramDatePicker",void 0);n([p({type:String,reflect:!0})],M.prototype,"searchContext",void 0);n([p({type:Object})],M.prototype,"collectionNameCache",void 0);n([p({type:String})],M.prototype,"pageContext",void 0);n([p({type:Object})],M.prototype,"restorationStateHandler",void 0);n([p({type:Number})],M.prototype,"mobileBreakpoint",void 0);n([p({type:Boolean})],M.prototype,"loggedIn",void 0);n([p({type:Object})],M.prototype,"modalManager",void 0);n([p({type:Boolean})],M.prototype,"isManageView",void 0);n([T()],M.prototype,"pagesToRender",void 0);n([T()],M.prototype,"searchResultsLoading",void 0);n([T()],M.prototype,"facetsLoading",void 0);n([T()],M.prototype,"lendingFacetLoading",void 0);n([T()],M.prototype,"fullYearAggregationLoading",void 0);n([T()],M.prototype,"aggregations",void 0);n([T()],M.prototype,"fullYearsHistogramAggregation",void 0);n([T()],M.prototype,"previousSearchType",void 0);n([T()],M.prototype,"totalResults",void 0);n([T()],M.prototype,"mobileView",void 0);n([T()],M.prototype,"mobileFacetsVisible",void 0);n([T()],M.prototype,"placeholderType",void 0);n([he("#content-container")],M.prototype,"contentContainer",void 0);n([p({type:Object,attribute:!1})],M.prototype,"analyticsHandler",void 0);n([he("infinite-scroller")],M.prototype,"infiniteScroller",void 0);M=n([N("collection-browser")],M);let se=class extends O{constructor(){super(...arguments),this.searchService=this.initSearchServiceFromUrlParams(),this.resizeObserver=new ps,this.localCache=new as,this.collectionNameCache=new us({searchService:this.searchService,localCache:this.localCache}),this.cellWidth=18,this.cellHeight=29,this.rowGap=1.7,this.colGap=1.7,this.loggedIn=!1,this.searchType=oe.METADATA,this.analyticsManager=new Ro,this.analyticsHandler={sendPing:this.sendAnalytics.bind(this),sendEvent:this.sendAnalytics.bind(this),sendEventNoSampling:this.sendAnalytics.bind(this)}}sendAnalytics(e){var t;console.log("Analytics Received ----",e),this.latestAction=e,(t=this.analyticsManager)===null||t===void 0||t.sendEventNoSampling(e)}initSearchServiceFromUrlParams(){var e,t,i;const a=new URL(window.location.href).searchParams;return new Ie({baseUrl:(e=a.get("search_base_url"))!==null&&e!==void 0?e:void 0,servicePath:(t=a.get("search_service_path"))!==null&&t!==void 0?t:void 0,debuggingEnabled:(i=!!a.get("debugging"))!==null&&i!==void 0?i:void 0})}searchPressed(e){var t,i;e.preventDefault(),this.searchQuery=this.baseQueryField.value,((t=this.currentPage)!==null&&t!==void 0?t:1)>1&&this.collectionBrowser.goToPage((i=this.currentPage)!==null&&i!==void 0?i:1)}changePagePressed(e){e.preventDefault(),this.currentPage=this.pageNumberInput.valueAsNumber,this.collectionBrowser.goToPage(this.currentPage)}updated(e){e.has("currentPage")&&this.currentPage&&(this.pageNumberInput.value=this.currentPage.toString()),e.has("searchQuery")&&this.queryUpdated()}queryUpdated(){this.collectionBrowser.baseQuery=this.searchQuery}render(){var e,t,i;return m`
      <div id="dev-tools">
        ...
        <div id="search-types">
          ...
          <span class="search-type">
            <input
              ...
              name="search-type"
              value="metadata"
              ?checked=${((t=this.collectionBrowser)===null||t===void 0?void 0:t.searchType)===oe.METADATA}
          ...
          <span class="search-type">
            <input
              ...
              name="search-type"
              value="fulltext"
              ?checked=${((i=this.collectionBrowser)===null||i===void 0?void 0:i.searchType)===oe.FULLTEXT}
              @click=${this.searchTypeChanged}
            />
        ...
        <div id="toggle-controls">
          <button
            @click=${()=>{var a,o;const s=(a=this.shadowRoot)===null||a===void 0?void 0:a.getElementById("cell-size-control");s==null||s.classList.toggle("hidden");const l=(o=this.shadowRoot)===null||o===void 0?void 0:o.getElementById("cell-gap-control");l==null||l.classList.toggle("hidden")}}
          >
            Toggle Cell Controls
          </button>
          <button
            @click=${()=>{var a;const o=(a=this.shadowRoot)===null||a===void 0?void 0:a.getElementById("latest-event-details");o==null||o.classList.toggle("hidden")}}
          >
            Last Event Captured
          </button>
        </div>
  ...
  `;n([T()],se.prototype,"currentPage",void 0);n([T()],se.prototype,"searchQuery",void 0);n([T()],se.prototype,"cellWidth",void 0);n([T()],se.prototype,"cellHeight",void 0);n([T()],se.prototype,"rowGap",void 0);n([T()],se.prototype,"colGap",void 0);n([T()],se.prototype,"loggedIn",void 0);n([T()],se.prototype,"searchType",void 0);n([p({type:Object,reflect:!1})],se.prototype,"latestAction",void 0);n([he("#base-query-field")],se.prototype,"baseQueryField",void 0);n([he("#page-number-input")],se.prototype,"pageNumberInput",void 0);n([he("collection-browser")],se.prototype,"collectionBrowser",void 0);n([he("modal-manager")],se.prototype,"modalManager",void 0);se=n([N("app-root")],se);
