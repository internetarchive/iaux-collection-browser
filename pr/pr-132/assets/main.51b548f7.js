 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var qi;const kt=globalThis.trustedTypes,dr=kt?kt.createPolicy("lit-html",{createHTML:r=>r}):void 0,Ee=`lit$${(Math.random()+"").slice(9)}$`,Ea="?"+Ee,ls=`<${Ea}>`,Tt=document,Jt=(r="")=>Tt.createComment(r),ei=r=>r===null||typeof r!="object"&&typeof r!="function",Kr=Array.isArray,qr=r=>{var e;return Kr(r)||typeof((e=r)===null||e===void 0?void 0:e[Symbol.iterator])=="function"},Vt=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,cr=/-->/g,hr=/>/g,Qe=/>|[ 	\n\r](?:([^\s"'>=/]+)([ 	\n\r]*=[ 	\n\r]*(?:[^ 	\n\r"'`<>=]|("|')|))|$)/g,ur=/'/g,pr=/"/g,Xr=/^(?:script|style|textarea|title)$/i,Zr=r=>(e,...t)=>({_$litType$:r,strings:e,values:t}),m=Zr(1),I=Zr(2),ge=Symbol.for("lit-noChange"),_=Symbol.for("lit-nothing"),mr=new WeakMap,mi=(r,e,t)=>{var i,a;const o=(i=t==null?void 0:t.renderBefore)!==null&&i!==void 0?i:e;let s=o._$litPart$;if(s===void 0){const l=(a=t==null?void 0:t.renderBefore)!==null&&a!==void 0?a:null;o._$litPart$=s=new Ot(e.insertBefore(Jt(),l),l,void 0,t!=null?t:{})}return s._$AI(r),s},$t=Tt.createTreeWalker(Tt,129,null,!1),Jr=(r,e)=>{const t=r.length-1,i=[];let a,o=e===2?"<svg>":"",s=Vt;for(let d=0;d<t;d++){const c=r[d];let p,v,f=-1,w=0;for(;w<c.length&&(s.lastIndex=w,v=s.exec(c),v!==null);)w=s.lastIndex,s===Vt?v[1]==="!--"?s=cr:v[1]!==void 0?s=hr:v[2]!==void 0?(Xr.test(v[2])&&(a=RegExp("</"+v[2],"g")),s=Qe):v[3]!==void 0&&(s=Qe):s===Qe?v[0]===">"?(s=a!=null?a:Vt,f=-1):v[1]===void 0?f=-2:(f=s.lastIndex-v[2].length,p=v[1],s=v[3]===void 0?Qe:v[3]==='"'?pr:ur):s===pr||s===ur?s=Qe:s===cr||s===hr?s=Vt:(s=Qe,a=void 0);const x=s===Qe&&r[d+1].startsWith("/>")?" ":"";o+=s===Vt?c+ls:f>=0?(i.push(p),c.slice(0,f)+"$lit$"+c.slice(f)+Ee+x):c+Ee+(f===-2?(i.push(void 0),d):x)}const l=o+(r[t]||"<?>")+(e===2?"</svg>":"");if(!Array.isArray(r)||!r.hasOwnProperty("raw"))throw Error("invalid template strings array");return[dr!==void 0?dr.createHTML(l):l,i]};class ti{constructor({strings:e,_$litType$:t},i){let a;this.parts=[];let o=0,s=0;const l=e.length-1,d=this.parts,[c,p]=Jr(e,t);if(this.el=ti.createElement(c,i),$t.currentNode=this.el.content,t===2){const v=this.el.content,f=v.firstChild;f.remove(),v.append(...f.childNodes)}for(;(a=$t.nextNode())!==null&&d.length<l;){if(a.nodeType===1){if(a.hasAttributes()){const v=[];for(const f of a.getAttributeNames())if(f.endsWith("$lit$")||f.startsWith(Ee)){const w=p[s++];if(v.push(f),w!==void 0){const x=a.getAttribute(w.toLowerCase()+"$lit$").split(Ee),$=/([.?@])?(.*)/.exec(w);d.push({type:1,index:o,name:$[2],strings:x,ctor:$[1]==="."?to:$[1]==="?"?io:$[1]==="@"?ao:ri})}else d.push({type:6,index:o})}for(const f of v)a.removeAttribute(f)}if(Xr.test(a.tagName)){const v=a.textContent.split(Ee),f=v.length-1;if(f>0){a.textContent=kt?kt.emptyScript:"";for(let w=0;w<f;w++)a.append(v[w],Jt()),$t.nextNode(),d.push({type:2,index:++o});a.append(v[f],Jt())}}}else if(a.nodeType===8)if(a.data===Ea)d.push({type:2,index:o});else{let v=-1;for(;(v=a.data.indexOf(Ee,v+1))!==-1;)d.push({type:7,index:o}),v+=Ee.length-1}o++}}static createElement(e,t){const i=Tt.createElement("template");return i.innerHTML=e,i}}function it(r,e,t=r,i){var a,o,s,l;if(e===ge)return e;let d=i!==void 0?(a=t._$Cl)===null||a===void 0?void 0:a[i]:t._$Cu;const c=ei(e)?void 0:e._$litDirective$;return(d==null?void 0:d.constructor)!==c&&((o=d==null?void 0:d._$AO)===null||o===void 0||o.call(d,!1),c===void 0?d=void 0:(d=new c(r),d._$AT(r,t,i)),i!==void 0?((s=(l=t)._$Cl)!==null&&s!==void 0?s:l._$Cl=[])[i]=d:t._$Cu=d),d!==void 0&&(e=it(r,d._$AS(r,e.values),d,i)),e}class eo{constructor(e,t){this.v=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}p(e){var t;const{el:{content:i},parts:a}=this._$AD,o=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:Tt).importNode(i,!0);$t.currentNode=o;let s=$t.nextNode(),l=0,d=0,c=a[0];for(;c!==void 0;){if(l===c.index){let p;c.type===2?p=new Ot(s,s.nextSibling,this,e):c.type===1?p=new c.ctor(s,c.name,c.strings,this,e):c.type===6&&(p=new ro(s,this,e)),this.v.push(p),c=a[++d]}l!==(c==null?void 0:c.index)&&(s=$t.nextNode(),l++)}return o}m(e){let t=0;for(const i of this.v)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class Ot{constructor(e,t,i,a){var o;this.type=2,this._$AH=_,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=a,this._$Cg=(o=a==null?void 0:a.isConnected)===null||o===void 0||o}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cg}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&e.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=it(this,e,t),ei(e)?e===_||e==null||e===""?(this._$AH!==_&&this._$AR(),this._$AH=_):e!==this._$AH&&e!==ge&&this.$(e):e._$litType$!==void 0?this.T(e):e.nodeType!==void 0?this.k(e):qr(e)?this.S(e):this.$(e)}M(e,t=this._$AB){return this._$AA.parentNode.insertBefore(e,t)}k(e){this._$AH!==e&&(this._$AR(),this._$AH=this.M(e))}$(e){this._$AH!==_&&ei(this._$AH)?this._$AA.nextSibling.data=e:this.k(Tt.createTextNode(e)),this._$AH=e}T(e){var t;const{values:i,_$litType$:a}=e,o=typeof a=="number"?this._$AC(e):(a.el===void 0&&(a.el=ti.createElement(a.h,this.options)),a);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===o)this._$AH.m(i);else{const s=new eo(o,this),l=s.p(this.options);s.m(i),this.k(l),this._$AH=s}}_$AC(e){let t=mr.get(e.strings);return t===void 0&&mr.set(e.strings,t=new ti(e)),t}S(e){Kr(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,a=0;for(const o of e)a===t.length?t.push(i=new Ot(this.M(Jt()),this.M(Jt()),this,this.options)):i=t[a],i._$AI(o),a++;a<t.length&&(this._$AR(i&&i._$AB.nextSibling,a),t.length=a)}_$AR(e=this._$AA.nextSibling,t){var i;for((i=this._$AP)===null||i===void 0||i.call(this,!1,!0,t);e&&e!==this._$AB;){const a=e.nextSibling;e.remove(),e=a}}setConnected(e){var t;this._$AM===void 0&&(this._$Cg=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}}class ri{constructor(e,t,i,a,o){this.type=1,this._$AH=_,this._$AN=void 0,this.element=e,this.name=t,this._$AM=a,this.options=o,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=_}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,i,a){const o=this.strings;let s=!1;if(o===void 0)e=it(this,e,t,0),s=!ei(e)||e!==this._$AH&&e!==ge,s&&(this._$AH=e);else{const l=e;let d,c;for(e=o[0],d=0;d<o.length-1;d++)c=it(this,l[i+d],t,d),c===ge&&(c=this._$AH[d]),s||(s=!ei(c)||c!==this._$AH[d]),c===_?e=_:e!==_&&(e+=(c!=null?c:"")+o[d+1]),this._$AH[d]=c}s&&!a&&this.C(e)}C(e){e===_?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e!=null?e:"")}}class to extends ri{constructor(){super(...arguments),this.type=3}C(e){this.element[this.name]=e===_?void 0:e}}const ds=kt?kt.emptyScript:"";class io extends ri{constructor(){super(...arguments),this.type=4}C(e){e&&e!==_?this.element.setAttribute(this.name,ds):this.element.removeAttribute(this.name)}}class ao extends ri{constructor(e,t,i,a,o){super(e,t,i,a,o),this.type=5}_$AI(e,t=this){var i;if((e=(i=it(this,e,t,0))!==null&&i!==void 0?i:_)===ge)return;const a=this._$AH,o=e===_&&a!==_||e.capture!==a.capture||e.once!==a.once||e.passive!==a.passive,s=e!==_&&(a===_||o);o&&this.element.removeEventListener(this.name,this,a),s&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,i;typeof this._$AH=="function"?this._$AH.call((i=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&i!==void 0?i:this.element,e):this._$AH.handleEvent(e)}}class ro{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){it(this,e)}}const cs={L:"$lit$",P:Ee,V:Ea,I:1,N:Jr,R:eo,j:qr,D:it,H:Ot,F:ri,O:io,W:ao,B:to,Z:ro},vr=window.litHtmlPolyfillSupport;vr==null||vr(ti,Ot),((qi=globalThis.litHtmlVersions)!==null&&qi!==void 0?qi:globalThis.litHtmlVersions=[]).push("2.2.4");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Xi,Zi;class O extends yt{constructor(){super(...arguments),this.renderOptions={host:this},this._$Dt=void 0}createRenderRoot(){var e,t;const i=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=i.firstChild),i}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Dt=mi(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Dt)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Dt)===null||e===void 0||e.setConnected(!1)}render(){return ge}}O.finalized=!0,O._$litElement$=!0,(Xi=globalThis.litElementHydrateSupport)===null||Xi===void 0||Xi.call(globalThis,{LitElement:O});const fr=globalThis.litElementPolyfillSupport;fr==null||fr({LitElement:O});((Zi=globalThis.litElementVersions)!==null&&Zi!==void 0?Zi:globalThis.litElementVersions=[]).push("3.2.0");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Fe={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Aa=r=>(...e)=>({_$litDirective$:r,values:e});class Da{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}/**
 * @license
 ...
 */function*vi(r,e){const t=typeof e=="function";if(r!==void 0){let i=-1;for(const a of r)i>-1&&(yield t?e(i):e),i++,yield a}}let Ci=class extends O{constructor(){super(...arguments),this.snippets=[],this.viewSize="desktop"}render(){var e;return!((e=this.snippets)===null||e===void 0)&&e.length?m`
    ...
    `}};n([u({type:Array})],Ci.prototype,"snippets",void 0);n([u({type:String})],Ci.prototype,"viewSize",void 0);Ci=n([R("text-snippet-block")],Ci);const Ts=y`
  .drop-shadow {
...
`;function Vs(r,e){let t=1;return r>=1e9?t=1e9:r>=1e6?t=1e6:r>=1e3&&e==="short"&&(t=1e3),t}function Gs(r=0,e){const t=r/e,i=t<10;let a=0;return i?a=Math.round((t+Number.EPSILON)*10)/10:a=Math.round(t),a}function Qs(r,e,t,i){switch(e){case 1e9:return Xe(t==="short"?gt`${r}B`:gt`${r} billion`);case 1e6:return Xe(t==="short"?gt`${r}M`:gt`${r} million`);case 1e3:return Xe(t==="short"?gt`${r}K`:gt`${r} thousand`);default:return new Intl.NumberFormat(i).format(r)}}function qt(r,e="long",t="short",i="en-US"){const a=r!=null?r:-1;if(a<0)return"";const o=Vs(a,e),s=Gs(a,o);return Qs(s,o,t,i)}let at=class extends O{render(){return m`
    ...
    `}};n([u({type:String})],zt.prototype,"baseImageUrl",void 0);n([u({type:Boolean})],zt.prototype,"loggedIn",void 0);n([u({type:Object})],zt.prototype,"model",void 0);n([u({type:Object})],zt.prototype,"sortParam",void 0);zt=n([R("item-tile")],zt);let ya=class extends O{render(){var e,t,i,a,o,s,l,d;return m`
...
`+ne),ct&&(ne=Le(ne,He," "),ne=Le(ne,Ue," ")),B&&si?B.createHTML(ne):ne},e.setConfig=function(C){ji(C),Ii=!0},e.clearConfig=function(){vt=null,Ii=!1},e.isValidAttribute=function(C,h,b){vt||ji({});var S=Ge(C),H=Ge(h);return Za(S,H,b)},e.addHook=function(C,h){typeof h=="function"&&(ue[C]=ue[C]||[],Qt(ue[C],h))},e.removeHook=function(C){if(ue[C])return _r(ue[C])},e.removeHooks=function(C){ue[C]&&(ue[C]=[])},e.removeAllHooks=function(){ue={}},e}var Xt=ho(),L;(function(r){r.relevance="relevance",r.alltimeview="alltimeview",r.weeklyview="weeklyview",r.title="title",r.datearchived="datearchived",r.date="date",r.datereviewed="datereviewed",r.dateadded="dateadded",r.creator="creator"})(L||(L={}));const qe={relevance:"Relevance",alltimeview:"All-time Views",weeklyview:"Weekly Views",title:"Title",datearchived:"Date Archived",date:"Date Published",datereviewed:"Date Reviewed",dateadded:"Date Added",creator:"Creator"},_n={relevance:null,alltimeview:"downloads",weeklyview:"week",title:"titleSorter",datearchived:"publicdate",date:"date",datereviewed:"reviewdate",dateadded:"addeddate",creator:"creatorSorter"},Tr={week:L.weeklyview,downloads:L.alltimeview,titleSorter:L.title,date:L.date,publicdate:L.datearchived,reviewdate:L.datereviewed,addeddate:L.dateadded,creatorSorter:L.creator},Ti={subject:{},lending:{},mediatype:{},language:{},creator:{},collection:{},year:{}},Sn=["mediatype","lending","year","subject","collection","creator","language"],zi={subject:"Subject",lending:"Availability",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"},$n={is_lendable:!0,is_borrowable:!1,available_to_borrow:!0,is_browsable:!1,available_to_browse:!1,is_readable:!0,available_to_waitlist:!1},zr={is_lendable:"Lending Library",available_to_borrow:"Borrow 14 Days",is_readable:"Always Available"},La={deemphasize:!0,community:!0,stream_only:!0,samples_only:!0,test_collection:!0,printdisabled:!0,"openlibrary-ol":!0,nationalemergencylibrary:!0,china:!0,americana:!0,toronto:!0};function uo(r){switch(r){case"date":return"Published";case"reviewdate":return"Reviewed";case"addeddate":return"Added";default:return"Archived"}}function po(r){return r?`Archivist since ${r.getFullYear()}`:""}let ye=class extends O{constructor(){super(...arguments),this.sortParam=null,this.collectionLinks=[],this.loggedIn=!1}updated(e){e.has("model")&&this.fetchCollectionNames()}async fetchCollectionNames(){var e,t;if(!(!((e=this.model)===null||e===void 0)&&e.collections)||this.model.collections.length===0||!this.collectionNameCache)return;this.collectionLinks=[];const i=[],a=[];for(const o of this.model.collections)La[o]||a.push((t=this.collectionNameCache)===null||t===void 0?void 0:t.collectionNameFor(o).then(s=>{i.push(this.detailsLink(o,s!=null?s:o))}));await Promise.all(a),this.collectionLinks=i}render(){return m`
  ...
  `;n([u({type:String})],Mi.prototype,"selectedLetter",void 0);Mi=n([R("alpha-bar")],Mi);const Er=I`
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ar=Aa(class extends Da{constructor(r){if(super(r),r.type!==Fe.PROPERTY&&r.type!==Fe.ATTRIBUTE&&r.type!==Fe.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!fs(r))throw Error("`live` bindings can only contain a single expression")}render(r){return r}update(r,[e]){if(e===ge||e===_)return e;const t=r.element,i=r.name;if(r.type===Fe.PROPERTY){if(e===t[i])return ge}else if(r.type===Fe.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(i))return ge}else if(r.type===Fe.ATTRIBUTE&&t.getAttribute(i)===e+"")return ge;return so(r),e}});var mo=60,vo=mo*60,fo=vo*24,zn=fo*7,Et=1e3,sa=mo*Et,Dr=vo*Et,Mn=fo*Et,En=zn*Et,Fa="millisecond",wt="second",xt="minute",_t="hour",Oe="day",yi="week",we="month",go="quarter",Ie="year",St="date",An="YYYY-MM-DDTHH:mm:ssZ",Lr="Invalid Date",Dn=/^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/,Ln=/\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g,Fn={name:"en",weekdays:"Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),months:"January_February_March_April_May_June_July_August_September_October_November_December".split("_")},_a=function(e,t,i){var a=String(e);return!a||a.length>=t?e:""+Array(t+1-a.length).join(i)+e},On=function(e){var t=-e.utcOffset(),i=Math.abs(t),a=Math.floor(i/60),o=i%60;return(t<=0?"+":"-")+_a(a,2,"0")+":"+_a(o,2,"0")},In=function r(e,t){if(e.date()<t.date())return-r(t,e);var i=(t.year()-e.year())*12+(t.month()-e.month()),a=e.clone().add(i,we),o=t-a<0,s=e.clone().add(i+(o?-1:1),we);return+(-(i+(t-a)/(o?a-s:s-a))||0)},Pn=function(e){return e<0?Math.ceil(e)||0:Math.floor(e)},Nn=function(e){var t={M:we,y:Ie,w:yi,d:Oe,D:St,h:_t,m:xt,s:wt,ms:Fa,Q:go};return t[e]||String(e||"").toLowerCase().replace(/s$/,"")},Rn=function(e){return e===void 0},Bn={s:_a,z:On,m:In,a:Pn,p:Nn,u:Rn},Zt="en",Je={};Je[Zt]=Fn;var Oa=function(e){return e instanceof Oi},Ei=function r(e,t,i){var a;if(!e)return Zt;if(typeof e=="string"){var o=e.toLowerCase();Je[o]&&(a=o),t&&(Je[o]=t,a=o);var s=e.split("-");if(!a&&s.length>1)return r(s[0])}else{var l=e.name;Je[l]=e,a=l}return!i&&a&&(Zt=a),a||!i&&Zt},Z=function(e,t){if(Oa(e))return e.clone();var i=typeof t=="object"?t:{};return i.date=e,i.args=arguments,new Oi(i)},Hn=function(e,t){return Z(e,{locale:t.$L,utc:t.$u,x:t.$x,$offset:t.$offset})},U=Bn;U.l=Ei;U.i=Oa;U.w=Hn;var Un=function(e){var t=e.date,i=e.utc;if(t===null)return new Date(NaN);if(U.u(t))return new Date;if(t instanceof Date)return new Date(t);if(typeof t=="string"&&!/Z$/i.test(t)){var a=t.match(Dn);if(a){var o=a[2]-1||0,s=(a[7]||"0").substring(0,3);return i?new Date(Date.UTC(a[1],o,a[3]||1,a[4]||0,a[5]||0,a[6]||0,s)):new Date(a[1],o,a[3]||1,a[4]||0,a[5]||0,a[6]||0,s)}}return new Date(t)},Oi=function(){function r(t){this.$L=Ei(t.locale,null,!0),this.parse(t)}var e=r.prototype;return e.parse=function(i){this.$d=Un(i),this.$x=i.x||{},this.init()},e.init=function(){var i=this.$d;this.$y=i.getFullYear(),this.$M=i.getMonth(),this.$D=i.getDate(),this.$W=i.getDay(),this.$H=i.getHours(),this.$m=i.getMinutes(),this.$s=i.getSeconds(),this.$ms=i.getMilliseconds()},e.$utils=function(){return U},e.isValid=function(){return this.$d.toString()!==Lr},e.isSame=function(i,a){var o=Z(i);return this.startOf(a)<=o&&o<=this.endOf(a)},e.isAfter=function(i,a){return Z(i)<this.startOf(a)},e.isBefore=function(i,a){return this.endOf(a)<Z(i)},e.$g=function(i,a,o){return U.u(i)?this[a]:this.set(o,i)},e.unix=function(){return Math.floor(this.valueOf()/1e3)},e.valueOf=function(){return this.$d.getTime()},e.startOf=function(i,a){var o=this,s=U.u(a)?!0:a,l=U.p(i),d=function(A,F){var N=U.w(o.$u?Date.UTC(o.$y,F,A):new Date(o.$y,F,A),o);return s?N:N.endOf(Oe)},c=function(A,F){var N=[0,0,0,0],B=[23,59,59,999];return U.w(o.toDate()[A].apply(o.toDate("s"),(s?N:B).slice(F)),o)},p=this.$W,v=this.$M,f=this.$D,w="set"+(this.$u?"UTC":"");switch(l){case Ie:return s?d(1,0):d(31,11);case we:return s?d(1,v):d(0,v+1);case yi:{var x=this.$locale().weekStart||0,$=(p<x?p+7:p)-x;return d(s?f-$:f+(6-$),v)}case Oe:case St:return c(w+"Hours",0);case _t:return c(w+"Minutes",1);case xt:return c(w+"Seconds",2);case wt:return c(w+"Milliseconds",3);default:return this.clone()}},e.endOf=function(i){return this.startOf(i,!1)},e.$set=function(i,a){var o,s=U.p(i),l="set"+(this.$u?"UTC":""),d=(o={},o[Oe]=l+"Date",o[St]=l+"Date",o[we]=l+"Month",o[Ie]=l+"FullYear",o[_t]=l+"Hours",o[xt]=l+"Minutes",o[wt]=l+"Seconds",o[Fa]=l+"Milliseconds",o)[s],c=s===Oe?this.$D+(a-this.$W):a;if(s===we||s===Ie){var p=this.clone().set(St,1);p.$d[d](c),p.init(),this.$d=p.set(St,Math.min(this.$D,p.daysInMonth())).$d}else d&&this.$d[d](c);return this.init(),this},e.set=function(i,a){return this.clone().$set(i,a)},e.get=function(i){return this[U.p(i)]()},e.add=function(i,a){var o=this,s;i=Number(i);var l=U.p(a),d=function(f){var w=Z(o);return U.w(w.date(w.date()+Math.round(f*i)),o)};if(l===we)return this.set(we,this.$M+i);if(l===Ie)return this.set(Ie,this.$y+i);if(l===Oe)return d(1);if(l===yi)return d(7);var c=(s={},s[xt]=sa,s[_t]=Dr,s[wt]=Et,s)[l]||1,p=this.$d.getTime()+i*c;return U.w(p,this)},e.subtract=function(i,a){return this.add(i*-1,a)},e.format=function(i){var a=this,o=this.$locale();if(!this.isValid())return o.invalidDate||Lr;var s=i||An,l=U.z(this),d=this.$H,c=this.$m,p=this.$M,v=o.weekdays,f=o.months,w=o.meridiem,x=function(N,B,Q,re){return N&&(N[B]||N(a,s))||Q[B].slice(0,re)},$=function(N){return U.s(d%12||12,N,"0")},E=w||function(F,N,B){var Q=F<12?"AM":"PM";return B?Q.toLowerCase():Q},A={YY:String(this.$y).slice(-2),YYYY:this.$y,M:p+1,MM:U.s(p+1,2,"0"),MMM:x(o.monthsShort,p,f,3),MMMM:x(f,p),D:this.$D,DD:U.s(this.$D,2,"0"),d:String(this.$W),dd:x(o.weekdaysMin,this.$W,v,2),ddd:x(o.weekdaysShort,this.$W,v,3),dddd:v[this.$W],H:String(d),HH:U.s(d,2,"0"),h:$(1),hh:$(2),a:E(d,c,!0),A:E(d,c,!1),m:String(c),mm:U.s(c,2,"0"),s:String(this.$s),ss:U.s(this.$s,2,"0"),SSS:U.s(this.$ms,3,"0"),Z:l};return s.replace(Ln,function(F,N){return N||A[F]||l.replace(":","")})},e.utcOffset=function(){return-Math.round(this.$d.getTimezoneOffset()/15)*15},e.diff=function(i,a,o){var s,l=U.p(a),d=Z(i),c=(d.utcOffset()-this.utcOffset())*sa,p=this-d,v=U.m(this,d);return v=(s={},s[Ie]=v/12,s[we]=v,s[go]=v/3,s[yi]=(p-c)/En,s[Oe]=(p-c)/Mn,s[_t]=p/Dr,s[xt]=p/sa,s[wt]=p/Et,s)[l]||p,o?v:U.a(v)},e.daysInMonth=function(){return this.endOf(we).$D},e.$locale=function(){return Je[this.$L]},e.locale=function(i,a){if(!i)return this.$L;var o=this.clone(),s=Ei(i,a,!0);return s&&(o.$L=s),o},e.clone=function(){return U.w(this.$d,this)},e.toDate=function(){return new Date(this.valueOf())},e.toJSON=function(){return this.isValid()?this.toISOString():null},e.toISOString=function(){return this.$d.toISOString()},e.toString=function(){return this.$d.toUTCString()},r}(),yo=Oi.prototype;Z.prototype=yo;[["$ms",Fa],["$s",wt],["$m",xt],["$H",_t],["$W",Oe],["$M",we],["$y",Ie],["$D",St]].forEach(function(r){yo[r[1]]=function(e){return this.$g(e,r[0],r[1])}});Z.extend=function(r,e){return r.$i||(r(e,Oi,Z),r.$i=!0),Z};Z.locale=Ei;Z.isDayjs=Oa;Z.unix=function(r){return Z(r*1e3)};Z.en=Je[Zt];Z.Ls=Je;Z.p={};var jn=function(e){return e.replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g,function(t,i,a){return i||a.slice(1)})},Wn={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"},Vn=function(e,t){return e.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g,function(i,a,o){var s=o&&o.toUpperCase();return a||t[o]||Wn[o]||jn(t[s])})},Gn=/(\[[^[]*\])|([-:/.()\s]+)|(A|a|YYYY|YY?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g,Qn=/\d/,pi=/\d\d/,Yn=/\d{3}/,Kn=/\d{4}/,$e=/\d\d?/,qn=/[+-]?\d+/,Xn=/[+-]\d\d:?(\d\d)?|Z/,Yt=/\d*[^\s\d-_:/()]+/,Ne={},bo=function(e){return e=+e,e+(e>68?1900:2e3)};function Zn(r){if(!r||r==="Z")return 0;var e=r.match(/([+-]|\d\d)/g),t=+(e[1]*60)+(+e[2]||0);return t===0?0:e[0]==="+"?-t:t}var me=function(e){return function(t){this[e]=+t}},Fr=[Xn,function(r){var e=this.zone||(this.zone={});e.offset=Zn(r)}],na=function(e){var t=Ne[e];return t&&(t.indexOf?t:t.s.concat(t.f))},Or=function(e,t){var i,a=Ne,o=a.meridiem;if(!o)i=e===(t?"pm":"PM");else for(var s=1;s<=24;s+=1)if(e.indexOf(o(s,0,t))>-1){i=s>12;break}return i},Jn={A:[Yt,function(r){this.afternoon=Or(r,!1)}],a:[Yt,function(r){this.afternoon=Or(r,!0)}],S:[Qn,function(r){this.milliseconds=+r*100}],SS:[pi,function(r){this.milliseconds=+r*10}],SSS:[Yn,function(r){this.milliseconds=+r}],s:[$e,me("seconds")],ss:[$e,me("seconds")],m:[$e,me("minutes")],mm:[$e,me("minutes")],H:[$e,me("hours")],h:[$e,me("hours")],HH:[$e,me("hours")],hh:[$e,me("hours")],D:[$e,me("day")],DD:[pi,me("day")],Do:[Yt,function(r){var e=Ne,t=e.ordinal,i=r.match(/\d+/);if(this.day=i[0],!!t)for(var a=1;a<=31;a+=1)t(a).replace(/\[|\]/g,"")===r&&(this.day=a)}],M:[$e,me("month")],MM:[pi,me("month")],MMM:[Yt,function(r){var e=na("months"),t=na("monthsShort"),i=(t||e.map(function(a){return a.slice(0,3)})).indexOf(r)+1;if(i<1)throw new Error;this.month=i%12||i}],MMMM:[Yt,function(r){var e=na("months"),t=e.indexOf(r)+1;if(t<1)throw new Error;this.month=t%12||t}],Y:[qn,me("year")],YY:[pi,function(r){this.year=bo(r)}],YYYY:[Kn,me("year")],Z:Fr,ZZ:Fr};function el(r){var e=r.afternoon;if(e!==void 0){var t=r.hours;e?t<12&&(r.hours+=12):t===12&&(r.hours=0),delete r.afternoon}}function tl(r){r=Vn(r,Ne&&Ne.formats);for(var e=r.match(Gn),t=e.length,i=0;i<t;i+=1){var a=e[i],o=Jn[a],s=o&&o[0],l=o&&o[1];l?e[i]={regex:s,parser:l}:e[i]=a.replace(/^\[|\]$/g,"")}return function(d){for(var c={},p=0,v=0;p<t;p+=1){var f=e[p];if(typeof f=="string")v+=f.length;else{var w=f.regex,x=f.parser,$=d.slice(v),E=w.exec($),A=E[0];x.call(c,A),d=d.replace(A,"")}}return el(c),c}}var il=function(e,t,i){try{if(["x","X"].indexOf(t)>-1)return new Date((t==="X"?1e3:1)*e);var a=tl(t),o=a(e),s=o.year,l=o.month,d=o.day,c=o.hours,p=o.minutes,v=o.seconds,f=o.milliseconds,w=o.zone,x=new Date,$=d||(!s&&!l?x.getDate():1),E=s||x.getFullYear(),A=0;s&&!l||(A=l>0?l-1:x.getMonth());var F=c||0,N=p||0,B=v||0,Q=f||0;return w?new Date(Date.UTC(E,A,$,F,N,B,Q+w.offset*60*1e3)):i?new Date(Date.UTC(E,A,$,F,N,B,Q)):new Date(E,A,$,F,N,B,Q)}catch{return new Date("")}},al=function(r,e,t){t.p.customParseFormat=!0,r&&r.parseTwoDigitYear&&(bo=r.parseTwoDigitYear);var i=e.prototype,a=i.parse;i.parse=function(o){var s=o.date,l=o.utc,d=o.args;this.$u=l;var c=d[1];if(typeof c=="string"){var p=d[2]===!0,v=d[3]===!0,f=p||v,w=d[2];v&&(w=d[2]),Ne=this.$locale(),!p&&w&&(Ne=t.Ls[w]),this.$d=il(s,c,l),this.init(),w&&w!==!0&&(this.$L=this.locale(w).$L),f&&s!=this.format(c)&&(this.$d=new Date("")),Ne={}}else if(c instanceof Array)for(var x=c.length,$=1;$<=x;$+=1){d[1]=c[$-1];var E=t.apply(this,d);if(E.isValid()){this.$d=E.$d,this.$L=E.$L,this.init();break}$===x&&(this.$d=new Date(""))}else a.call(this,o)}};const rl=Object.freeze({processing:"processing",complete:"complete"});class ol extends O{static get properties(){return{mode:{type:String}}}constructor(){super(),this.mode=rl.processing}render(){return m`
      <div class="${this.mode}">
        <svg
          viewBox="0 0 120 120"
...
`;let Lt=class extends O{facetClicked(e,t,i){const a=e.target,{checked:o,name:s,value:l}=a;o?this.facetChecked(s,l,t,i):this.facetUnchecked(s,l)}facetChecked(e,t,i,a){const{selectedFacets:o}=this;let s;o?s=fe({},o):s=Ti,s[e][t]={state:a?"hidden":"selected",count:i},this.selectedFacets=s,this.dispatchSelectedFacetsChanged()}facetUnchecked(e,t){const{selectedFacets:i}=this;let a;i?a=fe({},i):a=Ti,delete a[e][t],this.selectedFacets=a,this.dispatchSelectedFacetsChanged()}dispatchSelectedFacetsChanged(){const e=new CustomEvent("selectedFacetsChanged",{detail:this.selectedFacets,bubbles:!0,composed:!0});this.dispatchEvent(e)}getFacetsTemplate(e){let t=e==null?void 0:e.buckets;return t=[...t.filter(i=>i.state==="selected").sort((i,a)=>i.count<a.count?1:-1),...t.filter(i=>i.state==="hidden").sort((i,a)=>i.count<a.count?1:-1),...t.filter(i=>i.state==="none")],m`
        ...
        <div id="search-types">
          ...
          <span class="search-type">
            <input
              ...
              name="search-type"
              value="metadata"
              ?checked=${((t=this.collectionBrowser)===null||t===void 0?void 0:t.searchType)===de.METADATA}
          ...
          <span class="search-type">
            <input
              ...
              name="search-type"
              value="fulltext"
              ?checked=${((i=this.collectionBrowser)===null||i===void 0?void 0:i.searchType)===de.FULLTEXT}
              @click=${this.searchTypeChanged}
            />
