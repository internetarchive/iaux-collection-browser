 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ld=(s,...e)=>({strTag:!0,strings:s,values:e}),ot=ld,dd=s=>typeof s!="string"&&"strTag"in s,cd=(s,e,t)=>{let i=s[0];for(let o=1;o<s.length;o++)i+=e[o-1],i+=s[o];return i};/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const hd=s=>dd(s)?cd(s.strings,s.values):s;let k=hd;/**
 * @license
...
`;var it;let Le=it=class extends P{constructor(){super(...arguments),this.placeholderType=null,this.detailMessage=""}render(){return this.placeholderType?p`${this.placeholderTemplate}`:b}get placeholderTemplate(){return p`
      <div
...
`;function mc(s,e){let t=1;return s>=1e9?t=1e9:s>=1e6?t=1e6:s>=1e3&&e==="short"&&(t=1e3),t}function vc(s=0,e){const t=s/e,i=t<10;let o=0;return i?o=Math.round((t+Number.EPSILON)*10)/10:o=Math.round(t),o}function gc(s,e,t,i){switch(e){case 1e9:return k(t==="short"?ot`${s}B`:ot`${s} billion`);case 1e6:return k(t==="short"?ot`${s}M`:ot`${s} million`);case 1e3:return k(t==="short"?ot`${s}K`:ot`${s} thousand`);default:return new Intl.NumberFormat(i).format(s)}}function Mr(s,e="long",t="short",i="en-US"){const o=s??-1;if(o<0)return"";const r=mc(o,e),a=vc(o,r);return gc(a,r,t,i)}let Qe=class extends P{constructor(){super(...arguments),this.showTvClips=!1}render(){return p`
    ...
    `}columnTemplate(e,t,i,o=[]){const r=Mr(e??0,"short","short"),a=k(ot`${r} ${t}`),l=t+":";return p`
    ...
    `}get viewsColumnTemplate(){var e;const t=(e=this.viewLabel)!==null&&e!==void 0?e:k("all-time views");return this.columnTemplate(this.viewCount,t,uc)}get uploadsColumnTemplate(){return this.columnTemplate(this.itemCount,k("uploads"),pc)}get favoritesColumnTemplate(){return this.columnTemplate(this.favCount,k("favorites"),On)}get reviewsColumnTemplate(){return this.columnTemplate(this.commentCount,k("reviews"),hc,["reviews"])}get tvClipsColumnTemplate(){return this.columnTemplate(this.tvClipCount,k("clips"),fc)}static get styles(){return[at,f`
        tile-mediatype-icon {
          --iconHeight: 25px;
          --iconWidth: 25px;
        }
...
`+Te),Gt&&ho([Ze,Je,K],tt=>{Te=Ai(Te,tt," ")}),I&&io?I.createHTML(Te):Te},e.setConfig=function(){let z=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};os(z),Xo=!0},e.clearConfig=function(){Zt=null,Xo=!1},e.isValidAttribute=function(z,g,$){Zt||os({});const D=fe(z),J=fe(g);return Yr(D,J,$)},e.addHook=function(z,g){typeof g=="function"&&Mi(Q[z],g)},e.removeHook=function(z,g){if(g!==void 0){const $=kc(Q[z],g);return $===-1?void 0:Tc(Q[z],$,1)[0]}return La(Q[z])},e.removeHooks=function(z){Q[z]=[]},e.removeAllHooks=function(){Q=Oa()},e}var wo=Yn();let Po=class extends de{constructor(){super(...arguments),this.collectionLinks=[]}render(){return p`
    ...
    `}get datePublishedTemplate(){var e;const t=(e=this.model)===null||e===void 0?void 0:e.datePublished;let i="long";return Er(t)&&(i="year-only"),this.metadataTemplate(this.getFormattedDate(t,i),k("Published"))}get dateSortByTemplate(){return this.effectiveSort&&(this.effectiveSort.field==="addeddate"||this.effectiveSort.field==="reviewdate"||this.effectiveSort.field==="publicdate")?this.metadataTemplate(this.getFormattedDate(this.date,"long"),this.displayValueProvider.dateLabel):b}get viewsTemplate(){var e,t,i,o;const r=((e=this.effectiveSort)===null||e===void 0?void 0:e.field)==="week"?(t=this.model)===null||t===void 0?void 0:t.weeklyViewCount:(i=this.model)===null||i===void 0?void 0:i.viewCount;return r==null?b:((o=this.model)===null||o===void 0?void 0:o.mediatype)==="search"?this.metadataTemplate("(Favorited search query)",""):this.metadataTemplate(`${Mr(r,this.formatSize)}`,k("Views"))}get ratingTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.averageRating,k("Avg Rating"))}get reviewsTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.commentCount,k("Reviews"))}get topicsTemplate(){var e;return!(!((e=this.model)===null||e===void 0)&&e.subjects)||this.model.subjects.length===0?b:p`
    ...
    `}};Ua=n([R("tile-list-compact-header")],Ua);const Ha=(s,e=-1/0,t=1/0)=>Math.max(e,Math.min(s,t));class Wc{constructor(e,t={}){var i,o,r,a,l,d,u;this.host=e,this.mobileBreakpoint=600,this.offsetX=-10,this.offsetY=15,this.showDelay=300,this.hideDelay=100,this.longPressDelay=600,this.enableLongPress=!1,this.hoverPaneState="hidden",this.forceTouchBackdrop=!1,this.lastPointerClientPos={x:0,y:0},this.handleFocus=()=>{this.hoverPaneState==="hidden"&&this.showHoverPane({anchor:"host"})},this.handleBlur=()=>{this.hoverPaneState!=="hidden"&&this.fadeOutHoverPane()},this.handleKeyDown=h=>{(h.key==="ArrowDown"||h.key==="ArrowUp")&&this.hoverPaneState!=="hidden"&&h.preventDefault()},this.handleKeyUp=h=>{if(this.hoverPaneState==="hidden"||!this.hoverPane)return;h.key==="ArrowDown"&&(this.hoverPane.tabIndex=1,this.hoverPane.focus());const m=h.key==="ArrowUp",v=h.key==="Escape"||h.key==="Esc";v&&this.fadeOutHoverPane(),(m||v)&&(this.hoverPane.tabIndex=-1,this.host.acquireFocus())},this.handleMouseEnter=h=>{this.handleMouseMove(h)},this.handleMouseMove=h=>{var m;clearTimeout(this.hideTimer),this.hoverPaneState==="fading-out"&&(this.hoverPaneState="shown",(m=this.hoverPane)===null||m===void 0||m.classList.add("fade-in")),this.hoverPaneState==="hidden"&&(this.restartShowHoverPaneTimer(),this.lastPointerClientPos={x:h.clientX,y:h.clientY})},this.handleMouseLeave=()=>{this.host.releaseFocus(),clearTimeout(this.showTimer),this.hoverPaneState!=="hidden"&&(this.hideTimer=window.setTimeout(()=>{this.fadeOutHoverPane()},this.hideDelay))},this.handleTouchStart=h=>{clearTimeout(this.longPressTimer),h.touches.length===1&&(this.longPressTimer=window.setTimeout(()=>{this.hoverPaneState==="hidden"&&this.showHoverPane()},this.longPressDelay),this.lastPointerClientPos={x:h.touches[0].clientX,y:h.touches[0].clientY})},this.handleLongPressCancel=()=>{clearTimeout(this.longPressTimer)},this.handleContextMenu=h=>{h.preventDefault()},this.handleBackdropInteraction=h=>{this.hoverPaneState!=="hidden"&&this.fadeOutHoverPane(),h.stopPropagation()},this.mobileBreakpoint=(i=t.mobileBreakpoint)!==null&&i!==void 0?i:this.mobileBreakpoint,this.offsetX=(o=t.offsetX)!==null&&o!==void 0?o:this.offsetX,this.offsetY=(r=t.offsetY)!==null&&r!==void 0?r:this.offsetY,this.showDelay=(a=t.showDelay)!==null&&a!==void 0?a:this.showDelay,this.hideDelay=(l=t.hideDelay)!==null&&l!==void 0?l:this.hideDelay,this.longPressDelay=(d=t.longPressDelay)!==null&&d!==void 0?d:this.longPressDelay,this.enableLongPress=(u=t.enableLongPress)!==null&&u!==void 0?u:this.enableLongPress,this.host.addController(this)}hostConnected(){this.attachListeners()}hostDisconnected(){this.detachListeners()}hostUpdated(){this.hoverPane=this.host.getHoverPane(),this.hoverPaneProps=this.host.getHoverPaneProps()}getTemplate(){var e,t,i,o,r,a,l;return this.hoverPaneProps=this.host.getHoverPaneProps(),this.shouldRenderHoverPane?p` ${this.touchBackdropTemplate}
          ...
          ></tile-hover-pane>`:b}toggleHoverPane(e){var t;this.hoverPaneState==="shown"?(this.fadeOutHoverPane(),this.forceTouchBackdrop=!1):(this.lastPointerClientPos=e.coords,this.forceTouchBackdrop=(t=e.enableTouchBackdrop)!==null&&t!==void 0?t:!1,this.showHoverPane())}get touchBackdropTemplate(){return this.showTouchBackdrop?p`<div
          id="touch-backdrop"
...
`;let dr=class extends P{constructor(){super(...arguments),this.config=new Rt}render(){return p`
    ...
    `}static get styles(){const e=f`var(--modalLogoSize, 6.5rem)`,t=f`var(--processingImageSize, 7.5rem)`,i=f`var(--modalCornerRadius, 1rem)`,o=f`var(--modalBorder, 2px solid black)`,r=f`var(--modalBottomMargin, 2.5rem)`,a=f`var(--modalTopMargin, 5rem)`,l=f`var(--modalHeaderBottomPadding, 0.5em)`,d=f`var(--modalBottomPadding, 2rem)`,u=f`var(--modalScrollOffset, 5px)`,h=f`var(--modalTitleFontSize, 1.8rem)`,m=f`var(--modalSubtitleFontSize, 1.4rem)`,v=f`var(--modalHeadlineFontSize, 1.6rem)`,y=f`var(--modalMessageFontSize, 1.4rem)`,x=f`var(--modalTitleLineHeight, normal)`,S=f`var(--modalSubtitleLineHeight, normal)`,C=f`var(--modalHeadlineLineHeight, normal)`,F=f`var(--modalMessageLineHeight, normal)`;return f`
      .processing-logo {
        margin: auto;
        width: ${t};
        height: ${t};
...
`;let Ro=class extends P{constructor(){super(...arguments),this.items=[]}render(){return p`
    ...
    `}};n([c({type:Object})],Ro.prototype,"items",void 0);n([c({type:String})],Ro.prototype,"message",void 0);Ro=n([R("remove-items-modal-content")],Ro);let rt=class extends P{constructor(){super(...arguments),this.label=k("Select items to remove"),this.selectedItems=[],this.showSelectAll=!1,this.showUnselectAll=!1,this.showItemManageButton=!1,this.removeAllowed=!1}render(){return p`
...
`;let ke=class extends P{constructor(){super(...arguments),this.binSnapping="none",this.barScaling="logarithmic",this.boundEscapeListener=e=>{e.key==="Escape"&&this.closeModal()}}render(){var e,t,i;return p`
    ...
    `}connectedCallback(){var e;(e=super.connectedCallback)===null||e===void 0||e.call(this),this.setupEscapeListener()}disconnectedCallback(){var e;(e=super.disconnectedCallback)===null||e===void 0||e.call(this),this.removeEscapeListener()}setupEscapeListener(){document.addEventListener("keydown",this.boundEscapeListener)}removeEscapeListener(){document.removeEventListener("keydown",this.boundEscapeListener)}histogramDateRangeUpdated(e){this.minSelectedDate=e.detail.minDate,this.maxSelectedDate=e.detail.maxDate}applyBtnClicked(){var e;const t=new CustomEvent("histogramDateRangeApplied",{detail:{minDate:this.minSelectedDate,maxDate:this.maxSelectedDate}});this.dispatchEvent(t),this.closeModal(),(e=this.analyticsHandler)===null||e===void 0||e.sendEvent({category:st.default,action:te.histogramChangedFromModal,label:window.location.href})}closeModal(){this.modalManager&&(this.modalManager.closeModal(),this.dispatchEvent(new CustomEvent("modalClosed")))}static get styles(){return f`
      #container {
        display: flex;
        justify-content: center;
...
`;var hr;let Zi=hr=class extends P{render(){return p`${this.facetRowTemplate}`}get facetRowTemplate(){var e,t,i,o;const{bucket:r,facetType:a}=this;if(!r||!a)return b;const l=`${a}:${r.key}-show-only`,d=`${a}:${r.key}-negative`,u=r.extraNote?p`<span class="facet-note">${r.extraNote}</span>`:b,h=a!=="collection"?p`${(e=r.displayText)!==null&&e!==void 0?e:r.key} ${u}`:p`<a href="/details/${r.key}">
          ...
          </a> `,m=r.state==="hidden",v=r.state==="selected",y=`${a}: ${(o=r.displayText)!==null&&o!==void 0?o:r.key}`,x=v?`Show all ${a}s`:`Only show ${y}`,S=`Hide ${y}`,C=`Unhide ${y}`,F=m?C:S,M=`${y}, ${r.count} results`;return p`
    ...
    `}get loaderTemplate(){return p`<div class="facets-loader">
      <ia-activity-indicator .mode=${"processing"}></ia-activity-indicator>
        ...
        </div> `:b}sortFacetAggregation(e){this.sortedBy=e,this.dispatchEvent(new CustomEvent("sortedFacets",{detail:this.sortedBy}))}get modalHeaderTemplate(){var e,t,i;const r=((e=this.sortedBy)!==null&&e!==void 0?e:Ui[this.facetKey])===j.COUNT?"left":"right";return p`<span class="sr-only">${k("More facets for:")}</span>
      <span class="title">
    ...
    `}searchMoreFacetsLink(e){if(!this.moreLinksVisible||e.key==="lending"||Object.keys(e.buckets).length<this.allowedFacetCount)return b;const t=Ui[e.key];return p`<button
      class="more-link"
      @click=${()=>{var i;this.showMoreFacetsModal(e,t),(i=this.analyticsHandler)===null||i===void 0||i.sendEvent({category:st.default,action:te.showMoreFacetsModal,label:e.key}),this.dispatchEvent(new CustomEvent("showMoreFacets",{detail:e.key}))}}
