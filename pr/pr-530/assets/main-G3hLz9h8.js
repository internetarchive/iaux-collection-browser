...
`;var it;let Fe=it=class extends P{constructor(){super(...arguments),this.placeholderType=null,this.detailMessage=""}render(){return this.placeholderType?p`${this.placeholderTemplate}`:b}get placeholderTemplate(){return p`
      <div
