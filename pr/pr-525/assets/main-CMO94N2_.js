...
`;function hc(r,e){let t=1;return r>=1e9?t=1e9:r>=1e6?t=1e6:r>=1e3&&e==="short"&&(t=1e3),t}function pc(r=0,e){const t=r/e,i=t<10;let o=0;return i?o=Math.round((t+Number.EPSILON)*10)/10:o=Math.round(t),o}function uc(r,e,t,i){switch(e){case 1e9:return k(t==="short"?ot`${r}B`:ot`${r} billion`);case 1e6:return k(t==="short"?ot`${r}M`:ot`${r} million`);case 1e3:return k(t==="short"?ot`${r}K`:ot`${r} thousand`);default:return new Intl.NumberFormat(i).format(r)}}function Ts(r,e="long",t="short",i="en-US"){const o=r??-1;if(o<0)return"";const s=hc(o,e),a=pc(o,s);return uc(a,s,t,i)}let Qe=class extends P{constructor(){super(...arguments),this.showTvClips=!1}render(){return h`
    ...
    `}get sortedDateInfoTemplate(){var e,t,i,o,s;let a,l="long";switch((e=this.effectiveSort)===null||e===void 0?void 0:e.field){case"date":{const p=(t=this.model)===null||t===void 0?void 0:t.datePublished;a={field:"published",value:p},ks(p)&&(l="year-only");break}case"reviewdate":a={field:"reviewed",value:(i=this.model)===null||i===void 0?void 0:i.dateReviewed};break;case"addeddate":a={field:"added",value:(o=this.model)===null||o===void 0?void 0:o.dateAdded};break;case"publicdate":a={field:"archived",value:(s=this.model)===null||s===void 0?void 0:s.dateArchived};break}if(!(a!=null&&a.value))return b;const{useLocalTime:d}=this,u=Xi(a==null?void 0:a.value,l,{useLocalTime:d});return h`
      <div class="date-sorted-by truncated">
        <span> ${a==null?void 0:a.field} ${u} </span>
      </div>
...
`+Te),Gt&&po([Ze,Je,K],tt=>{Te=Ai(Te,tt," ")}),I&&oo?I.createHTML(Te):Te},e.setConfig=function(){let z=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};or(z),Xo=!0},e.clearConfig=function(){Zt=null,Xo=!1},e.isValidAttribute=function(z,g,$){Zt||or({});const L=fe(z),J=fe(g);return qs(L,J,$)},e.addHook=function(z,g){typeof g=="function"&&Mi(Q[z],g)},e.removeHook=function(z,g){if(g!==void 0){const $=bc(Q[z],g);return $===-1?void 0:yc(Q[z],$,1)[0]}return Aa(Q[z])},e.removeHooks=function(z){Q[z]=[]},e.removeAllHooks=function(){Q=Ra()},e}var wo=Wn();let Po=class extends de{constructor(){super(...arguments),this.collectionLinks=[]}render(){return h`
    ...
    `}get datePublishedTemplate(){var e;const t=(e=this.model)===null||e===void 0?void 0:e.datePublished;let i="long";ks(t)&&(i="year-only");const{useLocalTime:o}=this;return this.metadataTemplate(Xi(t,i,{useLocalTime:o}),k("Published"))}get dateSortByTemplate(){if(this.effectiveSort&&(this.effectiveSort.field==="addeddate"||this.effectiveSort.field==="reviewdate"||this.effectiveSort.field==="publicdate")){const{useLocalTime:e}=this;return this.metadataTemplate(Xi(this.date,"long",{useLocalTime:e}),this.displayValueProvider.dateLabel)}return b}get viewsTemplate(){var e,t,i,o;const s=((e=this.effectiveSort)===null||e===void 0?void 0:e.field)==="week"?(t=this.model)===null||t===void 0?void 0:t.weeklyViewCount:(i=this.model)===null||i===void 0?void 0:i.viewCount;return s==null?b:((o=this.model)===null||o===void 0?void 0:o.mediatype)==="search"?this.metadataTemplate("(Favorited search query)",""):this.metadataTemplate(`${Ts(s,this.formatSize)}`,k("Views"))}get ratingTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.averageRating,k("Avg Rating"))}get reviewsTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.commentCount,k("Reviews"))}get topicsTemplate(){var e;return!(!((e=this.model)===null||e===void 0)&&e.subjects)||this.model.subjects.length===0?b:h`
