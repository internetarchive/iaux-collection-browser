 ...
 */const va=(a,e,t)=>{const i=new Map;for(let o=e;o<=t;o++)i.set(a[o],o);return i},rr=ii(class extends oi{constructor(a){if(super(a),a.type!==Me.CHILD)throw Error("repeat() can only be used in text expressions")}dt(a,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);const o=[],r=[];let n=0;for(const l of a)o[n]=i?i(l,n):n,r[n]=t(l,n),n++;return{values:r,keys:o}}render(a,e,t){return this.dt(a,e,t).values}update(a,[e,t,i]){var o;const r=cs(a),{values:n,keys:l}=this.dt(e,t,i);if(!Array.isArray(r))return this.ut=l,n;const d=(o=this.ut)!==null&&o!==void 0?o:this.ut=[],u=[];let v,f,g=0,w=r.length-1,C=0,E=n.length-1;for(;g<=w&&C<=E;)if(r[g]===null)g++;else if(r[w]===null)w--;else if(d[g]===l[C])u[C]=dt(r[g],n[C]),g++,C++;else if(d[w]===l[E])u[E]=dt(r[w],n[E]),w--,E--;else if(d[g]===l[E])u[E]=dt(r[g],n[E]),Ut(a,u[E+1],r[g]),g++,E--;else if(d[w]===l[C])u[C]=dt(r[w],n[C]),Ut(a,r[g],r[w]),w--,C++;else if(v===void 0&&(v=va(l,C,E),f=va(d,g,w)),v.has(d[g]))if(v.has(d[w])){const L=f.get(l[C]),P=L!==void 0?r[L]:null;if(P===null){const R=Ut(a,r[g]);dt(R,n[C]),u[C]=R}else u[C]=dt(P,n[C]),Ut(a,r[g],P),r[L]=null;C++}else Vi(r[w]),w--;else Vi(r[g]),g++;for(;C<=E;){const L=Ut(a,u[E+1]);dt(L,n[C]),u[C++]=L}for(;g<=w;){const L=r[g++];L!==null&&Vi(L)}return this.ut=l,ar(a,u),be}});function di(a,e,t){return Array.from({length:(e-a)/t+1},(i,o)=>a+o*t)}let Oe=class extends A{constructor(){super(...arguments),this.itemCount=0,this.scrollOptimizationsDisabled=!1,this.intersectionObserver=new IntersectionObserver(e=>{e.forEach(t=>{if(t.target===this.sentinel){t.isIntersecting&&this.dispatchEvent(new Event("scrollThresholdReached"));return}const o=t.target.dataset.cellIndex;if(!o)return;const r=parseInt(o,10);t.isIntersecting?this.visibleCellIndices.add(r):this.visibleCellIndices.delete(r)}),this.scrollOptimizationsDisabled||this.processVisibleCells()}),this.renderedCellIndices=new Set,this.visibleCellIndices=new Set,this.placeholderCellIndices=new Set}reload(){di(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.removeCell(t)),this.renderedCellIndices.clear(),this.visibleCellIndices.clear(),this.placeholderCellIndices.clear(),this.setupObservations()}scrollToCell(e,t){const i=this.cellContainers[e];if(!i)return!1;const o=t?"smooth":"auto";return i.scrollIntoView({behavior:o}),!0}getVisibleCellIndices(){return Array.from(this.visibleCellIndices)}updated(e){(e.has("itemCount")||e.has("scrollOptimizationsDisabled"))&&this.setupObservations()}disconnectedCallback(){this.intersectionObserver.disconnect()}setupObservations(){this.setupIntersectionObserver()}setupIntersectionObserver(){this.intersectionObserver.disconnect(),this.sentinel&&this.intersectionObserver.observe(this.sentinel),this.scrollOptimizationsDisabled?(di(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.visibleCellIndices.add(t)),this.processVisibleCells()):this.cellContainers.forEach(e=>this.intersectionObserver.observe(e))}render(){var e;const t=this.itemCount-1,i=di(0,t,1),o=(e=this.ariaLandmarkLabel)!==null&&e!==void 0?e:y;return c`
    ...
    `}};s([h({type:Number})],Oe.prototype,"itemCount",void 0);s([h({type:Object})],Oe.prototype,"cellProvider",void 0);s([h({type:Object})],Oe.prototype,"placeholderCellTemplate",void 0);s([h({type:Boolean})],Oe.prototype,"scrollOptimizationsDisabled",void 0);s([h({type:String})],Oe.prototype,"ariaLandmarkLabel",void 0);s([Q("#sentinel")],Oe.prototype,"sentinel",void 0);s([rs(".cell-container")],Oe.prototype,"cellContainers",void 0);Oe=s([F("infinite-scroller")],Oe);/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`,Fs={account:{color:"#000000",icon:Cs,text:"Account"},audio:{color:"#00adef",icon:$s,text:"Audio"},collection:{color:"#4666ff",icon:sr,text:"Collection"},data:{color:"#333333",icon:Ss,text:"Data"},etree:{color:"#00adef",icon:ks,text:"E-tree"},film:{color:"#bf1b2c",icon:fa,text:"Film"},image:{color:"#aa99c9",icon:Ts,text:"Image"},movies:{color:"#f1644b",icon:fa,text:"Movie"},radio:{color:"#8fdaef",icon:zs,text:"Radio"},software:{color:"#9ecc4f",icon:Ms,text:"Software"},texts:{color:"#faab3c",icon:Es,text:"Text"},tv:{color:"#f1644b",icon:Ls,text:"TV"},video:{color:"#f1644b",icon:Ps,text:"Video"},web:{color:"#ffcd27",icon:Ds,text:"Web"}};let Jt=class extends A{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var e,t;const i=["tvnews","tvarchive","television"],o=["radio","radioprogram"];return this.mediatype==="movies"&&((e=this.collections)===null||e===void 0?void 0:e.some(r=>i.indexOf(r)>=0))?"tv":this.mediatype==="audio"&&((t=this.collections)===null||t===void 0?void 0:t.some(r=>o.indexOf(r)>=0))?"radio":this.mediatype||""}render(){const e=Fs[this.displayMediatype];return e?c`
    ...
    `}};s([h({type:String})],Jt.prototype,"mediatype",void 0);s([h({type:Array})],Jt.prototype,"collections",void 0);s([h({type:Boolean})],Jt.prototype,"showText",void 0);Jt=s([F("mediatype-icon")],Jt);const As=I`
...
`;let Pt=class extends A{constructor(){super(...arguments),this.step=2,this.currentPage=1,this.pages=[]}firstUpdated(){this.observePageCount()}updated(e){e.has("size")&&this.observePageCount(),e.has("currentPage")&&(this.observePageCount(),this.emitPageClick())}observePageCount(){this.pages=[];const e=7,t=this.size<=e;if(this.size<=5){this.pages=[...Array(this.size).keys()].map(r=>r+1);return}if(this.size===e){if(this.currentPage===2){this.pages=[1,2,3,4,0,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,4,5,this.size-1,this.size];return}}if(this.currentPage===1){this.pages=[1,2,3,0,this.size];return}if(this.currentPage===this.size){this.pages=[1,0,this.size-2,this.size-1,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,this.size-3,this.size-2,this.size-1,this.size];return}if(t&&this.currentPage>1&&this.currentPage<e){this.pages=[...Array(this.size).keys()].map(r=>r+1);return}let i=this.currentPage-this.step,o=this.currentPage+this.step;i<=0&&(o+=-i+1,i=1),o>=this.size&&(i=Math.max(i-(o-this.size),1),o=this.size),i===2&&(o-=1),o===this.size-1&&(i+=1),this.createFirstNode(i),this.createMiddelNode(i,o),this.createLastNode(o)}createFirstNode(e){var t,i;e>1&&((t=this.pages)===null||t===void 0||t.push(1)),e>2&&((i=this.pages)===null||i===void 0||i.push(0))}createMiddelNode(e,t){var i;for(let o=e;o<=t;o+=1)(i=this.pages)===null||i===void 0||i.push(o)}createLastNode(e){var t,i;e<this.size-1&&((t=this.pages)===null||t===void 0||t.push(0)),e<this.size&&((i=this.pages)===null||i===void 0||i.push(this.size))}get getEllipsisTemplate(){return c`<i class="ellipses">...</i>`}emitPageClick(){this.dispatchEvent(new CustomEvent("pageNumberClicked",{detail:{page:this.currentPage},bubbles:!0,composed:!0}))}onRewind(){this.currentPage-=1,this.currentPage<1&&(this.currentPage=1)}onForward(){this.currentPage+=1,this.currentPage>this.size&&(this.currentPage=this.size)}onChange(e){this.currentPage=e}getPageTemplate(e){return c`
    ...
    `}static get styles(){return[Je,m`
      ...
      `]}};s([h({type:Number})],Pt.prototype,"size",void 0);s([h({type:Number})],Pt.prototype,"step",void 0);s([h({type:Number})],Pt.prototype,"currentPage",void 0);s([T()],Pt.prototype,"pages",void 0);Pt=s([F("more-facets-pagination")],Pt);var cl=I`
...
`;let ft=class extends A{constructor(){super(...arguments),this.collectionPagePath="/details/"}facetClicked(e,t,i){const o=e.target,{checked:r,name:n,value:l}=o;r?this.facetChecked(n,l,t,i):this.facetUnchecked(n,l),this.dispatchFacetClickEvent(n,this.getFacetState(r,i),i)}facetChecked(e,t,i,o){const{selectedFacets:r}=this;let n;r?n=se({},r):n=ei(),n[e][t]={state:this.getFacetState(!0,o),count:i},this.selectedFacets=n,this.dispatchSelectedFacetsChanged()}facetUnchecked(e,t){const{selectedFacets:i}=this;let o;i?o=se({},i):o=ei(),delete o[e][t],this.selectedFacets=o,this.dispatchSelectedFacetsChanged()}getFacetState(e,t){let i;return e?i=t?"hidden":"selected":i="none",i}dispatchFacetClickEvent(e,t,i){const o=new CustomEvent("facetClick",{detail:{key:e,state:t,negative:i},composed:!0});this.dispatchEvent(o)}dispatchSelectedFacetsChanged(){const e=new CustomEvent("selectedFacetsChanged",{detail:this.selectedFacets,bubbles:!0,composed:!0});this.dispatchEvent(e)}getFacetsTemplate(e){let t=e==null?void 0:e.buckets;return t=[...t.filter(i=>i.state==="selected").sort((i,o)=>i.count<o.count?1:-1),...t.filter(i=>i.state==="hidden").sort((i,o)=>i.count<o.count?1:-1),...t.filter(i=>i.state==="none")],c`
    ...
    `}applySearchFacetsClicked(){var e,t;const i=new CustomEvent("facetsChanged",{detail:this.selectedFacets,bubbles:!0,composed:!0});this.dispatchEvent(i),(e=this.modalManager)===null||e===void 0||e.closeModal(),(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:Ie.default,action:`${oe.applyMoreFacetsModal}`,label:`${this.facetKey}`})}cancelClick(){var e,t;(e=this.modalManager)===null||e===void 0||e.closeModal(),(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:Ie.default,action:oe.closeMoreFacetsModal,label:`${this.facetKey}`})}static get styles(){const e=m`var(--primaryButtonBGColor, #194880)`;return[Je,m`
      ...
      `]}};s([h({type:String})],ie.prototype,"facetKey",void 0);s([h({type:String})],ie.prototype,"facetAggregationKey",void 0);s([h({type:String})],ie.prototype,"query",void 0);s([h({type:Object})],ie.prototype,"filterMap",void 0);s([h({type:Object})],ie.prototype,"modalManager",void 0);s([h({type:Object})],ie.prototype,"searchService",void 0);s([h({type:String})],ie.prototype,"searchType",void 0);s([h({type:Object})],ie.prototype,"collectionNameCache",void 0);s([h({type:Object})],ie.prototype,"selectedFacets",void 0);s([h({type:String})],ie.prototype,"sortedBy",void 0);s([h({type:Object,attribute:!1})],ie.prototype,"analyticsHandler",void 0);s([T()],ie.prototype,"aggregations",void 0);s([T()],ie.prototype,"facetGroup",void 0);s([T()],ie.prototype,"facetGroupTitle",void 0);s([T()],ie.prototype,"pageNumber",void 0);s([T()],ie.prototype,"facetsLoading",void 0);s([T()],ie.prototype,"paginationSize",void 0);s([T()],ie.prototype,"facetsType",void 0);ie=s([F("more-facets-content")],ie);let Ia=class extends A{render(){return c`
      <div id="row">
    ...
    `}};Ia=s([F("facet-tombstone-row")],Ia);let Le=class extends A{constructor(){super(...arguments),this.boundEscapeListener=e=>{e.key==="Escape"&&this.closeModal()}}render(){var e,t;return c`
      <div id="container">
    ...
    `}connectedCallback(){var e;(e=super.connectedCallback)===null||e===void 0||e.call(this),this.setupEscapeListener()}disconnectedCallback(){var e;(e=super.disconnectedCallback)===null||e===void 0||e.call(this),this.removeEscapeListener()}setupEscapeListener(){document.addEventListener("keydown",this.boundEscapeListener)}removeEscapeListener(){document.removeEventListener("keydown",this.boundEscapeListener)}histogramDateRangeUpdated(e){this.minSelectedDate=e.detail.minDate,this.maxSelectedDate=e.detail.maxDate}applyBtnClicked(){var e;const t=new CustomEvent("histogramDateRangeApplied",{detail:{minDate:this.minSelectedDate,maxDate:this.maxSelectedDate}});this.dispatchEvent(t),this.closeModal(),(e=this.analyticsHandler)===null||e===void 0||e.sendEvent({category:Ie.default,action:oe.histogramChangedFromModal,label:window.location.href})}closeModal(){this.modalManager&&(this.modalManager.closeModal(),this.dispatchEvent(new CustomEvent("modalClosed")))}static get styles(){return m`
      #container {
        display: flex;
        justify-content: center;
    ...
    `}searchMoreFacetsLink(e){if(!this.moreLinksVisible||e.key==="lending"||Object.keys(e.buckets).length<this.allowedFacetCount)return y;const t=fo[e.key];return c`<button
      class="more-link"
      @click=${()=>{var i;this.showMoreFacetsModal(e,t),(i=this.analyticsHandler)===null||i===void 0||i.sendEvent({category:Ie.default,action:oe.showMoreFacetsModal,label:e.key}),this.dispatchEvent(new CustomEvent("showMoreFacets",{detail:e.key}))}}
    >
      More...
