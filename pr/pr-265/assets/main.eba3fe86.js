...
`;let Xt=class extends A{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1,this.isCompactTile=!1}render(){return c`<div class="icon-overlay ${this.getClass}">
    ...
    `}};s([h({type:Boolean})],Xt.prototype,"loggedIn",void 0);s([h({type:Boolean})],Xt.prototype,"loginRequired",void 0);s([h({type:Boolean})],Xt.prototype,"isCompactTile",void 0);Xt=s([F("icon-overlay")],Xt);let Zt=class extends A{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1,this.iconRequired=!1}render(){return c`
    ...
    `}};s([h({type:Boolean})],Zt.prototype,"loggedIn",void 0);s([h({type:Boolean})],Zt.prototype,"loginRequired",void 0);s([h({type:Boolean})],Zt.prototype,"iconRequired",void 0);Zt=s([F("text-overlay")],Zt);let Ke=class extends A{constructor(){super(...arguments),this.isCompactTile=!1,this.isListTile=!1,this.loggedIn=!1,this.viewSize="desktop"}render(){var e;return!((e=this.model)===null||e===void 0)&&e.identifier?c`
    ...
    `}};s([h({type:String})],Ke.prototype,"baseImageUrl",void 0);s([h({type:Boolean})],Ke.prototype,"isCompactTile",void 0);s([h({type:Boolean})],Ke.prototype,"isListTile",void 0);s([h({type:Boolean})],Ke.prototype,"loggedIn",void 0);s([h({type:Object})],Ke.prototype,"model",void 0);s([h({type:String})],Ke.prototype,"viewSize",void 0);Ke=s([F("image-block")],Ke);let no=class extends ce{constructor(){super(...arguments),this.showInfoButton=!1}render(){return c`
      <div class="container">
    ...
    >`}get getSizeTemplate(){var e,t;const i=(t=(e=this.model)===null||e===void 0?void 0:e.collectionSize)!==null&&t!==void 0?t:0;return i?c`<span id="item-size">${gs(i,1)}</span>`:""}get infoButtonTemplate(){return this.showInfoButton?c`<button class="info-button" @click=${this.infoButtonPressed}>
      ...
      `]}};s([h({type:Boolean})],no.prototype,"showInfoButton",void 0);no=s([F("collection-tile")],no);function wi(a,e="short",t="en-US"){if(!a)return"";const i={};switch(e){case"year-only":i.year="numeric";break;case"short":i.month="short",i.year="numeric";break;case"long":i.year="numeric",i.month="short",i.day="2-digit";break}return new Intl.DateTimeFormat(t,i).format(a)}function ws(a){return new Date(a.getTime()-a.getTimezoneOffset()*1e3*60)}function Lo(a){return a?ws(a).toISOString().endsWith("-01-01T00:00:00.000Z"):!1}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*ui(a,e){const t=typeof e=="function";if(a!==void 0){let i=-1;for(const o of a)i>-1&&(yield t?e(i):e),i++,yield o}}let xi=class extends A{constructor(){super(...arguments),this.snippets=[],this.viewSize="desktop"}render(){var e;return!((e=this.snippets)===null||e===void 0)&&e.length?c`
      <div class="container">
    ...
    `}};s([h({type:Array})],xi.prototype,"snippets",void 0);s([h({type:String})],xi.prototype,"viewSize",void 0);xi=s([F("text-snippet-block")],xi);const xs=m`
  .drop-shadow {
    overflow: hidden;
    height: 100%;
  }
...
`;let Re=class extends A{constructor(){super(...arguments),this.isListTile=!1,this.isCompactTile=!1,this.loggedIn=!1,this.isWaveform=!1}render(){return c`
...
`,Fs={account:{color:"#000000",icon:Cs,text:"Account"},audio:{color:"#00adef",icon:$s,text:"Audio"},collection:{color:"#4666ff",icon:sr,text:"Collection"},data:{color:"#333333",icon:Ss,text:"Data"},etree:{color:"#00adef",icon:ks,text:"E-tree"},film:{color:"#bf1b2c",icon:fa,text:"Film"},image:{color:"#aa99c9",icon:Ts,text:"Image"},movies:{color:"#f1644b",icon:fa,text:"Movie"},radio:{color:"#8fdaef",icon:zs,text:"Radio"},software:{color:"#9ecc4f",icon:Ms,text:"Software"},texts:{color:"#faab3c",icon:Es,text:"Text"},tv:{color:"#f1644b",icon:Ls,text:"TV"},video:{color:"#f1644b",icon:Ps,text:"Video"},web:{color:"#ffcd27",icon:Ds,text:"Web"}};let Jt=class extends A{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var e,t;const i=["tvnews","tvarchive","television"],o=["radio","radioprogram"];return this.mediatype==="movies"&&((e=this.collections)===null||e===void 0?void 0:e.some(r=>i.indexOf(r)>=0))?"tv":this.mediatype==="audio"&&((t=this.collections)===null||t===void 0?void 0:t.some(r=>o.indexOf(r)>=0))?"radio":this.mediatype||""}render(){const e=Fs[this.displayMediatype];return e?c`
    ...
    `}};s([h({type:String})],Jt.prototype,"mediatype",void 0);s([h({type:Array})],Jt.prototype,"collections",void 0);s([h({type:Boolean})],Jt.prototype,"showText",void 0);Jt=s([F("mediatype-icon")],Jt);const As=O`
...
`;function Rs(a,e){let t=1;return a>=1e9?t=1e9:a>=1e6?t=1e6:a>=1e3&&e==="short"&&(t=1e3),t}function Ns(a=0,e){const t=a/e,i=t<10;let o=0;return i?o=Math.round((t+Number.EPSILON)*10)/10:o=Math.round(t),o}function Us(a,e,t,i){switch(e){case 1e9:return I(t==="short"?pt`${a}B`:pt`${a} billion`);case 1e6:return I(t==="short"?pt`${a}M`:pt`${a} million`);case 1e3:return I(t==="short"?pt`${a}K`:pt`${a} thousand`);default:return new Intl.NumberFormat(i).format(a)}}function Vt(a,e="long",t="short",i="en-US"){const o=a!=null?a:-1;if(o<0)return"";const r=Rs(o,e),n=Ns(o,r);return Us(n,r,t,i)}let Ye=class extends A{render(){var e;const t=Vt(this.favCount,"short","short"),i=Vt(this.commentCount,"short","short"),o=this.mediatype==="account"?`${this.itemCount} uploads`:`${this.viewCount} ${(e=this.viewLabel)!==null&&e!==void 0?e:"all-time views"}`;return c`
    ...
    `}get isSortedByDate(){var e;return["date","reviewdate","addeddate","publicdate"].includes((e=this.sortParam)===null||e===void 0?void 0:e.field)}get hasSnippets(){var e,t;return!!(!((t=(e=this.model)===null||e===void 0?void 0:e.snippets)===null||t===void 0)&&t.length)}infoButtonPressed(e){e.preventDefault();const t=new CustomEvent("infoButtonPressed",{detail:{x:e.clientX,y:e.clientY}});this.dispatchEvent(t)}static get styles(){const e=m`var(--tileBorderColor, #dddddd)`;return[Eo,m`
      ...
      `]}};s([h({type:Boolean})],lo.prototype,"showInfoButton",void 0);lo=s([F("item-tile")],lo);let co=class extends ce{constructor(){super(...arguments),this.showInfoButton=!1}render(){return c`
      <div class="container">
        ${this.infoButtonTemplate}
        <div class="tile-details">
          <div class="item-info">
    ...
    >
      ...
      `]}};s([h({type:Boolean})],co.prototype,"showInfoButton",void 0);co=s([F("account-tile")],co);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`+ve),ze&&(ve=je(ve,et," "),ve=je(ve,tt," ")),q&&ri?q.createHTML(ve):ve},e.setConfig=function(S){Di(S),rt=!0},e.clearConfig=function(){St=null,rt=!1},e.isValidAttribute=function(S,p,x){St||Di({});var _=nt(S),N=nt(p);return qo(_,N,x)},e.addHook=function(S,p){typeof p=="function"&&(re[S]=re[S]||[],Ht(re[S],p))},e.removeHook=function(S){if(re[S])return ba(re[S])},e.removeHooks=function(S){re[S]&&(re[S]=[])},e.removeAllHooks=function(){re={}},e}var fi=cr(),$;(function(a){a.default="default",a.relevance="relevance",a.alltimeview="alltimeview",a.weeklyview="weeklyview",a.title="title",a.date="date",a.datearchived="datearchived",a.datereviewed="datereviewed",a.dateadded="dateadded",a.creator="creator"})($||($={}));const ht={default:"",relevance:"Relevance",alltimeview:"All-time views",weeklyview:"Weekly views",title:"Title",date:"Date published",datearchived:"Date archived",datereviewed:"Date reviewed",dateadded:"Date added",creator:"Creator"},Ca={default:null,relevance:null,alltimeview:"desc",weeklyview:"desc",title:"asc",date:"desc",datearchived:"desc",datereviewed:"desc",dateadded:"desc",creator:"asc"},gn={default:null,relevance:null,alltimeview:"downloads",weeklyview:"week",title:"titleSorter",date:"date",datearchived:"publicdate",datereviewed:"reviewdate",dateadded:"addeddate",creator:"creatorSorter"},bn={week:$.weeklyview,downloads:$.alltimeview,titleSorter:$.title,date:$.date,publicdate:$.datearchived,reviewdate:$.datereviewed,addeddate:$.dateadded,creatorSorter:$.creator},yn={week:"week",downloads:"downloads",titleSorter:"title",date:"date",publicdate:"publicdate",reviewdate:"reviewdate",addeddate:"addeddate",creatorSorter:"creator"},$a={week:$.weeklyview,downloads:$.alltimeview,title:$.title,titleSorter:$.title,date:$.date,publicdate:$.datearchived,reviewdate:$.datereviewed,addeddate:$.dateadded,creator:$.creator,creatorSorter:$.creator},wn={title:"firstTitle",creator:"firstCreator"},ei=()=>({subject:{},lending:{},mediatype:{},language:{},creator:{},collection:{},year:{}}),xn=["mediatype","lending","year","subject","collection","creator","language"],Ci={subject:"Subject",lending:"Availability",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"},fo={subject:Z.COUNT,lending:Z.COUNT,mediatype:Z.COUNT,language:Z.COUNT,creator:Z.COUNT,collection:Z.COUNT,year:Z.NUMERIC},_n={subject:Z.ALPHABETICAL,lending:Z.ALPHABETICAL,mediatype:Z.ALPHABETICAL,language:Z.ALPHABETICAL,creator:Z.ALPHABETICAL,collection:Z.ALPHABETICAL,year:Z.NUMERIC},Cn={is_lendable:!0,is_borrowable:!1,available_to_borrow:!0,is_browsable:!1,available_to_browse:!1,is_readable:!0,available_to_waitlist:!1},Sa={is_lendable:"Lending Library",available_to_borrow:"Borrow 14 Days",is_readable:"Always Available"},Po={deemphasize:!0,community:!0,stream_only:!0,samples_only:!0,test_collection:!0,printdisabled:!0,"openlibrary-ol":!0,nationalemergencylibrary:!0,china:!0,americana:!0,toronto:!0};let $i=class extends ce{constructor(){super(...arguments),this.collectionLinks=[]}render(){return c`
    ...
    `}};s([h({type:Object})],$i.prototype,"collectionNameCache",void 0);s([T()],$i.prototype,"collectionLinks",void 0);$i=s([F("tile-list")],$i);let Xe=class extends A{constructor(){super(...arguments),this.loggedIn=!1}render(){return c`
      <div id="container">
        <tile-list
          .model=${this.model}
    ...
    `}};s([h({type:Object})],Xe.prototype,"model",void 0);s([h({type:String})],Xe.prototype,"baseNavigationUrl",void 0);s([h({type:String})],Xe.prototype,"baseImageUrl",void 0);s([h({type:Boolean})],Xe.prototype,"loggedIn",void 0);s([h({type:Object})],Xe.prototype,"sortParam",void 0);s([h({type:Object})],Xe.prototype,"collectionNameCache",void 0);Xe=s([F("tile-hover-pane")],Xe);let ka=class extends ce{render(){var e,t,i,o,r,n;return c`
      <div id="list-line" class="${this.classSize}">
        <image-block
          .model=${this.model}
          .baseImageUrl=${this.baseImageUrl}
    ...
    `}};ka=s([F("tile-list-compact")],ka);let Ta=class extends ce{render(){return c`
  ...
  `;bo=s([F("ia-icon-label")],bo);let yo=class extends A{constructor(){super(...arguments),this.numResults=0}render(){return c`
    ...
    `}};s([h({type:Number})],yo.prototype,"numResults",void 0);yo=s([F("alpha-bar-tooltip")],yo);let Ue=class extends A{constructor(){super(...arguments),this.selectedLetter=null,this.tooltipShown=!1,this.alphabet="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("")}get selectedUppercaseLetter(){var e;return(e=this.selectedLetter)===null||e===void 0?void 0:e.toUpperCase()}render(){var e;return c`
  ...
  `;s([h({type:String})],Ue.prototype,"selectedLetter",void 0);s([h({type:Object})],Ue.prototype,"letterCounts",void 0);s([h({type:String})],Ue.prototype,"ariaLandmarkLabel",void 0);s([T()],Ue.prototype,"tooltipShown",void 0);s([T()],Ue.prototype,"hoveredLetter",void 0);s([Q("alpha-bar-tooltip")],Ue.prototype,"tooltip",void 0);Ue=s([F("alpha-bar")],Ue);const Sn=c`
...
`;let te=class extends A{constructor(){super(...arguments),this.prompt="Do you find this feature useful?",this.buttonText="Beta",this.isOpen=!1,this.processing=!1,this.popupTopX=0,this.popupTopY=0,this.voteSubmitted=!1,this.voteNeedsChoosing=!1,this.resizingElement=document.body}render(){return c`
      <button
        id="beta-button"
...
`;let xo=class extends A{constructor(){super(...arguments),this.config=new wo}render(){return c`
    ...
    `}};s([h({type:Object})],xo.prototype,"config",void 0);xo=s([F("modal-template")],xo);function rl(a,e,t){var i=t||{},o=i.noTrailing,r=o===void 0?!1:o,n=i.noLeading,l=n===void 0?!1:n,d=i.debounceMode,u=d===void 0?void 0:d,v,f=!1,g=0;function w(){v&&clearTimeout(v)}function C(L){var P=L||{},R=P.upcomingOnly,he=R===void 0?!1:R;w(),f=!he}function E(){for(var L=arguments.length,P=new Array(L),R=0;R<L;R++)P[R]=arguments[R];var he=this,q=Date.now()-g;if(f)return;function H(){g=Date.now(),e.apply(he,P)}function K(){v=void 0}!l&&u&&!v&&H(),w(),u===void 0&&q>a?l?(g=Date.now(),r||(v=setTimeout(u?K:H,a))):H():r!==!0&&(v=setTimeout(u?K:H,u===void 0?a-q:a))}return E.cancel=C,E}var vt;(function(a){a.Open="open",a.Closed="closed"})(vt||(vt={}));class sl{constructor(e){this.windowResizeThrottler=rl(100,this.updateModalContainerHeight,{noLeading:!1,noTrailing:!1}).bind(this),this.modalManager=e}handleModeChange(e){switch(e){case vt.Open:this.startResizeListener(),this.stopDocumentScroll();break;case vt.Closed:this.stopResizeListener(),this.resumeDocumentScroll();break}}updateModalContainerHeight(){this.modalManager.style.setProperty("--containerHeight",`${window.innerHeight}px`)}stopDocumentScroll(){document.body.classList.add("modal-manager-open")}resumeDocumentScroll(){document.body.classList.remove("modal-manager-open")}startResizeListener(){window.addEventListener("resize",this.windowResizeThrottler)}stopResizeListener(){window.removeEventListener("resize",this.windowResizeThrottler)}}let Lt=class extends A{constructor(){super(...arguments),this.mode=vt.Closed,this.hostBridge=new sl(this),this.closeOnBackdropClick=!0}render(){return c`
      <div class="container">
...
`;let Pt=class extends A{constructor(){super(...arguments),this.step=2,this.currentPage=1,this.pages=[]}firstUpdated(){this.observePageCount()}updated(e){e.has("size")&&this.observePageCount(),e.has("currentPage")&&(this.observePageCount(),this.emitPageClick())}observePageCount(){this.pages=[];const e=7,t=this.size<=e;if(this.size<=5){this.pages=[...Array(this.size).keys()].map(r=>r+1);return}if(this.size===e){if(this.currentPage===2){this.pages=[1,2,3,4,0,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,4,5,this.size-1,this.size];return}}if(this.currentPage===1){this.pages=[1,2,3,0,this.size];return}if(this.currentPage===this.size){this.pages=[1,0,this.size-2,this.size-1,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,this.size-3,this.size-2,this.size-1,this.size];return}if(t&&this.currentPage>1&&this.currentPage<e){this.pages=[...Array(this.size).keys()].map(r=>r+1);return}let i=this.currentPage-this.step,o=this.currentPage+this.step;i<=0&&(o+=-i+1,i=1),o>=this.size&&(i=Math.max(i-(o-this.size),1),o=this.size),i===2&&(o-=1),o===this.size-1&&(i+=1),this.createFirstNode(i),this.createMiddelNode(i,o),this.createLastNode(o)}createFirstNode(e){var t,i;e>1&&((t=this.pages)===null||t===void 0||t.push(1)),e>2&&((i=this.pages)===null||i===void 0||i.push(0))}createMiddelNode(e,t){var i;for(let o=e;o<=t;o+=1)(i=this.pages)===null||i===void 0||i.push(o)}createLastNode(e){var t,i;e<this.size-1&&((t=this.pages)===null||t===void 0||t.push(0)),e<this.size&&((i=this.pages)===null||i===void 0||i.push(this.size))}get getEllipsisTemplate(){return c`<i class="ellipses">...</i>`}emitPageClick(){this.dispatchEvent(new CustomEvent("pageNumberClicked",{detail:{page:this.currentPage},bubbles:!0,composed:!0}))}onRewind(){this.currentPage-=1,this.currentPage<1&&(this.currentPage=1)}onForward(){this.currentPage+=1,this.currentPage>this.size&&(this.currentPage=this.size)}onChange(e){this.currentPage=e}getPageTemplate(e){return c`
    ...
    `}static get styles(){return[Je,m`
      ...
      `]}};s([h({type:Number})],Pt.prototype,"size",void 0);s([h({type:Number})],Pt.prototype,"step",void 0);s([h({type:Number})],Pt.prototype,"currentPage",void 0);s([T()],Pt.prototype,"pages",void 0);Pt=s([F("more-facets-pagination")],Pt);var cl=O`
...
`;let ft=class extends A{constructor(){super(...arguments),this.collectionPagePath="/details/"}facetClicked(e,t,i){const o=e.target,{checked:r,name:n,value:l}=o;r?this.facetChecked(n,l,t,i):this.facetUnchecked(n,l),this.dispatchFacetClickEvent(n,this.getFacetState(r,i),i)}facetChecked(e,t,i,o){const{selectedFacets:r}=this;let n;r?n=se({},r):n=ei(),n[e][t]={state:this.getFacetState(!0,o),count:i},this.selectedFacets=n,this.dispatchSelectedFacetsChanged()}facetUnchecked(e,t){const{selectedFacets:i}=this;let o;i?o=se({},i):o=ei(),delete o[e][t],this.selectedFacets=o,this.dispatchSelectedFacetsChanged()}getFacetState(e,t){let i;return e?i=t?"hidden":"selected":i="none",i}dispatchFacetClickEvent(e,t,i){const o=new CustomEvent("facetClick",{detail:{key:e,state:t,negative:i},composed:!0});this.dispatchEvent(o)}dispatchSelectedFacetsChanged(){const e=new CustomEvent("selectedFacetsChanged",{detail:this.selectedFacets,bubbles:!0,composed:!0});this.dispatchEvent(e)}getFacetsTemplate(e){let t=e==null?void 0:e.buckets;return t=[...t.filter(i=>i.state==="selected").sort((i,o)=>i.count<o.count?1:-1),...t.filter(i=>i.state==="hidden").sort((i,o)=>i.count<o.count?1:-1),...t.filter(i=>i.state==="none")],c`
    ...
    `}applySearchFacetsClicked(){var e,t;const i=new CustomEvent("facetsChanged",{detail:this.selectedFacets,bubbles:!0,composed:!0});this.dispatchEvent(i),(e=this.modalManager)===null||e===void 0||e.closeModal(),(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:Oe.default,action:`${oe.applyMoreFacetsModal}`,label:`${this.facetKey}`})}cancelClick(){var e,t;(e=this.modalManager)===null||e===void 0||e.closeModal(),(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:Oe.default,action:oe.closeMoreFacetsModal,label:`${this.facetKey}`})}static get styles(){const e=m`var(--primaryButtonBGColor, #194880)`;return[Je,m`
      ...
      `]}};s([h({type:String})],ie.prototype,"facetKey",void 0);s([h({type:String})],ie.prototype,"facetAggregationKey",void 0);s([h({type:String})],ie.prototype,"query",void 0);s([h({type:Object})],ie.prototype,"filterMap",void 0);s([h({type:Object})],ie.prototype,"modalManager",void 0);s([h({type:Object})],ie.prototype,"searchService",void 0);s([h({type:String})],ie.prototype,"searchType",void 0);s([h({type:Object})],ie.prototype,"collectionNameCache",void 0);s([h({type:Object})],ie.prototype,"selectedFacets",void 0);s([h({type:String})],ie.prototype,"sortedBy",void 0);s([h({type:Object,attribute:!1})],ie.prototype,"analyticsHandler",void 0);s([T()],ie.prototype,"aggregations",void 0);s([T()],ie.prototype,"facetGroup",void 0);s([T()],ie.prototype,"facetGroupTitle",void 0);s([T()],ie.prototype,"pageNumber",void 0);s([T()],ie.prototype,"facetsLoading",void 0);s([T()],ie.prototype,"paginationSize",void 0);s([T()],ie.prototype,"facetsType",void 0);ie=s([F("more-facets-content")],ie);let Oa=class extends A{render(){return c`
      <div id="row">
    ...
    `}};Oa=s([F("facet-tombstone-row")],Oa);let Le=class extends A{constructor(){super(...arguments),this.boundEscapeListener=e=>{e.key==="Escape"&&this.closeModal()}}render(){var e,t;return c`
      <div id="container">
...
`,Ge;let xe=Ge=class extends A{constructor(){super(...arguments),this.placeholderType=null,this.detailMessage=""}render(){return this.placeholderType?c`${this.placeholderTemplate}`:y}get placeholderTemplate(){return c`
      <div
