...
`;var He;let Te=He=class extends B{constructor(){super(...arguments),this.placeholderType=null,this.detailMessage=""}render(){return this.placeholderType?c`${this.placeholderTemplate}`:b}get placeholderTemplate(){return c`
      <div
...
`;function Pi(r,e="short",t="en-US"){if(!r)return"";const i={};switch(e){case"year-only":return`${r.getUTCFullYear()}`;case"short":i.month="short",i.year="numeric";break;case"long":i.year="numeric",i.month="short",i.day="2-digit";break}return new Intl.DateTimeFormat(t,i).format(r)}class ra{constructor(e={}){var t;this.model=e.model,this.baseNavigationUrl=e.baseNavigationUrl,this.collectionPagePath=(t=e.collectionPagePath)!==null&&t!==void 0?t:"/details/",this.sortParam=e.sortParam,this.creatorFilter=e.creatorFilter}get firstCreatorMatchingFilter(){var e,t;let i;if(this.creatorFilter&&(!((e=this.model)===null||e===void 0)&&e.creators.length)){const o=this.creatorFilter;i=this.model.creators.find(s=>s.normalize("NFD").replace(/[^A-Z]+/gi,"").toUpperCase().startsWith(o))}return i??((t=this.model)===null||t===void 0?void 0:t.creator)}get accountLabel(){var e;return!((e=this.model)===null||e===void 0)&&e.dateAdded?C(at`Archivist since ${this.model.dateAdded.getFullYear()}`):""}get dateLabel(){var e;switch((e=this.sortParam)===null||e===void 0?void 0:e.field){case"publicdate":return C("Archived");case"reviewdate":return C("Reviewed");case"addeddate":return C("Added");case"date":return C("Published");default:return""}}itemPageUrl(e,t=!1){if(!e||this.baseNavigationUrl==null)return b;const i=t?this.collectionPagePath:"/details/";return`${this.baseNavigationUrl}${i}${e}`}webArchivesCaptureLink(e,t){const o=`https://web.archive.org/web/${t.toISOString().replace(/[TZ:-]/g,"").replace(/\..*/,"")}/${encodeURIComponent(e)}`,s=Pi(t,"long");return c` <a href=${o}> ${s} </a> `}}class de extends B{constructor(){super(...arguments),this.sortParam=null,this.defaultSortParam=null,this.loggedIn=!1,this.displayValueProvider=new ra}willUpdate(e){var t,i;(e.has("model")||e.has("baseNavigationUrl")||e.has("collectionPagePath")||e.has("sortParam")||e.has("defaultSortParam")||e.has("creatorFilter"))&&(this.displayValueProvider=new ra({model:this.model,baseNavigationUrl:this.baseNavigationUrl,collectionPagePath:this.collectionPagePath,sortParam:(i=(t=this.sortParam)!==null&&t!==void 0?t:this.defaultSortParam)!==null&&i!==void 0?i:void 0,creatorFilter:this.creatorFilter}))}}n([h({type:Object})],de.prototype,"model",void 0);n([h({type:Number})],de.prototype,"currentWidth",void 0);n([h({type:Number})],de.prototype,"currentHeight",void 0);n([h({type:String})],de.prototype,"baseNavigationUrl",void 0);n([h({type:String})],de.prototype,"baseImageUrl",void 0);n([h({type:String})],de.prototype,"collectionPagePath",void 0);n([h({type:Object})],de.prototype,"sortParam",void 0);n([h({type:Object})],de.prototype,"defaultSortParam",void 0);n([h({type:String})],de.prototype,"creatorFilter",void 0);n([h({type:Number})],de.prototype,"mobileBreakpoint",void 0);n([h({type:Boolean})],de.prototype,"loggedIn",void 0);let Dr=class extends B{render(){return c`<div class="icon-overlay">${this.iconTemplate}</div>`}get iconTemplate(){var e;return this.type?c`${(e=sn[this.type])!==null&&e!==void 0?e:b}`:b}static get styles(){return m`
    ...
    `}};n([h({type:String})],Dr.prototype,"type",void 0);Dr=n([F("icon-overlay")],Dr);let Ar=class extends B{render(){return c`
    ...
    `}};n([h({type:String})],Ar.prototype,"type",void 0);Ar=n([F("text-overlay")],Ar);let pt=class extends B{constructor(){super(...arguments),this.isCompactTile=!1,this.isListTile=!1,this.loggedIn=!1,this.viewSize="desktop"}render(){var e;return!((e=this.model)===null||e===void 0)&&e.identifier?c`
...
`;let Zt=class extends B{constructor(){super(...arguments),this.title="",this.body="",this.starRating=0,this.viewSize="desktop"}render(){return!this.title&&!this.body&&!this.starRating?b:c`
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*io(r,e){const t=typeof e=="function";if(r!==void 0){let i=-1;for(const o of r)i>-1&&(yield t?e(i):e),i++,yield o}}let go=class extends B{constructor(){super(...arguments),this.snippets=[],this.viewSize="desktop"}render(){var e;return!((e=this.snippets)===null||e===void 0)&&e.length?c`
      <div class="container">
        <div class="snippet-view ${this.viewSize}">
...
`;let Ge=class extends B{constructor(){super(...arguments),this.isListTile=!1,this.isCompactTile=!1,this.loggedIn=!1,this.isWaveform=!1,this.isNotFound=!1}render(){return c`
...
`,fn={account:{color:"#000000",icon:cd,text:"Account"},audio:{color:"#00adef",icon:hd,text:"Audio"},collection:{color:"#4666ff",icon:hn,text:"Collection"},data:{color:"#333333",icon:pd,text:"Data"},etree:{color:"#00adef",icon:ud,text:"E-tree"},film:{color:"#bf1b2c",icon:sa,text:"Film"},image:{color:"#aa99c9",icon:fd,text:"Image"},movies:{color:"#f1644b",icon:sa,text:"Movie"},radio:{color:"#8fdaef",icon:md,text:"Radio"},software:{color:"#9ecc4f",icon:vd,text:"Software"},texts:{color:"#faab3c",icon:gd,text:"Text"},tv:{color:"#f1644b",icon:bd,text:"TV"},video:{color:"#f1644b",icon:yd,text:"Video"},web:{color:"#ffcd27",icon:wd,text:"Web"},search:{color:"#000000",icon:un,text:"Search"}};let Fi=class extends B{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var e,t;const i=["tvnews","tvarchive","television"],o=["radio","radioprogram"];return this.mediatype==="movies"&&(!((e=this.collections)===null||e===void 0)&&e.some(s=>i.indexOf(s)>=0))?"tv":this.mediatype==="audio"&&(!((t=this.collections)===null||t===void 0)&&t.some(s=>o.indexOf(s)>=0))?"radio":this.mediatype||""}render(){const e=fn[this.displayMediatype];return e?c`
      <div
        id="icon"
...
`;function Cd(r,e){let t=1;return r>=1e9?t=1e9:r>=1e6?t=1e6:r>=1e3&&e==="short"&&(t=1e3),t}function kd(r=0,e){const t=r/e,i=t<10;let o=0;return i?o=Math.round((t+Number.EPSILON)*10)/10:o=Math.round(t),o}function Td(r,e,t,i){switch(e){case 1e9:return C(t==="short"?at`${r}B`:at`${r} billion`);case 1e6:return C(t==="short"?at`${r}M`:at`${r} million`);case 1e3:return C(t==="short"?at`${r}K`:at`${r} thousand`);default:return new Intl.NumberFormat(i).format(r)}}function ss(r,e="long",t="short",i="en-US"){const o=r??-1;if(o<0)return"";const s=Cd(o,e),a=kd(o,s);return Td(a,s,t,i)}let qe=class extends B{constructor(){super(...arguments),this.showTvClips=!1}render(){return c`
...
`+_e),Ft&&Ki([Ie,Q,ne],Ue=>{_e=mi(_e,Ue," ")}),R&&Hi?R.createHTML(_e):_e},e.setConfig=function(){let A=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};No(A),Po=!0},e.clearConfig=function(){Nt=null,Po=!1},e.isValidAttribute=function(A,f,x){Nt||No({});const M=ce(A),X=ce(f);return ks(M,X,x)},e.addHook=function(A,f){typeof f=="function"&&fi(q[A],f)},e.removeHook=function(A,f){if(f!==void 0){const x=zd(q[A],f);return x===-1?void 0:Ld(q[A],x,1)[0]}return na(q[A])},e.removeHooks=function(A){q[A]=[]},e.removeAllHooks=function(){q=fa()},e}var ro=yn();let yo=class extends de{constructor(){super(...arguments),this.collectionLinks=[]}render(){return c`
    ...
    `}};n([h({type:Object})],yo.prototype,"collectionTitles",void 0);n([z()],yo.prototype,"collectionLinks",void 0);yo=n([F("tile-list")],yo);let Qe=class extends B{constructor(){super(...arguments),this.loggedIn=!1}render(){return c`
      <div id="container">
        ${this.headerTemplate}
...
fill=""></path>
  ...
  `;Or=n([F("ia-icon-label")],Or);let Nr=class extends B{constructor(){super(...arguments),this.numResults=0}render(){return c`
    ...
    `}};n([h({type:Number})],Nr.prototype,"numResults",void 0);Nr=n([F("alpha-bar-tooltip")],Nr);let it=class extends B{constructor(){super(...arguments),this.selectedLetter=null,this.tooltipShown=!1,this.alphabet="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("")}get selectedUppercaseLetter(){var e;return(e=this.selectedLetter)===null||e===void 0?void 0:e.toUpperCase()}render(){var e;return c`
...
`;class pc extends B{static get styles(){return m`
      :host {
...
`;let Hr=class extends B{constructor(){super(...arguments),this.config=new kt}render(){return c`
...
`;let wo=class extends B{constructor(){super(...arguments),this.items=[]}render(){return c`
      <ul>
    ...
    `}};n([h({type:Object})],wo.prototype,"items",void 0);n([h({type:String})],wo.prototype,"message",void 0);wo=n([F("remove-items-modal-content")],wo);let Ye=class extends B{constructor(){super(...arguments),this.label=C("Select items to remove"),this.selectedItems=[],this.showSelectAll=!1,this.showUnselectAll=!1,this.showItemManageButton=!1,this.removeAllowed=!1}render(){return c`
...
`;let re=class extends B{constructor(){super(...arguments),this.prompt="Do you find this feature useful?",this.buttonText="Beta",this.isOpen=!1,this.processing=!1,this.popupTopX=0,this.popupTopY=0,this.voteSubmitted=!1,this.voteNeedsChoosing=!1,this.resizingElement=document.body}render(){return c`
      <button
        id="beta-button"
...
`;var Wr;let Ri=Wr=class extends B{render(){return c`${this.facetRowTemplate}`}get facetRowTemplate(){var e,t,i,o;const{bucket:s,facetType:a}=this;if(!s||!a)return b;const l=`${a}:${s.key}-show-only`,d=`${a}:${s.key}-negative`,p=a!=="collection"?c`${(e=s.displayText)!==null&&e!==void 0?e:s.key}`:c`<a href="/details/${s.key}">
    ...
    `}};n([h({type:Object})],$o.prototype,"facetGroup",void 0);n([h({type:Object})],$o.prototype,"collectionTitles",void 0);$o=n([F("facets-template")],$o);let ut=class extends B{constructor(){super(...arguments),this.leftValue="",this.rightValue="",this.side="left"}render(){var e,t;return c`
      <div id="container">
    ...
    `}};Ra=n([F("facet-tombstone-row")],Ra);let Ke=class extends B{constructor(){super(...arguments),this.boundEscapeListener=e=>{e.key==="Escape"&&this.closeModal()}}render(){var e,t;return c`
      <div id="container">
...
`;function H0(r){return r&&r.charAt(0).toLocaleUpperCase()+r.slice(1)}let Bi=class extends B{constructor(){super(...arguments),this.selected=!1}render(){var e,t;if(!this.facetInfo)return b;const i=this.facetInfo.facets.length===1,o=this.facetInfo.facets[0],s=H0((this.labelPrefix?`${this.labelPrefix} `:"")+((t=(e=this.facetInfo.label)!==null&&e!==void 0?e:o.displayText)!==null&&t!==void 0?t:o.bucketKey));if(!s)return b;const a=i&&o.facetType==="mediatype"?fn[o.bucketKey].icon:b;return c`
    ...
    `}};n([h({type:Object})],Bi.prototype,"facetInfo",void 0);n([h({type:String})],Bi.prototype,"labelPrefix",void 0);n([h({type:Boolean})],Bi.prototype,"selected",void 0);Bi=n([F("smart-facet-button")],Bi);let ii=class extends B{render(){var e,t;if(!this.facetInfo||!this.activeFacetRef||this.facetInfo.length===0)return b;const i=(e=this.activeFacetRef.displayText)!==null&&e!==void 0?e:this.activeFacetRef.bucketKey;return i?c`
