(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function t(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerPolicy&&(r.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?r.credentials="include":o.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(o){if(o.ep)return;o.ep=!0;const r=t(o);fetch(o.href,r)}})();function n(s,e,t,i){var o=arguments.length,r=o<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(s,e,t,i);else for(var l=s.length-1;l>=0;l--)(a=s[l])&&(r=(o<3?a(r):o>3?a(e,t,r):a(e,t))||r);return o>3&&r&&Object.defineProperty(e,t,r),r}function Lr(s,e,t,i){function o(r){return r instanceof t?r:new t(function(a){a(r)})}return new(t||(t=Promise))(function(r,a){function l(u){try{p(i.next(u))}catch(v){a(v)}}function d(u){try{p(i.throw(u))}catch(v){a(v)}}function p(u){u.done?r(u.value):o(u.value).then(l,d)}p((i=i.apply(s,e||[])).next())})}class On{constructor(e){var t,i,o,r;this.ARCHIVE_ANALYTICS_VERSION=2,this.DEFAULT_SERVICE="ao_2",this.NO_SAMPLING_SERVICE="ao_no_sampling",this.DEFAULT_IMAGE_URL="https://athena.archive.org/0.gif",this.defaultService=(t=e?.defaultService)!==null&&t!==void 0?t:this.DEFAULT_SERVICE,this.imageUrl=(i=e?.imageUrl)!==null&&i!==void 0?i:this.DEFAULT_IMAGE_URL,this.imageContainer=(o=e?.imageContainer)!==null&&o!==void 0?o:document.body,this.requireImagePing=(r=e?.requireImagePing)!==null&&r!==void 0?r:!1}sendPing(e){const t=this.generateTrackingUrl(e).toString();if(this.requireImagePing){this.sendPingViaImage(t);return}const i=navigator.sendBeacon&&navigator.sendBeacon.bind(navigator);try{i(t)}catch{this.sendPingViaImage(t)}}sendEvent(e){const t=e.label&&e.label.trim().length>0?e.label:window.location.pathname,i={kind:"event",ec:e.category,ea:e.action,el:t,cache_bust:Math.random(),...e.eventConfiguration};this.sendPing(i)}sendEventNoSampling(e){const t=e.eventConfiguration||{};t.service=this.NO_SAMPLING_SERVICE;const i=e;i.eventConfiguration=t,this.sendEvent(i)}sendPingViaImage(e){const t=new Image(1,1);t.src=e,t.alt="",this.imageContainer.appendChild(t)}generateTrackingUrl(e){var t;const i=e??{};i.service=(t=i.service)!==null&&t!==void 0?t:this.defaultService;const o=new URL(this.imageUrl),r=Object.keys(i);return r.forEach(a=>{const l=i[a];o.searchParams.append(a,l)}),o.searchParams.append("version",`${this.ARCHIVE_ANALYTICS_VERSION}`),o.searchParams.append("count",`${r.length+2}`),o}}function S(s){let e,t,i;return typeof s=="object"?(e=s.hashFunction,t=s.expiring,i=s.tags):e=s,(o,r,a)=>{if(a.value!=null)a.value=Pr(a.value,e,t,i);else if(a.get!=null)a.get=Pr(a.get,e,t,i);else throw"Only put a Memoize() decorator on a method or get accessor."}}const Ho=new Map;function Pr(s,e,t=0,i){const o=Symbol("__memoized_map__");return function(...r){let a;this.hasOwnProperty(o)||Object.defineProperty(this,o,{configurable:!1,enumerable:!1,writable:!1,value:new Map});let l=this[o];if(Array.isArray(i))for(const d of i)Ho.has(d)?Ho.get(d).push(l):Ho.set(d,[l]);if(e||r.length>0||t>0){let d;e===!0?d=r.map(v=>v.toString()).join("!"):e?d=e.apply(this,r):d=r[0];const p=`${d}__timestamp`;let u=!1;if(t>0)if(!l.has(p))u=!0;else{let v=l.get(p);u=Date.now()-v>t}l.has(d)&&!u?a=l.get(d):(a=s.apply(this,r),l.set(d,a),t>0&&l.set(p,Date.now()))}else{const d=this;l.has(d)?a=l.get(d):(a=s.apply(this,r),l.set(d,a))}return a}}class vs{parseValue(e){return typeof e=="string"&&(e==="false"||e==="0")?!1:!!e}}vs.shared=new vs;class no{parseValue(e){if(typeof e=="number")return e;if(typeof e=="boolean")return;const t=parseFloat(e);if(!Number.isNaN(t))return t}}no.shared=new no;class gs{parseValue(e){return no.shared.parseValue(e)}}gs.shared=new gs;class bs{parseValue(e){return this.parseJSDate(e)||this.parseBracketDate(e)}parseBracketDate(e){if(typeof e!="string")return;const t=e.match(/\[([0-9]{4})\]/);if(!(!t||t.length<2))return this.parseJSDate(t[1])}parseJSDate(e){if(typeof e!="string")return;let t=e;t.match(/^[0-9]{4}-[0-9]{2}-[0-9]{2}\s{1}[0-9]{2}:[0-9]{2}:[0-9]{2}$/)&&(t=t.replace(" ","T"));const i=Date.parse(t);if(Number.isNaN(i))return;let o=new Date(t);return(t.match(/^[0-9]{4}$/)||t.match(/^[0-9]{4}-[0-9]{2}-[0-9]{2}$/))&&(o=new Date(o.getTime()+o.getTimezoneOffset()*1e3*60)),o}}bs.shared=new bs;class ys{parseValue(e){if(typeof e=="number")return e;if(typeof e=="boolean")return;const t=e.split(":");let i;return t.length===1?i=this.parseNumberFormat(t[0]):i=this.parseColonSeparatedFormat(t),i}parseNumberFormat(e){let t=parseFloat(e);return Number.isNaN(t)&&(t=void 0),t}parseColonSeparatedFormat(e){let t=!1;const i=e.map((o,r)=>{const a=parseFloat(o);if(Number.isNaN(a))return t=!0,0;const d=60**(e.length-1-r);return a*Math.floor(d)}).reduce((o,r)=>o+r,0);return t?void 0:i}}ys.shared=new ys;class ws{parseValue(e){if(typeof e=="string")return e}}ws.shared=new ws;class Nn{constructor(e,t){this.separators=[";",","],this.parser=e,t&&t.separators&&(this.separators=t.separators)}parseValue(e){const t=String(e);let i=[];for(const o of this.separators)if(i=t.split(o),i.length>1)break;return this.parseListValues(i)}parseListValues(e){const i=e.map(r=>r.trim()).map(r=>this.parser.parseValue(r)),o=[];return i.forEach(r=>{r!==void 0&&o.push(r)}),o}}class xs{parseValue(e){if(typeof e=="string")return e}}xs.shared=new xs;class lo{parseValue(e){return String(e)}}lo.shared=new lo;class Ie{get values(){return this.parseRawValue()}get value(){return this.values[0]}constructor(e,t){this.parser=e,this.rawValue=t}parseRawValue(){const e=Array.isArray(this.rawValue)?this.rawValue:[this.rawValue],t=[];return e.forEach(i=>{const o=this.parser.parseValue(i);Array.isArray(o)?t.push(...o):o!==void 0&&t.push(o)}),t}}n([S()],Ie.prototype,"values",null);n([S()],Ie.prototype,"value",null);class Ti extends Ie{constructor(e){super(vs.shared,e)}}class Ee extends Ie{constructor(e){super(bs.shared,e)}}class Vo extends Ie{constructor(e){super(ys.shared,e)}}class ue extends Ie{constructor(e){super(no.shared,e)}}class I extends Ie{constructor(e){super(lo.shared,e)}}class Un extends Ie{constructor(e){super(xs.shared,e)}}class Fr extends Ie{constructor(e){super(gs.shared,e)}}class Na extends Ie{constructor(e){super(ws.shared,e)}}class Hn extends Ie{constructor(e,t){super(t,e)}}class Vn extends Hn{constructor(e){const t=new Nn(lo.shared);super(e,t)}}class D{get identifier(){return this.rawMetadata.identifier}get addeddate(){return this.rawMetadata.addeddate!=null?new Ee(this.rawMetadata.addeddate):void 0}get audio_codec(){return this.rawMetadata.audio_codec!=null?new I(this.rawMetadata.audio_codec):void 0}get audio_sample_rate(){return this.rawMetadata.audio_sample_rate!=null?new ue(this.rawMetadata.audio_sample_rate):void 0}get avg_rating(){return this.rawMetadata.avg_rating!=null?new ue(this.rawMetadata.avg_rating):void 0}get collection(){return this.rawMetadata.collection!=null?new I(this.rawMetadata.collection):void 0}get collections_raw(){return this.rawMetadata.collections_raw!=null?new I(this.rawMetadata.collections_raw):void 0}get collection_size(){return this.rawMetadata.collection_size!=null?new Fr(this.rawMetadata.collection_size):void 0}get contributor(){return this.rawMetadata.contributor!=null?new I(this.rawMetadata.contributor):void 0}get coverage(){return this.rawMetadata.coverage!=null?new I(this.rawMetadata.coverage):void 0}get creator(){return this.rawMetadata.creator!=null?new I(this.rawMetadata.creator):void 0}get collection_layout(){return this.rawMetadata.collection_layout!=null?new I(this.rawMetadata.collection_layout):void 0}get date(){return this.rawMetadata.date!=null?new Ee(this.rawMetadata.date):void 0}get description(){return this.rawMetadata.description!=null?new I(this.rawMetadata.description):void 0}get downloads(){return this.rawMetadata.downloads!=null?new ue(this.rawMetadata.downloads):void 0}get duration(){return this.rawMetadata.duration!=null?new Vo(this.rawMetadata.duration):void 0}get external_identifier(){return this.rawMetadata["external-identifier"]!=null?new I(this.rawMetadata["external-identifier"]):void 0}get files_count(){return this.rawMetadata.files_count!=null?new ue(this.rawMetadata.files_count):void 0}get indexdate(){return this.rawMetadata.indexdate!=null?new Ee(this.rawMetadata.indexdate):void 0}get isbn(){return this.rawMetadata.isbn!=null?new I(this.rawMetadata.isbn):void 0}get issue(){return this.rawMetadata.issue!=null?new I(this.rawMetadata.issue):void 0}get item_count(){return this.rawMetadata.item_count!=null?new ue(this.rawMetadata.item_count):void 0}get item_size(){return this.rawMetadata.item_size!=null?new Fr(this.rawMetadata.item_size):void 0}get language(){return this.rawMetadata.language!=null?new I(this.rawMetadata.language):void 0}get length(){return this.rawMetadata.length!=null?new Vo(this.rawMetadata.length):void 0}get lineage(){return this.rawMetadata.lineage!=null?new I(this.rawMetadata.lineage):void 0}get month(){return this.rawMetadata.month!=null?new ue(this.rawMetadata.month):void 0}get mediatype(){return this.rawMetadata.mediatype!=null?new Na(this.rawMetadata.mediatype):void 0}get noindex(){return this.rawMetadata.noindex!=null?new Ti(this.rawMetadata.noindex):void 0}get notes(){return this.rawMetadata.notes!=null?new I(this.rawMetadata.notes):void 0}get num_favorites(){return this.rawMetadata.num_favorites!=null?new ue(this.rawMetadata.num_favorites):void 0}get num_reviews(){return this.rawMetadata.num_reviews!=null?new ue(this.rawMetadata.num_reviews):void 0}get openlibrary_edition(){return this.rawMetadata.openlibrary_edition!=null?new I(this.rawMetadata.openlibrary_edition):void 0}get openlibrary_work(){return this.rawMetadata.openlibrary_work!=null?new I(this.rawMetadata.openlibrary_work):void 0}get page_progression(){return this.rawMetadata.page_progression!=null?new Un(this.rawMetadata.page_progression):void 0}get partner(){return this.rawMetadata.partner!=null?new I(this.rawMetadata.partner):void 0}get ppi(){return this.rawMetadata.ppi!=null?new ue(this.rawMetadata.ppi):void 0}get publicdate(){return this.rawMetadata.publicdate!=null?new Ee(this.rawMetadata.publicdate):void 0}get publisher(){return this.rawMetadata.publisher!=null?new I(this.rawMetadata.publisher):void 0}get reviewdate(){return this.rawMetadata.reviewdate!=null?new Ee(this.rawMetadata.reviewdate):void 0}get runtime(){return this.rawMetadata.runtime!=null?new Vo(this.rawMetadata.runtime):void 0}get scanner(){return this.rawMetadata.scanner!=null?new I(this.rawMetadata.scanner):void 0}get source(){return this.rawMetadata.source!=null?new I(this.rawMetadata.source):void 0}get start_localtime(){return this.rawMetadata.start_localtime!=null?new Ee(this.rawMetadata.start_localtime):void 0}get start_time(){return this.rawMetadata.start_time!=null?new Ee(this.rawMetadata.start_time):void 0}get stop_time(){return this.rawMetadata.stop_time!=null?new Ee(this.rawMetadata.stop_time):void 0}get subject(){return this.rawMetadata.subject!=null?new Vn(this.rawMetadata.subject):void 0}get taper(){return this.rawMetadata.taper!=null?new I(this.rawMetadata.taper):void 0}get title(){return this.rawMetadata.title!=null?new I(this.rawMetadata.title):void 0}get transferer(){return this.rawMetadata.transferer!=null?new I(this.rawMetadata.transferer):void 0}get track(){return this.rawMetadata.track!=null?new ue(this.rawMetadata.track):void 0}get type(){return this.rawMetadata.type!=null?new I(this.rawMetadata.type):void 0}get uploader(){return this.rawMetadata.uploader!=null?new I(this.rawMetadata.uploader):void 0}get utc_offset(){return this.rawMetadata.utc_offset!=null?new ue(this.rawMetadata.utc_offset):void 0}get venue(){return this.rawMetadata.venue!=null?new I(this.rawMetadata.venue):void 0}get volume(){return this.rawMetadata.volume!=null?new I(this.rawMetadata.volume):void 0}get week(){return this.rawMetadata.week!=null?new ue(this.rawMetadata.week):void 0}get year(){return this.rawMetadata.year!=null?new ue(this.rawMetadata.year):void 0}constructor(e={}){this.rawMetadata=e}}n([S()],D.prototype,"addeddate",null);n([S()],D.prototype,"audio_codec",null);n([S()],D.prototype,"audio_sample_rate",null);n([S()],D.prototype,"avg_rating",null);n([S()],D.prototype,"collection",null);n([S()],D.prototype,"collections_raw",null);n([S()],D.prototype,"collection_size",null);n([S()],D.prototype,"contributor",null);n([S()],D.prototype,"coverage",null);n([S()],D.prototype,"creator",null);n([S()],D.prototype,"collection_layout",null);n([S()],D.prototype,"date",null);n([S()],D.prototype,"description",null);n([S()],D.prototype,"downloads",null);n([S()],D.prototype,"duration",null);n([S()],D.prototype,"external_identifier",null);n([S()],D.prototype,"files_count",null);n([S()],D.prototype,"indexdate",null);n([S()],D.prototype,"isbn",null);n([S()],D.prototype,"issue",null);n([S()],D.prototype,"item_count",null);n([S()],D.prototype,"item_size",null);n([S()],D.prototype,"language",null);n([S()],D.prototype,"length",null);n([S()],D.prototype,"lineage",null);n([S()],D.prototype,"month",null);n([S()],D.prototype,"mediatype",null);n([S()],D.prototype,"noindex",null);n([S()],D.prototype,"notes",null);n([S()],D.prototype,"num_favorites",null);n([S()],D.prototype,"num_reviews",null);n([S()],D.prototype,"openlibrary_edition",null);n([S()],D.prototype,"openlibrary_work",null);n([S()],D.prototype,"page_progression",null);n([S()],D.prototype,"partner",null);n([S()],D.prototype,"ppi",null);n([S()],D.prototype,"publicdate",null);n([S()],D.prototype,"publisher",null);n([S()],D.prototype,"reviewdate",null);n([S()],D.prototype,"runtime",null);n([S()],D.prototype,"scanner",null);n([S()],D.prototype,"source",null);n([S()],D.prototype,"start_localtime",null);n([S()],D.prototype,"start_time",null);n([S()],D.prototype,"stop_time",null);n([S()],D.prototype,"subject",null);n([S()],D.prototype,"taper",null);n([S()],D.prototype,"title",null);n([S()],D.prototype,"transferer",null);n([S()],D.prototype,"track",null);n([S()],D.prototype,"type",null);n([S()],D.prototype,"uploader",null);n([S()],D.prototype,"utc_offset",null);n([S()],D.prototype,"venue",null);n([S()],D.prototype,"volume",null);n([S()],D.prototype,"week",null);n([S()],D.prototype,"year",null);class be extends D{get created_on(){return this.rawMetadata.created_on!=null?new Ee(this.rawMetadata.created_on):void 0}get file_creation_mtime(){return this.rawMetadata.file_creation_mtime!=null?new ue(this.rawMetadata.file_creation_mtime):void 0}get filename(){return this.rawMetadata.filename!=null?new I(this.rawMetadata.filename):void 0}get file_basename(){return this.rawMetadata.file_basename!=null?new I(this.rawMetadata.file_basename):void 0}get result_in_subfile(){return this.rawMetadata.result_in_subfile!=null?new Ti(this.rawMetadata.result_in_subfile):void 0}get query(){return this.rawMetadata.query!=null?new I(this.rawMetadata.query):void 0}get date_favorited(){return this.rawMetadata.date_favorited!=null?new Ee(this.rawMetadata.date_favorited):void 0}get updated_on(){return this.rawMetadata.updated_on!=null?new Ee(this.rawMetadata.updated_on):void 0}get num_clips(){return this.rawMetadata.nclips!=null?new ue(this.rawMetadata.nclips):void 0}get __href__(){return this.rawMetadata.__href__!=null?new I(this.rawMetadata.__href__):void 0}get __img__(){return this.rawMetadata.__img__!=null?new I(this.rawMetadata.__img__):void 0}}n([S()],be.prototype,"created_on",null);n([S()],be.prototype,"file_creation_mtime",null);n([S()],be.prototype,"filename",null);n([S()],be.prototype,"file_basename",null);n([S()],be.prototype,"result_in_subfile",null);n([S()],be.prototype,"query",null);n([S()],be.prototype,"date_favorited",null);n([S()],be.prototype,"updated_on",null);n([S()],be.prototype,"num_clips",null);n([S()],be.prototype,"__href__",null);n([S()],be.prototype,"__img__",null);class Be{constructor(e){var t;this.rawMetadata=e,this.fields=new be((t=e.fields)!==null&&t!==void 0?t:{})}get identifier(){return this.fields.identifier}get addeddate(){return this.fields.addeddate}get avg_rating(){return this.fields.avg_rating}get collection(){return this.fields.collection}get collection_files_count(){var e;return((e=this.rawMetadata.fields)===null||e===void 0?void 0:e.collection_files_count)!=null?new ue(this.rawMetadata.fields.collection_files_count):void 0}get collection_size(){return this.fields.collection_size}get creator(){return this.fields.creator}get date(){return this.fields.date}get description(){return this.fields.description}get downloads(){return this.fields.downloads}get files_count(){return this.fields.files_count}get genre(){var e;return((e=this.rawMetadata.fields)===null||e===void 0?void 0:e.genre)!=null?new I(this.rawMetadata.fields.genre):void 0}get indexflag(){var e;return((e=this.rawMetadata.fields)===null||e===void 0?void 0:e.indexflag)!=null?new I(this.rawMetadata.fields.indexflag):void 0}get issue(){return this.fields.issue}get item_count(){return this.fields.item_count}get item_size(){return this.fields.item_size}get language(){return this.fields.language}get lending___available_to_borrow(){var e;return((e=this.rawMetadata.fields)===null||e===void 0?void 0:e.lending___available_to_borrow)!=null?new Ti(this.rawMetadata.fields.lending___available_to_borrow):void 0}get lending___available_to_browse(){var e;return((e=this.rawMetadata.fields)===null||e===void 0?void 0:e.lending___available_to_browse)!=null?new Ti(this.rawMetadata.fields.lending___available_to_browse):void 0}get lending___available_to_waitlist(){var e;return((e=this.rawMetadata.fields)===null||e===void 0?void 0:e.lending___available_to_waitlist)!=null?new Ti(this.rawMetadata.fields.lending___available_to_waitlist):void 0}get lending___status(){var e;return((e=this.rawMetadata.fields)===null||e===void 0?void 0:e.lending___status)!=null?new I(this.rawMetadata.fields.lending___status):void 0}get licenseurl(){var e;return((e=this.rawMetadata.fields)===null||e===void 0?void 0:e.licenseurl)!=null?new I(this.rawMetadata.fields.licenseurl):void 0}get mediatype(){return this.fields.mediatype}get month(){return this.fields.month}get noindex(){return this.fields.noindex}get num_favorites(){return this.fields.num_favorites}get num_reviews(){return this.fields.num_reviews}get publicdate(){return this.fields.publicdate}get reviewdate(){return this.fields.reviewdate}get review(){const e=this.rawMetadata.review;return e?{body:e.reviewbody,title:e.reviewtitle,author:e.reviewer,authorItem:e.reviewer_itemname,updatedate:new Date(e.reviewdate),createdate:new Date(e.createdate),stars:Number(e.stars)||0,__href__:e.__href__}:void 0}get source(){return this.fields.source}get subject(){return this.fields.subject}get title(){return this.fields.title}get type(){return this.fields.type}get volume(){return this.fields.volume}get week(){return this.fields.week}get year(){return this.fields.year}}n([S()],Be.prototype,"collection_files_count",null);n([S()],Be.prototype,"genre",null);n([S()],Be.prototype,"indexflag",null);n([S()],Be.prototype,"lending___available_to_borrow",null);n([S()],Be.prototype,"lending___available_to_browse",null);n([S()],Be.prototype,"lending___available_to_waitlist",null);n([S()],Be.prototype,"lending___status",null);n([S()],Be.prototype,"licenseurl",null);n([S()],Be.prototype,"review",null);class Ks{constructor(e){var t;this.rawMetadata=e,this.fields=new be((t=e.fields)!==null&&t!==void 0?t:{})}get identifier(){return this.fields.identifier}get highlight(){var e;return!((e=this.rawMetadata.highlight)===null||e===void 0)&&e.text?new I(this.rawMetadata.highlight.text):void 0}get addeddate(){return this.fields.addeddate}get avg_rating(){return this.fields.avg_rating}get collection(){return this.fields.collection}get created_on(){return this.fields.created_on}get creator(){return this.fields.creator}get date(){return this.fields.date}get description(){return this.fields.description}get downloads(){return this.fields.downloads}get filename(){return this.fields.filename}get file_basename(){return this.fields.file_basename}get file_creation_mtime(){return this.fields.file_creation_mtime}get issue(){return this.fields.issue}get mediatype(){return this.fields.mediatype}get page_num(){var e;return((e=this.rawMetadata.fields)===null||e===void 0?void 0:e.page_num)!=null?new ue(this.rawMetadata.fields.page_num):void 0}get publicdate(){return this.fields.publicdate}get result_in_subfile(){return this.fields.result_in_subfile}get reviewdate(){return this.fields.reviewdate}get source(){return this.fields.source}get subject(){return this.fields.subject}get title(){return this.fields.title}get updated_on(){return this.fields.updated_on}get year(){return this.fields.year}get __href__(){return this.fields.__href__}}n([S()],Ks.prototype,"highlight",null);n([S()],Ks.prototype,"page_num",null);var Y;(function(s){s[s.COUNT=0]="COUNT",s[s.ALPHABETICAL=1]="ALPHABETICAL",s[s.NUMERIC=2]="NUMERIC"})(Y||(Y={}));class Ua{constructor(e){this.buckets=e.buckets,this.doc_count_error_upper_bound=e.doc_count_error_upper_bound,this.sum_other_doc_count=e.sum_other_doc_count,this.first_bucket_key=e.first_bucket_key,this.last_bucket_key=e.last_bucket_key,this.number_buckets=e.number_buckets,this.interval=e.interval}getSortedBuckets(e){const t=[...this.buckets];if(this.isRawNumberBuckets(t))return t;const i=new Intl.Collator;switch(e){case Y.ALPHABETICAL:return t.sort((o,r)=>i.compare(o.key.toString(),r.key.toString()));case Y.NUMERIC:return t.sort((o,r)=>Number(r.key)-Number(o.key));case Y.COUNT:default:return t}}isRawNumberBuckets(e){return typeof this.buckets[0]=="number"}}n([S()],Ua.prototype,"getSortedBuckets",null);class Wn{constructor(e){var t;this.rawMetadata=e,this.fields=new be((t=e.fields)!==null&&t!==void 0?t:{})}get identifier(){var e;return(e=this.fields.query)===null||e===void 0?void 0:e.value}get title(){return this.fields.title}get query(){return this.fields.query}get date_favorited(){return this.fields.date_favorited}get __href__(){return this.fields.__href__}}class Ys{constructor(e){var t;this.rawMetadata=e,this.fields=new be((t=e.fields)!==null&&t!==void 0?t:{})}get identifier(){var e;return(e=this.rawMetadata.fields)===null||e===void 0?void 0:e.url}get mediatype(){return new Na("web")}get title(){var e,t;return!((e=this.rawMetadata.fields)===null||e===void 0)&&e.url?new I((t=this.rawMetadata.fields)===null||t===void 0?void 0:t.url):void 0}get capture_dates(){var e,t;return!((e=this.rawMetadata.fields)===null||e===void 0)&&e.capture_dates?new Ee((t=this.rawMetadata.fields)===null||t===void 0?void 0:t.capture_dates):void 0}get __href__(){return this.fields.__href__}}n([S()],Ys.prototype,"title",null);n([S()],Ys.prototype,"capture_dates",null);class Xs{constructor(e){var t;this.rawMetadata=e,this.fields=new be((t=e.fields)!==null&&t!==void 0?t:{})}get identifier(){return this.fields.identifier}get highlight(){var e;return!((e=this.rawMetadata.highlight)===null||e===void 0)&&e.text?new I(this.rawMetadata.highlight.text):void 0}get addeddate(){return this.fields.addeddate}get avg_rating(){return this.fields.avg_rating}get collection(){return this.fields.collection}get created_on(){return this.fields.created_on}get creator(){return this.fields.creator}get date(){return this.fields.date}get description(){return this.fields.description}get downloads(){return this.fields.downloads}get filename(){return this.fields.filename}get file_basename(){return this.fields.file_basename}get file_creation_mtime(){return this.fields.file_creation_mtime}get issue(){return this.fields.issue}get mediatype(){return this.fields.mediatype}get num_clips(){return this.fields.num_clips}get publicdate(){return this.fields.publicdate}get result_in_subfile(){return this.fields.result_in_subfile}get reviewdate(){return this.fields.reviewdate}get source(){return this.fields.source}get subject(){return this.fields.subject}get title(){return this.fields.title}get updated_on(){return this.fields.updated_on}get year(){return this.fields.year}get start(){var e;return((e=this.rawMetadata.fields)===null||e===void 0?void 0:e.start)!=null?new I(this.rawMetadata.fields.start):void 0}get __href__(){return this.fields.__href__}get __img__(){return this.fields.__img__}}n([S()],Xs.prototype,"highlight",null);n([S()],Xs.prototype,"start",null);const jn=["loans","waitlist","loan_history"];function Gn(s){const e=s.slice(0,4),t=s.slice(4,6),i=s.slice(6,8),o=s.slice(8,10),r=s.slice(10,12),a=s.slice(12,14);return`${e}-${t}-${i}T${o}:${r}:${a}Z`}function qn(s){var e;const t=[];for(const i of s){if(!(!((e=i.captures)===null||e===void 0)&&e.length))continue;const o=encodeURIComponent(i.url),r=`https://web.archive.org/web/${i.captures[0]}/${o}`;t.push({hit_type:"web_archive",fields:{url:i.url,capture_dates:i.captures.map(a=>Gn(a)),__href__:r}})}return t}class Zs{constructor(e,t){var i,o,r,a,l,d,p,u,v,g,y,w,$,T;this.schema=t,this.schemaHitType=t?.hit_type;let L;e?.page_elements&&(this.pageElements=e.page_elements,L=Object.values(this.pageElements)[0]);let E=(i=e?.hits)===null||i===void 0?void 0:i.hits;this.totalResults=(r=(o=e?.hits)===null||o===void 0?void 0:o.total)!==null&&r!==void 0?r:0,this.returnedCount=(l=(a=e?.hits)===null||a===void 0?void 0:a.returned)!==null&&l!==void 0?l:0,!E?.length&&(!((d=this.pageElements)===null||d===void 0)&&d.service___fts)?(this.totalResults=0,this.returnedCount=0,this.handleFederatedPageElements()):!E?.length&&(!((p=L?.hits)===null||p===void 0)&&p.hits)?(E=L.hits.hits,this.totalResults=(u=L.hits.total)!==null&&u!==void 0?u:0,this.returnedCount=(v=L.hits.returned)!==null&&v!==void 0?v:0):!((g=this.pageElements)===null||g===void 0)&&g.lending?E=this.handleLendingPageElement():!((y=this.pageElements)===null||y===void 0)&&y.web_archives&&(E=this.handleWebArchivesPageElement()),this.results=this.formatHits(E);let P=e?.aggregations;!(this.aggregations&&Object.keys(this.aggregations).length>0)&&L?.aggregations&&(P=L.aggregations),P&&this.buildAggregations(P),e?.collection_titles&&(this.collectionTitles=(w=e.collection_titles)!==null&&w!==void 0?w:{}),e?.collection_extra_info&&(this.collectionExtraInfo=($=e.collection_extra_info)!==null&&$!==void 0?$:null),e?.account_extra_info&&(this.accountExtraInfo=(T=e.account_extra_info)!==null&&T!==void 0?T:null)}formatHits(e){var t;return(t=e?.map(i=>{var o;return Zs.createResult((o=i.hit_type)!==null&&o!==void 0?o:this.schemaHitType,i)}))!==null&&t!==void 0?t:[]}buildAggregations(e){this.aggregations=Object.entries(e).reduce((t,[i,o])=>(t[i]=new Ua(o),t),{})}handleLendingPageElement(){var e,t;const i=(e=this.pageElements)===null||e===void 0?void 0:e.lending,o=(t=i.loans)!==null&&t!==void 0?t:[];this.totalResults=o.length,this.returnedCount=this.totalResults;for(const r of jn)i[r]=this.formatHits(i[r]);return o}handleWebArchivesPageElement(){var e;const t=qn((e=this.pageElements)===null||e===void 0?void 0:e.web_archives);return this.totalResults=t.length,this.returnedCount=this.totalResults,t}handleFederatedPageElements(){var e,t,i,o;const r=["service___fts","service___tvs","service___rcs","service___whisper","metadata___mediatype___texts","metadata___mediatype___movies","metadata___mediatype___audio","metadata___mediatype___software","metadata___mediatype___image","metadata___mediatype___etree"];for(const a of r){const l=this.removePageElementPrefix(a);this.federatedResults?this.federatedResults[a]=[]:this.federatedResults={[l]:[]};const d=(t=(e=this.pageElements)===null||e===void 0?void 0:e[a])===null||t===void 0?void 0:t.hits;d?.hits&&(this.federatedResults[l]=this.formatHits(d?.hits)),this.totalResults+=(i=d?.total)!==null&&i!==void 0?i:0,this.returnedCount+=(o=d?.returned)!==null&&o!==void 0?o:0}}removePageElementPrefix(e){return e.split("___").pop()}static createResult(e,t){switch(e){case"item":return new Be(t);case"text":case"asr_text":return new Ks(t);case"favorited_search":return new Wn(t);case"web_archive":return new Ys(t);case"tv_clip":return new Xs(t);default:return new Be(t)}}}class Qn{constructor(e){this.clientParameters=e.client_parameters,this.backendRequests=e.backend_requests,this.kind=e.kind}}class Kn{constructor(e){var t,i,o;this.rawResponse=e,this.request=new Qn(e.request),this.responseHeader=(t=e.response)===null||t===void 0?void 0:t.header,this.sessionContext=e.session_context,this.response=new Zs((i=e.response)===null||i===void 0?void 0:i.body,(o=e.response)===null||o===void 0?void 0:o.hit_schema)}}class ai{static aggregateSearchParamsAsString(e){if(e.omit)return"false";if(e.advancedParams){const t=e.advancedParams.map(o=>({terms:o}));return JSON.stringify(t)}if(e.simpleParams)return e.simpleParams.join(",")}static sortParamsAsString(e){return`${e.field}:${e.direction}`}static filterParamsAsString(e){return JSON.stringify(e)}static generateURLSearchParams(e){const t=new URLSearchParams;if(t.append("user_query",e.query),e.pageType&&t.append("page_type",String(e.pageType)),e.pageTarget&&t.append("page_target",String(e.pageTarget)),e.pageElements&&e.pageElements.length>0){const r=`[${e.pageElements.map(a=>`"${a}"`).join(",")}]`;t.append("page_elements",r)}if(e.rows!=null&&t.append("hits_per_page",String(e.rows)),e.page!=null&&t.append("page",String(e.page)),e.fields&&e.fields.length>0&&t.append("fields",e.fields.join(",")),e.filters&&Object.keys(e.filters).length>0){const o=this.filterParamsAsString(e.filters);o&&o!=="{}"&&t.append("filter_map",o)}if(e.sort&&e.sort.length>0){const o=e.sort.map(r=>this.sortParamsAsString(r));t.append("sort",o.join(","))}const i=e.aggregations;if(i){const o=this.aggregateSearchParamsAsString(i);o&&t.append("aggregations",o)}if(e.aggregationsSize!=null&&t.append("aggregations_size",String(e.aggregationsSize)),e.debugging&&t.append("debugging","true"),e.uid&&t.append("uid",e.uid),e.includeClientUrl!==!1){const o=window.location.href.slice(0,400);e.query.length<=1e3&&t.append("client_url",o)}return t}}var Ei;(function(s){s.networkError="SearchService.NetworkError",s.itemNotFound="SearchService.ItemNotFound",s.decodingError="SearchService.DecodingError",s.searchEngineError="SearchService.SearchEngineError"})(Ei||(Ei={}));class Yn extends Error{constructor(e,t,i){super(t),this.name=e,this.type=e,this.details=i}}const Rr={reCache:JSON.stringify({recompute:!0}),noCache:JSON.stringify({bypass:!0}),dontCache:JSON.stringify({no_compute:!0})};class ni{constructor(e){var t,i;this.baseUrl=(t=e?.baseUrl)!==null&&t!==void 0?t:"archive.org",e?.includeCredentials!==void 0?this.includeCredentials=e.includeCredentials:this.includeCredentials=window.location.href.match(/^https?:\/\/.*archive\.org(:[0-9]+)?/)!==null;const o=new URL(window.location.href).searchParams,r=o.get("scope"),a=o.get("verbose"),l=o.get("debugging"),d=o.get("cacheDebug");let p="";for(const u of Object.keys(Rr))if(o.get(u)){p=Rr[u];break}p=(i=o.get("caching"))!==null&&i!==void 0?i:p,e?.caching!==void 0?this.cachingFlags=e.caching:p&&(this.cachingFlags=p),e?.debuggingEnabled!==void 0?this.debuggingEnabled=e.debuggingEnabled:(l||d)&&(this.debuggingEnabled=!0),e?.scope!==void 0?this.requestScope=e.scope:r&&(this.requestScope=r),e?.verbose!==void 0?this.verbose=e.verbose:a&&(this.verbose=!!a)}async fetchUrl(e,t){var i,o;const r=new URL(e);this.requestScope&&r.searchParams.set("scope",this.requestScope),this.cachingFlags&&r.searchParams.set("caching",this.cachingFlags);let a;try{const l=(i=t?.requestOptions)!==null&&i!==void 0?i:{credentials:this.includeCredentials?"include":"same-origin"};a=await fetch(r.href,l)}catch(l){const d=l instanceof Error?l.message:typeof l=="string"?l:"Unknown error";return this.getErrorResult(Ei.networkError,d)}try{const l=await a.json();this.verbose&&this.printResponse(l),l.debugging&&this.printDebuggingInfo(l);const d=(o=l.response)===null||o===void 0?void 0:o.error;return d?this.getErrorResult(Ei.searchEngineError,d.message,d.forensics):{success:l}}catch(l){const d=l instanceof Error?l.message:typeof l=="string"?l:"Unknown error";return this.getErrorResult(Ei.decodingError,d)}}getErrorResult(e,t,i){return{error:new Yn(e,t,i)}}printResponse(e){var t,i,o,r,a;try{const l=JSON.parse(JSON.stringify(e)),d=(o=(i=(t=l?.response)===null||t===void 0?void 0:t.body)===null||i===void 0?void 0:i.hits)===null||o===void 0?void 0:o.hits;if(Array.isArray(d)&&d.length>1){const u=[];u.push(d[0]),u.push(`*** ${d.length-1} hits omitted ***`),l.response.body.hits.hits=u}const p=(a=(r=l?.response)===null||r===void 0?void 0:r.body)===null||a===void 0?void 0:a.aggregations;p&&Object.entries(p).forEach(([u,v])=>{var g,y,w,$;if(((y=(g=v)===null||g===void 0?void 0:g.buckets)===null||y===void 0?void 0:y.length)>0){const T=JSON.parse(JSON.stringify(v));T.buckets=`*** ${($=(w=T.buckets)===null||w===void 0?void 0:w.length)!==null&&$!==void 0?$:0} buckets omitted ***`,l.response.body.aggregations[u]=T}}),console.log("***** RESPONSE RECEIVED *****"),console.groupCollapsed("Response"),console.log(JSON.stringify(l,null,2)),console.groupEnd()}catch(l){console.error("Error printing search response:",l)}}printDebuggingInfo(e){var t,i;const o=e.debugging,r=(t=o.messages)!==null&&t!==void 0?t:[],a=(i=o.data)!==null&&i!==void 0?i:{};console.log("***** BEGIN DEBUGGING *****"),console.log("Full response:"),console.log(JSON.stringify(e,null,2)),console.group("Debug messages");for(const l of r)console.log(l);console.groupEnd(),console.group("Debug data");for(const[l,d]of Object.entries(a))console.log(l,d);console.groupEnd(),console.log("***** END DEBUGGING *****")}}class Xn extends ni{constructor(e){var t;super(e),this.servicePath=(t=e?.servicePath)!==null&&t!==void 0?t:"/services/search/beta/page_production"}async performSearch(e){this.debuggingEnabled&&e.debugging===void 0&&(e.debugging=!0);const i=ai.generateURLSearchParams(e).toString(),o=`https://${this.baseUrl}${this.servicePath}/?service_backend=metadata&${i}`;return this.fetchUrl(o)}}class Zn extends ni{constructor(e){var t;super(e),this.servicePath=(t=e?.servicePath)!==null&&t!==void 0?t:"/services/search/beta/page_production"}async performSearch(e){this.debuggingEnabled&&e.debugging===void 0&&(e.debugging=!0);const i=ai.generateURLSearchParams(e).toString(),o=`https://${this.baseUrl}${this.servicePath}/?service_backend=fts&${i}`;return this.fetchUrl(o)}}class Jn extends ni{constructor(e){var t;super(e),this.servicePath=(t=e?.servicePath)!==null&&t!==void 0?t:"/services/search/beta/page_production"}async performSearch(e){this.debuggingEnabled&&e.debugging===void 0&&(e.debugging=!0);const i=ai.generateURLSearchParams(e).toString(),o=`https://${this.baseUrl}${this.servicePath}/?service_backend=rcs&${i}`;return this.fetchUrl(o)}}var W;(function(s){s[s.DEFAULT=0]="DEFAULT",s[s.METADATA=1]="METADATA",s[s.FULLTEXT=2]="FULLTEXT",s[s.TV=3]="TV",s[s.RADIO=4]="RADIO",s[s.FEDERATED=5]="FEDERATED"})(W||(W={}));class el extends ni{constructor(e){var t;super(e),this.servicePath=(t=e?.servicePath)!==null&&t!==void 0?t:"/services/search/beta/page_production"}async performSearch(e){this.debuggingEnabled&&e.debugging===void 0&&(e.debugging=!0);const i=ai.generateURLSearchParams(e).toString(),o=`https://${this.baseUrl}${this.servicePath}/?service_backend=tvs&${i}`;return this.fetchUrl(o)}}class tl extends ni{constructor(e){var t;super(e),this.servicePath=(t=e?.servicePath)!==null&&t!==void 0?t:"/services/search/beta/page_production"}async performSearch(e){this.debuggingEnabled&&e.debugging===void 0&&(e.debugging=!0);const i=ai.generateURLSearchParams(e).toString(),o=`https://${this.baseUrl}${this.servicePath}/?page_type=simple_federation&${i}`;return this.fetchUrl(o)}}class il extends ni{constructor(e){var t;super(e),this.servicePath=(t=e?.servicePath)!==null&&t!==void 0?t:"/services/search/beta/page_production"}async performSearch(e){this.debuggingEnabled&&e.debugging===void 0&&(e.debugging=!0);const i=ai.generateURLSearchParams(e).toString(),o=`https://${this.baseUrl}${this.servicePath}/?${i}`;return this.fetchUrl(o)}}class je{constructor(e={}){this.backendOptions=e}async search(e,t=W.METADATA){const o=await je.getBackendForSearchType(t,this.backendOptions).performSearch(e);return o.error?o:{success:new Kn(o.success)}}static getBackendForSearchType(e,t={}){switch(e){case W.METADATA:return new Xn(t);case W.FULLTEXT:return new Zn(t);case W.RADIO:return new Jn(t);case W.TV:return new el(t);case W.FEDERATED:return new tl(t);default:return new il(t)}}}je.default=new je;n([S((s,e={})=>{const{includeCredentials:t=!1,verbose:i=!1,scope:o="",baseUrl:r=""}=e;return`${s};${t};${i};${o};${r}`})],je,"getBackendForSearchType",null);var at;(function(s){s.INCLUDE="inc",s.EXCLUDE="exc",s.GREATER_THAN="gt",s.GREATER_OR_EQUAL="gte",s.LESS_THAN="lt",s.LESS_OR_EQUAL="lte"})(at||(at={}));class ol{constructor(){this.filterMap={}}addFilter(e,t,i){if(this.filterMap[e]||(this.filterMap[e]={}),this.filterMap[e][t]){const o=[].concat(this.filterMap[e][t],i);this.filterMap[e][t]=Array.from(new Set(o))}else this.filterMap[e][t]=i;return this}removeSingleFilter(e,t,i){var o;if(!(!((o=this.filterMap[e])===null||o===void 0)&&o[t]))return this;const r=[].concat(this.filterMap[e][t]),a=r.indexOf(i);return a>=0&&r.splice(a,1),this.filterMap[e][t]=r.length===1?r[0]:r,r.length===0&&delete this.filterMap[e][t],this.deleteFieldIfEmpty(e),this}removeFilters(e,t){return this.filterMap[e]?(delete this.filterMap[e][t],this.deleteFieldIfEmpty(e),this):this}deleteFieldIfEmpty(e){const t=this.filterMap[e];t&&Object.keys(t).length===0&&delete this.filterMap[e]}setFilterMap(e){return this.filterMap={...e},this}mergeFilterMap(e){for(const[t,i]of Object.entries(e))for(const[o,r]of Object.entries(i))if(Array.isArray(r))for(const a of r)this.addFilter(t,o,a);else this.addFilter(t,o,r);return this}build(){return this.filterMap}}/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const to=window,Js=to.ShadowRoot&&(to.ShadyCSS===void 0||to.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,er=Symbol(),Br=new WeakMap;let Ha=class{constructor(e,t,i){if(this._$cssResult$=!0,i!==er)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o;const t=this.t;if(Js&&e===void 0){const i=t!==void 0&&t.length===1;i&&(e=Br.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),i&&Br.set(t,e))}return e}toString(){return this.cssText}};const sl=s=>new Ha(typeof s=="string"?s:s+"",void 0,er),m=(s,...e)=>{const t=s.length===1?s[0]:e.reduce((i,o,r)=>i+(a=>{if(a._$cssResult$===!0)return a.cssText;if(typeof a=="number")return a;throw Error("Value passed to 'css' function must be a 'css' function result: "+a+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(o)+s[r+1],s[0]);return new Ha(t,s,er)},rl=(s,e)=>{Js?s.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet):e.forEach(t=>{const i=document.createElement("style"),o=to.litNonce;o!==void 0&&i.setAttribute("nonce",o),i.textContent=t.cssText,s.appendChild(i)})},Ir=Js?s=>s:s=>s instanceof CSSStyleSheet?(e=>{let t="";for(const i of e.cssRules)t+=i.cssText;return sl(t)})(s):s;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Wo;const co=window,Or=co.trustedTypes,al=Or?Or.emptyScript:"",Nr=co.reactiveElementPolyfillSupport,Ss={toAttribute(s,e){switch(e){case Boolean:s=s?al:null;break;case Object:case Array:s=s==null?s:JSON.stringify(s)}return s},fromAttribute(s,e){let t=s;switch(e){case Boolean:t=s!==null;break;case Number:t=s===null?null:Number(s);break;case Object:case Array:try{t=JSON.parse(s)}catch{t=null}}return t}},Va=(s,e)=>e!==s&&(e==e||s==s),jo={attribute:!0,type:String,converter:Ss,reflect:!1,hasChanged:Va},$s="finalized";let Wt=class extends HTMLElement{constructor(){super(),this._$Ei=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$El=null,this._$Eu()}static addInitializer(e){var t;this.finalize(),((t=this.h)!==null&&t!==void 0?t:this.h=[]).push(e)}static get observedAttributes(){this.finalize();const e=[];return this.elementProperties.forEach((t,i)=>{const o=this._$Ep(i,t);o!==void 0&&(this._$Ev.set(o,i),e.push(o))}),e}static createProperty(e,t=jo){if(t.state&&(t.attribute=!1),this.finalize(),this.elementProperties.set(e,t),!t.noAccessor&&!this.prototype.hasOwnProperty(e)){const i=typeof e=="symbol"?Symbol():"__"+e,o=this.getPropertyDescriptor(e,i,t);o!==void 0&&Object.defineProperty(this.prototype,e,o)}}static getPropertyDescriptor(e,t,i){return{get(){return this[t]},set(o){const r=this[e];this[t]=o,this.requestUpdate(e,r,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)||jo}static finalize(){if(this.hasOwnProperty($s))return!1;this[$s]=!0;const e=Object.getPrototypeOf(this);if(e.finalize(),e.h!==void 0&&(this.h=[...e.h]),this.elementProperties=new Map(e.elementProperties),this._$Ev=new Map,this.hasOwnProperty("properties")){const t=this.properties,i=[...Object.getOwnPropertyNames(t),...Object.getOwnPropertySymbols(t)];for(const o of i)this.createProperty(o,t[o])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const i=new Set(e.flat(1/0).reverse());for(const o of i)t.unshift(Ir(o))}else e!==void 0&&t.push(Ir(e));return t}static _$Ep(e,t){const i=t.attribute;return i===!1?void 0:typeof i=="string"?i:typeof e=="string"?e.toLowerCase():void 0}_$Eu(){var e;this._$E_=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$Eg(),this.requestUpdate(),(e=this.constructor.h)===null||e===void 0||e.forEach(t=>t(this))}addController(e){var t,i;((t=this._$ES)!==null&&t!==void 0?t:this._$ES=[]).push(e),this.renderRoot!==void 0&&this.isConnected&&((i=e.hostConnected)===null||i===void 0||i.call(e))}removeController(e){var t;(t=this._$ES)===null||t===void 0||t.splice(this._$ES.indexOf(e)>>>0,1)}_$Eg(){this.constructor.elementProperties.forEach((e,t)=>{this.hasOwnProperty(t)&&(this._$Ei.set(t,this[t]),delete this[t])})}createRenderRoot(){var e;const t=(e=this.shadowRoot)!==null&&e!==void 0?e:this.attachShadow(this.constructor.shadowRootOptions);return rl(t,this.constructor.elementStyles),t}connectedCallback(){var e;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$ES)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostConnected)===null||i===void 0?void 0:i.call(t)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$ES)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostDisconnected)===null||i===void 0?void 0:i.call(t)})}attributeChangedCallback(e,t,i){this._$AK(e,i)}_$EO(e,t,i=jo){var o;const r=this.constructor._$Ep(e,i);if(r!==void 0&&i.reflect===!0){const a=(((o=i.converter)===null||o===void 0?void 0:o.toAttribute)!==void 0?i.converter:Ss).toAttribute(t,i.type);this._$El=e,a==null?this.removeAttribute(r):this.setAttribute(r,a),this._$El=null}}_$AK(e,t){var i;const o=this.constructor,r=o._$Ev.get(e);if(r!==void 0&&this._$El!==r){const a=o.getPropertyOptions(r),l=typeof a.converter=="function"?{fromAttribute:a.converter}:((i=a.converter)===null||i===void 0?void 0:i.fromAttribute)!==void 0?a.converter:Ss;this._$El=r,this[r]=l.fromAttribute(t,a.type),this._$El=null}}requestUpdate(e,t,i){let o=!0;e!==void 0&&(((i=i||this.constructor.getPropertyOptions(e)).hasChanged||Va)(this[e],t)?(this._$AL.has(e)||this._$AL.set(e,t),i.reflect===!0&&this._$El!==e&&(this._$EC===void 0&&(this._$EC=new Map),this._$EC.set(e,i))):o=!1),!this.isUpdatePending&&o&&(this._$E_=this._$Ej())}async _$Ej(){this.isUpdatePending=!0;try{await this._$E_}catch(t){Promise.reject(t)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var e;if(!this.isUpdatePending)return;this.hasUpdated,this._$Ei&&(this._$Ei.forEach((o,r)=>this[r]=o),this._$Ei=void 0);let t=!1;const i=this._$AL;try{t=this.shouldUpdate(i),t?(this.willUpdate(i),(e=this._$ES)===null||e===void 0||e.forEach(o=>{var r;return(r=o.hostUpdate)===null||r===void 0?void 0:r.call(o)}),this.update(i)):this._$Ek()}catch(o){throw t=!1,this._$Ek(),o}t&&this._$AE(i)}willUpdate(e){}_$AE(e){var t;(t=this._$ES)===null||t===void 0||t.forEach(i=>{var o;return(o=i.hostUpdated)===null||o===void 0?void 0:o.call(i)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$Ek(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$E_}shouldUpdate(e){return!0}update(e){this._$EC!==void 0&&(this._$EC.forEach((t,i)=>this._$EO(i,this[i],t)),this._$EC=void 0),this._$Ek()}updated(e){}firstUpdated(e){}};Wt[$s]=!0,Wt.elementProperties=new Map,Wt.elementStyles=[],Wt.shadowRootOptions={mode:"open"},Nr?.({ReactiveElement:Wt}),((Wo=co.reactiveElementVersions)!==null&&Wo!==void 0?Wo:co.reactiveElementVersions=[]).push("1.6.3");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Go;const ho=window,Kt=ho.trustedTypes,Ur=Kt?Kt.createPolicy("lit-html",{createHTML:s=>s}):void 0,_s="$lit$",ct=`lit$${(Math.random()+"").slice(9)}$`,Wa="?"+ct,nl=`<${Wa}>`,Dt=document,po=()=>Dt.createComment(""),Ai=s=>s===null||typeof s!="object"&&typeof s!="function",ja=Array.isArray,ll=s=>ja(s)||typeof s?.[Symbol.iterator]=="function",qo=`[ 	
\f\r]`,ui=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Hr=/-->/g,Vr=/>/g,gt=RegExp(`>|${qo}(?:([^\\s"'>=/]+)(${qo}*=${qo}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Wr=/'/g,jr=/"/g,Ga=/^(?:script|style|textarea|title)$/i,Me=Symbol.for("lit-noChange"),Z=Symbol.for("lit-nothing"),Gr=new WeakMap,$t=Dt.createTreeWalker(Dt,129,null,!1);function qa(s,e){if(!Array.isArray(s)||!s.hasOwnProperty("raw"))throw Error("invalid template strings array");return Ur!==void 0?Ur.createHTML(e):e}const dl=(s,e)=>{const t=s.length-1,i=[];let o,r=e===2?"<svg>":"",a=ui;for(let l=0;l<t;l++){const d=s[l];let p,u,v=-1,g=0;for(;g<d.length&&(a.lastIndex=g,u=a.exec(d),u!==null);)g=a.lastIndex,a===ui?u[1]==="!--"?a=Hr:u[1]!==void 0?a=Vr:u[2]!==void 0?(Ga.test(u[2])&&(o=RegExp("</"+u[2],"g")),a=gt):u[3]!==void 0&&(a=gt):a===gt?u[0]===">"?(a=o??ui,v=-1):u[1]===void 0?v=-2:(v=a.lastIndex-u[2].length,p=u[1],a=u[3]===void 0?gt:u[3]==='"'?jr:Wr):a===jr||a===Wr?a=gt:a===Hr||a===Vr?a=ui:(a=gt,o=void 0);const y=a===gt&&s[l+1].startsWith("/>")?" ":"";r+=a===ui?d+nl:v>=0?(i.push(p),d.slice(0,v)+_s+d.slice(v)+ct+y):d+ct+(v===-2?(i.push(void 0),l):y)}return[qa(s,r+(s[t]||"<?>")+(e===2?"</svg>":"")),i]};let Cs=class Qa{constructor({strings:e,_$litType$:t},i){let o;this.parts=[];let r=0,a=0;const l=e.length-1,d=this.parts,[p,u]=dl(e,t);if(this.el=Qa.createElement(p,i),$t.currentNode=this.el.content,t===2){const v=this.el.content,g=v.firstChild;g.remove(),v.append(...g.childNodes)}for(;(o=$t.nextNode())!==null&&d.length<l;){if(o.nodeType===1){if(o.hasAttributes()){const v=[];for(const g of o.getAttributeNames())if(g.endsWith(_s)||g.startsWith(ct)){const y=u[a++];if(v.push(g),y!==void 0){const w=o.getAttribute(y.toLowerCase()+_s).split(ct),$=/([.?@])?(.*)/.exec(y);d.push({type:1,index:r,name:$[2],strings:w,ctor:$[1]==="."?hl:$[1]==="?"?ul:$[1]==="@"?fl:ko})}else d.push({type:6,index:r})}for(const g of v)o.removeAttribute(g)}if(Ga.test(o.tagName)){const v=o.textContent.split(ct),g=v.length-1;if(g>0){o.textContent=Kt?Kt.emptyScript:"";for(let y=0;y<g;y++)o.append(v[y],po()),$t.nextNode(),d.push({type:2,index:++r});o.append(v[g],po())}}}else if(o.nodeType===8)if(o.data===Wa)d.push({type:2,index:r});else{let v=-1;for(;(v=o.data.indexOf(ct,v+1))!==-1;)d.push({type:7,index:r}),v+=ct.length-1}r++}}static createElement(e,t){const i=Dt.createElement("template");return i.innerHTML=e,i}};function Yt(s,e,t=s,i){var o,r,a,l;if(e===Me)return e;let d=i!==void 0?(o=t._$Co)===null||o===void 0?void 0:o[i]:t._$Cl;const p=Ai(e)?void 0:e._$litDirective$;return d?.constructor!==p&&((r=d?._$AO)===null||r===void 0||r.call(d,!1),p===void 0?d=void 0:(d=new p(s),d._$AT(s,t,i)),i!==void 0?((a=(l=t)._$Co)!==null&&a!==void 0?a:l._$Co=[])[i]=d:t._$Cl=d),d!==void 0&&(e=Yt(s,d._$AS(s,e.values),d,i)),e}let cl=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){var t;const{el:{content:i},parts:o}=this._$AD,r=((t=e?.creationScope)!==null&&t!==void 0?t:Dt).importNode(i,!0);$t.currentNode=r;let a=$t.nextNode(),l=0,d=0,p=o[0];for(;p!==void 0;){if(l===p.index){let u;p.type===2?u=new tr(a,a.nextSibling,this,e):p.type===1?u=new p.ctor(a,p.name,p.strings,this,e):p.type===6&&(u=new ml(a,this,e)),this._$AV.push(u),p=o[++d]}l!==p?.index&&(a=$t.nextNode(),l++)}return $t.currentNode=Dt,r}v(e){let t=0;for(const i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}},tr=class Ka{constructor(e,t,i,o){var r;this.type=2,this._$AH=Z,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=o,this._$Cp=(r=o?.isConnected)===null||r===void 0||r}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cp}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Yt(this,e,t),Ai(e)?e===Z||e==null||e===""?(this._$AH!==Z&&this._$AR(),this._$AH=Z):e!==this._$AH&&e!==Me&&this._(e):e._$litType$!==void 0?this.g(e):e.nodeType!==void 0?this.$(e):ll(e)?this.T(e):this._(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==Z&&Ai(this._$AH)?this._$AA.nextSibling.data=e:this.$(Dt.createTextNode(e)),this._$AH=e}g(e){var t;const{values:i,_$litType$:o}=e,r=typeof o=="number"?this._$AC(e):(o.el===void 0&&(o.el=Cs.createElement(qa(o.h,o.h[0]),this.options)),o);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===r)this._$AH.v(i);else{const a=new cl(r,this),l=a.u(this.options);a.v(i),this.$(l),this._$AH=a}}_$AC(e){let t=Gr.get(e.strings);return t===void 0&&Gr.set(e.strings,t=new Cs(e)),t}T(e){ja(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,o=0;for(const r of e)o===t.length?t.push(i=new Ka(this.k(po()),this.k(po()),this,this.options)):i=t[o],i._$AI(r),o++;o<t.length&&(this._$AR(i&&i._$AB.nextSibling,o),t.length=o)}_$AR(e=this._$AA.nextSibling,t){var i;for((i=this._$AP)===null||i===void 0||i.call(this,!1,!0,t);e&&e!==this._$AB;){const o=e.nextSibling;e.remove(),e=o}}setConnected(e){var t;this._$AM===void 0&&(this._$Cp=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}},ko=class{constructor(e,t,i,o,r){this.type=1,this._$AH=Z,this._$AN=void 0,this.element=e,this.name=t,this._$AM=o,this.options=r,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=Z}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,i,o){const r=this.strings;let a=!1;if(r===void 0)e=Yt(this,e,t,0),a=!Ai(e)||e!==this._$AH&&e!==Me,a&&(this._$AH=e);else{const l=e;let d,p;for(e=r[0],d=0;d<r.length-1;d++)p=Yt(this,l[i+d],t,d),p===Me&&(p=this._$AH[d]),a||(a=!Ai(p)||p!==this._$AH[d]),p===Z?e=Z:e!==Z&&(e+=(p??"")+r[d+1]),this._$AH[d]=p}a&&!o&&this.j(e)}j(e){e===Z?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},hl=class extends ko{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===Z?void 0:e}};const pl=Kt?Kt.emptyScript:"";let ul=class extends ko{constructor(){super(...arguments),this.type=4}j(e){e&&e!==Z?this.element.setAttribute(this.name,pl):this.element.removeAttribute(this.name)}},fl=class extends ko{constructor(e,t,i,o,r){super(e,t,i,o,r),this.type=5}_$AI(e,t=this){var i;if((e=(i=Yt(this,e,t,0))!==null&&i!==void 0?i:Z)===Me)return;const o=this._$AH,r=e===Z&&o!==Z||e.capture!==o.capture||e.once!==o.once||e.passive!==o.passive,a=e!==Z&&(o===Z||r);r&&this.element.removeEventListener(this.name,this,o),a&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,i;typeof this._$AH=="function"?this._$AH.call((i=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&i!==void 0?i:this.element,e):this._$AH.handleEvent(e)}},ml=class{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){Yt(this,e)}};const vl={I:tr},qr=ho.litHtmlPolyfillSupport;qr?.(Cs,tr),((Go=ho.litHtmlVersions)!==null&&Go!==void 0?Go:ho.litHtmlVersions=[]).push("2.8.0");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Qo;const uo=window,Xt=uo.trustedTypes,Qr=Xt?Xt.createPolicy("lit-html",{createHTML:s=>s}):void 0,ks="$lit$",ht=`lit$${(Math.random()+"").slice(9)}$`,Ya="?"+ht,gl=`<${Ya}>`,At=document,zi=()=>At.createComment(""),Li=s=>s===null||typeof s!="object"&&typeof s!="function",Xa=Array.isArray,bl=s=>Xa(s)||typeof s?.[Symbol.iterator]=="function",Ko=`[ 	
\f\r]`,fi=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Kr=/-->/g,Yr=/>/g,bt=RegExp(`>|${Ko}(?:([^\\s"'>=/]+)(${Ko}*=${Ko}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Xr=/'/g,Zr=/"/g,Za=/^(?:script|style|textarea|title)$/i,Ja=s=>(e,...t)=>({_$litType$:s,strings:e,values:t}),c=Ja(1),O=Ja(2),Zt=Symbol.for("lit-noChange"),b=Symbol.for("lit-nothing"),Jr=new WeakMap,_t=At.createTreeWalker(At,129,null,!1);function en(s,e){if(!Array.isArray(s)||!s.hasOwnProperty("raw"))throw Error("invalid template strings array");return Qr!==void 0?Qr.createHTML(e):e}const yl=(s,e)=>{const t=s.length-1,i=[];let o,r=e===2?"<svg>":"",a=fi;for(let l=0;l<t;l++){const d=s[l];let p,u,v=-1,g=0;for(;g<d.length&&(a.lastIndex=g,u=a.exec(d),u!==null);)g=a.lastIndex,a===fi?u[1]==="!--"?a=Kr:u[1]!==void 0?a=Yr:u[2]!==void 0?(Za.test(u[2])&&(o=RegExp("</"+u[2],"g")),a=bt):u[3]!==void 0&&(a=bt):a===bt?u[0]===">"?(a=o??fi,v=-1):u[1]===void 0?v=-2:(v=a.lastIndex-u[2].length,p=u[1],a=u[3]===void 0?bt:u[3]==='"'?Zr:Xr):a===Zr||a===Xr?a=bt:a===Kr||a===Yr?a=fi:(a=bt,o=void 0);const y=a===bt&&s[l+1].startsWith("/>")?" ":"";r+=a===fi?d+gl:v>=0?(i.push(p),d.slice(0,v)+ks+d.slice(v)+ht+y):d+ht+(v===-2?(i.push(void 0),l):y)}return[en(s,r+(s[t]||"<?>")+(e===2?"</svg>":"")),i]};class Pi{constructor({strings:e,_$litType$:t},i){let o;this.parts=[];let r=0,a=0;const l=e.length-1,d=this.parts,[p,u]=yl(e,t);if(this.el=Pi.createElement(p,i),_t.currentNode=this.el.content,t===2){const v=this.el.content,g=v.firstChild;g.remove(),v.append(...g.childNodes)}for(;(o=_t.nextNode())!==null&&d.length<l;){if(o.nodeType===1){if(o.hasAttributes()){const v=[];for(const g of o.getAttributeNames())if(g.endsWith(ks)||g.startsWith(ht)){const y=u[a++];if(v.push(g),y!==void 0){const w=o.getAttribute(y.toLowerCase()+ks).split(ht),$=/([.?@])?(.*)/.exec(y);d.push({type:1,index:r,name:$[2],strings:w,ctor:$[1]==="."?xl:$[1]==="?"?$l:$[1]==="@"?_l:To})}else d.push({type:6,index:r})}for(const g of v)o.removeAttribute(g)}if(Za.test(o.tagName)){const v=o.textContent.split(ht),g=v.length-1;if(g>0){o.textContent=Xt?Xt.emptyScript:"";for(let y=0;y<g;y++)o.append(v[y],zi()),_t.nextNode(),d.push({type:2,index:++r});o.append(v[g],zi())}}}else if(o.nodeType===8)if(o.data===Ya)d.push({type:2,index:r});else{let v=-1;for(;(v=o.data.indexOf(ht,v+1))!==-1;)d.push({type:7,index:r}),v+=ht.length-1}r++}}static createElement(e,t){const i=At.createElement("template");return i.innerHTML=e,i}}function Jt(s,e,t=s,i){var o,r,a,l;if(e===Zt)return e;let d=i!==void 0?(o=t._$Co)===null||o===void 0?void 0:o[i]:t._$Cl;const p=Li(e)?void 0:e._$litDirective$;return d?.constructor!==p&&((r=d?._$AO)===null||r===void 0||r.call(d,!1),p===void 0?d=void 0:(d=new p(s),d._$AT(s,t,i)),i!==void 0?((a=(l=t)._$Co)!==null&&a!==void 0?a:l._$Co=[])[i]=d:t._$Cl=d),d!==void 0&&(e=Jt(s,d._$AS(s,e.values),d,i)),e}let wl=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){var t;const{el:{content:i},parts:o}=this._$AD,r=((t=e?.creationScope)!==null&&t!==void 0?t:At).importNode(i,!0);_t.currentNode=r;let a=_t.nextNode(),l=0,d=0,p=o[0];for(;p!==void 0;){if(l===p.index){let u;p.type===2?u=new Oi(a,a.nextSibling,this,e):p.type===1?u=new p.ctor(a,p.name,p.strings,this,e):p.type===6&&(u=new Cl(a,this,e)),this._$AV.push(u),p=o[++d]}l!==p?.index&&(a=_t.nextNode(),l++)}return _t.currentNode=At,r}v(e){let t=0;for(const i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}};class Oi{constructor(e,t,i,o){var r;this.type=2,this._$AH=b,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=o,this._$Cp=(r=o?.isConnected)===null||r===void 0||r}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cp}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Jt(this,e,t),Li(e)?e===b||e==null||e===""?(this._$AH!==b&&this._$AR(),this._$AH=b):e!==this._$AH&&e!==Zt&&this._(e):e._$litType$!==void 0?this.g(e):e.nodeType!==void 0?this.$(e):bl(e)?this.T(e):this._(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==b&&Li(this._$AH)?this._$AA.nextSibling.data=e:this.$(At.createTextNode(e)),this._$AH=e}g(e){var t;const{values:i,_$litType$:o}=e,r=typeof o=="number"?this._$AC(e):(o.el===void 0&&(o.el=Pi.createElement(en(o.h,o.h[0]),this.options)),o);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===r)this._$AH.v(i);else{const a=new wl(r,this),l=a.u(this.options);a.v(i),this.$(l),this._$AH=a}}_$AC(e){let t=Jr.get(e.strings);return t===void 0&&Jr.set(e.strings,t=new Pi(e)),t}T(e){Xa(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,o=0;for(const r of e)o===t.length?t.push(i=new Oi(this.k(zi()),this.k(zi()),this,this.options)):i=t[o],i._$AI(r),o++;o<t.length&&(this._$AR(i&&i._$AB.nextSibling,o),t.length=o)}_$AR(e=this._$AA.nextSibling,t){var i;for((i=this._$AP)===null||i===void 0||i.call(this,!1,!0,t);e&&e!==this._$AB;){const o=e.nextSibling;e.remove(),e=o}}setConnected(e){var t;this._$AM===void 0&&(this._$Cp=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}}class To{constructor(e,t,i,o,r){this.type=1,this._$AH=b,this._$AN=void 0,this.element=e,this.name=t,this._$AM=o,this.options=r,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=b}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,i,o){const r=this.strings;let a=!1;if(r===void 0)e=Jt(this,e,t,0),a=!Li(e)||e!==this._$AH&&e!==Zt,a&&(this._$AH=e);else{const l=e;let d,p;for(e=r[0],d=0;d<r.length-1;d++)p=Jt(this,l[i+d],t,d),p===Zt&&(p=this._$AH[d]),a||(a=!Li(p)||p!==this._$AH[d]),p===b?e=b:e!==b&&(e+=(p??"")+r[d+1]),this._$AH[d]=p}a&&!o&&this.j(e)}j(e){e===b?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}let xl=class extends To{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===b?void 0:e}};const Sl=Xt?Xt.emptyScript:"";let $l=class extends To{constructor(){super(...arguments),this.type=4}j(e){e&&e!==b?this.element.setAttribute(this.name,Sl):this.element.removeAttribute(this.name)}};class _l extends To{constructor(e,t,i,o,r){super(e,t,i,o,r),this.type=5}_$AI(e,t=this){var i;if((e=(i=Jt(this,e,t,0))!==null&&i!==void 0?i:b)===Zt)return;const o=this._$AH,r=e===b&&o!==b||e.capture!==o.capture||e.once!==o.once||e.passive!==o.passive,a=e!==b&&(o===b||r);r&&this.element.removeEventListener(this.name,this,o),a&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,i;typeof this._$AH=="function"?this._$AH.call((i=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&i!==void 0?i:this.element,e):this._$AH.handleEvent(e)}}class Cl{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){Jt(this,e)}}const ea=uo.litHtmlPolyfillSupport;ea?.(Pi,Oi),((Qo=uo.litHtmlVersions)!==null&&Qo!==void 0?Qo:uo.litHtmlVersions=[]).push("2.8.0");const io=(s,e,t)=>{var i,o;const r=(i=t?.renderBefore)!==null&&i!==void 0?i:e;let a=r._$litPart$;if(a===void 0){const l=(o=t?.renderBefore)!==null&&o!==void 0?o:null;r._$litPart$=a=new Oi(e.insertBefore(zi(),l),l,void 0,t??{})}return a._$AI(s),a};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Yo,Xo;let B=class extends Wt{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e,t;const i=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=i.firstChild),i}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=io(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!1)}render(){return Zt}};B.finalized=!0,B._$litElement$=!0,(Yo=globalThis.litElementHydrateSupport)===null||Yo===void 0||Yo.call(globalThis,{LitElement:B});const ta=globalThis.litElementPolyfillSupport;ta?.({LitElement:B});((Xo=globalThis.litElementVersions)!==null&&Xo!==void 0?Xo:globalThis.litElementVersions=[]).push("3.3.3");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const F=s=>e=>typeof e=="function"?((t,i)=>(customElements.define(t,i),i))(s,e):((t,i)=>{const{kind:o,elements:r}=i;return{kind:o,elements:r,finisher(a){customElements.define(t,a)}}})(s,e);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const kl=(s,e)=>e.kind==="method"&&e.descriptor&&!("value"in e.descriptor)?{...e,finisher(t){t.createProperty(e.key,s)}}:{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){typeof e.initializer=="function"&&(this[e.key]=e.initializer.call(this))},finisher(t){t.createProperty(e.key,s)}},Tl=(s,e,t)=>{e.constructor.createProperty(t,s)};function h(s){return(e,t)=>t!==void 0?Tl(s,e,t):kl(s,e)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function z(s){return h({...s,state:!0})}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const tn=({finisher:s,descriptor:e})=>(t,i)=>{var o;if(i===void 0){const r=(o=t.originalKey)!==null&&o!==void 0?o:t.key,a=e!=null?{kind:"method",placement:"prototype",key:r,descriptor:e(t.key)}:{...t,key:r};return s!=null&&(a.finisher=function(l){s(l,r)}),a}{const r=t.constructor;e!==void 0&&Object.defineProperty(t,i,e(i)),s?.(r,i)}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function j(s,e){return tn({descriptor:t=>({get(){var o,r;return(r=(o=this.renderRoot)===null||o===void 0?void 0:o.querySelector(s))!==null&&r!==void 0?r:null},enumerable:!0,configurable:!0})})}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function El(s){return tn({descriptor:e=>({get(){var t,i;return(i=(t=this.renderRoot)===null||t===void 0?void 0:t.querySelectorAll(s))!==null&&i!==void 0?i:[]},enumerable:!0,configurable:!0})})}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Zo;((Zo=window.HTMLSlotElement)===null||Zo===void 0?void 0:Zo.prototype.assignedElements)!=null;class Ml{constructor(){this.resizeObserver=new ResizeObserver(e=>{window.requestAnimationFrame(()=>{for(const t of e){const i=this.resizeHandlers.get(t.target);i?.forEach(o=>{o.handleResize(t)})}})}),this.resizeHandlers=new Map}shutdown(){this.resizeHandlers.forEach((e,t)=>{this.resizeObserver.unobserve(t)}),this.resizeHandlers.clear()}addObserver(e){var t;const i=(t=this.resizeHandlers.get(e.target))!==null&&t!==void 0?t:new Set;i.add(e.handler),this.resizeHandlers.set(e.target,i),this.resizeObserver.observe(e.target,e.options)}removeObserver(e){const t=this.resizeHandlers.get(e.target);t&&(t.delete(e.handler),t.size===0&&(this.resizeObserver.unobserve(e.target),this.resizeHandlers.delete(e.target)))}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const We={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4},Ni=s=>(...e)=>({_$litDirective$:s,values:e});class Ui{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ct=Ni(class extends Ui{constructor(s){var e;if(super(s),s.type!==We.ATTRIBUTE||s.name!=="class"||((e=s.strings)===null||e===void 0?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(s){return" "+Object.keys(s).filter(e=>s[e]).join(" ")+" "}update(s,[e]){var t,i;if(this.it===void 0){this.it=new Set,s.strings!==void 0&&(this.nt=new Set(s.strings.join(" ").split(/\s/).filter(r=>r!=="")));for(const r in e)e[r]&&!(!((t=this.nt)===null||t===void 0)&&t.has(r))&&this.it.add(r);return this.render(e)}const o=s.element.classList;this.it.forEach(r=>{r in e||(o.remove(r),this.it.delete(r))});for(const r in e){const a=!!e[r];a===this.it.has(r)||!((i=this.nt)===null||i===void 0)&&i.has(r)||(a?(o.add(r),this.it.add(r)):(o.remove(r),this.it.delete(r)))}return Me}});/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Dl=(s,...e)=>({strTag:!0,strings:s,values:e}),nt=Dl,Al=s=>typeof s!="string"&&"strTag"in s,zl=(s,e,t)=>{let i=s[0];for(let o=1;o<s.length;o++)i+=e[o-1],i+=s[o];return i};/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ll=s=>Al(s)?zl(s.strings,s.values):s;let C=Ll;/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class Pl{constructor(){this.settled=!1,this.promise=new Promise((e,t)=>{this._resolve=e,this._reject=t})}resolve(e){this.settled=!0,this._resolve(e)}reject(e){this.settled=!0,this._reject(e)}}/**
 * @license
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let Fl=new Pl;Fl.resolve();/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{I:Rl}=vl,on=s=>s.strings===void 0,ia=()=>document.createComment(""),mi=(s,e,t)=>{var i;const o=s._$AA.parentNode,r=e===void 0?s._$AB:e._$AA;if(t===void 0){const a=o.insertBefore(ia(),r),l=o.insertBefore(ia(),r);t=new Rl(a,l,s,s.options)}else{const a=t._$AB.nextSibling,l=t._$AM,d=l!==s;if(d){let p;(i=t._$AQ)===null||i===void 0||i.call(t,s),t._$AM=s,t._$AP!==void 0&&(p=s._$AU)!==l._$AU&&t._$AP(p)}if(a!==r||d){let p=t._$AA;for(;p!==a;){const u=p.nextSibling;o.insertBefore(p,r),p=u}}}return t},yt=(s,e,t=s)=>(s._$AI(e,t),s),Bl={},sn=(s,e=Bl)=>s._$AH=e,Il=s=>s._$AH,Jo=s=>{var e;(e=s._$AP)===null||e===void 0||e.call(s,!1,!0);let t=s._$AA;const i=s._$AB.nextSibling;for(;t!==i;){const o=t.nextSibling;t.remove(),t=o}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const oa=(s,e,t)=>{const i=new Map;for(let o=e;o<=t;o++)i.set(s[o],o);return i},ir=Ni(class extends Ui{constructor(s){if(super(s),s.type!==We.CHILD)throw Error("repeat() can only be used in text expressions")}ct(s,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);const o=[],r=[];let a=0;for(const l of s)o[a]=i?i(l,a):a,r[a]=t(l,a),a++;return{values:r,keys:o}}render(s,e,t){return this.ct(s,e,t).values}update(s,[e,t,i]){var o;const r=Il(s),{values:a,keys:l}=this.ct(e,t,i);if(!Array.isArray(r))return this.ut=l,a;const d=(o=this.ut)!==null&&o!==void 0?o:this.ut=[],p=[];let u,v,g=0,y=r.length-1,w=0,$=a.length-1;for(;g<=y&&w<=$;)if(r[g]===null)g++;else if(r[y]===null)y--;else if(d[g]===l[w])p[w]=yt(r[g],a[w]),g++,w++;else if(d[y]===l[$])p[$]=yt(r[y],a[$]),y--,$--;else if(d[g]===l[$])p[$]=yt(r[g],a[$]),mi(s,p[$+1],r[g]),g++,$--;else if(d[y]===l[w])p[w]=yt(r[y],a[w]),mi(s,r[g],r[y]),y--,w++;else if(u===void 0&&(u=oa(l,w,$),v=oa(d,g,y)),u.has(d[g]))if(u.has(d[y])){const T=v.get(l[w]),L=T!==void 0?r[T]:null;if(L===null){const E=mi(s,r[g]);yt(E,a[w]),p[w]=E}else p[w]=yt(L,a[w]),mi(s,r[g],L),r[T]=null;w++}else Jo(r[y]),y--;else Jo(r[g]),g++;for(;w<=$;){const T=mi(s,p[$+1]);yt(T,a[w]),p[w++]=T}for(;g<=y;){const T=r[g++];T!==null&&Jo(T)}return this.ut=l,sn(s,p),Me}});function Ki(s,e,t){return Array.from({length:(e-s)/t+1},(i,o)=>s+o*t)}let it=class extends B{constructor(){super(...arguments),this.itemCount=0,this.scrollOptimizationsDisabled=!1,this.intersectionObserver=new IntersectionObserver(e=>{e.forEach(t=>{if(t.target===this.sentinel){t.isIntersecting&&this.dispatchEvent(new Event("scrollThresholdReached"));return}const o=t.target.dataset.cellIndex;if(!o)return;const r=parseInt(o,10);t.isIntersecting?this.visibleCellIndices.add(r):this.visibleCellIndices.delete(r)}),this.scrollOptimizationsDisabled||this.processVisibleCells()}),this.renderedCellIndices=new Set,this.visibleCellIndices=new Set,this.placeholderCellIndices=new Set}reload(){Ki(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.removeCell(t)),this.renderedCellIndices.clear(),this.visibleCellIndices.clear(),this.placeholderCellIndices.clear(),this.setupObservations()}refreshCell(e){this.removeCell(e),this.bufferRange.includes(e)&&this.renderCellBuffer([e])}refreshAllVisibleCells(){this.bufferRange.forEach(e=>this.removeCell(e)),this.renderCellBuffer(this.bufferRange)}scrollToCell(e,t){const i=this.cellContainers[e];if(!i)return!1;const o=t?"smooth":"auto";return i.scrollIntoView({behavior:o}),!0}getVisibleCellIndices(){return Array.from(this.visibleCellIndices)}updated(e){(e.has("itemCount")||e.has("scrollOptimizationsDisabled"))&&this.setupObservations()}disconnectedCallback(){this.intersectionObserver.disconnect()}setupObservations(){this.setupIntersectionObserver()}setupIntersectionObserver(){this.intersectionObserver.disconnect(),this.sentinel&&this.intersectionObserver.observe(this.sentinel),this.scrollOptimizationsDisabled?(Ki(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.visibleCellIndices.add(t)),this.processVisibleCells()):this.cellContainers.forEach(e=>this.intersectionObserver.observe(e))}render(){var e;const t=this.itemCount-1,i=Ki(0,t,1),o=(e=this.ariaLandmarkLabel)!==null&&e!==void 0?e:b;return c`
    ...
    `}};n([h({type:Number})],it.prototype,"itemCount",void 0);n([h({type:Object})],it.prototype,"cellProvider",void 0);n([h({type:Object})],it.prototype,"placeholderCellTemplate",void 0);n([h({type:Boolean})],it.prototype,"scrollOptimizationsDisabled",void 0);n([h({type:String})],it.prototype,"ariaLandmarkLabel",void 0);n([j("#sentinel")],it.prototype,"sentinel",void 0);n([El(".cell-container")],it.prototype,"cellContainers",void 0);it=n([F("infinite-scroller")],it);function Ol(s){return s?.replace(/%22%22(?!%22%22)(.+?)%22%22/g,"%22$1%22")}function Nl(s){var e,t,i;return((e=s?.rawMetadata)===null||e===void 0?void 0:e.hit_type)==="favorited_search"?"search":(i=(t=s.mediatype)===null||t===void 0?void 0:t.value)!==null&&i!==void 0?i:"data"}const Ul=O`
  <svg
    viewBox="0 0 100 100"
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const id=(s,e,t)=>{for(const i of e)if(i[0]===s)return(0,i[1])();return t?.()},od=O`
...
`;var Ve;let ke=Ve=class extends B{constructor(){super(...arguments),this.placeholderType=null,this.detailMessage=""}render(){return this.placeholderType?c`${this.placeholderTemplate}`:b}get placeholderTemplate(){return c`
      <div
    ...
    `}};ke.MESSAGE_EMPTY_QUERY=C('To begin searching, enter a search term in the box above and hit "Go".');ke.MESSAGE_NO_SEARCH_RESULTS=C("Your search did not match any items in the Archive. Try different keywords or a more general search.");ke.MESSAGE_NO_COLLECTION_RESULTS=C("Your search did not match any items in this collection. Try different keywords or a more general search.");ke.MESSAGE_NO_VIEWABLE_MEMBERS=C("This collection contains no viewable items.");ke.MESSAGE_QUERY_ERROR=C(c`The search engine encountered an error, which might be related to your
      ...
      <a href="mailto:info@archive.org">info@archive.org</a>.`);ke.QUERY_ERROR_DETAILS_MESSAGE=C("Error details:");n([h({type:String})],ke.prototype,"placeholderType",void 0);n([h({type:Boolean})],ke.prototype,"isMobileView",void 0);n([h({type:Boolean})],ke.prototype,"isCollection",void 0);n([h({type:String})],ke.prototype,"detailMessage",void 0);ke=Ve=n([F("empty-placeholder")],ke);/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Fi=s=>s??Z,hn=O`
...
`;var As;(function(s){s[s.bytes=0]="bytes",s[s.kilobytes=1]="kilobytes",s[s.megabytes=2]="megabytes",s[s.gigabytes=3]="gigabytes",s[s.terabytes=4]="terabytes",s[s.petabytes=5]="petabytes",s[s.exabytes=6]="exabytes",s[s.zettabytes=7]="zettabytes",s[s.yottabytes=8]="yottabytes"})(As||(As={}));function sd(s,e,t=" "){let i=s;if(i===void 0)return b;let o=0;for(;i>1024;)i/=1024,o+=1;const r=10**e;i=Math.round(i*r)/r;let a=As[o];return a=i===1?a.slice(0,-1):a,`${i.toLocaleString()+t+a}`}const rd=m`var(--tileBackgroundColor, #ffffff)`,ad=m`var(--tileCornerRadius, 4px)`,Mo=m`
...
`;function Ri(s,e="short",t="en-US"){if(!s)return"";const i={};switch(e){case"year-only":return`${s.getUTCFullYear()}`;case"short":i.month="short",i.year="numeric";break;case"long":i.year="numeric",i.month="short",i.day="2-digit";break}return new Intl.DateTimeFormat(t,i).format(s)}class aa{constructor(e={}){var t;this.model=e.model,this.baseNavigationUrl=e.baseNavigationUrl,this.collectionPagePath=(t=e.collectionPagePath)!==null&&t!==void 0?t:"/details/",this.sortParam=e.sortParam,this.creatorFilter=e.creatorFilter}get firstCreatorMatchingFilter(){var e,t;let i;if(this.creatorFilter&&(!((e=this.model)===null||e===void 0)&&e.creators.length)){const o=this.creatorFilter;i=this.model.creators.find(r=>r.normalize("NFD").replace(/[^A-Z]+/gi,"").toUpperCase().startsWith(o))}return i??((t=this.model)===null||t===void 0?void 0:t.creator)}get accountLabel(){var e;return!((e=this.model)===null||e===void 0)&&e.dateAdded?C(nt`Archivist since ${this.model.dateAdded.getFullYear()}`):""}get dateLabel(){var e;switch((e=this.sortParam)===null||e===void 0?void 0:e.field){case"publicdate":return C("Archived");case"reviewdate":return C("Reviewed");case"addeddate":return C("Added");case"date":return C("Published");default:return""}}itemPageUrl(e,t=!1){if(!e||this.baseNavigationUrl==null)return b;const i=t?this.collectionPagePath:"/details/";return`${this.baseNavigationUrl}${i}${e}`}webArchivesCaptureLink(e,t){const o=`https://web.archive.org/web/${t.toISOString().replace(/[TZ:-]/g,"").replace(/\..*/,"")}/${encodeURIComponent(e)}`,r=Ri(t,"long");return c` <a href=${o}> ${r} </a> `}}class ce extends B{constructor(){super(...arguments),this.sortParam=null,this.defaultSortParam=null,this.loggedIn=!1,this.displayValueProvider=new aa}willUpdate(e){var t,i;(e.has("model")||e.has("baseNavigationUrl")||e.has("collectionPagePath")||e.has("sortParam")||e.has("defaultSortParam")||e.has("creatorFilter"))&&(this.displayValueProvider=new aa({model:this.model,baseNavigationUrl:this.baseNavigationUrl,collectionPagePath:this.collectionPagePath,sortParam:(i=(t=this.sortParam)!==null&&t!==void 0?t:this.defaultSortParam)!==null&&i!==void 0?i:void 0,creatorFilter:this.creatorFilter}))}}n([h({type:Object})],ce.prototype,"model",void 0);n([h({type:Number})],ce.prototype,"currentWidth",void 0);n([h({type:Number})],ce.prototype,"currentHeight",void 0);n([h({type:String})],ce.prototype,"baseNavigationUrl",void 0);n([h({type:String})],ce.prototype,"baseImageUrl",void 0);n([h({type:String})],ce.prototype,"collectionPagePath",void 0);n([h({type:Object})],ce.prototype,"sortParam",void 0);n([h({type:Object})],ce.prototype,"defaultSortParam",void 0);n([h({type:String})],ce.prototype,"creatorFilter",void 0);n([h({type:Number})],ce.prototype,"mobileBreakpoint",void 0);n([h({type:Boolean})],ce.prototype,"loggedIn",void 0);let zs=class extends B{render(){return c`<div class="icon-overlay">${this.iconTemplate}</div>`}get iconTemplate(){var e;return this.type?c`${(e=rn[this.type])!==null&&e!==void 0?e:b}`:b}static get styles(){return m`
    ...
    `}};n([h({type:String})],zs.prototype,"type",void 0);zs=n([F("icon-overlay")],zs);let Ls=class extends B{render(){return c`
      <div class="overlay no-preview">
        <div class="icon-overlay">${this.iconTemplate}</div>
        <p class="text-overlay">${this.textTemplate}</p>
      </div>
    `}get iconTemplate(){var e;return this.type?c`${(e=rn[this.type])!==null&&e!==void 0?e:b}`:b}get textTemplate(){var e;return this.type?c`${(e=Vl[this.type])!==null&&e!==void 0?e:b}`:b}static get styles(){return m`
      :host {
        align-items: center;
        display: flex;
      }
    ...
    `}};n([h({type:String})],Ls.prototype,"type",void 0);Ls=n([F("text-overlay")],Ls);let ut=class extends B{constructor(){super(...arguments),this.isCompactTile=!1,this.isListTile=!1,this.loggedIn=!1,this.viewSize="desktop"}render(){var e;return!((e=this.model)===null||e===void 0)&&e.identifier?c`
      <div class=${Ct(this.baseClass)}>
        <item-image
          .model=${this.model}
    ...
    `}};n([h({type:String})],ut.prototype,"baseImageUrl",void 0);n([h({type:Boolean})],ut.prototype,"isCompactTile",void 0);n([h({type:Boolean})],ut.prototype,"isListTile",void 0);n([h({type:Boolean})],ut.prototype,"loggedIn",void 0);n([h({type:Object})],ut.prototype,"model",void 0);n([h({type:String})],ut.prototype,"viewSize",void 0);ut=n([F("image-block")],ut);let Ps=class extends ce{constructor(){super(...arguments),this.showInfoButton=!1}render(){return c`
      <div class="container">
    ...
    >`}get getSizeTemplate(){var e,t;const i=(t=(e=this.model)===null||e===void 0?void 0:e.collectionSize)!==null&&t!==void 0?t:0;return i?c`<span id="item-size">${sd(i,1)}</span>`:""}get infoButtonTemplate(){return this.showInfoButton?c`<button class="info-button" @click=${this.infoButtonPressed}>
          &#9432;
          <span class="sr-only">${C("More info")}</span>
        </button>`:b}infoButtonPressed(e){e.preventDefault();const t=new CustomEvent("infoButtonPressed",{detail:{x:e.clientX,y:e.clientY}});this.dispatchEvent(t)}static get styles(){const e=m`var(--tileBorderColor, #555555)`,t=m`var(--tileBackgroundColor, #666666)`,i=m`#fff`;return[Mo,m`
        .container {
          background-color: ${t};
          border: 1px solid ${e};
        }
      ...
      `]}};n([h({type:Boolean})],Ps.prototype,"showInfoButton",void 0);Ps=n([F("collection-tile")],Ps);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*kt(s,e){if(s!==void 0){let t=0;for(const i of s)yield e(i,t++)}}function ar(s){return s?s.toISOString().endsWith("-01-01T00:00:00.000Z"):!1}const pn=c`
...
`;let ei=class extends B{constructor(){super(...arguments),this.title="",this.body="",this.starRating=0,this.viewSize="desktop"}render(){return!this.title&&!this.body&&!this.starRating?b:c`
    ...
    `}static get styles(){return[st,m`
      ...
      `]}};n([h({type:String})],ei.prototype,"title",void 0);n([h({type:String})],ei.prototype,"body",void 0);n([h({type:Number})],ei.prototype,"starRating",void 0);n([h({type:String})],ei.prototype,"viewSize",void 0);ei=n([F("review-block")],ei);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*oo(s,e){const t=typeof e=="function";if(s!==void 0){let i=-1;for(const o of s)i>-1&&(yield t?e(i):e),i++,yield o}}let bo=class extends B{constructor(){super(...arguments),this.snippets=[],this.viewSize="desktop"}render(){var e;return!((e=this.snippets)===null||e===void 0)&&e.length?c`
      <div class="container">
        <div class="snippet-view ${this.viewSize}">
    ...
    `:c`${b}`}get ellipsisJoinedSnippets(){return c`
      &hellip; ${oo(this.snippetTemplates,c` &hellip; `)} &hellip;
    ...
    `}};n([h({type:Array})],bo.prototype,"snippets",void 0);n([h({type:String})],bo.prototype,"viewSize",void 0);bo=n([F("text-snippet-block")],bo);const ld=m`
  .drop-shadow {
    overflow: hidden;
    height: 100%;
  }
...
`;let qe=class extends B{constructor(){super(...arguments),this.isListTile=!1,this.isCompactTile=!1,this.loggedIn=!1,this.isWaveform=!1,this.isNotFound=!1}render(){return c`
    ...
    `}get imageSrc(){var e,t,i;if(this.isNotFound)return this.notFoundSrc;if(!((e=this.model)===null||e===void 0)&&e.captureDates&&this.model.identifier)try{const o=new URL(this.model.identifier),r=encodeURIComponent(o.hostname);return this.baseImageUrl?`https://web.archive.org/thumb/${r}?generate=1`:b}catch{return`${this.baseImageUrl}/images/notfound.png`}return!((t=this.model)===null||t===void 0)&&t.thumbnailUrl?this.model.thumbnailUrl:this.baseImageUrl&&(!((i=this.model)===null||i===void 0)&&i.identifier)?`${this.baseImageUrl}/services/img/${this.model.identifier}`:b}get notFoundSrc(){return this.baseImageUrl?`${this.baseImageUrl}/images/notfound.png`:b}get hashBasedGradient(){var e;return!((e=this.model)===null||e===void 0)&&e.identifier?`waveform-grad${this.hashStrToInt(this.model.identifier)%6}`:"waveform-grad0"}hashStrToInt(e){return e.split("").reduce((t,i)=>t+i.charCodeAt(0),0)}get itemBaseClass(){var e;return{"drop-shadow":!0,"list-box":this.isListTile,"search-image":((e=this.model)===null||e===void 0?void 0:e.mediatype)==="search",[this.hashBasedGradient]:this.isWaveform}}get itemImageClass(){var e,t,i;const o=((e=this.model)===null||e===void 0?void 0:e.contentWarning)||((t=this.model)===null||t===void 0?void 0:t.loginRequired);return{contain:!this.isCompactTile&&!this.isWaveform,cover:this.isCompactTile,blur:o||!1,waveform:this.isWaveform,"account-image":this.isAccountImage,"collection-image":((i=this.model)===null||i===void 0?void 0:i.mediatype)==="collection"}}get isAccountImage(){var e;return((e=this.model)===null||e===void 0?void 0:e.mediatype)==="account"&&!this.isCompactTile&&!this.isListTile}onLoad(){var e,t;(((e=this.model)===null||e===void 0?void 0:e.mediatype)==="audio"||((t=this.model)===null||t===void 0?void 0:t.mediatype)==="etree")&&this.baseImage.naturalWidth/this.baseImage.naturalHeight===4&&(this.isWaveform=!0)}onError(){this.isNotFound=!0}static get styles(){return[ld,dd,m`
      ...
      `]}};n([h({type:Object})],qe.prototype,"model",void 0);n([h({type:String})],qe.prototype,"baseImageUrl",void 0);n([h({type:Boolean})],qe.prototype,"isListTile",void 0);n([h({type:Boolean})],qe.prototype,"isCompactTile",void 0);n([h({type:Boolean})],qe.prototype,"loggedIn",void 0);n([z()],qe.prototype,"isWaveform",void 0);n([z()],qe.prototype,"isNotFound",void 0);n([j("img")],qe.prototype,"baseImage",void 0);qe=n([F("item-image")],qe);const cd=O`
...
`,fn={account:{color:"#000000",icon:cd,text:"Account"},audio:{color:"#00adef",icon:hd,text:"Audio"},collection:{color:"#4666ff",icon:hn,text:"Collection"},data:{color:"#333333",icon:pd,text:"Data"},etree:{color:"#00adef",icon:ud,text:"E-tree"},film:{color:"#bf1b2c",icon:na,text:"Film"},image:{color:"#aa99c9",icon:fd,text:"Image"},movies:{color:"#f1644b",icon:na,text:"Movie"},none:{color:"#00000000",icon:c``,text:""},radio:{color:"#8fdaef",icon:md,text:"Radio"},software:{color:"#9ecc4f",icon:vd,text:"Software"},texts:{color:"#faab3c",icon:gd,text:"Text"},tv:{color:"#f1644b",icon:bd,text:"TV"},tvCommercial:{color:"#84b648",icon:yd,text:"TV Commercial"},tvFactCheck:{color:"#f1644b",icon:wd,text:"TV Fact Check"},tvQuote:{color:"#fe7a5f",icon:$d,text:"TV Quote"},video:{color:"#f1644b",icon:xd,text:"Video"},web:{color:"#ffcd27",icon:Sd,text:"Web"},search:{color:"#000000",icon:un,text:"Search"}},_d="tv_ads",Cd="factchecked",kd=new Set(["tvnews","tvarchive","television"]),Td=new Set(["radio","radioprogram"]);let ti=class extends B{constructor(){super(...arguments),this.isTvSearchResult=!1,this.showText=!1}get displayMediatype(){var e;return this.isTvItem?this.tvDisplayMediatype:this.isRadioItem?"radio":(e=this.mediatype)!==null&&e!==void 0?e:"none"}get tvDisplayMediatype(){var e,t;return!((e=this.collections)===null||e===void 0)&&e.includes(_d)?"tvCommercial":this.isTvSearchResult&&(!((t=this.collections)===null||t===void 0)&&t.includes(Cd))?"tvFactCheck":"tv"}get isTvItem(){var e;return this.mediatype==="movies"&&!!(!((e=this.collections)===null||e===void 0)&&e.some(t=>kd.has(t)))}get isRadioItem(){var e;return this.mediatype==="audio"&&!!(!((e=this.collections)===null||e===void 0)&&e.some(t=>Td.has(t)))}render(){const e=fn[this.displayMediatype];return e?c`
      <div
        id="icon"
...
`;function zd(s,e){let t=1;return s>=1e9?t=1e9:s>=1e6?t=1e6:s>=1e3&&e==="short"&&(t=1e3),t}function Ld(s=0,e){const t=s/e,i=t<10;let o=0;return i?o=Math.round((t+Number.EPSILON)*10)/10:o=Math.round(t),o}function Pd(s,e,t,i){switch(e){case 1e9:return C(t==="short"?nt`${s}B`:nt`${s} billion`);case 1e6:return C(t==="short"?nt`${s}M`:nt`${s} million`);case 1e3:return C(t==="short"?nt`${s}K`:nt`${s} thousand`);default:return new Intl.NumberFormat(i).format(s)}}function nr(s,e="long",t="short",i="en-US"){const o=s??-1;if(o<0)return"";const r=zd(o,e),a=Ld(o,r);return Pd(a,r,t,i)}let De=class extends B{constructor(){super(...arguments),this.isTvSearchResult=!1,this.showTvClips=!1}render(){return c`
    ...
    `}columnTemplate(e,t,i,o=[]){const r=nr(e??0,"short","short"),a=C(nt`${r} ${t}`),l=t+":";return c`
    ...
    `}get viewsColumnTemplate(){var e;const t=(e=this.viewLabel)!==null&&e!==void 0?e:C("all-time views");return this.columnTemplate(this.viewCount,t,Dd)}get uploadsColumnTemplate(){return this.columnTemplate(this.itemCount,C("uploads"),Md)}get favoritesColumnTemplate(){return this.columnTemplate(this.favCount,C("favorites"),pn)}get reviewsColumnTemplate(){return this.columnTemplate(this.commentCount,C("reviews"),Ed,["reviews"])}get tvClipsColumnTemplate(){return this.columnTemplate(this.tvClipCount,C("clips"),Ad)}static get styles(){return[st,m`
        tile-mediatype-icon {
          --iconHeight: 25px;
          --iconWidth: 25px;
        }
      ...
      `]}};n([h({type:String})],De.prototype,"mediatype",void 0);n([h({type:Array})],De.prototype,"collections",void 0);n([h({type:Number})],De.prototype,"itemCount",void 0);n([h({type:Number})],De.prototype,"viewCount",void 0);n([h({type:String})],De.prototype,"viewLabel",void 0);n([h({type:Number})],De.prototype,"favCount",void 0);n([h({type:Number})],De.prototype,"commentCount",void 0);n([h({type:Boolean})],De.prototype,"isTvSearchResult",void 0);n([h({type:Boolean})],De.prototype,"showTvClips",void 0);n([h({type:Number})],De.prototype,"tvClipCount",void 0);De=n([F("tile-stats")],De);let yo=class extends ce{constructor(){super(...arguments),this.showInfoButton=!1,this.showTvClips=!1}render(){var e,t,i,o,r,a,l,d,p,u;const v=(e=this.model)===null||e===void 0?void 0:e.title,g=(t=this.sortParam)!==null&&t!==void 0?t:this.defaultSortParam,[y,w]=g?.field==="week"?[(i=this.model)===null||i===void 0?void 0:i.weeklyViewCount,"weekly views"]:[(o=this.model)===null||o===void 0?void 0:o.viewCount,"all-time views"];return c`
      <div class="container">
        ${this.infoButtonTemplate}
        <div class="tile-details">
          <div class="item-info">
          ...
          <tile-stats
            ...
            ?isTvSearchResult=${(p=this.model)===null||p===void 0?void 0:p.isTvSearchResult}
            .tvClipCount=${(u=this.model)===null||u===void 0?void 0:u.tvClipCount}
    ...
    `}get sortedDateInfoTemplate(){var e,t,i,o,r;let a,l="long";switch((e=this.effectiveSort)===null||e===void 0?void 0:e.field){case"date":{const d=(t=this.model)===null||t===void 0?void 0:t.datePublished;a={field:"published",value:d},ar(d)&&(l="year-only");break}case"reviewdate":a={field:"reviewed",value:(i=this.model)===null||i===void 0?void 0:i.dateReviewed};break;case"addeddate":a={field:"added",value:(o=this.model)===null||o===void 0?void 0:o.dateAdded};break;case"publicdate":a={field:"archived",value:(r=this.model)===null||r===void 0?void 0:r.dateArchived};break}return a?.value?c`
      <div class="date-sorted-by truncated">
        <span>
          ${a?.field} ${Ri(a?.value,l)}
        </span>
      </div>
    ...
    `}get isSortedByDate(){var e;return["date","reviewdate","addeddate","publicdate"].includes((e=this.effectiveSort)===null||e===void 0?void 0:e.field)}get effectiveSort(){var e;return(e=this.sortParam)!==null&&e!==void 0?e:this.defaultSortParam}get hasSnippets(){var e,t;return!!(!((t=(e=this.model)===null||e===void 0?void 0:e.snippets)===null||t===void 0)&&t.length)}infoButtonPressed(e){e.preventDefault();const t=new CustomEvent("infoButtonPressed",{detail:{x:e.clientX,y:e.clientY}});this.dispatchEvent(t)}static get styles(){const e=m`var(--tileBorderColor, #dddddd)`;return[Mo,m`
      ...
      `]}};n([h({type:Boolean})],yo.prototype,"showInfoButton",void 0);n([h({type:Boolean})],yo.prototype,"showTvClips",void 0);yo=n([F("item-tile")],yo);let Fs=class extends ce{constructor(){super(...arguments),this.showInfoButton=!1}render(){return c`
      <div class="container">
        ${this.infoButtonTemplate}
        <div class="tile-details">
          <div class="item-info">
    ...
    >
          ...
          &#9432;
          <span class="sr-only">${C("More info")}</span>
        </button>`:b}infoButtonPressed(e){e.preventDefault();const t=new CustomEvent("infoButtonPressed",{detail:{x:e.clientX,y:e.clientY}});this.dispatchEvent(t)}static get styles(){const e=m`var(--tileBorderColor, #dddddd)`;return[Mo,m`
        .container {
          border: 1px solid ${e};
        }
      `]}};n([h({type:Boolean})],Fs.prototype,"showInfoButton",void 0);Fs=n([F("account-tile")],Fs);let Rs=class extends ce{constructor(){super(...arguments),this.showInfoButton=!1}render(){return c`
      <div class="container">
        <div class="tile-details">
          <div class="item-info">
            ${this.getImageBlockTemplate} ${this.getTitleTemplate}
    ...
    `}get getTitleTemplate(){var e;return c`<div id="title">
      <h4 class="truncated">${(e=this.model)===null||e===void 0?void 0:e.title}</h4>
    </div>`}static get styles(){const e=m`var(--tileBorderColor, #555555)`,t=m`var(--tileBackgroundColor, #666666)`,i=m`#fff`;return[Mo,m`
        .container {
          background-color: ${t};
          border: 1px solid ${e};
        }
      ...
      `]}};n([h({type:Boolean})],Rs.prototype,"showInfoButton",void 0);Rs=n([F("search-tile")],Rs);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class Bs extends Ui{constructor(e){if(super(e),this.et=Z,e.type!==We.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===Z||e==null)return this.ft=void 0,this.et=e;if(e===Me)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.et)return this.ft;this.et=e;const t=[e];return t.raw=t,this.ft={_$litType$:this.constructor.resultType,strings:t,values:[]}}}Bs.directiveName="unsafeHTML",Bs.resultType=1;const Fd=Ni(Bs);/*! @license DOMPurify 3.2.4 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/3.2.4/LICENSE */const{entries:mn,setPrototypeOf:la,isFrozen:Rd,getPrototypeOf:Bd,getOwnPropertyDescriptor:Id}=Object;let{freeze:Se,seal:Ae,create:vn}=Object,{apply:Is,construct:Os}=typeof Reflect<"u"&&Reflect;Se||(Se=function(e){return e});Ae||(Ae=function(e){return e});Is||(Is=function(e,t,i){return e.apply(t,i)});Os||(Os=function(e,t){return new e(...t)});const Xi=$e(Array.prototype.forEach),Od=$e(Array.prototype.lastIndexOf),da=$e(Array.prototype.pop),vi=$e(Array.prototype.push),Nd=$e(Array.prototype.splice),so=$e(String.prototype.toLowerCase),es=$e(String.prototype.toString),ca=$e(String.prototype.match),gi=$e(String.prototype.replace),Ud=$e(String.prototype.indexOf),Hd=$e(String.prototype.trim),Pe=$e(Object.prototype.hasOwnProperty),we=$e(RegExp.prototype.test),bi=Vd(TypeError);function $e(s){return function(e){for(var t=arguments.length,i=new Array(t>1?t-1:0),o=1;o<t;o++)i[o-1]=arguments[o];return Is(s,e,i)}}function Vd(s){return function(){for(var e=arguments.length,t=new Array(e),i=0;i<e;i++)t[i]=arguments[i];return Os(s,t)}}function N(s,e){let t=arguments.length>2&&arguments[2]!==void 0?arguments[2]:so;la&&la(s,null);let i=e.length;for(;i--;){let o=e[i];if(typeof o=="string"){const r=t(o);r!==o&&(Rd(e)||(e[i]=r),o=r)}s[o]=!0}return s}function Wd(s){for(let e=0;e<s.length;e++)Pe(s,e)||(s[e]=null);return s}function St(s){const e=vn(null);for(const[t,i]of mn(s))Pe(s,t)&&(Array.isArray(i)?e[t]=Wd(i):i&&typeof i=="object"&&i.constructor===Object?e[t]=St(i):e[t]=i);return e}function yi(s,e){for(;s!==null;){const i=Id(s,e);if(i){if(i.get)return $e(i.get);if(typeof i.value=="function")return $e(i.value)}s=Bd(s)}function t(){return null}return t}const ha=Se(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","section","select","shadow","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),ts=Se(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","filter","font","g","glyph","glyphref","hkern","image","line","lineargradient","marker","mask","metadata","mpath","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),is=Se(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feDropShadow","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),jd=Se(["animate","color-profile","cursor","discard","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),os=Se(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover","mprescripts"]),Gd=Se(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),pa=Se(["#text"]),ua=Se(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","face","for","headers","height","hidden","high","href","hreflang","id","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","pattern","placeholder","playsinline","popover","popovertarget","popovertargetaction","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","wrap","xmlns","slot"]),ss=Se(["accent-height","accumulate","additive","alignment-baseline","amplitude","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","exponent","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","intercept","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","slope","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","tablevalues","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),fa=Se(["accent","accentunder","align","bevelled","close","columnsalign","columnlines","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lspace","lquote","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),Zi=Se(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),qd=Ae(/\{\{[\w\W]*|[\w\W]*\}\}/gm),Qd=Ae(/<%[\w\W]*|[\w\W]*%>/gm),Kd=Ae(/\$\{[\w\W]*/gm),Yd=Ae(/^data-[\-\w.\u00B7-\uFFFF]+$/),Xd=Ae(/^aria-[\-\w]+$/),gn=Ae(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),Zd=Ae(/^(?:\w+script|data):/i),Jd=Ae(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),bn=Ae(/^html$/i),ec=Ae(/^[a-z][.\w]*(-[.\w]+)+$/i);var ma=Object.freeze({__proto__:null,ARIA_ATTR:Xd,ATTR_WHITESPACE:Jd,CUSTOM_ELEMENT:ec,DATA_ATTR:Yd,DOCTYPE_NAME:bn,ERB_EXPR:Qd,IS_ALLOWED_URI:gn,IS_SCRIPT_OR_DATA:Zd,MUSTACHE_EXPR:qd,TMPLIT_EXPR:Kd});const wi={element:1,text:3,progressingInstruction:7,comment:8,document:9},tc=function(){return typeof window>"u"?null:window},ic=function(e,t){if(typeof e!="object"||typeof e.createPolicy!="function")return null;let i=null;const o="data-tt-policy-suffix";t&&t.hasAttribute(o)&&(i=t.getAttribute(o));const r="dompurify"+(i?"#"+i:"");try{return e.createPolicy(r,{createHTML(a){return a},createScriptURL(a){return a}})}catch{return console.warn("TrustedTypes policy "+r+" could not be created."),null}},va=function(){return{afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}};function yn(){let s=arguments.length>0&&arguments[0]!==void 0?arguments[0]:tc();const e=A=>yn(A);if(e.version="3.2.4",e.removed=[],!s||!s.document||s.document.nodeType!==wi.document||!s.Element)return e.isSupported=!1,e;let{document:t}=s;const i=t,o=i.currentScript,{DocumentFragment:r,HTMLTemplateElement:a,Node:l,Element:d,NodeFilter:p,NamedNodeMap:u=s.NamedNodeMap||s.MozNamedAttrMap,HTMLFormElement:v,DOMParser:g,trustedTypes:y}=s,w=d.prototype,$=yi(w,"cloneNode"),T=yi(w,"remove"),L=yi(w,"nextSibling"),E=yi(w,"childNodes"),P=yi(w,"parentNode");if(typeof a=="function"){const A=t.createElement("template");A.content&&A.content.ownerDocument&&(t=A.content.ownerDocument)}let R,H="";const{implementation:oe,createNodeIterator:Te,createDocumentFragment:me,getElementsByTagName:ne}=t,{importNode:Ce}=i;let q=va();e.isSupported=typeof mn=="function"&&typeof P=="function"&&oe&&oe.createHTMLDocument!==void 0;const{MUSTACHE_EXPR:Oe,ERB_EXPR:Q,TMPLIT_EXPR:le,DATA_ATTR:Ne,ARIA_ATTR:mt,IS_SCRIPT_OR_DATA:li,ATTR_WHITESPACE:zt,CUSTOM_ELEMENT:di}=ma;let{IS_ALLOWED_URI:Lt}=ma,te=null;const Pt=N({},[...ha,...ts,...is,...os,...pa]);let se=null;const Ft=N({},[...ua,...ss,...fa,...Zi]);let K=Object.seal(vn(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),Ze=null,Rt=null,pr=!0,zo=!0,ur=!1,fr=!0,Bt=!1,Lo=!0,vt=!1,Po=!1,Fo=!1,It=!1,Hi=!1,Vi=!1,mr=!0,vr=!1;const An="user-content-";let Ro=!0,ci=!1,Ot={},Nt=null;const gr=N({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","style","svg","template","thead","title","video","xmp"]);let br=null;const yr=N({},["audio","video","img","source","image","track"]);let Bo=null;const wr=N({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),Wi="http://www.w3.org/1998/Math/MathML",ji="http://www.w3.org/2000/svg",Je="http://www.w3.org/1999/xhtml";let Ut=Je,Io=!1,Oo=null;const zn=N({},[Wi,ji,Je],es);let Gi=N({},["mi","mo","mn","ms","mtext"]),qi=N({},["annotation-xml"]);const Ln=N({},["title","style","font","a","script"]);let hi=null;const Pn=["application/xhtml+xml","text/html"],Fn="text/html";let he=null,Ht=null;const Rn=t.createElement("form"),xr=function(f){return f instanceof RegExp||f instanceof Function},No=function(){let f=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if(!(Ht&&Ht===f)){if((!f||typeof f!="object")&&(f={}),f=St(f),hi=Pn.indexOf(f.PARSER_MEDIA_TYPE)===-1?Fn:f.PARSER_MEDIA_TYPE,he=hi==="application/xhtml+xml"?es:so,te=Pe(f,"ALLOWED_TAGS")?N({},f.ALLOWED_TAGS,he):Pt,se=Pe(f,"ALLOWED_ATTR")?N({},f.ALLOWED_ATTR,he):Ft,Oo=Pe(f,"ALLOWED_NAMESPACES")?N({},f.ALLOWED_NAMESPACES,es):zn,Bo=Pe(f,"ADD_URI_SAFE_ATTR")?N(St(wr),f.ADD_URI_SAFE_ATTR,he):wr,br=Pe(f,"ADD_DATA_URI_TAGS")?N(St(yr),f.ADD_DATA_URI_TAGS,he):yr,Nt=Pe(f,"FORBID_CONTENTS")?N({},f.FORBID_CONTENTS,he):gr,Ze=Pe(f,"FORBID_TAGS")?N({},f.FORBID_TAGS,he):{},Rt=Pe(f,"FORBID_ATTR")?N({},f.FORBID_ATTR,he):{},Ot=Pe(f,"USE_PROFILES")?f.USE_PROFILES:!1,pr=f.ALLOW_ARIA_ATTR!==!1,zo=f.ALLOW_DATA_ATTR!==!1,ur=f.ALLOW_UNKNOWN_PROTOCOLS||!1,fr=f.ALLOW_SELF_CLOSE_IN_ATTR!==!1,Bt=f.SAFE_FOR_TEMPLATES||!1,Lo=f.SAFE_FOR_XML!==!1,vt=f.WHOLE_DOCUMENT||!1,It=f.RETURN_DOM||!1,Hi=f.RETURN_DOM_FRAGMENT||!1,Vi=f.RETURN_TRUSTED_TYPE||!1,Fo=f.FORCE_BODY||!1,mr=f.SANITIZE_DOM!==!1,vr=f.SANITIZE_NAMED_PROPS||!1,Ro=f.KEEP_CONTENT!==!1,ci=f.IN_PLACE||!1,Lt=f.ALLOWED_URI_REGEXP||gn,Ut=f.NAMESPACE||Je,Gi=f.MATHML_TEXT_INTEGRATION_POINTS||Gi,qi=f.HTML_INTEGRATION_POINTS||qi,K=f.CUSTOM_ELEMENT_HANDLING||{},f.CUSTOM_ELEMENT_HANDLING&&xr(f.CUSTOM_ELEMENT_HANDLING.tagNameCheck)&&(K.tagNameCheck=f.CUSTOM_ELEMENT_HANDLING.tagNameCheck),f.CUSTOM_ELEMENT_HANDLING&&xr(f.CUSTOM_ELEMENT_HANDLING.attributeNameCheck)&&(K.attributeNameCheck=f.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),f.CUSTOM_ELEMENT_HANDLING&&typeof f.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements=="boolean"&&(K.allowCustomizedBuiltInElements=f.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements),Bt&&(zo=!1),Hi&&(It=!0),Ot&&(te=N({},pa),se=[],Ot.html===!0&&(N(te,ha),N(se,ua)),Ot.svg===!0&&(N(te,ts),N(se,ss),N(se,Zi)),Ot.svgFilters===!0&&(N(te,is),N(se,ss),N(se,Zi)),Ot.mathMl===!0&&(N(te,os),N(se,fa),N(se,Zi))),f.ADD_TAGS&&(te===Pt&&(te=St(te)),N(te,f.ADD_TAGS,he)),f.ADD_ATTR&&(se===Ft&&(se=St(se)),N(se,f.ADD_ATTR,he)),f.ADD_URI_SAFE_ATTR&&N(Bo,f.ADD_URI_SAFE_ATTR,he),f.FORBID_CONTENTS&&(Nt===gr&&(Nt=St(Nt)),N(Nt,f.FORBID_CONTENTS,he)),Ro&&(te["#text"]=!0),vt&&N(te,["html","head","body"]),te.table&&(N(te,["tbody"]),delete Ze.tbody),f.TRUSTED_TYPES_POLICY){if(typeof f.TRUSTED_TYPES_POLICY.createHTML!="function")throw bi('TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.');if(typeof f.TRUSTED_TYPES_POLICY.createScriptURL!="function")throw bi('TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.');R=f.TRUSTED_TYPES_POLICY,H=R.createHTML("")}else R===void 0&&(R=ic(y,o)),R!==null&&typeof H=="string"&&(H=R.createHTML(""));Se&&Se(f),Ht=f}},Sr=N({},[...ts,...is,...jd]),$r=N({},[...os,...Gd]),Bn=function(f){let x=P(f);(!x||!x.tagName)&&(x={namespaceURI:Ut,tagName:"template"});const M=so(f.tagName),X=so(x.tagName);return Oo[f.namespaceURI]?f.namespaceURI===ji?x.namespaceURI===Je?M==="svg":x.namespaceURI===Wi?M==="svg"&&(X==="annotation-xml"||Gi[X]):!!Sr[M]:f.namespaceURI===Wi?x.namespaceURI===Je?M==="math":x.namespaceURI===ji?M==="math"&&qi[X]:!!$r[M]:f.namespaceURI===Je?x.namespaceURI===ji&&!qi[X]||x.namespaceURI===Wi&&!Gi[X]?!1:!$r[M]&&(Ln[M]||!Sr[M]):!!(hi==="application/xhtml+xml"&&Oo[f.namespaceURI]):!1},Ue=function(f){vi(e.removed,{element:f});try{P(f).removeChild(f)}catch{T(f)}},Qi=function(f,x){try{vi(e.removed,{attribute:x.getAttributeNode(f),from:x})}catch{vi(e.removed,{attribute:null,from:x})}if(x.removeAttribute(f),f==="is")if(It||Hi)try{Ue(x)}catch{}else try{x.setAttribute(f,"")}catch{}},_r=function(f){let x=null,M=null;if(Fo)f="<remove></remove>"+f;else{const pe=ca(f,/^[\r\n\t ]+/);M=pe&&pe[0]}hi==="application/xhtml+xml"&&Ut===Je&&(f='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+f+"</body></html>");const X=R?R.createHTML(f):f;if(Ut===Je)try{x=new g().parseFromString(X,hi)}catch{}if(!x||!x.documentElement){x=oe.createDocument(Ut,"template",null);try{x.documentElement.innerHTML=Io?H:X}catch{}}const ve=x.body||x.documentElement;return f&&M&&ve.insertBefore(t.createTextNode(M),ve.childNodes[0]||null),Ut===Je?ne.call(x,vt?"html":"body")[0]:vt?x.documentElement:ve},Cr=function(f){return Te.call(f.ownerDocument||f,f,p.SHOW_ELEMENT|p.SHOW_COMMENT|p.SHOW_TEXT|p.SHOW_PROCESSING_INSTRUCTION|p.SHOW_CDATA_SECTION,null)},Uo=function(f){return f instanceof v&&(typeof f.nodeName!="string"||typeof f.textContent!="string"||typeof f.removeChild!="function"||!(f.attributes instanceof u)||typeof f.removeAttribute!="function"||typeof f.setAttribute!="function"||typeof f.namespaceURI!="string"||typeof f.insertBefore!="function"||typeof f.hasChildNodes!="function")},kr=function(f){return typeof l=="function"&&f instanceof l};function et(A,f,x){Xi(A,M=>{M.call(e,f,x,Ht)})}const Tr=function(f){let x=null;if(et(q.beforeSanitizeElements,f,null),Uo(f))return Ue(f),!0;const M=he(f.nodeName);if(et(q.uponSanitizeElement,f,{tagName:M,allowedTags:te}),f.hasChildNodes()&&!kr(f.firstElementChild)&&we(/<[/\w]/g,f.innerHTML)&&we(/<[/\w]/g,f.textContent)||f.nodeType===wi.progressingInstruction||Lo&&f.nodeType===wi.comment&&we(/<[/\w]/g,f.data))return Ue(f),!0;if(!te[M]||Ze[M]){if(!Ze[M]&&Mr(M)&&(K.tagNameCheck instanceof RegExp&&we(K.tagNameCheck,M)||K.tagNameCheck instanceof Function&&K.tagNameCheck(M)))return!1;if(Ro&&!Nt[M]){const X=P(f)||f.parentNode,ve=E(f)||f.childNodes;if(ve&&X){const pe=ve.length;for(let _e=pe-1;_e>=0;--_e){const He=$(ve[_e],!0);He.__removalCount=(f.__removalCount||0)+1,X.insertBefore(He,L(f))}}}return Ue(f),!0}return f instanceof d&&!Bn(f)||(M==="noscript"||M==="noembed"||M==="noframes")&&we(/<\/no(script|embed|frames)/i,f.innerHTML)?(Ue(f),!0):(Bt&&f.nodeType===wi.text&&(x=f.textContent,Xi([Oe,Q,le],X=>{x=gi(x,X," ")}),f.textContent!==x&&(vi(e.removed,{element:f.cloneNode()}),f.textContent=x)),et(q.afterSanitizeElements,f,null),!1)},Er=function(f,x,M){if(mr&&(x==="id"||x==="name")&&(M in t||M in Rn))return!1;if(!(zo&&!Rt[x]&&we(Ne,x))){if(!(pr&&we(mt,x))){if(!se[x]||Rt[x]){if(!(Mr(f)&&(K.tagNameCheck instanceof RegExp&&we(K.tagNameCheck,f)||K.tagNameCheck instanceof Function&&K.tagNameCheck(f))&&(K.attributeNameCheck instanceof RegExp&&we(K.attributeNameCheck,x)||K.attributeNameCheck instanceof Function&&K.attributeNameCheck(x))||x==="is"&&K.allowCustomizedBuiltInElements&&(K.tagNameCheck instanceof RegExp&&we(K.tagNameCheck,M)||K.tagNameCheck instanceof Function&&K.tagNameCheck(M))))return!1}else if(!Bo[x]){if(!we(Lt,gi(M,zt,""))){if(!((x==="src"||x==="xlink:href"||x==="href")&&f!=="script"&&Ud(M,"data:")===0&&br[f])){if(!(ur&&!we(li,gi(M,zt,"")))){if(M)return!1}}}}}}return!0},Mr=function(f){return f!=="annotation-xml"&&ca(f,di)},Dr=function(f){et(q.beforeSanitizeAttributes,f,null);const{attributes:x}=f;if(!x||Uo(f))return;const M={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:se,forceKeepAttr:void 0};let X=x.length;for(;X--;){const ve=x[X],{name:pe,namespaceURI:_e,value:He}=ve,pi=he(pe);let ye=pe==="value"?He:Hd(He);if(M.attrName=pi,M.attrValue=ye,M.keepAttr=!0,M.forceKeepAttr=void 0,et(q.uponSanitizeAttribute,f,M),ye=M.attrValue,vr&&(pi==="id"||pi==="name")&&(Qi(pe,f),ye=An+ye),Lo&&we(/((--!?|])>)|<\/(style|title)/i,ye)){Qi(pe,f);continue}if(M.forceKeepAttr||(Qi(pe,f),!M.keepAttr))continue;if(!fr&&we(/\/>/i,ye)){Qi(pe,f);continue}Bt&&Xi([Oe,Q,le],zr=>{ye=gi(ye,zr," ")});const Ar=he(f.nodeName);if(Er(Ar,pi,ye)){if(R&&typeof y=="object"&&typeof y.getAttributeType=="function"&&!_e)switch(y.getAttributeType(Ar,pi)){case"TrustedHTML":{ye=R.createHTML(ye);break}case"TrustedScriptURL":{ye=R.createScriptURL(ye);break}}try{_e?f.setAttributeNS(_e,pe,ye):f.setAttribute(pe,ye),Uo(f)?Ue(f):da(e.removed)}catch{}}}et(q.afterSanitizeAttributes,f,null)},In=function A(f){let x=null;const M=Cr(f);for(et(q.beforeSanitizeShadowDOM,f,null);x=M.nextNode();)et(q.uponSanitizeShadowNode,x,null),Tr(x),Dr(x),x.content instanceof r&&A(x.content);et(q.afterSanitizeShadowDOM,f,null)};return e.sanitize=function(A){let f=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},x=null,M=null,X=null,ve=null;if(Io=!A,Io&&(A="<!-->"),typeof A!="string"&&!kr(A))if(typeof A.toString=="function"){if(A=A.toString(),typeof A!="string")throw bi("dirty is not a string, aborting")}else throw bi("toString is not a function");if(!e.isSupported)return A;if(Po||No(f),e.removed=[],typeof A=="string"&&(ci=!1),ci){if(A.nodeName){const He=he(A.nodeName);if(!te[He]||Ze[He])throw bi("root node is forbidden and cannot be sanitized in-place")}}else if(A instanceof l)x=_r("<!---->"),M=x.ownerDocument.importNode(A,!0),M.nodeType===wi.element&&M.nodeName==="BODY"||M.nodeName==="HTML"?x=M:x.appendChild(M);else{if(!It&&!Bt&&!vt&&A.indexOf("<")===-1)return R&&Vi?R.createHTML(A):A;if(x=_r(A),!x)return It?null:Vi?H:""}x&&Fo&&Ue(x.firstChild);const pe=Cr(ci?A:x);for(;X=pe.nextNode();)Tr(X),Dr(X),X.content instanceof r&&In(X.content);if(ci)return A;if(It){if(Hi)for(ve=me.call(x.ownerDocument);x.firstChild;)ve.appendChild(x.firstChild);else ve=x;return(se.shadowroot||se.shadowrootmode)&&(ve=Ce.call(i,ve,!0)),ve}let _e=vt?x.outerHTML:x.innerHTML;return vt&&te["!doctype"]&&x.ownerDocument&&x.ownerDocument.doctype&&x.ownerDocument.doctype.name&&we(bn,x.ownerDocument.doctype.name)&&(_e="<!DOCTYPE "+x.ownerDocument.doctype.name+`>
`+_e),Bt&&Xi([Oe,Q,le],He=>{_e=gi(_e,He," ")}),R&&Vi?R.createHTML(_e):_e},e.setConfig=function(){let A=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};No(A),Po=!0},e.clearConfig=function(){Ht=null,Po=!1},e.isValidAttribute=function(A,f,x){Ht||No({});const M=he(A),X=he(f);return Er(M,X,x)},e.addHook=function(A,f){typeof f=="function"&&vi(q[A],f)},e.removeHook=function(A,f){if(f!==void 0){const x=Od(q[A],f);return x===-1?void 0:Nd(q[A],x,1)[0]}return da(q[A])},e.removeHooks=function(A){q[A]=[]},e.removeAllHooks=function(){q=va()},e}var ro=yn();let wo=class extends ce{constructor(){super(...arguments),this.collectionLinks=[]}render(){return c`
    ...
    `:b}get volumeTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.volume,C("Volume"))}get issueTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.issue,C("Issue"))}get creatorTemplate(){var e,t,i;return((e=this.model)===null||e===void 0?void 0:e.mediatype)==="account"?c`
      ...
      <div id="creator" class="metadata">
        ...
        ${oo(kt(this.model.creators,o=>this.searchLink("creator",o)),", ")}
      </div>
    `}get datePublishedTemplate(){var e;const t=(e=this.model)===null||e===void 0?void 0:e.datePublished;let i="long";return ar(t)&&(i="year-only"),this.metadataTemplate(Ri(t,i),C("Published"))}get dateSortByTemplate(){return this.effectiveSort&&(this.effectiveSort.field==="addeddate"||this.effectiveSort.field==="reviewdate"||this.effectiveSort.field==="publicdate")?this.metadataTemplate(Ri(this.date,"long"),this.displayValueProvider.dateLabel):b}get viewsTemplate(){var e,t,i,o;const r=((e=this.effectiveSort)===null||e===void 0?void 0:e.field)==="week"?(t=this.model)===null||t===void 0?void 0:t.weeklyViewCount:(i=this.model)===null||i===void 0?void 0:i.viewCount;return r==null?b:((o=this.model)===null||o===void 0?void 0:o.mediatype)==="search"?this.metadataTemplate("(Favorited search query)",""):this.metadataTemplate(`${nr(r,this.formatSize)}`,C("Views"))}get ratingTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.averageRating,C("Avg Rating"))}get reviewsTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.commentCount,C("Reviews"))}get topicsTemplate(){var e;return!(!((e=this.model)===null||e===void 0)&&e.subjects)||this.model.subjects.length===0?b:c`
      <div id="topics" class="metadata">
        ${this.labelTemplate(C("Topics"))}
        ${oo(kt(this.model.subjects,t=>this.searchLink("subject",t)),", ")}
      </div>
    ...
    >
      ${ro.sanitize(t)}</a
    >`}detailsLink(e,t,i=!1){if(!e)return b;const o=t??e,r=this.displayValueProvider.itemPageUrl(e,i);return c`<a href=${r}> ${ro.sanitize(o)} </a>`}get mediatypeURL(){var e;if(this.baseNavigationUrl===void 0||!(!((e=this.model)===null||e===void 0)&&e.mediatype))return b;switch(this.model.mediatype){case"collection":return`${this.baseNavigationUrl}/search?query=mediatype:collection&sort=-downloads`;case"account":return b;default:return this.displayValueProvider.itemPageUrl(this.model.mediatype,!0)}}updated(e){(e.has("model")||e.has("collectionTitles"))&&this.buildCollectionLinks()}async buildCollectionLinks(){var e,t,i;if(!(!((e=this.model)===null||e===void 0)&&e.collections)||this.model.collections.length===0)return;this.collectionLinks=[];const o=[];for(const r of this.model.collections)!Eo[r]&&!r.startsWith("fav-")&&o.push(this.detailsLink(r,(i=(t=this.collectionTitles)===null||t===void 0?void 0:t.get(r))!==null&&i!==void 0?i:r,!0));this.collectionLinks=o}get date(){var e,t,i,o,r;switch((e=this.effectiveSort)===null||e===void 0?void 0:e.field){case"date":return(t=this.model)===null||t===void 0?void 0:t.datePublished;case"reviewdate":return(i=this.model)===null||i===void 0?void 0:i.dateReviewed;case"addeddate":return(o=this.model)===null||o===void 0?void 0:o.dateAdded;default:return(r=this.model)===null||r===void 0?void 0:r.dateArchived}}get effectiveSort(){var e;return(e=this.sortParam)!==null&&e!==void 0?e:this.defaultSortParam}get classSize(){return this.mobileBreakpoint&&this.currentWidth&&this.currentWidth<this.mobileBreakpoint?"mobile":"desktop"}get formatSize(){return this.mobileBreakpoint&&this.currentWidth&&this.currentWidth<this.mobileBreakpoint?"short":"long"}static get styles(){return m`
      html {
        font-size: unset;
      }
    ...
    `}};n([h({type:Object})],wo.prototype,"collectionTitles",void 0);n([z()],wo.prototype,"collectionLinks",void 0);wo=n([F("tile-list")],wo);let Qe=class extends B{constructor(){super(...arguments),this.loggedIn=!1}render(){return c`
      <div id="container">
        ${this.headerTemplate}
    ...
    `}get headerTemplate(){var e,t,i,o;if(((e=this.model)===null||e===void 0?void 0:e.collections.length)===0)return b;let r="",a="";for(const l of((t=this.model)===null||t===void 0?void 0:t.collections)||[])if(!Eo[l]&&!l.startsWith("fav-")){r=(o=(i=this.collectionTitles)===null||i===void 0?void 0:i.get(l))!==null&&o!==void 0?o:l,a=l;break}return a?c`
    ...
    `}};n([h({type:Object})],Qe.prototype,"model",void 0);n([h({type:String})],Qe.prototype,"baseNavigationUrl",void 0);n([h({type:String})],Qe.prototype,"baseImageUrl",void 0);n([h({type:Boolean})],Qe.prototype,"loggedIn",void 0);n([h({type:Object})],Qe.prototype,"sortParam",void 0);n([h({type:Number})],Qe.prototype,"mobileBreakpoint",void 0);n([h({type:Number})],Qe.prototype,"currentWidth",void 0);n([h({type:Object})],Qe.prototype,"collectionTitles",void 0);Qe=n([F("tile-hover-pane")],Qe);let ga=class extends ce{render(){var e,t,i,o,r,a,l;return c`
      <div id="list-line" class="${this.classSize}">
        <image-block
          .model=${this.model}
          .baseImageUrl=${this.baseImageUrl}
    ...
    `}};ga=n([F("tile-list-compact")],ga);let ba=class extends ce{render(){return c`
    ...
    `}firstUpdated(){this.shouldPrepareHoverPane&&(this.hoverPaneController=new oc(this,{mobileBreakpoint:this.mobileBreakpoint,enableLongPress:!1}))}get headerTemplate(){const{currentWidth:e,sortParam:t,defaultSortParam:i,mobileBreakpoint:o}=this;return c`
    ...
    `}get linkTileTemplate(){var e,t,i;return c`
      <a
        ...
        title=${this.shouldPrepareHoverPane?b:Fi((i=this.model)===null||i===void 0?void 0:i.title)}
    ...
    `}};ze.HOVER_PANE_DISPLAY_MODES={grid:!0,"list-compact":!0,"list-detail":!1,"list-header":!1};n([h({type:String})],ze.prototype,"tileDisplayMode",void 0);n([h({type:Boolean})],ze.prototype,"isManageView",void 0);n([h({type:Object})],ze.prototype,"resizeObserver",void 0);n([h({type:Object})],ze.prototype,"collectionTitles",void 0);n([h({type:Boolean})],ze.prototype,"showTvClips",void 0);n([h({type:Boolean})],ze.prototype,"enableHoverPane",void 0);n([h({type:String})],ze.prototype,"manageCheckTitle",void 0);n([j("#container")],ze.prototype,"container",void 0);n([j("tile-hover-pane")],ze.prototype,"hoverPane",void 0);ze=Ns=n([F("tile-dispatcher")],ze);let wa=class extends B{render(){return c` <div id="container"></div> `}static get styles(){return m`
      :host {
        display: block;
        height: 100%;
      }
...
fill=""></path>
    ...
    `}};n([h({type:Boolean,reflect:!0})],fe.prototype,"open",void 0);n([h({type:Boolean,reflect:!0})],fe.prototype,"isDisabled",void 0);n([h({type:Boolean})],fe.prototype,"displayCaret",void 0);n([h({type:Boolean})],fe.prototype,"closeOnSelect",void 0);n([h({type:Boolean})],fe.prototype,"openViaButton",void 0);n([h({type:Boolean})],fe.prototype,"openViaCaret",void 0);n([h({type:Boolean})],fe.prototype,"includeSelectedOption",void 0);n([h({type:String})],fe.prototype,"selectedOption",void 0);n([h({attribute:!1})],fe.prototype,"options",void 0);n([h({type:String})],fe.prototype,"optionGroup",void 0);n([h({attribute:!1})],fe.prototype,"optionSelected",void 0);n([h({type:Boolean,reflect:!0})],fe.prototype,"isCustomList",void 0);n([h({type:Boolean,reflect:!0})],fe.prototype,"hasCustomClickHandler",void 0);n([h({type:Boolean,reflect:!0})],fe.prototype,"closeOnEscape",void 0);n([h({type:Boolean,reflect:!0})],fe.prototype,"closeOnBackdropClick",void 0);fe=n([F("ia-dropdown")],fe);let Us=class extends B{render(){return c`
  ...
  `;Us=n([F("ia-icon-label")],Us);let Hs=class extends B{constructor(){super(...arguments),this.numResults=0}render(){return c`
    ...
    `}};n([h({type:Number})],Hs.prototype,"numResults",void 0);Hs=n([F("alpha-bar-tooltip")],Hs);let ot=class extends B{constructor(){super(...arguments),this.selectedLetter=null,this.tooltipShown=!1,this.alphabet="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("")}get selectedUppercaseLetter(){var e;return(e=this.selectedLetter)===null||e===void 0?void 0:e.toUpperCase()}render(){var e;return c`
  ...
  `;n([h({type:String})],ot.prototype,"selectedLetter",void 0);n([h({type:Object})],ot.prototype,"letterCounts",void 0);n([h({type:String})],ot.prototype,"ariaLandmarkLabel",void 0);n([z()],ot.prototype,"tooltipShown",void 0);n([z()],ot.prototype,"hoveredLetter",void 0);n([j("alpha-bar-tooltip")],ot.prototype,"tooltip",void 0);ot=n([F("alpha-bar")],ot);const ac=c`
...
`;let G=class extends B{constructor(){super(...arguments),this.defaultSortDirection=null,this.defaultSortField=_.relevance,this.sortDirection=null,this.selectedSort=_.default,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.showRelevance=!0,this.showDateFavorited=!1,this.enableSortOptionsSlot=!1,this.suppressDisplayModes=!1,this.lastSelectedViewSort=_.weeklyview,this.lastSelectedDateSort=this.defaultDateSortField,this.alphaSelectorVisible=null,this.dropdownBackdropVisible=!1,this.desktopSortContainerWidth=0,this.selectorBarContainerWidth=0,this.boundSortBarSelectorEscapeListener=e=>{e.key==="Escape"&&this.closeDropdowns()}}render(){return c`
    ...
    `}get sortDirectionIcon(){return this.canChangeSortDirection?c`
      <div class="sort-direction-icon">
        ${this.finalizedSortDirection==="asc"?ac:nc}
      </div>
    `:c`<div class="sort-direction-icon">${lc}</div>`}get desktopSortSelectorTemplate(){return c`
      <div
    ...
    `}getSortDisplayOption(e,t){var i,o;const r=(i=t?.selected)!==null&&i!==void 0?i:this.finalizedSortField===e,a=(o=t?.displayName)!==null&&o!==void 0?o:xe[e].displayName;return c`
      <button
        class=${r?"selected":b}
        data-title="${a}"
    ...
    ></alpha-bar>`}titleLetterChanged(e){var t;this.selectedTitleFilter=(t=e.detail.selectedLetter)!==null&&t!==void 0?t:null,this.emitTitleLetterChangedEvent()}creatorLetterChanged(e){var t;this.selectedCreatorFilter=(t=e.detail.selectedLetter)!==null&&t!==void 0?t:null,this.emitCreatorLetterChangedEvent()}emitTitleLetterChangedEvent(){const e=new CustomEvent("titleLetterChanged",{detail:{selectedLetter:this.selectedTitleFilter}});this.dispatchEvent(e)}emitCreatorLetterChangedEvent(){const e=new CustomEvent("creatorLetterChanged",{detail:{selectedLetter:this.selectedCreatorFilter}});this.dispatchEvent(e)}displayModeChanged(){const e=new CustomEvent("displayModeChanged",{detail:{displayMode:this.displayMode}});this.dispatchEvent(e)}emitSortChangedEvent(){const e=new CustomEvent("sortChanged",{detail:{selectedSort:this.selectedSort,sortDirection:this.sortDirection}});this.dispatchEvent(e)}static get styles(){return[st,m`
      ...
      `]}};n([h({type:String})],G.prototype,"displayMode",void 0);n([h({type:String})],G.prototype,"defaultSortDirection",void 0);n([h({type:String})],G.prototype,"defaultSortField",void 0);n([h({type:String})],G.prototype,"sortDirection",void 0);n([h({type:String})],G.prototype,"selectedSort",void 0);n([h({type:String})],G.prototype,"selectedTitleFilter",void 0);n([h({type:String})],G.prototype,"selectedCreatorFilter",void 0);n([h({type:Boolean})],G.prototype,"showRelevance",void 0);n([h({type:Boolean})],G.prototype,"showDateFavorited",void 0);n([h({type:Boolean,reflect:!0})],G.prototype,"enableSortOptionsSlot",void 0);n([h({type:Boolean,reflect:!0})],G.prototype,"suppressDisplayModes",void 0);n([h({type:Object})],G.prototype,"prefixFilterCountMap",void 0);n([h({type:Object})],G.prototype,"resizeObserver",void 0);n([z()],G.prototype,"lastSelectedViewSort",void 0);n([z()],G.prototype,"lastSelectedDateSort",void 0);n([z()],G.prototype,"alphaSelectorVisible",void 0);n([z()],G.prototype,"dropdownBackdropVisible",void 0);n([z()],G.prototype,"desktopSortContainerWidth",void 0);n([z()],G.prototype,"selectorBarContainerWidth",void 0);n([j("#desktop-sort-container")],G.prototype,"desktopSortContainer",void 0);n([j("#sort-selector-container")],G.prototype,"sortSelectorContainer",void 0);n([j("#views-dropdown")],G.prototype,"viewsDropdown",void 0);n([j("#date-dropdown")],G.prototype,"dateDropdown",void 0);n([j("#mobile-dropdown")],G.prototype,"mobileDropdown",void 0);G=n([F("sort-filter-bar")],G);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function rs(s,e,t){return s?e():t?.()}class Tt{constructor(e){var t,i,o,r,a,l,d;this.title=e?.title,this.subtitle=e?.subtitle,this.headline=e?.headline,this.message=e?.message,this.headerColor=(t=e?.headerColor)!==null&&t!==void 0?t:"#55A183",this.bodyColor=(i=e?.bodyColor)!==null&&i!==void 0?i:"#f5f5f7",this.showProcessingIndicator=(o=e?.showProcessingIndicator)!==null&&o!==void 0?o:!1,this.processingImageMode=(r=e?.processingImageMode)!==null&&r!==void 0?r:"complete",this.showCloseButton=(a=e?.showCloseButton)!==null&&a!==void 0?a:!0,this.showHeaderLogo=(l=e?.showHeaderLogo)!==null&&l!==void 0?l:!0,this.closeOnBackdropClick=(d=e?.closeOnBackdropClick)!==null&&d!==void 0?d:!0}}function*lr(s=document.activeElement){s!=null&&(yield s,"shadowRoot"in s&&s.shadowRoot&&s.shadowRoot.mode!=="closed"&&(yield*lr(s.shadowRoot.activeElement)))}function pc(){return[...lr()].pop()}const xa=new WeakMap;function wn(s){let e=xa.get(s);return e||(e=window.getComputedStyle(s,null),xa.set(s,e)),e}function uc(s){if("checkVisibility"in s&&typeof s.checkVisibility=="function")return s.checkVisibility({checkOpacity:!1,checkVisibilityCSS:!0});const e=wn(s);return e.visibility!=="hidden"&&e.display!=="none"}function fc(s){const e=wn(s),{overflowY:t,overflowX:i}=e;return t==="scroll"||i==="scroll"?!0:t!=="auto"||i!=="auto"?!1:s.scrollHeight>s.clientHeight&&t==="auto"||s.scrollWidth>s.clientWidth&&i==="auto"}function mc(s){const e=s.tagName.toLowerCase(),t=Number(s.getAttribute("tabindex"));return s.hasAttribute("tabindex")&&(isNaN(t)||t<=-1)||s.hasAttribute("disabled")||s.closest("[inert]")||e==="input"&&s.getAttribute("type")==="radio"&&!s.hasAttribute("checked")||!uc(s)?!1:(e==="audio"||e==="video")&&s.hasAttribute("controls")||s.hasAttribute("tabindex")||s.hasAttribute("contenteditable")&&s.getAttribute("contenteditable")!=="false"||["button","input","select","textarea","a","audio","video","summary","iframe"].includes(e)?!0:fc(s)}function vc(s,e){var t;return((t=s.getRootNode({composed:!0}))===null||t===void 0?void 0:t.host)!==e}function Sa(s){const e=new WeakMap,t=[];function i(o){if(o instanceof Element){if(o.hasAttribute("inert")||o.closest("[inert]")||e.has(o))return;e.set(o,!0),!t.includes(o)&&mc(o)&&t.push(o),o instanceof HTMLSlotElement&&vc(o,s)&&o.assignedElements({flatten:!0}).forEach(r=>{i(r)}),o.shadowRoot!==null&&o.shadowRoot.mode==="open"&&i(o.shadowRoot)}for(const r of Array.from(o.children))i(r)}return i(s),t.sort((o,r)=>{const a=Number(o.getAttribute("tabindex"))||0;return(Number(r.getAttribute("tabindex"))||0)-a})}let xi=[];class gc{constructor(e){this.isExternalActivated=!1,this.tabDirection="forward",this.currentFocus=null,this.previousFocus=null,this.handleFocusIn=()=>{this.isActive()&&this.checkFocus()},this.handleKeyDown=t=>{var i;if(t.key!=="Tab"||this.isExternalActivated||!this.isActive())return;const o=pc();if(this.previousFocus=o,this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus))return;t.shiftKey?this.tabDirection="backward":this.tabDirection="forward";const r=Sa(this.element);let a=r.findIndex(d=>d===o);this.previousFocus=this.currentFocus;const l=this.tabDirection==="forward"?1:-1;for(;;){a+l>=r.length?a=0:a+l<0?a=r.length-1:a+=l,this.previousFocus=this.currentFocus;const d=r[a];if(this.tabDirection==="backward"&&this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus)||d&&this.possiblyHasTabbableChildren(d))return;t.preventDefault(),this.currentFocus=d,(i=this.currentFocus)===null||i===void 0||i.focus({preventScroll:!1});const p=[...lr()];if(p.includes(this.currentFocus)||!p.includes(this.previousFocus))break}setTimeout(()=>this.checkFocus())},this.handleKeyUp=()=>{this.tabDirection="forward"},this.element=e,this.elementsWithTabbableControls=["iframe"]}activate(){xi.push(this.element),document.addEventListener("focusin",this.handleFocusIn),document.addEventListener("keydown",this.handleKeyDown),document.addEventListener("keyup",this.handleKeyUp)}deactivate(){xi=xi.filter(e=>e!==this.element),this.currentFocus=null,document.removeEventListener("focusin",this.handleFocusIn),document.removeEventListener("keydown",this.handleKeyDown),document.removeEventListener("keyup",this.handleKeyUp)}isActive(){return xi[xi.length-1]===this.element}activateExternal(){this.isExternalActivated=!0}deactivateExternal(){this.isExternalActivated=!1}checkFocus(){if(this.isActive()&&!this.isExternalActivated){const e=Sa(this.element);if(!this.element.matches(":focus-within")){const t=e[0],i=e[e.length-1],o=this.tabDirection==="forward"?t:i;typeof o?.focus=="function"&&(this.currentFocus=o,o.focus({preventScroll:!1}))}}}possiblyHasTabbableChildren(e){return this.elementsWithTabbableControls.includes(e.tagName.toLowerCase())||e.hasAttribute("controls")}}var $a;(function(s){s.processing="processing",s.complete="complete"})($a||($a={}));let Vs=class extends B{constructor(){super(...arguments),this.mode="processing"}render(){return c`
      <div class="${this.mode}">
        <svg
          viewBox="0 0 120 120"
    ...
    `}};n([h({type:String})],Vs.prototype,"mode",void 0);Vs=n([F("ia-activity-indicator")],Vs);const bc=c`
<svg
  viewBox="0 0 40 40"
  version="1.1"
  xmlns="http://www.w3.org/2000/svg"
...
`;class yc extends B{static get styles(){return m`
      :host {
    ...
    `}render(){return bc}}customElements.define("ia-icon-close",yc);const wc=c`
  <svg
    class="ia-logo"
    viewBox="0 0 27 30"
    xmlns="http://www.w3.org/2000/svg"
...
`;let Ws=class extends B{constructor(){super(...arguments),this.config=new Tt}render(){return c`
      <div class="modal-wrapper">
        <div class="modal-container">
          <header style="background-color: ${this.config.headerColor}">
            ${this.config.showCloseButton?this.closeButtonTemplate:""}
            ${this.config.showHeaderLogo?c`<div class="logo-icon">${wc}</div>`:b}
    ...
    `}static get styles(){const e=m`var(--modalLogoSize, 6.5rem)`,t=m`var(--processingImageSize, 7.5rem)`,i=m`var(--modalCornerRadius, 1rem)`,o=m`var(--modalBorder, 2px solid black)`,r=m`var(--modalBottomMargin, 2.5rem)`,a=m`var(--modalTopMargin, 5rem)`,l=m`var(--modalHeaderBottomPadding, 0.5em)`,d=m`var(--modalBottomPadding, 2rem)`,p=m`var(--modalScrollOffset, 5px)`,u=m`var(--modalTitleFontSize, 1.8rem)`,v=m`var(--modalSubtitleFontSize, 1.4rem)`,g=m`var(--modalHeadlineFontSize, 1.6rem)`,y=m`var(--modalMessageFontSize, 1.4rem)`,w=m`var(--modalTitleLineHeight, normal)`,$=m`var(--modalSubtitleLineHeight, normal)`,T=m`var(--modalHeadlineLineHeight, normal)`,L=m`var(--modalMessageLineHeight, normal)`;return m`
      .processing-logo {
        margin: auto;
        width: ${t};
        height: ${t};
    ...
    `}};n([h({type:Object})],Ws.prototype,"config",void 0);Ws=n([F("modal-template")],Ws);function xc(s,e,t){var i=t||{},o=i.noTrailing,r=o===void 0?!1:o,a=i.noLeading,l=a===void 0?!1:a,d=i.debounceMode,p=d===void 0?void 0:d,u,v=!1,g=0;function y(){u&&clearTimeout(u)}function w(T){var L=T||{},E=L.upcomingOnly,P=E===void 0?!1:E;y(),v=!P}function $(){for(var T=arguments.length,L=new Array(T),E=0;E<T;E++)L[E]=arguments[E];var P=this,R=Date.now()-g;if(v)return;function H(){g=Date.now(),e.apply(P,L)}function oe(){u=void 0}!l&&p&&!u&&H(),y(),p===void 0&&R>s?l?(g=Date.now(),r||(u=setTimeout(p?oe:H,s))):H():r!==!0&&(u=setTimeout(p?oe:H,p===void 0?s-R:s))}return $.cancel=w,$}var Et;(function(s){s.Open="open",s.Closed="closed"})(Et||(Et={}));class Sc{constructor(e){this.windowResizeThrottler=xc(100,this.updateModalContainerHeight,{noLeading:!1,noTrailing:!1}).bind(this),this.modalManager=e}handleModeChange(e){switch(e){case Et.Open:this.startResizeListener(),this.stopDocumentScroll();break;case Et.Closed:this.stopResizeListener(),this.resumeDocumentScroll();break}}updateModalContainerHeight(){this.modalManager.style.setProperty("--containerHeight",`${window.innerHeight}px`)}stopDocumentScroll(){document.body.classList.add("modal-manager-open")}resumeDocumentScroll(){document.body.classList.remove("modal-manager-open")}startResizeListener(){window.addEventListener("resize",this.windowResizeThrottler)}stopResizeListener(){window.removeEventListener("resize",this.windowResizeThrottler)}}let ii=class extends B{constructor(){super(...arguments),this.mode=Et.Closed,this.hostBridge=new Sc(this),this.modal=new gc(this),this.closeOnBackdropClick=!0}firstUpdated(){return Lr(this,void 0,void 0,function*(){yield new Promise(e=>setTimeout(e,0)),this.closeOnBackdropClick&&this.addEventListener("keydown",e=>{e.key==="Escape"&&this.backdropClicked()})})}disconnectedCallback(){super.disconnectedCallback(),this.modal.deactivate()}render(){return c`
      <div class="container">
    ...
    `}};n([h({type:String,reflect:!0})],ii.prototype,"mode",void 0);n([h({type:Object})],ii.prototype,"customModalContent",void 0);n([h({type:Object})],ii.prototype,"hostBridge",void 0);n([j("modal-template")],ii.prototype,"modalTemplate",void 0);ii=n([F("modal-manager")],ii);const _a=m`var(--white, #fff)`,$c=m`var(--primaryDisableCTAFill, #767676)`,_c=m`var(--secondaryCTABorder, #999)`,Cc=m`var(--primaryCTAFill, #194880)`,as=m`var(--primaryCTAFillRGB, 25, 72, 128)`,kc=m`var(--primaryCTABorder, #c5d1df)`,Tc=m`var(--primaryErrorCTAFill, #d9534f)`,ns=m`var(--primaryErrorCTAFillRGB, 229, 28, 38)`,Ec=m`var(--primaryErrorCTABorder, #d43f3a)`,Mc=m`var(--secondaryCTAFill, #333)`,ls=m`var(--secondaryCTAFillRGB, 51, 51, 51)`,Dc=m`var(--primaryCTABorder, #979797)`,Ac=m`var(---primaryWarningFill, #ee8950)`,ds=m`var(--primaryWarningFillRGB, 238, 137, 80)`,zc=m`var(--primaryWarningBorder, #ec7939)`,Lc=m`
  .ia-button {
    min-height: 3rem;
    cursor: pointer;
    color: ${_a};
  ...
  .ia-button.primary:hover {
    background-color: rgba(${as}, 0.9);
  }
  .ia-button.primary:focus-visible {
    background-color: rgba(${as}, 0.8);
  }
  .ia-button.primary:active {
    background-color: rgba(${as}, 0.7);
  }
...
`;let xo=class extends B{constructor(){super(...arguments),this.items=[]}render(){return c`
      <ul>
        ${kt(this.items,({title:e,date:t})=>c`
            <li>
    ...
    `}};n([h({type:Object})],xo.prototype,"items",void 0);n([h({type:String})],xo.prototype,"message",void 0);xo=n([F("remove-items-modal-content")],xo);let Ke=class extends B{constructor(){super(...arguments),this.label=C("Select items to remove"),this.selectedItems=[],this.showSelectAll=!1,this.showUnselectAll=!1,this.showItemManageButton=!1,this.removeAllowed=!1}render(){return c`
      <div class="manage-container">
        ...
        <div class="manage-buttons">
          ...
          ${rs(this.showItemManageButton,()=>c` <button
          ...
          <div class="selection-buttons">
            ${rs(this.showSelectAll,()=>c` <button
                  class="ia-button link select-all-btn"
                  @click=${this.selectAllClicked}
                >
                  ${C("Select all")}
                </button>`)}
            ${rs(this.showUnselectAll,()=>c` <button
    ...
    `}};n([h({type:String})],Ke.prototype,"label",void 0);n([h({type:Object})],Ke.prototype,"modalManager",void 0);n([h({type:Object})],Ke.prototype,"selectedItems",void 0);n([h({type:String})],Ke.prototype,"manageViewModalMsg",void 0);n([h({type:Boolean})],Ke.prototype,"showSelectAll",void 0);n([h({type:Boolean})],Ke.prototype,"showUnselectAll",void 0);n([h({type:Boolean})],Ke.prototype,"showItemManageButton",void 0);n([h({type:Boolean})],Ke.prototype,"removeAllowed",void 0);Ke=n([F("manage-bar")],Ke);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Mi=(s,e)=>{var t,i;const o=s._$AN;if(o===void 0)return!1;for(const r of o)(i=(t=r)._$AO)===null||i===void 0||i.call(t,e,!1),Mi(r,e);return!0},So=s=>{let e,t;do{if((e=s._$AM)===void 0)break;t=e._$AN,t.delete(s),s=e}while(t?.size===0)},xn=s=>{for(let e;e=s._$AM;s=e){let t=e._$AN;if(t===void 0)e._$AN=t=new Set;else if(t.has(s))break;t.add(s),Rc(e)}};function Pc(s){this._$AN!==void 0?(So(this),this._$AM=s,xn(this)):this._$AM=s}function Fc(s,e=!1,t=0){const i=this._$AH,o=this._$AN;if(o!==void 0&&o.size!==0)if(e)if(Array.isArray(i))for(let r=t;r<i.length;r++)Mi(i[r],!1),So(i[r]);else i!=null&&(Mi(i,!1),So(i));else Mi(this,s)}const Rc=s=>{var e,t,i,o;s.type==We.CHILD&&((e=(i=s)._$AP)!==null&&e!==void 0||(i._$AP=Fc),(t=(o=s)._$AQ)!==null&&t!==void 0||(o._$AQ=Pc))};class Bc extends Ui{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,i){super._$AT(e,t,i),xn(this),this.isConnected=e._$AU}_$AO(e,t=!0){var i,o;e!==this.isConnected&&(this.isConnected=e,e?(i=this.reconnected)===null||i===void 0||i.call(this):(o=this.disconnected)===null||o===void 0||o.call(this)),t&&(Mi(this,e),So(this))}setValue(e){if(on(this._$Ct))this._$Ct._$AI(e,this);else{const t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}}const cs=new WeakMap,Ic=Ni(class extends Bc{render(s){return Z}update(s,[e]){var t;const i=e!==this.G;return i&&this.G!==void 0&&this.ot(void 0),(i||this.rt!==this.lt)&&(this.G=e,this.dt=(t=s.options)===null||t===void 0?void 0:t.host,this.ot(this.lt=s.element)),Z}ot(s){var e;if(typeof this.G=="function"){const t=(e=this.dt)!==null&&e!==void 0?e:globalThis;let i=cs.get(t);i===void 0&&(i=new WeakMap,cs.set(t,i)),i.get(this.G)!==void 0&&this.G.call(this.dt,void 0),i.set(this.G,s),s!==void 0&&this.G.call(this.dt,s)}else this.G.value=s}get rt(){var s,e,t;return typeof this.G=="function"?(e=cs.get((s=this.dt)!==null&&s!==void 0?s:globalThis))===null||e===void 0?void 0:e.get(this.G):(t=this.G)===null||t===void 0?void 0:t.value}disconnected(){this.rt===this.lt&&this.ot(void 0)}reconnected(){this.ot(this.lt)}});var Sn=60,$n=Sn*60,_n=$n*24,Oc=_n*7,oi=1e3,hs=Sn*oi,Ca=$n*oi,Nc=_n*oi,Uc=Oc*oi,dr="millisecond",jt="second",Gt="minute",qt="hour",lt="day",ao="week",Re="month",Cn="quarter",dt="year",Qt="date",Hc="YYYY-MM-DDTHH:mm:ssZ",ka="Invalid Date",Vc=/^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/,Wc=/\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g;const jc={name:"en",weekdays:"Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),months:"January_February_March_April_May_June_July_August_September_October_November_December".split("_"),ordinal:function(e){var t=["th","st","nd","rd"],i=e%100;return"["+e+(t[(i-20)%10]||t[i]||t[0])+"]"}};var js=function(e,t,i){var o=String(e);return!o||o.length>=t?e:""+Array(t+1-o.length).join(i)+e},Gc=function(e){var t=-e.utcOffset(),i=Math.abs(t),o=Math.floor(i/60),r=i%60;return(t<=0?"+":"-")+js(o,2,"0")+":"+js(r,2,"0")},qc=function s(e,t){if(e.date()<t.date())return-s(t,e);var i=(t.year()-e.year())*12+(t.month()-e.month()),o=e.clone().add(i,Re),r=t-o<0,a=e.clone().add(i+(r?-1:1),Re);return+(-(i+(t-o)/(r?o-a:a-o))||0)},Qc=function(e){return e<0?Math.ceil(e)||0:Math.floor(e)},Kc=function(e){var t={M:Re,y:dt,w:ao,d:lt,D:Qt,h:qt,m:Gt,s:jt,ms:dr,Q:Cn};return t[e]||String(e||"").toLowerCase().replace(/s$/,"")},Yc=function(e){return e===void 0};const Xc={s:js,z:Gc,m:qc,a:Qc,p:Kc,u:Yc};var Di="en",Mt={};Mt[Di]=jc;var kn="$isDayjsObject",cr=function(e){return e instanceof Do||!!(e&&e[kn])},$o=function s(e,t,i){var o;if(!e)return Di;if(typeof e=="string"){var r=e.toLowerCase();Mt[r]&&(o=r),t&&(Mt[r]=t,o=r);var a=e.split("-");if(!o&&a.length>1)return s(a[0])}else{var l=e.name;Mt[l]=e,o=l}return!i&&o&&(Di=o),o||!i&&Di},ae=function(e,t){if(cr(e))return e.clone();var i=typeof t=="object"?t:{};return i.date=e,i.args=arguments,new Do(i)},Zc=function(e,t){return ae(e,{locale:t.$L,utc:t.$u,x:t.$x,$offset:t.$offset})},V=Xc;V.l=$o;V.i=cr;V.w=Zc;var Jc=function(e){var t=e.date,i=e.utc;if(t===null)return new Date(NaN);if(V.u(t))return new Date;if(t instanceof Date)return new Date(t);if(typeof t=="string"&&!/Z$/i.test(t)){var o=t.match(Vc);if(o){var r=o[2]-1||0,a=(o[7]||"0").substring(0,3);return i?new Date(Date.UTC(o[1],r,o[3]||1,o[4]||0,o[5]||0,o[6]||0,a)):new Date(o[1],r,o[3]||1,o[4]||0,o[5]||0,o[6]||0,a)}}return new Date(t)},Do=function(){function s(t){this.$L=$o(t.locale,null,!0),this.parse(t),this.$x=this.$x||t.x||{},this[kn]=!0}var e=s.prototype;return e.parse=function(i){this.$d=Jc(i),this.init()},e.init=function(){var i=this.$d;this.$y=i.getFullYear(),this.$M=i.getMonth(),this.$D=i.getDate(),this.$W=i.getDay(),this.$H=i.getHours(),this.$m=i.getMinutes(),this.$s=i.getSeconds(),this.$ms=i.getMilliseconds()},e.$utils=function(){return V},e.isValid=function(){return this.$d.toString()!==ka},e.isSame=function(i,o){var r=ae(i);return this.startOf(o)<=r&&r<=this.endOf(o)},e.isAfter=function(i,o){return ae(i)<this.startOf(o)},e.isBefore=function(i,o){return this.endOf(o)<ae(i)},e.$g=function(i,o,r){return V.u(i)?this[o]:this.set(r,i)},e.unix=function(){return Math.floor(this.valueOf()/1e3)},e.valueOf=function(){return this.$d.getTime()},e.startOf=function(i,o){var r=this,a=V.u(o)?!0:o,l=V.p(i),d=function(L,E){var P=V.w(r.$u?Date.UTC(r.$y,E,L):new Date(r.$y,E,L),r);return a?P:P.endOf(lt)},p=function(L,E){var P=[0,0,0,0],R=[23,59,59,999];return V.w(r.toDate()[L].apply(r.toDate("s"),(a?P:R).slice(E)),r)},u=this.$W,v=this.$M,g=this.$D,y="set"+(this.$u?"UTC":"");switch(l){case dt:return a?d(1,0):d(31,11);case Re:return a?d(1,v):d(0,v+1);case ao:{var w=this.$locale().weekStart||0,$=(u<w?u+7:u)-w;return d(a?g-$:g+(6-$),v)}case lt:case Qt:return p(y+"Hours",0);case qt:return p(y+"Minutes",1);case Gt:return p(y+"Seconds",2);case jt:return p(y+"Milliseconds",3);default:return this.clone()}},e.endOf=function(i){return this.startOf(i,!1)},e.$set=function(i,o){var r,a=V.p(i),l="set"+(this.$u?"UTC":""),d=(r={},r[lt]=l+"Date",r[Qt]=l+"Date",r[Re]=l+"Month",r[dt]=l+"FullYear",r[qt]=l+"Hours",r[Gt]=l+"Minutes",r[jt]=l+"Seconds",r[dr]=l+"Milliseconds",r)[a],p=a===lt?this.$D+(o-this.$W):o;if(a===Re||a===dt){var u=this.clone().set(Qt,1);u.$d[d](p),u.init(),this.$d=u.set(Qt,Math.min(this.$D,u.daysInMonth())).$d}else d&&this.$d[d](p);return this.init(),this},e.set=function(i,o){return this.clone().$set(i,o)},e.get=function(i){return this[V.p(i)]()},e.add=function(i,o){var r=this,a;i=Number(i);var l=V.p(o),d=function(g){var y=ae(r);return V.w(y.date(y.date()+Math.round(g*i)),r)};if(l===Re)return this.set(Re,this.$M+i);if(l===dt)return this.set(dt,this.$y+i);if(l===lt)return d(1);if(l===ao)return d(7);var p=(a={},a[Gt]=hs,a[qt]=Ca,a[jt]=oi,a)[l]||1,u=this.$d.getTime()+i*p;return V.w(u,this)},e.subtract=function(i,o){return this.add(i*-1,o)},e.format=function(i){var o=this,r=this.$locale();if(!this.isValid())return r.invalidDate||ka;var a=i||Hc,l=V.z(this),d=this.$H,p=this.$m,u=this.$M,v=r.weekdays,g=r.months,y=r.meridiem,w=function(P,R,H,oe){return P&&(P[R]||P(o,a))||H[R].slice(0,oe)},$=function(P){return V.s(d%12||12,P,"0")},T=y||function(E,P,R){var H=E<12?"AM":"PM";return R?H.toLowerCase():H},L=function(P){switch(P){case"YY":return String(o.$y).slice(-2);case"YYYY":return V.s(o.$y,4,"0");case"M":return u+1;case"MM":return V.s(u+1,2,"0");case"MMM":return w(r.monthsShort,u,g,3);case"MMMM":return w(g,u);case"D":return o.$D;case"DD":return V.s(o.$D,2,"0");case"d":return String(o.$W);case"dd":return w(r.weekdaysMin,o.$W,v,2);case"ddd":return w(r.weekdaysShort,o.$W,v,3);case"dddd":return v[o.$W];case"H":return String(d);case"HH":return V.s(d,2,"0");case"h":return $(1);case"hh":return $(2);case"a":return T(d,p,!0);case"A":return T(d,p,!1);case"m":return String(p);case"mm":return V.s(p,2,"0");case"s":return String(o.$s);case"ss":return V.s(o.$s,2,"0");case"SSS":return V.s(o.$ms,3,"0");case"Z":return l}return null};return a.replace(Wc,function(E,P){return P||L(E)||l.replace(":","")})},e.utcOffset=function(){return-Math.round(this.$d.getTimezoneOffset()/15)*15},e.diff=function(i,o,r){var a=this,l=V.p(o),d=ae(i),p=(d.utcOffset()-this.utcOffset())*hs,u=this-d,v=function(){return V.m(a,d)},g;switch(l){case dt:g=v()/12;break;case Re:g=v();break;case Cn:g=v()/3;break;case ao:g=(u-p)/Uc;break;case lt:g=(u-p)/Nc;break;case qt:g=u/Ca;break;case Gt:g=u/hs;break;case jt:g=u/oi;break;default:g=u;break}return r?g:V.a(g)},e.daysInMonth=function(){return this.endOf(Re).$D},e.$locale=function(){return Mt[this.$L]},e.locale=function(i,o){if(!i)return this.$L;var r=this.clone(),a=$o(i,o,!0);return a&&(r.$L=a),r},e.clone=function(){return V.w(this.$d,this)},e.toDate=function(){return new Date(this.valueOf())},e.toJSON=function(){return this.isValid()?this.toISOString():null},e.toISOString=function(){return this.$d.toISOString()},e.toString=function(){return this.$d.toUTCString()},s}(),Tn=Do.prototype;ae.prototype=Tn;[["$ms",dr],["$s",jt],["$m",Gt],["$H",qt],["$W",lt],["$M",Re],["$y",dt],["$D",Qt]].forEach(function(s){Tn[s[1]]=function(e){return this.$g(e,s[0],s[1])}});ae.extend=function(s,e){return s.$i||(s(e,Do,ae),s.$i=!0),ae};ae.locale=$o;ae.isDayjs=cr;ae.unix=function(s){return ae(s*1e3)};ae.en=Mt[Di];ae.Ls=Mt;ae.p={};var e0=function(e){return e.replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g,function(t,i,o){return i||o.slice(1)})},t0={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"},i0=function(e,t){return e.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g,function(i,o,r){var a=r&&r.toUpperCase();return o||t[r]||t0[r]||e0(t[a])})},o0=/(\[[^[]*\])|([-_:/.,()\s]+)|(A|a|Q|YYYY|YY?|ww?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g,Ta=/\d/,Si=/\d\d/,s0=/\d{3}/,r0=/\d{4}/,Le=/\d\d?/,a0=/[+-]?\d+/,n0=/[+-]\d\d:?(\d\d)?|Z/,$i=/\d*[^-_:/,()\s\d]+/,pt={},En=function(e){return e=+e,e+(e>68?1900:2e3)};function l0(s){if(!s||s==="Z")return 0;var e=s.match(/([+-]|\d\d)/g),t=+(e[1]*60)+(+e[2]||0);return t===0?0:e[0]==="+"?-t:t}var ge=function(e){return function(t){this[e]=+t}},Ea=[n0,function(s){var e=this.zone||(this.zone={});e.offset=l0(s)}],ps=function(e){var t=pt[e];return t&&(t.indexOf?t:t.s.concat(t.f))},Ma=function(e,t){var i,o=pt,r=o.meridiem;if(!r)i=e===(t?"pm":"PM");else for(var a=1;a<=24;a+=1)if(e.indexOf(r(a,0,t))>-1){i=a>12;break}return i},d0={A:[$i,function(s){this.afternoon=Ma(s,!1)}],a:[$i,function(s){this.afternoon=Ma(s,!0)}],Q:[Ta,function(s){this.month=(s-1)*3+1}],S:[Ta,function(s){this.milliseconds=+s*100}],SS:[Si,function(s){this.milliseconds=+s*10}],SSS:[s0,function(s){this.milliseconds=+s}],s:[Le,ge("seconds")],ss:[Le,ge("seconds")],m:[Le,ge("minutes")],mm:[Le,ge("minutes")],H:[Le,ge("hours")],h:[Le,ge("hours")],HH:[Le,ge("hours")],hh:[Le,ge("hours")],D:[Le,ge("day")],DD:[Si,ge("day")],Do:[$i,function(s){var e=pt,t=e.ordinal,i=s.match(/\d+/);if(this.day=i[0],!!t)for(var o=1;o<=31;o+=1)t(o).replace(/\[|\]/g,"")===s&&(this.day=o)}],w:[Le,ge("week")],ww:[Si,ge("week")],M:[Le,ge("month")],MM:[Si,ge("month")],MMM:[$i,function(s){var e=ps("months"),t=ps("monthsShort"),i=(t||e.map(function(o){return o.slice(0,3)})).indexOf(s)+1;if(i<1)throw new Error;this.month=i%12||i}],MMMM:[$i,function(s){var e=ps("months"),t=e.indexOf(s)+1;if(t<1)throw new Error;this.month=t%12||t}],Y:[a0,ge("year")],YY:[Si,function(s){this.year=En(s)}],YYYY:[r0,ge("year")],Z:Ea,ZZ:Ea};function c0(s){var e=s.afternoon;if(e!==void 0){var t=s.hours;e?t<12&&(s.hours+=12):t===12&&(s.hours=0),delete s.afternoon}}function h0(s){s=i0(s,pt&&pt.formats);for(var e=s.match(o0),t=e.length,i=0;i<t;i+=1){var o=e[i],r=d0[o],a=r&&r[0],l=r&&r[1];l?e[i]={regex:a,parser:l}:e[i]=o.replace(/^\[|\]$/g,"")}return function(d){for(var p={},u=0,v=0;u<t;u+=1){var g=e[u];if(typeof g=="string")v+=g.length;else{var y=g.regex,w=g.parser,$=d.slice(v),T=y.exec($),L=T[0];w.call(p,L),d=d.replace(L,"")}}return c0(p),p}}var p0=function(e,t,i,o){try{if(["x","X"].indexOf(t)>-1)return new Date((t==="X"?1e3:1)*e);var r=h0(t),a=r(e),l=a.year,d=a.month,p=a.day,u=a.hours,v=a.minutes,g=a.seconds,y=a.milliseconds,w=a.zone,$=a.week,T=new Date,L=p||(!l&&!d?T.getDate():1),E=l||T.getFullYear(),P=0;l&&!d||(P=d>0?d-1:T.getMonth());var R=u||0,H=v||0,oe=g||0,Te=y||0;if(w)return new Date(Date.UTC(E,P,L,R,H,oe,Te+w.offset*60*1e3));if(i)return new Date(Date.UTC(E,P,L,R,H,oe,Te));var me;return me=new Date(E,P,L,R,H,oe,Te),$&&(me=o(me).week($).toDate()),me}catch{return new Date("")}};const u0=function(s,e,t){t.p.customParseFormat=!0,s&&s.parseTwoDigitYear&&(En=s.parseTwoDigitYear);var i=e.prototype,o=i.parse;i.parse=function(r){var a=r.date,l=r.utc,d=r.args;this.$u=l;var p=d[1];if(typeof p=="string"){var u=d[2]===!0,v=d[3]===!0,g=u||v,y=d[2];v&&(y=d[2]),pt=this.$locale(),!u&&y&&(pt=t.Ls[y]),this.$d=p0(a,p,l,t),this.init(),y&&y!==!0&&(this.$L=this.locale(y).$L),g&&a!=this.format(p)&&(this.$d=new Date("")),pt={}}else if(p instanceof Array)for(var w=p.length,$=1;$<=w;$+=1){d[1]=p[$-1];var T=t.apply(this,d);if(T.isValid()){this.$d=T.$d,this.$L=T.$L,this.init();break}$===w&&(this.$d=new Date(""))}else o.call(this,r)}};/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Da=Ni(class extends Ui{constructor(s){if(super(s),s.type!==We.PROPERTY&&s.type!==We.ATTRIBUTE&&s.type!==We.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!on(s))throw Error("`live` bindings can only contain a single expression")}render(s){return s}update(s,[e]){if(e===Me||e===Z)return e;const t=s.element,i=s.name;if(s.type===We.PROPERTY){if(e===t[i])return Me}else if(s.type===We.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(i))return Me}else if(s.type===We.ATTRIBUTE&&t.getAttribute(i)===e+"")return Me;return sn(s),e}});ae.extend(u0);const f0=180,m0=40,v0=10,g0=125,b0=30,Aa="YYYY",y0="no data",w0=0,za=4,x0=m`var(--histogramDateRangeSliderColor, #4B65FE)`,S0=m`var(--histogramDateRangeSelectedRangeColor, #DBE0FF)`,$0=m`var(--histogramDateRangeBarIncludedFill, #2C2C2C)`,_0=m`var(--histogramDateRangeActivityIndicator, #2C2C2C)`,C0=m`var(--histogramDateRangeBarExcludedFill, #CCCCCC)`,k0=m`var(--histogramDateRangeInputRowMargin, 0)`,T0=m`var(--histogramDateRangeInputBorder, 0.5px solid #2C2C2C)`,E0=m`var(--histogramDateRangeInputWidth, 35px)`,M0=m`var(--histogramDateRangeInputFontSize, 1.2rem)`,D0=m`var(--histogramDateRangeInputFontFamily, sans-serif)`,La=m`var(--histogramDateRangeTooltipBackgroundColor, #2C2C2C)`,Pa=m`var(--histogramDateRangeTooltipTextColor, #FFFFFF)`,A0=m`var(--histogramDateRangeTooltipFontSize, 1.1rem)`,z0=m`var(--histogramDateRangeTooltipFontFamily, sans-serif)`;let J=class extends B{constructor(){super(...arguments),this.width=f0,this.height=m0,this.sliderWidth=v0,this.tooltipWidth=g0,this.tooltipHeight=b0,this.updateDelay=w0,this.dateFormat=Aa,this.missingDataMessage=y0,this.minDate="",this.maxDate="",this.disabled=!1,this.bins=[],this.updateWhileFocused=!1,this._tooltipOffset=0,this._tooltipVisible=!1,this._isDragging=!1,this._isLoading=!1,this._minSelectedDate="",this._maxSelectedDate="",this._minDateMS=0,this._maxDateMS=0,this._dragOffset=0,this._histWidth=0,this._binWidth=0,this._histData=[],this._previousDateRange="",this.drag=e=>{e.preventDefault(),!this.disabled&&(this.setDragOffset(e),this._isDragging=!0,this.addListeners(),this.cancelPendingUpdateEvent())},this.drop=()=>{this._isDragging&&(this.removeListeners(),this.beginEmitUpdateProcess()),this._isDragging=!1},this.move=e=>{const t=this.getBoundingClientRect().x,i=e.clientX-t-this._dragOffset;this._currentSlider.id==="slider-min"?this.minSelectedDate=this.translatePositionToDate(this.validMinSliderX(i)):this.maxSelectedDate=this.translatePositionToDate(this.validMaxSliderX(i))}}disconnectedCallback(){this.removeListeners(),super.disconnectedCallback()}updated(e){(e.has("bins")||e.has("minDate")||e.has("maxDate")||e.has("minSelectedDate")||e.has("maxSelectedDate")||e.has("width")||e.has("height"))&&this.handleDataUpdate()}handleDataUpdate(){this.hasBinData&&(this._histWidth=this.width-this.sliderWidth*2,this._minDateMS=this.getMSFromString(this.minDate),this._maxDateMS=this.getMSFromString(this.maxDate),this._binWidth=this._histWidth/this._numBins,this._previousDateRange=this.currentDateRangeString,this._histData=this.calculateHistData(),this.minSelectedDate=this.minSelectedDate?this.minSelectedDate:this.minDate,this.maxSelectedDate=this.maxSelectedDate?this.maxSelectedDate:this.maxDate,this.requestUpdate())}calculateHistData(){const e=Math.min(...this.bins),t=Math.max(...this.bins),i=e===t?1:Math.log1p(t),o=this.height/i,r=this.dateRangeMS/this._numBins;return this.bins.map((a,l)=>({value:a,height:Math.floor(Math.log1p(a)*o),binStart:`${this.formatDate(l*r+this._minDateMS)}`,binEnd:`${this.formatDate((l+1)*r+this._minDateMS)}`}))}get hasBinData(){return this._numBins>0}get _numBins(){return!this.bins||!this.bins.length?0:this.bins.length}get histogramLeftEdgeX(){return this.sliderWidth}get histogramRightEdgeX(){return this.width-this.sliderWidth}get loading(){return this._isLoading}set loading(e){this.disabled=e,this._isLoading=e}get minSelectedDate(){return this.formatDate(this.getMSFromString(this._minSelectedDate))}set minSelectedDate(e){if(!this._minSelectedDate){this._minSelectedDate=e;return}const t=this.getMSFromString(e),i=!Number.isNaN(t),o=t<=this.getMSFromString(this.maxSelectedDate);i&&o&&(this._minSelectedDate=this.formatDate(t)),this.requestUpdate()}get maxSelectedDate(){return this.formatDate(this.getMSFromString(this._maxSelectedDate))}set maxSelectedDate(e){if(!this._maxSelectedDate){this._maxSelectedDate=e;return}const t=this.getMSFromString(e),i=!Number.isNaN(t),o=t>=this.getMSFromString(this.minSelectedDate);i&&o&&(this._maxSelectedDate=this.formatDate(t)),this.requestUpdate()}get minSliderX(){const e=this.translateDateToPosition(this.minSelectedDate);return this.validMinSliderX(e)}get maxSliderX(){const e=this.translateDateToPosition(this.maxSelectedDate);return this.validMaxSliderX(e)}get dateRangeMS(){return this._maxDateMS-this._minDateMS}showTooltip(e){if(this._isDragging||this.disabled)return;const t=e.currentTarget,i=t.x.baseVal.value+this.sliderWidth/2,o=t.dataset,r=`item${o.numItems!=="1"?"s":""}`,a=Number(o.numItems).toLocaleString();this._tooltipOffset=i+(this._binWidth-this.sliderWidth-this.tooltipWidth)/2,this._tooltipContent=c`
      ${a} ${r}<br />
      ${o.binStart} - ${o.binEnd}
    `,this._tooltipVisible=!0}hideTooltip(){this._tooltipContent=void 0,this._tooltipVisible=!1}validMinSliderX(e){const t=Math.min(this.translateDateToPosition(this.maxSelectedDate),this.histogramRightEdgeX);return e=this.clamp(e,this.histogramLeftEdgeX,t),Number.isNaN(e)||t<this.histogramLeftEdgeX?this.histogramLeftEdgeX:e}validMaxSliderX(e){const t=Math.max(this.histogramLeftEdgeX,this.translateDateToPosition(this.minSelectedDate));return e=this.clamp(e,t,this.histogramRightEdgeX),Number.isNaN(e)||t>this.histogramRightEdgeX?this.histogramRightEdgeX:e}addListeners(){window.addEventListener("pointermove",this.move),window.addEventListener("pointerup",this.drop),window.addEventListener("pointercancel",this.drop)}removeListeners(){window.removeEventListener("pointermove",this.move),window.removeEventListener("pointerup",this.drop),window.removeEventListener("pointercancel",this.drop)}beginEmitUpdateProcess(){this.cancelPendingUpdateEvent(),this._emitUpdatedEventTimer=setTimeout(()=>{if(this.currentDateRangeString===this._previousDateRange)return;this._previousDateRange=this.currentDateRangeString;const e={detail:{minDate:this.minSelectedDate,maxDate:this.maxSelectedDate},bubbles:!0,composed:!0};this.dispatchEvent(new CustomEvent("histogramDateRangeUpdated",e))},this.updateDelay)}cancelPendingUpdateEvent(){this._emitUpdatedEventTimer!==void 0&&(clearTimeout(this._emitUpdatedEventTimer),this._emitUpdatedEventTimer=void 0)}setDragOffset(e){this._currentSlider=e.currentTarget;const t=this._currentSlider.id==="slider-min"?this.minSliderX:this.maxSliderX,i=this.getBoundingClientRect().x;this._dragOffset=e.clientX-i-t}translatePositionToDate(e){const t=Math.ceil((e-this.sliderWidth)*this.dateRangeMS/this._histWidth);return this.formatDate(this._minDateMS+t)}translateDateToPosition(e){const t=this.getMSFromString(e);return this.sliderWidth+(t-this._minDateMS)*this._histWidth/this.dateRangeMS}clamp(e,t,i){return Math.min(Math.max(e,t),i)}handleInputFocus(){this.updateWhileFocused||this.cancelPendingUpdateEvent()}handleMinDateInput(e){const t=e.currentTarget;t.value!==this.minSelectedDate&&(this.minSelectedDate=t.value,this.beginEmitUpdateProcess())}handleMaxDateInput(e){const t=e.currentTarget;t.value!==this.maxSelectedDate&&(this.maxSelectedDate=t.value,this.beginEmitUpdateProcess())}handleKeyUp(e){if(e.key==="Enter"){const t=e.currentTarget;t.blur(),t.id==="date-min"?this.handleMinDateInput(e):t.id==="date-max"&&this.handleMaxDateInput(e)}}get currentDateRangeString(){return`${this.minSelectedDate}:${this.maxSelectedDate}`}getMSFromString(e){const t=typeof e=="string"?e:String(e);if((t.split(/(\d+)/).length-1)/2===1){const o=new Date(0,0);return o.setFullYear(Number(t)),o.getTime()}return ae(t,[this.dateFormat,Aa]).valueOf()}handleBarClick(e){const t=e.currentTarget.dataset,i=(this.getMSFromString(t.binStart)+this.getMSFromString(t.binEnd))/2,o=Math.abs(i-this.getMSFromString(this.minSelectedDate)),r=Math.abs(i-this.getMSFromString(this.maxSelectedDate));o<r?this.minSelectedDate=t.binStart:this.maxSelectedDate=t.binEnd,this.beginEmitUpdateProcess()}get minSliderTemplate(){const e=za,t=`
            M${this.minSliderX},0
    ...
    `}get selectedRangeTemplate(){return O`
      ...
      />`}get histogramTemplate(){const e=this._histWidth/this._numBins,t=e-1;let i=this.sliderWidth;return this._histData.map(o=>{const r=O`
        <rect
          ...
          fill="${i+t>=this.minSliderX&&i<=this.maxSliderX?$0:C0}"
    ...
    ia-activity-indicator {
      ...
      --activityIndicatorLoadingRingColor: ${_0};
    }
    ...
    #tooltip:after {
      ...
      /* arrow */
      border: 5px solid ${Pa};
      border-color: ${La} transparent transparent
        transparent;
    }
    /****** slider ********/
    .draggable:hover {
...
`;let ie=class extends B{constructor(){super(...arguments),this.prompt="Do you find this feature useful?",this.buttonText="Beta",this.displayMode="button",this.isOpen=!1,this.processing=!1,this.popupTopX=0,this.popupTopY=0,this.voteSubmitted=!1,this.voteNeedsChoosing=!1,this.resizingElement=document.body}render(){return c`
    ...
    `}get upvoteSelected(){return this.vote==="up"}get downvoteSelected(){return this.vote==="down"}upvoteKeypressed(e){(e.key==="Enter"||e.key===" ")&&this.upvoteButtonSelected()}downvoteKeypressed(e){(e.key==="Enter"||e.key===" ")&&this.downvoteButtonSelected()}upvoteButtonSelected(){this.processing||this.voteSubmitted||(this.vote=this.vote==="up"?void 0:"up",this.handleButtonSelection())}downvoteButtonSelected(){this.processing||this.voteSubmitted||(this.vote=this.vote==="down"?void 0:"down",this.handleButtonSelection())}async handleButtonSelection(){this.isOpen||(await this.setupRecaptcha(),this.submit())}get chooseVoteErrorClass(){return this.voteNeedsChoosing?"error":""}get upvoteButtonClass(){switch(this.vote){case"up":return"selected";case"down":return"unselected";default:return"noselection"}}get downvoteButtonClass(){switch(this.vote){case"up":return"unselected";case"down":return"selected";default:return"noselection"}}backgroundClicked(e){var t;e.target instanceof Node&&(!((t=this.popup)===null||t===void 0)&&t.contains(e.target)||this.cancel(e))}cancel(e){e.preventDefault(),this.closePopup(),this.voteSubmitted||this.resetState()}async submit(e){if(e?.preventDefault(),!this.vote){this.voteNeedsChoosing=!0,this.error=c`Please select a vote.`;return}if(!this.featureIdentifier)throw new Error("featureIdentifier is required");if(!this.featureFeedbackService)throw new Error("featureFeedbackService is required");if(!this.recaptchaWidget)throw new Error("recaptchaWidget is required");const t=this.isOpen;this.processing=!0;try{const i=await this.recaptchaWidget.execute();(await this.featureFeedbackService.submitFeedback({featureIdentifier:this.featureIdentifier,vote:this.vote,comments:this.comments.value,recaptchaToken:i})).success?(this.voteSubmitted=!0,t&&this.closePopup()):this.error=c`There was an error submitting your feedback.`}catch(i){this.error=c`There was an error submitting your feedback.<br />Error:
        ${i instanceof Error?i.message:i}`}this.processing=!1}static get styles(){const e=m`var(--featureFeedbackBlueColor, #194880)`,t=m`var(--featureFeedbackDarkGrayColor, #767676)`,i=m`var(--defaultColorSvgFilter, invert(52%) sepia(0%) saturate(1%) hue-rotate(331deg) brightness(87%) contrast(89%))`,o=m`var(--featureFeedbackBackdropZindex, 5)`,r=m`var(--featureFeedbackModalZindex, 6)`,a=m`var(--featureFeedbackPopupBorderColor, ${e})`,l=m`var(--featureFeedbackSubmitButtonColor, ${e})`,d=m`var(--featureFeedbackBetaButtonBorderColor, ${e})`,p=m`var(--featureFeedbackBetaButtonTextColor, ${e})`,u=m`var(--featureFeedbackBetaButtonSvgFilter, ${i})`,v=m`var(--featureFeedbackCancelButtonColor, #515151)`,g=m`var(--featureFeedbackPopupBlockerColor, rgba(255, 255, 255, 0.3))`,y=m`var(--featureFeedbackPopupBackgroundColor, #F5F5F7)`,w=m`var(--featureFeedbackPromptFontWeight, bold)`,$=m`var(--featureFeedbackPromptFontSize, 1.4rem)`,T=m`var(--featureFeedbackCommentButtonFontWeight, normal)`,L=m`var(--featureFeedbackCommentButtonFontWeight, 1.4rem)`,E=m`var(--defaultColor, ${t});`,P=m`var(--defaultColorSvgFilter, ${i});`,R=m`var(--upvoteColor, #23765D);`,H=m`var(--upvoteColorSvgFilter, invert(34%) sepia(72%) saturate(357%) hue-rotate(111deg) brightness(97%) contrast(95%));`,oe=m`var(--downvoteColor, #720D11);`,Te=m`var(--downvoteColorSvgFilter, invert(5%) sepia(81%) saturate(5874%) hue-rotate(352deg) brightness(105%) contrast(95%));`,me=m`var(--unselectedColor, #CCCCCC);`,ne=m`var(--unselectedColorSvgFilter, invert(100%) sepia(0%) saturate(107%) hue-rotate(138deg) brightness(89%) contrast(77%));`;return m`
      #container {
        display: inline-block;
      }
    ...
    `}};n([h({type:String})],ie.prototype,"featureIdentifier",void 0);n([h({type:String})],ie.prototype,"prompt",void 0);n([h({type:String})],ie.prototype,"buttonText",void 0);n([h({type:String})],ie.prototype,"displayMode",void 0);n([h({type:Object})],ie.prototype,"recaptchaManager",void 0);n([h({type:Object})],ie.prototype,"resizeObserver",void 0);n([h({type:Boolean})],ie.prototype,"disabled",void 0);n([h({type:Object})],ie.prototype,"featureFeedbackService",void 0);n([z()],ie.prototype,"isOpen",void 0);n([z()],ie.prototype,"processing",void 0);n([z()],ie.prototype,"popupTopX",void 0);n([z()],ie.prototype,"popupTopY",void 0);n([z()],ie.prototype,"vote",void 0);n([z()],ie.prototype,"voteSubmitted",void 0);n([z()],ie.prototype,"error",void 0);n([z()],ie.prototype,"voteNeedsChoosing",void 0);n([z()],ie.prototype,"recaptchaWidget",void 0);n([j("#container")],ie.prototype,"container",void 0);n([j("#popup")],ie.prototype,"popup",void 0);n([j("#comments")],ie.prototype,"comments",void 0);ie=n([F("feature-feedback")],ie);const L0=c`
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path
...
`;let si=class extends B{constructor(){super(...arguments),this.step=2,this.currentPage=1,this.pages=[]}firstUpdated(){this.observePageCount()}updated(e){e.has("size")&&this.observePageCount(),e.has("currentPage")&&(this.observePageCount(),this.emitPageClick())}observePageCount(){this.pages=[];const e=7,t=this.size<=e;if(this.size<=5){this.pages=[...Array(this.size).keys()].map(r=>r+1);return}if(this.size===e){if(this.currentPage===2){this.pages=[1,2,3,4,0,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,4,5,this.size-1,this.size];return}}if(this.currentPage===1){this.pages=[1,2,3,0,this.size];return}if(this.currentPage===this.size){this.pages=[1,0,this.size-2,this.size-1,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,this.size-3,this.size-2,this.size-1,this.size];return}if(t&&this.currentPage>1&&this.currentPage<e){this.pages=[...Array(this.size).keys()].map(r=>r+1);return}let i=this.currentPage-this.step,o=this.currentPage+this.step;i<=0&&(o+=-i+1,i=1),o>=this.size&&(i=Math.max(i-(o-this.size),1),o=this.size),i===2&&(o-=1),o===this.size-1&&(i+=1),this.createFirstNode(i),this.createMiddelNode(i,o),this.createLastNode(o)}createFirstNode(e){var t,i;e>1&&((t=this.pages)===null||t===void 0||t.push(1)),e>2&&((i=this.pages)===null||i===void 0||i.push(0))}createMiddelNode(e,t){var i;for(let o=e;o<=t;o+=1)(i=this.pages)===null||i===void 0||i.push(o)}createLastNode(e){var t,i;e<this.size-1&&((t=this.pages)===null||t===void 0||t.push(0)),e<this.size&&((i=this.pages)===null||i===void 0||i.push(this.size))}get getEllipsisTemplate(){return c`<i class="ellipses">...</i>`}emitPageClick(){this.dispatchEvent(new CustomEvent("pageNumberClicked",{detail:{page:this.currentPage},bubbles:!0,composed:!0}))}onRewind(){this.currentPage-=1,this.currentPage<1&&(this.currentPage=1)}onForward(){this.currentPage+=1,this.currentPage>this.size&&(this.currentPage=this.size)}onChange(e){this.currentPage=e}getPageTemplate(e){return c`
    ...
    `}static get styles(){return[st,m`
      ...
      `]}};n([h({type:Number})],si.prototype,"size",void 0);n([h({type:Number})],si.prototype,"step",void 0);n([h({type:Number})],si.prototype,"currentPage",void 0);n([z()],si.prototype,"pages",void 0);si=n([F("more-facets-pagination")],si);const R0=O`
...
`;var Gs;let Bi=Gs=class extends B{render(){return c`${this.facetRowTemplate}`}get facetRowTemplate(){var e,t,i,o;const{bucket:r,facetType:a}=this;if(!r||!a)return b;const l=`${a}:${r.key}-show-only`,d=`${a}:${r.key}-negative`,p=a!=="collection"?c`${(e=r.displayText)!==null&&e!==void 0?e:r.key}`:c`<a href="/details/${r.key}">
            ${(i=(t=this.collectionTitles)===null||t===void 0?void 0:t.get(r.key))!==null&&i!==void 0?i:r.key}
          </a> `,u=r.state==="hidden",v=r.state==="selected",g=`${a}: ${(o=r.displayText)!==null&&o!==void 0?o:r.key}`,y=v?`Show all ${a}s`:`Only show ${g}`,w=`Hide ${g}`,$=`Unhide ${g}`,T=u?$:w,L=`${g}, ${r.count} results`;return c`
      <div class="facet-row-container">
        <div class="facet-checkboxes">
          ...
          <label
            ...
            data-testid=${d}
          >
            <span class="eye">${R0}</span>
            <span class="eye-closed">${B0}</span>
          </label>
        </div>
        <label
          for=${l}
    ...
    `}facetClicked(e,t){const{bucket:i,facetType:o}=this;if(!i||!o)return;const r=e.target,{checked:a}=r;this.bucket={...i,state:Gs.getFacetState(a,t)},this.dispatchFacetClickEvent({facetType:o,bucket:this.bucket,negative:t})}dispatchFacetClickEvent(e){const t=new CustomEvent("facetClick",{detail:e});this.dispatchEvent(t)}static getFacetState(e,t){let i;return e?i=t?"hidden":"selected":i="none",i}static get styles(){const e=m`var(--facet-row-border-top, 1px solid transparent)`,t=m`var(--facet-row-border-bottom, 1px solid transparent)`;return m`
    ...
    `}};n([h({type:String})],Bi.prototype,"facetType",void 0);n([h({type:Object})],Bi.prototype,"bucket",void 0);n([h({type:Object})],Bi.prototype,"collectionTitles",void 0);Bi=Gs=n([F("facet-row")],Bi);let _o=class extends B{facetClicked(e){this.dispatchFacetClickEvent(e.detail)}dispatchFacetClickEvent(e){const t=new CustomEvent("facetClick",{detail:e,composed:!0});this.dispatchEvent(t)}get facetsTemplate(){const{facetGroup:e}=this;if(!e)return b;const t=e.buckets;return c`
      <div class="facet-rows" data-testid="facets-on-${e.key}">
        ${ir(t,i=>`${e.key}:${i.key}`,i=>c`<facet-row
              .facetType=${e.key}
              .bucket=${i}
              .collectionTitles=${this.collectionTitles}
    ...
    `}};n([h({type:Object})],_o.prototype,"facetGroup",void 0);n([h({type:Object})],_o.prototype,"collectionTitles",void 0);_o=n([F("facets-template")],_o);let ft=class extends B{constructor(){super(...arguments),this.leftValue="",this.rightValue="",this.side="left"}render(){var e,t;return c`
      <div id="container">
    ...
    `}get value(){return this.side==="left"?this.leftValue:this.rightValue}get selectedLabel(){var e,t;return this.side==="left"?(e=this.leftLabel)!==null&&e!==void 0?e:this.leftValue:(t=this.rightLabel)!==null&&t!==void 0?t:this.rightValue}handleClick(){this.side=this.side==="left"?"right":"left",this.emitChangeEvent()}handleRadioChange(){this.side=this.leftRadio.checked?"left":"right",this.emitChangeEvent()}emitChangeEvent(){const e=new CustomEvent("change",{detail:this.value});this.dispatchEvent(e)}static get styles(){const e=m`var(--switchWidth, 30px)`,t=m`var(--switchHeight, 14px)`,i=m`var(--switchMarginLeft, 5px)`,o=m`var(--switchMarginRight, 5px)`,r=m`var(--switchBorderWidth, 3px)`,a=m`var(--switchBgColor, #194880)`,l=m`var(--switchBorderColor, #194880)`,d=m`var(--labelFontSize, 1.3rem)`,p=m`var(--knobColor, white)`,u=m`var(--knobTransitionDuration, 0.25s)`,v=m`var(--knobTransitionFn, ease)`;return[st,m`
      ...
      `]}};n([h({type:String,attribute:!0})],ft.prototype,"leftValue",void 0);n([h({type:String,attribute:!0})],ft.prototype,"leftLabel",void 0);n([h({type:String,attribute:!0})],ft.prototype,"rightValue",void 0);n([h({type:String,attribute:!0})],ft.prototype,"rightLabel",void 0);n([h({type:String,attribute:!0})],ft.prototype,"side",void 0);n([j("#switch-left")],ft.prototype,"leftRadio",void 0);ft=n([F("toggle-switch")],ft);function qs(s,e){if(s)for(const[t,i]of Object.entries(s))for(const[o,r]of Object.entries(i))e(t,o,r,s)}function Co(s,e,t,i=!1){const o=s??tt(),r={...o,[e]:{...o[e],[t.key]:t}};return i&&t.state==="none"&&delete r[e][t.key],r}function I0(s){const e=tt();return qs(s,(t,i,o)=>{e[t][i]=o}),e}function O0(s,e){const t=I0(s);return qs(e,(i,o,r)=>{t[i][o]=r}),qs(t,(i,o,r)=>{r.state==="none"&&delete t[i][o]}),t}const Fa=["selected","hidden","none"];function Mn(s,e=Y.COUNT){return s.sort((t,i)=>{const o=Fa.indexOf(t.state),r=Fa.indexOf(i.state),a=o-r;let l;return e===Y.ALPHABETICAL?l=t.key.localeCompare(i.key):e===Y.NUMERIC?l=Number(i.key)-Number(t.key):l=i.count-t.count,a||l})}let de=class extends B{constructor(){super(...arguments),this.facetsPerPage=35,this.facetsLoading=!0,this.sortedBy=Y.COUNT,this.unappliedFacetChanges=tt(),this.pageNumber=1}willUpdate(e){(e.has("aggregations")||e.has("facetsPerPage")||e.has("sortedBy")||e.has("selectedFacets")||e.has("unappliedFacetChanges"))&&(this.facetGroup=this.mergedFacets)}updated(e){(e.has("facetKey")||e.has("query")||e.has("searchType")||e.has("filterMap"))&&(this.facetsLoading=!0,this.pageNumber=1,this.sortedBy=vo[this.facetKey],this.updateSpecificFacets())}firstUpdated(){this.setupEscapeListeners()}setupEscapeListeners(){this.modalManager?document.addEventListener("keydown",e=>{var t;e.key==="Escape"&&((t=this.modalManager)===null||t===void 0||t.closeModal())}):document.removeEventListener("keydown",()=>{})}get isSearchResultsPage(){var e;const t=(e=this.pageSpecifierParams)===null||e===void 0?void 0:e.pageType;return t===void 0||t==="search_results"}async updateSpecificFacets(){var e,t,i,o,r,a;if(!this.facetKey)return;const l=(e=this.query)===null||e===void 0?void 0:e.trim();if(!l&&this.isSearchResultsPage)return;const d={simpleParams:[this.facetKey]},u={...this.pageSpecifierParams,query:l||"",filters:this.filterMap,aggregations:d,aggregationsSize:65535,rows:0},v=await((t=this.searchService)===null||t===void 0?void 0:t.search(u,this.searchType));this.aggregations=(i=v?.success)===null||i===void 0?void 0:i.response.aggregations,this.facetsLoading=!1;const g=(r=(o=v?.success)===null||o===void 0?void 0:o.response)===null||r===void 0?void 0:r.collectionTitles;if(g)for(const[y,w]of Object.entries(g))(a=this.collectionTitles)===null||a===void 0||a.set(y,w)}pageNumberClicked(e){var t,i;const o=(t=e?.detail)===null||t===void 0?void 0:t.page;o&&(this.pageNumber=Number(o)),(i=this.analyticsHandler)===null||i===void 0||i.sendEvent({category:Ge.default,action:ee.moreFacetsPageChange,label:`${this.pageNumber}`})}get mergedFacets(){var e;if(!this.facetKey||!this.selectedFacets)return;const{selectedFacetGroup:t,aggregationFacetGroup:i}=this;if(!i)return;const o={...t??i},r=(e=t?.buckets.map(l=>{const d=i.buckets.find(p=>p.key===l.key);return d?{...l,count:d.count}:l}))!==null&&e!==void 0?e:[];Mn(r,this.sortedBy),i.buckets.forEach(l=>{t?.buckets.find(p=>p.key===l.key)||r.push(l)});const a=this.unappliedFacetChanges[this.facetKey];for(const[l,d]of r.entries()){const p=a[d.key];p&&(r[l]={...p})}return o.buckets=r,o}get selectedFacetGroup(){if(!this.selectedFacets||!this.facetKey)return;const e=this.selectedFacets[this.facetKey];if(!e)return;const t=mo[this.facetKey],i=Object.entries(e).map(([o,r])=>({displayText:o,key:o,count:r?.count,state:r?.state}));return{title:t,key:this.facetKey,buckets:i}}get aggregationFacetGroup(){if(!this.aggregations||!this.facetKey)return;const e=this.aggregations[this.facetKey];if(!e)return;const t=mo[this.facetKey];let i=e.getSortedBuckets(this.sortedBy);this.facetKey==="collection"&&(i=i?.filter(r=>{var a;const l=(a=r?.key)===null||a===void 0?void 0:a.toString();return!Eo[l]&&!l?.startsWith("fav-")}));const o=i.map(r=>{const a=`${r.key}`;return{displayText:`${a}`,key:`${a}`,count:r.doc_count,state:"none"}});return{title:t,key:this.facetKey,buckets:o}}get facetGroupForCurrentPage(){const{facetGroup:e}=this;if(!e)return;const t=(this.pageNumber-1)*this.facetsPerPage,i=e.buckets.slice(t,t+this.facetsPerPage);return{...e,buckets:i}}get moreFacetsTemplate(){return c`
      <facets-template
        .facetGroup=${this.facetGroupForCurrentPage}
        .selectedFacets=${this.selectedFacets}
        .collectionTitles=${this.collectionTitles}
        @facetClick=${e=>{this.facetKey&&(this.unappliedFacetChanges=Co(this.unappliedFacetChanges,this.facetKey,e.detail.bucket))}}
      ></facets-template>
    `}get loaderTemplate(){return c`<div class="facets-loader">
      <ia-activity-indicator .mode=${"processing"}></ia-activity-indicator>
        ...
        </div> `:b}sortFacetAggregation(e){this.sortedBy=e,this.dispatchEvent(new CustomEvent("sortedFacets",{detail:this.sortedBy}))}get modalHeaderTemplate(){var e,t,i;const r=((e=this.sortedBy)!==null&&e!==void 0?e:vo[this.facetKey])===Y.COUNT?"left":"right";return c`<span class="sr-only">${C("More facets for:")}</span>
      <span class="title">
      ...
      ${this.facetsLoading?this.loaderTemplate:c`
          ...
          `}
    `}applySearchFacetsClicked(){var e,t;const i=O0(this.selectedFacets,this.unappliedFacetChanges),o=new CustomEvent("facetsChanged",{detail:i,bubbles:!0,composed:!0});this.dispatchEvent(o),this.unappliedFacetChanges=tt(),(e=this.modalManager)===null||e===void 0||e.closeModal(),(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:Ge.default,action:`${ee.applyMoreFacetsModal}`,label:`${this.facetKey}`})}cancelClick(){var e,t;this.unappliedFacetChanges=tt(),(e=this.modalManager)===null||e===void 0||e.closeModal(),(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:Ge.default,action:ee.closeMoreFacetsModal,label:`${this.facetKey}`})}static get styles(){const e=m`var(--primaryButtonBGColor, #194880)`;return[st,m`
        section#more-facets {
          overflow: auto;
    ...
    `}};Ra=n([F("facet-tombstone-row")],Ra);let Ye=class extends B{constructor(){super(...arguments),this.boundEscapeListener=e=>{e.key==="Escape"&&this.closeModal()}}render(){var e,t;return c`
      <div id="container">
    ...
    `}};n([h({type:String})],Ye.prototype,"minDate",void 0);n([h({type:String})],Ye.prototype,"maxDate",void 0);n([h({type:String})],Ye.prototype,"minSelectedDate",void 0);n([h({type:String})],Ye.prototype,"maxSelectedDate",void 0);n([h({type:Array})],Ye.prototype,"buckets",void 0);n([h({type:Object,attribute:!1})],Ye.prototype,"modalManager",void 0);n([h({type:Object,attribute:!1})],Ye.prototype,"analyticsHandler",void 0);Ye=n([F("expanded-date-picker")],Ye);let U=class extends B{constructor(){super(...arguments),this.moreLinksVisible=!0,this.facetsLoading=!1,this.fullYearAggregationLoading=!1,this.collapsableFacets=!1,this.showHistogramDatePicker=!1,this.allowExpandingDatePicker=!1,this.parentCollections=[],this.collectionPagePath="/details/",this.isManageView=!1,this.openFacets={subject:!1,lending:!1,mediatype:!1,language:!1,creator:!1,collection:!1,year:!1},this.allowedFacetCount=6,this.handleExpandedDatePickerClosed=()=>{var e;(e=this.modalManager)===null||e===void 0||e.classList.remove("expanded-date-picker")},this.histogramDateRangeUpdated=e=>{const{minDate:t,maxDate:i}=e.detail,o=new CustomEvent("histogramDateRangeUpdated",{detail:{minDate:t,maxDate:i}});this.dispatchEvent(o)}}render(){const e=Ct({loading:this.facetsLoading,managing:this.isManageView}),t="date-picker-label";return c`
    ...
    `}get collectionPartOfTemplate(){var e;if(!(!((e=this.parentCollections)===null||e===void 0)&&e.length))return b;const t="partof-heading";return c`
      ...
      >
        ...
        <ul>
          ${kt(this.parentCollections,i=>{var o,r;const a=`${this.baseNavigationUrl}${this.collectionPagePath}${i}`;return c` <li>
              <a
                href=${a}
                data-id=${i}
    ...
    `}partOfCollectionClicked(e){var t;(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:Ge.default,action:ee.partOfCollectionClicked,label:e.target.dataset.id})}showDatePickerModal(){var e,t,i;const{fullYearsHistogramAggregation:o}=this,r=o?.first_bucket_key,a=o?.last_bucket_key,l=o?.buckets,p=c`
      <expanded-date-picker
        ${Ic(v=>{if(v&&v instanceof Ye){const g=v;g.minSelectedDate=this.minSelectedDate,g.maxSelectedDate=this.maxSelectedDate}})}
        .minDate=${r}
        .maxDate=${a}
    ...
    `,u=new Tt({bodyColor:"#fff",headerColor:"#194880",showHeaderLogo:!1,closeOnBackdropClick:!0,title:c`Select a date range`});(e=this.modalManager)===null||e===void 0||e.classList.add("expanded-date-picker"),(t=this.modalManager)===null||t===void 0||t.showModal({config:u,customModalContent:p,userClosedModalCallback:this.handleExpandedDatePickerClosed}),(i=this.analyticsHandler)===null||i===void 0||i.sendEvent({category:Ge.default,action:ee.histogramExpanded,label:window.location.href})}updated(e){e.has("selectedFacets")&&this.dispatchFacetsChangedEvent()}dispatchFacetsChangedEvent(){const e=new CustomEvent("facetsChanged",{detail:this.selectedFacets});this.dispatchEvent(e)}get expandDatePickerBtnTemplate(){return this.allowExpandingDatePicker&&!this.facetsLoading?c`<button
        ...
        >
          ...
          <histogram-date-range
            ...
            @histogramDateRangeUpdated=${this.histogramDateRangeUpdated}
          ></histogram-date-range>
        `}get mergedFacets(){const e=[];return Gl.forEach(t=>{var i,o;const r=this.selectedFacetGroups.find(u=>u.key===t),a=this.aggregationFacetGroups.find(u=>u.key===t);if(r&&!a){e.push(r);return}if(!a)return;const l=r??a;let d=(i=r?.buckets.map(u=>{const v=a.buckets.find(g=>g.key===u.key);return v?{...u,count:v.count}:u}))!==null&&i!==void 0?i:[];a.buckets.forEach(u=>{d.find(g=>g.key===u.key)||d.push(u)});let p=(o=Object.keys(r?.buckets||[]))===null||o===void 0?void 0:o.length;if(p<this.allowedFacetCount&&(p=this.allowedFacetCount),t==="lending"&&(d=d.filter(u=>Ql[u.key])),Mn(d),t==="mediatype"){const u=d.findIndex(v=>v.key==="collection");if(u>=p){const[v]=d.splice(u,1);p>this.allowedFacetCount&&(p+=1),d.splice(p-1,0,v)}}l.buckets=d.slice(0,p),e.push(l)}),e}get selectedFacetGroups(){return this.selectedFacets?Object.entries(this.selectedFacets).map(([t,i])=>{const o=t,r=mo[o],a=Object.entries(i).map(([l,d])=>{var p;let u=l;return o==="lending"&&(u=(p=sa[l])!==null&&p!==void 0?p:l),{displayText:u,key:l,count:d.count,state:d.state}});return{title:r,key:o,buckets:a}}):[]}get aggregationFacetGroups(){var e;const t=[];return Object.entries((e=this.aggregations)!==null&&e!==void 0?e:[]).forEach(([i,o])=>{if(i==="year_histogram")return;const r=i,a=mo[r];if(!a)return;let l=o.getSortedBuckets(vo[r]);r==="collection"&&(l=l?.filter(u=>{var v;const g=(v=u?.key)===null||v===void 0?void 0:v.toString();return!Eo[g]&&!g?.startsWith("fav-")}));const d=l.map(u=>{var v;const g=u.key;let y=`${u.key}`;return r==="lending"&&(y=(v=sa[u.key])!==null&&v!==void 0?v:`${u.key}`),{displayText:y,key:`${g}`,count:u.doc_count,state:"none"}}),p={title:a,key:r,buckets:d};t.push(p)}),t}getFacetGroupTemplate(e){if(!this.facetsLoading&&e.buckets.length===0)return b;const{key:t}=e,i=this.openFacets[t],o=c`
      <span class="collapser ${i?"open":""}"> ${Ds} </span>
    ...
    `}searchMoreFacetsLink(e){if(!this.moreLinksVisible||e.key==="lending"||Object.keys(e.buckets).length<this.allowedFacetCount)return b;const t=vo[e.key];return c`<button
      class="more-link"
    ...
    `,a=new Tt({bodyColor:"#fff",headerColor:"#194880",showHeaderLogo:!1,closeOnBackdropClick:!0,title:c`Select filters`});(i=this.modalManager)===null||i===void 0||i.classList.add("more-search-facets"),(o=this.modalManager)===null||o===void 0||o.showModal({config:a,customModalContent:r,userClosedModalCallback:()=>{var l;(l=this.modalManager)===null||l===void 0||l.classList.remove("more-search-facets")}})}getFacetTemplate(e){return c`
      <facets-template
        .collectionPagePath=${this.collectionPagePath}
        .facetGroup=${e}
        .selectedFacets=${this.selectedFacets}
        .collectionTitles=${this.collectionTitles}
        @facetClick=${t=>{this.selectedFacets=Co(this.selectedFacets,e.key,t.detail.bucket,!0);const i=new CustomEvent("facetsChanged",{detail:this.selectedFacets,bubbles:!0,composed:!0});this.dispatchEvent(i)}}
      ></facets-template>
    `}static get styles(){return[st,m`
        a:link {
          text-decoration: none;
    ...
    `}};Ba=n([F("circular-activity-indicator")],Ba);function N0(s,e){return s===void 0?e!==void 0:e===void 0?s!==void 0:s.facetType===e.facetType&&s.bucketKey===e.bucketKey}function Qs(s,e){return s.label===e.label&&s.facets.length===e.facets.length&&s.facets.every((t,i)=>N0(t,e.facets[i]))}function Dn(s){if(!Array.isArray(s[0])){let o=[...s];for(let r=0;r<o.length;r++){const a=o[r];o=o.filter(l=>a===l||!Qs(a,l))}return o}const e=s,t=[];for(const i of e){const o=[];for(const r of i)t.find(l=>l.find(d=>Qs(r,d)))||o.push(r);o.length>0&&t.push(o)}return t}class hr{async getRecommendedFacets(){const e=navigator.language,t=hr.getLanguageDisplayName(e);return t?[{facets:[{facetType:"language",bucketKey:t}]}]:[]}static getLanguageDisplayName(e){const t=e.split("-")[0];return new Intl.DisplayNames(["en"],{type:"language"}).of(t)}}const wt={facets:[{facetType:"mediatype",bucketKey:"texts"}]},xt={facets:[{facetType:"mediatype",bucketKey:"audio"}]},Vt={facets:[{facetType:"mediatype",bucketKey:"movies"}]},rt={facets:[{facetType:"mediatype",bucketKey:"image"}]},_i={facets:[{facetType:"mediatype",bucketKey:"software"}]},ms={facets:[{facetType:"mediatype",bucketKey:"etree"}]},U0={facets:[{facetType:"mediatype",bucketKey:"web"}]},H0={facets:[{facetType:"mediatype",bucketKey:"data"}]},V0={text:[wt],book:[wt],novel:[wt],magazine:[wt],newspaper:[wt],pdf:[wt],epub:[wt],audio:[xt],song:[xt],music:[xt],listen:[xt],podcast:[xt],radio:[xt],stream:[xt,Vt],video:[Vt],movie:[Vt],film:[Vt],animation:[Vt],youtube:[Vt],image:[rt],photo:[rt],picture:[rt],painting:[rt],jpg:[rt],jpeg:[rt],png:[rt],gif:[rt],software:[_i],app:[_i],program:[_i],game:[_i],arcade:[_i],etree:[ms],concert:[ms],"live music":[ms],"web crawl":[U0],dataset:[H0]};class W0{async getRecommendedFacets(e){const t=[];for(const[i,o]of Object.entries(V0))e.includes(i)&&t.push(...o);return t}}const Ji=[{facets:[{facetType:"mediatype",bucketKey:"texts"}]}],Ia=[{label:"Films by __QUERY",facets:[{facetType:"mediatype",bucketKey:"movies"},{facetType:"creator",bucketKey:"__QUERY"}]}],Ci=[{label:"Writing by __QUERY",facets:[{facetType:"mediatype",bucketKey:"texts"},{facetType:"creator",bucketKey:"__QUERY"}]}],eo=[{label:"Images by __QUERY",facets:[{facetType:"mediatype",bucketKey:"image"},{facetType:"creator",bucketKey:"__QUERY"}]}],ki=[{label:"Music by __QUERY",facets:[{facetType:"mediatype",bucketKey:"audio"},{facetType:"creator",bucketKey:"__QUERY"}]}],j0={"written work":Ji,literature:Ji,book:Ji,novel:Ji,filmmaker:Ia,director:Ia,author:Ci,writer:Ci,novelist:Ci,essayist:Ci,poet:Ci,"visual artist":eo,"graphic artist":eo,photographer:eo,painter:eo,singer:ki,songwriter:ki,musician:ki,composer:ki,pianist:ki};class G0{constructor(){this.WIKIDATA_BASE_URL="https://www.wikidata.org/w/api.php",this.WIKIDATA_DEFAULT_ARGS="?action=wbsearchentities&format=json&language=en&uselang=en&origin=*&type=item&limit=5"}getWikidataURL(e){const t=encodeURIComponent(e);return`${this.WIKIDATA_BASE_URL}${this.WIKIDATA_DEFAULT_ARGS}&search=${t}`}replaceQueryPlaceholders(e,t){return e.map(i=>{var o;return{label:(o=i.label)===null||o===void 0?void 0:o.replace("__QUERY",t),facets:i.facets.map(r=>{var a;const l={...r,bucketKey:r.bucketKey.replace("__QUERY",t.toLowerCase())};return r.displayText&&(l.displayText=(a=l.displayText)===null||a===void 0?void 0:a.replace("__QUERY",t)),l})}})}async getRecommendedFacets(e){var t;const i=[];try{const o=this.getWikidataURL(e),a=await(await fetch(o)).json();for(const[l,d]of Object.entries(j0))if(new RegExp(`\\b${l}\\b`).test((t=a.search[0])===null||t===void 0?void 0:t.description)){const u=a.search[0].label;i.push(...this.replaceQueryPlaceholders(d,u))}return i}catch(o){return console.warn(o),[]}}}class Ao{async getRecommendedFacets(e,t=Ao.DEFAULT_HEURISTICS){const i=t.map(o=>new o().getRecommendedFacets(e));return Dn((await Promise.all(i)).flat())}}Ao.DEFAULT_HEURISTICS=[W0,G0,hr];const q0=c`
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path
...
`;function K0(s){return s&&s.charAt(0).toLocaleUpperCase()+s.slice(1)}let Ii=class extends B{constructor(){super(...arguments),this.selected=!1}render(){var e,t;if(!this.facetInfo)return b;const i=this.facetInfo.facets.length===1,o=this.facetInfo.facets[0],r=K0((this.labelPrefix?`${this.labelPrefix} `:"")+((t=(e=this.facetInfo.label)!==null&&e!==void 0?e:o.displayText)!==null&&t!==void 0?t:o.bucketKey));if(!r)return b;const a=i&&o.facetType==="mediatype"?fn[o.bucketKey].icon:b;return c`
      <a
      ...
      >
        ${a} ${r}
        ${this.selected?c`<span class="unselect-button">${Q0}</span>`:b}
      </a>
    ...
    `}};n([h({type:Object})],Ii.prototype,"facetInfo",void 0);n([h({type:String})],Ii.prototype,"labelPrefix",void 0);n([h({type:Boolean})],Ii.prototype,"selected",void 0);Ii=n([F("smart-facet-button")],Ii);let ri=class extends B{render(){var e,t;if(!this.facetInfo||!this.activeFacetRef||this.facetInfo.length===0)return b;const i=(e=this.activeFacetRef.displayText)!==null&&e!==void 0?e:this.activeFacetRef.bucketKey;return i?c`
    ...
    `}};n([h({type:Array})],ri.prototype,"facetInfo",void 0);n([h({type:String})],ri.prototype,"labelPrefix",void 0);n([h({type:Object})],ri.prototype,"activeFacetRef",void 0);n([j("ia-dropdown")],ri.prototype,"dropdown",void 0);ri=n([F("smart-facet-dropdown")],ri);const Oa={collection:"Collection: ",creator:"By: ",subject:"About: "};function Y0(s){return s.charAt(0).toUpperCase()+s.slice(1)}let Xe=class extends B{constructor(){super(...arguments),this.filterToggleActive=!1,this.heuristicRecs=[],this.smartFacets=[]}render(){return this.query?c`
      <div id="smart-facets-container">
        ${this.filtersToggleTemplate}
        ${this.smartFacets.length>0?c`<p id="filters-label">${C("Insights:")}</p>`:b}
        ${ir(this.smartFacets,e=>`${e[0].label}|${e[0].facets[0].facetType}|${e[0].facets[0].bucketKey}`,e=>this.makeSmartFacet(e))}
      </div>
    `:b}willUpdate(e){let t=!1;e.has("query")&&(Fe("query change",e.get("query"),this.query),this.lastAggregations=void 0,t=!0),e.has("aggregations")&&!this.lastAggregations&&this.aggregations&&Object.keys(this.aggregations).length>0&&(Fe("aggs change",e.get("aggregations"),this.aggregations),this.lastAggregations=this.aggregations,t=!0),t&&(Fe("should update smart facets, doing so..."),this.updateSmartFacets())}refresh(){this.lastAggregations=this.aggregations,this.updateSmartFacets()}async updateSmartFacets(){Fe("updating smart facets"),this.query&&(this.heuristicRecs=await new Ao().getRecommendedFacets(this.query),Fe("heuristic recs are",this.heuristicRecs),this.smartFacets=Dn(this.facetsToDisplay),Fe("smart facets are",this.smartFacets))}makeSmartFacet(e){return e.length===0?b:e.length===1?this.smartFacetButton(e[0]):this.smartFacetDropdown(e)}smartFacetButton(e){var t;return c`
      <smart-facet-button
        .facetInfo=${e}
    ...
    `}get facetsToDisplay(){const e=[];if(this.heuristicRecs.length>0)for(const t of this.heuristicRecs)t.facets.length===1&&t.facets[0].facetType==="mediatype"||e.push([t]);if(this.lastAggregations){const t=["mediatype","year","language","creator","subject","collection"];for(const i of t){const o=this.lastAggregations[i];if(!o||o.buckets.length===0||["lending","year_histogram"].includes(i)||typeof o.buckets[0]=="number"||i==="mediatype"&&this.selectedFacets&&Object.values(this.selectedFacets.mediatype).some(d=>d.state!=="none"))continue;const r=i,l=o.buckets.filter(d=>{var p;const u=(p=this.selectedFacets)===null||p===void 0?void 0:p[r][d.key];return!(u&&u.state!=="none")});if(r!=="mediatype")if(r==="collection"||r==="subject"){const d=l.slice(0,5);e.push(d.map(p=>this.toSmartFacet(r,[p])))}else e.push([this.toSmartFacet(r,[l[0]])])}}return e}toSmartFacet(e,t){return{facets:t.map(i=>{var o;let r=Y0(i.key.toString());if(e==="collection"){const a=(o=this.collectionTitles)===null||o===void 0?void 0:o.get(i.key.toString());a&&(r=a)}return{facetType:e,bucketKey:i.key.toString(),displayText:r}})}}facetClicked(e){e.detail.smartFacet.selected||(this.smartFacets=[[{...e.detail.smartFacet,selected:!0}],...this.smartFacets.filter(i=>i[0]!==e.detail.smartFacet)]);for(const i of e.detail.details)this.selectedFacets=Co(this.selectedFacets,i.facetType,i.bucket,!0);const t=new CustomEvent("facetsChanged",{detail:this.selectedFacets});this.dispatchEvent(t)}facetDropdownClicked(e){if(this.smartFacets.find(i=>Qs(i[0],e.detail.smartFacet)))return;this.smartFacets=[[{...e.detail.smartFacet,selected:!0}],...this.smartFacets];for(const i of e.detail.details)this.selectedFacets=Co(this.selectedFacets,i.facetType,i.bucket,!0);const t=new CustomEvent("facetsChanged",{detail:this.selectedFacets});this.dispatchEvent(t)}onDropdownClick(e){var t;Fe("smart bar: onDropdownClick",e.detail),(t=this.shadowRoot)===null||t===void 0||t.querySelectorAll("smart-facet-dropdown").forEach(i=>{i!==e.detail&&(Fe("closing",i),i.close())})}filterToggleClicked(){this.dispatchEvent(new CustomEvent("filtersToggled"))}static get styles(){return m`
    ...
    `}get rightColumnTemplate(){var e;const t=Ct({column:!0,"full-width":this.showSmartFacetBar&&!this.facetPaneVisible,"smart-results-spacing":!!this.showSmartResults});return c`
    ...
    </infinite-scroller>`}get infiniteScrollerClasses(){var e;return Ct({[(e=this.displayMode)!==null&&e!==void 0?e:""]:!!this.displayMode,hidden:!!this.placeholderType})}get sortFilterBarTemplate(){var e;return this.suppressSortBar?b:c`
      <sort-filter-bar
    ...
    `}handleRemoveItems(){this.dispatchEvent(new CustomEvent("itemRemovalRequested",{detail:{items:this.dataSource.checkedTileModels.map(e=>{var t;const i=e?.mediatype==="search"?"search:":"",o=(t=e?.identifier)!==null&&t!==void 0?t:"";return`${i}${o}`})}}))}handleManageItems(){this.dispatchEvent(new CustomEvent("itemManagerRequested",{detail:{items:this.dataSource.checkedTileModels.map(e=>e?.identifier?e.identifier:"")}}))}refreshSmartFacets(){var e;(e=this.smartFacetBar)===null||e===void 0||e.refresh()}showRemoveItemsProcessingModal(){var e;(e=this.manageBar)===null||e===void 0||e.showRemoveItemsProcessingModal()}showRemoveItemsErrorModal(){var e;(e=this.manageBar)===null||e===void 0||e.showRemoveItemsErrorModal()}removeCheckedTiles(){this.dataSource.removeCheckedTiles()}userChangedSort(e){var t;const{selectedSort:i,sortDirection:o}=e.detail;this.selectedSort=i,this.sortDirection=o,((t=this.currentPage)!==null&&t!==void 0?t:1)>1&&this.goToPage(1),this.currentPage=1}sendSortByAnalytics(e){var t;const i=e&&!this.sortDirection;(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:this.searchContext,action:ee.sortBy,label:`${this.selectedSort}${this.sortDirection||i?`-${this.sortDirection}`:""}`})}selectedSortChanged(){this.dataSource.updatePrefixFiltersForCurrentSort()}get sortParam(){var e;const t=xe[this.selectedSort];if(!t?.handledBySearchService)return null;const i=new URL(window.location.href).searchParams.get("sort"),o=(e=t.searchServiceKey)!==null&&e!==void 0?e:i?.replace(/^-/,"");return this.sortDirection||(this.sortDirection="asc"),o?{field:o,direction:this.sortDirection}:null}get defaultSortParam(){var e;const t=(e=this.defaultSortDirection)!==null&&e!==void 0?e:"asc",i=xe[this.defaultSortField].searchServiceKey;return i?{field:i,direction:t}:null}displayModeChanged(e){var t;this.displayMode=e.detail.displayMode,this.displayMode&&((t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:this.searchContext,action:ee.displayMode,label:this.displayMode}))}get titleQuery(){return this.selectedTitleFilter?`firstTitle:${this.selectedTitleFilter}`:void 0}get creatorQuery(){return this.selectedCreatorFilter?`firstCreator:${this.selectedCreatorFilter}`:void 0}sendFilterByTitleAnalytics(e){var t;if(!e&&!this.selectedTitleFilter)return;const i=e&&!this.selectedTitleFilter;(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:this.searchContext,action:ee.filterByTitle,label:i?`clear-${e}`:`${e||"start"}-${this.selectedTitleFilter}`})}sendFilterByCreatorAnalytics(e){var t;if(!e&&!this.selectedCreatorFilter)return;const i=e&&!this.selectedCreatorFilter;(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:this.searchContext,action:ee.filterByCreator,label:i?`clear-${e}`:`${e||"start"}-${this.selectedCreatorFilter}`})}titleLetterSelected(e){this.selectedCreatorFilter=null,this.selectedTitleFilter=e.detail.selectedLetter}creatorLetterSelected(e){this.selectedTitleFilter=null,this.selectedCreatorFilter=e.detail.selectedLetter}get mobileFacetsTemplate(){return Ms.includes(this.profileElement)?b:c`
      <details id="mobile-filter-collapse" @toggle=${t=>{var i;const o=t.target;this.isResizeToMobile=!1,this.collapsibleFacetsVisible=o.open,(i=this.analyticsHandler)===null||i===void 0||i.sendEvent({category:this.searchContext,action:ee.mobileFacetsToggled,label:o.open?"open":"closed"})}}>
        <summary>
          <span class="collapser-icon">${Ds}</span>
          <h2>${C("Filters")}</h2>
          ${this.clearFiltersBtnTemplate(!0)}
        </summary>
        ${this.facetsTemplate}
      </details>
    `}get facetsTemplate(){if(Ms.includes(this.profileElement))return b;if(this.facetLoadStrategy==="off")return c`
    ...
    `;return(this.facetLoadStrategy==="opt-in"||this.facetLoadStrategy==="opt-in-or-login"&&!this.loggedIn)&&!this.mobileView?c`
      ...
      `:e}clearFiltersBtnTemplate(e){if(!this.hasActiveFilters)return b;const t=Ct({"clear-filters-btn":!0,mobile:e}),i=e?"Clear all":"Clear all filters";return c`
  ...
  `;n([z()],re.prototype,"toggleSlots",void 0);n([z()],re.prototype,"currentPage",void 0);n([z()],re.prototype,"searchQuery",void 0);n([z()],re.prototype,"withinCollection",void 0);n([z()],re.prototype,"cellWidth",void 0);n([z()],re.prototype,"cellHeight",void 0);n([z()],re.prototype,"rowGap",void 0);n([z()],re.prototype,"colGap",void 0);n([z()],re.prototype,"suppressFacets",void 0);n([z()],re.prototype,"lazyLoadFacets",void 0);n([z()],re.prototype,"loggedIn",void 0);n([z()],re.prototype,"searchType",void 0);n([h({type:Object,reflect:!1})],re.prototype,"latestAction",void 0);n([j("#base-query-field")],re.prototype,"baseQueryField",void 0);n([j("#base-collection-field")],re.prototype,"baseCollectionField",void 0);n([j("#page-number-input")],re.prototype,"pageNumberInput",void 0);n([j("collection-browser")],re.prototype,"collectionBrowser",void 0);n([j("modal-manager")],re.prototype,"modalManager",void 0);re=n([F("app-root")],re);
