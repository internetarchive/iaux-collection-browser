...
\f\r"'\`<>=]|("|')|))|$)`,"g"),ma=/'/g,va=/"/g,xn=/^(?:script|style|textarea|title)$/i,$n=r=>(e,...t)=>({_$litType$:r,strings:e,values:t}),h=$n(1),N=$n(2),di=Symbol.for("lit-noChange"),b=Symbol.for("lit-nothing"),ga=new WeakMap,zt=Ut.createTreeWalker(Ut,129,null,!1);function _n(r,e){if(!Array.isArray(r)||!r.hasOwnProperty("raw"))throw Error("invalid template strings array");return pa!==void 0?pa.createHTML(e):e}const jl=(r,e)=>{const t=r.length-1,i=[];let o,s=e===2?"<svg>":"",a=Ti;for(let l=0;l<t;l++){const d=r[l];let u,p,m=-1,v=0;for(;v<d.length&&(a.lastIndex=v,p=a.exec(d),p!==null);)v=a.lastIndex,a===Ti?p[1]==="!--"?a=ua:p[1]!==void 0?a=fa:p[2]!==void 0?(xn.test(p[2])&&(o=RegExp("</"+p[2],"g")),a=Tt):p[3]!==void 0&&(a=Tt):a===Tt?p[0]===">"?(a=o??Ti,m=-1):p[1]===void 0?m=-2:(m=a.lastIndex-p[2].length,u=p[1],a=p[3]===void 0?Tt:p[3]==='"'?va:ma):a===va||a===ma?a=Tt:a===ua||a===fa?a=Ti:(a=Tt,o=void 0);const y=a===Tt&&r[l+1].startsWith("/>")?" ":"";s+=a===Ti?d+Vl:m>=0?(i.push(u),d.slice(0,m)+Vr+d.slice(m)+yt+y):d+yt+(m===-2?(i.push(void 0),l):y)}return[_n(r,s+(r[t]||"<?>")+(e===2?"</svg>":"")),i]};class Ki{constructor({strings:e,_$litType$:t},i){let o;this.parts=[];let s=0,a=0;const l=e.length-1,d=this.parts,[u,p]=jl(e,t);if(this.el=Ki.createElement(u,i),zt.currentNode=this.el.content,t===2){const m=this.el.content,v=m.firstChild;v.remove(),m.append(...v.childNodes)}for(;(o=zt.nextNode())!==null&&d.length<l;){if(o.nodeType===1){if(o.hasAttributes()){const m=[];for(const v of o.getAttributeNames())if(v.endsWith(Vr)||v.startsWith(yt)){const y=p[a++];if(m.push(v),y!==void 0){const x=o.getAttribute(y.toLowerCase()+Vr).split(yt),S=/([.?@])?(.*)/.exec(y);d.push({type:1,index:s,name:S[2],strings:x,ctor:S[1]==="."?Gl:S[1]==="?"?Ql:S[1]==="@"?Kl:Wo})}else d.push({type:6,index:s})}for(const v of m)o.removeAttribute(v)}if(xn.test(o.tagName)){const m=o.textContent.split(yt),v=m.length-1;if(v>0){o.textContent=li?li.emptyScript:"";for(let y=0;y<v;y++)o.append(m[y],Yi()),zt.nextNode(),d.push({type:2,index:++s});o.append(m[v],Yi())}}}else if(o.nodeType===8)if(o.data===wn)d.push({type:2,index:s});else{let m=-1;for(;(m=o.data.indexOf(yt,m+1))!==-1;)d.push({type:7,index:s}),m+=yt.length-1}s++}}static createElement(e,t){const i=Ut.createElement("template");return i.innerHTML=e,i}}function ci(r,e,t=r,i){var o,s,a,l;if(e===di)return e;let d=i!==void 0?(o=t._$Co)===null||o===void 0?void 0:o[i]:t._$Cl;const u=Qi(e)?void 0:e._$litDirective$;return d?.constructor!==u&&((s=d?._$AO)===null||s===void 0||s.call(d,!1),u===void 0?d=void 0:(d=new u(r),d._$AT(r,t,i)),i!==void 0?((a=(l=t)._$Co)!==null&&a!==void 0?a:l._$Co=[])[i]=d:t._$Cl=d),d!==void 0&&(e=ci(r,d._$AS(r,e.values),d,i)),e}let ql=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){var t;const{el:{content:i},parts:o}=this._$AD,s=((t=e?.creationScope)!==null&&t!==void 0?t:Ut).importNode(i,!0);zt.currentNode=s;let a=zt.nextNode(),l=0,d=0,u=o[0];for(;u!==void 0;){if(l===u.index){let p;u.type===2?p=new to(a,a.nextSibling,this,e):u.type===1?p=new u.ctor(a,u.name,u.strings,this,e):u.type===6&&(p=new Xl(a,this,e)),this._$AV.push(p),u=o[++d]}l!==u?.index&&(a=zt.nextNode(),l++)}return zt.currentNode=Ut,s}v(e){let t=0;for(const i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}};class to{constructor(e,t,i,o){var s;this.type=2,this._$AH=b,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=o,this._$Cp=(s=o?.isConnected)===null||s===void 0||s}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cp}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=ci(this,e,t),Qi(e)?e===b||e==null||e===""?(this._$AH!==b&&this._$AR(),this._$AH=b):e!==this._$AH&&e!==di&&this._(e):e._$litType$!==void 0?this.g(e):e.nodeType!==void 0?this.$(e):Wl(e)?this.T(e):this._(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==b&&Qi(this._$AH)?this._$AA.nextSibling.data=e:this.$(Ut.createTextNode(e)),this._$AH=e}g(e){var t;const{values:i,_$litType$:o}=e,s=typeof o=="number"?this._$AC(e):(o.el===void 0&&(o.el=Ki.createElement(_n(o.h,o.h[0]),this.options)),o);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===s)this._$AH.v(i);else{const a=new ql(s,this),l=a.u(this.options);a.v(i),this.$(l),this._$AH=a}}_$AC(e){let t=ga.get(e.strings);return t===void 0&&ga.set(e.strings,t=new Ki(e)),t}T(e){Sn(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,o=0;for(const s of e)o===t.length?t.push(i=new to(this.k(Yi()),this.k(Yi()),this,this.options)):i=t[o],i._$AI(s),o++;o<t.length&&(this._$AR(i&&i._$AB.nextSibling,o),t.length=o)}_$AR(e=this._$AA.nextSibling,t){var i;for((i=this._$AP)===null||i===void 0||i.call(this,!1,!0,t);e&&e!==this._$AB;){const o=e.nextSibling;e.remove(),e=o}}setConnected(e){var t;this._$AM===void 0&&(this._$Cp=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}}class Wo{constructor(e,t,i,o,s){this.type=1,this._$AH=b,this._$AN=void 0,this.element=e,this.name=t,this._$AM=o,this.options=s,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=b}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,i,o){const s=this.strings;let a=!1;if(s===void 0)e=ci(this,e,t,0),a=!Qi(e)||e!==this._$AH&&e!==di,a&&(this._$AH=e);else{const l=e;let d,u;for(e=s[0],d=0;d<s.length-1;d++)u=ci(this,l[i+d],t,d),u===di&&(u=this._$AH[d]),a||(a=!Qi(u)||u!==this._$AH[d]),u===b?e=b:e!==b&&(e+=(u??"")+s[d+1]),this._$AH[d]=u}a&&!o&&this.j(e)}j(e){e===b?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}let Gl=class extends Wo{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===b?void 0:e}};const Yl=li?li.emptyScript:"";let Ql=class extends Wo{constructor(){super(...arguments),this.type=4}j(e){e&&e!==b?this.element.setAttribute(this.name,Yl):this.element.removeAttribute(this.name)}};class Kl extends Wo{constructor(e,t,i,o,s){super(e,t,i,o,s),this.type=5}_$AI(e,t=this){var i;if((e=(i=ci(this,e,t,0))!==null&&i!==void 0?i:b)===di)return;const o=this._$AH,s=e===b&&o!==b||e.capture!==o.capture||e.once!==o.once||e.passive!==o.passive,a=e!==b&&(o===b||s);s&&this.element.removeEventListener(this.name,this,o),a&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,i;typeof this._$AH=="function"?this._$AH.call((i=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&i!==void 0?i:this.element,e):this._$AH.handleEvent(e)}}class Xl{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){ci(this,e)}}const ba=Ao.litHtmlPolyfillSupport;ba?.(Ki,to),((hr=Ao.litHtmlVersions)!==null&&hr!==void 0?hr:Ao.litHtmlVersions=[]).push("2.8.0");const go=(r,e,t)=>{var i,o;const s=(i=t?.renderBefore)!==null&&i!==void 0?i:e;let a=s._$litPart$;if(a===void 0){const l=(o=t?.renderBefore)!==null&&o!==void 0?o:null;s._$litPart$=a=new to(e.insertBefore(Yi(),l),l,void 0,t??{})}return a._$AI(r),a};var ur,fr;let P=class extends ei{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e,t;const i=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=i.firstChild),i}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=go(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!1)}render(){return di}};P.finalized=!0,P._$litElement$=!0,(ur=globalThis.litElementHydrateSupport)===null||ur===void 0||ur.call(globalThis,{LitElement:P});const ya=globalThis.litElementPolyfillSupport;ya?.({LitElement:P});((fr=globalThis.litElementVersions)!==null&&fr!==void 0?fr:globalThis.litElementVersions=[]).push("3.3.3");const R=r=>e=>typeof e=="function"?((t,i)=>(customElements.define(t,i),i))(r,e):((t,i)=>{const{kind:o,elements:s}=i;return{kind:o,elements:s,finisher(a){customElements.define(t,a)}}})(r,e);const Zl=(r,e)=>e.kind==="method"&&e.descriptor&&!("value"in e.descriptor)?{...e,finisher(t){t.createProperty(e.key,r)}}:{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){typeof e.initializer=="function"&&(this[e.key]=e.initializer.call(this))},finisher(t){t.createProperty(e.key,r)}},Jl=(r,e,t)=>{e.constructor.createProperty(t,r)};function c(r){return(e,t)=>t!==void 0?Jl(r,e,t):Zl(r,e)}function F(r){return c({...r,state:!0})}const ws=({finisher:r,descriptor:e})=>(t,i)=>{var o;if(i===void 0){const s=(o=t.originalKey)!==null&&o!==void 0?o:t.key,a=e!=null?{kind:"method",placement:"prototype",key:s,descriptor:e(t.key)}:{...t,key:s};return r!=null&&(a.finisher=function(l){r(l,s)}),a}{const s=t.constructor;e!==void 0&&Object.defineProperty(t,i,e(i)),r?.(s,i)}};function H(r,e){return ws({descriptor:t=>({get(){var o,s;return(s=(o=this.renderRoot)===null||o===void 0?void 0:o.querySelector(r))!==null&&s!==void 0?s:null},enumerable:!0,configurable:!0})})}function ed(r){return ws({descriptor:e=>({get(){var t,i;return(i=(t=this.renderRoot)===null||t===void 0?void 0:t.querySelectorAll(r))!==null&&i!==void 0?i:[]},enumerable:!0,configurable:!0})})}var mr;const td=((mr=window.HTMLSlotElement)===null||mr===void 0?void 0:mr.prototype.assignedElements)!=null?(r,e)=>r.assignedElements(e):(r,e)=>r.assignedNodes(e).filter(t=>t.nodeType===Node.ELEMENT_NODE);function id(r){const{slot:e,selector:t}={};return ws({descriptor:i=>({get(){var o;const s="slot"+(e?`[name=${e}]`:":not([name])"),a=(o=this.renderRoot)===null||o===void 0?void 0:o.querySelector(s),l=a!=null?td(a,r):[];return t?l.filter(d=>d.matches(t)):l},enumerable:!0,configurable:!0})})}class od{constructor(){this.resizeObserver=new ResizeObserver(e=>{window.requestAnimationFrame(()=>{for(const t of e){const i=this.resizeHandlers.get(t.target);i?.forEach(o=>{o.handleResize(t)})}})}),this.resizeHandlers=new Map}shutdown(){this.resizeHandlers.forEach((e,t)=>{this.resizeObserver.unobserve(t)}),this.resizeHandlers.clear()}addObserver(e){var t;const i=(t=this.resizeHandlers.get(e.target))!==null&&t!==void 0?t:new Set;i.add(e.handler),this.resizeHandlers.set(e.target,i),this.resizeObserver.observe(e.target,e.options)}removeObserver(e){const t=this.resizeHandlers.get(e.target);t&&(t.delete(e.handler),t.size===0&&(this.resizeObserver.unobserve(e.target),this.resizeHandlers.delete(e.target)))}}const We={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4},yi=r=>(...e)=>({_$litDirective$:r,values:e});let wi=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}};const je=yi(class extends wi{constructor(r){var e;if(super(r),r.type!==We.ATTRIBUTE||r.name!=="class"||((e=r.strings)===null||e===void 0?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(r){return" "+Object.keys(r).filter(e=>r[e]).join(" ")+" "}update(r,[e]){var t,i;if(this.it===void 0){this.it=new Set,r.strings!==void 0&&(this.nt=new Set(r.strings.join(" ").split(/\s/).filter(s=>s!=="")));for(const s in e)e[s]&&!(!((t=this.nt)===null||t===void 0)&&t.has(s))&&this.it.add(s);return this.render(e)}const o=r.element.classList;this.it.forEach(s=>{s in e||(o.remove(s),this.it.delete(s))});for(const s in e){const a=!!e[s];a===this.it.has(s)||!((i=this.nt)===null||i===void 0)&&i.has(s)||(a?(o.add(s),this.it.add(s)):(o.remove(s),this.it.delete(s)))}return Ae}});const rd=(r,...e)=>({strTag:!0,strings:r,values:e}),ot=rd,sd=r=>typeof r!="string"&&"strTag"in r,ad=(r,e,t)=>{let i=r[0];for(let o=1;o<r.length;o++)i+=e[o-1],i+=r[o];return i};const nd=r=>sd(r)?ad(r.strings,r.values):r;let k=nd;let ld=class{constructor(){this.settled=!1,this.promise=new Promise((e,t)=>{this._resolve=e,this._reject=t})}resolve(e){this.settled=!0,this._resolve(e)}reject(e){this.settled=!0,this._reject(e)}};for(let r=0;r<256;r++)(r>>4&15).toString(16)+(r&15).toString(16);let dd=new ld;dd.resolve();const{I:cd}=Hl,Cn=r=>r.strings===void 0,wa=()=>document.createComment(""),Ei=(r,e,t)=>{var i;const o=r._$AA.parentNode,s=e===void 0?r._$AB:e._$AA;if(t===void 0){const a=o.insertBefore(wa(),s),l=o.insertBefore(wa(),s);t=new cd(a,l,r,r.options)}else{const a=t._$AB.nextSibling,l=t._$AM,d=l!==r;if(d){let u;(i=t._$AQ)===null||i===void 0||i.call(t,r),t._$AM=r,t._$AP!==void 0&&(u=r._$AU)!==l._$AU&&t._$AP(u)}if(a!==s||d){let u=t._$AA;for(;u!==a;){const p=u.nextSibling;o.insertBefore(u,s),u=p}}}return t},Et=(r,e,t=r)=>(r._$AI(e,t),r),hd={},kn=(r,e=hd)=>r._$AH=e,pd=r=>r._$AH,vr=r=>{var e;(e=r._$AP)===null||e===void 0||e.call(r,!1,!0);let t=r._$AA;const i=r._$AB.nextSibling;for(;t!==i;){const o=t.nextSibling;t.remove(),t=o}};const Sa=(r,e,t)=>{const i=new Map;for(let o=e;o<=t;o++)i.set(r[o],o);return i},Ss=yi(class extends wi{constructor(r){if(super(r),r.type!==We.CHILD)throw Error("repeat() can only be used in text expressions")}ct(r,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);const o=[],s=[];let a=0;for(const l of r)o[a]=i?i(l,a):a,s[a]=t(l,a),a++;return{values:s,keys:o}}render(r,e,t){return this.ct(r,e,t).values}update(r,[e,t,i]){var o;const s=pd(r),{values:a,keys:l}=this.ct(e,t,i);if(!Array.isArray(s))return this.ut=l,a;const d=(o=this.ut)!==null&&o!==void 0?o:this.ut=[],u=[];let p,m,v=0,y=s.length-1,x=0,S=a.length-1;for(;v<=y&&x<=S;)if(s[v]===null)v++;else if(s[y]===null)y--;else if(d[v]===l[x])u[x]=Et(s[v],a[x]),v++,x++;else if(d[y]===l[S])u[S]=Et(s[y],a[S]),y--,S--;else if(d[v]===l[S])u[S]=Et(s[v],a[S]),Ei(r,u[S+1],s[v]),v++,S--;else if(d[y]===l[x])u[x]=Et(s[y],a[x]),Ei(r,s[v],s[y]),y--,x++;else if(p===void 0&&(p=Sa(l,x,S),m=Sa(d,v,y)),p.has(d[v]))if(p.has(d[y])){const C=m.get(l[x]),D=C!==void 0?s[C]:null;if(D===null){const M=Ei(r,s[v]);Et(M,a[x]),u[x]=M}else u[x]=Et(D,a[x]),Ei(r,s[v],D),s[C]=null;x++}else vr(s[y]),y--;else vr(s[v]),v++;for(;x<=S;){const C=Ei(r,u[S+1]);Et(C,a[x]),u[x++]=C}for(;v<=y;){const C=s[v++];C!==null&&vr(C)}return this.ut=l,kn(r,u),Ae}});function co(r,e,t){return Array.from({length:(e-r)/t+1},(i,o)=>r+o*t)}let ht=class extends P{constructor(){super(...arguments),this.itemCount=0,this.scrollOptimizationsDisabled=!1,this.intersectionObserver=new IntersectionObserver(e=>{e.forEach(t=>{if(t.target===this.sentinel){t.isIntersecting&&this.dispatchEvent(new Event("scrollThresholdReached"));return}const o=t.target.dataset.cellIndex;if(!o)return;const s=parseInt(o,10);t.isIntersecting?this.visibleCellIndices.add(s):this.visibleCellIndices.delete(s)}),this.scrollOptimizationsDisabled||this.processVisibleCells()}),this.renderedCellIndices=new Set,this.visibleCellIndices=new Set,this.placeholderCellIndices=new Set}reload(){co(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.removeCell(t)),this.renderedCellIndices.clear(),this.visibleCellIndices.clear(),this.placeholderCellIndices.clear(),this.setupObservations()}refreshCell(e){this.removeCell(e),this.bufferRange.includes(e)&&this.renderCellBuffer([e])}refreshAllVisibleCells(){this.bufferRange.forEach(e=>this.removeCell(e)),this.renderCellBuffer(this.bufferRange)}scrollToCell(e,t){const i=this.cellContainers[e];if(!i)return!1;const o=t?"smooth":"auto";return i.scrollIntoView({behavior:o}),!0}getVisibleCellIndices(){return Array.from(this.visibleCellIndices)}updated(e){(e.has("itemCount")||e.has("scrollOptimizationsDisabled"))&&this.setupObservations()}disconnectedCallback(){this.intersectionObserver.disconnect()}setupObservations(){this.setupIntersectionObserver()}setupIntersectionObserver(){this.intersectionObserver.disconnect(),this.sentinel&&this.intersectionObserver.observe(this.sentinel),this.scrollOptimizationsDisabled?(co(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.visibleCellIndices.add(t)),this.processVisibleCells()):this.cellContainers.forEach(e=>this.intersectionObserver.observe(e))}render(){var e;const t=this.itemCount-1,i=co(0,t,1),o=(e=this.ariaLandmarkLabel)!==null&&e!==void 0?e:b;return h`
    ...
    `}};n([c({type:Number})],ht.prototype,"itemCount",void 0);n([c({type:Object})],ht.prototype,"cellProvider",void 0);n([c({type:Object})],ht.prototype,"placeholderCellTemplate",void 0);n([c({type:Boolean})],ht.prototype,"scrollOptimizationsDisabled",void 0);n([c({type:String})],ht.prototype,"ariaLandmarkLabel",void 0);n([H("#sentinel")],ht.prototype,"sentinel",void 0);n([ed(".cell-container")],ht.prototype,"cellContainers",void 0);ht=n([R("infinite-scroller")],ht);function ud(r){return r?.replace(/%22%22(?!%22%22)(.+?)%22%22/g,"%22$1%22")}function fd(r){var e,t,i;return((e=r?.rawMetadata)===null||e===void 0?void 0:e.hit_type)==="favorited_search"?"search":(i=(t=r.mediatype)===null||t===void 0?void 0:t.value)!==null&&i!==void 0?i:"data"}const md=N`
  <svg
    viewBox="0 0 100 100"
...
`;function Xi(r,e="short",t="en-US"){if(!r)return"";const i={};switch(e){case"year-only":return`${r.getUTCFullYear()}`;case"short":i.month="short",i.year="numeric";break;case"long":i.year="numeric",i.month="short",i.day="2-digit";break}return new Intl.DateTimeFormat(t,i).format(r)}class Ta{constructor(e={}){var t;this.model=e.model,this.baseNavigationUrl=e.baseNavigationUrl,this.collectionPagePath=(t=e.collectionPagePath)!==null&&t!==void 0?t:"/details/",this.sortParam=e.sortParam,this.creatorFilter=e.creatorFilter}get firstCreatorMatchingFilter(){var e,t;let i;if(this.creatorFilter&&(!((e=this.model)===null||e===void 0)&&e.creators.length)){const o=this.creatorFilter;i=this.model.creators.find(s=>s.normalize("NFD").replace(/[^A-Z]+/gi,"").toUpperCase().startsWith(o))}return i??((t=this.model)===null||t===void 0?void 0:t.creator)}get accountLabel(){var e;return!((e=this.model)===null||e===void 0)&&e.dateAdded?k(ot`Archivist since ${this.model.dateAdded.getFullYear()}`):""}get dateLabel(){var e;switch((e=this.sortParam)===null||e===void 0?void 0:e.field){case"publicdate":return k("Archived");case"reviewdate":return k("Reviewed");case"addeddate":return k("Added");case"date":return k("Published");default:return""}}itemPageUrl(e,t=!1){if(!e||this.baseNavigationUrl==null)return b;const i=t?this.collectionPagePath:"/details/";return`${this.baseNavigationUrl}${i}${e}`}webArchivesCaptureLink(e,t){const o=`https://web.archive.org/web/${t.toISOString().replace(/[TZ:-]/g,"").replace(/\..*/,"")}/${encodeURIComponent(e)}`,s=Xi(t,"long");return h` <a href=${o}> ${s} </a> `}}class ce extends P{constructor(){super(...arguments),this.sortParam=null,this.defaultSortParam=null,this.loggedIn=!1,this.suppressBlurring=!1,this.displayValueProvider=new Ta}willUpdate(e){var t,i;(e.has("model")||e.has("baseNavigationUrl")||e.has("collectionPagePath")||e.has("sortParam")||e.has("defaultSortParam")||e.has("creatorFilter"))&&(this.displayValueProvider=new Ta({model:this.model,baseNavigationUrl:this.baseNavigationUrl,collectionPagePath:this.collectionPagePath,sortParam:(i=(t=this.sortParam)!==null&&t!==void 0?t:this.defaultSortParam)!==null&&i!==void 0?i:void 0,creatorFilter:this.creatorFilter}))}}n([c({type:Object})],ce.prototype,"model",void 0);n([c({type:Number})],ce.prototype,"currentWidth",void 0);n([c({type:Number})],ce.prototype,"currentHeight",void 0);n([c({type:String})],ce.prototype,"baseNavigationUrl",void 0);n([c({type:String})],ce.prototype,"baseImageUrl",void 0);n([c({type:String})],ce.prototype,"collectionPagePath",void 0);n([c({type:Object})],ce.prototype,"sortParam",void 0);n([c({type:Object})],ce.prototype,"defaultSortParam",void 0);n([c({type:String})],ce.prototype,"creatorFilter",void 0);n([c({type:Number})],ce.prototype,"mobileBreakpoint",void 0);n([c({type:Boolean})],ce.prototype,"loggedIn",void 0);n([c({type:Boolean})],ce.prototype,"suppressBlurring",void 0);let Kr=class extends P{render(){return h`<div class="icon-overlay">${this.iconTemplate}</div>`}get iconTemplate(){var e;return this.type?h`${(e=Tn[this.type])!==null&&e!==void 0?e:b}`:b}static get styles(){return f`
    ...
    `}};n([c({type:String})],Xr.prototype,"type",void 0);Xr=n([R("text-overlay")],Xr);let pt=class extends P{constructor(){super(...arguments),this.isCompactTile=!1,this.isListTile=!1,this.loggedIn=!1,this.suppressBlurring=!1,this.viewSize="desktop"}render(){var e;return!((e=this.model)===null||e===void 0)&&e.identifier?h`
    ...
    `}};n([c({type:String})],pt.prototype,"baseImageUrl",void 0);n([c({type:Boolean})],pt.prototype,"isCompactTile",void 0);n([c({type:Boolean})],pt.prototype,"isListTile",void 0);n([c({type:Boolean})],pt.prototype,"loggedIn",void 0);n([c({type:Boolean})],pt.prototype,"suppressBlurring",void 0);n([c({type:Object})],pt.prototype,"model",void 0);n([c({type:String})],pt.prototype,"viewSize",void 0);pt=n([R("image-block")],pt);let Zr=class extends ce{constructor(){super(...arguments),this.showInfoButton=!1}render(){return h`
      <div class="container">
...
fill=""></path>
  ...
  `;ss=n([R("ia-icon-label")],ss);let as=class extends P{constructor(){super(...arguments),this.numResults=0}render(){return h`
    ...
    `}};n([c({type:Number})],as.prototype,"numResults",void 0);as=n([R("alpha-bar-tooltip")],as);let ut=class extends P{constructor(){super(...arguments),this.selectedLetter=null,this.tooltipShown=!1,this.alphabet="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("")}get selectedUppercaseLetter(){var e;return(e=this.selectedLetter)===null||e===void 0?void 0:e.toUpperCase()}render(){var e;return h`
  ...
  `;n([c({type:String})],ut.prototype,"selectedLetter",void 0);n([c({type:Object})],ut.prototype,"letterCounts",void 0);n([c({type:String})],ut.prototype,"ariaLandmarkLabel",void 0);n([F()],ut.prototype,"tooltipShown",void 0);n([F()],ut.prototype,"hoveredLetter",void 0);n([H("alpha-bar-tooltip")],ut.prototype,"tooltip",void 0);ut=n([R("alpha-bar")],ut);const Oc=h`
...
`;let Ro=class extends P{constructor(){super(...arguments),this.items=[]}render(){return h`
    ...
    `}};n([c({type:Object})],Ro.prototype,"items",void 0);n([c({type:String})],Ro.prototype,"message",void 0);Ro=n([R("remove-items-modal-content")],Ro);let st=class extends P{constructor(){super(...arguments),this.label=k("Select items to remove"),this.selectedItems=[],this.showSelectAll=!1,this.showUnselectAll=!1,this.showItemManageButton=!1,this.removeAllowed=!1}render(){return h`
...
`;var cs;let Ji=cs=class extends P{render(){return h`${this.facetRowTemplate}`}get facetRowTemplate(){var e,t,i,o;const{bucket:s,facetType:a}=this;if(!s||!a)return b;const l=`${a}:${s.key}-show-only`,d=`${a}:${s.key}-negative`,u=s.extraNote?h`<span class="facet-note">${s.extraNote}</span>`:b,p=a!=="collection"?h`${(e=s.displayText)!==null&&e!==void 0?e:s.key} ${u}`:h`<a href="/details/${s.key}">
    ...
    `}get loaderTemplate(){return h`<div class="facets-loader">
      ...
      ${this.facetsLoading?this.loaderTemplate:h`
          ...
          `}
    `}applySearchFacetsClicked(){var e,t;const i=zn(this.selectedFacets,this.unappliedFacetChanges),o=new CustomEvent("facetsChanged",{detail:i,bubbles:!0,composed:!0});this.dispatchEvent(o),this.unappliedFacetChanges=ct(),(e=this.modalManager)===null||e===void 0||e.closeModal(),(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:rt.default,action:`${te.applyMoreFacetsModal}`,label:`${this.facetKey}`})}cancelClick(){var e,t;this.unappliedFacetChanges=ct(),(e=this.modalManager)===null||e===void 0||e.closeModal(),(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:rt.default,action:te.closeMoreFacetsModal,label:`${this.facetKey}`})}static get styles(){const e=f`var(--primaryButtonBGColor, #194880)`;return[ft,f`
        section#more-facets {
          overflow: auto;
