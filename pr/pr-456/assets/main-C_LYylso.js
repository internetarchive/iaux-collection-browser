...
`;var it;let De=it=class extends P{constructor(){super(...arguments),this.placeholderType=null,this.detailMessage=""}render(){return this.placeholderType?h`${this.placeholderTemplate}`:b}get placeholderTemplate(){return h`
    ...
    `}};De.MESSAGE_EMPTY_QUERY=E('To begin searching, enter a search term in the box above and hit "Go".');De.MESSAGE_NO_SEARCH_RESULTS=E("Your search did not match any items in the Archive. Try different keywords or a more general search.");De.MESSAGE_NO_COLLECTION_RESULTS=E("Your search did not match any items in this collection. Try different keywords or a more general search.");De.MESSAGE_NO_VIEWABLE_MEMBERS=E("This collection contains no viewable items.");De.MESSAGE_QUERY_ERROR=E(h`The search engine encountered an error, which might be related to your
      ...
      <a href="mailto:info@archive.org">info@archive.org</a>.`);De.QUERY_ERROR_DETAILS_MESSAGE=E("Error details:");n([c({type:String})],De.prototype,"placeholderType",void 0);n([c({type:Boolean})],De.prototype,"isMobileView",void 0);n([c({type:Boolean})],De.prototype,"isCollection",void 0);n([c({type:String})],De.prototype,"detailMessage",void 0);De=it=n([R("empty-placeholder")],De);const Ee=r=>r??ee,Pn=N`
...
`;var Qr;(function(r){r[r.bytes=0]="bytes",r[r.kilobytes=1]="kilobytes",r[r.megabytes=2]="megabytes",r[r.gigabytes=3]="gigabytes",r[r.terabytes=4]="terabytes",r[r.petabytes=5]="petabytes",r[r.exabytes=6]="exabytes",r[r.zettabytes=7]="zettabytes",r[r.yottabytes=8]="yottabytes"})(Qr||(Qr={}));function Rd(r,e,t=" "){let i=r;if(i===void 0)return b;let o=0;for(;i>1024;)i/=1024,o+=1;const s=10**e;i=Math.round(i*s)/s;let a=Qr[o];return a=i===1?a.slice(0,-1):a,`${i.toLocaleString()+t+a}`}const Od=f`var(--tileBackgroundColor, #ffffff)`,Id=f`var(--tileCornerRadius, 4px)`,Go=f`
...
`+Te),Gt&&po([Ze,Je,K],tt=>{Te=Ai(Te,tt," ")}),O&&oo?O.createHTML(Te):Te},e.setConfig=function(){let z=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};or(z),Xo=!0},e.clearConfig=function(){Zt=null,Xo=!1},e.isValidAttribute=function(z,g,$){Zt||or({});const L=fe(z),J=fe(g);return qs(L,J,$)},e.addHook=function(z,g){typeof g=="function"&&Mi(Q[z],g)},e.removeHook=function(z,g){if(g!==void 0){const $=bc(Q[z],g);return $===-1?void 0:yc(Q[z],$,1)[0]}return Aa(Q[z])},e.removeHooks=function(z){Q[z]=[]},e.removeAllHooks=function(){Q=Ra()},e}var wo=Wn();let Po=class extends ce{constructor(){super(...arguments),this.collectionLinks=[]}render(){return h`
    ...
    `}};Oa=n([R("tile-list-compact")],Oa);let Ia=class extends ce{render(){return h`
...
fill=""></path>
  ...
  `;n([c({type:String})],pt.prototype,"selectedLetter",void 0);n([c({type:Object})],pt.prototype,"letterCounts",void 0);n([c({type:String})],pt.prototype,"ariaLandmarkLabel",void 0);n([F()],pt.prototype,"tooltipShown",void 0);n([F()],pt.prototype,"hoveredLetter",void 0);n([H("alpha-bar-tooltip")],pt.prototype,"tooltip",void 0);pt=n([R("alpha-bar")],pt);const Ic=h`
...
`;function X0(r){return r&&r.charAt(0).toLocaleUpperCase()+r.slice(1)}let eo=class extends P{constructor(){super(...arguments),this.selected=!1}render(){var e,t;if(!this.facetInfo)return b;const i=this.facetInfo.facets.length===1,o=this.facetInfo.facets[0],s=X0((this.labelPrefix?`${this.labelPrefix} `:"")+((t=(e=this.facetInfo.label)!==null&&e!==void 0?e:o.displayText)!==null&&t!==void 0?t:o.bucketKey));if(!s)return b;const a=i&&o.facetType==="mediatype"?In[o.bucketKey].icon:b;return h`
      <a
    ...
    `}get facetsTemplate(){if(qr.includes(this.profileElement))return b;if(this.facetLoadStrategy==="off")return h`
      ...
      `;const e=this.isTVCollection||!this.withinCollection&&this.searchType===I.TV,t=e?_d:Mn,i=h`
      <collection-facets
        .collectionPagePath=${this.collectionPagePath}
