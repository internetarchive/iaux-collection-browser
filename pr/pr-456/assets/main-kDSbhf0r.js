(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const a of s.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function t(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(o){if(o.ep)return;o.ep=!0;const s=t(o);fetch(o.href,s)}})();function n(r,e,t,i){var o=arguments.length,s=o<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")s=Reflect.decorate(r,e,t,i);else for(var l=r.length-1;l>=0;l--)(a=r[l])&&(s=(o<3?a(s):o>3?a(e,t,s):a(e,t))||s);return o>3&&s&&Object.defineProperty(e,t,s),s}function Ks(r,e,t,i){function o(s){return s instanceof t?s:new t(function(a){a(s)})}return new(t||(t=Promise))(function(s,a){function l(p){try{u(i.next(p))}catch(m){a(m)}}function d(p){try{u(i.throw(p))}catch(m){a(m)}}function u(p){p.done?s(p.value):o(p.value).then(l,d)}u((i=i.apply(r,e||[])).next())})}class ll{constructor(e){var t,i,o,s;this.ARCHIVE_ANALYTICS_VERSION=2,this.DEFAULT_SERVICE="ao_2",this.NO_SAMPLING_SERVICE="ao_no_sampling",this.DEFAULT_IMAGE_URL="https://athena.archive.org/0.gif",this.defaultService=(t=e?.defaultService)!==null&&t!==void 0?t:this.DEFAULT_SERVICE,this.imageUrl=(i=e?.imageUrl)!==null&&i!==void 0?i:this.DEFAULT_IMAGE_URL,this.imageContainer=(o=e?.imageContainer)!==null&&o!==void 0?o:document.body,this.requireImagePing=(s=e?.requireImagePing)!==null&&s!==void 0?s:!1}sendPing(e){const t=this.generateTrackingUrl(e).toString();if(this.requireImagePing){this.sendPingViaImage(t);return}const i=navigator.sendBeacon&&navigator.sendBeacon.bind(navigator);try{i(t)}catch{this.sendPingViaImage(t)}}sendEvent(e){const t=e.label&&e.label.trim().length>0?e.label:window.location.pathname,i={kind:"event",ec:e.category,ea:e.action,el:t,cache_bust:Math.random(),...e.eventConfiguration};this.sendPing(i)}sendEventNoSampling(e){const t=e.eventConfiguration||{};t.service=this.NO_SAMPLING_SERVICE;const i=e;i.eventConfiguration=t,this.sendEvent(i)}sendPingViaImage(e){const t=new Image(1,1);t.src=e,t.alt="",this.imageContainer.appendChild(t)}generateTrackingUrl(e){var t;const i=e??{};i.service=(t=i.service)!==null&&t!==void 0?t:this.defaultService;const o=new URL(this.imageUrl),s=Object.keys(i);return s.forEach(a=>{const l=i[a];o.searchParams.append(a,l)}),o.searchParams.append("version",`${this.ARCHIVE_ANALYTICS_VERSION}`),o.searchParams.append("count",`${s.length+2}`),o}}function w(r){let e,t,i;return typeof r=="object"?(e=r.hashFunction,t=r.expiring,i=r.tags):e=r,(o,s,a)=>{if(a.value!=null)a.value=Xs(a.value,e,t,i);else if(a.get!=null)a.get=Xs(a.get,e,t,i);else throw"Only put a Memoize() decorator on a method or get accessor."}}const sr=new Map;function Xs(r,e,t=0,i){const o=Symbol("__memoized_map__");return function(...s){let a;this.hasOwnProperty(o)||Object.defineProperty(this,o,{configurable:!1,enumerable:!1,writable:!1,value:new Map});let l=this[o];if(Array.isArray(i))for(const d of i)sr.has(d)?sr.get(d).push(l):sr.set(d,[l]);if(e||s.length>0||t>0){let d;e===!0?d=s.map(m=>m.toString()).join("!"):e?d=e.apply(this,s):d=s[0];const u=`${d}__timestamp`;let p=!1;if(t>0)if(!l.has(u))p=!0;else{let m=l.get(u);p=Date.now()-m>t}l.has(d)&&!p?a=l.get(d):(a=r.apply(this,s),l.set(d,a),t>0&&l.set(u,Date.now()))}else{const d=this;l.has(d)?a=l.get(d):(a=r.apply(this,s),l.set(d,a))}return a}}class Pr{parseValue(e){return typeof e=="string"&&(e==="false"||e==="0")?!1:!!e}}Pr.shared=new Pr;class lt{parseValue(e){if(typeof e=="number")return e;if(typeof e=="boolean")return;const t=parseFloat(e);if(!Number.isNaN(t))return t}}lt.shared=new lt;class _o{parseValue(e){return lt.shared.parseValue(e)}}_o.shared=new _o;class qi{parseValue(e){return this.parseJSDate(e)||this.parseBracketDate(e)}parseBracketDate(e){if(typeof e!="string")return;const t=e.match(/\[([0-9]{4})\]/);if(!(!t||t.length<2))return this.parseJSDate(t[1])}parseJSDate(e){if(typeof e!="string")return;let t=e;t.match(/^[0-9]{4}-[0-9]{2}-[0-9]{2}\s{1}[0-9]{2}:[0-9]{2}:[0-9]{2}$/)&&(t=t.replace(" ","T"));const i=Date.parse(t);if(Number.isNaN(i))return;let o=new Date(t);return(t.match(/^[0-9]{4}$/)||t.match(/^[0-9]{4}-[0-9]{2}-[0-9]{2}$/))&&(o=new Date(o.getTime()+o.getTimezoneOffset()*1e3*60)),o}}qi.shared=new qi;class Co{parseValue(e){if(typeof e=="number")return e;if(typeof e=="boolean")return;const t=e.split(":");let i;return t.length===1?i=this.parseNumberFormat(t[0]):i=this.parseColonSeparatedFormat(t),i}parseNumberFormat(e){let t=parseFloat(e);return Number.isNaN(t)&&(t=void 0),t}parseColonSeparatedFormat(e){let t=!1;const i=e.map((o,s)=>{const a=parseFloat(o);if(Number.isNaN(a))return t=!0,0;const d=60**(e.length-1-s);return a*Math.floor(d)}).reduce((o,s)=>o+s,0);return t?void 0:i}}Co.shared=new Co;class Rr{parseValue(e){if(typeof e=="string")return e}}Rr.shared=new Rr;class dl{constructor(e,t){this.separators=[";",","],this.parser=e,t&&t.separators&&(this.separators=t.separators)}parseValue(e){const t=String(e);let i=[];for(const o of this.separators)if(i=t.split(o),i.length>1)break;return this.parseListValues(i)}parseListValues(e){const i=e.map(s=>s.trim()).map(s=>this.parser.parseValue(s)),o=[];return i.forEach(s=>{s!==void 0&&o.push(s)}),o}}class Ir{parseValue(e){if(typeof e=="string")return e}}Ir.shared=new Ir;class ko{parseValue(e){return String(e)}}ko.shared=new ko;class vi{get name(){return this.rawValue.name}get source(){return this.rawValue.source}get btih(){return this.rawValue.btih}get md5(){return this.rawValue.md5}get format(){return this.rawValue.format}get mtime(){if(this.rawValue.mtime==null)return;const e=lt.shared.parseValue(this.rawValue.mtime);if(e)return new Date(e*1e3)}get crc32(){return this.rawValue.crc32}get sha1(){return this.rawValue.sha1}get original(){return this.rawValue.original}get size(){return this.rawValue.size!=null?_o.shared.parseValue(this.rawValue.size):void 0}get title(){return this.rawValue.title}get length(){return this.rawValue.length!=null?Co.shared.parseValue(this.rawValue.length):void 0}get height(){return this.rawValue.height!=null?lt.shared.parseValue(this.rawValue.height):void 0}get width(){return this.rawValue.width!=null?lt.shared.parseValue(this.rawValue.width):void 0}get track(){return this.rawValue.track!=null?lt.shared.parseValue(this.rawValue.track):void 0}get external_identifier(){return this.rawValue.external_identifier}get creator(){return this.rawValue.creator}get album(){return this.rawValue.album}constructor(e={}){this.rawValue=e}}n([w()],vi.prototype,"mtime",null);n([w()],vi.prototype,"size",null);n([w()],vi.prototype,"length",null);n([w()],vi.prototype,"height",null);n([w()],vi.prototype,"width",null);n([w()],vi.prototype,"track",null);class Ke{get values(){return this.parseRawValue()}get value(){return this.values[0]}constructor(e,t){this.parser=e,this.rawValue=t}parseRawValue(){const e=Array.isArray(this.rawValue)?this.rawValue:[this.rawValue],t=[];return e.forEach(i=>{const o=this.parser.parseValue(i);Array.isArray(o)?t.push(...o):o!==void 0&&t.push(o)}),t}}n([w()],Ke.prototype,"values",null);n([w()],Ke.prototype,"value",null);class Bt extends Ke{constructor(e){super(Pr.shared,e)}}class Pe extends Ke{constructor(e){super(qi.shared,e)}}class ar extends Ke{constructor(e){super(Co.shared,e)}}class me extends Ke{constructor(e){super(lt.shared,e)}}class B extends Ke{constructor(e){super(ko.shared,e)}}class cl extends Ke{constructor(e){super(Ir.shared,e)}}class Zs extends Ke{constructor(e){super(_o.shared,e)}}class an extends Ke{constructor(e){super(Rr.shared,e)}}class hl extends Ke{constructor(e,t){super(t,e)}}class pl extends hl{constructor(e){const t=new dl(ko.shared);super(e,t)}}class k{get identifier(){return this.rawMetadata.identifier}get addeddate(){return this.rawMetadata.addeddate!=null?new Pe(this.rawMetadata.addeddate):void 0}get audio_codec(){return this.rawMetadata.audio_codec!=null?new B(this.rawMetadata.audio_codec):void 0}get audio_sample_rate(){return this.rawMetadata.audio_sample_rate!=null?new me(this.rawMetadata.audio_sample_rate):void 0}get avg_rating(){return this.rawMetadata.avg_rating!=null?new me(this.rawMetadata.avg_rating):void 0}get collection(){return this.rawMetadata.collection!=null?new B(this.rawMetadata.collection):void 0}get collections_raw(){return this.rawMetadata.collections_raw!=null?new B(this.rawMetadata.collections_raw):void 0}get collection_size(){return this.rawMetadata.collection_size!=null?new Zs(this.rawMetadata.collection_size):void 0}get contact(){return this.rawMetadata.contact!=null?new B(this.rawMetadata.contact):void 0}get contributor(){return this.rawMetadata.contributor!=null?new B(this.rawMetadata.contributor):void 0}get coverage(){return this.rawMetadata.coverage!=null?new B(this.rawMetadata.coverage):void 0}get creator(){return this.rawMetadata.creator!=null?new B(this.rawMetadata.creator):void 0}get creator_alt_script(){return this.rawMetadata["creator-alt-script"]!=null?new B(this.rawMetadata["creator-alt-script"]):void 0}get credits(){return this.rawMetadata.credits!=null?new B(this.rawMetadata.credits):void 0}get collection_layout(){return this.rawMetadata.collection_layout!=null?new B(this.rawMetadata.collection_layout):void 0}get date(){return this.rawMetadata.date!=null?new Pe(this.rawMetadata.date):void 0}get description(){return this.rawMetadata.description!=null?new B(this.rawMetadata.description):void 0}get downloads(){return this.rawMetadata.downloads!=null?new me(this.rawMetadata.downloads):void 0}get duration(){return this.rawMetadata.duration!=null?new ar(this.rawMetadata.duration):void 0}get external_identifier(){return this.rawMetadata["external-identifier"]!=null?new B(this.rawMetadata["external-identifier"]):void 0}get external_link(){return this.rawMetadata["external-link"]!=null?new B(this.rawMetadata["external-link"]):void 0}get files_count(){return this.rawMetadata.files_count!=null?new me(this.rawMetadata.files_count):void 0}get indexdate(){return this.rawMetadata.indexdate!=null?new Pe(this.rawMetadata.indexdate):void 0}get isbn(){return this.rawMetadata.isbn!=null?new B(this.rawMetadata.isbn):void 0}get issue(){return this.rawMetadata.issue!=null?new B(this.rawMetadata.issue):void 0}get item_count(){return this.rawMetadata.item_count!=null?new me(this.rawMetadata.item_count):void 0}get item_size(){return this.rawMetadata.item_size!=null?new Zs(this.rawMetadata.item_size):void 0}get language(){return this.rawMetadata.language!=null?new B(this.rawMetadata.language):void 0}get length(){return this.rawMetadata.length!=null?new ar(this.rawMetadata.length):void 0}get licenseurl(){return this.rawMetadata.licenseurl!=null?new B(this.rawMetadata.licenseurl):void 0}get lineage(){return this.rawMetadata.lineage!=null?new B(this.rawMetadata.lineage):void 0}get month(){return this.rawMetadata.month!=null?new me(this.rawMetadata.month):void 0}get mediatype(){return this.rawMetadata.mediatype!=null?new an(this.rawMetadata.mediatype):void 0}get noindex(){return this.rawMetadata.noindex!=null?new Bt(this.rawMetadata.noindex):void 0}get notes(){return this.rawMetadata.notes!=null?new B(this.rawMetadata.notes):void 0}get num_favorites(){return this.rawMetadata.num_favorites!=null?new me(this.rawMetadata.num_favorites):void 0}get num_reviews(){return this.rawMetadata.num_reviews!=null?new me(this.rawMetadata.num_reviews):void 0}get openlibrary_edition(){return this.rawMetadata.openlibrary_edition!=null?new B(this.rawMetadata.openlibrary_edition):void 0}get openlibrary_work(){return this.rawMetadata.openlibrary_work!=null?new B(this.rawMetadata.openlibrary_work):void 0}get page_progression(){return this.rawMetadata.page_progression!=null?new cl(this.rawMetadata.page_progression):void 0}get paginated(){return this.rawMetadata.paginated!=null?new Bt(this.rawMetadata.paginated):void 0}get partner(){return this.rawMetadata.partner!=null?new B(this.rawMetadata.partner):void 0}get post_text(){return this.rawMetadata.post_text!=null?new B(this.rawMetadata.post_text):void 0}get ppi(){return this.rawMetadata.ppi!=null?new me(this.rawMetadata.ppi):void 0}get publicdate(){return this.rawMetadata.publicdate!=null?new Pe(this.rawMetadata.publicdate):void 0}get publisher(){return this.rawMetadata.publisher!=null?new B(this.rawMetadata.publisher):void 0}get reviewdate(){return this.rawMetadata.reviewdate!=null?new Pe(this.rawMetadata.reviewdate):void 0}get rights(){return this.rawMetadata.rights!=null?new B(this.rawMetadata.rights):void 0}get rights_holder(){var e;const t=(e=this.rawMetadata["rights-holder"])!==null&&e!==void 0?e:this.rawMetadata.rights_holder;return t!=null?new B(t):void 0}get runtime(){return this.rawMetadata.runtime!=null?new ar(this.rawMetadata.runtime):void 0}get scanner(){return this.rawMetadata.scanner!=null?new B(this.rawMetadata.scanner):void 0}get segments(){return this.rawMetadata.segments!=null?new B(this.rawMetadata.segments):void 0}get shotlist(){return this.rawMetadata.shotlist!=null?new B(this.rawMetadata.shotlist):void 0}get source(){return this.rawMetadata.source!=null?new B(this.rawMetadata.source):void 0}get sponsor(){return this.rawMetadata.sponsor!=null?new B(this.rawMetadata.sponsor):void 0}get start_localtime(){return this.rawMetadata.start_localtime!=null?new Pe(this.rawMetadata.start_localtime):void 0}get start_time(){return this.rawMetadata.start_time!=null?new Pe(this.rawMetadata.start_time):void 0}get stop_time(){return this.rawMetadata.stop_time!=null?new Pe(this.rawMetadata.stop_time):void 0}get subject(){return this.rawMetadata.subject!=null?new pl(this.rawMetadata.subject):void 0}get taper(){return this.rawMetadata.taper!=null?new B(this.rawMetadata.taper):void 0}get title(){return this.rawMetadata.title!=null?new B(this.rawMetadata.title):void 0}get title_alt_script(){return this.rawMetadata["title-alt-script"]!=null?new B(this.rawMetadata["title-alt-script"]):void 0}get transferer(){return this.rawMetadata.transferer!=null?new B(this.rawMetadata.transferer):void 0}get track(){return this.rawMetadata.track!=null?new me(this.rawMetadata.track):void 0}get type(){return this.rawMetadata.type!=null?new B(this.rawMetadata.type):void 0}get uploader(){return this.rawMetadata.uploader!=null?new B(this.rawMetadata.uploader):void 0}get utc_offset(){return this.rawMetadata.utc_offset!=null?new me(this.rawMetadata.utc_offset):void 0}get venue(){return this.rawMetadata.venue!=null?new B(this.rawMetadata.venue):void 0}get volume(){return this.rawMetadata.volume!=null?new B(this.rawMetadata.volume):void 0}get week(){return this.rawMetadata.week!=null?new me(this.rawMetadata.week):void 0}get year(){return this.rawMetadata.year!=null?new me(this.rawMetadata.year):void 0}constructor(e={}){this.rawMetadata=e}}n([w()],k.prototype,"addeddate",null);n([w()],k.prototype,"audio_codec",null);n([w()],k.prototype,"audio_sample_rate",null);n([w()],k.prototype,"avg_rating",null);n([w()],k.prototype,"collection",null);n([w()],k.prototype,"collections_raw",null);n([w()],k.prototype,"collection_size",null);n([w()],k.prototype,"contact",null);n([w()],k.prototype,"contributor",null);n([w()],k.prototype,"coverage",null);n([w()],k.prototype,"creator",null);n([w()],k.prototype,"creator_alt_script",null);n([w()],k.prototype,"credits",null);n([w()],k.prototype,"collection_layout",null);n([w()],k.prototype,"date",null);n([w()],k.prototype,"description",null);n([w()],k.prototype,"downloads",null);n([w()],k.prototype,"duration",null);n([w()],k.prototype,"external_identifier",null);n([w()],k.prototype,"external_link",null);n([w()],k.prototype,"files_count",null);n([w()],k.prototype,"indexdate",null);n([w()],k.prototype,"isbn",null);n([w()],k.prototype,"issue",null);n([w()],k.prototype,"item_count",null);n([w()],k.prototype,"item_size",null);n([w()],k.prototype,"language",null);n([w()],k.prototype,"length",null);n([w()],k.prototype,"licenseurl",null);n([w()],k.prototype,"lineage",null);n([w()],k.prototype,"month",null);n([w()],k.prototype,"mediatype",null);n([w()],k.prototype,"noindex",null);n([w()],k.prototype,"notes",null);n([w()],k.prototype,"num_favorites",null);n([w()],k.prototype,"num_reviews",null);n([w()],k.prototype,"openlibrary_edition",null);n([w()],k.prototype,"openlibrary_work",null);n([w()],k.prototype,"page_progression",null);n([w()],k.prototype,"paginated",null);n([w()],k.prototype,"partner",null);n([w()],k.prototype,"post_text",null);n([w()],k.prototype,"ppi",null);n([w()],k.prototype,"publicdate",null);n([w()],k.prototype,"publisher",null);n([w()],k.prototype,"reviewdate",null);n([w()],k.prototype,"rights",null);n([w()],k.prototype,"rights_holder",null);n([w()],k.prototype,"runtime",null);n([w()],k.prototype,"scanner",null);n([w()],k.prototype,"segments",null);n([w()],k.prototype,"shotlist",null);n([w()],k.prototype,"source",null);n([w()],k.prototype,"sponsor",null);n([w()],k.prototype,"start_localtime",null);n([w()],k.prototype,"start_time",null);n([w()],k.prototype,"stop_time",null);n([w()],k.prototype,"subject",null);n([w()],k.prototype,"taper",null);n([w()],k.prototype,"title",null);n([w()],k.prototype,"title_alt_script",null);n([w()],k.prototype,"transferer",null);n([w()],k.prototype,"track",null);n([w()],k.prototype,"type",null);n([w()],k.prototype,"uploader",null);n([w()],k.prototype,"utc_offset",null);n([w()],k.prototype,"venue",null);n([w()],k.prototype,"volume",null);n([w()],k.prototype,"week",null);n([w()],k.prototype,"year",null);class Vo{get reviewbody(){return this.rawValue.reviewbody}get reviewtitle(){return this.rawValue.reviewtitle}get reviewer(){return this.rawValue.reviewer}get reviewer_itemname(){return this.rawValue.reviewer_itemname}get reviewdate(){return this.rawValue.reviewdate!=null?qi.shared.parseValue(this.rawValue.reviewdate):void 0}get createdate(){return this.rawValue.createdate!=null?qi.shared.parseValue(this.rawValue.createdate):void 0}get stars(){return this.rawValue.stars!=null?lt.shared.parseValue(this.rawValue.stars):void 0}constructor(e={}){this.rawValue=e}}n([w()],Vo.prototype,"reviewdate",null);n([w()],Vo.prototype,"createdate",null);n([w()],Vo.prototype,"stars",null);class nn extends Vo{get __href__(){return this.rawValue.__href__}}const ul=["loans","waitlist","loan_history"];function fl(r){const e=r.slice(0,4),t=r.slice(4,6),i=r.slice(6,8),o=r.slice(8,10),s=r.slice(10,12),a=r.slice(12,14);return`${e}-${t}-${i}T${o}:${s}:${a}Z`}function ml(r){var e;const t=[];for(const i of r){if(!(!((e=i.captures)===null||e===void 0)&&e.length))continue;const o=encodeURIComponent(i.url),s=`https://web.archive.org/web/${i.captures[0]}/${o}`;t.push({hit_type:"web_archive",fields:{url:i.url,capture_dates:i.captures.map(a=>fl(a)),__href__:s}})}return t}class pe extends k{get created_on(){return this.rawMetadata.created_on!=null?new Pe(this.rawMetadata.created_on):void 0}get file_creation_mtime(){return this.rawMetadata.file_creation_mtime!=null?new me(this.rawMetadata.file_creation_mtime):void 0}get filename(){return this.rawMetadata.filename!=null?new B(this.rawMetadata.filename):void 0}get file_basename(){return this.rawMetadata.file_basename!=null?new B(this.rawMetadata.file_basename):void 0}get result_in_subfile(){return this.rawMetadata.result_in_subfile!=null?new Bt(this.rawMetadata.result_in_subfile):void 0}get query(){return this.rawMetadata.query!=null?new B(this.rawMetadata.query):void 0}get date_favorited(){return this.rawMetadata.date_favorited!=null?new Pe(this.rawMetadata.date_favorited):void 0}get updated_on(){return this.rawMetadata.updated_on!=null?new Pe(this.rawMetadata.updated_on):void 0}get ad_id(){return this.rawMetadata.ad_id!=null?new B(this.rawMetadata.ad_id):void 0}get factcheck(){return this.rawMetadata.factcheck!=null?new B(this.rawMetadata.factcheck):void 0}get is_clip(){return this.rawMetadata.clip!=null?new Bt(this.rawMetadata.clip):void 0}get num_clips(){return this.rawMetadata.nclips!=null?new me(this.rawMetadata.nclips):void 0}get __href__(){return this.rawMetadata.__href__!=null?new B(this.rawMetadata.__href__):void 0}get __img__(){return this.rawMetadata.__img__!=null?new B(this.rawMetadata.__img__):void 0}}n([w()],pe.prototype,"created_on",null);n([w()],pe.prototype,"file_creation_mtime",null);n([w()],pe.prototype,"filename",null);n([w()],pe.prototype,"file_basename",null);n([w()],pe.prototype,"result_in_subfile",null);n([w()],pe.prototype,"query",null);n([w()],pe.prototype,"date_favorited",null);n([w()],pe.prototype,"updated_on",null);n([w()],pe.prototype,"ad_id",null);n([w()],pe.prototype,"factcheck",null);n([w()],pe.prototype,"is_clip",null);n([w()],pe.prototype,"num_clips",null);n([w()],pe.prototype,"__href__",null);n([w()],pe.prototype,"__img__",null);class qe{constructor(e){var t;this.rawMetadata=e,this.fields=new pe((t=e.fields)!==null&&t!==void 0?t:{})}get identifier(){return this.fields.identifier}get addeddate(){return this.fields.addeddate}get avg_rating(){return this.fields.avg_rating}get collection(){return this.fields.collection}get collection_files_count(){var e;return((e=this.rawMetadata.fields)===null||e===void 0?void 0:e.collection_files_count)!=null?new me(this.rawMetadata.fields.collection_files_count):void 0}get collection_size(){return this.fields.collection_size}get creator(){return this.fields.creator}get date(){return this.fields.date}get description(){return this.fields.description}get downloads(){return this.fields.downloads}get files_count(){return this.fields.files_count}get genre(){var e;return((e=this.rawMetadata.fields)===null||e===void 0?void 0:e.genre)!=null?new B(this.rawMetadata.fields.genre):void 0}get indexflag(){var e;return((e=this.rawMetadata.fields)===null||e===void 0?void 0:e.indexflag)!=null?new B(this.rawMetadata.fields.indexflag):void 0}get issue(){return this.fields.issue}get item_count(){return this.fields.item_count}get item_size(){return this.fields.item_size}get language(){return this.fields.language}get lending___available_to_borrow(){var e;return((e=this.rawMetadata.fields)===null||e===void 0?void 0:e.lending___available_to_borrow)!=null?new Bt(this.rawMetadata.fields.lending___available_to_borrow):void 0}get lending___available_to_browse(){var e;return((e=this.rawMetadata.fields)===null||e===void 0?void 0:e.lending___available_to_browse)!=null?new Bt(this.rawMetadata.fields.lending___available_to_browse):void 0}get lending___available_to_waitlist(){var e;return((e=this.rawMetadata.fields)===null||e===void 0?void 0:e.lending___available_to_waitlist)!=null?new Bt(this.rawMetadata.fields.lending___available_to_waitlist):void 0}get lending___status(){var e;return((e=this.rawMetadata.fields)===null||e===void 0?void 0:e.lending___status)!=null?new B(this.rawMetadata.fields.lending___status):void 0}get licenseurl(){var e;return((e=this.rawMetadata.fields)===null||e===void 0?void 0:e.licenseurl)!=null?new B(this.rawMetadata.fields.licenseurl):void 0}get mediatype(){return this.fields.mediatype}get month(){return this.fields.month}get noindex(){return this.fields.noindex}get num_favorites(){return this.fields.num_favorites}get num_reviews(){return this.fields.num_reviews}get publicdate(){return this.fields.publicdate}get reviewdate(){return this.fields.reviewdate}get review(){const e=this.rawMetadata.review;return e?new nn(e):void 0}get source(){return this.fields.source}get subject(){return this.fields.subject}get title(){return this.fields.title}get type(){return this.fields.type}get volume(){return this.fields.volume}get week(){return this.fields.week}get year(){return this.fields.year}}n([w()],qe.prototype,"collection_files_count",null);n([w()],qe.prototype,"genre",null);n([w()],qe.prototype,"indexflag",null);n([w()],qe.prototype,"lending___available_to_borrow",null);n([w()],qe.prototype,"lending___available_to_browse",null);n([w()],qe.prototype,"lending___available_to_waitlist",null);n([w()],qe.prototype,"lending___status",null);n([w()],qe.prototype,"licenseurl",null);n([w()],qe.prototype,"review",null);class ps{constructor(e){var t;this.rawMetadata=e,this.fields=new pe((t=e.fields)!==null&&t!==void 0?t:{})}get identifier(){return this.fields.identifier}get highlight(){var e;return!((e=this.rawMetadata.highlight)===null||e===void 0)&&e.text?new B(this.rawMetadata.highlight.text):void 0}get addeddate(){return this.fields.addeddate}get avg_rating(){return this.fields.avg_rating}get collection(){return this.fields.collection}get created_on(){return this.fields.created_on}get creator(){return this.fields.creator}get date(){return this.fields.date}get description(){return this.fields.description}get downloads(){return this.fields.downloads}get filename(){return this.fields.filename}get file_basename(){return this.fields.file_basename}get file_creation_mtime(){return this.fields.file_creation_mtime}get issue(){return this.fields.issue}get mediatype(){return this.fields.mediatype}get page_num(){var e;return((e=this.rawMetadata.fields)===null||e===void 0?void 0:e.page_num)!=null?new me(this.rawMetadata.fields.page_num):void 0}get publicdate(){return this.fields.publicdate}get result_in_subfile(){return this.fields.result_in_subfile}get reviewdate(){return this.fields.reviewdate}get source(){return this.fields.source}get subject(){return this.fields.subject}get title(){return this.fields.title}get updated_on(){return this.fields.updated_on}get year(){return this.fields.year}get __href__(){return this.fields.__href__}}n([w()],ps.prototype,"highlight",null);n([w()],ps.prototype,"page_num",null);var j;(function(r){r[r.COUNT=0]="COUNT",r[r.ALPHABETICAL=1]="ALPHABETICAL",r[r.NUMERIC=2]="NUMERIC"})(j||(j={}));class ln{constructor(e){this.buckets=e.buckets,this.first_bucket_key=e.first_bucket_key,this.last_bucket_key=e.last_bucket_key,this.number_buckets=e.number_buckets,this.interval=e.interval,this.first_bucket_year=e.first_bucket_year,this.first_bucket_month=e.first_bucket_month,this.last_bucket_year=e.last_bucket_year,this.last_bucket_month=e.last_bucket_month,this.interval_in_months=e.interval_in_months}getSortedBuckets(e){const t=[...this.buckets];if(this.isRawNumberBuckets(t))return t;const i=new Intl.Collator;switch(e){case j.ALPHABETICAL:return t.sort((o,s)=>i.compare(o.key.toString(),s.key.toString()));case j.NUMERIC:return t.sort((o,s)=>Number(s.key)-Number(o.key));case j.COUNT:default:return t}}isRawNumberBuckets(e){return typeof e[0]=="number"}}n([w()],ln.prototype,"getSortedBuckets",null);class vl{constructor(e){var t;this.rawMetadata=e,this.fields=new pe((t=e.fields)!==null&&t!==void 0?t:{})}get identifier(){var e;return(e=this.fields.query)===null||e===void 0?void 0:e.value}get title(){return this.fields.title}get query(){return this.fields.query}get date_favorited(){return this.fields.date_favorited}get __href__(){return this.fields.__href__}}class us{constructor(e){var t;this.rawMetadata=e,this.fields=new pe((t=e.fields)!==null&&t!==void 0?t:{})}get identifier(){var e;return(e=this.rawMetadata.fields)===null||e===void 0?void 0:e.url}get mediatype(){return new an("web")}get title(){var e,t;return!((e=this.rawMetadata.fields)===null||e===void 0)&&e.url?new B((t=this.rawMetadata.fields)===null||t===void 0?void 0:t.url):void 0}get capture_dates(){var e,t;return!((e=this.rawMetadata.fields)===null||e===void 0)&&e.capture_dates?new Pe((t=this.rawMetadata.fields)===null||t===void 0?void 0:t.capture_dates):void 0}get __href__(){return this.fields.__href__}}n([w()],us.prototype,"title",null);n([w()],us.prototype,"capture_dates",null);class fs{constructor(e){var t;this.rawMetadata=e,this.fields=new pe((t=e.fields)!==null&&t!==void 0?t:{})}get identifier(){return this.fields.identifier}get highlight(){var e;return!((e=this.rawMetadata.highlight)===null||e===void 0)&&e.text?new B(this.rawMetadata.highlight.text):void 0}get addeddate(){return this.fields.addeddate}get ad_id(){return this.fields.ad_id}get avg_rating(){return this.fields.avg_rating}get collection(){return this.fields.collection}get created_on(){return this.fields.created_on}get creator(){return this.fields.creator}get date(){return this.fields.date}get description(){return this.fields.description}get downloads(){return this.fields.downloads}get factcheck(){return this.fields.factcheck}get filename(){return this.fields.filename}get file_basename(){return this.fields.file_basename}get file_creation_mtime(){return this.fields.file_creation_mtime}get files_count(){return this.fields.files_count}get is_clip(){return this.fields.is_clip}get issue(){return this.fields.issue}get item_count(){return this.fields.item_count}get item_size(){return this.fields.item_size}get language(){return this.fields.language}get mediatype(){return this.fields.mediatype}get num_clips(){return this.fields.num_clips}get num_favorites(){return this.fields.num_favorites}get publicdate(){return this.fields.publicdate}get result_in_subfile(){return this.fields.result_in_subfile}get reviewdate(){return this.fields.reviewdate}get source(){return this.fields.source}get subject(){return this.fields.subject}get title(){return this.fields.title}get updated_on(){return this.fields.updated_on}get week(){return this.fields.week}get year(){return this.fields.year}get start(){var e;return((e=this.rawMetadata.fields)===null||e===void 0?void 0:e.start)!=null?new B(this.rawMetadata.fields.start):void 0}get __href__(){return this.fields.__href__}get __img__(){return this.fields.__img__}}n([w()],fs.prototype,"highlight",null);n([w()],fs.prototype,"start",null);class ms{constructor(e){this.rawResponse=e}get item_size(){return this.rawResponse.item_size}get files_count(){return this.rawResponse.files_count}get month(){return this.rawResponse.month}get week(){return this.rawResponse.week}get downloads(){return this.rawResponse.downloads}get num_favorites(){return this.rawResponse.num_favorites}get title_message(){return this.rawResponse.title_message}get primary_collection(){return this.rawResponse.primary_collection}get thumbnail_url(){return this.rawResponse.thumbnail_url}get review_count(){return this.rawResponse.review_count}get uploader_details(){return this.rawResponse.uploader_details}get public_metadata(){if(this.rawResponse.public_metadata)return new k(this.rawResponse.public_metadata)}get part_of(){return this.rawResponse.part_of}get reviews_metadata(){var e;return((e=this.rawResponse.reviews_metadata)!==null&&e!==void 0?e:[]).map(i=>new nn(i))}}n([w()],ms.prototype,"public_metadata",null);n([w()],ms.prototype,"reviews_metadata",null);class vs{constructor(e,t){var i,o,s,a,l,d,u,p,m,v,y,S,x,_,D;this.extraInfo=null,this.schema=t,this.schemaHitType=t?.hit_type;let M;e?.page_elements&&(this.pageElements=e.page_elements,M=Object.values(this.pageElements)[0]);let A=(i=e?.hits)===null||i===void 0?void 0:i.hits;this.totalResults=(s=(o=e?.hits)===null||o===void 0?void 0:o.total)!==null&&s!==void 0?s:0,this.returnedCount=(l=(a=e?.hits)===null||a===void 0?void 0:a.returned)!==null&&l!==void 0?l:0,!A?.length&&(!((d=this.pageElements)===null||d===void 0)&&d.service___fts)?(this.totalResults=0,this.returnedCount=0,this.handleFederatedPageElements()):!A?.length&&(!((u=M?.hits)===null||u===void 0)&&u.hits)?(A=M.hits.hits,this.totalResults=(p=M.hits.total)!==null&&p!==void 0?p:0,this.returnedCount=(m=M.hits.returned)!==null&&m!==void 0?m:0):!((v=this.pageElements)===null||v===void 0)&&v.lending?A=this.handleLendingPageElement():!((y=this.pageElements)===null||y===void 0)&&y.web_archives&&(A=this.handleWebArchivesPageElement()),this.results=this.formatHits(A);let I=e?.aggregations;!(this.aggregations&&Object.keys(this.aggregations).length>0)&&M?.aggregations&&(I=M.aggregations),I&&this.buildAggregations(I),e?.collection_titles&&(this.collectionTitles=(S=e.collection_titles)!==null&&S!==void 0?S:{}),e?.tv_channel_aliases&&(this.tvChannelAliases=(x=e.tv_channel_aliases)!==null&&x!==void 0?x:{}),e?.collection_extra_info&&(this.collectionExtraInfo=(_=e.collection_extra_info)!==null&&_!==void 0?_:null),e?.account_extra_info&&(this.accountExtraInfo=(D=e.account_extra_info)!==null&&D!==void 0?D:null),e?.extra_info&&(this.extraInfo=new ms(e.extra_info))}formatHits(e){var t;return(t=e?.map(i=>{var o;return vs.createResult((o=i.hit_type)!==null&&o!==void 0?o:this.schemaHitType,i)}))!==null&&t!==void 0?t:[]}buildAggregations(e){this.aggregations=Object.entries(e).reduce((t,[i,o])=>(t[i]=new ln(o),t),{})}handleLendingPageElement(){var e,t;const i=(e=this.pageElements)===null||e===void 0?void 0:e.lending,o=(t=i.loans)!==null&&t!==void 0?t:[];this.totalResults=o.length,this.returnedCount=this.totalResults;for(const s of ul)i[s]=this.formatHits(i[s]);return o}handleWebArchivesPageElement(){var e;const t=ml((e=this.pageElements)===null||e===void 0?void 0:e.web_archives);return this.totalResults=t.length,this.returnedCount=this.totalResults,t}handleFederatedPageElements(){var e,t,i,o;const s=["service___fts","service___tvs","service___rcs","service___whisper","metadata___mediatype___texts","metadata___mediatype___movies","metadata___mediatype___audio","metadata___mediatype___software","metadata___mediatype___image","metadata___mediatype___etree"];for(const a of s){const l=this.removePageElementPrefix(a);this.federatedResults?this.federatedResults[a]=[]:this.federatedResults={[l]:[]};const d=(t=(e=this.pageElements)===null||e===void 0?void 0:e[a])===null||t===void 0?void 0:t.hits;d?.hits&&(this.federatedResults[l]=this.formatHits(d?.hits)),this.totalResults+=(i=d?.total)!==null&&i!==void 0?i:0,this.returnedCount+=(o=d?.returned)!==null&&o!==void 0?o:0}}removePageElementPrefix(e){return e.split("___").pop()}static createResult(e,t){switch(e){case"item":return new qe(t);case"text":case"asr_text":return new ps(t);case"favorited_search":return new vl(t);case"web_archive":return new us(t);case"tv_clip":return new fs(t);default:return new qe(t)}}}class gl{constructor(e){this.clientParameters=e.client_parameters,this.backendRequests=e.backend_requests,this.kind=e.kind}}class bl{constructor(e){var t,i,o;this.rawResponse=e,this.request=new gl(e.request),this.responseHeader=(t=e.response)===null||t===void 0?void 0:t.header,this.sessionContext=e.session_context,this.response=new vs((i=e.response)===null||i===void 0?void 0:i.body,(o=e.response)===null||o===void 0?void 0:o.hit_schema)}}class gi{static aggregateSearchParamsAsString(e){if(e.omit)return"false";if(e.advancedParams){const t=e.advancedParams.map(o=>({terms:o}));return JSON.stringify(t)}if(e.simpleParams)return e.simpleParams.join(",")}static sortParamsAsString(e){return`${e.field}:${e.direction}`}static filterParamsAsString(e){return JSON.stringify(e)}static generateURLSearchParams(e){const t=new URLSearchParams;if(e.query&&t.append("user_query",e.query),e.pageType&&t.append("page_type",String(e.pageType)),e.pageTarget&&t.append("page_target",String(e.pageTarget)),e.pageElements&&e.pageElements.length>0){const s=`[${e.pageElements.map(a=>`"${a}"`).join(",")}]`;t.append("page_elements",s)}if(e.rows!=null&&t.append("hits_per_page",String(e.rows)),e.page!=null&&t.append("page",String(e.page)),e.fields&&e.fields.length>0&&t.append("fields",e.fields.join(",")),e.filters&&Object.keys(e.filters).length>0){const o=this.filterParamsAsString(e.filters);o&&o!=="{}"&&t.append("filter_map",o)}if(e.sort&&e.sort.length>0){const o=e.sort.map(s=>this.sortParamsAsString(s));t.append("sort",o.join(","))}const i=e.aggregations;if(i){const o=this.aggregateSearchParamsAsString(i);o&&t.append("aggregations",o)}if(e.aggregationsSize!=null&&t.append("aggregations_size",String(e.aggregationsSize)),e.debugging&&t.append("debugging","true"),e.uid&&t.append("uid",e.uid),e.includeClientUrl!==!1){const o=e.query==null,s=e.query&&e.query.length<=1e3;if(o||s){const l=window.location.href.slice(0,400);t.append("client_url",l)}}return t}}var Ni;(function(r){r.networkError="SearchService.NetworkError",r.itemNotFound="SearchService.ItemNotFound",r.decodingError="SearchService.DecodingError",r.searchEngineError="SearchService.SearchEngineError"})(Ni||(Ni={}));class yl extends Error{constructor(e,t,i){super(t),this.name=e,this.type=e,this.details=i}}const Js={reCache:JSON.stringify({recompute:!0}),noCache:JSON.stringify({bypass:!0}),dontCache:JSON.stringify({no_compute:!0})};class bi{constructor(e){var t,i;this.baseUrl=(t=e?.baseUrl)!==null&&t!==void 0?t:"archive.org",e?.includeCredentials!==void 0?this.includeCredentials=e.includeCredentials:this.includeCredentials=window.location.href.match(/^https?:\/\/.*archive\.org(:[0-9]+)?/)!==null;const o=new URL(window.location.href).searchParams,s=o.get("scope"),a=o.get("verbose"),l=o.get("debugging"),d=o.get("cacheDebug");let u="";for(const p of Object.keys(Js))if(o.get(p)){u=Js[p];break}u=(i=o.get("caching"))!==null&&i!==void 0?i:u,e?.caching!==void 0?this.cachingFlags=e.caching:u&&(this.cachingFlags=u),e?.debuggingEnabled!==void 0?this.debuggingEnabled=e.debuggingEnabled:(l||d)&&(this.debuggingEnabled=!0),e?.scope!==void 0?this.requestScope=e.scope:s&&(this.requestScope=s),e?.verbose!==void 0?this.verbose=e.verbose:a&&(this.verbose=!!a)}async fetchUrl(e,t){var i,o;const s=new URL(e);this.requestScope&&s.searchParams.set("scope",this.requestScope),this.cachingFlags&&s.searchParams.set("caching",this.cachingFlags);let a;try{const l=(i=t?.requestOptions)!==null&&i!==void 0?i:{credentials:this.includeCredentials?"include":"same-origin"};a=await fetch(s.href,l)}catch(l){const d=l instanceof Error?l.message:typeof l=="string"?l:"Unknown error";return this.getErrorResult(Ni.networkError,d)}try{const l=await a.json();this.verbose&&this.printResponse(l),l.debugging&&this.printDebuggingInfo(l);const d=(o=l.response)===null||o===void 0?void 0:o.error;return d?this.getErrorResult(Ni.searchEngineError,d.message,d.forensics):{success:l}}catch(l){const d=l instanceof Error?l.message:typeof l=="string"?l:"Unknown error";return this.getErrorResult(Ni.decodingError,d)}}getErrorResult(e,t,i){return{error:new yl(e,t,i)}}printResponse(e){var t,i,o,s,a;try{const l=JSON.parse(JSON.stringify(e)),d=(o=(i=(t=l?.response)===null||t===void 0?void 0:t.body)===null||i===void 0?void 0:i.hits)===null||o===void 0?void 0:o.hits;if(Array.isArray(d)&&d.length>1){const p=[];p.push(d[0]),p.push(`*** ${d.length-1} hits omitted ***`),l.response.body.hits.hits=p}const u=(a=(s=l?.response)===null||s===void 0?void 0:s.body)===null||a===void 0?void 0:a.aggregations;u&&Object.entries(u).forEach(([p,m])=>{var v,y,S,x;if(((y=(v=m)===null||v===void 0?void 0:v.buckets)===null||y===void 0?void 0:y.length)>0){const _=JSON.parse(JSON.stringify(m));_.buckets=`*** ${(x=(S=_.buckets)===null||S===void 0?void 0:S.length)!==null&&x!==void 0?x:0} buckets omitted ***`,l.response.body.aggregations[p]=_}}),console.log("***** RESPONSE RECEIVED *****"),console.groupCollapsed("Response"),console.log(JSON.stringify(l,null,2)),console.groupEnd()}catch(l){console.error("Error printing search response:",l)}}printDebuggingInfo(e){var t,i;const o=e.debugging,s=(t=o.messages)!==null&&t!==void 0?t:[],a=(i=o.data)!==null&&i!==void 0?i:{};console.log("***** BEGIN DEBUGGING *****"),console.log("Full response:"),console.log(JSON.stringify(e,null,2)),console.group("Debug messages");for(const l of s)console.log(l);console.groupEnd(),console.group("Debug data");for(const[l,d]of Object.entries(a))console.log(l,d);console.groupEnd(),console.log("***** END DEBUGGING *****")}}class wl extends bi{constructor(e){var t;super(e),this.servicePath=(t=e?.servicePath)!==null&&t!==void 0?t:"/services/search/beta/page_production"}async performSearch(e){this.debuggingEnabled&&e.debugging===void 0&&(e.debugging=!0);const i=gi.generateURLSearchParams(e).toString(),o=`https://${this.baseUrl}${this.servicePath}/?service_backend=metadata&${i}`;return this.fetchUrl(o)}}class xl extends bi{constructor(e){var t;super(e),this.servicePath=(t=e?.servicePath)!==null&&t!==void 0?t:"/services/search/beta/page_production"}async performSearch(e){this.debuggingEnabled&&e.debugging===void 0&&(e.debugging=!0);const i=gi.generateURLSearchParams(e).toString(),o=`https://${this.baseUrl}${this.servicePath}/?service_backend=fts&${i}`;return this.fetchUrl(o)}}class Sl extends bi{constructor(e){var t;super(e),this.servicePath=(t=e?.servicePath)!==null&&t!==void 0?t:"/services/search/beta/page_production"}async performSearch(e){this.debuggingEnabled&&e.debugging===void 0&&(e.debugging=!0);const i=gi.generateURLSearchParams(e).toString(),o=`https://${this.baseUrl}${this.servicePath}/?service_backend=rcs&${i}`;return this.fetchUrl(o)}}var O;(function(r){r[r.DEFAULT=0]="DEFAULT",r[r.METADATA=1]="METADATA",r[r.FULLTEXT=2]="FULLTEXT",r[r.TV=3]="TV",r[r.RADIO=4]="RADIO",r[r.FEDERATED=5]="FEDERATED"})(O||(O={}));class $l extends bi{constructor(e){var t;super(e),this.servicePath=(t=e?.servicePath)!==null&&t!==void 0?t:"/services/search/beta/page_production"}async performSearch(e){this.debuggingEnabled&&e.debugging===void 0&&(e.debugging=!0);const i=gi.generateURLSearchParams(e).toString(),o=`https://${this.baseUrl}${this.servicePath}/?service_backend=tvs&${i}`;return this.fetchUrl(o)}}class _l extends bi{constructor(e){var t;super(e),this.servicePath=(t=e?.servicePath)!==null&&t!==void 0?t:"/services/search/beta/page_production"}async performSearch(e){this.debuggingEnabled&&e.debugging===void 0&&(e.debugging=!0);const i=gi.generateURLSearchParams(e).toString(),o=`https://${this.baseUrl}${this.servicePath}/?page_type=simple_federation&${i}`;return this.fetchUrl(o)}}class Cl extends bi{constructor(e){var t;super(e),this.servicePath=(t=e?.servicePath)!==null&&t!==void 0?t:"/services/search/beta/page_production"}async performSearch(e){this.debuggingEnabled&&e.debugging===void 0&&(e.debugging=!0);const i=gi.generateURLSearchParams(e).toString(),o=`https://${this.baseUrl}${this.servicePath}/?${i}`;return this.fetchUrl(o)}}class si{constructor(e={}){this.backendOptions=e}async search(e,t=O.METADATA){const o=await si.getBackendForSearchType(t,this.backendOptions).performSearch(e);return o.error?o:{success:new bl(o.success)}}itemDetails(e){const t={pageType:"item_details",pageTarget:e};return this.search(t,O.DEFAULT)}static getBackendForSearchType(e,t={}){switch(e){case O.METADATA:return new wl(t);case O.FULLTEXT:return new xl(t);case O.RADIO:return new Sl(t);case O.TV:return new $l(t);case O.FEDERATED:return new _l(t);default:return new Cl(t)}}}si.default=new si;n([w((r,e={})=>{const{includeCredentials:t=!1,verbose:i=!1,scope:o="",baseUrl:s=""}=e;return`${r};${t};${i};${o};${s}`})],si,"getBackendForSearchType",null);var Oe;(function(r){r.INCLUDE="inc",r.EXCLUDE="exc",r.GREATER_THAN="gt",r.GREATER_OR_EQUAL="gte",r.LESS_THAN="lt",r.LESS_OR_EQUAL="lte"})(Oe||(Oe={}));class kl{constructor(){this.filterMap={}}addFilter(e,t,i){if(this.filterMap[e]||(this.filterMap[e]={}),this.filterMap[e][t]){const o=[].concat(this.filterMap[e][t],i);this.filterMap[e][t]=Array.from(new Set(o))}else this.filterMap[e][t]=i;return this}removeSingleFilter(e,t,i){var o;if(!(!((o=this.filterMap[e])===null||o===void 0)&&o[t]))return this;const s=[].concat(this.filterMap[e][t]),a=s.indexOf(i);return a>=0&&s.splice(a,1),this.filterMap[e][t]=s.length===1?s[0]:s,s.length===0&&delete this.filterMap[e][t],this.deleteFieldIfEmpty(e),this}removeFilters(e,t){return this.filterMap[e]?(delete this.filterMap[e][t],this.deleteFieldIfEmpty(e),this):this}deleteFieldIfEmpty(e){const t=this.filterMap[e];t&&Object.keys(t).length===0&&delete this.filterMap[e]}setFilterMap(e){return this.filterMap={...e},this}mergeFilterMap(e){for(const[t,i]of Object.entries(e))for(const[o,s]of Object.entries(i))if(Array.isArray(s))for(const a of s)this.addFilter(t,o,a);else this.addFilter(t,o,s);return this}build(){return this.filterMap}}/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const vo=window,gs=vo.ShadowRoot&&(vo.ShadyCSS===void 0||vo.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,bs=Symbol(),ea=new WeakMap;let dn=class{constructor(e,t,i){if(this._$cssResult$=!0,i!==bs)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o;const t=this.t;if(gs&&e===void 0){const i=t!==void 0&&t.length===1;i&&(e=ea.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),i&&ea.set(t,e))}return e}toString(){return this.cssText}};const Tl=r=>new dn(typeof r=="string"?r:r+"",void 0,bs),f=(r,...e)=>{const t=r.length===1?r[0]:e.reduce((i,o,s)=>i+(a=>{if(a._$cssResult$===!0)return a.cssText;if(typeof a=="number")return a;throw Error("Value passed to 'css' function must be a 'css' function result: "+a+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(o)+r[s+1],r[0]);return new dn(t,r,bs)},El=(r,e)=>{gs?r.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet):e.forEach(t=>{const i=document.createElement("style"),o=vo.litNonce;o!==void 0&&i.setAttribute("nonce",o),i.textContent=t.cssText,r.appendChild(i)})},ta=gs?r=>r:r=>r instanceof CSSStyleSheet?(e=>{let t="";for(const i of e.cssRules)t+=i.cssText;return Tl(t)})(r):r;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var nr;const To=window,ia=To.trustedTypes,Ml=ia?ia.emptyScript:"",oa=To.reactiveElementPolyfillSupport,Or={toAttribute(r,e){switch(e){case Boolean:r=r?Ml:null;break;case Object:case Array:r=r==null?r:JSON.stringify(r)}return r},fromAttribute(r,e){let t=r;switch(e){case Boolean:t=r!==null;break;case Number:t=r===null?null:Number(r);break;case Object:case Array:try{t=JSON.parse(r)}catch{t=null}}return t}},cn=(r,e)=>e!==r&&(e==e||r==r),lr={attribute:!0,type:String,converter:Or,reflect:!1,hasChanged:cn},Nr="finalized";let ei=class extends HTMLElement{constructor(){super(),this._$Ei=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$El=null,this._$Eu()}static addInitializer(e){var t;this.finalize(),((t=this.h)!==null&&t!==void 0?t:this.h=[]).push(e)}static get observedAttributes(){this.finalize();const e=[];return this.elementProperties.forEach((t,i)=>{const o=this._$Ep(i,t);o!==void 0&&(this._$Ev.set(o,i),e.push(o))}),e}static createProperty(e,t=lr){if(t.state&&(t.attribute=!1),this.finalize(),this.elementProperties.set(e,t),!t.noAccessor&&!this.prototype.hasOwnProperty(e)){const i=typeof e=="symbol"?Symbol():"__"+e,o=this.getPropertyDescriptor(e,i,t);o!==void 0&&Object.defineProperty(this.prototype,e,o)}}static getPropertyDescriptor(e,t,i){return{get(){return this[t]},set(o){const s=this[e];this[t]=o,this.requestUpdate(e,s,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)||lr}static finalize(){if(this.hasOwnProperty(Nr))return!1;this[Nr]=!0;const e=Object.getPrototypeOf(this);if(e.finalize(),e.h!==void 0&&(this.h=[...e.h]),this.elementProperties=new Map(e.elementProperties),this._$Ev=new Map,this.hasOwnProperty("properties")){const t=this.properties,i=[...Object.getOwnPropertyNames(t),...Object.getOwnPropertySymbols(t)];for(const o of i)this.createProperty(o,t[o])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const i=new Set(e.flat(1/0).reverse());for(const o of i)t.unshift(ta(o))}else e!==void 0&&t.push(ta(e));return t}static _$Ep(e,t){const i=t.attribute;return i===!1?void 0:typeof i=="string"?i:typeof e=="string"?e.toLowerCase():void 0}_$Eu(){var e;this._$E_=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$Eg(),this.requestUpdate(),(e=this.constructor.h)===null||e===void 0||e.forEach(t=>t(this))}addController(e){var t,i;((t=this._$ES)!==null&&t!==void 0?t:this._$ES=[]).push(e),this.renderRoot!==void 0&&this.isConnected&&((i=e.hostConnected)===null||i===void 0||i.call(e))}removeController(e){var t;(t=this._$ES)===null||t===void 0||t.splice(this._$ES.indexOf(e)>>>0,1)}_$Eg(){this.constructor.elementProperties.forEach((e,t)=>{this.hasOwnProperty(t)&&(this._$Ei.set(t,this[t]),delete this[t])})}createRenderRoot(){var e;const t=(e=this.shadowRoot)!==null&&e!==void 0?e:this.attachShadow(this.constructor.shadowRootOptions);return El(t,this.constructor.elementStyles),t}connectedCallback(){var e;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$ES)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostConnected)===null||i===void 0?void 0:i.call(t)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$ES)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostDisconnected)===null||i===void 0?void 0:i.call(t)})}attributeChangedCallback(e,t,i){this._$AK(e,i)}_$EO(e,t,i=lr){var o;const s=this.constructor._$Ep(e,i);if(s!==void 0&&i.reflect===!0){const a=(((o=i.converter)===null||o===void 0?void 0:o.toAttribute)!==void 0?i.converter:Or).toAttribute(t,i.type);this._$El=e,a==null?this.removeAttribute(s):this.setAttribute(s,a),this._$El=null}}_$AK(e,t){var i;const o=this.constructor,s=o._$Ev.get(e);if(s!==void 0&&this._$El!==s){const a=o.getPropertyOptions(s),l=typeof a.converter=="function"?{fromAttribute:a.converter}:((i=a.converter)===null||i===void 0?void 0:i.fromAttribute)!==void 0?a.converter:Or;this._$El=s,this[s]=l.fromAttribute(t,a.type),this._$El=null}}requestUpdate(e,t,i){let o=!0;e!==void 0&&(((i=i||this.constructor.getPropertyOptions(e)).hasChanged||cn)(this[e],t)?(this._$AL.has(e)||this._$AL.set(e,t),i.reflect===!0&&this._$El!==e&&(this._$EC===void 0&&(this._$EC=new Map),this._$EC.set(e,i))):o=!1),!this.isUpdatePending&&o&&(this._$E_=this._$Ej())}async _$Ej(){this.isUpdatePending=!0;try{await this._$E_}catch(t){Promise.reject(t)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var e;if(!this.isUpdatePending)return;this.hasUpdated,this._$Ei&&(this._$Ei.forEach((o,s)=>this[s]=o),this._$Ei=void 0);let t=!1;const i=this._$AL;try{t=this.shouldUpdate(i),t?(this.willUpdate(i),(e=this._$ES)===null||e===void 0||e.forEach(o=>{var s;return(s=o.hostUpdate)===null||s===void 0?void 0:s.call(o)}),this.update(i)):this._$Ek()}catch(o){throw t=!1,this._$Ek(),o}t&&this._$AE(i)}willUpdate(e){}_$AE(e){var t;(t=this._$ES)===null||t===void 0||t.forEach(i=>{var o;return(o=i.hostUpdated)===null||o===void 0?void 0:o.call(i)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$Ek(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$E_}shouldUpdate(e){return!0}update(e){this._$EC!==void 0&&(this._$EC.forEach((t,i)=>this._$EO(i,this[i],t)),this._$EC=void 0),this._$Ek()}updated(e){}firstUpdated(e){}};ei[Nr]=!0,ei.elementProperties=new Map,ei.elementStyles=[],ei.shadowRootOptions={mode:"open"},oa?.({ReactiveElement:ei}),((nr=To.reactiveElementVersions)!==null&&nr!==void 0?nr:To.reactiveElementVersions=[]).push("1.6.3");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var dr;const Eo=window,ai=Eo.trustedTypes,ra=ai?ai.createPolicy("lit-html",{createHTML:r=>r}):void 0,Ur="$lit$",bt=`lit$${(Math.random()+"").slice(9)}$`,hn="?"+bt,Al=`<${hn}>`,Nt=document,Mo=()=>Nt.createComment(""),Gi=r=>r===null||typeof r!="object"&&typeof r!="function",pn=Array.isArray,Dl=r=>pn(r)||typeof r?.[Symbol.iterator]=="function",cr=`[ 	
\f\r]`,ki=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,sa=/-->/g,aa=/>/g,kt=RegExp(`>|${cr}(?:([^\\s"'>=/]+)(${cr}*=${cr}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),na=/'/g,la=/"/g,un=/^(?:script|style|textarea|title)$/i,Ae=Symbol.for("lit-noChange"),ee=Symbol.for("lit-nothing"),da=new WeakMap,Lt=Nt.createTreeWalker(Nt,129,null,!1);function fn(r,e){if(!Array.isArray(r)||!r.hasOwnProperty("raw"))throw Error("invalid template strings array");return ra!==void 0?ra.createHTML(e):e}const Fl=(r,e)=>{const t=r.length-1,i=[];let o,s=e===2?"<svg>":"",a=ki;for(let l=0;l<t;l++){const d=r[l];let u,p,m=-1,v=0;for(;v<d.length&&(a.lastIndex=v,p=a.exec(d),p!==null);)v=a.lastIndex,a===ki?p[1]==="!--"?a=sa:p[1]!==void 0?a=aa:p[2]!==void 0?(un.test(p[2])&&(o=RegExp("</"+p[2],"g")),a=kt):p[3]!==void 0&&(a=kt):a===kt?p[0]===">"?(a=o??ki,m=-1):p[1]===void 0?m=-2:(m=a.lastIndex-p[2].length,u=p[1],a=p[3]===void 0?kt:p[3]==='"'?la:na):a===la||a===na?a=kt:a===sa||a===aa?a=ki:(a=kt,o=void 0);const y=a===kt&&r[l+1].startsWith("/>")?" ":"";s+=a===ki?d+Al:m>=0?(i.push(u),d.slice(0,m)+Ur+d.slice(m)+bt+y):d+bt+(m===-2?(i.push(void 0),l):y)}return[fn(r,s+(r[t]||"<?>")+(e===2?"</svg>":"")),i]};let Hr=class mn{constructor({strings:e,_$litType$:t},i){let o;this.parts=[];let s=0,a=0;const l=e.length-1,d=this.parts,[u,p]=Fl(e,t);if(this.el=mn.createElement(u,i),Lt.currentNode=this.el.content,t===2){const m=this.el.content,v=m.firstChild;v.remove(),m.append(...v.childNodes)}for(;(o=Lt.nextNode())!==null&&d.length<l;){if(o.nodeType===1){if(o.hasAttributes()){const m=[];for(const v of o.getAttributeNames())if(v.endsWith(Ur)||v.startsWith(bt)){const y=p[a++];if(m.push(v),y!==void 0){const S=o.getAttribute(y.toLowerCase()+Ur).split(bt),x=/([.?@])?(.*)/.exec(y);d.push({type:1,index:s,name:x[2],strings:S,ctor:x[1]==="."?zl:x[1]==="?"?Pl:x[1]==="@"?Rl:Wo})}else d.push({type:6,index:s})}for(const v of m)o.removeAttribute(v)}if(un.test(o.tagName)){const m=o.textContent.split(bt),v=m.length-1;if(v>0){o.textContent=ai?ai.emptyScript:"";for(let y=0;y<v;y++)o.append(m[y],Mo()),Lt.nextNode(),d.push({type:2,index:++s});o.append(m[v],Mo())}}}else if(o.nodeType===8)if(o.data===hn)d.push({type:2,index:s});else{let m=-1;for(;(m=o.data.indexOf(bt,m+1))!==-1;)d.push({type:7,index:s}),m+=bt.length-1}s++}}static createElement(e,t){const i=Nt.createElement("template");return i.innerHTML=e,i}};function ni(r,e,t=r,i){var o,s,a,l;if(e===Ae)return e;let d=i!==void 0?(o=t._$Co)===null||o===void 0?void 0:o[i]:t._$Cl;const u=Gi(e)?void 0:e._$litDirective$;return d?.constructor!==u&&((s=d?._$AO)===null||s===void 0||s.call(d,!1),u===void 0?d=void 0:(d=new u(r),d._$AT(r,t,i)),i!==void 0?((a=(l=t)._$Co)!==null&&a!==void 0?a:l._$Co=[])[i]=d:t._$Cl=d),d!==void 0&&(e=ni(r,d._$AS(r,e.values),d,i)),e}let Ll=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){var t;const{el:{content:i},parts:o}=this._$AD,s=((t=e?.creationScope)!==null&&t!==void 0?t:Nt).importNode(i,!0);Lt.currentNode=s;let a=Lt.nextNode(),l=0,d=0,u=o[0];for(;u!==void 0;){if(l===u.index){let p;u.type===2?p=new ys(a,a.nextSibling,this,e):u.type===1?p=new u.ctor(a,u.name,u.strings,this,e):u.type===6&&(p=new Il(a,this,e)),this._$AV.push(p),u=o[++d]}l!==u?.index&&(a=Lt.nextNode(),l++)}return Lt.currentNode=Nt,s}v(e){let t=0;for(const i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}},ys=class vn{constructor(e,t,i,o){var s;this.type=2,this._$AH=ee,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=o,this._$Cp=(s=o?.isConnected)===null||s===void 0||s}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cp}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=ni(this,e,t),Gi(e)?e===ee||e==null||e===""?(this._$AH!==ee&&this._$AR(),this._$AH=ee):e!==this._$AH&&e!==Ae&&this._(e):e._$litType$!==void 0?this.g(e):e.nodeType!==void 0?this.$(e):Dl(e)?this.T(e):this._(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==ee&&Gi(this._$AH)?this._$AA.nextSibling.data=e:this.$(Nt.createTextNode(e)),this._$AH=e}g(e){var t;const{values:i,_$litType$:o}=e,s=typeof o=="number"?this._$AC(e):(o.el===void 0&&(o.el=Hr.createElement(fn(o.h,o.h[0]),this.options)),o);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===s)this._$AH.v(i);else{const a=new Ll(s,this),l=a.u(this.options);a.v(i),this.$(l),this._$AH=a}}_$AC(e){let t=da.get(e.strings);return t===void 0&&da.set(e.strings,t=new Hr(e)),t}T(e){pn(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,o=0;for(const s of e)o===t.length?t.push(i=new vn(this.k(Mo()),this.k(Mo()),this,this.options)):i=t[o],i._$AI(s),o++;o<t.length&&(this._$AR(i&&i._$AB.nextSibling,o),t.length=o)}_$AR(e=this._$AA.nextSibling,t){var i;for((i=this._$AP)===null||i===void 0||i.call(this,!1,!0,t);e&&e!==this._$AB;){const o=e.nextSibling;e.remove(),e=o}}setConnected(e){var t;this._$AM===void 0&&(this._$Cp=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}},Wo=class{constructor(e,t,i,o,s){this.type=1,this._$AH=ee,this._$AN=void 0,this.element=e,this.name=t,this._$AM=o,this.options=s,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=ee}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,i,o){const s=this.strings;let a=!1;if(s===void 0)e=ni(this,e,t,0),a=!Gi(e)||e!==this._$AH&&e!==Ae,a&&(this._$AH=e);else{const l=e;let d,u;for(e=s[0],d=0;d<s.length-1;d++)u=ni(this,l[i+d],t,d),u===Ae&&(u=this._$AH[d]),a||(a=!Gi(u)||u!==this._$AH[d]),u===ee?e=ee:e!==ee&&(e+=(u??"")+s[d+1]),this._$AH[d]=u}a&&!o&&this.j(e)}j(e){e===ee?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},zl=class extends Wo{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===ee?void 0:e}};const Bl=ai?ai.emptyScript:"";let Pl=class extends Wo{constructor(){super(...arguments),this.type=4}j(e){e&&e!==ee?this.element.setAttribute(this.name,Bl):this.element.removeAttribute(this.name)}},Rl=class extends Wo{constructor(e,t,i,o,s){super(e,t,i,o,s),this.type=5}_$AI(e,t=this){var i;if((e=(i=ni(this,e,t,0))!==null&&i!==void 0?i:ee)===Ae)return;const o=this._$AH,s=e===ee&&o!==ee||e.capture!==o.capture||e.once!==o.once||e.passive!==o.passive,a=e!==ee&&(o===ee||s);s&&this.element.removeEventListener(this.name,this,o),a&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,i;typeof this._$AH=="function"?this._$AH.call((i=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&i!==void 0?i:this.element,e):this._$AH.handleEvent(e)}},Il=class{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){ni(this,e)}};const Ol={I:ys},ca=Eo.litHtmlPolyfillSupport;ca?.(Hr,ys),((dr=Eo.litHtmlVersions)!==null&&dr!==void 0?dr:Eo.litHtmlVersions=[]).push("2.8.0");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var hr;const Ao=window,li=Ao.trustedTypes,ha=li?li.createPolicy("lit-html",{createHTML:r=>r}):void 0,Vr="$lit$",yt=`lit$${(Math.random()+"").slice(9)}$`,gn="?"+yt,Nl=`<${gn}>`,Ut=document,Yi=()=>Ut.createComment(""),Qi=r=>r===null||typeof r!="object"&&typeof r!="function",bn=Array.isArray,Ul=r=>bn(r)||typeof r?.[Symbol.iterator]=="function",pr=`[ 	
\f\r]`,Ti=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,pa=/-->/g,ua=/>/g,Tt=RegExp(`>|${pr}(?:([^\\s"'>=/]+)(${pr}*=${pr}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),fa=/'/g,ma=/"/g,yn=/^(?:script|style|textarea|title)$/i,wn=r=>(e,...t)=>({_$litType$:r,strings:e,values:t}),h=wn(1),N=wn(2),di=Symbol.for("lit-noChange"),b=Symbol.for("lit-nothing"),va=new WeakMap,zt=Ut.createTreeWalker(Ut,129,null,!1);function xn(r,e){if(!Array.isArray(r)||!r.hasOwnProperty("raw"))throw Error("invalid template strings array");return ha!==void 0?ha.createHTML(e):e}const Hl=(r,e)=>{const t=r.length-1,i=[];let o,s=e===2?"<svg>":"",a=Ti;for(let l=0;l<t;l++){const d=r[l];let u,p,m=-1,v=0;for(;v<d.length&&(a.lastIndex=v,p=a.exec(d),p!==null);)v=a.lastIndex,a===Ti?p[1]==="!--"?a=pa:p[1]!==void 0?a=ua:p[2]!==void 0?(yn.test(p[2])&&(o=RegExp("</"+p[2],"g")),a=Tt):p[3]!==void 0&&(a=Tt):a===Tt?p[0]===">"?(a=o??Ti,m=-1):p[1]===void 0?m=-2:(m=a.lastIndex-p[2].length,u=p[1],a=p[3]===void 0?Tt:p[3]==='"'?ma:fa):a===ma||a===fa?a=Tt:a===pa||a===ua?a=Ti:(a=Tt,o=void 0);const y=a===Tt&&r[l+1].startsWith("/>")?" ":"";s+=a===Ti?d+Nl:m>=0?(i.push(u),d.slice(0,m)+Vr+d.slice(m)+yt+y):d+yt+(m===-2?(i.push(void 0),l):y)}return[xn(r,s+(r[t]||"<?>")+(e===2?"</svg>":"")),i]};class Ki{constructor({strings:e,_$litType$:t},i){let o;this.parts=[];let s=0,a=0;const l=e.length-1,d=this.parts,[u,p]=Hl(e,t);if(this.el=Ki.createElement(u,i),zt.currentNode=this.el.content,t===2){const m=this.el.content,v=m.firstChild;v.remove(),m.append(...v.childNodes)}for(;(o=zt.nextNode())!==null&&d.length<l;){if(o.nodeType===1){if(o.hasAttributes()){const m=[];for(const v of o.getAttributeNames())if(v.endsWith(Vr)||v.startsWith(yt)){const y=p[a++];if(m.push(v),y!==void 0){const S=o.getAttribute(y.toLowerCase()+Vr).split(yt),x=/([.?@])?(.*)/.exec(y);d.push({type:1,index:s,name:x[2],strings:S,ctor:x[1]==="."?Wl:x[1]==="?"?ql:x[1]==="@"?Gl:jo})}else d.push({type:6,index:s})}for(const v of m)o.removeAttribute(v)}if(yn.test(o.tagName)){const m=o.textContent.split(yt),v=m.length-1;if(v>0){o.textContent=li?li.emptyScript:"";for(let y=0;y<v;y++)o.append(m[y],Yi()),zt.nextNode(),d.push({type:2,index:++s});o.append(m[v],Yi())}}}else if(o.nodeType===8)if(o.data===gn)d.push({type:2,index:s});else{let m=-1;for(;(m=o.data.indexOf(yt,m+1))!==-1;)d.push({type:7,index:s}),m+=yt.length-1}s++}}static createElement(e,t){const i=Ut.createElement("template");return i.innerHTML=e,i}}function ci(r,e,t=r,i){var o,s,a,l;if(e===di)return e;let d=i!==void 0?(o=t._$Co)===null||o===void 0?void 0:o[i]:t._$Cl;const u=Qi(e)?void 0:e._$litDirective$;return d?.constructor!==u&&((s=d?._$AO)===null||s===void 0||s.call(d,!1),u===void 0?d=void 0:(d=new u(r),d._$AT(r,t,i)),i!==void 0?((a=(l=t)._$Co)!==null&&a!==void 0?a:l._$Co=[])[i]=d:t._$Cl=d),d!==void 0&&(e=ci(r,d._$AS(r,e.values),d,i)),e}let Vl=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){var t;const{el:{content:i},parts:o}=this._$AD,s=((t=e?.creationScope)!==null&&t!==void 0?t:Ut).importNode(i,!0);zt.currentNode=s;let a=zt.nextNode(),l=0,d=0,u=o[0];for(;u!==void 0;){if(l===u.index){let p;u.type===2?p=new to(a,a.nextSibling,this,e):u.type===1?p=new u.ctor(a,u.name,u.strings,this,e):u.type===6&&(p=new Yl(a,this,e)),this._$AV.push(p),u=o[++d]}l!==u?.index&&(a=zt.nextNode(),l++)}return zt.currentNode=Ut,s}v(e){let t=0;for(const i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}};class to{constructor(e,t,i,o){var s;this.type=2,this._$AH=b,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=o,this._$Cp=(s=o?.isConnected)===null||s===void 0||s}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cp}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=ci(this,e,t),Qi(e)?e===b||e==null||e===""?(this._$AH!==b&&this._$AR(),this._$AH=b):e!==this._$AH&&e!==di&&this._(e):e._$litType$!==void 0?this.g(e):e.nodeType!==void 0?this.$(e):Ul(e)?this.T(e):this._(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==b&&Qi(this._$AH)?this._$AA.nextSibling.data=e:this.$(Ut.createTextNode(e)),this._$AH=e}g(e){var t;const{values:i,_$litType$:o}=e,s=typeof o=="number"?this._$AC(e):(o.el===void 0&&(o.el=Ki.createElement(xn(o.h,o.h[0]),this.options)),o);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===s)this._$AH.v(i);else{const a=new Vl(s,this),l=a.u(this.options);a.v(i),this.$(l),this._$AH=a}}_$AC(e){let t=va.get(e.strings);return t===void 0&&va.set(e.strings,t=new Ki(e)),t}T(e){bn(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,o=0;for(const s of e)o===t.length?t.push(i=new to(this.k(Yi()),this.k(Yi()),this,this.options)):i=t[o],i._$AI(s),o++;o<t.length&&(this._$AR(i&&i._$AB.nextSibling,o),t.length=o)}_$AR(e=this._$AA.nextSibling,t){var i;for((i=this._$AP)===null||i===void 0||i.call(this,!1,!0,t);e&&e!==this._$AB;){const o=e.nextSibling;e.remove(),e=o}}setConnected(e){var t;this._$AM===void 0&&(this._$Cp=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}}class jo{constructor(e,t,i,o,s){this.type=1,this._$AH=b,this._$AN=void 0,this.element=e,this.name=t,this._$AM=o,this.options=s,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=b}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,i,o){const s=this.strings;let a=!1;if(s===void 0)e=ci(this,e,t,0),a=!Qi(e)||e!==this._$AH&&e!==di,a&&(this._$AH=e);else{const l=e;let d,u;for(e=s[0],d=0;d<s.length-1;d++)u=ci(this,l[i+d],t,d),u===di&&(u=this._$AH[d]),a||(a=!Qi(u)||u!==this._$AH[d]),u===b?e=b:e!==b&&(e+=(u??"")+s[d+1]),this._$AH[d]=u}a&&!o&&this.j(e)}j(e){e===b?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}let Wl=class extends jo{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===b?void 0:e}};const jl=li?li.emptyScript:"";let ql=class extends jo{constructor(){super(...arguments),this.type=4}j(e){e&&e!==b?this.element.setAttribute(this.name,jl):this.element.removeAttribute(this.name)}};class Gl extends jo{constructor(e,t,i,o,s){super(e,t,i,o,s),this.type=5}_$AI(e,t=this){var i;if((e=(i=ci(this,e,t,0))!==null&&i!==void 0?i:b)===di)return;const o=this._$AH,s=e===b&&o!==b||e.capture!==o.capture||e.once!==o.once||e.passive!==o.passive,a=e!==b&&(o===b||s);s&&this.element.removeEventListener(this.name,this,o),a&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,i;typeof this._$AH=="function"?this._$AH.call((i=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&i!==void 0?i:this.element,e):this._$AH.handleEvent(e)}}class Yl{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){ci(this,e)}}const ga=Ao.litHtmlPolyfillSupport;ga?.(Ki,to),((hr=Ao.litHtmlVersions)!==null&&hr!==void 0?hr:Ao.litHtmlVersions=[]).push("2.8.0");const go=(r,e,t)=>{var i,o;const s=(i=t?.renderBefore)!==null&&i!==void 0?i:e;let a=s._$litPart$;if(a===void 0){const l=(o=t?.renderBefore)!==null&&o!==void 0?o:null;s._$litPart$=a=new to(e.insertBefore(Yi(),l),l,void 0,t??{})}return a._$AI(r),a};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var ur,fr;let P=class extends ei{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e,t;const i=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=i.firstChild),i}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=go(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!1)}render(){return di}};P.finalized=!0,P._$litElement$=!0,(ur=globalThis.litElementHydrateSupport)===null||ur===void 0||ur.call(globalThis,{LitElement:P});const ba=globalThis.litElementPolyfillSupport;ba?.({LitElement:P});((fr=globalThis.litElementVersions)!==null&&fr!==void 0?fr:globalThis.litElementVersions=[]).push("3.3.3");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ql=(r,e)=>e.kind==="method"&&e.descriptor&&!("value"in e.descriptor)?{...e,finisher(t){t.createProperty(e.key,r)}}:{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){typeof e.initializer=="function"&&(this[e.key]=e.initializer.call(this))},finisher(t){t.createProperty(e.key,r)}},Kl=(r,e,t)=>{e.constructor.createProperty(t,r)};function c(r){return(e,t)=>t!==void 0?Kl(r,e,t):Ql(r,e)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ws=({finisher:r,descriptor:e})=>(t,i)=>{var o;if(i===void 0){const s=(o=t.originalKey)!==null&&o!==void 0?o:t.key,a=e!=null?{kind:"method",placement:"prototype",key:s,descriptor:e(t.key)}:{...t,key:s};return r!=null&&(a.finisher=function(l){r(l,s)}),a}{const s=t.constructor;e!==void 0&&Object.defineProperty(t,i,e(i)),r?.(s,i)}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function V(r,e){return ws({descriptor:t=>({get(){var o,s;return(s=(o=this.renderRoot)===null||o===void 0?void 0:o.querySelector(r))!==null&&s!==void 0?s:null},enumerable:!0,configurable:!0})})}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Xl(r){return ws({descriptor:e=>({get(){var t,i;return(i=(t=this.renderRoot)===null||t===void 0?void 0:t.querySelectorAll(r))!==null&&i!==void 0?i:[]},enumerable:!0,configurable:!0})})}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var mr;const Zl=((mr=window.HTMLSlotElement)===null||mr===void 0?void 0:mr.prototype.assignedElements)!=null?(r,e)=>r.assignedElements(e):(r,e)=>r.assignedNodes(e).filter(t=>t.nodeType===Node.ELEMENT_NODE);function Jl(r){const{slot:e,selector:t}={};return ws({descriptor:i=>({get(){var o;const s="slot"+(e?`[name=${e}]`:":not([name])"),a=(o=this.renderRoot)===null||o===void 0?void 0:o.querySelector(s),l=a!=null?Zl(a,r):[];return t?l.filter(d=>d.matches(t)):l},enumerable:!0,configurable:!0})})}class ed{constructor(){this.resizeObserver=new ResizeObserver(e=>{window.requestAnimationFrame(()=>{for(const t of e){const i=this.resizeHandlers.get(t.target);i?.forEach(o=>{o.handleResize(t)})}})}),this.resizeHandlers=new Map}shutdown(){this.resizeHandlers.forEach((e,t)=>{this.resizeObserver.unobserve(t)}),this.resizeHandlers.clear()}addObserver(e){var t;const i=(t=this.resizeHandlers.get(e.target))!==null&&t!==void 0?t:new Set;i.add(e.handler),this.resizeHandlers.set(e.target,i),this.resizeObserver.observe(e.target,e.options)}removeObserver(e){const t=this.resizeHandlers.get(e.target);t&&(t.delete(e.handler),t.size===0&&(this.resizeObserver.unobserve(e.target),this.resizeHandlers.delete(e.target)))}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ve={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4},yi=r=>(...e)=>({_$litDirective$:r,values:e});let wi=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}};/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const We=yi(class extends wi{constructor(r){var e;if(super(r),r.type!==Ve.ATTRIBUTE||r.name!=="class"||((e=r.strings)===null||e===void 0?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(r){return" "+Object.keys(r).filter(e=>r[e]).join(" ")+" "}update(r,[e]){var t,i;if(this.it===void 0){this.it=new Set,r.strings!==void 0&&(this.nt=new Set(r.strings.join(" ").split(/\s/).filter(s=>s!=="")));for(const s in e)e[s]&&!(!((t=this.nt)===null||t===void 0)&&t.has(s))&&this.it.add(s);return this.render(e)}const o=r.element.classList;this.it.forEach(s=>{s in e||(o.remove(s),this.it.delete(s))});for(const s in e){const a=!!e[s];a===this.it.has(s)||!((i=this.nt)===null||i===void 0)&&i.has(s)||(a?(o.add(s),this.it.add(s)):(o.remove(s),this.it.delete(s)))}return Ae}});/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const td=(r,...e)=>({strTag:!0,strings:r,values:e}),mt=td,id=r=>typeof r!="string"&&"strTag"in r,od=(r,e,t)=>{let i=r[0];for(let o=1;o<r.length;o++)i+=e[o-1],i+=r[o];return i};/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const rd=r=>id(r)?od(r.strings,r.values):r;let E=rd;/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let sd=class{constructor(){this.settled=!1,this.promise=new Promise((e,t)=>{this._resolve=e,this._reject=t})}resolve(e){this.settled=!0,this._resolve(e)}reject(e){this.settled=!0,this._reject(e)}};/**
 * @license
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let ad=new sd;ad.resolve();/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{I:nd}=Ol,Sn=r=>r.strings===void 0,ya=()=>document.createComment(""),Ei=(r,e,t)=>{var i;const o=r._$AA.parentNode,s=e===void 0?r._$AB:e._$AA;if(t===void 0){const a=o.insertBefore(ya(),s),l=o.insertBefore(ya(),s);t=new nd(a,l,r,r.options)}else{const a=t._$AB.nextSibling,l=t._$AM,d=l!==r;if(d){let u;(i=t._$AQ)===null||i===void 0||i.call(t,r),t._$AM=r,t._$AP!==void 0&&(u=r._$AU)!==l._$AU&&t._$AP(u)}if(a!==s||d){let u=t._$AA;for(;u!==a;){const p=u.nextSibling;o.insertBefore(u,s),u=p}}}return t},Et=(r,e,t=r)=>(r._$AI(e,t),r),ld={},$n=(r,e=ld)=>r._$AH=e,dd=r=>r._$AH,vr=r=>{var e;(e=r._$AP)===null||e===void 0||e.call(r,!1,!0);let t=r._$AA;const i=r._$AB.nextSibling;for(;t!==i;){const o=t.nextSibling;t.remove(),t=o}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const wa=(r,e,t)=>{const i=new Map;for(let o=e;o<=t;o++)i.set(r[o],o);return i},xs=yi(class extends wi{constructor(r){if(super(r),r.type!==Ve.CHILD)throw Error("repeat() can only be used in text expressions")}ct(r,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);const o=[],s=[];let a=0;for(const l of r)o[a]=i?i(l,a):a,s[a]=t(l,a),a++;return{values:s,keys:o}}render(r,e,t){return this.ct(r,e,t).values}update(r,[e,t,i]){var o;const s=dd(r),{values:a,keys:l}=this.ct(e,t,i);if(!Array.isArray(s))return this.ut=l,a;const d=(o=this.ut)!==null&&o!==void 0?o:this.ut=[],u=[];let p,m,v=0,y=s.length-1,S=0,x=a.length-1;for(;v<=y&&S<=x;)if(s[v]===null)v++;else if(s[y]===null)y--;else if(d[v]===l[S])u[S]=Et(s[v],a[S]),v++,S++;else if(d[y]===l[x])u[x]=Et(s[y],a[x]),y--,x--;else if(d[v]===l[x])u[x]=Et(s[v],a[x]),Ei(r,u[x+1],s[v]),v++,x--;else if(d[y]===l[S])u[S]=Et(s[y],a[S]),Ei(r,s[v],s[y]),y--,S++;else if(p===void 0&&(p=wa(l,S,x),m=wa(d,v,y)),p.has(d[v]))if(p.has(d[y])){const _=m.get(l[S]),D=_!==void 0?s[_]:null;if(D===null){const M=Ei(r,s[v]);Et(M,a[S]),u[S]=M}else u[S]=Et(D,a[S]),Ei(r,s[v],D),s[_]=null;S++}else vr(s[y]),y--;else vr(s[v]),v++;for(;S<=x;){const _=Ei(r,u[x+1]);Et(_,a[S]),u[S++]=_}for(;v<=y;){const _=s[v++];_!==null&&vr(_)}return this.ut=l,$n(r,u),Ae}});function co(r,e,t){return Array.from({length:(e-r)/t+1},(i,o)=>r+o*t)}let ct=class extends P{constructor(){super(...arguments),this.itemCount=0,this.scrollOptimizationsDisabled=!1,this.intersectionObserver=new IntersectionObserver(e=>{e.forEach(t=>{if(t.target===this.sentinel){t.isIntersecting&&this.dispatchEvent(new Event("scrollThresholdReached"));return}const o=t.target.dataset.cellIndex;if(!o)return;const s=parseInt(o,10);t.isIntersecting?this.visibleCellIndices.add(s):this.visibleCellIndices.delete(s)}),this.scrollOptimizationsDisabled||this.processVisibleCells()}),this.renderedCellIndices=new Set,this.visibleCellIndices=new Set,this.placeholderCellIndices=new Set}reload(){co(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.removeCell(t)),this.renderedCellIndices.clear(),this.visibleCellIndices.clear(),this.placeholderCellIndices.clear(),this.setupObservations()}refreshCell(e){this.removeCell(e),this.bufferRange.includes(e)&&this.renderCellBuffer([e])}refreshAllVisibleCells(){this.bufferRange.forEach(e=>this.removeCell(e)),this.renderCellBuffer(this.bufferRange)}scrollToCell(e,t){const i=this.cellContainers[e];if(!i)return!1;const o=t?"smooth":"auto";return i.scrollIntoView({behavior:o}),!0}getVisibleCellIndices(){return Array.from(this.visibleCellIndices)}updated(e){(e.has("itemCount")||e.has("scrollOptimizationsDisabled"))&&this.setupObservations()}disconnectedCallback(){this.intersectionObserver.disconnect()}setupObservations(){this.setupIntersectionObserver()}setupIntersectionObserver(){this.intersectionObserver.disconnect(),this.sentinel&&this.intersectionObserver.observe(this.sentinel),this.scrollOptimizationsDisabled?(co(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.visibleCellIndices.add(t)),this.processVisibleCells()):this.cellContainers.forEach(e=>this.intersectionObserver.observe(e))}render(){var e;const t=this.itemCount-1,i=co(0,t,1),o=(e=this.ariaLandmarkLabel)!==null&&e!==void 0?e:b;return h`
    ...
    `}};n([c({type:Number})],ct.prototype,"itemCount",void 0);n([c({type:Object})],ct.prototype,"cellProvider",void 0);n([c({type:Object})],ct.prototype,"placeholderCellTemplate",void 0);n([c({type:Boolean})],ct.prototype,"scrollOptimizationsDisabled",void 0);n([c({type:String})],ct.prototype,"ariaLandmarkLabel",void 0);n([V("#sentinel")],ct.prototype,"sentinel",void 0);n([Xl(".cell-container")],ct.prototype,"cellContainers",void 0);ct=n([R("infinite-scroller")],ct);function cd(r){return r?.replace(/%22%22(?!%22%22)(.+?)%22%22/g,"%22$1%22")}function hd(r){var e,t,i;return((e=r?.rawMetadata)===null||e===void 0?void 0:e.hit_type)==="favorited_search"?"search":(i=(t=r.mediatype)===null||t===void 0?void 0:t.value)!==null&&i!==void 0?i:"data"}const pd=N`
  <svg
    viewBox="0 0 100 100"
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ad=(r,e,t)=>{for(const i of e)if(i[0]===r)return(0,i[1])();return t?.()},Dd=N`
...
`;var tt;let De=tt=class extends P{constructor(){super(...arguments),this.placeholderType=null,this.detailMessage=""}render(){return this.placeholderType?h`${this.placeholderTemplate}`:b}get placeholderTemplate(){return h`
      <div
    ...
    `}};De.MESSAGE_EMPTY_QUERY=E('To begin searching, enter a search term in the box above and hit "Go".');De.MESSAGE_NO_SEARCH_RESULTS=E("Your search did not match any items in the Archive. Try different keywords or a more general search.");De.MESSAGE_NO_COLLECTION_RESULTS=E("Your search did not match any items in this collection. Try different keywords or a more general search.");De.MESSAGE_NO_VIEWABLE_MEMBERS=E("This collection contains no viewable items.");De.MESSAGE_QUERY_ERROR=E(h`The search engine encountered an error, which might be related to your
      search query.
      <a
        href="https://help.archive.org/help/search-building-powerful-complex-queries/"
      >
        Tips for constructing search queries.
      </a> `);De.MESSAGE_COLLECTION_ERROR=E(h`The search engine encountered an error while loading this collection.
      If the problem persists, please let us know at
      <a href="mailto:info@archive.org">info@archive.org</a>.`);De.QUERY_ERROR_DETAILS_MESSAGE=E("Error details:");n([c({type:String})],De.prototype,"placeholderType",void 0);n([c({type:Boolean})],De.prototype,"isMobileView",void 0);n([c({type:Boolean})],De.prototype,"isCollection",void 0);n([c({type:String})],De.prototype,"detailMessage",void 0);De=tt=n([R("empty-placeholder")],De);/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ee=r=>r??ee,Ln=N`
...
`;var Qr;(function(r){r[r.bytes=0]="bytes",r[r.kilobytes=1]="kilobytes",r[r.megabytes=2]="megabytes",r[r.gigabytes=3]="gigabytes",r[r.terabytes=4]="terabytes",r[r.petabytes=5]="petabytes",r[r.exabytes=6]="exabytes",r[r.zettabytes=7]="zettabytes",r[r.yottabytes=8]="yottabytes"})(Qr||(Qr={}));function Fd(r,e,t=" "){let i=r;if(i===void 0)return b;let o=0;for(;i>1024;)i/=1024,o+=1;const s=10**e;i=Math.round(i*s)/s;let a=Qr[o];return a=i===1?a.slice(0,-1):a,`${i.toLocaleString()+t+a}`}const Ld=f`var(--tileBackgroundColor, #ffffff)`,zd=f`var(--tileCornerRadius, 4px)`,Go=f`
...
`;function Xi(r,e="short",t="en-US"){if(!r)return"";const i={};switch(e){case"year-only":return`${r.getUTCFullYear()}`;case"short":i.month="short",i.year="numeric";break;case"long":i.year="numeric",i.month="short",i.day="2-digit";break}return new Intl.DateTimeFormat(t,i).format(r)}class _a{constructor(e={}){var t;this.model=e.model,this.baseNavigationUrl=e.baseNavigationUrl,this.collectionPagePath=(t=e.collectionPagePath)!==null&&t!==void 0?t:"/details/",this.sortParam=e.sortParam,this.creatorFilter=e.creatorFilter}get firstCreatorMatchingFilter(){var e,t;let i;if(this.creatorFilter&&(!((e=this.model)===null||e===void 0)&&e.creators.length)){const o=this.creatorFilter;i=this.model.creators.find(s=>s.normalize("NFD").replace(/[^A-Z]+/gi,"").toUpperCase().startsWith(o))}return i??((t=this.model)===null||t===void 0?void 0:t.creator)}get accountLabel(){var e;return!((e=this.model)===null||e===void 0)&&e.dateAdded?E(mt`Archivist since ${this.model.dateAdded.getFullYear()}`):""}get dateLabel(){var e;switch((e=this.sortParam)===null||e===void 0?void 0:e.field){case"publicdate":return E("Archived");case"reviewdate":return E("Reviewed");case"addeddate":return E("Added");case"date":return E("Published");default:return""}}itemPageUrl(e,t=!1){if(!e||this.baseNavigationUrl==null)return b;const i=t?this.collectionPagePath:"/details/";return`${this.baseNavigationUrl}${i}${e}`}webArchivesCaptureLink(e,t){const o=`https://web.archive.org/web/${t.toISOString().replace(/[TZ:-]/g,"").replace(/\..*/,"")}/${encodeURIComponent(e)}`,s=Xi(t,"long");return h` <a href=${o}> ${s} </a> `}}class de extends P{constructor(){super(...arguments),this.sortParam=null,this.defaultSortParam=null,this.loggedIn=!1,this.suppressBlurring=!1,this.displayValueProvider=new _a}willUpdate(e){var t,i;(e.has("model")||e.has("baseNavigationUrl")||e.has("collectionPagePath")||e.has("sortParam")||e.has("defaultSortParam")||e.has("creatorFilter"))&&(this.displayValueProvider=new _a({model:this.model,baseNavigationUrl:this.baseNavigationUrl,collectionPagePath:this.collectionPagePath,sortParam:(i=(t=this.sortParam)!==null&&t!==void 0?t:this.defaultSortParam)!==null&&i!==void 0?i:void 0,creatorFilter:this.creatorFilter}))}}n([c({type:Object})],de.prototype,"model",void 0);n([c({type:Number})],de.prototype,"currentWidth",void 0);n([c({type:Number})],de.prototype,"currentHeight",void 0);n([c({type:String})],de.prototype,"baseNavigationUrl",void 0);n([c({type:String})],de.prototype,"baseImageUrl",void 0);n([c({type:String})],de.prototype,"collectionPagePath",void 0);n([c({type:Object})],de.prototype,"sortParam",void 0);n([c({type:Object})],de.prototype,"defaultSortParam",void 0);n([c({type:String})],de.prototype,"creatorFilter",void 0);n([c({type:Number})],de.prototype,"mobileBreakpoint",void 0);n([c({type:Boolean})],de.prototype,"loggedIn",void 0);n([c({type:Boolean})],de.prototype,"suppressBlurring",void 0);let Kr=class extends P{render(){return h`<div class="icon-overlay">${this.iconTemplate}</div>`}get iconTemplate(){var e;return this.type?h`${(e=_n[this.type])!==null&&e!==void 0?e:b}`:b}static get styles(){return f`
    ...
    `}};n([c({type:String})],Kr.prototype,"type",void 0);Kr=n([R("icon-overlay")],Kr);let Xr=class extends P{render(){return h`
      <div class="overlay no-preview">
        <div class="icon-overlay">${this.iconTemplate}</div>
        <p class="text-overlay">${this.textTemplate}</p>
      </div>
    `}get iconTemplate(){var e;return this.type?h`${(e=_n[this.type])!==null&&e!==void 0?e:b}`:b}get textTemplate(){var e;return this.type?h`${(e=fd[this.type])!==null&&e!==void 0?e:b}`:b}static get styles(){return f`
      :host {
        align-items: center;
        display: flex;
      }
    ...
    `}};n([c({type:String})],Xr.prototype,"type",void 0);Xr=n([R("text-overlay")],Xr);let ht=class extends P{constructor(){super(...arguments),this.isCompactTile=!1,this.isListTile=!1,this.loggedIn=!1,this.suppressBlurring=!1,this.viewSize="desktop"}render(){var e;return!((e=this.model)===null||e===void 0)&&e.identifier?h`
    ...
    `}};n([c({type:String})],ht.prototype,"baseImageUrl",void 0);n([c({type:Boolean})],ht.prototype,"isCompactTile",void 0);n([c({type:Boolean})],ht.prototype,"isListTile",void 0);n([c({type:Boolean})],ht.prototype,"loggedIn",void 0);n([c({type:Boolean})],ht.prototype,"suppressBlurring",void 0);n([c({type:Object})],ht.prototype,"model",void 0);n([c({type:String})],ht.prototype,"viewSize",void 0);ht=n([R("image-block")],ht);let Zr=class extends de{constructor(){super(...arguments),this.showInfoButton=!1}render(){return h`
      <div class="container">
    ...
    >`}get getSizeTemplate(){var e,t;const i=(t=(e=this.model)===null||e===void 0?void 0:e.collectionSize)!==null&&t!==void 0?t:0;return i?h`<span id="item-size">${Fd(i,1)}</span>`:""}get infoButtonTemplate(){return this.showInfoButton?h`<button class="info-button" @click=${this.infoButtonPressed}>
          &#9432;
      ...
      `]}};n([c({type:Boolean})],Zr.prototype,"showInfoButton",void 0);Zr=n([R("collection-tile")],Zr);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*Pt(r,e){if(r!==void 0){let t=0;for(const i of r)yield e(i,t++)}}function Cs(r){return r?r.toISOString().endsWith("-01-01T00:00:00.000Z"):!1}const zn=h`
...
`;let hi=class extends P{constructor(){super(...arguments),this.title="",this.body="",this.starRating=0,this.viewSize="desktop"}render(){return!this.title&&!this.body&&!this.starRating?b:h`
    ...
    `}get filledStarTemplate(){return h`<span aria-hidden="true">${zn}</span>`}get unfilledStarTemplate(){return h`
      <span class="unfilled-star" aria-hidden="true">
        ${Bd}
      </span>
    `}static get styles(){return[ut,f`
        .review-container {
          display: flex;
          flex-direction: row;
          flex-wrap: wrap;
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*bo(r,e){const t=typeof e=="function";if(r!==void 0){let i=-1;for(const o of r)i>-1&&(yield t?e(i):e),i++,yield o}}let Bo=class extends P{constructor(){super(...arguments),this.snippets=[],this.viewSize="desktop"}render(){var e;return!((e=this.snippets)===null||e===void 0)&&e.length?h`
      <div class="container">
        <div class="snippet-view ${this.viewSize}">
    ...
    `}};n([c({type:Array})],Bo.prototype,"snippets",void 0);n([c({type:String})],Bo.prototype,"viewSize",void 0);Bo=n([R("text-snippet-block")],Bo);const Pd=f`
  .drop-shadow {
    overflow: hidden;
    height: 100%;
  }
...
`;let Ge=class extends P{constructor(){super(...arguments),this.isListTile=!1,this.isCompactTile=!1,this.loggedIn=!1,this.suppressBlurring=!1,this.isWaveform=!1,this.isNotFound=!1}render(){return h`
    ...
    `}get imageSrc(){var e,t,i;if(this.isNotFound)return this.notFoundSrc;if(!((e=this.model)===null||e===void 0)&&e.captureDates&&this.model.identifier)try{const o=new URL(this.model.identifier),s=encodeURIComponent(o.hostname);return this.baseImageUrl?`https://web.archive.org/thumb/${s}?generate=1`:b}catch{return`${this.baseImageUrl}/images/notfound.png`}return!((t=this.model)===null||t===void 0)&&t.thumbnailUrl?this.model.thumbnailUrl:this.baseImageUrl&&(!((i=this.model)===null||i===void 0)&&i.identifier)?`${this.baseImageUrl}/services/img/${this.model.identifier}`:b}get notFoundSrc(){return this.baseImageUrl?`${this.baseImageUrl}/images/notfound.png`:b}get hashBasedGradient(){var e;return!((e=this.model)===null||e===void 0)&&e.identifier?`waveform-grad${this.hashStrToInt(this.model.identifier)%6}`:"waveform-grad0"}hashStrToInt(e){return e.split("").reduce((t,i)=>t+i.charCodeAt(0),0)}get itemBaseClass(){var e;return{"drop-shadow":!0,"list-box":this.isListTile,"search-image":((e=this.model)===null||e===void 0?void 0:e.mediatype)==="search",[this.hashBasedGradient]:this.isWaveform}}get itemImageClass(){var e,t,i;const s=!!(!((e=this.model)===null||e===void 0)&&e.contentWarning||!((t=this.model)===null||t===void 0)&&t.loginRequired)&&!this.suppressBlurring;return{contain:!this.isCompactTile&&!this.isWaveform,cover:this.isCompactTile,blur:s,waveform:this.isWaveform,"account-image":this.isAccountImage,"collection-image":((i=this.model)===null||i===void 0?void 0:i.mediatype)==="collection"}}get isAccountImage(){var e;return((e=this.model)===null||e===void 0?void 0:e.mediatype)==="account"&&!this.isCompactTile&&!this.isListTile}onLoad(){var e,t;(((e=this.model)===null||e===void 0?void 0:e.mediatype)==="audio"||((t=this.model)===null||t===void 0?void 0:t.mediatype)==="etree")&&this.baseImage.naturalWidth/this.baseImage.naturalHeight===4&&(this.isWaveform=!0)}onError(){this.isNotFound=!0}static get styles(){return[Pd,Rd,f`
      ...
      `]}};n([c({type:Object})],Ge.prototype,"model",void 0);n([c({type:String})],Ge.prototype,"baseImageUrl",void 0);n([c({type:Boolean})],Ge.prototype,"isListTile",void 0);n([c({type:Boolean})],Ge.prototype,"isCompactTile",void 0);n([c({type:Boolean})],Ge.prototype,"loggedIn",void 0);n([c({type:Boolean})],Ge.prototype,"suppressBlurring",void 0);n([F()],Ge.prototype,"isWaveform",void 0);n([F()],Ge.prototype,"isNotFound",void 0);n([V("img")],Ge.prototype,"baseImage",void 0);Ge=n([R("item-image")],Ge);const Id=N`
...
`,Pn={account:{color:"#000000",icon:Id,text:"Account"},audio:{color:"#00adef",icon:Od,text:"Audio"},collection:{color:"#4666ff",icon:Ln,text:"Collection"},data:{color:"#333333",icon:Nd,text:"Data"},etree:{color:"#00adef",icon:Ud,text:"E-tree"},film:{color:"#bf1b2c",icon:Ca,text:"Film"},image:{color:"#aa99c9",icon:Hd,text:"Image"},movies:{color:"#f1644b",icon:Ca,text:"Movie"},none:{color:"#00000000",icon:h``,text:""},radio:{color:"#8fdaef",icon:Vd,text:"Radio"},software:{color:"#9ecc4f",icon:Wd,text:"Software"},texts:{color:"#faab3c",icon:jd,text:"Text"},tv:{color:"#f1644b",icon:qd,text:"TV"},tvCommercial:{color:"#84b648",icon:Gd,text:"TV Commercial"},tvFactCheck:{color:"#f1644b",icon:Yd,text:"TV Fact Check"},tvQuote:{color:"#fe7a5f",icon:Xd,text:"TV Quote"},video:{color:"#f1644b",icon:Qd,text:"Video"},web:{color:"#ffcd27",icon:Kd,text:"Web"},search:{color:"#000000",icon:Bn,text:"Search"}},Zd="tv_ads",Jd="factchecked",ec=new Set(["tvnews","tvarchive","television"]),tc=new Set(["radio","radioprogram"]);let Po=class extends P{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var e,t;return this.isTvItem?this.tvDisplayMediatype:this.isRadioItem?"radio":(t=(e=this.model)===null||e===void 0?void 0:e.mediatype)!==null&&t!==void 0?t:"none"}get tvDisplayMediatype(){var e,t;return this.isTvCommercial?"tvCommercial":!((e=this.model)===null||e===void 0)&&e.isTvSearchResult&&this.isTvFactCheck?"tvFactCheck":!((t=this.model)===null||t===void 0)&&t.isTvSearchResult&&this.isTvQuote?"tvQuote":"tv"}get isTvItem(){var e,t;return!!(((e=this.model)===null||e===void 0?void 0:e.mediatype)==="movies"&&(!((t=this.model)===null||t===void 0)&&t.collections.some(i=>ec.has(i))))}get isTvCommercial(){var e,t,i;return!!(!((t=(e=this.model)===null||e===void 0?void 0:e.adIds)===null||t===void 0)&&t.length||!((i=this.model)===null||i===void 0)&&i.collections.includes(Zd))}get isTvFactCheck(){var e,t,i;return!!(!((t=(e=this.model)===null||e===void 0?void 0:e.factChecks)===null||t===void 0)&&t.length||!((i=this.model)===null||i===void 0)&&i.collections.includes(Jd))}get isTvQuote(){var e;return!!(!((e=this.model)===null||e===void 0)&&e.isClip)}get isRadioItem(){var e,t;return!!(((e=this.model)===null||e===void 0?void 0:e.mediatype)==="audio"&&(!((t=this.model)===null||t===void 0)&&t.collections.some(i=>tc.has(i))))}render(){const e=Pn[this.displayMediatype];return e?h`
      <div
        id="icon"
    ...
    `}};n([c({type:Object})],Po.prototype,"model",void 0);n([c({type:Boolean})],Po.prototype,"showText",void 0);Po=n([R("tile-mediatype-icon")],Po);const ic=N`
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path
...
`;function ac(r,e){let t=1;return r>=1e9?t=1e9:r>=1e6?t=1e6:r>=1e3&&e==="short"&&(t=1e3),t}function nc(r=0,e){const t=r/e,i=t<10;let o=0;return i?o=Math.round((t+Number.EPSILON)*10)/10:o=Math.round(t),o}function lc(r,e,t,i){switch(e){case 1e9:return E(t==="short"?mt`${r}B`:mt`${r} billion`);case 1e6:return E(t==="short"?mt`${r}M`:mt`${r} million`);case 1e3:return E(t==="short"?mt`${r}K`:mt`${r} thousand`);default:return new Intl.NumberFormat(i).format(r)}}function ks(r,e="long",t="short",i="en-US"){const o=r??-1;if(o<0)return"";const s=ac(o,e),a=nc(o,s);return lc(a,s,t,i)}let Ye=class extends P{constructor(){super(...arguments),this.showTvClips=!1}render(){return h`
    ...
    `}columnTemplate(e,t,i,o=[]){const s=ks(e??0,"short","short"),a=E(mt`${s} ${t}`),l=t+":";return h`
    ...
    `}get viewsColumnTemplate(){var e;const t=(e=this.viewLabel)!==null&&e!==void 0?e:E("all-time views");return this.columnTemplate(this.viewCount,t,rc)}get uploadsColumnTemplate(){return this.columnTemplate(this.itemCount,E("uploads"),oc)}get favoritesColumnTemplate(){return this.columnTemplate(this.favCount,E("favorites"),zn)}get reviewsColumnTemplate(){return this.columnTemplate(this.commentCount,E("reviews"),ic,["reviews"])}get tvClipsColumnTemplate(){return this.columnTemplate(this.tvClipCount,E("clips"),sc)}static get styles(){return[ut,f`
        tile-mediatype-icon {
          --iconHeight: 25px;
          --iconWidth: 25px;
        }
      ...
      `]}};n([c({type:Object})],Ye.prototype,"model",void 0);n([c({type:String})],Ye.prototype,"mediatype",void 0);n([c({type:Number})],Ye.prototype,"itemCount",void 0);n([c({type:Number})],Ye.prototype,"viewCount",void 0);n([c({type:String})],Ye.prototype,"viewLabel",void 0);n([c({type:Number})],Ye.prototype,"favCount",void 0);n([c({type:Number})],Ye.prototype,"commentCount",void 0);n([c({type:Boolean})],Ye.prototype,"showTvClips",void 0);n([c({type:Number})],Ye.prototype,"tvClipCount",void 0);Ye=n([R("tile-stats")],Ye);let Zi=class extends de{constructor(){super(...arguments),this.showInfoButton=!1,this.showTvClips=!1,this.simpleLayoutType="none"}render(){var e;const t=(e=this.model)===null||e===void 0?void 0:e.title,i=We({container:!0,simple:this.simpleLayoutType!=="none","stats-only":this.simpleLayoutType==="stats-only","snippets-only":this.simpleLayoutType==="snippets-only"});return h`
      <div class=${i}>
        ${this.infoButtonTemplate}
        <div class="tile-details">
          <div class="item-info">
    ...
    `}get sortedDateInfoTemplate(){var e,t,i,o,s;let a,l="long";switch((e=this.effectiveSort)===null||e===void 0?void 0:e.field){case"date":{const d=(t=this.model)===null||t===void 0?void 0:t.datePublished;a={field:"published",value:d},Cs(d)&&(l="year-only");break}case"reviewdate":a={field:"reviewed",value:(i=this.model)===null||i===void 0?void 0:i.dateReviewed};break;case"addeddate":a={field:"added",value:(o=this.model)===null||o===void 0?void 0:o.dateAdded};break;case"publicdate":a={field:"archived",value:(s=this.model)===null||s===void 0?void 0:s.dateArchived};break}return a?.value?h`
      <div class="date-sorted-by truncated">
        <span>
          ${a?.field} ${Xi(a?.value,l)}
        </span>
      </div>
    ...
    `}get tileStatsTemplate(){var e,t,i,o,s,a,l;if(this.simpleLayoutType==="snippets-only")return b;const d=(e=this.sortParam)!==null&&e!==void 0?e:this.defaultSortParam,[u,p]=d?.field==="week"?[(t=this.model)===null||t===void 0?void 0:t.weeklyViewCount,"weekly views"]:[(i=this.model)===null||i===void 0?void 0:i.viewCount,"all-time views"];return h`
      <tile-stats
        .model=${this.model}
    ...
    `}get isSortedByDate(){var e;return["date","reviewdate","addeddate","publicdate"].includes((e=this.effectiveSort)===null||e===void 0?void 0:e.field)}get effectiveSort(){var e;return(e=this.sortParam)!==null&&e!==void 0?e:this.defaultSortParam}get hasSnippets(){var e,t;return!!(!((t=(e=this.model)===null||e===void 0?void 0:e.snippets)===null||t===void 0)&&t.length)}infoButtonPressed(e){e.preventDefault();const t=new CustomEvent("infoButtonPressed",{detail:{x:e.clientX,y:e.clientY}});this.dispatchEvent(t)}static get styles(){const e=f`var(--tileBorderColor, #dddddd)`;return[Go,f`
      ...
      `]}};n([c({type:Boolean})],Zi.prototype,"showInfoButton",void 0);n([c({type:Boolean})],Zi.prototype,"showTvClips",void 0);n([c({type:String})],Zi.prototype,"simpleLayoutType",void 0);Zi=n([R("item-tile")],Zi);let Jr=class extends de{constructor(){super(...arguments),this.showInfoButton=!1}render(){return h`
      <div class="container">
        ${this.infoButtonTemplate}
        <div class="tile-details">
          <div class="item-info">
    ...
    >
      ...
      `]}};n([c({type:Boolean})],Jr.prototype,"showInfoButton",void 0);Jr=n([R("account-tile")],Jr);let es=class extends de{constructor(){super(...arguments),this.showInfoButton=!1}render(){return h`
      <div class="container">
        <div class="tile-details">
          <div class="item-info">
            ${this.getImageBlockTemplate} ${this.getTitleTemplate}
    ...
    `}get getTitleTemplate(){var e;return h`<div id="title">
      ...
      `]}};n([c({type:Boolean})],es.prototype,"showInfoButton",void 0);es=n([R("search-tile")],es);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class ts extends wi{constructor(e){if(super(e),this.et=ee,e.type!==Ve.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===ee||e==null)return this.ft=void 0,this.et=e;if(e===Ae)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.et)return this.ft;this.et=e;const t=[e];return t.raw=t,this.ft={_$litType$:this.constructor.resultType,strings:t,values:[]}}}ts.directiveName="unsafeHTML",ts.resultType=1;const dc=yi(ts);/*! @license DOMPurify 3.2.4 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/3.2.4/LICENSE */const{entries:Rn,setPrototypeOf:ka,isFrozen:cc,getPrototypeOf:hc,getOwnPropertyDescriptor:pc}=Object;let{freeze:$e,seal:Re,create:In}=Object,{apply:is,construct:os}=typeof Reflect<"u"&&Reflect;$e||($e=function(e){return e});Re||(Re=function(e){return e});is||(is=function(e,t,i){return e.apply(t,i)});os||(os=function(e,t){return new e(...t)});const po=_e(Array.prototype.forEach),uc=_e(Array.prototype.lastIndexOf),Ta=_e(Array.prototype.pop),Mi=_e(Array.prototype.push),fc=_e(Array.prototype.splice),yo=_e(String.prototype.toLowerCase),gr=_e(String.prototype.toString),Ea=_e(String.prototype.match),Ai=_e(String.prototype.replace),mc=_e(String.prototype.indexOf),vc=_e(String.prototype.trim),Ne=_e(Object.prototype.hasOwnProperty),xe=_e(RegExp.prototype.test),Di=gc(TypeError);function _e(r){return function(e){for(var t=arguments.length,i=new Array(t>1?t-1:0),o=1;o<t;o++)i[o-1]=arguments[o];return is(r,e,i)}}function gc(r){return function(){for(var e=arguments.length,t=new Array(e),i=0;i<e;i++)t[i]=arguments[i];return os(r,t)}}function U(r,e){let t=arguments.length>2&&arguments[2]!==void 0?arguments[2]:yo;ka&&ka(r,null);let i=e.length;for(;i--;){let o=e[i];if(typeof o=="string"){const s=t(o);s!==o&&(cc(e)||(e[i]=s),o=s)}r[o]=!0}return r}function bc(r){for(let e=0;e<r.length;e++)Ne(r,e)||(r[e]=null);return r}function Dt(r){const e=In(null);for(const[t,i]of Rn(r))Ne(r,t)&&(Array.isArray(i)?e[t]=bc(i):i&&typeof i=="object"&&i.constructor===Object?e[t]=Dt(i):e[t]=i);return e}function Fi(r,e){for(;r!==null;){const i=pc(r,e);if(i){if(i.get)return _e(i.get);if(typeof i.value=="function")return _e(i.value)}r=hc(r)}function t(){return null}return t}const Ma=$e(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","section","select","shadow","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),br=$e(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","filter","font","g","glyph","glyphref","hkern","image","line","lineargradient","marker","mask","metadata","mpath","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),yr=$e(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feDropShadow","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),yc=$e(["animate","color-profile","cursor","discard","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),wr=$e(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover","mprescripts"]),wc=$e(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),Aa=$e(["#text"]),Da=$e(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","face","for","headers","height","hidden","high","href","hreflang","id","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","pattern","placeholder","playsinline","popover","popovertarget","popovertargetaction","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","wrap","xmlns","slot"]),xr=$e(["accent-height","accumulate","additive","alignment-baseline","amplitude","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","exponent","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","intercept","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","slope","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","tablevalues","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),Fa=$e(["accent","accentunder","align","bevelled","close","columnsalign","columnlines","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lspace","lquote","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),uo=$e(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),xc=Re(/\{\{[\w\W]*|[\w\W]*\}\}/gm),Sc=Re(/<%[\w\W]*|[\w\W]*%>/gm),$c=Re(/\$\{[\w\W]*/gm),_c=Re(/^data-[\-\w.\u00B7-\uFFFF]+$/),Cc=Re(/^aria-[\-\w]+$/),On=Re(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),kc=Re(/^(?:\w+script|data):/i),Tc=Re(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),Nn=Re(/^html$/i),Ec=Re(/^[a-z][.\w]*(-[.\w]+)+$/i);var La=Object.freeze({__proto__:null,ARIA_ATTR:Cc,ATTR_WHITESPACE:Tc,CUSTOM_ELEMENT:Ec,DATA_ATTR:_c,DOCTYPE_NAME:Nn,ERB_EXPR:Sc,IS_ALLOWED_URI:On,IS_SCRIPT_OR_DATA:kc,MUSTACHE_EXPR:xc,TMPLIT_EXPR:$c});const Li={element:1,text:3,progressingInstruction:7,comment:8,document:9},Mc=function(){return typeof window>"u"?null:window},Ac=function(e,t){if(typeof e!="object"||typeof e.createPolicy!="function")return null;let i=null;const o="data-tt-policy-suffix";t&&t.hasAttribute(o)&&(i=t.getAttribute(o));const s="dompurify"+(i?"#"+i:"");try{return e.createPolicy(s,{createHTML(a){return a},createScriptURL(a){return a}})}catch{return console.warn("TrustedTypes policy "+s+" could not be created."),null}},za=function(){return{afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}};function Un(){let r=arguments.length>0&&arguments[0]!==void 0?arguments[0]:Mc();const e=z=>Un(z);if(e.version="3.2.4",e.removed=[],!r||!r.document||r.document.nodeType!==Li.document||!r.Element)return e.isSupported=!1,e;let{document:t}=r;const i=t,o=i.currentScript,{DocumentFragment:s,HTMLTemplateElement:a,Node:l,Element:d,NodeFilter:u,NamedNodeMap:p=r.NamedNodeMap||r.MozNamedAttrMap,HTMLFormElement:m,DOMParser:v,trustedTypes:y}=r,S=d.prototype,x=Fi(S,"cloneNode"),_=Fi(S,"remove"),D=Fi(S,"nextSibling"),M=Fi(S,"childNodes"),A=Fi(S,"parentNode");if(typeof a=="function"){const z=t.createElement("template");z.content&&z.content.ownerDocument&&(t=z.content.ownerDocument)}let I,W="";const{implementation:se,createNodeIterator:ze,createDocumentFragment:ge,getElementsByTagName:ce}=t,{importNode:Me}=i;let Q=za();e.isSupported=typeof Rn=="function"&&typeof A=="function"&&se&&se.createHTMLDocument!==void 0;const{MUSTACHE_EXPR:Xe,ERB_EXPR:Ze,TMPLIT_EXPR:K,DATA_ATTR:he,ARIA_ATTR:Be,IS_SCRIPT_OR_DATA:St,ATTR_WHITESPACE:Ht,CUSTOM_ELEMENT:xi}=La;let{IS_ALLOWED_URI:Vt}=La,oe=null;const Wt=U({},[...Ma,...br,...yr,...wr,...Aa]);let ae=null;const jt=U({},[...Da,...xr,...Fa,...uo]);let X=Object.seal(In(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),st=null,$t=null,qt=!0,_t=!0,Si=!1,Ds=!0,Gt=!1,Ko=!0,Ct=!1,Xo=!1,Zo=!1,Yt=!1,io=!1,oo=!1,Fs=!0,Ls=!1;const el="user-content-";let Jo=!0,$i=!1,Qt={},Kt=null;const zs=U({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","style","svg","template","thead","title","video","xmp"]);let Bs=null;const Ps=U({},["audio","video","img","source","image","track"]);let er=null;const Rs=U({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),ro="http://www.w3.org/1998/Math/MathML",so="http://www.w3.org/2000/svg",at="http://www.w3.org/1999/xhtml";let Xt=at,tr=!1,ir=null;const tl=U({},[ro,so,at],gr);let ao=U({},["mi","mo","mn","ms","mtext"]),no=U({},["annotation-xml"]);const il=U({},["title","style","font","a","script"]);let _i=null;const ol=["application/xhtml+xml","text/html"],rl="text/html";let ue=null,Zt=null;const sl=t.createElement("form"),Is=function(g){return g instanceof RegExp||g instanceof Function},or=function(){let g=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if(!(Zt&&Zt===g)){if((!g||typeof g!="object")&&(g={}),g=Dt(g),_i=ol.indexOf(g.PARSER_MEDIA_TYPE)===-1?rl:g.PARSER_MEDIA_TYPE,ue=_i==="application/xhtml+xml"?gr:yo,oe=Ne(g,"ALLOWED_TAGS")?U({},g.ALLOWED_TAGS,ue):Wt,ae=Ne(g,"ALLOWED_ATTR")?U({},g.ALLOWED_ATTR,ue):jt,ir=Ne(g,"ALLOWED_NAMESPACES")?U({},g.ALLOWED_NAMESPACES,gr):tl,er=Ne(g,"ADD_URI_SAFE_ATTR")?U(Dt(Rs),g.ADD_URI_SAFE_ATTR,ue):Rs,Bs=Ne(g,"ADD_DATA_URI_TAGS")?U(Dt(Ps),g.ADD_DATA_URI_TAGS,ue):Ps,Kt=Ne(g,"FORBID_CONTENTS")?U({},g.FORBID_CONTENTS,ue):zs,st=Ne(g,"FORBID_TAGS")?U({},g.FORBID_TAGS,ue):{},$t=Ne(g,"FORBID_ATTR")?U({},g.FORBID_ATTR,ue):{},Qt=Ne(g,"USE_PROFILES")?g.USE_PROFILES:!1,qt=g.ALLOW_ARIA_ATTR!==!1,_t=g.ALLOW_DATA_ATTR!==!1,Si=g.ALLOW_UNKNOWN_PROTOCOLS||!1,Ds=g.ALLOW_SELF_CLOSE_IN_ATTR!==!1,Gt=g.SAFE_FOR_TEMPLATES||!1,Ko=g.SAFE_FOR_XML!==!1,Ct=g.WHOLE_DOCUMENT||!1,Yt=g.RETURN_DOM||!1,io=g.RETURN_DOM_FRAGMENT||!1,oo=g.RETURN_TRUSTED_TYPE||!1,Zo=g.FORCE_BODY||!1,Fs=g.SANITIZE_DOM!==!1,Ls=g.SANITIZE_NAMED_PROPS||!1,Jo=g.KEEP_CONTENT!==!1,$i=g.IN_PLACE||!1,Vt=g.ALLOWED_URI_REGEXP||On,Xt=g.NAMESPACE||at,ao=g.MATHML_TEXT_INTEGRATION_POINTS||ao,no=g.HTML_INTEGRATION_POINTS||no,X=g.CUSTOM_ELEMENT_HANDLING||{},g.CUSTOM_ELEMENT_HANDLING&&Is(g.CUSTOM_ELEMENT_HANDLING.tagNameCheck)&&(X.tagNameCheck=g.CUSTOM_ELEMENT_HANDLING.tagNameCheck),g.CUSTOM_ELEMENT_HANDLING&&Is(g.CUSTOM_ELEMENT_HANDLING.attributeNameCheck)&&(X.attributeNameCheck=g.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),g.CUSTOM_ELEMENT_HANDLING&&typeof g.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements=="boolean"&&(X.allowCustomizedBuiltInElements=g.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements),Gt&&(_t=!1),io&&(Yt=!0),Qt&&(oe=U({},Aa),ae=[],Qt.html===!0&&(U(oe,Ma),U(ae,Da)),Qt.svg===!0&&(U(oe,br),U(ae,xr),U(ae,uo)),Qt.svgFilters===!0&&(U(oe,yr),U(ae,xr),U(ae,uo)),Qt.mathMl===!0&&(U(oe,wr),U(ae,Fa),U(ae,uo))),g.ADD_TAGS&&(oe===Wt&&(oe=Dt(oe)),U(oe,g.ADD_TAGS,ue)),g.ADD_ATTR&&(ae===jt&&(ae=Dt(ae)),U(ae,g.ADD_ATTR,ue)),g.ADD_URI_SAFE_ATTR&&U(er,g.ADD_URI_SAFE_ATTR,ue),g.FORBID_CONTENTS&&(Kt===zs&&(Kt=Dt(Kt)),U(Kt,g.FORBID_CONTENTS,ue)),Jo&&(oe["#text"]=!0),Ct&&U(oe,["html","head","body"]),oe.table&&(U(oe,["tbody"]),delete st.tbody),g.TRUSTED_TYPES_POLICY){if(typeof g.TRUSTED_TYPES_POLICY.createHTML!="function")throw Di('TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.');if(typeof g.TRUSTED_TYPES_POLICY.createScriptURL!="function")throw Di('TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.');I=g.TRUSTED_TYPES_POLICY,W=I.createHTML("")}else I===void 0&&(I=Ac(y,o)),I!==null&&typeof W=="string"&&(W=I.createHTML(""));$e&&$e(g),Zt=g}},Os=U({},[...br,...yr,...yc]),Ns=U({},[...wr,...wc]),al=function(g){let $=A(g);(!$||!$.tagName)&&($={namespaceURI:Xt,tagName:"template"});const L=yo(g.tagName),J=yo($.tagName);return ir[g.namespaceURI]?g.namespaceURI===so?$.namespaceURI===at?L==="svg":$.namespaceURI===ro?L==="svg"&&(J==="annotation-xml"||ao[J]):!!Os[L]:g.namespaceURI===ro?$.namespaceURI===at?L==="math":$.namespaceURI===so?L==="math"&&no[J]:!!Ns[L]:g.namespaceURI===at?$.namespaceURI===so&&!no[J]||$.namespaceURI===ro&&!ao[J]?!1:!Ns[L]&&(il[L]||!Os[L]):!!(_i==="application/xhtml+xml"&&ir[g.namespaceURI]):!1},Je=function(g){Mi(e.removed,{element:g});try{A(g).removeChild(g)}catch{_(g)}},lo=function(g,$){try{Mi(e.removed,{attribute:$.getAttributeNode(g),from:$})}catch{Mi(e.removed,{attribute:null,from:$})}if($.removeAttribute(g),g==="is")if(Yt||io)try{Je($)}catch{}else try{$.setAttribute(g,"")}catch{}},Us=function(g){let $=null,L=null;if(Zo)g="<remove></remove>"+g;else{const fe=Ea(g,/^[\r\n\t ]+/);L=fe&&fe[0]}_i==="application/xhtml+xml"&&Xt===at&&(g='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+g+"</body></html>");const J=I?I.createHTML(g):g;if(Xt===at)try{$=new v().parseFromString(J,_i)}catch{}if(!$||!$.documentElement){$=se.createDocument(Xt,"template",null);try{$.documentElement.innerHTML=tr?W:J}catch{}}const be=$.body||$.documentElement;return g&&L&&be.insertBefore(t.createTextNode(L),be.childNodes[0]||null),Xt===at?ce.call($,Ct?"html":"body")[0]:Ct?$.documentElement:be},Hs=function(g){return ze.call(g.ownerDocument||g,g,u.SHOW_ELEMENT|u.SHOW_COMMENT|u.SHOW_TEXT|u.SHOW_PROCESSING_INSTRUCTION|u.SHOW_CDATA_SECTION,null)},rr=function(g){return g instanceof m&&(typeof g.nodeName!="string"||typeof g.textContent!="string"||typeof g.removeChild!="function"||!(g.attributes instanceof p)||typeof g.removeAttribute!="function"||typeof g.setAttribute!="function"||typeof g.namespaceURI!="string"||typeof g.insertBefore!="function"||typeof g.hasChildNodes!="function")},Vs=function(g){return typeof l=="function"&&g instanceof l};function nt(z,g,$){po(z,L=>{L.call(e,g,$,Zt)})}const Ws=function(g){let $=null;if(nt(Q.beforeSanitizeElements,g,null),rr(g))return Je(g),!0;const L=ue(g.nodeName);if(nt(Q.uponSanitizeElement,g,{tagName:L,allowedTags:oe}),g.hasChildNodes()&&!Vs(g.firstElementChild)&&xe(/<[/\w]/g,g.innerHTML)&&xe(/<[/\w]/g,g.textContent)||g.nodeType===Li.progressingInstruction||Ko&&g.nodeType===Li.comment&&xe(/<[/\w]/g,g.data))return Je(g),!0;if(!oe[L]||st[L]){if(!st[L]&&qs(L)&&(X.tagNameCheck instanceof RegExp&&xe(X.tagNameCheck,L)||X.tagNameCheck instanceof Function&&X.tagNameCheck(L)))return!1;if(Jo&&!Kt[L]){const J=A(g)||g.parentNode,be=M(g)||g.childNodes;if(be&&J){const fe=be.length;for(let Te=fe-1;Te>=0;--Te){const et=x(be[Te],!0);et.__removalCount=(g.__removalCount||0)+1,J.insertBefore(et,D(g))}}}return Je(g),!0}return g instanceof d&&!al(g)||(L==="noscript"||L==="noembed"||L==="noframes")&&xe(/<\/no(script|embed|frames)/i,g.innerHTML)?(Je(g),!0):(Gt&&g.nodeType===Li.text&&($=g.textContent,po([Xe,Ze,K],J=>{$=Ai($,J," ")}),g.textContent!==$&&(Mi(e.removed,{element:g.cloneNode()}),g.textContent=$)),nt(Q.afterSanitizeElements,g,null),!1)},js=function(g,$,L){if(Fs&&($==="id"||$==="name")&&(L in t||L in sl))return!1;if(!(_t&&!$t[$]&&xe(he,$))){if(!(qt&&xe(Be,$))){if(!ae[$]||$t[$]){if(!(qs(g)&&(X.tagNameCheck instanceof RegExp&&xe(X.tagNameCheck,g)||X.tagNameCheck instanceof Function&&X.tagNameCheck(g))&&(X.attributeNameCheck instanceof RegExp&&xe(X.attributeNameCheck,$)||X.attributeNameCheck instanceof Function&&X.attributeNameCheck($))||$==="is"&&X.allowCustomizedBuiltInElements&&(X.tagNameCheck instanceof RegExp&&xe(X.tagNameCheck,L)||X.tagNameCheck instanceof Function&&X.tagNameCheck(L))))return!1}else if(!er[$]){if(!xe(Vt,Ai(L,Ht,""))){if(!(($==="src"||$==="xlink:href"||$==="href")&&g!=="script"&&mc(L,"data:")===0&&Bs[g])){if(!(Si&&!xe(St,Ai(L,Ht,"")))){if(L)return!1}}}}}}return!0},qs=function(g){return g!=="annotation-xml"&&Ea(g,xi)},Gs=function(g){nt(Q.beforeSanitizeAttributes,g,null);const{attributes:$}=g;if(!$||rr(g))return;const L={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:ae,forceKeepAttr:void 0};let J=$.length;for(;J--;){const be=$[J],{name:fe,namespaceURI:Te,value:et}=be,Ci=ue(fe);let we=fe==="value"?et:vc(et);if(L.attrName=Ci,L.attrValue=we,L.keepAttr=!0,L.forceKeepAttr=void 0,nt(Q.uponSanitizeAttribute,g,L),we=L.attrValue,Ls&&(Ci==="id"||Ci==="name")&&(lo(fe,g),we=el+we),Ko&&xe(/((--!?|])>)|<\/(style|title)/i,we)){lo(fe,g);continue}if(L.forceKeepAttr||(lo(fe,g),!L.keepAttr))continue;if(!Ds&&xe(/\/>/i,we)){lo(fe,g);continue}Gt&&po([Xe,Ze,K],Qs=>{we=Ai(we,Qs," ")});const Ys=ue(g.nodeName);if(js(Ys,Ci,we)){if(I&&typeof y=="object"&&typeof y.getAttributeType=="function"&&!Te)switch(y.getAttributeType(Ys,Ci)){case"TrustedHTML":{we=I.createHTML(we);break}case"TrustedScriptURL":{we=I.createScriptURL(we);break}}try{Te?g.setAttributeNS(Te,fe,we):g.setAttribute(fe,we),rr(g)?Je(g):Ta(e.removed)}catch{}}}nt(Q.afterSanitizeAttributes,g,null)},nl=function z(g){let $=null;const L=Hs(g);for(nt(Q.beforeSanitizeShadowDOM,g,null);$=L.nextNode();)nt(Q.uponSanitizeShadowNode,$,null),Ws($),Gs($),$.content instanceof s&&z($.content);nt(Q.afterSanitizeShadowDOM,g,null)};return e.sanitize=function(z){let g=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},$=null,L=null,J=null,be=null;if(tr=!z,tr&&(z="<!-->"),typeof z!="string"&&!Vs(z))if(typeof z.toString=="function"){if(z=z.toString(),typeof z!="string")throw Di("dirty is not a string, aborting")}else throw Di("toString is not a function");if(!e.isSupported)return z;if(Xo||or(g),e.removed=[],typeof z=="string"&&($i=!1),$i){if(z.nodeName){const et=ue(z.nodeName);if(!oe[et]||st[et])throw Di("root node is forbidden and cannot be sanitized in-place")}}else if(z instanceof l)$=Us("<!---->"),L=$.ownerDocument.importNode(z,!0),L.nodeType===Li.element&&L.nodeName==="BODY"||L.nodeName==="HTML"?$=L:$.appendChild(L);else{if(!Yt&&!Gt&&!Ct&&z.indexOf("<")===-1)return I&&oo?I.createHTML(z):z;if($=Us(z),!$)return Yt?null:oo?W:""}$&&Zo&&Je($.firstChild);const fe=Hs($i?z:$);for(;J=fe.nextNode();)Ws(J),Gs(J),J.content instanceof s&&nl(J.content);if($i)return z;if(Yt){if(io)for(be=ge.call($.ownerDocument);$.firstChild;)be.appendChild($.firstChild);else be=$;return(ae.shadowroot||ae.shadowrootmode)&&(be=Me.call(i,be,!0)),be}let Te=Ct?$.outerHTML:$.innerHTML;return Ct&&oe["!doctype"]&&$.ownerDocument&&$.ownerDocument.doctype&&$.ownerDocument.doctype.name&&xe(Nn,$.ownerDocument.doctype.name)&&(Te="<!DOCTYPE "+$.ownerDocument.doctype.name+`>
`+Te),Gt&&po([Xe,Ze,K],et=>{Te=Ai(Te,et," ")}),I&&oo?I.createHTML(Te):Te},e.setConfig=function(){let z=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};or(z),Xo=!0},e.clearConfig=function(){Zt=null,Xo=!1},e.isValidAttribute=function(z,g,$){Zt||or({});const L=ue(z),J=ue(g);return js(L,J,$)},e.addHook=function(z,g){typeof g=="function"&&Mi(Q[z],g)},e.removeHook=function(z,g){if(g!==void 0){const $=uc(Q[z],g);return $===-1?void 0:fc(Q[z],$,1)[0]}return Ta(Q[z])},e.removeHooks=function(z){Q[z]=[]},e.removeAllHooks=function(){Q=za()},e}var wo=Un();let Ro=class extends de{constructor(){super(...arguments),this.collectionLinks=[]}render(){return h`
    ...
    `:b}get volumeTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.volume,E("Volume"))}get issueTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.issue,E("Issue"))}get creatorTemplate(){var e,t,i;return((e=this.model)===null||e===void 0?void 0:e.mediatype)==="account"?h`
      ...
      <div id="creator" class="metadata">
        ...
        ${bo(Pt(this.model.creators,o=>this.searchLink("creator",o)),", ")}
      </div>
    `}get datePublishedTemplate(){var e;const t=(e=this.model)===null||e===void 0?void 0:e.datePublished;let i="long";return Cs(t)&&(i="year-only"),this.metadataTemplate(Xi(t,i),E("Published"))}get dateSortByTemplate(){return this.effectiveSort&&(this.effectiveSort.field==="addeddate"||this.effectiveSort.field==="reviewdate"||this.effectiveSort.field==="publicdate")?this.metadataTemplate(Xi(this.date,"long"),this.displayValueProvider.dateLabel):b}get viewsTemplate(){var e,t,i,o;const s=((e=this.effectiveSort)===null||e===void 0?void 0:e.field)==="week"?(t=this.model)===null||t===void 0?void 0:t.weeklyViewCount:(i=this.model)===null||i===void 0?void 0:i.viewCount;return s==null?b:((o=this.model)===null||o===void 0?void 0:o.mediatype)==="search"?this.metadataTemplate("(Favorited search query)",""):this.metadataTemplate(`${ks(s,this.formatSize)}`,E("Views"))}get ratingTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.averageRating,E("Avg Rating"))}get reviewsTemplate(){var e;return this.metadataTemplate((e=this.model)===null||e===void 0?void 0:e.commentCount,E("Reviews"))}get topicsTemplate(){var e;return!(!((e=this.model)===null||e===void 0)&&e.subjects)||this.model.subjects.length===0?b:h`
      <div id="topics" class="metadata">
        ${this.labelTemplate(E("Topics"))}
        ${bo(Pt(this.model.subjects,t=>this.searchLink("subject",t)),", ")}
      </div>
    ...
    `}};n([c({type:Object})],Ro.prototype,"collectionTitles",void 0);n([F()],Ro.prototype,"collectionLinks",void 0);Ro=n([R("tile-list")],Ro);let Qe=class extends P{constructor(){super(...arguments),this.loggedIn=!1,this.suppressBlurring=!1}render(){return h`
      <div id="container">
        ${this.headerTemplate}
    ...
    `}get headerTemplate(){var e,t,i,o;if(((e=this.model)===null||e===void 0?void 0:e.collections.length)===0)return b;let s="",a="";for(const l of((t=this.model)===null||t===void 0?void 0:t.collections)||[])if(!qo[l]&&!l.startsWith("fav-")){s=(o=(i=this.collectionTitles)===null||i===void 0?void 0:i.get(l))!==null&&o!==void 0?o:l,a=l;break}return a?h`
    ...
    `}};n([c({type:Object})],Qe.prototype,"model",void 0);n([c({type:String})],Qe.prototype,"baseNavigationUrl",void 0);n([c({type:String})],Qe.prototype,"baseImageUrl",void 0);n([c({type:Boolean})],Qe.prototype,"loggedIn",void 0);n([c({type:Boolean})],Qe.prototype,"suppressBlurring",void 0);n([c({type:Object})],Qe.prototype,"sortParam",void 0);n([c({type:Number})],Qe.prototype,"mobileBreakpoint",void 0);n([c({type:Number})],Qe.prototype,"currentWidth",void 0);n([c({type:Object})],Qe.prototype,"collectionTitles",void 0);Qe=n([R("tile-hover-pane")],Qe);let Ba=class extends de{render(){var e,t,i,o;return h`
      <div id="list-line" class="${this.classSize}">
        <image-block
          .model=${this.model}
          .baseImageUrl=${this.baseImageUrl}
    ...
    `}};Ba=n([R("tile-list-compact")],Ba);let Pa=class extends de{render(){return h`
    ...
    `}firstUpdated(){this.shouldPrepareHoverPane&&(this.hoverPaneController=new Dc(this,{mobileBreakpoint:this.mobileBreakpoint,enableLongPress:!1}))}get headerTemplate(){const{currentWidth:e,sortParam:t,defaultSortParam:i,mobileBreakpoint:o}=this;return h`
    ...
    `}};Fe.HOVER_PANE_DISPLAY_MODES={grid:!0,"list-compact":!0,"list-detail":!1,"list-header":!1};n([c({type:String})],Fe.prototype,"tileDisplayMode",void 0);n([c({type:Boolean})],Fe.prototype,"isManageView",void 0);n([c({type:Object})],Fe.prototype,"resizeObserver",void 0);n([c({type:Object})],Fe.prototype,"collectionTitles",void 0);n([c({type:Boolean})],Fe.prototype,"showTvClips",void 0);n([c({type:String})],Fe.prototype,"simpleLayoutType",void 0);n([c({type:Boolean})],Fe.prototype,"enableHoverPane",void 0);n([c({type:String})],Fe.prototype,"manageCheckTitle",void 0);n([V("#container")],Fe.prototype,"container",void 0);n([V("tile-hover-pane")],Fe.prototype,"hoverPane",void 0);Fe=rs=n([R("tile-dispatcher")],Fe);let Ia=class extends P{render(){return h` <div id="container"></div> `}static get styles(){return f`
      :host {
        display: block;
        height: 100%;
      }
...
fill=""></path>
      ...
      >
        <span ?hidden=${!this.open} class="caret-up">
          <slot name="caret-up">${Fc}</slot>
        </span>
        <span ?hidden=${this.open} class="caret-down">
          <slot name="caret-down">${Lc}</slot>
        </span>
      </span>
  ...
  `;ss=n([R("ia-icon-label")],ss);let as=class extends P{constructor(){super(...arguments),this.numResults=0}render(){return h`
    ...
    `}};n([c({type:Number})],as.prototype,"numResults",void 0);as=n([R("alpha-bar-tooltip")],as);let pt=class extends P{constructor(){super(...arguments),this.selectedLetter=null,this.tooltipShown=!1,this.alphabet="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("")}get selectedUppercaseLetter(){var e;return(e=this.selectedLetter)===null||e===void 0?void 0:e.toUpperCase()}render(){var e;return h`
  ...
  `;n([c({type:String})],pt.prototype,"selectedLetter",void 0);n([c({type:Object})],pt.prototype,"letterCounts",void 0);n([c({type:String})],pt.prototype,"ariaLandmarkLabel",void 0);n([F()],pt.prototype,"tooltipShown",void 0);n([F()],pt.prototype,"hoveredLetter",void 0);n([V("alpha-bar-tooltip")],pt.prototype,"tooltip",void 0);pt=n([R("alpha-bar")],pt);const zc=h`
...
`;let Y=class extends P{constructor(){super(...arguments),this.defaultSortDirection=null,this.defaultSortField=C.relevance,this.sortDirection=null,this.selectedSort=C.default,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.showRelevance=!0,this.showDateFavorited=!1,this.enableSortOptionsSlot=!1,this.suppressDisplayModes=!1,this.lastSelectedViewSort=C.weeklyview,this.lastSelectedDateSort=this.defaultDateSortField,this.alphaSelectorVisible=null,this.dropdownBackdropVisible=!1,this.desktopSortContainerWidth=0,this.selectorBarContainerWidth=0,this.boundSortBarSelectorEscapeListener=e=>{e.key==="Escape"&&this.closeDropdowns()}}render(){return h`
      <div id="container">
    ...
    `}get sortDirectionIcon(){return this.canChangeSortDirection?h`
      <div class="sort-direction-icon">
        ${this.finalizedSortDirection==="asc"?zc:Bc}
      </div>
      ...
      >
        <ul id="desktop-sort-selector">
          ${this.showRelevance?h`<li>
                ${this.getSortDisplayOption(C.relevance,{onClick:()=>{this.dropdownBackdropVisible=!1,this.finalizedSortField!==C.relevance&&(this.clearAlphaBarFilters(),this.setSelectedSort(C.relevance))}})}
              </li>`:b}
          <li>${this.viewsDropdownTemplate}</li>
          <li>
            ${this.getSortDisplayOption(C.title,{onClick:()=>{this.dropdownBackdropVisible=!1,this.finalizedSortField!==C.title&&(this.alphaSelectorVisible="title",this.selectedCreatorFilter=null,this.setSelectedSort(C.title),this.emitCreatorLetterChangedEvent())}})}
          </li>
          <li>${this.dateDropdownTemplate}</li>
          <li>
            ${this.getSortDisplayOption(C.creator,{onClick:()=>{this.dropdownBackdropVisible=!1,this.finalizedSortField!==C.creator&&(this.alphaSelectorVisible="creator",this.selectedTitleFilter=null,this.setSelectedSort(C.creator),this.emitTitleLetterChangedEvent())}})}
          </li>
        </ul>
      </div>
    `}get mobileSortSelectorTemplate(){const e=Object.values(Se).filter(t=>t.shownInSortBar).filter(t=>this.showRelevance||t.field!==C.relevance).filter(t=>this.showDateFavorited||t.field!==C.datefavorited);return h`
      <div
    ...
    `}getSortDisplayOption(e,t){var i,o;const s=(i=t?.selected)!==null&&i!==void 0?i:this.finalizedSortField===e,a=(o=t?.displayName)!==null&&o!==void 0?o:Se[e].displayName;return h`
      <button
        class=${s?"selected":b}
        data-title="${a}"
        @click=${l=>{var d;l.preventDefault(),(d=t?.onClick)===null||d===void 0||d.call(t,l)}}
      >
        ${a}
      </button>
    ...
    `}get dropdownBackdrop(){return h`
      ...
      ></div>
    `}closeDropdowns(){this.dropdownBackdropVisible=!1;const e=[this.viewsDropdown,this.dateDropdown,this.mobileDropdown];for(const t of e)t.open=!1,t.classList.remove("open")}selectDropdownSortField(e){this.dropdownBackdropVisible=!1,this.setSelectedSort(e)}clearAlphaBarFilters(){this.alphaSelectorVisible=null,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.emitTitleLetterChangedEvent(),this.emitCreatorLetterChangedEvent()}setSortDirection(e){this.sortDirection=e,this.emitSortChangedEvent()}toggleSortDirection(){this.setSortDirection(this.finalizedSortDirection==="desc"?"asc":"desc")}handleSortDirectionClicked(){!this.sortDirection&&this.defaultSortField&&this.defaultSortDirection&&(this.selectedSort=this.defaultSortField,this.sortDirection=this.defaultSortDirection),this.toggleSortDirection()}setSelectedSort(e){this.selectedSort=e;const t=Se[e];this.sortDirection=t.defaultSortDirection,this.emitSortChangedEvent()}get finalizedSortField(){return this.selectedSort===C.default?this.defaultSortField:this.selectedSort}get finalizedSortDirection(){return this.sortDirection===null?this.defaultSortDirection:this.sortDirection}get canChangeSortDirection(){return Se[this.finalizedSortField].canSetDirection}get dateOptionSelected(){return[C.datefavorited,C.datearchived,C.date,C.datereviewed,C.dateadded].includes(this.finalizedSortField)}get viewOptionSelected(){return[C.alltimeview,C.weeklyview].includes(this.finalizedSortField)}get defaultDateSortField(){return this.showDateFavorited?C.datefavorited:C.date}get dateSortDisplayName(){return Se[this.lastSelectedDateSort].displayName}get viewSortDisplayName(){return Se[this.lastSelectedViewSort].displayName}get titleSelectorBar(){var e;return h` <alpha-bar
    ...
    ></alpha-bar>`}titleLetterChanged(e){var t;this.selectedTitleFilter=(t=e.detail.selectedLetter)!==null&&t!==void 0?t:null,this.emitTitleLetterChangedEvent()}creatorLetterChanged(e){var t;this.selectedCreatorFilter=(t=e.detail.selectedLetter)!==null&&t!==void 0?t:null,this.emitCreatorLetterChangedEvent()}emitTitleLetterChangedEvent(){const e=new CustomEvent("titleLetterChanged",{detail:{selectedLetter:this.selectedTitleFilter}});this.dispatchEvent(e)}emitCreatorLetterChangedEvent(){const e=new CustomEvent("creatorLetterChanged",{detail:{selectedLetter:this.selectedCreatorFilter}});this.dispatchEvent(e)}displayModeChanged(){const e=new CustomEvent("displayModeChanged",{detail:{displayMode:this.displayMode}});this.dispatchEvent(e)}emitSortChangedEvent(){const e=new CustomEvent("sortChanged",{detail:{selectedSort:this.selectedSort,sortDirection:this.sortDirection}});this.dispatchEvent(e)}static get styles(){return[ut,f`
      ...
      `]}};n([c({type:String})],Y.prototype,"displayMode",void 0);n([c({type:String})],Y.prototype,"defaultSortDirection",void 0);n([c({type:String})],Y.prototype,"defaultSortField",void 0);n([c({type:String})],Y.prototype,"sortDirection",void 0);n([c({type:String})],Y.prototype,"selectedSort",void 0);n([c({type:String})],Y.prototype,"selectedTitleFilter",void 0);n([c({type:String})],Y.prototype,"selectedCreatorFilter",void 0);n([c({type:Boolean})],Y.prototype,"showRelevance",void 0);n([c({type:Boolean})],Y.prototype,"showDateFavorited",void 0);n([c({type:Boolean,reflect:!0})],Y.prototype,"enableSortOptionsSlot",void 0);n([c({type:Boolean,reflect:!0})],Y.prototype,"suppressDisplayModes",void 0);n([c({type:Object})],Y.prototype,"prefixFilterCountMap",void 0);n([c({type:Object})],Y.prototype,"resizeObserver",void 0);n([F()],Y.prototype,"lastSelectedViewSort",void 0);n([F()],Y.prototype,"lastSelectedDateSort",void 0);n([F()],Y.prototype,"alphaSelectorVisible",void 0);n([F()],Y.prototype,"dropdownBackdropVisible",void 0);n([F()],Y.prototype,"desktopSortContainerWidth",void 0);n([F()],Y.prototype,"selectorBarContainerWidth",void 0);n([V("#desktop-sort-container")],Y.prototype,"desktopSortContainer",void 0);n([V("#sort-selector-container")],Y.prototype,"sortSelectorContainer",void 0);n([V("#views-dropdown")],Y.prototype,"viewsDropdown",void 0);n([V("#date-dropdown")],Y.prototype,"dateDropdown",void 0);n([V("#mobile-dropdown")],Y.prototype,"mobileDropdown",void 0);Y=n([R("sort-filter-bar")],Y);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Sr(r,e,t){return r?e():t?.()}class Rt{constructor(e){var t,i,o,s,a,l,d;this.title=e?.title,this.subtitle=e?.subtitle,this.headline=e?.headline,this.message=e?.message,this.headerColor=(t=e?.headerColor)!==null&&t!==void 0?t:"#55A183",this.bodyColor=(i=e?.bodyColor)!==null&&i!==void 0?i:"#f5f5f7",this.showProcessingIndicator=(o=e?.showProcessingIndicator)!==null&&o!==void 0?o:!1,this.processingImageMode=(s=e?.processingImageMode)!==null&&s!==void 0?s:"complete",this.showCloseButton=(a=e?.showCloseButton)!==null&&a!==void 0?a:!0,this.showHeaderLogo=(l=e?.showHeaderLogo)!==null&&l!==void 0?l:!0,this.closeOnBackdropClick=(d=e?.closeOnBackdropClick)!==null&&d!==void 0?d:!0}}function*Ts(r=document.activeElement){r!=null&&(yield r,"shadowRoot"in r&&r.shadowRoot&&r.shadowRoot.mode!=="closed"&&(yield*Ts(r.shadowRoot.activeElement)))}function Nc(){return[...Ts()].pop()}const Oa=new WeakMap;function Hn(r){let e=Oa.get(r);return e||(e=window.getComputedStyle(r,null),Oa.set(r,e)),e}function Uc(r){if("checkVisibility"in r&&typeof r.checkVisibility=="function")return r.checkVisibility({checkOpacity:!1,checkVisibilityCSS:!0});const e=Hn(r);return e.visibility!=="hidden"&&e.display!=="none"}function Hc(r){const e=Hn(r),{overflowY:t,overflowX:i}=e;return t==="scroll"||i==="scroll"?!0:t!=="auto"||i!=="auto"?!1:r.scrollHeight>r.clientHeight&&t==="auto"||r.scrollWidth>r.clientWidth&&i==="auto"}function Vc(r){const e=r.tagName.toLowerCase(),t=Number(r.getAttribute("tabindex"));return r.hasAttribute("tabindex")&&(isNaN(t)||t<=-1)||r.hasAttribute("disabled")||r.closest("[inert]")||e==="input"&&r.getAttribute("type")==="radio"&&!r.hasAttribute("checked")||!Uc(r)?!1:(e==="audio"||e==="video")&&r.hasAttribute("controls")||r.hasAttribute("tabindex")||r.hasAttribute("contenteditable")&&r.getAttribute("contenteditable")!=="false"||["button","input","select","textarea","a","audio","video","summary","iframe"].includes(e)?!0:Hc(r)}function Wc(r,e){var t;return((t=r.getRootNode({composed:!0}))===null||t===void 0?void 0:t.host)!==e}function Na(r){const e=new WeakMap,t=[];function i(o){if(o instanceof Element){if(o.hasAttribute("inert")||o.closest("[inert]")||e.has(o))return;e.set(o,!0),!t.includes(o)&&Vc(o)&&t.push(o),o instanceof HTMLSlotElement&&Wc(o,r)&&o.assignedElements({flatten:!0}).forEach(s=>{i(s)}),o.shadowRoot!==null&&o.shadowRoot.mode==="open"&&i(o.shadowRoot)}for(const s of Array.from(o.children))i(s)}return i(r),t.sort((o,s)=>{const a=Number(o.getAttribute("tabindex"))||0;return(Number(s.getAttribute("tabindex"))||0)-a})}let zi=[];class jc{constructor(e){this.isExternalActivated=!1,this.tabDirection="forward",this.currentFocus=null,this.previousFocus=null,this.handleFocusIn=()=>{this.isActive()&&this.checkFocus()},this.handleKeyDown=t=>{var i;if(t.key!=="Tab"||this.isExternalActivated||!this.isActive())return;const o=Nc();if(this.previousFocus=o,this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus))return;t.shiftKey?this.tabDirection="backward":this.tabDirection="forward";const s=Na(this.element);let a=s.findIndex(d=>d===o);this.previousFocus=this.currentFocus;const l=this.tabDirection==="forward"?1:-1;for(;;){a+l>=s.length?a=0:a+l<0?a=s.length-1:a+=l,this.previousFocus=this.currentFocus;const d=s[a];if(this.tabDirection==="backward"&&this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus)||d&&this.possiblyHasTabbableChildren(d))return;t.preventDefault(),this.currentFocus=d,(i=this.currentFocus)===null||i===void 0||i.focus({preventScroll:!1});const u=[...Ts()];if(u.includes(this.currentFocus)||!u.includes(this.previousFocus))break}setTimeout(()=>this.checkFocus())},this.handleKeyUp=()=>{this.tabDirection="forward"},this.element=e,this.elementsWithTabbableControls=["iframe"]}activate(){zi.push(this.element),document.addEventListener("focusin",this.handleFocusIn),document.addEventListener("keydown",this.handleKeyDown),document.addEventListener("keyup",this.handleKeyUp)}deactivate(){zi=zi.filter(e=>e!==this.element),this.currentFocus=null,document.removeEventListener("focusin",this.handleFocusIn),document.removeEventListener("keydown",this.handleKeyDown),document.removeEventListener("keyup",this.handleKeyUp)}isActive(){return zi[zi.length-1]===this.element}activateExternal(){this.isExternalActivated=!0}deactivateExternal(){this.isExternalActivated=!1}checkFocus(){if(this.isActive()&&!this.isExternalActivated){const e=Na(this.element);if(!this.element.matches(":focus-within")){const t=e[0],i=e[e.length-1],o=this.tabDirection==="forward"?t:i;typeof o?.focus=="function"&&(this.currentFocus=o,o.focus({preventScroll:!1}))}}}possiblyHasTabbableChildren(e){return this.elementsWithTabbableControls.includes(e.tagName.toLowerCase())||e.hasAttribute("controls")}}var Ua;(function(r){r.processing="processing",r.complete="complete"})(Ua||(Ua={}));let ns=class extends P{constructor(){super(...arguments),this.mode="processing"}render(){return h`
      <div class="${this.mode}">
        <svg
          viewBox="0 0 120 120"
    ...
    `}};n([c({type:String})],ns.prototype,"mode",void 0);ns=n([R("ia-activity-indicator")],ns);const qc=h`
<svg
  viewBox="0 0 40 40"
  version="1.1"
  xmlns="http://www.w3.org/2000/svg"
...
`;class Gc extends P{static get styles(){return f`
      :host {
    ...
    `}render(){return qc}}customElements.define("ia-icon-close",Gc);const Yc=h`
  <svg
    class="ia-logo"
    viewBox="0 0 27 30"
    xmlns="http://www.w3.org/2000/svg"
...
`;let ls=class extends P{constructor(){super(...arguments),this.config=new Rt}render(){return h`
      <div class="modal-wrapper">
        <div class="modal-container">
          <header style="background-color: ${this.config.headerColor}">
            ${this.config.showCloseButton?this.closeButtonTemplate:""}
            ${this.config.showHeaderLogo?h`<div class="logo-icon">${Yc}</div>`:b}
    ...
    `}static get styles(){const e=f`var(--modalLogoSize, 6.5rem)`,t=f`var(--processingImageSize, 7.5rem)`,i=f`var(--modalCornerRadius, 1rem)`,o=f`var(--modalBorder, 2px solid black)`,s=f`var(--modalBottomMargin, 2.5rem)`,a=f`var(--modalTopMargin, 5rem)`,l=f`var(--modalHeaderBottomPadding, 0.5em)`,d=f`var(--modalBottomPadding, 2rem)`,u=f`var(--modalScrollOffset, 5px)`,p=f`var(--modalTitleFontSize, 1.8rem)`,m=f`var(--modalSubtitleFontSize, 1.4rem)`,v=f`var(--modalHeadlineFontSize, 1.6rem)`,y=f`var(--modalMessageFontSize, 1.4rem)`,S=f`var(--modalTitleLineHeight, normal)`,x=f`var(--modalSubtitleLineHeight, normal)`,_=f`var(--modalHeadlineLineHeight, normal)`,D=f`var(--modalMessageLineHeight, normal)`;return f`
      .processing-logo {
        margin: auto;
        width: ${t};
        height: ${t};
    ...
    `}};n([c({type:Object})],ls.prototype,"config",void 0);ls=n([R("modal-template")],ls);function Qc(r,e,t){var i=t||{},o=i.noTrailing,s=o===void 0?!1:o,a=i.noLeading,l=a===void 0?!1:a,d=i.debounceMode,u=d===void 0?void 0:d,p,m=!1,v=0;function y(){p&&clearTimeout(p)}function S(_){var D=_||{},M=D.upcomingOnly,A=M===void 0?!1:M;y(),m=!A}function x(){for(var _=arguments.length,D=new Array(_),M=0;M<_;M++)D[M]=arguments[M];var A=this,I=Date.now()-v;if(m)return;function W(){v=Date.now(),e.apply(A,D)}function se(){p=void 0}!l&&u&&!p&&W(),y(),u===void 0&&I>r?l?(v=Date.now(),s||(p=setTimeout(u?se:W,r))):W():s!==!0&&(p=setTimeout(u?se:W,u===void 0?r-I:r))}return x.cancel=S,x}var It;(function(r){r.Open="open",r.Closed="closed"})(It||(It={}));class Kc{constructor(e){this.windowResizeThrottler=Qc(100,this.updateModalContainerHeight,{noLeading:!1,noTrailing:!1}).bind(this),this.modalManager=e}handleModeChange(e){switch(e){case It.Open:this.startResizeListener(),this.stopDocumentScroll();break;case It.Closed:this.stopResizeListener(),this.resumeDocumentScroll();break}}updateModalContainerHeight(){this.modalManager.style.setProperty("--containerHeight",`${window.innerHeight}px`)}stopDocumentScroll(){document.body.classList.add("modal-manager-open")}resumeDocumentScroll(){document.body.classList.remove("modal-manager-open")}startResizeListener(){window.addEventListener("resize",this.windowResizeThrottler)}stopResizeListener(){window.removeEventListener("resize",this.windowResizeThrottler)}}let pi=class extends P{constructor(){super(...arguments),this.mode=It.Closed,this.hostBridge=new Kc(this),this.modal=new jc(this),this.closeOnBackdropClick=!0}firstUpdated(){return Ks(this,void 0,void 0,function*(){yield new Promise(e=>setTimeout(e,0)),this.closeOnBackdropClick&&this.addEventListener("keydown",e=>{e.key==="Escape"&&this.backdropClicked()})})}disconnectedCallback(){super.disconnectedCallback(),this.modal.deactivate()}render(){return h`
      <div class="container">
    ...
    `}};n([c({type:String,reflect:!0})],pi.prototype,"mode",void 0);n([c({type:Object})],pi.prototype,"customModalContent",void 0);n([c({type:Object})],pi.prototype,"hostBridge",void 0);n([V("modal-template")],pi.prototype,"modalTemplate",void 0);pi=n([R("modal-manager")],pi);const Ha=f`var(--white, #fff)`,Xc=f`var(--primaryDisableCTAFill, #767676)`,Zc=f`var(--secondaryCTABorder, #999)`,Jc=f`var(--primaryCTAFill, #194880)`,$r=f`var(--primaryCTAFillRGB, 25, 72, 128)`,e0=f`var(--primaryCTABorder, #c5d1df)`,t0=f`var(--primaryErrorCTAFill, #d9534f)`,_r=f`var(--primaryErrorCTAFillRGB, 229, 28, 38)`,i0=f`var(--primaryErrorCTABorder, #d43f3a)`,o0=f`var(--secondaryCTAFill, #333)`,Cr=f`var(--secondaryCTAFillRGB, 51, 51, 51)`,r0=f`var(--primaryCTABorder, #979797)`,s0=f`var(---primaryWarningFill, #ee8950)`,kr=f`var(--primaryWarningFillRGB, 238, 137, 80)`,a0=f`var(--primaryWarningBorder, #ec7939)`,n0=f`
  .ia-button {
    min-height: 3rem;
    cursor: pointer;
    color: ${Ha};
...
`;let Io=class extends P{constructor(){super(...arguments),this.items=[]}render(){return h`
      <ul>
    ...
    `}};n([c({type:Object})],Io.prototype,"items",void 0);n([c({type:String})],Io.prototype,"message",void 0);Io=n([R("remove-items-modal-content")],Io);let ot=class extends P{constructor(){super(...arguments),this.label=E("Select items to remove"),this.selectedItems=[],this.showSelectAll=!1,this.showUnselectAll=!1,this.showItemManageButton=!1,this.removeAllowed=!1}render(){return h`
    ...
    `}};n([c({type:String})],ot.prototype,"label",void 0);n([c({type:Object})],ot.prototype,"modalManager",void 0);n([c({type:Object})],ot.prototype,"selectedItems",void 0);n([c({type:String})],ot.prototype,"manageViewModalMsg",void 0);n([c({type:Boolean})],ot.prototype,"showSelectAll",void 0);n([c({type:Boolean})],ot.prototype,"showUnselectAll",void 0);n([c({type:Boolean})],ot.prototype,"showItemManageButton",void 0);n([c({type:Boolean})],ot.prototype,"removeAllowed",void 0);ot=n([R("manage-bar")],ot);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Hi=(r,e)=>{var t,i;const o=r._$AN;if(o===void 0)return!1;for(const s of o)(i=(t=s)._$AO)===null||i===void 0||i.call(t,e,!1),Hi(s,e);return!0},Oo=r=>{let e,t;do{if((e=r._$AM)===void 0)break;t=e._$AN,t.delete(r),r=e}while(t?.size===0)},Vn=r=>{for(let e;e=r._$AM;r=e){let t=e._$AN;if(t===void 0)e._$AN=t=new Set;else if(t.has(r))break;t.add(r),c0(e)}};function l0(r){this._$AN!==void 0?(Oo(this),this._$AM=r,Vn(this)):this._$AM=r}function d0(r,e=!1,t=0){const i=this._$AH,o=this._$AN;if(o!==void 0&&o.size!==0)if(e)if(Array.isArray(i))for(let s=t;s<i.length;s++)Hi(i[s],!1),Oo(i[s]);else i!=null&&(Hi(i,!1),Oo(i));else Hi(this,r)}const c0=r=>{var e,t,i,o;r.type==Ve.CHILD&&((e=(i=r)._$AP)!==null&&e!==void 0||(i._$AP=d0),(t=(o=r)._$AQ)!==null&&t!==void 0||(o._$AQ=l0))};class h0 extends wi{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,i){super._$AT(e,t,i),Vn(this),this.isConnected=e._$AU}_$AO(e,t=!0){var i,o;e!==this.isConnected&&(this.isConnected=e,e?(i=this.reconnected)===null||i===void 0||i.call(this):(o=this.disconnected)===null||o===void 0||o.call(this)),t&&(Hi(this,e),Oo(this))}setValue(e){if(Sn(this._$Ct))this._$Ct._$AI(e,this);else{const t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}}const Tr=new WeakMap,p0=yi(class extends h0{render(r){return ee}update(r,[e]){var t;const i=e!==this.G;return i&&this.G!==void 0&&this.ot(void 0),(i||this.rt!==this.lt)&&(this.G=e,this.dt=(t=r.options)===null||t===void 0?void 0:t.host,this.ot(this.lt=r.element)),ee}ot(r){var e;if(typeof this.G=="function"){const t=(e=this.dt)!==null&&e!==void 0?e:globalThis;let i=Tr.get(t);i===void 0&&(i=new WeakMap,Tr.set(t,i)),i.get(this.G)!==void 0&&this.G.call(this.dt,void 0),i.set(this.G,r),r!==void 0&&this.G.call(this.dt,r)}else this.G.value=r}get rt(){var r,e,t;return typeof this.G=="function"?(e=Tr.get((r=this.dt)!==null&&r!==void 0?r:globalThis))===null||e===void 0?void 0:e.get(this.G):(t=this.G)===null||t===void 0?void 0:t.value}disconnected(){this.rt===this.lt&&this.ot(void 0)}reconnected(){this.ot(this.lt)}});var Wn=60,jn=Wn*60,qn=jn*24,u0=qn*7,ui=1e3,Er=Wn*ui,Va=jn*ui,f0=qn*ui,m0=u0*ui,Es="millisecond",ti="second",ii="minute",oi="hour",vt="day",xo="week",He="month",Gn="quarter",gt="year",ri="date",v0="YYYY-MM-DDTHH:mm:ssZ",Wa="Invalid Date",g0=/^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/,b0=/\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g;const y0={name:"en",weekdays:"Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),months:"January_February_March_April_May_June_July_August_September_October_November_December".split("_"),ordinal:function(e){var t=["th","st","nd","rd"],i=e%100;return"["+e+(t[(i-20)%10]||t[i]||t[0])+"]"}};var ds=function(e,t,i){var o=String(e);return!o||o.length>=t?e:""+Array(t+1-o.length).join(i)+e},w0=function(e){var t=-e.utcOffset(),i=Math.abs(t),o=Math.floor(i/60),s=i%60;return(t<=0?"+":"-")+ds(o,2,"0")+":"+ds(s,2,"0")},x0=function r(e,t){if(e.date()<t.date())return-r(t,e);var i=(t.year()-e.year())*12+(t.month()-e.month()),o=e.clone().add(i,He),s=t-o<0,a=e.clone().add(i+(s?-1:1),He);return+(-(i+(t-o)/(s?o-a:a-o))||0)},S0=function(e){return e<0?Math.ceil(e)||0:Math.floor(e)},$0=function(e){var t={M:He,y:gt,w:xo,d:vt,D:ri,h:oi,m:ii,s:ti,ms:Es,Q:Gn};return t[e]||String(e||"").toLowerCase().replace(/s$/,"")},_0=function(e){return e===void 0};const C0={s:ds,z:w0,m:x0,a:S0,p:$0,u:_0};var Vi="en",Ot={};Ot[Vi]=y0;var Yn="$isDayjsObject",Ms=function(e){return e instanceof Yo||!!(e&&e[Yn])},No=function r(e,t,i){var o;if(!e)return Vi;if(typeof e=="string"){var s=e.toLowerCase();Ot[s]&&(o=s),t&&(Ot[s]=t,o=s);var a=e.split("-");if(!o&&a.length>1)return r(a[0])}else{var l=e.name;Ot[l]=e,o=l}return!i&&o&&(Vi=o),o||!i&&Vi},ie=function(e,t){if(Ms(e))return e.clone();var i=typeof t=="object"?t:{};return i.date=e,i.args=arguments,new Yo(i)},k0=function(e,t){return ie(e,{locale:t.$L,utc:t.$u,x:t.$x,$offset:t.$offset})},G=C0;G.l=No;G.i=Ms;G.w=k0;var T0=function(e){var t=e.date,i=e.utc;if(t===null)return new Date(NaN);if(G.u(t))return new Date;if(t instanceof Date)return new Date(t);if(typeof t=="string"&&!/Z$/i.test(t)){var o=t.match(g0);if(o){var s=o[2]-1||0,a=(o[7]||"0").substring(0,3);return i?new Date(Date.UTC(o[1],s,o[3]||1,o[4]||0,o[5]||0,o[6]||0,a)):new Date(o[1],s,o[3]||1,o[4]||0,o[5]||0,o[6]||0,a)}}return new Date(t)},Yo=function(){function r(t){this.$L=No(t.locale,null,!0),this.parse(t),this.$x=this.$x||t.x||{},this[Yn]=!0}var e=r.prototype;return e.parse=function(i){this.$d=T0(i),this.init()},e.init=function(){var i=this.$d;this.$y=i.getFullYear(),this.$M=i.getMonth(),this.$D=i.getDate(),this.$W=i.getDay(),this.$H=i.getHours(),this.$m=i.getMinutes(),this.$s=i.getSeconds(),this.$ms=i.getMilliseconds()},e.$utils=function(){return G},e.isValid=function(){return this.$d.toString()!==Wa},e.isSame=function(i,o){var s=ie(i);return this.startOf(o)<=s&&s<=this.endOf(o)},e.isAfter=function(i,o){return ie(i)<this.startOf(o)},e.isBefore=function(i,o){return this.endOf(o)<ie(i)},e.$g=function(i,o,s){return G.u(i)?this[o]:this.set(s,i)},e.unix=function(){return Math.floor(this.valueOf()/1e3)},e.valueOf=function(){return this.$d.getTime()},e.startOf=function(i,o){var s=this,a=G.u(o)?!0:o,l=G.p(i),d=function(D,M){var A=G.w(s.$u?Date.UTC(s.$y,M,D):new Date(s.$y,M,D),s);return a?A:A.endOf(vt)},u=function(D,M){var A=[0,0,0,0],I=[23,59,59,999];return G.w(s.toDate()[D].apply(s.toDate("s"),(a?A:I).slice(M)),s)},p=this.$W,m=this.$M,v=this.$D,y="set"+(this.$u?"UTC":"");switch(l){case gt:return a?d(1,0):d(31,11);case He:return a?d(1,m):d(0,m+1);case xo:{var S=this.$locale().weekStart||0,x=(p<S?p+7:p)-S;return d(a?v-x:v+(6-x),m)}case vt:case ri:return u(y+"Hours",0);case oi:return u(y+"Minutes",1);case ii:return u(y+"Seconds",2);case ti:return u(y+"Milliseconds",3);default:return this.clone()}},e.endOf=function(i){return this.startOf(i,!1)},e.$set=function(i,o){var s,a=G.p(i),l="set"+(this.$u?"UTC":""),d=(s={},s[vt]=l+"Date",s[ri]=l+"Date",s[He]=l+"Month",s[gt]=l+"FullYear",s[oi]=l+"Hours",s[ii]=l+"Minutes",s[ti]=l+"Seconds",s[Es]=l+"Milliseconds",s)[a],u=a===vt?this.$D+(o-this.$W):o;if(a===He||a===gt){var p=this.clone().set(ri,1);p.$d[d](u),p.init(),this.$d=p.set(ri,Math.min(this.$D,p.daysInMonth())).$d}else d&&this.$d[d](u);return this.init(),this},e.set=function(i,o){return this.clone().$set(i,o)},e.get=function(i){return this[G.p(i)]()},e.add=function(i,o){var s=this,a;i=Number(i);var l=G.p(o),d=function(v){var y=ie(s);return G.w(y.date(y.date()+Math.round(v*i)),s)};if(l===He)return this.set(He,this.$M+i);if(l===gt)return this.set(gt,this.$y+i);if(l===vt)return d(1);if(l===xo)return d(7);var u=(a={},a[ii]=Er,a[oi]=Va,a[ti]=ui,a)[l]||1,p=this.$d.getTime()+i*u;return G.w(p,this)},e.subtract=function(i,o){return this.add(i*-1,o)},e.format=function(i){var o=this,s=this.$locale();if(!this.isValid())return s.invalidDate||Wa;var a=i||v0,l=G.z(this),d=this.$H,u=this.$m,p=this.$M,m=s.weekdays,v=s.months,y=s.meridiem,S=function(A,I,W,se){return A&&(A[I]||A(o,a))||W[I].slice(0,se)},x=function(A){return G.s(d%12||12,A,"0")},_=y||function(M,A,I){var W=M<12?"AM":"PM";return I?W.toLowerCase():W},D=function(A){switch(A){case"YY":return String(o.$y).slice(-2);case"YYYY":return G.s(o.$y,4,"0");case"M":return p+1;case"MM":return G.s(p+1,2,"0");case"MMM":return S(s.monthsShort,p,v,3);case"MMMM":return S(v,p);case"D":return o.$D;case"DD":return G.s(o.$D,2,"0");case"d":return String(o.$W);case"dd":return S(s.weekdaysMin,o.$W,m,2);case"ddd":return S(s.weekdaysShort,o.$W,m,3);case"dddd":return m[o.$W];case"H":return String(d);case"HH":return G.s(d,2,"0");case"h":return x(1);case"hh":return x(2);case"a":return _(d,u,!0);case"A":return _(d,u,!1);case"m":return String(u);case"mm":return G.s(u,2,"0");case"s":return String(o.$s);case"ss":return G.s(o.$s,2,"0");case"SSS":return G.s(o.$ms,3,"0");case"Z":return l}return null};return a.replace(b0,function(M,A){return A||D(M)||l.replace(":","")})},e.utcOffset=function(){return-Math.round(this.$d.getTimezoneOffset()/15)*15},e.diff=function(i,o,s){var a=this,l=G.p(o),d=ie(i),u=(d.utcOffset()-this.utcOffset())*Er,p=this-d,m=function(){return G.m(a,d)},v;switch(l){case gt:v=m()/12;break;case He:v=m();break;case Gn:v=m()/3;break;case xo:v=(p-u)/m0;break;case vt:v=(p-u)/f0;break;case oi:v=p/Va;break;case ii:v=p/Er;break;case ti:v=p/ui;break;default:v=p;break}return s?v:G.a(v)},e.daysInMonth=function(){return this.endOf(He).$D},e.$locale=function(){return Ot[this.$L]},e.locale=function(i,o){if(!i)return this.$L;var s=this.clone(),a=No(i,o,!0);return a&&(s.$L=a),s},e.clone=function(){return G.w(this.$d,this)},e.toDate=function(){return new Date(this.valueOf())},e.toJSON=function(){return this.isValid()?this.toISOString():null},e.toISOString=function(){return this.$d.toISOString()},e.toString=function(){return this.$d.toUTCString()},r}(),Qn=Yo.prototype;ie.prototype=Qn;[["$ms",Es],["$s",ti],["$m",ii],["$H",oi],["$W",vt],["$M",He],["$y",gt],["$D",ri]].forEach(function(r){Qn[r[1]]=function(e){return this.$g(e,r[0],r[1])}});ie.extend=function(r,e){return r.$i||(r(e,Yo,ie),r.$i=!0),ie};ie.locale=No;ie.isDayjs=Ms;ie.unix=function(r){return ie(r*1e3)};ie.en=Ot[Vi];ie.Ls=Ot;ie.p={};var E0=function(e){return e.replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g,function(t,i,o){return i||o.slice(1)})},M0={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"},A0=function(e,t){return e.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g,function(i,o,s){var a=s&&s.toUpperCase();return o||t[s]||M0[s]||E0(t[a])})},D0=/(\[[^[]*\])|([-_:/.,()\s]+)|(A|a|Q|YYYY|YY?|ww?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g,ja=/\d/,Bi=/\d\d/,F0=/\d{3}/,L0=/\d{4}/,Ie=/\d\d?/,z0=/[+-]?\d+/,B0=/[+-]\d\d:?(\d\d)?|Z/,Pi=/\d*[^-_:/,()\s\d]+/,wt={},Kn=function(e){return e=+e,e+(e>68?1900:2e3)};function P0(r){if(!r||r==="Z")return 0;var e=r.match(/([+-]|\d\d)/g),t=+(e[1]*60)+(+e[2]||0);return t===0?0:e[0]==="+"?-t:t}var ye=function(e){return function(t){this[e]=+t}},qa=[B0,function(r){var e=this.zone||(this.zone={});e.offset=P0(r)}],Mr=function(e){var t=wt[e];return t&&(t.indexOf?t:t.s.concat(t.f))},Ga=function(e,t){var i,o=wt,s=o.meridiem;if(!s)i=e===(t?"pm":"PM");else for(var a=1;a<=24;a+=1)if(e.indexOf(s(a,0,t))>-1){i=a>12;break}return i},R0={A:[Pi,function(r){this.afternoon=Ga(r,!1)}],a:[Pi,function(r){this.afternoon=Ga(r,!0)}],Q:[ja,function(r){this.month=(r-1)*3+1}],S:[ja,function(r){this.milliseconds=+r*100}],SS:[Bi,function(r){this.milliseconds=+r*10}],SSS:[F0,function(r){this.milliseconds=+r}],s:[Ie,ye("seconds")],ss:[Ie,ye("seconds")],m:[Ie,ye("minutes")],mm:[Ie,ye("minutes")],H:[Ie,ye("hours")],h:[Ie,ye("hours")],HH:[Ie,ye("hours")],hh:[Ie,ye("hours")],D:[Ie,ye("day")],DD:[Bi,ye("day")],Do:[Pi,function(r){var e=wt,t=e.ordinal,i=r.match(/\d+/);if(this.day=i[0],!!t)for(var o=1;o<=31;o+=1)t(o).replace(/\[|\]/g,"")===r&&(this.day=o)}],w:[Ie,ye("week")],ww:[Bi,ye("week")],M:[Ie,ye("month")],MM:[Bi,ye("month")],MMM:[Pi,function(r){var e=Mr("months"),t=Mr("monthsShort"),i=(t||e.map(function(o){return o.slice(0,3)})).indexOf(r)+1;if(i<1)throw new Error;this.month=i%12||i}],MMMM:[Pi,function(r){var e=Mr("months"),t=e.indexOf(r)+1;if(t<1)throw new Error;this.month=t%12||t}],Y:[z0,ye("year")],YY:[Bi,function(r){this.year=Kn(r)}],YYYY:[L0,ye("year")],Z:qa,ZZ:qa};function I0(r){var e=r.afternoon;if(e!==void 0){var t=r.hours;e?t<12&&(r.hours+=12):t===12&&(r.hours=0),delete r.afternoon}}function O0(r){r=A0(r,wt&&wt.formats);for(var e=r.match(D0),t=e.length,i=0;i<t;i+=1){var o=e[i],s=R0[o],a=s&&s[0],l=s&&s[1];l?e[i]={regex:a,parser:l}:e[i]=o.replace(/^\[|\]$/g,"")}return function(d){for(var u={},p=0,m=0;p<t;p+=1){var v=e[p];if(typeof v=="string")m+=v.length;else{var y=v.regex,S=v.parser,x=d.slice(m),_=y.exec(x),D=_[0];S.call(u,D),d=d.replace(D,"")}}return I0(u),u}}var N0=function(e,t,i,o){try{if(["x","X"].indexOf(t)>-1)return new Date((t==="X"?1e3:1)*e);var s=O0(t),a=s(e),l=a.year,d=a.month,u=a.day,p=a.hours,m=a.minutes,v=a.seconds,y=a.milliseconds,S=a.zone,x=a.week,_=new Date,D=u||(!l&&!d?_.getDate():1),M=l||_.getFullYear(),A=0;l&&!d||(A=d>0?d-1:_.getMonth());var I=p||0,W=m||0,se=v||0,ze=y||0;if(S)return new Date(Date.UTC(M,A,D,I,W,se,ze+S.offset*60*1e3));if(i)return new Date(Date.UTC(M,A,D,I,W,se,ze));var ge;return ge=new Date(M,A,D,I,W,se,ze),x&&(ge=o(ge).week(x).toDate()),ge}catch{return new Date("")}};const U0=function(r,e,t){t.p.customParseFormat=!0,r&&r.parseTwoDigitYear&&(Kn=r.parseTwoDigitYear);var i=e.prototype,o=i.parse;i.parse=function(s){var a=s.date,l=s.utc,d=s.args;this.$u=l;var u=d[1];if(typeof u=="string"){var p=d[2]===!0,m=d[3]===!0,v=p||m,y=d[2];m&&(y=d[2]),wt=this.$locale(),!p&&y&&(wt=t.Ls[y]),this.$d=N0(a,u,l,t),this.init(),y&&y!==!0&&(this.$L=this.locale(y).$L),v&&a!=this.format(u)&&(this.$d=new Date("")),wt={}}else if(u instanceof Array)for(var S=u.length,x=1;x<=S;x+=1){d[1]=u[x-1];var _=t.apply(this,d);if(_.isValid()){this.$d=_.$d,this.$L=_.$L,this.init();break}x===S&&(this.$d=new Date(""))}else o.call(this,s)}};function H0(r,e){const t=e.prototype,i=t.parse;t.parse=function(o){const s=o.date,a=o.args[1];i.call(this,o);const l=this.year(),d=l>=1900&&l<2e3,u=typeof a=="string"&&a.includes("YYYY"),p=Array.isArray(a)&&typeof a[0]=="string"&&a[0].includes("YYYY"),m=u||p,v=typeof s=="string"&&!s.includes(`${l}`);d&&m&&v&&(this.$d.setFullYear(l-1900),this.init())}}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ya=yi(class extends wi{constructor(r){if(super(r),r.type!==Ve.PROPERTY&&r.type!==Ve.ATTRIBUTE&&r.type!==Ve.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Sn(r))throw Error("`live` bindings can only contain a single expression")}render(r){return r}update(r,[e]){if(e===Ae||e===ee)return e;const t=r.element,i=r.name;if(r.type===Ve.PROPERTY){if(e===t[i])return Ae}else if(r.type===Ve.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(i))return Ae}else if(r.type===Ve.ATTRIBUTE&&t.getAttribute(i)===e+"")return Ae;return $n(r),e}});/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Xn="important",V0=" !"+Xn,Zn=yi(class extends wi{constructor(r){var e;if(super(r),r.type!==Ve.ATTRIBUTE||r.name!=="style"||((e=r.strings)===null||e===void 0?void 0:e.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(r){return Object.keys(r).reduce((e,t)=>{const i=r[t];return i==null?e:e+`${t=t.includes("-")?t:t.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${i};`},"")}update(r,[e]){const{style:t}=r.element;if(this.ht===void 0){this.ht=new Set;for(const i in e)this.ht.add(i);return this.render(e)}this.ht.forEach(i=>{e[i]==null&&(this.ht.delete(i),i.includes("-")?t.removeProperty(i):t[i]="")});for(const i in e){const o=e[i];if(o!=null){this.ht.add(i);const s=typeof o=="string"&&o.endsWith(V0);i.includes("-")||s?t.setProperty(i,s?o.slice(0,-11):o,s?Xn:""):t[i]=o}}return Ae}});ie.extend(U0);ie.extend(H0);const W0=180,j0=40,q0=10,G0=125,Y0=30,Qa="YYYY",Q0="no data",K0=0,X0="item",Ka=4,Z0={linear:r=>r,logarithmic:r=>Math.log1p(r)},J0=f`var(--histogramDateRangeSliderColor, #4B65FE)`,eh=f`var(--histogramDateRangeSelectedRangeColor, #DBE0FF)`,th=f`var(--histogramDateRangeBarIncludedFill, #2C2C2C)`,ih=f`var(--histogramDateRangeActivityIndicator, #2C2C2C)`,oh=f`var(--histogramDateRangeBarExcludedFill, #CCCCCC)`,rh=f`var(--histogramDateRangeInputRowMargin, 0)`,sh=f`var(--histogramDateRangeInputBorder, 0.5px solid #2C2C2C)`,ah=f`var(--histogramDateRangeInputWidth, 35px)`,nh=f`var(--histogramDateRangeInputFontSize, 1.2rem)`,lh=f`var(--histogramDateRangeInputFontFamily, sans-serif)`,Xa=f`var(--histogramDateRangeTooltipBackgroundColor, #2C2C2C)`,Za=f`var(--histogramDateRangeTooltipTextColor, #FFFFFF)`,dh=f`var(--histogramDateRangeTooltipFontSize, 1.1rem)`,ch=f`var(--histogramDateRangeTooltipFontFamily, sans-serif)`;let q=class extends P{constructor(){super(...arguments),this.width=W0,this.height=j0,this.sliderWidth=q0,this.tooltipWidth=G0,this.tooltipHeight=Y0,this.updateDelay=K0,this.dateFormat=Qa,this.missingDataMessage=Q0,this.minDate="",this.maxDate="",this.disabled=!1,this.bins=[],this.updateWhileFocused=!1,this.binSnapping="none",this.tooltipLabel=X0,this.barScaling="logarithmic",this._tooltipOffsetX=0,this._tooltipOffsetY=0,this._isDragging=!1,this._isLoading=!1,this._minSelectedDate="",this._maxSelectedDate="",this._minDateMS=0,this._maxDateMS=0,this._dragOffset=0,this._histWidth=0,this._binWidth=0,this._histData=[],this._previousDateRange="",this.drag=e=>{e.preventDefault(),!this.disabled&&(this.setDragOffset(e),this._isDragging=!0,this.addListeners(),this.cancelPendingUpdateEvent())},this.drop=()=>{this._isDragging&&(this.removeListeners(),this.beginEmitUpdateProcess()),this._isDragging=!1},this.move=e=>{const t=this.getBoundingClientRect().x,i=e.clientX-t-this._dragOffset;this._currentSlider.id==="slider-min"?this.minSelectedDate=this.translatePositionToDate(this.validMinSliderX(i)):(this.maxSelectedDate=this.translatePositionToDate(this.validMaxSliderX(i)),this.getMSFromString(this.maxSelectedDate)>this._maxDateMS&&(this.maxSelectedDate=this.maxDate))}}disconnectedCallback(){this.removeListeners(),super.disconnectedCallback()}willUpdate(e){(e.has("bins")||e.has("minDate")||e.has("maxDate")||e.has("minSelectedDate")||e.has("maxSelectedDate")||e.has("width")||e.has("height")||e.has("binSnapping")||e.has("barScaling"))&&this.handleDataUpdate()}handleDataUpdate(){this.hasBinData&&(this._histWidth=this.width-this.sliderWidth*2,this._minDateMS=this.snapTimestamp(this.getMSFromString(this.minDate)),this._maxDateMS=this.snapTimestamp(this.getMSFromString(this.maxDate)+this.snapInterval)+this.snapEndOffset,this._binWidth=this._histWidth/this._numBins,this._previousDateRange=this.currentDateRangeString,this._histData=this.calculateHistData(),this.minSelectedDate=this.minSelectedDate?this.minSelectedDate:this.minDate,this.maxSelectedDate=this.maxSelectedDate?this.maxSelectedDate:this.maxDate)}snapToNextSecond(e){return Math.ceil(e/1e3)*1e3}snapToMonth(e){const t=ie(e),i=t.date()<16?0:1;return t.add(i,"month").date(1).hour(0).minute(0).second(0).millisecond(0).valueOf()}snapToYear(e){const t=ie(e),i=t.month()<6?0:1;return t.add(i,"year").month(0).date(1).hour(0).minute(0).second(0).millisecond(0).valueOf()}snapTimestamp(e){switch(this.binSnapping){case"year":return this.snapToYear(e);case"month":return this.snapToMonth(e);case"none":default:return this.snapToNextSecond(e)}}get barScalingFunction(){return typeof this.barScaling=="string"?Z0[this.barScaling]:this.barScaling}calculateHistData(){const{bins:e,height:t,dateRangeMS:i,_numBins:o,_minDateMS:s}=this,a=Math.min(...this.bins),l=Math.max(...this.bins),d=a===l?1:this.barScalingFunction(l),u=t/d,p=i/o;return e.map((m,v)=>{const y=this.snapTimestamp(v*p+s),S=this.formatDate(y),x=this.snapTimestamp((v+1)*p+s)+this.snapEndOffset,_=this.formatDate(x),D=this.formatDate(y,this.tooltipDateFormat),M=this.formatDate(x,this.tooltipDateFormat),A=D===M?D:`${D} - ${M}`;return{value:m,height:Math.floor(this.barScalingFunction(m)*u),binStart:S,binEnd:_,tooltip:A}})}get hasBinData(){return this._numBins>0}get _numBins(){return!this.bins||!this.bins.length?0:this.bins.length}get histogramLeftEdgeX(){return this.sliderWidth}get histogramRightEdgeX(){return this.width-this.sliderWidth}get snapInterval(){switch(this.binSnapping){case"year":return 31536e6;case"month":return 2592e6;case"none":default:return 0}}get snapEndOffset(){return this.binSnapping!=="none"&&this._numBins>1?-1:0}get tooltipDateFormat(){var e;return(e=this._tooltipDateFormat)!==null&&e!==void 0?e:this.dateFormat}set tooltipDateFormat(e){this._tooltipDateFormat=e}get loading(){return this._isLoading}set loading(e){this.disabled=e,this._isLoading=e}get minSelectedDate(){return this.formatDate(this.getMSFromString(this._minSelectedDate))}set minSelectedDate(e){if(!this._minSelectedDate){this._minSelectedDate=e;return}const t=this.getMSFromString(e),i=!Number.isNaN(t),o=t<=this.getMSFromString(this.maxSelectedDate);i&&o&&(this._minSelectedDate=this.formatDate(t)),this.requestUpdate()}get maxSelectedDate(){return this.formatDate(this.getMSFromString(this._maxSelectedDate))}set maxSelectedDate(e){if(!this._maxSelectedDate){this._maxSelectedDate=e;return}const t=this.getMSFromString(e),i=!Number.isNaN(t),o=t>=this.getMSFromString(this.minSelectedDate);i&&o&&(this._maxSelectedDate=this.formatDate(t)),this.requestUpdate()}get minSliderX(){const e=this.translateDateToPosition(this.minSelectedDate);return this.validMinSliderX(e)}get maxSliderX(){const e=this.snapTimestamp(this.getMSFromString(this.maxSelectedDate)+this.snapInterval),t=this.translateDateToPosition(this.formatDate(e));return this.validMaxSliderX(t)}get dateRangeMS(){return this._maxDateMS-this._minDateMS}showTooltip(e){var t,i;if(this._isDragging||this.disabled)return;const o=e.currentTarget,s=o.x.baseVal.value+this.sliderWidth/2,a=o.dataset,l=`${this.tooltipLabel}${a.numItems!=="1"?"s":""}`,d=Number(a.numItems).toLocaleString(),u=2,m=9+this.tooltipHeight,v=this.getBoundingClientRect(),y=v.x+s,S=v.y;this._tooltipOffsetX=y-u+(this._binWidth-this.sliderWidth-this.tooltipWidth)/2+window.scrollX,this._tooltipOffsetY=S-m+window.scrollY,this._tooltipContent=h`
      ${d} ${l}<br />
      ${a.tooltip}
    `,(i=(t=this._tooltip).showPopover)===null||i===void 0||i.call(t)}hideTooltip(){var e,t;this._tooltipContent=void 0,(t=(e=this._tooltip).hidePopover)===null||t===void 0||t.call(e)}validMinSliderX(e){const t=Math.min(this.translateDateToPosition(this.maxSelectedDate),this.histogramRightEdgeX);return e=this.clamp(e,this.histogramLeftEdgeX,t),Number.isNaN(e)||t<this.histogramLeftEdgeX?this.histogramLeftEdgeX:e}validMaxSliderX(e){const t=Math.max(this.histogramLeftEdgeX,this.translateDateToPosition(this.minSelectedDate));return e=this.clamp(e,t,this.histogramRightEdgeX),Number.isNaN(e)||t>this.histogramRightEdgeX?this.histogramRightEdgeX:e}addListeners(){window.addEventListener("pointermove",this.move),window.addEventListener("pointerup",this.drop),window.addEventListener("pointercancel",this.drop)}removeListeners(){window.removeEventListener("pointermove",this.move),window.removeEventListener("pointerup",this.drop),window.removeEventListener("pointercancel",this.drop)}beginEmitUpdateProcess(){this.cancelPendingUpdateEvent(),this._emitUpdatedEventTimer=setTimeout(()=>{if(this.currentDateRangeString===this._previousDateRange)return;this._previousDateRange=this.currentDateRangeString;const e={detail:{minDate:this.minSelectedDate,maxDate:this.maxSelectedDate},bubbles:!0,composed:!0};this.dispatchEvent(new CustomEvent("histogramDateRangeUpdated",e))},this.updateDelay)}cancelPendingUpdateEvent(){this._emitUpdatedEventTimer!==void 0&&(clearTimeout(this._emitUpdatedEventTimer),this._emitUpdatedEventTimer=void 0)}setDragOffset(e){this._currentSlider=e.currentTarget;const t=this._currentSlider.id==="slider-min"?this.minSliderX:this.maxSliderX,i=this.getBoundingClientRect().x;this._dragOffset=e.clientX-i-t}translatePositionToDate(e){const t=this.snapToNextSecond((e-this.sliderWidth)*this.dateRangeMS/this._histWidth);return this.formatDate(this._minDateMS+t)}translateDateToPosition(e){const t=this.getMSFromString(e);return this.sliderWidth+(t-this._minDateMS)*this._histWidth/this.dateRangeMS}clamp(e,t,i){return Math.min(Math.max(e,t),i)}handleInputFocus(){this.updateWhileFocused||this.cancelPendingUpdateEvent()}handleMinDateInput(e){const t=e.currentTarget;t.value!==this.minSelectedDate&&(this.minSelectedDate=t.value,this.beginEmitUpdateProcess())}handleMaxDateInput(e){const t=e.currentTarget;t.value!==this.maxSelectedDate&&(this.maxSelectedDate=t.value,this.beginEmitUpdateProcess())}handleKeyUp(e){if(e.key==="Enter"){const t=e.currentTarget;t.blur(),t.id==="date-min"?this.handleMinDateInput(e):t.id==="date-max"&&this.handleMaxDateInput(e)}}get currentDateRangeString(){return`${this.minSelectedDate}:${this.maxSelectedDate}`}getMSFromString(e){const t=typeof e=="string"?e:String(e);if((t.split(/(\d+)/).length-1)/2===1){const o=new Date(0,0);return o.setFullYear(Number(t)),o.getTime()}return ie(t,[this.dateFormat,Qa]).valueOf()}handleBarClick(e){const t=e.currentTarget.dataset,i=(this.getMSFromString(t.binStart)+this.getMSFromString(t.binEnd))/2,o=Math.abs(i-this.getMSFromString(this.minSelectedDate)),s=Math.abs(i-this.getMSFromString(this.maxSelectedDate));o<s?this.minSelectedDate=t.binStart:this.maxSelectedDate=t.binEnd,this.beginEmitUpdateProcess()}get minSliderTemplate(){const e=Ka,t=`
            M${this.minSliderX},0
            ...
            q0,${e} ${e},${e}
            h${this.sliderWidth-e}
          `;return this.generateSliderSVG(this.minSliderX,"slider-min",t)}get maxSliderTemplate(){const e=Ka,t=`
            M${this.maxSliderX},0
            h${this.sliderWidth-e}
            q${e},0 ${e},${e}
            v${this.height-e*2}
    ...
    `}get selectedRangeTemplate(){return N`
      <rect
        ...
        height="${this.height}"
        fill="${eh}"
      />`}get histogramTemplate(){const e=this._histWidth/this._numBins,t=e-1;let i=this.sliderWidth;return this._histData.map(o=>{const{minSelectedDate:s,maxSelectedDate:a}=this,l=o.height,d=this.isBefore(o.binEnd,s),u=this.isAfter(o.binStart,a),p=d||u?oh:th,m=`stroke-dasharray: 0 ${t} ${l} ${t} 0 ${l}`,v=N`
        <rect
    ...
    `}get maxInputTemplate(){return h`
      <input
        ...
        ?disabled=${this.disabled}
      />
    `}get minLabelTemplate(){return h`<label for="date-min" class="sr-only">Minimum date:</label>`}get maxLabelTemplate(){return h`<label for="date-max" class="sr-only">Maximum date:</label>`}get tooltipTemplate(){const e=Zn({width:`${this.tooltipWidth}px`,height:`${this.tooltipHeight}px`,top:`${this._tooltipOffsetY}px`,left:`${this._tooltipOffsetX}px`});return h`
    ...
    ia-activity-indicator {
      ...
      --activityIndicatorLoadingRingColor: ${ih};
    }
...
`;let re=class extends P{constructor(){super(...arguments),this.prompt="Do you find this feature useful?",this.buttonText="Beta",this.displayMode="button",this.isOpen=!1,this.processing=!1,this.popupTopX=0,this.popupTopY=0,this.voteSubmitted=!1,this.voteNeedsChoosing=!1,this.resizingElement=document.body}render(){return h`
    ...
    `}get upvoteSelected(){return this.vote==="up"}get downvoteSelected(){return this.vote==="down"}upvoteKeypressed(e){(e.key==="Enter"||e.key===" ")&&this.upvoteButtonSelected()}downvoteKeypressed(e){(e.key==="Enter"||e.key===" ")&&this.downvoteButtonSelected()}upvoteButtonSelected(){this.processing||this.voteSubmitted||(this.vote=this.vote==="up"?void 0:"up",this.handleButtonSelection())}downvoteButtonSelected(){this.processing||this.voteSubmitted||(this.vote=this.vote==="down"?void 0:"down",this.handleButtonSelection())}async handleButtonSelection(){this.isOpen||(await this.setupRecaptcha(),this.submit())}get chooseVoteErrorClass(){return this.voteNeedsChoosing?"error":""}get upvoteButtonClass(){switch(this.vote){case"up":return"selected";case"down":return"unselected";default:return"noselection"}}get downvoteButtonClass(){switch(this.vote){case"up":return"unselected";case"down":return"selected";default:return"noselection"}}backgroundClicked(e){var t;e.target instanceof Node&&(!((t=this.popup)===null||t===void 0)&&t.contains(e.target)||this.cancel(e))}cancel(e){e.preventDefault(),this.closePopup(),this.voteSubmitted||this.resetState()}async submit(e){if(e?.preventDefault(),!this.vote){this.voteNeedsChoosing=!0,this.error=h`Please select a vote.`;return}if(!this.featureIdentifier)throw new Error("featureIdentifier is required");if(!this.featureFeedbackService)throw new Error("featureFeedbackService is required");if(!this.recaptchaWidget)throw new Error("recaptchaWidget is required");const t=this.isOpen;this.processing=!0;try{const i=await this.recaptchaWidget.execute();(await this.featureFeedbackService.submitFeedback({featureIdentifier:this.featureIdentifier,vote:this.vote,comments:this.comments.value,recaptchaToken:i})).success?(this.voteSubmitted=!0,t&&this.closePopup()):this.error=h`There was an error submitting your feedback.`}catch(i){this.error=h`There was an error submitting your feedback.<br />Error:
        ${i instanceof Error?i.message:i}`}this.processing=!1}static get styles(){const e=f`var(--featureFeedbackBlueColor, #194880)`,t=f`var(--featureFeedbackDarkGrayColor, #767676)`,i=f`var(--defaultColorSvgFilter, invert(52%) sepia(0%) saturate(1%) hue-rotate(331deg) brightness(87%) contrast(89%))`,o=f`var(--featureFeedbackBackdropZindex, 5)`,s=f`var(--featureFeedbackModalZindex, 6)`,a=f`var(--featureFeedbackPopupBorderColor, ${e})`,l=f`var(--featureFeedbackSubmitButtonColor, ${e})`,d=f`var(--featureFeedbackBetaButtonBorderColor, ${e})`,u=f`var(--featureFeedbackBetaButtonTextColor, ${e})`,p=f`var(--featureFeedbackBetaButtonSvgFilter, ${i})`,m=f`var(--featureFeedbackCancelButtonColor, #515151)`,v=f`var(--featureFeedbackPopupBlockerColor, rgba(255, 255, 255, 0.3))`,y=f`var(--featureFeedbackPopupBackgroundColor, #F5F5F7)`,S=f`var(--featureFeedbackPromptFontWeight, bold)`,x=f`var(--featureFeedbackPromptFontSize, 1.4rem)`,_=f`var(--featureFeedbackCommentButtonFontWeight, normal)`,D=f`var(--featureFeedbackCommentButtonFontWeight, 1.4rem)`,M=f`var(--defaultColor, ${t});`,A=f`var(--defaultColorSvgFilter, ${i});`,I=f`var(--upvoteColor, #23765D);`,W=f`var(--upvoteColorSvgFilter, invert(34%) sepia(72%) saturate(357%) hue-rotate(111deg) brightness(97%) contrast(95%));`,se=f`var(--downvoteColor, #720D11);`,ze=f`var(--downvoteColorSvgFilter, invert(5%) sepia(81%) saturate(5874%) hue-rotate(352deg) brightness(105%) contrast(95%));`,ge=f`var(--unselectedColor, #CCCCCC);`,ce=f`var(--unselectedColorSvgFilter, invert(100%) sepia(0%) saturate(107%) hue-rotate(138deg) brightness(89%) contrast(77%));`;return f`
      #container {
        display: inline-block;
      }
    ...
    `}};n([c({type:String})],re.prototype,"featureIdentifier",void 0);n([c({type:String})],re.prototype,"prompt",void 0);n([c({type:String})],re.prototype,"buttonText",void 0);n([c({type:String})],re.prototype,"displayMode",void 0);n([c({type:Object})],re.prototype,"recaptchaManager",void 0);n([c({type:Object})],re.prototype,"resizeObserver",void 0);n([c({type:Boolean})],re.prototype,"disabled",void 0);n([c({type:Object})],re.prototype,"featureFeedbackService",void 0);n([F()],re.prototype,"isOpen",void 0);n([F()],re.prototype,"processing",void 0);n([F()],re.prototype,"popupTopX",void 0);n([F()],re.prototype,"popupTopY",void 0);n([F()],re.prototype,"vote",void 0);n([F()],re.prototype,"voteSubmitted",void 0);n([F()],re.prototype,"error",void 0);n([F()],re.prototype,"voteNeedsChoosing",void 0);n([F()],re.prototype,"recaptchaWidget",void 0);n([V("#container")],re.prototype,"container",void 0);n([V("#popup")],re.prototype,"popup",void 0);n([V("#comments")],re.prototype,"comments",void 0);re=n([R("feature-feedback")],re);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const hh=r=>typeof r!="string"&&"strTag"in r,ph=(r,e,t)=>{let i=r[0];for(let o=1;o<r.length;o++)i+=e[o-1],i+=r[o];return i};/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const uh=r=>hh(r)?ph(r.strings,r.values):r;/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class fh{constructor(){this.settled=!1,this.promise=new Promise((e,t)=>{this._resolve=e,this._reject=t})}resolve(e){this.settled=!0,this._resolve(e)}reject(e){this.settled=!0,this._reject(e)}}/**
 * @license
 * Copyright 2014 Travis Webb
 * SPDX-License-Identifier: MIT
 */for(let r=0;r<256;r++)(r>>4&15).toString(16)+(r&15).toString(16);/**
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let mh=new fh;mh.resolve();/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let je=uh;const Ja=f`var(--white, #fff)`,vh=f`var(--ia-theme-link-color, #4b64ff)`,gh=f`var(--primaryDisableCTAFill, #767676)`,bh=f`var(--secondaryCTABorder, #999)`,yh=f`var(--primaryCTAFill, #194880)`,Ar=f`var(--primaryCTAFillRGB, 25, 72, 128)`,wh=f`var(--primaryCTABorder, #c5d1df)`,xh=f`var(--primaryErrorCTAFill, #d9534f)`,Dr=f`var(--primaryErrorCTAFillRGB, 229, 28, 38)`,Sh=f`var(--primaryErrorCTABorder, #d43f3a)`,$h=f`var(--secondaryCTAFill, #333)`,Fr=f`var(--secondaryCTAFillRGB, 51, 51, 51)`,_h=f`var(--primaryCTABorder, #979797)`,Ch=f`var(---primaryWarningFill, #ee8950)`,Lr=f`var(--primaryWarningFillRGB, 238, 137, 80)`,kh=f`var(--primaryWarningBorder, #ec7939)`,Th=f`
  .ia-button {
    min-height: 3rem;
    cursor: pointer;
    color: ${Ja};
...
`;function en(r){return"disabled"in r&&typeof r.disabled=="boolean"}function Eh(r){return"numbered"in r&&typeof r.numbered=="boolean"}function Mh(r){return"validate"in r&&typeof r.validate=="function"}function Ah(r){return"response"in r&&typeof r.response=="object"&&r.response!==null&&"name"in r.response&&typeof r.response.name=="string"}class Dh extends Error{}async function zr(r,e,t="Operation timed out"){const i=new Promise((o,s)=>setTimeout(s,e,new Dh(t)));return Promise.race([r,i])}var Ft;let Z=Ft=class extends P{constructor(){super(...arguments),this.buttonText="Feedback",this.showButtonThumbs=!1,this.showQuestionNumbers=!1,this.disabled=!1,this.submitTimeout=8e3,this.isOpen=!1,this.submissionState="idle",this.popupTopX=0,this.popupTopY=0,this.resizingElement=document.body,this.handleScroll=()=>{this.isOpen&&this.positionPopup()},this.handleEscape=e=>{e.key==="Escape"&&this.cancel(e)}}render(){return h`<div id="container">${this.feedbackButtonTemplate}</div>`}willUpdate(e){if(e.has("submissionState")&&(this.isProcessing||this.isSubmitted?this.disableSlottedChildren():this.restoreSlottedChildrenDisabledStates()),e.has("resizeObserver")){const t=e.get("resizeObserver");this.disconnectResizeObserver(t)}}updated(e){(e.has("showQuestionNumbers")||e.has("assignedElements"))&&this.applyQuestionNumbers();const t=e.get("submissionState");t&&(this.submissionState==="error"||t==="error")&&this.positionPopup(),e.has("isOpen")&&this.isOpen&&this.focusFirstFormElement()}disconnectedCallback(){this.removeEscapeListener(),this.stopScrollObserver(),this.disconnectResizeObserver(this.resizeObserver)}disableSlottedChildren(){this.assignedElements.filter(en).forEach(e=>{e.dataset.originallyDisabled=e.disabled?"true":"false",e.disabled=!0})}restoreSlottedChildrenDisabledStates(){this.assignedElements.filter(en).forEach(e=>{const{originallyDisabled:t}=e.dataset;if(t===void 0)return;const i=t==="true";delete e.dataset.originallyDisabled,e.disabled=i})}handleResize(){this.isOpen&&this.positionPopup()}setupEscapeListener(){document.addEventListener("keyup",this.handleEscape)}removeEscapeListener(){document.removeEventListener("keyup",this.handleEscape)}setupScrollObserver(){document.addEventListener("scroll",this.handleScroll)}stopScrollObserver(){document.removeEventListener("scroll",this.handleScroll)}setupResizeObserver(){this.resizeObserver&&this.resizeObserver.addObserver({handler:this,target:this.resizingElement})}disconnectResizeObserver(e){const t=e??this.resizeObserver;t?.removeObserver({handler:this,target:this.resizingElement})}getRecaptchaWidget(){if(this.recaptchaWidgetPromise)return this.recaptchaWidgetPromise;if(this.recaptchaManager)return this.recaptchaWidgetPromise=this.recaptchaManager.getRecaptchaWidget(),this.recaptchaWidgetPromise}resetSubmissionState(){this.setSubmissionState("idle"),this.error=void 0}setSubmissionState(e){this.submissionState!==e&&(this.submissionState=e,this.emitSubmissionStateChanged())}emitSubmissionStateChanged(){this.dispatchEvent(new CustomEvent("submissionStateChanged",{detail:this.submissionState}))}get isProcessing(){return this.submissionState==="processing"}get isSubmitted(){return this.submissionState==="submitted"}showPopup(){this.isSubmitted||(this.setupResizeObserver(),this.setupScrollObserver(),this.setupEscapeListener(),this.positionPopup(),this.isOpen=!0,this.getRecaptchaWidget())}closePopup(){this.disconnectResizeObserver(),this.stopScrollObserver(),this.removeEscapeListener(),this.isOpen=!1}positionPopup(){const e=this.container.getBoundingClientRect(),t=this.popup.getBoundingClientRect(),i=window.innerWidth,o=window.innerHeight,s=i/2,a=o/2,l=5,d=5;e.left<s?this.popupTopX=e.right-20:this.popupTopX=e.left+20-t.width,this.popupTopX+t.width>i&&(this.popupTopX=i-t.width-l),e.top<a?this.popupTopY=e.bottom-10:this.popupTopY=e.top+10-t.height,this.popupTopY+t.height>o&&(this.popupTopY=o-t.height-d),this.popupTopX=Math.max(l,this.popupTopX),this.popupTopY=Math.max(d,this.popupTopY)}get feedbackButtonThumbsTemplate(){return this.showButtonThumbs?h`
    ...
    `:b}get feedbackButtonCheckTemplate(){return h`<span class="beta-button-icon success">&check;</span>`}get feedbackButtonTemplate(){return h`
      ...
      ${this.popupTemplate}
    `}get popupTemplate(){const e=this.isProcessing||this.isSubmitted,t=this.isProcessing?Ft.SUBMIT_BUTTON_PROCESSING_TEXT:Ft.SUBMIT_BUTTON_NORMAL_TEXT,i=this.error?h`<div id="error">${this.error}</div>`:b,o=Zn({left:`${this.popupTopX}px`,top:`${this.popupTopY}px`}),s=a=>a.stopPropagation();return h`
      <div
        id="popup-background"
        class=${this.isOpen?"open":"closed"}
        @click=${this.backgroundClicked}
    ...
    `}focusFirstFormElement(){const e=this.getRootNode();for(const t of this.assignedElements)if(t.focus(),e.activeElement===t)return;this.focusCancelButton()}focusCancelButton(){this.cancelButton.focus()}focusSubmitButton(){this.submitButton.focus()}applyQuestionNumbers(){if(!this.showQuestionNumbers){this.assignedElements.forEach(t=>{var i;(i=t.querySelector("[slot=question-number]"))===null||i===void 0||i.remove()});return}let e=1;this.assignedElements.filter(t=>Eh(t)&&t.numbered).forEach(t=>{let i=t.querySelector("[slot=question-number]");i||(i=document.createElement("span"),i.setAttribute("slot","question-number")),i.textContent=`${e}. `,t.append(i),e+=1})}backgroundClicked(e){var t;e.target instanceof Node&&(!((t=this.popup)===null||t===void 0)&&t.contains(e.target)||this.cancel(e))}cancel(e){e.preventDefault(),this.closePopup(),this.isSubmitted||this.resetSubmissionState()}validate(){return this.assignedElements.filter(Mh).map(e=>e.validate()).every(e=>e)}async submit(e){if(e?.preventDefault(),!this.validate()){this.error=h`${Ft.ERROR_MESSAGE_MISSING_REQUIRED_INPUT}`,this.setSubmissionState("error");return}const{surveyIdentifier:t,submitTimeout:i,featureFeedbackService:o}=this;if(this.error=void 0,!t)throw new Error("surveyIdentifier is required");if(!o)throw new Error("featureFeedbackService is required");const s=this.getRecaptchaWidget();let a;try{a=await zr(s,i)}catch(d){throw new Error(`recaptchaWidget load failed: ${d}`)}if(!a)throw new Error("recaptchaWidget is required");const l=this.isOpen;this.setSubmissionState("processing");try{const d=await zr(a.execute(),i);(await zr(o.submitSurvey({surveyIdentifier:t,responses:this.assignedElements.filter(Ah).map(p=>p.response),recaptchaToken:d}),i)).success?(this.setSubmissionState("submitted"),l&&this.closePopup()):(this.error=h`${Ft.ERROR_MESSAGE_SUBMIT_REQUEST_FAILED}`,this.setSubmissionState("error"))}catch(d){this.error=h`${Ft.ERROR_MESSAGE_SUBMIT_REQUEST_FAILED}
        <br />
...
`;let ke=class extends P{constructor(){super(...arguments),this.binSnapping="none",this.barScaling="logarithmic",this.boundEscapeListener=e=>{e.key==="Escape"&&this.closeModal()}}render(){var e,t,i;return h`
    ...
    `}connectedCallback(){var e;(e=super.connectedCallback)===null||e===void 0||e.call(this),this.setupEscapeListener()}disconnectedCallback(){var e;(e=super.disconnectedCallback)===null||e===void 0||e.call(this),this.removeEscapeListener()}setupEscapeListener(){document.addEventListener("keydown",this.boundEscapeListener)}removeEscapeListener(){document.removeEventListener("keydown",this.boundEscapeListener)}histogramDateRangeUpdated(e){this.minSelectedDate=e.detail.minDate,this.maxSelectedDate=e.detail.maxDate}applyBtnClicked(){var e;const t=new CustomEvent("histogramDateRangeApplied",{detail:{minDate:this.minSelectedDate,maxDate:this.maxSelectedDate}});this.dispatchEvent(t),this.closeModal(),(e=this.analyticsHandler)===null||e===void 0||e.sendEvent({category:it.default,action:te.histogramChangedFromModal,label:window.location.href})}closeModal(){this.modalManager&&(this.modalManager.closeModal(),this.dispatchEvent(new CustomEvent("modalClosed")))}static get styles(){return f`
      #container {
        display: flex;
        justify-content: center;
...
`;let fi=class extends P{constructor(){super(...arguments),this.step=2,this.currentPage=1,this.pages=[]}firstUpdated(){this.observePageCount()}updated(e){e.has("size")&&this.observePageCount(),e.has("currentPage")&&(this.observePageCount(),this.emitPageClick())}observePageCount(){this.pages=[];const e=7,t=this.size<=e;if(this.size<=5){this.pages=[...Array(this.size).keys()].map(s=>s+1);return}if(this.size===e){if(this.currentPage===2){this.pages=[1,2,3,4,0,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,4,5,this.size-1,this.size];return}}if(this.currentPage===1){this.pages=[1,2,3,0,this.size];return}if(this.currentPage===this.size){this.pages=[1,0,this.size-2,this.size-1,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,this.size-3,this.size-2,this.size-1,this.size];return}if(t&&this.currentPage>1&&this.currentPage<e){this.pages=[...Array(this.size).keys()].map(s=>s+1);return}let i=this.currentPage-this.step,o=this.currentPage+this.step;i<=0&&(o+=-i+1,i=1),o>=this.size&&(i=Math.max(i-(o-this.size),1),o=this.size),i===2&&(o-=1),o===this.size-1&&(i+=1),this.createFirstNode(i),this.createMiddelNode(i,o),this.createLastNode(o)}createFirstNode(e){var t,i;e>1&&((t=this.pages)===null||t===void 0||t.push(1)),e>2&&((i=this.pages)===null||i===void 0||i.push(0))}createMiddelNode(e,t){var i;for(let o=e;o<=t;o+=1)(i=this.pages)===null||i===void 0||i.push(o)}createLastNode(e){var t,i;e<this.size-1&&((t=this.pages)===null||t===void 0||t.push(0)),e<this.size&&((i=this.pages)===null||i===void 0||i.push(this.size))}get getEllipsisTemplate(){return h`<i class="ellipses">...</i>`}emitPageClick(){this.dispatchEvent(new CustomEvent("pageNumberClicked",{detail:{page:this.currentPage},bubbles:!0,composed:!0}))}onRewind(){this.currentPage-=1,this.currentPage<1&&(this.currentPage=1)}onForward(){this.currentPage+=1,this.currentPage>this.size&&(this.currentPage=this.size)}onChange(e){this.currentPage=e}getPageTemplate(e){return h`
    ...
    `}static get styles(){return[ut,f`
      ...
      `]}};n([c({type:Number})],fi.prototype,"size",void 0);n([c({type:Number})],fi.prototype,"step",void 0);n([c({type:Number})],fi.prototype,"currentPage",void 0);n([F()],fi.prototype,"pages",void 0);fi=n([R("more-facets-pagination")],fi);const Bh=N`
...
`;var cs;let Ji=cs=class extends P{render(){return h`${this.facetRowTemplate}`}get facetRowTemplate(){var e,t,i,o;const{bucket:s,facetType:a}=this;if(!s||!a)return b;const l=`${a}:${s.key}-show-only`,d=`${a}:${s.key}-negative`,u=s.extraNote?h`<span class="facet-note">${s.extraNote}</span>`:b,p=a!=="collection"?h`${(e=s.displayText)!==null&&e!==void 0?e:s.key} ${u}`:h`<a href="/details/${s.key}">
            ${(i=(t=this.collectionTitles)===null||t===void 0?void 0:t.get(s.key))!==null&&i!==void 0?i:s.key}
          </a> `,m=s.state==="hidden",v=s.state==="selected",y=`${a}: ${(o=s.displayText)!==null&&o!==void 0?o:s.key}`,S=v?`Show all ${a}s`:`Only show ${y}`,x=`Hide ${y}`,_=`Unhide ${y}`,D=m?_:x,M=`${y}, ${s.count} results`;return h`
    ...
    `}};n([c({type:String})],Ji.prototype,"facetType",void 0);n([c({type:Object})],Ji.prototype,"bucket",void 0);n([c({type:Object})],Ji.prototype,"collectionTitles",void 0);Ji=cs=n([R("facet-row")],Ji);let Ho=class extends P{facetClicked(e){this.dispatchFacetClickEvent(e.detail)}dispatchFacetClickEvent(e){const t=new CustomEvent("facetClick",{detail:e,composed:!0});this.dispatchEvent(t)}get facetsTemplate(){const{facetGroup:e}=this;if(!e)return b;const t=e.buckets;return h`
      <div class="facet-rows" data-testid="facets-on-${e.key}">
        ${xs(t,i=>`${e.key}:${i.key}`,i=>h`<facet-row
              .facetType=${e.key}
              .bucket=${i}
              .collectionTitles=${this.collectionTitles}
    ...
    `}get value(){return this.side==="left"?this.leftValue:this.rightValue}get selectedLabel(){var e,t;return this.side==="left"?(e=this.leftLabel)!==null&&e!==void 0?e:this.leftValue:(t=this.rightLabel)!==null&&t!==void 0?t:this.rightValue}handleClick(){this.side=this.side==="left"?"right":"left",this.emitChangeEvent()}handleRadioChange(){this.side=this.leftRadio.checked?"left":"right",this.emitChangeEvent()}emitChangeEvent(){const e=new CustomEvent("change",{detail:this.value});this.dispatchEvent(e)}static get styles(){const e=f`var(--switchWidth, 30px)`,t=f`var(--switchHeight, 14px)`,i=f`var(--switchMarginLeft, 5px)`,o=f`var(--switchMarginRight, 5px)`,s=f`var(--switchBorderWidth, 3px)`,a=f`var(--switchBgColor, #194880)`,l=f`var(--switchBorderColor, #194880)`,d=f`var(--labelFontSize, 1.3rem)`,u=f`var(--knobColor, white)`,p=f`var(--knobTransitionDuration, 0.25s)`,m=f`var(--knobTransitionFn, ease)`;return[ut,f`
      ...
      `]}};n([c({type:String,attribute:!0})],xt.prototype,"leftValue",void 0);n([c({type:String,attribute:!0})],xt.prototype,"leftLabel",void 0);n([c({type:String,attribute:!0})],xt.prototype,"rightValue",void 0);n([c({type:String,attribute:!0})],xt.prototype,"rightLabel",void 0);n([c({type:String,attribute:!0})],xt.prototype,"side",void 0);n([V("#switch-left")],xt.prototype,"leftRadio",void 0);xt=n([R("toggle-switch")],xt);let ne=class extends P{constructor(){super(...arguments),this.facetsPerPage=35,this.facetsLoading=!0,this.sortedBy=j.COUNT,this.isTvSearch=!1,this.unappliedFacetChanges=dt(),this.pageNumber=1}willUpdate(e){(e.has("aggregations")||e.has("facetsPerPage")||e.has("sortedBy")||e.has("selectedFacets")||e.has("unappliedFacetChanges"))&&(this.facetGroup=this.mergedFacets)}updated(e){(e.has("facetKey")||e.has("query")||e.has("searchType")||e.has("filterMap"))&&(this.facetsLoading=!0,this.pageNumber=1,this.sortedBy=Ui[this.facetKey],this.updateSpecificFacets())}firstUpdated(){this.setupEscapeListeners()}setupEscapeListeners(){this.modalManager?document.addEventListener("keydown",e=>{var t;e.key==="Escape"&&((t=this.modalManager)===null||t===void 0||t.closeModal())}):document.removeEventListener("keydown",()=>{})}get isSearchResultsPage(){var e;const t=(e=this.pageSpecifierParams)===null||e===void 0?void 0:e.pageType;return t===void 0||t==="search_results"}async updateSpecificFacets(){var e,t,i,o,s,a;if(!this.facetKey)return;const l=(e=this.query)===null||e===void 0?void 0:e.trim();if(!l&&this.isSearchResultsPage)return;const d={simpleParams:[this.facetKey]},p={...this.pageSpecifierParams,query:l||"",filters:this.filterMap,aggregations:d,aggregationsSize:65535,rows:0},m=await((t=this.searchService)===null||t===void 0?void 0:t.search(p,this.searchType));this.aggregations=(i=m?.success)===null||i===void 0?void 0:i.response.aggregations,this.facetsLoading=!1;const v=(s=(o=m?.success)===null||o===void 0?void 0:o.response)===null||s===void 0?void 0:s.collectionTitles;if(v)for(const[y,S]of Object.entries(v))(a=this.collectionTitles)===null||a===void 0||a.set(y,S)}pageNumberClicked(e){var t,i;const o=(t=e?.detail)===null||t===void 0?void 0:t.page;o&&(this.pageNumber=Number(o)),(i=this.analyticsHandler)===null||i===void 0||i.sendEvent({category:it.default,action:te.moreFacetsPageChange,label:`${this.pageNumber}`})}get mergedFacets(){var e;if(!this.facetKey||!this.selectedFacets)return;const{selectedFacetGroup:t,aggregationFacetGroup:i}=this;if(!i)return;const o={...t??i},s=(e=t?.buckets.map(l=>{const d=i.buckets.find(u=>u.key===l.key);return d?{...l,count:d.count}:l}))!==null&&e!==void 0?e:[];Fn(s,this.sortedBy),i.buckets.forEach(l=>{t?.buckets.find(u=>u.key===l.key)||s.push(l)});const a=this.unappliedFacetChanges[this.facetKey];for(const[l,d]of s.entries()){const u=a?.[d.key];u&&(s[l]={...u})}return this.facetKey==="creator"&&this.isTvSearch&&s.forEach(l=>{var d,u,p;l.displayText=(u=(d=l.displayText)!==null&&d!==void 0?d:l.key)===null||u===void 0?void 0:u.toLocaleUpperCase();const m=(p=this.tvChannelAliases)===null||p===void 0?void 0:p.get(l.displayText);m&&m!==l.displayText&&(l.extraNote=`(${m})`)}),o.buckets=s,o}get selectedFacetGroup(){if(!this.selectedFacets||!this.facetKey)return;const e=this.selectedFacets[this.facetKey];if(!e)return;const t=Fo[this.facetKey],i=Object.entries(e).map(([o,s])=>({displayText:o,key:o,count:s?.count,state:s?.state}));return{title:t,key:this.facetKey,buckets:i}}get aggregationFacetGroup(){if(!this.aggregations||!this.facetKey)return;const e=this.aggregations[this.facetKey];if(!e)return;const t=Fo[this.facetKey];let i=e.getSortedBuckets(this.sortedBy);this.facetKey==="collection"&&(i=i?.filter(s=>{var a;const l=(a=s?.key)===null||a===void 0?void 0:a.toString();return!qo[l]&&!l?.startsWith("fav-")}));const o=i.map(s=>{const a=`${s.key}`;return{displayText:`${a}`,key:`${a}`,count:s.doc_count,state:"none"}});return{title:t,key:this.facetKey,buckets:o}}get facetGroupForCurrentPage(){const{facetGroup:e}=this;if(!e)return;const t=(this.pageNumber-1)*this.facetsPerPage,i=e.buckets.slice(t,t+this.facetsPerPage);return{...e,buckets:i}}get moreFacetsTemplate(){return h`
      <facets-template
        .facetGroup=${this.facetGroupForCurrentPage}
        .selectedFacets=${this.selectedFacets}
        .collectionTitles=${this.collectionTitles}
        @facetClick=${e=>{this.facetKey&&(this.unappliedFacetChanges=zo(this.unappliedFacetChanges,this.facetKey,e.detail.bucket))}}
      ></facets-template>
    `}get loaderTemplate(){return h`<div class="facets-loader">
      <ia-activity-indicator .mode=${"processing"}></ia-activity-indicator>
        ...
        </div> `:b}sortFacetAggregation(e){this.sortedBy=e,this.dispatchEvent(new CustomEvent("sortedFacets",{detail:this.sortedBy}))}get modalHeaderTemplate(){var e,t,i;const s=((e=this.sortedBy)!==null&&e!==void 0?e:Ui[this.facetKey])===j.COUNT?"left":"right";return h`<span class="sr-only">${E("More facets for:")}</span>
      <span class="title">
      ...
      ${this.facetsLoading?this.loaderTemplate:h`
          ...
          `}
    `}applySearchFacetsClicked(){var e,t;const i=Dn(this.selectedFacets,this.unappliedFacetChanges),o=new CustomEvent("facetsChanged",{detail:i,bubbles:!0,composed:!0});this.dispatchEvent(o),this.unappliedFacetChanges=dt(),(e=this.modalManager)===null||e===void 0||e.closeModal(),(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:it.default,action:`${te.applyMoreFacetsModal}`,label:`${this.facetKey}`})}cancelClick(){var e,t;this.unappliedFacetChanges=dt(),(e=this.modalManager)===null||e===void 0||e.closeModal(),(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:it.default,action:te.closeMoreFacetsModal,label:`${this.facetKey}`})}static get styles(){const e=f`var(--primaryButtonBGColor, #194880)`;return[ut,f`
        section#more-facets {
          overflow: auto;
    ...
    `}partOfCollectionClicked(e){var t;(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:it.default,action:te.partOfCollectionClicked,label:e.target.dataset.id})}get histogramProps(){var e,t,i,o,s,a;const{histogramAggregation:l}=this;if(!l)return;const d=(e=l.first_bucket_year)!==null&&e!==void 0?e:l.first_bucket_key,u=(t=l.last_bucket_year)!==null&&t!==void 0?t:l.last_bucket_key;if(d==null||u==null)return;const p=(i=l.first_bucket_month)!==null&&i!==void 0?i:1,m=(o=l.last_bucket_month)!==null&&o!==void 0?o:12,v=(s=l.interval)!==null&&s!==void 0?s:1,y=(a=l.interval_in_months)!==null&&a!==void 0?a:12,S=x=>x.toString().padStart(2,"0");if(this.isTvSearch){const x=y<12;return{buckets:l.buckets,dateFormat:"YYYY-MM",tooltipDateFormat:x?"MMM YYYY":"YYYY",tooltipLabel:"broadcast",binSnapping:x?"month":"year",barScaling:"linear",minDate:`${d}-${S(p)}`,maxDate:`${u}-${S(m+y-1)}`}}return{buckets:l.buckets,dateFormat:"YYYY",tooltipDateFormat:"YYYY",tooltipLabel:"item",binSnapping:"year",barScaling:"logarithmic",minDate:`${d}`,maxDate:`${u+v-1}`}}showDatePickerModal(){var e,t,i;const{histogramProps:o}=this;if(!o)return;const{buckets:s,dateFormat:a,tooltipDateFormat:l,tooltipLabel:d,binSnapping:u,barScaling:p,minDate:m,maxDate:v}=o,S=h`
      <expanded-date-picker
        ${p0(_=>{if(_&&_ instanceof ke){const D=_;D.minSelectedDate=this.minSelectedDate,D.maxSelectedDate=this.maxSelectedDate}})}
        .minDate=${m}
        .maxDate=${v}
      ...
      ></expanded-date-picker>
    `,x=new Rt({bodyColor:"#fff",headerColor:"#194880",showHeaderLogo:!1,closeOnBackdropClick:!0,title:h`${E("Select a date range")}`});(e=this.modalManager)===null||e===void 0||e.classList.add("expanded-date-picker"),(t=this.modalManager)===null||t===void 0||t.showModal({config:x,customModalContent:S,userClosedModalCallback:this.handleExpandedDatePickerClosed}),(i=this.analyticsHandler)===null||i===void 0||i.sendEvent({category:it.default,action:te.histogramExpanded,label:window.location.href})}updated(e){e.has("selectedFacets")&&this.dispatchFacetsChangedEvent()}dispatchFacetsChangedEvent(){const e=new CustomEvent("facetsChanged",{detail:this.selectedFacets});this.dispatchEvent(e)}get expandDatePickerBtnTemplate(){return this.allowExpandingDatePicker&&!this.facetsLoading?h`<button
    ...
    `}searchMoreFacetsLink(e){if(!this.moreLinksVisible||e.key==="lending"||Object.keys(e.buckets).length<this.allowedFacetCount)return b;const t=Ui[e.key];return h`<button
      class="more-link"
      @click=${()=>{var i;this.showMoreFacetsModal(e,t),(i=this.analyticsHandler)===null||i===void 0||i.sendEvent({category:it.default,action:te.showMoreFacetsModal,label:e.key}),this.dispatchEvent(new CustomEvent("showMoreFacets",{detail:e.key}))}}
    ...
    `,a=new Rt({bodyColor:"#fff",headerColor:"#194880",showHeaderLogo:!1,closeOnBackdropClick:!0,title:h`Select filters`});(i=this.modalManager)===null||i===void 0||i.classList.add("more-search-facets"),(o=this.modalManager)===null||o===void 0||o.showModal({config:a,customModalContent:s,userClosedModalCallback:()=>{var l;(l=this.modalManager)===null||l===void 0||l.classList.remove("more-search-facets")}})}getFacetTemplate(e){return h`
      <facets-template
        ...
        .selectedFacets=${this.selectedFacets}
        .collectionTitles=${this.collectionTitles}
        @facetClick=${t=>{this.selectedFacets=zo(this.selectedFacets,e.key,t.detail.bucket,!0);const i=new CustomEvent("facetsChanged",{detail:this.selectedFacets,bubbles:!0,composed:!0});this.dispatchEvent(i)}}
      ></facets-template>
    `}static get styles(){return[ut,f`
        a:link {
          text-decoration: none;
    ...
    `}};on=n([R("circular-activity-indicator")],on);function Rh(r,e){return r===void 0?e!==void 0:e===void 0?r!==void 0:r.facetType===e.facetType&&r.bucketKey===e.bucketKey}function hs(r,e){return r.label===e.label&&r.facets.length===e.facets.length&&r.facets.every((t,i)=>Rh(t,e.facets[i]))}function Jn(r){if(!Array.isArray(r[0])){let o=[...r];for(let s=0;s<o.length;s++){const a=o[s];o=o.filter(l=>a===l||!hs(a,l))}return o}const e=r,t=[];for(const i of e){const o=[];for(const s of i)t.find(l=>l.find(d=>hs(s,d)))||o.push(s);o.length>0&&t.push(o)}return t}class As{async getRecommendedFacets(){const e=navigator.language,t=As.getLanguageDisplayName(e);return t?[{facets:[{facetType:"language",bucketKey:t}]}]:[]}static getLanguageDisplayName(e){const t=e.split("-")[0];return new Intl.DisplayNames(["en"],{type:"language"}).of(t)}}const Mt={facets:[{facetType:"mediatype",bucketKey:"texts"}]},At={facets:[{facetType:"mediatype",bucketKey:"audio"}]},Jt={facets:[{facetType:"mediatype",bucketKey:"movies"}]},ft={facets:[{facetType:"mediatype",bucketKey:"image"}]},Ri={facets:[{facetType:"mediatype",bucketKey:"software"}]},Br={facets:[{facetType:"mediatype",bucketKey:"etree"}]},Ih={facets:[{facetType:"mediatype",bucketKey:"web"}]},Oh={facets:[{facetType:"mediatype",bucketKey:"data"}]},Nh={text:[Mt],book:[Mt],novel:[Mt],magazine:[Mt],newspaper:[Mt],pdf:[Mt],epub:[Mt],audio:[At],song:[At],music:[At],listen:[At],podcast:[At],radio:[At],stream:[At,Jt],video:[Jt],movie:[Jt],film:[Jt],animation:[Jt],youtube:[Jt],image:[ft],photo:[ft],picture:[ft],painting:[ft],jpg:[ft],jpeg:[ft],png:[ft],gif:[ft],software:[Ri],app:[Ri],program:[Ri],game:[Ri],arcade:[Ri],etree:[Br],concert:[Br],"live music":[Br],"web crawl":[Ih],dataset:[Oh]};class Uh{async getRecommendedFacets(e){const t=[];for(const[i,o]of Object.entries(Nh))e.includes(i)&&t.push(...o);return t}}const fo=[{facets:[{facetType:"mediatype",bucketKey:"texts"}]}],rn=[{label:"Films by __QUERY",facets:[{facetType:"mediatype",bucketKey:"movies"},{facetType:"creator",bucketKey:"__QUERY"}]}],Ii=[{label:"Writing by __QUERY",facets:[{facetType:"mediatype",bucketKey:"texts"},{facetType:"creator",bucketKey:"__QUERY"}]}],mo=[{label:"Images by __QUERY",facets:[{facetType:"mediatype",bucketKey:"image"},{facetType:"creator",bucketKey:"__QUERY"}]}],Oi=[{label:"Music by __QUERY",facets:[{facetType:"mediatype",bucketKey:"audio"},{facetType:"creator",bucketKey:"__QUERY"}]}],Hh={"written work":fo,literature:fo,book:fo,novel:fo,filmmaker:rn,director:rn,author:Ii,writer:Ii,novelist:Ii,essayist:Ii,poet:Ii,"visual artist":mo,"graphic artist":mo,photographer:mo,painter:mo,singer:Oi,songwriter:Oi,musician:Oi,composer:Oi,pianist:Oi};class Vh{constructor(){this.WIKIDATA_BASE_URL="https://www.wikidata.org/w/api.php",this.WIKIDATA_DEFAULT_ARGS="?action=wbsearchentities&format=json&language=en&uselang=en&origin=*&type=item&limit=5"}getWikidataURL(e){const t=encodeURIComponent(e);return`${this.WIKIDATA_BASE_URL}${this.WIKIDATA_DEFAULT_ARGS}&search=${t}`}replaceQueryPlaceholders(e,t){return e.map(i=>{var o;return{label:(o=i.label)===null||o===void 0?void 0:o.replace("__QUERY",t),facets:i.facets.map(s=>{var a;const l={...s,bucketKey:s.bucketKey.replace("__QUERY",t.toLowerCase())};return s.displayText&&(l.displayText=(a=l.displayText)===null||a===void 0?void 0:a.replace("__QUERY",t)),l})}})}async getRecommendedFacets(e){var t;const i=[];try{const o=this.getWikidataURL(e),a=await(await fetch(o)).json();for(const[l,d]of Object.entries(Hh))if(new RegExp(`\\b${l}\\b`).test((t=a.search[0])===null||t===void 0?void 0:t.description)){const p=a.search[0].label;i.push(...this.replaceQueryPlaceholders(d,p))}return i}catch(o){return console.warn(o),[]}}}class Qo{async getRecommendedFacets(e,t=Qo.DEFAULT_HEURISTICS){const i=t.map(o=>new o().getRecommendedFacets(e));return Jn((await Promise.all(i)).flat())}}Qo.DEFAULT_HEURISTICS=[Uh,Vh,As];const Wh=h`
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path
...
`;function qh(r){return r&&r.charAt(0).toLocaleUpperCase()+r.slice(1)}let eo=class extends P{constructor(){super(...arguments),this.selected=!1}render(){var e,t;if(!this.facetInfo)return b;const i=this.facetInfo.facets.length===1,o=this.facetInfo.facets[0],s=qh((this.labelPrefix?`${this.labelPrefix} `:"")+((t=(e=this.facetInfo.label)!==null&&e!==void 0?e:o.displayText)!==null&&t!==void 0?t:o.bucketKey));if(!s)return b;const a=i&&o.facetType==="mediatype"?Pn[o.bucketKey].icon:b;return h`
      <a
      ...
      >
        ${a} ${s}
        ${this.selected?h`<span class="unselect-button">${jh}</span>`:b}
      </a>
    ...
    `}};n([c({type:Object})],eo.prototype,"facetInfo",void 0);n([c({type:String})],eo.prototype,"labelPrefix",void 0);n([c({type:Boolean})],eo.prototype,"selected",void 0);eo=n([R("smart-facet-button")],eo);let mi=class extends P{render(){var e,t;if(!this.facetInfo||!this.activeFacetRef||this.facetInfo.length===0)return b;const i=(e=this.activeFacetRef.displayText)!==null&&e!==void 0?e:this.activeFacetRef.bucketKey;return i?h`
    ...
    `}};n([c({type:Array})],mi.prototype,"facetInfo",void 0);n([c({type:String})],mi.prototype,"labelPrefix",void 0);n([c({type:Object})],mi.prototype,"activeFacetRef",void 0);n([V("ia-dropdown")],mi.prototype,"dropdown",void 0);mi=n([R("smart-facet-dropdown")],mi);const sn={collection:"Collection: ",creator:"By: ",subject:"About: "};function Gh(r){return r.charAt(0).toUpperCase()+r.slice(1)}let rt=class extends P{constructor(){super(...arguments),this.filterToggleActive=!1,this.heuristicRecs=[],this.smartFacets=[]}render(){return this.query?h`
      <div id="smart-facets-container">
        ${this.filtersToggleTemplate}
        ${xs(this.smartFacets,e=>`${e[0].label}|${e[0].facets[0].facetType}|${e[0].facets[0].bucketKey}`,e=>this.makeSmartFacet(e))}
      </div>
    `:b}willUpdate(e){let t=!1;e.has("query")&&(Ue("query change",e.get("query"),this.query),this.lastAggregations=void 0,t=!0),e.has("aggregations")&&!this.lastAggregations&&this.aggregations&&Object.keys(this.aggregations).length>0&&(Ue("aggs change",e.get("aggregations"),this.aggregations),this.lastAggregations=this.aggregations,t=!0),t&&(Ue("should update smart facets, doing so..."),this.updateSmartFacets())}refresh(){this.lastAggregations=this.aggregations,this.updateSmartFacets()}async updateSmartFacets(){Ue("updating smart facets"),this.query&&(this.heuristicRecs=await new Qo().getRecommendedFacets(this.query),Ue("heuristic recs are",this.heuristicRecs),this.smartFacets=Jn(this.facetsToDisplay),Ue("smart facets are",this.smartFacets))}makeSmartFacet(e){return e.length===0?b:e.length===1?this.smartFacetButton(e[0]):this.smartFacetDropdown(e)}smartFacetButton(e){var t;return h`
      <smart-facet-button
        .facetInfo=${e}
        .labelPrefix=${sn[e.facets[0].facetType]}
    ...
    `}smartFacetDropdown(e){return h`
      <smart-facet-dropdown
        .facetInfo=${e}
        .labelPrefix=${sn[e[0].facets[0].facetType]}
    ...
    `}};n([c({type:String})],rt.prototype,"query",void 0);n([c({type:Object})],rt.prototype,"aggregations",void 0);n([c({type:Object})],rt.prototype,"selectedFacets",void 0);n([c({type:Object})],rt.prototype,"collectionTitles",void 0);n([c({type:Boolean})],rt.prototype,"filterToggleActive",void 0);n([F()],rt.prototype,"heuristicRecs",void 0);n([F()],rt.prototype,"smartFacets",void 0);n([F()],rt.prototype,"lastAggregations",void 0);rt=n([R("smart-facet-bar")],rt);let T=class extends P{constructor(){super(),this.baseImageUrl="https://archive.org",this.searchType=O.DEFAULT,this.selectedSort=C.default,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.tvClipFilter="all",this.sortDirection=null,this.defaultSortField=C.relevance,this.defaultSortDirection=null,this.pageSize=50,this.showSmartFacetBar=!1,this.showHistogramDatePicker=!1,this.suppressPlaceholders=!1,this.suppressResultCount=!1,this.suppressResultTiles=!1,this.suppressURLQuery=!1,this.suppressSortBar=!1,this.suppressDisplayModes=!1,this.suppressMediatypeFacets=!1,this.facetLoadStrategy="eager",this.facetPaneVisible=!1,this.clearResultsOnEmptyQuery=!1,this.collectionPagePath="/details/",this.searchContext=it.default,this.pageContext="search",this.restorationStateHandler=new kd({context:this.pageContext}),this.mobileBreakpoint=600,this.loggedIn=!1,this.modalManager=void 0,this.isTVCollection=!1,this.isManageView=!1,this.manageViewLabel="Select items to remove",this.enableSortOptionsSlot=!1,this.showSmartResults=!1,this.maxPagesToManage=15,this.dataSource=new Md(this,this.pageSize),this.initialPageNumber=1,this.pagesToRender=this.initialPageNumber,this.searchResultsLoading=!1,this.facetsLoading=!1,this.mobileView=!1,this.tileBlurOverrideState="no-override",this.collapsibleFacetsVisible=!1,this.placeholderType=null,this.layoutSizeAnalyticsSent=!1,this.isScrollingToCell=!1,this.isResizeToMobile=!1,this.dataSourceInstallInProgress=!1,this.placeholderCellTemplate=h`<collection-browser-loading-tile></collection-browser-loading-tile>`,this.updateLeftColumnHeight=()=>{var e,t,i,o,s;if(this.mobileView)(t=(e=this.leftColumn)===null||e===void 0?void 0:e.style)===null||t===void 0||t.removeProperty("height");else{const a=(i=this.leftColumn)===null||i===void 0?void 0:i.getBoundingClientRect().top,l=window.innerHeight-(a??0),d=a===0?null:`calc(${l}px - var(--leftColumnPaddingTop, 2rem))`;(s=(o=this.leftColumn)===null||o===void 0?void 0:o.style)===null||s===void 0||s.setProperty("height",d)}},this.updateFacetFadeOut=e=>{var t,i;const o=(t=this.shadowRoot)===null||t===void 0?void 0:t.getElementById("facets-bottom-fade");o?.classList.toggle("hidden",(i=e?.[0])===null||i===void 0?void 0:i.isIntersecting)},this.initialQueryChangeHappened=!1,this.historyPopOccurred=!1,this.addController(this.dataSource)}tileModelAtCellIndex(e){const t=this.dataSource.getTileModelAt(e);if(!t&&!this.isScrollingToCell&&this.dataSource.queryInitialized){const i=Math.floor(e/this.pageSize)+1;this.dataSource.fetchPage(i)}return t}get estimatedTileCount(){return this.pagesToRender*this.pageSize}async getSessionId(){try{const e=sessionStorage==null?void 0:sessionStorage.getItem("cb-session");if(e)return e;if(this.sessionIdGenPromise)return this.sessionIdGenPromise;this.sessionIdGenPromise=An(Math.random().toString());const t=await this.sessionIdGenPromise;return sessionStorage==null||sessionStorage.setItem("cb-session",t),t}catch{return""}}goToPage(e){return this.initialPageNumber=e,this.pagesToRender=e,this.scrollToPage(e)}setSearchResultsLoading(e){this.searchResultsLoading=e}setFacetsLoading(e){this.facetsLoading=e}setTotalResultCount(e){this.totalResults=e}clearFilters({facets:e=!0,dateRange:t=!0,letterFilters:i=!0,sort:o=!1}={}){e&&this.hasCheckedFacets&&(this.selectedFacets=dt()),t&&(this.minSelectedDate=void 0,this.maxSelectedDate=void 0),i&&(this.selectedTitleFilter=null,this.selectedCreatorFilter=null),o&&(this.sortDirection=null,this.selectedSort=C.default)}get hasCheckedFacets(){if(!this.selectedFacets)return!1;for(const e of Object.values(this.selectedFacets))for(const t of Object.values(e))if(t.state!=="none")return!0;return!1}get hasActiveFilters(){return!!(this.hasCheckedFacets||this.minSelectedDate||this.maxSelectedDate||this.selectedTitleFilter||this.selectedCreatorFilter)}willUpdate(){this.setPlaceholderType()}render(){return h`
    ...
    `}get facetsTemplate(){if(qr.includes(this.profileElement))return b;if(this.facetLoadStrategy==="off")return h`
      ...
      `;const e=this.isTVCollection||!this.withinCollection&&this.searchType===O.TV,t=e?yd:kn,i=h`
      <collection-facets
        .collectionPagePath=${this.collectionPagePath}
      ...
      <div class="dev-tool-container">
        <div id="dev-tools" class=${this.getClass}>
          ...
          <div id="toggle-controls">
            <button
              @click=${()=>{var i,o;const s=(i=this.shadowRoot)===null||i===void 0?void 0:i.getElementById("cell-size-control");s?.classList.toggle("hidden");const a=(o=this.shadowRoot)===null||o===void 0?void 0:o.getElementById("cell-gap-control");a?.classList.toggle("hidden")}}
            >
