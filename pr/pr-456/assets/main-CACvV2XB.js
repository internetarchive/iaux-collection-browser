 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*Ct(r,e){if(r!==void 0){let t=0;for(const i of r)yield e(i,t++)}}function nd(r){return new Date(r.getTime()-r.getTimezoneOffset()*1e3*60)}function rs(r){return r?nd(r).toISOString().endsWith("-01-01T00:00:00.000Z"):!1}const pn=c`
 ...
 */function*io(r,e){const t=typeof e=="function";if(r!==void 0){let i=-1;for(const o of r)i>-1&&(yield t?e(i):e),i++,yield o}}let go=class extends B{constructor(){super(...arguments),this.snippets=[],this.viewSize="desktop"}render(){var e;return!((e=this.snippets)===null||e===void 0)&&e.length?c`
    ...
    `}};n([h({type:Array})],go.prototype,"snippets",void 0);n([h({type:String})],go.prototype,"viewSize",void 0);go=n([F("text-snippet-block")],go);const dd=m`
  .drop-shadow {
    overflow: hidden;
    height: 100%;
  }
...
`,fn={account:{color:"#000000",icon:hd,text:"Account"},audio:{color:"#00adef",icon:pd,text:"Audio"},collection:{color:"#4666ff",icon:hn,text:"Collection"},data:{color:"#333333",icon:ud,text:"Data"},etree:{color:"#00adef",icon:fd,text:"E-tree"},film:{color:"#bf1b2c",icon:sa,text:"Film"},image:{color:"#aa99c9",icon:md,text:"Image"},movies:{color:"#f1644b",icon:sa,text:"Movie"},radio:{color:"#8fdaef",icon:vd,text:"Radio"},software:{color:"#9ecc4f",icon:gd,text:"Software"},texts:{color:"#faab3c",icon:bd,text:"Text"},tv:{color:"#f1644b",icon:yd,text:"TV"},video:{color:"#f1644b",icon:wd,text:"Video"},web:{color:"#ffcd27",icon:xd,text:"Web"},search:{color:"#000000",icon:un,text:"Search"}};let Fi=class extends B{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var e,t;const i=["tvnews","tvarchive","television"],o=["radio","radioprogram"];return this.mediatype==="movies"&&(!((e=this.collections)===null||e===void 0)&&e.some(s=>i.indexOf(s)>=0))?"tv":this.mediatype==="audio"&&(!((t=this.collections)===null||t===void 0)&&t.some(s=>o.indexOf(s)>=0))?"radio":this.mediatype||""}render(){const e=fn[this.displayMediatype];return e?c`
      <div
        id="icon"
    ...
    `}};n([h({type:String})],Fi.prototype,"mediatype",void 0);n([h({type:Array})],Fi.prototype,"collections",void 0);n([h({type:Boolean})],Fi.prototype,"showText",void 0);Fi=n([F("mediatype-icon")],Fi);const Sd=O`
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path
...
`;function kd(r,e){let t=1;return r>=1e9?t=1e9:r>=1e6?t=1e6:r>=1e3&&e==="short"&&(t=1e3),t}function Td(r=0,e){const t=r/e,i=t<10;let o=0;return i?o=Math.round((t+Number.EPSILON)*10)/10:o=Math.round(t),o}function Ed(r,e,t,i){switch(e){case 1e9:return C(t==="short"?at`${r}B`:at`${r} billion`);case 1e6:return C(t==="short"?at`${r}M`:at`${r} million`);case 1e3:return C(t==="short"?at`${r}K`:at`${r} thousand`);default:return new Intl.NumberFormat(i).format(r)}}function ss(r,e="long",t="short",i="en-US"){const o=r??-1;if(o<0)return"";const s=kd(o,e),a=Td(o,s);return Ed(a,s,t,i)}let qe=class extends B{constructor(){super(...arguments),this.showTvClips=!1}render(){return c`
...
`+_e),Ft&&Ki([Ie,Q,ne],Ue=>{_e=mi(_e,Ue," ")}),R&&Hi?R.createHTML(_e):_e},e.setConfig=function(){let A=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};No(A),Po=!0},e.clearConfig=function(){Nt=null,Po=!1},e.isValidAttribute=function(A,f,x){Nt||No({});const M=ce(A),X=ce(f);return ks(M,X,x)},e.addHook=function(A,f){typeof f=="function"&&fi(q[A],f)},e.removeHook=function(A,f){if(f!==void 0){const x=Ld(q[A],f);return x===-1?void 0:Pd(q[A],x,1)[0]}return na(q[A])},e.removeHooks=function(A){q[A]=[]},e.removeAllHooks=function(){q=fa()},e}var ro=yn();let yo=class extends de{constructor(){super(...arguments),this.collectionLinks=[]}render(){return c`
    ...
    `}};ba=n([F("collection-browser-loading-tile")],ba);const Zd=O`<svg class="caret-up-svg" viewBox="0 0 8 4" xmlns="http://www.w3.org/2000/svg">
<path d="m6.7226499 3.51689722c.22976435.15317623.54019902.0910893.69337525-.13867505.13615665-.20423497.10222882-.47220946-.06836249-.63681849l-.07031256-.05655675-3.2773501-2.18490007-3.2773501 2.18490007c-.22976434.15317623-.29185128.4636109-.13867505.69337524.13615665.20423498.39656688.27598409.61412572.18182636l.07924953-.04315131 2.7226499-1.81402514z"
  fill=""></path>
</svg>`,Jd=O`<svg class="caret-down-svg" viewBox="0 0 8 4" xmlns="http://www.w3.org/2000/svg">
...
fill=""></path>
  ...
  `;n([h({type:String})],it.prototype,"selectedLetter",void 0);n([h({type:Object})],it.prototype,"letterCounts",void 0);n([h({type:String})],it.prototype,"ariaLandmarkLabel",void 0);n([z()],it.prototype,"tooltipShown",void 0);n([z()],it.prototype,"hoveredLetter",void 0);n([j("alpha-bar-tooltip")],it.prototype,"tooltip",void 0);it=n([F("alpha-bar")],it);const ec=c`
...
`;let G=class extends B{constructor(){super(...arguments),this.defaultSortDirection=null,this.defaultSortField=_.relevance,this.sortDirection=null,this.selectedSort=_.default,this.selectedTitleFilter=null,this.selectedCreatorFilter=null,this.showRelevance=!0,this.showDateFavorited=!1,this.enableSortOptionsSlot=!1,this.suppressDisplayModes=!1,this.lastSelectedViewSort=_.weeklyview,this.lastSelectedDateSort=this.defaultDateSortField,this.alphaSelectorVisible=null,this.dropdownBackdropVisible=!1,this.desktopSortContainerWidth=0,this.selectorBarContainerWidth=0,this.boundSortBarSelectorEscapeListener=e=>{e.key==="Escape"&&this.closeDropdowns()}}render(){return c`
    ...
    `}get sortDirectionIcon(){return this.canChangeSortDirection?c`
      <div class="sort-direction-icon">
        ${this.finalizedSortDirection==="asc"?ec:tc}
      </div>
    `:c`<div class="sort-direction-icon">${ic}</div>`}get desktopSortSelectorTemplate(){return c`
      <div
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function sr(r,e,t){return r?e():t?.()}class kt{constructor(e){var t,i,o,s,a,l,d;this.title=e?.title,this.subtitle=e?.subtitle,this.headline=e?.headline,this.message=e?.message,this.headerColor=(t=e?.headerColor)!==null&&t!==void 0?t:"#55A183",this.bodyColor=(i=e?.bodyColor)!==null&&i!==void 0?i:"#f5f5f7",this.showProcessingIndicator=(o=e?.showProcessingIndicator)!==null&&o!==void 0?o:!1,this.processingImageMode=(s=e?.processingImageMode)!==null&&s!==void 0?s:"complete",this.showCloseButton=(a=e?.showCloseButton)!==null&&a!==void 0?a:!0,this.showHeaderLogo=(l=e?.showHeaderLogo)!==null&&l!==void 0?l:!0,this.closeOnBackdropClick=(d=e?.closeOnBackdropClick)!==null&&d!==void 0?d:!0}}function*as(r=document.activeElement){r!=null&&(yield r,"shadowRoot"in r&&r.shadowRoot&&r.shadowRoot.mode!=="closed"&&(yield*as(r.shadowRoot.activeElement)))}function ac(){return[...as()].pop()}const ya=new WeakMap;function wn(r){let e=ya.get(r);return e||(e=window.getComputedStyle(r,null),ya.set(r,e)),e}function nc(r){if("checkVisibility"in r&&typeof r.checkVisibility=="function")return r.checkVisibility({checkOpacity:!1,checkVisibilityCSS:!0});const e=wn(r);return e.visibility!=="hidden"&&e.display!=="none"}function lc(r){const e=wn(r),{overflowY:t,overflowX:i}=e;return t==="scroll"||i==="scroll"?!0:t!=="auto"||i!=="auto"?!1:r.scrollHeight>r.clientHeight&&t==="auto"||r.scrollWidth>r.clientWidth&&i==="auto"}function dc(r){const e=r.tagName.toLowerCase(),t=Number(r.getAttribute("tabindex"));return r.hasAttribute("tabindex")&&(isNaN(t)||t<=-1)||r.hasAttribute("disabled")||r.closest("[inert]")||e==="input"&&r.getAttribute("type")==="radio"&&!r.hasAttribute("checked")||!nc(r)?!1:(e==="audio"||e==="video")&&r.hasAttribute("controls")||r.hasAttribute("tabindex")||r.hasAttribute("contenteditable")&&r.getAttribute("contenteditable")!=="false"||["button","input","select","textarea","a","audio","video","summary","iframe"].includes(e)?!0:lc(r)}function cc(r,e){var t;return((t=r.getRootNode({composed:!0}))===null||t===void 0?void 0:t.host)!==e}function wa(r){const e=new WeakMap,t=[];function i(o){if(o instanceof Element){if(o.hasAttribute("inert")||o.closest("[inert]")||e.has(o))return;e.set(o,!0),!t.includes(o)&&dc(o)&&t.push(o),o instanceof HTMLSlotElement&&cc(o,r)&&o.assignedElements({flatten:!0}).forEach(s=>{i(s)}),o.shadowRoot!==null&&o.shadowRoot.mode==="open"&&i(o.shadowRoot)}for(const s of Array.from(o.children))i(s)}return i(r),t.sort((o,s)=>{const a=Number(o.getAttribute("tabindex"))||0;return(Number(s.getAttribute("tabindex"))||0)-a})}let yi=[];class hc{constructor(e){this.isExternalActivated=!1,this.tabDirection="forward",this.currentFocus=null,this.previousFocus=null,this.handleFocusIn=()=>{this.isActive()&&this.checkFocus()},this.handleKeyDown=t=>{var i;if(t.key!=="Tab"||this.isExternalActivated||!this.isActive())return;const o=ac();if(this.previousFocus=o,this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus))return;t.shiftKey?this.tabDirection="backward":this.tabDirection="forward";const s=wa(this.element);let a=s.findIndex(d=>d===o);this.previousFocus=this.currentFocus;const l=this.tabDirection==="forward"?1:-1;for(;;){a+l>=s.length?a=0:a+l<0?a=s.length-1:a+=l,this.previousFocus=this.currentFocus;const d=s[a];if(this.tabDirection==="backward"&&this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus)||d&&this.possiblyHasTabbableChildren(d))return;t.preventDefault(),this.currentFocus=d,(i=this.currentFocus)===null||i===void 0||i.focus({preventScroll:!1});const p=[...as()];if(p.includes(this.currentFocus)||!p.includes(this.previousFocus))break}setTimeout(()=>this.checkFocus())},this.handleKeyUp=()=>{this.tabDirection="forward"},this.element=e,this.elementsWithTabbableControls=["iframe"]}activate(){yi.push(this.element),document.addEventListener("focusin",this.handleFocusIn),document.addEventListener("keydown",this.handleKeyDown),document.addEventListener("keyup",this.handleKeyUp)}deactivate(){yi=yi.filter(e=>e!==this.element),this.currentFocus=null,document.removeEventListener("focusin",this.handleFocusIn),document.removeEventListener("keydown",this.handleKeyDown),document.removeEventListener("keyup",this.handleKeyUp)}isActive(){return yi[yi.length-1]===this.element}activateExternal(){this.isExternalActivated=!0}deactivateExternal(){this.isExternalActivated=!1}checkFocus(){if(this.isActive()&&!this.isExternalActivated){const e=wa(this.element);if(!this.element.matches(":focus-within")){const t=e[0],i=e[e.length-1],o=this.tabDirection==="forward"?t:i;typeof o?.focus=="function"&&(this.currentFocus=o,o.focus({preventScroll:!1}))}}}possiblyHasTabbableChildren(e){return this.elementsWithTabbableControls.includes(e.tagName.toLowerCase())||e.hasAttribute("controls")}}var xa;(function(r){r.processing="processing",r.complete="complete"})(xa||(xa={}));let Ur=class extends B{constructor(){super(...arguments),this.mode="processing"}render(){return c`
      <div class="${this.mode}">
        <svg
          viewBox="0 0 120 120"
    ...
    `}};n([h({type:String})],Ur.prototype,"mode",void 0);Ur=n([F("ia-activity-indicator")],Ur);const pc=c`
<svg
  viewBox="0 0 40 40"
  version="1.1"
  xmlns="http://www.w3.org/2000/svg"
...
`;class uc extends B{static get styles(){return m`
      :host {
    ...
    `}render(){return pc}}customElements.define("ia-icon-close",uc);const fc=c`
  <svg
    class="ia-logo"
    viewBox="0 0 27 30"
    xmlns="http://www.w3.org/2000/svg"
...
`;let Hr=class extends B{constructor(){super(...arguments),this.config=new kt}render(){return c`
      <div class="modal-wrapper">
        <div class="modal-container">
          <header style="background-color: ${this.config.headerColor}">
            ...
            ${this.config.showHeaderLogo?c`<div class="logo-icon">${fc}</div>`:b}
    ...
    `}};n([h({type:Object})],Hr.prototype,"config",void 0);Hr=n([F("modal-template")],Hr);function mc(r,e,t){var i=t||{},o=i.noTrailing,s=o===void 0?!1:o,a=i.noLeading,l=a===void 0?!1:a,d=i.debounceMode,p=d===void 0?void 0:d,u,v=!1,g=0;function y(){u&&clearTimeout(u)}function w(T){var L=T||{},E=L.upcomingOnly,P=E===void 0?!1:E;y(),v=!P}function $(){for(var T=arguments.length,L=new Array(T),E=0;E<T;E++)L[E]=arguments[E];var P=this,R=Date.now()-g;if(v)return;function H(){g=Date.now(),e.apply(P,L)}function ie(){u=void 0}!l&&p&&!u&&H(),y(),p===void 0&&R>r?l?(g=Date.now(),s||(u=setTimeout(p?ie:H,r))):H():s!==!0&&(u=setTimeout(p?ie:H,p===void 0?r-R:r))}return $.cancel=w,$}var Tt;(function(r){r.Open="open",r.Closed="closed"})(Tt||(Tt={}));class vc{constructor(e){this.windowResizeThrottler=mc(100,this.updateModalContainerHeight,{noLeading:!1,noTrailing:!1}).bind(this),this.modalManager=e}handleModeChange(e){switch(e){case Tt.Open:this.startResizeListener(),this.stopDocumentScroll();break;case Tt.Closed:this.stopResizeListener(),this.resumeDocumentScroll();break}}updateModalContainerHeight(){this.modalManager.style.setProperty("--containerHeight",`${window.innerHeight}px`)}stopDocumentScroll(){document.body.classList.add("modal-manager-open")}resumeDocumentScroll(){document.body.classList.remove("modal-manager-open")}startResizeListener(){window.addEventListener("resize",this.windowResizeThrottler)}stopResizeListener(){window.removeEventListener("resize",this.windowResizeThrottler)}}let Jt=class extends B{constructor(){super(...arguments),this.mode=Tt.Closed,this.hostBridge=new vc(this),this.modal=new hc(this),this.closeOnBackdropClick=!0}firstUpdated(){return As(this,void 0,void 0,function*(){yield new Promise(e=>setTimeout(e,0)),this.closeOnBackdropClick&&this.addEventListener("keydown",e=>{e.key==="Escape"&&this.backdropClicked()})})}disconnectedCallback(){super.disconnectedCallback(),this.modal.deactivate()}render(){return c`
      <div class="container">
    ...
    `}};n([h({type:String,reflect:!0})],Jt.prototype,"mode",void 0);n([h({type:Object})],Jt.prototype,"customModalContent",void 0);n([h({type:Object})],Jt.prototype,"hostBridge",void 0);n([j("modal-template")],Jt.prototype,"modalTemplate",void 0);Jt=n([F("modal-manager")],Jt);const Sa=m`var(--white, #fff)`,gc=m`var(--primaryDisableCTAFill, #767676)`,bc=m`var(--secondaryCTABorder, #999)`,yc=m`var(--primaryCTAFill, #194880)`,ar=m`var(--primaryCTAFillRGB, 25, 72, 128)`,wc=m`var(--primaryCTABorder, #c5d1df)`,xc=m`var(--primaryErrorCTAFill, #d9534f)`,nr=m`var(--primaryErrorCTAFillRGB, 229, 28, 38)`,Sc=m`var(--primaryErrorCTABorder, #d43f3a)`,$c=m`var(--secondaryCTAFill, #333)`,lr=m`var(--secondaryCTAFillRGB, 51, 51, 51)`,_c=m`var(--primaryCTABorder, #979797)`,Cc=m`var(---primaryWarningFill, #ee8950)`,dr=m`var(--primaryWarningFillRGB, 238, 137, 80)`,kc=m`var(--primaryWarningBorder, #ec7939)`,Tc=m`
  .ia-button {
    min-height: 3rem;
    cursor: pointer;
    color: ${Sa};
 ...
 */const Ea=Oi(class extends Ni{constructor(r){if(super(r),r.type!==Ve.PROPERTY&&r.type!==Ve.ATTRIBUTE&&r.type!==Ve.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!on(r))throw Error("`live` bindings can only contain a single expression")}render(r){return r}update(r,[e]){if(e===Me||e===Z)return e;const t=r.element,i=r.name;if(r.type===Ve.PROPERTY){if(e===t[i])return Me}else if(r.type===Ve.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(i))return Me}else if(r.type===Ve.ATTRIBUTE&&t.getAttribute(i)===e+"")return Me;return rn(r),e}});ae.extend(n0);const l0=180,d0=40,c0=10,h0=125,p0=30,Ma="YYYY",u0="no data",f0=0,Da=4,m0=m`var(--histogramDateRangeSliderColor, #4B65FE)`,v0=m`var(--histogramDateRangeSelectedRangeColor, #DBE0FF)`,g0=m`var(--histogramDateRangeBarIncludedFill, #2C2C2C)`,b0=m`var(--histogramDateRangeActivityIndicator, #2C2C2C)`,y0=m`var(--histogramDateRangeBarExcludedFill, #CCCCCC)`,w0=m`var(--histogramDateRangeInputRowMargin, 0)`,x0=m`var(--histogramDateRangeInputBorder, 0.5px solid #2C2C2C)`,S0=m`var(--histogramDateRangeInputWidth, 35px)`,$0=m`var(--histogramDateRangeInputFontSize, 1.2rem)`,_0=m`var(--histogramDateRangeInputFontFamily, sans-serif)`,Aa=m`var(--histogramDateRangeTooltipBackgroundColor, #2C2C2C)`,za=m`var(--histogramDateRangeTooltipTextColor, #FFFFFF)`,C0=m`var(--histogramDateRangeTooltipFontSize, 1.1rem)`,k0=m`var(--histogramDateRangeTooltipFontFamily, sans-serif)`;let J=class extends B{constructor(){super(...arguments),this.width=l0,this.height=d0,this.sliderWidth=c0,this.tooltipWidth=h0,this.tooltipHeight=p0,this.updateDelay=f0,this.dateFormat=Ma,this.missingDataMessage=u0,this.minDate="",this.maxDate="",this.disabled=!1,this.bins=[],this.updateWhileFocused=!1,this._tooltipOffset=0,this._tooltipVisible=!1,this._isDragging=!1,this._isLoading=!1,this._minSelectedDate="",this._maxSelectedDate="",this._minDateMS=0,this._maxDateMS=0,this._dragOffset=0,this._histWidth=0,this._binWidth=0,this._histData=[],this._previousDateRange="",this.drag=e=>{e.preventDefault(),!this.disabled&&(this.setDragOffset(e),this._isDragging=!0,this.addListeners(),this.cancelPendingUpdateEvent())},this.drop=()=>{this._isDragging&&(this.removeListeners(),this.beginEmitUpdateProcess()),this._isDragging=!1},this.move=e=>{const t=this.getBoundingClientRect().x,i=e.clientX-t-this._dragOffset;this._currentSlider.id==="slider-min"?this.minSelectedDate=this.translatePositionToDate(this.validMinSliderX(i)):this.maxSelectedDate=this.translatePositionToDate(this.validMaxSliderX(i))}}disconnectedCallback(){this.removeListeners(),super.disconnectedCallback()}updated(e){(e.has("bins")||e.has("minDate")||e.has("maxDate")||e.has("minSelectedDate")||e.has("maxSelectedDate")||e.has("width")||e.has("height"))&&this.handleDataUpdate()}handleDataUpdate(){this.hasBinData&&(this._histWidth=this.width-this.sliderWidth*2,this._minDateMS=this.getMSFromString(this.minDate),this._maxDateMS=this.getMSFromString(this.maxDate),this._binWidth=this._histWidth/this._numBins,this._previousDateRange=this.currentDateRangeString,this._histData=this.calculateHistData(),this.minSelectedDate=this.minSelectedDate?this.minSelectedDate:this.minDate,this.maxSelectedDate=this.maxSelectedDate?this.maxSelectedDate:this.maxDate,this.requestUpdate())}calculateHistData(){const e=Math.min(...this.bins),t=Math.max(...this.bins),i=e===t?1:Math.log1p(t),o=this.height/i,s=this.dateRangeMS/this._numBins;return this.bins.map((a,l)=>({value:a,height:Math.floor(Math.log1p(a)*o),binStart:`${this.formatDate(l*s+this._minDateMS)}`,binEnd:`${this.formatDate((l+1)*s+this._minDateMS)}`}))}get hasBinData(){return this._numBins>0}get _numBins(){return!this.bins||!this.bins.length?0:this.bins.length}get histogramLeftEdgeX(){return this.sliderWidth}get histogramRightEdgeX(){return this.width-this.sliderWidth}get loading(){return this._isLoading}set loading(e){this.disabled=e,this._isLoading=e}get minSelectedDate(){return this.formatDate(this.getMSFromString(this._minSelectedDate))}set minSelectedDate(e){if(!this._minSelectedDate){this._minSelectedDate=e;return}const t=this.getMSFromString(e),i=!Number.isNaN(t),o=t<=this.getMSFromString(this.maxSelectedDate);i&&o&&(this._minSelectedDate=this.formatDate(t)),this.requestUpdate()}get maxSelectedDate(){return this.formatDate(this.getMSFromString(this._maxSelectedDate))}set maxSelectedDate(e){if(!this._maxSelectedDate){this._maxSelectedDate=e;return}const t=this.getMSFromString(e),i=!Number.isNaN(t),o=t>=this.getMSFromString(this.minSelectedDate);i&&o&&(this._maxSelectedDate=this.formatDate(t)),this.requestUpdate()}get minSliderX(){const e=this.translateDateToPosition(this.minSelectedDate);return this.validMinSliderX(e)}get maxSliderX(){const e=this.translateDateToPosition(this.maxSelectedDate);return this.validMaxSliderX(e)}get dateRangeMS(){return this._maxDateMS-this._minDateMS}showTooltip(e){if(this._isDragging||this.disabled)return;const t=e.currentTarget,i=t.x.baseVal.value+this.sliderWidth/2,o=t.dataset,s=`item${o.numItems!=="1"?"s":""}`,a=Number(o.numItems).toLocaleString();this._tooltipOffset=i+(this._binWidth-this.sliderWidth-this.tooltipWidth)/2,this._tooltipContent=c`
    ...
    `}get selectedRangeTemplate(){return O`
      ...
      />`}get histogramTemplate(){const e=this._histWidth/this._numBins,t=e-1;let i=this.sliderWidth;return this._histData.map(o=>{const s=O`
        <rect
          ...
          fill="${i+t>=this.minSliderX&&i<=this.maxSliderX?g0:y0}"
    ...
    ia-activity-indicator {
      ...
      --activityIndicatorLoadingRingColor: ${b0};
    }
...
`;let re=class extends B{constructor(){super(...arguments),this.prompt="Do you find this feature useful?",this.buttonText="Beta",this.isOpen=!1,this.processing=!1,this.popupTopX=0,this.popupTopY=0,this.voteSubmitted=!1,this.voteNeedsChoosing=!1,this.resizingElement=document.body}render(){return c`
    ...
    `}};n([h({type:String})],re.prototype,"featureIdentifier",void 0);n([h({type:String})],re.prototype,"prompt",void 0);n([h({type:String})],re.prototype,"buttonText",void 0);n([h({type:Object})],re.prototype,"recaptchaManager",void 0);n([h({type:Object})],re.prototype,"resizeObserver",void 0);n([h({type:Boolean})],re.prototype,"disabled",void 0);n([h({type:Object})],re.prototype,"featureFeedbackService",void 0);n([j("#beta-button")],re.prototype,"betaButton",void 0);n([j("#popup")],re.prototype,"popup",void 0);n([z()],re.prototype,"isOpen",void 0);n([z()],re.prototype,"processing",void 0);n([z()],re.prototype,"popupTopX",void 0);n([z()],re.prototype,"popupTopY",void 0);n([z()],re.prototype,"vote",void 0);n([z()],re.prototype,"voteSubmitted",void 0);n([z()],re.prototype,"error",void 0);n([z()],re.prototype,"voteNeedsChoosing",void 0);n([z()],re.prototype,"recaptchaWidget",void 0);n([j("#comments")],re.prototype,"comments",void 0);re=n([F("feature-feedback")],re);const T0=c`
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path
...
`;let ti=class extends B{constructor(){super(...arguments),this.step=2,this.currentPage=1,this.pages=[]}firstUpdated(){this.observePageCount()}updated(e){e.has("size")&&this.observePageCount(),e.has("currentPage")&&(this.observePageCount(),this.emitPageClick())}observePageCount(){this.pages=[];const e=7,t=this.size<=e;if(this.size<=5){this.pages=[...Array(this.size).keys()].map(s=>s+1);return}if(this.size===e){if(this.currentPage===2){this.pages=[1,2,3,4,0,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,4,5,this.size-1,this.size];return}}if(this.currentPage===1){this.pages=[1,2,3,0,this.size];return}if(this.currentPage===this.size){this.pages=[1,0,this.size-2,this.size-1,this.size];return}if(this.currentPage===this.size-1){this.pages=[1,0,this.size-3,this.size-2,this.size-1,this.size];return}if(t&&this.currentPage>1&&this.currentPage<e){this.pages=[...Array(this.size).keys()].map(s=>s+1);return}let i=this.currentPage-this.step,o=this.currentPage+this.step;i<=0&&(o+=-i+1,i=1),o>=this.size&&(i=Math.max(i-(o-this.size),1),o=this.size),i===2&&(o-=1),o===this.size-1&&(i+=1),this.createFirstNode(i),this.createMiddelNode(i,o),this.createLastNode(o)}createFirstNode(e){var t,i;e>1&&((t=this.pages)===null||t===void 0||t.push(1)),e>2&&((i=this.pages)===null||i===void 0||i.push(0))}createMiddelNode(e,t){var i;for(let o=e;o<=t;o+=1)(i=this.pages)===null||i===void 0||i.push(o)}createLastNode(e){var t,i;e<this.size-1&&((t=this.pages)===null||t===void 0||t.push(0)),e<this.size&&((i=this.pages)===null||i===void 0||i.push(this.size))}get getEllipsisTemplate(){return c`<i class="ellipses">...</i>`}emitPageClick(){this.dispatchEvent(new CustomEvent("pageNumberClicked",{detail:{page:this.currentPage},bubbles:!0,composed:!0}))}onRewind(){this.currentPage-=1,this.currentPage<1&&(this.currentPage=1)}onForward(){this.currentPage+=1,this.currentPage>this.size&&(this.currentPage=this.size)}onChange(e){this.currentPage=e}getPageTemplate(e){return c`
    ...
    `}static get styles(){return[ot,m`
      ...
      `]}};n([h({type:Number})],ti.prototype,"size",void 0);n([h({type:Number})],ti.prototype,"step",void 0);n([h({type:Number})],ti.prototype,"currentPage",void 0);n([z()],ti.prototype,"pages",void 0);ti=n([F("more-facets-pagination")],ti);const D0=O`
...
`;var Wr;let Ri=Wr=class extends B{render(){return c`${this.facetRowTemplate}`}get facetRowTemplate(){var e,t,i,o;const{bucket:s,facetType:a}=this;if(!s||!a)return b;const l=`${a}:${s.key}-show-only`,d=`${a}:${s.key}-negative`,p=a!=="collection"?c`${(e=s.displayText)!==null&&e!==void 0?e:s.key}`:c`<a href="/details/${s.key}">
      ...
      <div class="facet-row-container">
        <div class="facet-checkboxes">
          ...
          <label
            ...
            data-testid=${d}
          >
            <span class="eye">${D0}</span>
            <span class="eye-closed">${A0}</span>
          </label>
        </div>
        <label
          for=${l}
    ...
    `}partOfCollectionClicked(e){var t;(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:je.default,action:ee.partOfCollectionClicked,label:e.target.dataset.id})}showDatePickerModal(){var e,t,i;const{fullYearsHistogramAggregation:o}=this,s=o?.first_bucket_key,a=o?.last_bucket_key,l=o?.buckets,p=c`
      <expanded-date-picker
        ${zc(v=>{if(v&&v instanceof Ke){const g=v;g.minSelectedDate=this.minSelectedDate,g.maxSelectedDate=this.maxSelectedDate}})}
        .minDate=${s}
        .maxDate=${a}
    ...
    `}};Ba=n([F("circular-activity-indicator")],Ba);function P0(r,e){return r===void 0?e!==void 0:e===void 0?r!==void 0:r.facetType===e.facetType&&r.bucketKey===e.bucketKey}function Gr(r,e){return r.label===e.label&&r.facets.length===e.facets.length&&r.facets.every((t,i)=>P0(t,e.facets[i]))}function Dn(r){if(!Array.isArray(r[0])){let o=[...r];for(let s=0;s<o.length;s++){const a=o[s];o=o.filter(l=>a===l||!Gr(a,l))}return o}const e=r,t=[];for(const i of e){const o=[];for(const s of i)t.find(l=>l.find(d=>Gr(s,d)))||o.push(s);o.length>0&&t.push(o)}return t}class ds{async getRecommendedFacets(){const e=navigator.language,t=ds.getLanguageDisplayName(e);return t?[{facets:[{facetType:"language",bucketKey:t}]}]:[]}static getLanguageDisplayName(e){const t=e.split("-")[0];return new Intl.DisplayNames(["en"],{type:"language"}).of(t)}}const yt={facets:[{facetType:"mediatype",bucketKey:"texts"}]},wt={facets:[{facetType:"mediatype",bucketKey:"audio"}]},Ut={facets:[{facetType:"mediatype",bucketKey:"movies"}]},rt={facets:[{facetType:"mediatype",bucketKey:"image"}]},Si={facets:[{facetType:"mediatype",bucketKey:"software"}]},ur={facets:[{facetType:"mediatype",bucketKey:"etree"}]},F0={facets:[{facetType:"mediatype",bucketKey:"web"}]},R0={facets:[{facetType:"mediatype",bucketKey:"data"}]},B0={text:[yt],book:[yt],novel:[yt],magazine:[yt],newspaper:[yt],pdf:[yt],epub:[yt],audio:[wt],song:[wt],music:[wt],listen:[wt],podcast:[wt],radio:[wt],stream:[wt,Ut],video:[Ut],movie:[Ut],film:[Ut],animation:[Ut],youtube:[Ut],image:[rt],photo:[rt],picture:[rt],painting:[rt],jpg:[rt],jpeg:[rt],png:[rt],gif:[rt],software:[Si],app:[Si],program:[Si],game:[Si],arcade:[Si],etree:[ur],concert:[ur],"live music":[ur],"web crawl":[F0],dataset:[R0]};class I0{async getRecommendedFacets(e){const t=[];for(const[i,o]of Object.entries(B0))e.includes(i)&&t.push(...o);return t}}const Zi=[{facets:[{facetType:"mediatype",bucketKey:"texts"}]}],Ia=[{label:"Films by __QUERY",facets:[{facetType:"mediatype",bucketKey:"movies"},{facetType:"creator",bucketKey:"__QUERY"}]}],$i=[{label:"Writing by __QUERY",facets:[{facetType:"mediatype",bucketKey:"texts"},{facetType:"creator",bucketKey:"__QUERY"}]}],Ji=[{label:"Images by __QUERY",facets:[{facetType:"mediatype",bucketKey:"image"},{facetType:"creator",bucketKey:"__QUERY"}]}],_i=[{label:"Music by __QUERY",facets:[{facetType:"mediatype",bucketKey:"audio"},{facetType:"creator",bucketKey:"__QUERY"}]}],O0={"written work":Zi,literature:Zi,book:Zi,novel:Zi,filmmaker:Ia,director:Ia,author:$i,writer:$i,novelist:$i,essayist:$i,poet:$i,"visual artist":Ji,"graphic artist":Ji,photographer:Ji,painter:Ji,singer:_i,songwriter:_i,musician:_i,composer:_i,pianist:_i};class N0{constructor(){this.WIKIDATA_BASE_URL="https://www.wikidata.org/w/api.php",this.WIKIDATA_DEFAULT_ARGS="?action=wbsearchentities&format=json&language=en&uselang=en&origin=*&type=item&limit=5"}getWikidataURL(e){const t=encodeURIComponent(e);return`${this.WIKIDATA_BASE_URL}${this.WIKIDATA_DEFAULT_ARGS}&search=${t}`}replaceQueryPlaceholders(e,t){return e.map(i=>{var o;return{label:(o=i.label)===null||o===void 0?void 0:o.replace("__QUERY",t),facets:i.facets.map(s=>{var a;const l={...s,bucketKey:s.bucketKey.replace("__QUERY",t.toLowerCase())};return s.displayText&&(l.displayText=(a=l.displayText)===null||a===void 0?void 0:a.replace("__QUERY",t)),l})}})}async getRecommendedFacets(e){var t;const i=[];try{const o=this.getWikidataURL(e),a=await(await fetch(o)).json();for(const[l,d]of Object.entries(O0))if(new RegExp(`\\b${l}\\b`).test((t=a.search[0])===null||t===void 0?void 0:t.description)){const u=a.search[0].label;i.push(...this.replaceQueryPlaceholders(d,u))}return i}catch(o){return console.warn(o),[]}}}class Do{async getRecommendedFacets(e,t=Do.DEFAULT_HEURISTICS){const i=t.map(o=>new o().getRecommendedFacets(e));return Dn((await Promise.all(i)).flat())}}Do.DEFAULT_HEURISTICS=[I0,N0,ds];const U0=c`
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path
...
`;function V0(r){return r&&r.charAt(0).toLocaleUpperCase()+r.slice(1)}let Bi=class extends B{constructor(){super(...arguments),this.selected=!1}render(){var e,t;if(!this.facetInfo)return b;const i=this.facetInfo.facets.length===1,o=this.facetInfo.facets[0],s=V0((this.labelPrefix?`${this.labelPrefix} `:"")+((t=(e=this.facetInfo.label)!==null&&e!==void 0?e:o.displayText)!==null&&t!==void 0?t:o.bucketKey));if(!s)return b;const a=i&&o.facetType==="mediatype"?fn[o.bucketKey].icon:b;return c`
      <a
      ...
      >
        ${a} ${s}
        ${this.selected?c`<span class="unselect-button">${H0}</span>`:b}
      </a>
    ...
    `}};n([h({type:Array})],ii.prototype,"facetInfo",void 0);n([h({type:String})],ii.prototype,"labelPrefix",void 0);n([h({type:Object})],ii.prototype,"activeFacetRef",void 0);n([j("ia-dropdown")],ii.prototype,"dropdown",void 0);ii=n([F("smart-facet-dropdown")],ii);const Oa={collection:"Collection: ",creator:"By: ",subject:"About: "};function W0(r){return r.charAt(0).toUpperCase()+r.slice(1)}let Xe=class extends B{constructor(){super(...arguments),this.filterToggleActive=!1,this.heuristicRecs=[],this.smartFacets=[]}render(){return this.query?c`
