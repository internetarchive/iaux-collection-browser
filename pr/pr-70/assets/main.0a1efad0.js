 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ae={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},dr=a=>(...e)=>({_$litDirective$:a,values:e});class cr{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}/**
 * @license
 ...
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Jr=dr(class extends cr{constructor(a){var e;if(super(a),a.type!==Ae.ATTRIBUTE||a.name!=="class"||((e=a.strings)===null||e===void 0?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(a){return" "+Object.keys(a).filter(e=>a[e]).join(" ")+" "}update(a,[e]){var t,i;if(this.et===void 0){this.et=new Set,a.strings!==void 0&&(this.st=new Set(a.strings.join(" ").split(/\s/).filter(o=>o!=="")));for(const o in e)e[o]&&!(!((t=this.st)===null||t===void 0)&&t.has(o))&&this.et.add(o);return this.render(e)}const r=a.element.classList;this.et.forEach(o=>{o in e||(r.remove(o),this.et.delete(o))});for(const o in e){const s=!!e[o];s===this.et.has(o)||((i=this.st)===null||i===void 0?void 0:i.has(o))||(s?(r.add(o),this.et.add(o)):(r.remove(o),this.et.delete(o)))}return ce}}),ys=b`
  .drop-shadow {
...
`;let si=class extends B{render(){var e,t,i,r,o,s,l;const d=(e=this.model)===null||e===void 0?void 0:e.title,h=(t=this.model)===null||t===void 0?void 0:t.creator;return m`
      <div id="container">
    ...
    `}static get styles(){return[Ss]}};n([p({type:Object})],si.prototype,"model",void 0);n([p({type:String})],si.prototype,"baseImageUrl",void 0);si=n([G("item-tile")],si);const $s=L`
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path
      d="m89.6854559 79.6500588c1.7300364 6.4823648 2.180423 13.3122689 3.3145441 20.3499412h-86c.5683151-15.8558542 2.98334063-30.7849367 15.1676149-41.6581341 22.9948067-20.518674 59.250299-9.0032844 67.517841 21.3081929zm-40.0998307-79.6500588c10.872402.0493248 19.9700408 9.25722341 19.917959 20.1421788-.0829413 11.042868-8.9616237 19.8492523-20.0602807 19.8578212-11.1181198 0-19.9397193-8.7904706-19.9397193-19.8908727-.0327543-11.11998815 9.0125781-20.17487063 20.082041-20.1091273z"
      fill="#333"
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ca=dr(class extends cr{constructor(a){if(super(a),a.type!==Ae.PROPERTY&&a.type!==Ae.ATTRIBUTE&&a.type!==Ae.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Yo(a))throw Error("`live` bindings can only contain a single expression")}render(a){return a}update(a,[e]){if(e===ce||e===_)return e;const t=a.element,i=a.name;if(a.type===Ae.PROPERTY){if(e===t[i])return ce}else if(a.type===Ae.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(i))return ce}else if(a.type===Ae.ATTRIBUTE&&t.getAttribute(i)===e+"")return ce;return Na(a),e}});var Qa=60,Ga=Qa*60,Ya=Ga*24,tn=Ya*7,mt=1e3,Hi=Qa*mt,ha=Ga*mt,rn=Ya*mt,an=tn*mt,hr="millisecond",nt="second",lt="minute",dt="hour",Ee="day",ii="week",ue="month",Ka="quarter",Oe="year",ct="date",on="YYYY-MM-DDTHH:mm:ssZ",ua="Invalid Date",sn=/^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/,nn=/\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g,ln={name:"en",weekdays:"Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),months:"January_February_March_April_May_June_July_August_September_October_November_December".split("_")},rr=function(e,t,i){var r=String(e);return!r||r.length>=t?e:""+Array(t+1-r.length).join(i)+e},dn=function(e){var t=-e.utcOffset(),i=Math.abs(t),r=Math.floor(i/60),o=i%60;return(t<=0?"+":"-")+rr(r,2,"0")+":"+rr(o,2,"0")},cn=function a(e,t){if(e.date()<t.date())return-a(t,e);var i=(t.year()-e.year())*12+(t.month()-e.month()),r=e.clone().add(i,ue),o=t-r<0,s=e.clone().add(i+(o?-1:1),ue);return+(-(i+(t-r)/(o?r-s:s-r))||0)},hn=function(e){return e<0?Math.ceil(e)||0:Math.floor(e)},un=function(e){var t={M:ue,y:Oe,w:ii,d:Ee,D:ct,h:dt,m:lt,s:nt,ms:hr,Q:Ka};return t[e]||String(e||"").toLowerCase().replace(/s$/,"")},pn=function(e){return e===void 0},vn={s:rr,z:dn,m:cn,a:hn,p:un,u:pn},It="en",Ge={};Ge[It]=ln;var ur=function(e){return e instanceof vi},ci=function a(e,t,i){var r;if(!e)return It;if(typeof e=="string"){var o=e.toLowerCase();Ge[o]&&(r=o),t&&(Ge[o]=t,r=o);var s=e.split("-");if(!r&&s.length>1)return a(s[0])}else{var l=e.name;Ge[l]=e,r=l}return!i&&r&&(It=r),r||!i&&It},Q=function(e,t){if(ur(e))return e.clone();var i=typeof t=="object"?t:{};return i.date=e,i.args=arguments,new vi(i)},mn=function(e,t){return Q(e,{locale:t.$L,utc:t.$u,x:t.$x,$offset:t.$offset})},z=vn;z.l=ci;z.i=ur;z.w=mn;var gn=function(e){var t=e.date,i=e.utc;if(t===null)return new Date(NaN);if(z.u(t))return new Date;if(t instanceof Date)return new Date(t);if(typeof t=="string"&&!/Z$/i.test(t)){var r=t.match(sn);if(r){var o=r[2]-1||0,s=(r[7]||"0").substring(0,3);return i?new Date(Date.UTC(r[1],o,r[3]||1,r[4]||0,r[5]||0,r[6]||0,s)):new Date(r[1],o,r[3]||1,r[4]||0,r[5]||0,r[6]||0,s)}}return new Date(t)},vi=function(){function a(t){this.$L=ci(t.locale,null,!0),this.parse(t)}var e=a.prototype;return e.parse=function(i){this.$d=gn(i),this.$x=i.x||{},this.init()},e.init=function(){var i=this.$d;this.$y=i.getFullYear(),this.$M=i.getMonth(),this.$D=i.getDate(),this.$W=i.getDay(),this.$H=i.getHours(),this.$m=i.getMinutes(),this.$s=i.getSeconds(),this.$ms=i.getMilliseconds()},e.$utils=function(){return z},e.isValid=function(){return this.$d.toString()!==ua},e.isSame=function(i,r){var o=Q(i);return this.startOf(r)<=o&&o<=this.endOf(r)},e.isAfter=function(i,r){return Q(i)<this.startOf(r)},e.isBefore=function(i,r){return this.endOf(r)<Q(i)},e.$g=function(i,r,o){return z.u(i)?this[r]:this.set(o,i)},e.unix=function(){return Math.floor(this.valueOf()/1e3)},e.valueOf=function(){return this.$d.getTime()},e.startOf=function(i,r){var o=this,s=z.u(r)?!0:r,l=z.p(i),d=function(A,R){var F=z.w(o.$u?Date.UTC(o.$y,R,A):new Date(o.$y,R,A),o);return s?F:F.endOf(Ee)},h=function(A,R){var F=[0,0,0,0],N=[23,59,59,999];return z.w(o.toDate()[A].apply(o.toDate("s"),(s?F:N).slice(R)),o)},u=this.$W,v=this.$M,f=this.$D,y="set"+(this.$u?"UTC":"");switch(l){case Oe:return s?d(1,0):d(31,11);case ue:return s?d(1,v):d(0,v+1);case ii:{var $=this.$locale().weekStart||0,k=(u<$?u+7:u)-$;return d(s?f-k:f+(6-k),v)}case Ee:case ct:return h(y+"Hours",0);case dt:return h(y+"Minutes",1);case lt:return h(y+"Seconds",2);case nt:return h(y+"Milliseconds",3);default:return this.clone()}},e.endOf=function(i){return this.startOf(i,!1)},e.$set=function(i,r){var o,s=z.p(i),l="set"+(this.$u?"UTC":""),d=(o={},o[Ee]=l+"Date",o[ct]=l+"Date",o[ue]=l+"Month",o[Oe]=l+"FullYear",o[dt]=l+"Hours",o[lt]=l+"Minutes",o[nt]=l+"Seconds",o[hr]=l+"Milliseconds",o)[s],h=s===Ee?this.$D+(r-this.$W):r;if(s===ue||s===Oe){var u=this.clone().set(ct,1);u.$d[d](h),u.init(),this.$d=u.set(ct,Math.min(this.$D,u.daysInMonth())).$d}else d&&this.$d[d](h);return this.init(),this},e.set=function(i,r){return this.clone().$set(i,r)},e.get=function(i){return this[z.p(i)]()},e.add=function(i,r){var o=this,s;i=Number(i);var l=z.p(r),d=function(f){var y=Q(o);return z.w(y.date(y.date()+Math.round(f*i)),o)};if(l===ue)return this.set(ue,this.$M+i);if(l===Oe)return this.set(Oe,this.$y+i);if(l===Ee)return d(1);if(l===ii)return d(7);var h=(s={},s[lt]=Hi,s[dt]=ha,s[nt]=mt,s)[l]||1,u=this.$d.getTime()+i*h;return z.w(u,this)},e.subtract=function(i,r){return this.add(i*-1,r)},e.format=function(i){var r=this,o=this.$locale();if(!this.isValid())return o.invalidDate||ua;var s=i||on,l=z.z(this),d=this.$H,h=this.$m,u=this.$M,v=o.weekdays,f=o.months,y=o.meridiem,$=function(F,N,Y,oe){return F&&(F[N]||F(r,s))||Y[N].slice(0,oe)},k=function(F){return z.s(d%12||12,F,"0")},E=y||function(R,F,N){var Y=R<12?"AM":"PM";return N?Y.toLowerCase():Y},A={YY:String(this.$y).slice(-2),YYYY:this.$y,M:u+1,MM:z.s(u+1,2,"0"),MMM:$(o.monthsShort,u,f,3),MMMM:$(f,u),D:this.$D,DD:z.s(this.$D,2,"0"),d:String(this.$W),dd:$(o.weekdaysMin,this.$W,v,2),ddd:$(o.weekdaysShort,this.$W,v,3),dddd:v[this.$W],H:String(d),HH:z.s(d,2,"0"),h:k(1),hh:k(2),a:E(d,h,!0),A:E(d,h,!1),m:String(h),mm:z.s(h,2,"0"),s:String(this.$s),ss:z.s(this.$s,2,"0"),SSS:z.s(this.$ms,3,"0"),Z:l};return s.replace(nn,function(R,F){return F||A[R]||l.replace(":","")})},e.utcOffset=function(){return-Math.round(this.$d.getTimezoneOffset()/15)*15},e.diff=function(i,r,o){var s,l=z.p(r),d=Q(i),h=(d.utcOffset()-this.utcOffset())*Hi,u=this-d,v=z.m(this,d);return v=(s={},s[Oe]=v/12,s[ue]=v,s[Ka]=v/3,s[ii]=(u-h)/an,s[Ee]=(u-h)/rn,s[dt]=u/ha,s[lt]=u/Hi,s[nt]=u/mt,s)[l]||u,o?v:z.a(v)},e.daysInMonth=function(){return this.endOf(ue).$D},e.$locale=function(){return Ge[this.$L]},e.locale=function(i,r){if(!i)return this.$L;var o=this.clone(),s=ci(i,r,!0);return s&&(o.$L=s),o},e.clone=function(){return z.w(this.$d,this)},e.toDate=function(){return new Date(this.valueOf())},e.toJSON=function(){return this.isValid()?this.toISOString():null},e.toISOString=function(){return this.$d.toISOString()},e.toString=function(){return this.$d.toUTCString()},a}(),qa=vi.prototype;Q.prototype=qa;[["$ms",hr],["$s",nt],["$m",lt],["$H",dt],["$W",Ee],["$M",ue],["$y",Oe],["$D",ct]].forEach(function(a){qa[a[1]]=function(e){return this.$g(e,a[0],a[1])}});Q.extend=function(a,e){return a.$i||(a(e,vi,Q),a.$i=!0),Q};Q.locale=ci;Q.isDayjs=ur;Q.unix=function(a){return Q(a*1e3)};Q.en=Ge[It];Q.Ls=Ge;Q.p={};var fn=function(e){return e.replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g,function(t,i,r){return i||r.slice(1)})},bn={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"},yn=function(e,t){return e.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g,function(i,r,o){var s=o&&o.toUpperCase();return r||t[o]||bn[o]||fn(t[s])})},wn=/(\[[^[]*\])|([-:/.()\s]+)|(A|a|YYYY|YY?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g,Sn=/\d/,Zt=/\d\d/,$n=/\d{3}/,xn=/\d{4}/,be=/\d\d?/,Cn=/[+-]?\d+/,_n=/[+-]\d\d:?(\d\d)?|Z/,Lt=/\d*[^\s\d-_:/()]+/,Fe={},Xa=function(e){return e=+e,e+(e>68?1900:2e3)};function kn(a){if(!a||a==="Z")return 0;var e=a.match(/([+-]|\d\d)/g),t=+(e[1]*60)+(+e[2]||0);return t===0?0:e[0]==="+"?-t:t}var re=function(e){return function(t){this[e]=+t}},pa=[_n,function(a){var e=this.zone||(this.zone={});e.offset=kn(a)}],Vi=function(e){var t=Fe[e];return t&&(t.indexOf?t:t.s.concat(t.f))},va=function(e,t){var i,r=Fe,o=r.meridiem;if(!o)i=e===(t?"pm":"PM");else for(var s=1;s<=24;s+=1)if(e.indexOf(o(s,0,t))>-1){i=s>12;break}return i},Tn={A:[Lt,function(a){this.afternoon=va(a,!1)}],a:[Lt,function(a){this.afternoon=va(a,!0)}],S:[Sn,function(a){this.milliseconds=+a*100}],SS:[Zt,function(a){this.milliseconds=+a*10}],SSS:[$n,function(a){this.milliseconds=+a}],s:[be,re("seconds")],ss:[be,re("seconds")],m:[be,re("minutes")],mm:[be,re("minutes")],H:[be,re("hours")],h:[be,re("hours")],HH:[be,re("hours")],hh:[be,re("hours")],D:[be,re("day")],DD:[Zt,re("day")],Do:[Lt,function(a){var e=Fe,t=e.ordinal,i=a.match(/\d+/);if(this.day=i[0],!!t)for(var r=1;r<=31;r+=1)t(r).replace(/\[|\]/g,"")===a&&(this.day=r)}],M:[be,re("month")],MM:[Zt,re("month")],MMM:[Lt,function(a){var e=Vi("months"),t=Vi("monthsShort"),i=(t||e.map(function(r){return r.slice(0,3)})).indexOf(a)+1;if(i<1)throw new Error;this.month=i%12||i}],MMMM:[Lt,function(a){var e=Vi("months"),t=e.indexOf(a)+1;if(t<1)throw new Error;this.month=t%12||t}],Y:[Cn,re("year")],YY:[Zt,function(a){this.year=Xa(a)}],YYYY:[xn,re("year")],Z:pa,ZZ:pa};function Dn(a){var e=a.afternoon;if(e!==void 0){var t=a.hours;e?t<12&&(a.hours+=12):t===12&&(a.hours=0),delete a.afternoon}}function Mn(a){a=yn(a,Fe&&Fe.formats);for(var e=a.match(wn),t=e.length,i=0;i<t;i+=1){var r=e[i],o=Tn[r],s=o&&o[0],l=o&&o[1];l?e[i]={regex:s,parser:l}:e[i]=r.replace(/^\[|\]$/g,"")}return function(d){for(var h={},u=0,v=0;u<t;u+=1){var f=e[u];if(typeof f=="string")v+=f.length;else{var y=f.regex,$=f.parser,k=d.slice(v),E=y.exec(k),A=E[0];$.call(h,A),d=d.replace(A,"")}}return Dn(h),h}}var An=function(e,t,i){try{if(["x","X"].indexOf(t)>-1)return new Date((t==="X"?1e3:1)*e);var r=Mn(t),o=r(e),s=o.year,l=o.month,d=o.day,h=o.hours,u=o.minutes,v=o.seconds,f=o.milliseconds,y=o.zone,$=new Date,k=d||(!s&&!l?$.getDate():1),E=s||$.getFullYear(),A=0;s&&!l||(A=l>0?l-1:$.getMonth());var R=h||0,F=u||0,N=v||0,Y=f||0;return y?new Date(Date.UTC(E,A,k,R,F,N,Y+y.offset*60*1e3)):i?new Date(Date.UTC(E,A,k,R,F,N,Y)):new Date(E,A,k,R,F,N,Y)}catch{return new Date("")}},En=function(a,e,t){t.p.customParseFormat=!0,a&&a.parseTwoDigitYear&&(Xa=a.parseTwoDigitYear);var i=e.prototype,r=i.parse;i.parse=function(o){var s=o.date,l=o.utc,d=o.args;this.$u=l;var h=d[1];if(typeof h=="string"){var u=d[2]===!0,v=d[3]===!0,f=u||v,y=d[2];v&&(y=d[2]),Fe=this.$locale(),!u&&y&&(Fe=t.Ls[y]),this.$d=An(s,h,l),this.init(),y&&y!==!0&&(this.$L=this.locale(y).$L),f&&s!=this.format(h)&&(this.$d=new Date("")),Fe={}}else if(h instanceof Array)for(var $=h.length,k=1;k<=$;k+=1){d[1]=h[k-1];var E=t.apply(this,d);if(E.isValid()){this.$d=E.$d,this.$L=E.$L,this.init();break}k===$&&(this.$d=new Date(""))}else r.call(this,o)}};const On=Object.freeze({processing:"processing",complete:"complete"});class Ln extends B{static get properties(){return{mode:{type:String}}}constructor(){super(),this.mode=On.processing}render(){return m`
      <div class="${this.mode}">
        <svg
          viewBox="0 0 120 120"
