 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Oi;const pt=globalThis.trustedTypes,Vr=pt?pt.createPolicy("lit-html",{createHTML:a=>a}):void 0,xe=`lit$${(Math.random()+"").slice(9)}$`,dr="?"+xe,Po=`<${dr}>`,vt=document,Pt=(a="")=>vt.createComment(a),Bt=a=>a===null||typeof a!="object"&&typeof a!="function",Ta=Array.isArray,Da=a=>{var e;return Ta(a)||typeof((e=a)===null||e===void 0?void 0:e[Symbol.iterator])=="function"},At=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Wr=/-->/g,jr=/>/g,Ue=/>|[ 	\n\r](?:([^\s"'>=/]+)([ 	\n\r]*=[ 	\n\r]*(?:[^ 	\n\r"'`<>=]|("|')|))|$)/g,Qr=/'/g,Gr=/"/g,Ma=/^(?:script|style|textarea|title)$/i,Aa=a=>(e,...t)=>({_$litType$:a,strings:e,values:t}),m=Aa(1),F=Aa(2),ce=Symbol.for("lit-noChange"),_=Symbol.for("lit-nothing"),Yr=new WeakMap,ei=(a,e,t)=>{var i,r;const o=(i=t==null?void 0:t.renderBefore)!==null&&i!==void 0?i:e;let s=o._$litPart$;if(s===void 0){const l=(r=t==null?void 0:t.renderBefore)!==null&&r!==void 0?r:null;o._$litPart$=s=new yt(e.insertBefore(Pt(),l),l,void 0,t!=null?t:{})}return s._$AI(a),s},ut=vt.createTreeWalker(vt,129,null,!1),Ea=(a,e)=>{const t=a.length-1,i=[];let r,o=e===2?"<svg>":"",s=At;for(let d=0;d<t;d++){const h=a[d];let p,v,f=-1,y=0;for(;y<h.length&&(s.lastIndex=y,v=s.exec(h),v!==null);)y=s.lastIndex,s===At?v[1]==="!--"?s=Wr:v[1]!==void 0?s=jr:v[2]!==void 0?(Ma.test(v[2])&&(r=RegExp("</"+v[2],"g")),s=Ue):v[3]!==void 0&&(s=Ue):s===Ue?v[0]===">"?(s=r!=null?r:At,f=-1):v[1]===void 0?f=-2:(f=s.lastIndex-v[2].length,p=v[1],s=v[3]===void 0?Ue:v[3]==='"'?Gr:Qr):s===Gr||s===Qr?s=Ue:s===Wr||s===jr?s=At:(s=Ue,r=void 0);const $=s===Ue&&a[d+1].startsWith("/>")?" ":"";o+=s===At?h+Po:f>=0?(i.push(p),h.slice(0,f)+"$lit$"+h.slice(f)+xe+$):h+xe+(f===-2?(i.push(void 0),d):$)}const l=o+(a[t]||"<?>")+(e===2?"</svg>":"");if(!Array.isArray(a)||!a.hasOwnProperty("raw"))throw Error("invalid template strings array");return[Vr!==void 0?Vr.createHTML(l):l,i]};class Ut{constructor({strings:e,_$litType$:t},i){let r;this.parts=[];let o=0,s=0;const l=e.length-1,d=this.parts,[h,p]=Ea(e,t);if(this.el=Ut.createElement(h,i),ut.currentNode=this.el.content,t===2){const v=this.el.content,f=v.firstChild;f.remove(),v.append(...f.childNodes)}for(;(r=ut.nextNode())!==null&&d.length<l;){if(r.nodeType===1){if(r.hasAttributes()){const v=[];for(const f of r.getAttributeNames())if(f.endsWith("$lit$")||f.startsWith(xe)){const y=p[s++];if(v.push(f),y!==void 0){const $=r.getAttribute(y.toLowerCase()+"$lit$").split(xe),k=/([.?@])?(.*)/.exec(y);d.push({type:1,index:o,name:k[2],strings:$,ctor:k[1]==="."?La:k[1]==="?"?Fa:k[1]==="@"?Na:Wt})}else d.push({type:6,index:o})}for(const f of v)r.removeAttribute(f)}if(Ma.test(r.tagName)){const v=r.textContent.split(xe),f=v.length-1;if(f>0){r.textContent=pt?pt.emptyScript:"";for(let y=0;y<f;y++)r.append(v[y],Pt()),ut.nextNode(),d.push({type:2,index:++o});r.append(v[f],Pt())}}}else if(r.nodeType===8)if(r.data===dr)d.push({type:2,index:o});else{let v=-1;for(;(v=r.data.indexOf(xe,v+1))!==-1;)d.push({type:7,index:o}),v+=xe.length-1}o++}}static createElement(e,t){const i=vt.createElement("template");return i.innerHTML=e,i}}function Ye(a,e,t=a,i){var r,o,s,l;if(e===ce)return e;let d=i!==void 0?(r=t._$Cl)===null||r===void 0?void 0:r[i]:t._$Cu;const h=Bt(e)?void 0:e._$litDirective$;return(d==null?void 0:d.constructor)!==h&&((o=d==null?void 0:d._$AO)===null||o===void 0||o.call(d,!1),h===void 0?d=void 0:(d=new h(a),d._$AT(a,t,i)),i!==void 0?((s=(l=t)._$Cl)!==null&&s!==void 0?s:l._$Cl=[])[i]=d:t._$Cu=d),d!==void 0&&(e=Ye(a,d._$AS(a,e.values),d,i)),e}class Oa{constructor(e,t){this.v=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}p(e){var t;const{el:{content:i},parts:r}=this._$AD,o=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:vt).importNode(i,!0);ut.currentNode=o;let s=ut.nextNode(),l=0,d=0,h=r[0];for(;h!==void 0;){if(l===h.index){let p;h.type===2?p=new yt(s,s.nextSibling,this,e):h.type===1?p=new h.ctor(s,h.name,h.strings,this,e):h.type===6&&(p=new Ra(s,this,e)),this.v.push(p),h=r[++d]}l!==(h==null?void 0:h.index)&&(s=ut.nextNode(),l++)}return o}m(e){let t=0;for(const i of this.v)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class yt{constructor(e,t,i,r){var o;this.type=2,this._$AH=_,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=r,this._$Cg=(o=r==null?void 0:r.isConnected)===null||o===void 0||o}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cg}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&e.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Ye(this,e,t),Bt(e)?e===_||e==null||e===""?(this._$AH!==_&&this._$AR(),this._$AH=_):e!==this._$AH&&e!==ce&&this.$(e):e._$litType$!==void 0?this.T(e):e.nodeType!==void 0?this.k(e):Da(e)?this.S(e):this.$(e)}M(e,t=this._$AB){return this._$AA.parentNode.insertBefore(e,t)}k(e){this._$AH!==e&&(this._$AR(),this._$AH=this.M(e))}$(e){this._$AH!==_&&Bt(this._$AH)?this._$AA.nextSibling.data=e:this.k(vt.createTextNode(e)),this._$AH=e}T(e){var t;const{values:i,_$litType$:r}=e,o=typeof r=="number"?this._$AC(e):(r.el===void 0&&(r.el=Ut.createElement(r.h,this.options)),r);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===o)this._$AH.m(i);else{const s=new Oa(o,this),l=s.p(this.options);s.m(i),this.k(l),this._$AH=s}}_$AC(e){let t=Yr.get(e.strings);return t===void 0&&Yr.set(e.strings,t=new Ut(e)),t}S(e){Ta(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,r=0;for(const o of e)r===t.length?t.push(i=new yt(this.M(Pt()),this.M(Pt()),this,this.options)):i=t[r],i._$AI(o),r++;r<t.length&&(this._$AR(i&&i._$AB.nextSibling,r),t.length=r)}_$AR(e=this._$AA.nextSibling,t){var i;for((i=this._$AP)===null||i===void 0||i.call(this,!1,!0,t);e&&e!==this._$AB;){const r=e.nextSibling;e.remove(),e=r}}setConnected(e){var t;this._$AM===void 0&&(this._$Cg=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}}class Wt{constructor(e,t,i,r,o){this.type=1,this._$AH=_,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=o,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=_}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,i,r){const o=this.strings;let s=!1;if(o===void 0)e=Ye(this,e,t,0),s=!Bt(e)||e!==this._$AH&&e!==ce,s&&(this._$AH=e);else{const l=e;let d,h;for(e=o[0],d=0;d<o.length-1;d++)h=Ye(this,l[i+d],t,d),h===ce&&(h=this._$AH[d]),s||(s=!Bt(h)||h!==this._$AH[d]),h===_?e=_:e!==_&&(e+=(h!=null?h:"")+o[d+1]),this._$AH[d]=h}s&&!r&&this.C(e)}C(e){e===_?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e!=null?e:"")}}class La extends Wt{constructor(){super(...arguments),this.type=3}C(e){this.element[this.name]=e===_?void 0:e}}const Bo=pt?pt.emptyScript:"";class Fa extends Wt{constructor(){super(...arguments),this.type=4}C(e){e&&e!==_?this.element.setAttribute(this.name,Bo):this.element.removeAttribute(this.name)}}class Na extends Wt{constructor(e,t,i,r,o){super(e,t,i,r,o),this.type=5}_$AI(e,t=this){var i;if((e=(i=Ye(this,e,t,0))!==null&&i!==void 0?i:_)===ce)return;const r=this._$AH,o=e===_&&r!==_||e.capture!==r.capture||e.once!==r.once||e.passive!==r.passive,s=e!==_&&(r===_||o);o&&this.element.removeEventListener(this.name,this,r),s&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,i;typeof this._$AH=="function"?this._$AH.call((i=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&i!==void 0?i:this.element,e):this._$AH.handleEvent(e)}}class Ra{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){Ye(this,e)}}const Uo={L:"$lit$",P:xe,V:dr,I:1,N:Ea,R:Oa,j:Da,D:Ye,H:yt,F:Wt,O:Fa,W:Na,B:La,Z:Ra},Kr=window.litHtmlPolyfillSupport;Kr==null||Kr(Ut,yt),((Oi=globalThis.litHtmlVersions)!==null&&Oi!==void 0?Oi:globalThis.litHtmlVersions=[]).push("2.2.4");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ho=(a,e)=>e.kind==="method"&&e.descriptor&&!("value"in e.descriptor)?Mt(fe({},e),{finisher(t){t.createProperty(e.key,a)}}):{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){typeof e.initializer=="function"&&(this[e.key]=e.initializer.call(this))},finisher(t){t.createProperty(e.key,a)}};function u(a){return(e,t)=>t!==void 0?((i,r,o)=>{r.constructor.createProperty(o,i)})(a,e,t):Ho(a,e)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ia=({finisher:a,descriptor:e})=>(t,i)=>{var r;if(i===void 0){const o=(r=t.originalKey)!==null&&r!==void 0?r:t.key,s=e!=null?{kind:"method",placement:"prototype",key:o,descriptor:e(t.key)}:Mt(fe({},t),{key:o});return a!=null&&(s.finisher=function(l){a(l,o)}),s}{const o=t.constructor;e!==void 0&&Object.defineProperty(t,i,e(i)),a==null||a(o,i)}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */const Zr=(a,e,t)=>{const i=new Map;for(let r=e;r<=t;r++)i.set(a[r],r);return i},Pa=cr(class extends hr{constructor(a){if(super(a),a.type!==Ae.CHILD)throw Error("repeat() can only be used in text expressions")}dt(a,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);const r=[],o=[];let s=0;for(const l of a)r[s]=i?i(l,s):s,o[s]=t(l,s),s++;return{values:o,keys:r}}render(a,e,t){return this.dt(a,e,t).values}update(a,[e,t,i]){var r;const o=Ko(a),{values:s,keys:l}=this.dt(e,t,i);if(!Array.isArray(o))return this.ut=l,s;const d=(r=this.ut)!==null&&r!==void 0?r:this.ut=[],h=[];let p,v,f=0,y=o.length-1,$=0,k=s.length-1;for(;f<=y&&$<=k;)if(o[f]===null)f++;else if(o[y]===null)y--;else if(d[f]===l[$])h[$]=He(o[f],s[$]),f++,$++;else if(d[y]===l[k])h[k]=He(o[y],s[k]),y--,k--;else if(d[f]===l[k])h[k]=He(o[f],s[k]),Et(a,h[k+1],o[f]),f++,k--;else if(d[y]===l[$])h[$]=He(o[y],s[$]),Et(a,o[f],o[y]),y--,$++;else if(p===void 0&&(p=Zr(l,$,k),v=Zr(d,f,y)),p.has(d[f]))if(p.has(d[y])){const E=v.get(l[$]),A=E!==void 0?o[E]:null;if(A===null){const N=Et(a,o[f]);He(N,s[$]),h[$]=N}else h[$]=He(A,s[$]),Et(a,o[f],A),o[E]=null;$++}else Ri(o[y]),y--;else Ri(o[f]),f++;for(;$<=k;){const E=Et(a,h[k+1]);He(E,s[$]),h[$++]=E}for(;f<=y;){const E=o[f++];E!==null&&Ri(E)}return this.ut=l,za(a,h),ce}});function qt(a,e,t){return Array.from({length:(e-a)/t+1},(i,r)=>a+r*t)}let Ne=class extends B{constructor(){super(...arguments),this.itemCount=0,this.scrollOptimizationsDisabled=!1,this.intersectionObserver=new IntersectionObserver(e=>{e.forEach(t=>{if(t.target===this.sentinel){t.isIntersecting&&this.dispatchEvent(new Event("scrollThresholdReached"));return}const r=t.target.dataset.cellIndex;if(!r)return;const o=parseInt(r,10);t.isIntersecting?this.visibleCellIndices.add(o):this.visibleCellIndices.delete(o)}),this.scrollOptimizationsDisabled||this.processVisibleCells()}),this.renderedCellIndices=new Set,this.visibleCellIndices=new Set,this.placeholderCellIndices=new Set}reload(){qt(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.removeCell(t)),this.renderedCellIndices.clear(),this.visibleCellIndices.clear(),this.placeholderCellIndices.clear(),this.setupObservations()}scrollToCell(e,t){const i=this.cellContainers[e];if(!i)return!1;const r=t?"smooth":"auto";return i.scrollIntoView({behavior:r}),!0}getVisibleCellIndices(){return Array.from(this.visibleCellIndices)}updated(e){(e.has("itemCount")||e.has("scrollOptimizationsDisabled"))&&this.setupObservations()}disconnectedCallback(){this.intersectionObserver.disconnect()}setupObservations(){this.setupIntersectionObserver()}setupIntersectionObserver(){this.intersectionObserver.disconnect(),this.sentinel&&this.intersectionObserver.observe(this.sentinel),this.scrollOptimizationsDisabled?(qt(0,Math.max(0,this.itemCount-1),1).forEach(t=>this.visibleCellIndices.add(t)),this.processVisibleCells()):this.cellContainers.forEach(e=>this.intersectionObserver.observe(e))}render(){const e=this.itemCount-1,t=qt(0,e,1);return m`
    ...
    `}};n([u({type:Number})],Ne.prototype,"itemCount",void 0);n([u({type:Object})],Ne.prototype,"cellProvider",void 0);n([u({type:Object})],Ne.prototype,"placeholderCellTemplate",void 0);n([u({type:Boolean})],Ne.prototype,"scrollOptimizationsDisabled",void 0);n([le("#sentinel")],Ne.prototype,"sentinel",void 0);n([Vo(".cell-container")],Ne.prototype,"cellContainers",void 0);Ne=n([Q("infinite-scroller")],Ne);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const qo=(a,...e)=>({strTag:!0,strings:a,values:e}),st=qo,Xo=a=>typeof a!="string"&&"strTag"in a,Zo=(a,e,t)=>{let i=a[0];for(let r=1;r<a.length;r++)i+=e[t?t[r-1]:r-1],i+=a[r];return i};/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;let Zi=class extends B{render(){var e,t,i;return m`
    ...
    `}};n([u({type:Object})],Zi.prototype,"model",void 0);Zi=n([Q("collection-tile")],Zi);const is=F`
...
`,ps={account:{color:"#000000",icon:is,text:"Account"},audio:{color:"#8fdaef",icon:rs,text:"Audio"},collection:{color:"#000000",icon:Ba,text:"Collection"},data:{color:"#333333",icon:as,text:"Data"},etree:{color:"#3871c1",icon:os,text:"E-tree"},film:{color:"#bf1b2c",icon:Jr,text:"Film"},image:{color:"#62c4a9",icon:ss,text:"Image"},movies:{color:"#bf1b2c",icon:Jr,text:"Movie"},radio:{color:"#8fdaef",icon:ns,text:"Radio"},software:{color:"#80cc28",icon:ls,text:"Software"},texts:{color:"#f9a72b",icon:ds,text:"Text"},tv:{color:"#f25d54",icon:cs,text:"TV"},video:{color:"#bf1b2c",icon:hs,text:"Video"},web:{color:"#fddd10",icon:us,text:"Web"}};let Vt=class extends B{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var e,t;const i=["tvnews","tvarchive","television"],r=["radio","radioprogram"];return this.mediatype==="movies"&&((e=this.collections)===null||e===void 0?void 0:e.some(o=>i.indexOf(o)>=0))?"tv":this.mediatype==="audio"&&((t=this.collections)===null||t===void 0?void 0:t.some(o=>r.indexOf(o)>=0))?"radio":this.mediatype||""}render(){const e=ps[this.displayMediatype];return e?m`
      <div
        id="icon"
 ...
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ea=cr(class extends hr{constructor(a){var e;if(super(a),a.type!==Ae.ATTRIBUTE||a.name!=="class"||((e=a.strings)===null||e===void 0?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(a){return" "+Object.keys(a).filter(e=>a[e]).join(" ")+" "}update(a,[e]){var t,i;if(this.et===void 0){this.et=new Set,a.strings!==void 0&&(this.st=new Set(a.strings.join(" ").split(/\s/).filter(o=>o!=="")));for(const o in e)e[o]&&!(!((t=this.st)===null||t===void 0)&&t.has(o))&&this.et.add(o);return this.render(e)}const r=a.element.classList;this.et.forEach(o=>{o in e||(r.remove(o),this.et.delete(o))});for(const o in e){const s=!!e[o];s===this.et.has(o)||((i=this.st)===null||i===void 0?void 0:i.has(o))||(s?(r.add(o),this.et.add(o)):(r.remove(o),this.et.delete(o)))}return ce}}),vs=b`
  .drop-shadow {
...
`;let _e=class extends B{constructor(){super(...arguments),this.isListTile=!1,this.isCompactTile=!1,this.loggedIn=!1,this.isWaveform=!1}render(){return m`
...
`;function Ss(a,e){let t=1;return a>=1e9?t=1e9:a>=1e6?t=1e6:a>=1e3&&e==="short"&&(t=1e3),t}function $s(a=0,e){const t=a/e,i=t<10;let r=0;return i?r=Math.round((t+Number.EPSILON)*10)/10:r=Math.round(t),r}function xs(a,e,t,i){switch(e){case 1e9:return We(t==="short"?st`${a}B`:st`${a} billion`);case 1e6:return We(t==="short"?st`${a}M`:st`${a} million`);case 1e3:return We(t==="short"?st`${a}K`:st`${a} thousand`);default:return new Intl.NumberFormat(i).format(a)}}function Nt(a,e="long",t="short",i="en-US"){const r=a!=null?a:-1;if(r<0)return"";const o=Ss(r,e),s=$s(r,o);return xs(s,o,t,i)}let Ke=class extends B{render(){return m`
    ...
    `}static get styles(){return[ws]}};n([u({type:String})],Ke.prototype,"mediatype",void 0);n([u({type:Number})],Ke.prototype,"itemCount",void 0);n([u({type:Number})],Ke.prototype,"viewCount",void 0);n([u({type:Number})],Ke.prototype,"favCount",void 0);n([u({type:Number})],Ke.prototype,"commentCount",void 0);Ke=n([Q("item-stats")],Ke);const Cs=b`
  #container {
...
`;let ni=class extends B{render(){var e,t,i,r,o,s;const l=(e=this.model)===null||e===void 0?void 0:e.title,d=(t=this.model)===null||t===void 0?void 0:t.creator;return m`
      <div id="container">
        <div class="title-wrapper">
          <h1 id="item-title" title=${Ce(l)}>${l}</h1>
        </div>
    ...
    `}static get styles(){return[Cs]}};n([u({type:Object})],ni.prototype,"model",void 0);n([u({type:String})],ni.prototype,"baseImageUrl",void 0);ni=n([Q("item-tile")],ni);let Ji=class extends B{render(){var e,t,i,r,o,s,l,d;return m`
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*ta(a,e){if(a!==void 0){let t=0;for(const i of a)yield e(i,t++)}}/*! @license DOMPurify 2.3.8 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/2.3.8/LICENSE */function je(a){return je=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},je(a)}function er(a,e){return er=Object.setPrototypeOf||function(i,r){return i.__proto__=r,i},er(a,e)}function _s(){if(typeof Reflect=="undefined"||!Reflect.construct||Reflect.construct.sham)return!1;if(typeof Proxy=="function")return!0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],function(){})),!0}catch{return!1}}function ti(a,e,t){return _s()?ti=Reflect.construct:ti=function(r,o,s){var l=[null];l.push.apply(l,o);var d=Function.bind.apply(r,l),h=new d;return s&&er(h,s.prototype),h},ti.apply(null,arguments)}function he(a){return ks(a)||Ts(a)||Ds(a)||Ms()}function ks(a){if(Array.isArray(a))return tr(a)}function Ts(a){if(typeof Symbol!="undefined"&&a[Symbol.iterator]!=null||a["@@iterator"]!=null)return Array.from(a)}function Ds(a,e){if(!!a){if(typeof a=="string")return tr(a,e);var t=Object.prototype.toString.call(a).slice(8,-1);if(t==="Object"&&a.constructor&&(t=a.constructor.name),t==="Map"||t==="Set")return Array.from(a);if(t==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t))return tr(a,e)}}function tr(a,e){(e==null||e>a.length)&&(e=a.length);for(var t=0,i=new Array(e);t<e;t++)i[t]=a[t];return i}function Ms(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}var As=Object.hasOwnProperty,ia=Object.setPrototypeOf,Es=Object.isFrozen,Os=Object.getPrototypeOf,Ls=Object.getOwnPropertyDescriptor,ee=Object.freeze,ye=Object.seal,Fs=Object.create,Ua=typeof Reflect!="undefined"&&Reflect,li=Ua.apply,ir=Ua.construct;li||(li=function(e,t,i){return e.apply(t,i)});ee||(ee=function(e){return e});ye||(ye=function(e){return e});ir||(ir=function(e,t){return ti(e,he(t))});var Ns=pe(Array.prototype.forEach),ra=pe(Array.prototype.pop),Ot=pe(Array.prototype.push),ii=pe(String.prototype.toLowerCase),Rs=pe(String.prototype.match),Me=pe(String.prototype.replace),Is=pe(String.prototype.indexOf),zs=pe(String.prototype.trim),J=pe(RegExp.prototype.test),zi=Ps(TypeError);function pe(a){return function(e){for(var t=arguments.length,i=new Array(t>1?t-1:0),r=1;r<t;r++)i[r-1]=arguments[r];return li(a,e,i)}}function Ps(a){return function(){for(var e=arguments.length,t=new Array(e),i=0;i<e;i++)t[i]=arguments[i];return ir(a,t)}}function M(a,e){ia&&ia(a,null);for(var t=e.length;t--;){var i=e[t];if(typeof i=="string"){var r=ii(i);r!==i&&(Es(e)||(e[t]=r),i=r)}a[i]=!0}return a}function Ve(a){var e=Fs(null),t;for(t in a)li(As,a,[t])&&(e[t]=a[t]);return e}function Xt(a,e){for(;a!==null;){var t=Ls(a,e);if(t){if(t.get)return pe(t.get);if(typeof t.value=="function")return pe(t.value)}a=Os(a)}function i(r){return console.warn("fallback value for",r),null}return i}var aa=ee(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","section","select","shadow","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),Pi=ee(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","filter","font","g","glyph","glyphref","hkern","image","line","lineargradient","marker","mask","metadata","mpath","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),Bi=ee(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),Bs=ee(["animate","color-profile","cursor","discard","fedropshadow","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),Ui=ee(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover"]),Us=ee(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),oa=ee(["#text"]),sa=ee(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","face","for","headers","height","hidden","high","href","hreflang","id","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","pattern","placeholder","playsinline","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","xmlns","slot"]),Hi=ee(["accent-height","accumulate","additive","alignment-baseline","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),na=ee(["accent","accentunder","align","bevelled","close","columnsalign","columnlines","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lspace","lquote","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),Zt=ee(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),Hs=ye(/\{\{[\w\W]*|[\w\W]*\}\}/gm),Vs=ye(/<%[\w\W]*|[\w\W]*%>/gm),Ws=ye(/^data-[\-\w.\u00B7-\uFFFF]/),js=ye(/^aria-[\-\w]+$/),Qs=ye(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|cid|xmpp):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),Gs=ye(/^(?:\w+script|data):/i),Ys=ye(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),Ks=ye(/^html$/i),qs=function(){return typeof window=="undefined"?null:window},Xs=function(e,t){if(je(e)!=="object"||typeof e.createPolicy!="function")return null;var i=null,r="data-tt-policy-suffix";t.currentScript&&t.currentScript.hasAttribute(r)&&(i=t.currentScript.getAttribute(r));var o="dompurify"+(i?"#"+i:"");try{return e.createPolicy(o,{createHTML:function(l){return l}})}catch{return console.warn("TrustedTypes policy "+o+" could not be created."),null}};function Ha(){var a=arguments.length>0&&arguments[0]!==void 0?arguments[0]:qs(),e=function(c){return Ha(c)};if(e.version="2.3.8",e.removed=[],!a||!a.document||a.document.nodeType!==9)return e.isSupported=!1,e;var t=a.document,i=a.document,r=a.DocumentFragment,o=a.HTMLTemplateElement,s=a.Node,l=a.Element,d=a.NodeFilter,h=a.NamedNodeMap,p=h===void 0?a.NamedNodeMap||a.MozNamedAttrMap:h,v=a.HTMLFormElement,f=a.DOMParser,y=a.trustedTypes,$=l.prototype,k=Xt($,"cloneNode"),E=Xt($,"nextSibling"),A=Xt($,"childNodes"),N=Xt($,"parentNode");if(typeof o=="function"){var L=i.createElement("template");L.content&&L.content.ownerDocument&&(i=L.content.ownerDocument)}var I=Xs(y,t),Y=I?I.createHTML(""):"",oe=i,ge=oe.implementation,wt=oe.createNodeIterator,St=oe.createDocumentFragment,$t=oe.getElementsByTagName,xt=t.importNode,qe={};try{qe=Ve(i).documentMode?i.documentMode:{}}catch{}var te={};e.isSupported=typeof N=="function"&&ge&&typeof ge.createHTMLDocument!="undefined"&&qe!==9;var Re=Hs,Ie=Vs,Ct=Ws,_t=js,kt=Gs,Xe=Ys,ze=Qs,V=null,Ze=M({},[].concat(he(aa),he(Pi),he(Bi),he(Ui),he(oa))),W=null,Je=M({},[].concat(he(sa),he(Hi),he(na),he(Zt))),U=Object.seal(Object.create(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),Te=null,gi=null,fr=!0,fi=!0,br=!1,et=!1,Pe=!1,bi=!1,yi=!1,tt=!1,jt=!1,Qt=!1,yr=!0,wi=!0,Tt=!1,it={},rt=null,wr=M({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","style","svg","template","thead","title","video","xmp"]),Sr=null,$r=M({},["audio","video","img","source","image","track"]),Si=null,xr=M({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),$i="http://www.w3.org/1998/Math/MathML",xi="http://www.w3.org/2000/svg",De="http://www.w3.org/1999/xhtml",Gt=De,Ci=!1,at,to=["application/xhtml+xml","text/html"],io="text/html",Be,ot=null,ro=i.createElement("form"),Cr=function(c){return c instanceof RegExp||c instanceof Function},_i=function(c){ot&&ot===c||((!c||je(c)!=="object")&&(c={}),c=Ve(c),V="ALLOWED_TAGS"in c?M({},c.ALLOWED_TAGS):Ze,W="ALLOWED_ATTR"in c?M({},c.ALLOWED_ATTR):Je,Si="ADD_URI_SAFE_ATTR"in c?M(Ve(xr),c.ADD_URI_SAFE_ATTR):xr,Sr="ADD_DATA_URI_TAGS"in c?M(Ve($r),c.ADD_DATA_URI_TAGS):$r,rt="FORBID_CONTENTS"in c?M({},c.FORBID_CONTENTS):wr,Te="FORBID_TAGS"in c?M({},c.FORBID_TAGS):{},gi="FORBID_ATTR"in c?M({},c.FORBID_ATTR):{},it="USE_PROFILES"in c?c.USE_PROFILES:!1,fr=c.ALLOW_ARIA_ATTR!==!1,fi=c.ALLOW_DATA_ATTR!==!1,br=c.ALLOW_UNKNOWN_PROTOCOLS||!1,et=c.SAFE_FOR_TEMPLATES||!1,Pe=c.WHOLE_DOCUMENT||!1,tt=c.RETURN_DOM||!1,jt=c.RETURN_DOM_FRAGMENT||!1,Qt=c.RETURN_TRUSTED_TYPE||!1,yi=c.FORCE_BODY||!1,yr=c.SANITIZE_DOM!==!1,wi=c.KEEP_CONTENT!==!1,Tt=c.IN_PLACE||!1,ze=c.ALLOWED_URI_REGEXP||ze,Gt=c.NAMESPACE||De,c.CUSTOM_ELEMENT_HANDLING&&Cr(c.CUSTOM_ELEMENT_HANDLING.tagNameCheck)&&(U.tagNameCheck=c.CUSTOM_ELEMENT_HANDLING.tagNameCheck),c.CUSTOM_ELEMENT_HANDLING&&Cr(c.CUSTOM_ELEMENT_HANDLING.attributeNameCheck)&&(U.attributeNameCheck=c.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),c.CUSTOM_ELEMENT_HANDLING&&typeof c.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements=="boolean"&&(U.allowCustomizedBuiltInElements=c.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements),at=to.indexOf(c.PARSER_MEDIA_TYPE)===-1?at=io:at=c.PARSER_MEDIA_TYPE,Be=at==="application/xhtml+xml"?function(g){return g}:ii,et&&(fi=!1),jt&&(tt=!0),it&&(V=M({},he(oa)),W=[],it.html===!0&&(M(V,aa),M(W,sa)),it.svg===!0&&(M(V,Pi),M(W,Hi),M(W,Zt)),it.svgFilters===!0&&(M(V,Bi),M(W,Hi),M(W,Zt)),it.mathMl===!0&&(M(V,Ui),M(W,na),M(W,Zt))),c.ADD_TAGS&&(V===Ze&&(V=Ve(V)),M(V,c.ADD_TAGS)),c.ADD_ATTR&&(W===Je&&(W=Ve(W)),M(W,c.ADD_ATTR)),c.ADD_URI_SAFE_ATTR&&M(Si,c.ADD_URI_SAFE_ATTR),c.FORBID_CONTENTS&&(rt===wr&&(rt=Ve(rt)),M(rt,c.FORBID_CONTENTS)),wi&&(V["#text"]=!0),Pe&&M(V,["html","head","body"]),V.table&&(M(V,["tbody"]),delete Te.tbody),ee&&ee(c),ot=c)},_r=M({},["mi","mo","mn","ms","mtext"]),kr=M({},["foreignobject","desc","title","annotation-xml"]),ao=M({},["title","style","font","a","script"]),Yt=M({},Pi);M(Yt,Bi),M(Yt,Bs);var ki=M({},Ui);M(ki,Us);var oo=function(c){var g=N(c);(!g||!g.tagName)&&(g={namespaceURI:De,tagName:"template"});var S=ii(c.tagName),R=ii(g.tagName);return c.namespaceURI===xi?g.namespaceURI===De?S==="svg":g.namespaceURI===$i?S==="svg"&&(R==="annotation-xml"||_r[R]):Boolean(Yt[S]):c.namespaceURI===$i?g.namespaceURI===De?S==="math":g.namespaceURI===xi?S==="math"&&kr[R]:Boolean(ki[S]):c.namespaceURI===De?g.namespaceURI===xi&&!kr[R]||g.namespaceURI===$i&&!_r[R]?!1:!ki[S]&&(ao[S]||!Yt[S]):!1},we=function(c){Ot(e.removed,{element:c});try{c.parentNode.removeChild(c)}catch{try{c.outerHTML=Y}catch{c.remove()}}},Tr=function(c,g){try{Ot(e.removed,{attribute:g.getAttributeNode(c),from:g})}catch{Ot(e.removed,{attribute:null,from:g})}if(g.removeAttribute(c),c==="is"&&!W[c])if(tt||jt)try{we(g)}catch{}else try{g.setAttribute(c,"")}catch{}},Dr=function(c){var g,S;if(yi)c="<remove></remove>"+c;else{var R=Rs(c,/^[\r\n\t ]+/);S=R&&R[0]}at==="application/xhtml+xml"&&(c='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+c+"</body></html>");var ie=I?I.createHTML(c):c;if(Gt===De)try{g=new f().parseFromString(ie,at)}catch{}if(!g||!g.documentElement){g=ge.createDocument(Gt,"template",null);try{g.documentElement.innerHTML=Ci?"":ie}catch{}}var X=g.body||g.documentElement;return c&&S&&X.insertBefore(i.createTextNode(S),X.childNodes[0]||null),Gt===De?$t.call(g,Pe?"html":"body")[0]:Pe?g.documentElement:X},Mr=function(c){return wt.call(c.ownerDocument||c,c,d.SHOW_ELEMENT|d.SHOW_COMMENT|d.SHOW_TEXT,null,!1)},so=function(c){return c instanceof v&&(typeof c.nodeName!="string"||typeof c.textContent!="string"||typeof c.removeChild!="function"||!(c.attributes instanceof p)||typeof c.removeAttribute!="function"||typeof c.setAttribute!="function"||typeof c.namespaceURI!="string"||typeof c.insertBefore!="function")},Dt=function(c){return je(s)==="object"?c instanceof s:c&&je(c)==="object"&&typeof c.nodeType=="number"&&typeof c.nodeName=="string"},Se=function(c,g,S){!te[c]||Ns(te[c],function(R){R.call(e,g,S,ot)})},Ar=function(c){var g;if(Se("beforeSanitizeElements",c,null),so(c)||J(/[\u0080-\uFFFF]/,c.nodeName))return we(c),!0;var S=Be(c.nodeName);if(Se("uponSanitizeElement",c,{tagName:S,allowedTags:V}),c.hasChildNodes()&&!Dt(c.firstElementChild)&&(!Dt(c.content)||!Dt(c.content.firstElementChild))&&J(/<[/\w]/g,c.innerHTML)&&J(/<[/\w]/g,c.textContent)||S==="select"&&J(/<template/i,c.innerHTML))return we(c),!0;if(!V[S]||Te[S]){if(!Te[S]&&Or(S)&&(U.tagNameCheck instanceof RegExp&&J(U.tagNameCheck,S)||U.tagNameCheck instanceof Function&&U.tagNameCheck(S)))return!1;if(wi&&!rt[S]){var R=N(c)||c.parentNode,ie=A(c)||c.childNodes;if(ie&&R)for(var X=ie.length,K=X-1;K>=0;--K)R.insertBefore(k(ie[K],!0),E(c))}return we(c),!0}return c instanceof l&&!oo(c)||(S==="noscript"||S==="noembed")&&J(/<\/no(script|embed)/i,c.innerHTML)?(we(c),!0):(et&&c.nodeType===3&&(g=c.textContent,g=Me(g,Re," "),g=Me(g,Ie," "),c.textContent!==g&&(Ot(e.removed,{element:c.cloneNode()}),c.textContent=g)),Se("afterSanitizeElements",c,null),!1)},Er=function(c,g,S){if(yr&&(g==="id"||g==="name")&&(S in i||S in ro))return!1;if(!(fi&&!gi[g]&&J(Ct,g))){if(!(fr&&J(_t,g))){if(!W[g]||gi[g]){if(!(Or(c)&&(U.tagNameCheck instanceof RegExp&&J(U.tagNameCheck,c)||U.tagNameCheck instanceof Function&&U.tagNameCheck(c))&&(U.attributeNameCheck instanceof RegExp&&J(U.attributeNameCheck,g)||U.attributeNameCheck instanceof Function&&U.attributeNameCheck(g))||g==="is"&&U.allowCustomizedBuiltInElements&&(U.tagNameCheck instanceof RegExp&&J(U.tagNameCheck,S)||U.tagNameCheck instanceof Function&&U.tagNameCheck(S))))return!1}else if(!Si[g]){if(!J(ze,Me(S,Xe,""))){if(!((g==="src"||g==="xlink:href"||g==="href")&&c!=="script"&&Is(S,"data:")===0&&Sr[c])){if(!(br&&!J(kt,Me(S,Xe,"")))){if(S)return!1}}}}}}return!0},Or=function(c){return c.indexOf("-")>0},Lr=function(c){var g,S,R,ie;Se("beforeSanitizeAttributes",c,null);var X=c.attributes;if(!!X){var K={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:W};for(ie=X.length;ie--;){g=X[ie];var Kt=g,Z=Kt.name,Fr=Kt.namespaceURI;if(S=Z==="value"?g.value:zs(g.value),R=Be(Z),K.attrName=R,K.attrValue=S,K.keepAttr=!0,K.forceKeepAttr=void 0,Se("uponSanitizeAttribute",c,K),S=K.attrValue,!K.forceKeepAttr&&(Tr(Z,c),!!K.keepAttr)){if(J(/\/>/i,S)){Tr(Z,c);continue}et&&(S=Me(S,Re," "),S=Me(S,Ie," "));var lo=Be(c.nodeName);if(!!Er(lo,R,S))try{Fr?c.setAttributeNS(Fr,Z,S):c.setAttribute(Z,S),ra(e.removed)}catch{}}}Se("afterSanitizeAttributes",c,null)}},no=function C(c){var g,S=Mr(c);for(Se("beforeSanitizeShadowDOM",c,null);g=S.nextNode();)Se("uponSanitizeShadowNode",g,null),!Ar(g)&&(g.content instanceof r&&C(g.content),Lr(g));Se("afterSanitizeShadowDOM",c,null)};return e.sanitize=function(C,c){var g,S,R,ie,X;if(Ci=!C,Ci&&(C="<!-->"),typeof C!="string"&&!Dt(C)){if(typeof C.toString!="function")throw zi("toString is not a function");if(C=C.toString(),typeof C!="string")throw zi("dirty is not a string, aborting")}if(!e.isSupported){if(je(a.toStaticHTML)==="object"||typeof a.toStaticHTML=="function"){if(typeof C=="string")return a.toStaticHTML(C);if(Dt(C))return a.toStaticHTML(C.outerHTML)}return C}if(bi||_i(c),e.removed=[],typeof C=="string"&&(Tt=!1),Tt){if(C.nodeName){var K=Be(C.nodeName);if(!V[K]||Te[K])throw zi("root node is forbidden and cannot be sanitized in-place")}}else if(C instanceof s)g=Dr("<!---->"),S=g.ownerDocument.importNode(C,!0),S.nodeType===1&&S.nodeName==="BODY"||S.nodeName==="HTML"?g=S:g.appendChild(S);else{if(!tt&&!et&&!Pe&&C.indexOf("<")===-1)return I&&Qt?I.createHTML(C):C;if(g=Dr(C),!g)return tt?null:Qt?Y:""}g&&yi&&we(g.firstChild);for(var Kt=Mr(Tt?C:g);R=Kt.nextNode();)R.nodeType===3&&R===ie||Ar(R)||(R.content instanceof r&&no(R.content),Lr(R),ie=R);if(ie=null,Tt)return C;if(tt){if(jt)for(X=St.call(g.ownerDocument);g.firstChild;)X.appendChild(g.firstChild);else X=g;return W.shadowroot&&(X=xt.call(t,X,!0)),X}var Z=Pe?g.outerHTML:g.innerHTML;return Pe&&V["!doctype"]&&g.ownerDocument&&g.ownerDocument.doctype&&g.ownerDocument.doctype.name&&J(Ks,g.ownerDocument.doctype.name)&&(Z="<!DOCTYPE "+g.ownerDocument.doctype.name+`>
`+Z),et&&(Z=Me(Z,Re," "),Z=Me(Z,Ie," ")),I&&Qt?I.createHTML(Z):Z},e.setConfig=function(C){_i(C),bi=!0},e.clearConfig=function(){ot=null,bi=!1},e.isValidAttribute=function(C,c,g){ot||_i({});var S=Be(C),R=Be(c);return Er(S,R,g)},e.addHook=function(C,c){typeof c=="function"&&(te[C]=te[C]||[],Ot(te[C],c))},e.removeHook=function(C){if(te[C])return ra(te[C])},e.removeHooks=function(C){te[C]&&(te[C]=[])},e.removeAllHooks=function(){te={}},e}var Rt=Ha();function Va(a){switch(a){case"date":return"Published";case"reviewdate":return"Reviewed";case"addeddate":return"Added";default:return"Archived"}}function Wa(a){return a?`Archivist since ${a.getFullYear()}`:""}function rr(a,e="short",t="en-US"){if(!a)return"";const i={timeZone:"UTC"};switch(e){case"short":i.month="short",i.year="numeric";break;case"long":i.year="numeric",i.month="short",i.day="2-digit";break}return new Intl.DateTimeFormat(t,i).format(a)}let ve=class extends B{constructor(){super(...arguments),this.sortParam=null,this.collectionLinks=[]}updated(e){e.has("model")&&this.fetchCollectionNames()}async fetchCollectionNames(){var e,t;if(!(!((e=this.model)===null||e===void 0)&&e.collections)||this.model.collections.length===0||!this.collectionNameCache)return;this.collectionLinks=[];const i=[],r=[];for(const o of this.model.collections)r.push((t=this.collectionNameCache)===null||t===void 0?void 0:t.collectionNameFor(o).then(s=>{i.push(this.detailsLink(o,s!=null?s:o))}));await Promise.all(r),this.collectionLinks=i}render(){return m`
    ...
    `}};n([u({type:Object})],ve.prototype,"model",void 0);n([u({type:String})],ve.prototype,"baseNavigationUrl",void 0);n([u({type:Object})],ve.prototype,"collectionNameCache",void 0);n([u({type:Number})],ve.prototype,"currentWidth",void 0);n([u({type:Number})],ve.prototype,"currentHeight",void 0);n([u({type:Object})],ve.prototype,"sortParam",void 0);n([u({type:Number})],ve.prototype,"mobileBreakpoint",void 0);n([D()],ve.prototype,"collectionLinks",void 0);n([u({type:String})],ve.prototype,"baseImageUrl",void 0);ve=n([Q("tile-list")],ve);let ke=class extends B{constructor(){super(...arguments),this.sortParam=null}render(){var e,t,i,r,o,s,l,d,h,p,v;return m`
      <div id="list-line" class="${this.classSize}">
        ...
        <div id="creator">
          ${((r=this.model)===null||r===void 0?void 0:r.mediatype)==="account"?Wa((o=this.model)===null||o===void 0?void 0:o.dateAdded):Rt.sanitize((l=(s=this.model)===null||s===void 0?void 0:s.creator)!==null&&l!==void 0?l:"")}
        </div>
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ha=cr(class extends hr{constructor(a){if(super(a),a.type!==Ae.PROPERTY&&a.type!==Ae.ATTRIBUTE&&a.type!==Ae.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Go(a))throw Error("`live` bindings can only contain a single expression")}render(a){return a}update(a,[e]){if(e===ce||e===_)return e;const t=a.element,i=a.name;if(a.type===Ae.PROPERTY){if(e===t[i])return ce}else if(a.type===Ae.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(i))return ce}else if(a.type===Ae.ATTRIBUTE&&t.getAttribute(i)===e+"")return ce;return za(a),e}});var ja=60,Qa=ja*60,Ga=Qa*24,rn=Ga*7,gt=1e3,Vi=ja*gt,ua=Qa*gt,an=Ga*gt,on=rn*gt,ur="millisecond",lt="second",dt="minute",ct="hour",Ee="day",ri="week",ue="month",Ya="quarter",Oe="year",ht="date",sn="YYYY-MM-DDTHH:mm:ssZ",pa="Invalid Date",nn=/^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/,ln=/\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g,dn={name:"en",weekdays:"Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),months:"January_February_March_April_May_June_July_August_September_October_November_December".split("_")},ar=function(e,t,i){var r=String(e);return!r||r.length>=t?e:""+Array(t+1-r.length).join(i)+e},cn=function(e){var t=-e.utcOffset(),i=Math.abs(t),r=Math.floor(i/60),o=i%60;return(t<=0?"+":"-")+ar(r,2,"0")+":"+ar(o,2,"0")},hn=function a(e,t){if(e.date()<t.date())return-a(t,e);var i=(t.year()-e.year())*12+(t.month()-e.month()),r=e.clone().add(i,ue),o=t-r<0,s=e.clone().add(i+(o?-1:1),ue);return+(-(i+(t-r)/(o?r-s:s-r))||0)},un=function(e){return e<0?Math.ceil(e)||0:Math.floor(e)},pn=function(e){var t={M:ue,y:Oe,w:ri,d:Ee,D:ht,h:ct,m:dt,s:lt,ms:ur,Q:Ya};return t[e]||String(e||"").toLowerCase().replace(/s$/,"")},vn=function(e){return e===void 0},mn={s:ar,z:cn,m:hn,a:un,p:pn,u:vn},It="en",Ge={};Ge[It]=dn;var pr=function(e){return e instanceof mi},hi=function a(e,t,i){var r;if(!e)return It;if(typeof e=="string"){var o=e.toLowerCase();Ge[o]&&(r=o),t&&(Ge[o]=t,r=o);var s=e.split("-");if(!r&&s.length>1)return a(s[0])}else{var l=e.name;Ge[l]=e,r=l}return!i&&r&&(It=r),r||!i&&It},G=function(e,t){if(pr(e))return e.clone();var i=typeof t=="object"?t:{};return i.date=e,i.args=arguments,new mi(i)},gn=function(e,t){return G(e,{locale:t.$L,utc:t.$u,x:t.$x,$offset:t.$offset})},z=mn;z.l=hi;z.i=pr;z.w=gn;var fn=function(e){var t=e.date,i=e.utc;if(t===null)return new Date(NaN);if(z.u(t))return new Date;if(t instanceof Date)return new Date(t);if(typeof t=="string"&&!/Z$/i.test(t)){var r=t.match(nn);if(r){var o=r[2]-1||0,s=(r[7]||"0").substring(0,3);return i?new Date(Date.UTC(r[1],o,r[3]||1,r[4]||0,r[5]||0,r[6]||0,s)):new Date(r[1],o,r[3]||1,r[4]||0,r[5]||0,r[6]||0,s)}}return new Date(t)},mi=function(){function a(t){this.$L=hi(t.locale,null,!0),this.parse(t)}var e=a.prototype;return e.parse=function(i){this.$d=fn(i),this.$x=i.x||{},this.init()},e.init=function(){var i=this.$d;this.$y=i.getFullYear(),this.$M=i.getMonth(),this.$D=i.getDate(),this.$W=i.getDay(),this.$H=i.getHours(),this.$m=i.getMinutes(),this.$s=i.getSeconds(),this.$ms=i.getMilliseconds()},e.$utils=function(){return z},e.isValid=function(){return this.$d.toString()!==pa},e.isSame=function(i,r){var o=G(i);return this.startOf(r)<=o&&o<=this.endOf(r)},e.isAfter=function(i,r){return G(i)<this.startOf(r)},e.isBefore=function(i,r){return this.endOf(r)<G(i)},e.$g=function(i,r,o){return z.u(i)?this[r]:this.set(o,i)},e.unix=function(){return Math.floor(this.valueOf()/1e3)},e.valueOf=function(){return this.$d.getTime()},e.startOf=function(i,r){var o=this,s=z.u(r)?!0:r,l=z.p(i),d=function(A,N){var L=z.w(o.$u?Date.UTC(o.$y,N,A):new Date(o.$y,N,A),o);return s?L:L.endOf(Ee)},h=function(A,N){var L=[0,0,0,0],I=[23,59,59,999];return z.w(o.toDate()[A].apply(o.toDate("s"),(s?L:I).slice(N)),o)},p=this.$W,v=this.$M,f=this.$D,y="set"+(this.$u?"UTC":"");switch(l){case Oe:return s?d(1,0):d(31,11);case ue:return s?d(1,v):d(0,v+1);case ri:{var $=this.$locale().weekStart||0,k=(p<$?p+7:p)-$;return d(s?f-k:f+(6-k),v)}case Ee:case ht:return h(y+"Hours",0);case ct:return h(y+"Minutes",1);case dt:return h(y+"Seconds",2);case lt:return h(y+"Milliseconds",3);default:return this.clone()}},e.endOf=function(i){return this.startOf(i,!1)},e.$set=function(i,r){var o,s=z.p(i),l="set"+(this.$u?"UTC":""),d=(o={},o[Ee]=l+"Date",o[ht]=l+"Date",o[ue]=l+"Month",o[Oe]=l+"FullYear",o[ct]=l+"Hours",o[dt]=l+"Minutes",o[lt]=l+"Seconds",o[ur]=l+"Milliseconds",o)[s],h=s===Ee?this.$D+(r-this.$W):r;if(s===ue||s===Oe){var p=this.clone().set(ht,1);p.$d[d](h),p.init(),this.$d=p.set(ht,Math.min(this.$D,p.daysInMonth())).$d}else d&&this.$d[d](h);return this.init(),this},e.set=function(i,r){return this.clone().$set(i,r)},e.get=function(i){return this[z.p(i)]()},e.add=function(i,r){var o=this,s;i=Number(i);var l=z.p(r),d=function(f){var y=G(o);return z.w(y.date(y.date()+Math.round(f*i)),o)};if(l===ue)return this.set(ue,this.$M+i);if(l===Oe)return this.set(Oe,this.$y+i);if(l===Ee)return d(1);if(l===ri)return d(7);var h=(s={},s[dt]=Vi,s[ct]=ua,s[lt]=gt,s)[l]||1,p=this.$d.getTime()+i*h;return z.w(p,this)},e.subtract=function(i,r){return this.add(i*-1,r)},e.format=function(i){var r=this,o=this.$locale();if(!this.isValid())return o.invalidDate||pa;var s=i||sn,l=z.z(this),d=this.$H,h=this.$m,p=this.$M,v=o.weekdays,f=o.months,y=o.meridiem,$=function(L,I,Y,oe){return L&&(L[I]||L(r,s))||Y[I].slice(0,oe)},k=function(L){return z.s(d%12||12,L,"0")},E=y||function(N,L,I){var Y=N<12?"AM":"PM";return I?Y.toLowerCase():Y},A={YY:String(this.$y).slice(-2),YYYY:this.$y,M:p+1,MM:z.s(p+1,2,"0"),MMM:$(o.monthsShort,p,f,3),MMMM:$(f,p),D:this.$D,DD:z.s(this.$D,2,"0"),d:String(this.$W),dd:$(o.weekdaysMin,this.$W,v,2),ddd:$(o.weekdaysShort,this.$W,v,3),dddd:v[this.$W],H:String(d),HH:z.s(d,2,"0"),h:k(1),hh:k(2),a:E(d,h,!0),A:E(d,h,!1),m:String(h),mm:z.s(h,2,"0"),s:String(this.$s),ss:z.s(this.$s,2,"0"),SSS:z.s(this.$ms,3,"0"),Z:l};return s.replace(ln,function(N,L){return L||A[N]||l.replace(":","")})},e.utcOffset=function(){return-Math.round(this.$d.getTimezoneOffset()/15)*15},e.diff=function(i,r,o){var s,l=z.p(r),d=G(i),h=(d.utcOffset()-this.utcOffset())*Vi,p=this-d,v=z.m(this,d);return v=(s={},s[Oe]=v/12,s[ue]=v,s[Ya]=v/3,s[ri]=(p-h)/on,s[Ee]=(p-h)/an,s[ct]=p/ua,s[dt]=p/Vi,s[lt]=p/gt,s)[l]||p,o?v:z.a(v)},e.daysInMonth=function(){return this.endOf(ue).$D},e.$locale=function(){return Ge[this.$L]},e.locale=function(i,r){if(!i)return this.$L;var o=this.clone(),s=hi(i,r,!0);return s&&(o.$L=s),o},e.clone=function(){return z.w(this.$d,this)},e.toDate=function(){return new Date(this.valueOf())},e.toJSON=function(){return this.isValid()?this.toISOString():null},e.toISOString=function(){return this.$d.toISOString()},e.toString=function(){return this.$d.toUTCString()},a}(),Ka=mi.prototype;G.prototype=Ka;[["$ms",ur],["$s",lt],["$m",dt],["$H",ct],["$W",Ee],["$M",ue],["$y",Oe],["$D",ht]].forEach(function(a){Ka[a[1]]=function(e){return this.$g(e,a[0],a[1])}});G.extend=function(a,e){return a.$i||(a(e,mi,G),a.$i=!0),G};G.locale=hi;G.isDayjs=pr;G.unix=function(a){return G(a*1e3)};G.en=Ge[It];G.Ls=Ge;G.p={};var bn=function(e){return e.replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g,function(t,i,r){return i||r.slice(1)})},yn={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"},wn=function(e,t){return e.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g,function(i,r,o){var s=o&&o.toUpperCase();return r||t[o]||yn[o]||bn(t[s])})},Sn=/(\[[^[]*\])|([-:/.()\s]+)|(A|a|YYYY|YY?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g,$n=/\d/,Jt=/\d\d/,xn=/\d{3}/,Cn=/\d{4}/,be=/\d\d?/,_n=/[+-]?\d+/,kn=/[+-]\d\d:?(\d\d)?|Z/,Ft=/\d*[^\s\d-_:/()]+/,Fe={},qa=function(e){return e=+e,e+(e>68?1900:2e3)};function Tn(a){if(!a||a==="Z")return 0;var e=a.match(/([+-]|\d\d)/g),t=+(e[1]*60)+(+e[2]||0);return t===0?0:e[0]==="+"?-t:t}var re=function(e){return function(t){this[e]=+t}},va=[kn,function(a){var e=this.zone||(this.zone={});e.offset=Tn(a)}],Wi=function(e){var t=Fe[e];return t&&(t.indexOf?t:t.s.concat(t.f))},ma=function(e,t){var i,r=Fe,o=r.meridiem;if(!o)i=e===(t?"pm":"PM");else for(var s=1;s<=24;s+=1)if(e.indexOf(o(s,0,t))>-1){i=s>12;break}return i},Dn={A:[Ft,function(a){this.afternoon=ma(a,!1)}],a:[Ft,function(a){this.afternoon=ma(a,!0)}],S:[$n,function(a){this.milliseconds=+a*100}],SS:[Jt,function(a){this.milliseconds=+a*10}],SSS:[xn,function(a){this.milliseconds=+a}],s:[be,re("seconds")],ss:[be,re("seconds")],m:[be,re("minutes")],mm:[be,re("minutes")],H:[be,re("hours")],h:[be,re("hours")],HH:[be,re("hours")],hh:[be,re("hours")],D:[be,re("day")],DD:[Jt,re("day")],Do:[Ft,function(a){var e=Fe,t=e.ordinal,i=a.match(/\d+/);if(this.day=i[0],!!t)for(var r=1;r<=31;r+=1)t(r).replace(/\[|\]/g,"")===a&&(this.day=r)}],M:[be,re("month")],MM:[Jt,re("month")],MMM:[Ft,function(a){var e=Wi("months"),t=Wi("monthsShort"),i=(t||e.map(function(r){return r.slice(0,3)})).indexOf(a)+1;if(i<1)throw new Error;this.month=i%12||i}],MMMM:[Ft,function(a){var e=Wi("months"),t=e.indexOf(a)+1;if(t<1)throw new Error;this.month=t%12||t}],Y:[_n,re("year")],YY:[Jt,function(a){this.year=qa(a)}],YYYY:[Cn,re("year")],Z:va,ZZ:va};function Mn(a){var e=a.afternoon;if(e!==void 0){var t=a.hours;e?t<12&&(a.hours+=12):t===12&&(a.hours=0),delete a.afternoon}}function An(a){a=wn(a,Fe&&Fe.formats);for(var e=a.match(Sn),t=e.length,i=0;i<t;i+=1){var r=e[i],o=Dn[r],s=o&&o[0],l=o&&o[1];l?e[i]={regex:s,parser:l}:e[i]=r.replace(/^\[|\]$/g,"")}return function(d){for(var h={},p=0,v=0;p<t;p+=1){var f=e[p];if(typeof f=="string")v+=f.length;else{var y=f.regex,$=f.parser,k=d.slice(v),E=y.exec(k),A=E[0];$.call(h,A),d=d.replace(A,"")}}return Mn(h),h}}var En=function(e,t,i){try{if(["x","X"].indexOf(t)>-1)return new Date((t==="X"?1e3:1)*e);var r=An(t),o=r(e),s=o.year,l=o.month,d=o.day,h=o.hours,p=o.minutes,v=o.seconds,f=o.milliseconds,y=o.zone,$=new Date,k=d||(!s&&!l?$.getDate():1),E=s||$.getFullYear(),A=0;s&&!l||(A=l>0?l-1:$.getMonth());var N=h||0,L=p||0,I=v||0,Y=f||0;return y?new Date(Date.UTC(E,A,k,N,L,I,Y+y.offset*60*1e3)):i?new Date(Date.UTC(E,A,k,N,L,I,Y)):new Date(E,A,k,N,L,I,Y)}catch{return new Date("")}},On=function(a,e,t){t.p.customParseFormat=!0,a&&a.parseTwoDigitYear&&(qa=a.parseTwoDigitYear);var i=e.prototype,r=i.parse;i.parse=function(o){var s=o.date,l=o.utc,d=o.args;this.$u=l;var h=d[1];if(typeof h=="string"){var p=d[2]===!0,v=d[3]===!0,f=p||v,y=d[2];v&&(y=d[2]),Fe=this.$locale(),!p&&y&&(Fe=t.Ls[y]),this.$d=En(s,h,l),this.init(),y&&y!==!0&&(this.$L=this.locale(y).$L),f&&s!=this.format(h)&&(this.$d=new Date("")),Fe={}}else if(h instanceof Array)for(var $=h.length,k=1;k<=$;k+=1){d[1]=h[k-1];var E=t.apply(this,d);if(E.isValid()){this.$d=E.$d,this.$L=E.$L,this.init();break}k===$&&(this.$d=new Date(""))}else r.call(this,o)}};const Ln=Object.freeze({processing:"processing",complete:"complete"});class Fn extends B{static get properties(){return{mode:{type:String}}}constructor(){super(),this.mode=Ln.processing}render(){return m`
      <div class="${this.mode}">
        <svg
          viewBox="0 0 120 120"
    ...
    `}get selectedRangeTemplate(){return F`
      <rect
        ...
        height="${this.height}"
        fill="${Vn}"
      />`}get histogramTemplate(){const e=this._histWidth/this._numBins,t=e-1;let i=this.sliderWidth;return this._histData.map(r=>{const o=F`
        <rect
          class="bar"
