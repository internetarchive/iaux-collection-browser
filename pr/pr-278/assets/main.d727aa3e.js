 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*gi(a,e){const t=typeof e=="function";if(a!==void 0){let i=-1;for(const o of a)i>-1&&(yield t?e(i):e),i++,yield o}}let Si=class extends B{constructor(){super(...arguments),this.snippets=[],this.viewSize="desktop"}render(){var e;return!((e=this.snippets)===null||e===void 0)&&e.length?h`
      <div class="container">
    ...
    `}};s([c({type:Array})],Si.prototype,"snippets",void 0);s([c({type:String})],Si.prototype,"viewSize",void 0);Si=s([A("text-snippet-block")],Si);const _s=f`
  .drop-shadow {
    overflow: hidden;
    height: 100%;
  }
...
`+ve),ze&&(ve=je(ve,et," "),ve=je(ve,tt," ")),Q&&ci?Q.createHTML(ve):ve},e.setConfig=function($){Bi($),rt=!0},e.clearConfig=function(){$t=null,rt=!1},e.isValidAttribute=function($,u,x){$t||Bi({});var C=nt($),N=nt(u);return Qo(C,N,x)},e.addHook=function($,u){typeof u=="function"&&(se[$]=se[$]||[],Vt(se[$],u))},e.removeHook=function($){if(se[$])return ba(se[$])},e.removeHooks=function($){se[$]&&(se[$]=[])},e.removeAllHooks=function(){se={}},e}var wi=dr(),_;(function(a){a.default="default",a.unrecognized="unrecognized",a.relevance="relevance",a.alltimeview="alltimeview",a.weeklyview="weeklyview",a.title="title",a.date="date",a.datearchived="datearchived",a.datereviewed="datereviewed",a.dateadded="dateadded",a.datefavorited="datefavorited",a.creator="creator"})(_||(_={}));const ge={[_.default]:{field:_.default,defaultSortDirection:null,canSetDirection:!1,shownInSortBar:!1,shownInURL:!1,handledBySearchService:!1,displayName:"",urlNames:["",null,void 0]},[_.unrecognized]:{field:_.unrecognized,defaultSortDirection:null,canSetDirection:!0,shownInSortBar:!1,shownInURL:!1,handledBySearchService:!0,displayName:"",urlNames:[]},[_.relevance]:{field:_.relevance,defaultSortDirection:null,canSetDirection:!1,shownInSortBar:!0,shownInURL:!1,handledBySearchService:!1,displayName:"Relevance",urlNames:["_score"]},[_.alltimeview]:{field:_.alltimeview,defaultSortDirection:"desc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"downloads",displayName:"All-time views",urlNames:["downloads"]},[_.weeklyview]:{field:_.weeklyview,defaultSortDirection:"desc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"week",displayName:"Weekly views",urlNames:["week"]},[_.title]:{field:_.title,defaultSortDirection:"asc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"titleSorter",displayName:"Title",urlNames:["title","titleSorter"]},[_.date]:{field:_.date,defaultSortDirection:"desc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"date",displayName:"Date published",urlNames:["date"]},[_.datearchived]:{field:_.datearchived,defaultSortDirection:"desc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"publicdate",displayName:"Date archived",urlNames:["publicdate"]},[_.datereviewed]:{field:_.datereviewed,defaultSortDirection:"desc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"reviewdate",displayName:"Date reviewed",urlNames:["reviewdate"]},[_.dateadded]:{field:_.dateadded,defaultSortDirection:"desc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"addeddate",displayName:"Date added",urlNames:["addeddate"]},[_.datefavorited]:{field:_.datefavorited,defaultSortDirection:"desc",canSetDirection:!1,shownInSortBar:!0,shownInURL:!1,handledBySearchService:!1,searchServiceKey:"favoritedate",displayName:"Date favorited",urlNames:["favoritedate"]},[_.creator]:{field:_.creator,defaultSortDirection:"asc",canSetDirection:!0,shownInSortBar:!0,shownInURL:!0,handledBySearchService:!0,searchServiceKey:"creatorSorter",displayName:"Creator",urlNames:["creator","creatorSorter"]}};function cr(a){var e;return(e=Object.values(ge).find(t=>t.urlNames.some(i=>a===i)))!==null&&e!==void 0?e:ge[_.unrecognized]}const bn={title:"firstTitle",creator:"firstCreator"},ai=()=>({subject:{},lending:{},mediatype:{},language:{},creator:{},collection:{},year:{}}),yn=["mediatype","lending","year","subject","collection","creator","language"],ki={subject:"Subject",lending:"Availability",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"},fo={subject:J.COUNT,lending:J.COUNT,mediatype:J.COUNT,language:J.COUNT,creator:J.COUNT,collection:J.COUNT,year:J.NUMERIC},wn={subject:J.ALPHABETICAL,lending:J.ALPHABETICAL,mediatype:J.ALPHABETICAL,language:J.ALPHABETICAL,creator:J.ALPHABETICAL,collection:J.ALPHABETICAL,year:J.NUMERIC},xn={is_lendable:!0,is_borrowable:!1,available_to_borrow:!0,is_browsable:!1,available_to_browse:!1,is_readable:!0,available_to_waitlist:!1},Ca={is_lendable:"Lending Library",available_to_borrow:"Borrow 14 Days",is_readable:"Always Available"},Lo={deemphasize:!0,community:!0,stream_only:!0,samples_only:!0,test_collection:!0,printdisabled:!0,"openlibrary-ol":!0,nationalemergencylibrary:!0,china:!0,americana:!0,toronto:!0};let Ti=class extends ce{constructor(){super(...arguments),this.collectionLinks=[]}render(){return h`
    ...
    `}};s([c({type:Object})],Xe.prototype,"model",void 0);s([c({type:String})],Xe.prototype,"baseNavigationUrl",void 0);s([c({type:String})],Xe.prototype,"baseImageUrl",void 0);s([c({type:Boolean})],Xe.prototype,"loggedIn",void 0);s([c({type:Object})],Xe.prototype,"sortParam",void 0);s([c({type:Object})],Xe.prototype,"collectionNameCache",void 0);Xe=s([A("tile-hover-pane")],Xe);let Sa=class extends ce{render(){var e,t,i,o,r,n;return h`
      <div id="list-line" class="${this.classSize}">
        <image-block
          .model=${this.model}
          .baseImageUrl=${this.baseImageUrl}
    ...
    `}};Sa=s([A("tile-list-compact")],Sa);let $a=class extends ce{render(){return h`
  ...
  `;s([c({type:String})],He.prototype,"selectedLetter",void 0);s([c({type:Object})],He.prototype,"letterCounts",void 0);s([c({type:String})],He.prototype,"ariaLandmarkLabel",void 0);s([T()],He.prototype,"tooltipShown",void 0);s([T()],He.prototype,"hoveredLetter",void 0);s([q("alpha-bar-tooltip")],He.prototype,"tooltip",void 0);He=s([A("alpha-bar")],He);const Cn=h`
...
`;let xo=class extends B{constructor(){super(...arguments),this.config=new wo}render(){return h`
    ...
    `}static get styles(){const e=f`var(--modalLogoSize, 6.5rem)`,t=f`var(--processingImageSize, 7.5rem)`,i=f`var(--modalCornerRadius, 1rem)`,o=f`var(--modalBorder, 2px solid black)`,r=f`var(--modalBottomMargin, 2.5rem)`,n=f`var(--modalTopMargin, 5rem)`,l=f`var(--modalHeaderBottomPadding, 0.5em)`,d=f`var(--modalBottomPadding, 2rem)`,p=f`var(--modalScrollOffset, 5px)`,v=f`var(--modalTitleFontSize, 1.8rem)`,m=f`var(--modalSubtitleFontSize, 1.4rem)`,g=f`var(--modalHeadlineFontSize, 1.6rem)`,w=f`var(--modalMessageFontSize, 1.4rem)`,S=f`var(--modalTitleLineHeight, normal)`,M=f`var(--modalSubtitleLineHeight, normal)`,P=f`var(--modalHeadlineLineHeight, normal)`,L=f`var(--modalMessageLineHeight, normal)`;return f`
      .processing-logo {
        margin: auto;
        width: ${t};
        height: ${t};
    ...
    `}};s([c({type:Object})],xo.prototype,"config",void 0);xo=s([A("modal-template")],xo);function ol(a,e,t){var i=t||{},o=i.noTrailing,r=o===void 0?!1:o,n=i.noLeading,l=n===void 0?!1:n,d=i.debounceMode,p=d===void 0?void 0:d,v,m=!1,g=0;function w(){v&&clearTimeout(v)}function S(P){var L=P||{},R=L.upcomingOnly,he=R===void 0?!1:R;w(),m=!he}function M(){for(var P=arguments.length,L=new Array(P),R=0;R<P;R++)L[R]=arguments[R];var he=this,Q=Date.now()-g;if(m)return;function V(){g=Date.now(),e.apply(he,L)}function K(){v=void 0}!l&&p&&!v&&V(),w(),p===void 0&&Q>a?l?(g=Date.now(),r||(v=setTimeout(p?K:V,a))):V():r!==!0&&(v=setTimeout(p?K:V,p===void 0?a-Q:a))}return M.cancel=S,M}var ut;(function(a){a.Open="open",a.Closed="closed"})(ut||(ut={}));class al{constructor(e){this.windowResizeThrottler=ol(100,this.updateModalContainerHeight,{noLeading:!1,noTrailing:!1}).bind(this),this.modalManager=e}handleModeChange(e){switch(e){case ut.Open:this.startResizeListener(),this.stopDocumentScroll();break;case ut.Closed:this.stopResizeListener(),this.resumeDocumentScroll();break}}updateModalContainerHeight(){this.modalManager.style.setProperty("--containerHeight",`${window.innerHeight}px`)}stopDocumentScroll(){document.body.classList.add("modal-manager-open")}resumeDocumentScroll(){document.body.classList.remove("modal-manager-open")}startResizeListener(){window.addEventListener("resize",this.windowResizeThrottler)}stopResizeListener(){window.removeEventListener("resize",this.windowResizeThrottler)}}let Lt=class extends B{constructor(){super(...arguments),this.mode=ut.Closed,this.hostBridge=new al(this),this.closeOnBackdropClick=!0}render(){return h`
      <div class="container">
      ...
      <div class="facets-on-${this.renderOn}">
        ${ar(t,i=>`${e.key}:${i.key}`,i=>{var o,r;const n=`${e.key}:${i.key}-show-only`,l=`${e.key}:${i.key}-negative`,d=e.key!=="collection"?h`${(o=i.displayText)!==null&&o!==void 0?o:i.key}`:h`<a href="${this.collectionPagePath}${i.key}">
                    <async-collection-name
                      ...
                      placeholder="-"
                    ></async-collection-name>
                  </a> `,p=i.state==="hidden",v=i.state==="selected",m=`${e.key}: ${(r=i.displayText)!==null&&r!==void 0?r:i.key}`,g=v?`Show all ${e.key}s`:`Only show ${m}`,w=`Hide ${m}`,S=`Unhide ${m}`,M=p?S:w,P=`${m}, ${i.count} results`;return h`
              <div class="facet-row">
...
`,Ge;let Ce=Ge=class extends B{constructor(){super(...arguments),this.placeholderType=null,this.detailMessage=""}render(){return this.placeholderType?h`${this.placeholderTemplate}`:y}get placeholderTemplate(){return h`
      <div
