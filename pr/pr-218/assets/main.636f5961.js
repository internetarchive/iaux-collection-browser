 ...
 */function*hi(a,e){const t=typeof e=="function";if(a!==void 0){let i=-1;for(const o of a)i>-1&&(yield t?e(i):e),i++,yield o}}let wi=class extends M{constructor(){super(...arguments),this.snippets=[],this.viewSize="desktop"}render(){var e;return!((e=this.snippets)===null||e===void 0)&&e.length?h`
    ...
    `}};s([c({type:Array})],wi.prototype,"snippets",void 0);s([c({type:String})],wi.prototype,"viewSize",void 0);wi=s([A("text-snippet-block")],wi);const as=m`
  .drop-shadow {
    overflow: hidden;
    height: 100%;
  }
...
`;let vo=class extends M{constructor(){super(...arguments),this.config=new er}render(){return h`
    ...
    `}static get styles(){const e=m`var(--modalLogoSize, 6.5rem)`,t=m`var(--processingImageSize, 7.5rem)`,i=m`var(--modalCornerRadius, 1rem)`,o=m`var(--modalBorder, 2px solid black)`,r=m`var(--modalBottomMargin, 2.5rem)`,n=m`var(--modalTopMargin, 5rem)`,l=m`var(--modalHeaderBottomPadding, 0.5em)`,d=m`var(--modalBottomPadding, 2rem)`,u=m`var(--modalScrollOffset, 5px)`,v=m`var(--modalTitleFontSize, 1.8rem)`,f=m`var(--modalSubtitleFontSize, 1.4rem)`,y=m`var(--modalHeadlineFontSize, 1.6rem)`,x=m`var(--modalMessageFontSize, 1.4rem)`,S=m`var(--modalTitleLineHeight, normal)`,L=m`var(--modalSubtitleLineHeight, normal)`,B=m`var(--modalHeadlineLineHeight, normal)`,Y=m`var(--modalMessageLineHeight, normal)`;return m`
      .processing-logo {
        margin: auto;
        width: ${t};
        height: ${t};
      ...
      <div class="facets-on-${this.renderOn}">
        ${Ga(t,i=>`${e.key}:${i.key}`,i=>{var o,r;const n=`${e.key}:${i.key}-show-only`,l=`${e.key}:${i.key}-negative`,d=e.key!=="collection"?h`${(o=i.displayText)!==null&&o!==void 0?o:i.key}`:h`<a href="/details/${i.key}">
                    <async-collection-name
                      ...
                      placeholder="-"
                    ></async-collection-name>
                  </a> `,u=i.state==="hidden",v=i.state==="selected",f=`${e.key}: ${(r=i.displayText)!==null&&r!==void 0?r:i.key}`,y=v?`Show all ${e.key}s`:`Only show ${f}`,x=`Hide ${f}`,S=`Unhide ${f}`,L=u?S:x;return h`
              <div class="facet-row">
...
`),favCount:(He=(Ue=d.num_favorites)===null||Ue===void 0?void 0:Ue.value)!==null&&He!==void 0?He:0,href:(Pt=d.__href__)===null||Pt===void 0?void 0:Pt.value,identifier:d.identifier,issue:(Ft=d.issue)===null||Ft===void 0?void 0:Ft.value,itemCount:(st=(Bt=d.item_count)===null||Bt===void 0?void 0:Bt.value)!==null&&st!==void 0?st:0,mediatype:(j=(We=d.mediatype)===null||We===void 0?void 0:We.value)!==null&&j!==void 0?j:"data",snippets:(V=(nt=d.highlight)===null||nt===void 0?void 0:nt.values)!==null&&V!==void 0?V:[],source:(lt=d.source)===null||lt===void 0?void 0:lt.value,subjects:(Se=(U=d.subject)===null||U===void 0?void 0:U.values)!==null&&Se!==void 0?Se:[],title:(dt=(je=d.title)===null||je===void 0?void 0:je.value)!==null&&dt!==void 0?dt:"",volume:(Ve=d.volume)===null||Ve===void 0?void 0:Ve.value,viewCount:(_e=(ct=d.downloads)===null||ct===void 0?void 0:ct.value)!==null&&_e!==void 0?_e:0,weeklyViewCount:(ge=d.week)===null||ge===void 0?void 0:ge.value,loginRequired:Ge,contentWarning:Qe})}),o[e]=r,this.dataSource=o,this.currentVisiblePageNumbers.includes(e)&&((i=this.infiniteScroller)===null||i===void 0||i.reload())}async fetchPrefixFilterBuckets(e){var t,i,o,r,n,l;if(!this.fullQueryWithoutAlphaFilters)return[];const d=nn[e],u={query:this.fullQueryWithoutAlphaFilters,rows:0,aggregations:{simpleParams:[d]},aggregationsSize:26},v=await((t=this.searchService)===null||t===void 0?void 0:t.search(u,this.searchType));return(l=(n=(r=(o=(i=v==null?void 0:v.success)===null||i===void 0?void 0:i.response)===null||o===void 0?void 0:o.aggregations)===null||r===void 0?void 0:r[d])===null||n===void 0?void 0:n.buckets)!==null&&l!==void 0?l:[]}async updatePrefixFilterCounts(e){const t=await this.fetchPrefixFilterBuckets(e);this.prefixFilterCountMap=he({},this.prefixFilterCountMap),this.prefixFilterCountMap[e]=t.reduce((i,o)=>(i[o.key.toUpperCase()]=o.doc_count,i),{})}async updatePrefixFiltersForCurrentSort(){if(["title","creator"].includes(this.selectedSort)){const e=this.selectedSort;this.prefixFilterCountMap[e]||this.updatePrefixFilterCounts(e)}}refreshLetterCounts(){this.prefixFilterCountMap={},this.updatePrefixFiltersForCurrentSort()}resultSelected(e){var t,i;(t=this.analyticsHandler)===null||t===void 0||t.sendEvent({category:this.searchContext,action:te.resultSelected,label:e.detail.mediatype}),(i=this.analyticsHandler)===null||i===void 0||i.sendEvent({category:this.searchContext,action:te.resultSelected,label:`page-${this.currentPage}`})}cellForIndex(e){const t=this.tileModelAtCellIndex(e);if(!!t)return h`
    ...
    `}scrollThresholdReached(){this.endOfDataReached||(this.pagesToRender+=1,this.fetchPage(this.pagesToRender))}};z.styles=m`
    :host {
      display: block;
    }
