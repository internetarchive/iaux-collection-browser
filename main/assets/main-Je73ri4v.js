...
`,Lh,Rh=Lh=class extends O{render(){return T`${this.facetRowTemplate}`}get facetRowTemplate(){let{bucket:e,facetType:t}=this;if(!e||!t)return D;let n=`${t}:${e.key}-show-only`,r=`${t}:${e.key}-negative`,i=e.extraNote?T`<span class="facet-note">${e.extraNote}</span>`:D,a=t===`collection`?T`<a href="/details/${e.key}">
    ...
    `]}};L([A({type:String})],Rh.prototype,`facetType`,void 0),L([A({type:Object})],Rh.prototype,`bucket`,void 0),L([A({type:Boolean})],Rh.prototype,`omitHideButton`,void 0),L([A({type:Object})],Rh.prototype,`collectionTitles`,void 0),Rh=Lh=L([k(`facet-row`)],Rh);var zh=class extends O{facetClicked(e){this.dispatchFacetClickEvent(e.detail)}dispatchFacetClickEvent(e){let t=new CustomEvent(`facetClick`,{detail:e,composed:!0});this.dispatchEvent(t)}get facetsTemplate(){let{facetGroup:e}=this;if(!e)return D;let t=e.buckets,n=t.length===1;return T`
