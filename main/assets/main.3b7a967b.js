 ...
 */function*xi(r,e){const t=typeof e=="function";if(r!==void 0){let i=-1;for(const a of r)i>-1&&(yield t?e(i):e),i++,yield a}}let Mi=class extends O{constructor(){super(...arguments),this.snippets=[],this.viewSize="desktop"}render(){var e;return!((e=this.snippets)===null||e===void 0)&&e.length?p`
    ...
    `}};n([h({type:Array})],Mi.prototype,"snippets",void 0);n([h({type:String})],Mi.prototype,"viewSize",void 0);Mi=n([R("text-snippet-block")],Mi);const As=y`
  .drop-shadow {
...
`,Ws={account:{color:"#000000",icon:Ls,text:"Account"},audio:{color:"#00adef",icon:Fs,text:"Audio"},collection:{color:"#4666ff",icon:uo,text:"Collection"},data:{color:"#333333",icon:Os,text:"Data"},etree:{color:"#00adef",icon:Is,text:"E-tree"},film:{color:"#bf1b2c",icon:_r,text:"Film"},image:{color:"#aa99c9",icon:Ps,text:"Image"},movies:{color:"#f1644b",icon:_r,text:"Movie"},radio:{color:"#8fdaef",icon:Ns,text:"Radio"},software:{color:"#9ecc4f",icon:Rs,text:"Software"},texts:{color:"#faab3c",icon:Bs,text:"Text"},tv:{color:"#f1644b",icon:Hs,text:"TV"},video:{color:"#f1644b",icon:Us,text:"Video"},web:{color:"#ffcd27",icon:js,text:"Web"}};let li=class extends O{constructor(){super(...arguments),this.showText=!1}get displayMediatype(){var e,t;const i=["tvnews","tvarchive","television"],a=["radio","radioprogram"];return this.mediatype==="movies"&&((e=this.collections)===null||e===void 0?void 0:e.some(o=>i.indexOf(o)>=0))?"tv":this.mediatype==="audio"&&((t=this.collections)===null||t===void 0?void 0:t.some(o=>a.indexOf(o)>=0))?"radio":this.mediatype||""}render(){const e=Ws[this.displayMediatype];return e?p`
    ...
    `}};n([h({type:String})],li.prototype,"mediatype",void 0);n([h({type:Array})],li.prototype,"collections",void 0);n([h({type:Boolean})],li.prototype,"showText",void 0);li=n([R("mediatype-icon")],li);const Vs=I`
...
`+ne),ct&&(ne=Fe(ne,He," "),ne=Fe(ne,Ue," ")),B&&ui?B.createHTML(ne):ne},e.setConfig=function(C){Qi(C),Bi=!0},e.clearConfig=function(){vt=null,Bi=!1},e.isValidAttribute=function(C,u,b){vt||Qi({});var S=Qe(C),H=Qe(u);return tr(S,H,b)},e.addHook=function(C,u){typeof u=="function"&&(pe[C]=pe[C]||[],Kt(pe[C],u))},e.removeHook=function(C){if(pe[C])return $r(pe[C])},e.removeHooks=function(C){pe[C]&&(pe[C]=[])},e.removeAllHooks=function(){pe={}},e}var Jt=fo(),L;(function(r){r.relevance="relevance",r.alltimeview="alltimeview",r.weeklyview="weeklyview",r.title="title",r.datearchived="datearchived",r.date="date",r.datereviewed="datereviewed",r.dateadded="dateadded",r.creator="creator"})(L||(L={}));const Xe={relevance:"Relevance",alltimeview:"All-time Views",weeklyview:"Weekly Views",title:"Title",datearchived:"Date Archived",date:"Date Published",datereviewed:"Date Reviewed",dateadded:"Date Added",creator:"Creator"},Tn={relevance:null,alltimeview:"downloads",weeklyview:"week",title:"titleSorter",datearchived:"publicdate",date:"date",datereviewed:"reviewdate",dateadded:"addeddate",creator:"creatorSorter"},Mr={week:L.weeklyview,downloads:L.alltimeview,titleSorter:L.title,date:L.date,publicdate:L.datearchived,reviewdate:L.datereviewed,addeddate:L.dateadded,creatorSorter:L.creator},zn={title:"firstTitle",creator:"firstCreator"},Ai={subject:{},lending:{},mediatype:{},language:{},creator:{},collection:{},year:{}},Mn=["mediatype","lending","year","subject","collection","creator","language"],Di={subject:"Subject",lending:"Availability",mediatype:"Media Type",language:"Language",creator:"Creator",collection:"Collection",year:"Year"},En={is_lendable:!0,is_borrowable:!1,available_to_borrow:!0,is_browsable:!1,available_to_browse:!1,is_readable:!0,available_to_waitlist:!1},Er={is_lendable:"Lending Library",available_to_borrow:"Borrow 14 Days",is_readable:"Always Available"},Pa={deemphasize:!0,community:!0,stream_only:!0,samples_only:!0,test_collection:!0,printdisabled:!0,"openlibrary-ol":!0,nationalemergencylibrary:!0,china:!0,americana:!0,toronto:!0};function go(r){switch(r){case"date":return"Published";case"reviewdate":return"Reviewed";case"addeddate":return"Added";default:return"Archived"}}function yo(r){return r?`Archivist since ${r.getFullYear()}`:""}let ye=class extends O{constructor(){super(...arguments),this.sortParam=null,this.collectionLinks=[],this.loggedIn=!1}updated(e){e.has("model")&&this.fetchCollectionNames()}async fetchCollectionNames(){var e,t;if(!(!((e=this.model)===null||e===void 0)&&e.collections)||this.model.collections.length===0||!this.collectionNameCache)return;this.collectionLinks=[];const i=[],a=[];for(const o of this.model.collections)!Pa[o]&&!o.startsWith("fav-")&&a.push((t=this.collectionNameCache)===null||t===void 0?void 0:t.collectionNameFor(o).then(s=>{i.push(this.detailsLink(o,s!=null?s:o))}));await Promise.all(a),this.collectionLinks=i}render(){return p`
    ...
    `}};Ar=n([R("collection-browser-loading-tile")],Ar);let di=class extends O{constructor(){super(...arguments),this.selectedLetter=null,this.alphabet="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("")}get selectedUppercaseLetter(){var e;return(e=this.selectedLetter)===null||e===void 0?void 0:e.toUpperCase()}render(){return p`
      <div id="container">
        <ul>
  ...
  `;n([h({type:String})],di.prototype,"selectedLetter",void 0);n([h({type:Object})],di.prototype,"letterCounts",void 0);di=n([R("alpha-bar")],di);const Dr=I`
