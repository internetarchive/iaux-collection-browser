 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Wo=(r,e)=>e.kind==="method"&&e.descriptor&&!("value"in e.descriptor)?pt(se({},e),{finisher(t){t.createProperty(e.key,r)}}):{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){typeof e.initializer=="function"&&(this[e.key]=e.initializer.call(this))},finisher(t){t.createProperty(e.key,r)}};function c(r){return(e,t)=>t!==void 0?((i,a,o)=>{a.constructor.createProperty(o,i)})(r,e,t):Wo(r,e)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function $(r){return c(pt(se({},r),{state:!0}))}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Nr=({finisher:r,descriptor:e})=>(t,i)=>{var a;if(i===void 0){const o=(a=t.originalKey)!==null&&a!==void 0?a:t.key,n=e!=null?{kind:"method",placement:"prototype",key:o,descriptor:e(t.key)}:pt(se({},t),{key:o});return r!=null&&(n.finisher=function(l){r(l,o)}),n}{const o=t.constructor;e!==void 0&&Object.defineProperty(t,i,e(i)),r==null||r(o,i)}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;let Qt=class extends E{constructor(){super(...arguments),this.loggedIn=!1,this.loginRequired=!1,this.isCompactTile=!1}render(){return p`<div class="icon-overlay ${this.getClass}">
    ...
    >`}get getSizeTemplate(){var e,t;const i=(t=(e=this.model)===null||e===void 0?void 0:e.collectionSize)!==null&&t!==void 0?t:0;return i?p`<span id="item-size">${Zo(i,1)}</span>`:""}get infoButtonTemplate(){return this.showInfoButton?p`<button class="info-button" @click=${this.infoButtonPressed}>
          &#9432;
      ...
      `]}};s([c({type:Object})],Kt.prototype,"model",void 0);s([c({type:String})],Kt.prototype,"baseImageUrl",void 0);s([c({type:Boolean})],Kt.prototype,"showInfoButton",void 0);Kt=s([F("collection-tile")],Kt);function fi(r,e="short",t="en-US"){if(!r)return"";const i={timeZone:"UTC"};switch(e){case"short":i.month="short",i.year="numeric";break;case"long":i.year="numeric",i.month="short",i.day="2-digit";break}return new Intl.DateTimeFormat(t,i).format(r)}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*li(r,e){const t=typeof e=="function";if(r!==void 0){let i=-1;for(const a of r)i>-1&&(yield t?e(i):e),i++,yield a}}let gi=class extends E{constructor(){super(...arguments),this.snippets=[],this.viewSize="desktop"}render(){var e;return!((e=this.snippets)===null||e===void 0)&&e.length?p`
      <div class="container">
    ...
    `}};s([c({type:Array})],gi.prototype,"snippets",void 0);s([c({type:String})],gi.prototype,"viewSize",void 0);gi=s([F("text-snippet-block")],gi);const ts=f`
  .drop-shadow {
    overflow: hidden;
    height: 100%;
  }
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ys=(r,...e)=>({strTag:!0,strings:r,values:e}),ut=ys,ws=r=>typeof r!="string"&&"strTag"in r,xs=(r,e,t)=>{let i=r[0];for(let a=1;a<r.length;a++)i+=e[t?t[a-1]:a-1],i+=r[a];return i};/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let mt=_s;function $s(r,e){let t=1;return r>=1e9?t=1e9:r>=1e6?t=1e6:r>=1e3&&e==="short"&&(t=1e3),t}function ks(r=0,e){const t=r/e,i=t<10;let a=0;return i?a=Math.round((t+Number.EPSILON)*10)/10:a=Math.round(t),a}function Ts(r,e,t,i){switch(e){case 1e9:return mt(t==="short"?ut`${r}B`:ut`${r} billion`);case 1e6:return mt(t==="short"?ut`${r}M`:ut`${r} million`);case 1e3:return mt(t==="short"?ut`${r}K`:ut`${r} thousand`);default:return new Intl.NumberFormat(i).format(r)}}function Ht(r,e="long",t="short",i="en-US"){const a=r!=null?r:-1;if(a<0)return"";const o=$s(a,e),n=ks(a,o);return Ts(n,o,t,i)}let et=class extends E{render(){const e=Ht(this.favCount,"short","short"),t=Ht(this.commentCount,"short","short"),i=this.mediatype==="account"?`${this.itemCount} uploads`:`${this.viewCount} all-time views`;return p`
    ...
    `}get doesSortedByDate(){var e;return["date","reviewdate","addeddate","publicdate"].includes((e=this.sortParam)===null||e===void 0?void 0:e.field)}get hasSnippets(){var e,t;return!!(!((t=(e=this.model)===null||e===void 0?void 0:e.snippets)===null||t===void 0)&&t.length)}infoButtonPressed(e){e.preventDefault();const t=new CustomEvent("infoButtonPressed",{detail:{x:e.clientX,y:e.clientY}});this.dispatchEvent(t)}static get styles(){const e=f`var(--tileBorderColor, #dddddd)`;return[ya,f`
      ...
      `]}};s([c({type:String})],tt.prototype,"baseImageUrl",void 0);s([c({type:Boolean})],tt.prototype,"loggedIn",void 0);s([c({type:Object})],tt.prototype,"model",void 0);s([c({type:Object})],tt.prototype,"sortParam",void 0);s([c({type:Boolean})],tt.prototype,"showInfoButton",void 0);tt=s([F("item-tile")],tt);let Xt=class extends E{constructor(){super(...arguments),this.showInfoButton=!1}render(){return p`
      <div class="container">
        ${this.infoButtonTemplate}
        <div class="tile-details">
          <div class="item-info">
    ...
    >
      ...
      `]}};s([c({type:Object})],Xt.prototype,"model",void 0);s([c({type:String})],Xt.prototype,"baseImageUrl",void 0);s([c({type:Boolean})],Xt.prototype,"showInfoButton",void 0);Xt=s([F("account-tile")],Xt);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
