...
`;let mi=class extends P{constructor(){super(...arguments),this.placeholderType=null}render(){return this.placeholderType?f`${this.placeholderTemplate}`:_}get placeholderTemplate(){return f`
      <div
