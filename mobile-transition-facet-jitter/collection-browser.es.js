...
let ItemImage = class extends s$1 {
  ...
  get restrictedIconTemplate() {
    var _a;
    if (!((_a = this.model) == null ? void 0 : _a.contentWarning)) {
      return w;
    }
  ...
  get imageClass() {
    var _a;
    return `item-image ${((_a = this.model) == null ? void 0 : _a.contentWarning) ? "deemphasize" : "default"}`;
  }
  get listImageClass() {
    var _a;
  ...
  get imageBoxClass() {
    var _a, _b;
    if (this.isListTile) {
      return `list-image-box${((_a = this.model) == null ? void 0 : _a.contentWarning) ? " deemphasize" : ""}`;
    }
    if ((_b = this.model) == null ? void 0 : _b.contentWarning) {
...
let CollectionBrowser = class extends s$1 {
  ...
  updateDataSource(pageNumber, docs) {
    ...
    docs == null ? void 0 : docs.forEach((doc) => {
      ...
      if (((_a = doc.collections_raw) == null ? void 0 : _a.values.length) && ((_b = doc.mediatype) == null ? void 0 : _b.value) !== "collection") {
        for (const collection of (_c = doc.collections_raw) == null ? void 0 : _c.values) {
      ...
      tiles.push({
        averageRating: (_d = doc.avg_rating) == null ? void 0 : _d.value,
        collections: (_f = (_e = doc.collections_raw) == null ? void 0 : _e.values) != null ? _f : [],
        commentCount: (_h = (_g = doc.num_reviews) == null ? void 0 : _g.value) != null ? _h : 0,
        creator: (_i = doc.creator) == null ? void 0 : _i.value,
        creators: (_k = (_j = doc.creator) == null ? void 0 : _j.values) != null ? _k : [],
        dateAdded: (_l = doc.addeddate) == null ? void 0 : _l.value,
        dateArchived: (_m = doc.publicdate) == null ? void 0 : _m.value,
        datePublished: (_n = doc.date) == null ? void 0 : _n.value,
        dateReviewed: (_o = doc.reviewdate) == null ? void 0 : _o.value,
        description: (_p = doc.description) == null ? void 0 : _p.value,
        favCount: (_r = (_q = doc.num_favorites) == null ? void 0 : _q.value) != null ? _r : 0,
        identifier: doc.identifier,
        issue: (_s = doc.issue) == null ? void 0 : _s.value,
        itemCount: (_u = (_t = doc.item_count) == null ? void 0 : _t.value) != null ? _u : 0,
        mediatype: (_w = (_v = doc.mediatype) == null ? void 0 : _v.value) != null ? _w : "data",
        source: (_x = doc.source) == null ? void 0 : _x.value,
        subjects: (_z = (_y = doc.subject) == null ? void 0 : _y.values) != null ? _z : [],
        title: this.etreeTitle((_A = doc.title) == null ? void 0 : _A.value, (_B = doc.mediatype) == null ? void 0 : _B.value, (_C = doc.collection) == null ? void 0 : _C.values),
        volume: (_D = doc.volume) == null ? void 0 : _D.value,
        viewCount: (_F = (_E = doc.downloads) == null ? void 0 : _E.value) != null ? _F : 0,
        loginRequired,
        contentWarning
      });
    });
...
__decorateClass$1([
  e$3({ type: Boolean })
], CollectionBrowser.prototype, "loggedIn", 2);
__decorateClass$1([
  e$3({ type: Boolean })
], CollectionBrowser.prototype, "isManageView", 2);
__decorateClass$1([
  t$2()
